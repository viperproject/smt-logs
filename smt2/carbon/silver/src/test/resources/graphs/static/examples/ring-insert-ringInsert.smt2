...
(declare-fun n_30_1 () T@Ref)
(declare-fun n_28_1 () T@Ref)
...
(declare-fun v1_31 () T@Ref)
(declare-fun v_34 () T@Ref)
(declare-fun v2_31 () T@Ref)
(declare-fun n$0_38 () T@Ref)
...
(assert (not
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$0_5@@0 next))
)) (and (=> (= (ControlFlow 0 445) (- 0 446)) (forall ((n$0_5@@1 T@Ref) (n$0_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5@@1 n$0_5_2)) (select new_g n$0_5@@1)) (select new_g n$0_5_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_5@@1 n$0_5_2)))
 :qid |stdinbpl.4772:27|
 :skolemid |513|
 :pattern ( (neverTriggered57 n$0_5@@1) (neverTriggered57 n$0_5_2))
))) (=> (forall ((n$0_5@@2 T@Ref) (n$0_5_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5@@2 n$0_5_2@@0)) (select new_g n$0_5@@2)) (select new_g n$0_5_2@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_5@@2 n$0_5_2@@0)))
 :qid |stdinbpl.4772:27|
 :skolemid |513|
 :pattern ( (neverTriggered57 n$0_5@@2) (neverTriggered57 n$0_5_2@@0))
...
(let ((anon313_Then_correct  (=> (exists_path ($$ PostHeap@0 new_g) n_65 m_9) (and (=> (= (ControlFlow 0 448) 445) anon314_Then_correct) (=> (= (ControlFlow 0 448) 437) anon74_correct)))))
(let ((anon313_Else_correct  (=> (and (not (exists_path ($$ PostHeap@0 new_g) n_65 m_9)) (= (ControlFlow 0 443) 437)) anon74_correct)))
(let ((anon311_Then_correct  (=> (and (select new_g n_65) (select new_g m_9)) (and (and (=> (= (ControlFlow 0 449) 440) anon312_Then_correct) (=> (= (ControlFlow 0 449) 448) anon313_Then_correct)) (=> (= (ControlFlow 0 449) 443) anon313_Else_correct)))))
(let ((anon311_Else_correct  (=> (and (not (and (select new_g n_65) (select new_g m_9))) (= (ControlFlow 0 438) 437)) anon74_correct)))
...
(let ((anon309_Else_correct  (=> (and (not (and (select new_g n_62) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_62 next) new_start))) (= (ControlFlow 0 432) 427)) anon66_correct)))
(let ((anon309_Then_correct  (=> (and (select new_g n_62) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_62 next) new_start)) (and (=> (= (ControlFlow 0 428) (- 0 431)) (HasDirectPerm_48849_48850 QPMask@29 n_62 next)) (=> (HasDirectPerm_48849_48850 QPMask@29 n_62 next) (and (=> (= (ControlFlow 0 428) (- 0 430)) (HasDirectPerm_48852_6878 QPMask@29 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_62 next) val)) (=> (HasDirectPerm_48852_6878 QPMask@29 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_62 next) val) (and (=> (= (ControlFlow 0 428) (- 0 429)) (HasDirectPerm_48852_6878 QPMask@29 n_62 val)) (=> (HasDirectPerm_48852_6878 QPMask@29 n_62 val) (=> (= (ControlFlow 0 428) 427) anon66_correct))))))))))
(let ((anon308_Else_correct  (=> (not (select new_g n_62)) (and (=> (= (ControlFlow 0 435) 428) anon309_Then_correct) (=> (= (ControlFlow 0 435) 432) anon309_Else_correct)))))
(let ((anon308_Then_correct  (=> (select new_g n_62) (and (=> (= (ControlFlow 0 433) (- 0 434)) (HasDirectPerm_48849_48850 QPMask@29 n_62 next)) (=> (HasDirectPerm_48849_48850 QPMask@29 n_62 next) (and (=> (= (ControlFlow 0 433) 428) anon309_Then_correct) (=> (= (ControlFlow 0 433) 432) anon309_Else_correct)))))))
(let ((anon304_Else_correct  (=> (and (forall ((n_13 T@Ref) ) (!  (=> (and (select new_g n_13) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_13 next) new_start))) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| PostHeap@0) n_13 val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| PostHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_13 next) val)))
 :qid |stdinbpl.4681:20|
 :skolemid |505|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| PostHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_13 next) val))
...
(let ((anon306_Else_correct  (=> (and (not (and (select new_g n_61) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_61 next) new_start)))) (= (ControlFlow 0 423) 418)) anon60_correct)))
(let ((anon306_Then_correct  (=> (and (select new_g n_61) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_61 next) new_start))) (and (=> (= (ControlFlow 0 419) (- 0 422)) (HasDirectPerm_48852_6878 QPMask@29 n_61 val)) (=> (HasDirectPerm_48852_6878 QPMask@29 n_61 val) (and (=> (= (ControlFlow 0 419) (- 0 421)) (HasDirectPerm_48849_48850 QPMask@29 n_61 next)) (=> (HasDirectPerm_48849_48850 QPMask@29 n_61 next) (and (=> (= (ControlFlow 0 419) (- 0 420)) (HasDirectPerm_48852_6878 QPMask@29 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_61 next) val)) (=> (HasDirectPerm_48852_6878 QPMask@29 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_61 next) val) (=> (= (ControlFlow 0 419) 418) anon60_correct))))))))))
(let ((anon305_Else_correct  (=> (not (select new_g n_61)) (and (=> (= (ControlFlow 0 426) 419) anon306_Then_correct) (=> (= (ControlFlow 0 426) 423) anon306_Else_correct)))))
(let ((anon305_Then_correct  (=> (select new_g n_61) (and (=> (= (ControlFlow 0 424) (- 0 425)) (HasDirectPerm_48849_48850 QPMask@29 n_61 next)) (=> (HasDirectPerm_48849_48850 QPMask@29 n_61 next) (and (=> (= (ControlFlow 0 424) 419) anon306_Then_correct) (=> (= (ControlFlow 0 424) 423) anon306_Else_correct)))))))
(let ((anon303_Else_correct  (and (=> (= (ControlFlow 0 452) (- 0 454)) (forall ((n_11_1 T@Ref) (n_11_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_1 n_11_2)) (select new_g n_11_1)) (select new_g n_11_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_1 n_11_2)))
 :qid |stdinbpl.4622:15|
 :skolemid |499|
))) (=> (forall ((n_11_1@@0 T@Ref) (n_11_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_1@@0 n_11_2@@0)) (select new_g n_11_1@@0)) (select new_g n_11_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_1@@0 n_11_2@@0)))
 :qid |stdinbpl.4622:15|
 :skolemid |499|
)) (=> (and (and (forall ((n_11_1@@1 T@Ref) ) (!  (=> (and (select new_g n_11_1@@1) (< NoPerm FullPerm)) (and (qpRange55 n_11_1@@1) (= (invRecv55 n_11_1@@1) n_11_1@@1)))
 :qid |stdinbpl.4628:22|
 :skolemid |500|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| PostHeap@0) n_11_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@29) n_11_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| PostHeap@0) n_11_1@@1 val))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select new_g (invRecv55 o_4)) (< NoPerm FullPerm)) (qpRange55 o_4)) (= (invRecv55 o_4) o_4))
 :qid |stdinbpl.4632:22|
 :skolemid |501|
 :pattern ( (invRecv55 o_4))
))) (and (forall ((n_11_1@@2 T@Ref) ) (!  (=> (select new_g n_11_1@@2) (not (= n_11_1@@2 null)))
 :qid |stdinbpl.4638:22|
 :skolemid |502|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| PostHeap@0) n_11_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@29) n_11_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| PostHeap@0) n_11_1@@2 val))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select new_g (invRecv55 o_4@@0)) (< NoPerm FullPerm)) (qpRange55 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv55 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@29) o_4@@0 val) (+ (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@28) o_4@@0 val) FullPerm)))) (=> (not (and (and (select new_g (invRecv55 o_4@@0)) (< NoPerm FullPerm)) (qpRange55 o_4@@0))) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@29) o_4@@0 val) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@28) o_4@@0 val))))
 :qid |stdinbpl.4644:22|
 :skolemid |503|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@29) o_4@@0 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@28) o_4@@1 f_5) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@29) o_4@@1 f_5)))
 :qid |stdinbpl.4648:29|
 :skolemid |504|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@28) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@29) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_74000_74001) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@28) o_4@@2 f_5@@0) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@29) o_4@@2 f_5@@0)))
 :qid |stdinbpl.4648:29|
 :skolemid |504|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@28) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@29) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_83161_6878) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@28) o_4@@3 f_5@@1) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@29) o_4@@3 f_5@@1)))
 :qid |stdinbpl.4648:29|
 :skolemid |504|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@28) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@29) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@28) o_4@@4 f_5@@2) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@29) o_4@@4 f_5@@2)))
 :qid |stdinbpl.4648:29|
 :skolemid |504|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@28) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@29) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@28) o_4@@5 f_5@@3) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@29) o_4@@5 f_5@@3)))
 :qid |stdinbpl.4648:29|
 :skolemid |504|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@28) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@29) o_4@@5 f_5@@3))
...
(let ((anon296_Else_correct  (=> (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (select new_g n$2_1_1) (select new_g (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_1_1 next)))
 :qid |stdinbpl.4577:20|
 :skolemid |496|
 :pattern ( (select new_g (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_1_1 next)))
 :pattern ( (select new_g n$2_1_1) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_1_1 next))
...
(let ((anon297_Else_correct  (=> (and (not (select new_g n$2_19)) (= (ControlFlow 0 405) 402)) anon43_correct)))
(let ((anon297_Then_correct  (=> (select new_g n$2_19) (and (=> (= (ControlFlow 0 403) (- 0 404)) (HasDirectPerm_48849_48850 QPMask@28 n$2_19 next)) (=> (HasDirectPerm_48849_48850 QPMask@28 n$2_19 next) (=> (= (ControlFlow 0 403) 402) anon43_correct))))))
(let ((anon295_Else_correct  (and (=> (= (ControlFlow 0 458) (- 0 459)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select new_g n$1_1)) (select new_g n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (select new_g (invRecv54 o_4@@6)) (< NoPerm FullPerm)) (qpRange54 o_4@@6)) (= (invRecv54 o_4@@6) o_4@@6))
 :qid |stdinbpl.4546:22|
 :skolemid |492|
 :pattern ( (invRecv54 o_4@@6))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@2 next))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (select new_g (invRecv54 o_4@@7)) (< NoPerm FullPerm)) (qpRange54 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv54 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@28) o_4@@7 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@7 next) FullPerm)))) (=> (not (and (and (select new_g (invRecv54 o_4@@7)) (< NoPerm FullPerm)) (qpRange54 o_4@@7))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@28) o_4@@7 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@7 next))))
 :qid |stdinbpl.4558:22|
 :skolemid |494|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@28) o_4@@7 next))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@28) o_4@@8 f_5@@4)))
 :qid |stdinbpl.4562:29|
 :skolemid |495|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@28) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_74000_74001) ) (!  (=> (not (= f_5@@5 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@28) o_4@@9 f_5@@5)))
 :qid |stdinbpl.4562:29|
 :skolemid |495|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@28) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@28) o_4@@10 f_5@@6)))
 :qid |stdinbpl.4562:29|
 :skolemid |495|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@28) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@28) o_4@@11 f_5@@7)))
 :qid |stdinbpl.4562:29|
 :skolemid |495|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@28) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@28) o_4@@12 f_5@@8)))
 :qid |stdinbpl.4562:29|
 :skolemid |495|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@28) o_4@@12 f_5@@8))
...
(let ((anon348_Else_correct  (=> (and (not (and (select g_1 n_68) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_68 next) start@@1))) (= (ControlFlow 0 374) 369)) anon138_correct)))
(let ((anon348_Then_correct  (=> (and (select g_1 n_68) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_68 next) start@@1)) (and (=> (= (ControlFlow 0 370) (- 0 373)) (HasDirectPerm_48849_48850 QPMask@25 n_68 next)) (=> (HasDirectPerm_48849_48850 QPMask@25 n_68 next) (and (=> (= (ControlFlow 0 370) (- 0 372)) (HasDirectPerm_48852_6878 QPMask@25 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_68 next) val)) (=> (HasDirectPerm_48852_6878 QPMask@25 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_68 next) val) (and (=> (= (ControlFlow 0 370) (- 0 371)) (HasDirectPerm_48852_6878 QPMask@25 n_68 val)) (=> (HasDirectPerm_48852_6878 QPMask@25 n_68 val) (=> (= (ControlFlow 0 370) 369) anon138_correct))))))))))
(let ((anon347_Else_correct  (=> (not (select g_1 n_68)) (and (=> (= (ControlFlow 0 377) 370) anon348_Then_correct) (=> (= (ControlFlow 0 377) 374) anon348_Else_correct)))))
(let ((anon347_Then_correct  (=> (select g_1 n_68) (and (=> (= (ControlFlow 0 375) (- 0 376)) (HasDirectPerm_48849_48850 QPMask@25 n_68 next)) (=> (HasDirectPerm_48849_48850 QPMask@25 n_68 next) (and (=> (= (ControlFlow 0 375) 370) anon348_Then_correct) (=> (= (ControlFlow 0 375) 374) anon348_Else_correct)))))))
(let ((anon346_Else_correct true))
(let ((anon343_Else_correct  (=> (and (forall ((n_37_1 T@Ref) ) (!  (=> (and (select g_1 n_37_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_37_1 next) start@@1))) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_37_1 val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_37_1 next) val)))
 :qid |stdinbpl.5263:24|
 :skolemid |562|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_37_1 next) val))
...
(let ((anon345_Else_correct  (=> (and (not (and (select g_1 n_67) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_67 next) start@@1)))) (= (ControlFlow 0 364) 359)) anon132_correct)))
(let ((anon345_Then_correct  (=> (and (select g_1 n_67) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_67 next) start@@1))) (and (=> (= (ControlFlow 0 360) (- 0 363)) (HasDirectPerm_48852_6878 QPMask@25 n_67 val)) (=> (HasDirectPerm_48852_6878 QPMask@25 n_67 val) (and (=> (= (ControlFlow 0 360) (- 0 362)) (HasDirectPerm_48849_48850 QPMask@25 n_67 next)) (=> (HasDirectPerm_48849_48850 QPMask@25 n_67 next) (and (=> (= (ControlFlow 0 360) (- 0 361)) (HasDirectPerm_48852_6878 QPMask@25 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_67 next) val)) (=> (HasDirectPerm_48852_6878 QPMask@25 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_67 next) val) (=> (= (ControlFlow 0 360) 359) anon132_correct))))))))))
(let ((anon344_Else_correct  (=> (not (select g_1 n_67)) (and (=> (= (ControlFlow 0 367) 360) anon345_Then_correct) (=> (= (ControlFlow 0 367) 364) anon345_Else_correct)))))
(let ((anon344_Then_correct  (=> (select g_1 n_67) (and (=> (= (ControlFlow 0 365) (- 0 366)) (HasDirectPerm_48849_48850 QPMask@25 n_67 next)) (=> (HasDirectPerm_48849_48850 QPMask@25 n_67 next) (and (=> (= (ControlFlow 0 365) 360) anon345_Then_correct) (=> (= (ControlFlow 0 365) 364) anon345_Else_correct)))))))
(let ((anon342_Else_correct  (and (=> (= (ControlFlow 0 379) (- 0 380)) (forall ((n_35_1 T@Ref) (n_35_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_35_1 n_35_2)) (select g_1 n_35_1)) (select g_1 n_35_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_35_1 n_35_2)))
 :qid |stdinbpl.5213:19|
 :skolemid |556|
))) (=> (forall ((n_35_1@@0 T@Ref) (n_35_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_35_1@@0 n_35_2@@0)) (select g_1 n_35_1@@0)) (select g_1 n_35_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_35_1@@0 n_35_2@@0)))
 :qid |stdinbpl.5213:19|
 :skolemid |556|
)) (=> (and (and (forall ((n_35_1@@1 T@Ref) ) (!  (=> (and (select g_1 n_35_1@@1) (< NoPerm FullPerm)) (and (qpRange65 n_35_1@@1) (= (invRecv65 n_35_1@@1) n_35_1@@1)))
 :qid |stdinbpl.5219:26|
 :skolemid |557|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_35_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@25) n_35_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_35_1@@1 val))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv65 o_4@@13)) (< NoPerm FullPerm)) (qpRange65 o_4@@13)) (= (invRecv65 o_4@@13) o_4@@13))
 :qid |stdinbpl.5223:26|
 :skolemid |558|
 :pattern ( (invRecv65 o_4@@13))
))) (and (forall ((n_35_1@@2 T@Ref) ) (!  (=> (select g_1 n_35_1@@2) (not (= n_35_1@@2 null)))
 :qid |stdinbpl.5229:26|
 :skolemid |559|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_35_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@25) n_35_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_35_1@@2 val))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv65 o_4@@14)) (< NoPerm FullPerm)) (qpRange65 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv65 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@25) o_4@@14 val) (+ (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@24) o_4@@14 val) FullPerm)))) (=> (not (and (and (select g_1 (invRecv65 o_4@@14)) (< NoPerm FullPerm)) (qpRange65 o_4@@14))) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@25) o_4@@14 val) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@24) o_4@@14 val))))
 :qid |stdinbpl.5235:26|
 :skolemid |560|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@25) o_4@@14 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@24) o_4@@15 f_5@@9) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@25) o_4@@15 f_5@@9)))
 :qid |stdinbpl.5239:33|
 :skolemid |561|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@24) o_4@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@25) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_74000_74001) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@24) o_4@@16 f_5@@10) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@25) o_4@@16 f_5@@10)))
 :qid |stdinbpl.5239:33|
 :skolemid |561|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@24) o_4@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@25) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_83161_6878) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@24) o_4@@17 f_5@@11) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@25) o_4@@17 f_5@@11)))
 :qid |stdinbpl.5239:33|
 :skolemid |561|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@24) o_4@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@25) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@24) o_4@@18 f_5@@12) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@25) o_4@@18 f_5@@12)))
 :qid |stdinbpl.5239:33|
 :skolemid |561|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@24) o_4@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@25) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@24) o_4@@19 f_5@@13) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@25) o_4@@19 f_5@@13)))
 :qid |stdinbpl.5239:33|
 :skolemid |561|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@24) o_4@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@25) o_4@@19 f_5@@13))
...
(let ((anon337_Else_correct  (=> (and (forall ((n_33_1 T@Ref) (m_9_1 T@Ref) ) (!  (=> (and (select g_1 n_33_1) (select g_1 m_9_1)) (and (exists_path ($$ ExhaleHeap@0 g_1) n_33_1 m_9_1) (exists_path ($$ ExhaleHeap@0 g_1) m_9_1 n_33_1)))
 :qid |stdinbpl.5201:24|
 :skolemid |555|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_7031 (|$$#condqp1| ExhaleHeap@0 g_1)) g_1) n_33_1 m_9_1))
...
(let ((anon341_Then_correct  (and (=> (= (ControlFlow 0 353) (- 0 355)) (forall ((n$0_7 T@Ref) ) (!  (=> (and (select g_1 n$0_7) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$0_7 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$0_7@@0 next))
)) (and (=> (= (ControlFlow 0 353) (- 0 354)) (forall ((n$0_7@@1 T@Ref) (n$0_7_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_7@@1 n$0_7_2)) (select g_1 n$0_7@@1)) (select g_1 n$0_7_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_7@@1 n$0_7_2)))
 :qid |stdinbpl.5169:31|
 :skolemid |551|
 :pattern ( (neverTriggered64 n$0_7@@1) (neverTriggered64 n$0_7_2))
))) (=> (forall ((n$0_7@@2 T@Ref) (n$0_7_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_7@@2 n$0_7_2@@0)) (select g_1 n$0_7@@2)) (select g_1 n$0_7_2@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_7@@2 n$0_7_2@@0)))
 :qid |stdinbpl.5169:31|
 :skolemid |551|
 :pattern ( (neverTriggered64 n$0_7@@2) (neverTriggered64 n$0_7_2@@0))
...
(let ((anon340_Then_correct  (=> (exists_path ($$ ExhaleHeap@0 g_1) n_66 m_10) (and (=> (= (ControlFlow 0 356) 353) anon341_Then_correct) (=> (= (ControlFlow 0 356) 345) anon124_correct)))))
(let ((anon340_Else_correct  (=> (and (not (exists_path ($$ ExhaleHeap@0 g_1) n_66 m_10)) (= (ControlFlow 0 351) 345)) anon124_correct)))
(let ((anon338_Then_correct  (=> (and (select g_1 n_66) (select g_1 m_10)) (and (and (=> (= (ControlFlow 0 357) 348) anon339_Then_correct) (=> (= (ControlFlow 0 357) 356) anon340_Then_correct)) (=> (= (ControlFlow 0 357) 351) anon340_Else_correct)))))
(let ((anon338_Else_correct  (=> (and (not (and (select g_1 n_66) (select g_1 m_10))) (= (ControlFlow 0 346) 345)) anon124_correct)))
...
(let ((anon330_Else_correct  (=> (and (forall ((n$4_3 T@Ref) ) (!  (=> (select g_1 n$4_3) (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_3 next)))
 :qid |stdinbpl.5067:24|
 :skolemid |542|
 :pattern ( (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_3 next)))
 :pattern ( (select g_1 n$4_3) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_3 next))
...
(let ((anon331_Else_correct  (=> (and (not (select g_1 n$4_15)) (= (ControlFlow 0 333) 330)) anon107_correct)))
(let ((anon331_Then_correct  (=> (select g_1 n$4_15) (and (=> (= (ControlFlow 0 331) (- 0 332)) (HasDirectPerm_48849_48850 QPMask@24 n$4_15 next)) (=> (HasDirectPerm_48849_48850 QPMask@24 n$4_15 next) (=> (= (ControlFlow 0 331) 330) anon107_correct))))))
(let ((anon329_Else_correct  (and (=> (= (ControlFlow 0 385) (- 0 386)) (forall ((n$3_2 T@Ref) (n$3_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_2 n$3_2_1)) (select g_1 n$3_2)) (select g_1 n$3_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_2 n$3_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_2@@1 next))
)) (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv62 o_4@@20)) (< NoPerm FullPerm)) (qpRange62 o_4@@20)) (= (invRecv62 o_4@@20) o_4@@20))
 :qid |stdinbpl.5036:26|
 :skolemid |538|
 :pattern ( (invRecv62 o_4@@20))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_2@@2 next))
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv62 o_4@@21)) (< NoPerm FullPerm)) (qpRange62 o_4@@21)) (and (=> (< NoPerm FullPerm) (= (invRecv62 o_4@@21) o_4@@21)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@24) o_4@@21 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) o_4@@21 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv62 o_4@@21)) (< NoPerm FullPerm)) (qpRange62 o_4@@21))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@24) o_4@@21 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) o_4@@21 next))))
 :qid |stdinbpl.5048:26|
 :skolemid |540|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@24) o_4@@21 next))
)))) (=> (and (and (and (and (and (forall ((o_4@@22 T@Ref) (f_5@@14 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@3) o_4@@22 f_5@@14) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@24) o_4@@22 f_5@@14)))
 :qid |stdinbpl.5052:33|
 :skolemid |541|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@3) o_4@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@24) o_4@@22 f_5@@14))
)) (forall ((o_4@@23 T@Ref) (f_5@@15 T@Field_74000_74001) ) (!  (=> (not (= f_5@@15 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) o_4@@23 f_5@@15) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@24) o_4@@23 f_5@@15)))
 :qid |stdinbpl.5052:33|
 :skolemid |541|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) o_4@@23 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@24) o_4@@23 f_5@@15))
))) (forall ((o_4@@24 T@Ref) (f_5@@16 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) o_4@@24 f_5@@16) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@24) o_4@@24 f_5@@16)))
 :qid |stdinbpl.5052:33|
 :skolemid |541|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) o_4@@24 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@24) o_4@@24 f_5@@16))
))) (forall ((o_4@@25 T@Ref) (f_5@@17 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@3) o_4@@25 f_5@@17) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@24) o_4@@25 f_5@@17)))
 :qid |stdinbpl.5052:33|
 :skolemid |541|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@3) o_4@@25 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@24) o_4@@25 f_5@@17))
))) (forall ((o_4@@26 T@Ref) (f_5@@18 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@3) o_4@@26 f_5@@18) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@24) o_4@@26 f_5@@18)))
 :qid |stdinbpl.5052:33|
 :skolemid |541|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@3) o_4@@26 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@24) o_4@@26 f_5@@18))
...
(let ((anon366_Else_correct  (=> (and (not (and (select g_1 n_49_1) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_49_1 next) start@@1))) (= (ControlFlow 0 298) 295)) anon171_correct)))
(let ((anon366_Then_correct  (=> (and (select g_1 n_49_1) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_49_1 next) start@@1)) (and (=> (= (ControlFlow 0 296) (- 0 297)) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_49_1 next) val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_49_1 val))) (=> (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_49_1 next) val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_49_1 val)) (=> (= (ControlFlow 0 296) 295) anon171_correct))))))
(let ((anon365_Else_correct true))
(let ((anon363_Else_correct  (=> (forall ((n_48_1_1 T@Ref) ) (!  (=> (and (select g_1 n_48_1_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_48_1_1 next) start@@1))) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_48_1_1 val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_48_1_1 next) val)))
 :qid |stdinbpl.5576:24|
 :skolemid |598|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_48_1_1 next) val))
...
(let ((anon361_Else_correct  (=> (forall ((n_45_1_1 T@Ref) (m_12_1 T@Ref) ) (!  (=> (and (select g_1 n_45_1_1) (select g_1 m_12_1)) (and (exists_path ($$ ExhaleHeap@0 g_1) n_45_1_1 m_12_1) (exists_path ($$ ExhaleHeap@0 g_1) m_12_1 n_45_1_1)))
...
)) (and (=> (= (ControlFlow 0 300) (- 0 302)) (forall ((n_46_1 T@Ref) (n_46_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_46_1 n_46_2)) (select g_1 n_46_1)) (select g_1 n_46_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_46_1 n_46_2)))
 :qid |stdinbpl.5535:21|
 :skolemid |592|
 :pattern ( (neverTriggered69 n_46_1) (neverTriggered69 n_46_2))
 ...
 :qid |stdinbpl.5535:21|
 :skolemid |592|
 :pattern ( (neverTriggered69 n_46_1@@0) (neverTriggered69 n_46_2@@0))
)) (and (=> (= (ControlFlow 0 300) (- 0 301)) (forall ((n_46_1@@1 T@Ref) ) (!  (=> (select g_1 n_46_1@@1) (>= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@22) n_46_1@@1 val) FullPerm))
 :qid |stdinbpl.5542:21|
 :skolemid |593|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_46_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@23) n_46_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_46_1@@1 val))
))) (=> (forall ((n_46_1@@2 T@Ref) ) (!  (=> (select g_1 n_46_1@@2) (>= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@22) n_46_1@@2 val) FullPerm))
 :qid |stdinbpl.5542:21|
 :skolemid |593|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_46_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@23) n_46_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_46_1@@2 val))
)) (=> (forall ((n_46_1@@3 T@Ref) ) (!  (=> (and (select g_1 n_46_1@@3) (< NoPerm FullPerm)) (and (qpRange69 n_46_1@@3) (= (invRecv69 n_46_1@@3) n_46_1@@3)))
 :qid |stdinbpl.5548:26|
 :skolemid |594|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_46_1@@3 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@23) n_46_1@@3 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_46_1@@3 val))
)) (=> (and (forall ((o_4@@27 T@Ref) ) (!  (=> (and (select g_1 (invRecv69 o_4@@27)) (and (< NoPerm FullPerm) (qpRange69 o_4@@27))) (= (invRecv69 o_4@@27) o_4@@27))
 :qid |stdinbpl.5552:26|
 :skolemid |595|
 :pattern ( (invRecv69 o_4@@27))
)) (forall ((o_4@@28 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv69 o_4@@28)) (and (< NoPerm FullPerm) (qpRange69 o_4@@28))) (and (= (invRecv69 o_4@@28) o_4@@28) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@23) o_4@@28 val) (- (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@22) o_4@@28 val) FullPerm)))) (=> (not (and (select g_1 (invRecv69 o_4@@28)) (and (< NoPerm FullPerm) (qpRange69 o_4@@28)))) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@23) o_4@@28 val) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@22) o_4@@28 val))))
 :qid |stdinbpl.5558:26|
 :skolemid |596|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@23) o_4@@28 val))
))) (=> (and (and (and (and (forall ((o_4@@29 T@Ref) (f_5@@19 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@22) o_4@@29 f_5@@19) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@23) o_4@@29 f_5@@19)))
 :qid |stdinbpl.5564:33|
 :skolemid |597|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@23) o_4@@29 f_5@@19))
)) (forall ((o_4@@30 T@Ref) (f_5@@20 T@Field_74000_74001) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@22) o_4@@30 f_5@@20) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@23) o_4@@30 f_5@@20)))
 :qid |stdinbpl.5564:33|
 :skolemid |597|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@23) o_4@@30 f_5@@20))
))) (forall ((o_4@@31 T@Ref) (f_5@@21 T@Field_83161_6878) ) (!  (=> (not (= f_5@@21 val)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@22) o_4@@31 f_5@@21) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@23) o_4@@31 f_5@@21)))
 :qid |stdinbpl.5564:33|
 :skolemid |597|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@23) o_4@@31 f_5@@21))
))) (forall ((o_4@@32 T@Ref) (f_5@@22 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@22) o_4@@32 f_5@@22) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@23) o_4@@32 f_5@@22)))
 :qid |stdinbpl.5564:33|
 :skolemid |597|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@23) o_4@@32 f_5@@22))
))) (forall ((o_4@@33 T@Ref) (f_5@@23 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@22) o_4@@33 f_5@@23) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@23) o_4@@33 f_5@@23)))
 :qid |stdinbpl.5564:33|
 :skolemid |597|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@23) o_4@@33 f_5@@23))
...
(let ((anon362_Else_correct  (=> (and (not (and (select g_1 n_44_1) (select g_1 m_11))) (= (ControlFlow 0 289) 285)) anon163_correct)))
(let ((anon362_Then_correct  (=> (and (select g_1 n_44_1) (select g_1 m_11)) (and (=> (= (ControlFlow 0 286) (- 0 288)) (exists_path ($$ ExhaleHeap@0 g_1) n_44_1 m_11)) (=> (exists_path ($$ ExhaleHeap@0 g_1) n_44_1 m_11) (and (=> (= (ControlFlow 0 286) (- 0 287)) (exists_path ($$ ExhaleHeap@0 g_1) m_11 n_44_1)) (=> (exists_path ($$ ExhaleHeap@0 g_1) m_11 n_44_1) (=> (= (ControlFlow 0 286) 285) anon163_correct))))))))
...
(let ((anon355_Else_correct  (=> (and (not (select g_1 n$4_5)) (= (ControlFlow 0 274) 271)) anon150_correct)))
(let ((anon355_Then_correct  (=> (select g_1 n$4_5) (and (=> (= (ControlFlow 0 272) (- 0 273)) (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_5 next))) (=> (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_5 next)) (=> (= (ControlFlow 0 272) 271) anon150_correct))))))
(let ((anon147_correct  (=> (and (not (or (and (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) node@0 val) x@@14) (< x@@14 (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next) val))) (and (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next) start@@1) (or (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) node@0 val) x@@14) (< x@@14 (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) start@@1 val)))))) (state ExhaleHeap@0 QPMask@5)) (and (=> (= (ControlFlow 0 307) (- 0 311)) (HasDirectPerm_48849_48850 QPMask@5 node@0 next)) (=> (HasDirectPerm_48849_48850 QPMask@5 node@0 next) (=> (and (= node@1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next)) (state ExhaleHeap@0 QPMask@5)) (and (=> (= (ControlFlow 0 307) (- 0 310)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 307) (- 0 309)) (forall ((n$3_4 T@Ref) (n$3_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_4 n$3_4_1)) (select g_1 n$3_4)) (select g_1 n$3_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_4 n$3_4_1)))
 :qid |stdinbpl.5444:21|
 :skolemid |582|
 :pattern ( (neverTriggered68 n$3_4) (neverTriggered68 n$3_4_1))
))) (=> (forall ((n$3_4@@0 T@Ref) (n$3_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_4@@0 n$3_4_1@@0)) (select g_1 n$3_4@@0)) (select g_1 n$3_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_4@@0 n$3_4_1@@0)))
 :qid |stdinbpl.5444:21|
 :skolemid |582|
 :pattern ( (neverTriggered68 n$3_4@@0) (neverTriggered68 n$3_4_1@@0))
)) (and (=> (= (ControlFlow 0 307) (- 0 308)) (forall ((n$3_4@@1 T@Ref) ) (!  (=> (select g_1 n$3_4@@1) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) n$3_4@@1 next) FullPerm))
 :qid |stdinbpl.5451:21|
 :skolemid |583|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@22) n$3_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_4@@1 next))
))) (=> (forall ((n$3_4@@2 T@Ref) ) (!  (=> (select g_1 n$3_4@@2) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) n$3_4@@2 next) FullPerm))
 :qid |stdinbpl.5451:21|
 :skolemid |583|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@22) n$3_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_4@@2 next))
)) (=> (forall ((n$3_4@@3 T@Ref) ) (!  (=> (and (select g_1 n$3_4@@3) (< NoPerm FullPerm)) (and (qpRange68 n$3_4@@3) (= (invRecv68 n$3_4@@3) n$3_4@@3)))
 :qid |stdinbpl.5457:26|
 :skolemid |584|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_4@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@22) n$3_4@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_4@@3 next))
)) (=> (and (forall ((o_4@@34 T@Ref) ) (!  (=> (and (select g_1 (invRecv68 o_4@@34)) (and (< NoPerm FullPerm) (qpRange68 o_4@@34))) (= (invRecv68 o_4@@34) o_4@@34))
 :qid |stdinbpl.5461:26|
 :skolemid |585|
 :pattern ( (invRecv68 o_4@@34))
)) (forall ((o_4@@35 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv68 o_4@@35)) (and (< NoPerm FullPerm) (qpRange68 o_4@@35))) (and (= (invRecv68 o_4@@35) o_4@@35) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@22) o_4@@35 next) (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) o_4@@35 next) FullPerm)))) (=> (not (and (select g_1 (invRecv68 o_4@@35)) (and (< NoPerm FullPerm) (qpRange68 o_4@@35)))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@22) o_4@@35 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) o_4@@35 next))))
 :qid |stdinbpl.5467:26|
 :skolemid |586|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@22) o_4@@35 next))
))) (=> (and (and (and (and (forall ((o_4@@36 T@Ref) (f_5@@24 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@5) o_4@@36 f_5@@24) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@22) o_4@@36 f_5@@24)))
 :qid |stdinbpl.5473:33|
 :skolemid |587|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@22) o_4@@36 f_5@@24))
)) (forall ((o_4@@37 T@Ref) (f_5@@25 T@Field_74000_74001) ) (!  (=> (not (= f_5@@25 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) o_4@@37 f_5@@25) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@22) o_4@@37 f_5@@25)))
 :qid |stdinbpl.5473:33|
 :skolemid |587|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@22) o_4@@37 f_5@@25))
))) (forall ((o_4@@38 T@Ref) (f_5@@26 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@5) o_4@@38 f_5@@26) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@22) o_4@@38 f_5@@26)))
 :qid |stdinbpl.5473:33|
 :skolemid |587|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@22) o_4@@38 f_5@@26))
))) (forall ((o_4@@39 T@Ref) (f_5@@27 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@5) o_4@@39 f_5@@27) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@22) o_4@@39 f_5@@27)))
 :qid |stdinbpl.5473:33|
 :skolemid |587|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@22) o_4@@39 f_5@@27))
))) (forall ((o_4@@40 T@Ref) (f_5@@28 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@5) o_4@@40 f_5@@28) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@22) o_4@@40 f_5@@28)))
 :qid |stdinbpl.5473:33|
 :skolemid |587|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@22) o_4@@40 f_5@@28))
...
(let ((anon353_Then_correct  (=> (not (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) node@0 val) x@@14)) (and (=> (= (ControlFlow 0 314) (- 0 315)) (HasDirectPerm_48852_6878 QPMask@5 start@@1 val)) (=> (HasDirectPerm_48852_6878 QPMask@5 start@@1 val) (=> (= (ControlFlow 0 314) 307) anon147_correct))))))
(let ((anon352_Then_correct  (=> (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next) start@@1) (and (=> (= (ControlFlow 0 317) (- 0 318)) (HasDirectPerm_48852_6878 QPMask@5 node@0 val)) (=> (HasDirectPerm_48852_6878 QPMask@5 node@0 val) (and (=> (= (ControlFlow 0 317) 314) anon353_Then_correct) (=> (= (ControlFlow 0 317) 316) anon353_Else_correct)))))))
(let ((anon352_Else_correct  (=> (and (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next) start@@1)) (= (ControlFlow 0 313) 307)) anon147_correct)))
...
(let ((anon349_Then_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (not (select g_1 null))) (and (=> (= (ControlFlow 0 325) (- 0 328)) (forall ((n$3_3 T@Ref) (n$3_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_3 n$3_3_1)) (select g_1 n$3_3)) (select g_1 n$3_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_3 n$3_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_3@@1 next))
)) (forall ((o_4@@41 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv66 o_4@@41)) (< NoPerm FullPerm)) (qpRange66 o_4@@41)) (= (invRecv66 o_4@@41) o_4@@41))
 :qid |stdinbpl.5314:26|
 :skolemid |566|
 :pattern ( (invRecv66 o_4@@41))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_3@@2 next))
)) (forall ((o_4@@42 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv66 o_4@@42)) (< NoPerm FullPerm)) (qpRange66 o_4@@42)) (and (=> (< NoPerm FullPerm) (= (invRecv66 o_4@@42) o_4@@42)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@4) o_4@@42 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@42 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv66 o_4@@42)) (< NoPerm FullPerm)) (qpRange66 o_4@@42))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@4) o_4@@42 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@42 next))))
 :qid |stdinbpl.5326:26|
 :skolemid |568|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@4) o_4@@42 next))
)))) (=> (and (and (and (and (and (and (and (forall ((o_4@@43 T@Ref) (f_5@@29 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) o_4@@43 f_5@@29) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@4) o_4@@43 f_5@@29)))
 :qid |stdinbpl.5330:33|
 :skolemid |569|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) o_4@@43 f_5@@29))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@4) o_4@@43 f_5@@29))
)) (forall ((o_4@@44 T@Ref) (f_5@@30 T@Field_74000_74001) ) (!  (=> (not (= f_5@@30 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@44 f_5@@30) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@4) o_4@@44 f_5@@30)))
 :qid |stdinbpl.5330:33|
 :skolemid |569|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@44 f_5@@30))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@4) o_4@@44 f_5@@30))
))) (forall ((o_4@@45 T@Ref) (f_5@@31 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) o_4@@45 f_5@@31) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@4) o_4@@45 f_5@@31)))
 :qid |stdinbpl.5330:33|
 :skolemid |569|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) o_4@@45 f_5@@31))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@4) o_4@@45 f_5@@31))
))) (forall ((o_4@@46 T@Ref) (f_5@@32 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) o_4@@46 f_5@@32) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@4) o_4@@46 f_5@@32)))
 :qid |stdinbpl.5330:33|
 :skolemid |569|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) o_4@@46 f_5@@32))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@4) o_4@@46 f_5@@32))
))) (forall ((o_4@@47 T@Ref) (f_5@@33 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask) o_4@@47 f_5@@33) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@4) o_4@@47 f_5@@33)))
 :qid |stdinbpl.5330:33|
 :skolemid |569|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask) o_4@@47 f_5@@33))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@4) o_4@@47 f_5@@33))
))) (state ExhaleHeap@0 QPMask@4)) (and (forall ((n$4_4 T@Ref) ) (!  (=> (select g_1 n$4_4) (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_4 next)))
 :qid |stdinbpl.5336:24|
 :skolemid |570|
 :pattern ( (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_4 next)))
 :pattern ( (select g_1 n$4_4) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_4 next))
...
)) (select g_1 node@0)) (and (state ExhaleHeap@0 QPMask@4) (forall ((n_40_1 T@Ref) (m_10_1 T@Ref) ) (!  (=> (and (select g_1 n_40_1) (select g_1 m_10_1)) (and (exists_path ($$ ExhaleHeap@0 g_1) n_40_1 m_10_1) (exists_path ($$ ExhaleHeap@0 g_1) m_10_1 n_40_1)))
 :qid |stdinbpl.5350:24|
 :skolemid |573|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_7031 (|$$#condqp1| ExhaleHeap@0 g_1)) g_1) n_40_1 m_10_1))
))))) (and (=> (= (ControlFlow 0 325) (- 0 327)) (forall ((n_41_1 T@Ref) (n_41_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_41_1 n_41_2)) (select g_1 n_41_1)) (select g_1 n_41_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_41_1 n_41_2)))
 ...
 :qid |stdinbpl.5356:19|
 :skolemid |574|
)) (=> (and (and (forall ((n_41_1@@1 T@Ref) ) (!  (=> (and (select g_1 n_41_1@@1) (< NoPerm FullPerm)) (and (qpRange67 n_41_1@@1) (= (invRecv67 n_41_1@@1) n_41_1@@1)))
 :qid |stdinbpl.5362:26|
 :skolemid |575|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_41_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@5) n_41_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_41_1@@1 val))
)) (forall ((o_4@@48 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv67 o_4@@48)) (< NoPerm FullPerm)) (qpRange67 o_4@@48)) (= (invRecv67 o_4@@48) o_4@@48))
 :qid |stdinbpl.5366:26|
 :skolemid |576|
 :pattern ( (invRecv67 o_4@@48))
))) (and (forall ((n_41_1@@2 T@Ref) ) (!  (=> (select g_1 n_41_1@@2) (not (= n_41_1@@2 null)))
 :qid |stdinbpl.5372:26|
 :skolemid |577|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_41_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@5) n_41_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_41_1@@2 val))
)) (forall ((o_4@@49 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv67 o_4@@49)) (< NoPerm FullPerm)) (qpRange67 o_4@@49)) (and (=> (< NoPerm FullPerm) (= (invRecv67 o_4@@49) o_4@@49)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@5) o_4@@49 val) (+ (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@4) o_4@@49 val) FullPerm)))) (=> (not (and (and (select g_1 (invRecv67 o_4@@49)) (< NoPerm FullPerm)) (qpRange67 o_4@@49))) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@5) o_4@@49 val) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@4) o_4@@49 val))))
 :qid |stdinbpl.5378:26|
 :skolemid |578|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@5) o_4@@49 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@50 T@Ref) (f_5@@34 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@4) o_4@@50 f_5@@34) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@5) o_4@@50 f_5@@34)))
 :qid |stdinbpl.5382:33|
 :skolemid |579|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@4) o_4@@50 f_5@@34))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@5) o_4@@50 f_5@@34))
)) (forall ((o_4@@51 T@Ref) (f_5@@35 T@Field_74000_74001) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@4) o_4@@51 f_5@@35) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) o_4@@51 f_5@@35)))
 :qid |stdinbpl.5382:33|
 :skolemid |579|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@4) o_4@@51 f_5@@35))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) o_4@@51 f_5@@35))
))) (forall ((o_4@@52 T@Ref) (f_5@@36 T@Field_83161_6878) ) (!  (=> (not (= f_5@@36 val)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@4) o_4@@52 f_5@@36) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@5) o_4@@52 f_5@@36)))
 :qid |stdinbpl.5382:33|
 :skolemid |579|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@4) o_4@@52 f_5@@36))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@5) o_4@@52 f_5@@36))
))) (forall ((o_4@@53 T@Ref) (f_5@@37 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@4) o_4@@53 f_5@@37) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@5) o_4@@53 f_5@@37)))
 :qid |stdinbpl.5382:33|
 :skolemid |579|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@4) o_4@@53 f_5@@37))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@5) o_4@@53 f_5@@37))
))) (forall ((o_4@@54 T@Ref) (f_5@@38 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@4) o_4@@54 f_5@@38) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@5) o_4@@54 f_5@@38)))
 :qid |stdinbpl.5382:33|
 :skolemid |579|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@4) o_4@@54 f_5@@38))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@5) o_4@@54 f_5@@38))
))) (and (and (state ExhaleHeap@0 QPMask@5) (forall ((n_42_1 T@Ref) ) (!  (=> (and (select g_1 n_42_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_42_1 next) start@@1))) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_42_1 val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_42_1 next) val)))
 :qid |stdinbpl.5388:24|
 :skolemid |580|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_42_1 next) val))
))) (and (forall ((n_43_1 T@Ref) ) (!  (=> (and (select g_1 n_43_1) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_43_1 next) start@@1)) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_43_1 next) val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_43_1 val)))
 :qid |stdinbpl.5392:24|
 :skolemid |581|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_43_1 next) val))
...
(let ((anon387_Else_correct  (=> (and (not (and (select new_g@0 n$0_12) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n$0_12 next) null)))) (= (ControlFlow 0 183) 180)) anon214_correct)))
(let ((anon387_Then_correct  (=> (and (select new_g@0 n$0_12) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n$0_12 next) null))) (and (=> (= (ControlFlow 0 181) (- 0 182)) (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n$0_12 next))) (=> (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n$0_12 next)) (=> (= (ControlFlow 0 181) 180) anon214_correct))))))
...
(let ((anon410_Else_correct  (=> (forall ((v$2_3_1 T@Ref) ) (!  (=> (select new_g@0 v$2_3_1) (= (= v$2_3_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) v$2_3_1 next)) (|Set#Equal_49043| new_g@0 (|Set#Singleton_49733| v$2_3_1))))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@5) n_18@@3 val))
)) (=> (and (forall ((o_4@@55 T@Ref) ) (!  (=> (and (select new_g@0 (invRecv59 o_4@@55)) (and (< NoPerm FullPerm) (qpRange59 o_4@@55))) (= (invRecv59 o_4@@55) o_4@@55))
 :qid |stdinbpl.6767:22|
 :skolemid |745|
 :pattern ( (invRecv59 o_4@@55))
)) (forall ((o_4@@56 T@Ref) ) (!  (and (=> (and (select new_g@0 (invRecv59 o_4@@56)) (and (< NoPerm FullPerm) (qpRange59 o_4@@56))) (and (= (invRecv59 o_4@@56) o_4@@56) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@19) o_4@@56 val) (- (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@18) o_4@@56 val) FullPerm)))) (=> (not (and (select new_g@0 (invRecv59 o_4@@56)) (and (< NoPerm FullPerm) (qpRange59 o_4@@56)))) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@19) o_4@@56 val) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@18) o_4@@56 val))))
 :qid |stdinbpl.6773:22|
 :skolemid |746|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@19) o_4@@56 val))
))) (=> (and (and (and (and (forall ((o_4@@57 T@Ref) (f_5@@39 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@18) o_4@@57 f_5@@39) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@19) o_4@@57 f_5@@39)))
 :qid |stdinbpl.6779:29|
 :skolemid |747|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@19) o_4@@57 f_5@@39))
)) (forall ((o_4@@58 T@Ref) (f_5@@40 T@Field_74000_74001) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@18) o_4@@58 f_5@@40) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@19) o_4@@58 f_5@@40)))
 :qid |stdinbpl.6779:29|
 :skolemid |747|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@19) o_4@@58 f_5@@40))
))) (forall ((o_4@@59 T@Ref) (f_5@@41 T@Field_83161_6878) ) (!  (=> (not (= f_5@@41 val)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@18) o_4@@59 f_5@@41) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@19) o_4@@59 f_5@@41)))
 :qid |stdinbpl.6779:29|
 :skolemid |747|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@19) o_4@@59 f_5@@41))
))) (forall ((o_4@@60 T@Ref) (f_5@@42 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@18) o_4@@60 f_5@@42) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@19) o_4@@60 f_5@@42)))
 :qid |stdinbpl.6779:29|
 :skolemid |747|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@19) o_4@@60 f_5@@42))
))) (forall ((o_4@@61 T@Ref) (f_5@@43 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@18) o_4@@61 f_5@@43) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@19) o_4@@61 f_5@@43)))
 :qid |stdinbpl.6779:29|
 :skolemid |747|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@19) o_4@@61 f_5@@43))
...
(let ((anon403_Else_correct  (=> (and (forall ((n_71_1 T@Ref) (m_16_1 T@Ref) ) (!  (=> (and (select new_g@0 n_71_1) (select new_g@0 m_16_1)) (and (exists_path ($$ ExhaleHeap@5 new_g@0) n_71_1 node@0) (exists_path ($$ ExhaleHeap@5 new_g@0) node@0 m_16_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$1_2@@3 next))
)) (=> (and (forall ((o_4@@62 T@Ref) ) (!  (=> (and (select new_g@0 (invRecv58 o_4@@62)) (and (< NoPerm FullPerm) (qpRange58 o_4@@62))) (= (invRecv58 o_4@@62) o_4@@62))
 :qid |stdinbpl.6689:22|
 :skolemid |736|
 :pattern ( (invRecv58 o_4@@62))
)) (forall ((o_4@@63 T@Ref) ) (!  (and (=> (and (select new_g@0 (invRecv58 o_4@@63)) (and (< NoPerm FullPerm) (qpRange58 o_4@@63))) (and (= (invRecv58 o_4@@63) o_4@@63) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@18) o_4@@63 next) (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@17) o_4@@63 next) FullPerm)))) (=> (not (and (select new_g@0 (invRecv58 o_4@@63)) (and (< NoPerm FullPerm) (qpRange58 o_4@@63)))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@18) o_4@@63 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@17) o_4@@63 next))))
 :qid |stdinbpl.6695:22|
 :skolemid |737|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@18) o_4@@63 next))
))) (=> (and (and (and (and (forall ((o_4@@64 T@Ref) (f_5@@44 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@17) o_4@@64 f_5@@44) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@18) o_4@@64 f_5@@44)))
 :qid |stdinbpl.6701:29|
 :skolemid |738|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@18) o_4@@64 f_5@@44))
)) (forall ((o_4@@65 T@Ref) (f_5@@45 T@Field_74000_74001) ) (!  (=> (not (= f_5@@45 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@17) o_4@@65 f_5@@45) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@18) o_4@@65 f_5@@45)))
 :qid |stdinbpl.6701:29|
 :skolemid |738|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@18) o_4@@65 f_5@@45))
))) (forall ((o_4@@66 T@Ref) (f_5@@46 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@17) o_4@@66 f_5@@46) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@18) o_4@@66 f_5@@46)))
 :qid |stdinbpl.6701:29|
 :skolemid |738|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@18) o_4@@66 f_5@@46))
))) (forall ((o_4@@67 T@Ref) (f_5@@47 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@17) o_4@@67 f_5@@47) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@18) o_4@@67 f_5@@47)))
 :qid |stdinbpl.6701:29|
 :skolemid |738|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@18) o_4@@67 f_5@@47))
))) (forall ((o_4@@68 T@Ref) (f_5@@48 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@17) o_4@@68 f_5@@48) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@18) o_4@@68 f_5@@48)))
 :qid |stdinbpl.6701:29|
 :skolemid |738|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@18) o_4@@68 f_5@@48))
...
(let ((anon400_Then_correct  (and (=> (= (ControlFlow 0 95) (- 0 97)) (forall ((n$0_16 T@Ref) ) (!  (=> (and (select new_g@0 n$0_16) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$0_16 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.6562:25|
 :skolemid |722|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$0_16 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@20) n$0_16 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$0_16 next))
))) (=> (forall ((n$0_16@@0 T@Ref) ) (!  (=> (and (select new_g@0 n$0_16@@0) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$0_16@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.6562:25|
 :skolemid |722|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$0_16@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@20) n$0_16@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$0_16@@0 next))
)) (and (=> (= (ControlFlow 0 95) (- 0 96)) (forall ((n$0_16@@1 T@Ref) (n$0_16_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_16@@1 n$0_16_1)) (select new_g@0 n$0_16@@1)) (select new_g@0 n$0_16_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_16@@1 n$0_16_1)))
 :qid |stdinbpl.6569:25|
 :skolemid |723|
 :pattern ( (neverTriggered82 n$0_16@@1) (neverTriggered82 n$0_16_1))
))) (=> (forall ((n$0_16@@2 T@Ref) (n$0_16_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_16@@2 n$0_16_1@@0)) (select new_g@0 n$0_16@@2)) (select new_g@0 n$0_16_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_16@@2 n$0_16_1@@0)))
 :qid |stdinbpl.6569:25|
 :skolemid |723|
 :pattern ( (neverTriggered82 n$0_16@@2) (neverTriggered82 n$0_16_1@@0))
)) (=> (= (ControlFlow 0 95) (- 0 94)) (forall ((n$0_16@@3 T@Ref) ) (!  (=> (select new_g@0 n$0_16@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@17) n$0_16@@3 next) NoPerm)))
 :qid |stdinbpl.6576:25|
 :skolemid |724|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$0_16@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@20) n$0_16@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$0_16@@3 next))
)))))))))
(let ((anon243_correct true))
(let ((anon401_Then_correct  (=> (exists_path ($$ ExhaleHeap@5 new_g@0) n_69 node@0) (and (=> (= (ControlFlow 0 103) 100) anon402_Then_correct) (=> (= (ControlFlow 0 103) 92) anon243_correct)))))
(let ((anon401_Else_correct  (=> (and (not (exists_path ($$ ExhaleHeap@5 new_g@0) n_69 node@0)) (= (ControlFlow 0 98) 92)) anon243_correct)))
(let ((anon399_Then_correct  (=> (and (select new_g@0 n_69) (select new_g@0 m_12)) (and (and (=> (= (ControlFlow 0 104) 95) anon400_Then_correct) (=> (= (ControlFlow 0 104) 103) anon401_Then_correct)) (=> (= (ControlFlow 0 104) 98) anon401_Else_correct)))))
(let ((anon399_Else_correct  (=> (and (not (and (select new_g@0 n_69) (select new_g@0 m_12))) (= (ControlFlow 0 93) 92)) anon243_correct)))
...
(let ((anon397_Then_correct  (=> (and (and (not (= new_node@0 null)) (state ExhaleHeap@5 QPMask@17)) (and (forall ((x$0_5 T@Ref) (y_5_2 T@Ref) (u_5 T@Ref) (v_7 T@Ref) ) (!  (=> (and (DEP ($$ ExhaleHeap@5 new_g@0) x$0_5 y_5_2 u_5 v_7) (not (DEP ($$ ExhaleHeap@5 new_g@0) x$0_5 y_5_2 node@0 new_node@0))) (DEP ($$ Heap@1 new_g@0) x$0_5 y_5_2 u_5 v_7))
 :qid |stdinbpl.6516:24|
 :skolemid |717|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| ExhaleHeap@5 new_g@0)) new_g@0) x$0_5 y_5_2 u_5 v_7))
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@1 new_g@0)) new_g@0) x$0_5 y_5_2 u_5 v_7))
...
(let ((anon396_Then_correct  (=> (not (= new_node@0 null)) (=> (and (state ExhaleHeap@5 QPMask@17) (forall ((x$0_4 T@Ref) (y_4_1 T@Ref) (u_4_1@@0 T@Ref) (v_6_1 T@Ref) ) (!  (=> (and (not (= node@0 new_node@0)) (and (not (= u_4_1@@0 v_6_1)) (not (= x$0_4 y_4_1)))) (=> (or (DEP ($$ Heap@1 new_g@0) x$0_4 y_4_1 u_4_1@@0 v_6_1) (or (and (= x$0_4 node@0) (and (= u_4_1@@0 node@0) (and (= y_4_1 new_node@0) (= v_6_1 new_node@0)))) (or (exists ((w_2_2 T@Ref) (z_2 T@Ref) ) (!  (and (forall ((u__3 T@Ref) (v__3 T@Ref) ) (!  (not (DEP ($$ Heap@1 new_g@0) x$0_4 y_4_1 u__3 v__3))
 :qid |stdinbpl.6495:21|
 :skolemid |710|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@1 new_g@0)) new_g@0) x$0_4 y_4_1 u__3 v__3))
)) (and (or (and (DEP ($$ Heap@1 new_g@0) x$0_4 node@0 u_4_1@@0 v_6_1) (not (= x$0_4 node@0))) (and (= x$0_4 u_4_1@@0) (and (= u_4_1@@0 node@0) (= v_6_1 new_node@0)))) (or (and (DEP ($$ Heap@1 new_g@0) new_node@0 y_4_1 w_2_2 z_2) (not (= new_node@0 y_4_1))) (and (= node@0 w_2_2) (and (= new_node@0 z_2) (= z_2 y_4_1))))))
 :qid |stdinbpl.6493:229|
 :skolemid |711|
...
)) (and (or (and (DEP ($$ Heap@1 new_g@0) x$0_4 node@0 U_2_1 V_2_1) (not (= x$0_4 node@0))) (and (= x$0_4 U_2_1) (and (= U_2_1 node@0) (= V_2_1 new_node@0)))) (or (and (DEP ($$ Heap@1 new_g@0) new_node@0 y_4_1 u_4_1@@0 v_6_1) (not (= new_node@0 y_4_1))) (and (= node@0 u_4_1@@0) (and (= new_node@0 v_6_1) (= v_6_1 y_4_1))))))
 :qid |stdinbpl.6499:25|
 :skolemid |713|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@1 new_g@0)) new_g@0) x$0_4 node@0 U_2_1 V_2_1))
)) (and (= u_4_1@@0 node@0) (and (= v_6_1 new_node@0) (exists ((U_3_1 T@Ref) (V_3 T@Ref) (w_3_1 T@Ref) (z_3 T@Ref) ) (!  (and (forall ((u__5 T@Ref) (v__5 T@Ref) ) (!  (not (DEP ($$ Heap@1 new_g@0) x$0_4 y_4_1 u__5 v__5))
...
)))))))) (DEP ($$ ExhaleHeap@5 new_g@0) x$0_4 y_4_1 u_4_1@@0 v_6_1)))
 :qid |stdinbpl.6491:24|
 :skolemid |716|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| ExhaleHeap@5 new_g@0)) new_g@0) x$0_4 y_4_1 u_4_1@@0 v_6_1))
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@1 new_g@0)) new_g@0) x$0_4 y_4_1 u_4_1@@0 v_6_1))
...
(let ((anon392_Else_correct  (=> (forall ((n$0_15_1 T@Ref) ) (!  (=> (and (select new_g@0 n$0_15_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n$0_15_1 next) null))) (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n$0_15_1 next)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$1_6@@1 next))
)) (forall ((o_4@@69 T@Ref) ) (!  (=> (and (and (and (select new_g@0 (invRecv81 o_4@@69)) (not (= (invRecv81 o_4@@69) node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange81 o_4@@69)) (= (invRecv81 o_4@@69) o_4@@69))
 :qid |stdinbpl.6445:24|
 :skolemid |703|
 :pattern ( (invRecv81 o_4@@69))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$1_6@@4 next))
)) (forall ((o_4@@70 T@Ref) ) (!  (and (=> (and (and (and (select new_g@0 (invRecv81 o_4@@70)) (not (= (invRecv81 o_4@@70) node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange81 o_4@@70)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv81 o_4@@70) o_4@@70)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@17) o_4@@70 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@11) o_4@@70 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select new_g@0 (invRecv81 o_4@@70)) (not (= (invRecv81 o_4@@70) node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange81 o_4@@70))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@17) o_4@@70 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@11) o_4@@70 next))))
 :qid |stdinbpl.6463:24|
 :skolemid |706|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@17) o_4@@70 next))
))) (=> (and (and (and (and (and (and (forall ((o_4@@71 T@Ref) (f_5@@49 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@11) o_4@@71 f_5@@49) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@17) o_4@@71 f_5@@49)))
 :qid |stdinbpl.6467:31|
 :skolemid |707|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@11) o_4@@71 f_5@@49))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@17) o_4@@71 f_5@@49))
)) (forall ((o_4@@72 T@Ref) (f_5@@50 T@Field_74000_74001) ) (!  (=> (not (= f_5@@50 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@11) o_4@@72 f_5@@50) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@17) o_4@@72 f_5@@50)))
 :qid |stdinbpl.6467:31|
 :skolemid |707|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@11) o_4@@72 f_5@@50))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@17) o_4@@72 f_5@@50))
))) (forall ((o_4@@73 T@Ref) (f_5@@51 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@11) o_4@@73 f_5@@51) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@17) o_4@@73 f_5@@51)))
 :qid |stdinbpl.6467:31|
 :skolemid |707|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@11) o_4@@73 f_5@@51))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@17) o_4@@73 f_5@@51))
))) (forall ((o_4@@74 T@Ref) (f_5@@52 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@11) o_4@@74 f_5@@52) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@17) o_4@@74 f_5@@52)))
 :qid |stdinbpl.6467:31|
 :skolemid |707|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@11) o_4@@74 f_5@@52))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@17) o_4@@74 f_5@@52))
))) (forall ((o_4@@75 T@Ref) (f_5@@53 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@11) o_4@@75 f_5@@53) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@17) o_4@@75 f_5@@53)))
 :qid |stdinbpl.6467:31|
 :skolemid |707|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@11) o_4@@75 f_5@@53))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@17) o_4@@75 f_5@@53))
))) (state ExhaleHeap@5 QPMask@17)) (and (forall ((n$2_7 T@Ref) ) (!  (=> (and (select new_g@0 n$2_7) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$2_7 next) null))) (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$2_7 next)))
 :qid |stdinbpl.6473:22|
 :skolemid |708|
 :pattern ( (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$2_7 next)))
 :pattern ( (select new_g@0 n$2_7) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@5) n$2_7 next))
...
(let ((anon393_Else_correct  (=> (and (not (and (select new_g@0 n$0_14) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n$0_14 next) null)))) (= (ControlFlow 0 91) 88)) anon227_correct)))
(let ((anon393_Then_correct  (=> (and (select new_g@0 n$0_14) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n$0_14 next) null))) (and (=> (= (ControlFlow 0 89) (- 0 90)) (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n$0_14 next))) (=> (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n$0_14 next)) (=> (= (ControlFlow 0 89) 88) anon227_correct))))))
(let ((anon224_correct  (=> (= Mask@10 (PolymorphicMapType_73948 (store (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@9) node@0 next (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@9) node@0 next) FullPerm)) (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@9) (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@9) (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@9) (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@9))) (and (=> (= (ControlFlow 0 167) (- 0 170)) (forall ((n_64 T@Ref) ) (!  (=> (and (and (select new_g@0 n_64) (not (= n_64 node@0))) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.6365:19|
 :skolemid |693|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@16) n_64 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64 next))
))) (=> (forall ((n_64@@0 T@Ref) ) (!  (=> (and (and (select new_g@0 n_64@@0) (not (= n_64@@0 node@0))) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.6365:19|
 :skolemid |693|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@16) n_64@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64@@0 next))
)) (and (=> (= (ControlFlow 0 167) (- 0 169)) (forall ((n_64@@1 T@Ref) (n_64_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_64@@1 n_64_1)) (and (select new_g@0 n_64@@1) (not (= n_64@@1 node@0)))) (and (select new_g@0 n_64_1) (not (= n_64_1 node@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_64@@1 n_64_1)))
 :qid |stdinbpl.6372:19|
 :skolemid |694|
 :pattern ( (neverTriggered80 n_64@@1) (neverTriggered80 n_64_1))
))) (=> (forall ((n_64@@2 T@Ref) (n_64_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_64@@2 n_64_1@@0)) (and (select new_g@0 n_64@@2) (not (= n_64@@2 node@0)))) (and (select new_g@0 n_64_1@@0) (not (= n_64_1@@0 node@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_64@@2 n_64_1@@0)))
 :qid |stdinbpl.6372:19|
 :skolemid |694|
 :pattern ( (neverTriggered80 n_64@@2) (neverTriggered80 n_64_1@@0))
)) (and (=> (= (ControlFlow 0 167) (- 0 168)) (forall ((n_64@@3 T@Ref) ) (!  (=> (and (select new_g@0 n_64@@3) (not (= n_64@@3 node@0))) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@10) n_64@@3 next) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.6379:19|
 :skolemid |695|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@16) n_64@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64@@3 next))
))) (=> (forall ((n_64@@4 T@Ref) ) (!  (=> (and (select new_g@0 n_64@@4) (not (= n_64@@4 node@0))) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@10) n_64@@4 next) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.6379:19|
 :skolemid |695|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64@@4 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@16) n_64@@4 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64@@4 next))
)) (=> (forall ((n_64@@5 T@Ref) ) (!  (=> (and (and (select new_g@0 n_64@@5) (not (= n_64@@5 node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange80 n_64@@5) (= (invRecv80 n_64@@5) n_64@@5)))
 :qid |stdinbpl.6385:24|
 :skolemid |696|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64@@5 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@16) n_64@@5 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@1) n_64@@5 next))
)) (=> (and (forall ((o_4@@76 T@Ref) ) (!  (=> (and (and (select new_g@0 (invRecv80 o_4@@76)) (not (= (invRecv80 o_4@@76) node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange80 o_4@@76))) (= (invRecv80 o_4@@76) o_4@@76))
 :qid |stdinbpl.6389:24|
 :skolemid |697|
 :pattern ( (invRecv80 o_4@@76))
)) (forall ((o_4@@77 T@Ref) ) (!  (and (=> (and (and (select new_g@0 (invRecv80 o_4@@77)) (not (= (invRecv80 o_4@@77) node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange80 o_4@@77))) (and (= (invRecv80 o_4@@77) o_4@@77) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@16) o_4@@77 next) (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@10) o_4@@77 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select new_g@0 (invRecv80 o_4@@77)) (not (= (invRecv80 o_4@@77) node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange80 o_4@@77)))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@16) o_4@@77 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@10) o_4@@77 next))))
 :qid |stdinbpl.6395:24|
 :skolemid |698|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@16) o_4@@77 next))
))) (=> (and (and (and (and (forall ((o_4@@78 T@Ref) (f_5@@54 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@10) o_4@@78 f_5@@54) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@16) o_4@@78 f_5@@54)))
 :qid |stdinbpl.6401:31|
 :skolemid |699|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@16) o_4@@78 f_5@@54))
)) (forall ((o_4@@79 T@Ref) (f_5@@55 T@Field_74000_74001) ) (!  (=> (not (= f_5@@55 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@10) o_4@@79 f_5@@55) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@16) o_4@@79 f_5@@55)))
 :qid |stdinbpl.6401:31|
 :skolemid |699|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@16) o_4@@79 f_5@@55))
))) (forall ((o_4@@80 T@Ref) (f_5@@56 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@10) o_4@@80 f_5@@56) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@16) o_4@@80 f_5@@56)))
 :qid |stdinbpl.6401:31|
 :skolemid |699|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@16) o_4@@80 f_5@@56))
))) (forall ((o_4@@81 T@Ref) (f_5@@57 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@10) o_4@@81 f_5@@57) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@16) o_4@@81 f_5@@57)))
 :qid |stdinbpl.6401:31|
 :skolemid |699|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@16) o_4@@81 f_5@@57))
))) (forall ((o_4@@82 T@Ref) (f_5@@58 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@10) o_4@@82 f_5@@58) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@16) o_4@@82 f_5@@58)))
 :qid |stdinbpl.6401:31|
 :skolemid |699|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@16) o_4@@82 f_5@@58))
...
(let ((anon390_Then_correct  (=> (and (and (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) node@0 next) null)) (state ExhaleHeap@4 QPMask@15)) (and (forall ((x$0_3_1 T@Ref) (y_3_2 T@Ref) (u_3_1@@0 T@Ref) (v_5_1 T@Ref) ) (!  (=> (and (DEP ($$ ExhaleHeap@3 new_g@0) x$0_3_1 y_3_2 u_3_1@@0 v_5_1) (not (DEP ($$ ExhaleHeap@3 new_g@0) x$0_3_1 y_3_2 node@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) node@0 next)))) (DEP ($$ ExhaleHeap@4 new_g@0) x$0_3_1 y_3_2 u_3_1@@0 v_5_1))
 :qid |stdinbpl.6330:28|
 :skolemid |692|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| ExhaleHeap@4 new_g@0)) new_g@0) x$0_3_1 y_3_2 u_3_1@@0 v_5_1))
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| ExhaleHeap@3 new_g@0)) new_g@0) x$0_3_1 y_3_2 u_3_1@@0 v_5_1))
...
(let ((anon386_Else_correct  (=> (forall ((n$0_13_1 T@Ref) ) (!  (=> (and (select new_g@0 n$0_13_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n$0_13_1 next) null))) (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n$0_13_1 next)))
 :qid |stdinbpl.6256:26|
 :skolemid |682|
 :pattern ( (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n$0_13_1 next)))
 :pattern ( (select new_g@0 n$0_13_1) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n$0_13_1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@4) n$1_5@@1 next))
)) (forall ((o_4@@83 T@Ref) ) (!  (=> (and (and (and (select new_g@0 (invRecv79 o_4@@83)) (not (= (invRecv79 o_4@@83) node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange79 o_4@@83)) (= (invRecv79 o_4@@83) o_4@@83))
 :qid |stdinbpl.6284:28|
 :skolemid |685|
 :pattern ( (invRecv79 o_4@@83))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@4) n$1_5@@4 next))
)) (forall ((o_4@@84 T@Ref) ) (!  (and (=> (and (and (and (select new_g@0 (invRecv79 o_4@@84)) (not (= (invRecv79 o_4@@84) node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange79 o_4@@84)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv79 o_4@@84) o_4@@84)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@15) o_4@@84 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@8) o_4@@84 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select new_g@0 (invRecv79 o_4@@84)) (not (= (invRecv79 o_4@@84) node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange79 o_4@@84))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@15) o_4@@84 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@8) o_4@@84 next))))
 :qid |stdinbpl.6302:28|
 :skolemid |688|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@15) o_4@@84 next))
))) (=> (and (and (and (and (and (and (forall ((o_4@@85 T@Ref) (f_5@@59 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@8) o_4@@85 f_5@@59) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@15) o_4@@85 f_5@@59)))
 :qid |stdinbpl.6306:35|
 :skolemid |689|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@8) o_4@@85 f_5@@59))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@15) o_4@@85 f_5@@59))
)) (forall ((o_4@@86 T@Ref) (f_5@@60 T@Field_74000_74001) ) (!  (=> (not (= f_5@@60 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@8) o_4@@86 f_5@@60) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@15) o_4@@86 f_5@@60)))
 :qid |stdinbpl.6306:35|
 :skolemid |689|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@8) o_4@@86 f_5@@60))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@15) o_4@@86 f_5@@60))
))) (forall ((o_4@@87 T@Ref) (f_5@@61 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@8) o_4@@87 f_5@@61) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@15) o_4@@87 f_5@@61)))
 :qid |stdinbpl.6306:35|
 :skolemid |689|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@8) o_4@@87 f_5@@61))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@15) o_4@@87 f_5@@61))
))) (forall ((o_4@@88 T@Ref) (f_5@@62 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@8) o_4@@88 f_5@@62) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@15) o_4@@88 f_5@@62)))
 :qid |stdinbpl.6306:35|
 :skolemid |689|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@8) o_4@@88 f_5@@62))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@15) o_4@@88 f_5@@62))
))) (forall ((o_4@@89 T@Ref) (f_5@@63 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@8) o_4@@89 f_5@@63) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@15) o_4@@89 f_5@@63)))
 :qid |stdinbpl.6306:35|
 :skolemid |689|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@8) o_4@@89 f_5@@63))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@15) o_4@@89 f_5@@63))
))) (state ExhaleHeap@4 QPMask@15)) (and (forall ((n$2_6 T@Ref) ) (!  (=> (and (select new_g@0 n$2_6) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@4) n$2_6 next) null))) (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@4) n$2_6 next)))
 :qid |stdinbpl.6312:26|
 :skolemid |690|
 :pattern ( (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@4) n$2_6 next)))
 :pattern ( (select new_g@0 n$2_6) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@4) n$2_6 next))
...
(let ((anon211_correct  (=> (= Mask@7 (PolymorphicMapType_73948 (store (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@13) node@0 next (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@13) node@0 next) FullPerm)) (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@13) (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@13) (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@13) (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@13))) (and (=> (= (ControlFlow 0 194) (- 0 197)) (forall ((n_63 T@Ref) ) (!  (=> (and (and (select new_g@0 n_63) (not (= n_63 node@0))) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.6208:23|
 :skolemid |675|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@14) n_63 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63 next))
))) (=> (forall ((n_63@@0 T@Ref) ) (!  (=> (and (and (select new_g@0 n_63@@0) (not (= n_63@@0 node@0))) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.6208:23|
 :skolemid |675|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@14) n_63@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63@@0 next))
)) (and (=> (= (ControlFlow 0 194) (- 0 196)) (forall ((n_63@@1 T@Ref) (n_63_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_63@@1 n_63_1)) (and (select new_g@0 n_63@@1) (not (= n_63@@1 node@0)))) (and (select new_g@0 n_63_1) (not (= n_63_1 node@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_63@@1 n_63_1)))
 :qid |stdinbpl.6215:23|
 :skolemid |676|
 :pattern ( (neverTriggered78 n_63@@1) (neverTriggered78 n_63_1))
))) (=> (forall ((n_63@@2 T@Ref) (n_63_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_63@@2 n_63_1@@0)) (and (select new_g@0 n_63@@2) (not (= n_63@@2 node@0)))) (and (select new_g@0 n_63_1@@0) (not (= n_63_1@@0 node@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_63@@2 n_63_1@@0)))
 :qid |stdinbpl.6215:23|
 :skolemid |676|
 :pattern ( (neverTriggered78 n_63@@2) (neverTriggered78 n_63_1@@0))
)) (and (=> (= (ControlFlow 0 194) (- 0 195)) (forall ((n_63@@3 T@Ref) ) (!  (=> (and (select new_g@0 n_63@@3) (not (= n_63@@3 node@0))) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@7) n_63@@3 next) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.6222:23|
 :skolemid |677|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@14) n_63@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63@@3 next))
))) (=> (forall ((n_63@@4 T@Ref) ) (!  (=> (and (select new_g@0 n_63@@4) (not (= n_63@@4 node@0))) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@7) n_63@@4 next) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.6222:23|
 :skolemid |677|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63@@4 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@14) n_63@@4 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63@@4 next))
)) (=> (forall ((n_63@@5 T@Ref) ) (!  (=> (and (and (select new_g@0 n_63@@5) (not (= n_63@@5 node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange78 n_63@@5) (= (invRecv78 n_63@@5) n_63@@5)))
 :qid |stdinbpl.6228:28|
 :skolemid |678|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63@@5 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@14) n_63@@5 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n_63@@5 next))
)) (=> (and (forall ((o_4@@90 T@Ref) ) (!  (=> (and (and (select new_g@0 (invRecv78 o_4@@90)) (not (= (invRecv78 o_4@@90) node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange78 o_4@@90))) (= (invRecv78 o_4@@90) o_4@@90))
 :qid |stdinbpl.6232:28|
 :skolemid |679|
 :pattern ( (invRecv78 o_4@@90))
)) (forall ((o_4@@91 T@Ref) ) (!  (and (=> (and (and (select new_g@0 (invRecv78 o_4@@91)) (not (= (invRecv78 o_4@@91) node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange78 o_4@@91))) (and (= (invRecv78 o_4@@91) o_4@@91) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@14) o_4@@91 next) (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@7) o_4@@91 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select new_g@0 (invRecv78 o_4@@91)) (not (= (invRecv78 o_4@@91) node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange78 o_4@@91)))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@14) o_4@@91 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@7) o_4@@91 next))))
 :qid |stdinbpl.6238:28|
 :skolemid |680|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@14) o_4@@91 next))
))) (=> (and (and (and (and (forall ((o_4@@92 T@Ref) (f_5@@64 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@7) o_4@@92 f_5@@64) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@14) o_4@@92 f_5@@64)))
 :qid |stdinbpl.6244:35|
 :skolemid |681|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@14) o_4@@92 f_5@@64))
)) (forall ((o_4@@93 T@Ref) (f_5@@65 T@Field_74000_74001) ) (!  (=> (not (= f_5@@65 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@7) o_4@@93 f_5@@65) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@14) o_4@@93 f_5@@65)))
 :qid |stdinbpl.6244:35|
 :skolemid |681|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@14) o_4@@93 f_5@@65))
))) (forall ((o_4@@94 T@Ref) (f_5@@66 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@7) o_4@@94 f_5@@66) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@14) o_4@@94 f_5@@66)))
 :qid |stdinbpl.6244:35|
 :skolemid |681|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@14) o_4@@94 f_5@@66))
))) (forall ((o_4@@95 T@Ref) (f_5@@67 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@7) o_4@@95 f_5@@67) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@14) o_4@@95 f_5@@67)))
 :qid |stdinbpl.6244:35|
 :skolemid |681|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@14) o_4@@95 f_5@@67))
))) (forall ((o_4@@96 T@Ref) (f_5@@68 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@7) o_4@@96 f_5@@68) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@14) o_4@@96 f_5@@68)))
 :qid |stdinbpl.6244:35|
 :skolemid |681|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@14) o_4@@96 f_5@@68))
...
(let ((anon383_Then_correct  (=> (and (and (not (= arg_to@0 null)) (state ExhaleHeap@3 QPMask@13)) (and (forall ((x$0_2 T@Ref) (y_2 T@Ref) (u_2_1@@0 T@Ref) (v_4_1@@0 T@Ref) ) (!  (=> (and (DEP ($$ ExhaleHeap@3 new_g@0) x$0_2 y_2 u_2_1@@0 v_4_1@@0) (not (DEP ($$ ExhaleHeap@3 new_g@0) x$0_2 y_2 new_node@0 arg_to@0))) (DEP ($$ Heap@0 new_g@0) x$0_2 y_2 u_2_1@@0 v_4_1@@0))
 :qid |stdinbpl.6150:24|
 :skolemid |670|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| ExhaleHeap@3 new_g@0)) new_g@0) x$0_2 y_2 u_2_1@@0 v_4_1@@0))
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@0 new_g@0)) new_g@0) x$0_2 y_2 u_2_1@@0 v_4_1@@0))
...
(let ((anon382_Then_correct  (=> (not (= arg_to@0 null)) (=> (and (state ExhaleHeap@3 QPMask@13) (forall ((x$0_1 T@Ref) (y_1 T@Ref) (u_1@@1 T@Ref) (v_3_1@@0 T@Ref) ) (!  (=> (and (not (= new_node@0 arg_to@0)) (and (not (= u_1@@1 v_3_1@@0)) (not (= x$0_1 y_1)))) (=> (or (DEP ($$ Heap@0 new_g@0) x$0_1 y_1 u_1@@1 v_3_1@@0) (or (and (= x$0_1 new_node@0) (and (= u_1@@1 new_node@0) (and (= y_1 arg_to@0) (= v_3_1@@0 arg_to@0)))) (or (exists ((w_2@@1 T@Ref) (z T@Ref) ) (!  (and (forall ((u_ T@Ref) (v_ T@Ref) ) (!  (not (DEP ($$ Heap@0 new_g@0) x$0_1 y_1 u_ v_))
 :qid |stdinbpl.6129:21|
 :skolemid |663|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@0 new_g@0)) new_g@0) x$0_1 y_1 u_ v_))
)) (and (or (and (DEP ($$ Heap@0 new_g@0) x$0_1 new_node@0 u_1@@1 v_3_1@@0) (not (= x$0_1 new_node@0))) (and (= x$0_1 u_1@@1) (and (= u_1@@1 new_node@0) (= v_3_1@@0 arg_to@0)))) (or (and (DEP ($$ Heap@0 new_g@0) arg_to@0 y_1 w_2@@1 z) (not (= arg_to@0 y_1))) (and (= new_node@0 w_2@@1) (and (= arg_to@0 z) (= z y_1))))))
 :qid |stdinbpl.6127:223|
 :skolemid |664|
...
)) (and (or (and (DEP ($$ Heap@0 new_g@0) x$0_1 new_node@0 U_1@@0 V_11) (not (= x$0_1 new_node@0))) (and (= x$0_1 U_1@@0) (and (= U_1@@0 new_node@0) (= V_11 arg_to@0)))) (or (and (DEP ($$ Heap@0 new_g@0) arg_to@0 y_1 u_1@@1 v_3_1@@0) (not (= arg_to@0 y_1))) (and (= new_node@0 u_1@@1) (and (= arg_to@0 v_3_1@@0) (= v_3_1@@0 y_1))))))
 :qid |stdinbpl.6133:25|
 :skolemid |666|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@0 new_g@0)) new_g@0) x$0_1 new_node@0 U_1@@0 V_11))
)) (and (= u_1@@1 new_node@0) (and (= v_3_1@@0 arg_to@0) (exists ((U_1_1 T@Ref) (V_1 T@Ref) (w_1 T@Ref) (z_1 T@Ref) ) (!  (and (forall ((u__2 T@Ref) (v__2 T@Ref) ) (!  (not (DEP ($$ Heap@0 new_g@0) x$0_1 y_1 u__2 v__2))
 :qid |stdinbpl.6141:21|
 :skolemid |667|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@0 new_g@0)) new_g@0) x$0_1 y_1 u__2 v__2))
)) (and (or (and (DEP ($$ Heap@0 new_g@0) x$0_1 new_node@0 U_1_1 V_1) (not (= x$0_1 new_node@0))) (and (= x$0_1 U_1_1) (and (= U_1_1 new_node@0) (= V_1 arg_to@0)))) (or (and (DEP ($$ Heap@0 new_g@0) arg_to@0 y_1 w_1 z_1) (not (= arg_to@0 y_1))) (and (= new_node@0 w_1) (and (= arg_to@0 z_1) (= z_1 y_1))))))
 :qid |stdinbpl.6139:64|
 :skolemid |668|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@0 new_g@0)) new_g@0) x$0_1 new_node@0 U_1_1 V_1) (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@0 new_g@0)) new_g@0) arg_to@0 y_1 w_1 z_1))
)))))))) (DEP ($$ ExhaleHeap@3 new_g@0) x$0_1 y_1 u_1@@1 v_3_1@@0)))
 :qid |stdinbpl.6125:24|
 :skolemid |669|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| ExhaleHeap@3 new_g@0)) new_g@0) x$0_1 y_1 u_1@@1 v_3_1@@0))
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| Heap@0 new_g@0)) new_g@0) x$0_1 y_1 u_1@@1 v_3_1@@0))
...
(let ((anon378_Else_correct  (=> (forall ((n$0_11_1 T@Ref) ) (!  (=> (and (select new_g@0 n$0_11_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n$0_11_1 next) null))) (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n$0_11_1 next)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n$1_4@@1 next))
)) (forall ((o_4@@97 T@Ref) ) (!  (=> (and (and (and (select new_g@0 (invRecv77 o_4@@97)) (not (= (invRecv77 o_4@@97) new_node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange77 o_4@@97)) (= (invRecv77 o_4@@97) o_4@@97))
 :qid |stdinbpl.6079:24|
 :skolemid |656|
 :pattern ( (invRecv77 o_4@@97))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@3) n$1_4@@4 next))
)) (forall ((o_4@@98 T@Ref) ) (!  (and (=> (and (and (and (select new_g@0 (invRecv77 o_4@@98)) (not (= (invRecv77 o_4@@98) new_node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange77 o_4@@98)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv77 o_4@@98) o_4@@98)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@13) o_4@@98 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@6) o_4@@98 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select new_g@0 (invRecv77 o_4@@98)) (not (= (invRecv77 o_4@@98) new_node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange77 o_4@@98))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@13) o_4@@98 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@6) o_4@@98 next))))
 :qid |stdinbpl.6097:24|
 :skolemid |659|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@13) o_4@@98 next))
))) (=> (and (and (and (and (and (and (forall ((o_4@@99 T@Ref) (f_5@@69 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@6) o_4@@99 f_5@@69) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@13) o_4@@99 f_5@@69)))
 :qid |stdinbpl.6101:31|
 :skolemid |660|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@6) o_4@@99 f_5@@69))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@13) o_4@@99 f_5@@69))
)) (forall ((o_4@@100 T@Ref) (f_5@@70 T@Field_74000_74001) ) (!  (=> (not (= f_5@@70 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@6) o_4@@100 f_5@@70) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@13) o_4@@100 f_5@@70)))
 :qid |stdinbpl.6101:31|
 :skolemid |660|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@6) o_4@@100 f_5@@70))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@13) o_4@@100 f_5@@70))
))) (forall ((o_4@@101 T@Ref) (f_5@@71 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@6) o_4@@101 f_5@@71) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@13) o_4@@101 f_5@@71)))
 :qid |stdinbpl.6101:31|
 :skolemid |660|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@6) o_4@@101 f_5@@71))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@13) o_4@@101 f_5@@71))
))) (forall ((o_4@@102 T@Ref) (f_5@@72 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@6) o_4@@102 f_5@@72) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@13) o_4@@102 f_5@@72)))
 :qid |stdinbpl.6101:31|
 :skolemid |660|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@6) o_4@@102 f_5@@72))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@13) o_4@@102 f_5@@72))
))) (forall ((o_4@@103 T@Ref) (f_5@@73 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@6) o_4@@103 f_5@@73) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@13) o_4@@103 f_5@@73)))
 :qid |stdinbpl.6101:31|
 :skolemid |660|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@6) o_4@@103 f_5@@73))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@13) o_4@@103 f_5@@73))
...
(let ((anon379_Else_correct  (=> (and (not (and (select new_g@0 n$0_10) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n$0_10 next) null)))) (= (ControlFlow 0 87) 84)) anon199_correct)))
(let ((anon379_Then_correct  (=> (and (select new_g@0 n$0_10) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n$0_10 next) null))) (and (=> (= (ControlFlow 0 85) (- 0 86)) (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n$0_10 next))) (=> (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n$0_10 next)) (=> (= (ControlFlow 0 85) 84) anon199_correct))))))
(let ((anon196_correct  (=> (= Mask@5 (PolymorphicMapType_73948 (store (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@4) new_node@0 next (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@4) new_node@0 next) FullPerm)) (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@4) (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@4) (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@4) (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@4))) (and (=> (= (ControlFlow 0 220) (- 0 223)) (forall ((n_58 T@Ref) ) (!  (=> (and (and (select new_g@0 n_58) (not (= n_58 new_node@0))) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.5999:19|
 :skolemid |646|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@12) n_58 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58 next))
))) (=> (forall ((n_58@@0 T@Ref) ) (!  (=> (and (and (select new_g@0 n_58@@0) (not (= n_58@@0 new_node@0))) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.5999:19|
 :skolemid |646|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@12) n_58@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58@@0 next))
)) (and (=> (= (ControlFlow 0 220) (- 0 222)) (forall ((n_58@@1 T@Ref) (n_58_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_58@@1 n_58_1)) (and (select new_g@0 n_58@@1) (not (= n_58@@1 new_node@0)))) (and (select new_g@0 n_58_1) (not (= n_58_1 new_node@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_58@@1 n_58_1)))
 :qid |stdinbpl.6006:19|
 :skolemid |647|
 :pattern ( (neverTriggered76 n_58@@1) (neverTriggered76 n_58_1))
))) (=> (forall ((n_58@@2 T@Ref) (n_58_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_58@@2 n_58_1@@0)) (and (select new_g@0 n_58@@2) (not (= n_58@@2 new_node@0)))) (and (select new_g@0 n_58_1@@0) (not (= n_58_1@@0 new_node@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_58@@2 n_58_1@@0)))
 :qid |stdinbpl.6006:19|
 :skolemid |647|
 :pattern ( (neverTriggered76 n_58@@2) (neverTriggered76 n_58_1@@0))
)) (and (=> (= (ControlFlow 0 220) (- 0 221)) (forall ((n_58@@3 T@Ref) ) (!  (=> (and (select new_g@0 n_58@@3) (not (= n_58@@3 new_node@0))) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@5) n_58@@3 next) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.6013:19|
 :skolemid |648|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@12) n_58@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58@@3 next))
))) (=> (forall ((n_58@@4 T@Ref) ) (!  (=> (and (select new_g@0 n_58@@4) (not (= n_58@@4 new_node@0))) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@5) n_58@@4 next) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.6013:19|
 :skolemid |648|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58@@4 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@12) n_58@@4 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58@@4 next))
)) (=> (forall ((n_58@@5 T@Ref) ) (!  (=> (and (and (select new_g@0 n_58@@5) (not (= n_58@@5 new_node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange76 n_58@@5) (= (invRecv76 n_58@@5) n_58@@5)))
 :qid |stdinbpl.6019:24|
 :skolemid |649|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58@@5 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@12) n_58@@5 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@0) n_58@@5 next))
)) (=> (and (forall ((o_4@@104 T@Ref) ) (!  (=> (and (and (select new_g@0 (invRecv76 o_4@@104)) (not (= (invRecv76 o_4@@104) new_node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange76 o_4@@104))) (= (invRecv76 o_4@@104) o_4@@104))
 :qid |stdinbpl.6023:24|
 :skolemid |650|
 :pattern ( (invRecv76 o_4@@104))
)) (forall ((o_4@@105 T@Ref) ) (!  (and (=> (and (and (select new_g@0 (invRecv76 o_4@@105)) (not (= (invRecv76 o_4@@105) new_node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange76 o_4@@105))) (and (= (invRecv76 o_4@@105) o_4@@105) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@12) o_4@@105 next) (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@5) o_4@@105 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select new_g@0 (invRecv76 o_4@@105)) (not (= (invRecv76 o_4@@105) new_node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange76 o_4@@105)))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@12) o_4@@105 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@5) o_4@@105 next))))
 :qid |stdinbpl.6029:24|
 :skolemid |651|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@12) o_4@@105 next))
))) (=> (and (and (and (and (forall ((o_4@@106 T@Ref) (f_5@@74 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@5) o_4@@106 f_5@@74) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@12) o_4@@106 f_5@@74)))
 :qid |stdinbpl.6035:31|
 :skolemid |652|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@12) o_4@@106 f_5@@74))
)) (forall ((o_4@@107 T@Ref) (f_5@@75 T@Field_74000_74001) ) (!  (=> (not (= f_5@@75 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@5) o_4@@107 f_5@@75) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@12) o_4@@107 f_5@@75)))
 :qid |stdinbpl.6035:31|
 :skolemid |652|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@12) o_4@@107 f_5@@75))
))) (forall ((o_4@@108 T@Ref) (f_5@@76 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@5) o_4@@108 f_5@@76) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@12) o_4@@108 f_5@@76)))
 :qid |stdinbpl.6035:31|
 :skolemid |652|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@12) o_4@@108 f_5@@76))
))) (forall ((o_4@@109 T@Ref) (f_5@@77 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@5) o_4@@109 f_5@@77) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@12) o_4@@109 f_5@@77)))
 :qid |stdinbpl.6035:31|
 :skolemid |652|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@12) o_4@@109 f_5@@77))
))) (forall ((o_4@@110 T@Ref) (f_5@@78 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@5) o_4@@110 f_5@@78) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@12) o_4@@110 f_5@@78)))
 :qid |stdinbpl.6035:31|
 :skolemid |652|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@12) o_4@@110 f_5@@78))
...
(let ((anon376_Then_correct  (=> (and (and (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) new_node@0 next) null)) (state ExhaleHeap@2 QPMask@11)) (and (forall ((x$0 T@Ref) (y@@12 T@Ref) (u_3@@7 T@Ref) (v_2_1@@0 T@Ref) ) (!  (=> (and (DEP ($$ ExhaleHeap@0 new_g@0) x$0 y@@12 u_3@@7 v_2_1@@0) (not (DEP ($$ ExhaleHeap@0 new_g@0) x$0 y@@12 new_node@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) new_node@0 next)))) (DEP ($$ ExhaleHeap@2 new_g@0) x$0 y@@12 u_3@@7 v_2_1@@0))
 :qid |stdinbpl.5959:28|
 :skolemid |645|
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| ExhaleHeap@2 new_g@0)) new_g@0) x$0 y@@12 u_3@@7 v_2_1@@0))
 :pattern ( (DEP (|$$#frame| (FrameFragment_7031 (|$$#condqp1| ExhaleHeap@0 new_g@0)) new_g@0) x$0 y@@12 u_3@@7 v_2_1@@0))
...
(let ((anon372_Else_correct  (=> (forall ((n$0_9_1 T@Ref) ) (!  (=> (and (select new_g@0 n$0_9_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$0_9_1 next) null))) (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$0_9_1 next)))
 :qid |stdinbpl.5885:26|
 :skolemid |635|
 :pattern ( (select new_g@0 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$0_9_1 next)))
 :pattern ( (select new_g@0 n$0_9_1) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$0_9_1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@2) n$1_3@@1 next))
)) (forall ((o_4@@111 T@Ref) ) (!  (=> (and (and (and (select new_g@0 (invRecv75 o_4@@111)) (not (= (invRecv75 o_4@@111) new_node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange75 o_4@@111)) (= (invRecv75 o_4@@111) o_4@@111))
 :qid |stdinbpl.5913:28|
 :skolemid |638|
 :pattern ( (invRecv75 o_4@@111))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@2) n$1_3@@4 next))
)) (forall ((o_4@@112 T@Ref) ) (!  (and (=> (and (and (and (select new_g@0 (invRecv75 o_4@@112)) (not (= (invRecv75 o_4@@112) new_node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange75 o_4@@112)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv75 o_4@@112) o_4@@112)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@11) o_4@@112 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@3) o_4@@112 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select new_g@0 (invRecv75 o_4@@112)) (not (= (invRecv75 o_4@@112) new_node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange75 o_4@@112))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@11) o_4@@112 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@3) o_4@@112 next))))
 :qid |stdinbpl.5931:28|
 :skolemid |641|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@11) o_4@@112 next))
))) (=> (and (and (and (and (and (and (forall ((o_4@@113 T@Ref) (f_5@@79 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@3) o_4@@113 f_5@@79) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@11) o_4@@113 f_5@@79)))
 :qid |stdinbpl.5935:35|
 :skolemid |642|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@3) o_4@@113 f_5@@79))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@11) o_4@@113 f_5@@79))
)) (forall ((o_4@@114 T@Ref) (f_5@@80 T@Field_74000_74001) ) (!  (=> (not (= f_5@@80 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@3) o_4@@114 f_5@@80) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@11) o_4@@114 f_5@@80)))
 :qid |stdinbpl.5935:35|
 :skolemid |642|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@3) o_4@@114 f_5@@80))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@11) o_4@@114 f_5@@80))
))) (forall ((o_4@@115 T@Ref) (f_5@@81 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@3) o_4@@115 f_5@@81) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@11) o_4@@115 f_5@@81)))
 :qid |stdinbpl.5935:35|
 :skolemid |642|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@3) o_4@@115 f_5@@81))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@11) o_4@@115 f_5@@81))
))) (forall ((o_4@@116 T@Ref) (f_5@@82 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@3) o_4@@116 f_5@@82) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@11) o_4@@116 f_5@@82)))
 :qid |stdinbpl.5935:35|
 :skolemid |642|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@3) o_4@@116 f_5@@82))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@11) o_4@@116 f_5@@82))
))) (forall ((o_4@@117 T@Ref) (f_5@@83 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@3) o_4@@117 f_5@@83) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@11) o_4@@117 f_5@@83)))
 :qid |stdinbpl.5935:35|
 :skolemid |642|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@3) o_4@@117 f_5@@83))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@11) o_4@@117 f_5@@83))
...
(let ((anon183_correct  (=> (= Mask@2 (PolymorphicMapType_73948 (store (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) new_node@0 next (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) new_node@0 next) FullPerm)) (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@7) (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@7) (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@7) (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@7))) (and (=> (= (ControlFlow 0 248) (- 0 251)) (forall ((n_57 T@Ref) ) (!  (=> (and (and (select new_g@0 n_57) (not (= n_57 new_node@0))) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.5837:23|
 :skolemid |628|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@10) n_57 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57 next))
))) (=> (forall ((n_57@@0 T@Ref) ) (!  (=> (and (and (select new_g@0 n_57@@0) (not (= n_57@@0 new_node@0))) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.5837:23|
 :skolemid |628|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@10) n_57@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57@@0 next))
)) (and (=> (= (ControlFlow 0 248) (- 0 250)) (forall ((n_57@@1 T@Ref) (n_57_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_57@@1 n_57_1)) (and (select new_g@0 n_57@@1) (not (= n_57@@1 new_node@0)))) (and (select new_g@0 n_57_1) (not (= n_57_1 new_node@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_57@@1 n_57_1)))
 :qid |stdinbpl.5844:23|
 :skolemid |629|
 :pattern ( (neverTriggered74 n_57@@1) (neverTriggered74 n_57_1))
))) (=> (forall ((n_57@@2 T@Ref) (n_57_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_57@@2 n_57_1@@0)) (and (select new_g@0 n_57@@2) (not (= n_57@@2 new_node@0)))) (and (select new_g@0 n_57_1@@0) (not (= n_57_1@@0 new_node@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_57@@2 n_57_1@@0)))
 :qid |stdinbpl.5844:23|
 :skolemid |629|
 :pattern ( (neverTriggered74 n_57@@2) (neverTriggered74 n_57_1@@0))
)) (and (=> (= (ControlFlow 0 248) (- 0 249)) (forall ((n_57@@3 T@Ref) ) (!  (=> (and (select new_g@0 n_57@@3) (not (= n_57@@3 new_node@0))) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@2) n_57@@3 next) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.5851:23|
 :skolemid |630|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@10) n_57@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57@@3 next))
))) (=> (forall ((n_57@@4 T@Ref) ) (!  (=> (and (select new_g@0 n_57@@4) (not (= n_57@@4 new_node@0))) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@2) n_57@@4 next) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.5851:23|
 :skolemid |630|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57@@4 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@10) n_57@@4 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57@@4 next))
)) (=> (forall ((n_57@@5 T@Ref) ) (!  (=> (and (and (select new_g@0 n_57@@5) (not (= n_57@@5 new_node@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange74 n_57@@5) (= (invRecv74 n_57@@5) n_57@@5)))
 :qid |stdinbpl.5857:28|
 :skolemid |631|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57@@5 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@10) n_57@@5 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_57@@5 next))
)) (=> (and (forall ((o_4@@118 T@Ref) ) (!  (=> (and (and (select new_g@0 (invRecv74 o_4@@118)) (not (= (invRecv74 o_4@@118) new_node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange74 o_4@@118))) (= (invRecv74 o_4@@118) o_4@@118))
 :qid |stdinbpl.5861:28|
 :skolemid |632|
 :pattern ( (invRecv74 o_4@@118))
)) (forall ((o_4@@119 T@Ref) ) (!  (and (=> (and (and (select new_g@0 (invRecv74 o_4@@119)) (not (= (invRecv74 o_4@@119) new_node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange74 o_4@@119))) (and (= (invRecv74 o_4@@119) o_4@@119) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@10) o_4@@119 next) (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@2) o_4@@119 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select new_g@0 (invRecv74 o_4@@119)) (not (= (invRecv74 o_4@@119) new_node@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange74 o_4@@119)))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@10) o_4@@119 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@2) o_4@@119 next))))
 :qid |stdinbpl.5867:28|
 :skolemid |633|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@10) o_4@@119 next))
))) (=> (and (and (and (and (forall ((o_4@@120 T@Ref) (f_5@@84 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@2) o_4@@120 f_5@@84) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@10) o_4@@120 f_5@@84)))
 :qid |stdinbpl.5873:35|
 :skolemid |634|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@10) o_4@@120 f_5@@84))
)) (forall ((o_4@@121 T@Ref) (f_5@@85 T@Field_74000_74001) ) (!  (=> (not (= f_5@@85 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@2) o_4@@121 f_5@@85) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@10) o_4@@121 f_5@@85)))
 :qid |stdinbpl.5873:35|
 :skolemid |634|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@10) o_4@@121 f_5@@85))
))) (forall ((o_4@@122 T@Ref) (f_5@@86 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@2) o_4@@122 f_5@@86) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@10) o_4@@122 f_5@@86)))
 :qid |stdinbpl.5873:35|
 :skolemid |634|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@10) o_4@@122 f_5@@86))
))) (forall ((o_4@@123 T@Ref) (f_5@@87 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@2) o_4@@123 f_5@@87) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@10) o_4@@123 f_5@@87)))
 :qid |stdinbpl.5873:35|
 :skolemid |634|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@10) o_4@@123 f_5@@87))
))) (forall ((o_4@@124 T@Ref) (f_5@@88 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@2) o_4@@124 f_5@@88) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@10) o_4@@124 f_5@@88)))
 :qid |stdinbpl.5873:35|
 :skolemid |634|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@10) o_4@@124 f_5@@88))
...
(let ((anon369_Then_correct  (and (=> (= (ControlFlow 0 77) (- 0 83)) (forall ((n_55 T@Ref) ) (!  (=> (and (select g_1 n_55) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.5734:21|
 :skolemid |618|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@8) n_55 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55 next))
))) (=> (forall ((n_55@@0 T@Ref) ) (!  (=> (and (select g_1 n_55@@0) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.5734:21|
 :skolemid |618|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@8) n_55@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55@@0 next))
)) (and (=> (= (ControlFlow 0 77) (- 0 82)) (forall ((n_55@@1 T@Ref) (n_55_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_55@@1 n_55_1)) (select g_1 n_55@@1)) (select g_1 n_55_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_55@@1 n_55_1)))
 :qid |stdinbpl.5741:21|
 :skolemid |619|
 :pattern ( (neverTriggered72 n_55@@1) (neverTriggered72 n_55_1))
))) (=> (forall ((n_55@@2 T@Ref) (n_55_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_55@@2 n_55_1@@0)) (select g_1 n_55@@2)) (select g_1 n_55_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_55@@2 n_55_1@@0)))
 :qid |stdinbpl.5741:21|
 :skolemid |619|
 :pattern ( (neverTriggered72 n_55@@2) (neverTriggered72 n_55_1@@0))
)) (and (=> (= (ControlFlow 0 77) (- 0 81)) (forall ((n_55@@3 T@Ref) ) (!  (=> (select g_1 n_55@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) n_55@@3 next) NoPerm)))
 :qid |stdinbpl.5748:21|
 :skolemid |620|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@8) n_55@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55@@3 next))
))) (=> (forall ((n_55@@4 T@Ref) ) (!  (=> (select g_1 n_55@@4) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) n_55@@4 next) NoPerm)))
 :qid |stdinbpl.5748:21|
 :skolemid |620|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55@@4 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@8) n_55@@4 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55@@4 next))
)) (=> (and (forall ((n_55@@5 T@Ref) ) (!  (=> (and (select g_1 n_55@@5) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange72 n_55@@5) (= (invRecv72 n_55@@5) n_55@@5)))
 :qid |stdinbpl.5754:26|
 :skolemid |621|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55@@5 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@8) n_55@@5 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_55@@5 next))
)) (forall ((o_4@@125 T@Ref) ) (!  (=> (and (select g_1 (invRecv72 o_4@@125)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange72 o_4@@125))) (= (invRecv72 o_4@@125) o_4@@125))
 :qid |stdinbpl.5758:26|
 :skolemid |622|
 :pattern ( (invRecv72 o_4@@125))
))) (and (=> (= (ControlFlow 0 77) (- 0 80)) (forall ((n_56 T@Ref) ) (!  (=> (and (select (|Set#Singleton_49733| new_node@0) n_56) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.5766:21|
 :skolemid |623|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@9) n_56 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56 next))
))) (=> (forall ((n_56@@0 T@Ref) ) (!  (=> (and (select (|Set#Singleton_49733| new_node@0) n_56@@0) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.5766:21|
 :skolemid |623|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@9) n_56@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56@@0 next))
)) (and (=> (= (ControlFlow 0 77) (- 0 79)) (forall ((n_56@@1 T@Ref) (n_56_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_56@@1 n_56_1)) (select (|Set#Singleton_49733| new_node@0) n_56@@1)) (select (|Set#Singleton_49733| new_node@0) n_56_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_56@@1 n_56_1)))
 :qid |stdinbpl.5773:21|
 :skolemid |624|
 :pattern ( (neverTriggered73 n_56@@1) (neverTriggered73 n_56_1))
))) (=> (forall ((n_56@@2 T@Ref) (n_56_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_56@@2 n_56_1@@0)) (select (|Set#Singleton_49733| new_node@0) n_56@@2)) (select (|Set#Singleton_49733| new_node@0) n_56_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_56@@2 n_56_1@@0)))
 :qid |stdinbpl.5773:21|
 :skolemid |624|
 :pattern ( (neverTriggered73 n_56@@2) (neverTriggered73 n_56_1@@0))
)) (and (=> (= (ControlFlow 0 77) (- 0 78)) (forall ((n_56@@3 T@Ref) ) (!  (=> (select (|Set#Singleton_49733| new_node@0) n_56@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) n_56@@3 next) NoPerm)))
 :qid |stdinbpl.5780:21|
 :skolemid |625|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@9) n_56@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56@@3 next))
))) (=> (forall ((n_56@@4 T@Ref) ) (!  (=> (select (|Set#Singleton_49733| new_node@0) n_56@@4) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) n_56@@4 next) NoPerm)))
 :qid |stdinbpl.5780:21|
 :skolemid |625|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56@@4 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@9) n_56@@4 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56@@4 next))
)) (=> (forall ((n_56@@5 T@Ref) ) (!  (=> (and (select (|Set#Singleton_49733| new_node@0) n_56@@5) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange73 n_56@@5) (= (invRecv73 n_56@@5) n_56@@5)))
 :qid |stdinbpl.5786:26|
 :skolemid |626|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56@@5 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@9) n_56@@5 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_56@@5 next))
)) (=> (and (forall ((o_4@@126 T@Ref) ) (!  (=> (and (select (|Set#Singleton_49733| new_node@0) (invRecv73 o_4@@126)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange73 o_4@@126))) (= (invRecv73 o_4@@126) o_4@@126))
 :qid |stdinbpl.5790:26|
 :skolemid |627|
 :pattern ( (invRecv73 o_4@@126))
...
(let ((anon368_Else_correct  (=> (and (and (not (and (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next) start@@1) (< x@@14 (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) start@@1 val)))) (state ExhaleHeap@0 QPMask@7)) (and (= new_start@0 start@@1) (= (ControlFlow 0 263) 261))) anon178_correct)))
(let ((anon368_Then_correct  (=> (and (and (and (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next) start@@1) (< x@@14 (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) start@@1 val))) (state ExhaleHeap@0 QPMask@7)) (and (= new_start@0 new_node@0) (= (ControlFlow 0 262) 261))) anon178_correct)))
(let ((anon367_Else_correct  (=> (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next) start@@1)) (and (=> (= (ControlFlow 0 266) 262) anon368_Then_correct) (=> (= (ControlFlow 0 266) 263) anon368_Else_correct)))))
(let ((anon367_Then_correct  (=> (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next) start@@1) (and (=> (= (ControlFlow 0 264) (- 0 265)) (HasDirectPerm_48852_6878 QPMask@7 start@@1 val)) (=> (HasDirectPerm_48852_6878 QPMask@7 start@@1 val) (and (=> (= (ControlFlow 0 264) 262) anon368_Then_correct) (=> (= (ControlFlow 0 264) 263) anon368_Else_correct)))))))
(let ((anon349_Else_correct  (=> (or (and (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) node@0 val) x@@14) (< x@@14 (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next) val))) (and (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) node@0 next) start@@1) (or (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) node@0 val) x@@14) (< x@@14 (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) start@@1 val))))) (=> (and (state ExhaleHeap@0 QPMask@3) (not (select g_1 null))) (and (=> (= (ControlFlow 0 267) (- 0 270)) (forall ((n$3_5 T@Ref) (n$3_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_5 n$3_5_1)) (select g_1 n$3_5)) (select g_1 n$3_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_5 n$3_5_1)))
 :qid |stdinbpl.5605:17|
 :skolemid |600|
))) (=> (forall ((n$3_5@@0 T@Ref) (n$3_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_5@@0 n$3_5_1@@0)) (select g_1 n$3_5@@0)) (select g_1 n$3_5_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_5@@0 n$3_5_1@@0)))
 :qid |stdinbpl.5605:17|
 :skolemid |600|
)) (=> (and (and (forall ((n$3_5@@1 T@Ref) ) (!  (=> (and (select g_1 n$3_5@@1) (< NoPerm FullPerm)) (and (qpRange70 n$3_5@@1) (= (invRecv70 n$3_5@@1) n$3_5@@1)))
 :qid |stdinbpl.5611:24|
 :skolemid |601|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) n$3_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_5@@1 next))
)) (forall ((o_4@@127 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv70 o_4@@127)) (< NoPerm FullPerm)) (qpRange70 o_4@@127)) (= (invRecv70 o_4@@127) o_4@@127))
 :qid |stdinbpl.5615:24|
 :skolemid |602|
 :pattern ( (invRecv70 o_4@@127))
))) (and (forall ((n$3_5@@2 T@Ref) ) (!  (=> (select g_1 n$3_5@@2) (not (= n$3_5@@2 null)))
 :qid |stdinbpl.5621:24|
 :skolemid |603|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_5@@2 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) n$3_5@@2 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$3_5@@2 next))
)) (forall ((o_4@@128 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv70 o_4@@128)) (< NoPerm FullPerm)) (qpRange70 o_4@@128)) (and (=> (< NoPerm FullPerm) (= (invRecv70 o_4@@128) o_4@@128)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) o_4@@128 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) o_4@@128 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv70 o_4@@128)) (< NoPerm FullPerm)) (qpRange70 o_4@@128))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) o_4@@128 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) o_4@@128 next))))
 :qid |stdinbpl.5627:24|
 :skolemid |604|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) o_4@@128 next))
)))) (=> (and (and (and (and (and (and (and (forall ((o_4@@129 T@Ref) (f_5@@89 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@3) o_4@@129 f_5@@89) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@6) o_4@@129 f_5@@89)))
 :qid |stdinbpl.5631:31|
 :skolemid |605|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@3) o_4@@129 f_5@@89))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@6) o_4@@129 f_5@@89))
)) (forall ((o_4@@130 T@Ref) (f_5@@90 T@Field_74000_74001) ) (!  (=> (not (= f_5@@90 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) o_4@@130 f_5@@90) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) o_4@@130 f_5@@90)))
 :qid |stdinbpl.5631:31|
 :skolemid |605|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) o_4@@130 f_5@@90))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) o_4@@130 f_5@@90))
))) (forall ((o_4@@131 T@Ref) (f_5@@91 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) o_4@@131 f_5@@91) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@6) o_4@@131 f_5@@91)))
 :qid |stdinbpl.5631:31|
 :skolemid |605|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) o_4@@131 f_5@@91))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@6) o_4@@131 f_5@@91))
))) (forall ((o_4@@132 T@Ref) (f_5@@92 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@3) o_4@@132 f_5@@92) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@6) o_4@@132 f_5@@92)))
 :qid |stdinbpl.5631:31|
 :skolemid |605|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@3) o_4@@132 f_5@@92))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@6) o_4@@132 f_5@@92))
))) (forall ((o_4@@133 T@Ref) (f_5@@93 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@3) o_4@@133 f_5@@93) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@6) o_4@@133 f_5@@93)))
 :qid |stdinbpl.5631:31|
 :skolemid |605|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@3) o_4@@133 f_5@@93))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@6) o_4@@133 f_5@@93))
))) (state ExhaleHeap@0 QPMask@6)) (and (forall ((n$4_7 T@Ref) ) (!  (=> (select g_1 n$4_7) (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_7 next)))
 :qid |stdinbpl.5637:22|
 :skolemid |606|
 :pattern ( (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_7 next)))
 :pattern ( (select g_1 n$4_7) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n$4_7 next))
...
))))) (and (=> (= (ControlFlow 0 267) (- 0 269)) (forall ((n_52 T@Ref) (n_52_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_52 n_52_1)) (select g_1 n_52)) (select g_1 n_52_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_52 n_52_1)))
 :qid |stdinbpl.5657:17|
 :skolemid |610|
))) (=> (forall ((n_52@@0 T@Ref) (n_52_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_52@@0 n_52_1@@0)) (select g_1 n_52@@0)) (select g_1 n_52_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_52@@0 n_52_1@@0)))
 :qid |stdinbpl.5657:17|
 :skolemid |610|
)) (=> (and (and (forall ((n_52@@1 T@Ref) ) (!  (=> (and (select g_1 n_52@@1) (< NoPerm FullPerm)) (and (qpRange71 n_52@@1) (= (invRecv71 n_52@@1) n_52@@1)))
 :qid |stdinbpl.5663:24|
 :skolemid |611|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_52@@1 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@7) n_52@@1 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_52@@1 val))
)) (forall ((o_4@@134 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv71 o_4@@134)) (< NoPerm FullPerm)) (qpRange71 o_4@@134)) (= (invRecv71 o_4@@134) o_4@@134))
 :qid |stdinbpl.5667:24|
 :skolemid |612|
 :pattern ( (invRecv71 o_4@@134))
))) (and (forall ((n_52@@2 T@Ref) ) (!  (=> (select g_1 n_52@@2) (not (= n_52@@2 null)))
 :qid |stdinbpl.5673:24|
 :skolemid |613|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_52@@2 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@7) n_52@@2 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_52@@2 val))
)) (forall ((o_4@@135 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv71 o_4@@135)) (< NoPerm FullPerm)) (qpRange71 o_4@@135)) (and (=> (< NoPerm FullPerm) (= (invRecv71 o_4@@135) o_4@@135)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@7) o_4@@135 val) (+ (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@6) o_4@@135 val) FullPerm)))) (=> (not (and (and (select g_1 (invRecv71 o_4@@135)) (< NoPerm FullPerm)) (qpRange71 o_4@@135))) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@7) o_4@@135 val) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@6) o_4@@135 val))))
 :qid |stdinbpl.5679:24|
 :skolemid |614|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@7) o_4@@135 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@136 T@Ref) (f_5@@94 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@6) o_4@@136 f_5@@94) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@7) o_4@@136 f_5@@94)))
 :qid |stdinbpl.5683:31|
 :skolemid |615|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@6) o_4@@136 f_5@@94))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@7) o_4@@136 f_5@@94))
)) (forall ((o_4@@137 T@Ref) (f_5@@95 T@Field_74000_74001) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) o_4@@137 f_5@@95) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) o_4@@137 f_5@@95)))
 :qid |stdinbpl.5683:31|
 :skolemid |615|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) o_4@@137 f_5@@95))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) o_4@@137 f_5@@95))
))) (forall ((o_4@@138 T@Ref) (f_5@@96 T@Field_83161_6878) ) (!  (=> (not (= f_5@@96 val)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@6) o_4@@138 f_5@@96) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@7) o_4@@138 f_5@@96)))
 :qid |stdinbpl.5683:31|
 :skolemid |615|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@6) o_4@@138 f_5@@96))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@7) o_4@@138 f_5@@96))
))) (forall ((o_4@@139 T@Ref) (f_5@@97 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@6) o_4@@139 f_5@@97) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@7) o_4@@139 f_5@@97)))
 :qid |stdinbpl.5683:31|
 :skolemid |615|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@6) o_4@@139 f_5@@97))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@7) o_4@@139 f_5@@97))
))) (forall ((o_4@@140 T@Ref) (f_5@@98 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@6) o_4@@140 f_5@@98) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@7) o_4@@140 f_5@@98)))
 :qid |stdinbpl.5683:31|
 :skolemid |615|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@6) o_4@@140 f_5@@98))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@7) o_4@@140 f_5@@98))
))) (state ExhaleHeap@0 QPMask@7)) (and (and (forall ((n_53_1 T@Ref) ) (!  (=> (and (select g_1 n_53_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_53_1 next) start@@1))) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) n_53_1 val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| ExhaleHeap@0) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| ExhaleHeap@0) n_53_1 next) val)))
...
(let ((anon327_Else_correct  (=> (and (not (and (select g_1 n_30_1) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_30_1 next) start@@1))) (= (ControlFlow 0 75) 72)) anon100_correct)))
(let ((anon327_Then_correct  (=> (and (select g_1 n_30_1) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_30_1 next) start@@1)) (and (=> (= (ControlFlow 0 73) (- 0 74)) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_30_1 next) val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_30_1 val))) (=> (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_30_1 next) val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_30_1 val)) (=> (= (ControlFlow 0 73) 72) anon100_correct))))))
(let ((anon324_Else_correct  (=> (forall ((n_29_1_1 T@Ref) ) (!  (=> (and (select g_1 n_29_1_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_29_1_1 next) start@@1))) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_29_1_1 val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_29_1_1 next) val)))
...
(let ((anon325_Else_correct  (=> (and (not (and (select g_1 n_28_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_28_1 next) start@@1)))) (= (ControlFlow 0 71) 68)) anon96_correct)))
(let ((anon325_Then_correct  (=> (and (select g_1 n_28_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_28_1 next) start@@1))) (and (=> (= (ControlFlow 0 69) (- 0 70)) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_28_1 val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_28_1 next) val))) (=> (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_28_1 val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_28_1 next) val)) (=> (= (ControlFlow 0 69) 68) anon96_correct))))))
(let ((anon322_Else_correct  (=> (forall ((n_26_1_1 T@Ref) (m_7_1 T@Ref) ) (!  (=> (and (select g_1 n_26_1_1) (select g_1 m_7_1)) (and (exists_path ($$ Heap@@32 g_1) n_26_1_1 m_7_1) (exists_path ($$ Heap@@32 g_1) m_7_1 n_26_1_1)))
...
)) (and (=> (= (ControlFlow 0 390) (- 0 392)) (forall ((n_27_1 T@Ref) (n_27_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_27_1 n_27_2)) (select g_1 n_27_1)) (select g_1 n_27_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_27_1 n_27_2)))
 :qid |stdinbpl.4951:21|
 :skolemid |528|
 :pattern ( (neverTriggered61 n_27_1) (neverTriggered61 n_27_2))
 ...
 :qid |stdinbpl.4951:21|
 :skolemid |528|
 :pattern ( (neverTriggered61 n_27_1@@0) (neverTriggered61 n_27_2@@0))
)) (and (=> (= (ControlFlow 0 390) (- 0 391)) (forall ((n_27_1@@1 T@Ref) ) (!  (=> (select g_1 n_27_1@@1) (>= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@2) n_27_1@@1 val) FullPerm))
 :qid |stdinbpl.4958:21|
 :skolemid |529|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_27_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) n_27_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_27_1@@1 val))
))) (=> (forall ((n_27_1@@2 T@Ref) ) (!  (=> (select g_1 n_27_1@@2) (>= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@2) n_27_1@@2 val) FullPerm))
 :qid |stdinbpl.4958:21|
 :skolemid |529|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_27_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) n_27_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_27_1@@2 val))
)) (=> (forall ((n_27_1@@3 T@Ref) ) (!  (=> (and (select g_1 n_27_1@@3) (< NoPerm FullPerm)) (and (qpRange61 n_27_1@@3) (= (invRecv61 n_27_1@@3) n_27_1@@3)))
 :qid |stdinbpl.4964:26|
 :skolemid |530|
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_27_1@@3 val))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) n_27_1@@3 val))
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_27_1@@3 val))
)) (=> (and (forall ((o_4@@141 T@Ref) ) (!  (=> (and (select g_1 (invRecv61 o_4@@141)) (and (< NoPerm FullPerm) (qpRange61 o_4@@141))) (= (invRecv61 o_4@@141) o_4@@141))
 :qid |stdinbpl.4968:26|
 :skolemid |531|
 :pattern ( (invRecv61 o_4@@141))
)) (forall ((o_4@@142 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv61 o_4@@142)) (and (< NoPerm FullPerm) (qpRange61 o_4@@142))) (and (= (invRecv61 o_4@@142) o_4@@142) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) o_4@@142 val) (- (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@2) o_4@@142 val) FullPerm)))) (=> (not (and (select g_1 (invRecv61 o_4@@142)) (and (< NoPerm FullPerm) (qpRange61 o_4@@142)))) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) o_4@@142 val) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@2) o_4@@142 val))))
 :qid |stdinbpl.4974:26|
 :skolemid |532|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) o_4@@142 val))
))) (=> (and (and (and (and (forall ((o_4@@143 T@Ref) (f_5@@99 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@2) o_4@@143 f_5@@99) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@3) o_4@@143 f_5@@99)))
 :qid |stdinbpl.4980:33|
 :skolemid |533|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@3) o_4@@143 f_5@@99))
)) (forall ((o_4@@144 T@Ref) (f_5@@100 T@Field_74000_74001) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) o_4@@144 f_5@@100) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) o_4@@144 f_5@@100)))
 :qid |stdinbpl.4980:33|
 :skolemid |533|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) o_4@@144 f_5@@100))
))) (forall ((o_4@@145 T@Ref) (f_5@@101 T@Field_83161_6878) ) (!  (=> (not (= f_5@@101 val)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@2) o_4@@145 f_5@@101) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) o_4@@145 f_5@@101)))
 :qid |stdinbpl.4980:33|
 :skolemid |533|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@3) o_4@@145 f_5@@101))
))) (forall ((o_4@@146 T@Ref) (f_5@@102 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@2) o_4@@146 f_5@@102) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@3) o_4@@146 f_5@@102)))
 :qid |stdinbpl.4980:33|
 :skolemid |533|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@3) o_4@@146 f_5@@102))
))) (forall ((o_4@@147 T@Ref) (f_5@@103 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@2) o_4@@147 f_5@@103) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@3) o_4@@147 f_5@@103)))
 :qid |stdinbpl.4980:33|
 :skolemid |533|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@3) o_4@@147 f_5@@103))
...
(let ((anon323_Else_correct  (=> (and (not (and (select g_1 n_25_1) (select g_1 m_6_1))) (= (ControlFlow 0 67) 63)) anon92_correct)))
(let ((anon323_Then_correct  (=> (and (select g_1 n_25_1) (select g_1 m_6_1)) (and (=> (= (ControlFlow 0 64) (- 0 66)) (exists_path ($$ Heap@@32 g_1) n_25_1 m_6_1)) (=> (exists_path ($$ Heap@@32 g_1) n_25_1 m_6_1) (and (=> (= (ControlFlow 0 64) (- 0 65)) (exists_path ($$ Heap@@32 g_1) m_6_1 n_25_1)) (=> (exists_path ($$ Heap@@32 g_1) m_6_1 n_25_1) (=> (= (ControlFlow 0 64) 63) anon92_correct))))))))
...
)) (and (=> (= (ControlFlow 0 393) (- 0 394)) (select g_1 start@@1)) (=> (select g_1 start@@1) (and (and (=> (= (ControlFlow 0 393) 390) anon322_Else_correct) (=> (= (ControlFlow 0 393) 64) anon323_Then_correct)) (=> (= (ControlFlow 0 393) 67) anon323_Else_correct)))))))
...
(let ((anon315_Else_correct  (=> (forall ((n$4_1_1 T@Ref) ) (!  (=> (select g_1 n$4_1_1) (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$4_1_1 next)))
 :qid |stdinbpl.4901:24|
 :skolemid |524|
 :pattern ( (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$4_1_1 next)))
 :pattern ( (select g_1 n$4_1_1) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$4_1_1 next))
...
(let ((anon316_Else_correct  (=> (and (not (select g_1 n$4)) (= (ControlFlow 0 52) 49)) anon79_correct)))
(let ((anon316_Then_correct  (=> (select g_1 n$4) (and (=> (= (ControlFlow 0 50) (- 0 51)) (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$4 next))) (=> (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$4 next)) (=> (= (ControlFlow 0 50) 49) anon79_correct))))))
(let ((anon294_Else_correct  (=> (select (|PolymorphicMapType_73927_47953_53#PolymorphicMapType_73927| Heap@@32) node $allocated) (=> (and (not (select g_1 new_node@0)) (|Set#Equal_49043| new_g@0 (|Set#Union_49040| g_1 (|Set#Singleton_49733| new_node@0)))) (=> (and (and (not (= new_node@0 null)) (= Mask@0 (PolymorphicMapType_73948 (store (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) new_node@0 next (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) new_node@0 next) FullPerm)) (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@1) (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@1) (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@1) (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@1)))) (and (state Heap@@32 Mask@0) (not (= new_node@0 null)))) (=> (and (and (and (= Mask@1 (PolymorphicMapType_73948 (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@0) (store (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@0) new_node@0 val (+ (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@0) new_node@0 val) FullPerm)) (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@0) (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@0) (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@0))) (state Heap@@32 Mask@1)) (and (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) new_node@0 next) null) (= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) new_node@0 val) x@@14))) (and (and (state Heap@@32 Mask@1) (select (|PolymorphicMapType_73927_47953_53#PolymorphicMapType_73927| Heap@@32) new_node@0 $allocated)) (and (state Heap@@32 Mask@1) (state Heap@@32 Mask@1)))) (and (=> (= (ControlFlow 0 397) (- 0 400)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 397) (- 0 399)) (forall ((n$3 T@Ref) (n$3_9 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3 n$3_9)) (select g_1 n$3)) (select g_1 n$3_9)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3 n$3_9)))
 :qid |stdinbpl.4860:21|
 :skolemid |518|
 :pattern ( (neverTriggered60 n$3) (neverTriggered60 n$3_9))
))) (=> (forall ((n$3@@0 T@Ref) (n$3_9@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3@@0 n$3_9@@0)) (select g_1 n$3@@0)) (select g_1 n$3_9@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3@@0 n$3_9@@0)))
 :qid |stdinbpl.4860:21|
 :skolemid |518|
 :pattern ( (neverTriggered60 n$3@@0) (neverTriggered60 n$3_9@@0))
)) (and (=> (= (ControlFlow 0 397) (- 0 398)) (forall ((n$3@@1 T@Ref) ) (!  (=> (select g_1 n$3@@1) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@1) n$3@@1 next) FullPerm))
 :qid |stdinbpl.4867:21|
 :skolemid |519|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$3@@1 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) n$3@@1 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$3@@1 next))
))) (=> (forall ((n$3@@2 T@Ref) ) (!  (=> (select g_1 n$3@@2) (>= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@1) n$3@@2 next) FullPerm))
 :qid |stdinbpl.4867:21|
 :skolemid |519|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$3@@2 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) n$3@@2 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$3@@2 next))
)) (=> (forall ((n$3@@3 T@Ref) ) (!  (=> (and (select g_1 n$3@@3) (< NoPerm FullPerm)) (and (qpRange60 n$3@@3) (= (invRecv60 n$3@@3) n$3@@3)))
 :qid |stdinbpl.4873:26|
 :skolemid |520|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$3@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) n$3@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$3@@3 next))
)) (=> (and (forall ((o_4@@148 T@Ref) ) (!  (=> (and (select g_1 (invRecv60 o_4@@148)) (and (< NoPerm FullPerm) (qpRange60 o_4@@148))) (= (invRecv60 o_4@@148) o_4@@148))
 :qid |stdinbpl.4877:26|
 :skolemid |521|
 :pattern ( (invRecv60 o_4@@148))
)) (forall ((o_4@@149 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv60 o_4@@149)) (and (< NoPerm FullPerm) (qpRange60 o_4@@149))) (and (= (invRecv60 o_4@@149) o_4@@149) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) o_4@@149 next) (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@1) o_4@@149 next) FullPerm)))) (=> (not (and (select g_1 (invRecv60 o_4@@149)) (and (< NoPerm FullPerm) (qpRange60 o_4@@149)))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) o_4@@149 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@1) o_4@@149 next))))
 :qid |stdinbpl.4883:26|
 :skolemid |522|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) o_4@@149 next))
))) (=> (and (and (and (and (forall ((o_4@@150 T@Ref) (f_5@@104 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| Mask@1) o_4@@150 f_5@@104) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@2) o_4@@150 f_5@@104)))
 :qid |stdinbpl.4889:33|
 :skolemid |523|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@2) o_4@@150 f_5@@104))
)) (forall ((o_4@@151 T@Ref) (f_5@@105 T@Field_74000_74001) ) (!  (=> (not (= f_5@@105 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@1) o_4@@151 f_5@@105) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) o_4@@151 f_5@@105)))
 :qid |stdinbpl.4889:33|
 :skolemid |523|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) o_4@@151 f_5@@105))
))) (forall ((o_4@@152 T@Ref) (f_5@@106 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| Mask@1) o_4@@152 f_5@@106) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@2) o_4@@152 f_5@@106)))
 :qid |stdinbpl.4889:33|
 :skolemid |523|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@2) o_4@@152 f_5@@106))
))) (forall ((o_4@@153 T@Ref) (f_5@@107 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| Mask@1) o_4@@153 f_5@@107) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@2) o_4@@153 f_5@@107)))
 :qid |stdinbpl.4889:33|
 :skolemid |523|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@2) o_4@@153 f_5@@107))
))) (forall ((o_4@@154 T@Ref) (f_5@@108 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| Mask@1) o_4@@154 f_5@@108) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@2) o_4@@154 f_5@@108)))
 :qid |stdinbpl.4889:33|
 :skolemid |523|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@2) o_4@@154 f_5@@108))
...
(let ((anon293_Else_correct  (=> (and (not (and (select g_1 n_35) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_35 next) start@@1))) (= (ControlFlow 0 45) 40)) anon36_correct)))
(let ((anon293_Then_correct  (=> (and (select g_1 n_35) (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_35 next) start@@1)) (and (=> (= (ControlFlow 0 41) (- 0 44)) (HasDirectPerm_48849_48850 QPMask@1 n_35 next)) (=> (HasDirectPerm_48849_48850 QPMask@1 n_35 next) (and (=> (= (ControlFlow 0 41) (- 0 43)) (HasDirectPerm_48852_6878 QPMask@1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_35 next) val)) (=> (HasDirectPerm_48852_6878 QPMask@1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_35 next) val) (and (=> (= (ControlFlow 0 41) (- 0 42)) (HasDirectPerm_48852_6878 QPMask@1 n_35 val)) (=> (HasDirectPerm_48852_6878 QPMask@1 n_35 val) (=> (= (ControlFlow 0 41) 40) anon36_correct))))))))))
(let ((anon292_Else_correct  (=> (not (select g_1 n_35)) (and (=> (= (ControlFlow 0 48) 41) anon293_Then_correct) (=> (= (ControlFlow 0 48) 45) anon293_Else_correct)))))
(let ((anon292_Then_correct  (=> (select g_1 n_35) (and (=> (= (ControlFlow 0 46) (- 0 47)) (HasDirectPerm_48849_48850 QPMask@1 n_35 next)) (=> (HasDirectPerm_48849_48850 QPMask@1 n_35 next) (and (=> (= (ControlFlow 0 46) 41) anon293_Then_correct) (=> (= (ControlFlow 0 46) 45) anon293_Else_correct)))))))
(let ((anon288_Else_correct  (=> (and (forall ((n_7 T@Ref) ) (!  (=> (and (select g_1 n_7) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_7 next) start@@1))) (<= (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_7 val) (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_7 next) val)))
...
(let ((anon290_Else_correct  (=> (and (not (and (select g_1 n_60) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_60 next) start@@1)))) (= (ControlFlow 0 36) 31)) anon30_correct)))
(let ((anon290_Then_correct  (=> (and (select g_1 n_60) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_60 next) start@@1))) (and (=> (= (ControlFlow 0 32) (- 0 35)) (HasDirectPerm_48852_6878 QPMask@1 n_60 val)) (=> (HasDirectPerm_48852_6878 QPMask@1 n_60 val) (and (=> (= (ControlFlow 0 32) (- 0 34)) (HasDirectPerm_48849_48850 QPMask@1 n_60 next)) (=> (HasDirectPerm_48849_48850 QPMask@1 n_60 next) (and (=> (= (ControlFlow 0 32) (- 0 33)) (HasDirectPerm_48852_6878 QPMask@1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_60 next) val)) (=> (HasDirectPerm_48852_6878 QPMask@1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_60 next) val) (=> (= (ControlFlow 0 32) 31) anon30_correct))))))))))
(let ((anon289_Else_correct  (=> (not (select g_1 n_60)) (and (=> (= (ControlFlow 0 39) 32) anon290_Then_correct) (=> (= (ControlFlow 0 39) 36) anon290_Else_correct)))))
(let ((anon289_Then_correct  (=> (select g_1 n_60) (and (=> (= (ControlFlow 0 37) (- 0 38)) (HasDirectPerm_48849_48850 QPMask@1 n_60 next)) (=> (HasDirectPerm_48849_48850 QPMask@1 n_60 next) (and (=> (= (ControlFlow 0 37) 32) anon290_Then_correct) (=> (= (ControlFlow 0 37) 36) anon290_Else_correct)))))))
(let ((anon287_Else_correct  (and (=> (= (ControlFlow 0 463) (- 0 464)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select g_1 n_5)) (select g_1 n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_5@@1 val))
)) (forall ((o_4@@155 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv53 o_4@@155)) (< NoPerm FullPerm)) (qpRange53 o_4@@155)) (= (invRecv53 o_4@@155) o_4@@155))
 :qid |stdinbpl.4450:22|
 :skolemid |484|
 :pattern ( (invRecv53 o_4@@155))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_48852_6878#PolymorphicMapType_73927| Heap@@32) n_5@@2 val))
)) (forall ((o_4@@156 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv53 o_4@@156)) (< NoPerm FullPerm)) (qpRange53 o_4@@156)) (and (=> (< NoPerm FullPerm) (= (invRecv53 o_4@@156) o_4@@156)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@1) o_4@@156 val) (+ (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@0) o_4@@156 val) FullPerm)))) (=> (not (and (and (select g_1 (invRecv53 o_4@@156)) (< NoPerm FullPerm)) (qpRange53 o_4@@156))) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@1) o_4@@156 val) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@0) o_4@@156 val))))
 :qid |stdinbpl.4462:22|
 :skolemid |486|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@1) o_4@@156 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@157 T@Ref) (f_5@@109 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@0) o_4@@157 f_5@@109) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@1) o_4@@157 f_5@@109)))
 :qid |stdinbpl.4466:29|
 :skolemid |487|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@0) o_4@@157 f_5@@109))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@1) o_4@@157 f_5@@109))
)) (forall ((o_4@@158 T@Ref) (f_5@@110 T@Field_74000_74001) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@158 f_5@@110) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_4@@158 f_5@@110)))
 :qid |stdinbpl.4466:29|
 :skolemid |487|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@158 f_5@@110))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_4@@158 f_5@@110))
))) (forall ((o_4@@159 T@Ref) (f_5@@111 T@Field_83161_6878) ) (!  (=> (not (= f_5@@111 val)) (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@0) o_4@@159 f_5@@111) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@1) o_4@@159 f_5@@111)))
 :qid |stdinbpl.4466:29|
 :skolemid |487|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@0) o_4@@159 f_5@@111))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@1) o_4@@159 f_5@@111))
))) (forall ((o_4@@160 T@Ref) (f_5@@112 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@0) o_4@@160 f_5@@112) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@1) o_4@@160 f_5@@112)))
 :qid |stdinbpl.4466:29|
 :skolemid |487|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@0) o_4@@160 f_5@@112))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@1) o_4@@160 f_5@@112))
))) (forall ((o_4@@161 T@Ref) (f_5@@113 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@0) o_4@@161 f_5@@113) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@1) o_4@@161 f_5@@113)))
 :qid |stdinbpl.4466:29|
 :skolemid |487|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@0) o_4@@161 f_5@@113))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@1) o_4@@161 f_5@@113))
...
(let ((anon282_Else_correct  (=> (and (forall ((n_3 T@Ref) (m_1_1 T@Ref) ) (!  (=> (and (select g_1 n_3) (select g_1 m_1_1)) (and (exists_path ($$ Heap@@32 g_1) n_3 m_1_1) (exists_path ($$ Heap@@32 g_1) m_1_1 n_3)))
...
(let ((anon286_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((n$0_3_2 T@Ref) ) (!  (=> (and (select g_1 n$0_3_2) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_3_2 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4389:27|
 :skolemid |476|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_3_2 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@33) n$0_3_2 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_3_2 next))
 ...
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@33) n$0_3_2@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_3_2@@0 next))
 ...
 :skolemid |477|
 :pattern ( (neverTriggered52 n$0_3_2@@1) (neverTriggered52 n$0_3_3))
 ...
 :qid |stdinbpl.4396:27|
 :skolemid |477|
 :pattern ( (neverTriggered52 n$0_3_2@@2) (neverTriggered52 n$0_3_3@@0))
 ...
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@33) n$0_3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_3_2@@3 next))
)))))))))
(let ((anon284_Then_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((n$0_2_1 T@Ref) ) (!  (=> (and (select g_1 n$0_2_1) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_2_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4345:25|
 :skolemid |471|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_2_1 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@32) n$0_2_1 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_2_1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@32) n$0_2_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_2_1@@0 next))
 ...
 :skolemid |472|
 :pattern ( (neverTriggered51 n$0_2_1@@1) (neverTriggered51 n$0_2_2))
 ...
 :qid |stdinbpl.4352:25|
 :skolemid |472|
 :pattern ( (neverTriggered51 n$0_2_1@@2) (neverTriggered51 n$0_2_2@@0))
 ...
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@32) n$0_2_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_2_1@@3 next))
)))))))))
(let ((anon22_correct true))
(let ((anon285_Then_correct  (=> (exists_path ($$ Heap@@32 g_1) n_59 m_8) (and (=> (= (ControlFlow 0 28) 25) anon286_Then_correct) (=> (= (ControlFlow 0 28) 17) anon22_correct)))))
(let ((anon285_Else_correct  (=> (and (not (exists_path ($$ Heap@@32 g_1) n_59 m_8)) (= (ControlFlow 0 23) 17)) anon22_correct)))
(let ((anon283_Then_correct  (=> (and (select g_1 n_59) (select g_1 m_8)) (and (and (=> (= (ControlFlow 0 29) 20) anon284_Then_correct) (=> (= (ControlFlow 0 29) 28) anon285_Then_correct)) (=> (= (ControlFlow 0 29) 23) anon285_Else_correct)))))
(let ((anon283_Else_correct  (=> (and (not (and (select g_1 n_59) (select g_1 m_8))) (= (ControlFlow 0 18) 17)) anon22_correct)))
...
)) (=> (and (and (state Heap@@32 QPMask@0) (select g_1 start@@1)) (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0))) (and (and (=> (= (ControlFlow 0 466) 465) anon282_Else_correct) (=> (= (ControlFlow 0 466) 29) anon283_Then_correct)) (=> (= (ControlFlow 0 466) 18) anon283_Else_correct))))))
...
(let ((anon279_Else_correct  (=> (and (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) v1_31 next) v_34)) (= (ControlFlow 0 10) 6)) anon10_correct)))
(let ((anon279_Then_correct  (=> (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) v1_31 next) v_34) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_48849_48850 QPMask@0 v2_31 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 v2_31 next) (=> (= (ControlFlow 0 8) 6) anon10_correct))))))
(let ((anon278_Then_correct  (=> (and (select g_1 v1_31) (and (select g_1 v2_31) (select g_1 v_34))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_48849_48850 QPMask@0 v1_31 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 v1_31 next) (and (=> (= (ControlFlow 0 11) 8) anon279_Then_correct) (=> (= (ControlFlow 0 11) 10) anon279_Else_correct)))))))
(let ((anon278_Else_correct  (=> (and (not (and (select g_1 v1_31) (and (select g_1 v2_31) (select g_1 v_34)))) (= (ControlFlow 0 7) 6)) anon10_correct)))
...
(let ((anon276_Else_correct  (=> (and (not (select g_1 n$0_38)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon276_Then_correct  (=> (select g_1 n$0_38) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_48849_48850 QPMask@0 n$0_38 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 n$0_38 next) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon274_Else_correct  (and (=> (= (ControlFlow 0 469) (- 0 470)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_1@@1 next))
)) (forall ((o_4@@162 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv50 o_4@@162)) (< NoPerm FullPerm)) (qpRange50 o_4@@162)) (= (invRecv50 o_4@@162) o_4@@162))
 :qid |stdinbpl.4263:22|
 :skolemid |464|
 :pattern ( (invRecv50 o_4@@162))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_1@@2 next))
)) (forall ((o_4@@163 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv50 o_4@@163)) (< NoPerm FullPerm)) (qpRange50 o_4@@163)) (and (=> (< NoPerm FullPerm) (= (invRecv50 o_4@@163) o_4@@163)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@163 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@163 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv50 o_4@@163)) (< NoPerm FullPerm)) (qpRange50 o_4@@163))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@163 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@163 next))))
 :qid |stdinbpl.4275:22|
 :skolemid |466|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@163 next))
)))) (=> (and (and (and (and (and (forall ((o_4@@164 T@Ref) (f_5@@114 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) o_4@@164 f_5@@114) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@0) o_4@@164 f_5@@114)))
 :qid |stdinbpl.4279:29|
 :skolemid |467|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) o_4@@164 f_5@@114))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@0) o_4@@164 f_5@@114))
)) (forall ((o_4@@165 T@Ref) (f_5@@115 T@Field_74000_74001) ) (!  (=> (not (= f_5@@115 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@165 f_5@@115) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@165 f_5@@115)))
 :qid |stdinbpl.4279:29|
 :skolemid |467|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@165 f_5@@115))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@165 f_5@@115))
))) (forall ((o_4@@166 T@Ref) (f_5@@116 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) o_4@@166 f_5@@116) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@0) o_4@@166 f_5@@116)))
 :qid |stdinbpl.4279:29|
 :skolemid |467|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) o_4@@166 f_5@@116))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@0) o_4@@166 f_5@@116))
))) (forall ((o_4@@167 T@Ref) (f_5@@117 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) o_4@@167 f_5@@117) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@0) o_4@@167 f_5@@117)))
 :qid |stdinbpl.4279:29|
 :skolemid |467|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) o_4@@167 f_5@@117))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@0) o_4@@167 f_5@@117))
))) (forall ((o_4@@168 T@Ref) (f_5@@118 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask) o_4@@168 f_5@@118) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@0) o_4@@168 f_5@@118)))
 :qid |stdinbpl.4279:29|
 :skolemid |467|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask) o_4@@168 f_5@@118))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@0) o_4@@168 f_5@@118))
...
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_73927_47953_53#PolymorphicMapType_73927| Heap@@32) start@@1 $allocated) (not (select g_1 null)))) (and (=> (= (ControlFlow 0 471) 1) anon274_Then_correct) (=> (= (ControlFlow 0 471) 469) anon274_Else_correct))))))
