...
(assert (not
 ...
 :skolemid |199|
 :pattern ( (neverTriggered13 n$0_5) (neverTriggered13 n$0_5_2))
 ...
 :qid |stdinbpl.1711:25|
 :skolemid |199|
 :pattern ( (neverTriggered13 n$0_5@@0) (neverTriggered13 n$0_5_2@@0))
...
(let ((anon19_Then_correct  (=> (select g_1@@15 n_25) (and (=> (= (ControlFlow 0 15) 13) anon20_Then_correct) (=> (= (ControlFlow 0 15) 10) anon12_correct)))))
(let ((anon19_Else_correct  (=> (and (not (select g_1@@15 n_25)) (= (ControlFlow 0 11) 10)) anon12_correct)))
...
(let ((anon17_Else_correct  (=> (and (not (and (select g_1@@15 n$1_13) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_13 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon17_Then_correct  (=> (and (select g_1@@15 n$1_13) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_13 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$1_13 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$1_13 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon16_Else_correct  (=> (not (select g_1@@15 n$1_13)) (and (=> (= (ControlFlow 0 8) 3) anon17_Then_correct) (=> (= (ControlFlow 0 8) 5) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (select g_1@@15 n$1_13) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$1_13 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$1_13 next) (and (=> (= (ControlFlow 0 6) 3) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct)))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((n$0_4 T@Ref) (n$0_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_4 n$0_4_1)) (select g_1@@15 n$0_4)) (select g_1@@15 n$0_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4 n$0_4_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g_1@@15 (invRecv12 o_4)) (< NoPerm FullPerm)) (qpRange12 o_4)) (= (invRecv12 o_4) o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g_1@@15 (invRecv12 o_4@@0)) (< NoPerm FullPerm)) (qpRange12 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv12 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g_1@@15 (invRecv12 o_4@@0)) (< NoPerm FullPerm)) (qpRange12 o_4@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@0 next))))
