...
(let ((anon83_Then_correct  (and (=> (= (ControlFlow 0 51) (- 0 53)) (forall ((n_4 T@Ref) ) (!  (=> (and (select g_1 n_4) (dummyFunction_37931 (select (|PolymorphicMapType_58002_37181_37182#PolymorphicMapType_58002| PostHeap@0) n_4 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
...
)) (=> (= (ControlFlow 0 51) (- 0 50)) (forall ((n_4@@3 T@Ref) ) (!  (=> (select g_1 n_4@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_58023_37930_37931#PolymorphicMapType_58023| QPMask@1) n_4@@3 next) NoPerm)))
...
(let ((anon75_Else_correct  (=> (and (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1) (not (= (select (|PolymorphicMapType_58002_37181_37182#PolymorphicMapType_58002| PostHeap@0) n$2_1 next) null))) (select g_1 (select (|PolymorphicMapType_58002_37181_37182#PolymorphicMapType_58002| PostHeap@0) n$2_1 next)))
...
(let ((anon77_Else_correct  (=> (and (not (and (select g_1 n$2_21) (not (= (select (|PolymorphicMapType_58002_37181_37182#PolymorphicMapType_58002| PostHeap@0) n$2_21 next) null)))) (= (ControlFlow 0 16) 13)) anon18_correct)))
(let ((anon77_Then_correct  (=> (and (select g_1 n$2_21) (not (= (select (|PolymorphicMapType_58002_37181_37182#PolymorphicMapType_58002| PostHeap@0) n$2_21 next) null))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_37930_37931 QPMask@1 n$2_21 next)) (=> (HasDirectPerm_37930_37931 QPMask@1 n$2_21 next) (=> (= (ControlFlow 0 14) 13) anon18_correct))))))
...
(let ((anon76_Then_correct  (=> (select g_1 n$2_21) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_37930_37931 QPMask@1 n$2_21 next)) (=> (HasDirectPerm_37930_37931 QPMask@1 n$2_21 next) (and (=> (= (ControlFlow 0 17) 14) anon77_Then_correct) (=> (= (ControlFlow 0 17) 16) anon77_Else_correct)))))))
...
(let ((anon72_Else_correct  (=> (and (not (and (select g_1 n$0_28) (not (= (select (|PolymorphicMapType_58002_37181_37182#PolymorphicMapType_58002| Heap@@29) n$0_28 next) null)))) (= (ControlFlow 0 5) 2)) anon9_correct)))
(let ((anon72_Then_correct  (=> (and (select g_1 n$0_28) (not (= (select (|PolymorphicMapType_58002_37181_37182#PolymorphicMapType_58002| Heap@@29) n$0_28 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37930_37931 QPMask@0 n$0_28 next)) (=> (HasDirectPerm_37930_37931 QPMask@0 n$0_28 next) (=> (= (ControlFlow 0 3) 2) anon9_correct))))))
...
(let ((anon71_Then_correct  (=> (select g_1 n$0_28) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37930_37931 QPMask@0 n$0_28 next)) (=> (HasDirectPerm_37930_37931 QPMask@0 n$0_28 next) (and (=> (= (ControlFlow 0 6) 3) anon72_Then_correct) (=> (= (ControlFlow 0 6) 5) anon72_Else_correct)))))))
(let ((anon69_Else_correct  (and (=> (= (ControlFlow 0 80) (- 0 82)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (and (select g_1 n_1) (not (= n_1 x@@6)))) (and (select g_1 n_1_1) (not (= n_1_1 x@@6)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58002_37181_37182#PolymorphicMapType_58002| Heap@@29) n_1@@4 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv12 o_9@@6)) (not (= (invRecv12 o_9@@6) x@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_9@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv12 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_58023_37930_37931#PolymorphicMapType_58023| QPMask@0) o_9@@6 next) (+ (select (|PolymorphicMapType_58023_37930_37931#PolymorphicMapType_58023| Mask@0) o_9@@6 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv12 o_9@@6)) (not (= (invRecv12 o_9@@6) x@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_9@@6))) (= (select (|PolymorphicMapType_58023_37930_37931#PolymorphicMapType_58023| QPMask@0) o_9@@6 next) (select (|PolymorphicMapType_58023_37930_37931#PolymorphicMapType_58023| Mask@0) o_9@@6 next))))
