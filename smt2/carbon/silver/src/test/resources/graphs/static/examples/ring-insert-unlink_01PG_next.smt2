...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 87) (let ((anon78_Then_correct  (and (=> (= (ControlFlow 0 70) (- 0 72)) (forall ((n_3 T@Ref) ) (!  (=> (and (select g_1 n_3) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_3 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2007:23|
 :skolemid |231|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) n_3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_3 next))
))) (=> (forall ((n_3@@0 T@Ref) ) (!  (=> (and (select g_1 n_3@@0) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_3@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2007:23|
 :skolemid |231|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_3@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@3) n_3@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_3@@0 next))
)) (and (=> (= (ControlFlow 0 70) (- 0 71)) (forall ((n_3@@1 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3@@1 n_3_1)) (select g_1 n_3@@1)) (select g_1 n_3_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_3@@1 n_3_1)))
...
)) (=> (= (ControlFlow 0 70) (- 0 69)) (forall ((n_3@@3 T@Ref) ) (!  (=> (select g_1 n_3@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) n_3@@3 next) NoPerm)))
...
(let ((anon77_Then_correct  (and (=> (= (ControlFlow 0 66) (- 0 68)) (forall ((n_2 T@Ref) ) (!  (=> (and (select g_1 n_2) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_2 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1964:23|
 :skolemid |226|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_2 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) n_2 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_2 next))
))) (=> (forall ((n_2@@0 T@Ref) ) (!  (=> (and (select g_1 n_2@@0) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_2@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1964:23|
 :skolemid |226|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_2@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) n_2@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_2@@0 next))
)) (and (=> (= (ControlFlow 0 66) (- 0 67)) (forall ((n_2@@1 T@Ref) (n_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_2@@1 n_2_1)) (select g_1 n_2@@1)) (select g_1 n_2_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_2@@1 n_2_1)))
 :qid |stdinbpl.1971:23|
 :skolemid |227|
...
)) (=> (= (ControlFlow 0 66) (- 0 65)) (forall ((n_2@@3 T@Ref) ) (!  (=> (select g_1 n_2@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) n_2@@3 next) NoPerm)))
 :qid |stdinbpl.1978:23|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) n_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_2@@3 next))
)))))))))
(let ((anon32_correct true))
(let ((anon84_Else_correct  (=> (and (not (= v1_5 node)) (= (ControlFlow 0 59) 55)) anon32_correct)))
(let ((anon84_Then_correct  (=> (= v1_5 node) (and (=> (= (ControlFlow 0 57) (- 0 58)) (HasDirectPerm_48849_48850 QPMask@0 node next)) (=> (HasDirectPerm_48849_48850 QPMask@0 node next) (=> (= (ControlFlow 0 57) 55) anon32_correct))))))
(let ((anon83_Then_correct  (=> (edge ($$ Heap@@32 g_1) v1_5 v2_5) (and (=> (= (ControlFlow 0 60) 57) anon84_Then_correct) (=> (= (ControlFlow 0 60) 59) anon84_Else_correct)))))
(let ((anon83_Else_correct  (=> (and (not (edge ($$ Heap@@32 g_1) v1_5 v2_5)) (= (ControlFlow 0 56) 55)) anon32_correct)))
(let ((anon82_Then_correct  (and (=> (= (ControlFlow 0 52) (- 0 54)) (forall ((n_5 T@Ref) ) (!  (=> (and (select g_1 n_5) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_5 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2102:25|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_5 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@8) n_5 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_5 next))
))) (=> (forall ((n_5@@0 T@Ref) ) (!  (=> (and (select g_1 n_5@@0) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_5@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2102:25|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_5@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@8) n_5@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_5@@0 next))
)) (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((n_5@@1 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5@@1 n_5_1)) (select g_1 n_5@@1)) (select g_1 n_5_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_5@@1 n_5_1)))
 :qid |stdinbpl.2109:25|
 :skolemid |242|
...
)) (=> (= (ControlFlow 0 52) (- 0 51)) (forall ((n_5@@3 T@Ref) ) (!  (=> (select g_1 n_5@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) n_5@@3 next) NoPerm)))
 :qid |stdinbpl.2116:25|
 :skolemid |243|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_5@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@8) n_5@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_5@@3 next))
)))))))))
(let ((anon81_Then_correct  (and (=> (= (ControlFlow 0 48) (- 0 50)) (forall ((n_4 T@Ref) ) (!  (=> (and (select g_1 n_4) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2059:25|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) n_4 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4 next))
))) (=> (forall ((n_4@@0 T@Ref) ) (!  (=> (and (select g_1 n_4@@0) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2059:25|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) n_4@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4@@0 next))
)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (forall ((n_4@@1 T@Ref) (n_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4@@1 n_4_1)) (select g_1 n_4@@1)) (select g_1 n_4_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_4@@1 n_4_1)))
 :qid |stdinbpl.2066:25|
 :skolemid |237|
...
)) (=> (= (ControlFlow 0 48) (- 0 47)) (forall ((n_4@@3 T@Ref) ) (!  (=> (select g_1 n_4@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) n_4@@3 next) NoPerm)))
 :qid |stdinbpl.2073:25|
 :skolemid |238|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) n_4@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4@@3 next))
)))))))))
(let ((anon89_Then_correct  (and (=> (= (ControlFlow 0 36) (- 0 38)) (forall ((n_7 T@Ref) ) (!  (=> (and (select g_1 n_7) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_7 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2206:27|
 :skolemid |252|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_7 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) n_7 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_7 next))
 ...
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) n_7@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_7@@0 next))
)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((n_7@@1 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7@@1 n_7_1)) (select g_1 n_7@@1)) (select g_1 n_7_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_7@@1 n_7_1)))
 :qid |stdinbpl.2213:27|
 :skolemid |253|
...
)) (=> (= (ControlFlow 0 36) (- 0 35)) (forall ((n_7@@3 T@Ref) ) (!  (=> (select g_1 n_7@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) n_7@@3 next) NoPerm)))
 :qid |stdinbpl.2220:27|
 :skolemid |254|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_7@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) n_7@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_7@@3 next))
)))))))))
(let ((anon91_Then_correct  (and (=> (= (ControlFlow 0 30) (- 0 32)) (forall ((n_8 T@Ref) ) (!  (=> (and (select g_1 n_8) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_8 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2250:27|
 :skolemid |257|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_8 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) n_8 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_8 next))
))) (=> (forall ((n_8@@0 T@Ref) ) (!  (=> (and (select g_1 n_8@@0) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_8@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2250:27|
 :skolemid |257|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_8@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) n_8@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_8@@0 next))
...
)) (=> (= (ControlFlow 0 30) (- 0 29)) (forall ((n_8@@3 T@Ref) ) (!  (=> (select g_1 n_8@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) n_8@@3 next) NoPerm)))
 :qid |stdinbpl.2264:27|
 :skolemid |259|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_8@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) n_8@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_8@@3 next))
)))))))))
(let ((anon45_correct true))
(let ((anon90_Then_correct  (=> (and (DEP ($$ Heap@@32 g_1) x_21 y_3 u_31 v_31) (not (DEP ($$ Heap@@32 g_1) x_21 y_3 node (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next)))) (and (=> (= (ControlFlow 0 33) 30) anon91_Then_correct) (=> (= (ControlFlow 0 33) 27) anon45_correct)))))
(let ((anon90_Else_correct  (=> (and (not (and (DEP ($$ Heap@@32 g_1) x_21 y_3 u_31 v_31) (not (DEP ($$ Heap@@32 g_1) x_21 y_3 node (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next))))) (= (ControlFlow 0 28) 27)) anon45_correct)))
(let ((anon89_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 40)) (HasDirectPerm_48849_48850 QPMask@0 node next)) (=> (HasDirectPerm_48849_48850 QPMask@0 node next) (and (=> (= (ControlFlow 0 39) 33) anon90_Then_correct) (=> (= (ControlFlow 0 39) 28) anon90_Else_correct))))))
(let ((anon88_Then_correct  (=> (DEP ($$ Heap@@32 g_1) x_21 y_3 u_31 v_31) (and (=> (= (ControlFlow 0 41) 36) anon89_Then_correct) (=> (= (ControlFlow 0 41) 39) anon89_Else_correct)))))
(let ((anon88_Else_correct  (=> (not (DEP ($$ Heap@@32 g_1) x_21 y_3 u_31 v_31)) (and (=> (= (ControlFlow 0 34) 33) anon90_Then_correct) (=> (= (ControlFlow 0 34) 28) anon90_Else_correct)))))
(let ((anon87_Then_correct  (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((n_6 T@Ref) ) (!  (=> (and (select g_1 n_6) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_6 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2165:25|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_6 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@4) n_6 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_6 next))
 ...
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@4) n_6@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_6@@0 next))
)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((n_6@@1 T@Ref) (n_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6@@1 n_6_1)) (select g_1 n_6@@1)) (select g_1 n_6_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_6@@1 n_6_1)))
 :qid |stdinbpl.2172:25|
 :skolemid |248|
...
)) (=> (= (ControlFlow 0 24) (- 0 23)) (forall ((n_6@@3 T@Ref) ) (!  (=> (select g_1 n_6@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) n_6@@3 next) NoPerm)))
 :qid |stdinbpl.2179:25|
 :skolemid |249|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_6@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@4) n_6@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_6@@3 next))
)))))))))
(let ((anon47_correct true))
(let ((anon86_Else_correct  (=> (and (forall ((x_1 T@Ref) (y_1 T@Ref) (u_1_1@@1 T@Ref) (v_1_1@@1 T@Ref) ) (!  (=> (and (DEP ($$ Heap@@32 g_1) x_1 y_1 u_1_1@@1 v_1_1@@1) (not (DEP ($$ Heap@@32 g_1) x_1 y_1 node (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next)))) (DEP ($$ PostHeap@0 g_1) x_1 y_1 u_1_1@@1 v_1_1@@1))
...
(let ((anon85_Then_correct  (=> (and (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next) null)) (state PostHeap@0 QPMask@1)) (and (and (and (=> (= (ControlFlow 0 42) 22) anon86_Else_correct) (=> (= (ControlFlow 0 42) 24) anon87_Then_correct)) (=> (= (ControlFlow 0 42) 41) anon88_Then_correct)) (=> (= (ControlFlow 0 42) 34) anon88_Else_correct)))))
(let ((anon85_Else_correct  (=> (and (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next) null) (= (ControlFlow 0 21) 20)) anon47_correct)))
(let ((anon34_correct  (=> (state PostHeap@0 QPMask@1) (and (=> (= (ControlFlow 0 43) (- 0 44)) (HasDirectPerm_48849_48850 QPMask@0 node next)) (=> (HasDirectPerm_48849_48850 QPMask@0 node next) (and (=> (= (ControlFlow 0 43) 42) anon85_Then_correct) (=> (= (ControlFlow 0 43) 21) anon85_Else_correct)))))))
(let ((anon80_Else_correct  (=> (and (forall ((v1_1 T@Ref) (v2_1 T@Ref) ) (! (= (edge ($$ PostHeap@0 g_1) v1_1 v2_1)  (and (edge ($$ Heap@@32 g_1) v1_1 v2_1) (not (and (= v1_1 node) (= v2_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next))))))
...
(let ((anon79_Then_correct  (=> (and (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next) null)) (state PostHeap@0 QPMask@1)) (and (and (and (and (=> (= (ControlFlow 0 61) 46) anon80_Else_correct) (=> (= (ControlFlow 0 61) 48) anon81_Then_correct)) (=> (= (ControlFlow 0 61) 52) anon82_Then_correct)) (=> (= (ControlFlow 0 61) 60) anon83_Then_correct)) (=> (= (ControlFlow 0 61) 56) anon83_Else_correct)))))
(let ((anon79_Else_correct  (=> (and (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next) null) (= (ControlFlow 0 45) 43)) anon34_correct)))
(let ((anon23_correct  (=> (state PostHeap@0 QPMask@1) (and (=> (= (ControlFlow 0 62) (- 0 63)) (HasDirectPerm_48849_48850 QPMask@0 node next)) (=> (HasDirectPerm_48849_48850 QPMask@0 node next) (and (=> (= (ControlFlow 0 62) 61) anon79_Then_correct) (=> (= (ControlFlow 0 62) 45) anon79_Else_correct)))))))
(let ((anon78_Else_correct  (=> (and (|Set#Equal_48858| ($$ PostHeap@0 g_1) ($$ Heap@@32 g_1)) (= (ControlFlow 0 73) 62)) anon23_correct)))
(let ((anon76_Then_correct  (=> (and (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next) null) (state PostHeap@0 QPMask@1)) (and (and (=> (= (ControlFlow 0 74) 66) anon77_Then_correct) (=> (= (ControlFlow 0 74) 70) anon78_Then_correct)) (=> (= (ControlFlow 0 74) 73) anon78_Else_correct)))))
(let ((anon76_Else_correct  (=> (and (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next) null)) (= (ControlFlow 0 64) 62)) anon23_correct)))
(let ((anon73_Else_correct  (=> (and (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_1 next) null))) (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_1 next)))
 :qid |stdinbpl.1937:20|
 :skolemid |225|
...
)) (state PostHeap@0 QPMask@1)) (and (=> (= (ControlFlow 0 75) (- 0 77)) (HasDirectPerm_48849_48850 QPMask@1 node next)) (=> (HasDirectPerm_48849_48850 QPMask@1 node next) (=> (and (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) node next) null) (state PostHeap@0 QPMask@1)) (and (=> (= (ControlFlow 0 75) (- 0 76)) (HasDirectPerm_48849_48850 QPMask@0 node next)) (=> (HasDirectPerm_48849_48850 QPMask@0 node next) (and (=> (= (ControlFlow 0 75) 74) anon76_Then_correct) (=> (= (ControlFlow 0 75) 64) anon76_Else_correct))))))))))
(let ((anon16_correct true))
(let ((anon75_Else_correct  (=> (and (not (and (select g_1 n$2_30) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_30 next) null)))) (= (ControlFlow 0 16) 13)) anon16_correct)))
(let ((anon75_Then_correct  (=> (and (select g_1 n$2_30) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_30 next) null))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_48849_48850 QPMask@1 n$2_30 next)) (=> (HasDirectPerm_48849_48850 QPMask@1 n$2_30 next) (=> (= (ControlFlow 0 14) 13) anon16_correct))))))
(let ((anon74_Else_correct  (=> (not (select g_1 n$2_30)) (and (=> (= (ControlFlow 0 19) 14) anon75_Then_correct) (=> (= (ControlFlow 0 19) 16) anon75_Else_correct)))))
(let ((anon74_Then_correct  (=> (select g_1 n$2_30) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_48849_48850 QPMask@1 n$2_30 next)) (=> (HasDirectPerm_48849_48850 QPMask@1 n$2_30 next) (and (=> (= (ControlFlow 0 17) 14) anon75_Then_correct) (=> (= (ControlFlow 0 17) 16) anon75_Else_correct)))))))
(let ((anon72_Else_correct  (and (=> (= (ControlFlow 0 78) (- 0 80)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (and (select g_1 n$1_1) (not (= n$1_1 node)))) (and (select g_1 n$1_1_1) (not (= n$1_1_1 node)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$1_1 n$1_1_1)))
 :qid |stdinbpl.1886:15|
 :skolemid |218|
))) (=> (forall ((n$1_1@@0 T@Ref) (n$1_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1@@0 n$1_1_1@@0)) (and (select g_1 n$1_1@@0) (not (= n$1_1@@0 node)))) (and (select g_1 n$1_1_1@@0) (not (= n$1_1_1@@0 node)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$1_1@@0 n$1_1_1@@0)))
 :qid |stdinbpl.1886:15|
 :skolemid |218|
)) (=> (and (forall ((n$1_1@@1 T@Ref) ) (!  (=> (and (and (select g_1 n$1_1@@1) (not (= n$1_1@@1 node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange14 n$1_1@@1) (= (invRecv14 n$1_1@@1) n$1_1@@1)))
 :qid |stdinbpl.1892:22|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) n$1_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv14 o_9)) (not (= (invRecv14 o_9) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9)) (= (invRecv14 o_9) o_9))
 :qid |stdinbpl.1896:22|
 :skolemid |220|
 :pattern ( (invRecv14 o_9))
))) (and (=> (= (ControlFlow 0 78) (- 0 79)) (forall ((n$1_1@@2 T@Ref) ) (!  (=> (and (select g_1 n$1_1@@2) (not (= n$1_1@@2 node))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1902:15|
 :skolemid |221|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) n$1_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@2 next))
))) (=> (forall ((n$1_1@@3 T@Ref) ) (!  (=> (and (select g_1 n$1_1@@3) (not (= n$1_1@@3 node))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1902:15|
 :skolemid |221|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) n$1_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@3 next))
)) (=> (and (forall ((n$1_1@@4 T@Ref) ) (!  (=> (and (and (select g_1 n$1_1@@4) (not (= n$1_1@@4 node))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= n$1_1@@4 null)))
 :qid |stdinbpl.1908:22|
 :skolemid |222|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@4 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) n$1_1@@4 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@4 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv14 o_9@@0)) (not (= (invRecv14 o_9@@0) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv14 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_9@@0 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| PostMask@0) o_9@@0 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv14 o_9@@0)) (not (= (invRecv14 o_9@@0) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9@@0))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_9@@0 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| PostMask@0) o_9@@0 next))))
 :qid |stdinbpl.1914:22|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_9@@0 next))
))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| PostMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@1) o_9@@1 f_5)))
...
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_74000_74001) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| PostMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1918:29|
 :skolemid |224|
...
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| PostMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1918:29|
 :skolemid |224|
...
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| PostMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1918:29|
 :skolemid |224|
...
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| PostMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1918:29|
 :skolemid |224|
...
(let ((anon71_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (select g_1 null))) (=> (and (and (select g_1 node) (not (= node null))) (and (= PostMask@0 (PolymorphicMapType_73948 (store (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) node next (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) node next) FullPerm)) (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask))) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 81) 12) anon72_Then_correct) (=> (= (ControlFlow 0 81) 78) anon72_Else_correct))))))
(let ((anon71_Else_correct true))
(let ((anon68_Else_correct  (=> (and (forall ((n$0_1 T@Ref) ) (!  (=> (and (select g_1 n$0_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_1 next) null))) (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_1 next)))
 :qid |stdinbpl.1857:20|
 :skolemid |217|
...
)) (state Heap@@32 QPMask@0)) (and (=> (= (ControlFlow 0 82) 81) anon71_Then_correct) (=> (= (ControlFlow 0 82) 10) anon71_Else_correct)))))
(let ((anon7_correct true))
(let ((anon70_Else_correct  (=> (and (not (and (select g_1 n$0_32) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_32 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon70_Then_correct  (=> (and (select g_1 n$0_32) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_32 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_48849_48850 QPMask@0 n$0_32 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 n$0_32 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon69_Else_correct  (=> (not (select g_1 n$0_32)) (and (=> (= (ControlFlow 0 8) 3) anon70_Then_correct) (=> (= (ControlFlow 0 8) 5) anon70_Else_correct)))))
(let ((anon69_Then_correct  (=> (select g_1 n$0_32) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_48849_48850 QPMask@0 n$0_32 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 n$0_32 next) (and (=> (= (ControlFlow 0 6) 3) anon70_Then_correct) (=> (= (ControlFlow 0 6) 5) anon70_Else_correct)))))))
(let ((anon67_Else_correct  (and (=> (= (ControlFlow 0 83) (- 0 85)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (and (select g_1 n_1) (not (= n_1 node)))) (and (select g_1 n_1_1) (not (= n_1_1 node)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_1 n_1_1)))
 :qid |stdinbpl.1806:15|
 :skolemid |210|
))) (=> (forall ((n_1@@0 T@Ref) (n_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1@@0 n_1_1@@0)) (and (select g_1 n_1@@0) (not (= n_1@@0 node)))) (and (select g_1 n_1_1@@0) (not (= n_1_1@@0 node)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_1@@0 n_1_1@@0)))
 :qid |stdinbpl.1806:15|
 :skolemid |210|
)) (=> (and (forall ((n_1@@1 T@Ref) ) (!  (=> (and (and (select g_1 n_1@@1) (not (= n_1@@1 node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange13 n_1@@1) (= (invRecv13 n_1@@1) n_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_1@@1 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv13 o_9@@6)) (not (= (invRecv13 o_9@@6) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_9@@6)) (= (invRecv13 o_9@@6) o_9@@6))
 :qid |stdinbpl.1816:22|
 :skolemid |212|
 :pattern ( (invRecv13 o_9@@6))
))) (and (=> (= (ControlFlow 0 83) (- 0 84)) (forall ((n_1@@2 T@Ref) ) (!  (=> (and (select g_1 n_1@@2) (not (= n_1@@2 node))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_1@@2 next))
))) (=> (forall ((n_1@@3 T@Ref) ) (!  (=> (and (select g_1 n_1@@3) (not (= n_1@@3 node))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1822:15|
 :skolemid |213|
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_1@@3 next))
)) (=> (and (forall ((n_1@@4 T@Ref) ) (!  (=> (and (and (select g_1 n_1@@4) (not (= n_1@@4 node))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= n_1@@4 null)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_1@@4 next))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv13 o_9@@7)) (not (= (invRecv13 o_9@@7) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_9@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv13 o_9@@7) o_9@@7)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_9@@7 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@0) o_9@@7 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv13 o_9@@7)) (not (= (invRecv13 o_9@@7) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_9@@7))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_9@@7 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@0) o_9@@7 next))))
...
))) (state Heap@@32 QPMask@0)) (and (and (=> (= (ControlFlow 0 83) 82) anon68_Else_correct) (=> (= (ControlFlow 0 83) 6) anon69_Then_correct)) (=> (= (ControlFlow 0 83) 8) anon69_Else_correct)))))))))))
(let ((anon67_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (and (select (|PolymorphicMapType_73927_47953_53#PolymorphicMapType_73927| Heap@@32) node $allocated) (select g_1 node)) (and (state Heap@@32 ZeroMask) (not (select g_1 null)))) (and (and (select g_1 node) (not (= node null))) (and (= Mask@0 (PolymorphicMapType_73948 (store (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) node next (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) node next) FullPerm)) (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask))) (state Heap@@32 Mask@0)))) (and (=> (= (ControlFlow 0 86) 1) anon67_Then_correct) (=> (= (ControlFlow 0 86) 83) anon67_Else_correct)))))))
