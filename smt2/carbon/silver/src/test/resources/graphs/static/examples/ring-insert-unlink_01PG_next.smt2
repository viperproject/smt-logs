...
(let ((anon84_Else_correct  (=> (and (not (= v1_2 node)) (= (ControlFlow 0 59) 55)) anon32_correct)))
(let ((anon84_Then_correct  (=> (= v1_2 node) (and (=> (= (ControlFlow 0 57) (- 0 58)) (HasDirectPerm_48849_48850 QPMask@0 node next)) (=> (HasDirectPerm_48849_48850 QPMask@0 node next) (=> (= (ControlFlow 0 57) 55) anon32_correct))))))
(let ((anon83_Then_correct  (=> (edge ($$ Heap@@32 g_1) v1_2 v2_2) (and (=> (= (ControlFlow 0 60) 57) anon84_Then_correct) (=> (= (ControlFlow 0 60) 59) anon84_Else_correct)))))
(let ((anon83_Else_correct  (=> (and (not (edge ($$ Heap@@32 g_1) v1_2 v2_2)) (= (ControlFlow 0 56) 55)) anon32_correct)))
...
(let ((anon81_Then_correct  (and (=> (= (ControlFlow 0 48) (- 0 50)) (forall ((n_4_1 T@Ref) ) (!  (=> (and (select g_1 n_4_1) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2059:25|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4_1 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) n_4_1 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4_1 next))
))) (=> (forall ((n_4_1@@0 T@Ref) ) (!  (=> (and (select g_1 n_4_1@@0) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4_1@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2059:25|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) n_4_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4_1@@0 next))
)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (forall ((n_4_1@@1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1@@1 n_4_2)) (select g_1 n_4_1@@1)) (select g_1 n_4_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_4_1@@1 n_4_2)))
...
)) (=> (= (ControlFlow 0 48) (- 0 47)) (forall ((n_4_1@@3 T@Ref) ) (!  (=> (select g_1 n_4_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) n_4_1@@3 next) NoPerm)))
 :qid |stdinbpl.2073:25|
 :skolemid |238|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@7) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n_4_1@@3 next))
)))))))))
...
(let ((anon90_Then_correct  (=> (and (DEP ($$ Heap@@32 g_1) x_26 y_7 u_32 v_30) (not (DEP ($$ Heap@@32 g_1) x_26 y_7 node (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next)))) (and (=> (= (ControlFlow 0 33) 30) anon91_Then_correct) (=> (= (ControlFlow 0 33) 27) anon45_correct)))))
(let ((anon90_Else_correct  (=> (and (not (and (DEP ($$ Heap@@32 g_1) x_26 y_7 u_32 v_30) (not (DEP ($$ Heap@@32 g_1) x_26 y_7 node (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next))))) (= (ControlFlow 0 28) 27)) anon45_correct)))
...
(let ((anon88_Then_correct  (=> (DEP ($$ Heap@@32 g_1) x_26 y_7 u_32 v_30) (and (=> (= (ControlFlow 0 41) 36) anon89_Then_correct) (=> (= (ControlFlow 0 41) 39) anon89_Else_correct)))))
(let ((anon88_Else_correct  (=> (not (DEP ($$ Heap@@32 g_1) x_26 y_7 u_32 v_30)) (and (=> (= (ControlFlow 0 34) 33) anon90_Then_correct) (=> (= (ControlFlow 0 34) 28) anon90_Else_correct)))))
...
(let ((anon86_Else_correct  (=> (and (forall ((x_1 T@Ref) (y_1 T@Ref) (u_1@@1 T@Ref) (v_1_1@@1 T@Ref) ) (!  (=> (and (DEP ($$ Heap@@32 g_1) x_1 y_1 u_1@@1 v_1_1@@1) (not (DEP ($$ Heap@@32 g_1) x_1 y_1 node (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) node next)))) (DEP ($$ PostHeap@0 g_1) x_1 y_1 u_1@@1 v_1_1@@1))
...
(let ((anon73_Else_correct  (=> (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1_1) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_1_1 next) null))) (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_1_1 next)))
...
(let ((anon75_Else_correct  (=> (and (not (and (select g_1 n$2_37) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_37 next) null)))) (= (ControlFlow 0 16) 13)) anon16_correct)))
(let ((anon75_Then_correct  (=> (and (select g_1 n$2_37) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_37 next) null))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_48849_48850 QPMask@1 n$2_37 next)) (=> (HasDirectPerm_48849_48850 QPMask@1 n$2_37 next) (=> (= (ControlFlow 0 14) 13) anon16_correct))))))
(let ((anon74_Else_correct  (=> (not (select g_1 n$2_37)) (and (=> (= (ControlFlow 0 19) 14) anon75_Then_correct) (=> (= (ControlFlow 0 19) 16) anon75_Else_correct)))))
(let ((anon74_Then_correct  (=> (select g_1 n$2_37) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_48849_48850 QPMask@1 n$2_37 next)) (=> (HasDirectPerm_48849_48850 QPMask@1 n$2_37 next) (and (=> (= (ControlFlow 0 17) 14) anon75_Then_correct) (=> (= (ControlFlow 0 17) 16) anon75_Else_correct)))))))
(let ((anon72_Else_correct  (and (=> (= (ControlFlow 0 78) (- 0 80)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (and (select g_1 n$1_1) (not (= n$1_1 node)))) (and (select g_1 n$1_1_1) (not (= n$1_1_1 node)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv14 o_4)) (not (= (invRecv14 o_4) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_4)) (= (invRecv14 o_4) o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@4 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv14 o_4@@0)) (not (= (invRecv14 o_4@@0) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv14 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_4@@0 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| PostMask@0) o_4@@0 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv14 o_4@@0)) (not (= (invRecv14 o_4@@0) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_4@@0))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_4@@0 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| PostMask@0) o_4@@0 next))))
 :qid |stdinbpl.1914:22|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_4@@0 next))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| PostMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@1) o_4@@1 f_5)))
...
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_74000_74001) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| PostMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1918:29|
 :skolemid |224|
...
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| PostMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1918:29|
 :skolemid |224|
...
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| PostMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1918:29|
 :skolemid |224|
...
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| PostMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1918:29|
 :skolemid |224|
...
(let ((anon70_Else_correct  (=> (and (not (and (select g_1 n$0_36) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_36 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon70_Then_correct  (=> (and (select g_1 n$0_36) (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_36 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_48849_48850 QPMask@0 n$0_36 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 n$0_36 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon69_Else_correct  (=> (not (select g_1 n$0_36)) (and (=> (= (ControlFlow 0 8) 3) anon70_Then_correct) (=> (= (ControlFlow 0 8) 5) anon70_Else_correct)))))
(let ((anon69_Then_correct  (=> (select g_1 n$0_36) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_48849_48850 QPMask@0 n$0_36 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 n$0_36 next) (and (=> (= (ControlFlow 0 6) 3) anon70_Then_correct) (=> (= (ControlFlow 0 6) 5) anon70_Else_correct)))))))
(let ((anon67_Else_correct  (and (=> (= (ControlFlow 0 83) (- 0 85)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (and (select g_1 n_1) (not (= n_1 node)))) (and (select g_1 n_1_1) (not (= n_1_1 node)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_1@@1 next))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv13 o_4@@6)) (not (= (invRecv13 o_4@@6) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_4@@6)) (= (invRecv13 o_4@@6) o_4@@6))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_1@@4 next))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv13 o_4@@7)) (not (= (invRecv13 o_4@@7) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_4@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv13 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@7 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@0) o_4@@7 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv13 o_4@@7)) (not (= (invRecv13 o_4@@7) node))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_4@@7))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@7 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| Mask@0) o_4@@7 next))))
