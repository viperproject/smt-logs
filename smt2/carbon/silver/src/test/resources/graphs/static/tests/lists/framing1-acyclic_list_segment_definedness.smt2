...
(let ((anon18_Else_correct  (=> (and (forall ((n$0_3 T@Ref) ) (!  (=> (and (select g_1@@15 n$0_3) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3 next) null))) (select g_1@@15 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3 next)))
 :qid |stdinbpl.2053:20|
 :skolemid |235|
 :pattern ( (select g_1@@15 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3 next)))
 :pattern ( (select g_1@@15 n$0_3) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3 next))
...
(let ((anon20_Else_correct  (=> (and (not (and (select g_1@@15 n$0_12) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_12 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (select g_1@@15 n$0_12) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_12 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$0_12 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_12 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon19_Else_correct  (=> (not (select g_1@@15 n$0_12)) (and (=> (= (ControlFlow 0 8) 3) anon20_Then_correct) (=> (= (ControlFlow 0 8) 5) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (select g_1@@15 n$0_12) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$0_12 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_12 next) (and (=> (= (ControlFlow 0 6) 3) anon20_Then_correct) (=> (= (ControlFlow 0 6) 5) anon20_Else_correct)))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((n_4 T@Ref) (n_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4 n_4_1)) (select g_1@@15 n_4)) (select g_1@@15 n_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1)))
 :qid |stdinbpl.2008:15|
 :skolemid |229|
))) (=> (forall ((n_4@@0 T@Ref) (n_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4@@0 n_4_1@@0)) (select g_1@@15 n_4@@0)) (select g_1@@15 n_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4@@0 n_4_1@@0)))
 :qid |stdinbpl.2008:15|
 :skolemid |229|
)) (=> (and (and (forall ((n_4@@1 T@Ref) ) (!  (=> (and (select g_1@@15 n_4@@1) (< NoPerm FullPerm)) (and (qpRange16 n_4@@1) (= (invRecv16 n_4@@1) n_4@@1)))
 :qid |stdinbpl.2014:22|
 :skolemid |230|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_4@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1@@15 (invRecv16 o_9)) (< NoPerm FullPerm)) (qpRange16 o_9)) (= (invRecv16 o_9) o_9))
 :qid |stdinbpl.2018:22|
 :skolemid |231|
 :pattern ( (invRecv16 o_9))
))) (and (forall ((n_4@@2 T@Ref) ) (!  (=> (select g_1@@15 n_4@@2) (not (= n_4@@2 null)))
 :qid |stdinbpl.2024:22|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) n_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_4@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1@@15 (invRecv16 o_9@@0)) (< NoPerm FullPerm)) (qpRange16 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1@@15 (invRecv16 o_9@@0)) (< NoPerm FullPerm)) (qpRange16 o_9@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@0 next))))
