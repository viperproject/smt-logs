...
(declare-fun u_17 () T@Ref)
(declare-fun v_17 () T@Ref)
...
(declare-fun u_16 () T@Ref)
(declare-fun v_16 () T@Ref)
(declare-fun neverTriggered33 (T@Ref) Bool)
(declare-fun QPMask@11 () T@PolymorphicMapType_58550)
(declare-fun u_15 () T@Ref)
(declare-fun v_15 () T@Ref)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 110) (let ((anon101_Then_correct  (and (=> (= (ControlFlow 0 91) (- 0 92)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select g0@@10 n_5)) (select g0@@10 n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1)))
 :qid |stdinbpl.3204:27|
 :skolemid |340|
...
)) (=> (= (ControlFlow 0 91) (- 0 90)) (forall ((n_5@@1 T@Ref) ) (!  (=> (select g0@@10 n_5@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n_5@@1 next) NoPerm)))
 :qid |stdinbpl.3211:27|
 :skolemid |341|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_5@@1 next))
)))))))
(let ((anon103_Then_correct  (and (=> (= (ControlFlow 0 85) (- 0 86)) (forall ((n_6 T@Ref) (n_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6 n_6_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_6)) (select (|Set#Union_37395| g0@@10 g1@@10) n_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1)))
 :qid |stdinbpl.3246:25|
 :skolemid |344|
 :pattern ( (neverTriggered37 n_6) (neverTriggered37 n_6_1))
))) (=> (forall ((n_6@@0 T@Ref) (n_6_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6@@0 n_6_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_6@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_6_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6@@0 n_6_1@@0)))
 :qid |stdinbpl.3246:25|
 :skolemid |344|
 :pattern ( (neverTriggered37 n_6@@0) (neverTriggered37 n_6_1@@0))
)) (=> (= (ControlFlow 0 85) (- 0 84)) (forall ((n_6@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_6@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n_6@@1 next) NoPerm)))
 :qid |stdinbpl.3253:25|
 :skolemid |345|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_6@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) n_6@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_6@@1 next))
)))))))
(let ((anon51_correct true))
(let ((anon102_Then_correct  (=> (and (select g1@@10 u_17) (and (select g1@@10 v_17) (exists_path ($$ PostHeap@0 g0@@10) u_17 v_17))) (and (=> (= (ControlFlow 0 87) 85) anon103_Then_correct) (=> (= (ControlFlow 0 87) 82) anon51_correct)))))
(let ((anon102_Else_correct  (=> (and (not (and (select g1@@10 u_17) (and (select g1@@10 v_17) (exists_path ($$ PostHeap@0 g0@@10) u_17 v_17)))) (= (ControlFlow 0 83) 82)) anon51_correct)))
(let ((anon100_Then_correct  (=> (select g1@@10 v_17) (and (and (=> (= (ControlFlow 0 93) 91) anon101_Then_correct) (=> (= (ControlFlow 0 93) 87) anon102_Then_correct)) (=> (= (ControlFlow 0 93) 83) anon102_Else_correct)))))
(let ((anon100_Else_correct  (=> (not (select g1@@10 v_17)) (and (=> (= (ControlFlow 0 89) 87) anon102_Then_correct) (=> (= (ControlFlow 0 89) 83) anon102_Else_correct)))))
(let ((anon99_Then_correct  (=> (select g1@@10 u_17) (and (=> (= (ControlFlow 0 94) 93) anon100_Then_correct) (=> (= (ControlFlow 0 94) 89) anon100_Else_correct)))))
(let ((anon99_Else_correct  (=> (not (select g1@@10 u_17)) (and (=> (= (ControlFlow 0 88) 87) anon102_Then_correct) (=> (= (ControlFlow 0 88) 83) anon102_Else_correct)))))
(let ((anon98_Else_correct true))
(let ((anon92_Else_correct  (=> (forall ((u_3_1@@0 T@Ref) (v_3_1@@0 T@Ref) ) (!  (=> (and (select g0@@10 u_3_1@@0) (and (select g0@@10 v_3_1@@0) (exists_path ($$ PostHeap@0 g0@@10) u_3_1@@0 v_3_1@@0))) (exists_path ($$ PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10)) u_3_1@@0 v_3_1@@0))
 :qid |stdinbpl.3182:20|
 :skolemid |339|
 :pattern ( (select g0@@10 u_3_1@@0) (select g0@@10 v_3_1@@0))
 :pattern ( (select g0@@10 u_3_1@@0) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| PostHeap@0 g0@@10)) g0@@10) u_3_1@@0 v_3_1@@0))
 :pattern ( (select g0@@10 u_3_1@@0) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_3_1@@0 v_3_1@@0))
 :pattern ( (select g0@@10 v_3_1@@0) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| PostHeap@0 g0@@10)) g0@@10) u_3_1@@0 v_3_1@@0))
 :pattern ( (select g0@@10 v_3_1@@0) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_3_1@@0 v_3_1@@0))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| PostHeap@0 g0@@10)) g0@@10) u_3_1@@0 v_3_1@@0))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_3_1@@0 v_3_1@@0))
...
(let ((anon95_Then_correct  (and (=> (= (ControlFlow 0 77) (- 0 78)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select g0@@10 n_3)) (select g0@@10 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 :qid |stdinbpl.3109:27|
 :skolemid |331|
...
)) (=> (= (ControlFlow 0 77) (- 0 76)) (forall ((n_3@@1 T@Ref) ) (!  (=> (select g0@@10 n_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n_3@@1 next) NoPerm)))
 :qid |stdinbpl.3116:27|
 :skolemid |332|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) n_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_3@@1 next))
)))))))
(let ((anon97_Then_correct  (and (=> (= (ControlFlow 0 71) (- 0 72)) (forall ((n_4 T@Ref) (n_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4 n_4_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_4)) (select (|Set#Union_37395| g0@@10 g1@@10) n_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1)))
 :qid |stdinbpl.3151:25|
 :skolemid |335|
...
)) (=> (= (ControlFlow 0 71) (- 0 70)) (forall ((n_4@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_4@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n_4@@1 next) NoPerm)))
 :qid |stdinbpl.3158:25|
 :skolemid |336|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@10) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_4@@1 next))
)))))))
(let ((anon42_correct true))
(let ((anon96_Then_correct  (=> (and (select g0@@10 u_16) (and (select g0@@10 v_16) (exists_path ($$ PostHeap@0 g0@@10) u_16 v_16))) (and (=> (= (ControlFlow 0 73) 71) anon97_Then_correct) (=> (= (ControlFlow 0 73) 68) anon42_correct)))))
(let ((anon96_Else_correct  (=> (and (not (and (select g0@@10 u_16) (and (select g0@@10 v_16) (exists_path ($$ PostHeap@0 g0@@10) u_16 v_16)))) (= (ControlFlow 0 69) 68)) anon42_correct)))
(let ((anon94_Then_correct  (=> (select g0@@10 v_16) (and (and (=> (= (ControlFlow 0 79) 77) anon95_Then_correct) (=> (= (ControlFlow 0 79) 73) anon96_Then_correct)) (=> (= (ControlFlow 0 79) 69) anon96_Else_correct)))))
(let ((anon94_Else_correct  (=> (not (select g0@@10 v_16)) (and (=> (= (ControlFlow 0 75) 73) anon96_Then_correct) (=> (= (ControlFlow 0 75) 69) anon96_Else_correct)))))
(let ((anon93_Then_correct  (=> (select g0@@10 u_16) (and (=> (= (ControlFlow 0 80) 79) anon94_Then_correct) (=> (= (ControlFlow 0 80) 75) anon94_Else_correct)))))
(let ((anon93_Else_correct  (=> (not (select g0@@10 u_16)) (and (=> (= (ControlFlow 0 74) 73) anon96_Then_correct) (=> (= (ControlFlow 0 74) 69) anon96_Else_correct)))))
(let ((anon89_Else_correct  (=> (forall ((u_1_1@@1 T@Ref) (v_1_1@@1 T@Ref) ) (!  (=> (and (select g0@@10 u_1_1@@1) (select g1@@10 v_1_1@@1)) (not (exists_path ($$ PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10)) u_1_1@@1 v_1_1@@1)))
 :qid |stdinbpl.3087:20|
 :skolemid |330|
 :pattern ( (select g0@@10 u_1_1@@1) (select g1@@10 v_1_1@@1))
 :pattern ( (select g0@@10 u_1_1@@1) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_1_1@@1 v_1_1@@1))
 :pattern ( (select g1@@10 v_1_1@@1) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_1_1@@1 v_1_1@@1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_1_1@@1 v_1_1@@1))
...
(let ((anon91_Then_correct  (and (=> (= (ControlFlow 0 65) (- 0 66)) (forall ((n_2 T@Ref) (n_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_2 n_2_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_2)) (select (|Set#Union_37395| g0@@10 g1@@10) n_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1)))
 :qid |stdinbpl.3056:25|
 :skolemid |326|
 :pattern ( (neverTriggered33 n_2) (neverTriggered33 n_2_1))
))) (=> (forall ((n_2@@0 T@Ref) (n_2_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_2@@0 n_2_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_2@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_2_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2@@0 n_2_1@@0)))
 :qid |stdinbpl.3056:25|
 :skolemid |326|
 :pattern ( (neverTriggered33 n_2@@0) (neverTriggered33 n_2_1@@0))
)) (=> (= (ControlFlow 0 65) (- 0 64)) (forall ((n_2@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n_2@@1 next) NoPerm)))
 :qid |stdinbpl.3063:25|
 :skolemid |327|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@11) n_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_2@@1 next))
)))))))
(let ((anon33_correct true))
(let ((anon90_Then_correct  (=> (and (select g0@@10 u_15) (select g1@@10 v_15)) (and (=> (= (ControlFlow 0 67) 65) anon91_Then_correct) (=> (= (ControlFlow 0 67) 62) anon33_correct)))))
(let ((anon90_Else_correct  (=> (and (not (and (select g0@@10 u_15) (select g1@@10 v_15))) (= (ControlFlow 0 63) 62)) anon33_correct)))
(let ((anon86_Else_correct  (=> (forall ((n$4_1 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_1 next) null))) (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_1 next)))
 :qid |stdinbpl.3035:20|
 :skolemid |325|
 :pattern ( (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_1 next)))
 :pattern ( (select (|Set#Union_37395| g0@@10 g1@@10) n$4_1) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_1 next))
...
(let ((anon88_Else_correct  (=> (and (not (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_5) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_5 next) null)))) (= (ControlFlow 0 58) 55)) anon28_correct)))
(let ((anon88_Then_correct  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_5) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_5 next) null))) (and (=> (= (ControlFlow 0 56) (- 0 57)) (HasDirectPerm_37315_37316 QPMask@6 n$4_5 next)) (=> (HasDirectPerm_37315_37316 QPMask@6 n$4_5 next) (=> (= (ControlFlow 0 56) 55) anon28_correct))))))
(let ((anon87_Else_correct  (=> (not (select (|Set#Union_37395| g0@@10 g1@@10) n$4_5)) (and (=> (= (ControlFlow 0 61) 56) anon88_Then_correct) (=> (= (ControlFlow 0 61) 58) anon88_Else_correct)))))
(let ((anon87_Then_correct  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n$4_5) (and (=> (= (ControlFlow 0 59) (- 0 60)) (HasDirectPerm_37315_37316 QPMask@6 n$4_5 next)) (=> (HasDirectPerm_37315_37316 QPMask@6 n$4_5 next) (and (=> (= (ControlFlow 0 59) 56) anon88_Then_correct) (=> (= (ControlFlow 0 59) 58) anon88_Else_correct)))))))
(let ((anon85_Else_correct  (and (=> (= (ControlFlow 0 98) (- 0 99)) (forall ((n$3_1 T@Ref) (n$3_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_1 n$3_1_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_1 n$3_1_1)))
 :qid |stdinbpl.2990:15|
 :skolemid |319|
))) (=> (forall ((n$3_1@@0 T@Ref) (n$3_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_1@@0 n$3_1_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_1@@0 n$3_1_1@@0)))
 :qid |stdinbpl.2990:15|
 :skolemid |319|
)) (=> (and (and (forall ((n$3_1@@1 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$3_1@@1) (< NoPerm FullPerm)) (and (qpRange32 n$3_1@@1) (= (invRecv32 n$3_1@@1) n$3_1@@1)))
 :qid |stdinbpl.2996:22|
 :skolemid |320|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n$3_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv32 o_9)) (< NoPerm FullPerm)) (qpRange32 o_9)) (= (invRecv32 o_9) o_9))
 :qid |stdinbpl.3000:22|
 :skolemid |321|
 :pattern ( (invRecv32 o_9))
))) (and (forall ((n$3_1@@2 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n$3_1@@2) (not (= n$3_1@@2 null)))
 :qid |stdinbpl.3006:22|
 :skolemid |322|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n$3_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv32 o_9@@0)) (< NoPerm FullPerm)) (qpRange32 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv32 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) o_9@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv32 o_9@@0)) (< NoPerm FullPerm)) (qpRange32 o_9@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) o_9@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.3012:22|
 :skolemid |323|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) o_9@@0 next))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@6) o_9@@1 f_5)))
 :qid |stdinbpl.3016:29|
 :skolemid |324|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@6) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_58602_58603) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) o_9@@2 f_5@@0)))
 :qid |stdinbpl.3016:29|
 :skolemid |324|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@6) o_9@@3 f_5@@1)))
 :qid |stdinbpl.3016:29|
 :skolemid |324|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@6) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@6) o_9@@4 f_5@@2)))
 :qid |stdinbpl.3016:29|
 :skolemid |324|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@6) o_9@@4 f_5@@2))
...
(let ((anon84_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (select (|Set#Union_37395| g0@@10 g1@@10) null))) (and (=> (= (ControlFlow 0 100) 54) anon85_Then_correct) (=> (= (ControlFlow 0 100) 98) anon85_Else_correct)))))
(let ((anon72_correct true))
(let ((anon113_Else_correct  (=> (and (not (and (select g1@@10 u_10) (and (select g1@@10 v_10) (exists_path ($$ Heap@@41 g0@@10) u_10 v_10)))) (= (ControlFlow 0 44) 41)) anon72_correct)))
(let ((anon113_Then_correct  (=> (and (select g1@@10 u_10) (and (select g1@@10 v_10) (exists_path ($$ Heap@@41 g0@@10) u_10 v_10))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_10 v_10)) (=> (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_10 v_10) (=> (= (ControlFlow 0 42) 41) anon72_correct))))))
(let ((anon112_Else_correct true))
(let ((anon110_Else_correct  (=> (forall ((u_9_1 T@Ref) (v_9_1 T@Ref) ) (!  (=> (and (select g0@@10 u_9_1) (and (select g0@@10 v_9_1) (exists_path ($$ Heap@@41 g0@@10) u_9_1 v_9_1))) (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_9_1 v_9_1))
 :qid |stdinbpl.3485:20|
 :skolemid |369|
 :pattern ( (select g0@@10 u_9_1) (select g0@@10 v_9_1))
 :pattern ( (select g0@@10 u_9_1) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_9_1 v_9_1))
 :pattern ( (select g0@@10 u_9_1) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_9_1 v_9_1))
 :pattern ( (select g0@@10 v_9_1) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_9_1 v_9_1))
 :pattern ( (select g0@@10 v_9_1) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_9_1 v_9_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_9_1 v_9_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_9_1 v_9_1))
...
(let ((anon111_Else_correct  (=> (and (not (and (select g0@@10 u_8_2) (and (select g0@@10 v_8_2) (exists_path ($$ Heap@@41 g0@@10) u_8_2 v_8_2)))) (= (ControlFlow 0 39) 36)) anon68_correct)))
(let ((anon111_Then_correct  (=> (and (select g0@@10 u_8_2) (and (select g0@@10 v_8_2) (exists_path ($$ Heap@@41 g0@@10) u_8_2 v_8_2))) (and (=> (= (ControlFlow 0 37) (- 0 38)) (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_8_2 v_8_2)) (=> (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_8_2 v_8_2) (=> (= (ControlFlow 0 37) 36) anon68_correct))))))
(let ((anon108_Else_correct  (=> (forall ((u_7_1 T@Ref) (v_7_1 T@Ref) ) (!  (=> (and (select g0@@10 u_7_1) (select g1@@10 v_7_1)) (not (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_7_1 v_7_1)))
 :qid |stdinbpl.3474:20|
 :skolemid |368|
 :pattern ( (select g0@@10 u_7_1) (select g1@@10 v_7_1))
 :pattern ( (select g0@@10 u_7_1) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_7_1 v_7_1))
 :pattern ( (select g1@@10 v_7_1) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_7_1 v_7_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_7_1 v_7_1))
...
(let ((anon109_Else_correct  (=> (and (not (and (select g0@@10 u_6_1) (select g1@@10 v_6_1))) (= (ControlFlow 0 35) 32)) anon64_correct)))
(let ((anon109_Then_correct  (=> (and (select g0@@10 u_6_1) (select g1@@10 v_6_1)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (not (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_6_1 v_6_1))) (=> (not (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_6_1 v_6_1)) (=> (= (ControlFlow 0 33) 32) anon64_correct))))))
(let ((anon106_Else_correct  (=> (forall ((n$4_3_1 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_3_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_3_1 next) null))) (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_3_1 next)))
 :qid |stdinbpl.3463:20|
 :skolemid |367|
 :pattern ( (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_3_1 next)))
 :pattern ( (select (|Set#Union_37395| g0@@10 g1@@10) n$4_3_1) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_3_1 next))
...
(let ((anon107_Else_correct  (=> (and (not (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_2) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2 next) null)))) (= (ControlFlow 0 31) 28)) anon60_correct)))
(let ((anon107_Then_correct  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_2) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2 next) null))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2 next))) (=> (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2 next)) (=> (= (ControlFlow 0 29) 28) anon60_correct))))))
(let ((anon105_Else_correct  (=> (apply_TCFraming Heap@@41 g0@@10 g1@@10) (=> (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 48) (- 0 51)) (not (select (|Set#Union_37395| g0@@10 g1@@10) null))) (=> (not (select (|Set#Union_37395| g0@@10 g1@@10) null)) (and (=> (= (ControlFlow 0 48) (- 0 50)) (forall ((n$3_2 T@Ref) (n$3_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_2 n$3_2_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_2 n$3_2_1)))
 :qid |stdinbpl.3422:17|
 :skolemid |361|
 :pattern ( (neverTriggered38 n$3_2) (neverTriggered38 n$3_2_1))
))) (=> (forall ((n$3_2@@0 T@Ref) (n$3_2_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_2@@0 n$3_2_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_2@@0 n$3_2_1@@0)))
 :qid |stdinbpl.3422:17|
 :skolemid |361|
 :pattern ( (neverTriggered38 n$3_2@@0) (neverTriggered38 n$3_2_1@@0))
)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (forall ((n$3_2@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2@@1) (>= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$3_2@@1 next) FullPerm))
 :qid |stdinbpl.3429:17|
 :skolemid |362|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n$3_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@1 next))
))) (=> (forall ((n$3_2@@2 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2@@2) (>= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$3_2@@2 next) FullPerm))
 :qid |stdinbpl.3429:17|
 :skolemid |362|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n$3_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@2 next))
)) (=> (forall ((n$3_2@@3 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2@@3) (< NoPerm FullPerm)) (and (qpRange38 n$3_2@@3) (= (invRecv38 n$3_2@@3) n$3_2@@3)))
 :qid |stdinbpl.3435:22|
 :skolemid |363|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n$3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@3 next))
)) (=> (and (forall ((o_9@@5 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv38 o_9@@5)) (and (< NoPerm FullPerm) (qpRange38 o_9@@5))) (= (invRecv38 o_9@@5) o_9@@5))
 :qid |stdinbpl.3439:22|
 :skolemid |364|
 :pattern ( (invRecv38 o_9@@5))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv38 o_9@@6)) (and (< NoPerm FullPerm) (qpRange38 o_9@@6))) (and (= (invRecv38 o_9@@6) o_9@@6) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) o_9@@6 next) (- (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@6 next) FullPerm)))) (=> (not (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv38 o_9@@6)) (and (< NoPerm FullPerm) (qpRange38 o_9@@6)))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) o_9@@6 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@6 next))))
 :qid |stdinbpl.3445:22|
 :skolemid |365|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) o_9@@6 next))
))) (=> (and (and (and (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_9@@7 f_5@@3) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@5) o_9@@7 f_5@@3)))
 :qid |stdinbpl.3451:29|
 :skolemid |366|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@5) o_9@@7 f_5@@3))
)) (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_58602_58603) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@8 f_5@@4) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) o_9@@8 f_5@@4)))
 :qid |stdinbpl.3451:29|
 :skolemid |366|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) o_9@@8 f_5@@4))
))) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_9@@9 f_5@@5) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@5) o_9@@9 f_5@@5)))
 :qid |stdinbpl.3451:29|
 :skolemid |366|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@5) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_9@@10 f_5@@6) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@5) o_9@@10 f_5@@6)))
 :qid |stdinbpl.3451:29|
 :skolemid |366|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@5) o_9@@10 f_5@@6))
...
(let ((anon105_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 27)) (forall ((n_8 T@Ref) (n_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_8 n_8_1)) (select g0@@10 n_8)) (select g0@@10 n_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_8 n_8_1)))
 :qid |stdinbpl.3348:21|
 :skolemid |353|
...
)) (and (=> (= (ControlFlow 0 23) (- 0 26)) (forall ((n_8@@1 T@Ref) ) (!  (=> (select g0@@10 n_8@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_8@@1 next) NoPerm)))
 :qid |stdinbpl.3355:21|
 :skolemid |354|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_8@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@3) n_8@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_8@@1 next))
))) (=> (forall ((n_8@@2 T@Ref) ) (!  (=> (select g0@@10 n_8@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_8@@2 next) NoPerm)))
 :qid |stdinbpl.3355:21|
 :skolemid |354|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_8@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@3) n_8@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_8@@2 next))
)) (=> (and (forall ((n_8@@3 T@Ref) ) (!  (=> (and (select g0@@10 n_8@@3) (< NoPerm FullPerm)) (and (qpRange40 n_8@@3) (= (invRecv40 n_8@@3) n_8@@3)))
 :qid |stdinbpl.3361:26|
 :skolemid |355|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_8@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@3) n_8@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_8@@3 next))
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (select g0@@10 (invRecv40 o_9@@11)) (and (< NoPerm FullPerm) (qpRange40 o_9@@11))) (= (invRecv40 o_9@@11) o_9@@11))
 :qid |stdinbpl.3365:26|
 :skolemid |356|
 :pattern ( (invRecv40 o_9@@11))
))) (and (=> (= (ControlFlow 0 23) (- 0 25)) (forall ((n_9 T@Ref) (n_9_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_9 n_9_1)) (select g1@@10 n_9)) (select g1@@10 n_9_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_9 n_9_1)))
 :qid |stdinbpl.3376:21|
 :skolemid |357|
 :pattern ( (neverTriggered41 n_9) (neverTriggered41 n_9_1))
))) (=> (forall ((n_9@@0 T@Ref) (n_9_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_9@@0 n_9_1@@0)) (select g1@@10 n_9@@0)) (select g1@@10 n_9_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_9@@0 n_9_1@@0)))
 :qid |stdinbpl.3376:21|
 :skolemid |357|
 :pattern ( (neverTriggered41 n_9@@0) (neverTriggered41 n_9_1@@0))
)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((n_9@@1 T@Ref) ) (!  (=> (select g1@@10 n_9@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_9@@1 next) NoPerm)))
 :qid |stdinbpl.3383:21|
 :skolemid |358|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_9@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_9@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_9@@1 next))
))) (=> (forall ((n_9@@2 T@Ref) ) (!  (=> (select g1@@10 n_9@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_9@@2 next) NoPerm)))
 :qid |stdinbpl.3383:21|
 :skolemid |358|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_9@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_9@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_9@@2 next))
)) (=> (forall ((n_9@@3 T@Ref) ) (!  (=> (and (select g1@@10 n_9@@3) (< NoPerm FullPerm)) (and (qpRange41 n_9@@3) (= (invRecv41 n_9@@3) n_9@@3)))
 :qid |stdinbpl.3389:26|
 :skolemid |359|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_9@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_9@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_9@@3 next))
)) (=> (and (forall ((o_9@@12 T@Ref) ) (!  (=> (and (select g1@@10 (invRecv41 o_9@@12)) (and (< NoPerm FullPerm) (qpRange41 o_9@@12))) (= (invRecv41 o_9@@12) o_9@@12))
 :qid |stdinbpl.3393:26|
 :skolemid |360|
 :pattern ( (invRecv41 o_9@@12))
)) (= (ControlFlow 0 23) (- 0 22))) (|Set#Equal_37295| (|Set#Intersection_37295| g1@@10 g0@@10) |Set#Empty_37301|))))))))))))))
(let ((anon104_Else_correct  (=> (and (and (apply_noExit ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) (|Set#Union_37395| g0@@10 g1@@10) g0@@10) (state Heap@@41 QPMask@1)) (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1))) (and (=> (= (ControlFlow 0 52) 23) anon105_Then_correct) (=> (= (ControlFlow 0 52) 48) anon105_Else_correct)))))
(let ((anon104_Then_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_7)) (select (|Set#Union_37395| g0@@10 g1@@10) n_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1)))
 :qid |stdinbpl.3301:21|
 :skolemid |349|
...
)) (=> (= (ControlFlow 0 20) (- 0 19)) (forall ((n_7@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_7@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_7@@1 next) NoPerm)))
 :qid |stdinbpl.3308:21|
 :skolemid |350|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@2) n_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@1 next))
)))))))
(let ((anon84_Else_correct  (=> (state Heap@@41 QPMask@1) (and (=> (= (ControlFlow 0 53) 20) anon104_Then_correct) (=> (= (ControlFlow 0 53) 52) anon104_Else_correct)))))
(let ((anon83_Else_correct  (=> (and (forall ((r$0_1 T@Ref) ) (!  (=> (select g1@@10 r$0_1) (not (select g0@@10 r$0_1)))
 :qid |stdinbpl.2966:20|
 :skolemid |318|
 :pattern ( (select g0@@10 r$0_1) (select g1@@10 r$0_1))
)) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 101) 100) anon84_Then_correct) (=> (= (ControlFlow 0 101) 53) anon84_Else_correct)))))
(let ((anon83_Then_correct true))
(let ((anon82_Else_correct  (=> (forall ((r_1_1 T@Ref) ) (!  (=> (select g0@@10 r_1_1) (not (select g1@@10 r_1_1)))
 :qid |stdinbpl.2957:20|
 :skolemid |317|
...
(let ((anon79_Else_correct  (=> (and (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g1@@10 n$2_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1 next) null))) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1 next)))
 :qid |stdinbpl.2947:20|
 :skolemid |316|
...
)) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 103) 17) anon82_Then_correct) (=> (= (ControlFlow 0 103) 102) anon82_Else_correct)))))
(let ((anon15_correct true))
(let ((anon81_Else_correct  (=> (and (not (and (select g1@@10 n$2_16) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_16 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon81_Then_correct  (=> (and (select g1@@10 n$2_16) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_16 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_37315_37316 QPMask@1 n$2_16 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_16 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon80_Else_correct  (=> (not (select g1@@10 n$2_16)) (and (=> (= (ControlFlow 0 16) 11) anon81_Then_correct) (=> (= (ControlFlow 0 16) 13) anon81_Else_correct)))))
(let ((anon80_Then_correct  (=> (select g1@@10 n$2_16) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_37315_37316 QPMask@1 n$2_16 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_16 next) (and (=> (= (ControlFlow 0 14) 11) anon81_Then_correct) (=> (= (ControlFlow 0 14) 13) anon81_Else_correct)))))))
(let ((anon78_Else_correct  (and (=> (= (ControlFlow 0 104) (- 0 105)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@10 n$1_1)) (select g1@@10 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :qid |stdinbpl.2902:15|
 :skolemid |310|
)) (=> (and (and (forall ((n$1_1@@1 T@Ref) ) (!  (=> (and (select g1@@10 n$1_1@@1) (< NoPerm FullPerm)) (and (qpRange31 n$1_1@@1) (= (invRecv31 n$1_1@@1) n$1_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@1 next))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv31 o_9@@13)) (< NoPerm FullPerm)) (qpRange31 o_9@@13)) (= (invRecv31 o_9@@13) o_9@@13))
 :qid |stdinbpl.2912:22|
 :skolemid |312|
 :pattern ( (invRecv31 o_9@@13))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@2 next))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv31 o_9@@14)) (< NoPerm FullPerm)) (qpRange31 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv31 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@14 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@14 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv31 o_9@@14)) (< NoPerm FullPerm)) (qpRange31 o_9@@14))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@14 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@14 next))))
...
))) (state Heap@@41 QPMask@1)) (and (and (=> (= (ControlFlow 0 104) 103) anon79_Else_correct) (=> (= (ControlFlow 0 104) 14) anon80_Then_correct)) (=> (= (ControlFlow 0 104) 16) anon80_Else_correct))))))))
(let ((anon78_Then_correct true))
(let ((anon75_Else_correct  (=> (and (forall ((n$0_1 T@Ref) ) (!  (=> (and (select g0@@10 n$0_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_1 next) null))) (select g0@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_1 next)))
...
)) (not (select g1@@10 null))) (and (=> (= (ControlFlow 0 106) 9) anon78_Then_correct) (=> (= (ControlFlow 0 106) 104) anon78_Else_correct)))))
(let ((anon7_correct true))
(let ((anon77_Else_correct  (=> (and (not (and (select g0@@10 n$0_23) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_23 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon77_Then_correct  (=> (and (select g0@@10 n$0_23) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_23 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$0_23 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_23 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon76_Else_correct  (=> (not (select g0@@10 n$0_23)) (and (=> (= (ControlFlow 0 8) 3) anon77_Then_correct) (=> (= (ControlFlow 0 8) 5) anon77_Else_correct)))))
(let ((anon76_Then_correct  (=> (select g0@@10 n$0_23) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$0_23 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_23 next) (and (=> (= (ControlFlow 0 6) 3) anon77_Then_correct) (=> (= (ControlFlow 0 6) 5) anon77_Else_correct)))))))
(let ((anon74_Else_correct  (and (=> (= (ControlFlow 0 107) (- 0 108)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@10 n_1)) (select g0@@10 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 :qid |stdinbpl.2845:15|
 :skolemid |303|
 ...
 :qid |stdinbpl.2845:15|
 :skolemid |303|
)) (=> (and (and (forall ((n_1@@1 T@Ref) ) (!  (=> (and (select g0@@10 n_1@@1) (< NoPerm FullPerm)) (and (qpRange30 n_1@@1) (= (invRecv30 n_1@@1) n_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@1 next))
)) (forall ((o_9@@19 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv30 o_9@@19)) (< NoPerm FullPerm)) (qpRange30 o_9@@19)) (= (invRecv30 o_9@@19) o_9@@19))
 :qid |stdinbpl.2855:22|
 :skolemid |305|
 :pattern ( (invRecv30 o_9@@19))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@2 next))
)) (forall ((o_9@@20 T@Ref) ) (!  (and (=> (and (and (select g0@@10 (invRecv30 o_9@@20)) (< NoPerm FullPerm)) (qpRange30 o_9@@20)) (and (=> (< NoPerm FullPerm) (= (invRecv30 o_9@@20) o_9@@20)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@20 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@20 next) FullPerm)))) (=> (not (and (and (select g0@@10 (invRecv30 o_9@@20)) (< NoPerm FullPerm)) (qpRange30 o_9@@20))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@20 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@20 next))))
...
))) (state Heap@@41 QPMask@0)) (and (and (=> (= (ControlFlow 0 107) 106) anon75_Else_correct) (=> (= (ControlFlow 0 107) 6) anon76_Then_correct)) (=> (= (ControlFlow 0 107) 8) anon76_Else_correct))))))))
(let ((anon74_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (not (select g0@@10 null)))) (and (=> (= (ControlFlow 0 109) 1) anon74_Then_correct) (=> (= (ControlFlow 0 109) 107) anon74_Else_correct)))))
