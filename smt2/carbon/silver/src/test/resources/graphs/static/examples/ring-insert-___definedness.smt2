...
(let ((anon13_Else_correct  (=> (and (forall ((p_4_1 T@Ref) (s_4_1 T@Ref) ) (! (=  (and (select refs@@6 p_4_1) (and (select refs@@6 s_4_1) (and (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) p_4_1 next) s_4_1) (not (= p_4_1 s_4_1))))) (select Result (create_edge p_4_1 s_4_1)))
...
(let ((anon15_Then_correct  (=> (select refs@@6 s_5) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_48849_48850 QPMask@0 p_9 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 p_9 next) (=> (= (ControlFlow 0 4) 2) anon6_correct))))))
...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select refs@@6 n_3)) (select refs@@6 n_3_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_3 n_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_3@@4 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select refs@@6 (invRecv1 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@0 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@0 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select refs@@6 (invRecv1 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@0 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@0 next))))
 :qid |stdinbpl.1014:22|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@0 next))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@0) o_4@@1 f_5)))
...
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_74000_74001) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1018:29|
 :skolemid |126|
...
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1018:29|
 :skolemid |126|
...
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1018:29|
 :skolemid |126|
...
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1018:29|
 :skolemid |126|
