...
(let ((anon99_Else_correct  (=> (and (not (and (select g0@@10 n$1_2) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_2 next) null)))) (= (ControlFlow 0 126) 123)) anon24_correct)))
(let ((anon99_Then_correct  (=> (and (select g0@@10 n$1_2) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_2 next) null))) (and (=> (= (ControlFlow 0 124) (- 0 125)) (select g0@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_2 next))) (=> (select g0@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_2 next)) (=> (= (ControlFlow 0 124) 123) anon24_correct))))))
(let ((anon98_Else_correct  (=> (and (forall ((n$1_3_1_1 T@Ref) ) (!  (=> (and (select g0@@10 n$1_3_1_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_3_1_1 next) null))) (select g0@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_3_1_1 next)))
 :qid |stdinbpl.4294:24|
 :skolemid |445|
...
)) (= (ControlFlow 0 122) (- 0 121))) (select g0@@10 x0))))
(let ((anon97_Then_correct  (and (=> (= (ControlFlow 0 127) (- 0 130)) (not (select g0@@10 null))) (=> (not (select g0@@10 null)) (and (=> (= (ControlFlow 0 127) (- 0 129)) (forall ((n$0_2_1 T@Ref) (n$0_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_2_1 n$0_2_2)) (select g0@@10 n$0_2_1)) (select g0@@10 n$0_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_2_1 n$0_2_2)))
 :qid |stdinbpl.4266:21|
 :skolemid |441|
 :pattern ( (neverTriggered54 n$0_2_1) (neverTriggered54 n$0_2_2))
 ...
 :qid |stdinbpl.4266:21|
 :skolemid |441|
 :pattern ( (neverTriggered54 n$0_2_1@@0) (neverTriggered54 n$0_2_2@@0))
)) (and (=> (= (ControlFlow 0 127) (- 0 128)) (forall ((n$0_2_1@@1 T@Ref) ) (!  (=> (select g0@@10 n$0_2_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$0_2_1@@1 next) NoPerm)))
 :qid |stdinbpl.4273:21|
 :skolemid |442|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_2_1@@2 next))
)) (=> (and (forall ((n$0_2_1@@3 T@Ref) ) (!  (=> (and (select g0@@10 n$0_2_1@@3) (< NoPerm FullPerm)) (and (qpRange54 n$0_2_1@@3) (= (invRecv54 n$0_2_1@@3) n$0_2_1@@3)))
 :qid |stdinbpl.4279:26|
 :skolemid |443|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_2_1@@3 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select g0@@10 (invRecv54 o_4)) (and (< NoPerm FullPerm) (qpRange54 o_4))) (= (invRecv54 o_4) o_4))
 :qid |stdinbpl.4283:26|
 :skolemid |444|
...
(let ((anon102_Else_correct  (=> (and (not (and (select g1@@10 n$1_4) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_4 next) null)))) (= (ControlFlow 0 115) 112)) anon30_correct)))
(let ((anon102_Then_correct  (=> (and (select g1@@10 n$1_4) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_4 next) null))) (and (=> (= (ControlFlow 0 113) (- 0 114)) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_4 next))) (=> (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_4 next)) (=> (= (ControlFlow 0 113) 112) anon30_correct))))))
(let ((anon101_Else_correct  (=> (and (forall ((n$1_5_1_1 T@Ref) ) (!  (=> (and (select g1@@10 n$1_5_1_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_5_1_1 next) null))) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_5_1_1 next)))
 :qid |stdinbpl.4353:24|
 :skolemid |450|
...
)) (= (ControlFlow 0 111) (- 0 110))) (select g1@@10 x1_2))))
(let ((anon100_Then_correct  (and (=> (= (ControlFlow 0 116) (- 0 119)) (not (select g1@@10 null))) (=> (not (select g1@@10 null)) (and (=> (= (ControlFlow 0 116) (- 0 118)) (forall ((n$0_3_2 T@Ref) (n$0_3_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_3_2 n$0_3_3)) (select g1@@10 n$0_3_2)) (select g1@@10 n$0_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_3_2 n$0_3_3)))
 :qid |stdinbpl.4325:21|
 :skolemid |446|
 :pattern ( (neverTriggered55 n$0_3_2) (neverTriggered55 n$0_3_3))
 ...
 :qid |stdinbpl.4325:21|
 :skolemid |446|
 :pattern ( (neverTriggered55 n$0_3_2@@0) (neverTriggered55 n$0_3_3@@0))
)) (and (=> (= (ControlFlow 0 116) (- 0 117)) (forall ((n$0_3_2@@1 T@Ref) ) (!  (=> (select g1@@10 n$0_3_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$0_3_2@@1 next) NoPerm)))
 :qid |stdinbpl.4332:21|
 :skolemid |447|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3_2@@2 next))
)) (=> (and (forall ((n$0_3_2@@3 T@Ref) ) (!  (=> (and (select g1@@10 n$0_3_2@@3) (< NoPerm FullPerm)) (and (qpRange55 n$0_3_2@@3) (= (invRecv55 n$0_3_2@@3) n$0_3_2@@3)))
 :qid |stdinbpl.4338:26|
 :skolemid |448|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3_2@@3 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (select g1@@10 (invRecv55 o_4@@0)) (and (< NoPerm FullPerm) (qpRange55 o_4@@0))) (= (invRecv55 o_4@@0) o_4@@0))
 :qid |stdinbpl.4342:26|
 :skolemid |449|
 :pattern ( (invRecv55 o_4@@0))
...
(let ((anon105_Else_correct  (=> (and (not (and (select g0@@10 n$0_4) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4 next) null)))) (= (ControlFlow 0 104) 101)) anon36_correct)))
(let ((anon105_Then_correct  (=> (and (select g0@@10 n$0_4) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4 next) null))) (and (=> (= (ControlFlow 0 102) (- 0 103)) (select g0@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4 next))) (=> (select g0@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4 next)) (=> (= (ControlFlow 0 102) 101) anon36_correct))))))
(let ((anon104_Else_correct true))
(let ((anon103_Then_correct  (and (=> (= (ControlFlow 0 105) (- 0 108)) (not (select g0@@10 null))) (=> (not (select g0@@10 null)) (and (=> (= (ControlFlow 0 105) (- 0 107)) (forall ((n_2 T@Ref) (n_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_2 n_2_1)) (select g0@@10 n_2)) (select g0@@10 n_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1)))
...
)) (and (=> (= (ControlFlow 0 105) (- 0 106)) (forall ((n_2@@1 T@Ref) ) (!  (=> (select g0@@10 n_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_2@@1 next) NoPerm)))
 :qid |stdinbpl.4391:21|
 :skolemid |452|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_2@@1 next))
))) (=> (forall ((n_2@@2 T@Ref) ) (!  (=> (select g0@@10 n_2@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_2@@2 next) NoPerm)))
 :qid |stdinbpl.4391:21|
 :skolemid |452|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_2@@2 next))
)) (=> (and (forall ((n_2@@3 T@Ref) ) (!  (=> (and (select g0@@10 n_2@@3) (< NoPerm FullPerm)) (and (qpRange56 n_2@@3) (= (invRecv56 n_2@@3) n_2@@3)))
 :qid |stdinbpl.4397:26|
 :skolemid |453|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_2@@3 next))
)) (forall ((o_4@@1 T@Ref) ) (!  (=> (and (select g0@@10 (invRecv56 o_4@@1)) (and (< NoPerm FullPerm) (qpRange56 o_4@@1))) (= (invRecv56 o_4@@1) o_4@@1))
 :qid |stdinbpl.4401:26|
 :skolemid |454|
 :pattern ( (invRecv56 o_4@@1))
...
(let ((anon108_Else_correct  (=> (and (not (and (select g1@@10 n$0_6) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_6 next) null)))) (= (ControlFlow 0 94) 91)) anon42_correct)))
(let ((anon108_Then_correct  (=> (and (select g1@@10 n$0_6) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_6 next) null))) (and (=> (= (ControlFlow 0 92) (- 0 93)) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_6 next))) (=> (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_6 next)) (=> (= (ControlFlow 0 92) 91) anon42_correct))))))
(let ((anon107_Else_correct true))
(let ((anon106_Then_correct  (and (=> (= (ControlFlow 0 95) (- 0 98)) (not (select g1@@10 null))) (=> (not (select g1@@10 null)) (and (=> (= (ControlFlow 0 95) (- 0 97)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select g1@@10 n_3)) (select g1@@10 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
...
)) (and (=> (= (ControlFlow 0 95) (- 0 96)) (forall ((n_3@@1 T@Ref) ) (!  (=> (select g1@@10 n_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_3@@1 next) NoPerm)))
 :qid |stdinbpl.4448:21|
 :skolemid |457|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@1 next))
))) (=> (forall ((n_3@@2 T@Ref) ) (!  (=> (select g1@@10 n_3@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_3@@2 next) NoPerm)))
 :qid |stdinbpl.4448:21|
 :skolemid |457|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n_3@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@2 next))
)) (=> (and (forall ((n_3@@3 T@Ref) ) (!  (=> (and (select g1@@10 n_3@@3) (< NoPerm FullPerm)) (and (qpRange57 n_3@@3) (= (invRecv57 n_3@@3) n_3@@3)))
 :qid |stdinbpl.4454:26|
 :skolemid |458|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n_3@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@3 next))
)) (forall ((o_4@@2 T@Ref) ) (!  (=> (and (select g1@@10 (invRecv57 o_4@@2)) (and (< NoPerm FullPerm) (qpRange57 o_4@@2))) (= (invRecv57 o_4@@2) o_4@@2))
 :qid |stdinbpl.4458:26|
 :skolemid |459|
 :pattern ( (invRecv57 o_4@@2))
...
(let ((anon116_Else_correct  (=> (and (not (and (select (|Set#Union_37395| g0@@10 g1@@10) n$1_6) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$1_6 next) null)))) (= (ControlFlow 0 80) 77)) anon57_correct)))
(let ((anon116_Then_correct  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$1_6) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$1_6 next) null))) (and (=> (= (ControlFlow 0 78) (- 0 79)) (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$1_6 next))) (=> (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$1_6 next)) (=> (= (ControlFlow 0 78) 77) anon57_correct))))))
(let ((anon115_Else_correct  (=> (and (forall ((n$1_7_1_1 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$1_7_1_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$1_7_1_1 next) null))) (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$1_7_1_1 next)))
 :qid |stdinbpl.4595:24|
 :skolemid |472|
 :pattern ( (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$1_7_1_1 next)))
 :pattern ( (select (|Set#Union_37395| g0@@10 g1@@10) n$1_7_1_1) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$1_7_1_1 next))
)) (= (ControlFlow 0 76) (- 0 75))) (|Set#Subset_37790| (|Set#UnionOne_38322| (|Set#Singleton_38322| x1_2) x0) (|Set#Union_37395| g0@@10 g1@@10)))))
(let ((anon114_Then_correct  (and (=> (= (ControlFlow 0 81) (- 0 84)) (not (select (|Set#Union_37395| g0@@10 g1@@10) null))) (=> (not (select (|Set#Union_37395| g0@@10 g1@@10) null)) (and (=> (= (ControlFlow 0 81) (- 0 83)) (forall ((n$0_8 T@Ref) (n$0_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_8 n$0_8_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n$0_8)) (select (|Set#Union_37395| g0@@10 g1@@10) n$0_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_8 n$0_8_1)))
 :qid |stdinbpl.4567:21|
 :skolemid |468|
 :pattern ( (neverTriggered59 n$0_8) (neverTriggered59 n$0_8_1))
))) (=> (forall ((n$0_8@@0 T@Ref) (n$0_8_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_8@@0 n$0_8_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n$0_8@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n$0_8_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_8@@0 n$0_8_1@@0)))
 :qid |stdinbpl.4567:21|
 :skolemid |468|
 :pattern ( (neverTriggered59 n$0_8@@0) (neverTriggered59 n$0_8_1@@0))
)) (and (=> (= (ControlFlow 0 81) (- 0 82)) (forall ((n$0_8@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n$0_8@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) n$0_8@@1 next) NoPerm)))
 :qid |stdinbpl.4574:21|
 :skolemid |469|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$0_8@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@10) n$0_8@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$0_8@@1 next))
))) (=> (forall ((n$0_8@@2 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n$0_8@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) n$0_8@@2 next) NoPerm)))
 :qid |stdinbpl.4574:21|
 :skolemid |469|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$0_8@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@10) n$0_8@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$0_8@@2 next))
)) (=> (and (forall ((n$0_8@@3 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$0_8@@3) (< NoPerm FullPerm)) (and (qpRange59 n$0_8@@3) (= (invRecv59 n$0_8@@3) n$0_8@@3)))
 :qid |stdinbpl.4580:26|
 :skolemid |470|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$0_8@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@10) n$0_8@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$0_8@@3 next))
)) (forall ((o_4@@3 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv59 o_4@@3)) (and (< NoPerm FullPerm) (qpRange59 o_4@@3))) (= (invRecv59 o_4@@3) o_4@@3))
 :qid |stdinbpl.4584:26|
 :skolemid |471|
 :pattern ( (invRecv59 o_4@@3))
...
(let ((anon119_Else_correct  (=> (and (not (and (select (|Set#Union_37395| g0@@10 g1@@10) n$0_9) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$0_9 next) null)))) (= (ControlFlow 0 69) 66)) anon63_correct)))
(let ((anon119_Then_correct  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$0_9) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$0_9 next) null))) (and (=> (= (ControlFlow 0 67) (- 0 68)) (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$0_9 next))) (=> (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$0_9 next)) (=> (= (ControlFlow 0 67) 66) anon63_correct))))))
(let ((anon118_Else_correct true))
(let ((anon117_Then_correct  (and (=> (= (ControlFlow 0 70) (- 0 73)) (not (select (|Set#Union_37395| g0@@10 g1@@10) null))) (=> (not (select (|Set#Union_37395| g0@@10 g1@@10) null)) (and (=> (= (ControlFlow 0 70) (- 0 72)) (forall ((n_4_1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1 n_4_2)) (select (|Set#Union_37395| g0@@10 g1@@10) n_4_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1 n_4_2)))
 :qid |stdinbpl.4626:21|
 :skolemid |473|
 :pattern ( (neverTriggered60 n_4_1) (neverTriggered60 n_4_2))
 ...
 :qid |stdinbpl.4626:21|
 :skolemid |473|
 :pattern ( (neverTriggered60 n_4_1@@0) (neverTriggered60 n_4_2@@0))
)) (and (=> (= (ControlFlow 0 70) (- 0 71)) (forall ((n_4_1@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_4_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) n_4_1@@1 next) NoPerm)))
 :qid |stdinbpl.4633:21|
 :skolemid |474|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_4_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@11) n_4_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_4_1@@1 next))
))) (=> (forall ((n_4_1@@2 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_4_1@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) n_4_1@@2 next) NoPerm)))
 :qid |stdinbpl.4633:21|
 :skolemid |474|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_4_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@11) n_4_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_4_1@@2 next))
)) (=> (and (forall ((n_4_1@@3 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n_4_1@@3) (< NoPerm FullPerm)) (and (qpRange60 n_4_1@@3) (= (invRecv60 n_4_1@@3) n_4_1@@3)))
 :qid |stdinbpl.4639:26|
 :skolemid |475|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@11) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_4_1@@3 next))
)) (forall ((o_4@@4 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv60 o_4@@4)) (and (< NoPerm FullPerm) (qpRange60 o_4@@4))) (= (invRecv60 o_4@@4) o_4@@4))
 :qid |stdinbpl.4643:26|
 :skolemid |476|
 :pattern ( (invRecv60 o_4@@4))
...
(let ((anon121_Else_correct  (=> (forall ((r$1_1 T@Ref) ) (!  (=> (select g0@@10 r$1_1) (not (select g1@@10 r$1_1)))
 :qid |stdinbpl.4716:20|
 :skolemid |482|
 :pattern ( (select g0@@10 r$1_1) (select g1@@10 r$1_1))
)) (and (=> (= (ControlFlow 0 62) 60) anon122_Then_correct) (=> (= (ControlFlow 0 62) 61) anon122_Else_correct)))))
(let ((anon121_Then_correct true))
(let ((anon120_Else_correct  (=> (and (unshared_graph ($$ PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10))) (state PostHeap@0 QPMask@9)) (and (=> (= (ControlFlow 0 63) 59) anon121_Then_correct) (=> (= (ControlFlow 0 63) 62) anon121_Else_correct)))))
(let ((anon120_Then_correct  (and (=> (= (ControlFlow 0 57) (- 0 58)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_5)) (select (|Set#Union_37395| g0@@10 g1@@10) n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1)))
 :qid |stdinbpl.4681:21|
 :skolemid |478|
...
)) (=> (= (ControlFlow 0 57) (- 0 56)) (forall ((n_5@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_5@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) n_5@@1 next) NoPerm)))
 :qid |stdinbpl.4688:21|
 :skolemid |479|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@12) n_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_5@@1 next))
)))))))
(let ((anon117_Else_correct  (=> (acyclic_list_segment PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10)) (=> (and (state PostHeap@0 QPMask@9) (state PostHeap@0 QPMask@9)) (and (=> (= (ControlFlow 0 64) 57) anon120_Then_correct) (=> (= (ControlFlow 0 64) 63) anon120_Else_correct))))))
(let ((anon114_Else_correct  (=> (is_global_sroot PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10) (|Set#UnionOne_38322| (|Set#Singleton_38322| x1_2) x0)) (=> (and (state PostHeap@0 QPMask@9) (state PostHeap@0 QPMask@9)) (and (=> (= (ControlFlow 0 74) 70) anon117_Then_correct) (=> (= (ControlFlow 0 74) 64) anon117_Else_correct))))))
(let ((anon111_Else_correct  (=> (forall ((n$4_1_2 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_1_2) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_1_2 next) null))) (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_1_2 next)))
 :qid |stdinbpl.4546:20|
 :skolemid |467|
...
(let ((anon113_Else_correct  (=> (and (not (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_8) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_8 next) null)))) (= (ControlFlow 0 52) 49)) anon52_correct)))
(let ((anon113_Then_correct  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_8) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_8 next) null))) (and (=> (= (ControlFlow 0 50) (- 0 51)) (HasDirectPerm_37315_37316 QPMask@9 n$4_8 next)) (=> (HasDirectPerm_37315_37316 QPMask@9 n$4_8 next) (=> (= (ControlFlow 0 50) 49) anon52_correct))))))
(let ((anon112_Else_correct  (=> (not (select (|Set#Union_37395| g0@@10 g1@@10) n$4_8)) (and (=> (= (ControlFlow 0 55) 50) anon113_Then_correct) (=> (= (ControlFlow 0 55) 52) anon113_Else_correct)))))
(let ((anon112_Then_correct  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n$4_8) (and (=> (= (ControlFlow 0 53) (- 0 54)) (HasDirectPerm_37315_37316 QPMask@9 n$4_8 next)) (=> (HasDirectPerm_37315_37316 QPMask@9 n$4_8 next) (and (=> (= (ControlFlow 0 53) 50) anon113_Then_correct) (=> (= (ControlFlow 0 53) 52) anon113_Else_correct)))))))
(let ((anon110_Else_correct  (and (=> (= (ControlFlow 0 86) (- 0 87)) (forall ((n$3_1_2 T@Ref) (n$3_1_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_1_2 n$3_1_3)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_1_2)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_1_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_1_2 n$3_1_3)))
 :qid |stdinbpl.4501:15|
 :skolemid |461|
 ...
 :qid |stdinbpl.4501:15|
 :skolemid |461|
)) (=> (and (and (forall ((n$3_1_2@@1 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$3_1_2@@1) (< NoPerm FullPerm)) (and (qpRange58 n$3_1_2@@1) (= (invRecv58 n$3_1_2@@1) n$3_1_2@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) n$3_1_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1_2@@1 next))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv58 o_4@@5)) (< NoPerm FullPerm)) (qpRange58 o_4@@5)) (= (invRecv58 o_4@@5) o_4@@5))
 :qid |stdinbpl.4511:22|
 :skolemid |463|
 :pattern ( (invRecv58 o_4@@5))
))) (and (forall ((n$3_1_2@@2 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n$3_1_2@@2) (not (= n$3_1_2@@2 null)))
 :qid |stdinbpl.4517:22|
 :skolemid |464|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) n$3_1_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1_2@@2 next))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv58 o_4@@6)) (< NoPerm FullPerm)) (qpRange58 o_4@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv58 o_4@@6) o_4@@6)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) o_4@@6 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@6 next) FullPerm)))) (=> (not (and (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv58 o_4@@6)) (< NoPerm FullPerm)) (qpRange58 o_4@@6))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) o_4@@6 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@6 next))))
 :qid |stdinbpl.4523:22|
 :skolemid |465|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) o_4@@6 next))
)))) (=> (and (and (and (and (forall ((o_4@@7 T@Ref) (f_5 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@7 f_5) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@9) o_4@@7 f_5)))
 :qid |stdinbpl.4527:29|
 :skolemid |466|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@7 f_5))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@9) o_4@@7 f_5))
)) (forall ((o_4@@8 T@Ref) (f_5@@0 T@Field_58602_58603) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@8 f_5@@0) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) o_4@@8 f_5@@0)))
 :qid |stdinbpl.4527:29|
 :skolemid |466|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@8 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) o_4@@8 f_5@@0))
))) (forall ((o_4@@9 T@Ref) (f_5@@1 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@9 f_5@@1) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@9) o_4@@9 f_5@@1)))
 :qid |stdinbpl.4527:29|
 :skolemid |466|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@9 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@9) o_4@@9 f_5@@1))
))) (forall ((o_4@@10 T@Ref) (f_5@@2 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@10 f_5@@2) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@9) o_4@@10 f_5@@2)))
 :qid |stdinbpl.4527:29|
 :skolemid |466|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@10 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@9) o_4@@10 f_5@@2))
...
(let ((anon109_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (select (|Set#Union_37395| g0@@10 g1@@10) null))) (and (=> (= (ControlFlow 0 88) 48) anon110_Then_correct) (=> (= (ControlFlow 0 88) 86) anon110_Else_correct)))))
(let ((anon85_correct true))
(let ((anon129_Else_correct  (=> (and (not (select g1@@10 r$2_2)) (= (ControlFlow 0 37) 34)) anon85_correct)))
(let ((anon129_Then_correct  (=> (select g1@@10 r$2_2) (and (=> (= (ControlFlow 0 35) (- 0 36)) (not (select g0@@10 r$2_2))) (=> (not (select g0@@10 r$2_2)) (=> (= (ControlFlow 0 35) 34) anon85_correct))))))
(let ((anon128_Else_correct true))
(let ((anon126_Else_correct  (=> (forall ((r$1_3_1 T@Ref) ) (!  (=> (select g0@@10 r$1_3_1) (not (select g1@@10 r$1_3_1)))
 :qid |stdinbpl.4881:20|
 :skolemid |499|
 :pattern ( (select g0@@10 r$1_3_1) (select g1@@10 r$1_3_1))
...
(let ((anon127_Else_correct  (=> (and (not (select g0@@10 r$1_2)) (= (ControlFlow 0 32) 29)) anon81_correct)))
(let ((anon127_Then_correct  (=> (select g0@@10 r$1_2) (and (=> (= (ControlFlow 0 30) (- 0 31)) (not (select g1@@10 r$1_2))) (=> (not (select g1@@10 r$1_2)) (=> (= (ControlFlow 0 30) 29) anon81_correct))))))
(let ((anon124_Else_correct  (=> (forall ((n$4_3_1 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_3_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_3_1 next) null))) (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_3_1 next)))
 :qid |stdinbpl.4864:20|
 :skolemid |498|
...
)) (and (=> (= (ControlFlow 0 39) (- 0 42)) (is_global_sroot Heap@@41 (|Set#Union_37395| g0@@10 g1@@10) (|Set#UnionOne_38322| (|Set#Singleton_38322| x1_2) x0))) (=> (is_global_sroot Heap@@41 (|Set#Union_37395| g0@@10 g1@@10) (|Set#UnionOne_38322| (|Set#Singleton_38322| x1_2) x0)) (and (=> (= (ControlFlow 0 39) (- 0 41)) (acyclic_list_segment Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (=> (acyclic_list_segment Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (unshared_graph ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)))) (=> (unshared_graph ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (and (and (=> (= (ControlFlow 0 39) 38) anon126_Else_correct) (=> (= (ControlFlow 0 39) 30) anon127_Then_correct)) (=> (= (ControlFlow 0 39) 32) anon127_Else_correct)))))))))))
(let ((anon77_correct true))
(let ((anon125_Else_correct  (=> (and (not (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_2_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2_1 next) null)))) (= (ControlFlow 0 28) 25)) anon77_correct)))
(let ((anon125_Then_correct  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$4_2_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2_1 next) null))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2_1 next))) (=> (select (|Set#Union_37395| g0@@10 g1@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2_1 next)) (=> (= (ControlFlow 0 26) 25) anon77_correct))))))
(let ((anon123_Else_correct  (=> (apply_TCFraming Heap@@41 g0@@10 g1@@10) (=> (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 43) (- 0 46)) (not (select (|Set#Union_37395| g0@@10 g1@@10) null))) (=> (not (select (|Set#Union_37395| g0@@10 g1@@10) null)) (and (=> (= (ControlFlow 0 43) (- 0 45)) (forall ((n$3_2 T@Ref) (n$3_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_2 n$3_2_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2)) (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_2 n$3_2_1)))
 :qid |stdinbpl.4823:17|
 :skolemid |492|
...
)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (forall ((n$3_2@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2@@1) (>= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$3_2@@1 next) FullPerm))
 :qid |stdinbpl.4830:17|
 :skolemid |493|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) n$3_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) n$3_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@2 next))
)) (=> (forall ((n$3_2@@3 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) n$3_2@@3) (< NoPerm FullPerm)) (and (qpRange62 n$3_2@@3) (= (invRecv62 n$3_2@@3) n$3_2@@3)))
 :qid |stdinbpl.4836:22|
 :skolemid |494|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) n$3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@3 next))
)) (=> (and (forall ((o_4@@11 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv62 o_4@@11)) (and (< NoPerm FullPerm) (qpRange62 o_4@@11))) (= (invRecv62 o_4@@11) o_4@@11))
 :qid |stdinbpl.4840:22|
 :skolemid |495|
 :pattern ( (invRecv62 o_4@@11))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv62 o_4@@12)) (and (< NoPerm FullPerm) (qpRange62 o_4@@12))) (and (= (invRecv62 o_4@@12) o_4@@12) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) o_4@@12 next) (- (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@12 next) FullPerm)))) (=> (not (and (select (|Set#Union_37395| g0@@10 g1@@10) (invRecv62 o_4@@12)) (and (< NoPerm FullPerm) (qpRange62 o_4@@12)))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) o_4@@12 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@12 next))))
 :qid |stdinbpl.4846:22|
 :skolemid |496|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) o_4@@12 next))
))) (=> (and (and (and (forall ((o_4@@13 T@Ref) (f_5@@3 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@13 f_5@@3) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@8) o_4@@13 f_5@@3)))
 :qid |stdinbpl.4852:29|
 :skolemid |497|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@8) o_4@@13 f_5@@3))
)) (forall ((o_4@@14 T@Ref) (f_5@@4 T@Field_58602_58603) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@14 f_5@@4) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) o_4@@14 f_5@@4)))
 :qid |stdinbpl.4852:29|
 :skolemid |497|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) o_4@@14 f_5@@4))
))) (forall ((o_4@@15 T@Ref) (f_5@@5 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_4@@15 f_5@@5) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@8) o_4@@15 f_5@@5)))
 :qid |stdinbpl.4852:29|
 :skolemid |497|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@8) o_4@@15 f_5@@5))
))) (forall ((o_4@@16 T@Ref) (f_5@@6 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_4@@16 f_5@@6) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@8) o_4@@16 f_5@@6)))
 :qid |stdinbpl.4852:29|
 :skolemid |497|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@8) o_4@@16 f_5@@6))
...
(let ((anon123_Then_correct  (and (=> (= (ControlFlow 0 20) (- 0 24)) (forall ((n_6 T@Ref) (n_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6 n_6_1)) (select g0@@10 n_6)) (select g0@@10 n_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1)))
 :qid |stdinbpl.4749:21|
 :skolemid |484|
...
)) (and (=> (= (ControlFlow 0 20) (- 0 23)) (forall ((n_6@@1 T@Ref) ) (!  (=> (select g0@@10 n_6@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_6@@1 next) NoPerm)))
 :qid |stdinbpl.4756:21|
 :skolemid |485|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_6@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n_6@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_6@@1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n_6@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_6@@2 next))
)) (=> (and (forall ((n_6@@3 T@Ref) ) (!  (=> (and (select g0@@10 n_6@@3) (< NoPerm FullPerm)) (and (qpRange63 n_6@@3) (= (invRecv63 n_6@@3) n_6@@3)))
 :qid |stdinbpl.4762:26|
 :skolemid |486|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_6@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n_6@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_6@@3 next))
)) (forall ((o_4@@17 T@Ref) ) (!  (=> (and (select g0@@10 (invRecv63 o_4@@17)) (and (< NoPerm FullPerm) (qpRange63 o_4@@17))) (= (invRecv63 o_4@@17) o_4@@17))
 :qid |stdinbpl.4766:26|
 :skolemid |487|
 :pattern ( (invRecv63 o_4@@17))
))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select g1@@10 n_7)) (select g1@@10 n_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1)))
 :qid |stdinbpl.4777:21|
 :skolemid |488|
...
)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((n_7@@1 T@Ref) ) (!  (=> (select g1@@10 n_7@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_7@@1 next) NoPerm)))
 :qid |stdinbpl.4784:21|
 :skolemid |489|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n_7@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@2 next))
)) (=> (forall ((n_7@@3 T@Ref) ) (!  (=> (and (select g1@@10 n_7@@3) (< NoPerm FullPerm)) (and (qpRange64 n_7@@3) (= (invRecv64 n_7@@3) n_7@@3)))
 :qid |stdinbpl.4790:26|
 :skolemid |490|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n_7@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@3 next))
)) (=> (and (forall ((o_4@@18 T@Ref) ) (!  (=> (and (select g1@@10 (invRecv64 o_4@@18)) (and (< NoPerm FullPerm) (qpRange64 o_4@@18))) (= (invRecv64 o_4@@18) o_4@@18))
 :qid |stdinbpl.4794:26|
 :skolemid |491|
 :pattern ( (invRecv64 o_4@@18))
)) (= (ControlFlow 0 20) (- 0 19))) (|Set#Equal_37295| (|Set#Intersection_37295| g1@@10 g0@@10) |Set#Empty_37301|))))))))))))))
(let ((anon109_Else_correct  (=> (state Heap@@41 QPMask@1) (and (=> (= (ControlFlow 0 47) 20) anon123_Then_correct) (=> (= (ControlFlow 0 47) 43) anon123_Else_correct)))))
(let ((anon106_Else_correct  (=> (and (acyclic_list_segment Heap@@41 g1@@10) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 89) 88) anon109_Then_correct) (=> (= (ControlFlow 0 89) 47) anon109_Else_correct)))))
(let ((anon103_Else_correct  (=> (acyclic_list_segment Heap@@41 g0@@10) (=> (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 99) 95) anon106_Then_correct) (=> (= (ControlFlow 0 99) 89) anon106_Else_correct))))))
(let ((anon100_Else_correct  (=> (is_global_root Heap@@41 g1@@10 x1_2) (=> (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 109) 105) anon103_Then_correct) (=> (= (ControlFlow 0 109) 99) anon103_Else_correct))))))
(let ((anon97_Else_correct  (=> (is_global_root Heap@@41 g0@@10 x0) (=> (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 120) 116) anon100_Then_correct) (=> (= (ControlFlow 0 120) 109) anon100_Else_correct))))))
(let ((anon96_Else_correct  (=> (forall ((r$0_1 T@Ref) ) (!  (=> (select g1@@10 r$0_1) (not (select g0@@10 r$0_1)))
 :qid |stdinbpl.4245:20|
 :skolemid |440|
 :pattern ( (select g0@@10 r$0_1) (select g1@@10 r$0_1))
)) (=> (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 131) 127) anon97_Then_correct) (=> (= (ControlFlow 0 131) 120) anon97_Else_correct))))))
(let ((anon96_Then_correct true))
(let ((anon95_Else_correct  (=> (forall ((r_1_1 T@Ref) ) (!  (=> (select g0@@10 r_1_1) (not (select g1@@10 r_1_1)))
 :qid |stdinbpl.4236:20|
 :skolemid |439|
...
(let ((anon92_Else_correct  (=> (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g1@@10 n$2_1_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next) null))) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next)))
 :qid |stdinbpl.4222:20|
 :skolemid |438|
...
)) (state Heap@@41 QPMask@1)) (=> (and (and (select g0@@10 x0) (state Heap@@41 QPMask@1)) (and (select g1@@10 x1_2) (state Heap@@41 QPMask@1))) (and (=> (= (ControlFlow 0 133) 17) anon95_Then_correct) (=> (= (ControlFlow 0 133) 132) anon95_Else_correct))))))
(let ((anon15_correct true))
(let ((anon94_Else_correct  (=> (and (not (and (select g1@@10 n$2_20) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_20 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon94_Then_correct  (=> (and (select g1@@10 n$2_20) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_20 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_37315_37316 QPMask@1 n$2_20 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_20 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon93_Else_correct  (=> (not (select g1@@10 n$2_20)) (and (=> (= (ControlFlow 0 16) 11) anon94_Then_correct) (=> (= (ControlFlow 0 16) 13) anon94_Else_correct)))))
(let ((anon93_Then_correct  (=> (select g1@@10 n$2_20) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_37315_37316 QPMask@1 n$2_20 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_20 next) (and (=> (= (ControlFlow 0 14) 11) anon94_Then_correct) (=> (= (ControlFlow 0 14) 13) anon94_Else_correct)))))))
(let ((anon91_Else_correct  (and (=> (= (ControlFlow 0 134) (- 0 135)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@10 n$1_1)) (select g1@@10 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 :qid |stdinbpl.4177:15|
 :skolemid |432|
 ...
 :qid |stdinbpl.4177:15|
 :skolemid |432|
)) (=> (and (and (forall ((n$1_1@@1 T@Ref) ) (!  (=> (and (select g1@@10 n$1_1@@1) (< NoPerm FullPerm)) (and (qpRange53 n$1_1@@1) (= (invRecv53 n$1_1@@1) n$1_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@1 next))
)) (forall ((o_4@@19 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv53 o_4@@19)) (< NoPerm FullPerm)) (qpRange53 o_4@@19)) (= (invRecv53 o_4@@19) o_4@@19))
 :qid |stdinbpl.4187:22|
 :skolemid |434|
 :pattern ( (invRecv53 o_4@@19))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@2 next))
)) (forall ((o_4@@20 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv53 o_4@@20)) (< NoPerm FullPerm)) (qpRange53 o_4@@20)) (and (=> (< NoPerm FullPerm) (= (invRecv53 o_4@@20) o_4@@20)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@20 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@20 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv53 o_4@@20)) (< NoPerm FullPerm)) (qpRange53 o_4@@20))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@20 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@20 next))))
 :qid |stdinbpl.4199:22|
 :skolemid |436|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@20 next))
)))) (=> (and (and (and (and (forall ((o_4@@21 T@Ref) (f_5@@7 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@21 f_5@@7) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@21 f_5@@7)))
 :qid |stdinbpl.4203:29|
 :skolemid |437|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@21 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@21 f_5@@7))
)) (forall ((o_4@@22 T@Ref) (f_5@@8 T@Field_58602_58603) ) (!  (=> (not (= f_5@@8 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@22 f_5@@8) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@22 f_5@@8)))
 :qid |stdinbpl.4203:29|
 :skolemid |437|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@22 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@22 f_5@@8))
))) (forall ((o_4@@23 T@Ref) (f_5@@9 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@23 f_5@@9) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_4@@23 f_5@@9)))
 :qid |stdinbpl.4203:29|
 :skolemid |437|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@23 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_4@@23 f_5@@9))
))) (forall ((o_4@@24 T@Ref) (f_5@@10 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@24 f_5@@10) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_4@@24 f_5@@10)))
 :qid |stdinbpl.4203:29|
 :skolemid |437|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@24 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_4@@24 f_5@@10))
))) (state Heap@@41 QPMask@1)) (and (and (=> (= (ControlFlow 0 134) 133) anon92_Else_correct) (=> (= (ControlFlow 0 134) 14) anon93_Then_correct)) (=> (= (ControlFlow 0 134) 16) anon93_Else_correct))))))))
(let ((anon91_Then_correct true))
(let ((anon88_Else_correct  (=> (and (forall ((n$0_1 T@Ref) ) (!  (=> (and (select g0@@10 n$0_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_1 next) null))) (select g0@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_1 next)))
 :qid |stdinbpl.4165:20|
 :skolemid |431|
...
)) (not (select g1@@10 null))) (and (=> (= (ControlFlow 0 136) 9) anon91_Then_correct) (=> (= (ControlFlow 0 136) 134) anon91_Else_correct)))))
(let ((anon7_correct true))
(let ((anon90_Else_correct  (=> (and (not (and (select g0@@10 n$0_22) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_22 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon90_Then_correct  (=> (and (select g0@@10 n$0_22) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_22 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$0_22 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_22 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon89_Else_correct  (=> (not (select g0@@10 n$0_22)) (and (=> (= (ControlFlow 0 8) 3) anon90_Then_correct) (=> (= (ControlFlow 0 8) 5) anon90_Else_correct)))))
(let ((anon89_Then_correct  (=> (select g0@@10 n$0_22) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$0_22 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_22 next) (and (=> (= (ControlFlow 0 6) 3) anon90_Then_correct) (=> (= (ControlFlow 0 6) 5) anon90_Else_correct)))))))
(let ((anon87_Else_correct  (and (=> (= (ControlFlow 0 137) (- 0 138)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@10 n_1)) (select g0@@10 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :qid |stdinbpl.4120:15|
 :skolemid |425|
)) (=> (and (and (forall ((n_1@@1 T@Ref) ) (!  (=> (and (select g0@@10 n_1@@1) (< NoPerm FullPerm)) (and (qpRange52 n_1@@1) (= (invRecv52 n_1@@1) n_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@1 next))
)) (forall ((o_4@@25 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv52 o_4@@25)) (< NoPerm FullPerm)) (qpRange52 o_4@@25)) (= (invRecv52 o_4@@25) o_4@@25))
 :qid |stdinbpl.4130:22|
 :skolemid |427|
 :pattern ( (invRecv52 o_4@@25))
))) (and (forall ((n_1@@2 T@Ref) ) (!  (=> (select g0@@10 n_1@@2) (not (= n_1@@2 null)))
 :qid |stdinbpl.4136:22|
 :skolemid |428|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@2 next))
)) (forall ((o_4@@26 T@Ref) ) (!  (and (=> (and (and (select g0@@10 (invRecv52 o_4@@26)) (< NoPerm FullPerm)) (qpRange52 o_4@@26)) (and (=> (< NoPerm FullPerm) (= (invRecv52 o_4@@26) o_4@@26)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@26 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@26 next) FullPerm)))) (=> (not (and (and (select g0@@10 (invRecv52 o_4@@26)) (< NoPerm FullPerm)) (qpRange52 o_4@@26))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@26 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@26 next))))
 :qid |stdinbpl.4142:22|
 :skolemid |429|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@26 next))
)))) (=> (and (and (and (and (forall ((o_4@@27 T@Ref) (f_5@@11 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@27 f_5@@11) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@27 f_5@@11)))
 :qid |stdinbpl.4146:29|
 :skolemid |430|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@27 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@27 f_5@@11))
)) (forall ((o_4@@28 T@Ref) (f_5@@12 T@Field_58602_58603) ) (!  (=> (not (= f_5@@12 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@28 f_5@@12) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@28 f_5@@12)))
 :qid |stdinbpl.4146:29|
 :skolemid |430|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@28 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@28 f_5@@12))
))) (forall ((o_4@@29 T@Ref) (f_5@@13 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@29 f_5@@13) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@29 f_5@@13)))
 :qid |stdinbpl.4146:29|
 :skolemid |430|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@29 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@29 f_5@@13))
))) (forall ((o_4@@30 T@Ref) (f_5@@14 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@30 f_5@@14) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@30 f_5@@14)))
 :qid |stdinbpl.4146:29|
 :skolemid |430|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@30 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@30 f_5@@14))
))) (state Heap@@41 QPMask@0)) (and (and (=> (= (ControlFlow 0 137) 136) anon88_Else_correct) (=> (= (ControlFlow 0 137) 6) anon89_Then_correct)) (=> (= (ControlFlow 0 137) 8) anon89_Else_correct))))))))
(let ((anon87_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_58529_36503_53#PolymorphicMapType_58529| Heap@@41) x0 $allocated)) (and (select (|PolymorphicMapType_58529_36503_53#PolymorphicMapType_58529| Heap@@41) x1_2 $allocated) (not (select g0@@10 null)))) (and (=> (= (ControlFlow 0 139) 1) anon87_Then_correct) (=> (= (ControlFlow 0 139) 137) anon87_Else_correct))))))
