...
(let ((anon16_Else_correct  (=> (and (= (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) p_18 car) s_7) (= (ControlFlow 0 9) 4)) anon9_correct)))
(let ((anon16_Then_correct  (=> (not (= (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) p_18 car) s_7)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_18763_18764 QPMask@1 p_18 cdr)) (=> (HasDirectPerm_18763_18764 QPMask@1 p_18 cdr) (=> (= (ControlFlow 0 7) 4) anon9_correct))))))
(let ((anon15_Then_correct  (=> (select refs@@5 s_7) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_18763_18764 QPMask@1 p_18 car)) (=> (HasDirectPerm_18763_18764 QPMask@1 p_18 car) (and (=> (= (ControlFlow 0 10) 7) anon16_Then_correct) (=> (= (ControlFlow 0 10) 9) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (not (select refs@@5 s_7)) (= (ControlFlow 0 6) 4)) anon9_correct)))
(let ((anon14_Then_correct  (=> (select refs@@5 p_18) (and (=> (= (ControlFlow 0 12) 10) anon15_Then_correct) (=> (= (ControlFlow 0 12) 6) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not (select refs@@5 p_18)) (= (ControlFlow 0 5) 4)) anon9_correct)))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n$0_3_2 T@Ref) (n$0_3_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_3_2 n$0_3_3)) (select refs@@5 n$0_3_2)) (select refs@@5 n$0_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_3_2 n$0_3_3)))
 :qid |stdinbpl.758:15|
 :skolemid |107|
))) (=> (forall ((n$0_3_2@@0 T@Ref) (n$0_3_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_3_2@@0 n$0_3_3@@0)) (select refs@@5 n$0_3_2@@0)) (select refs@@5 n$0_3_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_3_2@@0 n$0_3_3@@0)))
 :qid |stdinbpl.758:15|
 :skolemid |107|
)) (=> (and (and (forall ((n$0_3_2@@1 T@Ref) ) (!  (=> (and (select refs@@5 n$0_3_2@@1) (< NoPerm FullPerm)) (and (qpRange2 n$0_3_2@@1) (= (invRecv2 n$0_3_2@@1) n$0_3_2@@1)))
 :qid |stdinbpl.764:22|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$0_3_2@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) n$0_3_2@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$0_3_2@@1 cdr))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select refs@@5 (invRecv2 o_4)) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.768:22|
 :skolemid |109|
 :pattern ( (invRecv2 o_4))
))) (and (forall ((n$0_3_2@@2 T@Ref) ) (!  (=> (select refs@@5 n$0_3_2@@2) (not (= n$0_3_2@@2 null)))
 :qid |stdinbpl.774:22|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$0_3_2@@2 cdr))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) n$0_3_2@@2 cdr))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$0_3_2@@2 cdr))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select refs@@5 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_4@@0 cdr) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_4@@0 cdr) FullPerm)))) (=> (not (and (and (select refs@@5 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_4@@0 cdr) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_4@@0 cdr))))
 :qid |stdinbpl.780:22|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_4@@0 cdr))
)))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.784:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@0) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_28338_28339) ) (!  (=> (not (= f_5@@0 cdr)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.784:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.784:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@0) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.784:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@0) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@1) o_4@@4 f_5@@2))
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select refs@@5 n_3)) (select refs@@5 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n_3@@1 car))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select refs@@5 (invRecv1 o_4@@5)) (< NoPerm FullPerm)) (qpRange1 o_4@@5)) (= (invRecv1 o_4@@5) o_4@@5))
 :qid |stdinbpl.729:22|
 :skolemid |103|
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n_3@@2 car))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (and (select refs@@5 (invRecv1 o_4@@6)) (< NoPerm FullPerm)) (qpRange1 o_4@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@6) o_4@@6)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_4@@6 car) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_4@@6 car) FullPerm)))) (=> (not (and (and (select refs@@5 (invRecv1 o_4@@6)) (< NoPerm FullPerm)) (qpRange1 o_4@@6))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_4@@6 car) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_4@@6 car))))
 :qid |stdinbpl.741:22|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_4@@6 car))
)))) (=> (and (and (and (and (forall ((o_4@@7 T@Ref) (f_5@@3 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| ZeroMask) o_4@@7 f_5@@3) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@0) o_4@@7 f_5@@3)))
 :qid |stdinbpl.745:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| ZeroMask) o_4@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@0) o_4@@7 f_5@@3))
)) (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_28338_28339) ) (!  (=> (not (= f_5@@4 car)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.745:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_4@@8 f_5@@4))
))) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.745:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.745:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@0) o_4@@10 f_5@@6))
