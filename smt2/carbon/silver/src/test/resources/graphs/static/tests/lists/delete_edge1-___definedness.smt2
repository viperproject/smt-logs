...
(let ((anon13_Else_correct  (=> (and (forall ((p_4_1 T@Ref) (s_4 T@Ref) ) (! (=  (and (select refs@@6 p_4_1) (and (select refs@@6 s_4) (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) p_4_1 next) s_4))) (select Result (create_edge p_4_1 s_4)))
 :qid |stdinbpl.950:20|
 :skolemid |116|
...
(let ((anon15_Then_correct  (=> (select refs@@6 s_2) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_40180_40181 QPMask@0 p_4 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 p_4 next) (=> (= (ControlFlow 0 4) 2) anon6_correct))))))
...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select refs@@6 n_3)) (select refs@@6 n_3_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_3 n_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_3@@4 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select refs@@6 (invRecv1 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv1 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_9@@0 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select refs@@6 (invRecv1 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.926:22|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@0 next))
))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_61502_53) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.930:29|
 :skolemid |115|
...
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_61515_61516) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.930:29|
 :skolemid |115|
...
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_40180_203868) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.930:29|
 :skolemid |115|
...
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_40180_204001) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.930:29|
 :skolemid |115|
