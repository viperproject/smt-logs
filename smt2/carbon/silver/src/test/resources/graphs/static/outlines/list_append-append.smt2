...
(declare-fun n_10 () T@Ref)
(declare-fun n$0_13 () T@Ref)
...
(let ((anon232_Then_correct  (and (=> (= (ControlFlow 0 242) (- 0 243)) (forall ((n$0_9 T@Ref) (n$0_9_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_9 n$0_9_1)) (select g_1 n$0_9)) (select g_1 n$0_9_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_9 n$0_9_1)))
 :qid |stdinbpl.3730:35|
 :skolemid |372|
 :pattern ( (neverTriggered51 n$0_9) (neverTriggered51 n$0_9_1))
))) (=> (forall ((n$0_9@@0 T@Ref) (n$0_9_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_9@@0 n$0_9_1@@0)) (select g_1 n$0_9@@0)) (select g_1 n$0_9_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_9@@0 n$0_9_1@@0)))
 :qid |stdinbpl.3730:35|
 :skolemid |372|
...
(let ((anon231_Then_correct  (=> (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_14) (and (=> (= (ControlFlow 0 244) 242) anon232_Then_correct) (=> (= (ControlFlow 0 244) 235) anon73_correct)))))
(let ((anon231_Else_correct  (=> (and (not (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_14)) (= (ControlFlow 0 240) 235)) anon73_correct)))
(let ((anon229_Then_correct  (=> (select g_1 n_14) (and (and (=> (= (ControlFlow 0 245) 238) anon230_Then_correct) (=> (= (ControlFlow 0 245) 244) anon231_Then_correct)) (=> (= (ControlFlow 0 245) 240) anon231_Else_correct)))))
(let ((anon229_Else_correct  (=> (and (not (select g_1 n_14)) (= (ControlFlow 0 236) 235)) anon73_correct)))
...
(let ((anon227_Then_correct  (and (=> (= (ControlFlow 0 231) (- 0 232)) (forall ((n$0_7 T@Ref) (n$0_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_7 n$0_7_1)) (select g_1 n$0_7)) (select g_1 n$0_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_7 n$0_7_1)))
 :qid |stdinbpl.3637:35|
 :skolemid |363|
 :pattern ( (neverTriggered49 n$0_7) (neverTriggered49 n$0_7_1))
))) (=> (forall ((n$0_7@@0 T@Ref) (n$0_7_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_7@@0 n$0_7_1@@0)) (select g_1 n$0_7@@0)) (select g_1 n$0_7_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_7@@0 n$0_7_1@@0)))
 :qid |stdinbpl.3637:35|
 :skolemid |363|
...
(let ((anon226_Then_correct  (=> (not (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_13)) (and (=> (= (ControlFlow 0 233) 231) anon227_Then_correct) (=> (= (ControlFlow 0 233) 224) anon65_correct)))))
(let ((anon226_Else_correct  (=> (and (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_13) (= (ControlFlow 0 229) 224)) anon65_correct)))
(let ((anon224_Then_correct  (=> (select g_1 n_13) (and (and (=> (= (ControlFlow 0 234) 227) anon225_Then_correct) (=> (= (ControlFlow 0 234) 233) anon226_Then_correct)) (=> (= (ControlFlow 0 234) 229) anon226_Else_correct)))))
(let ((anon224_Else_correct  (=> (and (not (select g_1 n_13)) (= (ControlFlow 0 225) 224)) anon65_correct)))
(let ((anon220_Else_correct  (=> (and (and (and (forall ((n$2_3_2 T@Ref) ) (!  (=> (and (select g_1 n$2_3_2) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$2_3_2 next) null))) (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$2_3_2 next)))
 :qid |stdinbpl.3571:28|
 :skolemid |358|
 :pattern ( (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$2_3_2 next)))
 :pattern ( (select g_1 n$2_3_2) (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$2_3_2 next))
...
(let ((anon222_Else_correct  (=> (and (not (and (select g_1 n$2_7) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$2_7 next) null)))) (= (ControlFlow 0 220) 217)) anon57_correct)))
(let ((anon222_Then_correct  (=> (and (select g_1 n$2_7) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$2_7 next) null))) (and (=> (= (ControlFlow 0 218) (- 0 219)) (HasDirectPerm_29078_29079 QPMask@25 n$2_7 next)) (=> (HasDirectPerm_29078_29079 QPMask@25 n$2_7 next) (=> (= (ControlFlow 0 218) 217) anon57_correct))))))
(let ((anon221_Else_correct  (=> (not (select g_1 n$2_7)) (and (=> (= (ControlFlow 0 223) 218) anon222_Then_correct) (=> (= (ControlFlow 0 223) 220) anon222_Else_correct)))))
(let ((anon221_Then_correct  (=> (select g_1 n$2_7) (and (=> (= (ControlFlow 0 221) (- 0 222)) (HasDirectPerm_29078_29079 QPMask@25 n$2_7 next)) (=> (HasDirectPerm_29078_29079 QPMask@25 n$2_7 next) (and (=> (= (ControlFlow 0 221) 218) anon222_Then_correct) (=> (= (ControlFlow 0 221) 220) anon222_Else_correct)))))))
(let ((anon219_Else_correct  (and (=> (= (ControlFlow 0 289) (- 0 290)) (forall ((n$1_2 T@Ref) (n$1_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_2 n$1_2_1)) (select g_1 n$1_2)) (select g_1 n$1_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_2 n$1_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$1_2@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv47 o_9)) (< NoPerm FullPerm)) (qpRange47 o_9)) (= (invRecv47 o_9) o_9))
 :qid |stdinbpl.3536:30|
 :skolemid |354|
 :pattern ( (invRecv47 o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$1_2@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv47 o_9@@0)) (< NoPerm FullPerm)) (qpRange47 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv47 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@25) o_9@@0 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv47 o_9@@0)) (< NoPerm FullPerm)) (qpRange47 o_9@@0))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@25) o_9@@0 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@0 next))))
 :qid |stdinbpl.3548:30|
 :skolemid |356|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@25) o_9@@0 next))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@5) o_9@@1 f_5) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@25) o_9@@1 f_5)))
 :qid |stdinbpl.3552:37|
 :skolemid |357|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@5) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@25) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_44212_44213) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@2 f_5@@0) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@25) o_9@@2 f_5@@0)))
 :qid |stdinbpl.3552:37|
 :skolemid |357|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@25) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@5) o_9@@3 f_5@@1) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@25) o_9@@3 f_5@@1)))
 :qid |stdinbpl.3552:37|
 :skolemid |357|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@5) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@25) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@5) o_9@@4 f_5@@2) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@25) o_9@@4 f_5@@2)))
 :qid |stdinbpl.3552:37|
 :skolemid |357|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@5) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@25) o_9@@4 f_5@@2))
...
(let ((anon248_Then_correct  (and (=> (= (ControlFlow 0 202) (- 0 203)) (forall ((n_28 T@Ref) (n_28_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_28 n_28_1)) (select g_1 n_28)) (select g_1 n_28_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_28 n_28_1)))
 :qid |stdinbpl.4232:35|
 :skolemid |418|
 :pattern ( (neverTriggered61 n_28) (neverTriggered61 n_28_1))
))) (=> (forall ((n_28@@0 T@Ref) (n_28_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_28@@0 n_28_1@@0)) (select g_1 n_28@@0)) (select g_1 n_28_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_28@@0 n_28_1@@0)))
 :qid |stdinbpl.4232:35|
 :skolemid |418|
 :pattern ( (neverTriggered61 n_28@@0) (neverTriggered61 n_28_1@@0))
)) (=> (= (ControlFlow 0 202) (- 0 201)) (forall ((n_28@@1 T@Ref) ) (!  (=> (select g_1 n_28@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) n_28@@1 next) NoPerm)))
 :qid |stdinbpl.4239:35|
 :skolemid |419|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_28@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@21) n_28@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_28@@1 next))
)))))))
(let ((anon247_Then_correct  (and (=> (= (ControlFlow 0 199) (- 0 200)) (forall ((n_27 T@Ref) (n_27_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_27 n_27_1)) (select g_1 n_27)) (select g_1 n_27_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_27 n_27_1)))
...
)) (=> (= (ControlFlow 0 199) (- 0 198)) (forall ((n_27@@1 T@Ref) ) (!  (=> (select g_1 n_27@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) n_27@@1 next) NoPerm)))
 :qid |stdinbpl.4200:35|
 :skolemid |415|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_27@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@20) n_27@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_27@@1 next))
)))))))
(let ((anon251_Then_correct  (and (=> (= (ControlFlow 0 191) (- 0 192)) (forall ((n_30 T@Ref) (n_30_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_30 n_30_1)) (select g_1 n_30)) (select g_1 n_30_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_30 n_30_1)))
 :qid |stdinbpl.4327:35|
 :skolemid |426|
 :pattern ( (neverTriggered63 n_30) (neverTriggered63 n_30_1))
))) (=> (forall ((n_30@@0 T@Ref) (n_30_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_30@@0 n_30_1@@0)) (select g_1 n_30@@0)) (select g_1 n_30_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_30@@0 n_30_1@@0)))
 :qid |stdinbpl.4327:35|
 :skolemid |426|
 :pattern ( (neverTriggered63 n_30@@0) (neverTriggered63 n_30_1@@0))
)) (=> (= (ControlFlow 0 191) (- 0 190)) (forall ((n_30@@1 T@Ref) ) (!  (=> (select g_1 n_30@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) n_30@@1 next) NoPerm)))
 :qid |stdinbpl.4334:35|
 :skolemid |427|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_30@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@23) n_30@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_30@@1 next))
)))))))
(let ((anon250_Then_correct  (and (=> (= (ControlFlow 0 188) (- 0 189)) (forall ((n_29 T@Ref) (n_29_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_29 n_29_1)) (select g_1 n_29)) (select g_1 n_29_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_29 n_29_1)))
 :qid |stdinbpl.4288:35|
 :skolemid |422|
 :pattern ( (neverTriggered62 n_29) (neverTriggered62 n_29_1))
))) (=> (forall ((n_29@@0 T@Ref) (n_29_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_29@@0 n_29_1@@0)) (select g_1 n_29@@0)) (select g_1 n_29_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_29@@0 n_29_1@@0)))
 :qid |stdinbpl.4288:35|
 :skolemid |422|
 :pattern ( (neverTriggered62 n_29@@0) (neverTriggered62 n_29_1@@0))
)) (=> (= (ControlFlow 0 188) (- 0 187)) (forall ((n_29@@1 T@Ref) ) (!  (=> (select g_1 n_29@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) n_29@@1 next) NoPerm)))
 :qid |stdinbpl.4295:35|
 :skolemid |423|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_29@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@22) n_29@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_29@@1 next))
)))))))
...
(let ((anon256_Else_correct  (=> (forall ((n_34_1 T@Ref) ) (!  (=> (select g_1 n_34_1) (or (not (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_34_1)) (not (exists_path ($$ ExhaleHeap@4 g_1) y@@4 n_34_1))))
 :qid |stdinbpl.4448:28|
 :skolemid |438|
 :pattern ( (select g_1 n_34_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) x@@7 n_34_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) y@@4 n_34_1))
...
(let ((anon257_Else_correct  (=> (and (not (select g_1 n_33)) (= (ControlFlow 0 164) 161)) anon121_correct)))
(let ((anon257_Then_correct  (=> (select g_1 n_33) (and (=> (= (ControlFlow 0 162) (- 0 163)) (or (not (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_33)) (not (exists_path ($$ ExhaleHeap@4 g_1) y@@4 n_33)))) (=> (or (not (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_33)) (not (exists_path ($$ ExhaleHeap@4 g_1) y@@4 n_33))) (=> (= (ControlFlow 0 162) 161) anon121_correct))))))
(let ((anon254_Else_correct  (=> (forall ((n_32_1 T@Ref) ) (!  (=> (select g_1 n_32_1) (or (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_32_1) (exists_path ($$ ExhaleHeap@4 g_1) y@@4 n_32_1)))
 :qid |stdinbpl.4437:28|
 :skolemid |437|
 :pattern ( (select g_1 n_32_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) x@@7 n_32_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) y@@4 n_32_1))
...
(let ((anon255_Else_correct  (=> (and (not (select g_1 n_31)) (= (ControlFlow 0 160) 157)) anon117_correct)))
(let ((anon255_Then_correct  (=> (select g_1 n_31) (and (=> (= (ControlFlow 0 158) (- 0 159)) (or (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_31) (exists_path ($$ ExhaleHeap@4 g_1) y@@4 n_31))) (=> (or (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_31) (exists_path ($$ ExhaleHeap@4 g_1) y@@4 n_31)) (=> (= (ControlFlow 0 158) 157) anon117_correct))))))
...
(let ((anon110_correct  (=> (and (state ExhaleHeap@4 QPMask@6) (state ExhaleHeap@4 QPMask@6)) (and (=> (= (ControlFlow 0 181) (- 0 185)) (HasDirectPerm_29078_29079 QPMask@6 last@0 next)) (=> (HasDirectPerm_29078_29079 QPMask@6 last@0 next) (=> (and (= last@2 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) last@0 next)) (state ExhaleHeap@4 QPMask@6)) (and (=> (= (ControlFlow 0 181) (- 0 184)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 181) (- 0 183)) (forall ((n$1_4 T@Ref) (n$1_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_4 n$1_4_1)) (select g_1 n$1_4)) (select g_1 n$1_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_4 n$1_4_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$1_4@@3 next))
)) (=> (and (forall ((o_9@@5 T@Ref) ) (!  (=> (and (select g_1 (invRecv64 o_9@@5)) (and (< NoPerm FullPerm) (qpRange64 o_9@@5))) (= (invRecv64 o_9@@5) o_9@@5))
 :qid |stdinbpl.4396:30|
 :skolemid |433|
 :pattern ( (invRecv64 o_9@@5))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv64 o_9@@6)) (and (< NoPerm FullPerm) (qpRange64 o_9@@6))) (and (= (invRecv64 o_9@@6) o_9@@6) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@24) o_9@@6 next) (- (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) o_9@@6 next) FullPerm)))) (=> (not (and (select g_1 (invRecv64 o_9@@6)) (and (< NoPerm FullPerm) (qpRange64 o_9@@6)))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@24) o_9@@6 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) o_9@@6 next))))
 :qid |stdinbpl.4402:30|
 :skolemid |434|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@24) o_9@@6 next))
))) (=> (and (and (and (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@6) o_9@@7 f_5@@3) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@24) o_9@@7 f_5@@3)))
 :qid |stdinbpl.4408:37|
 :skolemid |435|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@24) o_9@@7 f_5@@3))
)) (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_44212_44213) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) o_9@@8 f_5@@4) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@24) o_9@@8 f_5@@4)))
 :qid |stdinbpl.4408:37|
 :skolemid |435|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@24) o_9@@8 f_5@@4))
))) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@6) o_9@@9 f_5@@5) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@24) o_9@@9 f_5@@5)))
 :qid |stdinbpl.4408:37|
 :skolemid |435|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@24) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@6) o_9@@10 f_5@@6) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@24) o_9@@10 f_5@@6)))
 :qid |stdinbpl.4408:37|
 :skolemid |435|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@24) o_9@@10 f_5@@6))
...
(let ((anon243_Then_correct  (=> (and (state ExhaleHeap@4 ZeroMask) (not (select g_1 null))) (and (=> (= (ControlFlow 0 214) (- 0 215)) (forall ((n$1_3 T@Ref) (n$1_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_3 n$1_3_1)) (select g_1 n$1_3)) (select g_1 n$1_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_3 n$1_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$1_3@@1 next))
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv59 o_9@@11)) (< NoPerm FullPerm)) (qpRange59 o_9@@11)) (= (invRecv59 o_9@@11) o_9@@11))
 :qid |stdinbpl.4108:30|
 :skolemid |407|
 :pattern ( (invRecv59 o_9@@11))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$1_3@@2 next))
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv59 o_9@@12)) (< NoPerm FullPerm)) (qpRange59 o_9@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv59 o_9@@12) o_9@@12)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) o_9@@12 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@12 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv59 o_9@@12)) (< NoPerm FullPerm)) (qpRange59 o_9@@12))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) o_9@@12 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@12 next))))
 :qid |stdinbpl.4120:30|
 :skolemid |409|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) o_9@@12 next))
)))) (=> (and (and (and (and (and (forall ((o_9@@13 T@Ref) (f_5@@7 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_9@@13 f_5@@7) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@6) o_9@@13 f_5@@7)))
 :qid |stdinbpl.4124:37|
 :skolemid |410|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_9@@13 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@6) o_9@@13 f_5@@7))
)) (forall ((o_9@@14 T@Ref) (f_5@@8 T@Field_44212_44213) ) (!  (=> (not (= f_5@@8 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@14 f_5@@8) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) o_9@@14 f_5@@8)))
 :qid |stdinbpl.4124:37|
 :skolemid |410|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@14 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) o_9@@14 f_5@@8))
))) (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_9@@15 f_5@@9) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@6) o_9@@15 f_5@@9)))
 :qid |stdinbpl.4124:37|
 :skolemid |410|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@6) o_9@@15 f_5@@9))
))) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_9@@16 f_5@@10) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@6) o_9@@16 f_5@@10)))
 :qid |stdinbpl.4124:37|
 :skolemid |410|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@6) o_9@@16 f_5@@10))
...
)) (select g_1 last@0)) (and (select g_1 x@@7) (select g_1 y@@4))) (and (and (state ExhaleHeap@4 QPMask@6) (forall ((n_25 T@Ref) ) (!  (=> (select g_1 n_25) (or (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_25) (exists_path ($$ ExhaleHeap@4 g_1) y@@4 n_25)))
 :qid |stdinbpl.4138:28|
 :skolemid |412|
 :pattern ( (select g_1 n_25))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) x@@7 n_25))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) y@@4 n_25))
))) (and (state ExhaleHeap@4 QPMask@6) (forall ((n_26 T@Ref) ) (!  (=> (select g_1 n_26) (or (not (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_26)) (not (exists_path ($$ ExhaleHeap@4 g_1) y@@4 n_26))))
 :qid |stdinbpl.4143:28|
 :skolemid |413|
 :pattern ( (select g_1 n_26))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) x@@7 n_26))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) y@@4 n_26))
...
(let ((anon293_Then_correct  (=> (= (ControlFlow 0 112) (- 0 111)) (= (edge ($$ Heap@0 g_1) u_10 v_7)  (or (edge old_g@0 u_10 v_7) (and (= u_10 last@1) (= v_7 y@@4)))))))
(let ((anon290_Else_correct  (=> (and (forall ((u_8_1 T@Ref) ) (! (= (exists_path ($$ Heap@0 g_1) x@@7 u_8_1)  (or (exists_path old_g@0 x@@7 u_8_1) (exists_path old_g@0 y@@4 u_8_1)))
 :qid |stdinbpl.5157:20|
 :skolemid |504|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| Heap@0 g_1)) g_1) x@@7 u_8_1))
 :pattern ( (exists_path old_g@0 x@@7 u_8_1))
 :pattern ( (exists_path old_g@0 y@@4 u_8_1))
...
(let ((anon289_Then_correct  (and (=> (= (ControlFlow 0 108) (- 0 109)) (forall ((n_46 T@Ref) (n_46_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_46 n_46_1)) (select g_1 n_46)) (select g_1 n_46_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_46 n_46_1)))
...
)) (=> (= (ControlFlow 0 108) (- 0 107)) (forall ((n_46@@1 T@Ref) ) (!  (=> (select g_1 n_46@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| Mask@0) n_46@@1 next) NoPerm)))
 :qid |stdinbpl.5129:23|
 :skolemid |501|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@0) n_46@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@14) n_46@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@0) n_46@@1 next))
)))))))
...
(let ((anon287_Then_correct  (and (=> (= (ControlFlow 0 103) (- 0 104)) (forall ((n_45 T@Ref) (n_45_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_45 n_45_1)) (select g_1 n_45)) (select g_1 n_45_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_45 n_45_1)))
 :qid |stdinbpl.5068:21|
 :skolemid |496|
 :pattern ( (neverTriggered75 n_45) (neverTriggered75 n_45_1))
))) (=> (forall ((n_45@@0 T@Ref) (n_45_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_45@@0 n_45_1@@0)) (select g_1 n_45@@0)) (select g_1 n_45_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_45@@0 n_45_1@@0)))
 :qid |stdinbpl.5068:21|
 :skolemid |496|
 :pattern ( (neverTriggered75 n_45@@0) (neverTriggered75 n_45_1@@0))
)) (=> (= (ControlFlow 0 103) (- 0 102)) (forall ((n_45@@1 T@Ref) ) (!  (=> (select g_1 n_45@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| Mask@0) n_45@@1 next) NoPerm)))
 :qid |stdinbpl.5075:21|
 :skolemid |497|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@0) n_45@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@12) n_45@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@0) n_45@@1 next))
)))))))
...
(let ((anon286_Then_correct  (and (=> (= (ControlFlow 0 100) (- 0 101)) (forall ((n_44 T@Ref) (n_44_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_44 n_44_1)) (select g_1 n_44)) (select g_1 n_44_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_44 n_44_1)))
 :qid |stdinbpl.5020:21|
 :skolemid |492|
 :pattern ( (neverTriggered74 n_44) (neverTriggered74 n_44_1))
))) (=> (forall ((n_44@@0 T@Ref) (n_44_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_44@@0 n_44_1@@0)) (select g_1 n_44@@0)) (select g_1 n_44_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_44@@0 n_44_1@@0)))
 :qid |stdinbpl.5020:21|
 :skolemid |492|
 :pattern ( (neverTriggered74 n_44@@0) (neverTriggered74 n_44_1@@0))
)) (=> (= (ControlFlow 0 100) (- 0 99)) (forall ((n_44@@1 T@Ref) ) (!  (=> (select g_1 n_44@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| Mask@0) n_44@@1 next) NoPerm)))
 :qid |stdinbpl.5027:21|
 :skolemid |493|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@0) n_44@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@11) n_44@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@0) n_44@@1 next))
)))))))
...
(let ((anon285_Then_correct  (and (=> (= (ControlFlow 0 97) (- 0 98)) (forall ((n_43 T@Ref) (n_43_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_43 n_43_1)) (select g_1 n_43)) (select g_1 n_43_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_43 n_43_1)))
 :qid |stdinbpl.4972:21|
 :skolemid |488|
 :pattern ( (neverTriggered73 n_43) (neverTriggered73 n_43_1))
))) (=> (forall ((n_43@@0 T@Ref) (n_43_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_43@@0 n_43_1@@0)) (select g_1 n_43@@0)) (select g_1 n_43_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_43@@0 n_43_1@@0)))
 :qid |stdinbpl.4972:21|
 :skolemid |488|
 :pattern ( (neverTriggered73 n_43@@0) (neverTriggered73 n_43_1@@0))
)) (=> (= (ControlFlow 0 97) (- 0 96)) (forall ((n_43@@1 T@Ref) ) (!  (=> (select g_1 n_43@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| Mask@0) n_43@@1 next) NoPerm)))
 :qid |stdinbpl.4979:21|
 :skolemid |489|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@0) n_43@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@10) n_43@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@0) n_43@@1 next))
)))))))
...
(let ((anon283_Else_correct  (=> (and (forall ((u_5_1 T@Ref) (v_5_1 T@Ref) ) (!  (=> (not (exists_path ($$ ExhaleHeap@5 g_1) u_5_1 v_5_1)) (not (edge ($$ ExhaleHeap@5 g_1) u_5_1 v_5_1)))
 :qid |stdinbpl.4944:24|
 :skolemid |487|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@5 g_1)) g_1) u_5_1 v_5_1))
 :pattern ( (edge (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@5 g_1)) g_1) u_5_1 v_5_1))
...
(let ((anon284_Else_correct  (=> (and (exists_path ($$ ExhaleHeap@5 g_1) u_4 v_4_1) (= (ControlFlow 0 95) 92)) anon170_correct)))
(let ((anon284_Then_correct  (=> (not (exists_path ($$ ExhaleHeap@5 g_1) u_4 v_4_1)) (and (=> (= (ControlFlow 0 93) (- 0 94)) (not (edge ($$ ExhaleHeap@5 g_1) u_4 v_4_1))) (=> (not (edge ($$ ExhaleHeap@5 g_1) u_4 v_4_1)) (=> (= (ControlFlow 0 93) 92) anon170_correct))))))
(let ((anon282_Then_correct  (and (=> (= (ControlFlow 0 89) (- 0 90)) (forall ((n_42 T@Ref) (n_42_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_42 n_42_1)) (select g_1 n_42)) (select g_1 n_42_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_42 n_42_1)))
 :qid |stdinbpl.4906:29|
 :skolemid |483|
 :pattern ( (neverTriggered72 n_42) (neverTriggered72 n_42_1))
))) (=> (forall ((n_42@@0 T@Ref) (n_42_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_42@@0 n_42_1@@0)) (select g_1 n_42@@0)) (select g_1 n_42_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_42@@0 n_42_1@@0)))
 :qid |stdinbpl.4906:29|
 :skolemid |483|
 :pattern ( (neverTriggered72 n_42@@0) (neverTriggered72 n_42_1@@0))
)) (=> (= (ControlFlow 0 89) (- 0 88)) (forall ((n_42@@1 T@Ref) ) (!  (=> (select g_1 n_42@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@9) n_42@@1 next) NoPerm)))
 :qid |stdinbpl.4913:29|
 :skolemid |484|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n_42@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@16) n_42@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n_42@@1 next))
)))))))
(let ((anon166_correct true))
(let ((anon281_Then_correct  (=> (not (exists_path ($$ ExhaleHeap@5 g_1) u_3 v_4)) (and (=> (= (ControlFlow 0 91) 89) anon282_Then_correct) (=> (= (ControlFlow 0 91) 86) anon166_correct)))))
(let ((anon281_Else_correct  (=> (and (exists_path ($$ ExhaleHeap@5 g_1) u_3 v_4) (= (ControlFlow 0 87) 86)) anon166_correct)))
(let ((anon280_Then_correct  (and (=> (= (ControlFlow 0 84) (- 0 85)) (forall ((n_41 T@Ref) (n_41_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_41 n_41_1)) (select g_1 n_41)) (select g_1 n_41_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_41 n_41_1)))
...
)) (=> (= (ControlFlow 0 84) (- 0 83)) (forall ((n_41@@1 T@Ref) ) (!  (=> (select g_1 n_41@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@9) n_41@@1 next) NoPerm)))
 :qid |stdinbpl.4873:27|
 :skolemid |480|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n_41@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@15) n_41@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n_41@@1 next))
)))))))
(let ((anon276_Else_correct  (=> (and (forall ((u_2_1 T@Ref) (v_2_1 T@Ref) ) (!  (=> (not (exists_path ($$ ExhaleHeap@5 g_1) u_2_1 v_2_1)) (and (not (= u_2_1 v_2_1)) (forall ((w_3_1 T@Ref) ) (!  (or (not (edge ($$ ExhaleHeap@5 g_1) u_2_1 w_3_1)) (not (exists_path ($$ ExhaleHeap@5 g_1) w_3_1 v_2_1)))
 :qid |stdinbpl.4839:91|
 :skolemid |477|
 :pattern ( (edge (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@5 g_1)) g_1) u_2_1 w_3_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@5 g_1)) g_1) w_3_1 v_2_1))
))))
 :qid |stdinbpl.4837:24|
 :skolemid |478|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@5 g_1)) g_1) u_2_1 v_2_1))
...
(let ((anon278_Then_correct  (=> (= (ControlFlow 0 79) (- 0 78)) (or (not (edge ($$ ExhaleHeap@5 g_1) u_1_1@@1 w_1_1)) (not (exists_path ($$ ExhaleHeap@5 g_1) w_1_1 v_1_1))))))
(let ((anon159_correct true))
(let ((anon278_Else_correct  (=> (and (forall ((w_2_1 T@Ref) ) (!  (or (not (edge ($$ ExhaleHeap@5 g_1) u_1_1@@1 w_2_1)) (not (exists_path ($$ ExhaleHeap@5 g_1) w_2_1 v_1_1)))
 :qid |stdinbpl.4830:28|
 :skolemid |476|
 :pattern ( (edge (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@5 g_1)) g_1) u_1_1@@1 w_2_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@5 g_1)) g_1) w_2_1 v_1_1))
)) (= (ControlFlow 0 80) 76)) anon159_correct)))
(let ((anon277_Then_correct  (=> (not (exists_path ($$ ExhaleHeap@5 g_1) u_1_1@@1 v_1_1)) (and (=> (= (ControlFlow 0 81) (- 0 82)) (not (= u_1_1@@1 v_1_1))) (=> (not (= u_1_1@@1 v_1_1)) (and (=> (= (ControlFlow 0 81) 79) anon278_Then_correct) (=> (= (ControlFlow 0 81) 80) anon278_Else_correct)))))))
(let ((anon277_Else_correct  (=> (and (exists_path ($$ ExhaleHeap@5 g_1) u_1_1@@1 v_1_1) (= (ControlFlow 0 77) 76)) anon159_correct)))
(let ((anon275_Then_correct  (and (=> (= (ControlFlow 0 71) (- 0 72)) (forall ((n_40 T@Ref) (n_40_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_40 n_40_1)) (select g_1 n_40)) (select g_1 n_40_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_40 n_40_1)))
 :qid |stdinbpl.4786:35|
 :skolemid |472|
 :pattern ( (neverTriggered70 n_40) (neverTriggered70 n_40_1))
))) (=> (forall ((n_40@@0 T@Ref) (n_40_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_40@@0 n_40_1@@0)) (select g_1 n_40@@0)) (select g_1 n_40_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_40@@0 n_40_1@@0)))
 :qid |stdinbpl.4786:35|
 :skolemid |472|
 :pattern ( (neverTriggered70 n_40@@0) (neverTriggered70 n_40_1@@0))
)) (=> (= (ControlFlow 0 71) (- 0 70)) (forall ((n_40@@1 T@Ref) ) (!  (=> (select g_1 n_40@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@9) n_40@@1 next) NoPerm)))
 :qid |stdinbpl.4793:35|
 :skolemid |473|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n_40@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@19) n_40@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n_40@@1 next))
)))))))
(let ((anon152_correct true))
(let ((anon274_Then_correct  (=> (edge ($$ ExhaleHeap@5 g_1) u_2 w_3) (and (=> (= (ControlFlow 0 73) 71) anon275_Then_correct) (=> (= (ControlFlow 0 73) 68) anon152_correct)))))
(let ((anon274_Else_correct  (=> (and (not (edge ($$ ExhaleHeap@5 g_1) u_2 w_3)) (= (ControlFlow 0 69) 68)) anon152_correct)))
(let ((anon273_Then_correct  (and (=> (= (ControlFlow 0 66) (- 0 67)) (forall ((n_39 T@Ref) (n_39_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_39 n_39_1)) (select g_1 n_39)) (select g_1 n_39_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_39 n_39_1)))
 :qid |stdinbpl.4746:33|
 :skolemid |468|
 :pattern ( (neverTriggered69 n_39) (neverTriggered69 n_39_1))
))) (=> (forall ((n_39@@0 T@Ref) (n_39_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_39@@0 n_39_1@@0)) (select g_1 n_39@@0)) (select g_1 n_39_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_39@@0 n_39_1@@0)))
 :qid |stdinbpl.4746:33|
 :skolemid |468|
 :pattern ( (neverTriggered69 n_39@@0) (neverTriggered69 n_39_1@@0))
)) (=> (= (ControlFlow 0 66) (- 0 65)) (forall ((n_39@@1 T@Ref) ) (!  (=> (select g_1 n_39@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@9) n_39@@1 next) NoPerm)))
 :qid |stdinbpl.4753:33|
 :skolemid |469|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n_39@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@18) n_39@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n_39@@1 next))
)))))))
...
(let ((anon270_Then_correct  (=> (not (exists_path ($$ ExhaleHeap@5 g_1) u_2 v_3)) (and (=> (= (ControlFlow 0 75) 74) anon271_Then_correct) (=> (= (ControlFlow 0 75) 64) anon271_Else_correct)))))
(let ((anon270_Else_correct  (=> (and (exists_path ($$ ExhaleHeap@5 g_1) u_2 v_3) (= (ControlFlow 0 63) 62)) anon153_correct)))
(let ((anon269_Then_correct  (and (=> (= (ControlFlow 0 60) (- 0 61)) (forall ((n_38 T@Ref) (n_38_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_38 n_38_1)) (select g_1 n_38)) (select g_1 n_38_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_38 n_38_1)))
 :qid |stdinbpl.4704:27|
 :skolemid |464|
 :pattern ( (neverTriggered68 n_38) (neverTriggered68 n_38_1))
))) (=> (forall ((n_38@@0 T@Ref) (n_38_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_38@@0 n_38_1@@0)) (select g_1 n_38@@0)) (select g_1 n_38_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_38@@0 n_38_1@@0)))
 :qid |stdinbpl.4704:27|
 :skolemid |464|
 :pattern ( (neverTriggered68 n_38@@0) (neverTriggered68 n_38_1@@0))
)) (=> (= (ControlFlow 0 60) (- 0 59)) (forall ((n_38@@1 T@Ref) ) (!  (=> (select g_1 n_38@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@9) n_38@@1 next) NoPerm)))
 :qid |stdinbpl.4711:27|
 :skolemid |465|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n_38@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@17) n_38@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n_38@@1 next))
)))))))
...
(let ((anon263_Else_correct  (=> (forall ((n$0_11_1 T@Ref) ) (!  (=> (and (select g_1 n$0_11_1) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$0_11_1 next) null))) (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$0_11_1 next)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n$1_6@@1 next))
)) (forall ((o_9@@17 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv67 o_9@@17)) (< NoPerm FullPerm)) (qpRange67 o_9@@17)) (= (invRecv67 o_9@@17) o_9@@17))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@5) n$1_6@@2 next))
)) (forall ((o_9@@18 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv67 o_9@@18)) (< NoPerm FullPerm)) (qpRange67 o_9@@18)) (and (=> (< NoPerm FullPerm) (= (invRecv67 o_9@@18) o_9@@18)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@9) o_9@@18 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_9@@18 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv67 o_9@@18)) (< NoPerm FullPerm)) (qpRange67 o_9@@18))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@9) o_9@@18 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_9@@18 next))))
 :qid |stdinbpl.4644:28|
 :skolemid |459|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@9) o_9@@18 next))
)))) (=> (and (and (and (and (and (forall ((o_9@@19 T@Ref) (f_5@@11 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@8) o_9@@19 f_5@@11) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@9) o_9@@19 f_5@@11)))
 :qid |stdinbpl.4648:35|
 :skolemid |460|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@8) o_9@@19 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@9) o_9@@19 f_5@@11))
)) (forall ((o_9@@20 T@Ref) (f_5@@12 T@Field_44212_44213) ) (!  (=> (not (= f_5@@12 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_9@@20 f_5@@12) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@9) o_9@@20 f_5@@12)))
 :qid |stdinbpl.4648:35|
 :skolemid |460|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_9@@20 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@9) o_9@@20 f_5@@12))
))) (forall ((o_9@@21 T@Ref) (f_5@@13 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@8) o_9@@21 f_5@@13) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@9) o_9@@21 f_5@@13)))
 :qid |stdinbpl.4648:35|
 :skolemid |460|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@8) o_9@@21 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@9) o_9@@21 f_5@@13))
))) (forall ((o_9@@22 T@Ref) (f_5@@14 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@8) o_9@@22 f_5@@14) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@9) o_9@@22 f_5@@14)))
 :qid |stdinbpl.4648:35|
 :skolemid |460|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@8) o_9@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@9) o_9@@22 f_5@@14))
...
(let ((anon264_Else_correct  (=> (and (not (and (select g_1 n$0_10_1) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$0_10_1 next) null)))) (= (ControlFlow 0 58) 55)) anon134_correct)))
(let ((anon264_Then_correct  (=> (and (select g_1 n$0_10_1) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$0_10_1 next) null))) (and (=> (= (ControlFlow 0 56) (- 0 57)) (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$0_10_1 next))) (=> (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$0_10_1 next)) (=> (= (ControlFlow 0 56) 55) anon134_correct))))))
(let ((anon131_correct  (and (=> (= (ControlFlow 0 138) (- 0 141)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 138) (- 0 140)) (forall ((n_37 T@Ref) (n_37_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_37 n_37_1)) (select g_1 n_37)) (select g_1 n_37_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_37 n_37_1)))
 :qid |stdinbpl.4568:23|
 :skolemid |448|
 :pattern ( (neverTriggered66 n_37) (neverTriggered66 n_37_1))
))) (=> (forall ((n_37@@0 T@Ref) (n_37_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_37@@0 n_37_1@@0)) (select g_1 n_37@@0)) (select g_1 n_37_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_37@@0 n_37_1@@0)))
 :qid |stdinbpl.4568:23|
 :skolemid |448|
 :pattern ( (neverTriggered66 n_37@@0) (neverTriggered66 n_37_1@@0))
)) (and (=> (= (ControlFlow 0 138) (- 0 139)) (forall ((n_37@@1 T@Ref) ) (!  (=> (select g_1 n_37@@1) (>= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) n_37@@1 next) FullPerm))
 :qid |stdinbpl.4575:23|
 :skolemid |449|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_37@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) n_37@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_37@@1 next))
))) (=> (forall ((n_37@@2 T@Ref) ) (!  (=> (select g_1 n_37@@2) (>= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) n_37@@2 next) FullPerm))
 :qid |stdinbpl.4575:23|
 :skolemid |449|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_37@@2 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) n_37@@2 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_37@@2 next))
)) (=> (forall ((n_37@@3 T@Ref) ) (!  (=> (and (select g_1 n_37@@3) (< NoPerm FullPerm)) (and (qpRange66 n_37@@3) (= (invRecv66 n_37@@3) n_37@@3)))
 :qid |stdinbpl.4581:28|
 :skolemid |450|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_37@@3 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) n_37@@3 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n_37@@3 next))
)) (=> (and (forall ((o_9@@23 T@Ref) ) (!  (=> (and (select g_1 (invRecv66 o_9@@23)) (and (< NoPerm FullPerm) (qpRange66 o_9@@23))) (= (invRecv66 o_9@@23) o_9@@23))
 :qid |stdinbpl.4585:28|
 :skolemid |451|
 :pattern ( (invRecv66 o_9@@23))
)) (forall ((o_9@@24 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv66 o_9@@24)) (and (< NoPerm FullPerm) (qpRange66 o_9@@24))) (and (= (invRecv66 o_9@@24) o_9@@24) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_9@@24 next) (- (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_9@@24 next) FullPerm)))) (=> (not (and (select g_1 (invRecv66 o_9@@24)) (and (< NoPerm FullPerm) (qpRange66 o_9@@24)))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_9@@24 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_9@@24 next))))
 :qid |stdinbpl.4591:28|
 :skolemid |452|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_9@@24 next))
))) (=> (and (and (and (forall ((o_9@@25 T@Ref) (f_5@@15 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@7) o_9@@25 f_5@@15) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@8) o_9@@25 f_5@@15)))
 :qid |stdinbpl.4597:35|
 :skolemid |453|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@8) o_9@@25 f_5@@15))
)) (forall ((o_9@@26 T@Ref) (f_5@@16 T@Field_44212_44213) ) (!  (=> (not (= f_5@@16 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_9@@26 f_5@@16) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_9@@26 f_5@@16)))
 :qid |stdinbpl.4597:35|
 :skolemid |453|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_9@@26 f_5@@16))
))) (forall ((o_9@@27 T@Ref) (f_5@@17 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@7) o_9@@27 f_5@@17) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@8) o_9@@27 f_5@@17)))
 :qid |stdinbpl.4597:35|
 :skolemid |453|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@8) o_9@@27 f_5@@17))
))) (forall ((o_9@@28 T@Ref) (f_5@@18 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@7) o_9@@28 f_5@@18) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@8) o_9@@28 f_5@@18)))
 :qid |stdinbpl.4597:35|
 :skolemid |453|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@8) o_9@@28 f_5@@18))
...
(let ((anon243_Else_correct  (=> (not (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) last@0 next) null))) (=> (and (state ExhaleHeap@4 QPMask@5) (not (select g_1 null))) (and (=> (= (ControlFlow 0 151) (- 0 152)) (forall ((n$1_5 T@Ref) (n$1_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_5 n$1_5_1)) (select g_1 n$1_5)) (select g_1 n$1_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_5 n$1_5_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$1_5@@1 next))
)) (forall ((o_9@@29 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv65 o_9@@29)) (< NoPerm FullPerm)) (qpRange65 o_9@@29)) (= (invRecv65 o_9@@29) o_9@@29))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$1_5@@2 next))
)) (forall ((o_9@@30 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv65 o_9@@30)) (< NoPerm FullPerm)) (qpRange65 o_9@@30)) (and (=> (< NoPerm FullPerm) (= (invRecv65 o_9@@30) o_9@@30)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_9@@30 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@30 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv65 o_9@@30)) (< NoPerm FullPerm)) (qpRange65 o_9@@30))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_9@@30 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@30 next))))
 :qid |stdinbpl.4502:28|
 :skolemid |443|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_9@@30 next))
)))) (=> (and (and (and (and (and (forall ((o_9@@31 T@Ref) (f_5@@19 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@5) o_9@@31 f_5@@19) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@7) o_9@@31 f_5@@19)))
 :qid |stdinbpl.4506:35|
 :skolemid |444|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@5) o_9@@31 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@7) o_9@@31 f_5@@19))
)) (forall ((o_9@@32 T@Ref) (f_5@@20 T@Field_44212_44213) ) (!  (=> (not (= f_5@@20 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@32 f_5@@20) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_9@@32 f_5@@20)))
 :qid |stdinbpl.4506:35|
 :skolemid |444|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@32 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_9@@32 f_5@@20))
))) (forall ((o_9@@33 T@Ref) (f_5@@21 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@5) o_9@@33 f_5@@21) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@7) o_9@@33 f_5@@21)))
 :qid |stdinbpl.4506:35|
 :skolemid |444|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@5) o_9@@33 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@7) o_9@@33 f_5@@21))
))) (forall ((o_9@@34 T@Ref) (f_5@@22 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@5) o_9@@34 f_5@@22) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@7) o_9@@34 f_5@@22)))
 :qid |stdinbpl.4506:35|
 :skolemid |444|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@5) o_9@@34 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@7) o_9@@34 f_5@@22))
))) (state ExhaleHeap@4 QPMask@7)) (and (and (and (and (forall ((n$2_7_1 T@Ref) ) (!  (=> (and (select g_1 n$2_7_1) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$2_7_1 next) null))) (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$2_7_1 next)))
 :qid |stdinbpl.4512:26|
 :skolemid |445|
 :pattern ( (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$2_7_1 next)))
 :pattern ( (select g_1 n$2_7_1) (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| ExhaleHeap@4) n$2_7_1 next))
)) (select g_1 last@0)) (and (select g_1 x@@7) (select g_1 y@@4))) (and (and (state ExhaleHeap@4 QPMask@7) (forall ((n_35 T@Ref) ) (!  (=> (select g_1 n_35) (or (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_35) (exists_path ($$ ExhaleHeap@4 g_1) y@@4 n_35)))
 :qid |stdinbpl.4520:26|
 :skolemid |446|
 :pattern ( (select g_1 n_35))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) x@@7 n_35))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) y@@4 n_35))
))) (and (state ExhaleHeap@4 QPMask@7) (forall ((n_36 T@Ref) ) (!  (=> (select g_1 n_36) (or (not (exists_path ($$ ExhaleHeap@4 g_1) x@@7 n_36)) (not (exists_path ($$ ExhaleHeap@4 g_1) y@@4 n_36))))
 :qid |stdinbpl.4525:26|
 :skolemid |447|
 :pattern ( (select g_1 n_36))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) x@@7 n_36))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) y@@4 n_36))
...
(let ((anon214_Else_correct  (=> (forall ((n_13_1 T@Ref) ) (!  (=> (select g_1 n_13_1) (or (not (exists_path ($$ Heap@@19 g_1) x@@7 n_13_1)) (not (exists_path ($$ Heap@@19 g_1) y@@4 n_13_1))))
 :qid |stdinbpl.3489:28|
 :skolemid |351|
 :pattern ( (select g_1 n_13_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| Heap@@19 g_1)) g_1) x@@7 n_13_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| Heap@@19 g_1)) g_1) y@@4 n_13_1))
...
(let ((anon215_Else_correct  (=> (and (not (select g_1 n_12)) (= (ControlFlow 0 54) 51)) anon45_correct)))
(let ((anon215_Then_correct  (=> (select g_1 n_12) (and (=> (= (ControlFlow 0 52) (- 0 53)) (or (not (exists_path ($$ Heap@@19 g_1) x@@7 n_12)) (not (exists_path ($$ Heap@@19 g_1) y@@4 n_12)))) (=> (or (not (exists_path ($$ Heap@@19 g_1) x@@7 n_12)) (not (exists_path ($$ Heap@@19 g_1) y@@4 n_12))) (=> (= (ControlFlow 0 52) 51) anon45_correct))))))
(let ((anon212_Else_correct  (=> (forall ((n_11_1 T@Ref) ) (!  (=> (select g_1 n_11_1) (or (exists_path ($$ Heap@@19 g_1) x@@7 n_11_1) (exists_path ($$ Heap@@19 g_1) y@@4 n_11_1)))
 :qid |stdinbpl.3478:28|
 :skolemid |350|
 :pattern ( (select g_1 n_11_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| Heap@@19 g_1)) g_1) x@@7 n_11_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| Heap@@19 g_1)) g_1) y@@4 n_11_1))
...
(let ((anon210_Else_correct  (=> (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1_1) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$2_1_1 next) null))) (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$2_1_1 next)))
 :qid |stdinbpl.3461:28|
 :skolemid |349|
 :pattern ( (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$2_1_1 next)))
 :pattern ( (select g_1 n$2_1_1) (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$2_1_1 next))
...
(let ((anon211_Else_correct  (=> (and (not (and (select g_1 n$2_6) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$2_6 next) null)))) (= (ControlFlow 0 46) 43)) anon37_correct)))
(let ((anon211_Then_correct  (=> (and (select g_1 n$2_6) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$2_6 next) null))) (and (=> (= (ControlFlow 0 44) (- 0 45)) (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$2_6 next))) (=> (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$2_6 next)) (=> (= (ControlFlow 0 44) 43) anon37_correct))))))
(let ((anon209_Else_correct  (=> (not (= x@@7 null)) (and (=> (= (ControlFlow 0 308) (- 0 311)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 308) (- 0 310)) (forall ((n$1 T@Ref) (n$1_7 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1 n$1_7)) (select g_1 n$1)) (select g_1 n$1_7)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1 n$1_7)))
...
)) (and (=> (= (ControlFlow 0 308) (- 0 309)) (forall ((n$1@@1 T@Ref) ) (!  (=> (select g_1 n$1@@1) (>= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) n$1@@1 next) FullPerm))
 :qid |stdinbpl.3427:25|
 :skolemid |344|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) n$1@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1@@1 next))
))) (=> (forall ((n$1@@2 T@Ref) ) (!  (=> (select g_1 n$1@@2) (>= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) n$1@@2 next) FullPerm))
 :qid |stdinbpl.3427:25|
 :skolemid |344|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1@@2 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) n$1@@2 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1@@2 next))
)) (=> (forall ((n$1@@3 T@Ref) ) (!  (=> (and (select g_1 n$1@@3) (< NoPerm FullPerm)) (and (qpRange46 n$1@@3) (= (invRecv46 n$1@@3) n$1@@3)))
 :qid |stdinbpl.3433:30|
 :skolemid |345|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1@@3 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) n$1@@3 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1@@3 next))
)) (=> (and (forall ((o_9@@35 T@Ref) ) (!  (=> (and (select g_1 (invRecv46 o_9@@35)) (and (< NoPerm FullPerm) (qpRange46 o_9@@35))) (= (invRecv46 o_9@@35) o_9@@35))
 :qid |stdinbpl.3437:30|
 :skolemid |346|
 :pattern ( (invRecv46 o_9@@35))
)) (forall ((o_9@@36 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv46 o_9@@36)) (and (< NoPerm FullPerm) (qpRange46 o_9@@36))) (and (= (invRecv46 o_9@@36) o_9@@36) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@36 next) (- (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@36 next) FullPerm)))) (=> (not (and (select g_1 (invRecv46 o_9@@36)) (and (< NoPerm FullPerm) (qpRange46 o_9@@36)))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@36 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@36 next))))
 :qid |stdinbpl.3443:30|
 :skolemid |347|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@36 next))
))) (=> (and (and (and (forall ((o_9@@37 T@Ref) (f_5@@23 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@0) o_9@@37 f_5@@23) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@5) o_9@@37 f_5@@23)))
 :qid |stdinbpl.3449:37|
 :skolemid |348|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@5) o_9@@37 f_5@@23))
)) (forall ((o_9@@38 T@Ref) (f_5@@24 T@Field_44212_44213) ) (!  (=> (not (= f_5@@24 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@38 f_5@@24) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@38 f_5@@24)))
 :qid |stdinbpl.3449:37|
 :skolemid |348|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@38 f_5@@24))
))) (forall ((o_9@@39 T@Ref) (f_5@@25 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@0) o_9@@39 f_5@@25) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@5) o_9@@39 f_5@@25)))
 :qid |stdinbpl.3449:37|
 :skolemid |348|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@5) o_9@@39 f_5@@25))
))) (forall ((o_9@@40 T@Ref) (f_5@@26 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@0) o_9@@40 f_5@@26) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@5) o_9@@40 f_5@@26)))
 :qid |stdinbpl.3449:37|
 :skolemid |348|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@5) o_9@@40 f_5@@26))
...
(let ((anon204_Then_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((n$0_5 T@Ref) (n$0_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5 n$0_5_1)) (select g_1 n$0_5)) (select g_1 n$0_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5 n$0_5_1)))
 :qid |stdinbpl.3171:27|
 :skolemid |322|
 :pattern ( (neverTriggered41 n$0_5) (neverTriggered41 n$0_5_1))
))) (=> (forall ((n$0_5@@0 T@Ref) (n$0_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5@@0 n$0_5_1@@0)) (select g_1 n$0_5@@0)) (select g_1 n$0_5_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5@@0 n$0_5_1@@0)))
 :qid |stdinbpl.3171:27|
 :skolemid |322|
...
(let ((anon203_Then_correct  (=> (exists_path ($$ Heap@@19 g_1) x@@7 n_11) (and (=> (= (ControlFlow 0 29) 27) anon204_Then_correct) (=> (= (ControlFlow 0 29) 20) anon23_correct)))))
(let ((anon203_Else_correct  (=> (and (not (exists_path ($$ Heap@@19 g_1) x@@7 n_11)) (= (ControlFlow 0 25) 20)) anon23_correct)))
(let ((anon201_Then_correct  (=> (select g_1 n_11) (and (and (=> (= (ControlFlow 0 30) 23) anon202_Then_correct) (=> (= (ControlFlow 0 30) 29) anon203_Then_correct)) (=> (= (ControlFlow 0 30) 25) anon203_Else_correct)))))
(let ((anon201_Else_correct  (=> (and (not (select g_1 n_11)) (= (ControlFlow 0 21) 20)) anon23_correct)))
...
(let ((anon199_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((n$0_3 T@Ref) (n$0_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_3 n$0_3_1)) (select g_1 n$0_3)) (select g_1 n$0_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_3 n$0_3_1)))
 :qid |stdinbpl.3078:27|
 :skolemid |313|
 :pattern ( (neverTriggered39 n$0_3) (neverTriggered39 n$0_3_1))
))) (=> (forall ((n$0_3@@0 T@Ref) (n$0_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_3@@0 n$0_3_1@@0)) (select g_1 n$0_3@@0)) (select g_1 n$0_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_3@@0 n$0_3_1@@0)))
 :qid |stdinbpl.3078:27|
 :skolemid |313|
 :pattern ( (neverTriggered39 n$0_3@@0) (neverTriggered39 n$0_3_1@@0))
)) (=> (= (ControlFlow 0 16) (- 0 15)) (forall ((n$0_3@@1 T@Ref) ) (!  (=> (select g_1 n$0_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) n$0_3@@1 next) NoPerm)))
 :qid |stdinbpl.3085:27|
 :skolemid |314|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@40) n$0_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_3@@1 next))
)))))))
(let ((anon197_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((n$0_2 T@Ref) (n$0_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_2 n$0_2_1)) (select g_1 n$0_2)) (select g_1 n$0_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_2 n$0_2_1)))
 :qid |stdinbpl.3038:25|
 :skolemid |309|
 :pattern ( (neverTriggered38 n$0_2) (neverTriggered38 n$0_2_1))
))) (=> (forall ((n$0_2@@0 T@Ref) (n$0_2_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_2@@0 n$0_2_1@@0)) (select g_1 n$0_2@@0)) (select g_1 n$0_2_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_2@@0 n$0_2_1@@0)))
 :qid |stdinbpl.3038:25|
 :skolemid |309|
 :pattern ( (neverTriggered38 n$0_2@@0) (neverTriggered38 n$0_2_1@@0))
)) (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((n$0_2@@1 T@Ref) ) (!  (=> (select g_1 n$0_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) n$0_2@@1 next) NoPerm)))
 :qid |stdinbpl.3045:25|
 :skolemid |310|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@39) n$0_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_2@@1 next))
)))))))
(let ((anon15_correct true))
(let ((anon198_Then_correct  (=> (not (exists_path ($$ Heap@@19 g_1) x@@7 n_10)) (and (=> (= (ControlFlow 0 18) 16) anon199_Then_correct) (=> (= (ControlFlow 0 18) 9) anon15_correct)))))
(let ((anon198_Else_correct  (=> (and (exists_path ($$ Heap@@19 g_1) x@@7 n_10) (= (ControlFlow 0 14) 9)) anon15_correct)))
(let ((anon196_Then_correct  (=> (select g_1 n_10) (and (and (=> (= (ControlFlow 0 19) 12) anon197_Then_correct) (=> (= (ControlFlow 0 19) 18) anon198_Then_correct)) (=> (= (ControlFlow 0 19) 14) anon198_Else_correct)))))
(let ((anon196_Else_correct  (=> (and (not (select g_1 n_10)) (= (ControlFlow 0 10) 9)) anon15_correct)))
...
(let ((anon194_Else_correct  (=> (and (not (and (select g_1 n$0_13) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_13 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon194_Then_correct  (=> (and (select g_1 n$0_13) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_13 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29078_29079 QPMask@0 n$0_13 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0_13 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon193_Else_correct  (=> (not (select g_1 n$0_13)) (and (=> (= (ControlFlow 0 8) 3) anon194_Then_correct) (=> (= (ControlFlow 0 8) 5) anon194_Else_correct)))))
(let ((anon193_Then_correct  (=> (select g_1 n$0_13) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29078_29079 QPMask@0 n$0_13 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0_13 next) (and (=> (= (ControlFlow 0 6) 3) anon194_Then_correct) (=> (= (ControlFlow 0 6) 5) anon194_Else_correct)))))))
(let ((anon191_Else_correct  (and (=> (= (ControlFlow 0 319) (- 0 320)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@1 next))
)) (forall ((o_9@@41 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv37 o_9@@41)) (< NoPerm FullPerm)) (qpRange37 o_9@@41)) (= (invRecv37 o_9@@41) o_9@@41))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@2 next))
)) (forall ((o_9@@42 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv37 o_9@@42)) (< NoPerm FullPerm)) (qpRange37 o_9@@42)) (and (=> (< NoPerm FullPerm) (= (invRecv37 o_9@@42) o_9@@42)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@42 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@42 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv37 o_9@@42)) (< NoPerm FullPerm)) (qpRange37 o_9@@42))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@42 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@42 next))))
 :qid |stdinbpl.2990:22|
 :skolemid |306|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@42 next))
)))) (=> (and (and (and (and (forall ((o_9@@43 T@Ref) (f_5@@27 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_9@@43 f_5@@27) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@0) o_9@@43 f_5@@27)))
 :qid |stdinbpl.2994:29|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_9@@43 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@0) o_9@@43 f_5@@27))
)) (forall ((o_9@@44 T@Ref) (f_5@@28 T@Field_44212_44213) ) (!  (=> (not (= f_5@@28 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@44 f_5@@28) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@44 f_5@@28)))
 :qid |stdinbpl.2994:29|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@44 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@44 f_5@@28))
))) (forall ((o_9@@45 T@Ref) (f_5@@29 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_9@@45 f_5@@29) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@0) o_9@@45 f_5@@29)))
 :qid |stdinbpl.2994:29|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_9@@45 f_5@@29))
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@0) o_9@@45 f_5@@29))
))) (forall ((o_9@@46 T@Ref) (f_5@@30 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_9@@46 f_5@@30) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@0) o_9@@46 f_5@@30)))
 :qid |stdinbpl.2994:29|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_9@@46 f_5@@30))
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@0) o_9@@46 f_5@@30))
