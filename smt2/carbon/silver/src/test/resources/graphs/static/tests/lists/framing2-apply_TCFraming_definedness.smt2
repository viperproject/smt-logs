...
(let ((anon44_Then_correct  (=> (and (select g1@@8 u_22) (select g1@@8 v_22)) (and (and (=> (= (ControlFlow 0 39) 32) anon45_Then_correct) (=> (= (ControlFlow 0 39) 36) anon46_Then_correct)) (=> (= (ControlFlow 0 39) 29) anon29_correct)))))
(let ((anon44_Else_correct  (=> (and (not (and (select g1@@8 u_22) (select g1@@8 v_22))) (= (ControlFlow 0 30) 29)) anon29_correct)))
...
(let ((anon41_Then_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((n_4_1 T@Ref) ) (!  (=> (and (select g0@@8 n_4_1) (dummyFunction_29365 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1570:25|
 :skolemid |196|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@4) n_4_1 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1 next))
))) (=> (forall ((n_4_1@@0 T@Ref) ) (!  (=> (and (select g0@@8 n_4_1@@0) (dummyFunction_29365 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1570:25|
 :skolemid |196|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@4) n_4_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@0 next))
)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((n_4_1@@1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1@@1 n_4_2)) (select g0@@8 n_4_1@@1)) (select g0@@8 n_4_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_4_1@@1 n_4_2)))
 :qid |stdinbpl.1577:25|
 :skolemid |197|
 :pattern ( (neverTriggered10 n_4_1@@1) (neverTriggered10 n_4_2))
))) (=> (forall ((n_4_1@@2 T@Ref) (n_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1@@2 n_4_2@@0)) (select g0@@8 n_4_1@@2)) (select g0@@8 n_4_2@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_4_1@@2 n_4_2@@0)))
 :qid |stdinbpl.1577:25|
 :skolemid |197|
 :pattern ( (neverTriggered10 n_4_1@@2) (neverTriggered10 n_4_2@@0))
)) (=> (= (ControlFlow 0 20) (- 0 19)) (forall ((n_4_1@@3 T@Ref) ) (!  (=> (select g0@@8 n_4_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) n_4_1@@3 next) NoPerm)))
 :qid |stdinbpl.1584:25|
 :skolemid |198|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@4) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@3 next))
)))))))))
(let ((anon22_correct true))
(let ((anon40_Then_correct  (=> (and (select g0@@8 u_21) (select g0@@8 v_21)) (and (and (=> (= (ControlFlow 0 27) 20) anon41_Then_correct) (=> (= (ControlFlow 0 27) 24) anon42_Then_correct)) (=> (= (ControlFlow 0 27) 17) anon22_correct)))))
(let ((anon40_Else_correct  (=> (and (not (and (select g0@@8 u_21) (select g0@@8 v_21))) (= (ControlFlow 0 18) 17)) anon22_correct)))
...
(let ((anon38_Else_correct  (=> (and (not (and (select g1@@8 n$2_23) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_23 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon38_Then_correct  (=> (and (select g1@@8 n$2_23) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_23 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_29364_29365 QPMask@1 n$2_23 next)) (=> (HasDirectPerm_29364_29365 QPMask@1 n$2_23 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon37_Else_correct  (=> (not (select g1@@8 n$2_23)) (and (=> (= (ControlFlow 0 16) 11) anon38_Then_correct) (=> (= (ControlFlow 0 16) 13) anon38_Else_correct)))))
(let ((anon37_Then_correct  (=> (select g1@@8 n$2_23) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_29364_29365 QPMask@1 n$2_23 next)) (=> (HasDirectPerm_29364_29365 QPMask@1 n$2_23 next) (and (=> (= (ControlFlow 0 14) 11) anon38_Then_correct) (=> (= (ControlFlow 0 14) 13) anon38_Else_correct)))))))
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((n$1_3 T@Ref) (n$1_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_3 n$1_3_1)) (select g1@@8 n$1_3)) (select g1@@8 n$1_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_3 n$1_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_3@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g1@@8 (invRecv9 o_4)) (< NoPerm FullPerm)) (qpRange9 o_4)) (= (invRecv9 o_4) o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_3@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@8 (invRecv9 o_4@@0)) (< NoPerm FullPerm)) (qpRange9 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@0 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g1@@8 (invRecv9 o_4@@0)) (< NoPerm FullPerm)) (qpRange9 o_4@@0))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@0 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@0 next))))
...
(let ((anon32_Else_correct  (=> (and (forall ((n$0_2_1 T@Ref) ) (!  (=> (and (select g0@@8 n$0_2_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next) null))) (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next)))
 :qid |stdinbpl.1489:20|
 :skolemid |188|
 :pattern ( (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next)))
 :pattern ( (select g0@@8 n$0_2_1) (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next))
)) (not (select g1@@8 null))) (and (=> (= (ControlFlow 0 44) 9) anon35_Then_correct) (=> (= (ControlFlow 0 44) 42) anon35_Else_correct)))))
(let ((anon7_correct true))
(let ((anon34_Else_correct  (=> (and (not (and (select g0@@8 n$0_26) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_26 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon34_Then_correct  (=> (and (select g0@@8 n$0_26) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_26 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29364_29365 QPMask@0 n$0_26 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_26 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon33_Else_correct  (=> (not (select g0@@8 n$0_26)) (and (=> (= (ControlFlow 0 8) 3) anon34_Then_correct) (=> (= (ControlFlow 0 8) 5) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (select g0@@8 n$0_26) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29364_29365 QPMask@0 n$0_26 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_26 next) (and (=> (= (ControlFlow 0 6) 3) anon34_Then_correct) (=> (= (ControlFlow 0 6) 5) anon34_Else_correct)))))))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 45) (- 0 46)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select g0@@8 n_3)) (select g0@@8 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_3@@1 next))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select g0@@8 (invRecv8 o_4@@5)) (< NoPerm FullPerm)) (qpRange8 o_4@@5)) (= (invRecv8 o_4@@5) o_4@@5))
