...
(assert (not
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$0_5@@0 next))
)) (and (=> (= (ControlFlow 0 82) (- 0 83)) (forall ((n$0_5@@1 T@Ref) (n$0_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5@@1 n$0_5_1)) (select g_1 n$0_5@@1)) (select g_1 n$0_5_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_5@@1 n$0_5_1)))
...
(let ((anon91_Then_correct  (=> (exists_path ($$ PostHeap@0 g_1) n_79 m_16) (and (=> (= (ControlFlow 0 85) 82) anon92_Then_correct) (=> (= (ControlFlow 0 85) 74) anon46_correct)))))
(let ((anon91_Else_correct  (=> (and (not (exists_path ($$ PostHeap@0 g_1) n_79 m_16)) (= (ControlFlow 0 80) 74)) anon46_correct)))
(let ((anon89_Then_correct  (=> (and (select g_1 n_79) (select g_1 m_16)) (and (and (=> (= (ControlFlow 0 86) 77) anon90_Then_correct) (=> (= (ControlFlow 0 86) 85) anon91_Then_correct)) (=> (= (ControlFlow 0 86) 80) anon91_Else_correct)))))
(let ((anon89_Else_correct  (=> (and (not (and (select g_1 n_79) (select g_1 m_16))) (= (ControlFlow 0 75) 74)) anon46_correct)))
...
(let ((anon81_Else_correct  (=> (and (forall ((n$2_1 T@Ref) ) (!  (=> (select g_1 n$2_1) (select g_1 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$2_1 next)))
...
(let ((anon82_Else_correct  (=> (and (not (select g_1 n$2_32)) (= (ControlFlow 0 61) 58)) anon29_correct)))
(let ((anon82_Then_correct  (=> (select g_1 n$2_32) (and (=> (= (ControlFlow 0 59) (- 0 60)) (HasDirectPerm_48849_48850 QPMask@2 n$2_32 next)) (=> (HasDirectPerm_48849_48850 QPMask@2 n$2_32 next) (=> (= (ControlFlow 0 59) 58) anon29_correct))))))
(let ((anon80_Else_correct  (and (=> (= (ControlFlow 0 90) (- 0 91)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g_1 n$1_1)) (select g_1 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv87 o_9)) (< NoPerm FullPerm)) (qpRange87 o_9)) (= (invRecv87 o_9) o_9))
 :qid |stdinbpl.7095:22|
 :skolemid |773|
 :pattern ( (invRecv87 o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) n$1_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv87 o_9@@0)) (< NoPerm FullPerm)) (qpRange87 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv87 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) o_9@@0 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv87 o_9@@0)) (< NoPerm FullPerm)) (qpRange87 o_9@@0))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) o_9@@0 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.7107:22|
 :skolemid |775|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) o_9@@0 next))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@2) o_9@@1 f_5)))
...
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_74000_74001) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.7111:29|
 :skolemid |776|
...
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.7111:29|
 :skolemid |776|
...
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.7111:29|
 :skolemid |776|
...
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@2) o_9@@5 f_5@@3)))
 :qid |stdinbpl.7111:29|
 :skolemid |776|
...
(let ((anon79_Else_correct  (and (=> (= (ControlFlow 0 53) (- 0 56)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 53) (- 0 55)) (forall ((n$1_2 T@Ref) (n$1_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_2 n$1_2_1)) (select g_1 n$1_2)) (select g_1 n$1_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_2 n$1_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$1_2@@3 next))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (select g_1 (invRecv90 o_9@@6)) (and (< NoPerm FullPerm) (qpRange90 o_9@@6))) (= (invRecv90 o_9@@6) o_9@@6))
 :qid |stdinbpl.7296:22|
 :skolemid |794|
 :pattern ( (invRecv90 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv90 o_9@@7)) (and (< NoPerm FullPerm) (qpRange90 o_9@@7))) (and (= (invRecv90 o_9@@7) o_9@@7) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_9@@7 next) (- (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_9@@7 next) FullPerm)))) (=> (not (and (select g_1 (invRecv90 o_9@@7)) (and (< NoPerm FullPerm) (qpRange90 o_9@@7)))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_9@@7 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_9@@7 next))))
 :qid |stdinbpl.7302:22|
 :skolemid |795|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_9@@7 next))
))) (=> (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@0) o_9@@8 f_5@@4) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@1) o_9@@8 f_5@@4)))
 :qid |stdinbpl.7308:29|
 :skolemid |796|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@1) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_74000_74001) ) (!  (=> (not (= f_5@@5 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_9@@9 f_5@@5) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_9@@9 f_5@@5)))
 :qid |stdinbpl.7308:29|
 :skolemid |796|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@1) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@0) o_9@@10 f_5@@6) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@1) o_9@@10 f_5@@6)))
 :qid |stdinbpl.7308:29|
 :skolemid |796|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@1) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@0) o_9@@11 f_5@@7) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@1) o_9@@11 f_5@@7)))
 :qid |stdinbpl.7308:29|
 :skolemid |796|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@1) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@0) o_9@@12 f_5@@8) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@1) o_9@@12 f_5@@8)))
 :qid |stdinbpl.7308:29|
 :skolemid |796|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@1) o_9@@12 f_5@@8))
...
(let ((anon74_Else_correct  (=> (and (forall ((n_3 T@Ref) (m_1 T@Ref) ) (!  (=> (and (select g_1 n_3) (select g_1 m_1)) (and (exists_path ($$ Heap@@32 g_1) n_3 start_1@@1) (exists_path ($$ Heap@@32 g_1) start_1@@1 m_1)))
...
(let ((anon78_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((n$0_3 T@Ref) ) (!  (=> (and (select g_1 n$0_3) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_3 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.7022:27|
 :skolemid |765|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_3 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) n$0_3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_3 next))
 ...
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) n$0_3@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_3@@0 next))
 ...
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@6) n$0_3@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_3@@3 next))
)))))))))
(let ((anon76_Then_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((n$0_2 T@Ref) ) (!  (=> (and (select g_1 n$0_2) (dummyFunction_48850 (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_2 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.6978:25|
 :skolemid |760|
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_2 next))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) n$0_2 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_2 next))
 ...
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) n$0_2@@0 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_2@@0 next))
 ...
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@5) n$0_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n$0_2@@3 next))
)))))))))
(let ((anon22_correct true))
(let ((anon77_Then_correct  (=> (exists_path ($$ Heap@@32 g_1) n_78 start_1@@1) (and (=> (= (ControlFlow 0 28) 25) anon78_Then_correct) (=> (= (ControlFlow 0 28) 17) anon22_correct)))))
(let ((anon77_Else_correct  (=> (and (not (exists_path ($$ Heap@@32 g_1) n_78 start_1@@1)) (= (ControlFlow 0 23) 17)) anon22_correct)))
(let ((anon75_Then_correct  (=> (and (select g_1 n_78) (select g_1 m_14)) (and (and (=> (= (ControlFlow 0 29) 20) anon76_Then_correct) (=> (= (ControlFlow 0 29) 28) anon77_Then_correct)) (=> (= (ControlFlow 0 29) 23) anon77_Else_correct)))))
(let ((anon75_Else_correct  (=> (and (not (and (select g_1 n_78) (select g_1 m_14))) (= (ControlFlow 0 18) 17)) anon22_correct)))
...
)) (=> (and (and (state Heap@@32 QPMask@0) (select g_1 start_1@@1)) (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0))) (and (and (=> (= (ControlFlow 0 94) 93) anon74_Else_correct) (=> (= (ControlFlow 0 94) 29) anon75_Then_correct)) (=> (= (ControlFlow 0 94) 18) anon75_Else_correct))))))
...
(let ((anon71_Else_correct  (=> (and (not (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) v1_21 next) v_34)) (= (ControlFlow 0 10) 6)) anon10_correct)))
(let ((anon71_Then_correct  (=> (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) v1_21 next) v_34) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_48849_48850 QPMask@0 v2_21 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 v2_21 next) (=> (= (ControlFlow 0 8) 6) anon10_correct))))))
(let ((anon70_Then_correct  (=> (and (select g_1 v1_21) (and (select g_1 v2_21) (select g_1 v_34))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_48849_48850 QPMask@0 v1_21 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 v1_21 next) (and (=> (= (ControlFlow 0 11) 8) anon71_Then_correct) (=> (= (ControlFlow 0 11) 10) anon71_Else_correct)))))))
(let ((anon70_Else_correct  (=> (and (not (and (select g_1 v1_21) (and (select g_1 v2_21) (select g_1 v_34)))) (= (ControlFlow 0 7) 6)) anon10_correct)))
...
(let ((anon68_Else_correct  (=> (and (not (select g_1 n$0_35)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon68_Then_correct  (=> (select g_1 n$0_35) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_48849_48850 QPMask@0 n$0_35 next)) (=> (HasDirectPerm_48849_48850 QPMask@0 n$0_35 next) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon66_Else_correct  (and (=> (= (ControlFlow 0 97) (- 0 98)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_1@@1 next))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv84 o_9@@13)) (< NoPerm FullPerm)) (qpRange84 o_9@@13)) (= (invRecv84 o_9@@13) o_9@@13))
 :qid |stdinbpl.6896:22|
 :skolemid |753|
 :pattern ( (invRecv84 o_9@@13))
 ...
 :pattern ( (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| Heap@@32) n_1@@2 next))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv84 o_9@@14)) (< NoPerm FullPerm)) (qpRange84 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv84 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_9@@14 next) (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_9@@14 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv84 o_9@@14)) (< NoPerm FullPerm)) (qpRange84 o_9@@14))) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_9@@14 next) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_9@@14 next))))
 :qid |stdinbpl.6908:22|
 :skolemid |755|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_9@@14 next))
)))) (=> (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_73987_53) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) o_9@@15 f_5@@9) (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@0) o_9@@15 f_5@@9)))
 :qid |stdinbpl.6912:29|
 :skolemid |756|
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| QPMask@0) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_74000_74001) ) (!  (=> (not (= f_5@@10 next)) (= (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_9@@16 f_5@@10) (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_9@@16 f_5@@10)))
 :qid |stdinbpl.6912:29|
 :skolemid |756|
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| QPMask@0) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_83161_6878) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) o_9@@17 f_5@@11) (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@0) o_9@@17 f_5@@11)))
 :qid |stdinbpl.6912:29|
 :skolemid |756|
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| QPMask@0) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_48849_250533) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) o_9@@18 f_5@@12) (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@0) o_9@@18 f_5@@12)))
 :qid |stdinbpl.6912:29|
 :skolemid |756|
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| QPMask@0) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_48849_250666) ) (!  (=> true (= (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask) o_9@@19 f_5@@13) (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@0) o_9@@19 f_5@@13)))
 :qid |stdinbpl.6912:29|
 :skolemid |756|
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| QPMask@0) o_9@@19 f_5@@13))
...
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_73927_47953_53#PolymorphicMapType_73927| Heap@@32) start_1@@1 $allocated) (not (select g_1 null)))) (and (=> (= (ControlFlow 0 99) 1) anon66_Then_correct) (=> (= (ControlFlow 0 99) 97) anon66_Else_correct))))))
