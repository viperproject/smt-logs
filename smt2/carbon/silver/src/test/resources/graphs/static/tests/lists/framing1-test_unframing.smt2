...
(let ((anon51_Else_correct  (=> (and (not (and (select g0@@10 u_1@@1) (and (select g0@@10 v_1_1@@1) (edge ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_1@@1 v_1_1@@1)))) (= (ControlFlow 0 36) 33)) anon32_correct)))
(let ((anon51_Then_correct  (=> (and (select g0@@10 u_1@@1) (and (select g0@@10 v_1_1@@1) (edge ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_1@@1 v_1_1@@1))) (and (=> (= (ControlFlow 0 34) (- 0 35)) (edge ($$ Heap@@41 g0@@10) u_1@@1 v_1_1@@1)) (=> (edge ($$ Heap@@41 g0@@10) u_1@@1 v_1_1@@1) (=> (= (ControlFlow 0 34) 33) anon32_correct))))))
...
(let ((anon39_Else_correct  (=> (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g1@@10 n$2_1_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next) null))) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next)))
...
(let ((anon41_Else_correct  (=> (and (not (and (select g1@@10 n$2_21) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_21 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon41_Then_correct  (=> (and (select g1@@10 n$2_21) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_21 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_37315_37316 QPMask@1 n$2_21 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_21 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon40_Else_correct  (=> (not (select g1@@10 n$2_21)) (and (=> (= (ControlFlow 0 16) 11) anon41_Then_correct) (=> (= (ControlFlow 0 16) 13) anon41_Else_correct)))))
(let ((anon40_Then_correct  (=> (select g1@@10 n$2_21) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_37315_37316 QPMask@1 n$2_21 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_21 next) (and (=> (= (ControlFlow 0 14) 11) anon41_Then_correct) (=> (= (ControlFlow 0 14) 13) anon41_Else_correct)))))))
(let ((anon38_Else_correct  (and (=> (= (ControlFlow 0 40) (- 0 41)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@10 n$1_1)) (select g1@@10 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv66 o_4)) (< NoPerm FullPerm)) (qpRange66 o_4)) (= (invRecv66 o_4) o_4))
 :qid |stdinbpl.5006:22|
 :skolemid |510|
 :pattern ( (invRecv66 o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv66 o_4@@0)) (< NoPerm FullPerm)) (qpRange66 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv66 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv66 o_4@@0)) (< NoPerm FullPerm)) (qpRange66 o_4@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next))))
...
(let ((anon37_Else_correct  (=> (and (not (and (select g0@@10 n$0_23) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_23 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon37_Then_correct  (=> (and (select g0@@10 n$0_23) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_23 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$0_23 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_23 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon36_Else_correct  (=> (not (select g0@@10 n$0_23)) (and (=> (= (ControlFlow 0 8) 3) anon37_Then_correct) (=> (= (ControlFlow 0 8) 5) anon37_Else_correct)))))
(let ((anon36_Then_correct  (=> (select g0@@10 n$0_23) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$0_23 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_23 next) (and (=> (= (ControlFlow 0 6) 3) anon37_Then_correct) (=> (= (ControlFlow 0 6) 5) anon37_Else_correct)))))))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 43) (- 0 44)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@10 n_1)) (select g0@@10 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@1 next))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv65 o_4@@5)) (< NoPerm FullPerm)) (qpRange65 o_4@@5)) (= (invRecv65 o_4@@5) o_4@@5))
 :qid |stdinbpl.4949:22|
 :skolemid |503|
 :pattern ( (invRecv65 o_4@@5))
