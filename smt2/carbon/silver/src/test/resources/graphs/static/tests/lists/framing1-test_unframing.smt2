...
(declare-fun u_18 () T@Ref)
(declare-fun v_18 () T@Ref)
...
(let ((anon51_Else_correct  (=> (and (not (and (select g0@@10 u_1_1@@1) (and (select g0@@10 v_1_1@@1) (edge ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_1_1@@1 v_1_1@@1)))) (= (ControlFlow 0 36) 33)) anon32_correct)))
(let ((anon51_Then_correct  (=> (and (select g0@@10 u_1_1@@1) (and (select g0@@10 v_1_1@@1) (edge ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_1_1@@1 v_1_1@@1))) (and (=> (= (ControlFlow 0 34) (- 0 35)) (edge ($$ Heap@@41 g0@@10) u_1_1@@1 v_1_1@@1)) (=> (edge ($$ Heap@@41 g0@@10) u_1_1@@1 v_1_1@@1) (=> (= (ControlFlow 0 34) 33) anon32_correct))))))
(let ((anon47_Then_correct  (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((n_2 T@Ref) (n_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_2 n_2_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_2)) (select (|Set#Union_37395| g0@@10 g1@@10) n_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1)))
 :qid |stdinbpl.5100:27|
 :skolemid |517|
...
)) (=> (= (ControlFlow 0 29) (- 0 28)) (forall ((n_2@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_2@@1 next) NoPerm)))
 :qid |stdinbpl.5107:27|
 :skolemid |518|
...
(let ((anon49_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select g0@@10 n_3)) (select g0@@10 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 :qid |stdinbpl.5142:25|
 :skolemid |521|
...
(let ((anon48_Then_correct  (=> (and (select g0@@10 u_18) (and (select g0@@10 v_18) (edge ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_18 v_18))) (and (=> (= (ControlFlow 0 25) 23) anon49_Then_correct) (=> (= (ControlFlow 0 25) 20) anon28_correct)))))
(let ((anon48_Else_correct  (=> (and (not (and (select g0@@10 u_18) (and (select g0@@10 v_18) (edge ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_18 v_18)))) (= (ControlFlow 0 21) 20)) anon28_correct)))
(let ((anon46_Then_correct  (=> (select g0@@10 v_18) (and (and (=> (= (ControlFlow 0 31) 29) anon47_Then_correct) (=> (= (ControlFlow 0 31) 25) anon48_Then_correct)) (=> (= (ControlFlow 0 31) 21) anon48_Else_correct)))))
(let ((anon46_Else_correct  (=> (not (select g0@@10 v_18)) (and (=> (= (ControlFlow 0 27) 25) anon48_Then_correct) (=> (= (ControlFlow 0 27) 21) anon48_Else_correct)))))
(let ((anon45_Then_correct  (=> (select g0@@10 u_18) (and (=> (= (ControlFlow 0 32) 31) anon46_Then_correct) (=> (= (ControlFlow 0 32) 27) anon46_Else_correct)))))
(let ((anon45_Else_correct  (=> (not (select g0@@10 u_18)) (and (=> (= (ControlFlow 0 26) 25) anon48_Then_correct) (=> (= (ControlFlow 0 26) 21) anon48_Else_correct)))))
(let ((anon50_Else_correct true))
(let ((anon43_Else_correct  (=> (and (forall ((r$0_1 T@Ref) ) (!  (=> (select g1@@10 r$0_1) (not (select g0@@10 r$0_1)))
 :qid |stdinbpl.5060:20|
 :skolemid |516|
 :pattern ( (select g0@@10 r$0_1) (select g1@@10 r$0_1))
)) (state Heap@@41 QPMask@1)) (and (and (and (and (=> (= (ControlFlow 0 37) 19) anon50_Else_correct) (=> (= (ControlFlow 0 37) 34) anon51_Then_correct)) (=> (= (ControlFlow 0 37) 36) anon51_Else_correct)) (=> (= (ControlFlow 0 37) 32) anon45_Then_correct)) (=> (= (ControlFlow 0 37) 26) anon45_Else_correct)))))
(let ((anon43_Then_correct true))
(let ((anon42_Else_correct  (=> (forall ((r_1_1 T@Ref) ) (!  (=> (select g0@@10 r_1_1) (not (select g1@@10 r_1_1)))
...
(let ((anon39_Else_correct  (=> (and (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g1@@10 n$2_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1 next) null))) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1 next)))
 :qid |stdinbpl.5041:20|
 :skolemid |514|
...
)) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 39) 17) anon42_Then_correct) (=> (= (ControlFlow 0 39) 38) anon42_Else_correct)))))
(let ((anon15_correct true))
(let ((anon41_Else_correct  (=> (and (not (and (select g1@@10 n$2_19) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_19 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon41_Then_correct  (=> (and (select g1@@10 n$2_19) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_19 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_37315_37316 QPMask@1 n$2_19 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_19 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon40_Else_correct  (=> (not (select g1@@10 n$2_19)) (and (=> (= (ControlFlow 0 16) 11) anon41_Then_correct) (=> (= (ControlFlow 0 16) 13) anon41_Else_correct)))))
(let ((anon40_Then_correct  (=> (select g1@@10 n$2_19) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_37315_37316 QPMask@1 n$2_19 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_19 next) (and (=> (= (ControlFlow 0 14) 11) anon41_Then_correct) (=> (= (ControlFlow 0 14) 13) anon41_Else_correct)))))))
(let ((anon38_Else_correct  (and (=> (= (ControlFlow 0 40) (- 0 41)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@10 n$1_1)) (select g1@@10 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 :qid |stdinbpl.4996:15|
 :skolemid |508|
 ...
 :qid |stdinbpl.4996:15|
 :skolemid |508|
)) (=> (and (and (forall ((n$1_1@@1 T@Ref) ) (!  (=> (and (select g1@@10 n$1_1@@1) (< NoPerm FullPerm)) (and (qpRange66 n$1_1@@1) (= (invRecv66 n$1_1@@1) n$1_1@@1)))
 :qid |stdinbpl.5002:22|
 :skolemid |509|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv66 o_9)) (< NoPerm FullPerm)) (qpRange66 o_9)) (= (invRecv66 o_9) o_9))
 :qid |stdinbpl.5006:22|
 :skolemid |510|
 :pattern ( (invRecv66 o_9))
))) (and (forall ((n$1_1@@2 T@Ref) ) (!  (=> (select g1@@10 n$1_1@@2) (not (= n$1_1@@2 null)))
 :qid |stdinbpl.5012:22|
 :skolemid |511|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv66 o_9@@0)) (< NoPerm FullPerm)) (qpRange66 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv66 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv66 o_9@@0)) (< NoPerm FullPerm)) (qpRange66 o_9@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next))))
 :qid |stdinbpl.5018:22|
 :skolemid |512|
...
))) (state Heap@@41 QPMask@1)) (and (and (=> (= (ControlFlow 0 40) 39) anon39_Else_correct) (=> (= (ControlFlow 0 40) 14) anon40_Then_correct)) (=> (= (ControlFlow 0 40) 16) anon40_Else_correct))))))))
(let ((anon38_Then_correct true))
(let ((anon35_Else_correct  (=> (and (forall ((n$0_1 T@Ref) ) (!  (=> (and (select g0@@10 n$0_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_1 next) null))) (select g0@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_1 next)))
 :qid |stdinbpl.4984:20|
 :skolemid |507|
...
)) (not (select g1@@10 null))) (and (=> (= (ControlFlow 0 42) 9) anon38_Then_correct) (=> (= (ControlFlow 0 42) 40) anon38_Else_correct)))))
(let ((anon7_correct true))
(let ((anon37_Else_correct  (=> (and (not (and (select g0@@10 n$0_26) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_26 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon37_Then_correct  (=> (and (select g0@@10 n$0_26) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_26 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$0_26 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_26 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon36_Else_correct  (=> (not (select g0@@10 n$0_26)) (and (=> (= (ControlFlow 0 8) 3) anon37_Then_correct) (=> (= (ControlFlow 0 8) 5) anon37_Else_correct)))))
(let ((anon36_Then_correct  (=> (select g0@@10 n$0_26) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$0_26 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_26 next) (and (=> (= (ControlFlow 0 6) 3) anon37_Then_correct) (=> (= (ControlFlow 0 6) 5) anon37_Else_correct)))))))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 43) (- 0 44)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@10 n_1)) (select g0@@10 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 :qid |stdinbpl.4939:15|
 :skolemid |501|
 ...
 :qid |stdinbpl.4939:15|
 :skolemid |501|
)) (=> (and (and (forall ((n_1@@1 T@Ref) ) (!  (=> (and (select g0@@10 n_1@@1) (< NoPerm FullPerm)) (and (qpRange65 n_1@@1) (= (invRecv65 n_1@@1) n_1@@1)))
 :qid |stdinbpl.4945:22|
 :skolemid |502|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@1 next))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv65 o_9@@5)) (< NoPerm FullPerm)) (qpRange65 o_9@@5)) (= (invRecv65 o_9@@5) o_9@@5))
 :qid |stdinbpl.4949:22|
 :skolemid |503|
 :pattern ( (invRecv65 o_9@@5))
))) (and (forall ((n_1@@2 T@Ref) ) (!  (=> (select g0@@10 n_1@@2) (not (= n_1@@2 null)))
 :qid |stdinbpl.4955:22|
 :skolemid |504|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@2 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select g0@@10 (invRecv65 o_9@@6)) (< NoPerm FullPerm)) (qpRange65 o_9@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv65 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@6 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@6 next) FullPerm)))) (=> (not (and (and (select g0@@10 (invRecv65 o_9@@6)) (< NoPerm FullPerm)) (qpRange65 o_9@@6))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@6 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@6 next))))
 :qid |stdinbpl.4961:22|
 :skolemid |505|
...
))) (state Heap@@41 QPMask@0)) (and (and (=> (= (ControlFlow 0 43) 42) anon35_Else_correct) (=> (= (ControlFlow 0 43) 6) anon36_Then_correct)) (=> (= (ControlFlow 0 43) 8) anon36_Else_correct))))))))
(let ((anon34_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (not (select g0@@10 null)))) (and (=> (= (ControlFlow 0 45) 1) anon34_Then_correct) (=> (= (ControlFlow 0 45) 43) anon34_Else_correct)))))
