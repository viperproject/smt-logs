...
(declare-fun roots@@4 () (Array T@Ref Bool))
(declare-fun n$1_10 () T@Ref)
(declare-fun qpRange14 (T@Ref) Bool)
(declare-fun invRecv14 (T@Ref) T@Ref)
(set-info :boogie-vc-id |is_global_sroot#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n$0_5 T@Ref) (n$0_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5 n$0_5_1)) (select g_1@@15 n$0_5)) (select g_1@@15 n$0_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5 n$0_5_1)))
 :qid |stdinbpl.1896:25|
 :skolemid |218|
 :pattern ( (neverTriggered15 n$0_5) (neverTriggered15 n$0_5_1))
))) (=> (forall ((n$0_5@@0 T@Ref) (n$0_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5@@0 n$0_5_1@@0)) (select g_1@@15 n$0_5@@0)) (select g_1@@15 n$0_5_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5@@0 n$0_5_1@@0)))
 :qid |stdinbpl.1896:25|
 :skolemid |218|
 :pattern ( (neverTriggered15 n$0_5@@0) (neverTriggered15 n$0_5_1@@0))
)) (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((n$0_5@@1 T@Ref) ) (!  (=> (select g_1@@15 n$0_5@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) n$0_5@@1 next) NoPerm)))
 :qid |stdinbpl.1903:25|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$0_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_5@@1 next))
)))))))
(let ((anon12_correct true))
(let ((anon19_Then_correct  (=> (select g_1@@15 n_34) (and (=> (= (ControlFlow 0 15) 13) anon20_Then_correct) (=> (= (ControlFlow 0 15) 10) anon12_correct)))))
(let ((anon19_Else_correct  (=> (and (not (select g_1@@15 n_34)) (= (ControlFlow 0 11) 10)) anon12_correct)))
(let ((anon18_Else_correct true))
(let ((anon15_Else_correct  (=> (and (and (forall ((n$1_3 T@Ref) ) (!  (=> (and (select g_1@@15 n$1_3) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_3 next) null))) (select g_1@@15 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_3 next)))
 :qid |stdinbpl.1872:20|
 :skolemid |217|
 :pattern ( (select g_1@@15 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_3 next)))
 :pattern ( (select g_1@@15 n$1_3) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_3 next))
)) (state Heap@@41 QPMask@0)) (and (|Set#Subset_37790| roots@@4 g_1@@15) (state Heap@@41 QPMask@0))) (and (and (=> (= (ControlFlow 0 16) 9) anon18_Else_correct) (=> (= (ControlFlow 0 16) 15) anon19_Then_correct)) (=> (= (ControlFlow 0 16) 11) anon19_Else_correct)))))
(let ((anon7_correct true))
(let ((anon17_Else_correct  (=> (and (not (and (select g_1@@15 n$1_10) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_10 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon17_Then_correct  (=> (and (select g_1@@15 n$1_10) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_10 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$1_10 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$1_10 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon16_Else_correct  (=> (not (select g_1@@15 n$1_10)) (and (=> (= (ControlFlow 0 8) 3) anon17_Then_correct) (=> (= (ControlFlow 0 8) 5) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (select g_1@@15 n$1_10) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$1_10 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$1_10 next) (and (=> (= (ControlFlow 0 6) 3) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct)))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((n$0_4 T@Ref) (n$0_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_4 n$0_4_1)) (select g_1@@15 n$0_4)) (select g_1@@15 n$0_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4 n$0_4_1)))
 :qid |stdinbpl.1827:15|
 :skolemid |211|
))) (=> (forall ((n$0_4@@0 T@Ref) (n$0_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_4@@0 n$0_4_1@@0)) (select g_1@@15 n$0_4@@0)) (select g_1@@15 n$0_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4@@0 n$0_4_1@@0)))
 :qid |stdinbpl.1827:15|
 :skolemid |211|
)) (=> (and (and (forall ((n$0_4@@1 T@Ref) ) (!  (=> (and (select g_1@@15 n$0_4@@1) (< NoPerm FullPerm)) (and (qpRange14 n$0_4@@1) (= (invRecv14 n$0_4@@1) n$0_4@@1)))
 :qid |stdinbpl.1833:22|
 :skolemid |212|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) n$0_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1@@15 (invRecv14 o_9)) (< NoPerm FullPerm)) (qpRange14 o_9)) (= (invRecv14 o_9) o_9))
 :qid |stdinbpl.1837:22|
 :skolemid |213|
 :pattern ( (invRecv14 o_9))
))) (and (forall ((n$0_4@@2 T@Ref) ) (!  (=> (select g_1@@15 n$0_4@@2) (not (= n$0_4@@2 null)))
 :qid |stdinbpl.1843:22|
 :skolemid |214|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) n$0_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1@@15 (invRecv14 o_9@@0)) (< NoPerm FullPerm)) (qpRange14 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv14 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1@@15 (invRecv14 o_9@@0)) (< NoPerm FullPerm)) (qpRange14 o_9@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.1849:22|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1853:29|
 :skolemid |216|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_58602_58603) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1853:29|
 :skolemid |216|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1853:29|
 :skolemid |216|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1853:29|
 :skolemid |216|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_9@@4 f_5@@2))
))) (state Heap@@41 QPMask@0)) (and (and (=> (= (ControlFlow 0 17) 16) anon15_Else_correct) (=> (= (ControlFlow 0 17) 6) anon16_Then_correct)) (=> (= (ControlFlow 0 17) 8) anon16_Else_correct))))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 1) (not (select g_1@@15 null)))) (and (=> (= (ControlFlow 0 19) 1) anon14_Then_correct) (=> (= (ControlFlow 0 19) 17) anon14_Else_correct)))))
