...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n$0_5 T@Ref) (n$0_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5 n$0_5_2)) (select g_1@@15 n$0_5)) (select g_1@@15 n$0_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5 n$0_5_2)))
 :qid |stdinbpl.1896:25|
 :skolemid |218|
 :pattern ( (neverTriggered15 n$0_5) (neverTriggered15 n$0_5_2))
))) (=> (forall ((n$0_5@@0 T@Ref) (n$0_5_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5@@0 n$0_5_2@@0)) (select g_1@@15 n$0_5@@0)) (select g_1@@15 n$0_5_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5@@0 n$0_5_2@@0)))
 :qid |stdinbpl.1896:25|
 :skolemid |218|
 :pattern ( (neverTriggered15 n$0_5@@0) (neverTriggered15 n$0_5_2@@0))
...
(let ((anon19_Then_correct  (=> (select g_1@@15 n_26) (and (=> (= (ControlFlow 0 15) 13) anon20_Then_correct) (=> (= (ControlFlow 0 15) 10) anon12_correct)))))
(let ((anon19_Else_correct  (=> (and (not (select g_1@@15 n_26)) (= (ControlFlow 0 11) 10)) anon12_correct)))
...
(let ((anon17_Else_correct  (=> (and (not (and (select g_1@@15 n$1_14) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_14 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon17_Then_correct  (=> (and (select g_1@@15 n$1_14) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_14 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$1_14 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$1_14 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon16_Else_correct  (=> (not (select g_1@@15 n$1_14)) (and (=> (= (ControlFlow 0 8) 3) anon17_Then_correct) (=> (= (ControlFlow 0 8) 5) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (select g_1@@15 n$1_14) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$1_14 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$1_14 next) (and (=> (= (ControlFlow 0 6) 3) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct)))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((n$0_4 T@Ref) (n$0_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_4 n$0_4_1)) (select g_1@@15 n$0_4)) (select g_1@@15 n$0_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4 n$0_4_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g_1@@15 (invRecv14 o_4)) (< NoPerm FullPerm)) (qpRange14 o_4)) (= (invRecv14 o_4) o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_4@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g_1@@15 (invRecv14 o_4@@0)) (< NoPerm FullPerm)) (qpRange14 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv14 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g_1@@15 (invRecv14 o_4@@0)) (< NoPerm FullPerm)) (qpRange14 o_4@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@0 next))))
