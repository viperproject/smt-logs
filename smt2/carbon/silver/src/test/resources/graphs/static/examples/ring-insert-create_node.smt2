...
(declare-fun new_graph () (Array T@Ref Bool))
(declare-fun PostMask@0 () T@PolymorphicMapType_73948)
(declare-fun PostMask@1 () T@PolymorphicMapType_73948)
...
(let ((anon7_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (not (select graph new_node))) (and (state PostHeap@0 ZeroMask) (|Set#Equal_49043| new_graph (|Set#Union_49040| graph (|Set#Singleton_49733| new_node))))) (=> (and (and (and (state PostHeap@0 ZeroMask) (not (= new_node null))) (and (= PostMask@0 (PolymorphicMapType_73948 (store (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) new_node next (+ (select (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| ZeroMask) new_node next) FullPerm)) (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| ZeroMask) (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| ZeroMask) (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| ZeroMask) (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| ZeroMask))) (state PostHeap@0 PostMask@0))) (and (and (not (= new_node null)) (= PostMask@1 (PolymorphicMapType_73948 (|PolymorphicMapType_73948_48849_48850#PolymorphicMapType_73948| PostMask@0) (store (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| PostMask@0) new_node val (+ (select (|PolymorphicMapType_73948_48852_6878#PolymorphicMapType_73948| PostMask@0) new_node val) FullPerm)) (|PolymorphicMapType_73948_48849_53#PolymorphicMapType_73948| PostMask@0) (|PolymorphicMapType_73948_48849_250533#PolymorphicMapType_73948| PostMask@0) (|PolymorphicMapType_73948_48849_254773#PolymorphicMapType_73948| PostMask@0)))) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_48849_48850 PostMask@1 new_node next)) (=> (HasDirectPerm_48849_48850 PostMask@1 new_node next) (=> (= (select (|PolymorphicMapType_73927_47956_47957#PolymorphicMapType_73927| PostHeap@0) new_node next) null) (=> (and (state PostHeap@0 PostMask@1) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm_48852_6878 PostMask@1 new_node val)))))))))
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 7) 2) anon7_Then_correct) (=> (= (ControlFlow 0 7) 5) anon7_Else_correct))))))
