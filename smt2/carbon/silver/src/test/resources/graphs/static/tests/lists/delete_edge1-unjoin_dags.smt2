...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 151) (let ((anon120_Then_correct  (and (=> (= (ControlFlow 0 126) (- 0 128)) (forall ((n_11_2 T@Ref) ) (!  (=> (and (select g1@@9 n_11_2) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n_11_2 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n_11_2@@0 next))
)) (and (=> (= (ControlFlow 0 126) (- 0 127)) (forall ((n_11_2@@1 T@Ref) (n_11_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_2@@1 n_11_3)) (select g1@@9 n_11_2@@1)) (select g1@@9 n_11_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_11_2@@1 n_11_3)))
 :qid |stdinbpl.5907:25|
 :skolemid |633|
 :pattern ( (neverTriggered84 n_11_2@@1) (neverTriggered84 n_11_3))
 ...
 :qid |stdinbpl.5907:25|
 :skolemid |633|
 :pattern ( (neverTriggered84 n_11_2@@2) (neverTriggered84 n_11_3@@0))
)) (=> (= (ControlFlow 0 126) (- 0 125)) (forall ((n_11_2@@3 T@Ref) ) (!  (=> (select g1@@9 n_11_2@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@11) n_11_2@@3 next) NoPerm)))
...
(let ((anon112_Else_correct  (and (=> (= (ControlFlow 0 133) (- 0 134)) (forall ((n$5_1 T@Ref) (n$5_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$5_1 n$5_1_1)) (select g1@@9 n$5_1)) (select g1@@9 n$5_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$5_1 n$5_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$5_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g1@@9 (invRecv81 o_9)) (< NoPerm FullPerm)) (qpRange81 o_9)) (= (invRecv81 o_9) o_9))
 :qid |stdinbpl.5751:22|
 :skolemid |617|
 :pattern ( (invRecv81 o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$5_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@9 (invRecv81 o_9@@0)) (< NoPerm FullPerm)) (qpRange81 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv81 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@11) o_9@@0 next) (+ (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g1@@9 (invRecv81 o_9@@0)) (< NoPerm FullPerm)) (qpRange81 o_9@@0))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@11) o_9@@0 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) o_9@@0 next))))
 :qid |stdinbpl.5763:22|
 :skolemid |619|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@11) o_9@@0 next))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_61502_53) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@10) o_9@@1 f_5) (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@11) o_9@@1 f_5)))
 :qid |stdinbpl.5767:29|
 :skolemid |620|
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@10) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@11) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_61515_61516) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) o_9@@2 f_5@@0) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@11) o_9@@2 f_5@@0)))
 :qid |stdinbpl.5767:29|
 :skolemid |620|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@11) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_40180_203868) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@10) o_9@@3 f_5@@1) (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@11) o_9@@3 f_5@@1)))
 :qid |stdinbpl.5767:29|
 :skolemid |620|
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@10) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@11) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_40180_204001) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@10) o_9@@4 f_5@@2) (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@11) o_9@@4 f_5@@2)))
 :qid |stdinbpl.5767:29|
 :skolemid |620|
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@10) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@11) o_9@@4 f_5@@2))
...
(let ((anon109_Else_correct  (=> (forall ((n$4_1 T@Ref) ) (!  (=> (and (select g0@@9 n$4_1) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$4_1 next) null))) (select g0@@9 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$4_1 next)))
...
(let ((anon111_Else_correct  (=> (and (not (and (select g0@@9 n$4_9) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$4_9 next) null)))) (= (ControlFlow 0 102) 99)) anon42_correct)))
(let ((anon111_Then_correct  (=> (and (select g0@@9 n$4_9) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$4_9 next) null))) (and (=> (= (ControlFlow 0 100) (- 0 101)) (HasDirectPerm_40180_40181 QPMask@10 n$4_9 next)) (=> (HasDirectPerm_40180_40181 QPMask@10 n$4_9 next) (=> (= (ControlFlow 0 100) 99) anon42_correct))))))
(let ((anon110_Else_correct  (=> (not (select g0@@9 n$4_9)) (and (=> (= (ControlFlow 0 105) 100) anon111_Then_correct) (=> (= (ControlFlow 0 105) 102) anon111_Else_correct)))))
(let ((anon110_Then_correct  (=> (select g0@@9 n$4_9) (and (=> (= (ControlFlow 0 103) (- 0 104)) (HasDirectPerm_40180_40181 QPMask@10 n$4_9 next)) (=> (HasDirectPerm_40180_40181 QPMask@10 n$4_9 next) (and (=> (= (ControlFlow 0 103) 100) anon111_Then_correct) (=> (= (ControlFlow 0 103) 102) anon111_Else_correct)))))))
(let ((anon108_Else_correct  (and (=> (= (ControlFlow 0 136) (- 0 137)) (forall ((n$3_1 T@Ref) (n$3_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_1 n$3_1_1)) (select g0@@9 n$3_1)) (select g0@@9 n$3_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_1 n$3_1_1)))
 ...
 :qid |stdinbpl.5683:15|
 :skolemid |608|
)) (=> (and (and (forall ((n$3_1@@1 T@Ref) ) (!  (=> (and (select g0@@9 n$3_1@@1) (< NoPerm FullPerm)) (and (qpRange80 n$3_1@@1) (= (invRecv80 n$3_1@@1) n$3_1@@1)))
 :qid |stdinbpl.5689:22|
 :skolemid |609|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$3_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) n$3_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$3_1@@1 next))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select g0@@9 (invRecv80 o_9@@5)) (< NoPerm FullPerm)) (qpRange80 o_9@@5)) (= (invRecv80 o_9@@5) o_9@@5))
 :qid |stdinbpl.5693:22|
 :skolemid |610|
 :pattern ( (invRecv80 o_9@@5))
 ...
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) n$3_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$3_1@@2 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select g0@@9 (invRecv80 o_9@@6)) (< NoPerm FullPerm)) (qpRange80 o_9@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv80 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) o_9@@6 next) (+ (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_9@@6 next) FullPerm)))) (=> (not (and (and (select g0@@9 (invRecv80 o_9@@6)) (< NoPerm FullPerm)) (qpRange80 o_9@@6))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) o_9@@6 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_9@@6 next))))
 :qid |stdinbpl.5705:22|
 :skolemid |612|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) o_9@@6 next))
)))) (=> (and (and (and (and (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_61502_53) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| ZeroMask) o_9@@7 f_5@@3) (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@10) o_9@@7 f_5@@3)))
 :qid |stdinbpl.5709:29|
 :skolemid |613|
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| ZeroMask) o_9@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@10) o_9@@7 f_5@@3))
)) (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_61515_61516) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) o_9@@8 f_5@@4)))
 :qid |stdinbpl.5709:29|
 :skolemid |613|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@10) o_9@@8 f_5@@4))
))) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_40180_203868) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@10) o_9@@9 f_5@@5)))
 :qid |stdinbpl.5709:29|
 :skolemid |613|
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@10) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_40180_204001) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@10) o_9@@10 f_5@@6)))
 :qid |stdinbpl.5709:29|
 :skolemid |613|
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@10) o_9@@10 f_5@@6))
...
(let ((anon133_Then_correct  (=> (select g1@@9 n$7_2) (and (=> (= (ControlFlow 0 69) (- 0 70)) (exists_path ($$ ExhaleHeap@2 g1@@9) x1 n$7_2)) (=> (exists_path ($$ ExhaleHeap@2 g1@@9) x1 n$7_2) (=> (= (ControlFlow 0 69) 68) anon86_correct))))))
...
(let ((anon128_Else_correct  (=> (forall ((n$4_3_1 T@Ref) ) (!  (=> (and (select g0@@9 n$4_3_1) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n$4_3_1 next) null))) (select g0@@9 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n$4_3_1 next)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n$5_2@@3 next))
)) (=> (and (forall ((o_9@@11 T@Ref) ) (!  (=> (and (select g1@@9 (invRecv86 o_9@@11)) (and (< NoPerm FullPerm) (qpRange86 o_9@@11))) (= (invRecv86 o_9@@11) o_9@@11))
 :qid |stdinbpl.6328:22|
 :skolemid |684|
 :pattern ( (invRecv86 o_9@@11))
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (select g1@@9 (invRecv86 o_9@@12)) (and (< NoPerm FullPerm) (qpRange86 o_9@@12))) (and (= (invRecv86 o_9@@12) o_9@@12) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@9) o_9@@12 next) (- (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@8) o_9@@12 next) FullPerm)))) (=> (not (and (select g1@@9 (invRecv86 o_9@@12)) (and (< NoPerm FullPerm) (qpRange86 o_9@@12)))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@9) o_9@@12 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@8) o_9@@12 next))))
 :qid |stdinbpl.6334:22|
 :skolemid |685|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@9) o_9@@12 next))
))) (=> (and (and (and (forall ((o_9@@13 T@Ref) (f_5@@7 T@Field_61502_53) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@8) o_9@@13 f_5@@7) (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@9) o_9@@13 f_5@@7)))
 :qid |stdinbpl.6340:29|
 :skolemid |686|
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@9) o_9@@13 f_5@@7))
)) (forall ((o_9@@14 T@Ref) (f_5@@8 T@Field_61515_61516) ) (!  (=> (not (= f_5@@8 next)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@8) o_9@@14 f_5@@8) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@9) o_9@@14 f_5@@8)))
 :qid |stdinbpl.6340:29|
 :skolemid |686|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@9) o_9@@14 f_5@@8))
))) (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_40180_203868) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@8) o_9@@15 f_5@@9) (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@9) o_9@@15 f_5@@9)))
 :qid |stdinbpl.6340:29|
 :skolemid |686|
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@9) o_9@@15 f_5@@9))
))) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_40180_204001) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@8) o_9@@16 f_5@@10) (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@9) o_9@@16 f_5@@10)))
 :qid |stdinbpl.6340:29|
 :skolemid |686|
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@9) o_9@@16 f_5@@10))
...
(let ((anon129_Else_correct  (=> (and (not (and (select g0@@9 n$4_2) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n$4_2 next) null)))) (= (ControlFlow 0 62) 59)) anon78_correct)))
(let ((anon129_Then_correct  (=> (and (select g0@@9 n$4_2) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n$4_2 next) null))) (and (=> (= (ControlFlow 0 60) (- 0 61)) (select g0@@9 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n$4_2 next))) (=> (select g0@@9 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n$4_2 next)) (=> (= (ControlFlow 0 60) 59) anon78_correct))))))
(let ((anon127_Else_correct  (=> (apply_TCFraming ExhaleHeap@2 g0@@9 g1@@9) (=> (and (state ExhaleHeap@2 QPMask@5) (state ExhaleHeap@2 QPMask@5)) (and (=> (= (ControlFlow 0 79) (- 0 82)) (not (select g0@@9 null))) (=> (not (select g0@@9 null)) (and (=> (= (ControlFlow 0 79) (- 0 81)) (forall ((n$3_2 T@Ref) (n$3_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_2 n$3_2_1)) (select g0@@9 n$3_2)) (select g0@@9 n$3_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_2 n$3_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n$3_2@@3 next))
)) (=> (and (forall ((o_9@@17 T@Ref) ) (!  (=> (and (select g0@@9 (invRecv85 o_9@@17)) (and (< NoPerm FullPerm) (qpRange85 o_9@@17))) (= (invRecv85 o_9@@17) o_9@@17))
 :qid |stdinbpl.6274:22|
 :skolemid |677|
 :pattern ( (invRecv85 o_9@@17))
)) (forall ((o_9@@18 T@Ref) ) (!  (and (=> (and (select g0@@9 (invRecv85 o_9@@18)) (and (< NoPerm FullPerm) (qpRange85 o_9@@18))) (and (= (invRecv85 o_9@@18) o_9@@18) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@8) o_9@@18 next) (- (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@5) o_9@@18 next) FullPerm)))) (=> (not (and (select g0@@9 (invRecv85 o_9@@18)) (and (< NoPerm FullPerm) (qpRange85 o_9@@18)))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@8) o_9@@18 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@5) o_9@@18 next))))
 :qid |stdinbpl.6280:22|
 :skolemid |678|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@8) o_9@@18 next))
))) (=> (and (and (and (forall ((o_9@@19 T@Ref) (f_5@@11 T@Field_61502_53) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@5) o_9@@19 f_5@@11) (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@8) o_9@@19 f_5@@11)))
 :qid |stdinbpl.6286:29|
 :skolemid |679|
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@8) o_9@@19 f_5@@11))
)) (forall ((o_9@@20 T@Ref) (f_5@@12 T@Field_61515_61516) ) (!  (=> (not (= f_5@@12 next)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@5) o_9@@20 f_5@@12) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@8) o_9@@20 f_5@@12)))
 :qid |stdinbpl.6286:29|
 :skolemid |679|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@8) o_9@@20 f_5@@12))
))) (forall ((o_9@@21 T@Ref) (f_5@@13 T@Field_40180_203868) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@5) o_9@@21 f_5@@13) (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@8) o_9@@21 f_5@@13)))
 :qid |stdinbpl.6286:29|
 :skolemid |679|
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@8) o_9@@21 f_5@@13))
))) (forall ((o_9@@22 T@Ref) (f_5@@14 T@Field_40180_204001) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@5) o_9@@22 f_5@@14) (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@8) o_9@@22 f_5@@14)))
 :qid |stdinbpl.6286:29|
 :skolemid |679|
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@8) o_9@@22 f_5@@14))
...
(let ((anon127_Then_correct  (and (=> (= (ControlFlow 0 54) (- 0 58)) (forall ((n_18 T@Ref) (n_18_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_18 n_18_1)) (select g0@@9 n_18)) (select g0@@9 n_18_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_18 n_18_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n_18@@3 next))
)) (forall ((o_9@@23 T@Ref) ) (!  (=> (and (select g0@@9 (invRecv91 o_9@@23)) (and (< NoPerm FullPerm) (qpRange91 o_9@@23))) (= (invRecv91 o_9@@23) o_9@@23))
 :qid |stdinbpl.6200:26|
 :skolemid |669|
 :pattern ( (invRecv91 o_9@@23))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n_19@@3 next))
)) (=> (and (forall ((o_9@@24 T@Ref) ) (!  (=> (and (select g1@@9 (invRecv92 o_9@@24)) (and (< NoPerm FullPerm) (qpRange92 o_9@@24))) (= (invRecv92 o_9@@24) o_9@@24))
 :qid |stdinbpl.6228:26|
 :skolemid |673|
 :pattern ( (invRecv92 o_9@@24))
...
(let ((anon126_Then_correct  (=> (and (and (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x0 next) null)) (state ExhaleHeap@2 QPMask@5)) (and (forall ((v1_1 T@Ref) (v2_1 T@Ref) ) (! (= (exists_path ($$ ExhaleHeap@2 arg_g@0) v1_1 v2_1)  (or (= v1_1 v2_1) (and (not (= v1_1 v2_1)) (or (exists ((n_16_1 T@Ref) ) (!  (and (exists_path ($$ Heap@@29 arg_g@0) v1_1 n_16_1) (and (exists_path ($$ Heap@@29 arg_g@0) n_16_1 v2_1) (or (and (not (exists_path ($$ Heap@@29 arg_g@0) n_16_1 x0)) (not (exists_path ($$ Heap@@29 arg_g@0) x0 n_16_1))) (and (not (exists_path ($$ Heap@@29 arg_g@0) n_16_1 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x0 next))) (not (exists_path ($$ Heap@@29 arg_g@0) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x0 next) n_16_1))))))
 :qid |stdinbpl.6153:106|
 :skolemid |662|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) v1_1 n_16_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) n_16_1 v2_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) n_16_1 x0))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) x0 n_16_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) n_16_1 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x0 next)))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x0 next) n_16_1))
...
)) (exists ((u_1@@2 T@Ref) (v_2@@5 T@Ref) ) (!  (and (or (not (= u_1@@2 x0)) (not (= v_2@@5 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x0 next)))) (and (edge ($$ Heap@@29 arg_g@0) u_1@@2 v_2@@5) (and (exists_path ($$ Heap@@29 arg_g@0) v1_1 u_1@@2) (and (exists_path ($$ Heap@@29 arg_g@0) u_1@@2 x0) (and (exists_path ($$ Heap@@29 arg_g@0) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x0 next) v_2@@5) (exists_path ($$ Heap@@29 arg_g@0) v_2@@5 v2_1))))))
 :qid |stdinbpl.6159:24|
 :skolemid |664|
 :pattern ( (edge (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) u_1@@2 v_2@@5))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) v1_1 u_1@@2) (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x0 next) v_2@@5))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) v1_1 u_1@@2) (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) v_2@@5 v2_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) u_1@@2 x0) (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x0 next) v_2@@5))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) u_1@@2 x0) (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 arg_g@0)) arg_g@0) v_2@@5 v2_1))
)))))))
...
(let ((anon122_Else_correct  (=> (forall ((n$0_5_1_1 T@Ref) ) (!  (=> (and (select arg_g@0 n$0_5_1_1) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_5_1_1 next) null))) (select arg_g@0 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_5_1_1 next)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n$1_2@@1 next))
)) (forall ((o_9@@25 T@Ref) ) (!  (=> (and (and (select arg_g@0 (invRecv90 o_9@@25)) (< NoPerm FullPerm)) (qpRange90 o_9@@25)) (= (invRecv90 o_9@@25) o_9@@25))
 :qid |stdinbpl.6107:24|
 :skolemid |655|
 :pattern ( (invRecv90 o_9@@25))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| ExhaleHeap@2) n$1_2@@2 next))
)) (forall ((o_9@@26 T@Ref) ) (!  (and (=> (and (and (select arg_g@0 (invRecv90 o_9@@26)) (< NoPerm FullPerm)) (qpRange90 o_9@@26)) (and (=> (< NoPerm FullPerm) (= (invRecv90 o_9@@26) o_9@@26)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@5) o_9@@26 next) (+ (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) o_9@@26 next) FullPerm)))) (=> (not (and (and (select arg_g@0 (invRecv90 o_9@@26)) (< NoPerm FullPerm)) (qpRange90 o_9@@26))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@5) o_9@@26 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) o_9@@26 next))))
 :qid |stdinbpl.6119:24|
 :skolemid |657|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@5) o_9@@26 next))
)))) (=> (and (and (and (and (forall ((o_9@@27 T@Ref) (f_5@@15 T@Field_61502_53) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@4) o_9@@27 f_5@@15) (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@5) o_9@@27 f_5@@15)))
 :qid |stdinbpl.6123:31|
 :skolemid |658|
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@4) o_9@@27 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@5) o_9@@27 f_5@@15))
)) (forall ((o_9@@28 T@Ref) (f_5@@16 T@Field_61515_61516) ) (!  (=> (not (= f_5@@16 next)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) o_9@@28 f_5@@16) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@5) o_9@@28 f_5@@16)))
 :qid |stdinbpl.6123:31|
 :skolemid |658|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) o_9@@28 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@5) o_9@@28 f_5@@16))
))) (forall ((o_9@@29 T@Ref) (f_5@@17 T@Field_40180_203868) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@4) o_9@@29 f_5@@17) (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@5) o_9@@29 f_5@@17)))
 :qid |stdinbpl.6123:31|
 :skolemid |658|
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@4) o_9@@29 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@5) o_9@@29 f_5@@17))
))) (forall ((o_9@@30 T@Ref) (f_5@@18 T@Field_40180_204001) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@4) o_9@@30 f_5@@18) (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@5) o_9@@30 f_5@@18)))
 :qid |stdinbpl.6123:31|
 :skolemid |658|
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@4) o_9@@30 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@5) o_9@@30 f_5@@18))
...
(let ((anon121_Else_correct  (=> (and (and (apply_TCFraming Heap@@29 g0@@9 g1@@9) (state Heap@@29 QPMask@0)) (and (state Heap@@29 QPMask@0) (= arg_g@0 (|Set#Union_40369| g0@@9 g1@@9)))) (and (=> (= (ControlFlow 0 92) (- 0 96)) (select arg_g@0 x0)) (=> (select arg_g@0 x0) (and (=> (= (ControlFlow 0 92) (- 0 95)) (not (select arg_g@0 null))) (=> (not (select arg_g@0 null)) (and (=> (= (ControlFlow 0 92) (- 0 94)) (forall ((n_14_1 T@Ref) (n_14_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_14_1 n_14_2)) (select arg_g@0 n_14_1)) (select arg_g@0 n_14_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_14_1 n_14_2)))
 :qid |stdinbpl.6043:19|
 :skolemid |646|
 :pattern ( (neverTriggered89 n_14_1) (neverTriggered89 n_14_2))
))) (=> (forall ((n_14_1@@0 T@Ref) (n_14_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_14_1@@0 n_14_2@@0)) (select arg_g@0 n_14_1@@0)) (select arg_g@0 n_14_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_14_1@@0 n_14_2@@0)))
 :qid |stdinbpl.6043:19|
 :skolemid |646|
 :pattern ( (neverTriggered89 n_14_1@@0) (neverTriggered89 n_14_2@@0))
)) (and (=> (= (ControlFlow 0 92) (- 0 93)) (forall ((n_14_1@@1 T@Ref) ) (!  (=> (select arg_g@0 n_14_1@@1) (>= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) n_14_1@@1 next) FullPerm))
 :qid |stdinbpl.6050:19|
 :skolemid |647|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) n_14_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14_1@@1 next))
))) (=> (forall ((n_14_1@@2 T@Ref) ) (!  (=> (select arg_g@0 n_14_1@@2) (>= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) n_14_1@@2 next) FullPerm))
 :qid |stdinbpl.6050:19|
 :skolemid |647|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) n_14_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14_1@@2 next))
)) (=> (forall ((n_14_1@@3 T@Ref) ) (!  (=> (and (select arg_g@0 n_14_1@@3) (< NoPerm FullPerm)) (and (qpRange89 n_14_1@@3) (= (invRecv89 n_14_1@@3) n_14_1@@3)))
 :qid |stdinbpl.6056:24|
 :skolemid |648|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) n_14_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14_1@@3 next))
)) (=> (and (forall ((o_9@@31 T@Ref) ) (!  (=> (and (select arg_g@0 (invRecv89 o_9@@31)) (and (< NoPerm FullPerm) (qpRange89 o_9@@31))) (= (invRecv89 o_9@@31) o_9@@31))
 :qid |stdinbpl.6060:24|
 :skolemid |649|
 :pattern ( (invRecv89 o_9@@31))
)) (forall ((o_9@@32 T@Ref) ) (!  (and (=> (and (select arg_g@0 (invRecv89 o_9@@32)) (and (< NoPerm FullPerm) (qpRange89 o_9@@32))) (and (= (invRecv89 o_9@@32) o_9@@32) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) o_9@@32 next) (- (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@32 next) FullPerm)))) (=> (not (and (select arg_g@0 (invRecv89 o_9@@32)) (and (< NoPerm FullPerm) (qpRange89 o_9@@32)))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) o_9@@32 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@32 next))))
 :qid |stdinbpl.6066:24|
 :skolemid |650|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) o_9@@32 next))
))) (=> (and (and (and (forall ((o_9@@33 T@Ref) (f_5@@19 T@Field_61502_53) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@0) o_9@@33 f_5@@19) (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@4) o_9@@33 f_5@@19)))
 :qid |stdinbpl.6072:31|
 :skolemid |651|
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@4) o_9@@33 f_5@@19))
)) (forall ((o_9@@34 T@Ref) (f_5@@20 T@Field_61515_61516) ) (!  (=> (not (= f_5@@20 next)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@34 f_5@@20) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) o_9@@34 f_5@@20)))
 :qid |stdinbpl.6072:31|
 :skolemid |651|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@4) o_9@@34 f_5@@20))
))) (forall ((o_9@@35 T@Ref) (f_5@@21 T@Field_40180_203868) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@0) o_9@@35 f_5@@21) (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@4) o_9@@35 f_5@@21)))
 :qid |stdinbpl.6072:31|
 :skolemid |651|
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@4) o_9@@35 f_5@@21))
))) (forall ((o_9@@36 T@Ref) (f_5@@22 T@Field_40180_204001) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@0) o_9@@36 f_5@@22) (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@4) o_9@@36 f_5@@22)))
 :qid |stdinbpl.6072:31|
 :skolemid |651|
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@4) o_9@@36 f_5@@22))
...
(let ((anon121_Then_correct  (and (=> (= (ControlFlow 0 44) (- 0 48)) (forall ((n_12 T@Ref) (n_12_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12 n_12_1)) (select g0@@9 n_12)) (select g0@@9 n_12_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12 n_12_1)))
...
)) (and (=> (= (ControlFlow 0 44) (- 0 47)) (forall ((n_12@@1 T@Ref) ) (!  (=> (select g0@@9 n_12@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) n_12@@1 next) NoPerm)))
 :qid |stdinbpl.5969:21|
 :skolemid |639|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_12@@1 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@2) n_12@@1 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_12@@1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@2) n_12@@2 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_12@@2 next))
)) (=> (and (forall ((n_12@@3 T@Ref) ) (!  (=> (and (select g0@@9 n_12@@3) (< NoPerm FullPerm)) (and (qpRange87 n_12@@3) (= (invRecv87 n_12@@3) n_12@@3)))
 :qid |stdinbpl.5975:26|
 :skolemid |640|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_12@@3 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@2) n_12@@3 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_12@@3 next))
)) (forall ((o_9@@37 T@Ref) ) (!  (=> (and (select g0@@9 (invRecv87 o_9@@37)) (and (< NoPerm FullPerm) (qpRange87 o_9@@37))) (= (invRecv87 o_9@@37) o_9@@37))
 :qid |stdinbpl.5979:26|
 :skolemid |641|
 :pattern ( (invRecv87 o_9@@37))
))) (and (=> (= (ControlFlow 0 44) (- 0 46)) (forall ((n_13_2 T@Ref) (n_13_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13_2 n_13_3)) (select g1@@9 n_13_2)) (select g1@@9 n_13_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13_2 n_13_3)))
 :qid |stdinbpl.5990:21|
 :skolemid |642|
 :pattern ( (neverTriggered88 n_13_2) (neverTriggered88 n_13_3))
 ...
 :qid |stdinbpl.5990:21|
 :skolemid |642|
 :pattern ( (neverTriggered88 n_13_2@@0) (neverTriggered88 n_13_3@@0))
)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (forall ((n_13_2@@1 T@Ref) ) (!  (=> (select g1@@9 n_13_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) n_13_2@@1 next) NoPerm)))
 :qid |stdinbpl.5997:21|
 :skolemid |643|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@3) n_13_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13_2@@1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@3) n_13_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13_2@@2 next))
)) (=> (forall ((n_13_2@@3 T@Ref) ) (!  (=> (and (select g1@@9 n_13_2@@3) (< NoPerm FullPerm)) (and (qpRange88 n_13_2@@3) (= (invRecv88 n_13_2@@3) n_13_2@@3)))
 :qid |stdinbpl.6003:26|
 :skolemid |644|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@3) n_13_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13_2@@3 next))
)) (=> (and (forall ((o_9@@38 T@Ref) ) (!  (=> (and (select g1@@9 (invRecv88 o_9@@38)) (and (< NoPerm FullPerm) (qpRange88 o_9@@38))) (= (invRecv88 o_9@@38) o_9@@38))
 :qid |stdinbpl.6007:26|
 :skolemid |645|
 :pattern ( (invRecv88 o_9@@38))
...
(let ((anon105_Then_correct  (and (=> (= (ControlFlow 0 35) (- 0 37)) (forall ((n$0_3 T@Ref) ) (!  (=> (and (select (|Set#Union_40369| g0@@9 g1@@9) n$0_3) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_3 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
...
(let ((anon104_Then_correct  (=> (and (select g1@@9 n_58) (select g0@@9 m_5)) (and (=> (= (ControlFlow 0 38) 35) anon105_Then_correct) (=> (= (ControlFlow 0 38) 32) anon31_correct)))))
(let ((anon104_Else_correct  (=> (and (not (and (select g1@@9 n_58) (select g0@@9 m_5))) (= (ControlFlow 0 33) 32)) anon31_correct)))
(let ((anon100_Else_correct  (=> (forall ((n_5 T@Ref) (m_1 T@Ref) ) (!  (=> (and (select g0@@9 n_5) (select g1@@9 m_1)) (= (edge ($$ Heap@@29 (|Set#Union_40369| g0@@9 g1@@9)) n_5 m_1)  (and (= n_5 x0) (= m_1 x1))))
...
(let ((anon102_Then_correct  (and (=> (= (ControlFlow 0 28) (- 0 30)) (forall ((n$0_2 T@Ref) ) (!  (=> (and (select (|Set#Union_40369| g0@@9 g1@@9) n$0_2) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
...
(let ((anon101_Then_correct  (=> (and (select g0@@9 n_57) (select g1@@9 m_4)) (and (=> (= (ControlFlow 0 31) 28) anon102_Then_correct) (=> (= (ControlFlow 0 31) 25) anon26_correct)))))
(let ((anon101_Else_correct  (=> (and (not (and (select g0@@9 n_57) (select g1@@9 m_4))) (= (ControlFlow 0 26) 25)) anon26_correct)))
(let ((anon97_Else_correct  (=> (forall ((n$2_1 T@Ref) ) (!  (=> (select g1@@9 n$2_1) (exists_path ($$ Heap@@29 g1@@9) x1 n$2_1))
...
(let ((anon98_Then_correct  (=> (select g1@@9 n$2_23) (and (=> (= (ControlFlow 0 24) 21) anon99_Then_correct) (=> (= (ControlFlow 0 24) 18) anon21_correct)))))
(let ((anon98_Else_correct  (=> (and (not (select g1@@9 n$2_23)) (= (ControlFlow 0 19) 18)) anon21_correct)))
...
(let ((anon95_Then_correct  (=> (select g0@@9 n$1_12) (and (=> (= (ControlFlow 0 17) 14) anon96_Then_correct) (=> (= (ControlFlow 0 17) 11) anon16_correct)))))
(let ((anon95_Else_correct  (=> (and (not (select g0@@9 n$1_12)) (= (ControlFlow 0 12) 11)) anon16_correct)))
...
)) (state Heap@@29 QPMask@0)) (=> (and (and (select g0@@9 x0) (select g1@@9 x1)) (and (state Heap@@29 QPMask@0) (state Heap@@29 QPMask@0))) (and (and (=> (= (ControlFlow 0 145) 144) anon94_Else_correct) (=> (= (ControlFlow 0 145) 17) anon95_Then_correct)) (=> (= (ControlFlow 0 145) 12) anon95_Else_correct))))))
(let ((anon11_correct true))
(let ((anon93_Else_correct  (=> (and (not (and (select (|Set#Union_40369| g0@@9 g1@@9) n$0_30) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_30 next) null)))) (= (ControlFlow 0 7) 4)) anon11_correct)))
(let ((anon93_Then_correct  (=> (and (select (|Set#Union_40369| g0@@9 g1@@9) n$0_30) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_30 next) null))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_40180_40181 QPMask@0 n$0_30 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 n$0_30 next) (=> (= (ControlFlow 0 5) 4) anon11_correct))))))
(let ((anon92_Else_correct  (=> (not (select (|Set#Union_40369| g0@@9 g1@@9) n$0_30)) (and (=> (= (ControlFlow 0 10) 5) anon93_Then_correct) (=> (= (ControlFlow 0 10) 7) anon93_Else_correct)))))
(let ((anon92_Then_correct  (=> (select (|Set#Union_40369| g0@@9 g1@@9) n$0_30) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_40180_40181 QPMask@0 n$0_30 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 n$0_30 next) (and (=> (= (ControlFlow 0 8) 5) anon93_Then_correct) (=> (= (ControlFlow 0 8) 7) anon93_Else_correct)))))))
(let ((anon90_Else_correct  (and (=> (= (ControlFlow 0 146) (- 0 147)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select (|Set#Union_40369| g0@@9 g1@@9) n_1)) (select (|Set#Union_40369| g0@@9 g1@@9) n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_1@@1 next))
)) (forall ((o_9@@39 T@Ref) ) (!  (=> (and (and (select (|Set#Union_40369| g0@@9 g1@@9) (invRecv74 o_9@@39)) (< NoPerm FullPerm)) (qpRange74 o_9@@39)) (= (invRecv74 o_9@@39) o_9@@39))
 :qid |stdinbpl.5343:22|
 :skolemid |574|
 :pattern ( (invRecv74 o_9@@39))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_1@@2 next))
)) (forall ((o_9@@40 T@Ref) ) (!  (and (=> (and (and (select (|Set#Union_40369| g0@@9 g1@@9) (invRecv74 o_9@@40)) (< NoPerm FullPerm)) (qpRange74 o_9@@40)) (and (=> (< NoPerm FullPerm) (= (invRecv74 o_9@@40) o_9@@40)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@40 next) (+ (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_9@@40 next) FullPerm)))) (=> (not (and (and (select (|Set#Union_40369| g0@@9 g1@@9) (invRecv74 o_9@@40)) (< NoPerm FullPerm)) (qpRange74 o_9@@40))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@40 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_9@@40 next))))
...
(let ((anon0_correct  (=> (state Heap@@29 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_61442_39384_53#PolymorphicMapType_61442| Heap@@29) x0 $allocated) (select (|PolymorphicMapType_61442_39384_53#PolymorphicMapType_61442| Heap@@29) x1 $allocated))) (and (=> (= (ControlFlow 0 150) 1) anon88_Then_correct) (=> (= (ControlFlow 0 150) 149) anon88_Else_correct))))))
