...
(declare-fun g_1@@10 () (Array T@Ref Bool))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (forall ((n$0_5 T@Ref) ) (!  (=> (and (select g_1@@10 n$0_5) (dummyFunction_29365 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_5 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1016:25|
 :skolemid |132|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_5 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) n$0_5 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_5 next))
))) (=> (forall ((n$0_5@@0 T@Ref) ) (!  (=> (and (select g_1@@10 n$0_5@@0) (dummyFunction_29365 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_5@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1016:25|
 :skolemid |132|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_5@@0 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) n$0_5@@0 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_5@@0 next))
)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n$0_5@@1 T@Ref) (n$0_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5@@1 n$0_5_1)) (select g_1@@10 n$0_5@@1)) (select g_1@@10 n$0_5_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_5@@1 n$0_5_1)))
 :qid |stdinbpl.1023:25|
 :skolemid |133|
 :pattern ( (neverTriggered3 n$0_5@@1) (neverTriggered3 n$0_5_1))
))) (=> (forall ((n$0_5@@2 T@Ref) (n$0_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5@@2 n$0_5_1@@0)) (select g_1@@10 n$0_5@@2)) (select g_1@@10 n$0_5_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_5@@2 n$0_5_1@@0)))
 :qid |stdinbpl.1023:25|
 :skolemid |133|
 :pattern ( (neverTriggered3 n$0_5@@2) (neverTriggered3 n$0_5_1@@0))
)) (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((n$0_5@@3 T@Ref) ) (!  (=> (select g_1@@10 n$0_5@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) n$0_5@@3 next) NoPerm)))
 :qid |stdinbpl.1030:25|
 :skolemid |134|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_5@@3 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) n$0_5@@3 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_5@@3 next))
)))))))))
(let ((anon12_correct true))
(let ((anon19_Then_correct  (=> (select g_1@@10 n_16) (and (=> (= (ControlFlow 0 16) 13) anon20_Then_correct) (=> (= (ControlFlow 0 16) 10) anon12_correct)))))
(let ((anon19_Else_correct  (=> (and (not (select g_1@@10 n_16)) (= (ControlFlow 0 11) 10)) anon12_correct)))
(let ((anon18_Else_correct true))
(let ((anon15_Else_correct  (=> (and (and (forall ((n$1_3 T@Ref) ) (!  (=> (and (select g_1@@10 n$1_3) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_3 next) null))) (select g_1@@10 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_3 next)))
 :qid |stdinbpl.995:20|
 :skolemid |131|
 :pattern ( (select g_1@@10 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_3 next)))
 :pattern ( (select g_1@@10 n$1_3) (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_3 next))
)) (state Heap@@33 QPMask@0)) (and (|Set#Subset_29491| roots@@4 g_1@@10) (state Heap@@33 QPMask@0))) (and (and (=> (= (ControlFlow 0 17) 9) anon18_Else_correct) (=> (= (ControlFlow 0 17) 16) anon19_Then_correct)) (=> (= (ControlFlow 0 17) 11) anon19_Else_correct)))))
(let ((anon7_correct true))
(let ((anon17_Else_correct  (=> (and (not (and (select g_1@@10 n$1_8) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_8 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon17_Then_correct  (=> (and (select g_1@@10 n$1_8) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_8 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29364_29365 QPMask@0 n$1_8 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$1_8 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon16_Else_correct  (=> (not (select g_1@@10 n$1_8)) (and (=> (= (ControlFlow 0 8) 3) anon17_Then_correct) (=> (= (ControlFlow 0 8) 5) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (select g_1@@10 n$1_8) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29364_29365 QPMask@0 n$1_8 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$1_8 next) (and (=> (= (ControlFlow 0 6) 3) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct)))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((n$0_4 T@Ref) (n$0_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_4 n$0_4_1)) (select g_1@@10 n$0_4)) (select g_1@@10 n$0_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4 n$0_4_1)))
 :qid |stdinbpl.950:15|
 :skolemid |125|
))) (=> (forall ((n$0_4@@0 T@Ref) (n$0_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_4@@0 n$0_4_1@@0)) (select g_1@@10 n$0_4@@0)) (select g_1@@10 n$0_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4@@0 n$0_4_1@@0)))
 :qid |stdinbpl.950:15|
 :skolemid |125|
)) (=> (and (and (forall ((n$0_4@@1 T@Ref) ) (!  (=> (and (select g_1@@10 n$0_4@@1) (< NoPerm FullPerm)) (and (qpRange2 n$0_4@@1) (= (invRecv2 n$0_4@@1) n$0_4@@1)))
 :qid |stdinbpl.956:22|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) n$0_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_4@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1@@10 (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.960:22|
 :skolemid |127|
 :pattern ( (invRecv2 o_9))
))) (and (forall ((n$0_4@@2 T@Ref) ) (!  (=> (select g_1@@10 n$0_4@@2) (not (= n$0_4@@2 null)))
 :qid |stdinbpl.966:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) n$0_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_4@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1@@10 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1@@10 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.972:22|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_9@@0 next))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_46438_53) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.976:29|
 :skolemid |130|
...
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_46451_46452) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.976:29|
 :skolemid |130|
...
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_29364_147463) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.976:29|
 :skolemid |130|
...
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_29364_147596) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.976:29|
 :skolemid |130|
...
))) (state Heap@@33 QPMask@0)) (and (and (=> (= (ControlFlow 0 18) 17) anon15_Else_correct) (=> (= (ControlFlow 0 18) 6) anon16_Then_correct)) (=> (= (ControlFlow 0 18) 8) anon16_Else_correct))))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@33 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 1) (not (select g_1@@10 null)))) (and (=> (= (ControlFlow 0 20) 1) anon14_Then_correct) (=> (= (ControlFlow 0 20) 18) anon14_Else_correct)))))
