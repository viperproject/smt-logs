...
(let ((anon83_Then_correct  (and (=> (= (ControlFlow 0 51) (- 0 53)) (forall ((n_4 T@Ref) ) (!  (=> (and (select g_1 n_4) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n_4 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :skolemid |216|
 :pattern ( (neverTriggered16 n_4@@1) (neverTriggered16 n_4_1))
 ...
 :qid |stdinbpl.1898:25|
 :skolemid |216|
 :pattern ( (neverTriggered16 n_4@@2) (neverTriggered16 n_4_1@@0))
)) (=> (= (ControlFlow 0 51) (- 0 50)) (forall ((n_4@@3 T@Ref) ) (!  (=> (select g_1 n_4@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@1) n_4@@3 next) NoPerm)))
...
(let ((anon92_Then_correct  (=> (exists_path ($$ Heap@@29 g_1) v1_5 x@@6) (and (=> (= (ControlFlow 0 43) 40) anon93_Then_correct) (=> (= (ControlFlow 0 43) 23) anon46_correct)))))
(let ((anon92_Else_correct  (=> (and (not (exists_path ($$ Heap@@29 g_1) v1_5 x@@6)) (= (ControlFlow 0 38) 23)) anon46_correct)))
(let ((anon90_Then_correct  (=> (not (exists_path ($$ Heap@@29 g_1) v1_5 v2_5)) (and (and (=> (= (ControlFlow 0 44) 35) anon91_Then_correct) (=> (= (ControlFlow 0 44) 43) anon92_Then_correct)) (=> (= (ControlFlow 0 44) 38) anon92_Else_correct)))))
(let ((anon90_Else_correct  (=> (and (exists_path ($$ Heap@@29 g_1) v1_5 v2_5) (= (ControlFlow 0 33) 23)) anon46_correct)))
(let ((anon87_Then_correct  (=> (not (= v1_5 v2_5)) (and (and (and (=> (= (ControlFlow 0 45) 26) anon88_Then_correct) (=> (= (ControlFlow 0 45) 30) anon89_Then_correct)) (=> (= (ControlFlow 0 45) 44) anon90_Then_correct)) (=> (= (ControlFlow 0 45) 33) anon90_Else_correct)))))
(let ((anon87_Else_correct  (=> (and (= v1_5 v2_5) (= (ControlFlow 0 24) 23)) anon46_correct)))
...
(let ((anon75_Else_correct  (=> (and (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_1 next) null))) (select g_1 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_1 next)))
...
(let ((anon77_Else_correct  (=> (and (not (and (select g_1 n$2_21) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_21 next) null)))) (= (ControlFlow 0 16) 13)) anon18_correct)))
(let ((anon77_Then_correct  (=> (and (select g_1 n$2_21) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_21 next) null))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_40180_40181 QPMask@1 n$2_21 next)) (=> (HasDirectPerm_40180_40181 QPMask@1 n$2_21 next) (=> (= (ControlFlow 0 14) 13) anon18_correct))))))
(let ((anon76_Else_correct  (=> (not (select g_1 n$2_21)) (and (=> (= (ControlFlow 0 19) 14) anon77_Then_correct) (=> (= (ControlFlow 0 19) 16) anon77_Else_correct)))))
(let ((anon76_Then_correct  (=> (select g_1 n$2_21) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_40180_40181 QPMask@1 n$2_21 next)) (=> (HasDirectPerm_40180_40181 QPMask@1 n$2_21 next) (and (=> (= (ControlFlow 0 17) 14) anon77_Then_correct) (=> (= (ControlFlow 0 17) 16) anon77_Else_correct)))))))
(let ((anon74_Else_correct  (and (=> (= (ControlFlow 0 74) (- 0 76)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (and (select g_1 n$1_1) (not (= n$1_1 x@@6)))) (and (select g_1 n$1_1_1) (not (= n$1_1_1 x@@6)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv13 o_9)) (not (= (invRecv13 o_9) x@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_9)) (= (invRecv13 o_9) o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$1_1@@4 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv13 o_9@@0)) (not (= (invRecv13 o_9@@0) x@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv13 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@1) o_9@@0 next) (+ (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| PostMask@0) o_9@@0 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv13 o_9@@0)) (not (= (invRecv13 o_9@@0) x@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_9@@0))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@1) o_9@@0 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| PostMask@0) o_9@@0 next))))
...
(let ((anon72_Else_correct  (=> (and (not (and (select g_1 n$0_28) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_28 next) null)))) (= (ControlFlow 0 5) 2)) anon9_correct)))
(let ((anon72_Then_correct  (=> (and (select g_1 n$0_28) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_28 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_40180_40181 QPMask@0 n$0_28 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 n$0_28 next) (=> (= (ControlFlow 0 3) 2) anon9_correct))))))
(let ((anon71_Else_correct  (=> (not (select g_1 n$0_28)) (and (=> (= (ControlFlow 0 8) 3) anon72_Then_correct) (=> (= (ControlFlow 0 8) 5) anon72_Else_correct)))))
(let ((anon71_Then_correct  (=> (select g_1 n$0_28) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_40180_40181 QPMask@0 n$0_28 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 n$0_28 next) (and (=> (= (ControlFlow 0 6) 3) anon72_Then_correct) (=> (= (ControlFlow 0 6) 5) anon72_Else_correct)))))))
(let ((anon69_Else_correct  (and (=> (= (ControlFlow 0 80) (- 0 82)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (and (select g_1 n_1) (not (= n_1 x@@6)))) (and (select g_1 n_1_1) (not (= n_1_1 x@@6)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_1@@1 next))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv12 o_9@@5)) (not (= (invRecv12 o_9@@5) x@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_9@@5)) (= (invRecv12 o_9@@5) o_9@@5))
 :qid |stdinbpl.1650:22|
 :skolemid |191|
 :pattern ( (invRecv12 o_9@@5))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_1@@4 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv12 o_9@@6)) (not (= (invRecv12 o_9@@6) x@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_9@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv12 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@6 next) (+ (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| Mask@0) o_9@@6 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv12 o_9@@6)) (not (= (invRecv12 o_9@@6) x@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_9@@6))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) o_9@@6 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| Mask@0) o_9@@6 next))))
