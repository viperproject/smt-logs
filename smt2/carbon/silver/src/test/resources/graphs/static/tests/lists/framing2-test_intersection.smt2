...
(let ((anon38_Else_correct  (=> (forall ((r_2_1_1 T@Ref) ) (!  (=> (select g0@@8 r_2_1_1) (not (select g1@@8 r_2_1_1)))
 :qid |stdinbpl.2368:20|
 :skolemid |277|
 :pattern ( (select g0@@8 r_2_1_1) (select g1@@8 r_2_1_1))
...
(let ((anon34_Else_correct  (=> (and (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g1@@8 n$2_1_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_1_1 next) null))) (select g1@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_1_1 next)))
...
(let ((anon36_Else_correct  (=> (and (not (and (select g1@@8 n$2_16) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_16 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon36_Then_correct  (=> (and (select g1@@8 n$2_16) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_16 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_29364_29365 QPMask@1 n$2_16 next)) (=> (HasDirectPerm_29364_29365 QPMask@1 n$2_16 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon35_Else_correct  (=> (not (select g1@@8 n$2_16)) (and (=> (= (ControlFlow 0 16) 11) anon36_Then_correct) (=> (= (ControlFlow 0 16) 13) anon36_Else_correct)))))
(let ((anon35_Then_correct  (=> (select g1@@8 n$2_16) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_29364_29365 QPMask@1 n$2_16 next)) (=> (HasDirectPerm_29364_29365 QPMask@1 n$2_16 next) (and (=> (= (ControlFlow 0 14) 11) anon36_Then_correct) (=> (= (ControlFlow 0 14) 13) anon36_Else_correct)))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@8 n$1_1)) (select g1@@8 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_1@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g1@@8 (invRecv23 o_4)) (< NoPerm FullPerm)) (qpRange23 o_4)) (= (invRecv23 o_4) o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_1@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@8 (invRecv23 o_4@@0)) (< NoPerm FullPerm)) (qpRange23 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv23 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@0 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g1@@8 (invRecv23 o_4@@0)) (< NoPerm FullPerm)) (qpRange23 o_4@@0))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@0 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@0 next))))
...
(let ((anon32_Else_correct  (=> (and (not (and (select g0@@8 n$0_15) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_15 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon32_Then_correct  (=> (and (select g0@@8 n$0_15) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_15 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29364_29365 QPMask@0 n$0_15 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_15 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon31_Else_correct  (=> (not (select g0@@8 n$0_15)) (and (=> (= (ControlFlow 0 8) 3) anon32_Then_correct) (=> (= (ControlFlow 0 8) 5) anon32_Else_correct)))))
(let ((anon31_Then_correct  (=> (select g0@@8 n$0_15) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29364_29365 QPMask@0 n$0_15 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_15 next) (and (=> (= (ControlFlow 0 6) 3) anon32_Then_correct) (=> (= (ControlFlow 0 6) 5) anon32_Else_correct)))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@8 n_1)) (select g0@@8 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_1@@1 next))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select g0@@8 (invRecv22 o_4@@5)) (< NoPerm FullPerm)) (qpRange22 o_4@@5)) (= (invRecv22 o_4@@5) o_4@@5))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_1@@2 next))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (and (select g0@@8 (invRecv22 o_4@@6)) (< NoPerm FullPerm)) (qpRange22 o_4@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv22 o_4@@6) o_4@@6)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@6 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@6 next) FullPerm)))) (=> (not (and (and (select g0@@8 (invRecv22 o_4@@6)) (< NoPerm FullPerm)) (qpRange22 o_4@@6))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@6 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@6 next))))
