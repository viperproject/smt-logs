...
(set-info :boogie-vc-id test_intersection)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon27_correct true))
(let ((anon42_Else_correct  (=> (and (not (select g1@@8 r$0_1)) (= (ControlFlow 0 27) 24)) anon27_correct)))
(let ((anon42_Then_correct  (=> (select g1@@8 r$0_1) (and (=> (= (ControlFlow 0 25) (- 0 26)) (not (select g0@@8 r$0_1))) (=> (not (select g0@@8 r$0_1)) (=> (= (ControlFlow 0 25) 24) anon27_correct))))))
(let ((anon41_Else_correct true))
(let ((anon40_Then_correct true))
(let ((anon38_Else_correct  (=> (forall ((r_2_1 T@Ref) ) (!  (=> (select g0@@8 r_2_1) (not (select g1@@8 r_2_1)))
 :qid |stdinbpl.2368:20|
 :skolemid |277|
 :pattern ( (select g0@@8 r_2_1) (select g1@@8 r_2_1))
)) (and (and (and (=> (= (ControlFlow 0 28) 22) anon40_Then_correct) (=> (= (ControlFlow 0 28) 23) anon41_Else_correct)) (=> (= (ControlFlow 0 28) 25) anon42_Then_correct)) (=> (= (ControlFlow 0 28) 27) anon42_Else_correct)))))
(let ((anon21_correct true))
(let ((anon39_Else_correct  (=> (and (not (select g0@@8 r_1_1)) (= (ControlFlow 0 21) 18)) anon21_correct)))
(let ((anon39_Then_correct  (=> (select g0@@8 r_1_1) (and (=> (= (ControlFlow 0 19) (- 0 20)) (not (select g1@@8 r_1_1))) (=> (not (select g1@@8 r_1_1)) (=> (= (ControlFlow 0 19) 18) anon21_correct))))))
(let ((anon37_Then_correct true))
(let ((anon34_Else_correct  (=> (and (and (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g1@@8 n$2_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_1 next) null))) (select g1@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_1 next)))
 :qid |stdinbpl.2334:20|
 :skolemid |276|
...
)) (state Heap@@33 QPMask@1)) (and (|Set#Equal_29344| (|Set#Intersection_29344| g0@@8 g1@@8) |Set#Empty_29350|) (state Heap@@33 QPMask@1))) (and (and (and (=> (= (ControlFlow 0 29) 17) anon37_Then_correct) (=> (= (ControlFlow 0 29) 28) anon38_Else_correct)) (=> (= (ControlFlow 0 29) 19) anon39_Then_correct)) (=> (= (ControlFlow 0 29) 21) anon39_Else_correct)))))
(let ((anon15_correct true))
(let ((anon36_Else_correct  (=> (and (not (and (select g1@@8 n$2_11) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_11 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon36_Then_correct  (=> (and (select g1@@8 n$2_11) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_11 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_29364_29365 QPMask@1 n$2_11 next)) (=> (HasDirectPerm_29364_29365 QPMask@1 n$2_11 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon35_Else_correct  (=> (not (select g1@@8 n$2_11)) (and (=> (= (ControlFlow 0 16) 11) anon36_Then_correct) (=> (= (ControlFlow 0 16) 13) anon36_Else_correct)))))
(let ((anon35_Then_correct  (=> (select g1@@8 n$2_11) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_29364_29365 QPMask@1 n$2_11 next)) (=> (HasDirectPerm_29364_29365 QPMask@1 n$2_11 next) (and (=> (= (ControlFlow 0 14) 11) anon36_Then_correct) (=> (= (ControlFlow 0 14) 13) anon36_Else_correct)))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@8 n$1_1)) (select g1@@8 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 :qid |stdinbpl.2289:15|
 :skolemid |270|
 ...
 :qid |stdinbpl.2289:15|
 :skolemid |270|
)) (=> (and (and (forall ((n$1_1@@1 T@Ref) ) (!  (=> (and (select g1@@8 n$1_1@@1) (< NoPerm FullPerm)) (and (qpRange23 n$1_1@@1) (= (invRecv23 n$1_1@@1) n$1_1@@1)))
 :qid |stdinbpl.2295:22|
 :skolemid |271|
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g1@@8 (invRecv23 o_9)) (< NoPerm FullPerm)) (qpRange23 o_9)) (= (invRecv23 o_9) o_9))
 :qid |stdinbpl.2299:22|
 :skolemid |272|
 :pattern ( (invRecv23 o_9))
))) (and (forall ((n$1_1@@2 T@Ref) ) (!  (=> (select g1@@8 n$1_1@@2) (not (= n$1_1@@2 null)))
 :qid |stdinbpl.2305:22|
 :skolemid |273|
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@8 (invRecv23 o_9@@0)) (< NoPerm FullPerm)) (qpRange23 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv23 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_9@@0 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g1@@8 (invRecv23 o_9@@0)) (< NoPerm FullPerm)) (qpRange23 o_9@@0))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_9@@0 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_9@@0 next))))
 :qid |stdinbpl.2311:22|
 :skolemid |274|
...
))) (state Heap@@33 QPMask@1)) (and (and (=> (= (ControlFlow 0 30) 29) anon34_Else_correct) (=> (= (ControlFlow 0 30) 14) anon35_Then_correct)) (=> (= (ControlFlow 0 30) 16) anon35_Else_correct))))))))
(let ((anon33_Then_correct true))
(let ((anon30_Else_correct  (=> (and (forall ((n$0_1 T@Ref) ) (!  (=> (and (select g0@@8 n$0_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_1 next) null))) (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_1 next)))
 :qid |stdinbpl.2277:20|
 :skolemid |269|
...
)) (not (select g1@@8 null))) (and (=> (= (ControlFlow 0 32) 9) anon33_Then_correct) (=> (= (ControlFlow 0 32) 30) anon33_Else_correct)))))
(let ((anon7_correct true))
(let ((anon32_Else_correct  (=> (and (not (and (select g0@@8 n$0_18) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_18 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon32_Then_correct  (=> (and (select g0@@8 n$0_18) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_18 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29364_29365 QPMask@0 n$0_18 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_18 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon31_Else_correct  (=> (not (select g0@@8 n$0_18)) (and (=> (= (ControlFlow 0 8) 3) anon32_Then_correct) (=> (= (ControlFlow 0 8) 5) anon32_Else_correct)))))
(let ((anon31_Then_correct  (=> (select g0@@8 n$0_18) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29364_29365 QPMask@0 n$0_18 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_18 next) (and (=> (= (ControlFlow 0 6) 3) anon32_Then_correct) (=> (= (ControlFlow 0 6) 5) anon32_Else_correct)))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@8 n_1)) (select g0@@8 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 :qid |stdinbpl.2232:15|
 :skolemid |263|
 ...
 :qid |stdinbpl.2232:15|
 :skolemid |263|
)) (=> (and (and (forall ((n_1@@1 T@Ref) ) (!  (=> (and (select g0@@8 n_1@@1) (< NoPerm FullPerm)) (and (qpRange22 n_1@@1) (= (invRecv22 n_1@@1) n_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_1@@1 next))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select g0@@8 (invRecv22 o_9@@5)) (< NoPerm FullPerm)) (qpRange22 o_9@@5)) (= (invRecv22 o_9@@5) o_9@@5))
 :qid |stdinbpl.2242:22|
 :skolemid |265|
 :pattern ( (invRecv22 o_9@@5))
))) (and (forall ((n_1@@2 T@Ref) ) (!  (=> (select g0@@8 n_1@@2) (not (= n_1@@2 null)))
 :qid |stdinbpl.2248:22|
 :skolemid |266|
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_1@@2 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select g0@@8 (invRecv22 o_9@@6)) (< NoPerm FullPerm)) (qpRange22 o_9@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv22 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_9@@6 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_9@@6 next) FullPerm)))) (=> (not (and (and (select g0@@8 (invRecv22 o_9@@6)) (< NoPerm FullPerm)) (qpRange22 o_9@@6))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_9@@6 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_9@@6 next))))
...
))) (state Heap@@33 QPMask@0)) (and (and (=> (= (ControlFlow 0 33) 32) anon30_Else_correct) (=> (= (ControlFlow 0 33) 6) anon31_Then_correct)) (=> (= (ControlFlow 0 33) 8) anon31_Else_correct))))))))
(let ((anon29_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (not (select g0@@8 null)))) (and (=> (= (ControlFlow 0 35) 1) anon29_Then_correct) (=> (= (ControlFlow 0 35) 33) anon29_Else_correct)))))
