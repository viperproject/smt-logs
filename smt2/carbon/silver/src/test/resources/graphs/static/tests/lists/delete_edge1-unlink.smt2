...
(let ((anon87_Then_correct  (=> (= v1_5 x@@6) (and (=> (= (ControlFlow 0 63) (- 0 64)) (HasDirectPerm_40180_40181 QPMask@0 x@@6 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 x@@6 next) (=> (= (ControlFlow 0 63) 61) anon32_correct))))))
...
(let ((anon84_Then_correct  (and (=> (= (ControlFlow 0 54) (- 0 56)) (forall ((n_4_1 T@Ref) ) (!  (=> (and (select g_1 n_4_1) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n_4_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
...
)) (=> (= (ControlFlow 0 54) (- 0 53)) (forall ((n_4_1@@3 T@Ref) ) (!  (=> (select g_1 n_4_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@1) n_4_1@@3 next) NoPerm)))
...
(let ((anon76_Else_correct  (=> (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1_1) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_1_1 next) null))) (select g_1 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_1_1 next)))
...
(let ((anon78_Else_correct  (=> (and (not (and (select g_1 n$2_4) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_4 next) null)))) (= (ControlFlow 0 16) 13)) anon16_correct)))
(let ((anon78_Then_correct  (=> (and (select g_1 n$2_4) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_4 next) null))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_40180_40181 QPMask@1 n$2_4 next)) (=> (HasDirectPerm_40180_40181 QPMask@1 n$2_4 next) (=> (= (ControlFlow 0 14) 13) anon16_correct))))))
...
(let ((anon77_Then_correct  (=> (select g_1 n$2_4) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_40180_40181 QPMask@1 n$2_4 next)) (=> (HasDirectPerm_40180_40181 QPMask@1 n$2_4 next) (and (=> (= (ControlFlow 0 17) 14) anon78_Then_correct) (=> (= (ControlFlow 0 17) 16) anon78_Else_correct)))))))
...
(let ((anon73_Else_correct  (=> (and (not (and (select g_1 n$0_2) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon73_Then_correct  (=> (and (select g_1 n$0_2) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_40180_40181 QPMask@0 n$0_2 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 n$0_2 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
...
(let ((anon72_Then_correct  (=> (select g_1 n$0_2) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_40180_40181 QPMask@0 n$0_2 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 n$0_2 next) (and (=> (= (ControlFlow 0 6) 3) anon73_Then_correct) (=> (= (ControlFlow 0 6) 5) anon73_Else_correct)))))))
