...
(let ((anon21_Else_correct  (=> (and (forall ((p_6_1 T@Ref) (s_6_1 T@Ref) ) (!  (=> (and (select refs@@7 p_6_1) (exists_path Result p_6_1 s_6_1)) (select refs@@7 s_6_1))
 :qid |stdinbpl.1308:20|
 :skolemid |125|
 :pattern ( (select refs@@7 p_6_1) (select refs@@7 s_6_1) (exists_path Result p_6_1 s_6_1))
...
(let ((anon17_Else_correct  (=> (and (forall ((p_4_1 T@Ref) (s_4_1 T@Ref) ) (! (=  (and (select refs@@7 p_4_1) (and (select refs@@7 s_4_1) (or (= (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) p_4_1 l_8) s_4_1) (= (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) p_4_1 r_6) s_4_1)))) (select Result (create_edge p_4_1 s_4_1)))
...
(let ((anon20_Else_correct  (=> (and (= (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) p_18 l_8) s_7) (= (ControlFlow 0 8) 3)) anon9_correct)))
(let ((anon20_Then_correct  (=> (not (= (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) p_18 l_8) s_7)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_70297_70298 QPMask@1 p_18 r_6)) (=> (HasDirectPerm_70297_70298 QPMask@1 p_18 r_6) (=> (= (ControlFlow 0 6) 3) anon9_correct))))))
(let ((anon19_Then_correct  (=> (select refs@@7 s_7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_70297_70298 QPMask@1 p_18 l_8)) (=> (HasDirectPerm_70297_70298 QPMask@1 p_18 l_8) (and (=> (= (ControlFlow 0 9) 6) anon20_Then_correct) (=> (= (ControlFlow 0 9) 8) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (and (not (select refs@@7 s_7)) (= (ControlFlow 0 5) 3)) anon9_correct)))
(let ((anon18_Then_correct  (=> (select refs@@7 p_18) (and (=> (= (ControlFlow 0 11) 9) anon19_Then_correct) (=> (= (ControlFlow 0 11) 5) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (select refs@@7 p_18)) (= (ControlFlow 0 4) 3)) anon9_correct)))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select refs@@7 n_7)) (select refs@@7 n_7_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_7 n_7_1)))
 ...
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@1 r_6))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) n_7@@1 r_6))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@1 r_6))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select refs@@7 (invRecv2 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 ...
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@2 r_6))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) n_7@@2 r_6))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@2 r_6))
 ...
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) n_7@@3 r_6))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@3 r_6))
)) (=> (and (forall ((n_7@@4 T@Ref) ) (!  (=> (and (select refs@@7 n_7@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= n_7@@4 null)))
 :qid |stdinbpl.1264:22|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@4 r_6))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) n_7@@4 r_6))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@4 r_6))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select refs@@7 (invRecv2 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) o_4@@0 r_6) (+ (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_4@@0 r_6) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select refs@@7 (invRecv2 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) o_4@@0 r_6) (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_4@@0 r_6))))
 :qid |stdinbpl.1270:22|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) o_4@@0 r_6))
))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_105221_53) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.1274:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@0) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_105234_105235) ) (!  (=> (not (= f_5@@0 r_6)) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1274:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_70297_350585) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1274:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@0) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_70297_350718) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1274:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@0) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@1) o_4@@4 f_5@@2))
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select refs@@7 n_5)) (select refs@@7 n_5_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_5 n_5_1)))
 ...
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@1 l_8))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) n_5@@1 l_8))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@1 l_8))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select refs@@7 (invRecv1 o_4@@5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@5)) (= (invRecv1 o_4@@5) o_4@@5))
 ...
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@2 l_8))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) n_5@@2 l_8))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@2 l_8))
))) (=> (forall ((n_5@@3 T@Ref) ) (!  (=> (select refs@@7 n_5@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1212:15|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@3 l_8))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) n_5@@3 l_8))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@3 l_8))
)) (=> (and (forall ((n_5@@4 T@Ref) ) (!  (=> (and (select refs@@7 n_5@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= n_5@@4 null)))
 :qid |stdinbpl.1218:22|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@4 l_8))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) n_5@@4 l_8))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@4 l_8))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (and (select refs@@7 (invRecv1 o_4@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv1 o_4@@6) o_4@@6)) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_4@@6 l_8) (+ (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| ZeroMask) o_4@@6 l_8) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select refs@@7 (invRecv1 o_4@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@6))) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_4@@6 l_8) (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| ZeroMask) o_4@@6 l_8))))
 :qid |stdinbpl.1224:22|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_4@@6 l_8))
))) (=> (and (and (and (and (forall ((o_4@@7 T@Ref) (f_5@@3 T@Field_105221_53) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| ZeroMask) o_4@@7 f_5@@3) (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@0) o_4@@7 f_5@@3)))
 :qid |stdinbpl.1228:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| ZeroMask) o_4@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@0) o_4@@7 f_5@@3))
)) (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_105234_105235) ) (!  (=> (not (= f_5@@4 l_8)) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1228:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_4@@8 f_5@@4))
))) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_70297_350585) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1228:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_70297_350718) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1228:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@0) o_4@@10 f_5@@6))
