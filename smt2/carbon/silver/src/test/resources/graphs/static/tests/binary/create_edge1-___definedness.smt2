...
(declare-fun refs@@7 () (Array T@Ref Bool))
...
(let ((anon21_Else_correct  (=> (and (forall ((p_6 T@Ref) (s_6 T@Ref) ) (!  (=> (and (select refs@@7 p_6) (exists_path Result p_6 s_6)) (select refs@@7 s_6))
 :qid |stdinbpl.1308:20|
 :skolemid |125|
 :pattern ( (select refs@@7 p_6) (select refs@@7 s_6) (exists_path Result p_6 s_6))
)) (state Heap@@29 QPMask@1)) (and (=> (= (ControlFlow 0 15) 13) anon22_Then_correct) (=> (= (ControlFlow 0 15) 14) anon22_Else_correct)))))
(let ((anon21_Then_correct true))
(let ((anon17_Else_correct  (=> (and (forall ((p_4_1 T@Ref) (s_4 T@Ref) ) (! (=  (and (select refs@@7 p_4_1) (and (select refs@@7 s_4) (or (= (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) p_4_1 l) s_4) (= (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) p_4_1 r_11) s_4)))) (select Result (create_edge p_4_1 s_4)))
 :qid |stdinbpl.1298:20|
 :skolemid |124|
 :pattern ( (create_edge p_4_1 s_4))
)) (state Heap@@29 QPMask@1)) (and (=> (= (ControlFlow 0 16) 12) anon21_Then_correct) (=> (= (ControlFlow 0 16) 15) anon21_Else_correct)))))
(let ((anon9_correct true))
(let ((anon20_Else_correct  (=> (and (= (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) p_7 l) s_5) (= (ControlFlow 0 8) 3)) anon9_correct)))
(let ((anon20_Then_correct  (=> (not (= (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) p_7 l) s_5)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_70297_70298 QPMask@1 p_7 r_11)) (=> (HasDirectPerm_70297_70298 QPMask@1 p_7 r_11) (=> (= (ControlFlow 0 6) 3) anon9_correct))))))
(let ((anon19_Then_correct  (=> (select refs@@7 s_5) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_70297_70298 QPMask@1 p_7 l)) (=> (HasDirectPerm_70297_70298 QPMask@1 p_7 l) (and (=> (= (ControlFlow 0 9) 6) anon20_Then_correct) (=> (= (ControlFlow 0 9) 8) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (and (not (select refs@@7 s_5)) (= (ControlFlow 0 5) 3)) anon9_correct)))
(let ((anon18_Then_correct  (=> (select refs@@7 p_7) (and (=> (= (ControlFlow 0 11) 9) anon19_Then_correct) (=> (= (ControlFlow 0 11) 5) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (select refs@@7 p_7)) (= (ControlFlow 0 4) 3)) anon9_correct)))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select refs@@7 n_7)) (select refs@@7 n_7_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_7 n_7_1)))
 :qid |stdinbpl.1242:15|
 :skolemid |117|
))) (=> (forall ((n_7@@0 T@Ref) (n_7_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7@@0 n_7_1@@0)) (select refs@@7 n_7@@0)) (select refs@@7 n_7_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_7@@0 n_7_1@@0)))
 :qid |stdinbpl.1242:15|
 :skolemid |117|
)) (=> (and (forall ((n_7@@1 T@Ref) ) (!  (=> (and (select refs@@7 n_7@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange2 n_7@@1) (= (invRecv2 n_7@@1) n_7@@1)))
 :qid |stdinbpl.1248:22|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@1 r_11))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) n_7@@1 r_11))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@1 r_11))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select refs@@7 (invRecv2 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.1252:22|
 :skolemid |119|
 :pattern ( (invRecv2 o_9))
))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((n_7@@2 T@Ref) ) (!  (=> (select refs@@7 n_7@@2) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1258:15|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@2 r_11))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) n_7@@2 r_11))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@2 r_11))
))) (=> (forall ((n_7@@3 T@Ref) ) (!  (=> (select refs@@7 n_7@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1258:15|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@3 r_11))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) n_7@@3 r_11))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@3 r_11))
)) (=> (and (forall ((n_7@@4 T@Ref) ) (!  (=> (and (select refs@@7 n_7@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= n_7@@4 null)))
 :qid |stdinbpl.1264:22|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@4 r_11))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) n_7@@4 r_11))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_7@@4 r_11))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select refs@@7 (invRecv2 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) o_9@@0 r_11) (+ (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_9@@0 r_11) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select refs@@7 (invRecv2 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) o_9@@0 r_11) (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_9@@0 r_11))))
 :qid |stdinbpl.1270:22|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) o_9@@0 r_11))
))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_105221_53) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.1274:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_105234_105235) ) (!  (=> (not (= f_5@@0 r_11)) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1274:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_70297_350585) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1274:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_70297_350718) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1274:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@1) o_9@@4 f_5@@2))
))) (and (state Heap@@29 QPMask@1) (state Heap@@29 QPMask@1))) (and (and (=> (= (ControlFlow 0 17) 16) anon17_Else_correct) (=> (= (ControlFlow 0 17) 11) anon18_Then_correct)) (=> (= (ControlFlow 0 17) 4) anon18_Else_correct)))))))))))
(let ((anon16_Then_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select refs@@7 n_5)) (select refs@@7 n_5_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_5 n_5_1)))
 :qid |stdinbpl.1196:15|
 :skolemid |110|
))) (=> (forall ((n_5@@0 T@Ref) (n_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5@@0 n_5_1@@0)) (select refs@@7 n_5@@0)) (select refs@@7 n_5_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_5@@0 n_5_1@@0)))
 :qid |stdinbpl.1196:15|
 :skolemid |110|
)) (=> (and (forall ((n_5@@1 T@Ref) ) (!  (=> (and (select refs@@7 n_5@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 n_5@@1) (= (invRecv1 n_5@@1) n_5@@1)))
 :qid |stdinbpl.1202:22|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@1 l))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) n_5@@1 l))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@1 l))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select refs@@7 (invRecv1 o_9@@5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@5)) (= (invRecv1 o_9@@5) o_9@@5))
 :qid |stdinbpl.1206:22|
 :skolemid |112|
 :pattern ( (invRecv1 o_9@@5))
))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((n_5@@2 T@Ref) ) (!  (=> (select refs@@7 n_5@@2) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1212:15|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@2 l))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) n_5@@2 l))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@2 l))
))) (=> (forall ((n_5@@3 T@Ref) ) (!  (=> (select refs@@7 n_5@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1212:15|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@3 l))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) n_5@@3 l))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@3 l))
)) (=> (and (forall ((n_5@@4 T@Ref) ) (!  (=> (and (select refs@@7 n_5@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= n_5@@4 null)))
 :qid |stdinbpl.1218:22|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@4 l))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) n_5@@4 l))
 :pattern ( (select (|PolymorphicMapType_105161_69134_69135#PolymorphicMapType_105161| Heap@@29) n_5@@4 l))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select refs@@7 (invRecv1 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv1 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_9@@6 l) (+ (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| ZeroMask) o_9@@6 l) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select refs@@7 (invRecv1 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@6))) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_9@@6 l) (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| ZeroMask) o_9@@6 l))))
 :qid |stdinbpl.1224:22|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_9@@6 l))
))) (=> (and (and (and (and (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_105221_53) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| ZeroMask) o_9@@7 f_5@@3) (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@0) o_9@@7 f_5@@3)))
 :qid |stdinbpl.1228:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| ZeroMask) o_9@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_105182_70297_53#PolymorphicMapType_105182| QPMask@0) o_9@@7 f_5@@3))
)) (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_105234_105235) ) (!  (=> (not (= f_5@@4 l)) (= (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.1228:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_105182_70297_70298#PolymorphicMapType_105182| QPMask@0) o_9@@8 f_5@@4))
))) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_70297_350585) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.1228:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_105182_70297_350585#PolymorphicMapType_105182| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_70297_350718) ) (!  (=> true (= (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.1228:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_105182_70297_354264#PolymorphicMapType_105182| QPMask@0) o_9@@10 f_5@@6))
))) (and (state Heap@@29 QPMask@0) (state Heap@@29 QPMask@0))) (and (=> (= (ControlFlow 0 20) 2) anon16_Then_correct) (=> (= (ControlFlow 0 20) 17) anon16_Else_correct)))))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@29 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 23) 1) anon15_Then_correct) (=> (= (ControlFlow 0 23) 20) anon15_Else_correct))))))
