...
(let ((anon11_Then_correct  (=> (select refs@@4 s_2) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_29364_29365 QPMask@0 p_4 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 p_4 next) (=> (= (ControlFlow 0 5) 3) anon6_correct))))))
