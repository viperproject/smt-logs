...
(let ((anon40_Else_correct  (=> (and (not (and (select g_1 n$2_40) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_40 next) null)))) (= (ControlFlow 0 33) 30)) anon18_correct)))
(let ((anon40_Then_correct  (=> (and (select g_1 n$2_40) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_40 next) null))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (HasDirectPerm_29078_29079 QPMask@5 n$2_40 next)) (=> (HasDirectPerm_29078_29079 QPMask@5 n$2_40 next) (=> (= (ControlFlow 0 31) 30) anon18_correct))))))
(let ((anon39_Else_correct  (=> (not (select g_1 n$2_40)) (and (=> (= (ControlFlow 0 36) 31) anon40_Then_correct) (=> (= (ControlFlow 0 36) 33) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> (select g_1 n$2_40) (and (=> (= (ControlFlow 0 34) (- 0 35)) (HasDirectPerm_29078_29079 QPMask@5 n$2_40 next)) (=> (HasDirectPerm_29078_29079 QPMask@5 n$2_40 next) (and (=> (= (ControlFlow 0 34) 31) anon40_Then_correct) (=> (= (ControlFlow 0 34) 33) anon40_Else_correct)))))))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g_1 n$1_1)) (select g_1 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv22 o_4)) (< NoPerm FullPerm)) (qpRange22 o_4)) (= (invRecv22 o_4) o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv22 o_4@@0)) (< NoPerm FullPerm)) (qpRange22 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv22 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_4@@0 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv22 o_4@@0)) (< NoPerm FullPerm)) (qpRange22 o_4@@0))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_4@@0 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_4@@0 next))))
...
)) (= (ControlFlow 0 19) (- 0 18))) (exists_path ($$ Heap@@19 g_1) u_3@@3 v_2@@6))))
(let ((anon43_Else_correct  (=> (apply_IND_2 ($$ Heap@@19 g_1) (|Set#Singleton_29281| v_2@@6) (inst_uReach_rev ($$ Heap@@19 g_1) v_2@@6)) (=> (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0)) (and (=> (= (ControlFlow 0 24) (- 0 27)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((n$1_2 T@Ref) (n$1_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_2 n$1_2_1)) (select g_1 n$1_2)) (select g_1 n$1_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_2 n$1_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1_2@@3 next))
)) (=> (and (forall ((o_4@@5 T@Ref) ) (!  (=> (and (select g_1 (invRecv24 o_4@@5)) (and (< NoPerm FullPerm) (qpRange24 o_4@@5))) (= (invRecv24 o_4@@5) o_4@@5))
 :qid |stdinbpl.2332:22|
 :skolemid |249|
 :pattern ( (invRecv24 o_4@@5))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv24 o_4@@6)) (and (< NoPerm FullPerm) (qpRange24 o_4@@6))) (and (= (invRecv24 o_4@@6) o_4@@6) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@4) o_4@@6 next) (- (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_4@@6 next) FullPerm)))) (=> (not (and (select g_1 (invRecv24 o_4@@6)) (and (< NoPerm FullPerm) (qpRange24 o_4@@6)))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@4) o_4@@6 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_4@@6 next))))
...
(let ((anon42_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n_4_1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1 n_4_2)) (select g_1 n_4_1)) (select g_1 n_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1 n_4_2)))
 ...
 :skolemid |238|
 :pattern ( (neverTriggered25 n_4_1) (neverTriggered25 n_4_2))
 ...
 :qid |stdinbpl.2232:21|
 :skolemid |238|
 :pattern ( (neverTriggered25 n_4_1@@0) (neverTriggered25 n_4_2@@0))
...
(let ((anon35_Else_correct  (=> (and (exists_path_2 ($$ Heap@@19 g_1) u_3@@3 v_2@@6) (state Heap@@19 QPMask@0)) (and (=> (= (ControlFlow 0 45) 44) anon36_Then_correct) (=> (= (ControlFlow 0 45) 28) anon36_Else_correct)))))
...
(let ((anon34_Else_correct  (=> (and (not (and (select g_1 n$0_40) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_40 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon34_Then_correct  (=> (and (select g_1 n$0_40) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_40 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29078_29079 QPMask@0 n$0_40 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0_40 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon33_Else_correct  (=> (not (select g_1 n$0_40)) (and (=> (= (ControlFlow 0 8) 3) anon34_Then_correct) (=> (= (ControlFlow 0 8) 5) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (select g_1 n$0_40) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29078_29079 QPMask@0 n$0_40 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0_40 next) (and (=> (= (ControlFlow 0 6) 3) anon34_Then_correct) (=> (= (ControlFlow 0 6) 5) anon34_Else_correct)))))))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 47) (- 0 48)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@1 next))
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv20 o_4@@11)) (< NoPerm FullPerm)) (qpRange20 o_4@@11)) (= (invRecv20 o_4@@11) o_4@@11))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@2 next))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv20 o_4@@12)) (< NoPerm FullPerm)) (qpRange20 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv20 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_4@@12 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_4@@12 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv20 o_4@@12)) (< NoPerm FullPerm)) (qpRange20 o_4@@12))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_4@@12 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_4@@12 next))))
