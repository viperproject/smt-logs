...
(let ((anon40_Else_correct  (=> (and (not (and (select g_1 n$2_4) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_4 next) null)))) (= (ControlFlow 0 33) 30)) anon18_correct)))
(let ((anon40_Then_correct  (=> (and (select g_1 n$2_4) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_4 next) null))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (HasDirectPerm_29078_29079 QPMask@5 n$2_4 next)) (=> (HasDirectPerm_29078_29079 QPMask@5 n$2_4 next) (=> (= (ControlFlow 0 31) 30) anon18_correct))))))
(let ((anon39_Else_correct  (=> (not (select g_1 n$2_4)) (and (=> (= (ControlFlow 0 36) 31) anon40_Then_correct) (=> (= (ControlFlow 0 36) 33) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> (select g_1 n$2_4) (and (=> (= (ControlFlow 0 34) (- 0 35)) (HasDirectPerm_29078_29079 QPMask@5 n$2_4 next)) (=> (HasDirectPerm_29078_29079 QPMask@5 n$2_4 next) (and (=> (= (ControlFlow 0 34) 31) anon40_Then_correct) (=> (= (ControlFlow 0 34) 33) anon40_Else_correct)))))))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g_1 n$1_1)) (select g_1 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :qid |stdinbpl.2119:15|
 :skolemid |227|
)) (=> (and (and (forall ((n$1_1@@1 T@Ref) ) (!  (=> (and (select g_1 n$1_1@@1) (< NoPerm FullPerm)) (and (qpRange22 n$1_1@@1) (= (invRecv22 n$1_1@@1) n$1_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv22 o_9)) (< NoPerm FullPerm)) (qpRange22 o_9)) (= (invRecv22 o_9) o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv22 o_9@@0)) (< NoPerm FullPerm)) (qpRange22 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv22 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@0 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv22 o_9@@0)) (< NoPerm FullPerm)) (qpRange22 o_9@@0))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@0 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@0 next))))
...
(let ((anon43_Else_correct  (=> (apply_IND_2 ($$ Heap@@19 g_1) (|Set#Singleton_29281| v_2@@6) (inst_uReach_rev ($$ Heap@@19 g_1) v_2@@6)) (=> (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0)) (and (=> (= (ControlFlow 0 24) (- 0 27)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((n$1_2 T@Ref) (n$1_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_2 n$1_2_1)) (select g_1 n$1_2)) (select g_1 n$1_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_2 n$1_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1_2@@2 next))
)) (=> (forall ((n$1_2@@3 T@Ref) ) (!  (=> (and (select g_1 n$1_2@@3) (< NoPerm FullPerm)) (and (qpRange24 n$1_2@@3) (= (invRecv24 n$1_2@@3) n$1_2@@3)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1_2@@3 next))
)) (=> (and (forall ((o_9@@5 T@Ref) ) (!  (=> (and (select g_1 (invRecv24 o_9@@5)) (and (< NoPerm FullPerm) (qpRange24 o_9@@5))) (= (invRecv24 o_9@@5) o_9@@5))
 :qid |stdinbpl.2332:22|
 :skolemid |249|
 :pattern ( (invRecv24 o_9@@5))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv24 o_9@@6)) (and (< NoPerm FullPerm) (qpRange24 o_9@@6))) (and (= (invRecv24 o_9@@6) o_9@@6) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@4) o_9@@6 next) (- (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@6 next) FullPerm)))) (=> (not (and (select g_1 (invRecv24 o_9@@6)) (and (< NoPerm FullPerm) (qpRange24 o_9@@6)))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@4) o_9@@6 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@6 next))))
...
(let ((anon35_Else_correct  (=> (and (exists_path_2 ($$ Heap@@19 g_1) u_1@@3 v_2@@6) (state Heap@@19 QPMask@0)) (and (=> (= (ControlFlow 0 45) 44) anon36_Then_correct) (=> (= (ControlFlow 0 45) 28) anon36_Else_correct)))))
...
(let ((anon34_Else_correct  (=> (and (not (and (select g_1 n$0_11) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_11 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon34_Then_correct  (=> (and (select g_1 n$0_11) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_11 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29078_29079 QPMask@0 n$0_11 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0_11 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon33_Else_correct  (=> (not (select g_1 n$0_11)) (and (=> (= (ControlFlow 0 8) 3) anon34_Then_correct) (=> (= (ControlFlow 0 8) 5) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (select g_1 n$0_11) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29078_29079 QPMask@0 n$0_11 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0_11 next) (and (=> (= (ControlFlow 0 6) 3) anon34_Then_correct) (=> (= (ControlFlow 0 6) 5) anon34_Else_correct)))))))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 47) (- 0 48)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :qid |stdinbpl.2003:15|
 :skolemid |216|
)) (=> (and (and (forall ((n_1@@1 T@Ref) ) (!  (=> (and (select g_1 n_1@@1) (< NoPerm FullPerm)) (and (qpRange20 n_1@@1) (= (invRecv20 n_1@@1) n_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@1 next))
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv20 o_9@@11)) (< NoPerm FullPerm)) (qpRange20 o_9@@11)) (= (invRecv20 o_9@@11) o_9@@11))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@2 next))
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv20 o_9@@12)) (< NoPerm FullPerm)) (qpRange20 o_9@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv20 o_9@@12) o_9@@12)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@12 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@12 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv20 o_9@@12)) (< NoPerm FullPerm)) (qpRange20 o_9@@12))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@12 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@12 next))))
