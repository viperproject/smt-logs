...
(let ((anon115_Else_correct  (=> (and (not (and (select g0@@8 n$0_2_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next) null)))) (= (ControlFlow 0 143) 140)) anon34_correct)))
(let ((anon115_Then_correct  (=> (and (select g0@@8 n$0_2_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next) null))) (and (=> (= (ControlFlow 0 141) (- 0 142)) (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next))) (=> (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next)) (=> (= (ControlFlow 0 141) 140) anon34_correct))))))
(let ((anon114_Else_correct true))
(let ((anon113_Then_correct  (and (=> (= (ControlFlow 0 144) (- 0 147)) (not (select g0@@8 null))) (=> (not (select g0@@8 null)) (and (=> (= (ControlFlow 0 144) (- 0 146)) (forall ((n_4_1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1 n_4_2)) (select g0@@8 n_4_1)) (select g0@@8 n_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1 n_4_2)))
 :qid |stdinbpl.4054:21|
 :skolemid |441|
 :pattern ( (neverTriggered50 n_4_1) (neverTriggered50 n_4_2))
))) (=> (forall ((n_4_1@@0 T@Ref) (n_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1@@0 n_4_2@@0)) (select g0@@8 n_4_1@@0)) (select g0@@8 n_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1@@0 n_4_2@@0)))
 :qid |stdinbpl.4054:21|
 :skolemid |441|
 :pattern ( (neverTriggered50 n_4_1@@0) (neverTriggered50 n_4_2@@0))
)) (and (=> (= (ControlFlow 0 144) (- 0 145)) (forall ((n_4_1@@1 T@Ref) ) (!  (=> (select g0@@8 n_4_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) n_4_1@@1 next) NoPerm)))
 :qid |stdinbpl.4061:21|
 :skolemid |442|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@2) n_4_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@1 next))
))) (=> (forall ((n_4_1@@2 T@Ref) ) (!  (=> (select g0@@8 n_4_1@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) n_4_1@@2 next) NoPerm)))
 :qid |stdinbpl.4061:21|
 :skolemid |442|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@2) n_4_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@2 next))
)) (=> (and (forall ((n_4_1@@3 T@Ref) ) (!  (=> (and (select g0@@8 n_4_1@@3) (< NoPerm FullPerm)) (and (qpRange50 n_4_1@@3) (= (invRecv50 n_4_1@@3) n_4_1@@3)))
 :qid |stdinbpl.4067:26|
 :skolemid |443|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@2) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4_1@@3 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select g0@@8 (invRecv50 o_4)) (and (< NoPerm FullPerm) (qpRange50 o_4))) (= (invRecv50 o_4) o_4))
 :qid |stdinbpl.4071:26|
 :skolemid |444|
 :pattern ( (invRecv50 o_4))
...
(let ((anon116_Then_correct  (and (=> (= (ControlFlow 0 134) (- 0 137)) (not (select g1@@8 null))) (=> (not (select g1@@8 null)) (and (=> (= (ControlFlow 0 134) (- 0 136)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select g1@@8 n_5)) (select g1@@8 n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_5@@3 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (select g1@@8 (invRecv51 o_4@@0)) (and (< NoPerm FullPerm) (qpRange51 o_4@@0))) (= (invRecv51 o_4@@0) o_4@@0))
 :qid |stdinbpl.4128:26|
 :skolemid |449|
 :pattern ( (invRecv51 o_4@@0))
...
)) (= (ControlFlow 0 115) (- 0 114))) (|Set#Subset_29491| (|Set#UnionOne_30254| (|Set#Singleton_30254| x1_2) x0) (|Set#Union_29737| g0@@8 g1@@8)))))
(let ((anon124_Then_correct  (and (=> (= (ControlFlow 0 120) (- 0 123)) (not (select (|Set#Union_29737| g0@@8 g1@@8) null))) (=> (not (select (|Set#Union_29737| g0@@8 g1@@8) null)) (and (=> (= (ControlFlow 0 120) (- 0 122)) (forall ((n$0_6 T@Ref) (n$0_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_6 n$0_6_1)) (select (|Set#Union_29737| g0@@8 g1@@8) n$0_6)) (select (|Set#Union_29737| g0@@8 g1@@8) n$0_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_6 n$0_6_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$0_6@@3 next))
)) (forall ((o_4@@1 T@Ref) ) (!  (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv53 o_4@@1)) (and (< NoPerm FullPerm) (qpRange53 o_4@@1))) (= (invRecv53 o_4@@1) o_4@@1))
 :qid |stdinbpl.4254:26|
 :skolemid |461|
 :pattern ( (invRecv53 o_4@@1))
...
(let ((anon127_Then_correct  (and (=> (= (ControlFlow 0 109) (- 0 112)) (not (select (|Set#Union_29737| g0@@8 g1@@8) null))) (=> (not (select (|Set#Union_29737| g0@@8 g1@@8) null)) (and (=> (= (ControlFlow 0 109) (- 0 111)) (forall ((n_6 T@Ref) (n_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6 n_6_1)) (select (|Set#Union_29737| g0@@8 g1@@8) n_6)) (select (|Set#Union_29737| g0@@8 g1@@8) n_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n_6@@3 next))
)) (forall ((o_4@@2 T@Ref) ) (!  (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv54 o_4@@2)) (and (< NoPerm FullPerm) (qpRange54 o_4@@2))) (= (invRecv54 o_4@@2) o_4@@2))
 :qid |stdinbpl.4313:26|
 :skolemid |466|
 :pattern ( (invRecv54 o_4@@2))
...
(let ((anon124_Else_correct  (=> (is_global_sroot PostHeap@0 (|Set#Union_29737| g0@@8 g1@@8) (|Set#UnionOne_30254| (|Set#Singleton_30254| x1_2) x0)) (=> (and (state PostHeap@0 QPMask@10) (state PostHeap@0 QPMask@10)) (and (=> (= (ControlFlow 0 113) 109) anon127_Then_correct) (=> (= (ControlFlow 0 113) 103) anon127_Else_correct))))))
...
(let ((anon120_Else_correct  (and (=> (= (ControlFlow 0 125) (- 0 126)) (forall ((n$5_1 T@Ref) (n$5_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$5_1 n$5_1_1)) (select (|Set#Union_29737| g0@@8 g1@@8) n$5_1)) (select (|Set#Union_29737| g0@@8 g1@@8) n$5_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$5_1 n$5_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$5_1@@1 next))
)) (forall ((o_4@@3 T@Ref) ) (!  (=> (and (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv52 o_4@@3)) (< NoPerm FullPerm)) (qpRange52 o_4@@3)) (= (invRecv52 o_4@@3) o_4@@3))
 :qid |stdinbpl.4181:22|
 :skolemid |453|
 :pattern ( (invRecv52 o_4@@3))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$5_1@@2 next))
)) (forall ((o_4@@4 T@Ref) ) (!  (and (=> (and (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv52 o_4@@4)) (< NoPerm FullPerm)) (qpRange52 o_4@@4)) (and (=> (< NoPerm FullPerm) (= (invRecv52 o_4@@4) o_4@@4)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@10) o_4@@4 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@4 next) FullPerm)))) (=> (not (and (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv52 o_4@@4)) (< NoPerm FullPerm)) (qpRange52 o_4@@4))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@10) o_4@@4 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@4 next))))
 :qid |stdinbpl.4193:22|
 :skolemid |455|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@10) o_4@@4 next))
)))) (=> (and (and (and (and (forall ((o_4@@5 T@Ref) (f_5 T@Field_46438_53) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| ZeroMask) o_4@@5 f_5) (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@10) o_4@@5 f_5)))
 :qid |stdinbpl.4197:29|
 :skolemid |456|
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| ZeroMask) o_4@@5 f_5))
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@10) o_4@@5 f_5))
)) (forall ((o_4@@6 T@Ref) (f_5@@0 T@Field_46451_46452) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@6 f_5@@0) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@10) o_4@@6 f_5@@0)))
 :qid |stdinbpl.4197:29|
 :skolemid |456|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@6 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@10) o_4@@6 f_5@@0))
))) (forall ((o_4@@7 T@Ref) (f_5@@1 T@Field_29364_147463) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| ZeroMask) o_4@@7 f_5@@1) (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@10) o_4@@7 f_5@@1)))
 :qid |stdinbpl.4197:29|
 :skolemid |456|
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| ZeroMask) o_4@@7 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@10) o_4@@7 f_5@@1))
))) (forall ((o_4@@8 T@Ref) (f_5@@2 T@Field_29364_147596) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| ZeroMask) o_4@@8 f_5@@2) (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@10) o_4@@8 f_5@@2)))
 :qid |stdinbpl.4197:29|
 :skolemid |456|
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| ZeroMask) o_4@@8 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@10) o_4@@8 f_5@@2))
...
(let ((anon133_Else_correct  (=> (forall ((n$0_10_1 T@Ref) ) (!  (=> (and (select g0@@8 n$0_10_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_10_1 next) null))) (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_10_1 next)))
 :qid |stdinbpl.4405:24|
 :skolemid |474|
 :pattern ( (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_10_1 next)))
 :pattern ( (select g0@@8 n$0_10_1) (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_10_1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_4@@3 next))
)) (forall ((o_4@@9 T@Ref) ) (!  (=> (and (select g1@@8 (invRecv57 o_4@@9)) (and (< NoPerm FullPerm) (qpRange57 o_4@@9))) (= (invRecv57 o_4@@9) o_4@@9))
 :qid |stdinbpl.4435:26|
 :skolemid |478|
 :pattern ( (invRecv57 o_4@@9))
...
(let ((anon132_Then_correct  (and (=> (= (ControlFlow 0 86) (- 0 89)) (not (select g0@@8 null))) (=> (not (select g0@@8 null)) (and (=> (= (ControlFlow 0 86) (- 0 88)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select g0@@8 n_7)) (select g0@@8 n_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_7@@3 next))
)) (forall ((o_4@@10 T@Ref) ) (!  (=> (and (select g0@@8 (invRecv56 o_4@@10)) (and (< NoPerm FullPerm) (qpRange56 o_4@@10))) (= (invRecv56 o_4@@10) o_4@@10))
 :qid |stdinbpl.4394:26|
 :skolemid |473|
 :pattern ( (invRecv56 o_4@@10))
...
)) (and (=> (= (ControlFlow 0 59) (- 0 61)) (is_global_sroot Heap@@33 (|Set#Union_29737| g0@@8 g1@@8) (|Set#UnionOne_30254| (|Set#Singleton_30254| x1_2) x0))) (=> (is_global_sroot Heap@@33 (|Set#Union_29737| g0@@8 g1@@8) (|Set#UnionOne_30254| (|Set#Singleton_30254| x1_2) x0)) (and (=> (= (ControlFlow 0 59) (- 0 60)) (acyclic_list_segment Heap@@33 (|Set#Union_29737| g0@@8 g1@@8))) (=> (acyclic_list_segment Heap@@33 (|Set#Union_29737| g0@@8 g1@@8)) (and (and (=> (= (ControlFlow 0 59) 58) anon142_Else_correct) (=> (= (ControlFlow 0 59) 50) anon143_Then_correct)) (=> (= (ControlFlow 0 59) 52) anon143_Else_correct)))))))))
...
(let ((anon139_Else_correct  (and (=> (= (ControlFlow 0 62) (- 0 66)) (unshared_graph ($$ Heap@@33 (|Set#Union_29737| g0@@8 g1@@8)))) (=> (unshared_graph ($$ Heap@@33 (|Set#Union_29737| g0@@8 g1@@8))) (=> (state Heap@@33 QPMask@1) (and (=> (= (ControlFlow 0 62) (- 0 65)) (not (select (|Set#Union_29737| g0@@8 g1@@8) null))) (=> (not (select (|Set#Union_29737| g0@@8 g1@@8) null)) (and (=> (= (ControlFlow 0 62) (- 0 64)) (forall ((n$5_2 T@Ref) (n$5_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$5_2 n$5_2_1)) (select (|Set#Union_29737| g0@@8 g1@@8) n$5_2)) (select (|Set#Union_29737| g0@@8 g1@@8) n$5_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$5_2 n$5_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$5_2@@3 next))
)) (=> (and (forall ((o_4@@11 T@Ref) ) (!  (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv55 o_4@@11)) (and (< NoPerm FullPerm) (qpRange55 o_4@@11))) (= (invRecv55 o_4@@11) o_4@@11))
 :qid |stdinbpl.4648:22|
 :skolemid |498|
 :pattern ( (invRecv55 o_4@@11))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv55 o_4@@12)) (and (< NoPerm FullPerm) (qpRange55 o_4@@12))) (and (= (invRecv55 o_4@@12) o_4@@12) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@8) o_4@@12 next) (- (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@12 next) FullPerm)))) (=> (not (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv55 o_4@@12)) (and (< NoPerm FullPerm) (qpRange55 o_4@@12)))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@8) o_4@@12 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@12 next))))
 :qid |stdinbpl.4654:22|
 :skolemid |499|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@8) o_4@@12 next))
))) (=> (and (and (and (forall ((o_4@@13 T@Ref) (f_5@@3 T@Field_46438_53) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@1) o_4@@13 f_5@@3) (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@8) o_4@@13 f_5@@3)))
 :qid |stdinbpl.4660:29|
 :skolemid |500|
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@8) o_4@@13 f_5@@3))
)) (forall ((o_4@@14 T@Ref) (f_5@@4 T@Field_46451_46452) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@14 f_5@@4) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@8) o_4@@14 f_5@@4)))
 :qid |stdinbpl.4660:29|
 :skolemid |500|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@8) o_4@@14 f_5@@4))
))) (forall ((o_4@@15 T@Ref) (f_5@@5 T@Field_29364_147463) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@1) o_4@@15 f_5@@5) (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@8) o_4@@15 f_5@@5)))
 :qid |stdinbpl.4660:29|
 :skolemid |500|
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@8) o_4@@15 f_5@@5))
))) (forall ((o_4@@16 T@Ref) (f_5@@6 T@Field_29364_147596) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@1) o_4@@16 f_5@@6) (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@8) o_4@@16 f_5@@6)))
 :qid |stdinbpl.4660:29|
 :skolemid |500|
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@8) o_4@@16 f_5@@6))
...
(let ((anon110_Else_correct  (=> (forall ((n$4_1_2 T@Ref) ) (!  (=> (select g1@@8 n$4_1_2) (exists_path ($$ Heap@@33 g1@@8) x1_2 n$4_1_2))
 :qid |stdinbpl.4033:20|
 :skolemid |440|
 :pattern ( (select g1@@8 n$4_1_2))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_5743 (|$$#condqp1| Heap@@33 g1@@8)) g1@@8) x1_2 n$4_1_2))
...
(let ((anon111_Then_correct  (=> (select g1@@8 n$4_11) (and (=> (= (ControlFlow 0 32) 29) anon112_Then_correct) (=> (= (ControlFlow 0 32) 26) anon29_correct)))))
(let ((anon111_Else_correct  (=> (and (not (select g1@@8 n$4_11)) (= (ControlFlow 0 27) 26)) anon29_correct)))
(let ((anon107_Else_correct  (=> (forall ((n$3_1_2 T@Ref) ) (!  (=> (select g0@@8 n$3_1_2) (exists_path ($$ Heap@@33 g0@@8) x0 n$3_1_2))
 :qid |stdinbpl.3977:20|
 :skolemid |434|
 :pattern ( (select g0@@8 n$3_1_2))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_5743 (|$$#condqp1| Heap@@33 g0@@8)) g0@@8) x0 n$3_1_2))
...
(let ((anon108_Then_correct  (=> (select g0@@8 n$3_6) (and (=> (= (ControlFlow 0 25) 22) anon109_Then_correct) (=> (= (ControlFlow 0 25) 19) anon24_correct)))))
(let ((anon108_Else_correct  (=> (and (not (select g0@@8 n$3_6)) (= (ControlFlow 0 20) 19)) anon24_correct)))
...
(let ((anon102_Else_correct  (=> (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g1@@8 n$2_1_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_1_1 next) null))) (select g1@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_1_1 next)))
...
)) (state Heap@@33 QPMask@1)) (=> (and (and (select g0@@8 x0) (state Heap@@33 QPMask@1)) (and (select g1@@8 x1_2) (state Heap@@33 QPMask@1))) (and (=> (= (ControlFlow 0 152) 17) anon105_Then_correct) (=> (= (ControlFlow 0 152) 151) anon105_Else_correct))))))
(let ((anon15_correct true))
(let ((anon104_Else_correct  (=> (and (not (and (select g1@@8 n$2_27) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_27 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon104_Then_correct  (=> (and (select g1@@8 n$2_27) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_27 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_29364_29365 QPMask@1 n$2_27 next)) (=> (HasDirectPerm_29364_29365 QPMask@1 n$2_27 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon103_Else_correct  (=> (not (select g1@@8 n$2_27)) (and (=> (= (ControlFlow 0 16) 11) anon104_Then_correct) (=> (= (ControlFlow 0 16) 13) anon104_Else_correct)))))
(let ((anon103_Then_correct  (=> (select g1@@8 n$2_27) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_29364_29365 QPMask@1 n$2_27 next)) (=> (HasDirectPerm_29364_29365 QPMask@1 n$2_27 next) (and (=> (= (ControlFlow 0 14) 11) anon104_Then_correct) (=> (= (ControlFlow 0 14) 13) anon104_Else_correct)))))))
(let ((anon101_Else_correct  (and (=> (= (ControlFlow 0 153) (- 0 154)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@8 n$1_1)) (select g1@@8 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_1@@1 next))
)) (forall ((o_4@@17 T@Ref) ) (!  (=> (and (and (select g1@@8 (invRecv47 o_4@@17)) (< NoPerm FullPerm)) (qpRange47 o_4@@17)) (= (invRecv47 o_4@@17) o_4@@17))
 :qid |stdinbpl.3863:22|
 :skolemid |422|
 :pattern ( (invRecv47 o_4@@17))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_1@@2 next))
)) (forall ((o_4@@18 T@Ref) ) (!  (and (=> (and (and (select g1@@8 (invRecv47 o_4@@18)) (< NoPerm FullPerm)) (qpRange47 o_4@@18)) (and (=> (< NoPerm FullPerm) (= (invRecv47 o_4@@18) o_4@@18)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@18 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@18 next) FullPerm)))) (=> (not (and (and (select g1@@8 (invRecv47 o_4@@18)) (< NoPerm FullPerm)) (qpRange47 o_4@@18))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@18 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@18 next))))
 :qid |stdinbpl.3875:22|
 :skolemid |424|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@18 next))
)))) (=> (and (and (and (and (forall ((o_4@@19 T@Ref) (f_5@@7 T@Field_46438_53) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@0) o_4@@19 f_5@@7) (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@1) o_4@@19 f_5@@7)))
 :qid |stdinbpl.3879:29|
 :skolemid |425|
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@0) o_4@@19 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@1) o_4@@19 f_5@@7))
)) (forall ((o_4@@20 T@Ref) (f_5@@8 T@Field_46451_46452) ) (!  (=> (not (= f_5@@8 next)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@20 f_5@@8) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@20 f_5@@8)))
 :qid |stdinbpl.3879:29|
 :skolemid |425|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@20 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@20 f_5@@8))
))) (forall ((o_4@@21 T@Ref) (f_5@@9 T@Field_29364_147463) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@0) o_4@@21 f_5@@9) (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@1) o_4@@21 f_5@@9)))
 :qid |stdinbpl.3879:29|
 :skolemid |425|
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@0) o_4@@21 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@1) o_4@@21 f_5@@9))
))) (forall ((o_4@@22 T@Ref) (f_5@@10 T@Field_29364_147596) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@0) o_4@@22 f_5@@10) (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@1) o_4@@22 f_5@@10)))
 :qid |stdinbpl.3879:29|
 :skolemid |425|
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@0) o_4@@22 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@1) o_4@@22 f_5@@10))
...
(let ((anon100_Else_correct  (=> (and (not (and (select g0@@8 n$0_30) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_30 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon100_Then_correct  (=> (and (select g0@@8 n$0_30) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_30 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29364_29365 QPMask@0 n$0_30 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_30 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon99_Else_correct  (=> (not (select g0@@8 n$0_30)) (and (=> (= (ControlFlow 0 8) 3) anon100_Then_correct) (=> (= (ControlFlow 0 8) 5) anon100_Else_correct)))))
(let ((anon99_Then_correct  (=> (select g0@@8 n$0_30) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29364_29365 QPMask@0 n$0_30 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_30 next) (and (=> (= (ControlFlow 0 6) 3) anon100_Then_correct) (=> (= (ControlFlow 0 6) 5) anon100_Else_correct)))))))
(let ((anon97_Else_correct  (and (=> (= (ControlFlow 0 156) (- 0 157)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@8 n_1)) (select g0@@8 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_1@@1 next))
)) (forall ((o_4@@23 T@Ref) ) (!  (=> (and (and (select g0@@8 (invRecv46 o_4@@23)) (< NoPerm FullPerm)) (qpRange46 o_4@@23)) (= (invRecv46 o_4@@23) o_4@@23))
 :qid |stdinbpl.3806:22|
 :skolemid |415|
 :pattern ( (invRecv46 o_4@@23))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_1@@2 next))
)) (forall ((o_4@@24 T@Ref) ) (!  (and (=> (and (and (select g0@@8 (invRecv46 o_4@@24)) (< NoPerm FullPerm)) (qpRange46 o_4@@24)) (and (=> (< NoPerm FullPerm) (= (invRecv46 o_4@@24) o_4@@24)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@24 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@24 next) FullPerm)))) (=> (not (and (and (select g0@@8 (invRecv46 o_4@@24)) (< NoPerm FullPerm)) (qpRange46 o_4@@24))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@24 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@24 next))))
 :qid |stdinbpl.3818:22|
 :skolemid |417|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@24 next))
)))) (=> (and (and (and (and (forall ((o_4@@25 T@Ref) (f_5@@11 T@Field_46438_53) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| ZeroMask) o_4@@25 f_5@@11) (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@0) o_4@@25 f_5@@11)))
 :qid |stdinbpl.3822:29|
 :skolemid |418|
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| ZeroMask) o_4@@25 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@0) o_4@@25 f_5@@11))
)) (forall ((o_4@@26 T@Ref) (f_5@@12 T@Field_46451_46452) ) (!  (=> (not (= f_5@@12 next)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@26 f_5@@12) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@26 f_5@@12)))
 :qid |stdinbpl.3822:29|
 :skolemid |418|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@26 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@26 f_5@@12))
))) (forall ((o_4@@27 T@Ref) (f_5@@13 T@Field_29364_147463) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| ZeroMask) o_4@@27 f_5@@13) (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@0) o_4@@27 f_5@@13)))
 :qid |stdinbpl.3822:29|
 :skolemid |418|
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| ZeroMask) o_4@@27 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@0) o_4@@27 f_5@@13))
))) (forall ((o_4@@28 T@Ref) (f_5@@14 T@Field_29364_147596) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| ZeroMask) o_4@@28 f_5@@14) (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@0) o_4@@28 f_5@@14)))
 :qid |stdinbpl.3822:29|
 :skolemid |418|
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| ZeroMask) o_4@@28 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@0) o_4@@28 f_5@@14))
...
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_46378_28668_53#PolymorphicMapType_46378| Heap@@33) x0 $allocated)) (and (select (|PolymorphicMapType_46378_28668_53#PolymorphicMapType_46378| Heap@@33) x1_2 $allocated) (not (select g0@@8 null)))) (and (=> (= (ControlFlow 0 158) 1) anon97_Then_correct) (=> (= (ControlFlow 0 158) 156) anon97_Else_correct))))))
