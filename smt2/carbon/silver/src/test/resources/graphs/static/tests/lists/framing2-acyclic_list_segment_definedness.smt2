...
(let ((anon18_Else_correct  (=> (and (forall ((n$0_3 T@Ref) ) (!  (=> (and (select g_1@@10 n$0_3) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_3 next) null))) (select g_1@@10 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_3 next)))
 :qid |stdinbpl.1180:20|
 :skolemid |150|
 :pattern ( (select g_1@@10 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_3 next)))
 :pattern ( (select g_1@@10 n$0_3) (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_3 next))
...
(let ((anon20_Else_correct  (=> (and (not (and (select g_1@@10 n$0_15) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_15 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (select g_1@@10 n$0_15) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_15 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29364_29365 QPMask@0 n$0_15 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_15 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon19_Else_correct  (=> (not (select g_1@@10 n$0_15)) (and (=> (= (ControlFlow 0 8) 3) anon20_Then_correct) (=> (= (ControlFlow 0 8) 5) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (select g_1@@10 n$0_15) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29364_29365 QPMask@0 n$0_15 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_15 next) (and (=> (= (ControlFlow 0 6) 3) anon20_Then_correct) (=> (= (ControlFlow 0 6) 5) anon20_Else_correct)))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((n_4 T@Ref) (n_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4 n_4_1)) (select g_1@@10 n_4)) (select g_1@@10 n_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1)))
 :qid |stdinbpl.1135:15|
 :skolemid |144|
))) (=> (forall ((n_4@@0 T@Ref) (n_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4@@0 n_4_1@@0)) (select g_1@@10 n_4@@0)) (select g_1@@10 n_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4@@0 n_4_1@@0)))
 :qid |stdinbpl.1135:15|
 :skolemid |144|
)) (=> (and (and (forall ((n_4@@1 T@Ref) ) (!  (=> (and (select g_1@@10 n_4@@1) (< NoPerm FullPerm)) (and (qpRange4 n_4@@1) (= (invRecv4 n_4@@1) n_4@@1)))
 :qid |stdinbpl.1141:22|
 :skolemid |145|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1@@10 (invRecv4 o_9)) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (invRecv4 o_9) o_9))
 :qid |stdinbpl.1145:22|
 :skolemid |146|
 :pattern ( (invRecv4 o_9))
))) (and (forall ((n_4@@2 T@Ref) ) (!  (=> (select g_1@@10 n_4@@2) (not (= n_4@@2 null)))
 :qid |stdinbpl.1151:22|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) n_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_4@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1@@10 (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1@@10 (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_9@@0 next))))
