...
(assert (not
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n_3@@3 car))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (select g_1 (invRecv9 o_9)) (and (< NoPerm FullPerm) (qpRange9 o_9))) (= (invRecv9 o_9) o_9))
 :qid |stdinbpl.1262:30|
 :skolemid |158|
 :pattern ( (invRecv9 o_9))
))) (and (=> (= (ControlFlow 0 293) (- 0 294)) (forall ((n$0_3 T@Ref) (n$0_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_3 n$0_3_1)) (select g_1 n$0_3)) (select g_1 n$0_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_3 n$0_3_1)))
...
)) (=> (= (ControlFlow 0 293) (- 0 292)) (forall ((n$0_3@@1 T@Ref) ) (!  (=> (select g_1 n$0_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@35) n$0_3@@1 cdr) NoPerm)))
 :qid |stdinbpl.1280:25|
 :skolemid |160|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$0_3@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@37) n$0_3@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$0_3@@1 cdr))
))))))))))))
(let ((anon35_correct true))
(let ((anon191_Then_correct  (=> (select g_1 v_6) (and (=> (= (ControlFlow 0 297) 293) anon192_Then_correct) (=> (= (ControlFlow 0 297) 290) anon35_correct)))))
(let ((anon191_Else_correct  (=> (and (not (select g_1 v_6)) (= (ControlFlow 0 291) 290)) anon35_correct)))
...
(let ((anon189_Then_correct  (and (=> (= (ControlFlow 0 283) (- 0 286)) (forall ((n_2 T@Ref) (n_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_2 n_2_1)) (select g_1 n_2)) (select g_1 n_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n_2@@3 car))
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (select g_1 (invRecv7 o_9@@0)) (and (< NoPerm FullPerm) (qpRange7 o_9@@0))) (= (invRecv7 o_9@@0) o_9@@0))
 :qid |stdinbpl.1181:32|
 :skolemid |149|
 :pattern ( (invRecv7 o_9@@0))
))) (and (=> (= (ControlFlow 0 283) (- 0 284)) (forall ((n$0_2 T@Ref) (n$0_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_2 n$0_2_1)) (select g_1 n$0_2)) (select g_1 n$0_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_2 n$0_2_1)))
...
)) (=> (= (ControlFlow 0 283) (- 0 282)) (forall ((n$0_2@@1 T@Ref) ) (!  (=> (select g_1 n$0_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@35) n$0_2@@1 cdr) NoPerm)))
 :qid |stdinbpl.1199:27|
 :skolemid |151|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$0_2@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@39) n$0_2@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$0_2@@1 cdr))
))))))))))))
(let ((anon30_correct true))
(let ((anon188_Then_correct  (=> (select marked v_5) (and (=> (= (ControlFlow 0 287) 283) anon189_Then_correct) (=> (= (ControlFlow 0 287) 279) anon30_correct)))))
(let ((anon188_Else_correct  (=> (and (not (select marked v_5)) (= (ControlFlow 0 281) 279)) anon30_correct)))
(let ((anon187_Then_correct  (=> (select g_1 v_5) (and (=> (= (ControlFlow 0 288) 287) anon188_Then_correct) (=> (= (ControlFlow 0 288) 281) anon188_Else_correct)))))
(let ((anon187_Else_correct  (=> (and (not (select g_1 v_5)) (= (ControlFlow 0 280) 279)) anon30_correct)))
(let ((anon184_Else_correct  (=> (forall ((n$4_1 T@Ref) ) (!  (=> (select g_1 n$4_1) (select g_1 (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$4_1 cdr)))
 :qid |stdinbpl.1142:20|
 :skolemid |145|
 :pattern ( (select g_1 (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$4_1 cdr)))
 :pattern ( (select g_1 n$4_1) (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$4_1 cdr))
...
(let ((anon185_Else_correct  (=> (and (not (select g_1 n$4_13)) (= (ControlFlow 0 278) 275)) anon24_correct)))
(let ((anon185_Then_correct  (=> (select g_1 n$4_13) (and (=> (= (ControlFlow 0 276) (- 0 277)) (HasDirectPerm_18763_18764 QPMask@35 n$4_13 cdr)) (=> (HasDirectPerm_18763_18764 QPMask@35 n$4_13 cdr) (=> (= (ControlFlow 0 276) 275) anon24_correct))))))
(let ((anon182_Else_correct  (=> (forall ((n$3_1 T@Ref) ) (!  (=> (select g_1 n$3_1) (select g_1 (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$3_1 car)))
 :qid |stdinbpl.1129:20|
 :skolemid |144|
 :pattern ( (select g_1 (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$3_1 car)))
 :pattern ( (select g_1 n$3_1) (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$3_1 car))
...
(let ((anon181_Else_correct  (and (=> (= (ControlFlow 0 301) (- 0 302)) (forall ((n$6_1 T@Ref) (n$6_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$6_1 n$6_1_1)) (select g_1 n$6_1)) (select g_1 n$6_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$6_1 n$6_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$6_1@@1 cdr))
)) (forall ((o_9@@1 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv6 o_9@@1)) (< NoPerm FullPerm)) (qpRange6 o_9@@1)) (= (invRecv6 o_9@@1) o_9@@1))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$6_1@@2 cdr))
)) (forall ((o_9@@2 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv6 o_9@@2)) (< NoPerm FullPerm)) (qpRange6 o_9@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_9@@2) o_9@@2)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@35) o_9@@2 cdr) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@34) o_9@@2 cdr) FullPerm)))) (=> (not (and (and (select g_1 (invRecv6 o_9@@2)) (< NoPerm FullPerm)) (qpRange6 o_9@@2))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@35) o_9@@2 cdr) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@34) o_9@@2 cdr))))
 :qid |stdinbpl.1110:22|
 :skolemid |142|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@35) o_9@@2 cdr))
)))) (=> (and (and (and (and (forall ((o_9@@3 T@Ref) (f_5 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@34) o_9@@3 f_5) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@35) o_9@@3 f_5)))
 :qid |stdinbpl.1114:29|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@34) o_9@@3 f_5))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@35) o_9@@3 f_5))
)) (forall ((o_9@@4 T@Ref) (f_5@@0 T@Field_28338_28339) ) (!  (=> (not (= f_5@@0 cdr)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@34) o_9@@4 f_5@@0) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@35) o_9@@4 f_5@@0)))
 :qid |stdinbpl.1114:29|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@34) o_9@@4 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@35) o_9@@4 f_5@@0))
))) (forall ((o_9@@5 T@Ref) (f_5@@1 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@34) o_9@@5 f_5@@1) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@35) o_9@@5 f_5@@1)))
 :qid |stdinbpl.1114:29|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@34) o_9@@5 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@35) o_9@@5 f_5@@1))
))) (forall ((o_9@@6 T@Ref) (f_5@@2 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@34) o_9@@6 f_5@@2) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@35) o_9@@6 f_5@@2)))
 :qid |stdinbpl.1114:29|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@34) o_9@@6 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@35) o_9@@6 f_5@@2))
...
(let ((anon180_Else_correct  (and (=> (= (ControlFlow 0 303) (- 0 304)) (forall ((n$5_1 T@Ref) (n$5_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$5_1 n$5_1_1)) (select g_1 n$5_1)) (select g_1 n$5_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$5_1 n$5_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$5_1@@1 car))
)) (forall ((o_9@@7 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv5 o_9@@7)) (< NoPerm FullPerm)) (qpRange5 o_9@@7)) (= (invRecv5 o_9@@7) o_9@@7))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| PostHeap@0) n$5_1@@2 car))
)) (forall ((o_9@@8 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv5 o_9@@8)) (< NoPerm FullPerm)) (qpRange5 o_9@@8)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_9@@8) o_9@@8)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@34) o_9@@8 car) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@8 car) FullPerm)))) (=> (not (and (and (select g_1 (invRecv5 o_9@@8)) (< NoPerm FullPerm)) (qpRange5 o_9@@8))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@34) o_9@@8 car) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@8 car))))
 :qid |stdinbpl.1071:22|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@34) o_9@@8 car))
)))) (=> (and (and (and (and (forall ((o_9@@9 T@Ref) (f_5@@3 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| ZeroMask) o_9@@9 f_5@@3) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@34) o_9@@9 f_5@@3)))
 :qid |stdinbpl.1075:29|
 :skolemid |137|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| ZeroMask) o_9@@9 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@34) o_9@@9 f_5@@3))
)) (forall ((o_9@@10 T@Ref) (f_5@@4 T@Field_28338_28339) ) (!  (=> (not (= f_5@@4 car)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@10 f_5@@4) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@34) o_9@@10 f_5@@4)))
 :qid |stdinbpl.1075:29|
 :skolemid |137|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@10 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@34) o_9@@10 f_5@@4))
))) (forall ((o_9@@11 T@Ref) (f_5@@5 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| ZeroMask) o_9@@11 f_5@@5) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@34) o_9@@11 f_5@@5)))
 :qid |stdinbpl.1075:29|
 :skolemid |137|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| ZeroMask) o_9@@11 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@34) o_9@@11 f_5@@5))
))) (forall ((o_9@@12 T@Ref) (f_5@@6 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| ZeroMask) o_9@@12 f_5@@6) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@34) o_9@@12 f_5@@6)))
 :qid |stdinbpl.1075:29|
 :skolemid |137|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| ZeroMask) o_9@@12 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@34) o_9@@12 f_5@@6))
...
(let ((anon213_Then_correct  (and (=> (= (ControlFlow 0 225) (- 0 228)) (forall ((n_11_2 T@Ref) (n_11_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_2 n_11_3)) (select g_1 n_11_2)) (select g_1 n_11_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_2 n_11_3)))
 :qid |stdinbpl.1774:29|
 :skolemid |214|
 :pattern ( (neverTriggered21 n_11_2) (neverTriggered21 n_11_3))
 ...
 :qid |stdinbpl.1774:29|
 :skolemid |214|
 :pattern ( (neverTriggered21 n_11_2@@0) (neverTriggered21 n_11_3@@0))
)) (and (=> (= (ControlFlow 0 225) (- 0 227)) (forall ((n_11_2@@1 T@Ref) ) (!  (=> (select g_1 n_11_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n_11_2@@1 car) NoPerm)))
 :qid |stdinbpl.1781:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_11_2@@1 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@20) n_11_2@@1 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_11_2@@1 car))
))) (=> (forall ((n_11_2@@2 T@Ref) ) (!  (=> (select g_1 n_11_2@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n_11_2@@2 car) NoPerm)))
 :qid |stdinbpl.1781:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_11_2@@2 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@20) n_11_2@@2 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_11_2@@2 car))
)) (=> (and (forall ((n_11_2@@3 T@Ref) ) (!  (=> (and (select g_1 n_11_2@@3) (< NoPerm FullPerm)) (and (qpRange21 n_11_2@@3) (= (invRecv21 n_11_2@@3) n_11_2@@3)))
 :qid |stdinbpl.1787:34|
 :skolemid |216|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_11_2@@3 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@20) n_11_2@@3 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_11_2@@3 car))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (select g_1 (invRecv21 o_9@@13)) (and (< NoPerm FullPerm) (qpRange21 o_9@@13))) (= (invRecv21 o_9@@13) o_9@@13))
...
(let ((anon215_Then_correct  (and (=> (= (ControlFlow 0 216) (- 0 219)) (forall ((n_12 T@Ref) (n_12_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12 n_12_1)) (select g_1 n_12)) (select g_1 n_12_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12 n_12_1)))
...
)) (and (=> (= (ControlFlow 0 216) (- 0 218)) (forall ((n_12@@1 T@Ref) ) (!  (=> (select g_1 n_12@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n_12@@1 car) NoPerm)))
 :qid |stdinbpl.1857:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_12@@1 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@22) n_12@@1 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_12@@1 car))
))) (=> (forall ((n_12@@2 T@Ref) ) (!  (=> (select g_1 n_12@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n_12@@2 car) NoPerm)))
 :qid |stdinbpl.1857:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_12@@2 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@22) n_12@@2 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_12@@2 car))
)) (=> (and (forall ((n_12@@3 T@Ref) ) (!  (=> (and (select g_1 n_12@@3) (< NoPerm FullPerm)) (and (qpRange23 n_12@@3) (= (invRecv23 n_12@@3) n_12@@3)))
 :qid |stdinbpl.1863:34|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_12@@3 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@22) n_12@@3 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_12@@3 car))
)) (forall ((o_9@@14 T@Ref) ) (!  (=> (and (select g_1 (invRecv23 o_9@@14)) (and (< NoPerm FullPerm) (qpRange23 o_9@@14))) (= (invRecv23 o_9@@14) o_9@@14))
 :qid |stdinbpl.1867:34|
 :skolemid |225|
 :pattern ( (invRecv23 o_9@@14))
))) (and (=> (= (ControlFlow 0 216) (- 0 217)) (forall ((n$0_7 T@Ref) (n$0_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_7 n$0_7_1)) (select g_1 n$0_7)) (select g_1 n$0_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_7 n$0_7_1)))
...
(let ((anon211_Then_correct  (and (=> (= (ControlFlow 0 210) (- 0 213)) (forall ((n_10_1 T@Ref) (n_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_10_1 n_10_2)) (select g_1 n_10_1)) (select g_1 n_10_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_10_1 n_10_2)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_10_1@@3 car))
)) (forall ((o_9@@15 T@Ref) ) (!  (=> (and (select g_1 (invRecv19 o_9@@15)) (and (< NoPerm FullPerm) (qpRange19 o_9@@15))) (= (invRecv19 o_9@@15) o_9@@15))
 :qid |stdinbpl.1723:32|
 :skolemid |209|
 :pattern ( (invRecv19 o_9@@15))
))) (and (=> (= (ControlFlow 0 210) (- 0 211)) (forall ((n$0_5 T@Ref) (n$0_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5 n$0_5_1)) (select g_1 n$0_5)) (select g_1 n$0_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5 n$0_5_1)))
...
(let ((anon219_Then_correct  (and (=> (= (ControlFlow 0 196) (- 0 199)) (forall ((n_14_1 T@Ref) (n_14_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_14_1 n_14_2)) (select g_1 n_14_1)) (select g_1 n_14_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_14_1 n_14_2)))
 :qid |stdinbpl.1999:29|
 :skolemid |238|
 :pattern ( (neverTriggered27 n_14_1) (neverTriggered27 n_14_2))
))) (=> (forall ((n_14_1@@0 T@Ref) (n_14_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_14_1@@0 n_14_2@@0)) (select g_1 n_14_1@@0)) (select g_1 n_14_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_14_1@@0 n_14_2@@0)))
 :qid |stdinbpl.1999:29|
 :skolemid |238|
 :pattern ( (neverTriggered27 n_14_1@@0) (neverTriggered27 n_14_2@@0))
)) (and (=> (= (ControlFlow 0 196) (- 0 198)) (forall ((n_14_1@@1 T@Ref) ) (!  (=> (select g_1 n_14_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n_14_1@@1 car) NoPerm)))
 :qid |stdinbpl.2006:29|
 :skolemid |239|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_14_1@@1 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@26) n_14_1@@1 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_14_1@@1 car))
))) (=> (forall ((n_14_1@@2 T@Ref) ) (!  (=> (select g_1 n_14_1@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n_14_1@@2 car) NoPerm)))
 :qid |stdinbpl.2006:29|
 :skolemid |239|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_14_1@@2 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@26) n_14_1@@2 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_14_1@@2 car))
)) (=> (and (forall ((n_14_1@@3 T@Ref) ) (!  (=> (and (select g_1 n_14_1@@3) (< NoPerm FullPerm)) (and (qpRange27 n_14_1@@3) (= (invRecv27 n_14_1@@3) n_14_1@@3)))
 :qid |stdinbpl.2012:34|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_14_1@@3 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@26) n_14_1@@3 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_14_1@@3 car))
)) (forall ((o_9@@16 T@Ref) ) (!  (=> (and (select g_1 (invRecv27 o_9@@16)) (and (< NoPerm FullPerm) (qpRange27 o_9@@16))) (= (invRecv27 o_9@@16) o_9@@16))
 :qid |stdinbpl.2016:34|
 :skolemid |241|
 :pattern ( (invRecv27 o_9@@16))
))) (and (=> (= (ControlFlow 0 196) (- 0 197)) (forall ((n$0_9 T@Ref) (n$0_9_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_9 n$0_9_1)) (select g_1 n$0_9)) (select g_1 n$0_9_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_9 n$0_9_1)))
...
(let ((anon221_Then_correct  (and (=> (= (ControlFlow 0 187) (- 0 190)) (forall ((n_15 T@Ref) (n_15_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_15 n_15_1)) (select g_1 n_15)) (select g_1 n_15_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_15 n_15_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_15@@3 car))
)) (forall ((o_9@@17 T@Ref) ) (!  (=> (and (select g_1 (invRecv29 o_9@@17)) (and (< NoPerm FullPerm) (qpRange29 o_9@@17))) (= (invRecv29 o_9@@17) o_9@@17))
 :qid |stdinbpl.2092:34|
 :skolemid |249|
 :pattern ( (invRecv29 o_9@@17))
))) (and (=> (= (ControlFlow 0 187) (- 0 188)) (forall ((n$0_10_1 T@Ref) (n$0_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_10_1 n$0_10_2)) (select g_1 n$0_10_1)) (select g_1 n$0_10_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_10_1 n$0_10_2)))
 :qid |stdinbpl.2103:29|
 :skolemid |250|
 :pattern ( (neverTriggered30 n$0_10_1) (neverTriggered30 n$0_10_2))
))) (=> (forall ((n$0_10_1@@0 T@Ref) (n$0_10_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_10_1@@0 n$0_10_2@@0)) (select g_1 n$0_10_1@@0)) (select g_1 n$0_10_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_10_1@@0 n$0_10_2@@0)))
 :qid |stdinbpl.2103:29|
 :skolemid |250|
 :pattern ( (neverTriggered30 n$0_10_1@@0) (neverTriggered30 n$0_10_2@@0))
)) (=> (= (ControlFlow 0 187) (- 0 186)) (forall ((n$0_10_1@@1 T@Ref) ) (!  (=> (select g_1 n$0_10_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n$0_10_1@@1 cdr) NoPerm)))
 :qid |stdinbpl.2110:29|
 :skolemid |251|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_10_1@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@29) n$0_10_1@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_10_1@@1 cdr))
))))))))))))
(let ((anon217_Then_correct  (and (=> (= (ControlFlow 0 181) (- 0 184)) (forall ((n_13_2 T@Ref) (n_13_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13_2 n_13_3)) (select g_1 n_13_2)) (select g_1 n_13_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13_2 n_13_3)))
 :qid |stdinbpl.1931:27|
 :skolemid |230|
 :pattern ( (neverTriggered25 n_13_2) (neverTriggered25 n_13_3))
))) (=> (forall ((n_13_2@@0 T@Ref) (n_13_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13_2@@0 n_13_3@@0)) (select g_1 n_13_2@@0)) (select g_1 n_13_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13_2@@0 n_13_3@@0)))
 :qid |stdinbpl.1931:27|
 :skolemid |230|
 :pattern ( (neverTriggered25 n_13_2@@0) (neverTriggered25 n_13_3@@0))
)) (and (=> (= (ControlFlow 0 181) (- 0 183)) (forall ((n_13_2@@1 T@Ref) ) (!  (=> (select g_1 n_13_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n_13_2@@1 car) NoPerm)))
 :qid |stdinbpl.1938:27|
 :skolemid |231|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_13_2@@1 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@24) n_13_2@@1 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_13_2@@1 car))
))) (=> (forall ((n_13_2@@2 T@Ref) ) (!  (=> (select g_1 n_13_2@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n_13_2@@2 car) NoPerm)))
 :qid |stdinbpl.1938:27|
 :skolemid |231|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_13_2@@2 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@24) n_13_2@@2 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_13_2@@2 car))
)) (=> (and (forall ((n_13_2@@3 T@Ref) ) (!  (=> (and (select g_1 n_13_2@@3) (< NoPerm FullPerm)) (and (qpRange25 n_13_2@@3) (= (invRecv25 n_13_2@@3) n_13_2@@3)))
 :qid |stdinbpl.1944:32|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_13_2@@3 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@24) n_13_2@@3 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_13_2@@3 car))
)) (forall ((o_9@@18 T@Ref) ) (!  (=> (and (select g_1 (invRecv25 o_9@@18)) (and (< NoPerm FullPerm) (qpRange25 o_9@@18))) (= (invRecv25 o_9@@18) o_9@@18))
 :qid |stdinbpl.1948:32|
 :skolemid |233|
 :pattern ( (invRecv25 o_9@@18))
...
(let ((anon236_Then_correct  (and (=> (= (ControlFlow 0 166) (- 0 169)) (forall ((n_27 T@Ref) (n_27_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_27 n_27_1)) (select g_1 n_27)) (select g_1 n_27_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_27 n_27_1)))
...
)) (and (=> (= (ControlFlow 0 166) (- 0 168)) (forall ((n_27@@1 T@Ref) ) (!  (=> (select g_1 n_27@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n_27@@1 car) NoPerm)))
 :qid |stdinbpl.2268:37|
 :skolemid |269|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_27@@1 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@30) n_27@@1 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_27@@1 car))
))) (=> (forall ((n_27@@2 T@Ref) ) (!  (=> (select g_1 n_27@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n_27@@2 car) NoPerm)))
 :qid |stdinbpl.2268:37|
 :skolemid |269|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_27@@2 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@30) n_27@@2 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_27@@2 car))
)) (=> (and (forall ((n_27@@3 T@Ref) ) (!  (=> (and (select g_1 n_27@@3) (< NoPerm FullPerm)) (and (qpRange33 n_27@@3) (= (invRecv33 n_27@@3) n_27@@3)))
 :qid |stdinbpl.2274:42|
 :skolemid |270|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_27@@3 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@30) n_27@@3 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_27@@3 car))
)) (forall ((o_9@@19 T@Ref) ) (!  (=> (and (select g_1 (invRecv33 o_9@@19)) (and (< NoPerm FullPerm) (qpRange33 o_9@@19))) (= (invRecv33 o_9@@19) o_9@@19))
 :qid |stdinbpl.2278:42|
 :skolemid |271|
 :pattern ( (invRecv33 o_9@@19))
))) (and (=> (= (ControlFlow 0 166) (- 0 167)) (forall ((n$0_13_1 T@Ref) (n$0_13_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_13_1 n$0_13_2)) (select g_1 n$0_13_1)) (select g_1 n$0_13_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_13_1 n$0_13_2)))
 :qid |stdinbpl.2289:37|
 :skolemid |272|
 :pattern ( (neverTriggered34 n$0_13_1) (neverTriggered34 n$0_13_2))
))) (=> (forall ((n$0_13_1@@0 T@Ref) (n$0_13_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_13_1@@0 n$0_13_2@@0)) (select g_1 n$0_13_1@@0)) (select g_1 n$0_13_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_13_1@@0 n$0_13_2@@0)))
 :qid |stdinbpl.2289:37|
 :skolemid |272|
 :pattern ( (neverTriggered34 n$0_13_1@@0) (neverTriggered34 n$0_13_2@@0))
)) (=> (= (ControlFlow 0 166) (- 0 165)) (forall ((n$0_13_1@@1 T@Ref) ) (!  (=> (select g_1 n$0_13_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n$0_13_1@@1 cdr) NoPerm)))
 :qid |stdinbpl.2296:37|
 :skolemid |273|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_13_1@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@31) n$0_13_1@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_13_1@@1 cdr))
))))))))))))
(let ((anon112_correct true))
(let ((anon235_Then_correct  (=> (and (select marked@1 n1_1) (and (select g_1 n2_1) (and (not (select marked@1 n2_1)) (not (select pending@0 n2_1))))) (and (=> (= (ControlFlow 0 170) 166) anon236_Then_correct) (=> (= (ControlFlow 0 170) 163) anon112_correct)))))
(let ((anon235_Else_correct  (=> (and (not (and (select marked@1 n1_1) (and (select g_1 n2_1) (and (not (select marked@1 n2_1)) (not (select pending@0 n2_1)))))) (= (ControlFlow 0 164) 163)) anon112_correct)))
(let ((anon232_Then_correct  (and (=> (= (ControlFlow 0 158) (- 0 161)) (forall ((n$0_11_2 T@Ref) (n$0_11_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_11_2 n$0_11_3)) (select g_1 n$0_11_2)) (select g_1 n$0_11_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_11_2 n$0_11_3)))
 :qid |stdinbpl.2185:35|
 :skolemid |259|
 :pattern ( (neverTriggered31 n$0_11_2) (neverTriggered31 n$0_11_3))
))) (=> (forall ((n$0_11_2@@0 T@Ref) (n$0_11_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_11_2@@0 n$0_11_3@@0)) (select g_1 n$0_11_2@@0)) (select g_1 n$0_11_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_11_2@@0 n$0_11_3@@0)))
 :qid |stdinbpl.2185:35|
 :skolemid |259|
 :pattern ( (neverTriggered31 n$0_11_2@@0) (neverTriggered31 n$0_11_3@@0))
)) (and (=> (= (ControlFlow 0 158) (- 0 160)) (forall ((n$0_11_2@@1 T@Ref) ) (!  (=> (select g_1 n$0_11_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n$0_11_2@@1 car) NoPerm)))
 :qid |stdinbpl.2192:35|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_11_2@@1 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@32) n$0_11_2@@1 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_11_2@@1 car))
))) (=> (forall ((n$0_11_2@@2 T@Ref) ) (!  (=> (select g_1 n$0_11_2@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n$0_11_2@@2 car) NoPerm)))
 :qid |stdinbpl.2192:35|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_11_2@@2 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@32) n$0_11_2@@2 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_11_2@@2 car))
)) (=> (and (forall ((n$0_11_2@@3 T@Ref) ) (!  (=> (and (select g_1 n$0_11_2@@3) (< NoPerm FullPerm)) (and (qpRange31 n$0_11_2@@3) (= (invRecv31 n$0_11_2@@3) n$0_11_2@@3)))
 :qid |stdinbpl.2198:40|
 :skolemid |261|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_11_2@@3 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@32) n$0_11_2@@3 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_11_2@@3 car))
)) (forall ((o_9@@20 T@Ref) ) (!  (=> (and (select g_1 (invRecv31 o_9@@20)) (and (< NoPerm FullPerm) (qpRange31 o_9@@20))) (= (invRecv31 o_9@@20) o_9@@20))
 :qid |stdinbpl.2202:40|
 :skolemid |262|
 :pattern ( (invRecv31 o_9@@20))
))) (and (=> (= (ControlFlow 0 158) (- 0 159)) (forall ((n$0_12_1 T@Ref) (n$0_12_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_12_1 n$0_12_2)) (select g_1 n$0_12_1)) (select g_1 n$0_12_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_12_1 n$0_12_2)))
 :qid |stdinbpl.2213:35|
 :skolemid |263|
 :pattern ( (neverTriggered32 n$0_12_1) (neverTriggered32 n$0_12_2))
))) (=> (forall ((n$0_12_1@@0 T@Ref) (n$0_12_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_12_1@@0 n$0_12_2@@0)) (select g_1 n$0_12_1@@0)) (select g_1 n$0_12_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_12_1@@0 n$0_12_2@@0)))
 :qid |stdinbpl.2213:35|
 :skolemid |263|
 :pattern ( (neverTriggered32 n$0_12_1@@0) (neverTriggered32 n$0_12_2@@0))
)) (=> (= (ControlFlow 0 158) (- 0 157)) (forall ((n$0_12_1@@1 T@Ref) ) (!  (=> (select g_1 n$0_12_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) n$0_12_1@@1 cdr) NoPerm)))
 :qid |stdinbpl.2220:35|
 :skolemid |264|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_12_1@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@33) n$0_12_1@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_12_1@@1 cdr))
))))))))))))
(let ((anon106_correct true))
(let ((anon231_Then_correct  (=> (or (select pending@0 n_81) (select marked@1 n_81)) (and (=> (= (ControlFlow 0 162) 158) anon232_Then_correct) (=> (= (ControlFlow 0 162) 155) anon106_correct)))))
(let ((anon231_Else_correct  (=> (and (not (or (select pending@0 n_81) (select marked@1 n_81))) (= (ControlFlow 0 156) 155)) anon106_correct)))
(let ((anon228_Then_correct true))
(let ((anon226_Then_correct true))
(let ((anon113_correct true))
(let ((anon233_Then_correct  (=> (forall ((n_26 T@Ref) ) (!  (=> (or (select pending@0 n_26) (select marked@1 n_26)) (exists_spath ($$ ExhaleHeap@0 g_1) roots n_26))
 :qid |stdinbpl.2244:29|
 :skolemid |267|
 :pattern ( (exists_spath (|$$#frame| (CombineFrames (FrameFragment_5097 (|$$#condqp1| ExhaleHeap@0 g_1)) (FrameFragment_5097 (|$$#condqp2| ExhaleHeap@0 g_1))) g_1) roots n_26))
...
(let ((anon233_Else_correct  (=> (and (not (forall ((n_26@@0 T@Ref) ) (!  (=> (or (select pending@0 n_26@@0) (select marked@1 n_26@@0)) (exists_spath ($$ ExhaleHeap@0 g_1) roots n_26@@0))
 :qid |stdinbpl.2244:29|
 :skolemid |267|
 :pattern ( (exists_spath (|$$#frame| (CombineFrames (FrameFragment_5097 (|$$#condqp1| ExhaleHeap@0 g_1)) (FrameFragment_5097 (|$$#condqp2| ExhaleHeap@0 g_1))) g_1) roots n_26@@0))
...
(let ((anon209_Then_correct  (and (=> (= (ControlFlow 0 143) (- 0 146)) (forall ((n_9 T@Ref) (n_9_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_9 n_9_1)) (select g_1 n_9)) (select g_1 n_9_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_9 n_9_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_9@@3 car))
)) (forall ((o_9@@21 T@Ref) ) (!  (=> (and (select g_1 (invRecv17 o_9@@21)) (and (< NoPerm FullPerm) (qpRange17 o_9@@21))) (= (invRecv17 o_9@@21) o_9@@21))
...
(let ((anon204_Else_correct  (and (=> (= (ControlFlow 0 239) (- 0 240)) (forall ((n$10_2 T@Ref) (n$10_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$10_2 n$10_2_1)) (select g_1 n$10_2)) (select g_1 n$10_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$10_2 n$10_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$10_2@@1 cdr))
)) (forall ((o_9@@22 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv16 o_9@@22)) (< NoPerm FullPerm)) (qpRange16 o_9@@22)) (= (invRecv16 o_9@@22) o_9@@22))
 :qid |stdinbpl.1560:26|
 :skolemid |192|
 :pattern ( (invRecv16 o_9@@22))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$10_2@@2 cdr))
)) (forall ((o_9@@23 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv16 o_9@@23)) (< NoPerm FullPerm)) (qpRange16 o_9@@23)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_9@@23) o_9@@23)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) o_9@@23 cdr) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@14) o_9@@23 cdr) FullPerm)))) (=> (not (and (and (select g_1 (invRecv16 o_9@@23)) (< NoPerm FullPerm)) (qpRange16 o_9@@23))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) o_9@@23 cdr) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@14) o_9@@23 cdr))))
 :qid |stdinbpl.1572:26|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) o_9@@23 cdr))
)))) (=> (and (and (and (and (forall ((o_9@@24 T@Ref) (f_5@@7 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@14) o_9@@24 f_5@@7) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@15) o_9@@24 f_5@@7)))
 :qid |stdinbpl.1576:33|
 :skolemid |195|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@14) o_9@@24 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@15) o_9@@24 f_5@@7))
)) (forall ((o_9@@25 T@Ref) (f_5@@8 T@Field_28338_28339) ) (!  (=> (not (= f_5@@8 cdr)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@14) o_9@@25 f_5@@8) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) o_9@@25 f_5@@8)))
 :qid |stdinbpl.1576:33|
 :skolemid |195|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@14) o_9@@25 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@15) o_9@@25 f_5@@8))
))) (forall ((o_9@@26 T@Ref) (f_5@@9 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@14) o_9@@26 f_5@@9) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@15) o_9@@26 f_5@@9)))
 :qid |stdinbpl.1576:33|
 :skolemid |195|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@14) o_9@@26 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@15) o_9@@26 f_5@@9))
))) (forall ((o_9@@27 T@Ref) (f_5@@10 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@14) o_9@@27 f_5@@10) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@15) o_9@@27 f_5@@10)))
 :qid |stdinbpl.1576:33|
 :skolemid |195|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@14) o_9@@27 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@15) o_9@@27 f_5@@10))
...
(let ((anon203_Else_correct  (and (=> (= (ControlFlow 0 241) (- 0 242)) (forall ((n$9_2 T@Ref) (n$9_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$9_2 n$9_2_1)) (select g_1 n$9_2)) (select g_1 n$9_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$9_2 n$9_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$9_2@@1 car))
)) (forall ((o_9@@28 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv15 o_9@@28)) (< NoPerm FullPerm)) (qpRange15 o_9@@28)) (= (invRecv15 o_9@@28) o_9@@28))
 :qid |stdinbpl.1521:26|
 :skolemid |186|
 :pattern ( (invRecv15 o_9@@28))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$9_2@@2 car))
)) (forall ((o_9@@29 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv15 o_9@@29)) (< NoPerm FullPerm)) (qpRange15 o_9@@29)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_9@@29) o_9@@29)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@14) o_9@@29 car) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@29 car) FullPerm)))) (=> (not (and (and (select g_1 (invRecv15 o_9@@29)) (< NoPerm FullPerm)) (qpRange15 o_9@@29))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@14) o_9@@29 car) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@29 car))))
 :qid |stdinbpl.1533:26|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@14) o_9@@29 car))
)))) (=> (and (and (and (and (forall ((o_9@@30 T@Ref) (f_5@@11 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@3) o_9@@30 f_5@@11) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@14) o_9@@30 f_5@@11)))
 :qid |stdinbpl.1537:33|
 :skolemid |189|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@3) o_9@@30 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@14) o_9@@30 f_5@@11))
)) (forall ((o_9@@31 T@Ref) (f_5@@12 T@Field_28338_28339) ) (!  (=> (not (= f_5@@12 car)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@31 f_5@@12) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@14) o_9@@31 f_5@@12)))
 :qid |stdinbpl.1537:33|
 :skolemid |189|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@31 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@14) o_9@@31 f_5@@12))
))) (forall ((o_9@@32 T@Ref) (f_5@@13 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@3) o_9@@32 f_5@@13) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@14) o_9@@32 f_5@@13)))
 :qid |stdinbpl.1537:33|
 :skolemid |189|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@3) o_9@@32 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@14) o_9@@32 f_5@@13))
))) (forall ((o_9@@33 T@Ref) (f_5@@14 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@3) o_9@@33 f_5@@14) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@14) o_9@@33 f_5@@14)))
 :qid |stdinbpl.1537:33|
 :skolemid |189|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@3) o_9@@33 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@14) o_9@@33 f_5@@14))
...
(let ((anon145_correct  (=> (= (ControlFlow 0 81) (- 0 80)) (or (and (forall ((n_38 T@Ref) ) (! (= (select roots n_38) (select pending@5 n_38))
 :qid |stdinbpl.2670:20|
 :skolemid |316|
 :pattern ( (select pending@5 n_38))
 :pattern ( (select roots n_38))
)) (forall ((n_39 T@Ref) ) (!  (=> (select g_1 n_39) (not (select marked@2 n_39)))
 :qid |stdinbpl.2673:22|
 :skolemid |317|
 :pattern ( (select marked@2 n_39))
))) (and (forall ((n_40 T@Ref) ) (!  (=> (select roots n_40) (or (select marked@2 n_40) (select pending@5 n_40)))
 :qid |stdinbpl.2676:24|
 :skolemid |318|
 :pattern ( (select pending@5 n_40))
 :pattern ( (select marked@2 n_40))
)) (and (forall ((n_41 T@Ref) ) (!  (=> (select g_1 n_41) (not (and (select marked@2 n_41) (select pending@5 n_41))))
 :qid |stdinbpl.2679:23|
 :skolemid |319|
 :pattern ( (select pending@5 n_41))
)) (and (forall ((n_42 T@Ref) ) (!  (=> (or (select pending@5 n_42) (select marked@2 n_42)) (exists_spath ($$ ExhaleHeap@0 g_1) roots n_42))
 :qid |stdinbpl.2682:23|
 :skolemid |320|
 :pattern ( (exists_spath (|$$#frame| (CombineFrames (FrameFragment_5097 (|$$#condqp1| ExhaleHeap@0 g_1)) (FrameFragment_5097 (|$$#condqp2| ExhaleHeap@0 g_1))) g_1) roots n_42))
...
(let ((anon131_correct  (=> (state ExhaleHeap@0 QPMask@5) (and (=> (= (ControlFlow 0 98) (- 0 103)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 98) (- 0 102)) (forall ((n$9_4 T@Ref) (n$9_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$9_4 n$9_4_1)) (select g_1 n$9_4)) (select g_1 n$9_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$9_4 n$9_4_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$9_4@@3 car))
)) (=> (and (forall ((o_9@@34 T@Ref) ) (!  (=> (and (select g_1 (invRecv37 o_9@@34)) (and (< NoPerm FullPerm) (qpRange37 o_9@@34))) (= (invRecv37 o_9@@34) o_9@@34))
 :qid |stdinbpl.2569:26|
 :skolemid |305|
 :pattern ( (invRecv37 o_9@@34))
)) (forall ((o_9@@35 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv37 o_9@@35)) (and (< NoPerm FullPerm) (qpRange37 o_9@@35))) (and (= (invRecv37 o_9@@35) o_9@@35) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@12) o_9@@35 car) (- (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@5) o_9@@35 car) FullPerm)))) (=> (not (and (select g_1 (invRecv37 o_9@@35)) (and (< NoPerm FullPerm) (qpRange37 o_9@@35)))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@12) o_9@@35 car) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@5) o_9@@35 car))))
 :qid |stdinbpl.2575:26|
 :skolemid |306|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@12) o_9@@35 car))
))) (=> (and (and (and (forall ((o_9@@36 T@Ref) (f_5@@15 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@5) o_9@@36 f_5@@15) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@12) o_9@@36 f_5@@15)))
 :qid |stdinbpl.2581:33|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@12) o_9@@36 f_5@@15))
)) (forall ((o_9@@37 T@Ref) (f_5@@16 T@Field_28338_28339) ) (!  (=> (not (= f_5@@16 car)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@5) o_9@@37 f_5@@16) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@12) o_9@@37 f_5@@16)))
 :qid |stdinbpl.2581:33|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@12) o_9@@37 f_5@@16))
))) (forall ((o_9@@38 T@Ref) (f_5@@17 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@5) o_9@@38 f_5@@17) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@12) o_9@@38 f_5@@17)))
 :qid |stdinbpl.2581:33|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@12) o_9@@38 f_5@@17))
))) (forall ((o_9@@39 T@Ref) (f_5@@18 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@5) o_9@@39 f_5@@18) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@12) o_9@@39 f_5@@18)))
 :qid |stdinbpl.2581:33|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@12) o_9@@39 f_5@@18))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$10_4@@3 cdr))
)) (=> (and (forall ((o_9@@40 T@Ref) ) (!  (=> (and (select g_1 (invRecv38 o_9@@40)) (and (< NoPerm FullPerm) (qpRange38 o_9@@40))) (= (invRecv38 o_9@@40) o_9@@40))
 :qid |stdinbpl.2610:26|
 :skolemid |311|
 :pattern ( (invRecv38 o_9@@40))
)) (forall ((o_9@@41 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv38 o_9@@41)) (and (< NoPerm FullPerm) (qpRange38 o_9@@41))) (and (= (invRecv38 o_9@@41) o_9@@41) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@13) o_9@@41 cdr) (- (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@12) o_9@@41 cdr) FullPerm)))) (=> (not (and (select g_1 (invRecv38 o_9@@41)) (and (< NoPerm FullPerm) (qpRange38 o_9@@41)))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@13) o_9@@41 cdr) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@12) o_9@@41 cdr))))
 :qid |stdinbpl.2616:26|
 :skolemid |312|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@13) o_9@@41 cdr))
))) (=> (and (and (and (forall ((o_9@@42 T@Ref) (f_5@@19 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@12) o_9@@42 f_5@@19) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@13) o_9@@42 f_5@@19)))
 :qid |stdinbpl.2622:33|
 :skolemid |313|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@13) o_9@@42 f_5@@19))
)) (forall ((o_9@@43 T@Ref) (f_5@@20 T@Field_28338_28339) ) (!  (=> (not (= f_5@@20 cdr)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@12) o_9@@43 f_5@@20) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@13) o_9@@43 f_5@@20)))
 :qid |stdinbpl.2622:33|
 :skolemid |313|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@13) o_9@@43 f_5@@20))
))) (forall ((o_9@@44 T@Ref) (f_5@@21 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@12) o_9@@44 f_5@@21) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@13) o_9@@44 f_5@@21)))
 :qid |stdinbpl.2622:33|
 :skolemid |313|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@13) o_9@@44 f_5@@21))
))) (forall ((o_9@@45 T@Ref) (f_5@@22 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@12) o_9@@45 f_5@@22) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@13) o_9@@45 f_5@@22)))
 :qid |stdinbpl.2622:33|
 :skolemid |313|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@13) o_9@@45 f_5@@22))
...
(let ((anon121_correct  (=> (state ExhaleHeap@0 QPMask@5) (=> (and (and (or (and (forall ((n_33 T@Ref) ) (! (= (select roots n_33) (select pending@0 n_33))
 :qid |stdinbpl.2450:25|
 :skolemid |296|
 :pattern ( (select pending@0 n_33))
 :pattern ( (select roots n_33))
)) (forall ((n_34_2 T@Ref) ) (!  (=> (select g_1 n_34_2) (not (select marked@1 n_34_2)))
 :qid |stdinbpl.2453:22|
 :skolemid |297|
 :pattern ( (select marked@1 n_34_2))
))) (and (forall ((n_35 T@Ref) ) (!  (=> (select roots n_35) (or (select marked@1 n_35) (select pending@0 n_35)))
 :qid |stdinbpl.2456:24|
 :skolemid |298|
 :pattern ( (select pending@0 n_35))
 :pattern ( (select marked@1 n_35))
)) (and (forall ((n_36 T@Ref) ) (!  (=> (select g_1 n_36) (not (and (select marked@1 n_36) (select pending@0 n_36))))
 :qid |stdinbpl.2459:23|
 :skolemid |299|
 :pattern ( (select pending@0 n_36))
)) (and (forall ((n_37 T@Ref) ) (!  (=> (or (select pending@0 n_37) (select marked@1 n_37)) (exists_spath ($$ ExhaleHeap@0 g_1) roots n_37))
 :qid |stdinbpl.2462:23|
 :skolemid |300|
 :pattern ( (exists_spath (|$$#frame| (CombineFrames (FrameFragment_5097 (|$$#condqp1| ExhaleHeap@0 g_1)) (FrameFragment_5097 (|$$#condqp2| ExhaleHeap@0 g_1))) g_1) roots n_37))
...
(let ((anon237_Then_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (not (select g_1 null))) (and (=> (= (ControlFlow 0 129) (- 0 131)) (forall ((n$9_3 T@Ref) (n$9_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$9_3 n$9_3_1)) (select g_1 n$9_3)) (select g_1 n$9_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$9_3 n$9_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$9_3@@1 car))
)) (forall ((o_9@@46 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv35 o_9@@46)) (< NoPerm FullPerm)) (qpRange35 o_9@@46)) (= (invRecv35 o_9@@46) o_9@@46))
 :qid |stdinbpl.2368:26|
 :skolemid |284|
 :pattern ( (invRecv35 o_9@@46))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$9_3@@2 car))
)) (forall ((o_9@@47 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv35 o_9@@47)) (< NoPerm FullPerm)) (qpRange35 o_9@@47)) (and (=> (< NoPerm FullPerm) (= (invRecv35 o_9@@47) o_9@@47)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@4) o_9@@47 car) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@47 car) FullPerm)))) (=> (not (and (and (select g_1 (invRecv35 o_9@@47)) (< NoPerm FullPerm)) (qpRange35 o_9@@47))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@4) o_9@@47 car) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@47 car))))
 :qid |stdinbpl.2380:26|
 :skolemid |286|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@4) o_9@@47 car))
)))) (=> (and (and (and (and (forall ((o_9@@48 T@Ref) (f_5@@23 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| ZeroMask) o_9@@48 f_5@@23) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@4) o_9@@48 f_5@@23)))
 :qid |stdinbpl.2384:33|
 :skolemid |287|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| ZeroMask) o_9@@48 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@4) o_9@@48 f_5@@23))
)) (forall ((o_9@@49 T@Ref) (f_5@@24 T@Field_28338_28339) ) (!  (=> (not (= f_5@@24 car)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@49 f_5@@24) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@4) o_9@@49 f_5@@24)))
 :qid |stdinbpl.2384:33|
 :skolemid |287|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@49 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@4) o_9@@49 f_5@@24))
))) (forall ((o_9@@50 T@Ref) (f_5@@25 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| ZeroMask) o_9@@50 f_5@@25) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@4) o_9@@50 f_5@@25)))
 :qid |stdinbpl.2384:33|
 :skolemid |287|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| ZeroMask) o_9@@50 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@4) o_9@@50 f_5@@25))
))) (forall ((o_9@@51 T@Ref) (f_5@@26 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| ZeroMask) o_9@@51 f_5@@26) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@4) o_9@@51 f_5@@26)))
 :qid |stdinbpl.2384:33|
 :skolemid |287|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| ZeroMask) o_9@@51 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@4) o_9@@51 f_5@@26))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$10_3@@1 cdr))
)) (forall ((o_9@@52 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv36 o_9@@52)) (< NoPerm FullPerm)) (qpRange36 o_9@@52)) (= (invRecv36 o_9@@52) o_9@@52))
 :qid |stdinbpl.2402:26|
 :skolemid |290|
 :pattern ( (invRecv36 o_9@@52))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$10_3@@2 cdr))
)) (forall ((o_9@@53 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv36 o_9@@53)) (< NoPerm FullPerm)) (qpRange36 o_9@@53)) (and (=> (< NoPerm FullPerm) (= (invRecv36 o_9@@53) o_9@@53)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@5) o_9@@53 cdr) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@4) o_9@@53 cdr) FullPerm)))) (=> (not (and (and (select g_1 (invRecv36 o_9@@53)) (< NoPerm FullPerm)) (qpRange36 o_9@@53))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@5) o_9@@53 cdr) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@4) o_9@@53 cdr))))
 :qid |stdinbpl.2414:26|
 :skolemid |292|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@5) o_9@@53 cdr))
)))) (=> (and (and (and (and (forall ((o_9@@54 T@Ref) (f_5@@27 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@4) o_9@@54 f_5@@27) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@5) o_9@@54 f_5@@27)))
 :qid |stdinbpl.2418:33|
 :skolemid |293|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@4) o_9@@54 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@5) o_9@@54 f_5@@27))
)) (forall ((o_9@@55 T@Ref) (f_5@@28 T@Field_28338_28339) ) (!  (=> (not (= f_5@@28 cdr)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@4) o_9@@55 f_5@@28) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@5) o_9@@55 f_5@@28)))
 :qid |stdinbpl.2418:33|
 :skolemid |293|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@4) o_9@@55 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@5) o_9@@55 f_5@@28))
))) (forall ((o_9@@56 T@Ref) (f_5@@29 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@4) o_9@@56 f_5@@29) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@5) o_9@@56 f_5@@29)))
 :qid |stdinbpl.2418:33|
 :skolemid |293|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@4) o_9@@56 f_5@@29))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@5) o_9@@56 f_5@@29))
))) (forall ((o_9@@57 T@Ref) (f_5@@30 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@4) o_9@@57 f_5@@30) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@5) o_9@@57 f_5@@30)))
 :qid |stdinbpl.2418:33|
 :skolemid |293|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@4) o_9@@57 f_5@@30))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@5) o_9@@57 f_5@@30))
...
(let ((anon264_Else_correct  (=> (forall ((v_5_1 T@Ref) ) (!  (=> (select g_1 v_5_1) (=> (select marked@1 v_5_1) (exists_spath ($$ ExhaleHeap@0 g_1) roots v_5_1)))
 :qid |stdinbpl.3014:20|
 :skolemid |364|
 :pattern ( (select marked@1 v_5_1))
 :pattern ( (exists_spath (|$$#frame| (CombineFrames (FrameFragment_5097 (|$$#condqp1| ExhaleHeap@0 g_1)) (FrameFragment_5097 (|$$#condqp2| ExhaleHeap@0 g_1))) g_1) roots v_5_1))
...
(let ((anon263_Else_correct  (=> (and (not (select g_1 n$4_2)) (= (ControlFlow 0 33) 30)) anon161_correct)))
(let ((anon263_Then_correct  (=> (select g_1 n$4_2) (and (=> (= (ControlFlow 0 31) (- 0 32)) (select g_1 (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$4_2 cdr))) (=> (select g_1 (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$4_2 cdr)) (=> (= (ControlFlow 0 31) 30) anon161_correct))))))
...
(let ((anon259_Else_correct  (=> (apply_noExit ($$ ExhaleHeap@0 g_1) g_1 marked@1) (=> (and (state ExhaleHeap@0 QPMask@7) (state ExhaleHeap@0 QPMask@7)) (and (=> (= (ControlFlow 0 50) (- 0 57)) (|Set#Subset_18938| roots marked@1)) (=> (|Set#Subset_18938| roots marked@1) (and (=> (= (ControlFlow 0 50) (- 0 56)) (|Set#Subset_18938| marked@1 g_1)) (=> (|Set#Subset_18938| marked@1 g_1) (and (=> (= (ControlFlow 0 50) (- 0 55)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 50) (- 0 54)) (forall ((n$5_2 T@Ref) (n$5_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$5_2 n$5_2_1)) (select g_1 n$5_2)) (select g_1 n$5_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$5_2 n$5_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$5_2@@3 car))
)) (=> (and (forall ((o_9@@58 T@Ref) ) (!  (=> (and (select g_1 (invRecv11 o_9@@58)) (and (< NoPerm FullPerm) (qpRange11 o_9@@58))) (= (invRecv11 o_9@@58) o_9@@58))
 :qid |stdinbpl.2925:22|
 :skolemid |353|
 :pattern ( (invRecv11 o_9@@58))
)) (forall ((o_9@@59 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv11 o_9@@59)) (and (< NoPerm FullPerm) (qpRange11 o_9@@59))) (and (= (invRecv11 o_9@@59) o_9@@59) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@10) o_9@@59 car) (- (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) o_9@@59 car) FullPerm)))) (=> (not (and (select g_1 (invRecv11 o_9@@59)) (and (< NoPerm FullPerm) (qpRange11 o_9@@59)))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@10) o_9@@59 car) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) o_9@@59 car))))
 :qid |stdinbpl.2931:22|
 :skolemid |354|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@10) o_9@@59 car))
))) (=> (and (and (and (forall ((o_9@@60 T@Ref) (f_5@@31 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@7) o_9@@60 f_5@@31) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@10) o_9@@60 f_5@@31)))
 :qid |stdinbpl.2937:29|
 :skolemid |355|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@10) o_9@@60 f_5@@31))
)) (forall ((o_9@@61 T@Ref) (f_5@@32 T@Field_28338_28339) ) (!  (=> (not (= f_5@@32 car)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) o_9@@61 f_5@@32) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@10) o_9@@61 f_5@@32)))
 :qid |stdinbpl.2937:29|
 :skolemid |355|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@10) o_9@@61 f_5@@32))
))) (forall ((o_9@@62 T@Ref) (f_5@@33 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@7) o_9@@62 f_5@@33) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@10) o_9@@62 f_5@@33)))
 :qid |stdinbpl.2937:29|
 :skolemid |355|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@10) o_9@@62 f_5@@33))
))) (forall ((o_9@@63 T@Ref) (f_5@@34 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@7) o_9@@63 f_5@@34) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@10) o_9@@63 f_5@@34)))
 :qid |stdinbpl.2937:29|
 :skolemid |355|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@10) o_9@@63 f_5@@34))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$6_2@@3 cdr))
)) (=> (and (forall ((o_9@@64 T@Ref) ) (!  (=> (and (select g_1 (invRecv12 o_9@@64)) (and (< NoPerm FullPerm) (qpRange12 o_9@@64))) (= (invRecv12 o_9@@64) o_9@@64))
 :qid |stdinbpl.2966:22|
 :skolemid |359|
 :pattern ( (invRecv12 o_9@@64))
)) (forall ((o_9@@65 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv12 o_9@@65)) (and (< NoPerm FullPerm) (qpRange12 o_9@@65))) (and (= (invRecv12 o_9@@65) o_9@@65) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@11) o_9@@65 cdr) (- (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@10) o_9@@65 cdr) FullPerm)))) (=> (not (and (select g_1 (invRecv12 o_9@@65)) (and (< NoPerm FullPerm) (qpRange12 o_9@@65)))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@11) o_9@@65 cdr) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@10) o_9@@65 cdr))))
 :qid |stdinbpl.2972:22|
 :skolemid |360|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@11) o_9@@65 cdr))
))) (=> (and (and (and (forall ((o_9@@66 T@Ref) (f_5@@35 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@10) o_9@@66 f_5@@35) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@11) o_9@@66 f_5@@35)))
 :qid |stdinbpl.2978:29|
 :skolemid |361|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@11) o_9@@66 f_5@@35))
)) (forall ((o_9@@67 T@Ref) (f_5@@36 T@Field_28338_28339) ) (!  (=> (not (= f_5@@36 cdr)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@10) o_9@@67 f_5@@36) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@11) o_9@@67 f_5@@36)))
 :qid |stdinbpl.2978:29|
 :skolemid |361|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@11) o_9@@67 f_5@@36))
))) (forall ((o_9@@68 T@Ref) (f_5@@37 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@10) o_9@@68 f_5@@37) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@11) o_9@@68 f_5@@37)))
 :qid |stdinbpl.2978:29|
 :skolemid |361|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@11) o_9@@68 f_5@@37))
))) (forall ((o_9@@69 T@Ref) (f_5@@38 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@10) o_9@@69 f_5@@38) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@11) o_9@@69 f_5@@38)))
 :qid |stdinbpl.2978:29|
 :skolemid |361|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@11) o_9@@69 f_5@@38))
...
(let ((anon259_Then_correct  (and (=> (= (ControlFlow 0 22) (- 0 25)) (forall ((n_48_2 T@Ref) (n_48_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n_48_2 n_48_3)) (select g_1 n_48_2)) (select g_1 n_48_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_48_2 n_48_3)))
 :qid |stdinbpl.2832:21|
 :skolemid |342|
 :pattern ( (neverTriggered41 n_48_2) (neverTriggered41 n_48_3))
))) (=> (forall ((n_48_2@@0 T@Ref) (n_48_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_48_2@@0 n_48_3@@0)) (select g_1 n_48_2@@0)) (select g_1 n_48_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_48_2@@0 n_48_3@@0)))
 :qid |stdinbpl.2832:21|
 :skolemid |342|
 :pattern ( (neverTriggered41 n_48_2@@0) (neverTriggered41 n_48_3@@0))
)) (and (=> (= (ControlFlow 0 22) (- 0 24)) (forall ((n_48_2@@1 T@Ref) ) (!  (=> (select g_1 n_48_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) n_48_2@@1 car) NoPerm)))
 :qid |stdinbpl.2839:21|
 :skolemid |343|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_48_2@@1 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@8) n_48_2@@1 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_48_2@@1 car))
))) (=> (forall ((n_48_2@@2 T@Ref) ) (!  (=> (select g_1 n_48_2@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) n_48_2@@2 car) NoPerm)))
 :qid |stdinbpl.2839:21|
 :skolemid |343|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_48_2@@2 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@8) n_48_2@@2 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_48_2@@2 car))
)) (=> (and (forall ((n_48_2@@3 T@Ref) ) (!  (=> (and (select g_1 n_48_2@@3) (< NoPerm FullPerm)) (and (qpRange41 n_48_2@@3) (= (invRecv41 n_48_2@@3) n_48_2@@3)))
 :qid |stdinbpl.2845:26|
 :skolemid |344|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_48_2@@3 car))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@8) n_48_2@@3 car))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n_48_2@@3 car))
)) (forall ((o_9@@70 T@Ref) ) (!  (=> (and (select g_1 (invRecv41 o_9@@70)) (and (< NoPerm FullPerm) (qpRange41 o_9@@70))) (= (invRecv41 o_9@@70) o_9@@70))
 :qid |stdinbpl.2849:26|
 :skolemid |345|
 :pattern ( (invRecv41 o_9@@70))
))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((n$0_14_1 T@Ref) (n$0_14_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_14_1 n$0_14_2)) (select g_1 n$0_14_1)) (select g_1 n$0_14_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_14_1 n$0_14_2)))
 :qid |stdinbpl.2860:21|
 :skolemid |346|
 :pattern ( (neverTriggered42 n$0_14_1) (neverTriggered42 n$0_14_2))
))) (=> (forall ((n$0_14_1@@0 T@Ref) (n$0_14_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_14_1@@0 n$0_14_2@@0)) (select g_1 n$0_14_1@@0)) (select g_1 n$0_14_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_14_1@@0 n$0_14_2@@0)))
 :qid |stdinbpl.2860:21|
 :skolemid |346|
 :pattern ( (neverTriggered42 n$0_14_1@@0) (neverTriggered42 n$0_14_2@@0))
)) (=> (= (ControlFlow 0 22) (- 0 21)) (forall ((n$0_14_1@@1 T@Ref) ) (!  (=> (select g_1 n$0_14_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) n$0_14_1@@1 cdr) NoPerm)))
 :qid |stdinbpl.2867:21|
 :skolemid |347|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_14_1@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@9) n$0_14_1@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$0_14_1@@1 cdr))
))))))))))))
(let ((anon152_correct  (=> (state ExhaleHeap@0 QPMask@7) (=> (and (and (or (and (forall ((n_43 T@Ref) ) (! (= (select roots n_43) (select pending@0 n_43))
 :qid |stdinbpl.2795:23|
 :skolemid |336|
 :pattern ( (select pending@0 n_43))
 :pattern ( (select roots n_43))
)) (forall ((n_44 T@Ref) ) (!  (=> (select g_1 n_44) (not (select marked@1 n_44)))
 :qid |stdinbpl.2798:20|
 :skolemid |337|
 :pattern ( (select marked@1 n_44))
))) (and (forall ((n_45 T@Ref) ) (!  (=> (select roots n_45) (or (select marked@1 n_45) (select pending@0 n_45)))
 :qid |stdinbpl.2801:22|
 :skolemid |338|
 :pattern ( (select pending@0 n_45))
 :pattern ( (select marked@1 n_45))
)) (and (forall ((n_46 T@Ref) ) (!  (=> (select g_1 n_46) (not (and (select marked@1 n_46) (select pending@0 n_46))))
 :qid |stdinbpl.2804:21|
 :skolemid |339|
 :pattern ( (select pending@0 n_46))
...
(let ((anon237_Else_correct  (=> (not (> (|Set#Card_18907| pending@0) 0)) (=> (and (state ExhaleHeap@0 QPMask@3) (not (select g_1 null))) (and (=> (= (ControlFlow 0 67) (- 0 69)) (forall ((n$9_5 T@Ref) (n$9_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$9_5 n$9_5_1)) (select g_1 n$9_5)) (select g_1 n$9_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$9_5 n$9_5_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$9_5@@1 car))
)) (forall ((o_9@@71 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv39 o_9@@71)) (< NoPerm FullPerm)) (qpRange39 o_9@@71)) (= (invRecv39 o_9@@71) o_9@@71))
 :qid |stdinbpl.2713:24|
 :skolemid |324|
 :pattern ( (invRecv39 o_9@@71))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$9_5@@2 car))
)) (forall ((o_9@@72 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv39 o_9@@72)) (< NoPerm FullPerm)) (qpRange39 o_9@@72)) (and (=> (< NoPerm FullPerm) (= (invRecv39 o_9@@72) o_9@@72)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@6) o_9@@72 car) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@72 car) FullPerm)))) (=> (not (and (and (select g_1 (invRecv39 o_9@@72)) (< NoPerm FullPerm)) (qpRange39 o_9@@72))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@6) o_9@@72 car) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@72 car))))
 :qid |stdinbpl.2725:24|
 :skolemid |326|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@6) o_9@@72 car))
)))) (=> (and (and (and (and (forall ((o_9@@73 T@Ref) (f_5@@39 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@3) o_9@@73 f_5@@39) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@6) o_9@@73 f_5@@39)))
 :qid |stdinbpl.2729:31|
 :skolemid |327|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@3) o_9@@73 f_5@@39))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@6) o_9@@73 f_5@@39))
)) (forall ((o_9@@74 T@Ref) (f_5@@40 T@Field_28338_28339) ) (!  (=> (not (= f_5@@40 car)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@74 f_5@@40) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@6) o_9@@74 f_5@@40)))
 :qid |stdinbpl.2729:31|
 :skolemid |327|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@74 f_5@@40))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@6) o_9@@74 f_5@@40))
))) (forall ((o_9@@75 T@Ref) (f_5@@41 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@3) o_9@@75 f_5@@41) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@6) o_9@@75 f_5@@41)))
 :qid |stdinbpl.2729:31|
 :skolemid |327|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@3) o_9@@75 f_5@@41))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@6) o_9@@75 f_5@@41))
))) (forall ((o_9@@76 T@Ref) (f_5@@42 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@3) o_9@@76 f_5@@42) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@6) o_9@@76 f_5@@42)))
 :qid |stdinbpl.2729:31|
 :skolemid |327|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@3) o_9@@76 f_5@@42))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@6) o_9@@76 f_5@@42))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$10_5@@1 cdr))
)) (forall ((o_9@@77 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv40 o_9@@77)) (< NoPerm FullPerm)) (qpRange40 o_9@@77)) (= (invRecv40 o_9@@77) o_9@@77))
 :qid |stdinbpl.2747:24|
 :skolemid |330|
 :pattern ( (invRecv40 o_9@@77))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| ExhaleHeap@0) n$10_5@@2 cdr))
)) (forall ((o_9@@78 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv40 o_9@@78)) (< NoPerm FullPerm)) (qpRange40 o_9@@78)) (and (=> (< NoPerm FullPerm) (= (invRecv40 o_9@@78) o_9@@78)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) o_9@@78 cdr) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@6) o_9@@78 cdr) FullPerm)))) (=> (not (and (and (select g_1 (invRecv40 o_9@@78)) (< NoPerm FullPerm)) (qpRange40 o_9@@78))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) o_9@@78 cdr) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@6) o_9@@78 cdr))))
 :qid |stdinbpl.2759:24|
 :skolemid |332|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) o_9@@78 cdr))
)))) (=> (and (and (and (and (forall ((o_9@@79 T@Ref) (f_5@@43 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@6) o_9@@79 f_5@@43) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@7) o_9@@79 f_5@@43)))
 :qid |stdinbpl.2763:31|
 :skolemid |333|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@6) o_9@@79 f_5@@43))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@7) o_9@@79 f_5@@43))
)) (forall ((o_9@@80 T@Ref) (f_5@@44 T@Field_28338_28339) ) (!  (=> (not (= f_5@@44 cdr)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@6) o_9@@80 f_5@@44) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) o_9@@80 f_5@@44)))
 :qid |stdinbpl.2763:31|
 :skolemid |333|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@6) o_9@@80 f_5@@44))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@7) o_9@@80 f_5@@44))
))) (forall ((o_9@@81 T@Ref) (f_5@@45 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@6) o_9@@81 f_5@@45) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@7) o_9@@81 f_5@@45)))
 :qid |stdinbpl.2763:31|
 :skolemid |333|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@6) o_9@@81 f_5@@45))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@7) o_9@@81 f_5@@45))
))) (forall ((o_9@@82 T@Ref) (f_5@@46 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@6) o_9@@82 f_5@@46) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@7) o_9@@82 f_5@@46)))
 :qid |stdinbpl.2763:31|
 :skolemid |333|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@6) o_9@@82 f_5@@46))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@7) o_9@@82 f_5@@46))
...
(let ((anon53_correct  (and (=> (= (ControlFlow 0 244) (- 0 245)) (or (and (forall ((n_4 T@Ref) ) (! (= (select roots n_4) (select roots n_4))
 :qid |stdinbpl.1473:20|
 :skolemid |178|
 :pattern ( (select roots n_4))
 :pattern ( (select roots n_4))
...
)) (forall ((n1 T@Ref) (n2 T@Ref) ) (!  (=> (and (select marked@0 n1) (and (select g_1 n2) (and (not (select marked@0 n2)) (not (select roots n2))))) (not (select ($$ Heap@@23 g_1) (create_edge n1 n2))))
 :qid |stdinbpl.1488:22|
 :skolemid |183|
 :pattern ( (select marked@0 n1) (select marked@0 n2))
))))))) (=> (or (and (forall ((n_4@@0 T@Ref) ) (! (= (select roots n_4@@0) (select roots n_4@@0))
 :qid |stdinbpl.1473:20|
 :skolemid |178|
 :pattern ( (select roots n_4@@0))
 :pattern ( (select roots n_4@@0))
...
)) (forall ((n1@@0 T@Ref) (n2@@0 T@Ref) ) (!  (=> (and (select marked@0 n1@@0) (and (select g_1 n2@@0) (and (not (select marked@0 n2@@0)) (not (select roots n2@@0))))) (not (select ($$ Heap@@23 g_1) (create_edge n1@@0 n2@@0))))
 :qid |stdinbpl.1488:22|
 :skolemid |183|
 :pattern ( (select marked@0 n1@@0) (select marked@0 n2@@0))
...
(let ((anon193_Else_correct  (=> (= x@0 (get Heap@@23 roots)) (=> (and (and (state Heap@@23 QPMask@1) (state Heap@@23 QPMask@1)) (and (= marked@0 |Set#Empty_19035|) (state Heap@@23 QPMask@1))) (and (=> (= (ControlFlow 0 262) (- 0 267)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 262) (- 0 266)) (forall ((n$9 T@Ref) (n$9_6 T@Ref) ) (!  (=> (and (and (and (and (not (= n$9 n$9_6)) (select g_1 n$9)) (select g_1 n$9_6)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$9 n$9_6)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$9@@3 car))
)) (=> (and (forall ((o_9@@83 T@Ref) ) (!  (=> (and (select g_1 (invRecv13 o_9@@83)) (and (< NoPerm FullPerm) (qpRange13 o_9@@83))) (= (invRecv13 o_9@@83) o_9@@83))
 :qid |stdinbpl.1372:26|
 :skolemid |167|
 :pattern ( (invRecv13 o_9@@83))
)) (forall ((o_9@@84 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv13 o_9@@84)) (and (< NoPerm FullPerm) (qpRange13 o_9@@84))) (and (= (invRecv13 o_9@@84) o_9@@84) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@2) o_9@@84 car) (- (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_9@@84 car) FullPerm)))) (=> (not (and (select g_1 (invRecv13 o_9@@84)) (and (< NoPerm FullPerm) (qpRange13 o_9@@84)))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@2) o_9@@84 car) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_9@@84 car))))
 :qid |stdinbpl.1378:26|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@2) o_9@@84 car))
))) (=> (and (and (and (forall ((o_9@@85 T@Ref) (f_5@@47 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@1) o_9@@85 f_5@@47) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@2) o_9@@85 f_5@@47)))
 :qid |stdinbpl.1384:33|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@2) o_9@@85 f_5@@47))
)) (forall ((o_9@@86 T@Ref) (f_5@@48 T@Field_28338_28339) ) (!  (=> (not (= f_5@@48 car)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_9@@86 f_5@@48) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@2) o_9@@86 f_5@@48)))
 :qid |stdinbpl.1384:33|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@2) o_9@@86 f_5@@48))
))) (forall ((o_9@@87 T@Ref) (f_5@@49 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@1) o_9@@87 f_5@@49) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@2) o_9@@87 f_5@@49)))
 :qid |stdinbpl.1384:33|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@2) o_9@@87 f_5@@49))
))) (forall ((o_9@@88 T@Ref) (f_5@@50 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@1) o_9@@88 f_5@@50) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@2) o_9@@88 f_5@@50)))
 :qid |stdinbpl.1384:33|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@2) o_9@@88 f_5@@50))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$10@@3 cdr))
)) (=> (and (forall ((o_9@@89 T@Ref) ) (!  (=> (and (select g_1 (invRecv14 o_9@@89)) (and (< NoPerm FullPerm) (qpRange14 o_9@@89))) (= (invRecv14 o_9@@89) o_9@@89))
 :qid |stdinbpl.1413:26|
 :skolemid |173|
 :pattern ( (invRecv14 o_9@@89))
)) (forall ((o_9@@90 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv14 o_9@@90)) (and (< NoPerm FullPerm) (qpRange14 o_9@@90))) (and (= (invRecv14 o_9@@90) o_9@@90) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@90 cdr) (- (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@2) o_9@@90 cdr) FullPerm)))) (=> (not (and (select g_1 (invRecv14 o_9@@90)) (and (< NoPerm FullPerm) (qpRange14 o_9@@90)))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@90 cdr) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@2) o_9@@90 cdr))))
 :qid |stdinbpl.1419:26|
 :skolemid |174|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@90 cdr))
))) (=> (and (and (and (forall ((o_9@@91 T@Ref) (f_5@@51 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@2) o_9@@91 f_5@@51) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@3) o_9@@91 f_5@@51)))
 :qid |stdinbpl.1425:33|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@3) o_9@@91 f_5@@51))
)) (forall ((o_9@@92 T@Ref) (f_5@@52 T@Field_28338_28339) ) (!  (=> (not (= f_5@@52 cdr)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@2) o_9@@92 f_5@@52) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@92 f_5@@52)))
 :qid |stdinbpl.1425:33|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@3) o_9@@92 f_5@@52))
))) (forall ((o_9@@93 T@Ref) (f_5@@53 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@2) o_9@@93 f_5@@53) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@3) o_9@@93 f_5@@53)))
 :qid |stdinbpl.1425:33|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@3) o_9@@93 f_5@@53))
))) (forall ((o_9@@94 T@Ref) (f_5@@54 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@2) o_9@@94 f_5@@54) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@3) o_9@@94 f_5@@54)))
 :qid |stdinbpl.1425:33|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@3) o_9@@94 f_5@@54))
...
(let ((anon178_Else_correct  (=> (and (not (select g_1 n$0_15)) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon178_Then_correct  (=> (select g_1 n$0_15) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_18763_18764 QPMask@1 n$0_15 cdr)) (=> (HasDirectPerm_18763_18764 QPMask@1 n$0_15 cdr) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
...
(let ((anon176_Else_correct  (=> (and (not (select g_1 n_80)) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon176_Then_correct  (=> (select g_1 n_80) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_18763_18764 QPMask@1 n_80 car)) (=> (HasDirectPerm_18763_18764 QPMask@1 n_80 car) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon174_Else_correct  (and (=> (= (ControlFlow 0 308) (- 0 309)) (forall ((n$2_1 T@Ref) (n$2_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$2_1 n$2_1_2)) (select g_1 n$2_1)) (select g_1 n$2_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$2_1 n$2_1_2)))
 :qid |stdinbpl.965:15|
 :skolemid |124|
))) (=> (forall ((n$2_1@@0 T@Ref) (n$2_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$2_1@@0 n$2_1_2@@0)) (select g_1 n$2_1@@0)) (select g_1 n$2_1_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$2_1@@0 n$2_1_2@@0)))
 :qid |stdinbpl.965:15|
 :skolemid |124|
)) (=> (and (and (forall ((n$2_1@@1 T@Ref) ) (!  (=> (and (select g_1 n$2_1@@1) (< NoPerm FullPerm)) (and (qpRange4 n$2_1@@1) (= (invRecv4 n$2_1@@1) n$2_1@@1)))
 :qid |stdinbpl.971:22|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$2_1@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) n$2_1@@1 cdr))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$2_1@@1 cdr))
)) (forall ((o_9@@95 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv4 o_9@@95)) (< NoPerm FullPerm)) (qpRange4 o_9@@95)) (= (invRecv4 o_9@@95) o_9@@95))
 :qid |stdinbpl.975:22|
 :skolemid |126|
 :pattern ( (invRecv4 o_9@@95))
))) (and (forall ((n$2_1@@2 T@Ref) ) (!  (=> (select g_1 n$2_1@@2) (not (= n$2_1@@2 null)))
 :qid |stdinbpl.981:22|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$2_1@@2 cdr))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) n$2_1@@2 cdr))
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$2_1@@2 cdr))
)) (forall ((o_9@@96 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv4 o_9@@96)) (< NoPerm FullPerm)) (qpRange4 o_9@@96)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_9@@96) o_9@@96)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_9@@96 cdr) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_9@@96 cdr) FullPerm)))) (=> (not (and (and (select g_1 (invRecv4 o_9@@96)) (< NoPerm FullPerm)) (qpRange4 o_9@@96))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_9@@96 cdr) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_9@@96 cdr))))
 :qid |stdinbpl.987:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_9@@96 cdr))
)))) (=> (and (and (and (and (forall ((o_9@@97 T@Ref) (f_5@@55 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@0) o_9@@97 f_5@@55) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@1) o_9@@97 f_5@@55)))
 :qid |stdinbpl.991:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@0) o_9@@97 f_5@@55))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@1) o_9@@97 f_5@@55))
)) (forall ((o_9@@98 T@Ref) (f_5@@56 T@Field_28338_28339) ) (!  (=> (not (= f_5@@56 cdr)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_9@@98 f_5@@56) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_9@@98 f_5@@56)))
 :qid |stdinbpl.991:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_9@@98 f_5@@56))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@1) o_9@@98 f_5@@56))
))) (forall ((o_9@@99 T@Ref) (f_5@@57 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@0) o_9@@99 f_5@@57) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@1) o_9@@99 f_5@@57)))
 :qid |stdinbpl.991:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@0) o_9@@99 f_5@@57))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@1) o_9@@99 f_5@@57))
))) (forall ((o_9@@100 T@Ref) (f_5@@58 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@0) o_9@@100 f_5@@58) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@1) o_9@@100 f_5@@58)))
 :qid |stdinbpl.991:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@0) o_9@@100 f_5@@58))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@1) o_9@@100 f_5@@58))
...
(let ((anon173_Else_correct  (and (=> (= (ControlFlow 0 310) (- 0 311)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g_1 n$1_1)) (select g_1 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$1_1@@1 car))
)) (forall ((o_9@@101 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv3 o_9@@101)) (< NoPerm FullPerm)) (qpRange3 o_9@@101)) (= (invRecv3 o_9@@101) o_9@@101))
 :qid |stdinbpl.936:22|
 :skolemid |120|
 :pattern ( (invRecv3 o_9@@101))
 ...
 :pattern ( (select (|PolymorphicMapType_28265_18152_18153#PolymorphicMapType_28265| Heap@@23) n$1_1@@2 car))
)) (forall ((o_9@@102 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv3 o_9@@102)) (< NoPerm FullPerm)) (qpRange3 o_9@@102)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_9@@102) o_9@@102)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_9@@102 car) (+ (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@102 car) FullPerm)))) (=> (not (and (and (select g_1 (invRecv3 o_9@@102)) (< NoPerm FullPerm)) (qpRange3 o_9@@102))) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_9@@102 car) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@102 car))))
 :qid |stdinbpl.948:22|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_9@@102 car))
)))) (=> (and (and (and (and (forall ((o_9@@103 T@Ref) (f_5@@59 T@Field_28325_53) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| ZeroMask) o_9@@103 f_5@@59) (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@0) o_9@@103 f_5@@59)))
 :qid |stdinbpl.952:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| ZeroMask) o_9@@103 f_5@@59))
 :pattern ( (select (|PolymorphicMapType_28286_18763_53#PolymorphicMapType_28286| QPMask@0) o_9@@103 f_5@@59))
)) (forall ((o_9@@104 T@Ref) (f_5@@60 T@Field_28338_28339) ) (!  (=> (not (= f_5@@60 car)) (= (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@104 f_5@@60) (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_9@@104 f_5@@60)))
 :qid |stdinbpl.952:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| ZeroMask) o_9@@104 f_5@@60))
 :pattern ( (select (|PolymorphicMapType_28286_18763_18764#PolymorphicMapType_28286| QPMask@0) o_9@@104 f_5@@60))
))) (forall ((o_9@@105 T@Ref) (f_5@@61 T@Field_18763_90710) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| ZeroMask) o_9@@105 f_5@@61) (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@0) o_9@@105 f_5@@61)))
 :qid |stdinbpl.952:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| ZeroMask) o_9@@105 f_5@@61))
 :pattern ( (select (|PolymorphicMapType_28286_18763_90710#PolymorphicMapType_28286| QPMask@0) o_9@@105 f_5@@61))
))) (forall ((o_9@@106 T@Ref) (f_5@@62 T@Field_18763_90843) ) (!  (=> true (= (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| ZeroMask) o_9@@106 f_5@@62) (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@0) o_9@@106 f_5@@62)))
 :qid |stdinbpl.952:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| ZeroMask) o_9@@106 f_5@@62))
 :pattern ( (select (|PolymorphicMapType_28286_18763_94389#PolymorphicMapType_28286| QPMask@0) o_9@@106 f_5@@62))
