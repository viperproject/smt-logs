...
function  neverTriggered4(n$2_1: Ref): bool;
...
function  neverTriggered21(n_11_2: Ref): bool;
function  neverTriggered22(n$0_6: Ref): bool;
function  neverTriggered23(n_12: Ref): bool;
function  neverTriggered24(n$0_7: Ref): bool;
function  neverTriggered25(n_13_2: Ref): bool;
function  neverTriggered26(n$0_8: Ref): bool;
function  neverTriggered27(n_14_1: Ref): bool;
function  neverTriggered28(n$0_9: Ref): bool;
function  neverTriggered29(n_15: Ref): bool;
function  neverTriggered30(n$0_10_1: Ref): bool;
function  neverTriggered31(n$0_11_2: Ref): bool;
function  neverTriggered32(n$0_12_1: Ref): bool;
function  neverTriggered33(n_27: Ref): bool;
function  neverTriggered34(n$0_13_1: Ref): bool;
...
function  neverTriggered41(n_48_2: Ref): bool;
function  neverTriggered42(n$0_14_1: Ref): bool;
// ==================================================
...
axiom (forall Heap: HeapType, Mask: MaskType, refs: (Set Ref) ::
  { state(Heap, Mask), $$'(Heap, refs) }
  state(Heap, Mask) && (AssumeFunctionsAbove < 0 || $$#trigger(CombineFrames(FrameFragment($$#condqp1(Heap, refs)), FrameFragment($$#condqp2(Heap, refs))), refs)) ==> (forall p_1: Ref, s_1: Ref ::
    { $$'(Heap, refs)[(create_edge(p_1, s_1): EdgeDomainType)] }
    (refs[p_1] && (refs[s_1] && (Heap[p_1, car] == s_1 || Heap[p_1, cdr] == s_1))) == $$'(Heap, refs)[(create_edge(p_1, s_1): EdgeDomainType)]
  )
);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Inhaling precondition (with checking)
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource n.car might not be injective. (graph_mark.vpr@158.14--158.25) [16666]"}
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, car] }
        ((refs[invRecv1(o_9)] && NoPerm < FullPerm) && qpRange1(o_9) ==> (NoPerm < FullPerm ==> invRecv1(o_9) == o_9) && QPMask[o_9, car] == Mask[o_9, car] + FullPerm) && (!((refs[invRecv1(o_9)] && NoPerm < FullPerm) && qpRange1(o_9)) ==> QPMask[o_9, car] == Mask[o_9, car])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != car ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@158.14--158.25) [16667]"}
    ...
    // -- Define Inverse Function
      ...
      assume (forall o_9: Ref ::
        { invRecv2(o_9) }
        (refs[invRecv2(o_9)] && NoPerm < FullPerm) && qpRange2(o_9) ==> invRecv2(o_9) == o_9
      );
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, cdr] }
        ((refs[invRecv2(o_9)] && NoPerm < FullPerm) && qpRange2(o_9) ==> (NoPerm < FullPerm ==> invRecv2(o_9) == o_9) && QPMask[o_9, cdr] == Mask[o_9, cdr] + FullPerm) && (!((refs[invRecv2(o_9)] && NoPerm < FullPerm) && qpRange2(o_9)) ==> QPMask[o_9, cdr] == Mask[o_9, cdr])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != cdr ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // -- Checking definedness of postcondition (no body)
    ...
    // -- Check definedness of (forall p: Ref, s: Ref :: { (create_edge(p, s) in result) } ((p in refs) && ((s in refs) && (p.car == s || p.cdr == s))) == (create_edge(p, s) in result))
      if (*) {
        if (refs[p_7]) {
          if (refs[s_5]) {
            assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.car (graph_mark.vpr@159.13--163.34) [16668]"}
              HasDirectPerm(Mask, p_7, car);
            if (!(Heap[p_7, car] == s_5)) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.cdr (graph_mark.vpr@159.13--163.34) [16669]"}
                HasDirectPerm(Mask, p_7, cdr);
            }
          }
        }
        assume false;
...
axiom (forall Heap: HeapType, Mask: MaskType, s_1: (Set Ref) ::
  { state(Heap, Mask), get'(Heap, s_1) }
  state(Heap, Mask) && (AssumeFunctionsAbove < 1 || get#trigger(EmptyFrame, s_1)) ==> Set#Card(s_1) > 0 ==> s_1[get'(Heap, s_1)]
);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource n$1.car might not be injective. (graph_mark.vpr@191.14--191.22) [16670]"}
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, car] }
        ((g_1[invRecv3(o_9)] && NoPerm < FullPerm) && qpRange3(o_9) ==> (NoPerm < FullPerm ==> invRecv3(o_9) == o_9) && QPMask[o_9, car] == Mask[o_9, car] + FullPerm) && (!((g_1[invRecv3(o_9)] && NoPerm < FullPerm) && qpRange3(o_9)) ==> QPMask[o_9, car] == Mask[o_9, car])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != car ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource n$2.cdr might not be injective. (graph_mark.vpr@191.14--191.22) [16671]"}
      (forall n$2_1: Ref, n$2_1_2: Ref ::
      
      (((n$2_1 != n$2_1_2 && g_1[n$2_1]) && g_1[n$2_1_2]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n$2_1 != n$2_1_2
    );
    
    // -- Define Inverse Function
      assume (forall n$2_1: Ref ::
        { Heap[n$2_1, cdr] } { QPMask[n$2_1, cdr] } { Heap[n$2_1, cdr] }
        g_1[n$2_1] && NoPerm < FullPerm ==> qpRange4(n$2_1) && invRecv4(n$2_1) == n$2_1
      );
      assume (forall o_9: Ref ::
        { invRecv4(o_9) }
    ...
    // -- Assume set of fields is nonNull
      assume (forall n$2_1: Ref ::
        { Heap[n$2_1, cdr] } { QPMask[n$2_1, cdr] } { Heap[n$2_1, cdr] }
        g_1[n$2_1] ==> n$2_1 != null
      );
    
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, cdr] }
        ((g_1[invRecv4(o_9)] && NoPerm < FullPerm) && qpRange4(o_9) ==> (NoPerm < FullPerm ==> invRecv4(o_9) == o_9) && QPMask[o_9, cdr] == Mask[o_9, cdr] + FullPerm) && (!((g_1[invRecv4(o_9)] && NoPerm < FullPerm) && qpRange4(o_9)) ==> QPMask[o_9, cdr] == Mask[o_9, cdr])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != cdr ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
    ...
    // -- Check definedness of (forall n: Ref :: { (n.car in g) } { (n in g), n.car } (n in g) ==> (n.car in g))
      if (*) {
        if (g_1[n_80]) {
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access n.car (graph_mark.vpr@191.14--191.22) [16672]"}
            HasDirectPerm(Mask, n_80, car);
        }
        assume false;
      }
    ...
    // -- Check definedness of (forall n$0: Ref :: { (n$0.cdr in g) } { (n$0 in g), n$0.cdr } (n$0 in g) ==> (n$0.cdr in g))
      if (*) {
        if (g_1[n$0_15]) {
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@191.14--191.22) [16673]"}
            HasDirectPerm(Mask, n$0_15, cdr);
        }
        assume false;
      }
  ...
  if (*) {
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource n$5.car might not be injective. (graph_mark.vpr@195.13--195.21) [16674]"}
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, car] }
        ((g_1[invRecv5(o_9)] && NoPerm < FullPerm) && qpRange5(o_9) ==> (NoPerm < FullPerm ==> invRecv5(o_9) == o_9) && QPMask[o_9, car] == PostMask[o_9, car] + FullPerm) && (!((g_1[invRecv5(o_9)] && NoPerm < FullPerm) && qpRange5(o_9)) ==> QPMask[o_9, car] == PostMask[o_9, car])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { PostMask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != car ==> PostMask[o_9, f_5] == QPMask[o_9, f_5]
      );
    PostMask := QPMask;
    assume state(PostHeap, PostMask);
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource n$6.cdr might not be injective. (graph_mark.vpr@195.13--195.21) [16675]"}
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, cdr] }
        ((g_1[invRecv6(o_9)] && NoPerm < FullPerm) && qpRange6(o_9) ==> (NoPerm < FullPerm ==> invRecv6(o_9) == o_9) && QPMask[o_9, cdr] == PostMask[o_9, cdr] + FullPerm) && (!((g_1[invRecv6(o_9)] && NoPerm < FullPerm) && qpRange6(o_9)) ==> QPMask[o_9, cdr] == PostMask[o_9, cdr])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { PostMask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != cdr ==> PostMask[o_9, f_5] == QPMask[o_9, f_5]
      );
    PostMask := QPMask;
    assume state(PostHeap, PostMask);
    ...
    // -- Check definedness of (forall n$3: Ref :: { (n$3.car in g) } { (n$3 in g), n$3.car } (n$3 in g) ==> (n$3.car in g))
      if (*) {
        if (g_1[n$3_8]) {
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access n$3.car (graph_mark.vpr@195.13--195.21) [16676]"}
            HasDirectPerm(PostMask, n$3_8, car);
        }
        assume false;
      }
    assume (forall n$3_1: Ref ::
      { g_1[PostHeap[n$3_1, car]] } { g_1[n$3_1], PostHeap[n$3_1, car] }
      g_1[n$3_1] ==> g_1[PostHeap[n$3_1, car]]
    );
    
    // -- Check definedness of (forall n$4: Ref :: { (n$4.cdr in g) } { (n$4 in g), n$4.cdr } (n$4 in g) ==> (n$4.cdr in g))
      if (*) {
        if (g_1[n$4_13]) {
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access n$4.cdr (graph_mark.vpr@195.13--195.21) [16677]"}
            HasDirectPerm(PostMask, n$4_13, cdr);
        }
        assume false;
      }
    assume (forall n$4_1: Ref ::
      { g_1[PostHeap[n$4_1, cdr]] } { g_1[n$4_1], PostHeap[n$4_1, cdr] }
      g_1[n$4_1] ==> g_1[PostHeap[n$4_1, cdr]]
    );
    assume state(PostHeap, PostMask);
    assume state(PostHeap, PostMask);
          ...
          if (marked[v_5]) {
            if (*) {
              ...
              // -- check if receiver n is injective
                assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@196.114--196.119) [16678]"}
              ...
              // -- check if sufficient permission is held
                assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@196.114--196.119) [16679]"}
                  (forall n_2: Ref ::
              ...
              // -- check if receiver n$0 is injective
                assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@196.114--196.119) [16680]"}
              ...
              // -- check if sufficient permission is held
                assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@196.114--196.119) [16681]"}
                  (forall n$0_2: Ref ::
                  { PostHeap[n$0_2, cdr] } { QPMask[n$0_2, cdr] } { PostHeap[n$0_2, cdr] }
                  g_1[n$0_2] ==> FullPerm > NoPerm ==> PostMask[n$0_2, cdr] > NoPerm
                );
              
              // -- assumptions for inverse of receiver n$0
                assume (forall n$0_2: Ref ::
                  { PostHeap[n$0_2, cdr] } { QPMask[n$0_2, cdr] } { PostHeap[n$0_2, cdr] }
                  g_1[n$0_2] && NoPerm < FullPerm ==> qpRange8(n$0_2) && invRecv8(n$0_2) == n$0_2
                );
                assume (forall o_9: Ref ::
                  { invRecv8(o_9) }
      ...
      if (*) {
        if (g_1[v_6]) {
          if (*) {
            ...
            // -- check if receiver n is injective
              assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@197.98--197.103) [16682]"}
                (forall n_3: Ref, n_3_1: Ref ::
            ...
            // -- check if sufficient permission is held
              assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@197.98--197.103) [16683]"}
                (forall n_3: Ref ::
            ...
            // -- check if receiver n$0 is injective
              assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@197.98--197.103) [16684]"}
                (forall n$0_3: Ref, n$0_3_1: Ref ::
            ...
            // -- check if sufficient permission is held
              assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@197.98--197.103) [16685]"}
                (forall n$0_3: Ref ::
                { PostHeap[n$0_3, cdr] } { QPMask[n$0_3, cdr] } { PostHeap[n$0_3, cdr] }
                g_1[n$0_3] ==> FullPerm > NoPerm ==> PostMask[n$0_3, cdr] > NoPerm
              );
            
            // -- assumptions for inverse of receiver n$0
              assume (forall n$0_3: Ref ::
                { PostHeap[n$0_3, cdr] } { QPMask[n$0_3, cdr] } { PostHeap[n$0_3, cdr] }
                g_1[n$0_3] && NoPerm < FullPerm ==> qpRange10(n$0_3) && invRecv10(n$0_3) == n$0_3
              );
              assume (forall o_9: Ref ::
                { invRecv10(o_9) }
  ...
  // -- Translating statement: x := get(roots) -- graph_mark.vpr@199.5--199.28
    ...
    // -- Check definedness of get(roots)
      if (*) {
        ...
        assert {:msg "  Precondition of function get might not hold. Assertion |roots| > 0 might not hold. (graph_mark.vpr@199.18--199.28) [16686]"}
          Set#Card(roots) > 0;
        // Stop execution
        assume false;
      }
  ...
  // -- Translating statement: while (|pending| > 0) -- graph_mark.vpr@203.5--238.6
    ...
    // -- Before loop head
      ...
      // -- Exhale loop invariant before loop
        ...
        // -- check if receiver n$9 is injective
          assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not hold on entry. Quantified resource n$9.car might not be injective. (graph_mark.vpr@205.19--205.27) [16688]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not hold on entry. There might be insufficient permission to access n$9.car (graph_mark.vpr@205.19--205.27) [16689]"}
            (forall n$9: Ref ::
        ...
        // -- assume permission updates for field car
          assume (forall o_9: Ref ::
            { QPMask[o_9, car] }
            (g_1[invRecv13(o_9)] && (NoPerm < FullPerm && qpRange13(o_9)) ==> invRecv13(o_9) == o_9 && QPMask[o_9, car] == Mask[o_9, car] - FullPerm) && (!(g_1[invRecv13(o_9)] && (NoPerm < FullPerm && qpRange13(o_9))) ==> QPMask[o_9, car] == Mask[o_9, car])
          );
        ...
        // -- check if receiver n$10 is injective
          assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not hold on entry. Quantified resource n$10.cdr might not be injective. (graph_mark.vpr@205.19--205.27) [16690]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not hold on entry. There might be insufficient permission to access n$10.cdr (graph_mark.vpr@205.19--205.27) [16691]"}
            (forall n$10: Ref ::
        ...
        // -- assume permission updates for field cdr
          assume (forall o_9: Ref ::
            { QPMask[o_9, cdr] }
            (g_1[invRecv14(o_9)] && (NoPerm < FullPerm && qpRange14(o_9)) ==> invRecv14(o_9) == o_9 && QPMask[o_9, cdr] == Mask[o_9, cdr] - FullPerm) && (!(g_1[invRecv14(o_9)] && (NoPerm < FullPerm && qpRange14(o_9))) ==> QPMask[o_9, cdr] == Mask[o_9, cdr])
          );
        ...
        if (*) {
          if (g_1[n$7_4]) {
            assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not hold on entry. Assertion (n$7.car in g) might not hold. (graph_mark.vpr@205.19--205.27) [16692]"}
              g_1[Heap[n$7_4, car]];
          }
          assume false;
        }
        ...
        if (*) {
          if (g_1[n$8]) {
            assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not hold on entry. Assertion (n$8.cdr in g) might not hold. (graph_mark.vpr@205.19--205.27) [16693]"}
              g_1[Heap[n$8, cdr]];
          }
          assume false;
        }
        ...
        assert {:msg "  Loop invariant (x in g) might not hold on entry. Assertion (x in g) might not hold. (graph_mark.vpr@208.19--208.25) [16694]"}
          g_1[x];
        assert {:msg "  Loop invariant (pending subset g) might not hold on entry. Assertion (pending subset g) might not hold. (graph_mark.vpr@209.19--209.35) [16695]"}
          Set#Subset(pending, g_1);
        assert {:msg "  Loop invariant (marked subset g) might not hold on entry. Assertion (marked subset g) might not hold. (graph_mark.vpr@210.19--210.34) [16696]"}
          Set#Subset(marked, g_1);
        assert {:msg "  Loop invariant exists_spath($$(g), roots, x) && ((x.cdr != null ==> (create_edge(x, x.cdr) in $$(g)) && exists_path($$(g), x.cdr, x.cdr) ==> exists_path($$(g), x, x.cdr)) && (x.car != null ==> (create_edge(x, x.car) in $$(g)) && exists_path($$(g), x.car, x.car) ==> exists_path($$(g), x, x.car))) might not hold on entry. Assertion exists_spath($$(g), roots, x) might not hold. (graph_mark.vpr@212.19--214.118) [16697]"}
        ...
        if (Heap[x, cdr] != null) {
          if ($$(Heap, g_1)[(create_edge(x, Heap[x, cdr]): EdgeDomainType)] && (exists_path($$(Heap, g_1), Heap[x, cdr], Heap[x, cdr]): bool)) {
            assert {:msg "  Loop invariant exists_spath($$(g), roots, x) && ((x.cdr != null ==> (create_edge(x, x.cdr) in $$(g)) && exists_path($$(g), x.cdr, x.cdr) ==> exists_path($$(g), x, x.cdr)) && (x.car != null ==> (create_edge(x, x.car) in $$(g)) && exists_path($$(g), x.car, x.car) ==> exists_path($$(g), x, x.car))) might not hold on entry. Assertion exists_path($$(g), x, x.cdr) might not hold. (graph_mark.vpr@212.19--214.118) [16698]"}
        ...
        assert {:msg "  Loop invariant (forall n: Ref :: { (n in pending) } { (n in roots) } (n in roots) == (n in pending)) && (forall n: Ref :: { (n in marked) } (n in g) ==> !((n in marked))) || (forall n: Ref :: { (n in pending) } { (n in marked) } (n in roots) ==> (n in marked) || (n in pending)) && ((forall n: Ref :: { (n in pending) } (n in g) ==> !((n in marked) && (n in pending))) && ((forall n: Ref :: { exists_spath($$(g), roots, n) } (n in pending) || (n in marked) ==> exists_spath($$(g), roots, n)) && (forall n1: Ref, n2: Ref :: { (n1 in marked), (n2 in marked) } (n1 in marked) && ((n2 in g) && (!((n2 in marked)) && !((n2 in pending)))) ==> !((create_edge(n1, n2) in $$(g)))))) might not hold on entry. Assertion (forall n: Ref :: { (n in pending) } { (n in roots) } (n in roots) == (n in pending)) && (forall n: Ref :: { (n in marked) } (n in g) ==> !((n in marked))) || (forall n: Ref :: { (n in pending) } { (n in marked) } (n in roots) ==> (n in marked) || (n in pending)) && ((forall n: Ref :: { (n in pending) } (n in g) ==> !((n in marked) && (n in pending))) && ((forall n: Ref :: { exists_spath($$(g), roots, n) } (n in pending) || (n in marked) ==> exists_spath($$(g), roots, n)) && (forall n1: Ref, n2: Ref :: { (n1 in marked), (n2 in marked) } (n1 in marked) && ((n2 in g) && (!((n2 in marked)) && !((n2 in pending)))) ==> !((create_edge(n1, n2) in $$(g)))))) might not hold. (graph_mark.vpr@217.9--223.152) [16700]"}
          ...
          { marked[n1], marked[n2] }
          marked[n1] && (g_1[n2] && (!marked[n2] && !pending[n2])) ==> !$$(Heap, g_1)[(create_edge(n1, n2): EdgeDomainType)]
        ))));
        // Finish exhale
        havoc ExhaleHeap;
    ...
    // -- Check definedness of invariant
      if (*) {
        ...
        havoc QPMask;
        assert {:msg "  Contract might not be well-formed. Quantified resource n$9.car might not be injective. (graph_mark.vpr@205.19--205.27) [16701]"}
        ...
        // -- Define permissions
          assume (forall o_9: Ref ::
            { QPMask[o_9, car] }
            ((g_1[invRecv15(o_9)] && NoPerm < FullPerm) && qpRange15(o_9) ==> (NoPerm < FullPerm ==> invRecv15(o_9) == o_9) && QPMask[o_9, car] == Mask[o_9, car] + FullPerm) && (!((g_1[invRecv15(o_9)] && NoPerm < FullPerm) && qpRange15(o_9)) ==> QPMask[o_9, car] == Mask[o_9, car])
          );
          assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
            { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
            f_5 != car ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
        ...
        havoc QPMask;
        assert {:msg "  Contract might not be well-formed. Quantified resource n$10.cdr might not be injective. (graph_mark.vpr@205.19--205.27) [16702]"}
        ...
        // -- Define permissions
          assume (forall o_9: Ref ::
            { QPMask[o_9, cdr] }
            ((g_1[invRecv16(o_9)] && NoPerm < FullPerm) && qpRange16(o_9) ==> (NoPerm < FullPerm ==> invRecv16(o_9) == o_9) && QPMask[o_9, cdr] == Mask[o_9, cdr] + FullPerm) && (!((g_1[invRecv16(o_9)] && NoPerm < FullPerm) && qpRange16(o_9)) ==> QPMask[o_9, cdr] == Mask[o_9, cdr])
          );
          assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
            { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
            f_5 != cdr ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
        ...
        // -- Check definedness of (forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g))
          if (*) {
            if (g_1[n$7_5]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access n$7.car (graph_mark.vpr@205.19--205.27) [16703]"}
        ...
        // -- Check definedness of (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g))
          if (*) {
            if (g_1[n$8_2]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access n$8.cdr (graph_mark.vpr@205.19--205.27) [16704]"}
        ...
        // -- Check definedness of exists_spath($$(g), roots, x)
          if (*) {
            ...
            // -- check if receiver n is injective
              assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@212.32--212.37) [16705]"}
            ...
            // -- check if sufficient permission is held
              assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@212.32--212.37) [16706]"}
                (forall n_9: Ref ::
            ...
            // -- check if receiver n$0 is injective
              assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@212.32--212.37) [16707]"}
            ...
            // -- check if sufficient permission is held
              assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@212.32--212.37) [16708]"}
                (forall n$0_4: Ref ::
        ...
        // -- Check definedness of x.cdr != null
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.cdr (graph_mark.vpr@212.19--214.118) [16709]"}
            HasDirectPerm(Mask, x, cdr);
        if (Heap[x, cdr] != null) {
          
          // -- Check definedness of (create_edge(x, x.cdr) in $$(g)) && exists_path($$(g), x.cdr, x.cdr)
            assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.cdr (graph_mark.vpr@212.19--214.118) [16710]"}
              HasDirectPerm(Mask, x, cdr);
            if (*) {
              // Exhale precondition of function application
              ExhaleWellDef0Heap := Heap;
              ...
              // -- check if receiver n is injective
                assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@213.32--213.51) [16711]"}
              ...
              // -- check if sufficient permission is held
                assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@213.32--213.51) [16712]"}
                  (forall n_10_1: Ref ::
              ...
              // -- check if receiver n$0 is injective
                assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@213.32--213.51) [16713]"}
              ...
              // -- check if sufficient permission is held
                assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@213.32--213.51) [16714]"}
                  (forall n$0_5: Ref ::
            ...
            if ($$(Heap, g_1)[(create_edge(x, Heap[x, cdr]): EdgeDomainType)]) {
              if (*) {
                ...
                // -- check if receiver n is injective
                  assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@213.67--213.72) [16715]"}
                    (forall n_11_2: Ref, n_11_3: Ref ::
                    { neverTriggered21(n_11_2), neverTriggered21(n_11_3) }
                    (((n_11_2 != n_11_3 && g_1[n_11_2]) && g_1[n_11_3]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n_11_2 != n_11_3
                  );
                
                // -- check if sufficient permission is held
                  assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@213.67--213.72) [16716]"}
                    (forall n_11_2: Ref ::
                    { Heap[n_11_2, car] } { QPMask[n_11_2, car] } { Heap[n_11_2, car] }
                    g_1[n_11_2] ==> FullPerm > NoPerm ==> Mask[n_11_2, car] > NoPerm
                  );
                
                // -- assumptions for inverse of receiver n
                  assume (forall n_11_2: Ref ::
                    { Heap[n_11_2, car] } { QPMask[n_11_2, car] } { Heap[n_11_2, car] }
                    g_1[n_11_2] && NoPerm < FullPerm ==> qpRange21(n_11_2) && invRecv21(n_11_2) == n_11_2
                  );
                  assume (forall o_9: Ref ::
                    { invRecv21(o_9) }
                ...
                // -- check if receiver n$0 is injective
                  assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@213.67--213.72) [16717]"}
                ...
                // -- check if sufficient permission is held
                  assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@213.67--213.72) [16718]"}
                    (forall n$0_6: Ref ::
              ...
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.cdr (graph_mark.vpr@212.19--214.118) [16719]"}
                HasDirectPerm(Mask, x, cdr);
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.cdr (graph_mark.vpr@212.19--214.118) [16720]"}
                HasDirectPerm(Mask, x, cdr);
            }
          if ($$(Heap, g_1)[(create_edge(x, Heap[x, cdr]): EdgeDomainType)] && (exists_path($$(Heap, g_1), Heap[x, cdr], Heap[x, cdr]): bool)) {
            assume state(Heap, Mask);
            ...
            // -- Check definedness of exists_path($$(g), x, x.cdr)
              if (*) {
                ...
                // -- check if receiver n is injective
                  assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@213.102--213.107) [16721]"}
                ...
                // -- check if sufficient permission is held
                  assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@213.102--213.107) [16722]"}
                    (forall n_12: Ref ::
                    { Heap[n_12, car] } { QPMask[n_12, car] } { Heap[n_12, car] }
                    g_1[n_12] ==> FullPerm > NoPerm ==> Mask[n_12, car] > NoPerm
                  );
                ...
                // -- check if receiver n$0 is injective
                  assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@213.102--213.107) [16723]"}
                ...
                // -- check if sufficient permission is held
                  assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@213.102--213.107) [16724]"}
                    (forall n$0_7: Ref ::
              ...
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.cdr (graph_mark.vpr@212.19--214.118) [16725]"}
                HasDirectPerm(Mask, x, cdr);
        ...
        // -- Check definedness of x.car != null
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.car (graph_mark.vpr@212.19--214.118) [16726]"}
            HasDirectPerm(Mask, x, car);
        if (Heap[x, car] != null) {
          
          // -- Check definedness of (create_edge(x, x.car) in $$(g)) && exists_path($$(g), x.car, x.car)
            assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.car (graph_mark.vpr@212.19--214.118) [16727]"}
              HasDirectPerm(Mask, x, car);
            if (*) {
              // Exhale precondition of function application
              ExhaleWellDef0Heap := Heap;
              ...
              // -- check if receiver n is injective
                assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@214.32--214.51) [16728]"}
                  (forall n_13_2: Ref, n_13_3: Ref ::
                  { neverTriggered25(n_13_2), neverTriggered25(n_13_3) }
                  (((n_13_2 != n_13_3 && g_1[n_13_2]) && g_1[n_13_3]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n_13_2 != n_13_3
                );
              
              // -- check if sufficient permission is held
                assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@214.32--214.51) [16729]"}
                  (forall n_13_2: Ref ::
                  { Heap[n_13_2, car] } { QPMask[n_13_2, car] } { Heap[n_13_2, car] }
                  g_1[n_13_2] ==> FullPerm > NoPerm ==> Mask[n_13_2, car] > NoPerm
                );
              
              // -- assumptions for inverse of receiver n
                assume (forall n_13_2: Ref ::
                  { Heap[n_13_2, car] } { QPMask[n_13_2, car] } { Heap[n_13_2, car] }
                  g_1[n_13_2] && NoPerm < FullPerm ==> qpRange25(n_13_2) && invRecv25(n_13_2) == n_13_2
                );
                assume (forall o_9: Ref ::
                  { invRecv25(o_9) }
              ...
              // -- check if receiver n$0 is injective
                assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@214.32--214.51) [16730]"}
              ...
              // -- check if sufficient permission is held
                assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@214.32--214.51) [16731]"}
                  (forall n$0_8: Ref ::
            ...
            if ($$(Heap, g_1)[(create_edge(x, Heap[x, car]): EdgeDomainType)]) {
              if (*) {
                ...
                // -- check if receiver n is injective
                  assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@214.67--214.72) [16732]"}
                    (forall n_14_1: Ref, n_14_2: Ref ::
                    { neverTriggered27(n_14_1), neverTriggered27(n_14_2) }
                    (((n_14_1 != n_14_2 && g_1[n_14_1]) && g_1[n_14_2]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n_14_1 != n_14_2
                  );
                
                // -- check if sufficient permission is held
                  assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@214.67--214.72) [16733]"}
                    (forall n_14_1: Ref ::
                    { Heap[n_14_1, car] } { QPMask[n_14_1, car] } { Heap[n_14_1, car] }
                    g_1[n_14_1] ==> FullPerm > NoPerm ==> Mask[n_14_1, car] > NoPerm
                  );
                
                // -- assumptions for inverse of receiver n
                  assume (forall n_14_1: Ref ::
                    { Heap[n_14_1, car] } { QPMask[n_14_1, car] } { Heap[n_14_1, car] }
                    g_1[n_14_1] && NoPerm < FullPerm ==> qpRange27(n_14_1) && invRecv27(n_14_1) == n_14_1
                  );
                  assume (forall o_9: Ref ::
                    { invRecv27(o_9) }
                ...
                // -- check if receiver n$0 is injective
                  assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@214.67--214.72) [16734]"}
                ...
                // -- check if sufficient permission is held
                  assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@214.67--214.72) [16735]"}
                    (forall n$0_9: Ref ::
              ...
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.car (graph_mark.vpr@212.19--214.118) [16736]"}
                HasDirectPerm(Mask, x, car);
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.car (graph_mark.vpr@212.19--214.118) [16737]"}
                HasDirectPerm(Mask, x, car);
            }
          if ($$(Heap, g_1)[(create_edge(x, Heap[x, car]): EdgeDomainType)] && (exists_path($$(Heap, g_1), Heap[x, car], Heap[x, car]): bool)) {
            assume state(Heap, Mask);
            ...
            // -- Check definedness of exists_path($$(g), x, x.car)
              if (*) {
                ...
                // -- check if receiver n is injective
                  assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@214.102--214.107) [16738]"}
                ...
                // -- check if sufficient permission is held
                  assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@214.102--214.107) [16739]"}
                    (forall n_15: Ref ::
                ...
                // -- check if receiver n$0 is injective
                  assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@214.102--214.107) [16740]"}
                    (forall n$0_10_1: Ref, n$0_10_2: Ref ::
                    { neverTriggered30(n$0_10_1), neverTriggered30(n$0_10_2) }
                    (((n$0_10_1 != n$0_10_2 && g_1[n$0_10_1]) && g_1[n$0_10_2]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n$0_10_1 != n$0_10_2
                  );
                
                // -- check if sufficient permission is held
                  assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@214.102--214.107) [16741]"}
                    (forall n$0_10_1: Ref ::
                    { Heap[n$0_10_1, cdr] } { QPMask[n$0_10_1, cdr] } { Heap[n$0_10_1, cdr] }
                    g_1[n$0_10_1] ==> FullPerm > NoPerm ==> Mask[n$0_10_1, cdr] > NoPerm
                  );
                
                // -- assumptions for inverse of receiver n$0
                  assume (forall n$0_10_1: Ref ::
                    { Heap[n$0_10_1, cdr] } { QPMask[n$0_10_1, cdr] } { Heap[n$0_10_1, cdr] }
                    g_1[n$0_10_1] && NoPerm < FullPerm ==> qpRange30(n$0_10_1) && invRecv30(n$0_10_1) == n$0_10_1
                  );
                  assume (forall o_9: Ref ::
                    { invRecv30(o_9) }
              ...
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.car (graph_mark.vpr@212.19--214.118) [16742]"}
                HasDirectPerm(Mask, x, car);
          ...
          if (!((forall n_19: Ref ::
            ...
            if ((forall n_22: Ref ::
              ...
              if ((forall n_24: Ref ::
                ...
                if (*) {
                  if (pending[n_81] || marked[n_81]) {
                    if (*) {
                      ...
                      // -- check if receiver n$0 is injective
                        assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.car might not be injective. (graph_mark.vpr@222.102--222.107) [16743]"}
                          (forall n$0_11_2: Ref, n$0_11_3: Ref ::
                          { neverTriggered31(n$0_11_2), neverTriggered31(n$0_11_3) }
                          (((n$0_11_2 != n$0_11_3 && g_1[n$0_11_2]) && g_1[n$0_11_3]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n$0_11_2 != n$0_11_3
                        );
                      
                      // -- check if sufficient permission is held
                        assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.car (graph_mark.vpr@222.102--222.107) [16744]"}
                          (forall n$0_11_2: Ref ::
                          { Heap[n$0_11_2, car] } { QPMask[n$0_11_2, car] } { Heap[n$0_11_2, car] }
                          g_1[n$0_11_2] ==> FullPerm > NoPerm ==> Mask[n$0_11_2, car] > NoPerm
                        );
                      
                      // -- assumptions for inverse of receiver n$0
                        assume (forall n$0_11_2: Ref ::
                          { Heap[n$0_11_2, car] } { QPMask[n$0_11_2, car] } { Heap[n$0_11_2, car] }
                          g_1[n$0_11_2] && NoPerm < FullPerm ==> qpRange31(n$0_11_2) && invRecv31(n$0_11_2) == n$0_11_2
                        );
                        assume (forall o_9: Ref ::
                          { invRecv31(o_9) }
                      ...
                      // -- check if receiver n$0 is injective
                        assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@222.102--222.107) [16745]"}
                          (forall n$0_12_1: Ref, n$0_12_2: Ref ::
                          { neverTriggered32(n$0_12_1), neverTriggered32(n$0_12_2) }
                          (((n$0_12_1 != n$0_12_2 && g_1[n$0_12_1]) && g_1[n$0_12_2]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n$0_12_1 != n$0_12_2
                        );
                      
                      // -- check if sufficient permission is held
                        assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@222.102--222.107) [16746]"}
                          (forall n$0_12_1: Ref ::
                          { Heap[n$0_12_1, cdr] } { QPMask[n$0_12_1, cdr] } { Heap[n$0_12_1, cdr] }
                          g_1[n$0_12_1] ==> FullPerm > NoPerm ==> Mask[n$0_12_1, cdr] > NoPerm
                        );
                      
                      // -- assumptions for inverse of receiver n$0
                        assume (forall n$0_12_1: Ref ::
                          { Heap[n$0_12_1, cdr] } { QPMask[n$0_12_1, cdr] } { Heap[n$0_12_1, cdr] }
                          g_1[n$0_12_1] && NoPerm < FullPerm ==> qpRange32(n$0_12_1) && invRecv32(n$0_12_1) == n$0_12_1
                        );
                        assume (forall o_9: Ref ::
                          { invRecv32(o_9) }
                ...
                if ((forall n_26: Ref ::
                  { (exists_spath($$#frame(CombineFrames(FrameFragment($$#condqp1(Heap, g_1)), FrameFragment($$#condqp2(Heap, g_1))), g_1), roots, n_26): bool) }
                  pending[n_26] || marked[n_26] ==> (exists_spath($$(Heap, g_1), roots, n_26): bool)
                )) {
                  if (*) {
                    if (marked[n1_1] && (g_1[n2_1] && (!marked[n2_1] && !pending[n2_1]))) {
                      if (*) {
                        // Exhale precondition of function application
                        ExhaleWellDef0Heap := Heap;
                        ExhaleWellDef0Mask := Mask;
                        ...
                        // -- check if receiver n is injective
                          assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@223.133--223.150) [16747]"}
                            (forall n_27: Ref, n_27_1: Ref ::
                            { neverTriggered33(n_27), neverTriggered33(n_27_1) }
                            (((n_27 != n_27_1 && g_1[n_27]) && g_1[n_27_1]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n_27 != n_27_1
                          );
                        
                        // -- check if sufficient permission is held
                          assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@223.133--223.150) [16748]"}
                            (forall n_27: Ref ::
                            { Heap[n_27, car] } { QPMask[n_27, car] } { Heap[n_27, car] }
                            g_1[n_27] ==> FullPerm > NoPerm ==> Mask[n_27, car] > NoPerm
                          );
                        
                        // -- assumptions for inverse of receiver n
                          assume (forall n_27: Ref ::
                            { Heap[n_27, car] } { QPMask[n_27, car] } { Heap[n_27, car] }
                            g_1[n_27] && NoPerm < FullPerm ==> qpRange33(n_27) && invRecv33(n_27) == n_27
                          );
                          assume (forall o_9: Ref ::
                            { invRecv33(o_9) }
                        ...
                        // -- check if receiver n$0 is injective
                          assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@223.133--223.150) [16749]"}
                            (forall n$0_13_1: Ref, n$0_13_2: Ref ::
                            { neverTriggered34(n$0_13_1), neverTriggered34(n$0_13_2) }
                            (((n$0_13_1 != n$0_13_2 && g_1[n$0_13_1]) && g_1[n$0_13_2]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n$0_13_1 != n$0_13_2
                          );
                        
                        // -- check if sufficient permission is held
                          assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@223.133--223.150) [16750]"}
                            (forall n$0_13_1: Ref ::
                            { Heap[n$0_13_1, cdr] } { QPMask[n$0_13_1, cdr] } { Heap[n$0_13_1, cdr] }
                            g_1[n$0_13_1] ==> FullPerm > NoPerm ==> Mask[n$0_13_1, cdr] > NoPerm
                          );
                        
                        // -- assumptions for inverse of receiver n$0
                          assume (forall n$0_13_1: Ref ::
                            { Heap[n$0_13_1, cdr] } { QPMask[n$0_13_1, cdr] } { Heap[n$0_13_1, cdr] }
                            g_1[n$0_13_1] && NoPerm < FullPerm ==> qpRange34(n$0_13_1) && invRecv34(n$0_13_1) == n$0_13_1
                          );
                          assume (forall o_9: Ref ::
                            { invRecv34(o_9) }
        ...
        assume ((forall n_28: Ref ::
          { pending[n_28] } { roots[n_28] }
          roots[n_28] == pending[n_28]
        ) && (forall n_29: Ref ::
          { marked[n_29] }
          g_1[n_29] ==> !marked[n_29]
        )) || ((forall n_30: Ref ::
          { pending[n_30] } { marked[n_30] }
          roots[n_30] ==> marked[n_30] || pending[n_30]
        ) && ((forall n_31: Ref ::
          { pending[n_31] }
          g_1[n_31] ==> !(marked[n_31] && pending[n_31])
        ) && ((forall n_32_2: Ref ::
          { (exists_spath($$#frame(CombineFrames(FrameFragment($$#condqp1(Heap, g_1)), FrameFragment($$#condqp2(Heap, g_1))), g_1), roots, n_32_2): bool) }
          pending[n_32_2] || marked[n_32_2] ==> (exists_spath($$(Heap, g_1), roots, n_32_2): bool)
        ) && (forall n1_2: Ref, n2_2: Ref ::
          { marked[n1_2], marked[n2_2] }
          marked[n1_2] && (g_1[n2_2] && (!marked[n2_2] && !pending[n2_2])) ==> !$$(Heap, g_1)[(create_edge(n1_2, n2_2): EdgeDomainType)]
        ))));
        assume state(Heap, Mask);
        assume false;
      }
    ...
    // -- Check the loop body
      if (*) {
        ...
        assume !g_1[null];
        havoc QPMask;
        assert {:msg "  While statement might fail. Quantified resource n$9.car might not be injective. (graph_mark.vpr@205.19--205.27) [16751]"}
        ...
        // -- Define permissions
          assume (forall o_9: Ref ::
            { QPMask[o_9, car] }
            ((g_1[invRecv35(o_9)] && NoPerm < FullPerm) && qpRange35(o_9) ==> (NoPerm < FullPerm ==> invRecv35(o_9) == o_9) && QPMask[o_9, car] == Mask[o_9, car] + FullPerm) && (!((g_1[invRecv35(o_9)] && NoPerm < FullPerm) && qpRange35(o_9)) ==> QPMask[o_9, car] == Mask[o_9, car])
          );
          assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
            { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
            f_5 != car ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
        ...
        assume state(Heap, Mask);
        havoc QPMask;
        assert {:msg "  While statement might fail. Quantified resource n$10.cdr might not be injective. (graph_mark.vpr@205.19--205.27) [16752]"}
        ...
        // -- Define permissions
          assume (forall o_9: Ref ::
            { QPMask[o_9, cdr] }
            ((g_1[invRecv36(o_9)] && NoPerm < FullPerm) && qpRange36(o_9) ==> (NoPerm < FullPerm ==> invRecv36(o_9) == o_9) && QPMask[o_9, cdr] == Mask[o_9, cdr] + FullPerm) && (!((g_1[invRecv36(o_9)] && NoPerm < FullPerm) && qpRange36(o_9)) ==> QPMask[o_9, cdr] == Mask[o_9, cdr])
          );
          assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
            { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
            f_5 != cdr ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
        ...
        assume ((forall n_33: Ref ::
          { pending[n_33] } { roots[n_33] }
          roots[n_33] == pending[n_33]
        ) && (forall n_34_2: Ref ::
          { marked[n_34_2] }
          g_1[n_34_2] ==> !marked[n_34_2]
        )) || ((forall n_35: Ref ::
          { pending[n_35] } { marked[n_35] }
          roots[n_35] ==> marked[n_35] || pending[n_35]
        ) && ((forall n_36: Ref ::
          { pending[n_36] }
          g_1[n_36] ==> !(marked[n_36] && pending[n_36])
        ) && ((forall n_37: Ref ::
          { (exists_spath($$#frame(CombineFrames(FrameFragment($$#condqp1(Heap, g_1)), FrameFragment($$#condqp2(Heap, g_1))), g_1), roots, n_37): bool) }
          pending[n_37] || marked[n_37] ==> (exists_spath($$(Heap, g_1), roots, n_37): bool)
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: x := get(pending) -- graph_mark.vpr@226.9--226.26
            ...
            // -- Check definedness of get(pending)
              if (*) {
                ...
                ExhaleWellDef0Heap := Heap;
                ExhaleWellDef0Mask := Mask;
                assert {:msg "  Precondition of function get might not hold. Assertion |pending| > 0 might not hold. (graph_mark.vpr@226.14--226.26) [16753]"}
                  Set#Card(pending) > 0;
                // Stop execution
                assume false;
              }
          ...
          // -- Translating statement: if (x.car != null && !((x.car in marked))) -- graph_mark.vpr@232.9--234.10
            ...
            // -- Check definedness of x.car != null && !((x.car in marked))
              assert {:msg "  Conditional statement might fail. There might be insufficient permission to access x.car (graph_mark.vpr@232.14--232.49) [16754]"}
                HasDirectPerm(Mask, x, car);
              if (Heap[x, car] != null) {
                assert {:msg "  Conditional statement might fail. There might be insufficient permission to access x.car (graph_mark.vpr@232.14--232.49) [16755]"}
                  HasDirectPerm(Mask, x, car);
              }
            if (Heap[x, car] != null && !marked[Heap[x, car]]) {
              ...
              // -- Translating statement: pending := (pending union Set(x.car)) -- graph_mark.vpr@233.13--233.48
                ...
                // -- Check definedness of (pending union Set(x.car))
                  assert {:msg "  Assignment might fail. There might be insufficient permission to access x.car (graph_mark.vpr@233.13--233.48) [16756]"}
                    HasDirectPerm(Mask, x, car);
          ...
          // -- Translating statement: if (x.cdr != null && !((x.cdr in marked))) -- graph_mark.vpr@235.9--237.10
            ...
            // -- Check definedness of x.cdr != null && !((x.cdr in marked))
              assert {:msg "  Conditional statement might fail. There might be insufficient permission to access x.cdr (graph_mark.vpr@235.14--235.49) [16757]"}
                HasDirectPerm(Mask, x, cdr);
              if (Heap[x, cdr] != null) {
                assert {:msg "  Conditional statement might fail. There might be insufficient permission to access x.cdr (graph_mark.vpr@235.14--235.49) [16758]"}
                  HasDirectPerm(Mask, x, cdr);
              }
            if (Heap[x, cdr] != null && !marked[Heap[x, cdr]]) {
              ...
              // -- Translating statement: pending := (pending union Set(x.cdr)) -- graph_mark.vpr@236.13--236.48
                ...
                // -- Check definedness of (pending union Set(x.cdr))
                  assert {:msg "  Assignment might fail. There might be insufficient permission to access x.cdr (graph_mark.vpr@236.13--236.48) [16759]"}
                    HasDirectPerm(Mask, x, cdr);
        ...
        ExhaleWellDef0Heap := Heap;
        ExhaleWellDef0Mask := Mask;
        assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not be preserved. Assertion !((null in g)) might not hold. (graph_mark.vpr@205.19--205.27) [16760]"}
          !g_1[null];
        havoc QPMask;
        ...
        // -- check if receiver n$9 is injective
          assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not be preserved. Quantified resource n$9.car might not be injective. (graph_mark.vpr@205.19--205.27) [16761]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not be preserved. There might be insufficient permission to access n$9.car (graph_mark.vpr@205.19--205.27) [16762]"}
            (forall n$9_4: Ref ::
        ...
        // -- assume permission updates for field car
          assume (forall o_9: Ref ::
            { QPMask[o_9, car] }
            (g_1[invRecv37(o_9)] && (NoPerm < FullPerm && qpRange37(o_9)) ==> invRecv37(o_9) == o_9 && QPMask[o_9, car] == Mask[o_9, car] - FullPerm) && (!(g_1[invRecv37(o_9)] && (NoPerm < FullPerm && qpRange37(o_9))) ==> QPMask[o_9, car] == Mask[o_9, car])
          );
        ...
        // -- check if receiver n$10 is injective
          assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not be preserved. Quantified resource n$10.cdr might not be injective. (graph_mark.vpr@205.19--205.27) [16763]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not be preserved. There might be insufficient permission to access n$10.cdr (graph_mark.vpr@205.19--205.27) [16764]"}
            (forall n$10_4: Ref ::
        ...
        // -- assume permission updates for field cdr
          assume (forall o_9: Ref ::
            { QPMask[o_9, cdr] }
            (g_1[invRecv38(o_9)] && (NoPerm < FullPerm && qpRange38(o_9)) ==> invRecv38(o_9) == o_9 && QPMask[o_9, cdr] == Mask[o_9, cdr] - FullPerm) && (!(g_1[invRecv38(o_9)] && (NoPerm < FullPerm && qpRange38(o_9))) ==> QPMask[o_9, cdr] == Mask[o_9, cdr])
          );
        ...
        if (*) {
          if (g_1[n$7_5_1]) {
            assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not be preserved. Assertion (n$7.car in g) might not hold. (graph_mark.vpr@205.19--205.27) [16765]"}
        ...
        if (*) {
          if (g_1[n$8_5]) {
            assert {:msg "  Loop invariant !((null in g)) && (true && ((forall n$9: Ref :: { n$9.car } (n$9 in g) ==> acc(n$9.car, write)) && (forall n$10: Ref :: { n$10.cdr } (n$10 in g) ==> acc(n$10.cdr, write))) && ((forall n$7: Ref :: { (n$7.car in g) } { (n$7 in g), n$7.car } (n$7 in g) ==> (n$7.car in g)) && (forall n$8: Ref :: { (n$8.cdr in g) } { (n$8 in g), n$8.cdr } (n$8 in g) ==> (n$8.cdr in g)))) might not be preserved. Assertion (n$8.cdr in g) might not hold. (graph_mark.vpr@205.19--205.27) [16766]"}
              g_1[Heap[n$8_5, cdr]];
          }
          assume false;
        }
        ...
        assert {:msg "  Loop invariant (x in g) might not be preserved. Assertion (x in g) might not hold. (graph_mark.vpr@208.19--208.25) [16767]"}
          g_1[x];
        assert {:msg "  Loop invariant (pending subset g) might not be preserved. Assertion (pending subset g) might not hold. (graph_mark.vpr@209.19--209.35) [16768]"}
          Set#Subset(pending, g_1);
        assert {:msg "  Loop invariant (marked subset g) might not be preserved. Assertion (marked subset g) might not hold. (graph_mark.vpr@210.19--210.34) [16769]"}
          Set#Subset(marked, g_1);
        assert {:msg "  Loop invariant exists_spath($$(g), roots, x) && ((x.cdr != null ==> (create_edge(x, x.cdr) in $$(g)) && exists_path($$(g), x.cdr, x.cdr) ==> exists_path($$(g), x, x.cdr)) && (x.car != null ==> (create_edge(x, x.car) in $$(g)) && exists_path($$(g), x.car, x.car) ==> exists_path($$(g), x, x.car))) might not be preserved. Assertion exists_spath($$(g), roots, x) might not hold. (graph_mark.vpr@212.19--214.118) [16770]"}
          (exists_spath($$(Heap, g_1), roots, x): bool);
        if (Heap[x, cdr] != null) {
          if ($$(Heap, g_1)[(create_edge(x, Heap[x, cdr]): EdgeDomainType)] && (exists_path($$(Heap, g_1), Heap[x, cdr], Heap[x, cdr]): bool)) {
            assert {:msg "  Loop invariant exists_spath($$(g), roots, x) && ((x.cdr != null ==> (create_edge(x, x.cdr) in $$(g)) && exists_path($$(g), x.cdr, x.cdr) ==> exists_path($$(g), x, x.cdr)) && (x.car != null ==> (create_edge(x, x.car) in $$(g)) && exists_path($$(g), x.car, x.car) ==> exists_path($$(g), x, x.car))) might not be preserved. Assertion exists_path($$(g), x, x.cdr) might not hold. (graph_mark.vpr@212.19--214.118) [16771]"}
              (exists_path($$(Heap, g_1), x, Heap[x, cdr]): bool);
          }
        }
        if (Heap[x, car] != null) {
          if ($$(Heap, g_1)[(create_edge(x, Heap[x, car]): EdgeDomainType)] && (exists_path($$(Heap, g_1), Heap[x, car], Heap[x, car]): bool)) {
            assert {:msg "  Loop invariant exists_spath($$(g), roots, x) && ((x.cdr != null ==> (create_edge(x, x.cdr) in $$(g)) && exists_path($$(g), x.cdr, x.cdr) ==> exists_path($$(g), x, x.cdr)) && (x.car != null ==> (create_edge(x, x.car) in $$(g)) && exists_path($$(g), x.car, x.car) ==> exists_path($$(g), x, x.car))) might not be preserved. Assertion exists_path($$(g), x, x.car) might not hold. (graph_mark.vpr@212.19--214.118) [16772]"}
              (exists_path($$(Heap, g_1), x, Heap[x, car]): bool);
          }
        }
        assert {:msg "  Loop invariant (forall n: Ref :: { (n in pending) } { (n in roots) } (n in roots) == (n in pending)) && (forall n: Ref :: { (n in marked) } (n in g) ==> !((n in marked))) || (forall n: Ref :: { (n in pending) } { (n in marked) } (n in roots) ==> (n in marked) || (n in pending)) && ((forall n: Ref :: { (n in pending) } (n in g) ==> !((n in marked) && (n in pending))) && ((forall n: Ref :: { exists_spath($$(g), roots, n) } (n in pending) || (n in marked) ==> exists_spath($$(g), roots, n)) && (forall n1: Ref, n2: Ref :: { (n1 in marked), (n2 in marked) } (n1 in marked) && ((n2 in g) && (!((n2 in marked)) && !((n2 in pending)))) ==> !((create_edge(n1, n2) in $$(g)))))) might not be preserved. Assertion (forall n: Ref :: { (n in pending) } { (n in roots) } (n in roots) == (n in pending)) && (forall n: Ref :: { (n in marked) } (n in g) ==> !((n in marked))) || (forall n: Ref :: { (n in pending) } { (n in marked) } (n in roots) ==> (n in marked) || (n in pending)) && ((forall n: Ref :: { (n in pending) } (n in g) ==> !((n in marked) && (n in pending))) && ((forall n: Ref :: { exists_spath($$(g), roots, n) } (n in pending) || (n in marked) ==> exists_spath($$(g), roots, n)) && (forall n1: Ref, n2: Ref :: { (n1 in marked), (n2 in marked) } (n1 in marked) && ((n2 in g) && (!((n2 in marked)) && !((n2 in pending)))) ==> !((create_edge(n1, n2) in $$(g)))))) might not hold. (graph_mark.vpr@217.9--223.152) [16773]"}
          ((forall n_38: Ref ::
          { pending[n_38] } { roots[n_38] }
          roots[n_38] == pending[n_38]
        ) && (forall n_39: Ref ::
          { marked[n_39] }
          g_1[n_39] ==> !marked[n_39]
        )) || ((forall n_40: Ref ::
          { pending[n_40] } { marked[n_40] }
          roots[n_40] ==> marked[n_40] || pending[n_40]
        ) && ((forall n_41: Ref ::
          { pending[n_41] }
          g_1[n_41] ==> !(marked[n_41] && pending[n_41])
        ) && ((forall n_42: Ref ::
          { (exists_spath($$#frame(CombineFrames(FrameFragment($$#condqp1(Heap, g_1)), FrameFragment($$#condqp2(Heap, g_1))), g_1), roots, n_42): bool) }
          pending[n_42] || marked[n_42] ==> (exists_spath($$(Heap, g_1), roots, n_42): bool)
    ...
    // -- Inhale loop invariant after loop, and assume guard
      ...
      assume !g_1[null];
      havoc QPMask;
      assert {:msg "  While statement might fail. Quantified resource n$9.car might not be injective. (graph_mark.vpr@205.19--205.27) [16774]"}
      ...
      // -- Define permissions
        assume (forall o_9: Ref ::
          { QPMask[o_9, car] }
          ((g_1[invRecv39(o_9)] && NoPerm < FullPerm) && qpRange39(o_9) ==> (NoPerm < FullPerm ==> invRecv39(o_9) == o_9) && QPMask[o_9, car] == Mask[o_9, car] + FullPerm) && (!((g_1[invRecv39(o_9)] && NoPerm < FullPerm) && qpRange39(o_9)) ==> QPMask[o_9, car] == Mask[o_9, car])
        );
        assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
          { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
          f_5 != car ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
      ...
      assume state(Heap, Mask);
      havoc QPMask;
      assert {:msg "  While statement might fail. Quantified resource n$10.cdr might not be injective. (graph_mark.vpr@205.19--205.27) [16775]"}
      ...
      // -- Define permissions
        assume (forall o_9: Ref ::
          { QPMask[o_9, cdr] }
          ((g_1[invRecv40(o_9)] && NoPerm < FullPerm) && qpRange40(o_9) ==> (NoPerm < FullPerm ==> invRecv40(o_9) == o_9) && QPMask[o_9, cdr] == Mask[o_9, cdr] + FullPerm) && (!((g_1[invRecv40(o_9)] && NoPerm < FullPerm) && qpRange40(o_9)) ==> QPMask[o_9, cdr] == Mask[o_9, cdr])
        );
        assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
          { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
          f_5 != cdr ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
      ...
      assume ((forall n_43: Ref ::
        { pending[n_43] } { roots[n_43] }
        roots[n_43] == pending[n_43]
      ) && (forall n_44: Ref ::
        { marked[n_44] }
        g_1[n_44] ==> !marked[n_44]
      )) || ((forall n_45: Ref ::
        { pending[n_45] } { marked[n_45] }
        roots[n_45] ==> marked[n_45] || pending[n_45]
      ) && ((forall n_46: Ref ::
        { pending[n_46] }
        g_1[n_46] ==> !(marked[n_46] && pending[n_46])
      ) && ((forall n_47: Ref ::
  ...
  // -- Translating statement: inhale apply_noExit($$(g), g, marked) -- graph_mark.vpr@243.12--243.42
    ...
    // -- Check definedness of apply_noExit($$(g), g, marked)
      if (*) {
        ...
        // -- check if receiver n is injective
          assert {:msg "  Precondition of function $$ might not hold. Quantified resource n.car might not be injective. (graph_mark.vpr@243.25--243.30) [16776]"}
            (forall n_48_2: Ref, n_48_3: Ref ::
            { neverTriggered41(n_48_2), neverTriggered41(n_48_3) }
            (((n_48_2 != n_48_3 && g_1[n_48_2]) && g_1[n_48_3]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n_48_2 != n_48_3
          );
        
        // -- check if sufficient permission is held
          assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n.car (graph_mark.vpr@243.25--243.30) [16777]"}
            (forall n_48_2: Ref ::
            { Heap[n_48_2, car] } { QPMask[n_48_2, car] } { Heap[n_48_2, car] }
            g_1[n_48_2] ==> FullPerm > NoPerm ==> Mask[n_48_2, car] > NoPerm
          );
        
        // -- assumptions for inverse of receiver n
          assume (forall n_48_2: Ref ::
            { Heap[n_48_2, car] } { QPMask[n_48_2, car] } { Heap[n_48_2, car] }
            g_1[n_48_2] && NoPerm < FullPerm ==> qpRange41(n_48_2) && invRecv41(n_48_2) == n_48_2
          );
          assume (forall o_9: Ref ::
            { invRecv41(o_9) }
        ...
        // -- check if receiver n$0 is injective
          assert {:msg "  Precondition of function $$ might not hold. Quantified resource n$0.cdr might not be injective. (graph_mark.vpr@243.25--243.30) [16778]"}
            (forall n$0_14_1: Ref, n$0_14_2: Ref ::
            { neverTriggered42(n$0_14_1), neverTriggered42(n$0_14_2) }
            (((n$0_14_1 != n$0_14_2 && g_1[n$0_14_1]) && g_1[n$0_14_2]) && NoPerm < FullPerm) && NoPerm < FullPerm ==> n$0_14_1 != n$0_14_2
          );
        
        // -- check if sufficient permission is held
          assert {:msg "  Precondition of function $$ might not hold. There might be insufficient permission to access n$0.cdr (graph_mark.vpr@243.25--243.30) [16779]"}
            (forall n$0_14_1: Ref ::
            { Heap[n$0_14_1, cdr] } { QPMask[n$0_14_1, cdr] } { Heap[n$0_14_1, cdr] }
            g_1[n$0_14_1] ==> FullPerm > NoPerm ==> Mask[n$0_14_1, cdr] > NoPerm
          );
        
        // -- assumptions for inverse of receiver n$0
          assume (forall n$0_14_1: Ref ::
            { Heap[n$0_14_1, cdr] } { QPMask[n$0_14_1, cdr] } { Heap[n$0_14_1, cdr] }
            g_1[n$0_14_1] && NoPerm < FullPerm ==> qpRange42(n$0_14_1) && invRecv42(n$0_14_1) == n$0_14_1
          );
          assume (forall o_9: Ref ::
            { invRecv42(o_9) }
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Postcondition of mark might not hold. Assertion (roots subset marked) might not hold. (graph_mark.vpr@193.13--193.32) [16780]"}
      Set#Subset(roots, marked);
    assert {:msg "  Postcondition of mark might not hold. Assertion (marked subset g) might not hold. (graph_mark.vpr@194.13--194.28) [16781]"}
      Set#Subset(marked, g_1);
    assert {:msg "  Postcondition of mark might not hold. Assertion !((null in g)) might not hold. (graph_mark.vpr@195.13--195.21) [16782]"}
      !g_1[null];
    havoc QPMask;
    ...
    // -- check if receiver n$5 is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource n$5.car might not be injective. (graph_mark.vpr@195.13--195.21) [16783]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of mark might not hold. There might be insufficient permission to access n$5.car (graph_mark.vpr@195.13--195.21) [16784]"}
        (forall n$5_2: Ref ::
    ...
    // -- assume permission updates for field car
      assume (forall o_9: Ref ::
        { QPMask[o_9, car] }
        (g_1[invRecv11(o_9)] && (NoPerm < FullPerm && qpRange11(o_9)) ==> invRecv11(o_9) == o_9 && QPMask[o_9, car] == Mask[o_9, car] - FullPerm) && (!(g_1[invRecv11(o_9)] && (NoPerm < FullPerm && qpRange11(o_9))) ==> QPMask[o_9, car] == Mask[o_9, car])
      );
    ...
    // -- check if receiver n$6 is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource n$6.cdr might not be injective. (graph_mark.vpr@195.13--195.21) [16785]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of mark might not hold. There might be insufficient permission to access n$6.cdr (graph_mark.vpr@195.13--195.21) [16786]"}
        (forall n$6_2: Ref ::
    ...
    // -- assume permission updates for field cdr
      assume (forall o_9: Ref ::
        { QPMask[o_9, cdr] }
        (g_1[invRecv12(o_9)] && (NoPerm < FullPerm && qpRange12(o_9)) ==> invRecv12(o_9) == o_9 && QPMask[o_9, cdr] == Mask[o_9, cdr] - FullPerm) && (!(g_1[invRecv12(o_9)] && (NoPerm < FullPerm && qpRange12(o_9))) ==> QPMask[o_9, cdr] == Mask[o_9, cdr])
      );
    ...
    if (*) {
      if (g_1[n$3_2]) {
        assert {:msg "  Postcondition of mark might not hold. Assertion (n$3.car in g) might not hold. (graph_mark.vpr@195.13--195.21) [16787]"}
          g_1[Heap[n$3_2, car]];
      }
      assume false;
    }
    ...
    if (*) {
      if (g_1[n$4_2]) {
        assert {:msg "  Postcondition of mark might not hold. Assertion (n$4.cdr in g) might not hold. (graph_mark.vpr@195.13--195.21) [16788]"}
          g_1[Heap[n$4_2, cdr]];
      }
      assume false;
    }
    ...
    if (*) {
      if (g_1[v_4_1]) {
        if (marked[v_4_1]) {
          assert {:msg "  Postcondition of mark might not hold. Assertion exists_spath($$(g), roots, v) might not hold. (graph_mark.vpr@196.13--196.130) [16789]"}
    ...
    assume (forall v_5_1: Ref ::
      { marked[v_5_1] } { (exists_spath($$#frame(CombineFrames(FrameFragment($$#condqp1(Heap, g_1)), FrameFragment($$#condqp2(Heap, g_1))), g_1), roots, v_5_1): bool) }
      g_1[v_5_1] ==> marked[v_5_1] ==> (exists_spath($$(Heap, g_1), roots, v_5_1): bool)
    );
    if (*) {
      if (g_1[v_6_1]) {
        if ((exists_spath($$(Heap, g_1), roots, v_6_1): bool)) {
          assert {:msg "  Postcondition of mark might not hold. Assertion (v in marked) might not hold. (graph_mark.vpr@197.13--197.130) [16790]"}
            marked[v_6_1];
        }
      }
      assume false;
