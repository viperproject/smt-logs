...
(let ((anon11_Then_correct  (=> (select refs@@4 s_2) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_25325_25326 QPMask@0 p_4 next)) (=> (HasDirectPerm_25325_25326 QPMask@0 p_4 next) (=> (= (ControlFlow 0 5) 3) anon6_correct))))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select refs@@4 n_3)) (select refs@@4 n_3_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_3 n_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_3@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select refs@@4 (invRecv1 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.745:22|
 :skolemid |104|
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_3@@4 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select refs@@4 (invRecv1 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv1 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_9@@0 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select refs@@4 (invRecv1 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.763:22|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_9@@0 next))
))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.767:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_38178_38179) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.767:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.767:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.767:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@0) o_9@@4 f_5@@2))
