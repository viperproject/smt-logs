...
(let ((anon48_Then_correct  (and (=> (= (ControlFlow 0 48) (- 0 49)) (forall ((n_4_1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1 n_4_2)) (select g_1 n_4_1)) (select g_1 n_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1 n_4_2)))
 :qid |stdinbpl.2631:21|
 :skolemid |275|
 :pattern ( (neverTriggered31 n_4_1) (neverTriggered31 n_4_2))
 ...
 :qid |stdinbpl.2631:21|
 :skolemid |275|
 :pattern ( (neverTriggered31 n_4_1@@0) (neverTriggered31 n_4_2@@0))
)) (=> (= (ControlFlow 0 48) (- 0 47)) (forall ((n_4_1@@1 T@Ref) ) (!  (=> (select g_1 n_4_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) n_4_1@@1 next) NoPerm)))
...
(let ((anon45_Else_correct  (=> (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1_1) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_1_1 next) null))) (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_1_1 next)))
...
(let ((anon47_Else_correct  (=> (and (not (and (select g_1 n$2_4) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_4 next) null)))) (= (ControlFlow 0 43) 40)) anon20_correct)))
(let ((anon47_Then_correct  (=> (and (select g_1 n$2_4) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_4 next) null))) (and (=> (= (ControlFlow 0 41) (- 0 42)) (HasDirectPerm_29078_29079 QPMask@8 n$2_4 next)) (=> (HasDirectPerm_29078_29079 QPMask@8 n$2_4 next) (=> (= (ControlFlow 0 41) 40) anon20_correct))))))
(let ((anon46_Else_correct  (=> (not (select g_1 n$2_4)) (and (=> (= (ControlFlow 0 46) 41) anon47_Then_correct) (=> (= (ControlFlow 0 46) 43) anon47_Else_correct)))))
(let ((anon46_Then_correct  (=> (select g_1 n$2_4) (and (=> (= (ControlFlow 0 44) (- 0 45)) (HasDirectPerm_29078_29079 QPMask@8 n$2_4 next)) (=> (HasDirectPerm_29078_29079 QPMask@8 n$2_4 next) (and (=> (= (ControlFlow 0 44) 41) anon47_Then_correct) (=> (= (ControlFlow 0 44) 43) anon47_Else_correct)))))))
(let ((anon44_Else_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g_1 n$1_1)) (select g_1 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv30 o_4)) (< NoPerm FullPerm)) (qpRange30 o_4)) (= (invRecv30 o_4) o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv30 o_4@@0)) (< NoPerm FullPerm)) (qpRange30 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv30 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_4@@0 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv30 o_4@@0)) (< NoPerm FullPerm)) (qpRange30 o_4@@0))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_4@@0 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_4@@0 next))))
 :qid |stdinbpl.2589:22|
 :skolemid |272|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_4@@0 next))
)))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@8) o_4@@1 f_5)))
 :qid |stdinbpl.2593:29|
 :skolemid |273|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@8) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_44212_44213) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2593:29|
 :skolemid |273|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@8) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2593:29|
 :skolemid |273|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@8) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@8) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2593:29|
 :skolemid |273|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@8) o_4@@4 f_5@@2))
...
)) (= (ControlFlow 0 28) (- 0 27))) (exists_path ($$ Heap@@19 g_1) u_3@@3 v_2@@6))))
(let ((anon52_Else_correct  (=> (apply_IND ($$ Heap@@19 g_1) (|Set#Singleton_29281| u_3@@3) (inst_uReach_2 ($$ Heap@@19 g_1) u_3@@3)) (=> (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0)) (and (=> (= (ControlFlow 0 33) (- 0 36)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (forall ((n$1_2 T@Ref) (n$1_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_2 n$1_2_1)) (select g_1 n$1_2)) (select g_1 n$1_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_2 n$1_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1_2@@3 next))
)) (=> (and (forall ((o_4@@5 T@Ref) ) (!  (=> (and (select g_1 (invRecv32 o_4@@5)) (and (< NoPerm FullPerm) (qpRange32 o_4@@5))) (= (invRecv32 o_4@@5) o_4@@5))
 :qid |stdinbpl.2866:22|
 :skolemid |298|
 :pattern ( (invRecv32 o_4@@5))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv32 o_4@@6)) (and (< NoPerm FullPerm) (qpRange32 o_4@@6))) (and (= (invRecv32 o_4@@6) o_4@@6) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_4@@6 next) (- (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_4@@6 next) FullPerm)))) (=> (not (and (select g_1 (invRecv32 o_4@@6)) (and (< NoPerm FullPerm) (qpRange32 o_4@@6)))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_4@@6 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_4@@6 next))))
 :qid |stdinbpl.2872:22|
 :skolemid |299|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_4@@6 next))
))) (=> (and (and (and (forall ((o_4@@7 T@Ref) (f_5@@3 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@0) o_4@@7 f_5@@3) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@7) o_4@@7 f_5@@3)))
 :qid |stdinbpl.2878:29|
 :skolemid |300|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@7) o_4@@7 f_5@@3))
)) (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_44212_44213) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_4@@8 f_5@@4) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_4@@8 f_5@@4)))
 :qid |stdinbpl.2878:29|
 :skolemid |300|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) o_4@@8 f_5@@4))
))) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@0) o_4@@9 f_5@@5) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@7) o_4@@9 f_5@@5)))
 :qid |stdinbpl.2878:29|
 :skolemid |300|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@7) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@0) o_4@@10 f_5@@6) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@7) o_4@@10 f_5@@6)))
 :qid |stdinbpl.2878:29|
 :skolemid |300|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@7) o_4@@10 f_5@@6))
...
(let ((anon41_Else_correct  (=> (and (exists_path ($$ Heap@@19 g_1) u_3@@3 w_2@@2) (state Heap@@19 QPMask@0)) (and (=> (= (ControlFlow 0 56) 13) anon42_Then_correct) (=> (= (ControlFlow 0 56) 55) anon42_Else_correct)))))
...
)) (=> (and (state Heap@@19 QPMask@0) (select g_1 u_3@@3)) (=> (and (and (select g_1 w_2@@2) (select g_1 v_2@@6)) (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0))) (and (=> (= (ControlFlow 0 57) 10) anon41_Then_correct) (=> (= (ControlFlow 0 57) 56) anon41_Else_correct)))))))
(let ((anon7_correct true))
(let ((anon40_Else_correct  (=> (and (not (and (select g_1 n$0_2) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_2 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon40_Then_correct  (=> (and (select g_1 n$0_2) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_2 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29078_29079 QPMask@0 n$0_2 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0_2 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon39_Else_correct  (=> (not (select g_1 n$0_2)) (and (=> (= (ControlFlow 0 8) 3) anon40_Then_correct) (=> (= (ControlFlow 0 8) 5) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> (select g_1 n$0_2) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29078_29079 QPMask@0 n$0_2 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0_2 next) (and (=> (= (ControlFlow 0 6) 3) anon40_Then_correct) (=> (= (ControlFlow 0 6) 5) anon40_Else_correct)))))))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@1 next))
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv27 o_4@@11)) (< NoPerm FullPerm)) (qpRange27 o_4@@11)) (= (invRecv27 o_4@@11) o_4@@11))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@2 next))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv27 o_4@@12)) (< NoPerm FullPerm)) (qpRange27 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv27 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_4@@12 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_4@@12 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv27 o_4@@12)) (< NoPerm FullPerm)) (qpRange27 o_4@@12))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_4@@12 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_4@@12 next))))
