...
(let ((anon127_Then_correct  (and (=> (= (ControlFlow 0 156) (- 0 159)) (not (select g0@@10 null))) (=> (not (select g0@@10 null)) (and (=> (= (ControlFlow 0 156) (- 0 158)) (forall ((n$0_2_1 T@Ref) (n$0_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_2_1 n$0_2_2)) (select g0@@10 n$0_2_1)) (select g0@@10 n$0_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_2_1 n$0_2_2)))
 :qid |stdinbpl.5391:21|
 :skolemid |542|
 :pattern ( (neverTriggered71 n$0_2_1) (neverTriggered71 n$0_2_2))
))) (=> (forall ((n$0_2_1@@0 T@Ref) (n$0_2_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_2_1@@0 n$0_2_2@@0)) (select g0@@10 n$0_2_1@@0)) (select g0@@10 n$0_2_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_2_1@@0 n$0_2_2@@0)))
 :qid |stdinbpl.5391:21|
 :skolemid |542|
 :pattern ( (neverTriggered71 n$0_2_1@@0) (neverTriggered71 n$0_2_2@@0))
)) (and (=> (= (ControlFlow 0 156) (- 0 157)) (forall ((n$0_2_1@@1 T@Ref) ) (!  (=> (select g0@@10 n$0_2_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$0_2_1@@1 next) NoPerm)))
 :qid |stdinbpl.5398:21|
 :skolemid |543|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_2_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@2) n$0_2_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_2_1@@1 next))
))) (=> (forall ((n$0_2_1@@2 T@Ref) ) (!  (=> (select g0@@10 n$0_2_1@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$0_2_1@@2 next) NoPerm)))
 :qid |stdinbpl.5398:21|
 :skolemid |543|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_2_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@2) n$0_2_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_2_1@@2 next))
)) (=> (and (forall ((n$0_2_1@@3 T@Ref) ) (!  (=> (and (select g0@@10 n$0_2_1@@3) (< NoPerm FullPerm)) (and (qpRange71 n$0_2_1@@3) (= (invRecv71 n$0_2_1@@3) n$0_2_1@@3)))
 :qid |stdinbpl.5404:26|
 :skolemid |544|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_2_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@2) n$0_2_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_2_1@@3 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select g0@@10 (invRecv71 o_4)) (and (< NoPerm FullPerm) (qpRange71 o_4))) (= (invRecv71 o_4) o_4))
 :qid |stdinbpl.5408:26|
 :skolemid |545|
 :pattern ( (invRecv71 o_4))
...
)) (= (ControlFlow 0 140) (- 0 139))) (select g1@@10 x1_2))))
(let ((anon130_Then_correct  (and (=> (= (ControlFlow 0 145) (- 0 148)) (not (select g1@@10 null))) (=> (not (select g1@@10 null)) (and (=> (= (ControlFlow 0 145) (- 0 147)) (forall ((n$0_3_2 T@Ref) (n$0_3_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_3_2 n$0_3_3)) (select g1@@10 n$0_3_2)) (select g1@@10 n$0_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_3_2 n$0_3_3)))
 :qid |stdinbpl.5450:21|
 :skolemid |547|
 :pattern ( (neverTriggered72 n$0_3_2) (neverTriggered72 n$0_3_3))
))) (=> (forall ((n$0_3_2@@0 T@Ref) (n$0_3_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_3_2@@0 n$0_3_3@@0)) (select g1@@10 n$0_3_2@@0)) (select g1@@10 n$0_3_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_3_2@@0 n$0_3_3@@0)))
 :qid |stdinbpl.5450:21|
 :skolemid |547|
 :pattern ( (neverTriggered72 n$0_3_2@@0) (neverTriggered72 n$0_3_3@@0))
)) (and (=> (= (ControlFlow 0 145) (- 0 146)) (forall ((n$0_3_2@@1 T@Ref) ) (!  (=> (select g1@@10 n$0_3_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$0_3_2@@1 next) NoPerm)))
 :qid |stdinbpl.5457:21|
 :skolemid |548|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@3) n$0_3_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3_2@@1 next))
))) (=> (forall ((n$0_3_2@@2 T@Ref) ) (!  (=> (select g1@@10 n$0_3_2@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$0_3_2@@2 next) NoPerm)))
 :qid |stdinbpl.5457:21|
 :skolemid |548|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@3) n$0_3_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3_2@@2 next))
)) (=> (and (forall ((n$0_3_2@@3 T@Ref) ) (!  (=> (and (select g1@@10 n$0_3_2@@3) (< NoPerm FullPerm)) (and (qpRange72 n$0_3_2@@3) (= (invRecv72 n$0_3_2@@3) n$0_3_2@@3)))
 :qid |stdinbpl.5463:26|
 :skolemid |549|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@3) n$0_3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_3_2@@3 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (select g1@@10 (invRecv72 o_4@@0)) (and (< NoPerm FullPerm) (qpRange72 o_4@@0))) (= (invRecv72 o_4@@0) o_4@@0))
 :qid |stdinbpl.5467:26|
 :skolemid |550|
 :pattern ( (invRecv72 o_4@@0))
...
(let ((anon180_Then_correct  (=> (select g_1@0 n_21) (and (=> (= (ControlFlow 0 127) (- 0 128)) (or (not (exists_path ($$ Heap@@41 g_1@0) x0 n_21)) (not (exists_path ($$ Heap@@41 g_1@0) x1_2 n_21)))) (=> (or (not (exists_path ($$ Heap@@41 g_1@0) x0 n_21)) (not (exists_path ($$ Heap@@41 g_1@0) x1_2 n_21))) (=> (= (ControlFlow 0 127) 126) anon115_correct))))))
(let ((anon178_Then_correct  (and (=> (= (ControlFlow 0 122) (- 0 123)) (forall ((n$0_11 T@Ref) (n$0_11_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_11 n$0_11_2)) (select g_1@0 n$0_11)) (select g_1@0 n$0_11_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_11 n$0_11_2)))
 :qid |stdinbpl.6328:27|
 :skolemid |623|
 :pattern ( (neverTriggered89 n$0_11) (neverTriggered89 n$0_11_2))
))) (=> (forall ((n$0_11@@0 T@Ref) (n$0_11_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_11@@0 n$0_11_2@@0)) (select g_1@0 n$0_11@@0)) (select g_1@0 n$0_11_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_11@@0 n$0_11_2@@0)))
 :qid |stdinbpl.6328:27|
 :skolemid |623|
 :pattern ( (neverTriggered89 n$0_11@@0) (neverTriggered89 n$0_11_2@@0))
)) (=> (= (ControlFlow 0 122) (- 0 121)) (forall ((n$0_11@@1 T@Ref) ) (!  (=> (select g_1@0 n$0_11@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$0_11@@1 next) NoPerm)))
 :qid |stdinbpl.6335:27|
 :skolemid |624|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_11@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) n$0_11@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_11@@1 next))
)))))))
(let ((anon176_Then_correct  (and (=> (= (ControlFlow 0 118) (- 0 119)) (forall ((n$0_10 T@Ref) (n$0_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_10 n$0_10_2)) (select g_1@0 n$0_10)) (select g_1@0 n$0_10_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_10 n$0_10_2)))
 :qid |stdinbpl.6288:25|
 :skolemid |619|
 :pattern ( (neverTriggered88 n$0_10) (neverTriggered88 n$0_10_2))
))) (=> (forall ((n$0_10@@0 T@Ref) (n$0_10_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_10@@0 n$0_10_2@@0)) (select g_1@0 n$0_10@@0)) (select g_1@0 n$0_10_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_10@@0 n$0_10_2@@0)))
 :qid |stdinbpl.6288:25|
 :skolemid |619|
 :pattern ( (neverTriggered88 n$0_10@@0) (neverTriggered88 n$0_10_2@@0))
)) (=> (= (ControlFlow 0 118) (- 0 117)) (forall ((n$0_10@@1 T@Ref) ) (!  (=> (select g_1@0 n$0_10@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n$0_10@@1 next) NoPerm)))
 :qid |stdinbpl.6295:25|
 :skolemid |620|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_10@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) n$0_10@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_10@@1 next))
)))))))
(let ((anon111_correct true))
(let ((anon177_Then_correct  (=> (exists_path ($$ Heap@@41 g_1@0) x0 n_30) (and (=> (= (ControlFlow 0 124) 122) anon178_Then_correct) (=> (= (ControlFlow 0 124) 115) anon111_correct)))))
(let ((anon177_Else_correct  (=> (and (not (exists_path ($$ Heap@@41 g_1@0) x0 n_30)) (= (ControlFlow 0 120) 115)) anon111_correct)))
(let ((anon175_Then_correct  (=> (select g_1@0 n_30) (and (and (=> (= (ControlFlow 0 125) 118) anon176_Then_correct) (=> (= (ControlFlow 0 125) 124) anon177_Then_correct)) (=> (= (ControlFlow 0 125) 120) anon177_Else_correct)))))
(let ((anon175_Else_correct  (=> (and (not (select g_1@0 n_30)) (= (ControlFlow 0 116) 115)) anon111_correct)))
(let ((anon179_Else_correct  (=> (forall ((n_22_1_1 T@Ref) ) (!  (=> (select g_1@0 n_22_1_1) (or (not (exists_path ($$ Heap@@41 g_1@0) x0 n_22_1_1)) (not (exists_path ($$ Heap@@41 g_1@0) x1_2 n_22_1_1))))
 ...
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g_1@0)) g_1@0) x1_2 n_22_1_1))
)) (=> (and (state Heap@@41 QPMask@1) (= (ControlFlow 0 114) (- 0 113))) false))))
(let ((anon172_Else_correct  (=> (and (forall ((n_19_1_1 T@Ref) ) (!  (=> (select g_1@0 n_19_1_1) (or (exists_path ($$ Heap@@41 g_1@0) x0 n_19_1_1) (exists_path ($$ Heap@@41 g_1@0) x1_2 n_19_1_1)))
 ...
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g_1@0)) g_1@0) x1_2 n_19_1_1))
...
(let ((anon173_Then_correct  (=> (select g_1@0 n_18) (and (=> (= (ControlFlow 0 110) (- 0 111)) (or (exists_path ($$ Heap@@41 g_1@0) x0 n_18) (exists_path ($$ Heap@@41 g_1@0) x1_2 n_18))) (=> (or (exists_path ($$ Heap@@41 g_1@0) x0 n_18) (exists_path ($$ Heap@@41 g_1@0) x1_2 n_18)) (=> (= (ControlFlow 0 110) 109) anon103_correct))))))
(let ((anon171_Then_correct  (and (=> (= (ControlFlow 0 105) (- 0 106)) (forall ((n$0_9 T@Ref) (n$0_9_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_9 n$0_9_2)) (select g_1@0 n$0_9)) (select g_1@0 n$0_9_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_9 n$0_9_2)))
 :qid |stdinbpl.6221:27|
 :skolemid |614|
 :pattern ( (neverTriggered87 n$0_9) (neverTriggered87 n$0_9_2))
))) (=> (forall ((n$0_9@@0 T@Ref) (n$0_9_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_9@@0 n$0_9_2@@0)) (select g_1@0 n$0_9@@0)) (select g_1@0 n$0_9_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_9@@0 n$0_9_2@@0)))
 :qid |stdinbpl.6221:27|
 :skolemid |614|
 :pattern ( (neverTriggered87 n$0_9@@0) (neverTriggered87 n$0_9_2@@0))
...
(let ((anon170_Then_correct  (=> (not (exists_path ($$ Heap@@41 g_1@0) x0 n_29)) (and (=> (= (ControlFlow 0 107) 105) anon171_Then_correct) (=> (= (ControlFlow 0 107) 98) anon99_correct)))))
(let ((anon170_Else_correct  (=> (and (exists_path ($$ Heap@@41 g_1@0) x0 n_29) (= (ControlFlow 0 103) 98)) anon99_correct)))
(let ((anon168_Then_correct  (=> (select g_1@0 n_29) (and (and (=> (= (ControlFlow 0 108) 101) anon169_Then_correct) (=> (= (ControlFlow 0 108) 107) anon170_Then_correct)) (=> (= (ControlFlow 0 108) 103) anon170_Else_correct)))))
(let ((anon168_Else_correct  (=> (and (not (select g_1@0 n_29)) (= (ControlFlow 0 99) 98)) anon99_correct)))
...
(let ((anon166_Then_correct  (and (=> (= (ControlFlow 0 96) (- 0 97)) (forall ((n_16 T@Ref) (n_16_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_16 n_16_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_16)) (select (|Set#Union_37395| g0@@10 g1@@10) n_16_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_16 n_16_1)))
 :qid |stdinbpl.6127:21|
 :skolemid |606|
 :pattern ( (neverTriggered85 n_16) (neverTriggered85 n_16_1))
))) (=> (forall ((n_16@@0 T@Ref) (n_16_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_16@@0 n_16_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_16@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_16_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_16@@0 n_16_1@@0)))
 :qid |stdinbpl.6127:21|
 :skolemid |606|
 :pattern ( (neverTriggered85 n_16@@0) (neverTriggered85 n_16_1@@0))
)) (=> (= (ControlFlow 0 96) (- 0 95)) (forall ((n_16@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_16@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_16@@1 next) NoPerm)))
 :qid |stdinbpl.6134:21|
 :skolemid |607|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_16@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n_16@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_16@@1 next))
)))))))
...
(let ((anon164_Then_correct  (and (=> (= (ControlFlow 0 87) (- 0 91)) (forall ((n_13 T@Ref) (n_13_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13 n_13_1)) (select g0@@10 n_13)) (select g0@@10 n_13_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13 n_13_1)))
 :qid |stdinbpl.6003:21|
 :skolemid |594|
 :pattern ( (neverTriggered82 n_13) (neverTriggered82 n_13_1))
))) (=> (forall ((n_13@@0 T@Ref) (n_13_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13@@0 n_13_1@@0)) (select g0@@10 n_13@@0)) (select g0@@10 n_13_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13@@0 n_13_1@@0)))
 :qid |stdinbpl.6003:21|
 :skolemid |594|
 :pattern ( (neverTriggered82 n_13@@0) (neverTriggered82 n_13_1@@0))
)) (and (=> (= (ControlFlow 0 87) (- 0 90)) (forall ((n_13@@1 T@Ref) ) (!  (=> (select g0@@10 n_13@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_13@@1 next) NoPerm)))
 :qid |stdinbpl.6010:21|
 :skolemid |595|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_13@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_13@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_13@@1 next))
))) (=> (forall ((n_13@@2 T@Ref) ) (!  (=> (select g0@@10 n_13@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_13@@2 next) NoPerm)))
 :qid |stdinbpl.6010:21|
 :skolemid |595|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_13@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_13@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_13@@2 next))
)) (=> (and (forall ((n_13@@3 T@Ref) ) (!  (=> (and (select g0@@10 n_13@@3) (< NoPerm FullPerm)) (and (qpRange82 n_13@@3) (= (invRecv82 n_13@@3) n_13@@3)))
 :qid |stdinbpl.6016:26|
 :skolemid |596|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_13@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_13@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_13@@3 next))
)) (forall ((o_4@@1 T@Ref) ) (!  (=> (and (select g0@@10 (invRecv82 o_4@@1)) (and (< NoPerm FullPerm) (qpRange82 o_4@@1))) (= (invRecv82 o_4@@1) o_4@@1))
 :qid |stdinbpl.6020:26|
 :skolemid |597|
 :pattern ( (invRecv82 o_4@@1))
))) (and (=> (= (ControlFlow 0 87) (- 0 89)) (forall ((n_14 T@Ref) (n_14_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_14 n_14_1)) (select g1@@10 n_14)) (select g1@@10 n_14_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_14 n_14_1)))
 :qid |stdinbpl.6031:21|
 :skolemid |598|
 :pattern ( (neverTriggered83 n_14) (neverTriggered83 n_14_1))
))) (=> (forall ((n_14@@0 T@Ref) (n_14_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_14@@0 n_14_1@@0)) (select g1@@10 n_14@@0)) (select g1@@10 n_14_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_14@@0 n_14_1@@0)))
 :qid |stdinbpl.6031:21|
 :skolemid |598|
 :pattern ( (neverTriggered83 n_14@@0) (neverTriggered83 n_14_1@@0))
)) (and (=> (= (ControlFlow 0 87) (- 0 88)) (forall ((n_14@@1 T@Ref) ) (!  (=> (select g1@@10 n_14@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_14@@1 next) NoPerm)))
 :qid |stdinbpl.6038:21|
 :skolemid |599|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_14@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n_14@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_14@@1 next))
))) (=> (forall ((n_14@@2 T@Ref) ) (!  (=> (select g1@@10 n_14@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_14@@2 next) NoPerm)))
 :qid |stdinbpl.6038:21|
 :skolemid |599|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_14@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n_14@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_14@@2 next))
)) (=> (forall ((n_14@@3 T@Ref) ) (!  (=> (and (select g1@@10 n_14@@3) (< NoPerm FullPerm)) (and (qpRange83 n_14@@3) (= (invRecv83 n_14@@3) n_14@@3)))
 :qid |stdinbpl.6044:26|
 :skolemid |600|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_14@@3 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n_14@@3 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_14@@3 next))
)) (=> (and (forall ((o_4@@2 T@Ref) ) (!  (=> (and (select g1@@10 (invRecv83 o_4@@2)) (and (< NoPerm FullPerm) (qpRange83 o_4@@2))) (= (invRecv83 o_4@@2) o_4@@2))
 :qid |stdinbpl.6048:26|
 :skolemid |601|
 :pattern ( (invRecv83 o_4@@2))
)) (= (ControlFlow 0 87) (- 0 86))) (|Set#Equal_37295| (|Set#Intersection_37295| g1@@10 g0@@10) |Set#Empty_37301|))))))))))))))
(let ((anon162_Else_correct  (=> (forall ((n_12_1_1 T@Ref) ) (!  (=> (select g_1@0 n_12_1_1) (or (not (exists_path ($$ Heap@@41 g0@@10) x0 n_12_1_1)) (not (exists_path ($$ Heap@@41 g1@@10) x1_2 n_12_1_1))))
 ...
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g1@@10)) g1@@10) x1_2 n_12_1_1))
...
(let ((anon163_Else_correct  (=> (and (not (select g_1@0 n_11_1)) (= (ControlFlow 0 85) 82)) anon85_correct)))
(let ((anon163_Then_correct  (=> (select g_1@0 n_11_1) (and (=> (= (ControlFlow 0 83) (- 0 84)) (or (not (exists_path ($$ Heap@@41 g0@@10) x0 n_11_1)) (not (exists_path ($$ Heap@@41 g1@@10) x1_2 n_11_1)))) (=> (or (not (exists_path ($$ Heap@@41 g0@@10) x0 n_11_1)) (not (exists_path ($$ Heap@@41 g1@@10) x1_2 n_11_1))) (=> (= (ControlFlow 0 83) 82) anon85_correct))))))
(let ((anon161_Then_correct  (and (=> (= (ControlFlow 0 78) (- 0 79)) (forall ((n$0_7 T@Ref) (n$0_7_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_7 n$0_7_2)) (select g1@@10 n$0_7)) (select g1@@10 n$0_7_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_7 n$0_7_2)))
 :qid |stdinbpl.5943:27|
 :skolemid |589|
 :pattern ( (neverTriggered81 n$0_7) (neverTriggered81 n$0_7_2))
))) (=> (forall ((n$0_7@@0 T@Ref) (n$0_7_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_7@@0 n$0_7_2@@0)) (select g1@@10 n$0_7@@0)) (select g1@@10 n$0_7_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_7@@0 n$0_7_2@@0)))
 :qid |stdinbpl.5943:27|
 :skolemid |589|
...
(let ((anon160_Then_correct  (=> (exists_path ($$ Heap@@41 g0@@10) x0 n_28) (and (=> (= (ControlFlow 0 80) 78) anon161_Then_correct) (=> (= (ControlFlow 0 80) 71) anon81_correct)))))
(let ((anon160_Else_correct  (=> (and (not (exists_path ($$ Heap@@41 g0@@10) x0 n_28)) (= (ControlFlow 0 76) 71)) anon81_correct)))
(let ((anon158_Then_correct  (=> (select g_1@0 n_28) (and (and (=> (= (ControlFlow 0 81) 74) anon159_Then_correct) (=> (= (ControlFlow 0 81) 80) anon160_Then_correct)) (=> (= (ControlFlow 0 81) 76) anon160_Else_correct)))))
(let ((anon158_Else_correct  (=> (and (not (select g_1@0 n_28)) (= (ControlFlow 0 72) 71)) anon81_correct)))
(let ((anon155_Else_correct  (=> (and (forall ((u_5_1 T@Ref) (v_5_1_1 T@Ref) ) (!  (=> (not (exists_path ($$ Heap@@41 g0@@10) u_5_1 v_5_1_1)) (not (edge ($$ Heap@@41 g0@@10) u_5_1 v_5_1_1)))
 :qid |stdinbpl.5875:20|
 :skolemid |584|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_5_1 v_5_1_1))
 :pattern ( (edge (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_5_1 v_5_1_1))
...
(let ((anon156_Else_correct  (=> (and (exists_path ($$ Heap@@41 g0@@10) u_4_1 v_4_1) (= (ControlFlow 0 70) 67)) anon73_correct)))
(let ((anon156_Then_correct  (=> (not (exists_path ($$ Heap@@41 g0@@10) u_4_1 v_4_1)) (and (=> (= (ControlFlow 0 68) (- 0 69)) (not (edge ($$ Heap@@41 g0@@10) u_4_1 v_4_1))) (=> (not (edge ($$ Heap@@41 g0@@10) u_4_1 v_4_1)) (=> (= (ControlFlow 0 68) 67) anon73_correct))))))
...
(let ((anon148_Else_correct  (=> (and (forall ((u_2_1_1 T@Ref) (v_2_1_1 T@Ref) ) (!  (=> (not (exists_path ($$ Heap@@41 g0@@10) u_2_1_1 v_2_1_1)) (and (not (= u_2_1_1 v_2_1_1)) (forall ((w_3_1 T@Ref) ) (!  (or (not (edge ($$ Heap@@41 g0@@10) u_2_1_1 w_3_1)) (not (exists_path ($$ Heap@@41 g0@@10) w_3_1 v_2_1_1)))
 :qid |stdinbpl.5770:94|
 :skolemid |574|
 :pattern ( (edge (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_2_1_1 w_3_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) w_3_1 v_2_1_1))
))))
 :qid |stdinbpl.5768:20|
 :skolemid |575|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_2_1_1 v_2_1_1))
...
(let ((anon150_Then_correct  (=> (= (ControlFlow 0 54) (- 0 53)) (or (not (edge ($$ Heap@@41 g0@@10) u_1@@1 w_1)) (not (exists_path ($$ Heap@@41 g0@@10) w_1 v_1_1@@1))))))
(let ((anon62_correct true))
(let ((anon150_Else_correct  (=> (and (forall ((w_2_1 T@Ref) ) (!  (or (not (edge ($$ Heap@@41 g0@@10) u_1@@1 w_2_1)) (not (exists_path ($$ Heap@@41 g0@@10) w_2_1 v_1_1@@1)))
 :qid |stdinbpl.5761:24|
 :skolemid |573|
 :pattern ( (edge (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_1@@1 w_2_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) w_2_1 v_1_1@@1))
)) (= (ControlFlow 0 55) 51)) anon62_correct)))
(let ((anon149_Then_correct  (=> (not (exists_path ($$ Heap@@41 g0@@10) u_1@@1 v_1_1@@1)) (and (=> (= (ControlFlow 0 56) (- 0 57)) (not (= u_1@@1 v_1_1@@1))) (=> (not (= u_1@@1 v_1_1@@1)) (and (=> (= (ControlFlow 0 56) 54) anon150_Then_correct) (=> (= (ControlFlow 0 56) 55) anon150_Else_correct)))))))
(let ((anon149_Else_correct  (=> (and (exists_path ($$ Heap@@41 g0@@10) u_1@@1 v_1_1@@1) (= (ControlFlow 0 52) 51)) anon62_correct)))
...
(let ((anon146_Then_correct  (=> (edge ($$ Heap@@41 g0@@10) u_19 w_3) (and (=> (= (ControlFlow 0 48) 46) anon147_Then_correct) (=> (= (ControlFlow 0 48) 43) anon55_correct)))))
(let ((anon146_Else_correct  (=> (and (not (edge ($$ Heap@@41 g0@@10) u_19 w_3)) (= (ControlFlow 0 44) 43)) anon55_correct)))
...
(let ((anon138_Else_correct  (=> (and (forall ((n_4_1_1 T@Ref) ) (!  (=> (select g_1@0 n_4_1_1) (or (exists_path ($$ Heap@@41 g0@@10) x0 n_4_1_1) (exists_path ($$ Heap@@41 g1@@10) x1_2 n_4_1_1)))
 ...
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g1@@10)) g1@@10) x1_2 n_4_1_1))
...
(let ((anon139_Then_correct  (=> (select g_1@0 n_3) (and (=> (= (ControlFlow 0 31) (- 0 32)) (or (exists_path ($$ Heap@@41 g0@@10) x0 n_3) (exists_path ($$ Heap@@41 g1@@10) x1_2 n_3))) (=> (or (exists_path ($$ Heap@@41 g0@@10) x0 n_3) (exists_path ($$ Heap@@41 g1@@10) x1_2 n_3)) (=> (= (ControlFlow 0 31) 30) anon43_correct))))))
(let ((anon137_Then_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((n$0_5 T@Ref) (n$0_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5 n$0_5_2)) (select g1@@10 n$0_5)) (select g1@@10 n$0_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5 n$0_5_2)))
 :qid |stdinbpl.5566:27|
 :skolemid |556|
 :pattern ( (neverTriggered74 n$0_5) (neverTriggered74 n$0_5_2))
))) (=> (forall ((n$0_5@@0 T@Ref) (n$0_5_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5@@0 n$0_5_2@@0)) (select g1@@10 n$0_5@@0)) (select g1@@10 n$0_5_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5@@0 n$0_5_2@@0)))
 :qid |stdinbpl.5566:27|
 :skolemid |556|
 :pattern ( (neverTriggered74 n$0_5@@0) (neverTriggered74 n$0_5_2@@0))
...
(let ((anon136_Then_correct  (=> (not (exists_path ($$ Heap@@41 g0@@10) x0 n_27)) (and (=> (= (ControlFlow 0 28) 26) anon137_Then_correct) (=> (= (ControlFlow 0 28) 19) anon39_correct)))))
(let ((anon136_Else_correct  (=> (and (exists_path ($$ Heap@@41 g0@@10) x0 n_27) (= (ControlFlow 0 24) 19)) anon39_correct)))
(let ((anon134_Then_correct  (=> (select g_1@0 n_27) (and (and (=> (= (ControlFlow 0 29) 22) anon135_Then_correct) (=> (= (ControlFlow 0 29) 28) anon136_Then_correct)) (=> (= (ControlFlow 0 29) 24) anon136_Else_correct)))))
(let ((anon134_Else_correct  (=> (and (not (select g_1@0 n_27)) (= (ControlFlow 0 20) 19)) anon39_correct)))
(let ((anon130_Else_correct  (=> (and (and (is_global_root Heap@@41 g1@@10 x1_2) (state Heap@@41 QPMask@1)) (and (= g_1@0 (|Set#Union_37395| g0@@10 g1@@10)) (state Heap@@41 QPMask@1))) (and (and (and (and (=> (= (ControlFlow 0 138) 137) anon138_Else_correct) (=> (= (ControlFlow 0 138) 31) anon139_Then_correct)) (=> (= (ControlFlow 0 138) 33) anon139_Else_correct)) (=> (= (ControlFlow 0 138) 29) anon134_Then_correct)) (=> (= (ControlFlow 0 138) 20) anon134_Else_correct)))))
...
(let ((anon122_Else_correct  (=> (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g1@@10 n$2_1_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next) null))) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next)))
...
)) (state Heap@@41 QPMask@1)) (=> (and (and (select g0@@10 x0) (state Heap@@41 QPMask@1)) (and (select g1@@10 x1_2) (state Heap@@41 QPMask@1))) (and (=> (= (ControlFlow 0 162) 17) anon125_Then_correct) (=> (= (ControlFlow 0 162) 161) anon125_Else_correct))))))
(let ((anon15_correct true))
(let ((anon124_Else_correct  (=> (and (not (and (select g1@@10 n$2_22) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_22 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon124_Then_correct  (=> (and (select g1@@10 n$2_22) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_22 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_37315_37316 QPMask@1 n$2_22 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_22 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon123_Else_correct  (=> (not (select g1@@10 n$2_22)) (and (=> (= (ControlFlow 0 16) 11) anon124_Then_correct) (=> (= (ControlFlow 0 16) 13) anon124_Else_correct)))))
(let ((anon123_Then_correct  (=> (select g1@@10 n$2_22) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_37315_37316 QPMask@1 n$2_22 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_22 next) (and (=> (= (ControlFlow 0 14) 11) anon124_Then_correct) (=> (= (ControlFlow 0 14) 13) anon124_Else_correct)))))))
(let ((anon121_Else_correct  (and (=> (= (ControlFlow 0 163) (- 0 164)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@10 n$1_1)) (select g1@@10 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@1 next))
)) (forall ((o_4@@3 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv70 o_4@@3)) (< NoPerm FullPerm)) (qpRange70 o_4@@3)) (= (invRecv70 o_4@@3) o_4@@3))
 :qid |stdinbpl.5312:22|
 :skolemid |535|
 :pattern ( (invRecv70 o_4@@3))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@2 next))
)) (forall ((o_4@@4 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv70 o_4@@4)) (< NoPerm FullPerm)) (qpRange70 o_4@@4)) (and (=> (< NoPerm FullPerm) (= (invRecv70 o_4@@4) o_4@@4)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@4 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@4 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv70 o_4@@4)) (< NoPerm FullPerm)) (qpRange70 o_4@@4))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@4 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@4 next))))
 :qid |stdinbpl.5324:22|
 :skolemid |537|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@4 next))
)))) (=> (and (and (and (and (forall ((o_4@@5 T@Ref) (f_5 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@5 f_5) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@5 f_5)))
 :qid |stdinbpl.5328:29|
 :skolemid |538|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@5 f_5))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@5 f_5))
)) (forall ((o_4@@6 T@Ref) (f_5@@0 T@Field_58602_58603) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@6 f_5@@0) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@6 f_5@@0)))
 :qid |stdinbpl.5328:29|
 :skolemid |538|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@6 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@6 f_5@@0))
))) (forall ((o_4@@7 T@Ref) (f_5@@1 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@7 f_5@@1) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_4@@7 f_5@@1)))
 :qid |stdinbpl.5328:29|
 :skolemid |538|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@7 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_4@@7 f_5@@1))
))) (forall ((o_4@@8 T@Ref) (f_5@@2 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@8 f_5@@2) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_4@@8 f_5@@2)))
 :qid |stdinbpl.5328:29|
 :skolemid |538|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@8 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_4@@8 f_5@@2))
...
(let ((anon120_Else_correct  (=> (and (not (and (select g0@@10 n$0_24) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_24 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon120_Then_correct  (=> (and (select g0@@10 n$0_24) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_24 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$0_24 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_24 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon119_Else_correct  (=> (not (select g0@@10 n$0_24)) (and (=> (= (ControlFlow 0 8) 3) anon120_Then_correct) (=> (= (ControlFlow 0 8) 5) anon120_Else_correct)))))
(let ((anon119_Then_correct  (=> (select g0@@10 n$0_24) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$0_24 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_24 next) (and (=> (= (ControlFlow 0 6) 3) anon120_Then_correct) (=> (= (ControlFlow 0 6) 5) anon120_Else_correct)))))))
(let ((anon117_Else_correct  (and (=> (= (ControlFlow 0 166) (- 0 167)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@10 n_1)) (select g0@@10 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@1 next))
)) (forall ((o_4@@9 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv69 o_4@@9)) (< NoPerm FullPerm)) (qpRange69 o_4@@9)) (= (invRecv69 o_4@@9) o_4@@9))
 :qid |stdinbpl.5255:22|
 :skolemid |528|
 :pattern ( (invRecv69 o_4@@9))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@2 next))
)) (forall ((o_4@@10 T@Ref) ) (!  (and (=> (and (and (select g0@@10 (invRecv69 o_4@@10)) (< NoPerm FullPerm)) (qpRange69 o_4@@10)) (and (=> (< NoPerm FullPerm) (= (invRecv69 o_4@@10) o_4@@10)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@10 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@10 next) FullPerm)))) (=> (not (and (and (select g0@@10 (invRecv69 o_4@@10)) (< NoPerm FullPerm)) (qpRange69 o_4@@10))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@10 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@10 next))))
 :qid |stdinbpl.5267:22|
 :skolemid |530|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@10 next))
)))) (=> (and (and (and (and (forall ((o_4@@11 T@Ref) (f_5@@3 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@11 f_5@@3) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@11 f_5@@3)))
 :qid |stdinbpl.5271:29|
 :skolemid |531|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@11 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@11 f_5@@3))
)) (forall ((o_4@@12 T@Ref) (f_5@@4 T@Field_58602_58603) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@12 f_5@@4) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@12 f_5@@4)))
 :qid |stdinbpl.5271:29|
 :skolemid |531|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@12 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@12 f_5@@4))
))) (forall ((o_4@@13 T@Ref) (f_5@@5 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@13 f_5@@5) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@13 f_5@@5)))
 :qid |stdinbpl.5271:29|
 :skolemid |531|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@13 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@13 f_5@@5))
))) (forall ((o_4@@14 T@Ref) (f_5@@6 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@14 f_5@@6) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@14 f_5@@6)))
 :qid |stdinbpl.5271:29|
 :skolemid |531|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@14 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@14 f_5@@6))
...
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_58529_36503_53#PolymorphicMapType_58529| Heap@@41) x0 $allocated)) (and (select (|PolymorphicMapType_58529_36503_53#PolymorphicMapType_58529| Heap@@41) x1_2 $allocated) (not (select g0@@10 null)))) (and (=> (= (ControlFlow 0 168) 1) anon117_Then_correct) (=> (= (ControlFlow 0 168) 166) anon117_Else_correct))))))
