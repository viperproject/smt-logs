...
(let ((anon42_Else_correct  (=> (and (not (select g1@@10 r$0_1)) (= (ControlFlow 0 27) 24)) anon27_correct)))
(let ((anon42_Then_correct  (=> (select g1@@10 r$0_1) (and (=> (= (ControlFlow 0 25) (- 0 26)) (not (select g0@@10 r$0_1))) (=> (not (select g0@@10 r$0_1)) (=> (= (ControlFlow 0 25) 24) anon27_correct))))))
(let ((anon41_Else_correct true))
(let ((anon40_Then_correct true))
(let ((anon38_Else_correct  (=> (forall ((r_2_1 T@Ref) ) (!  (=> (select g0@@10 r_2_1) (not (select g1@@10 r_2_1)))
 :qid |stdinbpl.2775:20|
 :skolemid |301|
 :pattern ( (select g0@@10 r_2_1) (select g1@@10 r_2_1))
...
(let ((anon39_Else_correct  (=> (and (not (select g0@@10 r_1_1)) (= (ControlFlow 0 21) 18)) anon21_correct)))
(let ((anon39_Then_correct  (=> (select g0@@10 r_1_1) (and (=> (= (ControlFlow 0 19) (- 0 20)) (not (select g1@@10 r_1_1))) (=> (not (select g1@@10 r_1_1)) (=> (= (ControlFlow 0 19) 18) anon21_correct))))))
(let ((anon37_Then_correct true))
(let ((anon34_Else_correct  (=> (and (and (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g1@@10 n$2_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1 next) null))) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1 next)))
 :qid |stdinbpl.2741:20|
 :skolemid |300|
...
)) (state Heap@@41 QPMask@1)) (and (|Set#Equal_37295| (|Set#Intersection_37295| g0@@10 g1@@10) |Set#Empty_37301|) (state Heap@@41 QPMask@1))) (and (and (and (=> (= (ControlFlow 0 29) 17) anon37_Then_correct) (=> (= (ControlFlow 0 29) 28) anon38_Else_correct)) (=> (= (ControlFlow 0 29) 19) anon39_Then_correct)) (=> (= (ControlFlow 0 29) 21) anon39_Else_correct)))))
(let ((anon15_correct true))
(let ((anon36_Else_correct  (=> (and (not (and (select g1@@10 n$2_15) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_15 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon36_Then_correct  (=> (and (select g1@@10 n$2_15) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_15 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_37315_37316 QPMask@1 n$2_15 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_15 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon35_Else_correct  (=> (not (select g1@@10 n$2_15)) (and (=> (= (ControlFlow 0 16) 11) anon36_Then_correct) (=> (= (ControlFlow 0 16) 13) anon36_Else_correct)))))
(let ((anon35_Then_correct  (=> (select g1@@10 n$2_15) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_37315_37316 QPMask@1 n$2_15 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_15 next) (and (=> (= (ControlFlow 0 14) 11) anon36_Then_correct) (=> (= (ControlFlow 0 14) 13) anon36_Else_correct)))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@10 n$1_1)) (select g1@@10 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 :qid |stdinbpl.2696:15|
 :skolemid |294|
 ...
 :qid |stdinbpl.2696:15|
 :skolemid |294|
)) (=> (and (and (forall ((n$1_1@@1 T@Ref) ) (!  (=> (and (select g1@@10 n$1_1@@1) (< NoPerm FullPerm)) (and (qpRange29 n$1_1@@1) (= (invRecv29 n$1_1@@1) n$1_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv29 o_9)) (< NoPerm FullPerm)) (qpRange29 o_9)) (= (invRecv29 o_9) o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv29 o_9@@0)) (< NoPerm FullPerm)) (qpRange29 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv29 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv29 o_9@@0)) (< NoPerm FullPerm)) (qpRange29 o_9@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next))))
 :qid |stdinbpl.2718:22|
 :skolemid |298|
...
))) (state Heap@@41 QPMask@1)) (and (and (=> (= (ControlFlow 0 30) 29) anon34_Else_correct) (=> (= (ControlFlow 0 30) 14) anon35_Then_correct)) (=> (= (ControlFlow 0 30) 16) anon35_Else_correct))))))))
(let ((anon33_Then_correct true))
(let ((anon30_Else_correct  (=> (and (forall ((n$0_1 T@Ref) ) (!  (=> (and (select g0@@10 n$0_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_1 next) null))) (select g0@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_1 next)))
 :qid |stdinbpl.2684:20|
 :skolemid |293|
...
)) (not (select g1@@10 null))) (and (=> (= (ControlFlow 0 32) 9) anon33_Then_correct) (=> (= (ControlFlow 0 32) 30) anon33_Else_correct)))))
(let ((anon7_correct true))
(let ((anon32_Else_correct  (=> (and (not (and (select g0@@10 n$0_22) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_22 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon32_Then_correct  (=> (and (select g0@@10 n$0_22) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_22 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$0_22 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_22 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon31_Else_correct  (=> (not (select g0@@10 n$0_22)) (and (=> (= (ControlFlow 0 8) 3) anon32_Then_correct) (=> (= (ControlFlow 0 8) 5) anon32_Else_correct)))))
(let ((anon31_Then_correct  (=> (select g0@@10 n$0_22) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$0_22 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_22 next) (and (=> (= (ControlFlow 0 6) 3) anon32_Then_correct) (=> (= (ControlFlow 0 6) 5) anon32_Else_correct)))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@10 n_1)) (select g0@@10 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 :qid |stdinbpl.2639:15|
 :skolemid |287|
 ...
 :qid |stdinbpl.2639:15|
 :skolemid |287|
)) (=> (and (and (forall ((n_1@@1 T@Ref) ) (!  (=> (and (select g0@@10 n_1@@1) (< NoPerm FullPerm)) (and (qpRange28 n_1@@1) (= (invRecv28 n_1@@1) n_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@1 next))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv28 o_9@@5)) (< NoPerm FullPerm)) (qpRange28 o_9@@5)) (= (invRecv28 o_9@@5) o_9@@5))
 :qid |stdinbpl.2649:22|
 :skolemid |289|
 :pattern ( (invRecv28 o_9@@5))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@2 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select g0@@10 (invRecv28 o_9@@6)) (< NoPerm FullPerm)) (qpRange28 o_9@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv28 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@6 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@6 next) FullPerm)))) (=> (not (and (and (select g0@@10 (invRecv28 o_9@@6)) (< NoPerm FullPerm)) (qpRange28 o_9@@6))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@6 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@6 next))))
...
))) (state Heap@@41 QPMask@0)) (and (and (=> (= (ControlFlow 0 33) 32) anon30_Else_correct) (=> (= (ControlFlow 0 33) 6) anon31_Then_correct)) (=> (= (ControlFlow 0 33) 8) anon31_Else_correct))))))))
(let ((anon29_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (not (select g0@@10 null)))) (and (=> (= (ControlFlow 0 35) 1) anon29_Then_correct) (=> (= (ControlFlow 0 35) 33) anon29_Else_correct)))))
