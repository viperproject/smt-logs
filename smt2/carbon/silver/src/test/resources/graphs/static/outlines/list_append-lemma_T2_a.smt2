...
(let ((anon38_Else_correct  (=> (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_1 next) null))) (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_1 next)))
...
(let ((anon40_Else_correct  (=> (and (not (and (select g_1 n$2_3) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_3 next) null)))) (= (ControlFlow 0 33) 30)) anon18_correct)))
(let ((anon40_Then_correct  (=> (and (select g_1 n$2_3) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_3 next) null))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (HasDirectPerm_29078_29079 QPMask@5 n$2_3 next)) (=> (HasDirectPerm_29078_29079 QPMask@5 n$2_3 next) (=> (= (ControlFlow 0 31) 30) anon18_correct))))))
(let ((anon39_Else_correct  (=> (not (select g_1 n$2_3)) (and (=> (= (ControlFlow 0 36) 31) anon40_Then_correct) (=> (= (ControlFlow 0 36) 33) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> (select g_1 n$2_3) (and (=> (= (ControlFlow 0 34) (- 0 35)) (HasDirectPerm_29078_29079 QPMask@5 n$2_3 next)) (=> (HasDirectPerm_29078_29079 QPMask@5 n$2_3 next) (and (=> (= (ControlFlow 0 34) 31) anon40_Then_correct) (=> (= (ControlFlow 0 34) 33) anon40_Else_correct)))))))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g_1 n$1_1)) (select g_1 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv15 o_9)) (< NoPerm FullPerm)) (qpRange15 o_9)) (= (invRecv15 o_9) o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv15 o_9@@0)) (< NoPerm FullPerm)) (qpRange15 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@0 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv15 o_9@@0)) (< NoPerm FullPerm)) (qpRange15 o_9@@0))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@0 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.1738:22|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@0 next))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@5) o_9@@1 f_5)))
...
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_44212_44213) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1742:29|
 :skolemid |195|
...
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@5) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1742:29|
 :skolemid |195|
...
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@5) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1742:29|
 :skolemid |195|
...
)) (= (ControlFlow 0 19) (- 0 18))) (exists_path_2 ($$ Heap@@19 g_1) u_1@@3 v_2@@6))))
(let ((anon43_Else_correct  (=> (apply_IND ($$ Heap@@19 g_1) (|Set#Singleton_29281| u_1@@3) (inst_uReach_2 ($$ Heap@@19 g_1) u_1@@3)) (=> (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0)) (and (=> (= (ControlFlow 0 24) (- 0 27)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((n$1_2 T@Ref) (n$1_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_2 n$1_2_1)) (select g_1 n$1_2)) (select g_1 n$1_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_2 n$1_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$1_2@@3 next))
)) (=> (and (forall ((o_9@@5 T@Ref) ) (!  (=> (and (select g_1 (invRecv17 o_9@@5)) (and (< NoPerm FullPerm) (qpRange17 o_9@@5))) (= (invRecv17 o_9@@5) o_9@@5))
 :qid |stdinbpl.1929:22|
 :skolemid |212|
 :pattern ( (invRecv17 o_9@@5))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv17 o_9@@6)) (and (< NoPerm FullPerm) (qpRange17 o_9@@6))) (and (= (invRecv17 o_9@@6) o_9@@6) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@4) o_9@@6 next) (- (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@6 next) FullPerm)))) (=> (not (and (select g_1 (invRecv17 o_9@@6)) (and (< NoPerm FullPerm) (qpRange17 o_9@@6)))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@4) o_9@@6 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@6 next))))
 :qid |stdinbpl.1935:22|
 :skolemid |213|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@4) o_9@@6 next))
))) (=> (and (and (and (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@0) o_9@@7 f_5@@3) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@4) o_9@@7 f_5@@3)))
 :qid |stdinbpl.1941:29|
 :skolemid |214|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@4) o_9@@7 f_5@@3))
)) (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_44212_44213) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@8 f_5@@4) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@4) o_9@@8 f_5@@4)))
 :qid |stdinbpl.1941:29|
 :skolemid |214|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@4) o_9@@8 f_5@@4))
))) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@0) o_9@@9 f_5@@5) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@4) o_9@@9 f_5@@5)))
 :qid |stdinbpl.1941:29|
 :skolemid |214|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@4) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@0) o_9@@10 f_5@@6) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@4) o_9@@10 f_5@@6)))
 :qid |stdinbpl.1941:29|
 :skolemid |214|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@4) o_9@@10 f_5@@6))
...
(let ((anon42_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n_4 T@Ref) (n_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4 n_4_1)) (select g_1 n_4)) (select g_1 n_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1)))
...
)) (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((n_4@@1 T@Ref) ) (!  (=> (select g_1 n_4@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) n_4@@1 next) NoPerm)))
 :qid |stdinbpl.1836:21|
 :skolemid |202|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_4@@1 next))
)))))))
...
(let ((anon35_Else_correct  (=> (and (exists_path ($$ Heap@@19 g_1) u_1@@3 v_2@@6) (state Heap@@19 QPMask@0)) (and (=> (= (ControlFlow 0 45) 44) anon36_Then_correct) (=> (= (ControlFlow 0 45) 28) anon36_Else_correct)))))
...
)) (state Heap@@19 QPMask@0)) (=> (and (and (select g_1 u_1@@3) (select g_1 v_2@@6)) (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0))) (and (=> (= (ControlFlow 0 46) 10) anon35_Then_correct) (=> (= (ControlFlow 0 46) 45) anon35_Else_correct))))))
(let ((anon7_correct true))
(let ((anon34_Else_correct  (=> (and (not (and (select g_1 n$0_10) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_10 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon34_Then_correct  (=> (and (select g_1 n$0_10) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_10 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29078_29079 QPMask@0 n$0_10 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0_10 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon33_Else_correct  (=> (not (select g_1 n$0_10)) (and (=> (= (ControlFlow 0 8) 3) anon34_Then_correct) (=> (= (ControlFlow 0 8) 5) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (select g_1 n$0_10) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29078_29079 QPMask@0 n$0_10 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0_10 next) (and (=> (= (ControlFlow 0 6) 3) anon34_Then_correct) (=> (= (ControlFlow 0 6) 5) anon34_Else_correct)))))))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 47) (- 0 48)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@1 next))
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv13 o_9@@11)) (< NoPerm FullPerm)) (qpRange13 o_9@@11)) (= (invRecv13 o_9@@11) o_9@@11))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@2 next))
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv13 o_9@@12)) (< NoPerm FullPerm)) (qpRange13 o_9@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv13 o_9@@12) o_9@@12)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@12 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@12 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv13 o_9@@12)) (< NoPerm FullPerm)) (qpRange13 o_9@@12))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@12 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@12 next))))
