...
(let ((anon62_Else_correct  (=> (exists_path ($$ PostHeap@0 (|Set#Union_37395| g0@@10 g1@@10)) x1_2 y1) (=> (and (state PostHeap@0 QPMask@7) (state PostHeap@0 QPMask@7)) (and (=> (= (ControlFlow 0 58) 55) anon63_Then_correct) (=> (= (ControlFlow 0 58) 57) anon63_Else_correct))))))
(let ((anon62_Then_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((n_4_1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1 n_4_2)) (select (|Set#Union_37395| g0@@10 g1@@10) n_4_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1 n_4_2)))
 :qid |stdinbpl.3851:21|
 :skolemid |402|
 :pattern ( (neverTriggered47 n_4_1) (neverTriggered47 n_4_2))
))) (=> (forall ((n_4_1@@0 T@Ref) (n_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1@@0 n_4_2@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_4_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1@@0 n_4_2@@0)))
 :qid |stdinbpl.3851:21|
 :skolemid |402|
 :pattern ( (neverTriggered47 n_4_1@@0) (neverTriggered47 n_4_2@@0))
)) (=> (= (ControlFlow 0 52) (- 0 51)) (forall ((n_4_1@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_4_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n_4_1@@1 next) NoPerm)))
 :qid |stdinbpl.3858:21|
 :skolemid |403|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_4_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) n_4_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n_4_1@@1 next))
)))))))
(let ((anon59_Else_correct  (=> (forall ((n$4_1_2 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g1@@10 g0@@10) n$4_1_2) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_1_2 next) null))) (select (|Set#Union_37395| g1@@10 g0@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_1_2 next)))
 :qid |stdinbpl.3832:20|
 :skolemid |401|
 :pattern ( (select (|Set#Union_37395| g1@@10 g0@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_1_2 next)))
 :pattern ( (select (|Set#Union_37395| g1@@10 g0@@10) n$4_1_2) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$4_1_2 next))
...
(let ((anon58_Else_correct  (and (=> (= (ControlFlow 0 60) (- 0 61)) (forall ((n$3_1_2 T@Ref) (n$3_1_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_1_2 n$3_1_3)) (select (|Set#Union_37395| g1@@10 g0@@10) n$3_1_2)) (select (|Set#Union_37395| g1@@10 g0@@10) n$3_1_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_1_2 n$3_1_3)))
 :qid |stdinbpl.3787:15|
 :skolemid |395|
))) (=> (forall ((n$3_1_2@@0 T@Ref) (n$3_1_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_1_2@@0 n$3_1_3@@0)) (select (|Set#Union_37395| g1@@10 g0@@10) n$3_1_2@@0)) (select (|Set#Union_37395| g1@@10 g0@@10) n$3_1_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_1_2@@0 n$3_1_3@@0)))
 :qid |stdinbpl.3787:15|
 :skolemid |395|
)) (=> (and (and (forall ((n$3_1_2@@1 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g1@@10 g0@@10) n$3_1_2@@1) (< NoPerm FullPerm)) (and (qpRange46 n$3_1_2@@1) (= (invRecv46 n$3_1_2@@1) n$3_1_2@@1)))
 :qid |stdinbpl.3793:22|
 :skolemid |396|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n$3_1_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1_2@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select (|Set#Union_37395| g1@@10 g0@@10) (invRecv46 o_4)) (< NoPerm FullPerm)) (qpRange46 o_4)) (= (invRecv46 o_4) o_4))
 :qid |stdinbpl.3797:22|
 :skolemid |397|
 :pattern ( (invRecv46 o_4))
))) (and (forall ((n$3_1_2@@2 T@Ref) ) (!  (=> (select (|Set#Union_37395| g1@@10 g0@@10) n$3_1_2@@2) (not (= n$3_1_2@@2 null)))
 :qid |stdinbpl.3803:22|
 :skolemid |398|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n$3_1_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| PostHeap@0) n$3_1_2@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select (|Set#Union_37395| g1@@10 g0@@10) (invRecv46 o_4@@0)) (< NoPerm FullPerm)) (qpRange46 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv46 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) o_4@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@0 next) FullPerm)))) (=> (not (and (and (select (|Set#Union_37395| g1@@10 g0@@10) (invRecv46 o_4@@0)) (< NoPerm FullPerm)) (qpRange46 o_4@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) o_4@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@0 next))))
 :qid |stdinbpl.3809:22|
 :skolemid |399|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) o_4@@0 next))
)))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@7) o_4@@1 f_5)))
 :qid |stdinbpl.3813:29|
 :skolemid |400|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@7) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_58602_58603) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) o_4@@2 f_5@@0)))
 :qid |stdinbpl.3813:29|
 :skolemid |400|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@7) o_4@@3 f_5@@1)))
 :qid |stdinbpl.3813:29|
 :skolemid |400|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@7) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@7) o_4@@4 f_5@@2)))
 :qid |stdinbpl.3813:29|
 :skolemid |400|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@7) o_4@@4 f_5@@2))
...
(let ((anon66_Else_correct  (=> (and (not (and (select (|Set#Union_37395| g1@@10 g0@@10) n$4_2_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2_1 next) null)))) (= (ControlFlow 0 37) 34)) anon43_correct)))
(let ((anon66_Then_correct  (=> (and (select (|Set#Union_37395| g1@@10 g0@@10) n$4_2_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2_1 next) null))) (and (=> (= (ControlFlow 0 35) (- 0 36)) (select (|Set#Union_37395| g1@@10 g0@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2_1 next))) (=> (select (|Set#Union_37395| g1@@10 g0@@10) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$4_2_1 next)) (=> (= (ControlFlow 0 35) 34) anon43_correct))))))
...
)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) x1_2 y1)) (=> (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) x1_2 y1) (=> (= (ControlFlow 0 32) (- 0 31)) (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) x0 y0)))))))
(let ((anon64_Else_correct  (=> (apply_TCFraming Heap@@41 g0@@10 g1@@10) (=> (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 38) (- 0 41)) (not (select (|Set#Union_37395| g1@@10 g0@@10) null))) (=> (not (select (|Set#Union_37395| g1@@10 g0@@10) null)) (and (=> (= (ControlFlow 0 38) (- 0 40)) (forall ((n$3_2 T@Ref) (n$3_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_2 n$3_2_1)) (select (|Set#Union_37395| g1@@10 g0@@10) n$3_2)) (select (|Set#Union_37395| g1@@10 g0@@10) n$3_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_2 n$3_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$3_2@@3 next))
)) (=> (and (forall ((o_4@@5 T@Ref) ) (!  (=> (and (select (|Set#Union_37395| g1@@10 g0@@10) (invRecv49 o_4@@5)) (and (< NoPerm FullPerm) (qpRange49 o_4@@5))) (= (invRecv49 o_4@@5) o_4@@5))
 :qid |stdinbpl.4035:22|
 :skolemid |421|
 :pattern ( (invRecv49 o_4@@5))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (select (|Set#Union_37395| g1@@10 g0@@10) (invRecv49 o_4@@6)) (and (< NoPerm FullPerm) (qpRange49 o_4@@6))) (and (= (invRecv49 o_4@@6) o_4@@6) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) o_4@@6 next) (- (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@6 next) FullPerm)))) (=> (not (and (select (|Set#Union_37395| g1@@10 g0@@10) (invRecv49 o_4@@6)) (and (< NoPerm FullPerm) (qpRange49 o_4@@6)))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) o_4@@6 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@6 next))))
 :qid |stdinbpl.4041:22|
 :skolemid |422|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) o_4@@6 next))
))) (=> (and (and (and (forall ((o_4@@7 T@Ref) (f_5@@3 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@7 f_5@@3) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@6) o_4@@7 f_5@@3)))
 :qid |stdinbpl.4047:29|
 :skolemid |423|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@6) o_4@@7 f_5@@3))
)) (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_58602_58603) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@8 f_5@@4) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) o_4@@8 f_5@@4)))
 :qid |stdinbpl.4047:29|
 :skolemid |423|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) o_4@@8 f_5@@4))
))) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_4@@9 f_5@@5) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@6) o_4@@9 f_5@@5)))
 :qid |stdinbpl.4047:29|
 :skolemid |423|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@6) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_4@@10 f_5@@6) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@6) o_4@@10 f_5@@6)))
 :qid |stdinbpl.4047:29|
 :skolemid |423|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@6) o_4@@10 f_5@@6))
...
(let ((anon64_Then_correct  (and (=> (= (ControlFlow 0 26) (- 0 30)) (forall ((n_6 T@Ref) (n_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6 n_6_1)) (select g0@@10 n_6)) (select g0@@10 n_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_6@@3 next))
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (select g0@@10 (invRecv50 o_4@@11)) (and (< NoPerm FullPerm) (qpRange50 o_4@@11))) (= (invRecv50 o_4@@11) o_4@@11))
 :qid |stdinbpl.3961:26|
 :skolemid |413|
 :pattern ( (invRecv50 o_4@@11))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@3 next))
)) (=> (and (forall ((o_4@@12 T@Ref) ) (!  (=> (and (select g1@@10 (invRecv51 o_4@@12)) (and (< NoPerm FullPerm) (qpRange51 o_4@@12))) (= (invRecv51 o_4@@12) o_4@@12))
 :qid |stdinbpl.3989:26|
 :skolemid |417|
 :pattern ( (invRecv51 o_4@@12))
...
(let ((anon56_Else_correct  (=> (and (exists_path ($$ Heap@@41 g1@@10) x1_2 y1) (state Heap@@41 QPMask@1)) (and (=> (= (ControlFlow 0 63) 62) anon57_Then_correct) (=> (= (ControlFlow 0 63) 42) anon57_Else_correct)))))
...
(let ((anon50_Else_correct  (=> (and (and (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g1@@10 n$2_1_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next) null))) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next)))
 :qid |stdinbpl.3650:20|
 :skolemid |384|
 :pattern ( (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next)))
 :pattern ( (select g1@@10 n$2_1_1) (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next))
)) (state Heap@@41 QPMask@1)) (and (select g0@@10 x0) (select g0@@10 y0))) (and (and (state Heap@@41 QPMask@1) (select g1@@10 x1_2)) (and (select g1@@10 y1) (state Heap@@41 QPMask@1)))) (and (=> (= (ControlFlow 0 67) 17) anon53_Then_correct) (=> (= (ControlFlow 0 67) 66) anon53_Else_correct)))))
(let ((anon15_correct true))
(let ((anon52_Else_correct  (=> (and (not (and (select g1@@10 n$2_19) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_19 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon52_Then_correct  (=> (and (select g1@@10 n$2_19) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_19 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_37315_37316 QPMask@1 n$2_19 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_19 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon51_Else_correct  (=> (not (select g1@@10 n$2_19)) (and (=> (= (ControlFlow 0 16) 11) anon52_Then_correct) (=> (= (ControlFlow 0 16) 13) anon52_Else_correct)))))
(let ((anon51_Then_correct  (=> (select g1@@10 n$2_19) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_37315_37316 QPMask@1 n$2_19 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_19 next) (and (=> (= (ControlFlow 0 14) 11) anon52_Then_correct) (=> (= (ControlFlow 0 14) 13) anon52_Else_correct)))))))
(let ((anon49_Else_correct  (and (=> (= (ControlFlow 0 68) (- 0 69)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@10 n$1_1)) (select g1@@10 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@1 next))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv43 o_4@@13)) (< NoPerm FullPerm)) (qpRange43 o_4@@13)) (= (invRecv43 o_4@@13) o_4@@13))
 :qid |stdinbpl.3615:22|
 :skolemid |380|
 :pattern ( (invRecv43 o_4@@13))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@2 next))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv43 o_4@@14)) (< NoPerm FullPerm)) (qpRange43 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv43 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@14 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@14 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv43 o_4@@14)) (< NoPerm FullPerm)) (qpRange43 o_4@@14))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@14 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@14 next))))
 :qid |stdinbpl.3627:22|
 :skolemid |382|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@14 next))
)))) (=> (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@7 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@15 f_5@@7) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@15 f_5@@7)))
 :qid |stdinbpl.3631:29|
 :skolemid |383|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@15 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@15 f_5@@7))
)) (forall ((o_4@@16 T@Ref) (f_5@@8 T@Field_58602_58603) ) (!  (=> (not (= f_5@@8 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@16 f_5@@8) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@16 f_5@@8)))
 :qid |stdinbpl.3631:29|
 :skolemid |383|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@16 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@16 f_5@@8))
))) (forall ((o_4@@17 T@Ref) (f_5@@9 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@17 f_5@@9) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_4@@17 f_5@@9)))
 :qid |stdinbpl.3631:29|
 :skolemid |383|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@17 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_4@@17 f_5@@9))
))) (forall ((o_4@@18 T@Ref) (f_5@@10 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@18 f_5@@10) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_4@@18 f_5@@10)))
 :qid |stdinbpl.3631:29|
 :skolemid |383|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@18 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_4@@18 f_5@@10))
...
(let ((anon48_Else_correct  (=> (and (not (and (select g0@@10 n$0_21) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_21 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon48_Then_correct  (=> (and (select g0@@10 n$0_21) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_21 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$0_21 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_21 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon47_Else_correct  (=> (not (select g0@@10 n$0_21)) (and (=> (= (ControlFlow 0 8) 3) anon48_Then_correct) (=> (= (ControlFlow 0 8) 5) anon48_Else_correct)))))
(let ((anon47_Then_correct  (=> (select g0@@10 n$0_21) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$0_21 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_21 next) (and (=> (= (ControlFlow 0 6) 3) anon48_Then_correct) (=> (= (ControlFlow 0 6) 5) anon48_Else_correct)))))))
(let ((anon45_Else_correct  (and (=> (= (ControlFlow 0 71) (- 0 72)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@10 n_1)) (select g0@@10 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@1 next))
)) (forall ((o_4@@19 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv42 o_4@@19)) (< NoPerm FullPerm)) (qpRange42 o_4@@19)) (= (invRecv42 o_4@@19) o_4@@19))
 :qid |stdinbpl.3557:22|
 :skolemid |373|
 :pattern ( (invRecv42 o_4@@19))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@2 next))
)) (forall ((o_4@@20 T@Ref) ) (!  (and (=> (and (and (select g0@@10 (invRecv42 o_4@@20)) (< NoPerm FullPerm)) (qpRange42 o_4@@20)) (and (=> (< NoPerm FullPerm) (= (invRecv42 o_4@@20) o_4@@20)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@20 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@20 next) FullPerm)))) (=> (not (and (and (select g0@@10 (invRecv42 o_4@@20)) (< NoPerm FullPerm)) (qpRange42 o_4@@20))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@20 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@20 next))))
 :qid |stdinbpl.3569:22|
 :skolemid |375|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@20 next))
)))) (=> (and (and (and (and (forall ((o_4@@21 T@Ref) (f_5@@11 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@21 f_5@@11) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@21 f_5@@11)))
 :qid |stdinbpl.3573:29|
 :skolemid |376|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@21 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@21 f_5@@11))
)) (forall ((o_4@@22 T@Ref) (f_5@@12 T@Field_58602_58603) ) (!  (=> (not (= f_5@@12 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@22 f_5@@12) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@22 f_5@@12)))
 :qid |stdinbpl.3573:29|
 :skolemid |376|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@22 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@22 f_5@@12))
))) (forall ((o_4@@23 T@Ref) (f_5@@13 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@23 f_5@@13) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@23 f_5@@13)))
 :qid |stdinbpl.3573:29|
 :skolemid |376|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@23 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@23 f_5@@13))
))) (forall ((o_4@@24 T@Ref) (f_5@@14 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@24 f_5@@14) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@24 f_5@@14)))
 :qid |stdinbpl.3573:29|
 :skolemid |376|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@24 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@24 f_5@@14))
...
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_58529_36503_53#PolymorphicMapType_58529| Heap@@41) x0 $allocated))) (and (and (select (|PolymorphicMapType_58529_36503_53#PolymorphicMapType_58529| Heap@@41) y0 $allocated) (select (|PolymorphicMapType_58529_36503_53#PolymorphicMapType_58529| Heap@@41) x1_2 $allocated)) (and (select (|PolymorphicMapType_58529_36503_53#PolymorphicMapType_58529| Heap@@41) y1 $allocated) (not (select g0@@10 null))))) (and (=> (= (ControlFlow 0 73) 1) anon45_Then_correct) (=> (= (ControlFlow 0 73) 71) anon45_Else_correct)))))
