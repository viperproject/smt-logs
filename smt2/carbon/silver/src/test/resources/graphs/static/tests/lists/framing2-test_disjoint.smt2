...
(let ((anon104_Then_correct  (=> (and (select g1@@8 u_25) (and (select g1@@8 v_25) (exists_path ($$ PostHeap@0 g0@@8) u_25 v_25))) (and (=> (= (ControlFlow 0 102) 99) anon105_Then_correct) (=> (= (ControlFlow 0 102) 96) anon47_correct)))))
(let ((anon104_Else_correct  (=> (and (not (and (select g1@@8 u_25) (and (select g1@@8 v_25) (exists_path ($$ PostHeap@0 g0@@8) u_25 v_25)))) (= (ControlFlow 0 97) 96)) anon47_correct)))
(let ((anon102_Then_correct  (=> (select g1@@8 v_25) (and (and (=> (= (ControlFlow 0 109) 106) anon103_Then_correct) (=> (= (ControlFlow 0 109) 102) anon104_Then_correct)) (=> (= (ControlFlow 0 109) 97) anon104_Else_correct)))))
(let ((anon102_Else_correct  (=> (not (select g1@@8 v_25)) (and (=> (= (ControlFlow 0 104) 102) anon104_Then_correct) (=> (= (ControlFlow 0 104) 97) anon104_Else_correct)))))
(let ((anon101_Then_correct  (=> (select g1@@8 u_25) (and (=> (= (ControlFlow 0 110) 109) anon102_Then_correct) (=> (= (ControlFlow 0 110) 104) anon102_Else_correct)))))
(let ((anon101_Else_correct  (=> (not (select g1@@8 u_25)) (and (=> (= (ControlFlow 0 103) 102) anon104_Then_correct) (=> (= (ControlFlow 0 103) 97) anon104_Else_correct)))))
...
(let ((anon99_Then_correct  (and (=> (= (ControlFlow 0 83) (- 0 85)) (forall ((n_4_1 T@Ref) ) (!  (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) n_4_1) (dummyFunction_29365 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n_4_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2734:25|
 :skolemid |311|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n_4_1 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@10) n_4_1 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n_4_1 next))
))) (=> (forall ((n_4_1@@0 T@Ref) ) (!  (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) n_4_1@@0) (dummyFunction_29365 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n_4_1@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2734:25|
 :skolemid |311|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n_4_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@10) n_4_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n_4_1@@0 next))
)) (and (=> (= (ControlFlow 0 83) (- 0 84)) (forall ((n_4_1@@1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1@@1 n_4_2)) (select (|Set#Union_29737| g0@@8 g1@@8) n_4_1@@1)) (select (|Set#Union_29737| g0@@8 g1@@8) n_4_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_4_1@@1 n_4_2)))
 :qid |stdinbpl.2741:25|
 :skolemid |312|
 :pattern ( (neverTriggered29 n_4_1@@1) (neverTriggered29 n_4_2))
))) (=> (forall ((n_4_1@@2 T@Ref) (n_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1@@2 n_4_2@@0)) (select (|Set#Union_29737| g0@@8 g1@@8) n_4_1@@2)) (select (|Set#Union_29737| g0@@8 g1@@8) n_4_2@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_4_1@@2 n_4_2@@0)))
 :qid |stdinbpl.2741:25|
 :skolemid |312|
 :pattern ( (neverTriggered29 n_4_1@@2) (neverTriggered29 n_4_2@@0))
)) (=> (= (ControlFlow 0 83) (- 0 82)) (forall ((n_4_1@@3 T@Ref) ) (!  (=> (select (|Set#Union_29737| g0@@8 g1@@8) n_4_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@6) n_4_1@@3 next) NoPerm)))
 :qid |stdinbpl.2748:25|
 :skolemid |313|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@10) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n_4_1@@3 next))
)))))))))
(let ((anon38_correct true))
(let ((anon98_Then_correct  (=> (and (select g0@@8 u_24) (and (select g0@@8 v_24) (exists_path ($$ PostHeap@0 g0@@8) u_24 v_24))) (and (=> (= (ControlFlow 0 86) 83) anon99_Then_correct) (=> (= (ControlFlow 0 86) 80) anon38_correct)))))
(let ((anon98_Else_correct  (=> (and (not (and (select g0@@8 u_24) (and (select g0@@8 v_24) (exists_path ($$ PostHeap@0 g0@@8) u_24 v_24)))) (= (ControlFlow 0 81) 80)) anon38_correct)))
(let ((anon96_Then_correct  (=> (select g0@@8 v_24) (and (and (=> (= (ControlFlow 0 93) 90) anon97_Then_correct) (=> (= (ControlFlow 0 93) 86) anon98_Then_correct)) (=> (= (ControlFlow 0 93) 81) anon98_Else_correct)))))
(let ((anon96_Else_correct  (=> (not (select g0@@8 v_24)) (and (=> (= (ControlFlow 0 88) 86) anon98_Then_correct) (=> (= (ControlFlow 0 88) 81) anon98_Else_correct)))))
(let ((anon95_Then_correct  (=> (select g0@@8 u_24) (and (=> (= (ControlFlow 0 94) 93) anon96_Then_correct) (=> (= (ControlFlow 0 94) 88) anon96_Else_correct)))))
(let ((anon95_Else_correct  (=> (not (select g0@@8 u_24)) (and (=> (= (ControlFlow 0 87) 86) anon98_Then_correct) (=> (= (ControlFlow 0 87) 81) anon98_Else_correct)))))
(let ((anon91_Else_correct  (=> (forall ((u_1@@1 T@Ref) (v_1_1@@1 T@Ref) ) (!  (=> (and (select g0@@8 u_1@@1) (select g1@@8 v_1_1@@1)) (not (exists_path ($$ PostHeap@0 (|Set#Union_29737| g0@@8 g1@@8)) u_1@@1 v_1_1@@1)))
 :qid |stdinbpl.2669:20|
 :skolemid |305|
 :pattern ( (select g0@@8 u_1@@1) (select g1@@8 v_1_1@@1))
 :pattern ( (select g0@@8 u_1@@1) (exists_path (|$$#frame| (FrameFragment_5743 (|$$#condqp1| PostHeap@0 (|Set#Union_29737| g0@@8 g1@@8))) (|Set#Union_29737| g0@@8 g1@@8)) u_1@@1 v_1_1@@1))
 :pattern ( (select g1@@8 v_1_1@@1) (exists_path (|$$#frame| (FrameFragment_5743 (|$$#condqp1| PostHeap@0 (|Set#Union_29737| g0@@8 g1@@8))) (|Set#Union_29737| g0@@8 g1@@8)) u_1@@1 v_1_1@@1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_5743 (|$$#condqp1| PostHeap@0 (|Set#Union_29737| g0@@8 g1@@8))) (|Set#Union_29737| g0@@8 g1@@8)) u_1@@1 v_1_1@@1))
...
(let ((anon92_Then_correct  (=> (and (select g0@@8 u_23) (select g1@@8 v_23)) (and (=> (= (ControlFlow 0 79) 76) anon93_Then_correct) (=> (= (ControlFlow 0 79) 73) anon29_correct)))))
(let ((anon92_Else_correct  (=> (and (not (and (select g0@@8 u_23) (select g1@@8 v_23))) (= (ControlFlow 0 74) 73)) anon29_correct)))
(let ((anon88_Else_correct  (=> (forall ((n$4_1_2 T@Ref) ) (!  (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) n$4_1_2) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$4_1_2 next) null))) (select (|Set#Union_29737| g0@@8 g1@@8) (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$4_1_2 next)))
 :qid |stdinbpl.2613:20|
 :skolemid |299|
 :pattern ( (select (|Set#Union_29737| g0@@8 g1@@8) (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$4_1_2 next)))
 :pattern ( (select (|Set#Union_29737| g0@@8 g1@@8) n$4_1_2) (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$4_1_2 next))
...
(let ((anon90_Else_correct  (=> (and (not (and (select (|Set#Union_29737| g0@@8 g1@@8) n$4_9) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$4_9 next) null)))) (= (ControlFlow 0 69) 66)) anon24_correct)))
(let ((anon90_Then_correct  (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) n$4_9) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$4_9 next) null))) (and (=> (= (ControlFlow 0 67) (- 0 68)) (HasDirectPerm_29364_29365 QPMask@6 n$4_9 next)) (=> (HasDirectPerm_29364_29365 QPMask@6 n$4_9 next) (=> (= (ControlFlow 0 67) 66) anon24_correct))))))
(let ((anon89_Else_correct  (=> (not (select (|Set#Union_29737| g0@@8 g1@@8) n$4_9)) (and (=> (= (ControlFlow 0 72) 67) anon90_Then_correct) (=> (= (ControlFlow 0 72) 69) anon90_Else_correct)))))
(let ((anon89_Then_correct  (=> (select (|Set#Union_29737| g0@@8 g1@@8) n$4_9) (and (=> (= (ControlFlow 0 70) (- 0 71)) (HasDirectPerm_29364_29365 QPMask@6 n$4_9 next)) (=> (HasDirectPerm_29364_29365 QPMask@6 n$4_9 next) (and (=> (= (ControlFlow 0 70) 67) anon90_Then_correct) (=> (= (ControlFlow 0 70) 69) anon90_Else_correct)))))))
(let ((anon87_Else_correct  (and (=> (= (ControlFlow 0 114) (- 0 115)) (forall ((n$3_1_2 T@Ref) (n$3_1_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_1_2 n$3_1_3)) (select (|Set#Union_29737| g0@@8 g1@@8) n$3_1_2)) (select (|Set#Union_29737| g0@@8 g1@@8) n$3_1_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_1_2 n$3_1_3)))
 :qid |stdinbpl.2568:15|
 :skolemid |293|
))) (=> (forall ((n$3_1_2@@0 T@Ref) (n$3_1_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_1_2@@0 n$3_1_3@@0)) (select (|Set#Union_29737| g0@@8 g1@@8) n$3_1_2@@0)) (select (|Set#Union_29737| g0@@8 g1@@8) n$3_1_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_1_2@@0 n$3_1_3@@0)))
 :qid |stdinbpl.2568:15|
 :skolemid |293|
)) (=> (and (and (forall ((n$3_1_2@@1 T@Ref) ) (!  (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) n$3_1_2@@1) (< NoPerm FullPerm)) (and (qpRange26 n$3_1_2@@1) (= (invRecv26 n$3_1_2@@1) n$3_1_2@@1)))
 :qid |stdinbpl.2574:22|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$3_1_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@6) n$3_1_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$3_1_2@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv26 o_4)) (< NoPerm FullPerm)) (qpRange26 o_4)) (= (invRecv26 o_4) o_4))
 :qid |stdinbpl.2578:22|
 :skolemid |295|
 :pattern ( (invRecv26 o_4))
))) (and (forall ((n$3_1_2@@2 T@Ref) ) (!  (=> (select (|Set#Union_29737| g0@@8 g1@@8) n$3_1_2@@2) (not (= n$3_1_2@@2 null)))
 :qid |stdinbpl.2584:22|
 :skolemid |296|
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$3_1_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@6) n$3_1_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| PostHeap@0) n$3_1_2@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv26 o_4@@0)) (< NoPerm FullPerm)) (qpRange26 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv26 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@6) o_4@@0 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@0 next) FullPerm)))) (=> (not (and (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv26 o_4@@0)) (< NoPerm FullPerm)) (qpRange26 o_4@@0))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@6) o_4@@0 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@0 next))))
 :qid |stdinbpl.2590:22|
 :skolemid |297|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@6) o_4@@0 next))
)))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_46438_53) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@6) o_4@@1 f_5)))
 :qid |stdinbpl.2594:29|
 :skolemid |298|
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@6) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_46451_46452) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@6) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2594:29|
 :skolemid |298|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@6) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_29364_147463) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@6) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2594:29|
 :skolemid |298|
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@6) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_29364_147596) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@6) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2594:29|
 :skolemid |298|
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@6) o_4@@4 f_5@@2))
...
(let ((anon108_Else_correct  (=> (forall ((n$0_3_1 T@Ref) ) (!  (=> (and (select g0@@8 n$0_3_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_3_1 next) null))) (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_3_1 next)))
 :qid |stdinbpl.2980:24|
 :skolemid |337|
 :pattern ( (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_3_1 next)))
 :pattern ( (select g0@@8 n$0_3_1) (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_3_1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_2@@3 next))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (select g1@@8 (invRecv35 o_4@@5)) (and (< NoPerm FullPerm) (qpRange35 o_4@@5))) (= (invRecv35 o_4@@5) o_4@@5))
 :qid |stdinbpl.3010:26|
 :skolemid |341|
 :pattern ( (invRecv35 o_4@@5))
...
(let ((anon109_Else_correct  (=> (and (not (and (select g0@@8 n$0_2_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next) null)))) (= (ControlFlow 0 48) 45)) anon55_correct)))
(let ((anon109_Then_correct  (=> (and (select g0@@8 n$0_2_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next) null))) (and (=> (= (ControlFlow 0 46) (- 0 47)) (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next))) (=> (select g0@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_2_1 next)) (=> (= (ControlFlow 0 46) 45) anon55_correct))))))
(let ((anon107_Then_correct  (and (=> (= (ControlFlow 0 59) (- 0 62)) (not (select g0@@8 null))) (=> (not (select g0@@8 null)) (and (=> (= (ControlFlow 0 59) (- 0 61)) (forall ((n_8 T@Ref) (n_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_8 n_8_1)) (select g0@@8 n_8)) (select g0@@8 n_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_8 n_8_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_8@@3 next))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (select g0@@8 (invRecv34 o_4@@6)) (and (< NoPerm FullPerm) (qpRange34 o_4@@6))) (= (invRecv34 o_4@@6) o_4@@6))
 :qid |stdinbpl.2969:26|
 :skolemid |336|
 :pattern ( (invRecv34 o_4@@6))
...
(let ((anon119_Else_correct  (=> (and (not (and (select g1@@8 u_10_1) (and (select g1@@8 v_10_1) (exists_path ($$ Heap@@33 g0@@8) u_10_1 v_10_1)))) (= (ControlFlow 0 37) 34)) anon76_correct)))
(let ((anon119_Then_correct  (=> (and (select g1@@8 u_10_1) (and (select g1@@8 v_10_1) (exists_path ($$ Heap@@33 g0@@8) u_10_1 v_10_1))) (and (=> (= (ControlFlow 0 35) (- 0 36)) (exists_path ($$ Heap@@33 (|Set#Union_29737| g0@@8 g1@@8)) u_10_1 v_10_1)) (=> (exists_path ($$ Heap@@33 (|Set#Union_29737| g0@@8 g1@@8)) u_10_1 v_10_1) (=> (= (ControlFlow 0 35) 34) anon76_correct))))))
...
(let ((anon117_Else_correct  (=> (and (not (and (select g0@@8 u_8_1) (and (select g0@@8 v_8_1) (exists_path ($$ Heap@@33 g0@@8) u_8_1 v_8_1)))) (= (ControlFlow 0 32) 29)) anon72_correct)))
(let ((anon117_Then_correct  (=> (and (select g0@@8 u_8_1) (and (select g0@@8 v_8_1) (exists_path ($$ Heap@@33 g0@@8) u_8_1 v_8_1))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (exists_path ($$ Heap@@33 (|Set#Union_29737| g0@@8 g1@@8)) u_8_1 v_8_1)) (=> (exists_path ($$ Heap@@33 (|Set#Union_29737| g0@@8 g1@@8)) u_8_1 v_8_1) (=> (= (ControlFlow 0 30) 29) anon72_correct))))))
...
(let ((anon113_Else_correct  (=> (and (not (and (select (|Set#Union_29737| g0@@8 g1@@8) n$4_2_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$4_2_1 next) null)))) (= (ControlFlow 0 24) 21)) anon64_correct)))
(let ((anon113_Then_correct  (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) n$4_2_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$4_2_1 next) null))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (select (|Set#Union_29737| g0@@8 g1@@8) (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$4_2_1 next))) (=> (select (|Set#Union_29737| g0@@8 g1@@8) (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$4_2_1 next)) (=> (= (ControlFlow 0 22) 21) anon64_correct))))))
(let ((anon107_Else_correct  (=> (apply_TCFraming Heap@@33 g0@@8 g1@@8) (=> (and (state Heap@@33 QPMask@1) (state Heap@@33 QPMask@1)) (and (=> (= (ControlFlow 0 41) (- 0 44)) (not (select (|Set#Union_29737| g0@@8 g1@@8) null))) (=> (not (select (|Set#Union_29737| g0@@8 g1@@8) null)) (and (=> (= (ControlFlow 0 41) (- 0 43)) (forall ((n$3_2 T@Ref) (n$3_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$3_2 n$3_2_1)) (select (|Set#Union_29737| g0@@8 g1@@8) n$3_2)) (select (|Set#Union_29737| g0@@8 g1@@8) n$3_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$3_2 n$3_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$3_2@@3 next))
)) (=> (and (forall ((o_4@@7 T@Ref) ) (!  (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv32 o_4@@7)) (and (< NoPerm FullPerm) (qpRange32 o_4@@7))) (= (invRecv32 o_4@@7) o_4@@7))
 :qid |stdinbpl.3067:22|
 :skolemid |346|
 :pattern ( (invRecv32 o_4@@7))
)) (forall ((o_4@@8 T@Ref) ) (!  (and (=> (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv32 o_4@@8)) (and (< NoPerm FullPerm) (qpRange32 o_4@@8))) (and (= (invRecv32 o_4@@8) o_4@@8) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@4) o_4@@8 next) (- (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@8 next) FullPerm)))) (=> (not (and (select (|Set#Union_29737| g0@@8 g1@@8) (invRecv32 o_4@@8)) (and (< NoPerm FullPerm) (qpRange32 o_4@@8)))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@4) o_4@@8 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@8 next))))
 :qid |stdinbpl.3073:22|
 :skolemid |347|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@4) o_4@@8 next))
))) (=> (and (and (and (forall ((o_4@@9 T@Ref) (f_5@@3 T@Field_46438_53) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@1) o_4@@9 f_5@@3) (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@4) o_4@@9 f_5@@3)))
 :qid |stdinbpl.3079:29|
 :skolemid |348|
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@4) o_4@@9 f_5@@3))
)) (forall ((o_4@@10 T@Ref) (f_5@@4 T@Field_46451_46452) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@10 f_5@@4) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@4) o_4@@10 f_5@@4)))
 :qid |stdinbpl.3079:29|
 :skolemid |348|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@4) o_4@@10 f_5@@4))
))) (forall ((o_4@@11 T@Ref) (f_5@@5 T@Field_29364_147463) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@1) o_4@@11 f_5@@5) (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@4) o_4@@11 f_5@@5)))
 :qid |stdinbpl.3079:29|
 :skolemid |348|
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@4) o_4@@11 f_5@@5))
))) (forall ((o_4@@12 T@Ref) (f_5@@6 T@Field_29364_147596) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@1) o_4@@12 f_5@@6) (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@4) o_4@@12 f_5@@6)))
 :qid |stdinbpl.3079:29|
 :skolemid |348|
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@4) o_4@@12 f_5@@6))
...
(let ((anon83_Else_correct  (=> (and (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g1@@8 n$2_1_1) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_1_1 next) null))) (select g1@@8 (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_1_1 next)))
...
(let ((anon85_Else_correct  (=> (and (not (and (select g1@@8 n$2_25) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_25 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon85_Then_correct  (=> (and (select g1@@8 n$2_25) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$2_25 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_29364_29365 QPMask@1 n$2_25 next)) (=> (HasDirectPerm_29364_29365 QPMask@1 n$2_25 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon84_Else_correct  (=> (not (select g1@@8 n$2_25)) (and (=> (= (ControlFlow 0 16) 11) anon85_Then_correct) (=> (= (ControlFlow 0 16) 13) anon85_Else_correct)))))
(let ((anon84_Then_correct  (=> (select g1@@8 n$2_25) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_29364_29365 QPMask@1 n$2_25 next)) (=> (HasDirectPerm_29364_29365 QPMask@1 n$2_25 next) (and (=> (= (ControlFlow 0 14) 11) anon85_Then_correct) (=> (= (ControlFlow 0 14) 13) anon85_Else_correct)))))))
(let ((anon82_Else_correct  (and (=> (= (ControlFlow 0 118) (- 0 119)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@8 n$1_1)) (select g1@@8 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_1@@1 next))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (select g1@@8 (invRecv25 o_4@@13)) (< NoPerm FullPerm)) (qpRange25 o_4@@13)) (= (invRecv25 o_4@@13) o_4@@13))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$1_1@@2 next))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (select g1@@8 (invRecv25 o_4@@14)) (< NoPerm FullPerm)) (qpRange25 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv25 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@14 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@14 next) FullPerm)))) (=> (not (and (and (select g1@@8 (invRecv25 o_4@@14)) (< NoPerm FullPerm)) (qpRange25 o_4@@14))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@14 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@14 next))))
 :qid |stdinbpl.2519:22|
 :skolemid |290|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@14 next))
)))) (=> (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@7 T@Field_46438_53) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@0) o_4@@15 f_5@@7) (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@1) o_4@@15 f_5@@7)))
 :qid |stdinbpl.2523:29|
 :skolemid |291|
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@0) o_4@@15 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@1) o_4@@15 f_5@@7))
)) (forall ((o_4@@16 T@Ref) (f_5@@8 T@Field_46451_46452) ) (!  (=> (not (= f_5@@8 next)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@16 f_5@@8) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@16 f_5@@8)))
 :qid |stdinbpl.2523:29|
 :skolemid |291|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@16 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@1) o_4@@16 f_5@@8))
))) (forall ((o_4@@17 T@Ref) (f_5@@9 T@Field_29364_147463) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@0) o_4@@17 f_5@@9) (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@1) o_4@@17 f_5@@9)))
 :qid |stdinbpl.2523:29|
 :skolemid |291|
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@0) o_4@@17 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@1) o_4@@17 f_5@@9))
))) (forall ((o_4@@18 T@Ref) (f_5@@10 T@Field_29364_147596) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@0) o_4@@18 f_5@@10) (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@1) o_4@@18 f_5@@10)))
 :qid |stdinbpl.2523:29|
 :skolemid |291|
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@0) o_4@@18 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@1) o_4@@18 f_5@@10))
...
(let ((anon81_Else_correct  (=> (and (not (and (select g0@@8 n$0_28) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_28 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon81_Then_correct  (=> (and (select g0@@8 n$0_28) (not (= (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n$0_28 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29364_29365 QPMask@0 n$0_28 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_28 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon80_Else_correct  (=> (not (select g0@@8 n$0_28)) (and (=> (= (ControlFlow 0 8) 3) anon81_Then_correct) (=> (= (ControlFlow 0 8) 5) anon81_Else_correct)))))
(let ((anon80_Then_correct  (=> (select g0@@8 n$0_28) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29364_29365 QPMask@0 n$0_28 next)) (=> (HasDirectPerm_29364_29365 QPMask@0 n$0_28 next) (and (=> (= (ControlFlow 0 6) 3) anon81_Then_correct) (=> (= (ControlFlow 0 6) 5) anon81_Else_correct)))))))
(let ((anon78_Else_correct  (and (=> (= (ControlFlow 0 121) (- 0 122)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@8 n_1)) (select g0@@8 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_1@@1 next))
)) (forall ((o_4@@19 T@Ref) ) (!  (=> (and (and (select g0@@8 (invRecv24 o_4@@19)) (< NoPerm FullPerm)) (qpRange24 o_4@@19)) (= (invRecv24 o_4@@19) o_4@@19))
 ...
 :pattern ( (select (|PolymorphicMapType_46378_28671_28672#PolymorphicMapType_46378| Heap@@33) n_1@@2 next))
)) (forall ((o_4@@20 T@Ref) ) (!  (and (=> (and (and (select g0@@8 (invRecv24 o_4@@20)) (< NoPerm FullPerm)) (qpRange24 o_4@@20)) (and (=> (< NoPerm FullPerm) (= (invRecv24 o_4@@20) o_4@@20)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@20 next) (+ (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@20 next) FullPerm)))) (=> (not (and (and (select g0@@8 (invRecv24 o_4@@20)) (< NoPerm FullPerm)) (qpRange24 o_4@@20))) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@20 next) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@20 next))))
 :qid |stdinbpl.2462:22|
 :skolemid |283|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@20 next))
)))) (=> (and (and (and (and (forall ((o_4@@21 T@Ref) (f_5@@11 T@Field_46438_53) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| ZeroMask) o_4@@21 f_5@@11) (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@0) o_4@@21 f_5@@11)))
 :qid |stdinbpl.2466:29|
 :skolemid |284|
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| ZeroMask) o_4@@21 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_46399_29364_53#PolymorphicMapType_46399| QPMask@0) o_4@@21 f_5@@11))
)) (forall ((o_4@@22 T@Ref) (f_5@@12 T@Field_46451_46452) ) (!  (=> (not (= f_5@@12 next)) (= (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@22 f_5@@12) (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@22 f_5@@12)))
 :qid |stdinbpl.2466:29|
 :skolemid |284|
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| ZeroMask) o_4@@22 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_46399_29364_29365#PolymorphicMapType_46399| QPMask@0) o_4@@22 f_5@@12))
))) (forall ((o_4@@23 T@Ref) (f_5@@13 T@Field_29364_147463) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| ZeroMask) o_4@@23 f_5@@13) (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@0) o_4@@23 f_5@@13)))
 :qid |stdinbpl.2466:29|
 :skolemid |284|
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| ZeroMask) o_4@@23 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_46399_29364_147463#PolymorphicMapType_46399| QPMask@0) o_4@@23 f_5@@13))
))) (forall ((o_4@@24 T@Ref) (f_5@@14 T@Field_29364_147596) ) (!  (=> true (= (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| ZeroMask) o_4@@24 f_5@@14) (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@0) o_4@@24 f_5@@14)))
 :qid |stdinbpl.2466:29|
 :skolemid |284|
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| ZeroMask) o_4@@24 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_46399_29364_151142#PolymorphicMapType_46399| QPMask@0) o_4@@24 f_5@@14))
