...
(declare-fun v1_27 () T@Ref)
(declare-fun x@@0 () T@Ref)
(declare-fun v2_27 () T@Ref)
(declare-fun y () T@Ref)
...
(let ((anon83_Then_correct  (and (=> (= (ControlFlow 0 51) (- 0 53)) (forall ((n_4_1 T@Ref) ) (!  (=> (and (select g_1 n_4_1) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n_4_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :skolemid |137|
 :pattern ( (neverTriggered6 n_4_1@@1) (neverTriggered6 n_4_2))
 ...
 :qid |stdinbpl.1108:25|
 :skolemid |137|
 :pattern ( (neverTriggered6 n_4_1@@2) (neverTriggered6 n_4_2@@0))
)) (=> (= (ControlFlow 0 51) (- 0 50)) (forall ((n_4_1@@3 T@Ref) ) (!  (=> (select g_1 n_4_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@1) n_4_1@@3 next) NoPerm)))
...
(let ((anon92_Then_correct  (=> (exists_path ($$ Heap@@19 g_1) v1_27 x@@0) (and (=> (= (ControlFlow 0 43) 40) anon93_Then_correct) (=> (= (ControlFlow 0 43) 23) anon46_correct)))))
(let ((anon92_Else_correct  (=> (and (not (exists_path ($$ Heap@@19 g_1) v1_27 x@@0)) (= (ControlFlow 0 38) 23)) anon46_correct)))
(let ((anon90_Then_correct  (=> (not (exists_path ($$ Heap@@19 g_1) v1_27 v2_27)) (and (and (=> (= (ControlFlow 0 44) 35) anon91_Then_correct) (=> (= (ControlFlow 0 44) 43) anon92_Then_correct)) (=> (= (ControlFlow 0 44) 38) anon92_Else_correct)))))
(let ((anon90_Else_correct  (=> (and (exists_path ($$ Heap@@19 g_1) v1_27 v2_27) (= (ControlFlow 0 33) 23)) anon46_correct)))
(let ((anon87_Then_correct  (=> (not (= v1_27 v2_27)) (and (and (and (=> (= (ControlFlow 0 45) 26) anon88_Then_correct) (=> (= (ControlFlow 0 45) 30) anon89_Then_correct)) (=> (= (ControlFlow 0 45) 44) anon90_Then_correct)) (=> (= (ControlFlow 0 45) 33) anon90_Else_correct)))))
(let ((anon87_Else_correct  (=> (and (= v1_27 v2_27) (= (ControlFlow 0 24) 23)) anon46_correct)))
...
(let ((anon75_Else_correct  (=> (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1_1) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$2_1_1 next) null))) (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$2_1_1 next)))
 :qid |stdinbpl.987:20|
 :skolemid |125|
...
(let ((anon77_Else_correct  (=> (and (not (and (select g_1 n$2_35) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$2_35 next) null)))) (= (ControlFlow 0 16) 13)) anon18_correct)))
(let ((anon77_Then_correct  (=> (and (select g_1 n$2_35) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$2_35 next) null))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_25325_25326 QPMask@1 n$2_35 next)) (=> (HasDirectPerm_25325_25326 QPMask@1 n$2_35 next) (=> (= (ControlFlow 0 14) 13) anon18_correct))))))
(let ((anon76_Else_correct  (=> (not (select g_1 n$2_35)) (and (=> (= (ControlFlow 0 19) 14) anon77_Then_correct) (=> (= (ControlFlow 0 19) 16) anon77_Else_correct)))))
(let ((anon76_Then_correct  (=> (select g_1 n$2_35) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_25325_25326 QPMask@1 n$2_35 next)) (=> (HasDirectPerm_25325_25326 QPMask@1 n$2_35 next) (and (=> (= (ControlFlow 0 17) 14) anon77_Then_correct) (=> (= (ControlFlow 0 17) 16) anon77_Else_correct)))))))
(let ((anon74_Else_correct  (and (=> (= (ControlFlow 0 74) (- 0 76)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (and (select g_1 n$1_1) (not (= n$1_1 x@@0)))) (and (select g_1 n$1_1_1) (not (= n$1_1_1 x@@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv3 o_4)) (not (= (invRecv3 o_4) x@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_4)) (= (invRecv3 o_4) o_4))
 :qid |stdinbpl.946:22|
 :skolemid |120|
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$1_1@@4 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv3 o_4@@0)) (not (= (invRecv3 o_4@@0) x@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv3 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@1) o_4@@0 next) (+ (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| PostMask@0) o_4@@0 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv3 o_4@@0)) (not (= (invRecv3 o_4@@0) x@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_4@@0))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@1) o_4@@0 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| PostMask@0) o_4@@0 next))))
 :qid |stdinbpl.964:22|
 :skolemid |123|
...
(let ((anon72_Else_correct  (=> (and (not (and (select g_1 n$0_33) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$0_33 next) null)))) (= (ControlFlow 0 5) 2)) anon9_correct)))
(let ((anon72_Then_correct  (=> (and (select g_1 n$0_33) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$0_33 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_25325_25326 QPMask@0 n$0_33 next)) (=> (HasDirectPerm_25325_25326 QPMask@0 n$0_33 next) (=> (= (ControlFlow 0 3) 2) anon9_correct))))))
(let ((anon71_Else_correct  (=> (not (select g_1 n$0_33)) (and (=> (= (ControlFlow 0 8) 3) anon72_Then_correct) (=> (= (ControlFlow 0 8) 5) anon72_Else_correct)))))
(let ((anon71_Then_correct  (=> (select g_1 n$0_33) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_25325_25326 QPMask@0 n$0_33 next)) (=> (HasDirectPerm_25325_25326 QPMask@0 n$0_33 next) (and (=> (= (ControlFlow 0 6) 3) anon72_Then_correct) (=> (= (ControlFlow 0 6) 5) anon72_Else_correct)))))))
(let ((anon69_Else_correct  (and (=> (= (ControlFlow 0 80) (- 0 82)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (and (select g_1 n_1) (not (= n_1 x@@0)))) (and (select g_1 n_1_1) (not (= n_1_1 x@@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_1@@1 next))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv2 o_4@@5)) (not (= (invRecv2 o_4@@5) x@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_4@@5)) (= (invRecv2 o_4@@5) o_4@@5))
 :qid |stdinbpl.860:22|
 :skolemid |112|
