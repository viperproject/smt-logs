...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 64) (let ((anon64_Then_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((n_14 T@Ref) (n_14_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_14 n_14_1)) (select g1@@10 n_14)) (select g1@@10 n_14_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_14 n_14_1)))
...
)) (=> (= (ControlFlow 0 52) (- 0 51)) (forall ((n_14@@1 T@Ref) ) (!  (=> (select g1@@10 n_14@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_14@@1 next) NoPerm)))
 :qid |stdinbpl.1334:27|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_14@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@2) n_14@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_14@@1 next))
)))))))
...
(let ((anon65_Then_correct  (=> (and (select g1@@10 u_14) (and (select g1@@10 v_3) (not (exists_path ($$ Heap@@41 g1@@10) u_14 v_3)))) (and (=> (= (ControlFlow 0 48) 46) anon66_Then_correct) (=> (= (ControlFlow 0 48) 43) anon39_correct)))))
(let ((anon65_Else_correct  (=> (and (not (and (select g1@@10 u_14) (and (select g1@@10 v_3) (not (exists_path ($$ Heap@@41 g1@@10) u_14 v_3))))) (= (ControlFlow 0 44) 43)) anon39_correct)))
(let ((anon63_Then_correct  (=> (select g1@@10 v_3) (and (and (=> (= (ControlFlow 0 54) 52) anon64_Then_correct) (=> (= (ControlFlow 0 54) 48) anon65_Then_correct)) (=> (= (ControlFlow 0 54) 44) anon65_Else_correct)))))
(let ((anon63_Else_correct  (=> (not (select g1@@10 v_3)) (and (=> (= (ControlFlow 0 50) 48) anon65_Then_correct) (=> (= (ControlFlow 0 50) 44) anon65_Else_correct)))))
...
(let ((anon55_Else_correct  (=> (forall ((u_9 T@Ref) (v_9 T@Ref) ) (!  (=> (and (select g0@@10 u_9) (and (select g0@@10 v_9) (not (exists_path ($$ Heap@@41 g0@@10) u_9 v_9)))) (not (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_9 v_9)))
 :qid |stdinbpl.1305:20|
 :skolemid |156|
 :pattern ( (select g0@@10 u_9) (select g0@@10 v_9))
 :pattern ( (select g0@@10 u_9) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_9 v_9))
 :pattern ( (select g0@@10 u_9) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_9 v_9))
 :pattern ( (select g0@@10 v_9) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_9 v_9))
 :pattern ( (select g0@@10 v_9) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_9 v_9))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_9 v_9))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_9 v_9))
...
(let ((anon58_Then_correct  (and (=> (= (ControlFlow 0 38) (- 0 39)) (forall ((n_12_1 T@Ref) (n_12_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12_1 n_12_2)) (select g0@@10 n_12_1)) (select g0@@10 n_12_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12_1 n_12_2)))
 :qid |stdinbpl.1232:27|
 :skolemid |148|
 :pattern ( (neverTriggered7 n_12_1) (neverTriggered7 n_12_2))
))) (=> (forall ((n_12_1@@0 T@Ref) (n_12_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12_1@@0 n_12_2@@0)) (select g0@@10 n_12_1@@0)) (select g0@@10 n_12_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12_1@@0 n_12_2@@0)))
 :qid |stdinbpl.1232:27|
 :skolemid |148|
 :pattern ( (neverTriggered7 n_12_1@@0) (neverTriggered7 n_12_2@@0))
)) (=> (= (ControlFlow 0 38) (- 0 37)) (forall ((n_12_1@@1 T@Ref) ) (!  (=> (select g0@@10 n_12_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_12_1@@1 next) NoPerm)))
 :qid |stdinbpl.1239:27|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_12_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_12_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_12_1@@1 next))
)))))))
(let ((anon60_Then_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((n_13 T@Ref) (n_13_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13 n_13_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_13)) (select (|Set#Union_37395| g0@@10 g1@@10) n_13_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13 n_13_1)))
 :qid |stdinbpl.1274:25|
 :skolemid |152|
 :pattern ( (neverTriggered8 n_13) (neverTriggered8 n_13_1))
))) (=> (forall ((n_13@@0 T@Ref) (n_13_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13@@0 n_13_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_13@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_13_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13@@0 n_13_1@@0)))
 :qid |stdinbpl.1274:25|
 :skolemid |152|
 :pattern ( (neverTriggered8 n_13@@0) (neverTriggered8 n_13_1@@0))
)) (=> (= (ControlFlow 0 32) (- 0 31)) (forall ((n_13@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_13@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_13@@1 next) NoPerm)))
 :qid |stdinbpl.1281:25|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_13@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n_13@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_13@@1 next))
)))))))
(let ((anon30_correct true))
(let ((anon59_Then_correct  (=> (and (select g0@@10 u_2) (and (select g0@@10 v_14) (not (exists_path ($$ Heap@@41 g0@@10) u_2 v_14)))) (and (=> (= (ControlFlow 0 34) 32) anon60_Then_correct) (=> (= (ControlFlow 0 34) 29) anon30_correct)))))
(let ((anon59_Else_correct  (=> (and (not (and (select g0@@10 u_2) (and (select g0@@10 v_14) (not (exists_path ($$ Heap@@41 g0@@10) u_2 v_14))))) (= (ControlFlow 0 30) 29)) anon30_correct)))
(let ((anon57_Then_correct  (=> (select g0@@10 v_14) (and (and (=> (= (ControlFlow 0 40) 38) anon58_Then_correct) (=> (= (ControlFlow 0 40) 34) anon59_Then_correct)) (=> (= (ControlFlow 0 40) 30) anon59_Else_correct)))))
(let ((anon57_Else_correct  (=> (not (select g0@@10 v_14)) (and (=> (= (ControlFlow 0 36) 34) anon59_Then_correct) (=> (= (ControlFlow 0 36) 30) anon59_Else_correct)))))
(let ((anon56_Then_correct  (=> (select g0@@10 u_2) (and (=> (= (ControlFlow 0 41) 40) anon57_Then_correct) (=> (= (ControlFlow 0 41) 36) anon57_Else_correct)))))
(let ((anon56_Else_correct  (=> (not (select g0@@10 u_2)) (and (=> (= (ControlFlow 0 35) 34) anon59_Then_correct) (=> (= (ControlFlow 0 35) 30) anon59_Else_correct)))))
...
(let ((anon54_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((n_11_1 T@Ref) (n_11_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_1 n_11_2)) (select (|Set#Union_37395| g1@@10 g0@@10) n_11_1)) (select (|Set#Union_37395| g1@@10 g0@@10) n_11_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_1 n_11_2)))
 :qid |stdinbpl.1179:25|
 :skolemid |143|
 :pattern ( (neverTriggered6 n_11_1) (neverTriggered6 n_11_2))
))) (=> (forall ((n_11_1@@0 T@Ref) (n_11_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_1@@0 n_11_2@@0)) (select (|Set#Union_37395| g1@@10 g0@@10) n_11_1@@0)) (select (|Set#Union_37395| g1@@10 g0@@10) n_11_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_1@@0 n_11_2@@0)))
 :qid |stdinbpl.1179:25|
 :skolemid |143|
 :pattern ( (neverTriggered6 n_11_1@@0) (neverTriggered6 n_11_2@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((n_11_1@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g1@@10 g0@@10) n_11_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_11_1@@1 next) NoPerm)))
 :qid |stdinbpl.1186:25|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_11_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n_11_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_11_1@@1 next))
)))))))
(let ((anon21_correct true))
(let ((anon53_Then_correct  (=> (and (select g1@@10 u_13) (and (select g1@@10 v_13) (exists_path ($$ Heap@@41 g1@@10) u_13 v_13))) (and (=> (= (ControlFlow 0 21) 19) anon54_Then_correct) (=> (= (ControlFlow 0 21) 16) anon21_correct)))))
(let ((anon53_Else_correct  (=> (and (not (and (select g1@@10 u_13) (and (select g1@@10 v_13) (exists_path ($$ Heap@@41 g1@@10) u_13 v_13)))) (= (ControlFlow 0 17) 16)) anon21_correct)))
(let ((anon51_Then_correct  (=> (select g1@@10 v_13) (and (and (=> (= (ControlFlow 0 27) 25) anon52_Then_correct) (=> (= (ControlFlow 0 27) 21) anon53_Then_correct)) (=> (= (ControlFlow 0 27) 17) anon53_Else_correct)))))
(let ((anon51_Else_correct  (=> (not (select g1@@10 v_13)) (and (=> (= (ControlFlow 0 23) 21) anon53_Then_correct) (=> (= (ControlFlow 0 23) 17) anon53_Else_correct)))))
(let ((anon50_Then_correct  (=> (select g1@@10 u_13) (and (=> (= (ControlFlow 0 28) 27) anon51_Then_correct) (=> (= (ControlFlow 0 28) 23) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (not (select g1@@10 u_13)) (and (=> (= (ControlFlow 0 22) 21) anon53_Then_correct) (=> (= (ControlFlow 0 22) 17) anon53_Else_correct)))))
(let ((anon43_Else_correct  (=> (forall ((u_5 T@Ref) (v_5_1 T@Ref) ) (!  (=> (and (select g0@@10 u_5) (and (select g0@@10 v_5_1) (exists_path ($$ Heap@@41 g0@@10) u_5 v_5_1))) (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_5 v_5_1))
 :qid |stdinbpl.1115:20|
 :skolemid |138|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_5 v_5_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_5 v_5_1))
...
(let ((anon47_Then_correct  (=> (and (select g0@@10 u_12) (and (select g0@@10 v_12) (exists_path ($$ Heap@@41 g0@@10) u_12 v_12))) (and (=> (= (ControlFlow 0 8) 6) anon48_Then_correct) (=> (= (ControlFlow 0 8) 3) anon12_correct)))))
(let ((anon47_Else_correct  (=> (and (not (and (select g0@@10 u_12) (and (select g0@@10 v_12) (exists_path ($$ Heap@@41 g0@@10) u_12 v_12)))) (= (ControlFlow 0 4) 3)) anon12_correct)))
(let ((anon45_Then_correct  (=> (select g0@@10 v_12) (and (and (=> (= (ControlFlow 0 14) 12) anon46_Then_correct) (=> (= (ControlFlow 0 14) 8) anon47_Then_correct)) (=> (= (ControlFlow 0 14) 4) anon47_Else_correct)))))
(let ((anon45_Else_correct  (=> (not (select g0@@10 v_12)) (and (=> (= (ControlFlow 0 10) 8) anon47_Then_correct) (=> (= (ControlFlow 0 10) 4) anon47_Else_correct)))))
(let ((anon44_Then_correct  (=> (select g0@@10 u_12) (and (=> (= (ControlFlow 0 15) 14) anon45_Then_correct) (=> (= (ControlFlow 0 15) 10) anon45_Else_correct)))))
(let ((anon44_Else_correct  (=> (not (select g0@@10 u_12)) (and (=> (= (ControlFlow 0 9) 8) anon47_Then_correct) (=> (= (ControlFlow 0 9) 4) anon47_Else_correct)))))
(let ((anon42_Else_correct  (and (=> (= (ControlFlow 0 59) (- 0 60)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select g1@@10 n_7)) (select g1@@10 n_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv2 o_4)) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.996:22|
 :skolemid |126|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next))))
 :qid |stdinbpl.1008:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@0 next))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@1 f_5)))
...
(let ((anon41_Else_correct  (and (=> (= (ControlFlow 0 61) (- 0 62)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select g0@@10 n_5)) (select g0@@10 n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_5@@1 next))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv1 o_4@@5)) (< NoPerm FullPerm)) (qpRange1 o_4@@5)) (= (invRecv1 o_4@@5) o_4@@5))
 :qid |stdinbpl.956:22|
 :skolemid |120|
