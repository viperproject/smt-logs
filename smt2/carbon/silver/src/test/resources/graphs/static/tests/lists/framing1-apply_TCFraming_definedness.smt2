...
(declare-fun u_12 () T@Ref)
(declare-fun v_12 () T@Ref)
...
(declare-fun u_11 () T@Ref)
(declare-fun v_11 () T@Ref)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 64) (let ((anon64_Then_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((n_14_1 T@Ref) (n_14_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_14_1 n_14_2)) (select g1@@10 n_14_1)) (select g1@@10 n_14_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_14_1 n_14_2)))
 :qid |stdinbpl.1327:27|
 :skolemid |157|
 :pattern ( (neverTriggered9 n_14_1) (neverTriggered9 n_14_2))
 ...
 :qid |stdinbpl.1327:27|
 :skolemid |157|
 :pattern ( (neverTriggered9 n_14_1@@0) (neverTriggered9 n_14_2@@0))
)) (=> (= (ControlFlow 0 52) (- 0 51)) (forall ((n_14_1@@1 T@Ref) ) (!  (=> (select g1@@10 n_14_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_14_1@@1 next) NoPerm)))
 :qid |stdinbpl.1334:27|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_14_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@2) n_14_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_14_1@@1 next))
)))))))
(let ((anon66_Then_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((n_15 T@Ref) (n_15_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_15 n_15_1)) (select (|Set#Union_37395| g1@@10 g0@@10) n_15)) (select (|Set#Union_37395| g1@@10 g0@@10) n_15_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_15 n_15_1)))
 :qid |stdinbpl.1369:25|
 :skolemid |161|
 :pattern ( (neverTriggered10 n_15) (neverTriggered10 n_15_1))
))) (=> (forall ((n_15@@0 T@Ref) (n_15_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_15@@0 n_15_1@@0)) (select (|Set#Union_37395| g1@@10 g0@@10) n_15@@0)) (select (|Set#Union_37395| g1@@10 g0@@10) n_15_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_15@@0 n_15_1@@0)))
 :qid |stdinbpl.1369:25|
 :skolemid |161|
 :pattern ( (neverTriggered10 n_15@@0) (neverTriggered10 n_15_1@@0))
)) (=> (= (ControlFlow 0 46) (- 0 45)) (forall ((n_15@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g1@@10 g0@@10) n_15@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_15@@1 next) NoPerm)))
 :qid |stdinbpl.1376:25|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_15@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@3) n_15@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_15@@1 next))
)))))))
(let ((anon39_correct true))
(let ((anon65_Then_correct  (=> (and (select g1@@10 u_14) (and (select g1@@10 v_14) (not (exists_path ($$ Heap@@41 g1@@10) u_14 v_14)))) (and (=> (= (ControlFlow 0 48) 46) anon66_Then_correct) (=> (= (ControlFlow 0 48) 43) anon39_correct)))))
(let ((anon65_Else_correct  (=> (and (not (and (select g1@@10 u_14) (and (select g1@@10 v_14) (not (exists_path ($$ Heap@@41 g1@@10) u_14 v_14))))) (= (ControlFlow 0 44) 43)) anon39_correct)))
(let ((anon63_Then_correct  (=> (select g1@@10 v_14) (and (and (=> (= (ControlFlow 0 54) 52) anon64_Then_correct) (=> (= (ControlFlow 0 54) 48) anon65_Then_correct)) (=> (= (ControlFlow 0 54) 44) anon65_Else_correct)))))
(let ((anon63_Else_correct  (=> (not (select g1@@10 v_14)) (and (=> (= (ControlFlow 0 50) 48) anon65_Then_correct) (=> (= (ControlFlow 0 50) 44) anon65_Else_correct)))))
(let ((anon62_Then_correct  (=> (select g1@@10 u_14) (and (=> (= (ControlFlow 0 55) 54) anon63_Then_correct) (=> (= (ControlFlow 0 55) 50) anon63_Else_correct)))))
(let ((anon62_Else_correct  (=> (not (select g1@@10 u_14)) (and (=> (= (ControlFlow 0 49) 48) anon65_Then_correct) (=> (= (ControlFlow 0 49) 44) anon65_Else_correct)))))
(let ((anon61_Else_correct true))
(let ((anon55_Else_correct  (=> (forall ((u_9_2 T@Ref) (v_9_2 T@Ref) ) (!  (=> (and (select g0@@10 u_9_2) (and (select g0@@10 v_9_2) (not (exists_path ($$ Heap@@41 g0@@10) u_9_2 v_9_2)))) (not (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_9_2 v_9_2)))
 :qid |stdinbpl.1305:20|
 :skolemid |156|
 :pattern ( (select g0@@10 u_9_2) (select g0@@10 v_9_2))
 :pattern ( (select g0@@10 u_9_2) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_9_2 v_9_2))
 :pattern ( (select g0@@10 u_9_2) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_9_2 v_9_2))
 :pattern ( (select g0@@10 v_9_2) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_9_2 v_9_2))
 :pattern ( (select g0@@10 v_9_2) (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_9_2 v_9_2))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_9_2 v_9_2))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_9_2 v_9_2))
)) (=> (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (and (=> (= (ControlFlow 0 56) 42) anon61_Else_correct) (=> (= (ControlFlow 0 56) 55) anon62_Then_correct)) (=> (= (ControlFlow 0 56) 49) anon62_Else_correct))))))
(let ((anon58_Then_correct  (and (=> (= (ControlFlow 0 38) (- 0 39)) (forall ((n_12 T@Ref) (n_12_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12 n_12_1)) (select g0@@10 n_12)) (select g0@@10 n_12_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12 n_12_1)))
 :qid |stdinbpl.1232:27|
 :skolemid |148|
 :pattern ( (neverTriggered7 n_12) (neverTriggered7 n_12_1))
))) (=> (forall ((n_12@@0 T@Ref) (n_12_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12@@0 n_12_1@@0)) (select g0@@10 n_12@@0)) (select g0@@10 n_12_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12@@0 n_12_1@@0)))
 :qid |stdinbpl.1232:27|
 :skolemid |148|
 :pattern ( (neverTriggered7 n_12@@0) (neverTriggered7 n_12_1@@0))
)) (=> (= (ControlFlow 0 38) (- 0 37)) (forall ((n_12@@1 T@Ref) ) (!  (=> (select g0@@10 n_12@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_12@@1 next) NoPerm)))
 :qid |stdinbpl.1239:27|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_12@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_12@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_12@@1 next))
)))))))
(let ((anon60_Then_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((n_13_2 T@Ref) (n_13_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13_2 n_13_3)) (select (|Set#Union_37395| g0@@10 g1@@10) n_13_2)) (select (|Set#Union_37395| g0@@10 g1@@10) n_13_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13_2 n_13_3)))
 :qid |stdinbpl.1274:25|
 :skolemid |152|
 :pattern ( (neverTriggered8 n_13_2) (neverTriggered8 n_13_3))
))) (=> (forall ((n_13_2@@0 T@Ref) (n_13_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13_2@@0 n_13_3@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_13_2@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_13_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13_2@@0 n_13_3@@0)))
 :qid |stdinbpl.1274:25|
 :skolemid |152|
 :pattern ( (neverTriggered8 n_13_2@@0) (neverTriggered8 n_13_3@@0))
)) (=> (= (ControlFlow 0 32) (- 0 31)) (forall ((n_13_2@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_13_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_13_2@@1 next) NoPerm)))
 :qid |stdinbpl.1281:25|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_13_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n_13_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_13_2@@1 next))
)))))))
(let ((anon30_correct true))
(let ((anon59_Then_correct  (=> (and (select g0@@10 u_13) (and (select g0@@10 v_13) (not (exists_path ($$ Heap@@41 g0@@10) u_13 v_13)))) (and (=> (= (ControlFlow 0 34) 32) anon60_Then_correct) (=> (= (ControlFlow 0 34) 29) anon30_correct)))))
(let ((anon59_Else_correct  (=> (and (not (and (select g0@@10 u_13) (and (select g0@@10 v_13) (not (exists_path ($$ Heap@@41 g0@@10) u_13 v_13))))) (= (ControlFlow 0 30) 29)) anon30_correct)))
(let ((anon57_Then_correct  (=> (select g0@@10 v_13) (and (and (=> (= (ControlFlow 0 40) 38) anon58_Then_correct) (=> (= (ControlFlow 0 40) 34) anon59_Then_correct)) (=> (= (ControlFlow 0 40) 30) anon59_Else_correct)))))
(let ((anon57_Else_correct  (=> (not (select g0@@10 v_13)) (and (=> (= (ControlFlow 0 36) 34) anon59_Then_correct) (=> (= (ControlFlow 0 36) 30) anon59_Else_correct)))))
(let ((anon56_Then_correct  (=> (select g0@@10 u_13) (and (=> (= (ControlFlow 0 41) 40) anon57_Then_correct) (=> (= (ControlFlow 0 41) 36) anon57_Else_correct)))))
(let ((anon56_Else_correct  (=> (not (select g0@@10 u_13)) (and (=> (= (ControlFlow 0 35) 34) anon59_Then_correct) (=> (= (ControlFlow 0 35) 30) anon59_Else_correct)))))
(let ((anon49_Else_correct  (=> (forall ((u_7 T@Ref) (v_7 T@Ref) ) (!  (=> (and (select g1@@10 u_7) (and (select g1@@10 v_7) (exists_path ($$ Heap@@41 g1@@10) u_7 v_7))) (exists_path ($$ Heap@@41 (|Set#Union_37395| g1@@10 g0@@10)) u_7 v_7))
 :qid |stdinbpl.1210:20|
 :skolemid |147|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g1@@10)) g1@@10) u_7 v_7))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g1@@10 g0@@10))) (|Set#Union_37395| g1@@10 g0@@10)) u_7 v_7))
)) (=> (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (and (=> (= (ControlFlow 0 57) 56) anon55_Else_correct) (=> (= (ControlFlow 0 57) 41) anon56_Then_correct)) (=> (= (ControlFlow 0 57) 35) anon56_Else_correct))))))
(let ((anon52_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((n_10_1 T@Ref) (n_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_10_1 n_10_2)) (select g1@@10 n_10_1)) (select g1@@10 n_10_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_10_1 n_10_2)))
 :qid |stdinbpl.1137:27|
 :skolemid |139|
 :pattern ( (neverTriggered5 n_10_1) (neverTriggered5 n_10_2))
))) (=> (forall ((n_10_1@@0 T@Ref) (n_10_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_10_1@@0 n_10_2@@0)) (select g1@@10 n_10_1@@0)) (select g1@@10 n_10_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_10_1@@0 n_10_2@@0)))
 :qid |stdinbpl.1137:27|
 :skolemid |139|
 :pattern ( (neverTriggered5 n_10_1@@0) (neverTriggered5 n_10_2@@0))
)) (=> (= (ControlFlow 0 25) (- 0 24)) (forall ((n_10_1@@1 T@Ref) ) (!  (=> (select g1@@10 n_10_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_10_1@@1 next) NoPerm)))
 :qid |stdinbpl.1144:27|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_10_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n_10_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_10_1@@1 next))
)))))))
(let ((anon54_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((n_11_2 T@Ref) (n_11_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_2 n_11_3)) (select (|Set#Union_37395| g1@@10 g0@@10) n_11_2)) (select (|Set#Union_37395| g1@@10 g0@@10) n_11_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_2 n_11_3)))
 :qid |stdinbpl.1179:25|
 :skolemid |143|
 :pattern ( (neverTriggered6 n_11_2) (neverTriggered6 n_11_3))
))) (=> (forall ((n_11_2@@0 T@Ref) (n_11_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_2@@0 n_11_3@@0)) (select (|Set#Union_37395| g1@@10 g0@@10) n_11_2@@0)) (select (|Set#Union_37395| g1@@10 g0@@10) n_11_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_2@@0 n_11_3@@0)))
 :qid |stdinbpl.1179:25|
 :skolemid |143|
 :pattern ( (neverTriggered6 n_11_2@@0) (neverTriggered6 n_11_3@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((n_11_2@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g1@@10 g0@@10) n_11_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_11_2@@1 next) NoPerm)))
 :qid |stdinbpl.1186:25|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_11_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n_11_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_11_2@@1 next))
)))))))
(let ((anon21_correct true))
(let ((anon53_Then_correct  (=> (and (select g1@@10 u_12) (and (select g1@@10 v_12) (exists_path ($$ Heap@@41 g1@@10) u_12 v_12))) (and (=> (= (ControlFlow 0 21) 19) anon54_Then_correct) (=> (= (ControlFlow 0 21) 16) anon21_correct)))))
(let ((anon53_Else_correct  (=> (and (not (and (select g1@@10 u_12) (and (select g1@@10 v_12) (exists_path ($$ Heap@@41 g1@@10) u_12 v_12)))) (= (ControlFlow 0 17) 16)) anon21_correct)))
(let ((anon51_Then_correct  (=> (select g1@@10 v_12) (and (and (=> (= (ControlFlow 0 27) 25) anon52_Then_correct) (=> (= (ControlFlow 0 27) 21) anon53_Then_correct)) (=> (= (ControlFlow 0 27) 17) anon53_Else_correct)))))
(let ((anon51_Else_correct  (=> (not (select g1@@10 v_12)) (and (=> (= (ControlFlow 0 23) 21) anon53_Then_correct) (=> (= (ControlFlow 0 23) 17) anon53_Else_correct)))))
(let ((anon50_Then_correct  (=> (select g1@@10 u_12) (and (=> (= (ControlFlow 0 28) 27) anon51_Then_correct) (=> (= (ControlFlow 0 28) 23) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (not (select g1@@10 u_12)) (and (=> (= (ControlFlow 0 22) 21) anon53_Then_correct) (=> (= (ControlFlow 0 22) 17) anon53_Else_correct)))))
(let ((anon43_Else_correct  (=> (forall ((u_5_2 T@Ref) (v_5_2 T@Ref) ) (!  (=> (and (select g0@@10 u_5_2) (and (select g0@@10 v_5_2) (exists_path ($$ Heap@@41 g0@@10) u_5_2 v_5_2))) (exists_path ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10)) u_5_2 v_5_2))
 :qid |stdinbpl.1115:20|
 :skolemid |138|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) u_5_2 v_5_2))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))) (|Set#Union_37395| g0@@10 g1@@10)) u_5_2 v_5_2))
)) (=> (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (and (=> (= (ControlFlow 0 58) 57) anon49_Else_correct) (=> (= (ControlFlow 0 58) 28) anon50_Then_correct)) (=> (= (ControlFlow 0 58) 22) anon50_Else_correct))))))
(let ((anon46_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((n_8 T@Ref) (n_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_8 n_8_1)) (select g0@@10 n_8)) (select g0@@10 n_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_8 n_8_1)))
...
)) (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((n_8@@1 T@Ref) ) (!  (=> (select g0@@10 n_8@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_8@@1 next) NoPerm)))
 :qid |stdinbpl.1049:27|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_8@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@8) n_8@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_8@@1 next))
)))))))
(let ((anon48_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((n_9 T@Ref) (n_9_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_9 n_9_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_9)) (select (|Set#Union_37395| g0@@10 g1@@10) n_9_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_9 n_9_1)))
 :qid |stdinbpl.1084:25|
 :skolemid |134|
 :pattern ( (neverTriggered4 n_9) (neverTriggered4 n_9_1))
))) (=> (forall ((n_9@@0 T@Ref) (n_9_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_9@@0 n_9_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_9@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_9_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_9@@0 n_9_1@@0)))
 :qid |stdinbpl.1084:25|
 :skolemid |134|
 :pattern ( (neverTriggered4 n_9@@0) (neverTriggered4 n_9_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((n_9@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_9@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_9@@1 next) NoPerm)))
 :qid |stdinbpl.1091:25|
 :skolemid |135|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_9@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@9) n_9@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_9@@1 next))
)))))))
(let ((anon12_correct true))
(let ((anon47_Then_correct  (=> (and (select g0@@10 u_11) (and (select g0@@10 v_11) (exists_path ($$ Heap@@41 g0@@10) u_11 v_11))) (and (=> (= (ControlFlow 0 8) 6) anon48_Then_correct) (=> (= (ControlFlow 0 8) 3) anon12_correct)))))
(let ((anon47_Else_correct  (=> (and (not (and (select g0@@10 u_11) (and (select g0@@10 v_11) (exists_path ($$ Heap@@41 g0@@10) u_11 v_11)))) (= (ControlFlow 0 4) 3)) anon12_correct)))
(let ((anon45_Then_correct  (=> (select g0@@10 v_11) (and (and (=> (= (ControlFlow 0 14) 12) anon46_Then_correct) (=> (= (ControlFlow 0 14) 8) anon47_Then_correct)) (=> (= (ControlFlow 0 14) 4) anon47_Else_correct)))))
(let ((anon45_Else_correct  (=> (not (select g0@@10 v_11)) (and (=> (= (ControlFlow 0 10) 8) anon47_Then_correct) (=> (= (ControlFlow 0 10) 4) anon47_Else_correct)))))
(let ((anon44_Then_correct  (=> (select g0@@10 u_11) (and (=> (= (ControlFlow 0 15) 14) anon45_Then_correct) (=> (= (ControlFlow 0 15) 10) anon45_Else_correct)))))
(let ((anon44_Else_correct  (=> (not (select g0@@10 u_11)) (and (=> (= (ControlFlow 0 9) 8) anon47_Then_correct) (=> (= (ControlFlow 0 9) 4) anon47_Else_correct)))))
(let ((anon42_Else_correct  (and (=> (= (ControlFlow 0 59) (- 0 60)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select g1@@10 n_7)) (select g1@@10 n_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1)))
 :qid |stdinbpl.986:15|
 :skolemid |124|
 ...
 :qid |stdinbpl.986:15|
 :skolemid |124|
)) (=> (and (and (forall ((n_7@@1 T@Ref) ) (!  (=> (and (select g1@@10 n_7@@1) (< NoPerm FullPerm)) (and (qpRange2 n_7@@1) (= (invRecv2 n_7@@1) n_7@@1)))
 :qid |stdinbpl.992:22|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.996:22|
 :skolemid |126|
 :pattern ( (invRecv2 o_9))
))) (and (forall ((n_7@@2 T@Ref) ) (!  (=> (select g1@@10 n_7@@2) (not (= n_7@@2 null)))
 :qid |stdinbpl.1002:22|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_7@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next))))
 :qid |stdinbpl.1008:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@0 next))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_9@@1 f_5)))
...
))) (state Heap@@41 QPMask@1)) (and (state Heap@@41 QPMask@1) (|Set#Equal_37295| (|Set#Intersection_37295| g1@@10 g0@@10) |Set#Empty_37301|))) (and (and (state Heap@@41 QPMask@1) (|Set#Equal_37295| (|Set#Union_37395| g0@@10 g1@@10) (|Set#Union_37395| g1@@10 g0@@10))) (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)))) (and (and (=> (= (ControlFlow 0 59) 58) anon43_Else_correct) (=> (= (ControlFlow 0 59) 15) anon44_Then_correct)) (=> (= (ControlFlow 0 59) 9) anon44_Else_correct))))))))
(let ((anon42_Then_correct true))
(let ((anon41_Else_correct  (and (=> (= (ControlFlow 0 61) (- 0 62)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select g0@@10 n_5)) (select g0@@10 n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1)))
 :qid |stdinbpl.946:15|
 :skolemid |118|
 ...
 :qid |stdinbpl.946:15|
 :skolemid |118|
)) (=> (and (and (forall ((n_5@@1 T@Ref) ) (!  (=> (and (select g0@@10 n_5@@1) (< NoPerm FullPerm)) (and (qpRange1 n_5@@1) (= (invRecv1 n_5@@1) n_5@@1)))
 :qid |stdinbpl.952:22|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) n_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_5@@1 next))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv1 o_9@@5)) (< NoPerm FullPerm)) (qpRange1 o_9@@5)) (= (invRecv1 o_9@@5) o_9@@5))
 :qid |stdinbpl.956:22|
 :skolemid |120|
 :pattern ( (invRecv1 o_9@@5))
))) (and (forall ((n_5@@2 T@Ref) ) (!  (=> (select g0@@10 n_5@@2) (not (= n_5@@2 null)))
 :qid |stdinbpl.962:22|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_5@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) n_5@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_5@@2 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select g0@@10 (invRecv1 o_9@@6)) (< NoPerm FullPerm)) (qpRange1 o_9@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@6 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@6 next) FullPerm)))) (=> (not (and (and (select g0@@10 (invRecv1 o_9@@6)) (< NoPerm FullPerm)) (qpRange1 o_9@@6))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@6 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@6 next))))
 :qid |stdinbpl.968:22|
 :skolemid |122|
...
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (=> (= (ControlFlow 0 61) 2) anon42_Then_correct) (=> (= (ControlFlow 0 61) 59) anon42_Else_correct))))))))
(let ((anon41_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 3)) (and (=> (= (ControlFlow 0 63) 1) anon41_Then_correct) (=> (= (ControlFlow 0 63) 61) anon41_Else_correct))))))
