...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 75) (let ((anon75_Then_correct  (and (=> (= (ControlFlow 0 59) (- 0 60)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select g_1 n_3)) (select g_1 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 :qid |stdinbpl.1182:23|
 :skolemid |140|
...
)) (=> (= (ControlFlow 0 59) (- 0 58)) (forall ((n_3@@1 T@Ref) ) (!  (=> (select g_1 n_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) n_3@@1 next) NoPerm)))
 :qid |stdinbpl.1189:23|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@4) n_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_3@@1 next))
)))))))
(let ((anon74_Then_correct  (and (=> (= (ControlFlow 0 56) (- 0 57)) (forall ((n_2 T@Ref) (n_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_2 n_2_1)) (select g_1 n_2)) (select g_1 n_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1)))
 :qid |stdinbpl.1143:23|
 :skolemid |136|
...
)) (=> (= (ControlFlow 0 56) (- 0 55)) (forall ((n_2@@1 T@Ref) ) (!  (=> (select g_1 n_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) n_2@@1 next) NoPerm)))
 :qid |stdinbpl.1150:23|
 :skolemid |137|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@3) n_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n_2@@1 next))
)))))))
(let ((anon79_Else_correct true))
(let ((anon79_Then_correct  (and (=> (= (ControlFlow 0 49) (- 0 50)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select g_1 n_5)) (select g_1 n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1)))
 :qid |stdinbpl.1265:25|
 :skolemid |148|
...
)) (=> (= (ControlFlow 0 49) (- 0 48)) (forall ((n_5@@1 T@Ref) ) (!  (=> (select g_1 n_5@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) n_5@@1 next) NoPerm)))
 :qid |stdinbpl.1272:25|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@10) n_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_5@@1 next))
)))))))
(let ((anon78_Then_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((n_4 T@Ref) (n_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4 n_4_1)) (select g_1 n_4)) (select g_1 n_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1)))
 :qid |stdinbpl.1226:25|
 :skolemid |144|
...
)) (=> (= (ControlFlow 0 46) (- 0 45)) (forall ((n_4@@1 T@Ref) ) (!  (=> (select g_1 n_4@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) n_4@@1 next) NoPerm)))
 :qid |stdinbpl.1233:25|
 :skolemid |145|
...
(let ((anon87_Then_correct  (and (=> (= (ControlFlow 0 37) (- 0 38)) (forall ((n_9 T@Ref) (n_9_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_9 n_9_1)) (select g_1 n_9)) (select g_1 n_9_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_9 n_9_1)))
 :qid |stdinbpl.1427:29|
 :skolemid |165|
 :pattern ( (neverTriggered11 n_9) (neverTriggered11 n_9_1))
 ...
 :qid |stdinbpl.1427:29|
 :skolemid |165|
 :pattern ( (neverTriggered11 n_9@@0) (neverTriggered11 n_9_1@@0))
)) (=> (= (ControlFlow 0 37) (- 0 36)) (forall ((n_9@@1 T@Ref) ) (!  (=> (select g_1 n_9@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) n_9@@1 next) NoPerm)))
 :qid |stdinbpl.1434:29|
 :skolemid |166|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_9@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@8) n_9@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_9@@1 next))
)))))))
(let ((anon85_Then_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((n_8 T@Ref) (n_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_8 n_8_1)) (select g_1 n_8)) (select g_1 n_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_8 n_8_1)))
 :qid |stdinbpl.1390:27|
 :skolemid |161|
 :pattern ( (neverTriggered10 n_8) (neverTriggered10 n_8_1))
 ...
 :qid |stdinbpl.1390:27|
 :skolemid |161|
 :pattern ( (neverTriggered10 n_8@@0) (neverTriggered10 n_8_1@@0))
)) (=> (= (ControlFlow 0 33) (- 0 32)) (forall ((n_8@@1 T@Ref) ) (!  (=> (select g_1 n_8@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) n_8@@1 next) NoPerm)))
 :qid |stdinbpl.1397:27|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_8@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@7) n_8@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_8@@1 next))
)))))))
(let ((anon45_correct true))
(let ((anon86_Then_correct  (=> (exists_path ($$ Heap@@19 g_1) v1_2 x@@7) (and (=> (= (ControlFlow 0 39) 37) anon87_Then_correct) (=> (= (ControlFlow 0 39) 30) anon45_correct)))))
(let ((anon86_Else_correct  (=> (and (not (exists_path ($$ Heap@@19 g_1) v1_2 x@@7)) (= (ControlFlow 0 35) 30)) anon45_correct)))
(let ((anon84_Then_correct  (=> (not (exists_path ($$ Heap@@19 g_1) v1_2 v2_2)) (and (and (=> (= (ControlFlow 0 40) 33) anon85_Then_correct) (=> (= (ControlFlow 0 40) 39) anon86_Then_correct)) (=> (= (ControlFlow 0 40) 35) anon86_Else_correct)))))
(let ((anon84_Else_correct  (=> (and (exists_path ($$ Heap@@19 g_1) v1_2 v2_2) (= (ControlFlow 0 31) 30)) anon45_correct)))
(let ((anon83_Then_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select g_1 n_7)) (select g_1 n_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1)))
...
)) (=> (= (ControlFlow 0 28) (- 0 27)) (forall ((n_7@@1 T@Ref) ) (!  (=> (select g_1 n_7@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) n_7@@1 next) NoPerm)))
 :qid |stdinbpl.1360:25|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@6) n_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_7@@1 next))
)))))))
(let ((anon82_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((n_6 T@Ref) (n_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6 n_6_1)) (select g_1 n_6)) (select g_1 n_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1)))
 :qid |stdinbpl.1314:25|
 :skolemid |153|
...
)) (=> (= (ControlFlow 0 25) (- 0 24)) (forall ((n_6@@1 T@Ref) ) (!  (=> (select g_1 n_6@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) n_6@@1 next) NoPerm)))
 :qid |stdinbpl.1321:25|
 :skolemid |154|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n_6@@1 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@5) n_6@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n_6@@1 next))
)))))))
(let ((anon47_correct true))
(let ((anon81_Else_correct  (=> (and (forall ((v1_3 T@Ref) (v2_3 T@Ref) ) (! (= (exists_path ($$ PostHeap@0 g_1) v1_3 v2_3)  (or (exists_path ($$ Heap@@19 g_1) v1_3 v2_3) (and (exists_path ($$ Heap@@19 g_1) v1_3 x@@7) (exists_path ($$ Heap@@19 g_1) y@@4 v2_3))))
 :qid |stdinbpl.1456:22|
 :skolemid |169|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6496 (|$$#condqp1| PostHeap@0 g_1)) g_1) v1_3 v2_3))
)) (= (ControlFlow 0 23) 21)) anon47_correct)))
(let ((anon80_Then_correct  (=> (and (not (= y@@4 null)) (state PostHeap@0 QPMask@2)) (and (and (and (and (=> (= (ControlFlow 0 41) 23) anon81_Else_correct) (=> (= (ControlFlow 0 41) 25) anon82_Then_correct)) (=> (= (ControlFlow 0 41) 28) anon83_Then_correct)) (=> (= (ControlFlow 0 41) 40) anon84_Then_correct)) (=> (= (ControlFlow 0 41) 31) anon84_Else_correct)))))
(let ((anon80_Else_correct  (=> (and (= y@@4 null) (= (ControlFlow 0 22) 21)) anon47_correct)))
(let ((anon33_correct  (=> (state PostHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 42) 41) anon80_Then_correct) (=> (= (ControlFlow 0 42) 22) anon80_Else_correct)))))
(let ((anon77_Else_correct  (=> (and (forall ((v1_1 T@Ref) (v2_1 T@Ref) ) (! (= (edge ($$ PostHeap@0 g_1) v1_1 v2_1)  (or (edge ($$ Heap@@19 g_1) v1_1 v2_1) (and (= v1_1 x@@7) (= v2_1 y@@4))))
 :qid |stdinbpl.1292:22|
 :skolemid |152|
 :pattern ( (edge (|$$#frame| (FrameFragment_6496 (|$$#condqp1| Heap@@19 g_1)) g_1) v1_1 v2_1))
)) (= (ControlFlow 0 44) 42)) anon33_correct)))
(let ((anon76_Then_correct  (=> (and (not (= y@@4 null)) (state PostHeap@0 QPMask@2)) (and (and (and (=> (= (ControlFlow 0 52) 44) anon77_Else_correct) (=> (= (ControlFlow 0 52) 46) anon78_Then_correct)) (=> (= (ControlFlow 0 52) 49) anon79_Then_correct)) (=> (= (ControlFlow 0 52) 51) anon79_Else_correct)))))
(let ((anon76_Else_correct  (=> (and (= y@@4 null) (= (ControlFlow 0 43) 42)) anon33_correct)))
(let ((anon25_correct  (=> (state PostHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 53) 52) anon76_Then_correct) (=> (= (ControlFlow 0 53) 43) anon76_Else_correct)))))
(let ((anon75_Else_correct  (=> (and (|Set#Equal_29085| ($$ PostHeap@0 g_1) ($$ Heap@@19 g_1)) (= (ControlFlow 0 61) 53)) anon25_correct)))
(let ((anon73_Then_correct  (=> (and (= y@@4 null) (state PostHeap@0 QPMask@2)) (and (and (=> (= (ControlFlow 0 62) 56) anon74_Then_correct) (=> (= (ControlFlow 0 62) 59) anon75_Then_correct)) (=> (= (ControlFlow 0 62) 61) anon75_Else_correct)))))
(let ((anon73_Else_correct  (=> (and (not (= y@@4 null)) (= (ControlFlow 0 54) 53)) anon25_correct)))
(let ((anon70_Else_correct  (=> (and (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_1 next) null))) (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2_1 next)))
...
)) (state PostHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 63) (- 0 64)) (HasDirectPerm_29078_29079 QPMask@2 x@@7 next)) (=> (HasDirectPerm_29078_29079 QPMask@2 x@@7 next) (=> (and (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) x@@7 next) y@@4) (state PostHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 63) 62) anon73_Then_correct) (=> (= (ControlFlow 0 63) 54) anon73_Else_correct))))))))
(let ((anon18_correct true))
(let ((anon72_Else_correct  (=> (and (not (and (select g_1 n$2) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2 next) null)))) (= (ControlFlow 0 17) 14)) anon18_correct)))
(let ((anon72_Then_correct  (=> (and (select g_1 n$2) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$2 next) null))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_29078_29079 QPMask@2 n$2 next)) (=> (HasDirectPerm_29078_29079 QPMask@2 n$2 next) (=> (= (ControlFlow 0 15) 14) anon18_correct))))))
(let ((anon71_Else_correct  (=> (not (select g_1 n$2)) (and (=> (= (ControlFlow 0 20) 15) anon72_Then_correct) (=> (= (ControlFlow 0 20) 17) anon72_Else_correct)))))
(let ((anon71_Then_correct  (=> (select g_1 n$2) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_29078_29079 QPMask@2 n$2 next)) (=> (HasDirectPerm_29078_29079 QPMask@2 n$2 next) (and (=> (= (ControlFlow 0 18) 15) anon72_Then_correct) (=> (= (ControlFlow 0 18) 17) anon72_Else_correct)))))))
(let ((anon69_Else_correct  (and (=> (= (ControlFlow 0 65) (- 0 66)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g_1 n$1_1)) (select g_1 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) n$1_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv3 o_9)) (< NoPerm FullPerm)) (qpRange3 o_9)) (= (invRecv3 o_9) o_9))
 :qid |stdinbpl.1082:22|
 :skolemid |131|
 :pattern ( (invRecv3 o_9))
))) (and (forall ((n$1_1@@2 T@Ref) ) (!  (=> (select g_1 n$1_1@@2) (not (= n$1_1@@2 null)))
 :qid |stdinbpl.1088:22|
 :skolemid |132|
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) n$1_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| PostHeap@0) n$1_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv3 o_9@@0)) (< NoPerm FullPerm)) (qpRange3 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) o_9@@0 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv3 o_9@@0)) (< NoPerm FullPerm)) (qpRange3 o_9@@0))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) o_9@@0 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.1094:22|
 :skolemid |133|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) o_9@@0 next))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@2) o_9@@1 f_5)))
 :qid |stdinbpl.1098:29|
 :skolemid |134|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@2) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_44212_44213) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1098:29|
 :skolemid |134|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@2) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1098:29|
 :skolemid |134|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@2) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1098:29|
 :skolemid |134|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@2) o_9@@4 f_5@@2))
))) (state PostHeap@0 QPMask@2)) (and (and (=> (= (ControlFlow 0 65) 63) anon70_Else_correct) (=> (= (ControlFlow 0 65) 18) anon71_Then_correct)) (=> (= (ControlFlow 0 65) 20) anon71_Else_correct))))))))
(let ((anon69_Then_correct true))
(let ((anon68_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (select g_1 null))) (and (=> (= (ControlFlow 0 67) 13) anon69_Then_correct) (=> (= (ControlFlow 0 67) 65) anon69_Else_correct)))))
(let ((anon68_Else_correct true))
(let ((anon65_Else_correct  (=> (and (forall ((n$0_1 T@Ref) ) (!  (=> (and (select g_1 n$0_1) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_1 next) null))) (select g_1 (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0_1 next)))
...
)) (state Heap@@19 QPMask@0)) (and (=> (= (ControlFlow 0 68) 67) anon68_Then_correct) (=> (= (ControlFlow 0 68) 10) anon68_Else_correct)))))
(let ((anon9_correct true))
(let ((anon67_Else_correct  (=> (and (not (and (select g_1 n$0) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0 next) null)))) (= (ControlFlow 0 5) 2)) anon9_correct)))
(let ((anon67_Then_correct  (=> (and (select g_1 n$0) (not (= (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n$0 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_29078_29079 QPMask@0 n$0 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0 next) (=> (= (ControlFlow 0 3) 2) anon9_correct))))))
(let ((anon66_Else_correct  (=> (not (select g_1 n$0)) (and (=> (= (ControlFlow 0 8) 3) anon67_Then_correct) (=> (= (ControlFlow 0 8) 5) anon67_Else_correct)))))
(let ((anon66_Then_correct  (=> (select g_1 n$0) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_29078_29079 QPMask@0 n$0 next)) (=> (HasDirectPerm_29078_29079 QPMask@0 n$0 next) (and (=> (= (ControlFlow 0 6) 3) anon67_Then_correct) (=> (= (ControlFlow 0 6) 5) anon67_Else_correct)))))))
(let ((anon64_Else_correct  (and (=> (= (ControlFlow 0 69) (- 0 70)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@1 next))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv2 o_9@@5)) (< NoPerm FullPerm)) (qpRange2 o_9@@5)) (= (invRecv2 o_9@@5) o_9@@5))
 ...
 :pattern ( (select (|PolymorphicMapType_44139_28232_28233#PolymorphicMapType_44139| Heap@@19) n_1@@2 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv2 o_9@@6)) (< NoPerm FullPerm)) (qpRange2 o_9@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@6 next) (+ (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@6 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv2 o_9@@6)) (< NoPerm FullPerm)) (qpRange2 o_9@@6))) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@6 next) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@6 next))))
 :qid |stdinbpl.1025:22|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@6 next))
)))) (=> (and (and (and (and (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_44199_53) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_9@@7 f_5@@3) (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@0) o_9@@7 f_5@@3)))
 :qid |stdinbpl.1029:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| ZeroMask) o_9@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_44160_29078_53#PolymorphicMapType_44160| QPMask@0) o_9@@7 f_5@@3))
)) (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_44212_44213) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.1029:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_44160_29078_29079#PolymorphicMapType_44160| QPMask@0) o_9@@8 f_5@@4))
))) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_29078_143803) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.1029:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_44160_29078_143803#PolymorphicMapType_44160| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_29078_143936) ) (!  (=> true (= (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.1029:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_44160_29078_147482#PolymorphicMapType_44160| QPMask@0) o_9@@10 f_5@@6))
))) (state Heap@@19 QPMask@0)) (and (and (=> (= (ControlFlow 0 69) 68) anon65_Else_correct) (=> (= (ControlFlow 0 69) 6) anon66_Then_correct)) (=> (= (ControlFlow 0 69) 8) anon66_Else_correct))))))))
(let ((anon64_Then_correct true))
(let ((anon2_correct  (=> (and (state Heap@@19 ZeroMask) (not (select g_1 null))) (and (=> (= (ControlFlow 0 71) 1) anon64_Then_correct) (=> (= (ControlFlow 0 71) 69) anon64_Else_correct)))))
(let ((anon63_Else_correct  (=> (and (= y@@4 null) (= (ControlFlow 0 73) 71)) anon2_correct)))
(let ((anon63_Then_correct  (=> (not (= y@@4 null)) (=> (and (select g_1 y@@4) (= (ControlFlow 0 72) 71)) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_44139_28229_53#PolymorphicMapType_44139| Heap@@19) x@@7 $allocated) (select (|PolymorphicMapType_44139_28229_53#PolymorphicMapType_44139| Heap@@19) y@@4 $allocated)) (and (select g_1 x@@7) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 74) 72) anon63_Then_correct) (=> (= (ControlFlow 0 74) 73) anon63_Else_correct)))))))
