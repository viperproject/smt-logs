...
(let ((anon48_Then_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((n_4_1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1 n_4_2)) (select g1@@10 n_4_1)) (select g1@@10 n_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1 n_4_2)))
 :qid |stdinbpl.2436:25|
 :skolemid |270|
 :pattern ( (neverTriggered24 n_4_1) (neverTriggered24 n_4_2))
))) (=> (forall ((n_4_1@@0 T@Ref) (n_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1@@0 n_4_2@@0)) (select g1@@10 n_4_1@@0)) (select g1@@10 n_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1@@0 n_4_2@@0)))
 :qid |stdinbpl.2436:25|
 :skolemid |270|
 :pattern ( (neverTriggered24 n_4_1@@0) (neverTriggered24 n_4_2@@0))
)) (=> (= (ControlFlow 0 26) (- 0 25)) (forall ((n_4_1@@1 T@Ref) ) (!  (=> (select g1@@10 n_4_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_4_1@@1 next) NoPerm)))
 :qid |stdinbpl.2443:25|
 :skolemid |271|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_4_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n_4_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_4_1@@1 next))
)))))))
...
(let ((anon46_Then_correct  (=> (select ($$ Heap@@41 g0@@10) e_2) (and (and (=> (= (ControlFlow 0 28) 23) anon47_Then_correct) (=> (= (ControlFlow 0 28) 26) anon48_Then_correct)) (=> (= (ControlFlow 0 28) 20) anon24_correct)))))
(let ((anon46_Else_correct  (=> (and (not (select ($$ Heap@@41 g0@@10) e_2)) (= (ControlFlow 0 21) 20)) anon24_correct)))
...
(let ((anon41_Else_correct  (=> (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g1@@10 n$2_1_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next) null))) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1_1 next)))
...
(let ((anon43_Else_correct  (=> (and (not (and (select g1@@10 n$2_16) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_16 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon43_Then_correct  (=> (and (select g1@@10 n$2_16) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_16 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_37315_37316 QPMask@1 n$2_16 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_16 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon42_Else_correct  (=> (not (select g1@@10 n$2_16)) (and (=> (= (ControlFlow 0 16) 11) anon43_Then_correct) (=> (= (ControlFlow 0 16) 13) anon43_Else_correct)))))
(let ((anon42_Then_correct  (=> (select g1@@10 n$2_16) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_37315_37316 QPMask@1 n$2_16 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_16 next) (and (=> (= (ControlFlow 0 14) 11) anon43_Then_correct) (=> (= (ControlFlow 0 14) 13) anon43_Else_correct)))))))
(let ((anon40_Else_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@10 n$1_1)) (select g1@@10 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv21 o_4)) (< NoPerm FullPerm)) (qpRange21 o_4)) (= (invRecv21 o_4) o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv21 o_4@@0)) (< NoPerm FullPerm)) (qpRange21 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv21 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv21 o_4@@0)) (< NoPerm FullPerm)) (qpRange21 o_4@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next))))
 :qid |stdinbpl.2302:22|
 :skolemid |259|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@0 next))
)))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.2306:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_58602_58603) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2306:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2306:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2306:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_4@@4 f_5@@2))
...
(let ((anon39_Else_correct  (=> (and (not (and (select g0@@10 n$0_15) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_15 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon39_Then_correct  (=> (and (select g0@@10 n$0_15) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_15 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$0_15 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_15 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon38_Else_correct  (=> (not (select g0@@10 n$0_15)) (and (=> (= (ControlFlow 0 8) 3) anon39_Then_correct) (=> (= (ControlFlow 0 8) 5) anon39_Else_correct)))))
(let ((anon38_Then_correct  (=> (select g0@@10 n$0_15) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$0_15 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_15 next) (and (=> (= (ControlFlow 0 6) 3) anon39_Then_correct) (=> (= (ControlFlow 0 6) 5) anon39_Else_correct)))))))
(let ((anon36_Else_correct  (and (=> (= (ControlFlow 0 49) (- 0 50)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@10 n_1)) (select g0@@10 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@1 next))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv20 o_4@@5)) (< NoPerm FullPerm)) (qpRange20 o_4@@5)) (= (invRecv20 o_4@@5) o_4@@5))
 :qid |stdinbpl.2233:22|
 :skolemid |250|
 :pattern ( (invRecv20 o_4@@5))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@2 next))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (and (select g0@@10 (invRecv20 o_4@@6)) (< NoPerm FullPerm)) (qpRange20 o_4@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv20 o_4@@6) o_4@@6)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@6 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@6 next) FullPerm)))) (=> (not (and (and (select g0@@10 (invRecv20 o_4@@6)) (< NoPerm FullPerm)) (qpRange20 o_4@@6))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@6 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@6 next))))
 :qid |stdinbpl.2245:22|
 :skolemid |252|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@6 next))
)))) (=> (and (and (and (and (forall ((o_4@@7 T@Ref) (f_5@@3 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@7 f_5@@3) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@7 f_5@@3)))
 :qid |stdinbpl.2249:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_4@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_4@@7 f_5@@3))
)) (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_58602_58603) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.2249:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@8 f_5@@4))
))) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.2249:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.2249:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_4@@10 f_5@@6))
