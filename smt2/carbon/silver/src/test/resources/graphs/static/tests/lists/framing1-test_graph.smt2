...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 52) (let ((anon53_Else_correct  (=> (= (ControlFlow 0 43) (- 0 42)) (|Set#Equal_37564| (|Set#Union_37564| ($$ Heap@@41 g0@@10) ($$ Heap@@41 g1@@10)) ($$ Heap@@41 (|Set#Union_37395| g0@@10 g1@@10))))))
(let ((anon53_Then_correct  (and (=> (= (ControlFlow 0 40) (- 0 41)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select (|Set#Union_37395| g0@@10 g1@@10) n_7)) (select (|Set#Union_37395| g0@@10 g1@@10) n_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1)))
 :qid |stdinbpl.2574:21|
 :skolemid |283|
 :pattern ( (neverTriggered27 n_7) (neverTriggered27 n_7_1))
))) (=> (forall ((n_7@@0 T@Ref) (n_7_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7@@0 n_7_1@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_7@@0)) (select (|Set#Union_37395| g0@@10 g1@@10) n_7_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7@@0 n_7_1@@0)))
 :qid |stdinbpl.2574:21|
 :skolemid |283|
 :pattern ( (neverTriggered27 n_7@@0) (neverTriggered27 n_7_1@@0))
)) (=> (= (ControlFlow 0 40) (- 0 39)) (forall ((n_7@@1 T@Ref) ) (!  (=> (select (|Set#Union_37395| g0@@10 g1@@10) n_7@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_7@@1 next) NoPerm)))
 :qid |stdinbpl.2581:21|
 :skolemid |284|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@4) n_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_7@@1 next))
)))))))
(let ((anon52_Then_correct  (and (=> (= (ControlFlow 0 37) (- 0 38)) (forall ((n_6 T@Ref) (n_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6 n_6_1)) (select g1@@10 n_6)) (select g1@@10 n_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1)))
 :qid |stdinbpl.2535:21|
 :skolemid |279|
 :pattern ( (neverTriggered26 n_6) (neverTriggered26 n_6_1))
))) (=> (forall ((n_6@@0 T@Ref) (n_6_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6@@0 n_6_1@@0)) (select g1@@10 n_6@@0)) (select g1@@10 n_6_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6@@0 n_6_1@@0)))
 :qid |stdinbpl.2535:21|
 :skolemid |279|
 :pattern ( (neverTriggered26 n_6@@0) (neverTriggered26 n_6_1@@0))
)) (=> (= (ControlFlow 0 37) (- 0 36)) (forall ((n_6@@1 T@Ref) ) (!  (=> (select g1@@10 n_6@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_6@@1 next) NoPerm)))
 :qid |stdinbpl.2542:21|
 :skolemid |280|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_6@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@3) n_6@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_6@@1 next))
)))))))
(let ((anon51_Then_correct  (and (=> (= (ControlFlow 0 34) (- 0 35)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select g0@@10 n_5)) (select g0@@10 n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1)))
 :qid |stdinbpl.2496:21|
 :skolemid |275|
 :pattern ( (neverTriggered25 n_5) (neverTriggered25 n_5_1))
 ...
 :qid |stdinbpl.2496:21|
 :skolemid |275|
 :pattern ( (neverTriggered25 n_5@@0) (neverTriggered25 n_5_1@@0))
)) (=> (= (ControlFlow 0 34) (- 0 33)) (forall ((n_5@@1 T@Ref) ) (!  (=> (select g0@@10 n_5@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_5@@1 next) NoPerm)))
 :qid |stdinbpl.2503:21|
 :skolemid |276|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@2) n_5@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_5@@1 next))
)))))))
(let ((anon49_Else_correct  (=> (and (forall ((e_2_1 T@EdgeDomainType) ) (!  (=> (select ($$ Heap@@41 g0@@10) e_2_1) (select (|Set#Union_37564| ($$ Heap@@41 g0@@10) ($$ Heap@@41 g1@@10)) e_2_1))
 :qid |stdinbpl.2474:20|
 :skolemid |274|
 :pattern ( (select (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) e_2_1))
 :pattern ( (select (|Set#Union_37564| (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g0@@10)) g0@@10) (|$$#frame| (FrameFragment_6487 (|$$#condqp3| Heap@@41 g1@@10)) g1@@10)) e_2_1))
)) (state Heap@@41 QPMask@1)) (and (and (and (=> (= (ControlFlow 0 44) 34) anon51_Then_correct) (=> (= (ControlFlow 0 44) 37) anon52_Then_correct)) (=> (= (ControlFlow 0 44) 40) anon53_Then_correct)) (=> (= (ControlFlow 0 44) 43) anon53_Else_correct)))))
(let ((anon28_correct true))
(let ((anon50_Else_correct  (=> (and (not (select ($$ Heap@@41 g0@@10) e_1_1)) (= (ControlFlow 0 32) 29)) anon28_correct)))
(let ((anon50_Then_correct  (=> (select ($$ Heap@@41 g0@@10) e_1_1) (and (=> (= (ControlFlow 0 30) (- 0 31)) (select (|Set#Union_37564| ($$ Heap@@41 g0@@10) ($$ Heap@@41 g1@@10)) e_1_1)) (=> (select (|Set#Union_37564| ($$ Heap@@41 g0@@10) ($$ Heap@@41 g1@@10)) e_1_1) (=> (= (ControlFlow 0 30) 29) anon28_correct))))))
(let ((anon48_Then_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((n_4 T@Ref) (n_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4 n_4_1)) (select g1@@10 n_4)) (select g1@@10 n_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1)))
 :qid |stdinbpl.2436:25|
 :skolemid |270|
 :pattern ( (neverTriggered24 n_4) (neverTriggered24 n_4_1))
))) (=> (forall ((n_4@@0 T@Ref) (n_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4@@0 n_4_1@@0)) (select g1@@10 n_4@@0)) (select g1@@10 n_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4@@0 n_4_1@@0)))
 :qid |stdinbpl.2436:25|
 :skolemid |270|
 :pattern ( (neverTriggered24 n_4@@0) (neverTriggered24 n_4_1@@0))
)) (=> (= (ControlFlow 0 26) (- 0 25)) (forall ((n_4@@1 T@Ref) ) (!  (=> (select g1@@10 n_4@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_4@@1 next) NoPerm)))
 :qid |stdinbpl.2443:25|
 :skolemid |271|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@7) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_4@@1 next))
)))))))
(let ((anon47_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select g0@@10 n_3)) (select g0@@10 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 :qid |stdinbpl.2397:25|
 :skolemid |266|
 :pattern ( (neverTriggered23 n_3) (neverTriggered23 n_3_1))
))) (=> (forall ((n_3@@0 T@Ref) (n_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3@@0 n_3_1@@0)) (select g0@@10 n_3@@0)) (select g0@@10 n_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3@@0 n_3_1@@0)))
 :qid |stdinbpl.2397:25|
 :skolemid |266|
 :pattern ( (neverTriggered23 n_3@@0) (neverTriggered23 n_3_1@@0))
)) (=> (= (ControlFlow 0 23) (- 0 22)) (forall ((n_3@@1 T@Ref) ) (!  (=> (select g0@@10 n_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_3@@1 next) NoPerm)))
 :qid |stdinbpl.2404:25|
 :skolemid |267|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@6) n_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@1 next))
)))))))
(let ((anon24_correct true))
(let ((anon46_Then_correct  (=> (select ($$ Heap@@41 g0@@10) e_3) (and (and (=> (= (ControlFlow 0 28) 23) anon47_Then_correct) (=> (= (ControlFlow 0 28) 26) anon48_Then_correct)) (=> (= (ControlFlow 0 28) 20) anon24_correct)))))
(let ((anon46_Else_correct  (=> (and (not (select ($$ Heap@@41 g0@@10) e_3)) (= (ControlFlow 0 21) 20)) anon24_correct)))
(let ((anon45_Then_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((n_2 T@Ref) (n_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_2 n_2_1)) (select g0@@10 n_2)) (select g0@@10 n_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1)))
 :qid |stdinbpl.2357:23|
 :skolemid |262|
 :pattern ( (neverTriggered22 n_2) (neverTriggered22 n_2_1))
 ...
 :qid |stdinbpl.2357:23|
 :skolemid |262|
 :pattern ( (neverTriggered22 n_2@@0) (neverTriggered22 n_2_1@@0))
)) (=> (= (ControlFlow 0 18) (- 0 17)) (forall ((n_2@@1 T@Ref) ) (!  (=> (select g0@@10 n_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) n_2@@1 next) NoPerm)))
 :qid |stdinbpl.2364:23|
 :skolemid |263|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@5) n_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_2@@1 next))
)))))))
(let ((anon41_Else_correct  (=> (and (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g1@@10 n$2_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1 next) null))) (select g1@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_1 next)))
 :qid |stdinbpl.2325:20|
 :skolemid |261|
...
)) (state Heap@@41 QPMask@1)) (and (and (and (and (and (=> (= (ControlFlow 0 45) 44) anon49_Else_correct) (=> (= (ControlFlow 0 45) 30) anon50_Then_correct)) (=> (= (ControlFlow 0 45) 32) anon50_Else_correct)) (=> (= (ControlFlow 0 45) 18) anon45_Then_correct)) (=> (= (ControlFlow 0 45) 28) anon46_Then_correct)) (=> (= (ControlFlow 0 45) 21) anon46_Else_correct)))))
(let ((anon15_correct true))
(let ((anon43_Else_correct  (=> (and (not (and (select g1@@10 n$2_11) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_11 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon43_Then_correct  (=> (and (select g1@@10 n$2_11) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$2_11 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_37315_37316 QPMask@1 n$2_11 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_11 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon42_Else_correct  (=> (not (select g1@@10 n$2_11)) (and (=> (= (ControlFlow 0 16) 11) anon43_Then_correct) (=> (= (ControlFlow 0 16) 13) anon43_Else_correct)))))
(let ((anon42_Then_correct  (=> (select g1@@10 n$2_11) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_37315_37316 QPMask@1 n$2_11 next)) (=> (HasDirectPerm_37315_37316 QPMask@1 n$2_11 next) (and (=> (= (ControlFlow 0 14) 11) anon43_Then_correct) (=> (= (ControlFlow 0 14) 13) anon43_Else_correct)))))))
(let ((anon40_Else_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g1@@10 n$1_1)) (select g1@@10 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :qid |stdinbpl.2280:15|
 :skolemid |255|
)) (=> (and (and (forall ((n$1_1@@1 T@Ref) ) (!  (=> (and (select g1@@10 n$1_1@@1) (< NoPerm FullPerm)) (and (qpRange21 n$1_1@@1) (= (invRecv21 n$1_1@@1) n$1_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g1@@10 (invRecv21 o_9)) (< NoPerm FullPerm)) (qpRange21 o_9)) (= (invRecv21 o_9) o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$1_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g1@@10 (invRecv21 o_9@@0)) (< NoPerm FullPerm)) (qpRange21 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv21 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g1@@10 (invRecv21 o_9@@0)) (< NoPerm FullPerm)) (qpRange21 o_9@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next))))
 :qid |stdinbpl.2302:22|
 :skolemid |259|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@0 next))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.2306:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_58602_58603) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.2306:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.2306:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.2306:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@1) o_9@@4 f_5@@2))
))) (state Heap@@41 QPMask@1)) (and (and (=> (= (ControlFlow 0 46) 45) anon41_Else_correct) (=> (= (ControlFlow 0 46) 14) anon42_Then_correct)) (=> (= (ControlFlow 0 46) 16) anon42_Else_correct))))))))
(let ((anon40_Then_correct true))
(let ((anon37_Else_correct  (=> (and (forall ((n$0_1 T@Ref) ) (!  (=> (and (select g0@@10 n$0_1) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_1 next) null))) (select g0@@10 (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_1 next)))
 :qid |stdinbpl.2268:20|
 :skolemid |254|
...
)) (not (select g1@@10 null))) (and (=> (= (ControlFlow 0 48) 9) anon40_Then_correct) (=> (= (ControlFlow 0 48) 46) anon40_Else_correct)))))
(let ((anon7_correct true))
(let ((anon39_Else_correct  (=> (and (not (and (select g0@@10 n$0_18) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_18 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon39_Then_correct  (=> (and (select g0@@10 n$0_18) (not (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n$0_18 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_37315_37316 QPMask@0 n$0_18 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_18 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon38_Else_correct  (=> (not (select g0@@10 n$0_18)) (and (=> (= (ControlFlow 0 8) 3) anon39_Then_correct) (=> (= (ControlFlow 0 8) 5) anon39_Else_correct)))))
(let ((anon38_Then_correct  (=> (select g0@@10 n$0_18) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_37315_37316 QPMask@0 n$0_18 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 n$0_18 next) (and (=> (= (ControlFlow 0 6) 3) anon39_Then_correct) (=> (= (ControlFlow 0 6) 5) anon39_Else_correct)))))))
(let ((anon36_Else_correct  (and (=> (= (ControlFlow 0 49) (- 0 50)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g0@@10 n_1)) (select g0@@10 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :qid |stdinbpl.2223:15|
 :skolemid |248|
)) (=> (and (and (forall ((n_1@@1 T@Ref) ) (!  (=> (and (select g0@@10 n_1@@1) (< NoPerm FullPerm)) (and (qpRange20 n_1@@1) (= (invRecv20 n_1@@1) n_1@@1)))
 :qid |stdinbpl.2229:22|
 :skolemid |249|
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@1 next))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select g0@@10 (invRecv20 o_9@@5)) (< NoPerm FullPerm)) (qpRange20 o_9@@5)) (= (invRecv20 o_9@@5) o_9@@5))
 :qid |stdinbpl.2233:22|
 :skolemid |250|
 :pattern ( (invRecv20 o_9@@5))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_1@@2 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select g0@@10 (invRecv20 o_9@@6)) (< NoPerm FullPerm)) (qpRange20 o_9@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv20 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@6 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@6 next) FullPerm)))) (=> (not (and (and (select g0@@10 (invRecv20 o_9@@6)) (< NoPerm FullPerm)) (qpRange20 o_9@@6))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@6 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@6 next))))
 :qid |stdinbpl.2245:22|
 :skolemid |252|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@6 next))
)))) (=> (and (and (and (and (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_58589_53) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_9@@7 f_5@@3) (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_9@@7 f_5@@3)))
 :qid |stdinbpl.2249:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| ZeroMask) o_9@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_58550_37315_53#PolymorphicMapType_58550| QPMask@0) o_9@@7 f_5@@3))
)) (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_58602_58603) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.2249:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@8 f_5@@4))
))) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_37315_186613) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.2249:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_58550_37315_186613#PolymorphicMapType_58550| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_37315_186746) ) (!  (=> true (= (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.2249:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_58550_37315_190292#PolymorphicMapType_58550| QPMask@0) o_9@@10 f_5@@6))
))) (state Heap@@41 QPMask@0)) (and (and (=> (= (ControlFlow 0 49) 48) anon37_Else_correct) (=> (= (ControlFlow 0 49) 6) anon38_Then_correct)) (=> (= (ControlFlow 0 49) 8) anon38_Else_correct))))))))
(let ((anon36_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (not (select g0@@10 null)))) (and (=> (= (ControlFlow 0 51) 1) anon36_Then_correct) (=> (= (ControlFlow 0 51) 49) anon36_Else_correct)))))
