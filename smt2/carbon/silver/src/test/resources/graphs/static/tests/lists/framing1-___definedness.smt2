...
(let ((anon13_Else_correct  (=> (and (forall ((p_4_1 T@Ref) (s_4 T@Ref) ) (! (=  (and (select refs@@6 p_4_1) (and (select refs@@6 s_4) (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) p_4_1 next) s_4))) (select Result (create_edge p_4_1 s_4)))
...
(let ((anon15_Else_correct  (=> (and (not (select refs@@6 s_3)) (= (ControlFlow 0 6) 2)) anon6_correct)))
(let ((anon15_Then_correct  (=> (select refs@@6 s_3) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_37315_37316 QPMask@0 p_5 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 p_5 next) (=> (= (ControlFlow 0 4) 2) anon6_correct))))))
(let ((anon14_Then_correct  (=> (select refs@@6 p_5) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not (select refs@@6 p_5)) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select refs@@6 n_3)) (select refs@@6 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select refs@@6 (invRecv11 o_9)) (< NoPerm FullPerm)) (qpRange11 o_9)) (= (invRecv11 o_9) o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select refs@@6 (invRecv11 o_9@@0)) (< NoPerm FullPerm)) (qpRange11 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv11 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select refs@@6 (invRecv11 o_9@@0)) (< NoPerm FullPerm)) (qpRange11 o_9@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_9@@0 next))))
