...
)) (state Heap@@41 QPMask@0)) (and (=> (= (ControlFlow 0 11) 9) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((anon13_Else_correct  (=> (and (forall ((p_4_1 T@Ref) (s_4_1 T@Ref) ) (! (=  (and (select refs@@6 p_4_1) (and (select refs@@6 s_4_1) (= (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) p_4_1 next) s_4_1))) (select Result (create_edge p_4_1 s_4_1)))
 :qid |stdinbpl.1537:20|
 :skolemid |182|
 :pattern ( (create_edge p_4_1 s_4_1))
)) (state Heap@@41 QPMask@0)) (and (=> (= (ControlFlow 0 12) 8) anon16_Then_correct) (=> (= (ControlFlow 0 12) 11) anon16_Else_correct)))))
(let ((anon6_correct true))
(let ((anon15_Else_correct  (=> (and (not (select refs@@6 s_10)) (= (ControlFlow 0 6) 2)) anon6_correct)))
(let ((anon15_Then_correct  (=> (select refs@@6 s_10) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_37315_37316 QPMask@0 p_17 next)) (=> (HasDirectPerm_37315_37316 QPMask@0 p_17 next) (=> (= (ControlFlow 0 4) 2) anon6_correct))))))
(let ((anon14_Then_correct  (=> (select refs@@6 p_17) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not (select refs@@6 p_17)) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select refs@@6 n_3)) (select refs@@6 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 :qid |stdinbpl.1491:15|
 :skolemid |176|
))) (=> (forall ((n_3@@0 T@Ref) (n_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3@@0 n_3_1@@0)) (select refs@@6 n_3@@0)) (select refs@@6 n_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3@@0 n_3_1@@0)))
 :qid |stdinbpl.1491:15|
 :skolemid |176|
)) (=> (and (and (forall ((n_3@@1 T@Ref) ) (!  (=> (and (select refs@@6 n_3@@1) (< NoPerm FullPerm)) (and (qpRange11 n_3@@1) (= (invRecv11 n_3@@1) n_3@@1)))
 :qid |stdinbpl.1497:22|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) n_3@@1 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select refs@@6 (invRecv11 o_4)) (< NoPerm FullPerm)) (qpRange11 o_4)) (= (invRecv11 o_4) o_4))
 :qid |stdinbpl.1501:22|
 :skolemid |178|
 :pattern ( (invRecv11 o_4))
))) (and (forall ((n_3@@2 T@Ref) ) (!  (=> (select refs@@6 n_3@@2) (not (= n_3@@2 null)))
 :qid |stdinbpl.1507:22|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@2 next))
 :pattern ( (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) n_3@@2 next))
 :pattern ( (select (|PolymorphicMapType_58529_36506_36507#PolymorphicMapType_58529| Heap@@41) n_3@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select refs@@6 (invRecv11 o_4@@0)) (< NoPerm FullPerm)) (qpRange11 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv11 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next) (+ (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@0 next) FullPerm)))) (=> (not (and (and (select refs@@6 (invRecv11 o_4@@0)) (< NoPerm FullPerm)) (qpRange11 o_4@@0))) (= (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| QPMask@0) o_4@@0 next) (select (|PolymorphicMapType_58550_37315_37316#PolymorphicMapType_58550| ZeroMask) o_4@@0 next))))
...
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (and (=> (= (ControlFlow 0 13) 12) anon13_Else_correct) (=> (= (ControlFlow 0 13) 7) anon14_Then_correct)) (=> (= (ControlFlow 0 13) 3) anon14_Else_correct))))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 4)) (and (=> (= (ControlFlow 0 15) 1) anon12_Then_correct) (=> (= (ControlFlow 0 15) 13) anon12_Else_correct))))))
