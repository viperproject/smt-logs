...
(declare-fun foo_2 (T@PolymorphicMapType_3034) Bool)
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_3034) (Mask@@4 T@PolymorphicMapType_3055) ) (!  (=> (and (state Heap@@4 Mask@@4) (< AssumeFunctionsAbove 0)) (not (foo_2 Heap@@4)))
 :qid |stdinbpl.196:15|
 :skolemid |24|
 :pattern ( (state Heap@@4 Mask@@4) (foo_2 Heap@@4))
)))
...
(assert (forall ((Heap@@18 T@PolymorphicMapType_3034) ) (!  (and (= (foo_2 Heap@@18) (|foo'| Heap@@18)) (dummyFunction_1311 |foo#triggerStateless|))
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (foo_2 Heap@@18))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
