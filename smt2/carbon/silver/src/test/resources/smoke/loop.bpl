...
// Framing axioms
function  foo#frame(frame: FrameType): bool;
axiom (forall Heap: HeapType, Mask: MaskType ::
...
procedure foo#definedness() returns (Result: bool)
  modifies Heap, Mask;
{
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: inhale foo() -- loop.vpr@12.16--12.21
            assume state(Heap, Mask);
            
            // -- Check definedness of foo()
              if (*) {
                // Stop execution
                assume false;
              }
