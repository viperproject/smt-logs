...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (<= 1 (len_1 a_2@@5))) (=> (<= 1 (len_1 a_2@@5)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (and (<= 0 i_4_1) (< i_4_1 1))) (and (<= 0 i_4_2) (< i_4_2 1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_4_1) (loc a_2@@5 i_4_2))))
...
(let ((anon8_Else_correct  (=> (Contains Heap@@20 a_2@@5 5 1) (=> (and (state Heap@@20 QPMask@0) (= arg_right@0 (len_1 a_2@@5))) (and (=> (= (ControlFlow 0 12) (- 0 17)) (< 1 arg_right@0)) (=> (< 1 arg_right@0) (and (=> (= (ControlFlow 0 12) (- 0 16)) (<= arg_right@0 (len_1 a_2@@5))) (=> (<= arg_right@0 (len_1 a_2@@5)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 1 i_3) (< i_3 arg_right@0))) (and (<= 1 i_3_1) (< i_3_1 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_3) (loc a_2@@5 i_3_1))))
 :qid |stdinbpl.1037:19|
 :skolemid |90|
 :pattern ( (neverTriggered11 i_3) (neverTriggered11 i_3_1))
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 1 i_3@@0) (< i_3@@0 arg_right@0))) (and (<= 1 i_3_1@@0) (< i_3_1@@0 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_3@@0) (loc a_2@@5 i_3_1@@0))))
 :qid |stdinbpl.1037:19|
 :skolemid |90|
 :pattern ( (neverTriggered11 i_3@@0) (neverTriggered11 i_3_1@@0))
)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((i_3@@1 Int) ) (!  (=> (and (<= 1 i_3@@1) (< i_3@@1 arg_right@0)) (>= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) (loc a_2@@5 i_3@@1) val) FullPerm))
 :qid |stdinbpl.1044:19|
 :skolemid |91|
 :pattern ( (loc a_2@@5 i_3@@1))
 :pattern ( (loc a_2@@5 i_3@@1))
))) (=> (forall ((i_3@@2 Int) ) (!  (=> (and (<= 1 i_3@@2) (< i_3@@2 arg_right@0)) (>= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) (loc a_2@@5 i_3@@2) val) FullPerm))
 :qid |stdinbpl.1044:19|
 :skolemid |91|
 :pattern ( (loc a_2@@5 i_3@@2))
 :pattern ( (loc a_2@@5 i_3@@2))
)) (=> (forall ((i_3@@3 Int) ) (!  (=> (and (and (<= 1 i_3@@3) (< i_3@@3 arg_right@0)) (< NoPerm FullPerm)) (and (qpRange11 (loc a_2@@5 i_3@@3)) (= (invRecv11 (loc a_2@@5 i_3@@3)) i_3@@3)))
 :qid |stdinbpl.1050:24|
 :skolemid |92|
 :pattern ( (loc a_2@@5 i_3@@3))
 :pattern ( (loc a_2@@5 i_3@@3))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 1 (invRecv11 o_4)) (< (invRecv11 o_4) arg_right@0)) (and (< NoPerm FullPerm) (qpRange11 o_4))) (= (loc a_2@@5 (invRecv11 o_4)) o_4))
 :qid |stdinbpl.1054:24|
 :skolemid |93|
 :pattern ( (invRecv11 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 1 (invRecv11 o_4@@0)) (< (invRecv11 o_4@@0) arg_right@0)) (and (< NoPerm FullPerm) (qpRange11 o_4@@0))) (and (= (loc a_2@@5 (invRecv11 o_4@@0)) o_4@@0) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_4@@0 val) (- (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_4@@0 val) FullPerm)))) (=> (not (and (and (<= 1 (invRecv11 o_4@@0)) (< (invRecv11 o_4@@0) arg_right@0)) (and (< NoPerm FullPerm) (qpRange11 o_4@@0)))) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_4@@0 val) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_4@@0 val))))
 :qid |stdinbpl.1060:24|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_4@@0 val))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_11178_53) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.1066:31|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_11191_11192) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1066:31|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_14640_1596) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1066:31|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7519_32611) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1066:31|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@2) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7519_32744) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@2) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1066:31|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@2) o_4@@5 f_5@@3))
 ...
 :pattern ( (loc a_2@@5 i$0@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 1 (invRecv12 o_4@@6)) (< (invRecv12 o_4@@6) arg_right@0)) (< NoPerm FullPerm)) (qpRange12 o_4@@6)) (= (loc a_2@@5 (invRecv12 o_4@@6)) o_4@@6))
 ...
 :pattern ( (loc a_2@@5 i$0@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 1 (invRecv12 o_4@@7)) (< (invRecv12 o_4@@7) arg_right@0)) (< NoPerm FullPerm)) (qpRange12 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@5 (invRecv12 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) o_4@@7 val) (+ (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_4@@7 val) FullPerm)))) (=> (not (and (and (and (<= 1 (invRecv12 o_4@@7)) (< (invRecv12 o_4@@7) arg_right@0)) (< NoPerm FullPerm)) (qpRange12 o_4@@7))) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) o_4@@7 val) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_4@@7 val))))
 :qid |stdinbpl.1101:24|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) o_4@@7 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_11178_53) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@2) o_4@@8 f_5@@4) (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@3) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1105:31|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@2) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@3) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_11191_11192) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@2) o_4@@9 f_5@@5) (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@3) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1105:31|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@2) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@3) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_14640_1596) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_4@@10 f_5@@6) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1105:31|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_7519_32611) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@2) o_4@@11 f_5@@7) (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@3) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1105:31|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@2) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@3) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_7519_32744) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@2) o_4@@12 f_5@@8) (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@3) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1105:31|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@2) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@3) o_4@@12 f_5@@8))
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= 1 (len_1 a_2@@5))) (=> (<= 1 (len_1 a_2@@5)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_2_1 Int) (i_2_2 Int) ) (!  (=> (and (and (and (and (not (= i_2_1 i_2_2)) (and (<= 0 i_2_1) (< i_2_1 1))) (and (<= 0 i_2_2) (< i_2_2 1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_2_1) (loc a_2@@5 i_2_2))))
 :qid |stdinbpl.981:21|
 :skolemid |86|
 :pattern ( (neverTriggered10 i_2_1) (neverTriggered10 i_2_2))
))) (=> (forall ((i_2_1@@0 Int) (i_2_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_2_1@@0 i_2_2@@0)) (and (<= 0 i_2_1@@0) (< i_2_1@@0 1))) (and (<= 0 i_2_2@@0) (< i_2_2@@0 1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_2_1@@0) (loc a_2@@5 i_2_2@@0))))
 :qid |stdinbpl.981:21|
 :skolemid |86|
 :pattern ( (neverTriggered10 i_2_1@@0) (neverTriggered10 i_2_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_2_1@@1 Int) ) (!  (=> (and (<= 0 i_2_1@@1) (< i_2_1@@1 1)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) (loc a_2@@5 i_2_1@@1) val) NoPerm)))
 :qid |stdinbpl.988:21|
 :skolemid |87|
 :pattern ( (loc a_2@@5 i_2_1@@1))
 :pattern ( (loc a_2@@5 i_2_1@@1))
)))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len_1 a_2@@5)))) (and (<= 0 i_1_1) (< i_1_1 (len_1 a_2@@5)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_1) (loc a_2@@5 i_1_1))))
 :qid |stdinbpl.932:15|
 :skolemid |80|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (len_1 a_2@@5)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (len_1 a_2@@5)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_1@@0) (loc a_2@@5 i_1_1@@0))))
 :qid |stdinbpl.932:15|
 :skolemid |80|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (len_1 a_2@@5))) (< NoPerm FullPerm)) (and (qpRange9 (loc a_2@@5 i_1@@1)) (= (invRecv9 (loc a_2@@5 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.938:22|
 :skolemid |81|
 :pattern ( (loc a_2@@5 i_1@@1))
 :pattern ( (loc a_2@@5 i_1@@1))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_4@@13)) (< (invRecv9 o_4@@13) (len_1 a_2@@5))) (< NoPerm FullPerm)) (qpRange9 o_4@@13)) (= (loc a_2@@5 (invRecv9 o_4@@13)) o_4@@13))
 :qid |stdinbpl.942:22|
 :skolemid |82|
 :pattern ( (invRecv9 o_4@@13))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (len_1 a_2@@5))) (not (= (loc a_2@@5 i_1@@2) null)))
 :qid |stdinbpl.948:22|
 :skolemid |83|
 :pattern ( (loc a_2@@5 i_1@@2))
 :pattern ( (loc a_2@@5 i_1@@2))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_4@@14)) (< (invRecv9 o_4@@14) (len_1 a_2@@5))) (< NoPerm FullPerm)) (qpRange9 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@5 (invRecv9 o_4@@14)) o_4@@14)) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_4@@14 val) (+ (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| ZeroMask) o_4@@14 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_4@@14)) (< (invRecv9 o_4@@14) (len_1 a_2@@5))) (< NoPerm FullPerm)) (qpRange9 o_4@@14))) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_4@@14 val) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| ZeroMask) o_4@@14 val))))
 :qid |stdinbpl.954:22|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_4@@14 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_11178_53) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| ZeroMask) o_4@@15 f_5@@9) (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@0) o_4@@15 f_5@@9)))
 :qid |stdinbpl.958:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| ZeroMask) o_4@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@0) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_11191_11192) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| ZeroMask) o_4@@16 f_5@@10) (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@0) o_4@@16 f_5@@10)))
 :qid |stdinbpl.958:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| ZeroMask) o_4@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@0) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_14640_1596) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| ZeroMask) o_4@@17 f_5@@11) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_4@@17 f_5@@11)))
 :qid |stdinbpl.958:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| ZeroMask) o_4@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_7519_32611) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| ZeroMask) o_4@@18 f_5@@12) (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@0) o_4@@18 f_5@@12)))
 :qid |stdinbpl.958:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| ZeroMask) o_4@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@0) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_7519_32744) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| ZeroMask) o_4@@19 f_5@@13) (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@0) o_4@@19 f_5@@13)))
 :qid |stdinbpl.958:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| ZeroMask) o_4@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@0) o_4@@19 f_5@@13))
...
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (< 1 (len_1 a_2@@5)) (state Heap@@20 ZeroMask))) (and (=> (= (ControlFlow 0 20) 1) anon7_Then_correct) (=> (= (ControlFlow 0 20) 18) anon7_Else_correct))))))
