...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (Contains ExhaleHeap@1 a_2@@5 5 1))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (<= 1 (len a_2@@5))) (=> (<= 1 (len a_2@@5)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (and (<= 0 i_4_1) (< i_4_1 1))) (and (<= 0 i_4_2) (< i_4_2 1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_4_1) (loc a_2@@5 i_4_2))))
 :qid |stdinbpl.1136:21|
 :skolemid |103|
 :pattern ( (neverTriggered13 i_4_1) (neverTriggered13 i_4_2))
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (and (<= 0 i_4_1@@0) (< i_4_1@@0 1))) (and (<= 0 i_4_2@@0) (< i_4_2@@0 1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_4_1@@0) (loc a_2@@5 i_4_2@@0))))
 :qid |stdinbpl.1136:21|
 :skolemid |103|
 :pattern ( (neverTriggered13 i_4_1@@0) (neverTriggered13 i_4_2@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_4_1@@1 Int) ) (!  (=> (and (<= 0 i_4_1@@1) (< i_4_1@@1 1)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) (loc a_2@@5 i_4_1@@1) val) NoPerm)))
 :qid |stdinbpl.1143:21|
 :skolemid |104|
 :pattern ( (loc a_2@@5 i_4_1@@1))
 :pattern ( (loc a_2@@5 i_4_1@@1))
)))))))))
(let ((anon8_Else_correct  (=> (Contains Heap@@20 a_2@@5 5 1) (=> (and (state Heap@@20 QPMask@0) (= arg_right@0 (len a_2@@5))) (and (=> (= (ControlFlow 0 12) (- 0 17)) (< 1 arg_right@0)) (=> (< 1 arg_right@0) (and (=> (= (ControlFlow 0 12) (- 0 16)) (<= arg_right@0 (len a_2@@5))) (=> (<= arg_right@0 (len a_2@@5)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 1 i_3_2) (< i_3_2 arg_right@0))) (and (<= 1 i_3_3) (< i_3_3 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_3_2) (loc a_2@@5 i_3_3))))
 :qid |stdinbpl.1037:19|
 :skolemid |90|
 :pattern ( (neverTriggered11 i_3_2) (neverTriggered11 i_3_3))
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (and (<= 1 i_3_2@@0) (< i_3_2@@0 arg_right@0))) (and (<= 1 i_3_3@@0) (< i_3_3@@0 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_3_2@@0) (loc a_2@@5 i_3_3@@0))))
 :qid |stdinbpl.1037:19|
 :skolemid |90|
 :pattern ( (neverTriggered11 i_3_2@@0) (neverTriggered11 i_3_3@@0))
)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((i_3_2@@1 Int) ) (!  (=> (and (<= 1 i_3_2@@1) (< i_3_2@@1 arg_right@0)) (>= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) (loc a_2@@5 i_3_2@@1) val) FullPerm))
 :qid |stdinbpl.1044:19|
 :skolemid |91|
 :pattern ( (loc a_2@@5 i_3_2@@1))
 :pattern ( (loc a_2@@5 i_3_2@@1))
))) (=> (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= 1 i_3_2@@2) (< i_3_2@@2 arg_right@0)) (>= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) (loc a_2@@5 i_3_2@@2) val) FullPerm))
 :qid |stdinbpl.1044:19|
 :skolemid |91|
 :pattern ( (loc a_2@@5 i_3_2@@2))
 :pattern ( (loc a_2@@5 i_3_2@@2))
)) (=> (forall ((i_3_2@@3 Int) ) (!  (=> (and (and (<= 1 i_3_2@@3) (< i_3_2@@3 arg_right@0)) (< NoPerm FullPerm)) (and (qpRange11 (loc a_2@@5 i_3_2@@3)) (= (invRecv11 (loc a_2@@5 i_3_2@@3)) i_3_2@@3)))
 :qid |stdinbpl.1050:24|
 :skolemid |92|
 :pattern ( (loc a_2@@5 i_3_2@@3))
 :pattern ( (loc a_2@@5 i_3_2@@3))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 1 (invRecv11 o_9)) (< (invRecv11 o_9) arg_right@0)) (and (< NoPerm FullPerm) (qpRange11 o_9))) (= (loc a_2@@5 (invRecv11 o_9)) o_9))
 :qid |stdinbpl.1054:24|
 :skolemid |93|
 :pattern ( (invRecv11 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 1 (invRecv11 o_9@@0)) (< (invRecv11 o_9@@0) arg_right@0)) (and (< NoPerm FullPerm) (qpRange11 o_9@@0))) (and (= (loc a_2@@5 (invRecv11 o_9@@0)) o_9@@0) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_9@@0 val) (- (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_9@@0 val) FullPerm)))) (=> (not (and (and (<= 1 (invRecv11 o_9@@0)) (< (invRecv11 o_9@@0) arg_right@0)) (and (< NoPerm FullPerm) (qpRange11 o_9@@0)))) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_9@@0 val) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_9@@0 val))))
 :qid |stdinbpl.1060:24|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_9@@0 val))
))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_11178_53) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@2) o_9@@1 f_5)))
 :qid |stdinbpl.1066:31|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@2) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_11191_11192) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1066:31|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@2) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_14640_1596) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1066:31|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_7519_32611) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1066:31|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@2) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_7519_32744) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@2) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1066:31|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@2) o_9@@5 f_5@@3))
))) (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@1 QPMask@2)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((i$0 Int) (i$0_3 Int) ) (!  (=> (and (and (and (and (not (= i$0 i$0_3)) (and (<= 1 i$0) (< i$0 arg_right@0))) (and (<= 1 i$0_3) (< i$0_3 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i$0) (loc a_2@@5 i$0_3))))
 :qid |stdinbpl.1079:17|
 :skolemid |96|
))) (=> (forall ((i$0@@0 Int) (i$0_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i$0@@0 i$0_3@@0)) (and (<= 1 i$0@@0) (< i$0@@0 arg_right@0))) (and (<= 1 i$0_3@@0) (< i$0_3@@0 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i$0@@0) (loc a_2@@5 i$0_3@@0))))
 :qid |stdinbpl.1079:17|
 :skolemid |96|
)) (=> (and (and (forall ((i$0@@1 Int) ) (!  (=> (and (and (<= 1 i$0@@1) (< i$0@@1 arg_right@0)) (< NoPerm FullPerm)) (and (qpRange12 (loc a_2@@5 i$0@@1)) (= (invRecv12 (loc a_2@@5 i$0@@1)) i$0@@1)))
 :qid |stdinbpl.1085:24|
 :skolemid |97|
 :pattern ( (loc a_2@@5 i$0@@1))
 :pattern ( (loc a_2@@5 i$0@@1))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (and (<= 1 (invRecv12 o_9@@6)) (< (invRecv12 o_9@@6) arg_right@0)) (< NoPerm FullPerm)) (qpRange12 o_9@@6)) (= (loc a_2@@5 (invRecv12 o_9@@6)) o_9@@6))
 :qid |stdinbpl.1089:24|
 :skolemid |98|
 :pattern ( (invRecv12 o_9@@6))
))) (and (forall ((i$0@@2 Int) ) (!  (=> (and (<= 1 i$0@@2) (< i$0@@2 arg_right@0)) (not (= (loc a_2@@5 i$0@@2) null)))
 :qid |stdinbpl.1095:24|
 :skolemid |99|
 :pattern ( (loc a_2@@5 i$0@@2))
 :pattern ( (loc a_2@@5 i$0@@2))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 1 (invRecv12 o_9@@7)) (< (invRecv12 o_9@@7) arg_right@0)) (< NoPerm FullPerm)) (qpRange12 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@5 (invRecv12 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) o_9@@7 val) (+ (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_9@@7 val) FullPerm)))) (=> (not (and (and (and (<= 1 (invRecv12 o_9@@7)) (< (invRecv12 o_9@@7) arg_right@0)) (< NoPerm FullPerm)) (qpRange12 o_9@@7))) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) o_9@@7 val) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_9@@7 val))))
 :qid |stdinbpl.1101:24|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) o_9@@7 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_11178_53) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@2) o_9@@8 f_5@@4) (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@3) o_9@@8 f_5@@4)))
 :qid |stdinbpl.1105:31|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@2) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@3) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_11191_11192) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@2) o_9@@9 f_5@@5) (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@3) o_9@@9 f_5@@5)))
 :qid |stdinbpl.1105:31|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@2) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@3) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_14640_1596) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_9@@10 f_5@@6) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) o_9@@10 f_5@@6)))
 :qid |stdinbpl.1105:31|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@2) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@3) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_7519_32611) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@2) o_9@@11 f_5@@7) (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@3) o_9@@11 f_5@@7)))
 :qid |stdinbpl.1105:31|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@2) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@3) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_7519_32744) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@2) o_9@@12 f_5@@8) (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@3) o_9@@12 f_5@@8)))
 :qid |stdinbpl.1105:31|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@2) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@3) o_9@@12 f_5@@8))
))) (and (and (state ExhaleHeap@1 QPMask@3) (forall ((i$1 Int) ) (!  (=> (and (<= 1 i$1) (< i$1 arg_right@0)) (ite (= (select (|PolymorphicMapType_11118_7519_1596#PolymorphicMapType_11118| Heap@@20) (loc a_2@@5 i$1) val) 5) (= (select (|PolymorphicMapType_11118_7519_1596#PolymorphicMapType_11118| ExhaleHeap@1) (loc a_2@@5 i$1) val) 7) (= (select (|PolymorphicMapType_11118_7519_1596#PolymorphicMapType_11118| ExhaleHeap@1) (loc a_2@@5 i$1) val) (select (|PolymorphicMapType_11118_7519_1596#PolymorphicMapType_11118| Heap@@20) (loc a_2@@5 i$1) val))))
 :qid |stdinbpl.1111:22|
 :skolemid |102|
 :pattern ( (loc a_2@@5 i$1))
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= 1 (len a_2@@5))) (=> (<= 1 (len a_2@@5)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_2 Int) (i_2_2 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_2)) (and (<= 0 i_2) (< i_2 1))) (and (<= 0 i_2_2) (< i_2_2 1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_2) (loc a_2@@5 i_2_2))))
 :qid |stdinbpl.981:21|
 :skolemid |86|
 :pattern ( (neverTriggered10 i_2) (neverTriggered10 i_2_2))
))) (=> (forall ((i_2@@0 Int) (i_2_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_2@@0 i_2_2@@0)) (and (<= 0 i_2@@0) (< i_2@@0 1))) (and (<= 0 i_2_2@@0) (< i_2_2@@0 1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_2@@0) (loc a_2@@5 i_2_2@@0))))
 :qid |stdinbpl.981:21|
 :skolemid |86|
 :pattern ( (neverTriggered10 i_2@@0) (neverTriggered10 i_2_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_2@@1 Int) ) (!  (=> (and (<= 0 i_2@@1) (< i_2@@1 1)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) (loc a_2@@5 i_2@@1) val) NoPerm)))
 :qid |stdinbpl.988:21|
 :skolemid |87|
 :pattern ( (loc a_2@@5 i_2@@1))
 :pattern ( (loc a_2@@5 i_2@@1))
)))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len a_2@@5)))) (and (<= 0 i_1_1) (< i_1_1 (len a_2@@5)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_1) (loc a_2@@5 i_1_1))))
 :qid |stdinbpl.932:15|
 :skolemid |80|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (len a_2@@5)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (len a_2@@5)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@5 i_1@@0) (loc a_2@@5 i_1_1@@0))))
 :qid |stdinbpl.932:15|
 :skolemid |80|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (len a_2@@5))) (< NoPerm FullPerm)) (and (qpRange9 (loc a_2@@5 i_1@@1)) (= (invRecv9 (loc a_2@@5 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.938:22|
 :skolemid |81|
 :pattern ( (loc a_2@@5 i_1@@1))
 :pattern ( (loc a_2@@5 i_1@@1))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_9@@13)) (< (invRecv9 o_9@@13) (len a_2@@5))) (< NoPerm FullPerm)) (qpRange9 o_9@@13)) (= (loc a_2@@5 (invRecv9 o_9@@13)) o_9@@13))
 :qid |stdinbpl.942:22|
 :skolemid |82|
 :pattern ( (invRecv9 o_9@@13))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (len a_2@@5))) (not (= (loc a_2@@5 i_1@@2) null)))
 :qid |stdinbpl.948:22|
 :skolemid |83|
 :pattern ( (loc a_2@@5 i_1@@2))
 :pattern ( (loc a_2@@5 i_1@@2))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_9@@14)) (< (invRecv9 o_9@@14) (len a_2@@5))) (< NoPerm FullPerm)) (qpRange9 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@5 (invRecv9 o_9@@14)) o_9@@14)) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_9@@14 val) (+ (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| ZeroMask) o_9@@14 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_9@@14)) (< (invRecv9 o_9@@14) (len a_2@@5))) (< NoPerm FullPerm)) (qpRange9 o_9@@14))) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_9@@14 val) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| ZeroMask) o_9@@14 val))))
 :qid |stdinbpl.954:22|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_9@@14 val))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_11178_53) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| ZeroMask) o_9@@15 f_5@@9) (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@0) o_9@@15 f_5@@9)))
 :qid |stdinbpl.958:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| ZeroMask) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_11139_7519_53#PolymorphicMapType_11139| QPMask@0) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_11191_11192) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| ZeroMask) o_9@@16 f_5@@10) (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@0) o_9@@16 f_5@@10)))
 :qid |stdinbpl.958:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| ZeroMask) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_11139_7519_11192#PolymorphicMapType_11139| QPMask@0) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_14640_1596) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| ZeroMask) o_9@@17 f_5@@11) (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_9@@17 f_5@@11)))
 :qid |stdinbpl.958:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| ZeroMask) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_11139_7519_1596#PolymorphicMapType_11139| QPMask@0) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_7519_32611) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| ZeroMask) o_9@@18 f_5@@12) (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@0) o_9@@18 f_5@@12)))
 :qid |stdinbpl.958:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| ZeroMask) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_11139_7519_32611#PolymorphicMapType_11139| QPMask@0) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_7519_32744) ) (!  (=> true (= (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| ZeroMask) o_9@@19 f_5@@13) (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@0) o_9@@19 f_5@@13)))
 :qid |stdinbpl.958:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| ZeroMask) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_11139_7519_36866#PolymorphicMapType_11139| QPMask@0) o_9@@19 f_5@@13))
))) (state Heap@@20 QPMask@0)) (and (state Heap@@20 QPMask@0) (state Heap@@20 QPMask@0))) (and (=> (= (ControlFlow 0 18) 3) anon8_Then_correct) (=> (= (ControlFlow 0 18) 12) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (< 1 (len a_2@@5)) (state Heap@@20 ZeroMask))) (and (=> (= (ControlFlow 0 20) 1) anon7_Then_correct) (=> (= (ControlFlow 0 20) 18) anon7_Else_correct))))))
