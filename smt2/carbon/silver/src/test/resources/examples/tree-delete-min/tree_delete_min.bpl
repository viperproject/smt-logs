  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (unfolding acc(Tree(x), write) in x.v)
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access x.v (tree_delete_min.vpr@30.1--32.34) [111815]"}
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (x == null ? Seq[Int]() : (unfolding acc(Tree(x), write) in vals(x.l) ++ Seq(x.v) ++ vals(x.r)))
      if (x == null) {
        ...
        assume state(UnfoldingHeap, UnfoldingMask);
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access x.l (tree_delete_min.vpr@34.1--36.90) [111817]"}
        ...
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access x.v (tree_delete_min.vpr@34.1--36.90) [111819]"}
          HasDirectPerm(UnfoldingMask, x, v_36);
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access x.r (tree_delete_min.vpr@34.1--36.90) [111820]"}
  ...
  // -- Check definedness of predicate body of Tree
    ...
    if (x == null) {
      ...
      // -- Check definedness of acc(Tree(x.l), write)
        assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access x.l (tree_delete_min.vpr@22.1--28.2) [111822]"}
      ...
      // -- Check definedness of acc(Tree(x.r), write)
        assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access x.r (tree_delete_min.vpr@22.1--28.2) [111823]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: plvs := vals(p.l) -- tree_delete_min.vpr@54.3--54.20
    ...
    // -- Check definedness of vals(p.l)
      assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@54.3--54.20) [111834]"}
  ...
  // -- Translating statement: if (p.l == null) -- tree_delete_min.vpr@56.3--92.4
    ...
    // -- Check definedness of p.l == null
      assert {:msg "  Conditional statement might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@56.7--56.18) [111836]"}
        HasDirectPerm(Mask, p_1, l_8);
    if (Heap[p_1, l_8] == null) {
      ...
      // -- Translating statement: z := p.r -- tree_delete_min.vpr@57.5--57.13
        ...
        // -- Check definedness of p.r
          assert {:msg "  Assignment might fail. There might be insufficient permission to access p.r (tree_delete_min.vpr@57.5--57.13) [111837]"}
      ...
      // -- Translating statement: assert vals(x.l) == Seq[Int]() -- tree_delete_min.vpr@59.5--59.35
        ...
        assert {:msg "  Assert might fail. Assertion vals(x.l) == Seq[Int]() might not hold. (tree_delete_min.vpr@59.12--59.35) [111840]"}
  ...
  // } -- tree_delete_min.vpr@61.5--63.6
            ...
            if (b_1_1) {
              if (b_1_1) {
                ...
                // -- Check definedness of acc(Tree(p.l), write)
                  assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@61.5--63.6) [111841]"}
            ...
            if (b_1_1) {
              ...
              if (b_1_1) {
                ...
                // -- Check definedness of vals(p.l) == plvs[1..]
                  assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@61.5--63.6) [111842]"}
                    HasDirectPerm(Ops_1Mask, p_1, l_8);
                  if (*) {
                    // Exhale precondition of function application
            ...
            if (b_1_1) {
              if (p_1 == null) {
                ...
                // -- Transfer of acc(p.v, write)
                  ...
                  assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.v, write) might be negative. (tree_delete_min.vpr@62.9--62.26) [111846]"}
                  ...
                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.v (tree_delete_min.vpr@62.9--62.26) [111847]"}
                ...
                // -- Transfer of acc(p.l, write)
                  ...
                  assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.l, write) might be negative. (tree_delete_min.vpr@62.9--62.26) [111848]"}
                    neededTransfer >= 0.000000000;
                  ...
                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@62.9--62.26) [111849]"}
                ...
                // -- Transfer of acc(Tree(p.l), write)
                  ...
                  // -- checking if access predicate defined in used state
                    if (b_1_1 && b_2_1) {
                      if (b_1_1) {
                        ...
                        // -- Check definedness of acc(Tree(p.l), write)
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@62.9--62.26) [111850]"}
                  ...
                  assert {:msg "  Folding Tree(p) might fail. Fraction acc(Tree(p.l), write) might be negative. (tree_delete_min.vpr@62.9--62.26) [111851]"}
                    neededTransfer >= 0.000000000;
                  ...
                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@62.9--62.26) [111852]"}
                ...
                // -- Transfer of acc(p.r, write)
                  ...
                  assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.r, write) might be negative. (tree_delete_min.vpr@62.9--62.26) [111853]"}
                    neededTransfer >= 0.000000000;
                  ...
                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.r (tree_delete_min.vpr@62.9--62.26) [111854]"}
                ...
                // -- Transfer of acc(Tree(p.r), write)
                    ...
                    if (b_1_1 && b_2_1) {
                      if (b_1_1) {
                        ...
                        // -- Check definedness of acc(Tree(p.r), write)
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.r (tree_delete_min.vpr@62.9--62.26) [111855]"}
                  ...
                  assert {:msg "  Folding Tree(p) might fail. Fraction acc(Tree(p.r), write) might be negative. (tree_delete_min.vpr@62.9--62.26) [111856]"}
                    neededTransfer >= 0.000000000;
                  ...
                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access Tree(p.r) (tree_delete_min.vpr@62.9--62.26) [111857]"}
        ...
        // -- Transfer of acc(Tree(x), write)
          ...
          assert {:msg "  Packaging wand might fail. Fraction acc(Tree(x), write) might be negative. (tree_delete_min.vpr@61.5--63.6) [111859]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@61.5--63.6) [111860]"}
        ...
        assert {:msg "  Packaging wand might fail. Assertion vals(x) == old(vals(x))[1..] might not hold. (tree_delete_min.vpr@61.5--63.6) [111863]"}
      ...
      // -- Translating statement: while ((unfolding acc(Tree(p.l), write) in p.l.l != null)) -- tree_delete_min.vpr@65.5--82.6
        ...
        // -- Before loop head
          ...
          // -- Exhale loop invariant before loop
            ...
            perm := FullPerm;
            if (perm != NoPerm) {
              assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not hold on entry. There might be insufficient permission to access p.l (tree_delete_min.vpr@66.17--66.71) [111865]"}
                perm <= Mask[p_1, l_8];
            }
            Mask := Mask[p_1, l_8:=Mask[p_1, l_8] - perm];
            perm := FullPerm;
            if (perm != NoPerm) {
              assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not hold on entry. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@66.17--66.71) [111866]"}
                perm <= Mask[null, Tree(Heap[p_1, l_8])];
            }
            Mask := Mask[null, Tree(Heap[p_1, l_8]):=Mask[null, Tree(Heap[p_1, l_8])] - perm];
            assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not hold on entry. Assertion p.l != null might not hold. (tree_delete_min.vpr@66.17--66.71) [111867]"}
              Heap[p_1, l_8] != null;
            assert {:msg "  Loop invariant plvs == vals(p.l) might not hold on entry. Assertion plvs == vals(p.l) might not hold. (tree_delete_min.vpr@67.17--67.34) [111868]"}
              Seq#Equal(plvs, vals(Heap, Heap[p_1, l_8]));
            // permLe
            assert {:msg "  Loop invariant acc(p.l, write) && (acc(Tree(p.l), write) && vals(p.l) == plvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..] might not hold on entry. Magic wand instance not found. (tree_delete_min.vpr@68.17--68.24) [111869]"}
        ...
        // -- Check definedness of invariant
          if (*) {
            ...
            // -- Check definedness of acc(Tree(p.l), write)
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.l (tree_delete_min.vpr@66.17--66.71) [111870]"}
                HasDirectPerm(Mask, p_1, l_8);
            perm := FullPerm;
            Mask := Mask[null, Tree(Heap[p_1, l_8]):=Mask[null, Tree(Heap[p_1, l_8])] + perm];
            assume state(Heap, Mask);
            ...
            // -- Check definedness of p.l != null
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.l (tree_delete_min.vpr@66.17--66.71) [111871]"}
                HasDirectPerm(Mask, p_1, l_8);
            ...
            // -- Check definedness of plvs == vals(p.l)
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.l (tree_delete_min.vpr@67.17--67.34) [111872]"}
                HasDirectPerm(Mask, p_1, l_8);
              if (*) {
                // Exhale precondition of function application
                ExhaleWellDef0Mask := Mask;
            ...
            // -- Check definedness of acc(p.l, write) && (acc(Tree(p.l), write) && vals(p.l) == plvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..]
              if (*) {
                ...
                // -- Check definedness of acc(Tree(p.l), write)
                  assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.l (tree_delete_min.vpr@68.17--68.24) [111874]"}
                ...
                // -- Check definedness of vals(p.l) == plvs[1..]
                  assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.l (tree_delete_min.vpr@68.17--68.24) [111875]"}
                    HasDirectPerm(WandDefLHSMask, p_1, l_8);
                  if (*) {
                    // Exhale precondition of function application
        ...
        // -- Check the loop body
          if (*) {
            ...
            // -- Check definedness of (unfolding acc(Tree(p.l), write) in p.l.l != null)
              ...
              assume state(UnfoldingHeap, UnfoldingMask);
              assert {:msg "  While statement might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@65.12--65.53) [111880]"}
                HasDirectPerm(UnfoldingMask, p_1, l_8);
              assert {:msg "  While statement might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@65.12--65.53) [111881]"}
                HasDirectPerm(UnfoldingMask, p_1, l_8);
              assert {:msg "  While statement might fail. There might be insufficient permission to access p.l.l (tree_delete_min.vpr@65.12--65.53) [111882]"}
            ...
            // -- Translate loop body
              ...
              // -- Translating statement: unfold acc(Tree(p.l), write) -- tree_delete_min.vpr@73.7--73.28
                ...
                // -- Check definedness of acc(Tree(p.l), write)
                  assert {:msg "  Unfolding Tree(p.l) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@73.7--73.28) [111883]"}
                    HasDirectPerm(Mask, p_1, l_8);
              ...
              // -- Translating statement: p := p.l -- tree_delete_min.vpr@74.7--74.15
                ...
                // -- Check definedness of p.l
                  assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@74.7--74.15) [111885]"}
                    HasDirectPerm(Mask, p_1, l_8);
                p_1 := Heap[p_1, l_8];
                assume state(Heap, Mask);
              ...
              // -- Translating statement: plvs := vals(p.l) -- tree_delete_min.vpr@75.7--75.24
                ...
                // -- Check definedness of vals(p.l)
                  assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@75.7--75.24) [111886]"}
                    HasDirectPerm(Mask, p_1, l_8);
                  if (*) {
                    // Exhale precondition of function application
                    ExhaleWellDef0Mask := Mask;
                  ...
                  if (b_12) {
                    if (b_12) {
                      if (b_12) {
                        ...
                        // -- Check definedness of acc(Tree(p.l), write)
                          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@77.7--81.8) [111888]"}
                    ...
                    if (b_12) {
                      ...
                      if (b_12) {
                        ...
                        // -- Check definedness of vals(p.l) == plvs[1..]
                          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@77.7--81.8) [111889]"}
                            HasDirectPerm(Ops_3Mask, p_1, l_8);
                          if (*) {
                            // Exhale precondition of function application
                    ...
                    if (b_12) {
                      if (p_1 == null) {
                        ...
                        // -- Transfer of acc(p.v, write)
                          ...
                          assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.v, write) might be negative. (tree_delete_min.vpr@78.11--78.23) [111891]"}
                            neededTransfer >= 0.000000000;
                          ...
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.v (tree_delete_min.vpr@78.11--78.23) [111892]"}
                        ...
                        // -- Transfer of acc(p.l, write)
                          ...
                          assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.l, write) might be negative. (tree_delete_min.vpr@78.11--78.23) [111893]"}
                            neededTransfer >= 0.000000000;
                          ...
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@78.11--78.23) [111894]"}
                        ...
                        // -- Transfer of acc(Tree(p.l), write)
                          ...
                          // -- checking if access predicate defined in used state
                            if (b_12 && b_13) {
                              if (b_12) {
                                ...
                                // -- Check definedness of acc(Tree(p.l), write)
                                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@78.11--78.23) [111895]"}
                          ...
                          assert {:msg "  Folding Tree(p) might fail. Fraction acc(Tree(p.l), write) might be negative. (tree_delete_min.vpr@78.11--78.23) [111896]"}
                            neededTransfer >= 0.000000000;
                          ...
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@78.11--78.23) [111897]"}
                        ...
                        // -- Transfer of acc(p.r, write)
                          ...
                          assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.r, write) might be negative. (tree_delete_min.vpr@78.11--78.23) [111898]"}
                            neededTransfer >= 0.000000000;
                          ...
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.r (tree_delete_min.vpr@78.11--78.23) [111899]"}
                        ...
                        // -- Transfer of acc(Tree(p.r), write)
                          ...
                          // -- checking if access predicate defined in used state
                            if (b_12 && b_13) {
                              if (b_12) {
                                ...
                                // -- Check definedness of acc(Tree(p.r), write)
                                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.r (tree_delete_min.vpr@78.11--78.23) [111900]"}
                          ...
                          assert {:msg "  Folding Tree(p) might fail. Fraction acc(Tree(p.r), write) might be negative. (tree_delete_min.vpr@78.11--78.23) [111901]"}
                            neededTransfer >= 0.000000000;
                          ...
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access Tree(p.r) (tree_delete_min.vpr@78.11--78.23) [111902]"}
  ...
  //   acc(Tree(x), write) && vals(x) == old(vals(x))[1..] -- tree_delete_min.vpr@79.11--80.57
                    ...
                    // -- check if wand is held and remove an instance
                      ...
                      // -- Transfer of acc(oldP.l, write) && (acc(Tree(oldP.l), write) && vals(oldP.l) == oldPlvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..]
                              ...
                              // -- Check definedness of acc(oldP.l, write) && (acc(Tree(oldP.l), write) && vals(oldP.l) == oldPlvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..]
                                if (*) {
                                  ...
                                  // -- Check definedness of acc(Tree(oldP.l), write)
                                    assert {:msg "  Applying wand might fail. There might be insufficient permission to access oldP.l (tree_delete_min.vpr@79.11--80.57) [111903]"}
                                  ...
                                  // -- Check definedness of vals(oldP.l) == oldPlvs[1..]
                                    assert {:msg "  Applying wand might fail. There might be insufficient permission to access oldP.l (tree_delete_min.vpr@79.11--80.57) [111904]"}
                                      HasDirectPerm(WandDefLHSMask, oldP, l_8);
                                    if (*) {
                                      // Exhale precondition of function application
                        ...
                        assert {:msg "  Applying wand might fail. Fraction acc(oldP.l, write) && (acc(Tree(oldP.l), write) && vals(oldP.l) == oldPlvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..] might be negative. (tree_delete_min.vpr@79.11--80.57) [111908]"}
                          neededTransfer >= 0.000000000;
                        ...
                        assert {:msg "  Applying wand might fail. Magic wand instance not found. (tree_delete_min.vpr@79.11--80.57) [111909]"}
                    ...
                    // -- check if LHS holds and remove permissions 
                      ...
                      // -- Transfer of acc(oldP.l, write)
                        ...
                        assert {:msg "  Applying wand might fail. Fraction acc(oldP.l, write) might be negative. (tree_delete_min.vpr@79.11--80.57) [111910]"}
                          neededTransfer >= 0.000000000;
                        ...
                        assert {:msg "  Applying wand might fail. There might be insufficient permission to access oldP.l (tree_delete_min.vpr@79.11--80.57) [111911]"}
                      ...
                      // -- Transfer of acc(Tree(oldP.l), write)
                        ...
                        // -- checking if access predicate defined in used state
                          if (b_12 && b_22) {
                            if (b_12) {
                              ...
                              // -- Check definedness of acc(Tree(oldP.l), write)
                                assert {:msg "  Applying wand might fail. There might be insufficient permission to access oldP.l (tree_delete_min.vpr@79.11--80.57) [111912]"}
                        ...
                        assert {:msg "  Applying wand might fail. Fraction acc(Tree(oldP.l), write) might be negative. (tree_delete_min.vpr@79.11--80.57) [111913]"}
                          neededTransfer >= 0.000000000;
                        ...
                        assert {:msg "  Applying wand might fail. There might be insufficient permission to access Tree(oldP.l) (tree_delete_min.vpr@79.11--80.57) [111914]"}
                      ...
                      if (b_12 && b_22) {
                        if (b_12) {
                          ...
                          // -- Check definedness of vals(oldP.l) == oldPlvs[1..]
                            assert {:msg "  Applying wand might fail. There might be insufficient permission to access oldP.l (tree_delete_min.vpr@79.11--80.57) [111915]"}
                      ...
                      assert {:msg "  Applying wand might fail. Assertion vals(oldP.l) == oldPlvs[1..] might not hold. (tree_delete_min.vpr@79.11--80.57) [111917]"}
                ...
                // -- Transfer of acc(Tree(x), write)
                  ...
                  assert {:msg "  Packaging wand might fail. Fraction acc(Tree(x), write) might be negative. (tree_delete_min.vpr@77.7--81.8) [111918]"}
                    neededTransfer >= 0.000000000;
                  ...
                  assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@77.7--81.8) [111919]"}
                ...
                assert {:msg "  Packaging wand might fail. Assertion vals(x) == old(vals(x))[1..] might not hold. (tree_delete_min.vpr@77.7--81.8) [111922]"}
            ...
            perm := FullPerm;
            if (perm != NoPerm) {
              assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not be preserved. There might be insufficient permission to access p.l (tree_delete_min.vpr@66.17--66.71) [111924]"}
                perm <= Mask[p_1, l_8];
            }
            Mask := Mask[p_1, l_8:=Mask[p_1, l_8] - perm];
            perm := FullPerm;
            if (perm != NoPerm) {
              assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not be preserved. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@66.17--66.71) [111925]"}
                perm <= Mask[null, Tree(Heap[p_1, l_8])];
            }
            Mask := Mask[null, Tree(Heap[p_1, l_8]):=Mask[null, Tree(Heap[p_1, l_8])] - perm];
            assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not be preserved. Assertion p.l != null might not hold. (tree_delete_min.vpr@66.17--66.71) [111926]"}
              Heap[p_1, l_8] != null;
            assert {:msg "  Loop invariant plvs == vals(p.l) might not be preserved. Assertion plvs == vals(p.l) might not hold. (tree_delete_min.vpr@67.17--67.34) [111927]"}
              Seq#Equal(plvs, vals(Heap, Heap[p_1, l_8]));
            // permLe
            assert {:msg "  Loop invariant acc(p.l, write) && (acc(Tree(p.l), write) && vals(p.l) == plvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..] might not be preserved. Magic wand instance not found. (tree_delete_min.vpr@68.17--68.24) [111928]"}
              FullPerm <= Mask[null, wand(p_1, FullPerm, p_1, p_1, Seq#Drop(plvs, 1), x, x, Seq#Drop(vals(oldHeap, x), 1))];
            Mask := Mask[null, wand(p_1, FullPerm, p_1, p_1, Seq#Drop(plvs, 1), x, x, Seq#Drop(vals(oldHeap, x), 1)):=Mask[null, wand(p_1, FullPerm, p_1, p_1, Seq#Drop(plvs, 1), x, x, Seq#Drop(vals(oldHeap, x), 1))] - FullPerm];
            // Finish exhale
            havoc ExhaleHeap;
      ...
      // -- Translating statement: unfold acc(Tree(p.l), write) -- tree_delete_min.vpr@84.5--84.26
        ...
        // -- Check definedness of acc(Tree(p.l), write)
          assert {:msg "  Unfolding Tree(p.l) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@84.5--84.26) [111929]"}
            HasDirectPerm(Mask, p_1, l_8);
        assume Tree#trigger(Heap, Tree(Heap[p_1, l_8]));
        assume Heap[null, Tree(Heap[p_1, l_8])] == FrameFragment((if Heap[p_1, l_8] == null then EmptyFrame else CombineFrames(FrameFragment(Heap[Heap[p_1, l_8], v_36]), CombineFrames(FrameFragment(Heap[Heap[p_1, l_8], l_8]), CombineFrames(Heap[null, Tree(Heap[Heap[p_1, l_8], l_8])], CombineFrames(FrameFragment(Heap[Heap[p_1, l_8], r_6]), Heap[null, Tree(Heap[Heap[p_1, l_8], r_6])]))))));
        ExhaleWellDef0Mask := Mask;
      ...
      // -- Translating statement: assert vals(p.l.l) == Seq[Int]() -- tree_delete_min.vpr@85.5--85.37
        ...
        // -- Check definedness of vals(p.l.l) == Seq[Int]()
          ...
          assert {:msg "  Assert might fail. There might be insufficient permission to access p.l.l (tree_delete_min.vpr@85.12--85.37) [111939]"}
        ...
        assert {:msg "  Assert might fail. Assertion vals(p.l.l) == Seq[Int]() might not hold. (tree_delete_min.vpr@85.12--85.37) [111941]"}
      ...
      // -- Translating statement: p.l := p.l.r -- tree_delete_min.vpr@87.5--87.17
        ...
        // -- Check definedness of p.l.r
          assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@87.5--87.17) [111942]"}
            HasDirectPerm(Mask, p_1, l_8);
          assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l.r (tree_delete_min.vpr@87.5--87.17) [111943]"}
            HasDirectPerm(Mask, Heap[p_1, l_8], r_6);
        assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@87.5--87.17) [111944]"}
  ...
  //   acc(Tree(x), write) && vals(x) == old(vals(x))[1..] -- tree_delete_min.vpr@89.5--89.18
        ...
        // -- check if LHS holds and remove permissions 
          ...
          perm := FullPerm;
          if (perm != NoPerm) {
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@89.5--89.18) [111949]"}
              perm <= Mask[null, Tree(Heap[p_1, l_8])];
          }
          Mask := Mask[null, Tree(Heap[p_1, l_8]):=Mask[null, Tree(Heap[p_1, l_8])] - perm];
          assert {:msg "  Applying wand might fail. Assertion vals(p.l) == plvs[1..] might not hold. (tree_delete_min.vpr@89.5--89.18) [111950]"}
  ...
  // -- Exhaling postcondition
    ...
    assert {:msg "  Postcondition of tree_delete_min might not hold. Assertion vals(z) == old(vals(x))[1..] might not hold. (tree_delete_min.vpr@45.11--45.39) [111953]"}
