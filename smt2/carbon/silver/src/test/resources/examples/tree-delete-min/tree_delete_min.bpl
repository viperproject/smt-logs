  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (unfolding acc(Tree(x), write) in x.v)
      ...
      perm := FullPerm;
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@30.1--32.34) [107739]"}
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access x.v (tree_delete_min.vpr@30.1--32.34) [107740]"}
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (x == null ? Seq[Int]() : (unfolding acc(Tree(x), write) in vals(x.l) ++ Seq(x.v) ++ vals(x.r)))
      if (x == null) {
        ...
        ExhaleWellDef0Heap := UnfoldingHeap;
        perm := FullPerm;
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@34.1--36.90) [107741]"}
          NoPerm < perm ==> NoPerm < UnfoldingMask[null, Tree(x)];
        if (x == null) {
        } else {
          perm := FullPerm;
        ...
        assume state(UnfoldingHeap, UnfoldingMask);
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access x.l (tree_delete_min.vpr@34.1--36.90) [107742]"}
        ...
        if (*) {
          ...
          ExhaleWellDef0Heap := UnfoldingHeap;
          perm := FullPerm;
          assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x.l) (tree_delete_min.vpr@36.54--36.63) [107743]"}
        ...
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access x.v (tree_delete_min.vpr@34.1--36.90) [107744]"}
          HasDirectPerm(UnfoldingMask, x, v_35);
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access x.r (tree_delete_min.vpr@34.1--36.90) [107745]"}
        ...
        if (*) {
          ...
          ExhaleWellDef0Heap := UnfoldingHeap;
          perm := FullPerm;
          assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x.r) (tree_delete_min.vpr@36.79--36.88) [107746]"}
  ...
  // -- Check definedness of predicate body of Tree
    ...
    if (x == null) {
      ...
      // -- Check definedness of acc(Tree(x.l), write)
        assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access x.l (tree_delete_min.vpr@22.1--28.2) [107747]"}
      ...
      // -- Check definedness of acc(Tree(x.r), write)
        assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access x.r (tree_delete_min.vpr@22.1--28.2) [107748]"}
  ...
  modifies Heap, Mask;
{
  ...
  if (*) {
    ...
    // -- Check definedness of vals(z) == old(vals(x))[1..]
      if (*) {
        ...
        perm := FullPerm;
        assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(z) (tree_delete_min.vpr@45.11--45.18) [107749]"}
      ...
      if (*) {
        ...
        perm := FullPerm;
        assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@45.26--45.33) [107750]"}
  ...
  // -- Translating statement: p := x -- tree_delete_min.vpr@47.3--47.18
    p_1 := x;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: unfold acc(Tree(p), write) -- tree_delete_min.vpr@53.3--53.22
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Unfolding Tree(p) might fail. There might be insufficient permission to access Tree(p) (tree_delete_min.vpr@53.3--53.22) [107753]"}
  ...
  // -- Translating statement: plvs := vals(p.l) -- tree_delete_min.vpr@54.3--54.20
    
    // -- Check definedness of vals(p.l)
      assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@54.3--54.20) [107759]"}
      ...
      if (*) {
        ...
        ExhaleWellDef0Heap := Heap;
        perm := FullPerm;
        assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@54.11--54.20) [107760]"}
  ...
  // -- Translating statement: if (p.l == null) -- tree_delete_min.vpr@56.3--92.4
    
    // -- Check definedness of p.l == null
      assert {:msg "  Conditional statement might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@56.7--56.18) [107761]"}
        HasDirectPerm(Mask, p_1, l);
    if (Heap[p_1, l] == null) {
      
      // -- Translating statement: z := p.r -- tree_delete_min.vpr@57.5--57.13
        
        // -- Check definedness of p.r
          assert {:msg "  Assignment might fail. There might be insufficient permission to access p.r (tree_delete_min.vpr@57.5--57.13) [107762]"}
      ...
      // -- Translating statement: assert vals(x.l) == Seq[Int]() -- tree_delete_min.vpr@59.5--59.35
        ...
        // -- Check definedness of vals(x.l) == Seq[Int]()
          assert {:msg "  Assert might fail. There might be insufficient permission to access x.l (tree_delete_min.vpr@59.12--59.35) [107763]"}
          ...
          if (*) {
            ...
            perm := FullPerm;
            assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x.l) (tree_delete_min.vpr@59.12--59.21) [107764]"}
        ...
        assert {:msg "  Assert might fail. Assertion vals(x.l) == Seq[Int]() might not hold. (tree_delete_min.vpr@59.12--59.35) [107765]"}
  ...
  // } -- tree_delete_min.vpr@61.5--63.6
            ...
            if (b_1_1) {
              if (b_1_1) {
                ...
                // -- Check definedness of acc(Tree(p.l), write)
                  assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@61.5--63.6) [107766]"}
            ...
            if (b_1_1) {
              ...
              if (b_1_1) {
                ...
                // -- Check definedness of vals(p.l) == plvs[1..]
                  assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@61.5--63.6) [107767]"}
                    HasDirectPerm(Ops_1Mask, p_1, l);
                  if (*) {
                    // Exhale precondition of function application
                    ...
                    perm := FullPerm;
                    assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@61.14--61.15) [107768]"}
            ...
            if (b_1_1) {
              if (p_1 == null) {
                ...
                // -- Transfer of acc(p.v, write)
                  ...
                  assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.v, write) might be negative. (tree_delete_min.vpr@62.9--62.26) [107771]"}
                  ...
                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.v (tree_delete_min.vpr@62.9--62.26) [107772]"}
                ...
                // -- Transfer of acc(p.l, write)
                  ...
                  assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.l, write) might be negative. (tree_delete_min.vpr@62.9--62.26) [107773]"}
                    neededTransfer >= 0.000000000;
                  ...
                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@62.9--62.26) [107774]"}
                ...
                // -- Transfer of acc(Tree(p.l), write)
                  ...
                  // -- checking if access predicate defined in used state
                    if (b_1_1 && b_2_1) {
                      if (b_1_1) {
                        ...
                        // -- Check definedness of acc(Tree(p.l), write)
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@62.9--62.26) [107775]"}
                  ...
                  assert {:msg "  Folding Tree(p) might fail. Fraction acc(Tree(p.l), write) might be negative. (tree_delete_min.vpr@62.9--62.26) [107776]"}
                    neededTransfer >= 0.000000000;
                  ...
                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@62.9--62.26) [107777]"}
                ...
                // -- Transfer of acc(p.r, write)
                  ...
                  assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.r, write) might be negative. (tree_delete_min.vpr@62.9--62.26) [107778]"}
                    neededTransfer >= 0.000000000;
                  ...
                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.r (tree_delete_min.vpr@62.9--62.26) [107779]"}
                ...
                // -- Transfer of acc(Tree(p.r), write)
                    ...
                    if (b_1_1 && b_2_1) {
                      if (b_1_1) {
                        ...
                        // -- Check definedness of acc(Tree(p.r), write)
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.r (tree_delete_min.vpr@62.9--62.26) [107780]"}
                  ...
                  assert {:msg "  Folding Tree(p) might fail. Fraction acc(Tree(p.r), write) might be negative. (tree_delete_min.vpr@62.9--62.26) [107781]"}
                    neededTransfer >= 0.000000000;
                  ...
                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access Tree(p.r) (tree_delete_min.vpr@62.9--62.26) [107782]"}
        ...
        // -- Transfer of acc(Tree(x), write)
          ...
          assert {:msg "  Packaging wand might fail. Fraction acc(Tree(x), write) might be negative. (tree_delete_min.vpr@61.5--63.6) [107784]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@61.5--63.6) [107785]"}
          ...
          if (b_1_1) {
            ...
            // -- Check definedness of vals(x) == old(vals(x))[1..]
              if (*) {
                ...
                perm := FullPerm;
                assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@61.21--61.22) [107786]"}
              ...
              if (*) {
                ...
                ExhaleWellDef0Heap := oldHeap;
                perm := FullPerm;
                assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@61.21--61.22) [107787]"}
                  NoPerm < perm ==> NoPerm < oldMask[null, Tree(x)];
                // Finish exhale
                // Stop execution
                assume false;
        ...
        assert {:msg "  Packaging wand might fail. Assertion vals(x) == old(vals(x))[1..] might not hold. (tree_delete_min.vpr@61.5--63.6) [107788]"}
      ...
      // -- Translating statement: while ((unfolding acc(Tree(p.l), write) in p.l.l != null)) -- tree_delete_min.vpr@65.5--82.6
        ...
        // -- Before loop head
          ...
          // -- Exhale loop invariant before loop
            ExhaleWellDef0Mask := Mask;
            ExhaleWellDef0Heap := Heap;
            assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not hold on entry. Assertion p != null might not hold. (tree_delete_min.vpr@66.17--66.71) [107789]"}
              p_1 != null;
            perm := FullPerm;
            if (perm != NoPerm) {
              assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not hold on entry. There might be insufficient permission to access p.l (tree_delete_min.vpr@66.17--66.71) [107790]"}
                perm <= Mask[p_1, l];
            }
            Mask := Mask[p_1, l:=Mask[p_1, l] - perm];
            perm := FullPerm;
            if (perm != NoPerm) {
              assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not hold on entry. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@66.17--66.71) [107791]"}
                perm <= Mask[null, Tree(Heap[p_1, l])];
            }
            Mask := Mask[null, Tree(Heap[p_1, l]):=Mask[null, Tree(Heap[p_1, l])] - perm];
            assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not hold on entry. Assertion p.l != null might not hold. (tree_delete_min.vpr@66.17--66.71) [107792]"}
              Heap[p_1, l] != null;
            assert {:msg "  Loop invariant plvs == vals(p.l) might not hold on entry. Assertion plvs == vals(p.l) might not hold. (tree_delete_min.vpr@67.17--67.34) [107793]"}
              Seq#Equal(plvs, vals_1(Heap, Heap[p_1, l]));
            // permLe
            assert {:msg "  Loop invariant acc(p.l, write) && (acc(Tree(p.l), write) && vals(p.l) == plvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..] might not hold on entry. Magic wand instance not found. (tree_delete_min.vpr@68.17--68.24) [107794]"}
        ...
        // -- Check definedness of invariant
          if (*) {
            ...
            // -- Check definedness of acc(Tree(p.l), write)
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.l (tree_delete_min.vpr@66.17--66.71) [107795]"}
                HasDirectPerm(Mask, p_1, l);
            perm := FullPerm;
            Mask := Mask[null, Tree(Heap[p_1, l]):=Mask[null, Tree(Heap[p_1, l])] + perm];
            assume state(Heap, Mask);
            ...
            // -- Check definedness of p.l != null
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.l (tree_delete_min.vpr@66.17--66.71) [107796]"}
                HasDirectPerm(Mask, p_1, l);
            ...
            // -- Check definedness of plvs == vals(p.l)
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.l (tree_delete_min.vpr@67.17--67.34) [107797]"}
                HasDirectPerm(Mask, p_1, l);
              if (*) {
                // Exhale precondition of function application
                ExhaleWellDef0Mask := Mask;
                ExhaleWellDef0Heap := Heap;
                perm := FullPerm;
                assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@67.25--67.34) [107798]"}
                  NoPerm < perm ==> NoPerm < Mask[null, Tree(Heap[p_1, l])];
                // Finish exhale
                havoc ExhaleHeap;
                assume IdenticalOnKnownLocations(Heap, ExhaleHeap, Mask);
            ...
            // -- Check definedness of acc(p.l, write) && (acc(Tree(p.l), write) && vals(p.l) == plvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..]
              if (*) {
                ...
                // -- Check definedness of acc(Tree(p.l), write)
                  assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.l (tree_delete_min.vpr@68.17--68.24) [107799]"}
                ...
                // -- Check definedness of vals(p.l) == plvs[1..]
                  assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.l (tree_delete_min.vpr@68.17--68.24) [107800]"}
                    HasDirectPerm(WandDefLHSMask, p_1, l);
                  if (*) {
                    // Exhale precondition of function application
                    ...
                    perm := FullPerm;
                    assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@68.17--68.18) [107801]"}
                ...
                // -- Check definedness of vals(x) == old(vals(x))[1..]
                  if (*) {
                    ...
                    perm := FullPerm;
                    assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@68.23--68.24) [107802]"}
                  ...
                  if (*) {
                    ...
                    ExhaleWellDef0Heap := oldHeap;
                    perm := FullPerm;
                    assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@68.23--68.24) [107803]"}
                      NoPerm < perm ==> NoPerm < oldMask[null, Tree(x)];
                    // Finish exhale
                    // Stop execution
                    assume false;
        ...
        // -- Check the loop body
          if (*) {
            ...
            // -- Check definedness of (unfolding acc(Tree(p.l), write) in p.l.l != null)
              ...
              perm := FullPerm;
              if (perm != NoPerm) {
                assert {:msg "  While statement might fail. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@65.12--65.53) [107804]"}
              ...
              assume state(UnfoldingHeap, UnfoldingMask);
              assert {:msg "  While statement might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@65.12--65.53) [107805]"}
                HasDirectPerm(UnfoldingMask, p_1, l);
              assert {:msg "  While statement might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@65.12--65.53) [107806]"}
                HasDirectPerm(UnfoldingMask, p_1, l);
              assert {:msg "  While statement might fail. There might be insufficient permission to access p.l.l (tree_delete_min.vpr@65.12--65.53) [107807]"}
            ...
            // -- Translate loop body
              ...
              // -- Translating statement: oldP := p -- tree_delete_min.vpr@70.7--70.25
                oldP := p_1;
                assume state(Heap, Mask);
              
              // -- Translating statement: oldPlvs := plvs -- tree_delete_min.vpr@71.7--71.36
                oldPlvs := plvs;
                assume state(Heap, Mask);
              
              // -- Translating statement: unfold acc(Tree(p.l), write) -- tree_delete_min.vpr@73.7--73.28
                
                // -- Check definedness of acc(Tree(p.l), write)
                  assert {:msg "  Unfolding Tree(p.l) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@73.7--73.28) [107808]"}
                    HasDirectPerm(Mask, p_1, l);
                ...
                perm := FullPerm;
                if (perm != NoPerm) {
                  assert {:msg "  Unfolding Tree(p.l) might fail. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@73.7--73.28) [107809]"}
                    perm <= Mask[null, Tree(Heap[p_1, l])];
                }
                Mask := Mask[null, Tree(Heap[p_1, l]):=Mask[null, Tree(Heap[p_1, l])] - perm];
              ...
              // -- Translating statement: p := p.l -- tree_delete_min.vpr@74.7--74.15
                
                // -- Check definedness of p.l
                  assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@74.7--74.15) [107810]"}
                    HasDirectPerm(Mask, p_1, l);
                p_1 := Heap[p_1, l];
                assume state(Heap, Mask);
              
              // -- Translating statement: plvs := vals(p.l) -- tree_delete_min.vpr@75.7--75.24
                
                // -- Check definedness of vals(p.l)
                  assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@75.7--75.24) [107811]"}
                    HasDirectPerm(Mask, p_1, l);
                  if (*) {
                    // Exhale precondition of function application
                    ExhaleWellDef0Mask := Mask;
                    ExhaleWellDef0Heap := Heap;
                    perm := FullPerm;
                    assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@75.15--75.24) [107812]"}
                      NoPerm < perm ==> NoPerm < Mask[null, Tree(Heap[p_1, l])];
                    // Finish exhale
                    havoc ExhaleHeap;
                    assume IdenticalOnKnownLocations(Heap, ExhaleHeap, Mask);
                  ...
                  if (b_12) {
                    if (b_12) {
                      if (b_12) {
                        ...
                        // -- Check definedness of acc(Tree(p.l), write)
                          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@77.7--81.8) [107813]"}
                    ...
                    if (b_12) {
                      ...
                      if (b_12) {
                        ...
                        // -- Check definedness of vals(p.l) == plvs[1..]
                          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@77.7--81.8) [107814]"}
                            HasDirectPerm(Ops_3Mask, p_1, l);
                          if (*) {
                            // Exhale precondition of function application
                            ...
                            perm := FullPerm;
                            assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@77.16--77.17) [107815]"}
                    ...
                    if (b_12) {
                      if (p_1 == null) {
                        ...
                        // -- Transfer of acc(p.v, write)
                          ...
                          assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.v, write) might be negative. (tree_delete_min.vpr@78.11--78.23) [107816]"}
                            neededTransfer >= 0.000000000;
                          ...
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.v (tree_delete_min.vpr@78.11--78.23) [107817]"}
                        ...
                        // -- Transfer of acc(p.l, write)
                          ...
                          assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.l, write) might be negative. (tree_delete_min.vpr@78.11--78.23) [107818]"}
                            neededTransfer >= 0.000000000;
                          ...
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@78.11--78.23) [107819]"}
                        ...
                        // -- Transfer of acc(Tree(p.l), write)
                          ...
                          // -- checking if access predicate defined in used state
                            if (b_12 && b_13) {
                              if (b_12) {
                                ...
                                // -- Check definedness of acc(Tree(p.l), write)
                                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@78.11--78.23) [107820]"}
                          ...
                          assert {:msg "  Folding Tree(p) might fail. Fraction acc(Tree(p.l), write) might be negative. (tree_delete_min.vpr@78.11--78.23) [107821]"}
                            neededTransfer >= 0.000000000;
                          ...
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@78.11--78.23) [107822]"}
                        ...
                        // -- Transfer of acc(p.r, write)
                          ...
                          assert {:msg "  Folding Tree(p) might fail. Fraction acc(p.r, write) might be negative. (tree_delete_min.vpr@78.11--78.23) [107823]"}
                            neededTransfer >= 0.000000000;
                          ...
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.r (tree_delete_min.vpr@78.11--78.23) [107824]"}
                        ...
                        // -- Transfer of acc(Tree(p.r), write)
                          ...
                          // -- checking if access predicate defined in used state
                            if (b_12 && b_13) {
                              if (b_12) {
                                ...
                                // -- Check definedness of acc(Tree(p.r), write)
                                  assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access p.r (tree_delete_min.vpr@78.11--78.23) [107825]"}
                          ...
                          assert {:msg "  Folding Tree(p) might fail. Fraction acc(Tree(p.r), write) might be negative. (tree_delete_min.vpr@78.11--78.23) [107826]"}
                            neededTransfer >= 0.000000000;
                          ...
                          assert {:msg "  Folding Tree(p) might fail. There might be insufficient permission to access Tree(p.r) (tree_delete_min.vpr@78.11--78.23) [107827]"}
  ...
  //   acc(Tree(x), write) && vals(x) == old(vals(x))[1..] -- tree_delete_min.vpr@79.11--80.57
                    ...
                    // -- check if wand is held and remove an instance
                      ...
                      // -- Transfer of acc(oldP.l, write) && (acc(Tree(oldP.l), write) && vals(oldP.l) == oldPlvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..]
                              ...
                              // -- Check definedness of acc(oldP.l, write) && (acc(Tree(oldP.l), write) && vals(oldP.l) == oldPlvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..]
                                if (*) {
                                  ...
                                  // -- Check definedness of acc(Tree(oldP.l), write)
                                    assert {:msg "  Applying wand might fail. There might be insufficient permission to access oldP.l (tree_delete_min.vpr@79.11--80.57) [107828]"}
                                  ...
                                  // -- Check definedness of vals(oldP.l) == oldPlvs[1..]
                                    assert {:msg "  Applying wand might fail. There might be insufficient permission to access oldP.l (tree_delete_min.vpr@79.11--80.57) [107829]"}
                                      HasDirectPerm(WandDefLHSMask, oldP, l);
                                    if (*) {
                                      // Exhale precondition of function application
                                      ...
                                      perm := FullPerm;
                                      assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(oldP.l) (tree_delete_min.vpr@79.54--79.66) [107830]"}
                                  ...
                                  // -- Check definedness of vals(x) == old(vals(x))[1..]
                                    if (*) {
                                      ...
                                      perm := FullPerm;
                                      assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@80.28--80.35) [107831]"}
                                        NoPerm < perm ==> NoPerm < WandDefRHSMask[null, Tree(x)];
                                      // Finish exhale
                                      havoc ExhaleHeap;
                                      assume IdenticalOnKnownLocations(WandDefRHSHeap, ExhaleHeap, WandDefRHSMask);
                                    ...
                                    if (*) {
                                      ...
                                      perm := FullPerm;
                                      assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@80.43--80.50) [107832]"}
                                        NoPerm < perm ==> NoPerm < oldMask[null, Tree(x)];
                                      // Finish exhale
                                      // Stop execution
                                      assume false;
                        ...
                        assert {:msg "  Applying wand might fail. Fraction acc(oldP.l, write) && (acc(Tree(oldP.l), write) && vals(oldP.l) == oldPlvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..] might be negative. (tree_delete_min.vpr@79.11--80.57) [107833]"}
                          neededTransfer >= 0.000000000;
                        ...
                        assert {:msg "  Applying wand might fail. Magic wand instance not found. (tree_delete_min.vpr@79.11--80.57) [107834]"}
                    ...
                    // -- check if LHS holds and remove permissions 
                      ...
                      // -- Transfer of acc(oldP.l, write)
                        ...
                        assert {:msg "  Applying wand might fail. Fraction acc(oldP.l, write) might be negative. (tree_delete_min.vpr@79.11--80.57) [107835]"}
                          neededTransfer >= 0.000000000;
                        ...
                        assert {:msg "  Applying wand might fail. There might be insufficient permission to access oldP.l (tree_delete_min.vpr@79.11--80.57) [107836]"}
                      ...
                      // -- Transfer of acc(Tree(oldP.l), write)
                        ...
                        // -- checking if access predicate defined in used state
                          if (b_12 && b_22) {
                            if (b_12) {
                              ...
                              // -- Check definedness of acc(Tree(oldP.l), write)
                                assert {:msg "  Applying wand might fail. There might be insufficient permission to access oldP.l (tree_delete_min.vpr@79.11--80.57) [107837]"}
                        ...
                        assert {:msg "  Applying wand might fail. Fraction acc(Tree(oldP.l), write) might be negative. (tree_delete_min.vpr@79.11--80.57) [107838]"}
                          neededTransfer >= 0.000000000;
                        ...
                        assert {:msg "  Applying wand might fail. There might be insufficient permission to access Tree(oldP.l) (tree_delete_min.vpr@79.11--80.57) [107839]"}
                      ...
                      if (b_12 && b_22) {
                        if (b_12) {
                          ...
                          // -- Check definedness of vals(oldP.l) == oldPlvs[1..]
                            assert {:msg "  Applying wand might fail. There might be insufficient permission to access oldP.l (tree_delete_min.vpr@79.11--80.57) [107840]"}
                            ...
                            if (*) {
                              ...
                              perm := FullPerm;
                              assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(oldP.l) (tree_delete_min.vpr@79.54--79.66) [107841]"}
                      ...
                      assert {:msg "  Applying wand might fail. Assertion vals(oldP.l) == oldPlvs[1..] might not hold. (tree_delete_min.vpr@79.11--80.57) [107842]"}
                ...
                // -- Transfer of acc(Tree(x), write)
                  ...
                  assert {:msg "  Packaging wand might fail. Fraction acc(Tree(x), write) might be negative. (tree_delete_min.vpr@77.7--81.8) [107843]"}
                    neededTransfer >= 0.000000000;
                  ...
                  assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@77.7--81.8) [107844]"}
                  ...
                  if (b_12) {
                    ...
                    // -- Check definedness of vals(x) == old(vals(x))[1..]
                      if (*) {
                        ...
                        perm := FullPerm;
                        assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@77.23--77.24) [107845]"}
                      ...
                      if (*) {
                        ...
                        ExhaleWellDef0Heap := oldHeap;
                        perm := FullPerm;
                        assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(x) (tree_delete_min.vpr@77.23--77.24) [107846]"}
                          NoPerm < perm ==> NoPerm < oldMask[null, Tree(x)];
                        // Finish exhale
                        // Stop execution
                        assume false;
                ...
                assert {:msg "  Packaging wand might fail. Assertion vals(x) == old(vals(x))[1..] might not hold. (tree_delete_min.vpr@77.7--81.8) [107847]"}
            ...
            ExhaleWellDef0Mask := Mask;
            ExhaleWellDef0Heap := Heap;
            assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not be preserved. Assertion p != null might not hold. (tree_delete_min.vpr@66.17--66.71) [107848]"}
              p_1 != null;
            perm := FullPerm;
            if (perm != NoPerm) {
              assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not be preserved. There might be insufficient permission to access p.l (tree_delete_min.vpr@66.17--66.71) [107849]"}
                perm <= Mask[p_1, l];
            }
            Mask := Mask[p_1, l:=Mask[p_1, l] - perm];
            perm := FullPerm;
            if (perm != NoPerm) {
              assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not be preserved. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@66.17--66.71) [107850]"}
                perm <= Mask[null, Tree(Heap[p_1, l])];
            }
            Mask := Mask[null, Tree(Heap[p_1, l]):=Mask[null, Tree(Heap[p_1, l])] - perm];
            assert {:msg "  Loop invariant p != null && (acc(p.l, write) && (acc(Tree(p.l), write) && p.l != null)) might not be preserved. Assertion p.l != null might not hold. (tree_delete_min.vpr@66.17--66.71) [107851]"}
              Heap[p_1, l] != null;
            assert {:msg "  Loop invariant plvs == vals(p.l) might not be preserved. Assertion plvs == vals(p.l) might not hold. (tree_delete_min.vpr@67.17--67.34) [107852]"}
              Seq#Equal(plvs, vals_1(Heap, Heap[p_1, l]));
            // permLe
            assert {:msg "  Loop invariant acc(p.l, write) && (acc(Tree(p.l), write) && vals(p.l) == plvs[1..]) --* acc(Tree(x), write) && vals(x) == old(vals(x))[1..] might not be preserved. Magic wand instance not found. (tree_delete_min.vpr@68.17--68.24) [107853]"}
              FullPerm <= Mask[null, wand(p_1, FullPerm, p_1, p_1, Seq#Drop(plvs, 1), x, x, Seq#Drop(vals_1(oldHeap, x), 1))];
            Mask := Mask[null, wand(p_1, FullPerm, p_1, p_1, Seq#Drop(plvs, 1), x, x, Seq#Drop(vals_1(oldHeap, x), 1)):=Mask[null, wand(p_1, FullPerm, p_1, p_1, Seq#Drop(plvs, 1), x, x, Seq#Drop(vals_1(oldHeap, x), 1))] - FullPerm];
            // Finish exhale
            havoc ExhaleHeap;
      ...
      // -- Translating statement: unfold acc(Tree(p.l), write) -- tree_delete_min.vpr@84.5--84.26
        
        // -- Check definedness of acc(Tree(p.l), write)
          assert {:msg "  Unfolding Tree(p.l) might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@84.5--84.26) [107854]"}
            HasDirectPerm(Mask, p_1, l);
        assume Tree#trigger(Heap, Tree(Heap[p_1, l]));
        assume Heap[null, Tree(Heap[p_1, l])] == FrameFragment((if Heap[p_1, l] == null then EmptyFrame else CombineFrames(FrameFragment(Heap[Heap[p_1, l], v_35]), CombineFrames(FrameFragment(Heap[Heap[p_1, l], l]), CombineFrames(Heap[null, Tree(Heap[Heap[p_1, l], l])], CombineFrames(FrameFragment(Heap[Heap[p_1, l], r_11]), Heap[null, Tree(Heap[Heap[p_1, l], r_11])]))))));
        ExhaleWellDef0Mask := Mask;
        ...
        perm := FullPerm;
        if (perm != NoPerm) {
          assert {:msg "  Unfolding Tree(p.l) might fail. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@84.5--84.26) [107857]"}
            perm <= Mask[null, Tree(Heap[p_1, l])];
        }
        Mask := Mask[null, Tree(Heap[p_1, l]):=Mask[null, Tree(Heap[p_1, l])] - perm];
      ...
      // -- Translating statement: assert vals(p.l.l) == Seq[Int]() -- tree_delete_min.vpr@85.5--85.37
        ...
        // -- Check definedness of vals(p.l.l) == Seq[Int]()
          assert {:msg "  Assert might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@85.12--85.37) [107863]"}
            HasDirectPerm(ExhaleWellDef0Mask, p_1, l);
          assert {:msg "  Assert might fail. There might be insufficient permission to access p.l.l (tree_delete_min.vpr@85.12--85.37) [107864]"}
          ...
          if (*) {
            ...
            ExhaleWellDef1Heap := ExhaleWellDef0Heap;
            perm := FullPerm;
            assert {:msg "  Precondition of function vals might not hold. There might be insufficient permission to access Tree(p.l.l) (tree_delete_min.vpr@85.12--85.23) [107865]"}
        ...
        assert {:msg "  Assert might fail. Assertion vals(p.l.l) == Seq[Int]() might not hold. (tree_delete_min.vpr@85.12--85.37) [107866]"}
          Seq#Equal(vals_1(Heap, Heap[Heap[p_1, l], l]), (Seq#Empty(): Seq int));
        assume state(Heap, Mask);
      
      // -- Translating statement: p.l := p.l.r -- tree_delete_min.vpr@87.5--87.17
        
        // -- Check definedness of p.l.r
          assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@87.5--87.17) [107867]"}
            HasDirectPerm(Mask, p_1, l);
          assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l.r (tree_delete_min.vpr@87.5--87.17) [107868]"}
            HasDirectPerm(Mask, Heap[p_1, l], r_11);
        assert {:msg "  Assignment might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@87.5--87.17) [107869]"}
          FullPerm == Mask[p_1, l];
  ...
  //   acc(Tree(x), write) && vals(x) == old(vals(x))[1..] -- tree_delete_min.vpr@89.5--89.18
        ...
        // -- check if wand is held and remove an instance
          ...
          ExhaleWellDef0Heap := Heap;
          // permLe
          assert {:msg "  Applying wand might fail. Magic wand instance not found. (tree_delete_min.vpr@89.5--89.18) [107870]"}
            FullPerm <= Mask[null, wand(p_1, FullPerm, p_1, p_1, Seq#Drop(plvs, 1), x, x, Seq#Drop(vals_1(oldHeap, x), 1))];
          Mask := Mask[null, wand(p_1, FullPerm, p_1, p_1, Seq#Drop(plvs, 1), x, x, Seq#Drop(vals_1(oldHeap, x), 1)):=Mask[null, wand(p_1, FullPerm, p_1, p_1, Seq#Drop(plvs, 1), x, x, Seq#Drop(vals_1(oldHeap, x), 1))] - FullPerm];
        assume state(Heap, Mask);
        ...
        // -- check if LHS holds and remove permissions 
          ...
          perm := FullPerm;
          if (perm != NoPerm) {
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.l (tree_delete_min.vpr@89.5--89.18) [107872]"}
              perm <= Mask[p_1, l];
          }
          Mask := Mask[p_1, l:=Mask[p_1, l] - perm];
          perm := FullPerm;
          if (perm != NoPerm) {
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access Tree(p.l) (tree_delete_min.vpr@89.5--89.18) [107874]"}
              perm <= Mask[null, Tree(Heap[p_1, l])];
          }
          Mask := Mask[null, Tree(Heap[p_1, l]):=Mask[null, Tree(Heap[p_1, l])] - perm];
          assert {:msg "  Applying wand might fail. Assertion vals(p.l) == plvs[1..] might not hold. (tree_delete_min.vpr@89.5--89.18) [107875]"}
      ...
      // -- Translating statement: z := x -- tree_delete_min.vpr@91.5--91.11
        z := x;
        assume state(Heap, Mask);
    }
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of tree_delete_min might not hold. There might be insufficient permission to access Tree(z) (tree_delete_min.vpr@44.11--44.23) [107877]"}
        perm <= Mask[null, Tree(z)];
    }
    Mask := Mask[null, Tree(z):=Mask[null, Tree(z)] - perm];
    assert {:msg "  Postcondition of tree_delete_min might not hold. Assertion vals(z) == old(vals(x))[1..] might not hold. (tree_delete_min.vpr@45.11--45.39) [107878]"}
