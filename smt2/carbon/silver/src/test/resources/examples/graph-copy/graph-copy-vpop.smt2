...
(declare-fun s1_2 () (Array Int Bool))
...
(let ((anon0_correct  (=> (and (and (state Heap@@19 ZeroMask) AssumePermUpperBound) (and (< 0 (|Set#Card_6709| s1_2)) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
