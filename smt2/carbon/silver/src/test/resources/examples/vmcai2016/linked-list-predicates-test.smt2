...
(let ((anon32_Else_correct  (=> (and (not (HasDirectPerm_40731_2989 ZeroMask r_33 held)) (= (ControlFlow 0 46) 43)) anon6_correct)))
(let ((anon32_Then_correct  (=> (HasDirectPerm_40731_2989 ZeroMask r_33 held) (and (=> (= (ControlFlow 0 44) (- 0 45)) (HasDirectPerm_40731_2989 ZeroMask r_33 held)) (=> (HasDirectPerm_40731_2989 ZeroMask r_33 held) (=> (= (ControlFlow 0 44) 43) anon6_correct))))))
...
(let ((anon34_Then_correct  (=> (<= 2 (length Heap@@74 lock)) (and (=> (= (ControlFlow 0 39) 36) anon35_Then_correct) (=> (= (ControlFlow 0 39) 38) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (and (and (< (length Heap@@74 lock) 2) (= Mask@5 Mask@2)) (and (= Heap@1 Heap@@74) (= (ControlFlow 0 27) 26))) anon16_correct)))
