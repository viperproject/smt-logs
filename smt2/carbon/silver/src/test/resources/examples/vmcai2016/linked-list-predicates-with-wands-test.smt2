...
(let ((anon32_Else_correct  (=> (and (not (HasDirectPerm_51392_3835 ZeroMask r_34 held)) (= (ControlFlow 0 46) 43)) anon6_correct)))
(let ((anon32_Then_correct  (=> (HasDirectPerm_51392_3835 ZeroMask r_34 held) (and (=> (= (ControlFlow 0 44) (- 0 45)) (HasDirectPerm_51392_3835 ZeroMask r_34 held)) (=> (HasDirectPerm_51392_3835 ZeroMask r_34 held) (=> (= (ControlFlow 0 44) 43) anon6_correct))))))
...
(let ((anon34_Then_correct  (=> (<= 2 (length Heap@@88 lock)) (and (=> (= (ControlFlow 0 39) 36) anon35_Then_correct) (=> (= (ControlFlow 0 39) 38) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (and (and (< (length Heap@@88 lock) 2) (= Mask@5 Mask@2)) (and (= Heap@1 Heap@@88) (= (ControlFlow 0 27) 26))) anon16_correct)))
