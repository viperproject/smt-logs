...
(declare-fun xs@@3 () T@listDomainType)
(declare-fun y_5_2@0 () Int)
(declare-fun ys_13@0 () T@listDomainType)
(declare-fun z_1@0 () Int)
(declare-fun ys_12@0 () T@listDomainType)
(declare-fun z@0 () Int)
(declare-fun y_4_1@0 () Int)
(declare-fun ys_10@0 () T@listDomainType)
(declare-fun ys_9@0 () T@listDomainType)
(declare-fun ys_7@0 () T@listDomainType)
(declare-fun y_3_2@0 () Int)
(declare-fun ys_8@0 () T@listDomainType)
(declare-fun Heap@@15 () T@PolymorphicMapType_3983)
(declare-fun y_1@0 () Int)
(declare-fun ys_4@0 () T@listDomainType)
(declare-fun y@0 () Int)
(declare-fun ys_3@0 () T@listDomainType)
(declare-fun ys_1@0 () T@listDomainType)
...
(let ((anon30_Then_correct  (=> (and (and (not (is_Nil xs@@3)) (and (not (and (is_Cons xs@@3) (is_Nil (tail_Cons xs@@3)))) (not (and (is_Cons xs@@3) (and (is_Cons (tail_Cons xs@@3)) (< (head_Cons xs@@3) (head_Cons (tail_Cons xs@@3)))))))) (= (ControlFlow 0 4) (- 0 3))) false)))
(let ((anon16_correct  (=> (= y_5_2@0 (head_Cons xs@@3)) (=> (and (= ys_13@0 (tail_Cons xs@@3)) (= z_1@0 (head_Cons ys_13@0))) (and (=> (= (ControlFlow 0 8) 4) anon30_Then_correct) (=> (= (ControlFlow 0 8) 5) anon30_Else_correct))))))
...
(let ((anon28_Then_correct  (=> (is_Cons xs@@3) (=> (and (= y_4_1@0 (head_Cons xs@@3)) (= ys_12@0 (tail_Cons xs@@3))) (and (=> (= (ControlFlow 0 12) 10) anon29_Then_correct) (=> (= (ControlFlow 0 12) 11) anon29_Else_correct))))))
(let ((anon28_Else_correct  (=> (and (not (is_Cons xs@@3)) (= (ControlFlow 0 9) 8)) anon16_correct)))
(let ((anon27_Then_correct  (=> (not (and (is_Cons xs@@3) (is_Nil (tail_Cons xs@@3)))) (and (=> (= (ControlFlow 0 13) 12) anon28_Then_correct) (=> (= (ControlFlow 0 13) 9) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (is_Cons xs@@3) (is_Nil (tail_Cons xs@@3))) (and (=> (= (ControlFlow 0 7) 4) anon30_Then_correct) (=> (= (ControlFlow 0 7) 5) anon30_Else_correct)))))
(let ((anon12_correct  (=> (= ys_10@0 (tail_Cons xs@@3)) (and (=> (= (ControlFlow 0 14) 13) anon27_Then_correct) (=> (= (ControlFlow 0 14) 7) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (not (is_Cons xs@@3)) (= (ControlFlow 0 16) 14)) anon12_correct)))
(let ((anon26_Then_correct  (=> (is_Cons xs@@3) (=> (and (= ys_9@0 (tail_Cons xs@@3)) (= (ControlFlow 0 15) 14)) anon12_correct))))
(let ((anon25_Then_correct  (=> (not (is_Nil xs@@3)) (and (=> (= (ControlFlow 0 17) 15) anon26_Then_correct) (=> (= (ControlFlow 0 17) 16) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (is_Nil xs@@3) (and (=> (= (ControlFlow 0 6) 4) anon30_Then_correct) (=> (= (ControlFlow 0 6) 5) anon30_Else_correct)))))
(let ((anon24_Else_correct  (=> (not (and (not (is_Nil xs@@3)) (and (not (and (is_Cons xs@@3) (is_Nil (tail_Cons xs@@3)))) (not (and (is_Cons xs@@3) (is_Cons (tail_Cons xs@@3))))))) (=> (and (and (= ys_7@0 (tail_Cons xs@@3)) (= y_3_2@0 (head_Cons xs@@3))) (and (= ys_8@0 (tail_Cons xs@@3)) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 18) 17) anon25_Then_correct) (=> (= (ControlFlow 0 18) 6) anon25_Else_correct))))))
(let ((anon24_Then_correct  (=> (and (and (not (is_Nil xs@@3)) (and (not (and (is_Cons xs@@3) (is_Nil (tail_Cons xs@@3)))) (not (and (is_Cons xs@@3) (is_Cons (tail_Cons xs@@3)))))) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon6_correct  (=> (and (= y_1@0 (head_Cons xs@@3)) (= ys_4@0 (tail_Cons xs@@3))) (and (=> (= (ControlFlow 0 21) 2) anon24_Then_correct) (=> (= (ControlFlow 0 21) 18) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (not (is_Cons xs@@3)) (= (ControlFlow 0 23) 21)) anon6_correct)))
(let ((anon23_Then_correct  (=> (and (and (is_Cons xs@@3) (= y@0 (head_Cons xs@@3))) (and (= ys_3@0 (tail_Cons xs@@3)) (= (ControlFlow 0 22) 21))) anon6_correct)))
(let ((anon22_Then_correct  (=> (not (and (is_Cons xs@@3) (is_Nil (tail_Cons xs@@3)))) (and (=> (= (ControlFlow 0 24) 22) anon23_Then_correct) (=> (= (ControlFlow 0 24) 23) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (is_Cons xs@@3) (is_Nil (tail_Cons xs@@3))) (and (=> (= (ControlFlow 0 20) 2) anon24_Then_correct) (=> (= (ControlFlow 0 20) 18) anon24_Else_correct)))))
(let ((anon3_correct  (=> (= ys_1@0 (tail_Cons xs@@3)) (and (=> (= (ControlFlow 0 25) 24) anon22_Then_correct) (=> (= (ControlFlow 0 25) 20) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (not (is_Cons xs@@3)) (= (ControlFlow 0 27) 25)) anon3_correct)))
(let ((anon21_Then_correct  (=> (is_Cons xs@@3) (=> (and (= ys@0 (tail_Cons xs@@3)) (= (ControlFlow 0 26) 25)) anon3_correct))))
(let ((anon20_Then_correct  (=> (not (is_Nil xs@@3)) (and (=> (= (ControlFlow 0 28) 26) anon21_Then_correct) (=> (= (ControlFlow 0 28) 27) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (is_Nil xs@@3) (and (=> (= (ControlFlow 0 19) 2) anon24_Then_correct) (=> (= (ControlFlow 0 19) 18) anon24_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 29) 28) anon20_Then_correct) (=> (= (ControlFlow 0 29) 19) anon20_Else_correct)))))
