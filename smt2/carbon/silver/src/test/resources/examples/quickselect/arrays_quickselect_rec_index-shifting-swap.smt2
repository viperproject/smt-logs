...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon5_correct  (=> (state PostHeap@0 PostMask@2) (and (=> (= (ControlFlow 0 20) (- 0 23)) (HasDirectPerm_20221_3612 PostMask@2 (loc a_2@@1 i@@11) val)) (=> (HasDirectPerm_20221_3612 PostMask@2 (loc a_2@@1 i@@11) val) (and (=> (= (ControlFlow 0 20) (- 0 22)) (HasDirectPerm_20221_3612 Mask@2 (loc a_2@@1 j@@5) val)) (=> (HasDirectPerm_20221_3612 Mask@2 (loc a_2@@1 j@@5) val) (=> (and (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| PostHeap@0) (loc a_2@@1 i@@11) val) (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 j@@5) val)) (state PostHeap@0 PostMask@2)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm_20221_3612 PostMask@2 (loc a_2@@1 j@@5) val)) (=> (HasDirectPerm_20221_3612 PostMask@2 (loc a_2@@1 j@@5) val) (=> (= (ControlFlow 0 20) (- 0 19)) (HasDirectPerm_20221_3612 Mask@2 (loc a_2@@1 i@@11) val))))))))))))
(let ((anon15_Else_correct  (=> (= i@@11 j@@5) (=> (and (= PostMask@2 PostMask@0) (= (ControlFlow 0 25) 20)) anon5_correct))))
(let ((anon15_Then_correct  (=> (and (not (= i@@11 j@@5)) (not (= (loc a_2@@1 j@@5) null))) (=> (and (and (= PostMask@1 (PolymorphicMapType_29378 (store (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| PostMask@0) (loc a_2@@1 j@@5) val (+ (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| PostMask@0) (loc a_2@@1 j@@5) val) FullPerm)) (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| PostMask@0) (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| PostMask@0) (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| PostMask@0) (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| PostMask@0))) (state PostHeap@0 PostMask@1)) (and (= PostMask@2 PostMask@1) (= (ControlFlow 0 24) 20))) anon5_correct))))
...
(let ((anon13_Else_correct  (=> (= i@@11 j@@5) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 29) 27)) anon2_correct))))
(let ((anon13_Then_correct  (=> (and (not (= i@@11 j@@5)) (not (= (loc a_2@@1 j@@5) null))) (=> (and (and (= Mask@1 (PolymorphicMapType_29378 (store (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| Mask@0) (loc a_2@@1 j@@5) val (+ (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| Mask@0) (loc a_2@@1 j@@5) val) FullPerm)) (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| Mask@0) (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| Mask@0) (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| Mask@0) (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| Mask@0))) (state Heap@@21 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 28) 27))) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (<= 0 i@@11) (< i@@11 (len a_2@@1)))) (=> (and (and (and (state Heap@@21 ZeroMask) (<= 0 j@@5)) (and (< j@@5 (len a_2@@1)) (state Heap@@21 ZeroMask))) (and (and (not (= (loc a_2@@1 i@@11) null)) (= Mask@0 (PolymorphicMapType_29378 (store (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| ZeroMask) (loc a_2@@1 i@@11) val (+ (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| ZeroMask) (loc a_2@@1 i@@11) val) FullPerm)) (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| ZeroMask) (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| ZeroMask) (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| ZeroMask) (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| ZeroMask)))) (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0)))) (and (=> (= (ControlFlow 0 30) 28) anon13_Then_correct) (=> (= (ControlFlow 0 30) 29) anon13_Else_correct)))))))
