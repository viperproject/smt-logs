...
(let ((anon90_Else_correct  (=> (and (not (and (<= left_1 i_32) (<= i_32 right))) (= (ControlFlow 0 147) 141)) anon25_correct)))
(let ((anon90_Then_correct  (=> (and (<= left_1 i_32) (<= i_32 right)) (and (=> (= (ControlFlow 0 142) (- 0 146)) (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_32) val)) (=> (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_32) val) (and (=> (= (ControlFlow 0 142) (- 0 145)) (>= i_32 0)) (=> (>= i_32 0) (and (=> (= (ControlFlow 0 142) (- 0 144)) (< i_32 (|Seq#Length_3395| pw))) (=> (< i_32 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 142) (- 0 143)) (HasDirectPerm_19693_3612 QPMask@0 (loc a_2@@1 (|Seq#Index_3395| pw i_32)) val)) (=> (HasDirectPerm_19693_3612 QPMask@0 (loc a_2@@1 (|Seq#Index_3395| pw i_32)) val) (=> (= (ControlFlow 0 142) 141) anon25_correct))))))))))))
(let ((anon89_Else_correct true))
(let ((anon87_Else_correct  (=> (and (forall ((i_11_1 Int) (j_1 Int) ) (!  (=> (and (<= left_1 i_11_1) (and (< i_11_1 j_1) (<= j_1 right))) (not (= (|Seq#Index_3395| pw i_11_1) (|Seq#Index_3395| pw j_1))))
...
(let ((anon88_Else_correct  (=> (and (not (and (<= left_1 i_31) (and (< i_31 j_19) (<= j_19 right)))) (= (ControlFlow 0 139) 133)) anon21_correct)))
(let ((anon88_Then_correct  (=> (and (<= left_1 i_31) (and (< i_31 j_19) (<= j_19 right))) (and (=> (= (ControlFlow 0 134) (- 0 138)) (>= i_31 0)) (=> (>= i_31 0) (and (=> (= (ControlFlow 0 134) (- 0 137)) (< i_31 (|Seq#Length_3395| pw))) (=> (< i_31 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 134) (- 0 136)) (>= j_19 0)) (=> (>= j_19 0) (and (=> (= (ControlFlow 0 134) (- 0 135)) (< j_19 (|Seq#Length_3395| pw))) (=> (< j_19 (|Seq#Length_3395| pw)) (=> (= (ControlFlow 0 134) 133) anon21_correct))))))))))))
(let ((anon84_Else_correct  (=> (and (forall ((i_9_1 Int) ) (!  (=> (and (<= left_1 i_9_1) (<= i_9_1 right)) (and (<= left_1 (|Seq#Index_3395| pw i_9_1)) (<= (|Seq#Index_3395| pw i_9_1) right)))
...
(let ((anon85_Then_correct  (=> (and (<= left_1 i_30) (<= i_30 right)) (and (=> (= (ControlFlow 0 130) (- 0 132)) (>= i_30 0)) (=> (>= i_30 0) (and (=> (= (ControlFlow 0 130) (- 0 131)) (< i_30 (|Seq#Length_3395| pw))) (=> (< i_30 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 130) 126) anon86_Then_correct) (=> (= (ControlFlow 0 130) 129) anon86_Else_correct)))))))))
(let ((anon85_Else_correct  (=> (and (not (and (<= left_1 i_30) (<= i_30 right))) (= (ControlFlow 0 125) 124)) anon17_correct)))
(let ((anon82_Else_correct  (=> (and (and (forall ((i_7_1 Int) ) (!  (=> (and (< storeIndex i_7_1) (<= i_7_1 right)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| PostHeap@0) (loc a_2@@1 storeIndex) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| PostHeap@0) (loc a_2@@1 i_7_1) val)))
 :qid |stdinbpl.2171:20|
 :skolemid |160|
 :pattern ( (loc a_2@@1 i_7_1))
)) (state PostHeap@0 QPMask@8)) (and (= (|Seq#Length_3395| pw) (+ right 1)) (state PostHeap@0 QPMask@8))) (and (and (=> (= (ControlFlow 0 150) 149) anon84_Else_correct) (=> (= (ControlFlow 0 150) 130) anon85_Then_correct)) (=> (= (ControlFlow 0 150) 125) anon85_Else_correct)))))
...
(let ((anon83_Then_correct  (=> (and (< storeIndex i_29) (<= i_29 right)) (and (=> (= (ControlFlow 0 120) (- 0 122)) (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 storeIndex) val)) (=> (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 storeIndex) val) (and (=> (= (ControlFlow 0 120) (- 0 121)) (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_29) val)) (=> (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_29) val) (=> (= (ControlFlow 0 120) 119) anon12_correct))))))))
(let ((anon80_Else_correct  (=> (and (forall ((i_5 Int) ) (!  (=> (and (<= left_1 i_5) (< i_5 storeIndex)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| PostHeap@0) (loc a_2@@1 i_5) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| PostHeap@0) (loc a_2@@1 storeIndex) val)))
...
(let ((anon81_Then_correct  (=> (and (<= left_1 i_24) (< i_24 storeIndex)) (and (=> (= (ControlFlow 0 115) (- 0 117)) (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_24) val)) (=> (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_24) val) (and (=> (= (ControlFlow 0 115) (- 0 116)) (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 storeIndex) val)) (=> (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 storeIndex) val) (=> (= (ControlFlow 0 115) 114) anon8_correct))))))))
(let ((anon79_Else_correct  (and (=> (= (ControlFlow 0 152) (- 0 153)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= left_1 i_3) (<= i_3 right))) (and (<= left_1 i_3_1) (<= i_3_1 right))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_3) (loc a_2@@1 i_3_1))))
 ...
 :pattern ( (loc a_2@@1 i_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= left_1 (invRecv10 o_4@@0)) (<= (invRecv10 o_4@@0) right)) (< NoPerm FullPerm)) (qpRange10 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv10 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@8) o_4@@0 val) (+ (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (<= left_1 (invRecv10 o_4@@0)) (<= (invRecv10 o_4@@0) right)) (< NoPerm FullPerm)) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@8) o_4@@0 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.2131:22|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@8) o_4@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@8) o_4@@1 f_5)))
 :qid |stdinbpl.2135:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@8) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@8) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2135:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@8) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_34782_3612) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@8) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2135:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@8) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@8) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2135:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@8) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@8) o_4@@5 f_5@@3)))
 :qid |stdinbpl.2135:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@8) o_4@@5 f_5@@3))
...
(let ((anon98_Else_correct  (=> (and (not (and (<= pivotIndex@0 i_34) (<= i_34 right))) (= (ControlFlow 0 88) 82)) anon41_correct)))
(let ((anon98_Then_correct  (=> (and (<= pivotIndex@0 i_34) (<= i_34 right)) (and (=> (= (ControlFlow 0 83) (- 0 87)) (>= i_34 0)) (=> (>= i_34 0) (and (=> (= (ControlFlow 0 83) (- 0 86)) (< i_34 (|Seq#Length_3395| pw))) (=> (< i_34 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 83) (- 0 85)) (>= i_34 0)) (=> (>= i_34 0) (and (=> (= (ControlFlow 0 83) (- 0 84)) (< i_34 (|Seq#Length_3395| pwPar@0))) (=> (< i_34 (|Seq#Length_3395| pwPar@0)) (=> (= (ControlFlow 0 83) 82) anon41_correct))))))))))))
(let ((anon37_correct true))
(let ((anon96_Else_correct  (=> (and (not (and (<= left_1 i_33) (<= i_33 (- pivotIndex@0 1)))) (= (ControlFlow 0 80) 72)) anon37_correct)))
(let ((anon96_Then_correct  (=> (and (<= left_1 i_33) (<= i_33 (- pivotIndex@0 1))) (and (=> (= (ControlFlow 0 73) (- 0 79)) (>= i_33 0)) (=> (>= i_33 0) (and (=> (= (ControlFlow 0 73) (- 0 78)) (< i_33 (|Seq#Length_3395| pw))) (=> (< i_33 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 73) (- 0 77)) (>= i_33 0)) (=> (>= i_33 0) (and (=> (= (ControlFlow 0 73) (- 0 76)) (< i_33 (|Seq#Length_3395| pwRec@0))) (=> (< i_33 (|Seq#Length_3395| pwRec@0)) (and (=> (= (ControlFlow 0 73) (- 0 75)) (>= (|Seq#Index_3395| pwRec@0 i_33) 0)) (=> (>= (|Seq#Index_3395| pwRec@0 i_33) 0) (and (=> (= (ControlFlow 0 73) (- 0 74)) (< (|Seq#Index_3395| pwRec@0 i_33) (|Seq#Length_3395| pwPar@0))) (=> (< (|Seq#Index_3395| pwRec@0 i_33) (|Seq#Length_3395| pwPar@0)) (=> (= (ControlFlow 0 73) 72) anon37_correct))))))))))))))))
(let ((anon94_Then_correct true))
(let ((anon75_correct true))
(let ((anon113_Else_correct  (=> (and (not (and (<= left_1 i_23) (<= i_23 right))) (= (ControlFlow 0 40) 37)) anon75_correct)))
(let ((anon113_Then_correct  (=> (and (<= left_1 i_23) (<= i_23 right)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_23) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@@21) (loc a_2@@1 (|Seq#Index_3395| pw@2 i_23)) val))) (=> (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_23) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@@21) (loc a_2@@1 (|Seq#Index_3395| pw@2 i_23)) val)) (=> (= (ControlFlow 0 38) 37) anon75_correct))))))
(let ((anon112_Else_correct true))
(let ((anon110_Else_correct  (=> (forall ((i_22_1_1 Int) (j_3_1_1 Int) ) (!  (=> (and (<= left_1 i_22_1_1) (and (< i_22_1_1 j_3_1_1) (<= j_3_1_1 right))) (not (= (|Seq#Index_3395| pw@2 i_22_1_1) (|Seq#Index_3395| pw@2 j_3_1_1))))
...
(let ((anon111_Else_correct  (=> (and (not (and (<= left_1 i_21) (and (< i_21 j_2_1) (<= j_2_1 right)))) (= (ControlFlow 0 35) 32)) anon71_correct)))
(let ((anon111_Then_correct  (=> (and (<= left_1 i_21) (and (< i_21 j_2_1) (<= j_2_1 right))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (not (= (|Seq#Index_3395| pw@2 i_21) (|Seq#Index_3395| pw@2 j_2_1)))) (=> (not (= (|Seq#Index_3395| pw@2 i_21) (|Seq#Index_3395| pw@2 j_2_1))) (=> (= (ControlFlow 0 33) 32) anon71_correct))))))
(let ((anon108_Else_correct  (=> (forall ((i_20_1_1 Int) ) (!  (=> (and (<= left_1 i_20_1_1) (<= i_20_1_1 right)) (and (<= left_1 (|Seq#Index_3395| pw@2 i_20_1_1)) (<= (|Seq#Index_3395| pw@2 i_20_1_1) right)))
...
(let ((anon109_Else_correct  (=> (and (not (and (<= left_1 i_19) (<= i_19 right))) (= (ControlFlow 0 31) 27)) anon67_correct)))
(let ((anon109_Then_correct  (=> (and (<= left_1 i_19) (<= i_19 right)) (and (=> (= (ControlFlow 0 28) (- 0 30)) (<= left_1 (|Seq#Index_3395| pw@2 i_19))) (=> (<= left_1 (|Seq#Index_3395| pw@2 i_19)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (<= (|Seq#Index_3395| pw@2 i_19) right)) (=> (<= (|Seq#Index_3395| pw@2 i_19) right) (=> (= (ControlFlow 0 28) 27) anon67_correct))))))))
(let ((anon106_Else_correct  (=> (forall ((i_18_1_1 Int) ) (!  (=> (and (< storeIndex@4 i_18_1_1) (<= i_18_1_1 right)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 storeIndex@4) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_18_1_1) val)))
 :qid |stdinbpl.2895:20|
 :skolemid |226|
 :pattern ( (loc a_2@@1 i_18_1_1))
)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (= (|Seq#Length_3395| pw@2) (+ right 1))) (=> (= (|Seq#Length_3395| pw@2) (+ right 1)) (and (and (=> (= (ControlFlow 0 43) 42) anon108_Else_correct) (=> (= (ControlFlow 0 43) 28) anon109_Then_correct)) (=> (= (ControlFlow 0 43) 31) anon109_Else_correct)))))))
...
(let ((anon107_Then_correct  (=> (and (< storeIndex@4 i_17) (<= i_17 right)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 storeIndex@4) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_17) val))) (=> (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 storeIndex@4) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_17) val)) (=> (= (ControlFlow 0 24) 23) anon63_correct))))))
(let ((anon104_Else_correct  (=> (forall ((i_16_1_1 Int) ) (!  (=> (and (<= left_1 i_16_1_1) (< i_16_1_1 storeIndex@4)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_16_1_1) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 storeIndex@4) val)))
...
)) (and (=> (= (ControlFlow 0 46) (- 0 48)) (forall ((i_14_1@@1 Int) ) (!  (=> (and (<= left_1 i_14_1@@1) (<= i_14_1@@1 right)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| Mask@2) (loc a_2@@1 i_14_1@@1) val) FullPerm))
 :qid |stdinbpl.2848:17|
 :skolemid |220|
 :pattern ( (loc a_2@@1 i_14_1@@1))
 :pattern ( (loc a_2@@1 i_14_1@@1))
))) (=> (forall ((i_14_1@@2 Int) ) (!  (=> (and (<= left_1 i_14_1@@2) (<= i_14_1@@2 right)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| Mask@2) (loc a_2@@1 i_14_1@@2) val) FullPerm))
 :qid |stdinbpl.2848:17|
 :skolemid |220|
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (<= left_1 (invRecv11 o_4@@7)) (<= (invRecv11 o_4@@7) right)) (and (< NoPerm FullPerm) (qpRange11 o_4@@7))) (and (= (loc a_2@@1 (invRecv11 o_4@@7)) o_4@@7) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@7) o_4@@7 val) (- (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| Mask@2) o_4@@7 val) FullPerm)))) (=> (not (and (and (<= left_1 (invRecv11 o_4@@7)) (<= (invRecv11 o_4@@7) right)) (and (< NoPerm FullPerm) (qpRange11 o_4@@7)))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@7) o_4@@7 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| Mask@2) o_4@@7 val))))
 :qid |stdinbpl.2864:22|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@7) o_4@@7 val))
))) (=> (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| Mask@2) o_4@@8 f_5@@4) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@7) o_4@@8 f_5@@4)))
 :qid |stdinbpl.2870:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@7) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| Mask@2) o_4@@9 f_5@@5) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@7) o_4@@9 f_5@@5)))
 :qid |stdinbpl.2870:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@7) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_34782_3612) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| Mask@2) o_4@@10 f_5@@6) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@7) o_4@@10 f_5@@6)))
 :qid |stdinbpl.2870:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@7) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| Mask@2) o_4@@11 f_5@@7) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@7) o_4@@11 f_5@@7)))
 :qid |stdinbpl.2870:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@7) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| Mask@2) o_4@@12 f_5@@8) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@7) o_4@@12 f_5@@8)))
 :qid |stdinbpl.2870:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@7) o_4@@12 f_5@@8))
...
(let ((anon97_Else_correct  (=> (forall ((i_42 Int) ) (!  (=> (and (<= pivotIndex@0 i_42) (<= i_42 right)) (= (|Seq#Index_3395| pw i_42) (|Seq#Index_3395| pwPar@0 i_42)))
...
(let ((anon95_Else_correct  (=> (forall ((i_40 Int) ) (!  (=> (and (<= left_1 i_40) (<= i_40 (- pivotIndex@0 1))) (= (|Seq#Index_3395| pw i_40) (|Seq#Index_3395| pwPar@0 (|Seq#Index_3395| pwRec@0 i_40))))
...
(let ((anon94_Else_correct  (and (=> (= (ControlFlow 0 90) (- 0 91)) (dummy ExhaleHeap@1 (|Seq#Index_3395| pwRec@0 storeIndex@0))) (=> (dummy ExhaleHeap@1 (|Seq#Index_3395| pwRec@0 storeIndex@0)) (=> (and (and (state ExhaleHeap@1 QPMask@4) (= (|Seq#Length_3395| pw) (+ right 1))) (and (state ExhaleHeap@1 QPMask@4) (state ExhaleHeap@1 QPMask@4))) (and (and (=> (= (ControlFlow 0 90) 89) anon95_Else_correct) (=> (= (ControlFlow 0 90) 73) anon96_Then_correct)) (=> (= (ControlFlow 0 90) 80) anon96_Else_correct)))))))
(let ((anon93_Then_correct  (=> (and (< n@@13 pivotIndex@0) (= arg_right@0 (- pivotIndex@0 1))) (and (=> (= (ControlFlow 0 92) (- 0 102)) (<= 0 left_1)) (=> (<= 0 left_1) (and (=> (= (ControlFlow 0 92) (- 0 101)) (<= left_1 arg_right@0)) (=> (<= left_1 arg_right@0) (and (=> (= (ControlFlow 0 92) (- 0 100)) (< arg_right@0 (len_1 a_2@@1))) (=> (< arg_right@0 (len_1 a_2@@1)) (and (=> (= (ControlFlow 0 92) (- 0 99)) (<= left_1 n@@13)) (=> (<= left_1 n@@13) (and (=> (= (ControlFlow 0 92) (- 0 98)) (<= n@@13 arg_right@0)) (=> (<= n@@13 arg_right@0) (and (=> (= (ControlFlow 0 92) (- 0 97)) (forall ((i_32_2 Int) (i_32_3 Int) ) (!  (=> (and (and (and (and (not (= i_32_2 i_32_3)) (and (<= left_1 i_32_2) (<= i_32_2 arg_right@0))) (and (<= left_1 i_32_3) (<= i_32_3 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_32_2) (loc a_2@@1 i_32_3))))
...
)) (and (=> (= (ControlFlow 0 92) (- 0 96)) (forall ((i_32_2@@1 Int) ) (!  (=> (and (<= left_1 i_32_2@@1) (<= i_32_2@@1 arg_right@0)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) (loc a_2@@1 i_32_2@@1) val) FullPerm))
 :qid |stdinbpl.2438:31|
 :skolemid |182|
 :pattern ( (loc a_2@@1 i_32_2@@1))
 :pattern ( (loc a_2@@1 i_32_2@@1))
))) (=> (forall ((i_32_2@@2 Int) ) (!  (=> (and (<= left_1 i_32_2@@2) (<= i_32_2@@2 arg_right@0)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) (loc a_2@@1 i_32_2@@2) val) FullPerm))
 :qid |stdinbpl.2438:31|
 :skolemid |182|
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (<= left_1 (invRecv14 o_4@@14)) (<= (invRecv14 o_4@@14) arg_right@0)) (and (< NoPerm FullPerm) (qpRange14 o_4@@14))) (and (= (loc a_2@@1 (invRecv14 o_4@@14)) o_4@@14) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_4@@14 val) (- (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@14 val) FullPerm)))) (=> (not (and (and (<= left_1 (invRecv14 o_4@@14)) (<= (invRecv14 o_4@@14) arg_right@0)) (and (< NoPerm FullPerm) (qpRange14 o_4@@14)))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_4@@14 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@14 val))))
 :qid |stdinbpl.2454:36|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_4@@14 val))
))) (=> (and (and (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@2) o_4@@15 f_5@@9) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@3) o_4@@15 f_5@@9)))
 :qid |stdinbpl.2460:43|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@3) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@2) o_4@@16 f_5@@10) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@3) o_4@@16 f_5@@10)))
 :qid |stdinbpl.2460:43|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@3) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_34782_3612) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@17 f_5@@11) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_4@@17 f_5@@11)))
 :qid |stdinbpl.2460:43|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@2) o_4@@18 f_5@@12) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@3) o_4@@18 f_5@@12)))
 :qid |stdinbpl.2460:43|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@3) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@2) o_4@@19 f_5@@13) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@3) o_4@@19 f_5@@13)))
 :qid |stdinbpl.2460:43|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@3) o_4@@19 f_5@@13))
 ...
 :pattern ( (loc a_2@@1 i_33_1@@2))
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (and (<= left_1 (invRecv15 o_4@@21)) (<= (invRecv15 o_4@@21) arg_right@0)) (< NoPerm FullPerm)) (qpRange15 o_4@@21)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv15 o_4@@21)) o_4@@21)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@4) o_4@@21 val) (+ (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_4@@21 val) FullPerm)))) (=> (not (and (and (and (<= left_1 (invRecv15 o_4@@21)) (<= (invRecv15 o_4@@21) arg_right@0)) (< NoPerm FullPerm)) (qpRange15 o_4@@21))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@4) o_4@@21 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_4@@21 val))))
 :qid |stdinbpl.2500:36|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@4) o_4@@21 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@22 T@Ref) (f_5@@14 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@3) o_4@@22 f_5@@14) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@4) o_4@@22 f_5@@14)))
 :qid |stdinbpl.2504:43|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@3) o_4@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@4) o_4@@22 f_5@@14))
)) (forall ((o_4@@23 T@Ref) (f_5@@15 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@3) o_4@@23 f_5@@15) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@4) o_4@@23 f_5@@15)))
 :qid |stdinbpl.2504:43|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@3) o_4@@23 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@4) o_4@@23 f_5@@15))
))) (forall ((o_4@@24 T@Ref) (f_5@@16 T@Field_34782_3612) ) (!  (=> (not (= f_5@@16 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_4@@24 f_5@@16) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@4) o_4@@24 f_5@@16)))
 :qid |stdinbpl.2504:43|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_4@@24 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@4) o_4@@24 f_5@@16))
))) (forall ((o_4@@25 T@Ref) (f_5@@17 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@3) o_4@@25 f_5@@17) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@4) o_4@@25 f_5@@17)))
 :qid |stdinbpl.2504:43|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@3) o_4@@25 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@4) o_4@@25 f_5@@17))
))) (forall ((o_4@@26 T@Ref) (f_5@@18 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@3) o_4@@26 f_5@@18) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@4) o_4@@26 f_5@@18)))
 :qid |stdinbpl.2504:43|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@3) o_4@@26 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@4) o_4@@26 f_5@@18))
))) (and (state ExhaleHeap@1 QPMask@4) (= storeIndex@0 n@@13))) (and (and (and (forall ((i_34_2 Int) ) (!  (=> (and (<= left_1 i_34_2) (< i_34_2 storeIndex@0)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@1) (loc a_2@@1 i_34_2) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@1) (loc a_2@@1 storeIndex@0) val)))
 :qid |stdinbpl.2511:34|
 :skolemid |193|
 :pattern ( (loc a_2@@1 i_34_2))
)) (forall ((i_35_1 Int) ) (!  (=> (and (< storeIndex@0 i_35_1) (<= i_35_1 arg_right@0)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@1) (loc a_2@@1 storeIndex@0) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@1) (loc a_2@@1 i_35_1) val)))
 :qid |stdinbpl.2515:34|
 :skolemid |194|
 :pattern ( (loc a_2@@1 i_35_1))
))) (and (= (|Seq#Length_3395| pwRec@0) (+ arg_right@0 1)) (forall ((i_36_2 Int) ) (!  (=> (and (<= left_1 i_36_2) (<= i_36_2 arg_right@0)) (and (<= left_1 (|Seq#Index_3395| pwRec@0 i_36_2)) (<= (|Seq#Index_3395| pwRec@0 i_36_2) arg_right@0)))
 :qid |stdinbpl.2520:34|
 :skolemid |195|
 :pattern ( (|Seq#Index_3395| pwRec@0 i_36_2))
)))) (and (and (forall ((i_37 Int) (j_4_1 Int) ) (!  (=> (and (<= left_1 i_37) (and (< i_37 j_4_1) (<= j_4_1 arg_right@0))) (not (= (|Seq#Index_3395| pwRec@0 i_37) (|Seq#Index_3395| pwRec@0 j_4_1))))
 :qid |stdinbpl.2524:34|
 :skolemid |196|
 :pattern ( (|Seq#Index_3395| pwRec@0 i_37) (|Seq#Index_3395| pwRec@0 j_4_1))
)) (forall ((i_38 Int) ) (!  (=> (and (<= left_1 i_38) (<= i_38 arg_right@0)) (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@1) (loc a_2@@1 i_38) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 (|Seq#Index_3395| pwRec@0 i_38)) val)))
...
(let ((anon102_Else_correct  (=> (forall ((i_53 Int) ) (!  (=> (and (<= (+ pivotIndex@0 1) i_53) (<= i_53 right)) (= (|Seq#Index_3395| pw i_53) (|Seq#Index_3395| pwPar@0 (|Seq#Index_3395| pwRec@1 i_53))))
 :qid |stdinbpl.2814:32|
 :skolemid |218|
 :pattern ( (|Seq#Index_3395| pw i_53))
 :pattern ( (|Seq#Index_3395| pwPar@0 (|Seq#Index_3395| pwRec@1 i_53)))
...
(let ((anon91_Then_correct  (=> (= left_1 right) (=> (and (and (and (state Heap@@21 QPMask@0) (= pw@0 (|Seq#Range| 0 (+ left_1 1)))) (and (state Heap@@21 QPMask@0) (= Heap@2 Heap@@21))) (and (and (= Mask@2 QPMask@0) (= storeIndex@4 left_1)) (and (= pw@2 pw@0) (= (ControlFlow 0 52) 46)))) anon56_correct))))
(let ((anon52_correct true))
(let ((anon103_Else_correct  (=> (and (not (and (<= (+ pivotIndex@0 1) i_36) (<= i_36 right))) (= (ControlFlow 0 18) 10)) anon52_correct)))
(let ((anon103_Then_correct  (=> (and (<= (+ pivotIndex@0 1) i_36) (<= i_36 right)) (and (=> (= (ControlFlow 0 11) (- 0 17)) (>= i_36 0)) (=> (>= i_36 0) (and (=> (= (ControlFlow 0 11) (- 0 16)) (< i_36 (|Seq#Length_3395| pw))) (=> (< i_36 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 11) (- 0 15)) (>= i_36 0)) (=> (>= i_36 0) (and (=> (= (ControlFlow 0 11) (- 0 14)) (< i_36 (|Seq#Length_3395| pwRec@1))) (=> (< i_36 (|Seq#Length_3395| pwRec@1)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= (|Seq#Index_3395| pwRec@1 i_36) 0)) (=> (>= (|Seq#Index_3395| pwRec@1 i_36) 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< (|Seq#Index_3395| pwRec@1 i_36) (|Seq#Length_3395| pwPar@0))) (=> (< (|Seq#Index_3395| pwRec@1 i_36) (|Seq#Length_3395| pwPar@0)) (=> (= (ControlFlow 0 11) 10) anon52_correct))))))))))))))))
(let ((anon100_Else_correct  (=> (forall ((i_51 Int) ) (!  (=> (and (<= left_1 i_51) (<= i_51 pivotIndex@0)) (= (|Seq#Index_3395| pw i_51) (|Seq#Index_3395| pwPar@0 i_51)))
...
(let ((anon93_Else_correct  (=> (and (<= pivotIndex@0 n@@13) (= arg_left@0 (+ pivotIndex@0 1))) (and (=> (= (ControlFlow 0 60) (- 0 70)) (<= 0 arg_left@0)) (=> (<= 0 arg_left@0) (and (=> (= (ControlFlow 0 60) (- 0 69)) (<= arg_left@0 right)) (=> (<= arg_left@0 right) (and (=> (= (ControlFlow 0 60) (- 0 68)) (< right (len_1 a_2@@1))) (=> (< right (len_1 a_2@@1)) (and (=> (= (ControlFlow 0 60) (- 0 67)) (<= arg_left@0 n@@13)) (=> (<= arg_left@0 n@@13) (and (=> (= (ControlFlow 0 60) (- 0 66)) (<= n@@13 right)) (=> (<= n@@13 right) (and (=> (= (ControlFlow 0 60) (- 0 65)) (forall ((i_43_2 Int) (i_43_3 Int) ) (!  (=> (and (and (and (and (not (= i_43_2 i_43_3)) (and (<= arg_left@0 i_43_2) (<= i_43_2 right))) (and (<= arg_left@0 i_43_3) (<= i_43_3 right))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_43_2) (loc a_2@@1 i_43_3))))
...
)) (and (=> (= (ControlFlow 0 60) (- 0 64)) (forall ((i_43_2@@1 Int) ) (!  (=> (and (<= arg_left@0 i_43_2@@1) (<= i_43_2@@1 right)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) (loc a_2@@1 i_43_2@@1) val) FullPerm))
 :qid |stdinbpl.2646:31|
 :skolemid |201|
 :pattern ( (loc a_2@@1 i_43_2@@1))
 :pattern ( (loc a_2@@1 i_43_2@@1))
))) (=> (forall ((i_43_2@@2 Int) ) (!  (=> (and (<= arg_left@0 i_43_2@@2) (<= i_43_2@@2 right)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) (loc a_2@@1 i_43_2@@2) val) FullPerm))
 :qid |stdinbpl.2646:31|
 :skolemid |201|
...
)) (forall ((o_4@@28 T@Ref) ) (!  (and (=> (and (and (<= arg_left@0 (invRecv16 o_4@@28)) (<= (invRecv16 o_4@@28) right)) (and (< NoPerm FullPerm) (qpRange16 o_4@@28))) (and (= (loc a_2@@1 (invRecv16 o_4@@28)) o_4@@28) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_4@@28 val) (- (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@28 val) FullPerm)))) (=> (not (and (and (<= arg_left@0 (invRecv16 o_4@@28)) (<= (invRecv16 o_4@@28) right)) (and (< NoPerm FullPerm) (qpRange16 o_4@@28)))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_4@@28 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@28 val))))
 :qid |stdinbpl.2662:36|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_4@@28 val))
))) (=> (and (and (and (and (and (and (forall ((o_4@@29 T@Ref) (f_5@@19 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@2) o_4@@29 f_5@@19) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@5) o_4@@29 f_5@@19)))
 :qid |stdinbpl.2668:43|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@5) o_4@@29 f_5@@19))
)) (forall ((o_4@@30 T@Ref) (f_5@@20 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@2) o_4@@30 f_5@@20) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@5) o_4@@30 f_5@@20)))
 :qid |stdinbpl.2668:43|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@5) o_4@@30 f_5@@20))
))) (forall ((o_4@@31 T@Ref) (f_5@@21 T@Field_34782_3612) ) (!  (=> (not (= f_5@@21 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@31 f_5@@21) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_4@@31 f_5@@21)))
 :qid |stdinbpl.2668:43|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_4@@31 f_5@@21))
))) (forall ((o_4@@32 T@Ref) (f_5@@22 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@2) o_4@@32 f_5@@22) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@5) o_4@@32 f_5@@22)))
 :qid |stdinbpl.2668:43|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@5) o_4@@32 f_5@@22))
))) (forall ((o_4@@33 T@Ref) (f_5@@23 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@2) o_4@@33 f_5@@23) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@5) o_4@@33 f_5@@23)))
 :qid |stdinbpl.2668:43|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@5) o_4@@33 f_5@@23))
 ...
 :pattern ( (loc a_2@@1 i_44@@2))
)) (forall ((o_4@@35 T@Ref) ) (!  (and (=> (and (and (and (<= arg_left@0 (invRecv17 o_4@@35)) (<= (invRecv17 o_4@@35) right)) (< NoPerm FullPerm)) (qpRange17 o_4@@35)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv17 o_4@@35)) o_4@@35)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@6) o_4@@35 val) (+ (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_4@@35 val) FullPerm)))) (=> (not (and (and (and (<= arg_left@0 (invRecv17 o_4@@35)) (<= (invRecv17 o_4@@35) right)) (< NoPerm FullPerm)) (qpRange17 o_4@@35))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@6) o_4@@35 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_4@@35 val))))
 :qid |stdinbpl.2708:36|
 :skolemid |210|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@6) o_4@@35 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@36 T@Ref) (f_5@@24 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@5) o_4@@36 f_5@@24) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@6) o_4@@36 f_5@@24)))
 :qid |stdinbpl.2712:43|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@5) o_4@@36 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@6) o_4@@36 f_5@@24))
)) (forall ((o_4@@37 T@Ref) (f_5@@25 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@5) o_4@@37 f_5@@25) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@6) o_4@@37 f_5@@25)))
 :qid |stdinbpl.2712:43|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@5) o_4@@37 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@6) o_4@@37 f_5@@25))
))) (forall ((o_4@@38 T@Ref) (f_5@@26 T@Field_34782_3612) ) (!  (=> (not (= f_5@@26 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_4@@38 f_5@@26) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@6) o_4@@38 f_5@@26)))
 :qid |stdinbpl.2712:43|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_4@@38 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@6) o_4@@38 f_5@@26))
))) (forall ((o_4@@39 T@Ref) (f_5@@27 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@5) o_4@@39 f_5@@27) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@6) o_4@@39 f_5@@27)))
 :qid |stdinbpl.2712:43|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@5) o_4@@39 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@6) o_4@@39 f_5@@27))
))) (forall ((o_4@@40 T@Ref) (f_5@@28 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@5) o_4@@40 f_5@@28) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@6) o_4@@40 f_5@@28)))
 :qid |stdinbpl.2712:43|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@5) o_4@@40 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@6) o_4@@40 f_5@@28))
))) (and (state ExhaleHeap@2 QPMask@6) (= storeIndex@1 n@@13))) (and (and (and (forall ((i_45_2 Int) ) (!  (=> (and (<= arg_left@0 i_45_2) (< i_45_2 storeIndex@1)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@2) (loc a_2@@1 i_45_2) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@2) (loc a_2@@1 storeIndex@1) val)))
 :qid |stdinbpl.2719:34|
 :skolemid |212|
 :pattern ( (loc a_2@@1 i_45_2))
)) (forall ((i_46 Int) ) (!  (=> (and (< storeIndex@1 i_46) (<= i_46 right)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@2) (loc a_2@@1 storeIndex@1) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@2) (loc a_2@@1 i_46) val)))
 :qid |stdinbpl.2723:34|
 :skolemid |213|
 :pattern ( (loc a_2@@1 i_46))
))) (and (= (|Seq#Length_3395| pwRec@1) (+ right 1)) (forall ((i_47_2 Int) ) (!  (=> (and (<= arg_left@0 i_47_2) (<= i_47_2 right)) (and (<= arg_left@0 (|Seq#Index_3395| pwRec@1 i_47_2)) (<= (|Seq#Index_3395| pwRec@1 i_47_2) right)))
 :qid |stdinbpl.2728:34|
 :skolemid |214|
 :pattern ( (|Seq#Index_3395| pwRec@1 i_47_2))
)))) (and (and (forall ((i_48_2 Int) (j_5_1 Int) ) (!  (=> (and (<= arg_left@0 i_48_2) (and (< i_48_2 j_5_1) (<= j_5_1 right))) (not (= (|Seq#Index_3395| pwRec@1 i_48_2) (|Seq#Index_3395| pwRec@1 j_5_1))))
 :qid |stdinbpl.2732:34|
 :skolemid |215|
 :pattern ( (|Seq#Index_3395| pwRec@1 i_48_2) (|Seq#Index_3395| pwRec@1 j_5_1))
)) (forall ((i_49 Int) ) (!  (=> (and (<= arg_left@0 i_49) (<= i_49 right)) (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@2) (loc a_2@@1 i_49) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 (|Seq#Index_3395| pwRec@1 i_49)) val)))
...
(let ((anon91_Else_correct  (=> (not (= left_1 right)) (=> (and (and (<= left_1 pivotIndex) (<= pivotIndex right)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 104) (- 0 112)) (<= 0 left_1)) (=> (<= 0 left_1) (and (=> (= (ControlFlow 0 104) (- 0 111)) (< left_1 right)) (=> (< left_1 right) (and (=> (= (ControlFlow 0 104) (- 0 110)) (< right (len_1 a_2@@1))) (=> (< right (len_1 a_2@@1)) (and (=> (= (ControlFlow 0 104) (- 0 109)) (<= left_1 pivotIndex)) (=> (<= left_1 pivotIndex) (and (=> (= (ControlFlow 0 104) (- 0 108)) (<= pivotIndex right)) (=> (<= pivotIndex right) (and (=> (= (ControlFlow 0 104) (- 0 107)) (forall ((i_25 Int) (i_25_2 Int) ) (!  (=> (and (and (and (and (not (= i_25 i_25_2)) (and (<= left_1 i_25) (<= i_25 right))) (and (<= left_1 i_25_2) (<= i_25_2 right))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_25) (loc a_2@@1 i_25_2))))
...
)) (and (=> (= (ControlFlow 0 104) (- 0 106)) (forall ((i_25@@1 Int) ) (!  (=> (and (<= left_1 i_25@@1) (<= i_25@@1 right)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) (loc a_2@@1 i_25@@1) val) FullPerm))
 :qid |stdinbpl.2294:23|
 :skolemid |165|
 :pattern ( (loc a_2@@1 i_25@@1))
 :pattern ( (loc a_2@@1 i_25@@1))
))) (=> (forall ((i_25@@2 Int) ) (!  (=> (and (<= left_1 i_25@@2) (<= i_25@@2 right)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) (loc a_2@@1 i_25@@2) val) FullPerm))
 :qid |stdinbpl.2294:23|
 :skolemid |165|
...
)) (forall ((o_4@@42 T@Ref) ) (!  (and (=> (and (and (<= left_1 (invRecv12 o_4@@42)) (<= (invRecv12 o_4@@42) right)) (and (< NoPerm FullPerm) (qpRange12 o_4@@42))) (and (= (loc a_2@@1 (invRecv12 o_4@@42)) o_4@@42) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_4@@42 val) (- (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_4@@42 val) FullPerm)))) (=> (not (and (and (<= left_1 (invRecv12 o_4@@42)) (<= (invRecv12 o_4@@42) right)) (and (< NoPerm FullPerm) (qpRange12 o_4@@42)))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_4@@42 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_4@@42 val))))
 :qid |stdinbpl.2310:28|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_4@@42 val))
))) (=> (and (and (and (and (and (and (forall ((o_4@@43 T@Ref) (f_5@@29 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@0) o_4@@43 f_5@@29) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@1) o_4@@43 f_5@@29)))
 :qid |stdinbpl.2316:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@1) o_4@@43 f_5@@29))
)) (forall ((o_4@@44 T@Ref) (f_5@@30 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@0) o_4@@44 f_5@@30) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@1) o_4@@44 f_5@@30)))
 :qid |stdinbpl.2316:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@1) o_4@@44 f_5@@30))
))) (forall ((o_4@@45 T@Ref) (f_5@@31 T@Field_34782_3612) ) (!  (=> (not (= f_5@@31 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_4@@45 f_5@@31) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_4@@45 f_5@@31)))
 :qid |stdinbpl.2316:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_4@@45 f_5@@31))
))) (forall ((o_4@@46 T@Ref) (f_5@@32 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@0) o_4@@46 f_5@@32) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@1) o_4@@46 f_5@@32)))
 :qid |stdinbpl.2316:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@1) o_4@@46 f_5@@32))
))) (forall ((o_4@@47 T@Ref) (f_5@@33 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@0) o_4@@47 f_5@@33) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@1) o_4@@47 f_5@@33)))
 :qid |stdinbpl.2316:35|
 :skolemid |169|
 ...
 :pattern ( (loc a_2@@1 i_26@@2))
)) (forall ((o_4@@49 T@Ref) ) (!  (and (=> (and (and (and (<= left_1 (invRecv13 o_4@@49)) (<= (invRecv13 o_4@@49) right)) (< NoPerm FullPerm)) (qpRange13 o_4@@49)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv13 o_4@@49)) o_4@@49)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@49 val) (+ (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_4@@49 val) FullPerm)))) (=> (not (and (and (and (<= left_1 (invRecv13 o_4@@49)) (<= (invRecv13 o_4@@49) right)) (< NoPerm FullPerm)) (qpRange13 o_4@@49))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@49 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_4@@49 val))))
 :qid |stdinbpl.2356:28|
 :skolemid |174|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@49 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@50 T@Ref) (f_5@@34 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@1) o_4@@50 f_5@@34) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@2) o_4@@50 f_5@@34)))
 :qid |stdinbpl.2360:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@1) o_4@@50 f_5@@34))
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@2) o_4@@50 f_5@@34))
)) (forall ((o_4@@51 T@Ref) (f_5@@35 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@1) o_4@@51 f_5@@35) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@2) o_4@@51 f_5@@35)))
 :qid |stdinbpl.2360:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@1) o_4@@51 f_5@@35))
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@2) o_4@@51 f_5@@35))
))) (forall ((o_4@@52 T@Ref) (f_5@@36 T@Field_34782_3612) ) (!  (=> (not (= f_5@@36 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_4@@52 f_5@@36) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@52 f_5@@36)))
 :qid |stdinbpl.2360:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_4@@52 f_5@@36))
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_4@@52 f_5@@36))
))) (forall ((o_4@@53 T@Ref) (f_5@@37 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@1) o_4@@53 f_5@@37) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@2) o_4@@53 f_5@@37)))
 :qid |stdinbpl.2360:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@1) o_4@@53 f_5@@37))
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@2) o_4@@53 f_5@@37))
))) (forall ((o_4@@54 T@Ref) (f_5@@38 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@1) o_4@@54 f_5@@38) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@2) o_4@@54 f_5@@38)))
 :qid |stdinbpl.2360:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@1) o_4@@54 f_5@@38))
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@2) o_4@@54 f_5@@38))
))) (and (state ExhaleHeap@0 QPMask@2) (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 pivotIndex@0) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@@21) (loc a_2@@1 pivotIndex) val)))) (and (and (and (forall ((i_27 Int) ) (!  (=> (and (<= left_1 i_27) (< i_27 pivotIndex@0)) (< (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 i_27) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 pivotIndex@0) val)))
 :qid |stdinbpl.2367:26|
 :skolemid |176|
 :pattern ( (loc a_2@@1 i_27))
)) (forall ((i_28 Int) ) (!  (=> (and (< pivotIndex@0 i_28) (<= i_28 right)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 pivotIndex@0) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 i_28) val)))
 :qid |stdinbpl.2371:26|
 :skolemid |177|
 :pattern ( (loc a_2@@1 i_28))
))) (and (= (|Seq#Length_3395| pwPar@0) (+ right 1)) (forall ((i_29_1 Int) ) (!  (=> (and (<= left_1 i_29_1) (<= i_29_1 right)) (and (<= left_1 (|Seq#Index_3395| pwPar@0 i_29_1)) (<= (|Seq#Index_3395| pwPar@0 i_29_1) right)))
 :qid |stdinbpl.2376:26|
 :skolemid |178|
 :pattern ( (|Seq#Index_3395| pwPar@0 i_29_1))
)))) (and (and (forall ((i_30_2 Int) (k Int) ) (!  (=> (and (<= left_1 i_30_2) (and (< i_30_2 k) (<= k right))) (not (= (|Seq#Index_3395| pwPar@0 i_30_2) (|Seq#Index_3395| pwPar@0 k))))
 :qid |stdinbpl.2380:26|
 :skolemid |179|
 :pattern ( (|Seq#Index_3395| pwPar@0 i_30_2) (|Seq#Index_3395| pwPar@0 k))
)) (forall ((i_31_1 Int) ) (!  (=> (and (<= left_1 i_31_1) (<= i_31_1 right)) (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 i_31_1) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@@21) (loc a_2@@1 (|Seq#Index_3395| pwPar@0 i_31_1)) val)))
...
(let ((anon77_Else_correct  (and (=> (= (ControlFlow 0 155) (- 0 156)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= left_1 i_1) (<= i_1 right))) (and (<= left_1 i_1_1) (<= i_1_1 right))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_1) (loc a_2@@1 i_1_1))))
 ...
 :pattern ( (loc a_2@@1 i_1@@2))
)) (forall ((o_4@@56 T@Ref) ) (!  (and (=> (and (and (and (<= left_1 (invRecv9 o_4@@56)) (<= (invRecv9 o_4@@56) right)) (< NoPerm FullPerm)) (qpRange9 o_4@@56)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv9 o_4@@56)) o_4@@56)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_4@@56 val) (+ (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_4@@56 val) FullPerm)))) (=> (not (and (and (and (<= left_1 (invRecv9 o_4@@56)) (<= (invRecv9 o_4@@56) right)) (< NoPerm FullPerm)) (qpRange9 o_4@@56))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_4@@56 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_4@@56 val))))
 :qid |stdinbpl.2077:22|
 :skolemid |151|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_4@@56 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@57 T@Ref) (f_5@@39 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| ZeroMask) o_4@@57 f_5@@39) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@0) o_4@@57 f_5@@39)))
 :qid |stdinbpl.2081:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| ZeroMask) o_4@@57 f_5@@39))
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@0) o_4@@57 f_5@@39))
)) (forall ((o_4@@58 T@Ref) (f_5@@40 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| ZeroMask) o_4@@58 f_5@@40) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@0) o_4@@58 f_5@@40)))
 :qid |stdinbpl.2081:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| ZeroMask) o_4@@58 f_5@@40))
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@0) o_4@@58 f_5@@40))
))) (forall ((o_4@@59 T@Ref) (f_5@@41 T@Field_34782_3612) ) (!  (=> (not (= f_5@@41 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_4@@59 f_5@@41) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_4@@59 f_5@@41)))
 :qid |stdinbpl.2081:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_4@@59 f_5@@41))
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_4@@59 f_5@@41))
))) (forall ((o_4@@60 T@Ref) (f_5@@42 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| ZeroMask) o_4@@60 f_5@@42) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@0) o_4@@60 f_5@@42)))
 :qid |stdinbpl.2081:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| ZeroMask) o_4@@60 f_5@@42))
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@0) o_4@@60 f_5@@42))
))) (forall ((o_4@@61 T@Ref) (f_5@@43 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| ZeroMask) o_4@@61 f_5@@43) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@0) o_4@@61 f_5@@43)))
 :qid |stdinbpl.2081:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| ZeroMask) o_4@@61 f_5@@43))
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@0) o_4@@61 f_5@@43))
