...
(declare-fun QPMask@8 () T@PolymorphicMapType_28572)
...
(declare-fun Heap@2 () T@PolymorphicMapType_28551)
...
(declare-fun Heap@1 () T@PolymorphicMapType_28551)
...
(let ((anon90_Else_correct  (=> (and (not (and (<= left i_27) (<= i_27 right_2))) (= (ControlFlow 0 147) 141)) anon25_correct)))
(let ((anon90_Then_correct  (=> (and (<= left i_27) (<= i_27 right_2)) (and (=> (= (ControlFlow 0 142) (- 0 146)) (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_27) val)) (=> (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_27) val) (and (=> (= (ControlFlow 0 142) (- 0 145)) (>= i_27 0)) (=> (>= i_27 0) (and (=> (= (ControlFlow 0 142) (- 0 144)) (< i_27 (|Seq#Length_3395| pw))) (=> (< i_27 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 142) (- 0 143)) (HasDirectPerm_19693_3612 QPMask@0 (loc a_2@@1 (|Seq#Index_3395| pw i_27)) val)) (=> (HasDirectPerm_19693_3612 QPMask@0 (loc a_2@@1 (|Seq#Index_3395| pw i_27)) val) (=> (= (ControlFlow 0 142) 141) anon25_correct))))))))))))
(let ((anon89_Else_correct true))
(let ((anon87_Else_correct  (=> (and (forall ((i_11_1 Int) (j_1 Int) ) (!  (=> (and (<= left i_11_1) (and (< i_11_1 j_1) (<= j_1 right_2))) (not (= (|Seq#Index_3395| pw i_11_1) (|Seq#Index_3395| pw j_1))))
 :qid |stdinbpl.2215:20|
 :skolemid |162|
...
(let ((anon88_Else_correct  (=> (and (not (and (<= left i_25) (and (< i_25 j_25) (<= j_25 right_2)))) (= (ControlFlow 0 139) 133)) anon21_correct)))
(let ((anon88_Then_correct  (=> (and (<= left i_25) (and (< i_25 j_25) (<= j_25 right_2))) (and (=> (= (ControlFlow 0 134) (- 0 138)) (>= i_25 0)) (=> (>= i_25 0) (and (=> (= (ControlFlow 0 134) (- 0 137)) (< i_25 (|Seq#Length_3395| pw))) (=> (< i_25 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 134) (- 0 136)) (>= j_25 0)) (=> (>= j_25 0) (and (=> (= (ControlFlow 0 134) (- 0 135)) (< j_25 (|Seq#Length_3395| pw))) (=> (< j_25 (|Seq#Length_3395| pw)) (=> (= (ControlFlow 0 134) 133) anon21_correct))))))))))))
(let ((anon84_Else_correct  (=> (and (forall ((i_9_1 Int) ) (!  (=> (and (<= left i_9_1) (<= i_9_1 right_2)) (and (<= left (|Seq#Index_3395| pw i_9_1)) (<= (|Seq#Index_3395| pw i_9_1) right_2)))
 :qid |stdinbpl.2195:20|
 :skolemid |161|
...
(let ((anon86_Else_correct  (=> (and (< (|Seq#Index_3395| pw i_24) left) (= (ControlFlow 0 129) 124)) anon17_correct)))
(let ((anon86_Then_correct  (=> (<= left (|Seq#Index_3395| pw i_24)) (and (=> (= (ControlFlow 0 126) (- 0 128)) (>= i_24 0)) (=> (>= i_24 0) (and (=> (= (ControlFlow 0 126) (- 0 127)) (< i_24 (|Seq#Length_3395| pw))) (=> (< i_24 (|Seq#Length_3395| pw)) (=> (= (ControlFlow 0 126) 124) anon17_correct))))))))
(let ((anon85_Then_correct  (=> (and (<= left i_24) (<= i_24 right_2)) (and (=> (= (ControlFlow 0 130) (- 0 132)) (>= i_24 0)) (=> (>= i_24 0) (and (=> (= (ControlFlow 0 130) (- 0 131)) (< i_24 (|Seq#Length_3395| pw))) (=> (< i_24 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 130) 126) anon86_Then_correct) (=> (= (ControlFlow 0 130) 129) anon86_Else_correct)))))))))
(let ((anon85_Else_correct  (=> (and (not (and (<= left i_24) (<= i_24 right_2))) (= (ControlFlow 0 125) 124)) anon17_correct)))
(let ((anon82_Else_correct  (=> (and (and (forall ((i_7_1 Int) ) (!  (=> (and (< storeIndex i_7_1) (<= i_7_1 right_2)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| PostHeap@0) (loc a_2@@1 storeIndex) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| PostHeap@0) (loc a_2@@1 i_7_1) val)))
 :qid |stdinbpl.2171:20|
 :skolemid |160|
 :pattern ( (loc a_2@@1 i_7_1))
)) (state PostHeap@0 QPMask@8)) (and (= (|Seq#Length_3395| pw) (+ right_2 1)) (state PostHeap@0 QPMask@8))) (and (and (=> (= (ControlFlow 0 150) 149) anon84_Else_correct) (=> (= (ControlFlow 0 150) 130) anon85_Then_correct)) (=> (= (ControlFlow 0 150) 125) anon85_Else_correct)))))
(let ((anon12_correct true))
(let ((anon83_Else_correct  (=> (and (not (and (< storeIndex i_23) (<= i_23 right_2))) (= (ControlFlow 0 123) 119)) anon12_correct)))
(let ((anon83_Then_correct  (=> (and (< storeIndex i_23) (<= i_23 right_2)) (and (=> (= (ControlFlow 0 120) (- 0 122)) (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 storeIndex) val)) (=> (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 storeIndex) val) (and (=> (= (ControlFlow 0 120) (- 0 121)) (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_23) val)) (=> (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_23) val) (=> (= (ControlFlow 0 120) 119) anon12_correct))))))))
(let ((anon80_Else_correct  (=> (and (forall ((i_5_1 Int) ) (!  (=> (and (<= left i_5_1) (< i_5_1 storeIndex)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| PostHeap@0) (loc a_2@@1 i_5_1) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| PostHeap@0) (loc a_2@@1 storeIndex) val)))
...
(let ((anon81_Else_correct  (=> (and (not (and (<= left i_13) (< i_13 storeIndex))) (= (ControlFlow 0 118) 114)) anon8_correct)))
(let ((anon81_Then_correct  (=> (and (<= left i_13) (< i_13 storeIndex)) (and (=> (= (ControlFlow 0 115) (- 0 117)) (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_13) val)) (=> (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 i_13) val) (and (=> (= (ControlFlow 0 115) (- 0 116)) (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 storeIndex) val)) (=> (HasDirectPerm_19693_3612 QPMask@8 (loc a_2@@1 storeIndex) val) (=> (= (ControlFlow 0 115) 114) anon8_correct))))))))
(let ((anon79_Else_correct  (and (=> (= (ControlFlow 0 152) (- 0 153)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= left i_3_2) (<= i_3_2 right_2))) (and (<= left i_3_3) (<= i_3_3 right_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_3_2) (loc a_2@@1 i_3_3))))
 ...
 :qid |stdinbpl.2109:15|
 :skolemid |153|
)) (=> (and (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= left i_3_2@@1) (<= i_3_2@@1 right_2)) (< NoPerm FullPerm)) (and (qpRange10 (loc a_2@@1 i_3_2@@1)) (= (invRecv10 (loc a_2@@1 i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.2115:22|
 :skolemid |154|
 :pattern ( (loc a_2@@1 i_3_2@@1))
 :pattern ( (loc a_2@@1 i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= left (invRecv10 o_9)) (<= (invRecv10 o_9) right_2)) (< NoPerm FullPerm)) (qpRange10 o_9)) (= (loc a_2@@1 (invRecv10 o_9)) o_9))
 ...
 :pattern ( (loc a_2@@1 i_3_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= left (invRecv10 o_9@@0)) (<= (invRecv10 o_9@@0) right_2)) (< NoPerm FullPerm)) (qpRange10 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv10 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@8) o_9@@0 val) (+ (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= left (invRecv10 o_9@@0)) (<= (invRecv10 o_9@@0) right_2)) (< NoPerm FullPerm)) (qpRange10 o_9@@0))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@8) o_9@@0 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.2131:22|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@8) o_9@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@8) o_9@@1 f_5)))
 :qid |stdinbpl.2135:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@8) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@8) o_9@@2 f_5@@0)))
 :qid |stdinbpl.2135:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@8) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_34782_3612) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@8) o_9@@3 f_5@@1)))
 :qid |stdinbpl.2135:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@8) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@8) o_9@@4 f_5@@2)))
 :qid |stdinbpl.2135:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@8) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@8) o_9@@5 f_5@@3)))
 :qid |stdinbpl.2135:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@8) o_9@@5 f_5@@3))
...
(let ((anon78_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (<= left storeIndex)) (and (<= storeIndex right_2) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 154) 113) anon79_Then_correct) (=> (= (ControlFlow 0 154) 152) anon79_Else_correct)))))
(let ((anon41_correct true))
(let ((anon98_Else_correct  (=> (and (not (and (<= pivotIndex@0 i_42) (<= i_42 right_2))) (= (ControlFlow 0 88) 82)) anon41_correct)))
(let ((anon98_Then_correct  (=> (and (<= pivotIndex@0 i_42) (<= i_42 right_2)) (and (=> (= (ControlFlow 0 83) (- 0 87)) (>= i_42 0)) (=> (>= i_42 0) (and (=> (= (ControlFlow 0 83) (- 0 86)) (< i_42 (|Seq#Length_3395| pw))) (=> (< i_42 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 83) (- 0 85)) (>= i_42 0)) (=> (>= i_42 0) (and (=> (= (ControlFlow 0 83) (- 0 84)) (< i_42 (|Seq#Length_3395| pwPar@0))) (=> (< i_42 (|Seq#Length_3395| pwPar@0)) (=> (= (ControlFlow 0 83) 82) anon41_correct))))))))))))
(let ((anon37_correct true))
(let ((anon96_Else_correct  (=> (and (not (and (<= left i_16) (<= i_16 (- pivotIndex@0 1)))) (= (ControlFlow 0 80) 72)) anon37_correct)))
(let ((anon96_Then_correct  (=> (and (<= left i_16) (<= i_16 (- pivotIndex@0 1))) (and (=> (= (ControlFlow 0 73) (- 0 79)) (>= i_16 0)) (=> (>= i_16 0) (and (=> (= (ControlFlow 0 73) (- 0 78)) (< i_16 (|Seq#Length_3395| pw))) (=> (< i_16 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 73) (- 0 77)) (>= i_16 0)) (=> (>= i_16 0) (and (=> (= (ControlFlow 0 73) (- 0 76)) (< i_16 (|Seq#Length_3395| pwRec@0))) (=> (< i_16 (|Seq#Length_3395| pwRec@0)) (and (=> (= (ControlFlow 0 73) (- 0 75)) (>= (|Seq#Index_3395| pwRec@0 i_16) 0)) (=> (>= (|Seq#Index_3395| pwRec@0 i_16) 0) (and (=> (= (ControlFlow 0 73) (- 0 74)) (< (|Seq#Index_3395| pwRec@0 i_16) (|Seq#Length_3395| pwPar@0))) (=> (< (|Seq#Index_3395| pwRec@0 i_16) (|Seq#Length_3395| pwPar@0)) (=> (= (ControlFlow 0 73) 72) anon37_correct))))))))))))))))
(let ((anon94_Then_correct true))
(let ((anon75_correct true))
(let ((anon113_Else_correct  (=> (and (not (and (<= left i_23_1) (<= i_23_1 right_2))) (= (ControlFlow 0 40) 37)) anon75_correct)))
(let ((anon113_Then_correct  (=> (and (<= left i_23_1) (<= i_23_1 right_2)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_23_1) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@@21) (loc a_2@@1 (|Seq#Index_3395| pw@2 i_23_1)) val))) (=> (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_23_1) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@@21) (loc a_2@@1 (|Seq#Index_3395| pw@2 i_23_1)) val)) (=> (= (ControlFlow 0 38) 37) anon75_correct))))))
(let ((anon112_Else_correct true))
(let ((anon110_Else_correct  (=> (forall ((i_22_1_1 Int) (j_3_1_1 Int) ) (!  (=> (and (<= left i_22_1_1) (and (< i_22_1_1 j_3_1_1) (<= j_3_1_1 right_2))) (not (= (|Seq#Index_3395| pw@2 i_22_1_1) (|Seq#Index_3395| pw@2 j_3_1_1))))
 :qid |stdinbpl.2921:20|
 :skolemid |228|
...
(let ((anon111_Else_correct  (=> (and (not (and (<= left i_21_1) (and (< i_21_1 j_2_2) (<= j_2_2 right_2)))) (= (ControlFlow 0 35) 32)) anon71_correct)))
(let ((anon111_Then_correct  (=> (and (<= left i_21_1) (and (< i_21_1 j_2_2) (<= j_2_2 right_2))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (not (= (|Seq#Index_3395| pw@2 i_21_1) (|Seq#Index_3395| pw@2 j_2_2)))) (=> (not (= (|Seq#Index_3395| pw@2 i_21_1) (|Seq#Index_3395| pw@2 j_2_2))) (=> (= (ControlFlow 0 33) 32) anon71_correct))))))
(let ((anon108_Else_correct  (=> (forall ((i_20_1 Int) ) (!  (=> (and (<= left i_20_1) (<= i_20_1 right_2)) (and (<= left (|Seq#Index_3395| pw@2 i_20_1)) (<= (|Seq#Index_3395| pw@2 i_20_1) right_2)))
 :qid |stdinbpl.2910:20|
 :skolemid |227|
 :pattern ( (|Seq#Index_3395| pw@2 i_20_1))
...
(let ((anon109_Else_correct  (=> (and (not (and (<= left i_19_1) (<= i_19_1 right_2))) (= (ControlFlow 0 31) 27)) anon67_correct)))
(let ((anon109_Then_correct  (=> (and (<= left i_19_1) (<= i_19_1 right_2)) (and (=> (= (ControlFlow 0 28) (- 0 30)) (<= left (|Seq#Index_3395| pw@2 i_19_1))) (=> (<= left (|Seq#Index_3395| pw@2 i_19_1)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (<= (|Seq#Index_3395| pw@2 i_19_1) right_2)) (=> (<= (|Seq#Index_3395| pw@2 i_19_1) right_2) (=> (= (ControlFlow 0 28) 27) anon67_correct))))))))
(let ((anon106_Else_correct  (=> (forall ((i_18_1_1 Int) ) (!  (=> (and (< storeIndex@4 i_18_1_1) (<= i_18_1_1 right_2)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 storeIndex@4) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_18_1_1) val)))
 :qid |stdinbpl.2895:20|
 :skolemid |226|
 :pattern ( (loc a_2@@1 i_18_1_1))
)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (= (|Seq#Length_3395| pw@2) (+ right_2 1))) (=> (= (|Seq#Length_3395| pw@2) (+ right_2 1)) (and (and (=> (= (ControlFlow 0 43) 42) anon108_Else_correct) (=> (= (ControlFlow 0 43) 28) anon109_Then_correct)) (=> (= (ControlFlow 0 43) 31) anon109_Else_correct)))))))
(let ((anon63_correct true))
(let ((anon107_Else_correct  (=> (and (not (and (< storeIndex@4 i_17_1) (<= i_17_1 right_2))) (= (ControlFlow 0 26) 23)) anon63_correct)))
(let ((anon107_Then_correct  (=> (and (< storeIndex@4 i_17_1) (<= i_17_1 right_2)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 storeIndex@4) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_17_1) val))) (=> (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 storeIndex@4) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_17_1) val)) (=> (= (ControlFlow 0 24) 23) anon63_correct))))))
(let ((anon104_Else_correct  (=> (forall ((i_16_1_1 Int) ) (!  (=> (and (<= left i_16_1_1) (< i_16_1_1 storeIndex@4)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_16_1_1) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 storeIndex@4) val)))
 :qid |stdinbpl.2884:20|
 :skolemid |225|
...
(let ((anon105_Then_correct  (=> (and (<= left i_15_1) (< i_15_1 storeIndex@4)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_15_1) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 storeIndex@4) val))) (=> (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 i_15_1) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@2) (loc a_2@@1 storeIndex@4) val)) (=> (= (ControlFlow 0 20) 19) anon59_correct))))))
(let ((anon56_correct  (=> (state Heap@2 Mask@2) (and (=> (= (ControlFlow 0 46) (- 0 51)) (<= left storeIndex@4)) (=> (<= left storeIndex@4) (and (=> (= (ControlFlow 0 46) (- 0 50)) (<= storeIndex@4 right_2)) (=> (<= storeIndex@4 right_2) (and (=> (= (ControlFlow 0 46) (- 0 49)) (forall ((i_14_1 Int) (i_14_2 Int) ) (!  (=> (and (and (and (and (not (= i_14_1 i_14_2)) (and (<= left i_14_1) (<= i_14_1 right_2))) (and (<= left i_14_2) (<= i_14_2 right_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_14_1) (loc a_2@@1 i_14_2))))
...
)) (and (=> (= (ControlFlow 0 46) (- 0 48)) (forall ((i_14_1@@1 Int) ) (!  (=> (and (<= left i_14_1@@1) (<= i_14_1@@1 right_2)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| Mask@2) (loc a_2@@1 i_14_1@@1) val) FullPerm))
 :qid |stdinbpl.2848:17|
 :skolemid |220|
 :pattern ( (loc a_2@@1 i_14_1@@1))
 :pattern ( (loc a_2@@1 i_14_1@@1))
))) (=> (forall ((i_14_1@@2 Int) ) (!  (=> (and (<= left i_14_1@@2) (<= i_14_1@@2 right_2)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| Mask@2) (loc a_2@@1 i_14_1@@2) val) FullPerm))
 :qid |stdinbpl.2848:17|
 :skolemid |220|
 :pattern ( (loc a_2@@1 i_14_1@@2))
 :pattern ( (loc a_2@@1 i_14_1@@2))
)) (=> (forall ((i_14_1@@3 Int) ) (!  (=> (and (and (<= left i_14_1@@3) (<= i_14_1@@3 right_2)) (< NoPerm FullPerm)) (and (qpRange11 (loc a_2@@1 i_14_1@@3)) (= (invRecv11 (loc a_2@@1 i_14_1@@3)) i_14_1@@3)))
 :qid |stdinbpl.2854:22|
 :skolemid |221|
 :pattern ( (loc a_2@@1 i_14_1@@3))
 :pattern ( (loc a_2@@1 i_14_1@@3))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (<= left (invRecv11 o_9@@6)) (<= (invRecv11 o_9@@6) right_2)) (and (< NoPerm FullPerm) (qpRange11 o_9@@6))) (= (loc a_2@@1 (invRecv11 o_9@@6)) o_9@@6))
 :qid |stdinbpl.2858:22|
 :skolemid |222|
 :pattern ( (invRecv11 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (<= left (invRecv11 o_9@@7)) (<= (invRecv11 o_9@@7) right_2)) (and (< NoPerm FullPerm) (qpRange11 o_9@@7))) (and (= (loc a_2@@1 (invRecv11 o_9@@7)) o_9@@7) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@7) o_9@@7 val) (- (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| Mask@2) o_9@@7 val) FullPerm)))) (=> (not (and (and (<= left (invRecv11 o_9@@7)) (<= (invRecv11 o_9@@7) right_2)) (and (< NoPerm FullPerm) (qpRange11 o_9@@7)))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@7) o_9@@7 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| Mask@2) o_9@@7 val))))
 :qid |stdinbpl.2864:22|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@7) o_9@@7 val))
))) (=> (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| Mask@2) o_9@@8 f_5@@4) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@7) o_9@@8 f_5@@4)))
 :qid |stdinbpl.2870:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@7) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| Mask@2) o_9@@9 f_5@@5) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@7) o_9@@9 f_5@@5)))
 :qid |stdinbpl.2870:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@7) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_34782_3612) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| Mask@2) o_9@@10 f_5@@6) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@7) o_9@@10 f_5@@6)))
 :qid |stdinbpl.2870:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@7) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| Mask@2) o_9@@11 f_5@@7) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@7) o_9@@11 f_5@@7)))
 :qid |stdinbpl.2870:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@7) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| Mask@2) o_9@@12 f_5@@8) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@7) o_9@@12 f_5@@8)))
 :qid |stdinbpl.2870:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@7) o_9@@12 f_5@@8))
...
(let ((anon97_Else_correct  (=> (forall ((i_42_1 Int) ) (!  (=> (and (<= pivotIndex@0 i_42_1) (<= i_42_1 right_2)) (= (|Seq#Index_3395| pw i_42_1) (|Seq#Index_3395| pwPar@0 i_42_1)))
 :qid |stdinbpl.2606:32|
 :skolemid |199|
 :pattern ( (|Seq#Index_3395| pw i_42_1))
 :pattern ( (|Seq#Index_3395| pwPar@0 i_42_1))
...
(let ((anon95_Else_correct  (=> (forall ((i_40 Int) ) (!  (=> (and (<= left i_40) (<= i_40 (- pivotIndex@0 1))) (= (|Seq#Index_3395| pw i_40) (|Seq#Index_3395| pwPar@0 (|Seq#Index_3395| pwRec@0 i_40))))
 :qid |stdinbpl.2580:32|
 :skolemid |198|
 :pattern ( (|Seq#Index_3395| pw i_40))
 :pattern ( (|Seq#Index_3395| pwPar@0 (|Seq#Index_3395| pwRec@0 i_40)))
...
(let ((anon94_Else_correct  (and (=> (= (ControlFlow 0 90) (- 0 91)) (dummy_1 ExhaleHeap@1 (|Seq#Index_3395| pwRec@0 storeIndex@0))) (=> (dummy_1 ExhaleHeap@1 (|Seq#Index_3395| pwRec@0 storeIndex@0)) (=> (and (and (state ExhaleHeap@1 QPMask@4) (= (|Seq#Length_3395| pw) (+ right_2 1))) (and (state ExhaleHeap@1 QPMask@4) (state ExhaleHeap@1 QPMask@4))) (and (and (=> (= (ControlFlow 0 90) 89) anon95_Else_correct) (=> (= (ControlFlow 0 90) 73) anon96_Then_correct)) (=> (= (ControlFlow 0 90) 80) anon96_Else_correct)))))))
(let ((anon93_Then_correct  (=> (and (< n@@13 pivotIndex@0) (= arg_right@0 (- pivotIndex@0 1))) (and (=> (= (ControlFlow 0 92) (- 0 102)) (<= 0 left)) (=> (<= 0 left) (and (=> (= (ControlFlow 0 92) (- 0 101)) (<= left arg_right@0)) (=> (<= left arg_right@0) (and (=> (= (ControlFlow 0 92) (- 0 100)) (< arg_right@0 (len a_2@@1))) (=> (< arg_right@0 (len a_2@@1)) (and (=> (= (ControlFlow 0 92) (- 0 99)) (<= left n@@13)) (=> (<= left n@@13) (and (=> (= (ControlFlow 0 92) (- 0 98)) (<= n@@13 arg_right@0)) (=> (<= n@@13 arg_right@0) (and (=> (= (ControlFlow 0 92) (- 0 97)) (forall ((i_32 Int) (i_32_1 Int) ) (!  (=> (and (and (and (and (not (= i_32 i_32_1)) (and (<= left i_32) (<= i_32 arg_right@0))) (and (<= left i_32_1) (<= i_32_1 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_32) (loc a_2@@1 i_32_1))))
 :qid |stdinbpl.2431:31|
 :skolemid |181|
 :pattern ( (neverTriggered14 i_32) (neverTriggered14 i_32_1))
))) (=> (forall ((i_32@@0 Int) (i_32_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_32@@0 i_32_1@@0)) (and (<= left i_32@@0) (<= i_32@@0 arg_right@0))) (and (<= left i_32_1@@0) (<= i_32_1@@0 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_32@@0) (loc a_2@@1 i_32_1@@0))))
 :qid |stdinbpl.2431:31|
 :skolemid |181|
 :pattern ( (neverTriggered14 i_32@@0) (neverTriggered14 i_32_1@@0))
)) (and (=> (= (ControlFlow 0 92) (- 0 96)) (forall ((i_32@@1 Int) ) (!  (=> (and (<= left i_32@@1) (<= i_32@@1 arg_right@0)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) (loc a_2@@1 i_32@@1) val) FullPerm))
 :qid |stdinbpl.2438:31|
 :skolemid |182|
 :pattern ( (loc a_2@@1 i_32@@1))
 :pattern ( (loc a_2@@1 i_32@@1))
))) (=> (forall ((i_32@@2 Int) ) (!  (=> (and (<= left i_32@@2) (<= i_32@@2 arg_right@0)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) (loc a_2@@1 i_32@@2) val) FullPerm))
 :qid |stdinbpl.2438:31|
 :skolemid |182|
 :pattern ( (loc a_2@@1 i_32@@2))
 :pattern ( (loc a_2@@1 i_32@@2))
)) (=> (forall ((i_32@@3 Int) ) (!  (=> (and (and (<= left i_32@@3) (<= i_32@@3 arg_right@0)) (< NoPerm FullPerm)) (and (qpRange14 (loc a_2@@1 i_32@@3)) (= (invRecv14 (loc a_2@@1 i_32@@3)) i_32@@3)))
 :qid |stdinbpl.2444:36|
 :skolemid |183|
 :pattern ( (loc a_2@@1 i_32@@3))
 :pattern ( (loc a_2@@1 i_32@@3))
)) (=> (and (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (<= left (invRecv14 o_9@@13)) (<= (invRecv14 o_9@@13) arg_right@0)) (and (< NoPerm FullPerm) (qpRange14 o_9@@13))) (= (loc a_2@@1 (invRecv14 o_9@@13)) o_9@@13))
 :qid |stdinbpl.2448:36|
 :skolemid |184|
 :pattern ( (invRecv14 o_9@@13))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (<= left (invRecv14 o_9@@14)) (<= (invRecv14 o_9@@14) arg_right@0)) (and (< NoPerm FullPerm) (qpRange14 o_9@@14))) (and (= (loc a_2@@1 (invRecv14 o_9@@14)) o_9@@14) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_9@@14 val) (- (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@14 val) FullPerm)))) (=> (not (and (and (<= left (invRecv14 o_9@@14)) (<= (invRecv14 o_9@@14) arg_right@0)) (and (< NoPerm FullPerm) (qpRange14 o_9@@14)))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_9@@14 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@14 val))))
 :qid |stdinbpl.2454:36|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_9@@14 val))
))) (=> (and (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@2) o_9@@15 f_5@@9) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@3) o_9@@15 f_5@@9)))
 :qid |stdinbpl.2460:43|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@3) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@2) o_9@@16 f_5@@10) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@3) o_9@@16 f_5@@10)))
 :qid |stdinbpl.2460:43|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@3) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_34782_3612) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@17 f_5@@11) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_9@@17 f_5@@11)))
 :qid |stdinbpl.2460:43|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@2) o_9@@18 f_5@@12) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@3) o_9@@18 f_5@@12)))
 :qid |stdinbpl.2460:43|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@3) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@2) o_9@@19 f_5@@13) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@3) o_9@@19 f_5@@13)))
 :qid |stdinbpl.2460:43|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@3) o_9@@19 f_5@@13))
))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 QPMask@3)) (and (<= left storeIndex@0) (<= storeIndex@0 arg_right@0))) (and (=> (= (ControlFlow 0 92) (- 0 95)) (forall ((i_33 Int) (i_33_2 Int) ) (!  (=> (and (and (and (and (not (= i_33 i_33_2)) (and (<= left i_33) (<= i_33 arg_right@0))) (and (<= left i_33_2) (<= i_33_2 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_33) (loc a_2@@1 i_33_2))))
 :qid |stdinbpl.2478:29|
 :skolemid |187|
))) (=> (forall ((i_33@@0 Int) (i_33_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_33@@0 i_33_2@@0)) (and (<= left i_33@@0) (<= i_33@@0 arg_right@0))) (and (<= left i_33_2@@0) (<= i_33_2@@0 arg_right@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_33@@0) (loc a_2@@1 i_33_2@@0))))
 :qid |stdinbpl.2478:29|
 :skolemid |187|
)) (=> (and (and (forall ((i_33@@1 Int) ) (!  (=> (and (and (<= left i_33@@1) (<= i_33@@1 arg_right@0)) (< NoPerm FullPerm)) (and (qpRange15 (loc a_2@@1 i_33@@1)) (= (invRecv15 (loc a_2@@1 i_33@@1)) i_33@@1)))
 :qid |stdinbpl.2484:36|
 :skolemid |188|
 :pattern ( (loc a_2@@1 i_33@@1))
 :pattern ( (loc a_2@@1 i_33@@1))
)) (forall ((o_9@@20 T@Ref) ) (!  (=> (and (and (and (<= left (invRecv15 o_9@@20)) (<= (invRecv15 o_9@@20) arg_right@0)) (< NoPerm FullPerm)) (qpRange15 o_9@@20)) (= (loc a_2@@1 (invRecv15 o_9@@20)) o_9@@20))
 :qid |stdinbpl.2488:36|
 :skolemid |189|
 :pattern ( (invRecv15 o_9@@20))
))) (and (forall ((i_33@@2 Int) ) (!  (=> (and (<= left i_33@@2) (<= i_33@@2 arg_right@0)) (not (= (loc a_2@@1 i_33@@2) null)))
 :qid |stdinbpl.2494:36|
 :skolemid |190|
 :pattern ( (loc a_2@@1 i_33@@2))
 :pattern ( (loc a_2@@1 i_33@@2))
)) (forall ((o_9@@21 T@Ref) ) (!  (and (=> (and (and (and (<= left (invRecv15 o_9@@21)) (<= (invRecv15 o_9@@21) arg_right@0)) (< NoPerm FullPerm)) (qpRange15 o_9@@21)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv15 o_9@@21)) o_9@@21)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@4) o_9@@21 val) (+ (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_9@@21 val) FullPerm)))) (=> (not (and (and (and (<= left (invRecv15 o_9@@21)) (<= (invRecv15 o_9@@21) arg_right@0)) (< NoPerm FullPerm)) (qpRange15 o_9@@21))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@4) o_9@@21 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_9@@21 val))))
 :qid |stdinbpl.2500:36|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@4) o_9@@21 val))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@22 T@Ref) (f_5@@14 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@3) o_9@@22 f_5@@14) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@4) o_9@@22 f_5@@14)))
 :qid |stdinbpl.2504:43|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@3) o_9@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@4) o_9@@22 f_5@@14))
)) (forall ((o_9@@23 T@Ref) (f_5@@15 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@3) o_9@@23 f_5@@15) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@4) o_9@@23 f_5@@15)))
 :qid |stdinbpl.2504:43|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@3) o_9@@23 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@4) o_9@@23 f_5@@15))
))) (forall ((o_9@@24 T@Ref) (f_5@@16 T@Field_34782_3612) ) (!  (=> (not (= f_5@@16 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_9@@24 f_5@@16) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@4) o_9@@24 f_5@@16)))
 :qid |stdinbpl.2504:43|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@3) o_9@@24 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@4) o_9@@24 f_5@@16))
))) (forall ((o_9@@25 T@Ref) (f_5@@17 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@3) o_9@@25 f_5@@17) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@4) o_9@@25 f_5@@17)))
 :qid |stdinbpl.2504:43|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@3) o_9@@25 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@4) o_9@@25 f_5@@17))
))) (forall ((o_9@@26 T@Ref) (f_5@@18 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@3) o_9@@26 f_5@@18) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@4) o_9@@26 f_5@@18)))
 :qid |stdinbpl.2504:43|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@3) o_9@@26 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@4) o_9@@26 f_5@@18))
))) (and (state ExhaleHeap@1 QPMask@4) (= storeIndex@0 n@@13))) (and (and (and (forall ((i_34 Int) ) (!  (=> (and (<= left i_34) (< i_34 storeIndex@0)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@1) (loc a_2@@1 i_34) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@1) (loc a_2@@1 storeIndex@0) val)))
 :qid |stdinbpl.2511:34|
 :skolemid |193|
 :pattern ( (loc a_2@@1 i_34))
)) (forall ((i_35 Int) ) (!  (=> (and (< storeIndex@0 i_35) (<= i_35 arg_right@0)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@1) (loc a_2@@1 storeIndex@0) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@1) (loc a_2@@1 i_35) val)))
 :qid |stdinbpl.2515:34|
 :skolemid |194|
 :pattern ( (loc a_2@@1 i_35))
))) (and (= (|Seq#Length_3395| pwRec@0) (+ arg_right@0 1)) (forall ((i_36 Int) ) (!  (=> (and (<= left i_36) (<= i_36 arg_right@0)) (and (<= left (|Seq#Index_3395| pwRec@0 i_36)) (<= (|Seq#Index_3395| pwRec@0 i_36) arg_right@0)))
 :qid |stdinbpl.2520:34|
 :skolemid |195|
 :pattern ( (|Seq#Index_3395| pwRec@0 i_36))
)))) (and (and (forall ((i_37 Int) (j_4_1 Int) ) (!  (=> (and (<= left i_37) (and (< i_37 j_4_1) (<= j_4_1 arg_right@0))) (not (= (|Seq#Index_3395| pwRec@0 i_37) (|Seq#Index_3395| pwRec@0 j_4_1))))
 :qid |stdinbpl.2524:34|
 :skolemid |196|
 :pattern ( (|Seq#Index_3395| pwRec@0 i_37) (|Seq#Index_3395| pwRec@0 j_4_1))
)) (forall ((i_38 Int) ) (!  (=> (and (<= left i_38) (<= i_38 arg_right@0)) (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@1) (loc a_2@@1 i_38) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 (|Seq#Index_3395| pwRec@0 i_38)) val)))
 :qid |stdinbpl.2528:34|
 :skolemid |197|
 :pattern ( (|Seq#Index_3395| pwRec@0 i_38))
))) (and (state ExhaleHeap@1 QPMask@4) (state ExhaleHeap@1 QPMask@4))))) (and (=> (= (ControlFlow 0 92) (- 0 94)) (>= storeIndex@0 0)) (=> (>= storeIndex@0 0) (and (=> (= (ControlFlow 0 92) (- 0 93)) (< storeIndex@0 (|Seq#Length_3395| pwRec@0))) (=> (< storeIndex@0 (|Seq#Length_3395| pwRec@0)) (and (=> (= (ControlFlow 0 92) 71) anon94_Then_correct) (=> (= (ControlFlow 0 92) 90) anon94_Else_correct))))))))))))))))))))))))))))))
(let ((anon102_Else_correct  (=> (forall ((i_53_2 Int) ) (!  (=> (and (<= (+ pivotIndex@0 1) i_53_2) (<= i_53_2 right_2)) (= (|Seq#Index_3395| pw i_53_2) (|Seq#Index_3395| pwPar@0 (|Seq#Index_3395| pwRec@1 i_53_2))))
 :qid |stdinbpl.2814:32|
 :skolemid |218|
 :pattern ( (|Seq#Index_3395| pw i_53_2))
 :pattern ( (|Seq#Index_3395| pwPar@0 (|Seq#Index_3395| pwRec@1 i_53_2)))
...
(let ((anon91_Then_correct  (=> (= left right_2) (=> (and (and (and (state Heap@@21 QPMask@0) (= pw@0 (|Seq#Range| 0 (+ left 1)))) (and (state Heap@@21 QPMask@0) (= Heap@2 Heap@@21))) (and (and (= Mask@2 QPMask@0) (= storeIndex@4 left)) (and (= pw@2 pw@0) (= (ControlFlow 0 52) 46)))) anon56_correct))))
(let ((anon52_correct true))
(let ((anon103_Else_correct  (=> (and (not (and (<= (+ pivotIndex@0 1) i_53) (<= i_53 right_2))) (= (ControlFlow 0 18) 10)) anon52_correct)))
(let ((anon103_Then_correct  (=> (and (<= (+ pivotIndex@0 1) i_53) (<= i_53 right_2)) (and (=> (= (ControlFlow 0 11) (- 0 17)) (>= i_53 0)) (=> (>= i_53 0) (and (=> (= (ControlFlow 0 11) (- 0 16)) (< i_53 (|Seq#Length_3395| pw))) (=> (< i_53 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 11) (- 0 15)) (>= i_53 0)) (=> (>= i_53 0) (and (=> (= (ControlFlow 0 11) (- 0 14)) (< i_53 (|Seq#Length_3395| pwRec@1))) (=> (< i_53 (|Seq#Length_3395| pwRec@1)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= (|Seq#Index_3395| pwRec@1 i_53) 0)) (=> (>= (|Seq#Index_3395| pwRec@1 i_53) 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< (|Seq#Index_3395| pwRec@1 i_53) (|Seq#Length_3395| pwPar@0))) (=> (< (|Seq#Index_3395| pwRec@1 i_53) (|Seq#Length_3395| pwPar@0)) (=> (= (ControlFlow 0 11) 10) anon52_correct))))))))))))))))
(let ((anon100_Else_correct  (=> (forall ((i_51_2 Int) ) (!  (=> (and (<= left i_51_2) (<= i_51_2 pivotIndex@0)) (= (|Seq#Index_3395| pw i_51_2) (|Seq#Index_3395| pwPar@0 i_51_2)))
 :qid |stdinbpl.2784:32|
 :skolemid |217|
 :pattern ( (|Seq#Index_3395| pw i_51_2))
 :pattern ( (|Seq#Index_3395| pwPar@0 i_51_2))
...
(let ((anon101_Then_correct  (=> (and (<= left i_51) (<= i_51 pivotIndex@0)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (>= i_51 0)) (=> (>= i_51 0) (and (=> (= (ControlFlow 0 4) (- 0 7)) (< i_51 (|Seq#Length_3395| pw))) (=> (< i_51 (|Seq#Length_3395| pw)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= i_51 0)) (=> (>= i_51 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< i_51 (|Seq#Length_3395| pwPar@0))) (=> (< i_51 (|Seq#Length_3395| pwPar@0)) (=> (= (ControlFlow 0 4) 3) anon48_correct))))))))))))
(let ((anon99_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (dummy_1 ExhaleHeap@2 (|Seq#Index_3395| pwRec@1 storeIndex@1))) (=> (dummy_1 ExhaleHeap@2 (|Seq#Index_3395| pwRec@1 storeIndex@1)) (=> (and (and (state ExhaleHeap@2 QPMask@6) (= (|Seq#Length_3395| pw) (+ right_2 1))) (and (state ExhaleHeap@2 QPMask@6) (state ExhaleHeap@2 QPMask@6))) (and (and (=> (= (ControlFlow 0 58) 57) anon100_Else_correct) (=> (= (ControlFlow 0 58) 4) anon101_Then_correct)) (=> (= (ControlFlow 0 58) 9) anon101_Else_correct)))))))
(let ((anon99_Then_correct true))
(let ((anon93_Else_correct  (=> (and (<= pivotIndex@0 n@@13) (= arg_left@0 (+ pivotIndex@0 1))) (and (=> (= (ControlFlow 0 60) (- 0 70)) (<= 0 arg_left@0)) (=> (<= 0 arg_left@0) (and (=> (= (ControlFlow 0 60) (- 0 69)) (<= arg_left@0 right_2)) (=> (<= arg_left@0 right_2) (and (=> (= (ControlFlow 0 60) (- 0 68)) (< right_2 (len a_2@@1))) (=> (< right_2 (len a_2@@1)) (and (=> (= (ControlFlow 0 60) (- 0 67)) (<= arg_left@0 n@@13)) (=> (<= arg_left@0 n@@13) (and (=> (= (ControlFlow 0 60) (- 0 66)) (<= n@@13 right_2)) (=> (<= n@@13 right_2) (and (=> (= (ControlFlow 0 60) (- 0 65)) (forall ((i_43 Int) (i_43_1 Int) ) (!  (=> (and (and (and (and (not (= i_43 i_43_1)) (and (<= arg_left@0 i_43) (<= i_43 right_2))) (and (<= arg_left@0 i_43_1) (<= i_43_1 right_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_43) (loc a_2@@1 i_43_1))))
 :qid |stdinbpl.2639:31|
 :skolemid |200|
 :pattern ( (neverTriggered16 i_43) (neverTriggered16 i_43_1))
))) (=> (forall ((i_43@@0 Int) (i_43_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_43@@0 i_43_1@@0)) (and (<= arg_left@0 i_43@@0) (<= i_43@@0 right_2))) (and (<= arg_left@0 i_43_1@@0) (<= i_43_1@@0 right_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_43@@0) (loc a_2@@1 i_43_1@@0))))
 :qid |stdinbpl.2639:31|
 :skolemid |200|
 :pattern ( (neverTriggered16 i_43@@0) (neverTriggered16 i_43_1@@0))
)) (and (=> (= (ControlFlow 0 60) (- 0 64)) (forall ((i_43@@1 Int) ) (!  (=> (and (<= arg_left@0 i_43@@1) (<= i_43@@1 right_2)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) (loc a_2@@1 i_43@@1) val) FullPerm))
 :qid |stdinbpl.2646:31|
 :skolemid |201|
 :pattern ( (loc a_2@@1 i_43@@1))
 :pattern ( (loc a_2@@1 i_43@@1))
))) (=> (forall ((i_43@@2 Int) ) (!  (=> (and (<= arg_left@0 i_43@@2) (<= i_43@@2 right_2)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) (loc a_2@@1 i_43@@2) val) FullPerm))
 :qid |stdinbpl.2646:31|
 :skolemid |201|
 :pattern ( (loc a_2@@1 i_43@@2))
 :pattern ( (loc a_2@@1 i_43@@2))
)) (=> (forall ((i_43@@3 Int) ) (!  (=> (and (and (<= arg_left@0 i_43@@3) (<= i_43@@3 right_2)) (< NoPerm FullPerm)) (and (qpRange16 (loc a_2@@1 i_43@@3)) (= (invRecv16 (loc a_2@@1 i_43@@3)) i_43@@3)))
 :qid |stdinbpl.2652:36|
 :skolemid |202|
 :pattern ( (loc a_2@@1 i_43@@3))
 :pattern ( (loc a_2@@1 i_43@@3))
)) (=> (and (forall ((o_9@@27 T@Ref) ) (!  (=> (and (and (<= arg_left@0 (invRecv16 o_9@@27)) (<= (invRecv16 o_9@@27) right_2)) (and (< NoPerm FullPerm) (qpRange16 o_9@@27))) (= (loc a_2@@1 (invRecv16 o_9@@27)) o_9@@27))
 :qid |stdinbpl.2656:36|
 :skolemid |203|
 :pattern ( (invRecv16 o_9@@27))
)) (forall ((o_9@@28 T@Ref) ) (!  (and (=> (and (and (<= arg_left@0 (invRecv16 o_9@@28)) (<= (invRecv16 o_9@@28) right_2)) (and (< NoPerm FullPerm) (qpRange16 o_9@@28))) (and (= (loc a_2@@1 (invRecv16 o_9@@28)) o_9@@28) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_9@@28 val) (- (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@28 val) FullPerm)))) (=> (not (and (and (<= arg_left@0 (invRecv16 o_9@@28)) (<= (invRecv16 o_9@@28) right_2)) (and (< NoPerm FullPerm) (qpRange16 o_9@@28)))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_9@@28 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@28 val))))
 :qid |stdinbpl.2662:36|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_9@@28 val))
))) (=> (and (and (and (and (and (and (forall ((o_9@@29 T@Ref) (f_5@@19 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@2) o_9@@29 f_5@@19) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@5) o_9@@29 f_5@@19)))
 :qid |stdinbpl.2668:43|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@5) o_9@@29 f_5@@19))
)) (forall ((o_9@@30 T@Ref) (f_5@@20 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@2) o_9@@30 f_5@@20) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@5) o_9@@30 f_5@@20)))
 :qid |stdinbpl.2668:43|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@5) o_9@@30 f_5@@20))
))) (forall ((o_9@@31 T@Ref) (f_5@@21 T@Field_34782_3612) ) (!  (=> (not (= f_5@@21 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@31 f_5@@21) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_9@@31 f_5@@21)))
 :qid |stdinbpl.2668:43|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_9@@31 f_5@@21))
))) (forall ((o_9@@32 T@Ref) (f_5@@22 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@2) o_9@@32 f_5@@22) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@5) o_9@@32 f_5@@22)))
 :qid |stdinbpl.2668:43|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@5) o_9@@32 f_5@@22))
))) (forall ((o_9@@33 T@Ref) (f_5@@23 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@2) o_9@@33 f_5@@23) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@5) o_9@@33 f_5@@23)))
 :qid |stdinbpl.2668:43|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@5) o_9@@33 f_5@@23))
))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@2 QPMask@5)) (and (<= arg_left@0 storeIndex@1) (<= storeIndex@1 right_2))) (and (=> (= (ControlFlow 0 60) (- 0 63)) (forall ((i_44 Int) (i_44_1 Int) ) (!  (=> (and (and (and (and (not (= i_44 i_44_1)) (and (<= arg_left@0 i_44) (<= i_44 right_2))) (and (<= arg_left@0 i_44_1) (<= i_44_1 right_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_44) (loc a_2@@1 i_44_1))))
 :qid |stdinbpl.2686:29|
 :skolemid |206|
))) (=> (forall ((i_44@@0 Int) (i_44_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_44@@0 i_44_1@@0)) (and (<= arg_left@0 i_44@@0) (<= i_44@@0 right_2))) (and (<= arg_left@0 i_44_1@@0) (<= i_44_1@@0 right_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_44@@0) (loc a_2@@1 i_44_1@@0))))
 :qid |stdinbpl.2686:29|
 :skolemid |206|
)) (=> (and (and (forall ((i_44@@1 Int) ) (!  (=> (and (and (<= arg_left@0 i_44@@1) (<= i_44@@1 right_2)) (< NoPerm FullPerm)) (and (qpRange17 (loc a_2@@1 i_44@@1)) (= (invRecv17 (loc a_2@@1 i_44@@1)) i_44@@1)))
 :qid |stdinbpl.2692:36|
 :skolemid |207|
 :pattern ( (loc a_2@@1 i_44@@1))
 :pattern ( (loc a_2@@1 i_44@@1))
)) (forall ((o_9@@34 T@Ref) ) (!  (=> (and (and (and (<= arg_left@0 (invRecv17 o_9@@34)) (<= (invRecv17 o_9@@34) right_2)) (< NoPerm FullPerm)) (qpRange17 o_9@@34)) (= (loc a_2@@1 (invRecv17 o_9@@34)) o_9@@34))
 :qid |stdinbpl.2696:36|
 :skolemid |208|
 :pattern ( (invRecv17 o_9@@34))
))) (and (forall ((i_44@@2 Int) ) (!  (=> (and (<= arg_left@0 i_44@@2) (<= i_44@@2 right_2)) (not (= (loc a_2@@1 i_44@@2) null)))
 :qid |stdinbpl.2702:36|
 :skolemid |209|
 :pattern ( (loc a_2@@1 i_44@@2))
 :pattern ( (loc a_2@@1 i_44@@2))
)) (forall ((o_9@@35 T@Ref) ) (!  (and (=> (and (and (and (<= arg_left@0 (invRecv17 o_9@@35)) (<= (invRecv17 o_9@@35) right_2)) (< NoPerm FullPerm)) (qpRange17 o_9@@35)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv17 o_9@@35)) o_9@@35)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@6) o_9@@35 val) (+ (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_9@@35 val) FullPerm)))) (=> (not (and (and (and (<= arg_left@0 (invRecv17 o_9@@35)) (<= (invRecv17 o_9@@35) right_2)) (< NoPerm FullPerm)) (qpRange17 o_9@@35))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@6) o_9@@35 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_9@@35 val))))
 :qid |stdinbpl.2708:36|
 :skolemid |210|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@6) o_9@@35 val))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@36 T@Ref) (f_5@@24 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@5) o_9@@36 f_5@@24) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@6) o_9@@36 f_5@@24)))
 :qid |stdinbpl.2712:43|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@5) o_9@@36 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@6) o_9@@36 f_5@@24))
)) (forall ((o_9@@37 T@Ref) (f_5@@25 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@5) o_9@@37 f_5@@25) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@6) o_9@@37 f_5@@25)))
 :qid |stdinbpl.2712:43|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@5) o_9@@37 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@6) o_9@@37 f_5@@25))
))) (forall ((o_9@@38 T@Ref) (f_5@@26 T@Field_34782_3612) ) (!  (=> (not (= f_5@@26 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_9@@38 f_5@@26) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@6) o_9@@38 f_5@@26)))
 :qid |stdinbpl.2712:43|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@5) o_9@@38 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@6) o_9@@38 f_5@@26))
))) (forall ((o_9@@39 T@Ref) (f_5@@27 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@5) o_9@@39 f_5@@27) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@6) o_9@@39 f_5@@27)))
 :qid |stdinbpl.2712:43|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@5) o_9@@39 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@6) o_9@@39 f_5@@27))
))) (forall ((o_9@@40 T@Ref) (f_5@@28 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@5) o_9@@40 f_5@@28) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@6) o_9@@40 f_5@@28)))
 :qid |stdinbpl.2712:43|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@5) o_9@@40 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@6) o_9@@40 f_5@@28))
))) (and (state ExhaleHeap@2 QPMask@6) (= storeIndex@1 n@@13))) (and (and (and (forall ((i_45 Int) ) (!  (=> (and (<= arg_left@0 i_45) (< i_45 storeIndex@1)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@2) (loc a_2@@1 i_45) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@2) (loc a_2@@1 storeIndex@1) val)))
 :qid |stdinbpl.2719:34|
 :skolemid |212|
 :pattern ( (loc a_2@@1 i_45))
)) (forall ((i_46 Int) ) (!  (=> (and (< storeIndex@1 i_46) (<= i_46 right_2)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@2) (loc a_2@@1 storeIndex@1) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@2) (loc a_2@@1 i_46) val)))
 :qid |stdinbpl.2723:34|
 :skolemid |213|
 :pattern ( (loc a_2@@1 i_46))
))) (and (= (|Seq#Length_3395| pwRec@1) (+ right_2 1)) (forall ((i_47 Int) ) (!  (=> (and (<= arg_left@0 i_47) (<= i_47 right_2)) (and (<= arg_left@0 (|Seq#Index_3395| pwRec@1 i_47)) (<= (|Seq#Index_3395| pwRec@1 i_47) right_2)))
 :qid |stdinbpl.2728:34|
 :skolemid |214|
 :pattern ( (|Seq#Index_3395| pwRec@1 i_47))
)))) (and (and (forall ((i_48 Int) (j_5 Int) ) (!  (=> (and (<= arg_left@0 i_48) (and (< i_48 j_5) (<= j_5 right_2))) (not (= (|Seq#Index_3395| pwRec@1 i_48) (|Seq#Index_3395| pwRec@1 j_5))))
 :qid |stdinbpl.2732:34|
 :skolemid |215|
 :pattern ( (|Seq#Index_3395| pwRec@1 i_48) (|Seq#Index_3395| pwRec@1 j_5))
)) (forall ((i_49 Int) ) (!  (=> (and (<= arg_left@0 i_49) (<= i_49 right_2)) (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@2) (loc a_2@@1 i_49) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 (|Seq#Index_3395| pwRec@1 i_49)) val)))
 :qid |stdinbpl.2736:34|
 :skolemid |216|
 :pattern ( (|Seq#Index_3395| pwRec@1 i_49))
))) (and (state ExhaleHeap@2 QPMask@6) (state ExhaleHeap@2 QPMask@6))))) (and (=> (= (ControlFlow 0 60) (- 0 62)) (>= storeIndex@1 0)) (=> (>= storeIndex@1 0) (and (=> (= (ControlFlow 0 60) (- 0 61)) (< storeIndex@1 (|Seq#Length_3395| pwRec@1))) (=> (< storeIndex@1 (|Seq#Length_3395| pwRec@1)) (and (=> (= (ControlFlow 0 60) 2) anon99_Then_correct) (=> (= (ControlFlow 0 60) 58) anon99_Else_correct))))))))))))))))))))))))))))))
...
(let ((anon91_Else_correct  (=> (not (= left right_2)) (=> (and (and (<= left pivotIndex) (<= pivotIndex right_2)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 104) (- 0 112)) (<= 0 left)) (=> (<= 0 left) (and (=> (= (ControlFlow 0 104) (- 0 111)) (< left right_2)) (=> (< left right_2) (and (=> (= (ControlFlow 0 104) (- 0 110)) (< right_2 (len a_2@@1))) (=> (< right_2 (len a_2@@1)) (and (=> (= (ControlFlow 0 104) (- 0 109)) (<= left pivotIndex)) (=> (<= left pivotIndex) (and (=> (= (ControlFlow 0 104) (- 0 108)) (<= pivotIndex right_2)) (=> (<= pivotIndex right_2) (and (=> (= (ControlFlow 0 104) (- 0 107)) (forall ((i_25_1 Int) (i_25_2 Int) ) (!  (=> (and (and (and (and (not (= i_25_1 i_25_2)) (and (<= left i_25_1) (<= i_25_1 right_2))) (and (<= left i_25_2) (<= i_25_2 right_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_25_1) (loc a_2@@1 i_25_2))))
 :qid |stdinbpl.2287:23|
 :skolemid |164|
 :pattern ( (neverTriggered12 i_25_1) (neverTriggered12 i_25_2))
 ...
 :qid |stdinbpl.2287:23|
 :skolemid |164|
 :pattern ( (neverTriggered12 i_25_1@@0) (neverTriggered12 i_25_2@@0))
)) (and (=> (= (ControlFlow 0 104) (- 0 106)) (forall ((i_25_1@@1 Int) ) (!  (=> (and (<= left i_25_1@@1) (<= i_25_1@@1 right_2)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) (loc a_2@@1 i_25_1@@1) val) FullPerm))
 :qid |stdinbpl.2294:23|
 :skolemid |165|
 :pattern ( (loc a_2@@1 i_25_1@@1))
 :pattern ( (loc a_2@@1 i_25_1@@1))
))) (=> (forall ((i_25_1@@2 Int) ) (!  (=> (and (<= left i_25_1@@2) (<= i_25_1@@2 right_2)) (>= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) (loc a_2@@1 i_25_1@@2) val) FullPerm))
 :qid |stdinbpl.2294:23|
 :skolemid |165|
 :pattern ( (loc a_2@@1 i_25_1@@2))
 :pattern ( (loc a_2@@1 i_25_1@@2))
)) (=> (forall ((i_25_1@@3 Int) ) (!  (=> (and (and (<= left i_25_1@@3) (<= i_25_1@@3 right_2)) (< NoPerm FullPerm)) (and (qpRange12 (loc a_2@@1 i_25_1@@3)) (= (invRecv12 (loc a_2@@1 i_25_1@@3)) i_25_1@@3)))
 :qid |stdinbpl.2300:28|
 :skolemid |166|
 :pattern ( (loc a_2@@1 i_25_1@@3))
 :pattern ( (loc a_2@@1 i_25_1@@3))
)) (=> (and (forall ((o_9@@41 T@Ref) ) (!  (=> (and (and (<= left (invRecv12 o_9@@41)) (<= (invRecv12 o_9@@41) right_2)) (and (< NoPerm FullPerm) (qpRange12 o_9@@41))) (= (loc a_2@@1 (invRecv12 o_9@@41)) o_9@@41))
 :qid |stdinbpl.2304:28|
 :skolemid |167|
 :pattern ( (invRecv12 o_9@@41))
)) (forall ((o_9@@42 T@Ref) ) (!  (and (=> (and (and (<= left (invRecv12 o_9@@42)) (<= (invRecv12 o_9@@42) right_2)) (and (< NoPerm FullPerm) (qpRange12 o_9@@42))) (and (= (loc a_2@@1 (invRecv12 o_9@@42)) o_9@@42) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_9@@42 val) (- (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_9@@42 val) FullPerm)))) (=> (not (and (and (<= left (invRecv12 o_9@@42)) (<= (invRecv12 o_9@@42) right_2)) (and (< NoPerm FullPerm) (qpRange12 o_9@@42)))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_9@@42 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_9@@42 val))))
 :qid |stdinbpl.2310:28|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_9@@42 val))
))) (=> (and (and (and (and (and (and (forall ((o_9@@43 T@Ref) (f_5@@29 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@0) o_9@@43 f_5@@29) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@1) o_9@@43 f_5@@29)))
 :qid |stdinbpl.2316:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@1) o_9@@43 f_5@@29))
)) (forall ((o_9@@44 T@Ref) (f_5@@30 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@0) o_9@@44 f_5@@30) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@1) o_9@@44 f_5@@30)))
 :qid |stdinbpl.2316:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@1) o_9@@44 f_5@@30))
))) (forall ((o_9@@45 T@Ref) (f_5@@31 T@Field_34782_3612) ) (!  (=> (not (= f_5@@31 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_9@@45 f_5@@31) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_9@@45 f_5@@31)))
 :qid |stdinbpl.2316:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_9@@45 f_5@@31))
))) (forall ((o_9@@46 T@Ref) (f_5@@32 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@0) o_9@@46 f_5@@32) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@1) o_9@@46 f_5@@32)))
 :qid |stdinbpl.2316:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@1) o_9@@46 f_5@@32))
))) (forall ((o_9@@47 T@Ref) (f_5@@33 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@0) o_9@@47 f_5@@33) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@1) o_9@@47 f_5@@33)))
 :qid |stdinbpl.2316:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@1) o_9@@47 f_5@@33))
))) (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@0 QPMask@1)) (and (<= left pivotIndex@0) (<= pivotIndex@0 right_2))) (and (=> (= (ControlFlow 0 104) (- 0 105)) (forall ((i_26_1 Int) (i_26_2 Int) ) (!  (=> (and (and (and (and (not (= i_26_1 i_26_2)) (and (<= left i_26_1) (<= i_26_1 right_2))) (and (<= left i_26_2) (<= i_26_2 right_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_26_1) (loc a_2@@1 i_26_2))))
 :qid |stdinbpl.2334:21|
 :skolemid |170|
))) (=> (forall ((i_26_1@@0 Int) (i_26_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_26_1@@0 i_26_2@@0)) (and (<= left i_26_1@@0) (<= i_26_1@@0 right_2))) (and (<= left i_26_2@@0) (<= i_26_2@@0 right_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_26_1@@0) (loc a_2@@1 i_26_2@@0))))
 :qid |stdinbpl.2334:21|
 :skolemid |170|
)) (=> (and (and (forall ((i_26_1@@1 Int) ) (!  (=> (and (and (<= left i_26_1@@1) (<= i_26_1@@1 right_2)) (< NoPerm FullPerm)) (and (qpRange13 (loc a_2@@1 i_26_1@@1)) (= (invRecv13 (loc a_2@@1 i_26_1@@1)) i_26_1@@1)))
 :qid |stdinbpl.2340:28|
 :skolemid |171|
 :pattern ( (loc a_2@@1 i_26_1@@1))
 :pattern ( (loc a_2@@1 i_26_1@@1))
)) (forall ((o_9@@48 T@Ref) ) (!  (=> (and (and (and (<= left (invRecv13 o_9@@48)) (<= (invRecv13 o_9@@48) right_2)) (< NoPerm FullPerm)) (qpRange13 o_9@@48)) (= (loc a_2@@1 (invRecv13 o_9@@48)) o_9@@48))
 :qid |stdinbpl.2344:28|
 :skolemid |172|
 :pattern ( (invRecv13 o_9@@48))
))) (and (forall ((i_26_1@@2 Int) ) (!  (=> (and (<= left i_26_1@@2) (<= i_26_1@@2 right_2)) (not (= (loc a_2@@1 i_26_1@@2) null)))
 :qid |stdinbpl.2350:28|
 :skolemid |173|
 :pattern ( (loc a_2@@1 i_26_1@@2))
 :pattern ( (loc a_2@@1 i_26_1@@2))
)) (forall ((o_9@@49 T@Ref) ) (!  (and (=> (and (and (and (<= left (invRecv13 o_9@@49)) (<= (invRecv13 o_9@@49) right_2)) (< NoPerm FullPerm)) (qpRange13 o_9@@49)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv13 o_9@@49)) o_9@@49)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@49 val) (+ (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_9@@49 val) FullPerm)))) (=> (not (and (and (and (<= left (invRecv13 o_9@@49)) (<= (invRecv13 o_9@@49) right_2)) (< NoPerm FullPerm)) (qpRange13 o_9@@49))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@49 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_9@@49 val))))
 :qid |stdinbpl.2356:28|
 :skolemid |174|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@49 val))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@50 T@Ref) (f_5@@34 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@1) o_9@@50 f_5@@34) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@2) o_9@@50 f_5@@34)))
 :qid |stdinbpl.2360:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@1) o_9@@50 f_5@@34))
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@2) o_9@@50 f_5@@34))
)) (forall ((o_9@@51 T@Ref) (f_5@@35 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@1) o_9@@51 f_5@@35) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@2) o_9@@51 f_5@@35)))
 :qid |stdinbpl.2360:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@1) o_9@@51 f_5@@35))
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@2) o_9@@51 f_5@@35))
))) (forall ((o_9@@52 T@Ref) (f_5@@36 T@Field_34782_3612) ) (!  (=> (not (= f_5@@36 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_9@@52 f_5@@36) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@52 f_5@@36)))
 :qid |stdinbpl.2360:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@1) o_9@@52 f_5@@36))
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@2) o_9@@52 f_5@@36))
))) (forall ((o_9@@53 T@Ref) (f_5@@37 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@1) o_9@@53 f_5@@37) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@2) o_9@@53 f_5@@37)))
 :qid |stdinbpl.2360:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@1) o_9@@53 f_5@@37))
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@2) o_9@@53 f_5@@37))
))) (forall ((o_9@@54 T@Ref) (f_5@@38 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@1) o_9@@54 f_5@@38) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@2) o_9@@54 f_5@@38)))
 :qid |stdinbpl.2360:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@1) o_9@@54 f_5@@38))
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@2) o_9@@54 f_5@@38))
))) (and (state ExhaleHeap@0 QPMask@2) (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 pivotIndex@0) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@@21) (loc a_2@@1 pivotIndex) val)))) (and (and (and (forall ((i_27_2 Int) ) (!  (=> (and (<= left i_27_2) (< i_27_2 pivotIndex@0)) (< (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 i_27_2) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 pivotIndex@0) val)))
 :qid |stdinbpl.2367:26|
 :skolemid |176|
 :pattern ( (loc a_2@@1 i_27_2))
)) (forall ((i_28 Int) ) (!  (=> (and (< pivotIndex@0 i_28) (<= i_28 right_2)) (<= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 pivotIndex@0) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 i_28) val)))
 :qid |stdinbpl.2371:26|
 :skolemid |177|
 :pattern ( (loc a_2@@1 i_28))
))) (and (= (|Seq#Length_3395| pwPar@0) (+ right_2 1)) (forall ((i_29 Int) ) (!  (=> (and (<= left i_29) (<= i_29 right_2)) (and (<= left (|Seq#Index_3395| pwPar@0 i_29)) (<= (|Seq#Index_3395| pwPar@0 i_29) right_2)))
 :qid |stdinbpl.2376:26|
 :skolemid |178|
 :pattern ( (|Seq#Index_3395| pwPar@0 i_29))
)))) (and (and (forall ((i_30 Int) (k Int) ) (!  (=> (and (<= left i_30) (and (< i_30 k) (<= k right_2))) (not (= (|Seq#Index_3395| pwPar@0 i_30) (|Seq#Index_3395| pwPar@0 k))))
 :qid |stdinbpl.2380:26|
 :skolemid |179|
 :pattern ( (|Seq#Index_3395| pwPar@0 i_30) (|Seq#Index_3395| pwPar@0 k))
)) (forall ((i_31 Int) ) (!  (=> (and (<= left i_31) (<= i_31 right_2)) (= (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| ExhaleHeap@0) (loc a_2@@1 i_31) val) (select (|PolymorphicMapType_28551_19693_3612#PolymorphicMapType_28551| Heap@@21) (loc a_2@@1 (|Seq#Index_3395| pwPar@0 i_31)) val)))
 :qid |stdinbpl.2384:26|
 :skolemid |180|
 :pattern ( (|Seq#Index_3395| pwPar@0 i_31))
...
(let ((anon77_Else_correct  (and (=> (= (ControlFlow 0 155) (- 0 156)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= left i_1) (<= i_1 right_2))) (and (<= left i_1_1) (<= i_1_1 right_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_1) (loc a_2@@1 i_1_1))))
 ...
 :qid |stdinbpl.2055:15|
 :skolemid |147|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= left i_1@@1) (<= i_1@@1 right_2)) (< NoPerm FullPerm)) (and (qpRange9 (loc a_2@@1 i_1@@1)) (= (invRecv9 (loc a_2@@1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.2061:22|
 :skolemid |148|
 :pattern ( (loc a_2@@1 i_1@@1))
 :pattern ( (loc a_2@@1 i_1@@1))
)) (forall ((o_9@@55 T@Ref) ) (!  (=> (and (and (and (<= left (invRecv9 o_9@@55)) (<= (invRecv9 o_9@@55) right_2)) (< NoPerm FullPerm)) (qpRange9 o_9@@55)) (= (loc a_2@@1 (invRecv9 o_9@@55)) o_9@@55))
 :qid |stdinbpl.2065:22|
 :skolemid |149|
 :pattern ( (invRecv9 o_9@@55))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= left i_1@@2) (<= i_1@@2 right_2)) (not (= (loc a_2@@1 i_1@@2) null)))
 :qid |stdinbpl.2071:22|
 :skolemid |150|
 :pattern ( (loc a_2@@1 i_1@@2))
 :pattern ( (loc a_2@@1 i_1@@2))
)) (forall ((o_9@@56 T@Ref) ) (!  (and (=> (and (and (and (<= left (invRecv9 o_9@@56)) (<= (invRecv9 o_9@@56) right_2)) (< NoPerm FullPerm)) (qpRange9 o_9@@56)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv9 o_9@@56)) o_9@@56)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_9@@56 val) (+ (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_9@@56 val) FullPerm)))) (=> (not (and (and (and (<= left (invRecv9 o_9@@56)) (<= (invRecv9 o_9@@56) right_2)) (< NoPerm FullPerm)) (qpRange9 o_9@@56))) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_9@@56 val) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_9@@56 val))))
 :qid |stdinbpl.2077:22|
 :skolemid |151|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_9@@56 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@57 T@Ref) (f_5@@39 T@Field_28611_53) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| ZeroMask) o_9@@57 f_5@@39) (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@0) o_9@@57 f_5@@39)))
 :qid |stdinbpl.2081:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| ZeroMask) o_9@@57 f_5@@39))
 :pattern ( (select (|PolymorphicMapType_28572_19693_53#PolymorphicMapType_28572| QPMask@0) o_9@@57 f_5@@39))
)) (forall ((o_9@@58 T@Ref) (f_5@@40 T@Field_28624_28625) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| ZeroMask) o_9@@58 f_5@@40) (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@0) o_9@@58 f_5@@40)))
 :qid |stdinbpl.2081:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| ZeroMask) o_9@@58 f_5@@40))
 :pattern ( (select (|PolymorphicMapType_28572_19693_28625#PolymorphicMapType_28572| QPMask@0) o_9@@58 f_5@@40))
))) (forall ((o_9@@59 T@Ref) (f_5@@41 T@Field_34782_3612) ) (!  (=> (not (= f_5@@41 val)) (= (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_9@@59 f_5@@41) (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_9@@59 f_5@@41)))
 :qid |stdinbpl.2081:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| ZeroMask) o_9@@59 f_5@@41))
 :pattern ( (select (|PolymorphicMapType_28572_19693_3612#PolymorphicMapType_28572| QPMask@0) o_9@@59 f_5@@41))
))) (forall ((o_9@@60 T@Ref) (f_5@@42 T@Field_19693_82618) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| ZeroMask) o_9@@60 f_5@@42) (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@0) o_9@@60 f_5@@42)))
 :qid |stdinbpl.2081:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| ZeroMask) o_9@@60 f_5@@42))
 :pattern ( (select (|PolymorphicMapType_28572_19693_82618#PolymorphicMapType_28572| QPMask@0) o_9@@60 f_5@@42))
))) (forall ((o_9@@61 T@Ref) (f_5@@43 T@Field_19693_82751) ) (!  (=> true (= (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| ZeroMask) o_9@@61 f_5@@43) (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@0) o_9@@61 f_5@@43)))
 :qid |stdinbpl.2081:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| ZeroMask) o_9@@61 f_5@@43))
 :pattern ( (select (|PolymorphicMapType_28572_19693_86873#PolymorphicMapType_28572| QPMask@0) o_9@@61 f_5@@43))
...
(let ((anon0_correct  (=> (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (<= 0 left)) (and (<= left right_2) (< right_2 (len a_2@@1)))) (and (and (state Heap@@21 ZeroMask) (<= left n@@13)) (and (<= n@@13 right_2) (state Heap@@21 ZeroMask)))) (and (=> (= (ControlFlow 0 157) 1) anon77_Then_correct) (=> (= (ControlFlow 0 157) 155) anon77_Else_correct))))))
