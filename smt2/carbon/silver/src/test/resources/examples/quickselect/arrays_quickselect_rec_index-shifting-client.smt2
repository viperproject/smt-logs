...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 28) (- 0 27)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (<= 0 i_5) (< i_5 (len_1 a_2@@1)))) (and (<= 0 i_5_1) (< i_5_1 (len_1 a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_5) (loc a_2@@1 i_5_1))))
 :qid |stdinbpl.3047:15|
 :skolemid |237|
)))))
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 25)) (< 10 (len_1 a_2@@1))) (=> (< 10 (len_1 a_2@@1)) (and (=> (= (ControlFlow 0 7) (- 0 24)) (forall ((i_7_1 Int) (i_7_2 Int) ) (!  (=> (and (and (and (and (not (= i_7_1 i_7_2)) (and (<= 0 i_7_1) (<= i_7_1 10))) (and (<= 0 i_7_2) (<= i_7_2 10))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_7_1) (loc a_2@@1 i_7_2))))
 :qid |stdinbpl.3100:19|
 :skolemid |243|
...
)) (and (=> (= (ControlFlow 0 7) (- 0 23)) (forall ((i_7_1@@1 Int) ) (!  (=> (and (<= 0 i_7_1@@1) (<= i_7_1@@1 10)) (>= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@0) (loc a_2@@1 i_7_1@@1) val) FullPerm))
 :qid |stdinbpl.3107:19|
 :skolemid |244|
 :pattern ( (loc a_2@@1 i_7_1@@1))
 :pattern ( (loc a_2@@1 i_7_1@@1))
))) (=> (forall ((i_7_1@@2 Int) ) (!  (=> (and (<= 0 i_7_1@@2) (<= i_7_1@@2 10)) (>= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@0) (loc a_2@@1 i_7_1@@2) val) FullPerm))
 :qid |stdinbpl.3107:19|
 :skolemid |244|
 ...
 :pattern ( (loc a_2@@1 i_7_1@@3))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv21 o_4)) (<= (invRecv21 o_4) 10)) (and (< NoPerm FullPerm) (qpRange21 o_4))) (= (loc a_2@@1 (invRecv21 o_4)) o_4))
 :qid |stdinbpl.3117:24|
 :skolemid |246|
 :pattern ( (invRecv21 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv21 o_4@@0)) (<= (invRecv21 o_4@@0) 10)) (and (< NoPerm FullPerm) (qpRange21 o_4@@0))) (and (= (loc a_2@@1 (invRecv21 o_4@@0)) o_4@@0) (= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@1) o_4@@0 val) (- (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@0) o_4@@0 val) FullPerm)))) (=> (not (and (and (<= 0 (invRecv21 o_4@@0)) (<= (invRecv21 o_4@@0) 10)) (and (< NoPerm FullPerm) (qpRange21 o_4@@0)))) (= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@1) o_4@@0 val) (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@0) o_4@@0 val))))
 :qid |stdinbpl.3123:24|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@1) o_4@@0 val))
))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_29417_53) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.3129:31|
 :skolemid |248|
 :pattern ( (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_29430_29431) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.3129:31|
 :skolemid |248|
 :pattern ( (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_35588_3612) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.3129:31|
 :skolemid |248|
 :pattern ( (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_20221_84854) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.3129:31|
 :skolemid |248|
 :pattern ( (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_20221_84987) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| QPMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.3129:31|
 :skolemid |248|
 :pattern ( (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| QPMask@1) o_4@@5 f_5@@3))
))) (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@0 QPMask@1)) (and (<= 0 storeIndex@0) (<= storeIndex@0 10))) (and (=> (= (ControlFlow 0 7) (- 0 22)) (forall ((i_8_2 Int) (i_8_3 Int) ) (!  (=> (and (and (and (and (not (= i_8_2 i_8_3)) (and (<= 0 i_8_2) (<= i_8_2 10))) (and (<= 0 i_8_3) (<= i_8_3 10))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_8_2) (loc a_2@@1 i_8_3))))
 :qid |stdinbpl.3147:17|
 :skolemid |249|
))) (=> (forall ((i_8_2@@0 Int) (i_8_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8_2@@0 i_8_3@@0)) (and (<= 0 i_8_2@@0) (<= i_8_2@@0 10))) (and (<= 0 i_8_3@@0) (<= i_8_3@@0 10))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_8_2@@0) (loc a_2@@1 i_8_3@@0))))
 :qid |stdinbpl.3147:17|
 :skolemid |249|
)) (=> (and (and (forall ((i_8_2@@1 Int) ) (!  (=> (and (and (<= 0 i_8_2@@1) (<= i_8_2@@1 10)) (< NoPerm FullPerm)) (and (qpRange22 (loc a_2@@1 i_8_2@@1)) (= (invRecv22 (loc a_2@@1 i_8_2@@1)) i_8_2@@1)))
 :qid |stdinbpl.3153:24|
 :skolemid |250|
 :pattern ( (loc a_2@@1 i_8_2@@1))
 :pattern ( (loc a_2@@1 i_8_2@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv22 o_4@@6)) (<= (invRecv22 o_4@@6) 10)) (< NoPerm FullPerm)) (qpRange22 o_4@@6)) (= (loc a_2@@1 (invRecv22 o_4@@6)) o_4@@6))
 :qid |stdinbpl.3157:24|
 :skolemid |251|
 :pattern ( (invRecv22 o_4@@6))
))) (and (forall ((i_8_2@@2 Int) ) (!  (=> (and (<= 0 i_8_2@@2) (<= i_8_2@@2 10)) (not (= (loc a_2@@1 i_8_2@@2) null)))
 :qid |stdinbpl.3163:24|
 :skolemid |252|
 :pattern ( (loc a_2@@1 i_8_2@@2))
 :pattern ( (loc a_2@@1 i_8_2@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv22 o_4@@7)) (<= (invRecv22 o_4@@7) 10)) (< NoPerm FullPerm)) (qpRange22 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv22 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@2) o_4@@7 val) (+ (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@1) o_4@@7 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv22 o_4@@7)) (<= (invRecv22 o_4@@7) 10)) (< NoPerm FullPerm)) (qpRange22 o_4@@7))) (= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@2) o_4@@7 val) (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@1) o_4@@7 val))))
 :qid |stdinbpl.3169:24|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@2) o_4@@7 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_29417_53) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| QPMask@1) o_4@@8 f_5@@4) (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| QPMask@2) o_4@@8 f_5@@4)))
 :qid |stdinbpl.3173:31|
 :skolemid |254|
 :pattern ( (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| QPMask@1) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| QPMask@2) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_29430_29431) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| QPMask@1) o_4@@9 f_5@@5) (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| QPMask@2) o_4@@9 f_5@@5)))
 :qid |stdinbpl.3173:31|
 :skolemid |254|
 :pattern ( (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| QPMask@1) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| QPMask@2) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_35588_3612) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@1) o_4@@10 f_5@@6) (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@2) o_4@@10 f_5@@6)))
 :qid |stdinbpl.3173:31|
 :skolemid |254|
 :pattern ( (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@1) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@2) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_20221_84854) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| QPMask@1) o_4@@11 f_5@@7) (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| QPMask@2) o_4@@11 f_5@@7)))
 :qid |stdinbpl.3173:31|
 :skolemid |254|
 :pattern ( (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| QPMask@1) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| QPMask@2) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_20221_84987) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| QPMask@1) o_4@@12 f_5@@8) (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| QPMask@2) o_4@@12 f_5@@8)))
 :qid |stdinbpl.3173:31|
 :skolemid |254|
 :pattern ( (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| QPMask@1) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| QPMask@2) o_4@@12 f_5@@8))
))) (and (state ExhaleHeap@0 QPMask@2) (= storeIndex@0 3))) (and (and (and (forall ((i_9_1 Int) ) (!  (=> (and (<= 0 i_9_1) (< i_9_1 storeIndex@0)) (<= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| ExhaleHeap@0) (loc a_2@@1 i_9_1) val) (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| ExhaleHeap@0) (loc a_2@@1 storeIndex@0) val)))
 :qid |stdinbpl.3180:22|
 :skolemid |255|
 :pattern ( (loc a_2@@1 i_9_1))
)) (forall ((i_10_1 Int) ) (!  (=> (and (< storeIndex@0 i_10_1) (<= i_10_1 10)) (<= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| ExhaleHeap@0) (loc a_2@@1 storeIndex@0) val) (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| ExhaleHeap@0) (loc a_2@@1 i_10_1) val)))
 :qid |stdinbpl.3184:22|
 :skolemid |256|
 :pattern ( (loc a_2@@1 i_10_1))
))) (and (= (|Seq#Length_3395| pw@0) 11) (forall ((i_11_1 Int) ) (!  (=> (and (<= 0 i_11_1) (< i_11_1 (|Seq#Length_3395| pw@0))) (and (<= 0 (|Seq#Index_3395| pw@0 i_11_1)) (<= (|Seq#Index_3395| pw@0 i_11_1) 10)))
 :qid |stdinbpl.3189:22|
 :skolemid |257|
 :pattern ( (|Seq#Index_3395| pw@0 i_11_1))
)))) (and (and (forall ((i_12_1 Int) (j_9 Int) ) (!  (=> (and (<= 0 i_12_1) (and (< i_12_1 j_9) (< j_9 (|Seq#Length_3395| pw@0)))) (not (= (|Seq#Index_3395| pw@0 i_12_1) (|Seq#Index_3395| pw@0 j_9))))
 :qid |stdinbpl.3193:22|
 :skolemid |258|
 :pattern ( (|Seq#Index_3395| pw@0 i_12_1) (|Seq#Index_3395| pw@0 j_9))
)) (forall ((i_13_1 Int) ) (!  (=> (and (<= 0 i_13_1) (< i_13_1 (|Seq#Length_3395| pw@0))) (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| ExhaleHeap@0) (loc a_2@@1 (+ 0 i_13_1)) val) (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 (|Seq#Index_3395| pw@0 i_13_1)) val)))
 :qid |stdinbpl.3197:22|
 :skolemid |259|
 :pattern ( (|Seq#Index_3395| pw@0 i_13_1))
))) (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2))))) (and (=> (= (ControlFlow 0 7) (- 0 21)) (= storeIndex@0 3)) (=> (= storeIndex@0 3) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 20)) (HasDirectPerm_20221_3612 QPMask@2 (loc a_2@@1 storeIndex@0) val)) (=> (HasDirectPerm_20221_3612 QPMask@2 (loc a_2@@1 storeIndex@0) val) (and (=> (= (ControlFlow 0 7) (- 0 19)) (>= storeIndex@0 0)) (=> (>= storeIndex@0 0) (and (=> (= (ControlFlow 0 7) (- 0 18)) (< storeIndex@0 (|Seq#Length_3395| pw@0))) (=> (< storeIndex@0 (|Seq#Length_3395| pw@0)) (and (=> (= (ControlFlow 0 7) (- 0 17)) (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 (|Seq#Index_3395| pw@0 storeIndex@0)) val)) (=> (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 (|Seq#Index_3395| pw@0 storeIndex@0)) val) (and (=> (= (ControlFlow 0 7) (- 0 16)) (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| ExhaleHeap@0) (loc a_2@@1 storeIndex@0) val) (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 (|Seq#Index_3395| pw@0 storeIndex@0)) val))) (=> (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| ExhaleHeap@0) (loc a_2@@1 storeIndex@0) val) (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 (|Seq#Index_3395| pw@0 storeIndex@0)) val)) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 15)) (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 0) val)) (=> (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 0) val) (and (=> (= (ControlFlow 0 7) (- 0 14)) (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 0) val) 0)) (=> (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 0) val) 0) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 13)) (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 3) val)) (=> (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 3) val) (and (=> (= (ControlFlow 0 7) (- 0 12)) (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 3) val) 3)) (=> (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 3) val) 3) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 11)) (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 2) val)) (=> (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 2) val) (and (=> (= (ControlFlow 0 7) (- 0 10)) (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 3) val)) (=> (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 3) val) (and (=> (= (ControlFlow 0 7) (- 0 9)) (not (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 2) val) (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 3) val)))) (=> (not (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 2) val) (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 3) val))) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_6_1 Int) (i_6_2 Int) ) (!  (=> (and (and (and (and (not (= i_6_1 i_6_2)) (and (<= 0 i_6_1) (< i_6_1 (len_1 a_2@@1)))) (and (<= 0 i_6_2) (< i_6_2 (len_1 a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_6_1) (loc a_2@@1 i_6_2))))
 :qid |stdinbpl.3273:17|
 :skolemid |260|
 :pattern ( (neverTriggered20 i_6_1) (neverTriggered20 i_6_2))
 ...
 :qid |stdinbpl.3273:17|
 :skolemid |260|
 :pattern ( (neverTriggered20 i_6_1@@0) (neverTriggered20 i_6_2@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_6_1@@1 Int) ) (!  (=> (and (<= 0 i_6_1@@1) (< i_6_1@@1 (len_1 a_2@@1))) (>= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@2) (loc a_2@@1 i_6_1@@1) val) FullPerm))
 :qid |stdinbpl.3280:17|
 :skolemid |261|
 :pattern ( (loc a_2@@1 i_6_1@@1))
 :pattern ( (loc a_2@@1 i_6_1@@1))
)))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon12_Else_correct  (=> (and (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (<= i_3 10)) (= (select (|PolymorphicMapType_29357_20221_3612#PolymorphicMapType_29357| Heap@@21) (loc a_2@@1 i_3) val) i_3))
 :qid |stdinbpl.3024:20|
 :skolemid |236|
...
(let ((anon13_Else_correct  (=> (and (not (and (<= 0 i_43) (<= i_43 10))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (and (<= 0 i_43) (<= i_43 10)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 i_43) val)) (=> (HasDirectPerm_20221_3612 QPMask@0 (loc a_2@@1 i_43) val) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len_1 a_2@@1)))) (and (<= 0 i_1_1) (< i_1_1 (len_1 a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_1) (loc a_2@@1 i_1_1))))
 :qid |stdinbpl.2982:15|
 :skolemid |230|
 ...
 :qid |stdinbpl.2982:15|
 :skolemid |230|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (len_1 a_2@@1))) (< NoPerm FullPerm)) (and (qpRange18 (loc a_2@@1 i_1@@1)) (= (invRecv18 (loc a_2@@1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.2988:22|
 :skolemid |231|
 :pattern ( (loc a_2@@1 i_1@@1))
 :pattern ( (loc a_2@@1 i_1@@1))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv18 o_4@@13)) (< (invRecv18 o_4@@13) (len_1 a_2@@1))) (< NoPerm FullPerm)) (qpRange18 o_4@@13)) (= (loc a_2@@1 (invRecv18 o_4@@13)) o_4@@13))
 :qid |stdinbpl.2992:22|
 :skolemid |232|
 :pattern ( (invRecv18 o_4@@13))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (len_1 a_2@@1))) (not (= (loc a_2@@1 i_1@@2) null)))
 :qid |stdinbpl.2998:22|
 :skolemid |233|
 :pattern ( (loc a_2@@1 i_1@@2))
 :pattern ( (loc a_2@@1 i_1@@2))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv18 o_4@@14)) (< (invRecv18 o_4@@14) (len_1 a_2@@1))) (< NoPerm FullPerm)) (qpRange18 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv18 o_4@@14)) o_4@@14)) (= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@0) o_4@@14 val) (+ (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| ZeroMask) o_4@@14 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv18 o_4@@14)) (< (invRecv18 o_4@@14) (len_1 a_2@@1))) (< NoPerm FullPerm)) (qpRange18 o_4@@14))) (= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@0) o_4@@14 val) (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| ZeroMask) o_4@@14 val))))
 :qid |stdinbpl.3004:22|
 :skolemid |234|
 :pattern ( (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@0) o_4@@14 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_29417_53) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| ZeroMask) o_4@@15 f_5@@9) (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| QPMask@0) o_4@@15 f_5@@9)))
 :qid |stdinbpl.3008:29|
 :skolemid |235|
 :pattern ( (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| ZeroMask) o_4@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_29378_20221_53#PolymorphicMapType_29378| QPMask@0) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_29430_29431) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| ZeroMask) o_4@@16 f_5@@10) (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| QPMask@0) o_4@@16 f_5@@10)))
 :qid |stdinbpl.3008:29|
 :skolemid |235|
 :pattern ( (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| ZeroMask) o_4@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_29378_20221_29431#PolymorphicMapType_29378| QPMask@0) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_35588_3612) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| ZeroMask) o_4@@17 f_5@@11) (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@0) o_4@@17 f_5@@11)))
 :qid |stdinbpl.3008:29|
 :skolemid |235|
 :pattern ( (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| ZeroMask) o_4@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_29378_20221_3612#PolymorphicMapType_29378| QPMask@0) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_20221_84854) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| ZeroMask) o_4@@18 f_5@@12) (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| QPMask@0) o_4@@18 f_5@@12)))
 :qid |stdinbpl.3008:29|
 :skolemid |235|
 :pattern ( (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| ZeroMask) o_4@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_29378_20221_84854#PolymorphicMapType_29378| QPMask@0) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_20221_84987) ) (!  (=> true (= (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| ZeroMask) o_4@@19 f_5@@13) (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| QPMask@0) o_4@@19 f_5@@13)))
 :qid |stdinbpl.3008:29|
 :skolemid |235|
 :pattern ( (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| ZeroMask) o_4@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_29378_20221_89109#PolymorphicMapType_29378| QPMask@0) o_4@@19 f_5@@13))
...
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (< 10 (len_1 a_2@@1)) (state Heap@@21 ZeroMask))) (and (=> (= (ControlFlow 0 33) 1) anon11_Then_correct) (=> (= (ControlFlow 0 33) 31) anon11_Else_correct))))))
