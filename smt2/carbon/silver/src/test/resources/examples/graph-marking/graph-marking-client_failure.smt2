...
(let ((anon34_Else_correct  (=> (and (not (select nodes@0 n_96)) (= (ControlFlow 0 21) 18)) anon19_correct)))
(let ((anon34_Then_correct  (=> (select nodes@0 n_96) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm_17242_4009 QPMask@5 n_96 is_marked)) (=> (HasDirectPerm_17242_4009 QPMask@5 n_96 is_marked) (=> (= (ControlFlow 0 19) 18) anon19_correct))))))
...
(let ((anon31_Else_correct  (=> (forall ((n$3_1_1_1 T@Ref) ) (!  (=> (and (select nodes@0 n$3_1_1_1) (not (= (select (|PolymorphicMapType_27089_16818_16819#PolymorphicMapType_27089| Heap@7) n$3_1_1_1 right_1) null))) (select nodes@0 (select (|PolymorphicMapType_27089_16818_16819#PolymorphicMapType_27089| Heap@7) n$3_1_1_1 right_1)))
 ...
 :qid |stdinbpl.2595:17|
 :skolemid |310|
)) (=> (and (and (forall ((n$4_10@@1 T@Ref) ) (!  (=> (and (select nodes@0 n$4_10@@1) (< NoPerm FullPerm)) (and (qpRange31 n$4_10@@1) (= (invRecv31 n$4_10@@1) n$4_10@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select nodes@0 (invRecv31 o_9)) (< NoPerm FullPerm)) (qpRange31 o_9)) (= (invRecv31 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select nodes@0 (invRecv31 o_9@@0)) (< NoPerm FullPerm)) (qpRange31 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv31 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@3) o_9@@0 left_2) (+ (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@2) o_9@@0 left_2) FullPerm)))) (=> (not (and (and (select nodes@0 (invRecv31 o_9@@0)) (< NoPerm FullPerm)) (qpRange31 o_9@@0))) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@3) o_9@@0 left_2) (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@2) o_9@@0 left_2))))
 ...
 :qid |stdinbpl.2629:17|
 :skolemid |316|
)) (=> (and (and (forall ((n$5_8@@1 T@Ref) ) (!  (=> (and (select nodes@0 n$5_8@@1) (< NoPerm FullPerm)) (and (qpRange32 n$5_8@@1) (= (invRecv32 n$5_8@@1) n$5_8@@1)))
...
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select nodes@0 (invRecv32 o_9@@5)) (< NoPerm FullPerm)) (qpRange32 o_9@@5)) (= (invRecv32 o_9@@5) o_9@@5))
...
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select nodes@0 (invRecv32 o_9@@6)) (< NoPerm FullPerm)) (qpRange32 o_9@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv32 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@4) o_9@@6 right_1) (+ (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@3) o_9@@6 right_1) FullPerm)))) (=> (not (and (and (select nodes@0 (invRecv32 o_9@@6)) (< NoPerm FullPerm)) (qpRange32 o_9@@6))) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@4) o_9@@6 right_1) (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@3) o_9@@6 right_1))))
 ...
 :qid |stdinbpl.2663:17|
 :skolemid |322|
)) (=> (and (and (forall ((n$6_11@@1 T@Ref) ) (!  (=> (and (select nodes@0 n$6_11@@1) (< NoPerm FullPerm)) (and (qpRange33 n$6_11@@1) (= (invRecv33 n$6_11@@1) n$6_11@@1)))
...
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (and (select nodes@0 (invRecv33 o_9@@11)) (< NoPerm FullPerm)) (qpRange33 o_9@@11)) (= (invRecv33 o_9@@11) o_9@@11))
 :qid |stdinbpl.2673:24|
 :skolemid |324|
 :pattern ( (invRecv33 o_9@@11))
...
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (and (select nodes@0 (invRecv33 o_9@@12)) (< NoPerm FullPerm)) (qpRange33 o_9@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv33 o_9@@12) o_9@@12)) (= (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@5) o_9@@12 is_marked) (+ (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@4) o_9@@12 is_marked) FullPerm)))) (=> (not (and (and (select nodes@0 (invRecv33 o_9@@12)) (< NoPerm FullPerm)) (qpRange33 o_9@@12))) (= (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@5) o_9@@12 is_marked) (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@4) o_9@@12 is_marked))))
...
(let ((anon27_Else_correct  (=> (and (forall ((n_2_1_1 T@Ref) ) (!  (=> (select nodes@0 n_2_1_1) (not (select (|PolymorphicMapType_27089_16815_53#PolymorphicMapType_27089| Heap@7) n_2_1_1 is_marked)))
...
)) (=> (forall ((n_3@@3 T@Ref) ) (!  (=> (and (select nodes@0 n_3@@3) (< NoPerm FullPerm)) (and (qpRange28 n_3@@3) (= (invRecv28 n_3@@3) n_3@@3)))
...
)) (=> (and (forall ((o_9@@17 T@Ref) ) (!  (=> (and (select nodes@0 (invRecv28 o_9@@17)) (and (< NoPerm FullPerm) (qpRange28 o_9@@17))) (= (invRecv28 o_9@@17) o_9@@17))
 :qid |stdinbpl.2462:24|
 :skolemid |293|
 :pattern ( (invRecv28 o_9@@17))
)) (forall ((o_9@@18 T@Ref) ) (!  (and (=> (and (select nodes@0 (invRecv28 o_9@@18)) (and (< NoPerm FullPerm) (qpRange28 o_9@@18))) (and (= (invRecv28 o_9@@18) o_9@@18) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@0) o_9@@18 left_2) (- (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| Mask@5) o_9@@18 left_2) FullPerm)))) (=> (not (and (select nodes@0 (invRecv28 o_9@@18)) (and (< NoPerm FullPerm) (qpRange28 o_9@@18)))) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@0) o_9@@18 left_2) (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| Mask@5) o_9@@18 left_2))))
 ...
 :skolemid |296|
 :pattern ( (neverTriggered29 n$0_14) (neverTriggered29 n$0_37))
 ...
 :qid |stdinbpl.2486:19|
 :skolemid |296|
 :pattern ( (neverTriggered29 n$0_14@@0) (neverTriggered29 n$0_37@@0))
...
)) (=> (forall ((n$0_14@@3 T@Ref) ) (!  (=> (and (select nodes@0 n$0_14@@3) (< NoPerm FullPerm)) (and (qpRange29 n$0_14@@3) (= (invRecv29 n$0_14@@3) n$0_14@@3)))
...
)) (=> (and (forall ((o_9@@23 T@Ref) ) (!  (=> (and (select nodes@0 (invRecv29 o_9@@23)) (and (< NoPerm FullPerm) (qpRange29 o_9@@23))) (= (invRecv29 o_9@@23) o_9@@23))
 :qid |stdinbpl.2503:24|
 :skolemid |299|
 :pattern ( (invRecv29 o_9@@23))
)) (forall ((o_9@@24 T@Ref) ) (!  (and (=> (and (select nodes@0 (invRecv29 o_9@@24)) (and (< NoPerm FullPerm) (qpRange29 o_9@@24))) (and (= (invRecv29 o_9@@24) o_9@@24) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@1) o_9@@24 right_1) (- (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@0) o_9@@24 right_1) FullPerm)))) (=> (not (and (select nodes@0 (invRecv29 o_9@@24)) (and (< NoPerm FullPerm) (qpRange29 o_9@@24)))) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@1) o_9@@24 right_1) (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@0) o_9@@24 right_1))))
...
)) (=> (forall ((n$1@@3 T@Ref) ) (!  (=> (and (select nodes@0 n$1@@3) (< NoPerm FullPerm)) (and (qpRange30 n$1@@3) (= (invRecv30 n$1@@3) n$1@@3)))
...
)) (=> (and (forall ((o_9@@29 T@Ref) ) (!  (=> (and (select nodes@0 (invRecv30 o_9@@29)) (and (< NoPerm FullPerm) (qpRange30 o_9@@29))) (= (invRecv30 o_9@@29) o_9@@29))
 :qid |stdinbpl.2544:24|
 :skolemid |305|
 :pattern ( (invRecv30 o_9@@29))
)) (forall ((o_9@@30 T@Ref) ) (!  (and (=> (and (select nodes@0 (invRecv30 o_9@@30)) (and (< NoPerm FullPerm) (qpRange30 o_9@@30))) (and (= (invRecv30 o_9@@30) o_9@@30) (= (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@2) o_9@@30 is_marked) (- (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@1) o_9@@30 is_marked) FullPerm)))) (=> (not (and (select nodes@0 (invRecv30 o_9@@30)) (and (< NoPerm FullPerm) (qpRange30 o_9@@30)))) (= (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@2) o_9@@30 is_marked) (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@1) o_9@@30 is_marked))))
