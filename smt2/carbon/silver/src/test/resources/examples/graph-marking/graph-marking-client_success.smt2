...
(let ((anon34_Else_correct  (=> (and (not (select nodes_1@0 n_81)) (= (ControlFlow 0 21) 18)) anon19_correct)))
(let ((anon34_Then_correct  (=> (select nodes_1@0 n_81) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm_17242_4009 QPMask@5 n_81 is_marked)) (=> (HasDirectPerm_17242_4009 QPMask@5 n_81 is_marked) (=> (= (ControlFlow 0 19) 18) anon19_correct))))))
...
(let ((anon31_Else_correct  (=> (forall ((n$3_1_1 T@Ref) ) (!  (=> (and (select nodes_1@0 n$3_1_1) (not (= (select (|PolymorphicMapType_27089_16818_16819#PolymorphicMapType_27089| Heap@7) n$3_1_1 right_1) null))) (select nodes_1@0 (select (|PolymorphicMapType_27089_16818_16819#PolymorphicMapType_27089| Heap@7) n$3_1_1 right_1)))
 ...
 :qid |stdinbpl.2143:17|
 :skolemid |263|
)) (=> (and (and (forall ((n$4@@1 T@Ref) ) (!  (=> (and (select nodes_1@0 n$4@@1) (< NoPerm FullPerm)) (and (qpRange25 n$4@@1) (= (invRecv25 n$4@@1) n$4@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select nodes_1@0 (invRecv25 o_4)) (< NoPerm FullPerm)) (qpRange25 o_4)) (= (invRecv25 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select nodes_1@0 (invRecv25 o_4@@0)) (< NoPerm FullPerm)) (qpRange25 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv25 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@3) o_4@@0 left) (+ (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@2) o_4@@0 left) FullPerm)))) (=> (not (and (and (select nodes_1@0 (invRecv25 o_4@@0)) (< NoPerm FullPerm)) (qpRange25 o_4@@0))) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@3) o_4@@0 left) (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@2) o_4@@0 left))))
 ...
 :qid |stdinbpl.2177:17|
 :skolemid |269|
)) (=> (and (and (forall ((n$5_8@@1 T@Ref) ) (!  (=> (and (select nodes_1@0 n$5_8@@1) (< NoPerm FullPerm)) (and (qpRange26 n$5_8@@1) (= (invRecv26 n$5_8@@1) n$5_8@@1)))
...
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select nodes_1@0 (invRecv26 o_4@@5)) (< NoPerm FullPerm)) (qpRange26 o_4@@5)) (= (invRecv26 o_4@@5) o_4@@5))
 :qid |stdinbpl.2187:24|
 :skolemid |271|
 :pattern ( (invRecv26 o_4@@5))
...
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (and (select nodes_1@0 (invRecv26 o_4@@6)) (< NoPerm FullPerm)) (qpRange26 o_4@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv26 o_4@@6) o_4@@6)) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@4) o_4@@6 right_1) (+ (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@3) o_4@@6 right_1) FullPerm)))) (=> (not (and (and (select nodes_1@0 (invRecv26 o_4@@6)) (< NoPerm FullPerm)) (qpRange26 o_4@@6))) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@4) o_4@@6 right_1) (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@3) o_4@@6 right_1))))
 ...
 :qid |stdinbpl.2211:17|
 :skolemid |275|
)) (=> (and (and (forall ((n$6_11@@1 T@Ref) ) (!  (=> (and (select nodes_1@0 n$6_11@@1) (< NoPerm FullPerm)) (and (qpRange27 n$6_11@@1) (= (invRecv27 n$6_11@@1) n$6_11@@1)))
...
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (select nodes_1@0 (invRecv27 o_4@@11)) (< NoPerm FullPerm)) (qpRange27 o_4@@11)) (= (invRecv27 o_4@@11) o_4@@11))
 :qid |stdinbpl.2221:24|
 :skolemid |277|
 :pattern ( (invRecv27 o_4@@11))
...
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (select nodes_1@0 (invRecv27 o_4@@12)) (< NoPerm FullPerm)) (qpRange27 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv27 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@5) o_4@@12 is_marked) (+ (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@4) o_4@@12 is_marked) FullPerm)))) (=> (not (and (and (select nodes_1@0 (invRecv27 o_4@@12)) (< NoPerm FullPerm)) (qpRange27 o_4@@12))) (= (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@5) o_4@@12 is_marked) (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@4) o_4@@12 is_marked))))
...
(let ((anon27_Else_correct  (=> (and (forall ((n_2_1_1 T@Ref) ) (!  (=> (select nodes_1@0 n_2_1_1) (not (select (|PolymorphicMapType_27089_16815_53#PolymorphicMapType_27089| Heap@7) n_2_1_1 is_marked)))
...
)) (=> (forall ((n_3@@3 T@Ref) ) (!  (=> (and (select nodes_1@0 n_3@@3) (< NoPerm FullPerm)) (and (qpRange22 n_3@@3) (= (invRecv22 n_3@@3) n_3@@3)))
...
)) (=> (and (forall ((o_4@@17 T@Ref) ) (!  (=> (and (select nodes_1@0 (invRecv22 o_4@@17)) (and (< NoPerm FullPerm) (qpRange22 o_4@@17))) (= (invRecv22 o_4@@17) o_4@@17))
 :qid |stdinbpl.2010:24|
 :skolemid |246|
 :pattern ( (invRecv22 o_4@@17))
)) (forall ((o_4@@18 T@Ref) ) (!  (and (=> (and (select nodes_1@0 (invRecv22 o_4@@18)) (and (< NoPerm FullPerm) (qpRange22 o_4@@18))) (and (= (invRecv22 o_4@@18) o_4@@18) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@0) o_4@@18 left) (- (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| Mask@5) o_4@@18 left) FullPerm)))) (=> (not (and (select nodes_1@0 (invRecv22 o_4@@18)) (and (< NoPerm FullPerm) (qpRange22 o_4@@18)))) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@0) o_4@@18 left) (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| Mask@5) o_4@@18 left))))
 ...
 :skolemid |249|
 :pattern ( (neverTriggered23 n$0_13) (neverTriggered23 n$0_42))
 ...
 :qid |stdinbpl.2034:19|
 :skolemid |249|
 :pattern ( (neverTriggered23 n$0_13@@0) (neverTriggered23 n$0_42@@0))
...
)) (=> (forall ((n$0_13@@3 T@Ref) ) (!  (=> (and (select nodes_1@0 n$0_13@@3) (< NoPerm FullPerm)) (and (qpRange23 n$0_13@@3) (= (invRecv23 n$0_13@@3) n$0_13@@3)))
...
)) (=> (and (forall ((o_4@@23 T@Ref) ) (!  (=> (and (select nodes_1@0 (invRecv23 o_4@@23)) (and (< NoPerm FullPerm) (qpRange23 o_4@@23))) (= (invRecv23 o_4@@23) o_4@@23))
 :qid |stdinbpl.2051:24|
 :skolemid |252|
 :pattern ( (invRecv23 o_4@@23))
)) (forall ((o_4@@24 T@Ref) ) (!  (and (=> (and (select nodes_1@0 (invRecv23 o_4@@24)) (and (< NoPerm FullPerm) (qpRange23 o_4@@24))) (and (= (invRecv23 o_4@@24) o_4@@24) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@1) o_4@@24 right_1) (- (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@0) o_4@@24 right_1) FullPerm)))) (=> (not (and (select nodes_1@0 (invRecv23 o_4@@24)) (and (< NoPerm FullPerm) (qpRange23 o_4@@24)))) (= (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@1) o_4@@24 right_1) (select (|PolymorphicMapType_27110_17236_17237#PolymorphicMapType_27110| QPMask@0) o_4@@24 right_1))))
 ...
 :skolemid |255|
 :pattern ( (neverTriggered24 n$1_12) (neverTriggered24 n$1_24))
 ...
 :qid |stdinbpl.2075:19|
 :skolemid |255|
 :pattern ( (neverTriggered24 n$1_12@@0) (neverTriggered24 n$1_24@@0))
...
)) (=> (forall ((n$1_12@@3 T@Ref) ) (!  (=> (and (select nodes_1@0 n$1_12@@3) (< NoPerm FullPerm)) (and (qpRange24 n$1_12@@3) (= (invRecv24 n$1_12@@3) n$1_12@@3)))
...
)) (=> (and (forall ((o_4@@29 T@Ref) ) (!  (=> (and (select nodes_1@0 (invRecv24 o_4@@29)) (and (< NoPerm FullPerm) (qpRange24 o_4@@29))) (= (invRecv24 o_4@@29) o_4@@29))
 :qid |stdinbpl.2092:24|
 :skolemid |258|
 :pattern ( (invRecv24 o_4@@29))
)) (forall ((o_4@@30 T@Ref) ) (!  (and (=> (and (select nodes_1@0 (invRecv24 o_4@@30)) (and (< NoPerm FullPerm) (qpRange24 o_4@@30))) (and (= (invRecv24 o_4@@30) o_4@@30) (= (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@2) o_4@@30 is_marked) (- (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@1) o_4@@30 is_marked) FullPerm)))) (=> (not (and (select nodes_1@0 (invRecv24 o_4@@30)) (and (< NoPerm FullPerm) (qpRange24 o_4@@30)))) (= (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@2) o_4@@30 is_marked) (select (|PolymorphicMapType_27110_17242_4009#PolymorphicMapType_27110| QPMask@1) o_4@@30 is_marked))))
