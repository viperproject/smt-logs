...
(let ((anon71_Else_correct  (=> (and (not (and (<= 0 j$2) (< j$2 (len a_2@@1)))) (= (ControlFlow 0 90) 86)) anon15_correct)))
(let ((anon71_Then_correct  (=> (and (<= 0 j$2) (< j$2 (len a_2@@1))) (and (=> (= (ControlFlow 0 87) (- 0 89)) (HasDirectPerm_7620_1545 QPMask@7 (loc a_2@@1 j$2) val)) (=> (HasDirectPerm_7620_1545 QPMask@7 (loc a_2@@1 j$2) val) (and (=> (= (ControlFlow 0 87) (- 0 88)) (HasDirectPerm_7620_1545 QPMask@7 (loc a_2@@1 at_1) val)) (=> (HasDirectPerm_7620_1545 QPMask@7 (loc a_2@@1 at_1) val) (=> (= (ControlFlow 0 87) 86) anon15_correct))))))))
...
(let ((anon69_Else_correct  (=> (and (and (not (= (len a_2@@1) 0)) (<= 0 at_1)) (and (< at_1 (len a_2@@1)) (= (ControlFlow 0 93) 91))) anon12_correct)))
(let ((anon69_Then_correct  (=> (= (len a_2@@1) 0) (=> (and (= at_1 (- 0 1)) (= (ControlFlow 0 92) 91)) anon12_correct))))
(let ((anon67_Else_correct  (=> (and (forall ((j$1_1 Int) ) (!  (=> (and (<= 0 j$1_1) (< j$1_1 (len a_2@@1))) (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| PostHeap@0) (loc a_2@@1 j$1_1) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$1_1) val)))
 :qid |stdinbpl.396:20|
 :skolemid |36|
...
(let ((anon68_Else_correct  (=> (and (not (and (<= 0 j$1) (< j$1 (len a_2@@1)))) (= (ControlFlow 0 84) 80)) anon8_correct)))
(let ((anon68_Then_correct  (=> (and (<= 0 j$1) (< j$1 (len a_2@@1))) (and (=> (= (ControlFlow 0 81) (- 0 83)) (HasDirectPerm_7620_1545 QPMask@7 (loc a_2@@1 j$1) val)) (=> (HasDirectPerm_7620_1545 QPMask@7 (loc a_2@@1 j$1) val) (and (=> (= (ControlFlow 0 81) (- 0 82)) (HasDirectPerm_7620_1545 QPMask@0 (loc a_2@@1 j$1) val)) (=> (HasDirectPerm_7620_1545 QPMask@0 (loc a_2@@1 j$1) val) (=> (= (ControlFlow 0 81) 80) anon8_correct))))))))
(let ((anon66_Else_correct  (and (=> (= (ControlFlow 0 95) (- 0 96)) (forall ((j$0_1 Int) (j$0_1_1 Int) ) (!  (=> (and (and (and (and (not (= j$0_1 j$0_1_1)) (and (<= 0 j$0_1) (< j$0_1 (len a_2@@1)))) (and (<= 0 j$0_1_1) (< j$0_1_1 (len a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 j$0_1) (loc a_2@@1 j$0_1_1))))
 :qid |stdinbpl.353:15|
 :skolemid |30|
 ...
 :pattern ( (loc a_2@@1 j$0_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv2 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@7) o_9@@0 val) (+ (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@7) o_9@@0 val) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.375:22|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@7) o_9@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_11120_53) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@7) o_9@@1 f_5)))
 :qid |stdinbpl.379:29|
 :skolemid |35|
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@7) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_11133_11134) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@7) o_9@@2 f_5@@0)))
 :qid |stdinbpl.379:29|
 :skolemid |35|
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@7) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_14577_1545) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@7) o_9@@3 f_5@@1)))
 :qid |stdinbpl.379:29|
 :skolemid |35|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@7) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_7620_32791) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@7) o_9@@4 f_5@@2)))
 :qid |stdinbpl.379:29|
 :skolemid |35|
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@7) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_7620_32924) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@7) o_9@@5 f_5@@3)))
 :qid |stdinbpl.379:29|
 :skolemid |35|
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@7) o_9@@5 f_5@@3))
...
(let ((anon82_Then_correct  (=> (and (<= 0 j$5_1) (< j$5_1 k@0)) (and (=> (= (ControlFlow 0 62) (- 0 64)) (HasDirectPerm_7620_1545 QPMask@6 (loc a_2@@1 j$5_1) val)) (=> (HasDirectPerm_7620_1545 QPMask@6 (loc a_2@@1 j$5_1) val) (and (=> (= (ControlFlow 0 62) (- 0 63)) (HasDirectPerm_7620_1545 QPMask@6 (loc a_2@@1 at_1@1) val)) (=> (HasDirectPerm_7620_1545 QPMask@6 (loc a_2@@1 at_1@1) val) (=> (= (ControlFlow 0 62) 61) anon37_correct))))))))
(let ((anon81_Else_correct true))
(let ((anon79_Else_correct  (=> (forall ((j$4_3 Int) ) (!  (=> (and (<= 0 j$4_3) (< j$4_3 (len a_2@@1))) (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 j$4_3) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4_3) val)))
 :qid |stdinbpl.585:28|
 :skolemid |52|
 :pattern ( (loc a_2@@1 j$4_3))
)) (=> (and (and (state ExhaleHeap@0 QPMask@6) (<= 0 at_1@1)) (and (< at_1@1 k@0) (state ExhaleHeap@0 QPMask@6))) (and (and (=> (= (ControlFlow 0 66) 60) anon81_Else_correct) (=> (= (ControlFlow 0 66) 62) anon82_Then_correct)) (=> (= (ControlFlow 0 66) 65) anon82_Else_correct))))))
(let ((anon33_correct true))
(let ((anon80_Else_correct  (=> (and (not (and (<= 0 j$4_1) (< j$4_1 (len a_2@@1)))) (= (ControlFlow 0 59) 55)) anon33_correct)))
(let ((anon80_Then_correct  (=> (and (<= 0 j$4_1) (< j$4_1 (len a_2@@1))) (and (=> (= (ControlFlow 0 56) (- 0 58)) (HasDirectPerm_7620_1545 QPMask@6 (loc a_2@@1 j$4_1) val)) (=> (HasDirectPerm_7620_1545 QPMask@6 (loc a_2@@1 j$4_1) val) (and (=> (= (ControlFlow 0 56) (- 0 57)) (HasDirectPerm_7620_1545 QPMask@0 (loc a_2@@1 j$4_1) val)) (=> (HasDirectPerm_7620_1545 QPMask@0 (loc a_2@@1 j$4_1) val) (=> (= (ControlFlow 0 56) 55) anon33_correct))))))))
(let ((anon78_Else_correct  (and (=> (= (ControlFlow 0 67) (- 0 68)) (forall ((j$3_2 Int) (j$3_2_1 Int) ) (!  (=> (and (and (and (and (not (= j$3_2 j$3_2_1)) (and (<= 0 j$3_2) (< j$3_2 (len a_2@@1)))) (and (<= 0 j$3_2_1) (< j$3_2_1 (len a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 j$3_2) (loc a_2@@1 j$3_2_1))))
 :qid |stdinbpl.542:23|
 :skolemid |46|
 ...
 :pattern ( (loc a_2@@1 j$3_2@@2))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv5 o_9@@7)) (< (invRecv5 o_9@@7) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange5 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv5 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@6) o_9@@7 val) (+ (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@7 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv5 o_9@@7)) (< (invRecv5 o_9@@7) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange5 o_9@@7))) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@6) o_9@@7 val) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@7 val))))
 :qid |stdinbpl.564:30|
 :skolemid |50|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@6) o_9@@7 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_11120_53) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@1) o_9@@8 f_5@@4) (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@6) o_9@@8 f_5@@4)))
 :qid |stdinbpl.568:37|
 :skolemid |51|
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@1) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@6) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_11133_11134) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@1) o_9@@9 f_5@@5) (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@6) o_9@@9 f_5@@5)))
 :qid |stdinbpl.568:37|
 :skolemid |51|
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@1) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@6) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_14577_1545) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@10 f_5@@6) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@6) o_9@@10 f_5@@6)))
 :qid |stdinbpl.568:37|
 :skolemid |51|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@6) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_7620_32791) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@1) o_9@@11 f_5@@7) (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@6) o_9@@11 f_5@@7)))
 :qid |stdinbpl.568:37|
 :skolemid |51|
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@1) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@6) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_7620_32924) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@1) o_9@@12 f_5@@8) (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@6) o_9@@12 f_5@@8)))
 :qid |stdinbpl.568:37|
 :skolemid |51|
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@1) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@6) o_9@@12 f_5@@8))
...
(let ((anon77_Then_correct  (=> (<= 1 k@0) (=> (and (<= k@0 (len a_2@@1)) (state ExhaleHeap@0 QPMask@1)) (and (=> (= (ControlFlow 0 69) 54) anon78_Then_correct) (=> (= (ControlFlow 0 69) 67) anon78_Else_correct))))))
(let ((anon49_correct true))
(let ((anon88_Else_correct  (=> (and (not (and (<= 0 j$5_5) (< j$5_5 k@1))) (= (ControlFlow 0 39) 36)) anon49_correct)))
(let ((anon88_Then_correct  (=> (and (<= 0 j$5_5) (< j$5_5 k@1)) (and (=> (= (ControlFlow 0 37) (- 0 38)) (<= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 j$5_5) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 at_1@3) val))) (=> (<= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 j$5_5) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 at_1@3) val)) (=> (= (ControlFlow 0 37) 36) anon49_correct))))))
(let ((anon87_Else_correct true))
(let ((anon85_Else_correct  (=> (forall ((j$4_6_1 Int) ) (!  (=> (and (<= 0 j$4_6_1) (< j$4_6_1 (len a_2@@1))) (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 j$4_6_1) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4_6_1) val)))
 :qid |stdinbpl.746:28|
 :skolemid |68|
 :pattern ( (loc a_2@@1 j$4_6_1))
)) (and (=> (= (ControlFlow 0 40) (- 0 42)) (<= 0 at_1@3)) (=> (<= 0 at_1@3) (and (=> (= (ControlFlow 0 40) (- 0 41)) (< at_1@3 k@1)) (=> (< at_1@3 k@1) (and (and (=> (= (ControlFlow 0 40) 35) anon87_Else_correct) (=> (= (ControlFlow 0 40) 37) anon88_Then_correct)) (=> (= (ControlFlow 0 40) 39) anon88_Else_correct)))))))))
(let ((anon45_correct true))
(let ((anon86_Else_correct  (=> (and (not (and (<= 0 j$4_5) (< j$4_5 (len a_2@@1)))) (= (ControlFlow 0 34) 31)) anon45_correct)))
(let ((anon86_Then_correct  (=> (and (<= 0 j$4_5) (< j$4_5 (len a_2@@1))) (and (=> (= (ControlFlow 0 32) (- 0 33)) (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 j$4_5) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4_5) val))) (=> (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 j$4_5) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4_5) val)) (=> (= (ControlFlow 0 32) 31) anon45_correct))))))
(let ((anon42_correct  (=> (state ExhaleHeap@0 QPMask@2) (=> (and (= k@1 (+ k@0 1)) (state ExhaleHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 43) (- 0 47)) (<= 1 k@1)) (=> (<= 1 k@1) (and (=> (= (ControlFlow 0 43) (- 0 46)) (<= k@1 (len a_2@@1))) (=> (<= k@1 (len a_2@@1)) (and (=> (= (ControlFlow 0 43) (- 0 45)) (forall ((j$3_4 Int) (j$3_4_1 Int) ) (!  (=> (and (and (and (and (not (= j$3_4 j$3_4_1)) (and (<= 0 j$3_4) (< j$3_4 (len a_2@@1)))) (and (<= 0 j$3_4_1) (< j$3_4_1 (len a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 j$3_4) (loc a_2@@1 j$3_4_1))))
 :qid |stdinbpl.705:25|
 :skolemid |62|
...
)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (forall ((j$3_4@@1 Int) ) (!  (=> (and (<= 0 j$3_4@@1) (< j$3_4@@1 (len a_2@@1))) (>= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@2) (loc a_2@@1 j$3_4@@1) val) FullPerm))
 :qid |stdinbpl.712:25|
 :skolemid |63|
 :pattern ( (loc a_2@@1 j$3_4@@1))
 :pattern ( (loc a_2@@1 j$3_4@@1))
))) (=> (forall ((j$3_4@@2 Int) ) (!  (=> (and (<= 0 j$3_4@@2) (< j$3_4@@2 (len a_2@@1))) (>= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@2) (loc a_2@@1 j$3_4@@2) val) FullPerm))
 :qid |stdinbpl.712:25|
 :skolemid |63|
...
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv7 o_9@@14)) (< (invRecv7 o_9@@14) (len a_2@@1))) (and (< NoPerm FullPerm) (qpRange7 o_9@@14))) (and (= (loc a_2@@1 (invRecv7 o_9@@14)) o_9@@14) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@5) o_9@@14 val) (- (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@2) o_9@@14 val) FullPerm)))) (=> (not (and (and (<= 0 (invRecv7 o_9@@14)) (< (invRecv7 o_9@@14) (len a_2@@1))) (and (< NoPerm FullPerm) (qpRange7 o_9@@14)))) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@5) o_9@@14 val) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@2) o_9@@14 val))))
 :qid |stdinbpl.728:30|
 :skolemid |66|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@5) o_9@@14 val))
))) (=> (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_11120_53) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@2) o_9@@15 f_5@@9) (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@5) o_9@@15 f_5@@9)))
 :qid |stdinbpl.734:37|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@5) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_11133_11134) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@2) o_9@@16 f_5@@10) (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@5) o_9@@16 f_5@@10)))
 :qid |stdinbpl.734:37|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@5) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_14577_1545) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@2) o_9@@17 f_5@@11) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@5) o_9@@17 f_5@@11)))
 :qid |stdinbpl.734:37|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@5) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_7620_32791) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@2) o_9@@18 f_5@@12) (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@5) o_9@@18 f_5@@12)))
 :qid |stdinbpl.734:37|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@5) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_7620_32924) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@2) o_9@@19 f_5@@13) (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@5) o_9@@19 f_5@@13)))
 :qid |stdinbpl.734:37|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@5) o_9@@19 f_5@@13))
...
(let ((anon84_Else_correct  (=> (<= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 k@0) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 at_1@1) val)) (=> (and (= at_1@3 at_1@1) (= (ControlFlow 0 49) 43)) anon42_correct))))
(let ((anon84_Then_correct  (=> (and (and (< (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 at_1@1) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 k@0) val)) (state ExhaleHeap@0 QPMask@2)) (and (= at_1@3 k@0) (= (ControlFlow 0 48) 43))) anon42_correct)))
(let ((anon83_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (<= 1 k@0) (<= k@0 (len a_2@@1))) (and (=> (= (ControlFlow 0 50) (- 0 53)) (forall ((j$3_3 Int) (j$3_3_1 Int) ) (!  (=> (and (and (and (and (not (= j$3_3 j$3_3_1)) (and (<= 0 j$3_3) (< j$3_3 (len a_2@@1)))) (and (<= 0 j$3_3_1) (< j$3_3_1 (len a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 j$3_3) (loc a_2@@1 j$3_3_1))))
 :qid |stdinbpl.624:23|
 :skolemid |54|
 ...
 :pattern ( (loc a_2@@1 j$3_3@@2))
)) (forall ((o_9@@21 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv6 o_9@@21)) (< (invRecv6 o_9@@21) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange6 o_9@@21)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv6 o_9@@21)) o_9@@21)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@2) o_9@@21 val) (+ (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@21 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv6 o_9@@21)) (< (invRecv6 o_9@@21) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange6 o_9@@21))) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@2) o_9@@21 val) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@21 val))))
 :qid |stdinbpl.646:30|
 :skolemid |58|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@2) o_9@@21 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@22 T@Ref) (f_5@@14 T@Field_11120_53) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| ZeroMask) o_9@@22 f_5@@14) (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@2) o_9@@22 f_5@@14)))
 :qid |stdinbpl.650:37|
 :skolemid |59|
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| ZeroMask) o_9@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@2) o_9@@22 f_5@@14))
)) (forall ((o_9@@23 T@Ref) (f_5@@15 T@Field_11133_11134) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| ZeroMask) o_9@@23 f_5@@15) (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@2) o_9@@23 f_5@@15)))
 :qid |stdinbpl.650:37|
 :skolemid |59|
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| ZeroMask) o_9@@23 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@2) o_9@@23 f_5@@15))
))) (forall ((o_9@@24 T@Ref) (f_5@@16 T@Field_14577_1545) ) (!  (=> (not (= f_5@@16 val)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@24 f_5@@16) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@2) o_9@@24 f_5@@16)))
 :qid |stdinbpl.650:37|
 :skolemid |59|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@24 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@2) o_9@@24 f_5@@16))
))) (forall ((o_9@@25 T@Ref) (f_5@@17 T@Field_7620_32791) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| ZeroMask) o_9@@25 f_5@@17) (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@2) o_9@@25 f_5@@17)))
 :qid |stdinbpl.650:37|
 :skolemid |59|
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| ZeroMask) o_9@@25 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@2) o_9@@25 f_5@@17))
))) (forall ((o_9@@26 T@Ref) (f_5@@18 T@Field_7620_32924) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| ZeroMask) o_9@@26 f_5@@18) (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@2) o_9@@26 f_5@@18)))
 :qid |stdinbpl.650:37|
 :skolemid |59|
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| ZeroMask) o_9@@26 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@2) o_9@@26 f_5@@18))
))) (and (and (and (state ExhaleHeap@0 QPMask@2) (forall ((j$4_4 Int) ) (!  (=> (and (<= 0 j$4_4) (< j$4_4 (len a_2@@1))) (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 j$4_4) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4_4) val)))
 :qid |stdinbpl.656:28|
 :skolemid |60|
 :pattern ( (loc a_2@@1 j$4_4))
))) (and (<= 0 at_1@1) (< at_1@1 k@0))) (and (and (forall ((j$5_4 Int) ) (!  (=> (and (<= 0 j$5_4) (< j$5_4 k@0)) (<= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 j$5_4) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 at_1@1) val)))
 :qid |stdinbpl.662:28|
 :skolemid |61|
 :pattern ( (loc a_2@@1 j$5_4))
)) (state ExhaleHeap@0 QPMask@2)) (and (< k@0 (len a_2@@1)) (state ExhaleHeap@0 QPMask@2))))) (and (=> (= (ControlFlow 0 50) (- 0 52)) (HasDirectPerm_7620_1545 QPMask@2 (loc a_2@@1 at_1@1) val)) (=> (HasDirectPerm_7620_1545 QPMask@2 (loc a_2@@1 at_1@1) val) (and (=> (= (ControlFlow 0 50) (- 0 51)) (HasDirectPerm_7620_1545 QPMask@2 (loc a_2@@1 k@0) val)) (=> (HasDirectPerm_7620_1545 QPMask@2 (loc a_2@@1 k@0) val) (and (=> (= (ControlFlow 0 50) 48) anon84_Then_correct) (=> (= (ControlFlow 0 50) 49) anon84_Else_correct))))))))))))))
(let ((anon62_correct true))
(let ((anon93_Else_correct  (=> (and (not (and (<= 0 j$2_2) (< j$2_2 (len a_2@@1)))) (= (ControlFlow 0 18) 15)) anon62_correct)))
(let ((anon93_Then_correct  (=> (and (<= 0 j$2_2) (< j$2_2 (len a_2@@1))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@0) (loc a_2@@1 j$2_2) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@0) (loc a_2@@1 at_1@2) val))) (=> (<= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@0) (loc a_2@@1 j$2_2) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@0) (loc a_2@@1 at_1@2) val)) (=> (= (ControlFlow 0 16) 15) anon62_correct))))))
(let ((anon92_Else_correct true))
(let ((anon91_Else_correct  (=> (not (= (len a_2@@1) 0)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (<= 0 at_1@2)) (=> (<= 0 at_1@2) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< at_1@2 (len a_2@@1))) (=> (< at_1@2 (len a_2@@1)) (and (and (=> (= (ControlFlow 0 21) 14) anon92_Else_correct) (=> (= (ControlFlow 0 21) 16) anon93_Then_correct)) (=> (= (ControlFlow 0 21) 18) anon93_Else_correct)))))))))
(let ((anon91_Then_correct  (=> (= (len a_2@@1) 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= at_1@2 (- 0 1))) (=> (= at_1@2 (- 0 1)) (and (and (=> (= (ControlFlow 0 19) 14) anon92_Else_correct) (=> (= (ControlFlow 0 19) 16) anon93_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon93_Else_correct)))))))
(let ((anon89_Else_correct  (=> (forall ((j$1_3_1 Int) ) (!  (=> (and (<= 0 j$1_3_1) (< j$1_3_1 (len a_2@@1))) (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@0) (loc a_2@@1 j$1_3_1) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$1_3_1) val)))
 :qid |stdinbpl.878:20|
 :skolemid |84|
...
(let ((anon90_Else_correct  (=> (and (not (and (<= 0 j$1_2) (< j$1_2 (len a_2@@1)))) (= (ControlFlow 0 13) 10)) anon55_correct)))
(let ((anon90_Then_correct  (=> (and (<= 0 j$1_2) (< j$1_2 (len a_2@@1))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@0) (loc a_2@@1 j$1_2) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$1_2) val))) (=> (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@0) (loc a_2@@1 j$1_2) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$1_2) val)) (=> (= (ControlFlow 0 11) 10) anon55_correct))))))
(let ((anon52_correct  (=> (state Heap@0 Mask@0) (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((j$0_2 Int) (j$0_2_1 Int) ) (!  (=> (and (and (and (and (not (= j$0_2 j$0_2_1)) (and (<= 0 j$0_2) (< j$0_2 (len a_2@@1)))) (and (<= 0 j$0_2_1) (< j$0_2_1 (len a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 j$0_2) (loc a_2@@1 j$0_2_1))))
 :qid |stdinbpl.837:17|
 :skolemid |78|
...
)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((j$0_2@@1 Int) ) (!  (=> (and (<= 0 j$0_2@@1) (< j$0_2@@1 (len a_2@@1))) (>= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| Mask@0) (loc a_2@@1 j$0_2@@1) val) FullPerm))
 :qid |stdinbpl.844:17|
 :skolemid |79|
 :pattern ( (loc a_2@@1 j$0_2@@1))
 :pattern ( (loc a_2@@1 j$0_2@@1))
))) (=> (forall ((j$0_2@@2 Int) ) (!  (=> (and (<= 0 j$0_2@@2) (< j$0_2@@2 (len a_2@@1))) (>= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| Mask@0) (loc a_2@@1 j$0_2@@2) val) FullPerm))
 :qid |stdinbpl.844:17|
 :skolemid |79|
 ...
 :pattern ( (loc a_2@@1 j$0_2@@3))
)) (=> (and (forall ((o_9@@27 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv3 o_9@@27)) (< (invRecv3 o_9@@27) (len a_2@@1))) (and (< NoPerm FullPerm) (qpRange3 o_9@@27))) (= (loc a_2@@1 (invRecv3 o_9@@27)) o_9@@27))
 :qid |stdinbpl.854:22|
 :skolemid |81|
 :pattern ( (invRecv3 o_9@@27))
)) (forall ((o_9@@28 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv3 o_9@@28)) (< (invRecv3 o_9@@28) (len a_2@@1))) (and (< NoPerm FullPerm) (qpRange3 o_9@@28))) (and (= (loc a_2@@1 (invRecv3 o_9@@28)) o_9@@28) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@4) o_9@@28 val) (- (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| Mask@0) o_9@@28 val) FullPerm)))) (=> (not (and (and (<= 0 (invRecv3 o_9@@28)) (< (invRecv3 o_9@@28) (len a_2@@1))) (and (< NoPerm FullPerm) (qpRange3 o_9@@28)))) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@4) o_9@@28 val) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| Mask@0) o_9@@28 val))))
 :qid |stdinbpl.860:22|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@4) o_9@@28 val))
))) (=> (and (and (and (and (forall ((o_9@@29 T@Ref) (f_5@@19 T@Field_11120_53) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| Mask@0) o_9@@29 f_5@@19) (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@4) o_9@@29 f_5@@19)))
 :qid |stdinbpl.866:29|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@4) o_9@@29 f_5@@19))
)) (forall ((o_9@@30 T@Ref) (f_5@@20 T@Field_11133_11134) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| Mask@0) o_9@@30 f_5@@20) (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@4) o_9@@30 f_5@@20)))
 :qid |stdinbpl.866:29|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@4) o_9@@30 f_5@@20))
))) (forall ((o_9@@31 T@Ref) (f_5@@21 T@Field_14577_1545) ) (!  (=> (not (= f_5@@21 val)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| Mask@0) o_9@@31 f_5@@21) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@4) o_9@@31 f_5@@21)))
 :qid |stdinbpl.866:29|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@4) o_9@@31 f_5@@21))
))) (forall ((o_9@@32 T@Ref) (f_5@@22 T@Field_7620_32791) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| Mask@0) o_9@@32 f_5@@22) (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@4) o_9@@32 f_5@@22)))
 :qid |stdinbpl.866:29|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@4) o_9@@32 f_5@@22))
))) (forall ((o_9@@33 T@Ref) (f_5@@23 T@Field_7620_32924) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| Mask@0) o_9@@33 f_5@@23) (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@4) o_9@@33 f_5@@23)))
 :qid |stdinbpl.866:29|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@4) o_9@@33 f_5@@23))
...
(let ((anon83_Else_correct  (=> (and (and (not (< k@0 (len a_2@@1))) (state ExhaleHeap@0 QPMask@1)) (and (<= 1 k@0) (<= k@0 (len a_2@@1)))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((j$3_5 Int) (j$3_5_1 Int) ) (!  (=> (and (and (and (and (not (= j$3_5 j$3_5_1)) (and (<= 0 j$3_5) (< j$3_5 (len a_2@@1)))) (and (<= 0 j$3_5_1) (< j$3_5_1 (len a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 j$3_5) (loc a_2@@1 j$3_5_1))))
 :qid |stdinbpl.780:21|
 :skolemid |70|
 ...
 :pattern ( (loc a_2@@1 j$3_5@@1))
)) (forall ((o_9@@34 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv8 o_9@@34)) (< (invRecv8 o_9@@34) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange8 o_9@@34)) (= (loc a_2@@1 (invRecv8 o_9@@34)) o_9@@34))
 :qid |stdinbpl.790:28|
 :skolemid |72|
 ...
 :pattern ( (loc a_2@@1 j$3_5@@2))
)) (forall ((o_9@@35 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv8 o_9@@35)) (< (invRecv8 o_9@@35) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange8 o_9@@35)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv8 o_9@@35)) o_9@@35)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@3) o_9@@35 val) (+ (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@35 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv8 o_9@@35)) (< (invRecv8 o_9@@35) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange8 o_9@@35))) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@3) o_9@@35 val) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@35 val))))
 :qid |stdinbpl.802:28|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@3) o_9@@35 val))
)))) (=> (and (and (and (and (and (and (and (forall ((o_9@@36 T@Ref) (f_5@@24 T@Field_11120_53) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@1) o_9@@36 f_5@@24) (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@3) o_9@@36 f_5@@24)))
 :qid |stdinbpl.806:35|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@1) o_9@@36 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@3) o_9@@36 f_5@@24))
)) (forall ((o_9@@37 T@Ref) (f_5@@25 T@Field_11133_11134) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@1) o_9@@37 f_5@@25) (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@3) o_9@@37 f_5@@25)))
 :qid |stdinbpl.806:35|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@1) o_9@@37 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@3) o_9@@37 f_5@@25))
))) (forall ((o_9@@38 T@Ref) (f_5@@26 T@Field_14577_1545) ) (!  (=> (not (= f_5@@26 val)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@38 f_5@@26) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@3) o_9@@38 f_5@@26)))
 :qid |stdinbpl.806:35|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@38 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@3) o_9@@38 f_5@@26))
))) (forall ((o_9@@39 T@Ref) (f_5@@27 T@Field_7620_32791) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@1) o_9@@39 f_5@@27) (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@3) o_9@@39 f_5@@27)))
 :qid |stdinbpl.806:35|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@1) o_9@@39 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@3) o_9@@39 f_5@@27))
))) (forall ((o_9@@40 T@Ref) (f_5@@28 T@Field_7620_32924) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@1) o_9@@40 f_5@@28) (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@3) o_9@@40 f_5@@28)))
 :qid |stdinbpl.806:35|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@1) o_9@@40 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@3) o_9@@40 f_5@@28))
))) (state ExhaleHeap@0 QPMask@3)) (and (forall ((j$4_7 Int) ) (!  (=> (and (<= 0 j$4_7) (< j$4_7 (len a_2@@1))) (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 j$4_7) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4_7) val)))
 :qid |stdinbpl.812:26|
 :skolemid |76|
 :pattern ( (loc a_2@@1 j$4_7))
)) (<= 0 at_1@1))) (and (and (and (< at_1@1 k@0) (forall ((j$5_7 Int) ) (!  (=> (and (<= 0 j$5_7) (< j$5_7 k@0)) (<= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 j$5_7) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| ExhaleHeap@0) (loc a_2@@1 at_1@1) val)))
 :qid |stdinbpl.818:26|
 :skolemid |77|
 :pattern ( (loc a_2@@1 j$5_7))
))) (and (state ExhaleHeap@0 QPMask@3) (state ExhaleHeap@0 QPMask@3))) (and (and (= Heap@0 ExhaleHeap@0) (= Mask@0 QPMask@3)) (and (= at_1@2 at_1@1) (= (ControlFlow 0 29) 25))))) anon52_correct)))))))
...
(let ((anon72_Then_correct  (=> (= (len a_2@@1) 0) (=> (and (= at_1@0 (- 0 1)) (state Heap@@17 QPMask@0)) (=> (and (and (= Heap@0 Heap@@17) (= Mask@0 QPMask@0)) (and (= at_1@2 at_1@0) (= (ControlFlow 0 28) 25))) anon52_correct)))))
...
(let ((anon73_Else_correct  (=> (forall ((j$4_1_1 Int) ) (!  (=> (and (<= 0 j$4_1_1) (< j$4_1_1 (len a_2@@1))) (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4_1_1) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4_1_1) val)))
 :qid |stdinbpl.503:28|
 :skolemid |44|
...
(let ((anon74_Else_correct  (=> (and (not (and (<= 0 j$4) (< j$4 (len a_2@@1)))) (= (ControlFlow 0 5) 2)) anon22_correct)))
(let ((anon74_Then_correct  (=> (and (<= 0 j$4) (< j$4 (len a_2@@1))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4) val))) (=> (= (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4) val) (select (|PolymorphicMapType_11060_7620_1545#PolymorphicMapType_11060| Heap@@17) (loc a_2@@1 j$4) val)) (=> (= (ControlFlow 0 3) 2) anon22_correct))))))
(let ((anon72_Else_correct  (=> (not (= (len a_2@@1) 0)) (=> (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0)) (and (=> (= (ControlFlow 0 74) (- 0 78)) (<= 1 1)) (=> (<= 1 1) (and (=> (= (ControlFlow 0 74) (- 0 77)) (<= 1 (len a_2@@1))) (=> (<= 1 (len a_2@@1)) (and (=> (= (ControlFlow 0 74) (- 0 76)) (forall ((j$3 Int) (j$3_1 Int) ) (!  (=> (and (and (and (and (not (= j$3 j$3_1)) (and (<= 0 j$3) (< j$3 (len a_2@@1)))) (and (<= 0 j$3_1) (< j$3_1 (len a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 j$3) (loc a_2@@1 j$3_1))))
 :qid |stdinbpl.462:25|
 :skolemid |38|
...
)) (and (=> (= (ControlFlow 0 74) (- 0 75)) (forall ((j$3@@1 Int) ) (!  (=> (and (<= 0 j$3@@1) (< j$3@@1 (len a_2@@1))) (>= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@0) (loc a_2@@1 j$3@@1) val) FullPerm))
 :qid |stdinbpl.469:25|
 :skolemid |39|
 :pattern ( (loc a_2@@1 j$3@@1))
 :pattern ( (loc a_2@@1 j$3@@1))
))) (=> (forall ((j$3@@2 Int) ) (!  (=> (and (<= 0 j$3@@2) (< j$3@@2 (len a_2@@1))) (>= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@0) (loc a_2@@1 j$3@@2) val) FullPerm))
 :qid |stdinbpl.469:25|
 :skolemid |39|
...
)) (forall ((o_9@@42 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv4 o_9@@42)) (< (invRecv4 o_9@@42) (len a_2@@1))) (and (< NoPerm FullPerm) (qpRange4 o_9@@42))) (and (= (loc a_2@@1 (invRecv4 o_9@@42)) o_9@@42) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@42 val) (- (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@0) o_9@@42 val) FullPerm)))) (=> (not (and (and (<= 0 (invRecv4 o_9@@42)) (< (invRecv4 o_9@@42) (len a_2@@1))) (and (< NoPerm FullPerm) (qpRange4 o_9@@42)))) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@42 val) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@0) o_9@@42 val))))
 :qid |stdinbpl.485:30|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@42 val))
))) (=> (and (and (and (and (forall ((o_9@@43 T@Ref) (f_5@@29 T@Field_11120_53) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@0) o_9@@43 f_5@@29) (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@1) o_9@@43 f_5@@29)))
 :qid |stdinbpl.491:37|
 :skolemid |43|
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@1) o_9@@43 f_5@@29))
)) (forall ((o_9@@44 T@Ref) (f_5@@30 T@Field_11133_11134) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@0) o_9@@44 f_5@@30) (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@1) o_9@@44 f_5@@30)))
 :qid |stdinbpl.491:37|
 :skolemid |43|
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@1) o_9@@44 f_5@@30))
))) (forall ((o_9@@45 T@Ref) (f_5@@31 T@Field_14577_1545) ) (!  (=> (not (= f_5@@31 val)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@0) o_9@@45 f_5@@31) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@45 f_5@@31)))
 :qid |stdinbpl.491:37|
 :skolemid |43|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@1) o_9@@45 f_5@@31))
))) (forall ((o_9@@46 T@Ref) (f_5@@32 T@Field_7620_32791) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@0) o_9@@46 f_5@@32) (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@1) o_9@@46 f_5@@32)))
 :qid |stdinbpl.491:37|
 :skolemid |43|
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@1) o_9@@46 f_5@@32))
))) (forall ((o_9@@47 T@Ref) (f_5@@33 T@Field_7620_32924) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@0) o_9@@47 f_5@@33) (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@1) o_9@@47 f_5@@33)))
 :qid |stdinbpl.491:37|
 :skolemid |43|
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@1) o_9@@47 f_5@@33))
...
(let ((anon64_Else_correct  (and (=> (= (ControlFlow 0 98) (- 0 99)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (and (<= 0 j_1) (< j_1 (len a_2@@1)))) (and (<= 0 j_1_1) (< j_1_1 (len a_2@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 j_1) (loc a_2@@1 j_1_1))))
 :qid |stdinbpl.302:15|
 :skolemid |24|
 ...
 :pattern ( (loc a_2@@1 j_1@@2))
)) (forall ((o_9@@49 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_9@@49)) (< (invRecv1 o_9@@49) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange1 o_9@@49)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv1 o_9@@49)) o_9@@49)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@0) o_9@@49 val) (+ (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@49 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_9@@49)) (< (invRecv1 o_9@@49) (len a_2@@1))) (< NoPerm FullPerm)) (qpRange1 o_9@@49))) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@0) o_9@@49 val) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@49 val))))
 :qid |stdinbpl.324:22|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@0) o_9@@49 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@50 T@Ref) (f_5@@34 T@Field_11120_53) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| ZeroMask) o_9@@50 f_5@@34) (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@0) o_9@@50 f_5@@34)))
 :qid |stdinbpl.328:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| ZeroMask) o_9@@50 f_5@@34))
 :pattern ( (select (|PolymorphicMapType_11081_7620_53#PolymorphicMapType_11081| QPMask@0) o_9@@50 f_5@@34))
)) (forall ((o_9@@51 T@Ref) (f_5@@35 T@Field_11133_11134) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| ZeroMask) o_9@@51 f_5@@35) (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@0) o_9@@51 f_5@@35)))
 :qid |stdinbpl.328:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| ZeroMask) o_9@@51 f_5@@35))
 :pattern ( (select (|PolymorphicMapType_11081_7620_11134#PolymorphicMapType_11081| QPMask@0) o_9@@51 f_5@@35))
))) (forall ((o_9@@52 T@Ref) (f_5@@36 T@Field_14577_1545) ) (!  (=> (not (= f_5@@36 val)) (= (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@52 f_5@@36) (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@0) o_9@@52 f_5@@36)))
 :qid |stdinbpl.328:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| ZeroMask) o_9@@52 f_5@@36))
 :pattern ( (select (|PolymorphicMapType_11081_7620_1545#PolymorphicMapType_11081| QPMask@0) o_9@@52 f_5@@36))
))) (forall ((o_9@@53 T@Ref) (f_5@@37 T@Field_7620_32791) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| ZeroMask) o_9@@53 f_5@@37) (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@0) o_9@@53 f_5@@37)))
 :qid |stdinbpl.328:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| ZeroMask) o_9@@53 f_5@@37))
 :pattern ( (select (|PolymorphicMapType_11081_7620_32791#PolymorphicMapType_11081| QPMask@0) o_9@@53 f_5@@37))
))) (forall ((o_9@@54 T@Ref) (f_5@@38 T@Field_7620_32924) ) (!  (=> true (= (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| ZeroMask) o_9@@54 f_5@@38) (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@0) o_9@@54 f_5@@38)))
 :qid |stdinbpl.328:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| ZeroMask) o_9@@54 f_5@@38))
 :pattern ( (select (|PolymorphicMapType_11081_7620_37046#PolymorphicMapType_11081| QPMask@0) o_9@@54 f_5@@38))
