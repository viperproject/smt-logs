...
)) (=> (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_9941| xs r_1_1@@1) (< NoPerm FullPerm)) (and (= (invRecv7 r_1_1@@1 i@@23) r_1_1@@1) (qpRange7 r_1_1@@1 i@@23)))
...
)) (=> (and (forall ((r_2_1 T@Ref) (i_1_1_1 Int) ) (!  (=> (and (and (|Seq#Contains_9941| xs (invRecv7 r_2_1 i_1_1_1)) (< NoPerm FullPerm)) (qpRange7 r_2_1 i_1_1_1)) (and (= (invRecv7 r_2_1 i_1_1_1) r_2_1) (= i@@23 i_1_1_1)))
 :qid |stdinbpl.1571:22|
 :skolemid |121|
 :pattern ( (invRecv7 r_2_1 i_1_1_1))
)) (forall ((r_2_1@@0 T@Ref) (i_1_1_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_9941| xs (invRecv7 r_2_1@@0 i_1_1_1@@0)) (< NoPerm FullPerm)) (qpRange7 r_2_1@@0 i_1_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv7 r_2_1@@0 i_1_1_1@@0) r_2_1@@0) (= i@@23 i_1_1_1@@0))) (= (select (|PolymorphicMapType_15975_9913_9914#PolymorphicMapType_15975| QPMask@0) null (p5 r_2_1@@0 i_1_1_1@@0)) (+ (select (|PolymorphicMapType_15975_9913_9914#PolymorphicMapType_15975| ZeroMask) null (p5 r_2_1@@0 i_1_1_1@@0)) FullPerm))))
 :qid |stdinbpl.1577:22|
 :skolemid |122|
...
))) (forall ((r_2_1@@1 T@Ref) (i_1_1_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_9941| xs (invRecv7 r_2_1@@1 i_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange7 r_2_1@@1 i_1_1_1@@1))) (= (select (|PolymorphicMapType_15975_9913_9914#PolymorphicMapType_15975| QPMask@0) null (p5 r_2_1@@1 i_1_1_1@@1)) (select (|PolymorphicMapType_15975_9913_9914#PolymorphicMapType_15975| ZeroMask) null (p5 r_2_1@@1 i_1_1_1@@1))))
 :qid |stdinbpl.1587:22|
 :skolemid |124|
