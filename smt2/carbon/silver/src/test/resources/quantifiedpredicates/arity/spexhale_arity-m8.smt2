...
)) (=> (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_8736| xs r_1_1@@1) (< NoPerm FullPerm)) (and (= (invRecv7 r_1_1@@1 i@@23) r_1_1@@1) (qpRange7 r_1_1@@1 i@@23)))
...
)) (=> (and (forall ((r_2_1 T@Ref) (i_1_1_1 Int) ) (!  (=> (and (and (|Seq#Contains_8736| xs (invRecv7 r_2_1 i_1_1_1)) (< NoPerm FullPerm)) (qpRange7 r_2_1 i_1_1_1)) (and (= (invRecv7 r_2_1 i_1_1_1) r_2_1) (= i@@23 i_1_1_1)))
 :qid |stdinbpl.1507:22|
 :skolemid |121|
 :pattern ( (invRecv7 r_2_1 i_1_1_1))
)) (forall ((r_2_1@@0 T@Ref) (i_1_1_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_8736| xs (invRecv7 r_2_1@@0 i_1_1_1@@0)) (< NoPerm FullPerm)) (qpRange7 r_2_1@@0 i_1_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv7 r_2_1@@0 i_1_1_1@@0) r_2_1@@0) (= i@@23 i_1_1_1@@0))) (= (select (|PolymorphicMapType_13639_8708_8709#PolymorphicMapType_13639| QPMask@0) null (p5 r_2_1@@0 i_1_1_1@@0)) (+ (select (|PolymorphicMapType_13639_8708_8709#PolymorphicMapType_13639| ZeroMask) null (p5 r_2_1@@0 i_1_1_1@@0)) FullPerm))))
...
))) (forall ((r_2_1@@1 T@Ref) (i_1_1_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_8736| xs (invRecv7 r_2_1@@1 i_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange7 r_2_1@@1 i_1_1_1@@1))) (= (select (|PolymorphicMapType_13639_8708_8709#PolymorphicMapType_13639| QPMask@0) null (p5 r_2_1@@1 i_1_1_1@@1)) (select (|PolymorphicMapType_13639_8708_8709#PolymorphicMapType_13639| ZeroMask) null (p5 r_2_1@@1 i_1_1_1@@1))))
...
))) (and (and (state Heap@@92 QPMask@0) (state Heap@@92 QPMask@0)) (and (|Seq#Contains_8736| xs x@@5) (state Heap@@92 QPMask@0)))) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Then_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))))
