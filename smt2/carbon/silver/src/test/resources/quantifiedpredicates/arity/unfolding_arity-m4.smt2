...
)) (=> (and (forall ((r_2_1 T@Ref) (i_1_1_1 Int) ) (!  (=> (and (and (select xs (invRecv4 r_2_1 i_1_1_1)) (< NoPerm FullPerm)) (qpRange4 r_2_1 i_1_1_1)) (and (= (invRecv4 r_2_1 i_1_1_1) r_2_1) (= i@@5 i_1_1_1)))
 :qid |stdinbpl.1129:22|
 :skolemid |125|
 :pattern ( (invRecv4 r_2_1 i_1_1_1))
)) (forall ((r_2_1@@0 T@Ref) (i_1_1_1@@0 Int) ) (!  (=> (and (and (select xs (invRecv4 r_2_1@@0 i_1_1_1@@0)) (< NoPerm FullPerm)) (qpRange4 r_2_1@@0 i_1_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv4 r_2_1@@0 i_1_1_1@@0) r_2_1@@0) (= i@@5 i_1_1_1@@0))) (= (select (|PolymorphicMapType_13154_7942_7943#PolymorphicMapType_13154| QPMask@0) null (p3_1 r_2_1@@0 i_1_1_1@@0)) (+ (select (|PolymorphicMapType_13154_7942_7943#PolymorphicMapType_13154| ZeroMask) null (p3_1 r_2_1@@0 i_1_1_1@@0)) FullPerm))))
...
))) (forall ((r_2_1@@1 T@Ref) (i_1_1_1@@1 Int) ) (!  (=> (not (and (and (select xs (invRecv4 r_2_1@@1 i_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange4 r_2_1@@1 i_1_1_1@@1))) (= (select (|PolymorphicMapType_13154_7942_7943#PolymorphicMapType_13154| QPMask@0) null (p3_1 r_2_1@@1 i_1_1_1@@1)) (select (|PolymorphicMapType_13154_7942_7943#PolymorphicMapType_13154| ZeroMask) null (p3_1 r_2_1@@1 i_1_1_1@@1))))
