  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of p3
    ...
    // -- Check definedness of r.f == 0
      assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access r.f (spprod_arity.vpr@18.1--21.2) [204761]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of p5
    ...
    // -- Check definedness of r.f == i
      assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access r.f (spprod_arity.vpr@28.1--31.2) [204762]"}
        HasDirectPerm(Mask, r_1, f_7);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(p2(r), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p2(r) might not be injective. (spprod_arity.vpr@34.10--34.48) [204763]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(p3(r), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p3(r) might not be injective. (spprod_arity.vpr@39.10--39.48) [204764]"}
        (forall r_1_1: Ref, r_1_2: Ref ::
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(p4(r, i), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p4(r, i) might not be injective. (spprod_arity.vpr@44.10--44.51) [204765]"}
        (forall r_1_1: Ref, r_1_2: Ref ::
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(p5(r, i), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p5(r, i) might not be injective. (spprod_arity.vpr@49.10--49.51) [204766]"}
        (forall r_1_1: Ref, r_1_2: Ref ::
