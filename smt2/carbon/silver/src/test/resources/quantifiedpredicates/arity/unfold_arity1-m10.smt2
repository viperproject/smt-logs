...
)) (=> (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_9941| xs r_1_1@@1) (< NoPerm FullPerm)) (and (= (invRecv9 r_1_1@@1 i@@23) r_1_1@@1) (qpRange9 r_1_1@@1 i@@23)))
...
)) (=> (and (forall ((r_2_1 T@Ref) (i_1_1_1 Int) ) (!  (=> (and (and (|Seq#Contains_9941| xs (invRecv9 r_2_1 i_1_1_1)) (< NoPerm FullPerm)) (qpRange9 r_2_1 i_1_1_1)) (and (= (invRecv9 r_2_1 i_1_1_1) r_2_1) (= i@@23 i_1_1_1)))
 :qid |stdinbpl.1805:22|
 :skolemid |133|
 :pattern ( (invRecv9 r_2_1 i_1_1_1))
)) (forall ((r_2_1@@0 T@Ref) (i_1_1_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_9941| xs (invRecv9 r_2_1@@0 i_1_1_1@@0)) (< NoPerm FullPerm)) (qpRange9 r_2_1@@0 i_1_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv9 r_2_1@@0 i_1_1_1@@0) r_2_1@@0) (= i@@23 i_1_1_1@@0))) (= (select (|PolymorphicMapType_15975_9913_9914#PolymorphicMapType_15975| QPMask@0) null (p5 r_2_1@@0 i_1_1_1@@0)) (+ (select (|PolymorphicMapType_15975_9913_9914#PolymorphicMapType_15975| ZeroMask) null (p5 r_2_1@@0 i_1_1_1@@0)) FullPerm))))
...
))) (forall ((r_2_1@@1 T@Ref) (i_1_1_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_9941| xs (invRecv9 r_2_1@@1 i_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange9 r_2_1@@1 i_1_1_1@@1))) (= (select (|PolymorphicMapType_15975_9913_9914#PolymorphicMapType_15975| QPMask@0) null (p5 r_2_1@@1 i_1_1_1@@1)) (select (|PolymorphicMapType_15975_9913_9914#PolymorphicMapType_15975| ZeroMask) null (p5 r_2_1@@1 i_1_1_1@@1))))
...
))) (and (and (state Heap@@92 QPMask@0) (state Heap@@92 QPMask@0)) (and (|p5#trigger_9913| Heap@@92 (p5 x@@5 i@@23)) (= (select (|PolymorphicMapType_15954_9913_9914#PolymorphicMapType_15954| Heap@@92) null (p5 x@@5 i@@23)) (FrameFragment_3242 (select (|PolymorphicMapType_15954_9821_3242#PolymorphicMapType_15954| Heap@@92) x@@5 f_7)))))) (and (=> (= (ControlFlow 0 9) 6) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@92 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_15954_9597_53#PolymorphicMapType_15954| Heap@@92) x@@5 $allocated)) (and (=> (= (ControlFlow 0 11) 1) anon7_Then_correct) (=> (= (ControlFlow 0 11) 9) anon7_Else_correct))))))
