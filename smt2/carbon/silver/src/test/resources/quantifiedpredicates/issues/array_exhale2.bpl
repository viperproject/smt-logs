  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(p(a, i + 1), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i + 1) might not be injective. (array_exhale2.vpr@35.12--35.62) [199683]"}
  ...
  if (*) {
    ...
    // -- check if receiver acc(p(a, i + 1), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i + 1) might not be injective. (array_exhale2.vpr@36.12--36.62) [199684]"}
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver acc(p(a, i + 1), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i + 1) might not be injective. (array_exhale2.vpr@36.12--36.62) [199685]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m1 might not hold. There might be insufficient permission to access p(a, i + 1) (array_exhale2.vpr@36.12--36.62) [199686]"}
        (forall i_8_1: int ::
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i + 1).val might not be injective. (array_exhale2.vpr@41.12--41.68) [199687]"}
      (forall i_1: int, i_1_1: int ::
  ...
  if (*) {
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i + 1).val might not be injective. (array_exhale2.vpr@42.12--42.69) [199688]"}
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver loc(a, i + 1) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i + 1).val might not be injective. (array_exhale2.vpr@42.12--42.69) [199689]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m2 might not hold. There might be insufficient permission to access loc(a, i + 1).val (array_exhale2.vpr@42.12--42.69) [199690]"}
        (forall i_4_1: int ::
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(p(a, i + 1), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i + 1) might not be injective. (array_exhale2.vpr@47.12--47.63) [199691]"}
        (forall i_1: int, i_1_1: int ::
    ...
    // -- Define Inverse Function
      ...
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        ...
        ((invRecv7(a_1_1_1, i_2_1) > 0 && invRecv7(a_1_1_1, i_2_1) < n) && NoPerm < FullPerm) && qpRange7(a_1_1_1, i_2_1) ==> a_2 == a_1_1_1 && invRecv7(a_1_1_1, i_2_1) + 1 == i_2_1
      );
    
    // -- Define updated permissions
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        { QPMask[null, p_2(a_1_1_1, i_2_1)] }
        ((invRecv7(a_1_1_1, i_2_1) > 0 && invRecv7(a_1_1_1, i_2_1) < n) && NoPerm < FullPerm) && qpRange7(a_1_1_1, i_2_1) ==> (NoPerm < FullPerm ==> a_2 == a_1_1_1 && invRecv7(a_1_1_1, i_2_1) + 1 == i_2_1) && QPMask[null, p_2(a_1_1_1, i_2_1)] == Mask[null, p_2(a_1_1_1, i_2_1)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        { QPMask[null, p_2(a_1_1_1, i_2_1)] }
        !(((invRecv7(a_1_1_1, i_2_1) > 0 && invRecv7(a_1_1_1, i_2_1) < n) && NoPerm < FullPerm) && qpRange7(a_1_1_1, i_2_1)) ==> QPMask[null, p_2(a_1_1_1, i_2_1)] == Mask[null, p_2(a_1_1_1, i_2_1)]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of m3 might not hold. There might be insufficient permission to access p(a, 1) (array_exhale2.vpr@50.12--50.24) [199692]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i + 1).val might not be injective. (array_exhale2.vpr@55.12--55.69) [199693]"}
      (forall i_1: int, i_1_1: int ::
    ...
    // -- Define Inverse Function
      ...
      assume (forall o_9: Ref ::
        { invRecv8(o_9) }
        ((invRecv8(o_9) > 0 && invRecv8(o_9) < n) && NoPerm < FullPerm) && qpRange8(o_9) ==> (loc(a_2, invRecv8(o_9) + 1): Ref) == o_9
      );
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        (((invRecv8(o_9) > 0 && invRecv8(o_9) < n) && NoPerm < FullPerm) && qpRange8(o_9) ==> (NoPerm < FullPerm ==> (loc(a_2, invRecv8(o_9) + 1): Ref) == o_9) && QPMask[o_9, val] == Mask[o_9, val] + FullPerm) && (!(((invRecv8(o_9) > 0 && invRecv8(o_9) < n) && NoPerm < FullPerm) && qpRange8(o_9)) ==> QPMask[o_9, val] == Mask[o_9, val])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != val ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of m4 might not hold. There might be insufficient permission to access loc(a, 1).val (array_exhale2.vpr@58.12--58.30) [199694]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(p(a, i + 1), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i + 1) might not be injective. (array_exhale2.vpr@63.12--63.62) [199695]"}
        (forall i_1: int, i_1_1: int ::
    ...
    // -- Define Inverse Function
      ...
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        ...
        ((invRecv9(a_1_1_1, i_2_1) > 0 && invRecv9(a_1_1_1, i_2_1) < n) && NoPerm < FullPerm) && qpRange9(a_1_1_1, i_2_1) ==> a_2 == a_1_1_1 && invRecv9(a_1_1_1, i_2_1) + 1 == i_2_1
      );
    
    // -- Define updated permissions
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        { QPMask[null, p_2(a_1_1_1, i_2_1)] }
        ((invRecv9(a_1_1_1, i_2_1) > 0 && invRecv9(a_1_1_1, i_2_1) < n) && NoPerm < FullPerm) && qpRange9(a_1_1_1, i_2_1) ==> (NoPerm < FullPerm ==> a_2 == a_1_1_1 && invRecv9(a_1_1_1, i_2_1) + 1 == i_2_1) && QPMask[null, p_2(a_1_1_1, i_2_1)] == Mask[null, p_2(a_1_1_1, i_2_1)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        { QPMask[null, p_2(a_1_1_1, i_2_1)] }
        !(((invRecv9(a_1_1_1, i_2_1) > 0 && invRecv9(a_1_1_1, i_2_1) < n) && NoPerm < FullPerm) && qpRange9(a_1_1_1, i_2_1)) ==> QPMask[null, p_2(a_1_1_1, i_2_1)] == Mask[null, p_2(a_1_1_1, i_2_1)]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  if (*) {
    ...
    // -- check if receiver acc(p(a, i), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i) might not be injective. (array_exhale2.vpr@65.12--65.63) [199696]"}
        (forall i_5_1: int, i_5_2: int ::
        { neverTriggered10(i_5_1), neverTriggered10(i_5_2) }
        (((i_5_1 != i_5_2 && (i_5_1 > 1 && i_5_1 < n + 1)) && (i_5_2 > 1 && i_5_2 < n + 1)) && NoPerm < FullPerm) && NoPerm < FullPerm ==> a_2 != a_2 || i_5_1 != i_5_2
      );
    
    // -- Define Inverse Function
      assume (forall i_5_1: int ::
        { PostHeap[null, p_2(a_2, i_5_1)] } { PostMask[null, p_2(a_2, i_5_1)] }
        (i_5_1 > 1 && i_5_1 < n + 1) && NoPerm < FullPerm ==> invRecv10(a_2, i_5_1) == i_5_1 && qpRange10(a_2, i_5_1)
      );
      assume (forall a_2_1: IArrayDomainType, i_6_1: int ::
        { invRecv10(a_2_1, i_6_1) }
        ((invRecv10(a_2_1, i_6_1) > 1 && invRecv10(a_2_1, i_6_1) < n + 1) && NoPerm < FullPerm) && qpRange10(a_2_1, i_6_1) ==> a_2 == a_2_1 && invRecv10(a_2_1, i_6_1) == i_6_1
      );
    
    // -- Define updated permissions
      assume (forall a_2_1: IArrayDomainType, i_6_1: int ::
        { QPMask[null, p_2(a_2_1, i_6_1)] }
        ((invRecv10(a_2_1, i_6_1) > 1 && invRecv10(a_2_1, i_6_1) < n + 1) && NoPerm < FullPerm) && qpRange10(a_2_1, i_6_1) ==> (NoPerm < FullPerm ==> a_2 == a_2_1 && invRecv10(a_2_1, i_6_1) == i_6_1) && QPMask[null, p_2(a_2_1, i_6_1)] == PostMask[null, p_2(a_2_1, i_6_1)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall a_2_1: IArrayDomainType, i_6_1: int ::
        { QPMask[null, p_2(a_2_1, i_6_1)] }
        !(((invRecv10(a_2_1, i_6_1) > 1 && invRecv10(a_2_1, i_6_1) < n + 1) && NoPerm < FullPerm) && qpRange10(a_2_1, i_6_1)) ==> QPMask[null, p_2(a_2_1, i_6_1)] == PostMask[null, p_2(a_2_1, i_6_1)]
      );
    PostMask := QPMask;
    assume state(PostHeap, PostMask);
    assume state(PostHeap, PostMask);
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver acc(p(a, i), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i) might not be injective. (array_exhale2.vpr@65.12--65.63) [199697]"}
        (forall i_8_1: int, i_8_2: int ::
        { neverTriggered11(i_8_1), neverTriggered11(i_8_2) }
        (((i_8_1 != i_8_2 && (i_8_1 > 1 && i_8_1 < n + 1)) && (i_8_2 > 1 && i_8_2 < n + 1)) && NoPerm < FullPerm) && NoPerm < FullPerm ==> a_2 != a_2 || i_8_1 != i_8_2
      );
    
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m5 might not hold. There might be insufficient permission to access p(a, i) (array_exhale2.vpr@65.12--65.63) [199698]"}
        (forall i_8_1: int ::
        { Heap[null, p_2(a_2, i_8_1)] } { Mask[null, p_2(a_2, i_8_1)] }
        i_8_1 > 1 && i_8_1 < n + 1 ==> Mask[null, p_2(a_2, i_8_1)] >= FullPerm
      );
    
    // -- assumptions for inverse of receiver acc(p(a, i), write)
      assume (forall i_8_1: int ::
        { Heap[null, p_2(a_2, i_8_1)] } { Mask[null, p_2(a_2, i_8_1)] }
        (i_8_1 > 1 && i_8_1 < n + 1) && NoPerm < FullPerm ==> invRecv11(a_2, i_8_1) == i_8_1 && qpRange11(a_2, i_8_1)
      );
      assume (forall a_3_1_1: IArrayDomainType, i_9_1_1: int ::
    ...
    // -- assume permission updates
      assume (forall a_3_1_1: IArrayDomainType, i_9_1_1: int ::
        { QPMask[null, p_2(a_3_1_1, i_9_1_1)] }
        ((invRecv11(a_3_1_1, i_9_1_1) > 1 && invRecv11(a_3_1_1, i_9_1_1) < n + 1) && NoPerm < FullPerm) && qpRange11(a_3_1_1, i_9_1_1) ==> (a_2 == a_3_1_1 && invRecv11(a_3_1_1, i_9_1_1) == i_9_1_1) && QPMask[null, p_2(a_3_1_1, i_9_1_1)] == Mask[null, p_2(a_3_1_1, i_9_1_1)] - FullPerm
      );
      assume (forall a_3_1_1: IArrayDomainType, i_9_1_1: int ::
        { QPMask[null, p_2(a_3_1_1, i_9_1_1)] }
        !(((invRecv11(a_3_1_1, i_9_1_1) > 1 && invRecv11(a_3_1_1, i_9_1_1) < n + 1) && NoPerm < FullPerm) && qpRange11(a_3_1_1, i_9_1_1)) ==> QPMask[null, p_2(a_3_1_1, i_9_1_1)] == Mask[null, p_2(a_3_1_1, i_9_1_1)]
      );
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i + 1).val might not be injective. (array_exhale2.vpr@70.12--70.70) [199699]"}
      (forall i_1: int, i_1_1: int ::
    ...
    // -- Define Inverse Function
      ...
      assume (forall o_9: Ref ::
        { invRecv12(o_9) }
        ((invRecv12(o_9) > 0 && invRecv12(o_9) < n) && NoPerm < FullPerm) && qpRange12(o_9) ==> (loc(a_2, invRecv12(o_9) + 1): Ref) == o_9
      );
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        (((invRecv12(o_9) > 0 && invRecv12(o_9) < n) && NoPerm < FullPerm) && qpRange12(o_9) ==> (NoPerm < FullPerm ==> (loc(a_2, invRecv12(o_9) + 1): Ref) == o_9) && QPMask[o_9, val] == Mask[o_9, val] + FullPerm) && (!(((invRecv12(o_9) > 0 && invRecv12(o_9) < n) && NoPerm < FullPerm) && qpRange12(o_9)) ==> QPMask[o_9, val] == Mask[o_9, val])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != val ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
  ...
  if (*) {
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i).val might not be injective. (array_exhale2.vpr@72.12--72.70) [199700]"}
      (forall i_3_2: int, i_3_3: int ::
      
      (((i_3_2 != i_3_3 && (i_3_2 > 1 && i_3_2 < n + 1)) && (i_3_3 > 1 && i_3_3 < n + 1)) && NoPerm < FullPerm) && NoPerm < FullPerm ==> (loc(a_2, i_3_2): Ref) != (loc(a_2, i_3_3): Ref)
    );
    
    // -- Define Inverse Function
      assume (forall i_3_2: int ::
        { (loc(a_2, i_3_2): Ref) } { (loc(a_2, i_3_2): Ref) }
        (i_3_2 > 1 && i_3_2 < n + 1) && NoPerm < FullPerm ==> qpRange13((loc(a_2, i_3_2): Ref)) && invRecv13((loc(a_2, i_3_2): Ref)) == i_3_2
      );
      assume (forall o_9: Ref ::
        { invRecv13(o_9) }
        ((invRecv13(o_9) > 1 && invRecv13(o_9) < n + 1) && NoPerm < FullPerm) && qpRange13(o_9) ==> (loc(a_2, invRecv13(o_9)): Ref) == o_9
      );
    
    // -- Assume set of fields is nonNull
      assume (forall i_3_2: int ::
        { (loc(a_2, i_3_2): Ref) } { (loc(a_2, i_3_2): Ref) }
        i_3_2 > 1 && i_3_2 < n + 1 ==> (loc(a_2, i_3_2): Ref) != null
      );
    
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        (((invRecv13(o_9) > 1 && invRecv13(o_9) < n + 1) && NoPerm < FullPerm) && qpRange13(o_9) ==> (NoPerm < FullPerm ==> (loc(a_2, invRecv13(o_9)): Ref) == o_9) && QPMask[o_9, val] == PostMask[o_9, val] + FullPerm) && (!(((invRecv13(o_9) > 1 && invRecv13(o_9) < n + 1) && NoPerm < FullPerm) && qpRange13(o_9)) ==> QPMask[o_9, val] == PostMask[o_9, val])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { PostMask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != val ==> PostMask[o_9, f_5] == QPMask[o_9, f_5]
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver loc(a, i) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i).val might not be injective. (array_exhale2.vpr@72.12--72.70) [199701]"}
        (forall i_4_1: int, i_4_2: int ::
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m6 might not hold. There might be insufficient permission to access loc(a, i).val (array_exhale2.vpr@72.12--72.70) [199702]"}
        (forall i_4_1: int ::
    ...
    // -- assumptions for inverse of receiver loc(a, i)
      ...
      assume (forall o_9: Ref ::
        { invRecv14(o_9) }
        (invRecv14(o_9) > 1 && invRecv14(o_9) < n + 1) && (NoPerm < FullPerm && qpRange14(o_9)) ==> (loc(a_2, invRecv14(o_9)): Ref) == o_9
      );
    
    // -- assume permission updates for field val
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        ((invRecv14(o_9) > 1 && invRecv14(o_9) < n + 1) && (NoPerm < FullPerm && qpRange14(o_9)) ==> (loc(a_2, invRecv14(o_9)): Ref) == o_9 && QPMask[o_9, val] == Mask[o_9, val] - FullPerm) && (!((invRecv14(o_9) > 1 && invRecv14(o_9) < n + 1) && (NoPerm < FullPerm && qpRange14(o_9))) ==> QPMask[o_9, val] == Mask[o_9, val])
      );
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(p(a, i), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i) might not be injective. (array_exhale2.vpr@77.12--77.64) [199703]"}
        (forall i_1: int, i_1_1: int ::
    ...
    // -- Define Inverse Function
      ...
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        ...
        ((invRecv15(a_1_1_1, i_2_1) > 1 && invRecv15(a_1_1_1, i_2_1) < n + 1) && NoPerm < FullPerm) && qpRange15(a_1_1_1, i_2_1) ==> a_2 == a_1_1_1 && invRecv15(a_1_1_1, i_2_1) == i_2_1
      );
    
    // -- Define updated permissions
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        { QPMask[null, p_2(a_1_1_1, i_2_1)] }
        ((invRecv15(a_1_1_1, i_2_1) > 1 && invRecv15(a_1_1_1, i_2_1) < n + 1) && NoPerm < FullPerm) && qpRange15(a_1_1_1, i_2_1) ==> (NoPerm < FullPerm ==> a_2 == a_1_1_1 && invRecv15(a_1_1_1, i_2_1) == i_2_1) && QPMask[null, p_2(a_1_1_1, i_2_1)] == Mask[null, p_2(a_1_1_1, i_2_1)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        { QPMask[null, p_2(a_1_1_1, i_2_1)] }
        !(((invRecv15(a_1_1_1, i_2_1) > 1 && invRecv15(a_1_1_1, i_2_1) < n + 1) && NoPerm < FullPerm) && qpRange15(a_1_1_1, i_2_1)) ==> QPMask[null, p_2(a_1_1_1, i_2_1)] == Mask[null, p_2(a_1_1_1, i_2_1)]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  if (*) {
    ...
    // -- check if receiver acc(p(a, i + 1), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i + 1) might not be injective. (array_exhale2.vpr@78.12--78.63) [199704]"}
        (forall i_5_1: int, i_5_2: int ::
    ...
    // -- Define Inverse Function
      assume (forall i_5_1: int ::
        ...
        (i_5_1 > 0 && i_5_1 < n) && NoPerm < FullPerm ==> invRecv16(a_2, i_5_1 + 1) == i_5_1 && qpRange16(a_2, i_5_1 + 1)
      );
      assume (forall a_2_1: IArrayDomainType, i_6_1: int ::
        { invRecv16(a_2_1, i_6_1) }
        ((invRecv16(a_2_1, i_6_1) > 0 && invRecv16(a_2_1, i_6_1) < n) && NoPerm < FullPerm) && qpRange16(a_2_1, i_6_1) ==> a_2 == a_2_1 && invRecv16(a_2_1, i_6_1) + 1 == i_6_1
      );
    
    // -- Define updated permissions
      assume (forall a_2_1: IArrayDomainType, i_6_1: int ::
        { QPMask[null, p_2(a_2_1, i_6_1)] }
        ((invRecv16(a_2_1, i_6_1) > 0 && invRecv16(a_2_1, i_6_1) < n) && NoPerm < FullPerm) && qpRange16(a_2_1, i_6_1) ==> (NoPerm < FullPerm ==> a_2 == a_2_1 && invRecv16(a_2_1, i_6_1) + 1 == i_6_1) && QPMask[null, p_2(a_2_1, i_6_1)] == PostMask[null, p_2(a_2_1, i_6_1)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall a_2_1: IArrayDomainType, i_6_1: int ::
        { QPMask[null, p_2(a_2_1, i_6_1)] }
        !(((invRecv16(a_2_1, i_6_1) > 0 && invRecv16(a_2_1, i_6_1) < n) && NoPerm < FullPerm) && qpRange16(a_2_1, i_6_1)) ==> QPMask[null, p_2(a_2_1, i_6_1)] == PostMask[null, p_2(a_2_1, i_6_1)]
      );
    PostMask := QPMask;
    assume state(PostHeap, PostMask);
    assume state(PostHeap, PostMask);
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver acc(p(a, i + 1), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i + 1) might not be injective. (array_exhale2.vpr@78.12--78.63) [199705]"}
        (forall i_8_1: int, i_8_2: int ::
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m7 might not hold. There might be insufficient permission to access p(a, i + 1) (array_exhale2.vpr@78.12--78.63) [199706]"}
        (forall i_8_1: int ::
    ...
    // -- assumptions for inverse of receiver acc(p(a, i + 1), write)
      assume (forall i_8_1: int ::
        ...
        (i_8_1 > 0 && i_8_1 < n) && NoPerm < FullPerm ==> invRecv17(a_2, i_8_1 + 1) == i_8_1 && qpRange17(a_2, i_8_1 + 1)
      );
      assume (forall a_3_1_1: IArrayDomainType, i_9_1_1: int ::
    ...
    // -- assume permission updates
      assume (forall a_3_1_1: IArrayDomainType, i_9_1_1: int ::
        { QPMask[null, p_2(a_3_1_1, i_9_1_1)] }
        ((invRecv17(a_3_1_1, i_9_1_1) > 0 && invRecv17(a_3_1_1, i_9_1_1) < n) && NoPerm < FullPerm) && qpRange17(a_3_1_1, i_9_1_1) ==> (a_2 == a_3_1_1 && invRecv17(a_3_1_1, i_9_1_1) + 1 == i_9_1_1) && QPMask[null, p_2(a_3_1_1, i_9_1_1)] == Mask[null, p_2(a_3_1_1, i_9_1_1)] - FullPerm
      );
      assume (forall a_3_1_1: IArrayDomainType, i_9_1_1: int ::
        { QPMask[null, p_2(a_3_1_1, i_9_1_1)] }
        !(((invRecv17(a_3_1_1, i_9_1_1) > 0 && invRecv17(a_3_1_1, i_9_1_1) < n) && NoPerm < FullPerm) && qpRange17(a_3_1_1, i_9_1_1)) ==> QPMask[null, p_2(a_3_1_1, i_9_1_1)] == Mask[null, p_2(a_3_1_1, i_9_1_1)]
      );
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i).val might not be injective. (array_exhale2.vpr@83.12--83.70) [199707]"}
      (forall i_1: int, i_1_1: int ::
    ...
    // -- Define Inverse Function
      ...
      assume (forall o_9: Ref ::
        { invRecv18(o_9) }
        ((invRecv18(o_9) > 1 && invRecv18(o_9) < n + 1) && NoPerm < FullPerm) && qpRange18(o_9) ==> (loc(a_2, invRecv18(o_9)): Ref) == o_9
      );
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        (((invRecv18(o_9) > 1 && invRecv18(o_9) < n + 1) && NoPerm < FullPerm) && qpRange18(o_9) ==> (NoPerm < FullPerm ==> (loc(a_2, invRecv18(o_9)): Ref) == o_9) && QPMask[o_9, val] == Mask[o_9, val] + FullPerm) && (!(((invRecv18(o_9) > 1 && invRecv18(o_9) < n + 1) && NoPerm < FullPerm) && qpRange18(o_9)) ==> QPMask[o_9, val] == Mask[o_9, val])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != val ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
  ...
  if (*) {
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i + 1).val might not be injective. (array_exhale2.vpr@84.12--84.70) [199708]"}
      (forall i_3_2: int, i_3_3: int ::
    ...
    // -- Define Inverse Function
      assume (forall i_3_2: int ::
        ...
        (i_3_2 > 0 && i_3_2 < n) && NoPerm < FullPerm ==> qpRange19((loc(a_2, i_3_2 + 1): Ref)) && invRecv19((loc(a_2, i_3_2 + 1): Ref)) == i_3_2
      );
      assume (forall o_9: Ref ::
        { invRecv19(o_9) }
        ((invRecv19(o_9) > 0 && invRecv19(o_9) < n) && NoPerm < FullPerm) && qpRange19(o_9) ==> (loc(a_2, invRecv19(o_9) + 1): Ref) == o_9
      );
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        (((invRecv19(o_9) > 0 && invRecv19(o_9) < n) && NoPerm < FullPerm) && qpRange19(o_9) ==> (NoPerm < FullPerm ==> (loc(a_2, invRecv19(o_9) + 1): Ref) == o_9) && QPMask[o_9, val] == PostMask[o_9, val] + FullPerm) && (!(((invRecv19(o_9) > 0 && invRecv19(o_9) < n) && NoPerm < FullPerm) && qpRange19(o_9)) ==> QPMask[o_9, val] == PostMask[o_9, val])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { PostMask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != val ==> PostMask[o_9, f_5] == QPMask[o_9, f_5]
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver loc(a, i + 1) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i + 1).val might not be injective. (array_exhale2.vpr@84.12--84.70) [199709]"}
        (forall i_4_1: int, i_4_2: int ::
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m8 might not hold. There might be insufficient permission to access loc(a, i + 1).val (array_exhale2.vpr@84.12--84.70) [199710]"}
        (forall i_4_1: int ::
    ...
    // -- assumptions for inverse of receiver loc(a, i + 1)
      ...
      assume (forall o_9: Ref ::
        { invRecv20(o_9) }
        (invRecv20(o_9) > 0 && invRecv20(o_9) < n) && (NoPerm < FullPerm && qpRange20(o_9)) ==> (loc(a_2, invRecv20(o_9) + 1): Ref) == o_9
      );
    
    // -- assume permission updates for field val
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        ((invRecv20(o_9) > 0 && invRecv20(o_9) < n) && (NoPerm < FullPerm && qpRange20(o_9)) ==> (loc(a_2, invRecv20(o_9) + 1): Ref) == o_9 && QPMask[o_9, val] == Mask[o_9, val] - FullPerm) && (!((invRecv20(o_9) > 0 && invRecv20(o_9) < n) && (NoPerm < FullPerm && qpRange20(o_9))) ==> QPMask[o_9, val] == Mask[o_9, val])
      );
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(p(a, i), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i) might not be injective. (array_exhale2.vpr@89.12--89.61) [199711]"}
        (forall i_1: int, i_1_1: int ::
    ...
    // -- Define Inverse Function
      ...
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        ...
        ((invRecv21(a_1_1_1, i_2_1) > 0 && invRecv21(a_1_1_1, i_2_1) < n) && NoPerm < FullPerm) && qpRange21(a_1_1_1, i_2_1) ==> a_2 == a_1_1_1 && invRecv21(a_1_1_1, i_2_1) == i_2_1
      );
    
    // -- Define updated permissions
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        { QPMask[null, p_2(a_1_1_1, i_2_1)] }
        ((invRecv21(a_1_1_1, i_2_1) > 0 && invRecv21(a_1_1_1, i_2_1) < n) && NoPerm < FullPerm) && qpRange21(a_1_1_1, i_2_1) ==> (NoPerm < FullPerm ==> a_2 == a_1_1_1 && invRecv21(a_1_1_1, i_2_1) == i_2_1) && QPMask[null, p_2(a_1_1_1, i_2_1)] == Mask[null, p_2(a_1_1_1, i_2_1)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall a_1_1_1: IArrayDomainType, i_2_1: int ::
        { QPMask[null, p_2(a_1_1_1, i_2_1)] }
        !(((invRecv21(a_1_1_1, i_2_1) > 0 && invRecv21(a_1_1_1, i_2_1) < n) && NoPerm < FullPerm) && qpRange21(a_1_1_1, i_2_1)) ==> QPMask[null, p_2(a_1_1_1, i_2_1)] == Mask[null, p_2(a_1_1_1, i_2_1)]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  if (*) {
    ...
    // -- check if receiver acc(p(a, i), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i) might not be injective. (array_exhale2.vpr@90.11--90.60) [199712]"}
        (forall i_5_1: int, i_5_2: int ::
        { neverTriggered22(i_5_1), neverTriggered22(i_5_2) }
        (((i_5_1 != i_5_2 && (i_5_1 > 4 && i_5_1 < n)) && (i_5_2 > 4 && i_5_2 < n)) && NoPerm < FullPerm) && NoPerm < FullPerm ==> a_2 != a_2 || i_5_1 != i_5_2
      );
    
    // -- Define Inverse Function
      assume (forall i_5_1: int ::
        { PostHeap[null, p_2(a_2, i_5_1)] } { PostMask[null, p_2(a_2, i_5_1)] }
        (i_5_1 > 4 && i_5_1 < n) && NoPerm < FullPerm ==> invRecv22(a_2, i_5_1) == i_5_1 && qpRange22(a_2, i_5_1)
      );
      assume (forall a_2_1: IArrayDomainType, i_6_1: int ::
        { invRecv22(a_2_1, i_6_1) }
        ((invRecv22(a_2_1, i_6_1) > 4 && invRecv22(a_2_1, i_6_1) < n) && NoPerm < FullPerm) && qpRange22(a_2_1, i_6_1) ==> a_2 == a_2_1 && invRecv22(a_2_1, i_6_1) == i_6_1
      );
    
    // -- Define updated permissions
      assume (forall a_2_1: IArrayDomainType, i_6_1: int ::
        { QPMask[null, p_2(a_2_1, i_6_1)] }
        ((invRecv22(a_2_1, i_6_1) > 4 && invRecv22(a_2_1, i_6_1) < n) && NoPerm < FullPerm) && qpRange22(a_2_1, i_6_1) ==> (NoPerm < FullPerm ==> a_2 == a_2_1 && invRecv22(a_2_1, i_6_1) == i_6_1) && QPMask[null, p_2(a_2_1, i_6_1)] == PostMask[null, p_2(a_2_1, i_6_1)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall a_2_1: IArrayDomainType, i_6_1: int ::
        { QPMask[null, p_2(a_2_1, i_6_1)] }
        !(((invRecv22(a_2_1, i_6_1) > 4 && invRecv22(a_2_1, i_6_1) < n) && NoPerm < FullPerm) && qpRange22(a_2_1, i_6_1)) ==> QPMask[null, p_2(a_2_1, i_6_1)] == PostMask[null, p_2(a_2_1, i_6_1)]
      );
    PostMask := QPMask;
    assume state(PostHeap, PostMask);
    assume state(PostHeap, PostMask);
    ...
    // -- check if receiver acc(p(a, i), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i) might not be injective. (array_exhale2.vpr@91.11--91.61) [199713]"}
    ...
    // -- Define Inverse Function
      assume (forall i_9_1: int ::
        { PostHeap[null, p_2(a_2, i_9_1)] } { PostMask[null, p_2(a_2, i_9_1)] }
    ...
    // -- Define updated permissions
      assume (forall a_3_1_1: IArrayDomainType, i_10_1_1: int ::
        ...
        ((invRecv23(a_3_1_1, i_10_1_1) > 0 && invRecv23(a_3_1_1, i_10_1_1) < 4) && NoPerm < FullPerm) && qpRange23(a_3_1_1, i_10_1_1) ==> (NoPerm < FullPerm ==> a_2 == a_3_1_1 && invRecv23(a_3_1_1, i_10_1_1) == i_10_1_1) && QPMask[null, p_2(a_3_1_1, i_10_1_1)] == PostMask[null, p_2(a_3_1_1, i_10_1_1)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall a_3_1_1: IArrayDomainType, i_10_1_1: int ::
        { QPMask[null, p_2(a_3_1_1, i_10_1_1)] }
        !(((invRecv23(a_3_1_1, i_10_1_1) > 0 && invRecv23(a_3_1_1, i_10_1_1) < 4) && NoPerm < FullPerm) && qpRange23(a_3_1_1, i_10_1_1)) ==> QPMask[null, p_2(a_3_1_1, i_10_1_1)] == PostMask[null, p_2(a_3_1_1, i_10_1_1)]
      );
    PostMask := QPMask;
    assume state(PostHeap, PostMask);
    assume state(PostHeap, PostMask);
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver acc(p(a, i), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i) might not be injective. (array_exhale2.vpr@90.11--90.60) [199714]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m9 might not hold. There might be insufficient permission to access p(a, i) (array_exhale2.vpr@90.11--90.60) [199715]"}
        (forall i_12_1: int ::
        { Heap[null, p_2(a_2, i_12_1)] } { Mask[null, p_2(a_2, i_12_1)] }
        i_12_1 > 4 && i_12_1 < n ==> Mask[null, p_2(a_2, i_12_1)] >= FullPerm
      );
    ...
    // -- assumptions for inverse of receiver acc(p(a, i), write)
      ...
      assume (forall a_4_1_1: IArrayDomainType, i_13_1_1: int ::
        ...
        ((invRecv24(a_4_1_1, i_13_1_1) > 4 && invRecv24(a_4_1_1, i_13_1_1) < n) && NoPerm < FullPerm) && qpRange24(a_4_1_1, i_13_1_1) ==> a_2 == a_4_1_1 && invRecv24(a_4_1_1, i_13_1_1) == i_13_1_1
      );
    
    // -- assume permission updates
      assume (forall a_4_1_1: IArrayDomainType, i_13_1_1: int ::
        { QPMask[null, p_2(a_4_1_1, i_13_1_1)] }
        ((invRecv24(a_4_1_1, i_13_1_1) > 4 && invRecv24(a_4_1_1, i_13_1_1) < n) && NoPerm < FullPerm) && qpRange24(a_4_1_1, i_13_1_1) ==> (a_2 == a_4_1_1 && invRecv24(a_4_1_1, i_13_1_1) == i_13_1_1) && QPMask[null, p_2(a_4_1_1, i_13_1_1)] == Mask[null, p_2(a_4_1_1, i_13_1_1)] - FullPerm
      );
      assume (forall a_4_1_1: IArrayDomainType, i_13_1_1: int ::
        { QPMask[null, p_2(a_4_1_1, i_13_1_1)] }
        !(((invRecv24(a_4_1_1, i_13_1_1) > 4 && invRecv24(a_4_1_1, i_13_1_1) < n) && NoPerm < FullPerm) && qpRange24(a_4_1_1, i_13_1_1)) ==> QPMask[null, p_2(a_4_1_1, i_13_1_1)] == Mask[null, p_2(a_4_1_1, i_13_1_1)]
      );
    ...
    // -- check if receiver acc(p(a, i), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource p(a, i) might not be injective. (array_exhale2.vpr@91.11--91.61) [199716]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m9 might not hold. There might be insufficient permission to access p(a, i) (array_exhale2.vpr@91.11--91.61) [199717]"}
        (forall i_14_1: int ::
        { Heap[null, p_2(a_2, i_14_1)] } { Mask[null, p_2(a_2, i_14_1)] }
        i_14_1 > 0 && i_14_1 < 4 ==> Mask[null, p_2(a_2, i_14_1)] >= FullPerm
      );
    ...
    // -- assume permission updates
      assume (forall a_5_1_1: IArrayDomainType, i_15_1_1: int ::
        ...
        ((invRecv25(a_5_1_1, i_15_1_1) > 0 && invRecv25(a_5_1_1, i_15_1_1) < 4) && NoPerm < FullPerm) && qpRange25(a_5_1_1, i_15_1_1) ==> (a_2 == a_5_1_1 && invRecv25(a_5_1_1, i_15_1_1) == i_15_1_1) && QPMask[null, p_2(a_5_1_1, i_15_1_1)] == Mask[null, p_2(a_5_1_1, i_15_1_1)] - FullPerm
      );
      assume (forall a_5_1_1: IArrayDomainType, i_15_1_1: int ::
        { QPMask[null, p_2(a_5_1_1, i_15_1_1)] }
        !(((invRecv25(a_5_1_1, i_15_1_1) > 0 && invRecv25(a_5_1_1, i_15_1_1) < 4) && NoPerm < FullPerm) && qpRange25(a_5_1_1, i_15_1_1)) ==> QPMask[null, p_2(a_5_1_1, i_15_1_1)] == Mask[null, p_2(a_5_1_1, i_15_1_1)]
      );
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i).val might not be injective. (array_exhale2.vpr@96.12--96.66) [199718]"}
      (forall i_1: int, i_1_1: int ::
    ...
    // -- Define Inverse Function
      ...
      assume (forall o_9: Ref ::
        { invRecv26(o_9) }
        ((invRecv26(o_9) > 0 && invRecv26(o_9) < n) && NoPerm < FullPerm) && qpRange26(o_9) ==> (loc(a_2, invRecv26(o_9)): Ref) == o_9
      );
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        (((invRecv26(o_9) > 0 && invRecv26(o_9) < n) && NoPerm < FullPerm) && qpRange26(o_9) ==> (NoPerm < FullPerm ==> (loc(a_2, invRecv26(o_9)): Ref) == o_9) && QPMask[o_9, val] == Mask[o_9, val] + FullPerm) && (!(((invRecv26(o_9) > 0 && invRecv26(o_9) < n) && NoPerm < FullPerm) && qpRange26(o_9)) ==> QPMask[o_9, val] == Mask[o_9, val])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != val ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
  ...
  if (*) {
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i).val might not be injective. (array_exhale2.vpr@97.11--97.65) [199719]"}
      (forall i_3_2: int, i_3_3: int ::
      
      (((i_3_2 != i_3_3 && (i_3_2 > 4 && i_3_2 < n)) && (i_3_3 > 4 && i_3_3 < n)) && NoPerm < FullPerm) && NoPerm < FullPerm ==> (loc(a_2, i_3_2): Ref) != (loc(a_2, i_3_3): Ref)
    );
    
    // -- Define Inverse Function
      assume (forall i_3_2: int ::
        { (loc(a_2, i_3_2): Ref) } { (loc(a_2, i_3_2): Ref) }
        (i_3_2 > 4 && i_3_2 < n) && NoPerm < FullPerm ==> qpRange27((loc(a_2, i_3_2): Ref)) && invRecv27((loc(a_2, i_3_2): Ref)) == i_3_2
      );
      assume (forall o_9: Ref ::
        { invRecv27(o_9) }
        ((invRecv27(o_9) > 4 && invRecv27(o_9) < n) && NoPerm < FullPerm) && qpRange27(o_9) ==> (loc(a_2, invRecv27(o_9)): Ref) == o_9
      );
    
    // -- Assume set of fields is nonNull
      assume (forall i_3_2: int ::
        { (loc(a_2, i_3_2): Ref) } { (loc(a_2, i_3_2): Ref) }
        i_3_2 > 4 && i_3_2 < n ==> (loc(a_2, i_3_2): Ref) != null
      );
    
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        (((invRecv27(o_9) > 4 && invRecv27(o_9) < n) && NoPerm < FullPerm) && qpRange27(o_9) ==> (NoPerm < FullPerm ==> (loc(a_2, invRecv27(o_9)): Ref) == o_9) && QPMask[o_9, val] == PostMask[o_9, val] + FullPerm) && (!(((invRecv27(o_9) > 4 && invRecv27(o_9) < n) && NoPerm < FullPerm) && qpRange27(o_9)) ==> QPMask[o_9, val] == PostMask[o_9, val])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { PostMask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != val ==> PostMask[o_9, f_5] == QPMask[o_9, f_5]
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i).val might not be injective. (array_exhale2.vpr@98.11--98.66) [199720]"}
      (forall i_5_1: int, i_5_2: int ::
      
      (((i_5_1 != i_5_2 && (i_5_1 > 0 && i_5_1 < 4)) && (i_5_2 > 0 && i_5_2 < 4)) && NoPerm < FullPerm) && NoPerm < FullPerm ==> (loc(a_2, i_5_1): Ref) != (loc(a_2, i_5_2): Ref)
    );
    
    // -- Define Inverse Function
      assume (forall i_5_1: int ::
        { (loc(a_2, i_5_1): Ref) } { (loc(a_2, i_5_1): Ref) }
        (i_5_1 > 0 && i_5_1 < 4) && NoPerm < FullPerm ==> qpRange28((loc(a_2, i_5_1): Ref)) && invRecv28((loc(a_2, i_5_1): Ref)) == i_5_1
      );
      assume (forall o_9: Ref ::
        { invRecv28(o_9) }
        ((invRecv28(o_9) > 0 && invRecv28(o_9) < 4) && NoPerm < FullPerm) && qpRange28(o_9) ==> (loc(a_2, invRecv28(o_9)): Ref) == o_9
      );
    
    // -- Assume set of fields is nonNull
      assume (forall i_5_1: int ::
        { (loc(a_2, i_5_1): Ref) } { (loc(a_2, i_5_1): Ref) }
        i_5_1 > 0 && i_5_1 < 4 ==> (loc(a_2, i_5_1): Ref) != null
      );
    
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        (((invRecv28(o_9) > 0 && invRecv28(o_9) < 4) && NoPerm < FullPerm) && qpRange28(o_9) ==> (NoPerm < FullPerm ==> (loc(a_2, invRecv28(o_9)): Ref) == o_9) && QPMask[o_9, val] == PostMask[o_9, val] + FullPerm) && (!(((invRecv28(o_9) > 0 && invRecv28(o_9) < 4) && NoPerm < FullPerm) && qpRange28(o_9)) ==> QPMask[o_9, val] == PostMask[o_9, val])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { PostMask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != val ==> PostMask[o_9, f_5] == QPMask[o_9, f_5]
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver loc(a, i) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i).val might not be injective. (array_exhale2.vpr@97.11--97.65) [199721]"}
        (forall i_6_2: int, i_6_3: int ::
        { neverTriggered29(i_6_2), neverTriggered29(i_6_3) }
        (((i_6_2 != i_6_3 && (i_6_2 > 4 && i_6_2 < n)) && (i_6_3 > 4 && i_6_3 < n)) && NoPerm < FullPerm) && NoPerm < FullPerm ==> (loc(a_2, i_6_2): Ref) != (loc(a_2, i_6_3): Ref)
      );
    
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m10 might not hold. There might be insufficient permission to access loc(a, i).val (array_exhale2.vpr@97.11--97.65) [199722]"}
        (forall i_6_2: int ::
        { (loc(a_2, i_6_2): Ref) } { (loc(a_2, i_6_2): Ref) }
        i_6_2 > 4 && i_6_2 < n ==> Mask[(loc(a_2, i_6_2): Ref), val] >= FullPerm
      );
    
    // -- assumptions for inverse of receiver loc(a, i)
      assume (forall i_6_2: int ::
        { (loc(a_2, i_6_2): Ref) } { (loc(a_2, i_6_2): Ref) }
        (i_6_2 > 4 && i_6_2 < n) && NoPerm < FullPerm ==> qpRange29((loc(a_2, i_6_2): Ref)) && invRecv29((loc(a_2, i_6_2): Ref)) == i_6_2
      );
      assume (forall o_9: Ref ::
        { invRecv29(o_9) }
        (invRecv29(o_9) > 4 && invRecv29(o_9) < n) && (NoPerm < FullPerm && qpRange29(o_9)) ==> (loc(a_2, invRecv29(o_9)): Ref) == o_9
      );
    
    // -- assume permission updates for field val
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        ((invRecv29(o_9) > 4 && invRecv29(o_9) < n) && (NoPerm < FullPerm && qpRange29(o_9)) ==> (loc(a_2, invRecv29(o_9)): Ref) == o_9 && QPMask[o_9, val] == Mask[o_9, val] - FullPerm) && (!((invRecv29(o_9) > 4 && invRecv29(o_9) < n) && (NoPerm < FullPerm && qpRange29(o_9))) ==> QPMask[o_9, val] == Mask[o_9, val])
      );
    ...
    // -- check if receiver loc(a, i) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource loc(a, i).val might not be injective. (array_exhale2.vpr@98.11--98.66) [199723]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m10 might not hold. There might be insufficient permission to access loc(a, i).val (array_exhale2.vpr@98.11--98.66) [199724]"}
        (forall i_7_1: int ::
    ...
    // -- assumptions for inverse of receiver loc(a, i)
      ...
      assume (forall o_9: Ref ::
        { invRecv30(o_9) }
        (invRecv30(o_9) > 0 && invRecv30(o_9) < 4) && (NoPerm < FullPerm && qpRange30(o_9)) ==> (loc(a_2, invRecv30(o_9)): Ref) == o_9
      );
    
    // -- assume permission updates for field val
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        ((invRecv30(o_9) > 0 && invRecv30(o_9) < 4) && (NoPerm < FullPerm && qpRange30(o_9)) ==> (loc(a_2, invRecv30(o_9)): Ref) == o_9 && QPMask[o_9, val] == Mask[o_9, val] - FullPerm) && (!((invRecv30(o_9) > 0 && invRecv30(o_9) < 4) && (NoPerm < FullPerm && qpRange30(o_9))) ==> QPMask[o_9, val] == Mask[o_9, val])
      );
