...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (> i_3_2 0) (< i_3_2 n@@13))) (and (> i_3_3 0) (< i_3_3 n@@13))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_3_2 1)) (loc a_2@@8 (+ i_3_3 1)))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (and (> i_4_1 0) (< i_4_1 n@@13))) (and (> i_4_2 0) (< i_4_2 n@@13))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_4_1 1)) (loc a_2@@8 (+ i_4_2 1)))))
 :qid |stdinbpl.1049:17|
 :skolemid |98|
 :pattern ( (neverTriggered6 i_4_1) (neverTriggered6 i_4_2))
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (and (> i_4_1@@0 0) (< i_4_1@@0 n@@13))) (and (> i_4_2@@0 0) (< i_4_2@@0 n@@13))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_4_1@@0 1)) (loc a_2@@8 (+ i_4_2@@0 1)))))
 :qid |stdinbpl.1049:17|
 :skolemid |98|
 :pattern ( (neverTriggered6 i_4_1@@0) (neverTriggered6 i_4_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_4_1@@1 Int) ) (!  (=> (and (> i_4_1@@1 0) (< i_4_1@@1 n@@13)) (>= (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) (loc a_2@@8 (+ i_4_1@@1 1)) val) FullPerm))
 :qid |stdinbpl.1056:17|
 :skolemid |99|
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (> i_1 0) (< i_1 n@@13))) (and (> i_1_1 0) (< i_1_1 n@@13))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1 1)) (loc a_2@@8 (+ i_1_1 1)))))
 :qid |stdinbpl.951:15|
 :skolemid |86|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (> i_1@@0 0) (< i_1@@0 n@@13))) (and (> i_1_1@@0 0) (< i_1_1@@0 n@@13))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1@@0 1)) (loc a_2@@8 (+ i_1_1@@0 1)))))
 :qid |stdinbpl.951:15|
 :skolemid |86|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (> i_1@@1 0) (< i_1@@1 n@@13)) (< NoPerm FullPerm)) (and (qpRange4 (loc a_2@@8 (+ i_1@@1 1))) (= (invRecv4 (loc a_2@@8 (+ i_1@@1 1))) i_1@@1)))
 :qid |stdinbpl.957:22|
 :skolemid |87|
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (> (invRecv4 o_9) 0) (< (invRecv4 o_9) n@@13)) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (loc a_2@@8 (+ (invRecv4 o_9) 1)) o_9))
 :qid |stdinbpl.961:22|
 :skolemid |88|
 :pattern ( (invRecv4 o_9))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (> i_1@@2 0) (< i_1@@2 n@@13)) (not (= (loc a_2@@8 (+ i_1@@2 1)) null)))
 :qid |stdinbpl.967:22|
 :skolemid |89|
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (> (invRecv4 o_9@@0) 0) (< (invRecv4 o_9@@0) n@@13)) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@8 (+ (invRecv4 o_9@@0) 1)) o_9@@0)) (= (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (> (invRecv4 o_9@@0) 0) (< (invRecv4 o_9@@0) n@@13)) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.973:22|
 :skolemid |90|
