...
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((j_6_1@@1 Int) ) (!  (=> (and (>= j_6_1@@1 0) (and (< j_6_1@@1 (len_1 a_2@@7)) (= (mod j_6_1@@1 2) 0))) (>= (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| Mask@16) null (access a_2@@7 j_6_1@@1)) FullPerm))
 :qid |stdinbpl.825:17|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_31285_19410_19411#PolymorphicMapType_31285| Heap@16) null (access a_2@@7 j_6_1@@1)))
 :pattern ( (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| Mask@16) null (access a_2@@7 j_6_1@@1)))
))))))))))))
...
(let ((anon13_correct  (=> (and (state Heap@9 Mask@11) (state Heap@9 Mask@11)) (and (=> (= (ControlFlow 0 51) (- 0 53)) (HasDirectPerm_19407_1721 Mask@11 (loc a_2@@7 i@@6) val)) (=> (HasDirectPerm_19407_1721 Mask@11 (loc a_2@@7 i@@6) val) (and (=> (= (ControlFlow 0 51) (- 0 52)) (HasDirectPerm_19407_1721 Mask@11 (loc a_2@@7 (+ i@@6 1)) val)) (=> (HasDirectPerm_19407_1721 Mask@11 (loc a_2@@7 (+ i@@6 1)) val) (=> (and (= sum_1@2 (+ (+ sum_1@0 (select (|PolymorphicMapType_31285_19407_1721#PolymorphicMapType_31285| Heap@9) (loc a_2@@7 i@@6) val)) (select (|PolymorphicMapType_31285_19407_1721#PolymorphicMapType_31285| Heap@9) (loc a_2@@7 (+ i@@6 1)) val))) (state Heap@9 Mask@11)) (and (=> (= (ControlFlow 0 51) 50) anon49_Then_correct) (=> (= (ControlFlow 0 51) 41) anon49_Else_correct))))))))))
...
(let ((anon45_Then_correct  (=> (and (< (+ i@@6 3) (len_1 a_2@@7)) (= arg_i@0 (+ i@@6 2))) (and (=> (= (ControlFlow 0 62) (- 0 68)) (>= arg_i@0 0)) (=> (>= arg_i@0 0) (and (=> (= (ControlFlow 0 62) (- 0 67)) (< (+ arg_i@0 1) (len_1 a_2@@7))) (=> (< (+ arg_i@0 1) (len_1 a_2@@7)) (and (=> (= (ControlFlow 0 62) (- 0 66)) (= (mod arg_i@0 2) 0)) (=> (= (mod arg_i@0 2) 0) (and (=> (= (ControlFlow 0 62) (- 0 65)) (forall ((j_7_1 Int) (j_7_2 Int) ) (!  (=> (and (and (and (and (not (= j_7_1 j_7_2)) (and (>= j_7_1 0) (and (< j_7_1 (len_1 a_2@@7)) (= (mod j_7_1 2) 0)))) (and (>= j_7_2 0) (and (< j_7_2 (len_1 a_2@@7)) (= (mod j_7_2 2) 0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_2@@7 a_2@@7)) (not (= j_7_1 j_7_2))))
...
)) (and (=> (= (ControlFlow 0 62) (- 0 64)) (forall ((j_7_1@@1 Int) ) (!  (=> (and (>= j_7_1@@1 0) (and (< j_7_1@@1 (len_1 a_2@@7)) (= (mod j_7_1@@1 2) 0))) (>= (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@0) null (access a_2@@7 j_7_1@@1)) FullPerm))
 :qid |stdinbpl.570:23|
 :skolemid |43|
...
))) (=> (forall ((j_7_1@@2 Int) ) (!  (=> (and (>= j_7_1@@2 0) (and (< j_7_1@@2 (len_1 a_2@@7)) (= (mod j_7_1@@2 2) 0))) (>= (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@0) null (access a_2@@7 j_7_1@@2)) FullPerm))
 :qid |stdinbpl.570:23|
 :skolemid |43|
...
))) (and (forall ((a_4_1@@0 T@IArrayDomainType) (i_4_1_1@@0 Int) ) (!  (=> (and (and (and (>= (invRecv4 a_4_1@@0 i_4_1_1@@0) 0) (and (< (invRecv4 a_4_1@@0 i_4_1_1@@0) (len_1 a_2@@7)) (= (mod (invRecv4 a_4_1@@0 i_4_1_1@@0) 2) 0))) (< NoPerm FullPerm)) (qpRange4 a_4_1@@0 i_4_1_1@@0)) (and (and (= a_2@@7 a_4_1@@0) (= (invRecv4 a_4_1@@0 i_4_1_1@@0) i_4_1_1@@0)) (= (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@1) null (access a_4_1@@0 i_4_1_1@@0)) (- (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@0) null (access a_4_1@@0 i_4_1_1@@0)) FullPerm))))
 :qid |stdinbpl.586:28|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@1) null (access a_4_1@@0 i_4_1_1@@0)))
)) (forall ((a_4_1@@1 T@IArrayDomainType) (i_4_1_1@@1 Int) ) (!  (=> (not (and (and (and (>= (invRecv4 a_4_1@@1 i_4_1_1@@1) 0) (and (< (invRecv4 a_4_1@@1 i_4_1_1@@1) (len_1 a_2@@7)) (= (mod (invRecv4 a_4_1@@1 i_4_1_1@@1) 2) 0))) (< NoPerm FullPerm)) (qpRange4 a_4_1@@1 i_4_1_1@@1))) (= (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@1) null (access a_4_1@@1 i_4_1_1@@1)) (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@0) null (access a_4_1@@1 i_4_1_1@@1))))
 :qid |stdinbpl.590:28|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@1) null (access a_4_1@@1 i_4_1_1@@1)))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_34810_1721) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_19407_1721 f_5))) (not (= (getPredWandId_19407_1721 f_5) 0))) (= (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| QPMask@0) o_4 f_5) (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| QPMask@1) o_4 f_5)))
 :qid |stdinbpl.596:35|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| QPMask@0) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| QPMask@1) o_4 f_5))
)) (forall ((o_4@@0 T@Ref) (f_5@@0 T@Field_19407_19411) ) (!  (=> (or (or (not (= o_4@@0 null)) (not (IsPredicateField_19407_106282 f_5@@0))) (not (= (getPredWandId_19407_19411 f_5@@0) 0))) (= (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| QPMask@0) o_4@@0 f_5@@0) (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| QPMask@1) o_4@@0 f_5@@0)))
 :qid |stdinbpl.596:35|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| QPMask@0) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| QPMask@1) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_31345_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_19407_53 f_5@@1))) (not (= (getPredWandId_19407_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| QPMask@0) o_4@@1 f_5@@1) (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| QPMask@1) o_4@@1 f_5@@1)))
 :qid |stdinbpl.596:35|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| QPMask@0) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| QPMask@1) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_31358_31359) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_19407_31359 f_5@@2))) (not (= (getPredWandId_19407_31359 f_5@@2) 0))) (= (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| QPMask@0) o_4@@2 f_5@@2) (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| QPMask@1) o_4@@2 f_5@@2)))
 :qid |stdinbpl.596:35|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| QPMask@0) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| QPMask@1) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_19407_34875) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsPredicateField_19407_115743 f_5@@3))) (not (= (getPredWandId_19407_122203 f_5@@3) 0))) (= (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| QPMask@0) o_4@@3 f_5@@3) (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| QPMask@1) o_4@@3 f_5@@3)))
 :qid |stdinbpl.596:35|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| QPMask@0) o_4@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| QPMask@1) o_4@@3 f_5@@3))
))) (forall ((o_4@@4 T@Ref) (f_5@@4 T@Field_19410_1721) ) (!  (=> (or (or (not (= o_4@@4 null)) (not (IsPredicateField_19410_1721 f_5@@4))) (not (= (getPredWandId_19410_1721 f_5@@4) 0))) (= (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| QPMask@0) o_4@@4 f_5@@4) (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| QPMask@1) o_4@@4 f_5@@4)))
 :qid |stdinbpl.596:35|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| QPMask@0) o_4@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| QPMask@1) o_4@@4 f_5@@4))
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_34857_34858) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_19410_19411 f_5@@5))) (not (= (getPredWandId_19410_19411 f_5@@5) 0))) (= (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@0) o_4@@5 f_5@@5) (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@1) o_4@@5 f_5@@5)))
 :qid |stdinbpl.596:35|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@0) o_4@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@1) o_4@@5 f_5@@5))
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_19410_53) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_19410_53 f_5@@6))) (not (= (getPredWandId_19410_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| QPMask@0) o_4@@6 f_5@@6) (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| QPMask@1) o_4@@6 f_5@@6)))
 :qid |stdinbpl.596:35|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| QPMask@0) o_4@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| QPMask@1) o_4@@6 f_5@@6))
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_19410_31359) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsPredicateField_19410_31359 f_5@@7))) (not (= (getPredWandId_19410_31359 f_5@@7) 0))) (= (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| QPMask@0) o_4@@7 f_5@@7) (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| QPMask@1) o_4@@7 f_5@@7)))
 :qid |stdinbpl.596:35|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| QPMask@0) o_4@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| QPMask@1) o_4@@7 f_5@@7))
))) (forall ((o_4@@8 T@Ref) (f_5@@8 T@Field_34870_34875) ) (!  (=> (or (or (not (= o_4@@8 null)) (not (IsPredicateField_19410_116574 f_5@@8))) (not (= (getPredWandId_19410_123012 f_5@@8) 0))) (= (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| QPMask@0) o_4@@8 f_5@@8) (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| QPMask@1) o_4@@8 f_5@@8)))
 :qid |stdinbpl.596:35|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| QPMask@0) o_4@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| QPMask@1) o_4@@8 f_5@@8))
 ...
 :qid |stdinbpl.622:28|
 :skolemid |50|
 :pattern ( (select (|PolymorphicMapType_31285_19410_19411#PolymorphicMapType_31285| ExhaleHeap@0) null (access a_2@@7 j_8@@1)))
 :pattern ( (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@1) null (access a_2@@7 j_8@@1)))
...
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@9 T@Ref) (f_5@@9 T@Field_34810_1721) ) (!  (=> (or (or (not (= o_4@@9 null)) (not (IsPredicateField_19407_1721 f_5@@9))) (not (= (getPredWandId_19407_1721 f_5@@9) 0))) (= (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| QPMask@1) o_4@@9 f_5@@9) (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| QPMask@2) o_4@@9 f_5@@9)))
 :qid |stdinbpl.638:35|
 :skolemid |53|
 :pattern ( (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| QPMask@1) o_4@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| QPMask@2) o_4@@9 f_5@@9))
)) (forall ((o_4@@10 T@Ref) (f_5@@10 T@Field_19407_19411) ) (!  (=> (or (or (not (= o_4@@10 null)) (not (IsPredicateField_19407_106282 f_5@@10))) (not (= (getPredWandId_19407_19411 f_5@@10) 0))) (= (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| QPMask@1) o_4@@10 f_5@@10) (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| QPMask@2) o_4@@10 f_5@@10)))
 :qid |stdinbpl.638:35|
 :skolemid |53|
 :pattern ( (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| QPMask@1) o_4@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| QPMask@2) o_4@@10 f_5@@10))
))) (forall ((o_4@@11 T@Ref) (f_5@@11 T@Field_31345_53) ) (!  (=> (or (or (not (= o_4@@11 null)) (not (IsPredicateField_19407_53 f_5@@11))) (not (= (getPredWandId_19407_53 f_5@@11) 0))) (= (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| QPMask@1) o_4@@11 f_5@@11) (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| QPMask@2) o_4@@11 f_5@@11)))
 :qid |stdinbpl.638:35|
 :skolemid |53|
 :pattern ( (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| QPMask@1) o_4@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| QPMask@2) o_4@@11 f_5@@11))
))) (forall ((o_4@@12 T@Ref) (f_5@@12 T@Field_31358_31359) ) (!  (=> (or (or (not (= o_4@@12 null)) (not (IsPredicateField_19407_31359 f_5@@12))) (not (= (getPredWandId_19407_31359 f_5@@12) 0))) (= (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| QPMask@1) o_4@@12 f_5@@12) (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| QPMask@2) o_4@@12 f_5@@12)))
 :qid |stdinbpl.638:35|
 :skolemid |53|
 :pattern ( (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| QPMask@1) o_4@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| QPMask@2) o_4@@12 f_5@@12))
))) (forall ((o_4@@13 T@Ref) (f_5@@13 T@Field_19407_34875) ) (!  (=> (or (or (not (= o_4@@13 null)) (not (IsPredicateField_19407_115743 f_5@@13))) (not (= (getPredWandId_19407_122203 f_5@@13) 0))) (= (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| QPMask@1) o_4@@13 f_5@@13) (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| QPMask@2) o_4@@13 f_5@@13)))
 :qid |stdinbpl.638:35|
 :skolemid |53|
 :pattern ( (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| QPMask@1) o_4@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| QPMask@2) o_4@@13 f_5@@13))
))) (forall ((o_4@@14 T@Ref) (f_5@@14 T@Field_19410_1721) ) (!  (=> (or (or (not (= o_4@@14 null)) (not (IsPredicateField_19410_1721 f_5@@14))) (not (= (getPredWandId_19410_1721 f_5@@14) 0))) (= (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| QPMask@1) o_4@@14 f_5@@14) (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| QPMask@2) o_4@@14 f_5@@14)))
 :qid |stdinbpl.638:35|
 :skolemid |53|
 :pattern ( (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| QPMask@1) o_4@@14 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| QPMask@2) o_4@@14 f_5@@14))
))) (forall ((o_4@@15 T@Ref) (f_5@@15 T@Field_34857_34858) ) (!  (=> (or (or (not (= o_4@@15 null)) (not (IsPredicateField_19410_19411 f_5@@15))) (not (= (getPredWandId_19410_19411 f_5@@15) 0))) (= (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@1) o_4@@15 f_5@@15) (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@2) o_4@@15 f_5@@15)))
 :qid |stdinbpl.638:35|
 :skolemid |53|
 :pattern ( (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@1) o_4@@15 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@2) o_4@@15 f_5@@15))
))) (forall ((o_4@@16 T@Ref) (f_5@@16 T@Field_19410_53) ) (!  (=> (or (or (not (= o_4@@16 null)) (not (IsPredicateField_19410_53 f_5@@16))) (not (= (getPredWandId_19410_53 f_5@@16) 0))) (= (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| QPMask@1) o_4@@16 f_5@@16) (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| QPMask@2) o_4@@16 f_5@@16)))
 :qid |stdinbpl.638:35|
 :skolemid |53|
 :pattern ( (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| QPMask@1) o_4@@16 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| QPMask@2) o_4@@16 f_5@@16))
))) (forall ((o_4@@17 T@Ref) (f_5@@17 T@Field_19410_31359) ) (!  (=> (or (or (not (= o_4@@17 null)) (not (IsPredicateField_19410_31359 f_5@@17))) (not (= (getPredWandId_19410_31359 f_5@@17) 0))) (= (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| QPMask@1) o_4@@17 f_5@@17) (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| QPMask@2) o_4@@17 f_5@@17)))
 :qid |stdinbpl.638:35|
 :skolemid |53|
 :pattern ( (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| QPMask@1) o_4@@17 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| QPMask@2) o_4@@17 f_5@@17))
))) (forall ((o_4@@18 T@Ref) (f_5@@18 T@Field_34870_34875) ) (!  (=> (or (or (not (= o_4@@18 null)) (not (IsPredicateField_19410_116574 f_5@@18))) (not (= (getPredWandId_19410_123012 f_5@@18) 0))) (= (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| QPMask@1) o_4@@18 f_5@@18) (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| QPMask@2) o_4@@18 f_5@@18)))
 :qid |stdinbpl.638:35|
 :skolemid |53|
 :pattern ( (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| QPMask@1) o_4@@18 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| QPMask@2) o_4@@18 f_5@@18))
...
(let ((anon30_correct  (=> (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)) (and (=> (= (ControlFlow 0 23) (- 0 25)) (HasDirectPerm_19407_1721 Mask@3 (loc a_2@@7 i@@6) val)) (=> (HasDirectPerm_19407_1721 Mask@3 (loc a_2@@7 i@@6) val) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_19407_1721 Mask@3 (loc a_2@@7 (+ i@@6 1)) val)) (=> (HasDirectPerm_19407_1721 Mask@3 (loc a_2@@7 (+ i@@6 1)) val) (=> (and (= sum_1@1 (+ (select (|PolymorphicMapType_31285_19407_1721#PolymorphicMapType_31285| Heap@1) (loc a_2@@7 i@@6) val) (select (|PolymorphicMapType_31285_19407_1721#PolymorphicMapType_31285| Heap@1) (loc a_2@@7 (+ i@@6 1)) val))) (state Heap@1 Mask@3)) (and (=> (= (ControlFlow 0 23) 22) anon57_Then_correct) (=> (= (ControlFlow 0 23) 13) anon57_Else_correct))))))))))
...
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@19 T@Ref) (f_5@@19 T@Field_34810_1721) ) (!  (=> (or (or (not (= o_4@@19 null)) (not (IsPredicateField_19407_1721 f_5@@19))) (not (= (getPredWandId_19407_1721 f_5@@19) 0))) (= (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| ZeroMask) o_4@@19 f_5@@19) (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| QPMask@0) o_4@@19 f_5@@19)))
 :qid |stdinbpl.468:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| ZeroMask) o_4@@19 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_31306_19407_1721#PolymorphicMapType_31306| QPMask@0) o_4@@19 f_5@@19))
)) (forall ((o_4@@20 T@Ref) (f_5@@20 T@Field_19407_19411) ) (!  (=> (or (or (not (= o_4@@20 null)) (not (IsPredicateField_19407_106282 f_5@@20))) (not (= (getPredWandId_19407_19411 f_5@@20) 0))) (= (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| ZeroMask) o_4@@20 f_5@@20) (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| QPMask@0) o_4@@20 f_5@@20)))
 :qid |stdinbpl.468:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| ZeroMask) o_4@@20 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_31306_19407_19411#PolymorphicMapType_31306| QPMask@0) o_4@@20 f_5@@20))
))) (forall ((o_4@@21 T@Ref) (f_5@@21 T@Field_31345_53) ) (!  (=> (or (or (not (= o_4@@21 null)) (not (IsPredicateField_19407_53 f_5@@21))) (not (= (getPredWandId_19407_53 f_5@@21) 0))) (= (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| ZeroMask) o_4@@21 f_5@@21) (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| QPMask@0) o_4@@21 f_5@@21)))
 :qid |stdinbpl.468:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| ZeroMask) o_4@@21 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_31306_19407_53#PolymorphicMapType_31306| QPMask@0) o_4@@21 f_5@@21))
))) (forall ((o_4@@22 T@Ref) (f_5@@22 T@Field_31358_31359) ) (!  (=> (or (or (not (= o_4@@22 null)) (not (IsPredicateField_19407_31359 f_5@@22))) (not (= (getPredWandId_19407_31359 f_5@@22) 0))) (= (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| ZeroMask) o_4@@22 f_5@@22) (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| QPMask@0) o_4@@22 f_5@@22)))
 :qid |stdinbpl.468:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| ZeroMask) o_4@@22 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_31306_19407_31359#PolymorphicMapType_31306| QPMask@0) o_4@@22 f_5@@22))
))) (forall ((o_4@@23 T@Ref) (f_5@@23 T@Field_19407_34875) ) (!  (=> (or (or (not (= o_4@@23 null)) (not (IsPredicateField_19407_115743 f_5@@23))) (not (= (getPredWandId_19407_122203 f_5@@23) 0))) (= (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| ZeroMask) o_4@@23 f_5@@23) (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| QPMask@0) o_4@@23 f_5@@23)))
 :qid |stdinbpl.468:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| ZeroMask) o_4@@23 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_31306_19407_113871#PolymorphicMapType_31306| QPMask@0) o_4@@23 f_5@@23))
))) (forall ((o_4@@24 T@Ref) (f_5@@24 T@Field_19410_1721) ) (!  (=> (or (or (not (= o_4@@24 null)) (not (IsPredicateField_19410_1721 f_5@@24))) (not (= (getPredWandId_19410_1721 f_5@@24) 0))) (= (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| ZeroMask) o_4@@24 f_5@@24) (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| QPMask@0) o_4@@24 f_5@@24)))
 :qid |stdinbpl.468:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| ZeroMask) o_4@@24 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_31306_19410_1721#PolymorphicMapType_31306| QPMask@0) o_4@@24 f_5@@24))
))) (forall ((o_4@@25 T@Ref) (f_5@@25 T@Field_34857_34858) ) (!  (=> (or (or (not (= o_4@@25 null)) (not (IsPredicateField_19410_19411 f_5@@25))) (not (= (getPredWandId_19410_19411 f_5@@25) 0))) (= (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| ZeroMask) o_4@@25 f_5@@25) (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@0) o_4@@25 f_5@@25)))
 :qid |stdinbpl.468:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| ZeroMask) o_4@@25 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_31306_19410_19411#PolymorphicMapType_31306| QPMask@0) o_4@@25 f_5@@25))
))) (forall ((o_4@@26 T@Ref) (f_5@@26 T@Field_19410_53) ) (!  (=> (or (or (not (= o_4@@26 null)) (not (IsPredicateField_19410_53 f_5@@26))) (not (= (getPredWandId_19410_53 f_5@@26) 0))) (= (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| ZeroMask) o_4@@26 f_5@@26) (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| QPMask@0) o_4@@26 f_5@@26)))
 :qid |stdinbpl.468:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| ZeroMask) o_4@@26 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_31306_19410_53#PolymorphicMapType_31306| QPMask@0) o_4@@26 f_5@@26))
))) (forall ((o_4@@27 T@Ref) (f_5@@27 T@Field_19410_31359) ) (!  (=> (or (or (not (= o_4@@27 null)) (not (IsPredicateField_19410_31359 f_5@@27))) (not (= (getPredWandId_19410_31359 f_5@@27) 0))) (= (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| ZeroMask) o_4@@27 f_5@@27) (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| QPMask@0) o_4@@27 f_5@@27)))
 :qid |stdinbpl.468:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| ZeroMask) o_4@@27 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_31306_19410_31359#PolymorphicMapType_31306| QPMask@0) o_4@@27 f_5@@27))
))) (forall ((o_4@@28 T@Ref) (f_5@@28 T@Field_34870_34875) ) (!  (=> (or (or (not (= o_4@@28 null)) (not (IsPredicateField_19410_116574 f_5@@28))) (not (= (getPredWandId_19410_123012 f_5@@28) 0))) (= (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| ZeroMask) o_4@@28 f_5@@28) (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| QPMask@0) o_4@@28 f_5@@28)))
 :qid |stdinbpl.468:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| ZeroMask) o_4@@28 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_31306_19410_114282#PolymorphicMapType_31306| QPMask@0) o_4@@28 f_5@@28))
