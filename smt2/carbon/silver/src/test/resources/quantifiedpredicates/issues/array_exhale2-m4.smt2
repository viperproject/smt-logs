...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) (loc a_2@@8 1) val))) (=> (<= FullPerm (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) (loc a_2@@8 1) val)) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (> i_1 0) (< i_1 n))) (and (> i_1_1 0) (< i_1_1 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1 1)) (loc a_2@@8 (+ i_1_1 1)))))
 :qid |stdinbpl.858:15|
 :skolemid |74|
 ...
 :qid |stdinbpl.858:15|
 :skolemid |74|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (> i_1@@1 0) (< i_1@@1 n)) (< NoPerm FullPerm)) (and (qpRange8 (loc a_2@@8 (+ i_1@@1 1))) (= (invRecv8 (loc a_2@@8 (+ i_1@@1 1))) i_1@@1)))
 :qid |stdinbpl.864:22|
 :skolemid |75|
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (> (invRecv8 o_4) 0) (< (invRecv8 o_4) n)) (< NoPerm FullPerm)) (qpRange8 o_4)) (= (loc a_2@@8 (+ (invRecv8 o_4) 1)) o_4))
 :qid |stdinbpl.868:22|
 :skolemid |76|
