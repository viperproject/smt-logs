...
(declare-fun ix_27 () T@Ref)
(declare-fun jx_27 () T@Ref)
...
(let ((anon29_Then_correct  (=> (|Seq#Contains_6503| xs x_32) (and (=> (= (ControlFlow 0 18) 17) anon30_Then_correct) (=> (= (ControlFlow 0 18) 15) anon17_correct)))))
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains_6503| xs x_32)) (= (ControlFlow 0 16) 15)) anon17_correct)))
(let ((anon28_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (|Seq#Contains_6503| xs x_4)) (|Seq#Contains_6503| xs x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (e_5 PostHeap@0 x_4) (e_5 PostHeap@0 x_4_1))) (not (= (+ i@@17 1) (+ i@@17 1)))))
...
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_6 T@Ref) (x_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_6 x_6_1)) (|Seq#Contains_6503| xs x_6)) (|Seq#Contains_6503| xs x_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (e_5 Heap@@35 x_6) (e_5 Heap@@35 x_6_1))) (not (= (+ i@@17 1) (+ i@@17 1)))))
 :qid |stdinbpl.1061:17|
 :skolemid |99|
 :pattern ( (neverTriggered6 x_6) (neverTriggered6 x_6_1))
))) (=> (forall ((x_6@@0 T@Ref) (x_6_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (|Seq#Contains_6503| xs x_6@@0)) (|Seq#Contains_6503| xs x_6_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (e_5 Heap@@35 x_6@@0) (e_5 Heap@@35 x_6_1@@0))) (not (= (+ i@@17 1) (+ i@@17 1)))))
 :qid |stdinbpl.1061:17|
 :skolemid |99|
 :pattern ( (neverTriggered6 x_6@@0) (neverTriggered6 x_6_1@@0))
)) (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((x_6@@1 T@Ref) ) (!  (=> (|Seq#Contains_6503| xs x_6@@1) (>= (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) null (p_14 (e_5 Heap@@35 x_6@@1) (+ i@@17 1))) FullPerm))
...
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_6503| xs x_1)) (|Seq#Contains_6503| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (e_5 Heap@@35 x_1) (e_5 Heap@@35 x_1_1))) (not (= (+ i@@17 1) (+ i@@17 1)))))
 :qid |stdinbpl.954:17|
 :skolemid |87|
 :pattern ( (neverTriggered4 x_1) (neverTriggered4 x_1_1))
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains_6503| xs x_1@@0)) (|Seq#Contains_6503| xs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (e_5 Heap@@35 x_1@@0) (e_5 Heap@@35 x_1_1@@0))) (not (= (+ i@@17 1) (+ i@@17 1)))))
 :qid |stdinbpl.954:17|
 :skolemid |87|
 :pattern ( (neverTriggered4 x_1@@0) (neverTriggered4 x_1_1@@0))
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_6503| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv4 (e_5 Heap@@35 x_1@@1) (+ i@@17 1)) x_1@@1) (qpRange4 (e_5 Heap@@35 x_1@@1) (+ i@@17 1))))
 :qid |stdinbpl.960:22|
 :skolemid |88|
 :pattern ( (|Seq#ContainsTrigger_6503| xs x_1@@1))
 :pattern ( (|Seq#Contains_6503| xs x_1@@1))
 :pattern ( (|e#frame| EmptyFrame x_1@@1))
)) (=> (and (forall ((r_1@@5 T@Ref) (i_1_1_1 Int) ) (!  (=> (and (and (|Seq#Contains_6503| xs (invRecv4 r_1@@5 i_1_1_1)) (< NoPerm FullPerm)) (qpRange4 r_1@@5 i_1_1_1)) (and (= (e_5 Heap@@35 (invRecv4 r_1@@5 i_1_1_1)) r_1@@5) (= (+ i@@17 1) i_1_1_1)))
 :qid |stdinbpl.964:22|
 :skolemid |89|
 :pattern ( (invRecv4 r_1@@5 i_1_1_1))
)) (forall ((r_1@@6 T@Ref) (i_1_1_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_6503| xs (invRecv4 r_1@@6 i_1_1_1@@0)) (< NoPerm FullPerm)) (qpRange4 r_1@@6 i_1_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (e_5 Heap@@35 (invRecv4 r_1@@6 i_1_1_1@@0)) r_1@@6) (= (+ i@@17 1) i_1_1_1@@0))) (= (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) null (p_14 r_1@@6 i_1_1_1@@0)) (+ (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| ZeroMask) null (p_14 r_1@@6 i_1_1_1@@0)) FullPerm))))
 :qid |stdinbpl.970:22|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) null (p_14 r_1@@6 i_1_1_1@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_15831_3157) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_6450_3157 f_5))) (not (= (getPredWandId_6450_3157 f_5) 0))) (= (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) o_4 f_5) (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_4 f_5)))
 :qid |stdinbpl.976:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_4 f_5))
)) (forall ((o_4@@0 T@Ref) (f_5@@0 T@Field_6450_16351) ) (!  (=> (or (or (not (= o_4@@0 null)) (not (IsPredicateField_6450_28611 f_5@@0))) (not (= (getPredWandId_6450_6478 f_5@@0) 0))) (= (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| ZeroMask) o_4@@0 f_5@@0) (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| QPMask@0) o_4@@0 f_5@@0)))
 :qid |stdinbpl.976:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| ZeroMask) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| QPMask@0) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_9789_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_6450_53 f_5@@1))) (not (= (getPredWandId_6450_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| ZeroMask) o_4@@1 f_5@@1) (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| QPMask@0) o_4@@1 f_5@@1)))
 :qid |stdinbpl.976:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| ZeroMask) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| QPMask@0) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_9802_9803) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_6450_9803 f_5@@2))) (not (= (getPredWandId_6450_9803 f_5@@2) 0))) (= (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| ZeroMask) o_4@@2 f_5@@2) (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| QPMask@0) o_4@@2 f_5@@2)))
 :qid |stdinbpl.976:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| ZeroMask) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| QPMask@0) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_6450_16368) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsPredicateField_6450_38409 f_5@@3))) (not (= (getPredWandId_6450_54265 f_5@@3) 0))) (= (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| ZeroMask) o_4@@3 f_5@@3) (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| QPMask@0) o_4@@3 f_5@@3)))
 :qid |stdinbpl.976:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| ZeroMask) o_4@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| QPMask@0) o_4@@3 f_5@@3))
))) (forall ((o_4@@4 T@Ref) (f_5@@4 T@Field_16350_3157) ) (!  (=> (or (or (not (= o_4@@4 null)) (not (IsPredicateField_6477_3157 f_5@@4))) (not (= (getPredWandId_6477_3157 f_5@@4) 0))) (= (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| ZeroMask) o_4@@4 f_5@@4) (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| QPMask@0) o_4@@4 f_5@@4)))
 :qid |stdinbpl.976:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| ZeroMask) o_4@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| QPMask@0) o_4@@4 f_5@@4))
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_16350_16351) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_6477_6478 f_5@@5))) (not (= (getPredWandId_6477_6478 f_5@@5) 0))) (= (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| ZeroMask) o_4@@5 f_5@@5) (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) o_4@@5 f_5@@5)))
 :qid |stdinbpl.976:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| ZeroMask) o_4@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) o_4@@5 f_5@@5))
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_16350_53) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_6477_53 f_5@@6))) (not (= (getPredWandId_6477_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| ZeroMask) o_4@@6 f_5@@6) (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| QPMask@0) o_4@@6 f_5@@6)))
 :qid |stdinbpl.976:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| ZeroMask) o_4@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| QPMask@0) o_4@@6 f_5@@6))
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_16350_9803) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsPredicateField_6477_9803 f_5@@7))) (not (= (getPredWandId_6477_9803 f_5@@7) 0))) (= (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| ZeroMask) o_4@@7 f_5@@7) (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| QPMask@0) o_4@@7 f_5@@7)))
 :qid |stdinbpl.976:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| ZeroMask) o_4@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| QPMask@0) o_4@@7 f_5@@7))
))) (forall ((o_4@@8 T@Ref) (f_5@@8 T@Field_16363_16368) ) (!  (=> (or (or (not (= o_4@@8 null)) (not (IsPredicateField_6477_39240 f_5@@8))) (not (= (getPredWandId_6477_55074 f_5@@8) 0))) (= (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| ZeroMask) o_4@@8 f_5@@8) (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| QPMask@0) o_4@@8 f_5@@8)))
 :qid |stdinbpl.976:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| ZeroMask) o_4@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| QPMask@0) o_4@@8 f_5@@8))
))) (forall ((r_1@@7 T@Ref) (i_1_1_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_6503| xs (invRecv4 r_1@@7 i_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange4 r_1@@7 i_1_1_1@@1))) (= (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) null (p_14 r_1@@7 i_1_1_1@@1)) (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| ZeroMask) null (p_14 r_1@@7 i_1_1_1@@1))))
 :qid |stdinbpl.980:22|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) null (p_14 r_1@@7 i_1_1_1@@1)))
...
(let ((anon25_Then_correct  (=> (|Seq#Contains_6503| xs x_38) (and (=> (= (ControlFlow 0 9) 8) anon26_Then_correct) (=> (= (ControlFlow 0 9) 6) anon11_correct)))))
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains_6503| xs x_38)) (= (ControlFlow 0 7) 6)) anon11_correct)))
...
(let ((anon21_Then_correct  (=> (and (|Seq#Contains_6503| xs ix_27) (and (|Seq#Contains_6503| xs jx_27) (not (= ix_27 jx_27)))) (and (and (=> (= (ControlFlow 0 5) 3) anon22_Then_correct) (=> (= (ControlFlow 0 5) 4) anon23_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon21_Else_correct  (=> (and (not (and (|Seq#Contains_6503| xs ix_27) (and (|Seq#Contains_6503| xs jx_27) (not (= ix_27 jx_27))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
