...
(declare-fun Mask@0 () T@PolymorphicMapType_9750)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (state Heap@@35 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_9729_6238_53#PolymorphicMapType_9729| Heap@@35) r_1@@5 $allocated))) (and (and (not (= r_1@@5 null)) (= Mask@0 (PolymorphicMapType_9750 (store (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) r_1@@5 f_7 (+ (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) r_1@@5 f_7) FullPerm)) (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| ZeroMask) (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| ZeroMask) (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| ZeroMask) (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| ZeroMask) (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| ZeroMask) (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| ZeroMask) (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| ZeroMask) (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| ZeroMask) (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| ZeroMask)))) (and (state Heap@@35 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm_6450_3157 Mask@0 r_1@@5 f_7))))
