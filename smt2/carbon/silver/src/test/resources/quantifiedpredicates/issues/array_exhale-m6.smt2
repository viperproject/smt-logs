...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_3_2)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_3_2) (loc a_2@@8 i_3_3))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_4_1)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_4_1) (loc a_2@@8 i_4_2))))
 :qid |stdinbpl.1596:17|
 :skolemid |147|
 :pattern ( (neverTriggered14 i_4_1) (neverTriggered14 i_4_2))
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_4_1@@0)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_4_1@@0) (loc a_2@@8 i_4_2@@0))))
 :qid |stdinbpl.1596:17|
 :skolemid |147|
 :pattern ( (neverTriggered14 i_4_1@@0) (neverTriggered14 i_4_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_4_1@@1 Int) ) (!  (=> (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_4_1@@1) (>= (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) (loc a_2@@8 i_4_1@@1) val) FullPerm))
 :qid |stdinbpl.1603:17|
 :skolemid |148|
 :pattern ( (loc a_2@@8 i_4_1@@1))
 :pattern ( (loc a_2@@8 i_4_1@@1))
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1 1)) (loc a_2@@8 (+ i_1_1 1)))))
 :qid |stdinbpl.1498:15|
 :skolemid |135|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1@@0)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1@@0 1)) (loc a_2@@8 (+ i_1_1@@0 1)))))
 :qid |stdinbpl.1498:15|
 :skolemid |135|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1@@1) (< NoPerm FullPerm)) (and (qpRange12 (loc a_2@@8 (+ i_1@@1 1))) (= (invRecv12 (loc a_2@@8 (+ i_1@@1 1))) i_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) (invRecv12 o_9)) (< NoPerm FullPerm)) (qpRange12 o_9)) (= (loc a_2@@8 (+ (invRecv12 o_9) 1)) o_9))
 :qid |stdinbpl.1508:22|
 :skolemid |137|
 :pattern ( (invRecv12 o_9))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1@@2) (not (= (loc a_2@@8 (+ i_1@@2 1)) null)))
 :qid |stdinbpl.1514:22|
 :skolemid |138|
 :pattern ( (|Seq#ContainsTrigger_3704| (|Seq#Range| 0 n@@13) i_1@@2))
 :pattern ( (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) (invRecv12 o_9@@0)) (< NoPerm FullPerm)) (qpRange12 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@8 (+ (invRecv12 o_9@@0) 1)) o_9@@0)) (= (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) (invRecv12 o_9@@0)) (< NoPerm FullPerm)) (qpRange12 o_9@@0))) (= (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.1520:22|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) o_9@@0 val))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_22668_53) ) (!  (=> true (= (select (|PolymorphicMapType_22629_15994_53#PolymorphicMapType_22629| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_22629_15994_53#PolymorphicMapType_22629| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1524:29|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_22629_15994_53#PolymorphicMapType_22629| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_22629_15994_53#PolymorphicMapType_22629| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_22681_22682) ) (!  (=> true (= (select (|PolymorphicMapType_22629_15994_22682#PolymorphicMapType_22629| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_22629_15994_22682#PolymorphicMapType_22629| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1524:29|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_22629_15994_22682#PolymorphicMapType_22629| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_22629_15994_22682#PolymorphicMapType_22629| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_28909_3961) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1524:29|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_22668_28957) ) (!  (=> true (= (select (|PolymorphicMapType_22629_15994_15998#PolymorphicMapType_22629| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_22629_15994_15998#PolymorphicMapType_22629| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1524:29|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_22629_15994_15998#PolymorphicMapType_22629| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_22629_15994_15998#PolymorphicMapType_22629| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_22668_28974) ) (!  (=> true (= (select (|PolymorphicMapType_22629_15994_75254#PolymorphicMapType_22629| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_22629_15994_75254#PolymorphicMapType_22629| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1524:29|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_22629_15994_75254#PolymorphicMapType_22629| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_22629_15994_75254#PolymorphicMapType_22629| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_28956_53) ) (!  (=> true (= (select (|PolymorphicMapType_22629_15997_53#PolymorphicMapType_22629| ZeroMask) o_9@@6 f_5@@4) (select (|PolymorphicMapType_22629_15997_53#PolymorphicMapType_22629| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.1524:29|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_22629_15997_53#PolymorphicMapType_22629| ZeroMask) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_22629_15997_53#PolymorphicMapType_22629| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_28956_22682) ) (!  (=> true (= (select (|PolymorphicMapType_22629_15997_22682#PolymorphicMapType_22629| ZeroMask) o_9@@7 f_5@@5) (select (|PolymorphicMapType_22629_15997_22682#PolymorphicMapType_22629| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.1524:29|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_22629_15997_22682#PolymorphicMapType_22629| ZeroMask) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_22629_15997_22682#PolymorphicMapType_22629| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_28956_3961) ) (!  (=> true (= (select (|PolymorphicMapType_22629_15997_3961#PolymorphicMapType_22629| ZeroMask) o_9@@8 f_5@@6) (select (|PolymorphicMapType_22629_15997_3961#PolymorphicMapType_22629| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.1524:29|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_22629_15997_3961#PolymorphicMapType_22629| ZeroMask) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_22629_15997_3961#PolymorphicMapType_22629| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_28956_28957) ) (!  (=> true (= (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| ZeroMask) o_9@@9 f_5@@7) (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.1524:29|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| ZeroMask) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_28969_28974) ) (!  (=> true (= (select (|PolymorphicMapType_22629_15997_75665#PolymorphicMapType_22629| ZeroMask) o_9@@10 f_5@@8) (select (|PolymorphicMapType_22629_15997_75665#PolymorphicMapType_22629| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.1524:29|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_22629_15997_75665#PolymorphicMapType_22629| ZeroMask) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_22629_15997_75665#PolymorphicMapType_22629| QPMask@0) o_9@@10 f_5@@8))
