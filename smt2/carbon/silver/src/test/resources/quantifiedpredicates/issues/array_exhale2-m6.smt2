...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (> i_3 1) (< i_3 (+ n 1)))) (and (> i_3_1 1) (< i_3_1 (+ n 1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_3) (loc a_2@@8 i_3_1))))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (> i_1 0) (< i_1 n))) (and (> i_1_1 0) (< i_1_1 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1 1)) (loc a_2@@8 (+ i_1_1 1)))))
 ...
 :skolemid |100|
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (> (invRecv12 o_4) 0) (< (invRecv12 o_4) n)) (< NoPerm FullPerm)) (qpRange12 o_4)) (= (loc a_2@@8 (+ (invRecv12 o_4) 1)) o_4))
 ...
 :skolemid |102|
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (> (invRecv12 o_4@@0) 0) (< (invRecv12 o_4@@0) n)) (< NoPerm FullPerm)) (qpRange12 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@8 (+ (invRecv12 o_4@@0) 1)) o_4@@0)) (= (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (> (invRecv12 o_4@@0) 0) (< (invRecv12 o_4@@0) n)) (< NoPerm FullPerm)) (qpRange12 o_4@@0))) (= (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| ZeroMask) o_4@@0 val))))
