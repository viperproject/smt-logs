...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (> i_3_2 1) (< i_3_2 (+ n 1)))) (and (> i_3_3 1) (< i_3_3 (+ n 1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_3_2) (loc a_2@@8 i_3_3))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (and (> i_4_1 1) (< i_4_1 (+ n 1)))) (and (> i_4_2 1) (< i_4_2 (+ n 1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_4_1) (loc a_2@@8 i_4_2))))
 :qid |stdinbpl.1232:17|
 :skolemid |111|
 :pattern ( (neverTriggered14 i_4_1) (neverTriggered14 i_4_2))
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (and (> i_4_1@@0 1) (< i_4_1@@0 (+ n 1)))) (and (> i_4_2@@0 1) (< i_4_2@@0 (+ n 1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_4_1@@0) (loc a_2@@8 i_4_2@@0))))
 :qid |stdinbpl.1232:17|
 :skolemid |111|
 :pattern ( (neverTriggered14 i_4_1@@0) (neverTriggered14 i_4_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_4_1@@1 Int) ) (!  (=> (and (> i_4_1@@1 1) (< i_4_1@@1 (+ n 1))) (>= (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) (loc a_2@@8 i_4_1@@1) val) FullPerm))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (> i_1 0) (< i_1 n))) (and (> i_1_1 0) (< i_1_1 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1 1)) (loc a_2@@8 (+ i_1_1 1)))))
 ...
 :qid |stdinbpl.1134:15|
 :skolemid |99|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (> i_1@@1 0) (< i_1@@1 n)) (< NoPerm FullPerm)) (and (qpRange12 (loc a_2@@8 (+ i_1@@1 1))) (= (invRecv12 (loc a_2@@8 (+ i_1@@1 1))) i_1@@1)))
 :qid |stdinbpl.1140:22|
 :skolemid |100|
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (> (invRecv12 o_9) 0) (< (invRecv12 o_9) n)) (< NoPerm FullPerm)) (qpRange12 o_9)) (= (loc a_2@@8 (+ (invRecv12 o_9) 1)) o_9))
 ...
 :skolemid |102|
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (> (invRecv12 o_9@@0) 0) (< (invRecv12 o_9@@0) n)) (< NoPerm FullPerm)) (qpRange12 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@8 (+ (invRecv12 o_9@@0) 1)) o_9@@0)) (= (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (> (invRecv12 o_9@@0) 0) (< (invRecv12 o_9@@0) n)) (< NoPerm FullPerm)) (qpRange12 o_9@@0))) (= (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| ZeroMask) o_9@@0 val))))
