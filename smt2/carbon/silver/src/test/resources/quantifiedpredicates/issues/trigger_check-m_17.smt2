...
(declare-fun ix_9 () T@Ref)
(declare-fun jx_9 () T@Ref)
...
(let ((anon29_Then_correct  (=> (|Seq#Contains_6503| xs x_27) (and (=> (= (ControlFlow 0 18) 17) anon30_Then_correct) (=> (= (ControlFlow 0 18) 15) anon17_correct)))))
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains_6503| xs x_27)) (= (ControlFlow 0 16) 15)) anon17_correct)))
(let ((anon28_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains_6503| xs x_3)) (|Seq#Contains_6503| xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e_7 PostHeap@0 x_3) (e_7 PostHeap@0 x_3_1))))
 :qid |stdinbpl.803:15|
 :skolemid |74|
)))))
...
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_4_2 T@Ref) (x_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (|Seq#Contains_6503| xs x_4_2)) (|Seq#Contains_6503| xs x_4_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e_7 Heap@@35 x_4_2) (e_7 Heap@@35 x_4_3))))
 :qid |stdinbpl.850:17|
 :skolemid |80|
 :pattern ( (neverTriggered3 x_4_2) (neverTriggered3 x_4_3))
))) (=> (forall ((x_4_2@@0 T@Ref) (x_4_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2@@0 x_4_3@@0)) (|Seq#Contains_6503| xs x_4_2@@0)) (|Seq#Contains_6503| xs x_4_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e_7 Heap@@35 x_4_2@@0) (e_7 Heap@@35 x_4_3@@0))))
 :qid |stdinbpl.850:17|
 :skolemid |80|
 :pattern ( (neverTriggered3 x_4_2@@0) (neverTriggered3 x_4_3@@0))
)) (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((x_4_2@@1 T@Ref) ) (!  (=> (|Seq#Contains_6503| xs x_4_2@@1) (>= (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) (e_7 Heap@@35 x_4_2@@1) f_7) FullPerm))
 :qid |stdinbpl.857:17|
 :skolemid |81|
 :pattern ( (|e#frame| EmptyFrame x_4_2@@1))
 :pattern ( (|Seq#ContainsTrigger_6503| xs x_4_2@@1))
 :pattern ( (|Seq#Contains_6503| xs x_4_2@@1))
 :pattern ( (|e#frame| EmptyFrame x_4_2@@1))
)))))))
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_6503| xs x_1)) (|Seq#Contains_6503| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e_7 Heap@@35 x_1) (e_7 Heap@@35 x_1_1))))
 :qid |stdinbpl.745:15|
 :skolemid |68|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains_6503| xs x_1@@0)) (|Seq#Contains_6503| xs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e_7 Heap@@35 x_1@@0) (e_7 Heap@@35 x_1_1@@0))))
 :qid |stdinbpl.745:15|
 :skolemid |68|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_6503| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange1 (e_7 Heap@@35 x_1@@1)) (= (invRecv1 (e_7 Heap@@35 x_1@@1)) x_1@@1)))
 :qid |stdinbpl.751:22|
 :skolemid |69|
 ...
 :pattern ( (|e#frame| EmptyFrame x_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_6503| xs (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (e_7 Heap@@35 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.755:22|
 :skolemid |70|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (|Seq#Contains_6503| xs x_1@@2) (not (= (e_7 Heap@@35 x_1@@2) null)))
 :qid |stdinbpl.761:22|
 :skolemid |71|
 ...
 :pattern ( (|e#frame| EmptyFrame x_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_6503| xs (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (e_7 Heap@@35 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_6503| xs (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.767:22|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_9789_53) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_9802_9803) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_15831_3157) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_6450_16351) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_6450_16368) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_16350_53) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| ZeroMask) o_9@@6 f_5@@4) (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| ZeroMask) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_16350_9803) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| ZeroMask) o_9@@7 f_5@@5) (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| ZeroMask) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_16350_3157) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| ZeroMask) o_9@@8 f_5@@6) (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| ZeroMask) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_16350_16351) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| ZeroMask) o_9@@9 f_5@@7) (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| ZeroMask) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_16363_16368) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| ZeroMask) o_9@@10 f_5@@8) (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| ZeroMask) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| QPMask@0) o_9@@10 f_5@@8))
...
(let ((anon25_Then_correct  (=> (|Seq#Contains_6503| xs x_2) (and (=> (= (ControlFlow 0 9) 8) anon26_Then_correct) (=> (= (ControlFlow 0 9) 6) anon11_correct)))))
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains_6503| xs x_2)) (= (ControlFlow 0 7) 6)) anon11_correct)))
...
(let ((anon21_Then_correct  (=> (and (|Seq#Contains_6503| xs ix_9) (and (|Seq#Contains_6503| xs jx_9) (not (= ix_9 jx_9)))) (and (and (=> (= (ControlFlow 0 5) 3) anon22_Then_correct) (=> (= (ControlFlow 0 5) 4) anon23_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon21_Else_correct  (=> (and (not (and (|Seq#Contains_6503| xs ix_9) (and (|Seq#Contains_6503| xs jx_9) (not (= ix_9 jx_9))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
