...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (> i_1 0) (< i_1 n))) (and (> i_1_1 0) (< i_1_1 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1 1)) (loc a_2@@8 (+ i_1_1 1)))))
 ...
 :qid |stdinbpl.593:22|
 :skolemid |51|
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (> (invRecv4 o_9) 0) (< (invRecv4 o_9) n)) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (loc a_2@@8 (+ (invRecv4 o_9) 1)) o_9))
 :qid |stdinbpl.597:22|
 :skolemid |52|
 ...
 :qid |stdinbpl.603:22|
 :skolemid |53|
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (> (invRecv4 o_9@@0) 0) (< (invRecv4 o_9@@0) n)) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@8 (+ (invRecv4 o_9@@0) 1)) o_9@@0)) (= (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (> (invRecv4 o_9@@0) 0) (< (invRecv4 o_9@@0) n)) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.609:22|
 :skolemid |54|
