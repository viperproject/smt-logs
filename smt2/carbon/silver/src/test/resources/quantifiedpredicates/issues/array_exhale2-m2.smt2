...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (> i_1 0) (< i_1 n))) (and (> i_1_1 0) (< i_1_1 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1 1)) (loc a_2@@8 (+ i_1_1 1)))))
 :qid |stdinbpl.587:15|
 :skolemid |50|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (> i_1@@0 0) (< i_1@@0 n))) (and (> i_1_1@@0 0) (< i_1_1@@0 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1@@0 1)) (loc a_2@@8 (+ i_1_1@@0 1)))))
 :qid |stdinbpl.587:15|
 :skolemid |50|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (> i_1@@1 0) (< i_1@@1 n)) (< NoPerm FullPerm)) (and (qpRange4 (loc a_2@@8 (+ i_1@@1 1))) (= (invRecv4 (loc a_2@@8 (+ i_1@@1 1))) i_1@@1)))
 :qid |stdinbpl.593:22|
 :skolemid |51|
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (> (invRecv4 o_4) 0) (< (invRecv4 o_4) n)) (< NoPerm FullPerm)) (qpRange4 o_4)) (= (loc a_2@@8 (+ (invRecv4 o_4) 1)) o_4))
 :qid |stdinbpl.597:22|
 :skolemid |52|
 :pattern ( (invRecv4 o_4))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (> i_1@@2 0) (< i_1@@2 n)) (not (= (loc a_2@@8 (+ i_1@@2 1)) null)))
 :qid |stdinbpl.603:22|
 :skolemid |53|
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (> (invRecv4 o_4@@0) 0) (< (invRecv4 o_4@@0) n)) (< NoPerm FullPerm)) (qpRange4 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@8 (+ (invRecv4 o_4@@0) 1)) o_4@@0)) (= (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (> (invRecv4 o_4@@0) 0) (< (invRecv4 o_4@@0) n)) (< NoPerm FullPerm)) (qpRange4 o_4@@0))) (= (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_19489_13834_2161#PolymorphicMapType_19489| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.609:22|
 :skolemid |54|
