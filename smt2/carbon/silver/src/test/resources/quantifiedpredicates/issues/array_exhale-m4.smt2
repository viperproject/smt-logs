...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) (loc a_2@@8 1) val))) (=> (<= FullPerm (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) (loc a_2@@8 1) val)) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_1 1)) (loc a_2@@8 (+ i_1_1 1)))))
 ...
 :qid |stdinbpl.1222:15|
 :skolemid |110|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1@@1) (< NoPerm FullPerm)) (and (qpRange8 (loc a_2@@8 (+ i_1@@1 1))) (= (invRecv8 (loc a_2@@8 (+ i_1@@1 1))) i_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) (invRecv8 o_9)) (< NoPerm FullPerm)) (qpRange8 o_9)) (= (loc a_2@@8 (+ (invRecv8 o_9) 1)) o_9))
