...
(declare-fun xs () T@Seq_17442)
(declare-fun x_31 () T@Ref)
(declare-fun PostHeap@0 () T@PolymorphicMapType_9729)
(declare-fun neverTriggered3 (T@Ref) Bool)
(declare-fun Heap@@35 () T@PolymorphicMapType_9729)
(declare-fun QPMask@0 () T@PolymorphicMapType_9750)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon30_Then_correct true))
(let ((anon17_correct true))
(let ((anon29_Then_correct  (=> (|Seq#Contains_6503| xs x_31) (and (=> (= (ControlFlow 0 18) 17) anon30_Then_correct) (=> (= (ControlFlow 0 18) 15) anon17_correct)))))
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains_6503| xs x_31)) (= (ControlFlow 0 16) 15)) anon17_correct)))
(let ((anon28_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains_6503| xs x_3)) (|Seq#Contains_6503| xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e_5 PostHeap@0 x_3) (e_5 PostHeap@0 x_3_1))))
 :qid |stdinbpl.803:15|
 :skolemid |74|
)))))
(let ((anon27_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 19) 14) anon28_Else_correct) (=> (= (ControlFlow 0 19) 18) anon29_Then_correct)) (=> (= (ControlFlow 0 19) 16) anon29_Else_correct)))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (|Seq#Contains_6503| xs x_4)) (|Seq#Contains_6503| xs x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e_5 Heap@@35 x_4) (e_5 Heap@@35 x_4_1))))
 :qid |stdinbpl.850:17|
 :skolemid |80|
 :pattern ( (neverTriggered3 x_4) (neverTriggered3 x_4_1))
))) (=> (forall ((x_4@@0 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (|Seq#Contains_6503| xs x_4@@0)) (|Seq#Contains_6503| xs x_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e_5 Heap@@35 x_4@@0) (e_5 Heap@@35 x_4_1@@0))))
 :qid |stdinbpl.850:17|
 :skolemid |80|
 :pattern ( (neverTriggered3 x_4@@0) (neverTriggered3 x_4_1@@0))
)) (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((x_4@@1 T@Ref) ) (!  (=> (|Seq#Contains_6503| xs x_4@@1) (>= (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) (e_5 Heap@@35 x_4@@1) f_7) FullPerm))
 :qid |stdinbpl.857:17|
 :skolemid |81|
 :pattern ( (|e#frame| EmptyFrame x_4@@1))
 :pattern ( (|Seq#ContainsTrigger_6503| xs x_4@@1))
 :pattern ( (|Seq#Contains_6503| xs x_4@@1))
 :pattern ( (|e#frame| EmptyFrame x_4@@1))
)))))))
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_6503| xs x_1)) (|Seq#Contains_6503| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e_5 Heap@@35 x_1) (e_5 Heap@@35 x_1_1))))
 :qid |stdinbpl.745:15|
 :skolemid |68|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains_6503| xs x_1@@0)) (|Seq#Contains_6503| xs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e_5 Heap@@35 x_1@@0) (e_5 Heap@@35 x_1_1@@0))))
 :qid |stdinbpl.745:15|
 :skolemid |68|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_6503| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange1 (e_5 Heap@@35 x_1@@1)) (= (invRecv1 (e_5 Heap@@35 x_1@@1)) x_1@@1)))
 :qid |stdinbpl.751:22|
 :skolemid |69|
 :pattern ( (|e#frame| EmptyFrame x_1@@1))
 :pattern ( (|Seq#ContainsTrigger_6503| xs x_1@@1))
 :pattern ( (|Seq#Contains_6503| xs x_1@@1))
 :pattern ( (|e#frame| EmptyFrame x_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_6503| xs (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (e_5 Heap@@35 (invRecv1 o_4)) o_4))
 :qid |stdinbpl.755:22|
 :skolemid |70|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (|Seq#Contains_6503| xs x_1@@2) (not (= (e_5 Heap@@35 x_1@@2) null)))
 :qid |stdinbpl.761:22|
 :skolemid |71|
 :pattern ( (|e#frame| EmptyFrame x_1@@2))
 :pattern ( (|Seq#ContainsTrigger_6503| xs x_1@@2))
 :pattern ( (|Seq#Contains_6503| xs x_1@@2))
 :pattern ( (|e#frame| EmptyFrame x_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_6503| xs (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (e_5 Heap@@35 (invRecv1 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_6503| xs (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.767:22|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_9789_53) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_9750_6450_53#PolymorphicMapType_9750| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_9802_9803) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9750_6450_9803#PolymorphicMapType_9750| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_15831_3157) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9750_6450_3157#PolymorphicMapType_9750| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_6450_16351) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9750_6450_6478#PolymorphicMapType_9750| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_6450_16368) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9750_6450_36537#PolymorphicMapType_9750| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_16350_53) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| ZeroMask) o_4@@6 f_5@@4) (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| ZeroMask) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_9750_6477_53#PolymorphicMapType_9750| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_16350_9803) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| ZeroMask) o_4@@7 f_5@@5) (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| ZeroMask) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_9750_6477_9803#PolymorphicMapType_9750| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_16350_3157) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| ZeroMask) o_4@@8 f_5@@6) (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| ZeroMask) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_9750_6477_3157#PolymorphicMapType_9750| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_16350_16351) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| ZeroMask) o_4@@9 f_5@@7) (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| ZeroMask) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_9750_6477_6478#PolymorphicMapType_9750| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_16363_16368) ) (!  (=> true (= (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| ZeroMask) o_4@@10 f_5@@8) (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.771:29|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| ZeroMask) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_9750_6477_36948#PolymorphicMapType_9750| QPMask@0) o_4@@10 f_5@@8))
))) (and (state Heap@@35 QPMask@0) (state Heap@@35 QPMask@0))) (and (=> (= (ControlFlow 0 20) 19) anon27_Then_correct) (=> (= (ControlFlow 0 20) 11) anon27_Else_correct))))))))
(let ((anon26_Then_correct true))
(let ((anon11_correct true))
(let ((anon25_Then_correct  (=> (|Seq#Contains_6503| xs x_10) (and (=> (= (ControlFlow 0 9) 8) anon26_Then_correct) (=> (= (ControlFlow 0 9) 6) anon11_correct)))))
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains_6503| xs x_10)) (= (ControlFlow 0 7) 6)) anon11_correct)))
(let ((anon20_Else_correct  (=> (forall ((ix_1 T@Ref) (jx_1 T@Ref) ) (!  (=> (and (|Seq#Contains_6503| xs ix_1) (and (|Seq#Contains_6503| xs jx_1) (not (= ix_1 jx_1)))) (not (= (e_5 Heap@@35 ix_1) (e_5 Heap@@35 jx_1))))
 :qid |stdinbpl.726:20|
 :skolemid |67|
 :pattern ( (|Seq#ContainsTrigger_6503| xs ix_1) (|Seq#ContainsTrigger_6503| xs jx_1))
 :pattern ( (|Seq#ContainsTrigger_6503| xs ix_1) (|Seq#Contains_6503| xs jx_1))
 :pattern ( (|Seq#Contains_6503| xs ix_1) (|Seq#ContainsTrigger_6503| xs jx_1))
 :pattern ( (|Seq#Contains_6503| xs ix_1) (|Seq#Contains_6503| xs jx_1))
 :pattern ( (|Seq#ContainsTrigger_6503| xs ix_1) (|e#frame| EmptyFrame jx_1))
 :pattern ( (|Seq#Contains_6503| xs ix_1) (|e#frame| EmptyFrame jx_1))
 :pattern ( (|Seq#ContainsTrigger_6503| xs jx_1) (|e#frame| EmptyFrame ix_1))
 :pattern ( (|Seq#Contains_6503| xs jx_1) (|e#frame| EmptyFrame ix_1))
 :pattern ( (|e#frame| EmptyFrame ix_1) (|e#frame| EmptyFrame jx_1))
)) (=> (and (state Heap@@35 ZeroMask) (state Heap@@35 ZeroMask)) (and (and (=> (= (ControlFlow 0 22) 20) anon24_Else_correct) (=> (= (ControlFlow 0 22) 9) anon25_Then_correct)) (=> (= (ControlFlow 0 22) 7) anon25_Else_correct))))))
(let ((anon23_Then_correct true))
(let ((anon22_Then_correct true))
(let ((anon6_correct true))
(let ((anon21_Then_correct  (=> (and (|Seq#Contains_6503| xs ix) (and (|Seq#Contains_6503| xs jx) (not (= ix jx)))) (and (and (=> (= (ControlFlow 0 5) 3) anon22_Then_correct) (=> (= (ControlFlow 0 5) 4) anon23_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon21_Else_correct  (=> (and (not (and (|Seq#Contains_6503| xs ix) (and (|Seq#Contains_6503| xs jx) (not (= ix jx))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@35 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@35 ZeroMask))) (and (and (=> (= (ControlFlow 0 23) 22) anon20_Else_correct) (=> (= (ControlFlow 0 23) 5) anon21_Then_correct)) (=> (= (ControlFlow 0 23) 2) anon21_Else_correct)))))
