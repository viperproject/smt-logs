...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) null (p_14 a_2@@8 1)))) (=> (<= FullPerm (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) null (p_14 a_2@@8 1))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_2@@8 a_2@@8)) (not (= (+ i_1 1) (+ i_1_1 1)))))
 :qid |stdinbpl.1123:17|
 :skolemid |104|
...
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_1@@1) (< NoPerm FullPerm)) (and (= (invRecv7 a_2@@8 (+ i_1@@1 1)) i_1@@1) (qpRange7 a_2@@8 (+ i_1@@1 1))))
...
)) (=> (and (forall ((a_1_1_1 T@IArrayDomainType) (i_2_1_1 Int) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) (invRecv7 a_1_1_1 i_2_1_1)) (< NoPerm FullPerm)) (qpRange7 a_1_1_1 i_2_1_1)) (and (= a_2@@8 a_1_1_1) (= (+ (invRecv7 a_1_1_1 i_2_1_1) 1) i_2_1_1)))
 :qid |stdinbpl.1133:22|
 :skolemid |106|
 :pattern ( (invRecv7 a_1_1_1 i_2_1_1))
)) (forall ((a_1_1_1@@0 T@IArrayDomainType) (i_2_1_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) (invRecv7 a_1_1_1@@0 i_2_1_1@@0)) (< NoPerm FullPerm)) (qpRange7 a_1_1_1@@0 i_2_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_2@@8 a_1_1_1@@0) (= (+ (invRecv7 a_1_1_1@@0 i_2_1_1@@0) 1) i_2_1_1@@0))) (= (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) null (p_14 a_1_1_1@@0 i_2_1_1@@0)) (+ (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| ZeroMask) null (p_14 a_1_1_1@@0 i_2_1_1@@0)) FullPerm))))
 ...
 :qid |stdinbpl.1145:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| ZeroMask) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) o_4 f_5))
...
(let ((anon0_correct  (=> (and (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (and (> n@@13 3) (state Heap@@32 ZeroMask))) (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 7) anon7_Else_correct)))))
