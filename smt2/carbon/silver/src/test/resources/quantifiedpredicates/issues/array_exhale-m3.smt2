...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) null (p_2 a_2@@8 1)))) (=> (<= FullPerm (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) null (p_2 a_2@@8 1))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
...
)) (=> (and (forall ((a_1_1_1 T@IArrayDomainType) (i_2_1 Int) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) (invRecv7 a_1_1_1 i_2_1)) (< NoPerm FullPerm)) (qpRange7 a_1_1_1 i_2_1)) (and (= a_2@@8 a_1_1_1) (= (+ (invRecv7 a_1_1_1 i_2_1) 1) i_2_1)))
 :qid |stdinbpl.1133:22|
 :skolemid |106|
 :pattern ( (invRecv7 a_1_1_1 i_2_1))
)) (forall ((a_1_1_1@@0 T@IArrayDomainType) (i_2_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) (invRecv7 a_1_1_1@@0 i_2_1@@0)) (< NoPerm FullPerm)) (qpRange7 a_1_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_2@@8 a_1_1_1@@0) (= (+ (invRecv7 a_1_1_1@@0 i_2_1@@0) 1) i_2_1@@0))) (= (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) null (p_2 a_1_1_1@@0 i_2_1@@0)) (+ (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| ZeroMask) null (p_2 a_1_1_1@@0 i_2_1@@0)) FullPerm))))
...
))) (forall ((a_1_1_1@@1 T@IArrayDomainType) (i_2_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) (invRecv7 a_1_1_1@@1 i_2_1@@1)) (< NoPerm FullPerm)) (qpRange7 a_1_1_1@@1 i_2_1@@1))) (= (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) null (p_2 a_1_1_1@@1 i_2_1@@1)) (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| ZeroMask) null (p_2 a_1_1_1@@1 i_2_1@@1))))
