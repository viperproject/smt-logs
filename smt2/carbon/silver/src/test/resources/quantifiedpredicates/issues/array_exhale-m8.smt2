...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_3_2)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_3_2 1)) (loc a_2@@8 (+ i_3_3 1)))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_4_1)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_4_1 1)) (loc a_2@@8 (+ i_4_2 1)))))
 :qid |stdinbpl.1942:17|
 :skolemid |184|
 :pattern ( (neverTriggered20 i_4_1) (neverTriggered20 i_4_2))
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_4_1@@0)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_4_1@@0 1)) (loc a_2@@8 (+ i_4_2@@0 1)))))
 :qid |stdinbpl.1942:17|
 :skolemid |184|
 :pattern ( (neverTriggered20 i_4_1@@0) (neverTriggered20 i_4_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_4_1@@1 Int) ) (!  (=> (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_4_1@@1) (>= (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) (loc a_2@@8 (+ i_4_1@@1 1)) val) FullPerm))
 :qid |stdinbpl.1949:17|
 :skolemid |185|
 :pattern ( (|Seq#ContainsTrigger_3704| (|Seq#Range| 0 n@@13) i_4_1@@1))
 :pattern ( (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_4_1@@1))
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_1)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_1) (loc a_2@@8 i_1_1))))
 :qid |stdinbpl.1844:15|
 :skolemid |172|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_1@@0)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_1@@0) (loc a_2@@8 i_1_1@@0))))
 :qid |stdinbpl.1844:15|
 :skolemid |172|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_1@@1) (< NoPerm FullPerm)) (and (qpRange18 (loc a_2@@8 i_1@@1)) (= (invRecv18 (loc a_2@@8 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1850:22|
 :skolemid |173|
 :pattern ( (loc a_2@@8 i_1@@1))
 :pattern ( (loc a_2@@8 i_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) (invRecv18 o_9)) (< NoPerm FullPerm)) (qpRange18 o_9)) (= (loc a_2@@8 (invRecv18 o_9)) o_9))
 :qid |stdinbpl.1854:22|
 :skolemid |174|
 :pattern ( (invRecv18 o_9))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_1@@2) (not (= (loc a_2@@8 i_1@@2) null)))
 :qid |stdinbpl.1860:22|
 :skolemid |175|
 :pattern ( (loc a_2@@8 i_1@@2))
 :pattern ( (loc a_2@@8 i_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) (invRecv18 o_9@@0)) (< NoPerm FullPerm)) (qpRange18 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@8 (invRecv18 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) (invRecv18 o_9@@0)) (< NoPerm FullPerm)) (qpRange18 o_9@@0))) (= (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_22629_15994_3961#PolymorphicMapType_22629| ZeroMask) o_9@@0 val))))
