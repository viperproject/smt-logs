...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_3)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 (+ i_3 1)) (loc a_2@@8 (+ i_3_1 1)))))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_1)) (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_1) (loc a_2@@8 i_1_1))))
 ...
 :pattern ( (loc a_2@@8 i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) (invRecv18 o_4)) (< NoPerm FullPerm)) (qpRange18 o_4)) (= (loc a_2@@8 (invRecv18 o_4)) o_4))
