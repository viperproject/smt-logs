...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_5)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_2@@8 a_2@@8)) (not (= (+ i_5 1) (+ i_5_1 1)))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_8_2 Int) (i_8_3 Int) ) (!  (=> (and (and (and (and (not (= i_8_2 i_8_3)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_8_2)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_8_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_2@@8 a_2@@8)) (not (= (+ i_8_2 1) (+ i_8_3 1)))))
 :qid |stdinbpl.1769:17|
 :skolemid |165|
 :pattern ( (neverTriggered17 i_8_2) (neverTriggered17 i_8_3))
))) (=> (forall ((i_8_2@@0 Int) (i_8_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8_2@@0 i_8_3@@0)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_8_2@@0)) (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_8_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_2@@8 a_2@@8)) (not (= (+ i_8_2@@0 1) (+ i_8_3@@0 1)))))
 :qid |stdinbpl.1769:17|
 :skolemid |165|
 :pattern ( (neverTriggered17 i_8_2@@0) (neverTriggered17 i_8_3@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_8_2@@1 Int) ) (!  (=> (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_8_2@@1) (>= (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) null (p_14 a_2@@8 (+ i_8_2@@1 1))) FullPerm))
 :qid |stdinbpl.1776:17|
 :skolemid |166|
 :pattern ( (|Seq#ContainsTrigger_3704| (|Seq#Range| 0 n@@13) i_8_2@@1))
 :pattern ( (|Seq#Contains_3704| (|Seq#Range| 0 n@@13) i_8_2@@1))
)))))))
...
)) (=> (and (forall ((a_1_1_1 T@IArrayDomainType) (i_2_1_1 Int) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) (invRecv15 a_1_1_1 i_2_1_1)) (< NoPerm FullPerm)) (qpRange15 a_1_1_1 i_2_1_1)) (and (= a_2@@8 a_1_1_1) (= (invRecv15 a_1_1_1 i_2_1_1) i_2_1_1)))
 :qid |stdinbpl.1679:22|
 :skolemid |155|
 :pattern ( (invRecv15 a_1_1_1 i_2_1_1))
)) (forall ((a_1_1_1@@0 T@IArrayDomainType) (i_2_1_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) (invRecv15 a_1_1_1@@0 i_2_1_1@@0)) (< NoPerm FullPerm)) (qpRange15 a_1_1_1@@0 i_2_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_2@@8 a_1_1_1@@0) (= (invRecv15 a_1_1_1@@0 i_2_1_1@@0) i_2_1_1@@0))) (= (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) null (p_14 a_1_1_1@@0 i_2_1_1@@0)) (+ (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| ZeroMask) null (p_14 a_1_1_1@@0 i_2_1_1@@0)) FullPerm))))
...
))) (forall ((a_1_1_1@@1 T@IArrayDomainType) (i_2_1_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_3704| (|Seq#Range| 1 (+ n@@13 1)) (invRecv15 a_1_1_1@@1 i_2_1_1@@1)) (< NoPerm FullPerm)) (qpRange15 a_1_1_1@@1 i_2_1_1@@1))) (= (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| QPMask@0) null (p_14 a_1_1_1@@1 i_2_1_1@@1)) (select (|PolymorphicMapType_22629_15997_15998#PolymorphicMapType_22629| ZeroMask) null (p_14 a_1_1_1@@1 i_2_1_1@@1))))
