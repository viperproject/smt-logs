  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (i <= 0 ? true : (unfolding acc(list(r, i), write) in r.val == v && allSet(r.next, i - 1, v)))
      if (i <= 0) {
        ...
        perm := FullPerm;
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access list(r, i) (list.vpr@13.1--21.2) [106194]"}
        ...
        assume state(UnfoldingHeap, UnfoldingMask);
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access r.val (list.vpr@13.1--21.2) [106195]"}
          HasDirectPerm(UnfoldingMask, r_1, val);
        if (UnfoldingHeap[r_1, val] == v_2) {
          assert {:msg "  Function might not be well-formed. There might be insufficient permission to access r.next (list.vpr@13.1--21.2) [106196]"}
          ...
          if (*) {
            ...
            ExhaleWellDef0Heap := UnfoldingHeap;
            perm := FullPerm;
            assert {:msg "  Precondition of function allSet might not hold. There might be insufficient permission to access list(r.next, i - 1) (list.vpr@19.37--19.59) [106197]"}
  ...
  // -- Check definedness of predicate body of list
    ...
    if (i > 0) {
      ...
      // -- Check definedness of acc(list(r.next, i - 1), write)
        assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access r.next (list.vpr@7.1--10.2) [106198]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(list(r, length), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length) might not be injective. (list.vpr@25.10--25.62) [106199]"}
  ...
  if (*) {
    ...
    // -- check if receiver acc(list(r, length), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length) might not be injective. (list.vpr@26.9--26.85) [106200]"}
      ...
      if (*) {
        if (lists[r_12]) {
          if (*) {
            ...
            perm := FullPerm;
            assert {:msg "  Precondition of function allSet might not hold. There might be insufficient permission to access list(r, length) (list.vpr@26.65--26.85) [106201]"}
  ...
  // -- Translating statement: s := lists -- list.vpr@28.5--28.29
    s_2 := lists;
    assume state(Heap, Mask);
  
  // -- Translating statement: sNext := Set[Ref]() -- list.vpr@29.5--29.38
    sNext := (Set#Empty(): Set Ref);
    assume state(Heap, Mask);
  
  // -- Translating statement: while (|s| > 0) -- list.vpr@30.5--46.6
    ...
    // -- Before loop head
      ...
      // -- Exhale loop invariant before loop
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r, length), write)) might not hold on entry. Quantified resource list(r, length) might not be injective. (list.vpr@31.15--31.63) [106202]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r, length), write)) might not hold on entry. There might be insufficient permission to access list(r, length) (list.vpr@31.15--31.63) [106203]"}
            (forall r_14: Ref ::
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.next, write)) might not hold on entry. Quantified resource r.next might not be injective. (list.vpr@32.15--32.71) [106204]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.next, write)) might not hold on entry. There might be insufficient permission to access r.next (list.vpr@32.15--32.71) [106205]"}
            (forall r_16: Ref ::
        ...
        // -- check if receiver acc(list(r, length - 1), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in sNext) } (r in sNext) ==> acc(list(r, length - 1), write)) might not hold on entry. Quantified resource list(r, length - 1) might not be injective. (list.vpr@33.15--33.69) [106206]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in sNext) } (r in sNext) ==> acc(list(r, length - 1), write)) might not hold on entry. There might be insufficient permission to access list(r, length - 1) (list.vpr@33.15--33.69) [106207]"}
            (forall r_17: Ref ::
            { sNext[r_17] }
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not hold on entry. Quantified resource r.val might not be injective. (list.vpr@34.15--34.84) [106208]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not hold on entry. There might be insufficient permission to access r.val (list.vpr@34.15--34.84) [106209]"}
            (forall r_19: Ref ::
        ...
        if (*) {
          if (lists[r_20] && !s_2[r_20]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not hold on entry. Assertion r.val == v might not hold. (list.vpr@34.15--34.84) [106210]"}
              Heap[r_20, val] == v_2;
          }
          assume false;
        }
        ...
        if (*) {
          if (lists[r_22] && !s_2[r_22]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } { (r.next in sNext) } (r in lists) && !((r in s)) ==> (r.next in sNext)) might not hold on entry. Assertion (r.next in sNext) might not hold. (list.vpr@35.15--35.75) [106211]"}
        ...
        if (*) {
          if (lists[r1] && (!s_2[r1] && (lists[r2] && (!s_2[r2] && r1 != r2)))) {
            assert {:msg "  Loop invariant (forall r1: Ref, r2: Ref :: { (r1 in lists), (r2 in lists) } { (r1 in lists), (r2 in s) } { (r1 in s), (r2 in lists) } { (r1 in s), (r2 in s) } (r1 in lists) && (!((r1 in s)) && ((r2 in lists) && (!((r2 in s)) && r1 != r2))) ==> r1.next != r2.next) might not hold on entry. Assertion r1.next != r2.next might not hold. (list.vpr@36.15--36.131) [106212]"}
    ...
    // -- Check definedness of invariant
      if (*) {
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length) might not be injective. (list.vpr@31.15--31.63) [106213]"}
        ...
        havoc QPMask;
        assert {:msg "  Contract might not be well-formed. Quantified resource r.next might not be injective. (list.vpr@32.15--32.71) [106214]"}
        ...
        // -- check if receiver acc(list(r, length - 1), write) is injective
          assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length - 1) might not be injective. (list.vpr@33.15--33.69) [106215]"}
        ...
        havoc QPMask;
        assert {:msg "  Contract might not be well-formed. Quantified resource r.val might not be injective. (list.vpr@34.15--34.84) [106216]"}
        ...
        // -- Check definedness of (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v)
          if (*) {
            if (lists[r_13] && !s_2[r_13]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r.val (list.vpr@34.15--34.84) [106217]"}
        ...
        // -- Check definedness of (forall r: Ref :: { (r in lists) } { (r in s) } { (r.next in sNext) } (r in lists) && !((r in s)) ==> (r.next in sNext))
          if (*) {
            if (lists[r_15] && !s_2[r_15]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r.next (list.vpr@35.15--35.75) [106218]"}
        ...
        // -- Check definedness of (forall r1: Ref, r2: Ref :: { (r1 in lists), (r2 in lists) } { (r1 in lists), (r2 in s) } { (r1 in s), (r2 in lists) } { (r1 in s), (r2 in s) } (r1 in lists) && (!((r1 in s)) && ((r2 in lists) && (!((r2 in s)) && r1 != r2))) ==> r1.next != r2.next)
          if (*) {
            if (lists[r1_1] && (!s_2[r1_1] && (lists[r2_1] && (!s_2[r2_1] && r1_1 != r2_1)))) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r1.next (list.vpr@36.15--36.131) [106219]"}
                HasDirectPerm(Mask, r1_1, next);
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r2.next (list.vpr@36.15--36.131) [106220]"}
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  While statement might fail. Quantified resource list(r, length) might not be injective. (list.vpr@31.15--31.63) [106221]"}
        ...
        assume state(Heap, Mask);
        havoc QPMask;
        assert {:msg "  While statement might fail. Quantified resource r.next might not be injective. (list.vpr@32.15--32.71) [106222]"}
        ...
        // -- check if receiver acc(list(r, length - 1), write) is injective
          assert {:msg "  While statement might fail. Quantified resource list(r, length - 1) might not be injective. (list.vpr@33.15--33.69) [106223]"}
        ...
        assume state(Heap, Mask);
        havoc QPMask;
        assert {:msg "  While statement might fail. Quantified resource r.val might not be injective. (list.vpr@34.15--34.84) [106224]"}
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: inhale (l in s) -- list.vpr@39.16--39.22
            assume s_2[l_2];
            assume state(Heap, Mask);
            assume state(Heap, Mask);
          ...
          // -- Translating statement: unfold acc(list(l, length), write) -- list.vpr@40.9--40.31
            ...
            perm := FullPerm;
            if (perm != NoPerm) {
              assert {:msg "  Unfolding list(l, length) might fail. There might be insufficient permission to access list(l, length) (list.vpr@40.9--40.31) [106225]"}
  ...
  //     { (r in lists) }
  //     { (r in s) }
  //     (r in lists) && !((r in s)) ==> r.next != l.next) -- list.vpr@41.16--41.77
            
            // -- Check definedness of (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.next != l.next)
              if (*) {
                if (lists[r_18] && !s_2[r_18]) {
                  assert {:msg "  Inhale might fail. There might be insufficient permission to access r.next (list.vpr@41.16--41.77) [106226]"}
                    HasDirectPerm(Mask, r_18, next);
                  assert {:msg "  Inhale might fail. There might be insufficient permission to access l.next (list.vpr@41.16--41.77) [106227]"}
          ...
          // -- Translating statement: s := (s setminus Set(l)) -- list.vpr@43.9--43.31
            s_2 := Set#Difference(s_2, Set#Singleton(l_2));
            assume state(Heap, Mask);
          
          // -- Translating statement: sNext := (sNext union Set(l.next)) -- list.vpr@44.9--44.41
            
            // -- Check definedness of (sNext union Set(l.next))
              assert {:msg "  Assignment might fail. There might be insufficient permission to access l.next (list.vpr@44.9--44.41) [106228]"}
                HasDirectPerm(Mask, l_2, next);
            sNext := Set#Union(sNext, Set#Singleton(Heap[l_2, next]));
            assume state(Heap, Mask);
          
          // -- Translating statement: l.val := v -- list.vpr@45.9--45.19
            assert {:msg "  Assignment might fail. There might be insufficient permission to access l.val (list.vpr@45.9--45.19) [106229]"}
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r, length), write)) might not be preserved. Quantified resource list(r, length) might not be injective. (list.vpr@31.15--31.63) [106230]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r, length), write)) might not be preserved. There might be insufficient permission to access list(r, length) (list.vpr@31.15--31.63) [106231]"}
            (forall r_52: Ref ::
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.next, write)) might not be preserved. Quantified resource r.next might not be injective. (list.vpr@32.15--32.71) [106232]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.next, write)) might not be preserved. There might be insufficient permission to access r.next (list.vpr@32.15--32.71) [106233]"}
            (forall r_54: Ref ::
        ...
        // -- check if receiver acc(list(r, length - 1), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in sNext) } (r in sNext) ==> acc(list(r, length - 1), write)) might not be preserved. Quantified resource list(r, length - 1) might not be injective. (list.vpr@33.15--33.69) [106234]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in sNext) } (r in sNext) ==> acc(list(r, length - 1), write)) might not be preserved. There might be insufficient permission to access list(r, length - 1) (list.vpr@33.15--33.69) [106235]"}
            (forall r_55: Ref ::
            { sNext[r_55] }
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not be preserved. Quantified resource r.val might not be injective. (list.vpr@34.15--34.84) [106236]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not be preserved. There might be insufficient permission to access r.val (list.vpr@34.15--34.84) [106237]"}
            (forall r_57: Ref ::
        ...
        if (*) {
          if (lists[r_58] && !s_2[r_58]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not be preserved. Assertion r.val == v might not hold. (list.vpr@34.15--34.84) [106238]"}
              Heap[r_58, val] == v_2;
          }
          assume false;
        }
        ...
        if (*) {
          if (lists[r_60] && !s_2[r_60]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } { (r.next in sNext) } (r in lists) && !((r in s)) ==> (r.next in sNext)) might not be preserved. Assertion (r.next in sNext) might not hold. (list.vpr@35.15--35.75) [106239]"}
        ...
        if (*) {
          if (lists[r1_5] && (!s_2[r1_5] && (lists[r2_5] && (!s_2[r2_5] && r1_5 != r2_5)))) {
            assert {:msg "  Loop invariant (forall r1: Ref, r2: Ref :: { (r1 in lists), (r2 in lists) } { (r1 in lists), (r2 in s) } { (r1 in s), (r2 in lists) } { (r1 in s), (r2 in s) } (r1 in lists) && (!((r1 in s)) && ((r2 in lists) && (!((r2 in s)) && r1 != r2))) ==> r1.next != r2.next) might not be preserved. Assertion r1.next != r2.next might not hold. (list.vpr@36.15--36.131) [106240]"}
    ...
    // -- Inhale loop invariant after loop, and assume guard
      ...
      // -- check if receiver acc(list(r, length), write) is injective
        assert {:msg "  While statement might fail. Quantified resource list(r, length) might not be injective. (list.vpr@31.15--31.63) [106241]"}
      ...
      assume state(Heap, Mask);
      havoc QPMask;
      assert {:msg "  While statement might fail. Quantified resource r.next might not be injective. (list.vpr@32.15--32.71) [106242]"}
      ...
      // -- check if receiver acc(list(r, length - 1), write) is injective
        assert {:msg "  While statement might fail. Quantified resource list(r, length - 1) might not be injective. (list.vpr@33.15--33.69) [106243]"}
      ...
      assume state(Heap, Mask);
      havoc QPMask;
      assert {:msg "  While statement might fail. Quantified resource r.val might not be injective. (list.vpr@34.15--34.84) [106244]"}
  ...
  // -- Translating statement: if (length - 1 > 0) -- list.vpr@47.5--49.6
    if (length_2 - 1 > 0) {
      
      // -- Translating statement: m1(sNext, length - 1, v) -- list.vpr@48.9--48.31
        PreCallHeap := Heap;
        PreCallMask := Mask;
        ...
        // -- Exhaling precondition
          ExhaleWellDef0Mask := Mask;
          ExhaleWellDef0Heap := Heap;
          assert {:msg "  The precondition of method m1 might not hold. Assertion length - 1 > 0 might not hold. (list.vpr@48.9--48.31) [106245]"}
            arg_length > 0;
          havoc QPMask;
          ...
          // -- check if receiver acc(list(r, arg_length), write) is injective
            assert {:msg "  The precondition of method m1 might not hold. Quantified resource list(r, length - 1) might not be injective. (list.vpr@48.9--48.31) [106246]"}
          ...
          // -- check if sufficient permission is held
            assert {:msg "  The precondition of method m1 might not hold. There might be insufficient permission to access list(r, length - 1) (list.vpr@48.9--48.31) [106247]"}
              (forall r_72: Ref ::
        ...
        // -- Inhaling postcondition
          ...
          // -- check if receiver acc(list(r, arg_length), write) is injective
            assert {:msg "  Method call might fail. Quantified resource list(r, length - 1) might not be injective. (list.vpr@48.9--48.31) [106248]"}
  ...
  // -- Translating statement: s := lists -- list.vpr@50.5--50.15
    s_2 := lists;
    assume state(Heap, Mask);
  
  // -- Translating statement: while (|s| > 0) -- list.vpr@51.5--63.10
    ...
    // -- Before loop head
      ...
      // -- Exhale loop invariant before loop
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(list(r, length), write)) might not hold on entry. Quantified resource list(r, length) might not be injective. (list.vpr@52.19--52.84) [106249]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(list(r, length), write)) might not hold on entry. There might be insufficient permission to access list(r, length) (list.vpr@52.19--52.84) [106250]"}
            (forall r_78: Ref ::
        ...
        if (*) {
          if (lists[r_80] && !s_2[r_80]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } { allSet(r, length, v) } (r in lists) && !((r in s)) ==> allSet(r, length, v)) might not hold on entry. Assertion allSet(r, length, v) might not hold. (list.vpr@53.19--53.85) [106251]"}
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not hold on entry. Quantified resource r.val might not be injective. (list.vpr@54.19--54.86) [106252]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not hold on entry. There might be insufficient permission to access r.val (list.vpr@54.19--54.86) [106253]"}
            (forall r_82: Ref ::
        ...
        if (*) {
          if (s_2[r_83]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not hold on entry. Assertion r.val == v might not hold. (list.vpr@54.19--54.86) [106254]"}
              Heap[r_83, val] == v_2;
          }
          assume false;
        }
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not hold on entry. Quantified resource r.next might not be injective. (list.vpr@54.19--54.86) [106255]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not hold on entry. There might be insufficient permission to access r.next (list.vpr@54.19--54.86) [106256]"}
            (forall r_85: Ref ::
        ...
        if (*) {
          if (s_2[r1_8] && (s_2[r2_8] && r1_8 != r2_8)) {
            assert {:msg "  Loop invariant (forall r1: Ref, r2: Ref :: { (r1 in s), (r2 in s) } (r1 in s) && ((r2 in s) && r1 != r2) ==> r1.next != r2.next) might not hold on entry. Assertion r1.next != r2.next might not hold. (list.vpr@55.19--55.99) [106257]"}
        ...
        // -- check if receiver acc(list(r.next, length - 1), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r.next, length - 1), write)) might not hold on entry. Quantified resource list(r.next, length - 1) might not be injective. (list.vpr@56.19--56.75) [106258]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r.next, length - 1), write)) might not hold on entry. There might be insufficient permission to access list(r.next, length - 1) (list.vpr@56.19--56.75) [106259]"}
            (forall r_86: Ref ::
            { s_2[r_86] }
        ...
        if (*) {
          if (s_2[r_88]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> allSet(r.next, length - 1, v)) might not hold on entry. Assertion allSet(r.next, length - 1, v) might not hold. (list.vpr@57.19--57.75) [106260]"}
    ...
    // -- Check definedness of invariant
      if (*) {
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length) might not be injective. (list.vpr@52.19--52.84) [106261]"}
          ...
          if (*) {
            if (lists[r_21] && !s_2[r_21]) {
              if (*) {
                ...
                ExhaleWellDef0Heap := Heap;
                perm := FullPerm;
                assert {:msg "  Precondition of function allSet might not hold. There might be insufficient permission to access list(r, length) (list.vpr@53.65--53.85) [106262]"}
        ...
        havoc QPMask;
        assert {:msg "  Contract might not be well-formed. Quantified resource r.val might not be injective. (list.vpr@54.19--54.86) [106263]"}
        ...
        // -- Check definedness of (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v)
          if (*) {
            if (s_2[r_23]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r.val (list.vpr@54.19--54.86) [106264]"}
        ...
        havoc QPMask;
        assert {:msg "  Contract might not be well-formed. Quantified resource r.next might not be injective. (list.vpr@54.19--54.86) [106265]"}
        ...
        // -- Check definedness of (forall r1: Ref, r2: Ref :: { (r1 in s), (r2 in s) } (r1 in s) && ((r2 in s) && r1 != r2) ==> r1.next != r2.next)
          if (*) {
            if (s_2[r1_2] && (s_2[r2_2] && r1_2 != r2_2)) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r1.next (list.vpr@55.19--55.99) [106266]"}
                HasDirectPerm(Mask, r1_2, next);
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r2.next (list.vpr@55.19--55.99) [106267]"}
        ...
        // -- Check definedness of (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r.next, length - 1), write))
          if (*) {
            if (s_2[r_24]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r.next (list.vpr@56.19--56.75) [106268]"}
        ...
        // -- check if receiver acc(list(r.next, length - 1), write) is injective
          assert {:msg "  Contract might not be well-formed. Quantified resource list(r.next, length - 1) might not be injective. (list.vpr@56.19--56.75) [106269]"}
        ...
        // -- Check definedness of (forall r: Ref :: { (r in s) } (r in s) ==> allSet(r.next, length - 1, v))
          if (*) {
            if (s_2[r_26]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r.next (list.vpr@57.19--57.75) [106270]"}
              ...
              if (*) {
                ...
                ExhaleWellDef0Heap := Heap;
                perm := FullPerm;
                assert {:msg "  Precondition of function allSet might not hold. There might be insufficient permission to access list(r.next, length - 1) (list.vpr@57.48--57.75) [106271]"}
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  While statement might fail. Quantified resource list(r, length) might not be injective. (list.vpr@52.19--52.84) [106272]"}
        ...
        havoc QPMask;
        assert {:msg "  While statement might fail. Quantified resource r.val might not be injective. (list.vpr@54.19--54.86) [106273]"}
        ...
        havoc QPMask;
        assert {:msg "  While statement might fail. Quantified resource r.next might not be injective. (list.vpr@54.19--54.86) [106274]"}
        ...
        // -- check if receiver acc(list(r.next, length - 1), write) is injective
          assert {:msg "  While statement might fail. Quantified resource list(r.next, length - 1) might not be injective. (list.vpr@56.19--56.75) [106275]"}
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: inhale (l2 in s) -- list.vpr@60.20--60.27
            assume s_2[l2_2];
            assume state(Heap, Mask);
            assume state(Heap, Mask);
          ...
          // -- Translating statement: fold acc(list(l2, length), write) -- list.vpr@61.13--61.34
            ...
            if (length_2 > 0) {
              perm := FullPerm;
              if (perm != NoPerm) {
                assert {:msg "  Folding list(l2, length) might fail. There might be insufficient permission to access l2.val (list.vpr@61.13--61.34) [106276]"}
                  perm <= Mask[l2_2, val];
              }
              Mask := Mask[l2_2, val:=Mask[l2_2, val] - perm];
              perm := FullPerm;
              if (perm != NoPerm) {
                assert {:msg "  Folding list(l2, length) might fail. There might be insufficient permission to access l2.next (list.vpr@61.13--61.34) [106277]"}
                  perm <= Mask[l2_2, next];
              }
              Mask := Mask[l2_2, next:=Mask[l2_2, next] - perm];
              perm := FullPerm;
              if (perm != NoPerm) {
                assert {:msg "  Folding list(l2, length) might fail. There might be insufficient permission to access list(l2.next, length - 1) (list.vpr@61.13--61.34) [106278]"}
          ...
          // -- Translating statement: s := (s setminus Set(l2)) -- list.vpr@62.13--62.36
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(list(r, length), write)) might not be preserved. Quantified resource list(r, length) might not be injective. (list.vpr@52.19--52.84) [106279]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(list(r, length), write)) might not be preserved. There might be insufficient permission to access list(r, length) (list.vpr@52.19--52.84) [106280]"}
            (forall r_119: Ref ::
        ...
        if (*) {
          if (lists[r_121] && !s_2[r_121]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } { allSet(r, length, v) } (r in lists) && !((r in s)) ==> allSet(r, length, v)) might not be preserved. Assertion allSet(r, length, v) might not hold. (list.vpr@53.19--53.85) [106281]"}
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not be preserved. Quantified resource r.val might not be injective. (list.vpr@54.19--54.86) [106282]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not be preserved. There might be insufficient permission to access r.val (list.vpr@54.19--54.86) [106283]"}
            (forall r_123: Ref ::
        ...
        if (*) {
          if (s_2[r_124]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not be preserved. Assertion r.val == v might not hold. (list.vpr@54.19--54.86) [106284]"}
              Heap[r_124, val] == v_2;
          }
          assume false;
        }
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not be preserved. Quantified resource r.next might not be injective. (list.vpr@54.19--54.86) [106285]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not be preserved. There might be insufficient permission to access r.next (list.vpr@54.19--54.86) [106286]"}
            (forall r_126: Ref ::
        ...
        if (*) {
          if (s_2[r1_13] && (s_2[r2_13] && r1_13 != r2_13)) {
            assert {:msg "  Loop invariant (forall r1: Ref, r2: Ref :: { (r1 in s), (r2 in s) } (r1 in s) && ((r2 in s) && r1 != r2) ==> r1.next != r2.next) might not be preserved. Assertion r1.next != r2.next might not hold. (list.vpr@55.19--55.99) [106287]"}
        ...
        // -- check if receiver acc(list(r.next, length - 1), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r.next, length - 1), write)) might not be preserved. Quantified resource list(r.next, length - 1) might not be injective. (list.vpr@56.19--56.75) [106288]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r.next, length - 1), write)) might not be preserved. There might be insufficient permission to access list(r.next, length - 1) (list.vpr@56.19--56.75) [106289]"}
            (forall r_127: Ref ::
            { s_2[r_127] }
        ...
        if (*) {
          if (s_2[r_129]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> allSet(r.next, length - 1, v)) might not be preserved. Assertion allSet(r.next, length - 1, v) might not hold. (list.vpr@57.19--57.75) [106290]"}
    ...
    // -- Inhale loop invariant after loop, and assume guard
      ...
      // -- check if receiver acc(list(r, length), write) is injective
        assert {:msg "  While statement might fail. Quantified resource list(r, length) might not be injective. (list.vpr@52.19--52.84) [106291]"}
      ...
      havoc QPMask;
      assert {:msg "  While statement might fail. Quantified resource r.val might not be injective. (list.vpr@54.19--54.86) [106292]"}
      ...
      havoc QPMask;
      assert {:msg "  While statement might fail. Quantified resource r.next might not be injective. (list.vpr@54.19--54.86) [106293]"}
      ...
      // -- check if receiver acc(list(r.next, length - 1), write) is injective
        assert {:msg "  While statement might fail. Quantified resource list(r.next, length - 1) might not be injective. (list.vpr@56.19--56.75) [106294]"}
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver acc(list(r, length), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length) might not be injective. (list.vpr@26.9--26.85) [106295]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m1 might not hold. There might be insufficient permission to access list(r, length) (list.vpr@26.9--26.85) [106296]"}
        (forall r_10_1: Ref ::
    ...
    if (*) {
      if (lists[r_12_1]) {
        assert {:msg "  Postcondition of m1 might not hold. Assertion allSet(r, length, v) might not hold. (list.vpr@26.9--26.85) [106297]"}
