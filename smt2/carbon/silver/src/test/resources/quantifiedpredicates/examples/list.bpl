  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (i <= 0 ? true : (unfolding acc(list(r, i), write) in r.val == v && allSet(r.next, i - 1, v)))
      if (i <= 0) {
        ...
        assume state(UnfoldingHeap, UnfoldingMask);
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access r.val (list.vpr@13.1--21.2) [201129]"}
          HasDirectPerm(UnfoldingMask, r_1, val);
        if (UnfoldingHeap[r_1, val] == v_2) {
          assert {:msg "  Function might not be well-formed. There might be insufficient permission to access r.next (list.vpr@13.1--21.2) [201130]"}
  ...
  // -- Check definedness of predicate body of list
    ...
    if (i > 0) {
      ...
      // -- Check definedness of acc(list(r.next, i - 1), write)
        assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access r.next (list.vpr@7.1--10.2) [201132]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(list(r, length), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length) might not be injective. (list.vpr@25.10--25.62) [201133]"}
  ...
  if (*) {
    ...
    // -- check if receiver acc(list(r, length), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length) might not be injective. (list.vpr@26.9--26.85) [201134]"}
  ...
  // -- Translating statement: while (|s| > 0) -- list.vpr@30.5--46.6
    ...
    // -- Before loop head
      ...
      // -- Exhale loop invariant before loop
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r, length), write)) might not hold on entry. Quantified resource list(r, length) might not be injective. (list.vpr@31.15--31.63) [201136]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r, length), write)) might not hold on entry. There might be insufficient permission to access list(r, length) (list.vpr@31.15--31.63) [201137]"}
            (forall r_14_1: Ref ::
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.next, write)) might not hold on entry. Quantified resource r.next might not be injective. (list.vpr@32.15--32.71) [201138]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.next, write)) might not hold on entry. There might be insufficient permission to access r.next (list.vpr@32.15--32.71) [201139]"}
            (forall r_16_1: Ref ::
        ...
        // -- check if receiver acc(list(r, length - 1), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in sNext) } (r in sNext) ==> acc(list(r, length - 1), write)) might not hold on entry. Quantified resource list(r, length - 1) might not be injective. (list.vpr@33.15--33.69) [201140]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in sNext) } (r in sNext) ==> acc(list(r, length - 1), write)) might not hold on entry. There might be insufficient permission to access list(r, length - 1) (list.vpr@33.15--33.69) [201141]"}
            (forall r_17: Ref ::
            { sNext[r_17] }
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not hold on entry. Quantified resource r.val might not be injective. (list.vpr@34.15--34.84) [201142]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not hold on entry. There might be insufficient permission to access r.val (list.vpr@34.15--34.84) [201143]"}
            (forall r_19: Ref ::
        ...
        if (*) {
          if (lists[r_20_1] && !s_1[r_20_1]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not hold on entry. Assertion r.val == v might not hold. (list.vpr@34.15--34.84) [201144]"}
              Heap[r_20_1, val] == v_2;
          }
          assume false;
        }
        ...
        if (*) {
          if (lists[r_22_1] && !s_1[r_22_1]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } { (r.next in sNext) } (r in lists) && !((r in s)) ==> (r.next in sNext)) might not hold on entry. Assertion (r.next in sNext) might not hold. (list.vpr@35.15--35.75) [201145]"}
        ...
        if (*) {
          if (lists[r1] && (!s_1[r1] && (lists[r2] && (!s_1[r2] && r1 != r2)))) {
            assert {:msg "  Loop invariant (forall r1: Ref, r2: Ref :: { (r1 in lists), (r2 in lists) } { (r1 in lists), (r2 in s) } { (r1 in s), (r2 in lists) } { (r1 in s), (r2 in s) } (r1 in lists) && (!((r1 in s)) && ((r2 in lists) && (!((r2 in s)) && r1 != r2))) ==> r1.next != r2.next) might not hold on entry. Assertion r1.next != r2.next might not hold. (list.vpr@36.15--36.131) [201146]"}
    ...
    // -- Check definedness of invariant
      if (*) {
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length) might not be injective. (list.vpr@31.15--31.63) [201147]"}
        ...
        havoc QPMask;
        assert {:msg "  Contract might not be well-formed. Quantified resource r.next might not be injective. (list.vpr@32.15--32.71) [201148]"}
        ...
        // -- check if receiver acc(list(r, length - 1), write) is injective
          assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length - 1) might not be injective. (list.vpr@33.15--33.69) [201149]"}
        ...
        havoc QPMask;
        assert {:msg "  Contract might not be well-formed. Quantified resource r.val might not be injective. (list.vpr@34.15--34.84) [201150]"}
        ...
        // -- Check definedness of (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v)
          if (*) {
            if (lists[r_30] && !s_1[r_30]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r.val (list.vpr@34.15--34.84) [201151]"}
        ...
        // -- Check definedness of (forall r: Ref :: { (r in lists) } { (r in s) } { (r.next in sNext) } (r in lists) && !((r in s)) ==> (r.next in sNext))
          if (*) {
            if (lists[r_32] && !s_1[r_32]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r.next (list.vpr@35.15--35.75) [201152]"}
        ...
        // -- Check definedness of (forall r1: Ref, r2: Ref :: { (r1 in lists), (r2 in lists) } { (r1 in lists), (r2 in s) } { (r1 in s), (r2 in lists) } { (r1 in s), (r2 in s) } (r1 in lists) && (!((r1 in s)) && ((r2 in lists) && (!((r2 in s)) && r1 != r2))) ==> r1.next != r2.next)
          if (*) {
            if (lists[r1_2] && (!s_1[r1_2] && (lists[r2_2] && (!s_1[r2_2] && r1_2 != r2_2)))) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r1.next (list.vpr@36.15--36.131) [201153]"}
                HasDirectPerm(Mask, r1_2, next);
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r2.next (list.vpr@36.15--36.131) [201154]"}
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  While statement might fail. Quantified resource list(r, length) might not be injective. (list.vpr@31.15--31.63) [201155]"}
        ...
        assume state(Heap, Mask);
        havoc QPMask;
        assert {:msg "  While statement might fail. Quantified resource r.next might not be injective. (list.vpr@32.15--32.71) [201156]"}
        ...
        // -- check if receiver acc(list(r, length - 1), write) is injective
          assert {:msg "  While statement might fail. Quantified resource list(r, length - 1) might not be injective. (list.vpr@33.15--33.69) [201157]"}
        ...
        assume state(Heap, Mask);
        havoc QPMask;
        assert {:msg "  While statement might fail. Quantified resource r.val might not be injective. (list.vpr@34.15--34.84) [201158]"}
  ...
  //     (r in lists) && !((r in s)) ==> r.next != l.next) -- list.vpr@41.16--41.77
            ...
            // -- Check definedness of (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.next != l.next)
              if (*) {
                if (lists[r_36] && !s_1[r_36]) {
                  assert {:msg "  Inhale might fail. There might be insufficient permission to access r.next (list.vpr@41.16--41.77) [201160]"}
                    HasDirectPerm(Mask, r_36, next);
                  assert {:msg "  Inhale might fail. There might be insufficient permission to access l.next (list.vpr@41.16--41.77) [201161]"}
          ...
          // -- Translating statement: sNext := (sNext union Set(l.next)) -- list.vpr@44.9--44.41
            ...
            // -- Check definedness of (sNext union Set(l.next))
              assert {:msg "  Assignment might fail. There might be insufficient permission to access l.next (list.vpr@44.9--44.41) [201162]"}
                HasDirectPerm(Mask, l_1, next);
            sNext := Set#Union(sNext, Set#Singleton(Heap[l_1, next]));
            assume state(Heap, Mask);
          
          // -- Translating statement: l.val := v -- list.vpr@45.9--45.19
            assert {:msg "  Assignment might fail. There might be insufficient permission to access l.val (list.vpr@45.9--45.19) [201163]"}
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r, length), write)) might not be preserved. Quantified resource list(r, length) might not be injective. (list.vpr@31.15--31.63) [201164]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r, length), write)) might not be preserved. There might be insufficient permission to access list(r, length) (list.vpr@31.15--31.63) [201165]"}
            (forall r_52_1: Ref ::
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.next, write)) might not be preserved. Quantified resource r.next might not be injective. (list.vpr@32.15--32.71) [201166]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.next, write)) might not be preserved. There might be insufficient permission to access r.next (list.vpr@32.15--32.71) [201167]"}
            (forall r_54_1: Ref ::
        ...
        // -- check if receiver acc(list(r, length - 1), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in sNext) } (r in sNext) ==> acc(list(r, length - 1), write)) might not be preserved. Quantified resource list(r, length - 1) might not be injective. (list.vpr@33.15--33.69) [201168]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in sNext) } (r in sNext) ==> acc(list(r, length - 1), write)) might not be preserved. There might be insufficient permission to access list(r, length - 1) (list.vpr@33.15--33.69) [201169]"}
            (forall r_55: Ref ::
            { sNext[r_55] }
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not be preserved. Quantified resource r.val might not be injective. (list.vpr@34.15--34.84) [201170]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not be preserved. There might be insufficient permission to access r.val (list.vpr@34.15--34.84) [201171]"}
            (forall r_57: Ref ::
        ...
        if (*) {
          if (lists[r_58] && !s_1[r_58]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(r.val, write)) && (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> r.val == v) might not be preserved. Assertion r.val == v might not hold. (list.vpr@34.15--34.84) [201172]"}
              Heap[r_58, val] == v_2;
          }
          assume false;
        }
        ...
        if (*) {
          if (lists[r_60] && !s_1[r_60]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } { (r.next in sNext) } (r in lists) && !((r in s)) ==> (r.next in sNext)) might not be preserved. Assertion (r.next in sNext) might not hold. (list.vpr@35.15--35.75) [201173]"}
        ...
        if (*) {
          if (lists[r1_5] && (!s_1[r1_5] && (lists[r2_5] && (!s_1[r2_5] && r1_5 != r2_5)))) {
            assert {:msg "  Loop invariant (forall r1: Ref, r2: Ref :: { (r1 in lists), (r2 in lists) } { (r1 in lists), (r2 in s) } { (r1 in s), (r2 in lists) } { (r1 in s), (r2 in s) } (r1 in lists) && (!((r1 in s)) && ((r2 in lists) && (!((r2 in s)) && r1 != r2))) ==> r1.next != r2.next) might not be preserved. Assertion r1.next != r2.next might not hold. (list.vpr@36.15--36.131) [201174]"}
    ...
    // -- Inhale loop invariant after loop, and assume guard
      ...
      // -- check if receiver acc(list(r, length), write) is injective
        assert {:msg "  While statement might fail. Quantified resource list(r, length) might not be injective. (list.vpr@31.15--31.63) [201175]"}
      ...
      assume state(Heap, Mask);
      havoc QPMask;
      assert {:msg "  While statement might fail. Quantified resource r.next might not be injective. (list.vpr@32.15--32.71) [201176]"}
      ...
      // -- check if receiver acc(list(r, length - 1), write) is injective
        assert {:msg "  While statement might fail. Quantified resource list(r, length - 1) might not be injective. (list.vpr@33.15--33.69) [201177]"}
      ...
      assume state(Heap, Mask);
      havoc QPMask;
      assert {:msg "  While statement might fail. Quantified resource r.val might not be injective. (list.vpr@34.15--34.84) [201178]"}
      ...
      // -- Translating statement: m1(sNext, length - 1, v) -- list.vpr@48.9--48.31
        ...
        // -- Exhaling precondition
          ...
          // -- check if receiver acc(list(r, arg_length), write) is injective
            assert {:msg "  The precondition of method m1 might not hold. Quantified resource list(r, length - 1) might not be injective. (list.vpr@48.9--48.31) [201180]"}
          ...
          // -- check if sufficient permission is held
            assert {:msg "  The precondition of method m1 might not hold. There might be insufficient permission to access list(r, length - 1) (list.vpr@48.9--48.31) [201181]"}
              (forall r_72: Ref ::
        ...
        // -- Inhaling postcondition
          ...
          // -- check if receiver acc(list(r, arg_length), write) is injective
            assert {:msg "  Method call might fail. Quantified resource list(r, length - 1) might not be injective. (list.vpr@48.9--48.31) [201182]"}
  ...
  // -- Translating statement: while (|s| > 0) -- list.vpr@51.5--63.10
    ...
    // -- Before loop head
      ...
      // -- Exhale loop invariant before loop
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(list(r, length), write)) might not hold on entry. Quantified resource list(r, length) might not be injective. (list.vpr@52.19--52.84) [201183]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(list(r, length), write)) might not hold on entry. There might be insufficient permission to access list(r, length) (list.vpr@52.19--52.84) [201184]"}
            (forall r_78: Ref ::
        ...
        if (*) {
          if (lists[r_80] && !s_1[r_80]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } { allSet(r, length, v) } (r in lists) && !((r in s)) ==> allSet(r, length, v)) might not hold on entry. Assertion allSet(r, length, v) might not hold. (list.vpr@53.19--53.85) [201185]"}
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not hold on entry. Quantified resource r.val might not be injective. (list.vpr@54.19--54.86) [201186]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not hold on entry. There might be insufficient permission to access r.val (list.vpr@54.19--54.86) [201187]"}
            (forall r_82: Ref ::
        ...
        if (*) {
          if (s_1[r_83]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not hold on entry. Assertion r.val == v might not hold. (list.vpr@54.19--54.86) [201188]"}
              Heap[r_83, val] == v_2;
          }
          assume false;
        }
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not hold on entry. Quantified resource r.next might not be injective. (list.vpr@54.19--54.86) [201189]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not hold on entry. There might be insufficient permission to access r.next (list.vpr@54.19--54.86) [201190]"}
            (forall r_85: Ref ::
        ...
        if (*) {
          if (s_1[r1_8] && (s_1[r2_8] && r1_8 != r2_8)) {
            assert {:msg "  Loop invariant (forall r1: Ref, r2: Ref :: { (r1 in s), (r2 in s) } (r1 in s) && ((r2 in s) && r1 != r2) ==> r1.next != r2.next) might not hold on entry. Assertion r1.next != r2.next might not hold. (list.vpr@55.19--55.99) [201191]"}
        ...
        // -- check if receiver acc(list(r.next, length - 1), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r.next, length - 1), write)) might not hold on entry. Quantified resource list(r.next, length - 1) might not be injective. (list.vpr@56.19--56.75) [201192]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r.next, length - 1), write)) might not hold on entry. There might be insufficient permission to access list(r.next, length - 1) (list.vpr@56.19--56.75) [201193]"}
            (forall r_86: Ref ::
            { s_1[r_86] }
        ...
        if (*) {
          if (s_1[r_88]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> allSet(r.next, length - 1, v)) might not hold on entry. Assertion allSet(r.next, length - 1, v) might not hold. (list.vpr@57.19--57.75) [201194]"}
    ...
    // -- Check definedness of invariant
      if (*) {
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length) might not be injective. (list.vpr@52.19--52.84) [201195]"}
        ...
        havoc QPMask;
        assert {:msg "  Contract might not be well-formed. Quantified resource r.val might not be injective. (list.vpr@54.19--54.86) [201197]"}
        ...
        // -- Check definedness of (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v)
          if (*) {
            if (s_1[r_44]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r.val (list.vpr@54.19--54.86) [201198]"}
        ...
        havoc QPMask;
        assert {:msg "  Contract might not be well-formed. Quantified resource r.next might not be injective. (list.vpr@54.19--54.86) [201199]"}
        ...
        // -- Check definedness of (forall r1: Ref, r2: Ref :: { (r1 in s), (r2 in s) } (r1 in s) && ((r2 in s) && r1 != r2) ==> r1.next != r2.next)
          if (*) {
            if (s_1[r1_6] && (s_1[r2_6] && r1_6 != r2_6)) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r1.next (list.vpr@55.19--55.99) [201200]"}
                HasDirectPerm(Mask, r1_6, next);
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r2.next (list.vpr@55.19--55.99) [201201]"}
        ...
        // -- Check definedness of (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r.next, length - 1), write))
          if (*) {
            if (s_1[r_45]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r.next (list.vpr@56.19--56.75) [201202]"}
        ...
        // -- check if receiver acc(list(r.next, length - 1), write) is injective
          assert {:msg "  Contract might not be well-formed. Quantified resource list(r.next, length - 1) might not be injective. (list.vpr@56.19--56.75) [201203]"}
        ...
        // -- Check definedness of (forall r: Ref :: { (r in s) } (r in s) ==> allSet(r.next, length - 1, v))
          if (*) {
            if (s_1[r_46]) {
              assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access r.next (list.vpr@57.19--57.75) [201204]"}
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  While statement might fail. Quantified resource list(r, length) might not be injective. (list.vpr@52.19--52.84) [201206]"}
        ...
        havoc QPMask;
        assert {:msg "  While statement might fail. Quantified resource r.val might not be injective. (list.vpr@54.19--54.86) [201207]"}
        ...
        havoc QPMask;
        assert {:msg "  While statement might fail. Quantified resource r.next might not be injective. (list.vpr@54.19--54.86) [201208]"}
        ...
        // -- check if receiver acc(list(r.next, length - 1), write) is injective
          assert {:msg "  While statement might fail. Quantified resource list(r.next, length - 1) might not be injective. (list.vpr@56.19--56.75) [201209]"}
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: fold acc(list(l2, length), write) -- list.vpr@61.13--61.34
            ...
            if (length_3 > 0) {
              perm := FullPerm;
              if (perm != NoPerm) {
                assert {:msg "  Folding list(l2, length) might fail. There might be insufficient permission to access l2.val (list.vpr@61.13--61.34) [201210]"}
                  perm <= Mask[l2, val];
              }
              Mask := Mask[l2, val:=Mask[l2, val] - perm];
              perm := FullPerm;
              if (perm != NoPerm) {
                assert {:msg "  Folding list(l2, length) might fail. There might be insufficient permission to access l2.next (list.vpr@61.13--61.34) [201211]"}
                  perm <= Mask[l2, next];
              }
              Mask := Mask[l2, next:=Mask[l2, next] - perm];
              perm := FullPerm;
              if (perm != NoPerm) {
                assert {:msg "  Folding list(l2, length) might fail. There might be insufficient permission to access list(l2.next, length - 1) (list.vpr@61.13--61.34) [201212]"}
        ...
        // -- check if receiver acc(list(r, length), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(list(r, length), write)) might not be preserved. Quantified resource list(r, length) might not be injective. (list.vpr@52.19--52.84) [201213]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } (r in lists) && !((r in s)) ==> acc(list(r, length), write)) might not be preserved. There might be insufficient permission to access list(r, length) (list.vpr@52.19--52.84) [201214]"}
            (forall r_119: Ref ::
        ...
        if (*) {
          if (lists[r_121] && !s_1[r_121]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in lists) } { (r in s) } { allSet(r, length, v) } (r in lists) && !((r in s)) ==> allSet(r, length, v)) might not be preserved. Assertion allSet(r, length, v) might not hold. (list.vpr@53.19--53.85) [201215]"}
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not be preserved. Quantified resource r.val might not be injective. (list.vpr@54.19--54.86) [201216]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not be preserved. There might be insufficient permission to access r.val (list.vpr@54.19--54.86) [201217]"}
            (forall r_123: Ref ::
        ...
        if (*) {
          if (s_1[r_124]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not be preserved. Assertion r.val == v might not hold. (list.vpr@54.19--54.86) [201218]"}
              Heap[r_124, val] == v_2;
          }
          assume false;
        }
        ...
        // -- check if receiver r is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not be preserved. Quantified resource r.next might not be injective. (list.vpr@54.19--54.86) [201219]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.val, write)) && (forall r: Ref :: { (r in s) } (r in s) ==> r.val == v) && (forall r: Ref :: { (r in s) } (r in s) ==> acc(r.next, write)) might not be preserved. There might be insufficient permission to access r.next (list.vpr@54.19--54.86) [201220]"}
            (forall r_126: Ref ::
        ...
        if (*) {
          if (s_1[r1_13] && (s_1[r2_13] && r1_13 != r2_13)) {
            assert {:msg "  Loop invariant (forall r1: Ref, r2: Ref :: { (r1 in s), (r2 in s) } (r1 in s) && ((r2 in s) && r1 != r2) ==> r1.next != r2.next) might not be preserved. Assertion r1.next != r2.next might not hold. (list.vpr@55.19--55.99) [201221]"}
        ...
        // -- check if receiver acc(list(r.next, length - 1), write) is injective
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r.next, length - 1), write)) might not be preserved. Quantified resource list(r.next, length - 1) might not be injective. (list.vpr@56.19--56.75) [201222]"}
        ...
        // -- check if sufficient permission is held
          assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> acc(list(r.next, length - 1), write)) might not be preserved. There might be insufficient permission to access list(r.next, length - 1) (list.vpr@56.19--56.75) [201223]"}
            (forall r_127: Ref ::
            { s_1[r_127] }
        ...
        if (*) {
          if (s_1[r_129]) {
            assert {:msg "  Loop invariant (forall r: Ref :: { (r in s) } (r in s) ==> allSet(r.next, length - 1, v)) might not be preserved. Assertion allSet(r.next, length - 1, v) might not hold. (list.vpr@57.19--57.75) [201224]"}
    ...
    // -- Inhale loop invariant after loop, and assume guard
      ...
      // -- check if receiver acc(list(r, length), write) is injective
        assert {:msg "  While statement might fail. Quantified resource list(r, length) might not be injective. (list.vpr@52.19--52.84) [201225]"}
      ...
      havoc QPMask;
      assert {:msg "  While statement might fail. Quantified resource r.val might not be injective. (list.vpr@54.19--54.86) [201226]"}
      ...
      havoc QPMask;
      assert {:msg "  While statement might fail. Quantified resource r.next might not be injective. (list.vpr@54.19--54.86) [201227]"}
      ...
      // -- check if receiver acc(list(r.next, length - 1), write) is injective
        assert {:msg "  While statement might fail. Quantified resource list(r.next, length - 1) might not be injective. (list.vpr@56.19--56.75) [201228]"}
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver acc(list(r, length), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource list(r, length) might not be injective. (list.vpr@26.9--26.85) [201229]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m1 might not hold. There might be insufficient permission to access list(r, length) (list.vpr@26.9--26.85) [201230]"}
        (forall r_10_1: Ref ::
    ...
    if (*) {
      if (lists[r_12_1]) {
        assert {:msg "  Postcondition of m1 might not hold. Assertion allSet(r, length, v) might not hold. (list.vpr@26.9--26.85) [201231]"}
