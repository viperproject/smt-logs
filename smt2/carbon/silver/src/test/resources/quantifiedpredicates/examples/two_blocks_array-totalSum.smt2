...
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((j_6_2@@1 Int) ) (!  (=> (and (>= j_6_2@@1 0) (and (< j_6_2@@1 (len a_2@@7)) (= (mod j_6_2@@1 2) 0))) (>= (select (|PolymorphicMapType_19203_12611_12612#PolymorphicMapType_19203| Mask@16) null (access a_2@@7 j_6_2@@1)) FullPerm))
 :qid |stdinbpl.825:17|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_19182_12611_12612#PolymorphicMapType_19182| Heap@16) null (access a_2@@7 j_6_2@@1)))
 :pattern ( (select (|PolymorphicMapType_19203_12611_12612#PolymorphicMapType_19203| Mask@16) null (access a_2@@7 j_6_2@@1)))
))))))))))))
...
)) (and (=> (= (ControlFlow 0 62) (- 0 64)) (forall ((j_7_1@@1 Int) ) (!  (=> (and (>= j_7_1@@1 0) (and (< j_7_1@@1 (len a_2@@7)) (= (mod j_7_1@@1 2) 0))) (>= (select (|PolymorphicMapType_19203_12611_12612#PolymorphicMapType_19203| QPMask@0) null (access a_2@@7 j_7_1@@1)) FullPerm))
 :qid |stdinbpl.570:23|
 :skolemid |43|
...
))) (=> (forall ((j_7_1@@2 Int) ) (!  (=> (and (>= j_7_1@@2 0) (and (< j_7_1@@2 (len a_2@@7)) (= (mod j_7_1@@2 2) 0))) (>= (select (|PolymorphicMapType_19203_12611_12612#PolymorphicMapType_19203| QPMask@0) null (access a_2@@7 j_7_1@@2)) FullPerm))
 :qid |stdinbpl.570:23|
 :skolemid |43|
...
(let ((anon30_correct  (=> (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)) (and (=> (= (ControlFlow 0 23) (- 0 25)) (HasDirectPerm_12608_1721 Mask@3 (loc a_2@@7 i@@6) val)) (=> (HasDirectPerm_12608_1721 Mask@3 (loc a_2@@7 i@@6) val) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_12608_1721 Mask@3 (loc a_2@@7 (+ i@@6 1)) val)) (=> (HasDirectPerm_12608_1721 Mask@3 (loc a_2@@7 (+ i@@6 1)) val) (=> (and (= sum_3@1 (+ (select (|PolymorphicMapType_19182_12608_1721#PolymorphicMapType_19182| Heap@1) (loc a_2@@7 i@@6) val) (select (|PolymorphicMapType_19182_12608_1721#PolymorphicMapType_19182| Heap@1) (loc a_2@@7 (+ i@@6 1)) val))) (state Heap@1 Mask@3)) (and (=> (= (ControlFlow 0 23) 22) anon57_Then_correct) (=> (= (ControlFlow 0 23) 13) anon57_Else_correct))))))))))
