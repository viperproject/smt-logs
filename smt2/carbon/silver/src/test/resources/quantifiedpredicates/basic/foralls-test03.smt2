...
(declare-fun ix_27 () Int)
(declare-fun jx_27 () Int)
...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 (|Seq#Length_9242| xs)))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_7) (< i_7 (|Seq#Length_9242| xs))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_7 (|Seq#Length_9242| xs))) (=> (< i_7 (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length_9242| xs)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length_9242| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9242| xs i_1) (|Seq#Index_9242| xs i_1_1))))
...
(let ((anon10_Else_correct  (=> (and (not (and (>= ix_27 0) (and (< ix_27 (|Seq#Length_9242| xs)) (and (>= jx_27 0) (and (< jx_27 (|Seq#Length_9242| xs)) (not (= ix_27 jx_27))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= ix_27 0) (and (< ix_27 (|Seq#Length_9242| xs)) (and (>= jx_27 0) (and (< jx_27 (|Seq#Length_9242| xs)) (not (= ix_27 jx_27)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_27 0)) (=> (>= ix_27 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_27 (|Seq#Length_9242| xs))) (=> (< ix_27 (|Seq#Length_9242| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_27 0)) (=> (>= jx_27 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_27 (|Seq#Length_9242| xs))) (=> (< jx_27 (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
