...
(set-info :boogie-vc-id test04_qp)
...
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_12233| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv9 x_1@@1) x_1@@1) (qpRange9 x_1@@1)))
...
)) (=> (and (forall ((a_2@@11 T@Ref) ) (!  (=> (and (and (|Seq#Contains_12233| xs (invRecv9 a_2@@11)) (< NoPerm FullPerm)) (qpRange9 a_2@@11)) (= (invRecv9 a_2@@11) a_2@@11))
 :qid |stdinbpl.1567:22|
 :skolemid |123|
 :pattern ( (invRecv9 a_2@@11))
)) (forall ((a_2@@12 T@Ref) ) (!  (=> (and (and (|Seq#Contains_12233| xs (invRecv9 a_2@@12)) (< NoPerm FullPerm)) (qpRange9 a_2@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv9 a_2@@12) a_2@@12)) (= (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| QPMask@0) null (pred1 a_2@@12)) (+ (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| ZeroMask) null (pred1 a_2@@12)) FullPerm))))
 :qid |stdinbpl.1573:22|
 :skolemid |124|
...
))) (forall ((a_2@@13 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_12233| xs (invRecv9 a_2@@13)) (< NoPerm FullPerm)) (qpRange9 a_2@@13))) (= (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| QPMask@0) null (pred1 a_2@@13)) (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| ZeroMask) null (pred1 a_2@@13))))
 :qid |stdinbpl.1583:22|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| QPMask@0) null (pred1 a_2@@13)))
))) (and (and (state Heap@@47 QPMask@0) (state Heap@@47 QPMask@0)) (and (|pred1#trigger_12157| Heap@@47 (pred1 y@@1)) (= (select (|PolymorphicMapType_21038_12157_12158#PolymorphicMapType_21038| Heap@@47) null (pred1 y@@1)) (FrameFragment_3274 (select (|PolymorphicMapType_21038_12154_3274#PolymorphicMapType_21038| Heap@@47) y@@1 f_7)))))) (and (=> (= (ControlFlow 0 28) 25) anon18_Then_correct) (=> (= (ControlFlow 0 28) 27) anon18_Else_correct)))))))))
