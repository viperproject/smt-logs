...
(let ((anon6_Then_correct  (=> (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_12) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= (+ (* a_2@@5 i_12) b_24) 0)) (=> (>= (+ (* a_2@@5 i_12) b_24) 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (+ (* a_2@@5 i_12) b_24) (|Seq#Length_9242| xs))) (=> (< (+ (* a_2@@5 i_12) b_24) (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_1)) (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9242| xs (+ (* a_2@@5 i_1) b_24)) (|Seq#Index_9242| xs (+ (* a_2@@5 i_1_1) b_24)))))
 :qid |stdinbpl.1292:17|
 :skolemid |158|
 :pattern ( (neverTriggered6 i_1) (neverTriggered6 i_1_1))
)))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (and (<= 0 a_2@@5) (<= 0 b_24))) (and (and (<= 0 n@@27) (state Heap@@32 ZeroMask)) (and (<= (+ (* a_2@@5 (- n@@27 1)) b_24) (|Seq#Length_9242| xs)) (state Heap@@32 ZeroMask)))) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
