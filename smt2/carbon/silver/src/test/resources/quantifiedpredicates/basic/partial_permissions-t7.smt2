...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_1 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_1) (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_1 x_1)) NoPerm))
 :qid |stdinbpl.2316:15|
 :skolemid |247|
))) (=> (forall ((x_1@@0 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_1@@0) (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_1 x_1@@0)) NoPerm))
 :qid |stdinbpl.2316:15|
 :skolemid |247|
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_1@@1) (< wildcard@0 (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_1 x_1@@1))))
 :qid |stdinbpl.2320:20|
 :skolemid |248|
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((r_1_1_1 T@Ref) ) (!  (=> (and (|Seq#Contains_11977| xs (invRecv24 r_1_1_1)) (qpRange24 r_1_1_1)) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2327:17|
 :skolemid |249|
 :pattern ( (invRecv24 r_1_1_1))
))) (=> (forall ((r_1_1_1@@0 T@Ref) ) (!  (=> (and (|Seq#Contains_11977| xs (invRecv24 r_1_1_1@@0)) (qpRange24 r_1_1_1@@0)) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2327:17|
 :skolemid |249|
 :pattern ( (invRecv24 r_1_1_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_1@@2 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@2 x_1_1)) (|Seq#Contains_11977| xs x_1@@2)) (|Seq#Contains_11977| xs x_1_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_1@@2 x_1_1)))
 :qid |stdinbpl.2334:17|
 :skolemid |250|
 :pattern ( (neverTriggered24 x_1@@2) (neverTriggered24 x_1_1))
))) (=> (forall ((x_1@@3 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@3 x_1_1@@0)) (|Seq#Contains_11977| xs x_1@@3)) (|Seq#Contains_11977| xs x_1_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_1@@3 x_1_1@@0)))
 :qid |stdinbpl.2334:17|
 :skolemid |250|
 :pattern ( (neverTriggered24 x_1@@3) (neverTriggered24 x_1_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_1@@4 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_1@@4) (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_1 x_1@@4)) NoPerm))
 :qid |stdinbpl.2341:17|
 :skolemid |251|
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_1 x_1@@4)))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_1 x_1@@4)))
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_1 x_1@@4)))
)))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_18248_11466_53#PolymorphicMapType_18248| Heap@@32) r_1@@5 $allocated)) (and (|Seq#Contains_11977| xs r_1@@5) (state Heap@@32 ZeroMask))) (and (=> (= (ControlFlow 0 7) 1) anon3_Then_correct) (=> (= (ControlFlow 0 7) 3) anon3_Else_correct))))))
