...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_1 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_1) (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 x_1)) NoPerm))
 :qid |stdinbpl.2316:15|
 :skolemid |247|
))) (=> (forall ((x_1@@0 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_1@@0) (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 x_1@@0)) NoPerm))
 :qid |stdinbpl.2316:15|
 :skolemid |247|
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_1@@1) (< wildcard@0 (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 x_1@@1))))
...
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_1@@4 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_1@@4) (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 x_1@@4)) NoPerm))
 :qid |stdinbpl.2341:17|
 :skolemid |251|
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_1@@4)))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 x_1@@4)))
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_1@@4)))
)))))))))))))
