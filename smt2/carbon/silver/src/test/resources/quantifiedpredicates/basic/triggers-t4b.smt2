...
(let ((anon18_Then_correct  (=> (|Seq#Contains_8450| xs y_12) (and (=> (= (ControlFlow 0 13) 12) anon19_Then_correct) (=> (= (ControlFlow 0 13) 10) anon10_correct)))))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains_8450| xs y_12)) (= (ControlFlow 0 11) 10)) anon10_correct)))
...
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_3_2@@1 T@Ref) ) (!  (=> (|Seq#Contains_8450| xs y_3_2@@1) (>= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_3 (fun2 Heap@@40 y_3_2@@1))) FullPerm))
 :qid |stdinbpl.1291:17|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_12901_8423_8424#PolymorphicMapType_12901| Heap@@40) null (pred_3 (|fun2#frame| EmptyFrame y_3_2@@1))))
 :pattern ( (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_3 (|fun2#frame| EmptyFrame y_3_2@@1))))
...
))) (forall ((r_1_1_1@@1 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_8450| xs (invRecv6 r_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange6 r_1_1_1@@1))) (= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_3 r_1_1_1@@1)) (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| ZeroMask) null (pred_3 r_1_1_1@@1))))
...
(let ((anon14_Then_correct  (=> (|Seq#Contains_8450| xs x_32) (and (=> (= (ControlFlow 0 4) 3) anon15_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains_8450| xs x_32)) (= (ControlFlow 0 2) 1)) anon4_correct)))
