...
(let ((anon26_Then_correct  (=> (|Seq#Contains_8450| xs x_2) (and (=> (= (ControlFlow 0 18) 17) anon27_Then_correct) (=> (= (ControlFlow 0 18) 15) anon10_correct)))))
(let ((anon26_Else_correct  (=> (and (not (|Seq#Contains_8450| xs x_2)) (= (ControlFlow 0 16) 15)) anon10_correct)))
(let ((anon25_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((x_4_2 T@Ref) (x_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (|Seq#Contains_8450| xs x_4_2)) (|Seq#Contains_8450| xs x_4_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 PostHeap@0 x_4_2) (fun2 PostHeap@0 x_4_3))))
 :qid |stdinbpl.862:17|
 :skolemid |78|
...
(let ((anon31_Else_correct  (=> (and (forall ((x_9_1_1 T@Ref) ) (! (= (fun Heap@@40 x_9_1_1 i@@15) (fun2 Heap@@40 x_9_1_1))
 :qid |stdinbpl.920:20|
 :skolemid |84|
 :pattern ( (|fun#frame| EmptyFrame x_9_1_1 i@@15))
 :pattern ( (|fun2#frame| EmptyFrame x_9_1_1))
...
)) (=> (= (ControlFlow 0 8) (- 0 7)) (forall ((x_6@@1 T@Ref) ) (!  (=> (|Seq#Contains_8450| xs x_6@@1) (>= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_1 (fun2 Heap@@40 x_6@@1))) FullPerm))
 :qid |stdinbpl.943:17|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_12901_8423_8424#PolymorphicMapType_12901| Heap@@40) null (pred_1 (|fun2#frame| EmptyFrame x_6@@1))))
 :pattern ( (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_1 (|fun2#frame| EmptyFrame x_6@@1))))
 :pattern ( (|Seq#ContainsTrigger_8450| xs x_6@@1))
 :pattern ( (|Seq#Contains_8450| xs x_6@@1))
 :pattern ( (|fun2#frame| EmptyFrame x_6@@1))
))))))))
(let ((anon31_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (fun Heap@@40 x_8 i@@15) (fun2 Heap@@40 x_8)))))
...
))) (forall ((r_1_1_1@@1 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_8450| xs (invRecv1 r_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange1 r_1_1_1@@1))) (= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_1 r_1_1_1@@1)) (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| ZeroMask) null (pred_1 r_1_1_1@@1))))
 :qid |stdinbpl.828:22|
 :skolemid |77|
...
(let ((anon22_Then_correct  (=> (|Seq#Contains_8450| xs x_40) (and (=> (= (ControlFlow 0 4) 3) anon23_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon22_Else_correct  (=> (and (not (|Seq#Contains_8450| xs x_40)) (= (ControlFlow 0 2) 1)) anon4_correct)))
