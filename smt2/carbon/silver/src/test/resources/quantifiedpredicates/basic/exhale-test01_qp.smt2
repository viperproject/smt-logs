...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon17_Else_correct  (=> (= (ControlFlow 0 22) (- 0 21)) (forall ((x_4_2 T@Ref) (x_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (|Seq#Contains_12233| xs x_4_2)) (|Seq#Contains_12233| xs x_4_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4_2 x_4_3)))
 :qid |stdinbpl.919:17|
 :skolemid |76|
