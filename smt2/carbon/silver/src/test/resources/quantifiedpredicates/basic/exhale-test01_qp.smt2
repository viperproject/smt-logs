...
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_12233| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv1 x_1@@1) x_1@@1) (qpRange1 x_1@@1)))
 :qid |stdinbpl.872:22|
 :skolemid |71|
...
)) (=> (and (forall ((a_2@@11 T@Ref) ) (!  (=> (and (and (|Seq#Contains_12233| xs (invRecv1 a_2@@11)) (< NoPerm FullPerm)) (qpRange1 a_2@@11)) (= (invRecv1 a_2@@11) a_2@@11))
 :qid |stdinbpl.876:22|
 :skolemid |72|
 :pattern ( (invRecv1 a_2@@11))
)) (forall ((a_2@@12 T@Ref) ) (!  (=> (and (and (|Seq#Contains_12233| xs (invRecv1 a_2@@12)) (< NoPerm FullPerm)) (qpRange1 a_2@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv1 a_2@@12) a_2@@12)) (= (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| QPMask@0) null (pred1 a_2@@12)) (+ (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| ZeroMask) null (pred1 a_2@@12)) FullPerm))))
 :qid |stdinbpl.882:22|
 :skolemid |73|
...
))) (forall ((a_2@@13 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_12233| xs (invRecv1 a_2@@13)) (< NoPerm FullPerm)) (qpRange1 a_2@@13))) (= (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| QPMask@0) null (pred1 a_2@@13)) (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| ZeroMask) null (pred1 a_2@@13))))
 :qid |stdinbpl.892:22|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| QPMask@0) null (pred1 a_2@@13)))
))) (and (state Heap@@47 QPMask@0) (state Heap@@47 QPMask@0))) (and (=> (= (ControlFlow 0 24) 23) anon16_Then_correct) (=> (= (ControlFlow 0 24) 19) anon16_Else_correct)))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_21038_11918_53#PolymorphicMapType_21038| Heap@@47) y@@1 $allocated)) (and (|Seq#Contains_12233| xs y@@1) (state Heap@@47 ZeroMask))) (and (=> (= (ControlFlow 0 26) 1) anon15_Then_correct) (=> (= (ControlFlow 0 26) 24) anon15_Else_correct))))))
