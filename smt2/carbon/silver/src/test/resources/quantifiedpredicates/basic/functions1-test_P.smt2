...
)) (and (=> (= (ControlFlow 0 14) (- 0 17)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length_8337| ys)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length_8337| ys)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8337| ys i_3) (|Seq#Index_8337| ys i_3_1))))
 :qid |stdinbpl.1199:21|
 :skolemid |104|
 :pattern ( (neverTriggered4 i_3) (neverTriggered4 i_3_1))
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length_8337| ys)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length_8337| ys)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8337| ys i_3@@0) (|Seq#Index_8337| ys i_3_1@@0))))
 :qid |stdinbpl.1199:21|
 :skolemid |104|
 :pattern ( (neverTriggered4 i_3@@0) (neverTriggered4 i_3_1@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((i_3@@1 Int) ) (!  (=> (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length_8337| ys))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_12682_8459_8460#PolymorphicMapType_12682| QPMask@0) null (P (|Seq#Index_8337| ys i_3@@1))) NoPerm)))
 :qid |stdinbpl.1206:21|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_12661_8459_8460#PolymorphicMapType_12661| Heap@@46) null (P (|Seq#Index_8337| ys i_3@@1))))
 :pattern ( (select (|PolymorphicMapType_12682_8459_8460#PolymorphicMapType_12682| QPMask@0) null (P (|Seq#Index_8337| ys i_3@@1))))
 :pattern ( (|Seq#Index_8337| ys i_3@@1))
))) (=> (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length_8337| ys))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_12682_8459_8460#PolymorphicMapType_12682| QPMask@0) null (P (|Seq#Index_8337| ys i_3@@2))) NoPerm)))
 :qid |stdinbpl.1206:21|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_12661_8459_8460#PolymorphicMapType_12661| Heap@@46) null (P (|Seq#Index_8337| ys i_3@@2))))
 :pattern ( (select (|PolymorphicMapType_12682_8459_8460#PolymorphicMapType_12682| QPMask@0) null (P (|Seq#Index_8337| ys i_3@@2))))
 :pattern ( (|Seq#Index_8337| ys i_3@@2))
)) (=> (and (forall ((i_3@@3 Int) ) (!  (=> (and (and (<= 0 i_3@@3) (< i_3@@3 (|Seq#Length_8337| ys))) (< NoPerm FullPerm)) (and (= (invRecv4 (|Seq#Index_8337| ys i_3@@3)) i_3@@3) (qpRange4 (|Seq#Index_8337| ys i_3@@3))))
 :qid |stdinbpl.1212:26|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_12661_8459_8460#PolymorphicMapType_12661| Heap@@46) null (P (|Seq#Index_8337| ys i_3@@3))))
 :pattern ( (select (|PolymorphicMapType_12682_8459_8460#PolymorphicMapType_12682| QPMask@0) null (P (|Seq#Index_8337| ys i_3@@3))))
 :pattern ( (|Seq#Index_8337| ys i_3@@3))
...
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 (|Seq#Length_8337| ys)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 i_8) (< i_8 (|Seq#Length_8337| ys))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_8 (|Seq#Length_8337| ys))) (=> (< i_8 (|Seq#Length_8337| ys)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon18_Else_correct  (=> (and (not (and (>= ix_21 0) (and (< ix_21 (|Seq#Length_8337| ys)) (and (>= jx_21 0) (and (< jx_21 (|Seq#Length_8337| ys)) (not (= ix_21 jx_21))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (>= ix_21 0) (and (< ix_21 (|Seq#Length_8337| ys)) (and (>= jx_21 0) (and (< jx_21 (|Seq#Length_8337| ys)) (not (= ix_21 jx_21)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_21 0)) (=> (>= ix_21 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_21 (|Seq#Length_8337| ys))) (=> (< ix_21 (|Seq#Length_8337| ys)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_21 0)) (=> (>= jx_21 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_21 (|Seq#Length_8337| ys))) (=> (< jx_21 (|Seq#Length_8337| ys)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
