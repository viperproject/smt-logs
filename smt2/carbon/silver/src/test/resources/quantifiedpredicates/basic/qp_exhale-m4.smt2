...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((r_4_1 T@Ref) (r_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4_1 r_4_2)) (select (|Set#UnionOne_9565| (|Set#UnionOne_9565| (|Set#Singleton_9565| z) y@@3) x@@5) r_4_1)) (select (|Set#UnionOne_9565| (|Set#UnionOne_9565| (|Set#Singleton_9565| z) y@@3) x@@5) r_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4_1 r_4_2)))
 :qid |stdinbpl.1253:17|
 :skolemid |152|
 :pattern ( (neverTriggered8 r_4_1) (neverTriggered8 r_4_2))
))) (=> (forall ((r_4_1@@0 T@Ref) (r_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4_1@@0 r_4_2@@0)) (select (|Set#UnionOne_9565| (|Set#UnionOne_9565| (|Set#Singleton_9565| z) y@@3) x@@5) r_4_1@@0)) (select (|Set#UnionOne_9565| (|Set#UnionOne_9565| (|Set#Singleton_9565| z) y@@3) x@@5) r_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4_1@@0 r_4_2@@0)))
 :qid |stdinbpl.1253:17|
 :skolemid |152|
 :pattern ( (neverTriggered8 r_4_1@@0) (neverTriggered8 r_4_2@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_4_1@@1 T@Ref) ) (!  (=> (select (|Set#UnionOne_9565| (|Set#UnionOne_9565| (|Set#Singleton_9565| z) y@@3) x@@5) r_4_1@@1) (>= (select (|PolymorphicMapType_15660_9461_9462#PolymorphicMapType_15660| Mask@1) null (p2 r_4_1@@1)) FullPerm))
 :qid |stdinbpl.1260:17|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_15639_9461_9462#PolymorphicMapType_15639| Heap@@92) null (p2 r_4_1@@1)))
 :pattern ( (select (|PolymorphicMapType_15660_9461_9462#PolymorphicMapType_15660| Mask@1) null (p2 r_4_1@@1)))
 :pattern ( (select (|Set#UnionOne_9565| (|Set#UnionOne_9565| (|Set#Singleton_9565| z) y@@3) x@@5) r_4_1@@1))
)))))))
