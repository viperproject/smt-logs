...
function  invRecv3(a_2: Ref, i: int): Ref;
function  invRecv4(a_1_1: Ref, i_1: int): Ref;
function  invRecv5(a_2: Ref, i: int): Ref;
// ==================================================
...
function  qpRange3(a_2: Ref, i: int): bool;
function  qpRange4(a_1_1: Ref, i_1: int): bool;
function  qpRange5(a_2: Ref, i: int): bool;
...
procedure test01(xs: (Seq Ref), y: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  ...
  if (*) {
    ...
    // -- Define Inverse Function
      assume (forall x_1: Ref ::
        ...
        Seq#Contains(xs, x_1) && NoPerm < FullPerm ==> invRecv1(y) == x_1 && qpRange1(y)
      );
      assume (forall a_2: Ref ::
        { invRecv1(a_2) }
        (Seq#Contains(xs, invRecv1(a_2)) && NoPerm < FullPerm) && qpRange1(a_2) ==> y == a_2
      );
    
    // -- Define updated permissions
      assume (forall a_2: Ref ::
        { QPMask[null, pred1(a_2)] }
        (Seq#Contains(xs, invRecv1(a_2)) && NoPerm < FullPerm) && qpRange1(a_2) ==> (NoPerm < FullPerm ==> y == a_2) && QPMask[null, pred1(a_2)] == PostMask[null, pred1(a_2)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall a_2: Ref ::
        { QPMask[null, pred1(a_2)] }
        !((Seq#Contains(xs, invRecv1(a_2)) && NoPerm < FullPerm) && qpRange1(a_2)) ==> QPMask[null, pred1(a_2)] == PostMask[null, pred1(a_2)]
      );
    PostMask := QPMask;
    assume state(PostHeap, PostMask);
    assume state(PostHeap, PostMask);
  ...
  // -- Exhaling postcondition
    ...
    // -- assumptions for inverse of receiver acc(pred1(y), write)
      ...
      assume (forall a_1_1: Ref ::
        { invRecv2(a_1_1) }
        (Seq#Contains(xs, invRecv2(a_1_1)) && NoPerm < FullPerm) && qpRange2(a_1_1) ==> y == a_1_1
      );
    
    // -- assume permission updates
      assume (forall a_1_1: Ref ::
        { QPMask[null, pred1(a_1_1)] }
        (Seq#Contains(xs, invRecv2(a_1_1)) && NoPerm < FullPerm) && qpRange2(a_1_1) ==> y == a_1_1 && QPMask[null, pred1(a_1_1)] == Mask[null, pred1(a_1_1)] - FullPerm
      );
      assume (forall a_1_1: Ref ::
        { QPMask[null, pred1(a_1_1)] }
        !((Seq#Contains(xs, invRecv2(a_1_1)) && NoPerm < FullPerm) && qpRange2(a_1_1)) ==> QPMask[null, pred1(a_1_1)] == Mask[null, pred1(a_1_1)]
      );
  ...
  modifies Heap, Mask;
{
  ...
  if (*) {
    ...
    // -- Define Inverse Function
      assume (forall x_1: Ref ::
        { Seq#ContainsTrigger(xs, x_1) } { Seq#Contains(xs, x_1) }
        Seq#Contains(xs, x_1) && NoPerm < FullPerm ==> invRecv3(y, 1) == x_1 && qpRange3(y, 1)
      );
      assume (forall a_2: Ref, i: int ::
        { invRecv3(a_2, i) }
        (Seq#Contains(xs, invRecv3(a_2, i)) && NoPerm < FullPerm) && qpRange3(a_2, i) ==> y == a_2 && 1 == i
      );
    
    // -- Define updated permissions
      assume (forall a_2: Ref, i: int ::
        { QPMask[null, pred2(a_2, i)] }
        (Seq#Contains(xs, invRecv3(a_2, i)) && NoPerm < FullPerm) && qpRange3(a_2, i) ==> (NoPerm < FullPerm ==> y == a_2 && 1 == i) && QPMask[null, pred2(a_2, i)] == PostMask[null, pred2(a_2, i)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall a_2: Ref, i: int ::
        { QPMask[null, pred2(a_2, i)] }
        !((Seq#Contains(xs, invRecv3(a_2, i)) && NoPerm < FullPerm) && qpRange3(a_2, i)) ==> QPMask[null, pred2(a_2, i)] == PostMask[null, pred2(a_2, i)]
      );
    PostMask := QPMask;
    assume state(PostHeap, PostMask);
    assume state(PostHeap, PostMask);
  ...
  // -- Exhaling postcondition
    ...
    // -- assumptions for inverse of receiver acc(pred2(y, 1), write)
      assume (forall x_3: Ref ::
        { Seq#ContainsTrigger(xs, x_3) } { Seq#Contains(xs, x_3) }
        Seq#Contains(xs, x_3) && NoPerm < FullPerm ==> invRecv4(y, 1) == x_3 && qpRange4(y, 1)
      );
      assume (forall a_1_1: Ref, i_1: int ::
        { invRecv4(a_1_1, i_1) }
        (Seq#Contains(xs, invRecv4(a_1_1, i_1)) && NoPerm < FullPerm) && qpRange4(a_1_1, i_1) ==> y == a_1_1 && 1 == i_1
      );
    
    // -- assume permission updates
      assume (forall a_1_1: Ref, i_1: int ::
        { QPMask[null, pred2(a_1_1, i_1)] }
        (Seq#Contains(xs, invRecv4(a_1_1, i_1)) && NoPerm < FullPerm) && qpRange4(a_1_1, i_1) ==> (y == a_1_1 && 1 == i_1) && QPMask[null, pred2(a_1_1, i_1)] == Mask[null, pred2(a_1_1, i_1)] - FullPerm
      );
      assume (forall a_1_1: Ref, i_1: int ::
        { QPMask[null, pred2(a_1_1, i_1)] }
        !((Seq#Contains(xs, invRecv4(a_1_1, i_1)) && NoPerm < FullPerm) && qpRange4(a_1_1, i_1)) ==> QPMask[null, pred2(a_1_1, i_1)] == Mask[null, pred2(a_1_1, i_1)]
      );
...
procedure test03(xs: (Seq Ref), y: Ref) returns ()
  modifies Heap, Mask;
{
  var oldHeap: HeapType;
  var oldMask: MaskType;
  ...
  //     { (x in xs) }
  //     (x in xs) ==> acc(pred2(x, 1), write)) -- injectivity.vpr@32.2--32.54
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    ...
    // -- assumptions for inverse of receiver acc(pred2(x, 1), write)
      assume (forall x_1: Ref ::
        { Heap[null, pred2(x_1, 1)] } { Mask[null, pred2(x_1, 1)] } { Seq#ContainsTrigger(xs, x_1) } { Seq#Contains(xs, x_1) }
        Seq#Contains(xs, x_1) && NoPerm < FullPerm ==> invRecv5(x_1, 1) == x_1 && qpRange5(x_1, 1)
      );
      assume (forall a_2: Ref, i: int ::
        { invRecv5(a_2, i) }
        (Seq#Contains(xs, invRecv5(a_2, i)) && NoPerm < FullPerm) && qpRange5(a_2, i) ==> invRecv5(a_2, i) == a_2 && 1 == i
      );
    
    // -- assume permission updates
      assume (forall a_2: Ref, i: int ::
        { QPMask[null, pred2(a_2, i)] }
        (Seq#Contains(xs, invRecv5(a_2, i)) && NoPerm < FullPerm) && qpRange5(a_2, i) ==> (invRecv5(a_2, i) == a_2 && 1 == i) && QPMask[null, pred2(a_2, i)] == Mask[null, pred2(a_2, i)] - FullPerm
      );
      assume (forall a_2: Ref, i: int ::
        { QPMask[null, pred2(a_2, i)] }
        !((Seq#Contains(xs, invRecv5(a_2, i)) && NoPerm < FullPerm) && qpRange5(a_2, i)) ==> QPMask[null, pred2(a_2, i)] == Mask[null, pred2(a_2, i)]
      );
