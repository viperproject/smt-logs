...
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_12233| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv11 x_1@@1) x_1@@1) (qpRange11 x_1@@1)))
...
)) (=> (and (forall ((a_2@@11 T@Ref) ) (!  (=> (and (and (|Seq#Contains_12233| xs (invRecv11 a_2@@11)) (< NoPerm FullPerm)) (qpRange11 a_2@@11)) (= (invRecv11 a_2@@11) a_2@@11))
 :qid |stdinbpl.1970:22|
 :skolemid |135|
 :pattern ( (invRecv11 a_2@@11))
)) (forall ((a_2@@12 T@Ref) ) (!  (=> (and (and (|Seq#Contains_12233| xs (invRecv11 a_2@@12)) (< NoPerm FullPerm)) (qpRange11 a_2@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv11 a_2@@12) a_2@@12)) (= (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| QPMask@0) null (pred1 a_2@@12)) (+ (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| ZeroMask) null (pred1 a_2@@12)) FullPerm))))
...
))) (forall ((a_2@@13 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_12233| xs (invRecv11 a_2@@13)) (< NoPerm FullPerm)) (qpRange11 a_2@@13))) (= (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| QPMask@0) null (pred1 a_2@@13)) (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| ZeroMask) null (pred1 a_2@@13))))
...
))) (and (and (state Heap@@47 QPMask@0) (state Heap@@47 QPMask@0)) (and (|pred1#trigger_12157| Heap@@47 (pred1 y@@1)) (= (select (|PolymorphicMapType_21038_12157_12158#PolymorphicMapType_21038| Heap@@47) null (pred1 y@@1)) (FrameFragment_3274 (select (|PolymorphicMapType_21038_12154_3274#PolymorphicMapType_21038| Heap@@47) y@@1 f_7)))))) (and (=> (= (ControlFlow 0 16) 13) anon12_Then_correct) (=> (= (ControlFlow 0 16) 15) anon12_Else_correct)))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@47 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_21038_11918_53#PolymorphicMapType_21038| Heap@@47) y@@1 $allocated) (select (|PolymorphicMapType_21038_11918_53#PolymorphicMapType_21038| Heap@@47) z $allocated)) (and (|Seq#Contains_12233| xs y@@1) (state Heap@@47 ZeroMask))) (and (=> (= (ControlFlow 0 18) 1) anon11_Then_correct) (=> (= (ControlFlow 0 18) 16) anon11_Else_correct))))))
