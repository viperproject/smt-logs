...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((x_3 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_3) (> (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| ZeroMask) x_3 f_7) NoPerm))
 :qid |stdinbpl.2212:15|
 :skolemid |238|
))) (=> (forall ((x_3@@0 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_3@@0) (> (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| ZeroMask) x_3@@0 f_7) NoPerm))
 :qid |stdinbpl.2212:15|
 :skolemid |238|
)) (=> (forall ((x_3@@1 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_3@@1) (< wildcard@0 (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| ZeroMask) x_3@@1 f_7)))
 :qid |stdinbpl.2216:20|
 :skolemid |239|
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x_3@@2 T@Ref) ) (!  (=> (and (|Seq#Contains_11977| xs x_3@@2) (dummyFunction_3562 (select (|PolymorphicMapType_18248_11750_3562#PolymorphicMapType_18248| Heap@@32) x_3@@2 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2223:17|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_18248_11750_3562#PolymorphicMapType_18248| Heap@@32) x_3@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@0) x_3@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger_12054| xs x_3@@2))
 :pattern ( (|Seq#Contains_11977| xs x_3@@2))
))) (=> (forall ((x_3@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_11977| xs x_3@@3) (dummyFunction_3562 (select (|PolymorphicMapType_18248_11750_3562#PolymorphicMapType_18248| Heap@@32) x_3@@3 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2223:17|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_18248_11750_3562#PolymorphicMapType_18248| Heap@@32) x_3@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@0) x_3@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger_12054| xs x_3@@3))
 :pattern ( (|Seq#Contains_11977| xs x_3@@3))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_3@@4 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3@@4 x_3_1)) (|Seq#Contains_11977| xs x_3@@4)) (|Seq#Contains_11977| xs x_3_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_3@@4 x_3_1)))
 :qid |stdinbpl.2230:17|
 :skolemid |241|
 :pattern ( (neverTriggered23 x_3@@4) (neverTriggered23 x_3_1))
))) (=> (forall ((x_3@@5 T@Ref) (x_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3@@5 x_3_1@@0)) (|Seq#Contains_11977| xs x_3@@5)) (|Seq#Contains_11977| xs x_3_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_3@@5 x_3_1@@0)))
 :qid |stdinbpl.2230:17|
 :skolemid |241|
 :pattern ( (neverTriggered23 x_3@@5) (neverTriggered23 x_3_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_3@@6 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_3@@6) (> (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| ZeroMask) x_3@@6 f_7) NoPerm))
 :qid |stdinbpl.2237:17|
 :skolemid |242|
 :pattern ( (select (|PolymorphicMapType_18248_11750_3562#PolymorphicMapType_18248| Heap@@32) x_3@@6 f_7))
 :pattern ( (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@0) x_3@@6 f_7))
 :pattern ( (|Seq#ContainsTrigger_12054| xs x_3@@6))
 :pattern ( (|Seq#Contains_11977| xs x_3@@6))
)))))))))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (forall ((x_1 T@Ref) ) (!  (=> (|Seq#Contains_11977| xs x_1) (not (= x_1 null)))
 :qid |stdinbpl.2193:20|
 :skolemid |237|
 :pattern ( (|Seq#ContainsTrigger_12054| xs x_1))
 :pattern ( (|Seq#Contains_11977| xs x_1))
)) (=> (and (state Heap@@32 ZeroMask) (state Heap@@32 ZeroMask)) (and (=> (= (ControlFlow 0 8) 2) anon6_Then_correct) (=> (= (ControlFlow 0 8) 4) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_18248_11466_53#PolymorphicMapType_18248| Heap@@32) r_1@@5 $allocated)) (and (|Seq#Contains_11977| xs r_1@@5) (state Heap@@32 ZeroMask))) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard 0.0) true) (= (ControlFlow 0 10) 9)) anon0_correct)))
