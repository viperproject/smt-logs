...
(declare-fun invRecv2 (T@IArrayDomainType Int) Int)
(declare-fun qpRange2 (T@IArrayDomainType Int) Bool)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_9_1 Int) (i_9_2 Int) ) (!  (=> (and (and (and (and (not (= i_9_1 i_9_2)) (|Seq#Contains_3440| (|Seq#Range| 0 4) i_9_1)) (|Seq#Contains_3440| (|Seq#Range| 0 4) i_9_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_2@@8 a_2@@8)) (not (= i_9_1 i_9_2))))
 :qid |stdinbpl.835:17|
 :skolemid |79|
 :pattern ( (neverTriggered3 i_9_1) (neverTriggered3 i_9_2))
)))))
...
)) (=> (forall ((i_5_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) i_5_1@@1) (< NoPerm FullPerm)) (and (= (invRecv2 a_2@@8 i_5_1@@1) i_5_1@@1) (qpRange2 a_2@@8 i_5_1@@1)))
 :qid |stdinbpl.799:22|
 :skolemid |74|
...
)) (=> (and (forall ((a_2_1 T@IArrayDomainType) (i_6_1 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv2 a_2_1 i_6_1)) (< NoPerm FullPerm)) (qpRange2 a_2_1 i_6_1)) (and (= a_2@@8 a_2_1) (= (invRecv2 a_2_1 i_6_1) i_6_1)))
 :qid |stdinbpl.803:22|
 :skolemid |75|
 :pattern ( (invRecv2 a_2_1 i_6_1))
)) (forall ((a_2_1@@0 T@IArrayDomainType) (i_6_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv2 a_2_1@@0 i_6_1@@0)) (< NoPerm FullPerm)) (qpRange2 a_2_1@@0 i_6_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_2@@8 a_2_1@@0) (= (invRecv2 a_2_1@@0 i_6_1@@0) i_6_1@@0))) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@3) null (p_2 a_2_1@@0 i_6_1@@0)) (+ (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| ZeroMask) null (p_2 a_2_1@@0 i_6_1@@0)) FullPerm))))
 :qid |stdinbpl.809:22|
 :skolemid |76|
...
))) (forall ((a_2_1@@1 T@IArrayDomainType) (i_6_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv2 a_2_1@@1 i_6_1@@1)) (< NoPerm FullPerm)) (qpRange2 a_2_1@@1 i_6_1@@1))) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@3) null (p_2 a_2_1@@1 i_6_1@@1)) (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| ZeroMask) null (p_2 a_2_1@@1 i_6_1@@1))))
 :qid |stdinbpl.819:22|
 :skolemid |78|
...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((i_12_1 Int) (i_12_2 Int) ) (!  (=> (and (and (and (and (not (= i_12_1 i_12_2)) (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) i_12_1)) (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) i_12_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_2@@8 a_2@@8)) (not (= i_12_1 i_12_2))))
 :qid |stdinbpl.882:17|
 :skolemid |85|
 :pattern ( (neverTriggered4 i_12_1) (neverTriggered4 i_12_2))
 ...
 :qid |stdinbpl.882:17|
 :skolemid |85|
 :pattern ( (neverTriggered4 i_12_1@@0) (neverTriggered4 i_12_2@@0))
...
)) (=> (and (and (forall ((i_12_1@@3 Int) ) (!  (=> (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) i_12_1@@3) (< NoPerm FullPerm)) (and (= (invRecv4 a_2@@8 i_12_1@@3) i_12_1@@3) (qpRange4 a_2@@8 i_12_1@@3)))
 :qid |stdinbpl.895:22|
 :skolemid |87|
...
)) (forall ((a_4_1_1 T@IArrayDomainType) (i_13_1_1 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv4 a_4_1_1 i_13_1_1)) (< NoPerm FullPerm)) (qpRange4 a_4_1_1 i_13_1_1)) (and (= a_2@@8 a_4_1_1) (= (invRecv4 a_4_1_1 i_13_1_1) i_13_1_1)))
 :qid |stdinbpl.899:22|
 :skolemid |88|
 :pattern ( (invRecv4 a_4_1_1 i_13_1_1))
))) (and (forall ((a_4_1_1@@0 T@IArrayDomainType) (i_13_1_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv4 a_4_1_1@@0 i_13_1_1@@0)) (< NoPerm FullPerm)) (qpRange4 a_4_1_1@@0 i_13_1_1@@0)) (and (and (= a_2@@8 a_4_1_1@@0) (= (invRecv4 a_4_1_1@@0 i_13_1_1@@0) i_13_1_1@@0)) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@1) null (p_2 a_4_1_1@@0 i_13_1_1@@0)) (- (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@0) null (p_2 a_4_1_1@@0 i_13_1_1@@0)) FullPerm))))
 :qid |stdinbpl.905:22|
 :skolemid |89|
 :pattern ( (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@1) null (p_2 a_4_1_1@@0 i_13_1_1@@0)))
)) (forall ((a_4_1_1@@1 T@IArrayDomainType) (i_13_1_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv4 a_4_1_1@@1 i_13_1_1@@1)) (< NoPerm FullPerm)) (qpRange4 a_4_1_1@@1 i_13_1_1@@1))) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@1) null (p_2 a_4_1_1@@1 i_13_1_1@@1)) (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@0) null (p_2 a_4_1_1@@1 i_13_1_1@@1))))
 :qid |stdinbpl.909:22|
 :skolemid |90|
...
))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_14_1 Int) (i_14_2 Int) ) (!  (=> (and (and (and (and (not (= i_14_1 i_14_2)) (|Seq#Contains_3440| (|Seq#Range| 0 4) i_14_1)) (|Seq#Contains_3440| (|Seq#Range| 0 4) i_14_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_2@@8 a_2@@8)) (not (= i_14_1 i_14_2))))
 :qid |stdinbpl.927:17|
 :skolemid |92|
 :pattern ( (neverTriggered5 i_14_1) (neverTriggered5 i_14_2))
))) (=> (forall ((i_14_1@@0 Int) (i_14_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_14_1@@0 i_14_2@@0)) (|Seq#Contains_3440| (|Seq#Range| 0 4) i_14_1@@0)) (|Seq#Contains_3440| (|Seq#Range| 0 4) i_14_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_2@@8 a_2@@8)) (not (= i_14_1@@0 i_14_2@@0))))
 :qid |stdinbpl.927:17|
 :skolemid |92|
 :pattern ( (neverTriggered5 i_14_1@@0) (neverTriggered5 i_14_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_14_1@@1 Int) ) (!  (=> (|Seq#Contains_3440| (|Seq#Range| 0 4) i_14_1@@1) (>= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@1) null (p_2 a_2@@8 i_14_1@@1)) FullPerm))
 :qid |stdinbpl.934:17|
 :skolemid |93|
 ...
 :pattern ( (|Seq#ContainsTrigger_3440| (|Seq#Range| 0 4) i_14_1@@1))
 :pattern ( (|Seq#Contains_3440| (|Seq#Range| 0 4) i_14_1@@1))
)))))))))))))
...
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3440| (|Seq#Range| 0 n@@13) i_1@@1) (< NoPerm FullPerm)) (and (= (invRecv1 a_2@@8 i_1@@1) i_1@@1) (qpRange1 a_2@@8 i_1@@1)))
 :qid |stdinbpl.746:22|
 :skolemid |68|
...
)) (=> (and (forall ((a_1_1_1 T@IArrayDomainType) (i_2_1 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 0 n@@13) (invRecv1 a_1_1_1 i_2_1)) (< NoPerm FullPerm)) (qpRange1 a_1_1_1 i_2_1)) (and (= a_2@@8 a_1_1_1) (= (invRecv1 a_1_1_1 i_2_1) i_2_1)))
 :qid |stdinbpl.750:22|
 :skolemid |69|
 :pattern ( (invRecv1 a_1_1_1 i_2_1))
)) (forall ((a_1_1_1@@0 T@IArrayDomainType) (i_2_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 0 n@@13) (invRecv1 a_1_1_1@@0 i_2_1@@0)) (< NoPerm FullPerm)) (qpRange1 a_1_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_2@@8 a_1_1_1@@0) (= (invRecv1 a_1_1_1@@0 i_2_1@@0) i_2_1@@0))) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@0) null (p_2 a_1_1_1@@0 i_2_1@@0)) (+ (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| ZeroMask) null (p_2 a_1_1_1@@0 i_2_1@@0)) FullPerm))))
 :qid |stdinbpl.756:22|
 :skolemid |70|
...
))) (forall ((a_1_1_1@@1 T@IArrayDomainType) (i_2_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_3440| (|Seq#Range| 0 n@@13) (invRecv1 a_1_1_1@@1 i_2_1@@1)) (< NoPerm FullPerm)) (qpRange1 a_1_1_1@@1 i_2_1@@1))) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@0) null (p_2 a_1_1_1@@1 i_2_1@@1)) (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| ZeroMask) null (p_2 a_1_1_1@@1 i_2_1@@1))))
 :qid |stdinbpl.766:22|
 :skolemid |72|
