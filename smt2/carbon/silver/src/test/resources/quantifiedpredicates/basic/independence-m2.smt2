...
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 24)) (forall ((x_4_2 Int) (x_4_3 Int) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (> x_4_2 0)) (> x_4_3 0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_1 r_1)) (not (= x_4_2 x_4_3))))
 :qid |stdinbpl.688:17|
 :skolemid |60|
 :pattern ( (neverTriggered4 x_4_2) (neverTriggered4 x_4_3))
 ...
 :qid |stdinbpl.688:17|
 :skolemid |60|
 :pattern ( (neverTriggered4 x_4_2@@0) (neverTriggered4 x_4_3@@0))
...
)) (=> (and (and (forall ((x_4_2@@3 Int) ) (!  (=> (and (> x_4_2@@3 0) (< NoPerm FullPerm)) (and (= (invRecv4 r_1 x_4_2@@3) x_4_2@@3) (qpRange4 r_1 x_4_2@@3)))
 :qid |stdinbpl.701:22|
 :skolemid |62|
