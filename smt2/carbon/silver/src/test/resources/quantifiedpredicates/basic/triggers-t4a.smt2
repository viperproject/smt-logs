...
(let ((anon15_Then_correct  (=> (|Seq#Contains_8450| xs y_26) (and (=> (= (ControlFlow 0 11) 10) anon16_Then_correct) (=> (= (ControlFlow 0 11) 8) anon9_correct)))))
(let ((anon15_Else_correct  (=> (and (not (|Seq#Contains_8450| xs y_26)) (= (ControlFlow 0 9) 8)) anon9_correct)))
...
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_8450| xs y_1@@1) (>= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_1 (fun2 Heap@@40 y_1@@1))) FullPerm))
 :qid |stdinbpl.1095:17|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_12901_8423_8424#PolymorphicMapType_12901| Heap@@40) null (pred_1 (|fun2#frame| EmptyFrame y_1@@1))))
 :pattern ( (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_1 (|fun2#frame| EmptyFrame y_1@@1))))
...
))) (and (and (forall ((r_1_1_1@@1 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_8450| xs (invRecv4 r_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange4 r_1_1_1@@1))) (= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_1 r_1_1_1@@1)) (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| ZeroMask) null (pred_1 r_1_1_1@@1))))
...
(let ((anon12_Then_correct  (=> (|Seq#Contains_8450| xs x_4) (and (=> (= (ControlFlow 0 4) 3) anon13_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_8450| xs x_4)) (= (ControlFlow 0 2) 1)) anon4_correct)))
