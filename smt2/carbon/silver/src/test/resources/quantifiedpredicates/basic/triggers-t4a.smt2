...
(let ((anon15_Then_correct  (=> (|Seq#Contains_8450| xs y_11) (and (=> (= (ControlFlow 0 11) 10) anon16_Then_correct) (=> (= (ControlFlow 0 11) 8) anon9_correct)))))
(let ((anon15_Else_correct  (=> (and (not (|Seq#Contains_8450| xs y_11)) (= (ControlFlow 0 9) 8)) anon9_correct)))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (|Seq#Contains_8450| xs y_1)) (|Seq#Contains_8450| xs y_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@40 y_1) (fun2 Heap@@40 y_1_1))))
 :qid |stdinbpl.1088:17|
 :skolemid |98|
 :pattern ( (neverTriggered5 y_1) (neverTriggered5 y_1_1))
))) (=> (forall ((y_1@@0 T@Ref) (y_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (|Seq#Contains_8450| xs y_1@@0)) (|Seq#Contains_8450| xs y_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@40 y_1@@0) (fun2 Heap@@40 y_1_1@@0))))
 :qid |stdinbpl.1088:17|
 :skolemid |98|
 :pattern ( (neverTriggered5 y_1@@0) (neverTriggered5 y_1_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_8450| xs y_1@@1) (>= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_3 (fun2 Heap@@40 y_1@@1))) FullPerm))
 :qid |stdinbpl.1095:17|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_12901_8423_8424#PolymorphicMapType_12901| Heap@@40) null (pred_3 (|fun2#frame| EmptyFrame y_1@@1))))
 :pattern ( (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_3 (|fun2#frame| EmptyFrame y_1@@1))))
 :pattern ( (|fun#frame| EmptyFrame y_1@@1 i@@15))
)))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_8450| xs x_1)) (|Seq#Contains_8450| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun Heap@@40 x_1 i@@15) (fun Heap@@40 x_1_1 i@@15))))
...
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_8450| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv4 (fun Heap@@40 x_1@@1 i@@15)) x_1@@1) (qpRange4 (fun Heap@@40 x_1@@1 i@@15))))
...
)) (=> (and (forall ((r_1_1_1 T@Ref) ) (!  (=> (and (and (|Seq#Contains_8450| xs (invRecv4 r_1_1_1)) (< NoPerm FullPerm)) (qpRange4 r_1_1_1)) (= (fun Heap@@40 (invRecv4 r_1_1_1) i@@15) r_1_1_1))
 :qid |stdinbpl.1040:22|
 :skolemid |94|
 :pattern ( (invRecv4 r_1_1_1))
)) (forall ((r_1_1_1@@0 T@Ref) ) (!  (=> (and (and (|Seq#Contains_8450| xs (invRecv4 r_1_1_1@@0)) (< NoPerm FullPerm)) (qpRange4 r_1_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (fun Heap@@40 (invRecv4 r_1_1_1@@0) i@@15) r_1_1_1@@0)) (= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_3 r_1_1_1@@0)) (+ (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| ZeroMask) null (pred_3 r_1_1_1@@0)) FullPerm))))
...
))) (and (and (forall ((r_1_1_1@@1 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_8450| xs (invRecv4 r_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange4 r_1_1_1@@1))) (= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) null (pred_3 r_1_1_1@@1)) (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| ZeroMask) null (pred_3 r_1_1_1@@1))))
...
)) (state Heap@@40 QPMask@0)) (and (state Heap@@40 QPMask@0) (state Heap@@40 QPMask@0)))) (and (and (=> (= (ControlFlow 0 12) 6) anon14_Else_correct) (=> (= (ControlFlow 0 12) 11) anon15_Then_correct)) (=> (= (ControlFlow 0 12) 9) anon15_Else_correct)))))))))
(let ((anon13_Then_correct true))
(let ((anon4_correct true))
(let ((anon12_Then_correct  (=> (|Seq#Contains_8450| xs x_11) (and (=> (= (ControlFlow 0 4) 3) anon13_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_8450| xs x_11)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@40 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_12901_8132_53#PolymorphicMapType_12901| Heap@@40) r_1@@13 $allocated) (state Heap@@40 ZeroMask))) (and (and (=> (= (ControlFlow 0 14) 12) anon11_Else_correct) (=> (= (ControlFlow 0 14) 4) anon12_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon12_Else_correct))))))
