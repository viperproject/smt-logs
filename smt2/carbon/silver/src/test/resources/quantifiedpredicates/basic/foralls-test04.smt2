...
(let ((anon12_Then_correct  (=> (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_7) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_7 (|Seq#Length_9242| xs))) (=> (< i_7 (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_1)) (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9242| xs i_1) (|Seq#Index_9242| xs i_1_1))))
 :qid |stdinbpl.1118:17|
 :skolemid |145|
...
(let ((anon10_Else_correct  (=> (and (not (and (>= ix_12 0) (and (< ix_12 (|Seq#Length_9242| xs)) (and (>= jx_12 0) (and (< jx_12 (|Seq#Length_9242| xs)) (not (= ix_12 jx_12))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= ix_12 0) (and (< ix_12 (|Seq#Length_9242| xs)) (and (>= jx_12 0) (and (< jx_12 (|Seq#Length_9242| xs)) (not (= ix_12 jx_12)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_12 0)) (=> (>= ix_12 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_12 (|Seq#Length_9242| xs))) (=> (< ix_12 (|Seq#Length_9242| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_12 0)) (=> (>= jx_12 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_12 (|Seq#Length_9242| xs))) (=> (< jx_12 (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and (and AssumePermUpperBound (<= 0 n@@27)) (and (<= n@@27 (|Seq#Length_9242| xs)) (state Heap@@32 ZeroMask))) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct))))))
