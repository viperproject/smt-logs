...
(let ((anon12_Then_correct  (=> (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_9) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_9 (|Seq#Length_9242| xs))) (=> (< i_9 (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
...
(let ((anon10_Else_correct  (=> (and (not (and (>= ix_4 0) (and (< ix_4 (|Seq#Length_9242| xs)) (and (>= jx_4 0) (and (< jx_4 (|Seq#Length_9242| xs)) (not (= ix_4 jx_4))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= ix_4 0) (and (< ix_4 (|Seq#Length_9242| xs)) (and (>= jx_4 0) (and (< jx_4 (|Seq#Length_9242| xs)) (not (= ix_4 jx_4)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_4 0)) (=> (>= ix_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_4 (|Seq#Length_9242| xs))) (=> (< ix_4 (|Seq#Length_9242| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_4 0)) (=> (>= jx_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_4 (|Seq#Length_9242| xs))) (=> (< jx_4 (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
