...
(let ((anon15_Then_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_12682_8459_8460#PolymorphicMapType_12682| QPMask@0) null (P (|Seq#Index_8337| xs@@9 j@@18))))))))
...
)) (state Heap@@46 QPMask@0))) (and (and (state Heap@@46 QPMask@0) (<= 0 j@@18)) (and (< j@@18 (|Seq#Length_8337| xs@@9)) (state Heap@@46 QPMask@0)))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (>= j@@18 0)) (=> (>= j@@18 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< j@@18 (|Seq#Length_8337| xs@@9))) (=> (< j@@18 (|Seq#Length_8337| xs@@9)) (and (=> (= (ControlFlow 0 16) 14) anon15_Then_correct) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct)))))))))))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length_8337| xs@@9)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon14_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length_8337| xs@@9))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_3 (|Seq#Length_8337| xs@@9))) (=> (< i_3 (|Seq#Length_8337| xs@@9)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon12_Else_correct  (=> (and (not (and (>= ix_9 0) (and (< ix_9 (|Seq#Length_8337| xs@@9)) (and (>= jx_9 0) (and (< jx_9 (|Seq#Length_8337| xs@@9)) (not (= ix_9 jx_9))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (>= ix_9 0) (and (< ix_9 (|Seq#Length_8337| xs@@9)) (and (>= jx_9 0) (and (< jx_9 (|Seq#Length_8337| xs@@9)) (not (= ix_9 jx_9)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_9 0)) (=> (>= ix_9 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_9 (|Seq#Length_8337| xs@@9))) (=> (< ix_9 (|Seq#Length_8337| xs@@9)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_9 0)) (=> (>= jx_9 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_9 (|Seq#Length_8337| xs@@9))) (=> (< jx_9 (|Seq#Length_8337| xs@@9)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
