...
(let ((anon18_Then_correct  (=> (|Seq#Contains_8450| xs y_34) (and (=> (= (ControlFlow 0 13) 12) anon19_Then_correct) (=> (= (ControlFlow 0 13) 10) anon10_correct)))))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains_8450| xs y_34)) (= (ControlFlow 0 11) 10)) anon10_correct)))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((y_2_1 T@Ref) (y_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2_1 y_2_2)) (|Seq#Contains_8450| xs y_2_1)) (|Seq#Contains_8450| xs y_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@40 y_2_1) (fun2 Heap@@40 y_2_2))))
 :qid |stdinbpl.1475:17|
 :skolemid |136|
 :pattern ( (neverTriggered11 y_2_1) (neverTriggered11 y_2_2))
))) (=> (forall ((y_2_1@@0 T@Ref) (y_2_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2_1@@0 y_2_2@@0)) (|Seq#Contains_8450| xs y_2_1@@0)) (|Seq#Contains_8450| xs y_2_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@40 y_2_1@@0) (fun2 Heap@@40 y_2_2@@0))))
 :qid |stdinbpl.1475:17|
 :skolemid |136|
 :pattern ( (neverTriggered11 y_2_1@@0) (neverTriggered11 y_2_2@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_2_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_8450| xs y_2_1@@1) (>= (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) (fun2 Heap@@40 y_2_1@@1) f_7) FullPerm))
 :qid |stdinbpl.1482:17|
 :skolemid |137|
 :pattern ( (|fun2#frame| EmptyFrame y_2_1@@1))
 :pattern ( (|fun#frame| EmptyFrame y_2_1@@1 i@@15))
)))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_8450| xs x_1)) (|Seq#Contains_8450| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun Heap@@40 x_1 i@@15) (fun Heap@@40 x_1_1 i@@15))))
 ...
 :qid |stdinbpl.1370:15|
 :skolemid |124|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_8450| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange9 (fun Heap@@40 x_1@@1 i@@15)) (= (invRecv9 (fun Heap@@40 x_1@@1 i@@15)) x_1@@1)))
 :qid |stdinbpl.1376:22|
 :skolemid |125|
 :pattern ( (|fun#frame| EmptyFrame x_1@@1 i@@15))
 :pattern ( (|fun2#frame| EmptyFrame x_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_8450| xs (invRecv9 o_9)) (< NoPerm FullPerm)) (qpRange9 o_9)) (= (fun Heap@@40 (invRecv9 o_9) i@@15) o_9))
 :qid |stdinbpl.1380:22|
 :skolemid |126|
 :pattern ( (invRecv9 o_9))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (|Seq#Contains_8450| xs x_1@@2) (not (= (fun Heap@@40 x_1@@2 i@@15) null)))
 :qid |stdinbpl.1386:22|
 :skolemid |127|
 :pattern ( (|fun#frame| EmptyFrame x_1@@2 i@@15))
 :pattern ( (|fun2#frame| EmptyFrame x_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_8450| xs (invRecv9 o_9@@0)) (< NoPerm FullPerm)) (qpRange9 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (fun Heap@@40 (invRecv9 o_9@@0) i@@15) o_9@@0)) (= (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_8450| xs (invRecv9 o_9@@0)) (< NoPerm FullPerm)) (qpRange9 o_9@@0))) (= (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1392:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_12961_53) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8364_53#PolymorphicMapType_12922| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_12922_8364_53#PolymorphicMapType_12922| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8364_53#PolymorphicMapType_12922| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_12922_8364_53#PolymorphicMapType_12922| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_12974_12975) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8364_12975#PolymorphicMapType_12922| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_12922_8364_12975#PolymorphicMapType_12922| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8364_12975#PolymorphicMapType_12922| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_12922_8364_12975#PolymorphicMapType_12922| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_19023_3253) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_12961_20334) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8364_8424#PolymorphicMapType_12922| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_12922_8364_8424#PolymorphicMapType_12922| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8364_8424#PolymorphicMapType_12922| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_12922_8364_8424#PolymorphicMapType_12922| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_12961_20351) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8364_46712#PolymorphicMapType_12922| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_12922_8364_46712#PolymorphicMapType_12922| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8364_46712#PolymorphicMapType_12922| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_12922_8364_46712#PolymorphicMapType_12922| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_20333_53) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8423_53#PolymorphicMapType_12922| ZeroMask) o_9@@6 f_5@@4) (select (|PolymorphicMapType_12922_8423_53#PolymorphicMapType_12922| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8423_53#PolymorphicMapType_12922| ZeroMask) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_12922_8423_53#PolymorphicMapType_12922| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_20333_12975) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8423_12975#PolymorphicMapType_12922| ZeroMask) o_9@@7 f_5@@5) (select (|PolymorphicMapType_12922_8423_12975#PolymorphicMapType_12922| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8423_12975#PolymorphicMapType_12922| ZeroMask) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_12922_8423_12975#PolymorphicMapType_12922| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_20333_3253) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8423_3253#PolymorphicMapType_12922| ZeroMask) o_9@@8 f_5@@6) (select (|PolymorphicMapType_12922_8423_3253#PolymorphicMapType_12922| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8423_3253#PolymorphicMapType_12922| ZeroMask) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_12922_8423_3253#PolymorphicMapType_12922| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_20333_20334) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| ZeroMask) o_9@@9 f_5@@7) (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| ZeroMask) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_20346_20351) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8423_47123#PolymorphicMapType_12922| ZeroMask) o_9@@10 f_5@@8) (select (|PolymorphicMapType_12922_8423_47123#PolymorphicMapType_12922| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8423_47123#PolymorphicMapType_12922| ZeroMask) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_12922_8423_47123#PolymorphicMapType_12922| QPMask@0) o_9@@10 f_5@@8))
...
(let ((anon14_Then_correct  (=> (|Seq#Contains_8450| xs x_15) (and (=> (= (ControlFlow 0 4) 3) anon15_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains_8450| xs x_15)) (= (ControlFlow 0 2) 1)) anon4_correct)))
