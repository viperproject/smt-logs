...
(let ((anon18_Then_correct  (=> (|Seq#Contains_8450| xs y_13) (and (=> (= (ControlFlow 0 13) 12) anon19_Then_correct) (=> (= (ControlFlow 0 13) 10) anon10_correct)))))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains_8450| xs y_13)) (= (ControlFlow 0 11) 10)) anon10_correct)))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((y_2 T@Ref) (y_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2 y_2_1)) (|Seq#Contains_8450| xs y_2)) (|Seq#Contains_8450| xs y_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@40 y_2) (fun2 Heap@@40 y_2_1))))
 :qid |stdinbpl.1475:17|
 :skolemid |136|
 :pattern ( (neverTriggered11 y_2) (neverTriggered11 y_2_1))
))) (=> (forall ((y_2@@0 T@Ref) (y_2_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2@@0 y_2_1@@0)) (|Seq#Contains_8450| xs y_2@@0)) (|Seq#Contains_8450| xs y_2_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@40 y_2@@0) (fun2 Heap@@40 y_2_1@@0))))
 :qid |stdinbpl.1475:17|
 :skolemid |136|
 :pattern ( (neverTriggered11 y_2@@0) (neverTriggered11 y_2_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_2@@1 T@Ref) ) (!  (=> (|Seq#Contains_8450| xs y_2@@1) (>= (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) (fun2 Heap@@40 y_2@@1) f_7) FullPerm))
 :qid |stdinbpl.1482:17|
 :skolemid |137|
 :pattern ( (|fun2#frame| EmptyFrame y_2@@1))
 :pattern ( (|fun#frame| EmptyFrame y_2@@1 i@@15))
)))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_8450| xs (invRecv9 o_4)) (< NoPerm FullPerm)) (qpRange9 o_4)) (= (fun Heap@@40 (invRecv9 o_4) i@@15) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_8450| xs (invRecv9 o_4@@0)) (< NoPerm FullPerm)) (qpRange9 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (fun Heap@@40 (invRecv9 o_4@@0) i@@15) o_4@@0)) (= (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_8450| xs (invRecv9 o_4@@0)) (< NoPerm FullPerm)) (qpRange9 o_4@@0))) (= (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1392:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_12961_53) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8364_53#PolymorphicMapType_12922| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_12922_8364_53#PolymorphicMapType_12922| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8364_53#PolymorphicMapType_12922| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_12922_8364_53#PolymorphicMapType_12922| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_12974_12975) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8364_12975#PolymorphicMapType_12922| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_12922_8364_12975#PolymorphicMapType_12922| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8364_12975#PolymorphicMapType_12922| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_12922_8364_12975#PolymorphicMapType_12922| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_19023_3253) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_12922_8364_3253#PolymorphicMapType_12922| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_12961_20334) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8364_8424#PolymorphicMapType_12922| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_12922_8364_8424#PolymorphicMapType_12922| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8364_8424#PolymorphicMapType_12922| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_12922_8364_8424#PolymorphicMapType_12922| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_12961_20351) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8364_46712#PolymorphicMapType_12922| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_12922_8364_46712#PolymorphicMapType_12922| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8364_46712#PolymorphicMapType_12922| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_12922_8364_46712#PolymorphicMapType_12922| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_20333_53) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8423_53#PolymorphicMapType_12922| ZeroMask) o_4@@6 f_5@@4) (select (|PolymorphicMapType_12922_8423_53#PolymorphicMapType_12922| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8423_53#PolymorphicMapType_12922| ZeroMask) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_12922_8423_53#PolymorphicMapType_12922| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_20333_12975) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8423_12975#PolymorphicMapType_12922| ZeroMask) o_4@@7 f_5@@5) (select (|PolymorphicMapType_12922_8423_12975#PolymorphicMapType_12922| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8423_12975#PolymorphicMapType_12922| ZeroMask) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_12922_8423_12975#PolymorphicMapType_12922| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_20333_3253) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8423_3253#PolymorphicMapType_12922| ZeroMask) o_4@@8 f_5@@6) (select (|PolymorphicMapType_12922_8423_3253#PolymorphicMapType_12922| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8423_3253#PolymorphicMapType_12922| ZeroMask) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_12922_8423_3253#PolymorphicMapType_12922| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_20333_20334) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| ZeroMask) o_4@@9 f_5@@7) (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| ZeroMask) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_12922_8423_8424#PolymorphicMapType_12922| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_20346_20351) ) (!  (=> true (= (select (|PolymorphicMapType_12922_8423_47123#PolymorphicMapType_12922| ZeroMask) o_4@@10 f_5@@8) (select (|PolymorphicMapType_12922_8423_47123#PolymorphicMapType_12922| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.1396:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_12922_8423_47123#PolymorphicMapType_12922| ZeroMask) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_12922_8423_47123#PolymorphicMapType_12922| QPMask@0) o_4@@10 f_5@@8))
...
(let ((anon14_Then_correct  (=> (|Seq#Contains_8450| xs x_18) (and (=> (= (ControlFlow 0 4) 3) anon15_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains_8450| xs x_18)) (= (ControlFlow 0 2) 1)) anon4_correct)))
