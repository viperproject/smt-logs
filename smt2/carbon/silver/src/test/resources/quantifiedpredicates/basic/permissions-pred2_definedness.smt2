...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_11873_7053_53#PolymorphicMapType_11873| Heap@@47) a_2@@11 $allocated)) (and (<= NoPerm p_1@@5) (= (ControlFlow 0 2) (- 0 1)))) (>= p_1@@5 NoPerm)))))
