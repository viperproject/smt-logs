...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_5792| xs x_1)) (|Seq#Contains_5792| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.1010:17|
 :skolemid |96|
 :pattern ( (neverTriggered5 x_1) (neverTriggered5 x_1_1))
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains_5792| xs x_1@@0)) (|Seq#Contains_5792| xs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.1010:17|
 :skolemid |96|
 :pattern ( (neverTriggered5 x_1@@0) (neverTriggered5 x_1_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_5792| xs x_1@@1) (>= (select (|PolymorphicMapType_8704_5765_5766#PolymorphicMapType_8704| ZeroMask) null (pred2 x_1@@1 1)) FullPerm))
 :qid |stdinbpl.1017:17|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_8683_5765_5766#PolymorphicMapType_8683| Heap@@47) null (pred2 x_1@@1 1)))
 :pattern ( (select (|PolymorphicMapType_8704_5765_5766#PolymorphicMapType_8704| ZeroMask) null (pred2 x_1@@1 1)))
 :pattern ( (|Seq#ContainsTrigger_5792| xs x_1@@1))
 :pattern ( (|Seq#Contains_5792| xs x_1@@1))
)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_8683_5529_53#PolymorphicMapType_8683| Heap@@47) y@@1 $allocated)) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
