...
)) (=> (forall ((i_5_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) i_5_1@@1) (< NoPerm FullPerm)) (and (= (invRecv12 a_2@@8 i_5_1@@1) i_5_1@@1) (qpRange12 a_2@@8 i_5_1@@1)))
...
)) (=> (and (forall ((a_2_1 T@IArrayDomainType) (i_6_1 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv12 a_2_1 i_6_1)) (< NoPerm FullPerm)) (qpRange12 a_2_1 i_6_1)) (and (= a_2@@8 a_2_1) (= (invRecv12 a_2_1 i_6_1) i_6_1)))
 :qid |stdinbpl.1331:22|
 :skolemid |139|
 :pattern ( (invRecv12 a_2_1 i_6_1))
)) (forall ((a_2_1@@0 T@IArrayDomainType) (i_6_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv12 a_2_1@@0 i_6_1@@0)) (< NoPerm FullPerm)) (qpRange12 a_2_1@@0 i_6_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_2@@8 a_2_1@@0) (= (invRecv12 a_2_1@@0 i_6_1@@0) i_6_1@@0))) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@3) null (p_2 a_2_1@@0 i_6_1@@0)) (+ (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| ZeroMask) null (p_2 a_2_1@@0 i_6_1@@0)) FullPerm))))
...
))) (forall ((a_2_1@@1 T@IArrayDomainType) (i_6_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv12 a_2_1@@1 i_6_1@@1)) (< NoPerm FullPerm)) (qpRange12 a_2_1@@1 i_6_1@@1))) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@3) null (p_2 a_2_1@@1 i_6_1@@1)) (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| ZeroMask) null (p_2 a_2_1@@1 i_6_1@@1))))
...
)) (forall ((a_4_1_1 T@IArrayDomainType) (i_13_1_1 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv14 a_4_1_1 i_13_1_1)) (< NoPerm FullPerm)) (qpRange14 a_4_1_1 i_13_1_1)) (and (= a_2@@8 a_4_1_1) (= (invRecv14 a_4_1_1 i_13_1_1) i_13_1_1)))
 :qid |stdinbpl.1427:22|
 :skolemid |152|
 :pattern ( (invRecv14 a_4_1_1 i_13_1_1))
))) (and (forall ((a_4_1_1@@0 T@IArrayDomainType) (i_13_1_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv14 a_4_1_1@@0 i_13_1_1@@0)) (< NoPerm FullPerm)) (qpRange14 a_4_1_1@@0 i_13_1_1@@0)) (and (and (= a_2@@8 a_4_1_1@@0) (= (invRecv14 a_4_1_1@@0 i_13_1_1@@0) i_13_1_1@@0)) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@1) null (p_2 a_4_1_1@@0 i_13_1_1@@0)) (- (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@0) null (p_2 a_4_1_1@@0 i_13_1_1@@0)) FullPerm))))
...
)) (forall ((a_4_1_1@@1 T@IArrayDomainType) (i_13_1_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_3440| (|Seq#Range| 4 n@@13) (invRecv14 a_4_1_1@@1 i_13_1_1@@1)) (< NoPerm FullPerm)) (qpRange14 a_4_1_1@@1 i_13_1_1@@1))) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@1) null (p_2 a_4_1_1@@1 i_13_1_1@@1)) (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@0) null (p_2 a_4_1_1@@1 i_13_1_1@@1))))
...
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_14_1@@1 Int) ) (!  (=> (|Seq#Contains_3440| (|Seq#Range| 0 3) i_14_1@@1) (>= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@1) null (p_2 a_2@@8 i_14_1@@1)) FullPerm))
...
)) (=> (and (forall ((a_1_1_1 T@IArrayDomainType) (i_2_1 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 0 n@@13) (invRecv11 a_1_1_1 i_2_1)) (< NoPerm FullPerm)) (qpRange11 a_1_1_1 i_2_1)) (and (= a_2@@8 a_1_1_1) (= (invRecv11 a_1_1_1 i_2_1) i_2_1)))
 :qid |stdinbpl.1278:22|
 :skolemid |133|
 :pattern ( (invRecv11 a_1_1_1 i_2_1))
)) (forall ((a_1_1_1@@0 T@IArrayDomainType) (i_2_1@@0 Int) ) (!  (=> (and (and (|Seq#Contains_3440| (|Seq#Range| 0 n@@13) (invRecv11 a_1_1_1@@0 i_2_1@@0)) (< NoPerm FullPerm)) (qpRange11 a_1_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_2@@8 a_1_1_1@@0) (= (invRecv11 a_1_1_1@@0 i_2_1@@0) i_2_1@@0))) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@0) null (p_2 a_1_1_1@@0 i_2_1@@0)) (+ (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| ZeroMask) null (p_2 a_1_1_1@@0 i_2_1@@0)) FullPerm))))
...
))) (forall ((a_1_1_1@@1 T@IArrayDomainType) (i_2_1@@1 Int) ) (!  (=> (not (and (and (|Seq#Contains_3440| (|Seq#Range| 0 n@@13) (invRecv11 a_1_1_1@@1 i_2_1@@1)) (< NoPerm FullPerm)) (qpRange11 a_1_1_1@@1 i_2_1@@1))) (= (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| QPMask@0) null (p_2 a_1_1_1@@1 i_2_1@@1)) (select (|PolymorphicMapType_16088_11296_11297#PolymorphicMapType_16088| ZeroMask) null (p_2 a_1_1_1@@1 i_2_1@@1))))
