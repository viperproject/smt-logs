...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (|Seq#Contains_12233| xs x_4)) (|Seq#Contains_12233| xs x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1)))
 :qid |stdinbpl.1475:17|
 :skolemid |114|
 :pattern ( (neverTriggered8 x_4) (neverTriggered8 x_4_1))
))) (=> (forall ((x_4@@0 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (|Seq#Contains_12233| xs x_4@@0)) (|Seq#Contains_12233| xs x_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0)))
 :qid |stdinbpl.1475:17|
 :skolemid |114|
 :pattern ( (neverTriggered8 x_4@@0) (neverTriggered8 x_4_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_4@@1 T@Ref) ) (!  (=> (|Seq#Contains_12233| xs x_4@@1) (>= (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| Mask@4) null (pred1 x_4@@1)) FullPerm))
 :qid |stdinbpl.1482:17|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_21038_12157_12158#PolymorphicMapType_21038| ExhaleHeap@0) null (pred1 x_4@@1)))
 :pattern ( (select (|PolymorphicMapType_21059_12157_12158#PolymorphicMapType_21059| Mask@4) null (pred1 x_4@@1)))
 :pattern ( (|Seq#ContainsTrigger_12233| xs x_4@@1))
 :pattern ( (|Seq#Contains_12233| xs x_4@@1))
)))))))
