...
(let ((anon12_Else_correct  (=> (and (not (select ss i_17)) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon12_Then_correct  (=> (select ss i_17) (and (=> (= (ControlFlow 0 6) (- 0 8)) (>= i_17 0)) (=> (>= i_17 0) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< i_17 (|Seq#Length_9242| xs))) (=> (< i_17 (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((i_5_1 Int) (i_5_2 Int) ) (!  (=> (and (and (and (and (not (= i_5_1 i_5_2)) (select ss i_5_1)) (select ss i_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9242| xs i_5_1) (|Seq#Index_9242| xs i_5_2))))
 :qid |stdinbpl.1394:17|
 :skolemid |166|
 :pattern ( (neverTriggered7 i_5_1) (neverTriggered7 i_5_2))
)))))
(let ((anon10_Else_correct  (=> (and (forall ((i_3_2 Int) ) (!  (=> (select ss i_3_2) (<= 0 i_3_2))
 :qid |stdinbpl.1374:20|
 :skolemid |165|
 :pattern ( (select ss i_3_2))
)) (state Heap@@32 ZeroMask)) (and (and (=> (= (ControlFlow 0 10) 4) anon11_Else_correct) (=> (= (ControlFlow 0 10) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon12_Else_correct)))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_1) (select ss (+ (* a_2@@5 i_1) b_24)))
 :qid |stdinbpl.1364:20|
 :skolemid |164|
 :pattern ( (|Seq#ContainsTrigger_3032| (|Seq#Range| 0 n@@27) i_1))
 :pattern ( (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_1))
)) (state Heap@@32 ZeroMask)) (and (=> (= (ControlFlow 0 11) 2) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (=> (and (and (and (<= 0 a_2@@5) (<= 0 b_24)) (and (<= 0 n@@27) (state Heap@@32 ZeroMask))) (and (and (<= (+ (* a_2@@5 (- n@@27 1)) b_24) (|Seq#Length_9242| xs)) (state Heap@@32 ZeroMask)) (and (= (|Set#Card_8326| ss) n@@27) (state Heap@@32 ZeroMask)))) (and (=> (= (ControlFlow 0 12) 1) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct))))))
