...
(let ((anon12_Else_correct  (=> (and (not (select ss i_13)) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon12_Then_correct  (=> (select ss i_13) (and (=> (= (ControlFlow 0 6) (- 0 8)) (>= i_13 0)) (=> (>= i_13 0) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< i_13 (|Seq#Length_9242| xs))) (=> (< i_13 (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (select ss i_5)) (select ss i_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9242| xs i_5) (|Seq#Index_9242| xs i_5_1))))
 :qid |stdinbpl.1394:17|
 :skolemid |166|
 :pattern ( (neverTriggered7 i_5) (neverTriggered7 i_5_1))
)))))
(let ((anon10_Else_correct  (=> (and (forall ((i_3 Int) ) (!  (=> (select ss i_3) (<= 0 i_3))
 :qid |stdinbpl.1374:20|
 :skolemid |165|
 :pattern ( (select ss i_3))
