...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_11894_7270_7271#PolymorphicMapType_11894| ZeroMask) null (pred1 x@@5)))) (=> (<= FullPerm (select (|PolymorphicMapType_11894_7270_7271#PolymorphicMapType_11894| ZeroMask) null (pred1 x@@5))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_11873_7053_53#PolymorphicMapType_11873| Heap@@47) x@@5 $allocated)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
