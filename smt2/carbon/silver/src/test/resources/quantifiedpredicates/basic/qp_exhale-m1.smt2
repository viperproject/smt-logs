...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((r_4 T@Ref) (r_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4 r_4_1)) (select (|Set#UnionOne_9565| (|Set#UnionOne_9565| (|Set#Singleton_9565| z) y@@3) x@@5) r_4)) (select (|Set#UnionOne_9565| (|Set#UnionOne_9565| (|Set#Singleton_9565| z) y@@3) x@@5) r_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4 r_4_1)))
 :qid |stdinbpl.784:17|
 :skolemid |113|
 :pattern ( (neverTriggered2 r_4) (neverTriggered2 r_4_1))
 ...
 :qid |stdinbpl.784:17|
 :skolemid |113|
 :pattern ( (neverTriggered2 r_4@@0) (neverTriggered2 r_4_1@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_4@@1 T@Ref) ) (!  (=> (select (|Set#UnionOne_9565| (|Set#UnionOne_9565| (|Set#Singleton_9565| z) y@@3) x@@5) r_4@@1) (>= (select (|PolymorphicMapType_15660_9461_9462#PolymorphicMapType_15660| Mask@2) null (p2 r_4@@1)) FullPerm))
 :qid |stdinbpl.791:17|
 :skolemid |114|
