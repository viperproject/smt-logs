...
(declare-fun getPredWandId_11750_3562 (T@Field_24421_3562) Int)
(declare-fun getPredWandId_11750_11754 (T@Field_18308_24469) Int)
(declare-fun getPredWandId_11750_53 (T@Field_18308_53) Int)
(declare-fun getPredWandId_11750_18322 (T@Field_18321_18322) Int)
(declare-fun getPredWandId_11750_79705 (T@Field_18308_24486) Int)
(declare-fun getPredWandId_11753_3562 (T@Field_24468_3562) Int)
(declare-fun getPredWandId_11753_53 (T@Field_24468_53) Int)
(declare-fun getPredWandId_11753_18322 (T@Field_24468_18322) Int)
(declare-fun getPredWandId_11753_80514 (T@Field_24481_24486) Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon12_Else_correct  (=> (and (> wildcard@4 0.0) (= (ControlFlow 0 14) (- 0 13))) (forall ((x_7 T@Ref) (x_7_1 T@Ref) ) (!  (=> (and (and (not (= x_7 x_7_1)) (< NoPerm wildcard@4)) (< NoPerm wildcard@4)) (not (= x_7 x_7_1)))
 :qid |stdinbpl.1266:17|
 :skolemid |126|
 :pattern ( (neverTriggered9 x_7) (neverTriggered9 x_7_1))
)))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> (> wildcard@3 0.0) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (not (= x_4 x_4_1)) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= x_4 x_4_1)))
 :qid |stdinbpl.1223:17|
 :skolemid |120|
 :pattern ( (neverTriggered8 x_4) (neverTriggered8 x_4_1))
))) (=> (forall ((x_4@@0 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (not (= x_4@@0 x_4_1@@0)) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= x_4@@0 x_4_1@@0)))
 :qid |stdinbpl.1223:17|
 :skolemid |120|
 :pattern ( (neverTriggered8 x_4@@0) (neverTriggered8 x_4_1@@0))
)) (=> (forall ((x_4@@1 T@Ref) ) (!  (=> (< NoPerm wildcard@3) (and (= (invRecv8 x_4@@1) x_4@@1) (qpRange8 x_4@@1)))
 :qid |stdinbpl.1229:22|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| PostHeap@0) null (pred_3 x_4@@1)))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 x_4@@1)))
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| PostHeap@0) null (pred_3 x_4@@1)))
)) (=> (and (forall ((r_2_1_1 T@Ref) ) (!  (=> (and (< NoPerm wildcard@3) (qpRange8 r_2_1_1)) (= (invRecv8 r_2_1_1) r_2_1_1))
 :qid |stdinbpl.1233:22|
 :skolemid |122|
 :pattern ( (invRecv8 r_2_1_1))
)) (forall ((r_2_1_1@@0 T@Ref) ) (!  (=> (and (< NoPerm wildcard@3) (qpRange8 r_2_1_1@@0)) (and (=> (< NoPerm wildcard@3) (= (invRecv8 r_2_1_1@@0) r_2_1_1@@0)) (= (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@3) null (pred_3 r_2_1_1@@0)) (+ (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 r_2_1_1@@0)) wildcard@3))))
 :qid |stdinbpl.1239:22|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@3) null (pred_3 r_2_1_1@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_24421_3562) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_11750_3562 f_5))) (not (= (getPredWandId_11750_3562 f_5) 0))) (= (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| ZeroMask) o_4 f_5) (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@3) o_4 f_5)))
 :qid |stdinbpl.1245:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| ZeroMask) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@3) o_4 f_5))
)) (forall ((o_4@@0 T@Ref) (f_5@@0 T@Field_18308_24469) ) (!  (=> (or (or (not (= o_4@@0 null)) (not (IsPredicateField_18308_57773 f_5@@0))) (not (= (getPredWandId_11750_11754 f_5@@0) 0))) (= (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| ZeroMask) o_4@@0 f_5@@0) (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| QPMask@3) o_4@@0 f_5@@0)))
 :qid |stdinbpl.1245:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| ZeroMask) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| QPMask@3) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_18308_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_11750_53 f_5@@1))) (not (= (getPredWandId_11750_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| ZeroMask) o_4@@1 f_5@@1) (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| QPMask@3) o_4@@1 f_5@@1)))
 :qid |stdinbpl.1245:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| ZeroMask) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| QPMask@3) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_18321_18322) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_11750_18322 f_5@@2))) (not (= (getPredWandId_11750_18322 f_5@@2) 0))) (= (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| ZeroMask) o_4@@2 f_5@@2) (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| QPMask@3) o_4@@2 f_5@@2)))
 :qid |stdinbpl.1245:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| ZeroMask) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| QPMask@3) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_18308_24486) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsPredicateField_11750_67571 f_5@@3))) (not (= (getPredWandId_11750_79705 f_5@@3) 0))) (= (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| ZeroMask) o_4@@3 f_5@@3) (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| QPMask@3) o_4@@3 f_5@@3)))
 :qid |stdinbpl.1245:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| ZeroMask) o_4@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| QPMask@3) o_4@@3 f_5@@3))
))) (forall ((o_4@@4 T@Ref) (f_5@@4 T@Field_24468_3562) ) (!  (=> (or (or (not (= o_4@@4 null)) (not (IsPredicateField_11753_3562 f_5@@4))) (not (= (getPredWandId_11753_3562 f_5@@4) 0))) (= (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| ZeroMask) o_4@@4 f_5@@4) (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| QPMask@3) o_4@@4 f_5@@4)))
 :qid |stdinbpl.1245:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| ZeroMask) o_4@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| QPMask@3) o_4@@4 f_5@@4))
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_24468_24469) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_11753_11754 f_5@@5))) (not (= (getPredWandId_11753_11754 f_5@@5) 0))) (= (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) o_4@@5 f_5@@5) (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@3) o_4@@5 f_5@@5)))
 :qid |stdinbpl.1245:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) o_4@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@3) o_4@@5 f_5@@5))
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_24468_53) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_11753_53 f_5@@6))) (not (= (getPredWandId_11753_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| ZeroMask) o_4@@6 f_5@@6) (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| QPMask@3) o_4@@6 f_5@@6)))
 :qid |stdinbpl.1245:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| ZeroMask) o_4@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| QPMask@3) o_4@@6 f_5@@6))
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_24468_18322) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsPredicateField_11753_18322 f_5@@7))) (not (= (getPredWandId_11753_18322 f_5@@7) 0))) (= (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| ZeroMask) o_4@@7 f_5@@7) (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| QPMask@3) o_4@@7 f_5@@7)))
 :qid |stdinbpl.1245:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| ZeroMask) o_4@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| QPMask@3) o_4@@7 f_5@@7))
))) (forall ((o_4@@8 T@Ref) (f_5@@8 T@Field_24481_24486) ) (!  (=> (or (or (not (= o_4@@8 null)) (not (IsPredicateField_11753_68402 f_5@@8))) (not (= (getPredWandId_11753_80514 f_5@@8) 0))) (= (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| ZeroMask) o_4@@8 f_5@@8) (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| QPMask@3) o_4@@8 f_5@@8)))
 :qid |stdinbpl.1245:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| ZeroMask) o_4@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| QPMask@3) o_4@@8 f_5@@8))
))) (forall ((r_2_1_1@@1 T@Ref) ) (!  (=> (not (and (< NoPerm wildcard@3) (qpRange8 r_2_1_1@@1))) (= (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@3) null (pred_3 r_2_1_1@@1)) (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 r_2_1_1@@1))))
 :qid |stdinbpl.1249:22|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@3) null (pred_3 r_2_1_1@@1)))
...
(let ((anon10_Else_correct  (=> (> wildcard@1 0.0) (and (=> (= (ControlFlow 0 3) (- 0 10)) (forall ((x_9_2 T@Ref) ) (! (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 x_9_2)) NoPerm)
 :qid |stdinbpl.1310:15|
 :skolemid |132|
))) (=> (forall ((x_9_2@@0 T@Ref) ) (! (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 x_9_2@@0)) NoPerm)
 :qid |stdinbpl.1310:15|
 :skolemid |132|
)) (=> (forall ((x_9_2@@1 T@Ref) ) (! (< wildcard@1 (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 x_9_2@@1)))
 :qid |stdinbpl.1314:20|
 :skolemid |133|
)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (forall ((r_4_1_1 T@Ref) ) (!  (=> (qpRange10 r_4_1_1) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.1321:17|
 :skolemid |134|
 :pattern ( (invRecv10 r_4_1_1))
))) (=> (forall ((r_4_1_1@@0 T@Ref) ) (!  (=> (qpRange10 r_4_1_1@@0) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.1321:17|
 :skolemid |134|
 :pattern ( (invRecv10 r_4_1_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (forall ((x_9_2@@2 T@Ref) (x_9_3 T@Ref) ) (!  (=> (and (and (not (= x_9_2@@2 x_9_3)) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_9_2@@2 x_9_3)))
 :qid |stdinbpl.1328:17|
 :skolemid |135|
 :pattern ( (neverTriggered10 x_9_2@@2) (neverTriggered10 x_9_3))
))) (=> (forall ((x_9_2@@3 T@Ref) (x_9_3@@0 T@Ref) ) (!  (=> (and (and (not (= x_9_2@@3 x_9_3@@0)) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_9_2@@3 x_9_3@@0)))
 :qid |stdinbpl.1328:17|
 :skolemid |135|
 :pattern ( (neverTriggered10 x_9_2@@3) (neverTriggered10 x_9_3@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (forall ((x_9_2@@4 T@Ref) ) (! (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 x_9_2@@4)) NoPerm)
 :qid |stdinbpl.1335:17|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_9_2@@4)))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 x_9_2@@4)))
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_9_2@@4)))
))) (=> (forall ((x_9_2@@5 T@Ref) ) (! (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 x_9_2@@5)) NoPerm)
 :qid |stdinbpl.1335:17|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_9_2@@5)))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 x_9_2@@5)))
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_9_2@@5)))
)) (=> (and (and (forall ((x_9_2@@6 T@Ref) ) (!  (=> (< NoPerm wildcard@1) (and (= (invRecv10 x_9_2@@6) x_9_2@@6) (qpRange10 x_9_2@@6)))
 :qid |stdinbpl.1341:22|
 :skolemid |137|
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_9_2@@6)))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 x_9_2@@6)))
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_9_2@@6)))
)) (forall ((r_4_1_1@@1 T@Ref) ) (!  (=> (and (< NoPerm wildcard@1) (qpRange10 r_4_1_1@@1)) (= (invRecv10 r_4_1_1@@1) r_4_1_1@@1))
 :qid |stdinbpl.1345:22|
 :skolemid |138|
 :pattern ( (invRecv10 r_4_1_1@@1))
))) (and (forall ((r_4_1_1@@2 T@Ref) ) (!  (=> (and (< NoPerm wildcard@1) (qpRange10 r_4_1_1@@2)) (and (= (invRecv10 r_4_1_1@@2) r_4_1_1@@2) (= (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) null (pred_3 r_4_1_1@@2)) (- (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 r_4_1_1@@2)) wildcard@1))))
 :qid |stdinbpl.1351:22|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) null (pred_3 r_4_1_1@@2)))
)) (forall ((r_4_1_1@@3 T@Ref) ) (!  (=> (not (and (< NoPerm wildcard@1) (qpRange10 r_4_1_1@@3))) (= (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) null (pred_3 r_4_1_1@@3)) (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 r_4_1_1@@3))))
 :qid |stdinbpl.1355:22|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) null (pred_3 r_4_1_1@@3)))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@9 T@Ref) (f_5@@9 T@Field_24421_3562) ) (!  (=> (or (or (not (= o_4@@9 null)) (not (IsPredicateField_11750_3562 f_5@@9))) (not (= (getPredWandId_11750_3562 f_5@@9) 0))) (= (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@0) o_4@@9 f_5@@9) (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@1) o_4@@9 f_5@@9)))
 :qid |stdinbpl.1361:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@0) o_4@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@1) o_4@@9 f_5@@9))
)) (forall ((o_4@@10 T@Ref) (f_5@@10 T@Field_18308_24469) ) (!  (=> (or (or (not (= o_4@@10 null)) (not (IsPredicateField_18308_57773 f_5@@10))) (not (= (getPredWandId_11750_11754 f_5@@10) 0))) (= (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| QPMask@0) o_4@@10 f_5@@10) (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| QPMask@1) o_4@@10 f_5@@10)))
 :qid |stdinbpl.1361:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| QPMask@0) o_4@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| QPMask@1) o_4@@10 f_5@@10))
))) (forall ((o_4@@11 T@Ref) (f_5@@11 T@Field_18308_53) ) (!  (=> (or (or (not (= o_4@@11 null)) (not (IsPredicateField_11750_53 f_5@@11))) (not (= (getPredWandId_11750_53 f_5@@11) 0))) (= (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| QPMask@0) o_4@@11 f_5@@11) (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| QPMask@1) o_4@@11 f_5@@11)))
 :qid |stdinbpl.1361:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| QPMask@0) o_4@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| QPMask@1) o_4@@11 f_5@@11))
))) (forall ((o_4@@12 T@Ref) (f_5@@12 T@Field_18321_18322) ) (!  (=> (or (or (not (= o_4@@12 null)) (not (IsPredicateField_11750_18322 f_5@@12))) (not (= (getPredWandId_11750_18322 f_5@@12) 0))) (= (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| QPMask@0) o_4@@12 f_5@@12) (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| QPMask@1) o_4@@12 f_5@@12)))
 :qid |stdinbpl.1361:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| QPMask@0) o_4@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| QPMask@1) o_4@@12 f_5@@12))
))) (forall ((o_4@@13 T@Ref) (f_5@@13 T@Field_18308_24486) ) (!  (=> (or (or (not (= o_4@@13 null)) (not (IsPredicateField_11750_67571 f_5@@13))) (not (= (getPredWandId_11750_79705 f_5@@13) 0))) (= (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| QPMask@0) o_4@@13 f_5@@13) (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| QPMask@1) o_4@@13 f_5@@13)))
 :qid |stdinbpl.1361:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| QPMask@0) o_4@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| QPMask@1) o_4@@13 f_5@@13))
))) (forall ((o_4@@14 T@Ref) (f_5@@14 T@Field_24468_3562) ) (!  (=> (or (or (not (= o_4@@14 null)) (not (IsPredicateField_11753_3562 f_5@@14))) (not (= (getPredWandId_11753_3562 f_5@@14) 0))) (= (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| QPMask@0) o_4@@14 f_5@@14) (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| QPMask@1) o_4@@14 f_5@@14)))
 :qid |stdinbpl.1361:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| QPMask@0) o_4@@14 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| QPMask@1) o_4@@14 f_5@@14))
))) (forall ((o_4@@15 T@Ref) (f_5@@15 T@Field_24468_24469) ) (!  (=> (or (or (not (= o_4@@15 null)) (not (IsPredicateField_11753_11754 f_5@@15))) (not (= (getPredWandId_11753_11754 f_5@@15) 0))) (= (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) o_4@@15 f_5@@15) (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) o_4@@15 f_5@@15)))
 :qid |stdinbpl.1361:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) o_4@@15 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) o_4@@15 f_5@@15))
))) (forall ((o_4@@16 T@Ref) (f_5@@16 T@Field_24468_53) ) (!  (=> (or (or (not (= o_4@@16 null)) (not (IsPredicateField_11753_53 f_5@@16))) (not (= (getPredWandId_11753_53 f_5@@16) 0))) (= (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| QPMask@0) o_4@@16 f_5@@16) (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| QPMask@1) o_4@@16 f_5@@16)))
 :qid |stdinbpl.1361:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| QPMask@0) o_4@@16 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| QPMask@1) o_4@@16 f_5@@16))
))) (forall ((o_4@@17 T@Ref) (f_5@@17 T@Field_24468_18322) ) (!  (=> (or (or (not (= o_4@@17 null)) (not (IsPredicateField_11753_18322 f_5@@17))) (not (= (getPredWandId_11753_18322 f_5@@17) 0))) (= (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| QPMask@0) o_4@@17 f_5@@17) (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| QPMask@1) o_4@@17 f_5@@17)))
 :qid |stdinbpl.1361:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| QPMask@0) o_4@@17 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| QPMask@1) o_4@@17 f_5@@17))
))) (forall ((o_4@@18 T@Ref) (f_5@@18 T@Field_24481_24486) ) (!  (=> (or (or (not (= o_4@@18 null)) (not (IsPredicateField_11753_68402 f_5@@18))) (not (= (getPredWandId_11753_80514 f_5@@18) 0))) (= (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| QPMask@0) o_4@@18 f_5@@18) (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| QPMask@1) o_4@@18 f_5@@18)))
 :qid |stdinbpl.1361:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| QPMask@0) o_4@@18 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| QPMask@1) o_4@@18 f_5@@18))
))) (> wildcard@2 0.0)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_10_1 T@Ref) ) (! (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) null (pred_3 x_10_1)) NoPerm)
 :qid |stdinbpl.1370:15|
 :skolemid |142|
))) (=> (forall ((x_10_1@@0 T@Ref) ) (! (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) null (pred_3 x_10_1@@0)) NoPerm)
 :qid |stdinbpl.1370:15|
 :skolemid |142|
)) (=> (forall ((x_10_1@@1 T@Ref) ) (! (< wildcard@2 (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) null (pred_3 x_10_1@@1)))
 :qid |stdinbpl.1374:20|
 :skolemid |143|
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((r_5_1_1 T@Ref) ) (!  (=> (qpRange11 r_5_1_1) (>= wildcard@2 NoPerm))
 :qid |stdinbpl.1381:17|
 :skolemid |144|
 :pattern ( (invRecv11 r_5_1_1))
))) (=> (forall ((r_5_1_1@@0 T@Ref) ) (!  (=> (qpRange11 r_5_1_1@@0) (>= wildcard@2 NoPerm))
 :qid |stdinbpl.1381:17|
 :skolemid |144|
 :pattern ( (invRecv11 r_5_1_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_10_1@@2 T@Ref) (x_10_2 T@Ref) ) (!  (=> (and (and (not (= x_10_1@@2 x_10_2)) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= x_10_1@@2 x_10_2)))
 :qid |stdinbpl.1388:17|
 :skolemid |145|
 :pattern ( (neverTriggered11 x_10_1@@2) (neverTriggered11 x_10_2))
))) (=> (forall ((x_10_1@@3 T@Ref) (x_10_2@@0 T@Ref) ) (!  (=> (and (and (not (= x_10_1@@3 x_10_2@@0)) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= x_10_1@@3 x_10_2@@0)))
 :qid |stdinbpl.1388:17|
 :skolemid |145|
 :pattern ( (neverTriggered11 x_10_1@@3) (neverTriggered11 x_10_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_10_1@@4 T@Ref) ) (! (> (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) null (pred_3 x_10_1@@4)) NoPerm)
 :qid |stdinbpl.1395:17|
 :skolemid |146|
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_10_1@@4)))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@1) null (pred_3 x_10_1@@4)))
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_10_1@@4)))
))))))))))))))))))))))))
(let ((anon9_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (not (= x_1 x_1_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.1169:17|
 :skolemid |114|
 :pattern ( (neverTriggered7 x_1) (neverTriggered7 x_1_1))
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (not (= x_1@@0 x_1_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.1169:17|
 :skolemid |114|
 :pattern ( (neverTriggered7 x_1@@0) (neverTriggered7 x_1_1@@0))
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (< NoPerm wildcard@0) (and (= (invRecv7 x_1@@1) x_1@@1) (qpRange7 x_1@@1)))
 :qid |stdinbpl.1175:22|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_1@@1)))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 x_1@@1)))
 :pattern ( (select (|PolymorphicMapType_18248_11753_11754#PolymorphicMapType_18248| Heap@@32) null (pred_3 x_1@@1)))
)) (=> (and (forall ((r_1_1_1 T@Ref) ) (!  (=> (and (< NoPerm wildcard@0) (qpRange7 r_1_1_1)) (= (invRecv7 r_1_1_1) r_1_1_1))
 :qid |stdinbpl.1179:22|
 :skolemid |116|
 :pattern ( (invRecv7 r_1_1_1))
)) (forall ((r_1_1_1@@0 T@Ref) ) (!  (=> (and (< NoPerm wildcard@0) (qpRange7 r_1_1_1@@0)) (and (=> (< NoPerm wildcard@0) (= (invRecv7 r_1_1_1@@0) r_1_1_1@@0)) (= (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 r_1_1_1@@0)) (+ (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 r_1_1_1@@0)) wildcard@0))))
 :qid |stdinbpl.1185:22|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 r_1_1_1@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@19 T@Ref) (f_5@@19 T@Field_24421_3562) ) (!  (=> (or (or (not (= o_4@@19 null)) (not (IsPredicateField_11750_3562 f_5@@19))) (not (= (getPredWandId_11750_3562 f_5@@19) 0))) (= (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| ZeroMask) o_4@@19 f_5@@19) (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@0) o_4@@19 f_5@@19)))
 :qid |stdinbpl.1191:29|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| ZeroMask) o_4@@19 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_18269_11750_3562#PolymorphicMapType_18269| QPMask@0) o_4@@19 f_5@@19))
)) (forall ((o_4@@20 T@Ref) (f_5@@20 T@Field_18308_24469) ) (!  (=> (or (or (not (= o_4@@20 null)) (not (IsPredicateField_18308_57773 f_5@@20))) (not (= (getPredWandId_11750_11754 f_5@@20) 0))) (= (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| ZeroMask) o_4@@20 f_5@@20) (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| QPMask@0) o_4@@20 f_5@@20)))
 :qid |stdinbpl.1191:29|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| ZeroMask) o_4@@20 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_18269_11750_11754#PolymorphicMapType_18269| QPMask@0) o_4@@20 f_5@@20))
))) (forall ((o_4@@21 T@Ref) (f_5@@21 T@Field_18308_53) ) (!  (=> (or (or (not (= o_4@@21 null)) (not (IsPredicateField_11750_53 f_5@@21))) (not (= (getPredWandId_11750_53 f_5@@21) 0))) (= (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| ZeroMask) o_4@@21 f_5@@21) (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| QPMask@0) o_4@@21 f_5@@21)))
 :qid |stdinbpl.1191:29|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| ZeroMask) o_4@@21 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_18269_11750_53#PolymorphicMapType_18269| QPMask@0) o_4@@21 f_5@@21))
))) (forall ((o_4@@22 T@Ref) (f_5@@22 T@Field_18321_18322) ) (!  (=> (or (or (not (= o_4@@22 null)) (not (IsPredicateField_11750_18322 f_5@@22))) (not (= (getPredWandId_11750_18322 f_5@@22) 0))) (= (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| ZeroMask) o_4@@22 f_5@@22) (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| QPMask@0) o_4@@22 f_5@@22)))
 :qid |stdinbpl.1191:29|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| ZeroMask) o_4@@22 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_18269_11750_18322#PolymorphicMapType_18269| QPMask@0) o_4@@22 f_5@@22))
))) (forall ((o_4@@23 T@Ref) (f_5@@23 T@Field_18308_24486) ) (!  (=> (or (or (not (= o_4@@23 null)) (not (IsPredicateField_11750_67571 f_5@@23))) (not (= (getPredWandId_11750_79705 f_5@@23) 0))) (= (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| ZeroMask) o_4@@23 f_5@@23) (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| QPMask@0) o_4@@23 f_5@@23)))
 :qid |stdinbpl.1191:29|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| ZeroMask) o_4@@23 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_18269_11750_65699#PolymorphicMapType_18269| QPMask@0) o_4@@23 f_5@@23))
))) (forall ((o_4@@24 T@Ref) (f_5@@24 T@Field_24468_3562) ) (!  (=> (or (or (not (= o_4@@24 null)) (not (IsPredicateField_11753_3562 f_5@@24))) (not (= (getPredWandId_11753_3562 f_5@@24) 0))) (= (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| ZeroMask) o_4@@24 f_5@@24) (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| QPMask@0) o_4@@24 f_5@@24)))
 :qid |stdinbpl.1191:29|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| ZeroMask) o_4@@24 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_18269_11753_3562#PolymorphicMapType_18269| QPMask@0) o_4@@24 f_5@@24))
))) (forall ((o_4@@25 T@Ref) (f_5@@25 T@Field_24468_24469) ) (!  (=> (or (or (not (= o_4@@25 null)) (not (IsPredicateField_11753_11754 f_5@@25))) (not (= (getPredWandId_11753_11754 f_5@@25) 0))) (= (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) o_4@@25 f_5@@25) (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) o_4@@25 f_5@@25)))
 :qid |stdinbpl.1191:29|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) o_4@@25 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) o_4@@25 f_5@@25))
))) (forall ((o_4@@26 T@Ref) (f_5@@26 T@Field_24468_53) ) (!  (=> (or (or (not (= o_4@@26 null)) (not (IsPredicateField_11753_53 f_5@@26))) (not (= (getPredWandId_11753_53 f_5@@26) 0))) (= (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| ZeroMask) o_4@@26 f_5@@26) (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| QPMask@0) o_4@@26 f_5@@26)))
 :qid |stdinbpl.1191:29|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| ZeroMask) o_4@@26 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_18269_11753_53#PolymorphicMapType_18269| QPMask@0) o_4@@26 f_5@@26))
))) (forall ((o_4@@27 T@Ref) (f_5@@27 T@Field_24468_18322) ) (!  (=> (or (or (not (= o_4@@27 null)) (not (IsPredicateField_11753_18322 f_5@@27))) (not (= (getPredWandId_11753_18322 f_5@@27) 0))) (= (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| ZeroMask) o_4@@27 f_5@@27) (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| QPMask@0) o_4@@27 f_5@@27)))
 :qid |stdinbpl.1191:29|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| ZeroMask) o_4@@27 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_18269_11753_18322#PolymorphicMapType_18269| QPMask@0) o_4@@27 f_5@@27))
))) (forall ((o_4@@28 T@Ref) (f_5@@28 T@Field_24481_24486) ) (!  (=> (or (or (not (= o_4@@28 null)) (not (IsPredicateField_11753_68402 f_5@@28))) (not (= (getPredWandId_11753_80514 f_5@@28) 0))) (= (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| ZeroMask) o_4@@28 f_5@@28) (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| QPMask@0) o_4@@28 f_5@@28)))
 :qid |stdinbpl.1191:29|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| ZeroMask) o_4@@28 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_18269_11753_66110#PolymorphicMapType_18269| QPMask@0) o_4@@28 f_5@@28))
))) (forall ((r_1_1_1@@1 T@Ref) ) (!  (=> (not (and (< NoPerm wildcard@0) (qpRange7 r_1_1_1@@1))) (= (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 r_1_1_1@@1)) (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| ZeroMask) null (pred_3 r_1_1_1@@1))))
 :qid |stdinbpl.1195:22|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_18269_11753_11754#PolymorphicMapType_18269| QPMask@0) null (pred_3 r_1_1_1@@1)))
