...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_11873_7053_53#PolymorphicMapType_11873| Heap@@47) y@@1 $allocated)) (and (|Seq#Contains_7352| xs y@@1) (state Heap@@47 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Contains_7352| xs y@@1)) (=> (|Seq#Contains_7352| xs y@@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x@@5 T@Ref) (x_9 T@Ref) ) (!  (=> (and (and (and (and (not (= x@@5 x_9)) (|Seq#Contains_7352| xs x@@5)) (|Seq#Contains_7352| xs x_9)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@5 x_9)))
 :qid |stdinbpl.962:19|
 :skolemid |76|
 :pattern ( (neverTriggered2 x@@5) (neverTriggered2 x_9))
))) (=> (forall ((x@@6 T@Ref) (x_9@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x@@6 x_9@@0)) (|Seq#Contains_7352| xs x@@6)) (|Seq#Contains_7352| xs x_9@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@6 x_9@@0)))
 :qid |stdinbpl.962:19|
 :skolemid |76|
