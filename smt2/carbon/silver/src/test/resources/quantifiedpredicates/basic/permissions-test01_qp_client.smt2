...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_11873_7053_53#PolymorphicMapType_11873| Heap@@47) y@@1 $allocated)) (and (|Seq#Contains_7352| xs y@@1) (state Heap@@47 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Contains_7352| xs y@@1)) (=> (|Seq#Contains_7352| xs y@@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x@@5 T@Ref) (x_46 T@Ref) ) (!  (=> (and (and (and (and (not (= x@@5 x_46)) (|Seq#Contains_7352| xs x@@5)) (|Seq#Contains_7352| xs x_46)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@5 x_46)))
 :qid |stdinbpl.962:19|
 :skolemid |76|
 :pattern ( (neverTriggered2 x@@5) (neverTriggered2 x_46))
))) (=> (forall ((x@@6 T@Ref) (x_46@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x@@6 x_46@@0)) (|Seq#Contains_7352| xs x@@6)) (|Seq#Contains_7352| xs x_46@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@6 x_46@@0)))
 :qid |stdinbpl.962:19|
 :skolemid |76|
 :pattern ( (neverTriggered2 x@@6) (neverTriggered2 x_46@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x@@7 T@Ref) ) (!  (=> (|Seq#Contains_7352| xs x@@7) (>= (select (|PolymorphicMapType_11894_7270_7271#PolymorphicMapType_11894| ZeroMask) null (pred1 x@@7)) FullPerm))
 :qid |stdinbpl.969:19|
 :skolemid |77|
 :pattern ( (select (|PolymorphicMapType_11873_7270_7271#PolymorphicMapType_11873| Heap@@47) null (pred1 x@@7)))
 :pattern ( (select (|PolymorphicMapType_11894_7270_7271#PolymorphicMapType_11894| ZeroMask) null (pred1 x@@7)))
 :pattern ( (|Seq#ContainsTrigger_7352| xs x@@7))
 :pattern ( (|Seq#Contains_7352| xs x@@7))
)))))))))))
