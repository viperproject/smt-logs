...
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_3@@1 T@Ref) ) (!  (=> (|Seq#Contains_5792| xs x_3@@1) (>= (select (|PolymorphicMapType_8704_5765_5766#PolymorphicMapType_8704| Mask@0) null (pred2 y@@1 1)) FullPerm))
 :qid |stdinbpl.928:17|
 :skolemid |90|
 :pattern ( (|Seq#ContainsTrigger_5792| xs x_3@@1))
 :pattern ( (|Seq#Contains_5792| xs x_3@@1))
)))))))
(let ((anon0_correct  (=> (and (state Heap@@47 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_8683_5529_53#PolymorphicMapType_8683| Heap@@47) y@@1 $allocated) (= Mask@0 (PolymorphicMapType_8704 (|PolymorphicMapType_8704_5737_3130#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5740_5741#PolymorphicMapType_8704| ZeroMask) (store (|PolymorphicMapType_8704_5765_5766#PolymorphicMapType_8704| ZeroMask) null (pred2 y@@1 1) (+ (select (|PolymorphicMapType_8704_5765_5766#PolymorphicMapType_8704| ZeroMask) null (pred2 y@@1 1)) FullPerm)) (|PolymorphicMapType_8704_5737_5741#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5737_53#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5737_8757#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5737_38770#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5740_3130#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5740_53#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5740_8757#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5740_39181#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5765_3130#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5765_53#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5765_8757#PolymorphicMapType_8704| ZeroMask) (|PolymorphicMapType_8704_5765_39592#PolymorphicMapType_8704| ZeroMask)))) (and (state Heap@@47 Mask@0) (state Heap@@47 Mask@0))) (and (=> (= (ControlFlow 0 8) 7) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct))))))
