...
(declare-fun ix_26 () Int)
(declare-fun jx_26 () Int)
...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3032| (|Seq#Range| 1 (+ (|Seq#Length_9242| xs) 1)) i_11)) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3032| (|Seq#Range| 1 (+ (|Seq#Length_9242| xs) 1)) i_11) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= (- i_11 1) 0)) (=> (>= (- i_11 1) 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< (- i_11 1) (|Seq#Length_9242| xs))) (=> (< (- i_11 1) (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
...
(let ((anon10_Else_correct  (=> (and (not (and (>= ix_26 0) (and (< ix_26 (|Seq#Length_9242| xs)) (and (>= jx_26 0) (and (< jx_26 (|Seq#Length_9242| xs)) (not (= ix_26 jx_26))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= ix_26 0) (and (< ix_26 (|Seq#Length_9242| xs)) (and (>= jx_26 0) (and (< jx_26 (|Seq#Length_9242| xs)) (not (= ix_26 jx_26)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_26 0)) (=> (>= ix_26 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_26 (|Seq#Length_9242| xs))) (=> (< ix_26 (|Seq#Length_9242| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_26 0)) (=> (>= jx_26 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_26 (|Seq#Length_9242| xs))) (=> (< jx_26 (|Seq#Length_9242| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
