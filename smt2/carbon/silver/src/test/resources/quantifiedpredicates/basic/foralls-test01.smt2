...
(declare-fun ys () T@Seq_23340)
(declare-fun i_4 () Int)
(declare-fun neverTriggered2 (Int) Bool)
(declare-fun Heap@@32 () T@PolymorphicMapType_13438)
(declare-fun QPMask@0 () T@PolymorphicMapType_13459)
(declare-fun ix_25 () Int)
(declare-fun jx_25 () Int)
(declare-fun neverTriggered1 (T@Ref) Bool)
(declare-fun xs () (Array T@Ref Bool))
(declare-fun invRecv1 (T@Ref) T@Ref)
(declare-fun qpRange1 (T@Ref) Bool)
(declare-fun getPredWandId_9207_5155 (T@Field_22373_5155) Int)
(declare-fun getPredWandId_9207_9211 (T@Field_13498_22421) Int)
(declare-fun getPredWandId_9207_53 (T@Field_13498_53) Int)
(declare-fun getPredWandId_9207_13512 (T@Field_13511_13512) Int)
(declare-fun getPredWandId_9207_58831 (T@Field_13498_22438) Int)
(declare-fun getPredWandId_9210_5155 (T@Field_22420_5155) Int)
(declare-fun getPredWandId_9210_53 (T@Field_22420_53) Int)
(declare-fun getPredWandId_9210_13512 (T@Field_22420_13512) Int)
(declare-fun getPredWandId_9210_59640 (T@Field_22433_22438) Int)
...
(let ((anon15_Else_correct  (=> (and (not (|Seq#Contains_3032| (|Seq#Range| 0 (|Seq#Length_9242| ys)) i_4)) (= (ControlFlow 0 15) 11)) anon9_correct)))
(let ((anon15_Then_correct  (=> (|Seq#Contains_3032| (|Seq#Range| 0 (|Seq#Length_9242| ys)) i_4) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i_4 (|Seq#Length_9242| ys))) (=> (< i_4 (|Seq#Length_9242| ys)) (=> (= (ControlFlow 0 12) 11) anon9_correct))))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3032| (|Seq#Range| 0 (|Seq#Length_9242| ys)) i_1)) (|Seq#Contains_3032| (|Seq#Range| 0 (|Seq#Length_9242| ys)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9242| ys i_1) (|Seq#Index_9242| ys i_1_1))))
 :qid |stdinbpl.923:17|
 :skolemid |131|
 :pattern ( (neverTriggered2 i_1) (neverTriggered2 i_1_1))
)))))
(let ((anon12_Else_correct  (=> (and (forall ((ix_1 Int) (jx_1 Int) ) (!  (=> (and (>= ix_1 0) (and (< ix_1 (|Seq#Length_9242| ys)) (and (>= jx_1 0) (and (< jx_1 (|Seq#Length_9242| ys)) (not (= ix_1 jx_1)))))) (not (= (|Seq#Index_9242| ys ix_1) (|Seq#Index_9242| ys jx_1))))
 :qid |stdinbpl.903:20|
 :skolemid |130|
 :pattern ( (|Seq#Index_9242| ys ix_1) (|Seq#Index_9242| ys jx_1))
)) (state Heap@@32 QPMask@0)) (and (and (=> (= (ControlFlow 0 16) 10) anon14_Else_correct) (=> (= (ControlFlow 0 16) 12) anon15_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (and (>= ix_25 0) (and (< ix_25 (|Seq#Length_9242| ys)) (and (>= jx_25 0) (and (< jx_25 (|Seq#Length_9242| ys)) (not (= ix_25 jx_25))))))) (= (ControlFlow 0 8) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (and (>= ix_25 0) (and (< ix_25 (|Seq#Length_9242| ys)) (and (>= jx_25 0) (and (< jx_25 (|Seq#Length_9242| ys)) (not (= ix_25 jx_25)))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (>= ix_25 0)) (=> (>= ix_25 0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< ix_25 (|Seq#Length_9242| ys))) (=> (< ix_25 (|Seq#Length_9242| ys)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= jx_25 0)) (=> (>= jx_25 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< jx_25 (|Seq#Length_9242| ys))) (=> (< jx_25 (|Seq#Length_9242| ys)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs x_1)) (select xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.861:22|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_13438_9210_9211#PolymorphicMapType_13438| Heap@@32) null (h x_1@@1)))
 :pattern ( (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| ZeroMask) null (h x_1@@1)))
 :pattern ( (select xs x_1@@1))
)) (=> (and (forall ((a_2@@5 T@Ref) ) (!  (=> (and (and (select xs (invRecv1 a_2@@5)) (< NoPerm FullPerm)) (qpRange1 a_2@@5)) (= (invRecv1 a_2@@5) a_2@@5))
 :qid |stdinbpl.865:22|
 :skolemid |126|
 :pattern ( (invRecv1 a_2@@5))
)) (forall ((a_2@@6 T@Ref) ) (!  (=> (and (and (select xs (invRecv1 a_2@@6)) (< NoPerm FullPerm)) (qpRange1 a_2@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 a_2@@6) a_2@@6)) (= (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| QPMask@0) null (h a_2@@6)) (+ (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| ZeroMask) null (h a_2@@6)) FullPerm))))
 :qid |stdinbpl.871:22|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| QPMask@0) null (h a_2@@6)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_22373_5155) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_9207_5155 f_5))) (not (= (getPredWandId_9207_5155 f_5) 0))) (= (select (|PolymorphicMapType_13459_9207_5155#PolymorphicMapType_13459| ZeroMask) o_9 f_5) (select (|PolymorphicMapType_13459_9207_5155#PolymorphicMapType_13459| QPMask@0) o_9 f_5)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9207_5155#PolymorphicMapType_13459| ZeroMask) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_13459_9207_5155#PolymorphicMapType_13459| QPMask@0) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_13498_22421) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsPredicateField_13498_36428 f_5@@0))) (not (= (getPredWandId_9207_9211 f_5@@0) 0))) (= (select (|PolymorphicMapType_13459_9207_9211#PolymorphicMapType_13459| ZeroMask) o_9@@0 f_5@@0) (select (|PolymorphicMapType_13459_9207_9211#PolymorphicMapType_13459| QPMask@0) o_9@@0 f_5@@0)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9207_9211#PolymorphicMapType_13459| ZeroMask) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_13459_9207_9211#PolymorphicMapType_13459| QPMask@0) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_13498_53) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_9207_53 f_5@@1))) (not (= (getPredWandId_9207_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_13459_9207_53#PolymorphicMapType_13459| ZeroMask) o_9@@1 f_5@@1) (select (|PolymorphicMapType_13459_9207_53#PolymorphicMapType_13459| QPMask@0) o_9@@1 f_5@@1)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9207_53#PolymorphicMapType_13459| ZeroMask) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_13459_9207_53#PolymorphicMapType_13459| QPMask@0) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_13511_13512) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_9207_13512 f_5@@2))) (not (= (getPredWandId_9207_13512 f_5@@2) 0))) (= (select (|PolymorphicMapType_13459_9207_13512#PolymorphicMapType_13459| ZeroMask) o_9@@2 f_5@@2) (select (|PolymorphicMapType_13459_9207_13512#PolymorphicMapType_13459| QPMask@0) o_9@@2 f_5@@2)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9207_13512#PolymorphicMapType_13459| ZeroMask) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_13459_9207_13512#PolymorphicMapType_13459| QPMask@0) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_13498_22438) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_9207_46226 f_5@@3))) (not (= (getPredWandId_9207_58831 f_5@@3) 0))) (= (select (|PolymorphicMapType_13459_9207_44354#PolymorphicMapType_13459| ZeroMask) o_9@@3 f_5@@3) (select (|PolymorphicMapType_13459_9207_44354#PolymorphicMapType_13459| QPMask@0) o_9@@3 f_5@@3)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9207_44354#PolymorphicMapType_13459| ZeroMask) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_13459_9207_44354#PolymorphicMapType_13459| QPMask@0) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_22420_5155) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsPredicateField_9210_5155 f_5@@4))) (not (= (getPredWandId_9210_5155 f_5@@4) 0))) (= (select (|PolymorphicMapType_13459_9210_5155#PolymorphicMapType_13459| ZeroMask) o_9@@4 f_5@@4) (select (|PolymorphicMapType_13459_9210_5155#PolymorphicMapType_13459| QPMask@0) o_9@@4 f_5@@4)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9210_5155#PolymorphicMapType_13459| ZeroMask) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_13459_9210_5155#PolymorphicMapType_13459| QPMask@0) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_22420_22421) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_9210_9211 f_5@@5))) (not (= (getPredWandId_9210_9211 f_5@@5) 0))) (= (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| ZeroMask) o_9@@5 f_5@@5) (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| QPMask@0) o_9@@5 f_5@@5)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| ZeroMask) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| QPMask@0) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_22420_53) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_9210_53 f_5@@6))) (not (= (getPredWandId_9210_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_13459_9210_53#PolymorphicMapType_13459| ZeroMask) o_9@@6 f_5@@6) (select (|PolymorphicMapType_13459_9210_53#PolymorphicMapType_13459| QPMask@0) o_9@@6 f_5@@6)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9210_53#PolymorphicMapType_13459| ZeroMask) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_13459_9210_53#PolymorphicMapType_13459| QPMask@0) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_22420_13512) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_9210_13512 f_5@@7))) (not (= (getPredWandId_9210_13512 f_5@@7) 0))) (= (select (|PolymorphicMapType_13459_9210_13512#PolymorphicMapType_13459| ZeroMask) o_9@@7 f_5@@7) (select (|PolymorphicMapType_13459_9210_13512#PolymorphicMapType_13459| QPMask@0) o_9@@7 f_5@@7)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9210_13512#PolymorphicMapType_13459| ZeroMask) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_13459_9210_13512#PolymorphicMapType_13459| QPMask@0) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_22433_22438) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_9210_47057 f_5@@8))) (not (= (getPredWandId_9210_59640 f_5@@8) 0))) (= (select (|PolymorphicMapType_13459_9210_44765#PolymorphicMapType_13459| ZeroMask) o_9@@8 f_5@@8) (select (|PolymorphicMapType_13459_9210_44765#PolymorphicMapType_13459| QPMask@0) o_9@@8 f_5@@8)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9210_44765#PolymorphicMapType_13459| ZeroMask) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_13459_9210_44765#PolymorphicMapType_13459| QPMask@0) o_9@@8 f_5@@8))
))) (forall ((a_2@@7 T@Ref) ) (!  (=> (not (and (and (select xs (invRecv1 a_2@@7)) (< NoPerm FullPerm)) (qpRange1 a_2@@7))) (= (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| QPMask@0) null (h a_2@@7)) (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| ZeroMask) null (h a_2@@7))))
 :qid |stdinbpl.881:22|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| QPMask@0) null (h a_2@@7)))
))) (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0))) (and (and (=> (= (ControlFlow 0 17) 16) anon12_Else_correct) (=> (= (ControlFlow 0 17) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 17) 8) anon13_Else_correct)))))))))
