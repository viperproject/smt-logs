...
(declare-fun ix_28 () Int)
(declare-fun jx_28 () Int)
...
(let ((anon13_Else_correct  (=> (and (not (and (>= ix_28 0) (and (< ix_28 (|Seq#Length_9242| ys)) (and (>= jx_28 0) (and (< jx_28 (|Seq#Length_9242| ys)) (not (= ix_28 jx_28))))))) (= (ControlFlow 0 8) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (and (>= ix_28 0) (and (< ix_28 (|Seq#Length_9242| ys)) (and (>= jx_28 0) (and (< jx_28 (|Seq#Length_9242| ys)) (not (= ix_28 jx_28)))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (>= ix_28 0)) (=> (>= ix_28 0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< ix_28 (|Seq#Length_9242| ys))) (=> (< ix_28 (|Seq#Length_9242| ys)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= jx_28 0)) (=> (>= jx_28 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< jx_28 (|Seq#Length_9242| ys))) (=> (< jx_28 (|Seq#Length_9242| ys)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))))))
...
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_22373_5155) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_9207_5155 f_5))) (not (= (getPredWandId_9207_5155 f_5) 0))) (= (select (|PolymorphicMapType_13459_9207_5155#PolymorphicMapType_13459| ZeroMask) o_4 f_5) (select (|PolymorphicMapType_13459_9207_5155#PolymorphicMapType_13459| QPMask@0) o_4 f_5)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9207_5155#PolymorphicMapType_13459| ZeroMask) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_13459_9207_5155#PolymorphicMapType_13459| QPMask@0) o_4 f_5))
)) (forall ((o_4@@0 T@Ref) (f_5@@0 T@Field_13498_22421) ) (!  (=> (or (or (not (= o_4@@0 null)) (not (IsPredicateField_13498_36428 f_5@@0))) (not (= (getPredWandId_9207_9211 f_5@@0) 0))) (= (select (|PolymorphicMapType_13459_9207_9211#PolymorphicMapType_13459| ZeroMask) o_4@@0 f_5@@0) (select (|PolymorphicMapType_13459_9207_9211#PolymorphicMapType_13459| QPMask@0) o_4@@0 f_5@@0)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9207_9211#PolymorphicMapType_13459| ZeroMask) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_13459_9207_9211#PolymorphicMapType_13459| QPMask@0) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_13498_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_9207_53 f_5@@1))) (not (= (getPredWandId_9207_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_13459_9207_53#PolymorphicMapType_13459| ZeroMask) o_4@@1 f_5@@1) (select (|PolymorphicMapType_13459_9207_53#PolymorphicMapType_13459| QPMask@0) o_4@@1 f_5@@1)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9207_53#PolymorphicMapType_13459| ZeroMask) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_13459_9207_53#PolymorphicMapType_13459| QPMask@0) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_13511_13512) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_9207_13512 f_5@@2))) (not (= (getPredWandId_9207_13512 f_5@@2) 0))) (= (select (|PolymorphicMapType_13459_9207_13512#PolymorphicMapType_13459| ZeroMask) o_4@@2 f_5@@2) (select (|PolymorphicMapType_13459_9207_13512#PolymorphicMapType_13459| QPMask@0) o_4@@2 f_5@@2)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9207_13512#PolymorphicMapType_13459| ZeroMask) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_13459_9207_13512#PolymorphicMapType_13459| QPMask@0) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_13498_22438) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsPredicateField_9207_46226 f_5@@3))) (not (= (getPredWandId_9207_58831 f_5@@3) 0))) (= (select (|PolymorphicMapType_13459_9207_44354#PolymorphicMapType_13459| ZeroMask) o_4@@3 f_5@@3) (select (|PolymorphicMapType_13459_9207_44354#PolymorphicMapType_13459| QPMask@0) o_4@@3 f_5@@3)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9207_44354#PolymorphicMapType_13459| ZeroMask) o_4@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_13459_9207_44354#PolymorphicMapType_13459| QPMask@0) o_4@@3 f_5@@3))
))) (forall ((o_4@@4 T@Ref) (f_5@@4 T@Field_22420_5155) ) (!  (=> (or (or (not (= o_4@@4 null)) (not (IsPredicateField_9210_5155 f_5@@4))) (not (= (getPredWandId_9210_5155 f_5@@4) 0))) (= (select (|PolymorphicMapType_13459_9210_5155#PolymorphicMapType_13459| ZeroMask) o_4@@4 f_5@@4) (select (|PolymorphicMapType_13459_9210_5155#PolymorphicMapType_13459| QPMask@0) o_4@@4 f_5@@4)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9210_5155#PolymorphicMapType_13459| ZeroMask) o_4@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_13459_9210_5155#PolymorphicMapType_13459| QPMask@0) o_4@@4 f_5@@4))
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_22420_22421) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_9210_9211 f_5@@5))) (not (= (getPredWandId_9210_9211 f_5@@5) 0))) (= (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| ZeroMask) o_4@@5 f_5@@5) (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| QPMask@0) o_4@@5 f_5@@5)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| ZeroMask) o_4@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_13459_9210_9211#PolymorphicMapType_13459| QPMask@0) o_4@@5 f_5@@5))
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_22420_53) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_9210_53 f_5@@6))) (not (= (getPredWandId_9210_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_13459_9210_53#PolymorphicMapType_13459| ZeroMask) o_4@@6 f_5@@6) (select (|PolymorphicMapType_13459_9210_53#PolymorphicMapType_13459| QPMask@0) o_4@@6 f_5@@6)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9210_53#PolymorphicMapType_13459| ZeroMask) o_4@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_13459_9210_53#PolymorphicMapType_13459| QPMask@0) o_4@@6 f_5@@6))
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_22420_13512) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsPredicateField_9210_13512 f_5@@7))) (not (= (getPredWandId_9210_13512 f_5@@7) 0))) (= (select (|PolymorphicMapType_13459_9210_13512#PolymorphicMapType_13459| ZeroMask) o_4@@7 f_5@@7) (select (|PolymorphicMapType_13459_9210_13512#PolymorphicMapType_13459| QPMask@0) o_4@@7 f_5@@7)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9210_13512#PolymorphicMapType_13459| ZeroMask) o_4@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_13459_9210_13512#PolymorphicMapType_13459| QPMask@0) o_4@@7 f_5@@7))
))) (forall ((o_4@@8 T@Ref) (f_5@@8 T@Field_22433_22438) ) (!  (=> (or (or (not (= o_4@@8 null)) (not (IsPredicateField_9210_47057 f_5@@8))) (not (= (getPredWandId_9210_59640 f_5@@8) 0))) (= (select (|PolymorphicMapType_13459_9210_44765#PolymorphicMapType_13459| ZeroMask) o_4@@8 f_5@@8) (select (|PolymorphicMapType_13459_9210_44765#PolymorphicMapType_13459| QPMask@0) o_4@@8 f_5@@8)))
 :qid |stdinbpl.877:29|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_13459_9210_44765#PolymorphicMapType_13459| ZeroMask) o_4@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_13459_9210_44765#PolymorphicMapType_13459| QPMask@0) o_4@@8 f_5@@8))
