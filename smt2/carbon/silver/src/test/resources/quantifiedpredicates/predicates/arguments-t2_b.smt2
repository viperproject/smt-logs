...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon13_Else_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select (|Set#UnionOne_20528| (|Set#Singleton_20528| x2) x1) x_3)) (select (|Set#UnionOne_20528| (|Set#Singleton_20528| x2) x1) x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
...
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_5@@1 T@Ref) ) (!  (=> (select (|Set#UnionOne_20528| (|Set#Singleton_20528| x2) x1) x_5@@1) (>= (select (|PolymorphicMapType_34728_20350_20351#PolymorphicMapType_34728| Mask@2) null (valid x_5@@1 true)) FullPerm))
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select (|Set#UnionOne_20528| (|Set#Singleton_20528| x2) x1) x_1)) (select (|Set#UnionOne_20528| (|Set#Singleton_20528| x2) x1) x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.2289:15|
 :skolemid |192|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_20528| (|Set#Singleton_20528| x2) x1) x_1@@1) (< NoPerm FullPerm)) (and (qpRange12 x_1@@1) (= (invRecv12 x_1@@1) x_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (|Set#UnionOne_20528| (|Set#Singleton_20528| x2) x1) (invRecv12 o_9)) (< NoPerm FullPerm)) (qpRange12 o_9)) (= (invRecv12 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (|Set#UnionOne_20528| (|Set#Singleton_20528| x2) x1) (invRecv12 o_9@@0)) (< NoPerm FullPerm)) (qpRange12 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv12 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| Mask@0) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select (|Set#UnionOne_20528| (|Set#Singleton_20528| x2) x1) (invRecv12 o_9@@0)) (< NoPerm FullPerm)) (qpRange12 o_9@@0))) (= (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| Mask@0) o_9@@0 f_7))))
...
(let ((anon0_correct  (=> (and (and (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_34707_19914_53#PolymorphicMapType_34707| Heap@@32) x1 $allocated) (select (|PolymorphicMapType_34707_19914_53#PolymorphicMapType_34707| Heap@@32) x2 $allocated))) (and (and (not (= x1 null)) (= Mask@0 (PolymorphicMapType_34728 (store (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| ZeroMask) x1 unrelatedField (+ (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| ZeroMask) x1 unrelatedField) FullPerm)) (|PolymorphicMapType_34728_20350_20351#PolymorphicMapType_34728| ZeroMask) (|PolymorphicMapType_34728_20343_20351#PolymorphicMapType_34728| ZeroMask) (|PolymorphicMapType_34728_20343_53#PolymorphicMapType_34728| ZeroMask) (|PolymorphicMapType_34728_20343_34781#PolymorphicMapType_34728| ZeroMask) (|PolymorphicMapType_34728_20343_117728#PolymorphicMapType_34728| ZeroMask) (|PolymorphicMapType_34728_20350_5587#PolymorphicMapType_34728| ZeroMask) (|PolymorphicMapType_34728_20350_53#PolymorphicMapType_34728| ZeroMask) (|PolymorphicMapType_34728_20350_34781#PolymorphicMapType_34728| ZeroMask) (|PolymorphicMapType_34728_20350_118139#PolymorphicMapType_34728| ZeroMask)))) (and (state Heap@@32 Mask@0) (state Heap@@32 Mask@0)))) (and (=> (= (ControlFlow 0 17) 1) anon11_Then_correct) (=> (= (ControlFlow 0 17) 15) anon11_Else_correct)))))
