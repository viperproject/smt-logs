...
)) (forall ((o_4@@9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_20388| xs (invRecv4 o_4@@9)) (< NoPerm FullPerm)) (qpRange4 o_4@@9)) (= (invRecv4 o_4@@9) o_4@@9))
 :qid |stdinbpl.1474:22|
 :skolemid |144|
 :pattern ( (invRecv4 o_4@@9))
...
)) (forall ((o_4@@10 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_20388| xs (invRecv4 o_4@@10)) (< NoPerm FullPerm)) (qpRange4 o_4@@10)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_4@@10) o_4@@10)) (= (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| QPMask@0) o_4@@10 unrelatedField) (+ (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| ZeroMask) o_4@@10 unrelatedField) FullPerm)))) (=> (not (and (and (|Seq#Contains_20388| xs (invRecv4 o_4@@10)) (< NoPerm FullPerm)) (qpRange4 o_4@@10))) (= (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| QPMask@0) o_4@@10 unrelatedField) (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| ZeroMask) o_4@@10 unrelatedField))))
