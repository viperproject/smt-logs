...
)) (forall ((o_9@@9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_20388| xs (invRecv2 o_9@@9)) (< NoPerm FullPerm)) (qpRange2 o_9@@9)) (= (invRecv2 o_9@@9) o_9@@9))
 :qid |stdinbpl.1214:22|
 :skolemid |132|
 :pattern ( (invRecv2 o_9@@9))
...
)) (forall ((o_9@@10 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_20388| xs (invRecv2 o_9@@10)) (< NoPerm FullPerm)) (qpRange2 o_9@@10)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@10) o_9@@10)) (= (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| QPMask@0) o_9@@10 unrelatedField) (+ (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| ZeroMask) o_9@@10 unrelatedField) FullPerm)))) (=> (not (and (and (|Seq#Contains_20388| xs (invRecv2 o_9@@10)) (< NoPerm FullPerm)) (qpRange2 o_9@@10))) (= (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| QPMask@0) o_9@@10 unrelatedField) (select (|PolymorphicMapType_34728_20343_5587#PolymorphicMapType_34728| ZeroMask) o_9@@10 unrelatedField))))
