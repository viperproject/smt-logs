...
(let ((anon26_Else_correct  (and (=> (= (ControlFlow 0 43) (- 0 44)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (|Seq#Contains_20388| xs x_4)) (|Seq#Contains_20388| xs x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_4 x_4_1)) (=  (not b_24@@5)  (not (not b_24@@5)))))
...
)) (=> (forall ((x_4@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_20388| xs x_4@@1) (< NoPerm FullPerm)) (and (= (invRecv16 x_4@@1  (not b_24@@5)) x_4@@1) (qpRange16 x_4@@1  (not b_24@@5))))
