...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (|Seq#Contains_20388| xs x_4)) (|Seq#Contains_20388| xs x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_4 x_4_1)) (=  (not b_24@@5)  (not (not b_24@@5)))))
...
)) (=> (forall ((x_4@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_20388| xs x_4@@1) (< NoPerm FullPerm)) (and (= (invRecv20 x_4@@1  (not b_24@@5)) x_4@@1) (qpRange20 x_4@@1  (not b_24@@5))))
