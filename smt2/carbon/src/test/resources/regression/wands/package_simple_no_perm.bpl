  ...
  modifies Heap, Mask;
{
  ...
  // } -- package_simple_no_perm.vpr@17.3--17.25
    ...
    assert {:msg "  Packaging wand might fail. Assertion false might not hold. (package_simple_no_perm.vpr@17.3--17.25) [618]"}
  ...
  modifies Heap, Mask;
{
  ...
  // } -- package_simple_no_perm.vpr@22.3--22.36
    ...
    assert {:msg "  Packaging wand might fail. Assertion x >= 2 might not hold. (package_simple_no_perm.vpr@22.3--22.36) [619]"}
      (b_4 && b_4) && b_5 ==> x >= 2;
    assert {:msg "  Packaging wand might fail. Assertion x >= 1 might not hold. (package_simple_no_perm.vpr@22.3--22.36) [620]"}
      (b_4 && b_4) && b_5 ==> x >= 1;
  ...
  // -- Translating statement: assert false -- package_simple_no_perm.vpr@25.3--25.15
    ...
    assert {:msg "  Assert might fail. Assertion false might not hold. (package_simple_no_perm.vpr@25.10--25.15) [621]"}
      false;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // } -- package_simple_no_perm.vpr@31.3--31.25
    ...
    assert {:msg "  Packaging wand might fail. Assertion false might not hold. (package_simple_no_perm.vpr@31.3--31.25) [622]"}
      (b_7 && b_7) && b_8 ==> false;
  ...
  // -- Translating statement: assert false -- package_simple_no_perm.vpr@34.3--34.15
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion false might not hold. (package_simple_no_perm.vpr@34.10--34.15) [623]"}
      false;
    assume state(Heap, Mask);
}