...
; Externals for module TypeclassDefinition


; <Start encoding type TypeclassDefinition.to_int_tc>

;;;;;;;;;;;;;;;;Constructor
(declare-fun TypeclassDefinition.to_int_tc (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun TypeclassDefinition.to_int_tc@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TypeclassDefinition.Mkto_int_tc (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TypeclassDefinition.Mkto_int_tc_t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TypeclassDefinition.Mkto_int_tc_to_int (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: TypeclassDefinition.Mkto_int_tc
(declare-fun TypeclassDefinition.Mkto_int_tc@tok () Term)
;;;;;;;;;;;;;;;;_: t -> Prims.int
(declare-fun Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 (Term) Term)

;;;;;;;;;;;;;;;;to_int: (_: t -> Prims.int) -> to_int_tc t
(declare-fun Tm_arrow_ab6dbec411cb4e68944594b3e505acb6 () Term)

; <start constructor TypeclassDefinition.to_int_tc>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TypeclassDefinition.to_int_tc ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
101)
(exists ((@x0 Term))
 (! (= __@x0
(TypeclassDefinition.to_int_tc @x0))
 
;;no pats
:qid is-TypeclassDefinition.to_int_tc))))

; </end constructor TypeclassDefinition.to_int_tc>


; <start constructor TypeclassDefinition.Mkto_int_tc>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TypeclassDefinition.Mkto_int_tc ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
110)
(= __@x0
(TypeclassDefinition.Mkto_int_tc (TypeclassDefinition.Mkto_int_tc_t __@x0)
(TypeclassDefinition.Mkto_int_tc_to_int __@x0)))))

; </end constructor TypeclassDefinition.Mkto_int_tc>


; </end encoding type TypeclassDefinition.to_int_tc>


; <Start encoding val TypeclassDefinition.__proj__Mkto_int_tc__item__to_int>

(declare-fun TypeclassDefinition.__proj__Mkto_int_tc__item__to_int (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: to_int_tc t -> _: t -> Prims.int
(declare-fun Tm_arrow_58a73f091a1ed5aaec2767f44bbcf109 () Term)
(declare-fun TypeclassDefinition.__proj__Mkto_int_tc__item__to_int@tok () Term)


; </end encoding val TypeclassDefinition.__proj__Mkto_int_tc__item__to_int>


; <Skipped let __proj__Mkto_int_tc__item__to_int/>


; <Start encoding let to_int>

(declare-fun TypeclassDefinition.to_int (Term) Term)

;;;;;;;;;;;;;;;;{| projectee: to_int_tc t |} -> _: t -> Prims.int
(declare-fun Tm_arrow_91961a913caf59a6e3a22420ed55cace (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: to_int_tc t |} -> _: t -> Prims.int
(declare-fun Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b () Term)
(declare-fun TypeclassDefinition.to_int@tok () Term)




(declare-fun Tm_abs_10c307e745bd1f35830ec43312a2d0ac (Term) Term)

; </end encoding let to_int>


; End Externals for module TypeclassDefinition


; Externals for module TypeclassInstance


; <Start encoding let uu___0>

(declare-fun TypeclassInstance.uu___0 (Dummy_sort) Term)
...
; End Externals for module TypeclassInstance


; Externals for module Definitions


; <Start encoding type Definitions.a_type__AType3__payload>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.a_type__AType3__payload () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.a_type () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.b_type__BType3__payload () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.b_type () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.Mka_type__AType3__payload (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.Mka_type__AType3__payload_a_type_C_field1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.Mka_type__AType3__payload_a_type_C_field2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Definitions.Mka_type__AType3__payload
(declare-fun Definitions.Mka_type__AType3__payload@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.AType1 (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.AType1_a1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.AType1_a2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Definitions.AType1
(declare-fun Definitions.AType1@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.AType2 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.AType2__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Definitions.AType2
(declare-fun Definitions.AType2@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.AType3 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.AType3__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Definitions.AType3
(declare-fun Definitions.AType3@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.Mkb_type__BType3__payload (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.Mkb_type__BType3__payload_b_type_F_field1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.Mkb_type__BType3__payload_a_type_F_field2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Definitions.Mkb_type__BType3__payload
(declare-fun Definitions.Mkb_type__BType3__payload@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.BType1 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Definitions.BType1
(declare-fun Definitions.BType1@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.BType2 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.BType2__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Definitions.BType2
(declare-fun Definitions.BType2@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.BType3 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.BType3__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Definitions.BType3
(declare-fun Definitions.BType3@tok () Term)
;;;;;;;;;;;;;;;;a_type_C_field1: Prims.int -> a_type_C_field2: b_type -> a_type__AType3__payload
(declare-fun Tm_arrow_8a53f07f91304dc07f2855ba5d36e85c () Term)
;;;;;;;;;;;;;;;;a1: Prims.int -> a2: Prims.nat -> a_type
(declare-fun Tm_arrow_3edf5eb62f61a1751e04641b9071879e () Term)
;;;;;;;;;;;;;;;;_0: Prims.string -> a_type
(declare-fun Tm_arrow_d4f0f483dd7ac404440c88b57e3165e5 () Term)
;;;;;;;;;;;;;;;;_0: a_type__AType3__payload -> a_type
(declare-fun Tm_arrow_e1740001059ffe5e75e101943098ff60 () Term)
;;;;;;;;;;;;;;;;b_type_F_field1: Prims.int -> a_type_F_field2: a_type -> b_type__BType3__payload
(declare-fun Tm_arrow_556deb444fc4618419b19983c4da3d29 () Term)
;;;;;;;;;;;;;;;;_0: a_type -> b_type
(declare-fun Tm_arrow_02b4f5fc5e70cfa84e9156c661401fb9 () Term)
;;;;;;;;;;;;;;;;_0: b_type__BType3__payload -> b_type
(declare-fun Tm_arrow_5eb7034e46ad07e332f9079729966c88 () Term)

; <start constructor Definitions.a_type__AType3__payload>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.a_type__AType3__payload ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
101)
(= __@x0
Definitions.a_type__AType3__payload)))

; </end constructor Definitions.a_type__AType3__payload>


; <start constructor Definitions.a_type>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.a_type ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
106)
(= __@x0
Definitions.a_type)))

; </end constructor Definitions.a_type>


; <start constructor Definitions.b_type__BType3__payload>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.b_type__BType3__payload ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
111)
(= __@x0
Definitions.b_type__BType3__payload)))

; </end constructor Definitions.b_type__BType3__payload>


; <start constructor Definitions.b_type>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.b_type ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
Definitions.b_type)))

; </end constructor Definitions.b_type>


; <start constructor Definitions.Mka_type__AType3__payload>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.Mka_type__AType3__payload ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
(Definitions.Mka_type__AType3__payload (Definitions.Mka_type__AType3__payload_a_type_C_field1 __@x0)
(Definitions.Mka_type__AType3__payload_a_type_C_field2 __@x0)))))

; </end constructor Definitions.Mka_type__AType3__payload>


; <start constructor Definitions.AType1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.AType1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
127)
(= __@x0
(Definitions.AType1 (Definitions.AType1_a1 __@x0)
(Definitions.AType1_a2 __@x0)))))

; </end constructor Definitions.AType1>


; <start constructor Definitions.AType2>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.AType2 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
132)
(= __@x0
(Definitions.AType2 (Definitions.AType2__0 __@x0)))))

; </end constructor Definitions.AType2>


; <start constructor Definitions.AType3>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.AType3 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
137)
(= __@x0
(Definitions.AType3 (Definitions.AType3__0 __@x0)))))

; </end constructor Definitions.AType3>


; <start constructor Definitions.Mkb_type__BType3__payload>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.Mkb_type__BType3__payload ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
142)
(= __@x0
(Definitions.Mkb_type__BType3__payload (Definitions.Mkb_type__BType3__payload_b_type_F_field1 __@x0)
(Definitions.Mkb_type__BType3__payload_a_type_F_field2 __@x0)))))

; </end constructor Definitions.Mkb_type__BType3__payload>


; <start constructor Definitions.BType1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.BType1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
147)
(= __@x0
Definitions.BType1)))

; </end constructor Definitions.BType1>


; <start constructor Definitions.BType2>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.BType2 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
149)
(= __@x0
(Definitions.BType2 (Definitions.BType2__0 __@x0)))))

; </end constructor Definitions.BType2>


; <start constructor Definitions.BType3>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.BType3 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
154)
(= __@x0
(Definitions.BType3 (Definitions.BType3__0 __@x0)))))

; </end constructor Definitions.BType3>


; </end encoding type Definitions.a_type__AType3__payload>


; <Start encoding assume Definitions.a_type__AType3__payload__uu___haseq>


; </end encoding assume Definitions.a_type__AType3__payload__uu___haseq>


; <Start encoding assume Definitions.a_type__uu___haseq>


; </end encoding assume Definitions.a_type__uu___haseq>


; <Start encoding assume Definitions.b_type__BType3__payload__uu___haseq>


; </end encoding assume Definitions.b_type__BType3__payload__uu___haseq>


; <Start encoding assume Definitions.b_type__uu___haseq>


; </end encoding assume Definitions.b_type__uu___haseq>


; <Start encoding val Definitions.__proj__Mka_type__AType3__payload__item__a_type_C_field1>

(declare-fun Definitions.__proj__Mka_type__AType3__payload__item__a_type_C_field1 (Term) Term)
;;;;;;;;;;;;;;;;projectee: a_type__AType3__payload -> Prims.int
(declare-fun Tm_arrow_c16263e1be75671ae514651381dbb27d () Term)
(declare-fun Definitions.__proj__Mka_type__AType3__payload__item__a_type_C_field1@tok () Term)

; </end encoding val Definitions.__proj__Mka_type__AType3__payload__item__a_type_C_field1>


; <Skipped let __proj__Mka_type__AType3__payload__item__a_type_C_field1/>


; <Start encoding val Definitions.__proj__Mka_type__AType3__payload__item__a_type_C_field2>

(declare-fun Definitions.__proj__Mka_type__AType3__payload__item__a_type_C_field2 (Term) Term)
;;;;;;;;;;;;;;;;projectee: a_type__AType3__payload -> b_type
(declare-fun Tm_arrow_ef6116fbdd34caa5fc9d08c9c039f1b3 () Term)
(declare-fun Definitions.__proj__Mka_type__AType3__payload__item__a_type_C_field2@tok () Term)

; </end encoding val Definitions.__proj__Mka_type__AType3__payload__item__a_type_C_field2>


; <Skipped let __proj__Mka_type__AType3__payload__item__a_type_C_field2/>


; <Start encoding val Definitions.uu___is_AType1>

(declare-fun Definitions.uu___is_AType1 (Term) Term)
;;;;;;;;;;;;;;;;projectee: a_type -> Prims.bool
(declare-fun Tm_arrow_94c862e84d32d6e2c8b2897c5e8312ee () Term)
(declare-fun Definitions.uu___is_AType1@tok () Term)

; </end encoding val Definitions.uu___is_AType1>


; <Skipped let uu___is_AType1/>


; <Start encoding val Definitions.__proj__AType1__item__a1>

(declare-fun Tm_refine_c7b78031a083619f4ae5429fef7d7717 () Term)
(declare-fun Definitions.__proj__AType1__item__a1 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: a_type{AType1? _} -> Prims.int
(declare-fun Tm_arrow_de9dfea0f6a0fd718841a8bace0a6ef7 () Term)
(declare-fun Definitions.__proj__AType1__item__a1@tok () Term)

; </end encoding val Definitions.__proj__AType1__item__a1>


; <Skipped let __proj__AType1__item__a1/>


; <Start encoding val Definitions.__proj__AType1__item__a2>


(declare-fun Definitions.__proj__AType1__item__a2 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: a_type{AType1? _} -> Prims.nat
(declare-fun Tm_arrow_779800e6a851ca4da52e9343228b55c2 () Term)
(declare-fun Definitions.__proj__AType1__item__a2@tok () Term)

; </end encoding val Definitions.__proj__AType1__item__a2>


; <Skipped let __proj__AType1__item__a2/>


; <Start encoding val Definitions.uu___is_AType2>

(declare-fun Definitions.uu___is_AType2 (Term) Term)

(declare-fun Definitions.uu___is_AType2@tok () Term)

; </end encoding val Definitions.uu___is_AType2>


; <Skipped let uu___is_AType2/>


; <Start encoding val Definitions.__proj__AType2__item___0>

(declare-fun Tm_refine_1e414ee7a2835faab22ca2996434cb14 () Term)
(declare-fun Definitions.__proj__AType2__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: a_type{AType2? _} -> Prims.string
(declare-fun Tm_arrow_f0478143d236b37711e06e798bf234cd () Term)
(declare-fun Definitions.__proj__AType2__item___0@tok () Term)

; </end encoding val Definitions.__proj__AType2__item___0>


; <Skipped let __proj__AType2__item___0/>


; <Start encoding val Definitions.uu___is_AType3>

(declare-fun Definitions.uu___is_AType3 (Term) Term)

(declare-fun Definitions.uu___is_AType3@tok () Term)

; </end encoding val Definitions.uu___is_AType3>


; <Skipped let uu___is_AType3/>


; <Start encoding val Definitions.__proj__AType3__item___0>

(declare-fun Tm_refine_8c57e72841e0abb0396be75a33c2f19a () Term)
(declare-fun Definitions.__proj__AType3__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: a_type{AType3? _} -> a_type__AType3__payload
(declare-fun Tm_arrow_477415e4da8e32ca47328ed5404ef52c () Term)
(declare-fun Definitions.__proj__AType3__item___0@tok () Term)

; </end encoding val Definitions.__proj__AType3__item___0>


; <Skipped let __proj__AType3__item___0/>


; <Start encoding val Definitions.__proj__Mkb_type__BType3__payload__item__b_type_F_field1>

(declare-fun Definitions.__proj__Mkb_type__BType3__payload__item__b_type_F_field1 (Term) Term)
;;;;;;;;;;;;;;;;projectee: b_type__BType3__payload -> Prims.int
(declare-fun Tm_arrow_75bc030f10475b835e9a3c0f36e3a6f8 () Term)
(declare-fun Definitions.__proj__Mkb_type__BType3__payload__item__b_type_F_field1@tok () Term)

; </end encoding val Definitions.__proj__Mkb_type__BType3__payload__item__b_type_F_field1>


; <Skipped let __proj__Mkb_type__BType3__payload__item__b_type_F_field1/>


; <Start encoding val Definitions.__proj__Mkb_type__BType3__payload__item__a_type_F_field2>

(declare-fun Definitions.__proj__Mkb_type__BType3__payload__item__a_type_F_field2 (Term) Term)
;;;;;;;;;;;;;;;;projectee: b_type__BType3__payload -> a_type
(declare-fun Tm_arrow_8a9c392d2dfa83568d24a722438f0d80 () Term)
(declare-fun Definitions.__proj__Mkb_type__BType3__payload__item__a_type_F_field2@tok () Term)

; </end encoding val Definitions.__proj__Mkb_type__BType3__payload__item__a_type_F_field2>


; <Skipped let __proj__Mkb_type__BType3__payload__item__a_type_F_field2/>


; <Start encoding val Definitions.uu___is_BType1>

(declare-fun Definitions.uu___is_BType1 (Term) Term)
;;;;;;;;;;;;;;;;projectee: b_type -> Prims.bool
(declare-fun Tm_arrow_2843e0f31103d7ba9938768d7d0edb8f () Term)
(declare-fun Definitions.uu___is_BType1@tok () Term)

; </end encoding val Definitions.uu___is_BType1>


; <Skipped let uu___is_BType1/>


; <Start encoding val Definitions.uu___is_BType2>

(declare-fun Definitions.uu___is_BType2 (Term) Term)

(declare-fun Definitions.uu___is_BType2@tok () Term)

; </end encoding val Definitions.uu___is_BType2>


; <Skipped let uu___is_BType2/>


; <Start encoding val Definitions.__proj__BType2__item___0>

(declare-fun Tm_refine_56db4283df581c1b775cbff0cbc2087a () Term)
(declare-fun Definitions.__proj__BType2__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: b_type{BType2? _} -> a_type
(declare-fun Tm_arrow_d9c210f018e4dfa448acbf0a8af9da3d () Term)
(declare-fun Definitions.__proj__BType2__item___0@tok () Term)

; </end encoding val Definitions.__proj__BType2__item___0>


; <Skipped let __proj__BType2__item___0/>


; <Start encoding val Definitions.uu___is_BType3>

(declare-fun Definitions.uu___is_BType3 (Term) Term)

(declare-fun Definitions.uu___is_BType3@tok () Term)

; </end encoding val Definitions.uu___is_BType3>


; <Skipped let uu___is_BType3/>


; <Start encoding val Definitions.__proj__BType3__item___0>

(declare-fun Tm_refine_e1eeea49459d45bd1c3e7944e83e335f () Term)
(declare-fun Definitions.__proj__BType3__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: b_type{BType3? _} -> b_type__BType3__payload
(declare-fun Tm_arrow_c56108007bca9b285996102c194b0d87 () Term)
(declare-fun Definitions.__proj__BType3__item___0@tok () Term)

; </end encoding val Definitions.__proj__BType3__item___0>


; <Skipped let __proj__BType3__item___0/>


; <Start encoding type Definitions.a_record>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.a_record () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Definitions.Mka_record (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.Mka_record_a_record_field1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Definitions.Mka_record_a_record_field2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Definitions.Mka_record
(declare-fun Definitions.Mka_record@tok () Term)
;;;;;;;;;;;;;;;;a_record_field1: a_type -> a_record_field2: Prims.int -> a_record
(declare-fun Tm_arrow_21b621dc8019de4e312090e795dc1bf4 () Term)

; <start constructor Definitions.a_record>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.a_record ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
202)
(= __@x0
Definitions.a_record)))

; </end constructor Definitions.a_record>


; <start constructor Definitions.Mka_record>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Definitions.Mka_record ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
208)
(= __@x0
(Definitions.Mka_record (Definitions.Mka_record_a_record_field1 __@x0)
(Definitions.Mka_record_a_record_field2 __@x0)))))

; </end constructor Definitions.Mka_record>


; </end encoding type Definitions.a_record>


; <Start encoding assume Definitions.a_record__uu___haseq>


; </end encoding assume Definitions.a_record__uu___haseq>


; <Start encoding val Definitions.__proj__Mka_record__item__a_record_field1>

(declare-fun Definitions.__proj__Mka_record__item__a_record_field1 (Term) Term)
;;;;;;;;;;;;;;;;projectee: a_record -> a_type
(declare-fun Tm_arrow_305e2ad9c50689c6c85756769b6dc456 () Term)
(declare-fun Definitions.__proj__Mka_record__item__a_record_field1@tok () Term)

; </end encoding val Definitions.__proj__Mka_record__item__a_record_field1>


; <Skipped let __proj__Mka_record__item__a_record_field1/>


; <Start encoding val Definitions.__proj__Mka_record__item__a_record_field2>

(declare-fun Definitions.__proj__Mka_record__item__a_record_field2 (Term) Term)
;;;;;;;;;;;;;;;;projectee: a_record -> Prims.int
(declare-fun Tm_arrow_7d03e10009c659e23e972f31c0b586df () Term)
(declare-fun Definitions.__proj__Mka_record__item__a_record_field2@tok () Term)

; </end encoding val Definitions.__proj__Mka_record__item__a_record_field2>


; <Skipped let __proj__Mka_record__item__a_record_field2/>


; <Start encoding let fn_example>

(declare-fun Definitions.fn_example (Term Term) Term)

(declare-fun Definitions.fn_example@tok () Term)

; </end encoding let fn_example>


; End Externals for module Definitions

(push) ;; push{1

; Internals for ConsumerInterface
...
(declare-fun ConsumerInterface.uu___0 () Term)
...
(declare-fun ConsumerInterface.uu___1 (Dummy_sort) Term)
...
(declare-fun ConsumerInterface.uu___2 (Dummy_sort) Term)

; </end encoding let uu___2>


; encoding sigelt let uu___3


; <Start encoding let uu___3>

(declare-fun ConsumerInterface.uu___3 (Dummy_sort) Term)

; </end encoding let uu___3>


; encoding sigelt let uu___4


; <Start encoding let uu___4>

(declare-fun ConsumerInterface.uu___4 () Term)

; </end encoding let uu___4>


; encoding sigelt let uu___5


; <Start encoding let uu___5>

(declare-fun ConsumerInterface.uu___5 (Term Term) Term)

(declare-fun ConsumerInterface.uu___5@tok () Term)

; </end encoding let uu___5>


; encoding sigelt let uu___6


; <Start encoding let uu___6>

(declare-fun ConsumerInterface.uu___6 (Dummy_sort) Term)

; </end encoding let uu___6>


; encoding sigelt let uu___7


; <Start encoding let uu___7>

(declare-fun ConsumerInterface.uu___7 (Dummy_sort) Term)
...
; encoding sigelt let uu___8


; <Start encoding let uu___8>

(declare-fun ConsumerInterface.uu___8 (Dummy_sort) Term)
...
; encoding sigelt let uu___9


; <Start encoding let uu___9>

(declare-fun ConsumerInterface.uu___9 (Term) Term)

(declare-fun ConsumerInterface.uu___9@tok () Term)

; </end encoding let uu___9>


; encoding sigelt let uu___10


; <Start encoding let uu___10>

(declare-fun ConsumerInterface.uu___10 (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name TypeclassInstance.uu___0; Namespace TypeclassInstance
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (TypeclassInstance.uu___0 @u0)
(TypeclassDefinition.to_int_tc Prims.int))
 

:pattern ((TypeclassInstance.uu___0 @u0))
:qid typing_TypeclassInstance.uu___0))
:named typing_TypeclassInstance.uu___0))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name TypeclassDefinition.to_int; Namespace TypeclassDefinition
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (TypeclassDefinition.to_int @x0)
(Tm_arrow_91961a913caf59a6e3a22420ed55cace @x0)))
 

:pattern ((TypeclassDefinition.to_int @x0))
:qid typing_TypeclassDefinition.to_int))
:named typing_TypeclassDefinition.to_int))
...
;;;;;;;;;;;;;;;;typing_Tm_abs_10c307e745bd1f35830ec43312a2d0ac
;;; Fact-ids: Name TypeclassDefinition.to_int; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(4,2-4,8); use=TypeclassDefinition.fst(4,2-4,8)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_10c307e745bd1f35830ec43312a2d0ac @x0)
(Tm_arrow_91961a913caf59a6e3a22420ed55cace @x0))
 

:pattern ((Tm_abs_10c307e745bd1f35830ec43312a2d0ac @x0))
:qid typing_Tm_abs_10c307e745bd1f35830ec43312a2d0ac))

:named typing_Tm_abs_10c307e745bd1f35830ec43312a2d0ac))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(3,6-3,15); use=TypeclassDefinition.fst(3,6-3,15)
(forall ((@x0 Term))
 (! (= (ApplyTT TypeclassDefinition.to_int_tc@tok
@x0)
(TypeclassDefinition.to_int_tc @x0))
 

:pattern ((ApplyTT TypeclassDefinition.to_int_tc@tok
@x0))

:pattern ((TypeclassDefinition.to_int_tc @x0))
:qid token_correspondence_TypeclassDefinition.to_int_tc@tok))

:named token_correspondence_TypeclassDefinition.to_int_tc@tok))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name TypeclassDefinition.to_int; Namespace TypeclassDefinition
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT TypeclassDefinition.to_int@tok
@x0)
(TypeclassDefinition.to_int @x0))
 

:pattern ((ApplyTT TypeclassDefinition.to_int@tok
@x0))
:qid token_correspondence_TypeclassDefinition.to_int))
:named token_correspondence_TypeclassDefinition.to_int))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(3,6-3,15); use=TypeclassDefinition.fst(3,6-3,15)
...
(TypeclassDefinition.Mkto_int_tc @x1
@x2)
(TypeclassDefinition.to_int_tc @x3))
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(TypeclassDefinition.Mkto_int_tc @x1
...
@x2)
(TypeclassDefinition.to_int_tc @x3)))
:qid subterm_ordering_TypeclassDefinition.Mkto_int_tc))

:named subterm_ordering_TypeclassDefinition.Mkto_int_tc))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=TypeclassDefinition.fst(3,6-3,15); use=TypeclassDefinition.fst(3,6-3,15)
(forall ((@x0 Term) (@x1 Term))
 (! (= (TypeclassDefinition.Mkto_int_tc_to_int (TypeclassDefinition.Mkto_int_tc @x0
@x1))
@x1)
 

:pattern ((TypeclassDefinition.Mkto_int_tc @x0
@x1))
:qid projection_inverse_TypeclassDefinition.Mkto_int_tc_to_int))

:named projection_inverse_TypeclassDefinition.Mkto_int_tc_to_int))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(3,6-3,15); use=TypeclassDefinition.fst(3,6-3,15)
(forall ((@x0 Term) (@x1 Term))
 (! (= (TypeclassDefinition.Mkto_int_tc_t (TypeclassDefinition.Mkto_int_tc @x0
@x1))
@x0)
...
:pattern ((TypeclassDefinition.Mkto_int_tc @x0
@x1))
:qid projection_inverse_TypeclassDefinition.Mkto_int_tc_t))

:named projection_inverse_TypeclassDefinition.Mkto_int_tc_t))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! (is-Tm_arrow (PreType TypeclassDefinition.to_int_tc@tok))
:named pre_kinding_TypeclassDefinition.to_int_tc@tok))
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! (and (IsTotFun TypeclassDefinition.to_int_tc@tok)

;; def=TypeclassDefinition.fst(3,6-3,15); use=TypeclassDefinition.fst(3,6-3,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (TypeclassDefinition.to_int_tc @x0)
Tm_type))
 

:pattern ((TypeclassDefinition.to_int_tc @x0))
:qid kinding_TypeclassDefinition.to_int_tc@tok))
)
:named kinding_TypeclassDefinition.to_int_tc@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_91961a913caf59a6e3a22420ed55cace
;;; Fact-ids: Name TypeclassDefinition.to_int; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(3,6-3,15); use=TypeclassDefinition.fst(3,16-4,8)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_91961a913caf59a6e3a22420ed55cace @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_91961a913caf59a6e3a22420ed55cace @x0)
Tm_type))
:qid kinding_Tm_arrow_91961a913caf59a6e3a22420ed55cace))

:named kinding_Tm_arrow_91961a913caf59a6e3a22420ed55cace))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b
;;; Fact-ids: Name TypeclassDefinition.to_int; Namespace TypeclassDefinition
(assert (! (HasType Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b
Tm_type)
:named kinding_Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(3,16-4,18); use=TypeclassDefinition.fst(4,10-4,18)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0)
Tm_type))
:qid kinding_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949))

:named kinding_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d
;;; Fact-ids: Name TypeclassInstance.uu___0; Namespace TypeclassInstance
(assert (! 
;; def=FStar.Pervasives.fsti(130,31-130,32); use=TypeclassInstance.fst(4,11-4,13)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_10c307e745bd1f35830ec43312a2d0ac
;;; Fact-ids: Name TypeclassDefinition.to_int; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(4,2-4,8); use=TypeclassDefinition.fst(4,2-4,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_10c307e745bd1f35830ec43312a2d0ac @x1)
@x0)
(let ((@lb2 @x0))
(TypeclassDefinition.Mkto_int_tc_to_int @lb2)))
 

:pattern ((ApplyTT (Tm_abs_10c307e745bd1f35830ec43312a2d0ac @x1)
@x0))
:qid interpretation_Tm_abs_10c307e745bd1f35830ec43312a2d0ac))

:named interpretation_Tm_abs_10c307e745bd1f35830ec43312a2d0ac))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType TypeclassDefinition.to_int@tok
Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b))
(forall ((@x1 Term))
 (! (= (ApplyTT TypeclassDefinition.to_int@tok
@x1)
(TypeclassDefinition.to_int @x1))
 

:pattern ((TypeclassDefinition.to_int @x1))
:qid function_token_typing_TypeclassDefinition.to_int.1)))
 

:pattern ((ApplyTT @x0
TypeclassDefinition.to_int@tok))
:qid function_token_typing_TypeclassDefinition.to_int))
:named function_token_typing_TypeclassDefinition.to_int))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(TypeclassDefinition.to_int_tc @x2))
(and (is-TypeclassDefinition.Mkto_int_tc @x1)
(= @x2
(TypeclassDefinition.Mkto_int_tc_t @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(TypeclassDefinition.to_int_tc @x2)))
:qid fuel_guarded_inversion_TypeclassDefinition.to_int_tc))

:named fuel_guarded_inversion_TypeclassDefinition.to_int_tc))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! (= 102
(Term_constr_id TypeclassDefinition.to_int_tc@tok))
:named fresh_token_TypeclassDefinition.to_int_tc@tok))
;;;;;;;;;;;;;;;;Equation for TypeclassInstance.uu___0
;;; Fact-ids: Name TypeclassInstance.uu___0; Namespace TypeclassInstance
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (TypeclassInstance.uu___0 @u0)
(TypeclassDefinition.Mkto_int_tc Prims.int
Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d))
 

:pattern ((TypeclassInstance.uu___0 @u0))
:qid equation_TypeclassInstance.uu___0))
:named equation_TypeclassInstance.uu___0))
;;;;;;;;;;;;;;;;Equation for TypeclassDefinition.to_int
;;; Fact-ids: Name TypeclassDefinition.to_int; Namespace TypeclassDefinition
(assert (! (forall ((@x0 Term))
 (! (= (TypeclassDefinition.to_int @x0)
(Tm_abs_10c307e745bd1f35830ec43312a2d0ac @x0))
 

:pattern ((TypeclassDefinition.to_int @x0))
:qid equation_TypeclassDefinition.to_int))
:named equation_TypeclassDefinition.to_int))
...
(HasTypeFuel @u0
@x2
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(HasTypeFuel @u0
(TypeclassDefinition.Mkto_int_tc @x1
@x2)
(TypeclassDefinition.to_int_tc @x1)))
...
@x2)
(TypeclassDefinition.to_int_tc @x1)))
:qid data_typing_intro_TypeclassDefinition.Mkto_int_tc@tok))

:named data_typing_intro_TypeclassDefinition.Mkto_int_tc@tok))
...
(HasTypeFuel @u0
@x2
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x3))))
...
@x2)
(TypeclassDefinition.to_int_tc @x3)))
:qid data_elim_TypeclassDefinition.Mkto_int_tc))

:named data_elim_TypeclassDefinition.Mkto_int_tc))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(3,6-3,15); use=TypeclassDefinition.fst(3,6-3,15)
(forall ((@x0 Term))
 (! (= 101
(Term_constr_id (TypeclassDefinition.to_int_tc @x0)))
 

:pattern ((TypeclassDefinition.to_int_tc @x0))
:qid constructor_distinct_TypeclassDefinition.to_int_tc))

:named constructor_distinct_TypeclassDefinition.to_int_tc))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(3,6-3,15); use=TypeclassDefinition.fst(3,6-3,15)
(forall ((@x0 Term) (@x1 Term))
 (! (= 110
(Term_constr_id (TypeclassDefinition.Mkto_int_tc @x0
@x1)))
 

:pattern ((TypeclassDefinition.Mkto_int_tc @x0
@x1))
:qid constructor_distinct_TypeclassDefinition.Mkto_int_tc))

:named constructor_distinct_TypeclassDefinition.Mkto_int_tc))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
@x0
(TypeclassDefinition.to_int_tc @x2)))
:qid TypeclassDefinition_pretyping_33d72fa13002378f615f8f3a487a58b6))

:named TypeclassDefinition_pretyping_33d72fa13002378f615f8f3a487a58b6))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_91961a913caf59a6e3a22420ed55cace @x2))
...
@x1
(Tm_arrow_91961a913caf59a6e3a22420ed55cace @x2)))
:qid TypeclassDefinition_pre_typing_Tm_arrow_91961a913caf59a6e3a22420ed55cace))

:named TypeclassDefinition_pre_typing_Tm_arrow_91961a913caf59a6e3a22420ed55cace))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name TypeclassDefinition.to_int; Namespace TypeclassDefinition
(assert (! 
;; def=dummy(0,0-0,0); use=TypeclassDefinition.fst(3,16-4,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b)
...
@x1
Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b))
:qid TypeclassDefinition_pre_typing_Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b))

:named TypeclassDefinition_pre_typing_Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(3,16-4,18); use=TypeclassDefinition.fst(4,10-4,18)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x2)))
:qid TypeclassDefinition_pre_typing_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949))

:named TypeclassDefinition_pre_typing_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_91961a913caf59a6e3a22420ed55cace
;;; Fact-ids: Name TypeclassDefinition.to_int; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(3,6-3,15); use=TypeclassDefinition.fst(3,16-4,8)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_91961a913caf59a6e3a22420ed55cace @x1))
(and 
;; def=TypeclassDefinition.fst(3,6-3,15); use=TypeclassDefinition.fst(3,16-4,8)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid TypeclassDefinition_interpretation_Tm_arrow_91961a913caf59a6e3a22420ed55cace.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_91961a913caf59a6e3a22420ed55cace @x1)))
:qid TypeclassDefinition_interpretation_Tm_arrow_91961a913caf59a6e3a22420ed55cace))

:named TypeclassDefinition_interpretation_Tm_arrow_91961a913caf59a6e3a22420ed55cace))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b
;;; Fact-ids: Name TypeclassDefinition.to_int; Namespace TypeclassDefinition
(assert (! 
;; def=dummy(0,0-0,0); use=TypeclassDefinition.fst(3,16-4,8)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid TypeclassDefinition_interpretation_Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b))
:qid TypeclassDefinition_interpretation_Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b))

:named TypeclassDefinition_interpretation_Tm_arrow_7149a8c00a63425f0ed931fbbf744d9b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949
;;; Fact-ids: Name TypeclassDefinition.to_int_tc; Namespace TypeclassDefinition; Name TypeclassDefinition.Mkto_int_tc; Namespace TypeclassDefinition
(assert (! 
;; def=TypeclassDefinition.fst(3,16-4,18); use=TypeclassDefinition.fst(4,10-4,18)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid TypeclassDefinition_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
:qid TypeclassDefinition_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949))

:named TypeclassDefinition_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
; Starting query at ConsumerInterface.fsti(68,0-68,30)
...
TypeclassDefinition.to_int@tok))
:named @kick_partial_app_9a1ebe14c7934c63217109a002c80f4b))

; Encoding query formula : TypeclassDefinition.to_int 3 == 3


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let uu___11`
...
;;; Fact-ids: 
(assert (! (not 
;; def=ConsumerInterface.fsti(68,15-68,30); use=ConsumerInterface.fsti(68,8-68,14)
(or label_1

;; def=ConsumerInterface.fsti(68,15-68,30); use=ConsumerInterface.fsti(68,8-68,14)
(= (ApplyTT (ApplyTT (ApplyTT TypeclassDefinition.to_int@tok
Prims.int)
(TypeclassInstance.uu___0 Dummy_value))
(BoxInt 3))
(BoxInt 3))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ConsumerInterface.uu___11, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_TypeclassDefinition.to_int, equation_TypeclassInstance.uu___0, interpretation_Tm_abs_10c307e745bd1f35830ec43312a2d0ac, interpretation_Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d, projection_inverse_TypeclassDefinition.Mkto_int_tc_to_int, token_correspondence_TypeclassDefinition.to_int
