...
; Internals for Bug2591b


; encoding sigelt type Bug2591b.tc1


; <Start encoding type Bug2591b.tc1>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2591b.tc1 (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug2591b.tc1@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2591b.Mktc1 (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2591b.Mktc1_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2591b.Mktc1_tc1_method (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2591b.Mktc1
(declare-fun Bug2591b.Mktc1@tok () Term)
;;;;;;;;;;;;;;;;_: a -> a
(declare-fun Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 (Term) Term)

;;;;;;;;;;;;;;;;tc1_method: (_: a -> a) -> tc1 a
(declare-fun Tm_arrow_27f8b419f2169f3a924cdec6a1d77a2e () Term)

; <start constructor Bug2591b.tc1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2591b.tc1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor Bug2591b.tc1>


; <start constructor Bug2591b.Mktc1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2591b.Mktc1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
113)
(= __@x0
(Bug2591b.Mktc1 (Bug2591b.Mktc1_a __@x0)
(Bug2591b.Mktc1_tc1_method __@x0)))))

; </end constructor Bug2591b.Mktc1>


; </end encoding type Bug2591b.tc1>


; encoding sigelt val Bug2591b.__proj__Mktc1__item__tc1_method


; <Start encoding val Bug2591b.__proj__Mktc1__item__tc1_method>

(declare-fun Bug2591b.__proj__Mktc1__item__tc1_method (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: tc1 a -> _: a -> a
(declare-fun Tm_arrow_86a268c3f1a333ae78380d5f3a0b4a3d () Term)
(declare-fun Bug2591b.__proj__Mktc1__item__tc1_method@tok () Term)


; </end encoding val Bug2591b.__proj__Mktc1__item__tc1_method>


; encoding sigelt let __proj__Mktc1__item__tc1_method


; <Skipped let __proj__Mktc1__item__tc1_method/>


; encoding sigelt let tc1_method


; <Start encoding let tc1_method>

(declare-fun Bug2591b.tc1_method (Term) Term)

;;;;;;;;;;;;;;;;{| projectee: tc1 a |} -> _: a -> a
(declare-fun Tm_arrow_3985aecc590e830933fe3cc80691fe8d (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: tc1 a |} -> _: a -> a
(declare-fun Tm_arrow_e00bd96ca20ccc13935aec27528e5007 () Term)
(declare-fun Bug2591b.tc1_method@tok () Term)




(declare-fun Tm_abs_335f4ce4a7ed5246df48b55b3887ee6c (Term) Term)

; </end encoding let tc1_method>
...
; encoding sigelt type Bug2591b.box


; <Start encoding type Bug2591b.box>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2591b.box (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug2591b.box@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2591b.Box (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2591b.Box_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2591b.Box_uu___0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2591b.Box_v (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2591b.Box
(declare-fun Bug2591b.Box@tok () Term)
;;;;;;;;;;;;;;;;v: a -> box a
(declare-fun Tm_arrow_6a0d4d306eba25875ca5950ef3baac6e () Term)

; <start constructor Bug2591b.box>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2591b.box ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
150)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
157)
(= __@x0
(Bug2591b.Box (Bug2591b.Box_a __@x0)
(Bug2591b.Box_uu___0 __@x0)
(Bug2591b.Box_v __@x0)))))

; </end constructor Bug2591b.Box>


; </end encoding type Bug2591b.box>
...
;;; Fact-ids: Name Bug2591b.tc1; Namespace Bug2591b; Name Bug2591b.Mktc1; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(3,6-3,9); use=Bug2591b.fst(3,6-3,9)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug2591b.tc1@tok
@x0)
(Bug2591b.tc1 @x0))
 

:pattern ((ApplyTT Bug2591b.tc1@tok
@x0))

:pattern ((Bug2591b.tc1 @x0))
:qid token_correspondence_Bug2591b.tc1@tok))

:named token_correspondence_Bug2591b.tc1@tok))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(7,5-7,8); use=Bug2591b.fst(7,5-7,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug2591b.box@tok
@x0)
@x1)
(Bug2591b.box @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Bug2591b.box@tok
@x0)
@x1))

:pattern ((Bug2591b.box @x0
@x1))
:qid token_correspondence_Bug2591b.box@tok))

:named token_correspondence_Bug2591b.box@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug2591b.tc1; Namespace Bug2591b; Name Bug2591b.Mktc1; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(3,6-3,9); use=Bug2591b.fst(3,6-3,9)
...
@x2)
(Bug2591b.tc1 @x3)))
:qid subterm_ordering_Bug2591b.Mktc1))

:named subterm_ordering_Bug2591b.Mktc1))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(8,3-8,6); use=Bug2591b.fst(8,3-8,6)
...
(Bug2591b.box @x4
@x5)))
:qid subterm_ordering_Bug2591b.Box))

:named subterm_ordering_Bug2591b.Box))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=Bug2591b.fst(3,6-3,9); use=Bug2591b.fst(3,6-3,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug2591b.Mktc1_tc1_method (Bug2591b.Mktc1 @x0
@x1))
@x1)
 

:pattern ((Bug2591b.Mktc1 @x0
@x1))
:qid projection_inverse_Bug2591b.Mktc1_tc1_method))

:named projection_inverse_Bug2591b.Mktc1_tc1_method))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2591b.tc1; Namespace Bug2591b; Name Bug2591b.Mktc1; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(3,6-3,9); use=Bug2591b.fst(3,6-3,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug2591b.Mktc1_a (Bug2591b.Mktc1 @x0
@x1))
@x0)
...
:pattern ((Bug2591b.Mktc1 @x0
@x1))
:qid projection_inverse_Bug2591b.Mktc1_a))

:named projection_inverse_Bug2591b.Mktc1_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(8,3-8,6); use=Bug2591b.fst(8,3-8,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug2591b.Box_v (Bug2591b.Box @x0
@x1
@x2))
@x2)
...
@x1
@x2))
:qid projection_inverse_Bug2591b.Box_v))

:named projection_inverse_Bug2591b.Box_v))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(8,3-8,6); use=Bug2591b.fst(8,3-8,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug2591b.Box_uu___0 (Bug2591b.Box @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_Bug2591b.Box_uu___0))

:named projection_inverse_Bug2591b.Box_uu___0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(8,3-8,6); use=Bug2591b.fst(8,3-8,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug2591b.Box_a (Bug2591b.Box @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_Bug2591b.Box_a))

:named projection_inverse_Bug2591b.Box_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug2591b.tc1; Namespace Bug2591b; Name Bug2591b.Mktc1; Namespace Bug2591b
(assert (! (is-Tm_arrow (PreType Bug2591b.tc1@tok))
:named pre_kinding_Bug2591b.tc1@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! (is-Tm_arrow (PreType Bug2591b.box@tok))
:named pre_kinding_Bug2591b.box@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015
;;; Fact-ids: Name Bug2591b.tc1; Namespace Bug2591b; Name Bug2591b.Mktc1; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(3,11-3,12); use=Bug2591b.fst(4,14-4,20)
(forall ((@x0 Term))
...
;;; Fact-ids: Name Bug2591b.tc1; Namespace Bug2591b; Name Bug2591b.Mktc1; Namespace Bug2591b
(assert (! (and (IsTotFun Bug2591b.tc1@tok)

;; def=Bug2591b.fst(3,6-3,9); use=Bug2591b.fst(3,6-3,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Bug2591b.tc1 @x0)
Tm_type))
 

:pattern ((Bug2591b.tc1 @x0))
:qid kinding_Bug2591b.tc1@tok))
)
:named kinding_Bug2591b.tc1@tok))
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! (and (IsTotFun Bug2591b.box@tok)

;; def=Bug2591b.fst(7,5-7,8); use=Bug2591b.fst(7,5-7,8)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Bug2591b.box@tok
@x0))
 

:pattern ((ApplyTT Bug2591b.box@tok
@x0))
:qid kinding_Bug2591b.box@tok))
...
:pattern ((Bug2591b.box @x0
@x1))
:qid kinding_Bug2591b.box@tok.1))
)
:named kinding_Bug2591b.box@tok))
...
@x1
(Bug2591b.tc1 @x2)))
:qid fuel_guarded_inversion_Bug2591b.tc1))

:named fuel_guarded_inversion_Bug2591b.tc1))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(7,5-7,8); use=Bug2591b.fst(7,5-7,8)
...
(Bug2591b.box @x2
@x3))
(and (is-Bug2591b.Box @x1)
(= @x2
(Bug2591b.Box_a @x1))
(= @x3
(Bug2591b.Box_uu___0 @x1))))
...
(Bug2591b.box @x2
@x3)))
:qid fuel_guarded_inversion_Bug2591b.box))

:named fuel_guarded_inversion_Bug2591b.box))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug2591b.tc1; Namespace Bug2591b; Name Bug2591b.Mktc1; Namespace Bug2591b
(assert (! (= 105
(Term_constr_id Bug2591b.tc1@tok))
:named fresh_token_Bug2591b.tc1@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! (= 151
(Term_constr_id Bug2591b.box@tok))
:named fresh_token_Bug2591b.box@tok))
...
@x2)
(Bug2591b.tc1 @x1)))
:qid data_typing_intro_Bug2591b.Mktc1@tok))

:named data_typing_intro_Bug2591b.Mktc1@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(8,3-8,6); use=Bug2591b.fst(8,3-8,6)
...
(Bug2591b.box @x1
@x2)))
:qid data_typing_intro_Bug2591b.Box@tok))

:named data_typing_intro_Bug2591b.Box@tok))
...
(HasTypeFuel @u0
@x2
(Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 @x3))))
...
@x2)
(Bug2591b.tc1 @x3)))
:qid data_elim_Bug2591b.Mktc1))

:named data_elim_Bug2591b.Mktc1))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(8,3-8,6); use=Bug2591b.fst(8,3-8,6)
...
(Bug2591b.box @x4
@x5)))
:qid data_elim_Bug2591b.Box))

:named data_elim_Bug2591b.Box))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 104
(Term_constr_id (Bug2591b.tc1 @x0)))
 

:pattern ((Bug2591b.tc1 @x0))
:qid constructor_distinct_Bug2591b.tc1))

:named constructor_distinct_Bug2591b.tc1))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(7,5-7,8); use=Bug2591b.fst(7,5-7,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 150
(Term_constr_id (Bug2591b.box @x0
@x1)))
 

:pattern ((Bug2591b.box @x0
@x1))
:qid constructor_distinct_Bug2591b.box))

:named constructor_distinct_Bug2591b.box))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2591b.tc1; Namespace Bug2591b; Name Bug2591b.Mktc1; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(3,6-3,9); use=Bug2591b.fst(3,6-3,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= 113
(Term_constr_id (Bug2591b.Mktc1 @x0
@x1)))
 

:pattern ((Bug2591b.Mktc1 @x0
@x1))
:qid constructor_distinct_Bug2591b.Mktc1))

:named constructor_distinct_Bug2591b.Mktc1))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(8,3-8,6); use=Bug2591b.fst(8,3-8,6)
...
@x0
(Bug2591b.tc1 @x2)))
:qid Bug2591b_pretyping_c711341168edbfe93719dc75bd0c7497))

:named Bug2591b_pretyping_c711341168edbfe93719dc75bd0c7497))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug2591b.box; Namespace Bug2591b; Name Bug2591b.Box; Namespace Bug2591b
(assert (! 
;; def=Bug2591b.fst(7,5-7,8); use=Bug2591b.fst(7,5-7,8)
...
(Bug2591b.box @x2
@x3)))
:qid Bug2591b_pretyping_5acd6c5c3c8f9edf9e84ce918231ec7b))

:named Bug2591b_pretyping_5acd6c5c3c8f9edf9e84ce918231ec7b))
...
@x1
(Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 @x2)))
:qid Bug2591b_pre_typing_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))

:named Bug2591b_pre_typing_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug2591b_interpretation_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 @x1)))
:qid Bug2591b_interpretation_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))

:named Bug2591b_interpretation_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))
(push) ;; push{4

; Starting query at Bug2591b.fst(7,0-8,21)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (_: Bug2591b.tc1 a).
;   Prims.hasEq a /\
;   (forall (a: Type) (_: Bug2591b.tc1 a). {:pattern Prims.hasEq (Bug2591b.box a)}
;       Prims.hasEq a ==> Prims.hasEq (Bug2591b.box a)) ==>
;   (forall (v: a).
...
; While typechecking the top-level declaration `type Bug2591b.box`
...
;; def=Bug2591b.fst(7,0-8,21); use=Bug2591b.fst(7,0-8,21)
(Valid 
;; def=Bug2591b.fst(7,0-8,21); use=Bug2591b.fst(7,0-8,21)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=Bug2591b.fst(7,0-8,21); use=Bug2591b.fst(7,0-8,21)
(Prims.hasEq (Bug2591b.box @x2
@x3))
)
)
 

:pattern ((Prims.hasEq (Bug2591b.box @x2
@x3)))
:qid @query.1))
)
...
;; def=Bug2591b.fst(7,0-8,21); use=Bug2591b.fst(8,11-8,12)
(or label_1
