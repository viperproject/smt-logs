...
; Internals for Bug3130e


; encoding sigelt type Bug3130e.ord_leq


; <Start encoding type Bug3130e.ord_leq>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug3130e.ord_leq (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug3130e.ord_leq@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug3130e.Mkord_leq (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug3130e.Mkord_leq_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug3130e.Mkord_leq_leq (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug3130e.Mkord_leq_trans (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug3130e.Mkord_leq
(declare-fun Bug3130e.Mkord_leq@tok () Term)

(declare-fun Tm_refine_4787595aefc8d009ec100360dba96506 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> z: a -> FStar.Pervasives.Lemma (ensures leq x y /\ leq y z ==> leq x z)
(declare-fun Tm_arrow_1636670e83c60650644609459794ed12 (Term Term) Term)



;;;;;;;;;;;;;;;;leq: (_: a -> _: a -> Prims.bool) ->     trans: (x: a -> y: a -> z: a -> FStar.Pervasives.Lemma (ensures leq x y /\ leq y z ==> leq x z))   -> ord_leq a
(declare-fun Tm_arrow_74063e523dd9f3d5030b389643e22a53 () Term)

; <start constructor Bug3130e.ord_leq>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug3130e.ord_leq ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-Bug3130e.ord_leq))))

; </end constructor Bug3130e.ord_leq>


; <start constructor Bug3130e.Mkord_leq>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug3130e.Mkord_leq ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
(Bug3130e.Mkord_leq (Bug3130e.Mkord_leq_a __@x0)
(Bug3130e.Mkord_leq_leq __@x0)
(Bug3130e.Mkord_leq_trans __@x0)))))

; </end constructor Bug3130e.Mkord_leq>


; </end encoding type Bug3130e.ord_leq>


; encoding sigelt val Bug3130e.__proj__Mkord_leq__item__leq


; <Start encoding val Bug3130e.__proj__Mkord_leq__item__leq>

(declare-fun Bug3130e.__proj__Mkord_leq__item__leq (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: ord_leq a -> _: a -> _: a -> Prims.bool
(declare-fun Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f () Term)
(declare-fun Bug3130e.__proj__Mkord_leq__item__leq@tok () Term)


; </end encoding val Bug3130e.__proj__Mkord_leq__item__leq>


; encoding sigelt let __proj__Mkord_leq__item__leq


; <Skipped let __proj__Mkord_leq__item__leq/>


; encoding sigelt val Bug3130e.__proj__Mkord_leq__item__trans


; <Start encoding val Bug3130e.__proj__Mkord_leq__item__trans>

(declare-fun Bug3130e.__proj__Mkord_leq__item__trans (Term Term) Term)


(declare-fun Tm_refine_edb8b2c7cdbbb6a05c2c50be5d165543 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma (ensures projectee.leq x y /\ projectee.leq y z ==> projectee.leq x z)
(declare-fun Tm_arrow_87e12ee0d89b3d3ed5ffbc6149bcb00f (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: ord_leq a -> x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma (ensures projectee.leq x y /\ projectee.leq y z ==> projectee.leq x z)
(declare-fun Tm_arrow_0fb08c63c6566066f77444530e577947 () Term)
(declare-fun Bug3130e.__proj__Mkord_leq__item__trans@tok () Term)
...
; </end encoding val Bug3130e.__proj__Mkord_leq__item__trans>


; encoding sigelt let __proj__Mkord_leq__item__trans


; <Skipped let __proj__Mkord_leq__item__trans/>
...
(declare-fun Bug3130e.leq (Term) Term)

;;;;;;;;;;;;;;;;_: a -> _: a -> Prims.bool
(declare-fun Tm_arrow_649a0684309abaa78e673cf48ebf1183 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: ord_leq a |} -> _: a -> _: a -> Prims.bool
(declare-fun Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: ord_leq a |} -> _: a -> _: a -> Prims.bool
(declare-fun Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5 () Term)
(declare-fun Bug3130e.leq@tok () Term)
...
(declare-fun Tm_abs_9563a090f65b0f80871ba123f9571371 (Term) Term)

; </end encoding let leq>


; encoding sigelt let trans


; <Start encoding let trans>

(declare-fun Bug3130e.trans (Term) Term)
(declare-fun Non_total_Tm_arrow_54c6f66e364768e851a254e9864d857b (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;y: a -> z: a   -> FStar.Pervasives.Lemma (ensures projectee.leq x y /\ projectee.leq y z ==> projectee.leq x z)
(declare-fun Tm_arrow_30b9bd06467023673df918b8a5b2700e (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma (ensures projectee.leq x y /\ projectee.leq y z ==> projectee.leq x z)
(declare-fun Tm_arrow_b2963c9f0cbd47123b5d1b581c2d4821 (Term Term) Term)
;;;;;;;;;;;;;;;;{| projectee: ord_leq a |} -> x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma (ensures projectee.leq x y /\ projectee.leq y z ==> projectee.leq x z)
(declare-fun Tm_arrow_8c62438fdd00fdf921742b338d8ef046 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: ord_leq a |} -> x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma (ensures projectee.leq x y /\ projectee.leq y z ==> projectee.leq x z)
(declare-fun Tm_arrow_366d0794d7268a0a7c38be803316439a () Term)
(declare-fun Bug3130e.trans@tok () Term)
...
(declare-fun Tm_abs_d5af243ba89cae999ec549be2373a710 (Term) Term)
...
;;;;;;;;;;;;;;;;typing_Tm_abs_9563a090f65b0f80871ba123f9571371
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(4,4-4,7); use=Bug3130e.fst(4,4-4,7)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_9563a090f65b0f80871ba123f9571371 @x0)
(Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213 @x0))
 

:pattern ((Tm_abs_9563a090f65b0f80871ba123f9571371 @x0))
:qid typing_Tm_abs_9563a090f65b0f80871ba123f9571371))

:named typing_Tm_abs_9563a090f65b0f80871ba123f9571371))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.eqtype)
(HasType (Bug3130e.leq @x0)
(Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213 @x0)))
 

:pattern ((Bug3130e.leq @x0))
:qid typing_Bug3130e.leq))
:named typing_Bug3130e.leq))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug3130e.__proj__Mkord_leq__item__leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(4,4-4,7); use=Bug3130e.fst(4,4-4,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Bug3130e.ord_leq @x0)))
(HasType (Bug3130e.__proj__Mkord_leq__item__leq @x0
@x1)
(Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e @x0)))
 

:pattern ((Bug3130e.__proj__Mkord_leq__item__leq @x0
@x1))
:qid typing_Bug3130e.__proj__Mkord_leq__item__leq))

:named typing_Bug3130e.__proj__Mkord_leq__item__leq))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
(assert (! (Valid Prims.l_True)
:named true_interp))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-3,13); use=Bug3130e.fst(3,6-3,13)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug3130e.ord_leq@tok
@x0)
(Bug3130e.ord_leq @x0))
 

:pattern ((ApplyTT Bug3130e.ord_leq@tok
@x0))

:pattern ((Bug3130e.ord_leq @x0))
:qid token_correspondence_Bug3130e.ord_leq@tok))

:named token_correspondence_Bug3130e.ord_leq@tok))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT Bug3130e.leq@tok
@x0)
(Bug3130e.leq @x0))
 

:pattern ((ApplyTT Bug3130e.leq@tok
@x0))
:qid token_correspondence_Bug3130e.leq))
:named token_correspondence_Bug3130e.leq))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Bug3130e.__proj__Mkord_leq__item__leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(4,4-4,7); use=Bug3130e.fst(4,4-4,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug3130e.__proj__Mkord_leq__item__leq@tok
@x0)
@x1)
(Bug3130e.__proj__Mkord_leq__item__leq @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Bug3130e.__proj__Mkord_leq__item__leq@tok
@x0)
@x1))
:qid token_correspondence_Bug3130e.__proj__Mkord_leq__item__leq))

:named token_correspondence_Bug3130e.__proj__Mkord_leq__item__leq))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-3,13); use=Bug3130e.fst(3,6-3,13)
...
@x3)
(Bug3130e.ord_leq @x4)))
:qid subterm_ordering_Bug3130e.Mkord_leq))

:named subterm_ordering_Bug3130e.Mkord_leq))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(5,38-5,82); use=Bug3130e.fst(5,38-5,82)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_4787595aefc8d009ec100360dba96506 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_4787595aefc8d009ec100360dba96506 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_4787595aefc8d009ec100360dba96506))

:named refinement_kinding_Tm_refine_4787595aefc8d009ec100360dba96506))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4787595aefc8d009ec100360dba96506 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Prims.fst(635,71-635,97); use=Bug3130e.fst(5,38-5,82)
(not 
;; def=Prims.fst(441,29-441,97); use=Bug3130e.fst(5,38-5,43)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=Bug3130e.fst(5,44-5,82); use=Bug3130e.fst(5,38-5,43)
(implies 
;; def=Bug3130e.fst(5,45-5,67); use=Bug3130e.fst(5,38-5,43)
(and 
;; def=Bug3130e.fst(5,45-5,54); use=Bug3130e.fst(5,38-5,43)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x2
@x3)
@x4))


;; def=Bug3130e.fst(5,58-5,67); use=Bug3130e.fst(5,38-5,43)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x2
@x4)
@x5))
)
...
;; def=Bug3130e.fst(5,72-5,81); use=Bug3130e.fst(5,38-5,43)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x2
@x3)
@x5))
)
...
;; def=Prims.fst(635,86-635,95); use=Bug3130e.fst(5,38-5,82)
(not 
;; def=Prims.fst(635,86-635,95); use=Bug3130e.fst(5,38-5,82)
(= @x6
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_4787595aefc8d009ec100360dba96506.1))
)
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_4787595aefc8d009ec100360dba96506))

:named refinement_interpretation_Tm_refine_4787595aefc8d009ec100360dba96506))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug3130e.Mkord_leq_trans (Bug3130e.Mkord_leq @x0
@x1
@x2))
@x2)
 

:pattern ((Bug3130e.Mkord_leq @x0
@x1
@x2))
:qid projection_inverse_Bug3130e.Mkord_leq_trans))

:named projection_inverse_Bug3130e.Mkord_leq_trans))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-3,13); use=Bug3130e.fst(3,6-3,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug3130e.Mkord_leq_leq (Bug3130e.Mkord_leq @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_Bug3130e.Mkord_leq_leq))

:named projection_inverse_Bug3130e.Mkord_leq_leq))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-3,13); use=Bug3130e.fst(3,6-3,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug3130e.Mkord_leq_a (Bug3130e.Mkord_leq @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_Bug3130e.Mkord_leq_a))

:named projection_inverse_Bug3130e.Mkord_leq_a))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug3130e.__proj__Mkord_leq__item__leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(4,4-4,7); use=Bug3130e.fst(4,4-4,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug3130e.__proj__Mkord_leq__item__leq @x0
@x1)
(Bug3130e.Mkord_leq_leq @x1))
 

:pattern ((Bug3130e.__proj__Mkord_leq__item__leq @x0
@x1))
:qid proj_equation_Bug3130e.Mkord_leq_leq))

:named proj_equation_Bug3130e.Mkord_leq_leq))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! (is-Tm_arrow (PreType Bug3130e.ord_leq@tok))
:named pre_kinding_Bug3130e.ord_leq@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! (HasType Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5
Tm_type)
:named kinding_Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f
;;; Fact-ids: Name Bug3130e.__proj__Mkord_leq__item__leq; Namespace Bug3130e
(assert (! (HasType Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f
Tm_type)
:named kinding_Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f))
...
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! 
;; def=dummy(0,0-0,0); use=Bug3130e.fst(3,15-4,7)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-3,13); use=Bug3130e.fst(3,15-4,7)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213 @x0)
Tm_type))
:qid kinding_Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213))

:named kinding_Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1636670e83c60650644609459794ed12
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,15-5,82); use=Bug3130e.fst(5,14-5,82)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_1636670e83c60650644609459794ed12 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_1636670e83c60650644609459794ed12 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_1636670e83c60650644609459794ed12))

:named kinding_Tm_arrow_1636670e83c60650644609459794ed12))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (HasType Prims.trivial
Tm_type)
:named kinding_Prims.trivial@tok))
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! (and (IsTotFun Bug3130e.ord_leq@tok)

;; def=Bug3130e.fst(3,6-3,13); use=Bug3130e.fst(3,6-3,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.eqtype)
(HasType (Bug3130e.ord_leq @x0)
Tm_type))
 

:pattern ((Bug3130e.ord_leq @x0))
:qid kinding_Bug3130e.ord_leq@tok))
)
:named kinding_Bug3130e.ord_leq@tok))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_9563a090f65b0f80871ba123f9571371
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(4,4-4,7); use=Bug3130e.fst(4,4-4,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_9563a090f65b0f80871ba123f9571371 @x1)
@x0)
(let ((@lb2 @x0))
(Bug3130e.Mkord_leq_leq @lb2)))
 

:pattern ((ApplyTT (Tm_abs_9563a090f65b0f80871ba123f9571371 @x1)
@x0))
:qid interpretation_Tm_abs_9563a090f65b0f80871ba123f9571371))

:named interpretation_Tm_abs_9563a090f65b0f80871ba123f9571371))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_4787595aefc8d009ec100360dba96506
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(5,38-5,82); use=Bug3130e.fst(5,38-5,82)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4787595aefc8d009ec100360dba96506 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_4787595aefc8d009ec100360dba96506 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_4787595aefc8d009ec100360dba96506))

:named haseqTm_refine_4787595aefc8d009ec100360dba96506))
...
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Bug3130e.leq@tok
Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5))
(forall ((@x1 Term))
 (! (= (ApplyTT Bug3130e.leq@tok
@x1)
(Bug3130e.leq @x1))
...
:pattern ((Bug3130e.leq @x1))
:qid function_token_typing_Bug3130e.leq.1)))
 

:pattern ((ApplyTT @x0
Bug3130e.leq@tok))
:qid function_token_typing_Bug3130e.leq))
:named function_token_typing_Bug3130e.leq))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Bug3130e.__proj__Mkord_leq__item__leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(4,4-4,7); use=Bug3130e.fst(4,4-4,7)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Bug3130e.__proj__Mkord_leq__item__leq@tok
Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f))
...
@x1)
@x2)
(Bug3130e.__proj__Mkord_leq__item__leq @x1
@x2))
 

:pattern ((Bug3130e.__proj__Mkord_leq__item__leq @x1
@x2))
:qid function_token_typing_Bug3130e.__proj__Mkord_leq__item__leq.1))
)
 

:pattern ((ApplyTT @x0
Bug3130e.__proj__Mkord_leq__item__leq@tok))
:qid function_token_typing_Bug3130e.__proj__Mkord_leq__item__leq))

:named function_token_typing_Bug3130e.__proj__Mkord_leq__item__leq))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
@x1
(Bug3130e.ord_leq @x2))
(and (is-Bug3130e.Mkord_leq @x1)
(= @x2
(Bug3130e.Mkord_leq_a @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(Bug3130e.ord_leq @x2)))
:qid fuel_guarded_inversion_Bug3130e.ord_leq))

:named fuel_guarded_inversion_Bug3130e.ord_leq))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! (= 105
(Term_constr_id Bug3130e.ord_leq@tok))
:named fresh_token_Bug3130e.ord_leq@tok))
...
;;;;;;;;;;;;;;;;Equation for Bug3130e.leq
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! (forall ((@x0 Term))
 (! (= (Bug3130e.leq @x0)
(Tm_abs_9563a090f65b0f80871ba123f9571371 @x0))
 

:pattern ((Bug3130e.leq @x0))
:qid equation_Bug3130e.leq))
:named equation_Bug3130e.leq))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(HasTypeFuel @u0
@x3
(Tm_arrow_1636670e83c60650644609459794ed12 @x2
@x1)))
(HasTypeFuel @u0
(Bug3130e.Mkord_leq @x1
@x2
...
@x3)
(Bug3130e.ord_leq @x1)))
:qid data_typing_intro_Bug3130e.Mkord_leq@tok))

:named data_typing_intro_Bug3130e.Mkord_leq@tok))
...
@x3)
(Bug3130e.ord_leq @x4)))
:qid data_elim_Bug3130e.Mkord_leq))

:named data_elim_Bug3130e.Mkord_leq))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 104
(Term_constr_id (Bug3130e.ord_leq @x0)))
 

:pattern ((Bug3130e.ord_leq @x0))
:qid constructor_distinct_Bug3130e.ord_leq))

:named constructor_distinct_Bug3130e.ord_leq))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-3,13); use=Bug3130e.fst(3,6-3,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 116
(Term_constr_id (Bug3130e.Mkord_leq @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_Bug3130e.Mkord_leq))

:named constructor_distinct_Bug3130e.Mkord_leq))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x0
(Bug3130e.ord_leq @x2)))
:qid Bug3130e_pretyping_1e0f87d8787e14d0f04d193366cfc2a6))

:named Bug3130e_pretyping_1e0f87d8787e14d0f04d193366cfc2a6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-3,23); use=Bug3130e.fst(3,15-4,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5)
...
@x1
Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5))
:qid Bug3130e_pre_typing_Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5))

:named Bug3130e_pre_typing_Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug3130e.__proj__Mkord_leq__item__leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-4,23); use=Bug3130e.fst(3,6-4,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f)
...
@x1
Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f))
:qid Bug3130e_pre_typing_Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f))

:named Bug3130e_pre_typing_Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! 
;; def=dummy(0,0-0,0); use=Bug3130e.fst(3,15-4,7)
...
@x1
(Tm_arrow_649a0684309abaa78e673cf48ebf1183 @x2)))
:qid Bug3130e_pre_typing_Tm_arrow_649a0684309abaa78e673cf48ebf1183))

:named Bug3130e_pre_typing_Tm_arrow_649a0684309abaa78e673cf48ebf1183))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-3,13); use=Bug3130e.fst(3,15-4,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213 @x2)))
:qid Bug3130e_pre_typing_Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213))

:named Bug3130e_pre_typing_Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,15-5,82); use=Bug3130e.fst(5,14-5,82)
...
(Tm_arrow_1636670e83c60650644609459794ed12 @x2
@x3)))
:qid Bug3130e_pre_typing_Tm_arrow_1636670e83c60650644609459794ed12))

:named Bug3130e_pre_typing_Tm_arrow_1636670e83c60650644609459794ed12))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-3,23); use=Bug3130e.fst(3,15-4,7)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid Bug3130e_interpretation_Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5))
:qid Bug3130e_interpretation_Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5))

:named Bug3130e_interpretation_Tm_arrow_f4f669b81f23bf3ff62befdbc312d5b5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f
;;; Fact-ids: Name Bug3130e.__proj__Mkord_leq__item__leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-4,23); use=Bug3130e.fst(3,6-4,23)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Bug3130e_interpretation_Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug3130e_interpretation_Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f))
:qid Bug3130e_interpretation_Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f))

:named Bug3130e_interpretation_Tm_arrow_f48b143fd632533b114bdb2ac7faeb0f))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug3130e_interpretation_Tm_arrow_649a0684309abaa78e673cf48ebf1183.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_649a0684309abaa78e673cf48ebf1183 @x1)))
:qid Bug3130e_interpretation_Tm_arrow_649a0684309abaa78e673cf48ebf1183))

:named Bug3130e_interpretation_Tm_arrow_649a0684309abaa78e673cf48ebf1183))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213
;;; Fact-ids: Name Bug3130e.leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,6-3,13); use=Bug3130e.fst(3,15-4,7)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug3130e_interpretation_Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213 @x1)))
:qid Bug3130e_interpretation_Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213))

:named Bug3130e_interpretation_Tm_arrow_2c8f94b7419b9f987a21e9ac5de5a213))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1636670e83c60650644609459794ed12
;;; Fact-ids: Name Bug3130e.ord_leq; Namespace Bug3130e; Name Bug3130e.Mkord_leq; Namespace Bug3130e
(assert (! 
;; def=Bug3130e.fst(3,15-5,82); use=Bug3130e.fst(5,14-5,82)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_1636670e83c60650644609459794ed12 @x1
@x2))
(and 
;; def=Bug3130e.fst(3,15-5,82); use=Bug3130e.fst(5,14-5,82)
...
@x4)
@x5)
(Tm_refine_4787595aefc8d009ec100360dba96506 @x1
@x3
@x4
@x5)))
...
@x4)
@x5))
:qid Bug3130e_interpretation_Tm_arrow_1636670e83c60650644609459794ed12.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Bug3130e_interpretation_Tm_arrow_1636670e83c60650644609459794ed12.2))
...
@x3)
@x4))
:qid Bug3130e_interpretation_Tm_arrow_1636670e83c60650644609459794ed12.3))
))
...
(Tm_arrow_1636670e83c60650644609459794ed12 @x1
@x2)))
:qid Bug3130e_interpretation_Tm_arrow_1636670e83c60650644609459794ed12))

:named Bug3130e_interpretation_Tm_arrow_1636670e83c60650644609459794ed12))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Bug3130e.__proj__Mkord_leq__item__trans; Namespace Bug3130e
(assert (! (Valid (ApplyTT __uu__PartialApp
Bug3130e.__proj__Mkord_leq__item__leq@tok))
:named @kick_partial_app_250027ce1af09e88ca5917b71738e461))
(push) ;; push{2

; Starting query at Bug3130e.fst(11,4-11,15)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
Bug3130e.leq@tok))
:named @kick_partial_app_8ebff33f33ca8a0d5ad978b521b9bf3a))



; Encoding query formula : forall ('a: Prims.eqtype) (_: Bug3130e.ord_leq 'a) (x: 'a) (y: 'a) (z: 'a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         (Bug3130e.leq x y /\ Bug3130e.leq y z ==> Bug3130e.leq x z) ==> p pure_result) ==>
;     (forall (pure_result: Prims.unit). (_.leq x y /\ _.leq y z ==> _.leq x z) ==> p pure_result)
...
;; def=Prims.fst(441,36-441,97); use=Bug3130e.fst(11,4-11,15)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))
(implies 
;; def=Bug3130e.fst(9,11-9,33); use=Bug3130e.fst(11,4-11,15)
(and 
;; def=Bug3130e.fst(9,11-9,20); use=Bug3130e.fst(11,4-11,15)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x1)
@x2)
@x3))
...
;; def=Bug3130e.fst(9,24-9,33); use=Bug3130e.fst(11,4-11,15)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x1)
@x3)
...
;; def=Bug3130e.fst(9,38-9,47); use=Bug3130e.fst(11,4-11,15)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug3130e.fst(11,4-11,15)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug3130e.fst(11,4-11,15)
(ApplyTT @x5
@x6)
...
;; def=Bug3130e.fst(5,44-5,82); use=Bug3130e.fst(11,4-11,9)
(implies 
;; def=Bug3130e.fst(5,45-5,67); use=Bug3130e.fst(11,4-11,9)
(and 
;; def=Bug3130e.fst(5,45-5,54); use=Bug3130e.fst(11,4-11,9)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.__proj__Mkord_leq__item__leq@tok
@x0)
@x1)
@x2)
@x3))
...
;; def=Bug3130e.fst(5,58-5,67); use=Bug3130e.fst(11,4-11,9)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.__proj__Mkord_leq__item__leq@tok
@x0)
@x1)
@x3)
...
;; def=Bug3130e.fst(5,72-5,81); use=Bug3130e.fst(11,4-11,9)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.__proj__Mkord_leq__item__leq@tok
@x0)
@x1)
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3130e.transitivity, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.List.Tot.Base_interpretation_Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e, bool_inversion, data_elim_Bug3130e.Mkord_leq, equation_Bug3130e.leq, fuel_guarded_inversion_Bug3130e.ord_leq, interpretation_Tm_abs_9563a090f65b0f80871ba123f9571371, proj_equation_Bug3130e.Mkord_leq_leq, token_correspondence_Bug3130e.__proj__Mkord_leq__item__leq, token_correspondence_Bug3130e.leq
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug3130e.transitivity (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug3130e.transitivity@tok () Term)
...
;;;;;;;;;;;;;;;;Lemma: Bug3130e.transitivity
;;; Fact-ids: Name Bug3130e.transitivity; Namespace Bug3130e
...
;; def=Bug3130e.fst(9,11-9,20); use=Bug3130e.fst(9,11-9,20)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x1)
@x2)
...
;; def=Bug3130e.fst(9,24-9,33); use=Bug3130e.fst(9,24-9,33)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x1)
@x3)
...
;; def=Bug3130e.fst(9,38-9,47); use=Bug3130e.fst(9,38-9,47)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x1)
@x2)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x1)
@x2)
@x3) (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x1)
@x2)
@x4))
:qid lemma_Bug3130e.transitivity))
:named lemma_Bug3130e.transitivity))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Bug3130e.transitivity; Namespace Bug3130e
(assert (! (Valid (ApplyTT __uu__PartialApp
Bug3130e.leq@tok))
...
; Starting query at Bug3130e.fst(17,2-17,4)
...
; Encoding query formula : forall (_: Type) (a: Prims.eqtype) (_: Bug3130e.ord_leq a) (unused: _).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         (forall (x: a) (y: a) (z: a). Bug3130e.leq x y /\ Bug3130e.leq y z ==> Bug3130e.leq x z) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let transitivity_forall`
...
;; def=Prims.fst(441,36-441,97); use=Bug3130e.fst(17,2-17,4)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Bug3130e.fst(16,10-16,69); use=Bug3130e.fst(17,2-17,4)
...
;; def=Bug3130e.fst(16,31-16,40); use=Bug3130e.fst(17,2-17,4)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x1)
@x2)
@x6)
...
;; def=Bug3130e.fst(16,44-16,53); use=Bug3130e.fst(17,2-17,4)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x1)
@x2)
@x7)
...
;; def=Bug3130e.fst(16,58-16,67); use=Bug3130e.fst(17,2-17,4)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug3130e.fst(17,2-17,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug3130e.fst(17,2-17,4)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3130e.transitivity_forall, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, lemma_Bug3130e.transitivity
...
; encoding sigelt let transitivity_forall


; <Start encoding let transitivity_forall>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug3130e.transitivity_forall (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug3130e.transitivity_forall@tok () Term)

; </end encoding let transitivity_forall>

(push) ;; push{2

; Starting query at Bug3130e.fst(21,2-21,4)
...
; Encoding query formula : forall (a: Prims.eqtype) (_: Bug3130e.ord_leq a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let transitivity_forall2`
...
;; def=Prims.fst(441,36-441,97); use=Bug3130e.fst(21,2-21,4)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=Bug3130e.fst(20,10-20,69); use=Bug3130e.fst(21,2-21,4)
...
;; def=Bug3130e.fst(20,31-20,40); use=Bug3130e.fst(21,2-21,4)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x1)
@x4)
...
;; def=Bug3130e.fst(20,44-20,53); use=Bug3130e.fst(21,2-21,4)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x1)
@x5)
...
;; def=Bug3130e.fst(20,58-20,67); use=Bug3130e.fst(21,2-21,4)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug3130e.fst(21,2-21,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug3130e.fst(21,2-21,4)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3130e.transitivity_forall2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, lemma_Bug3130e.transitivity
...
; encoding sigelt let transitivity_forall2


; <Start encoding let transitivity_forall2>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug3130e.transitivity_forall2 (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug3130e.transitivity_forall2@tok () Term)

; </end encoding let transitivity_forall2>

(push) ;; push{2

; Starting query at Bug3130e.fst(25,2-25,4)
...
; Encoding query formula : forall (a: Prims.eqtype) (b: Type) (_: Bug3130e.ord_leq a) (unit: b).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let transitivity_forall3`
...
;; def=Prims.fst(441,36-441,97); use=Bug3130e.fst(25,2-25,4)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Bug3130e.fst(24,10-24,69); use=Bug3130e.fst(25,2-25,4)
(forall ((@x6 Term) (@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x6
@x0)
(HasType @x7
...
;; def=Bug3130e.fst(24,31-24,40); use=Bug3130e.fst(25,2-25,4)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x2)
@x6)
...
;; def=Bug3130e.fst(24,44-24,53); use=Bug3130e.fst(25,2-25,4)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug3130e.leq@tok
@x0)
@x2)
@x7)
...
;; def=Bug3130e.fst(24,58-24,67); use=Bug3130e.fst(25,2-25,4)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug3130e.fst(25,2-25,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug3130e.fst(25,2-25,4)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3130e.transitivity_forall3, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, lemma_Bug3130e.transitivity
