...
; Internals for Higher


; encoding sigelt type Higher.code


; <Start encoding type Higher.code>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Higher.code () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Higher.Eq (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Higher.Eq__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Higher.Eq__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Higher.Eq
(declare-fun Higher.Eq@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Higher.ForallInt (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Higher.ForallInt__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Higher.ForallInt
(declare-fun Higher.ForallInt@tok () Term)
;;;;;;;;;;;;;;;;_0: Prims.int -> _1: Prims.int -> code
(declare-fun Tm_arrow_108750adad36c0a7db5686f7101d8dd5 () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> code
(declare-fun Tm_arrow_54c94def8be788232ff5a3285167fb31 () Term)

;;;;;;;;;;;;;;;;_0: (_: Prims.int -> code) -> code
(declare-fun Tm_arrow_bfdc9806453b542caa18845bfcd3731e () Term)

; <start constructor Higher.code>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Higher.code ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(= __@x0
Higher.code)))

; </end constructor Higher.code>


; <start constructor Higher.Eq>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Higher.Eq ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
110)
(= __@x0
(Higher.Eq (Higher.Eq__0 __@x0)
(Higher.Eq__1 __@x0)))))

; </end constructor Higher.Eq>


; <start constructor Higher.ForallInt>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Higher.ForallInt ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
117)
(= __@x0
(Higher.ForallInt (Higher.ForallInt__0 __@x0)))))

; </end constructor Higher.ForallInt>


; </end encoding type Higher.code>


; encoding sigelt val Higher.uu___is_Eq


; <Start encoding val Higher.uu___is_Eq>

(declare-fun Higher.uu___is_Eq (Term) Term)
;;;;;;;;;;;;;;;;projectee: code -> Prims.bool
(declare-fun Tm_arrow_4a945d3764eec210f69c05f3e9ca5e4a () Term)
(declare-fun Higher.uu___is_Eq@tok () Term)

; </end encoding val Higher.uu___is_Eq>


; encoding sigelt let uu___is_Eq


; <Skipped let uu___is_Eq/>


; encoding sigelt val Higher.__proj__Eq__item___0


; <Start encoding val Higher.__proj__Eq__item___0>

(declare-fun Tm_refine_44bdae1ae5ec9c37ce6546570e928708 () Term)
(declare-fun Higher.__proj__Eq__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: code{Eq? _} -> Prims.int
(declare-fun Tm_arrow_0cd28d2ca252afa9bdd9d7b2c4bce701 () Term)
(declare-fun Higher.__proj__Eq__item___0@tok () Term)

; </end encoding val Higher.__proj__Eq__item___0>
...
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(8,4-8,13); use=Higher.fst(8,4-8,13)
...
@x2)
(Higher.ForallInt @x1))))
:qid well_founded_ordering_on_codomain_Higher.ForallInt.1))
...
(Higher.ForallInt @x1)
Higher.code))
:qid well_founded_ordering_on_codomain_Higher.ForallInt))

:named well_founded_ordering_on_codomain_Higher.ForallInt))
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Higher.uu___is_Eq; Namespace Higher
(assert (! 
;; def=Higher.fst(7,4-7,6); use=Higher.fst(7,4-7,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Higher.code)
(HasType (Higher.uu___is_Eq @x0)
Prims.bool))
 

:pattern ((Higher.uu___is_Eq @x0))
:qid typing_Higher.uu___is_Eq))

:named typing_Higher.uu___is_Eq))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(8,4-8,13); use=Higher.fst(8,4-8,13)
...
(Higher.ForallInt @x1)
Higher.code))
:qid subterm_ordering_Higher.ForallInt))

:named subterm_ordering_Higher.ForallInt))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(7,4-7,6); use=Higher.fst(7,4-7,6)
...
@x2)
Higher.code))
:qid subterm_ordering_Higher.Eq))

:named subterm_ordering_Higher.Eq))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Higher.__proj__Eq__item___0; Namespace Higher
(assert (! (HasType Tm_refine_44bdae1ae5ec9c37ce6546570e928708
Tm_type)
:named refinement_kinding_Tm_refine_44bdae1ae5ec9c37ce6546570e928708))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_44bdae1ae5ec9c37ce6546570e928708)
(and (HasTypeFuel @u0
@x1
Higher.code)

;; def=Higher.fst(7,4-7,6); use=Higher.fst(7,4-7,6)
(BoxBool_proj_0 (Higher.uu___is_Eq @x1))
))
...
@x1
Tm_refine_44bdae1ae5ec9c37ce6546570e928708))
:qid refinement_interpretation_Tm_refine_44bdae1ae5ec9c37ce6546570e928708))

:named refinement_interpretation_Tm_refine_44bdae1ae5ec9c37ce6546570e928708))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
;; def=Higher.fst(8,4-8,13); use=Higher.fst(8,4-8,13)
(forall ((@x0 Term))
 (! (= (Higher.ForallInt__0 (Higher.ForallInt @x0))
@x0)
 

:pattern ((Higher.ForallInt @x0))
:qid projection_inverse_Higher.ForallInt__0))

:named projection_inverse_Higher.ForallInt__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(7,4-7,6); use=Higher.fst(7,4-7,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Higher.Eq__1 (Higher.Eq @x0
@x1))
@x1)
 

:pattern ((Higher.Eq @x0
@x1))
:qid projection_inverse_Higher.Eq__1))

:named projection_inverse_Higher.Eq__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(7,4-7,6); use=Higher.fst(7,4-7,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Higher.Eq__0 (Higher.Eq @x0
@x1))
@x0)
...
:pattern ((Higher.Eq @x0
@x1))
:qid projection_inverse_Higher.Eq__0))

:named projection_inverse_Higher.Eq__0))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_54c94def8be788232ff5a3285167fb31
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! (HasType Tm_arrow_54c94def8be788232ff5a3285167fb31
Tm_type)
:named kinding_Tm_arrow_54c94def8be788232ff5a3285167fb31))
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! (HasType Higher.code
Tm_type)
:named kinding_Higher.code@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_44bdae1ae5ec9c37ce6546570e928708
;;; Fact-ids: Name Higher.__proj__Eq__item___0; Namespace Higher
(assert (! (iff (Valid (Prims.hasEq Tm_refine_44bdae1ae5ec9c37ce6546570e928708))
(Valid (Prims.hasEq Higher.code)))
:named haseqTm_refine_44bdae1ae5ec9c37ce6546570e928708))
...
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(6,5-6,9); use=Higher.fst(6,5-6,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Higher.code)
(or (is-Higher.Eq @x1)
(is-Higher.ForallInt @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
Higher.code))
:qid fuel_guarded_inversion_Higher.code))

:named fuel_guarded_inversion_Higher.code))
...
;; def=Higher.fst(7,4-7,6); use=Higher.fst(7,4-7,6)
(forall ((@x0 Term))
 (! (= (Higher.uu___is_Eq @x0)
(BoxBool (is-Higher.Eq @x0)))
 

:pattern ((Higher.uu___is_Eq @x0))
:qid disc_equation_Higher.Eq))

:named disc_equation_Higher.Eq))
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_54c94def8be788232ff5a3285167fb31)
(HasTypeFuel @u0
(Higher.ForallInt @x1)
Higher.code))
...
(Higher.ForallInt @x1)
Higher.code))
:qid data_typing_intro_Higher.ForallInt@tok))

:named data_typing_intro_Higher.ForallInt@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(7,4-7,6); use=Higher.fst(7,4-7,6)
...
@x2)
Higher.code))
:qid data_typing_intro_Higher.Eq@tok))

:named data_typing_intro_Higher.Eq@tok))
...
(Higher.ForallInt @x1)
Higher.code))
:qid data_elim_Higher.ForallInt))

:named data_elim_Higher.ForallInt))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(7,4-7,6); use=Higher.fst(7,4-7,6)
...
@x2)
Higher.code))
:qid data_elim_Higher.Eq))

:named data_elim_Higher.Eq))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! (= 104
(Term_constr_id Higher.code))
:named constructor_distinct_Higher.code))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(8,4-8,13); use=Higher.fst(8,4-8,13)
(forall ((@x0 Term))
 (! (= 117
(Term_constr_id (Higher.ForallInt @x0)))
 

:pattern ((Higher.ForallInt @x0))
:qid constructor_distinct_Higher.ForallInt))

:named constructor_distinct_Higher.ForallInt))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(7,4-7,6); use=Higher.fst(7,4-7,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= 110
(Term_constr_id (Higher.Eq @x0
@x1)))
 

:pattern ((Higher.Eq @x0
@x1))
:qid constructor_distinct_Higher.Eq))

:named constructor_distinct_Higher.Eq))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x0
Higher.code))
:qid Higher_pretyping_d63cba25d189bd338b33ba46b9c8a968))

:named Higher_pretyping_d63cba25d189bd338b33ba46b9c8a968))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(8,17-8,28); use=Higher.fst(8,17-8,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_54c94def8be788232ff5a3285167fb31)
...
@x1
Tm_arrow_54c94def8be788232ff5a3285167fb31))
:qid Higher_pre_typing_Tm_arrow_54c94def8be788232ff5a3285167fb31))

:named Higher_pre_typing_Tm_arrow_54c94def8be788232ff5a3285167fb31))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_54c94def8be788232ff5a3285167fb31
;;; Fact-ids: Name Higher.code; Namespace Higher; Name Higher.Eq; Namespace Higher; Name Higher.ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(8,17-8,28); use=Higher.fst(8,17-8,28)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Higher_interpretation_Tm_arrow_54c94def8be788232ff5a3285167fb31.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_54c94def8be788232ff5a3285167fb31))
:qid Higher_interpretation_Tm_arrow_54c94def8be788232ff5a3285167fb31))

:named Higher_interpretation_Tm_arrow_54c94def8be788232ff5a3285167fb31))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: Higher.code{Eq? _}).
;   (*  - Could not prove post-condition
; *) ~(Eq? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Eq__item___0`
...
(not 
;; def=Higher.fst(7,4-7,6); use=Higher.fst(7,4-7,6)
(BoxBool_proj_0 (Higher.uu___is_Eq @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Higher.__proj__Eq__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_44bdae1ae5ec9c37ce6546570e928708
...
; encoding sigelt let __proj__Eq__item___0


; <Skipped let __proj__Eq__item___0/>


; encoding sigelt val Higher.__proj__Eq__item___1


; <Start encoding val Higher.__proj__Eq__item___1>


(declare-fun Higher.__proj__Eq__item___1 (Term) Term)


(declare-fun Higher.__proj__Eq__item___1@tok () Term)

; </end encoding val Higher.__proj__Eq__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Eq__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Higher.__proj__Eq__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_44bdae1ae5ec9c37ce6546570e928708
...
; encoding sigelt let __proj__Eq__item___1


; <Skipped let __proj__Eq__item___1/>


; encoding sigelt val Higher.uu___is_ForallInt


; <Start encoding val Higher.uu___is_ForallInt>

(declare-fun Higher.uu___is_ForallInt (Term) Term)

(declare-fun Higher.uu___is_ForallInt@tok () Term)

; </end encoding val Higher.uu___is_ForallInt>


; encoding sigelt let uu___is_ForallInt


; <Skipped let uu___is_ForallInt/>


; encoding sigelt val Higher.__proj__ForallInt__item___0


; <Start encoding val Higher.__proj__ForallInt__item___0>

(declare-fun Tm_refine_3e3c609390de31424dc40da0c863a6c2 () Term)
(declare-fun Higher.__proj__ForallInt__item___0 (Term) Term)


;;;;;;;;;;;;;;;;projectee: _: code{ForallInt? _} -> _: Prims.int -> code
(declare-fun Tm_arrow_32a23704f034a251c7942e9beb3c5a18 () Term)
(declare-fun Higher.__proj__ForallInt__item___0@tok () Term)


; </end encoding val Higher.__proj__ForallInt__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Higher.uu___is_ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(8,4-8,13); use=Higher.fst(8,4-8,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Higher.code)
(HasType (Higher.uu___is_ForallInt @x0)
Prims.bool))
 

:pattern ((Higher.uu___is_ForallInt @x0))
:qid typing_Higher.uu___is_ForallInt))

:named typing_Higher.uu___is_ForallInt))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Higher.__proj__ForallInt__item___0; Namespace Higher
(assert (! (HasType Tm_refine_3e3c609390de31424dc40da0c863a6c2
Tm_type)
:named refinement_kinding_Tm_refine_3e3c609390de31424dc40da0c863a6c2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Higher.__proj__ForallInt__item___0; Namespace Higher
(assert (! 
;; def=Higher.fst(8,4-8,13); use=Higher.fst(8,4-8,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_3e3c609390de31424dc40da0c863a6c2)
(and (HasTypeFuel @u0
@x1
Higher.code)

;; def=Higher.fst(8,4-8,13); use=Higher.fst(8,4-8,13)
(BoxBool_proj_0 (Higher.uu___is_ForallInt @x1))
))
...
@x1
Tm_refine_3e3c609390de31424dc40da0c863a6c2))
:qid refinement_interpretation_Tm_refine_3e3c609390de31424dc40da0c863a6c2))

:named refinement_interpretation_Tm_refine_3e3c609390de31424dc40da0c863a6c2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3e3c609390de31424dc40da0c863a6c2
;;; Fact-ids: Name Higher.__proj__ForallInt__item___0; Namespace Higher
(assert (! (iff (Valid (Prims.hasEq Tm_refine_3e3c609390de31424dc40da0c863a6c2))
(Valid (Prims.hasEq Higher.code)))
:named haseqTm_refine_3e3c609390de31424dc40da0c863a6c2))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Higher.uu___is_ForallInt; Namespace Higher
(assert (! 
;; def=Higher.fst(8,4-8,13); use=Higher.fst(8,4-8,13)
(forall ((@x0 Term))
 (! (= (Higher.uu___is_ForallInt @x0)
(BoxBool (is-Higher.ForallInt @x0)))
 

:pattern ((Higher.uu___is_ForallInt @x0))
:qid disc_equation_Higher.ForallInt))

:named disc_equation_Higher.ForallInt))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: Higher.code{ForallInt? _}).
;   (*  - Could not prove post-condition
; *) ~(ForallInt? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__ForallInt__item___0`
...
(not 
;; def=Higher.fst(8,4-8,13); use=Higher.fst(8,4-8,13)
(BoxBool_proj_0 (Higher.uu___is_ForallInt @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Higher.__proj__ForallInt__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_3e3c609390de31424dc40da0c863a6c2
...
; encoding sigelt let __proj__ForallInt__item___0


; <Skipped let __proj__ForallInt__item___0/>
...
; Starting query at Higher.fst(11,2-13,47)

;;;;;;;;;;;;;;;;c : Higher.code (Higher.code)
(declare-fun x_d63cba25d189bd338b33ba46b9c8a968_0 () Term)
;;;;;;;;;;;;;;;;binder_x_d63cba25d189bd338b33ba46b9c8a968_0
;;; Fact-ids: 
(assert (! (HasType x_d63cba25d189bd338b33ba46b9c8a968_0
Higher.code)
:named binder_x_d63cba25d189bd338b33ba46b9c8a968_0))
(declare-fun Tm_refine_292e6ddbf6aadf5b0a32910c025e7d29 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_292e6ddbf6aadf5b0a32910c025e7d29
Tm_type)
:named refinement_kinding_Tm_refine_292e6ddbf6aadf5b0a32910c025e7d29))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(10,16-13,47); use=Higher.fst(10,16-13,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_292e6ddbf6aadf5b0a32910c025e7d29)
(and (HasTypeFuel @u0
@x1
Higher.code)

;; def=Higher.fst(11,2-13,47); use=Higher.fst(11,2-13,47)

;; def=Higher.fst(11,2-13,47); use=Higher.fst(11,2-13,47)
(Valid 
;; def=Higher.fst(11,2-13,47); use=Higher.fst(11,2-13,47)
(Prims.precedes Higher.code
Higher.code
@x1
x_d63cba25d189bd338b33ba46b9c8a968_0)
)
...
@x1
Tm_refine_292e6ddbf6aadf5b0a32910c025e7d29))
:qid refinement_interpretation_Tm_refine_292e6ddbf6aadf5b0a32910c025e7d29))

:named refinement_interpretation_Tm_refine_292e6ddbf6aadf5b0a32910c025e7d29))
;;;;;;;;;;;;;;;;haseq for Tm_refine_292e6ddbf6aadf5b0a32910c025e7d29
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_292e6ddbf6aadf5b0a32910c025e7d29))
(Valid (Prims.hasEq Higher.code)))
:named haseqTm_refine_292e6ddbf6aadf5b0a32910c025e7d29))
(declare-fun Higher.interp (Term) Term)

;;;;;;;;;;;;;;;;c: code{c << c} -> Prims.prop
(declare-fun Tm_arrow_2217d1d7a582452501f8adda3b5f55db () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2217d1d7a582452501f8adda3b5f55db
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_2217d1d7a582452501f8adda3b5f55db
Tm_type)
:named kinding_Tm_arrow_2217d1d7a582452501f8adda3b5f55db))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(10,16-13,47); use=Higher.fst(10,16-13,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2217d1d7a582452501f8adda3b5f55db)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_2217d1d7a582452501f8adda3b5f55db))
:qid Higher_pre_typing_Tm_arrow_2217d1d7a582452501f8adda3b5f55db))

:named Higher_pre_typing_Tm_arrow_2217d1d7a582452501f8adda3b5f55db))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2217d1d7a582452501f8adda3b5f55db
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(10,16-13,47); use=Higher.fst(10,16-13,47)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Higher_interpretation_Tm_arrow_2217d1d7a582452501f8adda3b5f55db.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_2217d1d7a582452501f8adda3b5f55db))
:qid Higher_interpretation_Tm_arrow_2217d1d7a582452501f8adda3b5f55db))

:named Higher_interpretation_Tm_arrow_2217d1d7a582452501f8adda3b5f55db))
(declare-fun Higher.interp@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(10,8-10,14); use=Higher.fst(10,8-10,14)
(forall ((@x0 Term))
 (! (= (ApplyTT Higher.interp@tok
@x0)
(Higher.interp @x0))
 

:pattern ((ApplyTT Higher.interp@tok
@x0))
:qid token_correspondence_Higher.interp))

:named token_correspondence_Higher.interp))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(10,8-10,14); use=Higher.fst(10,8-10,14)
...
:pattern ((Higher.interp @x1))
:qid function_token_typing_Higher.interp.1))
)
 

:pattern ((ApplyTT @x0
Higher.interp@tok))
:qid function_token_typing_Higher.interp))

:named function_token_typing_Higher.interp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(10,8-10,14); use=Higher.fst(10,8-10,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_292e6ddbf6aadf5b0a32910c025e7d29)
(HasType (Higher.interp @x0)
Prims.prop))
 

:pattern ((Higher.interp @x0))
:qid typing_Higher.interp))

:named typing_Higher.interp))
...
;   (~(Eq? c) /\ ~(ForallInt? c) ==> Prims.l_False) /\
;   (~(Eq? c) ==>
;     (forall (b: (_: Prims.int -> Higher.code)).
;         c == Higher.ForallInt b ==>
;         (forall (x: Prims.int).
;             (*  - Subtyping check failed
;   - Expected type c: code{c << c} got type code
; *) b x << c
;         )))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec interp`
...
;; def=Prims.fst(402,27-402,88); use=Higher.fst(11,2-13,47)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Higher.fst(11,2-13,47)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Higher.fst(11,2-13,47)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Higher.fst(11,2-13,47)
(and (implies 
;; def=Higher.fst(10,16-10,17); use=Higher.fst(11,8-11,9)
(and 
;; def=Higher.fst(10,16-10,17); use=Higher.fst(11,8-11,9)
(not 
;; def=Higher.fst(10,16-10,17); use=Higher.fst(11,8-11,9)
(BoxBool_proj_0 (Higher.uu___is_Eq x_d63cba25d189bd338b33ba46b9c8a968_0))
)
...
(not 
;; def=Higher.fst(10,16-10,17); use=Higher.fst(11,8-11,9)
(BoxBool_proj_0 (Higher.uu___is_ForallInt x_d63cba25d189bd338b33ba46b9c8a968_0))
)
)

label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Higher.fst(11,2-13,47)
(not 
;; def=Higher.fst(10,16-10,17); use=Higher.fst(11,8-11,9)
(BoxBool_proj_0 (Higher.uu___is_Eq x_d63cba25d189bd338b33ba46b9c8a968_0))
)
...
;; def=Prims.fst(413,99-413,120); use=Higher.fst(11,2-13,47)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Tm_arrow_54c94def8be788232ff5a3285167fb31)

;; def=Higher.fst(10,16-13,15); use=Higher.fst(11,8-13,15)
(= x_d63cba25d189bd338b33ba46b9c8a968_0
(Higher.ForallInt @x1))
)

;; def=dummy(0,0-0,0); use=Higher.fst(11,2-13,47)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=Higher.fst(11,2-13,47); use=Higher.fst(13,42-13,47)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Higher.interp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Higher_pretyping_d63cba25d189bd338b33ba46b9c8a968, binder_x_d63cba25d189bd338b33ba46b9c8a968_0, disc_equation_Higher.Eq, disc_equation_Higher.ForallInt, fuel_guarded_inversion_Higher.code, projection_inverse_BoxBool_proj_0, projection_inverse_Higher.ForallInt__0, well_founded_ordering_on_codomain_Higher.ForallInt
...
; encoding sigelt let rec interp


; <Start encoding let rec interp>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Higher.interp.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Higher.interp.fuel_instrumented_token () Term)
(declare-fun Higher.interp (Term) Term)
(declare-fun Higher.interp@tok () Term)
;;;;;;;;;;;;;;;;x: Prims.int -> Prims.GTot Type
(declare-fun Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2 () Term)
(declare-fun Tm_abs_c0a44cd0515cf5d01c6936176c972053 (Fuel Term) Term)
;;;;;;;;;;;;;;;;c: code -> Prims.prop
(declare-fun Tm_arrow_5a6e092d3a1c3fb5b6fcaeb94316ca70 () Term)

; </end encoding let rec interp>


; encoding sigelt type Higher.codeable


; <Start encoding type Higher.codeable>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Higher.codeable (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Higher.codeable@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Higher.Mkcodeable (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Higher.Mkcodeable_p (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Higher.Mkcodeable_code_of (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Higher.Mkcodeable_pf (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Higher.Mkcodeable
(declare-fun Higher.Mkcodeable@tok () Term)
(declare-fun Tm_refine_460499d21b72160e33ae643374cd0121 (Term Term) Term)

;;;;;;;;;;;;;;;;code_of: code -> pf: Prims.squash (interp code_of <==> p) -> codeable p
(declare-fun Tm_arrow_0330fedc1bf77548202675f3f4f5bf34 () Term)

; <start constructor Higher.codeable>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Higher.codeable ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
157)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-Higher.codeable))))

; </end constructor Higher.codeable>


; <start constructor Higher.Mkcodeable>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Higher.Mkcodeable ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
165)
(= __@x0
(Higher.Mkcodeable (Higher.Mkcodeable_p __@x0)
(Higher.Mkcodeable_code_of __@x0)
(Higher.Mkcodeable_pf __@x0)))))

; </end constructor Higher.Mkcodeable>


; </end encoding type Higher.codeable>


; encoding sigelt val Higher.__proj__Mkcodeable__item__code_of


; <Start encoding val Higher.__proj__Mkcodeable__item__code_of>

(declare-fun Higher.__proj__Mkcodeable__item__code_of (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: codeable p -> code
(declare-fun Tm_arrow_565ebf515c300954a288984cd90214b4 () Term)
(declare-fun Higher.__proj__Mkcodeable__item__code_of@tok () Term)

; </end encoding val Higher.__proj__Mkcodeable__item__code_of>


; encoding sigelt let __proj__Mkcodeable__item__code_of


; <Skipped let __proj__Mkcodeable__item__code_of/>


; encoding sigelt val Higher.__proj__Mkcodeable__item__pf


; <Start encoding val Higher.__proj__Mkcodeable__item__pf>

(declare-fun Higher.__proj__Mkcodeable__item__pf (Term Term) Term)
(declare-fun Tm_refine_7cdf0934593c6aa03a2608b1dcab0622 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: codeable p -> Prims.squash (interp projectee.code_of <==> p)
(declare-fun Tm_arrow_4a23e6568119d70c4ac255b60074651f () Term)
(declare-fun Higher.__proj__Mkcodeable__item__pf@tok () Term)


; </end encoding val Higher.__proj__Mkcodeable__item__pf>


; encoding sigelt let __proj__Mkcodeable__item__pf


; <Skipped let __proj__Mkcodeable__item__pf/>


; encoding sigelt let code_of


; <Start encoding let code_of>

(declare-fun Higher.code_of (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: codeable p |} -> code
(declare-fun Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: codeable p |} -> code
(declare-fun Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15 () Term)
(declare-fun Higher.code_of@tok () Term)


(declare-fun Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511 (Term) Term)

; </end encoding let code_of>


; encoding sigelt let pf


; <Start encoding let pf>

(declare-fun Higher.pf (Term) Term)

;;;;;;;;;;;;;;;;{| projectee: codeable p |} -> Prims.squash (interp projectee.code_of <==> p)
(declare-fun Tm_arrow_973822c7c89a0a9b219a569aeacfec8b (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: codeable p |} -> Prims.squash (interp projectee.code_of <==> p)
(declare-fun Tm_arrow_ceb77475cc3bc63012a72a1df745f746 () Term)
(declare-fun Higher.pf@tok () Term)




(declare-fun Tm_abs_1fa63d21aaad1dabba01444566e62b81 (Term) Term)

; </end encoding let pf>

;;;;;;;;;;;;;;;;typing_Tm_abs_c0a44cd0515cf5d01c6936176c972053
;;; Fact-ids: Name Higher.interp; Namespace Higher
(assert (! 
;; def=Higher.fst(13,19-13,47); use=Higher.fst(13,19-13,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (HasType (Tm_abs_c0a44cd0515cf5d01c6936176c972053 @u0
@x1)
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
 

:pattern ((Tm_abs_c0a44cd0515cf5d01c6936176c972053 @u0
@x1))
:qid typing_Tm_abs_c0a44cd0515cf5d01c6936176c972053))

:named typing_Tm_abs_c0a44cd0515cf5d01c6936176c972053))
;;;;;;;;;;;;;;;;free var typing
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
Higher.code)
(HasType (Higher.interp.fuel_instrumented @u0
@x1)
Prims.prop))
 

:pattern ((Higher.interp.fuel_instrumented @u0
@x1))
:qid token_correspondence_Higher.interp.fuel_instrumented))

:named token_correspondence_Higher.interp.fuel_instrumented))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
...
(Tm_abs_c0a44cd0515cf5d01c6936176c972053 @u1
@x0)))
...
;; def=Higher.fst(13,35-13,47); use=Higher.fst(13,35-13,47)
(Valid 
;; def=Higher.fst(13,35-13,47); use=Higher.fst(13,35-13,47)
(Higher.interp.fuel_instrumented @u1
(ApplyTT (Higher.ForallInt__0 @x0)
@x2))
)
)
 
;;no pats
:qid l_quant_interp_969aa0b9455973368a3ad358b6f79351.1))
)
...
(Tm_abs_c0a44cd0515cf5d01c6936176c972053 @u1
@x0))))
:qid l_quant_interp_969aa0b9455973368a3ad358b6f79351))

:named l_quant_interp_969aa0b9455973368a3ad358b6f79351))
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c0a44cd0515cf5d01c6936176c972053
;;; Fact-ids: Name Higher.interp; Namespace Higher
(assert (! 
;; def=Higher.fst(13,19-13,47); use=Higher.fst(13,19-13,47)
(forall ((@x0 Term) (@u1 Fuel) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_c0a44cd0515cf5d01c6936176c972053 @u1
@x2)
@x0)
(Higher.interp.fuel_instrumented @u1
(ApplyTT (Higher.ForallInt__0 @x2)
@x0)))
 

:pattern ((ApplyTT (Tm_abs_c0a44cd0515cf5d01c6936176c972053 @u1
@x2)
@x0))
:qid interpretation_Tm_abs_c0a44cd0515cf5d01c6936176c972053))

:named interpretation_Tm_abs_c0a44cd0515cf5d01c6936176c972053))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
(assert (! 
;; def=Prims.fst(165,5-165,11); use=Prims.fst(165,5-165,11)
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Higher.interp
;;; Fact-ids: Name Higher.interp; Namespace Higher
(assert (! 
;; def=Higher.fst(10,8-10,14); use=Higher.fst(10,8-10,14)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
Higher.code)
(= (Higher.interp.fuel_instrumented (SFuel @u0)
@x1)
(let ((@lb2 @x1))
(ite (is-Higher.Eq @lb2)
(Prims.eq2 Prims.int
(Higher.Eq__0 @lb2)
(Higher.Eq__1 @lb2))
(ite (is-Higher.ForallInt @lb2)
(Prims.l_Forall Prims.int
(Tm_abs_c0a44cd0515cf5d01c6936176c972053 @u0
@lb2))
Tm_unit)))))
 :weight 0


:pattern ((Higher.interp.fuel_instrumented (SFuel @u0)
@x1))
:qid equation_with_fuel_Higher.interp.fuel_instrumented))

:named equation_with_fuel_Higher.interp.fuel_instrumented))
...
;;; Fact-ids: Name Higher.interp; Namespace Higher
(assert (! 
;; def=Higher.fst(13,29-13,32); use=Higher.fst(13,26-13,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
...
@x1
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid Higher_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named Higher_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
...
:pattern ((ApplyTT @x0
@x1))
:qid Higher_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid Higher_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named Higher_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Higher.interp; Namespace Higher
(assert (! 
;; def=Higher.fst(10,8-10,14); use=Higher.fst(10,8-10,14)
(forall ((@u0 Fuel) (@x1 Term))
 (! (= (Higher.interp.fuel_instrumented (SFuel @u0)
@x1)
(Higher.interp.fuel_instrumented ZFuel
@x1))
 

:pattern ((Higher.interp.fuel_instrumented (SFuel @u0)
@x1))
:qid @fuel_irrelevance_Higher.interp.fuel_instrumented))

:named @fuel_irrelevance_Higher.interp.fuel_instrumented))
...
(forall ((@x0 Term))
 (! (= (Higher.interp @x0)
(Higher.interp.fuel_instrumented MaxFuel
@x0))
 

:pattern ((Higher.interp @x0))
:qid @fuel_correspondence_Higher.interp.fuel_instrumented))

:named @fuel_correspondence_Higher.interp.fuel_instrumented))
(push) ;; push{2

; Starting query at Higher.fst(21,2-22,10)
...
;     return_val == (x == y) ==> (Higher.interp (Higher.Eq x y) <==> x == y)


; Context: While encoding a query
; While typechecking the top-level declaration `let codeable_eq`
...
;; def=Prims.fst(356,2-356,58); use=Higher.fst(21,2-22,10)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.prop)

;; def=Prims.fst(356,26-356,41); use=Higher.fst(21,2-22,10)
(= @x2
(Prims.eq2 Prims.int
@x0
@x1))
...
;; def=Higher.fst(17,14-17,37); use=Higher.fst(22,7-22,9)
(or label_1

;; def=Higher.fst(17,14-17,37); use=Higher.fst(22,7-22,9)
(iff 
;; def=Higher.fst(17,15-17,29); use=Higher.fst(22,7-22,9)
(Valid 
;; def=Higher.fst(17,15-17,29); use=Higher.fst(22,7-22,9)
(Higher.interp (Higher.Eq @x0
@x1))
)


;; def=Higher.fst(20,44-20,52); use=Higher.fst(22,7-22,9)
(= @x0
@x1)
)
)
...
; encoding sigelt let codeable_eq


; <Start encoding let codeable_eq>

(declare-fun Higher.codeable_eq (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int -> codeable (x == y)
(declare-fun Tm_arrow_8b6ea862eaf50ab18f39d5714a8115df () Term)
(declare-fun Higher.codeable_eq@tok () Term)

; </end encoding let codeable_eq>

;;;;;;;;;;;;;;;;typing_Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! 
;; def=Higher.fst(16,2-16,9); use=Higher.fst(16,2-16,9)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511 @x0)
(Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3 @x0))
 

:pattern ((Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511 @x0))
:qid typing_Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511))

:named typing_Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.prop)
(HasType (Higher.code_of @x0)
(Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3 @x0)))
 

:pattern ((Higher.code_of @x0))
:qid typing_Higher.code_of))
:named typing_Higher.code_of))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
(forall ((@x0 Term))
 (! (= (ApplyTT Higher.codeable@tok
@x0)
(Higher.codeable @x0))
 

:pattern ((ApplyTT Higher.codeable@tok
@x0))

:pattern ((Higher.codeable @x0))
:qid token_correspondence_Higher.codeable@tok))

:named token_correspondence_Higher.codeable@tok))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT Higher.code_of@tok
@x0)
(Higher.code_of @x0))
 

:pattern ((ApplyTT Higher.code_of@tok
@x0))
:qid token_correspondence_Higher.code_of))
:named token_correspondence_Higher.code_of))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
...
@x3)
(Higher.codeable @x4)))
:qid subterm_ordering_Higher.Mkcodeable))

:named subterm_ordering_Higher.Mkcodeable))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(17,14-17,37); use=Higher.fst(17,14-17,37)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_460499d21b72160e33ae643374cd0121 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_460499d21b72160e33ae643374cd0121 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_460499d21b72160e33ae643374cd0121))

:named refinement_kinding_Tm_refine_460499d21b72160e33ae643374cd0121))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(17,14-17,37); use=Higher.fst(17,14-17,37)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_460499d21b72160e33ae643374cd0121 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Higher.fst(17,14-17,37); use=Higher.fst(17,14-17,37)
(iff 
;; def=Higher.fst(17,15-17,29); use=Higher.fst(17,15-17,29)
(Valid 
;; def=Higher.fst(17,15-17,29); use=Higher.fst(17,15-17,29)
(Higher.interp @x2)
)
...
;; def=Higher.fst(15,16-15,17); use=Higher.fst(17,35-17,36)
(Valid 
;; def=Higher.fst(15,16-15,17); use=Higher.fst(17,35-17,36)
@x3
)
...
(Tm_refine_460499d21b72160e33ae643374cd0121 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_460499d21b72160e33ae643374cd0121))

:named refinement_interpretation_Tm_refine_460499d21b72160e33ae643374cd0121))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Higher.Mkcodeable_pf (Higher.Mkcodeable @x0
@x1
@x2))
@x2)
 

:pattern ((Higher.Mkcodeable @x0
@x1
@x2))
:qid projection_inverse_Higher.Mkcodeable_pf))

:named projection_inverse_Higher.Mkcodeable_pf))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Higher.Mkcodeable_p (Higher.Mkcodeable @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_Higher.Mkcodeable_p))

:named projection_inverse_Higher.Mkcodeable_p))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Higher.Mkcodeable_code_of (Higher.Mkcodeable @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_Higher.Mkcodeable_code_of))

:named projection_inverse_Higher.Mkcodeable_code_of))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! (is-Tm_arrow (PreType Higher.codeable@tok))
:named pre_kinding_Higher.codeable@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! (HasType Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15
Tm_type)
:named kinding_Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-16,16); use=Higher.fst(16,2-16,9)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3 @x0)
Tm_type))
:qid kinding_Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3))

:named kinding_Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3))
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! (and (IsTotFun Higher.codeable@tok)

;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.prop)
(HasType (Higher.codeable @x0)
Tm_type))
 

:pattern ((Higher.codeable @x0))
:qid kinding_Higher.codeable@tok))
)
:named kinding_Higher.codeable@tok))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! 
;; def=Higher.fst(16,2-16,9); use=Higher.fst(16,2-16,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511 @x1)
@x0)
(let ((@lb2 @x0))
(Higher.Mkcodeable_code_of @lb2)))
 

:pattern ((ApplyTT (Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511 @x1)
@x0))
:qid interpretation_Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511))

:named interpretation_Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511))
;;;;;;;;;;;;;;;;haseq for Tm_refine_460499d21b72160e33ae643374cd0121
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(17,14-17,37); use=Higher.fst(17,14-17,37)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_460499d21b72160e33ae643374cd0121 @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_460499d21b72160e33ae643374cd0121 @x0
@x1))))
:qid haseqTm_refine_460499d21b72160e33ae643374cd0121))

:named haseqTm_refine_460499d21b72160e33ae643374cd0121))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Higher.code_of@tok
Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15))
(forall ((@x1 Term))
 (! (= (ApplyTT Higher.code_of@tok
@x1)
(Higher.code_of @x1))
...
:pattern ((Higher.code_of @x1))
:qid function_token_typing_Higher.code_of.1)))
 

:pattern ((ApplyTT @x0
Higher.code_of@tok))
:qid function_token_typing_Higher.code_of))
:named function_token_typing_Higher.code_of))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
...
@x1
(Higher.codeable @x2))
(and (is-Higher.Mkcodeable @x1)
(= @x2
(Higher.Mkcodeable_p @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(Higher.codeable @x2)))
:qid fuel_guarded_inversion_Higher.codeable))

:named fuel_guarded_inversion_Higher.codeable))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! (= 158
(Term_constr_id Higher.codeable@tok))
:named fresh_token_Higher.codeable@tok))
;;;;;;;;;;;;;;;;Equation for Higher.code_of
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! (forall ((@x0 Term))
 (! (= (Higher.code_of @x0)
(Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511 @x0))
 

:pattern ((Higher.code_of @x0))
:qid equation_Higher.code_of))
:named equation_Higher.code_of))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
...
@x3)
(Higher.codeable @x1)))
:qid data_typing_intro_Higher.Mkcodeable@tok))

:named data_typing_intro_Higher.Mkcodeable@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
...
@x3)
(Higher.codeable @x4)))
:qid data_elim_Higher.Mkcodeable))

:named data_elim_Higher.Mkcodeable))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
(forall ((@x0 Term))
 (! (= 157
(Term_constr_id (Higher.codeable @x0)))
 

:pattern ((Higher.codeable @x0))
:qid constructor_distinct_Higher.codeable))

:named constructor_distinct_Higher.codeable))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 165
(Term_constr_id (Higher.Mkcodeable @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_Higher.Mkcodeable))

:named constructor_distinct_Higher.Mkcodeable))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Higher.codeable; Namespace Higher; Name Higher.Mkcodeable; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-15,14); use=Higher.fst(15,6-15,14)
...
@x0
(Higher.codeable @x2)))
:qid Higher_pretyping_47db172409d9d1c0393b5e2b002d66b7))

:named Higher_pretyping_47db172409d9d1c0393b5e2b002d66b7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-16,16); use=Higher.fst(16,2-16,9)
...
@x1
Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15))
:qid Higher_pre_typing_Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15))

:named Higher_pre_typing_Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-16,16); use=Higher.fst(16,2-16,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3 @x2)))
:qid Higher_pre_typing_Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3))

:named Higher_pre_typing_Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-16,16); use=Higher.fst(16,2-16,9)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid Higher_interpretation_Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15))
:qid Higher_interpretation_Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15))

:named Higher_interpretation_Tm_arrow_7085dc4fc0354d2331bbd1575f5b7c15))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3
;;; Fact-ids: Name Higher.code_of; Namespace Higher
(assert (! 
;; def=Higher.fst(15,6-16,16); use=Higher.fst(16,2-16,9)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid Higher_interpretation_Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3 @x1)))
:qid Higher_interpretation_Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3))

:named Higher_interpretation_Tm_arrow_3dd5a4a1d7005bb1ade065eca41cc6e3))
(push) ;; push{2

; Starting query at Higher.fst(29,2-30,10)
...
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(26,7-26,18); use=Higher.fst(26,7-26,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_3a9c22ddc54716caa0276c05e792d97e))
:qid Higher_pre_typing_Tm_arrow_3a9c22ddc54716caa0276c05e792d97e))

:named Higher_pre_typing_Tm_arrow_3a9c22ddc54716caa0276c05e792d97e))
...
:pattern ((ApplyTT @x0
@x1))
:qid Higher_interpretation_Tm_arrow_3a9c22ddc54716caa0276c05e792d97e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_3a9c22ddc54716caa0276c05e792d97e))
:qid Higher_interpretation_Tm_arrow_3a9c22ddc54716caa0276c05e792d97e))

:named Higher_interpretation_Tm_arrow_3a9c22ddc54716caa0276c05e792d97e))
;;;;;;;;;;;;;;;;x: Prims.int -> codeable (p x)
(declare-fun Tm_arrow_825941142a368a3513e16c5691eeb7e8 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_825941142a368a3513e16c5691eeb7e8
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(27,10-27,32); use=Higher.fst(27,10-27,32)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_825941142a368a3513e16c5691eeb7e8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_825941142a368a3513e16c5691eeb7e8 @x0)
Tm_type))
:qid kinding_Tm_arrow_825941142a368a3513e16c5691eeb7e8))

:named kinding_Tm_arrow_825941142a368a3513e16c5691eeb7e8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(27,10-27,32); use=Higher.fst(27,10-27,32)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_825941142a368a3513e16c5691eeb7e8 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_825941142a368a3513e16c5691eeb7e8 @x2)))
:qid Higher_pre_typing_Tm_arrow_825941142a368a3513e16c5691eeb7e8))

:named Higher_pre_typing_Tm_arrow_825941142a368a3513e16c5691eeb7e8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_825941142a368a3513e16c5691eeb7e8
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(27,10-27,32); use=Higher.fst(27,10-27,32)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_825941142a368a3513e16c5691eeb7e8 @x1))
(and 
;; def=Higher.fst(27,10-27,32); use=Higher.fst(27,10-27,32)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
(HasType (ApplyTT @x0
@x2)
(Higher.codeable (ApplyTT @x1
@x2))))
 

:pattern ((ApplyTT @x0
@x2))
:qid Higher_interpretation_Tm_arrow_825941142a368a3513e16c5691eeb7e8.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_825941142a368a3513e16c5691eeb7e8 @x1)))
:qid Higher_interpretation_Tm_arrow_825941142a368a3513e16c5691eeb7e8))

:named Higher_interpretation_Tm_arrow_825941142a368a3513e16c5691eeb7e8))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
Higher.code_of@tok))
:named @kick_partial_app_81a215eab92b7b2fc4661766e432597d))

(declare-fun Tm_abs_918071e082b6987850ebc9a0ad632655 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_918071e082b6987850ebc9a0ad632655
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(29,32-29,53); use=Higher.fst(30,7-30,9)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_918071e082b6987850ebc9a0ad632655 @x0
@x1)
Tm_arrow_54c94def8be788232ff5a3285167fb31)
 

:pattern ((Tm_abs_918071e082b6987850ebc9a0ad632655 @x0
@x1))
:qid typing_Tm_abs_918071e082b6987850ebc9a0ad632655))

:named typing_Tm_abs_918071e082b6987850ebc9a0ad632655))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_918071e082b6987850ebc9a0ad632655
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(29,32-29,53); use=Higher.fst(30,7-30,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_918071e082b6987850ebc9a0ad632655 @x1
@x2)
@x0)
(ApplyTT (ApplyTT Higher.code_of@tok
(ApplyTT @x1
@x0))
(ApplyTT @x2
@x0)))
...
:pattern ((ApplyTT (Tm_abs_918071e082b6987850ebc9a0ad632655 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_918071e082b6987850ebc9a0ad632655))

:named interpretation_Tm_abs_918071e082b6987850ebc9a0ad632655))

(declare-fun Tm_abs_af8d3c52dfff0842d05123005b00c2ab (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_af8d3c52dfff0842d05123005b00c2ab
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(28,11-28,32); use=Higher.fst(29,2-30,10)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_af8d3c52dfff0842d05123005b00c2ab @x0)
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
 

:pattern ((Tm_abs_af8d3c52dfff0842d05123005b00c2ab @x0))
:qid typing_Tm_abs_af8d3c52dfff0842d05123005b00c2ab))

:named typing_Tm_abs_af8d3c52dfff0842d05123005b00c2ab))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_af8d3c52dfff0842d05123005b00c2ab
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(28,11-28,32); use=Higher.fst(29,2-30,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_af8d3c52dfff0842d05123005b00c2ab @x1)
@x0)
(ApplyTT @x1
@x0))
 

:pattern ((ApplyTT (Tm_abs_af8d3c52dfff0842d05123005b00c2ab @x1)
@x0))
:qid interpretation_Tm_abs_af8d3c52dfff0842d05123005b00c2ab))

:named interpretation_Tm_abs_af8d3c52dfff0842d05123005b00c2ab))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=Higher.fst(28,11-28,32); use=Higher.fst(29,2-30,10)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.l_Forall Prims.int
(Tm_abs_af8d3c52dfff0842d05123005b00c2ab @x0)))
...
;; def=Higher.fst(28,28-28,31); use=Higher.fst(29,2-30,10)
(Valid 
;; def=Higher.fst(28,28-28,31); use=Higher.fst(29,2-30,10)
(ApplyTT @x0
@x1)
...
;;no pats
:qid l_quant_interp_631ae76e0ae09859b843dd9a7861693d.1))
)
 

:pattern ((Valid (Prims.l_Forall Prims.int
(Tm_abs_af8d3c52dfff0842d05123005b00c2ab @x0))))
:qid l_quant_interp_631ae76e0ae09859b843dd9a7861693d))

:named l_quant_interp_631ae76e0ae09859b843dd9a7861693d))

; Encoding query formula : forall (p: (_: Prims.int -> Prims.prop)) (d: (x: Prims.int -> Higher.codeable (p x))).
;   (*  - Could not prove post-condition
; *)
;   forall (return_val: Prims.prop).
;     return_val == (forall (x: Prims.int). p x) ==>
;     (Higher.interp (Higher.ForallInt (fun x -> Higher.code_of)) <==> (forall (x: Prims.int). p x))


; Context: While encoding a query
; While typechecking the top-level declaration `let codeable_forall`
...
Tm_arrow_3a9c22ddc54716caa0276c05e792d97e)
(HasType @x1
(Tm_arrow_825941142a368a3513e16c5691eeb7e8 @x0)))

;; def=Prims.fst(356,2-356,58); use=Higher.fst(29,2-30,10)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.prop)

;; def=Prims.fst(356,26-356,41); use=Higher.fst(29,2-30,10)
(= @x2
(Prims.l_Forall Prims.int
(Tm_abs_af8d3c52dfff0842d05123005b00c2ab @x0)))
)

;; def=Higher.fst(17,14-17,37); use=Higher.fst(30,7-30,9)
(or label_1

;; def=Higher.fst(17,14-17,37); use=Higher.fst(30,7-30,9)
(iff 
;; def=Higher.fst(17,15-17,29); use=Higher.fst(30,7-30,9)
(Valid 
;; def=Higher.fst(17,15-17,29); use=Higher.fst(30,7-30,9)
(Higher.interp (Higher.ForallInt (Tm_abs_918071e082b6987850ebc9a0ad632655 @x0
@x1)))
)


;; def=Higher.fst(28,11-28,32); use=Higher.fst(30,7-30,9)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.int)

;; def=Higher.fst(28,28-28,31); use=Higher.fst(30,7-30,9)
(Valid 
;; def=Higher.fst(28,28-28,31); use=Higher.fst(30,7-30,9)
(ApplyTT @x0
@x3)
...
; encoding sigelt let codeable_forall


; <Start encoding let codeable_forall>

;;;;;;;;;;;;;;;;_: Prims.int -> Prims.prop
(declare-fun Tm_arrow_3a9c22ddc54716caa0276c05e792d97e () Term)
;;;;;;;;;;;;;;;;x: Prims.int -> codeable (p x)
(declare-fun Tm_arrow_825941142a368a3513e16c5691eeb7e8 (Term) Term)
(declare-fun Higher.codeable_forall (Term Term) Term)



(declare-fun Tm_abs_af8d3c52dfff0842d05123005b00c2ab (Term) Term)
;;;;;;;;;;;;;;;;p: (_: Prims.int -> Prims.prop) -> d: (x: Prims.int -> codeable (p x))   -> codeable (forall (x: Prims.int). p x)
(declare-fun Tm_arrow_1286519d78e1cd89c4121176446c5a56 () Term)
(declare-fun Higher.codeable_forall@tok () Term)
...
; </end encoding let codeable_forall>


; encoding sigelt let encode


; <Start encoding let encode>

(declare-fun Higher.encode (Term Term) Term)

(declare-fun Higher.encode@tok () Term)


; </end encoding let encode>


; encoding sigelt let test0


; <Start encoding let test0>

(declare-fun Higher.test0 (Dummy_sort) Term)

; </end encoding let test0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Higher.test0; Namespace Higher
(assert (! 
;; def=Higher.fst(35,4-35,9); use=Higher.fst(35,4-35,9)
(forall ((@u0 Dummy_sort))
 (! (HasType (Higher.test0 @u0)
Higher.code)
 

:pattern ((Higher.test0 @u0))
:qid typing_Higher.test0))

:named typing_Higher.test0))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Higher.encode; Namespace Higher
(assert (! 
;; def=Higher.fst(33,4-33,10); use=Higher.fst(33,4-33,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.prop)
(HasType @x1
(Higher.codeable @x0)))
(HasType (Higher.encode @x0
@x1)
Higher.code))
 

:pattern ((Higher.encode @x0
@x1))
:qid typing_Higher.encode))

:named typing_Higher.encode))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Higher.codeable_eq; Namespace Higher
(assert (! 
;; def=Higher.fst(20,9-20,20); use=Higher.fst(20,9-20,20)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
Prims.int))
(HasType (Higher.codeable_eq @x0
@x1)
(Higher.codeable (Prims.eq2 Prims.int
@x0
@x1))))
 

:pattern ((Higher.codeable_eq @x0
@x1))
:qid typing_Higher.codeable_eq))

:named typing_Higher.codeable_eq))
;;;;;;;;;;;;;;;;Equation for Higher.test0
;;; Fact-ids: Name Higher.test0; Namespace Higher
(assert (! 
;; def=Higher.fst(35,4-35,9); use=Higher.fst(35,4-35,9)
(forall ((@u0 Dummy_sort))
...
(Higher.encode Prims.l_True
(Higher.codeable_eq (BoxInt 1)
(BoxInt 1))))
...
:qid equation_Higher.test0))

:named equation_Higher.test0))
;;;;;;;;;;;;;;;;Equation for Higher.encode
;;; Fact-ids: Name Higher.encode; Namespace Higher
(assert (! 
;; def=Higher.fst(33,4-33,10); use=Higher.fst(33,4-33,10)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((Higher.encode @x0
@x1))
:qid equation_Higher.encode))

:named equation_Higher.encode))
;;;;;;;;;;;;;;;;Equation for Higher.codeable_eq
;;; Fact-ids: Name Higher.codeable_eq; Namespace Higher
(assert (! 
;; def=Higher.fst(20,9-20,20); use=Higher.fst(20,9-20,20)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Higher.codeable_eq @x0
@x1)
(Higher.Mkcodeable (Prims.eq2 Prims.int
@x0
@x1)
(Higher.Eq @x0
@x1)
...
:pattern ((Higher.codeable_eq @x0
@x1))
:qid equation_Higher.codeable_eq))

:named equation_Higher.codeable_eq))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Higher.codeable_forall; Namespace Higher
(assert (! (Valid (ApplyTT __uu__PartialApp
Higher.code_of@tok))
:named @kick_partial_app_81a215eab92b7b2fc4661766e432597d))
(push) ;; push{2

; Starting query at Higher.fst(36,0-36,32)

(declare-fun label_1 () Bool)

; Encoding query formula : Higher.test0 == Higher.Eq 1 1
...
;;; Fact-ids: 
(assert (! (not 
;; def=Higher.fst(36,15-36,32); use=Higher.fst(36,8-36,14)
(or label_1

;; def=Higher.fst(36,15-36,32); use=Higher.fst(36,8-36,14)
(= (Higher.test0 Dummy_value)
(Higher.Eq (BoxInt 1)
(BoxInt 1)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Higher.uu___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Higher.code_of, equation_Higher.codeable_eq, equation_Higher.encode, equation_Higher.test0, equation_Prims.l_True, interpretation_Tm_abs_c0d5eff56c4577559ce0a0ccfc63c511, projection_inverse_Higher.Mkcodeable_code_of, token_correspondence_Higher.code_of
