...
; Internals for NegativeTests.Positivity


; encoding sigelt type NegativeTests.Positivity.t3


; <Start encoding type NegativeTests.Positivity.t3>

;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Positivity.t3 (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun NegativeTests.Positivity.t3@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Positivity.C31 (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C31_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C31__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: NegativeTests.Positivity.C31
(declare-fun NegativeTests.Positivity.C31@tok () Term)
;;;;;;;;;;;;;;;;_: a -> Prims.nat
(declare-fun Tm_arrow_1eea001dc988a6a52767d18e2341e80f (Term) Term)

;;;;;;;;;;;;;;;;_0: (_: a -> Prims.nat) -> t3 a
(declare-fun Tm_arrow_ed3bf1b5f238ba146e50540903299ea8 () Term)

; <start constructor NegativeTests.Positivity.t3>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Positivity.t3 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
120)
(exists ((@x0 Term))
 (! (= __@x0
(NegativeTests.Positivity.t3 @x0))
 
;;no pats
:qid is-NegativeTests.Positivity.t3))))

; </end constructor NegativeTests.Positivity.t3>


; <start constructor NegativeTests.Positivity.C31>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Positivity.C31 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
129)
(= __@x0
(NegativeTests.Positivity.C31 (NegativeTests.Positivity.C31_a __@x0)
(NegativeTests.Positivity.C31__0 __@x0)))))

; </end constructor NegativeTests.Positivity.C31>


; </end encoding type NegativeTests.Positivity.t3>


; encoding sigelt val NegativeTests.Positivity.uu___is_C31


; <Start encoding val NegativeTests.Positivity.uu___is_C31>

(declare-fun NegativeTests.Positivity.uu___is_C31 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: t3 a -> Prims.bool
(declare-fun Tm_arrow_a75382f0f7ae5a6f0520effcbe1ad759 () Term)
(declare-fun NegativeTests.Positivity.uu___is_C31@tok () Term)

; </end encoding val NegativeTests.Positivity.uu___is_C31>


; encoding sigelt let uu___is_C31


; <Skipped let uu___is_C31/>


; encoding sigelt val NegativeTests.Positivity.__proj__C31__item___0


; <Start encoding val NegativeTests.Positivity.__proj__C31__item___0>

(declare-fun NegativeTests.Positivity.__proj__C31__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: t3 a -> _: a -> Prims.nat
(declare-fun Tm_arrow_dcade46555d86cf8c1dd7654cb8332b5 () Term)
(declare-fun NegativeTests.Positivity.__proj__C31__item___0@tok () Term)


; </end encoding val NegativeTests.Positivity.__proj__C31__item___0>


; encoding sigelt let __proj__C31__item___0


; <Skipped let __proj__C31__item___0/>


; encoding sigelt type NegativeTests.Positivity.t4


; <Start encoding type NegativeTests.Positivity.t4>

;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Positivity.t4 (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun NegativeTests.Positivity.t4@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Positivity.C41 (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C41_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C41__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: NegativeTests.Positivity.C41
(declare-fun NegativeTests.Positivity.C41@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Positivity.C42 (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C42_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C42__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C42__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: NegativeTests.Positivity.C42
(declare-fun NegativeTests.Positivity.C42@tok () Term)
;;;;;;;;;;;;;;;;_0: t3 a -> t4 a
(declare-fun Tm_arrow_9b5bf1a84263b87bdb6c5cb955c4ff30 () Term)
;;;;;;;;;;;;;;;;_0: a -> _1: t4 a -> t4 a
(declare-fun Tm_arrow_21994a9c8dc73a5b59c9cd39193024fc () Term)

; <start constructor NegativeTests.Positivity.t4>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Positivity.t4 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
143)
(exists ((@x0 Term))
 (! (= __@x0
(NegativeTests.Positivity.t4 @x0))
 
;;no pats
:qid is-NegativeTests.Positivity.t4))))

; </end constructor NegativeTests.Positivity.t4>


; <start constructor NegativeTests.Positivity.C41>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Positivity.C41 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
150)
(= __@x0
(NegativeTests.Positivity.C41 (NegativeTests.Positivity.C41_a __@x0)
(NegativeTests.Positivity.C41__0 __@x0)))))

; </end constructor NegativeTests.Positivity.C41>


; <start constructor NegativeTests.Positivity.C42>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Positivity.C42 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
155)
(= __@x0
(NegativeTests.Positivity.C42 (NegativeTests.Positivity.C42_a __@x0)
(NegativeTests.Positivity.C42__0 __@x0)
(NegativeTests.Positivity.C42__1 __@x0)))))

; </end constructor NegativeTests.Positivity.C42>


; </end encoding type NegativeTests.Positivity.t4>


; encoding sigelt val NegativeTests.Positivity.uu___is_C41


; <Start encoding val NegativeTests.Positivity.uu___is_C41>

(declare-fun NegativeTests.Positivity.uu___is_C41 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: t4 a -> Prims.bool
(declare-fun Tm_arrow_fa7f513626e2ae54eb903cf65113cf05 () Term)
(declare-fun NegativeTests.Positivity.uu___is_C41@tok () Term)

; </end encoding val NegativeTests.Positivity.uu___is_C41>


; encoding sigelt let uu___is_C41


; <Skipped let uu___is_C41/>


; encoding sigelt val NegativeTests.Positivity.__proj__C41__item___0


; <Start encoding val NegativeTests.Positivity.__proj__C41__item___0>

(declare-fun Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0 (Term) Term)
(declare-fun NegativeTests.Positivity.__proj__C41__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t4 a {C41? _} -> t3 a
(declare-fun Tm_arrow_9bc5d301536476a51db359c0d2d69c13 () Term)
(declare-fun NegativeTests.Positivity.__proj__C41__item___0@tok () Term)

; </end encoding val NegativeTests.Positivity.__proj__C41__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Positivity.uu___is_C41; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(NegativeTests.Positivity.t4 @x0)))
(HasType (NegativeTests.Positivity.uu___is_C41 @x0
@x1)
Prims.bool))
 

:pattern ((NegativeTests.Positivity.uu___is_C41 @x0
@x1))
:qid typing_NegativeTests.Positivity.uu___is_C41))

:named typing_NegativeTests.Positivity.uu___is_C41))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(31,10-31,12); use=NegativeTests.Positivity.fst(31,10-31,12)
(forall ((@x0 Term))
 (! (= (ApplyTT NegativeTests.Positivity.t4@tok
@x0)
(NegativeTests.Positivity.t4 @x0))
 

:pattern ((ApplyTT NegativeTests.Positivity.t4@tok
@x0))

:pattern ((NegativeTests.Positivity.t4 @x0))
:qid token_correspondence_NegativeTests.Positivity.t4@tok))

:named token_correspondence_NegativeTests.Positivity.t4@tok))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(27,10-27,12); use=NegativeTests.Positivity.fst(27,10-27,12)
(forall ((@x0 Term))
 (! (= (ApplyTT NegativeTests.Positivity.t3@tok
@x0)
(NegativeTests.Positivity.t3 @x0))
 

:pattern ((ApplyTT NegativeTests.Positivity.t3@tok
@x0))

:pattern ((NegativeTests.Positivity.t3 @x0))
:qid token_correspondence_NegativeTests.Positivity.t3@tok))

:named token_correspondence_NegativeTests.Positivity.t3@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(NegativeTests.Positivity.C42 @x1
@x2
@x3)
(NegativeTests.Positivity.t4 @x4))
...
@x3)
(NegativeTests.Positivity.t4 @x4)))
:qid subterm_ordering_NegativeTests.Positivity.C42))

:named subterm_ordering_NegativeTests.Positivity.C42))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(NegativeTests.Positivity.C41 @x1
@x2)
(NegativeTests.Positivity.t4 @x3))
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(NegativeTests.Positivity.C41 @x1
...
@x2)
(NegativeTests.Positivity.t4 @x3)))
:qid subterm_ordering_NegativeTests.Positivity.C41))

:named subterm_ordering_NegativeTests.Positivity.C41))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(28,4-28,7); use=NegativeTests.Positivity.fst(28,4-28,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(NegativeTests.Positivity.C31 @x1
@x2)
(NegativeTests.Positivity.t3 @x3))
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(NegativeTests.Positivity.C31 @x1
...
@x2)
(NegativeTests.Positivity.t3 @x3)))
:qid subterm_ordering_NegativeTests.Positivity.C31))

:named subterm_ordering_NegativeTests.Positivity.C31))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name NegativeTests.Positivity.__proj__C41__item___0; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0))

:named refinement_kinding_Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0 @x2))
(and (HasTypeFuel @u0
@x1
(NegativeTests.Positivity.t4 @x2))

;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(BoxBool_proj_0 (NegativeTests.Positivity.uu___is_C41 @x2
@x1))
))
...
@x1
(Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0 @x2)))
:qid refinement_interpretation_Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0))

:named refinement_interpretation_Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Monotonic.Heap.lemma_free_addr_unused_in; Namespace FStar.Monotonic.Heap
(assert (! 
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (NegativeTests.Positivity.C42_a (NegativeTests.Positivity.C42 @x0
@x1
@x2))
@x0)
 

:pattern ((NegativeTests.Positivity.C42 @x0
@x1
@x2))
:qid projection_inverse_NegativeTests.Positivity.C42_a))

:named projection_inverse_NegativeTests.Positivity.C42_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (NegativeTests.Positivity.C42__1 (NegativeTests.Positivity.C42 @x0
@x1
@x2))
@x2)
...
@x1
@x2))
:qid projection_inverse_NegativeTests.Positivity.C42__1))

:named projection_inverse_NegativeTests.Positivity.C42__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (NegativeTests.Positivity.C42__0 (NegativeTests.Positivity.C42 @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_NegativeTests.Positivity.C42__0))

:named projection_inverse_NegativeTests.Positivity.C42__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (NegativeTests.Positivity.C41_a (NegativeTests.Positivity.C41 @x0
@x1))
@x0)
 

:pattern ((NegativeTests.Positivity.C41 @x0
@x1))
:qid projection_inverse_NegativeTests.Positivity.C41_a))

:named projection_inverse_NegativeTests.Positivity.C41_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (NegativeTests.Positivity.C41__0 (NegativeTests.Positivity.C41 @x0
@x1))
@x1)
...
:pattern ((NegativeTests.Positivity.C41 @x0
@x1))
:qid projection_inverse_NegativeTests.Positivity.C41__0))

:named projection_inverse_NegativeTests.Positivity.C41__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(28,4-28,7); use=NegativeTests.Positivity.fst(28,4-28,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (NegativeTests.Positivity.C31_a (NegativeTests.Positivity.C31 @x0
@x1))
@x0)
 

:pattern ((NegativeTests.Positivity.C31 @x0
@x1))
:qid projection_inverse_NegativeTests.Positivity.C31_a))

:named projection_inverse_NegativeTests.Positivity.C31_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(28,4-28,7); use=NegativeTests.Positivity.fst(28,4-28,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (NegativeTests.Positivity.C31__0 (NegativeTests.Positivity.C31 @x0
@x1))
@x1)
...
:pattern ((NegativeTests.Positivity.C31 @x0
@x1))
:qid projection_inverse_NegativeTests.Positivity.C31__0))

:named projection_inverse_NegativeTests.Positivity.C31__0))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! (is-Tm_arrow (PreType NegativeTests.Positivity.t4@tok))
:named pre_kinding_NegativeTests.Positivity.t4@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! (is-Tm_arrow (PreType NegativeTests.Positivity.t3@tok))
:named pre_kinding_NegativeTests.Positivity.t3@tok))
...
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(27,14-28,18); use=NegativeTests.Positivity.fst(28,10-28,18)
(forall ((@x0 Term))
...
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! (and (IsTotFun NegativeTests.Positivity.t4@tok)

;; def=NegativeTests.Positivity.fst(31,10-31,12); use=NegativeTests.Positivity.fst(31,10-31,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (NegativeTests.Positivity.t4 @x0)
Tm_type))
 

:pattern ((NegativeTests.Positivity.t4 @x0))
:qid kinding_NegativeTests.Positivity.t4@tok))
)
:named kinding_NegativeTests.Positivity.t4@tok))
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! (and (IsTotFun NegativeTests.Positivity.t3@tok)

;; def=NegativeTests.Positivity.fst(27,10-27,12); use=NegativeTests.Positivity.fst(27,10-27,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (NegativeTests.Positivity.t3 @x0)
Tm_type))
 

:pattern ((NegativeTests.Positivity.t3 @x0))
:qid kinding_NegativeTests.Positivity.t3@tok))
)
:named kinding_NegativeTests.Positivity.t3@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0
;;; Fact-ids: Name NegativeTests.Positivity.__proj__C41__item___0; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0 @x0)))
(Valid (Prims.hasEq (NegativeTests.Positivity.t4 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0 @x0))))
:qid haseqTm_refine_b87d6bbfde336dc7bda327a6b8b57fe0))

:named haseqTm_refine_b87d6bbfde336dc7bda327a6b8b57fe0))
...
@x1
(NegativeTests.Positivity.t4 @x2))
(or (and (is-NegativeTests.Positivity.C41 @x1)
(= @x2
(NegativeTests.Positivity.C41_a @x1)))
(and (is-NegativeTests.Positivity.C42 @x1)
(= @x2
(NegativeTests.Positivity.C42_a @x1)))))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
(NegativeTests.Positivity.t4 @x2)))
:qid fuel_guarded_inversion_NegativeTests.Positivity.t4))

:named fuel_guarded_inversion_NegativeTests.Positivity.t4))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(27,10-27,12); use=NegativeTests.Positivity.fst(27,10-27,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(NegativeTests.Positivity.t3 @x2))
(and (is-NegativeTests.Positivity.C31 @x1)
(= @x2
(NegativeTests.Positivity.C31_a @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(NegativeTests.Positivity.t3 @x2)))
:qid fuel_guarded_inversion_NegativeTests.Positivity.t3))

:named fuel_guarded_inversion_NegativeTests.Positivity.t3))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! (= 144
(Term_constr_id NegativeTests.Positivity.t4@tok))
:named fresh_token_NegativeTests.Positivity.t4@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! (= 121
(Term_constr_id NegativeTests.Positivity.t3@tok))
:named fresh_token_NegativeTests.Positivity.t3@tok))
...
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (NegativeTests.Positivity.uu___is_C41 @x0
@x1)
(BoxBool (is-NegativeTests.Positivity.C41 @x1)))
 

:pattern ((NegativeTests.Positivity.uu___is_C41 @x0
@x1))
:qid disc_equation_NegativeTests.Positivity.C41))

:named disc_equation_NegativeTests.Positivity.C41))
...
(HasTypeFuel @u0
@x3
(NegativeTests.Positivity.t4 @x1)))
(HasTypeFuel @u0
(NegativeTests.Positivity.C42 @x1
@x2
@x3)
...
@x3)
(NegativeTests.Positivity.t4 @x1)))
:qid data_typing_intro_NegativeTests.Positivity.C42@tok))

:named data_typing_intro_NegativeTests.Positivity.C42@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
...
(HasTypeFuel @u0
@x2
(NegativeTests.Positivity.t3 @x1)))
(HasTypeFuel @u0
(NegativeTests.Positivity.C41 @x1
@x2)
(NegativeTests.Positivity.t4 @x1)))
...
@x2)
(NegativeTests.Positivity.t4 @x1)))
:qid data_typing_intro_NegativeTests.Positivity.C41@tok))

:named data_typing_intro_NegativeTests.Positivity.C41@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(28,4-28,7); use=NegativeTests.Positivity.fst(28,4-28,7)
...
@x2)
(NegativeTests.Positivity.t3 @x1)))
:qid data_typing_intro_NegativeTests.Positivity.C31@tok))

:named data_typing_intro_NegativeTests.Positivity.C31@tok))
...
@x3)
(NegativeTests.Positivity.t4 @x4)))
:qid data_elim_NegativeTests.Positivity.C42))

:named data_elim_NegativeTests.Positivity.C42))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
...
@x2)
(NegativeTests.Positivity.t4 @x3)))
:qid data_elim_NegativeTests.Positivity.C41))

:named data_elim_NegativeTests.Positivity.C41))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(28,4-28,7); use=NegativeTests.Positivity.fst(28,4-28,7)
...
(HasTypeFuel @u0
@x2
(Tm_arrow_1eea001dc988a6a52767d18e2341e80f @x3))))
...
@x2)
(NegativeTests.Positivity.t3 @x3)))
:qid data_elim_NegativeTests.Positivity.C31))

:named data_elim_NegativeTests.Positivity.C31))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 143
(Term_constr_id (NegativeTests.Positivity.t4 @x0)))
 

:pattern ((NegativeTests.Positivity.t4 @x0))
:qid constructor_distinct_NegativeTests.Positivity.t4))

:named constructor_distinct_NegativeTests.Positivity.t4))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(27,10-27,12); use=NegativeTests.Positivity.fst(27,10-27,12)
(forall ((@x0 Term))
 (! (= 120
(Term_constr_id (NegativeTests.Positivity.t3 @x0)))
 

:pattern ((NegativeTests.Positivity.t3 @x0))
:qid constructor_distinct_NegativeTests.Positivity.t3))

:named constructor_distinct_NegativeTests.Positivity.t3))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 155
(Term_constr_id (NegativeTests.Positivity.C42 @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_NegativeTests.Positivity.C42))

:named constructor_distinct_NegativeTests.Positivity.C42))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= 150
(Term_constr_id (NegativeTests.Positivity.C41 @x0
@x1)))
 

:pattern ((NegativeTests.Positivity.C41 @x0
@x1))
:qid constructor_distinct_NegativeTests.Positivity.C41))

:named constructor_distinct_NegativeTests.Positivity.C41))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Positivity.t3; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C31; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(28,4-28,7); use=NegativeTests.Positivity.fst(28,4-28,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= 129
(Term_constr_id (NegativeTests.Positivity.C31 @x0
@x1)))
 

:pattern ((NegativeTests.Positivity.C31 @x0
@x1))
:qid constructor_distinct_NegativeTests.Positivity.C31))

:named constructor_distinct_NegativeTests.Positivity.C31))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Monotonic.Heap.core_mref; Namespace FStar.Monotonic.Heap
(assert (! 
;; def=FStar.Monotonic.Heap.fsti(39,4-39,13); use=FStar.Monotonic.Heap.fsti(39,4-39,13)
...
@x0
(NegativeTests.Positivity.t3 @x2)))
:qid NegativeTests.Positivity_pretyping_fee9e248dd62f176ed0430fba6084480))

:named NegativeTests.Positivity_pretyping_fee9e248dd62f176ed0430fba6084480))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name NegativeTests.Positivity.t4; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C41; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(31,10-31,12); use=NegativeTests.Positivity.fst(31,10-31,12)
...
@x0
(NegativeTests.Positivity.t4 @x2)))
:qid NegativeTests.Positivity_pretyping_d073428ca2aec9fa39a068c22a0f349e))

:named NegativeTests.Positivity_pretyping_d073428ca2aec9fa39a068c22a0f349e))
...
@x1
(Tm_arrow_1eea001dc988a6a52767d18e2341e80f @x2)))
:qid NegativeTests.Positivity_pre_typing_Tm_arrow_1eea001dc988a6a52767d18e2341e80f))

:named NegativeTests.Positivity_pre_typing_Tm_arrow_1eea001dc988a6a52767d18e2341e80f))
...
:pattern ((ApplyTT @x0
@x2))
:qid NegativeTests.Positivity_interpretation_Tm_arrow_1eea001dc988a6a52767d18e2341e80f.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_1eea001dc988a6a52767d18e2341e80f @x1)))
:qid NegativeTests.Positivity_interpretation_Tm_arrow_1eea001dc988a6a52767d18e2341e80f))

:named NegativeTests.Positivity_interpretation_Tm_arrow_1eea001dc988a6a52767d18e2341e80f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
; Encoding query formula : forall (a: Type) (projectee: _: NegativeTests.Positivity.t4 a {C41? _}).
;   (*  - Could not prove post-condition
; *) ~(C41? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__C41__item___0`
...
Tm_type)
(HasType @x1
(Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0 @x0))

;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(not 
;; def=NegativeTests.Positivity.fst(32,4-32,7); use=NegativeTests.Positivity.fst(32,4-32,7)
(BoxBool_proj_0 (NegativeTests.Positivity.uu___is_C41 @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Positivity.__proj__C41__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_b87d6bbfde336dc7bda327a6b8b57fe0
...
; encoding sigelt let __proj__C41__item___0


; <Skipped let __proj__C41__item___0/>


; encoding sigelt val NegativeTests.Positivity.uu___is_C42


; <Start encoding val NegativeTests.Positivity.uu___is_C42>

(declare-fun NegativeTests.Positivity.uu___is_C42 (Term Term) Term)

(declare-fun NegativeTests.Positivity.uu___is_C42@tok () Term)

; </end encoding val NegativeTests.Positivity.uu___is_C42>


; encoding sigelt let uu___is_C42


; <Skipped let uu___is_C42/>


; encoding sigelt val NegativeTests.Positivity.__proj__C42__item___0


; <Start encoding val NegativeTests.Positivity.__proj__C42__item___0>

(declare-fun Tm_refine_57bfa41d0d733420720971d3c9002d84 (Term) Term)
(declare-fun NegativeTests.Positivity.__proj__C42__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t4 a {C42? _} -> a
(declare-fun Tm_arrow_91a2b275c7e3abefc8075b8b81900633 () Term)
(declare-fun NegativeTests.Positivity.__proj__C42__item___0@tok () Term)

; </end encoding val NegativeTests.Positivity.__proj__C42__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Positivity.uu___is_C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(NegativeTests.Positivity.t4 @x0)))
(HasType (NegativeTests.Positivity.uu___is_C42 @x0
@x1)
Prims.bool))
 

:pattern ((NegativeTests.Positivity.uu___is_C42 @x0
@x1))
:qid typing_NegativeTests.Positivity.uu___is_C42))

:named typing_NegativeTests.Positivity.uu___is_C42))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name NegativeTests.Positivity.__proj__C42__item___0; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_57bfa41d0d733420720971d3c9002d84 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_57bfa41d0d733420720971d3c9002d84 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_57bfa41d0d733420720971d3c9002d84))

:named refinement_kinding_Tm_refine_57bfa41d0d733420720971d3c9002d84))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name NegativeTests.Positivity.__proj__C42__item___0; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_57bfa41d0d733420720971d3c9002d84 @x2))
(and (HasTypeFuel @u0
@x1
(NegativeTests.Positivity.t4 @x2))

;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(BoxBool_proj_0 (NegativeTests.Positivity.uu___is_C42 @x2
@x1))
))
...
@x1
(Tm_refine_57bfa41d0d733420720971d3c9002d84 @x2)))
:qid refinement_interpretation_Tm_refine_57bfa41d0d733420720971d3c9002d84))

:named refinement_interpretation_Tm_refine_57bfa41d0d733420720971d3c9002d84))
;;;;;;;;;;;;;;;;haseq for Tm_refine_57bfa41d0d733420720971d3c9002d84
;;; Fact-ids: Name NegativeTests.Positivity.__proj__C42__item___0; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_57bfa41d0d733420720971d3c9002d84 @x0)))
(Valid (Prims.hasEq (NegativeTests.Positivity.t4 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_57bfa41d0d733420720971d3c9002d84 @x0))))
:qid haseqTm_refine_57bfa41d0d733420720971d3c9002d84))

:named haseqTm_refine_57bfa41d0d733420720971d3c9002d84))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name NegativeTests.Positivity.uu___is_C42; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (NegativeTests.Positivity.uu___is_C42 @x0
@x1)
(BoxBool (is-NegativeTests.Positivity.C42 @x1)))
 

:pattern ((NegativeTests.Positivity.uu___is_C42 @x0
@x1))
:qid disc_equation_NegativeTests.Positivity.C42))

:named disc_equation_NegativeTests.Positivity.C42))
(push) ;; push{2
...
; Encoding query formula : forall (a: Type) (projectee: _: NegativeTests.Positivity.t4 a {C42? _}).
;   (*  - Could not prove post-condition
; *) ~(C42? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__C42__item___0`
...
Tm_type)
(HasType @x1
(Tm_refine_57bfa41d0d733420720971d3c9002d84 @x0))

;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(not 
;; def=NegativeTests.Positivity.fst(33,4-33,7); use=NegativeTests.Positivity.fst(33,4-33,7)
(BoxBool_proj_0 (NegativeTests.Positivity.uu___is_C42 @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Positivity.__proj__C42__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_57bfa41d0d733420720971d3c9002d84
...
; encoding sigelt let __proj__C42__item___0


; <Skipped let __proj__C42__item___0/>


; encoding sigelt val NegativeTests.Positivity.__proj__C42__item___1


; <Start encoding val NegativeTests.Positivity.__proj__C42__item___1>


(declare-fun NegativeTests.Positivity.__proj__C42__item___1 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t4 a {C42? _} -> t4 a
(declare-fun Tm_arrow_c65da02352256a9b42dc06d7a1f8dd29 () Term)
(declare-fun NegativeTests.Positivity.__proj__C42__item___1@tok () Term)

; </end encoding val NegativeTests.Positivity.__proj__C42__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__C42__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Positivity.__proj__C42__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_57bfa41d0d733420720971d3c9002d84
...
; encoding sigelt let __proj__C42__item___1


; <Skipped let __proj__C42__item___1/>


; encoding sigelt type NegativeTests.Positivity.t6


; <Start encoding type NegativeTests.Positivity.t6>

;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Positivity.t6 (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun NegativeTests.Positivity.t6@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Positivity.C61 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C61_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C61_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C61__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C61__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: NegativeTests.Positivity.C61
(declare-fun NegativeTests.Positivity.C61@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Positivity.C62 (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C62_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Positivity.C62_b (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: NegativeTests.Positivity.C62
(declare-fun NegativeTests.Positivity.C62@tok () Term)


;;;;;;;;;;;;;;;;_0: (_: a -> b) -> _1: t6 b a -> t6 a b
(declare-fun Tm_arrow_977b5722f112472239a5fad5491c4ede () Term)
;;;;;;;;;;;;;;;;t6 a b
(declare-fun Tm_arrow_c9001a1397abbd618a4ddc3f8184de21 () Term)

; <start constructor NegativeTests.Positivity.t6>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Positivity.t6 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
191)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
(NegativeTests.Positivity.t6 @x0
@x1))
 
;;no pats
:qid is-NegativeTests.Positivity.t6))))

; </end constructor NegativeTests.Positivity.t6>


; <start constructor NegativeTests.Positivity.C61>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Positivity.C61 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
200)
(= __@x0
(NegativeTests.Positivity.C61 (NegativeTests.Positivity.C61_a __@x0)
(NegativeTests.Positivity.C61_b __@x0)
(NegativeTests.Positivity.C61__0 __@x0)
(NegativeTests.Positivity.C61__1 __@x0)))))

; </end constructor NegativeTests.Positivity.C61>


; <start constructor NegativeTests.Positivity.C62>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Positivity.C62 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
207)
(= __@x0
(NegativeTests.Positivity.C62 (NegativeTests.Positivity.C62_a __@x0)
(NegativeTests.Positivity.C62_b __@x0)))))

; </end constructor NegativeTests.Positivity.C62>


; </end encoding type NegativeTests.Positivity.t6>


; encoding sigelt val NegativeTests.Positivity.uu___is_C61


; <Start encoding val NegativeTests.Positivity.uu___is_C61>

(declare-fun NegativeTests.Positivity.uu___is_C61 (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: t6 a b -> Prims.bool
(declare-fun Tm_arrow_1cc4fd2cf8837d4646ebee4eba7291f8 () Term)
(declare-fun NegativeTests.Positivity.uu___is_C61@tok () Term)

; </end encoding val NegativeTests.Positivity.uu___is_C61>


; encoding sigelt let uu___is_C61


; <Skipped let uu___is_C61/>


; encoding sigelt val NegativeTests.Positivity.__proj__C61__item___0


; <Start encoding val NegativeTests.Positivity.__proj__C61__item___0>

(declare-fun Tm_refine_d189dce05c186475c90958872418b4e6 (Term Term) Term)
(declare-fun NegativeTests.Positivity.__proj__C61__item___0 (Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: t6 a b {C61? _} -> _: a -> b
(declare-fun Tm_arrow_043992b3e6e736a77e1edc88d402ba7c () Term)
(declare-fun NegativeTests.Positivity.__proj__C61__item___0@tok () Term)


; </end encoding val NegativeTests.Positivity.__proj__C61__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Positivity.uu___is_C61; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(NegativeTests.Positivity.t6 @x0
@x1)))
(HasType (NegativeTests.Positivity.uu___is_C61 @x0
@x1
@x2)
Prims.bool))
 

:pattern ((NegativeTests.Positivity.uu___is_C61 @x0
@x1
@x2))
:qid typing_NegativeTests.Positivity.uu___is_C61))

:named typing_NegativeTests.Positivity.uu___is_C61))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(42,10-42,12); use=NegativeTests.Positivity.fst(42,10-42,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT NegativeTests.Positivity.t6@tok
@x0)
@x1)
(NegativeTests.Positivity.t6 @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT NegativeTests.Positivity.t6@tok
@x0)
@x1))

:pattern ((NegativeTests.Positivity.t6 @x0
@x1))
:qid token_correspondence_NegativeTests.Positivity.t6@tok))

:named token_correspondence_NegativeTests.Positivity.t6@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(NegativeTests.Positivity.C61 @x1
@x2
@x3
@x4)
(NegativeTests.Positivity.t6 @x5
@x6))
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x3
...
(NegativeTests.Positivity.t6 @x5
@x6)))
:qid subterm_ordering_NegativeTests.Positivity.C61))

:named subterm_ordering_NegativeTests.Positivity.C61))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name NegativeTests.Positivity.__proj__C61__item___0; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_d189dce05c186475c90958872418b4e6 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_d189dce05c186475c90958872418b4e6 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_d189dce05c186475c90958872418b4e6))

:named refinement_kinding_Tm_refine_d189dce05c186475c90958872418b4e6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name NegativeTests.Positivity.__proj__C61__item___0; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d189dce05c186475c90958872418b4e6 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(NegativeTests.Positivity.t6 @x2
@x3))

;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(BoxBool_proj_0 (NegativeTests.Positivity.uu___is_C61 @x2
@x3
@x1))
))
...
(Tm_refine_d189dce05c186475c90958872418b4e6 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_d189dce05c186475c90958872418b4e6))

:named refinement_interpretation_Tm_refine_d189dce05c186475c90958872418b4e6))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(44,4-44,7); use=NegativeTests.Positivity.fst(44,4-44,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (NegativeTests.Positivity.C62_b (NegativeTests.Positivity.C62 @x0
@x1))
@x1)
 

:pattern ((NegativeTests.Positivity.C62 @x0
@x1))
:qid projection_inverse_NegativeTests.Positivity.C62_b))

:named projection_inverse_NegativeTests.Positivity.C62_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(44,4-44,7); use=NegativeTests.Positivity.fst(44,4-44,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (NegativeTests.Positivity.C62_a (NegativeTests.Positivity.C62 @x0
@x1))
@x0)
...
:pattern ((NegativeTests.Positivity.C62 @x0
@x1))
:qid projection_inverse_NegativeTests.Positivity.C62_a))

:named projection_inverse_NegativeTests.Positivity.C62_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (NegativeTests.Positivity.C61_b (NegativeTests.Positivity.C61 @x0
@x1
@x2
@x3))
@x1)
...
:pattern ((NegativeTests.Positivity.C61 @x0
@x1
@x2
@x3))
:qid projection_inverse_NegativeTests.Positivity.C61_b))

:named projection_inverse_NegativeTests.Positivity.C61_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (NegativeTests.Positivity.C61_a (NegativeTests.Positivity.C61 @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_NegativeTests.Positivity.C61_a))

:named projection_inverse_NegativeTests.Positivity.C61_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (NegativeTests.Positivity.C61__1 (NegativeTests.Positivity.C61 @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_NegativeTests.Positivity.C61__1))

:named projection_inverse_NegativeTests.Positivity.C61__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (NegativeTests.Positivity.C61__0 (NegativeTests.Positivity.C61 @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_NegativeTests.Positivity.C61__0))

:named projection_inverse_NegativeTests.Positivity.C61__0))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! (is-Tm_arrow (PreType NegativeTests.Positivity.t6@tok))
:named pre_kinding_NegativeTests.Positivity.t6@tok))
...
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! (and (IsTotFun NegativeTests.Positivity.t6@tok)

;; def=NegativeTests.Positivity.fst(42,10-42,12); use=NegativeTests.Positivity.fst(42,10-42,12)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT NegativeTests.Positivity.t6@tok
@x0))
 

:pattern ((ApplyTT NegativeTests.Positivity.t6@tok
@x0))
:qid kinding_NegativeTests.Positivity.t6@tok))
...
(HasType @x1
Tm_type))
(HasType (NegativeTests.Positivity.t6 @x0
@x1)
Tm_type))
...
:pattern ((NegativeTests.Positivity.t6 @x0
@x1))
:qid kinding_NegativeTests.Positivity.t6@tok.1))
)
:named kinding_NegativeTests.Positivity.t6@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d189dce05c186475c90958872418b4e6
;;; Fact-ids: Name NegativeTests.Positivity.__proj__C61__item___0; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d189dce05c186475c90958872418b4e6 @x0
@x1)))
(Valid (Prims.hasEq (NegativeTests.Positivity.t6 @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d189dce05c186475c90958872418b4e6 @x0
@x1))))
:qid haseqTm_refine_d189dce05c186475c90958872418b4e6))

:named haseqTm_refine_d189dce05c186475c90958872418b4e6))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(42,10-42,12); use=NegativeTests.Positivity.fst(42,10-42,12)
...
(NegativeTests.Positivity.t6 @x2
@x3))
(or (and (is-NegativeTests.Positivity.C61 @x1)
(= @x2
(NegativeTests.Positivity.C61_a @x1))
(= @x3
(NegativeTests.Positivity.C61_b @x1)))
(and (is-NegativeTests.Positivity.C62 @x1)
(= @x2
(NegativeTests.Positivity.C62_a @x1))
(= @x3
(NegativeTests.Positivity.C62_b @x1)))))
...
(NegativeTests.Positivity.t6 @x2
@x3)))
:qid fuel_guarded_inversion_NegativeTests.Positivity.t6))

:named fuel_guarded_inversion_NegativeTests.Positivity.t6))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! (= 192
(Term_constr_id NegativeTests.Positivity.t6@tok))
:named fresh_token_NegativeTests.Positivity.t6@tok))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name NegativeTests.Positivity.uu___is_C61; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (NegativeTests.Positivity.uu___is_C61 @x0
@x1
@x2)
(BoxBool (is-NegativeTests.Positivity.C61 @x2)))
 

:pattern ((NegativeTests.Positivity.uu___is_C61 @x0
@x1
@x2))
:qid disc_equation_NegativeTests.Positivity.C61))

:named disc_equation_NegativeTests.Positivity.C61))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(44,4-44,7); use=NegativeTests.Positivity.fst(44,4-44,7)
...
Tm_type))
(HasTypeFuel @u0
(NegativeTests.Positivity.C62 @x1
@x2)
(NegativeTests.Positivity.t6 @x1
@x2)))
...
(NegativeTests.Positivity.t6 @x1
@x2)))
:qid data_typing_intro_NegativeTests.Positivity.C62@tok))

:named data_typing_intro_NegativeTests.Positivity.C62@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
...
(NegativeTests.Positivity.t6 @x1
@x2)))
:qid data_typing_intro_NegativeTests.Positivity.C61@tok))

:named data_typing_intro_NegativeTests.Positivity.C61@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(44,4-44,7); use=NegativeTests.Positivity.fst(44,4-44,7)
...
(NegativeTests.Positivity.C62 @x1
@x2)
(NegativeTests.Positivity.t6 @x3
@x4))
(and (HasTypeFuel @u0
@x3
Tm_type)
...
(NegativeTests.Positivity.t6 @x3
@x4)))
:qid data_elim_NegativeTests.Positivity.C62))

:named data_elim_NegativeTests.Positivity.C62))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
...
(HasTypeFuel @u0
@x4
(NegativeTests.Positivity.t6 @x6
@x5))))
...
(NegativeTests.Positivity.t6 @x5
@x6)))
:qid data_elim_NegativeTests.Positivity.C61))

:named data_elim_NegativeTests.Positivity.C61))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(42,10-42,12); use=NegativeTests.Positivity.fst(42,10-42,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= 191
(Term_constr_id (NegativeTests.Positivity.t6 @x0
@x1)))
 

:pattern ((NegativeTests.Positivity.t6 @x0
@x1))
:qid constructor_distinct_NegativeTests.Positivity.t6))

:named constructor_distinct_NegativeTests.Positivity.t6))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(44,4-44,7); use=NegativeTests.Positivity.fst(44,4-44,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= 207
(Term_constr_id (NegativeTests.Positivity.C62 @x0
@x1)))
 

:pattern ((NegativeTests.Positivity.C62 @x0
@x1))
:qid constructor_distinct_NegativeTests.Positivity.C62))

:named constructor_distinct_NegativeTests.Positivity.C62))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 200
(Term_constr_id (NegativeTests.Positivity.C61 @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_NegativeTests.Positivity.C61))

:named constructor_distinct_NegativeTests.Positivity.C61))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name NegativeTests.Positivity.t6; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C61; Namespace NegativeTests.Positivity; Name NegativeTests.Positivity.C62; Namespace NegativeTests.Positivity
(assert (! 
;; def=NegativeTests.Positivity.fst(42,10-42,12); use=NegativeTests.Positivity.fst(42,10-42,12)
...
(NegativeTests.Positivity.t6 @x2
@x3)))
:qid NegativeTests.Positivity_pretyping_cd55a6defd144f30fcd55a08b27fdf41))

:named NegativeTests.Positivity_pretyping_cd55a6defd144f30fcd55a08b27fdf41))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.TSet.map; Namespace FStar.TSet
(assert (! 
;; def=FStar.TSet.fsti(117,10-117,21); use=FStar.TSet.fsti(117,31-117,41)
...
; Encoding query formula : forall (a: Type) (b: Type) (projectee: _: NegativeTests.Positivity.t6 a b {C61? _}).
;   (*  - Could not prove post-condition
; *) ~(C61? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__C61__item___0`
...
Tm_type)
(HasType @x2
(Tm_refine_d189dce05c186475c90958872418b4e6 @x0
@x1))

;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(not 
;; def=NegativeTests.Positivity.fst(43,4-43,7); use=NegativeTests.Positivity.fst(43,4-43,7)
(BoxBool_proj_0 (NegativeTests.Positivity.uu___is_C61 @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Positivity.__proj__C61__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_d189dce05c186475c90958872418b4e6
...
; encoding sigelt let __proj__C61__item___0


; <Skipped let __proj__C61__item___0/>


; encoding sigelt val NegativeTests.Positivity.__proj__C61__item___1


; <Start encoding val NegativeTests.Positivity.__proj__C61__item___1>


(declare-fun NegativeTests.Positivity.__proj__C61__item___1 (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t6 a b {C61? _} -> t6 b a
(declare-fun Tm_arrow_a4d713fbcf53b50185a60134323427bd () Term)
(declare-fun NegativeTests.Positivity.__proj__C61__item___1@tok () Term)

; </end encoding val NegativeTests.Positivity.__proj__C61__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__C61__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Positivity.__proj__C61__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_d189dce05c186475c90958872418b4e6
