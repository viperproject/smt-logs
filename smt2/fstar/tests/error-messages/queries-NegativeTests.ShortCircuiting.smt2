...
; Internals for NegativeTests.ShortCircuiting


; encoding sigelt val NegativeTests.ShortCircuiting.bad_p


; <Start encoding val NegativeTests.ShortCircuiting.bad_p>

(declare-fun NegativeTests.ShortCircuiting.bad_p (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.bool -> Type
(declare-fun Tm_arrow_500279c757ae94c6b581e1748c9c53d5 () Term)
(declare-fun NegativeTests.ShortCircuiting.bad_p@tok () Term)

; </end encoding val NegativeTests.ShortCircuiting.bad_p>


; encoding sigelt val NegativeTests.ShortCircuiting.bad


; <Skipped val NegativeTests.ShortCircuiting.bad/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.ShortCircuiting.bad_p; Namespace NegativeTests.ShortCircuiting
(assert (! 
;; def=NegativeTests.ShortCircuiting.fst(18,12-18,17); use=NegativeTests.ShortCircuiting.fst(18,12-18,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.bool)
(HasType (NegativeTests.ShortCircuiting.bad_p @x0)
Tm_type))
 

:pattern ((NegativeTests.ShortCircuiting.bad_p @x0))
:qid typing_NegativeTests.ShortCircuiting.bad_p))

:named typing_NegativeTests.ShortCircuiting.bad_p))
;;;;;;;;;;;;;;;;refinement kinding
...
; Starting query at NegativeTests.ShortCircuiting.fst(21,16-21,33)
...
(declare-fun Tm_refine_5d880bf92d2d3739ef876b83dace403e () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_5d880bf92d2d3739ef876b83dace403e
Tm_type)
:named refinement_kinding_Tm_refine_5d880bf92d2d3739ef876b83dace403e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=NegativeTests.ShortCircuiting.fst(19,10-21,33); use=NegativeTests.ShortCircuiting.fst(19,10-21,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_5d880bf92d2d3739ef876b83dace403e)
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=NegativeTests.ShortCircuiting.fst(21,16-21,33); use=NegativeTests.ShortCircuiting.fst(21,16-21,33)
...
@x1
Tm_refine_5d880bf92d2d3739ef876b83dace403e))
:qid refinement_interpretation_Tm_refine_5d880bf92d2d3739ef876b83dace403e))

:named refinement_interpretation_Tm_refine_5d880bf92d2d3739ef876b83dace403e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5d880bf92d2d3739ef876b83dace403e
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_5d880bf92d2d3739ef876b83dace403e))
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_5d880bf92d2d3739ef876b83dace403e))
(declare-fun NegativeTests.ShortCircuiting.bad (Term) Term)

(declare-fun Tm_refine_7922a626ea58e3bf30cae826db41c058 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_7922a626ea58e3bf30cae826db41c058
Tm_type)
:named refinement_kinding_Tm_refine_7922a626ea58e3bf30cae826db41c058))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=NegativeTests.ShortCircuiting.fst(19,23-19,40); use=NegativeTests.ShortCircuiting.fst(21,8-21,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_7922a626ea58e3bf30cae826db41c058)
(and (HasTypeFuel @u0
@x1
Prims.bool)

;; def=NegativeTests.ShortCircuiting.fst(19,31-19,38); use=NegativeTests.ShortCircuiting.fst(21,8-21,11)
(Valid 
;; def=NegativeTests.ShortCircuiting.fst(19,31-19,38); use=NegativeTests.ShortCircuiting.fst(21,8-21,11)
(NegativeTests.ShortCircuiting.bad_p @x1)
)
))
...
@x1
Tm_refine_7922a626ea58e3bf30cae826db41c058))
:qid refinement_interpretation_Tm_refine_7922a626ea58e3bf30cae826db41c058))

:named refinement_interpretation_Tm_refine_7922a626ea58e3bf30cae826db41c058))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7922a626ea58e3bf30cae826db41c058
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_7922a626ea58e3bf30cae826db41c058))
(Valid (Prims.hasEq Prims.bool)))
:named haseqTm_refine_7922a626ea58e3bf30cae826db41c058))
;;;;;;;;;;;;;;;;x: Prims.int{x << x} -> b: Prims.bool{bad_p b}
(declare-fun Tm_arrow_425261853788b7a0f9d8931e56e5b958 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_425261853788b7a0f9d8931e56e5b958
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_425261853788b7a0f9d8931e56e5b958
Tm_type)
:named kinding_Tm_arrow_425261853788b7a0f9d8931e56e5b958))
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_425261853788b7a0f9d8931e56e5b958)
...
@x1
Tm_arrow_425261853788b7a0f9d8931e56e5b958))
:qid NegativeTests.ShortCircuiting_pre_typing_Tm_arrow_425261853788b7a0f9d8931e56e5b958))

:named NegativeTests.ShortCircuiting_pre_typing_Tm_arrow_425261853788b7a0f9d8931e56e5b958))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_425261853788b7a0f9d8931e56e5b958
;;; Fact-ids: 
(assert (! 
;; def=NegativeTests.ShortCircuiting.fst(19,10-21,33); use=NegativeTests.ShortCircuiting.fst(19,10-21,33)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid NegativeTests.ShortCircuiting_interpretation_Tm_arrow_425261853788b7a0f9d8931e56e5b958.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_425261853788b7a0f9d8931e56e5b958))
:qid NegativeTests.ShortCircuiting_interpretation_Tm_arrow_425261853788b7a0f9d8931e56e5b958))

:named NegativeTests.ShortCircuiting_interpretation_Tm_arrow_425261853788b7a0f9d8931e56e5b958))
(declare-fun NegativeTests.ShortCircuiting.bad@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=NegativeTests.ShortCircuiting.fst(21,8-21,11); use=NegativeTests.ShortCircuiting.fst(21,8-21,11)
(forall ((@x0 Term))
 (! (= (ApplyTT NegativeTests.ShortCircuiting.bad@tok
@x0)
(NegativeTests.ShortCircuiting.bad @x0))
 

:pattern ((ApplyTT NegativeTests.ShortCircuiting.bad@tok
@x0))
:qid token_correspondence_NegativeTests.ShortCircuiting.bad))

:named token_correspondence_NegativeTests.ShortCircuiting.bad))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=NegativeTests.ShortCircuiting.fst(21,8-21,11); use=NegativeTests.ShortCircuiting.fst(21,8-21,11)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType NegativeTests.ShortCircuiting.bad@tok
Tm_arrow_425261853788b7a0f9d8931e56e5b958))
...
(forall ((@x1 Term))
 (! (= (ApplyTT NegativeTests.ShortCircuiting.bad@tok
@x1)
(NegativeTests.ShortCircuiting.bad @x1))
 

:pattern ((NegativeTests.ShortCircuiting.bad @x1))
:qid function_token_typing_NegativeTests.ShortCircuiting.bad.1))
)
 

:pattern ((ApplyTT @x0
NegativeTests.ShortCircuiting.bad@tok))
:qid function_token_typing_NegativeTests.ShortCircuiting.bad))

:named function_token_typing_NegativeTests.ShortCircuiting.bad))
...
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_5d880bf92d2d3739ef876b83dace403e)
(HasType (NegativeTests.ShortCircuiting.bad @x0)
Tm_refine_7922a626ea58e3bf30cae826db41c058))
 

:pattern ((NegativeTests.ShortCircuiting.bad @x0))
:qid typing_NegativeTests.ShortCircuiting.bad))

:named typing_NegativeTests.ShortCircuiting.bad))
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (NegativeTests.ShortCircuiting.bad_p true)


; Context: While encoding a query
; While typechecking the top-level declaration `let rec bad`
; While typechecking the top-level declaration `[@@expect_failure] let rec bad`
...
;;; Fact-ids: 
(assert (! (not 
;; def=NegativeTests.ShortCircuiting.fst(19,31-19,38); use=NegativeTests.ShortCircuiting.fst(21,16-21,33)
(or label_1

;; def=NegativeTests.ShortCircuiting.fst(19,31-19,38); use=NegativeTests.ShortCircuiting.fst(21,16-21,33)
(Valid 
;; def=NegativeTests.ShortCircuiting.fst(19,31-19,38); use=NegativeTests.ShortCircuiting.fst(21,16-21,33)
(NegativeTests.ShortCircuiting.bad_p (BoxBool true))
)
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.ShortCircuiting.bad, 1)
...
; encoding sigelt val NegativeTests.ShortCircuiting.ff


; <Skipped val NegativeTests.ShortCircuiting.ff/>
...
; Starting query at NegativeTests.ShortCircuiting.fst(25,11-25,36)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u100: Prims.unit).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let ff`
; While typechecking the top-level declaration `[@@expect_failure] let ff`
...
;; def=Prims.fst(451,90-451,102); use=NegativeTests.ShortCircuiting.fst(25,11-25,36)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.ShortCircuiting.ff, 1)
; STATUS: unknown because (incomplete quantifiers)
