...
; Starting query at Asserts.fst(4,22-6,17)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Prims.int) (y: Prims.int). (*  - Could not prove post-condition
; *) y + 1 == y


; Context: While encoding a query
; While typechecking the top-level declaration `let test`
; While typechecking the top-level declaration `[@@expect_failure] let test`
...
;; def=Asserts.fst(6,9-6,17); use=Asserts.fst(6,9-6,17)
(or label_1
...
; Starting query at Asserts.fst(9,23-12,5)
...
;; def=Asserts.fst(11,9-11,17); use=Asserts.fst(11,2-11,8)
(or label_1
...
; Starting query at Asserts.fst(16,2-18,5)
