...
; Internals for NegativeTests.False


; encoding sigelt val NegativeTests.False.foo


; <Skipped val NegativeTests.False.foo/>
...
; Starting query at NegativeTests.False.fst(20,12-20,16)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.bool
(declare-fun Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76
Tm_type)
:named kinding_Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=NegativeTests.False.fst(18,13-18,29); use=NegativeTests.False.fst(20,4-20,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76)
...
@x1
Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76))
:qid NegativeTests.False_pre_typing_Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76))

:named NegativeTests.False_pre_typing_Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76
;;; Fact-ids: 
(assert (! 
;; def=NegativeTests.False.fst(18,13-18,29); use=NegativeTests.False.fst(20,4-20,7)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid NegativeTests.False_interpretation_Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76))
:qid NegativeTests.False_interpretation_Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76))

:named NegativeTests.False_interpretation_Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76))
(declare-fun Tm_refine_85721560a0c745412eef4b2aa333de58 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_85721560a0c745412eef4b2aa333de58
Tm_type)
:named refinement_kinding_Tm_refine_85721560a0c745412eef4b2aa333de58))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=NegativeTests.False.fst(18,10-18,43); use=NegativeTests.False.fst(20,4-20,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_85721560a0c745412eef4b2aa333de58)
(and (HasTypeFuel @u0
@x1
Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76)

;; def=NegativeTests.False.fst(18,31-18,42); use=NegativeTests.False.fst(20,4-20,7)
(= (ApplyTT @x1
Tm_unit)
(BoxBool true))
))
...
@x1
Tm_refine_85721560a0c745412eef4b2aa333de58))
:qid refinement_interpretation_Tm_refine_85721560a0c745412eef4b2aa333de58))

:named refinement_interpretation_Tm_refine_85721560a0c745412eef4b2aa333de58))
;;;;;;;;;;;;;;;;haseq for Tm_refine_85721560a0c745412eef4b2aa333de58
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_85721560a0c745412eef4b2aa333de58))
(Valid (Prims.hasEq Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76)))
:named haseqTm_refine_85721560a0c745412eef4b2aa333de58))

; Encoding query formula : forall (f: (_: Prims.unit -> Prims.bool){f () = true}).
...
;; def=NegativeTests.False.fst(19,38-19,46); use=NegativeTests.False.fst(20,12-20,16)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.False.foo, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_85721560a0c745412eef4b2aa333de58
...
(declare-fun Tm_arrow_d53b1a0e782bd9cb6682b59ede244c76 () Term)
(declare-fun Tm_refine_85721560a0c745412eef4b2aa333de58 () Term)
(declare-fun NegativeTests.False.foo (Term) Term)


(declare-fun Tm_refine_b88eef09f924d228c1bc055cd5cfe41d (Term) Term)
;;;;;;;;;;;;;;;;f: (_: Prims.unit -> Prims.bool){f () = true} -> r: Prims.bool{r = f () /\ r = true}
(declare-fun Tm_arrow_ebe97bb153de8b5329b2d7f908193836 () Term)
(declare-fun NegativeTests.False.foo@tok () Term)
...
; encoding sigelt val NegativeTests.False.bar


; <Skipped val NegativeTests.False.bar/>
...
; Starting query at NegativeTests.False.fst(23,13-23,33)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Prims.unit).
;   (*  - Could not prove post-condition
; *) forall (p: Prims.pure_post Prims.bool). Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let bar`
; While typechecking the top-level declaration `[@@expect_failure] let bar`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.False.bar, 1)
...
; Starting query at NegativeTests.False.fst(26,0-26,65)
...
;;; Fact-ids: 
(assert (! 
;; def=NegativeTests.False.fst(26,50-26,65); use=NegativeTests.False.fst(26,50-26,55)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
; Encoding query formula : forall (p1: Prims.l_True) (p2: Prims.l_True) (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *) Prims.hasEq Prims.l_True


; Context: While encoding a query
; While typechecking the top-level declaration `val NegativeTests.False.f`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=NegativeTests.False.fst(26,0-26,65)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.l_True)
(HasType @x1
...
;; def=Prims.fst(73,23-73,30); use=NegativeTests.False.fst(26,57-26,59)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.False.f, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, equation_Prims.l_True, equation_Prims.squash, haseqTm_refine_2de20c066034c13bf76e9c0b94f4806c, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.unit
...
; encoding sigelt val NegativeTests.False.f


; <Skipped val NegativeTests.False.f/>
...
; Starting query at NegativeTests.False.fst(27,14-27,16)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (p1: Prims.unit) (p2: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). p1 = p2 ==> p pure_result) ==>
...
;; def=Prims.fst(441,36-441,97); use=NegativeTests.False.fst(27,14-27,16)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=NegativeTests.False.fst(26,56-26,65); use=NegativeTests.False.fst(27,14-27,16)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NegativeTests.False.fst(27,14-27,16)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NegativeTests.False.fst(27,14-27,16)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.False.f, 2)
; STATUS: unsat
