...
; Internals for NegativeTests.ZZImplicitFalse


; encoding sigelt val NegativeTests.ZZImplicitFalse.test


; <Skipped val NegativeTests.ZZImplicitFalse.test/>
...
; Starting query at NegativeTests.ZZImplicitFalse.fst(20,12-20,34)
...
;     (forall (any_result: Prims.unit) (any_result: Prims.unit). p any_result)
...
;; def=Prims.fst(459,77-459,89); use=NegativeTests.ZZImplicitFalse.fst(20,12-20,34)
(and 
;; def=Prims.fst(159,29-159,34); use=NegativeTests.ZZImplicitFalse.fst(20,27-20,28)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=NegativeTests.ZZImplicitFalse.fst(20,12-20,34)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)
...
;; def=Prims.fst(451,90-451,102); use=NegativeTests.ZZImplicitFalse.fst(20,12-20,34)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.ZZImplicitFalse.test, 1)
