...
; Internals for NegativeTests.Neg


; encoding sigelt val NegativeTests.Neg.x


; <Skipped val NegativeTests.Neg.x/>
...
; Starting query at NegativeTests.Neg.fst(20,0-20,10)
...
; While typechecking the top-level declaration `[@@expect_failure] let x`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Neg.x, 1)
...
; encoding sigelt val NegativeTests.Neg.y


; <Skipped val NegativeTests.Neg.y/>
...
; Starting query at NegativeTests.Neg.fst(24,0-24,10)
...
; While typechecking the top-level declaration `[@@expect_failure] let y`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Neg.y, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; Starting query at NegativeTests.Neg.fst(27,23-27,35)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let assert_0_eq_1`
; While typechecking the top-level declaration `[@@expect_failure] let assert_0_eq_1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Neg.assert_0_eq_1, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; Starting query at NegativeTests.Neg.fst(30,28-31,15)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Type) (l: Prims.list _).
;   (*  - Could not prove post-condition
; *) ~(Cons? l) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let hd_int_inexhaustive`
; While typechecking the top-level declaration `[@@expect_failure] let hd_int_inexhaustive`
...
;; def=NegativeTests.Neg.fst(30,24-30,25); use=NegativeTests.Neg.fst(30,34-30,35)
(not 
;; def=NegativeTests.Neg.fst(30,24-30,25); use=NegativeTests.Neg.fst(30,34-30,35)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Neg.hd_int_inexhaustive, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val NegativeTests.Neg.test_label


; <Skipped val NegativeTests.Neg.test_label/>
...
; Starting query at NegativeTests.Neg.fst(34,15-34,16)
...
;     (forall (return_val: Prims.int). return_val == x ==> p return_val)


; Context: While encoding a query
; While typechecking the top-level declaration `let test_label`
...
;; def=NegativeTests.Neg.fst(33,44-33,57); use=NegativeTests.Neg.fst(34,19-34,20)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Prims.fst(441,36-441,97); use=NegativeTests.Neg.fst(34,19-34,20)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.int))

;; def=NegativeTests.Neg.fst(33,78-33,83); use=NegativeTests.Neg.fst(34,19-34,20)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NegativeTests.Neg.fst(34,19-34,20)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NegativeTests.Neg.fst(34,19-34,20)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Neg.test_label, 1)
; STATUS: unsat
...
; encoding sigelt let test_label


; <Start encoding let test_label>

(declare-fun NegativeTests.Neg.test_label (Term) Term)

;;;;;;;;;;;;;;;;x: Prims.int -> Prims.Pure Prims.int
(declare-fun Tm_arrow_458dd27aff900b58958a17d76c03fd2d () Term)
(declare-fun NegativeTests.Neg.test_label@tok () Term)


; </end encoding let test_label>


; encoding sigelt val NegativeTests.Neg.test_precondition_label


; <Skipped val NegativeTests.Neg.test_precondition_label/>
...
; Starting query at NegativeTests.Neg.fst(38,32-38,44)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let test_precondition_label`
; While typechecking the top-level declaration `[@@expect_failure] let test_precondition_label`
...
;; def=NegativeTests.Neg.fst(33,44-33,57); use=NegativeTests.Neg.fst(38,32-38,42)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Neg.test_precondition_label, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val NegativeTests.Neg.test_postcondition_label


; <Skipped val NegativeTests.Neg.test_postcondition_label/>
...
; Starting query at NegativeTests.Neg.fst(42,29-42,30)
...
; *)
;   forall (p: Prims.pure_post Prims.int).
;     (forall (pure_result: Prims.int). pure_result > 0 ==> p pure_result) ==>
;     (forall (return_val: Prims.int). return_val == x ==> p return_val)


; Context: While encoding a query
; While typechecking the top-level declaration `let test_postcondition_label`
; While typechecking the top-level declaration `[@@expect_failure] let test_postcondition_label`
...
;; def=Prims.fst(441,36-441,97); use=NegativeTests.Neg.fst(42,33-42,34)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.int))

;; def=NegativeTests.Neg.fst(40,83-40,88); use=NegativeTests.Neg.fst(42,33-42,34)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NegativeTests.Neg.fst(42,33-42,34)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NegativeTests.Neg.fst(42,33-42,34)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Neg.test_postcondition_label, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val NegativeTests.Neg.bad_projector


; <Skipped val NegativeTests.Neg.bad_projector/>
...
; Starting query at NegativeTests.Neg.fst(46,22-46,31)

(declare-fun label_1 () Bool)

; Encoding query formula : forall ('a: Type) (x: FStar.Pervasives.Native.option 'a).
;   (*  - Could not prove post-condition
; *) Some? x


; Context: While encoding a query
; While typechecking the top-level declaration `let bad_projector`
; While typechecking the top-level declaration `[@@expect_failure] let bad_projector`
...
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=NegativeTests.Neg.fst(46,30-46,31)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Neg.bad_projector, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val NegativeTests.Neg.t_pred


; <Start encoding val NegativeTests.Neg.t_pred>

;;;;;;;;;;;;;;;;_: FStar.Pervasives.result Prims.int -> Type
(declare-fun Tm_arrow_ad642eb176bc82a1bf45edd58c3ba08a () Term)
(declare-fun NegativeTests.Neg.t_pred (Term) Term)

;;;;;;;;;;;;;;;;_: (_: FStar.Pervasives.result Prims.int -> Type) -> Type
(declare-fun Tm_arrow_6285ae43f0e48e4486da6a7d7b259409 () Term)
(declare-fun NegativeTests.Neg.t_pred@tok () Term)

; </end encoding val NegativeTests.Neg.t_pred>
...
; Starting query at NegativeTests.Neg.fst(50,7-50,53)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (ri: FStar.Pervasives.result Prims.int). (*  - Could not prove post-condition
; *) V? ri


; Context: While encoding a query
; While typechecking the top-level declaration `val NegativeTests.Neg.test`
; While typechecking the top-level declaration `[@@expect_failure] val NegativeTests.Neg.test`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=NegativeTests.Neg.fst(50,7-50,53)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Pervasives.result Prims.int))

;; def=FStar.Pervasives.fsti(520,4-520,5); use=NegativeTests.Neg.fst(50,45-50,47)
(or label_1

;; def=FStar.Pervasives.fsti(520,4-520,5); use=NegativeTests.Neg.fst(50,45-50,47)
(BoxBool_proj_0 (FStar.Pervasives.uu___is_V Prims.int
@x0))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Neg.test, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val NegativeTests.Neg.f1


; <Start encoding val NegativeTests.Neg.f1>


(declare-fun NegativeTests.Neg.f1 (Term) Term)

;;;;;;;;;;;;;;;;_: (x: Prims.int -> Prims.unit) -> Prims.unit
(declare-fun Tm_arrow_17f1a613692a9308b16945fa6c95bb2c () Term)
(declare-fun NegativeTests.Neg.f1@tok () Term)

; </end encoding val NegativeTests.Neg.f1>


; encoding sigelt val NegativeTests.Neg.g1


; <Start encoding val NegativeTests.Neg.g1>

(declare-fun NegativeTests.Neg.g1 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.nat -> Prims.unit
(declare-fun Tm_arrow_293379194eb2dddb9319404068addd6f () Term)
(declare-fun NegativeTests.Neg.g1@tok () Term)

; </end encoding val NegativeTests.Neg.g1>
...
; Starting query at NegativeTests.Neg.fst(55,0-55,27)
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let h1`
; While typechecking the top-level declaration `[@@expect_failure] let h1`
...
;; def=Prims.fst(680,18-680,24); use=NegativeTests.Neg.fst(55,25-55,26)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Neg.h1, 1)
; STATUS: unknown because (incomplete quantifiers)
