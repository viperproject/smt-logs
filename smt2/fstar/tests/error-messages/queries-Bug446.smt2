...
(declare-fun Bug446.wP (Term) Term)

(declare-fun Bug446.wP@tok () Term)

; </end encoding let wP>


; encoding sigelt effect P a wp = Prims.PURE a


; <Skipped effect P a wp = Prims.PURE a/>
...
; encoding sigelt let m


; <Start encoding let m>

(declare-fun Bug446.m (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: wP a -> Type
(declare-fun Tm_arrow_6524b292fe31b9df8550ae48c6b849af () Term)
(declare-fun Bug446.m@tok () Term)
(declare-fun Non_total_Tm_arrow_d85157377bc97888f28cb086da5fac0f (Term Term) Term)
...
; encoding sigelt val Bug446.works


; <Skipped val Bug446.works/>


; encoding sigelt let works


; <Start encoding let works>

(declare-fun Bug446.works (Term Term Term) Term)
;;;;;;;;;;;;;;;;f: m a wp1 -> Prims.bool
(declare-fun Tm_arrow_bfaef8f5739a9232995ec13362281806 () Term)
(declare-fun Bug446.works@tok () Term)

; </end encoding let works>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug446.wP; Namespace Bug446
(assert (! 
;; def=Bug446.fst(20,5-20,7); use=Bug446.fst(20,5-20,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Bug446.wP @x0)
Tm_type))
 

:pattern ((Bug446.wP @x0))
:qid typing_Bug446.wP))

:named typing_Bug446.wP))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug446.m; Namespace Bug446
(assert (! 
;; def=Bug446.fst(25,5-25,6); use=Bug446.fst(25,5-25,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;;; Fact-ids: Name Bug446.m; Namespace Bug446
(assert (! 
;; def=Bug446.fst(26,5-26,23); use=Bug446.fst(26,5-26,23)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Bug446.wP @x0)))
(HasType (Non_total_Tm_arrow_d85157377bc97888f28cb086da5fac0f @x0
@x1)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_d85157377bc97888f28cb086da5fac0f @x0
@x1)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_d85157377bc97888f28cb086da5fac0f))

:named non_total_function_typing_Non_total_Tm_arrow_d85157377bc97888f28cb086da5fac0f))
...
;;;;;;;;;;;;;;;;Equation for Bug446.wP
;;; Fact-ids: Name Bug446.wP; Namespace Bug446
(assert (! 
;; def=Bug446.fst(20,5-20,7); use=Bug446.fst(20,5-20,7)
(forall ((@x0 Term))
 (! (= (Bug446.wP @x0)
(FStar.Pervasives.st_wp_h Prims.int
@x0))
 

:pattern ((Bug446.wP @x0))
:qid equation_Bug446.wP))

:named equation_Bug446.wP))
;;;;;;;;;;;;;;;;Equation for Bug446.m
;;; Fact-ids: Name Bug446.m; Namespace Bug446
(assert (! 
;; def=Bug446.fst(25,5-25,6); use=Bug446.fst(25,5-25,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug446.m @x0
@x1)
(Non_total_Tm_arrow_d85157377bc97888f28cb086da5fac0f @x0
@x1))
 

:pattern ((Bug446.m @x0
@x1))
:qid equation_Bug446.m))

:named equation_Bug446.m))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at Bug446.fst(33,7-34,74)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (b: Type) (wp1: Bug446.wP a) (wp2: Bug446.wP b) (f: Bug446.m a wp1).
;   (*  - Subtyping check failed
;   - Expected type wP a got type wP b
; *)
;   forall (_: b). Prims.has_type _ a


; Context: While encoding a query
; While typechecking the top-level declaration `val Bug446.fails`
; While typechecking the top-level declaration `[@@expect_failure] val Bug446.fails`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Bug446.fst(33,7-34,74)
...
;; def=dummy(0,0-0,0); use=Bug446.fst(34,59-34,62)
(forall ((@x5 Term))
 (! (implies (HasType @x5
@x1)

;; def=Bug446.fst(33,55-33,58); use=Bug446.fst(34,59-34,62)
(or label_1
(HasType @x5
@x0))
)
