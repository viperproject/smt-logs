...
; Internals for NegativeTests.Bug260
...
; encoding sigelt type NegativeTests.Bug260.pnat


; <Start encoding type NegativeTests.Bug260.pnat>

;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Bug260.pnat () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Bug260.O () Term)
;;;;;;;;;;;;;;;;data constructor proxy: NegativeTests.Bug260.O
(declare-fun NegativeTests.Bug260.O@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Bug260.S (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Bug260.S__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: NegativeTests.Bug260.S
(declare-fun NegativeTests.Bug260.S@tok () Term)
;;;;;;;;;;;;;;;;_0: pnat -> pnat
(declare-fun Tm_arrow_f66e38c45cd4afa0e8feb9a15ca1a62c () Term)

; <start constructor NegativeTests.Bug260.pnat>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Bug260.pnat ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
NegativeTests.Bug260.pnat)))

; </end constructor NegativeTests.Bug260.pnat>


; <start constructor NegativeTests.Bug260.O>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Bug260.O ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
NegativeTests.Bug260.O)))

; </end constructor NegativeTests.Bug260.O>


; <start constructor NegativeTests.Bug260.S>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Bug260.S ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
(NegativeTests.Bug260.S (NegativeTests.Bug260.S__0 __@x0)))))

; </end constructor NegativeTests.Bug260.S>


; </end encoding type NegativeTests.Bug260.pnat>
...
;;; Fact-ids: Name NegativeTests.Bug260.pnat; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.O; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.S; Namespace NegativeTests.Bug260
(assert (! (HasType NegativeTests.Bug260.O@tok
NegativeTests.Bug260.pnat)
:named typing_tok_NegativeTests.Bug260.O@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name NegativeTests.Bug260.pnat; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.O; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.S; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(19,4-19,5); use=NegativeTests.Bug260.fst(19,4-19,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(NegativeTests.Bug260.S @x1)
NegativeTests.Bug260.pnat)
...
(NegativeTests.Bug260.S @x1)
NegativeTests.Bug260.pnat))
:qid subterm_ordering_NegativeTests.Bug260.S))

:named subterm_ordering_NegativeTests.Bug260.S))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=NegativeTests.Bug260.fst(19,4-19,5); use=NegativeTests.Bug260.fst(19,4-19,5)
(forall ((@x0 Term))
 (! (= (NegativeTests.Bug260.S__0 (NegativeTests.Bug260.S @x0))
@x0)
 

:pattern ((NegativeTests.Bug260.S @x0))
:qid projection_inverse_NegativeTests.Bug260.S__0))

:named projection_inverse_NegativeTests.Bug260.S__0))
;;; Fact-ids: Name NegativeTests.Bug260.pnat; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.O; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.S; Namespace NegativeTests.Bug260
(assert (! (HasType NegativeTests.Bug260.pnat
Tm_type)
:named kinding_NegativeTests.Bug260.pnat@tok))
...
;;; Fact-ids: Name NegativeTests.Bug260.pnat; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.O; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.S; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(17,5-17,9); use=NegativeTests.Bug260.fst(17,5-17,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
NegativeTests.Bug260.pnat)
(or (is-NegativeTests.Bug260.O @x1)
(is-NegativeTests.Bug260.S @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
NegativeTests.Bug260.pnat))
:qid fuel_guarded_inversion_NegativeTests.Bug260.pnat))

:named fuel_guarded_inversion_NegativeTests.Bug260.pnat))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name NegativeTests.Bug260.pnat; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.O; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.S; Namespace NegativeTests.Bug260
(assert (! (= NegativeTests.Bug260.O@tok
NegativeTests.Bug260.O)
:named equality_tok_NegativeTests.Bug260.O@tok))
...
(NegativeTests.Bug260.S @x1)
NegativeTests.Bug260.pnat))
:qid data_typing_intro_NegativeTests.Bug260.S@tok))

:named data_typing_intro_NegativeTests.Bug260.S@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name NegativeTests.Bug260.pnat; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.O; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.S; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(18,4-18,5); use=NegativeTests.Bug260.fst(18,4-18,5)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
NegativeTests.Bug260.O
NegativeTests.Bug260.pnat)
...
NegativeTests.Bug260.O
NegativeTests.Bug260.pnat))
:qid data_typing_intro_NegativeTests.Bug260.O@tok))

:named data_typing_intro_NegativeTests.Bug260.O@tok))
...
(NegativeTests.Bug260.S @x1)
NegativeTests.Bug260.pnat))
:qid data_elim_NegativeTests.Bug260.S))

:named data_elim_NegativeTests.Bug260.S))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name NegativeTests.Bug260.pnat; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.O; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.S; Namespace NegativeTests.Bug260
(assert (! (= 116
(Term_constr_id NegativeTests.Bug260.pnat))
:named constructor_distinct_NegativeTests.Bug260.pnat))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Bug260.pnat; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.O; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.S; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(19,4-19,5); use=NegativeTests.Bug260.fst(19,4-19,5)
(forall ((@x0 Term))
 (! (= 124
(Term_constr_id (NegativeTests.Bug260.S @x0)))
 

:pattern ((NegativeTests.Bug260.S @x0))
:qid constructor_distinct_NegativeTests.Bug260.S))

:named constructor_distinct_NegativeTests.Bug260.S))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Bug260.pnat; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.O; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.S; Namespace NegativeTests.Bug260
(assert (! (= 122
(Term_constr_id NegativeTests.Bug260.O))
:named constructor_distinct_NegativeTests.Bug260.O))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
NegativeTests.Bug260.pnat))
:qid NegativeTests.Bug260_pretyping_6b627398f7ac3635fe8414aa6b9e872b))

:named NegativeTests.Bug260_pretyping_6b627398f7ac3635fe8414aa6b9e872b))
(push) ;; push{4

; Starting query at NegativeTests.Bug260.fst(17,0-19,20)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq NegativeTests.Bug260.pnat ==>
; (forall (_0: NegativeTests.Bug260.pnat).
...
; *)
;     Prims.hasEq NegativeTests.Bug260.pnat)


; Context: While encoding a query
; While typechecking the top-level declaration `type NegativeTests.Bug260.pnat`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=NegativeTests.Bug260.fst(17,0-19,20); use=NegativeTests.Bug260.fst(17,0-19,20)
(Valid 
;; def=NegativeTests.Bug260.fst(17,0-19,20); use=NegativeTests.Bug260.fst(17,0-19,20)
(Prims.hasEq NegativeTests.Bug260.pnat)
)
...
;; def=NegativeTests.Bug260.fst(17,0-19,20); use=NegativeTests.Bug260.fst(19,8-19,12)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Bug260.pnat, 1)
; STATUS: unsat
...
; encoding sigelt assume NegativeTests.Bug260.pnat__uu___haseq


; <Start encoding assume NegativeTests.Bug260.pnat__uu___haseq>


; </end encoding assume NegativeTests.Bug260.pnat__uu___haseq>


; encoding sigelt val NegativeTests.Bug260.uu___is_O


; <Start encoding val NegativeTests.Bug260.uu___is_O>

(declare-fun NegativeTests.Bug260.uu___is_O (Term) Term)
;;;;;;;;;;;;;;;;projectee: pnat -> Prims.bool
(declare-fun Tm_arrow_797d063ca6b29d85230fe520ae893165 () Term)
(declare-fun NegativeTests.Bug260.uu___is_O@tok () Term)

; </end encoding val NegativeTests.Bug260.uu___is_O>
...
; encoding sigelt val NegativeTests.Bug260.uu___is_S


; <Start encoding val NegativeTests.Bug260.uu___is_S>

(declare-fun NegativeTests.Bug260.uu___is_S (Term) Term)

(declare-fun NegativeTests.Bug260.uu___is_S@tok () Term)

; </end encoding val NegativeTests.Bug260.uu___is_S>
...
; encoding sigelt val NegativeTests.Bug260.__proj__S__item___0


; <Start encoding val NegativeTests.Bug260.__proj__S__item___0>

(declare-fun Tm_refine_c7798980fdaa69b62544817f36c3402f () Term)
(declare-fun NegativeTests.Bug260.__proj__S__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: pnat{S? _} -> pnat
(declare-fun Tm_arrow_e108de8840ecee35e68620f0ed36d522 () Term)
(declare-fun NegativeTests.Bug260.__proj__S__item___0@tok () Term)

; </end encoding val NegativeTests.Bug260.__proj__S__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Bug260.uu___is_S; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(19,4-19,5); use=NegativeTests.Bug260.fst(19,4-19,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
NegativeTests.Bug260.pnat)
(HasType (NegativeTests.Bug260.uu___is_S @x0)
Prims.bool))
 

:pattern ((NegativeTests.Bug260.uu___is_S @x0))
:qid typing_NegativeTests.Bug260.uu___is_S))

:named typing_NegativeTests.Bug260.uu___is_S))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name NegativeTests.Bug260.pnat; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.O; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.S; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(19,4-19,5); use=NegativeTests.Bug260.fst(19,4-19,5)
...
:named refinement_kinding_Tm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name NegativeTests.Bug260.__proj__S__item___0; Namespace NegativeTests.Bug260
(assert (! (HasType Tm_refine_c7798980fdaa69b62544817f36c3402f
Tm_type)
:named refinement_kinding_Tm_refine_c7798980fdaa69b62544817f36c3402f))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_c7798980fdaa69b62544817f36c3402f)
(and (HasTypeFuel @u0
@x1
NegativeTests.Bug260.pnat)

;; def=NegativeTests.Bug260.fst(19,4-19,5); use=NegativeTests.Bug260.fst(19,4-19,5)
(BoxBool_proj_0 (NegativeTests.Bug260.uu___is_S @x1))
))
...
@x1
Tm_refine_c7798980fdaa69b62544817f36c3402f))
:qid refinement_interpretation_Tm_refine_c7798980fdaa69b62544817f36c3402f))

:named refinement_interpretation_Tm_refine_c7798980fdaa69b62544817f36c3402f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
;; def=Prims.fst(304,12-304,41); use=Prims.fst(304,12-304,41)
...
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c7798980fdaa69b62544817f36c3402f
;;; Fact-ids: Name NegativeTests.Bug260.__proj__S__item___0; Namespace NegativeTests.Bug260
(assert (! (iff (Valid (Prims.hasEq Tm_refine_c7798980fdaa69b62544817f36c3402f))
(Valid (Prims.hasEq NegativeTests.Bug260.pnat)))
:named haseqTm_refine_c7798980fdaa69b62544817f36c3402f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
(Valid (Prims.hasEq Tm_type)))
...
;; def=NegativeTests.Bug260.fst(19,4-19,5); use=NegativeTests.Bug260.fst(19,4-19,5)
(forall ((@x0 Term))
 (! (= (NegativeTests.Bug260.uu___is_S @x0)
(BoxBool (is-NegativeTests.Bug260.S @x0)))
 

:pattern ((NegativeTests.Bug260.uu___is_S @x0))
:qid disc_equation_NegativeTests.Bug260.S))

:named disc_equation_NegativeTests.Bug260.S))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: NegativeTests.Bug260.pnat__uu___haseq
;;; Fact-ids: Name NegativeTests.Bug260.pnat__uu___haseq; Namespace NegativeTests.Bug260
(assert (! (Valid (Prims.hasEq NegativeTests.Bug260.pnat))
:named assumption_NegativeTests.Bug260.pnat__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Encoding query formula : forall (projectee: _: NegativeTests.Bug260.pnat{S? _}).
...
(not 
;; def=NegativeTests.Bug260.fst(19,4-19,5); use=NegativeTests.Bug260.fst(19,4-19,5)
(BoxBool_proj_0 (NegativeTests.Bug260.uu___is_S @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Bug260.__proj__S__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_c7798980fdaa69b62544817f36c3402f
...
; encoding sigelt type NegativeTests.Bug260.validity


; <Start encoding type NegativeTests.Bug260.validity>

;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Bug260.validity (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun NegativeTests.Bug260.validity@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun NegativeTests.Bug260.VSucc (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NegativeTests.Bug260.VSucc_n (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: NegativeTests.Bug260.VSucc
(declare-fun NegativeTests.Bug260.VSucc@tok () Term)
;;;;;;;;;;;;;;;;n: pnat -> validity (S n)
(declare-fun Tm_arrow_392edc925bec4c7f773e7093799fbd8c () Term)

; <start constructor NegativeTests.Bug260.validity>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Bug260.validity ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
161)
(exists ((@x0 Term))
 (! (= __@x0
(NegativeTests.Bug260.validity @x0))
 
;;no pats
:qid is-NegativeTests.Bug260.validity))))

; </end constructor NegativeTests.Bug260.validity>


; <start constructor NegativeTests.Bug260.VSucc>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NegativeTests.Bug260.VSucc ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
168)
(= __@x0
(NegativeTests.Bug260.VSucc (NegativeTests.Bug260.VSucc_n __@x0)))))

; </end constructor NegativeTests.Bug260.VSucc>


; </end encoding type NegativeTests.Bug260.validity>

;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(21,5-21,13); use=NegativeTests.Bug260.fst(21,5-21,13)
(forall ((@x0 Term))
 (! (= (ApplyTT NegativeTests.Bug260.validity@tok
@x0)
(NegativeTests.Bug260.validity @x0))
 

:pattern ((ApplyTT NegativeTests.Bug260.validity@tok
@x0))

:pattern ((NegativeTests.Bug260.validity @x0))
:qid token_correspondence_NegativeTests.Bug260.validity@tok))

:named token_correspondence_NegativeTests.Bug260.validity@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(22,4-22,9); use=NegativeTests.Bug260.fst(22,4-22,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(NegativeTests.Bug260.VSucc @x1)
(NegativeTests.Bug260.validity @x2))
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x1
(NegativeTests.Bug260.VSucc @x1))))
...
(NegativeTests.Bug260.VSucc @x1)
(NegativeTests.Bug260.validity @x2)))
:qid subterm_ordering_NegativeTests.Bug260.VSucc))

:named subterm_ordering_NegativeTests.Bug260.VSucc))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(22,4-22,9); use=NegativeTests.Bug260.fst(22,4-22,9)
(forall ((@x0 Term))
 (! (= (NegativeTests.Bug260.VSucc_n (NegativeTests.Bug260.VSucc @x0))
@x0)
 

:pattern ((NegativeTests.Bug260.VSucc @x0))
:qid projection_inverse_NegativeTests.Bug260.VSucc_n))

:named projection_inverse_NegativeTests.Bug260.VSucc_n))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! (is-Tm_arrow (PreType NegativeTests.Bug260.validity@tok))
:named pre_kinding_NegativeTests.Bug260.validity@tok))
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! (and (IsTotFun NegativeTests.Bug260.validity@tok)

;; def=NegativeTests.Bug260.fst(21,5-21,13); use=NegativeTests.Bug260.fst(21,5-21,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
NegativeTests.Bug260.pnat)
(HasType (NegativeTests.Bug260.validity @x0)
Tm_type))
 

:pattern ((NegativeTests.Bug260.validity @x0))
:qid kinding_NegativeTests.Bug260.validity@tok))
)
:named kinding_NegativeTests.Bug260.validity@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(21,5-21,13); use=NegativeTests.Bug260.fst(21,5-21,13)
...
@x1
(NegativeTests.Bug260.validity @x2))
(and (is-NegativeTests.Bug260.VSucc @x1)
(= @x2
(NegativeTests.Bug260.S (NegativeTests.Bug260.VSucc_n @x1)))))
 

:pattern ((HasTypeFuel @u0
@x1
(NegativeTests.Bug260.validity @x2)))
:qid fuel_guarded_inversion_NegativeTests.Bug260.validity))

:named fuel_guarded_inversion_NegativeTests.Bug260.validity))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! (= 162
(Term_constr_id NegativeTests.Bug260.validity@tok))
:named fresh_token_NegativeTests.Bug260.validity@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(22,4-22,9); use=NegativeTests.Bug260.fst(22,4-22,9)
...
(NegativeTests.Bug260.VSucc @x1)
(NegativeTests.Bug260.validity @x2)))
:qid data_typing_intro_NegativeTests.Bug260.VSucc@tok))

:named data_typing_intro_NegativeTests.Bug260.VSucc@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(22,4-22,9); use=NegativeTests.Bug260.fst(22,4-22,9)
...
(NegativeTests.Bug260.VSucc @x1)
(NegativeTests.Bug260.validity @x2)))
:qid data_elim_NegativeTests.Bug260.VSucc))

:named data_elim_NegativeTests.Bug260.VSucc))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(21,5-21,13); use=NegativeTests.Bug260.fst(21,5-21,13)
(forall ((@x0 Term))
 (! (= 161
(Term_constr_id (NegativeTests.Bug260.validity @x0)))
 

:pattern ((NegativeTests.Bug260.validity @x0))
:qid constructor_distinct_NegativeTests.Bug260.validity))

:named constructor_distinct_NegativeTests.Bug260.validity))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(22,4-22,9); use=NegativeTests.Bug260.fst(22,4-22,9)
(forall ((@x0 Term))
 (! (= 168
(Term_constr_id (NegativeTests.Bug260.VSucc @x0)))
 

:pattern ((NegativeTests.Bug260.VSucc @x0))
:qid constructor_distinct_NegativeTests.Bug260.VSucc))

:named constructor_distinct_NegativeTests.Bug260.VSucc))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name NegativeTests.Bug260.validity; Namespace NegativeTests.Bug260; Name NegativeTests.Bug260.VSucc; Namespace NegativeTests.Bug260
(assert (! 
;; def=NegativeTests.Bug260.fst(21,5-21,13); use=NegativeTests.Bug260.fst(21,5-21,13)
...
@x0
(NegativeTests.Bug260.validity @x2)))
:qid NegativeTests.Bug260_pretyping_341d975bcdd41d5c5ad86bd8283edcb5))

:named NegativeTests.Bug260_pretyping_341d975bcdd41d5c5ad86bd8283edcb5))
(push) ;; push{4

; Starting query at NegativeTests.Bug260.fst(21,0-22,42)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (n: NegativeTests.Bug260.pnat).
;   (forall (n: NegativeTests.Bug260.pnat). {:pattern Prims.hasEq (NegativeTests.Bug260.validity n)}
;       Prims.hasEq (NegativeTests.Bug260.validity n)) ==>
;   (forall (n: NegativeTests.Bug260.pnat).
;       (*  - Failed to prove that the type
;     'NegativeTests.Bug260.validity'
;     supports decidable equality because of this argument.
;   - Add either the 'noeq' or 'unopteq' qualifier
; *)
;       Prims.hasEq NegativeTests.Bug260.pnat)
...
; Context: While encoding a query
; While typechecking the top-level declaration `type NegativeTests.Bug260.validity`
...
;; def=NegativeTests.Bug260.fst(21,0-22,42); use=NegativeTests.Bug260.fst(21,0-22,42)
(forall ((@x1 Term))
 (! (implies (HasType @x1
NegativeTests.Bug260.pnat)
...
(Valid 
;; def=NegativeTests.Bug260.fst(21,0-22,42); use=NegativeTests.Bug260.fst(21,0-22,42)
(Prims.hasEq (NegativeTests.Bug260.validity @x1))
)
)
 

:pattern ((Prims.hasEq (NegativeTests.Bug260.validity @x1)))
:qid @query.1))
)
...
;; def=NegativeTests.Bug260.fst(21,0-22,42); use=NegativeTests.Bug260.fst(22,14-22,18)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Bug260.validity, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_NegativeTests.Bug260.pnat__uu___haseq
...
; encoding sigelt assume NegativeTests.Bug260.validity__uu___haseq


; <Start encoding assume NegativeTests.Bug260.validity__uu___haseq>


; </end encoding assume NegativeTests.Bug260.validity__uu___haseq>


; encoding sigelt val NegativeTests.Bug260.uu___is_VSucc


; <Start encoding val NegativeTests.Bug260.uu___is_VSucc>

(declare-fun NegativeTests.Bug260.uu___is_VSucc (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: validity n -> Prims.bool
(declare-fun Tm_arrow_22d8c05d33389ec06f82b04900786543 () Term)
(declare-fun NegativeTests.Bug260.uu___is_VSucc@tok () Term)

; </end encoding val NegativeTests.Bug260.uu___is_VSucc>


; encoding sigelt let uu___is_VSucc


; <Skipped let uu___is_VSucc/>


; encoding sigelt val NegativeTests.Bug260.__proj__VSucc__item__n


; <Start encoding val NegativeTests.Bug260.__proj__VSucc__item__n>

(declare-fun NegativeTests.Bug260.__proj__VSucc__item__n (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: validity n -> pnat
(declare-fun Tm_arrow_e8dbabc59947df3ff8b0372aa5c0369d () Term)
(declare-fun NegativeTests.Bug260.__proj__VSucc__item__n@tok () Term)

; </end encoding val NegativeTests.Bug260.__proj__VSucc__item__n>


; encoding sigelt let __proj__VSucc__item__n


; <Skipped let __proj__VSucc__item__n/>


; encoding sigelt val NegativeTests.Bug260.bad


; <Skipped val NegativeTests.Bug260.bad/>
...
; Starting query at NegativeTests.Bug260.fst(26,12-26,19)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (t: NegativeTests.Bug260.pnat).
;   (*  - Could not prove post-condition
; *) t == NegativeTests.Bug260.S t


; Context: While encoding a query
; While typechecking the top-level declaration `let bad`
; While typechecking the top-level declaration `[@@expect_failure] let bad`
...
;; def=NegativeTests.Bug260.fst(23,37-26,9); use=NegativeTests.Bug260.fst(26,12-26,19)
(or label_1

;; def=NegativeTests.Bug260.fst(23,37-26,9); use=NegativeTests.Bug260.fst(26,12-26,19)
(= @x0
(NegativeTests.Bug260.S @x0))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Bug260.bad, 1)
