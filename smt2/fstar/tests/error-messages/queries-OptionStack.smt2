...
; Internals for OptionStack


; encoding sigelt val OptionStack.p


; <Start encoding val OptionStack.p>

(declare-fun OptionStack.p (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.prop
(declare-fun Tm_arrow_3a9c22ddc54716caa0276c05e792d97e () Term)
(declare-fun OptionStack.p@tok () Term)

; </end encoding val OptionStack.p>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OptionStack.p; Namespace OptionStack
(assert (! 
;; def=OptionStack.fst(18,11-18,12); use=OptionStack.fst(18,11-18,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (OptionStack.p @x0)
Prims.prop))
 

:pattern ((OptionStack.p @x0))
:qid typing_OptionStack.p))

:named typing_OptionStack.p))
;;;;;;;;;;;;;;;;refinement kinding
...
; Starting query at OptionStack.fst(21,0-21,21)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (OptionStack.p 1)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let t0`
; While typechecking the top-level declaration `[@@expect_failure] let t0`
...
;;; Fact-ids: 
(assert (! (not 
;; def=OptionStack.fst(21,16-21,21); use=OptionStack.fst(21,9-21,15)
(or label_1

;; def=OptionStack.fst(21,16-21,21); use=OptionStack.fst(21,9-21,15)
(Valid 
;; def=OptionStack.fst(21,16-21,21); use=OptionStack.fst(21,9-21,15)
(OptionStack.p (BoxInt 1))
)
)
)
:named @query))
...
; Starting query at OptionStack.fst(24,0-24,21)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (OptionStack.p 2)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let t1`
; While typechecking the top-level declaration `[@@expect_failure] let t1`
...
;;; Fact-ids: 
(assert (! (not 
;; def=OptionStack.fst(24,16-24,21); use=OptionStack.fst(24,9-24,15)
(or label_1

;; def=OptionStack.fst(24,16-24,21); use=OptionStack.fst(24,9-24,15)
(Valid 
;; def=OptionStack.fst(24,16-24,21); use=OptionStack.fst(24,9-24,15)
(OptionStack.p (BoxInt 2))
)
)
)
:named @query))
...
; Starting query at OptionStack.fst(27,0-27,21)
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let t2`
; While typechecking the top-level declaration `[@@expect_failure] let t2`
...
; encoding sigelt #push-options "--admit_smt_queries true"


; <Skipped #push-options "--admit_smt_queries true"/>


; encoding sigelt let t3


; <Start encoding let t3>

(declare-fun OptionStack.t3 (Dummy_sort) Term)

; </end encoding let t3>


; encoding sigelt let t4


; <Start encoding let t4>

(declare-fun OptionStack.t4 (Dummy_sort) Term)

; </end encoding let t4>


; encoding sigelt let t5


; <Start encoding let t5>

(declare-fun OptionStack.t5 (Dummy_sort) Term)

; </end encoding let t5>


; encoding sigelt let t6


; <Start encoding let t6>

(declare-fun OptionStack.t6 (Dummy_sort) Term)
...
; Starting query at OptionStack.fst(39,0-39,21)
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let t7`
; While typechecking the top-level declaration `[@@expect_failure] let t7`
