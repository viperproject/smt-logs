...
; Internals for NegativeTests.Heap


; encoding sigelt val NegativeTests.Heap.x


; <Start encoding val NegativeTests.Heap.x>

(declare-fun NegativeTests.Heap.x (Dummy_sort) Term)

; </end encoding val NegativeTests.Heap.x>


; encoding sigelt val NegativeTests.Heap.y


; <Start encoding val NegativeTests.Heap.y>

(declare-fun NegativeTests.Heap.y (Dummy_sort) Term)

; </end encoding val NegativeTests.Heap.y>


; encoding sigelt val NegativeTests.Heap.h


; <Start encoding val NegativeTests.Heap.h>

(declare-fun NegativeTests.Heap.h (Dummy_sort) Term)

; </end encoding val NegativeTests.Heap.h>


; encoding sigelt assume NegativeTests.Heap.DistinctXY


; <Start encoding assume NegativeTests.Heap.DistinctXY>


; </end encoding assume NegativeTests.Heap.DistinctXY>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Heap.y; Namespace NegativeTests.Heap
(assert (! 
;; def=NegativeTests.Heap.fst(21,11-21,12); use=NegativeTests.Heap.fst(21,11-21,12)
(forall ((@u0 Dummy_sort))
 (! (HasType (NegativeTests.Heap.y @u0)
(FStar.Heap.ref Prims.int))
 

:pattern ((NegativeTests.Heap.y @u0))
:qid typing_NegativeTests.Heap.y))

:named typing_NegativeTests.Heap.y))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Heap.x; Namespace NegativeTests.Heap
(assert (! 
;; def=NegativeTests.Heap.fst(20,11-20,12); use=NegativeTests.Heap.fst(20,11-20,12)
(forall ((@u0 Dummy_sort))
 (! (HasType (NegativeTests.Heap.x @u0)
(FStar.Heap.ref Prims.int))
 

:pattern ((NegativeTests.Heap.x @u0))
:qid typing_NegativeTests.Heap.x))

:named typing_NegativeTests.Heap.x))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Heap.h; Namespace NegativeTests.Heap
(assert (! 
;; def=NegativeTests.Heap.fst(22,11-22,12); use=NegativeTests.Heap.fst(22,11-22,12)
(forall ((@u0 Dummy_sort))
 (! (HasType (NegativeTests.Heap.h @u0)
FStar.Monotonic.Heap.heap)
 

:pattern ((NegativeTests.Heap.h @u0))
:qid typing_NegativeTests.Heap.h))

:named typing_NegativeTests.Heap.h))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Heap.ref; Namespace FStar.Heap
(assert (! 
;; def=FStar.Heap.fst(24,5-24,8); use=FStar.Heap.fst(24,5-24,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.Heap.ref @x0)
Tm_type))
 

:pattern ((FStar.Heap.ref @x0))
:qid typing_FStar.Heap.ref))

:named typing_FStar.Heap.ref))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
:pattern ((FStar.Heap.ref @x0))
:qid equation_FStar.Heap.ref))

:named equation_FStar.Heap.ref))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;;;;;;;;;;;;;;;;Assumption: NegativeTests.Heap.DistinctXY
;;; Fact-ids: Name NegativeTests.Heap.DistinctXY; Namespace NegativeTests.Heap
(assert (! 
;; def=NegativeTests.Heap.fst(23,19-23,26); use=NegativeTests.Heap.fst(23,19-23,26)
(not 
;; def=NegativeTests.Heap.fst(23,19-23,26); use=NegativeTests.Heap.fst(23,19-23,26)
(= (NegativeTests.Heap.x Dummy_value)
(NegativeTests.Heap.y Dummy_value))
)

:named assumption_NegativeTests.Heap.DistinctXY))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
; Starting query at NegativeTests.Heap.fst(26,14-26,54)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Type) (_: _).
;   (*  - Could not prove post-condition
; *)
;   FStar.Monotonic.Heap.sel (FStar.Monotonic.Heap.upd (FStar.Monotonic.Heap.upd NegativeTests.Heap.h
;             NegativeTests.Heap.x
;             0)
;         NegativeTests.Heap.y
;         1)
;     NegativeTests.Heap.y =
;   0
...
;; def=NegativeTests.Heap.fst(26,21-26,54); use=NegativeTests.Heap.fst(26,21-26,54)
(or label_1

;; def=NegativeTests.Heap.fst(26,21-26,54); use=NegativeTests.Heap.fst(26,21-26,54)
(= (FStar.Monotonic.Heap.sel Prims.int
(FStar.Heap.trivial_preorder Prims.int)
(FStar.Monotonic.Heap.upd Prims.int
(FStar.Heap.trivial_preorder Prims.int)
(FStar.Monotonic.Heap.upd Prims.int
(FStar.Heap.trivial_preorder Prims.int)
(NegativeTests.Heap.h Dummy_value)
(NegativeTests.Heap.x Dummy_value)
(BoxInt 0))
(NegativeTests.Heap.y Dummy_value)
(BoxInt 1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Heap.test2, 1)
