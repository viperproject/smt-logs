...
; Starting query at PatImps.fst(4,2-6,17)

(declare-fun label_1 () Bool)

; Encoding query formula : forall ('a: Type) (x: Prims.list 'a).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Prims.int).
;     (forall (x: Prims.int). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(Nil? x) /\ ~(Cons? x) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let f1`
...
;; def=Prims.fst(402,27-402,88); use=PatImps.fst(4,2-6,17)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=PatImps.fst(4,2-6,17)
(Valid 
;; def=Prims.fst(402,84-402,87); use=PatImps.fst(4,2-6,17)
(ApplyTT @x2
@x3)
...
;; def=PatImps.fst(3,8-3,9); use=PatImps.fst(4,8-4,9)
(not 
;; def=PatImps.fst(3,8-3,9); use=PatImps.fst(4,8-4,9)
...
(declare-fun PatImps.f1 (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.list 'a -> Prims.int
(declare-fun Tm_arrow_3433562eec8491ed3fff7de6793b4a95 () Term)
(declare-fun PatImps.f1@tok () Term)

; </end encoding let f1>


; encoding sigelt type PatImps.t2


; <Start encoding type PatImps.t2>

;;;;;;;;;;;;;;;;Constructor
(declare-fun PatImps.t2 () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PatImps.A (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PatImps.A_x (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: PatImps.A
(declare-fun PatImps.A@tok () Term)
;;;;;;;;;;;;;;;;t2
(declare-fun Tm_arrow_e8eb77a58c3626631ad1bb92cad21817 () Term)

; <start constructor PatImps.t2>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PatImps.t2 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
106)
(= __@x0
PatImps.t2)))

; </end constructor PatImps.t2>


; <start constructor PatImps.A>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PatImps.A ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
112)
(= __@x0
(PatImps.A (PatImps.A_x __@x0)))))

; </end constructor PatImps.A>


; </end encoding type PatImps.t2>


; encoding sigelt val PatImps.uu___is_A


; <Start encoding val PatImps.uu___is_A>

(declare-fun PatImps.uu___is_A (Term) Term)
;;;;;;;;;;;;;;;;projectee: t2 -> Prims.bool
(declare-fun Tm_arrow_a6e84ddb40ccab914f5dd14ae052ac3d () Term)
(declare-fun PatImps.uu___is_A@tok () Term)

; </end encoding val PatImps.uu___is_A>
...
; encoding sigelt val PatImps.__proj__A__item__x


; <Start encoding val PatImps.__proj__A__item__x>

(declare-fun PatImps.__proj__A__item__x (Term) Term)
;;;;;;;;;;;;;;;;projectee: t2 -> Prims.int
(declare-fun Tm_arrow_2e1f4ccddfcdcdf851e22cb407b878be () Term)
(declare-fun PatImps.__proj__A__item__x@tok () Term)

; </end encoding val PatImps.__proj__A__item__x>


; encoding sigelt let __proj__A__item__x


; <Skipped let __proj__A__item__x/>


; encoding sigelt let f2


; <Start encoding let f2>

(declare-fun PatImps.f2 (Term) Term)

(declare-fun PatImps.f2@tok () Term)

; </end encoding let f2>


; encoding sigelt type PatImps.t3


; <Start encoding type PatImps.t3>

;;;;;;;;;;;;;;;;Constructor
(declare-fun PatImps.t3 () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PatImps.B (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PatImps.B_x (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: PatImps.B
(declare-fun PatImps.B@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PatImps.C (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PatImps.C_x (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: PatImps.C
(declare-fun PatImps.C@tok () Term)
;;;;;;;;;;;;;;;;t3
(declare-fun Tm_arrow_7e9c06cb9a9f41ce342e7fa0420eb71a () Term)


; <start constructor PatImps.t3>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PatImps.t3 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
PatImps.t3)))

; </end constructor PatImps.t3>


; <start constructor PatImps.B>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PatImps.B ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
128)
(= __@x0
(PatImps.B (PatImps.B_x __@x0)))))

; </end constructor PatImps.B>


; <start constructor PatImps.C>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PatImps.C ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
133)
(= __@x0
(PatImps.C (PatImps.C_x __@x0)))))

; </end constructor PatImps.C>


; </end encoding type PatImps.t3>


; encoding sigelt val PatImps.uu___is_B


; <Start encoding val PatImps.uu___is_B>

(declare-fun PatImps.uu___is_B (Term) Term)
;;;;;;;;;;;;;;;;projectee: t3 -> Prims.bool
(declare-fun Tm_arrow_62debdc71c76afb7189915a22c7e37d8 () Term)
(declare-fun PatImps.uu___is_B@tok () Term)

; </end encoding val PatImps.uu___is_B>
...
; encoding sigelt val PatImps.__proj__B__item__x


; <Start encoding val PatImps.__proj__B__item__x>

(declare-fun Tm_refine_d12b69dbfc634a024ebe6635710ee639 () Term)
(declare-fun PatImps.__proj__B__item__x (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t3{B? _} -> Prims.int
(declare-fun Tm_arrow_4c9094e456cf372c85f4c4505396171f () Term)
(declare-fun PatImps.__proj__B__item__x@tok () Term)

; </end encoding val PatImps.__proj__B__item__x>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatImps.uu___is_B; Namespace PatImps
(assert (! 
;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,4-17,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
PatImps.t3)
(HasType (PatImps.uu___is_B @x0)
Prims.bool))
 

:pattern ((PatImps.uu___is_B @x0))
:qid typing_PatImps.uu___is_B))

:named typing_PatImps.uu___is_B))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,4-18,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(PatImps.C @x1)
PatImps.t3)
...
(PatImps.C @x1)
PatImps.t3))
:qid subterm_ordering_PatImps.C))

:named subterm_ordering_PatImps.C))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,4-17,5)
...
(PatImps.B @x1)
PatImps.t3))
:qid subterm_ordering_PatImps.B))

:named subterm_ordering_PatImps.B))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name PatImps.__proj__B__item__x; Namespace PatImps
(assert (! (HasType Tm_refine_d12b69dbfc634a024ebe6635710ee639
Tm_type)
:named refinement_kinding_Tm_refine_d12b69dbfc634a024ebe6635710ee639))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name PatImps.__proj__B__item__x; Namespace PatImps
(assert (! 
;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,4-17,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_d12b69dbfc634a024ebe6635710ee639)
(and (HasTypeFuel @u0
@x1
PatImps.t3)

;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,4-17,5)
(BoxBool_proj_0 (PatImps.uu___is_B @x1))
))
...
@x1
Tm_refine_d12b69dbfc634a024ebe6635710ee639))
:qid refinement_interpretation_Tm_refine_d12b69dbfc634a024ebe6635710ee639))

:named refinement_interpretation_Tm_refine_d12b69dbfc634a024ebe6635710ee639))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,4-18,5)
(forall ((@x0 Term))
 (! (= (PatImps.C_x (PatImps.C @x0))
@x0)
 

:pattern ((PatImps.C @x0))
:qid projection_inverse_PatImps.C_x))

:named projection_inverse_PatImps.C_x))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,4-17,5)
(forall ((@x0 Term))
 (! (= (PatImps.B_x (PatImps.B @x0))
@x0)
 

:pattern ((PatImps.B @x0))
:qid projection_inverse_PatImps.B_x))

:named projection_inverse_PatImps.B_x))
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! (HasType PatImps.t3
Tm_type)
:named kinding_PatImps.t3@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d12b69dbfc634a024ebe6635710ee639
;;; Fact-ids: Name PatImps.__proj__B__item__x; Namespace PatImps
(assert (! (iff (Valid (Prims.hasEq Tm_refine_d12b69dbfc634a024ebe6635710ee639))
(Valid (Prims.hasEq PatImps.t3)))
:named haseqTm_refine_d12b69dbfc634a024ebe6635710ee639))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(16,5-16,7); use=PatImps.fst(16,5-16,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
PatImps.t3)
...
@x1
PatImps.t3))
:qid fuel_guarded_inversion_PatImps.t3))

:named fuel_guarded_inversion_PatImps.t3))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name PatImps.uu___is_B; Namespace PatImps
(assert (! 
;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,4-17,5)
(forall ((@x0 Term))
 (! (= (PatImps.uu___is_B @x0)
(BoxBool (is-PatImps.B @x0)))
 

:pattern ((PatImps.uu___is_B @x0))
:qid disc_equation_PatImps.B))

:named disc_equation_PatImps.B))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,4-18,5)
...
(PatImps.C @x1)
PatImps.t3))
:qid data_typing_intro_PatImps.C@tok))

:named data_typing_intro_PatImps.C@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,4-17,5)
...
(PatImps.B @x1)
PatImps.t3))
:qid data_typing_intro_PatImps.B@tok))

:named data_typing_intro_PatImps.B@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,4-18,5)
...
(PatImps.C @x1)
PatImps.t3))
:qid data_elim_PatImps.C))

:named data_elim_PatImps.C))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,4-17,5)
...
(PatImps.B @x1)
PatImps.t3))
:qid data_elim_PatImps.B))

:named data_elim_PatImps.B))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! (= 122
(Term_constr_id PatImps.t3))
:named constructor_distinct_PatImps.t3))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,4-18,5)
(forall ((@x0 Term))
 (! (= 133
(Term_constr_id (PatImps.C @x0)))
 

:pattern ((PatImps.C @x0))
:qid constructor_distinct_PatImps.C))

:named constructor_distinct_PatImps.C))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,4-17,5)
(forall ((@x0 Term))
 (! (= 128
(Term_constr_id (PatImps.B @x0)))
 

:pattern ((PatImps.B @x0))
:qid constructor_distinct_PatImps.B))

:named constructor_distinct_PatImps.B))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name PatImps.t3; Namespace PatImps; Name PatImps.B; Namespace PatImps; Name PatImps.C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(16,5-16,7); use=PatImps.fst(16,5-16,7)
...
@x0
PatImps.t3))
:qid PatImps_pretyping_ef399339244f5a28ec7343a4bcce46f6))

:named PatImps_pretyping_ef399339244f5a28ec7343a4bcce46f6))
(push) ;; push{2

; Starting query at PatImps.fst(17,9-17,10)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: PatImps.t3{B? _}).
;   (*  - Could not prove post-condition
; *) ~(B? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__B__item__x`
...
;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,9-17,10)
(not 
;; def=PatImps.fst(17,4-17,5); use=PatImps.fst(17,9-17,10)
(BoxBool_proj_0 (PatImps.uu___is_B @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatImps.__proj__B__item__x, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_d12b69dbfc634a024ebe6635710ee639
...
; encoding sigelt let __proj__B__item__x


; <Skipped let __proj__B__item__x/>


; encoding sigelt val PatImps.uu___is_C


; <Start encoding val PatImps.uu___is_C>

(declare-fun PatImps.uu___is_C (Term) Term)

(declare-fun PatImps.uu___is_C@tok () Term)

; </end encoding val PatImps.uu___is_C>
...
; encoding sigelt val PatImps.__proj__C__item__x


; <Start encoding val PatImps.__proj__C__item__x>

(declare-fun Tm_refine_d42021b5d15fa2ad400d571ee4741f6a () Term)
(declare-fun PatImps.__proj__C__item__x (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t3{C? _} -> Prims.int
(declare-fun Tm_arrow_79d8df6132ee01fca25432289eb72f4d () Term)
(declare-fun PatImps.__proj__C__item__x@tok () Term)

; </end encoding val PatImps.__proj__C__item__x>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatImps.uu___is_C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,4-18,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
PatImps.t3)
(HasType (PatImps.uu___is_C @x0)
Prims.bool))
 

:pattern ((PatImps.uu___is_C @x0))
:qid typing_PatImps.uu___is_C))

:named typing_PatImps.uu___is_C))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name PatImps.__proj__C__item__x; Namespace PatImps
(assert (! (HasType Tm_refine_d42021b5d15fa2ad400d571ee4741f6a
Tm_type)
:named refinement_kinding_Tm_refine_d42021b5d15fa2ad400d571ee4741f6a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name PatImps.__proj__C__item__x; Namespace PatImps
(assert (! 
;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,4-18,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_d42021b5d15fa2ad400d571ee4741f6a)
(and (HasTypeFuel @u0
@x1
PatImps.t3)

;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,4-18,5)
(BoxBool_proj_0 (PatImps.uu___is_C @x1))
))
...
@x1
Tm_refine_d42021b5d15fa2ad400d571ee4741f6a))
:qid refinement_interpretation_Tm_refine_d42021b5d15fa2ad400d571ee4741f6a))

:named refinement_interpretation_Tm_refine_d42021b5d15fa2ad400d571ee4741f6a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d42021b5d15fa2ad400d571ee4741f6a
;;; Fact-ids: Name PatImps.__proj__C__item__x; Namespace PatImps
(assert (! (iff (Valid (Prims.hasEq Tm_refine_d42021b5d15fa2ad400d571ee4741f6a))
(Valid (Prims.hasEq PatImps.t3)))
:named haseqTm_refine_d42021b5d15fa2ad400d571ee4741f6a))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name PatImps.uu___is_C; Namespace PatImps
(assert (! 
;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,4-18,5)
(forall ((@x0 Term))
 (! (= (PatImps.uu___is_C @x0)
(BoxBool (is-PatImps.C @x0)))
 

:pattern ((PatImps.uu___is_C @x0))
:qid disc_equation_PatImps.C))

:named disc_equation_PatImps.C))
(push) ;; push{2

; Starting query at PatImps.fst(18,9-18,10)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: PatImps.t3{C? _}).
;   (*  - Could not prove post-condition
; *) ~(C? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__C__item__x`
...
;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,9-18,10)
(not 
;; def=PatImps.fst(18,4-18,5); use=PatImps.fst(18,9-18,10)
(BoxBool_proj_0 (PatImps.uu___is_C @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatImps.__proj__C__item__x, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_d42021b5d15fa2ad400d571ee4741f6a
...
; Starting query at PatImps.fst(21,2-23,13)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: PatImps.t3).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Prims.int).
;     (forall (x: Prims.int). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(B? x) /\ ~(C? x) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let f3`
...
;; def=Prims.fst(402,27-402,88); use=PatImps.fst(21,2-23,13)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=PatImps.fst(21,2-23,13)
(Valid 
;; def=Prims.fst(402,84-402,87); use=PatImps.fst(21,2-23,13)
(ApplyTT @x1
@x2)
...
;; def=PatImps.fst(20,8-20,9); use=PatImps.fst(21,8-21,9)
(not 
;; def=PatImps.fst(20,8-20,9); use=PatImps.fst(21,8-21,9)
(BoxBool_proj_0 (PatImps.uu___is_B @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatImps.f3, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_PatImps.B, disc_equation_PatImps.C, fuel_guarded_inversion_PatImps.t3, projection_inverse_BoxBool_proj_0
