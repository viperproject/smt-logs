...
(declare-fun Coercions.test1 (Term) Term)
;;;;;;;;;;;;;;;;x: FStar.Ghost.erased Prims.int -> Prims.GTot Prims.int
(declare-fun Tm_ghost_arrow_d63f96709c13a9e16bcda3970dbc9684 () Term)
(declare-fun Coercions.test1@tok () Term)
...
(declare-fun Coercions.test2 (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> FStar.Ghost.erased Prims.int
(declare-fun Tm_arrow_50d3353809b5079ac9b36c7518a8ea9a () Term)
(declare-fun Coercions.test2@tok () Term)
...
(declare-fun Coercions.test3 (Term) Term)
;;;;;;;;;;;;;;;;x: FStar.Ghost.erased Prims.int -> FStar.Ghost.erased Prims.int
(declare-fun Tm_arrow_1bd8091082c2e7631ec1cb206db30d89 () Term)
(declare-fun Coercions.test3@tok () Term)
...
(declare-fun Coercions.test4 (Term) Term)

(declare-fun Coercions.test4@tok () Term)
...
(declare-fun Coercions.test5 (Term) Term)

(declare-fun Coercions.test5@tok () Term)
...
(declare-fun Coercions.test1_ (Term Term) Term)
;;;;;;;;;;;;;;;;x: FStar.Ghost.erased 'a -> Prims.GTot (FStar.Ghost.erased 'a)
(declare-fun Tm_arrow_28e26bff8087ac82fb9f77043cecca1e () Term)
(declare-fun Coercions.test1_@tok () Term)
...
(declare-fun Coercions.test2_ (Term Term) Term)

(declare-fun Coercions.test2_@tok () Term)
...
(declare-fun Coercions.test3_ (Term Term) Term)

(declare-fun Coercions.test3_@tok () Term)
...
(declare-fun Coercions.test4_ (Term Term) Term)

(declare-fun Coercions.test4_@tok () Term)
...
(declare-fun Coercions.test5_ (Term Term) Term)

(declare-fun Coercions.test5_@tok () Term)
...
(declare-fun Coercions.test1__ (Term Term) Term)

(declare-fun Coercions.test1__@tok () Term)
...
(declare-fun Coercions.test2__ (Term Term) Term)

(declare-fun Coercions.test2__@tok () Term)
...
(declare-fun Coercions.test3__ (Term Term) Term)

(declare-fun Coercions.test3__@tok () Term)
...
(declare-fun Coercions.test4__ (Term Term) Term)

(declare-fun Coercions.test4__@tok () Term)
...
(declare-fun Coercions.test5__ (Term Term) Term)

(declare-fun Coercions.test5__@tok () Term)

; </end encoding let test5''>


; encoding sigelt val Coercions.p


; <Start encoding val Coercions.p>

(declare-fun Coercions.p (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.prop
(declare-fun Tm_arrow_3a9c22ddc54716caa0276c05e792d97e () Term)
(declare-fun Coercions.p@tok () Term)

; </end encoding val Coercions.p>


; encoding sigelt val Coercions.foo


; <Start encoding val Coercions.foo>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Coercions.foo (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Coercions.foo@tok () Term)

; </end encoding val Coercions.foo>


; encoding sigelt let bar


; <Start encoding let bar>

(declare-fun Coercions.bar (Term) Term)
;;;;;;;;;;;;;;;;x: FStar.Ghost.erased Prims.int -> Prims.unit
(declare-fun Tm_arrow_526051600f91e7c5230d59f7549ad538 () Term)
(declare-fun Coercions.bar@tok () Term)

; </end encoding let bar>


; encoding sigelt let test_bar


; <Start encoding let test_bar>

(declare-fun Coercions.test_bar (Term) Term)

(declare-fun Coercions.test_bar@tok () Term)

; </end encoding let test_bar>


; encoding sigelt let test_nat_int_1


; <Start encoding let test_nat_int_1>

(declare-fun Coercions.test_nat_int_1 (Term) Term)
;;;;;;;;;;;;;;;;x: FStar.Ghost.erased Prims.nat -> Prims.GTot Prims.int
(declare-fun Tm_ghost_arrow_5ee6c79082142d06dc82493cce912ab8 () Term)
(declare-fun Coercions.test_nat_int_1@tok () Term)

; </end encoding let test_nat_int_1>


; encoding sigelt let test_nat_int_2


; <Start encoding let test_nat_int_2>

(declare-fun Coercions.test_nat_int_2 (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.nat -> FStar.Ghost.erased Prims.int
(declare-fun Tm_arrow_cc647a24f13d6095a5cf20ba7c3c8e2d () Term)
(declare-fun Coercions.test_nat_int_2@tok () Term)

; </end encoding let test_nat_int_2>
...
(declare-fun Coercions.test_nat_int_1_ (Term) Term)

(declare-fun Coercions.test_nat_int_1_@tok () Term)
...
(declare-fun Coercions.test_nat_int_2_ (Term) Term)

(declare-fun Coercions.test_nat_int_2_@tok () Term)

; </end encoding let test_nat_int_2'>


; encoding sigelt let int2


; <Start encoding let int2>

(declare-fun Coercions.int2 (Dummy_sort) Term)

; </end encoding let int2>


; encoding sigelt let test_int2_int_1


; <Start encoding let test_int2_int_1>

(declare-fun Coercions.test_int2_int_1 (Term) Term)
;;;;;;;;;;;;;;;;x: FStar.Ghost.erased int2 -> Prims.GTot Prims.int
(declare-fun Tm_ghost_arrow_91a752fa273fdd500ff96d72a35e4c3d () Term)
(declare-fun Coercions.test_int2_int_1@tok () Term)

; </end encoding let test_int2_int_1>


; encoding sigelt let test_int2_int_2


; <Start encoding let test_int2_int_2>

(declare-fun Coercions.test_int2_int_2 (Term) Term)
;;;;;;;;;;;;;;;;x: int2 -> FStar.Ghost.erased Prims.int
(declare-fun Tm_arrow_21b04fd9f819fdc1e62b5eb86692bcad () Term)
(declare-fun Coercions.test_int2_int_2@tok () Term)

; </end encoding let test_int2_int_2>
...
(declare-fun Coercions.test_int2_int_1_ (Term) Term)
;;;;;;;;;;;;;;;;x: FStar.Ghost.erased Prims.int -> Prims.GTot int2
(declare-fun Tm_ghost_arrow_ac94d209c6e361b0c89ece99e6f79991 () Term)
(declare-fun Coercions.test_int2_int_1_@tok () Term)
...
(declare-fun Coercions.test_int2_int_2_ (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> FStar.Ghost.erased int2
(declare-fun Tm_arrow_2d40549cdaf83fe2fb112bd487ddc0ad () Term)
(declare-fun Coercions.test_int2_int_2_@tok () Term)

; </end encoding let test_int2_int_2'>


; encoding sigelt let test_literal


; <Start encoding let test_literal>

(declare-fun Coercions.test_literal (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> FStar.Ghost.erased Prims.nat
(declare-fun Tm_arrow_70861bad94442ccc53afac993894b4db () Term)
(declare-fun Coercions.test_literal@tok () Term)

; </end encoding let test_literal>
...
; Starting query at Coercions.fst(69,25-71,8)
...
; While typechecking the top-level declaration `let test_literal_bad`
; While typechecking the top-level declaration `[@@expect_failure] let test_literal_bad`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Coercions.test_literal_bad, 1)
...
; Starting query at Coercions.fst(74,49-74,57)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: FStar.Ghost.erased Prims.int).
;   (*  - Could not prove post-condition
; *) forall (any_result: Prims.int). x == any_result ==> x >= 0


; Context: While encoding a query
; While typechecking the top-level declaration `let test_int_nat_1`
; While typechecking the top-level declaration `[@@expect_failure] let test_int_nat_1`
...
;; def=Prims.fst(451,66-451,102); use=Coercions.fst(74,49-74,57)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=Coercions.fst(74,43-74,57); use=Coercions.fst(74,49-74,57)
(= (FStar.Ghost.reveal Prims.int
@x0)
@x1)
)

;; def=Prims.fst(680,18-680,24); use=Coercions.fst(74,49-74,57)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Coercions.test_int_nat_1, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; Starting query at Coercions.fst(76,50-76,56)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let test_int_nat_2`
; While typechecking the top-level declaration `[@@expect_failure] let test_int_nat_2`
...
;; def=Prims.fst(680,18-680,24); use=Coercions.fst(76,55-76,56)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Coercions.test_int_nat_2, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; Starting query at Coercions.fst(78,50-78,51)
...
;; def=Prims.fst(451,66-451,102); use=Coercions.fst(78,50-78,51)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=Coercions.fst(78,21-78,47); use=Coercions.fst(78,50-78,51)
(= (FStar.Ghost.reveal Prims.int
@x0)
@x1)
)

;; def=Prims.fst(680,18-680,24); use=Coercions.fst(78,50-78,51)
(or label_1
...
; Starting query at Coercions.fst(80,51-80,52)
...
;; def=Prims.fst(680,18-680,24); use=Coercions.fst(80,51-80,52)
(or label_1
...
; encoding sigelt val Coercions.flag


; <Start encoding val Coercions.flag>

(declare-fun Coercions.flag (Dummy_sort) Term)

; </end encoding val Coercions.flag>


; encoding sigelt let c_erased_int


; <Start encoding let c_erased_int>

(declare-fun Coercions.c_erased_int () Term)

; </end encoding let c_erased_int>
...
:named typing_FStar.Ghost.erased))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Coercions.flag; Namespace Coercions
(assert (! 
;; def=Coercions.fst(86,11-86,15); use=Coercions.fst(86,11-86,15)
(forall ((@u0 Dummy_sort))
 (! (HasType (Coercions.flag @u0)
Prims.bool)
 

:pattern ((Coercions.flag @u0))
:qid typing_Coercions.flag))

:named typing_Coercions.flag))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Coercions.c_erased_int; Namespace Coercions
(assert (! (HasType Coercions.c_erased_int
Tm_type)
:named typing_Coercions.c_erased_int))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
(assert (! (HasType Coercions.c_erased_int
Tm_type)
:named function_token_typing_Coercions.c_erased_int))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
Tm_refine_414d0a9f578ab0048252f8c8f552b99f)
:named equation_Prims.eqtype))
;;;;;;;;;;;;;;;;Equation for Coercions.c_erased_int
;;; Fact-ids: Name Coercions.c_erased_int; Namespace Coercions
(assert (! (= Coercions.c_erased_int
(let ((@lb0 (Coercions.flag Dummy_value)))
(ite (= @lb0
(BoxBool true))
Prims.int
(FStar.Ghost.erased Prims.int))))
:named equation_Coercions.c_erased_int))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at Coercions.fst(90,38-90,64)
...
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Coercions.c_erased_int).
;     (forall (x: Coercions.c_erased_int). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     (Coercions.flag == true ==> Prims.has_type 0 Coercions.c_erased_int) /\
;     (~(Coercions.flag = true) ==>
;       (forall (b: Prims.bool). Coercions.flag == b ==> Prims.has_type 0 Coercions.c_erased_int))


; Context: While encoding a query
; While typechecking the top-level declaration `let c_erased_zero`
...
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Coercions.c_erased_int))

;; def=Prims.fst(402,27-402,88); use=Coercions.fst(90,38-90,64)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Coercions.fst(90,38-90,64)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Coercions.fst(90,38-90,64)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(389,2-389,39); use=Coercions.fst(90,38-90,64)
(and (implies 
;; def=Coercions.fst(90,41-90,45); use=Coercions.fst(90,41-90,45)
(= (Coercions.flag Dummy_value)
(BoxBool true))


;; def=Coercions.fst(90,51-90,52); use=Coercions.fst(90,51-90,52)
(or label_1
(HasType (BoxInt 0)
Coercions.c_erased_int))
)
(implies 
;; def=Prims.fst(389,19-389,21); use=Coercions.fst(90,38-90,64)
(not 
;; def=Coercions.fst(90,41-90,45); use=Coercions.fst(90,41-90,45)
(= (Coercions.flag Dummy_value)
(BoxBool true))
...
;; def=Prims.fst(413,99-413,120); use=Coercions.fst(90,38-90,64)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.bool)

;; def=Coercions.fst(90,41-90,64); use=Coercions.fst(90,41-90,64)
(= (Coercions.flag Dummy_value)
@x2)
)

;; def=Coercions.fst(90,58-90,64); use=Coercions.fst(90,58-90,64)
(or label_2
(HasType (FStar.Ghost.hide Prims.int
(BoxInt 0))
Coercions.c_erased_int))
)
