...
; Starting query at ArrowRanges.fst(4,11-4,39)
...
;;; Fact-ids: 
(assert (! 
;; def=ArrowRanges.fst(4,11-4,39); use=ArrowRanges.fst(4,30-4,39)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_84543425b818e2d10a976186b8e8c250 @x2)))
:qid ArrowRanges_pre_typing_Tm_arrow_84543425b818e2d10a976186b8e8c250))

:named ArrowRanges_pre_typing_Tm_arrow_84543425b818e2d10a976186b8e8c250))
...
:pattern ((ApplyTT @x0
@x2))
:qid ArrowRanges_interpretation_Tm_arrow_84543425b818e2d10a976186b8e8c250.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_84543425b818e2d10a976186b8e8c250 @x1)))
:qid ArrowRanges_interpretation_Tm_arrow_84543425b818e2d10a976186b8e8c250))

:named ArrowRanges_interpretation_Tm_arrow_84543425b818e2d10a976186b8e8c250))

; Encoding query formula : forall (a: Type). (*  - Could not prove post-condition
; *) Prims.hasEq (_: a -> Prims.bool)


; Context: While encoding a query
; While typechecking the top-level declaration `let ppof`
; While typechecking the top-level declaration `[@@expect_failure] let ppof`
...
;; def=Prims.fst(73,23-73,30); use=ArrowRanges.fst(4,30-4,39)
(or label_1

;; def=Prims.fst(73,23-73,30); use=ArrowRanges.fst(4,30-4,39)
(Valid 
;; def=Prims.fst(73,23-73,30); use=ArrowRanges.fst(4,30-4,39)
(Prims.hasEq (Tm_arrow_84543425b818e2d10a976186b8e8c250 @x0))
)
)
)
...
; encoding sigelt type ArrowRanges.ppof


; <Start encoding type ArrowRanges.ppof>

;;;;;;;;;;;;;;;;Constructor
(declare-fun ArrowRanges.ppof (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun ArrowRanges.ppof@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ArrowRanges.Mkppof (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrowRanges.Mkppof_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrowRanges.Mkppof_tot_p (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrowRanges.Mkppof_gho_p (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrowRanges.Mkppof_ok (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ArrowRanges.Mkppof
(declare-fun ArrowRanges.Mkppof@tok () Term)
;;;;;;;;;;;;;;;;_: a -> _: a -> Prims.bool
...
(declare-fun Tm_refine_3b87f3ebe9e11b92b69781836d261833 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> Prims.squash (gho_p x y ==> tot_p x y)
(declare-fun Tm_arrow_21f882070549433fc8dd2e0d2d56e65d (Term Term Term) Term)




;;;;;;;;;;;;;;;;tot_p: (_: a -> _: a -> Prims.bool) ->     gho_p: (_: a -> _: a -> Type) ->     ok: (x: a -> y: a -> Prims.squash (gho_p x y ==> tot_p x y))   -> ArrowRanges.ppof a
(declare-fun Tm_arrow_f69cb8d0b5bd7b7f46f128e5c93294c3 () Term)

; <start constructor ArrowRanges.ppof>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ArrowRanges.ppof ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
135)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-ArrowRanges.ppof))))

; </end constructor ArrowRanges.ppof>


; <start constructor ArrowRanges.Mkppof>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ArrowRanges.Mkppof ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
149)
(= __@x0
(ArrowRanges.Mkppof (ArrowRanges.Mkppof_a __@x0)
(ArrowRanges.Mkppof_tot_p __@x0)
(ArrowRanges.Mkppof_gho_p __@x0)
(ArrowRanges.Mkppof_ok __@x0)))))

; </end constructor ArrowRanges.Mkppof>


; </end encoding type ArrowRanges.ppof>
...
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,5-7,9); use=ArrowRanges.fst(7,5-7,9)
(forall ((@x0 Term))
 (! (= (ApplyTT ArrowRanges.ppof@tok
@x0)
(ArrowRanges.ppof @x0))
 

:pattern ((ApplyTT ArrowRanges.ppof@tok
@x0))

:pattern ((ArrowRanges.ppof @x0))
:qid token_correspondence_ArrowRanges.ppof@tok))

:named token_correspondence_ArrowRanges.ppof@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,5-7,9); use=ArrowRanges.fst(7,5-7,9)
...
@x4)
(ArrowRanges.ppof @x5)))
:qid subterm_ordering_ArrowRanges.Mkppof))

:named subterm_ordering_ArrowRanges.Mkppof))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! (HasType Tm_refine_f1ecc6ab6882a651504f328937700647
Tm_type)
...
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(10,28-10,53); use=ArrowRanges.fst(10,28-10,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_3b87f3ebe9e11b92b69781836d261833 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_3b87f3ebe9e11b92b69781836d261833 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_3b87f3ebe9e11b92b69781836d261833))

:named refinement_kinding_Tm_refine_3b87f3ebe9e11b92b69781836d261833))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(772,26-772,42); use=FStar.Pervasives.fsti(772,26-772,42)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3b87f3ebe9e11b92b69781836d261833 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=ArrowRanges.fst(10,28-10,53); use=ArrowRanges.fst(10,28-10,53)
(implies 
;; def=ArrowRanges.fst(10,29-10,38); use=ArrowRanges.fst(10,29-10,38)
(Valid 
;; def=ArrowRanges.fst(10,29-10,38); use=ArrowRanges.fst(10,29-10,38)
(ApplyTT (ApplyTT @x2
@x3)
...
;; def=ArrowRanges.fst(10,43-10,52); use=ArrowRanges.fst(10,43-10,52)
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_3b87f3ebe9e11b92b69781836d261833))

:named refinement_interpretation_Tm_refine_3b87f3ebe9e11b92b69781836d261833))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,5-7,9); use=ArrowRanges.fst(7,5-7,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrowRanges.Mkppof_tot_p (ArrowRanges.Mkppof @x0
@x1
@x2
@x3))
@x1)
...
:pattern ((ArrowRanges.Mkppof @x0
@x1
@x2
@x3))
:qid projection_inverse_ArrowRanges.Mkppof_tot_p))

:named projection_inverse_ArrowRanges.Mkppof_tot_p))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,5-7,9); use=ArrowRanges.fst(7,5-7,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrowRanges.Mkppof_ok (ArrowRanges.Mkppof @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_ArrowRanges.Mkppof_ok))

:named projection_inverse_ArrowRanges.Mkppof_ok))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,5-7,9); use=ArrowRanges.fst(7,5-7,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrowRanges.Mkppof_gho_p (ArrowRanges.Mkppof @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_ArrowRanges.Mkppof_gho_p))

:named projection_inverse_ArrowRanges.Mkppof_gho_p))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,5-7,9); use=ArrowRanges.fst(7,5-7,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrowRanges.Mkppof_a (ArrowRanges.Mkppof @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_ArrowRanges.Mkppof_a))

:named projection_inverse_ArrowRanges.Mkppof_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! (is-Tm_arrow (PreType ArrowRanges.ppof@tok))
:named pre_kinding_ArrowRanges.ppof@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,11-8,28); use=ArrowRanges.fst(8,10-8,28)
(forall ((@x0 Term))
...
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,11-9,24); use=ArrowRanges.fst(9,10-9,24)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_21f882070549433fc8dd2e0d2d56e65d
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,11-10,53); use=ArrowRanges.fst(10,9-10,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_21f882070549433fc8dd2e0d2d56e65d @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_21f882070549433fc8dd2e0d2d56e65d @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_21f882070549433fc8dd2e0d2d56e65d))

:named kinding_Tm_arrow_21f882070549433fc8dd2e0d2d56e65d))
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! (and (IsTotFun ArrowRanges.ppof@tok)

;; def=ArrowRanges.fst(7,5-7,9); use=ArrowRanges.fst(7,5-7,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (ArrowRanges.ppof @x0)
Tm_type))
 

:pattern ((ArrowRanges.ppof @x0))
:qid kinding_ArrowRanges.ppof@tok))
)
:named kinding_ArrowRanges.ppof@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f1ecc6ab6882a651504f328937700647
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! (iff (Valid (Prims.hasEq Tm_refine_f1ecc6ab6882a651504f328937700647))
(Valid (Prims.hasEq Prims.unit)))
...
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3b87f3ebe9e11b92b69781836d261833
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(10,28-10,53); use=ArrowRanges.fst(10,28-10,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3b87f3ebe9e11b92b69781836d261833 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_3b87f3ebe9e11b92b69781836d261833 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_3b87f3ebe9e11b92b69781836d261833))

:named haseqTm_refine_3b87f3ebe9e11b92b69781836d261833))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
@x1
(ArrowRanges.ppof @x2))
(and (is-ArrowRanges.Mkppof @x1)
(= @x2
(ArrowRanges.Mkppof_a @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(ArrowRanges.ppof @x2)))
:qid fuel_guarded_inversion_ArrowRanges.ppof))

:named fuel_guarded_inversion_ArrowRanges.ppof))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! (= 136
(Term_constr_id ArrowRanges.ppof@tok))
:named fresh_token_ArrowRanges.ppof@tok))
;;;;;;;;;;;;;;;;Equation for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
(HasTypeFuel @u0
@x4
(Tm_arrow_21f882070549433fc8dd2e0d2d56e65d @x2
@x3
@x1)))
(HasTypeFuel @u0
(ArrowRanges.Mkppof @x1
...
@x4)
(ArrowRanges.ppof @x1)))
:qid data_typing_intro_ArrowRanges.Mkppof@tok))

:named data_typing_intro_ArrowRanges.Mkppof@tok))
...
(HasTypeFuel @u0
@x2
(Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e @x5))
(HasTypeFuel @u0
@x3
...
@x4)
(ArrowRanges.ppof @x5)))
:qid data_elim_ArrowRanges.Mkppof))

:named data_elim_ArrowRanges.Mkppof))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
(Term_constr_id Prims.unit))
...
(forall ((@x0 Term))
 (! (= 135
(Term_constr_id (ArrowRanges.ppof @x0)))
 

:pattern ((ArrowRanges.ppof @x0))
:qid constructor_distinct_ArrowRanges.ppof))

:named constructor_distinct_ArrowRanges.ppof))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,5-7,9); use=ArrowRanges.fst(7,5-7,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 149
(Term_constr_id (ArrowRanges.Mkppof @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_ArrowRanges.Mkppof))

:named constructor_distinct_ArrowRanges.Mkppof))
;;;;;;;;;;;;;;;;bool inversion
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
...
@x0
(ArrowRanges.ppof @x2)))
:qid ArrowRanges_pretyping_ab5d6e15d1be913fcb1d94da74751824))

:named ArrowRanges_pretyping_ab5d6e15d1be913fcb1d94da74751824))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,11-8,28); use=ArrowRanges.fst(8,10-8,28)
...
@x1
(Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e @x2)))
:qid ArrowRanges_pre_typing_Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e))

:named ArrowRanges_pre_typing_Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,11-9,24); use=ArrowRanges.fst(9,10-9,24)
...
@x1
(Tm_arrow_a19f9d49348d4e0038f0ded87d87802f @x2)))
:qid ArrowRanges_pre_typing_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))

:named ArrowRanges_pre_typing_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,11-10,53); use=ArrowRanges.fst(10,9-10,53)
...
@x3
@x4)))
:qid ArrowRanges_pre_typing_Tm_arrow_21f882070549433fc8dd2e0d2d56e65d))

:named ArrowRanges_pre_typing_Tm_arrow_21f882070549433fc8dd2e0d2d56e65d))
...
@x2)
@x3))
:qid ArrowRanges_interpretation_Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid ArrowRanges_interpretation_Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e @x1)))
:qid ArrowRanges_interpretation_Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e))

:named ArrowRanges_interpretation_Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e))
...
@x2)
@x3))
:qid ArrowRanges_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid ArrowRanges_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_a19f9d49348d4e0038f0ded87d87802f @x1)))
:qid ArrowRanges_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))

:named ArrowRanges_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_21f882070549433fc8dd2e0d2d56e65d
;;; Fact-ids: Name ArrowRanges.ppof; Namespace ArrowRanges; Name ArrowRanges.Mkppof; Namespace ArrowRanges
(assert (! 
;; def=ArrowRanges.fst(7,11-10,53); use=ArrowRanges.fst(10,9-10,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_21f882070549433fc8dd2e0d2d56e65d @x1
@x2
@x3))
(and 
;; def=ArrowRanges.fst(7,11-10,53); use=ArrowRanges.fst(10,9-10,53)
...
@x4)
@x5))
:qid ArrowRanges_interpretation_Tm_arrow_21f882070549433fc8dd2e0d2d56e65d.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid ArrowRanges_interpretation_Tm_arrow_21f882070549433fc8dd2e0d2d56e65d.2))
))
...
@x2
@x3)))
:qid ArrowRanges_interpretation_Tm_arrow_21f882070549433fc8dd2e0d2d56e65d))

:named ArrowRanges_interpretation_Tm_arrow_21f882070549433fc8dd2e0d2d56e65d))
(push) ;; push{5

; Starting query at ArrowRanges.fst(7,0-11,1)
...
;   Prims.hasEq a /\
;   (forall (a: Type). {:pattern Prims.hasEq (ArrowRanges.ppof a)}
;       Prims.hasEq a ==> Prims.hasEq (ArrowRanges.ppof a)) ==>
;   (forall (tot_p: (_: a -> _: a -> Prims.bool))
;       (gho_p: (_: a -> _: a -> Type0))
;       (ok: (x: a -> y: a -> Prims.squash (gho_p x y ==> tot_p x y))).
;       Prims.hasEq (_: a -> _: a -> Prims.bool) /\ Prims.hasEq (_: a -> _: a -> Type0) /\
;       Prims.hasEq (x: a -> y: a -> Prims.squash (gho_p x y ==> tot_p x y)))


; Context: While encoding a query
; While typechecking the top-level declaration `type ArrowRanges.ppof`
; While typechecking the top-level declaration `[@@expect_failure] type ArrowRanges.ppof`
...
;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(7,0-11,1)
(Valid 
;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(7,0-11,1)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(7,0-11,1)
(Prims.hasEq (ArrowRanges.ppof @x1))
)
)
 

:pattern ((Prims.hasEq (ArrowRanges.ppof @x1)))
:qid @query.1))
)
...
;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(7,0-11,1)
(and 
;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(8,10-8,28)
(or label_1

;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(7,0-11,1)
(Valid 
;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(7,0-11,1)
(Prims.hasEq (Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e @x0))
)
)


;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(9,10-9,24)
(or label_2

;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(7,0-11,1)
(Valid 
;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(7,0-11,1)
(Prims.hasEq (Tm_arrow_a19f9d49348d4e0038f0ded87d87802f @x0))
)
)


;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(10,9-10,53)
(or label_3

;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(7,0-11,1)
(Valid 
;; def=ArrowRanges.fst(7,0-11,1); use=ArrowRanges.fst(7,0-11,1)
(Prims.hasEq (Tm_arrow_21f882070549433fc8dd2e0d2d56e65d @x1
@x2
@x0))
)
)
