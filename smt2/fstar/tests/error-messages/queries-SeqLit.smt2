...
(declare-fun SeqLit.x (Dummy_sort) Term)
...
(declare-fun SeqLit.y (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SeqLit.y; Namespace SeqLit
(assert (! 
;; def=SeqLit.fst(4,4-4,5); use=SeqLit.fst(4,4-4,5)
...
:named typing_SeqLit.y))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SeqLit.x; Namespace SeqLit
(assert (! 
;; def=SeqLit.fst(3,4-3,5); use=SeqLit.fst(3,4-3,5)
(forall ((@u0 Dummy_sort))
 (! (HasType (SeqLit.x @u0)
(FStar.Seq.Base.seq Prims.int))
 

:pattern ((SeqLit.x @u0))
:qid typing_SeqLit.x))

:named typing_SeqLit.x))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
(HasType (FStar.Seq.Base.seq_to_list @x0
@x1)
(Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e @x0
@x1)))
 

:pattern ((FStar.Seq.Base.seq_to_list @x0
@x1))
...
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e))

:named refinement_kinding_Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Seq.Base.empty; Namespace FStar.Seq.Base
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
(Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e @x2
@x3)))
:qid refinement_interpretation_Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e))

:named refinement_interpretation_Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Seq.Base.empty; Namespace FStar.Seq.Base
(assert (! 
;; def=FStar.Seq.Base.fsti(46,26-46,49); use=FStar.Seq.Base.fsti(46,26-46,49)
...
;;;;;;;;;;;;;;;;Lemma: FStar.Seq.Base.lemma_seq_to_list_cons
;;; Fact-ids: Name FStar.Seq.Base.lemma_seq_to_list_cons; Namespace FStar.Seq.Base
...
;; def=FStar.Seq.Base.fsti(88,11-88,55); use=FStar.Seq.Base.fsti(88,11-88,55)
(= (FStar.Seq.Base.seq_to_list @x0
...
@x1
@x2)))
:qid lemma_FStar.Seq.Base.lemma_seq_to_list_cons))
:named lemma_FStar.Seq.Base.lemma_seq_to_list_cons))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e
;;; Fact-ids: Name FStar.Seq.Base.seq_to_list; Namespace FStar.Seq.Base
(assert (! 
;; def=FStar.Seq.Base.fsti(28,42-28,79); use=FStar.Seq.Base.fsti(28,42-28,79)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e @x0
@x1)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e @x0
@x1))))
:qid haseqTm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e))

:named haseqTm_refine_c4e3a92f9bd1d01a07e4fb66c5de2e7e))
...
:qid equation_SeqLit.y))

:named equation_SeqLit.y))
;;;;;;;;;;;;;;;;Equation for SeqLit.x
;;; Fact-ids: Name SeqLit.x; Namespace SeqLit
(assert (! 
;; def=SeqLit.fst(3,4-3,5); use=SeqLit.fst(3,4-3,5)
(forall ((@u0 Dummy_sort))
...
(FStar.Seq.Base.cons Prims.int
(BoxInt 1)
(FStar.Seq.Base.cons Prims.int
(BoxInt 2)
(FStar.Seq.Base.cons Prims.int
(BoxInt 3)
(FStar.Seq.Base.empty Prims.int)))))
...
:qid equation_SeqLit.x))

:named equation_SeqLit.x))
...
; Starting query at SeqLit.fst(6,0-6,45)

(declare-fun label_1 () Bool)

; Encoding query formula : FStar.Seq.Base.seq_to_list SeqLit.x == SeqLit.y
...
;;; Fact-ids: 
(assert (! (not 
;; def=SeqLit.fst(6,15-6,45); use=SeqLit.fst(6,8-6,14)
(or label_1

;; def=SeqLit.fst(6,15-6,45); use=SeqLit.fst(6,8-6,14)
(= (FStar.Seq.Base.seq_to_list Prims.int
(SeqLit.x Dummy_value))
(SeqLit.y Dummy_value))
)
)
:named @query))
