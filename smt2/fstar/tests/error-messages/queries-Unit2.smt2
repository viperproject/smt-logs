...
(declare-fun Unit2.test1 (Term Term) Term)

(declare-fun Unit2.test1@tok () Term)

; </end encoding let test1>


; encoding sigelt val Unit2.vector


; <Start encoding val Unit2.vector>

(declare-fun Unit2.vector (Term Term) Term)
;;;;;;;;;;;;;;;;_: Type -> _: Prims.nat -> Type
(declare-fun Tm_arrow_67c7b2626869cb316f118144000415b9 () Term)
(declare-fun Unit2.vector@tok () Term)

; </end encoding val Unit2.vector>
...
(declare-fun Unit2.test2 (Term Term) Term)

(declare-fun Unit2.test2@tok () Term)
...
; Starting query at Unit2.fst(23,14-23,41)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Type) (_: _). (*  - Could not prove post-condition
; *) Prims.nat == y: Prims.int{y >= 0}
...
;; def=Unit2.fst(23,21-23,41); use=Unit2.fst(23,21-23,41)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Unit2.test3, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Prims.nat
...
(declare-fun Unit2.test3 (Term Term) Term)

(declare-fun Unit2.test3@tok () Term)

; </end encoding let test3>


; encoding sigelt let zat


; <Start encoding let zat>

(declare-fun Unit2.zat () Term)


; </end encoding let zat>


; encoding sigelt let geq


; <Start encoding let geq>

(declare-fun Unit2.geq (Term) Term)
;;;;;;;;;;;;;;;;z: Prims.int -> Type
(declare-fun Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2 () Term)
(declare-fun Unit2.geq@tok () Term)
(declare-fun Tm_refine_4f1d92a9a3f071e1fa3026ba94fce31c (Term) Term)

; </end encoding let geq>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Unit2.zat; Namespace Unit2
(assert (! (HasType Unit2.zat
Tm_type)
:named typing_Unit2.zat))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Unit2.zat; Namespace Unit2
(assert (! (HasType Unit2.zat
Tm_type)
:named function_token_typing_Unit2.zat))
;;;;;;;;;;;;;;;;Equation for Unit2.zat
;;; Fact-ids: Name Unit2.zat; Namespace Unit2
(assert (! (= Unit2.zat
Tm_refine_542f9d4f129664613f2483a6c88bc7c2)
:named equation_Unit2.zat))
(push) ;; push{2

; Starting query at Unit2.fst(29,14-29,33)
...
;; def=Unit2.fst(29,21-29,33); use=Unit2.fst(29,21-29,33)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Unit2.test5, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Prims.nat, equation_Unit2.zat
...
(declare-fun Unit2.test5 (Term Term) Term)

(declare-fun Unit2.test5@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Unit2.vector; Namespace Unit2
(assert (! 
;; def=Unit2.fst(20,12-20,18); use=Unit2.fst(20,12-20,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Prims.nat))
(HasType (Unit2.vector @x0
@x1)
Tm_type))
 

:pattern ((Unit2.vector @x0
@x1))
:qid typing_Unit2.vector))

:named typing_Unit2.vector))
(push) ;; push{3

; Starting query at Unit2.fst(37,14-38,60)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;a: Type0 -> x: Prims.nat -> vector a x
(declare-fun Tm_arrow_25b9d901b06a9a146d94089615c498b8 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_25b9d901b06a9a146d94089615c498b8
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_25b9d901b06a9a146d94089615c498b8
Tm_type)
:named kinding_Tm_arrow_25b9d901b06a9a146d94089615c498b8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Unit2.fst(37,25-37,58); use=Unit2.fst(37,25-37,58)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_25b9d901b06a9a146d94089615c498b8)
...
@x1
Tm_arrow_25b9d901b06a9a146d94089615c498b8))
:qid Unit2_pre_typing_Tm_arrow_25b9d901b06a9a146d94089615c498b8))

:named Unit2_pre_typing_Tm_arrow_25b9d901b06a9a146d94089615c498b8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_25b9d901b06a9a146d94089615c498b8
;;; Fact-ids: 
(assert (! 
;; def=Unit2.fst(37,25-37,58); use=Unit2.fst(37,25-37,58)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Unit2_interpretation_Tm_arrow_25b9d901b06a9a146d94089615c498b8.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Unit2_interpretation_Tm_arrow_25b9d901b06a9a146d94089615c498b8.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_25b9d901b06a9a146d94089615c498b8))
:qid Unit2_interpretation_Tm_arrow_25b9d901b06a9a146d94089615c498b8))

:named Unit2_interpretation_Tm_arrow_25b9d901b06a9a146d94089615c498b8))
;;;;;;;;;;;;;;;;b: Type0 -> y: zat -> vector b y
(declare-fun Tm_arrow_26bdd728112822e85c6731fddab49640 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_26bdd728112822e85c6731fddab49640
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_26bdd728112822e85c6731fddab49640
Tm_type)
:named kinding_Tm_arrow_26bdd728112822e85c6731fddab49640))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Unit2.fst(38,25-38,58); use=Unit2.fst(38,25-38,58)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_26bdd728112822e85c6731fddab49640)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_26bdd728112822e85c6731fddab49640))
:qid Unit2_pre_typing_Tm_arrow_26bdd728112822e85c6731fddab49640))

:named Unit2_pre_typing_Tm_arrow_26bdd728112822e85c6731fddab49640))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_26bdd728112822e85c6731fddab49640
;;; Fact-ids: 
(assert (! 
;; def=Unit2.fst(38,25-38,58); use=Unit2.fst(38,25-38,58)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Unit2_interpretation_Tm_arrow_26bdd728112822e85c6731fddab49640.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Unit2_interpretation_Tm_arrow_26bdd728112822e85c6731fddab49640.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_26bdd728112822e85c6731fddab49640))
:qid Unit2_interpretation_Tm_arrow_26bdd728112822e85c6731fddab49640))

:named Unit2_interpretation_Tm_arrow_26bdd728112822e85c6731fddab49640))

; Encoding query formula : forall (_: Type) (_: _).
;   (*  - Could not prove post-condition
; *)
;   (a: Type0 -> x: Prims.nat -> Unit2.vector a x) == (b: Type0 -> y: Unit2.zat -> Unit2.vector b y)
...
;; def=Unit2.fst(37,21-38,60); use=Unit2.fst(37,21-38,60)
(or label_1
...
(declare-fun Unit2.test7 (Term Term) Term)

(declare-fun Unit2.test7@tok () Term)

; </end encoding let test7>


; encoding sigelt type Unit2.t


; <Start encoding type Unit2.t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Unit2.t (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Unit2.t@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Unit2.Int (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Unit2.Int_i (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Unit2.Int
(declare-fun Unit2.Int@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Unit2.Bool (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Unit2.Bool_b (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Unit2.Bool
(declare-fun Unit2.Bool@tok () Term)
;;;;;;;;;;;;;;;;i: Prims.int -> t Prims.int
(declare-fun Tm_arrow_949e1b14a695d973b44c05d010ef986f () Term)
;;;;;;;;;;;;;;;;b: Prims.bool -> t Prims.bool
(declare-fun Tm_arrow_0a206714caeb746bfd47745cb4fe7529 () Term)

; <start constructor Unit2.t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Unit2.t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
163)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor Unit2.t>


; <start constructor Unit2.Int>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Unit2.Int ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
170)
(= __@x0
(Unit2.Int (Unit2.Int_i __@x0)))))

; </end constructor Unit2.Int>


; <start constructor Unit2.Bool>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Unit2.Bool ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
176)
(= __@x0
(Unit2.Bool (Unit2.Bool_b __@x0)))))

; </end constructor Unit2.Bool>


; </end encoding type Unit2.t>


; encoding sigelt assume Unit2.t__uu___haseq


; <Start encoding assume Unit2.t__uu___haseq>


; </end encoding assume Unit2.t__uu___haseq>


; encoding sigelt val Unit2.uu___is_Int


; <Start encoding val Unit2.uu___is_Int>

(declare-fun Unit2.uu___is_Int (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: t _ -> Prims.bool
(declare-fun Tm_arrow_6041e767ea2df29202c6c1ce636d1aea () Term)
(declare-fun Unit2.uu___is_Int@tok () Term)

; </end encoding val Unit2.uu___is_Int>
...
; encoding sigelt val Unit2.__proj__Int__item__i


; <Start encoding val Unit2.__proj__Int__item__i>

(declare-fun Tm_refine_a80b1732c37b674c773643729bebf97c (Term) Term)
(declare-fun Unit2.__proj__Int__item__i (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t _ {Int? _} -> Prims.int
(declare-fun Tm_arrow_860f8816ecdbb8083e7016003d1322b4 () Term)
(declare-fun Unit2.__proj__Int__item__i@tok () Term)

; </end encoding val Unit2.__proj__Int__item__i>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Unit2.uu___is_Int; Namespace Unit2
(assert (! 
;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,4-49,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Unit2.t @x0)))
(HasType (Unit2.uu___is_Int @x0
@x1)
Prims.bool))
 

:pattern ((Unit2.uu___is_Int @x0
@x1))
:qid typing_Unit2.uu___is_Int))

:named typing_Unit2.uu___is_Int))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(48,5-48,6); use=Unit2.fst(48,5-48,6)
(forall ((@x0 Term))
 (! (= (ApplyTT Unit2.t@tok
@x0)
(Unit2.t @x0))
...
:pattern ((ApplyTT Unit2.t@tok
@x0))

:pattern ((Unit2.t @x0))
:qid token_correspondence_Unit2.t@tok))

:named token_correspondence_Unit2.t@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,4-49,7)
...
(Unit2.Int @x1)
(Unit2.t @x2)))
:qid subterm_ordering_Unit2.Int))

:named subterm_ordering_Unit2.Int))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Unit2.Bool @x1)
(Unit2.t @x2))
...
(Unit2.Bool @x1)
(Unit2.t @x2)))
:qid subterm_ordering_Unit2.Bool))

:named subterm_ordering_Unit2.Bool))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Unit2.__proj__Int__item__i; Namespace Unit2
(assert (! 
;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,4-49,7)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_a80b1732c37b674c773643729bebf97c @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_a80b1732c37b674c773643729bebf97c @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_a80b1732c37b674c773643729bebf97c))

:named refinement_kinding_Tm_refine_a80b1732c37b674c773643729bebf97c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Unit2.__proj__Int__item__i; Namespace Unit2
(assert (! 
;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,4-49,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a80b1732c37b674c773643729bebf97c @x2))
(and (HasTypeFuel @u0
@x1
(Unit2.t @x2))

;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,4-49,7)
(BoxBool_proj_0 (Unit2.uu___is_Int @x2
@x1))
))
...
@x1
(Tm_refine_a80b1732c37b674c773643729bebf97c @x2)))
:qid refinement_interpretation_Tm_refine_a80b1732c37b674c773643729bebf97c))

:named refinement_interpretation_Tm_refine_a80b1732c37b674c773643729bebf97c))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,4-49,7)
(forall ((@x0 Term))
 (! (= (Unit2.Int_i (Unit2.Int @x0))
@x0)
 

:pattern ((Unit2.Int @x0))
:qid projection_inverse_Unit2.Int_i))

:named projection_inverse_Unit2.Int_i))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
(forall ((@x0 Term))
 (! (= (Unit2.Bool_b (Unit2.Bool @x0))
@x0)
 

:pattern ((Unit2.Bool @x0))
:qid projection_inverse_Unit2.Bool_b))

:named projection_inverse_Unit2.Bool_b))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! (is-Tm_arrow (PreType Unit2.t@tok))
:named pre_kinding_Unit2.t@tok))
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! (and (IsTotFun Unit2.t@tok)
...
:pattern ((Unit2.t @x0))
:qid kinding_Unit2.t@tok))
)
:named kinding_Unit2.t@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a80b1732c37b674c773643729bebf97c
;;; Fact-ids: Name Unit2.__proj__Int__item__i; Namespace Unit2
(assert (! 
;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,4-49,7)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a80b1732c37b674c773643729bebf97c @x0)))
(Valid (Prims.hasEq (Unit2.t @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a80b1732c37b674c773643729bebf97c @x0))))
:qid haseqTm_refine_a80b1732c37b674c773643729bebf97c))

:named haseqTm_refine_a80b1732c37b674c773643729bebf97c))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (HasType Prims.bool
Prims.eqtype)
...
@x1
(Unit2.t @x2))
(or (and (is-Unit2.Int @x1)
(= @x2
Prims.int))
(and (is-Unit2.Bool @x1)
(= @x2
Prims.bool))))
...
@x1
(Unit2.t @x2)))
:qid fuel_guarded_inversion_Unit2.t))

:named fuel_guarded_inversion_Unit2.t))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! (= 164
(Term_constr_id Unit2.t@tok))
:named fresh_token_Unit2.t@tok))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Unit2.uu___is_Int; Namespace Unit2
(assert (! 
;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,4-49,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Unit2.uu___is_Int @x0
@x1)
(BoxBool (is-Unit2.Int @x1)))
 

:pattern ((Unit2.uu___is_Int @x0
@x1))
:qid disc_equation_Unit2.Int))

:named disc_equation_Unit2.Int))
...
(Unit2.Int @x1)
(Unit2.t @x2)))
:qid data_typing_intro_Unit2.Int@tok))

:named data_typing_intro_Unit2.Int@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
...
(Unit2.Bool @x1)
(Unit2.t @x2)))
:qid data_typing_intro_Unit2.Bool@tok))

:named data_typing_intro_Unit2.Bool@tok))
...
(Unit2.Int @x1)
(Unit2.t @x2)))
:qid data_elim_Unit2.Int))

:named data_elim_Unit2.Int))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
...
(Unit2.Bool @x1)
(Unit2.t @x2)))
:qid data_elim_Unit2.Bool))

:named data_elim_Unit2.Bool))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(48,5-48,6); use=Unit2.fst(48,5-48,6)
(forall ((@x0 Term))
 (! (= 163
(Term_constr_id (Unit2.t @x0)))
 

:pattern ((Unit2.t @x0))
:qid constructor_distinct_Unit2.t))

:named constructor_distinct_Unit2.t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,4-49,7)
(forall ((@x0 Term))
 (! (= 170
(Term_constr_id (Unit2.Int @x0)))
 

:pattern ((Unit2.Int @x0))
:qid constructor_distinct_Unit2.Int))

:named constructor_distinct_Unit2.Int))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
(forall ((@x0 Term))
 (! (= 176
(Term_constr_id (Unit2.Bool @x0)))
 

:pattern ((Unit2.Bool @x0))
:qid constructor_distinct_Unit2.Bool))

:named constructor_distinct_Unit2.Bool))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (= 107
...
;;;;;;;;;;;;;;;;Assumption: Unit2.t__uu___haseq
;;; Fact-ids: Name Unit2.t__uu___haseq; Namespace Unit2
...
:pattern ((Prims.hasEq (Unit2.t @x0)))
:qid assumption_Unit2.t__uu___haseq))
:named assumption_Unit2.t__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Unit2.t; Namespace Unit2; Name Unit2.Int; Namespace Unit2; Name Unit2.Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(48,5-48,6); use=Unit2.fst(48,5-48,6)
...
@x0
(Unit2.t @x2)))
:qid Unit2_pretyping_caa9db4eb6695d1cc14cf67b01a7c3f8))

:named Unit2_pretyping_caa9db4eb6695d1cc14cf67b01a7c3f8))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! 
...
; Starting query at Unit2.fst(49,10-49,11)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Type) (projectee: _: Unit2.t _ {Int? _}).
;   (*  - Could not prove post-condition
; *) ~(Int? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Int__item__i`
...
Tm_type)
(HasType @x1
(Tm_refine_a80b1732c37b674c773643729bebf97c @x0))

;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,10-49,11)
(not 
;; def=Unit2.fst(49,4-49,7); use=Unit2.fst(49,10-49,11)
(BoxBool_proj_0 (Unit2.uu___is_Int @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Unit2.__proj__Int__item__i, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_a80b1732c37b674c773643729bebf97c
...
; encoding sigelt let __proj__Int__item__i


; <Skipped let __proj__Int__item__i/>


; encoding sigelt val Unit2.uu___is_Bool


; <Start encoding val Unit2.uu___is_Bool>

(declare-fun Unit2.uu___is_Bool (Term Term) Term)

(declare-fun Unit2.uu___is_Bool@tok () Term)

; </end encoding val Unit2.uu___is_Bool>
...
; encoding sigelt val Unit2.__proj__Bool__item__b


; <Start encoding val Unit2.__proj__Bool__item__b>

(declare-fun Tm_refine_51f253259fbb75b1f44c4d01d8397ea7 (Term) Term)
(declare-fun Unit2.__proj__Bool__item__b (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t _ {Bool? _} -> Prims.bool
(declare-fun Tm_arrow_f21cf7233cf49ee5fc070ae8fa331891 () Term)
(declare-fun Unit2.__proj__Bool__item__b@tok () Term)

; </end encoding val Unit2.__proj__Bool__item__b>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Unit2.uu___is_Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Unit2.t @x0)))
(HasType (Unit2.uu___is_Bool @x0
@x1)
Prims.bool))
 

:pattern ((Unit2.uu___is_Bool @x0
@x1))
:qid typing_Unit2.uu___is_Bool))

:named typing_Unit2.uu___is_Bool))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Unit2.__proj__Bool__item__b; Namespace Unit2
(assert (! 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_51f253259fbb75b1f44c4d01d8397ea7 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_51f253259fbb75b1f44c4d01d8397ea7 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_51f253259fbb75b1f44c4d01d8397ea7))

:named refinement_kinding_Tm_refine_51f253259fbb75b1f44c4d01d8397ea7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Unit2.__proj__Bool__item__b; Namespace Unit2
(assert (! 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_51f253259fbb75b1f44c4d01d8397ea7 @x2))
(and (HasTypeFuel @u0
@x1
(Unit2.t @x2))

;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
(BoxBool_proj_0 (Unit2.uu___is_Bool @x2
@x1))
))
...
@x1
(Tm_refine_51f253259fbb75b1f44c4d01d8397ea7 @x2)))
:qid refinement_interpretation_Tm_refine_51f253259fbb75b1f44c4d01d8397ea7))

:named refinement_interpretation_Tm_refine_51f253259fbb75b1f44c4d01d8397ea7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_51f253259fbb75b1f44c4d01d8397ea7
;;; Fact-ids: Name Unit2.__proj__Bool__item__b; Namespace Unit2
(assert (! 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_51f253259fbb75b1f44c4d01d8397ea7 @x0)))
(Valid (Prims.hasEq (Unit2.t @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_51f253259fbb75b1f44c4d01d8397ea7 @x0))))
:qid haseqTm_refine_51f253259fbb75b1f44c4d01d8397ea7))

:named haseqTm_refine_51f253259fbb75b1f44c4d01d8397ea7))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Unit2.uu___is_Bool; Namespace Unit2
(assert (! 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,4-50,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Unit2.uu___is_Bool @x0
@x1)
(BoxBool (is-Unit2.Bool @x1)))
 

:pattern ((Unit2.uu___is_Bool @x0
@x1))
:qid disc_equation_Unit2.Bool))

:named disc_equation_Unit2.Bool))
(push) ;; push{2

; Starting query at Unit2.fst(50,11-50,12)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Type) (projectee: _: Unit2.t _ {Bool? _}).
;   (*  - Could not prove post-condition
; *) ~(Bool? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Bool__item__b`
...
Tm_type)
(HasType @x1
(Tm_refine_51f253259fbb75b1f44c4d01d8397ea7 @x0))

;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,11-50,12)
(not 
;; def=Unit2.fst(50,4-50,8); use=Unit2.fst(50,11-50,12)
(BoxBool_proj_0 (Unit2.uu___is_Bool @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Unit2.__proj__Bool__item__b, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_51f253259fbb75b1f44c4d01d8397ea7
...
; encoding sigelt let __proj__Bool__item__b


; <Skipped let __proj__Bool__item__b/>
...
; Starting query at Unit2.fst(53,2-55,19)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (x: Unit2.t a).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post a).
;     (forall (x: a). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     (~(Int? x) /\ ~(Bool? x) ==> Prims.l_False) /\
;     (forall (b: Prims.int). x == Unit2.Int b ==> Prims.has_type (b + 1) a) /\
;     (~(Int? x) ==>
;       (forall (b: Prims.bool). x == Unit2.Bool b ==> Prims.has_type (Prims.op_Negation b) a))
...
;; def=Prims.fst(402,27-402,88); use=Unit2.fst(53,2-55,19)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Unit2.fst(53,2-55,19)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Unit2.fst(53,2-55,19)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(459,77-459,89); use=Unit2.fst(53,2-55,19)
(and (implies 
;; def=Unit2.fst(52,16-52,17); use=Unit2.fst(53,8-53,9)
(and 
;; def=Unit2.fst(52,16-52,17); use=Unit2.fst(53,8-53,9)
(not 
;; def=Unit2.fst(52,16-52,17); use=Unit2.fst(53,8-53,9)
...
;; def=Prims.fst(413,99-413,120); use=Unit2.fst(53,2-55,19)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.int)

;; def=Unit2.fst(52,16-54,9); use=Unit2.fst(53,8-54,9)
(= @x1
(Unit2.Int @x3))
)

;; def=Unit2.fst(54,13-54,18); use=Unit2.fst(54,13-54,18)
(or label_2
(HasType (Prims.op_Addition @x3
(BoxInt 1))
@x0))
)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Unit2.fst(53,2-55,19)
(not 
;; def=Unit2.fst(52,16-52,17); use=Unit2.fst(53,8-53,9)
(BoxBool_proj_0 (Unit2.uu___is_Int @x0
@x1))
...
;; def=Unit2.fst(52,16-55,10); use=Unit2.fst(53,8-55,10)
(= @x1
(Unit2.Bool @x3))
)

;; def=Unit2.fst(55,14-55,19); use=Unit2.fst(55,14-55,19)
(or label_3
(HasType (Prims.op_Negation @x3)
@x0))
)
...
; QUERY ID: (Unit2.f, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, bool_typing, data_elim_Unit2.Bool, data_elim_Unit2.Int, disc_equation_Unit2.Bool, disc_equation_Unit2.Int, fuel_guarded_inversion_Unit2.t, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_Negation, projection_inverse_BoxBool_proj_0
