...
(declare-fun QuickTestNBE.va_qattr (Dummy_sort) Term)

; </end encoding let va_qattr>


; encoding sigelt type QuickTestNBE.vale_state


; <Start encoding type QuickTestNBE.vale_state>

;;;;;;;;;;;;;;;;Constructor
(declare-fun QuickTestNBE.vale_state () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun QuickTestNBE.Mkvale_state (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.Mkvale_state_vs_ok (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: QuickTestNBE.Mkvale_state
(declare-fun QuickTestNBE.Mkvale_state@tok () Term)
;;;;;;;;;;;;;;;;vs_ok: Prims.bool -> vale_state
(declare-fun Tm_arrow_b01608b2533d041426cc76fd6d88bc95 () Term)

; <start constructor QuickTestNBE.vale_state>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-QuickTestNBE.vale_state ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(= __@x0
QuickTestNBE.vale_state)))

; </end constructor QuickTestNBE.vale_state>


; <start constructor QuickTestNBE.Mkvale_state>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-QuickTestNBE.Mkvale_state ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
110)
(= __@x0
(QuickTestNBE.Mkvale_state (QuickTestNBE.Mkvale_state_vs_ok __@x0)))))

; </end constructor QuickTestNBE.Mkvale_state>


; </end encoding type QuickTestNBE.vale_state>


; encoding sigelt val QuickTestNBE.__proj__Mkvale_state__item__vs_ok


; <Start encoding val QuickTestNBE.__proj__Mkvale_state__item__vs_ok>

(declare-fun QuickTestNBE.__proj__Mkvale_state__item__vs_ok (Term) Term)
;;;;;;;;;;;;;;;;projectee: vale_state -> Prims.bool
(declare-fun Tm_arrow_d9ca7e0caeedadd987d29092133d74c5 () Term)
(declare-fun QuickTestNBE.__proj__Mkvale_state__item__vs_ok@tok () Term)

; </end encoding val QuickTestNBE.__proj__Mkvale_state__item__vs_ok>
...
(declare-fun QuickTestNBE.quickProc_wp (Term) Term)

(declare-fun QuickTestNBE.quickProc_wp@tok () Term)
;;;;;;;;;;;;;;;;wp_continue: vale_state -> _: a -> Type
(declare-fun Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 (Term) Term)
;;;;;;;;;;;;;;;;s0: vale_state -> _: (wp_continue: vale_state -> _: a -> Type) -> Type
(declare-fun Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07 (Term) Term)
...
(declare-fun QuickTestNBE.t_ensure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;wp: quickProc_wp a -> s0: vale_state -> k: (_: vale_state -> _: a -> Type) -> _: vale_state & a   -> Type
(declare-fun Tm_arrow_3ac52fb8cb6c51792ae48357ede4cd13 () Term)
(declare-fun QuickTestNBE.t_ensure@tok () Term)
...
(declare-fun QuickTestNBE.t_proof (Term Term) Term)
;;;;;;;;;;;;;;;;wp: quickProc_wp a -> Type
(declare-fun Tm_arrow_0cde9567066eea8b7abec666c540605d () Term)
(declare-fun QuickTestNBE.t_proof@tok () Term)

(declare-fun Tm_refine_95f34d0b7a823205abc04e9d6b1ab0d8 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s0: vale_state -> k: (_: vale_state -> _: a -> Type) -> Prims.Ghost (vale_state & a)
(declare-fun Tm_ghost_arrow_cf88e9e661988a20758b664bfa72ee71 (Term Term) Term)

; </end encoding let t_proof>


; encoding sigelt type QuickTestNBE.quickCode


; <Start encoding type QuickTestNBE.quickCode>

;;;;;;;;;;;;;;;;Constructor
(declare-fun QuickTestNBE.quickCode (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun QuickTestNBE.quickCode@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun QuickTestNBE.QProc (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QProc_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QProc_wp (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QProc_proof (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: QuickTestNBE.QProc
(declare-fun QuickTestNBE.QProc@tok () Term)
;;;;;;;;;;;;;;;;wp: quickProc_wp a -> proof: t_proof wp -> quickCode a
(declare-fun Tm_arrow_225d609e2e1000062de9b2452b6bcaa3 () Term)

; <start constructor QuickTestNBE.quickCode>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-QuickTestNBE.quickCode ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
137)
(exists ((@x0 Term))
 (! (= __@x0
(QuickTestNBE.quickCode @x0))
 
;;no pats
:qid is-QuickTestNBE.quickCode))))

; </end constructor QuickTestNBE.quickCode>


; <start constructor QuickTestNBE.QProc>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-QuickTestNBE.QProc ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
144)
(= __@x0
(QuickTestNBE.QProc (QuickTestNBE.QProc_a __@x0)
(QuickTestNBE.QProc_wp __@x0)
(QuickTestNBE.QProc_proof __@x0)))))

; </end constructor QuickTestNBE.QProc>


; </end encoding type QuickTestNBE.quickCode>


; encoding sigelt val QuickTestNBE.uu___is_QProc


; <Start encoding val QuickTestNBE.uu___is_QProc>

(declare-fun QuickTestNBE.uu___is_QProc (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: quickCode a -> Prims.bool
(declare-fun Tm_arrow_fe786e26848d418ead8c327101ae0b8d () Term)
(declare-fun QuickTestNBE.uu___is_QProc@tok () Term)

; </end encoding val QuickTestNBE.uu___is_QProc>
...
; encoding sigelt val QuickTestNBE.__proj__QProc__item__wp


; <Start encoding val QuickTestNBE.__proj__QProc__item__wp>

(declare-fun QuickTestNBE.__proj__QProc__item__wp (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: quickCode a -> quickProc_wp a
(declare-fun Tm_arrow_11e598d057a1d763a5e60d0c8d898402 () Term)
(declare-fun QuickTestNBE.__proj__QProc__item__wp@tok () Term)

; </end encoding val QuickTestNBE.__proj__QProc__item__wp>
...
; encoding sigelt val QuickTestNBE.__proj__QProc__item__proof


; <Start encoding val QuickTestNBE.__proj__QProc__item__proof>

(declare-fun QuickTestNBE.__proj__QProc__item__proof (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: quickCode a -> t_proof projectee.wp
(declare-fun Tm_arrow_8fe884799c45443dc9dafef9a5990df6 () Term)
(declare-fun QuickTestNBE.__proj__QProc__item__proof@tok () Term)

; </end encoding val QuickTestNBE.__proj__QProc__item__proof>
...
(declare-fun QuickTestNBE.labeled_wrap (Term Term Term) Term)

(declare-fun QuickTestNBE.labeled_wrap@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickTestNBE.labeled_wrap; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(28,4-28,16); use=QuickTestNBE.fst(28,4-28,16)
...
(HasType @x2
Tm_type))
(HasType (QuickTestNBE.labeled_wrap @x0
@x1
@x2)
Tm_type))
 

:pattern ((QuickTestNBE.labeled_wrap @x0
@x1
@x2))
:qid typing_QuickTestNBE.labeled_wrap))

:named typing_QuickTestNBE.labeled_wrap))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
; Starting query at QuickTestNBE.fst(32,2-33,22)
...
;         (QuickTestNBE.labeled_wrap r msg p <==> p) ==>
;         (forall (any_result: Type0).
;             any_result == QuickTestNBE.labeled_wrap r msg p ==>
...
;; def=Prims.fst(441,36-441,97); use=QuickTestNBE.fst(32,2-33,22)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Tm_type))

;; def=QuickTestNBE.fst(31,90-31,98); use=QuickTestNBE.fst(32,2-33,22)
(or label_2
...
;; def=QuickTestNBE.fst(31,34-31,35); use=QuickTestNBE.fst(31,97-31,98)
(Valid 
;; def=QuickTestNBE.fst(31,34-31,35); use=QuickTestNBE.fst(31,97-31,98)
@x2
)
...
;; def=Prims.fst(441,83-441,96); use=QuickTestNBE.fst(32,2-33,22)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickTestNBE.fst(32,2-33,22)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,29-441,97); use=QuickTestNBE.fst(32,2-32,13)
(and (implies 
;; def=QuickTestNBE.fst(31,34-31,35); use=QuickTestNBE.fst(32,34-32,35)
(Valid 
;; def=QuickTestNBE.fst(31,34-31,35); use=QuickTestNBE.fst(32,34-32,35)
@x2
)
...
;; def=QuickTestNBE.fst(31,34-31,35); use=QuickTestNBE.fst(32,41-32,42)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=QuickTestNBE.fst(32,2-32,13)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=QuickTestNBE.fst(32,14-32,43); use=QuickTestNBE.fst(32,2-32,13)
(iff 
;; def=QuickTestNBE.fst(32,15-32,35); use=QuickTestNBE.fst(32,2-32,13)
(Valid 
;; def=QuickTestNBE.fst(32,15-32,35); use=QuickTestNBE.fst(32,2-32,13)
(QuickTestNBE.labeled_wrap @x0
@x1
@x2)
)
...
;; def=Prims.fst(451,66-451,102); use=QuickTestNBE.fst(32,2-33,22)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Tm_type)

;; def=QuickTestNBE.fst(31,51-33,22); use=QuickTestNBE.fst(32,2-33,22)
(= @x5
(QuickTestNBE.labeled_wrap @x0
@x1
@x2))
...
(declare-fun QuickTestNBE.label (Term Term Term) Term)
...
(declare-fun QuickTestNBE.label@tok () Term)


; </end encoding let label>


; encoding sigelt type QuickTestNBE.quickCodes


; <Start encoding type QuickTestNBE.quickCodes>

;;;;;;;;;;;;;;;;Constructor
(declare-fun QuickTestNBE.quickCodes (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun QuickTestNBE.quickCodes@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun QuickTestNBE.QEmpty (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QEmpty_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QEmpty__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: QuickTestNBE.QEmpty
(declare-fun QuickTestNBE.QEmpty@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun QuickTestNBE.QPURE (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QPURE_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QPURE_r (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QPURE_msg (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QPURE_pre (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QPURE__3 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun QuickTestNBE.QPURE__4 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: QuickTestNBE.QPURE
(declare-fun QuickTestNBE.QPURE@tok () Term)
;;;;;;;;;;;;;;;;_0: a -> quickCodes a
(declare-fun Tm_arrow_bb95b4a25f1d68feaa57f7a5f86bf3b2 () Term)
...
(declare-fun Tm_arrow_f74dfffa5719ef68cf91071af0ee636e () Term)

; <start constructor QuickTestNBE.quickCodes>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-QuickTestNBE.quickCodes ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
160)
(exists ((@x0 Term))
 (! (= __@x0
(QuickTestNBE.quickCodes @x0))
 
;;no pats
:qid is-QuickTestNBE.quickCodes))))

; </end constructor QuickTestNBE.quickCodes>


; <start constructor QuickTestNBE.QEmpty>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-QuickTestNBE.QEmpty ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
167)
(= __@x0
(QuickTestNBE.QEmpty (QuickTestNBE.QEmpty_a __@x0)
(QuickTestNBE.QEmpty__0 __@x0)))))

; </end constructor QuickTestNBE.QEmpty>


; <start constructor QuickTestNBE.QPURE>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-QuickTestNBE.QPURE ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
183)
(= __@x0
(QuickTestNBE.QPURE (QuickTestNBE.QPURE_a __@x0)
(QuickTestNBE.QPURE_r __@x0)
(QuickTestNBE.QPURE_msg __@x0)
(QuickTestNBE.QPURE_pre __@x0)
(QuickTestNBE.QPURE__3 __@x0)
(QuickTestNBE.QPURE__4 __@x0)))))

; </end constructor QuickTestNBE.QPURE>


; </end encoding type QuickTestNBE.quickCodes>


; encoding sigelt val QuickTestNBE.uu___is_QEmpty


; <Start encoding val QuickTestNBE.uu___is_QEmpty>

(declare-fun QuickTestNBE.uu___is_QEmpty (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: quickCodes a -> Prims.bool
(declare-fun Tm_arrow_347abedff35ba84f9a105c229f3a0197 () Term)
(declare-fun QuickTestNBE.uu___is_QEmpty@tok () Term)

; </end encoding val QuickTestNBE.uu___is_QEmpty>
...
; encoding sigelt val QuickTestNBE.__proj__QEmpty__item___0


; <Start encoding val QuickTestNBE.__proj__QEmpty__item___0>

(declare-fun Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2 (Term) Term)
(declare-fun QuickTestNBE.__proj__QEmpty__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: quickCodes a {QEmpty? _} -> a
(declare-fun Tm_arrow_c4268802e51cca7535b7a921c22982e7 () Term)
(declare-fun QuickTestNBE.__proj__QEmpty__item___0@tok () Term)

; </end encoding val QuickTestNBE.__proj__QEmpty__item___0>

;;;;;;;;;;;;;;;;typing_Tm_abs_89447cd1aa9afa7f1f584aea7ee0d61a
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=Prims.fst(635,86-635,95); use=QuickTestNBE.fst(38,18-38,22)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickTestNBE.uu___is_QEmpty; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(QuickTestNBE.quickCodes @x0)))
(HasType (QuickTestNBE.uu___is_QEmpty @x0
@x1)
Prims.bool))
 

:pattern ((QuickTestNBE.uu___is_QEmpty @x0
@x1))
:qid typing_QuickTestNBE.uu___is_QEmpty))

:named typing_QuickTestNBE.uu___is_QEmpty))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(35,10-35,20); use=QuickTestNBE.fst(35,10-35,20)
(forall ((@x0 Term))
 (! (= (ApplyTT QuickTestNBE.quickCodes@tok
@x0)
(QuickTestNBE.quickCodes @x0))
 

:pattern ((ApplyTT QuickTestNBE.quickCodes@tok
@x0))

:pattern ((QuickTestNBE.quickCodes @x0))
:qid token_correspondence_QuickTestNBE.quickCodes@tok))

:named token_correspondence_QuickTestNBE.quickCodes@tok))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(QuickTestNBE.QPURE @x1
@x2
@x3
@x4
@x5
@x6)
(QuickTestNBE.quickCodes @x7))
...
@x6)
(QuickTestNBE.quickCodes @x7)))
:qid subterm_ordering_QuickTestNBE.QPURE))

:named subterm_ordering_QuickTestNBE.QPURE))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(QuickTestNBE.QEmpty @x1
@x2)
(QuickTestNBE.quickCodes @x3))
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(QuickTestNBE.QEmpty @x1
...
@x2)
(QuickTestNBE.quickCodes @x3)))
:qid subterm_ordering_QuickTestNBE.QEmpty))

:named subterm_ordering_QuickTestNBE.QEmpty))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(38,18-38,22); use=QuickTestNBE.fst(38,18-38,22)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name QuickTestNBE.__proj__QEmpty__item___0; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2))

:named refinement_kinding_Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(38,18-38,22); use=QuickTestNBE.fst(38,18-38,22)
...
;; def=Prims.fst(635,71-635,97); use=QuickTestNBE.fst(38,18-38,22)
(not 
;; def=Prims.fst(635,72-635,97); use=QuickTestNBE.fst(38,18-38,22)
(Valid 
;; def=Prims.fst(635,72-635,97); use=QuickTestNBE.fst(38,18-38,22)
(ApplyTT @x2
...
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=Prims.fst(315,31-315,40); use=QuickTestNBE.fst(38,18-38,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2 @x2))
(and (HasTypeFuel @u0
@x1
(QuickTestNBE.quickCodes @x2))

;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(BoxBool_proj_0 (QuickTestNBE.uu___is_QEmpty @x2
@x1))
))
...
@x1
(Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2 @x2)))
:qid refinement_interpretation_Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2))

:named refinement_interpretation_Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (QuickTestNBE.QPURE_r (QuickTestNBE.QPURE @x0
@x1
@x2
@x3
@x4
...
:pattern ((QuickTestNBE.QPURE @x0
@x1
@x2
@x3
@x4
@x5))
:qid projection_inverse_QuickTestNBE.QPURE_r))

:named projection_inverse_QuickTestNBE.QPURE_r))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (QuickTestNBE.QPURE_pre (QuickTestNBE.QPURE @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_QuickTestNBE.QPURE_pre))

:named projection_inverse_QuickTestNBE.QPURE_pre))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (QuickTestNBE.QPURE_msg (QuickTestNBE.QPURE @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_QuickTestNBE.QPURE_msg))

:named projection_inverse_QuickTestNBE.QPURE_msg))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (QuickTestNBE.QPURE_a (QuickTestNBE.QPURE @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_QuickTestNBE.QPURE_a))

:named projection_inverse_QuickTestNBE.QPURE_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (QuickTestNBE.QPURE__4 (QuickTestNBE.QPURE @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_QuickTestNBE.QPURE__4))

:named projection_inverse_QuickTestNBE.QPURE__4))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (QuickTestNBE.QPURE__3 (QuickTestNBE.QPURE @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_QuickTestNBE.QPURE__3))

:named projection_inverse_QuickTestNBE.QPURE__3))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (QuickTestNBE.QEmpty_a (QuickTestNBE.QEmpty @x0
@x1))
@x0)
 

:pattern ((QuickTestNBE.QEmpty @x0
@x1))
:qid projection_inverse_QuickTestNBE.QEmpty_a))

:named projection_inverse_QuickTestNBE.QEmpty_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (QuickTestNBE.QEmpty__0 (QuickTestNBE.QEmpty @x0
@x1))
@x1)
...
:pattern ((QuickTestNBE.QEmpty @x0
@x1))
:qid projection_inverse_QuickTestNBE.QEmpty__0))

:named projection_inverse_QuickTestNBE.QEmpty__0))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! (is-Tm_arrow (PreType QuickTestNBE.quickCodes@tok))
:named pre_kinding_QuickTestNBE.quickCodes@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
...
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(38,5-38,22); use=QuickTestNBE.fst(38,5-38,22)
(forall ((@x0 Term))
...
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! (and (IsTotFun QuickTestNBE.quickCodes@tok)

;; def=QuickTestNBE.fst(35,10-35,20); use=QuickTestNBE.fst(35,10-35,20)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (QuickTestNBE.quickCodes @x0)
Tm_type))
 

:pattern ((QuickTestNBE.quickCodes @x0))
:qid kinding_QuickTestNBE.quickCodes@tok))
)
:named kinding_QuickTestNBE.quickCodes@tok))
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
...
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=Prims.fst(630,69-630,73); use=QuickTestNBE.fst(38,18-38,22)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2
;;; Fact-ids: Name QuickTestNBE.__proj__QEmpty__item___0; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2 @x0)))
(Valid (Prims.hasEq (QuickTestNBE.quickCodes @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2 @x0))))
:qid haseqTm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2))

:named haseqTm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.pure_pre; Namespace Prims
(assert (! (HasType Prims.pure_pre
Tm_type)
...
@x1
(QuickTestNBE.quickCodes @x2))
(or (and (is-QuickTestNBE.QEmpty @x1)
(= @x2
(QuickTestNBE.QEmpty_a @x1)))
(and (is-QuickTestNBE.QPURE @x1)
(= @x2
(QuickTestNBE.QPURE_a @x1)))))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
(QuickTestNBE.quickCodes @x2)))
:qid fuel_guarded_inversion_QuickTestNBE.quickCodes))

:named fuel_guarded_inversion_QuickTestNBE.quickCodes))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
(assert (! 
;; def=Prims.fst(165,5-165,11); use=Prims.fst(165,5-165,11)
...
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! (= 161
(Term_constr_id QuickTestNBE.quickCodes@tok))
:named fresh_token_QuickTestNBE.quickCodes@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
(assert (! (= 135
...
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (QuickTestNBE.uu___is_QEmpty @x0
@x1)
(BoxBool (is-QuickTestNBE.QEmpty @x1)))
 

:pattern ((QuickTestNBE.uu___is_QEmpty @x0
@x1))
:qid disc_equation_QuickTestNBE.QEmpty))

:named disc_equation_QuickTestNBE.QEmpty))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
...
@x6)
(QuickTestNBE.quickCodes @x1)))
:qid data_typing_intro_QuickTestNBE.QPURE@tok))

:named data_typing_intro_QuickTestNBE.QPURE@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
...
@x2)
(QuickTestNBE.quickCodes @x1)))
:qid data_typing_intro_QuickTestNBE.QEmpty@tok))

:named data_typing_intro_QuickTestNBE.QEmpty@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
(assert (! 
...
@x6)
(QuickTestNBE.quickCodes @x7)))
:qid data_elim_QuickTestNBE.QPURE))

:named data_elim_QuickTestNBE.QPURE))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
...
@x2)
(QuickTestNBE.quickCodes @x3)))
:qid data_elim_QuickTestNBE.QEmpty))

:named data_elim_QuickTestNBE.QEmpty))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
(assert (! 
;; def=Prims.fst(165,46-165,50); use=Prims.fst(165,46-165,50)
...
(forall ((@x0 Term))
 (! (= 160
(Term_constr_id (QuickTestNBE.quickCodes @x0)))
 

:pattern ((QuickTestNBE.quickCodes @x0))
:qid constructor_distinct_QuickTestNBE.quickCodes))

:named constructor_distinct_QuickTestNBE.quickCodes))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= 183
(Term_constr_id (QuickTestNBE.QPURE @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid constructor_distinct_QuickTestNBE.QPURE))

:named constructor_distinct_QuickTestNBE.QPURE))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 167
(Term_constr_id (QuickTestNBE.QEmpty @x0
@x1)))
 

:pattern ((QuickTestNBE.QEmpty @x0
@x1))
:qid constructor_distinct_QuickTestNBE.QEmpty))

:named constructor_distinct_QuickTestNBE.QEmpty))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
(assert (! 
;; def=Prims.fst(165,5-165,11); use=Prims.fst(165,5-165,11)
...
@x0
(QuickTestNBE.quickCodes @x2)))
:qid QuickTestNBE_pretyping_d1bbce577dcd6a34d49941db975bcfb7))

:named QuickTestNBE_pretyping_d1bbce577dcd6a34d49941db975bcfb7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(38,5-38,22); use=QuickTestNBE.fst(38,5-38,22)
...
@x1
(Tm_arrow_582bbc689b5fa61706dbd693625a682b @x2)))
:qid QuickTestNBE_pre_typing_Tm_arrow_582bbc689b5fa61706dbd693625a682b))

:named QuickTestNBE_pre_typing_Tm_arrow_582bbc689b5fa61706dbd693625a682b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name QuickTestNBE.quickCodes; Namespace QuickTestNBE; Name QuickTestNBE.QEmpty; Namespace QuickTestNBE; Name QuickTestNBE.QPURE; Namespace QuickTestNBE
(assert (! 
;; def=Prims.fst(315,31-315,54); use=QuickTestNBE.fst(38,18-38,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3b69f71421c5687fd98671b03c995f9a)
...
@x1
Tm_arrow_3b69f71421c5687fd98671b03c995f9a))
:qid QuickTestNBE_pre_typing_Tm_arrow_3b69f71421c5687fd98671b03c995f9a))

:named QuickTestNBE_pre_typing_Tm_arrow_3b69f71421c5687fd98671b03c995f9a))
...
(forall ((@x2 Term))
 (! (implies (and 
;; def=Prims.fst(630,56-630,74); use=QuickTestNBE.fst(38,18-38,22)
(Valid 
;; def=Prims.fst(630,56-630,74); use=QuickTestNBE.fst(38,18-38,22)
(ApplyTT @x1
...
:pattern ((ApplyTT @x0
@x2))
:qid QuickTestNBE_interpretation_Tm_arrow_582bbc689b5fa61706dbd693625a682b.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_582bbc689b5fa61706dbd693625a682b @x1)))
:qid QuickTestNBE_interpretation_Tm_arrow_582bbc689b5fa61706dbd693625a682b))

:named QuickTestNBE_interpretation_Tm_arrow_582bbc689b5fa61706dbd693625a682b))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickTestNBE_interpretation_Tm_arrow_3b69f71421c5687fd98671b03c995f9a.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_3b69f71421c5687fd98671b03c995f9a))
:qid QuickTestNBE_interpretation_Tm_arrow_3b69f71421c5687fd98671b03c995f9a))

:named QuickTestNBE_interpretation_Tm_arrow_3b69f71421c5687fd98671b03c995f9a))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! 
...
; Encoding query formula : forall (a: Type) (projectee: _: QuickTestNBE.quickCodes a {QEmpty? _}).
;   (*  - Could not prove post-condition
...
Tm_type)
(HasType @x1
(Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2 @x0))

;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(not 
;; def=QuickTestNBE.fst(36,2-36,8); use=QuickTestNBE.fst(36,2-36,8)
(BoxBool_proj_0 (QuickTestNBE.uu___is_QEmpty @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.__proj__QEmpty__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_094f3af0eb1394cef01fbb0cf7a0b6a2
...
; encoding sigelt val QuickTestNBE.uu___is_QPURE


; <Start encoding val QuickTestNBE.uu___is_QPURE>

(declare-fun QuickTestNBE.uu___is_QPURE (Term Term) Term)

(declare-fun QuickTestNBE.uu___is_QPURE@tok () Term)

; </end encoding val QuickTestNBE.uu___is_QPURE>
...
; encoding sigelt val QuickTestNBE.__proj__QPURE__item__r


; <Start encoding val QuickTestNBE.__proj__QPURE__item__r>

(declare-fun Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4 (Term) Term)
(declare-fun QuickTestNBE.__proj__QPURE__item__r (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: quickCodes a {QPURE? _} -> FStar.Range.range
(declare-fun Tm_arrow_c8e967006cb2e4055c13c2be88d05557 () Term)
(declare-fun QuickTestNBE.__proj__QPURE__item__r@tok () Term)

; </end encoding val QuickTestNBE.__proj__QPURE__item__r>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickTestNBE.uu___is_QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(QuickTestNBE.quickCodes @x0)))
(HasType (QuickTestNBE.uu___is_QPURE @x0
@x1)
Prims.bool))
 

:pattern ((QuickTestNBE.uu___is_QPURE @x0
@x1))
:qid typing_QuickTestNBE.uu___is_QPURE))

:named typing_QuickTestNBE.uu___is_QPURE))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name QuickTestNBE.__proj__QPURE__item__r; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4))

:named refinement_kinding_Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name QuickTestNBE.__proj__QPURE__item__r; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4 @x2))
(and (HasTypeFuel @u0
@x1
(QuickTestNBE.quickCodes @x2))

;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(BoxBool_proj_0 (QuickTestNBE.uu___is_QPURE @x2
@x1))
))
...
@x1
(Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4 @x2)))
:qid refinement_interpretation_Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4))

:named refinement_interpretation_Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4
;;; Fact-ids: Name QuickTestNBE.__proj__QPURE__item__r; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4 @x0)))
(Valid (Prims.hasEq (QuickTestNBE.quickCodes @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4 @x0))))
:qid haseqTm_refine_0e3e5b83231dd782c32cd3cd1715c5c4))

:named haseqTm_refine_0e3e5b83231dd782c32cd3cd1715c5c4))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name QuickTestNBE.uu___is_QPURE; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,2-37,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (QuickTestNBE.uu___is_QPURE @x0
@x1)
(BoxBool (is-QuickTestNBE.QPURE @x1)))
 

:pattern ((QuickTestNBE.uu___is_QPURE @x0
@x1))
:qid disc_equation_QuickTestNBE.QPURE))

:named disc_equation_QuickTestNBE.QPURE))
(push) ;; push{2

; Starting query at QuickTestNBE.fst(37,9-37,10)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (projectee: _: QuickTestNBE.quickCodes a {QPURE? _}).
;   (*  - Could not prove post-condition
...
Tm_type)
(HasType @x1
(Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4 @x0))

;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,9-37,10)
(not 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,9-37,10)
(BoxBool_proj_0 (QuickTestNBE.uu___is_QPURE @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.__proj__QPURE__item__r, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4
...
; encoding sigelt val QuickTestNBE.__proj__QPURE__item__msg


; <Start encoding val QuickTestNBE.__proj__QPURE__item__msg>


(declare-fun QuickTestNBE.__proj__QPURE__item__msg (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: quickCodes a {QPURE? _} -> Prims.string
(declare-fun Tm_arrow_9283fcd275ab46ec5f50fc41c28d421c () Term)
(declare-fun QuickTestNBE.__proj__QPURE__item__msg@tok () Term)

; </end encoding val QuickTestNBE.__proj__QPURE__item__msg>

(push) ;; push{2

; Starting query at QuickTestNBE.fst(37,20-37,23)
...
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,20-37,23)
(not 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,20-37,23)
(BoxBool_proj_0 (QuickTestNBE.uu___is_QPURE @x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.__proj__QPURE__item__msg, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4
...
; encoding sigelt val QuickTestNBE.__proj__QPURE__item__pre


; <Start encoding val QuickTestNBE.__proj__QPURE__item__pre>


(declare-fun QuickTestNBE.__proj__QPURE__item__pre (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: quickCodes a {QPURE? _} -> Prims.pure_wp Prims.unit
(declare-fun Tm_arrow_c6cf911daeae04d4601f6bd50dbcc394 () Term)
(declare-fun QuickTestNBE.__proj__QPURE__item__pre@tok () Term)

; </end encoding val QuickTestNBE.__proj__QPURE__item__pre>

(push) ;; push{2

; Starting query at QuickTestNBE.fst(37,34-37,37)
...
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,34-37,37)
(not 
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(37,34-37,37)
(BoxBool_proj_0 (QuickTestNBE.uu___is_QPURE @x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.__proj__QPURE__item__pre, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4
...
; encoding sigelt val QuickTestNBE.__proj__QPURE__item___3


; <Start encoding val QuickTestNBE.__proj__QPURE__item___3>


(declare-fun QuickTestNBE.__proj__QPURE__item___3 (Term Term) Term)





(declare-fun Tm_refine_d863de1ee6a5bfbb6c11f37b50b06ea7 (Term Term) Term)
...
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE Prims.unit
(declare-fun Tm_arrow_789211848cf3ed577485fee49cd2be3c (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: _: quickCodes a {QPURE? _} -> _: Prims.unit -> Prims.PURE Prims.unit
(declare-fun Tm_arrow_3e7a26d442e3b6c430d0cfc316c86a0a () Term)
(declare-fun QuickTestNBE.__proj__QPURE__item___3@tok () Term)
...
; </end encoding val QuickTestNBE.__proj__QPURE__item___3>
...
;       (b: QuickTestNBE.quickCodes a).
;       projectee == QuickTestNBE.QPURE b b b b b ==>
;       (forall (_: Prims.unit).
;           (*  - Subtyping check failed
;   - Expected type _: quickCodes a {QPURE? _} got type quickCodes a
; *)
;           QPURE? (QuickTestNBE.QPURE b b b b b)))
...
;; def=QuickTestNBE.fst(37,2-37,7); use=QuickTestNBE.fst(38,5-38,22)
(BoxBool_proj_0 (QuickTestNBE.uu___is_QPURE @x0
(QuickTestNBE.QPURE @x0
@x2
@x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.__proj__QPURE__item___3, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4
...
; encoding sigelt val QuickTestNBE.__proj__QPURE__item___4


; <Start encoding val QuickTestNBE.__proj__QPURE__item___4>


(declare-fun QuickTestNBE.__proj__QPURE__item___4 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: quickCodes a {QPURE? _} -> quickCodes a
(declare-fun Tm_arrow_62d10ee7cbe721f844ed6f891641bfbd () Term)
(declare-fun QuickTestNBE.__proj__QPURE__item___4@tok () Term)

; </end encoding val QuickTestNBE.__proj__QPURE__item___4>
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.__proj__QPURE__item___4, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0e3e5b83231dd782c32cd3cd1715c5c4
...
(declare-fun Tm_arrow_b9395aa0eda4fed1822bb8c12d6863b4 () Term)
(declare-fun QuickTestNBE.qPURE@tok () Term)
...
(declare-fun QuickTestNBE.range1 (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name QuickTestNBE.vale_state; Namespace QuickTestNBE; Name QuickTestNBE.Mkvale_state; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(7,10-7,20); use=QuickTestNBE.fst(7,10-7,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(QuickTestNBE.Mkvale_state @x1)
QuickTestNBE.vale_state)
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x1
...
(QuickTestNBE.Mkvale_state @x1)
QuickTestNBE.vale_state))
:qid subterm_ordering_QuickTestNBE.Mkvale_state))

:named subterm_ordering_QuickTestNBE.Mkvale_state))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=QuickTestNBE.fst(7,10-7,20); use=QuickTestNBE.fst(7,10-7,20)
(forall ((@x0 Term))
 (! (= (QuickTestNBE.Mkvale_state_vs_ok (QuickTestNBE.Mkvale_state @x0))
@x0)
 

:pattern ((QuickTestNBE.Mkvale_state @x0))
:qid projection_inverse_QuickTestNBE.Mkvale_state_vs_ok))

:named projection_inverse_QuickTestNBE.Mkvale_state_vs_ok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57
;;; Fact-ids: Name QuickTestNBE.quickProc_wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(9,18-9,96); use=QuickTestNBE.fst(9,72-9,96)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x0)
Tm_type))
:qid kinding_Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57))

:named kinding_Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57))
;;; Fact-ids: Name QuickTestNBE.vale_state; Namespace QuickTestNBE; Name QuickTestNBE.Mkvale_state; Namespace QuickTestNBE
(assert (! (HasType QuickTestNBE.vale_state
Tm_type)
:named kinding_QuickTestNBE.vale_state@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
@x1
QuickTestNBE.vale_state)
(is-QuickTestNBE.Mkvale_state @x1))
 

:pattern ((HasTypeFuel @u0
@x1
QuickTestNBE.vale_state))
:qid fuel_guarded_inversion_QuickTestNBE.vale_state))

:named fuel_guarded_inversion_QuickTestNBE.vale_state))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name QuickTestNBE.vale_state; Namespace QuickTestNBE; Name QuickTestNBE.Mkvale_state; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(7,10-7,20); use=QuickTestNBE.fst(7,10-7,20)
...
(QuickTestNBE.Mkvale_state @x1)
QuickTestNBE.vale_state))
:qid data_typing_intro_QuickTestNBE.Mkvale_state@tok))

:named data_typing_intro_QuickTestNBE.Mkvale_state@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name QuickTestNBE.vale_state; Namespace QuickTestNBE; Name QuickTestNBE.Mkvale_state; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(7,10-7,20); use=QuickTestNBE.fst(7,10-7,20)
...
(QuickTestNBE.Mkvale_state @x1)
QuickTestNBE.vale_state))
:qid data_elim_QuickTestNBE.Mkvale_state))

:named data_elim_QuickTestNBE.Mkvale_state))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name QuickTestNBE.vale_state; Namespace QuickTestNBE; Name QuickTestNBE.Mkvale_state; Namespace QuickTestNBE
(assert (! (= 104
(Term_constr_id QuickTestNBE.vale_state))
:named constructor_distinct_QuickTestNBE.vale_state))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name QuickTestNBE.vale_state; Namespace QuickTestNBE; Name QuickTestNBE.Mkvale_state; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(7,10-7,20); use=QuickTestNBE.fst(7,10-7,20)
(forall ((@x0 Term))
 (! (= 110
(Term_constr_id (QuickTestNBE.Mkvale_state @x0)))
 

:pattern ((QuickTestNBE.Mkvale_state @x0))
:qid constructor_distinct_QuickTestNBE.Mkvale_state))

:named constructor_distinct_QuickTestNBE.Mkvale_state))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
@x0
QuickTestNBE.vale_state))
:qid QuickTestNBE_pretyping_7d55acd0232baf7d4b889ef9ffa46971))

:named QuickTestNBE_pretyping_7d55acd0232baf7d4b889ef9ffa46971))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name QuickTestNBE.quickProc_wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(9,18-9,96); use=QuickTestNBE.fst(9,72-9,96)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x2)))
:qid QuickTestNBE_pre_typing_Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57))

:named QuickTestNBE_pre_typing_Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57
;;; Fact-ids: Name QuickTestNBE.quickProc_wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(9,18-9,96); use=QuickTestNBE.fst(9,72-9,96)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x1))
(and 
;; def=QuickTestNBE.fst(9,18-9,96); use=QuickTestNBE.fst(9,72-9,96)
...
@x2)
@x3))
:qid QuickTestNBE_interpretation_Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid QuickTestNBE_interpretation_Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x1)))
:qid QuickTestNBE_interpretation_Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57))

:named QuickTestNBE_interpretation_Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! 
...
; Starting query at QuickTestNBE.fst(54,2-60,28)
...
;;;;;;;;;;;;;;;;qcs : QuickTestNBE.quickCodes a (QuickTestNBE.quickCodes a)
(declare-fun x_fa10b5986d234da3d5bdfe9ba7efb81b_1 () Term)
;;;;;;;;;;;;;;;;binder_x_fa10b5986d234da3d5bdfe9ba7efb81b_1
;;; Fact-ids: 
(assert (! (HasType x_fa10b5986d234da3d5bdfe9ba7efb81b_1
(QuickTestNBE.quickCodes x_fe28d8bcde588226b4e538b35321de05_0))
:named binder_x_fa10b5986d234da3d5bdfe9ba7efb81b_1))
;;;;;;;;;;;;;;;;k : _: QuickTestNBE.vale_state -> _: a -> Type0 (_: QuickTestNBE.vale_state -> _: a -> Type)
(declare-fun x_0d5060e9bc8f366d142737eabe74f3d6_2 () Term)
;;;;;;;;;;;;;;;;_: vale_state -> _: a -> Type
(declare-fun Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528
Tm_type)
:named kinding_Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(51,13-51,68); use=QuickTestNBE.fst(51,44-51,68)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528))
:qid QuickTestNBE_pre_typing_Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528))

:named QuickTestNBE_pre_typing_Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(51,13-51,68); use=QuickTestNBE.fst(51,44-51,68)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid QuickTestNBE_interpretation_Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickTestNBE_interpretation_Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528))
:qid QuickTestNBE_interpretation_Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528))

:named QuickTestNBE_interpretation_Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528))
;;;;;;;;;;;;;;;;binder_x_0d5060e9bc8f366d142737eabe74f3d6_2
;;; Fact-ids: 
(assert (! (HasType x_0d5060e9bc8f366d142737eabe74f3d6_2
Tm_arrow_6df00e38d29eb8ca1fc0bb2588d0c528)
:named binder_x_0d5060e9bc8f366d142737eabe74f3d6_2))
;;;;;;;;;;;;;;;;s0 : QuickTestNBE.vale_state (QuickTestNBE.vale_state)
(declare-fun x_7d55acd0232baf7d4b889ef9ffa46971_3 () Term)
;;;;;;;;;;;;;;;;binder_x_7d55acd0232baf7d4b889ef9ffa46971_3
;;; Fact-ids: 
(assert (! (HasType x_7d55acd0232baf7d4b889ef9ffa46971_3
QuickTestNBE.vale_state)
:named binder_x_7d55acd0232baf7d4b889ef9ffa46971_3))

(declare-fun Tm_refine_6fc78d4cde9e59b665471c2621cb86f7 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(51,71-60,28); use=QuickTestNBE.fst(51,71-60,28)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_6fc78d4cde9e59b665471c2621cb86f7 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_6fc78d4cde9e59b665471c2621cb86f7 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_6fc78d4cde9e59b665471c2621cb86f7))

:named refinement_kinding_Tm_refine_6fc78d4cde9e59b665471c2621cb86f7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(51,71-60,28); use=QuickTestNBE.fst(51,71-60,28)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6fc78d4cde9e59b665471c2621cb86f7 @x2
@x3))
(and (HasTypeFuel @u0
@x1
QuickTestNBE.vale_state)

;; def=QuickTestNBE.fst(52,25-60,28); use=QuickTestNBE.fst(52,25-60,28)

;; def=QuickTestNBE.fst(52,25-60,28); use=QuickTestNBE.fst(52,25-60,28)
(or 
;; def=QuickTestNBE.fst(54,2-60,28); use=QuickTestNBE.fst(54,2-60,28)
(Valid 
;; def=QuickTestNBE.fst(54,2-60,28); use=QuickTestNBE.fst(54,2-60,28)
...
(Valid 
;; def=QuickTestNBE.fst(54,2-60,28); use=QuickTestNBE.fst(54,2-60,28)
(Prims.precedes (QuickTestNBE.quickCodes @x2)
(QuickTestNBE.quickCodes x_fe28d8bcde588226b4e538b35321de05_0)
@x3
x_fa10b5986d234da3d5bdfe9ba7efb81b_1)
)
)
...
(Tm_refine_6fc78d4cde9e59b665471c2621cb86f7 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_6fc78d4cde9e59b665471c2621cb86f7))

:named refinement_interpretation_Tm_refine_6fc78d4cde9e59b665471c2621cb86f7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6fc78d4cde9e59b665471c2621cb86f7
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(51,71-60,28); use=QuickTestNBE.fst(51,71-60,28)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6fc78d4cde9e59b665471c2621cb86f7 @x0
@x1)))
(Valid (Prims.hasEq QuickTestNBE.vale_state)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6fc78d4cde9e59b665471c2621cb86f7 @x0
@x1))))
:qid haseqTm_refine_6fc78d4cde9e59b665471c2621cb86f7))

:named haseqTm_refine_6fc78d4cde9e59b665471c2621cb86f7))
(declare-fun QuickTestNBE.wp (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;qcs: quickCodes a -> k: (_: vale_state -> _: a -> Type) -> s0: vale_state{0 << 0 \/ qcs << qcs}   -> Prims.Tot Type
(declare-fun Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc
Tm_type)
:named kinding_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(51,13-60,28); use=QuickTestNBE.fst(51,15-60,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc))
:qid QuickTestNBE_pre_typing_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc))

:named QuickTestNBE_pre_typing_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(51,13-60,28); use=QuickTestNBE.fst(51,15-60,28)
(forall ((@x0 Term))
...
(Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x1))
(HasType @x4
(Tm_refine_6fc78d4cde9e59b665471c2621cb86f7 @x1
@x2)))
...
@x3)
@x4))
:qid QuickTestNBE_interpretation_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickTestNBE_interpretation_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc.2))
...
@x1)
@x2))
:qid QuickTestNBE_interpretation_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc.3))
...
@x2)
@x3))
:qid QuickTestNBE_interpretation_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc))
:qid QuickTestNBE_interpretation_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc))

:named QuickTestNBE_interpretation_Tm_arrow_9982ab9e92ce762551e357bb6c8e30bc))
(declare-fun QuickTestNBE.wp@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(51,8-51,10); use=QuickTestNBE.fst(51,8-51,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT QuickTestNBE.wp@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT QuickTestNBE.wp@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_QuickTestNBE.wp))

:named token_correspondence_QuickTestNBE.wp))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(51,8-51,10); use=QuickTestNBE.fst(51,8-51,10)
...
:pattern ((QuickTestNBE.wp @x1
@x2
@x3
@x4))
:qid function_token_typing_QuickTestNBE.wp.1))
)
 

:pattern ((ApplyTT @x0
QuickTestNBE.wp@tok))
:qid function_token_typing_QuickTestNBE.wp))

:named function_token_typing_QuickTestNBE.wp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(51,8-51,10); use=QuickTestNBE.fst(51,8-51,10)
...
(QuickTestNBE.quickCodes @x0))
(HasType @x2
(Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x0))
(HasType @x3
(Tm_refine_6fc78d4cde9e59b665471c2621cb86f7 @x0
@x1)))
(HasType (QuickTestNBE.wp @x0
@x1
@x2
@x3)
Tm_type))
...
:pattern ((QuickTestNBE.wp @x0
@x1
@x2
@x3))
:qid typing_QuickTestNBE.wp))

:named typing_QuickTestNBE.wp))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(57,17-57,35); use=QuickTestNBE.fst(57,17-57,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
:qid QuickTestNBE_pre_typing_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))

:named QuickTestNBE_pre_typing_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickTestNBE_interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
:qid QuickTestNBE_interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))

:named QuickTestNBE_interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
...
;         (b: (_: Prims.unit -> Prims.PURE Prims.unit))
;         (b: QuickTestNBE.quickCodes a).
;         qcs == QuickTestNBE.QPURE b b b b b ==>
...
;; def=Prims.fst(402,27-402,88); use=QuickTestNBE.fst(54,2-60,28)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=QuickTestNBE.fst(54,2-60,28)
(Valid 
;; def=Prims.fst(402,84-402,87); use=QuickTestNBE.fst(54,2-60,28)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=QuickTestNBE.fst(54,2-60,28)
(and (implies 
;; def=QuickTestNBE.fst(51,23-51,26); use=QuickTestNBE.fst(54,8-54,11)
(and 
;; def=QuickTestNBE.fst(51,23-51,26); use=QuickTestNBE.fst(54,8-54,11)
(not 
;; def=QuickTestNBE.fst(51,23-51,26); use=QuickTestNBE.fst(54,8-54,11)
(BoxBool_proj_0 (QuickTestNBE.uu___is_QEmpty x_fe28d8bcde588226b4e538b35321de05_0
x_fa10b5986d234da3d5bdfe9ba7efb81b_1))
)
...
(not 
;; def=QuickTestNBE.fst(51,23-51,26); use=QuickTestNBE.fst(54,8-54,11)
(BoxBool_proj_0 (QuickTestNBE.uu___is_QPURE x_fe28d8bcde588226b4e538b35321de05_0
x_fa10b5986d234da3d5bdfe9ba7efb81b_1))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=QuickTestNBE.fst(54,2-60,28)
(not 
;; def=QuickTestNBE.fst(51,23-51,26); use=QuickTestNBE.fst(54,8-54,11)
(BoxBool_proj_0 (QuickTestNBE.uu___is_QEmpty x_fe28d8bcde588226b4e538b35321de05_0
x_fa10b5986d234da3d5bdfe9ba7efb81b_1))
...
;; def=Prims.fst(413,99-413,120); use=QuickTestNBE.fst(54,2-60,28)
(forall ((@x1 Term))
 (! (implies (HasType @x1
FStar.Range.range)
...
;; def=QuickTestNBE.fst(51,23-56,25); use=QuickTestNBE.fst(54,8-56,25)
(= x_fa10b5986d234da3d5bdfe9ba7efb81b_1
(QuickTestNBE.QPURE x_fe28d8bcde588226b4e538b35321de05_0
@x1
@x2
@x3
@x4
...
;; def=dummy(0,0-0,0); use=QuickTestNBE.fst(54,2-60,28)
...
;; def=QuickTestNBE.fst(52,25-60,28); use=QuickTestNBE.fst(58,64-58,66)
(or label_2

;; def=QuickTestNBE.fst(54,2-60,28); use=QuickTestNBE.fst(58,64-58,66)
(Valid 
;; def=QuickTestNBE.fst(54,2-60,28); use=QuickTestNBE.fst(58,64-58,66)
(Prims.precedes Prims.int
Prims.int
...
(Valid 
;; def=QuickTestNBE.fst(54,2-60,28); use=QuickTestNBE.fst(58,64-58,66)
(Prims.precedes (QuickTestNBE.quickCodes x_fe28d8bcde588226b4e538b35321de05_0)
(QuickTestNBE.quickCodes x_fe28d8bcde588226b4e538b35321de05_0)
@x5
x_fa10b5986d234da3d5bdfe9ba7efb81b_1)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.wp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_fa10b5986d234da3d5bdfe9ba7efb81b_1, disc_equation_QuickTestNBE.QEmpty, disc_equation_QuickTestNBE.QPURE, fuel_guarded_inversion_QuickTestNBE.quickCodes, projection_inverse_BoxBool_proj_0, projection_inverse_QuickTestNBE.QPURE__4, subterm_ordering_QuickTestNBE.QPURE
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun QuickTestNBE.wp.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun QuickTestNBE.wp.fuel_instrumented_token () Term)
(declare-fun QuickTestNBE.wp (Term Term Term Term) Term)
(declare-fun QuickTestNBE.wp@tok () Term)
...
(declare-fun Tm_abs_8fbce5fc0ff9448b562f25368fa84114 (Fuel Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;p: (_: Prims.unit -> Prims.GTot Type) -> Prims.GTot Type
(declare-fun Tm_arrow_2a3381d384e2722434518a0bfbf9e1c6 () Term)
(declare-fun Tm_abs_42e6bb718c339b3e05c3c4308057f1b2 (Fuel Term Term Term Term) Term)



;;;;;;;;;;;;;;;;qcs: quickCodes a -> k: (_: vale_state -> _: a -> Type) -> s0: vale_state -> Prims.Tot Type
(declare-fun Tm_arrow_ed9d8c9ffd7636929b839a57ffa0b161 () Term)
...
(declare-fun Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46 (Term) Term)

(declare-fun QuickTestNBE.wp_block (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;qcs: (_: vale_state -> Prims.GTot (quickCodes a)) ->     s0: vale_state ->     k: (_: vale_state -> _: a -> Type)   -> Type
(declare-fun Tm_arrow_7c8cda40dea64001676b71d53bb6b04a () Term)
(declare-fun QuickTestNBE.wp_block@tok () Term)
...
; encoding sigelt val QuickTestNBE.qblock_proof


; <Start encoding val QuickTestNBE.qblock_proof>



(declare-fun QuickTestNBE.qblock_proof (Term Term Term Term) Term)


(declare-fun Tm_refine_09a136d5256018bc61492f53aefb8ce7 (Term Term) Term)
;;;;;;;;;;;;;;;;qcs: (_: vale_state -> Prims.GTot (quickCodes a)) ->     s0: vale_state ->     k: (_: vale_state -> _: a -> Type)   -> Prims.Ghost (vale_state & a)
(declare-fun Tm_ghost_arrow_d32dcb2037651ef468b0dc1938d47cd3 () Term)
(declare-fun QuickTestNBE.qblock_proof@tok () Term)


; </end encoding val QuickTestNBE.qblock_proof>

;;;;;;;;;;;;;;;;typing_Tm_abs_8fbce5fc0ff9448b562f25368fa84114
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(58,8-58,76); use=QuickTestNBE.fst(58,8-58,76)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (HasType (Tm_abs_8fbce5fc0ff9448b562f25368fa84114 @u0
@x1
@x2
@x3
@x4
...
:pattern ((Tm_abs_8fbce5fc0ff9448b562f25368fa84114 @u0
@x1
@x2
@x3
@x4
@x5))
:qid typing_Tm_abs_8fbce5fc0ff9448b562f25368fa84114))

:named typing_Tm_abs_8fbce5fc0ff9448b562f25368fa84114))
;;;;;;;;;;;;;;;;typing_Tm_abs_42e6bb718c339b3e05c3c4308057f1b2
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(57,6-60,28); use=QuickTestNBE.fst(57,6-60,28)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_42e6bb718c339b3e05c3c4308057f1b2 @u0
@x1
@x2
@x3
@x4)
...
:pattern ((Tm_abs_42e6bb718c339b3e05c3c4308057f1b2 @u0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_42e6bb718c339b3e05c3c4308057f1b2))

:named typing_Tm_abs_42e6bb718c339b3e05c3c4308057f1b2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickTestNBE.wp_block; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(63,4-63,12); use=QuickTestNBE.fst(63,4-63,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46 @x0))
(HasType @x2
QuickTestNBE.vale_state)
(HasType @x3
(Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x0)))
(HasType (QuickTestNBE.wp_block @x0
@x1
@x2
@x3)
Tm_type))
...
:pattern ((QuickTestNBE.wp_block @x0
@x1
@x2
@x3))
:qid typing_QuickTestNBE.wp_block))

:named typing_QuickTestNBE.wp_block))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(51,8-51,10); use=QuickTestNBE.fst(51,8-51,10)
...
:named typing_QuickTestNBE.wp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickTestNBE.t_ensure; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(11,4-11,12); use=QuickTestNBE.fst(11,4-11,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(QuickTestNBE.quickProc_wp @x0))
(HasType @x2
QuickTestNBE.vale_state)
(HasType @x3
(Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x0))
(HasType @x4
(FStar.Pervasives.Native.tuple2 QuickTestNBE.vale_state
@x0)))
(HasType (QuickTestNBE.t_ensure @x0
@x1
@x2
@x3
@x4)
...
:pattern ((QuickTestNBE.t_ensure @x0
@x1
@x2
@x3
@x4))
:qid typing_QuickTestNBE.t_ensure))

:named typing_QuickTestNBE.t_ensure))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickTestNBE.quickProc_wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(9,4-9,16); use=QuickTestNBE.fst(9,4-9,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (QuickTestNBE.quickProc_wp @x0)
Tm_type))
 

:pattern ((QuickTestNBE.quickProc_wp @x0))
:qid typing_QuickTestNBE.quickProc_wp))

:named typing_QuickTestNBE.quickProc_wp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickTestNBE.label; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(31,4-31,9); use=QuickTestNBE.fst(31,4-31,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
FStar.Range.range)
(HasType @x1
...
(HasType @x2
Tm_type))
(HasType (QuickTestNBE.label @x0
@x1
@x2)
(Tm_refine_2a09f2450e26fe8d9312d402cf7d7936 @x2)))
 

:pattern ((QuickTestNBE.label @x0
@x1
@x2))
:qid typing_QuickTestNBE.label))

:named typing_QuickTestNBE.label))
;;;;;;;;;;;;;;;;free var typing
...
;; def=QuickTestNBE.fst(63,4-63,12); use=QuickTestNBE.fst(63,4-63,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT QuickTestNBE.wp_block@tok
@x0)
@x1)
@x2)
@x3)
(QuickTestNBE.wp_block @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT QuickTestNBE.wp_block@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_QuickTestNBE.wp_block))

:named token_correspondence_QuickTestNBE.wp_block))
...
(HasType @x4
QuickTestNBE.vale_state))
(HasType (QuickTestNBE.wp.fuel_instrumented @u0
@x1
@x2
@x3
@x4)
...
:pattern ((QuickTestNBE.wp.fuel_instrumented @u0
@x1
@x2
@x3
@x4))
:qid token_correspondence_QuickTestNBE.wp.fuel_instrumented))

:named token_correspondence_QuickTestNBE.wp.fuel_instrumented))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;; Fact-ids: Name QuickTestNBE.label; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(31,51-31,55); use=QuickTestNBE.fst(31,51-31,55)
(forall ((@x0 Term))
...
;; def=QuickTestNBE.fst(31,90-31,98); use=QuickTestNBE.fst(31,90-31,98)
(iff (Valid @x1)
...
(Tm_abs_8fbce5fc0ff9448b562f25368fa84114 @u5
@x4
@x3
@x2
@x1
...
(forall ((@x6 Term))
 (! 
;; def=QuickTestNBE.fst(58,55-58,75); use=QuickTestNBE.fst(58,55-58,75)
(implies 
;; def=QuickTestNBE.fst(58,55-58,66); use=QuickTestNBE.fst(58,55-58,66)
(Valid 
;; def=QuickTestNBE.fst(58,55-58,66); use=QuickTestNBE.fst(58,55-58,66)
(QuickTestNBE.wp.fuel_instrumented @u5
@x4
(QuickTestNBE.QPURE__4 @x3)
@x2
@x1)
)


;; def=QuickTestNBE.fst(58,71-58,75); use=QuickTestNBE.fst(58,71-58,75)
(Valid 
;; def=QuickTestNBE.fst(58,71-58,75); use=QuickTestNBE.fst(58,71-58,75)
(ApplyTT @x0
Tm_unit)
...
:pattern ((ApplyTT @x0
@x6))
:qid l_quant_interp_e61cdefc9af40dccf7236895cfb5d724.1))
)
...
@x1
@x0))))
:qid l_quant_interp_e61cdefc9af40dccf7236895cfb5d724))

:named l_quant_interp_e61cdefc9af40dccf7236895cfb5d724))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(57,6-60,28); use=QuickTestNBE.fst(57,6-60,28)
...
(Tm_abs_42e6bb718c339b3e05c3c4308057f1b2 @u4
@x3
@x2
@x1
@x0)))
...
(Valid 
;; def=QuickTestNBE.fst(58,55-58,66); use=QuickTestNBE.fst(58,55-58,66)
(QuickTestNBE.wp.fuel_instrumented @u4
@x3
(QuickTestNBE.QPURE__4 @x2)
@x1
@x0)
)
...
:pattern ((ApplyTT @x5
@x6))
:qid l_quant_interp_63c64324834b50a486e2c80180ba79c9.2))
)

;; def=QuickTestNBE.fst(60,8-60,27); use=QuickTestNBE.fst(60,8-60,27)
(Valid 
;; def=QuickTestNBE.fst(60,8-60,27); use=QuickTestNBE.fst(60,8-60,27)
(QuickTestNBE.label (QuickTestNBE.QPURE_r @x2)
(QuickTestNBE.QPURE_msg @x2)
(ApplyTT (QuickTestNBE.QPURE_pre @x2)
@x5))
)
)
 
;;no pats
:qid l_quant_interp_63c64324834b50a486e2c80180ba79c9.1))
)
...
@x1
@x0))))
:qid l_quant_interp_63c64324834b50a486e2c80180ba79c9))

:named l_quant_interp_63c64324834b50a486e2c80180ba79c9))
...
;;;;;;;;;;;;;;;;kinding_Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46
;;; Fact-ids: Name QuickTestNBE.wp_block; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(63,28-63,61); use=QuickTestNBE.fst(63,28-63,61)
(forall ((@x0 Term))
 (! (HasType (Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46 @x0)
Tm_type)
 

:pattern ((HasType (Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46 @x0)
Tm_type))
:qid kinding_Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46))

:named kinding_Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! (HasType Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe
Tm_type)
:named kinding_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a
;;; Fact-ids: Name QuickTestNBE.wp_block; Namespace QuickTestNBE
(assert (! (HasType Tm_arrow_7c8cda40dea64001676b71d53bb6b04a
Tm_type)
:named kinding_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07
;;; Fact-ids: Name QuickTestNBE.quickProc_wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(9,18-9,106); use=QuickTestNBE.fst(9,44-9,106)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07 @x0)
Tm_type))
:qid kinding_Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07))

:named kinding_Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07))
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_8fbce5fc0ff9448b562f25368fa84114
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(58,8-58,76); use=QuickTestNBE.fst(58,8-58,76)
(forall ((@x0 Term) (@u1 Fuel) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (ApplyTT (Tm_abs_8fbce5fc0ff9448b562f25368fa84114 @u1
@x2
@x3
@x4
@x5
@x6)
@x0)
(Prims.l_imp (QuickTestNBE.wp.fuel_instrumented @u1
@x2
(QuickTestNBE.QPURE__4 @x3)
@x4
@x5)
...
:pattern ((ApplyTT (Tm_abs_8fbce5fc0ff9448b562f25368fa84114 @u1
@x2
@x3
@x4
@x5
@x6)
@x0))
:qid interpretation_Tm_abs_8fbce5fc0ff9448b562f25368fa84114))

:named interpretation_Tm_abs_8fbce5fc0ff9448b562f25368fa84114))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_42e6bb718c339b3e05c3c4308057f1b2
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(57,6-60,28); use=QuickTestNBE.fst(57,6-60,28)
(forall ((@x0 Term) (@u1 Fuel) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (Tm_abs_42e6bb718c339b3e05c3c4308057f1b2 @u1
@x2
@x3
@x4
@x5)
...
(Tm_abs_8fbce5fc0ff9448b562f25368fa84114 @u1
@x2
@x3
@x4
@x5
@x0))
(QuickTestNBE.label (QuickTestNBE.QPURE_r @x3)
(QuickTestNBE.QPURE_msg @x3)
(ApplyTT (QuickTestNBE.QPURE_pre @x3)
@x0))))
 

:pattern ((ApplyTT (Tm_abs_42e6bb718c339b3e05c3c4308057f1b2 @u1
@x2
@x3
@x4
@x5)
@x0))
:qid interpretation_Tm_abs_42e6bb718c339b3e05c3c4308057f1b2))

:named interpretation_Tm_abs_42e6bb718c339b3e05c3c4308057f1b2))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType QuickTestNBE.wp_block@tok
Tm_arrow_7c8cda40dea64001676b71d53bb6b04a))
...
@x3)
@x4)
(QuickTestNBE.wp_block @x1
@x2
@x3
@x4))
 

:pattern ((QuickTestNBE.wp_block @x1
@x2
@x3
@x4))
:qid function_token_typing_QuickTestNBE.wp_block.1))
)
 

:pattern ((ApplyTT @x0
QuickTestNBE.wp_block@tok))
:qid function_token_typing_QuickTestNBE.wp_block))

:named function_token_typing_QuickTestNBE.wp_block))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,5-59,11); use=FStar.Pervasives.Native.fst(59,5-59,11)
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: QuickTestNBE.wp
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(51,8-51,10); use=QuickTestNBE.fst(51,8-51,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
(HasType @x4
QuickTestNBE.vale_state))
(= (QuickTestNBE.wp.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4)
(let ((@lb5 @x2))
(ite (is-QuickTestNBE.QEmpty @lb5)
(ApplyTT (ApplyTT @x3
@x4)
(QuickTestNBE.QEmpty__0 @lb5))
(ite (is-QuickTestNBE.QPURE @lb5)
(Prims.l_Forall Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe
(Tm_abs_42e6bb718c339b3e05c3c4308057f1b2 @u0
@x1
@lb5
@x3
@x4))
...
:pattern ((QuickTestNBE.wp.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4))
:qid equation_with_fuel_QuickTestNBE.wp.fuel_instrumented))

:named equation_with_fuel_QuickTestNBE.wp.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for QuickTestNBE.wp_block
;;; Fact-ids: Name QuickTestNBE.wp_block; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(63,4-63,12); use=QuickTestNBE.fst(63,4-63,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3))
:qid equation_QuickTestNBE.wp_block))

:named equation_QuickTestNBE.wp_block))
;;;;;;;;;;;;;;;;Equation for QuickTestNBE.t_ensure
;;; Fact-ids: Name QuickTestNBE.t_ensure; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(11,4-11,12); use=QuickTestNBE.fst(11,4-11,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (QuickTestNBE.t_ensure @x0
@x1
@x2
@x3
@x4)
...
@x3
@x4))
:qid equation_QuickTestNBE.t_ensure))

:named equation_QuickTestNBE.t_ensure))
;;;;;;;;;;;;;;;;Equation for QuickTestNBE.quickProc_wp
;;; Fact-ids: Name QuickTestNBE.quickProc_wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(9,4-9,16); use=QuickTestNBE.fst(9,4-9,16)
(forall ((@x0 Term))
 (! (= (QuickTestNBE.quickProc_wp @x0)
(Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07 @x0))
 

:pattern ((QuickTestNBE.quickProc_wp @x0))
:qid equation_QuickTestNBE.quickProc_wp))

:named equation_QuickTestNBE.quickProc_wp))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46 @x2)))
:qid QuickTestNBE_pre_typing_Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46))

:named QuickTestNBE_pre_typing_Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(57,17-57,35); use=QuickTestNBE.fst(57,17-57,35)
...
;;; Fact-ids: Name QuickTestNBE.wp_block; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(63,15-63,115); use=QuickTestNBE.fst(63,17-63,115)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7c8cda40dea64001676b71d53bb6b04a)
...
@x1
Tm_arrow_7c8cda40dea64001676b71d53bb6b04a))
:qid QuickTestNBE_pre_typing_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a))

:named QuickTestNBE_pre_typing_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name QuickTestNBE.quickProc_wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(9,18-9,106); use=QuickTestNBE.fst(9,44-9,106)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07 @x2)))
:qid QuickTestNBE_pre_typing_Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07))

:named QuickTestNBE_pre_typing_Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(57,17-57,35); use=QuickTestNBE.fst(57,14-57,36)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2a3381d384e2722434518a0bfbf9e1c6)
...
@x1
Tm_arrow_2a3381d384e2722434518a0bfbf9e1c6))
:qid QuickTestNBE_pre_typing_Tm_arrow_2a3381d384e2722434518a0bfbf9e1c6))

:named QuickTestNBE_pre_typing_Tm_arrow_2a3381d384e2722434518a0bfbf9e1c6))
;;;;;;;;;;;;;;;;interpretation_Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46
;;; Fact-ids: Name QuickTestNBE.wp_block; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(63,28-63,61); use=QuickTestNBE.fst(63,28-63,61)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46 @x1))
...
:pattern ((ApplyTT @x0
@x2))
:qid QuickTestNBE_interpretation_Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46.1))
)
 

:pattern ((HasTypeZ @x0
(Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46 @x1)))
:qid QuickTestNBE_interpretation_Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46))

:named QuickTestNBE_interpretation_Tm_ghost_arrow_110eb907b09e8f915de9a9d5e4a3df46))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe
;;; Fact-ids: Name QuickTestNBE.wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(57,17-57,35); use=QuickTestNBE.fst(57,17-57,35)
...
:named QuickTestNBE_interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a
;;; Fact-ids: Name QuickTestNBE.wp_block; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(63,15-63,115); use=QuickTestNBE.fst(63,17-63,115)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid QuickTestNBE_interpretation_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickTestNBE_interpretation_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a.2))
...
@x1)
@x2))
:qid QuickTestNBE_interpretation_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a.3))
...
@x2)
@x3))
:qid QuickTestNBE_interpretation_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_7c8cda40dea64001676b71d53bb6b04a))
:qid QuickTestNBE_interpretation_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a))

:named QuickTestNBE_interpretation_Tm_arrow_7c8cda40dea64001676b71d53bb6b04a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07
;;; Fact-ids: Name QuickTestNBE.quickProc_wp; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(9,18-9,106); use=QuickTestNBE.fst(9,44-9,106)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07 @x1))
(and 
;; def=QuickTestNBE.fst(9,18-9,106); use=QuickTestNBE.fst(9,44-9,106)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
...
@x2)
@x3))
:qid QuickTestNBE_interpretation_Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid QuickTestNBE_interpretation_Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07 @x1)))
:qid QuickTestNBE_interpretation_Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07))

:named QuickTestNBE_interpretation_Tm_arrow_5d6c20c5dac6e402ff7188fd7f2acb07))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickTestNBE_interpretation_Tm_arrow_2a3381d384e2722434518a0bfbf9e1c6.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_2a3381d384e2722434518a0bfbf9e1c6))
:qid QuickTestNBE_interpretation_Tm_arrow_2a3381d384e2722434518a0bfbf9e1c6))

:named QuickTestNBE_interpretation_Tm_arrow_2a3381d384e2722434518a0bfbf9e1c6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Prims.l_Forall; Namespace Prims
(assert (! 
;; def=Prims.fst(286,16-286,86); use=Prims.fst(286,71-286,86)
...
@x3
@x4)
(QuickTestNBE.wp.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid @fuel_irrelevance_QuickTestNBE.wp.fuel_instrumented))

:named @fuel_irrelevance_QuickTestNBE.wp.fuel_instrumented))
...
@x2
@x3)
(QuickTestNBE.wp.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_correspondence_QuickTestNBE.wp.fuel_instrumented))

:named @fuel_correspondence_QuickTestNBE.wp.fuel_instrumented))
(push) ;; push{2

; Starting query at QuickTestNBE.fst(73,2-73,41)
...
QuickTestNBE.wp_block@tok))
:named @kick_partial_app_548d81daec01dce6cd331520c49ffc91))

; Encoding query formula : forall (a: Type) (qcs: (_: QuickTestNBE.vale_state -> Prims.GTot (QuickTestNBE.quickCodes a))).
;   (*  - Could not prove post-condition
; *)
;   forall (s0: QuickTestNBE.vale_state)
;     (k: (_: QuickTestNBE.vale_state -> _: a -> Type0))
;     (p: Prims.pure_post (QuickTestNBE.vale_state & a)).
;     QuickTestNBE.wp_block qcs s0 k /\
;     (forall (ghost_result: QuickTestNBE.vale_state & a).
;         QuickTestNBE.t_ensure (QuickTestNBE.wp_block qcs) s0 k ghost_result ==> p ghost_result) ==>
;     QuickTestNBE.wp_block qcs s0 k /\
;     (forall (ghost_result: QuickTestNBE.vale_state & a).
...
;; def=dummy(0,0-0,0); use=QuickTestNBE.fst(73,23-73,41)
...
(Tm_arrow_ed1cf0b921035a17ec13306e2a62ac57 @x0))
(HasType @x4
(Prims.pure_post (FStar.Pervasives.Native.tuple2 QuickTestNBE.vale_state
@x0)))

;; def=QuickTestNBE.fst(16,14-16,21); use=QuickTestNBE.fst(73,23-73,41)
(Valid 
;; def=QuickTestNBE.fst(16,14-16,21); use=QuickTestNBE.fst(73,23-73,41)
(QuickTestNBE.wp_block @x0
@x1
...
;; def=Prims.fst(485,36-485,100); use=QuickTestNBE.fst(73,23-73,41)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Pervasives.Native.tuple2 QuickTestNBE.vale_state
@x0))

;; def=Prims.fst(485,63-485,80); use=QuickTestNBE.fst(73,23-73,41)
(Valid 
;; def=Prims.fst(485,63-485,80); use=QuickTestNBE.fst(73,23-73,41)
(QuickTestNBE.t_ensure @x0
(ApplyTT (ApplyTT QuickTestNBE.wp_block@tok
@x0)
@x1)
@x2
@x3
...
;; def=Prims.fst(485,85-485,99); use=QuickTestNBE.fst(73,23-73,41)
(Valid 
;; def=Prims.fst(485,85-485,99); use=QuickTestNBE.fst(73,23-73,41)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(485,29-485,100); use=QuickTestNBE.fst(73,23-73,41)
(and 
;; def=QuickTestNBE.fst(68,12-68,29); use=QuickTestNBE.fst(73,23-73,41)
(or label_1
...
;; def=QuickTestNBE.fst(69,26-69,32); use=QuickTestNBE.fst(73,23-73,41)
(Valid 
;; def=QuickTestNBE.fst(69,26-69,32); use=QuickTestNBE.fst(73,23-73,41)
(ApplyTT (ApplyTT @x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.qblock, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_QuickTestNBE.t_ensure
...
(declare-fun QuickTestNBE.qblock (Term Term) Term)

;;;;;;;;;;;;;;;;qcs: (_: vale_state -> Prims.GTot (quickCodes a)) -> quickCode a
(declare-fun Tm_arrow_f80f5db0fce19fdee74b3dd19eca7e41 () Term)
(declare-fun QuickTestNBE.qblock@tok () Term)
...
(declare-fun Tm_refine_9d66db97dd85afc9b737995edce6123e (Term) Term)
;;;;;;;;;;;;;;;;s0': vale_state{s0 == s0'} -> _: vale_state -> _: a -> Type
(declare-fun Tm_arrow_50d255b90e8af2f628b7de24acb99c1a (Term Term) Term)
(declare-fun QuickTestNBE.wp_sound_code_pre (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;qc: quickCode a ->     s0: vale_state ->     k: (s0': vale_state{s0 == s0'} -> _: vale_state -> _: a -> Type)   -> Type
(declare-fun Tm_arrow_d786b33b6551f43011844e0dbc9e7c5e () Term)
(declare-fun QuickTestNBE.wp_sound_code_pre@tok () Term)
...
(declare-fun QuickTestNBE.wp_sound_code_post (Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;qc: quickCode a ->     s0: vale_state ->     k: (s0': vale_state{s0 == s0'} -> _: vale_state -> _: a -> Type) ->     _: vale_state & a   -> Type
(declare-fun Tm_arrow_8bdeaa562b26f5aef2be59a940111adf () Term)
(declare-fun QuickTestNBE.wp_sound_code_post@tok () Term)
...
(declare-fun QuickTestNBE.normal_steps (Dummy_sort) Term)
...
(declare-fun QuickTestNBE.normal (Term) Term)

(declare-fun QuickTestNBE.normal@tok () Term)

; </end encoding let normal>


; encoding sigelt val QuickTestNBE.wp_sound_code_norm


; <Start encoding val QuickTestNBE.wp_sound_code_norm>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun QuickTestNBE.wp_sound_code_norm (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun QuickTestNBE.wp_sound_code_norm@tok () Term)

; </end encoding val QuickTestNBE.wp_sound_code_norm>


; encoding sigelt val QuickTestNBE.f


; <Start encoding val QuickTestNBE.f>

(declare-fun QuickTestNBE.f (Term) Term)

(declare-fun QuickTestNBE.f@tok () Term)

; </end encoding val QuickTestNBE.f>


; encoding sigelt val QuickTestNBE.lem


; <Start encoding val QuickTestNBE.lem>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun QuickTestNBE.lem (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun QuickTestNBE.lem@tok () Term)

; </end encoding val QuickTestNBE.lem>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickTestNBE.f; Namespace QuickTestNBE
(assert (! 
;; def=QuickTestNBE.fst(89,11-89,12); use=QuickTestNBE.fst(89,11-89,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (QuickTestNBE.f @x0)
Prims.int))
 

:pattern ((QuickTestNBE.f @x0))
:qid typing_QuickTestNBE.f))

:named typing_QuickTestNBE.f))
;;;;;;;;;;;;;;;;free var typing
...
; Starting query at QuickTestNBE.fst(97,0-106,3)
...
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(92,22-92,25); use=QuickTestNBE.fst(101,6-105,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid QuickTestNBE_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named QuickTestNBE_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickTestNBE_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid QuickTestNBE_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named QuickTestNBE_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
(declare-fun Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3
;;; Fact-ids: 
(assert (! (HasType Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
:named typing_Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(92,11-92,50); use=QuickTestNBE.fst(101,39-101,42)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3
@x0)
(Prims.b2t (Prims.op_GreaterThan (QuickTestNBE.f @x0)
(BoxInt 0))))
 

:pattern ((ApplyTT Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3
@x0))
:qid interpretation_Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3))

:named interpretation_Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.l_Forall Prims.int
Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3))
...
;; def=QuickTestNBE.fst(92,42-92,49); use=QuickTestNBE.fst(101,39-101,42)
(> (BoxInt_proj_0 (QuickTestNBE.f @x0))
(BoxInt_proj_0 (BoxInt 0)))
)
 

:pattern ((QuickTestNBE.f @x0))
:qid l_quant_interp_159a06120f590526825bb1a4fc026bb8))
)
:named l_quant_interp_159a06120f590526825bb1a4fc026bb8))

(declare-fun Tm_abs_0183a6394b823a6155719390faa84d4b (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_0183a6394b823a6155719390faa84d4b
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,36-441,97); use=QuickTestNBE.fst(101,39-101,42)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_0183a6394b823a6155719390faa84d4b @x0)
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe)
 

:pattern ((Tm_abs_0183a6394b823a6155719390faa84d4b @x0))
:qid typing_Tm_abs_0183a6394b823a6155719390faa84d4b))

:named typing_Tm_abs_0183a6394b823a6155719390faa84d4b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_0183a6394b823a6155719390faa84d4b
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,36-441,97); use=QuickTestNBE.fst(101,39-101,42)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_0183a6394b823a6155719390faa84d4b @x1)
@x0)
...
:pattern ((ApplyTT (Tm_abs_0183a6394b823a6155719390faa84d4b @x1)
@x0))
:qid interpretation_Tm_abs_0183a6394b823a6155719390faa84d4b))

:named interpretation_Tm_abs_0183a6394b823a6155719390faa84d4b))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,36-441,97); use=QuickTestNBE.fst(101,39-101,42)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.l_Forall Prims.unit
(Tm_abs_0183a6394b823a6155719390faa84d4b @x0)))
...
;; def=QuickTestNBE.fst(92,42-92,49); use=QuickTestNBE.fst(101,39-101,42)
(> (BoxInt_proj_0 (QuickTestNBE.f @x2))
(BoxInt_proj_0 (BoxInt 0)))
)
 

:pattern ((QuickTestNBE.f @x2))
:qid l_quant_interp_0c168580a82b5ed0782124081acd3faa.2))
)

;; def=Prims.fst(441,83-441,96); use=QuickTestNBE.fst(101,39-101,42)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickTestNBE.fst(101,39-101,42)
(ApplyTT @x0
@x1)
...
;;no pats
:qid l_quant_interp_0c168580a82b5ed0782124081acd3faa.1))
)
 

:pattern ((Valid (Prims.l_Forall Prims.unit
(Tm_abs_0183a6394b823a6155719390faa84d4b @x0))))
:qid l_quant_interp_0c168580a82b5ed0782124081acd3faa))

:named l_quant_interp_0c168580a82b5ed0782124081acd3faa))
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(188,39-441,24); use=QuickTestNBE.fst(101,39-101,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))
:qid QuickTestNBE_pre_typing_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))

:named QuickTestNBE_pre_typing_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickTestNBE_interpretation_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))
:qid QuickTestNBE_interpretation_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))

:named QuickTestNBE_interpretation_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))
(declare-fun Tm_abs_17de2bb0f4accb34f2f48a2c39070416 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_17de2bb0f4accb34f2f48a2c39070416
;;; Fact-ids: 
(assert (! (HasType Tm_abs_17de2bb0f4accb34f2f48a2c39070416
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21)
:named typing_Tm_abs_17de2bb0f4accb34f2f48a2c39070416))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_17de2bb0f4accb34f2f48a2c39070416
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,29-441,97); use=QuickTestNBE.fst(101,39-101,42)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_17de2bb0f4accb34f2f48a2c39070416
@x0)
(Prims.l_and (Prims.eq2 Prims.int
(Prims.op_Subtraction (QuickTestNBE.f (BoxInt 4))
(QuickTestNBE.f (BoxInt 4)))
(BoxInt 0))
(Prims.l_Forall Prims.unit
(Tm_abs_0183a6394b823a6155719390faa84d4b @x0))))
 

:pattern ((ApplyTT Tm_abs_17de2bb0f4accb34f2f48a2c39070416
@x0))
:qid interpretation_Tm_abs_17de2bb0f4accb34f2f48a2c39070416))

:named interpretation_Tm_abs_17de2bb0f4accb34f2f48a2c39070416))
...
(declare-fun Tm_abs_2b6bc9164ee5f4bd38b214e1ff8a50f8 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_2b6bc9164ee5f4bd38b214e1ff8a50f8
;;; Fact-ids: 
(assert (! (HasType Tm_abs_2b6bc9164ee5f4bd38b214e1ff8a50f8
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21)
:named typing_Tm_abs_2b6bc9164ee5f4bd38b214e1ff8a50f8))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2b6bc9164ee5f4bd38b214e1ff8a50f8
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,29-441,97); use=QuickTestNBE.fst(102,39-102,42)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_2b6bc9164ee5f4bd38b214e1ff8a50f8
@x0)
(Prims.l_and (Prims.eq2 Prims.int
(Prims.op_Subtraction (QuickTestNBE.f (BoxInt 5))
(QuickTestNBE.f (BoxInt 5)))
(BoxInt 0))
(Prims.l_Forall Prims.unit
(Tm_abs_0183a6394b823a6155719390faa84d4b @x0))))
 

:pattern ((ApplyTT Tm_abs_2b6bc9164ee5f4bd38b214e1ff8a50f8
@x0))
:qid interpretation_Tm_abs_2b6bc9164ee5f4bd38b214e1ff8a50f8))

:named interpretation_Tm_abs_2b6bc9164ee5f4bd38b214e1ff8a50f8))
...
(declare-fun Tm_abs_f0dd0e3bdd29bb942e87b897c66b101a () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_f0dd0e3bdd29bb942e87b897c66b101a
;;; Fact-ids: 
(assert (! (HasType Tm_abs_f0dd0e3bdd29bb942e87b897c66b101a
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21)
:named typing_Tm_abs_f0dd0e3bdd29bb942e87b897c66b101a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_f0dd0e3bdd29bb942e87b897c66b101a
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,29-441,97); use=QuickTestNBE.fst(103,39-103,42)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_f0dd0e3bdd29bb942e87b897c66b101a
@x0)
(Prims.l_and (Prims.eq2 Prims.int
(Prims.op_Subtraction (QuickTestNBE.f (BoxInt 6))
(QuickTestNBE.f (BoxInt 6)))
(BoxInt 0))
(Prims.l_Forall Prims.unit
(Tm_abs_0183a6394b823a6155719390faa84d4b @x0))))
 

:pattern ((ApplyTT Tm_abs_f0dd0e3bdd29bb942e87b897c66b101a
@x0))
:qid interpretation_Tm_abs_f0dd0e3bdd29bb942e87b897c66b101a))

:named interpretation_Tm_abs_f0dd0e3bdd29bb942e87b897c66b101a))
...
;   (forall (va_s: QuickTestNBE.vale_state).
;       (*  - Could not prove post-condition
; *)
;       Prims.auto_squash (Prims.pure_wp_monotonic Prims.unit
;             (fun p ->
;                 QuickTestNBE.f 4 - QuickTestNBE.f 4 == 0 /\
;                 (forall (pure_result: Prims.unit).
;                     (forall (i: Prims.int). {:pattern QuickTestNBE.f i} QuickTestNBE.f i > 0) ==>
;                     p pure_result))) /\
...
;           Prims.auto_squash (Prims.pure_wp_monotonic Prims.unit
;                 (fun p ->
;                     QuickTestNBE.f 5 - QuickTestNBE.f 5 == 0 /\
;                     (forall (pure_result: Prims.unit).
;                         (forall (i: Prims.int). {:pattern QuickTestNBE.f i} QuickTestNBE.f i > 0) ==>
;                         p pure_result))) /\
;           (forall (any_result: Prims.pure_wp Prims.unit).
...
;               Prims.auto_squash (Prims.pure_wp_monotonic Prims.unit
;                     (fun p ->
;                         QuickTestNBE.f 6 - QuickTestNBE.f 6 == 0 /\
;                         (forall (pure_result: Prims.unit).
;                             (forall (i: Prims.int). {:pattern QuickTestNBE.f i} QuickTestNBE.f i > 0
;                             ) ==>
;                             p pure_result))))))
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(441,36-441,97); use=QuickTestNBE.fst(98,2-98,15)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Prims.unit)

;; def=FStar.Pervasives.fsti(328,60-328,78); use=QuickTestNBE.fst(98,2-98,15)
(= Prims.pure_wp_monotonic0@tok
Prims.pure_wp_monotonic@tok)
)
(forall ((@x1 Term))
...
;; def=Prims.fst(459,77-459,89); use=QuickTestNBE.fst(101,6-105,7)
(and 
;; def=Prims.fst(339,38-339,60); use=QuickTestNBE.fst(101,39-101,42)
(or label_1
...
Tm_abs_17de2bb0f4accb34f2f48a2c39070416)
)
)


;; def=Prims.fst(451,66-451,102); use=QuickTestNBE.fst(101,6-105,7)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.pure_wp Prims.unit))

;; def=QuickTestNBE.fst(42,6-42,9); use=QuickTestNBE.fst(101,6-105,7)
(= Tm_abs_17de2bb0f4accb34f2f48a2c39070416
@x2)
)
...
;; def=Prims.fst(459,77-459,89); use=QuickTestNBE.fst(101,6-105,7)
(and 
;; def=Prims.fst(339,38-339,60); use=QuickTestNBE.fst(102,39-102,42)
(or label_2
...
;; def=Prims.fst(339,38-339,60); use=QuickTestNBE.fst(102,39-102,42)
(Prims.pure_wp_monotonic Prims.unit
Tm_abs_2b6bc9164ee5f4bd38b214e1ff8a50f8)
)
)
...
;; def=Prims.fst(339,38-339,60); use=QuickTestNBE.fst(103,39-103,42)
(or label_3
...
;; def=Prims.fst(339,38-339,60); use=QuickTestNBE.fst(103,39-103,42)
(Prims.pure_wp_monotonic Prims.unit
Tm_abs_f0dd0e3bdd29bb942e87b897c66b101a)
)
)
)
...
(declare-fun QuickTestNBE.va_qcode_Test (Dummy_sort) Term)

; </end encoding let va_qcode_Test>

(push) ;; push{2

; Starting query at QuickTestNBE.fst(109,2-112,34)
...
; Encoding query formula : forall (va_s0: QuickTestNBE.vale_state).
;   (*  - Could not prove post-condition
; *)
;   forall (ok: Prims.bool) (p: (_: Prims.unit -> Prims.GTot Type0)).
;     (forall (u300: Prims.unit). {:pattern Prims.guard_free (p u300)}
;         (forall (p: (_: Prims.unit -> Prims.GTot Type0)).
;             (forall (u303: Prims.unit). {:pattern Prims.guard_free (p u303)}
;                 (forall (p: (_: Prims.unit -> Prims.GTot Type0)).
;                     (forall (u306: Prims.unit). {:pattern Prims.guard_free (p u306)}
;                         Prims.auto_squash (p ())) ==>
...
;; def=QuickTestNBE.fst(77,9-77,18); use=QuickTestNBE.fst(77,9-77,18)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.bool)

;; def=QuickTestNBE.fst(57,14-57,36); use=QuickTestNBE.fst(57,14-57,36)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe)
...
;; def=QuickTestNBE.fst(58,16-58,24); use=QuickTestNBE.fst(58,16-58,24)
(forall ((@x7 Term))
 (! 
;; def=QuickTestNBE.fst(57,15-57,16); use=QuickTestNBE.fst(57,15-57,16)
(Valid 
;; def=QuickTestNBE.fst(57,15-57,16); use=QuickTestNBE.fst(57,15-57,16)
(ApplyTT @x6
Tm_unit)
...
;; def=Prims.fst(441,33-441,35); use=QuickTestNBE.fst(103,39-103,42)
(and 
;; def=QuickTestNBE.fst(91,22-91,24); use=QuickTestNBE(1,2-3,4)
(or label_1

;; def=QuickTestNBE.fst(91,22-91,24); use=QuickTestNBE.fst(91,22-91,24)
(= (Prims.op_Subtraction (QuickTestNBE.f (BoxInt 6))
(QuickTestNBE.f (BoxInt 6)))
(BoxInt 0))
)
...
;; def=Prims.fst(441,44-441,60); use=Prims.fst(441,44-441,60)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=QuickTestNBE.fst(92,19-92,26); use=QuickTestNBE.fst(92,19-92,26)
(forall ((@x8 Term))
 (! (implies (HasType @x8
Prims.int)

;; def=dummy(0,0-0,0); use=QuickTestNBE.fst(103,39-103,42)
(> (BoxInt_proj_0 (QuickTestNBE.f @x8))
(BoxInt_proj_0 (BoxInt 0)))
)
 

:pattern ((QuickTestNBE.f @x8))
:qid @query.9))
)

;; def=QuickTestNBE.fst(57,15-57,16); use=QuickTestNBE(1,2-3,4)
(or label_2
...
;; def=Prims.fst(441,33-441,35); use=QuickTestNBE.fst(102,39-102,42)
(and 
;; def=QuickTestNBE.fst(91,22-91,24); use=QuickTestNBE(1,2-3,4)
(or label_3
...
;; def=dummy(0,0-0,0); use=QuickTestNBE.fst(102,39-102,42)
(> (BoxInt_proj_0 (QuickTestNBE.f @x6))
(BoxInt_proj_0 (BoxInt 0)))
)
 

:pattern ((QuickTestNBE.f @x6))
:qid @query.11))
)
...
;; def=Prims.fst(441,33-441,35); use=QuickTestNBE.fst(101,39-101,42)
(and 
;; def=QuickTestNBE.fst(91,22-91,24); use=QuickTestNBE(1,2-3,4)
(or label_4
...
;; def=dummy(0,0-0,0); use=QuickTestNBE.fst(101,39-101,42)
(> (BoxInt_proj_0 (QuickTestNBE.f @x4))
(BoxInt_proj_0 (BoxInt 0)))
)
 

:pattern ((QuickTestNBE.f @x4))
:qid @query.13))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.va_lemma_Test, 1)
; STATUS: unsat
...
(declare-fun QuickTestNBE.va_lemma_Test (Term) Term)
;;;;;;;;;;;;;;;;va_s0: vale_state -> Prims.unit
(declare-fun Tm_arrow_40605629f4b8f770a885731eda63a368 () Term)
(declare-fun QuickTestNBE.va_lemma_Test@tok () Term)

; </end encoding let va_lemma_Test>


; encoding sigelt val QuickTestNBE.lem2


; <Start encoding val QuickTestNBE.lem2>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun QuickTestNBE.lem2 (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun QuickTestNBE.lem2@tok () Term)

; </end encoding val QuickTestNBE.lem2>

(push) ;; push{2

; Starting query at QuickTestNBE.fst(120,0-127,3)
...
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(117,22-117,25); use=QuickTestNBE.fst(124,6-126,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
...
;;; Fact-ids: 
(assert (! 
;; def=QuickTestNBE.fst(117,11-117,50); use=QuickTestNBE.fst(124,39-124,43)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_764eef756ddbfdcb7eed5b4345a35bc3
@x0)
(Prims.b2t (Prims.op_GreaterThan (QuickTestNBE.f @x0)
...
;; def=QuickTestNBE.fst(117,42-117,49); use=QuickTestNBE.fst(124,39-124,43)
(> (BoxInt_proj_0 (QuickTestNBE.f @x0))
(BoxInt_proj_0 (BoxInt 0)))
)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,36-441,97); use=QuickTestNBE.fst(124,39-124,43)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_0183a6394b823a6155719390faa84d4b @x0)
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe)
...
;; def=Prims.fst(441,83-441,96); use=QuickTestNBE.fst(124,39-124,43)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickTestNBE.fst(124,39-124,43)
(ApplyTT @x0
@x1)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(188,39-441,24); use=QuickTestNBE.fst(124,39-124,43)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21)
...
:named QuickTestNBE_interpretation_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))
(declare-fun Tm_abs_65576f223b9f28958f7512067494db64 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_65576f223b9f28958f7512067494db64
;;; Fact-ids: 
(assert (! (HasType Tm_abs_65576f223b9f28958f7512067494db64
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21)
:named typing_Tm_abs_65576f223b9f28958f7512067494db64))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_65576f223b9f28958f7512067494db64
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,29-441,97); use=QuickTestNBE.fst(124,39-124,43)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_65576f223b9f28958f7512067494db64
@x0)
...
:pattern ((ApplyTT Tm_abs_65576f223b9f28958f7512067494db64
@x0))
:qid interpretation_Tm_abs_65576f223b9f28958f7512067494db64))

:named interpretation_Tm_abs_65576f223b9f28958f7512067494db64))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
Prims.pure_wp_monotonic0@tok))
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(441,36-441,97); use=QuickTestNBE.fst(121,2-121,15)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Prims.unit)

;; def=FStar.Pervasives.fsti(328,60-328,78); use=QuickTestNBE.fst(121,2-121,15)
(= Prims.pure_wp_monotonic0@tok
Prims.pure_wp_monotonic@tok)
)
(forall ((@x1 Term))
...
;; def=Prims.fst(339,38-339,60); use=QuickTestNBE.fst(124,39-124,43)
(or label_1
...
;; def=Prims.fst(339,38-339,60); use=QuickTestNBE.fst(124,39-124,43)
(Prims.pure_wp_monotonic Prims.unit
Tm_abs_65576f223b9f28958f7512067494db64)
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.va_qcode_Test2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, Prims_pretyping_f8666440faa91836cc5a13998af863fc, eq2-interp, equation_Prims.pure_wp_monotonic0, function_token_typing_Prims.__cache_version_number__, function_token_typing_Prims.pure_wp_monotonic, int_typing, interpretation_Tm_abs_65576f223b9f28958f7512067494db64, l_and-interp, l_quant_interp_0c168580a82b5ed0782124081acd3faa, projection_inverse_BoxInt_proj_0, token_correspondence_Prims.pure_wp_monotonic0, unit_typing
...
(declare-fun QuickTestNBE.va_qcode_Test2 (Dummy_sort) Term)
...
; Starting query at QuickTestNBE.fst(131,2-134,34)
...
; *)
;   forall (ok: Prims.bool) (p: (_: Prims.unit -> Prims.GTot Type0)).
;     (forall (u195: Prims.unit). {:pattern Prims.guard_free (p u195)} Prims.auto_squash (p ())) ==>
;     FStar.Range.labeled (FStar.Sealed.seal QuickTestNBE(1,2-3,4))
;       ""
;       (QuickTestNBE.f 4 - QuickTestNBE.f 4 == 0 /\ QuickTestNBE.f 4 == 0 /\
;         (forall (pure_result: Prims.unit).
...
;; def=Prims.fst(441,33-441,35); use=QuickTestNBE.fst(124,39-124,43)
(and 
;; def=QuickTestNBE.fst(115,22-115,24); use=QuickTestNBE(1,2-3,4)
(or label_1

;; def=QuickTestNBE.fst(115,22-115,24); use=QuickTestNBE.fst(115,22-115,24)
(= (Prims.op_Subtraction (QuickTestNBE.f (BoxInt 4))
(QuickTestNBE.f (BoxInt 4)))
(BoxInt 0))
)
...
;; def=QuickTestNBE.fst(116,16-116,18); use=QuickTestNBE(1,2-3,4)
(or label_2

;; def=QuickTestNBE.fst(116,16-116,18); use=QuickTestNBE.fst(116,16-116,18)
(= (QuickTestNBE.f (BoxInt 4))
(BoxInt 0))
)
...
;; def=QuickTestNBE.fst(117,19-117,26); use=QuickTestNBE.fst(117,19-117,26)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.int)

;; def=dummy(0,0-0,0); use=QuickTestNBE.fst(124,39-124,43)
(> (BoxInt_proj_0 (QuickTestNBE.f @x4))
(BoxInt_proj_0 (BoxInt 0)))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickTestNBE.va_lemma_Test2, 1)
