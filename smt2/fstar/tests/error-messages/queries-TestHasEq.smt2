...
; encoding sigelt type TestHasEq.mlist


; <Start encoding type TestHasEq.mlist>

;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.mlist (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun TestHasEq.mlist@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.nlist (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun TestHasEq.nlist@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.MNil (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.MNil_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.MNil
(declare-fun TestHasEq.MNil@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.MCons (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.MCons_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.MCons_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.MCons_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.MCons
(declare-fun TestHasEq.MCons@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.NNil (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.NNil_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.NNil
(declare-fun TestHasEq.NNil@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.NCons (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.NCons_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.NCons_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.NCons_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.NCons
(declare-fun TestHasEq.NCons@tok () Term)
;;;;;;;;;;;;;;;;mlist a
(declare-fun Tm_arrow_233f08faf0f4c18b06dd02d0e08461b2 () Term)
;;;;;;;;;;;;;;;;hd: a -> tl: nlist a -> mlist a
(declare-fun Tm_arrow_6cd765963ff7789e8f45ac2ebd0eeb5e () Term)
;;;;;;;;;;;;;;;;nlist a
(declare-fun Tm_arrow_c7e25a23a11a95ee3b6ecd0dcd62c309 () Term)
;;;;;;;;;;;;;;;;hd: a -> tl: mlist a -> nlist a
(declare-fun Tm_arrow_b73c62172246baa64ab56698a63fb546 () Term)

; <start constructor TestHasEq.mlist>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.mlist ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
136)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-TestHasEq.mlist))))

; </end constructor TestHasEq.mlist>


; <start constructor TestHasEq.nlist>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.nlist ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
142)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-TestHasEq.nlist))))

; </end constructor TestHasEq.nlist>


; <start constructor TestHasEq.MNil>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.MNil ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
149)
(= __@x0
(TestHasEq.MNil (TestHasEq.MNil_a __@x0)))))

; </end constructor TestHasEq.MNil>


; <start constructor TestHasEq.MCons>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.MCons ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
154)
(= __@x0
(TestHasEq.MCons (TestHasEq.MCons_a __@x0)
(TestHasEq.MCons_hd __@x0)
(TestHasEq.MCons_tl __@x0)))))

; </end constructor TestHasEq.MCons>


; <start constructor TestHasEq.NNil>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.NNil ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
159)
(= __@x0
(TestHasEq.NNil (TestHasEq.NNil_a __@x0)))))

; </end constructor TestHasEq.NNil>


; <start constructor TestHasEq.NCons>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.NCons ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
164)
(= __@x0
(TestHasEq.NCons (TestHasEq.NCons_a __@x0)
(TestHasEq.NCons_hd __@x0)
(TestHasEq.NCons_tl __@x0)))))

; </end constructor TestHasEq.NCons>


; </end encoding type TestHasEq.mlist>
...
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(22,4-22,9); use=TestHasEq.fst(22,4-22,9)
(forall ((@x0 Term))
 (! (= (ApplyTT TestHasEq.nlist@tok
@x0)
(TestHasEq.nlist @x0))
 

:pattern ((ApplyTT TestHasEq.nlist@tok
@x0))

:pattern ((TestHasEq.nlist @x0))
:qid token_correspondence_TestHasEq.nlist@tok))

:named token_correspondence_TestHasEq.nlist@tok))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(18,5-18,10); use=TestHasEq.fst(18,5-18,10)
(forall ((@x0 Term))
 (! (= (ApplyTT TestHasEq.mlist@tok
@x0)
(TestHasEq.mlist @x0))
 

:pattern ((ApplyTT TestHasEq.mlist@tok
@x0))

:pattern ((TestHasEq.mlist @x0))
:qid token_correspondence_TestHasEq.mlist@tok))

:named token_correspondence_TestHasEq.mlist@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
...
@x3)
(TestHasEq.nlist @x4)))
:qid subterm_ordering_TestHasEq.NCons))

:named subterm_ordering_TestHasEq.NCons))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(TestHasEq.MCons @x1
@x2
...
@x3)
(TestHasEq.mlist @x4)))
:qid subterm_ordering_TestHasEq.MCons))

:named subterm_ordering_TestHasEq.MCons))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(23,4-23,8); use=TestHasEq.fst(23,4-23,8)
(forall ((@x0 Term))
 (! (= (TestHasEq.NNil_a (TestHasEq.NNil @x0))
@x0)
 

:pattern ((TestHasEq.NNil @x0))
:qid projection_inverse_TestHasEq.NNil_a))

:named projection_inverse_TestHasEq.NNil_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (TestHasEq.NCons_tl (TestHasEq.NCons @x0
@x1
@x2))
@x2)
 

:pattern ((TestHasEq.NCons @x0
@x1
@x2))
:qid projection_inverse_TestHasEq.NCons_tl))

:named projection_inverse_TestHasEq.NCons_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (TestHasEq.NCons_hd (TestHasEq.NCons @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_TestHasEq.NCons_hd))

:named projection_inverse_TestHasEq.NCons_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (TestHasEq.NCons_a (TestHasEq.NCons @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_TestHasEq.NCons_a))

:named projection_inverse_TestHasEq.NCons_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(19,4-19,8); use=TestHasEq.fst(19,4-19,8)
(forall ((@x0 Term))
 (! (= (TestHasEq.MNil_a (TestHasEq.MNil @x0))
@x0)
 

:pattern ((TestHasEq.MNil @x0))
:qid projection_inverse_TestHasEq.MNil_a))

:named projection_inverse_TestHasEq.MNil_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (TestHasEq.MCons_tl (TestHasEq.MCons @x0
@x1
@x2))
@x2)
 

:pattern ((TestHasEq.MCons @x0
@x1
@x2))
:qid projection_inverse_TestHasEq.MCons_tl))

:named projection_inverse_TestHasEq.MCons_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (TestHasEq.MCons_hd (TestHasEq.MCons @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_TestHasEq.MCons_hd))

:named projection_inverse_TestHasEq.MCons_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (TestHasEq.MCons_a (TestHasEq.MCons @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_TestHasEq.MCons_a))

:named projection_inverse_TestHasEq.MCons_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! (is-Tm_arrow (PreType TestHasEq.nlist@tok))
:named pre_kinding_TestHasEq.nlist@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! (is-Tm_arrow (PreType TestHasEq.mlist@tok))
:named pre_kinding_TestHasEq.mlist@tok))
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! (and (IsTotFun TestHasEq.nlist@tok)

;; def=TestHasEq.fst(22,4-22,9); use=TestHasEq.fst(22,4-22,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (TestHasEq.nlist @x0)
Tm_type))
 

:pattern ((TestHasEq.nlist @x0))
:qid kinding_TestHasEq.nlist@tok))
)
:named kinding_TestHasEq.nlist@tok))
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! (and (IsTotFun TestHasEq.mlist@tok)

;; def=TestHasEq.fst(18,5-18,10); use=TestHasEq.fst(18,5-18,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (TestHasEq.mlist @x0)
Tm_type))
 

:pattern ((TestHasEq.mlist @x0))
:qid kinding_TestHasEq.mlist@tok))
)
:named kinding_TestHasEq.mlist@tok))
...
@x1
(TestHasEq.nlist @x2))
(or (and (is-TestHasEq.NNil @x1)
(= @x2
(TestHasEq.NNil_a @x1)))
(and (is-TestHasEq.NCons @x1)
(= @x2
(TestHasEq.NCons_a @x1)))))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
(TestHasEq.nlist @x2)))
:qid fuel_guarded_inversion_TestHasEq.nlist))

:named fuel_guarded_inversion_TestHasEq.nlist))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(18,5-18,10); use=TestHasEq.fst(18,5-18,10)
...
@x1
(TestHasEq.mlist @x2))
(or (and (is-TestHasEq.MNil @x1)
(= @x2
(TestHasEq.MNil_a @x1)))
(and (is-TestHasEq.MCons @x1)
(= @x2
(TestHasEq.MCons_a @x1)))))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
(TestHasEq.mlist @x2)))
:qid fuel_guarded_inversion_TestHasEq.mlist))

:named fuel_guarded_inversion_TestHasEq.mlist))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! (= 143
(Term_constr_id TestHasEq.nlist@tok))
:named fresh_token_TestHasEq.nlist@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! (= 137
(Term_constr_id TestHasEq.mlist@tok))
:named fresh_token_TestHasEq.mlist@tok))
...
(TestHasEq.NNil @x1)
(TestHasEq.nlist @x1)))
:qid data_typing_intro_TestHasEq.NNil@tok))

:named data_typing_intro_TestHasEq.NNil@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
...
@x3)
(TestHasEq.nlist @x1)))
:qid data_typing_intro_TestHasEq.NCons@tok))

:named data_typing_intro_TestHasEq.NCons@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(19,4-19,8); use=TestHasEq.fst(19,4-19,8)
...
(TestHasEq.MNil @x1)
(TestHasEq.mlist @x1)))
:qid data_typing_intro_TestHasEq.MNil@tok))

:named data_typing_intro_TestHasEq.MNil@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
...
@x3)
(TestHasEq.mlist @x1)))
:qid data_typing_intro_TestHasEq.MCons@tok))

:named data_typing_intro_TestHasEq.MCons@tok))
...
(TestHasEq.NNil @x1)
(TestHasEq.nlist @x2)))
:qid data_elim_TestHasEq.NNil))

:named data_elim_TestHasEq.NNil))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
...
@x3)
(TestHasEq.nlist @x4)))
:qid data_elim_TestHasEq.NCons))

:named data_elim_TestHasEq.NCons))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(19,4-19,8); use=TestHasEq.fst(19,4-19,8)
...
(TestHasEq.MNil @x1)
(TestHasEq.mlist @x2)))
:qid data_elim_TestHasEq.MNil))

:named data_elim_TestHasEq.MNil))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
...
@x3)
(TestHasEq.mlist @x4)))
:qid data_elim_TestHasEq.MCons))

:named data_elim_TestHasEq.MCons))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(22,4-22,9); use=TestHasEq.fst(22,4-22,9)
(forall ((@x0 Term))
 (! (= 142
(Term_constr_id (TestHasEq.nlist @x0)))
 

:pattern ((TestHasEq.nlist @x0))
:qid constructor_distinct_TestHasEq.nlist))

:named constructor_distinct_TestHasEq.nlist))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(18,5-18,10); use=TestHasEq.fst(18,5-18,10)
(forall ((@x0 Term))
 (! (= 136
(Term_constr_id (TestHasEq.mlist @x0)))
 

:pattern ((TestHasEq.mlist @x0))
:qid constructor_distinct_TestHasEq.mlist))

:named constructor_distinct_TestHasEq.mlist))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(23,4-23,8); use=TestHasEq.fst(23,4-23,8)
(forall ((@x0 Term))
 (! (= 159
(Term_constr_id (TestHasEq.NNil @x0)))
 

:pattern ((TestHasEq.NNil @x0))
:qid constructor_distinct_TestHasEq.NNil))

:named constructor_distinct_TestHasEq.NNil))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 164
(Term_constr_id (TestHasEq.NCons @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_TestHasEq.NCons))

:named constructor_distinct_TestHasEq.NCons))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(19,4-19,8); use=TestHasEq.fst(19,4-19,8)
(forall ((@x0 Term))
 (! (= 149
(Term_constr_id (TestHasEq.MNil @x0)))
 

:pattern ((TestHasEq.MNil @x0))
:qid constructor_distinct_TestHasEq.MNil))

:named constructor_distinct_TestHasEq.MNil))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 154
(Term_constr_id (TestHasEq.MCons @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_TestHasEq.MCons))

:named constructor_distinct_TestHasEq.MCons))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
@x0
(TestHasEq.nlist @x2)))
:qid TestHasEq_pretyping_faa2f712094e24a1525172d5344b1882))

:named TestHasEq_pretyping_faa2f712094e24a1525172d5344b1882))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(18,5-18,10); use=TestHasEq.fst(18,5-18,10)
...
@x0
(TestHasEq.mlist @x2)))
:qid TestHasEq_pretyping_dcafca60d36214d1c4b90f061677fdf1))

:named TestHasEq_pretyping_dcafca60d36214d1c4b90f061677fdf1))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
; Starting query at TestHasEq.fst(18,0-24,40)
...
;   Prims.hasEq a /\
;   (forall (a: Type). {:pattern Prims.hasEq (TestHasEq.mlist a)}
;       Prims.hasEq a ==> Prims.hasEq (TestHasEq.mlist a)) /\
;   Prims.hasEq a /\
;   (forall (a: Type). {:pattern Prims.hasEq (TestHasEq.nlist a)}
;       Prims.hasEq a ==> Prims.hasEq (TestHasEq.nlist a)) ==>
;   (forall (hd: a) (tl: TestHasEq.nlist a). Prims.hasEq a /\ Prims.hasEq (TestHasEq.nlist a)) /\
;   (forall (hd: a) (tl: TestHasEq.mlist a). Prims.hasEq a /\ Prims.hasEq (TestHasEq.mlist a))


; Context: While encoding a query
; While typechecking the top-level declaration `type TestHasEq.mlist`
...
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(18,0-24,40)
(Valid 
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(18,0-24,40)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(18,0-24,40)
(Prims.hasEq (TestHasEq.mlist @x2))
)
)
 

:pattern ((Prims.hasEq (TestHasEq.mlist @x2)))
:qid @query.1))
...
(Valid 
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(18,0-24,40)
(Prims.hasEq (TestHasEq.nlist @x2))
)
)
 

:pattern ((Prims.hasEq (TestHasEq.nlist @x2)))
:qid @query.2))
)
...
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(18,0-24,40)
(and 
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(20,14-20,15)
(or label_1
...
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(20,22-20,29)
(or label_2

;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(18,0-24,40)
(Valid 
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(18,0-24,40)
(Prims.hasEq (TestHasEq.nlist @x0))
)
)
)
)
...
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(18,0-24,40)
(and 
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(24,14-24,15)
(or label_3
...
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(24,22-24,29)
(or label_4

;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(18,0-24,40)
(Valid 
;; def=TestHasEq.fst(18,0-24,40); use=TestHasEq.fst(18,0-24,40)
(Prims.hasEq (TestHasEq.mlist @x1))
)
)
)
)
...
; encoding sigelt assume TestHasEq.mlist__uu___haseq


; <Start encoding assume TestHasEq.mlist__uu___haseq>


; </end encoding assume TestHasEq.mlist__uu___haseq>


; encoding sigelt assume TestHasEq.nlist__uu___haseq


; <Start encoding assume TestHasEq.nlist__uu___haseq>


; </end encoding assume TestHasEq.nlist__uu___haseq>


; encoding sigelt val TestHasEq.uu___is_MNil


; <Start encoding val TestHasEq.uu___is_MNil>

(declare-fun TestHasEq.uu___is_MNil (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: mlist a -> Prims.bool
(declare-fun Tm_arrow_dc6abf21a4f52ed5d5bb672bfad0b26c () Term)
(declare-fun TestHasEq.uu___is_MNil@tok () Term)

; </end encoding val TestHasEq.uu___is_MNil>


; encoding sigelt let uu___is_MNil


; <Skipped let uu___is_MNil/>


; encoding sigelt val TestHasEq.uu___is_MCons


; <Start encoding val TestHasEq.uu___is_MCons>

(declare-fun TestHasEq.uu___is_MCons (Term Term) Term)

(declare-fun TestHasEq.uu___is_MCons@tok () Term)

; </end encoding val TestHasEq.uu___is_MCons>


; encoding sigelt let uu___is_MCons


; <Skipped let uu___is_MCons/>


; encoding sigelt val TestHasEq.__proj__MCons__item__hd


; <Start encoding val TestHasEq.__proj__MCons__item__hd>

(declare-fun Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5 (Term) Term)
(declare-fun TestHasEq.__proj__MCons__item__hd (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: mlist a {MCons? _} -> a
(declare-fun Tm_arrow_0d73be41aa1a19300bb85d4fe45839fe () Term)
(declare-fun TestHasEq.__proj__MCons__item__hd@tok () Term)

; </end encoding val TestHasEq.__proj__MCons__item__hd>
...
:named unit_inversion))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name TestHasEq.uu___is_MCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(TestHasEq.mlist @x0)))
(HasType (TestHasEq.uu___is_MCons @x0
@x1)
Prims.bool))
 

:pattern ((TestHasEq.uu___is_MCons @x0
@x1))
:qid typing_TestHasEq.uu___is_MCons))

:named typing_TestHasEq.uu___is_MCons))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
:named refinement_kinding_Tm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name TestHasEq.__proj__MCons__item__hd; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5))

:named refinement_kinding_Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(772,26-772,42); use=FStar.Pervasives.fsti(772,26-772,42)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5 @x2))
(and (HasTypeFuel @u0
@x1
(TestHasEq.mlist @x2))

;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
(BoxBool_proj_0 (TestHasEq.uu___is_MCons @x2
@x1))
))
...
@x1
(Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5 @x2)))
:qid refinement_interpretation_Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5))

:named refinement_interpretation_Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(23,4-23,8); use=TestHasEq.fst(23,4-23,8)
...
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5
;;; Fact-ids: Name TestHasEq.__proj__MCons__item__hd; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5 @x0)))
(Valid (Prims.hasEq (TestHasEq.mlist @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5 @x0))))
:qid haseqTm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5))

:named haseqTm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,4-20,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (TestHasEq.uu___is_MCons @x0
@x1)
(BoxBool (is-TestHasEq.MCons @x1)))
 

:pattern ((TestHasEq.uu___is_MCons @x0
@x1))
:qid disc_equation_TestHasEq.MCons))

:named disc_equation_TestHasEq.MCons))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: TestHasEq.nlist__uu___haseq
;;; Fact-ids: Name TestHasEq.nlist__uu___haseq; Namespace TestHasEq
(assert (! (forall ((@x0 Term))
 (! (implies (and (HasType @x0
Tm_type)
(Valid (Prims.hasEq @x0)))
(Valid (Prims.hasEq (TestHasEq.nlist @x0))))
 

:pattern ((Prims.hasEq (TestHasEq.nlist @x0)))
:qid assumption_TestHasEq.nlist__uu___haseq))
:named assumption_TestHasEq.nlist__uu___haseq))
;;;;;;;;;;;;;;;;Assumption: TestHasEq.mlist__uu___haseq
;;; Fact-ids: Name TestHasEq.mlist__uu___haseq; Namespace TestHasEq
(assert (! (forall ((@x0 Term))
 (! (implies (and (HasType @x0
Tm_type)
(Valid (Prims.hasEq @x0)))
...
:pattern ((Prims.hasEq (TestHasEq.mlist @x0)))
:qid assumption_TestHasEq.mlist__uu___haseq))
:named assumption_TestHasEq.mlist__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name TestHasEq.mlist; Namespace TestHasEq; Name TestHasEq.MNil; Namespace TestHasEq; Name TestHasEq.MCons; Namespace TestHasEq; Name TestHasEq.nlist; Namespace TestHasEq; Name TestHasEq.NNil; Namespace TestHasEq; Name TestHasEq.NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(22,4-22,9); use=TestHasEq.fst(22,4-22,9)
...
; Starting query at TestHasEq.fst(20,11-20,13)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (projectee: _: TestHasEq.mlist a {MCons? _}).
;   (*  - Could not prove post-condition
; *) ~(MCons? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__MCons__item__hd`
...
Tm_type)
(HasType @x1
(Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5 @x0))

;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,11-20,13)
(not 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,11-20,13)
(BoxBool_proj_0 (TestHasEq.uu___is_MCons @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestHasEq.__proj__MCons__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5
...
; encoding sigelt let __proj__MCons__item__hd


; <Skipped let __proj__MCons__item__hd/>


; encoding sigelt val TestHasEq.__proj__MCons__item__tl


; <Start encoding val TestHasEq.__proj__MCons__item__tl>


(declare-fun TestHasEq.__proj__MCons__item__tl (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: mlist a {MCons? _} -> nlist a
(declare-fun Tm_arrow_21ee82ff0adf201d6f315861275dff8f () Term)
(declare-fun TestHasEq.__proj__MCons__item__tl@tok () Term)

; </end encoding val TestHasEq.__proj__MCons__item__tl>

(push) ;; push{2

; Starting query at TestHasEq.fst(20,19-20,21)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__MCons__item__tl`
...
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,19-20,21)
(not 
;; def=TestHasEq.fst(20,4-20,9); use=TestHasEq.fst(20,19-20,21)
(BoxBool_proj_0 (TestHasEq.uu___is_MCons @x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestHasEq.__proj__MCons__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_04c57beb84c7e65ffbf87f2b1dfc7ef5
...
; encoding sigelt let __proj__MCons__item__tl


; <Skipped let __proj__MCons__item__tl/>


; encoding sigelt val TestHasEq.uu___is_NNil


; <Start encoding val TestHasEq.uu___is_NNil>

(declare-fun TestHasEq.uu___is_NNil (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: nlist a -> Prims.bool
(declare-fun Tm_arrow_2b71f3e6957a9fb4cfd7d8dba3f13e83 () Term)
(declare-fun TestHasEq.uu___is_NNil@tok () Term)

; </end encoding val TestHasEq.uu___is_NNil>


; encoding sigelt let uu___is_NNil


; <Skipped let uu___is_NNil/>


; encoding sigelt val TestHasEq.uu___is_NCons


; <Start encoding val TestHasEq.uu___is_NCons>

(declare-fun TestHasEq.uu___is_NCons (Term Term) Term)

(declare-fun TestHasEq.uu___is_NCons@tok () Term)

; </end encoding val TestHasEq.uu___is_NCons>


; encoding sigelt let uu___is_NCons


; <Skipped let uu___is_NCons/>


; encoding sigelt val TestHasEq.__proj__NCons__item__hd


; <Start encoding val TestHasEq.__proj__NCons__item__hd>

(declare-fun Tm_refine_7b907b210749d62a64a384804262b9e4 (Term) Term)
(declare-fun TestHasEq.__proj__NCons__item__hd (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: nlist a {NCons? _} -> a
(declare-fun Tm_arrow_641aeb8ced9e2a0c1327bc71e7e36736 () Term)
(declare-fun TestHasEq.__proj__NCons__item__hd@tok () Term)

; </end encoding val TestHasEq.__proj__NCons__item__hd>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name TestHasEq.uu___is_NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(TestHasEq.nlist @x0)))
(HasType (TestHasEq.uu___is_NCons @x0
@x1)
Prims.bool))
 

:pattern ((TestHasEq.uu___is_NCons @x0
@x1))
:qid typing_TestHasEq.uu___is_NCons))

:named typing_TestHasEq.uu___is_NCons))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name TestHasEq.__proj__NCons__item__hd; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_7b907b210749d62a64a384804262b9e4 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_7b907b210749d62a64a384804262b9e4 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_7b907b210749d62a64a384804262b9e4))

:named refinement_kinding_Tm_refine_7b907b210749d62a64a384804262b9e4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name TestHasEq.__proj__NCons__item__hd; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7b907b210749d62a64a384804262b9e4 @x2))
(and (HasTypeFuel @u0
@x1
(TestHasEq.nlist @x2))

;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
(BoxBool_proj_0 (TestHasEq.uu___is_NCons @x2
@x1))
))
...
@x1
(Tm_refine_7b907b210749d62a64a384804262b9e4 @x2)))
:qid refinement_interpretation_Tm_refine_7b907b210749d62a64a384804262b9e4))

:named refinement_interpretation_Tm_refine_7b907b210749d62a64a384804262b9e4))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7b907b210749d62a64a384804262b9e4
;;; Fact-ids: Name TestHasEq.__proj__NCons__item__hd; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7b907b210749d62a64a384804262b9e4 @x0)))
(Valid (Prims.hasEq (TestHasEq.nlist @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7b907b210749d62a64a384804262b9e4 @x0))))
:qid haseqTm_refine_7b907b210749d62a64a384804262b9e4))

:named haseqTm_refine_7b907b210749d62a64a384804262b9e4))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name TestHasEq.uu___is_NCons; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,4-24,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (TestHasEq.uu___is_NCons @x0
@x1)
(BoxBool (is-TestHasEq.NCons @x1)))
 

:pattern ((TestHasEq.uu___is_NCons @x0
@x1))
:qid disc_equation_TestHasEq.NCons))

:named disc_equation_TestHasEq.NCons))
(push) ;; push{2

; Starting query at TestHasEq.fst(24,11-24,13)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (projectee: _: TestHasEq.nlist a {NCons? _}).
;   (*  - Could not prove post-condition
; *) ~(NCons? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__NCons__item__hd`
...
Tm_type)
(HasType @x1
(Tm_refine_7b907b210749d62a64a384804262b9e4 @x0))

;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,11-24,13)
(not 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,11-24,13)
(BoxBool_proj_0 (TestHasEq.uu___is_NCons @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestHasEq.__proj__NCons__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_7b907b210749d62a64a384804262b9e4
...
; encoding sigelt let __proj__NCons__item__hd


; <Skipped let __proj__NCons__item__hd/>


; encoding sigelt val TestHasEq.__proj__NCons__item__tl


; <Start encoding val TestHasEq.__proj__NCons__item__tl>


(declare-fun TestHasEq.__proj__NCons__item__tl (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: nlist a {NCons? _} -> mlist a
(declare-fun Tm_arrow_94b74002779d68b2bf221b21871f72c7 () Term)
(declare-fun TestHasEq.__proj__NCons__item__tl@tok () Term)

; </end encoding val TestHasEq.__proj__NCons__item__tl>

(push) ;; push{2

; Starting query at TestHasEq.fst(24,19-24,21)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__NCons__item__tl`
...
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,19-24,21)
(not 
;; def=TestHasEq.fst(24,4-24,9); use=TestHasEq.fst(24,19-24,21)
(BoxBool_proj_0 (TestHasEq.uu___is_NCons @x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestHasEq.__proj__NCons__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_7b907b210749d62a64a384804262b9e4
...
; encoding sigelt let __proj__NCons__item__tl


; <Skipped let __proj__NCons__item__tl/>
...
; Starting query at TestHasEq.fst(26,14-26,61)
...
;   (*  - Could not prove post-condition
; *)
;   Prims.hasEq (TestHasEq.mlist Prims.nat) /\ Prims.hasEq (TestHasEq.nlist Prims.nat)
...
;; def=TestHasEq.fst(26,21-26,61); use=TestHasEq.fst(26,21-26,61)
(and 
;; def=TestHasEq.fst(26,22-26,39); use=TestHasEq.fst(26,22-26,39)
(or label_1

;; def=TestHasEq.fst(26,22-26,39); use=TestHasEq.fst(26,22-26,39)
(Valid 
;; def=TestHasEq.fst(26,22-26,39); use=TestHasEq.fst(26,22-26,39)
(Prims.hasEq (TestHasEq.mlist Prims.nat))
)
)


;; def=TestHasEq.fst(26,43-26,60); use=TestHasEq.fst(26,43-26,60)
(or label_2

;; def=TestHasEq.fst(26,43-26,60); use=TestHasEq.fst(26,43-26,60)
(Valid 
;; def=TestHasEq.fst(26,43-26,60); use=TestHasEq.fst(26,43-26,60)
(Prims.hasEq (TestHasEq.nlist Prims.nat))
)
)
)
)
...
(declare-fun TestHasEq.test1 (Term Term) Term)

(declare-fun TestHasEq.test1@tok () Term)

; </end encoding let test1>


; encoding sigelt type TestHasEq.t


; <Start encoding type TestHasEq.t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.t (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun TestHasEq.t@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.C (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C_x (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C_y (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.C
(declare-fun TestHasEq.C@tok () Term)



;;;;;;;;;;;;;;;;x: a -> y: b x -> t a b
(declare-fun Tm_arrow_823fec0c507ac916d2cf80211a9d8b40 () Term)

; <start constructor TestHasEq.t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
232)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
; </end constructor TestHasEq.t>


; <start constructor TestHasEq.C>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.C ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
241)
(= __@x0
(TestHasEq.C (TestHasEq.C_a __@x0)
(TestHasEq.C_b __@x0)
(TestHasEq.C_x __@x0)
(TestHasEq.C_y __@x0)))))

; </end constructor TestHasEq.C>


; </end encoding type TestHasEq.t>


; encoding sigelt assume TestHasEq.t__uu___haseq


; <Start encoding assume TestHasEq.t__uu___haseq>



; </end encoding assume TestHasEq.t__uu___haseq>


; encoding sigelt val TestHasEq.uu___is_C


; <Start encoding val TestHasEq.uu___is_C>


(declare-fun TestHasEq.uu___is_C (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: t a b -> Prims.bool
(declare-fun Tm_arrow_fd734c67d8c6295ecf29ff0eddc426f1 () Term)
(declare-fun TestHasEq.uu___is_C@tok () Term)

; </end encoding val TestHasEq.uu___is_C>
...
; encoding sigelt val TestHasEq.__proj__C__item__x


; <Start encoding val TestHasEq.__proj__C__item__x>


(declare-fun TestHasEq.__proj__C__item__x (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: t a b -> a
(declare-fun Tm_arrow_0dd336bd59eb41894af967dd6403d676 () Term)
(declare-fun TestHasEq.__proj__C__item__x@tok () Term)

; </end encoding val TestHasEq.__proj__C__item__x>
...
; encoding sigelt val TestHasEq.__proj__C__item__y


; <Start encoding val TestHasEq.__proj__C__item__y>


(declare-fun TestHasEq.__proj__C__item__y (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: t a b -> b projectee.x
(declare-fun Tm_arrow_b8bb4d37953ff755f6d5a059b7775096 () Term)
(declare-fun TestHasEq.__proj__C__item__y@tok () Term)

; </end encoding val TestHasEq.__proj__C__item__y>


; encoding sigelt let __proj__C__item__y


; <Skipped let __proj__C__item__y/>

;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(36,13-36,14); use=TestHasEq.fst(36,13-36,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT TestHasEq.t@tok
@x0)
@x1)
(TestHasEq.t @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT TestHasEq.t@tok
@x0)
@x1))

:pattern ((TestHasEq.t @x0
@x1))
:qid token_correspondence_TestHasEq.t@tok))

:named token_correspondence_TestHasEq.t@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(37,4-37,5); use=TestHasEq.fst(37,4-37,5)
...
(TestHasEq.t @x5
@x6)))
:qid subterm_ordering_TestHasEq.C))

:named subterm_ordering_TestHasEq.C))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(37,4-37,5); use=TestHasEq.fst(37,4-37,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (TestHasEq.C_y (TestHasEq.C @x0
@x1
@x2
@x3))
@x3)
...
:pattern ((TestHasEq.C @x0
@x1
@x2
@x3))
:qid projection_inverse_TestHasEq.C_y))

:named projection_inverse_TestHasEq.C_y))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(37,4-37,5); use=TestHasEq.fst(37,4-37,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (TestHasEq.C_x (TestHasEq.C @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_TestHasEq.C_x))

:named projection_inverse_TestHasEq.C_x))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(37,4-37,5); use=TestHasEq.fst(37,4-37,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (TestHasEq.C_b (TestHasEq.C @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_TestHasEq.C_b))

:named projection_inverse_TestHasEq.C_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(37,4-37,5); use=TestHasEq.fst(37,4-37,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (TestHasEq.C_a (TestHasEq.C @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_TestHasEq.C_a))

:named projection_inverse_TestHasEq.C_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! (is-Tm_arrow (PreType TestHasEq.t@tok))
:named pre_kinding_TestHasEq.t@tok))
...
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! (and (IsTotFun TestHasEq.t@tok)

;; def=TestHasEq.fst(36,13-36,14); use=TestHasEq.fst(36,13-36,14)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT TestHasEq.t@tok
@x0))
 

:pattern ((ApplyTT TestHasEq.t@tok
@x0))
:qid kinding_TestHasEq.t@tok))
...
:pattern ((TestHasEq.t @x0
@x1))
:qid kinding_TestHasEq.t@tok.1))
)
:named kinding_TestHasEq.t@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(36,13-36,14); use=TestHasEq.fst(36,13-36,14)
...
(TestHasEq.t @x2
@x3)))
:qid fuel_guarded_inversion_TestHasEq.t))

:named fuel_guarded_inversion_TestHasEq.t))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! (= 233
(Term_constr_id TestHasEq.t@tok))
:named fresh_token_TestHasEq.t@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(37,4-37,5); use=TestHasEq.fst(37,4-37,5)
...
(TestHasEq.t @x1
@x2)))
:qid data_typing_intro_TestHasEq.C@tok))

:named data_typing_intro_TestHasEq.C@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(37,4-37,5); use=TestHasEq.fst(37,4-37,5)
...
(TestHasEq.t @x5
@x6)))
:qid data_elim_TestHasEq.C))

:named data_elim_TestHasEq.C))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(36,13-36,14); use=TestHasEq.fst(36,13-36,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= 232
(Term_constr_id (TestHasEq.t @x0
@x1)))
 

:pattern ((TestHasEq.t @x0
@x1))
:qid constructor_distinct_TestHasEq.t))

:named constructor_distinct_TestHasEq.t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(37,4-37,5); use=TestHasEq.fst(37,4-37,5)
...
@x2
@x3))
:qid constructor_distinct_TestHasEq.C))

:named constructor_distinct_TestHasEq.C))
;;;;;;;;;;;;;;;;Assumption: TestHasEq.t__uu___haseq
;;; Fact-ids: Name TestHasEq.t__uu___haseq; Namespace TestHasEq
...
;;no pats
:qid assumption_TestHasEq.t__uu___haseq.1)))
(Valid (Prims.hasEq (TestHasEq.t @x0
@x1))))
 

:pattern ((Prims.hasEq (TestHasEq.t @x0
@x1)))
:qid assumption_TestHasEq.t__uu___haseq))
:named assumption_TestHasEq.t__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name TestHasEq.t; Namespace TestHasEq; Name TestHasEq.C; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(36,13-36,14); use=TestHasEq.fst(36,13-36,14)
...
(TestHasEq.t @x2
@x3)))
:qid TestHasEq_pretyping_16d3136622cafb2ffddc7c468354a1c4))

:named TestHasEq_pretyping_16d3136622cafb2ffddc7c468354a1c4))
...
; Starting query at TestHasEq.fst(39,14-39,60)
...
;;; Fact-ids: 
(assert (! 
;; def=TestHasEq.fst(39,45-39,57); use=TestHasEq.fst(39,45-39,57)
(forall ((@x0 Term))
...
;; def=TestHasEq.fst(39,51-39,56); use=TestHasEq.fst(39,51-39,56)
(> (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x2))
))
...
;;; Fact-ids: 
(assert (! 
;; def=TestHasEq.fst(36,32-39,34); use=TestHasEq.fst(39,29-39,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid TestHasEq_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named TestHasEq_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
...
:pattern ((ApplyTT @x0
@x1))
:qid TestHasEq_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid TestHasEq_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named TestHasEq_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
(declare-fun Tm_abs_387fd552e28fe87679131f6c15e8816b () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_387fd552e28fe87679131f6c15e8816b
;;; Fact-ids: 
(assert (! (HasType Tm_abs_387fd552e28fe87679131f6c15e8816b
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)
:named typing_Tm_abs_387fd552e28fe87679131f6c15e8816b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_387fd552e28fe87679131f6c15e8816b
;;; Fact-ids: 
(assert (! 
;; def=TestHasEq.fst(39,45-39,57); use=TestHasEq.fst(39,45-39,57)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_387fd552e28fe87679131f6c15e8816b
@x0)
(Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d @x0))
 

:pattern ((ApplyTT Tm_abs_387fd552e28fe87679131f6c15e8816b
@x0))
:qid interpretation_Tm_abs_387fd552e28fe87679131f6c15e8816b))

:named interpretation_Tm_abs_387fd552e28fe87679131f6c15e8816b))

; Encoding query formula : forall (_: Type) (_: _).
;   (*  - Could not prove post-condition
; *)
;   Prims.hasEq (TestHasEq.t Prims.nat (fun x -> y: Prims.nat{y > x}))
...
;; def=TestHasEq.fst(39,21-39,60); use=TestHasEq.fst(39,21-39,60)
(or label_1

;; def=TestHasEq.fst(39,21-39,60); use=TestHasEq.fst(39,21-39,60)
(Valid 
;; def=TestHasEq.fst(39,21-39,60); use=TestHasEq.fst(39,21-39,60)
(Prims.hasEq (TestHasEq.t Prims.nat
Tm_abs_387fd552e28fe87679131f6c15e8816b))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestHasEq.test2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, TestHasEq_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, assumption_TestHasEq.t__uu___haseq, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_2b9cd3e1fbccf82e9ebe34941f00564d, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, interpretation_Tm_abs_387fd552e28fe87679131f6c15e8816b, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_Prims.int, typing_Tm_abs_387fd552e28fe87679131f6c15e8816b
...
(declare-fun TestHasEq.test2 (Term Term) Term)

(declare-fun TestHasEq.test2@tok () Term)
...
; encoding sigelt type TestHasEq.t1


; <Start encoding type TestHasEq.t1>

;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.t1 (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun TestHasEq.t1@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.C1 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C1_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C1_x (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C1_y (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C1_z (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.C1
(declare-fun TestHasEq.C1@tok () Term)
(declare-fun Tm_refine_cb33e6378fd747af87c6b79e2a83cba9 (Term) Term)

;;;;;;;;;;;;;;;;x: a -> y: Prims.nat -> z: Prims.nat{z = y + 2} -> t1 a
(declare-fun Tm_arrow_6a1034c95687de3ed5a8a615e290d723 () Term)

; <start constructor TestHasEq.t1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.t1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
285)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor TestHasEq.t1>


; <start constructor TestHasEq.C1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.C1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
293)
(= __@x0
(TestHasEq.C1 (TestHasEq.C1_a __@x0)
(TestHasEq.C1_x __@x0)
(TestHasEq.C1_y __@x0)
(TestHasEq.C1_z __@x0)))))

; </end constructor TestHasEq.C1>


; </end encoding type TestHasEq.t1>

;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(41,5-41,7); use=TestHasEq.fst(41,5-41,7)
(forall ((@x0 Term))
 (! (= (ApplyTT TestHasEq.t1@tok
@x0)
(TestHasEq.t1 @x0))
 

:pattern ((ApplyTT TestHasEq.t1@tok
@x0))

:pattern ((TestHasEq.t1 @x0))
:qid token_correspondence_TestHasEq.t1@tok))

:named token_correspondence_TestHasEq.t1@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,4-42,6); use=TestHasEq.fst(42,4-42,6)
...
@x4)
(TestHasEq.t1 @x5)))
:qid subterm_ordering_TestHasEq.C1))

:named subterm_ordering_TestHasEq.C1))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,24-42,40); use=TestHasEq.fst(42,24-42,40)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_cb33e6378fd747af87c6b79e2a83cba9 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_cb33e6378fd747af87c6b79e2a83cba9 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_cb33e6378fd747af87c6b79e2a83cba9))

:named refinement_kinding_Tm_refine_cb33e6378fd747af87c6b79e2a83cba9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,24-42,40); use=TestHasEq.fst(42,24-42,40)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_cb33e6378fd747af87c6b79e2a83cba9 @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=TestHasEq.fst(42,30-42,39); use=TestHasEq.fst(42,30-42,39)
(= @x1
...
@x1
(Tm_refine_cb33e6378fd747af87c6b79e2a83cba9 @x2)))
:qid refinement_interpretation_Tm_refine_cb33e6378fd747af87c6b79e2a83cba9))

:named refinement_interpretation_Tm_refine_cb33e6378fd747af87c6b79e2a83cba9))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,4-42,6); use=TestHasEq.fst(42,4-42,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (TestHasEq.C1_z (TestHasEq.C1 @x0
@x1
@x2
@x3))
@x3)
...
:pattern ((TestHasEq.C1 @x0
@x1
@x2
@x3))
:qid projection_inverse_TestHasEq.C1_z))

:named projection_inverse_TestHasEq.C1_z))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,4-42,6); use=TestHasEq.fst(42,4-42,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (TestHasEq.C1_y (TestHasEq.C1 @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_TestHasEq.C1_y))

:named projection_inverse_TestHasEq.C1_y))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,4-42,6); use=TestHasEq.fst(42,4-42,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (TestHasEq.C1_x (TestHasEq.C1 @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_TestHasEq.C1_x))

:named projection_inverse_TestHasEq.C1_x))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,4-42,6); use=TestHasEq.fst(42,4-42,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (TestHasEq.C1_a (TestHasEq.C1 @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_TestHasEq.C1_a))

:named projection_inverse_TestHasEq.C1_a))
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! (is-Tm_arrow (PreType TestHasEq.t1@tok))
:named pre_kinding_TestHasEq.t1@tok))
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! (and (IsTotFun TestHasEq.t1@tok)

;; def=TestHasEq.fst(41,5-41,7); use=TestHasEq.fst(41,5-41,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (TestHasEq.t1 @x0)
Tm_type))
 

:pattern ((TestHasEq.t1 @x0))
:qid kinding_TestHasEq.t1@tok))
)
:named kinding_TestHasEq.t1@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_cb33e6378fd747af87c6b79e2a83cba9
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,24-42,40); use=TestHasEq.fst(42,24-42,40)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_cb33e6378fd747af87c6b79e2a83cba9 @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_cb33e6378fd747af87c6b79e2a83cba9 @x0))))
:qid haseqTm_refine_cb33e6378fd747af87c6b79e2a83cba9))

:named haseqTm_refine_cb33e6378fd747af87c6b79e2a83cba9))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(41,5-41,7); use=TestHasEq.fst(41,5-41,7)
...
@x1
(TestHasEq.t1 @x2)))
:qid fuel_guarded_inversion_TestHasEq.t1))

:named fuel_guarded_inversion_TestHasEq.t1))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! (= 286
(Term_constr_id TestHasEq.t1@tok))
:named fresh_token_TestHasEq.t1@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,4-42,6); use=TestHasEq.fst(42,4-42,6)
...
(HasTypeFuel @u0
@x4
(Tm_refine_cb33e6378fd747af87c6b79e2a83cba9 @x3)))
(HasTypeFuel @u0
(TestHasEq.C1 @x1
@x2
@x3
...
@x4)
(TestHasEq.t1 @x1)))
:qid data_typing_intro_TestHasEq.C1@tok))

:named data_typing_intro_TestHasEq.C1@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,4-42,6); use=TestHasEq.fst(42,4-42,6)
...
@x4)
(TestHasEq.t1 @x5)))
:qid data_elim_TestHasEq.C1))

:named data_elim_TestHasEq.C1))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(41,5-41,7); use=TestHasEq.fst(41,5-41,7)
(forall ((@x0 Term))
 (! (= 285
(Term_constr_id (TestHasEq.t1 @x0)))
 

:pattern ((TestHasEq.t1 @x0))
:qid constructor_distinct_TestHasEq.t1))

:named constructor_distinct_TestHasEq.t1))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(42,4-42,6); use=TestHasEq.fst(42,4-42,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 293
(Term_constr_id (TestHasEq.C1 @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_TestHasEq.C1))

:named constructor_distinct_TestHasEq.C1))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(41,5-41,7); use=TestHasEq.fst(41,5-41,7)
...
@x0
(TestHasEq.t1 @x2)))
:qid TestHasEq_pretyping_5a2914efd2733b6f6d28694c978e73b3))

:named TestHasEq_pretyping_5a2914efd2733b6f6d28694c978e73b3))
(push) ;; push{4

; Starting query at TestHasEq.fst(41,0-42,48)
...
;   Prims.hasEq a /\
;   (forall (a: Type). {:pattern Prims.hasEq (TestHasEq.t1 a)}
;       Prims.hasEq a ==> Prims.hasEq (TestHasEq.t1 a)) ==>
;   (forall (x: a) (y: Prims.nat) (z: Prims.nat{z = y + 2}).
;       Prims.hasEq a /\ Prims.hasEq Prims.nat /\ Prims.hasEq Prims.nat)


; Context: While encoding a query
; While typechecking the top-level declaration `type TestHasEq.t1`
...
;; def=TestHasEq.fst(41,0-42,48); use=TestHasEq.fst(41,0-42,48)
(Valid 
;; def=TestHasEq.fst(41,0-42,48); use=TestHasEq.fst(41,0-42,48)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=TestHasEq.fst(41,0-42,48); use=TestHasEq.fst(41,0-42,48)
(Prims.hasEq (TestHasEq.t1 @x1))
)
)
 

:pattern ((Prims.hasEq (TestHasEq.t1 @x1)))
:qid @query.1))
)
...
;; def=TestHasEq.fst(41,0-42,48); use=TestHasEq.fst(41,0-42,48)
(and 
;; def=TestHasEq.fst(41,0-42,48); use=TestHasEq.fst(42,10-42,11)
(or label_1
...
;; def=TestHasEq.fst(41,0-42,48); use=TestHasEq.fst(42,17-42,20)
(or label_2
...
;; def=TestHasEq.fst(42,26-42,29); use=TestHasEq.fst(42,26-42,29)
(or label_3
...
; encoding sigelt assume TestHasEq.t1__uu___haseq


; <Start encoding assume TestHasEq.t1__uu___haseq>


; </end encoding assume TestHasEq.t1__uu___haseq>


; encoding sigelt val TestHasEq.uu___is_C1


; <Start encoding val TestHasEq.uu___is_C1>

(declare-fun TestHasEq.uu___is_C1 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: t1 a -> Prims.bool
(declare-fun Tm_arrow_f98cb53301117f452e63e79fad7e1c79 () Term)
(declare-fun TestHasEq.uu___is_C1@tok () Term)

; </end encoding val TestHasEq.uu___is_C1>
...
; encoding sigelt val TestHasEq.__proj__C1__item__x


; <Start encoding val TestHasEq.__proj__C1__item__x>

(declare-fun TestHasEq.__proj__C1__item__x (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: t1 a -> a
(declare-fun Tm_arrow_4e2bc4e372e470cdc7f5f240e8288f3c () Term)
(declare-fun TestHasEq.__proj__C1__item__x@tok () Term)

; </end encoding val TestHasEq.__proj__C1__item__x>


; encoding sigelt let __proj__C1__item__x


; <Skipped let __proj__C1__item__x/>


; encoding sigelt val TestHasEq.__proj__C1__item__y


; <Start encoding val TestHasEq.__proj__C1__item__y>

(declare-fun TestHasEq.__proj__C1__item__y (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: t1 a -> Prims.nat
(declare-fun Tm_arrow_4d2bb8fa61fbdb10413081b1b7c854ba () Term)
(declare-fun TestHasEq.__proj__C1__item__y@tok () Term)

; </end encoding val TestHasEq.__proj__C1__item__y>


; encoding sigelt let __proj__C1__item__y


; <Skipped let __proj__C1__item__y/>


; encoding sigelt val TestHasEq.__proj__C1__item__z


; <Start encoding val TestHasEq.__proj__C1__item__z>

(declare-fun TestHasEq.__proj__C1__item__z (Term Term) Term)
(declare-fun Tm_refine_221894217c47ac61b410d2abc4c6e430 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: t1 a -> z: Prims.nat{z = projectee.y + 2}
(declare-fun Tm_arrow_24d21358943555011c8e97630f13f56b () Term)
(declare-fun TestHasEq.__proj__C1__item__z@tok () Term)


; </end encoding val TestHasEq.__proj__C1__item__z>


; encoding sigelt let __proj__C1__item__z


; <Skipped let __proj__C1__item__z/>
...
:named constructor_distinct_TestHasEq.C1))
;;;;;;;;;;;;;;;;Assumption: TestHasEq.t1__uu___haseq
;;; Fact-ids: Name TestHasEq.t1__uu___haseq; Namespace TestHasEq
(assert (! (forall ((@x0 Term))
 (! (implies (and (HasType @x0
Tm_type)
(Valid (Prims.hasEq @x0)))
(Valid (Prims.hasEq (TestHasEq.t1 @x0))))
 

:pattern ((Prims.hasEq (TestHasEq.t1 @x0)))
:qid assumption_TestHasEq.t1__uu___haseq))
:named assumption_TestHasEq.t1__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name TestHasEq.t1; Namespace TestHasEq; Name TestHasEq.C1; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(41,5-41,7); use=TestHasEq.fst(41,5-41,7)
...
; Starting query at TestHasEq.fst(44,0-44,36)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq (TestHasEq.t1 Prims.bool)
...
;;; Fact-ids: 
(assert (! (not 
;; def=TestHasEq.fst(44,19-44,36); use=TestHasEq.fst(44,12-44,18)
(or label_1

;; def=TestHasEq.fst(44,19-44,36); use=TestHasEq.fst(44,12-44,18)
(Valid 
;; def=TestHasEq.fst(44,19-44,36); use=TestHasEq.fst(44,12-44,18)
(Prims.hasEq (TestHasEq.t1 Prims.bool))
)
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestHasEq.test3, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_TestHasEq.t1__uu___haseq, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.bool
...
(declare-fun TestHasEq.test3 (Dummy_sort) Term)
...
; Starting query at TestHasEq.fst(46,0-46,64)
...
;;; Fact-ids: 
(assert (! 
;; def=TestHasEq.fst(46,49-46,61); use=TestHasEq.fst(46,12-46,18)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d @x0)
Tm_type)
...
;; def=TestHasEq.fst(46,55-46,60); use=TestHasEq.fst(46,12-46,18)
(> (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x2))
))
...
;;; Fact-ids: 
(assert (! 
;; def=TestHasEq.fst(46,35-46,38); use=TestHasEq.fst(46,12-46,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)
...
; Encoding query formula : Prims.hasEq (x: Prims.nat & y: Prims.nat{y > x})
...
;;; Fact-ids: 
(assert (! (not 
;; def=TestHasEq.fst(46,19-46,64); use=TestHasEq.fst(46,12-46,18)
(or label_1

;; def=TestHasEq.fst(46,19-46,64); use=TestHasEq.fst(46,12-46,18)
(Valid 
;; def=TestHasEq.fst(46,19-46,64); use=TestHasEq.fst(46,12-46,18)
(Prims.hasEq (Prims.dtuple2 Prims.nat
Tm_abs_387fd552e28fe87679131f6c15e8816b))
)
)
)
...
(declare-fun TestHasEq.test4 (Dummy_sort) Term)

; </end encoding let test4>


; encoding sigelt val TestHasEq.tp


; <Start encoding val TestHasEq.tp>

(declare-fun TestHasEq.tp (Term) Term)

(declare-fun TestHasEq.tp@tok () Term)

; </end encoding val TestHasEq.tp>


; encoding sigelt type TestHasEq.t2


; <Start encoding type TestHasEq.t2>

;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.t2 (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun TestHasEq.t2@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.Bad (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.Bad_t (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.Bad
(declare-fun TestHasEq.Bad@tok () Term)
(declare-fun Tm_refine_128cbfda218b8688baff56e8ac9ae52c () Term)


;;;;;;;;;;;;;;;;t2 t
(declare-fun Tm_arrow_9ec3afbce6a9138ac5f86384e46c412a () Term)

; <start constructor TestHasEq.t2>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.t2 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
356)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor TestHasEq.t2>


; <start constructor TestHasEq.Bad>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.Bad ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
364)
(= __@x0
(TestHasEq.Bad (TestHasEq.Bad_t __@x0)))))

; </end constructor TestHasEq.Bad>


; </end encoding type TestHasEq.t2>


; encoding sigelt assume TestHasEq.t2__uu___haseq


; <Start encoding assume TestHasEq.t2__uu___haseq>



; </end encoding assume TestHasEq.t2__uu___haseq>


; encoding sigelt val TestHasEq.uu___is_Bad


; <Start encoding val TestHasEq.uu___is_Bad>


(declare-fun TestHasEq.uu___is_Bad (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: t2 t -> Prims.bool
(declare-fun Tm_arrow_893244b50df915b53e4ce6e891ec5503 () Term)
(declare-fun TestHasEq.uu___is_Bad@tok () Term)

; </end encoding val TestHasEq.uu___is_Bad>


; encoding sigelt let uu___is_Bad


; <Skipped let uu___is_Bad/>
...
; encoding sigelt type TestHasEq.t3


; <Start encoding type TestHasEq.t3>

;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.t3 (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun TestHasEq.t3@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.C3 (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C3_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C3_x (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.C3
(declare-fun TestHasEq.C3@tok () Term)
;;;;;;;;;;;;;;;;x: a -> TestHasEq.t3 a
(declare-fun Tm_arrow_a38c272415765bc6c57f6d55f336b35c () Term)

; <start constructor TestHasEq.t3>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.t3 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
385)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor TestHasEq.t3>


; <start constructor TestHasEq.C3>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.C3 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
392)
(= __@x0
(TestHasEq.C3 (TestHasEq.C3_a __@x0)
(TestHasEq.C3_x __@x0)))))

; </end constructor TestHasEq.C3>


; </end encoding type TestHasEq.t3>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name TestHasEq.tp; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(48,12-48,14); use=TestHasEq.fst(48,12-48,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (TestHasEq.tp @x0)
Tm_type))
 

:pattern ((TestHasEq.tp @x0))
:qid typing_TestHasEq.tp))

:named typing_TestHasEq.tp))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name TestHasEq.t2; Namespace TestHasEq; Name TestHasEq.Bad; Namespace TestHasEq
(assert (! (HasType Tm_refine_128cbfda218b8688baff56e8ac9ae52c
Tm_type)
:named refinement_kinding_Tm_refine_128cbfda218b8688baff56e8ac9ae52c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name TestHasEq.t2; Namespace TestHasEq; Name TestHasEq.Bad; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(50,8-50,23); use=TestHasEq.fst(50,8-50,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_128cbfda218b8688baff56e8ac9ae52c)
(and (HasTypeFuel @u0
@x1
Tm_type)

;; def=TestHasEq.fst(50,17-50,21); use=TestHasEq.fst(50,17-50,21)
(Valid 
;; def=TestHasEq.fst(50,17-50,21); use=TestHasEq.fst(50,17-50,21)
(TestHasEq.tp @x1)
)
...
@x1
Tm_refine_128cbfda218b8688baff56e8ac9ae52c))
:qid refinement_interpretation_Tm_refine_128cbfda218b8688baff56e8ac9ae52c))

:named refinement_interpretation_Tm_refine_128cbfda218b8688baff56e8ac9ae52c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_128cbfda218b8688baff56e8ac9ae52c
;;; Fact-ids: Name TestHasEq.t2; Namespace TestHasEq; Name TestHasEq.Bad; Namespace TestHasEq
(assert (! (iff (Valid (Prims.hasEq Tm_refine_128cbfda218b8688baff56e8ac9ae52c))
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_128cbfda218b8688baff56e8ac9ae52c))
(push) ;; push{5

; Starting query at TestHasEq.fst(57,0-58,19)
...
; Context: While encoding a query
; While typechecking the top-level declaration `type TestHasEq.t3`
; While typechecking the top-level declaration `[@@expect_failure] type TestHasEq.t3`
...
;; def=TestHasEq.fst(57,0-58,19); use=TestHasEq.fst(58,10-58,11)
(or label_1

;; def=TestHasEq.fst(57,0-58,19); use=TestHasEq.fst(57,0-58,19)
(Valid 
;; def=TestHasEq.fst(57,0-58,19); use=TestHasEq.fst(57,0-58,19)
(Prims.hasEq @x0)
)
...
; encoding sigelt type TestHasEq.t4


; <Start encoding type TestHasEq.t4>

;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.t4 (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun TestHasEq.t4@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.C4 (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C4_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun TestHasEq.C4_x (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.C4
(declare-fun TestHasEq.C4@tok () Term)
;;;;;;;;;;;;;;;;x: Prims.nat -> t4 a
(declare-fun Tm_arrow_44cdd3ec15d43ab3ee86fa119aede3cd () Term)

; <start constructor TestHasEq.t4>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.t4 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
420)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor TestHasEq.t4>


; <start constructor TestHasEq.C4>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.C4 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
427)
(= __@x0
(TestHasEq.C4 (TestHasEq.C4_a __@x0)
(TestHasEq.C4_x __@x0)))))

; </end constructor TestHasEq.C4>


; </end encoding type TestHasEq.t4>
...
; Starting query at TestHasEq.fst(60,0-61,22)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (x: Prims.nat).
;   (*  - Failed to prove that the type
;     'TestHasEq.t4'
;     supports decidable equality because of this argument.
;   - Add either the 'noeq' or 'unopteq' qualifier
...
; Context: While encoding a query
; While typechecking the top-level declaration `type TestHasEq.t4`
...
;; def=TestHasEq.fst(60,0-61,22); use=TestHasEq.fst(61,11-61,14)
(or label_1

;; def=TestHasEq.fst(60,0-61,22); use=TestHasEq.fst(60,0-61,22)
(Valid 
;; def=TestHasEq.fst(60,0-61,22); use=TestHasEq.fst(60,0-61,22)
(Prims.hasEq Prims.nat)
)
...
; encoding sigelt assume TestHasEq.t4__uu___haseq


; <Start encoding assume TestHasEq.t4__uu___haseq>


; </end encoding assume TestHasEq.t4__uu___haseq>


; encoding sigelt val TestHasEq.uu___is_C4


; <Start encoding val TestHasEq.uu___is_C4>

(declare-fun TestHasEq.uu___is_C4 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: t4 a -> Prims.bool
(declare-fun Tm_arrow_fecbed29f25771d81cb473db849c6c0b () Term)
(declare-fun TestHasEq.uu___is_C4@tok () Term)

; </end encoding val TestHasEq.uu___is_C4>


; encoding sigelt let uu___is_C4


; <Skipped let uu___is_C4/>


; encoding sigelt val TestHasEq.__proj__C4__item__x


; <Start encoding val TestHasEq.__proj__C4__item__x>

(declare-fun TestHasEq.__proj__C4__item__x (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: t4 a -> Prims.nat
(declare-fun Tm_arrow_3713e22f38fe66dcb00f160430e660ea () Term)
(declare-fun TestHasEq.__proj__C4__item__x@tok () Term)

; </end encoding val TestHasEq.__proj__C4__item__x>


; encoding sigelt let __proj__C4__item__x


; <Skipped let __proj__C4__item__x/>


; encoding sigelt #push-options "--no_smt"


; <Skipped #push-options "--no_smt"/>


; encoding sigelt let test_1514


; <Start encoding let test_1514>

(declare-fun TestHasEq.test_1514 (Term) Term)

(declare-fun TestHasEq.test_1514@tok () Term)

; </end encoding let test_1514>
...
; encoding sigelt type TestHasEq.erasable_t


; <Start encoding type TestHasEq.erasable_t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.erasable_t () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.C_erasable_t () Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.C_erasable_t
(declare-fun TestHasEq.C_erasable_t@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun TestHasEq.D_erasable_t () Term)
;;;;;;;;;;;;;;;;data constructor proxy: TestHasEq.D_erasable_t
(declare-fun TestHasEq.D_erasable_t@tok () Term)

; <start constructor TestHasEq.erasable_t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.erasable_t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
448)
(= __@x0
TestHasEq.erasable_t)))

; </end constructor TestHasEq.erasable_t>


; <start constructor TestHasEq.C_erasable_t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.C_erasable_t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
454)
(= __@x0
TestHasEq.C_erasable_t)))

; </end constructor TestHasEq.C_erasable_t>


; <start constructor TestHasEq.D_erasable_t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-TestHasEq.D_erasable_t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
456)
(= __@x0
TestHasEq.D_erasable_t)))

; </end constructor TestHasEq.D_erasable_t>


; </end encoding type TestHasEq.erasable_t>


; encoding sigelt val TestHasEq.uu___is_C_erasable_t


; <Start encoding val TestHasEq.uu___is_C_erasable_t>

(declare-fun TestHasEq.uu___is_C_erasable_t (Term) Term)
;;;;;;;;;;;;;;;;projectee: erasable_t -> Prims.GTot Prims.bool
(declare-fun Tm_ghost_arrow_14ad0eb756e5bd5929be629d9098440d () Term)
(declare-fun TestHasEq.uu___is_C_erasable_t@tok () Term)

; </end encoding val TestHasEq.uu___is_C_erasable_t>


; encoding sigelt let uu___is_C_erasable_t


; <Skipped let uu___is_C_erasable_t/>


; encoding sigelt val TestHasEq.uu___is_D_erasable_t


; <Start encoding val TestHasEq.uu___is_D_erasable_t>

(declare-fun TestHasEq.uu___is_D_erasable_t (Term) Term)

(declare-fun TestHasEq.uu___is_D_erasable_t@tok () Term)

; </end encoding val TestHasEq.uu___is_D_erasable_t>


; encoding sigelt let uu___is_D_erasable_t


; <Skipped let uu___is_D_erasable_t/>
...
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! (HasType TestHasEq.D_erasable_t@tok
TestHasEq.erasable_t)
:named typing_tok_TestHasEq.D_erasable_t@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! (HasType TestHasEq.C_erasable_t@tok
TestHasEq.erasable_t)
:named typing_tok_TestHasEq.C_erasable_t@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name TestHasEq.uu___is_D_erasable_t; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(81,4-81,16); use=TestHasEq.fst(81,4-81,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
TestHasEq.erasable_t)
(HasType (TestHasEq.uu___is_D_erasable_t @x0)
Prims.bool))
 

:pattern ((TestHasEq.uu___is_D_erasable_t @x0))
:qid typing_TestHasEq.uu___is_D_erasable_t))

:named typing_TestHasEq.uu___is_D_erasable_t))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name TestHasEq.uu___is_C_erasable_t; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(80,4-80,16); use=TestHasEq.fst(80,4-80,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
TestHasEq.erasable_t)
(HasType (TestHasEq.uu___is_C_erasable_t @x0)
Prims.bool))
 

:pattern ((TestHasEq.uu___is_C_erasable_t @x0))
:qid typing_TestHasEq.uu___is_C_erasable_t))

:named typing_TestHasEq.uu___is_C_erasable_t))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name TestHasEq.tp; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(48,12-48,14); use=TestHasEq.fst(48,12-48,14)
...
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! (HasType TestHasEq.erasable_t
Tm_type)
:named kinding_TestHasEq.erasable_t@tok))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(79,5-79,15); use=TestHasEq.fst(79,5-79,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
TestHasEq.erasable_t)
(or (is-TestHasEq.C_erasable_t @x1)
(is-TestHasEq.D_erasable_t @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
TestHasEq.erasable_t))
:qid fuel_guarded_inversion_TestHasEq.erasable_t))

:named fuel_guarded_inversion_TestHasEq.erasable_t))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! (= TestHasEq.D_erasable_t@tok
TestHasEq.D_erasable_t)
:named equality_tok_TestHasEq.D_erasable_t@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! (= TestHasEq.C_erasable_t@tok
TestHasEq.C_erasable_t)
:named equality_tok_TestHasEq.C_erasable_t@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;; def=TestHasEq.fst(81,4-81,16); use=TestHasEq.fst(81,4-81,16)
(forall ((@x0 Term))
 (! (= (TestHasEq.uu___is_D_erasable_t @x0)
(BoxBool (is-TestHasEq.D_erasable_t @x0)))
 

:pattern ((TestHasEq.uu___is_D_erasable_t @x0))
:qid disc_equation_TestHasEq.D_erasable_t))

:named disc_equation_TestHasEq.D_erasable_t))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name TestHasEq.uu___is_C_erasable_t; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(80,4-80,16); use=TestHasEq.fst(80,4-80,16)
(forall ((@x0 Term))
 (! (= (TestHasEq.uu___is_C_erasable_t @x0)
(BoxBool (is-TestHasEq.C_erasable_t @x0)))
 

:pattern ((TestHasEq.uu___is_C_erasable_t @x0))
:qid disc_equation_TestHasEq.C_erasable_t))

:named disc_equation_TestHasEq.C_erasable_t))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(81,4-81,16); use=TestHasEq.fst(81,4-81,16)
...
TestHasEq.D_erasable_t
TestHasEq.erasable_t))
:qid data_typing_intro_TestHasEq.D_erasable_t@tok))

:named data_typing_intro_TestHasEq.D_erasable_t@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! 
;; def=TestHasEq.fst(80,4-80,16); use=TestHasEq.fst(80,4-80,16)
...
TestHasEq.C_erasable_t
TestHasEq.erasable_t))
:qid data_typing_intro_TestHasEq.C_erasable_t@tok))

:named data_typing_intro_TestHasEq.C_erasable_t@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! (= 448
(Term_constr_id TestHasEq.erasable_t))
:named constructor_distinct_TestHasEq.erasable_t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! (= 456
(Term_constr_id TestHasEq.D_erasable_t))
:named constructor_distinct_TestHasEq.D_erasable_t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name TestHasEq.erasable_t; Namespace TestHasEq; Name TestHasEq.C_erasable_t; Namespace TestHasEq; Name TestHasEq.D_erasable_t; Namespace TestHasEq
(assert (! (= 454
(Term_constr_id TestHasEq.C_erasable_t))
:named constructor_distinct_TestHasEq.C_erasable_t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= 116
...
@x0
TestHasEq.erasable_t))
:qid TestHasEq_pretyping_62632d2b550dec74f89e56ff870521c5))

:named TestHasEq_pretyping_62632d2b550dec74f89e56ff870521c5))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
;; def=Prims.fst(91,5-91,12); use=Prims.fst(91,5-91,12)
...
; Starting query at TestHasEq.fst(85,2-85,24)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_6d4423ad97eda18ffe686b845deb8abd () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_6d4423ad97eda18ffe686b845deb8abd
Tm_type)
:named refinement_kinding_Tm_refine_6d4423ad97eda18ffe686b845deb8abd))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=TestHasEq.fst(84,9-84,40); use=TestHasEq.fst(84,9-84,40)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_6d4423ad97eda18ffe686b845deb8abd)
(and (HasTypeFuel @u0
@x1
TestHasEq.erasable_t)

;; def=TestHasEq.fst(84,23-84,38); use=TestHasEq.fst(84,23-84,38)
(BoxBool_proj_0 (TestHasEq.uu___is_C_erasable_t @x1))
))
...
@x1
Tm_refine_6d4423ad97eda18ffe686b845deb8abd))
:qid refinement_interpretation_Tm_refine_6d4423ad97eda18ffe686b845deb8abd))

:named refinement_interpretation_Tm_refine_6d4423ad97eda18ffe686b845deb8abd))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6d4423ad97eda18ffe686b845deb8abd
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_6d4423ad97eda18ffe686b845deb8abd))
(Valid (Prims.hasEq TestHasEq.erasable_t)))
:named haseqTm_refine_6d4423ad97eda18ffe686b845deb8abd))
(declare-fun Tm_refine_b25cc4270b563a69cdd51b89eff8a6c4 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_b25cc4270b563a69cdd51b89eff8a6c4
Tm_type)
:named refinement_kinding_Tm_refine_b25cc4270b563a69cdd51b89eff8a6c4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=TestHasEq.fst(84,41-84,72); use=TestHasEq.fst(84,41-84,72)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_b25cc4270b563a69cdd51b89eff8a6c4)
(and (HasTypeFuel @u0
@x1
TestHasEq.erasable_t)

;; def=TestHasEq.fst(84,55-84,70); use=TestHasEq.fst(84,55-84,70)
(BoxBool_proj_0 (TestHasEq.uu___is_D_erasable_t @x1))
))
...
@x1
Tm_refine_b25cc4270b563a69cdd51b89eff8a6c4))
:qid refinement_interpretation_Tm_refine_b25cc4270b563a69cdd51b89eff8a6c4))

:named refinement_interpretation_Tm_refine_b25cc4270b563a69cdd51b89eff8a6c4))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b25cc4270b563a69cdd51b89eff8a6c4
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_b25cc4270b563a69cdd51b89eff8a6c4))
(Valid (Prims.hasEq TestHasEq.erasable_t)))
:named haseqTm_refine_b25cc4270b563a69cdd51b89eff8a6c4))


(declare-fun Tm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd
Tm_type)
:named refinement_kinding_Tm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=TestHasEq.fst(84,79-84,94); use=TestHasEq.fst(85,2-85,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd)
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=TestHasEq.fst(84,86-84,92); use=TestHasEq.fst(85,2-85,24)
(= @x1
(BoxInt 1))
))
...
@x1
Tm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd))
:qid refinement_interpretation_Tm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd))

:named refinement_interpretation_Tm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd))
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd))
(declare-fun Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f
Tm_type)
:named refinement_kinding_Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=TestHasEq.fst(84,10-84,70); use=TestHasEq.fst(85,2-85,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f)
(and (HasTypeFuel @u0
@x1
TestHasEq.erasable_t)

;; def=TestHasEq.fst(84,23-84,70); use=TestHasEq.fst(85,2-85,24)
(or 
;; def=TestHasEq.fst(84,23-84,38); use=TestHasEq.fst(85,5-85,6)
(BoxBool_proj_0 (TestHasEq.uu___is_C_erasable_t @x1))


;; def=TestHasEq.fst(84,55-84,70); use=TestHasEq.fst(85,9-85,10)
(BoxBool_proj_0 (TestHasEq.uu___is_D_erasable_t @x1))
)
))
...
@x1
Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f))
:qid refinement_interpretation_Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f))

:named refinement_interpretation_Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f))
(Valid (Prims.hasEq TestHasEq.erasable_t)))
:named haseqTm_refine_e0399dee3ea1a3b624e236d0bbe16a4f))




; Encoding query formula : forall (x: TestHasEq.erasable_t{C_erasable_t? x}) (y: TestHasEq.erasable_t{D_erasable_t? y}).
;   (*  - Could not prove post-condition
; *)
...
;                       (forall (x: n: Prims.int{n == 1}). {:pattern Prims.guard_free (k x)}
;                           Prims.auto_squash (k x)) ==>
;                       x = y == true ==> Prims.l_False)))))
...
;; def=Prims.fst(459,77-459,89); use=TestHasEq.fst(85,2-85,24)
(and 
;; def=TestHasEq.fst(84,12-84,22); use=TestHasEq.fst(84,10-84,70)
(or label_1

;; def=TestHasEq.fst(84,12-84,22); use=TestHasEq.fst(85,5-85,6)
(Valid 
;; def=TestHasEq.fst(84,12-84,22); use=TestHasEq.fst(85,5-85,6)
(Prims.hasEq TestHasEq.erasable_t)
)
...
;; def=Prims.fst(451,66-451,102); use=TestHasEq.fst(85,2-85,24)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_type)

;; def=Prims.fst(588,31-588,32); use=TestHasEq.fst(85,2-85,24)
(= Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f
@x2)
)
...
(and (implies 
;; def=TestHasEq.fst(84,23-84,38); use=TestHasEq.fst(85,5-85,6)
(BoxBool_proj_0 (TestHasEq.uu___is_C_erasable_t @x0))


;; def=TestHasEq.fst(84,23-84,70); use=TestHasEq.fst(85,5-85,6)
(or label_2
...
;; def=TestHasEq.fst(84,55-84,70); use=TestHasEq.fst(85,5-85,6)
(BoxBool_proj_0 (TestHasEq.uu___is_D_erasable_t @x0))
)
)
...
;; def=dummy(0,0-0,0); use=TestHasEq.fst(85,2-85,24)
(= @x0
@x3)
)
...
;; def=TestHasEq.fst(84,23-84,70); use=TestHasEq.fst(85,9-85,10)
(or label_3

;; def=TestHasEq.fst(84,23-84,38); use=TestHasEq.fst(85,9-85,10)
(BoxBool_proj_0 (TestHasEq.uu___is_C_erasable_t @x1))
...
;; def=TestHasEq.fst(85,5-85,10); use=TestHasEq.fst(85,5-85,10)
(= (Prims.op_Equality Tm_refine_e0399dee3ea1a3b624e236d0bbe16a4f
@x0
@x1)
@x5)
)
...
(Prims.pure_post Tm_refine_d0eee3c391f9d6e8f2bd864e1e88f2bd))

;; def=Prims.fst(402,27-402,88); use=TestHasEq.fst(85,2-85,24)
(forall ((@x7 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=TestHasEq.fst(85,2-85,24)
(Valid 
;; def=Prims.fst(402,84-402,87); use=TestHasEq.fst(85,2-85,24)
(ApplyTT @x6
@x7)
