...
; Internals for TestErrorLocations


; encoding sigelt #set-options "--initial_fuel 0 --max_fuel 0 --initial_ifuel 0 --max_ifuel 0"
...
; Starting query at TestErrorLocations.fst(20,0-20,25)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.l_False


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test0`
; While typechecking the top-level declaration `[@@expect_failure] let test0`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test0, 1)
...
; Starting query at TestErrorLocations.fst(24,0-24,33)
...
; While typechecking the top-level declaration `[@@expect_failure] let test1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test1, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val TestErrorLocations.test2_aux


; <Start encoding val TestErrorLocations.test2_aux>

(declare-fun TestErrorLocations.test2_aux (Term) Term)
(declare-fun Tm_refine_f065797dc3de34eba7c345fdef864bf6 () Term)
;;;;;;;;;;;;;;;;x: Prims.int -> Prims.Pure Prims.int
(declare-fun Tm_arrow_7a2ef4a23d89ba85723a6ee0e0c53e21 () Term)
(declare-fun TestErrorLocations.test2_aux@tok () Term)


; </end encoding val TestErrorLocations.test2_aux>
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name TestErrorLocations.test2_aux; Namespace TestErrorLocations
(assert (! (HasType Tm_refine_f065797dc3de34eba7c345fdef864bf6
Tm_type)
:named refinement_kinding_Tm_refine_f065797dc3de34eba7c345fdef864bf6))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name TestErrorLocations.test2_aux; Namespace TestErrorLocations
(assert (! 
;; def=TestErrorLocations.fst(27,36-27,39); use=TestErrorLocations.fst(27,36-27,39)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f065797dc3de34eba7c345fdef864bf6)
(HasTypeFuel @u0
@x1
Prims.int))
...
@x1
Tm_refine_f065797dc3de34eba7c345fdef864bf6))
:qid refinement_interpretation_Tm_refine_f065797dc3de34eba7c345fdef864bf6))

:named refinement_interpretation_Tm_refine_f065797dc3de34eba7c345fdef864bf6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_f065797dc3de34eba7c345fdef864bf6
;;; Fact-ids: Name TestErrorLocations.test2_aux; Namespace TestErrorLocations
(assert (! (iff (Valid (Prims.hasEq Tm_refine_f065797dc3de34eba7c345fdef864bf6))
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_f065797dc3de34eba7c345fdef864bf6))
...
; Starting query at TestErrorLocations.fst(30,19-32,7)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Prims.int). (*  - Could not prove post-condition
; *) x >= 0


; Context: While encoding a query
; While typechecking the top-level declaration `let test2`
; While typechecking the top-level declaration `[@@expect_failure] let test2`
...
;; def=TestErrorLocations.fst(27,50-27,58); use=TestErrorLocations.fst(31,10-31,19)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test2, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; Starting query at TestErrorLocations.fst(35,13-38,7)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Type) (x: _). (*  - Could not prove post-condition
; *) Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let test3`
; While typechecking the top-level declaration `[@@expect_failure] let test3`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test3, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val TestErrorLocations.test4_aux


; <Start encoding val TestErrorLocations.test4_aux>

(declare-fun TestErrorLocations.test4_aux (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.nat -> Prims.int
(declare-fun Tm_arrow_fc34ca66de2f262c06145b17fb7ed6cb () Term)
(declare-fun TestErrorLocations.test4_aux@tok () Term)

; </end encoding val TestErrorLocations.test4_aux>
...
; Starting query at TestErrorLocations.fst(42,19-44,7)
...
; While typechecking the top-level declaration `[@@expect_failure] let test4`
...
;; def=Prims.fst(680,18-680,24); use=TestErrorLocations.fst(43,20-43,21)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test4, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val TestErrorLocations.test5


; <Skipped val TestErrorLocations.test5/>
...
; Starting query at TestErrorLocations.fst(48,14-48,19)
...
;     x <> 0 /\ (forall (pure_result: Prims.int). pure_result >= 0 ==> p pure_result) ==>
;     (forall (return_val: Prims.int). return_val == x + 1 ==> p return_val)


; Context: While encoding a query
; While typechecking the top-level declaration `let test5`
; While typechecking the top-level declaration `[@@expect_failure] let test5`
...
;; def=TestErrorLocations.fst(46,39-46,53); use=TestErrorLocations.fst(48,14-48,19)
(not (= @x0
(BoxInt 0)))


;; def=Prims.fst(441,36-441,97); use=TestErrorLocations.fst(48,14-48,19)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.int))

;; def=TestErrorLocations.fst(46,84-46,90); use=TestErrorLocations.fst(48,14-48,19)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=TestErrorLocations.fst(48,14-48,19)
(Valid 
;; def=Prims.fst(441,83-441,96); use=TestErrorLocations.fst(48,14-48,19)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test5, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val TestErrorLocations.test6


; <Skipped val TestErrorLocations.test6/>
...
; Starting query at TestErrorLocations.fst(58,15-58,17)
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit) (any_result: Prims.unit). p any_result


; Context: While encoding a query
; While typechecking the top-level declaration `let test6`
; While typechecking the top-level declaration `[@@expect_failure] let test6`
...
;; def=Prims.fst(451,90-451,102); use=TestErrorLocations.fst(58,15-58,17)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test6, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val TestErrorLocations.test7


; <Skipped val TestErrorLocations.test7/>
...
; Starting query at TestErrorLocations.fst(62,15-62,17)
...
; While typechecking the top-level declaration `[@@expect_failure] let test7`
...
;; def=Prims.fst(451,90-451,102); use=TestErrorLocations.fst(62,15-62,17)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test7, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val TestErrorLocations.test8_aux


; <Start encoding val TestErrorLocations.test8_aux>

(declare-fun TestErrorLocations.test8_aux (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.nat -> Prims.nat
(declare-fun Tm_arrow_b71b847c8a1dce9fbabbfc40fd470d89 () Term)
(declare-fun TestErrorLocations.test8_aux@tok () Term)

; </end encoding val TestErrorLocations.test8_aux>
...
; Starting query at TestErrorLocations.fst(66,0-66,39)
...
; While typechecking the top-level declaration `[@@expect_failure] let test8`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=TestErrorLocations.fst(66,37-66,39)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)

;; def=Prims.fst(680,18-680,24); use=TestErrorLocations.fst(66,27-66,28)
(or label_1

;; def=Prims.fst(680,18-680,24); use=TestErrorLocations.fst(66,37-66,39)
(>= (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test8, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val TestErrorLocations.test9_aux


; <Start encoding val TestErrorLocations.test9_aux>

(declare-fun TestErrorLocations.test9_aux (Term) Term)
(declare-fun Tm_refine_1588d9cc9cb691265bea0ce2c66abf3c () Term)
;;;;;;;;;;;;;;;;x: Prims.int -> Prims.Pure Prims.bool
(declare-fun Tm_arrow_89d6ac0cbec8be63891ea9b57e9494f5 () Term)
(declare-fun TestErrorLocations.test9_aux@tok () Term)


; </end encoding val TestErrorLocations.test9_aux>
...
; Starting query at TestErrorLocations.fst(70,7-70,49)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Prims.int). x >= 0


; Context: While encoding a query
; While typechecking the top-level declaration `val TestErrorLocations.test9`
; While typechecking the top-level declaration `[@@expect_failure] val TestErrorLocations.test9`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=TestErrorLocations.fst(70,19-70,49)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)

;; def=TestErrorLocations.fst(68,52-68,66); use=TestErrorLocations.fst(70,25-70,34)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test9, 1)
; STATUS: unknown because (incomplete quantifiers)
...
:named refinement_kinding_Tm_refine_2de20c066034c13bf76e9c0b94f4806c))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name TestErrorLocations.test9_aux; Namespace TestErrorLocations
(assert (! (HasType Tm_refine_1588d9cc9cb691265bea0ce2c66abf3c
Tm_type)
:named refinement_kinding_Tm_refine_1588d9cc9cb691265bea0ce2c66abf3c))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! (HasType Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f
Tm_type)
...
;;; Fact-ids: Name TestErrorLocations.test9_aux; Namespace TestErrorLocations
(assert (! 
;; def=TestErrorLocations.fst(68,37-68,41); use=TestErrorLocations.fst(68,37-68,41)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_1588d9cc9cb691265bea0ce2c66abf3c)
(HasTypeFuel @u0
@x1
Prims.bool))
...
@x1
Tm_refine_1588d9cc9cb691265bea0ce2c66abf3c))
:qid refinement_interpretation_Tm_refine_1588d9cc9cb691265bea0ce2c66abf3c))

:named refinement_interpretation_Tm_refine_1588d9cc9cb691265bea0ce2c66abf3c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
;; def=Prims.fst(686,15-686,29); use=Prims.fst(686,15-686,29)
...
:named haseqTm_refine_2de20c066034c13bf76e9c0b94f4806c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1588d9cc9cb691265bea0ce2c66abf3c
;;; Fact-ids: Name TestErrorLocations.test9_aux; Namespace TestErrorLocations
(assert (! (iff (Valid (Prims.hasEq Tm_refine_1588d9cc9cb691265bea0ce2c66abf3c))
(Valid (Prims.hasEq Prims.bool)))
:named haseqTm_refine_1588d9cc9cb691265bea0ce2c66abf3c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f))
(Valid (Prims.hasEq Prims.int)))
...
; Starting query at TestErrorLocations.fst(89,2-91,30)
...
;   (*  - Could not prove post-condition
; *)
;   (forall (_: Prims.unit). exists (x: Prims.nat). x = 0) /\
;   (forall (any_result: Prims.unit) (n: Prims.nat) (pf_zero: Prims.squash (n = 0)).
;       (*  - Could not prove post-condition
; *) n = 0)


; Context: While encoding a query
; While typechecking the top-level declaration `let test_elim_exists`
; While typechecking the top-level declaration `[@@expect_failure] let test_elim_exists`
...
;; def=Prims.fst(459,77-459,89); use=TestErrorLocations.fst(89,2-91,30)
(and 
;; def=dummy(0,0-0,0); use=TestErrorLocations.fst(89,20-89,36)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.unit)

;; def=FStar.Classical.Sugar.fsti(66,22-66,41); use=TestErrorLocations.fst(89,20-89,36)
(or label_1
...
;; def=TestErrorLocations.fst(89,29-89,36); use=TestErrorLocations.fst(89,29-89,36)
(= @x2
(BoxInt 0))
)
...
;; def=Prims.fst(451,66-451,102); use=TestErrorLocations.fst(89,2-91,30)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.unit)

;; def=dummy(0,0-0,0); use=TestErrorLocations.fst(89,2-91,30)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.nat)
(HasType @x3
(Prims.squash (Prims.b2t (Prims.op_Equality Prims.int
@x2
(BoxInt 0))))))

;; def=TestErrorLocations.fst(91,23-91,30); use=TestErrorLocations.fst(91,23-91,30)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test_elim_exists, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; Starting query at TestErrorLocations.fst(97,2-98,8)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Prims.unit). (*  - Could not prove post-condition
; *) forall (x: Prims.nat). x = 0


; Context: While encoding a query
; While typechecking the top-level declaration `let test_elim_forall`
; While typechecking the top-level declaration `[@@expect_failure] let test_elim_forall`
...
;; def=FStar.Classical.Sugar.fsti(58,17-58,36); use=TestErrorLocations.fst(97,20-97,33)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.nat)

;; def=TestErrorLocations.fst(97,28-97,33); use=TestErrorLocations.fst(97,28-97,33)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test_elim_forall, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; Starting query at TestErrorLocations.fst(102,2-104,16)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (p: Prims.prop) (q: Prims.prop). (*  - Could not prove post-condition
; *) p /\ q


; Context: While encoding a query
; While typechecking the top-level declaration `let test_elim_and`
; While typechecking the top-level declaration `[@@expect_failure] let test_elim_and`
...
;; def=FStar.Classical.Sugar.fsti(100,18-100,28); use=TestErrorLocations.fst(102,12-102,18)
(and 
;; def=TestErrorLocations.fst(101,19-101,20); use=TestErrorLocations.fst(102,12-102,13)
(or label_1
...
;; def=TestErrorLocations.fst(101,21-101,22); use=TestErrorLocations.fst(102,17-102,18)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test_elim_and, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; Starting query at TestErrorLocations.fst(108,2-110,16)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (p: Prims.prop) (q: Prims.prop) (_: Prims.squash p).
;   (*  - Could not prove post-condition
; *) p /\ q
...
;; def=FStar.Classical.Sugar.fsti(100,18-100,28); use=TestErrorLocations.fst(108,12-108,18)
(and 
;; def=TestErrorLocations.fst(107,19-107,20); use=TestErrorLocations.fst(108,12-108,13)
(or label_1
...
;; def=TestErrorLocations.fst(107,21-107,22); use=TestErrorLocations.fst(108,17-108,18)
(or label_2
...
; Starting query at TestErrorLocations.fst(114,2-117,17)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let test_elim_or`
; While typechecking the top-level declaration `[@@expect_failure] let test_elim_or`
...
;; def=FStar.Classical.Sugar.fsti(88,21-88,31); use=TestErrorLocations.fst(114,12-114,18)
(or label_1

;; def=TestErrorLocations.fst(113,18-113,19); use=TestErrorLocations.fst(114,12-114,13)
(Valid 
;; def=TestErrorLocations.fst(113,18-113,19); use=TestErrorLocations.fst(114,12-114,13)
@x0
)
...
;; def=TestErrorLocations.fst(113,20-113,21); use=TestErrorLocations.fst(114,17-114,18)
(Valid 
;; def=TestErrorLocations.fst(113,20-113,21); use=TestErrorLocations.fst(114,17-114,18)
@x1
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (TestErrorLocations.test_elim_or, 1)
; STATUS: unknown because (incomplete quantifiers)
