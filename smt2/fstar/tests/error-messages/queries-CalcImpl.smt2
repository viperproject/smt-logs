...
; Internals for CalcImpl


; encoding sigelt val CalcImpl.p


; <Start encoding val CalcImpl.p>

(declare-fun CalcImpl.p (Dummy_sort) Term)

; </end encoding val CalcImpl.p>


; encoding sigelt val CalcImpl.q


; <Start encoding val CalcImpl.q>

(declare-fun CalcImpl.q (Dummy_sort) Term)

; </end encoding val CalcImpl.q>


; encoding sigelt val CalcImpl.lem


; <Start encoding val CalcImpl.lem>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CalcImpl.lem (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CalcImpl.lem@tok () Term)

; </end encoding val CalcImpl.lem>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CalcImpl.q; Namespace CalcImpl
(assert (! 
;; def=CalcImpl.fst(6,11-6,12); use=CalcImpl.fst(6,11-6,12)
(forall ((@u0 Dummy_sort))
 (! (HasType (CalcImpl.q @u0)
Prims.prop)
 

:pattern ((CalcImpl.q @u0))
:qid typing_CalcImpl.q))

:named typing_CalcImpl.q))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CalcImpl.p; Namespace CalcImpl
(assert (! 
;; def=CalcImpl.fst(5,11-5,12); use=CalcImpl.fst(5,11-5,12)
(forall ((@u0 Dummy_sort))
 (! (HasType (CalcImpl.p @u0)
Prims.prop)
 

:pattern ((CalcImpl.p @u0))
:qid typing_CalcImpl.p))

:named typing_CalcImpl.p))
...
; Starting query at CalcImpl.fst(11,2-18,3)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;x3: Prims.logical -> y4: Prims.logical -> Type
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(204,15-204,22); use=CalcImpl.fst(11,2-18,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_d6fb6409bd568a391a313a1aa14bd76c))
:qid CalcImpl_pre_typing_Tm_arrow_d6fb6409bd568a391a313a1aa14bd76c))

:named CalcImpl_pre_typing_Tm_arrow_d6fb6409bd568a391a313a1aa14bd76c))
...
@x1)
@x2))
:qid CalcImpl_interpretation_Tm_arrow_d6fb6409bd568a391a313a1aa14bd76c.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CalcImpl_interpretation_Tm_arrow_d6fb6409bd568a391a313a1aa14bd76c.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_d6fb6409bd568a391a313a1aa14bd76c))
:qid CalcImpl_interpretation_Tm_arrow_d6fb6409bd568a391a313a1aa14bd76c))

:named CalcImpl_interpretation_Tm_arrow_d6fb6409bd568a391a313a1aa14bd76c))
...
;;; Fact-ids: 
(assert (! 
;; def=CalcImpl.fst(13,4-13,7); use=CalcImpl.fst(11,2-18,3)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;_: Prims.unit -> FStar.Calc.calc_pack [fun x3 y4 -> x3 ==> y4 <: Type] p q
(declare-fun Tm_arrow_1ac7483da177faf4658241d631dcc7d5 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1ac7483da177faf4658241d631dcc7d5
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_1ac7483da177faf4658241d631dcc7d5
Tm_type)
:named kinding_Tm_arrow_1ac7483da177faf4658241d631dcc7d5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcImpl.fst(11,2-18,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_1ac7483da177faf4658241d631dcc7d5)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_1ac7483da177faf4658241d631dcc7d5))
:qid CalcImpl_pre_typing_Tm_arrow_1ac7483da177faf4658241d631dcc7d5))

:named CalcImpl_pre_typing_Tm_arrow_1ac7483da177faf4658241d631dcc7d5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1ac7483da177faf4658241d631dcc7d5
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcImpl.fst(11,2-18,3)
(forall ((@x0 Term))
...
(CalcImpl.p Dummy_value)
(CalcImpl.q Dummy_value))))
 

:pattern ((ApplyTT @x0
@x1))
:qid CalcImpl_interpretation_Tm_arrow_1ac7483da177faf4658241d631dcc7d5.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_1ac7483da177faf4658241d631dcc7d5))
:qid CalcImpl_interpretation_Tm_arrow_1ac7483da177faf4658241d631dcc7d5))

:named CalcImpl_interpretation_Tm_arrow_1ac7483da177faf4658241d631dcc7d5))
...
;         (*  - Could not prove post-condition
; *)
;         forall (_: Prims.squash CalcImpl.p).
;           (*  - Could not prove post-condition
; *)
;           CalcImpl.p /\
;           (forall (pure_result: Prims.unit). CalcImpl.q ==> Prims.auto_squash CalcImpl.q)) /\
;   (forall (any_result:
;       (_: Prims.unit -> FStar.Calc.calc_pack [fun x3 y4 -> x3 ==> y4 <: Type0] CalcImpl.p CalcImpl.q
;       )).
...
;                 (exists (w: Prims.logical). x == w /\ (w ==> y)) ==> x ==> y)))
...
;; def=Prims.fst(459,77-459,89); use=CalcImpl.fst(11,2-18,3)
(and 
;; def=dummy(0,0-0,0); use=CalcImpl.fst(11,2-18,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.unit)
...
;; def=dummy(0,0-0,0); use=CalcImpl.fst(13,10-13,16)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Prims.squash (CalcImpl.p Dummy_value)))

;; def=Prims.fst(441,29-441,97); use=CalcImpl.fst(13,10-13,13)
(and 
;; def=CalcImpl.fst(8,41-8,42); use=CalcImpl.fst(13,10-13,13)
(or label_1
...
;; def=Prims.fst(441,36-441,97); use=CalcImpl.fst(13,10-13,13)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=CalcImpl.fst(8,53-8,54); use=CalcImpl.fst(13,10-13,13)
(Valid 
;; def=CalcImpl.fst(8,53-8,54); use=CalcImpl.fst(13,10-13,13)
(CalcImpl.q Dummy_value)
)
...
;; def=CalcImpl.fst(17,4-17,5); use=CalcImpl.fst(13,10-13,16)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=CalcImpl.fst(11,2-18,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Tm_arrow_1ac7483da177faf4658241d631dcc7d5)
...
;; def=FStar.Calc.fsti(47,14-47,15); use=CalcImpl.fst(11,2-18,3)
(or label_3
...
(declare-fun CalcImpl.test (Term) Term)

(declare-fun CalcImpl.test@tok () Term)

; </end encoding let test>


; encoding sigelt let any


; <Start encoding let any>

(declare-fun CalcImpl.any (Term Term Term Term) Term)

(declare-fun CalcImpl.any@tok () Term)

; </end encoding let any>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CalcImpl.any; Namespace CalcImpl
(assert (! 
;; def=CalcImpl.fst(20,4-20,7); use=CalcImpl.fst(20,4-20,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((CalcImpl.any @x0
@x1
@x2
@x3))
:qid typing_CalcImpl.any))

:named typing_CalcImpl.any))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;;;;;;;;;;;;;;;Equation for CalcImpl.any
;;; Fact-ids: Name CalcImpl.any; Namespace CalcImpl
(assert (! 
;; def=CalcImpl.fst(20,4-20,7); use=CalcImpl.fst(20,4-20,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Valid (CalcImpl.any @x0
@x1
@x2
@x3))

;; def=CalcImpl.fst(20,14-20,18); use=CalcImpl.fst(20,14-20,18)
true
)
...
@x2
@x3))
:qid equation_CalcImpl.any))

:named equation_CalcImpl.any))
;;;;;;;;;;;;;;;;Prop-typing for CalcImpl.any
;;; Fact-ids: Name CalcImpl.any; Namespace CalcImpl
(assert (! 
;; def=CalcImpl.fst(20,4-20,7); use=CalcImpl.fst(20,4-20,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
@x1))
(Valid (Prims.subtype_of (CalcImpl.any @x0
@x1
@x2
@x3)
Prims.unit)))
...
:pattern ((Prims.subtype_of (CalcImpl.any @x0
@x1
@x2
@x3)
Prims.unit))
:qid defn_equation_CalcImpl.any))

:named defn_equation_CalcImpl.any))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
;; def=Prims.fst(183,34-183,38); use=Prims.fst(183,34-183,38)
...
; Starting query at CalcImpl.fst(23,2-31,3)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(210,15-210,22); use=CalcImpl.fst(23,2-31,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d6fb6409bd568a391a313a1aa14bd76c)
...
;;; Fact-ids: 
(assert (! 
;; def=CalcImpl.fst(25,4-25,8); use=CalcImpl.fst(23,2-31,3)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;_: Prims.unit -> FStar.Calc.calc_pack [fun x3 y4 -> x3 <==> y4 <: Type] (p /\ p) p
(declare-fun Tm_arrow_448a6ff58be6750372dfe32d9c6a6125 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_448a6ff58be6750372dfe32d9c6a6125
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_448a6ff58be6750372dfe32d9c6a6125
Tm_type)
:named kinding_Tm_arrow_448a6ff58be6750372dfe32d9c6a6125))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcImpl.fst(23,2-31,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_448a6ff58be6750372dfe32d9c6a6125)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_448a6ff58be6750372dfe32d9c6a6125))
:qid CalcImpl_pre_typing_Tm_arrow_448a6ff58be6750372dfe32d9c6a6125))

:named CalcImpl_pre_typing_Tm_arrow_448a6ff58be6750372dfe32d9c6a6125))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_448a6ff58be6750372dfe32d9c6a6125
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcImpl.fst(23,2-31,3)
(forall ((@x0 Term))
...
(Prims.Nil (FStar.Preorder.relation Prims.logical)))
(Prims.l_and (CalcImpl.p Dummy_value)
(CalcImpl.p Dummy_value))
(CalcImpl.p Dummy_value))))
...
:pattern ((ApplyTT @x0
@x1))
:qid CalcImpl_interpretation_Tm_arrow_448a6ff58be6750372dfe32d9c6a6125.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_448a6ff58be6750372dfe32d9c6a6125))
:qid CalcImpl_interpretation_Tm_arrow_448a6ff58be6750372dfe32d9c6a6125))

:named CalcImpl_interpretation_Tm_arrow_448a6ff58be6750372dfe32d9c6a6125))
...
;;; Fact-ids: 
(assert (! 
;; def=CalcImpl.fst(27,4-27,7); use=CalcImpl.fst(23,2-31,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_c48debfbef21de4eddade3354cc7f3a4
@x0)
@x1)
...
;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.Calc.calc_pack [(fun x5 y6 -> x5 ==> y6 <: Type); fun x3 y4 -> x3 <==> y4 <: Type]       (p /\ p)       (q /\ q)
(declare-fun Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe
Tm_type)
:named kinding_Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcImpl.fst(23,2-31,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe))
:qid CalcImpl_pre_typing_Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe))

:named CalcImpl_pre_typing_Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcImpl.fst(23,2-31,3)
(forall ((@x0 Term))
...
(Prims.l_and (CalcImpl.p Dummy_value)
(CalcImpl.p Dummy_value))
(Prims.l_and (CalcImpl.q Dummy_value)
(CalcImpl.q Dummy_value)))))
 

:pattern ((ApplyTT @x0
@x1))
:qid CalcImpl_interpretation_Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe))
:qid CalcImpl_interpretation_Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe))

:named CalcImpl_interpretation_Tm_arrow_f9f18be0ffc8c8ef233137b5064f72fe))
...
;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.Calc.calc_pack [         (fun x7 y8 -> x7 <==> y8 <: Type);         (fun x5 y6 -> x5 ==> y6 <: Type);         fun x3 y4 -> x3 <==> y4 <: Type       ]       (p /\ p)       q
(declare-fun Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0
Tm_type)
:named kinding_Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcImpl.fst(23,2-31,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0))
:qid CalcImpl_pre_typing_Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0))

:named CalcImpl_pre_typing_Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcImpl.fst(23,2-31,3)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid CalcImpl_interpretation_Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0))
:qid CalcImpl_interpretation_Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0))

:named CalcImpl_interpretation_Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0))
...
;               forall (_: Prims.unit).
;                 (*  - Could not prove post-condition
; *) CalcImpl.p /\ CalcImpl.p <==> CalcImpl.p) /\
;           (forall (any_result:
;               (_: Prims.unit
;                   -> FStar.Calc.calc_pack [fun x3 y4 -> x3 <==> y4 <: Type0]
...
; *)
;                 CalcImpl.p /\
;                 (forall (pure_result: Prims.unit). CalcImpl.q ==> CalcImpl.q /\ CalcImpl.q))) /\
;       (forall (any_result:
;           (_: Prims.unit
;               -> FStar.Calc.calc_pack [
;                     (fun x5 y6 -> x5 ==> y6 <: Type0);
;                     fun x3 y4 -> x3 <==> y4 <: Type0
;                   ]
;                   (CalcImpl.p /\ CalcImpl.p)
;                   (CalcImpl.q /\ CalcImpl.q)))
;           (_: Prims.unit).
;           (*  - Could not prove post-condition
; *) CalcImpl.q /\ CalcImpl.q <==> CalcImpl.q)) /\
;   (forall (any_result:
;       (_: Prims.unit
;           -> FStar.Calc.calc_pack [
...
;                     (exists (w: Prims.logical).
;                         (exists (w: Prims.logical). x == w /\ (w <==> w)) /\ (w ==> w)) /\
;                     (w <==> y)) ==>
;                 CalcImpl.any x y)))
...
;; def=Prims.fst(459,77-459,89); use=CalcImpl.fst(23,2-31,3)
(and 
;; def=dummy(0,0-0,0); use=CalcImpl.fst(23,2-31,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.unit)
...
;; def=CalcImpl.fst(25,4-25,8); use=CalcImpl.fst(25,9-25,11)
(or label_1

;; def=CalcImpl.fst(25,4-25,8); use=CalcImpl.fst(25,9-25,11)
(iff 
;; def=CalcImpl.fst(24,4-24,10); use=CalcImpl.fst(25,9-25,11)
(and 
;; def=CalcImpl.fst(24,4-24,5); use=CalcImpl.fst(25,9-25,11)
(Valid 
;; def=CalcImpl.fst(24,4-24,5); use=CalcImpl.fst(25,9-25,11)
(CalcImpl.p Dummy_value)
)
...
;; def=CalcImpl.fst(24,9-24,10); use=CalcImpl.fst(25,9-25,11)
(Valid 
;; def=CalcImpl.fst(24,9-24,10); use=CalcImpl.fst(25,9-25,11)
(CalcImpl.p Dummy_value)
)
...
;; def=CalcImpl.fst(26,4-26,5); use=CalcImpl.fst(25,9-25,11)
(Valid 
;; def=CalcImpl.fst(26,4-26,5); use=CalcImpl.fst(25,9-25,11)
(CalcImpl.p Dummy_value)
)
...
;; def=Prims.fst(451,66-451,102); use=CalcImpl.fst(23,2-31,3)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_arrow_448a6ff58be6750372dfe32d9c6a6125)
...
;; def=dummy(0,0-0,0); use=CalcImpl.fst(27,10-27,16)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Prims.squash (CalcImpl.p Dummy_value)))

;; def=Prims.fst(441,29-441,97); use=CalcImpl.fst(27,10-27,13)
(and 
;; def=CalcImpl.fst(8,41-8,42); use=CalcImpl.fst(27,10-27,13)
(or label_2
...
;; def=Prims.fst(441,36-441,97); use=CalcImpl.fst(27,10-27,13)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=CalcImpl.fst(8,53-8,54); use=CalcImpl.fst(27,10-27,13)
(Valid 
;; def=CalcImpl.fst(8,53-8,54); use=CalcImpl.fst(27,10-27,13)
(CalcImpl.q Dummy_value)
)
...
;; def=CalcImpl.fst(28,4-28,10); use=CalcImpl.fst(27,10-27,16)
(and 
;; def=CalcImpl.fst(28,4-28,5); use=CalcImpl.fst(27,10-27,16)
(or label_3
...
;; def=CalcImpl.fst(28,9-28,10); use=CalcImpl.fst(27,10-27,16)
(or label_4
...
;; def=CalcImpl.fst(29,4-29,8); use=CalcImpl.fst(29,9-29,11)
(or label_5

;; def=CalcImpl.fst(29,4-29,8); use=CalcImpl.fst(29,9-29,11)
(iff 
;; def=CalcImpl.fst(28,4-28,10); use=CalcImpl.fst(29,9-29,11)
(and 
;; def=CalcImpl.fst(28,4-28,5); use=CalcImpl.fst(29,9-29,11)
(Valid 
;; def=CalcImpl.fst(28,4-28,5); use=CalcImpl.fst(29,9-29,11)
(CalcImpl.q Dummy_value)
)
...
;; def=CalcImpl.fst(28,9-28,10); use=CalcImpl.fst(29,9-29,11)
(Valid 
;; def=CalcImpl.fst(28,9-28,10); use=CalcImpl.fst(29,9-29,11)
(CalcImpl.q Dummy_value)
)
...
;; def=CalcImpl.fst(30,4-30,5); use=CalcImpl.fst(29,9-29,11)
(Valid 
;; def=CalcImpl.fst(30,4-30,5); use=CalcImpl.fst(29,9-29,11)
(CalcImpl.q Dummy_value)
)
...
;; def=CalcImpl.fst(29,4-29,8); use=CalcImpl.fst(23,2-31,3)
(iff 
;; def=FStar.Calc.fsti(42,24-42,25); use=FStar.Calc.fsti(42,62-42,63)
(Valid 
;; def=FStar.Calc.fsti(42,24-42,25); use=FStar.Calc.fsti(42,62-42,63)
...
;; def=CalcImpl.fst(23,7-23,10); use=CalcImpl.fst(23,2-31,3)
(or label_6

;; def=CalcImpl.fst(23,7-23,10); use=CalcImpl.fst(23,2-31,3)
(Valid 
;; def=CalcImpl.fst(23,7-23,10); use=CalcImpl.fst(23,2-31,3)
(CalcImpl.any Prims.logical
Prims.logical
@x2
@x3)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcImpl.test3, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_CalcImpl.any, equation_Prims.logical, equation_Prims.squash, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c
...
(declare-fun CalcImpl.test3 (Term) Term)

(declare-fun CalcImpl.test3@tok () Term)

; </end encoding let test3>

(push) ;; push{2

; Starting query at CalcImpl.fst(34,2-42,3)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(210,15-210,22); use=CalcImpl.fst(34,2-42,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d6fb6409bd568a391a313a1aa14bd76c)
...
;;; Fact-ids: 
(assert (! 
;; def=CalcImpl.fst(36,4-36,8); use=CalcImpl.fst(34,2-42,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_12446a25a3d2c18d1187e7d226782010
@x0)
@x1)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcImpl.fst(34,2-42,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_448a6ff58be6750372dfe32d9c6a6125)
...
;;; Fact-ids: 
(assert (! 
;; def=CalcImpl.fst(38,4-38,9); use=CalcImpl.fst(34,2-42,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_c48debfbef21de4eddade3354cc7f3a4
@x0)
@x1)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcImpl.fst(34,2-42,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4c8517eff3690b7c3a3d97a2e7b4fbf0)
...
;; def=Prims.fst(459,77-459,89); use=CalcImpl.fst(34,2-42,3)
(and 
;; def=dummy(0,0-0,0); use=CalcImpl.fst(34,2-42,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.unit)
...
;; def=CalcImpl.fst(36,4-36,8); use=CalcImpl.fst(36,9-36,11)
(or label_1

;; def=CalcImpl.fst(36,4-36,8); use=CalcImpl.fst(36,9-36,11)
(iff 
;; def=CalcImpl.fst(35,4-35,10); use=CalcImpl.fst(36,9-36,11)
(and 
;; def=CalcImpl.fst(35,4-35,5); use=CalcImpl.fst(36,9-36,11)
(Valid 
;; def=CalcImpl.fst(35,4-35,5); use=CalcImpl.fst(36,9-36,11)
(CalcImpl.p Dummy_value)
)
...
;; def=CalcImpl.fst(35,9-35,10); use=CalcImpl.fst(36,9-36,11)
(Valid 
;; def=CalcImpl.fst(35,9-35,10); use=CalcImpl.fst(36,9-36,11)
(CalcImpl.p Dummy_value)
)
...
;; def=CalcImpl.fst(37,4-37,5); use=CalcImpl.fst(36,9-36,11)
(Valid 
;; def=CalcImpl.fst(37,4-37,5); use=CalcImpl.fst(36,9-36,11)
(CalcImpl.p Dummy_value)
)
...
;; def=Prims.fst(451,66-451,102); use=CalcImpl.fst(34,2-42,3)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_arrow_448a6ff58be6750372dfe32d9c6a6125)
...
;; def=dummy(0,0-0,0); use=CalcImpl.fst(38,12-38,18)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Prims.squash (CalcImpl.p Dummy_value)))

;; def=Prims.fst(441,29-441,97); use=CalcImpl.fst(38,12-38,15)
(and 
;; def=CalcImpl.fst(8,41-8,42); use=CalcImpl.fst(38,12-38,15)
(or label_2
...
;; def=Prims.fst(441,36-441,97); use=CalcImpl.fst(38,12-38,15)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=CalcImpl.fst(8,53-8,54); use=CalcImpl.fst(38,12-38,15)
(Valid 
;; def=CalcImpl.fst(8,53-8,54); use=CalcImpl.fst(38,12-38,15)
(CalcImpl.q Dummy_value)
)
...
;; def=CalcImpl.fst(39,4-39,10); use=CalcImpl.fst(38,12-38,18)
(and 
;; def=CalcImpl.fst(39,4-39,5); use=CalcImpl.fst(38,12-38,18)
(or label_3
...
;; def=CalcImpl.fst(39,9-39,10); use=CalcImpl.fst(38,12-38,18)
(or label_4
...
;; def=CalcImpl.fst(40,4-40,8); use=CalcImpl.fst(40,9-40,11)
(or label_5

;; def=CalcImpl.fst(40,4-40,8); use=CalcImpl.fst(40,9-40,11)
(iff 
;; def=CalcImpl.fst(39,4-39,10); use=CalcImpl.fst(40,9-40,11)
(and 
;; def=CalcImpl.fst(39,4-39,5); use=CalcImpl.fst(40,9-40,11)
(Valid 
;; def=CalcImpl.fst(39,4-39,5); use=CalcImpl.fst(40,9-40,11)
(CalcImpl.q Dummy_value)
)
...
;; def=CalcImpl.fst(39,9-39,10); use=CalcImpl.fst(40,9-40,11)
(Valid 
;; def=CalcImpl.fst(39,9-39,10); use=CalcImpl.fst(40,9-40,11)
(CalcImpl.q Dummy_value)
)
...
;; def=CalcImpl.fst(41,4-41,5); use=CalcImpl.fst(40,9-40,11)
(Valid 
;; def=CalcImpl.fst(41,4-41,5); use=CalcImpl.fst(40,9-40,11)
(CalcImpl.q Dummy_value)
)
...
;; def=CalcImpl.fst(40,4-40,8); use=CalcImpl.fst(34,2-42,3)
(iff 
;; def=FStar.Calc.fsti(42,24-42,25); use=FStar.Calc.fsti(42,62-42,63)
(Valid 
;; def=FStar.Calc.fsti(42,24-42,25); use=FStar.Calc.fsti(42,62-42,63)
...
;; def=CalcImpl.fst(34,7-34,10); use=CalcImpl.fst(34,2-42,3)
(or label_6
...
(declare-fun CalcImpl.test4 (Term) Term)

(declare-fun CalcImpl.test4@tok () Term)

; </end encoding let test4>


; encoding sigelt let op_Equals_Equals_Greater


; <Start encoding let op_Equals_Equals_Greater>

(declare-fun CalcImpl.op_Equals_Equals_Greater (Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> _: Prims.int -> Prims.bool
(declare-fun Tm_arrow_a3e60d2a4d3886e67c6e6d54fdc03056 () Term)
(declare-fun CalcImpl.op_Equals_Equals_Greater@tok () Term)

; </end encoding let op_Equals_Equals_Greater>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CalcImpl.op_Equals_Equals_Greater; Namespace CalcImpl
(assert (! 
;; def=CalcImpl.fst(46,5-46,8); use=CalcImpl.fst(46,5-46,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
Prims.int))
(HasType (CalcImpl.op_Equals_Equals_Greater @x0
@x1)
Prims.bool))
 

:pattern ((CalcImpl.op_Equals_Equals_Greater @x0
@x1))
:qid typing_CalcImpl.op_Equals_Equals_Greater))

:named typing_CalcImpl.op_Equals_Equals_Greater))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;Equation for CalcImpl.op_Equals_Equals_Greater
;;; Fact-ids: Name CalcImpl.op_Equals_Equals_Greater; Namespace CalcImpl
(assert (! 
;; def=CalcImpl.fst(46,5-46,8); use=CalcImpl.fst(46,5-46,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (CalcImpl.op_Equals_Equals_Greater @x0
@x1)
(Prims.op_LessThan @x0
@x1))
...
:pattern ((CalcImpl.op_Equals_Equals_Greater @x0
@x1))
:qid equation_CalcImpl.op_Equals_Equals_Greater))

:named equation_CalcImpl.op_Equals_Equals_Greater))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
; Starting query at CalcImpl.fst(49,2-53,3)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;x3: Prims.int -> y4: Prims.int -> Type
(declare-fun Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0
Tm_type)
:named kinding_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(582,17-582,20); use=CalcImpl.fst(49,2-53,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))
:qid CalcImpl_pre_typing_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))

:named CalcImpl_pre_typing_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(582,17-582,20); use=CalcImpl.fst(49,2-53,3)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid CalcImpl_interpretation_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CalcImpl_interpretation_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))
:qid CalcImpl_interpretation_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))

:named CalcImpl_interpretation_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))
(declare-fun Tm_abs_763b8b791f55c111fff09d2f7c226194 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_763b8b791f55c111fff09d2f7c226194
;;; Fact-ids: 
(assert (! (HasType Tm_abs_763b8b791f55c111fff09d2f7c226194
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0)
:named typing_Tm_abs_763b8b791f55c111fff09d2f7c226194))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_763b8b791f55c111fff09d2f7c226194
;;; Fact-ids: 
(assert (! 
;; def=CalcImpl.fst(51,4-51,7); use=CalcImpl.fst(49,2-53,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_763b8b791f55c111fff09d2f7c226194
@x0)
@x1)
(Prims.b2t (CalcImpl.op_Equals_Equals_Greater @x0
@x1)))
 

:pattern ((ApplyTT (ApplyTT Tm_abs_763b8b791f55c111fff09d2f7c226194
@x0)
@x1))
:qid interpretation_Tm_abs_763b8b791f55c111fff09d2f7c226194))

:named interpretation_Tm_abs_763b8b791f55c111fff09d2f7c226194))
;;;;;;;;;;;;;;;;_: Prims.unit -> FStar.Calc.calc_pack [fun x3 y4 -> x3 ==> y4 <: Type] 1 2
(declare-fun Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52
Tm_type)
:named kinding_Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcImpl.fst(49,2-53,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52))
:qid CalcImpl_pre_typing_Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52))

:named CalcImpl_pre_typing_Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcImpl.fst(49,2-53,3)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(FStar.Calc.calc_pack Prims.int
(Prims.Cons (FStar.Preorder.relation Prims.int)
Tm_abs_763b8b791f55c111fff09d2f7c226194
(Prims.Nil (FStar.Preorder.relation Prims.int)))
(BoxInt 1)
(BoxInt 2))))
...
:pattern ((ApplyTT @x0
@x1))
:qid CalcImpl_interpretation_Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52))
:qid CalcImpl_interpretation_Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52))

:named CalcImpl_interpretation_Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52))
...
;       (*  - Could not prove post-condition
; *)
;       forall (_: Prims.unit). (*  - Could not prove post-condition
; *) 1 ==> 2) /\
;   (forall (any_result:
;       (_: Prims.unit -> FStar.Calc.calc_pack [fun x3 y4 -> x3 ==> y4 <: Type0] 1 2)).
;       Prims.auto_squash (FStar.Range.labeled (FStar.Sealed.seal FStar.Calc.fsti(86,37-86,50))
;             "Could not prove that this calc-chain is compatible"
;             (forall (x: Prims.int) (y: Prims.int).
;                 (exists (w: Prims.int). x == w /\ (w ==> y)) ==> x ==> y)))
...
;; def=Prims.fst(459,77-459,89); use=CalcImpl.fst(49,2-53,3)
(and 
;; def=dummy(0,0-0,0); use=CalcImpl.fst(49,2-53,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.unit)
...
;; def=CalcImpl.fst(51,4-51,7); use=CalcImpl.fst(51,8-51,10)
(or label_1

;; def=CalcImpl.fst(51,4-51,7); use=CalcImpl.fst(51,8-51,10)
(BoxBool_proj_0 (CalcImpl.op_Equals_Equals_Greater (BoxInt 1)
(BoxInt 2)))
)
)
...
;; def=Prims.fst(451,66-451,102); use=CalcImpl.fst(49,2-53,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Tm_arrow_a4e30af0c7d38eb78d3b04514b0cfc52)
...
;; def=CalcImpl.fst(51,4-51,7); use=CalcImpl.fst(49,2-53,3)
(BoxBool_proj_0 (CalcImpl.op_Equals_Equals_Greater @x4
@x3))
)
...
;; def=CalcImpl.fst(49,7-49,12); use=CalcImpl.fst(49,2-53,3)
(or label_2

;; def=CalcImpl.fst(49,7-49,12); use=CalcImpl.fst(49,2-53,3)
(BoxBool_proj_0 (CalcImpl.op_Equals_Equals_Greater @x2
@x3))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcImpl.test5, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_CalcImpl.op_Equals_Equals_Greater, primitive_Prims.op_LessThan, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0
