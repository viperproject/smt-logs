...
; Internals for Erasable


; encoding sigelt type Erasable.t


; <Start encoding type Erasable.t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Erasable.t () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Erasable.This (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Erasable.This__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Erasable.This
(declare-fun Erasable.This@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Erasable.That (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Erasable.That__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Erasable.That
(declare-fun Erasable.That@tok () Term)
;;;;;;;;;;;;;;;;_0: Prims.int -> t
(declare-fun Tm_arrow_350e6a7f60f2e7fecb5d1762a5ca8e04 () Term)
;;;;;;;;;;;;;;;;_0: Prims.bool -> t
(declare-fun Tm_arrow_0483772aef947c55f55e3064d8cda530 () Term)

; <start constructor Erasable.t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Erasable.t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(= __@x0
Erasable.t)))

; </end constructor Erasable.t>


; <start constructor Erasable.This>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Erasable.This ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
110)
(= __@x0
(Erasable.This (Erasable.This__0 __@x0)))))

; </end constructor Erasable.This>


; <start constructor Erasable.That>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Erasable.That ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
115)
(= __@x0
(Erasable.That (Erasable.That__0 __@x0)))))

; </end constructor Erasable.That>


; </end encoding type Erasable.t>


; encoding sigelt val Erasable.uu___is_This


; <Start encoding val Erasable.uu___is_This>

(declare-fun Erasable.uu___is_This (Term) Term)
;;;;;;;;;;;;;;;;projectee: t -> Prims.GTot Prims.bool
(declare-fun Tm_ghost_arrow_d524cbbf0d2150d440c88acd1fd590eb () Term)
(declare-fun Erasable.uu___is_This@tok () Term)

; </end encoding val Erasable.uu___is_This>


; encoding sigelt let uu___is_This


; <Skipped let uu___is_This/>


; encoding sigelt val Erasable.__proj__This__item___0


; <Start encoding val Erasable.__proj__This__item___0>

(declare-fun Tm_refine_3c192a2edf78cec4f1eb553cb69a4e8f () Term)
(declare-fun Erasable.__proj__This__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t{This? _} -> Prims.GTot Prims.int
(declare-fun Tm_ghost_arrow_f73021950da56ecb3eb35d1bb1760720 () Term)
(declare-fun Erasable.__proj__This__item___0@tok () Term)

; </end encoding val Erasable.__proj__This__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Erasable.uu___is_This; Namespace Erasable
(assert (! 
;; def=Erasable.fst(13,4-13,8); use=Erasable.fst(13,4-13,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Erasable.t)
(HasType (Erasable.uu___is_This @x0)
Prims.bool))
 

:pattern ((Erasable.uu___is_This @x0))
:qid typing_Erasable.uu___is_This))

:named typing_Erasable.uu___is_This))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Erasable.t; Namespace Erasable; Name Erasable.This; Namespace Erasable; Name Erasable.That; Namespace Erasable
(assert (! 
;; def=Erasable.fst(13,4-13,8); use=Erasable.fst(13,4-13,8)
...
(Erasable.This @x1)
Erasable.t))
:qid subterm_ordering_Erasable.This))

:named subterm_ordering_Erasable.This))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Erasable.t; Namespace Erasable; Name Erasable.This; Namespace Erasable; Name Erasable.That; Namespace Erasable
(assert (! 
;; def=Erasable.fst(14,4-14,8); use=Erasable.fst(14,4-14,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Erasable.That @x1)
Erasable.t)
...
(Erasable.That @x1)
Erasable.t))
:qid subterm_ordering_Erasable.That))

:named subterm_ordering_Erasable.That))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Erasable.__proj__This__item___0; Namespace Erasable
(assert (! (HasType Tm_refine_3c192a2edf78cec4f1eb553cb69a4e8f
Tm_type)
:named refinement_kinding_Tm_refine_3c192a2edf78cec4f1eb553cb69a4e8f))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_3c192a2edf78cec4f1eb553cb69a4e8f)
(and (HasTypeFuel @u0
@x1
Erasable.t)

;; def=Erasable.fst(13,4-13,8); use=Erasable.fst(13,4-13,8)
(BoxBool_proj_0 (Erasable.uu___is_This @x1))
))
...
@x1
Tm_refine_3c192a2edf78cec4f1eb553cb69a4e8f))
:qid refinement_interpretation_Tm_refine_3c192a2edf78cec4f1eb553cb69a4e8f))

:named refinement_interpretation_Tm_refine_3c192a2edf78cec4f1eb553cb69a4e8f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
...
;; def=Erasable.fst(13,4-13,8); use=Erasable.fst(13,4-13,8)
(forall ((@x0 Term))
 (! (= (Erasable.This__0 (Erasable.This @x0))
@x0)
 

:pattern ((Erasable.This @x0))
:qid projection_inverse_Erasable.This__0))

:named projection_inverse_Erasable.This__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Erasable.t; Namespace Erasable; Name Erasable.This; Namespace Erasable; Name Erasable.That; Namespace Erasable
(assert (! 
;; def=Erasable.fst(14,4-14,8); use=Erasable.fst(14,4-14,8)
(forall ((@x0 Term))
 (! (= (Erasable.That__0 (Erasable.That @x0))
@x0)
 

:pattern ((Erasable.That @x0))
:qid projection_inverse_Erasable.That__0))

:named projection_inverse_Erasable.That__0))
;;; Fact-ids: Name Erasable.t; Namespace Erasable; Name Erasable.This; Namespace Erasable; Name Erasable.That; Namespace Erasable
(assert (! (HasType Erasable.t
Tm_type)
:named kinding_Erasable.t@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_3c192a2edf78cec4f1eb553cb69a4e8f
;;; Fact-ids: Name Erasable.__proj__This__item___0; Namespace Erasable
(assert (! (iff (Valid (Prims.hasEq Tm_refine_3c192a2edf78cec4f1eb553cb69a4e8f))
(Valid (Prims.hasEq Erasable.t)))
:named haseqTm_refine_3c192a2edf78cec4f1eb553cb69a4e8f))
...
;;; Fact-ids: Name Erasable.t; Namespace Erasable; Name Erasable.This; Namespace Erasable; Name Erasable.That; Namespace Erasable
(assert (! 
;; def=Erasable.fst(12,5-12,6); use=Erasable.fst(12,5-12,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Erasable.t)
(or (is-Erasable.This @x1)
(is-Erasable.That @x1)))
...
@x1
Erasable.t))
:qid fuel_guarded_inversion_Erasable.t))

:named fuel_guarded_inversion_Erasable.t))
...
;; def=Erasable.fst(13,4-13,8); use=Erasable.fst(13,4-13,8)
(forall ((@x0 Term))
 (! (= (Erasable.uu___is_This @x0)
(BoxBool (is-Erasable.This @x0)))
 

:pattern ((Erasable.uu___is_This @x0))
:qid disc_equation_Erasable.This))

:named disc_equation_Erasable.This))
...
(Erasable.This @x1)
Erasable.t))
:qid data_typing_intro_Erasable.This@tok))

:named data_typing_intro_Erasable.This@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Erasable.t; Namespace Erasable; Name Erasable.This; Namespace Erasable; Name Erasable.That; Namespace Erasable
(assert (! 
;; def=Erasable.fst(14,4-14,8); use=Erasable.fst(14,4-14,8)
...
(Erasable.That @x1)
Erasable.t))
:qid data_typing_intro_Erasable.That@tok))

:named data_typing_intro_Erasable.That@tok))
...
(Erasable.This @x1)
Erasable.t))
:qid data_elim_Erasable.This))

:named data_elim_Erasable.This))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Erasable.t; Namespace Erasable; Name Erasable.This; Namespace Erasable; Name Erasable.That; Namespace Erasable
(assert (! 
;; def=Erasable.fst(14,4-14,8); use=Erasable.fst(14,4-14,8)
...
(Erasable.That @x1)
Erasable.t))
:qid data_elim_Erasable.That))

:named data_elim_Erasable.That))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Erasable.t; Namespace Erasable; Name Erasable.This; Namespace Erasable; Name Erasable.That; Namespace Erasable
(assert (! (= 104
(Term_constr_id Erasable.t))
:named constructor_distinct_Erasable.t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Erasable.t; Namespace Erasable; Name Erasable.This; Namespace Erasable; Name Erasable.That; Namespace Erasable
(assert (! 
;; def=Erasable.fst(13,4-13,8); use=Erasable.fst(13,4-13,8)
(forall ((@x0 Term))
 (! (= 110
(Term_constr_id (Erasable.This @x0)))
 

:pattern ((Erasable.This @x0))
:qid constructor_distinct_Erasable.This))

:named constructor_distinct_Erasable.This))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Erasable.t; Namespace Erasable; Name Erasable.This; Namespace Erasable; Name Erasable.That; Namespace Erasable
(assert (! 
;; def=Erasable.fst(14,4-14,8); use=Erasable.fst(14,4-14,8)
(forall ((@x0 Term))
 (! (= 115
(Term_constr_id (Erasable.That @x0)))
 

:pattern ((Erasable.That @x0))
:qid constructor_distinct_Erasable.That))

:named constructor_distinct_Erasable.That))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x0
Erasable.t))
:qid Erasable_pretyping_af53481e089c59f860cd8013a192602d))

:named Erasable_pretyping_af53481e089c59f860cd8013a192602d))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: Erasable.t{This? _}).
;   (*  - Could not prove post-condition
; *)
;   forall (any_result: Prims.bool). ~(This? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__This__item___0`
...
;; def=Prims.fst(451,66-451,102); use=Prims.fst(490,33-490,46)
(forall ((@x1 Term))
...
(not 
;; def=Erasable.fst(13,4-13,8); use=Erasable.fst(13,4-13,8)
(BoxBool_proj_0 (Erasable.uu___is_This @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Erasable.__proj__This__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_3c192a2edf78cec4f1eb553cb69a4e8f
...
; encoding sigelt let __proj__This__item___0


; <Skipped let __proj__This__item___0/>


; encoding sigelt val Erasable.uu___is_That


; <Start encoding val Erasable.uu___is_That>

(declare-fun Erasable.uu___is_That (Term) Term)

(declare-fun Erasable.uu___is_That@tok () Term)

; </end encoding val Erasable.uu___is_That>


; encoding sigelt let uu___is_That


; <Skipped let uu___is_That/>


; encoding sigelt val Erasable.__proj__That__item___0


; <Start encoding val Erasable.__proj__That__item___0>

(declare-fun Tm_refine_ec597d6979f8847712206596e24a9e2d () Term)
(declare-fun Erasable.__proj__That__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t{That? _} -> Prims.GTot Prims.bool
(declare-fun Tm_ghost_arrow_f1a0c8cd3c22afb7e5dc0230c276423a () Term)
(declare-fun Erasable.__proj__That__item___0@tok () Term)

; </end encoding val Erasable.__proj__That__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Erasable.uu___is_That; Namespace Erasable
(assert (! 
;; def=Erasable.fst(14,4-14,8); use=Erasable.fst(14,4-14,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Erasable.t)
(HasType (Erasable.uu___is_That @x0)
Prims.bool))
 

:pattern ((Erasable.uu___is_That @x0))
:qid typing_Erasable.uu___is_That))

:named typing_Erasable.uu___is_That))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Erasable.__proj__That__item___0; Namespace Erasable
(assert (! (HasType Tm_refine_ec597d6979f8847712206596e24a9e2d
Tm_type)
:named refinement_kinding_Tm_refine_ec597d6979f8847712206596e24a9e2d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Erasable.__proj__That__item___0; Namespace Erasable
(assert (! 
;; def=Erasable.fst(14,4-14,8); use=Erasable.fst(14,4-14,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ec597d6979f8847712206596e24a9e2d)
(and (HasTypeFuel @u0
@x1
Erasable.t)

;; def=Erasable.fst(14,4-14,8); use=Erasable.fst(14,4-14,8)
(BoxBool_proj_0 (Erasable.uu___is_That @x1))
))
...
@x1
Tm_refine_ec597d6979f8847712206596e24a9e2d))
:qid refinement_interpretation_Tm_refine_ec597d6979f8847712206596e24a9e2d))

:named refinement_interpretation_Tm_refine_ec597d6979f8847712206596e24a9e2d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ec597d6979f8847712206596e24a9e2d
;;; Fact-ids: Name Erasable.__proj__That__item___0; Namespace Erasable
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ec597d6979f8847712206596e24a9e2d))
(Valid (Prims.hasEq Erasable.t)))
:named haseqTm_refine_ec597d6979f8847712206596e24a9e2d))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Erasable.uu___is_That; Namespace Erasable
(assert (! 
;; def=Erasable.fst(14,4-14,8); use=Erasable.fst(14,4-14,8)
(forall ((@x0 Term))
 (! (= (Erasable.uu___is_That @x0)
(BoxBool (is-Erasable.That @x0)))
 

:pattern ((Erasable.uu___is_That @x0))
:qid disc_equation_Erasable.That))

:named disc_equation_Erasable.That))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: Erasable.t{That? _}).
;   (*  - Could not prove post-condition
; *)
;   forall (any_result: Prims.bool). ~(That? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__That__item___0`
...
(not 
;; def=Erasable.fst(14,4-14,8); use=Erasable.fst(14,4-14,8)
(BoxBool_proj_0 (Erasable.uu___is_That @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Erasable.__proj__That__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_ec597d6979f8847712206596e24a9e2d
...
; encoding sigelt let __proj__That__item___0


; <Skipped let __proj__That__item___0/>
...
; Starting query at Erasable.fst(23,2-25,15)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Erasable.t).
;   (*  - Could not prove post-condition
; *)
;   forall (any_result: Prims.bool) (k: Prims.pure_post Prims.int).
;     (forall (x: Prims.int). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(This? x) /\ ~(That? x) ==> Prims.l_False
...
;; def=Prims.fst(451,66-451,102); use=Erasable.fst(23,2-25,15)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.bool)
(forall ((@x2 Term))
...
;; def=Prims.fst(402,27-402,88); use=Erasable.fst(23,2-25,15)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Erasable.fst(23,2-25,15)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Erasable.fst(23,2-25,15)
(ApplyTT @x2
@x3)
...
;; def=Erasable.fst(22,10-22,11); use=Erasable.fst(23,8-23,9)
(not 
;; def=Erasable.fst(22,10-22,11); use=Erasable.fst(23,8-23,9)
(BoxBool_proj_0 (Erasable.uu___is_This @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Erasable.test, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Erasable.That, disc_equation_Erasable.This, fuel_guarded_inversion_Erasable.t, projection_inverse_BoxBool_proj_0
...
(declare-fun Erasable.test (Term) Term)
;;;;;;;;;;;;;;;;x: t -> Prims.GTot Prims.int
(declare-fun Tm_ghost_arrow_354432ba9b2869d9085ce82ba87263df () Term)
(declare-fun Erasable.test@tok () Term)
...
(declare-fun Erasable.test1 (Term) Term)


(declare-fun Erasable.test1@tok () Term)
...
; Starting query at Erasable.fst(32,2-34,26)
...
;   (*  - Could not prove post-condition
; *)
;   forall (any_result: Prims.bool) (k: Prims.pure_post Erasable.t).
;     (forall (x: Erasable.t). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(This? x) /\ ~(That? x) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let test_promotion`
...
;; def=Prims.fst(451,66-451,102); use=Erasable.fst(32,2-34,26)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.bool)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.pure_post Erasable.t))

;; def=Prims.fst(402,27-402,88); use=Erasable.fst(32,2-34,26)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Erasable.fst(32,2-34,26)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Erasable.fst(32,2-34,26)
(ApplyTT @x2
@x3)
...
;; def=Erasable.fst(31,20-31,21); use=Erasable.fst(32,8-32,9)
(not 
;; def=Erasable.fst(31,20-31,21); use=Erasable.fst(32,8-32,9)
(BoxBool_proj_0 (Erasable.uu___is_This @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Erasable.test_promotion, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Erasable.That, disc_equation_Erasable.This, fuel_guarded_inversion_Erasable.t, projection_inverse_BoxBool_proj_0
