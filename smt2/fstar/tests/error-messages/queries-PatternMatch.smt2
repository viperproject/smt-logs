...
(declare-fun PatternMatch.uu___0 (Term) Term)
;;;;;;;;;;;;;;;;_: _ -> _: _ -> Prims.bool
...
(declare-fun PatternMatch.uu___0@tok () Term)


; </end encoding let uu___0>


; encoding sigelt let pair_on_arg


; <Start encoding let pair_on_arg>

(declare-fun PatternMatch.pair_on_arg (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int & Prims.int -> Prims.int
(declare-fun Tm_arrow_87c99612a960de2325070043686d8c4b () Term)
(declare-fun PatternMatch.pair_on_arg@tok () Term)

; </end encoding let pair_on_arg>


; encoding sigelt type PatternMatch.ab


; <Start encoding type PatternMatch.ab>

;;;;;;;;;;;;;;;;Constructor
(declare-fun PatternMatch.ab () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PatternMatch.A () Term)
;;;;;;;;;;;;;;;;data constructor proxy: PatternMatch.A
(declare-fun PatternMatch.A@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PatternMatch.B () Term)
;;;;;;;;;;;;;;;;data constructor proxy: PatternMatch.B
(declare-fun PatternMatch.B@tok () Term)

; <start constructor PatternMatch.ab>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PatternMatch.ab ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
130)
(= __@x0
PatternMatch.ab)))

; </end constructor PatternMatch.ab>


; <start constructor PatternMatch.A>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PatternMatch.A ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
136)
(= __@x0
PatternMatch.A)))

; </end constructor PatternMatch.A>


; <start constructor PatternMatch.B>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PatternMatch.B ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
138)
(= __@x0
PatternMatch.B)))

; </end constructor PatternMatch.B>


; </end encoding type PatternMatch.ab>


; encoding sigelt assume PatternMatch.ab__uu___haseq


; <Start encoding assume PatternMatch.ab__uu___haseq>


; </end encoding assume PatternMatch.ab__uu___haseq>


; encoding sigelt val PatternMatch.uu___is_A


; <Start encoding val PatternMatch.uu___is_A>

(declare-fun PatternMatch.uu___is_A (Term) Term)
;;;;;;;;;;;;;;;;projectee: ab -> Prims.bool
(declare-fun Tm_arrow_7a0aa2080e2efb9c0f1bed2e6f499130 () Term)
(declare-fun PatternMatch.uu___is_A@tok () Term)

; </end encoding val PatternMatch.uu___is_A>
...
; encoding sigelt val PatternMatch.uu___is_B


; <Start encoding val PatternMatch.uu___is_B>

(declare-fun PatternMatch.uu___is_B (Term) Term)

(declare-fun PatternMatch.uu___is_B@tok () Term)

; </end encoding val PatternMatch.uu___is_B>
...
(declare-fun PatternMatch.uu___1 (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.uu___1; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.uu___1 @u0)
(FStar.Pervasives.Native.option Prims.int))
 

:pattern ((PatternMatch.uu___1 @u0))
:qid typing_PatternMatch.uu___1))
:named typing_PatternMatch.uu___1))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Equation for PatternMatch.uu___1
;;; Fact-ids: Name PatternMatch.uu___1; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (PatternMatch.uu___1 @u0)
(FStar.Pervasives.Native.Some Prims.int
(BoxInt 42)))
 

:pattern ((PatternMatch.uu___1 @u0))
:qid equation_PatternMatch.uu___1))
:named equation_PatternMatch.uu___1))
...
; Encoding query formula : ~(None? _) ==> Prims.l_False
...
; While typechecking the top-level declaration `[@@expect_failure] let uu___1`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=PatternMatch.fst(21,4-21,8); use=PatternMatch.fst(21,4-21,8)
(not 
;; def=PatternMatch.fst(21,4-21,8); use=PatternMatch.fst(21,4-21,8)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None Prims.int
(PatternMatch.uu___1 Dummy_value)))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatternMatch.uu___2, 1)
...
(declare-fun PatternMatch.uu___1 (Term) Term)

(declare-fun PatternMatch.uu___1@tok () Term)
...
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (PatternMatch.uu___1 @x0)
(FStar.Pervasives.Native.option @x0)))
 

:pattern ((PatternMatch.uu___1 @x0))
:qid typing_PatternMatch.uu___1))
:named typing_PatternMatch.uu___1))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Pervasives.Native.uu___is_Some; Namespace FStar.Pervasives.Native
...
; Encoding query formula : ~(Some? _) ==> Prims.l_False
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=PatternMatch.fst(24,4-24,11); use=PatternMatch.fst(24,4-24,11)
(not 
;; def=PatternMatch.fst(24,4-24,11); use=PatternMatch.fst(24,4-24,11)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some Prims.unit
(PatternMatch.uu___1 Prims.unit)))
)
...
; Encoding query formula : ~(_ = true) ==> Prims.l_False
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=PatternMatch.fst(26,4-26,8); use=PatternMatch.fst(26,4-26,8)
(not 
;; def=PatternMatch.fst(26,4-26,8); use=PatternMatch.fst(26,4-26,8)
(= (PatternMatch.uu___1 Dummy_value)
(BoxBool true))
...
; QUERY ID: (PatternMatch.uu___2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_PatternMatch.uu___1
...
(declare-fun PatternMatch.uu___2 (Dummy_sort) Term)
...
(declare-fun PatternMatch.uu___3 (Dummy_sort) Term)

; </end encoding let uu___3>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.uu___3; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.uu___3 @u0)
Prims.bool)
 

:pattern ((PatternMatch.uu___3 @u0))
:qid typing_PatternMatch.uu___3))
:named typing_PatternMatch.uu___3))
;;;;;;;;;;;;;;;;Equation for PatternMatch.uu___3
;;; Fact-ids: Name PatternMatch.uu___3; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (PatternMatch.uu___3 @u0)
(BoxBool false))
 

:pattern ((PatternMatch.uu___3 @u0))
:qid equation_PatternMatch.uu___3))
:named equation_PatternMatch.uu___3))
(push) ;; push{3
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let uu___4`
; While typechecking the top-level declaration `[@@expect_failure] let uu___3`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=PatternMatch.fst(29,4-29,8); use=PatternMatch.fst(29,4-29,8)
(not 
;; def=PatternMatch.fst(29,4-29,8); use=PatternMatch.fst(29,4-29,8)
(= (PatternMatch.uu___3 Dummy_value)
(BoxBool true))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatternMatch.uu___4, 1)
; STATUS: unknown because (incomplete quantifiers)
...
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! (HasType PatternMatch.B@tok
PatternMatch.ab)
:named typing_tok_PatternMatch.B@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! (HasType PatternMatch.A@tok
PatternMatch.ab)
:named typing_tok_PatternMatch.A@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.uu___is_A; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(12,12-12,13); use=PatternMatch.fst(12,12-12,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
PatternMatch.ab)
(HasType (PatternMatch.uu___is_A @x0)
Prims.bool))
 

:pattern ((PatternMatch.uu___is_A @x0))
:qid typing_PatternMatch.uu___is_A))

:named typing_PatternMatch.uu___is_A))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.uu___3; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.uu___3 @u0)
...
:named typing_PatternMatch.uu___3))
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! (HasType PatternMatch.ab
Tm_type)
:named kinding_PatternMatch.ab@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(12,5-12,7); use=PatternMatch.fst(12,5-12,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
PatternMatch.ab)
(or (is-PatternMatch.A @x1)
(is-PatternMatch.B @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
PatternMatch.ab))
:qid fuel_guarded_inversion_PatternMatch.ab))

:named fuel_guarded_inversion_PatternMatch.ab))
;;;;;;;;;;;;;;;;Equation for PatternMatch.uu___3
;;; Fact-ids: Name PatternMatch.uu___3; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (PatternMatch.uu___3 @u0)
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! (= PatternMatch.B@tok
PatternMatch.B)
:named equality_tok_PatternMatch.B@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! (= PatternMatch.A@tok
PatternMatch.A)
:named equality_tok_PatternMatch.A@tok))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name PatternMatch.uu___is_A; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(12,12-12,13); use=PatternMatch.fst(12,12-12,13)
(forall ((@x0 Term))
 (! (= (PatternMatch.uu___is_A @x0)
(BoxBool (is-PatternMatch.A @x0)))
 

:pattern ((PatternMatch.uu___is_A @x0))
:qid disc_equation_PatternMatch.A))

:named disc_equation_PatternMatch.A))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(12,16-12,17); use=PatternMatch.fst(12,16-12,17)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
PatternMatch.B
PatternMatch.ab)
...
PatternMatch.B
PatternMatch.ab))
:qid data_typing_intro_PatternMatch.B@tok))

:named data_typing_intro_PatternMatch.B@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(12,12-12,13); use=PatternMatch.fst(12,12-12,13)
...
PatternMatch.A
PatternMatch.ab))
:qid data_typing_intro_PatternMatch.A@tok))

:named data_typing_intro_PatternMatch.A@tok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! (= 130
(Term_constr_id PatternMatch.ab))
:named constructor_distinct_PatternMatch.ab))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! (= 138
(Term_constr_id PatternMatch.B))
:named constructor_distinct_PatternMatch.B))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! (= 136
(Term_constr_id PatternMatch.A))
:named constructor_distinct_PatternMatch.A))
;;;;;;;;;;;;;;;;Assumption: PatternMatch.ab__uu___haseq
;;; Fact-ids: Name PatternMatch.ab__uu___haseq; Namespace PatternMatch
(assert (! (Valid (Prims.hasEq PatternMatch.ab))
:named assumption_PatternMatch.ab__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name PatternMatch.ab; Namespace PatternMatch; Name PatternMatch.A; Namespace PatternMatch; Name PatternMatch.B; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(12,5-12,7); use=PatternMatch.fst(12,5-12,7)
...
@x0
PatternMatch.ab))
:qid PatternMatch_pretyping_da8b16f6d9eb9f832f26e61517dd0b67))

:named PatternMatch_pretyping_da8b16f6d9eb9f832f26e61517dd0b67))
(push) ;; push{3
...
; Encoding query formula : ~(A? _) ==> Prims.l_False
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=PatternMatch.fst(38,4-38,5); use=PatternMatch.fst(38,4-38,5)
(not 
;; def=PatternMatch.fst(38,4-38,5); use=PatternMatch.fst(38,4-38,5)
(BoxBool_proj_0 (PatternMatch.uu___is_A (PatternMatch.uu___3 Dummy_value)))
)
...
; encoding sigelt let x1


; <Start encoding let x1>

(declare-fun PatternMatch.x1 (Dummy_sort) Term)

; </end encoding let x1>


; encoding sigelt let y1


; <Start encoding let y1>

(declare-fun PatternMatch.y1 (Dummy_sort) Term)
...
(declare-fun PatternMatch.uu___4 (Dummy_sort) Term)

; </end encoding let uu___4>


; encoding sigelt let x2


; <Start encoding let x2>

(declare-fun PatternMatch.x2 (Dummy_sort) Term)

; </end encoding let x2>


; encoding sigelt let y2


; <Start encoding let y2>

(declare-fun PatternMatch.y2 (Dummy_sort) Term)
...
:named typing_Prims.int))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.x1; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(43,4-43,6); use=PatternMatch.fst(43,4-43,6)
(forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.x1 @u0)
Prims.int)
 

:pattern ((PatternMatch.x1 @u0))
:qid typing_PatternMatch.x1))

:named typing_PatternMatch.x1))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.uu___3; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.uu___3 @u0)
...
(let ((@lb1 (PatternMatch.uu___3 Dummy_value)))
(FStar.Pervasives.Native.Mktuple2__1 @lb1)))
...
:qid equation_PatternMatch.x1))

:named equation_PatternMatch.x1))
;;;;;;;;;;;;;;;;Equation for PatternMatch.uu___3
;;; Fact-ids: Name PatternMatch.uu___3; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (PatternMatch.uu___3 @u0)
...
; Starting query at PatternMatch.fst(46,0-46,25)

(declare-fun label_1 () Bool)

; Encoding query formula : PatternMatch.x1 == 42


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let uu___5`
...
;;; Fact-ids: 
(assert (! (not 
;; def=PatternMatch.fst(46,15-46,25); use=PatternMatch.fst(46,8-46,14)
(or label_1

;; def=PatternMatch.fst(46,15-46,25); use=PatternMatch.fst(46,8-46,14)
(= (PatternMatch.x1 Dummy_value)
(BoxInt 42))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatternMatch.uu___5, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, equation_PatternMatch.uu___3, equation_PatternMatch.x1, function_token_typing_Prims.__cache_version_number__, projection_inverse_FStar.Pervasives.Native.Mktuple2__1
...
(declare-fun PatternMatch.uu___5 (Dummy_sort) Term)

; </end encoding let uu___5>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.y1; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(43,8-43,10); use=PatternMatch.fst(43,8-43,10)
(forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.y1 @u0)
Prims.bool)
 

:pattern ((PatternMatch.y1 @u0))
:qid typing_PatternMatch.y1))

:named typing_PatternMatch.y1))
;;;;;;;;;;;;;;;;Equation for PatternMatch.y1
;;; Fact-ids: Name PatternMatch.y1; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(43,8-43,10); use=PatternMatch.fst(43,8-43,10)
(forall ((@u0 Dummy_sort))
...
(let ((@lb1 (PatternMatch.uu___3 Dummy_value)))
(FStar.Pervasives.Native.Mktuple2__2 @lb1)))
...
:qid equation_PatternMatch.y1))

:named equation_PatternMatch.y1))
(push) ;; push{2

; Starting query at PatternMatch.fst(47,0-47,27)

(declare-fun label_1 () Bool)

; Encoding query formula : PatternMatch.y1 == true


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let uu___6`
...
;;; Fact-ids: 
(assert (! (not 
;; def=PatternMatch.fst(47,15-47,27); use=PatternMatch.fst(47,8-47,14)
(or label_1

;; def=PatternMatch.fst(47,15-47,27); use=PatternMatch.fst(47,8-47,14)
(= (PatternMatch.y1 Dummy_value)
(BoxBool true))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatternMatch.uu___6, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, equation_PatternMatch.uu___3, equation_PatternMatch.y1, function_token_typing_Prims.__cache_version_number__, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
(declare-fun PatternMatch.uu___6 (Dummy_sort) Term)

; </end encoding let uu___6>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.x2; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(44,6-44,8); use=PatternMatch.fst(44,6-44,8)
(forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.x2 @u0)
Prims.int)
 

:pattern ((PatternMatch.x2 @u0))
:qid typing_PatternMatch.x2))

:named typing_PatternMatch.x2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.uu___4; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.uu___4 @u0)
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.bool))
 

:pattern ((PatternMatch.uu___4 @u0))
:qid typing_PatternMatch.uu___4))
:named typing_PatternMatch.uu___4))
;;;;;;;;;;;;;;;;Equation for PatternMatch.x2
;;; Fact-ids: Name PatternMatch.x2; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(44,6-44,8); use=PatternMatch.fst(44,6-44,8)
(forall ((@u0 Dummy_sort))
...
(let ((@lb1 (PatternMatch.uu___4 Dummy_value)))
(FStar.Pervasives.Native.Mktuple2__1 @lb1)))
...
:qid equation_PatternMatch.x2))

:named equation_PatternMatch.x2))
;;;;;;;;;;;;;;;;Equation for PatternMatch.uu___4
;;; Fact-ids: Name PatternMatch.uu___4; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (PatternMatch.uu___4 @u0)
(FStar.Pervasives.Native.Mktuple2 Prims.int
Prims.bool
(BoxInt 42)
(BoxBool true)))
...
:pattern ((PatternMatch.uu___4 @u0))
:qid equation_PatternMatch.uu___4))
:named equation_PatternMatch.uu___4))
(push) ;; push{2

; Starting query at PatternMatch.fst(48,0-48,25)

(declare-fun label_1 () Bool)

; Encoding query formula : PatternMatch.x2 == 42


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let uu___7`
...
;;; Fact-ids: 
(assert (! (not 
;; def=PatternMatch.fst(48,15-48,25); use=PatternMatch.fst(48,8-48,14)
(or label_1

;; def=PatternMatch.fst(48,15-48,25); use=PatternMatch.fst(48,8-48,14)
(= (PatternMatch.x2 Dummy_value)
(BoxInt 42))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatternMatch.uu___7, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, equation_PatternMatch.uu___4, equation_PatternMatch.x2, function_token_typing_Prims.__cache_version_number__, projection_inverse_FStar.Pervasives.Native.Mktuple2__1
...
(declare-fun PatternMatch.uu___7 (Dummy_sort) Term)

; </end encoding let uu___7>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.y2; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(44,18-44,20); use=PatternMatch.fst(44,18-44,20)
(forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.y2 @u0)
Prims.bool)
 

:pattern ((PatternMatch.y2 @u0))
:qid typing_PatternMatch.y2))

:named typing_PatternMatch.y2))
;;;;;;;;;;;;;;;;Equation for PatternMatch.y2
;;; Fact-ids: Name PatternMatch.y2; Namespace PatternMatch
(assert (! 
;; def=PatternMatch.fst(44,18-44,20); use=PatternMatch.fst(44,18-44,20)
(forall ((@u0 Dummy_sort))
...
:qid equation_PatternMatch.y2))

:named equation_PatternMatch.y2))
(push) ;; push{2

; Starting query at PatternMatch.fst(49,0-49,27)

(declare-fun label_1 () Bool)

; Encoding query formula : PatternMatch.y2 == true


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let uu___8`
...
;;; Fact-ids: 
(assert (! (not 
;; def=PatternMatch.fst(49,15-49,27); use=PatternMatch.fst(49,8-49,14)
(or label_1

;; def=PatternMatch.fst(49,15-49,27); use=PatternMatch.fst(49,8-49,14)
(= (PatternMatch.y2 Dummy_value)
(BoxBool true))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatternMatch.uu___8, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, equation_PatternMatch.uu___4, equation_PatternMatch.y2, function_token_typing_Prims.__cache_version_number__, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
(declare-fun PatternMatch.uu___8 (Dummy_sort) Term)

; </end encoding let uu___8>


; encoding sigelt type PatternMatch.r


; <Start encoding type PatternMatch.r>

;;;;;;;;;;;;;;;;Constructor
(declare-fun PatternMatch.r () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PatternMatch.Mkr (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PatternMatch.Mkr_x (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: PatternMatch.Mkr
(declare-fun PatternMatch.Mkr@tok () Term)
;;;;;;;;;;;;;;;;x: Prims.int -> r
(declare-fun Tm_arrow_705058830ba8a639ca12535b91fe9d06 () Term)

; <start constructor PatternMatch.r>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PatternMatch.r ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
165)
(= __@x0
PatternMatch.r)))

; </end constructor PatternMatch.r>


; <start constructor PatternMatch.Mkr>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PatternMatch.Mkr ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
171)
(= __@x0
(PatternMatch.Mkr (PatternMatch.Mkr_x __@x0)))))

; </end constructor PatternMatch.Mkr>


; </end encoding type PatternMatch.r>


; encoding sigelt assume PatternMatch.r__uu___haseq


; <Start encoding assume PatternMatch.r__uu___haseq>


; </end encoding assume PatternMatch.r__uu___haseq>


; encoding sigelt val PatternMatch.__proj__Mkr__item__x


; <Start encoding val PatternMatch.__proj__Mkr__item__x>

(declare-fun PatternMatch.__proj__Mkr__item__x (Term) Term)
;;;;;;;;;;;;;;;;projectee: r -> Prims.int
(declare-fun Tm_arrow_0fc32013d18d8c85ae0f0df6a66b68ae () Term)
(declare-fun PatternMatch.__proj__Mkr__item__x@tok () Term)

; </end encoding val PatternMatch.__proj__Mkr__item__x>


; encoding sigelt let __proj__Mkr__item__x


; <Skipped let __proj__Mkr__item__x/>
...
(declare-fun PatternMatch.uu___9 (Dummy_sort) Term)

; </end encoding let uu___9>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.uu___9; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.uu___9 @u0)
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.bool))
 

:pattern ((PatternMatch.uu___9 @u0))
:qid typing_PatternMatch.uu___9))
:named typing_PatternMatch.uu___9))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Equation for PatternMatch.uu___9
;;; Fact-ids: Name PatternMatch.uu___9; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (PatternMatch.uu___9 @u0)
(FStar.Pervasives.Native.Mktuple2 Prims.int
Prims.bool
(BoxInt 2)
(BoxBool false)))
...
:pattern ((PatternMatch.uu___9 @u0))
:qid equation_PatternMatch.uu___9))
:named equation_PatternMatch.uu___9))
(push) ;; push{3
...
; Encoding query formula : ~(_._2 = true) ==> Prims.l_False


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let x`
; While typechecking the top-level declaration `[@@expect_failure] let uu___9`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=PatternMatch.fst(61,5-61,12); use=PatternMatch.fst(61,5-61,12)
(not 
;; def=PatternMatch.fst(61,5-61,12); use=PatternMatch.fst(61,5-61,12)
(= (FStar.Pervasives.Native.__proj__Mktuple2__item___2 Prims.int
Prims.bool
(PatternMatch.uu___9 Dummy_value))
(BoxBool true))
)
...
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.uu___9 @u0)
(FStar.Pervasives.Native.tuple3 Prims.bool
Prims.bool
Prims.int))
...
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (PatternMatch.uu___9 @u0)
(FStar.Pervasives.Native.Mktuple3 Prims.bool
Prims.bool
Prims.int
(BoxBool true)
(BoxBool true)
...
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name PatternMatch.uu___0; Namespace PatternMatch
...
; Encoding query formula : ~(_._1 = false && _._2 = false) ==> Prims.l_False
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=PatternMatch.fst(64,5-64,20); use=PatternMatch.fst(64,5-64,20)
(not 
;; def=PatternMatch.fst(64,5-64,20); use=PatternMatch.fst(64,5-64,20)
(and (BoxBool_proj_0 (Prims.op_Equality Prims.bool
(FStar.Pervasives.Native.__proj__Mktuple3__item___1 Prims.bool
Prims.bool
Prims.int
(PatternMatch.uu___9 Dummy_value))
(BoxBool false)))
(BoxBool_proj_0 (Prims.op_Equality Prims.bool
(FStar.Pervasives.Native.__proj__Mktuple3__item___2 Prims.bool
Prims.bool
Prims.int
(PatternMatch.uu___9 Dummy_value))
(BoxBool false))))
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=PatternMatch.fst(66,5-66,12); use=PatternMatch.fst(66,5-66,12)
(not 
;; def=PatternMatch.fst(66,5-66,12); use=PatternMatch.fst(66,5-66,12)
(= (FStar.Pervasives.Native.__proj__Mktuple2__item___2 Prims.int
Prims.bool
...
; QUERY ID: (PatternMatch.x, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_PatternMatch.uu___9, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
(declare-fun PatternMatch.x (Dummy_sort) Term)
...
(declare-fun PatternMatch.uu___10 (Dummy_sort) Term)

; </end encoding let uu___10>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatternMatch.uu___10; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (PatternMatch.uu___10 @u0)
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))
 

:pattern ((PatternMatch.uu___10 @u0))
:qid typing_PatternMatch.uu___10))
:named typing_PatternMatch.uu___10))
;;;;;;;;;;;;;;;;Equation for PatternMatch.uu___10
;;; Fact-ids: Name PatternMatch.uu___10; Namespace PatternMatch
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (PatternMatch.uu___10 @u0)
(FStar.Pervasives.Native.Mktuple2 Prims.int
Prims.int
(BoxInt 42)
(BoxInt 0)))
...
:pattern ((PatternMatch.uu___10 @u0))
:qid equation_PatternMatch.uu___10))
:named equation_PatternMatch.uu___10))
(push) ;; push{2
...
; Encoding query formula : ~(_._2 = 0) ==> Prims.l_False


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let z`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=PatternMatch.fst(71,5-71,9); use=PatternMatch.fst(71,5-71,9)
(not 
;; def=PatternMatch.fst(71,5-71,9); use=PatternMatch.fst(71,5-71,9)
(= (FStar.Pervasives.Native.__proj__Mktuple2__item___2 Prims.int
Prims.int
(PatternMatch.uu___10 Dummy_value))
(BoxInt 0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatternMatch.z, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_PatternMatch.uu___10, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
