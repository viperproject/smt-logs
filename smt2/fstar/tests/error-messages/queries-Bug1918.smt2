...
; Internals for Bug1918


; encoding sigelt type Bug1918.mon


; <Start encoding type Bug1918.mon>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1918.mon () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1918.Mkmon (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug1918.Mkmon_t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug1918.Mkmon_comp (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1918.Mkmon
(declare-fun Bug1918.Mkmon@tok () Term)
;;;;;;;;;;;;;;;;_: t -> _: t -> t
(declare-fun Tm_arrow_72ac2ec523211f8603e00b25deb1543b (Term) Term)

;;;;;;;;;;;;;;;;t: Type -> comp: (_: t -> _: t -> t) -> mon
(declare-fun Tm_arrow_2ea8653aa73157584866b8cdfe42cb07 () Term)

; <start constructor Bug1918.mon>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1918.mon ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(= __@x0
Bug1918.mon)))

; </end constructor Bug1918.mon>


; <start constructor Bug1918.Mkmon>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1918.Mkmon ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
112)
(= __@x0
(Bug1918.Mkmon (Bug1918.Mkmon_t __@x0)
(Bug1918.Mkmon_comp __@x0)))))

; </end constructor Bug1918.Mkmon>


; </end encoding type Bug1918.mon>


; encoding sigelt val Bug1918.__proj__Mkmon__item__t


; <Start encoding val Bug1918.__proj__Mkmon__item__t>

(declare-fun Bug1918.__proj__Mkmon__item__t (Term) Term)
;;;;;;;;;;;;;;;;projectee: mon -> Type
(declare-fun Tm_arrow_dc53370686a3da8a73e6a6c53c67314f () Term)
(declare-fun Bug1918.__proj__Mkmon__item__t@tok () Term)

; </end encoding val Bug1918.__proj__Mkmon__item__t>


; encoding sigelt let __proj__Mkmon__item__t


; <Skipped let __proj__Mkmon__item__t/>


; encoding sigelt val Bug1918.__proj__Mkmon__item__comp


; <Start encoding val Bug1918.__proj__Mkmon__item__comp>

(declare-fun Bug1918.__proj__Mkmon__item__comp (Term) Term)
;;;;;;;;;;;;;;;;_: projectee.t -> _: projectee.t -> projectee.t
(declare-fun Tm_arrow_3af26f4a1db3fc2d854ba8f363bd7f82 (Term) Term)
;;;;;;;;;;;;;;;;projectee: mon -> _: projectee.t -> _: projectee.t -> projectee.t
(declare-fun Tm_arrow_58e367180bd2f2bf03cd4071776bd87f () Term)
(declare-fun Bug1918.__proj__Mkmon__item__comp@tok () Term)


; </end encoding val Bug1918.__proj__Mkmon__item__comp>


; encoding sigelt let __proj__Mkmon__item__comp


; <Skipped let __proj__Mkmon__item__comp/>
...
(declare-fun Bug1918.t (Term) Term)

(declare-fun Bug1918.t@tok () Term)
...
(declare-fun Bug1918.comp (Term) Term)
;;;;;;;;;;;;;;;;_: projectee.t -> projectee.t
(declare-fun Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5 (Term) Term)
;;;;;;;;;;;;;;;;_: projectee.t -> _: projectee.t -> projectee.t
(declare-fun Tm_arrow_028e7ae9d895be9abe48214fdfceaccb (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: mon |} -> _: projectee.t -> _: projectee.t -> projectee.t
(declare-fun Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45 () Term)
(declare-fun Bug1918.comp@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1918.t; Namespace Bug1918
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1918.mon)
(HasType (Bug1918.t @x0)
Tm_type))
 

:pattern ((Bug1918.t @x0))
:qid typing_Bug1918.t))
:named typing_Bug1918.t))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1918.mon)
(HasType (Bug1918.comp @x0)
(Tm_arrow_028e7ae9d895be9abe48214fdfceaccb @x0)))
 

:pattern ((Bug1918.comp @x0))
:qid typing_Bug1918.comp))
:named typing_Bug1918.comp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1918.__proj__Mkmon__item__t; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(4,2-4,3); use=Bug1918.fst(4,2-4,3)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1918.mon)
(HasType (Bug1918.__proj__Mkmon__item__t @x0)
Tm_type))
 

:pattern ((Bug1918.__proj__Mkmon__item__t @x0))
:qid typing_Bug1918.__proj__Mkmon__item__t))

:named typing_Bug1918.__proj__Mkmon__item__t))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT Bug1918.comp@tok
@x0)
(Bug1918.comp @x0))
 

:pattern ((ApplyTT Bug1918.comp@tok
@x0))
:qid token_correspondence_Bug1918.comp))
:named token_correspondence_Bug1918.comp))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug1918.mon; Namespace Bug1918; Name Bug1918.Mkmon; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(3,6-3,9)
...
@x2)
Bug1918.mon))
:qid subterm_ordering_Bug1918.Mkmon))

:named subterm_ordering_Bug1918.Mkmon))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug1918.mon; Namespace Bug1918; Name Bug1918.Mkmon; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(3,6-3,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug1918.Mkmon_t (Bug1918.Mkmon @x0
@x1))
@x0)
 

:pattern ((Bug1918.Mkmon @x0
@x1))
:qid projection_inverse_Bug1918.Mkmon_t))

:named projection_inverse_Bug1918.Mkmon_t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug1918.mon; Namespace Bug1918; Name Bug1918.Mkmon; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(3,6-3,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug1918.Mkmon_comp (Bug1918.Mkmon @x0
@x1))
@x1)
...
:pattern ((Bug1918.Mkmon @x0
@x1))
:qid projection_inverse_Bug1918.Mkmon_comp))

:named projection_inverse_Bug1918.Mkmon_comp))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug1918.__proj__Mkmon__item__t; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(4,2-4,3); use=Bug1918.fst(4,2-4,3)
(forall ((@x0 Term))
 (! (= (Bug1918.__proj__Mkmon__item__t @x0)
(Bug1918.Mkmon_t @x0))
 

:pattern ((Bug1918.__proj__Mkmon__item__t @x0))
:qid proj_equation_Bug1918.Mkmon_t))

:named proj_equation_Bug1918.Mkmon_t))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! (HasType Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45
Tm_type)
:named kinding_Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_72ac2ec523211f8603e00b25deb1543b
;;; Fact-ids: Name Bug1918.mon; Namespace Bug1918; Name Bug1918.Mkmon; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(4,2-4,3); use=Bug1918.fst(5,9-5,20)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(5,2-5,6)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5 @x0)
Tm_type))
:qid kinding_Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5))

:named kinding_Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_028e7ae9d895be9abe48214fdfceaccb
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(5,2-5,6)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_028e7ae9d895be9abe48214fdfceaccb @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_028e7ae9d895be9abe48214fdfceaccb @x0)
Tm_type))
:qid kinding_Tm_arrow_028e7ae9d895be9abe48214fdfceaccb))

:named kinding_Tm_arrow_028e7ae9d895be9abe48214fdfceaccb))
;;; Fact-ids: Name Bug1918.mon; Namespace Bug1918; Name Bug1918.Mkmon; Namespace Bug1918
(assert (! (HasType Bug1918.mon
Tm_type)
:named kinding_Bug1918.mon@tok))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Bug1918.comp@tok
Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45))
(forall ((@x1 Term))
 (! (= (ApplyTT Bug1918.comp@tok
@x1)
(Bug1918.comp @x1))
...
:pattern ((Bug1918.comp @x1))
:qid function_token_typing_Bug1918.comp.1)))
 

:pattern ((ApplyTT @x0
Bug1918.comp@tok))
:qid function_token_typing_Bug1918.comp))
:named function_token_typing_Bug1918.comp))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug1918.mon; Namespace Bug1918; Name Bug1918.Mkmon; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(3,6-3,9)
...
@x1
Bug1918.mon))
:qid fuel_guarded_inversion_Bug1918.mon))

:named fuel_guarded_inversion_Bug1918.mon))
;;;;;;;;;;;;;;;;Equation for Bug1918.t
;;; Fact-ids: Name Bug1918.t; Namespace Bug1918
(assert (! (forall ((@x0 Term))
 (! (= (Bug1918.t @x0)
(let ((@lb1 @x0))
...
:pattern ((Bug1918.t @x0))
:qid equation_Bug1918.t))
:named equation_Bug1918.t))
;;;;;;;;;;;;;;;;Equation for Bug1918.comp
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! (forall ((@x0 Term))
 (! (= (Bug1918.comp @x0)
(let ((@lb1 @x0))
(Bug1918.Mkmon_comp @lb1)))
 

:pattern ((Bug1918.comp @x0))
:qid equation_Bug1918.comp))
:named equation_Bug1918.comp))
...
@x2)
Bug1918.mon))
:qid data_typing_intro_Bug1918.Mkmon@tok))

:named data_typing_intro_Bug1918.Mkmon@tok))
...
@x2)
Bug1918.mon))
:qid data_elim_Bug1918.Mkmon))

:named data_elim_Bug1918.Mkmon))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug1918.mon; Namespace Bug1918; Name Bug1918.Mkmon; Namespace Bug1918
(assert (! (= 104
(Term_constr_id Bug1918.mon))
:named constructor_distinct_Bug1918.mon))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug1918.mon; Namespace Bug1918; Name Bug1918.Mkmon; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(3,6-3,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= 112
(Term_constr_id (Bug1918.Mkmon @x0
@x1)))
 

:pattern ((Bug1918.Mkmon @x0
@x1))
:qid constructor_distinct_Bug1918.Mkmon))

:named constructor_distinct_Bug1918.Mkmon))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug1918.mon; Namespace Bug1918; Name Bug1918.Mkmon; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(3,6-3,9)
...
@x0
Bug1918.mon))
:qid Bug1918_pretyping_5ec2b8efce08e5f5168183b5f6bd4040))

:named Bug1918_pretyping_5ec2b8efce08e5f5168183b5f6bd4040))
...
@x1
Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45))
:qid Bug1918_pre_typing_Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45))

:named Bug1918_pre_typing_Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug1918.mon; Namespace Bug1918; Name Bug1918.Mkmon; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(4,2-4,3); use=Bug1918.fst(5,9-5,20)
...
@x1
(Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x2)))
:qid Bug1918_pre_typing_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))

:named Bug1918_pre_typing_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(5,2-5,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5 @x2)))
:qid Bug1918_pre_typing_Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5))

:named Bug1918_pre_typing_Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(5,2-5,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_028e7ae9d895be9abe48214fdfceaccb @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_028e7ae9d895be9abe48214fdfceaccb @x2)))
:qid Bug1918_pre_typing_Tm_arrow_028e7ae9d895be9abe48214fdfceaccb))

:named Bug1918_pre_typing_Tm_arrow_028e7ae9d895be9abe48214fdfceaccb))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(5,2-5,6)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_028e7ae9d895be9abe48214fdfceaccb @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid Bug1918_interpretation_Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45))
:qid Bug1918_interpretation_Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45))

:named Bug1918_interpretation_Tm_arrow_c82ae1dbfd1e38c364886c689cc3fb45))
...
@x2)
@x3))
:qid Bug1918_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug1918_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x1)))
:qid Bug1918_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))

:named Bug1918_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(5,2-5,6)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5 @x1))
(and 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(5,2-5,6)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Bug1918.__proj__Mkmon__item__t @x1))
(HasType (ApplyTT @x0
@x2)
(Bug1918.__proj__Mkmon__item__t @x1)))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug1918_interpretation_Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5 @x1)))
:qid Bug1918_interpretation_Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5))

:named Bug1918_interpretation_Tm_arrow_44b4d3aa81ce4a0730e8568a896730d5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_028e7ae9d895be9abe48214fdfceaccb
;;; Fact-ids: Name Bug1918.comp; Namespace Bug1918
(assert (! 
;; def=Bug1918.fst(3,6-3,9); use=Bug1918.fst(5,2-5,6)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug1918_interpretation_Tm_arrow_028e7ae9d895be9abe48214fdfceaccb.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_028e7ae9d895be9abe48214fdfceaccb @x1)))
:qid Bug1918_interpretation_Tm_arrow_028e7ae9d895be9abe48214fdfceaccb))

:named Bug1918_interpretation_Tm_arrow_028e7ae9d895be9abe48214fdfceaccb))
(push) ;; push{2

; Starting query at Bug1918.fst(8,36-8,44)
...
Bug1918.comp@tok))
:named @kick_partial_app_c0836ef81ac49e1ebf22b6213427de1b))


; Encoding query formula : forall (_: Bug1918.mon) (x: Bug1918.t) (y: Bug1918.t).
;   (*  - Could not prove post-condition
; *)
;   Prims.has_type x _.t /\
;   (forall (any_result: Bug1918.t).
;       x == any_result ==>
;       Prims.has_type y _.t /\
;       (forall (any_result: Bug1918.t).
;           y == any_result ==>
;           (forall (any_result: _.t).
;               Bug1918.comp x y == any_result ==> Prims.has_type (Bug1918.comp x y) Bug1918.t)))


; Context: While encoding a query
; While typechecking the top-level declaration `let comp1`
...
;; def=Prims.fst(459,77-459,89); use=Bug1918.fst(8,36-8,44)
(and 
;; def=Bug1918.fst(8,19-8,20); use=Bug1918.fst(8,41-8,42)
(or label_1
(HasType @x1
(Bug1918.__proj__Mkmon__item__t @x0)))


;; def=Prims.fst(451,66-451,102); use=Bug1918.fst(8,36-8,44)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Bug1918.t @x0))

;; def=dummy(0,0-0,0); use=Bug1918.fst(8,36-8,44)
(= @x1
@x3)
)
...
;; def=Prims.fst(459,77-459,89); use=Bug1918.fst(8,36-8,44)
(and 
;; def=Bug1918.fst(8,25-8,26); use=Bug1918.fst(8,43-8,44)
(or label_2
(HasType @x2
(Bug1918.__proj__Mkmon__item__t @x0)))
...
;; def=Bug1918.fst(8,32-8,44); use=Bug1918.fst(8,36-8,44)
(= (ApplyTT (ApplyTT (ApplyTT Bug1918.comp@tok
@x0)
@x1)
@x2)
@x5)
...
;; def=Bug1918.fst(8,36-8,44); use=Bug1918.fst(8,36-8,44)
(or label_3
(HasType (ApplyTT (ApplyTT (ApplyTT Bug1918.comp@tok
@x0)
@x1)
@x2)
(Bug1918.t @x0)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1918.comp1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Bug1918.t, fuel_guarded_inversion_Bug1918.mon, proj_equation_Bug1918.Mkmon_t
