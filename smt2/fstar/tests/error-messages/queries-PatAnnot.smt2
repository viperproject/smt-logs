...
(declare-fun PatAnnot.id (Term Term) Term)

(declare-fun PatAnnot.id@tok () Term)
...
(declare-fun PatAnnot.f (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.unit & Prims.unit
(declare-fun Tm_arrow_6f6466cd8da4a90557089f972751061a () Term)
(declare-fun PatAnnot.f@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PatAnnot.f; Namespace PatAnnot
(assert (! 
;; def=PatAnnot.fst(20,4-20,5); use=PatAnnot.fst(20,4-20,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.unit)
(HasType (PatAnnot.f @x0)
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.unit)))
 

:pattern ((PatAnnot.f @x0))
:qid typing_PatAnnot.f))

:named typing_PatAnnot.f))
...
:pattern ((PatAnnot.f @x0))
:qid equation_PatAnnot.f))

:named equation_PatAnnot.f))
...
; Starting query at PatAnnot.fst(23,0-25,30)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (b: Prims.unit) (b: Prims.unit). PatAnnot.f () == (b, b) ==> Prims.l_False


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let whoops`
; While typechecking the top-level declaration `[@@expect_failure] let whoops`
...
;; def=PatAnnot.fst(24,8-25,25); use=PatAnnot.fst(24,8-25,25)
(= (PatAnnot.f Tm_unit)
(FStar.Pervasives.Native.Mktuple2 Prims.unit
Prims.unit
@x0
...
; Starting query at PatAnnot.fst(28,0-30,14)
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let whoops2`
; While typechecking the top-level declaration `[@@expect_failure] let whoops2`
...
;; def=PatAnnot.fst(29,6-29,24); use=PatAnnot.fst(29,6-29,24)
(= (PatAnnot.f Tm_unit)
(FStar.Pervasives.Native.Mktuple2 Prims.unit
Prims.unit
@x0
...
(assert (! 
;; def=FStar.List.Tot.Base.fst(444,8-444,15); use=FStar.List.Tot.Base.fst(444,8-444,15)
...
(HasType @x2
(Prims.list @x0)))
(HasType (FStar.List.Tot.Base.splitAt @x0
@x1
@x2)
(FStar.Pervasives.Native.tuple2 (Prims.list @x0)
(Prims.list @x0))))
...
@x1
@x2))
:qid typing_FStar.List.Tot.Base.splitAt))

:named typing_FStar.List.Tot.Base.splitAt))
;;;;;;;;;;;;;;;;name-token correspondence
...
(HasType @x3
(Prims.list @x1)))
(HasType (FStar.List.Tot.Base.splitAt.fuel_instrumented @u0
@x1
@x2
@x3)
(FStar.Pervasives.Native.tuple2 (Prims.list @x1)
(Prims.list @x1))))
 

:pattern ((FStar.List.Tot.Base.splitAt.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_FStar.List.Tot.Base.splitAt.fuel_instrumented))

:named token_correspondence_FStar.List.Tot.Base.splitAt.fuel_instrumented))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
...
(Term_constr_id FStar.Pervasives.Native.tuple2@tok))
:named fresh_token_FStar.Pervasives.Native.tuple2@tok))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: FStar.List.Tot.Base.splitAt
;;; Fact-ids: Name FStar.List.Tot.Base.splitAt; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(444,8-444,15); use=FStar.List.Tot.Base.fst(444,8-444,15)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(ite (= @lb4
(BoxBool true))
(FStar.Pervasives.Native.Mktuple2 (Prims.list @x1)
(Prims.list @x1)
(Prims.Nil @x1)
@x3)
(let ((@lb5 @x3))
...
(let ((@lb6 (FStar.List.Tot.Base.splitAt.fuel_instrumented @u0
@x1
...
@x2
@x3))
:qid equation_with_fuel_FStar.List.Tot.Base.splitAt.fuel_instrumented))

:named equation_with_fuel_FStar.List.Tot.Base.splitAt.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
; Starting query at PatAnnot.fst(33,0-35,14)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (b: Prims.list Prims.int) (b: Prims.list Prims.int).
;   FStar.List.Tot.Base.splitAt 0 [1; 2; 3] == (b, b) ==> Prims.l_False


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let sub_bv`
; While typechecking the top-level declaration `[@@expect_failure] let sub_bv`
...
;; def=PatAnnot.fst(34,6-34,28); use=PatAnnot.fst(34,6-34,28)
(= (FStar.List.Tot.Base.splitAt Prims.int
(BoxInt 0)
...
; Starting query at PatAnnot.fst(38,0-40,40)
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let s`
; While typechecking the top-level declaration `[@@expect_failure] let s`
...
; Starting query at PatAnnot.fst(46,4-47,24)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (i: Prims.int). (*  - Could not prove post-condition
; *) i >= 0
...
;; def=Prims.fst(680,18-680,24); use=PatAnnot.fst(46,10-46,11)
(or label_1
...
; Starting query at PatAnnot.fst(50,4-51,20)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (i: Prims.int) (_: Prims.squash (i >= 0)). (*  - Could not prove post-condition
; *) i >= 0
...
Prims.int)
(HasType @x1
(Prims.squash (Prims.b2t (Prims.op_GreaterThanOrEqual @x0
(BoxInt 0))))))

;; def=Prims.fst(680,18-680,24); use=PatAnnot.fst(50,10-50,11)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatAnnot.test2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, b2t_def, equation_Prims.squash, primitive_Prims.op_GreaterThanOrEqual, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c
...
(declare-fun PatAnnot.test2 (Term Term) Term)
;;;;;;;;;;;;;;;;i: Prims.int -> _: Prims.squash (i >= 0) -> Prims.nat
(declare-fun Tm_arrow_6981d92dd82d076ffccc03907db85e40 () Term)
(declare-fun PatAnnot.test2@tok () Term)
...
; Starting query at PatAnnot.fst(54,0-55,51)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Prims.int). _ >= 0
...
;; def=Prims.fst(680,18-680,24); use=PatAnnot.fst(55,36-55,39)
(or label_1

;; def=Prims.fst(680,18-680,24); use=PatAnnot.fst(55,44-55,45)
(>= (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
; Starting query at PatAnnot.fst(58,4-61,15)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (i: FStar.Pervasives.Native.option Prims.nat).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Prims.int).
;     (forall (x: Prims.int). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(Some? i) /\ ~(Some? i) /\ ~(None? i) ==> Prims.l_False
...
;; def=Prims.fst(402,27-402,88); use=PatAnnot.fst(58,4-61,15)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=PatAnnot.fst(58,4-61,15)
(Valid 
;; def=Prims.fst(402,84-402,87); use=PatAnnot.fst(58,4-61,15)
(ApplyTT @x1
@x2)
...
;; def=PatAnnot.fst(57,10-57,11); use=PatAnnot.fst(58,10-58,11)
(not 
;; def=PatAnnot.fst(57,10-57,11); use=PatAnnot.fst(58,10-58,11)
...
(not 
;; def=PatAnnot.fst(57,10-57,11); use=PatAnnot.fst(58,10-58,11)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None Prims.nat
@x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PatAnnot.test4, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, lemma_FStar.Pervasives.invertOption, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
