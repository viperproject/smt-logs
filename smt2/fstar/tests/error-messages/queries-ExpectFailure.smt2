...
; Starting query at ExpectFailure.fst(28,0-28,20)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExpectFailure.uu___0, 1)
...
; Starting query at ExpectFailure.fst(30,0-30,20)
