...
; Starting query at AssertNorm.fst(7,2-9,4)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Prims.int) (y: Prims.int) (z: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   x + x == y + y /\ (forall (pure_result: Prims.unit). x + x == y + y ==> x + y == y + x)


; Context: While encoding a query
; While typechecking the top-level declaration `let f`
; While typechecking the top-level declaration `[@@expect_failure] let f`
...
;; def=Prims.fst(441,29-441,97); use=AssertNorm.fst(7,2-7,13)
(and 
;; def=AssertNorm.fst(7,14-7,30); use=AssertNorm.fst(7,2-7,13)
(or label_1
...
;; def=Prims.fst(441,36-441,97); use=AssertNorm.fst(7,2-7,13)
(forall ((@x3 Term))
...
;; def=AssertNorm.fst(8,9-8,25); use=AssertNorm.fst(8,2-8,8)
(or label_2
