...
; Internals for NegativeTests.Set


; encoding sigelt val NegativeTests.Set.elt


; <Start encoding val NegativeTests.Set.elt>

(declare-fun NegativeTests.Set.elt () Term)

; </end encoding val NegativeTests.Set.elt>


; encoding sigelt val NegativeTests.Set.a


; <Start encoding val NegativeTests.Set.a>

(declare-fun NegativeTests.Set.a (Dummy_sort) Term)

; </end encoding val NegativeTests.Set.a>


; encoding sigelt val NegativeTests.Set.b


; <Start encoding val NegativeTests.Set.b>

(declare-fun NegativeTests.Set.b (Dummy_sort) Term)

; </end encoding val NegativeTests.Set.b>


; encoding sigelt val NegativeTests.Set.c


; <Start encoding val NegativeTests.Set.c>

(declare-fun NegativeTests.Set.c (Dummy_sort) Term)

; </end encoding val NegativeTests.Set.c>


; encoding sigelt assume NegativeTests.Set.AB_distinct


; <Start encoding assume NegativeTests.Set.AB_distinct>


; </end encoding assume NegativeTests.Set.AB_distinct>


; encoding sigelt val NegativeTests.Set.should_fail1


; <Skipped val NegativeTests.Set.should_fail1/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Set.elt; Namespace NegativeTests.Set
(assert (! (HasType NegativeTests.Set.elt
Tm_type)
:named typing_NegativeTests.Set.elt))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Set.b; Namespace NegativeTests.Set
(assert (! 
;; def=NegativeTests.Set.fst(20,11-20,12); use=NegativeTests.Set.fst(20,11-20,12)
(forall ((@u0 Dummy_sort))
 (! (HasType (NegativeTests.Set.b @u0)
NegativeTests.Set.elt)
 

:pattern ((NegativeTests.Set.b @u0))
:qid typing_NegativeTests.Set.b))

:named typing_NegativeTests.Set.b))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Set.a; Namespace NegativeTests.Set
(assert (! 
;; def=NegativeTests.Set.fst(19,11-19,12); use=NegativeTests.Set.fst(19,11-19,12)
(forall ((@u0 Dummy_sort))
 (! (HasType (NegativeTests.Set.a @u0)
NegativeTests.Set.elt)
 

:pattern ((NegativeTests.Set.a @u0))
:qid typing_NegativeTests.Set.a))

:named typing_NegativeTests.Set.a))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.TSet.singleton; Namespace FStar.TSet
(assert (! 
;; def=FStar.TSet.fsti(36,4-36,13); use=FStar.TSet.fsti(36,4-36,13)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
@x0))
(HasType (FStar.TSet.singleton @x0
@x1)
(FStar.TSet.set @x0)))
 

:pattern ((FStar.TSet.singleton @x0
@x1))
:qid typing_FStar.TSet.singleton))

:named typing_FStar.TSet.singleton))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Lemma: FStar.TSet.mem_singleton
;;; Fact-ids: Name FStar.TSet.mem_singleton; Namespace FStar.TSet
...
;; def=FStar.TSet.fsti(53,12-53,45); use=FStar.TSet.fsti(53,12-53,45)
(iff 
;; def=FStar.TSet.fsti(53,13-53,32); use=FStar.TSet.fsti(53,13-53,32)
(Valid 
;; def=FStar.TSet.fsti(53,13-53,32); use=FStar.TSet.fsti(53,13-53,32)
(FStar.TSet.mem @x0
@x2
(FStar.TSet.singleton @x0
@x1))
)


;; def=FStar.TSet.fsti(53,38-53,44); use=FStar.TSet.fsti(53,38-53,44)
(= @x1
@x2)
)
)
...
(FStar.TSet.singleton @x0
@x1)))
:qid lemma_FStar.TSet.mem_singleton))
:named lemma_FStar.TSet.mem_singleton))
...
(assert (! (HasType NegativeTests.Set.elt
Tm_type)
:named function_token_typing_NegativeTests.Set.elt))
...
;;;;;;;;;;;;;;;;Assumption: NegativeTests.Set.AB_distinct
;;; Fact-ids: Name NegativeTests.Set.AB_distinct; Namespace NegativeTests.Set
(assert (! 
;; def=NegativeTests.Set.fst(22,20-22,25); use=NegativeTests.Set.fst(22,20-22,25)
(not 
;; def=NegativeTests.Set.fst(22,20-22,25); use=NegativeTests.Set.fst(22,20-22,25)
(= (NegativeTests.Set.a Dummy_value)
(NegativeTests.Set.b Dummy_value))
)

:named assumption_NegativeTests.Set.AB_distinct))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
; Starting query at NegativeTests.Set.fst(28,2-28,30)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u67: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash (FStar.TSet.mem NegativeTests.Set.b (FStar.TSet.singleton NegativeTests.Set.a))


; Context: While encoding a query
; While typechecking the top-level declaration `let should_fail1`
; While typechecking the top-level declaration `[@@expect_failure] let should_fail1`
...
;; def=NegativeTests.Set.fst(28,9-28,30); use=NegativeTests.Set.fst(28,9-28,30)
(or label_1

;; def=NegativeTests.Set.fst(28,9-28,30); use=NegativeTests.Set.fst(28,9-28,30)
(Valid 
;; def=NegativeTests.Set.fst(28,9-28,30); use=NegativeTests.Set.fst(28,9-28,30)
(FStar.TSet.mem NegativeTests.Set.elt
(NegativeTests.Set.b Dummy_value)
(FStar.TSet.singleton NegativeTests.Set.elt
(NegativeTests.Set.a Dummy_value)))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Set.should_fail1, 1)
...
; encoding sigelt val NegativeTests.Set.should_fail2


; <Skipped val NegativeTests.Set.should_fail2/>
...
:named typing_NegativeTests.Set.a))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.TSet.union; Namespace FStar.TSet
(assert (! 
;; def=FStar.TSet.fsti(37,4-37,9); use=FStar.TSet.fsti(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(FStar.TSet.set @x0)))
(HasType (FStar.TSet.union @x0
@x1
@x2)
(FStar.TSet.set @x0)))
 

:pattern ((FStar.TSet.union @x0
@x1
@x2))
:qid typing_FStar.TSet.union))

:named typing_FStar.TSet.union))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.TSet.subset; Namespace FStar.TSet
(assert (! 
;; def=FStar.TSet.fsti(43,4-43,10); use=FStar.TSet.fsti(43,4-43,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(FStar.TSet.set @x0)))
(HasType (FStar.TSet.subset @x0
@x1
@x2)
Tm_type))
 

:pattern ((FStar.TSet.subset @x0
@x1
@x2))
:qid typing_FStar.TSet.subset))

:named typing_FStar.TSet.subset))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.TSet.singleton; Namespace FStar.TSet
(assert (! 
;; def=FStar.TSet.fsti(36,4-36,13); use=FStar.TSet.fsti(36,4-36,13)
...
;;;;;;;;;;;;;;;;Lemma: FStar.TSet.subset_mem
;;; Fact-ids: Name FStar.TSet.subset_mem; Namespace FStar.TSet
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=FStar.TSet.fsti(77,13-77,27); use=FStar.TSet.fsti(77,13-77,27)
(Valid 
;; def=FStar.TSet.fsti(77,13-77,27); use=FStar.TSet.fsti(77,13-77,27)
(FStar.TSet.subset @x0
@x1
@x2)
)
)

;; def=FStar.TSet.fsti(78,12-78,45); use=FStar.TSet.fsti(78,12-78,45)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
@x0)

;; def=FStar.TSet.fsti(78,23-78,31); use=FStar.TSet.fsti(78,23-78,31)
(Valid 
;; def=FStar.TSet.fsti(78,23-78,31); use=FStar.TSet.fsti(78,23-78,31)
(FStar.TSet.mem @x0
@x3
...
;; def=FStar.TSet.fsti(78,36-78,44); use=FStar.TSet.fsti(78,36-78,44)
(Valid 
;; def=FStar.TSet.fsti(78,36-78,44); use=FStar.TSet.fsti(78,36-78,44)
(FStar.TSet.mem @x0
@x3
...
;;no pats
:qid lemma_FStar.TSet.subset_mem.1))
)
...
@x1
@x2))
:qid lemma_FStar.TSet.subset_mem))
:named lemma_FStar.TSet.subset_mem))
;;;;;;;;;;;;;;;;Lemma: FStar.TSet.mem_union
;;; Fact-ids: Name FStar.TSet.mem_union; Namespace FStar.TSet
...
;; def=FStar.TSet.fsti(58,12-58,59); use=FStar.TSet.fsti(58,12-58,59)
(= (FStar.TSet.mem @x0
@x1
(FStar.TSet.union @x0
@x2
@x3))
(Prims.l_or (FStar.TSet.mem @x0
@x1
@x2)
(FStar.TSet.mem @x0
@x1
...
@x2
@x3)))
:qid lemma_FStar.TSet.mem_union))
:named lemma_FStar.TSet.mem_union))
;;;;;;;;;;;;;;;;Lemma: FStar.TSet.mem_subset
;;; Fact-ids: Name FStar.TSet.mem_subset; Namespace FStar.TSet
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=FStar.TSet.fsti(72,13-72,46); use=FStar.TSet.fsti(72,13-72,46)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
@x0)

;; def=FStar.TSet.fsti(72,24-72,32); use=FStar.TSet.fsti(72,24-72,32)
(Valid 
;; def=FStar.TSet.fsti(72,24-72,32); use=FStar.TSet.fsti(72,24-72,32)
(FStar.TSet.mem @x0
@x3
...
;; def=FStar.TSet.fsti(72,37-72,45); use=FStar.TSet.fsti(72,37-72,45)
(Valid 
;; def=FStar.TSet.fsti(72,37-72,45); use=FStar.TSet.fsti(72,37-72,45)
(FStar.TSet.mem @x0
@x3
...
;;no pats
:qid lemma_FStar.TSet.mem_subset.1))
)

;; def=FStar.TSet.fsti(73,12-73,26); use=FStar.TSet.fsti(73,12-73,26)
(Valid 
;; def=FStar.TSet.fsti(73,12-73,26); use=FStar.TSet.fsti(73,12-73,26)
(FStar.TSet.subset @x0
@x1
...
@x1
@x2))
:qid lemma_FStar.TSet.mem_subset))
:named lemma_FStar.TSet.mem_subset))
;;;;;;;;;;;;;;;;Lemma: FStar.TSet.mem_singleton
;;; Fact-ids: Name FStar.TSet.mem_singleton; Namespace FStar.TSet
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
Tm_refine_414d0a9f578ab0048252f8c8f552b99f)
:named equation_Prims.eqtype))
;;;;;;;;;;;;;;;;Equation for FStar.TSet.subset
;;; Fact-ids: Name FStar.TSet.subset; Namespace FStar.TSet
(assert (! 
;; def=FStar.TSet.fsti(43,4-43,10); use=FStar.TSet.fsti(43,4-43,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (FStar.TSet.subset @x0
@x1
@x2))

;; def=FStar.TSet.fsti(43,53-43,84); use=FStar.TSet.fsti(43,53-43,84)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
@x0)

;; def=FStar.TSet.fsti(43,63-43,71); use=FStar.TSet.fsti(43,63-43,71)
(Valid 
;; def=FStar.TSet.fsti(43,63-43,71); use=FStar.TSet.fsti(43,63-43,71)
(FStar.TSet.mem @x0
@x3
...
;; def=FStar.TSet.fsti(43,76-43,84); use=FStar.TSet.fsti(43,76-43,84)
(Valid 
;; def=FStar.TSet.fsti(43,76-43,84); use=FStar.TSet.fsti(43,76-43,84)
(FStar.TSet.mem @x0
@x3
...
;;no pats
:qid equation_FStar.TSet.subset.1))
)
...
@x1
@x2))
:qid equation_FStar.TSet.subset))

:named equation_FStar.TSet.subset))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
:named defn_equation_Prims.subtype_of))
;;;;;;;;;;;;;;;;Prop-typing for FStar.TSet.subset
;;; Fact-ids: Name FStar.TSet.subset; Namespace FStar.TSet
(assert (! 
;; def=FStar.TSet.fsti(43,4-43,10); use=FStar.TSet.fsti(43,4-43,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(FStar.TSet.set @x0)))
(Valid (Prims.subtype_of (FStar.TSet.subset @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (FStar.TSet.subset @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_FStar.TSet.subset))

:named defn_equation_FStar.TSet.subset))
...
; Starting query at NegativeTests.Set.fst(33,2-33,67)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u99: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash (FStar.TSet.subset (FStar.TSet.union (FStar.TSet.singleton NegativeTests.Set.a)
;             (FStar.TSet.singleton NegativeTests.Set.b))
;         (FStar.TSet.singleton NegativeTests.Set.a))


; Context: While encoding a query
; While typechecking the top-level declaration `let should_fail2`
; While typechecking the top-level declaration `[@@expect_failure] let should_fail2`
...
;; def=NegativeTests.Set.fst(33,9-33,67); use=NegativeTests.Set.fst(33,9-33,67)
(or label_1

;; def=NegativeTests.Set.fst(33,9-33,67); use=NegativeTests.Set.fst(33,9-33,67)
(Valid 
;; def=NegativeTests.Set.fst(33,9-33,67); use=NegativeTests.Set.fst(33,9-33,67)
(FStar.TSet.subset NegativeTests.Set.elt
(FStar.TSet.union NegativeTests.Set.elt
(FStar.TSet.singleton NegativeTests.Set.elt
(NegativeTests.Set.a Dummy_value))
(FStar.TSet.singleton NegativeTests.Set.elt
(NegativeTests.Set.b Dummy_value)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Set.should_fail2, 1)
; STATUS: unknown because (incomplete quantifiers)
...
; encoding sigelt val NegativeTests.Set.should_fail3


; <Skipped val NegativeTests.Set.should_fail3/>
...
:named typing_NegativeTests.Set.elt))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Set.c; Namespace NegativeTests.Set
(assert (! 
;; def=NegativeTests.Set.fst(21,11-21,12); use=NegativeTests.Set.fst(21,11-21,12)
(forall ((@u0 Dummy_sort))
 (! (HasType (NegativeTests.Set.c @u0)
NegativeTests.Set.elt)
 

:pattern ((NegativeTests.Set.c @u0))
:qid typing_NegativeTests.Set.c))

:named typing_NegativeTests.Set.c))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NegativeTests.Set.b; Namespace NegativeTests.Set
(assert (! 
;; def=NegativeTests.Set.fst(20,11-20,12); use=NegativeTests.Set.fst(20,11-20,12)
...
; Starting query at NegativeTests.Set.fst(38,2-38,52)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u94: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash (FStar.TSet.mem NegativeTests.Set.c
;         (FStar.TSet.union (FStar.TSet.singleton NegativeTests.Set.a)
;             (FStar.TSet.singleton NegativeTests.Set.b)))


; Context: While encoding a query
; While typechecking the top-level declaration `let should_fail3`
...
;; def=NegativeTests.Set.fst(38,9-38,52); use=NegativeTests.Set.fst(38,9-38,52)
(or label_1
...
;; def=NegativeTests.Set.fst(38,9-38,52); use=NegativeTests.Set.fst(38,9-38,52)
(FStar.TSet.mem NegativeTests.Set.elt
(NegativeTests.Set.c Dummy_value)
(FStar.TSet.union NegativeTests.Set.elt
(FStar.TSet.singleton NegativeTests.Set.elt
(NegativeTests.Set.a Dummy_value))
(FStar.TSet.singleton NegativeTests.Set.elt
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NegativeTests.Set.should_fail3, 1)
; STATUS: unknown because (incomplete quantifiers)
