...
; Starting query at Lib.Sequence.fsti(311,0-318,7)
...
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(315,5-315,42); use=Lib.Sequence.fsti(315,5-315,42)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_b14928a18ba707004108386997fed9d6 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_b14928a18ba707004108386997fed9d6 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_b14928a18ba707004108386997fed9d6))

:named refinement_kinding_Tm_refine_b14928a18ba707004108386997fed9d6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(315,5-315,42); use=Lib.Sequence.fsti(315,5-315,42)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b14928a18ba707004108386997fed9d6 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Lib.Sequence.seq @x2))

;; def=Lib.Sequence.fsti(315,15-315,41); use=Lib.Sequence.fsti(315,15-315,41)
(= (Prims.op_Modulus (Lib.Sequence.length @x2
@x1)
@x3)
(BoxInt 0))
))
...
(Tm_refine_b14928a18ba707004108386997fed9d6 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_b14928a18ba707004108386997fed9d6))

:named refinement_interpretation_Tm_refine_b14928a18ba707004108386997fed9d6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b14928a18ba707004108386997fed9d6
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(315,5-315,42); use=Lib.Sequence.fsti(315,5-315,42)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b14928a18ba707004108386997fed9d6 @x0
@x1)))
(Valid (Prims.hasEq (Lib.Sequence.seq @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b14928a18ba707004108386997fed9d6 @x0
@x1))))
:qid haseqTm_refine_b14928a18ba707004108386997fed9d6))

:named haseqTm_refine_b14928a18ba707004108386997fed9d6))

; Encoding query formula : forall (a: Type0) (b: Type0) (blocksize: n: Prims.pos{n <= Prims.pow2 32 - 1}).
;   (forall (inp: Lib.Sequence.seq a).
;       (*  - Subtyping check failed
;   - Expected type Prims.nonzero got type Lib.IntTypes.size_pos
; *)
;       blocksize > 0 /\ blocksize <= Prims.pow2 32 - 1 ==> blocksize <> 0) /\
;   (forall (inp: Lib.Sequence.seq a {Lib.Sequence.length inp % blocksize = 0}).
;       (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;       blocksize > 0 /\ blocksize <= Prims.pow2 32 - 1 ==>
;       blocksize >= 0 /\ blocksize <= Prims.pow2 32 - 1)


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.repeat_blocks_multi`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(311,0-318,7)
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(311,0-318,7)
(and 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(312,7-318,7)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Lib.Sequence.seq @x0))

;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(315,28-315,37)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(315,28-315,37)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(315,28-315,37)
(or label_1
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Tm_refine_b14928a18ba707004108386997fed9d6 @x0
@x2))

;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(316,15-316,24)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(316,15-316,24)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(316,15-316,24)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(316,15-316,24)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.repeat_blocks_multi, 1)
; STATUS: unsat
