...
(declare-fun Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2 (Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(175,35-175,36); use=Lib.Sequence.fsti(425,11-429,84)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (HasType (Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2 @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2 @x0
@x1
@x2
@x3
@x4
...
@x7)
Tm_type))
:qid refinement_kinding_Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2))

:named refinement_kinding_Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(175,35-175,36); use=Lib.Sequence.fsti(425,11-429,84)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2 @x2
@x3
@x4
@x5
@x6
...
@x8
@x9)))
:qid refinement_interpretation_Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2))

:named refinement_interpretation_Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(175,35-175,36); use=Lib.Sequence.fsti(425,11-429,84)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2 @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2 @x0
@x1
@x2
@x3
@x4
...
@x6
@x7))))
:qid haseqTm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2))

:named haseqTm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2))
...
;   (_: _: Prims.unit{Lib.Sequence.map_blocks_multi bs max n inp f == return_val})
;   (any_result: i: Prims.nat{i < n * bs}) (_: _: Prims.unit{i == any_result}) (any_result: a)
;   (_:
;   _: Prims.unit{FStar.Seq.Base.index (Lib.Sequence.map_blocks_multi bs max n inp f) i == any_result})
; .
...
@x1))
(HasType @x33
(Tm_refine_0dee8cb03258a67c2f7ec66427696212 @x6
@x32))
(HasType @x34
@x0)
(HasType @x35
(Tm_refine_d94797aec0bcde8bd6a0d5ddfde2cee2 @x0
@x1
@x2
@x3
@x4
...
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(429,66-429,67)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(429,66-429,67)
(>= (BoxInt_proj_0 (Prims.op_Division @x6
@x1))
(BoxInt_proj_0 (BoxInt 0)))
)
)
