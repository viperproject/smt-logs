...
;     got type Prims.int
; *)
;   (i / bs + 1) * bs <= FStar.Seq.Base.length inp
...
;; def=FStar.Seq.Base.fsti(64,59-64,72); use=Lib.Sequence.fsti(428,50-428,64)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 13)
