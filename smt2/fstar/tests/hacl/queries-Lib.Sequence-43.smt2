...
(declare-fun Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(423,46-423,48)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b))

:named refinement_kinding_Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(423,46-423,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(423,46-423,48)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))
...
@x1
(Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b @x2)))
:qid refinement_interpretation_Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b))

:named refinement_interpretation_Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b
;;; Fact-ids: 
(assert (! 
;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(423,46-423,48)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b @x0))))
:qid haseqTm_refine_89c993ace77fbcbb3e1998f8c62bf10b))

:named haseqTm_refine_89c993ace77fbcbb3e1998f8c62bf10b))

; Encoding query formula : forall (a: Type)
;   (bs: n: Prims.pos{n <= Prims.pow2 32 - 1})
;   (max: Prims.pos)
;   (n: Prims.pos{n <= max})
;   (inp: Lib.Sequence.seq a {Lib.Sequence.length inp == max * bs})
;   (i: Prims.nat{i < max})
;   (_: Lib.Sequence.lseq a bs)
;   (_: _: Prims.unit{bs > 0 /\ bs <= Prims.pow2 32 - 1}).
;   (*  - Subtyping check failed
;   - Expected type Lib.IntTypes.size_nat got type Lib.IntTypes.size_pos
; *)
;   bs >= 0
...
@x1))
(HasType @x7
(Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b @x1)))

;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(423,46-423,48)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 4)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_89c993ace77fbcbb3e1998f8c62bf10b
