...
; Starting query at Lib.Sequence.fsti(369,0-371,26)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_9eb88b5d5c882369177d874ace786d6a (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(370,12-370,37); use=Lib.Sequence.fsti(369,43-369,48)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_9eb88b5d5c882369177d874ace786d6a @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_9eb88b5d5c882369177d874ace786d6a @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_9eb88b5d5c882369177d874ace786d6a))

:named refinement_kinding_Tm_refine_9eb88b5d5c882369177d874ace786d6a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(370,12-370,37); use=Lib.Sequence.fsti(369,43-369,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9eb88b5d5c882369177d874ace786d6a @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Lib.Sequence.fsti(370,12-370,28); use=Lib.Sequence.fsti(369,43-369,48)
(<= (BoxInt_proj_0 (Prims.op_Multiply (Prims.op_Division @x2
@x3)
@x3))
(BoxInt_proj_0 @x4))


;; def=Lib.Sequence.fsti(370,32-370,37); use=Lib.Sequence.fsti(369,43-369,48)
(< (BoxInt_proj_0 @x4)
(BoxInt_proj_0 @x2))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_9eb88b5d5c882369177d874ace786d6a))

:named refinement_interpretation_Tm_refine_9eb88b5d5c882369177d874ace786d6a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9eb88b5d5c882369177d874ace786d6a
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(370,12-370,37); use=Lib.Sequence.fsti(369,43-369,48)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9eb88b5d5c882369177d874ace786d6a @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9eb88b5d5c882369177d874ace786d6a @x0
@x1
@x2))))
:qid haseqTm_refine_9eb88b5d5c882369177d874ace786d6a))

:named haseqTm_refine_9eb88b5d5c882369177d874ace786d6a))

; Encoding query formula : forall (b: Prims.pos) (i: Prims.int) (j: Prims.int).
;   (b > 0 ==> b <> 0) /\
;   (forall (any_result: Prims.logical).
;       (j / b * b <= i) /\ (i < j) == any_result ==>
;       (b > 0 ==> b <> 0) /\
;       (forall (_: Prims.squash (j / b * b <= i /\ i < j)).
;           (*  - Could not prove post-condition
; *)
;           (b > 0 ==> b <> 0) /\
;           (forall (any_result: Prims.pos).
;               b == any_result ==>
;               (forall (any_result: Prims.int). i % b == any_result ==> b > 0 ==> b <> 0))))


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.mod_div_lt`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(369,0-371,26)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.pos)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(369,18-371,26)
(and (implies 
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(370,17-370,18)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(370,17-370,18)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=Lib.Sequence.fsti(369,18-371,26)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.logical)

;; def=FStar.Pervasives.fsti(112,28-112,31); use=Lib.Sequence.fsti(369,18-371,26)
(= (Prims.l_and (Prims.b2t (Prims.op_LessThanOrEqual (Prims.op_Multiply (Prims.op_Division @x2
@x0)
@x0)
@x1))
(Prims.b2t (Prims.op_LessThan @x1
@x2)))
@x3)
)

;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(369,18-371,26)
(and (implies 
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(371,12-371,25)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
...
;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(371,12-371,25)
(not (= @x0
(BoxInt 0)))
)
)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(371,12-371,25)
(and (implies 
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(371,16-371,17)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(371,16-371,17)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=Lib.Sequence.fsti(371,12-371,25)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.pos)

;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(371,12-371,25)
(= @x0
@x5)
)
...
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(371,24-371,25)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(371,24-371,25)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.mod_div_lt, 1)
; STATUS: unsat
