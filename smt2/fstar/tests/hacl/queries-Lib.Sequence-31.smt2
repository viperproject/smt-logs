...
; Starting query at Lib.Sequence.fsti(357,0-359,22)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(358,12-358,41); use=Lib.Sequence.fsti(357,45-357,50)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4))

:named refinement_kinding_Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(358,12-358,41); use=Lib.Sequence.fsti(357,45-357,50)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Lib.Sequence.fsti(358,12-358,22); use=Lib.Sequence.fsti(357,45-357,50)
(<= (BoxInt_proj_0 (Prims.op_Multiply @x2
@x3))
(BoxInt_proj_0 @x4))


;; def=Lib.Sequence.fsti(358,26-358,41); use=Lib.Sequence.fsti(357,45-357,50)
(< (BoxInt_proj_0 @x4)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4))

:named refinement_interpretation_Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4))
;;;;;;;;;;;;;;;;haseq for Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(358,12-358,41); use=Lib.Sequence.fsti(357,45-357,50)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4 @x0
@x1
@x2))))
:qid haseqTm_refine_72d7db778f558bf7c591dc36a9f9bdf4))

:named haseqTm_refine_72d7db778f558bf7c591dc36a9f9bdf4))

; Encoding query formula : forall (b: Prims.pos)
;   (n: Prims.int)
;   (i: Prims.int)
;   (_: Prims.squash (n * b <= i /\ i < (n + 1) * b)).
;   (*  - Could not prove post-condition
; *) b > 0 ==> b <> 0


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.div_interval`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(357,0-359,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.pos)
(HasType @x1
...
Prims.int)
(HasType @x3
(Tm_refine_72d7db778f558bf7c591dc36a9f9bdf4 @x1
@x0
@x2))

;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(359,16-359,17)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(359,16-359,17)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.div_interval, 1)
; STATUS: unsat
