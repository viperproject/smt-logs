...
; Starting query at Lib.Sequence.fsti(241,0-246,72)
...
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(241,10-241,33); use=Lib.Sequence.fsti(242,8-242,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x3
@x4)))
:qid Lib.Sequence_pre_typing_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a))

:named Lib.Sequence_pre_typing_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a))
...
@x4)
@x5))
:qid Lib.Sequence_interpretation_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid Lib.Sequence_interpretation_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a.2))
))
...
@x2
@x3)))
:qid Lib.Sequence_interpretation_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a))

:named Lib.Sequence_interpretation_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Lib.Sequence.index; Namespace Lib.Sequence
(assert (! 
...
; *)
;   forall (s3: Lib.Sequence.lseq c len) (i: Prims.nat).
;     i < len ==>
;     i <= Prims.pow2 32 - 1 /\ i < len /\
;     (forall (any_result: Prims.nat).
;         i == any_result ==>
;         (forall (any_result: r: c{r == FStar.Seq.Base.index (Lib.Sequence.to_seq s3) i}).
;             Lib.Sequence.index s3 i == any_result ==>
;             (forall (return_val: r: c{r == FStar.Seq.Base.index (Lib.Sequence.to_seq s3) i}).
;                 return_val == Lib.Sequence.index s3 i ==>
;                 Lib.Sequence.index s3 i == return_val ==>
;                 i <= Prims.pow2 32 - 1 /\ i < len /\
;                 (forall (any_result: Prims.nat).
;                     i == any_result ==>
;                     (forall (any_result: r: a{r == FStar.Seq.Base.index (Lib.Sequence.to_seq s1) i})
;                       .
;                         Lib.Sequence.index s1 i == any_result ==>
;                         (forall (return_val:
;                             r: a{r == FStar.Seq.Base.index (Lib.Sequence.to_seq s1) i}).
;                             return_val == Lib.Sequence.index s1 i ==>
;                             Lib.Sequence.index s1 i == return_val ==>
;                             i <= Prims.pow2 32 - 1 /\ i < len))))))


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.map2`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(241,0-246,72)
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(241,12-246,72)
...
;; def=Lib.Sequence.fsti(246,28-246,35); use=Lib.Sequence.fsti(246,28-246,35)
(< (BoxInt_proj_0 @x8)
(BoxInt_proj_0 @x3))
)

;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(246,28-246,69)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(246,49-246,50)
(or label_1
...
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(246,49-246,50)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Lib.Sequence.fsti(246,28-246,69)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.nat)

;; def=Lib.Sequence.fsti(40,5-245,31); use=Lib.Sequence.fsti(246,28-246,69)
(= @x8
@x9)
)
...
;; def=Lib.Sequence.fsti(41,6-246,50); use=Lib.Sequence.fsti(246,40-246,50)
...
;; def=Prims.fst(356,2-356,58); use=Lib.Sequence.fsti(246,28-246,69)
(forall ((@x11 Term))
...
;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(246,28-246,69)
(= @x11
(Lib.Sequence.index @x2
@x3
@x7
...
;; def=Prims.fst(175,35-175,36); use=Lib.Sequence.fsti(246,28-246,69)
(= (Lib.Sequence.index @x2
@x3
@x7
@x8)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(246,28-246,69)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(246,60-246,61)
(or label_3
...
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(246,60-246,61)
(or label_4
...
;; def=Lib.Sequence.fsti(41,6-246,62); use=Lib.Sequence.fsti(246,56-246,62)
(= (Lib.Sequence.index @x0
@x3
@x5
@x8)
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(246,28-246,69)
(= (Lib.Sequence.index @x0
@x3
@x5
@x8)
...
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(246,67-246,68)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(246,67-246,68)
(or label_5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.map2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_c8dd98bb91cb1ba6963e5299b3babaa4
