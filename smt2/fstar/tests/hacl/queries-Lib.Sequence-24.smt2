...
; Starting query at Lib.Sequence.fsti(268,0-280,13)
...
;   forall (nb: Prims.nat).
;     (*  - Subtyping check failed
;   - Expected type Prims.nonzero got type bs: Lib.IntTypes.size_nat{bs > 0}
; *)
;     bs >= 0 /\ bs <= Prims.pow2 32 - 1 /\ bs > 0 ==> bs <> 0
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(278,2-280,13)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(278,2-280,13)
(>= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(278,2-280,13)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))


;; def=Lib.Sequence.fsti(271,15-271,21); use=Lib.Sequence.fsti(278,2-280,13)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(274,29-274,31)
(or label_1

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(278,2-280,13)
(not (= @x2
(BoxInt 0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.repeat_blocks_f, 2)
; STATUS: unsat
