...
; Starting query at Lib.Sequence.fsti(209,2-209,41)
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Lib.Sequence.slice; Namespace Lib.Sequence
(assert (! 
;; def=Lib.Sequence.fsti(137,4-137,46); use=Lib.Sequence.fsti(137,4-137,46)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5))

:named refinement_kinding_Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Lib.Sequence.slice; Namespace Lib.Sequence
(assert (! 
;; def=Lib.Sequence.fsti(137,4-137,46); use=Lib.Sequence.fsti(137,4-137,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(137,9-137,17)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))


;; def=Lib.Sequence.fsti(137,18-137,30); use=Lib.Sequence.fsti(137,18-137,30)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 @x1))


;; def=Lib.Sequence.fsti(137,34-137,44); use=Lib.Sequence.fsti(137,34-137,44)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x3))
))
...
(Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5))

:named refinement_interpretation_Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5
;;; Fact-ids: Name Lib.Sequence.slice; Namespace Lib.Sequence
(assert (! 
;; def=Lib.Sequence.fsti(137,4-137,46); use=Lib.Sequence.fsti(137,4-137,46)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5 @x0
@x1)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5 @x0
@x1))))
:qid haseqTm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5))

:named haseqTm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5))
...
;   (fin: (n: Prims.nat{n <= Prims.pow2 32 - 1}){start <= fin /\ fin <= len})
;   (upd: Lib.Sequence.lseq a (fin - start)).
;   (*  - Could not prove post-condition
; *)
;   fin - start >= 0 /\ fin - start <= Prims.pow2 32 - 1 /\ start + (fin - start) <= len


; Context: While encoding a query
; While typechecking the top-level declaration `let update_slice`
...
Tm_refine_c8dd98bb91cb1ba6963e5299b3babaa4)
(HasType @x4
(Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5 @x3
@x1))
(HasType @x5
(Lib.Sequence.lseq @x0
...
;; def=Lib.Sequence.fsti(147,16-147,32); use=Lib.Sequence.fsti(209,24-209,37)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(209,24-209,37)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(209,24-209,37)
(>= (BoxInt_proj_0 (Prims.op_Subtraction @x4
@x3))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(209,24-209,37)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.update_slice, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, int_inversion, primitive_Prims.op_Addition, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_c8dd98bb91cb1ba6963e5299b3babaa4, refinement_interpretation_Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5
