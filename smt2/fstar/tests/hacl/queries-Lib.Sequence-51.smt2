...
;   - Expected type j: Prims.nat{j * bs <= j && j <= FStar.Seq.Base.length inp}
;     got type Prims.int
; *)
;   i / bs * bs <= (i / bs + 1) * bs
...
;; def=FStar.Seq.Base.fsti(64,49-64,55); use=Lib.Sequence.fsti(428,50-428,64)
(or label_1
...
@x1)
@x1))
(BoxInt_proj_0 (Prims.op_Multiply (Prims.op_Addition (Prims.op_Division @x6
@x1)
(BoxInt 1))
@x1)))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 12)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.pos, primitive_Prims.op_Addition, primitive_Prims.op_Division, primitive_Prims.op_Multiply, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_0dee8cb03258a67c2f7ec66427696212, refinement_interpretation_Tm_refine_288bbb48da5bad009ab47741bed35bc6, refinement_interpretation_Tm_refine_609674d96c81c962549b0076055bf213, refinement_interpretation_Tm_refine_6fdcf7302a39aeac615b0eb19b068938, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5
