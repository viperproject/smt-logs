...
; Internals for Lib.Exponentiation.Definition


; encoding sigelt #set-options "--z3rlimit 50 --fuel 0 --ifuel 0"


; <Skipped #set-options "--z3rlimit 50 --fuel 0 --ifuel 0"/>


; encoding sigelt type Lib.Exponentiation.Definition.comm_monoid


; <Start encoding type Lib.Exponentiation.Definition.comm_monoid>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Lib.Exponentiation.Definition.comm_monoid (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Lib.Exponentiation.Definition.comm_monoid@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Lib.Exponentiation.Definition.Mkcomm_monoid (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lib.Exponentiation.Definition.Mkcomm_monoid_t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lib.Exponentiation.Definition.Mkcomm_monoid_one (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lib.Exponentiation.Definition.Mkcomm_monoid_mul (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_one (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_mul_assoc (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_mul_comm (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Lib.Exponentiation.Definition.Mkcomm_monoid
(declare-fun Lib.Exponentiation.Definition.Mkcomm_monoid@tok () Term)
;;;;;;;;;;;;;;;;_: t -> _: t -> t
...
;;;;;;;;;;;;;;;;a: t -> FStar.Pervasives.Lemma (ensures mul a one == a)
...
;;;;;;;;;;;;;;;;a: t -> b: t -> c: t -> FStar.Pervasives.Lemma (ensures mul (mul a b) c == mul a (mul b c))
...
;;;;;;;;;;;;;;;;a: t -> b: t -> FStar.Pervasives.Lemma (ensures mul a b == mul b a)
...
;;;;;;;;;;;;;;;;one: t ->     mul: (_: t -> _: t -> t) ->     lemma_one: (a: t -> FStar.Pervasives.Lemma (ensures mul a one == a)) ->     lemma_mul_assoc:       (a: t -> b: t -> c: t -> FStar.Pervasives.Lemma (ensures mul (mul a b) c == mul a (mul b c))) ->     lemma_mul_comm: (a: t -> b: t -> FStar.Pervasives.Lemma (ensures mul a b == mul b a))   -> comm_monoid t
(declare-fun Tm_arrow_a07ab413b24a5d9ae3ef7ff91c2b7c54 () Term)

; <start constructor Lib.Exponentiation.Definition.comm_monoid>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lib.Exponentiation.Definition.comm_monoid ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
(Lib.Exponentiation.Definition.comm_monoid @x0))
 
;;no pats
:qid is-Lib.Exponentiation.Definition.comm_monoid))))

; </end constructor Lib.Exponentiation.Definition.comm_monoid>


; <start constructor Lib.Exponentiation.Definition.Mkcomm_monoid>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lib.Exponentiation.Definition.Mkcomm_monoid ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
(Lib.Exponentiation.Definition.Mkcomm_monoid (Lib.Exponentiation.Definition.Mkcomm_monoid_t __@x0)
(Lib.Exponentiation.Definition.Mkcomm_monoid_one __@x0)
(Lib.Exponentiation.Definition.Mkcomm_monoid_mul __@x0)
(Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_one __@x0)
(Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_mul_assoc __@x0)
(Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_mul_comm __@x0)))))

; </end constructor Lib.Exponentiation.Definition.Mkcomm_monoid>


; </end encoding type Lib.Exponentiation.Definition.comm_monoid>


; encoding sigelt val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__one


; <Start encoding val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__one>

(declare-fun Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__one (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: comm_monoid t -> t
(declare-fun Tm_arrow_114df80cc8f66128706467bc645c9cc2 () Term)
(declare-fun Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__one@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__one>


; encoding sigelt let __proj__Mkcomm_monoid__item__one


; <Skipped let __proj__Mkcomm_monoid__item__one/>


; encoding sigelt val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__mul


; <Start encoding val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__mul>

(declare-fun Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__mul (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: comm_monoid t -> _: t -> _: t -> t
(declare-fun Tm_arrow_ed1dc12c3031eac49a3b3710e8a1a6f5 () Term)
(declare-fun Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__mul@tok () Term)


; </end encoding val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__mul>


; encoding sigelt let __proj__Mkcomm_monoid__item__mul


; <Skipped let __proj__Mkcomm_monoid__item__mul/>


; encoding sigelt val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_one


; <Start encoding val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_one>

(declare-fun Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_one (Term Term) Term)
(declare-fun Tm_refine_e7e3b7e283eaf6ccac4a03d5ac3a490d (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: t -> FStar.Pervasives.Lemma (ensures projectee.mul a projectee.one == a)
(declare-fun Tm_arrow_8bbd106f5da5adaaeb236f1730cea504 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: comm_monoid t -> a: t   -> FStar.Pervasives.Lemma (ensures projectee.mul a projectee.one == a)
(declare-fun Tm_arrow_7a6e9ebab61d8dba6b8962eeed8fc24f () Term)
(declare-fun Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_one@tok () Term)




; </end encoding val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_one>


; encoding sigelt let __proj__Mkcomm_monoid__item__lemma_one


; <Skipped let __proj__Mkcomm_monoid__item__lemma_one/>


; encoding sigelt val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_mul_assoc


; <Start encoding val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_mul_assoc>

(declare-fun Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_mul_assoc (Term Term) Term)




(declare-fun Tm_refine_8812afabbd653e8c641bb6aeccffb7d6 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: t -> b: t -> c: t   -> FStar.Pervasives.Lemma     (ensures projectee.mul (projectee.mul a b) c == projectee.mul a (projectee.mul b c))
(declare-fun Tm_arrow_a9c91bbb25cee47c81c150f5015a2abd (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: comm_monoid t -> a: t -> b: t -> c: t   -> FStar.Pervasives.Lemma     (ensures projectee.mul (projectee.mul a b) c == projectee.mul a (projectee.mul b c))
(declare-fun Tm_arrow_c030777d25005d6edb6c7f768734d0b8 () Term)
(declare-fun Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_mul_assoc@tok () Term)
...
; </end encoding val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_mul_assoc>


; encoding sigelt let __proj__Mkcomm_monoid__item__lemma_mul_assoc


; <Skipped let __proj__Mkcomm_monoid__item__lemma_mul_assoc/>


; encoding sigelt val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_mul_comm


; <Start encoding val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_mul_comm>

(declare-fun Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_mul_comm (Term Term) Term)


(declare-fun Tm_refine_ddee4755ab07d99cc065f479cc3f1e93 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: t -> b: t -> FStar.Pervasives.Lemma (ensures projectee.mul a b == projectee.mul b a)
(declare-fun Tm_arrow_bcb99ffe63c02367f3ca6ec3a3362378 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: comm_monoid t -> a: t -> b: t   -> FStar.Pervasives.Lemma (ensures projectee.mul a b == projectee.mul b a)
(declare-fun Tm_arrow_a7efd50f430c894c18f7dd46dde93b58 () Term)
(declare-fun Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_mul_comm@tok () Term)





; </end encoding val Lib.Exponentiation.Definition.__proj__Mkcomm_monoid__item__lemma_mul_comm>


; encoding sigelt let __proj__Mkcomm_monoid__item__lemma_mul_comm


; <Skipped let __proj__Mkcomm_monoid__item__lemma_mul_comm/>
...
(declare-fun Lib.Exponentiation.Definition.one (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: comm_monoid t |} -> t
(declare-fun Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: comm_monoid t |} -> t
(declare-fun Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be () Term)
(declare-fun Lib.Exponentiation.Definition.one@tok () Term)


(declare-fun Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8 (Term) Term)

; </end encoding let one>


; encoding sigelt let mul


; <Start encoding let mul>

(declare-fun Lib.Exponentiation.Definition.mul (Term) Term)

;;;;;;;;;;;;;;;;_: t -> _: t -> t
(declare-fun Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: comm_monoid t |} -> _: t -> _: t -> t
(declare-fun Tm_arrow_91c2ad0c19715a715447e601b3c7259d (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: comm_monoid t |} -> _: t -> _: t -> t
(declare-fun Tm_arrow_b130726af5abe6e56dd563e668a77bed () Term)
(declare-fun Lib.Exponentiation.Definition.mul@tok () Term)
...
(declare-fun Tm_abs_2adc8a407a94c2d6b32710f342083b63 (Term) Term)

; </end encoding let mul>


; encoding sigelt let lemma_one


; <Start encoding let lemma_one>

(declare-fun Lib.Exponentiation.Definition.lemma_one (Term) Term)
(declare-fun Non_total_Tm_arrow_e416a6b549bbbd19efe3abd1c3d23cf8 (Term Term) Term)
;;;;;;;;;;;;;;;;{| projectee: comm_monoid t |} -> a: t   -> FStar.Pervasives.Lemma (ensures projectee.mul a projectee.one == a)
(declare-fun Tm_arrow_f2a5b97eadaa86c9df5db114d87471fe (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: comm_monoid t |} -> a: t   -> FStar.Pervasives.Lemma (ensures projectee.mul a projectee.one == a)
(declare-fun Tm_arrow_89d8c99b7a2d5b9b7fec99a196f54870 () Term)
(declare-fun Lib.Exponentiation.Definition.lemma_one@tok () Term)




(declare-fun Tm_abs_32edfcab152ba42e4eeb0a648835ebd7 (Term) Term)

; </end encoding let lemma_one>


; encoding sigelt let lemma_mul_assoc


; <Start encoding let lemma_mul_assoc>

(declare-fun Lib.Exponentiation.Definition.lemma_mul_assoc (Term) Term)
(declare-fun Non_total_Tm_arrow_01bf121281bc53f85d96f086134ee4a5 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;b: t -> c: t   -> FStar.Pervasives.Lemma     (ensures projectee.mul (projectee.mul a b) c == projectee.mul a (projectee.mul b c))
(declare-fun Tm_arrow_b207fc59d7a4d070bb2a823f61961046 (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: t -> b: t -> c: t   -> FStar.Pervasives.Lemma     (ensures projectee.mul (projectee.mul a b) c == projectee.mul a (projectee.mul b c))
(declare-fun Tm_arrow_66b95dd04e8c3ce28371f99d9e8c7e08 (Term Term) Term)
;;;;;;;;;;;;;;;;{| projectee: comm_monoid t |} -> a: t -> b: t -> c: t   -> FStar.Pervasives.Lemma     (ensures projectee.mul (projectee.mul a b) c == projectee.mul a (projectee.mul b c))
(declare-fun Tm_arrow_b1481aed4e27cefca6ee42a4b26e4085 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: comm_monoid t |} -> a: t -> b: t -> c: t   -> FStar.Pervasives.Lemma     (ensures projectee.mul (projectee.mul a b) c == projectee.mul a (projectee.mul b c))
(declare-fun Tm_arrow_75831d42c11ec683a1699743d8ba95fd () Term)
(declare-fun Lib.Exponentiation.Definition.lemma_mul_assoc@tok () Term)
...
(declare-fun Tm_abs_733d13f11770181626db59a35332dd7c (Term) Term)

; </end encoding let lemma_mul_assoc>


; encoding sigelt let lemma_mul_comm


; <Start encoding let lemma_mul_comm>

(declare-fun Lib.Exponentiation.Definition.lemma_mul_comm (Term) Term)
(declare-fun Non_total_Tm_arrow_7cb7631357c77d2f1655ce107dc3cfc9 (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: t -> b: t -> FStar.Pervasives.Lemma (ensures projectee.mul a b == projectee.mul b a)
(declare-fun Tm_arrow_bd131878413040760d7b41231460a32f (Term Term) Term)
;;;;;;;;;;;;;;;;{| projectee: comm_monoid t |} -> a: t -> b: t   -> FStar.Pervasives.Lemma (ensures projectee.mul a b == projectee.mul b a)
(declare-fun Tm_arrow_ed331ce7ee7f59983cb9e4591129e0f2 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: comm_monoid t |} -> a: t -> b: t   -> FStar.Pervasives.Lemma (ensures projectee.mul a b == projectee.mul b a)
(declare-fun Tm_arrow_04fca88487101ec34f75799910e37d42 () Term)
(declare-fun Lib.Exponentiation.Definition.lemma_mul_comm@tok () Term)
...
(declare-fun Tm_abs_759d181e8f68e02605b9d0f08b444732 (Term) Term)

; </end encoding let lemma_mul_comm>


; encoding sigelt type Lib.Exponentiation.Definition.abelian_group


; <Start encoding type Lib.Exponentiation.Definition.abelian_group>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Lib.Exponentiation.Definition.abelian_group (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Lib.Exponentiation.Definition.abelian_group@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Lib.Exponentiation.Definition.Mkabelian_group (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lib.Exponentiation.Definition.Mkabelian_group_t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lib.Exponentiation.Definition.Mkabelian_group_cm (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lib.Exponentiation.Definition.Mkabelian_group_inverse (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lib.Exponentiation.Definition.Mkabelian_group_lemma_inverse (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Lib.Exponentiation.Definition.Mkabelian_group
(declare-fun Lib.Exponentiation.Definition.Mkabelian_group@tok () Term)

(declare-fun Tm_refine_0e5befa12cd89693cc9bd1938882cff9 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: t -> FStar.Pervasives.Lemma (ensures mul (inverse a) a == one)
(declare-fun Tm_arrow_212eedc61dee6384925b2a04a4230ab9 (Term Term Term) Term)



;;;;;;;;;;;;;;;;cm: comm_monoid t ->     inverse: (_: t -> t) ->     lemma_inverse: (a: t -> FStar.Pervasives.Lemma (ensures mul (inverse a) a == one))   -> abelian_group t
(declare-fun Tm_arrow_e16dda4d9b97f6b36df975222b1b1c06 () Term)

; <start constructor Lib.Exponentiation.Definition.abelian_group>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lib.Exponentiation.Definition.abelian_group ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
275)
(exists ((@x0 Term))
 (! (= __@x0
(Lib.Exponentiation.Definition.abelian_group @x0))
 
;;no pats
:qid is-Lib.Exponentiation.Definition.abelian_group))))

; </end constructor Lib.Exponentiation.Definition.abelian_group>


; <start constructor Lib.Exponentiation.Definition.Mkabelian_group>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lib.Exponentiation.Definition.Mkabelian_group ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
287)
(= __@x0
(Lib.Exponentiation.Definition.Mkabelian_group (Lib.Exponentiation.Definition.Mkabelian_group_t __@x0)
(Lib.Exponentiation.Definition.Mkabelian_group_cm __@x0)
(Lib.Exponentiation.Definition.Mkabelian_group_inverse __@x0)
(Lib.Exponentiation.Definition.Mkabelian_group_lemma_inverse __@x0)))))

; </end constructor Lib.Exponentiation.Definition.Mkabelian_group>




; </end encoding type Lib.Exponentiation.Definition.abelian_group>


; encoding sigelt val Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__cm


; <Start encoding val Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__cm>

(declare-fun Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__cm (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: abelian_group t -> comm_monoid t
(declare-fun Tm_arrow_8bec39a0f84e185d7e1040626bec1939 () Term)
(declare-fun Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__cm@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__cm>


; encoding sigelt let __proj__Mkabelian_group__item__cm


; <Skipped let __proj__Mkabelian_group__item__cm/>


; encoding sigelt val Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__inverse


; <Start encoding val Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__inverse>

(declare-fun Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__inverse (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: abelian_group t -> _: t -> t
(declare-fun Tm_arrow_bc9f382d7a17cff685fbb5768b45eb41 () Term)
(declare-fun Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__inverse@tok () Term)


; </end encoding val Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__inverse>


; encoding sigelt let __proj__Mkabelian_group__item__inverse


; <Skipped let __proj__Mkabelian_group__item__inverse/>


; encoding sigelt val Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__lemma_inverse


; <Start encoding val Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__lemma_inverse>

(declare-fun Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__lemma_inverse (Term Term) Term)


(declare-fun Tm_refine_c8447eb39cf546b68619a54041c9f039 (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: t -> FStar.Pervasives.Lemma (ensures mul (projectee.inverse a) a == one)
(declare-fun Tm_arrow_4796a613941262b197e236d6e76faeb8 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: abelian_group t -> a: t   -> FStar.Pervasives.Lemma (ensures mul (projectee.inverse a) a == one)
(declare-fun Tm_arrow_7249df53282b1a0a199e71bab224d049 () Term)
(declare-fun Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__lemma_inverse@tok () Term)
...
; </end encoding val Lib.Exponentiation.Definition.__proj__Mkabelian_group__item__lemma_inverse>


; encoding sigelt let __proj__Mkabelian_group__item__lemma_inverse


; <Skipped let __proj__Mkabelian_group__item__lemma_inverse/>


; encoding sigelt let cm


; <Start encoding let cm>

(declare-fun Lib.Exponentiation.Definition.cm (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: abelian_group t |} -> comm_monoid t
(declare-fun Tm_arrow_73e231f34a0a408145ee5e15b06e4782 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: abelian_group t |} -> comm_monoid t
(declare-fun Tm_arrow_6dcdc0fd6148c879744fb90166c85050 () Term)
(declare-fun Lib.Exponentiation.Definition.cm@tok () Term)


(declare-fun Tm_abs_bea7b8fcbe4b120b89a3a7c95092cc95 (Term) Term)
...
(declare-fun Lib.Exponentiation.Definition.inverse (Term) Term)

;;;;;;;;;;;;;;;;{| projectee: abelian_group t |} -> _: t -> t
(declare-fun Tm_arrow_8e358aad141b12b56152f676aa1e3abc (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: abelian_group t |} -> _: t -> t
(declare-fun Tm_arrow_3c789c7f67d1aab9d88f565679431716 () Term)
(declare-fun Lib.Exponentiation.Definition.inverse@tok () Term)




(declare-fun Tm_abs_f983cda4662bef550ae87c91242338ae (Term) Term)

; </end encoding let inverse>


; encoding sigelt let lemma_inverse


; <Start encoding let lemma_inverse>

(declare-fun Lib.Exponentiation.Definition.lemma_inverse (Term) Term)
(declare-fun Non_total_Tm_arrow_113602f3e1dd1a45ab06fc9e17163364 (Term Term) Term)
;;;;;;;;;;;;;;;;{| projectee: abelian_group t |} -> a: t   -> FStar.Pervasives.Lemma (ensures mul (projectee.inverse a) a == one)
(declare-fun Tm_arrow_fb4bb7a0010fe397d00ba073f865ba0d (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: abelian_group t |} -> a: t   -> FStar.Pervasives.Lemma (ensures mul (projectee.inverse a) a == one)
(declare-fun Tm_arrow_fc7a2de8bf10755fb5c5ad6c106658dc () Term)
(declare-fun Lib.Exponentiation.Definition.lemma_inverse@tok () Term)




(declare-fun Tm_abs_2052d634989cea1edc89bf170f17d803 (Term) Term)

; </end encoding let lemma_inverse>


; encoding sigelt let sqr


; <Start encoding let sqr>

(declare-fun Lib.Exponentiation.Definition.sqr (Term Term Term) Term)
;;;;;;;;;;;;;;;;k: comm_monoid t -> a: t -> t
(declare-fun Tm_arrow_2a0618126810bd55586b14b08a922524 () Term)
(declare-fun Lib.Exponentiation.Definition.sqr@tok () Term)


; </end encoding let sqr>
...
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,6-12,17)
(forall ((@x0 Term))
 (! (= (ApplyTT Lib.Exponentiation.Definition.comm_monoid@tok
@x0)
(Lib.Exponentiation.Definition.comm_monoid @x0))
 

:pattern ((ApplyTT Lib.Exponentiation.Definition.comm_monoid@tok
@x0))

:pattern ((Lib.Exponentiation.Definition.comm_monoid @x0))
:qid token_correspondence_Lib.Exponentiation.Definition.comm_monoid@tok))

:named token_correspondence_Lib.Exponentiation.Definition.comm_monoid@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,6-12,17)
...
(Lib.Exponentiation.Definition.Mkcomm_monoid @x1
@x2
@x3
@x4
@x5
@x6)
(Lib.Exponentiation.Definition.comm_monoid @x7))
...
@x6)
(Lib.Exponentiation.Definition.comm_monoid @x7)))
:qid subterm_ordering_Lib.Exponentiation.Definition.Mkcomm_monoid))

:named subterm_ordering_Lib.Exponentiation.Definition.Mkcomm_monoid))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(16,40-16,82); use=Lib.Exponentiation.Definition.fsti(16,40-16,82)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(17,32-17,58); use=Lib.Exponentiation.Definition.fsti(17,32-17,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_4c7dcaed5cb85709e1374a35070247a6 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_4c7dcaed5cb85709e1374a35070247a6 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_4c7dcaed5cb85709e1374a35070247a6))

:named refinement_kinding_Tm_refine_4c7dcaed5cb85709e1374a35070247a6))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(15,20-15,42); use=Lib.Exponentiation.Definition.fsti(15,20-15,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;; def=Prims.fst(635,71-635,97); use=Lib.Exponentiation.Definition.fsti(16,40-16,82)
(not 
;; def=Prims.fst(441,29-441,97); use=Lib.Exponentiation.Definition.fsti(16,40-16,45)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=Lib.Exponentiation.Definition.fsti(16,46-16,82); use=Lib.Exponentiation.Definition.fsti(16,40-16,45)
(= (ApplyTT (ApplyTT @x2
(ApplyTT (ApplyTT @x2
@x3)
@x4))
...
;; def=Prims.fst(635,86-635,95); use=Lib.Exponentiation.Definition.fsti(16,40-16,82)
(not 
;; def=Prims.fst(635,86-635,95); use=Lib.Exponentiation.Definition.fsti(16,40-16,82)
(= @x6
@x1)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4c7dcaed5cb85709e1374a35070247a6 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=Lib.Exponentiation.Definition.fsti(17,32-17,58)
(not 
;; def=Prims.fst(441,29-441,97); use=Lib.Exponentiation.Definition.fsti(17,32-17,37)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=Lib.Exponentiation.Definition.fsti(17,38-17,58); use=Lib.Exponentiation.Definition.fsti(17,32-17,37)
(= (ApplyTT (ApplyTT @x2
@x3)
@x4)
(ApplyTT (ApplyTT @x2
...
;; def=Prims.fst(635,86-635,95); use=Lib.Exponentiation.Definition.fsti(17,32-17,58)
(not 
;; def=Prims.fst(635,86-635,95); use=Lib.Exponentiation.Definition.fsti(17,32-17,58)
(= @x5
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_4c7dcaed5cb85709e1374a35070247a6.1))
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_4c7dcaed5cb85709e1374a35070247a6))

:named refinement_interpretation_Tm_refine_4c7dcaed5cb85709e1374a35070247a6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Char.char_of_int; Namespace FStar.Char
(assert (! 
...
;; def=Prims.fst(635,71-635,97); use=Lib.Exponentiation.Definition.fsti(15,20-15,42)
(not 
;; def=Prims.fst(441,29-441,97); use=Lib.Exponentiation.Definition.fsti(15,20-15,25)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=Lib.Exponentiation.Definition.fsti(15,26-15,42); use=Lib.Exponentiation.Definition.fsti(15,20-15,25)
(= (ApplyTT (ApplyTT @x2
@x3)
@x4)
@x3)
...
;; def=Prims.fst(635,86-635,95); use=Lib.Exponentiation.Definition.fsti(15,20-15,42)
(not 
;; def=Prims.fst(635,86-635,95); use=Lib.Exponentiation.Definition.fsti(15,20-15,42)
(= @x5
@x1)
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Lib.Exponentiation.Definition.Mkcomm_monoid_t (Lib.Exponentiation.Definition.Mkcomm_monoid @x0
@x1
@x2
@x3
@x4
...
:pattern ((Lib.Exponentiation.Definition.Mkcomm_monoid @x0
@x1
@x2
@x3
@x4
@x5))
:qid projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_t))

:named projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,6-12,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Lib.Exponentiation.Definition.Mkcomm_monoid_one (Lib.Exponentiation.Definition.Mkcomm_monoid @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_one))

:named projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_one))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,6-12,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Lib.Exponentiation.Definition.Mkcomm_monoid_mul (Lib.Exponentiation.Definition.Mkcomm_monoid @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_mul))

:named projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_mul))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,6-12,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_one (Lib.Exponentiation.Definition.Mkcomm_monoid @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_one))

:named projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_one))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,6-12,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_mul_comm (Lib.Exponentiation.Definition.Mkcomm_monoid @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_mul_comm))

:named projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_mul_comm))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,6-12,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_mul_assoc (Lib.Exponentiation.Definition.Mkcomm_monoid @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_mul_assoc))

:named projection_inverse_Lib.Exponentiation.Definition.Mkcomm_monoid_lemma_mul_assoc))
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! (is-Tm_arrow (PreType Lib.Exponentiation.Definition.comm_monoid@tok))
:named pre_kinding_Lib.Exponentiation.Definition.comm_monoid@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c50378e6555d46933f317679ca8c6e54
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,19-15,42); use=Lib.Exponentiation.Definition.fsti(15,15-15,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,19-16,82); use=Lib.Exponentiation.Definition.fsti(16,21-16,82)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8f2c909cc77a6360ffea019409a9ceca
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,19-17,58); use=Lib.Exponentiation.Definition.fsti(17,20-17,58)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_8f2c909cc77a6360ffea019409a9ceca @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_8f2c909cc77a6360ffea019409a9ceca @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_8f2c909cc77a6360ffea019409a9ceca))

:named kinding_Tm_arrow_8f2c909cc77a6360ffea019409a9ceca))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_72ac2ec523211f8603e00b25deb1543b
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,19-12,20); use=Lib.Exponentiation.Definition.fsti(14,7-14,18)
(forall ((@x0 Term))
...
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! (and (IsTotFun Lib.Exponentiation.Definition.comm_monoid@tok)

;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,6-12,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Lib.Exponentiation.Definition.comm_monoid @x0)
Tm_type))
 

:pattern ((Lib.Exponentiation.Definition.comm_monoid @x0))
:qid kinding_Lib.Exponentiation.Definition.comm_monoid@tok))
)
:named kinding_Lib.Exponentiation.Definition.comm_monoid@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_4c7dcaed5cb85709e1374a35070247a6
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(17,32-17,58); use=Lib.Exponentiation.Definition.fsti(17,32-17,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4c7dcaed5cb85709e1374a35070247a6 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4c7dcaed5cb85709e1374a35070247a6 @x0
@x1
@x2))))
:qid haseqTm_refine_4c7dcaed5cb85709e1374a35070247a6))

:named haseqTm_refine_4c7dcaed5cb85709e1374a35070247a6))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Lib.Exponentiation.Definition.comm_monoid @x2))
(and (is-Lib.Exponentiation.Definition.Mkcomm_monoid @x1)
(= @x2
(Lib.Exponentiation.Definition.Mkcomm_monoid_t @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(Lib.Exponentiation.Definition.comm_monoid @x2)))
:qid fuel_guarded_inversion_Lib.Exponentiation.Definition.comm_monoid))

:named fuel_guarded_inversion_Lib.Exponentiation.Definition.comm_monoid))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! (= 105
(Term_constr_id Lib.Exponentiation.Definition.comm_monoid@tok))
:named fresh_token_Lib.Exponentiation.Definition.comm_monoid@tok))
...
(HasTypeFuel @u0
@x6
(Tm_arrow_8f2c909cc77a6360ffea019409a9ceca @x3
@x1)))
(HasTypeFuel @u0
(Lib.Exponentiation.Definition.Mkcomm_monoid @x1
@x2
...
@x5
@x6)
(Lib.Exponentiation.Definition.comm_monoid @x1)))
...
@x6)
(Lib.Exponentiation.Definition.comm_monoid @x1)))
:qid data_typing_intro_Lib.Exponentiation.Definition.Mkcomm_monoid@tok))

:named data_typing_intro_Lib.Exponentiation.Definition.Mkcomm_monoid@tok))
...
@x6)
(Lib.Exponentiation.Definition.comm_monoid @x7)))
:qid data_elim_Lib.Exponentiation.Definition.Mkcomm_monoid))

:named data_elim_Lib.Exponentiation.Definition.Mkcomm_monoid))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 104
(Term_constr_id (Lib.Exponentiation.Definition.comm_monoid @x0)))
 

:pattern ((Lib.Exponentiation.Definition.comm_monoid @x0))
:qid constructor_distinct_Lib.Exponentiation.Definition.comm_monoid))

:named constructor_distinct_Lib.Exponentiation.Definition.comm_monoid))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,6-12,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= 122
(Term_constr_id (Lib.Exponentiation.Definition.Mkcomm_monoid @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid constructor_distinct_Lib.Exponentiation.Definition.Mkcomm_monoid))

:named constructor_distinct_Lib.Exponentiation.Definition.Mkcomm_monoid))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Monotonic.Heap.core_mref; Namespace FStar.Monotonic.Heap
(assert (! 
;; def=FStar.Monotonic.Heap.fsti(39,4-39,13); use=FStar.Monotonic.Heap.fsti(39,4-39,13)
...
@x0
(Lib.Exponentiation.Definition.comm_monoid @x2)))
:qid Lib.Exponentiation.Definition_pretyping_cb64241bea69a3e3a182b6094a7d49ef))

:named Lib.Exponentiation.Definition_pretyping_cb64241bea69a3e3a182b6094a7d49ef))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,19-15,42); use=Lib.Exponentiation.Definition.fsti(15,15-15,42)
...
@x3
@x4)))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_c50378e6555d46933f317679ca8c6e54))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_c50378e6555d46933f317679ca8c6e54))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,19-16,82); use=Lib.Exponentiation.Definition.fsti(16,21-16,82)
...
(Tm_arrow_9975d018af81a325c298730f866f4b56 @x2
@x3)))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_9975d018af81a325c298730f866f4b56))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_9975d018af81a325c298730f866f4b56))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,19-17,58); use=Lib.Exponentiation.Definition.fsti(17,20-17,58)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_8f2c909cc77a6360ffea019409a9ceca @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_8f2c909cc77a6360ffea019409a9ceca @x2
@x3)))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_8f2c909cc77a6360ffea019409a9ceca))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_8f2c909cc77a6360ffea019409a9ceca))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,19-12,20); use=Lib.Exponentiation.Definition.fsti(14,7-14,18)
...
@x1
(Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x2)))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))
...
:pattern ((ApplyTT @x0
@x4))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_c50378e6555d46933f317679ca8c6e54.1))
...
@x2
@x3)))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_c50378e6555d46933f317679ca8c6e54))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_c50378e6555d46933f317679ca8c6e54))
...
@x4)
@x5))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56.2))
...
@x3)
@x4))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56.3))
))
...
(Tm_arrow_9975d018af81a325c298730f866f4b56 @x1
@x2)))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8f2c909cc77a6360ffea019409a9ceca
;;; Fact-ids: Name Lib.Exponentiation.Definition.comm_monoid; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkcomm_monoid; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,19-17,58); use=Lib.Exponentiation.Definition.fsti(17,20-17,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_8f2c909cc77a6360ffea019409a9ceca @x1
@x2))
(and 
;; def=Lib.Exponentiation.Definition.fsti(12,19-17,58); use=Lib.Exponentiation.Definition.fsti(17,20-17,58)
(forall ((@x3 Term) (@x4 Term))
...
@x3)
@x4)
(Tm_refine_4c7dcaed5cb85709e1374a35070247a6 @x1
@x3
@x4)))
...
@x3)
@x4))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_8f2c909cc77a6360ffea019409a9ceca.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_8f2c909cc77a6360ffea019409a9ceca.2))
))
...
(Tm_arrow_8f2c909cc77a6360ffea019409a9ceca @x1
@x2)))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_8f2c909cc77a6360ffea019409a9ceca))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_8f2c909cc77a6360ffea019409a9ceca))
...
@x2)
@x3))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x1)))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
; Starting query at Lib.Exponentiation.Definition.fsti(33,2-34,30)
...
;;;;;;;;;;;;;;;;k : Lib.Exponentiation.Definition.comm_monoid t (Lib.Exponentiation.Definition.comm_monoid t)
(declare-fun x_f10306508c57a5af9977b6a0e3b8781e_2 () Term)
;;;;;;;;;;;;;;;;binder_x_f10306508c57a5af9977b6a0e3b8781e_2
;;; Fact-ids: 
(assert (! (HasType x_f10306508c57a5af9977b6a0e3b8781e_2
(Lib.Exponentiation.Definition.comm_monoid x_fe28d8bcde588226b4e538b35321de05_1))
:named binder_x_f10306508c57a5af9977b6a0e3b8781e_2))
;;;;;;;;;;;;;;;;x : t (t)
...
(declare-fun Tm_refine_c65328f123d990fe7dac6541d30b67d2 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(32,23-34,30); use=Lib.Exponentiation.Definition.fsti(32,23-34,30)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_c65328f123d990fe7dac6541d30b67d2 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_c65328f123d990fe7dac6541d30b67d2 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_c65328f123d990fe7dac6541d30b67d2))

:named refinement_kinding_Tm_refine_c65328f123d990fe7dac6541d30b67d2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(32,23-34,30); use=Lib.Exponentiation.Definition.fsti(32,23-34,30)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c65328f123d990fe7dac6541d30b67d2 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Lib.Exponentiation.Definition.fsti(32,23-34,30); use=Lib.Exponentiation.Definition.fsti(32,23-34,30)
(or 
;; def=Lib.Exponentiation.Definition.fsti(33,2-34,30); use=Lib.Exponentiation.Definition.fsti(33,2-34,30)
(Valid 
;; def=Lib.Exponentiation.Definition.fsti(33,2-34,30); use=Lib.Exponentiation.Definition.fsti(33,2-34,30)
(Prims.precedes (Lib.Exponentiation.Definition.comm_monoid @x2)
(Lib.Exponentiation.Definition.comm_monoid x_fe28d8bcde588226b4e538b35321de05_1)
@x3
x_f10306508c57a5af9977b6a0e3b8781e_2)
)


;; def=Lib.Exponentiation.Definition.fsti(32,23-34,30); use=Lib.Exponentiation.Definition.fsti(32,23-34,30)
(and 
;; def=Lib.Exponentiation.Definition.fsti(32,23-32,24); use=Lib.Exponentiation.Definition.fsti(32,23-32,24)
(Valid 
;; def=Lib.Exponentiation.Definition.fsti(32,23-32,24); use=Lib.Exponentiation.Definition.fsti(32,23-32,24)
(Prims.op_Equals_Equals_Equals (Lib.Exponentiation.Definition.comm_monoid @x2)
(Lib.Exponentiation.Definition.comm_monoid x_fe28d8bcde588226b4e538b35321de05_1)
@x3
x_f10306508c57a5af9977b6a0e3b8781e_2)
)
...
;; def=Lib.Exponentiation.Definition.fsti(32,41-34,30); use=Lib.Exponentiation.Definition.fsti(32,41-34,30)
(or 
;; def=Lib.Exponentiation.Definition.fsti(33,2-34,30); use=Lib.Exponentiation.Definition.fsti(33,2-34,30)
(Valid 
;; def=Lib.Exponentiation.Definition.fsti(33,2-34,30); use=Lib.Exponentiation.Definition.fsti(33,2-34,30)
...
;; def=Lib.Exponentiation.Definition.fsti(32,41-34,30); use=Lib.Exponentiation.Definition.fsti(32,41-34,30)
(and 
;; def=Lib.Exponentiation.Definition.fsti(32,41-32,42); use=Lib.Exponentiation.Definition.fsti(32,41-32,42)
(Valid 
;; def=Lib.Exponentiation.Definition.fsti(32,41-32,42); use=Lib.Exponentiation.Definition.fsti(32,41-32,42)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_c65328f123d990fe7dac6541d30b67d2))

:named refinement_interpretation_Tm_refine_c65328f123d990fe7dac6541d30b67d2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c65328f123d990fe7dac6541d30b67d2
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(32,23-34,30); use=Lib.Exponentiation.Definition.fsti(32,23-34,30)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c65328f123d990fe7dac6541d30b67d2 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c65328f123d990fe7dac6541d30b67d2 @x0
@x1
@x2))))
:qid haseqTm_refine_c65328f123d990fe7dac6541d30b67d2))

:named haseqTm_refine_c65328f123d990fe7dac6541d30b67d2))
(declare-fun Lib.Exponentiation.Definition.pow (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;k: comm_monoid t -> x: t -> n: Prims.nat{k << k \/ k === k /\ (x << x \/ x === x /\ n << n)} -> t
(declare-fun Tm_arrow_40816a02c9e27f6f686ca77fb3313034 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_40816a02c9e27f6f686ca77fb3313034
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_40816a02c9e27f6f686ca77fb3313034
Tm_type)
:named kinding_Tm_arrow_40816a02c9e27f6f686ca77fb3313034))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(32,14-34,30); use=Lib.Exponentiation.Definition.fsti(32,16-34,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_40816a02c9e27f6f686ca77fb3313034)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_40816a02c9e27f6f686ca77fb3313034))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_40816a02c9e27f6f686ca77fb3313034))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_40816a02c9e27f6f686ca77fb3313034))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_40816a02c9e27f6f686ca77fb3313034
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(32,14-34,30); use=Lib.Exponentiation.Definition.fsti(32,16-34,30)
(forall ((@x0 Term))
...
@x1)
(HasType @x4
(Tm_refine_c65328f123d990fe7dac6541d30b67d2 @x1
@x2
@x3)))
...
@x3)
@x4))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_40816a02c9e27f6f686ca77fb3313034.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_40816a02c9e27f6f686ca77fb3313034.2))
...
@x1)
@x2))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_40816a02c9e27f6f686ca77fb3313034.3))
...
@x2)
@x3))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_40816a02c9e27f6f686ca77fb3313034.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_40816a02c9e27f6f686ca77fb3313034))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_40816a02c9e27f6f686ca77fb3313034))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_40816a02c9e27f6f686ca77fb3313034))
(declare-fun Lib.Exponentiation.Definition.pow@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(32,8-32,11); use=Lib.Exponentiation.Definition.fsti(32,8-32,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Lib.Exponentiation.Definition.pow@tok
@x0)
@x1)
@x2)
@x3)
(Lib.Exponentiation.Definition.pow @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Lib.Exponentiation.Definition.pow@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Lib.Exponentiation.Definition.pow))

:named token_correspondence_Lib.Exponentiation.Definition.pow))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(32,8-32,11); use=Lib.Exponentiation.Definition.fsti(32,8-32,11)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Lib.Exponentiation.Definition.pow@tok
Tm_arrow_40816a02c9e27f6f686ca77fb3313034))
...
@x3)
@x4)
(Lib.Exponentiation.Definition.pow @x1
@x2
@x3
@x4))
 

:pattern ((Lib.Exponentiation.Definition.pow @x1
@x2
@x3
@x4))
:qid function_token_typing_Lib.Exponentiation.Definition.pow.1))
)
 

:pattern ((ApplyTT @x0
Lib.Exponentiation.Definition.pow@tok))
:qid function_token_typing_Lib.Exponentiation.Definition.pow))

:named function_token_typing_Lib.Exponentiation.Definition.pow))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(32,8-32,11); use=Lib.Exponentiation.Definition.fsti(32,8-32,11)
...
@x0)
(HasType @x3
(Tm_refine_c65328f123d990fe7dac6541d30b67d2 @x0
@x1
@x2)))
(HasType (Lib.Exponentiation.Definition.pow @x0
@x1
@x2
@x3)
@x0))
...
:pattern ((Lib.Exponentiation.Definition.pow @x0
@x1
@x2
@x3))
:qid typing_Lib.Exponentiation.Definition.pow))

:named typing_Lib.Exponentiation.Definition.pow))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post t).
;   (forall (x: t). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   ~(n = 0 = true) ==>
;   (forall (b: Prims.bool). n = 0 == b ==> n - 1 >= 0 /\ (k << k \/ (x << x \/ n - 1 << n)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec pow`
...
;; def=Prims.fst(402,27-402,88); use=Lib.Exponentiation.Definition.fsti(33,2-34,30)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Lib.Exponentiation.Definition.fsti(33,2-34,30)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Lib.Exponentiation.Definition.fsti(33,2-34,30)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=Lib.Exponentiation.Definition.fsti(33,2-34,30)
(not 
;; def=Lib.Exponentiation.Definition.fsti(33,5-33,10); use=Lib.Exponentiation.Definition.fsti(33,5-33,10)
...
;; def=Prims.fst(413,99-413,120); use=Lib.Exponentiation.Definition.fsti(33,2-34,30)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=Lib.Exponentiation.Definition.fsti(33,5-34,30); use=Lib.Exponentiation.Definition.fsti(33,5-34,30)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_4
(BoxInt 0))
@x1)
...
;; def=Lib.Exponentiation.Definition.fsti(32,23-34,30); use=Lib.Exponentiation.Definition.fsti(34,22-34,29)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Exponentiation.Definition.fsti(34,22-34,29)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Lib.Exponentiation.Definition.fsti(34,22-34,29)
(>= (BoxInt_proj_0 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_4
(BoxInt 1)))
(BoxInt_proj_0 (BoxInt 0)))
)
...
;; def=Lib.Exponentiation.Definition.fsti(33,2-34,30); use=Lib.Exponentiation.Definition.fsti(34,22-34,29)
(Valid 
;; def=Lib.Exponentiation.Definition.fsti(33,2-34,30); use=Lib.Exponentiation.Definition.fsti(34,22-34,29)
(Prims.precedes (Lib.Exponentiation.Definition.comm_monoid x_fe28d8bcde588226b4e538b35321de05_1)
(Lib.Exponentiation.Definition.comm_monoid x_fe28d8bcde588226b4e538b35321de05_1)
x_f10306508c57a5af9977b6a0e3b8781e_2
x_f10306508c57a5af9977b6a0e3b8781e_2)
)
...
(Prims.precedes Prims.nat
Prims.nat
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_4
(BoxInt 1))
x_bb4e1c9af0265270f8e7a5f250f730e2_4)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Exponentiation.Definition.pow, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_4, equation_Prims.nat, int_inversion, int_typing, primitive_Prims.op_Equality, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec pow


; <Start encoding let rec pow>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Lib.Exponentiation.Definition.pow.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Lib.Exponentiation.Definition.pow.fuel_instrumented_token () Term)
(declare-fun Lib.Exponentiation.Definition.pow (Term Term Term Term) Term)
(declare-fun Lib.Exponentiation.Definition.pow@tok () Term)
;;;;;;;;;;;;;;;;k: comm_monoid t -> x: t -> n: Prims.nat -> t
(declare-fun Tm_arrow_7e90e2b016e2f420a1efcd5e3ad7ae33 () Term)



; </end encoding let rec pow>

;;;;;;;;;;;;;;;;typing_Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(13,2-13,5); use=Lib.Exponentiation.Definition.fsti(13,2-13,5)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8 @x0)
(Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5 @x0))
 

:pattern ((Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8 @x0))
:qid typing_Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8))

:named typing_Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8))
;;;;;;;;;;;;;;;;typing_Tm_abs_2adc8a407a94c2d6b32710f342083b63
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(14,2-14,5); use=Lib.Exponentiation.Definition.fsti(14,2-14,5)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_2adc8a407a94c2d6b32710f342083b63 @x0)
(Tm_arrow_91c2ad0c19715a715447e601b3c7259d @x0))
 

:pattern ((Tm_abs_2adc8a407a94c2d6b32710f342083b63 @x0))
:qid typing_Tm_abs_2adc8a407a94c2d6b32710f342083b63))

:named typing_Tm_abs_2adc8a407a94c2d6b32710f342083b63))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Lib.Exponentiation.Definition.one @x0)
(Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5 @x0)))
 

:pattern ((Lib.Exponentiation.Definition.one @x0))
:qid typing_Lib.Exponentiation.Definition.one))
:named typing_Lib.Exponentiation.Definition.one))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Lib.Exponentiation.Definition.mul @x0)
(Tm_arrow_91c2ad0c19715a715447e601b3c7259d @x0)))
 

:pattern ((Lib.Exponentiation.Definition.mul @x0))
:qid typing_Lib.Exponentiation.Definition.mul))
:named typing_Lib.Exponentiation.Definition.mul))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT Lib.Exponentiation.Definition.one@tok
@x0)
(Lib.Exponentiation.Definition.one @x0))
 

:pattern ((ApplyTT Lib.Exponentiation.Definition.one@tok
@x0))
:qid token_correspondence_Lib.Exponentiation.Definition.one))
:named token_correspondence_Lib.Exponentiation.Definition.one))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT Lib.Exponentiation.Definition.mul@tok
@x0)
(Lib.Exponentiation.Definition.mul @x0))
 

:pattern ((ApplyTT Lib.Exponentiation.Definition.mul@tok
@x0))
:qid token_correspondence_Lib.Exponentiation.Definition.mul))
:named token_correspondence_Lib.Exponentiation.Definition.mul))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
(forall ((@x0 Term))
 (! (= (ApplyTT Lib.Exponentiation.Definition.abelian_group@tok
@x0)
(Lib.Exponentiation.Definition.abelian_group @x0))
 

:pattern ((ApplyTT Lib.Exponentiation.Definition.abelian_group@tok
@x0))

:pattern ((Lib.Exponentiation.Definition.abelian_group @x0))
:qid token_correspondence_Lib.Exponentiation.Definition.abelian_group@tok))

:named token_correspondence_Lib.Exponentiation.Definition.abelian_group@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Lib.Exponentiation.Definition.Mkabelian_group @x1
@x2
@x3
@x4)
(Lib.Exponentiation.Definition.abelian_group @x5))
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(Lib.Exponentiation.Definition.Mkabelian_group @x1
...
@x4)
(Lib.Exponentiation.Definition.abelian_group @x5)))
:qid subterm_ordering_Lib.Exponentiation.Definition.Mkabelian_group))

:named subterm_ordering_Lib.Exponentiation.Definition.Mkabelian_group))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(25,24-25,56); use=Lib.Exponentiation.Definition.fsti(25,24-25,56)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_0e5befa12cd89693cc9bd1938882cff9 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_0e5befa12cd89693cc9bd1938882cff9 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_0e5befa12cd89693cc9bd1938882cff9))

:named refinement_kinding_Tm_refine_0e5befa12cd89693cc9bd1938882cff9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(25,24-25,56); use=Lib.Exponentiation.Definition.fsti(25,24-25,56)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_0e5befa12cd89693cc9bd1938882cff9 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Prims.fst(635,71-635,97); use=Lib.Exponentiation.Definition.fsti(25,24-25,56)
(not 
;; def=Prims.fst(441,29-441,97); use=Lib.Exponentiation.Definition.fsti(25,24-25,29)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=Lib.Exponentiation.Definition.fsti(25,30-25,56); use=Lib.Exponentiation.Definition.fsti(25,24-25,29)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Lib.Exponentiation.Definition.mul@tok
@x2)
@x3)
(ApplyTT @x4
@x5))
@x5)
(ApplyTT (ApplyTT Lib.Exponentiation.Definition.one@tok
@x2)
@x3))
)

;; def=Prims.fst(635,86-635,95); use=Lib.Exponentiation.Definition.fsti(25,24-25,56)
(not 
;; def=Prims.fst(635,86-635,95); use=Lib.Exponentiation.Definition.fsti(25,24-25,56)
(= @x6
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_0e5befa12cd89693cc9bd1938882cff9.1))
)
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_0e5befa12cd89693cc9bd1938882cff9))

:named refinement_interpretation_Tm_refine_0e5befa12cd89693cc9bd1938882cff9))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Lib.Exponentiation.Definition.Mkabelian_group_t (Lib.Exponentiation.Definition.Mkabelian_group @x0
@x1
@x2
@x3))
@x0)
...
:pattern ((Lib.Exponentiation.Definition.Mkabelian_group @x0
@x1
@x2
@x3))
:qid projection_inverse_Lib.Exponentiation.Definition.Mkabelian_group_t))

:named projection_inverse_Lib.Exponentiation.Definition.Mkabelian_group_t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Lib.Exponentiation.Definition.Mkabelian_group_lemma_inverse (Lib.Exponentiation.Definition.Mkabelian_group @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_Lib.Exponentiation.Definition.Mkabelian_group_lemma_inverse))

:named projection_inverse_Lib.Exponentiation.Definition.Mkabelian_group_lemma_inverse))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Lib.Exponentiation.Definition.Mkabelian_group_inverse (Lib.Exponentiation.Definition.Mkabelian_group @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Lib.Exponentiation.Definition.Mkabelian_group_inverse))

:named projection_inverse_Lib.Exponentiation.Definition.Mkabelian_group_inverse))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Lib.Exponentiation.Definition.Mkabelian_group_cm (Lib.Exponentiation.Definition.Mkabelian_group @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Lib.Exponentiation.Definition.Mkabelian_group_cm))

:named projection_inverse_Lib.Exponentiation.Definition.Mkabelian_group_cm))
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! (is-Tm_arrow (PreType Lib.Exponentiation.Definition.abelian_group@tok))
:named pre_kinding_Lib.Exponentiation.Definition.abelian_group@tok))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b130726af5abe6e56dd563e668a77bed
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! (HasType Tm_arrow_b130726af5abe6e56dd563e668a77bed
Tm_type)
:named kinding_Tm_arrow_b130726af5abe6e56dd563e668a77bed))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! (HasType Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be
Tm_type)
:named kinding_Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,19-13,5)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5 @x0)
Tm_type))
:qid kinding_Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5))

:named kinding_Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_91c2ad0c19715a715447e601b3c7259d
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,19-14,5)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_91c2ad0c19715a715447e601b3c7259d @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_91c2ad0c19715a715447e601b3c7259d @x0)
Tm_type))
:qid kinding_Tm_arrow_91c2ad0c19715a715447e601b3c7259d))

:named kinding_Tm_arrow_91c2ad0c19715a715447e601b3c7259d))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=dummy(0,0-0,0); use=Lib.Exponentiation.Definition.fsti(12,19-12,20)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_212eedc61dee6384925b2a04a4230ab9
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,21-25,56); use=Lib.Exponentiation.Definition.fsti(25,19-25,56)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_212eedc61dee6384925b2a04a4230ab9 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_212eedc61dee6384925b2a04a4230ab9 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_212eedc61dee6384925b2a04a4230ab9))

:named kinding_Tm_arrow_212eedc61dee6384925b2a04a4230ab9))
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! (and (IsTotFun Lib.Exponentiation.Definition.abelian_group@tok)

;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Lib.Exponentiation.Definition.abelian_group @x0)
Tm_type))
 

:pattern ((Lib.Exponentiation.Definition.abelian_group @x0))
:qid kinding_Lib.Exponentiation.Definition.abelian_group@tok))
)
:named kinding_Lib.Exponentiation.Definition.abelian_group@tok))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(13,2-13,5); use=Lib.Exponentiation.Definition.fsti(13,2-13,5)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8 @x1)
@x0)
(let ((@lb2 @x0))
(Lib.Exponentiation.Definition.Mkcomm_monoid_one @lb2)))
 

:pattern ((ApplyTT (Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8 @x1)
@x0))
:qid interpretation_Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8))

:named interpretation_Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2adc8a407a94c2d6b32710f342083b63
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(14,2-14,5); use=Lib.Exponentiation.Definition.fsti(14,2-14,5)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_2adc8a407a94c2d6b32710f342083b63 @x1)
@x0)
(let ((@lb2 @x0))
(Lib.Exponentiation.Definition.Mkcomm_monoid_mul @lb2)))
 

:pattern ((ApplyTT (Tm_abs_2adc8a407a94c2d6b32710f342083b63 @x1)
@x0))
:qid interpretation_Tm_abs_2adc8a407a94c2d6b32710f342083b63))

:named interpretation_Tm_abs_2adc8a407a94c2d6b32710f342083b63))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0e5befa12cd89693cc9bd1938882cff9
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(25,24-25,56); use=Lib.Exponentiation.Definition.fsti(25,24-25,56)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_0e5befa12cd89693cc9bd1938882cff9 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_0e5befa12cd89693cc9bd1938882cff9 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_0e5befa12cd89693cc9bd1938882cff9))

:named haseqTm_refine_0e5befa12cd89693cc9bd1938882cff9))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Lib.Exponentiation.Definition.one@tok
Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be))
(forall ((@x1 Term))
 (! (= (ApplyTT Lib.Exponentiation.Definition.one@tok
@x1)
(Lib.Exponentiation.Definition.one @x1))
 

:pattern ((Lib.Exponentiation.Definition.one @x1))
:qid function_token_typing_Lib.Exponentiation.Definition.one.1)))
 

:pattern ((ApplyTT @x0
Lib.Exponentiation.Definition.one@tok))
:qid function_token_typing_Lib.Exponentiation.Definition.one))
:named function_token_typing_Lib.Exponentiation.Definition.one))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Lib.Exponentiation.Definition.mul@tok
Tm_arrow_b130726af5abe6e56dd563e668a77bed))
(forall ((@x1 Term))
 (! (= (ApplyTT Lib.Exponentiation.Definition.mul@tok
@x1)
(Lib.Exponentiation.Definition.mul @x1))
 

:pattern ((Lib.Exponentiation.Definition.mul @x1))
:qid function_token_typing_Lib.Exponentiation.Definition.mul.1)))
 

:pattern ((ApplyTT @x0
Lib.Exponentiation.Definition.mul@tok))
:qid function_token_typing_Lib.Exponentiation.Definition.mul))
:named function_token_typing_Lib.Exponentiation.Definition.mul))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Lib.Exponentiation.Definition.abelian_group @x2))
(and (is-Lib.Exponentiation.Definition.Mkabelian_group @x1)
(= @x2
(Lib.Exponentiation.Definition.Mkabelian_group_t @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(Lib.Exponentiation.Definition.abelian_group @x2)))
:qid fuel_guarded_inversion_Lib.Exponentiation.Definition.abelian_group))

:named fuel_guarded_inversion_Lib.Exponentiation.Definition.abelian_group))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! (= 276
(Term_constr_id Lib.Exponentiation.Definition.abelian_group@tok))
:named fresh_token_Lib.Exponentiation.Definition.abelian_group@tok))
;;;;;;;;;;;;;;;;Equation for Lib.Exponentiation.Definition.one
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! (forall ((@x0 Term))
 (! (= (Lib.Exponentiation.Definition.one @x0)
(Tm_abs_4f0ae44e673f7fd9e9cd407751a167a8 @x0))
 

:pattern ((Lib.Exponentiation.Definition.one @x0))
:qid equation_Lib.Exponentiation.Definition.one))
:named equation_Lib.Exponentiation.Definition.one))
;;;;;;;;;;;;;;;;Equation for Lib.Exponentiation.Definition.mul
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! (forall ((@x0 Term))
 (! (= (Lib.Exponentiation.Definition.mul @x0)
(Tm_abs_2adc8a407a94c2d6b32710f342083b63 @x0))
 

:pattern ((Lib.Exponentiation.Definition.mul @x0))
:qid equation_Lib.Exponentiation.Definition.mul))
:named equation_Lib.Exponentiation.Definition.mul))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
...
(HasTypeFuel @u0
@x4
(Tm_arrow_212eedc61dee6384925b2a04a4230ab9 @x3
@x2
@x1)))
(HasTypeFuel @u0
(Lib.Exponentiation.Definition.Mkabelian_group @x1
...
@x3
@x4)
(Lib.Exponentiation.Definition.abelian_group @x1)))
...
@x4)
(Lib.Exponentiation.Definition.abelian_group @x1)))
:qid data_typing_intro_Lib.Exponentiation.Definition.Mkabelian_group@tok))

:named data_typing_intro_Lib.Exponentiation.Definition.Mkabelian_group@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
...
(HasTypeFuel @u0
@x2
(Lib.Exponentiation.Definition.comm_monoid @x5))
(HasTypeFuel @u0
@x3
(Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 @x5))
(HasTypeFuel @u0
@x4
(Tm_arrow_212eedc61dee6384925b2a04a4230ab9 @x3
@x2
...
@x4)
(Lib.Exponentiation.Definition.abelian_group @x5)))
:qid data_elim_Lib.Exponentiation.Definition.Mkabelian_group))

:named data_elim_Lib.Exponentiation.Definition.Mkabelian_group))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
(forall ((@x0 Term))
 (! (= 275
(Term_constr_id (Lib.Exponentiation.Definition.abelian_group @x0)))
 

:pattern ((Lib.Exponentiation.Definition.abelian_group @x0))
:qid constructor_distinct_Lib.Exponentiation.Definition.abelian_group))

:named constructor_distinct_Lib.Exponentiation.Definition.abelian_group))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,6-22,19); use=Lib.Exponentiation.Definition.fsti(22,6-22,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 287
(Term_constr_id (Lib.Exponentiation.Definition.Mkabelian_group @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_Lib.Exponentiation.Definition.Mkabelian_group))

:named constructor_distinct_Lib.Exponentiation.Definition.Mkabelian_group))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.LoopCombinators.repeat; Namespace Lib.LoopCombinators
(assert (! 
;; def=Lib.LoopCombinators.fsti(196,5-196,6); use=Lib.LoopCombinators.fsti(198,8-198,14)
...
@x0
(Lib.Exponentiation.Definition.abelian_group @x2)))
:qid Lib.Exponentiation.Definition_pretyping_922ad0ad0aa232ccff5e51569c090db6))

:named Lib.Exponentiation.Definition_pretyping_922ad0ad0aa232ccff5e51569c090db6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,25); use=Lib.Exponentiation.Definition.fsti(12,19-14,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_b130726af5abe6e56dd563e668a77bed)
...
@x1
Tm_arrow_b130726af5abe6e56dd563e668a77bed))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_b130726af5abe6e56dd563e668a77bed))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_b130726af5abe6e56dd563e668a77bed))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,25); use=Lib.Exponentiation.Definition.fsti(12,19-13,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be)
...
@x1
Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,19-13,5)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5 @x2)))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,19-14,5)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_91c2ad0c19715a715447e601b3c7259d @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_91c2ad0c19715a715447e601b3c7259d @x2)))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_91c2ad0c19715a715447e601b3c7259d))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_91c2ad0c19715a715447e601b3c7259d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=dummy(0,0-0,0); use=Lib.Exponentiation.Definition.fsti(12,19-12,20)
...
@x1
(Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62 @x2)))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,21-25,56); use=Lib.Exponentiation.Definition.fsti(25,19-25,56)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_212eedc61dee6384925b2a04a4230ab9 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid Lib.Exponentiation.Definition_pre_typing_Tm_arrow_212eedc61dee6384925b2a04a4230ab9))

:named Lib.Exponentiation.Definition_pre_typing_Tm_arrow_212eedc61dee6384925b2a04a4230ab9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b130726af5abe6e56dd563e668a77bed
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,25); use=Lib.Exponentiation.Definition.fsti(12,19-14,5)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_91c2ad0c19715a715447e601b3c7259d @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_b130726af5abe6e56dd563e668a77bed.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_b130726af5abe6e56dd563e668a77bed))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_b130726af5abe6e56dd563e668a77bed))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_b130726af5abe6e56dd563e668a77bed))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,25); use=Lib.Exponentiation.Definition.fsti(12,19-13,5)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_b0a794cd533d7d17c9e6cd42da0d26be))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5
;;; Fact-ids: Name Lib.Exponentiation.Definition.one; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,19-13,5)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5 @x1)))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_a3402e16be3e7e4824f1bb01d96d14e5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_91c2ad0c19715a715447e601b3c7259d
;;; Fact-ids: Name Lib.Exponentiation.Definition.mul; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(12,6-12,17); use=Lib.Exponentiation.Definition.fsti(12,19-14,5)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_91c2ad0c19715a715447e601b3c7259d.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_91c2ad0c19715a715447e601b3c7259d @x1)))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_91c2ad0c19715a715447e601b3c7259d))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_91c2ad0c19715a715447e601b3c7259d))
...
:pattern ((ApplyTT @x0
@x2))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62 @x1)))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_212eedc61dee6384925b2a04a4230ab9
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(22,21-25,56); use=Lib.Exponentiation.Definition.fsti(25,19-25,56)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_212eedc61dee6384925b2a04a4230ab9 @x1
@x2
@x3))
(and 
;; def=Lib.Exponentiation.Definition.fsti(22,21-25,56); use=Lib.Exponentiation.Definition.fsti(25,19-25,56)
...
(HasType (ApplyTT @x0
@x4)
(Tm_refine_0e5befa12cd89693cc9bd1938882cff9 @x3
@x2
@x1
@x4)))
...
:pattern ((ApplyTT @x0
@x4))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_212eedc61dee6384925b2a04a4230ab9.1))
...
@x2
@x3)))
:qid Lib.Exponentiation.Definition_interpretation_Tm_arrow_212eedc61dee6384925b2a04a4230ab9))

:named Lib.Exponentiation.Definition_interpretation_Tm_arrow_212eedc61dee6384925b2a04a4230ab9))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! (Valid (ApplyTT __uu__PartialApp
Lib.Exponentiation.Definition.one@tok))
:named @kick_partial_app_a8b18f0b0111ffd2bc4275c9651f36f5))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Lib.Exponentiation.Definition.abelian_group; Namespace Lib.Exponentiation.Definition; Name Lib.Exponentiation.Definition.Mkabelian_group; Namespace Lib.Exponentiation.Definition
(assert (! (Valid (ApplyTT __uu__PartialApp
Lib.Exponentiation.Definition.mul@tok))
:named @kick_partial_app_5ffcaee0290df3f5c3bb28dfbee90ad9))
(push) ;; push{2

; Starting query at Lib.Exponentiation.Definition.fsti(37,2-37,63)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (t: Type) (k: Lib.Exponentiation.Definition.abelian_group t) (x: t) (n: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post t).
;     (forall (x: t). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     (n >= 0 == true ==> n >= 0) /\
;     (~(n >= 0 = true) ==> (forall (b: Prims.bool). n >= 0 == b ==> - n >= 0))


; Context: While encoding a query
; While typechecking the top-level declaration `let pow_neg`
...
;; def=Prims.fst(402,27-402,88); use=Lib.Exponentiation.Definition.fsti(37,2-37,63)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Lib.Exponentiation.Definition.fsti(37,2-37,63)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Lib.Exponentiation.Definition.fsti(37,2-37,63)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(389,2-389,39); use=Lib.Exponentiation.Definition.fsti(37,2-37,63)
(and (implies 
;; def=Lib.Exponentiation.Definition.fsti(37,5-37,11); use=Lib.Exponentiation.Definition.fsti(37,5-37,11)
(= (Prims.op_GreaterThanOrEqual @x3
(BoxInt 0))
(BoxBool true))


;; def=Prims.fst(680,18-680,24); use=Lib.Exponentiation.Definition.fsti(37,28-37,29)
(or label_1
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Lib.Exponentiation.Definition.fsti(37,2-37,63)
(not 
;; def=Lib.Exponentiation.Definition.fsti(37,5-37,11); use=Lib.Exponentiation.Definition.fsti(37,5-37,11)
(= (Prims.op_GreaterThanOrEqual @x3
(BoxInt 0))
...
;; def=Prims.fst(413,99-413,120); use=Lib.Exponentiation.Definition.fsti(37,2-37,63)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=Lib.Exponentiation.Definition.fsti(37,5-37,63); use=Lib.Exponentiation.Definition.fsti(37,5-37,63)
(= (Prims.op_GreaterThanOrEqual @x3
(BoxInt 0))
@x5)
)

;; def=Prims.fst(680,18-680,24); use=Lib.Exponentiation.Definition.fsti(37,57-37,62)
(or label_2

;; def=Prims.fst(680,18-680,24); use=Lib.Exponentiation.Definition.fsti(37,57-37,62)
(>= (BoxInt_proj_0 (Prims.op_Minus @x3))
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Exponentiation.Definition.pow_neg, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, int_inversion, primitive_Prims.op_GreaterThanOrEqual, primitive_Prims.op_Minus, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0
...
; encoding sigelt let pow_neg


; <Start encoding let pow_neg>

(declare-fun Lib.Exponentiation.Definition.pow_neg (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;k: abelian_group t -> x: t -> n: Prims.int -> t
(declare-fun Tm_arrow_fa1c551f3a3491a2b9787ce4ec9079e2 () Term)
(declare-fun Lib.Exponentiation.Definition.pow_neg@tok () Term)


; </end encoding let pow_neg>


; encoding sigelt val Lib.Exponentiation.Definition.lemma_inverse_one


; <Start encoding val Lib.Exponentiation.Definition.lemma_inverse_one>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_inverse_one (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_inverse_one@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.lemma_inverse_one>


; encoding sigelt val Lib.Exponentiation.Definition.lemma_inverse_id


; <Start encoding val Lib.Exponentiation.Definition.lemma_inverse_id>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_inverse_id (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_inverse_id@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.lemma_inverse_id>


; encoding sigelt val Lib.Exponentiation.Definition.lemma_inverse_mul


; <Start encoding val Lib.Exponentiation.Definition.lemma_inverse_mul>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_inverse_mul (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_inverse_mul@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.lemma_inverse_mul>


; encoding sigelt val Lib.Exponentiation.Definition.lemma_pow0


; <Start encoding val Lib.Exponentiation.Definition.lemma_pow0>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow0 (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow0@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.lemma_pow0>


; encoding sigelt val Lib.Exponentiation.Definition.lemma_pow1


; <Start encoding val Lib.Exponentiation.Definition.lemma_pow1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow1 (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow1@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.lemma_pow1>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lib.Exponentiation.Definition.pow; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(32,8-32,11); use=Lib.Exponentiation.Definition.fsti(32,8-32,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
...
(HasType @x4
Prims.nat))
(HasType (Lib.Exponentiation.Definition.pow.fuel_instrumented @u0
@x1
@x2
@x3
@x4)
...
:pattern ((Lib.Exponentiation.Definition.pow.fuel_instrumented @u0
@x1
@x2
@x3
@x4))
:qid token_correspondence_Lib.Exponentiation.Definition.pow.fuel_instrumented))

:named token_correspondence_Lib.Exponentiation.Definition.pow.fuel_instrumented))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! (HasType Prims.pos
Tm_type)
:named function_token_typing_Prims.pos))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Lib.Exponentiation.Definition.pow
;;; Fact-ids: Name Lib.Exponentiation.Definition.pow; Namespace Lib.Exponentiation.Definition
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(32,8-32,11); use=Lib.Exponentiation.Definition.fsti(32,8-32,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
(HasType @x4
Prims.nat))
(= (Lib.Exponentiation.Definition.pow.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4)
...
@x2)
@x3)
(Lib.Exponentiation.Definition.pow.fuel_instrumented @u0
@x1
@x2
@x3
...
:pattern ((Lib.Exponentiation.Definition.pow.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4))
:qid equation_with_fuel_Lib.Exponentiation.Definition.pow.fuel_instrumented))

:named equation_with_fuel_Lib.Exponentiation.Definition.pow.fuel_instrumented))
...
@x3
@x4)
(Lib.Exponentiation.Definition.pow.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid @fuel_irrelevance_Lib.Exponentiation.Definition.pow.fuel_instrumented))

:named @fuel_irrelevance_Lib.Exponentiation.Definition.pow.fuel_instrumented))
...
@x2
@x3)
(Lib.Exponentiation.Definition.pow.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_correspondence_Lib.Exponentiation.Definition.pow.fuel_instrumented))

:named @fuel_correspondence_Lib.Exponentiation.Definition.pow.fuel_instrumented))
(push) ;; push{2

; Starting query at Lib.Exponentiation.Definition.fsti(58,0-59,46)
...
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(59,2-59,46); use=Lib.Exponentiation.Definition.fsti(59,2-59,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;       return_val == n - 1 ==>
;       (forall (any_result: t).
;           Lib.Exponentiation.Definition.pow k x (n - 1) == any_result ==>
;           (forall (any_result: t).
;               Lib.Exponentiation.Definition.mul x (Lib.Exponentiation.Definition.pow k x (n - 1)) ==
;               any_result ==>
;               n > 0 ==> n >= 0)))


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Exponentiation.Definition.lemma_pow_unfold`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Exponentiation.Definition.fsti(58,0-59,46)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Exponentiation.Definition.fsti(59,8-59,46)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Exponentiation.Definition.fsti(59,24-59,31)
(or label_1
...
;; def=Prims.fst(356,2-356,58); use=Lib.Exponentiation.Definition.fsti(59,8-59,46)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Lib.Exponentiation.Definition.fsti(59,8-59,46)
(= @x5
(Prims.op_Subtraction @x3
(BoxInt 1)))
)

;; def=Prims.fst(451,66-451,102); use=Lib.Exponentiation.Definition.fsti(59,8-59,46)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
@x0)

;; def=dummy(0,0-0,0); use=Lib.Exponentiation.Definition.fsti(59,8-59,46)
(= (Lib.Exponentiation.Definition.pow @x0
@x1
@x2
(Prims.op_Subtraction @x3
...
;; def=Prims.fst(175,35-175,36); use=Lib.Exponentiation.Definition.fsti(59,8-59,46)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Lib.Exponentiation.Definition.mul@tok
@x0)
@x1)
@x2)
...
;; def=Prims.fst(683,18-683,23); use=Lib.Exponentiation.Definition.fsti(59,44-59,45)
(> (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (BoxInt 0)))
)

;; def=Prims.fst(680,18-680,24); use=Lib.Exponentiation.Definition.fsti(59,44-59,45)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Exponentiation.Definition.lemma_pow_unfold, 1)
; STATUS: unsat
...
; encoding sigelt val Lib.Exponentiation.Definition.lemma_pow_unfold


; <Start encoding val Lib.Exponentiation.Definition.lemma_pow_unfold>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow_unfold (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow_unfold@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.lemma_pow_unfold>


; encoding sigelt val Lib.Exponentiation.Definition.lemma_pow_one


; <Start encoding val Lib.Exponentiation.Definition.lemma_pow_one>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow_one (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow_one@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.lemma_pow_one>
...
; Starting query at Lib.Exponentiation.Definition.fsti(64,0-65,56)
...
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(65,2-65,56); use=Lib.Exponentiation.Definition.fsti(65,2-65,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Exponentiation.Definition.lemma_pow_add`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Exponentiation.Definition.fsti(64,0-65,56)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=Prims.fst(680,18-680,24); use=Lib.Exponentiation.Definition.fsti(65,48-65,55)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Exponentiation.Definition.lemma_pow_add, 1)
; STATUS: unsat
...
; encoding sigelt val Lib.Exponentiation.Definition.lemma_pow_add


; <Start encoding val Lib.Exponentiation.Definition.lemma_pow_add>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow_add (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow_add@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.lemma_pow_add>
...
; Starting query at Lib.Exponentiation.Definition.fsti(67,0-68,48)
...
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(68,2-68,48); use=Lib.Exponentiation.Definition.fsti(68,2-68,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Exponentiation.Definition.lemma_pow_mul`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Exponentiation.Definition.fsti(67,0-68,48)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=Prims.fst(680,18-680,24); use=Lib.Exponentiation.Definition.fsti(68,40-68,47)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Exponentiation.Definition.lemma_pow_mul, 1)
; STATUS: unsat
...
; encoding sigelt val Lib.Exponentiation.Definition.lemma_pow_mul


; <Start encoding val Lib.Exponentiation.Definition.lemma_pow_mul>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow_mul (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow_mul@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.lemma_pow_mul>


; encoding sigelt val Lib.Exponentiation.Definition.lemma_pow_mul_base


; <Start encoding val Lib.Exponentiation.Definition.lemma_pow_mul_base>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow_mul_base (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Lib.Exponentiation.Definition.lemma_pow_mul_base@tok () Term)

; </end encoding val Lib.Exponentiation.Definition.lemma_pow_mul_base>

(push) ;; push{2

; Starting query at Lib.Exponentiation.Definition.fsti(73,0-74,46)
...
;;; Fact-ids: 
(assert (! 
;; def=Lib.Exponentiation.Definition.fsti(74,2-74,46); use=Lib.Exponentiation.Definition.fsti(74,2-74,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Exponentiation.Definition.lemma_pow_double`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Exponentiation.Definition.fsti(73,0-74,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=Prims.fst(680,18-680,24); use=Lib.Exponentiation.Definition.fsti(74,38-74,45)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Exponentiation.Definition.lemma_pow_double, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
