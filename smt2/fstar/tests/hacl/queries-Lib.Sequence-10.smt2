...
; Starting query at Lib.Sequence.fsti(139,2-139,31)
...
;; def=Lib.Sequence.fsti(127,16-127,32); use=Lib.Sequence.fsti(139,18-139,31)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(139,18-139,31)
(or label_1
...
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(139,18-139,31)
(or label_2
