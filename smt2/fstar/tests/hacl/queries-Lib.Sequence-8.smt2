...
; Starting query at Lib.Sequence.fsti(101,0-108,76)
...
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(41,7-41,38); use=Lib.Sequence.fsti(108,27-108,73)
...
;; def=Lib.Sequence.fsti(41,11-41,38); use=Lib.Sequence.fsti(108,51-108,69)
(or 
;; def=Lib.Sequence.fsti(41,11-41,38); use=Lib.Sequence.fsti(108,64-108,69)
(= @x1
(FStar.Seq.Base.index @x2
(Lib.Sequence.to_seq @x2
@x3
...
;; def=Lib.Sequence.fsti(41,11-41,38); use=Lib.Sequence.fsti(108,51-108,56)
(= @x1
(FStar.Seq.Base.index @x2
(Lib.Sequence.to_seq @x2
@x3
...
;   (n: (n: Prims.nat{n <= Prims.pow2 32 - 1}){n < len})
;   (x: a).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (o: Lib.Sequence.lseq a len).
;     (n <= Prims.pow2 32 - 1 /\ n < len ==> n < FStar.Seq.Base.length (Lib.Sequence.to_seq s)) /\
;     (Lib.Sequence.to_seq o == FStar.Seq.Base.upd (Lib.Sequence.to_seq s) n x /\
;       Lib.Sequence.index o n == x ==>
;       (forall (i: n: Prims.nat{n <= Prims.pow2 32 - 1}).
;           (i < len ==> Prims.hasEq Prims.nat) /\
;           (i < len /\ i <> n ==>
;             (forall (r: a).
;                 (i <= Prims.pow2 32 - 1 ==> i < FStar.Seq.Base.length (Lib.Sequence.to_seq s)) /\
;                 (~(r == FStar.Seq.Base.index (Lib.Sequence.to_seq s) i) ==>
;                   i <= Prims.pow2 32 - 1 ==> i < FStar.Seq.Base.length (Lib.Sequence.to_seq o))) /\
;             (forall (any_result: Type0).
;                 r:
;                 a
;                   { r == FStar.Seq.Base.index (Lib.Sequence.to_seq s) i \/
;                     r == FStar.Seq.Base.index (Lib.Sequence.to_seq o) i } ==
;                 any_result ==>
;                 i < len /\
;                 (forall (any_result: n: Prims.nat{n <= Prims.pow2 32 - 1}).
;                     i == any_result ==>
;                     (forall (any_result: r: a{r == FStar.Seq.Base.index (Lib.Sequence.to_seq o) i}).
;                         Lib.Sequence.index o i == any_result ==>
;                         (Lib.Sequence.index o i == FStar.Seq.Base.index (Lib.Sequence.to_seq o) i ==>
;                           Lib.Sequence.index o i == FStar.Seq.Base.index (Lib.Sequence.to_seq s) i \/
;                           Lib.Sequence.index o i == FStar.Seq.Base.index (Lib.Sequence.to_seq o) i) /\
;                         (forall (return_val:
;                             r:
;                             a
;                               { r == FStar.Seq.Base.index (Lib.Sequence.to_seq s) i \/
;                                 r == FStar.Seq.Base.index (Lib.Sequence.to_seq o) i }).
;                             return_val == Lib.Sequence.index o i ==>
;                             Lib.Sequence.index o i == return_val ==>
;                             i < len /\
;                             (forall (any_result: n: Prims.nat{n <= Prims.pow2 32 - 1}).
;                                 i == any_result ==>
;                                 (forall (any_result:
;                                     r: a{r == FStar.Seq.Base.index (Lib.Sequence.to_seq s) i}).
;                                     Lib.Sequence.index s i == any_result ==>
;                                     Lib.Sequence.index s i ==
;                                     FStar.Seq.Base.index (Lib.Sequence.to_seq s) i ==>
;                                     Lib.Sequence.index s i ==
;                                     FStar.Seq.Base.index (Lib.Sequence.to_seq s) i \/
;                                     Lib.Sequence.index s i ==
;                                     FStar.Seq.Base.index (Lib.Sequence.to_seq o) i)))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.upd`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(101,0-108,76)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(102,7-108,76)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Lib.Sequence.lseq @x0
@x1))

;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(107,20-108,74)
(and (implies 
;; def=Lib.Sequence.fsti(105,16-105,23); use=Lib.Sequence.fsti(107,51-107,52)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(107,51-107,52)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
...
;; def=FStar.Seq.Base.fsti(56,37-56,49); use=Lib.Sequence.fsti(107,51-107,52)
(or label_1
...
(implies 
;; def=Lib.Sequence.fsti(107,20-107,72); use=Lib.Sequence.fsti(107,20-107,72)
(and 
;; def=Lib.Sequence.fsti(107,20-107,54); use=Lib.Sequence.fsti(107,20-107,54)
(= (Lib.Sequence.to_seq @x0
@x1
@x5)
(FStar.Seq.Base.upd @x0
...
;; def=Lib.Sequence.fsti(107,58-107,72); use=Lib.Sequence.fsti(107,58-107,72)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(108,27-108,73)
(and (implies 
;; def=Lib.Sequence.fsti(108,28-108,35); use=Lib.Sequence.fsti(108,28-108,35)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x1))


;; def=Lib.IntTypes.fsti(308,18-308,21); use=Lib.Sequence.fsti(108,44-108,45)
(or label_2
...
(implies 
;; def=Lib.Sequence.fsti(108,27-108,46); use=Lib.Sequence.fsti(108,27-108,46)
(and 
;; def=Lib.Sequence.fsti(108,28-108,35); use=Lib.Sequence.fsti(108,28-108,35)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x1))
...
;; def=Lib.Sequence.fsti(108,39-108,45); use=Lib.Sequence.fsti(108,39-108,45)
(not (= @x6
@x3))
)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(108,27-108,73)
(and 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(108,27-108,73)
(forall ((@x7 Term))
 (! (implies (HasType @x7
@x0)

;; def=Lib.Sequence.fsti(41,11-107,86); use=Lib.Sequence.fsti(108,27-108,73)
(and (implies 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(108,51-108,69)
(<= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))


;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Lib.Sequence.fsti(108,72-108,73)
(or label_3

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Lib.Sequence.fsti(108,51-108,69)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (FStar.Seq.Base.length @x0
(Lib.Sequence.to_seq @x0
@x1
...
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(108,59-108,60)
(<= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Lib.Sequence.fsti(108,59-108,60)
(or label_4
...
;; def=Prims.fst(451,66-451,102); use=Lib.Sequence.fsti(108,27-108,73)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Tm_type)

;; def=Prims.fst(175,25-175,26); use=Lib.Sequence.fsti(108,27-108,73)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(108,27-108,73)
(and 
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(108,59-108,60)
(or label_5
...
;; def=Lib.Sequence.fsti(40,5-107,86); use=Lib.Sequence.fsti(108,27-108,73)
(= @x6
@x8)
)
...
;; def=Lib.Sequence.fsti(41,7-108,60); use=Lib.Sequence.fsti(108,27-108,73)
(= (Lib.Sequence.index @x0
@x1
@x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(108,27-108,73)
(and (implies 
;; def=Lib.Sequence.fsti(41,11-41,38); use=Lib.Sequence.fsti(108,51-108,60)
(= (Lib.Sequence.index @x0
@x1
@x5
@x6)
...
;; def=Prims.fst(356,2-356,58); use=Lib.Sequence.fsti(108,27-108,73)
(forall ((@x10 Term))
...
;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(108,27-108,73)
(= @x10
(Lib.Sequence.index @x0
@x1
@x5
...
;; def=Prims.fst(175,35-175,36); use=Lib.Sequence.fsti(108,27-108,73)
(= (Lib.Sequence.index @x0
@x1
@x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(108,27-108,73)
(and 
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(108,72-108,73)
(or label_7
...
;; def=Lib.Sequence.fsti(41,7-108,73); use=Lib.Sequence.fsti(108,27-108,73)
(= (Lib.Sequence.index @x0
@x1
@x2
@x6)
...
;; def=Lib.Sequence.fsti(41,11-41,38); use=Lib.Sequence.fsti(108,64-108,73)
(= (Lib.Sequence.index @x0
@x1
@x2
@x6)
