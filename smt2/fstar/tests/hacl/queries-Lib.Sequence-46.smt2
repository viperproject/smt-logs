...
;;; Fact-ids: 
(assert (! 
;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(427,16-427,18)
(forall ((@x0 Term))
...
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(427,16-427,18)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))
...
;   (_: i / bs < n) (_: _: Prims.unit{bs > 0 /\ bs <= Prims.pow2 32 - 1}).
...
;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(427,16-427,18)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 7)
; STATUS: unsat
