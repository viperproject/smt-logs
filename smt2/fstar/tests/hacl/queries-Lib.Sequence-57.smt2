...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lib.Sequence.map_blocks_multi; Namespace Lib.Sequence
(assert (! 
;; def=Lib.Sequence.fsti(394,4-394,20); use=Lib.Sequence.fsti(394,4-394,20)
...
@x0
@x2)))
(HasType (Lib.Sequence.map_blocks_multi @x0
@x1
@x2
@x3
@x4
...
:pattern ((Lib.Sequence.map_blocks_multi @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_Lib.Sequence.map_blocks_multi))

:named typing_Lib.Sequence.map_blocks_multi))
;;;;;;;;;;;;;;;;free var typing
...
(declare-fun Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(401,6-429,47); use=Lib.Sequence.fsti(429,14-429,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (HasType (Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc @x0
@x1
@x2
@x3
@x4
...
@x6)
Tm_type))
:qid refinement_kinding_Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc))

:named refinement_kinding_Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(401,6-429,47); use=Lib.Sequence.fsti(429,14-429,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc @x2
@x3
@x4
@x5
@x6
...
;; def=Lib.Sequence.fsti(401,6-429,47); use=Lib.Sequence.fsti(429,14-429,47)
(= (Lib.Sequence.map_blocks_multi @x2
@x3
@x4
@x5
@x6
...
@x7
@x8)))
:qid refinement_interpretation_Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc))

:named refinement_interpretation_Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc))
;;;;;;;;;;;;;;;;haseq for Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(401,6-429,47); use=Lib.Sequence.fsti(429,14-429,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc @x0
@x1
@x2
@x3
@x4
@x5
@x6))))
:qid haseqTm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc))

:named haseqTm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc))
(declare-fun Tm_refine_1f58f020580b1f7dafbbc9a17b71061e (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(425,11-429,84)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (HasType (Tm_refine_1f58f020580b1f7dafbbc9a17b71061e @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_1f58f020580b1f7dafbbc9a17b71061e @x0
@x1
@x2
@x3
@x4
...
@x6)
Tm_type))
:qid refinement_kinding_Tm_refine_1f58f020580b1f7dafbbc9a17b71061e))

:named refinement_kinding_Tm_refine_1f58f020580b1f7dafbbc9a17b71061e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(425,11-429,84)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1f58f020580b1f7dafbbc9a17b71061e @x2
@x3
@x4
@x5
@x6
...
;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(425,11-429,84)
(= @x2
(Lib.Sequence.map_blocks_multi @x3
@x4
@x5
@x6
@x7
...
@x7
@x8)))
:qid refinement_interpretation_Tm_refine_1f58f020580b1f7dafbbc9a17b71061e))

:named refinement_interpretation_Tm_refine_1f58f020580b1f7dafbbc9a17b71061e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1f58f020580b1f7dafbbc9a17b71061e
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(425,11-429,84)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1f58f020580b1f7dafbbc9a17b71061e @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_1f58f020580b1f7dafbbc9a17b71061e @x0
@x1
@x2
@x3
@x4
@x5
@x6))))
:qid haseqTm_refine_1f58f020580b1f7dafbbc9a17b71061e))

:named haseqTm_refine_1f58f020580b1f7dafbbc9a17b71061e))
...
;   (any_result: Prims.pos) (_: _: Prims.unit{max == any_result}) (any_result: n: Prims.pos{n <= max})
;   (_: _: Prims.unit{n == any_result})
;   (any_result: out: Lib.Sequence.seq a {Lib.Sequence.length out == n * bs})
;   (_: _: Prims.unit{Lib.Sequence.map_blocks_multi bs max n inp f == any_result})
;   (return_val: out: Lib.Sequence.seq a {Lib.Sequence.length out == n * bs})
;   (_: _: Prims.unit{return_val == Lib.Sequence.map_blocks_multi bs max n inp f})
;   (_: _: Prims.unit{Lib.Sequence.map_blocks_multi bs max n inp f == return_val}) (_: i < n * bs).
;   (*  - Subtyping check failed
;   - Expected type
;       i: Prims.nat{i < FStar.Seq.Base.length (map_blocks_multi bs max n inp f)}
;     got type i: Prims.nat{i < n * bs}
; *)
;   i < FStar.Seq.Base.length (Lib.Sequence.map_blocks_multi bs max n inp f)
...
@x1))
(HasType @x28
(Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc @x0
@x1
@x2
@x3
@x4
...
@x1))
(HasType @x30
(Tm_refine_1f58f020580b1f7dafbbc9a17b71061e @x29
@x0
@x1
@x2
@x3
...
@x29))
(HasType @x32
(Prims.b2t (Prims.op_LessThan @x6
(Prims.op_Multiply @x3
@x1)))))

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Lib.Sequence.fsti(429,48-429,49)
(or label_1

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Lib.Sequence.fsti(429,48-429,49)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (FStar.Seq.Base.length @x0
(Lib.Sequence.map_blocks_multi @x0
@x1
@x2
@x3
@x4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 18)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Lib.Sequence.length, refinement_interpretation_Tm_refine_bd302e137bb0aa6d9a57d25e75e1b7dc, refinement_interpretation_Tm_refine_e37a8a81b6e72b6dae52414929365d29, refinement_interpretation_Tm_refine_f4f040c0afc8e02646bd007fb369c803
