...
; Starting query at Lib.Sequence.fsti(361,0-363,26)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_aae6d783b3462c53b6a15525d347a445 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(362,12-362,50); use=Lib.Sequence.fsti(361,57-361,62)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_aae6d783b3462c53b6a15525d347a445 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_aae6d783b3462c53b6a15525d347a445 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_aae6d783b3462c53b6a15525d347a445))

:named refinement_kinding_Tm_refine_aae6d783b3462c53b6a15525d347a445))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(362,12-362,50); use=Lib.Sequence.fsti(361,57-361,62)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_aae6d783b3462c53b6a15525d347a445 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Lib.Sequence.fsti(362,12-362,22); use=Lib.Sequence.fsti(361,57-361,62)
(<= (BoxInt_proj_0 (Prims.op_Multiply @x2
@x3))
(BoxInt_proj_0 @x4))


;; def=Lib.Sequence.fsti(362,26-362,31); use=Lib.Sequence.fsti(361,57-361,62)
(< (BoxInt_proj_0 @x4)
(BoxInt_proj_0 @x5))


;; def=Lib.Sequence.fsti(362,35-362,50); use=Lib.Sequence.fsti(361,57-361,62)
(< (BoxInt_proj_0 @x5)
(BoxInt_proj_0 (Prims.op_Multiply (Prims.op_Addition @x2
(BoxInt 1))
@x3)))
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_aae6d783b3462c53b6a15525d347a445))

:named refinement_interpretation_Tm_refine_aae6d783b3462c53b6a15525d347a445))
;;;;;;;;;;;;;;;;haseq for Tm_refine_aae6d783b3462c53b6a15525d347a445
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(362,12-362,50); use=Lib.Sequence.fsti(361,57-361,62)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_aae6d783b3462c53b6a15525d347a445 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_aae6d783b3462c53b6a15525d347a445 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_aae6d783b3462c53b6a15525d347a445))

:named haseqTm_refine_aae6d783b3462c53b6a15525d347a445))

; Encoding query formula : forall (b: Prims.pos)
;   (n: Prims.int)
;   (i: Prims.int)
;   (j: Prims.int)
;   (_: Prims.squash (n * b <= i /\ i < j /\ j < (n + 1) * b)).
;   (*  - Could not prove post-condition
; *)
;   (b > 0 ==> b <> 0) /\
;   (forall (any_result: Prims.pos).
;       b == any_result ==> (forall (any_result: Prims.int). i % b == any_result ==> b > 0 ==> b <> 0)
;   )


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.mod_interval_lt`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(361,0-363,26)
...
Prims.int)
(HasType @x4
(Tm_refine_aae6d783b3462c53b6a15525d347a445 @x1
@x0
@x2
@x3)))

;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(363,12-363,25)
(and (implies 
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(363,16-363,17)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(363,16-363,17)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=Lib.Sequence.fsti(363,12-363,25)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.pos)

;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(363,12-363,25)
(= @x0
@x5)
)
...
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(363,24-363,25)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(363,24-363,25)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.mod_interval_lt, 1)
; STATUS: unsat
