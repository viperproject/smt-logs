...
; Starting query at Lib.Sequence.fsti(226,0-230,65)
...
;                 Lib.Sequence.index s2 i == return_val ==> i <= Prims.pow2 32 - 1 /\ i < len)))


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.map`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(226,0-230,65)
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(226,11-230,65)
...
;; def=Lib.Sequence.fsti(230,28-230,35); use=Lib.Sequence.fsti(230,28-230,35)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x2))
)

;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(230,28-230,62)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(230,49-230,50)
(or label_1
...
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(230,49-230,50)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Lib.Sequence.fsti(230,28-230,62)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)

;; def=Lib.Sequence.fsti(40,5-229,31); use=Lib.Sequence.fsti(230,28-230,62)
(= @x6
@x7)
)
...
;; def=Lib.Sequence.fsti(41,6-230,50); use=Lib.Sequence.fsti(230,40-230,50)
(= (Lib.Sequence.index @x1
@x2
@x5
@x6)
...
;; def=Prims.fst(356,2-356,58); use=Lib.Sequence.fsti(230,28-230,62)
(forall ((@x9 Term))
...
;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(230,28-230,62)
(= @x9
(Lib.Sequence.index @x1
@x2
@x5
...
;; def=Prims.fst(175,35-175,36); use=Lib.Sequence.fsti(230,28-230,62)
(= (Lib.Sequence.index @x1
@x2
@x5
@x6)
...
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(230,60-230,61)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(230,60-230,61)
(or label_3
