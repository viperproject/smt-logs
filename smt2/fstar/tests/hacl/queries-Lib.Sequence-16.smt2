...
; Starting query at Lib.Sequence.fsti(201,0-209,41)
...
; *)
;   fin - start >= 0 /\ fin - start <= Prims.pow2 32 - 1
...
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(209,2-209,41)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(207,16-207,29)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(209,2-209,41)
...
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(207,16-207,29)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.update_slice, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, int_inversion, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_c8dd98bb91cb1ba6963e5299b3babaa4, refinement_interpretation_Tm_refine_e5df7b46d8b4d6787f7fc44dbc0015e5
