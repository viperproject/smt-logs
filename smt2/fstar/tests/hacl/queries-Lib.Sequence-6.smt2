...
; Starting query at Lib.Sequence.fsti(76,0-81,34)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;haseq for Tm_refine_56609cb097df748006aafa90a98ed73d
;;; Fact-ids: Name Lib.Sequence.of_list; Namespace Lib.Sequence
(assert (! 
;; def=Lib.Sequence.fsti(73,5-73,46); use=Lib.Sequence.fsti(73,5-73,46)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_56609cb097df748006aafa90a98ed73d @x0)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_56609cb097df748006aafa90a98ed73d @x0))))
:qid haseqTm_refine_56609cb097df748006aafa90a98ed73d))

:named haseqTm_refine_56609cb097df748006aafa90a98ed73d))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Lib.Sequence.of_list; Namespace Lib.Sequence
(assert (! 
;; def=Lib.Sequence.fsti(73,5-73,46); use=Lib.Sequence.fsti(73,5-73,46)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_56609cb097df748006aafa90a98ed73d @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_56609cb097df748006aafa90a98ed73d @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_56609cb097df748006aafa90a98ed73d))

:named refinement_kinding_Tm_refine_56609cb097df748006aafa90a98ed73d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Lib.Sequence.of_list; Namespace Lib.Sequence
(assert (! 
;; def=Lib.Sequence.fsti(73,5-73,46); use=Lib.Sequence.fsti(73,5-73,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_56609cb097df748006aafa90a98ed73d @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))

;; def=Lib.Sequence.fsti(73,14-73,45); use=Lib.Sequence.fsti(73,14-73,45)
...
@x1
(Tm_refine_56609cb097df748006aafa90a98ed73d @x2)))
:qid refinement_interpretation_Tm_refine_56609cb097df748006aafa90a98ed73d))

:named refinement_interpretation_Tm_refine_56609cb097df748006aafa90a98ed73d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0
...
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0 @x0
@x1)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0 @x0
@x1))))
:qid haseqTm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0))

:named haseqTm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.List.Tot.Base.index; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(90,29-90,50); use=FStar.List.Tot.Base.fst(90,29-90,50)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0))

:named refinement_kinding_Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.List.Tot.Base.index; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(90,29-90,50); use=FStar.List.Tot.Base.fst(90,29-90,50)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(80,2-81,34); use=Lib.Sequence.fsti(80,2-80,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;   (l: Prims.list a {FStar.List.Tot.Base.length l <= Prims.pow2 32 - 1})
;   (i: Prims.nat{i < FStar.List.Tot.Base.length l})
;   (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   FStar.List.Tot.Base.length l <= Prims.pow2 32 - 1 /\
;   (forall (return_val: n: Prims.nat{n <= Prims.pow2 32 - 1}).
;       return_val == FStar.List.Tot.Base.length l ==>
;       i < FStar.List.Tot.Base.length l ==>
;       i <= Prims.pow2 32 - 1 /\ i < FStar.List.Tot.Base.length l)


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.of_list_index`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(76,0-81,34)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Tm_refine_56609cb097df748006aafa90a98ed73d @x0))
(HasType @x2
(Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0 @x0
@x1))
(HasType @x3
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9))

;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(80,8-80,51)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(80,16-80,23)
(or label_1
...
;; def=Prims.fst(356,2-356,58); use=Lib.Sequence.fsti(80,8-80,51)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_refine_c8dd98bb91cb1ba6963e5299b3babaa4)

;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(80,8-80,51)
(= @x4
(FStar.List.Tot.Base.length @x0
@x1))


;; def=Lib.Sequence.fsti(79,11-79,32); use=Lib.Sequence.fsti(80,27-80,28)
(< (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (FStar.List.Tot.Base.length @x0
@x1)))
)

;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(80,27-80,28)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(80,27-80,28)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.of_list_index, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_56609cb097df748006aafa90a98ed73d, refinement_interpretation_Tm_refine_c86aba5c6243e6b7f9a4b0ad41b4e9a0
