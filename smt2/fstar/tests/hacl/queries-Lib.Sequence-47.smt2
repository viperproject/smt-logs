...
;;; Fact-ids: 
(assert (! 
;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(428,22-428,24)
(forall ((@x0 Term))
...
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(428,22-428,24)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))
...
;   (_: _: Prims.unit{i / bs == any_result}) (_: _: Prims.unit{bs > 0 /\ bs <= Prims.pow2 32 - 1}).
...
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(428,22-428,24)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 8)
; STATUS: unsat
