...
; Starting query at Lib.Sequence.fsti(258,0-266,7)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(260,6-263,61); use=Lib.Sequence.fsti(263,8-263,71)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_arrow_c23d18c724c9dc3d8cafa5367905403d @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_arrow_c23d18c724c9dc3d8cafa5367905403d @x0
@x1
@x2
@x3)
Tm_type))
:qid kinding_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d))

:named kinding_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(260,6-263,61); use=Lib.Sequence.fsti(263,8-263,71)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_c23d18c724c9dc3d8cafa5367905403d @x2
@x3
@x4
@x5))
(is-Tm_arrow (PreType @x1)))
...
@x4
@x5)))
:qid Lib.Sequence_pre_typing_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d))

:named Lib.Sequence_pre_typing_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(260,6-263,61); use=Lib.Sequence.fsti(263,8-263,71)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_c23d18c724c9dc3d8cafa5367905403d @x1
@x2
@x3
@x4))
(and 
...
@x6)
@x7))
:qid Lib.Sequence_interpretation_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d.1))
...
:pattern ((ApplyTT @x0
@x5))
:qid Lib.Sequence_interpretation_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d.2))
...
@x5)
@x6))
:qid Lib.Sequence_interpretation_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d.3))
))
...
@x3
@x4)))
:qid Lib.Sequence_interpretation_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d))

:named Lib.Sequence_interpretation_Tm_arrow_c23d18c724c9dc3d8cafa5367905403d))
...
;   (forall (i: Prims.nat{i < Lib.Sequence.length inp / blocksize}).
;       (*  - Subtyping check failed
...
;   - Expected type Type0 got type Type0
; *)
;           forall (len: n: Prims.nat{n <= Prims.pow2 32 - 1}).
;             (*  - Subtyping check failed
;   - Expected type Prims.nonzero got type Lib.IntTypes.size_pos
; *)
;             blocksize > 0 /\ blocksize <= Prims.pow2 32 - 1 ==> blocksize <> 0))
...
; While typechecking the top-level declaration `val Lib.Sequence.repeati_blocks`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(258,0-266,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(258,0-266,7)
(and 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(263,8-263,71)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(263,31-263,40)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(263,31-263,40)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(263,31-263,40)
(or label_1
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(259,7-266,7)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Tm_refine_7af7abfd9fa791df66706ab563886df2 @x0
@x3
@x2))

;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(263,52-263,61)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(263,52-263,61)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(263,52-263,61)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(263,52-263,61)
(or label_2
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(259,7-266,7)
(and 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(264,8-264,115)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(264,32-264,41)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(264,32-264,41)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(264,32-264,41)
(or label_4
...
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(264,79-264,88)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(264,79-264,88)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(264,79-264,88)
(or label_5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.repeati_blocks, 1)
; STATUS: unsat
