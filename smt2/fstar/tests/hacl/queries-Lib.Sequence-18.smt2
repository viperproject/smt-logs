...
; Starting query at Lib.Sequence.fsti(219,0-223,67)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(219,10-220,22); use=Lib.Sequence.fsti(220,8-220,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d))

:named kinding_Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(219,10-220,22); use=Lib.Sequence.fsti(220,8-220,36)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid Lib.Sequence_pre_typing_Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d))

:named Lib.Sequence_pre_typing_Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(219,10-220,22); use=Lib.Sequence.fsti(220,8-220,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d @x1
@x2
@x3))
(and 
;; def=Lib.Sequence.fsti(219,10-220,22); use=Lib.Sequence.fsti(220,8-220,36)
...
@x4)
@x5))
:qid Lib.Sequence_interpretation_Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid Lib.Sequence_interpretation_Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d.2))
))
...
@x2
@x3)))
:qid Lib.Sequence_interpretation_Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d))

:named Lib.Sequence_interpretation_Tm_arrow_b57b4ee3d9891bb96d82ae5fb8c7337d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Lib.Sequence.index; Namespace Lib.Sequence
(assert (! 
...
; *)
;   forall (s2: Lib.Sequence.lseq b len) (i: Prims.nat).
;     i < len ==>
;     i <= Prims.pow2 32 - 1 /\ i < len /\
;     (forall (any_result: Prims.nat).
;         i == any_result ==>
;         (forall (any_result: r: b{r == FStar.Seq.Base.index (Lib.Sequence.to_seq s2) i}).
;             Lib.Sequence.index s2 i == any_result ==>
;             (forall (return_val: r: b{r == FStar.Seq.Base.index (Lib.Sequence.to_seq s2) i}).
;                 return_val == Lib.Sequence.index s2 i ==>
;                 Lib.Sequence.index s2 i == return_val ==>
;                 i < len /\
;                 (forall (any_result: Prims.nat).
;                     i == any_result ==> i <= Prims.pow2 32 - 1 /\ i < len))))


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.mapi`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(219,0-223,67)
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(219,12-223,67)
...
;; def=Lib.Sequence.fsti(223,28-223,35); use=Lib.Sequence.fsti(223,28-223,35)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x2))
)

;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(223,28-223,64)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(223,49-223,50)
(or label_1
...
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(223,49-223,50)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Lib.Sequence.fsti(223,28-223,64)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)

;; def=Lib.Sequence.fsti(40,5-222,31); use=Lib.Sequence.fsti(223,28-223,64)
(= @x6
@x7)
)
...
;; def=Lib.Sequence.fsti(41,6-223,50); use=Lib.Sequence.fsti(223,40-223,50)
(= (Lib.Sequence.index @x1
@x2
@x5
@x6)
...
;; def=Prims.fst(356,2-356,58); use=Lib.Sequence.fsti(223,28-223,64)
(forall ((@x9 Term))
...
;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(223,28-223,64)
(= @x9
(Lib.Sequence.index @x1
@x2
@x5
...
;; def=Prims.fst(175,35-175,36); use=Lib.Sequence.fsti(223,28-223,64)
(= (Lib.Sequence.index @x1
@x2
@x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(223,28-223,64)
(and 
;; def=Lib.Sequence.fsti(220,14-220,21); use=Lib.Sequence.fsti(223,56-223,57)
(or label_3
...
;; def=Lib.Sequence.fsti(220,8-222,31); use=Lib.Sequence.fsti(223,28-223,64)
(= @x6
@x10)
)

;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(223,62-223,63)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(223,62-223,63)
(or label_4
