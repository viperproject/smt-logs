...
;;;;;;;;;;;;;;;;query
;;; Fact-ids: 
(assert (! (not (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term) (@x12 Term) (@x13 Term) (@x14 Term) (@x15 Term) (@x16 Term) (@x17 Term) (@x18 Term) (@x19 Term) (@x20 Term) (@x21 Term) (@x22 Term) (@x23 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_refine_609674d96c81c962549b0076055bf213)
...
@x20))
(HasType @x23
(Prims.b2t (Prims.op_GreaterThan @x2
(BoxInt 0)))))

;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(429,35-429,38)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 15)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.pos, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5
