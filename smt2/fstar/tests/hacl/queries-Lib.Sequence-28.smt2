...
; Starting query at Lib.Sequence.fsti(320,0-331,70)
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Lib.Sequence.repeat_blocks_multi; Namespace Lib.Sequence
(assert (! 
...
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(327,2-331,70); use=Lib.Sequence.fsti(327,2-327,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
; Encoding query formula : (forall (a: Type0) (b: Type0) (bs: n: Prims.pos{n <= Prims.pow2 32 - 1}).
;     (forall (inp: Lib.Sequence.seq a).
;         (*  - Subtyping check failed
;   - Expected type Prims.nonzero got type Lib.IntTypes.size_pos
; *)
;         bs > 0 /\ bs <= Prims.pow2 32 - 1 ==> bs <> 0) /\
;     (forall (inp: Lib.Sequence.seq a {Lib.Sequence.length inp % bs = 0}).
;         (*  - Subtyping check failed
...
;     (inp: Lib.Sequence.seq a {Lib.Sequence.length inp % bs = 0})
...
;             (forall (any_result: Prims.int).
;                 Lib.Sequence.length inp / bs == any_result ==>
;                 (bs > 0 /\ bs <= Prims.pow2 32 - 1 ==> bs >= 0 /\ bs <= Prims.pow2 32 - 1 /\ bs > 0) /\
;                 (forall (any_result: n: Prims.pos{n <= Prims.pow2 32 - 1}).
;                     bs == any_result ==> Lib.Sequence.length inp / bs >= 0)))))


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.lemma_repeat_blocks_multi`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(320,0-331,70)
(and 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(320,0-331,70)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(320,0-331,70)
(and 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(321,7-331,70)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Lib.Sequence.seq @x0))

;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(324,28-324,30)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(324,28-324,30)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(324,28-324,30)
(or label_1
...
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(325,15-325,17)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(325,15-325,17)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(325,15-325,17)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(325,15-325,17)
(or label_2
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(327,8-331,70)
(and (implies 
;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(329,19-329,21)
(and 
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(329,19-329,21)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))
...
;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(329,19-329,21)
(or label_4
...
;; def=Prims.fst(451,66-451,102); use=Lib.Sequence.fsti(327,8-331,70)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Tm_refine_609674d96c81c962549b0076055bf213)

;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(327,8-331,70)
(= @x2
@x7)
)
...
;; def=Lib.Sequence.fsti(329,8-329,21); use=Lib.Sequence.fsti(329,8-329,21)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(327,8-331,70)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(331,32-331,34)
(or label_5
...
;; def=Lib.LoopCombinators.fsti(160,5-160,6); use=Lib.Sequence.fsti(327,8-331,70)
(= (Prims.op_Division (Lib.Sequence.length @x0
@x3)
@x2)
@x9)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(327,8-331,70)
(and (implies 
;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(331,52-331,54)
(and 
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(331,52-331,54)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))
...
;; def=Lib.Sequence.fsti(271,15-271,21); use=Lib.Sequence.fsti(331,52-331,54)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(331,52-331,54)
(or label_6
...
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(331,52-331,54)
(or label_7
...
;; def=Lib.Sequence.fsti(271,3-323,7); use=Lib.Sequence.fsti(327,8-331,70)
(= @x2
@x10)
)

;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(331,61-331,63)
(or label_9
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.lemma_repeat_blocks_multi, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Lib.Sequence.length, equation_Prims.nat, equation_Prims.pos, int_inversion, primitive_Prims.op_Division, primitive_Prims.op_Modulus, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_609674d96c81c962549b0076055bf213, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5, refinement_interpretation_Tm_refine_b14928a18ba707004108386997fed9d6, typing_Lib.Sequence.length
