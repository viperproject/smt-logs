...
; Starting query at Lib.Sequence.fsti(365,0-367,22)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (b: Prims.pos) (a: Prims.int) (n: Prims.int) (_: Prims.squash (a < n * b)).
;   (*  - Could not prove post-condition
; *) b > 0 ==> b <> 0


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.div_mul_lt`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(365,0-367,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.pos)
(HasType @x1
...
Prims.int)
(HasType @x3
(Prims.squash (Prims.b2t (Prims.op_LessThan @x1
(Prims.op_Multiply @x2
@x0)))))

;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(367,16-367,17)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=Lib.Sequence.fsti(367,16-367,17)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.div_mul_lt, 1)
; STATUS: unsat
