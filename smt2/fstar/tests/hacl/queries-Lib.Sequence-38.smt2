...
; Starting query at Lib.Sequence.fsti(394,0-401,47)
...
;       blocksize >= 0 /\ blocksize <= Prims.pow2 32 - 1) /\
;   (forall (i: Prims.nat{i < max}) (_: Lib.Sequence.lseq a blocksize).
;       (*  - Subtyping check failed
;   - Expected type Lib.IntTypes.size_nat got type Lib.IntTypes.size_pos
; *)
;       blocksize > 0 /\ blocksize <= Prims.pow2 32 - 1 ==>
...
; While typechecking the top-level declaration `val Lib.Sequence.map_blocks_multi`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(394,0-401,47)
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(395,7-401,47)
(and 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(395,7-401,47)
(forall ((@x5 Term))
...
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(400,33-400,42)
(> (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(400,33-400,42)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(400,33-400,42)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(400,33-400,42)
(or label_1
...
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(400,53-400,62)
(> (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(400,53-400,62)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(400,53-400,62)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(400,53-400,62)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.map_blocks_multi, 1)
; STATUS: unsat
