...
;;; Fact-ids: 
(assert (! 
;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(423,33-423,35)
(forall ((@x0 Term))
...
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(423,33-423,35)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))
...
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(423,33-423,35)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 3)
; STATUS: unsat
