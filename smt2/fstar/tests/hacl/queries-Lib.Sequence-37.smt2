...
; Starting query at Lib.Sequence.fsti(380,0-391,28)
...
;; def=Lib.Sequence.fsti(386,9-386,16); use=Lib.Sequence.fsti(389,2-391,28)
(< (BoxInt_proj_0 @x5)
(BoxInt_proj_0 @x2))
)

;; def=Lib.Sequence.fsti(378,57-378,65); use=Lib.Sequence.fsti(387,29-387,30)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.map_blocks_f, 2)
; STATUS: unsat
