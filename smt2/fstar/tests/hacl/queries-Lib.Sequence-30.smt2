...
; Starting query at Lib.Sequence.fsti(346,0-352,41)
...
; While typechecking the top-level declaration `val Lib.Sequence.generate_blocks_simple`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(346,0-352,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(347,6-352,41)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Tm_refine_c1424615841f28cac7fc34e92b7ff33c @x2))

;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(351,32-351,41)
(> (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(351,32-351,41)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (Prims.op_Subtraction (Prims.pow2 (BoxInt 32))
(BoxInt 1))))
)

;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(351,32-351,41)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(351,32-351,41)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.generate_blocks_simple, 1)
; STATUS: unsat
