...
;; def=Lib.Sequence.fsti(423,14-423,21); use=Lib.Sequence.fsti(429,66-429,67)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 20)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, b2t_def, primitive_Prims.op_LessThan, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_07295705544891065e7a01d318c0ba51
