...
; Starting query at Lib.Sequence.fsti(278,2-280,13)
...
(declare-fun Tm_refine_1c325641987cce6783228428bd15a869 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(64,43-64,73); use=Lib.Sequence.fsti(279,18-279,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_1c325641987cce6783228428bd15a869 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_1c325641987cce6783228428bd15a869 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_1c325641987cce6783228428bd15a869))

:named refinement_kinding_Tm_refine_1c325641987cce6783228428bd15a869))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(64,43-64,73); use=Lib.Sequence.fsti(279,18-279,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1c325641987cce6783228428bd15a869 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
@x1
Prims.nat)
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (Prims.op_Multiply @x2
@x3)
@x1))
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x1
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_1c325641987cce6783228428bd15a869))

:named refinement_interpretation_Tm_refine_1c325641987cce6783228428bd15a869))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1c325641987cce6783228428bd15a869
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(64,43-64,73); use=Lib.Sequence.fsti(279,18-279,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1c325641987cce6783228428bd15a869 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.nat)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_1c325641987cce6783228428bd15a869 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_1c325641987cce6783228428bd15a869))

:named haseqTm_refine_1c325641987cce6783228428bd15a869))
...
;           return_val == i * bs ==>
;           i * bs + bs >= 0 /\ i * bs <= i * bs + bs && i * bs + bs <= FStar.Seq.Base.length inp /\
;           (forall (return_val: j: Prims.nat{i * bs <= j && j <= FStar.Seq.Base.length inp}).
;               return_val == i * bs + bs ==>
;               (forall (any_result: FStar.Seq.Base.seq a).
;                   FStar.Seq.Base.slice inp (i * bs) (i * bs + bs) == any_result ==>
;                   FStar.Seq.Base.length (FStar.Seq.Base.slice inp (i * bs) (i * bs + bs)) == bs))))


; Context: While encoding a query
; While typechecking the top-level declaration `let repeat_blocks_f`
...
;; def=Prims.fst(441,29-441,97); use=Lib.Sequence.fsti(278,2-278,8)
(and 
;; def=Lib.Sequence.fsti(278,9-278,32); use=Lib.Sequence.fsti(278,2-278,8)
(or label_1

;; def=Lib.Sequence.fsti(278,9-278,32); use=Lib.Sequence.fsti(278,2-278,8)
(<= (BoxInt_proj_0 (Prims.op_Multiply (Prims.op_Addition @x6
(BoxInt 1))
@x2))
(BoxInt_proj_0 (Prims.op_Multiply @x5
@x2)))
)


;; def=Prims.fst(441,36-441,97); use=Lib.Sequence.fsti(278,2-278,8)
(forall ((@x8 Term))
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(278,2-280,13)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(279,28-279,36)
(or label_2

;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(279,28-279,36)
(>= (BoxInt_proj_0 (Prims.op_Multiply @x6
@x2))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=Prims.fst(356,2-356,58); use=Lib.Sequence.fsti(278,2-280,13)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(278,2-280,13)
(= @x9
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(278,2-280,13)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(279,37-279,50)
(or label_3

;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(279,37-279,50)
(>= (BoxInt_proj_0 (Prims.op_Addition (Prims.op_Multiply @x6
@x2)
@x2))
(BoxInt_proj_0 (BoxInt 0)))
)
...
;; def=Lib.Sequence.fsti(279,37-279,50); use=Lib.Sequence.fsti(279,37-279,50)
(or label_4
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (Prims.op_Multiply @x6
@x2)
...
;; def=Lib.Sequence.fsti(279,37-279,50); use=Lib.Sequence.fsti(279,37-279,50)
(or label_5
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (Prims.op_Addition (Prims.op_Multiply @x6
@x2)
@x2)
(FStar.Seq.Base.length @x0
@x3))))
...
(Tm_refine_1c325641987cce6783228428bd15a869 @x6
@x2
@x0
@x3))
...
;; def=Prims.fst(451,66-451,102); use=Lib.Sequence.fsti(278,2-280,13)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
(FStar.Seq.Base.seq @x0))

;; def=Lib.Sequence.fsti(279,6-279,50); use=Lib.Sequence.fsti(279,6-279,50)
(= (FStar.Seq.Base.slice @x0
@x3
(Prims.op_Multiply @x6
@x2)
...
;; def=Lib.Sequence.fsti(27,44-27,63); use=Lib.Sequence.fsti(280,4-280,9)
(or label_6
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.repeat_blocks_f, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Lib.Sequence.length, equation_Lib.Sequence.seq, equation_Prims.nat, int_inversion, lemma_FStar.Seq.Base.lemma_len_slice, primitive_Prims.op_Addition, primitive_Prims.op_Division, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Multiply, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_1c325641987cce6783228428bd15a869, refinement_interpretation_Tm_refine_1f6c16a51cd4ba3256b95ca590c832c5, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_81407705a0828c2c1b1976675443f647, refinement_interpretation_Tm_refine_aee8f5bc805e40f3cc22e281aedfc983, refinement_interpretation_Tm_refine_c1424615841f28cac7fc34e92b7ff33c
