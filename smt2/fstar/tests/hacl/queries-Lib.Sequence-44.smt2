...
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(423,46-423,48)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 5)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_609674d96c81c962549b0076055bf213
