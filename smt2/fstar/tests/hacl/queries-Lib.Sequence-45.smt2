...
;; def=Lib.Sequence.fsti(366,12-366,21); use=Lib.Sequence.fsti(426,4-426,14)
(or label_1

;; def=Lib.Sequence.fsti(366,12-366,21); use=Lib.Sequence.fsti(426,4-426,14)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (Prims.op_Multiply @x3
@x1)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 6)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_e37a8a81b6e72b6dae52414929365d29
