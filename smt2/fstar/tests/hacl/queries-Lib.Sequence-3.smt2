...
; Starting query at Lib.Sequence.fsti(53,0-59,80)
...
;   (forall (s2: Lib.Sequence.lseq a (len0 + len1)).
;       (*  - Subtyping check failed
...
; While typechecking the top-level declaration `val Lib.Sequence.concat`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(53,0-59,80)
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(54,7-59,80)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(59,17-59,30)
(or label_1
...
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(59,17-59,30)
(or label_2
...
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(59,38-59,40)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(59,38-59,40)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.concat, 1)
; STATUS: unsat
