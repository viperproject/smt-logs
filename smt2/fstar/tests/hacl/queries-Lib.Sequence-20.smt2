...
; Starting query at Lib.Sequence.fsti(233,0-238,74)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(233,11-234,22); use=Lib.Sequence.fsti(234,8-234,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1 @x0
@x1
@x2
@x3)
Tm_type))
:qid kinding_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1))

:named kinding_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(233,11-234,22); use=Lib.Sequence.fsti(234,8-234,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1 @x2
@x3
@x4
@x5))
(is-Tm_arrow (PreType @x1)))
...
@x4
@x5)))
:qid Lib.Sequence_pre_typing_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1))

:named Lib.Sequence_pre_typing_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1
;;; Fact-ids: 
(assert (! 
;; def=Lib.Sequence.fsti(233,11-234,22); use=Lib.Sequence.fsti(234,8-234,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1 @x1
@x2
@x3
@x4))
(and 
...
@x6)
@x7))
:qid Lib.Sequence_interpretation_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1.1))
...
:pattern ((ApplyTT @x0
@x5))
:qid Lib.Sequence_interpretation_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1.2))
...
@x5)
@x6))
:qid Lib.Sequence_interpretation_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1.3))
))
...
@x3
@x4)))
:qid Lib.Sequence_interpretation_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1))

:named Lib.Sequence_interpretation_Tm_arrow_0527e852c1e27810fd7c6e30e6ff41d1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Lib.Sequence.index; Namespace Lib.Sequence
(assert (! 
...
; While typechecking the top-level declaration `val Lib.Sequence.map2i`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(233,0-238,74)
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(233,13-238,74)
...
;; def=Lib.Sequence.fsti(238,28-238,35); use=Lib.Sequence.fsti(238,28-238,35)
(< (BoxInt_proj_0 @x8)
(BoxInt_proj_0 @x3))
)

;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(238,28-238,71)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(238,49-238,50)
(or label_1
...
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(238,49-238,50)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Lib.Sequence.fsti(238,28-238,71)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.nat)

;; def=Lib.Sequence.fsti(40,5-237,31); use=Lib.Sequence.fsti(238,28-238,71)
(= @x8
@x9)
)
...
;; def=Lib.Sequence.fsti(41,6-238,50); use=Lib.Sequence.fsti(238,40-238,50)
...
;; def=Prims.fst(356,2-356,58); use=Lib.Sequence.fsti(238,28-238,71)
(forall ((@x11 Term))
...
;; def=Prims.fst(356,26-356,41); use=Lib.Sequence.fsti(238,28-238,71)
(= @x11
(Lib.Sequence.index @x2
@x3
@x7
...
;; def=Prims.fst(175,35-175,36); use=Lib.Sequence.fsti(238,28-238,71)
(= (Lib.Sequence.index @x2
@x3
@x7
@x8)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(238,28-238,71)
(and 
;; def=Lib.Sequence.fsti(234,14-234,21); use=Lib.Sequence.fsti(238,56-238,57)
(or label_3
...
;; def=Lib.Sequence.fsti(234,8-237,31); use=Lib.Sequence.fsti(238,28-238,71)
(= @x8
@x12)
)
...
;; def=Prims.fst(459,77-459,89); use=Lib.Sequence.fsti(238,28-238,71)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(238,62-238,63)
(or label_4
...
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(238,62-238,63)
(or label_5
...
;; def=Lib.Sequence.fsti(41,6-238,64); use=Lib.Sequence.fsti(238,58-238,64)
(= (Lib.Sequence.index @x0
@x3
@x5
@x8)
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(238,28-238,71)
(= (Lib.Sequence.index @x0
@x3
@x5
@x8)
...
;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(238,69-238,70)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(238,69-238,70)
(or label_6
