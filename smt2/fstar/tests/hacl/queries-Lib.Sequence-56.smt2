...
;; def=Lib.Sequence.fsti(398,11-398,19); use=Lib.Sequence.fsti(429,39-429,40)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.index_map_blocks_multi, 17)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_07295705544891065e7a01d318c0ba51
