...
; Starting query at Lib.Sequence.fsti(44,0-49,59)
...
; Encoding query formula : forall (a: Type0) (len: n: Prims.nat{n <= Prims.pow2 32 - 1}) (init: a).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (s: Lib.Sequence.lseq a len).
;     Lib.Sequence.to_seq s == FStar.Seq.Base.create len init ==>
;     (forall (i: Prims.nat). i < len ==> i <= Prims.pow2 32 - 1 /\ i < len)


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.create`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(44,0-49,59)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(45,7-49,59)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Lib.Sequence.lseq @x0
@x1))

;; def=Lib.Sequence.fsti(48,20-48,51); use=Lib.Sequence.fsti(48,20-48,51)
(= (Lib.Sequence.to_seq @x0
@x1
@x3)
(FStar.Seq.Base.create @x0
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(48,20-49,57)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Lib.Sequence.fsti(49,27-49,34); use=Lib.Sequence.fsti(49,27-49,34)
(< (BoxInt_proj_0 @x4)
(BoxInt_proj_0 @x1))
)

;; def=Lib.Sequence.fsti(40,16-40,23); use=Lib.Sequence.fsti(49,47-49,48)
(and 
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(49,47-49,48)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.create, 1)
; STATUS: unsat
