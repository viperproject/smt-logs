...
; Starting query at Lib.Sequence.fsti(282,0-291,7)
...
;     blocksize >= 0 /\ blocksize <= Prims.pow2 32 - 1) /\
;   (forall (f: (_: Lib.Sequence.lseq a blocksize -> _: b -> b)).
;       (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;       forall (len: Prims.nat{len < blocksize}).
;         (*  - Subtyping check failed
;   - Expected type Lib.IntTypes.size_nat got type len: Prims.nat{len < blocksize}
; *)
;         len < blocksize ==> len <= Prims.pow2 32 - 1)


; Context: While encoding a query
; While typechecking the top-level declaration `val Lib.Sequence.repeat_blocks`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(282,0-291,7)
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(282,0-291,7)
(and (implies 
;; def=Lib.IntTypes.fsti(311,22-311,37); use=Lib.Sequence.fsti(288,15-288,24)
(and 
;; def=Prims.fst(683,18-683,23); use=Lib.Sequence.fsti(288,15-288,24)
(> (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (BoxInt 0)))
...
;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(288,15-288,24)
(and 
;; def=Prims.fst(680,18-680,24); use=Lib.Sequence.fsti(288,15-288,24)
(or label_1
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(283,7-291,7)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_c1424615841f28cac7fc34e92b7ff33c @x3))

;; def=Lib.Sequence.fsti(289,16-289,31); use=Lib.Sequence.fsti(289,45-289,48)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x3))
)

;; def=Lib.IntTypes.fsti(308,22-308,37); use=Lib.Sequence.fsti(289,45-289,48)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.repeat_blocks, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.pos, refinement_interpretation_Tm_refine_609674d96c81c962549b0076055bf213, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5
