...
; Starting query at Lib.Sequence.fsti(65,0-68,72)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type0) (s: Lib.Sequence.seq a).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (l: Prims.list a).
;     (*  - Subtyping check failed
...
; While typechecking the top-level declaration `val Lib.Sequence.to_list`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(65,0-68,72)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=dummy(0,0-0,0); use=Lib.Sequence.fsti(66,7-68,72)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Prims.list @x0))

;; def=Prims.fst(73,23-73,30); use=Lib.Sequence.fsti(68,25-68,31)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lib.Sequence.to_list, 1)
; STATUS: unsat
