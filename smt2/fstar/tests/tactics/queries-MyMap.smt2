...
; Starting query at MyMap.fst(31,4-31,6)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.eqtype) (v: Type) (m: MyMap.map k v) (key: k) (value: v).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         MyMap.sel (MyMap.upd m key value) key == value ==> p pure_result) ==>
...
;; def=Prims.fst(441,36-441,97); use=MyMap.fst(31,4-31,6)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=MyMap.fst(29,13-29,49); use=MyMap.fst(31,4-31,6)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MyMap.fst(31,4-31,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MyMap.fst(31,4-31,6)
(ApplyTT @x5
@x6)
...
; Starting query at MyMap.fst(37,4-37,6)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.eqtype) (v: Type) (m: MyMap.map k v) (key1: k) (key2: k) (value: v).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         (~(key1 == key2) ==> MyMap.sel (MyMap.upd m key1 value) key2 == MyMap.sel m key2) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)
...
;; def=Prims.fst(441,36-441,97); use=MyMap.fst(37,4-37,6)
(forall ((@x7 Term))
 (! (implies (and (or label_1
(HasType @x7
Prims.unit))
(implies 
;; def=MyMap.fst(35,14-35,29); use=MyMap.fst(37,4-37,6)
(not 
;; def=MyMap.fst(35,15-35,29); use=MyMap.fst(37,4-37,6)
(= @x3
@x4)
)


;; def=MyMap.fst(35,34-35,75); use=MyMap.fst(37,4-37,6)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MyMap.fst(37,4-37,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MyMap.fst(37,4-37,6)
(ApplyTT @x6
@x7)
