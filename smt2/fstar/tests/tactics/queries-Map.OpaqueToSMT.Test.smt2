...
; Externals for module Map.OpaqueToSMT
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Map.OpaqueToSMT.sel_upd2 (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Map.OpaqueToSMT.sel_upd2@tok () Term)
...
; End Externals for module Map.OpaqueToSMT

(push) ;; push{1

; Internals for Map.OpaqueToSMT.Test


; encoding sigelt let imap


; <Start encoding let imap>

(declare-fun Map.OpaqueToSMT.Test.imap () Term)

; </end encoding let imap>
...
(declare-fun Map.OpaqueToSMT.Test.upd (Term Term Term) Term)
;;;;;;;;;;;;;;;;n: imap -> k: Prims.int -> v: Prims.string -> MyMap.map Prims.int Prims.string
(declare-fun Tm_arrow_9ececf5f91a308193508154aab0a85ca () Term)
(declare-fun Map.OpaqueToSMT.Test.upd@tok () Term)
...
(declare-fun Map.OpaqueToSMT.Test.sel (Term Term) Term)
;;;;;;;;;;;;;;;;n: imap -> k: Prims.int -> Prims.string
(declare-fun Tm_arrow_6b4e169bf589d6235b680121f63562f7 () Term)
(declare-fun Map.OpaqueToSMT.Test.sel@tok () Term)


; </end encoding let sel>


; encoding sigelt #reset-options "--initial_fuel 0 --max_fuel 0 --initial_ifuel 0 --max_ifuel 0"


; <Skipped #reset-options "--initial_fuel 0 --max_fuel 0 --initial_ifuel 0 --max_ifuel 0"/>
...
(declare-fun Map.OpaqueToSMT.Test.test1 (Term) Term)
;;;;;;;;;;;;;;;;m: imap -> Prims.unit
(declare-fun Tm_arrow_c7880c0068e4fff99b19459c2cc50849 () Term)
(declare-fun Map.OpaqueToSMT.Test.test1@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Map.OpaqueToSMT.Test.sel; Namespace Map.OpaqueToSMT.Test
(assert (! 
;; def=Map.OpaqueToSMT.Test.fst(20,4-20,7); use=Map.OpaqueToSMT.Test.fst(20,4-20,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Map.OpaqueToSMT.Test.imap)
(HasType @x1
Prims.int))
(HasType (Map.OpaqueToSMT.Test.sel @x0
@x1)
Prims.string))
 

:pattern ((Map.OpaqueToSMT.Test.sel @x0
@x1))
:qid typing_Map.OpaqueToSMT.Test.sel))

:named typing_Map.OpaqueToSMT.Test.sel))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Map.OpaqueToSMT.Test.imap; Namespace Map.OpaqueToSMT.Test
(assert (! (HasType Map.OpaqueToSMT.Test.imap
Tm_type)
:named typing_Map.OpaqueToSMT.Test.imap))
...
(assert (! (HasType Map.OpaqueToSMT.Test.imap
Tm_type)
:named function_token_typing_Map.OpaqueToSMT.Test.imap))
...
;;;;;;;;;;;;;;;;Equation for Map.OpaqueToSMT.Test.sel
;;; Fact-ids: Name Map.OpaqueToSMT.Test.sel; Namespace Map.OpaqueToSMT.Test
(assert (! 
;; def=Map.OpaqueToSMT.Test.fst(20,4-20,7); use=Map.OpaqueToSMT.Test.fst(20,4-20,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Map.OpaqueToSMT.Test.sel @x0
@x1)
...
:pattern ((Map.OpaqueToSMT.Test.sel @x0
@x1))
:qid equation_Map.OpaqueToSMT.Test.sel))

:named equation_Map.OpaqueToSMT.Test.sel))
;;;;;;;;;;;;;;;;Equation for Map.OpaqueToSMT.Test.imap
;;; Fact-ids: Name Map.OpaqueToSMT.Test.imap; Namespace Map.OpaqueToSMT.Test
(assert (! (= Map.OpaqueToSMT.Test.imap
(Map.OpaqueToSMT.map Prims.int
Prims.string))
:named equation_Map.OpaqueToSMT.Test.imap))
...
; Starting query at Map.OpaqueToSMT.Test.fst(30,2-33,34)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (m: Map.OpaqueToSMT.Test.imap).
;   (*  - Could not prove post-condition
; *)
;   forall (pure_result: Prims.unit).
;     Map.OpaqueToSMT.Test.sel m 2 == "world" ==>
;     (forall (pure_result: Prims.unit). Map.OpaqueToSMT.Test.sel m 2 == m 2 ==> m 2 == "world")
...
;; def=Prims.fst(441,36-441,97); use=Map.OpaqueToSMT.Test.fst(30,2-30,8)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.unit)

;; def=Map.OpaqueToSMT.Test.fst(30,9-30,29); use=Map.OpaqueToSMT.Test.fst(30,2-30,8)
(= (Map.OpaqueToSMT.Test.sel @x0
(BoxInt 2))
(BoxString (FString_const 0)))
)

;; def=Prims.fst(441,36-441,97); use=Map.OpaqueToSMT.Test.fst(31,2-31,13)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=Map.OpaqueToSMT.Test.fst(31,14-31,30); use=Map.OpaqueToSMT.Test.fst(31,2-31,13)
(= (Map.OpaqueToSMT.Test.sel @x0
(BoxInt 2))
(ApplyTT @x0
(BoxInt 2)))
...
;; def=Map.OpaqueToSMT.Test.fst(33,14-33,34); use=Map.OpaqueToSMT.Test.fst(33,2-33,13)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Map.OpaqueToSMT.Test.test2, 1)
; STATUS: unsat
