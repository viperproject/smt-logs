...
(declare-fun MyMap.sel (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;m: map k v -> key: k -> v
(declare-fun Tm_arrow_7264741f746bb09a7541c29842ab4a60 () Term)
(declare-fun MyMap.sel@tok () Term)
...
(declare-fun MyMap.upd (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;m: map k v -> key: k -> value: v -> map k v
(declare-fun Tm_arrow_ee61b53c0f2ccb9f021d798168498fa7 () Term)
(declare-fun MyMap.upd@tok () Term)

(declare-fun Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f (Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MyMap.sel_upd1 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MyMap.sel_upd1@tok () Term)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MyMap.sel_upd2 (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MyMap.sel_upd2@tok () Term)

; </end encoding let sel_upd2>


; End Externals for module MyMap

(push) ;; push{1

; Internals for Map.OpaqueToSMT
...
(declare-fun Map.OpaqueToSMT.map (Term Term) Term)

(declare-fun Map.OpaqueToSMT.map@tok () Term)
...
(declare-fun Map.OpaqueToSMT.sel (Term Term) Term)
;;;;;;;;;;;;;;;;m: MyMap.map _ _ -> key: _ -> _
(declare-fun Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7 (Term Term) Term)
;;;;;;;;;;;;;;;;m: MyMap.map _ _ -> key: _ -> _
(declare-fun Tm_arrow_a05b37225076dac09a216d6662d5c112 () Term)
(declare-fun Map.OpaqueToSMT.sel@tok () Term)
...
(declare-fun Map.OpaqueToSMT.upd (Term Term) Term)
;;;;;;;;;;;;;;;;m: MyMap.map _ _ -> key: _ -> value: _ -> MyMap.map _ _
(declare-fun Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0 (Term Term) Term)
;;;;;;;;;;;;;;;;m: MyMap.map _ _ -> key: _ -> value: _ -> MyMap.map _ _
(declare-fun Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed () Term)
(declare-fun Map.OpaqueToSMT.upd@tok () Term)
...
;;;;;;;;;;;;;;;;typing_Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f
;;; Fact-ids: Name MyMap.upd; Namespace MyMap
(assert (! 
;; def=MyMap.fst(25,11-25,45); use=MyMap.fst(25,11-25,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f))

:named typing_Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name MyMap.upd; Namespace MyMap
(assert (! 
;; def=MyMap.fst(24,4-24,7); use=MyMap.fst(24,4-24,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
:pattern ((MyMap.upd @x0
@x1
@x2
@x3
@x4))
:qid typing_MyMap.upd))

:named typing_MyMap.upd))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MyMap.sel; Namespace MyMap
(assert (! 
;; def=MyMap.fst(22,4-22,7); use=MyMap.fst(22,4-22,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
:pattern ((MyMap.sel @x0
@x1
@x2
@x3))
:qid typing_MyMap.sel))

:named typing_MyMap.sel))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MyMap.map; Namespace MyMap
(assert (! 
;; def=MyMap.fst(20,5-20,8); use=MyMap.fst(20,5-20,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
Tm_type))
(HasType (MyMap.map @x0
@x1)
Tm_type))
 

:pattern ((MyMap.map @x0
@x1))
:qid typing_MyMap.map))

:named typing_MyMap.map))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Map.OpaqueToSMT.upd; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(26,4-26,7); use=Map.OpaqueToSMT.fst(26,4-26,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
Tm_type))
(HasType (Map.OpaqueToSMT.upd @x0
@x1)
(Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0 @x1
@x0)))
 

:pattern ((Map.OpaqueToSMT.upd @x0
@x1))
:qid typing_Map.OpaqueToSMT.upd))

:named typing_Map.OpaqueToSMT.upd))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Map.OpaqueToSMT.sel; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(23,4-23,7); use=Map.OpaqueToSMT.fst(23,4-23,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
Tm_type))
(HasType (Map.OpaqueToSMT.sel @x0
@x1)
(Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7 @x1
@x0)))
 

:pattern ((Map.OpaqueToSMT.sel @x0
@x1))
:qid typing_Map.OpaqueToSMT.sel))

:named typing_Map.OpaqueToSMT.sel))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Map.OpaqueToSMT.map; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(20,4-20,7); use=Map.OpaqueToSMT.fst(20,4-20,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
Tm_type))
(HasType (Map.OpaqueToSMT.map @x0
@x1)
Tm_type))
 

:pattern ((Map.OpaqueToSMT.map @x0
@x1))
:qid typing_Map.OpaqueToSMT.map))

:named typing_Map.OpaqueToSMT.map))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;; def=Map.OpaqueToSMT.fst(26,4-26,7); use=Map.OpaqueToSMT.fst(26,4-26,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Map.OpaqueToSMT.upd@tok
@x0)
@x1)
(Map.OpaqueToSMT.upd @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Map.OpaqueToSMT.upd@tok
@x0)
@x1))
:qid token_correspondence_Map.OpaqueToSMT.upd))

:named token_correspondence_Map.OpaqueToSMT.upd))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Map.OpaqueToSMT.sel; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(23,4-23,7); use=Map.OpaqueToSMT.fst(23,4-23,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Map.OpaqueToSMT.sel@tok
@x0)
@x1)
(Map.OpaqueToSMT.sel @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Map.OpaqueToSMT.sel@tok
@x0)
@x1))
:qid token_correspondence_Map.OpaqueToSMT.sel))

:named token_correspondence_Map.OpaqueToSMT.sel))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;Lemma: MyMap.sel_upd2
;;; Fact-ids: Name MyMap.sel_upd2; Namespace MyMap
...
;; def=MyMap.fst(35,14-35,29); use=MyMap.fst(35,14-35,29)
(not 
;; def=MyMap.fst(35,15-35,29); use=MyMap.fst(35,15-35,29)
(= @x3
@x4)
)
)

;; def=MyMap.fst(35,34-35,75); use=MyMap.fst(35,34-35,75)
(= (MyMap.sel @x0
@x1
(MyMap.upd @x0
@x1
...
@x5)
@x4))
:qid lemma_MyMap.sel_upd2))
:named lemma_MyMap.sel_upd2))
;;;;;;;;;;;;;;;;Lemma: MyMap.sel_upd1
;;; Fact-ids: Name MyMap.sel_upd1; Namespace MyMap
...
;; def=MyMap.fst(29,13-29,49); use=MyMap.fst(29,13-29,49)
(= (MyMap.sel @x0
@x1
(MyMap.upd @x0
@x1
...
@x4)
@x3))
:qid lemma_MyMap.sel_upd1))
:named lemma_MyMap.sel_upd1))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0
;;; Fact-ids: Name Map.OpaqueToSMT.upd; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(26,0-26,15); use=Map.OpaqueToSMT.fst(26,0-26,15)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0))

:named kinding_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed
;;; Fact-ids: Name Map.OpaqueToSMT.upd; Namespace Map.OpaqueToSMT
(assert (! (HasType Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed
Tm_type)
:named kinding_Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a05b37225076dac09a216d6662d5c112
;;; Fact-ids: Name Map.OpaqueToSMT.sel; Namespace Map.OpaqueToSMT
(assert (! (HasType Tm_arrow_a05b37225076dac09a216d6662d5c112
Tm_type)
:named kinding_Tm_arrow_a05b37225076dac09a216d6662d5c112))
...
;;; Fact-ids: Name MyMap.map; Namespace MyMap
(assert (! 
;; def=MyMap.fst(20,10-20,22); use=MyMap.fst(20,31-20,37)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7
;;; Fact-ids: Name Map.OpaqueToSMT.sel; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(23,0-23,15); use=Map.OpaqueToSMT.fst(23,0-23,15)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7))

:named kinding_Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (HasType Prims.trivial
Tm_type)
:named kinding_Prims.trivial@tok))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f
;;; Fact-ids: Name MyMap.upd; Namespace MyMap
(assert (! 
;; def=MyMap.fst(25,11-25,45); use=MyMap.fst(25,11-25,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f @x1
@x2
@x3
@x4
@x5)
...
:pattern ((ApplyTT (Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f @x1
@x2
@x3
@x4
@x5)
@x0))
:qid interpretation_Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f))

:named interpretation_Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Map.OpaqueToSMT.upd@tok
Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed))
...
@x1)
@x2)
(Map.OpaqueToSMT.upd @x1
@x2))
 

:pattern ((Map.OpaqueToSMT.upd @x1
@x2))
:qid function_token_typing_Map.OpaqueToSMT.upd.1))
)
 

:pattern ((ApplyTT @x0
Map.OpaqueToSMT.upd@tok))
:qid function_token_typing_Map.OpaqueToSMT.upd))

:named function_token_typing_Map.OpaqueToSMT.upd))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Map.OpaqueToSMT.sel; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(23,4-23,7); use=Map.OpaqueToSMT.fst(23,4-23,7)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Map.OpaqueToSMT.sel@tok
Tm_arrow_a05b37225076dac09a216d6662d5c112))
...
@x1)
@x2)
(Map.OpaqueToSMT.sel @x1
@x2))
 

:pattern ((Map.OpaqueToSMT.sel @x1
@x2))
:qid function_token_typing_Map.OpaqueToSMT.sel.1))
)
 

:pattern ((ApplyTT @x0
Map.OpaqueToSMT.sel@tok))
:qid function_token_typing_Map.OpaqueToSMT.sel))

:named function_token_typing_Map.OpaqueToSMT.sel))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
@x3
@x4)
(Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f @x4
@x2
@x3
@x1
@x0))
...
@x3
@x4))
:qid equation_MyMap.upd))

:named equation_MyMap.upd))
;;;;;;;;;;;;;;;;Equation for MyMap.sel
;;; Fact-ids: Name MyMap.sel; Namespace MyMap
(assert (! 
;; def=MyMap.fst(22,4-22,7); use=MyMap.fst(22,4-22,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3))
:qid equation_MyMap.sel))

:named equation_MyMap.sel))
;;;;;;;;;;;;;;;;Equation for MyMap.map
;;; Fact-ids: Name MyMap.map; Namespace MyMap
(assert (! 
;; def=MyMap.fst(20,5-20,8); use=MyMap.fst(20,5-20,8)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((MyMap.map @x0
@x1))
:qid equation_MyMap.map))

:named equation_MyMap.map))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x2
@x3)))
:qid MyMap_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named MyMap_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
...
:pattern ((ApplyTT @x0
@x3))
:qid MyMap_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe.1))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x2)))
:qid MyMap_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named MyMap_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Map.OpaqueToSMT.upd; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(26,0-26,15); use=Map.OpaqueToSMT.fst(26,0-26,15)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0 @x2
@x3)))
:qid Map.OpaqueToSMT_pre_typing_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0))

:named Map.OpaqueToSMT_pre_typing_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Map.OpaqueToSMT.upd; Namespace Map.OpaqueToSMT
(assert (! 
;; def=MyMap.fst(24,12-24,28); use=Map.OpaqueToSMT.fst(26,0-26,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed)
...
@x1
Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed))
:qid Map.OpaqueToSMT_pre_typing_Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed))

:named Map.OpaqueToSMT_pre_typing_Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Map.OpaqueToSMT.sel; Namespace Map.OpaqueToSMT
(assert (! 
;; def=MyMap.fst(22,12-22,28); use=Map.OpaqueToSMT.fst(23,0-23,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a05b37225076dac09a216d6662d5c112)
...
@x1
Tm_arrow_a05b37225076dac09a216d6662d5c112))
:qid Map.OpaqueToSMT_pre_typing_Tm_arrow_a05b37225076dac09a216d6662d5c112))

:named Map.OpaqueToSMT_pre_typing_Tm_arrow_a05b37225076dac09a216d6662d5c112))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Map.OpaqueToSMT.sel; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(23,0-23,15); use=Map.OpaqueToSMT.fst(23,0-23,15)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7 @x2
@x3)))
:qid Map.OpaqueToSMT_pre_typing_Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7))

:named Map.OpaqueToSMT_pre_typing_Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0
;;; Fact-ids: Name Map.OpaqueToSMT.upd; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(26,0-26,15); use=Map.OpaqueToSMT.fst(26,0-26,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x4)
@x5))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0.2))
...
@x3)
@x4))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0.3))
))
...
(Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0 @x1
@x2)))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0))

:named Map.OpaqueToSMT_interpretation_Tm_arrow_fd59b6a8652cd8b63bc588c844ac42c0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed
;;; Fact-ids: Name Map.OpaqueToSMT.upd; Namespace Map.OpaqueToSMT
(assert (! 
;; def=MyMap.fst(24,12-24,28); use=Map.OpaqueToSMT.fst(26,0-26,15)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed))

:named Map.OpaqueToSMT_interpretation_Tm_arrow_b5d7dc17e8f641455e68bb5708e5d9ed))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a05b37225076dac09a216d6662d5c112
;;; Fact-ids: Name Map.OpaqueToSMT.sel; Namespace Map.OpaqueToSMT
(assert (! 
;; def=MyMap.fst(22,12-22,28); use=Map.OpaqueToSMT.fst(23,0-23,15)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_a05b37225076dac09a216d6662d5c112.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_a05b37225076dac09a216d6662d5c112.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_a05b37225076dac09a216d6662d5c112))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_a05b37225076dac09a216d6662d5c112))

:named Map.OpaqueToSMT_interpretation_Tm_arrow_a05b37225076dac09a216d6662d5c112))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7
;;; Fact-ids: Name Map.OpaqueToSMT.sel; Namespace Map.OpaqueToSMT
(assert (! 
;; def=Map.OpaqueToSMT.fst(23,0-23,15); use=Map.OpaqueToSMT.fst(23,0-23,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x3)
@x4))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7.2))
))
...
(Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7 @x1
@x2)))
:qid Map.OpaqueToSMT_interpretation_Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7))

:named Map.OpaqueToSMT_interpretation_Tm_arrow_19504d83e5e7378b3ce6c2cfe34a25f7))
(push) ;; push{2

; Starting query at Map.OpaqueToSMT.fst(32,4-32,76)
...
Map.OpaqueToSMT.upd@tok))
:named @kick_partial_app_d3b48c8628bd9288c580039a2855ba78))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
Map.OpaqueToSMT.sel@tok))
:named @kick_partial_app_3fda93ea0c93eeb1fc5110dd7087d2e5))



; Encoding query formula : forall (k: Prims.eqtype) (v: Type) (m: Map.OpaqueToSMT.map k v) (key: k) (value: v).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         Map.OpaqueToSMT.sel (Map.OpaqueToSMT.upd m key value) key == value ==> p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         Map.OpaqueToSMT.sel (Map.OpaqueToSMT.upd m key value) key ==
;         MyMap.sel (MyMap.upd m key value) key ==>
;         p pure_result)
...
;; def=Prims.fst(441,36-441,97); use=Map.OpaqueToSMT.fst(32,4-32,76)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=Map.OpaqueToSMT.fst(30,13-30,49); use=Map.OpaqueToSMT.fst(32,4-32,76)
(or label_2

;; def=Map.OpaqueToSMT.fst(30,13-30,49); use=Map.OpaqueToSMT.fst(32,4-32,76)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.sel@tok
@x0)
@x1)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.upd@tok
@x0)
@x1)
@x2)
@x3)
...
;; def=Prims.fst(441,83-441,96); use=Map.OpaqueToSMT.fst(32,4-32,76)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Map.OpaqueToSMT.fst(32,4-32,76)
(ApplyTT @x5
@x6)
...
;; def=Map.OpaqueToSMT.fst(32,16-32,76); use=Map.OpaqueToSMT.fst(32,4-32,15)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.sel@tok
@x0)
@x1)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.upd@tok
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Map.OpaqueToSMT.sel_upd1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_MyMap.sel, equation_MyMap.upd, interpretation_Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f, primitive_Prims.op_Equality
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Map.OpaqueToSMT.sel_upd1 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Map.OpaqueToSMT.sel_upd1@tok () Term)



; </end encoding let sel_upd1>

;;;;;;;;;;;;;;;;Lemma: Map.OpaqueToSMT.sel_upd1
;;; Fact-ids: Name Map.OpaqueToSMT.sel_upd1; Namespace Map.OpaqueToSMT
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
;; def=Map.OpaqueToSMT.fst(30,13-30,49); use=Map.OpaqueToSMT.fst(30,13-30,49)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.sel@tok
@x0)
@x1)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.upd@tok
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.sel@tok
@x0)
@x1)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.upd@tok
@x0)
...
@x4))
@x3))
:qid lemma_Map.OpaqueToSMT.sel_upd1))
:named lemma_Map.OpaqueToSMT.sel_upd1))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Map.OpaqueToSMT.sel_upd1; Namespace Map.OpaqueToSMT
(assert (! (Valid (ApplyTT __uu__PartialApp
Map.OpaqueToSMT.upd@tok))
...
; Starting query at Map.OpaqueToSMT.fst(38,4-39,44)
...
; Encoding query formula : forall (k: Prims.eqtype) (v: Type) (m: Map.OpaqueToSMT.map k v) (key1: k) (key2: k) (value: v).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         (~(key1 == key2) ==>
;           Map.OpaqueToSMT.sel (Map.OpaqueToSMT.upd m key1 value) key2 == Map.OpaqueToSMT.sel m key2) ==>
;         p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         Map.OpaqueToSMT.sel (Map.OpaqueToSMT.upd m key1 value) key2 ==
;         MyMap.sel (MyMap.upd m key1 value) key2 ==>
;         (forall (pure_result: Prims.unit).
;             Map.OpaqueToSMT.sel m key2 == MyMap.sel m key2 ==> p pure_result))
...
;; def=Prims.fst(441,36-441,97); use=Map.OpaqueToSMT.fst(38,4-39,44)
(forall ((@x7 Term))
 (! (implies (and (or label_1
(HasType @x7
Prims.unit))
(implies 
;; def=Map.OpaqueToSMT.fst(36,14-36,29); use=Map.OpaqueToSMT.fst(38,4-39,44)
(not 
;; def=Map.OpaqueToSMT.fst(36,15-36,29); use=Map.OpaqueToSMT.fst(38,4-39,44)
(= @x3
@x4)
)


;; def=Map.OpaqueToSMT.fst(36,34-36,75); use=Map.OpaqueToSMT.fst(38,4-39,44)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Map.OpaqueToSMT.fst(38,4-39,44)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Map.OpaqueToSMT.fst(38,4-39,44)
(ApplyTT @x6
@x7)
...
;; def=Prims.fst(441,36-441,97); use=Map.OpaqueToSMT.fst(38,4-38,15)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=Map.OpaqueToSMT.fst(38,16-38,80); use=Map.OpaqueToSMT.fst(38,4-38,15)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.sel@tok
@x0)
@x1)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.upd@tok
...
;; def=Prims.fst(441,36-441,97); use=Map.OpaqueToSMT.fst(39,4-39,15)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=Map.OpaqueToSMT.fst(39,16-39,44); use=Map.OpaqueToSMT.fst(39,4-39,15)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Map.OpaqueToSMT.sel@tok
@x0)
@x1)
@x2)
...
;; def=Prims.fst(441,83-441,96); use=Map.OpaqueToSMT.fst(39,4-39,15)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Map.OpaqueToSMT.fst(39,4-39,15)
(ApplyTT @x6
@x8)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Map.OpaqueToSMT.sel_upd2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_MyMap.sel, equation_MyMap.upd, interpretation_Tm_abs_c949098ee5a6a1d16a9b3ac1fa6e078f, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0
