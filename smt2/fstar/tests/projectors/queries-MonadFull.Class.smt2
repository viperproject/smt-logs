...
; Externals for interface FStar.Tactics.MkProjectors


; <Start encoding val FStar.Tactics.MkProjectors.meta_projectors>

(declare-fun FStar.Tactics.MkProjectors.meta_projectors (Dummy_sort) Term)

; </end encoding val FStar.Tactics.MkProjectors.meta_projectors>


; <Start encoding val FStar.Tactics.MkProjectors.mk_one_projector>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Tactics.MkProjectors.mk_one_projector (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Tactics.MkProjectors.mk_one_projector@tok () Term)

; </end encoding val FStar.Tactics.MkProjectors.mk_one_projector>


; <Start encoding val FStar.Tactics.MkProjectors.mk_one_method>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Tactics.MkProjectors.mk_one_method (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Tactics.MkProjectors.mk_one_method@tok () Term)

; </end encoding val FStar.Tactics.MkProjectors.mk_one_method>


; <Start encoding val FStar.Tactics.MkProjectors.mk_projs>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Tactics.MkProjectors.mk_projs (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Tactics.MkProjectors.mk_projs@tok () Term)

; </end encoding val FStar.Tactics.MkProjectors.mk_projs>


; End Externals for interface FStar.Tactics.MkProjectors
...
; Internals for MonadFull.Class


; encoding sigelt type MonadFull.Class.monad


; <Start encoding type MonadFull.Class.monad>

;;;;;;;;;;;;;;;;Constructor
(declare-fun MonadFull.Class.monad (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun MonadFull.Class.monad@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun MonadFull.Class.Mkmonad (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFull.Class.Mkmonad_m (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFull.Class.Mkmonad_return (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFull.Class.Mkmonad_bind (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFull.Class.Mkmonad_idL (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFull.Class.Mkmonad_idR (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFull.Class.Mkmonad_assoc (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: MonadFull.Class.Mkmonad
(declare-fun MonadFull.Class.Mkmonad@tok () Term)
...
;;;;;;;;;;;;;;;;return: (_: a -> m a) ->     bind: (_: m a -> _: (_: a -> m b) -> m b) ->     idL: (x: a -> f: (_: a -> m b) -> FStar.Pervasives.Lemma (ensures bind (return x) f == f x)) ->     idR: (x: m a -> FStar.Pervasives.Lemma (ensures bind x return == x)) ->     assoc:       (x: m a -> f: (_: a -> m b) -> g: (_: b -> m c)           -> FStar.Pervasives.Lemma (ensures bind (bind x f) g == bind x (fun y -> bind (f y) g)))   -> monad m
(declare-fun Tm_arrow_f4c7ff00309d329cad047cd1adb676b8 () Term)

; <start constructor MonadFull.Class.monad>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-MonadFull.Class.monad ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
106)
(exists ((@x0 Term))
 (! (= __@x0
(MonadFull.Class.monad @x0))
 
;;no pats
:qid is-MonadFull.Class.monad))))

; </end constructor MonadFull.Class.monad>


; <start constructor MonadFull.Class.Mkmonad>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-MonadFull.Class.Mkmonad ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
138)
(= __@x0
(MonadFull.Class.Mkmonad (MonadFull.Class.Mkmonad_m __@x0)
(MonadFull.Class.Mkmonad_return __@x0)
(MonadFull.Class.Mkmonad_bind __@x0)
(MonadFull.Class.Mkmonad_idL __@x0)
(MonadFull.Class.Mkmonad_idR __@x0)
(MonadFull.Class.Mkmonad_assoc __@x0)))))

; </end constructor MonadFull.Class.Mkmonad>


; </end encoding type MonadFull.Class.monad>


; encoding sigelt let __proj__Mkmonad__item__return


; <Start encoding let __proj__Mkmonad__item__return>


(declare-fun MonadFull.Class.__proj__Mkmonad__item__return (Term) Term)


;;;;;;;;;;;;;;;;x7: monad m -> _: a -> m a
(declare-fun Tm_arrow_0dde81bd2dae218241739a1a2c115d81 (Term) Term)
;;;;;;;;;;;;;;;;x7: monad m -> _: a -> m a
(declare-fun Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc () Term)
(declare-fun MonadFull.Class.__proj__Mkmonad__item__return@tok () Term)





(declare-fun Tm_abs_64466ab2729ee208060f2d108e69e2ed (Term) Term)

; </end encoding let __proj__Mkmonad__item__return>
...
(declare-fun MonadFull.Class.return (Term) Term)




(declare-fun MonadFull.Class.return@tok () Term)





(declare-fun Tm_abs_0e0118ea919415a9d0f2ad39a014ac49 (Term) Term)
...
; <Start encoding let __proj__Mkmonad__item__bind>


(declare-fun MonadFull.Class.__proj__Mkmonad__item__bind (Term) Term)



;;;;;;;;;;;;;;;;x8: monad m -> _: m a -> _: (_: a -> m b) -> m b
(declare-fun Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 (Term) Term)
;;;;;;;;;;;;;;;;x8: monad m -> _: m a -> _: (_: a -> m b) -> m b
(declare-fun Tm_arrow_07115a929c8dc0a3043b474e1e463a52 () Term)
(declare-fun MonadFull.Class.__proj__Mkmonad__item__bind@tok () Term)
...
(declare-fun Tm_abs_7dd890189efc6e16730731fe8fbb7b75 (Term) Term)

; </end encoding let __proj__Mkmonad__item__bind>
...
(declare-fun MonadFull.Class.bind (Term) Term)





(declare-fun MonadFull.Class.bind@tok () Term)
...
(declare-fun Tm_abs_81a344c76be5119d83c28a952f047e07 (Term) Term)

; </end encoding let bind>


; encoding sigelt let __proj__Mkmonad__item__idL


; <Start encoding let __proj__Mkmonad__item__idL>


(declare-fun MonadFull.Class.__proj__Mkmonad__item__idL (Term) Term)




(declare-fun Tm_refine_e67f9f2ff1989bb2ca11fcd6e3864d2a (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> f: (_: a -> m b) -> FStar.Pervasives.Lemma (ensures x9.bind (x9.return x) f == f x)
(declare-fun Tm_arrow_29c8c6e825a1b4df09355bfc5b603245 (Term Term) Term)
;;;;;;;;;;;;;;;;x9: monad m -> x: a -> f: (_: a -> m b)   -> FStar.Pervasives.Lemma (ensures x9.bind (x9.return x) f == f x)
(declare-fun Tm_arrow_8e3c29060aff0cd896b6ddeb884bf72a (Term) Term)
;;;;;;;;;;;;;;;;x9: monad m -> x: a -> f: (_: a -> m b)   -> FStar.Pervasives.Lemma (ensures x9.bind (x9.return x) f == f x)
(declare-fun Tm_arrow_1e3df243494f9c653ac202b80e26e2db () Term)
(declare-fun MonadFull.Class.__proj__Mkmonad__item__idL@tok () Term)
...
(declare-fun Tm_abs_ce027392c3e34e8e078212533515506e (Term) Term)

; </end encoding let __proj__Mkmonad__item__idL>


; encoding sigelt let idL


; <Start encoding let idL>


(declare-fun MonadFull.Class.idL (Term) Term)
...
(declare-fun MonadFull.Class.idL@tok () Term)
...
(declare-fun Tm_abs_4f4a0ff27fe6d68402c8841102cd7ef4 (Term) Term)

; </end encoding let idL>


; encoding sigelt let __proj__Mkmonad__item__idR


; <Start encoding let __proj__Mkmonad__item__idR>


(declare-fun MonadFull.Class.__proj__Mkmonad__item__idR (Term) Term)



(declare-fun Tm_refine_e7afcd38e7e84814ad8c8a347b4e4170 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: m a -> FStar.Pervasives.Lemma (ensures x10.bind x x10.return == x)
(declare-fun Tm_arrow_38a85adc5e4a0be3784d43f948d35489 (Term Term) Term)
;;;;;;;;;;;;;;;;x10: monad m -> x: m a -> FStar.Pervasives.Lemma (ensures x10.bind x x10.return == x)
(declare-fun Tm_arrow_ec86023137932ecdd9573f9b786b70a9 (Term) Term)
;;;;;;;;;;;;;;;;x10: monad m -> x: m a -> FStar.Pervasives.Lemma (ensures x10.bind x x10.return == x)
(declare-fun Tm_arrow_bac31e93150755db7f1ab51c016dfbe4 () Term)
(declare-fun MonadFull.Class.__proj__Mkmonad__item__idR@tok () Term)
...
(declare-fun Tm_abs_b526a2c8c6ba64f574b49c01d566e029 (Term) Term)

; </end encoding let __proj__Mkmonad__item__idR>


; encoding sigelt let idR


; <Start encoding let idR>


(declare-fun MonadFull.Class.idR (Term) Term)
...
(declare-fun MonadFull.Class.idR@tok () Term)
...
(declare-fun Tm_abs_e77a8f9a58a4fd39de61d10d56a56882 (Term) Term)

; </end encoding let idR>


; encoding sigelt let __proj__Mkmonad__item__assoc


; <Start encoding let __proj__Mkmonad__item__assoc>


(declare-fun MonadFull.Class.__proj__Mkmonad__item__assoc (Term) Term)
...
(declare-fun Tm_abs_41808b75aff447218c48d75dd9dded0e (Term Term Term Term Term Term Term) Term)

(declare-fun Tm_refine_c2278e10690e3a8f20ca772fded46162 (Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: m a -> f: (_: a -> m b) -> g: (_: b -> m c)   -> FStar.Pervasives.Lemma     (ensures x11.bind (x11.bind x f) g == x11.bind x (fun y -> x11.bind (f y) g))
(declare-fun Tm_arrow_191311d0aa16ce3b8023b8fa05914955 (Term Term) Term)
;;;;;;;;;;;;;;;;x11: monad m -> x: m a -> f: (_: a -> m b) -> g: (_: b -> m c)   -> FStar.Pervasives.Lemma     (ensures x11.bind (x11.bind x f) g == x11.bind x (fun y -> x11.bind (f y) g))
(declare-fun Tm_arrow_d99b9b7a9fbef5c17c48b57442de2062 (Term) Term)
;;;;;;;;;;;;;;;;x11: monad m -> x: m a -> f: (_: a -> m b) -> g: (_: b -> m c)   -> FStar.Pervasives.Lemma     (ensures x11.bind (x11.bind x f) g == x11.bind x (fun y -> x11.bind (f y) g))
(declare-fun Tm_arrow_3899df3ac51f10234ef38ed013744976 () Term)
(declare-fun MonadFull.Class.__proj__Mkmonad__item__assoc@tok () Term)
...
(declare-fun Tm_abs_b1a569584e851472099ce2972d786498 (Term) Term)

; </end encoding let __proj__Mkmonad__item__assoc>
...
(declare-fun MonadFull.Class.assoc (Term) Term)
...
(declare-fun MonadFull.Class.assoc@tok () Term)
...
(declare-fun Tm_abs_52369319b8072836024b1b23d108e192 (Term) Term)
...
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(18,28-18,40); use=MonadFull.Class.fst(17,4-17,9)
...
;;;;;;;;;;;;;;;;typing_Tm_abs_81a344c76be5119d83c28a952f047e07
;;; Fact-ids: Name MonadFull.Class.bind; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(20,0-20,73); use=MonadFull.Class.fst(11,14-13,51)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_81a344c76be5119d83c28a952f047e07 @x0)
(Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 @x0))
 

:pattern ((Tm_abs_81a344c76be5119d83c28a952f047e07 @x0))
:qid typing_Tm_abs_81a344c76be5119d83c28a952f047e07))

:named typing_Tm_abs_81a344c76be5119d83c28a952f047e07))
;;;;;;;;;;;;;;;;typing_Tm_abs_7dd890189efc6e16730731fe8fbb7b75
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (HasType (Tm_abs_7dd890189efc6e16730731fe8fbb7b75 @x0)
(Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 @x0))
 

:pattern ((Tm_abs_7dd890189efc6e16730731fe8fbb7b75 @x0))
:qid typing_Tm_abs_7dd890189efc6e16730731fe8fbb7b75))
:named typing_Tm_abs_7dd890189efc6e16730731fe8fbb7b75))
;;;;;;;;;;;;;;;;typing_Tm_abs_64466ab2729ee208060f2d108e69e2ed
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (HasType (Tm_abs_64466ab2729ee208060f2d108e69e2ed @x0)
(Tm_arrow_0dde81bd2dae218241739a1a2c115d81 @x0))
 

:pattern ((Tm_abs_64466ab2729ee208060f2d108e69e2ed @x0))
:qid typing_Tm_abs_64466ab2729ee208060f2d108e69e2ed))
:named typing_Tm_abs_64466ab2729ee208060f2d108e69e2ed))
;;;;;;;;;;;;;;;;typing_Tm_abs_0e0118ea919415a9d0f2ad39a014ac49
;;; Fact-ids: Name MonadFull.Class.return; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(20,0-20,73); use=MonadFull.Class.fst(11,14-12,20)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_0e0118ea919415a9d0f2ad39a014ac49 @x0)
(Tm_arrow_0dde81bd2dae218241739a1a2c115d81 @x0))
 

:pattern ((Tm_abs_0e0118ea919415a9d0f2ad39a014ac49 @x0))
:qid typing_Tm_abs_0e0118ea919415a9d0f2ad39a014ac49))

:named typing_Tm_abs_0e0118ea919415a9d0f2ad39a014ac49))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
(HasType (MonadFull.Class.return @x0)
(Tm_arrow_0dde81bd2dae218241739a1a2c115d81 @x0)))
 

:pattern ((MonadFull.Class.return @x0))
:qid typing_MonadFull.Class.return))
:named typing_MonadFull.Class.return))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadFull.Class.bind; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (MonadFull.Class.bind @x0)
(Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 @x0)))
 

:pattern ((MonadFull.Class.bind @x0))
:qid typing_MonadFull.Class.bind))
:named typing_MonadFull.Class.bind))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (MonadFull.Class.__proj__Mkmonad__item__return @x0)
(Tm_arrow_0dde81bd2dae218241739a1a2c115d81 @x0)))
 

:pattern ((MonadFull.Class.__proj__Mkmonad__item__return @x0))
:qid typing_MonadFull.Class.__proj__Mkmonad__item__return))
:named typing_MonadFull.Class.__proj__Mkmonad__item__return))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (MonadFull.Class.__proj__Mkmonad__item__bind @x0)
(Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 @x0)))
 

:pattern ((MonadFull.Class.__proj__Mkmonad__item__bind @x0))
:qid typing_MonadFull.Class.__proj__Mkmonad__item__bind))
:named typing_MonadFull.Class.__proj__Mkmonad__item__bind))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name MonadFull.Class.return; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT MonadFull.Class.return@tok
@x0)
(MonadFull.Class.return @x0))
 

:pattern ((ApplyTT MonadFull.Class.return@tok
@x0))
:qid token_correspondence_MonadFull.Class.return))
:named token_correspondence_MonadFull.Class.return))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
(forall ((@x0 Term))
 (! (= (ApplyTT MonadFull.Class.monad@tok
@x0)
(MonadFull.Class.monad @x0))
 

:pattern ((ApplyTT MonadFull.Class.monad@tok
@x0))

:pattern ((MonadFull.Class.monad @x0))
:qid token_correspondence_MonadFull.Class.monad@tok))

:named token_correspondence_MonadFull.Class.monad@tok))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name MonadFull.Class.bind; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT MonadFull.Class.bind@tok
@x0)
(MonadFull.Class.bind @x0))
 

:pattern ((ApplyTT MonadFull.Class.bind@tok
@x0))
:qid token_correspondence_MonadFull.Class.bind))
:named token_correspondence_MonadFull.Class.bind))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT MonadFull.Class.__proj__Mkmonad__item__return@tok
@x0)
(MonadFull.Class.__proj__Mkmonad__item__return @x0))
 

:pattern ((ApplyTT MonadFull.Class.__proj__Mkmonad__item__return@tok
@x0))
:qid token_correspondence_MonadFull.Class.__proj__Mkmonad__item__return))
:named token_correspondence_MonadFull.Class.__proj__Mkmonad__item__return))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT MonadFull.Class.__proj__Mkmonad__item__bind@tok
@x0)
(MonadFull.Class.__proj__Mkmonad__item__bind @x0))
 

:pattern ((ApplyTT MonadFull.Class.__proj__Mkmonad__item__bind@tok
@x0))
:qid token_correspondence_MonadFull.Class.__proj__Mkmonad__item__bind))
:named token_correspondence_MonadFull.Class.__proj__Mkmonad__item__bind))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
...
(MonadFull.Class.Mkmonad @x1
@x2
@x3
@x4
@x5
@x6)
(MonadFull.Class.monad @x7))
...
@x6)
(MonadFull.Class.monad @x7)))
:qid subterm_ordering_MonadFull.Class.Mkmonad))

:named subterm_ordering_MonadFull.Class.Mkmonad))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(17,4-18,42); use=MonadFull.Class.fst(17,4-18,42)
...
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(14,50-14,82); use=MonadFull.Class.fst(14,50-14,82)
...
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(15,28-15,54); use=MonadFull.Class.fst(15,28-15,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;; def=Prims.fst(635,71-635,97); use=MonadFull.Class.fst(17,4-18,42)
(not 
;; def=Prims.fst(441,29-441,97); use=MonadFull.Class.fst(17,4-17,9)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=MonadFull.Class.fst(17,10-18,42); use=MonadFull.Class.fst(17,4-17,9)
...
;; def=Prims.fst(635,86-635,95); use=MonadFull.Class.fst(17,4-18,42)
(not 
;; def=Prims.fst(635,86-635,95); use=MonadFull.Class.fst(17,4-18,42)
(= @x10
@x1)
...
;; def=Prims.fst(635,71-635,97); use=MonadFull.Class.fst(14,50-14,82)
(not 
;; def=Prims.fst(441,29-441,97); use=MonadFull.Class.fst(14,50-14,55)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=MonadFull.Class.fst(14,56-14,82); use=MonadFull.Class.fst(14,50-14,55)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x2
@x3)
@x4)
(ApplyTT (ApplyTT @x5
...
;; def=Prims.fst(635,86-635,95); use=MonadFull.Class.fst(14,50-14,82)
(not 
;; def=Prims.fst(635,86-635,95); use=MonadFull.Class.fst(14,50-14,82)
(= @x8
@x1)
...
;; def=Prims.fst(635,71-635,97); use=MonadFull.Class.fst(15,28-15,54)
(not 
;; def=Prims.fst(441,29-441,97); use=MonadFull.Class.fst(15,28-15,33)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=MonadFull.Class.fst(15,34-15,54); use=MonadFull.Class.fst(15,28-15,33)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x2
@x3)
@x3)
@x4)
...
;; def=Prims.fst(635,86-635,95); use=MonadFull.Class.fst(15,28-15,54)
(not 
;; def=Prims.fst(635,86-635,95); use=MonadFull.Class.fst(15,28-15,54)
(= @x6
@x1)
...
;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (MonadFull.Class.Mkmonad_return (MonadFull.Class.Mkmonad @x0
@x1
@x2
@x3
@x4
...
:pattern ((MonadFull.Class.Mkmonad @x0
@x1
@x2
@x3
@x4
@x5))
:qid projection_inverse_MonadFull.Class.Mkmonad_return))

:named projection_inverse_MonadFull.Class.Mkmonad_return))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (MonadFull.Class.Mkmonad_m (MonadFull.Class.Mkmonad @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_MonadFull.Class.Mkmonad_m))

:named projection_inverse_MonadFull.Class.Mkmonad_m))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (MonadFull.Class.Mkmonad_idR (MonadFull.Class.Mkmonad @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_MonadFull.Class.Mkmonad_idR))

:named projection_inverse_MonadFull.Class.Mkmonad_idR))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (MonadFull.Class.Mkmonad_idL (MonadFull.Class.Mkmonad @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_MonadFull.Class.Mkmonad_idL))

:named projection_inverse_MonadFull.Class.Mkmonad_idL))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (MonadFull.Class.Mkmonad_bind (MonadFull.Class.Mkmonad @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_MonadFull.Class.Mkmonad_bind))

:named projection_inverse_MonadFull.Class.Mkmonad_bind))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (MonadFull.Class.Mkmonad_assoc (MonadFull.Class.Mkmonad @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_MonadFull.Class.Mkmonad_assoc))

:named projection_inverse_MonadFull.Class.Mkmonad_assoc))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! (is-Tm_arrow (PreType MonadFull.Class.monad@tok))
:named pre_kinding_MonadFull.Class.monad@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fe96ea64440933a872257514e1912843
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-13,51); use=MonadFull.Class.fst(13,27-13,51)
(forall ((@x0 Term))
...
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(13,12-13,43); use=MonadFull.Class.fst(13,35-13,43)
...
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(12,12-12,13); use=MonadFull.Class.fst(12,19-12,20)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! (HasType Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc
Tm_type)
:named kinding_Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c0f9a195bc5ae312e558b22f370ae731
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-13,51); use=MonadFull.Class.fst(11,14-13,51)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 @x0)
Tm_type))
:qid kinding_Tm_arrow_c0f9a195bc5ae312e558b22f370ae731))

:named kinding_Tm_arrow_c0f9a195bc5ae312e558b22f370ae731))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_826caaf1f5a068be489ec69d8e350705
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-14,45); use=MonadFull.Class.fst(14,29-14,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-18,42); use=MonadFull.Class.fst(16,37-18,42)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0dde81bd2dae218241739a1a2c115d81
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-12,13); use=MonadFull.Class.fst(11,14-12,20)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_0dde81bd2dae218241739a1a2c115d81 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_0dde81bd2dae218241739a1a2c115d81 @x0)
Tm_type))
:qid kinding_Tm_arrow_0dde81bd2dae218241739a1a2c115d81))

:named kinding_Tm_arrow_0dde81bd2dae218241739a1a2c115d81))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_07115a929c8dc0a3043b474e1e463a52
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! (HasType Tm_arrow_07115a929c8dc0a3043b474e1e463a52
Tm_type)
:named kinding_Tm_arrow_07115a929c8dc0a3043b474e1e463a52))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0343debff6b5862c3d3aa654609340e8
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-15,54); use=MonadFull.Class.fst(15,21-15,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! (and (IsTotFun MonadFull.Class.monad@tok)

;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (MonadFull.Class.monad @x0)
Tm_type))
 

:pattern ((MonadFull.Class.monad @x0))
:qid kinding_MonadFull.Class.monad@tok))
)
:named kinding_MonadFull.Class.monad@tok))
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_81a344c76be5119d83c28a952f047e07
;;; Fact-ids: Name MonadFull.Class.bind; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(20,0-20,73); use=MonadFull.Class.fst(11,14-13,51)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_81a344c76be5119d83c28a952f047e07 @x1)
@x0)
(ApplyTT (ApplyTT MonadFull.Class.__proj__Mkmonad__item__bind@tok
@x1)
@x0))
 

:pattern ((ApplyTT (Tm_abs_81a344c76be5119d83c28a952f047e07 @x1)
@x0))
:qid interpretation_Tm_abs_81a344c76be5119d83c28a952f047e07))

:named interpretation_Tm_abs_81a344c76be5119d83c28a952f047e07))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_7dd890189efc6e16730731fe8fbb7b75
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_7dd890189efc6e16730731fe8fbb7b75 @x1)
@x0)
(let ((@lb2 @x0))
(MonadFull.Class.Mkmonad_bind @lb2)))
 

:pattern ((ApplyTT (Tm_abs_7dd890189efc6e16730731fe8fbb7b75 @x1)
@x0))
:qid interpretation_Tm_abs_7dd890189efc6e16730731fe8fbb7b75))
:named interpretation_Tm_abs_7dd890189efc6e16730731fe8fbb7b75))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_64466ab2729ee208060f2d108e69e2ed
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_64466ab2729ee208060f2d108e69e2ed @x1)
@x0)
(let ((@lb2 @x0))
(MonadFull.Class.Mkmonad_return @lb2)))
 

:pattern ((ApplyTT (Tm_abs_64466ab2729ee208060f2d108e69e2ed @x1)
@x0))
:qid interpretation_Tm_abs_64466ab2729ee208060f2d108e69e2ed))
:named interpretation_Tm_abs_64466ab2729ee208060f2d108e69e2ed))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_0e0118ea919415a9d0f2ad39a014ac49
;;; Fact-ids: Name MonadFull.Class.return; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(20,0-20,73); use=MonadFull.Class.fst(11,14-12,20)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_0e0118ea919415a9d0f2ad39a014ac49 @x1)
@x0)
(ApplyTT (ApplyTT MonadFull.Class.__proj__Mkmonad__item__return@tok
@x1)
@x0))
 

:pattern ((ApplyTT (Tm_abs_0e0118ea919415a9d0f2ad39a014ac49 @x1)
@x0))
:qid interpretation_Tm_abs_0e0118ea919415a9d0f2ad39a014ac49))

:named interpretation_Tm_abs_0e0118ea919415a9d0f2ad39a014ac49))
...
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MonadFull.Class.return@tok
Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc))
(forall ((@x1 Term))
 (! (= (ApplyTT MonadFull.Class.return@tok
@x1)
(MonadFull.Class.return @x1))
 

:pattern ((MonadFull.Class.return @x1))
:qid function_token_typing_MonadFull.Class.return.1)))
 

:pattern ((ApplyTT @x0
MonadFull.Class.return@tok))
:qid function_token_typing_MonadFull.Class.return))
:named function_token_typing_MonadFull.Class.return))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name MonadFull.Class.bind; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MonadFull.Class.bind@tok
Tm_arrow_07115a929c8dc0a3043b474e1e463a52))
(forall ((@x1 Term))
 (! (= (ApplyTT MonadFull.Class.bind@tok
@x1)
(MonadFull.Class.bind @x1))
 

:pattern ((MonadFull.Class.bind @x1))
:qid function_token_typing_MonadFull.Class.bind.1)))
 

:pattern ((ApplyTT @x0
MonadFull.Class.bind@tok))
:qid function_token_typing_MonadFull.Class.bind))
:named function_token_typing_MonadFull.Class.bind))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MonadFull.Class.__proj__Mkmonad__item__return@tok
Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc))
(forall ((@x1 Term))
 (! (= (ApplyTT MonadFull.Class.__proj__Mkmonad__item__return@tok
@x1)
(MonadFull.Class.__proj__Mkmonad__item__return @x1))
 

:pattern ((MonadFull.Class.__proj__Mkmonad__item__return @x1))
:qid function_token_typing_MonadFull.Class.__proj__Mkmonad__item__return.1)))
 

:pattern ((ApplyTT @x0
MonadFull.Class.__proj__Mkmonad__item__return@tok))
:qid function_token_typing_MonadFull.Class.__proj__Mkmonad__item__return))
:named function_token_typing_MonadFull.Class.__proj__Mkmonad__item__return))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MonadFull.Class.__proj__Mkmonad__item__bind@tok
Tm_arrow_07115a929c8dc0a3043b474e1e463a52))
(forall ((@x1 Term))
 (! (= (ApplyTT MonadFull.Class.__proj__Mkmonad__item__bind@tok
@x1)
(MonadFull.Class.__proj__Mkmonad__item__bind @x1))
 

:pattern ((MonadFull.Class.__proj__Mkmonad__item__bind @x1))
:qid function_token_typing_MonadFull.Class.__proj__Mkmonad__item__bind.1)))
 

:pattern ((ApplyTT @x0
MonadFull.Class.__proj__Mkmonad__item__bind@tok))
:qid function_token_typing_MonadFull.Class.__proj__Mkmonad__item__bind))
:named function_token_typing_MonadFull.Class.__proj__Mkmonad__item__bind))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(MonadFull.Class.monad @x2))
(and (is-MonadFull.Class.Mkmonad @x1)
(= @x2
(MonadFull.Class.Mkmonad_m @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(MonadFull.Class.monad @x2)))
:qid fuel_guarded_inversion_MonadFull.Class.monad))

:named fuel_guarded_inversion_MonadFull.Class.monad))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! (= 107
(Term_constr_id MonadFull.Class.monad@tok))
:named fresh_token_MonadFull.Class.monad@tok))
...
;;;;;;;;;;;;;;;;Equation for MonadFull.Class.return
;;; Fact-ids: Name MonadFull.Class.return; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (= (MonadFull.Class.return @x0)
(Tm_abs_0e0118ea919415a9d0f2ad39a014ac49 @x0))
 

:pattern ((MonadFull.Class.return @x0))
:qid equation_MonadFull.Class.return))
:named equation_MonadFull.Class.return))
;;;;;;;;;;;;;;;;Equation for MonadFull.Class.bind
;;; Fact-ids: Name MonadFull.Class.bind; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (= (MonadFull.Class.bind @x0)
(Tm_abs_81a344c76be5119d83c28a952f047e07 @x0))
 

:pattern ((MonadFull.Class.bind @x0))
:qid equation_MonadFull.Class.bind))
:named equation_MonadFull.Class.bind))
;;;;;;;;;;;;;;;;Equation for MonadFull.Class.__proj__Mkmonad__item__return
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (= (MonadFull.Class.__proj__Mkmonad__item__return @x0)
(Tm_abs_64466ab2729ee208060f2d108e69e2ed @x0))
 

:pattern ((MonadFull.Class.__proj__Mkmonad__item__return @x0))
:qid equation_MonadFull.Class.__proj__Mkmonad__item__return))
:named equation_MonadFull.Class.__proj__Mkmonad__item__return))
;;;;;;;;;;;;;;;;Equation for MonadFull.Class.__proj__Mkmonad__item__bind
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! (forall ((@x0 Term))
 (! (= (MonadFull.Class.__proj__Mkmonad__item__bind @x0)
(Tm_abs_7dd890189efc6e16730731fe8fbb7b75 @x0))
 

:pattern ((MonadFull.Class.__proj__Mkmonad__item__bind @x0))
:qid equation_MonadFull.Class.__proj__Mkmonad__item__bind))
:named equation_MonadFull.Class.__proj__Mkmonad__item__bind))
...
@x6)
(MonadFull.Class.monad @x1)))
:qid data_typing_intro_MonadFull.Class.Mkmonad@tok))

:named data_typing_intro_MonadFull.Class.Mkmonad@tok))
...
@x6)
(MonadFull.Class.monad @x7)))
:qid data_elim_MonadFull.Class.Mkmonad))

:named data_elim_MonadFull.Class.Mkmonad))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 106
(Term_constr_id (MonadFull.Class.monad @x0)))
 

:pattern ((MonadFull.Class.monad @x0))
:qid constructor_distinct_MonadFull.Class.monad))

:named constructor_distinct_MonadFull.Class.monad))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,5-11,10); use=MonadFull.Class.fst(11,5-11,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= 138
(Term_constr_id (MonadFull.Class.Mkmonad @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid constructor_distinct_MonadFull.Class.Mkmonad))

:named constructor_distinct_MonadFull.Class.Mkmonad))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
(MonadFull.Class.monad @x2)))
:qid MonadFull.Class_pretyping_c5032a63610488208fef46e0aef2aeb5))

:named MonadFull.Class_pretyping_c5032a63610488208fef46e0aef2aeb5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-13,51); use=MonadFull.Class.fst(13,27-13,51)
...
@x1
(Tm_arrow_fe96ea64440933a872257514e1912843 @x2)))
:qid MonadFull.Class_pre_typing_Tm_arrow_fe96ea64440933a872257514e1912843))

:named MonadFull.Class_pre_typing_Tm_arrow_fe96ea64440933a872257514e1912843))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(13,12-13,43); use=MonadFull.Class.fst(13,35-13,43)
...
@x3
@x4)))
:qid MonadFull.Class_pre_typing_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))

:named MonadFull.Class_pre_typing_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(12,12-12,13); use=MonadFull.Class.fst(12,19-12,20)
...
@x1
(Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c @x2)))
:qid MonadFull.Class_pre_typing_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))

:named MonadFull.Class_pre_typing_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-12,13); use=MonadFull.Class.fst(11,14-12,20)
...
@x1
Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc))
:qid MonadFull.Class_pre_typing_Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc))

:named MonadFull.Class_pre_typing_Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-13,51); use=MonadFull.Class.fst(11,14-13,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 @x2)))
:qid MonadFull.Class_pre_typing_Tm_arrow_c0f9a195bc5ae312e558b22f370ae731))

:named MonadFull.Class_pre_typing_Tm_arrow_c0f9a195bc5ae312e558b22f370ae731))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-14,45); use=MonadFull.Class.fst(14,29-14,45)
...
@x3
@x4)))
:qid MonadFull.Class_pre_typing_Tm_arrow_826caaf1f5a068be489ec69d8e350705))

:named MonadFull.Class_pre_typing_Tm_arrow_826caaf1f5a068be489ec69d8e350705))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-18,42); use=MonadFull.Class.fst(16,37-18,42)
...
(Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 @x2
@x3)))
:qid MonadFull.Class_pre_typing_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42))

:named MonadFull.Class_pre_typing_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-12,13); use=MonadFull.Class.fst(11,14-12,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_0dde81bd2dae218241739a1a2c115d81 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_0dde81bd2dae218241739a1a2c115d81 @x2)))
:qid MonadFull.Class_pre_typing_Tm_arrow_0dde81bd2dae218241739a1a2c115d81))

:named MonadFull.Class_pre_typing_Tm_arrow_0dde81bd2dae218241739a1a2c115d81))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-13,51); use=MonadFull.Class.fst(11,14-13,51)
...
@x1
Tm_arrow_07115a929c8dc0a3043b474e1e463a52))
:qid MonadFull.Class_pre_typing_Tm_arrow_07115a929c8dc0a3043b474e1e463a52))

:named MonadFull.Class_pre_typing_Tm_arrow_07115a929c8dc0a3043b474e1e463a52))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFull.Class.monad; Namespace MonadFull.Class; Name MonadFull.Class.Mkmonad; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-15,54); use=MonadFull.Class.fst(15,21-15,54)
...
@x3
@x4)))
:qid MonadFull.Class_pre_typing_Tm_arrow_0343debff6b5862c3d3aa654609340e8))

:named MonadFull.Class_pre_typing_Tm_arrow_0343debff6b5862c3d3aa654609340e8))
...
@x4)
@x5))
:qid MonadFull.Class_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFull.Class_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.2))
...
@x2)
@x3))
:qid MonadFull.Class_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.3))
...
@x3)
@x4))
:qid MonadFull.Class_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.4))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_fe96ea64440933a872257514e1912843 @x1)))
:qid MonadFull.Class_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843))

:named MonadFull.Class_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843))
...
:pattern ((ApplyTT @x0
@x4))
:qid MonadFull.Class_interpretation_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96.1))
...
@x2
@x3)))
:qid MonadFull.Class_interpretation_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))

:named MonadFull.Class_interpretation_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))
...
@x2)
@x3))
:qid MonadFull.Class_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFull.Class_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c @x1)))
:qid MonadFull.Class_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))

:named MonadFull.Class_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-12,13); use=MonadFull.Class.fst(11,14-12,20)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_0dde81bd2dae218241739a1a2c115d81 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid MonadFull.Class_interpretation_Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc))
:qid MonadFull.Class_interpretation_Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc))

:named MonadFull.Class_interpretation_Tm_arrow_dd0a5a0336ddb9eb5f04d9a23335b7fc))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c0f9a195bc5ae312e558b22f370ae731
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-13,51); use=MonadFull.Class.fst(11,14-13,51)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 @x1))
(and 
;; def=MonadFull.Class.fst(11,14-13,51); use=MonadFull.Class.fst(11,14-13,51)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFull.Class_interpretation_Tm_arrow_c0f9a195bc5ae312e558b22f370ae731.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_c0f9a195bc5ae312e558b22f370ae731 @x1)))
:qid MonadFull.Class_interpretation_Tm_arrow_c0f9a195bc5ae312e558b22f370ae731))

:named MonadFull.Class_interpretation_Tm_arrow_c0f9a195bc5ae312e558b22f370ae731))
...
@x6)
@x7))
:qid MonadFull.Class_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid MonadFull.Class_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705.2))
...
@x4)
@x5))
:qid MonadFull.Class_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705.3))
...
@x5)
@x6))
:qid MonadFull.Class_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705.4))
))
...
@x2
@x3)))
:qid MonadFull.Class_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705))

:named MonadFull.Class_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705))
...
@x7)
@x8))
:qid MonadFull.Class_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid MonadFull.Class_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.2))
...
@x3)
@x4))
:qid MonadFull.Class_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.3))
...
@x4)
@x5))
:qid MonadFull.Class_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.4))
...
@x5)
@x6))
:qid MonadFull.Class_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.5))
...
@x6)
@x7))
:qid MonadFull.Class_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.6))
))
...
(Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 @x1
@x2)))
:qid MonadFull.Class_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42))

:named MonadFull.Class_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0dde81bd2dae218241739a1a2c115d81
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__return; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-12,13); use=MonadFull.Class.fst(11,14-12,20)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFull.Class_interpretation_Tm_arrow_0dde81bd2dae218241739a1a2c115d81.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_0dde81bd2dae218241739a1a2c115d81 @x1)))
:qid MonadFull.Class_interpretation_Tm_arrow_0dde81bd2dae218241739a1a2c115d81))

:named MonadFull.Class_interpretation_Tm_arrow_0dde81bd2dae218241739a1a2c115d81))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_07115a929c8dc0a3043b474e1e463a52
;;; Fact-ids: Name MonadFull.Class.__proj__Mkmonad__item__bind; Namespace MonadFull.Class
(assert (! 
;; def=MonadFull.Class.fst(11,14-13,51); use=MonadFull.Class.fst(11,14-13,51)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid MonadFull.Class_interpretation_Tm_arrow_07115a929c8dc0a3043b474e1e463a52.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_07115a929c8dc0a3043b474e1e463a52))
:qid MonadFull.Class_interpretation_Tm_arrow_07115a929c8dc0a3043b474e1e463a52))

:named MonadFull.Class_interpretation_Tm_arrow_07115a929c8dc0a3043b474e1e463a52))
...
@x4)
@x5))
:qid MonadFull.Class_interpretation_Tm_arrow_0343debff6b5862c3d3aa654609340e8.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid MonadFull.Class_interpretation_Tm_arrow_0343debff6b5862c3d3aa654609340e8.2))
))
...
@x2
@x3)))
:qid MonadFull.Class_interpretation_Tm_arrow_0343debff6b5862c3d3aa654609340e8))

:named MonadFull.Class_interpretation_Tm_arrow_0343debff6b5862c3d3aa654609340e8))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name MonadFull.Class.return; Namespace MonadFull.Class
(assert (! (Valid (ApplyTT __uu__PartialApp
MonadFull.Class.__proj__Mkmonad__item__return@tok))
:named @kick_partial_app_c568e4bf8f8876d58bafb8d8aa395e84))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name MonadFull.Class.bind; Namespace MonadFull.Class
(assert (! (Valid (ApplyTT __uu__PartialApp
MonadFull.Class.__proj__Mkmonad__item__bind@tok))
:named @kick_partial_app_0d6650826b38354fd37843f96ec872e9))
(push) ;; push{2

; Starting query at MonadFull.Class.fst(23,2-26,32)
...
;;; Fact-ids: 
(assert (! 
;; def=MonadFull.Class.fst(22,42-22,44); use=MonadFull.Class.fst(22,42-22,50)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 @x2)))
:qid MonadFull.Class_pre_typing_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))

:named MonadFull.Class_pre_typing_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFull.Class_interpretation_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 @x1)))
:qid MonadFull.Class_interpretation_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))

:named MonadFull.Class_interpretation_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))

;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
MonadFull.Class.return@tok))
:named @kick_partial_app_5b8ed04679a12b2e8d20506ca5179056))
...
;;; Fact-ids: 
(assert (! 
;; def=MonadFull.Class.fst(13,40-22,44); use=MonadFull.Class.fst(22,42-25,8)
(forall ((@x0 Term) (@x1 Term))
...
(Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x2
@x3)))
:qid MonadFull.Class_pre_typing_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))

:named MonadFull.Class_pre_typing_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))
...
:pattern ((ApplyTT @x0
@x3))
:qid MonadFull.Class_interpretation_Tm_arrow_8c46a296e41552271b43886f97a4b7b1.1))
...
(Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x1
@x2)))
:qid MonadFull.Class_interpretation_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))

:named MonadFull.Class_interpretation_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))
(declare-fun Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8
;;; Fact-ids: 
(assert (! 
;; def=MonadFull.Class.fst(25,69-25,81); use=MonadFull.Class.fst(25,2-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8 @x0
@x1
@x2
@x3)
(Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x2
...
:pattern ((Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8 @x0
@x1
@x2
@x3))
:qid typing_Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8))

:named typing_Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8
;;; Fact-ids: 
(assert (! 
;; def=MonadFull.Class.fst(25,69-25,81); use=MonadFull.Class.fst(25,2-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8 @x1
@x2
@x3
@x4)
@x0)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT MonadFull.Class.return@tok
@x3)
@x1)
@x4)
(ApplyTT @x2
...
:pattern ((ApplyTT (Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8 @x1
@x2
@x3
@x4)
@x0))
:qid interpretation_Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8))

:named interpretation_Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
MonadFull.Class.bind@tok))
:named @kick_partial_app_eed67d3867a715ac32f3289d9d7ab824))

(declare-fun Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7
;;; Fact-ids: 
(assert (! 
;; def=MonadFull.Class.fst(25,39-25,82); use=MonadFull.Class.fst(25,2-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7 @x0
@x1
@x2
@x3
@x4)
(Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x3
@x4))
 

:pattern ((Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7 @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7))

:named typing_Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7
;;; Fact-ids: 
(assert (! 
;; def=MonadFull.Class.fst(25,39-25,82); use=MonadFull.Class.fst(25,2-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7 @x1
@x2
@x3
@x4
@x5)
@x0)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT MonadFull.Class.bind@tok
@x4)
@x1)
@x5)
@x5)
...
(ApplyTT @x2
@x0)))
(Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8 @x1
@x3
@x4
@x5)))
 

:pattern ((ApplyTT (Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7 @x1
@x2
@x3
@x4
@x5)
@x0))
:qid interpretation_Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7))

:named interpretation_Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7))
...
;     _.bind (_.return x)
;       (fun y ->
;           MonadFull.Class.bind (MonadFull.Class.return (f y))
;             (fun z -> MonadFull.Class.return (g z))) ==
;     MonadFull.Class.bind (MonadFull.Class.return (f x)) (fun z -> MonadFull.Class.return (g z)) ==>
;     (forall (pure_result: Prims.unit).
;         _.bind (_.return (f x)) (fun z -> MonadFull.Class.return (g z)) ==
;         MonadFull.Class.return (g (f x)) ==>
;         MonadFull.Class.bind (MonadFull.Class.return x)
;           (fun y ->
;               MonadFull.Class.bind (MonadFull.Class.return (f y))
;                 (fun z -> MonadFull.Class.return (g z))) ==
;         MonadFull.Class.return (g (f x)))
...
;; def=Prims.fst(441,36-441,97); use=MonadFull.Class.fst(23,2-23,5)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=MonadFull.Class.fst(14,56-14,82); use=MonadFull.Class.fst(23,2-23,5)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT MonadFull.Class.__proj__Mkmonad__item__bind@tok
@x1)
@x2)
@x0)
@x0)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT MonadFull.Class.__proj__Mkmonad__item__return@tok
@x1)
@x2)
@x0)
@x3))
(Tm_abs_ff33fbd4502a9cdd3278beb005bb5eb7 @x2
@x4
@x5
@x1
@x0))
...
(ApplyTT @x4
@x3)))
(Tm_abs_664c74f23ee0ab2f99212cb6f311d6f8 @x2
@x5
@x1
@x0)))
)

;; def=Prims.fst(441,36-441,97); use=MonadFull.Class.fst(24,2-24,5)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=MonadFull.Class.fst(14,56-14,82); use=MonadFull.Class.fst(24,2-24,5)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT MonadFull.Class.__proj__Mkmonad__item__bind@tok
@x1)
@x2)
@x0)
...
;; def=MonadFull.Class.fst(25,9-26,32); use=MonadFull.Class.fst(25,2-25,8)
(or label_1
