...
; Internals for Bug2637


; encoding sigelt type Bug2637.prog


; <Start encoding type Bug2637.prog>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2637.prog (Term Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug2637.prog@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2637.P (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2637.P_state_t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2637.P_action_t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2637.P_pre (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2637.P__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2637.P
(declare-fun Bug2637.P@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2637.Q (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2637.Q_state_t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2637.Q_action_t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2637.Q_pre (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2637.Q__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2637.Q
(declare-fun Bug2637.Q@tok () Term)


;;;;;;;;;;;;;;;;_: Prims.bool -> action_t pre
(declare-fun Tm_arrow_c07a27fb814b178fd777d3022707518e (Term Term) Term)


;;;;;;;;;;;;;;;;pre: state_t -> _1: (_: Prims.bool -> action_t pre) -> prog state_t action_t pre
(declare-fun Tm_arrow_fb068bd238d152550ec7e8307f8b367a () Term)


;;;;;;;;;;;;;;;;pre: state_t -> _1: action_t pre -> prog state_t action_t pre
(declare-fun Tm_arrow_3c6affc35293b46348b111ee2f8dacb3 () Term)

; <start constructor Bug2637.prog>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2637.prog ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
106)
(exists ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= __@x0
...
; </end constructor Bug2637.prog>


; <start constructor Bug2637.P>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2637.P ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
117)
(= __@x0
(Bug2637.P (Bug2637.P_state_t __@x0)
(Bug2637.P_action_t __@x0)
(Bug2637.P_pre __@x0)
(Bug2637.P__1 __@x0)))))

; </end constructor Bug2637.P>


; <start constructor Bug2637.Q>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2637.Q ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
129)
(= __@x0
(Bug2637.Q (Bug2637.Q_state_t __@x0)
(Bug2637.Q_action_t __@x0)
(Bug2637.Q_pre __@x0)
(Bug2637.Q__1 __@x0)))))

; </end constructor Bug2637.Q>


; </end encoding type Bug2637.prog>


; encoding sigelt val Bug2637.uu___is_P


; <Start encoding val Bug2637.uu___is_P>


(declare-fun Bug2637.uu___is_P (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: prog state_t action_t _ -> Prims.bool
(declare-fun Tm_arrow_1be825d7e7540ca0b29f1fe64f20446a () Term)
(declare-fun Bug2637.uu___is_P@tok () Term)

; </end encoding val Bug2637.uu___is_P>


; encoding sigelt let uu___is_P


; <Skipped let uu___is_P/>


; encoding sigelt val Bug2637.__proj__P__item__pre


; <Start encoding val Bug2637.__proj__P__item__pre>


(declare-fun Tm_refine_ff30dfd30b652659f77c50fd186a90c0 (Term Term Term) Term)
(declare-fun Bug2637.__proj__P__item__pre (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: prog state_t action_t _ {P? _} -> state_t
(declare-fun Tm_arrow_439d4bc444bcb6eedf4634a113a4af1d () Term)
(declare-fun Bug2637.__proj__P__item__pre@tok () Term)

; </end encoding val Bug2637.__proj__P__item__pre>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2637.uu___is_P; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((Bug2637.uu___is_P @x0
@x1
@x2
@x3))
:qid typing_Bug2637.uu___is_P))

:named typing_Bug2637.uu___is_P))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(4,5-4,9); use=Bug2637.fst(4,5-4,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Bug2637.prog@tok
@x0)
@x1)
@x2)
(Bug2637.prog @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Bug2637.prog@tok
@x0)
@x1)
@x2))

:pattern ((Bug2637.prog @x0
@x1
@x2))
:qid token_correspondence_Bug2637.prog@tok))

:named token_correspondence_Bug2637.prog@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
...
@x6
@x7)))
:qid subterm_ordering_Bug2637.Q))

:named subterm_ordering_Bug2637.Q))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
...
@x6
@x7)))
:qid subterm_ordering_Bug2637.P))

:named subterm_ordering_Bug2637.P))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug2637.__proj__P__item__pre; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_ff30dfd30b652659f77c50fd186a90c0 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_ff30dfd30b652659f77c50fd186a90c0 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_ff30dfd30b652659f77c50fd186a90c0))

:named refinement_kinding_Tm_refine_ff30dfd30b652659f77c50fd186a90c0))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ff30dfd30b652659f77c50fd186a90c0 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
(BoxBool_proj_0 (Bug2637.uu___is_P @x2
@x3
@x4
@x1))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_ff30dfd30b652659f77c50fd186a90c0))

:named refinement_interpretation_Tm_refine_ff30dfd30b652659f77c50fd186a90c0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! 
...
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2637.Q_state_t (Bug2637.Q @x0
@x1
@x2
@x3))
@x0)
...
:pattern ((Bug2637.Q @x0
@x1
@x2
@x3))
:qid projection_inverse_Bug2637.Q_state_t))

:named projection_inverse_Bug2637.Q_state_t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2637.Q_pre (Bug2637.Q @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Bug2637.Q_pre))

:named projection_inverse_Bug2637.Q_pre))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2637.Q_action_t (Bug2637.Q @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Bug2637.Q_action_t))

:named projection_inverse_Bug2637.Q_action_t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2637.Q__1 (Bug2637.Q @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_Bug2637.Q__1))

:named projection_inverse_Bug2637.Q__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2637.P_state_t (Bug2637.P @x0
@x1
@x2
@x3))
@x0)
...
:pattern ((Bug2637.P @x0
@x1
@x2
@x3))
:qid projection_inverse_Bug2637.P_state_t))

:named projection_inverse_Bug2637.P_state_t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2637.P_pre (Bug2637.P @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Bug2637.P_pre))

:named projection_inverse_Bug2637.P_pre))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2637.P_action_t (Bug2637.P @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Bug2637.P_action_t))

:named projection_inverse_Bug2637.P_action_t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2637.P__1 (Bug2637.P @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_Bug2637.P__1))

:named projection_inverse_Bug2637.P__1))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! (is-Tm_arrow (PreType Bug2637.prog@tok))
:named pre_kinding_Bug2637.prog@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c07a27fb814b178fd777d3022707518e
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,21-5,41); use=Bug2637.fst(5,21-5,41)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_c07a27fb814b178fd777d3022707518e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_c07a27fb814b178fd777d3022707518e @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_c07a27fb814b178fd777d3022707518e))

:named kinding_Tm_arrow_c07a27fb814b178fd777d3022707518e))
...
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! (and (IsTotFun Bug2637.prog@tok)

;; def=Bug2637.fst(4,5-4,9); use=Bug2637.fst(4,5-4,9)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Bug2637.prog@tok
@x0))
 

:pattern ((ApplyTT Bug2637.prog@tok
@x0))
:qid kinding_Bug2637.prog@tok))


;; def=Bug2637.fst(4,5-4,9); use=Bug2637.fst(4,5-4,9)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (ApplyTT (ApplyTT Bug2637.prog@tok
@x0)
@x1))
 

:pattern ((ApplyTT (ApplyTT Bug2637.prog@tok
@x0)
@x1))
:qid kinding_Bug2637.prog@tok.1))
...
@x1
@x2))
:qid kinding_Bug2637.prog@tok.2))
)
:named kinding_Bug2637.prog@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ff30dfd30b652659f77c50fd186a90c0
;;; Fact-ids: Name Bug2637.__proj__P__item__pre; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ff30dfd30b652659f77c50fd186a90c0 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Bug2637.prog @x0
@x1
@x2))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ff30dfd30b652659f77c50fd186a90c0 @x0
@x1
@x2))))
:qid haseqTm_refine_ff30dfd30b652659f77c50fd186a90c0))

:named haseqTm_refine_ff30dfd30b652659f77c50fd186a90c0))
...
@x3
@x4))
(or (and (is-Bug2637.P @x1)
(= @x2
(Bug2637.P_state_t @x1))
(= @x3
(Bug2637.P_action_t @x1))
(= @x4
(Bug2637.P_pre @x1)))
(and (is-Bug2637.Q @x1)
(= @x2
(Bug2637.Q_state_t @x1))
(= @x3
(Bug2637.Q_action_t @x1))
(= @x4
(Bug2637.Q_pre @x1)))))
...
@x3
@x4)))
:qid fuel_guarded_inversion_Bug2637.prog))

:named fuel_guarded_inversion_Bug2637.prog))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! (= 107
(Term_constr_id Bug2637.prog@tok))
:named fresh_token_Bug2637.prog@tok))
...
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2637.uu___is_P @x0
@x1
@x2
@x3)
(BoxBool (is-Bug2637.P @x3)))
...
@x2
@x3))
:qid disc_equation_Bug2637.P))

:named disc_equation_Bug2637.P))
...
@x2
@x5)))
:qid data_typing_intro_Bug2637.Q@tok))

:named data_typing_intro_Bug2637.Q@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
...
(HasTypeFuel @u0
@x4
(Tm_arrow_c07a27fb814b178fd777d3022707518e @x3
@x2))
(= @x3
@x5))
(HasTypeFuel @u0
...
@x2
@x5)))
:qid data_typing_intro_Bug2637.P@tok))

:named data_typing_intro_Bug2637.P@tok))
...
@x6
@x7)))
:qid data_elim_Bug2637.Q))

:named data_elim_Bug2637.Q))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
...
@x6
@x7)))
:qid data_elim_Bug2637.P))

:named data_elim_Bug2637.P))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 106
(Term_constr_id (Bug2637.prog @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_Bug2637.prog))

:named constructor_distinct_Bug2637.prog))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
...
@x2
@x3))
:qid constructor_distinct_Bug2637.Q))

:named constructor_distinct_Bug2637.Q))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
...
@x2
@x3))
:qid constructor_distinct_Bug2637.P))

:named constructor_distinct_Bug2637.P))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x3
@x4)))
:qid Bug2637_pretyping_6355cc1d0f8009e6f18337c9d8cc1305))

:named Bug2637_pretyping_6355cc1d0f8009e6f18337c9d8cc1305))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,21-5,41); use=Bug2637.fst(5,21-5,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_c07a27fb814b178fd777d3022707518e @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_c07a27fb814b178fd777d3022707518e @x2
@x3)))
:qid Bug2637_pre_typing_Tm_arrow_c07a27fb814b178fd777d3022707518e))

:named Bug2637_pre_typing_Tm_arrow_c07a27fb814b178fd777d3022707518e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c07a27fb814b178fd777d3022707518e
;;; Fact-ids: Name Bug2637.prog; Namespace Bug2637; Name Bug2637.P; Namespace Bug2637; Name Bug2637.Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(5,21-5,41); use=Bug2637.fst(5,21-5,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_c07a27fb814b178fd777d3022707518e @x1
@x2))
(and 
;; def=Bug2637.fst(5,21-5,41); use=Bug2637.fst(5,21-5,41)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid Bug2637_interpretation_Tm_arrow_c07a27fb814b178fd777d3022707518e.1))
...
(Tm_arrow_c07a27fb814b178fd777d3022707518e @x1
@x2)))
:qid Bug2637_interpretation_Tm_arrow_c07a27fb814b178fd777d3022707518e))

:named Bug2637_interpretation_Tm_arrow_c07a27fb814b178fd777d3022707518e))
(push) ;; push{2

; Starting query at Bug2637.fst(5,8-5,11)

(declare-fun label_1 () Bool)



; Encoding query formula : forall (state_t: Type)
;   (action_t: (_: state_t -> Type))
;   (_: state_t)
;   (projectee: _: Bug2637.prog state_t action_t _ {P? _}).
;   (*  - Could not prove post-condition
; *) ~(P? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__P__item__pre`
...
@x0)
(HasType @x3
(Tm_refine_ff30dfd30b652659f77c50fd186a90c0 @x0
@x1
@x2))

;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,8-5,11)
(not 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,8-5,11)
(BoxBool_proj_0 (Bug2637.uu___is_P @x0
@x1
@x2
@x3))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2637.__proj__P__item__pre, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_ff30dfd30b652659f77c50fd186a90c0
...
; encoding sigelt let __proj__P__item__pre


; <Skipped let __proj__P__item__pre/>


; encoding sigelt val Bug2637.__proj__P__item___1


; <Start encoding val Bug2637.__proj__P__item___1>



(declare-fun Bug2637.__proj__P__item___1 (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;_: Prims.bool -> action_t projectee.pre
(declare-fun Tm_arrow_8be285e1ec36c0534839395045314f3f (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: _: prog state_t action_t _ {P? _} -> _: Prims.bool -> action_t projectee.pre
(declare-fun Tm_arrow_3298a800238d72cecd44faa2ea868b19 () Term)
(declare-fun Bug2637.__proj__P__item___1@tok () Term)


; </end encoding val Bug2637.__proj__P__item___1>
...
; *)
;   (~(P? projectee) ==> Prims.l_False) /\
;   (forall (b: state_t) (b: (_: Prims.bool -> action_t b)).
;       projectee == Bug2637.P b b ==>
;       (forall (_: Prims.bool).
;           (*  - Subtyping check failed
;   - Expected type _: prog state_t action_t _ {P? _}
;     got type prog state_t action_t pre
; *)
;           b == _ /\ P? (Bug2637.P b b)))


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__P__item___1`
...
(Tm_arrow_c07a27fb814b178fd777d3022707518e @x4
@x1))
...
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,21-5,41)
(and 
;; def=Bug2637.fst(5,4-5,5); use=Bug2637.fst(5,4-5,5)
(or label_2

;; def=dummy(0,0-0,0); use=Bug2637.fst(5,21-5,41)
(= @x4
@x2)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2637.__proj__P__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Bug2637.P, refinement_interpretation_Tm_refine_ff30dfd30b652659f77c50fd186a90c0
...
; encoding sigelt let __proj__P__item___1


; <Skipped let __proj__P__item___1/>


; encoding sigelt val Bug2637.uu___is_Q


; <Start encoding val Bug2637.uu___is_Q>


(declare-fun Bug2637.uu___is_Q (Term Term Term Term) Term)


(declare-fun Bug2637.uu___is_Q@tok () Term)

; </end encoding val Bug2637.uu___is_Q>


; encoding sigelt let uu___is_Q


; <Skipped let uu___is_Q/>


; encoding sigelt val Bug2637.__proj__Q__item__pre


; <Start encoding val Bug2637.__proj__Q__item__pre>


(declare-fun Tm_refine_7c82371b6868ea121d6179df8a5010ed (Term Term Term) Term)
(declare-fun Bug2637.__proj__Q__item__pre (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: prog state_t action_t _ {Q? _} -> state_t
(declare-fun Tm_arrow_6207a88d96663d79a8220d020cc578fa () Term)
(declare-fun Bug2637.__proj__Q__item__pre@tok () Term)

; </end encoding val Bug2637.__proj__Q__item__pre>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2637.uu___is_Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
...
:pattern ((Bug2637.uu___is_Q @x0
@x1
@x2
@x3))
:qid typing_Bug2637.uu___is_Q))

:named typing_Bug2637.uu___is_Q))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug2637.__proj__Q__item__pre; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_7c82371b6868ea121d6179df8a5010ed @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_7c82371b6868ea121d6179df8a5010ed @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_7c82371b6868ea121d6179df8a5010ed))

:named refinement_kinding_Tm_refine_7c82371b6868ea121d6179df8a5010ed))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug2637.__proj__Q__item__pre; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7c82371b6868ea121d6179df8a5010ed @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(BoxBool_proj_0 (Bug2637.uu___is_Q @x2
@x3
@x4
@x1))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_7c82371b6868ea121d6179df8a5010ed))

:named refinement_interpretation_Tm_refine_7c82371b6868ea121d6179df8a5010ed))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7c82371b6868ea121d6179df8a5010ed
;;; Fact-ids: Name Bug2637.__proj__Q__item__pre; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7c82371b6868ea121d6179df8a5010ed @x0
@x1
@x2)))
(Valid (Prims.hasEq (Bug2637.prog @x0
@x1
...
:pattern ((Valid (Prims.hasEq (Tm_refine_7c82371b6868ea121d6179df8a5010ed @x0
@x1
@x2))))
:qid haseqTm_refine_7c82371b6868ea121d6179df8a5010ed))

:named haseqTm_refine_7c82371b6868ea121d6179df8a5010ed))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug2637.uu___is_Q; Namespace Bug2637
(assert (! 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2637.uu___is_Q @x0
@x1
@x2
@x3)
(BoxBool (is-Bug2637.Q @x3)))
...
@x2
@x3))
:qid disc_equation_Bug2637.Q))

:named disc_equation_Bug2637.Q))
(push) ;; push{2

; Starting query at Bug2637.fst(6,8-6,11)
...
;   (action_t: (_: state_t -> Type))
;   (_: state_t)
;   (projectee: _: Bug2637.prog state_t action_t _ {Q? _}).
;   (*  - Could not prove post-condition
; *) ~(Q? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Q__item__pre`
...
@x0)
(HasType @x3
(Tm_refine_7c82371b6868ea121d6179df8a5010ed @x0
@x1
@x2))

;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,8-6,11)
(not 
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,8-6,11)
(BoxBool_proj_0 (Bug2637.uu___is_Q @x0
@x1
@x2
@x3))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2637.__proj__Q__item__pre, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_7c82371b6868ea121d6179df8a5010ed
...
; encoding sigelt let __proj__Q__item__pre


; <Skipped let __proj__Q__item__pre/>


; encoding sigelt val Bug2637.__proj__Q__item___1


; <Start encoding val Bug2637.__proj__Q__item___1>



(declare-fun Bug2637.__proj__Q__item___1 (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: prog state_t action_t _ {Q? _} -> action_t projectee.pre
(declare-fun Tm_arrow_0b80d14b528196feeed69bab908e78ea () Term)
(declare-fun Bug2637.__proj__Q__item___1@tok () Term)

; </end encoding val Bug2637.__proj__Q__item___1>
...
; *)
;   (~(Q? projectee) ==> Prims.l_False) /\
;   (forall (b: state_t) (b: action_t b). projectee == Bug2637.Q b b ==> b == _ /\ Q? (Bug2637.Q b b))


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Q__item___1`
...
;; def=Bug2637.fst(6,4-6,5); use=Bug2637.fst(6,4-6,5)
(and 
;; def=dummy(0,0-0,0); use=Bug2637.fst(6,4-6,5)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2637.__proj__Q__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Bug2637.Q, refinement_interpretation_Tm_refine_7c82371b6868ea121d6179df8a5010ed
