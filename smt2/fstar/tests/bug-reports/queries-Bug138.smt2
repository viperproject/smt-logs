...
; Internals for Bug138


; encoding sigelt val Bug138.foo


; <Skipped val Bug138.foo/>


; encoding sigelt val Bug138.bar


; <Skipped val Bug138.bar/>
...
; Starting query at Bug138.fst(21,16-23,21)
...
(declare-fun Tm_refine_8f271cb216aca0dd741acbc74e219a6d () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_8f271cb216aca0dd741acbc74e219a6d
Tm_type)
:named refinement_kinding_Tm_refine_8f271cb216aca0dd741acbc74e219a6d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(20,10-23,21); use=Bug138.fst(20,10-23,21)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_8f271cb216aca0dd741acbc74e219a6d)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=Bug138.fst(20,10-23,21); use=Bug138.fst(20,45-23,21)

;; def=Bug138.fst(20,10-23,21); use=Bug138.fst(20,45-23,21)
(or 
;; def=Bug138.fst(21,16-23,21); use=Bug138.fst(21,16-23,21)
(Valid 
;; def=Bug138.fst(21,16-23,21); use=Bug138.fst(21,16-23,21)
...
;; def=Bug138.fst(20,10-23,21); use=Bug138.fst(20,45-23,21)
(and 
;; def=Bug138.fst(20,10-21,13); use=Bug138.fst(20,45-21,13)
(Valid 
;; def=Bug138.fst(20,10-21,13); use=Bug138.fst(20,45-21,13)
...
@x1
Tm_refine_8f271cb216aca0dd741acbc74e219a6d))
:qid refinement_interpretation_Tm_refine_8f271cb216aca0dd741acbc74e219a6d))

:named refinement_interpretation_Tm_refine_8f271cb216aca0dd741acbc74e219a6d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8f271cb216aca0dd741acbc74e219a6d
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_8f271cb216aca0dd741acbc74e219a6d))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_8f271cb216aca0dd741acbc74e219a6d))
(declare-fun Bug138.bar (Term) Term)

;;;;;;;;;;;;;;;;l: Prims.list Prims.int {l << l \/ l === l /\ 1 << 0} -> Prims.Tot Prims.int
(declare-fun Tm_arrow_3e0b74b93e9122732f55811434f6beb5 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3e0b74b93e9122732f55811434f6beb5
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3e0b74b93e9122732f55811434f6beb5
Tm_type)
:named kinding_Tm_arrow_3e0b74b93e9122732f55811434f6beb5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(20,10-23,21); use=Bug138.fst(20,10-24,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3e0b74b93e9122732f55811434f6beb5)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_3e0b74b93e9122732f55811434f6beb5))
:qid Bug138_pre_typing_Tm_arrow_3e0b74b93e9122732f55811434f6beb5))

:named Bug138_pre_typing_Tm_arrow_3e0b74b93e9122732f55811434f6beb5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3e0b74b93e9122732f55811434f6beb5
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(20,10-23,21); use=Bug138.fst(20,10-24,7)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug138_interpretation_Tm_arrow_3e0b74b93e9122732f55811434f6beb5.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_3e0b74b93e9122732f55811434f6beb5))
:qid Bug138_interpretation_Tm_arrow_3e0b74b93e9122732f55811434f6beb5))

:named Bug138_interpretation_Tm_arrow_3e0b74b93e9122732f55811434f6beb5))
(declare-fun Bug138.bar@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(24,4-24,7); use=Bug138.fst(24,4-24,7)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug138.bar@tok
@x0)
(Bug138.bar @x0))
 

:pattern ((ApplyTT Bug138.bar@tok
@x0))
:qid token_correspondence_Bug138.bar))

:named token_correspondence_Bug138.bar))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(24,4-24,7); use=Bug138.fst(24,4-24,7)
...
:pattern ((Bug138.bar @x1))
:qid function_token_typing_Bug138.bar.1))
)
 

:pattern ((ApplyTT @x0
Bug138.bar@tok))
:qid function_token_typing_Bug138.bar))

:named function_token_typing_Bug138.bar))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(24,4-24,7); use=Bug138.fst(24,4-24,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_8f271cb216aca0dd741acbc74e219a6d)
(HasType (Bug138.bar @x0)
Prims.int))
 

:pattern ((Bug138.bar @x0))
:qid typing_Bug138.bar))

:named typing_Bug138.bar))
(declare-fun Tm_refine_5fce7013cb87426c8e7a63a468270d87 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_5fce7013cb87426c8e7a63a468270d87
Tm_type)
:named refinement_kinding_Tm_refine_5fce7013cb87426c8e7a63a468270d87))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(19,10-23,21); use=Bug138.fst(19,10-23,21)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_5fce7013cb87426c8e7a63a468270d87)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=Bug138.fst(19,10-23,21); use=Bug138.fst(19,45-23,21)
...
;; def=Bug138.fst(19,10-23,21); use=Bug138.fst(19,45-23,21)
(and 
;; def=Bug138.fst(19,10-21,13); use=Bug138.fst(19,45-21,13)
(Valid 
;; def=Bug138.fst(19,10-21,13); use=Bug138.fst(19,45-21,13)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.int)
(Prims.list Prims.int)
...
@x1
Tm_refine_5fce7013cb87426c8e7a63a468270d87))
:qid refinement_interpretation_Tm_refine_5fce7013cb87426c8e7a63a468270d87))

:named refinement_interpretation_Tm_refine_5fce7013cb87426c8e7a63a468270d87))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5fce7013cb87426c8e7a63a468270d87
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_5fce7013cb87426c8e7a63a468270d87))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_5fce7013cb87426c8e7a63a468270d87))
(declare-fun Bug138.foo (Term) Term)

;;;;;;;;;;;;;;;;l: Prims.list Prims.int {l << l \/ l === l /\ 0 << 0} -> Prims.Tot Prims.int
(declare-fun Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154
Tm_type)
:named kinding_Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(19,10-23,21); use=Bug138.fst(19,10-23,21)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154))
:qid Bug138_pre_typing_Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154))

:named Bug138_pre_typing_Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(19,10-23,21); use=Bug138.fst(19,10-23,21)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug138_interpretation_Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154))
:qid Bug138_interpretation_Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154))

:named Bug138_interpretation_Tm_arrow_fd84c8f7d7f539652ff93b8b8600c154))
(declare-fun Bug138.foo@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(21,8-21,11); use=Bug138.fst(21,8-21,11)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug138.foo@tok
@x0)
(Bug138.foo @x0))
 

:pattern ((ApplyTT Bug138.foo@tok
@x0))
:qid token_correspondence_Bug138.foo))

:named token_correspondence_Bug138.foo))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(21,8-21,11); use=Bug138.fst(21,8-21,11)
...
:pattern ((Bug138.foo @x1))
:qid function_token_typing_Bug138.foo.1))
)
 

:pattern ((ApplyTT @x0
Bug138.foo@tok))
:qid function_token_typing_Bug138.foo))

:named function_token_typing_Bug138.foo))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(21,8-21,11); use=Bug138.fst(21,8-21,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_5fce7013cb87426c8e7a63a468270d87)
(HasType (Bug138.foo @x0)
Prims.int))
 

:pattern ((Bug138.foo @x0))
:qid typing_Bug138.foo))

:named typing_Bug138.foo))
...
;   (~(Nil? l) ==>
;     (forall (b: Prims.int) (b: Prims.list Prims.int). l == b :: b ==> b << l \/ b === l /\ 1 << 0))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec foo and bar`
...
;; def=Prims.fst(402,27-402,88); use=Bug138.fst(21,16-23,21)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug138.fst(21,16-23,21)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug138.fst(21,16-23,21)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Bug138.fst(21,16-23,21)
(and (implies 
;; def=Bug138.fst(21,12-21,13); use=Bug138.fst(21,22-21,23)
(and 
;; def=Bug138.fst(21,12-21,13); use=Bug138.fst(21,22-21,23)
(not 
;; def=Bug138.fst(21,12-21,13); use=Bug138.fst(21,22-21,23)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Bug138.fst(21,16-23,21)
(not 
;; def=Bug138.fst(21,12-21,13); use=Bug138.fst(21,22-21,23)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_66b03f5c7897b05649fed8196554c587_0))
...
;; def=Prims.fst(413,99-413,120); use=Bug138.fst(21,16-23,21)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=Bug138.fst(21,12-23,11); use=Bug138.fst(21,22-23,11)
(= x_66b03f5c7897b05649fed8196554c587_0
...
;; def=Bug138.fst(20,10-23,21); use=Bug138.fst(23,19-23,21)
(or label_2

;; def=Bug138.fst(21,16-23,21); use=Bug138.fst(23,19-23,21)
(Valid 
;; def=Bug138.fst(21,16-23,21); use=Bug138.fst(23,19-23,21)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=Bug138.fst(20,10-23,21); use=Bug138.fst(23,19-23,21)
(and 
;; def=Bug138.fst(20,10-21,13); use=Bug138.fst(23,19-23,21)
(Valid 
;; def=Bug138.fst(20,10-21,13); use=Bug138.fst(23,19-23,21)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.int)
(Prims.list Prims.int)
...
; Starting query at Bug138.fst(24,12-24,17)
...
(Prims.list Prims.int))
:named binder_x_66b03f5c7897b05649fed8196554c587_0))
(declare-fun Tm_refine_52d2e66a5d284d6699ba5f46e5151778 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_52d2e66a5d284d6699ba5f46e5151778
Tm_type)
:named refinement_kinding_Tm_refine_52d2e66a5d284d6699ba5f46e5151778))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(20,10-24,17); use=Bug138.fst(20,10-24,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_52d2e66a5d284d6699ba5f46e5151778)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=Bug138.fst(20,10-24,17); use=Bug138.fst(20,45-24,17)

;; def=Bug138.fst(20,10-24,17); use=Bug138.fst(20,45-24,17)
(or 
;; def=Bug138.fst(24,12-24,17); use=Bug138.fst(24,12-24,17)
(Valid 
;; def=Bug138.fst(24,12-24,17); use=Bug138.fst(24,12-24,17)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=Bug138.fst(20,10-24,17); use=Bug138.fst(20,45-24,17)
(and 
;; def=Bug138.fst(20,10-24,9); use=Bug138.fst(20,45-24,9)
(Valid 
;; def=Bug138.fst(20,10-24,9); use=Bug138.fst(20,45-24,9)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.int)
(Prims.list Prims.int)
...
@x1
Tm_refine_52d2e66a5d284d6699ba5f46e5151778))
:qid refinement_interpretation_Tm_refine_52d2e66a5d284d6699ba5f46e5151778))

:named refinement_interpretation_Tm_refine_52d2e66a5d284d6699ba5f46e5151778))
;;;;;;;;;;;;;;;;haseq for Tm_refine_52d2e66a5d284d6699ba5f46e5151778
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_52d2e66a5d284d6699ba5f46e5151778))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_52d2e66a5d284d6699ba5f46e5151778))
(declare-fun Bug138.bar (Term) Term)

;;;;;;;;;;;;;;;;l: Prims.list Prims.int {l << l \/ l === l /\ 1 << 1} -> Prims.Tot Prims.int
(declare-fun Tm_arrow_d7764267850fa1a949f8855934000cf7 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d7764267850fa1a949f8855934000cf7
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_d7764267850fa1a949f8855934000cf7
Tm_type)
:named kinding_Tm_arrow_d7764267850fa1a949f8855934000cf7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(20,10-24,17); use=Bug138.fst(20,10-24,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d7764267850fa1a949f8855934000cf7)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_d7764267850fa1a949f8855934000cf7))
:qid Bug138_pre_typing_Tm_arrow_d7764267850fa1a949f8855934000cf7))

:named Bug138_pre_typing_Tm_arrow_d7764267850fa1a949f8855934000cf7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d7764267850fa1a949f8855934000cf7
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(20,10-24,17); use=Bug138.fst(20,10-24,17)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug138_interpretation_Tm_arrow_d7764267850fa1a949f8855934000cf7.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_d7764267850fa1a949f8855934000cf7))
:qid Bug138_interpretation_Tm_arrow_d7764267850fa1a949f8855934000cf7))

:named Bug138_interpretation_Tm_arrow_d7764267850fa1a949f8855934000cf7))
(declare-fun Bug138.bar@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
...
:named typing_Bug138.bar))
(declare-fun Tm_refine_fb3a4f19c58d336d0b81bf7ade1d4c0e () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_fb3a4f19c58d336d0b81bf7ade1d4c0e
Tm_type)
:named refinement_kinding_Tm_refine_fb3a4f19c58d336d0b81bf7ade1d4c0e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(19,10-24,17); use=Bug138.fst(19,10-24,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_fb3a4f19c58d336d0b81bf7ade1d4c0e)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=Bug138.fst(19,10-24,17); use=Bug138.fst(19,45-24,17)
...
;; def=Bug138.fst(19,10-24,17); use=Bug138.fst(19,45-24,17)
(and 
;; def=Bug138.fst(19,10-24,9); use=Bug138.fst(19,45-24,9)
(Valid 
;; def=Bug138.fst(19,10-24,9); use=Bug138.fst(19,45-24,9)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.int)
(Prims.list Prims.int)
...
@x1
Tm_refine_fb3a4f19c58d336d0b81bf7ade1d4c0e))
:qid refinement_interpretation_Tm_refine_fb3a4f19c58d336d0b81bf7ade1d4c0e))

:named refinement_interpretation_Tm_refine_fb3a4f19c58d336d0b81bf7ade1d4c0e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_fb3a4f19c58d336d0b81bf7ade1d4c0e
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_fb3a4f19c58d336d0b81bf7ade1d4c0e))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_fb3a4f19c58d336d0b81bf7ade1d4c0e))
(declare-fun Bug138.foo (Term) Term)

;;;;;;;;;;;;;;;;l: Prims.list Prims.int {l << l \/ l === l /\ 0 << 1} -> Prims.Tot Prims.int
(declare-fun Tm_arrow_ea90e992085a62c2c1eb4542af49b46a () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ea90e992085a62c2c1eb4542af49b46a
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_ea90e992085a62c2c1eb4542af49b46a
Tm_type)
:named kinding_Tm_arrow_ea90e992085a62c2c1eb4542af49b46a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(19,10-24,17); use=Bug138.fst(19,10-24,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ea90e992085a62c2c1eb4542af49b46a)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_ea90e992085a62c2c1eb4542af49b46a))
:qid Bug138_pre_typing_Tm_arrow_ea90e992085a62c2c1eb4542af49b46a))

:named Bug138_pre_typing_Tm_arrow_ea90e992085a62c2c1eb4542af49b46a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ea90e992085a62c2c1eb4542af49b46a
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(19,10-24,17); use=Bug138.fst(19,10-24,17)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug138_interpretation_Tm_arrow_ea90e992085a62c2c1eb4542af49b46a.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_ea90e992085a62c2c1eb4542af49b46a))
:qid Bug138_interpretation_Tm_arrow_ea90e992085a62c2c1eb4542af49b46a))

:named Bug138_interpretation_Tm_arrow_ea90e992085a62c2c1eb4542af49b46a))
(declare-fun Bug138.foo@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
...
; Encoding query formula : l << l \/ 0 << 1
...
;;; Fact-ids: 
(assert (! (not 
;; def=Bug138.fst(19,10-24,17); use=Bug138.fst(24,16-24,17)
(or label_1

;; def=Bug138.fst(24,12-24,17); use=Bug138.fst(24,16-24,17)
(Valid 
;; def=Bug138.fst(24,12-24,17); use=Bug138.fst(24,16-24,17)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug138.foo, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, int_typing, projection_inverse_BoxInt_proj_0, well-founded-ordering-on-nat
...
; encoding sigelt let rec foo and bar


; <Start encoding let rec foo and bar>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug138.bar.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug138.bar.fuel_instrumented_token () Term)
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug138.foo.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug138.foo.fuel_instrumented_token () Term)
(declare-fun Bug138.foo (Term) Term)
(declare-fun Bug138.foo@tok () Term)
(declare-fun Bug138.bar (Term) Term)
(declare-fun Bug138.bar@tok () Term)
;;;;;;;;;;;;;;;;l: Prims.list Prims.int -> Prims.Tot Prims.int
(declare-fun Tm_arrow_041f7e33375b506de77fc95f124d6c8b () Term)


; </end encoding let rec foo and bar>


; encoding sigelt type Bug138.arg


; <Start encoding type Bug138.arg>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug138.arg () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug138.Foo () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug138.Foo
(declare-fun Bug138.Foo@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug138.Bar () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug138.Bar
(declare-fun Bug138.Bar@tok () Term)

; <start constructor Bug138.arg>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug138.arg ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
143)
(= __@x0
Bug138.arg)))

; </end constructor Bug138.arg>


; <start constructor Bug138.Foo>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug138.Foo ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
149)
(= __@x0
Bug138.Foo)))

; </end constructor Bug138.Foo>


; <start constructor Bug138.Bar>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug138.Bar ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
151)
(= __@x0
Bug138.Bar)))

; </end constructor Bug138.Bar>


; </end encoding type Bug138.arg>


; encoding sigelt assume Bug138.arg__uu___haseq


; <Start encoding assume Bug138.arg__uu___haseq>


; </end encoding assume Bug138.arg__uu___haseq>


; encoding sigelt val Bug138.uu___is_Foo


; <Start encoding val Bug138.uu___is_Foo>

(declare-fun Bug138.uu___is_Foo (Term) Term)
;;;;;;;;;;;;;;;;projectee: arg -> Prims.bool
(declare-fun Tm_arrow_49067b7fbf73ea52b7860931bbaacf0b () Term)
(declare-fun Bug138.uu___is_Foo@tok () Term)

; </end encoding val Bug138.uu___is_Foo>


; encoding sigelt let uu___is_Foo


; <Skipped let uu___is_Foo/>


; encoding sigelt val Bug138.uu___is_Bar


; <Start encoding val Bug138.uu___is_Bar>

(declare-fun Bug138.uu___is_Bar (Term) Term)

(declare-fun Bug138.uu___is_Bar@tok () Term)

; </end encoding val Bug138.uu___is_Bar>


; encoding sigelt let uu___is_Bar


; <Skipped let uu___is_Bar/>


; encoding sigelt val Bug138.arg_precede


; <Skipped val Bug138.arg_precede/>

;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! (HasType Bug138.Foo@tok
Bug138.arg)
:named typing_tok_Bug138.Foo@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! (HasType Bug138.Bar@tok
Bug138.arg)
:named typing_tok_Bug138.Bar@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.nat; Namespace Prims
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug138.uu___is_Foo; Namespace Bug138
(assert (! 
;; def=Bug138.fst(28,4-28,7); use=Bug138.fst(28,4-28,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug138.arg)
(HasType (Bug138.uu___is_Foo @x0)
Prims.bool))
 

:pattern ((Bug138.uu___is_Foo @x0))
:qid typing_Bug138.uu___is_Foo))

:named typing_Bug138.uu___is_Foo))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug138.uu___is_Bar; Namespace Bug138
(assert (! 
;; def=Bug138.fst(29,4-29,7); use=Bug138.fst(29,4-29,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug138.arg)
(HasType (Bug138.uu___is_Bar @x0)
Prims.bool))
 

:pattern ((Bug138.uu___is_Bar @x0))
:qid typing_Bug138.uu___is_Bar))

:named typing_Bug138.uu___is_Bar))
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! (HasType Bug138.arg
Tm_type)
:named kinding_Bug138.arg@tok))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! (HasType Prims.nat
Tm_type)
...
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! 
;; def=Bug138.fst(27,5-27,8); use=Bug138.fst(27,5-27,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Bug138.arg)
...
@x1
Bug138.arg))
:qid fuel_guarded_inversion_Bug138.arg))

:named fuel_guarded_inversion_Bug138.arg))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! (= Bug138.Foo@tok
Bug138.Foo)
:named equality_tok_Bug138.Foo@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! (= Bug138.Bar@tok
Bug138.Bar)
:named equality_tok_Bug138.Bar@tok))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug138.uu___is_Foo; Namespace Bug138
(assert (! 
;; def=Bug138.fst(28,4-28,7); use=Bug138.fst(28,4-28,7)
(forall ((@x0 Term))
 (! (= (Bug138.uu___is_Foo @x0)
(BoxBool (is-Bug138.Foo @x0)))
 

:pattern ((Bug138.uu___is_Foo @x0))
:qid disc_equation_Bug138.Foo))

:named disc_equation_Bug138.Foo))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug138.uu___is_Bar; Namespace Bug138
(assert (! 
;; def=Bug138.fst(29,4-29,7); use=Bug138.fst(29,4-29,7)
(forall ((@x0 Term))
 (! (= (Bug138.uu___is_Bar @x0)
(BoxBool (is-Bug138.Bar @x0)))
 

:pattern ((Bug138.uu___is_Bar @x0))
:qid disc_equation_Bug138.Bar))

:named disc_equation_Bug138.Bar))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! 
;; def=Bug138.fst(28,4-28,7); use=Bug138.fst(28,4-28,7)
...
Bug138.Foo
Bug138.arg))
:qid data_typing_intro_Bug138.Foo@tok))

:named data_typing_intro_Bug138.Foo@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! 
;; def=Bug138.fst(29,4-29,7); use=Bug138.fst(29,4-29,7)
...
Bug138.Bar
Bug138.arg))
:qid data_typing_intro_Bug138.Bar@tok))

:named data_typing_intro_Bug138.Bar@tok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! (= 143
(Term_constr_id Bug138.arg))
:named constructor_distinct_Bug138.arg))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! (= 149
(Term_constr_id Bug138.Foo))
:named constructor_distinct_Bug138.Foo))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! (= 151
(Term_constr_id Bug138.Bar))
:named constructor_distinct_Bug138.Bar))
;;;;;;;;;;;;;;;;Assumption: Bug138.arg__uu___haseq
;;; Fact-ids: Name Bug138.arg__uu___haseq; Namespace Bug138
(assert (! (Valid (Prims.hasEq Bug138.arg))
:named assumption_Bug138.arg__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug138.arg; Namespace Bug138; Name Bug138.Foo; Namespace Bug138; Name Bug138.Bar; Namespace Bug138
(assert (! 
;; def=Bug138.fst(27,5-27,8); use=Bug138.fst(27,5-27,8)
...
@x0
Bug138.arg))
:qid Bug138_pretyping_b36ed00db7cc6c7168379d56a35933e2))

:named Bug138_pretyping_b36ed00db7cc6c7168379d56a35933e2))
(push) ;; push{2

; Starting query at Bug138.fst(33,2-35,14)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Bug138.arg).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Prims.nat).
;     (forall (x: Prims.nat). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(Foo? a) /\ ~(Bar? a) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let arg_precede`
...
;; def=Prims.fst(402,27-402,88); use=Bug138.fst(33,2-35,14)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug138.fst(33,2-35,14)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug138.fst(33,2-35,14)
(ApplyTT @x1
@x2)
...
;; def=Bug138.fst(32,16-32,17); use=Bug138.fst(33,8-33,9)
(not 
;; def=Bug138.fst(32,16-32,17); use=Bug138.fst(33,8-33,9)
(BoxBool_proj_0 (Bug138.uu___is_Foo @x0))
)
...
(not 
;; def=Bug138.fst(32,16-32,17); use=Bug138.fst(33,8-33,9)
(BoxBool_proj_0 (Bug138.uu___is_Bar @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug138.arg_precede, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Bug138.Bar, disc_equation_Bug138.Foo, fuel_guarded_inversion_Bug138.arg, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let arg_precede


; <Start encoding let arg_precede>

(declare-fun Bug138.arg_precede (Term) Term)
;;;;;;;;;;;;;;;;a: arg -> Prims.nat
(declare-fun Tm_arrow_684f034c2a750be1c565770a9a1fd3e2 () Term)
(declare-fun Bug138.arg_precede@tok () Term)

; </end encoding let arg_precede>


; encoding sigelt val Bug138.foo_bar


; <Skipped val Bug138.foo_bar/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug138.arg_precede; Namespace Bug138
(assert (! 
;; def=Bug138.fst(32,4-32,15); use=Bug138.fst(32,4-32,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug138.arg)
(HasType (Bug138.arg_precede @x0)
Prims.nat))
 

:pattern ((Bug138.arg_precede @x0))
:qid typing_Bug138.arg_precede))

:named typing_Bug138.arg_precede))
;;;;;;;;;;;;;;;;Equation for Bug138.arg_precede
;;; Fact-ids: Name Bug138.arg_precede; Namespace Bug138
(assert (! 
;; def=Bug138.fst(32,4-32,15); use=Bug138.fst(32,4-32,15)
(forall ((@x0 Term))
 (! (= (Bug138.arg_precede @x0)
(let ((@lb1 @x0))
(ite (is-Bug138.Foo @lb1)
(BoxInt 0)
(ite (is-Bug138.Bar @lb1)
(BoxInt 1)
Tm_unit))))
 

:pattern ((Bug138.arg_precede @x0))
:qid equation_Bug138.arg_precede))

:named equation_Bug138.arg_precede))
(push) ;; push{2

; Starting query at Bug138.fst(39,2-44,26)

;;;;;;;;;;;;;;;;a : Bug138.arg (Bug138.arg)
(declare-fun x_b36ed00db7cc6c7168379d56a35933e2_0 () Term)
;;;;;;;;;;;;;;;;binder_x_b36ed00db7cc6c7168379d56a35933e2_0
;;; Fact-ids: 
(assert (! (HasType x_b36ed00db7cc6c7168379d56a35933e2_0
Bug138.arg)
:named binder_x_b36ed00db7cc6c7168379d56a35933e2_0))
;;;;;;;;;;;;;;;;l : Prims.list Prims.int (Prims.list Prims.int)
...
(declare-fun Tm_refine_7bfdc00952137539b32d51b5defd6d7f (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(37,23-44,26); use=Bug138.fst(37,23-44,26)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_7bfdc00952137539b32d51b5defd6d7f @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_7bfdc00952137539b32d51b5defd6d7f @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_7bfdc00952137539b32d51b5defd6d7f))

:named refinement_kinding_Tm_refine_7bfdc00952137539b32d51b5defd6d7f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(37,23-44,26); use=Bug138.fst(37,23-44,26)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7bfdc00952137539b32d51b5defd6d7f @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=Bug138.fst(37,23-44,26); use=Bug138.fst(37,58-44,26)

;; def=Bug138.fst(37,23-44,26); use=Bug138.fst(37,58-44,26)
(or 
;; def=Bug138.fst(39,2-44,26); use=Bug138.fst(39,2-44,26)
(Valid 
;; def=Bug138.fst(39,2-44,26); use=Bug138.fst(39,2-44,26)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=Bug138.fst(37,23-44,26); use=Bug138.fst(37,58-44,26)
(and 
;; def=Bug138.fst(37,23-38,19); use=Bug138.fst(37,58-38,19)
(Valid 
;; def=Bug138.fst(37,23-38,19); use=Bug138.fst(37,58-38,19)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.int)
(Prims.list Prims.int)
...
Prims.nat
(Bug138.arg_precede @x2)
(Bug138.arg_precede x_b36ed00db7cc6c7168379d56a35933e2_0))
)
)
)
...
@x1
(Tm_refine_7bfdc00952137539b32d51b5defd6d7f @x2)))
:qid refinement_interpretation_Tm_refine_7bfdc00952137539b32d51b5defd6d7f))

:named refinement_interpretation_Tm_refine_7bfdc00952137539b32d51b5defd6d7f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7bfdc00952137539b32d51b5defd6d7f
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(37,23-44,26); use=Bug138.fst(37,23-44,26)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7bfdc00952137539b32d51b5defd6d7f @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7bfdc00952137539b32d51b5defd6d7f @x0))))
:qid haseqTm_refine_7bfdc00952137539b32d51b5defd6d7f))

:named haseqTm_refine_7bfdc00952137539b32d51b5defd6d7f))
(declare-fun Bug138.foo_bar (Term Term) Term)

;;;;;;;;;;;;;;;;a: arg -> l: Prims.list Prims.int {l << l \/ l === l /\ arg_precede a << arg_precede a}   -> Prims.Tot Prims.int
(declare-fun Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30
Tm_type)
:named kinding_Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(37,16-44,26); use=Bug138.fst(37,23-44,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30))
:qid Bug138_pre_typing_Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30))

:named Bug138_pre_typing_Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(37,16-44,26); use=Bug138.fst(37,23-44,26)
(forall ((@x0 Term))
...
Bug138.arg)
(HasType @x2
(Tm_refine_7bfdc00952137539b32d51b5defd6d7f @x1)))
...
@x1)
@x2))
:qid Bug138_interpretation_Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug138_interpretation_Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30))
:qid Bug138_interpretation_Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30))

:named Bug138_interpretation_Tm_arrow_3ca2696371ae6cdad19b8470a6f7ed30))
(declare-fun Bug138.foo_bar@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(38,8-38,15); use=Bug138.fst(38,8-38,15)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug138.foo_bar@tok
@x0)
@x1)
(Bug138.foo_bar @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Bug138.foo_bar@tok
@x0)
@x1))
:qid token_correspondence_Bug138.foo_bar))

:named token_correspondence_Bug138.foo_bar))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(38,8-38,15); use=Bug138.fst(38,8-38,15)
...
:pattern ((Bug138.foo_bar @x1
@x2))
:qid function_token_typing_Bug138.foo_bar.1))
)
 

:pattern ((ApplyTT @x0
Bug138.foo_bar@tok))
:qid function_token_typing_Bug138.foo_bar))

:named function_token_typing_Bug138.foo_bar))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug138.fst(38,8-38,15); use=Bug138.fst(38,8-38,15)
...
Bug138.arg)
(HasType @x1
(Tm_refine_7bfdc00952137539b32d51b5defd6d7f @x0)))
(HasType (Bug138.foo_bar @x0
@x1)
Prims.int))
 

:pattern ((Bug138.foo_bar @x0
@x1))
:qid typing_Bug138.foo_bar))

:named typing_Bug138.foo_bar))
...
;               l == b :: b ==>
;               b << l \/ b === l /\ Bug138.arg_precede Bug138.Bar << Bug138.arg_precede a)))) /\
;   (~(Foo? a) ==> a == Bug138.Bar ==> l << l \/ Bug138.arg_precede Bug138.Foo << Bug138.arg_precede a
;   )


; Context: While encoding a query
; While typechecking the top-level declaration `let rec foo_bar`
...
;; def=Prims.fst(402,27-402,88); use=Bug138.fst(39,2-44,26)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug138.fst(39,2-44,26)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug138.fst(39,2-44,26)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Bug138.fst(39,2-44,26)
(and (implies 
;; def=Bug138.fst(38,16-38,17); use=Bug138.fst(39,8-39,9)
(and 
;; def=Bug138.fst(38,16-38,17); use=Bug138.fst(39,8-39,9)
(not 
;; def=Bug138.fst(38,16-38,17); use=Bug138.fst(39,8-39,9)
(BoxBool_proj_0 (Bug138.uu___is_Foo x_b36ed00db7cc6c7168379d56a35933e2_0))
)
...
(not 
;; def=Bug138.fst(38,16-38,17); use=Bug138.fst(39,8-39,9)
(BoxBool_proj_0 (Bug138.uu___is_Bar x_b36ed00db7cc6c7168379d56a35933e2_0))
)
)

label_1)
(implies 
;; def=Bug138.fst(38,16-40,9); use=Bug138.fst(39,8-40,9)
(= x_b36ed00db7cc6c7168379d56a35933e2_0
Bug138.Foo@tok)
...
;; def=Prims.fst(459,77-459,89); use=Bug138.fst(39,2-44,26)
(and (implies 
;; def=Bug138.fst(38,18-38,19); use=Bug138.fst(41,14-41,15)
(and 
;; def=Bug138.fst(38,18-38,19); use=Bug138.fst(41,14-41,15)
(not 
;; def=Bug138.fst(38,18-38,19); use=Bug138.fst(41,14-41,15)
...
label_2)
(implies 
;; def=Prims.fst(389,19-389,21); use=Bug138.fst(39,2-44,26)
(not 
;; def=Bug138.fst(38,18-38,19); use=Bug138.fst(41,14-41,15)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_66b03f5c7897b05649fed8196554c587_1))
...
;; def=Prims.fst(413,99-413,120); use=Bug138.fst(39,2-44,26)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)
...
;; def=Bug138.fst(38,18-43,17); use=Bug138.fst(41,14-43,17)
(= x_66b03f5c7897b05649fed8196554c587_1
(Prims.Cons Prims.int
@x2
@x3))
...
;; def=Bug138.fst(37,23-44,26); use=Bug138.fst(43,33-43,35)
(or label_3

;; def=Bug138.fst(39,2-44,26); use=Bug138.fst(43,33-43,35)
(Valid 
;; def=Bug138.fst(39,2-44,26); use=Bug138.fst(43,33-43,35)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=Bug138.fst(37,23-44,26); use=Bug138.fst(43,33-43,35)
(and 
;; def=Bug138.fst(37,23-38,19); use=Bug138.fst(43,33-43,35)
(Valid 
;; def=Bug138.fst(37,23-38,19); use=Bug138.fst(43,33-43,35)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.int)
(Prims.list Prims.int)
...
(Prims.precedes Prims.nat
Prims.nat
(Bug138.arg_precede Bug138.Bar@tok)
(Bug138.arg_precede x_b36ed00db7cc6c7168379d56a35933e2_0))
)
)
)
...
:qid @query.2)))
(implies 
;; def=Prims.fst(389,18-389,39); use=Bug138.fst(39,2-44,26)
(and 
;; def=Prims.fst(389,19-389,21); use=Bug138.fst(39,2-44,26)
(not 
;; def=Bug138.fst(38,16-38,17); use=Bug138.fst(39,8-39,9)
...
;; def=Bug138.fst(38,16-44,9); use=Bug138.fst(39,8-44,9)
(= x_b36ed00db7cc6c7168379d56a35933e2_0
Bug138.Bar@tok)
)


;; def=Bug138.fst(37,23-44,26); use=Bug138.fst(44,25-44,26)
(or label_4

;; def=Bug138.fst(39,2-44,26); use=Bug138.fst(44,25-44,26)
(Valid 
;; def=Bug138.fst(39,2-44,26); use=Bug138.fst(44,25-44,26)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
(Prims.precedes Prims.nat
Prims.nat
(Bug138.arg_precede Bug138.Foo@tok)
(Bug138.arg_precede x_b36ed00db7cc6c7168379d56a35933e2_0))
)
)
))
