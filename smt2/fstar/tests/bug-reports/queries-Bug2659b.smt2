...
; Internals for Bug2659b


; encoding sigelt type Bug2659b.bool0


; <Start encoding type Bug2659b.bool0>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2659b.bool0 () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2659b.BT () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2659b.BT
(declare-fun Bug2659b.BT@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2659b.BF () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2659b.BF
(declare-fun Bug2659b.BF@tok () Term)

; <start constructor Bug2659b.bool0>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2659b.bool0 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(= __@x0
Bug2659b.bool0)))

; </end constructor Bug2659b.bool0>


; <start constructor Bug2659b.BT>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2659b.BT ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
110)
(= __@x0
Bug2659b.BT)))

; </end constructor Bug2659b.BT>


; <start constructor Bug2659b.BF>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2659b.BF ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
112)
(= __@x0
Bug2659b.BF)))

; </end constructor Bug2659b.BF>


; </end encoding type Bug2659b.bool0>


; encoding sigelt val Bug2659b.uu___is_BT


; <Start encoding val Bug2659b.uu___is_BT>

(declare-fun Bug2659b.uu___is_BT (Term) Term)
;;;;;;;;;;;;;;;;projectee: bool0 -> Prims.GTot Prims.bool
(declare-fun Tm_ghost_arrow_23fd8d50d40ef250af8bc3318036e0bb () Term)
(declare-fun Bug2659b.uu___is_BT@tok () Term)

; </end encoding val Bug2659b.uu___is_BT>


; encoding sigelt let uu___is_BT


; <Skipped let uu___is_BT/>


; encoding sigelt val Bug2659b.uu___is_BF


; <Start encoding val Bug2659b.uu___is_BF>

(declare-fun Bug2659b.uu___is_BF (Term) Term)

(declare-fun Bug2659b.uu___is_BF@tok () Term)

; </end encoding val Bug2659b.uu___is_BF>


; encoding sigelt let uu___is_BF


; <Skipped let uu___is_BF/>


; encoding sigelt type Bug2659b.index


; <Start encoding type Bug2659b.index>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2659b.index (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug2659b.index@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2659b.IT () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2659b.IT
(declare-fun Bug2659b.IT@tok () Term)

; <start constructor Bug2659b.index>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2659b.index ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
117)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-Bug2659b.index))))

; </end constructor Bug2659b.index>


; <start constructor Bug2659b.IT>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2659b.IT ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
Bug2659b.IT)))

; </end constructor Bug2659b.IT>


; </end encoding type Bug2659b.index>


; encoding sigelt val Bug2659b.uu___is_IT


; <Start encoding val Bug2659b.uu___is_IT>

(declare-fun Bug2659b.uu___is_IT (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: index b -> Prims.GTot Prims.bool
(declare-fun Tm_ghost_arrow_2132028075fb19673ca134e751f87c59 () Term)
(declare-fun Bug2659b.uu___is_IT@tok () Term)

; </end encoding val Bug2659b.uu___is_IT>


; encoding sigelt let uu___is_IT


; <Skipped let uu___is_IT/>
...
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug2659b.index; Namespace Bug2659b; Name Bug2659b.IT; Namespace Bug2659b
(assert (! (HasType Bug2659b.IT@tok
(Bug2659b.index Bug2659b.BT@tok))
:named typing_tok_Bug2659b.IT@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! (HasType Bug2659b.BT@tok
Bug2659b.bool0)
:named typing_tok_Bug2659b.BT@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! (HasType Bug2659b.BF@tok
Bug2659b.bool0)
:named typing_tok_Bug2659b.BF@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name Bug2659b.index; Namespace Bug2659b; Name Bug2659b.IT; Namespace Bug2659b
(assert (! 
;; def=Bug2659b.fst(16,10-16,15); use=Bug2659b.fst(16,10-16,15)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug2659b.index@tok
@x0)
(Bug2659b.index @x0))
 

:pattern ((ApplyTT Bug2659b.index@tok
@x0))

:pattern ((Bug2659b.index @x0))
:qid token_correspondence_Bug2659b.index@tok))

:named token_correspondence_Bug2659b.index@tok))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug2659b.index; Namespace Bug2659b; Name Bug2659b.IT; Namespace Bug2659b
(assert (! (is-Tm_arrow (PreType Bug2659b.index@tok))
:named pre_kinding_Bug2659b.index@tok))
...
;;; Fact-ids: Name Bug2659b.index; Namespace Bug2659b; Name Bug2659b.IT; Namespace Bug2659b
(assert (! (and (IsTotFun Bug2659b.index@tok)

;; def=Bug2659b.fst(16,10-16,15); use=Bug2659b.fst(16,10-16,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug2659b.bool0)
(HasType (Bug2659b.index @x0)
Tm_type))
 

:pattern ((Bug2659b.index @x0))
:qid kinding_Bug2659b.index@tok))
)
:named kinding_Bug2659b.index@tok))
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! (HasType Bug2659b.bool0
Tm_type)
:named kinding_Bug2659b.bool0@tok))
...
@x1
(Bug2659b.index @x2)))
:qid fuel_guarded_inversion_Bug2659b.index))

:named fuel_guarded_inversion_Bug2659b.index))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! 
;; def=Bug2659b.fst(13,10-13,15); use=Bug2659b.fst(13,10-13,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Bug2659b.bool0)
(or (is-Bug2659b.BT @x1)
(is-Bug2659b.BF @x1)))
...
@x1
Bug2659b.bool0))
:qid fuel_guarded_inversion_Bug2659b.bool0))

:named fuel_guarded_inversion_Bug2659b.bool0))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug2659b.index; Namespace Bug2659b; Name Bug2659b.IT; Namespace Bug2659b
(assert (! (= 118
(Term_constr_id Bug2659b.index@tok))
:named fresh_token_Bug2659b.index@tok))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug2659b.index; Namespace Bug2659b; Name Bug2659b.IT; Namespace Bug2659b
(assert (! (= Bug2659b.IT@tok
Bug2659b.IT)
:named equality_tok_Bug2659b.IT@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! (= Bug2659b.BT@tok
Bug2659b.BT)
:named equality_tok_Bug2659b.BT@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! (= Bug2659b.BF@tok
Bug2659b.BF)
:named equality_tok_Bug2659b.BF@tok))
...
;;; Fact-ids: Name Bug2659b.index; Namespace Bug2659b; Name Bug2659b.IT; Namespace Bug2659b
(assert (! 
;; def=Bug2659b.fst(17,4-17,6); use=Bug2659b.fst(17,4-17,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (= Bug2659b.BT@tok
@x1)
(HasTypeFuel @u0
Bug2659b.IT
(Bug2659b.index @x1)))
...
Bug2659b.IT
(Bug2659b.index @x1)))
:qid data_typing_intro_Bug2659b.IT@tok))

:named data_typing_intro_Bug2659b.IT@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! 
;; def=Bug2659b.fst(13,20-13,22); use=Bug2659b.fst(13,20-13,22)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug2659b.BT
Bug2659b.bool0)
...
Bug2659b.BT
Bug2659b.bool0))
:qid data_typing_intro_Bug2659b.BT@tok))

:named data_typing_intro_Bug2659b.BT@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! 
;; def=Bug2659b.fst(13,25-13,27); use=Bug2659b.fst(13,25-13,27)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug2659b.BF
Bug2659b.bool0)
...
Bug2659b.BF
Bug2659b.bool0))
:qid data_typing_intro_Bug2659b.BF@tok))

:named data_typing_intro_Bug2659b.BF@tok))
...
Bug2659b.IT
(Bug2659b.index @x1)))
:qid data_elim_Bug2659b.IT))

:named data_elim_Bug2659b.IT))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 117
(Term_constr_id (Bug2659b.index @x0)))
 

:pattern ((Bug2659b.index @x0))
:qid constructor_distinct_Bug2659b.index))

:named constructor_distinct_Bug2659b.index))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! (= 104
(Term_constr_id Bug2659b.bool0))
:named constructor_distinct_Bug2659b.bool0))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2659b.index; Namespace Bug2659b; Name Bug2659b.IT; Namespace Bug2659b
(assert (! (= 124
(Term_constr_id Bug2659b.IT))
:named constructor_distinct_Bug2659b.IT))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! (= 110
(Term_constr_id Bug2659b.BT))
:named constructor_distinct_Bug2659b.BT))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2659b.bool0; Namespace Bug2659b; Name Bug2659b.BT; Namespace Bug2659b; Name Bug2659b.BF; Namespace Bug2659b
(assert (! (= 112
(Term_constr_id Bug2659b.BF))
:named constructor_distinct_Bug2659b.BF))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Bug2659b.bool0))
:qid Bug2659b_pretyping_eaa712abd66fd051e358213d5ebb46a9))

:named Bug2659b_pretyping_eaa712abd66fd051e358213d5ebb46a9))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug2659b.index; Namespace Bug2659b; Name Bug2659b.IT; Namespace Bug2659b
(assert (! 
;; def=Bug2659b.fst(16,10-16,15); use=Bug2659b.fst(16,10-16,15)
...
@x0
(Bug2659b.index @x2)))
:qid Bug2659b_pretyping_d22353498df0c22b70cb630c03ad30ef))

:named Bug2659b_pretyping_d22353498df0c22b70cb630c03ad30ef))
(push) ;; push{2

; Starting query at Bug2659b.fst(20,4-20,6)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (i: Bug2659b.index Bug2659b.BF).
...
; While typechecking the top-level declaration `let elim_index_BF`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (HasType @x0
(Bug2659b.index Bug2659b.BF@tok))
...
;; def=Prims.fst(451,90-451,102); use=Bug2659b.fst(20,4-20,6)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2659b.elim_index_BF, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_Bug2659b.BF, constructor_distinct_Bug2659b.BT, equality_tok_Bug2659b.BF@tok, equality_tok_Bug2659b.BT@tok, fuel_guarded_inversion_Bug2659b.index
...
; encoding sigelt let elim_index_BF


; <Start encoding let elim_index_BF>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug2659b.elim_index_BF (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug2659b.elim_index_BF@tok () Term)

; </end encoding let elim_index_BF>


; encoding sigelt let repr0


; <Start encoding let repr0>

(declare-fun Bug2659b.repr0 (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> b: bool0 -> p: index b -> Type
(declare-fun Tm_arrow_d2cb4c8162820352d0eb1f62b33513ce () Term)
(declare-fun Bug2659b.repr0@tok () Term)

; </end encoding let repr0>


; encoding sigelt let return0


; <Start encoding let return0>

(declare-fun Bug2659b.return0 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> repr0 a BT IT
(declare-fun Tm_arrow_d9202fdf5a3731fcd681c4387acc2ac8 () Term)
(declare-fun Bug2659b.return0@tok () Term)

; </end encoding let return0>


; encoding sigelt let bind0


; <Start encoding let bind0>

;;;;;;;;;;;;;;;;_: a0 -> repr0 a1 b1 p1
(declare-fun Tm_arrow_8ec351b6a5deebcf323893dc25f1cb37 (Term Term Term Term) Term)
(declare-fun Bug2659b.bind0 (Term Term Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a0: Type ->     a1: Type ->     b0: bool0 ->     p0: index b0 ->     b1: bool0 ->     p1: index b1 ->     r0: repr0 a0 b0 p0 ->     r1: (_: a0 -> repr0 a1 b1 p1)   -> repr0 a1 b1 p1
(declare-fun Tm_arrow_a93025a359515fd5402774a64bfe101d () Term)
(declare-fun Bug2659b.bind0@tok () Term)


; </end encoding let bind0>


; encoding sigelt layered_effect { E0 ... }


; <Skipped layered_effect { E0 ... }/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2659b.repr0; Namespace Bug2659b
(assert (! 
;; def=Bug2659b.fst(25,5-25,10); use=Bug2659b.fst(25,5-25,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(Bug2659b.index @x1)))
(HasType (Bug2659b.repr0 @x0
@x1
@x2)
Tm_type))
 

:pattern ((Bug2659b.repr0 @x0
@x1
@x2))
:qid typing_Bug2659b.repr0))

:named typing_Bug2659b.repr0))
;;;;;;;;;;;;;;;;name-token correspondence
...
@x1
@x2))
:qid equation_Bug2659b.repr0))

:named equation_Bug2659b.repr0))
;;;;;;;;;;;;;;;;Eq2 interpretation
;;; Fact-ids: Name Prims.eq2; Namespace Prims
...
; Starting query at Bug2659b.fst(49,4-50,8)
...
;;;;;;;;;;;;;;;;return_val: repr0 a BT IT -> Prims.GTot Type0
(declare-fun Tm_arrow_b85fde54bf25adeb10efdf4919b62d68 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b85fde54bf25adeb10efdf4919b62d68
;;; Fact-ids: 
(assert (! 
;; def=Bug2659b.fst(46,9-46,24); use=Bug2659b.fst(49,4-50,8)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_b85fde54bf25adeb10efdf4919b62d68 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_b85fde54bf25adeb10efdf4919b62d68 @x0)
Tm_type))
:qid kinding_Tm_arrow_b85fde54bf25adeb10efdf4919b62d68))

:named kinding_Tm_arrow_b85fde54bf25adeb10efdf4919b62d68))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug2659b.fst(46,9-46,24); use=Bug2659b.fst(49,4-50,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_b85fde54bf25adeb10efdf4919b62d68 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_b85fde54bf25adeb10efdf4919b62d68 @x2)))
:qid Bug2659b_pre_typing_Tm_arrow_b85fde54bf25adeb10efdf4919b62d68))

:named Bug2659b_pre_typing_Tm_arrow_b85fde54bf25adeb10efdf4919b62d68))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b85fde54bf25adeb10efdf4919b62d68
;;; Fact-ids: 
(assert (! 
;; def=Bug2659b.fst(46,9-46,24); use=Bug2659b.fst(49,4-50,8)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_b85fde54bf25adeb10efdf4919b62d68 @x1))
(and 
;; def=Bug2659b.fst(46,9-46,24); use=Bug2659b.fst(49,4-50,8)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug2659b_interpretation_Tm_arrow_b85fde54bf25adeb10efdf4919b62d68.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_b85fde54bf25adeb10efdf4919b62d68 @x1)))
:qid Bug2659b_interpretation_Tm_arrow_b85fde54bf25adeb10efdf4919b62d68))

:named Bug2659b_interpretation_Tm_arrow_b85fde54bf25adeb10efdf4919b62d68))
(declare-fun Tm_abs_f902cbffb6e5f313a724ce22477f344c (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_f902cbffb6e5f313a724ce22477f344c
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=Prims.fst(426,19-426,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_f902cbffb6e5f313a724ce22477f344c @x0
@x1
@x2)
(Tm_arrow_b85fde54bf25adeb10efdf4919b62d68 @x2))
 

:pattern ((Tm_abs_f902cbffb6e5f313a724ce22477f344c @x0
@x1
@x2))
:qid typing_Tm_abs_f902cbffb6e5f313a724ce22477f344c))

:named typing_Tm_abs_f902cbffb6e5f313a724ce22477f344c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_f902cbffb6e5f313a724ce22477f344c
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=Prims.fst(426,19-426,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_f902cbffb6e5f313a724ce22477f344c @x1
@x2
@x3)
@x0)
(Prims.l_imp (Prims.eq2 (Bug2659b.repr0 @x3
Bug2659b.BT@tok
Bug2659b.IT@tok)
@x0
@x1)
...
:pattern ((ApplyTT (Tm_abs_f902cbffb6e5f313a724ce22477f344c @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_f902cbffb6e5f313a724ce22477f344c))

:named interpretation_Tm_abs_f902cbffb6e5f313a724ce22477f344c))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=Prims.fst(426,19-426,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.l_Forall (Bug2659b.repr0 @x2
Bug2659b.BT@tok
Bug2659b.IT@tok)
(Tm_abs_f902cbffb6e5f313a724ce22477f344c @x1
@x0
@x2)))
...
;;no pats
:qid l_quant_interp_0ea12045dadfcee216f8a6ef5ed560bc.1))
)
 

:pattern ((Valid (Prims.l_Forall (Bug2659b.repr0 @x2
Bug2659b.BT@tok
Bug2659b.IT@tok)
(Tm_abs_f902cbffb6e5f313a724ce22477f344c @x1
@x0
@x2))))
:qid l_quant_interp_0ea12045dadfcee216f8a6ef5ed560bc))

:named l_quant_interp_0ea12045dadfcee216f8a6ef5ed560bc))

(declare-fun Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,38-369,57); use=Prims.fst(427,19-427,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33 @x0
@x1
@x2)
(Tm_arrow_b85fde54bf25adeb10efdf4919b62d68 @x2))
 

:pattern ((Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33 @x0
@x1
@x2))
:qid typing_Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33))

:named typing_Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,38-369,57); use=Prims.fst(427,19-427,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33 @x1
@x2
@x3)
@x0)
(Prims.l_imp (Prims.eq2 (Bug2659b.repr0 @x3
...
(ApplyTT @x1
Tm_unit))
(Prims.l_Forall (Bug2659b.repr0 @x3
Bug2659b.BT@tok
Bug2659b.IT@tok)
(Tm_abs_f902cbffb6e5f313a724ce22477f344c @x0
@x2
@x3))))
 

:pattern ((ApplyTT (Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33))

:named interpretation_Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33))
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (Bug2659b.repr0 a Bug2659b.BT Bug2659b.IT)).
;     wp (fun _ -> Prims.l_True) /\
;     (forall (pure_result: Bug2659b.repr0 a Bug2659b.BT Bug2659b.IT).
...
;               bind_result_1 == f () ==>
;               (forall (return_val: Bug2659b.repr0 a Bug2659b.BT Bug2659b.IT).
;                   return_val == bind_result_1 ==> p return_val)))


; Context: While encoding a query
; While typechecking the top-level declaration `let lift_pure_e0`
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post (Bug2659b.repr0 @x0
Bug2659b.BT@tok
Bug2659b.IT@tok)))

;; def=Prims.fst(630,56-630,74); use=Bug2659b.fst(47,19-47,30)
(Valid 
;; def=Prims.fst(630,56-630,74); use=Bug2659b.fst(47,19-47,30)
(ApplyTT @x1
...
;; def=Prims.fst(441,36-441,97); use=Bug2659b.fst(49,4-50,8)
(forall ((@x4 Term))
 (! (implies (or label_1
(HasType @x4
(Bug2659b.repr0 @x0
...
;; def=Prims.fst(441,83-441,96); use=Bug2659b.fst(49,4-50,8)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug2659b.fst(49,4-50,8)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,36-441,97); use=Bug2659b.fst(49,25-49,50)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=FStar.Monotonic.Pure.fst(34,2-34,75); use=Bug2659b.fst(49,4-50,8)
...
;; def=FStar.Monotonic.Pure.fst(34,28-34,55); use=Bug2659b.fst(49,4-50,8)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
@x0)

;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=Bug2659b.fst(49,4-50,8)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=Bug2659b.fst(49,4-50,8)
(ApplyTT @x5
@x7)
...
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=Bug2659b.fst(49,4-50,8)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=Bug2659b.fst(49,4-50,8)
(ApplyTT @x6
@x7)
...
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=Bug2659b.fst(49,4-50,8)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=Bug2659b.fst(49,4-50,8)
(ApplyTT @x1
@x5)
...
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=Bug2659b.fst(49,4-50,8)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=Bug2659b.fst(49,4-50,8)
(ApplyTT @x1
@x6)
...
;; def=Prims.fst(369,38-369,57); use=Bug2659b.fst(49,4-50,8)
(or label_2
...
;; def=Prims.fst(369,38-369,57); use=Bug2659b.fst(49,4-50,8)
(ApplyTT @x1
(Tm_abs_99403bb437bd6b7d8c5d631c11ce2f33 @x2
@x3
@x0))
)
)
...
; encoding sigelt let lift_pure_e0


; <Start encoding let lift_pure_e0>
...
(declare-fun Bug2659b.lift_pure_e0 (Term Term Term) Term)
...
(declare-fun Tm_refine_6fd87d93181524836a09660253a6e32a (Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> f: (_: Prims.unit -> Prims.PURE a) -> Prims.Pure (repr0 a BT IT)
(declare-fun Tm_arrow_8f09768f9414319f84983abceaca5080 () Term)
(declare-fun Bug2659b.lift_pure_e0@tok () Term)
...
; </end encoding let lift_pure_e0>

(push) ;; push{2

; Starting query at Bug2659b.fst(52,0-52,36)
...
;   (wp: Prims.pure_wp a)
;   (p: Prims.pure_post (Bug2659b.repr0 a Bug2659b.BT Bug2659b.IT))
;   (q: Prims.pure_post (Bug2659b.repr0 a Bug2659b.BT Bug2659b.IT)).
;   (forall (x: Bug2659b.repr0 a Bug2659b.BT Bug2659b.IT). p x ==> q x) ==>
;   wp (fun _ -> Prims.l_True) /\
;   (forall (pure_result: Bug2659b.repr0 a Bug2659b.BT Bug2659b.IT). Prims.auto_squash (p pure_result)
;   ) ==>
;   wp (fun _ -> Prims.l_True) /\
;   (forall (pure_result: Bug2659b.repr0 a Bug2659b.BT Bug2659b.IT). Prims.auto_squash (q pure_result)
;   )


; Context: While encoding a query
; While typechecking the top-level declaration `sub_effect PURE ~> E0`
...
;; def=Prims.fst(630,56-630,74); use=Prims.fst(630,56-630,74)
(Valid 
;; def=Prims.fst(630,56-630,74); use=Prims.fst(630,56-630,74)
(ApplyTT @x1
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x0))
...
;; def=Prims.fst(441,36-441,97); use=Bug2659b.fst(52,24-52,36)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Bug2659b.repr0 @x0
Bug2659b.BT@tok
...
;; def=Prims.fst(441,83-441,96); use=Bug2659b.fst(52,24-52,36)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug2659b.fst(52,24-52,36)
(ApplyTT @x2
@x4)
...
;; def=Prims.fst(441,29-441,97); use=Bug2659b.fst(52,24-52,36)
(and 
;; def=Prims.fst(630,56-630,74); use=Prims.fst(630,56-630,74)
(or label_1
...
; encoding sigelt sub_effect PURE ~> E0


; <Skipped sub_effect PURE ~> E0/>


; encoding sigelt let repr1


; <Start encoding let repr1>

(declare-fun Bug2659b.repr1 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> b: bool0 -> Type
(declare-fun Tm_arrow_7bd5917cf230c81822f451df235c8a2e () Term)
(declare-fun Bug2659b.repr1@tok () Term)

; </end encoding let repr1>


; encoding sigelt let return1


; <Start encoding let return1>

(declare-fun Bug2659b.return1 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> repr1 a BT
(declare-fun Tm_arrow_791a6e35f0b350342cc65830de43ac57 () Term)
(declare-fun Bug2659b.return1@tok () Term)

; </end encoding let return1>


; encoding sigelt let bind1


; <Start encoding let bind1>

;;;;;;;;;;;;;;;;_: a0 -> repr1 a1 b1
(declare-fun Tm_arrow_8931d4588bc8bb7dbc701c7e52bb0b4f (Term Term Term) Term)
(declare-fun Bug2659b.bind1 (Term Term Term Term Term Term) Term)

(declare-fun Tm_refine_5b42d3bae8965155082ab580f334fa87 (Term Term) Term)
;;;;;;;;;;;;;;;;a0: Type -> a1: Type -> b0: bool0 -> b1: bool0 -> r0: repr1 a0 b0 -> r1: (_: a0 -> repr1 a1 b1)   -> Prims.Pure (repr1 a1 b1)
(declare-fun Tm_arrow_87151e922d7858b9b851b5d8795fe1cb () Term)
(declare-fun Bug2659b.bind1@tok () Term)



; </end encoding let bind1>


; encoding sigelt layered_effect { E1 ... }


; <Skipped layered_effect { E1 ... }/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2659b.repr1; Namespace Bug2659b
(assert (! 
;; def=Bug2659b.fst(55,4-55,9); use=Bug2659b.fst(55,4-55,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Bug2659b.bool0))
(HasType (Bug2659b.repr1 @x0
@x1)
Tm_type))
 

:pattern ((Bug2659b.repr1 @x0
@x1))
:qid typing_Bug2659b.repr1))

:named typing_Bug2659b.repr1))
;;;;;;;;;;;;;;;;Equation for Bug2659b.repr1
;;; Fact-ids: Name Bug2659b.repr1; Namespace Bug2659b
(assert (! 
;; def=Bug2659b.fst(55,4-55,9); use=Bug2659b.fst(55,4-55,9)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((Bug2659b.repr1 @x0
@x1))
:qid equation_Bug2659b.repr1))

:named equation_Bug2659b.repr1))
(push) ;; push{2

; Starting query at Bug2659b.fst(83,4-84,8)
...
;;;;;;;;;;;;;;;;return_val: repr1 a BT -> Prims.GTot Type0
(declare-fun Tm_arrow_5bfd32374da7c037fd5075868ddd26a8 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5bfd32374da7c037fd5075868ddd26a8
;;; Fact-ids: 
(assert (! 
;; def=Bug2659b.fst(80,9-80,21); use=Bug2659b.fst(83,4-84,8)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_5bfd32374da7c037fd5075868ddd26a8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_5bfd32374da7c037fd5075868ddd26a8 @x0)
Tm_type))
:qid kinding_Tm_arrow_5bfd32374da7c037fd5075868ddd26a8))

:named kinding_Tm_arrow_5bfd32374da7c037fd5075868ddd26a8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug2659b.fst(80,9-80,21); use=Bug2659b.fst(83,4-84,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_5bfd32374da7c037fd5075868ddd26a8 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_5bfd32374da7c037fd5075868ddd26a8 @x2)))
:qid Bug2659b_pre_typing_Tm_arrow_5bfd32374da7c037fd5075868ddd26a8))

:named Bug2659b_pre_typing_Tm_arrow_5bfd32374da7c037fd5075868ddd26a8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5bfd32374da7c037fd5075868ddd26a8
;;; Fact-ids: 
(assert (! 
;; def=Bug2659b.fst(80,9-80,21); use=Bug2659b.fst(83,4-84,8)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_5bfd32374da7c037fd5075868ddd26a8 @x1))
(and 
;; def=Bug2659b.fst(80,9-80,21); use=Bug2659b.fst(83,4-84,8)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug2659b_interpretation_Tm_arrow_5bfd32374da7c037fd5075868ddd26a8.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_5bfd32374da7c037fd5075868ddd26a8 @x1)))
:qid Bug2659b_interpretation_Tm_arrow_5bfd32374da7c037fd5075868ddd26a8))

:named Bug2659b_interpretation_Tm_arrow_5bfd32374da7c037fd5075868ddd26a8))
(declare-fun Tm_abs_29cf09a349a0209959f68da7f5b5f52a (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_29cf09a349a0209959f68da7f5b5f52a
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=Prims.fst(426,19-426,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_29cf09a349a0209959f68da7f5b5f52a @x0
@x1
@x2)
(Tm_arrow_5bfd32374da7c037fd5075868ddd26a8 @x2))
 

:pattern ((Tm_abs_29cf09a349a0209959f68da7f5b5f52a @x0
@x1
@x2))
:qid typing_Tm_abs_29cf09a349a0209959f68da7f5b5f52a))

:named typing_Tm_abs_29cf09a349a0209959f68da7f5b5f52a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_29cf09a349a0209959f68da7f5b5f52a
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=Prims.fst(426,19-426,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_29cf09a349a0209959f68da7f5b5f52a @x1
@x2
@x3)
@x0)
(Prims.l_imp (Prims.eq2 (Bug2659b.repr1 @x3
Bug2659b.BT@tok)
@x0
@x1)
(ApplyTT @x2
...
:pattern ((ApplyTT (Tm_abs_29cf09a349a0209959f68da7f5b5f52a @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_29cf09a349a0209959f68da7f5b5f52a))

:named interpretation_Tm_abs_29cf09a349a0209959f68da7f5b5f52a))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=Prims.fst(426,19-426,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.l_Forall (Bug2659b.repr1 @x2
Bug2659b.BT@tok)
(Tm_abs_29cf09a349a0209959f68da7f5b5f52a @x1
@x0
@x2)))
...
;;no pats
:qid l_quant_interp_f79e32b16dee17e13616e821b4877394.1))
)
 

:pattern ((Valid (Prims.l_Forall (Bug2659b.repr1 @x2
Bug2659b.BT@tok)
(Tm_abs_29cf09a349a0209959f68da7f5b5f52a @x1
@x0
@x2))))
:qid l_quant_interp_f79e32b16dee17e13616e821b4877394))

:named l_quant_interp_f79e32b16dee17e13616e821b4877394))

(declare-fun Tm_abs_d4060aae1f512a4fd24c2ace5b42c230 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_d4060aae1f512a4fd24c2ace5b42c230
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,38-369,57); use=Prims.fst(427,19-427,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_d4060aae1f512a4fd24c2ace5b42c230 @x0
@x1
@x2)
(Tm_arrow_5bfd32374da7c037fd5075868ddd26a8 @x2))
 

:pattern ((Tm_abs_d4060aae1f512a4fd24c2ace5b42c230 @x0
@x1
@x2))
:qid typing_Tm_abs_d4060aae1f512a4fd24c2ace5b42c230))

:named typing_Tm_abs_d4060aae1f512a4fd24c2ace5b42c230))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_d4060aae1f512a4fd24c2ace5b42c230
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,38-369,57); use=Prims.fst(427,19-427,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_d4060aae1f512a4fd24c2ace5b42c230 @x1
@x2
@x3)
@x0)
(Prims.l_imp (Prims.eq2 (Bug2659b.repr1 @x3
...
(ApplyTT @x1
Tm_unit))
(Prims.l_Forall (Bug2659b.repr1 @x3
Bug2659b.BT@tok)
(Tm_abs_29cf09a349a0209959f68da7f5b5f52a @x0
@x2
@x3))))
 

:pattern ((ApplyTT (Tm_abs_d4060aae1f512a4fd24c2ace5b42c230 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_d4060aae1f512a4fd24c2ace5b42c230))

:named interpretation_Tm_abs_d4060aae1f512a4fd24c2ace5b42c230))
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (Bug2659b.repr1 a Bug2659b.BT)).
;     wp (fun _ -> Prims.l_True) /\
;     (forall (pure_result: Bug2659b.repr1 a Bug2659b.BT). Prims.auto_squash (p pure_result)) ==>
;     (forall (pure_result: Prims.unit).
;         (forall (p: Prims.pure_post a) (q: Prims.pure_post a).
;             (forall (x: a). p x ==> q x) ==> wp p ==> wp q) ==>
;         wp (fun bind_result_1 ->
;               bind_result_1 == f () ==>
;               (forall (return_val: Bug2659b.repr1 a Bug2659b.BT).
;                   return_val == bind_result_1 ==> p return_val)))


; Context: While encoding a query
; While typechecking the top-level declaration `let lift_pure_e1`
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post (Bug2659b.repr1 @x0
Bug2659b.BT@tok)))

;; def=Bug2659b.fst(81,19-81,37); use=Bug2659b.fst(83,4-84,8)
(Valid 
;; def=Bug2659b.fst(81,19-81,37); use=Bug2659b.fst(83,4-84,8)
(ApplyTT @x1
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x0))
...
;; def=Prims.fst(441,36-441,97); use=Bug2659b.fst(83,4-84,8)
(forall ((@x4 Term))
 (! (implies (or label_1
(HasType @x4
(Bug2659b.repr1 @x0
...
;; def=Prims.fst(441,83-441,96); use=Bug2659b.fst(83,4-84,8)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug2659b.fst(83,4-84,8)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,36-441,97); use=Bug2659b.fst(83,25-83,50)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=FStar.Monotonic.Pure.fst(34,2-34,75); use=Bug2659b.fst(83,4-84,8)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
(Prims.pure_post @x0))
(HasType @x6
...
;; def=FStar.Monotonic.Pure.fst(34,28-34,55); use=Bug2659b.fst(83,4-84,8)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
@x0)

;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=Bug2659b.fst(83,4-84,8)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=Bug2659b.fst(83,4-84,8)
(ApplyTT @x5
@x7)
...
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=Bug2659b.fst(83,4-84,8)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=Bug2659b.fst(83,4-84,8)
(ApplyTT @x6
@x7)
...
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=Bug2659b.fst(83,4-84,8)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=Bug2659b.fst(83,4-84,8)
(ApplyTT @x1
@x5)
...
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=Bug2659b.fst(83,4-84,8)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=Bug2659b.fst(83,4-84,8)
(ApplyTT @x1
@x6)
...
;; def=Prims.fst(369,38-369,57); use=Bug2659b.fst(83,4-84,8)
(or label_2
...
;; def=Prims.fst(369,38-369,57); use=Bug2659b.fst(83,4-84,8)
(ApplyTT @x1
(Tm_abs_d4060aae1f512a4fd24c2ace5b42c230 @x2
@x3
@x0))
)
)
...
; encoding sigelt let lift_pure_e1


; <Start encoding let lift_pure_e1>
...
(declare-fun Bug2659b.lift_pure_e1 (Term Term Term) Term)
...
(declare-fun Tm_refine_10668b454887a06ee7c4de2dbba47c38 (Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> f: (_: Prims.unit -> Prims.PURE a) -> Prims.Pure (repr1 a BT)
(declare-fun Tm_arrow_275a7254240208dfe7421e06c9ce20a3 () Term)
(declare-fun Bug2659b.lift_pure_e1@tok () Term)
...
; </end encoding let lift_pure_e1>

(push) ;; push{2

; Starting query at Bug2659b.fst(86,0-86,36)
...
; Encoding query formula : forall (a: Type)
;   (wp: Prims.pure_wp a)
;   (p: Prims.pure_post (Bug2659b.repr1 a Bug2659b.BT))
;   (q: Prims.pure_post (Bug2659b.repr1 a Bug2659b.BT)).
;   (forall (x: Bug2659b.repr1 a Bug2659b.BT). p x ==> q x) ==>
;   wp (fun _ -> Prims.l_True) /\
;   (forall (pure_result: Bug2659b.repr1 a Bug2659b.BT). Prims.auto_squash (p pure_result)) ==>
;   wp (fun _ -> Prims.l_True) /\
;   (forall (pure_result: Bug2659b.repr1 a Bug2659b.BT). Prims.auto_squash (q pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `sub_effect PURE ~> E1`
...
;; def=Bug2659b.fst(81,19-81,37); use=Bug2659b.fst(86,24-86,36)
(Valid 
;; def=Bug2659b.fst(81,19-81,37); use=Bug2659b.fst(86,24-86,36)
(ApplyTT @x1
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x0))
...
;; def=Prims.fst(441,36-441,97); use=Bug2659b.fst(86,24-86,36)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Bug2659b.repr1 @x0
Bug2659b.BT@tok))

;; def=Prims.fst(441,83-441,96); use=Bug2659b.fst(86,24-86,36)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug2659b.fst(86,24-86,36)
(ApplyTT @x2
@x4)
...
;; def=Prims.fst(441,29-441,97); use=Bug2659b.fst(86,24-86,36)
(and 
;; def=Bug2659b.fst(81,19-81,37); use=Bug2659b.fst(86,24-86,36)
(or label_1
...
; encoding sigelt sub_effect PURE ~> E1


; <Skipped sub_effect PURE ~> E1/>


; encoding sigelt let lift_e0_e1


; <Start encoding let lift_e0_e1>

(declare-fun Bug2659b.lift_e0_e1 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> b: bool0 -> p: index b -> r: repr0 a b p -> repr1 a b
(declare-fun Tm_arrow_ae3b3ff43c0a3f9317ab63ed18c639b6 () Term)
(declare-fun Bug2659b.lift_e0_e1@tok () Term)

; </end encoding let lift_e0_e1>


; encoding sigelt sub_effect E0 ~> E1


; <Skipped sub_effect E0 ~> E1/>


; encoding sigelt val Bug2659b.return_False


; <Start encoding val Bug2659b.return_False>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug2659b.return_False (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug2659b.return_False@tok () Term)

; </end encoding val Bug2659b.return_False>

(push) ;; push{2

; Starting query at Bug2659b.fst(100,70-100,83)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

(declare-fun Non_total_Tm_arrow_55f9312874e66191196c1674bf806ac5 () Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! (HasType Non_total_Tm_arrow_55f9312874e66191196c1674bf806ac5
Tm_type)
:named non_total_function_typing_Non_total_Tm_arrow_55f9312874e66191196c1674bf806ac5))

; Encoding query formula : forall (f: Prims.squash Prims.l_False).
;   (forall (_: Prims.unit).
;       (*  - Subtyping check failed
;   - Expected type u171: Prims.unit{Prims.l_False} got type Prims.unit
; *)
;       Prims.l_False) /\
;   (forall (_: Prims.unit).
;       (*  - Subtyping check failed
;   - Expected type u240: Prims.unit{Prims.l_False} got type Prims.unit
; *)
;       Prims.l_False) /\
;   (forall (any_result: Type0).
;       (_: Prims.unit -> Bug2659b.E0 Prims.unit) == any_result ==> Prims.l_False)


; Context: While encoding a query
; While typechecking the top-level declaration `let make_BF`
...
;; def=Prims.fst(459,77-459,89); use=Bug2659b.fst(100,33-100,83)
(and 
;; def=dummy(0,0-0,0); use=Bug2659b.fst(100,70-100,83)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.unit)
label_1)
...
;; def=Prims.fst(451,66-451,102); use=Bug2659b.fst(100,70-100,83)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Tm_type)

;; def=FStar.Pervasives.fsti(772,17-772,18); use=Bug2659b.fst(100,70-100,83)
(= Non_total_Tm_arrow_55f9312874e66191196c1674bf806ac5
@x1)
)
label_3)
...
; encoding sigelt let make_BF


; <Start encoding let make_BF>


(declare-fun Bug2659b.make_BF (Term) Term)

(declare-fun Non_total_Tm_arrow_55f9312874e66191196c1674bf806ac5 () Term)
;;;;;;;;;;;;;;;;f: Prims.squash Prims.l_False -> _: Prims.unit -> E0 Prims.unit
(declare-fun Tm_arrow_6c8f34c1fbfbcd53d7989022e2b3067d () Term)
(declare-fun Bug2659b.make_BF@tok () Term)




; </end encoding let make_BF>
...
; Starting query at Bug2659b.fst(113,0-115,14)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Prims.unit) (f: Prims.squash Prims.l_False). Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let absurd_e1`
; While typechecking the top-level declaration `[@@expect_failure] let absurd_e1`
...
; Encoding query formula : forall (_: Prims.unit). Prims.l_False
