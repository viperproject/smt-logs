...
; Starting query at Bug1319b.fst(18,52-23,15)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug1319b.fst(18,23-18,39); use=Bug1319b.fst(18,17-18,25)
(forall ((@x0 Term) (@x1 Term))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x2
@x3)))
:qid Bug1319b_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named Bug1319b_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
...
:pattern ((ApplyTT @x0
@x3))
:qid Bug1319b_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe.1))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x2)))
:qid Bug1319b_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named Bug1319b_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
(declare-fun Tm_refine_b99228522790afde1b7df195b50e267c (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug1319b.fst(19,14-22,35); use=Bug1319b.fst(19,14-22,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_refine_b99228522790afde1b7df195b50e267c @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_refine_b99228522790afde1b7df195b50e267c @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid refinement_kinding_Tm_refine_b99228522790afde1b7df195b50e267c))

:named refinement_kinding_Tm_refine_b99228522790afde1b7df195b50e267c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug1319b.fst(19,14-22,35); use=Bug1319b.fst(19,14-22,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b99228522790afde1b7df195b50e267c @x2
@x3
@x4
@x5
@x6))
...
;; def=Bug1319b.fst(19,14-22,35); use=Bug1319b.fst(19,14-22,35)
(or 
;; def=Bug1319b.fst(20,3-22,35); use=Bug1319b.fst(20,3-22,35)
(Valid 
;; def=Bug1319b.fst(20,3-22,35); use=Bug1319b.fst(20,3-22,35)
...
;; def=Bug1319b.fst(19,14-22,35); use=Bug1319b.fst(19,14-22,35)
(and 
;; def=Bug1319b.fst(19,14-19,15); use=Bug1319b.fst(19,14-19,15)
(Valid 
;; def=Bug1319b.fst(19,14-19,15); use=Bug1319b.fst(19,14-19,15)
...
@x5
@x6)))
:qid refinement_interpretation_Tm_refine_b99228522790afde1b7df195b50e267c))

:named refinement_interpretation_Tm_refine_b99228522790afde1b7df195b50e267c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b99228522790afde1b7df195b50e267c
;;; Fact-ids: 
(assert (! 
;; def=Bug1319b.fst(19,14-22,35); use=Bug1319b.fst(19,14-22,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b99228522790afde1b7df195b50e267c @x0
@x1
@x2
@x3
@x4)))
(Valid (Prims.hasEq (Prims.list @x3))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b99228522790afde1b7df195b50e267c @x0
@x1
@x2
@x3
@x4))))
:qid haseqTm_refine_b99228522790afde1b7df195b50e267c))

:named haseqTm_refine_b99228522790afde1b7df195b50e267c))
;;;;;;;;;;;;;;;;l: Prims.list 'a -> acc: Prims.list 'b {l << l \/ l === l /\ acc << acc} -> Prims.list 'b
(declare-fun Tm_arrow_badf4a515dc6688e540de9d7d118ecfd (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_badf4a515dc6688e540de9d7d118ecfd
;;; Fact-ids: 
(assert (! 
;; def=Bug1319b.fst(19,14-22,35); use=Bug1319b.fst(18,52-23,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_arrow_badf4a515dc6688e540de9d7d118ecfd @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_arrow_badf4a515dc6688e540de9d7d118ecfd @x0
@x1
@x2
@x3)
Tm_type))
:qid kinding_Tm_arrow_badf4a515dc6688e540de9d7d118ecfd))

:named kinding_Tm_arrow_badf4a515dc6688e540de9d7d118ecfd))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug1319b.fst(19,14-22,35); use=Bug1319b.fst(18,52-23,15)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_badf4a515dc6688e540de9d7d118ecfd @x2
@x3
@x4
@x5))
(is-Tm_arrow (PreType @x1)))
...
@x4
@x5)))
:qid Bug1319b_pre_typing_Tm_arrow_badf4a515dc6688e540de9d7d118ecfd))

:named Bug1319b_pre_typing_Tm_arrow_badf4a515dc6688e540de9d7d118ecfd))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_badf4a515dc6688e540de9d7d118ecfd
;;; Fact-ids: 
(assert (! 
;; def=Bug1319b.fst(19,14-22,35); use=Bug1319b.fst(18,52-23,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_badf4a515dc6688e540de9d7d118ecfd @x1
@x2
@x3
@x4))
(and 
...
(Prims.list @x4))
(HasType @x6
(Tm_refine_b99228522790afde1b7df195b50e267c @x4
@x5
@x3
@x2
@x1)))
...
@x5)
@x6))
:qid Bug1319b_interpretation_Tm_arrow_badf4a515dc6688e540de9d7d118ecfd.1))
...
:pattern ((ApplyTT @x0
@x5))
:qid Bug1319b_interpretation_Tm_arrow_badf4a515dc6688e540de9d7d118ecfd.2))
))
...
@x3
@x4)))
:qid Bug1319b_interpretation_Tm_arrow_badf4a515dc6688e540de9d7d118ecfd))

:named Bug1319b_interpretation_Tm_arrow_badf4a515dc6688e540de9d7d118ecfd))
...
;   (l: Prims.list 'a)
;   (acc: Prims.list 'b)
;   (aux: (l: Prims.list 'a -> acc: Prims.list 'b {l << l \/ l === l /\ acc << acc} -> Prims.list 'b))
; .
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post (Prims.list 'b)).
;     (forall (x: Prims.list 'b). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;     (~(Nil? l) ==>
;       (forall (b: 'a) (b: Prims.list 'a). l == b :: b ==> b << l \/ b === l /\ f b :: acc << acc))


; Context: While encoding a query
; While typechecking the top-level declaration `let map_rev`
...
(Prims.list @x1))
(HasType @x6
(Tm_arrow_badf4a515dc6688e540de9d7d118ecfd @x5
@x1
@x4
@x0)))

;; def=dummy(0,0-0,0); use=Bug1319b.fst(18,52-23,15)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Prims.pure_post (Prims.list @x1)))

;; def=Prims.fst(402,27-402,88); use=Bug1319b.fst(20,3-22,35)
(forall ((@x8 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug1319b.fst(20,3-22,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug1319b.fst(20,3-22,35)
(ApplyTT @x7
@x8)
...
;; def=Prims.fst(459,77-459,89); use=Bug1319b.fst(20,3-22,35)
(and (implies 
;; def=Bug1319b.fst(19,14-19,15); use=Bug1319b.fst(20,9-20,10)
(and 
;; def=Bug1319b.fst(19,14-19,15); use=Bug1319b.fst(20,9-20,10)
(not 
;; def=Bug1319b.fst(19,14-19,15); use=Bug1319b.fst(20,9-20,10)
(BoxBool_proj_0 (Prims.uu___is_Nil @x0
@x4))
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Bug1319b.fst(20,3-22,35)
(not 
;; def=Bug1319b.fst(19,14-19,15); use=Bug1319b.fst(20,9-20,10)
(BoxBool_proj_0 (Prims.uu___is_Nil @x0
@x4))
...
;; def=Prims.fst(413,99-413,120); use=Bug1319b.fst(20,3-22,35)
(forall ((@x8 Term))
 (! (implies (HasType @x8
@x0)
...
;; def=Bug1319b.fst(19,14-22,12); use=Bug1319b.fst(20,9-22,12)
(= @x4
(Prims.Cons @x0
@x8
@x9))
...
;; def=Bug1319b.fst(19,14-22,35); use=Bug1319b.fst(22,23-22,35)
(or label_2

;; def=Bug1319b.fst(20,3-22,35); use=Bug1319b.fst(22,23-22,35)
(Valid 
;; def=Bug1319b.fst(20,3-22,35); use=Bug1319b.fst(22,23-22,35)
...
;; def=Bug1319b.fst(19,14-22,35); use=Bug1319b.fst(22,23-22,35)
(and 
;; def=Bug1319b.fst(19,14-19,15); use=Bug1319b.fst(22,23-22,35)
(Valid 
;; def=Bug1319b.fst(19,14-19,15); use=Bug1319b.fst(22,23-22,35)
(Prims.op_Equals_Equals_Equals (Prims.list @x0)
(Prims.list @x0)
@x9
@x4)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1319b.map_rev, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
