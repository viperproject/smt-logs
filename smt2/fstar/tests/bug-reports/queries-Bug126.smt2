...
; encoding sigelt type Bug126.typ


; <Start encoding type Bug126.typ>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.typ () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.TUnit () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug126.TUnit
(declare-fun Bug126.TUnit@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.TArr (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TArr_arg (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TArr_res (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug126.TArr
(declare-fun Bug126.TArr@tok () Term)
;;;;;;;;;;;;;;;;arg: typ -> res: typ -> typ
(declare-fun Tm_arrow_0a5dfb271bc1adf933bd3e1eeef2981c () Term)

; <start constructor Bug126.typ>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.typ ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
Bug126.typ)))

; </end constructor Bug126.typ>


; <start constructor Bug126.TUnit>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.TUnit ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
Bug126.TUnit)))

; </end constructor Bug126.TUnit>


; <start constructor Bug126.TArr>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.TArr ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
(Bug126.TArr (Bug126.TArr_arg __@x0)
(Bug126.TArr_res __@x0)))))

; </end constructor Bug126.TArr>


; </end encoding type Bug126.typ>
...
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! (HasType Bug126.TUnit@tok
Bug126.typ)
:named typing_tok_Bug126.TUnit@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,28-18,32)
...
@x2)
Bug126.typ))
:qid subterm_ordering_Bug126.TArr))

:named subterm_ordering_Bug126.TArr))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,28-18,32)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug126.TArr_res (Bug126.TArr @x0
@x1))
@x1)
 

:pattern ((Bug126.TArr @x0
@x1))
:qid projection_inverse_Bug126.TArr_res))

:named projection_inverse_Bug126.TArr_res))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,28-18,32)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug126.TArr_arg (Bug126.TArr @x0
@x1))
@x0)
...
:pattern ((Bug126.TArr @x0
@x1))
:qid projection_inverse_Bug126.TArr_arg))

:named projection_inverse_Bug126.TArr_arg))
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! (HasType Bug126.typ
Tm_type)
:named kinding_Bug126.typ@tok))
...
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,5-18,8); use=Bug126.fst(18,5-18,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Bug126.typ)
(or (is-Bug126.TUnit @x1)
(is-Bug126.TArr @x1)))
...
@x1
Bug126.typ))
:qid fuel_guarded_inversion_Bug126.typ))

:named fuel_guarded_inversion_Bug126.typ))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! (= Bug126.TUnit@tok
Bug126.TUnit)
:named equality_tok_Bug126.TUnit@tok))
...
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,14-18,19); use=Bug126.fst(18,14-18,19)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug126.TUnit
Bug126.typ)
...
Bug126.TUnit
Bug126.typ))
:qid data_typing_intro_Bug126.TUnit@tok))

:named data_typing_intro_Bug126.TUnit@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,28-18,32)
...
@x2)
Bug126.typ))
:qid data_typing_intro_Bug126.TArr@tok))

:named data_typing_intro_Bug126.TArr@tok))
...
@x2)
Bug126.typ))
:qid data_elim_Bug126.TArr))

:named data_elim_Bug126.TArr))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! (= 116
(Term_constr_id Bug126.typ))
:named constructor_distinct_Bug126.typ))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! (= 122
(Term_constr_id Bug126.TUnit))
:named constructor_distinct_Bug126.TUnit))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,28-18,32)
(forall ((@x0 Term) (@x1 Term))
 (! (= 124
(Term_constr_id (Bug126.TArr @x0
@x1)))
 

:pattern ((Bug126.TArr @x0
@x1))
:qid constructor_distinct_Bug126.TArr))

:named constructor_distinct_Bug126.TArr))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Bug126.typ))
:qid Bug126_pretyping_2ddca4d01e0793754b84d9f610f2a713))

:named Bug126_pretyping_2ddca4d01e0793754b84d9f610f2a713))
(push) ;; push{4

; Starting query at Bug126.fst(18,0-18,59)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq Bug126.typ ==>
; (forall (arg: Bug126.typ) (res: Bug126.typ). Prims.hasEq Bug126.typ /\ Prims.hasEq Bug126.typ)


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug126.typ`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=Bug126.fst(18,0-18,59); use=Bug126.fst(18,0-18,59)
(Valid 
;; def=Bug126.fst(18,0-18,59); use=Bug126.fst(18,0-18,59)
(Prims.hasEq Bug126.typ)
)
...
;; def=Bug126.fst(18,0-18,59); use=Bug126.fst(18,0-18,59)
(and 
;; def=Bug126.fst(18,0-18,59); use=Bug126.fst(18,38-18,41)
(or label_1
...
;; def=Bug126.fst(18,0-18,59); use=Bug126.fst(18,49-18,52)
(or label_2
...
; encoding sigelt assume Bug126.typ__uu___haseq


; <Start encoding assume Bug126.typ__uu___haseq>


; </end encoding assume Bug126.typ__uu___haseq>


; encoding sigelt val Bug126.uu___is_TUnit


; <Start encoding val Bug126.uu___is_TUnit>

(declare-fun Bug126.uu___is_TUnit (Term) Term)
;;;;;;;;;;;;;;;;projectee: typ -> Prims.bool
(declare-fun Tm_arrow_ccd801509419dfe2865afb9f22ed4c6a () Term)
(declare-fun Bug126.uu___is_TUnit@tok () Term)

; </end encoding val Bug126.uu___is_TUnit>


; encoding sigelt let uu___is_TUnit


; <Skipped let uu___is_TUnit/>


; encoding sigelt val Bug126.uu___is_TArr


; <Start encoding val Bug126.uu___is_TArr>

(declare-fun Bug126.uu___is_TArr (Term) Term)

(declare-fun Bug126.uu___is_TArr@tok () Term)

; </end encoding val Bug126.uu___is_TArr>


; encoding sigelt let uu___is_TArr


; <Skipped let uu___is_TArr/>


; encoding sigelt val Bug126.__proj__TArr__item__arg


; <Start encoding val Bug126.__proj__TArr__item__arg>

(declare-fun Tm_refine_82996e2fd8e55cc06b19627ffe4234dc () Term)
(declare-fun Bug126.__proj__TArr__item__arg (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typ{TArr? _} -> typ
(declare-fun Tm_arrow_460278130b09d52a42152df174ac7173 () Term)
(declare-fun Bug126.__proj__TArr__item__arg@tok () Term)

; </end encoding val Bug126.__proj__TArr__item__arg>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.uu___is_TArr; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,28-18,32)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug126.typ)
(HasType (Bug126.uu___is_TArr @x0)
Prims.bool))
 

:pattern ((Bug126.uu___is_TArr @x0))
:qid typing_Bug126.uu___is_TArr))

:named typing_Bug126.uu___is_TArr))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug126.typ; Namespace Bug126; Name Bug126.TUnit; Namespace Bug126; Name Bug126.TArr; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,28-18,32)
...
:named refinement_kinding_Tm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug126.__proj__TArr__item__arg; Namespace Bug126
(assert (! (HasType Tm_refine_82996e2fd8e55cc06b19627ffe4234dc
Tm_type)
:named refinement_kinding_Tm_refine_82996e2fd8e55cc06b19627ffe4234dc))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_82996e2fd8e55cc06b19627ffe4234dc)
(and (HasTypeFuel @u0
@x1
Bug126.typ)

;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,28-18,32)
(BoxBool_proj_0 (Bug126.uu___is_TArr @x1))
))
...
@x1
Tm_refine_82996e2fd8e55cc06b19627ffe4234dc))
:qid refinement_interpretation_Tm_refine_82996e2fd8e55cc06b19627ffe4234dc))

:named refinement_interpretation_Tm_refine_82996e2fd8e55cc06b19627ffe4234dc))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
;; def=Prims.fst(304,12-304,41); use=Prims.fst(304,12-304,41)
...
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;haseq for Tm_refine_82996e2fd8e55cc06b19627ffe4234dc
;;; Fact-ids: Name Bug126.__proj__TArr__item__arg; Namespace Bug126
(assert (! (iff (Valid (Prims.hasEq Tm_refine_82996e2fd8e55cc06b19627ffe4234dc))
(Valid (Prims.hasEq Bug126.typ)))
:named haseqTm_refine_82996e2fd8e55cc06b19627ffe4234dc))
;;;;;;;;;;;;;;;;haseq for Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
(Valid (Prims.hasEq Tm_type)))
...
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,28-18,32)
(forall ((@x0 Term))
 (! (= (Bug126.uu___is_TArr @x0)
(BoxBool (is-Bug126.TArr @x0)))
 

:pattern ((Bug126.uu___is_TArr @x0))
:qid disc_equation_Bug126.TArr))

:named disc_equation_Bug126.TArr))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: Bug126.typ__uu___haseq
;;; Fact-ids: Name Bug126.typ__uu___haseq; Namespace Bug126
(assert (! (Valid (Prims.hasEq Bug126.typ))
:named assumption_Bug126.typ__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Starting query at Bug126.fst(18,34-18,37)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: Bug126.typ{TArr? _}).
;   (*  - Could not prove post-condition
; *) ~(TArr? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__TArr__item__arg`
...
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,34-18,37)
(not 
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,34-18,37)
(BoxBool_proj_0 (Bug126.uu___is_TArr @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TArr__item__arg, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_82996e2fd8e55cc06b19627ffe4234dc
...
; encoding sigelt let __proj__TArr__item__arg


; <Skipped let __proj__TArr__item__arg/>


; encoding sigelt val Bug126.__proj__TArr__item__res


; <Start encoding val Bug126.__proj__TArr__item__res>


(declare-fun Bug126.__proj__TArr__item__res (Term) Term)


(declare-fun Bug126.__proj__TArr__item__res@tok () Term)

; </end encoding val Bug126.__proj__TArr__item__res>

(push) ;; push{2

; Starting query at Bug126.fst(18,45-18,48)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__TArr__item__res`
...
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,45-18,48)
(not 
;; def=Bug126.fst(18,28-18,32); use=Bug126.fst(18,45-18,48)
(BoxBool_proj_0 (Bug126.uu___is_TArr @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TArr__item__res, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_82996e2fd8e55cc06b19627ffe4234dc
...
; encoding sigelt let __proj__TArr__item__res


; <Skipped let __proj__TArr__item__res/>
...
; encoding sigelt type Bug126.exp


; <Start encoding type Bug126.exp>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.exp () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.EUnit () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug126.EUnit
(declare-fun Bug126.EUnit@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.EVar (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.EVar_x (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug126.EVar
(declare-fun Bug126.EVar@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.EApp (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.EApp_e1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.EApp_e2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug126.EApp
(declare-fun Bug126.EApp@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.ELam (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.ELam_t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.ELam_body (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug126.ELam
(declare-fun Bug126.ELam@tok () Term)
;;;;;;;;;;;;;;;;x: var -> exp
(declare-fun Tm_arrow_d86fbb78827e146396a3e299b049c8a9 () Term)
;;;;;;;;;;;;;;;;e1: exp -> e2: exp -> exp
(declare-fun Tm_arrow_2f6af18b40af19e173b2fa37364144d2 () Term)
;;;;;;;;;;;;;;;;t: typ -> body: exp -> exp
(declare-fun Tm_arrow_f3c2787ab166ae263a760c9fd6702302 () Term)

; <start constructor Bug126.exp>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.exp ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
176)
(= __@x0
Bug126.exp)))

; </end constructor Bug126.exp>


; <start constructor Bug126.EUnit>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.EUnit ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
182)
(= __@x0
Bug126.EUnit)))

; </end constructor Bug126.EUnit>


; <start constructor Bug126.EVar>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.EVar ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
184)
(= __@x0
(Bug126.EVar (Bug126.EVar_x __@x0)))))

; </end constructor Bug126.EVar>


; <start constructor Bug126.EApp>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.EApp ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
189)
(= __@x0
(Bug126.EApp (Bug126.EApp_e1 __@x0)
(Bug126.EApp_e2 __@x0)))))

; </end constructor Bug126.EApp>


; <start constructor Bug126.ELam>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.ELam ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
194)
(= __@x0
(Bug126.ELam (Bug126.ELam_t __@x0)
(Bug126.ELam_body __@x0)))))

; </end constructor Bug126.ELam>


; </end encoding type Bug126.exp>
...
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! (HasType Bug126.EUnit@tok
Bug126.exp)
:named typing_tok_Bug126.EUnit@tok))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.var; Namespace Bug126
(assert (! (HasType Bug126.var
Tm_type)
:named typing_Bug126.var))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,4-22,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Bug126.EVar @x1)
Bug126.exp)
...
(Bug126.EVar @x1)
Bug126.exp))
:qid subterm_ordering_Bug126.EVar))

:named subterm_ordering_Bug126.EVar))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,4-24,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Bug126.ELam @x1
@x2)
...
@x2)
Bug126.exp))
:qid subterm_ordering_Bug126.ELam))

:named subterm_ordering_Bug126.ELam))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,4-23,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Bug126.EApp @x1
@x2)
...
@x2)
Bug126.exp))
:qid subterm_ordering_Bug126.EApp))

:named subterm_ordering_Bug126.EApp))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,4-22,8)
(forall ((@x0 Term))
 (! (= (Bug126.EVar_x (Bug126.EVar @x0))
@x0)
 

:pattern ((Bug126.EVar @x0))
:qid projection_inverse_Bug126.EVar_x))

:named projection_inverse_Bug126.EVar_x))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,4-24,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug126.ELam_t (Bug126.ELam @x0
@x1))
@x0)
 

:pattern ((Bug126.ELam @x0
@x1))
:qid projection_inverse_Bug126.ELam_t))

:named projection_inverse_Bug126.ELam_t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,4-24,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug126.ELam_body (Bug126.ELam @x0
@x1))
@x1)
...
:pattern ((Bug126.ELam @x0
@x1))
:qid projection_inverse_Bug126.ELam_body))

:named projection_inverse_Bug126.ELam_body))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,4-23,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug126.EApp_e2 (Bug126.EApp @x0
@x1))
@x1)
 

:pattern ((Bug126.EApp @x0
@x1))
:qid projection_inverse_Bug126.EApp_e2))

:named projection_inverse_Bug126.EApp_e2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,4-23,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug126.EApp_e1 (Bug126.EApp @x0
@x1))
@x0)
...
:pattern ((Bug126.EApp @x0
@x1))
:qid projection_inverse_Bug126.EApp_e1))

:named projection_inverse_Bug126.EApp_e1))
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! (HasType Bug126.exp
Tm_type)
:named kinding_Bug126.exp@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
(assert (! (HasType Bug126.var
Tm_type)
:named function_token_typing_Bug126.var))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(20,5-20,8); use=Bug126.fst(20,5-20,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Bug126.exp)
(or (is-Bug126.EUnit @x1)
(is-Bug126.EVar @x1)
(is-Bug126.EApp @x1)
(is-Bug126.ELam @x1)))
...
@x1
Bug126.exp))
:qid fuel_guarded_inversion_Bug126.exp))

:named fuel_guarded_inversion_Bug126.exp))
;;;;;;;;;;;;;;;;Equation for Prims.nat
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! (= Prims.nat
Tm_refine_542f9d4f129664613f2483a6c88bc7c2)
:named equation_Prims.nat))
;;;;;;;;;;;;;;;;Equation for Bug126.var
;;; Fact-ids: Name Bug126.var; Namespace Bug126
(assert (! (= Bug126.var
Prims.nat)
:named equation_Bug126.var))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! (= Bug126.EUnit@tok
Bug126.EUnit)
:named equality_tok_Bug126.EUnit@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,4-22,8)
...
(Bug126.EVar @x1)
Bug126.exp))
:qid data_typing_intro_Bug126.EVar@tok))

:named data_typing_intro_Bug126.EVar@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(21,4-21,9); use=Bug126.fst(21,4-21,9)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug126.EUnit
Bug126.exp)
...
Bug126.EUnit
Bug126.exp))
:qid data_typing_intro_Bug126.EUnit@tok))

:named data_typing_intro_Bug126.EUnit@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,4-24,8)
...
@x2)
Bug126.exp))
:qid data_typing_intro_Bug126.ELam@tok))

:named data_typing_intro_Bug126.ELam@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,4-23,8)
...
@x2)
Bug126.exp))
:qid data_typing_intro_Bug126.EApp@tok))

:named data_typing_intro_Bug126.EApp@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,4-22,8)
...
(Bug126.EVar @x1)
Bug126.exp))
:qid data_elim_Bug126.EVar))

:named data_elim_Bug126.EVar))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,4-24,8)
...
@x2)
Bug126.exp))
:qid data_elim_Bug126.ELam))

:named data_elim_Bug126.ELam))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,4-23,8)
...
@x2)
Bug126.exp))
:qid data_elim_Bug126.EApp))

:named data_elim_Bug126.EApp))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! (= 176
(Term_constr_id Bug126.exp))
:named constructor_distinct_Bug126.exp))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,4-22,8)
(forall ((@x0 Term))
 (! (= 184
(Term_constr_id (Bug126.EVar @x0)))
 

:pattern ((Bug126.EVar @x0))
:qid constructor_distinct_Bug126.EVar))

:named constructor_distinct_Bug126.EVar))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! (= 182
(Term_constr_id Bug126.EUnit))
:named constructor_distinct_Bug126.EUnit))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,4-24,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 194
(Term_constr_id (Bug126.ELam @x0
@x1)))
 

:pattern ((Bug126.ELam @x0
@x1))
:qid constructor_distinct_Bug126.ELam))

:named constructor_distinct_Bug126.ELam))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,4-23,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 189
(Term_constr_id (Bug126.EApp @x0
@x1)))
 

:pattern ((Bug126.EApp @x0
@x1))
:qid constructor_distinct_Bug126.EApp))

:named constructor_distinct_Bug126.EApp))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! 
...
@x0
Bug126.exp))
:qid Bug126_pretyping_dfbfa7ed6d2152337b3d02c0c7eb5438))

:named Bug126_pretyping_dfbfa7ed6d2152337b3d02c0c7eb5438))
(push) ;; push{4

; Starting query at Bug126.fst(20,0-24,37)
...
; Encoding query formula : Prims.hasEq Bug126.exp ==>
; (forall (x: Bug126.var).
...
; *)
;     Prims.hasEq Bug126.var) /\
; (forall (e1: Bug126.exp) (e2: Bug126.exp). Prims.hasEq Bug126.exp /\ Prims.hasEq Bug126.exp) /\
; (forall (t: Bug126.typ) (body: Bug126.exp). Prims.hasEq Bug126.typ /\ Prims.hasEq Bug126.exp)


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug126.exp`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=Bug126.fst(20,0-24,37); use=Bug126.fst(20,0-24,37)
(Valid 
;; def=Bug126.fst(20,0-24,37); use=Bug126.fst(20,0-24,37)
(Prims.hasEq Bug126.exp)
)
...
;; def=Bug126.fst(20,0-24,37); use=Bug126.fst(22,15-22,18)
(or label_1
...
;; def=Bug126.fst(20,0-24,37); use=Bug126.fst(20,0-24,37)
(and 
;; def=Bug126.fst(20,0-24,37); use=Bug126.fst(23,16-23,19)
(or label_2
...
;; def=Bug126.fst(20,0-24,37); use=Bug126.fst(23,26-23,29)
(or label_3
...
;; def=Bug126.fst(20,0-24,37); use=Bug126.fst(20,0-24,37)
(and 
;; def=Bug126.fst(20,0-24,37); use=Bug126.fst(24,15-24,18)
(or label_4
...
;; def=Bug126.fst(20,0-24,37); use=Bug126.fst(24,27-24,30)
(or label_5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.exp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Bug126.typ__uu___haseq, equation_Bug126.var, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
; encoding sigelt assume Bug126.exp__uu___haseq


; <Start encoding assume Bug126.exp__uu___haseq>


; </end encoding assume Bug126.exp__uu___haseq>


; encoding sigelt val Bug126.uu___is_EUnit


; <Start encoding val Bug126.uu___is_EUnit>

(declare-fun Bug126.uu___is_EUnit (Term) Term)
;;;;;;;;;;;;;;;;projectee: exp -> Prims.bool
(declare-fun Tm_arrow_bc10324af14ccbd577b7658779a5f5b4 () Term)
(declare-fun Bug126.uu___is_EUnit@tok () Term)

; </end encoding val Bug126.uu___is_EUnit>


; encoding sigelt let uu___is_EUnit


; <Skipped let uu___is_EUnit/>


; encoding sigelt val Bug126.uu___is_EVar


; <Start encoding val Bug126.uu___is_EVar>

(declare-fun Bug126.uu___is_EVar (Term) Term)

(declare-fun Bug126.uu___is_EVar@tok () Term)

; </end encoding val Bug126.uu___is_EVar>
...
; encoding sigelt val Bug126.__proj__EVar__item__x


; <Start encoding val Bug126.__proj__EVar__item__x>

(declare-fun Tm_refine_46117f0e2abf87e3f99ab2933dff06d7 () Term)
(declare-fun Bug126.__proj__EVar__item__x (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: exp{EVar? _} -> var
(declare-fun Tm_arrow_198808f85fe0a847edff02358886bf7d () Term)
(declare-fun Bug126.__proj__EVar__item__x@tok () Term)

; </end encoding val Bug126.__proj__EVar__item__x>
...
:named typing_Bug126.var))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.uu___is_EVar; Namespace Bug126
(assert (! 
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,4-22,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug126.exp)
(HasType (Bug126.uu___is_EVar @x0)
Prims.bool))
 

:pattern ((Bug126.uu___is_EVar @x0))
:qid typing_Bug126.uu___is_EVar))

:named typing_Bug126.uu___is_EVar))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,4-22,8)
...
:named refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug126.__proj__EVar__item__x; Namespace Bug126
(assert (! (HasType Tm_refine_46117f0e2abf87e3f99ab2933dff06d7
Tm_type)
:named refinement_kinding_Tm_refine_46117f0e2abf87e3f99ab2933dff06d7))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! (HasType Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_46117f0e2abf87e3f99ab2933dff06d7)
(and (HasTypeFuel @u0
@x1
Bug126.exp)

;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,4-22,8)
(BoxBool_proj_0 (Bug126.uu___is_EVar @x1))
))
...
@x1
Tm_refine_46117f0e2abf87e3f99ab2933dff06d7))
:qid refinement_interpretation_Tm_refine_46117f0e2abf87e3f99ab2933dff06d7))

:named refinement_interpretation_Tm_refine_46117f0e2abf87e3f99ab2933dff06d7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
;; def=Prims.fst(686,15-686,29); use=Prims.fst(686,15-686,29)
...
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_46117f0e2abf87e3f99ab2933dff06d7
;;; Fact-ids: Name Bug126.__proj__EVar__item__x; Namespace Bug126
(assert (! (iff (Valid (Prims.hasEq Tm_refine_46117f0e2abf87e3f99ab2933dff06d7))
(Valid (Prims.hasEq Bug126.exp)))
:named haseqTm_refine_46117f0e2abf87e3f99ab2933dff06d7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f))
(Valid (Prims.hasEq Prims.int)))
...
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,4-22,8)
(forall ((@x0 Term))
 (! (= (Bug126.uu___is_EVar @x0)
(BoxBool (is-Bug126.EVar @x0)))
 

:pattern ((Bug126.uu___is_EVar @x0))
:qid disc_equation_Bug126.EVar))

:named disc_equation_Bug126.EVar))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug126.exp; Namespace Bug126; Name Bug126.EUnit; Namespace Bug126; Name Bug126.EVar; Namespace Bug126; Name Bug126.EApp; Namespace Bug126; Name Bug126.ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,4-22,8)
...
:named constructor_distinct_Bug126.EApp))
;;;;;;;;;;;;;;;;Assumption: Bug126.exp__uu___haseq
;;; Fact-ids: Name Bug126.exp__uu___haseq; Namespace Bug126
(assert (! (Valid (Prims.hasEq Bug126.exp))
:named assumption_Bug126.exp__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! 
;; def=Prims.fst(514,5-514,8); use=Prims.fst(514,5-514,8)
...
; Starting query at Bug126.fst(22,13-22,14)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: Bug126.exp{EVar? _}).
;   (*  - Could not prove post-condition
; *) ~(EVar? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__EVar__item__x`
...
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,13-22,14)
(not 
;; def=Bug126.fst(22,4-22,8); use=Bug126.fst(22,13-22,14)
(BoxBool_proj_0 (Bug126.uu___is_EVar @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__EVar__item__x, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_46117f0e2abf87e3f99ab2933dff06d7
...
; encoding sigelt let __proj__EVar__item__x


; <Skipped let __proj__EVar__item__x/>


; encoding sigelt val Bug126.uu___is_EApp


; <Start encoding val Bug126.uu___is_EApp>

(declare-fun Bug126.uu___is_EApp (Term) Term)

(declare-fun Bug126.uu___is_EApp@tok () Term)

; </end encoding val Bug126.uu___is_EApp>
...
; encoding sigelt val Bug126.__proj__EApp__item__e1


; <Start encoding val Bug126.__proj__EApp__item__e1>

(declare-fun Tm_refine_6300b515f777a9f030ddad14cfe46268 () Term)
(declare-fun Bug126.__proj__EApp__item__e1 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: exp{EApp? _} -> exp
(declare-fun Tm_arrow_76fa7885a7927d994e1d51527f3edbcd () Term)
(declare-fun Bug126.__proj__EApp__item__e1@tok () Term)

; </end encoding val Bug126.__proj__EApp__item__e1>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.uu___is_EApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,4-23,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug126.exp)
(HasType (Bug126.uu___is_EApp @x0)
Prims.bool))
 

:pattern ((Bug126.uu___is_EApp @x0))
:qid typing_Bug126.uu___is_EApp))

:named typing_Bug126.uu___is_EApp))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug126.__proj__EApp__item__e1; Namespace Bug126
(assert (! (HasType Tm_refine_6300b515f777a9f030ddad14cfe46268
Tm_type)
:named refinement_kinding_Tm_refine_6300b515f777a9f030ddad14cfe46268))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug126.__proj__EApp__item__e1; Namespace Bug126
(assert (! 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,4-23,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_6300b515f777a9f030ddad14cfe46268)
(and (HasTypeFuel @u0
@x1
Bug126.exp)

;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,4-23,8)
(BoxBool_proj_0 (Bug126.uu___is_EApp @x1))
))
...
@x1
Tm_refine_6300b515f777a9f030ddad14cfe46268))
:qid refinement_interpretation_Tm_refine_6300b515f777a9f030ddad14cfe46268))

:named refinement_interpretation_Tm_refine_6300b515f777a9f030ddad14cfe46268))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6300b515f777a9f030ddad14cfe46268
;;; Fact-ids: Name Bug126.__proj__EApp__item__e1; Namespace Bug126
(assert (! (iff (Valid (Prims.hasEq Tm_refine_6300b515f777a9f030ddad14cfe46268))
(Valid (Prims.hasEq Bug126.exp)))
:named haseqTm_refine_6300b515f777a9f030ddad14cfe46268))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug126.uu___is_EApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,4-23,8)
(forall ((@x0 Term))
 (! (= (Bug126.uu___is_EApp @x0)
(BoxBool (is-Bug126.EApp @x0)))
 

:pattern ((Bug126.uu___is_EApp @x0))
:qid disc_equation_Bug126.EApp))

:named disc_equation_Bug126.EApp))
(push) ;; push{2

; Starting query at Bug126.fst(23,13-23,15)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: Bug126.exp{EApp? _}).
;   (*  - Could not prove post-condition
; *) ~(EApp? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__EApp__item__e1`
...
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,13-23,15)
(not 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,13-23,15)
(BoxBool_proj_0 (Bug126.uu___is_EApp @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__EApp__item__e1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_6300b515f777a9f030ddad14cfe46268
...
; encoding sigelt let __proj__EApp__item__e1


; <Skipped let __proj__EApp__item__e1/>


; encoding sigelt val Bug126.__proj__EApp__item__e2


; <Start encoding val Bug126.__proj__EApp__item__e2>


(declare-fun Bug126.__proj__EApp__item__e2 (Term) Term)


(declare-fun Bug126.__proj__EApp__item__e2@tok () Term)

; </end encoding val Bug126.__proj__EApp__item__e2>

(push) ;; push{2

; Starting query at Bug126.fst(23,23-23,25)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__EApp__item__e2`
...
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,23-23,25)
(not 
;; def=Bug126.fst(23,4-23,8); use=Bug126.fst(23,23-23,25)
(BoxBool_proj_0 (Bug126.uu___is_EApp @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__EApp__item__e2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_6300b515f777a9f030ddad14cfe46268
...
; encoding sigelt let __proj__EApp__item__e2


; <Skipped let __proj__EApp__item__e2/>


; encoding sigelt val Bug126.uu___is_ELam


; <Start encoding val Bug126.uu___is_ELam>

(declare-fun Bug126.uu___is_ELam (Term) Term)

(declare-fun Bug126.uu___is_ELam@tok () Term)

; </end encoding val Bug126.uu___is_ELam>


; encoding sigelt let uu___is_ELam


; <Skipped let uu___is_ELam/>


; encoding sigelt val Bug126.__proj__ELam__item__t


; <Start encoding val Bug126.__proj__ELam__item__t>

(declare-fun Tm_refine_8144cd34f51c347b0afc7992a2a47ee2 () Term)
(declare-fun Bug126.__proj__ELam__item__t (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: exp{ELam? _} -> typ
(declare-fun Tm_arrow_90c5ea2966c8f779e6c45f640c0aaae2 () Term)
(declare-fun Bug126.__proj__ELam__item__t@tok () Term)

; </end encoding val Bug126.__proj__ELam__item__t>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.uu___is_ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,4-24,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug126.exp)
(HasType (Bug126.uu___is_ELam @x0)
Prims.bool))
 

:pattern ((Bug126.uu___is_ELam @x0))
:qid typing_Bug126.uu___is_ELam))

:named typing_Bug126.uu___is_ELam))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug126.__proj__ELam__item__t; Namespace Bug126
(assert (! (HasType Tm_refine_8144cd34f51c347b0afc7992a2a47ee2
Tm_type)
:named refinement_kinding_Tm_refine_8144cd34f51c347b0afc7992a2a47ee2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug126.__proj__ELam__item__t; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,4-24,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_8144cd34f51c347b0afc7992a2a47ee2)
(and (HasTypeFuel @u0
@x1
Bug126.exp)

;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,4-24,8)
(BoxBool_proj_0 (Bug126.uu___is_ELam @x1))
))
...
@x1
Tm_refine_8144cd34f51c347b0afc7992a2a47ee2))
:qid refinement_interpretation_Tm_refine_8144cd34f51c347b0afc7992a2a47ee2))

:named refinement_interpretation_Tm_refine_8144cd34f51c347b0afc7992a2a47ee2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8144cd34f51c347b0afc7992a2a47ee2
;;; Fact-ids: Name Bug126.__proj__ELam__item__t; Namespace Bug126
(assert (! (iff (Valid (Prims.hasEq Tm_refine_8144cd34f51c347b0afc7992a2a47ee2))
(Valid (Prims.hasEq Bug126.exp)))
:named haseqTm_refine_8144cd34f51c347b0afc7992a2a47ee2))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug126.uu___is_ELam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,4-24,8)
(forall ((@x0 Term))
 (! (= (Bug126.uu___is_ELam @x0)
(BoxBool (is-Bug126.ELam @x0)))
 

:pattern ((Bug126.uu___is_ELam @x0))
:qid disc_equation_Bug126.ELam))

:named disc_equation_Bug126.ELam))
(push) ;; push{2

; Starting query at Bug126.fst(24,13-24,14)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: Bug126.exp{ELam? _}).
;   (*  - Could not prove post-condition
; *) ~(ELam? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__ELam__item__t`
...
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,13-24,14)
(not 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,13-24,14)
(BoxBool_proj_0 (Bug126.uu___is_ELam @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__ELam__item__t, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_8144cd34f51c347b0afc7992a2a47ee2
...
; encoding sigelt let __proj__ELam__item__t


; <Skipped let __proj__ELam__item__t/>


; encoding sigelt val Bug126.__proj__ELam__item__body


; <Start encoding val Bug126.__proj__ELam__item__body>


(declare-fun Bug126.__proj__ELam__item__body (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: exp{ELam? _} -> exp
(declare-fun Tm_arrow_1e7ccd0488d7cfc01fa82e0b47fc039b () Term)
(declare-fun Bug126.__proj__ELam__item__body@tok () Term)

; </end encoding val Bug126.__proj__ELam__item__body>

(push) ;; push{2

; Starting query at Bug126.fst(24,22-24,26)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__ELam__item__body`
...
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,22-24,26)
(not 
;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(24,22-24,26)
(BoxBool_proj_0 (Bug126.uu___is_ELam @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__ELam__item__body, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_8144cd34f51c347b0afc7992a2a47ee2
...
; encoding sigelt let __proj__ELam__item__body


; <Skipped let __proj__ELam__item__body/>
...
(declare-fun Bug126.env () Term)
;;;;;;;;;;;;;;;;_: var -> FStar.Pervasives.Native.option typ
(declare-fun Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1 () Term)

; </end encoding let env>


; encoding sigelt val Bug126.extend


; <Skipped val Bug126.extend/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.env; Namespace Bug126
(assert (! (HasType Bug126.env
Tm_type)
:named typing_Bug126.env))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1
;;; Fact-ids: Name Bug126.env; Namespace Bug126
(assert (! (HasType Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1
Tm_type)
:named kinding_Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
(assert (! (HasType Bug126.env
Tm_type)
:named function_token_typing_Bug126.env))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;Equation for Bug126.env
;;; Fact-ids: Name Bug126.env; Namespace Bug126
(assert (! (= Bug126.env
Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1)
:named equation_Bug126.env))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;;; Fact-ids: Name Bug126.env; Namespace Bug126
(assert (! 
;; def=Bug126.fst(26,11-26,34); use=Bug126.fst(26,11-26,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1)
...
@x1
Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1))
:qid Bug126_pre_typing_Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1))

:named Bug126_pre_typing_Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1
;;; Fact-ids: Name Bug126.env; Namespace Bug126
(assert (! 
;; def=Bug126.fst(26,11-26,34); use=Bug126.fst(26,11-26,34)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(FStar.Pervasives.Native.option Bug126.typ)))
 

:pattern ((ApplyTT @x0
@x1))
:qid Bug126_interpretation_Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1))
:qid Bug126_interpretation_Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1))

:named Bug126_interpretation_Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1))
(push) ;; push{2

; Starting query at Bug126.fst(28,19-28,52)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (g: Bug126.env) (t: Bug126.typ) (y: Bug126.var).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post (FStar.Pervasives.Native.option Bug126.typ)).
;     (forall (x: FStar.Pervasives.Native.option Bug126.typ). {:pattern Prims.guard_free (k x)}
;         Prims.auto_squash (k x)) ==>
;     ~(y = 0 = true) ==> (forall (b: Prims.bool). y = 0 == b ==> y - 1 >= 0)
...
(Prims.pure_post (FStar.Pervasives.Native.option Bug126.typ)))

;; def=Prims.fst(402,27-402,88); use=Bug126.fst(28,19-28,52)
(forall ((@x4 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug126.fst(28,19-28,52)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug126.fst(28,19-28,52)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(389,19-389,21); use=Bug126.fst(28,19-28,52)
(not 
;; def=Bug126.fst(28,22-28,25); use=Bug126.fst(28,22-28,25)
...
;; def=Prims.fst(413,99-413,120); use=Bug126.fst(28,19-28,52)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.bool)

;; def=Bug126.fst(28,22-28,52); use=Bug126.fst(28,22-28,52)
(= (Prims.op_Equality Prims.int
@x2
(BoxInt 0))
@x4)
...
;; def=Prims.fst(680,18-680,24); use=Bug126.fst(28,45-28,52)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.extend, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Bug126.var, equation_Prims.nat, int_inversion, primitive_Prims.op_Equality, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
...
(declare-fun Bug126.extend (Term Term) Term)
;;;;;;;;;;;;;;;;g: env -> t: typ -> env
(declare-fun Tm_arrow_1b8d3731e51ccecec9df85e26c93fada () Term)
(declare-fun Bug126.extend@tok () Term)

(declare-fun Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae (Term Term) Term)
...
; Starting query at Bug126.fst(29,5-40,37)

(declare-fun Bug126.typing (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: env -> _: exp -> _: typ -> Type
(declare-fun Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6
Tm_type)
:named kinding_Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug126.fst(29,19-29,44); use=Bug126.fst(29,19-29,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6))
:qid Bug126_pre_typing_Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6))

:named Bug126_pre_typing_Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6
;;; Fact-ids: 
(assert (! 
;; def=Bug126.fst(29,19-29,44); use=Bug126.fst(29,19-29,44)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid Bug126_interpretation_Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug126_interpretation_Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6.2))
...
@x1)
@x2))
:qid Bug126_interpretation_Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6))
:qid Bug126_interpretation_Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6))

:named Bug126_interpretation_Tm_arrow_04cc09a8fa8a7b74f3ec9f948d0100f6))
(declare-fun Bug126.typing@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug126.fst(29,10-29,16); use=Bug126.fst(29,10-29,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Bug126.typing@tok
@x0)
@x1)
@x2)
(Bug126.typing @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Bug126.typing@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Bug126.typing))

:named token_correspondence_Bug126.typing))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug126.fst(29,10-29,16); use=Bug126.fst(29,10-29,16)
...
:pattern ((Bug126.typing @x1
@x2
@x3))
:qid function_token_typing_Bug126.typing.1))
)
 

:pattern ((ApplyTT @x0
Bug126.typing@tok))
:qid function_token_typing_Bug126.typing))

:named function_token_typing_Bug126.typing))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug126.fst(29,10-29,16); use=Bug126.fst(29,10-29,16)
...
(HasType @x2
Bug126.typ))
(HasType (Bug126.typing @x0
@x1
@x2)
Tm_type))
 

:pattern ((Bug126.typing @x0
@x1
@x2))
:qid typing_Bug126.typing))

:named typing_Bug126.typing))
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_568849ef81103d54de1b5cc62340abd7 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug126.fst(32,22-32,40); use=Bug126.fst(32,22-32,40)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_568849ef81103d54de1b5cc62340abd7 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_568849ef81103d54de1b5cc62340abd7 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_568849ef81103d54de1b5cc62340abd7))

:named refinement_kinding_Tm_refine_568849ef81103d54de1b5cc62340abd7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug126.fst(32,22-32,40); use=Bug126.fst(32,22-32,40)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_568849ef81103d54de1b5cc62340abd7 @x2))
(and (HasTypeFuel @u0
@x1
Bug126.var)

;; def=Bug126.fst(32,28-32,39); use=Bug126.fst(32,28-32,39)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some Bug126.typ
(ApplyTT @x2
@x1)))
))
...
@x1
(Tm_refine_568849ef81103d54de1b5cc62340abd7 @x2)))
:qid refinement_interpretation_Tm_refine_568849ef81103d54de1b5cc62340abd7))

:named refinement_interpretation_Tm_refine_568849ef81103d54de1b5cc62340abd7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_568849ef81103d54de1b5cc62340abd7
;;; Fact-ids: 
(assert (! 
;; def=Bug126.fst(32,22-32,40); use=Bug126.fst(32,22-32,40)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_568849ef81103d54de1b5cc62340abd7 @x0)))
(Valid (Prims.hasEq Bug126.var)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_568849ef81103d54de1b5cc62340abd7 @x0))))
:qid haseqTm_refine_568849ef81103d54de1b5cc62340abd7))

:named haseqTm_refine_568849ef81103d54de1b5cc62340abd7))

; Encoding query formula : forall (g: Bug126.env) (x: Bug126.var{Some? (g x)}).
;   (*  - Subtyping check failed
;   - Expected type _: FStar.Pervasives.Native.option typ {Some? _}
;     got type FStar.Pervasives.Native.option typ
; *)
;   Some? (g x)


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug126.typing`
...
Bug126.env)
(HasType @x1
(Tm_refine_568849ef81103d54de1b5cc62340abd7 @x0)))

;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=Bug126.fst(33,39-33,44)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.typing, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_568849ef81103d54de1b5cc62340abd7
...
; encoding sigelt type Bug126.typing


; <Start encoding type Bug126.typing>
...
(declare-fun Bug126.typing@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.TyUn (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyUn_g (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug126.TyUn
(declare-fun Bug126.TyUn@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.TyVar (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyVar_g (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyVar_x (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug126.TyVar
(declare-fun Bug126.TyVar@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.TyLam (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyLam_g (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyLam_t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyLam_e1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyLam_t_ (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyLam__4 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug126.TyLam
(declare-fun Bug126.TyLam@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug126.TyApp (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyApp_g (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyApp_e1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyApp_e2 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyApp_t11 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyApp_t12 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyApp__5 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug126.TyApp__6 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug126.TyApp
(declare-fun Bug126.TyApp@tok () Term)
;;;;;;;;;;;;;;;;typing g EUnit TUnit
(declare-fun Tm_arrow_b4c680c29fd43d4c42764a01c09f9159 () Term)
(declare-fun Tm_refine_568849ef81103d54de1b5cc62340abd7 (Term) Term)

;;;;;;;;;;;;;;;;x: var{Some? (g x)} -> typing g (EVar x) (g x).v
(declare-fun Tm_arrow_f9abdfd793502302928b152e78f5657a () Term)
;;;;;;;;;;;;;;;;t: typ -> _4: typing (extend g t) e1 t' -> typing g (ELam t e1) (TArr t t')
(declare-fun Tm_arrow_824b4fb5848fdca4e806d98f4301fd71 () Term)
;;;;;;;;;;;;;;;;_5: typing g e1 (TArr t11 t12) -> _6: typing g e2 t11 -> typing g (EApp e1 e2) t12
(declare-fun Tm_arrow_679a016d77503386657886df5ba0df6e () Term)

; <start constructor Bug126.typing>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.typing ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
262)
(exists ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= __@x0
...
;;no pats
:qid is-Bug126.typing))))

; </end constructor Bug126.typing>


; <start constructor Bug126.TyUn>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.TyUn ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
269)
(= __@x0
(Bug126.TyUn (Bug126.TyUn_g __@x0)))))

; </end constructor Bug126.TyUn>


; <start constructor Bug126.TyVar>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.TyVar ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
278)
(= __@x0
(Bug126.TyVar (Bug126.TyVar_g __@x0)
(Bug126.TyVar_x __@x0)))))

; </end constructor Bug126.TyVar>


; <start constructor Bug126.TyLam>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.TyLam ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
287)
(= __@x0
(Bug126.TyLam (Bug126.TyLam_g __@x0)
(Bug126.TyLam_t __@x0)
(Bug126.TyLam_e1 __@x0)
(Bug126.TyLam_t_ __@x0)
(Bug126.TyLam__4 __@x0)))))

; </end constructor Bug126.TyLam>


; <start constructor Bug126.TyApp>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug126.TyApp ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
295)
(= __@x0
(Bug126.TyApp (Bug126.TyApp_g __@x0)
(Bug126.TyApp_e1 __@x0)
(Bug126.TyApp_e2 __@x0)
(Bug126.TyApp_t11 __@x0)
(Bug126.TyApp_t12 __@x0)
(Bug126.TyApp__5 __@x0)
(Bug126.TyApp__6 __@x0)))))

; </end constructor Bug126.TyApp>


; </end encoding type Bug126.typing>


; encoding sigelt val Bug126.uu___is_TyUn


; <Start encoding val Bug126.uu___is_TyUn>

(declare-fun Bug126.uu___is_TyUn (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: typing _ _ _ -> Prims.bool
(declare-fun Tm_arrow_db7e88f97152891f885c589741b989c5 () Term)
(declare-fun Bug126.uu___is_TyUn@tok () Term)

; </end encoding val Bug126.uu___is_TyUn>


; encoding sigelt let uu___is_TyUn


; <Skipped let uu___is_TyUn/>


; encoding sigelt val Bug126.__proj__TyUn__item__g


; <Start encoding val Bug126.__proj__TyUn__item__g>

(declare-fun Tm_refine_531db1cadfe529187eb7a92f8711a848 (Term Term Term) Term)
(declare-fun Bug126.__proj__TyUn__item__g (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyUn? _} -> env
(declare-fun Tm_arrow_49b7b3005e9662c4056f345dde32d496 () Term)
(declare-fun Bug126.__proj__TyUn__item__g@tok () Term)

; </end encoding val Bug126.__proj__TyUn__item__g>

;;;;;;;;;;;;;;;;typing_Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae
;;; Fact-ids: Name Bug126.extend; Namespace Bug126
(assert (! 
;; def=Bug126.fst(28,19-28,52); use=Bug126.fst(28,19-28,52)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae @x0
@x1)
Tm_arrow_88c37ded21b87ff48cf4c31a5827e8c1)
 

:pattern ((Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae @x0
@x1))
:qid typing_Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae))

:named typing_Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.uu___is_TyUn; Namespace Bug126
(assert (! 
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,4-30,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Bug126.env)
(HasType @x1
...
@x1
@x2)))
(HasType (Bug126.uu___is_TyUn @x0
@x1
@x2
@x3)
Prims.bool))
...
:pattern ((Bug126.uu___is_TyUn @x0
@x1
@x2
@x3))
:qid typing_Bug126.uu___is_TyUn))

:named typing_Bug126.uu___is_TyUn))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.extend; Namespace Bug126
(assert (! 
;; def=Bug126.fst(28,4-28,10); use=Bug126.fst(28,4-28,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Bug126.env)
(HasType @x1
Bug126.typ))
(HasType (Bug126.extend @x0
@x1)
Bug126.env))
 

:pattern ((Bug126.extend @x0
@x1))
:qid typing_Bug126.extend))

:named typing_Bug126.extend))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(29,10-29,16); use=Bug126.fst(29,10-29,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Bug126.typing@tok
...
@x1
@x2))
:qid token_correspondence_Bug126.typing@tok))

:named token_correspondence_Bug126.typing@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
...
@x4
@x5)))
:qid subterm_ordering_Bug126.TyVar))

:named subterm_ordering_Bug126.TyVar))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,4-30,8)
...
@x3
@x4)))
:qid subterm_ordering_Bug126.TyUn))

:named subterm_ordering_Bug126.TyUn))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
...
@x7
@x8)))
:qid subterm_ordering_Bug126.TyLam))

:named subterm_ordering_Bug126.TyLam))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
...
@x9
@x10)))
:qid subterm_ordering_Bug126.TyApp))

:named subterm_ordering_Bug126.TyApp))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,22-32,40); use=Bug126.fst(32,22-32,40)
...
:named refinement_kinding_Tm_refine_568849ef81103d54de1b5cc62340abd7))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug126.__proj__TyUn__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,4-30,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_531db1cadfe529187eb7a92f8711a848 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_531db1cadfe529187eb7a92f8711a848 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_531db1cadfe529187eb7a92f8711a848))

:named refinement_kinding_Tm_refine_531db1cadfe529187eb7a92f8711a848))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Pervasives.Native.__proj__Some__item__v; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=FStar.Pervasives.Native.fst(33,4-33,8)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_531db1cadfe529187eb7a92f8711a848 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,4-30,8)
(BoxBool_proj_0 (Bug126.uu___is_TyUn @x2
@x3
@x4
@x1))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_531db1cadfe529187eb7a92f8711a848))

:named refinement_interpretation_Tm_refine_531db1cadfe529187eb7a92f8711a848))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.Native.__proj__Some__item__v; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=FStar.Pervasives.Native.fst(33,4-33,8)
...
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug126.TyVar_x (Bug126.TyVar @x0
@x1))
@x1)
 

:pattern ((Bug126.TyVar @x0
@x1))
:qid projection_inverse_Bug126.TyVar_x))

:named projection_inverse_Bug126.TyVar_x))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug126.TyVar_g (Bug126.TyVar @x0
@x1))
@x0)
...
:pattern ((Bug126.TyVar @x0
@x1))
:qid projection_inverse_Bug126.TyVar_g))

:named projection_inverse_Bug126.TyVar_g))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,4-30,8)
(forall ((@x0 Term))
 (! (= (Bug126.TyUn_g (Bug126.TyUn @x0))
@x0)
 

:pattern ((Bug126.TyUn @x0))
:qid projection_inverse_Bug126.TyUn_g))

:named projection_inverse_Bug126.TyUn_g))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Bug126.TyLam_t_ (Bug126.TyLam @x0
@x1
@x2
@x3
@x4))
...
:pattern ((Bug126.TyLam @x0
@x1
@x2
@x3
@x4))
:qid projection_inverse_Bug126.TyLam_t_))

:named projection_inverse_Bug126.TyLam_t_))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Bug126.TyLam_t (Bug126.TyLam @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Bug126.TyLam_t))

:named projection_inverse_Bug126.TyLam_t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Bug126.TyLam_g (Bug126.TyLam @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Bug126.TyLam_g))

:named projection_inverse_Bug126.TyLam_g))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Bug126.TyLam_e1 (Bug126.TyLam @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Bug126.TyLam_e1))

:named projection_inverse_Bug126.TyLam_e1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Bug126.TyLam__4 (Bug126.TyLam @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Bug126.TyLam__4))

:named projection_inverse_Bug126.TyLam__4))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (Bug126.TyApp_t12 (Bug126.TyApp @x0
@x1
@x2
@x3
@x4
...
@x5
@x6))
:qid projection_inverse_Bug126.TyApp_t12))

:named projection_inverse_Bug126.TyApp_t12))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (Bug126.TyApp_t11 (Bug126.TyApp @x0
@x1
@x2
@x3
@x4
...
@x5
@x6))
:qid projection_inverse_Bug126.TyApp_t11))

:named projection_inverse_Bug126.TyApp_t11))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (Bug126.TyApp_g (Bug126.TyApp @x0
@x1
@x2
@x3
@x4
...
@x5
@x6))
:qid projection_inverse_Bug126.TyApp_g))

:named projection_inverse_Bug126.TyApp_g))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (Bug126.TyApp_e2 (Bug126.TyApp @x0
@x1
@x2
@x3
@x4
...
@x5
@x6))
:qid projection_inverse_Bug126.TyApp_e2))

:named projection_inverse_Bug126.TyApp_e2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (Bug126.TyApp_e1 (Bug126.TyApp @x0
@x1
@x2
@x3
@x4
...
@x5
@x6))
:qid projection_inverse_Bug126.TyApp_e1))

:named projection_inverse_Bug126.TyApp_e1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (Bug126.TyApp__6 (Bug126.TyApp @x0
@x1
@x2
@x3
@x4
...
@x5
@x6))
:qid projection_inverse_Bug126.TyApp__6))

:named projection_inverse_Bug126.TyApp__6))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (Bug126.TyApp__5 (Bug126.TyApp @x0
@x1
@x2
@x3
@x4
...
@x5
@x6))
:qid projection_inverse_Bug126.TyApp__5))

:named projection_inverse_Bug126.TyApp__5))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name FStar.Pervasives.Native.__proj__Some__item__v; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,11-33,12); use=FStar.Pervasives.Native.fst(33,11-33,12)
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! (is-Tm_arrow (PreType Bug126.typing@tok))
:named pre_kinding_Bug126.typing@tok))
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! (and (IsTotFun Bug126.typing@tok)

;; def=Bug126.fst(29,10-29,16); use=Bug126.fst(29,10-29,16)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Bug126.typing@tok
@x0))
 

:pattern ((ApplyTT Bug126.typing@tok
@x0))
:qid kinding_Bug126.typing@tok))


;; def=Bug126.fst(29,10-29,16); use=Bug126.fst(29,10-29,16)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (ApplyTT (ApplyTT Bug126.typing@tok
@x0)
@x1))
 

:pattern ((ApplyTT (ApplyTT Bug126.typing@tok
@x0)
@x1))
:qid kinding_Bug126.typing@tok.1))
...
@x1
@x2))
:qid kinding_Bug126.typing@tok.2))
)
:named kinding_Bug126.typing@tok))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae
;;; Fact-ids: Name Bug126.extend; Namespace Bug126
(assert (! 
;; def=Bug126.fst(28,19-28,52); use=Bug126.fst(28,19-28,52)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae @x1
@x2)
@x0)
...
(ite (= @lb3
(BoxBool true))
(FStar.Pervasives.Native.Some Bug126.typ
@x1)
(ApplyTT @x2
(Prims.op_Subtraction @x0
(BoxInt 1))))))
...
:pattern ((ApplyTT (Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae @x1
@x2)
@x0))
:qid interpretation_Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae))

:named interpretation_Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae))
;;;;;;;;;;;;;;;;haseq for Tm_refine_568849ef81103d54de1b5cc62340abd7
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,22-32,40); use=Bug126.fst(32,22-32,40)
...
:named haseqTm_refine_568849ef81103d54de1b5cc62340abd7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_531db1cadfe529187eb7a92f8711a848
;;; Fact-ids: Name Bug126.__proj__TyUn__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,4-30,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_531db1cadfe529187eb7a92f8711a848 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Bug126.typing @x0
@x1
@x2))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_531db1cadfe529187eb7a92f8711a848 @x0
@x1
@x2))))
:qid haseqTm_refine_531db1cadfe529187eb7a92f8711a848))

:named haseqTm_refine_531db1cadfe529187eb7a92f8711a848))
...
(= @x4
Bug126.TUnit@tok))
(and (is-Bug126.TyVar @x1)
(= @x2
(Bug126.TyVar_g @x1))
(= @x3
(Bug126.EVar (Bug126.TyVar_x @x1)))
(= @x4
(FStar.Pervasives.Native.__proj__Some__item__v Bug126.typ
(ApplyTT (Bug126.TyVar_g @x1)
(Bug126.TyVar_x @x1)))))
(and (is-Bug126.TyLam @x1)
(= @x2
(Bug126.TyLam_g @x1))
(= @x3
(Bug126.ELam (Bug126.TyLam_t @x1)
(Bug126.TyLam_e1 @x1)))
(= @x4
(Bug126.TArr (Bug126.TyLam_t @x1)
(Bug126.TyLam_t_ @x1))))
(and (is-Bug126.TyApp @x1)
(= @x2
(Bug126.TyApp_g @x1))
(= @x3
(Bug126.EApp (Bug126.TyApp_e1 @x1)
(Bug126.TyApp_e2 @x1)))
(= @x4
(Bug126.TyApp_t12 @x1)))))
...
@x3
@x4)))
:qid fuel_guarded_inversion_Bug126.typing))

:named fuel_guarded_inversion_Bug126.typing))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! (= 263
(Term_constr_id Bug126.typing@tok))
:named fresh_token_Bug126.typing@tok))
;;;;;;;;;;;;;;;;Equation for Bug126.extend
;;; Fact-ids: Name Bug126.extend; Namespace Bug126
(assert (! 
;; def=Bug126.fst(28,4-28,10); use=Bug126.fst(28,4-28,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug126.extend @x0
@x1)
(Tm_abs_3f2a32e64f6e132bad4bd8860877f3ae @x1
@x0))
 

:pattern ((Bug126.extend @x0
@x1))
:qid equation_Bug126.extend))

:named equation_Bug126.extend))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug126.uu___is_TyUn; Namespace Bug126
(assert (! 
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,4-30,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.uu___is_TyUn @x0
@x1
@x2
@x3)
(BoxBool (is-Bug126.TyUn @x3)))
...
@x2
@x3))
:qid disc_equation_Bug126.TyUn))

:named disc_equation_Bug126.TyUn))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
...
(HasTypeFuel @u0
@x2
(Tm_refine_568849ef81103d54de1b5cc62340abd7 @x1))
(= @x1
@x3)
(= (Bug126.EVar @x2)
@x4)
...
@x4
@x5)))
:qid data_typing_intro_Bug126.TyVar@tok))

:named data_typing_intro_Bug126.TyVar@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,4-30,8)
...
@x3
@x4)))
:qid data_typing_intro_Bug126.TyUn@tok))

:named data_typing_intro_Bug126.TyUn@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
...
(HasTypeFuel @u0
@x5
(Bug126.typing (Bug126.extend @x1
@x2)
@x3
@x4))
(= @x1
...
@x7
@x8)))
:qid data_typing_intro_Bug126.TyLam@tok))

:named data_typing_intro_Bug126.TyLam@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
...
@x9
@x10)))
:qid data_typing_intro_Bug126.TyApp@tok))

:named data_typing_intro_Bug126.TyApp@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
...
@x4
@x5))
(and (= (FStar.Pervasives.Native.__proj__Some__item__v Bug126.typ
(ApplyTT @x1
@x2))
@x5)
(= (Bug126.EVar @x2)
...
@x4
@x5)))
:qid data_elim_Bug126.TyVar))

:named data_elim_Bug126.TyVar))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,4-30,8)
...
@x3
@x4)))
:qid data_elim_Bug126.TyUn))

:named data_elim_Bug126.TyUn))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
...
@x7
@x8)))
:qid data_elim_Bug126.TyLam))

:named data_elim_Bug126.TyLam))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
...
@x9
@x10)))
:qid data_elim_Bug126.TyApp))

:named data_elim_Bug126.TyApp))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(29,10-29,16); use=Bug126.fst(29,10-29,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 262
(Term_constr_id (Bug126.typing @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_Bug126.typing))

:named constructor_distinct_Bug126.typing))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= 278
(Term_constr_id (Bug126.TyVar @x0
@x1)))
 

:pattern ((Bug126.TyVar @x0
@x1))
:qid constructor_distinct_Bug126.TyVar))

:named constructor_distinct_Bug126.TyVar))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,4-30,8)
(forall ((@x0 Term))
 (! (= 269
(Term_constr_id (Bug126.TyUn @x0)))
 

:pattern ((Bug126.TyUn @x0))
:qid constructor_distinct_Bug126.TyUn))

:named constructor_distinct_Bug126.TyUn))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= 287
(Term_constr_id (Bug126.TyLam @x0
@x1
@x2
@x3
@x4)))
...
@x3
@x4))
:qid constructor_distinct_Bug126.TyLam))

:named constructor_distinct_Bug126.TyLam))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= 295
(Term_constr_id (Bug126.TyApp @x0
@x1
@x2
@x3
@x4
...
@x5
@x6))
:qid constructor_distinct_Bug126.TyApp))

:named constructor_distinct_Bug126.TyApp))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug126.typing; Namespace Bug126; Name Bug126.TyUn; Namespace Bug126; Name Bug126.TyVar; Namespace Bug126; Name Bug126.TyLam; Namespace Bug126; Name Bug126.TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(29,10-29,16); use=Bug126.fst(29,10-29,16)
...
@x3
@x4)))
:qid Bug126_pretyping_7d35d94e4f8eebd2181bd9c694e06654))

:named Bug126_pretyping_7d35d94e4f8eebd2181bd9c694e06654))
(push) ;; push{2

; Starting query at Bug126.fst(30,13-30,14)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Bug126.env)
;   (_: Bug126.exp)
;   (_: Bug126.typ)
;   (projectee: _: Bug126.typing _ _ _ {TyUn? _}).
;   (*  - Could not prove post-condition
; *) ~(TyUn? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__TyUn__item__g`
...
Bug126.typ)
(HasType @x3
(Tm_refine_531db1cadfe529187eb7a92f8711a848 @x0
@x1
@x2))

;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,13-30,14)
(not 
;; def=Bug126.fst(30,4-30,8); use=Bug126.fst(30,13-30,14)
(BoxBool_proj_0 (Bug126.uu___is_TyUn @x0
@x1
@x2
@x3))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyUn__item__g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_531db1cadfe529187eb7a92f8711a848
...
; encoding sigelt let __proj__TyUn__item__g


; <Skipped let __proj__TyUn__item__g/>


; encoding sigelt val Bug126.uu___is_TyVar


; <Start encoding val Bug126.uu___is_TyVar>

(declare-fun Bug126.uu___is_TyVar (Term Term Term Term) Term)

(declare-fun Bug126.uu___is_TyVar@tok () Term)

; </end encoding val Bug126.uu___is_TyVar>
...
; encoding sigelt val Bug126.__proj__TyVar__item__g


; <Start encoding val Bug126.__proj__TyVar__item__g>

(declare-fun Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c (Term Term Term) Term)
(declare-fun Bug126.__proj__TyVar__item__g (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyVar? _} -> env
(declare-fun Tm_arrow_86b7606e2d89715efcd4efc966f15442 () Term)
(declare-fun Bug126.__proj__TyVar__item__g@tok () Term)

; </end encoding val Bug126.__proj__TyVar__item__g>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.uu___is_TyVar; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
...
@x1
@x2)))
(HasType (Bug126.uu___is_TyVar @x0
@x1
@x2
@x3)
Prims.bool))
...
:pattern ((Bug126.uu___is_TyVar @x0
@x1
@x2
@x3))
:qid typing_Bug126.uu___is_TyVar))

:named typing_Bug126.uu___is_TyVar))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug126.__proj__TyVar__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c))

:named refinement_kinding_Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug126.__proj__TyVar__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
(BoxBool_proj_0 (Bug126.uu___is_TyVar @x2
@x3
@x4
@x1))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c))

:named refinement_interpretation_Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c
;;; Fact-ids: Name Bug126.__proj__TyVar__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c @x0
@x1
@x2)))
(Valid (Prims.hasEq (Bug126.typing @x0
@x1
...
:pattern ((Valid (Prims.hasEq (Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c @x0
@x1
@x2))))
:qid haseqTm_refine_515f421c7bd17bbf027ecc6fbafb3f6c))

:named haseqTm_refine_515f421c7bd17bbf027ecc6fbafb3f6c))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug126.uu___is_TyVar; Namespace Bug126
(assert (! 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,4-32,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.uu___is_TyVar @x0
@x1
@x2
@x3)
(BoxBool (is-Bug126.TyVar @x3)))
...
@x2
@x3))
:qid disc_equation_Bug126.TyVar))

:named disc_equation_Bug126.TyVar))
(push) ;; push{2

; Starting query at Bug126.fst(32,13-32,14)
...
;   (_: Bug126.exp)
;   (_: Bug126.typ)
;   (projectee: _: Bug126.typing _ _ _ {TyVar? _}).
;   (*  - Could not prove post-condition
...
Bug126.typ)
(HasType @x3
(Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c @x0
@x1
@x2))

;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,13-32,14)
(not 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,13-32,14)
(BoxBool_proj_0 (Bug126.uu___is_TyVar @x0
@x1
@x2
@x3))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyVar__item__g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c
...
; encoding sigelt val Bug126.__proj__TyVar__item__x


; <Start encoding val Bug126.__proj__TyVar__item__x>


(declare-fun Bug126.__proj__TyVar__item__x (Term Term Term Term) Term)

(declare-fun Tm_refine_421ebee7838b53e1e4f728f2e1cbbaa9 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyVar? _} -> x: var{Some? (projectee.g x)}
(declare-fun Tm_arrow_b964eaa9008779448c28a575f8385ebf () Term)
(declare-fun Bug126.__proj__TyVar__item__x@tok () Term)



; </end encoding val Bug126.__proj__TyVar__item__x>

(push) ;; push{2

; Starting query at Bug126.fst(32,22-32,23)
...
; *)
;   (~(TyVar? projectee) ==> Prims.l_False) /\
;   (forall (b: Bug126.env) (b: x: Bug126.var{Some? (b x)}).
;       projectee == Bug126.TyVar b ==>
;       (forall (x: Bug126.var).
;           (*  - Subtyping check failed
;   - Expected type _: typing _ _ _ {TyVar? _} got type typing g (EVar x) (g x).v
; *)
;           Bug126.EVar b == _ /\ ((b b).v == _) /\ (b == _) /\ TyVar? (Bug126.TyVar b)))
...
;; def=Prims.fst(459,77-459,89); use=Bug126.fst(32,22-32,23)
(and (implies 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,22-32,23)
(not 
;; def=Bug126.fst(32,4-32,9); use=Bug126.fst(32,22-32,23)
(BoxBool_proj_0 (Bug126.uu___is_TyVar @x0
@x1
...
;; def=Prims.fst(413,99-413,120); use=Bug126.fst(32,22-32,23)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Bug126.env)
...
(Tm_refine_568849ef81103d54de1b5cc62340abd7 @x4))
...
;; def=dummy(0,0-0,0); use=Bug126.fst(32,22-32,23)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Bug126.var)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyVar__item__x, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Bug126.TyVar, refinement_interpretation_Tm_refine_515f421c7bd17bbf027ecc6fbafb3f6c
...
; encoding sigelt val Bug126.uu___is_TyLam


; <Start encoding val Bug126.uu___is_TyLam>

(declare-fun Bug126.uu___is_TyLam (Term Term Term Term) Term)

(declare-fun Bug126.uu___is_TyLam@tok () Term)

; </end encoding val Bug126.uu___is_TyLam>


; encoding sigelt let uu___is_TyLam


; <Skipped let uu___is_TyLam/>


; encoding sigelt val Bug126.__proj__TyLam__item__g


; <Start encoding val Bug126.__proj__TyLam__item__g>

(declare-fun Tm_refine_13780dc621ffa127595a82e4cc50fd29 (Term Term Term) Term)
(declare-fun Bug126.__proj__TyLam__item__g (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyLam? _} -> env
(declare-fun Tm_arrow_614f48146a2e00c6bbdc3d45e8a6cb72 () Term)
(declare-fun Bug126.__proj__TyLam__item__g@tok () Term)

; </end encoding val Bug126.__proj__TyLam__item__g>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.uu___is_TyLam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
...
@x1
@x2)))
(HasType (Bug126.uu___is_TyLam @x0
@x1
@x2
@x3)
Prims.bool))
...
:pattern ((Bug126.uu___is_TyLam @x0
@x1
@x2
@x3))
:qid typing_Bug126.uu___is_TyLam))

:named typing_Bug126.uu___is_TyLam))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug126.__proj__TyLam__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_13780dc621ffa127595a82e4cc50fd29 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_13780dc621ffa127595a82e4cc50fd29 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_13780dc621ffa127595a82e4cc50fd29))

:named refinement_kinding_Tm_refine_13780dc621ffa127595a82e4cc50fd29))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug126.__proj__TyLam__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_13780dc621ffa127595a82e4cc50fd29 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(BoxBool_proj_0 (Bug126.uu___is_TyLam @x2
@x3
@x4
@x1))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_13780dc621ffa127595a82e4cc50fd29))

:named refinement_interpretation_Tm_refine_13780dc621ffa127595a82e4cc50fd29))
;;;;;;;;;;;;;;;;haseq for Tm_refine_13780dc621ffa127595a82e4cc50fd29
;;; Fact-ids: Name Bug126.__proj__TyLam__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_13780dc621ffa127595a82e4cc50fd29 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Bug126.typing @x0
@x1
...
:pattern ((Valid (Prims.hasEq (Tm_refine_13780dc621ffa127595a82e4cc50fd29 @x0
@x1
@x2))))
:qid haseqTm_refine_13780dc621ffa127595a82e4cc50fd29))

:named haseqTm_refine_13780dc621ffa127595a82e4cc50fd29))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug126.uu___is_TyLam; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,4-34,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.uu___is_TyLam @x0
@x1
@x2
@x3)
(BoxBool (is-Bug126.TyLam @x3)))
...
@x2
@x3))
:qid disc_equation_Bug126.TyLam))

:named disc_equation_Bug126.TyLam))
(push) ;; push{2

; Starting query at Bug126.fst(34,13-34,14)
...
;   (_: Bug126.exp)
;   (_: Bug126.typ)
;   (projectee: _: Bug126.typing _ _ _ {TyLam? _}).
;   (*  - Could not prove post-condition
; *) ~(TyLam? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__TyLam__item__g`
...
Bug126.typ)
(HasType @x3
(Tm_refine_13780dc621ffa127595a82e4cc50fd29 @x0
@x1
@x2))

;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,13-34,14)
(not 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,13-34,14)
(BoxBool_proj_0 (Bug126.uu___is_TyLam @x0
@x1
@x2
@x3))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyLam__item__g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_13780dc621ffa127595a82e4cc50fd29
...
; encoding sigelt let __proj__TyLam__item__g


; <Skipped let __proj__TyLam__item__g/>


; encoding sigelt val Bug126.__proj__TyLam__item__t


; <Start encoding val Bug126.__proj__TyLam__item__t>


(declare-fun Bug126.__proj__TyLam__item__t (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyLam? _} -> typ
(declare-fun Tm_arrow_98f5a2d219dc73ef4d45d8a3cae41eea () Term)
(declare-fun Bug126.__proj__TyLam__item__t@tok () Term)

; </end encoding val Bug126.__proj__TyLam__item__t>

(push) ;; push{2

; Starting query at Bug126.fst(34,22-34,23)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__TyLam__item__t`
...
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,22-34,23)
(not 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,22-34,23)
(BoxBool_proj_0 (Bug126.uu___is_TyLam @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyLam__item__t, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_13780dc621ffa127595a82e4cc50fd29
...
; encoding sigelt let __proj__TyLam__item__t


; <Skipped let __proj__TyLam__item__t/>


; encoding sigelt val Bug126.__proj__TyLam__item__e1


; <Start encoding val Bug126.__proj__TyLam__item__e1>


(declare-fun Bug126.__proj__TyLam__item__e1 (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyLam? _} -> exp
(declare-fun Tm_arrow_a28f5727f6015c420e489e5b78790e31 () Term)
(declare-fun Bug126.__proj__TyLam__item__e1@tok () Term)

; </end encoding val Bug126.__proj__TyLam__item__e1>

(push) ;; push{2

; Starting query at Bug126.fst(34,32-34,34)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__TyLam__item__e1`
...
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,32-34,34)
(not 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,32-34,34)
(BoxBool_proj_0 (Bug126.uu___is_TyLam @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyLam__item__e1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_13780dc621ffa127595a82e4cc50fd29
...
; encoding sigelt let __proj__TyLam__item__e1
...
(declare-fun Bug126.__proj__TyLam__item__t_ (Term Term Term Term) Term)


(declare-fun Bug126.__proj__TyLam__item__t_@tok () Term)

; </end encoding val Bug126.__proj__TyLam__item__t'>

(push) ;; push{2

; Starting query at Bug126.fst(34,43-34,45)
...
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,43-34,45)
(not 
;; def=Bug126.fst(34,4-34,9); use=Bug126.fst(34,43-34,45)
(BoxBool_proj_0 (Bug126.uu___is_TyLam @x0
@x1
...
; encoding sigelt val Bug126.__proj__TyLam__item___4


; <Start encoding val Bug126.__proj__TyLam__item___4>


(declare-fun Bug126.__proj__TyLam__item___4 (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyLam? _}   -> typing (extend projectee.g projectee.t) projectee.e1 projectee.t'
(declare-fun Tm_arrow_a9800e88803ce1b322c3d6eb7be77994 () Term)
(declare-fun Bug126.__proj__TyLam__item___4@tok () Term)

; </end encoding val Bug126.__proj__TyLam__item___4>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.__proj__TyLam__item__t; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,22-34,23); use=Bug126.fst(34,22-34,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Bug126.env)
(HasType @x1
...
@x1
@x2)))
(HasType (Bug126.__proj__TyLam__item__t @x0
@x1
@x2
@x3)
Bug126.typ))
...
:pattern ((Bug126.__proj__TyLam__item__t @x0
@x1
@x2
@x3))
:qid typing_Bug126.__proj__TyLam__item__t))

:named typing_Bug126.__proj__TyLam__item__t))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.__proj__TyLam__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,13-34,14); use=Bug126.fst(34,13-34,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Bug126.env)
(HasType @x1
...
@x1
@x2)))
(HasType (Bug126.__proj__TyLam__item__g @x0
@x1
@x2
@x3)
Bug126.env))
...
:pattern ((Bug126.__proj__TyLam__item__g @x0
@x1
@x2
@x3))
:qid typing_Bug126.__proj__TyLam__item__g))

:named typing_Bug126.__proj__TyLam__item__g))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.__proj__TyLam__item__e1; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,32-34,34); use=Bug126.fst(34,32-34,34)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Bug126.env)
(HasType @x1
...
@x1
@x2)))
(HasType (Bug126.__proj__TyLam__item__e1 @x0
@x1
@x2
@x3)
Bug126.exp))
...
:pattern ((Bug126.__proj__TyLam__item__e1 @x0
@x1
@x2
@x3))
:qid typing_Bug126.__proj__TyLam__item__e1))

:named typing_Bug126.__proj__TyLam__item__e1))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug126.__proj__TyLam__item__t; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,22-34,23); use=Bug126.fst(34,22-34,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.__proj__TyLam__item__t @x0
@x1
@x2
@x3)
(Bug126.TyLam_t @x3))
...
@x2
@x3))
:qid proj_equation_Bug126.TyLam_t))

:named proj_equation_Bug126.TyLam_t))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug126.__proj__TyLam__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,13-34,14); use=Bug126.fst(34,13-34,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.__proj__TyLam__item__g @x0
@x1
@x2
@x3)
(Bug126.TyLam_g @x3))
...
@x2
@x3))
:qid proj_equation_Bug126.TyLam_g))

:named proj_equation_Bug126.TyLam_g))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug126.__proj__TyLam__item__e1; Namespace Bug126
(assert (! 
;; def=Bug126.fst(34,32-34,34); use=Bug126.fst(34,32-34,34)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.__proj__TyLam__item__e1 @x0
@x1
@x2
@x3)
(Bug126.TyLam_e1 @x3))
...
@x2
@x3))
:qid proj_equation_Bug126.TyLam_e1))

:named proj_equation_Bug126.TyLam_e1))
(push) ;; push{2
...
;       (b: Bug126.exp)
;       (b: Bug126.typ)
;       (b: Bug126.typing (Bug126.extend b b) b b).
;       projectee == Bug126.TyLam b b ==>
;       Bug126.ELam b b == _ /\ (Bug126.TArr b b == _) /\ (b == _) /\ TyLam? (Bug126.TyLam b b) /\
;       (forall (return_val: _: Bug126.typing _ _ _ {TyLam? _}).
;           return_val == Bug126.TyLam b b ==>
;           (forall (any_result: Bug126.env).
;               (Bug126.TyLam b b).g == any_result ==>
;               Bug126.ELam b b == _ /\ (Bug126.TArr b b == _) /\ (b == _) /\
;               TyLam? (Bug126.TyLam b b) /\
;               (forall (return_val: _: Bug126.typing _ _ _ {TyLam? _}).
;                   return_val == Bug126.TyLam b b ==>
;                   (forall (any_result: Bug126.typ).
;                       (Bug126.TyLam b b).t == any_result ==>
;                       (forall (any_result: Bug126.env).
;                           Bug126.extend (Bug126.TyLam b b).g (Bug126.TyLam b b).t == any_result ==>
;                           Bug126.ELam b b == _ /\ (Bug126.TArr b b == _) /\ (b == _) /\
;                           TyLam? (Bug126.TyLam b b) /\
;                           (forall (return_val: _: Bug126.typing _ _ _ {TyLam? _}).
;                               return_val == Bug126.TyLam b b ==>
;                               (forall (any_result: Bug126.exp).
;                                   (Bug126.TyLam b b).e1 == any_result ==>
;                                   Bug126.ELam b b == _ /\ (Bug126.TArr b b == _) /\ (b == _) /\
;                                   TyLam? (Bug126.TyLam b b)))))))) /\
;       Bug126.extend b b == Bug126.extend (Bug126.TyLam b b).g (Bug126.TyLam b b).t)


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__TyLam__item___4`
...
(Bug126.typing (Bug126.extend @x4
@x5)
@x6
@x7))
...
;; def=Prims.fst(459,77-459,89); use=Prims.fst(459,77-459,89)
(and 
;; def=dummy(0,0-0,0); use=Bug126.fst(34,4-34,9)
(or label_2
...
Bug126.env)
(= (Bug126.extend (Bug126.__proj__TyLam__item__g @x0
@x1
@x2
(Bug126.TyLam @x4
@x5
...
;; def=Bug126.fst(35,19-35,31); use=dummy(0,0-0,0)
(or label_18

;; def=Bug126.fst(35,19-35,31); use=Bug126.fst(35,19-35,31)
(= (Bug126.extend @x4
@x5)
(Bug126.extend (Bug126.__proj__TyLam__item__g @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyLam__item___4, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Bug126.TyLam, proj_equation_Bug126.TyLam_g, proj_equation_Bug126.TyLam_t, projection_inverse_Bug126.TyLam_g, projection_inverse_Bug126.TyLam_t, refinement_interpretation_Tm_refine_13780dc621ffa127595a82e4cc50fd29
...
; encoding sigelt let __proj__TyLam__item___4


; <Skipped let __proj__TyLam__item___4/>


; encoding sigelt val Bug126.uu___is_TyApp


; <Start encoding val Bug126.uu___is_TyApp>

(declare-fun Bug126.uu___is_TyApp (Term Term Term Term) Term)

(declare-fun Bug126.uu___is_TyApp@tok () Term)

; </end encoding val Bug126.uu___is_TyApp>
...
; encoding sigelt val Bug126.__proj__TyApp__item__g


; <Start encoding val Bug126.__proj__TyApp__item__g>

(declare-fun Tm_refine_75d94a3a8edd252239dbdf0c6137d707 (Term Term Term) Term)
(declare-fun Bug126.__proj__TyApp__item__g (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyApp? _} -> env
(declare-fun Tm_arrow_5488a579b0649a43feeef74bfaf314f9 () Term)
(declare-fun Bug126.__proj__TyApp__item__g@tok () Term)

; </end encoding val Bug126.__proj__TyApp__item__g>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.uu___is_TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
...
@x1
@x2)))
(HasType (Bug126.uu___is_TyApp @x0
@x1
@x2
@x3)
Prims.bool))
...
:pattern ((Bug126.uu___is_TyApp @x0
@x1
@x2
@x3))
:qid typing_Bug126.uu___is_TyApp))

:named typing_Bug126.uu___is_TyApp))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug126.__proj__TyApp__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_75d94a3a8edd252239dbdf0c6137d707 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_75d94a3a8edd252239dbdf0c6137d707 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_75d94a3a8edd252239dbdf0c6137d707))

:named refinement_kinding_Tm_refine_75d94a3a8edd252239dbdf0c6137d707))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug126.__proj__TyApp__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_75d94a3a8edd252239dbdf0c6137d707 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(BoxBool_proj_0 (Bug126.uu___is_TyApp @x2
@x3
@x4
@x1))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_75d94a3a8edd252239dbdf0c6137d707))

:named refinement_interpretation_Tm_refine_75d94a3a8edd252239dbdf0c6137d707))
;;;;;;;;;;;;;;;;haseq for Tm_refine_75d94a3a8edd252239dbdf0c6137d707
;;; Fact-ids: Name Bug126.__proj__TyApp__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_75d94a3a8edd252239dbdf0c6137d707 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Bug126.typing @x0
@x1
...
:pattern ((Valid (Prims.hasEq (Tm_refine_75d94a3a8edd252239dbdf0c6137d707 @x0
@x1
@x2))))
:qid haseqTm_refine_75d94a3a8edd252239dbdf0c6137d707))

:named haseqTm_refine_75d94a3a8edd252239dbdf0c6137d707))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug126.uu___is_TyApp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,4-37,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.uu___is_TyApp @x0
@x1
@x2
@x3)
(BoxBool (is-Bug126.TyApp @x3)))
...
@x2
@x3))
:qid disc_equation_Bug126.TyApp))

:named disc_equation_Bug126.TyApp))
(push) ;; push{2

; Starting query at Bug126.fst(37,13-37,14)
...
;   (_: Bug126.exp)
;   (_: Bug126.typ)
;   (projectee: _: Bug126.typing _ _ _ {TyApp? _}).
;   (*  - Could not prove post-condition
...
Bug126.typ)
(HasType @x3
(Tm_refine_75d94a3a8edd252239dbdf0c6137d707 @x0
@x1
@x2))

;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,13-37,14)
(not 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,13-37,14)
(BoxBool_proj_0 (Bug126.uu___is_TyApp @x0
@x1
@x2
@x3))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyApp__item__g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_75d94a3a8edd252239dbdf0c6137d707
...
; encoding sigelt val Bug126.__proj__TyApp__item__e1


; <Start encoding val Bug126.__proj__TyApp__item__e1>


(declare-fun Bug126.__proj__TyApp__item__e1 (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyApp? _} -> exp
(declare-fun Tm_arrow_124db98b7fd5b6da279ad13300e659c7 () Term)
(declare-fun Bug126.__proj__TyApp__item__e1@tok () Term)

; </end encoding val Bug126.__proj__TyApp__item__e1>

(push) ;; push{2

; Starting query at Bug126.fst(37,23-37,25)
...
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,23-37,25)
(not 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,23-37,25)
(BoxBool_proj_0 (Bug126.uu___is_TyApp @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyApp__item__e1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_75d94a3a8edd252239dbdf0c6137d707
...
; encoding sigelt val Bug126.__proj__TyApp__item__e2


; <Start encoding val Bug126.__proj__TyApp__item__e2>


(declare-fun Bug126.__proj__TyApp__item__e2 (Term Term Term Term) Term)


(declare-fun Bug126.__proj__TyApp__item__e2@tok () Term)

; </end encoding val Bug126.__proj__TyApp__item__e2>

(push) ;; push{2

; Starting query at Bug126.fst(37,34-37,36)
...
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,34-37,36)
(not 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,34-37,36)
(BoxBool_proj_0 (Bug126.uu___is_TyApp @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyApp__item__e2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_75d94a3a8edd252239dbdf0c6137d707
...
; encoding sigelt val Bug126.__proj__TyApp__item__t11


; <Start encoding val Bug126.__proj__TyApp__item__t11>


(declare-fun Bug126.__proj__TyApp__item__t11 (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyApp? _} -> typ
(declare-fun Tm_arrow_13e05f219f92e6153818e60bf30cdd7b () Term)
(declare-fun Bug126.__proj__TyApp__item__t11@tok () Term)

; </end encoding val Bug126.__proj__TyApp__item__t11>

(push) ;; push{2

; Starting query at Bug126.fst(37,45-37,48)
...
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,45-37,48)
(not 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,45-37,48)
(BoxBool_proj_0 (Bug126.uu___is_TyApp @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyApp__item__t11, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_75d94a3a8edd252239dbdf0c6137d707
...
; encoding sigelt val Bug126.__proj__TyApp__item__t12


; <Start encoding val Bug126.__proj__TyApp__item__t12>


(declare-fun Bug126.__proj__TyApp__item__t12 (Term Term Term Term) Term)


(declare-fun Bug126.__proj__TyApp__item__t12@tok () Term)

; </end encoding val Bug126.__proj__TyApp__item__t12>

(push) ;; push{2

; Starting query at Bug126.fst(37,57-37,60)
...
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,57-37,60)
(not 
;; def=Bug126.fst(37,4-37,9); use=Bug126.fst(37,57-37,60)
(BoxBool_proj_0 (Bug126.uu___is_TyApp @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyApp__item__t12, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_75d94a3a8edd252239dbdf0c6137d707
...
; encoding sigelt val Bug126.__proj__TyApp__item___5


; <Start encoding val Bug126.__proj__TyApp__item___5>


(declare-fun Bug126.__proj__TyApp__item___5 (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyApp? _}   -> typing projectee.g projectee.e1 (TArr projectee.t11 projectee.t12)
(declare-fun Tm_arrow_80584a13aadeac17b51d39820e0a2a62 () Term)
(declare-fun Bug126.__proj__TyApp__item___5@tok () Term)

; </end encoding val Bug126.__proj__TyApp__item___5>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.__proj__TyApp__item__t11; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,45-37,48); use=Bug126.fst(37,45-37,48)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Bug126.env)
(HasType @x1
...
@x1
@x2)))
(HasType (Bug126.__proj__TyApp__item__t11 @x0
@x1
@x2
@x3)
Bug126.typ))
...
:pattern ((Bug126.__proj__TyApp__item__t11 @x0
@x1
@x2
@x3))
:qid typing_Bug126.__proj__TyApp__item__t11))

:named typing_Bug126.__proj__TyApp__item__t11))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.__proj__TyApp__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,13-37,14); use=Bug126.fst(37,13-37,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Bug126.env)
(HasType @x1
...
@x1
@x2)))
(HasType (Bug126.__proj__TyApp__item__g @x0
@x1
@x2
@x3)
Bug126.env))
...
:pattern ((Bug126.__proj__TyApp__item__g @x0
@x1
@x2
@x3))
:qid typing_Bug126.__proj__TyApp__item__g))

:named typing_Bug126.__proj__TyApp__item__g))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.__proj__TyApp__item__e1; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,23-37,25); use=Bug126.fst(37,23-37,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Bug126.env)
(HasType @x1
...
@x1
@x2)))
(HasType (Bug126.__proj__TyApp__item__e1 @x0
@x1
@x2
@x3)
Bug126.exp))
...
:pattern ((Bug126.__proj__TyApp__item__e1 @x0
@x1
@x2
@x3))
:qid typing_Bug126.__proj__TyApp__item__e1))

:named typing_Bug126.__proj__TyApp__item__e1))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug126.__proj__TyApp__item__t11; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,45-37,48); use=Bug126.fst(37,45-37,48)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.__proj__TyApp__item__t11 @x0
@x1
@x2
@x3)
(Bug126.TyApp_t11 @x3))
...
@x2
@x3))
:qid proj_equation_Bug126.TyApp_t11))

:named proj_equation_Bug126.TyApp_t11))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug126.__proj__TyApp__item__g; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,13-37,14); use=Bug126.fst(37,13-37,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.__proj__TyApp__item__g @x0
@x1
@x2
@x3)
(Bug126.TyApp_g @x3))
...
@x2
@x3))
:qid proj_equation_Bug126.TyApp_g))

:named proj_equation_Bug126.TyApp_g))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug126.__proj__TyApp__item__e1; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,23-37,25); use=Bug126.fst(37,23-37,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.__proj__TyApp__item__e1 @x0
@x1
@x2
@x3)
(Bug126.TyApp_e1 @x3))
...
@x2
@x3))
:qid proj_equation_Bug126.TyApp_e1))

:named proj_equation_Bug126.TyApp_e1))
(push) ;; push{2
...
;       (b: Bug126.typ)
;       (b: Bug126.typ)
;       (b: Bug126.typing b b (Bug126.TArr b b))
;       (b: Bug126.typing b b b).
;       projectee == Bug126.TyApp b b ==>
;       Bug126.EApp b b == _ /\ (b == _) /\ (b == _) /\ TyApp? (Bug126.TyApp b b) /\
;       (forall (return_val: _: Bug126.typing _ _ _ {TyApp? _}).
;           return_val == Bug126.TyApp b b ==>
;           (forall (any_result: Bug126.env).
;               (Bug126.TyApp b b).g == any_result ==>
;               Bug126.EApp b b == _ /\ (b == _) /\ (b == _) /\ TyApp? (Bug126.TyApp b b) /\
;               (forall (return_val: _: Bug126.typing _ _ _ {TyApp? _}).
;                   return_val == Bug126.TyApp b b ==>
;                   (forall (any_result: Bug126.exp).
;                       (Bug126.TyApp b b).e1 == any_result ==>
;                       Bug126.EApp b b == _ /\ (b == _) /\ (b == _) /\ TyApp? (Bug126.TyApp b b) /\
;                       (forall (return_val: _: Bug126.typing _ _ _ {TyApp? _}).
;                           return_val == Bug126.TyApp b b ==>
;                           (forall (any_result: Bug126.typ).
;                               (Bug126.TyApp b b).t11 == any_result ==>
;                               Bug126.EApp b b == _ /\ (b == _) /\ (b == _) /\
;                               TyApp? (Bug126.TyApp b b))))))))
...
;; def=Prims.fst(459,77-459,89); use=Prims.fst(459,77-459,89)
(and 
;; def=dummy(0,0-0,0); use=Bug126.fst(37,4-37,9)
(or label_2
...
;; def=Bug126.fst(18,34-37,9); use=Bug126.fst(18,34-37,9)
(= (Bug126.__proj__TyApp__item__t11 @x0
@x1
@x2
(Bug126.TyApp @x4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyApp__item___5, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Bug126.TyApp, refinement_interpretation_Tm_refine_75d94a3a8edd252239dbdf0c6137d707
...
; encoding sigelt val Bug126.__proj__TyApp__item___6


; <Start encoding val Bug126.__proj__TyApp__item___6>


(declare-fun Bug126.__proj__TyApp__item___6 (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: typing _ _ _ {TyApp? _} -> typing projectee.g projectee.e2 projectee.t11
(declare-fun Tm_arrow_6a6cf1221fcfdc439465b007c469b59e () Term)
(declare-fun Bug126.__proj__TyApp__item___6@tok () Term)

; </end encoding val Bug126.__proj__TyApp__item___6>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.__proj__TyApp__item__e2; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,34-37,36); use=Bug126.fst(37,34-37,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Bug126.env)
(HasType @x1
...
@x1
@x2)))
(HasType (Bug126.__proj__TyApp__item__e2 @x0
@x1
@x2
@x3)
Bug126.exp))
...
:pattern ((Bug126.__proj__TyApp__item__e2 @x0
@x1
@x2
@x3))
:qid typing_Bug126.__proj__TyApp__item__e2))

:named typing_Bug126.__proj__TyApp__item__e2))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug126.__proj__TyApp__item__e2; Namespace Bug126
(assert (! 
;; def=Bug126.fst(37,34-37,36); use=Bug126.fst(37,34-37,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug126.__proj__TyApp__item__e2 @x0
@x1
@x2
@x3)
(Bug126.TyApp_e2 @x3))
...
@x2
@x3))
:qid proj_equation_Bug126.TyApp_e2))

:named proj_equation_Bug126.TyApp_e2))
(push) ;; push{2
...
;                   return_val == Bug126.TyApp b b ==>
;                   (forall (any_result: Bug126.exp).
;                       (Bug126.TyApp b b).e2 == any_result ==>
;                       Bug126.EApp b b == _ /\ (b == _) /\ (b == _) /\ TyApp? (Bug126.TyApp b b))))))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.__proj__TyApp__item___6, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Bug126.TyApp, refinement_interpretation_Tm_refine_75d94a3a8edd252239dbdf0c6137d707
...
(declare-fun Bug126.emp (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: _ -> FStar.Pervasives.Native.option _
(declare-fun Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e () Term)
(declare-fun Bug126.emp@tok () Term)

; </end encoding let emp>


; encoding sigelt let value


; <Start encoding let value>

(declare-fun Bug126.value (Term) Term)

(declare-fun Bug126.value@tok () Term)

; </end encoding let value>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.value; Namespace Bug126
(assert (! 
;; def=Bug126.fst(43,4-43,9); use=Bug126.fst(43,4-43,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug126.exp)
(HasType (Bug126.value @x0)
Prims.bool))
 

:pattern ((Bug126.value @x0))
:qid typing_Bug126.value))

:named typing_Bug126.value))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.emp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(42,4-42,7); use=Bug126.fst(42,4-42,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
@x0))
(HasType (Bug126.emp @x0
@x1
@x2)
(FStar.Pervasives.Native.option @x1)))
 

:pattern ((Bug126.emp @x0
@x1
@x2))
:qid typing_Bug126.emp))

:named typing_Bug126.emp))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Bug126.emp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(42,4-42,7); use=Bug126.fst(42,4-42,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Bug126.emp@tok
@x0)
@x1)
@x2)
(Bug126.emp @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Bug126.emp@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Bug126.emp))

:named token_correspondence_Bug126.emp))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e
;;; Fact-ids: Name Bug126.emp; Namespace Bug126
(assert (! (HasType Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e
Tm_type)
:named kinding_Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Bug126.emp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(42,4-42,7); use=Bug126.fst(42,4-42,7)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Bug126.emp@tok
Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e))
...
:pattern ((Bug126.emp @x1
@x2
@x3))
:qid function_token_typing_Bug126.emp.1))
)
 

:pattern ((ApplyTT @x0
Bug126.emp@tok))
:qid function_token_typing_Bug126.emp))

:named function_token_typing_Bug126.emp))
;;;;;;;;;;;;;;;;Equation for Bug126.value
;;; Fact-ids: Name Bug126.value; Namespace Bug126
(assert (! 
;; def=Bug126.fst(43,4-43,9); use=Bug126.fst(43,4-43,9)
(forall ((@x0 Term))
 (! (= (Bug126.value @x0)
(let ((@lb1 @x0))
(ite (is-Bug126.ELam @lb1)
(BoxBool true)
(ite (is-Bug126.EVar @lb1)
(BoxBool true)
(ite (is-Bug126.EUnit @lb1)
(BoxBool true)
(BoxBool false))))))
 

:pattern ((Bug126.value @x0))
:qid equation_Bug126.value))

:named equation_Bug126.value))
;;;;;;;;;;;;;;;;Equation for Bug126.emp
;;; Fact-ids: Name Bug126.emp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(42,4-42,7); use=Bug126.fst(42,4-42,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x1
@x2))
:qid equation_Bug126.emp))

:named equation_Bug126.emp))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug126.emp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(42,0-42,16); use=Bug126.fst(42,0-42,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e)
...
@x1
Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e))
:qid Bug126_pre_typing_Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e))

:named Bug126_pre_typing_Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e
;;; Fact-ids: Name Bug126.emp; Namespace Bug126
(assert (! 
;; def=Bug126.fst(42,0-42,16); use=Bug126.fst(42,0-42,16)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid Bug126_interpretation_Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug126_interpretation_Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e.2))
...
@x1)
@x2))
:qid Bug126_interpretation_Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e))
:qid Bug126_interpretation_Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e))

:named Bug126_interpretation_Tm_arrow_c0e25bb1dddaf3971d85f9eb9862521e))
(push) ;; push{2

; Starting query at Bug126.fst(44,0-45,84)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_75276c261e8e18103e248f49ccb1ecac () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_75276c261e8e18103e248f49ccb1ecac
Tm_type)
:named refinement_kinding_Tm_refine_75276c261e8e18103e248f49ccb1ecac))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug126.fst(44,16-44,30); use=Bug126.fst(44,16-44,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_75276c261e8e18103e248f49ccb1ecac)
(and (HasTypeFuel @u0
@x1
Bug126.exp)

;; def=Bug126.fst(44,22-44,29); use=Bug126.fst(44,22-44,29)
(BoxBool_proj_0 (Bug126.value @x1))
))
...
@x1
Tm_refine_75276c261e8e18103e248f49ccb1ecac))
:qid refinement_interpretation_Tm_refine_75276c261e8e18103e248f49ccb1ecac))

:named refinement_interpretation_Tm_refine_75276c261e8e18103e248f49ccb1ecac))
;;;;;;;;;;;;;;;;haseq for Tm_refine_75276c261e8e18103e248f49ccb1ecac
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_75276c261e8e18103e248f49ccb1ecac))
(Valid (Prims.hasEq Bug126.exp)))
:named haseqTm_refine_75276c261e8e18103e248f49ccb1ecac))

;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
Bug126.emp@tok))
:named @kick_partial_app_da436beeb20005cb7fb4ab7df29870e9))

; Encoding query formula : forall (e: Bug126.exp{Bug126.value e}) (t: Bug126.typ{TArr? t}) (d: Bug126.typing Bug126.emp e t).
;   (*  - Subtyping check failed
;   - Expected type _: exp{ELam? _} got type e: exp{value e}
; *)
;   Bug126.value e ==> ELam? e


; Context: While encoding a query
; While typechecking the top-level declaration `val Bug126.invert_lam`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Bug126.fst(44,0-45,84)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_refine_75276c261e8e18103e248f49ccb1ecac)
(HasType @x1
Tm_refine_82996e2fd8e55cc06b19627ffe4234dc)
(HasType @x2
(Bug126.typing (ApplyTT (ApplyTT Bug126.emp@tok
Bug126.var)
Bug126.typ)
@x0
@x1))

;; def=Bug126.fst(44,22-44,29); use=Bug126.fst(45,67-45,68)
(BoxBool_proj_0 (Bug126.value @x0))
)

;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(45,67-45,68)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.invert_lam, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Bug126_pretyping_2ddca4d01e0793754b84d9f610f2a713, bool_inversion, constructor_distinct_Bug126.EApp, constructor_distinct_Bug126.ELam, constructor_distinct_Bug126.TUnit, constructor_distinct_FStar.Pervasives.Native.None, data_elim_Bug126.TyVar, disc_equation_Bug126.ELam, disc_equation_Bug126.TArr, disc_equation_FStar.Pervasives.Native.Some, equality_tok_Bug126.TUnit@tok, equation_Bug126.emp, equation_Bug126.value, equation_Bug126.var, equation_Prims.nat, fuel_guarded_inversion_Bug126.typing, projection_inverse_BoxBool_proj_0, projection_inverse_Bug126.ELam_body, projection_inverse_Bug126.ELam_t, refinement_interpretation_Tm_refine_568849ef81103d54de1b5cc62340abd7, refinement_interpretation_Tm_refine_75276c261e8e18103e248f49ccb1ecac, refinement_interpretation_Tm_refine_82996e2fd8e55cc06b19627ffe4234dc, token_correspondence_Bug126.emp, typing_Bug126.uu___is_TArr, typing_Bug126.value, typing_tok_Bug126.TUnit@tok
...
; encoding sigelt val Bug126.invert_lam


; <Skipped val Bug126.invert_lam/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.__proj__TArr__item__res; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,45-18,48); use=Bug126.fst(18,45-18,48)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_82996e2fd8e55cc06b19627ffe4234dc)
(HasType (Bug126.__proj__TArr__item__res @x0)
Bug126.typ))
 

:pattern ((Bug126.__proj__TArr__item__res @x0))
:qid typing_Bug126.__proj__TArr__item__res))

:named typing_Bug126.__proj__TArr__item__res))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.__proj__TArr__item__arg; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,34-18,37); use=Bug126.fst(18,34-18,37)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_82996e2fd8e55cc06b19627ffe4234dc)
(HasType (Bug126.__proj__TArr__item__arg @x0)
Bug126.typ))
 

:pattern ((Bug126.__proj__TArr__item__arg @x0))
:qid typing_Bug126.__proj__TArr__item__arg))

:named typing_Bug126.__proj__TArr__item__arg))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug126.__proj__ELam__item__body; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,22-24,26); use=Bug126.fst(24,22-24,26)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_8144cd34f51c347b0afc7992a2a47ee2)
(HasType (Bug126.__proj__ELam__item__body @x0)
Bug126.exp))
 

:pattern ((Bug126.__proj__ELam__item__body @x0))
:qid typing_Bug126.__proj__ELam__item__body))

:named typing_Bug126.__proj__ELam__item__body))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug126.__proj__TArr__item__res; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,45-18,48); use=Bug126.fst(18,45-18,48)
(forall ((@x0 Term))
 (! (= (Bug126.__proj__TArr__item__res @x0)
(Bug126.TArr_res @x0))
 

:pattern ((Bug126.__proj__TArr__item__res @x0))
:qid proj_equation_Bug126.TArr_res))

:named proj_equation_Bug126.TArr_res))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug126.__proj__TArr__item__arg; Namespace Bug126
(assert (! 
;; def=Bug126.fst(18,34-18,37); use=Bug126.fst(18,34-18,37)
(forall ((@x0 Term))
 (! (= (Bug126.__proj__TArr__item__arg @x0)
(Bug126.TArr_arg @x0))
 

:pattern ((Bug126.__proj__TArr__item__arg @x0))
:qid proj_equation_Bug126.TArr_arg))

:named proj_equation_Bug126.TArr_arg))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug126.__proj__ELam__item__body; Namespace Bug126
(assert (! 
;; def=Bug126.fst(24,22-24,26); use=Bug126.fst(24,22-24,26)
(forall ((@x0 Term))
 (! (= (Bug126.__proj__ELam__item__body @x0)
(Bug126.ELam_body @x0))
 

:pattern ((Bug126.__proj__ELam__item__body @x0))
:qid proj_equation_Bug126.ELam_body))

:named proj_equation_Bug126.ELam_body))
(push) ;; push{2

; Starting query at Bug126.fst(46,39-46,46)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug126.fst(44,16-44,30); use=Bug126.fst(46,4-46,14)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_75276c261e8e18103e248f49ccb1ecac)
...
;; def=Bug126.fst(44,22-44,29); use=Bug126.fst(46,4-46,14)
(BoxBool_proj_0 (Bug126.value @x1))
))
...
; Encoding query formula : forall (e: Bug126.exp{Bug126.value e}) (t: Bug126.typ{TArr? t}) (_: Bug126.typing Bug126.emp e t).
;   (*  - Could not prove post-condition
; *)
;   (Bug126.value e ==> ELam? e) /\
;   (~(TyLam? _) ==> Prims.l_False) /\
;   (forall (b: Bug126.env)
;       (b: Bug126.typ)
;       (b: Bug126.exp)
;       (b: Bug126.typ)
;       (b: Bug126.typing (Bug126.extend b b) b b).
;       _ == Bug126.TyLam b b ==>
;       b == e.body /\ (b == t.res) /\ (Bug126.extend b b == Bug126.extend Bug126.emp t.arg))


; Context: While encoding a query
; While typechecking the top-level declaration `let invert_lam`
...
;; def=Prims.fst(459,77-459,89); use=Bug126.fst(46,39-46,46)
(and (implies 
;; def=Bug126.fst(44,22-44,29); use=Bug126.fst(46,39-46,46)
(BoxBool_proj_0 (Bug126.value @x0))


;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(46,15-46,16)
(or label_1

;; def=Bug126.fst(24,4-24,8); use=Bug126.fst(46,39-46,46)
(BoxBool_proj_0 (Bug126.uu___is_ELam @x0))
)
)
(implies 
;; def=Bug126.fst(46,20-46,35); use=Bug126.fst(46,39-46,46)
(not 
;; def=Bug126.fst(46,20-46,35); use=Bug126.fst(46,39-46,46)
(BoxBool_proj_0 (Bug126.uu___is_TyLam (ApplyTT (ApplyTT Bug126.emp@tok
Bug126.var)
Bug126.typ)
@x0
@x1
...
;; def=Prims.fst(413,99-413,120); use=Bug126.fst(46,39-46,46)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Bug126.env)
...
(Bug126.typing (Bug126.extend @x3
@x4)
@x5
@x6))
...
;; def=dummy(0,0-0,0); use=Bug126.fst(46,39-46,46)
(and 
;; def=Bug126.fst(45,55-46,35); use=Bug126.fst(46,39-46,46)
(or label_3
...
;; def=Bug126.fst(45,70-46,35); use=Bug126.fst(46,39-46,46)
(or label_4

;; def=Bug126.fst(45,70-46,35); use=Bug126.fst(46,39-46,46)
(= @x6
(Bug126.__proj__TArr__item__res @x1))
)


;; def=Bug126.fst(35,19-45,54); use=Bug126.fst(46,39-46,46)
(or label_5

;; def=Bug126.fst(35,19-45,54); use=Bug126.fst(46,39-46,46)
(= (Bug126.extend @x3
@x4)
(Bug126.extend (ApplyTT (ApplyTT Bug126.emp@tok
Bug126.var)
Bug126.typ)
(Bug126.__proj__TArr__item__arg @x1)))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug126.invert_lam, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Bug126_pretyping_2ddca4d01e0793754b84d9f610f2a713, bool_inversion, constructor_distinct_Bug126.EApp, constructor_distinct_Bug126.ELam, constructor_distinct_Bug126.TUnit, constructor_distinct_FStar.Pervasives.Native.None, data_elim_Bug126.TyLam, data_elim_Bug126.TyVar, disc_equation_Bug126.ELam, disc_equation_Bug126.TArr, disc_equation_Bug126.TyLam, disc_equation_FStar.Pervasives.Native.Some, equality_tok_Bug126.TUnit@tok, equation_Bug126.emp, equation_Bug126.value, equation_Bug126.var, equation_Prims.nat, fuel_guarded_inversion_Bug126.typing, proj_equation_Bug126.ELam_body, proj_equation_Bug126.TArr_arg, proj_equation_Bug126.TArr_res, projection_inverse_BoxBool_proj_0, projection_inverse_Bug126.ELam_body, projection_inverse_Bug126.ELam_t, projection_inverse_Bug126.TArr_arg, projection_inverse_Bug126.TArr_res, projection_inverse_Bug126.TyLam_e1, projection_inverse_Bug126.TyLam_g, projection_inverse_Bug126.TyLam_t, projection_inverse_Bug126.TyLam_t_, refinement_interpretation_Tm_refine_568849ef81103d54de1b5cc62340abd7, refinement_interpretation_Tm_refine_75276c261e8e18103e248f49ccb1ecac, refinement_interpretation_Tm_refine_82996e2fd8e55cc06b19627ffe4234dc, token_correspondence_Bug126.emp, typing_Bug126.value, typing_tok_Bug126.TUnit@tok
