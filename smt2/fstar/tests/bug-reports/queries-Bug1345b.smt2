...
(declare-fun Bug1345b.t (Term) Term)
;;;;;;;;;;;;;;;;a: Prims.nat -> Type
(declare-fun Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e () Term)
(declare-fun Bug1345b.t@tok () Term)
...
(declare-fun Tm_refine_ec0e82e6b5306377f1886e7fbbf68810 (Term) Term)
(declare-fun Bug1345b.foo (Term Term) Term)

;;;;;;;;;;;;;;;;x: t a {x < 20} -> Prims.unit
(declare-fun Tm_arrow_1b5160116ce316e38552c286ffa87834 () Term)
(declare-fun Bug1345b.foo@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1345b.t; Namespace Bug1345b
(assert (! 
;; def=Bug1345b.fst(18,5-18,6); use=Bug1345b.fst(18,5-18,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (Bug1345b.t @x0)
Tm_type))
 

:pattern ((Bug1345b.t @x0))
:qid typing_Bug1345b.t))

:named typing_Bug1345b.t))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Bug1345b.t; Namespace Bug1345b
(assert (! 
;; def=Bug1345b.fst(18,17-18,30); use=Bug1345b.fst(18,17-18,30)
(forall ((@x0 Term))
...
;; def=Bug1345b.fst(18,23-18,29); use=Bug1345b.fst(18,23-18,29)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x2))
))
...
:pattern ((Bug1345b.t @x0))
:qid equation_Bug1345b.t))

:named equation_Bug1345b.t))
...
; Starting query at Bug1345b.fst(20,27-20,32)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_83b8d03b3ffd2c28394fed8b3e5b7021 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_83b8d03b3ffd2c28394fed8b3e5b7021
Tm_type)
:named refinement_kinding_Tm_refine_83b8d03b3ffd2c28394fed8b3e5b7021))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug1345b.fst(20,8-20,24); use=Bug1345b.fst(20,8-20,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_83b8d03b3ffd2c28394fed8b3e5b7021)
(and (HasTypeFuel @u0
@x1
(Bug1345b.t (BoxInt 17)))

;; def=Bug1345b.fst(20,16-20,22); use=Bug1345b.fst(20,16-20,22)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (BoxInt 10)))
))
...
@x1
Tm_refine_83b8d03b3ffd2c28394fed8b3e5b7021))
:qid refinement_interpretation_Tm_refine_83b8d03b3ffd2c28394fed8b3e5b7021))

:named refinement_interpretation_Tm_refine_83b8d03b3ffd2c28394fed8b3e5b7021))
;;;;;;;;;;;;;;;;haseq for Tm_refine_83b8d03b3ffd2c28394fed8b3e5b7021
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_83b8d03b3ffd2c28394fed8b3e5b7021))
(Valid (Prims.hasEq (Bug1345b.t (BoxInt 17)))))
:named haseqTm_refine_83b8d03b3ffd2c28394fed8b3e5b7021))

; Encoding query formula : forall (y: Bug1345b.t 17 {y < 10}). (*  - Could not prove post-condition
; *) y < 10 ==> y < 20
...
;; def=Bug1345b.fst(20,16-20,22); use=Bug1345b.fst(20,31-20,32)
(< (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 10)))
)

;; def=Bug1345b.fst(19,18-19,24); use=Bug1345b.fst(20,31-20,32)
(or label_1

;; def=Bug1345b.fst(19,18-19,24); use=Bug1345b.fst(20,31-20,32)
(< (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 20)))
)
)
