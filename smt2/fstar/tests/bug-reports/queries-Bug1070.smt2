...
; Starting query at Bug1070.fst(4,2-6,20)
...
(declare-fun Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(3,24-6,20); use=Bug1070.fst(3,24-6,20)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086))

:named refinement_kinding_Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(3,24-6,20); use=Bug1070.fst(3,24-6,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
;; def=Bug1070.fst(3,24-6,20); use=Bug1070.fst(3,24-6,20)
(or 
;; def=Bug1070.fst(4,2-6,20); use=Bug1070.fst(4,2-6,20)
(Valid 
;; def=Bug1070.fst(4,2-6,20); use=Bug1070.fst(4,2-6,20)
(Prims.precedes @x2
x_fe28d8bcde588226b4e538b35321de05_1
...
;; def=Bug1070.fst(3,24-6,20); use=Bug1070.fst(3,24-6,20)
(and 
;; def=Bug1070.fst(3,24-3,25); use=Bug1070.fst(3,24-3,25)
(Valid 
;; def=Bug1070.fst(3,24-3,25); use=Bug1070.fst(3,24-3,25)
...
(Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086))

:named refinement_interpretation_Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(3,24-6,20); use=Bug1070.fst(3,24-6,20)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086 @x0
@x1)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086 @x0
@x1))))
:qid haseqTm_refine_9b356cac11a5e5de5e0fc5c5b135f086))

:named haseqTm_refine_9b356cac11a5e5de5e0fc5c5b135f086))
(declare-fun Bug1070.f (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> n: Prims.nat{x << x \/ x === x /\ n << n} -> Prims.int
(declare-fun Tm_arrow_e70c92201581ee5065554887af60f137 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e70c92201581ee5065554887af60f137
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_e70c92201581ee5065554887af60f137
Tm_type)
:named kinding_Tm_arrow_e70c92201581ee5065554887af60f137))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(3,11-6,20); use=Bug1070.fst(3,13-6,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_e70c92201581ee5065554887af60f137)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_e70c92201581ee5065554887af60f137))
:qid Bug1070_pre_typing_Tm_arrow_e70c92201581ee5065554887af60f137))

:named Bug1070_pre_typing_Tm_arrow_e70c92201581ee5065554887af60f137))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e70c92201581ee5065554887af60f137
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(3,11-6,20); use=Bug1070.fst(3,13-6,20)
(forall ((@x0 Term))
...
@x1)
(HasType @x3
(Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086 @x1
@x2)))
...
@x2)
@x3))
:qid Bug1070_interpretation_Tm_arrow_e70c92201581ee5065554887af60f137.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug1070_interpretation_Tm_arrow_e70c92201581ee5065554887af60f137.2))
...
@x1)
@x2))
:qid Bug1070_interpretation_Tm_arrow_e70c92201581ee5065554887af60f137.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_e70c92201581ee5065554887af60f137))
:qid Bug1070_interpretation_Tm_arrow_e70c92201581ee5065554887af60f137))

:named Bug1070_interpretation_Tm_arrow_e70c92201581ee5065554887af60f137))
(declare-fun Bug1070.f@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(3,8-3,9); use=Bug1070.fst(3,8-3,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Bug1070.f@tok
@x0)
@x1)
@x2)
(Bug1070.f @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Bug1070.f@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Bug1070.f))

:named token_correspondence_Bug1070.f))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(3,8-3,9); use=Bug1070.fst(3,8-3,9)
...
:pattern ((Bug1070.f @x1
@x2
@x3))
:qid function_token_typing_Bug1070.f.1))
)
 

:pattern ((ApplyTT @x0
Bug1070.f@tok))
:qid function_token_typing_Bug1070.f))

:named function_token_typing_Bug1070.f))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(3,8-3,9); use=Bug1070.fst(3,8-3,9)
...
@x0)
(HasType @x2
(Tm_refine_9b356cac11a5e5de5e0fc5c5b135f086 @x0
@x1)))
(HasType (Bug1070.f @x0
@x1
@x2)
Prims.int))
 

:pattern ((Bug1070.f @x0
@x1
@x2))
:qid typing_Bug1070.f))

:named typing_Bug1070.f))
...
;   ~(n = 0 = true) ==> (forall (b: Prims.bool). n = 0 == b ==> n - 1 >= 0 /\ (x << x \/ n - 1 << n))
...
;; def=Prims.fst(402,27-402,88); use=Bug1070.fst(4,2-6,20)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug1070.fst(4,2-6,20)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug1070.fst(4,2-6,20)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=Bug1070.fst(4,2-6,20)
(not 
;; def=Bug1070.fst(4,5-4,10); use=Bug1070.fst(4,5-4,10)
...
;; def=Prims.fst(413,99-413,120); use=Bug1070.fst(4,2-6,20)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=Bug1070.fst(4,5-6,20); use=Bug1070.fst(4,5-6,20)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_3
(BoxInt 0))
@x1)
...
;; def=Bug1070.fst(3,24-6,20); use=Bug1070.fst(6,13-6,20)
(and 
;; def=Prims.fst(680,18-680,24); use=Bug1070.fst(6,13-6,20)
(or label_1
...
;; def=Bug1070.fst(4,2-6,20); use=Bug1070.fst(6,13-6,20)
(Valid 
;; def=Bug1070.fst(4,2-6,20); use=Bug1070.fst(6,13-6,20)
...
; encoding sigelt let rec f


; <Start encoding let rec f>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug1070.f.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug1070.f.fuel_instrumented_token () Term)
(declare-fun Bug1070.f (Term Term Term) Term)
(declare-fun Bug1070.f@tok () Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> n: Prims.nat -> Prims.int
(declare-fun Tm_arrow_04fe16fe3333cacce53292b7aa40a895 () Term)

; </end encoding let rec f>


; encoding sigelt val Bug1070.f'


; <Skipped val Bug1070.f'/>

(push) ;; push{2

; Starting query at Bug1070.fst(10,2-12,21)
...
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_3))
(declare-fun Tm_refine_3588d01980c2b40bf9a34ae922d0d103 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(8,21-12,21); use=Bug1070.fst(8,21-12,21)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_3588d01980c2b40bf9a34ae922d0d103 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_3588d01980c2b40bf9a34ae922d0d103 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_3588d01980c2b40bf9a34ae922d0d103))

:named refinement_kinding_Tm_refine_3588d01980c2b40bf9a34ae922d0d103))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(8,21-12,21); use=Bug1070.fst(8,21-12,21)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3588d01980c2b40bf9a34ae922d0d103 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
;; def=Bug1070.fst(8,21-12,21); use=Bug1070.fst(8,21-12,21)
(or 
;; def=Bug1070.fst(10,2-12,21); use=Bug1070.fst(10,2-12,21)
(Valid 
;; def=Bug1070.fst(10,2-12,21); use=Bug1070.fst(10,2-12,21)
(Prims.precedes @x2
x_fe28d8bcde588226b4e538b35321de05_1
...
;; def=Bug1070.fst(8,21-12,21); use=Bug1070.fst(8,21-12,21)
(and 
;; def=Bug1070.fst(8,21-9,14); use=Bug1070.fst(8,21-9,14)
(Valid 
;; def=Bug1070.fst(8,21-9,14); use=Bug1070.fst(8,21-9,14)
(Prims.op_Equals_Equals_Equals @x2
x_fe28d8bcde588226b4e538b35321de05_1
...
(Tm_refine_3588d01980c2b40bf9a34ae922d0d103 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_3588d01980c2b40bf9a34ae922d0d103))

:named refinement_interpretation_Tm_refine_3588d01980c2b40bf9a34ae922d0d103))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3588d01980c2b40bf9a34ae922d0d103
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(8,21-12,21); use=Bug1070.fst(8,21-12,21)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3588d01980c2b40bf9a34ae922d0d103 @x0
@x1)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3588d01980c2b40bf9a34ae922d0d103 @x0
@x1))))
:qid haseqTm_refine_3588d01980c2b40bf9a34ae922d0d103))

:named haseqTm_refine_3588d01980c2b40bf9a34ae922d0d103))
(declare-fun Bug1070.f_ (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> n: Prims.nat{x << x \/ x === x /\ n << n} -> Prims.nat
(declare-fun Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea
Tm_type)
:named kinding_Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(8,8-12,21); use=Bug1070.fst(8,21-12,21)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea))
:qid Bug1070_pre_typing_Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea))

:named Bug1070_pre_typing_Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(8,8-12,21); use=Bug1070.fst(8,21-12,21)
(forall ((@x0 Term))
...
@x1)
(HasType @x3
(Tm_refine_3588d01980c2b40bf9a34ae922d0d103 @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x2)
@x3))
:qid Bug1070_interpretation_Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug1070_interpretation_Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea.2))
...
@x1)
@x2))
:qid Bug1070_interpretation_Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea))
:qid Bug1070_interpretation_Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea))

:named Bug1070_interpretation_Tm_arrow_63f2474fb87edc1a7c32c1c0a46016ea))
(declare-fun Bug1070.f_@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(9,8-9,10); use=Bug1070.fst(9,8-9,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Bug1070.f_@tok
@x0)
@x1)
@x2)
(Bug1070.f_ @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Bug1070.f_@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Bug1070.f_))

:named token_correspondence_Bug1070.f_))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(9,8-9,10); use=Bug1070.fst(9,8-9,10)
...
:pattern ((Bug1070.f_ @x1
@x2
@x3))
:qid function_token_typing_Bug1070.f_.1))
)
 

:pattern ((ApplyTT @x0
Bug1070.f_@tok))
:qid function_token_typing_Bug1070.f_))

:named function_token_typing_Bug1070.f_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug1070.fst(9,8-9,10); use=Bug1070.fst(9,8-9,10)
...
@x0)
(HasType @x2
(Tm_refine_3588d01980c2b40bf9a34ae922d0d103 @x0
@x1)))
(HasType (Bug1070.f_ @x0
@x1
@x2)
Prims.nat))
 

:pattern ((Bug1070.f_ @x0
@x1
@x2))
:qid typing_Bug1070.f_))

:named typing_Bug1070.f_))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;; def=Prims.fst(402,27-402,88); use=Bug1070.fst(10,2-12,21)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug1070.fst(10,2-12,21)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug1070.fst(10,2-12,21)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=Bug1070.fst(10,2-12,21)
(not 
;; def=Bug1070.fst(10,5-10,10); use=Bug1070.fst(10,5-10,10)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_3
(BoxInt 0))
(BoxBool true))
...
;; def=Prims.fst(413,99-413,120); use=Bug1070.fst(10,2-12,21)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=Bug1070.fst(10,5-12,21); use=Bug1070.fst(10,5-12,21)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_3
(BoxInt 0))
@x1)
...
;; def=Bug1070.fst(8,21-12,21); use=Bug1070.fst(12,14-12,21)
(and 
;; def=Prims.fst(680,18-680,24); use=Bug1070.fst(12,14-12,21)
(or label_1
...
;; def=Bug1070.fst(10,2-12,21); use=Bug1070.fst(12,14-12,21)
(Valid 
;; def=Bug1070.fst(10,2-12,21); use=Bug1070.fst(12,14-12,21)
(Prims.precedes x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_1
...
; QUERY ID: (Bug1070.f', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_3, equation_Prims.nat, int_inversion, int_typing, primitive_Prims.op_Equality, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
