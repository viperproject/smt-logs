...
; Starting query at Bug3186.fst(4,2-4,17)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug3186.fst(3,17-3,39); use=Bug3186.fst(3,17-3,39)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_0cc3b8bc4390a8152398abb544530a43))

:named refinement_kinding_Tm_refine_0cc3b8bc4390a8152398abb544530a43))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug3186.fst(3,17-3,39); use=Bug3186.fst(3,17-3,39)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
@x1
(Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x2)))
:qid refinement_interpretation_Tm_refine_0cc3b8bc4390a8152398abb544530a43))

:named refinement_interpretation_Tm_refine_0cc3b8bc4390a8152398abb544530a43))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0cc3b8bc4390a8152398abb544530a43
;;; Fact-ids: 
(assert (! 
;; def=Bug3186.fst(3,17-3,39); use=Bug3186.fst(3,17-3,39)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x0))))
:qid haseqTm_refine_0cc3b8bc4390a8152398abb544530a43))

:named haseqTm_refine_0cc3b8bc4390a8152398abb544530a43))

; Encoding query formula : forall (x: Prims.int) (_: _: Prims.unit{_: Prims.unit{Prims.equals x 0 <: Type}}).
;   (*  - Could not prove post-condition
; *) x == 0


; Context: While encoding a query
; While typechecking the top-level declaration `let base`
...
Prims.int)
(HasType @x1
(Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x0)))

;; def=Bug3186.fst(4,9-4,17); use=Bug3186.fst(4,9-4,17)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3186.base, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0cc3b8bc4390a8152398abb544530a43
...
; encoding sigelt let base


; <Start encoding let base>

(declare-fun Tm_refine_dd9aed43babf35b17eb328513e1b5030 (Term) Term)
(declare-fun Bug3186.base (Term Term) Term)

;;;;;;;;;;;;;;;;x: Prims.int -> _: _: Prims.unit{Prims.equals x 0 <: Type} -> Prims.unit
(declare-fun Tm_arrow_481c1d4b922051a01ab294c4286e7017 () Term)
(declare-fun Bug3186.base@tok () Term)


; </end encoding let base>
...
; Starting query at Bug3186.fst(7,2-7,17)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Prims.int) (_: Prims.equals x 0). (*  - Could not prove post-condition
; *) x == 0


; Context: While encoding a query
; While typechecking the top-level declaration `let base2`
...
Prims.int)
(HasType @x1
(Prims.equals Prims.int
@x0
(BoxInt 0))))

;; def=Bug3186.fst(7,9-7,17); use=Bug3186.fst(7,9-7,17)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3186.base2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, data_elim_Prims.Refl, fuel_guarded_inversion_Prims.equals, function_token_typing_Prims.__cache_version_number__, int_inversion
...
; encoding sigelt let base2


; <Start encoding let base2>

(declare-fun Bug3186.base2 (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> _: Prims.equals x 0 -> Prims.unit
(declare-fun Tm_arrow_9912917d5f5a4b239102a3868e4dcefa () Term)
(declare-fun Bug3186.base2@tok () Term)

; </end encoding let base2>
...
; Starting query at Bug3186.fst(11,2-14,17)
...
;   (*  - Could not prove post-condition
; *)
;   forall (pure_result: Prims.unit). Prims.equals x 0 ==> x == 0


; Context: While encoding a query
; While typechecking the top-level declaration `let base3`
; While typechecking the top-level declaration `[@@expect_failure] let base3`
...
;; def=Prims.fst(441,36-441,97); use=Bug3186.fst(11,2-11,8)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.unit)

;; def=Bug3186.fst(11,9-11,21); use=Bug3186.fst(11,2-11,8)
(Valid 
;; def=Bug3186.fst(11,9-11,21); use=Bug3186.fst(11,2-11,8)
(Prims.equals Prims.int
@x0
...
;; def=Bug3186.fst(14,9-14,17); use=Bug3186.fst(14,2-14,8)
(or label_1
...
; Starting query at Bug3186.fst(16,0-18,59)

(declare-fun Bug3186.vec (Term Term) Term)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug3186.fst(16,13-16,35); use=Bug3186.fst(16,13-16,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_67c7b2626869cb316f118144000415b9))
:qid Bug3186_pre_typing_Tm_arrow_67c7b2626869cb316f118144000415b9))

:named Bug3186_pre_typing_Tm_arrow_67c7b2626869cb316f118144000415b9))
...
@x1)
@x2))
:qid Bug3186_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug3186_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_67c7b2626869cb316f118144000415b9))
:qid Bug3186_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9))

:named Bug3186_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9))
(declare-fun Bug3186.vec@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug3186.fst(16,5-16,8); use=Bug3186.fst(16,5-16,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug3186.vec@tok
@x0)
@x1)
(Bug3186.vec @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Bug3186.vec@tok
@x0)
@x1))
:qid token_correspondence_Bug3186.vec))

:named token_correspondence_Bug3186.vec))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug3186.fst(16,5-16,8); use=Bug3186.fst(16,5-16,8)
...
:pattern ((Bug3186.vec @x1
@x2))
:qid function_token_typing_Bug3186.vec.1))
)
 

:pattern ((ApplyTT @x0
Bug3186.vec@tok))
:qid function_token_typing_Bug3186.vec))

:named function_token_typing_Bug3186.vec))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug3186.fst(16,5-16,8); use=Bug3186.fst(16,5-16,8)
...
(HasType @x1
Prims.nat))
(HasType (Bug3186.vec @x0
@x1)
Tm_type))
 

:pattern ((Bug3186.vec @x0
@x1))
:qid typing_Bug3186.vec))

:named typing_Bug3186.vec))
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (n: Prims.nat) (hd: a) (tl: Bug3186.vec a n).
...
; Context: While encoding a query
; While typechecking the top-level declaration `type Bug3186.vec`
...
;; def=Prims.fst(680,18-680,24); use=Bug3186.fst(18,52-18,59)
(or label_1
...
; encoding sigelt type Bug3186.vec


; <Start encoding type Bug3186.vec>
...
(declare-fun Bug3186.vec@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug3186.Nil (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug3186.Nil_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug3186.Nil
(declare-fun Bug3186.Nil@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug3186.Cons (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug3186.Cons_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug3186.Cons_n (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug3186.Cons_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug3186.Cons_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug3186.Cons
(declare-fun Bug3186.Cons@tok () Term)
;;;;;;;;;;;;;;;;vec a 0
(declare-fun Tm_arrow_f809ef3668da8476adeb26e29a5e685d () Term)
;;;;;;;;;;;;;;;;hd: a -> tl: vec a n -> vec a (n + 1)
(declare-fun Tm_arrow_fc218ede8fe2810f58c03c18c61203ba () Term)

; <start constructor Bug3186.vec>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug3186.vec ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
134)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
; </end constructor Bug3186.vec>


; <start constructor Bug3186.Nil>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug3186.Nil ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
141)
(= __@x0
(Bug3186.Nil (Bug3186.Nil_a __@x0)))))

; </end constructor Bug3186.Nil>


; <start constructor Bug3186.Cons>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug3186.Cons ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
147)
(= __@x0
(Bug3186.Cons (Bug3186.Cons_a __@x0)
(Bug3186.Cons_n __@x0)
(Bug3186.Cons_hd __@x0)
(Bug3186.Cons_tl __@x0)))))

; </end constructor Bug3186.Cons>


; </end encoding type Bug3186.vec>
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(16,5-16,8); use=Bug3186.fst(16,5-16,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug3186.vec@tok
...
:pattern ((Bug3186.vec @x0
@x1))
:qid token_correspondence_Bug3186.vec@tok))

:named token_correspondence_Bug3186.vec@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
...
(Bug3186.vec @x5
@x6)))
:qid subterm_ordering_Bug3186.Cons))

:named subterm_ordering_Bug3186.Cons))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(17,4-17,7); use=Bug3186.fst(17,4-17,7)
(forall ((@x0 Term))
 (! (= (Bug3186.Nil_a (Bug3186.Nil @x0))
@x0)
 

:pattern ((Bug3186.Nil @x0))
:qid projection_inverse_Bug3186.Nil_a))

:named projection_inverse_Bug3186.Nil_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug3186.Cons_tl (Bug3186.Cons @x0
@x1
@x2
@x3))
@x3)
...
:pattern ((Bug3186.Cons @x0
@x1
@x2
@x3))
:qid projection_inverse_Bug3186.Cons_tl))

:named projection_inverse_Bug3186.Cons_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug3186.Cons_n (Bug3186.Cons @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Bug3186.Cons_n))

:named projection_inverse_Bug3186.Cons_n))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug3186.Cons_hd (Bug3186.Cons @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Bug3186.Cons_hd))

:named projection_inverse_Bug3186.Cons_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug3186.Cons_a (Bug3186.Cons @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_Bug3186.Cons_a))

:named projection_inverse_Bug3186.Cons_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! (is-Tm_arrow (PreType Bug3186.vec@tok))
:named pre_kinding_Bug3186.vec@tok))
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! (and (IsTotFun Bug3186.vec@tok)

;; def=Bug3186.fst(16,5-16,8); use=Bug3186.fst(16,5-16,8)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Bug3186.vec@tok
@x0))
 

:pattern ((ApplyTT Bug3186.vec@tok
@x0))
:qid kinding_Bug3186.vec@tok))
...
:pattern ((Bug3186.vec @x0
@x1))
:qid kinding_Bug3186.vec@tok.1))
)
:named kinding_Bug3186.vec@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(16,5-16,8); use=Bug3186.fst(16,5-16,8)
...
(Bug3186.vec @x2
@x3))
(or (and (is-Bug3186.Nil @x1)
(= @x2
(Bug3186.Nil_a @x1))
(= @x3
(BoxInt 0)))
(and (is-Bug3186.Cons @x1)
(= @x2
(Bug3186.Cons_a @x1))
(= @x3
(Prims.op_Addition (Bug3186.Cons_n @x1)
(BoxInt 1))))))
...
(Bug3186.vec @x2
@x3)))
:qid fuel_guarded_inversion_Bug3186.vec))

:named fuel_guarded_inversion_Bug3186.vec))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! (= 135
(Term_constr_id Bug3186.vec@tok))
:named fresh_token_Bug3186.vec@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(17,4-17,7); use=Bug3186.fst(17,4-17,7)
...
(Bug3186.vec @x1
@x2)))
:qid data_typing_intro_Bug3186.Nil@tok))

:named data_typing_intro_Bug3186.Nil@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
...
(Bug3186.vec @x1
@x5)))
:qid data_typing_intro_Bug3186.Cons@tok))

:named data_typing_intro_Bug3186.Cons@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(17,4-17,7); use=Bug3186.fst(17,4-17,7)
...
(Bug3186.vec @x2
@x3)))
:qid data_elim_Bug3186.Nil))

:named data_elim_Bug3186.Nil))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
...
(Bug3186.vec @x5
@x6)))
:qid data_elim_Bug3186.Cons))

:named data_elim_Bug3186.Cons))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(16,5-16,8); use=Bug3186.fst(16,5-16,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 134
(Term_constr_id (Bug3186.vec @x0
@x1)))
 

:pattern ((Bug3186.vec @x0
@x1))
:qid constructor_distinct_Bug3186.vec))

:named constructor_distinct_Bug3186.vec))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(17,4-17,7); use=Bug3186.fst(17,4-17,7)
(forall ((@x0 Term))
 (! (= 141
(Term_constr_id (Bug3186.Nil @x0)))
 

:pattern ((Bug3186.Nil @x0))
:qid constructor_distinct_Bug3186.Nil))

:named constructor_distinct_Bug3186.Nil))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 147
(Term_constr_id (Bug3186.Cons @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_Bug3186.Cons))

:named constructor_distinct_Bug3186.Cons))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(16,5-16,8); use=Bug3186.fst(16,5-16,8)
...
(Bug3186.vec @x2
@x3)))
:qid Bug3186_pretyping_cf0c6e0cd4ab5da998d28d2877378e71))

:named Bug3186_pretyping_cf0c6e0cd4ab5da998d28d2877378e71))
(push) ;; push{4
...
;   Prims.hasEq a /\
;   (forall (a: Type) (n: Prims.nat). {:pattern Prims.hasEq (Bug3186.vec a n)}
;       Prims.hasEq a ==> Prims.hasEq (Bug3186.vec a n)) ==>
;   (forall (n: Prims.nat) (hd: a) (tl: Bug3186.vec a n).
;       Prims.hasEq Prims.nat /\ Prims.hasEq a /\ Prims.hasEq (Bug3186.vec a n))
...
;; def=Bug3186.fst(16,0-18,59); use=Bug3186.fst(16,0-18,59)
(Valid 
;; def=Bug3186.fst(16,0-18,59); use=Bug3186.fst(16,0-18,59)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=Bug3186.fst(16,0-18,59); use=Bug3186.fst(16,0-18,59)
(Prims.hasEq (Bug3186.vec @x2
@x3))
)
)
 

:pattern ((Prims.hasEq (Bug3186.vec @x2
@x3)))
:qid @query.1))
)
...
;; def=Bug3186.fst(16,0-18,59); use=Bug3186.fst(16,0-18,59)
(and 
;; def=Bug3186.fst(16,0-18,59); use=Bug3186.fst(18,15-18,18)
(or label_1
...
;; def=Bug3186.fst(16,0-18,59); use=Bug3186.fst(18,26-18,27)
(or label_2
...
;; def=Bug3186.fst(16,0-18,59); use=Bug3186.fst(18,35-18,42)
(or label_3

;; def=Bug3186.fst(16,0-18,59); use=Bug3186.fst(16,0-18,59)
(Valid 
;; def=Bug3186.fst(16,0-18,59); use=Bug3186.fst(16,0-18,59)
(Prims.hasEq (Bug3186.vec @x0
@x2))
)
)
)
...
; encoding sigelt assume Bug3186.vec__uu___haseq


; <Start encoding assume Bug3186.vec__uu___haseq>


; </end encoding assume Bug3186.vec__uu___haseq>


; encoding sigelt val Bug3186.uu___is_Nil


; <Start encoding val Bug3186.uu___is_Nil>

(declare-fun Bug3186.uu___is_Nil (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: vec a n -> Prims.bool
(declare-fun Tm_arrow_a69188729e4eb6ccfe113898237b16d8 () Term)
(declare-fun Bug3186.uu___is_Nil@tok () Term)

; </end encoding val Bug3186.uu___is_Nil>
...
; encoding sigelt val Bug3186.uu___is_Cons


; <Start encoding val Bug3186.uu___is_Cons>

(declare-fun Bug3186.uu___is_Cons (Term Term Term) Term)

(declare-fun Bug3186.uu___is_Cons@tok () Term)

; </end encoding val Bug3186.uu___is_Cons>
...
; encoding sigelt val Bug3186.__proj__Cons__item__n


; <Start encoding val Bug3186.__proj__Cons__item__n>

(declare-fun Tm_refine_1a116130b76e885fa4991a27c9201108 (Term Term) Term)
(declare-fun Bug3186.__proj__Cons__item__n (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vec a n {Cons? _} -> Prims.nat
(declare-fun Tm_arrow_dcae6d915ce0a4795c576211287f4f12 () Term)
(declare-fun Bug3186.__proj__Cons__item__n@tok () Term)

; </end encoding val Bug3186.__proj__Cons__item__n>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug3186.uu___is_Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(Bug3186.vec @x0
@x1)))
(HasType (Bug3186.uu___is_Cons @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Bug3186.uu___is_Cons @x0
@x1
@x2))
:qid typing_Bug3186.uu___is_Cons))

:named typing_Bug3186.uu___is_Cons))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(16,5-16,8); use=Bug3186.fst(16,5-16,8)
...
:named subterm_ordering_Bug3186.Cons))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug3186.__proj__Cons__item__n; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_1a116130b76e885fa4991a27c9201108 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_1a116130b76e885fa4991a27c9201108 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_1a116130b76e885fa4991a27c9201108))

:named refinement_kinding_Tm_refine_1a116130b76e885fa4991a27c9201108))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug3186.__proj__Cons__item__n; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1a116130b76e885fa4991a27c9201108 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Bug3186.vec @x2
...
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(BoxBool_proj_0 (Bug3186.uu___is_Cons @x2
@x3
@x1))
))
...
(Tm_refine_1a116130b76e885fa4991a27c9201108 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_1a116130b76e885fa4991a27c9201108))

:named refinement_interpretation_Tm_refine_1a116130b76e885fa4991a27c9201108))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(17,4-17,7); use=Bug3186.fst(17,4-17,7)
...
:named kinding_Bug3186.vec@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1a116130b76e885fa4991a27c9201108
;;; Fact-ids: Name Bug3186.__proj__Cons__item__n; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1a116130b76e885fa4991a27c9201108 @x0
@x1)))
(Valid (Prims.hasEq (Bug3186.vec @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_1a116130b76e885fa4991a27c9201108 @x0
@x1))))
:qid haseqTm_refine_1a116130b76e885fa4991a27c9201108))

:named haseqTm_refine_1a116130b76e885fa4991a27c9201108))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! (HasType Prims.nat
Tm_type)
...
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,4-18,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug3186.uu___is_Cons @x0
@x1
@x2)
(BoxBool (is-Bug3186.Cons @x2)))
 

:pattern ((Bug3186.uu___is_Cons @x0
@x1
@x2))
:qid disc_equation_Bug3186.Cons))

:named disc_equation_Bug3186.Cons))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug3186.vec; Namespace Bug3186; Name Bug3186.Nil; Namespace Bug3186; Name Bug3186.Cons; Namespace Bug3186
(assert (! 
;; def=Bug3186.fst(17,4-17,7); use=Bug3186.fst(17,4-17,7)
...
;;;;;;;;;;;;;;;;Assumption: Bug3186.vec__uu___haseq
;;; Fact-ids: Name Bug3186.vec__uu___haseq; Namespace Bug3186
...
:pattern ((Prims.hasEq (Bug3186.vec @x0
@x1)))
:qid assumption_Bug3186.vec__uu___haseq))
:named assumption_Bug3186.vec__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! 
...
; Starting query at Bug3186.fst(18,12-18,13)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (n: Prims.nat) (projectee: _: Bug3186.vec a n {Cons? _}).
;   (*  - Could not prove post-condition
; *) ~(Cons? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Cons__item__n`
...
Prims.nat)
(HasType @x2
(Tm_refine_1a116130b76e885fa4991a27c9201108 @x0
@x1))

;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,12-18,13)
(not 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,12-18,13)
(BoxBool_proj_0 (Bug3186.uu___is_Cons @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3186.__proj__Cons__item__n, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_1a116130b76e885fa4991a27c9201108
...
; encoding sigelt let __proj__Cons__item__n


; <Skipped let __proj__Cons__item__n/>


; encoding sigelt val Bug3186.__proj__Cons__item__hd


; <Start encoding val Bug3186.__proj__Cons__item__hd>


(declare-fun Bug3186.__proj__Cons__item__hd (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vec a n {Cons? _} -> a
(declare-fun Tm_arrow_5df803e797a034332dc8dcb09e5261f4 () Term)
(declare-fun Bug3186.__proj__Cons__item__hd@tok () Term)

; </end encoding val Bug3186.__proj__Cons__item__hd>

(push) ;; push{2

; Starting query at Bug3186.fst(18,22-18,24)
...
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,22-18,24)
(not 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,22-18,24)
(BoxBool_proj_0 (Bug3186.uu___is_Cons @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3186.__proj__Cons__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_1a116130b76e885fa4991a27c9201108
...
; encoding sigelt val Bug3186.__proj__Cons__item__tl


; <Start encoding val Bug3186.__proj__Cons__item__tl>


(declare-fun Bug3186.__proj__Cons__item__tl (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vec a n {Cons? _} -> vec a projectee.n
(declare-fun Tm_arrow_8d9811a8cb252233d1823bce1818c5bb () Term)
(declare-fun Bug3186.__proj__Cons__item__tl@tok () Term)

; </end encoding val Bug3186.__proj__Cons__item__tl>

(push) ;; push{2

; Starting query at Bug3186.fst(18,31-18,33)
...
; *)
;   (~(Cons? projectee) ==> Prims.l_False) /\
;   (forall (b: Prims.nat) (b: a) (b: Bug3186.vec a b).
;       projectee == Bug3186.Cons b b ==> b + 1 == n /\ Cons? (Bug3186.Cons b b))
...
;; def=Prims.fst(459,77-459,89); use=Bug3186.fst(18,31-18,33)
(and (implies 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,31-18,33)
(not 
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,31-18,33)
(BoxBool_proj_0 (Bug3186.uu___is_Cons @x0
@x1
...
;; def=Prims.fst(413,99-413,120); use=Bug3186.fst(18,31-18,33)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.nat)
...
;; def=Bug3186.fst(18,4-18,8); use=Bug3186.fst(18,31-18,33)
(and 
;; def=Bug3186.fst(16,21-18,59); use=Bug3186.fst(18,4-18,8)
(or label_2

;; def=Bug3186.fst(16,21-18,59); use=Bug3186.fst(18,31-18,33)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3186.__proj__Cons__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Bug3186.Cons, refinement_interpretation_Tm_refine_1a116130b76e885fa4991a27c9201108
...
; Starting query at Bug3186.fst(21,76-21,77)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug3186.fst(21,41-21,49); use=Bug3186.fst(21,41-21,49)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x0)
Tm_type)
...
; Encoding query formula : forall (a: Type) (n: Prims.nat) (_: _: Prims.unit{n == 0}) (v: Bug3186.vec a n).
;   (*  - Could not prove post-condition
; *) n == 0


; Context: While encoding a query
; While typechecking the top-level declaration `let pconv_vec_z`
...
Prims.nat)
(HasType @x2
(Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x1))
(HasType @x3
(Bug3186.vec @x0
@x1)))

;; def=Bug3186.fst(21,29-21,73); use=Bug3186.fst(21,76-21,77)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3186.pconv_vec_z, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0cc3b8bc4390a8152398abb544530a43
...
; encoding sigelt let pconv_vec_z


; <Start encoding let pconv_vec_z>

(declare-fun Bug3186.pconv_vec_z (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: n == 0 -> v: vec a n -> vec a 0
(declare-fun Tm_arrow_3a1789aca0aefec3d29a504ac8bb1fba () Term)
(declare-fun Bug3186.pconv_vec_z@tok () Term)

; </end encoding let pconv_vec_z>

(push) ;; push{2

; Starting query at Bug3186.fst(23,84-23,85)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug3186.fst(23,38-23,58); use=Bug3186.fst(23,38-23,58)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x0)
Tm_type)
...
;   (n: Prims.nat)
;   (_: _: Prims.unit{_: Prims.unit{Prims.equals n 0 <: Type}})
;   (v: Bug3186.vec a n).
;   (*  - Could not prove post-condition
; *) n == 0
...
;; def=Bug3186.fst(23,30-23,81); use=Bug3186.fst(23,84-23,85)
(or label_1
...
(declare-fun Bug3186.pconv_vec_z_ (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;_: _: Prims.unit{Prims.equals n 0 <: Type} -> v: vec a n -> vec a 0
(declare-fun Tm_arrow_6cb78fa04c92f5444ca2e673076b8883 () Term)
(declare-fun Bug3186.pconv_vec_z_@tok () Term)
...
; Starting query at Bug3186.fst(25,89-25,90)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug3186.fst(25,42-25,62); use=Bug3186.fst(25,42-25,62)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_0cc3b8bc4390a8152398abb544530a43 @x0)
Tm_type)
...
; Encoding query formula : forall (a: Type)
;   (n: Prims.nat)
;   (_: _: Prims.unit{_: Prims.unit{Prims.equals n 0}})
;   (v: Bug3186.vec a n).
;   (*  - Could not prove post-condition
; *) n == 0
...
;; def=Bug3186.fst(25,31-25,86); use=Bug3186.fst(25,89-25,90)
(or label_1
