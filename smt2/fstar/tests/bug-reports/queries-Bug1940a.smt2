...
; Internals for Bug1940a


; encoding sigelt type Bug1940a.alg


; <Start encoding type Bug1940a.alg>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1940a.alg () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1940a.A () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1940a.A
(declare-fun Bug1940a.A@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1940a.B () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1940a.B
(declare-fun Bug1940a.B@tok () Term)

; <start constructor Bug1940a.alg>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1940a.alg ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
Bug1940a.alg)))

; </end constructor Bug1940a.alg>


; <start constructor Bug1940a.A>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1940a.A ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
128)
(= __@x0
Bug1940a.A)))

; </end constructor Bug1940a.A>


; <start constructor Bug1940a.B>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1940a.B ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
130)
(= __@x0
Bug1940a.B)))

; </end constructor Bug1940a.B>


; </end encoding type Bug1940a.alg>


; encoding sigelt assume Bug1940a.alg__uu___haseq


; <Start encoding assume Bug1940a.alg__uu___haseq>


; </end encoding assume Bug1940a.alg__uu___haseq>


; encoding sigelt val Bug1940a.uu___is_A


; <Start encoding val Bug1940a.uu___is_A>

(declare-fun Bug1940a.uu___is_A (Term) Term)
;;;;;;;;;;;;;;;;projectee: alg -> Prims.bool
(declare-fun Tm_arrow_45f32a2559d25da966b72c4c141bfeb4 () Term)
(declare-fun Bug1940a.uu___is_A@tok () Term)

; </end encoding val Bug1940a.uu___is_A>
...
; encoding sigelt val Bug1940a.uu___is_B


; <Start encoding val Bug1940a.uu___is_B>

(declare-fun Bug1940a.uu___is_B (Term) Term)

(declare-fun Bug1940a.uu___is_B@tok () Term)

; </end encoding val Bug1940a.uu___is_B>
...
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug1940a.alg; Namespace Bug1940a; Name Bug1940a.A; Namespace Bug1940a; Name Bug1940a.B; Namespace Bug1940a
(assert (! (HasType Bug1940a.B@tok
Bug1940a.alg)
:named typing_tok_Bug1940a.B@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug1940a.alg; Namespace Bug1940a; Name Bug1940a.A; Namespace Bug1940a; Name Bug1940a.B; Namespace Bug1940a
(assert (! (HasType Bug1940a.A@tok
Bug1940a.alg)
:named typing_tok_Bug1940a.A@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1940a.uu___is_B; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(7,17-7,18); use=Bug1940a.fst(7,17-7,18)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1940a.alg)
(HasType (Bug1940a.uu___is_B @x0)
Prims.bool))
 

:pattern ((Bug1940a.uu___is_B @x0))
:qid typing_Bug1940a.uu___is_B))

:named typing_Bug1940a.uu___is_B))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1940a.uu___is_A; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(7,13-7,14); use=Bug1940a.fst(7,13-7,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1940a.alg)
(HasType (Bug1940a.uu___is_A @x0)
Prims.bool))
 

:pattern ((Bug1940a.uu___is_A @x0))
:qid typing_Bug1940a.uu___is_A))

:named typing_Bug1940a.uu___is_A))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;; Fact-ids: Name Bug1940a.alg; Namespace Bug1940a; Name Bug1940a.A; Namespace Bug1940a; Name Bug1940a.B; Namespace Bug1940a
(assert (! (HasType Bug1940a.alg
Tm_type)
:named kinding_Bug1940a.alg@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;; Fact-ids: Name Bug1940a.alg; Namespace Bug1940a; Name Bug1940a.A; Namespace Bug1940a; Name Bug1940a.B; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(7,5-7,8); use=Bug1940a.fst(7,5-7,8)
(forall ((@u0 Fuel) (@x1 Term))
...
@x1
Bug1940a.alg))
:qid fuel_guarded_inversion_Bug1940a.alg))

:named fuel_guarded_inversion_Bug1940a.alg))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug1940a.alg; Namespace Bug1940a; Name Bug1940a.A; Namespace Bug1940a; Name Bug1940a.B; Namespace Bug1940a
(assert (! (= Bug1940a.B@tok
Bug1940a.B)
:named equality_tok_Bug1940a.B@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug1940a.alg; Namespace Bug1940a; Name Bug1940a.A; Namespace Bug1940a; Name Bug1940a.B; Namespace Bug1940a
(assert (! (= Bug1940a.A@tok
Bug1940a.A)
:named equality_tok_Bug1940a.A@tok))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug1940a.uu___is_B; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(7,17-7,18); use=Bug1940a.fst(7,17-7,18)
(forall ((@x0 Term))
 (! (= (Bug1940a.uu___is_B @x0)
(BoxBool (is-Bug1940a.B @x0)))
 

:pattern ((Bug1940a.uu___is_B @x0))
:qid disc_equation_Bug1940a.B))

:named disc_equation_Bug1940a.B))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug1940a.uu___is_A; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(7,13-7,14); use=Bug1940a.fst(7,13-7,14)
(forall ((@x0 Term))
 (! (= (Bug1940a.uu___is_A @x0)
(BoxBool (is-Bug1940a.A @x0)))
 

:pattern ((Bug1940a.uu___is_A @x0))
:qid disc_equation_Bug1940a.A))

:named disc_equation_Bug1940a.A))
...
Bug1940a.B
Bug1940a.alg))
:qid data_typing_intro_Bug1940a.B@tok))

:named data_typing_intro_Bug1940a.B@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug1940a.alg; Namespace Bug1940a; Name Bug1940a.A; Namespace Bug1940a; Name Bug1940a.B; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(7,13-7,14); use=Bug1940a.fst(7,13-7,14)
...
Bug1940a.A
Bug1940a.alg))
:qid data_typing_intro_Bug1940a.A@tok))

:named data_typing_intro_Bug1940a.A@tok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Bug1940a.alg; Namespace Bug1940a; Name Bug1940a.A; Namespace Bug1940a; Name Bug1940a.B; Namespace Bug1940a
(assert (! (= 122
(Term_constr_id Bug1940a.alg))
:named constructor_distinct_Bug1940a.alg))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug1940a.alg; Namespace Bug1940a; Name Bug1940a.A; Namespace Bug1940a; Name Bug1940a.B; Namespace Bug1940a
(assert (! (= 130
(Term_constr_id Bug1940a.B))
:named constructor_distinct_Bug1940a.B))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug1940a.alg; Namespace Bug1940a; Name Bug1940a.A; Namespace Bug1940a; Name Bug1940a.B; Namespace Bug1940a
(assert (! (= 128
(Term_constr_id Bug1940a.A))
:named constructor_distinct_Bug1940a.A))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
;;;;;;;;;;;;;;;;Assumption: Bug1940a.alg__uu___haseq
;;; Fact-ids: Name Bug1940a.alg__uu___haseq; Namespace Bug1940a
(assert (! (Valid (Prims.hasEq Bug1940a.alg))
:named assumption_Bug1940a.alg__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Bug1940a.alg))
:qid Bug1940a_pretyping_143fb44587ccb42789c24dc5a83ee7b9))

:named Bug1940a_pretyping_143fb44587ccb42789c24dc5a83ee7b9))
(push) ;; push{2

; Starting query at Bug1940a.fst(9,21-11,11)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Bug1940a.alg).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Prims.int).
;     (forall (x: Prims.int). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(A? a) /\ ~(B? a) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let length`
...
;; def=Prims.fst(402,27-402,88); use=Bug1940a.fst(9,21-11,11)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug1940a.fst(9,21-11,11)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug1940a.fst(9,21-11,11)
(ApplyTT @x1
@x2)
...
;; def=Bug1940a.fst(9,12-9,13); use=Bug1940a.fst(9,27-9,28)
(not 
;; def=Bug1940a.fst(9,12-9,13); use=Bug1940a.fst(9,27-9,28)
(BoxBool_proj_0 (Bug1940a.uu___is_A @x0))
)
...
(not 
;; def=Bug1940a.fst(9,12-9,13); use=Bug1940a.fst(9,27-9,28)
(BoxBool_proj_0 (Bug1940a.uu___is_B @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1940a.length, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Bug1940a.A, disc_equation_Bug1940a.B, fuel_guarded_inversion_Bug1940a.alg, projection_inverse_BoxBool_proj_0
...
(declare-fun Bug1940a.length (Term) Term)
;;;;;;;;;;;;;;;;a: alg -> Prims.int
(declare-fun Tm_arrow_ab8a6f7a3f0b6c00ae37c09718a632b7 () Term)
(declare-fun Bug1940a.length@tok () Term)

; </end encoding let length>

(push) ;; push{2

; Starting query at Bug1940a.fst(13,26-15,21)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let repr_length`
...
;; def=Prims.fst(402,27-402,88); use=Bug1940a.fst(13,26-15,21)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug1940a.fst(13,26-15,21)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug1940a.fst(13,26-15,21)
(ApplyTT @x1
@x2)
...
;; def=Bug1940a.fst(13,17-13,18); use=Bug1940a.fst(13,32-13,33)
(not 
;; def=Bug1940a.fst(13,17-13,18); use=Bug1940a.fst(13,32-13,33)
(BoxBool_proj_0 (Bug1940a.uu___is_A @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1940a.repr_length, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Bug1940a.A, disc_equation_Bug1940a.B, fuel_guarded_inversion_Bug1940a.alg, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let repr_length


; <Start encoding let repr_length>

(declare-fun Bug1940a.repr_length (Term) Term)

(declare-fun Bug1940a.repr_length@tok () Term)

; </end encoding let repr_length>
...
(declare-fun Bug1940a.lbytes (Term) Term)
;;;;;;;;;;;;;;;;n: Prims.nat -> Type
(declare-fun Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e () Term)
(declare-fun Bug1940a.lbytes@tok () Term)

; </end encoding let lbytes>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1940a.length; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(9,4-9,10); use=Bug1940a.fst(9,4-9,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1940a.alg)
(HasType (Bug1940a.length @x0)
Prims.int))
 

:pattern ((Bug1940a.length @x0))
:qid typing_Bug1940a.length))

:named typing_Bug1940a.length))
;;;;;;;;;;;;;;;;Equation for Bug1940a.length
;;; Fact-ids: Name Bug1940a.length; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(9,4-9,10); use=Bug1940a.fst(9,4-9,10)
(forall ((@x0 Term))
 (! (= (Bug1940a.length @x0)
(let ((@lb1 @x0))
(ite (is-Bug1940a.A @lb1)
(BoxInt 32)
(ite (is-Bug1940a.B @lb1)
(BoxInt 64)
Tm_unit))))
 

:pattern ((Bug1940a.length @x0))
:qid equation_Bug1940a.length))

:named equation_Bug1940a.length))
(push) ;; push{2

; Starting query at Bug1940a.fst(19,25-19,42)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Bug1940a.alg). (*  - Could not prove post-condition
; *) Bug1940a.length a >= 0


; Context: While encoding a query
; While typechecking the top-level declaration `let compressed`
...
;; def=Prims.fst(680,18-680,24); use=Bug1940a.fst(19,32-19,42)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Bug1940a.fst(19,32-19,42)
(>= (BoxInt_proj_0 (Bug1940a.length @x0))
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1940a.compressed, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Bug1940a.length, fuel_guarded_inversion_Bug1940a.alg, projection_inverse_BoxInt_proj_0
...
; encoding sigelt let compressed


; <Start encoding let compressed>

(declare-fun Bug1940a.compressed (Term) Term)
;;;;;;;;;;;;;;;;a: alg -> Type
(declare-fun Tm_arrow_198c8be4e08eb035462e15d05d784b8f () Term)
(declare-fun Bug1940a.compressed@tok () Term)

; </end encoding let compressed>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1940a.repr_length; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(13,4-13,15); use=Bug1940a.fst(13,4-13,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1940a.alg)
(HasType (Bug1940a.repr_length @x0)
Prims.int))
 

:pattern ((Bug1940a.repr_length @x0))
:qid typing_Bug1940a.repr_length))

:named typing_Bug1940a.repr_length))
...
;;;;;;;;;;;;;;;;Equation for Bug1940a.repr_length
;;; Fact-ids: Name Bug1940a.repr_length; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(13,4-13,15); use=Bug1940a.fst(13,4-13,15)
(forall ((@x0 Term))
 (! (= (Bug1940a.repr_length @x0)
(let ((@lb1 @x0))
(ite (is-Bug1940a.A @lb1)
(Bug1940a.length Bug1940a.A@tok)
(ite (is-Bug1940a.B @lb1)
(Prims.op_Addition (Bug1940a.length Bug1940a.B@tok)
(BoxInt 1))
Tm_unit))))
 

:pattern ((Bug1940a.repr_length @x0))
:qid equation_Bug1940a.repr_length))

:named equation_Bug1940a.repr_length))
(push) ;; push{2

; Starting query at Bug1940a.fst(21,19-21,41)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Bug1940a.alg). (*  - Could not prove post-condition
; *) Bug1940a.repr_length a >= 0
...
;; def=Prims.fst(680,18-680,24); use=Bug1940a.fst(21,26-21,41)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Bug1940a.fst(21,26-21,41)
(>= (BoxInt_proj_0 (Bug1940a.repr_length @x0))
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1940a.repr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_Bug1940a.A, constructor_distinct_Bug1940a.B, equality_tok_Bug1940a.A@tok, equality_tok_Bug1940a.B@tok, equation_Bug1940a.length, equation_Bug1940a.repr_length, fuel_guarded_inversion_Bug1940a.alg, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0
...
(declare-fun Bug1940a.repr (Term) Term)

(declare-fun Bug1940a.repr@tok () Term)
...
(HasType @x1
Prims.nat))
(HasType (FStar.Seq.Properties.lseq @x0
@x1)
Tm_type))
...
@x1))
:qid typing_FStar.Seq.Properties.lseq))

:named typing_FStar.Seq.Properties.lseq))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1940a.lbytes; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(17,4-17,10); use=Bug1940a.fst(17,4-17,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (Bug1940a.lbytes @x0)
Tm_type))
 

:pattern ((Bug1940a.lbytes @x0))
:qid typing_Bug1940a.lbytes))

:named typing_Bug1940a.lbytes))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1940a.compressed; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(19,4-19,14); use=Bug1940a.fst(19,4-19,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1940a.alg)
(HasType (Bug1940a.compressed @x0)
Tm_type))
 

:pattern ((Bug1940a.compressed @x0))
:qid typing_Bug1940a.compressed))

:named typing_Bug1940a.compressed))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Seq.Properties.lseq; Namespace FStar.Seq.Properties
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a0cd7d06c5da6444b6b51b319febde8e @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Seq.Base.seq @x2))

;; def=FStar.Seq.Properties.fsti(23,19-23,36); use=FStar.Seq.Properties.fsti(23,19-23,36)
...
(Tm_refine_a0cd7d06c5da6444b6b51b319febde8e @x2
@x3)))
:qid refinement_interpretation_Tm_refine_a0cd7d06c5da6444b6b51b319febde8e))

:named refinement_interpretation_Tm_refine_a0cd7d06c5da6444b6b51b319febde8e))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_a0cd7d06c5da6444b6b51b319febde8e
;;; Fact-ids: Name FStar.Seq.Properties.lseq; Namespace FStar.Seq.Properties
(assert (! 
;; def=FStar.Seq.Properties.fsti(23,4-23,38); use=FStar.Seq.Properties.fsti(23,4-23,38)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a0cd7d06c5da6444b6b51b319febde8e @x0
@x1)))
(Valid (Prims.hasEq (FStar.Seq.Base.seq @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a0cd7d06c5da6444b6b51b319febde8e @x0
@x1))))
:qid haseqTm_refine_a0cd7d06c5da6444b6b51b319febde8e))

:named haseqTm_refine_a0cd7d06c5da6444b6b51b319febde8e))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! (HasType Prims.nat
Tm_type)
...
;;;;;;;;;;;;;;;;Equation for Bug1940a.lbytes
;;; Fact-ids: Name Bug1940a.lbytes; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(17,4-17,10); use=Bug1940a.fst(17,4-17,10)
(forall ((@x0 Term))
 (! (= (Bug1940a.lbytes @x0)
(FStar.Seq.Properties.lseq Prims.nat
@x0))
 

:pattern ((Bug1940a.lbytes @x0))
:qid equation_Bug1940a.lbytes))

:named equation_Bug1940a.lbytes))
;;;;;;;;;;;;;;;;Equation for Bug1940a.compressed
;;; Fact-ids: Name Bug1940a.compressed; Namespace Bug1940a
(assert (! 
;; def=Bug1940a.fst(19,4-19,14); use=Bug1940a.fst(19,4-19,14)
(forall ((@x0 Term))
 (! (= (Bug1940a.compressed @x0)
(Bug1940a.lbytes (Bug1940a.length @x0)))
 

:pattern ((Bug1940a.compressed @x0))
:qid equation_Bug1940a.compressed))

:named equation_Bug1940a.compressed))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Seq.Base.seq; Namespace FStar.Seq.Base
(assert (! 
;; def=FStar.Seq.Base.fsti(23,8-23,11); use=FStar.Seq.Base.fsti(23,8-23,11)
...
; Starting query at Bug1940a.fst(24,64-24,66)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Bug1940a.alg) (pk: Bug1940a.compressed a).
;   (*  - Could not prove post-condition
; *)
;   FStar.Seq.Base.length pk == Bug1940a.length a ==>
;   FStar.Seq.Base.length pk == Bug1940a.repr_length a


; Context: While encoding a query
; While typechecking the top-level declaration `let point_decompress`
; While typechecking the top-level declaration `[@@expect_failure] let point_decompress`
...
;; def=FStar.Seq.Properties.fsti(23,19-23,36); use=Bug1940a.fst(24,64-24,66)
(= (FStar.Seq.Base.length Prims.nat
@x1)
(Bug1940a.length @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1940a.point_decompress, 1)
