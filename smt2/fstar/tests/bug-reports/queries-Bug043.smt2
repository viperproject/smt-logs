...
; encoding sigelt type Bug043.nat


; <Start encoding type Bug043.nat>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug043.nat () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug043.O () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug043.O
(declare-fun Bug043.O@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug043.S (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug043.S__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug043.S
(declare-fun Bug043.S@tok () Term)
;;;;;;;;;;;;;;;;_0: nat -> nat
(declare-fun Tm_arrow_d971454c0f30ecb3167bca82ec29b544 () Term)

; <start constructor Bug043.nat>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug043.nat ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
Bug043.nat)))

; </end constructor Bug043.nat>


; <start constructor Bug043.O>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug043.O ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
Bug043.O)))

; </end constructor Bug043.O>


; <start constructor Bug043.S>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug043.S ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
(Bug043.S (Bug043.S__0 __@x0)))))

; </end constructor Bug043.S>


; </end encoding type Bug043.nat>
...
;;; Fact-ids: Name Bug043.nat; Namespace Bug043; Name Bug043.O; Namespace Bug043; Name Bug043.S; Namespace Bug043
(assert (! (HasType Bug043.O@tok
Bug043.nat)
:named typing_tok_Bug043.O@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name Bug043.nat; Namespace Bug043; Name Bug043.O; Namespace Bug043; Name Bug043.S; Namespace Bug043
(assert (! 
;; def=Bug043.fst(20,4-20,5); use=Bug043.fst(20,4-20,5)
...
(Bug043.S @x1)
Bug043.nat))
:qid subterm_ordering_Bug043.S))

:named subterm_ordering_Bug043.S))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=Bug043.fst(20,4-20,5); use=Bug043.fst(20,4-20,5)
(forall ((@x0 Term))
 (! (= (Bug043.S__0 (Bug043.S @x0))
@x0)
 

:pattern ((Bug043.S @x0))
:qid projection_inverse_Bug043.S__0))

:named projection_inverse_Bug043.S__0))
;;; Fact-ids: Name Bug043.nat; Namespace Bug043; Name Bug043.O; Namespace Bug043; Name Bug043.S; Namespace Bug043
(assert (! (HasType Bug043.nat
Tm_type)
:named kinding_Bug043.nat@tok))
...
;;; Fact-ids: Name Bug043.nat; Namespace Bug043; Name Bug043.O; Namespace Bug043; Name Bug043.S; Namespace Bug043
(assert (! 
;; def=Bug043.fst(18,5-18,8); use=Bug043.fst(18,5-18,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Bug043.nat)
...
@x1
Bug043.nat))
:qid fuel_guarded_inversion_Bug043.nat))

:named fuel_guarded_inversion_Bug043.nat))
...
(assert (! (= Bug043.O@tok
Bug043.O)
:named equality_tok_Bug043.O@tok))
...
(Bug043.S @x1)
Bug043.nat))
:qid data_typing_intro_Bug043.S@tok))

:named data_typing_intro_Bug043.S@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug043.nat; Namespace Bug043; Name Bug043.O; Namespace Bug043; Name Bug043.S; Namespace Bug043
(assert (! 
;; def=Bug043.fst(19,4-19,5); use=Bug043.fst(19,4-19,5)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug043.O
Bug043.nat)
...
Bug043.O
Bug043.nat))
:qid data_typing_intro_Bug043.O@tok))

:named data_typing_intro_Bug043.O@tok))
...
(Bug043.S @x1)
Bug043.nat))
:qid data_elim_Bug043.S))

:named data_elim_Bug043.S))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Bug043.nat; Namespace Bug043; Name Bug043.O; Namespace Bug043; Name Bug043.S; Namespace Bug043
(assert (! (= 116
(Term_constr_id Bug043.nat))
:named constructor_distinct_Bug043.nat))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug043.nat; Namespace Bug043; Name Bug043.O; Namespace Bug043; Name Bug043.S; Namespace Bug043
(assert (! 
;; def=Bug043.fst(20,4-20,5); use=Bug043.fst(20,4-20,5)
(forall ((@x0 Term))
 (! (= 124
(Term_constr_id (Bug043.S @x0)))
 

:pattern ((Bug043.S @x0))
:qid constructor_distinct_Bug043.S))

:named constructor_distinct_Bug043.S))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug043.nat; Namespace Bug043; Name Bug043.O; Namespace Bug043; Name Bug043.S; Namespace Bug043
(assert (! (= 122
(Term_constr_id Bug043.O))
:named constructor_distinct_Bug043.O))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Bug043.nat))
:qid Bug043_pretyping_aff9916f72349fcab9447b4a76190831))

:named Bug043_pretyping_aff9916f72349fcab9447b4a76190831))
(push) ;; push{4

; Starting query at Bug043.fst(18,0-20,18)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq Bug043.nat ==>
; (forall (_0: Bug043.nat).
...
; *)
;     Prims.hasEq Bug043.nat)


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug043.nat`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=Bug043.fst(18,0-20,18); use=Bug043.fst(18,0-20,18)
(Valid 
;; def=Bug043.fst(18,0-20,18); use=Bug043.fst(18,0-20,18)
(Prims.hasEq Bug043.nat)
)
...
;; def=Bug043.fst(18,0-20,18); use=Bug043.fst(20,8-20,11)
(or label_1
...
; encoding sigelt assume Bug043.nat__uu___haseq


; <Start encoding assume Bug043.nat__uu___haseq>


; </end encoding assume Bug043.nat__uu___haseq>


; encoding sigelt val Bug043.uu___is_O


; <Start encoding val Bug043.uu___is_O>

(declare-fun Bug043.uu___is_O (Term) Term)
;;;;;;;;;;;;;;;;projectee: nat -> Prims.bool
(declare-fun Tm_arrow_25c963c88138aec1690ad32ff042e7ea () Term)
(declare-fun Bug043.uu___is_O@tok () Term)

; </end encoding val Bug043.uu___is_O>
...
; encoding sigelt val Bug043.uu___is_S


; <Start encoding val Bug043.uu___is_S>

(declare-fun Bug043.uu___is_S (Term) Term)

(declare-fun Bug043.uu___is_S@tok () Term)

; </end encoding val Bug043.uu___is_S>
...
; encoding sigelt val Bug043.__proj__S__item___0


; <Start encoding val Bug043.__proj__S__item___0>

(declare-fun Tm_refine_e9b75321b1c0b82fe3be1f811b1a5f79 () Term)
(declare-fun Bug043.__proj__S__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: nat{S? _} -> nat
(declare-fun Tm_arrow_d9fd1b1e106da0861bfaa57add4b9c77 () Term)
(declare-fun Bug043.__proj__S__item___0@tok () Term)

; </end encoding val Bug043.__proj__S__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug043.uu___is_S; Namespace Bug043
(assert (! 
;; def=Bug043.fst(20,4-20,5); use=Bug043.fst(20,4-20,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug043.nat)
(HasType (Bug043.uu___is_S @x0)
Prims.bool))
 

:pattern ((Bug043.uu___is_S @x0))
:qid typing_Bug043.uu___is_S))

:named typing_Bug043.uu___is_S))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug043.nat; Namespace Bug043; Name Bug043.O; Namespace Bug043; Name Bug043.S; Namespace Bug043
(assert (! 
;; def=Bug043.fst(20,4-20,5); use=Bug043.fst(20,4-20,5)
...
:named refinement_kinding_Tm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug043.__proj__S__item___0; Namespace Bug043
(assert (! (HasType Tm_refine_e9b75321b1c0b82fe3be1f811b1a5f79
Tm_type)
:named refinement_kinding_Tm_refine_e9b75321b1c0b82fe3be1f811b1a5f79))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_e9b75321b1c0b82fe3be1f811b1a5f79)
(and (HasTypeFuel @u0
@x1
Bug043.nat)

;; def=Bug043.fst(20,4-20,5); use=Bug043.fst(20,4-20,5)
(BoxBool_proj_0 (Bug043.uu___is_S @x1))
))
...
@x1
Tm_refine_e9b75321b1c0b82fe3be1f811b1a5f79))
:qid refinement_interpretation_Tm_refine_e9b75321b1c0b82fe3be1f811b1a5f79))

:named refinement_interpretation_Tm_refine_e9b75321b1c0b82fe3be1f811b1a5f79))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
;; def=Prims.fst(304,12-304,41); use=Prims.fst(304,12-304,41)
...
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e9b75321b1c0b82fe3be1f811b1a5f79
;;; Fact-ids: Name Bug043.__proj__S__item___0; Namespace Bug043
(assert (! (iff (Valid (Prims.hasEq Tm_refine_e9b75321b1c0b82fe3be1f811b1a5f79))
(Valid (Prims.hasEq Bug043.nat)))
:named haseqTm_refine_e9b75321b1c0b82fe3be1f811b1a5f79))
;;;;;;;;;;;;;;;;haseq for Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
(Valid (Prims.hasEq Tm_type)))
...
(forall ((@x0 Term))
 (! (= (Bug043.uu___is_S @x0)
(BoxBool (is-Bug043.S @x0)))
 

:pattern ((Bug043.uu___is_S @x0))
:qid disc_equation_Bug043.S))

:named disc_equation_Bug043.S))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: Bug043.nat__uu___haseq
;;; Fact-ids: Name Bug043.nat__uu___haseq; Namespace Bug043
(assert (! (Valid (Prims.hasEq Bug043.nat))
:named assumption_Bug043.nat__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Encoding query formula : forall (projectee: _: Bug043.nat{S? _}).
...
(not 
;; def=Bug043.fst(20,4-20,5); use=Bug043.fst(20,4-20,5)
(BoxBool_proj_0 (Bug043.uu___is_S @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug043.__proj__S__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_e9b75321b1c0b82fe3be1f811b1a5f79
...
(declare-fun Bug043.env () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> FStar.Pervasives.Native.option nat
(declare-fun Tm_arrow_8e982a9ff0ef1a163714a03e77801a32 () Term)

; </end encoding let env>


; encoding sigelt val Bug043.f


; <Start encoding val Bug043.f>

(declare-fun Bug043.f (Term) Term)

(declare-fun Bug043.f@tok () Term)

; </end encoding val Bug043.f>


; encoding sigelt val Bug043.free_in_context


; <Skipped val Bug043.free_in_context/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug043.env; Namespace Bug043
(assert (! (HasType Bug043.env
Tm_type)
:named typing_Bug043.env))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8e982a9ff0ef1a163714a03e77801a32
;;; Fact-ids: Name Bug043.env; Namespace Bug043
(assert (! (HasType Tm_arrow_8e982a9ff0ef1a163714a03e77801a32
Tm_type)
:named kinding_Tm_arrow_8e982a9ff0ef1a163714a03e77801a32))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
(assert (! (HasType Bug043.env
Tm_type)
:named function_token_typing_Bug043.env))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;Equation for Bug043.env
;;; Fact-ids: Name Bug043.env; Namespace Bug043
(assert (! (= Bug043.env
Tm_arrow_8e982a9ff0ef1a163714a03e77801a32)
:named equation_Bug043.env))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;;; Fact-ids: Name Bug043.env; Namespace Bug043
(assert (! 
;; def=Bug043.fst(22,11-22,34); use=Bug043.fst(22,11-22,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8e982a9ff0ef1a163714a03e77801a32)
...
@x1
Tm_arrow_8e982a9ff0ef1a163714a03e77801a32))
:qid Bug043_pre_typing_Tm_arrow_8e982a9ff0ef1a163714a03e77801a32))

:named Bug043_pre_typing_Tm_arrow_8e982a9ff0ef1a163714a03e77801a32))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8e982a9ff0ef1a163714a03e77801a32
;;; Fact-ids: Name Bug043.env; Namespace Bug043
(assert (! 
;; def=Bug043.fst(22,11-22,34); use=Bug043.fst(22,11-22,34)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(FStar.Pervasives.Native.option Bug043.nat)))
 

:pattern ((ApplyTT @x0
@x1))
:qid Bug043_interpretation_Tm_arrow_8e982a9ff0ef1a163714a03e77801a32.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_8e982a9ff0ef1a163714a03e77801a32))
:qid Bug043_interpretation_Tm_arrow_8e982a9ff0ef1a163714a03e77801a32))

:named Bug043_interpretation_Tm_arrow_8e982a9ff0ef1a163714a03e77801a32))
(push) ;; push{3

; Starting query at Bug043.fst(31,2-32,32)

;;;;;;;;;;;;;;;;e : Bug043.nat (Bug043.nat)
(declare-fun x_aff9916f72349fcab9447b4a76190831_0 () Term)
;;;;;;;;;;;;;;;;binder_x_aff9916f72349fcab9447b4a76190831_0
;;; Fact-ids: 
(assert (! (HasType x_aff9916f72349fcab9447b4a76190831_0
Bug043.nat)
:named binder_x_aff9916f72349fcab9447b4a76190831_0))
;;;;;;;;;;;;;;;;g : Bug043.env (Bug043.env)
(declare-fun x_8ff43a3c386d95104a4d4c7ea237a119_1 () Term)
;;;;;;;;;;;;;;;;binder_x_8ff43a3c386d95104a4d4c7ea237a119_1
;;; Fact-ids: 
(assert (! (HasType x_8ff43a3c386d95104a4d4c7ea237a119_1
Bug043.env)
:named binder_x_8ff43a3c386d95104a4d4c7ea237a119_1))
(declare-fun Tm_refine_25976510e8a37a5cf50df50893dcbd99 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug043.fst(26,31-32,32); use=Bug043.fst(26,31-32,32)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_25976510e8a37a5cf50df50893dcbd99 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_25976510e8a37a5cf50df50893dcbd99 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_25976510e8a37a5cf50df50893dcbd99))

:named refinement_kinding_Tm_refine_25976510e8a37a5cf50df50893dcbd99))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug043.fst(26,31-32,32); use=Bug043.fst(26,31-32,32)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_25976510e8a37a5cf50df50893dcbd99 @x2))
(and (HasTypeFuel @u0
@x1
Bug043.env)

;; def=Bug043.fst(31,2-32,32); use=Bug043.fst(31,2-32,32)

;; def=Bug043.fst(31,2-32,32); use=Bug043.fst(31,2-32,32)
(Valid 
;; def=Bug043.fst(31,2-32,32); use=Bug043.fst(31,2-32,32)
(Prims.precedes Bug043.nat
Bug043.nat
@x2
x_aff9916f72349fcab9447b4a76190831_0)
)
...
@x1
(Tm_refine_25976510e8a37a5cf50df50893dcbd99 @x2)))
:qid refinement_interpretation_Tm_refine_25976510e8a37a5cf50df50893dcbd99))

:named refinement_interpretation_Tm_refine_25976510e8a37a5cf50df50893dcbd99))
;;;;;;;;;;;;;;;;haseq for Tm_refine_25976510e8a37a5cf50df50893dcbd99
;;; Fact-ids: 
(assert (! 
;; def=Bug043.fst(26,31-32,32); use=Bug043.fst(26,31-32,32)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_25976510e8a37a5cf50df50893dcbd99 @x0)))
(Valid (Prims.hasEq Bug043.env)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_25976510e8a37a5cf50df50893dcbd99 @x0))))
:qid haseqTm_refine_25976510e8a37a5cf50df50893dcbd99))

:named haseqTm_refine_25976510e8a37a5cf50df50893dcbd99))
(declare-fun Bug043.free_in_context (Term Term) Term)

(declare-fun Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug043.fst(26,45-26,49); use=Bug043.fst(30,8-30,23)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b))

:named refinement_kinding_Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug043.fst(26,45-26,49); use=Bug043.fst(30,8-30,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=Bug043.fst(28,25-28,37); use=Bug043.fst(30,8-30,23)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some Bug043.nat
(ApplyTT @x2
(BoxInt 42))))
))
...
@x1
(Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b @x2)))
:qid refinement_interpretation_Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b))

:named refinement_interpretation_Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b
;;; Fact-ids: 
(assert (! 
;; def=Bug043.fst(26,45-26,49); use=Bug043.fst(30,8-30,23)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b @x0))))
:qid haseqTm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b))

:named haseqTm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b))
;;;;;;;;;;;;;;;;e: nat -> g: env{e << e} -> Prims.Pure Prims.unit
(declare-fun Tm_arrow_2718c126965d3405cad2f40386144011 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2718c126965d3405cad2f40386144011
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_2718c126965d3405cad2f40386144011
Tm_type)
:named kinding_Tm_arrow_2718c126965d3405cad2f40386144011))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug043.fst(26,24-32,32); use=Bug043.fst(26,31-32,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2718c126965d3405cad2f40386144011)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_2718c126965d3405cad2f40386144011))
:qid Bug043_pre_typing_Tm_arrow_2718c126965d3405cad2f40386144011))

:named Bug043_pre_typing_Tm_arrow_2718c126965d3405cad2f40386144011))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2718c126965d3405cad2f40386144011
;;; Fact-ids: 
(assert (! 
;; def=Bug043.fst(26,24-32,32); use=Bug043.fst(26,31-32,32)
(forall ((@x0 Term))
...
Bug043.nat)
(HasType @x2
(Tm_refine_25976510e8a37a5cf50df50893dcbd99 @x1)))
...
@x1)
@x2))
:qid Bug043_interpretation_Tm_arrow_2718c126965d3405cad2f40386144011.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug043_interpretation_Tm_arrow_2718c126965d3405cad2f40386144011.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_2718c126965d3405cad2f40386144011))
:qid Bug043_interpretation_Tm_arrow_2718c126965d3405cad2f40386144011))

:named Bug043_interpretation_Tm_arrow_2718c126965d3405cad2f40386144011))
(declare-fun Bug043.free_in_context@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug043.fst(30,8-30,23); use=Bug043.fst(30,8-30,23)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug043.free_in_context@tok
@x0)
@x1)
(Bug043.free_in_context @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Bug043.free_in_context@tok
@x0)
@x1))
:qid token_correspondence_Bug043.free_in_context))

:named token_correspondence_Bug043.free_in_context))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug043.fst(30,8-30,23); use=Bug043.fst(30,8-30,23)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Bug043.free_in_context@tok
Tm_arrow_2718c126965d3405cad2f40386144011))
...
@x1)
@x2)
(Bug043.free_in_context @x1
@x2))
 

:pattern ((Bug043.free_in_context @x1
@x2))
:qid function_token_typing_Bug043.free_in_context.1))
)
 

:pattern ((ApplyTT @x0
Bug043.free_in_context@tok))
:qid function_token_typing_Bug043.free_in_context))

:named function_token_typing_Bug043.free_in_context))
...
Bug043.nat)
(HasType @x1
(Tm_refine_25976510e8a37a5cf50df50893dcbd99 @x0)))
(HasType (Bug043.free_in_context @x0
@x1)
(Tm_refine_a68e3d5cc6497fd1d039a7a1d38ff38b @x1)))
 

:pattern ((Bug043.free_in_context @x0
@x1))
:qid typing_Bug043.free_in_context))

:named typing_Bug043.free_in_context))
...
;   (forall (pure_result: Prims.unit). Some? (g 42) ==> p pure_result) ==>
;   (~(S? e) ==> Prims.l_False) /\
;   (forall (b: Bug043.nat).
;       e == Bug043.S b ==>
;       b << e /\
;       (forall (any_result: Bug043.env).
;           g == any_result ==> (forall (pure_result: Prims.unit). Some? (g 42) ==> p pure_result)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec free_in_context`
; While typechecking the top-level declaration `[@@expect_failure] let rec free_in_context`
...
;; def=Prims.fst(441,36-441,97); use=Bug043.fst(31,2-32,32)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=Bug043.fst(28,25-28,37); use=Bug043.fst(31,2-32,32)
(or label_2

;; def=Bug043.fst(28,25-28,37); use=Bug043.fst(31,2-32,32)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some Bug043.nat
(ApplyTT x_8ff43a3c386d95104a4d4c7ea237a119_1
(BoxInt 42))))
)
)

;; def=Prims.fst(441,83-441,96); use=Bug043.fst(31,2-32,32)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug043.fst(31,2-32,32)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Bug043.fst(31,2-32,32)
(and (implies 
;; def=Bug043.fst(30,24-30,25); use=Bug043.fst(31,8-31,9)
(not 
;; def=Bug043.fst(30,24-30,25); use=Bug043.fst(31,8-31,9)
(BoxBool_proj_0 (Bug043.uu___is_S x_aff9916f72349fcab9447b4a76190831_0))
)

label_3)

;; def=Prims.fst(413,99-413,120); use=Bug043.fst(31,2-32,32)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Bug043.nat)

;; def=Bug043.fst(30,24-32,8); use=Bug043.fst(31,8-32,8)
(= x_aff9916f72349fcab9447b4a76190831_0
(Bug043.S @x1))
)
...
;; def=Prims.fst(459,77-459,89); use=Bug043.fst(31,2-32,32)
(and 
;; def=Bug043.fst(31,2-32,32); use=Bug043.fst(32,31-32,32)
(or label_4
...
;; def=Prims.fst(451,66-451,102); use=Bug043.fst(31,2-32,32)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Bug043.env)

;; def=Bug043.fst(26,31-30,27); use=Bug043.fst(31,2-32,32)
(= x_8ff43a3c386d95104a4d4c7ea237a119_1
@x2)
)

;; def=Prims.fst(441,36-441,97); use=Bug043.fst(32,12-32,27)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=Bug043.fst(28,25-28,37); use=Bug043.fst(32,12-32,27)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some Bug043.nat
(ApplyTT x_8ff43a3c386d95104a4d4c7ea237a119_1
(BoxInt 42))))
)

;; def=Prims.fst(441,83-441,96); use=Bug043.fst(32,12-32,27)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug043.fst(32,12-32,27)
(ApplyTT @x0
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug043.free_in_context, 1)
