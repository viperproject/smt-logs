...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1536.ex; Namespace Bug1536
(assert (! 
;; def=Bug1536.fst(18,4-18,6); use=Bug1536.fst(18,4-18,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Bug1536.ex @x0)
Tm_type))
 

:pattern ((Bug1536.ex @x0))
:qid typing_Bug1536.ex))

:named typing_Bug1536.ex))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;; Fact-ids: Name Bug1536.ex; Namespace Bug1536
(assert (! 
;; def=Bug1536.fst(18,18-18,42); use=Bug1536.fst(18,18-18,42)
(forall ((@x0 Term))
...
:pattern ((Bug1536.ex @x0))
:qid equation_Bug1536.ex))

:named equation_Bug1536.ex))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
@x1
(Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8 @x2)))
:qid Bug1536_pre_typing_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8))

:named Bug1536_pre_typing_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug1536_interpretation_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8 @x1)))
:qid Bug1536_interpretation_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8))

:named Bug1536_interpretation_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8))
(push) ;; push{2

; Starting query at Bug1536.fst(24,30-28,19)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;g: a -> ex b
(declare-fun Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7
;;; Fact-ids: 
(assert (! 
;; def=Bug1536.fst(23,58-24,13); use=Bug1536.fst(24,4-24,13)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7))

:named kinding_Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug1536.fst(23,58-24,13); use=Bug1536.fst(24,4-24,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7 @x2
@x3)))
:qid Bug1536_pre_typing_Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7))

:named Bug1536_pre_typing_Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7
;;; Fact-ids: 
(assert (! 
;; def=Bug1536.fst(23,58-24,13); use=Bug1536.fst(24,4-24,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7 @x1
@x2))
(and 
;; def=Bug1536.fst(23,58-24,13); use=Bug1536.fst(24,4-24,13)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid Bug1536_interpretation_Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7.1))
...
(Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7 @x1
@x2)))
:qid Bug1536_interpretation_Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7))

:named Bug1536_interpretation_Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7))

; Encoding query formula : forall (a: Type) (b: Type) (f: Bug1536.ex a) (g: (g: a -> Bug1536.ex b)) (_: Prims.unit).
...
;; def=Prims.fst(402,27-402,88); use=Bug1536.fst(24,30-28,19)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug1536.fst(24,30-28,19)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug1536.fst(24,30-28,19)
(ApplyTT @x5
@x6)
...
;; def=Bug1536.fst(25,6-25,7); use=Bug1536.fst(26,8-26,9)
(not 
;; def=Bug1536.fst(25,6-25,7); use=Bug1536.fst(26,8-26,9)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1536.bind_ex, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Bug1536_interpretation_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8, disc_equation_FStar.Pervasives.Inl, disc_equation_FStar.Pervasives.Inr, equation_Bug1536.ex, fuel_guarded_inversion_FStar.Pervasives.either, projection_inverse_BoxBool_proj_0, unit_typing
...
; Starting query at Bug1536.fst(41,59-41,60)
...
;     p (FStar.Pervasives.Inl x) ==>
;     (forall (return_val: a). return_val == x ==> p (FStar.Pervasives.Inl return_val))


; Context: While encoding a query
; While typechecking the top-level declaration `let ret`
...
;; def=dummy(0,0-0,0); use=Bug1536.fst(41,59-41,60)
...
;; def=Bug1536.fst(41,46-41,55); use=Bug1536.fst(41,59-41,60)
(Valid 
;; def=Bug1536.fst(41,46-41,55); use=Bug1536.fst(41,59-41,60)
(ApplyTT @x3
...
;; def=Bug1536.fst(21,29-21,34); use=Bug1536.fst(41,59-41,60)
(or label_1

;; def=Bug1536.fst(21,29-21,34); use=Bug1536.fst(21,29-21,34)
(Valid 
;; def=Bug1536.fst(21,29-21,34); use=Bug1536.fst(21,29-21,34)
(ApplyTT @x3
(FStar.Pervasives.Inl @x0
