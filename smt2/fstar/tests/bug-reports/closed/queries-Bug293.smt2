...
; Internals for Bug293


; encoding sigelt val Bug293.test


; <Skipped val Bug293.test/>
...
; Starting query at Bug293.fst(19,29-19,42)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug293.fst(18,20-18,30); use=Bug293.fst(19,4-19,8)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c))

:named refinement_kinding_Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug293.fst(18,20-18,30); use=Bug293.fst(19,4-19,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c @x2))
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=Bug293.fst(18,26-18,29); use=Bug293.fst(19,4-19,8)
(= @x2
@x1)
))
...
@x1
(Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c @x2)))
:qid refinement_interpretation_Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c))

:named refinement_interpretation_Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c
;;; Fact-ids: 
(assert (! 
;; def=Bug293.fst(18,20-18,30); use=Bug293.fst(19,4-19,8)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c @x0)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c @x0))))
:qid haseqTm_refine_bd81f7f6888a757bc18ca62c4d181a1c))

:named haseqTm_refine_bd81f7f6888a757bc18ca62c4d181a1c))
...
;;; Fact-ids: 
(assert (! 
;; def=Bug293.fst(18,14-18,17); use=Bug293.fst(18,11-19,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid Bug293_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named Bug293_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug293_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid Bug293_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named Bug293_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
(declare-fun Tm_abs_db661031562264258b81349c34479e96 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_db661031562264258b81349c34479e96
;;; Fact-ids: 
(assert (! (HasType Tm_abs_db661031562264258b81349c34479e96
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
:named typing_Tm_abs_db661031562264258b81349c34479e96))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_db661031562264258b81349c34479e96
;;; Fact-ids: 
(assert (! 
;; def=Bug293.fst(18,20-18,30); use=Bug293.fst(19,4-19,8)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_db661031562264258b81349c34479e96
@x0)
(Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c @x0))
 

:pattern ((ApplyTT Tm_abs_db661031562264258b81349c34479e96
@x0))
:qid interpretation_Tm_abs_db661031562264258b81349c34479e96))

:named interpretation_Tm_abs_db661031562264258b81349c34479e96))
...
; Encoding query formula : forall (_: a: Prims.int & b: Prims.int{a = b}) (_: Prims.unit & Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (b: Prims.int) (b: Prims.int{b = b}). (_, _) == ((| b, b |), ((), ())) ==> b = b
...
(assert (! (not (forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(Prims.dtuple2 Prims.int
Tm_abs_db661031562264258b81349c34479e96))
(HasType @x1
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.unit)))

;; def=Prims.fst(413,99-413,120); use=Bug293.fst(19,29-19,42)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)
...
;; def=Bug293.fst(19,0-19,42); use=Bug293.fst(19,29-19,42)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.dtuple2 Prims.int
Tm_abs_db661031562264258b81349c34479e96)
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.unit)
@x0
...
;; def=Bug293.fst(19,35-19,42); use=Bug293.fst(19,29-19,35)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug293.test, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_bd81f7f6888a757bc18ca62c4d181a1c
