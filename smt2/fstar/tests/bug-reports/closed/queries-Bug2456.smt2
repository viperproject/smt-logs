...
; Starting query at Bug2456.fst(3,0-5,66)


(declare-fun Bug2456.set (Term Term) Term)

;;;;;;;;;;;;;;;;a: Type{Prims.hasEq a} -> _: Prims.nat -> Type
(declare-fun Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e
Tm_type)
:named kinding_Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(3,9-3,45); use=Bug2456.fst(3,9-3,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e)
...
@x1
Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e))
:qid Bug2456_pre_typing_Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e))

:named Bug2456_pre_typing_Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(3,9-3,45); use=Bug2456.fst(3,9-3,45)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Bug2456_interpretation_Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug2456_interpretation_Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e))
:qid Bug2456_interpretation_Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e))

:named Bug2456_interpretation_Tm_arrow_3a43bd86e310e271925a8904d9ffcd5e))
(declare-fun Bug2456.set@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(3,5-3,8); use=Bug2456.fst(3,5-3,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug2456.set@tok
@x0)
@x1)
(Bug2456.set @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Bug2456.set@tok
@x0)
@x1))
:qid token_correspondence_Bug2456.set))

:named token_correspondence_Bug2456.set))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(3,5-3,8); use=Bug2456.fst(3,5-3,8)
...
:pattern ((Bug2456.set @x1
@x2))
:qid function_token_typing_Bug2456.set.1))
)
 

:pattern ((ApplyTT @x0
Bug2456.set@tok))
:qid function_token_typing_Bug2456.set))

:named function_token_typing_Bug2456.set))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(3,5-3,8); use=Bug2456.fst(3,5-3,8)
...
(HasType @x1
Prims.nat))
(HasType (Bug2456.set @x0
@x1)
Tm_type))
 

:pattern ((Bug2456.set @x0
@x1))
:qid typing_Bug2456.set))

:named typing_Bug2456.set))
(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type{Prims.hasEq a}) (n: Prims.nat) (hd: a) (tl: Bug2456.set a n).
...
; While typechecking the top-level declaration `type Bug2456.set`
...
;; def=Prims.fst(680,18-680,24); use=Bug2456.fst(5,59-5,66)
(or label_1
...
; encoding sigelt type Bug2456.set


; <Start encoding type Bug2456.set>
...
(declare-fun Bug2456.set@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2456.Empty (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2456.Empty_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2456.Empty
(declare-fun Bug2456.Empty@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2456.Next (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2456.Next_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2456.Next_n (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2456.Next_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2456.Next_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2456.Next
(declare-fun Bug2456.Next@tok () Term)



;;;;;;;;;;;;;;;;set a 0
(declare-fun Tm_arrow_b3f144d1770d650732b7e07ff2261bad () Term)


;;;;;;;;;;;;;;;;hd: a -> tl: set a n -> set a (n + 1)
(declare-fun Tm_arrow_5d6b6f44def0df4bad0c7696d18e1e33 () Term)

; <start constructor Bug2456.set>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2456.set ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
133)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
; </end constructor Bug2456.set>


; <start constructor Bug2456.Empty>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2456.Empty ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
141)
(= __@x0
(Bug2456.Empty (Bug2456.Empty_a __@x0)))))

; </end constructor Bug2456.Empty>


; <start constructor Bug2456.Next>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2456.Next ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
149)
(= __@x0
(Bug2456.Next (Bug2456.Next_a __@x0)
(Bug2456.Next_n __@x0)
(Bug2456.Next_hd __@x0)
(Bug2456.Next_tl __@x0)))))

; </end constructor Bug2456.Next>


; </end encoding type Bug2456.set>
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(3,5-3,8); use=Bug2456.fst(3,5-3,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug2456.set@tok
...
:pattern ((Bug2456.set @x0
@x1))
:qid token_correspondence_Bug2456.set@tok))

:named token_correspondence_Bug2456.set@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
...
(Bug2456.set @x5
@x6)))
:qid subterm_ordering_Bug2456.Next))

:named subterm_ordering_Bug2456.Next))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2456.Next_tl (Bug2456.Next @x0
@x1
@x2
@x3))
@x3)
...
:pattern ((Bug2456.Next @x0
@x1
@x2
@x3))
:qid projection_inverse_Bug2456.Next_tl))

:named projection_inverse_Bug2456.Next_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2456.Next_n (Bug2456.Next @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Bug2456.Next_n))

:named projection_inverse_Bug2456.Next_n))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2456.Next_hd (Bug2456.Next @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Bug2456.Next_hd))

:named projection_inverse_Bug2456.Next_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug2456.Next_a (Bug2456.Next @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_Bug2456.Next_a))

:named projection_inverse_Bug2456.Next_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(4,6-4,11); use=Bug2456.fst(4,6-4,11)
(forall ((@x0 Term))
 (! (= (Bug2456.Empty_a (Bug2456.Empty @x0))
@x0)
 

:pattern ((Bug2456.Empty @x0))
:qid projection_inverse_Bug2456.Empty_a))

:named projection_inverse_Bug2456.Empty_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! (is-Tm_arrow (PreType Bug2456.set@tok))
:named pre_kinding_Bug2456.set@tok))
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! (and (IsTotFun Bug2456.set@tok)

;; def=Bug2456.fst(3,5-3,8); use=Bug2456.fst(3,5-3,8)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Bug2456.set@tok
@x0))
 

:pattern ((ApplyTT Bug2456.set@tok
@x0))
:qid kinding_Bug2456.set@tok))
...
:pattern ((Bug2456.set @x0
@x1))
:qid kinding_Bug2456.set@tok.1))
)
:named kinding_Bug2456.set@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(3,5-3,8); use=Bug2456.fst(3,5-3,8)
...
(Bug2456.set @x2
@x3))
(or (and (is-Bug2456.Empty @x1)
(= @x2
(Bug2456.Empty_a @x1))
(= @x3
(BoxInt 0)))
(and (is-Bug2456.Next @x1)
(= @x2
(Bug2456.Next_a @x1))
(= @x3
(Prims.op_Addition (Bug2456.Next_n @x1)
(BoxInt 1))))))
...
(Bug2456.set @x2
@x3)))
:qid fuel_guarded_inversion_Bug2456.set))

:named fuel_guarded_inversion_Bug2456.set))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! (= 134
(Term_constr_id Bug2456.set@tok))
:named fresh_token_Bug2456.set@tok))
...
(Bug2456.set @x1
@x5)))
:qid data_typing_intro_Bug2456.Next@tok))

:named data_typing_intro_Bug2456.Next@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(4,6-4,11); use=Bug2456.fst(4,6-4,11)
...
(Bug2456.set @x1
@x2)))
:qid data_typing_intro_Bug2456.Empty@tok))

:named data_typing_intro_Bug2456.Empty@tok))
...
(Bug2456.set @x5
@x6)))
:qid data_elim_Bug2456.Next))

:named data_elim_Bug2456.Next))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(4,6-4,11); use=Bug2456.fst(4,6-4,11)
...
(Bug2456.set @x2
@x3)))
:qid data_elim_Bug2456.Empty))

:named data_elim_Bug2456.Empty))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(3,5-3,8); use=Bug2456.fst(3,5-3,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 133
(Term_constr_id (Bug2456.set @x0
@x1)))
 

:pattern ((Bug2456.set @x0
@x1))
:qid constructor_distinct_Bug2456.set))

:named constructor_distinct_Bug2456.set))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 149
(Term_constr_id (Bug2456.Next @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_Bug2456.Next))

:named constructor_distinct_Bug2456.Next))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(4,6-4,11); use=Bug2456.fst(4,6-4,11)
(forall ((@x0 Term))
 (! (= 141
(Term_constr_id (Bug2456.Empty @x0)))
 

:pattern ((Bug2456.Empty @x0))
:qid constructor_distinct_Bug2456.Empty))

:named constructor_distinct_Bug2456.Empty))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(3,5-3,8); use=Bug2456.fst(3,5-3,8)
...
(Bug2456.set @x2
@x3)))
:qid Bug2456_pretyping_ab76bf02985408320e3d272c86df55c9))

:named Bug2456_pretyping_ab76bf02985408320e3d272c86df55c9))
(push) ;; push{4
...
; Encoding query formula : forall (a: Type{Prims.hasEq a}) (_: Prims.nat).
;   Prims.hasEq a /\
;   (forall (a: Type{Prims.hasEq a}) (_: Prims.nat). {:pattern Prims.hasEq (Bug2456.set a _)}
;       Prims.hasEq a ==> Prims.hasEq (Bug2456.set a _)) ==>
;   (forall (n: Prims.nat) (hd: a) (tl: Bug2456.set a n).
;       Prims.hasEq Prims.nat /\ Prims.hasEq a /\ Prims.hasEq (Bug2456.set a n))
...
;; def=Bug2456.fst(3,0-5,66); use=Bug2456.fst(3,0-5,66)
(Valid 
;; def=Bug2456.fst(3,0-5,66); use=Bug2456.fst(3,0-5,66)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=Bug2456.fst(3,0-5,66); use=Bug2456.fst(3,0-5,66)
(Prims.hasEq (Bug2456.set @x2
@x3))
)
)
 

:pattern ((Prims.hasEq (Bug2456.set @x2
@x3)))
:qid @query.1))
)
...
;; def=Bug2456.fst(3,0-5,66); use=Bug2456.fst(3,0-5,66)
(and 
;; def=Bug2456.fst(3,0-5,66); use=Bug2456.fst(5,16-5,19)
(or label_1
...
;; def=Bug2456.fst(3,0-5,66); use=Bug2456.fst(5,29-5,30)
(or label_2
...
;; def=Bug2456.fst(3,0-5,66); use=Bug2456.fst(5,41-5,48)
(or label_3

;; def=Bug2456.fst(3,0-5,66); use=Bug2456.fst(3,0-5,66)
(Valid 
;; def=Bug2456.fst(3,0-5,66); use=Bug2456.fst(3,0-5,66)
(Prims.hasEq (Bug2456.set @x0
@x2))
)
)
)
...
; encoding sigelt assume Bug2456.set__uu___haseq


; <Start encoding assume Bug2456.set__uu___haseq>



; </end encoding assume Bug2456.set__uu___haseq>


; encoding sigelt val Bug2456.uu___is_Empty


; <Start encoding val Bug2456.uu___is_Empty>


(declare-fun Bug2456.uu___is_Empty (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: set a _ -> Prims.bool
(declare-fun Tm_arrow_0ce3b9bac1b67e9fc517440d4b1bd15c () Term)
(declare-fun Bug2456.uu___is_Empty@tok () Term)

; </end encoding val Bug2456.uu___is_Empty>


; encoding sigelt let uu___is_Empty


; <Skipped let uu___is_Empty/>


; encoding sigelt val Bug2456.uu___is_Next


; <Start encoding val Bug2456.uu___is_Next>


(declare-fun Bug2456.uu___is_Next (Term Term Term) Term)


(declare-fun Bug2456.uu___is_Next@tok () Term)

; </end encoding val Bug2456.uu___is_Next>


; encoding sigelt let uu___is_Next


; <Skipped let uu___is_Next/>


; encoding sigelt val Bug2456.__proj__Next__item__n


; <Start encoding val Bug2456.__proj__Next__item__n>


(declare-fun Tm_refine_822dd331fa64309a1c846e3918fab2f2 (Term Term) Term)
(declare-fun Bug2456.__proj__Next__item__n (Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: set a _ {Next? _} -> Prims.nat
(declare-fun Tm_arrow_d5be3c3ea5173cb64304942933c23390 () Term)
(declare-fun Bug2456.__proj__Next__item__n@tok () Term)

; </end encoding val Bug2456.__proj__Next__item__n>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2456.uu___is_Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
...
(Bug2456.set @x0
@x1)))
(HasType (Bug2456.uu___is_Next @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Bug2456.uu___is_Next @x0
@x1
@x2))
:qid typing_Bug2456.uu___is_Next))

:named typing_Bug2456.uu___is_Next))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug2456.set; Namespace Bug2456; Name Bug2456.Empty; Namespace Bug2456; Name Bug2456.Next; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(3,5-3,8); use=Bug2456.fst(3,5-3,8)
...
:named refinement_kinding_Tm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug2456.__proj__Next__item__n; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_822dd331fa64309a1c846e3918fab2f2 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_822dd331fa64309a1c846e3918fab2f2 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_822dd331fa64309a1c846e3918fab2f2))

:named refinement_kinding_Tm_refine_822dd331fa64309a1c846e3918fab2f2))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! (HasType Tm_refine_774ba3f728d91ead8ef40be66c9802e5
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_822dd331fa64309a1c846e3918fab2f2 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Bug2456.set @x2
...
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
(BoxBool_proj_0 (Bug2456.uu___is_Next @x2
@x3
@x1))
))
...
(Tm_refine_822dd331fa64309a1c846e3918fab2f2 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_822dd331fa64309a1c846e3918fab2f2))

:named refinement_interpretation_Tm_refine_822dd331fa64309a1c846e3918fab2f2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
;; def=Prims.fst(683,11-683,24); use=Prims.fst(683,11-683,24)
...
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;haseq for Tm_refine_822dd331fa64309a1c846e3918fab2f2
;;; Fact-ids: Name Bug2456.__proj__Next__item__n; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_822dd331fa64309a1c846e3918fab2f2 @x0
@x1)))
(Valid (Prims.hasEq (Bug2456.set @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_822dd331fa64309a1c846e3918fab2f2 @x0
@x1))))
:qid haseqTm_refine_822dd331fa64309a1c846e3918fab2f2))

:named haseqTm_refine_822dd331fa64309a1c846e3918fab2f2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_774ba3f728d91ead8ef40be66c9802e5
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_774ba3f728d91ead8ef40be66c9802e5))
(Valid (Prims.hasEq Prims.int)))
...
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,6-5,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug2456.uu___is_Next @x0
@x1
@x2)
(BoxBool (is-Bug2456.Next @x2)))
 

:pattern ((Bug2456.uu___is_Next @x0
@x1
@x2))
:qid disc_equation_Bug2456.Next))

:named disc_equation_Bug2456.Next))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: Bug2456.set__uu___haseq
;;; Fact-ids: Name Bug2456.set__uu___haseq; Namespace Bug2456
...
:pattern ((Prims.hasEq (Bug2456.set @x0
@x1)))
:qid assumption_Bug2456.set__uu___haseq))
:named assumption_Bug2456.set__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Starting query at Bug2456.fst(5,14-5,15)

(declare-fun label_1 () Bool)



; Encoding query formula : forall (a: Type{Prims.hasEq a}) (_: Prims.nat) (projectee: _: Bug2456.set a _ {Next? _}).
;   (*  - Could not prove post-condition
; *) ~(Next? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Next__item__n`
...
Prims.nat)
(HasType @x2
(Tm_refine_822dd331fa64309a1c846e3918fab2f2 @x0
@x1))

;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,14-5,15)
(not 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,14-5,15)
(BoxBool_proj_0 (Bug2456.uu___is_Next @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2456.__proj__Next__item__n, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_822dd331fa64309a1c846e3918fab2f2
...
; encoding sigelt let __proj__Next__item__n


; <Skipped let __proj__Next__item__n/>


; encoding sigelt val Bug2456.__proj__Next__item__hd


; <Start encoding val Bug2456.__proj__Next__item__hd>



(declare-fun Bug2456.__proj__Next__item__hd (Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: set a _ {Next? _} -> a
(declare-fun Tm_arrow_146e493d513c66043e532f80f52f40fa () Term)
(declare-fun Bug2456.__proj__Next__item__hd@tok () Term)

; </end encoding val Bug2456.__proj__Next__item__hd>

(push) ;; push{2

; Starting query at Bug2456.fst(5,24-5,26)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Next__item__hd`
...
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,24-5,26)
(not 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,24-5,26)
(BoxBool_proj_0 (Bug2456.uu___is_Next @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2456.__proj__Next__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_822dd331fa64309a1c846e3918fab2f2
...
; encoding sigelt let __proj__Next__item__hd


; <Skipped let __proj__Next__item__hd/>


; encoding sigelt val Bug2456.__proj__Next__item__tl


; <Start encoding val Bug2456.__proj__Next__item__tl>



(declare-fun Bug2456.__proj__Next__item__tl (Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: set a _ {Next? _} -> set a projectee.n
(declare-fun Tm_arrow_593018748d959762e06b1c4427005fad () Term)
(declare-fun Bug2456.__proj__Next__item__tl@tok () Term)

; </end encoding val Bug2456.__proj__Next__item__tl>

(push) ;; push{2

; Starting query at Bug2456.fst(5,36-5,38)
...
; *)
;   (~(Next? projectee) ==> Prims.l_False) /\
;   (forall (b: Prims.nat) (b: a) (b: Bug2456.set a b).
;       projectee == Bug2456.Next b b ==> b + 1 == _ /\ Next? (Bug2456.Next b b))


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Next__item__tl`
...
;; def=Prims.fst(459,77-459,89); use=Bug2456.fst(5,36-5,38)
(and (implies 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,36-5,38)
(not 
;; def=Bug2456.fst(5,6-5,10); use=Bug2456.fst(5,36-5,38)
(BoxBool_proj_0 (Bug2456.uu___is_Next @x0
@x1
...
;; def=Prims.fst(413,99-413,120); use=Bug2456.fst(5,36-5,38)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.nat)
...
;; def=dummy(0,0-0,0); use=Bug2456.fst(5,36-5,38)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2456.__proj__Next__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Bug2456.Next, refinement_interpretation_Tm_refine_822dd331fa64309a1c846e3918fab2f2
...
; encoding sigelt let __proj__Next__item__tl


; <Skipped let __proj__Next__item__tl/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2456.uu___is_Empty; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(4,6-4,11); use=Bug2456.fst(4,6-4,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(Bug2456.set @x0
@x1)))
(HasType (Bug2456.uu___is_Empty @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Bug2456.uu___is_Empty @x0
@x1
@x2))
:qid typing_Bug2456.uu___is_Empty))

:named typing_Bug2456.uu___is_Empty))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;; def=Bug2456.fst(4,6-4,11); use=Bug2456.fst(4,6-4,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug2456.uu___is_Empty @x0
@x1
@x2)
(BoxBool (is-Bug2456.Empty @x2)))
 

:pattern ((Bug2456.uu___is_Empty @x0
@x1
@x2))
:qid disc_equation_Bug2456.Empty))

:named disc_equation_Bug2456.Empty))
...
; Starting query at Bug2456.fst(8,4-10,45)
...
;;;;;;;;;;;;;;;;a : a: Type0{Prims.hasEq a} (a: Type{Prims.hasEq a})
(declare-fun x_c81500d55cdd4ca568958285fa42f9d4_1 () Term)

;;;;;;;;;;;;;;;;binder_x_c81500d55cdd4ca568958285fa42f9d4_1
;;; Fact-ids: 
(assert (! (HasType x_c81500d55cdd4ca568958285fa42f9d4_1
Tm_refine_414d0a9f578ab0048252f8c8f552b99f)
:named binder_x_c81500d55cdd4ca568958285fa42f9d4_1))
;;;;;;;;;;;;;;;;v : a (a)
(declare-fun x_89727191b59a6b737d6df9e27243e957_2 () Term)
;;;;;;;;;;;;;;;;binder_x_89727191b59a6b737d6df9e27243e957_2
;;; Fact-ids: 
(assert (! (HasType x_89727191b59a6b737d6df9e27243e957_2
x_c81500d55cdd4ca568958285fa42f9d4_1)
:named binder_x_89727191b59a6b737d6df9e27243e957_2))
;;;;;;;;;;;;;;;;s : Bug2456.set a n (Bug2456.set a n)
(declare-fun x_3f43fffebf2999fe261ac452cfacf31e_3 () Term)
;;;;;;;;;;;;;;;;binder_x_3f43fffebf2999fe261ac452cfacf31e_3
;;; Fact-ids: 
(assert (! (HasType x_3f43fffebf2999fe261ac452cfacf31e_3
(Bug2456.set x_c81500d55cdd4ca568958285fa42f9d4_1
x_bb4e1c9af0265270f8e7a5f250f730e2_0))
:named binder_x_3f43fffebf2999fe261ac452cfacf31e_3))

(declare-fun Tm_refine_154ca9c279031cae067ce315c776041e (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(7,19-10,45); use=Bug2456.fst(7,19-10,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_154ca9c279031cae067ce315c776041e @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_154ca9c279031cae067ce315c776041e @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_154ca9c279031cae067ce315c776041e))

:named refinement_kinding_Tm_refine_154ca9c279031cae067ce315c776041e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(7,19-10,45); use=Bug2456.fst(7,19-10,45)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_154ca9c279031cae067ce315c776041e @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Bug2456.fst(7,19-10,45); use=Bug2456.fst(7,19-10,45)
(or 
;; def=Bug2456.fst(8,4-10,45); use=Bug2456.fst(8,4-10,45)
(Valid 
;; def=Bug2456.fst(8,4-10,45); use=Bug2456.fst(8,4-10,45)
...
;; def=Bug2456.fst(7,19-10,45); use=Bug2456.fst(7,19-10,45)
(and 
;; def=Bug2456.fst(7,19-7,20); use=Bug2456.fst(7,19-7,20)
(Valid 
;; def=Bug2456.fst(7,19-7,20); use=Bug2456.fst(7,19-7,20)
...
;; def=Bug2456.fst(7,53-10,45); use=Bug2456.fst(7,53-10,45)
(or 
;; def=Bug2456.fst(8,4-10,45); use=Bug2456.fst(8,4-10,45)
(Valid 
;; def=Bug2456.fst(8,4-10,45); use=Bug2456.fst(8,4-10,45)
...
x_c81500d55cdd4ca568958285fa42f9d4_1
@x4
x_89727191b59a6b737d6df9e27243e957_2)
)


;; def=Bug2456.fst(7,53-10,45); use=Bug2456.fst(7,53-10,45)
(and 
;; def=Bug2456.fst(7,53-7,54); use=Bug2456.fst(7,53-7,54)
(Valid 
;; def=Bug2456.fst(7,53-7,54); use=Bug2456.fst(7,53-7,54)
...
(Valid 
;; def=Bug2456.fst(8,4-10,45); use=Bug2456.fst(8,4-10,45)
(Prims.precedes (Bug2456.set @x3
@x2)
(Bug2456.set x_c81500d55cdd4ca568958285fa42f9d4_1
x_bb4e1c9af0265270f8e7a5f250f730e2_0)
@x1
x_3f43fffebf2999fe261ac452cfacf31e_3)
)
)
)
)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_154ca9c279031cae067ce315c776041e))

:named refinement_interpretation_Tm_refine_154ca9c279031cae067ce315c776041e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_154ca9c279031cae067ce315c776041e
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(7,19-10,45); use=Bug2456.fst(7,19-10,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_154ca9c279031cae067ce315c776041e @x0
@x1
@x2)))
(Valid (Prims.hasEq (Bug2456.set @x1
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_154ca9c279031cae067ce315c776041e @x0
@x1
@x2))))
:qid haseqTm_refine_154ca9c279031cae067ce315c776041e))

:named haseqTm_refine_154ca9c279031cae067ce315c776041e))
(declare-fun Bug2456.contains (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;v: a -> s: set a n {n << n \/ n === n /\ (v << v \/ v === v /\ s << s)} -> Prims.bool
(declare-fun Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45
Tm_type)
:named kinding_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(7,19-10,45); use=Bug2456.fst(7,19-10,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45))
:qid Bug2456_pre_typing_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45))

:named Bug2456_pre_typing_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(7,19-10,45); use=Bug2456.fst(7,19-10,45)
(forall ((@x0 Term))
...
@x2)
(HasType @x4
(Tm_refine_154ca9c279031cae067ce315c776041e @x1
@x2
@x3)))
...
@x3)
@x4))
:qid Bug2456_interpretation_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug2456_interpretation_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45.2))
...
@x1)
@x2))
:qid Bug2456_interpretation_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45.3))
...
@x2)
@x3))
:qid Bug2456_interpretation_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45))
:qid Bug2456_interpretation_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45))

:named Bug2456_interpretation_Tm_arrow_18e92fbb6f72a56eb2fcad9380974a45))
(declare-fun Bug2456.contains@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(7,8-7,16); use=Bug2456.fst(7,8-7,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug2456.contains@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug2456.contains@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Bug2456.contains))

:named token_correspondence_Bug2456.contains))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(7,8-7,16); use=Bug2456.fst(7,8-7,16)
...
:pattern ((Bug2456.contains @x1
@x2
@x3
@x4))
:qid function_token_typing_Bug2456.contains.1))
)
 

:pattern ((ApplyTT @x0
Bug2456.contains@tok))
:qid function_token_typing_Bug2456.contains))

:named function_token_typing_Bug2456.contains))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug2456.fst(7,8-7,16); use=Bug2456.fst(7,8-7,16)
...
@x1)
(HasType @x3
(Tm_refine_154ca9c279031cae067ce315c776041e @x0
@x1
@x2)))
(HasType (Bug2456.contains @x0
@x1
@x2
@x3)
Prims.bool))
...
:pattern ((Bug2456.contains @x0
@x1
@x2
@x3))
:qid typing_Bug2456.contains))

:named typing_Bug2456.contains))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(Empty? s) /\ ~(Next? s) ==> Prims.l_False) /\
;   (~(Empty? s) ==>
;     (forall (b: Prims.nat) (b: a) (b: Bug2456.set a b).
;         s == Bug2456.Next b b ==> ~(b = v) ==> b << n \/ b === n /\ (v << v \/ b << s)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec contains`
...
;; def=Prims.fst(402,27-402,88); use=Bug2456.fst(8,4-10,45)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug2456.fst(8,4-10,45)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug2456.fst(8,4-10,45)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Bug2456.fst(8,4-10,45)
(and (implies 
;; def=Bug2456.fst(7,61-7,62); use=Bug2456.fst(8,10-8,11)
(and 
;; def=Bug2456.fst(7,61-7,62); use=Bug2456.fst(8,10-8,11)
(not 
;; def=Bug2456.fst(7,61-7,62); use=Bug2456.fst(8,10-8,11)
(BoxBool_proj_0 (Bug2456.uu___is_Empty x_c81500d55cdd4ca568958285fa42f9d4_1
x_bb4e1c9af0265270f8e7a5f250f730e2_0
x_3f43fffebf2999fe261ac452cfacf31e_3))
)
...
(not 
;; def=Bug2456.fst(7,61-7,62); use=Bug2456.fst(8,10-8,11)
(BoxBool_proj_0 (Bug2456.uu___is_Next x_c81500d55cdd4ca568958285fa42f9d4_1
x_bb4e1c9af0265270f8e7a5f250f730e2_0
x_3f43fffebf2999fe261ac452cfacf31e_3))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Bug2456.fst(8,4-10,45)
(not 
;; def=Bug2456.fst(7,61-7,62); use=Bug2456.fst(8,10-8,11)
(BoxBool_proj_0 (Bug2456.uu___is_Empty x_c81500d55cdd4ca568958285fa42f9d4_1
x_bb4e1c9af0265270f8e7a5f250f730e2_0
...
;; def=Prims.fst(413,99-413,120); use=Bug2456.fst(8,4-10,45)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.nat)
...
;; def=Bug2456.fst(7,61-10,16); use=Bug2456.fst(8,10-10,16)
(= x_3f43fffebf2999fe261ac452cfacf31e_3
(Bug2456.Next x_c81500d55cdd4ca568958285fa42f9d4_1
@x1
@x2
@x3))


;; def=Bug2456.fst(10,20-10,26); use=Bug2456.fst(10,20-10,26)
(not 
;; def=Bug2456.fst(10,20-10,26); use=Bug2456.fst(10,20-10,26)
(= @x2
x_89727191b59a6b737d6df9e27243e957_2)
...
;; def=Bug2456.fst(7,19-10,45); use=Bug2456.fst(10,42-10,44)
(or label_2

;; def=Bug2456.fst(8,4-10,45); use=Bug2456.fst(10,42-10,44)
(Valid 
;; def=Bug2456.fst(8,4-10,45); use=Bug2456.fst(10,42-10,44)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Bug2456.fst(7,19-10,45); use=Bug2456.fst(10,42-10,44)
(and 
;; def=Bug2456.fst(7,19-7,20); use=Bug2456.fst(10,42-10,44)
(Valid 
;; def=Bug2456.fst(7,19-7,20); use=Bug2456.fst(10,42-10,44)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Bug2456.fst(7,53-10,45); use=Bug2456.fst(10,42-10,44)
(or 
;; def=Bug2456.fst(8,4-10,45); use=Bug2456.fst(10,42-10,44)
(Valid 
;; def=Bug2456.fst(8,4-10,45); use=Bug2456.fst(10,42-10,44)
(Prims.precedes x_c81500d55cdd4ca568958285fa42f9d4_1
x_c81500d55cdd4ca568958285fa42f9d4_1
x_89727191b59a6b737d6df9e27243e957_2
x_89727191b59a6b737d6df9e27243e957_2)
)
...
(Valid 
;; def=Bug2456.fst(8,4-10,45); use=Bug2456.fst(10,42-10,44)
(Prims.precedes (Bug2456.set x_c81500d55cdd4ca568958285fa42f9d4_1
@x1)
(Bug2456.set x_c81500d55cdd4ca568958285fa42f9d4_1
x_bb4e1c9af0265270f8e7a5f250f730e2_0)
@x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2456.contains, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_3f43fffebf2999fe261ac452cfacf31e_3, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0, data_elim_Bug2456.Next, disc_equation_Bug2456.Empty, disc_equation_Bug2456.Next, equation_Prims.nat, fuel_guarded_inversion_Bug2456.set, int_inversion, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_Bug2456.Next_n, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec contains


; <Start encoding let rec contains>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug2456.contains.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug2456.contains.fuel_instrumented_token () Term)
(declare-fun Bug2456.contains (Term Term Term Term) Term)
(declare-fun Bug2456.contains@tok () Term)



;;;;;;;;;;;;;;;;v: a -> s: set a n -> Prims.bool
(declare-fun Tm_arrow_bf5d777c9511228ecbd6914cdd46683e () Term)

; </end encoding let rec contains>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2456.contains; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(7,8-7,16); use=Bug2456.fst(7,8-7,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
...
(Bug2456.set @x2
@x1)))
(HasType (Bug2456.contains.fuel_instrumented @u0
@x1
@x2
@x3
@x4)
...
:pattern ((Bug2456.contains.fuel_instrumented @u0
@x1
@x2
@x3
@x4))
:qid token_correspondence_Bug2456.contains.fuel_instrumented))

:named token_correspondence_Bug2456.contains.fuel_instrumented))
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Bug2456.contains
;;; Fact-ids: Name Bug2456.contains; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(7,8-7,16); use=Bug2456.fst(7,8-7,16)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
(Bug2456.set @x2
@x1)))
(= (Bug2456.contains.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4)
(let ((@lb5 @x4))
(ite (is-Bug2456.Empty @lb5)
(BoxBool false)
(ite (is-Bug2456.Next @lb5)
(Prims.op_BarBar (Prims.op_Equality @x2
(Bug2456.Next_hd @lb5)
@x3)
(Bug2456.contains.fuel_instrumented @u0
(Bug2456.Next_n @lb5)
@x2
@x3
(Bug2456.Next_tl @lb5)))
...
:pattern ((Bug2456.contains.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4))
:qid equation_with_fuel_Bug2456.contains.fuel_instrumented))

:named equation_with_fuel_Bug2456.contains.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Bug2456.contains; Namespace Bug2456
(assert (! 
;; def=Bug2456.fst(7,8-7,16); use=Bug2456.fst(7,8-7,16)
...
@x3
@x4)
(Bug2456.contains.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid @fuel_irrelevance_Bug2456.contains.fuel_instrumented))

:named @fuel_irrelevance_Bug2456.contains.fuel_instrumented))
...
@x2
@x3)
(Bug2456.contains.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_correspondence_Bug2456.contains.fuel_instrumented))

:named @fuel_correspondence_Bug2456.contains.fuel_instrumented))
(push) ;; push{2

; Starting query at Bug2456.fst(12,0-12,54)

(declare-fun label_1 () Bool)

; Encoding query formula : Bug2456.contains 3 (Bug2456.Next 3 Bug2456.Empty)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let containsWorks2`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Bug2456.fst(12,27-12,54); use=Bug2456.fst(12,21-12,27)
(or label_1

;; def=Bug2456.fst(12,27-12,54); use=Bug2456.fst(12,21-12,27)
(BoxBool_proj_0 (Bug2456.contains (BoxInt 1)
Prims.int
(BoxInt 3)
(Bug2456.Next Prims.int
(BoxInt 0)
(BoxInt 3)
(Bug2456.Empty Prims.int))))
)
)
:named @query))
(set-option :rlimit 2723280)
