...
; Internals for Bug316


; encoding sigelt let a


; <Start encoding let a>

(declare-fun Bug316.a (Term) Term)
;;;;;;;;;;;;;;;;Type
(declare-fun Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e () Term)
(declare-fun Bug316.a@tok () Term)
(declare-fun Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50 (Term) Term)

; </end encoding let a>


; encoding sigelt let t


; <Start encoding let t>

(declare-fun Bug316.t (Term) Term)

(declare-fun Bug316.t@tok () Term)
...
; encoding sigelt type Bug316.c


; <Start encoding type Bug316.c>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug316.c (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug316.c@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug316.C (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug316.C_max (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug316.C_x (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug316.C
(declare-fun Bug316.C@tok () Term)
;;;;;;;;;;;;;;;;x: a -> c
(declare-fun Tm_arrow_b4a87fc84ff322ad0e59782d6c266e84 () Term)

; <start constructor Bug316.c>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug316.c ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
120)
(exists ((@x0 Term))
 (! (= __@x0
...
127)
(= __@x0
(Bug316.C (Bug316.C_max __@x0)
(Bug316.C_x __@x0)))))

; </end constructor Bug316.C>


; </end encoding type Bug316.c>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug316.a; Namespace Bug316
(assert (! 
;; def=Bug316.fst(17,5-17,6); use=Bug316.fst(17,5-17,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (Bug316.a @x0)
...
:named typing_Bug316.a))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug316.c; Namespace Bug316; Name Bug316.C; Namespace Bug316
(assert (! 
;; def=Bug316.fst(23,5-23,6); use=Bug316.fst(23,5-23,6)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug316.c@tok
@x0)
(Bug316.c @x0))
 

:pattern ((ApplyTT Bug316.c@tok
@x0))

:pattern ((Bug316.c @x0))
:qid token_correspondence_Bug316.c@tok))

:named token_correspondence_Bug316.c@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug316.c; Namespace Bug316; Name Bug316.C; Namespace Bug316
(assert (! 
;; def=Bug316.fst(24,5-24,6); use=Bug316.fst(24,5-24,6)
...
@x2)
(Bug316.c @x3)))
:qid subterm_ordering_Bug316.C))

:named subterm_ordering_Bug316.C))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Bug316.a; Namespace Bug316
(assert (! 
;; def=Bug316.fst(17,20-17,36); use=Bug316.fst(17,20-17,36)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50))

:named refinement_kinding_Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50 @x2))
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=Bug316.fst(17,27-17,34); use=Bug316.fst(17,27-17,34)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x2))
))
...
@x1
(Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50 @x2)))
:qid refinement_interpretation_Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50))

:named refinement_interpretation_Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
...
:pattern ((Bug316.C @x0
@x1))
:qid projection_inverse_Bug316.C_x))

:named projection_inverse_Bug316.C_x))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug316.c; Namespace Bug316; Name Bug316.C; Namespace Bug316
(assert (! 
;; def=Bug316.fst(24,5-24,6); use=Bug316.fst(24,5-24,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug316.C_max (Bug316.C @x0
@x1))
@x0)
...
:pattern ((Bug316.C @x0
@x1))
:qid projection_inverse_Bug316.C_max))

:named projection_inverse_Bug316.C_max))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug316.c; Namespace Bug316; Name Bug316.C; Namespace Bug316
(assert (! (is-Tm_arrow (PreType Bug316.c@tok))
:named pre_kinding_Bug316.c@tok))
;;; Fact-ids: Name Bug316.c; Namespace Bug316; Name Bug316.C; Namespace Bug316
(assert (! (and (IsTotFun Bug316.c@tok)
...
:pattern ((Bug316.c @x0))
:qid kinding_Bug316.c@tok))
)
:named kinding_Bug316.c@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50
;;; Fact-ids: Name Bug316.a; Namespace Bug316
(assert (! 
;; def=Bug316.fst(17,20-17,36); use=Bug316.fst(17,20-17,36)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50 @x0)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50 @x0))))
:qid haseqTm_refine_22e66b3cc5a2a795d66d00b6de2b1e50))

:named haseqTm_refine_22e66b3cc5a2a795d66d00b6de2b1e50))
...
@x1
(Bug316.c @x2)))
:qid fuel_guarded_inversion_Bug316.c))

:named fuel_guarded_inversion_Bug316.c))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug316.c; Namespace Bug316; Name Bug316.C; Namespace Bug316
(assert (! (= 121
(Term_constr_id Bug316.c@tok))
:named fresh_token_Bug316.c@tok))
...
;;;;;;;;;;;;;;;;Equation for Bug316.a
;;; Fact-ids: Name Bug316.a; Namespace Bug316
(assert (! 
;; def=Bug316.fst(17,5-17,6); use=Bug316.fst(17,5-17,6)
(forall ((@x0 Term))
 (! (= (Bug316.a @x0)
(Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50 @x0))
 

:pattern ((Bug316.a @x0))
:qid equation_Bug316.a))

:named equation_Bug316.a))
...
@x2)
(Bug316.c @x1)))
:qid data_typing_intro_Bug316.C@tok))

:named data_typing_intro_Bug316.C@tok))
...
@x2)
(Bug316.c @x3)))
:qid data_elim_Bug316.C))

:named data_elim_Bug316.C))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 120
(Term_constr_id (Bug316.c @x0)))
 

:pattern ((Bug316.c @x0))
:qid constructor_distinct_Bug316.c))

:named constructor_distinct_Bug316.c))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug316.c; Namespace Bug316; Name Bug316.C; Namespace Bug316
(assert (! 
;; def=Bug316.fst(24,5-24,6); use=Bug316.fst(24,5-24,6)
...
@x0
(Bug316.c @x2)))
:qid Bug316_pretyping_5aaa2a3f9fb3f1aad3cf631acc2ca7d3))

:named Bug316_pretyping_5aaa2a3f9fb3f1aad3cf631acc2ca7d3))
(push) ;; push{4

; Starting query at Bug316.fst(23,0-24,27)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (max: Prims.nat).
;   (forall (max: Prims.nat). {:pattern Prims.hasEq Bug316.c} Prims.hasEq Bug316.c) ==>
;   (forall (x: Bug316.a).
...
; *)
;       Prims.hasEq Bug316.a)


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug316.c`
...
;; def=Bug316.fst(23,0-24,27); use=Bug316.fst(23,0-24,27)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.nat)
...
(Valid 
;; def=Bug316.fst(23,0-24,27); use=Bug316.fst(23,0-24,27)
(Prims.hasEq (Bug316.c @x1))
)
)
 

:pattern ((Prims.hasEq (Bug316.c @x1)))
:qid @query.1))
)
...
;; def=Bug316.fst(23,0-24,27); use=Bug316.fst(24,11-24,17)
(or label_1

;; def=Bug316.fst(23,0-24,27); use=Bug316.fst(23,0-24,27)
(Valid 
;; def=Bug316.fst(23,0-24,27); use=Bug316.fst(23,0-24,27)
(Prims.hasEq (Bug316.a @x0))
)
)
)
...
; QUERY ID: (Bug316.c, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Bug316.a, equation_Prims.eqtype, haseqTm_refine_22e66b3cc5a2a795d66d00b6de2b1e50, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
; encoding sigelt assume Bug316.c__uu___haseq


; <Start encoding assume Bug316.c__uu___haseq>


; </end encoding assume Bug316.c__uu___haseq>


; encoding sigelt val Bug316.uu___is_C


; <Start encoding val Bug316.uu___is_C>

(declare-fun Bug316.uu___is_C (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: c -> Prims.bool
(declare-fun Tm_arrow_cd3545231393812eea79888213c2fe08 () Term)
(declare-fun Bug316.uu___is_C@tok () Term)

; </end encoding val Bug316.uu___is_C>
...
; encoding sigelt val Bug316.__proj__C__item__x


; <Start encoding val Bug316.__proj__C__item__x>

(declare-fun Bug316.__proj__C__item__x (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: c -> a
(declare-fun Tm_arrow_c83d4dbfef02af839644b3f5334503e8 () Term)
(declare-fun Bug316.__proj__C__item__x@tok () Term)

; </end encoding val Bug316.__proj__C__item__x>


; encoding sigelt let __proj__C__item__x


; <Skipped let __proj__C__item__x/>
...
; encoding sigelt type Bug316.r


; <Start encoding type Bug316.r>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug316.r (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug316.r@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug316.Mkr (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug316.Mkr_max (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug316.Mkr_x (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug316.Mkr
(declare-fun Bug316.Mkr@tok () Term)
;;;;;;;;;;;;;;;;x: a -> r
(declare-fun Tm_arrow_391712396b162898e2ad0cc970c17636 () Term)

; <start constructor Bug316.r>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug316.r ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
157)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor Bug316.r>


; <start constructor Bug316.Mkr>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug316.Mkr ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
164)
(= __@x0
(Bug316.Mkr (Bug316.Mkr_max __@x0)
(Bug316.Mkr_x __@x0)))))

; </end constructor Bug316.Mkr>


; </end encoding type Bug316.r>
...
:named typing_Bug316.a))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug316.r; Namespace Bug316; Name Bug316.Mkr; Namespace Bug316
(assert (! 
;; def=Bug316.fst(27,5-27,6); use=Bug316.fst(27,5-27,6)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug316.r@tok
@x0)
(Bug316.r @x0))
 

:pattern ((ApplyTT Bug316.r@tok
@x0))

:pattern ((Bug316.r @x0))
:qid token_correspondence_Bug316.r@tok))

:named token_correspondence_Bug316.r@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug316.r; Namespace Bug316; Name Bug316.Mkr; Namespace Bug316
(assert (! 
;; def=Bug316.fst(27,5-27,6); use=Bug316.fst(27,5-27,6)
...
@x2)
(Bug316.r @x3)))
:qid subterm_ordering_Bug316.Mkr))

:named subterm_ordering_Bug316.Mkr))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! (HasType Tm_refine_f1ecc6ab6882a651504f328937700647
Tm_type)
...
;; def=Bug316.fst(27,5-27,6); use=Bug316.fst(27,5-27,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug316.Mkr_x (Bug316.Mkr @x0
@x1))
@x1)
 

:pattern ((Bug316.Mkr @x0
@x1))
:qid projection_inverse_Bug316.Mkr_x))

:named projection_inverse_Bug316.Mkr_x))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug316.r; Namespace Bug316; Name Bug316.Mkr; Namespace Bug316
(assert (! 
;; def=Bug316.fst(27,5-27,6); use=Bug316.fst(27,5-27,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug316.Mkr_max (Bug316.Mkr @x0
@x1))
@x0)
...
:pattern ((Bug316.Mkr @x0
@x1))
:qid projection_inverse_Bug316.Mkr_max))

:named projection_inverse_Bug316.Mkr_max))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug316.r; Namespace Bug316; Name Bug316.Mkr; Namespace Bug316
(assert (! (is-Tm_arrow (PreType Bug316.r@tok))
:named pre_kinding_Bug316.r@tok))
;;; Fact-ids: Name Bug316.r; Namespace Bug316; Name Bug316.Mkr; Namespace Bug316
(assert (! (and (IsTotFun Bug316.r@tok)
...
:pattern ((Bug316.r @x0))
:qid kinding_Bug316.r@tok))
)
:named kinding_Bug316.r@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
@x1
(Bug316.r @x2)))
:qid fuel_guarded_inversion_Bug316.r))

:named fuel_guarded_inversion_Bug316.r))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug316.r; Namespace Bug316; Name Bug316.Mkr; Namespace Bug316
(assert (! (= 158
(Term_constr_id Bug316.r@tok))
:named fresh_token_Bug316.r@tok))
;;;;;;;;;;;;;;;;Equation for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
@x2)
(Bug316.r @x1)))
:qid data_typing_intro_Bug316.Mkr@tok))

:named data_typing_intro_Bug316.Mkr@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug316.r; Namespace Bug316; Name Bug316.Mkr; Namespace Bug316
(assert (! 
;; def=Bug316.fst(27,5-27,6); use=Bug316.fst(27,5-27,6)
...
@x2)
(Bug316.r @x3)))
:qid data_elim_Bug316.Mkr))

:named data_elim_Bug316.Mkr))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
(Term_constr_id Prims.unit))
...
(forall ((@x0 Term))
 (! (= 157
(Term_constr_id (Bug316.r @x0)))
 

:pattern ((Bug316.r @x0))
:qid constructor_distinct_Bug316.r))

:named constructor_distinct_Bug316.r))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug316.r; Namespace Bug316; Name Bug316.Mkr; Namespace Bug316
(assert (! 
;; def=Bug316.fst(27,5-27,6); use=Bug316.fst(27,5-27,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= 164
(Term_constr_id (Bug316.Mkr @x0
@x1)))
 

:pattern ((Bug316.Mkr @x0
@x1))
:qid constructor_distinct_Bug316.Mkr))

:named constructor_distinct_Bug316.Mkr))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
@x0
(Bug316.r @x2)))
:qid Bug316_pretyping_9f4a72fdf6d6313bc1e42b4334e1f0a5))

:named Bug316_pretyping_9f4a72fdf6d6313bc1e42b4334e1f0a5))
(push) ;; push{4

; Starting query at Bug316.fst(27,0-27,33)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (max: Prims.nat).
;   (forall (max: Prims.nat). {:pattern Prims.hasEq Bug316.r} Prims.hasEq Bug316.r) ==>
;   (forall (x: Bug316.a).
;       (*  - Failed to prove that the type
;     'Bug316.r'
;     supports decidable equality because of this argument.
...
; Context: While encoding a query
; While typechecking the top-level declaration `type Bug316.r`
...
;; def=Bug316.fst(27,0-27,33); use=Bug316.fst(27,0-27,33)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.nat)
...
(Valid 
;; def=Bug316.fst(27,0-27,33); use=Bug316.fst(27,0-27,33)
(Prims.hasEq (Bug316.r @x1))
)
)
 

:pattern ((Prims.hasEq (Bug316.r @x1)))
:qid @query.1))
)
...
;; def=Bug316.fst(27,0-27,33); use=Bug316.fst(27,24-27,30)
(or label_1
