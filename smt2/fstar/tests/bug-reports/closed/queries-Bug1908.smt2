...
; Internals for Bug1908


; encoding sigelt type Bug1908.w


; <Start encoding type Bug1908.w>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1908.w () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1908.U32 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1908.U32
(declare-fun Bug1908.U32@tok () Term)

; <start constructor Bug1908.w>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1908.w ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
118)
(= __@x0
Bug1908.w)))

; </end constructor Bug1908.w>


; <start constructor Bug1908.U32>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1908.U32 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
Bug1908.U32)))

; </end constructor Bug1908.U32>


; </end encoding type Bug1908.w>


; encoding sigelt assume Bug1908.w__uu___haseq


; <Start encoding assume Bug1908.w__uu___haseq>


; </end encoding assume Bug1908.w__uu___haseq>


; encoding sigelt val Bug1908.uu___is_U32


; <Start encoding val Bug1908.uu___is_U32>

(declare-fun Bug1908.uu___is_U32 (Term) Term)
;;;;;;;;;;;;;;;;projectee: w -> Prims.bool
(declare-fun Tm_arrow_4721df8dba093d71b8a1b214e0204c91 () Term)
(declare-fun Bug1908.uu___is_U32@tok () Term)

; </end encoding val Bug1908.uu___is_U32>


; encoding sigelt let uu___is_U32
...
(declare-fun Bug1908.t (Term) Term)
;;;;;;;;;;;;;;;;w: w -> Prims.eqtype
(declare-fun Tm_arrow_c3e5dea9083f42923506746209497018 () Term)
(declare-fun Bug1908.t@tok () Term)
...
;;; Fact-ids: Name Bug1908.w; Namespace Bug1908; Name Bug1908.U32; Namespace Bug1908
(assert (! (HasType Bug1908.U32@tok
Bug1908.w)
:named typing_tok_Bug1908.U32@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1908.t; Namespace Bug1908
(assert (! 
;; def=Bug1908.fst(6,4-6,5); use=Bug1908.fst(6,4-6,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1908.w)
(HasType (Bug1908.t @x0)
Prims.eqtype))
 

:pattern ((Bug1908.t @x0))
:qid typing_Bug1908.t))

:named typing_Bug1908.t))
...
;;; Fact-ids: Name Bug1908.w; Namespace Bug1908; Name Bug1908.U32; Namespace Bug1908
(assert (! (HasType Bug1908.w
Tm_type)
:named kinding_Bug1908.w@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;; Fact-ids: Name Bug1908.w; Namespace Bug1908; Name Bug1908.U32; Namespace Bug1908
(assert (! 
;; def=Bug1908.fst(3,5-3,6); use=Bug1908.fst(3,5-3,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Bug1908.w)
...
@x1
Bug1908.w))
:qid fuel_guarded_inversion_Bug1908.w))

:named fuel_guarded_inversion_Bug1908.w))
...
:pattern ((Bug1908.t @x0))
:qid equation_Bug1908.t))

:named equation_Bug1908.t))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug1908.w; Namespace Bug1908; Name Bug1908.U32; Namespace Bug1908
(assert (! (= Bug1908.U32@tok
Bug1908.U32)
:named equality_tok_Bug1908.U32@tok))
...
;;; Fact-ids: Name Bug1908.w; Namespace Bug1908; Name Bug1908.U32; Namespace Bug1908
(assert (! 
;; def=Bug1908.fst(4,4-4,7); use=Bug1908.fst(4,4-4,7)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug1908.U32
Bug1908.w)
...
Bug1908.U32
Bug1908.w))
:qid data_typing_intro_Bug1908.U32@tok))

:named data_typing_intro_Bug1908.U32@tok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Bug1908.w; Namespace Bug1908; Name Bug1908.U32; Namespace Bug1908
(assert (! (= 118
(Term_constr_id Bug1908.w))
:named constructor_distinct_Bug1908.w))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug1908.w; Namespace Bug1908; Name Bug1908.U32; Namespace Bug1908
(assert (! (= 124
(Term_constr_id Bug1908.U32))
:named constructor_distinct_Bug1908.U32))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
:named b2t_def))
;;;;;;;;;;;;;;;;Assumption: Bug1908.w__uu___haseq
;;; Fact-ids: Name Bug1908.w__uu___haseq; Namespace Bug1908
(assert (! (Valid (Prims.hasEq Bug1908.w))
:named assumption_Bug1908.w__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Bug1908.w))
:qid Bug1908_pretyping_de182e038aeaa72cdb3700cb091182a3))

:named Bug1908_pretyping_de182e038aeaa72cdb3700cb091182a3))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Prims.pow2; Namespace Prims
(assert (! 
;; def=Prims.fst(708,8-708,12); use=Prims.fst(708,8-708,12)
...
; Starting query at Bug1908.fst(12,0-15,1)

(declare-fun Bug1908.r () Term)
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! (HasType Bug1908.r
Tm_type)
:named function_token_typing_Bug1908.r))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! (HasType Bug1908.r
Tm_type)
:named typing_Bug1908.r))
(declare-fun label_1 () Bool)

; Encoding query formula : forall (m: Bug1908.t Bug1908.U32).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (x: Prims.int).
;     (*  - Subtyping check failed
;   - Expected type Prims.int got type t U32
; *)
;     Prims.has_type m Prims.int


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug1908.r`
; While typechecking the top-level declaration `[@@expect_failure] type Bug1908.r`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (HasType @x0
(Bug1908.t Bug1908.U32@tok))

;; def=dummy(0,0-0,0); use=Bug1908.fst(12,0-15,1)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)

;; def=Bug1908.fst(13,2-13,3); use=Bug1908.fst(14,17-14,18)
(or label_1
(HasType @x0
Prims.int))
)
