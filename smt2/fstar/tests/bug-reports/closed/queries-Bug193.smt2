...
; encoding sigelt type Bug193.form


; <Start encoding type Bug193.form>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug193.form () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug193.FTrue () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug193.FTrue
(declare-fun Bug193.FTrue@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug193.FImpl (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug193.FImpl__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug193.FImpl__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug193.FImpl
(declare-fun Bug193.FImpl@tok () Term)
;;;;;;;;;;;;;;;;_0: form -> _1: form -> form
(declare-fun Tm_arrow_aa6b687133fb026d5427085609db80ca () Term)

; <start constructor Bug193.form>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug193.form ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
Bug193.form)))

; </end constructor Bug193.form>


; <start constructor Bug193.FTrue>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug193.FTrue ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
Bug193.FTrue)))

; </end constructor Bug193.FTrue>


; <start constructor Bug193.FImpl>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug193.FImpl ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
(Bug193.FImpl (Bug193.FImpl__0 __@x0)
(Bug193.FImpl__1 __@x0)))))

; </end constructor Bug193.FImpl>


; </end encoding type Bug193.form>
...
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! (HasType Bug193.FTrue@tok
Bug193.form)
:named typing_tok_Bug193.FTrue@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! 
;; def=Bug193.fst(20,2-20,7); use=Bug193.fst(20,2-20,7)
...
@x2)
Bug193.form))
:qid subterm_ordering_Bug193.FImpl))

:named subterm_ordering_Bug193.FImpl))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=Bug193.fst(20,2-20,7); use=Bug193.fst(20,2-20,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug193.FImpl__1 (Bug193.FImpl @x0
@x1))
@x1)
 

:pattern ((Bug193.FImpl @x0
@x1))
:qid projection_inverse_Bug193.FImpl__1))

:named projection_inverse_Bug193.FImpl__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! 
;; def=Bug193.fst(20,2-20,7); use=Bug193.fst(20,2-20,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug193.FImpl__0 (Bug193.FImpl @x0
@x1))
@x0)
...
:pattern ((Bug193.FImpl @x0
@x1))
:qid projection_inverse_Bug193.FImpl__0))

:named projection_inverse_Bug193.FImpl__0))
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! (HasType Bug193.form
Tm_type)
:named kinding_Bug193.form@tok))
...
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! 
;; def=Bug193.fst(18,5-18,9); use=Bug193.fst(18,5-18,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Bug193.form)
(or (is-Bug193.FTrue @x1)
(is-Bug193.FImpl @x1)))
...
@x1
Bug193.form))
:qid fuel_guarded_inversion_Bug193.form))

:named fuel_guarded_inversion_Bug193.form))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! (= Bug193.FTrue@tok
Bug193.FTrue)
:named equality_tok_Bug193.FTrue@tok))
...
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! 
;; def=Bug193.fst(19,2-19,7); use=Bug193.fst(19,2-19,7)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug193.FTrue
Bug193.form)
...
Bug193.FTrue
Bug193.form))
:qid data_typing_intro_Bug193.FTrue@tok))

:named data_typing_intro_Bug193.FTrue@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! 
;; def=Bug193.fst(20,2-20,7); use=Bug193.fst(20,2-20,7)
...
@x2)
Bug193.form))
:qid data_typing_intro_Bug193.FImpl@tok))

:named data_typing_intro_Bug193.FImpl@tok))
...
@x2)
Bug193.form))
:qid data_elim_Bug193.FImpl))

:named data_elim_Bug193.FImpl))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! (= 116
(Term_constr_id Bug193.form))
:named constructor_distinct_Bug193.form))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! (= 122
(Term_constr_id Bug193.FTrue))
:named constructor_distinct_Bug193.FTrue))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! 
;; def=Bug193.fst(20,2-20,7); use=Bug193.fst(20,2-20,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= 124
(Term_constr_id (Bug193.FImpl @x0
@x1)))
 

:pattern ((Bug193.FImpl @x0
@x1))
:qid constructor_distinct_Bug193.FImpl))

:named constructor_distinct_Bug193.FImpl))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Bug193.form))
:qid Bug193_pretyping_0c137989ff09cfa30d3e247de6db30b9))

:named Bug193_pretyping_0c137989ff09cfa30d3e247de6db30b9))
(push) ;; push{4

; Starting query at Bug193.fst(18,0-20,32)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq Bug193.form ==>
; (forall (_0: Bug193.form) (_1: Bug193.form). Prims.hasEq Bug193.form /\ Prims.hasEq Bug193.form)


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug193.form`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=Bug193.fst(18,0-20,32); use=Bug193.fst(18,0-20,32)
(Valid 
;; def=Bug193.fst(18,0-20,32); use=Bug193.fst(18,0-20,32)
(Prims.hasEq Bug193.form)
)
...
;; def=Bug193.fst(18,0-20,32); use=Bug193.fst(18,0-20,32)
(and 
;; def=Bug193.fst(18,0-20,32); use=Bug193.fst(20,12-20,16)
(or label_1
...
;; def=Bug193.fst(18,0-20,32); use=Bug193.fst(20,20-20,24)
(or label_2
...
; encoding sigelt assume Bug193.form__uu___haseq


; <Start encoding assume Bug193.form__uu___haseq>


; </end encoding assume Bug193.form__uu___haseq>


; encoding sigelt val Bug193.uu___is_FTrue


; <Start encoding val Bug193.uu___is_FTrue>

(declare-fun Bug193.uu___is_FTrue (Term) Term)
;;;;;;;;;;;;;;;;projectee: form -> Prims.bool
(declare-fun Tm_arrow_af85c975e4d79560f7d11fbfbd64c601 () Term)
(declare-fun Bug193.uu___is_FTrue@tok () Term)

; </end encoding val Bug193.uu___is_FTrue>


; encoding sigelt let uu___is_FTrue


; <Skipped let uu___is_FTrue/>


; encoding sigelt val Bug193.uu___is_FImpl


; <Start encoding val Bug193.uu___is_FImpl>

(declare-fun Bug193.uu___is_FImpl (Term) Term)

(declare-fun Bug193.uu___is_FImpl@tok () Term)

; </end encoding val Bug193.uu___is_FImpl>


; encoding sigelt let uu___is_FImpl


; <Skipped let uu___is_FImpl/>


; encoding sigelt val Bug193.__proj__FImpl__item___0


; <Start encoding val Bug193.__proj__FImpl__item___0>

(declare-fun Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c () Term)
(declare-fun Bug193.__proj__FImpl__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: form{FImpl? _} -> form
(declare-fun Tm_arrow_5f266e49ac1aca5424bc5aeee388dada () Term)
(declare-fun Bug193.__proj__FImpl__item___0@tok () Term)

; </end encoding val Bug193.__proj__FImpl__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug193.uu___is_FImpl; Namespace Bug193
(assert (! 
;; def=Bug193.fst(20,2-20,7); use=Bug193.fst(20,2-20,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug193.form)
(HasType (Bug193.uu___is_FImpl @x0)
Prims.bool))
 

:pattern ((Bug193.uu___is_FImpl @x0))
:qid typing_Bug193.uu___is_FImpl))

:named typing_Bug193.uu___is_FImpl))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug193.form; Namespace Bug193; Name Bug193.FTrue; Namespace Bug193; Name Bug193.FImpl; Namespace Bug193
(assert (! 
;; def=Bug193.fst(20,2-20,7); use=Bug193.fst(20,2-20,7)
...
:named refinement_kinding_Tm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug193.__proj__FImpl__item___0; Namespace Bug193
(assert (! (HasType Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c
Tm_type)
:named refinement_kinding_Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c)
(and (HasTypeFuel @u0
@x1
Bug193.form)

;; def=Bug193.fst(20,2-20,7); use=Bug193.fst(20,2-20,7)
(BoxBool_proj_0 (Bug193.uu___is_FImpl @x1))
))
...
@x1
Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c))
:qid refinement_interpretation_Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c))

:named refinement_interpretation_Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
;; def=Prims.fst(304,12-304,41); use=Prims.fst(304,12-304,41)
...
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c
;;; Fact-ids: Name Bug193.__proj__FImpl__item___0; Namespace Bug193
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c))
(Valid (Prims.hasEq Bug193.form)))
:named haseqTm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
(Valid (Prims.hasEq Tm_type)))
...
;; def=Bug193.fst(20,2-20,7); use=Bug193.fst(20,2-20,7)
(forall ((@x0 Term))
 (! (= (Bug193.uu___is_FImpl @x0)
(BoxBool (is-Bug193.FImpl @x0)))
 

:pattern ((Bug193.uu___is_FImpl @x0))
:qid disc_equation_Bug193.FImpl))

:named disc_equation_Bug193.FImpl))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: Bug193.form__uu___haseq
;;; Fact-ids: Name Bug193.form__uu___haseq; Namespace Bug193
(assert (! (Valid (Prims.hasEq Bug193.form))
:named assumption_Bug193.form__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Encoding query formula : forall (projectee: _: Bug193.form{FImpl? _}).
;   (*  - Could not prove post-condition
; *) ~(FImpl? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__FImpl__item___0`
...
(not 
;; def=Bug193.fst(20,2-20,7); use=Bug193.fst(20,2-20,7)
(BoxBool_proj_0 (Bug193.uu___is_FImpl @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug193.__proj__FImpl__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c
...
; encoding sigelt let __proj__FImpl__item___0


; <Skipped let __proj__FImpl__item___0/>


; encoding sigelt val Bug193.__proj__FImpl__item___1


; <Start encoding val Bug193.__proj__FImpl__item___1>


(declare-fun Bug193.__proj__FImpl__item___1 (Term) Term)


(declare-fun Bug193.__proj__FImpl__item___1@tok () Term)

; </end encoding val Bug193.__proj__FImpl__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__FImpl__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug193.__proj__FImpl__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_ad6e6f7896f300b4b617a2b6cbc38c6c
...
; encoding sigelt let __proj__FImpl__item___1


; <Skipped let __proj__FImpl__item___1/>
...
; encoding sigelt type Bug193.deduce


; <Start encoding type Bug193.deduce>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug193.deduce (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug193.deduce@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug193.DImplIntro (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug193.DImplIntro_f1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug193.DImplIntro_f2 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug193.DImplIntro__2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug193.DImplIntro
(declare-fun Bug193.DImplIntro@tok () Term)
;;;;;;;;;;;;;;;;_: deduce f1 -> deduce f2
(declare-fun Tm_arrow_ab839c301311d9601053a3ebdb86f175 (Term Term) Term)

;;;;;;;;;;;;;;;;_2: (_: deduce f1 -> deduce f2) -> deduce (FImpl f1 f2)
(declare-fun Tm_arrow_f8391d23b8eb36bb52f564ddba801c5b () Term)

; <start constructor Bug193.deduce>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug193.deduce ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
154)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-Bug193.deduce))))

; </end constructor Bug193.deduce>


; <start constructor Bug193.DImplIntro>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug193.DImplIntro ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
163)
(= __@x0
(Bug193.DImplIntro (Bug193.DImplIntro_f1 __@x0)
(Bug193.DImplIntro_f2 __@x0)
(Bug193.DImplIntro__2 __@x0)))))

; </end constructor Bug193.DImplIntro>


; </end encoding type Bug193.deduce>


; encoding sigelt val Bug193.uu___is_DImplIntro


; <Start encoding val Bug193.uu___is_DImplIntro>

(declare-fun Bug193.uu___is_DImplIntro (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: deduce _ -> Prims.bool
(declare-fun Tm_arrow_c0f9338f14e4181c6f693f9b11fbfb57 () Term)
(declare-fun Bug193.uu___is_DImplIntro@tok () Term)

; </end encoding val Bug193.uu___is_DImplIntro>


; encoding sigelt let uu___is_DImplIntro


; <Skipped let uu___is_DImplIntro/>


; encoding sigelt val Bug193.__proj__DImplIntro__item__f1


; <Start encoding val Bug193.__proj__DImplIntro__item__f1>

(declare-fun Bug193.__proj__DImplIntro__item__f1 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: deduce _ -> form
(declare-fun Tm_arrow_38722986c048e919fc29d21cb964c69b () Term)
(declare-fun Bug193.__proj__DImplIntro__item__f1@tok () Term)

; </end encoding val Bug193.__proj__DImplIntro__item__f1>


; encoding sigelt let __proj__DImplIntro__item__f1


; <Skipped let __proj__DImplIntro__item__f1/>


; encoding sigelt val Bug193.__proj__DImplIntro__item__f2


; <Start encoding val Bug193.__proj__DImplIntro__item__f2>

(declare-fun Bug193.__proj__DImplIntro__item__f2 (Term Term) Term)

(declare-fun Bug193.__proj__DImplIntro__item__f2@tok () Term)

; </end encoding val Bug193.__proj__DImplIntro__item__f2>


; encoding sigelt let __proj__DImplIntro__item__f2


; <Skipped let __proj__DImplIntro__item__f2/>


; encoding sigelt val Bug193.__proj__DImplIntro__item___2


; <Start encoding val Bug193.__proj__DImplIntro__item___2>

(declare-fun Bug193.__proj__DImplIntro__item___2 (Term Term) Term)
;;;;;;;;;;;;;;;;_: deduce projectee.f1 -> deduce projectee.f2
(declare-fun Tm_arrow_b1533e7e69cf140665e650f97569900b (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: deduce _ -> _: deduce projectee.f1 -> deduce projectee.f2
(declare-fun Tm_arrow_7ec2bc2abce661b5a31e7a69ad380d3e () Term)
(declare-fun Bug193.__proj__DImplIntro__item___2@tok () Term)


; </end encoding val Bug193.__proj__DImplIntro__item___2>

;;;;;;;;;;;;;;;;well-founded ordering on codomain
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(26,4-26,14); use=Bug193.fst(26,4-26,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! 
;; def=Bug193.fst(26,4-26,14); use=Bug193.fst(26,4-26,14)
(forall ((@x5 Term))
 (! (implies (and (HasTypeFuel @u0
(Bug193.DImplIntro @x1
@x2
@x3)
(Bug193.deduce (Bug193.FImpl @x1
@x2)))
(HasType @x5
(Bug193.deduce @x1)))
(Valid (Prims.precedes Prims.lex_t
...
@x2
@x3))))
:qid well_founded_ordering_on_codomain_Bug193.DImplIntro.1))
...
@x3)
(Bug193.deduce @x4)))
:qid well_founded_ordering_on_codomain_Bug193.DImplIntro))

:named well_founded_ordering_on_codomain_Bug193.DImplIntro))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug193.__proj__DImplIntro__item__f1; Namespace Bug193
(assert (! 
;; def=Bug193.fst(27,14-27,16); use=Bug193.fst(27,14-27,16)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Bug193.form)
(HasType @x1
(Bug193.deduce @x0)))
(HasType (Bug193.__proj__DImplIntro__item__f1 @x0
@x1)
Bug193.form))
 

:pattern ((Bug193.__proj__DImplIntro__item__f1 @x0
@x1))
:qid typing_Bug193.__proj__DImplIntro__item__f1))

:named typing_Bug193.__proj__DImplIntro__item__f1))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(25,5-25,11); use=Bug193.fst(25,5-25,11)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug193.deduce@tok
@x0)
(Bug193.deduce @x0))
 

:pattern ((ApplyTT Bug193.deduce@tok
@x0))

:pattern ((Bug193.deduce @x0))
:qid token_correspondence_Bug193.deduce@tok))

:named token_correspondence_Bug193.deduce@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(26,4-26,14); use=Bug193.fst(26,4-26,14)
...
@x3)
(Bug193.deduce @x4)))
:qid subterm_ordering_Bug193.DImplIntro))

:named subterm_ordering_Bug193.DImplIntro))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(26,4-26,14); use=Bug193.fst(26,4-26,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug193.DImplIntro_f2 (Bug193.DImplIntro @x0
@x1
@x2))
@x1)
 

:pattern ((Bug193.DImplIntro @x0
@x1
@x2))
:qid projection_inverse_Bug193.DImplIntro_f2))

:named projection_inverse_Bug193.DImplIntro_f2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(26,4-26,14); use=Bug193.fst(26,4-26,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug193.DImplIntro_f1 (Bug193.DImplIntro @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_Bug193.DImplIntro_f1))

:named projection_inverse_Bug193.DImplIntro_f1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(26,4-26,14); use=Bug193.fst(26,4-26,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug193.DImplIntro__2 (Bug193.DImplIntro @x0
@x1
@x2))
@x2)
...
@x1
@x2))
:qid projection_inverse_Bug193.DImplIntro__2))

:named projection_inverse_Bug193.DImplIntro__2))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug193.__proj__DImplIntro__item__f1; Namespace Bug193
(assert (! 
;; def=Bug193.fst(27,14-27,16); use=Bug193.fst(27,14-27,16)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug193.__proj__DImplIntro__item__f1 @x0
@x1)
(Bug193.DImplIntro_f1 @x1))
 

:pattern ((Bug193.__proj__DImplIntro__item__f1 @x0
@x1))
:qid proj_equation_Bug193.DImplIntro_f1))

:named proj_equation_Bug193.DImplIntro_f1))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! (is-Tm_arrow (PreType Bug193.deduce@tok))
:named pre_kinding_Bug193.deduce@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ab839c301311d9601053a3ebdb86f175
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(29,14-29,42); use=Bug193.fst(29,14-29,42)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_ab839c301311d9601053a3ebdb86f175 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_ab839c301311d9601053a3ebdb86f175 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_ab839c301311d9601053a3ebdb86f175))

:named kinding_Tm_arrow_ab839c301311d9601053a3ebdb86f175))
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! (and (IsTotFun Bug193.deduce@tok)

;; def=Bug193.fst(25,5-25,11); use=Bug193.fst(25,5-25,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug193.form)
(HasType (Bug193.deduce @x0)
Tm_type))
 

:pattern ((Bug193.deduce @x0))
:qid kinding_Bug193.deduce@tok))
)
:named kinding_Bug193.deduce@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(25,5-25,11); use=Bug193.fst(25,5-25,11)
...
@x1
(Bug193.deduce @x2))
(and (is-Bug193.DImplIntro @x1)
(= @x2
(Bug193.FImpl (Bug193.DImplIntro_f1 @x1)
(Bug193.DImplIntro_f2 @x1)))))
 

:pattern ((HasTypeFuel @u0
@x1
(Bug193.deduce @x2)))
:qid fuel_guarded_inversion_Bug193.deduce))

:named fuel_guarded_inversion_Bug193.deduce))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! (= 155
(Term_constr_id Bug193.deduce@tok))
:named fresh_token_Bug193.deduce@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(26,4-26,14); use=Bug193.fst(26,4-26,14)
...
(HasTypeFuel @u0
@x3
(Tm_arrow_ab839c301311d9601053a3ebdb86f175 @x2
@x1))
(= (Bug193.FImpl @x1
@x2)
@x4))
...
@x3)
(Bug193.deduce @x4)))
:qid data_typing_intro_Bug193.DImplIntro@tok))

:named data_typing_intro_Bug193.DImplIntro@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(26,4-26,14); use=Bug193.fst(26,4-26,14)
...
@x3)
(Bug193.deduce @x4)))
:qid data_elim_Bug193.DImplIntro))

:named data_elim_Bug193.DImplIntro))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(25,5-25,11); use=Bug193.fst(25,5-25,11)
(forall ((@x0 Term))
 (! (= 154
(Term_constr_id (Bug193.deduce @x0)))
 

:pattern ((Bug193.deduce @x0))
:qid constructor_distinct_Bug193.deduce))

:named constructor_distinct_Bug193.deduce))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(26,4-26,14); use=Bug193.fst(26,4-26,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 163
(Term_constr_id (Bug193.DImplIntro @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_Bug193.DImplIntro))

:named constructor_distinct_Bug193.DImplIntro))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(25,5-25,11); use=Bug193.fst(25,5-25,11)
...
@x0
(Bug193.deduce @x2)))
:qid Bug193_pretyping_bd2b6e112c3d47da1bef6b54f67cd323))

:named Bug193_pretyping_bd2b6e112c3d47da1bef6b54f67cd323))
...
(Tm_arrow_ab839c301311d9601053a3ebdb86f175 @x2
@x3)))
:qid Bug193_pre_typing_Tm_arrow_ab839c301311d9601053a3ebdb86f175))

:named Bug193_pre_typing_Tm_arrow_ab839c301311d9601053a3ebdb86f175))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ab839c301311d9601053a3ebdb86f175
;;; Fact-ids: Name Bug193.deduce; Namespace Bug193; Name Bug193.DImplIntro; Namespace Bug193
(assert (! 
;; def=Bug193.fst(29,14-29,42); use=Bug193.fst(29,14-29,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_ab839c301311d9601053a3ebdb86f175 @x1
@x2))
(and 
;; def=Bug193.fst(29,14-29,42); use=Bug193.fst(29,14-29,42)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid Bug193_interpretation_Tm_arrow_ab839c301311d9601053a3ebdb86f175.1))
...
(Tm_arrow_ab839c301311d9601053a3ebdb86f175 @x1
@x2)))
:qid Bug193_interpretation_Tm_arrow_ab839c301311d9601053a3ebdb86f175))

:named Bug193_interpretation_Tm_arrow_ab839c301311d9601053a3ebdb86f175))
(push) ;; push{2
...
; Encoding query formula : forall (_: Bug193.form) (projectee: Bug193.deduce _).
;   (*  - Could not prove post-condition
; *)
;   forall (b: Bug193.form) (b: Bug193.form) (b: (_: Bug193.deduce b -> Bug193.deduce b)).
;     projectee == Bug193.DImplIntro b ==>
;     Bug193.FImpl b b == _ /\
;     (forall (_: Bug193.deduce (Bug193.DImplIntro b).f1).
;         (*  - Subtyping check failed
;   - Expected type deduce _ got type deduce (FImpl f1 f2)
; *)
;         Bug193.FImpl b b == _)


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__DImplIntro__item___2`
...
(Tm_arrow_ab839c301311d9601053a3ebdb86f175 @x3
@x2))

;; def=Bug193.fst(26,4-26,14); use=Bug193.fst(26,4-26,14)
(= @x1
(Bug193.DImplIntro @x2
@x3
@x4))
)
(and 
...
;; def=dummy(0,0-0,0); use=Bug193.fst(29,14-29,42)
(= (Bug193.FImpl @x2
@x3)
@x0)
)
...
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Bug193.deduce (Bug193.__proj__DImplIntro__item__f1 @x0
(Bug193.DImplIntro @x2
@x3
@x4))))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug193.__proj__DImplIntro__item___2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Bug193.DImplIntro
