...
; Internals for Bug1604


; encoding sigelt type Bug1604.t


; <Start encoding type Bug1604.t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1604.t () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1604.A (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug1604.A__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug1604.A__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1604.A
(declare-fun Bug1604.A@tok () Term)
;;;;;;;;;;;;;;;;_0: Prims.int -> _1: Prims.int -> t
(declare-fun Tm_arrow_80ad7ad61e7aac89b6f259dffb2bca4c () Term)

; <start constructor Bug1604.t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1604.t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
Bug1604.t)))

; </end constructor Bug1604.t>


; <start constructor Bug1604.A>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1604.A ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
130)
(= __@x0
(Bug1604.A (Bug1604.A__0 __@x0)
(Bug1604.A__1 __@x0)))))

; </end constructor Bug1604.A>


; </end encoding type Bug1604.t>


; encoding sigelt assume Bug1604.t__uu___haseq


; <Start encoding assume Bug1604.t__uu___haseq>


; </end encoding assume Bug1604.t__uu___haseq>


; encoding sigelt val Bug1604.uu___is_A


; <Start encoding val Bug1604.uu___is_A>

(declare-fun Bug1604.uu___is_A (Term) Term)
;;;;;;;;;;;;;;;;projectee: t -> Prims.bool
(declare-fun Tm_arrow_720543376659f5a0335d9b0019ca6e6c () Term)
(declare-fun Bug1604.uu___is_A@tok () Term)

; </end encoding val Bug1604.uu___is_A>
...
; encoding sigelt val Bug1604.__proj__A__item___0


; <Start encoding val Bug1604.__proj__A__item___0>

(declare-fun Bug1604.__proj__A__item___0 (Term) Term)
;;;;;;;;;;;;;;;;projectee: t -> Prims.int
(declare-fun Tm_arrow_4ea28ce2185c0a7c7823f372d7583d23 () Term)
(declare-fun Bug1604.__proj__A__item___0@tok () Term)

; </end encoding val Bug1604.__proj__A__item___0>
...
; encoding sigelt val Bug1604.__proj__A__item___1


; <Start encoding val Bug1604.__proj__A__item___1>

(declare-fun Bug1604.__proj__A__item___1 (Term) Term)

(declare-fun Bug1604.__proj__A__item___1@tok () Term)

; </end encoding val Bug1604.__proj__A__item___1>
...
; encoding sigelt val Bug1604.f


; <Start encoding val Bug1604.f>

(declare-fun Bug1604.f (Term Term) Term)

(declare-fun Bug1604.f@tok () Term)

; </end encoding val Bug1604.f>


; encoding sigelt val Bug1604.g


; <Start encoding val Bug1604.g>

(declare-fun Bug1604.g (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.bool -> _: Prims.int -> _: Prims.int -> Prims.int
(declare-fun Tm_arrow_f1e1757ddb83fe10261cbef5a04bfe27 () Term)
(declare-fun Bug1604.g@tok () Term)

; </end encoding val Bug1604.g>
...
(declare-fun Bug1604.test1 (Dummy_sort) Term)
...
(declare-fun Bug1604.test2 (Dummy_sort) Term)
...
(declare-fun Bug1604.test3 (Dummy_sort) Term)
...
(declare-fun Bug1604.test4 (Dummy_sort) Term)
...
(declare-fun Bug1604.test5 (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Prims.int -> c: Prims.int -> e: Prims.int -> Prims.int
(declare-fun Tm_arrow_ddaab270e9fdf46f80b29f3d5d5fdd24 () Term)
(declare-fun Bug1604.test5@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1604.test5; Namespace Bug1604
(assert (! 
;; def=Bug1604.fst(14,4-14,9); use=Bug1604.fst(14,4-14,9)
...
(HasType @x2
Prims.int))
(HasType (Bug1604.test5 @x0
@x1
@x2)
Prims.int))
 

:pattern ((Bug1604.test5 @x0
@x1
@x2))
:qid typing_Bug1604.test5))

:named typing_Bug1604.test5))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1604.g; Namespace Bug1604
(assert (! 
;; def=Bug1604.fst(7,11-7,12); use=Bug1604.fst(7,11-7,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.bool)
(HasType @x1
...
(HasType @x2
Prims.int))
(HasType (Bug1604.g @x0
@x1
@x2)
Prims.int))
 

:pattern ((Bug1604.g @x0
@x1
@x2))
:qid typing_Bug1604.g))

:named typing_Bug1604.g))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1604.f; Namespace Bug1604
(assert (! 
;; def=Bug1604.fst(5,11-5,12); use=Bug1604.fst(5,11-5,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
Prims.int))
(HasType (Bug1604.f @x0
@x1)
Prims.int))
 

:pattern ((Bug1604.f @x0
@x1))
:qid typing_Bug1604.f))

:named typing_Bug1604.f))
;;;;;;;;;;;;;;;;refinement kinding
...
@x1
@x2))
:qid equation_Bug1604.test5))

:named equation_Bug1604.test5))
...
; Starting query at Bug1604.fst(17,4-17,44)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Prims.int) (c: Prims.int) (e: Prims.int).
;   (*  - Could not prove post-condition
; *) Bug1604.test5 a c e == Bug1604.g true (Bug1604.f a c) e
...
;; def=Bug1604.fst(17,11-17,44); use=Bug1604.fst(17,11-17,44)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1604.test6, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Bug1604.test5
