...
; Internals for Bug312


; encoding sigelt type Bug312.rel


; <Start encoding type Bug312.rel>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug312.rel (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug312.rel@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug312.R (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug312.R_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug312.R_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug312.R_l (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug312.R_r (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug312.R
(declare-fun Bug312.R@tok () Term)
;;;;;;;;;;;;;;;;l: a -> r: b -> rel a b
(declare-fun Tm_arrow_05e9c29069212a77b98c51662817e48c () Term)

; <start constructor Bug312.rel>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug312.rel ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
; </end constructor Bug312.rel>


; <start constructor Bug312.R>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug312.R ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
111)
(= __@x0
(Bug312.R (Bug312.R_a __@x0)
(Bug312.R_b __@x0)
(Bug312.R_l __@x0)
(Bug312.R_r __@x0)))))

; </end constructor Bug312.R>


; </end encoding type Bug312.rel>


; encoding sigelt val Bug312.uu___is_R


; <Start encoding val Bug312.uu___is_R>

(declare-fun Bug312.uu___is_R (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: rel a b -> Prims.bool
(declare-fun Tm_arrow_c11280e738ff9fa4f58bdd6361cb33fe () Term)
(declare-fun Bug312.uu___is_R@tok () Term)

; </end encoding val Bug312.uu___is_R>
...
; encoding sigelt val Bug312.__proj__R__item__l


; <Start encoding val Bug312.__proj__R__item__l>

(declare-fun Bug312.__proj__R__item__l (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: rel a b -> a
(declare-fun Tm_arrow_ddc419cecd2d65ea29c7750024fe6fc4 () Term)
(declare-fun Bug312.__proj__R__item__l@tok () Term)

; </end encoding val Bug312.__proj__R__item__l>


; encoding sigelt let __proj__R__item__l


; <Skipped let __proj__R__item__l/>


; encoding sigelt val Bug312.__proj__R__item__r


; <Start encoding val Bug312.__proj__R__item__r>

(declare-fun Bug312.__proj__R__item__r (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: rel a b -> b
(declare-fun Tm_arrow_ceefa91abd9b202c3800ddf59f02b18c () Term)
(declare-fun Bug312.__proj__R__item__r@tok () Term)

; </end encoding val Bug312.__proj__R__item__r>


; encoding sigelt let __proj__R__item__r


; <Skipped let __proj__R__item__r/>


; encoding sigelt let double


; <Start encoding let double>

(declare-fun Bug312.double (Term) Term)

(declare-fun Bug312.double@tok () Term)

; </end encoding let double>


; encoding sigelt let eq


; <Start encoding let eq>


(declare-fun Bug312.eq (Term) Term)

;;;;;;;;;;;;;;;;t: Type{Prims.hasEq t} -> Type
(declare-fun Tm_arrow_7f1707b40f7a454bd5936592af6883db () Term)
(declare-fun Bug312.eq@tok () Term)

(declare-fun Tm_refine_34f957f59f9b0f8945d448ccfa97b2fa (Term) Term)

; </end encoding let eq>


; encoding sigelt val Bug312.rel_map2


; <Skipped val Bug312.rel_map2/>


; encoding sigelt let rel_map2


; <Start encoding let rel_map2>

;;;;;;;;;;;;;;;;_: 'a -> _: 'b -> 'c
(declare-fun Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a (Term Term Term) Term)
(declare-fun Bug312.rel_map2 (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;f: (_: 'a -> _: 'b -> 'c) -> _: double 'a -> _: double 'b -> double 'c
(declare-fun Tm_arrow_daa56ec58cdb2423ae40d260d39a1653 () Term)
(declare-fun Bug312.rel_map2@tok () Term)


; </end encoding let rel_map2>


; encoding sigelt let shared


; <Start encoding let shared>

(declare-fun Bug312.shared (Term) Term)
;;;;;;;;;;;;;;;;secret: double Prims.int -> Type
(declare-fun Tm_arrow_272866e1ae22792086d65a53d6a4d721 () Term)
(declare-fun Bug312.shared@tok () Term)
(declare-fun Tm_refine_767ef0860b5ea727c250e25818987631 (Term) Term)

; </end encoding let shared>


; encoding sigelt let injection


; <Start encoding let injection>


(declare-fun Bug312.injection (Term) Term)

;;;;;;;;;;;;;;;;f: (_: Prims.int -> Prims.int) -> Prims.logical
(declare-fun Tm_arrow_72ea7f983c81b89071127342914eaf9a () Term)
(declare-fun Bug312.injection@tok () Term)

; </end encoding let injection>


; encoding sigelt let surjection


; <Start encoding let surjection>


(declare-fun Bug312.surjection (Term) Term)


(declare-fun Bug312.surjection@tok () Term)

; </end encoding let surjection>


; encoding sigelt let bijection


; <Start encoding let bijection>


(declare-fun Bug312.bijection (Term) Term)


(declare-fun Bug312.bijection@tok () Term)

; </end encoding let bijection>


; encoding sigelt let bij


; <Start encoding let bij>

(declare-fun Bug312.bij () Term)

(declare-fun Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a () Term)

; </end encoding let bij>


; encoding sigelt let inverses


; <Start encoding let inverses>



(declare-fun Bug312.inverses (Term Term) Term)


;;;;;;;;;;;;;;;;f: (_: Prims.int -> Prims.int) -> g: (_: Prims.int -> Prims.int) -> Prims.logical
(declare-fun Tm_arrow_031ff651bd60e6436d79e8bbc97d39d9 () Term)
(declare-fun Bug312.inverses@tok () Term)



; </end encoding let inverses>


; encoding sigelt val Bug312.lemma_inverses_bij


; <Start encoding val Bug312.lemma_inverses_bij>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug312.lemma_inverses_bij (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug312.lemma_inverses_bij@tok () Term)

; </end encoding val Bug312.lemma_inverses_bij>


; encoding sigelt let lemma_inverses_bij


; <Start encoding let lemma_inverses_bij>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug312.lemma_inverses_bij__175 (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug312.lemma_inverses_bij__175@tok () Term)

; </end encoding let lemma_inverses_bij>


; encoding sigelt val Bug312.sample


; <Start encoding val Bug312.sample>



(declare-fun Bug312.sample (Term) Term)


(declare-fun Tm_refine_53d3e5f019f4fe027ff7711c964d41f0 (Term) Term)
;;;;;;;;;;;;;;;;f: (_: Prims.int -> Prims.int){bijection f} -> r: rel Prims.int Prims.int {r.r = f r.l}
(declare-fun Tm_arrow_a721496c5c60270dc8edd8336caa475b () Term)
(declare-fun Bug312.sample@tok () Term)


; </end encoding val Bug312.sample>


; encoding sigelt val Bug312.triple_a


; <Start encoding val Bug312.triple_a>

(declare-fun Bug312.triple_a (Term) Term)

(declare-fun Tm_abs_8c09ed6cfc779448094da194cf0cfa5b () Term)




(declare-fun Tm_refine_36d900122040fd42673a930a4c6f9925 (Term) Term)
;;;;;;;;;;;;;;;;s: double Prims.int   -> r:     (h: double Prims.int & shared h)       { s.l - FStar.Pervasives.Native.snd (FStar.Pervasives.dsnd r).l =         s.r - FStar.Pervasives.Native.snd (FStar.Pervasives.dsnd r).r }
(declare-fun Tm_arrow_df40713703e4f470ec1b3b8ddf375370 () Term)
(declare-fun Bug312.triple_a@tok () Term)
...
; </end encoding val Bug312.triple_a>
...
;;;;;;;;;;;;;;;;typing_Tm_abs_8c09ed6cfc779448094da194cf0cfa5b
;;; Fact-ids: Name Bug312.triple_a; Namespace Bug312
(assert (! (HasType Tm_abs_8c09ed6cfc779448094da194cf0cfa5b
Tm_arrow_272866e1ae22792086d65a53d6a4d721)
:named typing_Tm_abs_8c09ed6cfc779448094da194cf0cfa5b))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug312.shared; Namespace Bug312
(assert (! 
;; def=Bug312.fst(27,5-27,11); use=Bug312.fst(27,5-27,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(Bug312.double Prims.int))
(HasType (Bug312.shared @x0)
Tm_type))
 

:pattern ((Bug312.shared @x0))
:qid typing_Bug312.shared))

:named typing_Bug312.shared))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug312.sample; Namespace Bug312
(assert (! 
;; def=Bug312.fst(48,11-48,17); use=Bug312.fst(48,11-48,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a)
(HasType (Bug312.sample @x0)
(Tm_refine_53d3e5f019f4fe027ff7711c964d41f0 @x0)))
 

:pattern ((Bug312.sample @x0))
:qid typing_Bug312.sample))

:named typing_Bug312.sample))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug312.rel_map2; Namespace Bug312
(assert (! 
;; def=Bug312.fst(25,4-25,12); use=Bug312.fst(25,4-25,12)
...
:pattern ((Bug312.rel_map2 @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_Bug312.rel_map2))

:named typing_Bug312.rel_map2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug312.double; Namespace Bug312
(assert (! 
;; def=Bug312.fst(21,5-21,11); use=Bug312.fst(21,5-21,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Bug312.double @x0)
Tm_type))
 

:pattern ((Bug312.double @x0))
:qid typing_Bug312.double))

:named typing_Bug312.double))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug312.bijection; Namespace Bug312
(assert (! 
;; def=Bug312.fst(34,17-34,26); use=Bug312.fst(34,17-34,26)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_35447810753695c4fe25c93af1251992)
(HasType (Bug312.bijection @x0)
Prims.logical))
 

:pattern ((Bug312.bijection @x0))
:qid typing_Bug312.bijection))

:named typing_Bug312.bijection))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug312.__proj__R__item__r; Namespace Bug312
(assert (! 
;; def=Bug312.fst(19,15-19,16); use=Bug312.fst(19,15-19,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Bug312.rel @x0
@x1)))
(HasType (Bug312.__proj__R__item__r @x0
@x1
@x2)
@x1))
 

:pattern ((Bug312.__proj__R__item__r @x0
@x1
@x2))
:qid typing_Bug312.__proj__R__item__r))

:named typing_Bug312.__proj__R__item__r))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug312.__proj__R__item__l; Namespace Bug312
(assert (! 
;; def=Bug312.fst(19,8-19,9); use=Bug312.fst(19,8-19,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Bug312.rel @x0
@x1)))
(HasType (Bug312.__proj__R__item__l @x0
@x1
@x2)
@x0))
 

:pattern ((Bug312.__proj__R__item__l @x0
@x1
@x2))
:qid typing_Bug312.__proj__R__item__l))

:named typing_Bug312.__proj__R__item__l))
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug312.rel; Namespace Bug312; Name Bug312.R; Namespace Bug312
(assert (! 
;; def=Bug312.fst(18,10-18,13); use=Bug312.fst(18,10-18,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug312.rel@tok
@x0)
@x1)
(Bug312.rel @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Bug312.rel@tok
@x0)
@x1))

:pattern ((Bug312.rel @x0
@x1))
:qid token_correspondence_Bug312.rel@tok))

:named token_correspondence_Bug312.rel@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Prims.dtuple2; Namespace Prims; Name Prims.Mkdtuple2; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name Bug312.rel; Namespace Bug312; Name Bug312.R; Namespace Bug312
(assert (! 
;; def=Bug312.fst(19,4-19,5); use=Bug312.fst(19,4-19,5)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Bug312.R @x1
@x2
...
(Bug312.rel @x5
@x6)))
:qid subterm_ordering_Bug312.R))

:named subterm_ordering_Bug312.R))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Bug312.shared; Namespace Bug312
(assert (! 
;; def=Bug312.fst(27,34-30,82); use=Bug312.fst(27,34-30,82)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_767ef0860b5ea727c250e25818987631 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_767ef0860b5ea727c250e25818987631 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_767ef0860b5ea727c250e25818987631))

:named refinement_kinding_Tm_refine_767ef0860b5ea727c250e25818987631))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Bug312.sample; Namespace Bug312
(assert (! 
;; def=Bug312.fst(50,27-50,66); use=Bug312.fst(50,27-50,66)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_53d3e5f019f4fe027ff7711c964d41f0 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_53d3e5f019f4fe027ff7711c964d41f0 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_53d3e5f019f4fe027ff7711c964d41f0))

:named refinement_kinding_Tm_refine_53d3e5f019f4fe027ff7711c964d41f0))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug312.bij; Namespace Bug312
(assert (! (HasType Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a
Tm_type)
:named refinement_kinding_Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_767ef0860b5ea727c250e25818987631 @x2))
(and (HasTypeFuel @u0
@x1
(Bug312.double (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))

;; def=Bug312.fst(28,37-28,62); use=Bug312.fst(28,37-28,62)
(= (FStar.Pervasives.Native.fst Prims.int
Prims.int
(Bug312.__proj__R__item__l (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
...
(FStar.Pervasives.Native.fst Prims.int
Prims.int
(Bug312.__proj__R__item__r (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
@x1)))
...
;; def=Bug312.fst(29,38-29,81); use=Bug312.fst(29,38-29,81)
(= (Prims.op_Addition (FStar.Pervasives.Native.fst Prims.int
Prims.int
(Bug312.__proj__R__item__l (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
...
Prims.int)
@x1)))
(Bug312.__proj__R__item__l Prims.int
Prims.int
@x2))


;; def=Bug312.fst(30,38-30,81); use=Bug312.fst(30,38-30,81)
(= (Prims.op_Addition (FStar.Pervasives.Native.fst Prims.int
Prims.int
(Bug312.__proj__R__item__r (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
...
Prims.int)
@x1)))
(Bug312.__proj__R__item__r Prims.int
Prims.int
@x2))
))
...
@x1
(Tm_refine_767ef0860b5ea727c250e25818987631 @x2)))
:qid refinement_interpretation_Tm_refine_767ef0860b5ea727c250e25818987631))

:named refinement_interpretation_Tm_refine_767ef0860b5ea727c250e25818987631))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_53d3e5f019f4fe027ff7711c964d41f0 @x2))
(and (HasTypeFuel @u0
@x1
(Bug312.rel Prims.int
Prims.int))

;; def=Bug312.fst(50,45-50,64); use=Bug312.fst(50,45-50,64)
(= (Bug312.__proj__R__item__r Prims.int
Prims.int
@x1)
(ApplyTT @x2
...
@x1
(Tm_refine_53d3e5f019f4fe027ff7711c964d41f0 @x2)))
:qid refinement_interpretation_Tm_refine_53d3e5f019f4fe027ff7711c964d41f0))

:named refinement_interpretation_Tm_refine_53d3e5f019f4fe027ff7711c964d41f0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug312.bij; Namespace Bug312
(assert (! 
;; def=Bug312.fst(36,11-36,42); use=Bug312.fst(36,11-36,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a)
...
;; def=Bug312.fst(36,30-36,41); use=Bug312.fst(36,30-36,41)
(Valid 
;; def=Bug312.fst(36,30-36,41); use=Bug312.fst(36,30-36,41)
(Bug312.bijection @x1)
)
...
@x1
Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a))
:qid refinement_interpretation_Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a))

:named refinement_interpretation_Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
@x2
@x3))
:qid projection_inverse_Bug312.R_r))

:named projection_inverse_Bug312.R_r))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug312.rel; Namespace Bug312; Name Bug312.R; Namespace Bug312
(assert (! 
;; def=Bug312.fst(19,4-19,5); use=Bug312.fst(19,4-19,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug312.R_l (Bug312.R @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Bug312.R_l))

:named projection_inverse_Bug312.R_l))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug312.rel; Namespace Bug312; Name Bug312.R; Namespace Bug312
(assert (! 
;; def=Bug312.fst(19,4-19,5); use=Bug312.fst(19,4-19,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug312.R_b (Bug312.R @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Bug312.R_b))

:named projection_inverse_Bug312.R_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug312.rel; Namespace Bug312; Name Bug312.R; Namespace Bug312
(assert (! 
;; def=Bug312.fst(19,4-19,5); use=Bug312.fst(19,4-19,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug312.R_a (Bug312.R @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_Bug312.R_a))

:named projection_inverse_Bug312.R_a))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Prims.__proj__Mkdtuple2__item___2; Namespace Prims
(assert (! 
;; def=Prims.fst(504,25-504,27); use=Prims.fst(504,25-504,27)
...
@x1
@x2))
:qid proj_equation_Bug312.R_r))

:named proj_equation_Bug312.R_r))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug312.__proj__R__item__l; Namespace Bug312
(assert (! 
;; def=Bug312.fst(19,8-19,9); use=Bug312.fst(19,8-19,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Bug312.__proj__R__item__l @x0
@x1
@x2)
(Bug312.R_l @x2))
...
@x1
@x2))
:qid proj_equation_Bug312.R_l))

:named proj_equation_Bug312.R_l))
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug312.rel; Namespace Bug312; Name Bug312.R; Namespace Bug312
(assert (! (is-Tm_arrow (PreType Bug312.rel@tok))
:named pre_kinding_Bug312.rel@tok))
...
;;; Fact-ids: Name Bug312.rel_map2; Namespace Bug312
(assert (! 
;; def=Bug312.fst(24,16-24,34); use=Bug312.fst(24,16-24,34)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_272866e1ae22792086d65a53d6a4d721
;;; Fact-ids: Name Bug312.shared; Namespace Bug312
(assert (! (HasType Tm_arrow_272866e1ae22792086d65a53d6a4d721
Tm_type)
:named kinding_Tm_arrow_272866e1ae22792086d65a53d6a4d721))
;;; Fact-ids: Name Prims.dtuple2; Namespace Prims; Name Prims.Mkdtuple2; Namespace Prims
...
;;; Fact-ids: Name Bug312.rel; Namespace Bug312; Name Bug312.R; Namespace Bug312
(assert (! (and (IsTotFun Bug312.rel@tok)

;; def=Bug312.fst(18,10-18,13); use=Bug312.fst(18,10-18,13)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Bug312.rel@tok
@x0))
 

:pattern ((ApplyTT Bug312.rel@tok
@x0))
:qid kinding_Bug312.rel@tok))
...
:pattern ((Bug312.rel @x0
@x1))
:qid kinding_Bug312.rel@tok.1))
)
:named kinding_Bug312.rel@tok))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_8c09ed6cfc779448094da194cf0cfa5b
;;; Fact-ids: Name Bug312.triple_a; Namespace Bug312
(assert (! 
;; def=Bug312.fst(54,41-54,49); use=Bug312.fst(54,41-54,49)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_8c09ed6cfc779448094da194cf0cfa5b
@x0)
(Bug312.shared @x0))
 

:pattern ((ApplyTT Tm_abs_8c09ed6cfc779448094da194cf0cfa5b
@x0))
:qid interpretation_Tm_abs_8c09ed6cfc779448094da194cf0cfa5b))

:named interpretation_Tm_abs_8c09ed6cfc779448094da194cf0cfa5b))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_767ef0860b5ea727c250e25818987631
;;; Fact-ids: Name Bug312.shared; Namespace Bug312
(assert (! 
;; def=Bug312.fst(27,34-30,82); use=Bug312.fst(27,34-30,82)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_767ef0860b5ea727c250e25818987631 @x0)))
(Valid (Prims.hasEq (Bug312.double (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_767ef0860b5ea727c250e25818987631 @x0))))
:qid haseqTm_refine_767ef0860b5ea727c250e25818987631))

:named haseqTm_refine_767ef0860b5ea727c250e25818987631))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_53d3e5f019f4fe027ff7711c964d41f0
;;; Fact-ids: Name Bug312.sample; Namespace Bug312
(assert (! 
;; def=Bug312.fst(50,27-50,66); use=Bug312.fst(50,27-50,66)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_53d3e5f019f4fe027ff7711c964d41f0 @x0)))
(Valid (Prims.hasEq (Bug312.rel Prims.int
Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_53d3e5f019f4fe027ff7711c964d41f0 @x0))))
:qid haseqTm_refine_53d3e5f019f4fe027ff7711c964d41f0))

:named haseqTm_refine_53d3e5f019f4fe027ff7711c964d41f0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a
;;; Fact-ids: Name Bug312.bij; Namespace Bug312
(assert (! (iff (Valid (Prims.hasEq Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a))
(Valid (Prims.hasEq Tm_arrow_35447810753695c4fe25c93af1251992)))
:named haseqTm_refine_48555fe919dde9cd3e5e9ec5a6baf81a))
...
(Bug312.rel @x2
@x3)))
:qid fuel_guarded_inversion_Bug312.rel))

:named fuel_guarded_inversion_Bug312.rel))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Prims.dtuple2; Namespace Prims; Name Prims.Mkdtuple2; Namespace Prims
(assert (! (= 259
...
;;; Fact-ids: Name Bug312.rel; Namespace Bug312; Name Bug312.R; Namespace Bug312
(assert (! (= 105
(Term_constr_id Bug312.rel@tok))
:named fresh_token_Bug312.rel@tok))
...
;;;;;;;;;;;;;;;;Equation for Bug312.shared
;;; Fact-ids: Name Bug312.shared; Namespace Bug312
(assert (! 
;; def=Bug312.fst(27,5-27,11); use=Bug312.fst(27,5-27,11)
(forall ((@x0 Term))
 (! (= (Bug312.shared @x0)
(Tm_refine_767ef0860b5ea727c250e25818987631 @x0))
 

:pattern ((Bug312.shared @x0))
:qid equation_Bug312.shared))

:named equation_Bug312.shared))
;;;;;;;;;;;;;;;;Equation for Bug312.rel_map2
;;; Fact-ids: Name Bug312.rel_map2; Namespace Bug312
(assert (! 
;; def=Bug312.fst(25,4-25,12); use=Bug312.fst(25,4-25,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
...
@x4
@x5)
(let ((@lb6 (FStar.Pervasives.Native.Mktuple2 (Bug312.rel @x0
@x0)
(Bug312.rel @x1
@x1)
@x4
...
@x2
(ApplyTT (ApplyTT @x3
(Bug312.R_l (FStar.Pervasives.Native.Mktuple2__1 @lb6)))
(Bug312.R_l (FStar.Pervasives.Native.Mktuple2__2 @lb6)))
(ApplyTT (ApplyTT @x3
(Bug312.R_r (FStar.Pervasives.Native.Mktuple2__1 @lb6)))
(Bug312.R_r (FStar.Pervasives.Native.Mktuple2__2 @lb6))))))
...
@x4
@x5))
:qid equation_Bug312.rel_map2))

:named equation_Bug312.rel_map2))
;;;;;;;;;;;;;;;;Equation for Bug312.double
;;; Fact-ids: Name Bug312.double; Namespace Bug312
(assert (! 
;; def=Bug312.fst(21,5-21,11); use=Bug312.fst(21,5-21,11)
(forall ((@x0 Term))
...
:pattern ((Bug312.double @x0))
:qid equation_Bug312.double))

:named equation_Bug312.double))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,22-59,30); use=FStar.Pervasives.Native.fst(59,22-59,30)
...
(Bug312.rel @x1
@x2)))
:qid data_typing_intro_Bug312.R@tok))

:named data_typing_intro_Bug312.R@tok))
...
(Bug312.rel @x5
@x6)))
:qid data_elim_Bug312.R))

:named data_elim_Bug312.R))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term) (@x1 Term))
 (! (= 104
(Term_constr_id (Bug312.rel @x0
@x1)))
 

:pattern ((Bug312.rel @x0
@x1))
:qid constructor_distinct_Bug312.rel))

:named constructor_distinct_Bug312.rel))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug312.rel; Namespace Bug312; Name Bug312.R; Namespace Bug312
(assert (! 
;; def=Bug312.fst(19,4-19,5); use=Bug312.fst(19,4-19,5)
...
@x2
@x3))
:qid constructor_distinct_Bug312.R))

:named constructor_distinct_Bug312.R))
...
(Bug312.rel @x2
@x3)))
:qid Bug312_pretyping_17ac45f213a1509bb252a1a8ac33ca45))

:named Bug312_pretyping_17ac45f213a1509bb252a1a8ac33ca45))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug312.rel_map2; Namespace Bug312
(assert (! 
;; def=Bug312.fst(24,16-24,34); use=Bug312.fst(24,16-24,34)
...
@x3
@x4)))
:qid Bug312_pre_typing_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a))

:named Bug312_pre_typing_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug312.shared; Namespace Bug312
(assert (! 
;; def=Bug312.fst(27,20-30,82); use=Bug312.fst(27,20-30,82)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_272866e1ae22792086d65a53d6a4d721)
...
@x1
Tm_arrow_272866e1ae22792086d65a53d6a4d721))
:qid Bug312_pre_typing_Tm_arrow_272866e1ae22792086d65a53d6a4d721))

:named Bug312_pre_typing_Tm_arrow_272866e1ae22792086d65a53d6a4d721))
...
@x4)
@x5))
:qid Bug312_interpretation_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid Bug312_interpretation_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a.2))
))
...
@x2
@x3)))
:qid Bug312_interpretation_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a))

:named Bug312_interpretation_Tm_arrow_31983ce7bb3fa3288ec94b088df0f02a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_272866e1ae22792086d65a53d6a4d721
;;; Fact-ids: Name Bug312.shared; Namespace Bug312
(assert (! 
;; def=Bug312.fst(27,20-30,82); use=Bug312.fst(27,20-30,82)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug312_interpretation_Tm_arrow_272866e1ae22792086d65a53d6a4d721.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_272866e1ae22792086d65a53d6a4d721))
:qid Bug312_interpretation_Tm_arrow_272866e1ae22792086d65a53d6a4d721))

:named Bug312_interpretation_Tm_arrow_272866e1ae22792086d65a53d6a4d721))
(push) ;; push{2

; Starting query at Bug312.fst(57,16-69,51)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(60,39-60,40); use=Bug312.fst(60,44-60,45)
(forall ((@x0 Term))
...
(declare-fun Tm_refine_ca9f76be1a1d89979edc18d3d48d438d () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_ca9f76be1a1d89979edc18d3d48d438d
Tm_type)
:named refinement_kinding_Tm_refine_ca9f76be1a1d89979edc18d3d48d438d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(50,27-50,66); use=Bug312.fst(57,16-69,51)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ca9f76be1a1d89979edc18d3d48d438d)
(and (HasTypeFuel @u0
@x1
(Bug312.rel Prims.int
Prims.int))

;; def=Bug312.fst(50,45-50,64); use=Bug312.fst(57,16-69,51)
(= (Bug312.__proj__R__item__r Prims.int
Prims.int
@x1)
(Bug312.__proj__R__item__l Prims.int
...
@x1
Tm_refine_ca9f76be1a1d89979edc18d3d48d438d))
:qid refinement_interpretation_Tm_refine_ca9f76be1a1d89979edc18d3d48d438d))

:named refinement_interpretation_Tm_refine_ca9f76be1a1d89979edc18d3d48d438d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ca9f76be1a1d89979edc18d3d48d438d
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ca9f76be1a1d89979edc18d3d48d438d))
(Valid (Prims.hasEq (Bug312.rel Prims.int
Prims.int))))
:named haseqTm_refine_ca9f76be1a1d89979edc18d3d48d438d))


(declare-fun Tm_abs_f55bf478ab1a3016cbe74690b81b2666 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_f55bf478ab1a3016cbe74690b81b2666
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(57,45-57,70); use=Bug312.fst(65,17-65,20)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x0)
Tm_arrow_35447810753695c4fe25c93af1251992)
 

:pattern ((Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x0))
:qid typing_Tm_abs_f55bf478ab1a3016cbe74690b81b2666))

:named typing_Tm_abs_f55bf478ab1a3016cbe74690b81b2666))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_f55bf478ab1a3016cbe74690b81b2666
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(57,45-57,70); use=Bug312.fst(65,17-65,20)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x1)
@x0)
(Prims.op_Addition (Prims.op_Subtraction @x0
(Bug312.__proj__R__item__l Prims.int
Prims.int
@x1))
(Bug312.__proj__R__item__r Prims.int
...
:pattern ((ApplyTT (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x1)
@x0))
:qid interpretation_Tm_abs_f55bf478ab1a3016cbe74690b81b2666))

:named interpretation_Tm_abs_f55bf478ab1a3016cbe74690b81b2666))



(declare-fun Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(50,27-50,66); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c))

:named refinement_kinding_Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(50,27-50,66); use=Bug312.fst(57,16-69,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c @x2))
(and (HasTypeFuel @u0
@x1
(Bug312.rel Prims.int
Prims.int))
...
Prims.int
@x1)
(Prims.op_Addition (Prims.op_Subtraction (Bug312.__proj__R__item__l Prims.int
Prims.int
@x1)
(Bug312.__proj__R__item__l Prims.int
Prims.int
...
@x1
(Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c @x2)))
:qid refinement_interpretation_Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c))

:named refinement_interpretation_Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(50,27-50,66); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c @x0)))
(Valid (Prims.hasEq (Bug312.rel Prims.int
Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c @x0))))
:qid haseqTm_refine_49f980a4b855f7a0b8ece23f426b0f6c))

:named haseqTm_refine_49f980a4b855f7a0b8ece23f426b0f6c))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.Pervasives.Native.Mktuple2@tok))
:named @kick_partial_app_3d7ee167be9fc6683b07cbea73a6a8dd))
...
(declare-fun Tm_abs_bf746d1d0fdd5fbd46344532b492d868 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_bf746d1d0fdd5fbd46344532b492d868
;;; Fact-ids: 
(assert (! (HasType Tm_abs_bf746d1d0fdd5fbd46344532b492d868
Tm_arrow_47fc285d7b44e13bcb7e420cbfc55623)
:named typing_Tm_abs_bf746d1d0fdd5fbd46344532b492d868))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_bf746d1d0fdd5fbd46344532b492d868
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(68,46-68,51); use=Bug312.fst(68,46-68,51)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_bf746d1d0fdd5fbd46344532b492d868
@x0)
@x1)
(Prims.op_Addition @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Tm_abs_bf746d1d0fdd5fbd46344532b492d868
@x0)
@x1))
:qid interpretation_Tm_abs_bf746d1d0fdd5fbd46344532b492d868))

:named interpretation_Tm_abs_bf746d1d0fdd5fbd46344532b492d868))
...
; Encoding query formula : forall (s: Bug312.double Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (pure_result: Prims.unit) (pure_result: Prims.unit).
;     Bug312.bijection (fun x -> x) ==>
;     Prims.auto_squash (Bug312.bijection (fun x -> x)) /\
;     (forall (any_result: f: (_: Prims.int -> Prims.int){Bug312.bijection f}).
;         (fun x -> x) == any_result ==>
;         (forall (any_result: r: Bug312.rel Prims.int Prims.int {r.r = r.l}).
;             Bug312.sample (fun x -> x) == any_result ==>
;             (forall (return_val: r: Bug312.rel Prims.int Prims.int {r.r = r.l}).
;                 return_val == Bug312.sample (fun x -> x) ==>
;                 Bug312.sample (fun x -> x) == return_val ==>
;                 (forall (y: Prims.int). y - s.r + s.l - s.l + s.r = y) /\
;                 (forall (x: Prims.int). x - s.l + s.r - s.r + s.l = x) /\
...
;                     (forall (x: Prims.int). x - s.l + s.r - s.r + s.l = x) /\
;                     (forall (pure_result: Prims.unit).
;                         Bug312.bijection (fun x -> x - s.l + s.r) ==>
;                         Bug312.bijection (fun x -> x - s.l + s.r) /\
;                         (forall (pure_result: Prims.unit).
;                             Bug312.bijection (fun x -> x - s.l + s.r) ==>
;                             Prims.auto_squash (Bug312.bijection (fun x -> x - s.l + s.r)) /\
;                             (forall (any_result: (x: Prims.int -> Prims.int)).
;                                 (fun x -> x - s.l + s.r) == any_result ==>
;                                 (forall (any_result:
;                                     r: Bug312.rel Prims.int Prims.int {r.r = r.l - s.l + s.r}).
;                                     Bug312.sample (fun x -> x - s.l + s.r) == any_result ==>
;                                     FStar.Pervasives.Native.fst (Bug312.rel_map2 FStar.Pervasives.Native.Mktuple2
;                                           (Bug312.sample (fun x -> x))
;                                           (Bug312.sample (fun x -> x - s.l + s.r)))
;                                         .l =
;                                     FStar.Pervasives.Native.fst (Bug312.rel_map2 FStar.Pervasives.Native.Mktuple2
;                                           (Bug312.sample (fun x -> x))
;                                           (Bug312.sample (fun x -> x - s.l + s.r)))
...
;                                           (Bug312.sample (fun x -> x - s.l + s.r)))
;                                         .l +
;                                     FStar.Pervasives.Native.snd (Bug312.rel_map2 FStar.Pervasives.Native.Mktuple2
;                                           (Bug312.sample (fun x -> x))
;                                           (Bug312.sample (fun x -> x - s.l + s.r)))
;                                         .l =
;                                     (Bug312.rel_map2 (fun x y -> x + y)
;                                         (Bug312.sample (fun x -> x))
;                                         (Bug312.sample (fun x -> x - s.l + s.r)))
;                                       .l /\
;                                     FStar.Pervasives.Native.fst (Bug312.rel_map2 FStar.Pervasives.Native.Mktuple2
...
;                                       .r /\
;                                     (forall (return_val:
;                                         Bug312.shared (Bug312.rel_map2 (fun x y -> x + y)
;                                               (Bug312.sample (fun x -> x))
;                                               (Bug312.sample (fun x -> x - s.l + s.r)))).
;                                         return_val ==
;                                         Bug312.rel_map2 FStar.Pervasives.Native.Mktuple2
;                                           (Bug312.sample (fun x -> x))
;                                           (Bug312.sample (fun x -> x - s.l + s.r)) ==>
;                                         (forall (any_result:
;                                             h: Bug312.double Prims.int & Bug312.shared h).
;                                             (|
;                                               Bug312.rel_map2 (fun x y -> x + y)
;                                                 (Bug312.sample (fun x -> x))
;                                                 (Bug312.sample (fun x -> x - s.l + s.r)),
...
;                                             any_result ==>
;                                             s.l -
;                                             FStar.Pervasives.Native.snd (FStar.Pervasives.dsnd (|
;                                                     Bug312.rel_map2 (fun x y -> x + y)
;                                                       (Bug312.sample (fun x -> x))
;                                                       (Bug312.sample (fun x -> x - s.l + s.r)),
;                                                     Bug312.rel_map2 FStar.Pervasives.Native.Mktuple2
...
; While typechecking the top-level declaration `let triple_a`
...
;; def=Prims.fst(441,36-441,97); use=Bug312.fst(58,17-58,20)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.unit)

;; def=Prims.fst(441,36-441,97); use=Bug312.fst(59,17-59,35)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=Bug312.fst(44,18-44,31); use=Bug312.fst(59,17-59,35)
(Valid 
;; def=Bug312.fst(44,18-44,31); use=Bug312.fst(59,17-59,35)
(Bug312.bijection Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d)
)
)

;; def=Prims.fst(459,77-459,89); use=Bug312.fst(57,16-69,51)
(and 
;; def=Bug312.fst(49,39-49,50); use=Bug312.fst(60,44-60,45)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=Bug312.fst(57,16-69,51)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a)

;; def=Bug312.fst(49,20-60,40); use=Bug312.fst(57,16-69,51)
...
;; def=Bug312.fst(50,27-60,46); use=Bug312.fst(60,27-60,46)
(= (Bug312.sample Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d)
@x4)
)

;; def=Prims.fst(356,2-356,58); use=Bug312.fst(57,16-69,51)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Tm_refine_ca9f76be1a1d89979edc18d3d48d438d)

;; def=Prims.fst(356,26-356,41); use=Bug312.fst(57,16-69,51)
(= @x5
(Bug312.sample Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d))


;; def=Bug312.fst(60,21-60,46); use=Bug312.fst(60,21-60,46)
(= (Bug312.sample Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d)
@x5)
)

;; def=Prims.fst(441,29-441,97); use=Bug312.fst(63,17-63,20)
(and 
;; def=Bug312.fst(39,3-39,32); use=Bug312.fst(63,17-63,20)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)

;; def=Bug312.fst(39,20-39,31); use=Bug312.fst(63,17-63,20)
(or label_2

;; def=Bug312.fst(39,20-39,31); use=Bug312.fst(63,17-63,20)
(= (Prims.op_Addition (Prims.op_Subtraction (Prims.op_Addition (Prims.op_Subtraction @x6
(Bug312.__proj__R__item__r Prims.int
Prims.int
@x0))
(Bug312.__proj__R__item__l Prims.int
...
;; def=Bug312.fst(40,3-40,32); use=Bug312.fst(63,17-63,20)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)

;; def=Bug312.fst(40,20-40,31); use=Bug312.fst(63,17-63,20)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=Bug312.fst(63,17-63,20)
(forall ((@x6 Term))
...
;; def=Bug312.fst(39,20-39,31); use=Bug312.fst(63,17-63,20)
(= (Prims.op_Addition (Prims.op_Subtraction (Prims.op_Addition (Prims.op_Subtraction @x7
(Bug312.__proj__R__item__r Prims.int
Prims.int
@x0))
(Bug312.__proj__R__item__l Prims.int
...
;; def=Prims.fst(441,29-441,97); use=Bug312.fst(64,17-64,35)
(and 
;; def=Bug312.fst(39,3-39,32); use=Bug312.fst(64,17-64,35)
(forall ((@x7 Term))
 (! (implies (HasType @x7
Prims.int)

;; def=Bug312.fst(39,20-39,31); use=Bug312.fst(64,17-64,35)
(or label_4
...
;; def=Bug312.fst(40,3-40,32); use=Bug312.fst(64,17-64,35)
(forall ((@x7 Term))
 (! (implies (HasType @x7
Prims.int)

;; def=Bug312.fst(40,20-40,31); use=Bug312.fst(64,17-64,35)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=Bug312.fst(64,17-64,35)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=Bug312.fst(44,18-44,31); use=Bug312.fst(64,17-64,35)
(Valid 
;; def=Bug312.fst(44,18-44,31); use=Bug312.fst(64,17-64,35)
(Bug312.bijection (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x0))
)
)

;; def=Prims.fst(441,29-441,97); use=Bug312.fst(65,17-65,20)
(and 
;; def=Bug312.fst(65,21-65,43); use=Bug312.fst(65,17-65,20)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=Bug312.fst(65,17-65,20)
(forall ((@x8 Term))
...
;; def=Prims.fst(459,77-459,89); use=Bug312.fst(57,16-69,51)
(and 
;; def=Bug312.fst(49,39-49,50); use=Bug312.fst(66,34-66,44)
(or label_7
...
;; def=Bug312.fst(49,20-57,31); use=Bug312.fst(57,16-69,51)
(= (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x0)
@x9)
)
...
(Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c @x0))

;; def=Bug312.fst(66,21-66,44); use=Bug312.fst(66,21-66,44)
(= (Bug312.sample (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x0))
@x10)
)

;; def=Prims.fst(459,77-459,89); use=Bug312.fst(57,16-69,51)
(and 
;; def=Bug312.fst(28,37-28,62); use=Bug312.fst(69,23-69,48)
(or label_8
...
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(Bug312.rel_map2 Prims.int
Prims.int
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(ApplyTT (ApplyTT FStar.Pervasives.Native.Mktuple2@tok
Prims.int)
Prims.int)
(Bug312.sample Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d)
(Bug312.sample (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x0)))))
...
;; def=Bug312.fst(29,38-29,81); use=Bug312.fst(69,23-69,48)
(or label_9
...
Prims.int
Prims.int
Tm_abs_bf746d1d0fdd5fbd46344532b492d868
(Bug312.sample Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d)
(Bug312.sample (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x0)))))
)


;; def=Bug312.fst(30,38-30,81); use=Bug312.fst(69,23-69,48)
(or label_10
...
(Bug312.shared (Bug312.rel_map2 Prims.int
Prims.int
Prims.int
Tm_abs_bf746d1d0fdd5fbd46344532b492d868
(Bug312.sample Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d)
...
(Prims.dtuple2 (Bug312.double Prims.int)
Tm_abs_8c09ed6cfc779448094da194cf0cfa5b))

;; def=Bug312.fst(54,22-69,51); use=Bug312.fst(57,16-69,51)
(= (Prims.Mkdtuple2 (Bug312.double Prims.int)
Tm_abs_8c09ed6cfc779448094da194cf0cfa5b
(Bug312.rel_map2 Prims.int
Prims.int
Prims.int
...
;; def=Bug312.fst(54,52-55,79); use=Bug312.fst(69,17-69,51)
(or label_11

;; def=Bug312.fst(54,52-55,79); use=Bug312.fst(69,17-69,51)
(= (Prims.op_Subtraction (Bug312.__proj__R__item__l Prims.int
Prims.int
@x0)
(FStar.Pervasives.Native.snd Prims.int
Prims.int
...
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(FStar.Pervasives.dsnd (Bug312.double Prims.int)
Tm_abs_8c09ed6cfc779448094da194cf0cfa5b
(Prims.Mkdtuple2 (Bug312.double Prims.int)
Tm_abs_8c09ed6cfc779448094da194cf0cfa5b
(Bug312.rel_map2 Prims.int
...
(Bug312.sample Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d)
(Bug312.sample (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x0))))))))
(Prims.op_Subtraction (Bug312.__proj__R__item__r Prims.int
Prims.int
@x0)
(FStar.Pervasives.Native.snd Prims.int
Prims.int
...
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(59,41-59,42); use=Bug312.fst(59,17-59,35)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d
@x0)
@x0)
...
(declare-fun Tm_refine_556d9584e258584021ef59b1057f3975 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(49,20-60,40); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_556d9584e258584021ef59b1057f3975 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_556d9584e258584021ef59b1057f3975 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_556d9584e258584021ef59b1057f3975))

:named refinement_kinding_Tm_refine_556d9584e258584021ef59b1057f3975))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(49,20-60,40); use=Bug312.fst(57,16-69,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_556d9584e258584021ef59b1057f3975 @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
@x1
(Tm_refine_556d9584e258584021ef59b1057f3975 @x2)))
:qid refinement_interpretation_Tm_refine_556d9584e258584021ef59b1057f3975))

:named refinement_interpretation_Tm_refine_556d9584e258584021ef59b1057f3975))
;;;;;;;;;;;;;;;;haseq for Tm_refine_556d9584e258584021ef59b1057f3975
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(49,20-60,40); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_556d9584e258584021ef59b1057f3975 @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_556d9584e258584021ef59b1057f3975 @x0))))
:qid haseqTm_refine_556d9584e258584021ef59b1057f3975))

:named haseqTm_refine_556d9584e258584021ef59b1057f3975))
(declare-fun Tm_refine_ca9f76be1a1d89979edc18d3d48d438d () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_ca9f76be1a1d89979edc18d3d48d438d
...
(declare-fun Tm_refine_cc45ec79675074ad95502fcaa66ec99d (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(50,27-60,46); use=Bug312.fst(60,27-60,46)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_cc45ec79675074ad95502fcaa66ec99d @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_cc45ec79675074ad95502fcaa66ec99d @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_cc45ec79675074ad95502fcaa66ec99d))

:named refinement_kinding_Tm_refine_cc45ec79675074ad95502fcaa66ec99d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(50,27-60,46); use=Bug312.fst(60,27-60,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_cc45ec79675074ad95502fcaa66ec99d @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
@x1
(Tm_refine_cc45ec79675074ad95502fcaa66ec99d @x2)))
:qid refinement_interpretation_Tm_refine_cc45ec79675074ad95502fcaa66ec99d))

:named refinement_interpretation_Tm_refine_cc45ec79675074ad95502fcaa66ec99d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_cc45ec79675074ad95502fcaa66ec99d
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(50,27-60,46); use=Bug312.fst(60,27-60,46)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_cc45ec79675074ad95502fcaa66ec99d @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_cc45ec79675074ad95502fcaa66ec99d @x0))))
:qid haseqTm_refine_cc45ec79675074ad95502fcaa66ec99d))

:named haseqTm_refine_cc45ec79675074ad95502fcaa66ec99d))



(declare-fun Tm_refine_ae8adeac4b579eea3d3be7745f51bab9 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,26-356,41); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_ae8adeac4b579eea3d3be7745f51bab9 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_ae8adeac4b579eea3d3be7745f51bab9 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_ae8adeac4b579eea3d3be7745f51bab9))

:named refinement_kinding_Tm_refine_ae8adeac4b579eea3d3be7745f51bab9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,26-356,41); use=Bug312.fst(57,16-69,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ae8adeac4b579eea3d3be7745f51bab9 @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
@x1
(Tm_refine_ae8adeac4b579eea3d3be7745f51bab9 @x2)))
:qid refinement_interpretation_Tm_refine_ae8adeac4b579eea3d3be7745f51bab9))

:named refinement_interpretation_Tm_refine_ae8adeac4b579eea3d3be7745f51bab9))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ae8adeac4b579eea3d3be7745f51bab9
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,26-356,41); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ae8adeac4b579eea3d3be7745f51bab9 @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ae8adeac4b579eea3d3be7745f51bab9 @x0))))
:qid haseqTm_refine_ae8adeac4b579eea3d3be7745f51bab9))

:named haseqTm_refine_ae8adeac4b579eea3d3be7745f51bab9))




; Encoding query formula : forall (s: Bug312.double Prims.int) (pure_result: Prims.unit) (pure_result: Prims.unit)
;   (_: Bug312.bijection (fun x -> x))
;   (any_result: f: (_: Prims.int -> Prims.int){Bug312.bijection f})
;   (_: _: Prims.unit{(fun x -> x) == any_result})
;   (any_result: r: Bug312.rel Prims.int Prims.int {r.r = r.l})
;   (_: _: Prims.unit{Bug312.sample (fun x -> x) == any_result})
;   (return_val: r: Bug312.rel Prims.int Prims.int {r.r = r.l})
;   (_: _: Prims.unit{return_val == Bug312.sample (fun x -> x)})
;   (_: _: Prims.unit{Bug312.sample (fun x -> x) == return_val}) (y: Prims.int).
;   (*  - Could not prove post-condition
; *) y - s.r + s.l - s.l + s.r = y
...
Tm_refine_48555fe919dde9cd3e5e9ec5a6baf81a)
(HasType @x5
(Tm_refine_556d9584e258584021ef59b1057f3975 @x4))
(HasType @x6
Tm_refine_ca9f76be1a1d89979edc18d3d48d438d)
(HasType @x7
(Tm_refine_cc45ec79675074ad95502fcaa66ec99d @x6))
(HasType @x8
Tm_refine_ca9f76be1a1d89979edc18d3d48d438d)
(HasType @x9
(Tm_refine_ae8adeac4b579eea3d3be7745f51bab9 @x8))
(HasType @x10
(Tm_refine_cc45ec79675074ad95502fcaa66ec99d @x8))
(HasType @x11
Prims.int))
...
;; def=Bug312.fst(39,20-39,31); use=Bug312.fst(63,17-63,20)
(= (Prims.op_Addition (Prims.op_Subtraction (Prims.op_Addition (Prims.op_Subtraction @x11
(Bug312.__proj__R__item__r Prims.int
Prims.int
@x0))
(Bug312.__proj__R__item__l Prims.int
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug312.triple_a, 3)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, int_inversion, primitive_Prims.op_Addition, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0
...
;   (return_val: r: Bug312.rel Prims.int Prims.int {r.r = r.l})
;   (_: _: Prims.unit{return_val == Bug312.sample (fun x -> x)})
;   (_: _: Prims.unit{Bug312.sample (fun x -> x) == return_val}) (x: Prims.int).
;   (*  - Could not prove post-condition
; *) x - s.l + s.r - s.r + s.l = x
...
(declare-fun Tm_refine_36f67b0a29dcbd18c4d38e08ae076873 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(39,3-40,32); use=Bug312.fst(63,17-63,20)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_36f67b0a29dcbd18c4d38e08ae076873 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_36f67b0a29dcbd18c4d38e08ae076873 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_36f67b0a29dcbd18c4d38e08ae076873))

:named refinement_kinding_Tm_refine_36f67b0a29dcbd18c4d38e08ae076873))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(39,3-40,32); use=Bug312.fst(63,17-63,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_36f67b0a29dcbd18c4d38e08ae076873 @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Bug312.fst(39,20-39,31); use=Bug312.fst(63,17-63,20)
(= (Prims.op_Addition (Prims.op_Subtraction (Prims.op_Addition (Prims.op_Subtraction @x3
(Bug312.__proj__R__item__r Prims.int
Prims.int
@x2))
(Bug312.__proj__R__item__l Prims.int
...
;;no pats
:qid refinement_interpretation_Tm_refine_36f67b0a29dcbd18c4d38e08ae076873.1))
...
;;no pats
:qid refinement_interpretation_Tm_refine_36f67b0a29dcbd18c4d38e08ae076873.2))
))
...
@x1
(Tm_refine_36f67b0a29dcbd18c4d38e08ae076873 @x2)))
:qid refinement_interpretation_Tm_refine_36f67b0a29dcbd18c4d38e08ae076873))

:named refinement_interpretation_Tm_refine_36f67b0a29dcbd18c4d38e08ae076873))
;;;;;;;;;;;;;;;;haseq for Tm_refine_36f67b0a29dcbd18c4d38e08ae076873
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(39,3-40,32); use=Bug312.fst(63,17-63,20)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_36f67b0a29dcbd18c4d38e08ae076873 @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_36f67b0a29dcbd18c4d38e08ae076873 @x0))))
:qid haseqTm_refine_36f67b0a29dcbd18c4d38e08ae076873))

:named haseqTm_refine_36f67b0a29dcbd18c4d38e08ae076873))
...
;   (return_val: r: Bug312.rel Prims.int Prims.int {r.r = r.l})
;   (_: _: Prims.unit{return_val == Bug312.sample (fun x -> x)})
;   (_: _: Prims.unit{Bug312.sample (fun x -> x) == return_val}) (pure_result: Prims.unit)
;   (_:
;   _:
;   Prims.unit
;     { (forall (y: Prims.int). y - s.r + s.l - s.l + s.r = y) /\
;       (forall (x: Prims.int). x - s.l + s.r - s.r + s.l = x) }) (y: Prims.int).
;   (*  - Could not prove post-condition
; *) y - s.r + s.l - s.l + s.r = y
...
Prims.unit)
(HasType @x12
(Tm_refine_36f67b0a29dcbd18c4d38e08ae076873 @x0))
(HasType @x13
Prims.int))
...
;; def=Bug312.fst(39,20-39,31); use=Bug312.fst(64,17-64,35)
(= (Prims.op_Addition (Prims.op_Subtraction (Prims.op_Addition (Prims.op_Subtraction @x13
(Bug312.__proj__R__item__r Prims.int
Prims.int
@x0))
(Bug312.__proj__R__item__l Prims.int
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug312.triple_a, 5)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, int_inversion, refinement_interpretation_Tm_refine_36f67b0a29dcbd18c4d38e08ae076873
...
;   Prims.unit
;     { (forall (y: Prims.int). y - s.r + s.l - s.l + s.r = y) /\
;       (forall (x: Prims.int). x - s.l + s.r - s.r + s.l = x) }) (x: Prims.int).
;   (*  - Could not prove post-condition
; *) x - s.l + s.r - s.r + s.l = x
...
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(57,45-57,70); use=Bug312.fst(64,17-64,35)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x0)
Tm_arrow_35447810753695c4fe25c93af1251992)
...
;   Prims.unit
;     { (forall (y: Prims.int). y - s.r + s.l - s.l + s.r = y) /\
;       (forall (x: Prims.int). x - s.l + s.r - s.r + s.l = x) }) (pure_result: Prims.unit)
;   (_: Bug312.bijection (fun x -> x - s.l + s.r)).
;   Prims.auto_squash (Bug312.bijection (fun x -> x - s.l + s.r))
...
;     { (forall (y: Prims.int). y - s.r + s.l - s.l + s.r = y) /\
;       (forall (x: Prims.int). x - s.l + s.r - s.r + s.l = x) }) (pure_result: Prims.unit)
;   (_: Bug312.bijection (fun x -> x - s.l + s.r)) (pure_result: Prims.unit)
;   (_: Bug312.bijection (fun x -> x - s.l + s.r)).
;   Prims.auto_squash (Bug312.bijection (fun x -> x - s.l + s.r))
...
(declare-fun Tm_refine_b4d7511f37d9080aab1df92cabaf61cb (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(49,20-57,31); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_b4d7511f37d9080aab1df92cabaf61cb @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_b4d7511f37d9080aab1df92cabaf61cb @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_b4d7511f37d9080aab1df92cabaf61cb))

:named refinement_kinding_Tm_refine_b4d7511f37d9080aab1df92cabaf61cb))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(49,20-57,31); use=Bug312.fst(57,16-69,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b4d7511f37d9080aab1df92cabaf61cb @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Bug312.fst(49,20-57,31); use=Bug312.fst(57,16-69,51)
(= (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x2)
@x3)
))
...
(Tm_refine_b4d7511f37d9080aab1df92cabaf61cb @x2
@x3)))
:qid refinement_interpretation_Tm_refine_b4d7511f37d9080aab1df92cabaf61cb))

:named refinement_interpretation_Tm_refine_b4d7511f37d9080aab1df92cabaf61cb))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b4d7511f37d9080aab1df92cabaf61cb
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(49,20-57,31); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b4d7511f37d9080aab1df92cabaf61cb @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b4d7511f37d9080aab1df92cabaf61cb @x0
@x1))))
:qid haseqTm_refine_b4d7511f37d9080aab1df92cabaf61cb))

:named haseqTm_refine_b4d7511f37d9080aab1df92cabaf61cb))
(declare-fun Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
...
(declare-fun Tm_refine_37ebdae6e7fe664f9be350f5690d7588 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(66,21-66,44); use=Bug312.fst(66,21-66,44)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_37ebdae6e7fe664f9be350f5690d7588 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_37ebdae6e7fe664f9be350f5690d7588 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_37ebdae6e7fe664f9be350f5690d7588))

:named refinement_kinding_Tm_refine_37ebdae6e7fe664f9be350f5690d7588))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(66,21-66,44); use=Bug312.fst(66,21-66,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_37ebdae6e7fe664f9be350f5690d7588 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Bug312.fst(66,21-66,44); use=Bug312.fst(66,21-66,44)
(= (Bug312.sample (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x2))
@x3)
))
...
(Tm_refine_37ebdae6e7fe664f9be350f5690d7588 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_37ebdae6e7fe664f9be350f5690d7588))

:named refinement_interpretation_Tm_refine_37ebdae6e7fe664f9be350f5690d7588))
;;;;;;;;;;;;;;;;haseq for Tm_refine_37ebdae6e7fe664f9be350f5690d7588
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(66,21-66,44); use=Bug312.fst(66,21-66,44)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_37ebdae6e7fe664f9be350f5690d7588 @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_37ebdae6e7fe664f9be350f5690d7588 @x0
@x1))))
:qid haseqTm_refine_37ebdae6e7fe664f9be350f5690d7588))

:named haseqTm_refine_37ebdae6e7fe664f9be350f5690d7588))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.Pervasives.Native.Mktuple2@tok))
...
;       (forall (x: Prims.int). x - s.l + s.r - s.r + s.l = x) }) (pure_result: Prims.unit)
;   (_: Bug312.bijection (fun x -> x - s.l + s.r)) (pure_result: Prims.unit)
;   (_: Bug312.bijection (fun x -> x - s.l + s.r)) (any_result: (x: Prims.int -> Prims.int))
;   (_: _: Prims.unit{(fun x -> x - s.l + s.r) == any_result})
;   (any_result: r: Bug312.rel Prims.int Prims.int {r.r = r.l - s.l + s.r})
;   (_: _: Prims.unit{Bug312.sample (fun x -> x - s.l + s.r) == any_result}).
;   (*  - Subtyping check failed
;   - Expected type shared a got type double (Prims.int & Prims.int)
; *)
;   FStar.Pervasives.Native.fst (Bug312.rel_map2 FStar.Pervasives.Native.Mktuple2
;         (Bug312.sample (fun x -> x))
;         (Bug312.sample (fun x -> x - s.l + s.r)))
...
Tm_arrow_35447810753695c4fe25c93af1251992)
(HasType @x18
(Tm_refine_b4d7511f37d9080aab1df92cabaf61cb @x0
@x17))
(HasType @x19
(Tm_refine_49f980a4b855f7a0b8ece23f426b0f6c @x0))
(HasType @x20
(Tm_refine_37ebdae6e7fe664f9be350f5690d7588 @x0
@x19)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug312.triple_a, 9)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, equality_tok_FStar.Pervasives.Native.Mktuple2@tok, equation_Bug312.rel_map2, equation_FStar.Pervasives.Native.fst, function_token_typing_Prims.__cache_version_number__, proj_equation_Bug312.R_l, proj_equation_Bug312.R_r, proj_equation_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_Bug312.R_l, projection_inverse_Bug312.R_r, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, refinement_interpretation_Tm_refine_ae8adeac4b579eea3d3be7745f51bab9, refinement_interpretation_Tm_refine_ca9f76be1a1d89979edc18d3d48d438d
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug312.triple_a, 10)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equality_tok_FStar.Pervasives.Native.Mktuple2@tok, equation_Bug312.rel_map2, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, interpretation_Tm_abs_bf746d1d0fdd5fbd46344532b492d868, proj_equation_Bug312.R_l, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_Bug312.R_l, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug312.triple_a, 11)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equality_tok_FStar.Pervasives.Native.Mktuple2@tok, equation_Bug312.rel_map2, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, interpretation_Tm_abs_bf746d1d0fdd5fbd46344532b492d868, proj_equation_Bug312.R_r, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_Bug312.R_r, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(68,46-68,51); use=Bug312.fst(69,17-69,51)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_bf746d1d0fdd5fbd46344532b492d868
@x0)
@x1)
...
(declare-fun Tm_refine_c8685bfd5f9924e11319c1d73f961ed9 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,26-356,41); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c8685bfd5f9924e11319c1d73f961ed9 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_c8685bfd5f9924e11319c1d73f961ed9 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_c8685bfd5f9924e11319c1d73f961ed9))

:named refinement_kinding_Tm_refine_c8685bfd5f9924e11319c1d73f961ed9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,26-356,41); use=Bug312.fst(57,16-69,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c8685bfd5f9924e11319c1d73f961ed9 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
Prims.int)
(Bug312.sample Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d)
(Bug312.sample (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x3))))
))
...
(Tm_refine_c8685bfd5f9924e11319c1d73f961ed9 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_c8685bfd5f9924e11319c1d73f961ed9))

:named refinement_interpretation_Tm_refine_c8685bfd5f9924e11319c1d73f961ed9))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c8685bfd5f9924e11319c1d73f961ed9
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,26-356,41); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c8685bfd5f9924e11319c1d73f961ed9 @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c8685bfd5f9924e11319c1d73f961ed9 @x0
@x1))))
:qid haseqTm_refine_c8685bfd5f9924e11319c1d73f961ed9))

:named haseqTm_refine_c8685bfd5f9924e11319c1d73f961ed9))
...
(declare-fun Tm_refine_c0647d0e49f45a692b8b1685aa25a814 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(54,22-69,51); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c0647d0e49f45a692b8b1685aa25a814 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_c0647d0e49f45a692b8b1685aa25a814 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_c0647d0e49f45a692b8b1685aa25a814))

:named refinement_kinding_Tm_refine_c0647d0e49f45a692b8b1685aa25a814))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(54,22-69,51); use=Bug312.fst(57,16-69,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c0647d0e49f45a692b8b1685aa25a814 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
(Tm_refine_c0647d0e49f45a692b8b1685aa25a814 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_c0647d0e49f45a692b8b1685aa25a814))

:named refinement_interpretation_Tm_refine_c0647d0e49f45a692b8b1685aa25a814))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c0647d0e49f45a692b8b1685aa25a814
;;; Fact-ids: 
(assert (! 
;; def=Bug312.fst(54,22-69,51); use=Bug312.fst(57,16-69,51)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c0647d0e49f45a692b8b1685aa25a814 @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c0647d0e49f45a692b8b1685aa25a814 @x0
@x1))))
:qid haseqTm_refine_c0647d0e49f45a692b8b1685aa25a814))

:named haseqTm_refine_c0647d0e49f45a692b8b1685aa25a814))
...
;         (Bug312.sample (fun x -> x))
;         (Bug312.sample (fun x -> x - s.l + s.r)) })
;   (any_result: h: Bug312.double Prims.int & Bug312.shared h)
;   (_:
;   _:
;   Prims.unit
;     { (|
...
;   - Expected type
;       r:
;       (h: double Prims.int & shared h)
;         { s.l - FStar.Pervasives.Native.snd (FStar.Pervasives.dsnd r).l =
;           s.r - FStar.Pervasives.Native.snd (FStar.Pervasives.dsnd r).r }
;     got type h: double Prims.int & shared h
; *)
;   s.l -
;   FStar.Pervasives.Native.snd (FStar.Pervasives.dsnd (|
;           Bug312.rel_map2 (fun x y -> x + y)
...
(Bug312.sample (Tm_abs_f55bf478ab1a3016cbe74690b81b2666 @x0)))))
(HasType @x22
(Tm_refine_c8685bfd5f9924e11319c1d73f961ed9 @x21
@x0))
(HasType @x23
(Prims.dtuple2 (Bug312.double Prims.int)
Tm_abs_8c09ed6cfc779448094da194cf0cfa5b))
(HasType @x24
(Tm_refine_c0647d0e49f45a692b8b1685aa25a814 @x0
@x23)))
