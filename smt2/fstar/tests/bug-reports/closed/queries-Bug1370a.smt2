...
; Internals for Bug1370a


; encoding sigelt effect Raises a ex = FStar.Pervasives.Exn a


; <Skipped effect Raises a ex = FStar.Pervasives.Exn a/>


; encoding sigelt datacon Bug1370a.Bad for type Prims.exn


; <Start encoding datacon Bug1370a.Bad for type Prims.exn>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1370a.Bad () Term)
;;;;;;;;;;;;;;;;Constructor base
(declare-fun Bug1370a.Bad@base () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1370a.Bad
(declare-fun Bug1370a.Bad@tok () Term)

; <start constructor Bug1370a.Bad>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1370a.Bad ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
105)
(= __@x0
Bug1370a.Bad)))

; </end constructor Bug1370a.Bad>


; </end encoding datacon Bug1370a.Bad for type Prims.exn>


; encoding sigelt val Bug1370a.uu___is_Bad


; <Start encoding val Bug1370a.uu___is_Bad>

(declare-fun Bug1370a.uu___is_Bad (Term) Term)
;;;;;;;;;;;;;;;;projectee: Prims.exn -> Prims.bool
(declare-fun Tm_arrow_81ab3356926b82578fcb92e97b412345 () Term)
(declare-fun Bug1370a.uu___is_Bad@tok () Term)

; </end encoding val Bug1370a.uu___is_Bad>
...
; encoding sigelt datacon Bug1370a.ReallyBad for type Prims.exn


; <Start encoding datacon Bug1370a.ReallyBad for type Prims.exn>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1370a.ReallyBad () Term)
;;;;;;;;;;;;;;;;Constructor base
(declare-fun Bug1370a.ReallyBad@base () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1370a.ReallyBad
(declare-fun Bug1370a.ReallyBad@tok () Term)

; <start constructor Bug1370a.ReallyBad>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1370a.ReallyBad ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
109)
(= __@x0
Bug1370a.ReallyBad)))

; </end constructor Bug1370a.ReallyBad>


; </end encoding datacon Bug1370a.ReallyBad for type Prims.exn>


; encoding sigelt val Bug1370a.uu___is_ReallyBad


; <Start encoding val Bug1370a.uu___is_ReallyBad>

(declare-fun Bug1370a.uu___is_ReallyBad (Term) Term)

(declare-fun Bug1370a.uu___is_ReallyBad@tok () Term)

; </end encoding val Bug1370a.uu___is_ReallyBad>


; encoding sigelt let uu___is_ReallyBad


; <Skipped let uu___is_ReallyBad/>


; encoding sigelt val Bug1370a.u


; <Skipped val Bug1370a.u/>
...
;;;;;;;;;;;;;;;;Constructor base
;;; Fact-ids: Name Bug1370a.Bad; Namespace Bug1370a
(assert (! (implies (is-Bug1370a.Bad Bug1370a.Bad)
(= Bug1370a.Bad
Bug1370a.Bad@base))
:named constructor_base_Bug1370a.Bad))
;;;;;;;;;;;;;;;;Constructor base
;;; Fact-ids: Name Bug1370a.ReallyBad; Namespace Bug1370a
(assert (! (implies (is-Bug1370a.ReallyBad Bug1370a.ReallyBad)
(= Bug1370a.ReallyBad
Bug1370a.ReallyBad@base))
:named constructor_base_Bug1370a.ReallyBad))
...
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug1370a.Bad; Namespace Bug1370a
(assert (! (HasType Bug1370a.Bad@tok
Prims.exn)
:named typing_tok_Bug1370a.Bad@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug1370a.Bad; Namespace Bug1370a
(assert (! (= Bug1370a.Bad@tok
Bug1370a.Bad)
:named equality_tok_Bug1370a.Bad@tok))
...
;;; Fact-ids: Name Bug1370a.Bad; Namespace Bug1370a
(assert (! 
;; def=Bug1370a.fst(30,10-30,13); use=Bug1370a.fst(30,10-30,13)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug1370a.Bad
Prims.exn)
...
Bug1370a.Bad
Prims.exn))
:qid data_typing_intro_Bug1370a.Bad@tok))

:named data_typing_intro_Bug1370a.Bad@tok))
...
;;; Fact-ids: Name Bug1370a.Bad; Namespace Bug1370a
(assert (! (= 105
(Term_constr_id Bug1370a.Bad))
:named constructor_distinct_Bug1370a.Bad))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
; Starting query at Bug1370a.fst(34,10-36,18)
...
; *)
;   forall (p: FStar.Pervasives.ex_post Prims.nat).
;     (forall (r: FStar.Pervasives.result Prims.nat).
;         (match r with
;           | FStar.Pervasives.V _ -> Prims.l_True
;           | FStar.Pervasives.E e -> e == Bug1370a.Bad
;           | _ -> Prims.l_False) ==>
;         p r) ==>
;     (forall (k: FStar.Pervasives.ex_post Prims.nat).
;         (forall (rb: FStar.Pervasives.result Prims.nat). {:pattern Prims.guard_free (k rb)}
;             p rb ==> k rb) ==>
;         (forall (k: FStar.Pervasives.ex_post Prims.nat).
;             (forall (rb: FStar.Pervasives.result Prims.nat). {:pattern Prims.guard_free (k rb)}
;                 k rb ==> k rb) ==>
...
;                       return_val == any_result ==> k (FStar.Pervasives.V return_val)))) /\
;             (~(i > 10 = true) ==>
;               (forall (b: Prims.bool).
;                   (forall (k: FStar.Pervasives.ex_post Prims.nat).
;                       (forall (rb: FStar.Pervasives.result Prims.nat).
;                           {:pattern Prims.guard_free (k rb)}
;                           k rb ==> k rb) ==>
;                       i > 10 == b ==>
;                       (forall (r: FStar.Pervasives.result Prims.nat).
;                           r == FStar.Pervasives.E Bug1370a.Bad ==> k r))
;                   <:
;                   Prims.GTot Type0))))
...
;; def=FStar.Pervasives.fsti(566,47-566,87); use=FStar.Pervasives.fsti(584,15-584,26)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(FStar.Pervasives.ex_post Prims.nat))

;; def=FStar.Pervasives.fsti(591,38-591,76); use=Bug1370a.fst(34,10-36,18)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
(FStar.Pervasives.result Prims.nat)))
(let ((@lb3 @x2))
(implies (not (is-FStar.Pervasives.V @lb3))
(ite (is-FStar.Pervasives.E @lb3)

;; def=Bug1370a.fst(26,27-26,34); use=Bug1370a.fst(34,10-36,18)
(or label_2

;; def=Bug1370a.fst(26,27-26,34); use=Bug1370a.fst(34,10-36,18)
(= (FStar.Pervasives.E_e @lb3)
Bug1370a.Bad@tok)
)

label_3))))

;; def=FStar.Pervasives.fsti(591,72-591,75); use=Bug1370a.fst(34,10-36,18)
(Valid 
;; def=FStar.Pervasives.fsti(591,72-591,75); use=Bug1370a.fst(34,10-36,18)
(ApplyTT @x1
@x2)
...
;; def=FStar.Pervasives.fsti(561,2-562,85); use=Bug1370a.fst(34,10-36,18)
(forall ((@x2 Term))
...
(forall ((@x3 Term))
 (! (implies 
;; def=FStar.Pervasives.fsti(562,59-562,66); use=Bug1370a.fst(34,10-36,18)
(Valid 
;; def=FStar.Pervasives.fsti(562,59-562,66); use=Bug1370a.fst(34,10-36,18)
(ApplyTT @x1
@x3)
...
;; def=FStar.Pervasives.fsti(562,71-562,75); use=Bug1370a.fst(34,10-36,18)
(Valid 
;; def=FStar.Pervasives.fsti(562,71-562,75); use=Bug1370a.fst(34,10-36,18)
(ApplyTT @x2
@x3)
...
;; def=FStar.Pervasives.fsti(545,2-550,32); use=Bug1370a.fst(34,10-36,18)
(forall ((@x3 Term))
...
(forall ((@x4 Term))
 (! (implies 
;; def=FStar.Pervasives.fsti(546,59-546,63); use=Bug1370a.fst(34,10-36,18)
(Valid 
;; def=FStar.Pervasives.fsti(546,59-546,63); use=Bug1370a.fst(34,10-36,18)
(ApplyTT @x2
@x4)
...
;; def=FStar.Pervasives.fsti(546,68-546,72); use=Bug1370a.fst(34,10-36,18)
(Valid 
;; def=FStar.Pervasives.fsti(546,68-546,72); use=Bug1370a.fst(34,10-36,18)
(ApplyTT @x3
@x4)
...
;; def=FStar.Pervasives.fsti(556,2-556,39); use=Bug1370a.fst(34,10-36,18)
(and (implies 
;; def=Bug1370a.fst(34,13-34,19); use=Bug1370a.fst(34,13-34,19)
(= (Prims.op_GreaterThan @x0
(BoxInt 10))
(BoxBool true))


;; def=Prims.fst(451,66-451,102); use=Bug1370a.fst(34,10-36,18)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Bug1370a.fst(33,22-34,7); use=Bug1370a.fst(34,10-36,18)
(= @x4
@x0)
)

;; def=Prims.fst(356,2-356,58); use=Bug1370a.fst(34,10-36,18)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Bug1370a.fst(34,10-36,18)
(= @x5
@x4)
)

;; def=FStar.Pervasives.fsti(598,73-598,80); use=Bug1370a.fst(34,10-36,18)
(Valid 
;; def=FStar.Pervasives.fsti(598,73-598,80); use=Bug1370a.fst(34,10-36,18)
(ApplyTT @x3
(FStar.Pervasives.V Prims.nat
@x5))
)
)
...
(implies 
;; def=FStar.Pervasives.fsti(556,19-556,21); use=Bug1370a.fst(34,10-36,18)
(not 
;; def=Bug1370a.fst(34,13-34,19); use=Bug1370a.fst(34,13-34,19)
(= (Prims.op_GreaterThan @x0
(BoxInt 10))
...
;; def=FStar.Pervasives.fsti(570,73-570,96); use=Bug1370a.fst(34,10-36,18)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.bool)
...
;; def=Bug1370a.fst(34,13-36,18); use=Bug1370a.fst(34,13-36,18)
(= (Prims.op_GreaterThan @x0
(BoxInt 10))
@x4)
)

;; def=FStar.Pervasives.fsti(591,38-591,76); use=Bug1370a.fst(36,9-36,14)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(FStar.Pervasives.result Prims.nat))

;; def=FStar.Exn.fst(22,63-22,71); use=Bug1370a.fst(36,9-36,14)
(= @x6
(FStar.Pervasives.E Prims.nat
Bug1370a.Bad@tok))
)

;; def=FStar.Pervasives.fsti(591,72-591,75); use=Bug1370a.fst(36,9-36,14)
(Valid 
;; def=FStar.Pervasives.fsti(591,72-591,75); use=Bug1370a.fst(36,9-36,14)
(ApplyTT @x5
@x6)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug1370a.u (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug1370a.u@tok () Term)
...
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug1370a.ReallyBad; Namespace Bug1370a
(assert (! (HasType Bug1370a.ReallyBad@tok
Prims.exn)
:named typing_tok_Bug1370a.ReallyBad@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug1370a.ReallyBad; Namespace Bug1370a
(assert (! (= Bug1370a.ReallyBad@tok
Bug1370a.ReallyBad)
:named equality_tok_Bug1370a.ReallyBad@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug1370a.ReallyBad; Namespace Bug1370a
(assert (! 
;; def=Bug1370a.fst(31,10-31,19); use=Bug1370a.fst(31,10-31,19)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug1370a.ReallyBad
Prims.exn)
...
Bug1370a.ReallyBad
Prims.exn))
:qid data_typing_intro_Bug1370a.ReallyBad@tok))

:named data_typing_intro_Bug1370a.ReallyBad@tok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug1370a.ReallyBad; Namespace Bug1370a
(assert (! (= 109
(Term_constr_id Bug1370a.ReallyBad))
:named constructor_distinct_Bug1370a.ReallyBad))
(push) ;; push{3

; Starting query at Bug1370a.fst(41,11-43,24)
...
;                       i > 10 == b ==>
;                       (forall (r: FStar.Pervasives.result Prims.nat).
;                           r == FStar.Pervasives.E Bug1370a.ReallyBad ==> k r))
;                   <:
;                   Prims.GTot Type0))))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let u'`
; While typechecking the top-level declaration `[@@expect_failure] let u'`
...
;; def=FStar.Pervasives.fsti(591,38-591,76); use=Bug1370a.fst(41,11-43,24)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
(FStar.Pervasives.result Prims.nat)))
...
;; def=Bug1370a.fst(26,27-26,34); use=Bug1370a.fst(41,11-43,24)
(or label_2
...
;; def=FStar.Pervasives.fsti(591,72-591,75); use=Bug1370a.fst(41,11-43,24)
(Valid 
;; def=FStar.Pervasives.fsti(591,72-591,75); use=Bug1370a.fst(41,11-43,24)
(ApplyTT @x1
@x2)
...
;; def=FStar.Pervasives.fsti(561,2-562,85); use=Bug1370a.fst(41,11-43,24)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(FStar.Pervasives.ex_post Prims.nat))
...
(forall ((@x3 Term))
 (! (implies 
;; def=FStar.Pervasives.fsti(562,59-562,66); use=Bug1370a.fst(41,11-43,24)
(Valid 
;; def=FStar.Pervasives.fsti(562,59-562,66); use=Bug1370a.fst(41,11-43,24)
(ApplyTT @x1
@x3)
...
;; def=FStar.Pervasives.fsti(562,71-562,75); use=Bug1370a.fst(41,11-43,24)
(Valid 
;; def=FStar.Pervasives.fsti(562,71-562,75); use=Bug1370a.fst(41,11-43,24)
(ApplyTT @x2
@x3)
...
;; def=FStar.Pervasives.fsti(545,2-550,32); use=Bug1370a.fst(41,11-43,24)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(FStar.Pervasives.ex_post Prims.nat))
...
(forall ((@x4 Term))
 (! (implies 
;; def=FStar.Pervasives.fsti(546,59-546,63); use=Bug1370a.fst(41,11-43,24)
(Valid 
;; def=FStar.Pervasives.fsti(546,59-546,63); use=Bug1370a.fst(41,11-43,24)
(ApplyTT @x2
@x4)
...
;; def=FStar.Pervasives.fsti(546,68-546,72); use=Bug1370a.fst(41,11-43,24)
(Valid 
;; def=FStar.Pervasives.fsti(546,68-546,72); use=Bug1370a.fst(41,11-43,24)
(ApplyTT @x3
@x4)
...
;; def=FStar.Pervasives.fsti(556,2-556,39); use=Bug1370a.fst(41,11-43,24)
(and (implies 
;; def=Bug1370a.fst(41,14-41,20); use=Bug1370a.fst(41,14-41,20)
(= (Prims.op_GreaterThan @x0
(BoxInt 10))
(BoxBool true))


;; def=Prims.fst(451,66-451,102); use=Bug1370a.fst(41,11-43,24)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Bug1370a.fst(38,23-41,8); use=Bug1370a.fst(41,11-43,24)
(= @x4
@x0)
)

;; def=Prims.fst(356,2-356,58); use=Bug1370a.fst(41,11-43,24)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Bug1370a.fst(41,11-43,24)
(= @x5
@x4)
)

;; def=FStar.Pervasives.fsti(598,73-598,80); use=Bug1370a.fst(41,11-43,24)
(Valid 
;; def=FStar.Pervasives.fsti(598,73-598,80); use=Bug1370a.fst(41,11-43,24)
(ApplyTT @x3
(FStar.Pervasives.V Prims.nat
...
(implies 
;; def=FStar.Pervasives.fsti(556,19-556,21); use=Bug1370a.fst(41,11-43,24)
(not 
;; def=Bug1370a.fst(41,14-41,20); use=Bug1370a.fst(41,14-41,20)
(= (Prims.op_GreaterThan @x0
(BoxInt 10))
...
;; def=FStar.Pervasives.fsti(570,73-570,96); use=Bug1370a.fst(41,11-43,24)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.bool)
...
;; def=Bug1370a.fst(41,14-43,24); use=Bug1370a.fst(41,14-43,24)
(= (Prims.op_GreaterThan @x0
(BoxInt 10))
@x4)
)

;; def=FStar.Pervasives.fsti(591,38-591,76); use=Bug1370a.fst(43,9-43,14)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(FStar.Pervasives.result Prims.nat))

;; def=FStar.Exn.fst(22,63-22,71); use=Bug1370a.fst(43,9-43,14)
(= @x6
(FStar.Pervasives.E Prims.nat
Bug1370a.ReallyBad@tok))
)

;; def=FStar.Pervasives.fsti(591,72-591,75); use=Bug1370a.fst(43,9-43,14)
(Valid 
;; def=FStar.Pervasives.fsti(591,72-591,75); use=Bug1370a.fst(43,9-43,14)
(ApplyTT @x5
@x6)
