...
; Internals for UnificationCrash
...
; encoding sigelt type UnificationCrash.tree


; <Start encoding type UnificationCrash.tree>

;;;;;;;;;;;;;;;;Constructor
(declare-fun UnificationCrash.tree (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun UnificationCrash.tree@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun UnificationCrash.Tree (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun UnificationCrash.Tree_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun UnificationCrash.Tree__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: UnificationCrash.Tree
(declare-fun UnificationCrash.Tree@tok () Term)
;;;;;;;;;;;;;;;;_0: a -> tree a
(declare-fun Tm_arrow_880cba1ede070affee92a4fbb3193b6c () Term)

; <start constructor UnificationCrash.tree>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-UnificationCrash.tree ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
115)
(exists ((@x0 Term))
 (! (= __@x0
(UnificationCrash.tree @x0))
 
;;no pats
:qid is-UnificationCrash.tree))))

; </end constructor UnificationCrash.tree>
...
122)
(= __@x0
(UnificationCrash.Tree (UnificationCrash.Tree_a __@x0)
(UnificationCrash.Tree__0 __@x0)))))

; </end constructor UnificationCrash.Tree>


; </end encoding type UnificationCrash.tree>
...
;;; Fact-ids: Name UnificationCrash.tree; Namespace UnificationCrash; Name UnificationCrash.Tree; Namespace UnificationCrash
(assert (! 
;; def=UnificationCrash.fst(17,5-17,9); use=UnificationCrash.fst(17,5-17,9)
(forall ((@x0 Term))
 (! (= (ApplyTT UnificationCrash.tree@tok
@x0)
(UnificationCrash.tree @x0))
 

:pattern ((ApplyTT UnificationCrash.tree@tok
@x0))

:pattern ((UnificationCrash.tree @x0))
:qid token_correspondence_UnificationCrash.tree@tok))

:named token_correspondence_UnificationCrash.tree@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name UnificationCrash.tree; Namespace UnificationCrash; Name UnificationCrash.Tree; Namespace UnificationCrash
(assert (! 
;; def=UnificationCrash.fst(17,24-17,28); use=UnificationCrash.fst(17,24-17,28)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(UnificationCrash.Tree @x1
@x2)
(UnificationCrash.tree @x3))
...
@x2)
(UnificationCrash.tree @x3)))
:qid subterm_ordering_UnificationCrash.Tree))

:named subterm_ordering_UnificationCrash.Tree))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=UnificationCrash.fst(17,24-17,28); use=UnificationCrash.fst(17,24-17,28)
(forall ((@x0 Term) (@x1 Term))
 (! (= (UnificationCrash.Tree_a (UnificationCrash.Tree @x0
@x1))
@x0)
...
:pattern ((UnificationCrash.Tree @x0
@x1))
:qid projection_inverse_UnificationCrash.Tree_a))

:named projection_inverse_UnificationCrash.Tree_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name UnificationCrash.tree; Namespace UnificationCrash; Name UnificationCrash.Tree; Namespace UnificationCrash
(assert (! 
;; def=UnificationCrash.fst(17,24-17,28); use=UnificationCrash.fst(17,24-17,28)
(forall ((@x0 Term) (@x1 Term))
 (! (= (UnificationCrash.Tree__0 (UnificationCrash.Tree @x0
@x1))
@x1)
...
:pattern ((UnificationCrash.Tree @x0
@x1))
:qid projection_inverse_UnificationCrash.Tree__0))

:named projection_inverse_UnificationCrash.Tree__0))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name UnificationCrash.tree; Namespace UnificationCrash; Name UnificationCrash.Tree; Namespace UnificationCrash
(assert (! (is-Tm_arrow (PreType UnificationCrash.tree@tok))
:named pre_kinding_UnificationCrash.tree@tok))
;;; Fact-ids: Name UnificationCrash.tree; Namespace UnificationCrash; Name UnificationCrash.Tree; Namespace UnificationCrash
(assert (! (and (IsTotFun UnificationCrash.tree@tok)

;; def=UnificationCrash.fst(17,5-17,9); use=UnificationCrash.fst(17,5-17,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (UnificationCrash.tree @x0)
Tm_type))
 

:pattern ((UnificationCrash.tree @x0))
:qid kinding_UnificationCrash.tree@tok))
)
:named kinding_UnificationCrash.tree@tok))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(UnificationCrash.tree @x2))
(and (is-UnificationCrash.Tree @x1)
(= @x2
(UnificationCrash.Tree_a @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(UnificationCrash.tree @x2)))
:qid fuel_guarded_inversion_UnificationCrash.tree))

:named fuel_guarded_inversion_UnificationCrash.tree))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name UnificationCrash.tree; Namespace UnificationCrash; Name UnificationCrash.Tree; Namespace UnificationCrash
(assert (! (= 116
(Term_constr_id UnificationCrash.tree@tok))
:named fresh_token_UnificationCrash.tree@tok))
...
@x2)
(UnificationCrash.tree @x1)))
:qid data_typing_intro_UnificationCrash.Tree@tok))

:named data_typing_intro_UnificationCrash.Tree@tok))
...
@x2)
(UnificationCrash.tree @x3)))
:qid data_elim_UnificationCrash.Tree))

:named data_elim_UnificationCrash.Tree))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name UnificationCrash.tree; Namespace UnificationCrash; Name UnificationCrash.Tree; Namespace UnificationCrash
(assert (! 
;; def=UnificationCrash.fst(17,5-17,9); use=UnificationCrash.fst(17,5-17,9)
(forall ((@x0 Term))
 (! (= 115
(Term_constr_id (UnificationCrash.tree @x0)))
 

:pattern ((UnificationCrash.tree @x0))
:qid constructor_distinct_UnificationCrash.tree))

:named constructor_distinct_UnificationCrash.tree))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name UnificationCrash.tree; Namespace UnificationCrash; Name UnificationCrash.Tree; Namespace UnificationCrash
(assert (! 
;; def=UnificationCrash.fst(17,24-17,28); use=UnificationCrash.fst(17,24-17,28)
...
@x0
(UnificationCrash.tree @x2)))
:qid UnificationCrash_pretyping_1926b60718005a2115e4d36bdd07c4c9))

:named UnificationCrash_pretyping_1926b60718005a2115e4d36bdd07c4c9))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
; Starting query at UnificationCrash.fst(17,0-17,42)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type).
;   Prims.hasEq a /\
;   (forall (a: Type0). {:pattern Prims.hasEq (UnificationCrash.tree a)}
;       Prims.hasEq a ==> Prims.hasEq (UnificationCrash.tree a)) ==>
;   (forall (_0: a).
;       (*  - Failed to prove that the type
;     'UnificationCrash.tree'
...
; While typechecking the top-level declaration `type UnificationCrash.tree`
...
;; def=UnificationCrash.fst(17,0-17,42); use=UnificationCrash.fst(17,0-17,42)
(Valid 
;; def=UnificationCrash.fst(17,0-17,42); use=UnificationCrash.fst(17,0-17,42)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=UnificationCrash.fst(17,0-17,42); use=UnificationCrash.fst(17,0-17,42)
(Prims.hasEq (UnificationCrash.tree @x1))
)
)
 

:pattern ((Prims.hasEq (UnificationCrash.tree @x1)))
:qid @query.1))
)
...
;; def=UnificationCrash.fst(17,0-17,42); use=UnificationCrash.fst(17,31-17,32)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (UnificationCrash.tree, 1)
; STATUS: unsat
