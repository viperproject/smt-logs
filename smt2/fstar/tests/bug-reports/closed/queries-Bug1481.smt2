...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1481.op_Plus; Namespace Bug1481
(assert (! 
;; def=Bug1481.fst(18,5-18,6); use=Bug1481.fst(18,5-18,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.bool)
(HasType @x1
Prims.bool))
(HasType (Bug1481.op_Plus @x0
@x1)
Prims.bool))
 

:pattern ((Bug1481.op_Plus @x0
@x1))
:qid typing_Bug1481.op_Plus))

:named typing_Bug1481.op_Plus))
;;;;;;;;;;;;;;;;refinement kinding
...
:pattern ((Bug1481.op_Plus @x0
@x1))
:qid equation_Bug1481.op_Plus))

:named equation_Bug1481.op_Plus))
...
; Starting query at Bug1481.fst(19,0-19,37)

(declare-fun label_1 () Bool)

; Encoding query formula : true + false == true
...
;;; Fact-ids: 
(assert (! (not 
;; def=Bug1481.fst(19,15-19,37); use=Bug1481.fst(19,8-19,14)
(or label_1

;; def=Bug1481.fst(19,15-19,37); use=Bug1481.fst(19,8-19,14)
(= (Bug1481.op_Plus (BoxBool true)
(BoxBool false))
(BoxBool true))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1481.uu___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Bug1481.op_Plus, primitive_Prims.op_BarBar, projection_inverse_BoxBool_proj_0
...
(declare-fun Bug1481.uu___0 (Dummy_sort) Term)

; </end encoding let uu___0>


; encoding sigelt let op_Amp_Amp


; <Start encoding let op_Amp_Amp>

(declare-fun Bug1481.op_Amp_Amp (Term Term) Term)

(declare-fun Bug1481.op_Amp_Amp@tok () Term)

; </end encoding let op_Amp_Amp>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1481.op_Amp_Amp; Namespace Bug1481
(assert (! 
;; def=Bug1481.fst(21,5-21,7); use=Bug1481.fst(21,5-21,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.bool)
(HasType @x1
Prims.bool))
(HasType (Bug1481.op_Amp_Amp @x0
@x1)
Prims.bool))
 

:pattern ((Bug1481.op_Amp_Amp @x0
@x1))
:qid typing_Bug1481.op_Amp_Amp))

:named typing_Bug1481.op_Amp_Amp))
;;;;;;;;;;;;;;;;Equation for Bug1481.op_Amp_Amp
;;; Fact-ids: Name Bug1481.op_Amp_Amp; Namespace Bug1481
(assert (! 
;; def=Bug1481.fst(21,5-21,7); use=Bug1481.fst(21,5-21,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug1481.op_Amp_Amp @x0
@x1)
(Prims.op_BarBar @x0
@x1))
...
:pattern ((Bug1481.op_Amp_Amp @x0
@x1))
:qid equation_Bug1481.op_Amp_Amp))

:named equation_Bug1481.op_Amp_Amp))
(push) ;; push{2

; Starting query at Bug1481.fst(22,0-22,40)
...
;;; Fact-ids: 
(assert (! (not 
;; def=Bug1481.fst(22,15-22,40); use=Bug1481.fst(22,8-22,14)
(or label_1

;; def=Bug1481.fst(22,15-22,40); use=Bug1481.fst(22,8-22,14)
(= (Bug1481.op_Amp_Amp (BoxBool true)
(BoxBool false))
(BoxBool true))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1481.uu___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Bug1481.op_Amp_Amp, primitive_Prims.op_BarBar, projection_inverse_BoxBool_proj_0
