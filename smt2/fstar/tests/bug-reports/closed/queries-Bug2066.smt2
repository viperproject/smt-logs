...
(declare-fun Bug2066.pre_t () Term)
...
(declare-fun Bug2066.post_t (Term) Term)

(declare-fun Bug2066.post_t@tok () Term)
...
(declare-fun Bug2066.repr (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> pre: pre_t -> post: post_t a -> Type
(declare-fun Tm_arrow_221438b3e6ecf13d3918d6d9749c4898 () Term)
(declare-fun Bug2066.repr@tok () Term)
(declare-fun Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 (Term Term) Term)
;;;;;;;;;;;;;;;;_: unit -> Prims.Pure a
(declare-fun Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f (Term Term Term) Term)

; </end encoding let repr>


; encoding sigelt let return_pre


; <Start encoding let return_pre>

(declare-fun Bug2066.return_pre (Dummy_sort) Term)

; </end encoding let return_pre>


; encoding sigelt let return_post


; <Start encoding let return_post>

(declare-fun Bug2066.return_post (Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> post_t a
(declare-fun Tm_arrow_b4c63e72a21a4c936c87ad59aa5399a0 () Term)
(declare-fun Bug2066.return_post@tok () Term)

(declare-fun Tm_abs_bbcaf2c7177276dfe13060488d87cfe1 (Term Term) Term)

; </end encoding let return_post>
...
(declare-fun Bug2066.return (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> x: a -> repr a Prims.l_True (fun r -> r == x)
(declare-fun Tm_arrow_2be7921b1bceb6e9f707216b3e9aec6d () Term)
(declare-fun Bug2066.return@tok () Term)


(declare-fun Tm_abs_b21d8f383472a72bc3cf7080c825a2bf (Term) Term)

; </end encoding let return>


; encoding sigelt let bind_pre


; <Start encoding let bind_pre>

;;;;;;;;;;;;;;;;_: a -> pre_t
(declare-fun Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a (Term) Term)
(declare-fun Bug2066.bind_pre (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;pre_f: pre_t -> post_f: post_t a -> pre_g: (_: a -> pre_t) -> pre_t
(declare-fun Tm_arrow_239ffdf7188006eb1917f38c8b61c565 () Term)
(declare-fun Bug2066.bind_pre@tok () Term)


; </end encoding let bind_pre>


; encoding sigelt let bind_post


; <Start encoding let bind_post>


;;;;;;;;;;;;;;;;_: a -> post_t b
(declare-fun Tm_arrow_5280bc31102eeb96bc2388c02b5089e9 (Term Term) Term)
(declare-fun Bug2066.bind_post (Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;post_f: post_t a -> pre_g: (_: a -> pre_t) -> post_g: (_: a -> post_t b) -> post_t b
(declare-fun Tm_arrow_c206db68daf800a5bca103ac03400cac () Term)
(declare-fun Bug2066.bind_post@tok () Term)



(declare-fun Tm_abs_db476d03ad22df463015da3c3b2d64f7 (Term Term Term Term) Term)

(declare-fun Tm_abs_d1c8c87a9f91b588f9ef61de5f90104f (Term Term Term Term) Term)

; </end encoding let bind_post>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2066.unit; Namespace Bug2066
(assert (! (HasType Bug2066.unit
Tm_type)
:named typing_Bug2066.unit))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2066.repr; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(9,5-9,9); use=Bug2066.fst(9,5-9,9)
...
(HasType @x2
(Bug2066.post_t @x0)))
(HasType (Bug2066.repr @x0
@x1
@x2)
Tm_type))
 

:pattern ((Bug2066.repr @x0
@x1
@x2))
:qid typing_Bug2066.repr))

:named typing_Bug2066.repr))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2066.pre_t; Namespace Bug2066
(assert (! (HasType Bug2066.pre_t
Tm_type)
:named typing_Bug2066.pre_t))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2066.post_t; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(7,5-7,11); use=Bug2066.fst(7,5-7,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Bug2066.post_t @x0)
Tm_type))
 

:pattern ((Bug2066.post_t @x0))
:qid typing_Bug2066.post_t))

:named typing_Bug2066.post_t))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;; Fact-ids: Name Bug2066.repr; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(9,11-9,12); use=Bug2066.fst(10,15-10,16)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a
;;; Fact-ids: Name Bug2066.bind_pre; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(22,15-24,19); use=Bug2066.fst(24,9-24,19)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a @x0)
Tm_type))
:qid kinding_Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a))

:named kinding_Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f
;;; Fact-ids: Name Bug2066.repr; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(9,11-10,6); use=Bug2066.fst(10,2-10,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f))

:named kinding_Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5280bc31102eeb96bc2388c02b5089e9
;;; Fact-ids: Name Bug2066.bind_post; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(29,16-31,42); use=Bug2066.fst(31,29-31,42)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_5280bc31102eeb96bc2388c02b5089e9 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_5280bc31102eeb96bc2388c02b5089e9 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_5280bc31102eeb96bc2388c02b5089e9))

:named kinding_Tm_arrow_5280bc31102eeb96bc2388c02b5089e9))
...
(assert (! (HasType Bug2066.unit
Tm_type)
:named function_token_typing_Bug2066.unit))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Bug2066.pre_t; Namespace Bug2066
(assert (! (HasType Bug2066.pre_t
Tm_type)
:named function_token_typing_Bug2066.pre_t))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;Equation for Bug2066.unit
;;; Fact-ids: Name Bug2066.unit; Namespace Bug2066
(assert (! (= Bug2066.unit
Prims.unit)
:named equation_Bug2066.unit))
;;;;;;;;;;;;;;;;Equation for Bug2066.repr
;;; Fact-ids: Name Bug2066.repr; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(9,5-9,9); use=Bug2066.fst(9,5-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x1
@x2)
(Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f @x2
@x0
@x1))
...
@x1
@x2))
:qid equation_Bug2066.repr))

:named equation_Bug2066.repr))
;;;;;;;;;;;;;;;;Equation for Bug2066.pre_t
;;; Fact-ids: Name Bug2066.pre_t; Namespace Bug2066
(assert (! (= Bug2066.pre_t
Tm_type)
:named equation_Bug2066.pre_t))
;;;;;;;;;;;;;;;;Equation for Bug2066.post_t
;;; Fact-ids: Name Bug2066.post_t; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(7,5-7,11); use=Bug2066.fst(7,5-7,11)
(forall ((@x0 Term))
...
:pattern ((Bug2066.post_t @x0))
:qid equation_Bug2066.post_t))

:named equation_Bug2066.post_t))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a @x2)))
:qid Bug2066_pre_typing_Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a))

:named Bug2066_pre_typing_Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug2066.repr; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(9,11-10,6); use=Bug2066.fst(10,2-10,16)
...
@x3
@x4)))
:qid Bug2066_pre_typing_Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f))

:named Bug2066_pre_typing_Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug2066.bind_post; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(29,16-31,42); use=Bug2066.fst(31,29-31,42)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_5280bc31102eeb96bc2388c02b5089e9 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_5280bc31102eeb96bc2388c02b5089e9 @x2
@x3)))
:qid Bug2066_pre_typing_Tm_arrow_5280bc31102eeb96bc2388c02b5089e9))

:named Bug2066_pre_typing_Tm_arrow_5280bc31102eeb96bc2388c02b5089e9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a
;;; Fact-ids: Name Bug2066.bind_pre; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(22,15-24,19); use=Bug2066.fst(24,9-24,19)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a @x1))
(and 
;; def=Bug2066.fst(22,15-24,19); use=Bug2066.fst(24,9-24,19)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug2066_interpretation_Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a @x1)))
:qid Bug2066_interpretation_Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a))

:named Bug2066_interpretation_Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f
;;; Fact-ids: Name Bug2066.repr; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(9,11-10,6); use=Bug2066.fst(10,2-10,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f @x1
@x2
@x3))
(and 
;; def=Bug2066.fst(9,11-10,6); use=Bug2066.fst(10,2-10,16)
(forall ((@x4 Term))
 (! (implies (and 
;; def=Bug2066.fst(9,20-9,23); use=Bug2066.fst(10,17-10,20)
(Valid 
;; def=Bug2066.fst(9,20-9,23); use=Bug2066.fst(10,17-10,20)
@x3
)
...
:pattern ((ApplyTT @x0
@x4))
:qid Bug2066_interpretation_Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f.1))
...
@x2
@x3)))
:qid Bug2066_interpretation_Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f))

:named Bug2066_interpretation_Tm_arrow_b176eb5cc52bc8599668e76f7dde5e2f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5280bc31102eeb96bc2388c02b5089e9
;;; Fact-ids: Name Bug2066.bind_post; Namespace Bug2066
(assert (! 
;; def=Bug2066.fst(29,16-31,42); use=Bug2066.fst(31,29-31,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_5280bc31102eeb96bc2388c02b5089e9 @x1
@x2))
(and 
;; def=Bug2066.fst(29,16-31,42); use=Bug2066.fst(31,29-31,42)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid Bug2066_interpretation_Tm_arrow_5280bc31102eeb96bc2388c02b5089e9.1))
...
(Tm_arrow_5280bc31102eeb96bc2388c02b5089e9 @x1
@x2)))
:qid Bug2066_interpretation_Tm_arrow_5280bc31102eeb96bc2388c02b5089e9))

:named Bug2066_interpretation_Tm_arrow_5280bc31102eeb96bc2388c02b5089e9))
(push) ;; push{2

; Starting query at Bug2066.fst(43,4-45,12)
...
;;;;;;;;;;;;;;;;x: a -> repr b (pre_g x) (post_g x)
(declare-fun Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757
;;; Fact-ids: 
(assert (! 
;; def=Bug2066.fst(35,10-39,40); use=Bug2066.fst(39,8-39,40)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757 @x0
@x1
@x2
@x3)
Tm_type))
:qid kinding_Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757))

:named kinding_Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug2066.fst(35,10-39,40); use=Bug2066.fst(39,8-39,40)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757 @x2
@x3
@x4
@x5))
(is-Tm_arrow (PreType @x1)))
...
@x4
@x5)))
:qid Bug2066_pre_typing_Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757))

:named Bug2066_pre_typing_Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757
;;; Fact-ids: 
(assert (! 
;; def=Bug2066.fst(35,10-39,40); use=Bug2066.fst(39,8-39,40)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757 @x1
@x2
@x3
@x4))
(and 
...
:pattern ((ApplyTT @x0
@x5))
:qid Bug2066_interpretation_Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757.1))
...
@x3
@x4)))
:qid Bug2066_interpretation_Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757))

:named Bug2066_interpretation_Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (pre_f: Bug2066.pre_t)
;   (post_f: Bug2066.post_t a)
;   (pre_g: (_: a -> Bug2066.pre_t))
;   (post_g: (_: a -> Bug2066.post_t b))
;   (f: Bug2066.repr a pre_f post_f)
;   (g: (x: a -> Bug2066.repr b (pre_g x) (post_g x))).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Bug2066.unit).
;     (*  - Could not prove post-condition
; *)
;     forall (p: Prims.pure_post b).
;       pre_f /\ (forall (x: a). post_f x ==> pre_g x) /\
;       (forall (pure_result: b). (exists (x: a). post_f x /\ post_g x pure_result) ==> p pure_result) ==>
;       pre_f /\
;       (forall (pure_result: a).
;           post_f pure_result ==>
;           f () == pure_result ==>
;           pre_g (f ()) /\
;           (forall (pure_result: b).
;               post_g (f ()) pure_result ==>
;               pure_result == g (f ()) () ==>
;               (forall (return_val: b). return_val == pure_result ==> p return_val)))
...
(Bug2066.post_t @x0))
(HasType @x4
(Tm_arrow_db5d7c4c248a5f77d7a5d5e85eb9540a @x0))
(HasType @x5
(Tm_arrow_5280bc31102eeb96bc2388c02b5089e9 @x1
@x0))
(HasType @x6
...
@x3))
(HasType @x7
(Tm_arrow_fecd0baf8a8750f8e41eed5d7b043757 @x5
@x4
@x1
@x0)))

;; def=dummy(0,0-0,0); use=Bug2066.fst(43,4-45,12)
(forall ((@x8 Term))
 (! (implies (HasType @x8
Bug2066.unit)

;; def=Prims.fst(406,51-406,91); use=Bug2066.fst(43,4-45,12)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(Prims.pure_post @x1))

;; def=Bug2066.fst(36,3-36,8); use=Bug2066.fst(41,16-41,21)
(Valid 
;; def=Bug2066.fst(36,3-36,8); use=Bug2066.fst(41,16-41,21)
@x2
)
...
;; def=Bug2066.fst(26,13-26,49); use=Bug2066.fst(43,4-45,12)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
@x0)

;; def=Bug2066.fst(26,28-26,36); use=Bug2066.fst(43,4-45,12)
(Valid 
;; def=Bug2066.fst(26,28-26,36); use=Bug2066.fst(43,4-45,12)
(ApplyTT @x3
@x10)
...
;; def=Bug2066.fst(26,41-26,48); use=Bug2066.fst(43,4-45,12)
(Valid 
;; def=Bug2066.fst(26,41-26,48); use=Bug2066.fst(43,4-45,12)
(ApplyTT @x4
@x10)
...
;; def=Prims.fst(441,36-441,97); use=Bug2066.fst(43,12-45,12)
(forall ((@x10 Term))
 (! (implies (and (or label_1
(HasType @x10
@x1))

;; def=Bug2066.fst(33,13-33,49); use=Bug2066.fst(43,4-45,12)
(or label_2
...
;; def=Bug2066.fst(33,27-33,35); use=Bug2066.fst(43,4-45,12)
(Valid 
;; def=Bug2066.fst(33,27-33,35); use=Bug2066.fst(43,4-45,12)
(ApplyTT @x3
@x11)
...
;; def=Bug2066.fst(33,39-33,49); use=Bug2066.fst(43,4-45,12)
(Valid 
;; def=Bug2066.fst(33,39-33,49); use=Bug2066.fst(43,4-45,12)
(ApplyTT (ApplyTT @x5
@x11)
...
;; def=Prims.fst(441,83-441,96); use=Bug2066.fst(43,12-45,12)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug2066.fst(43,12-45,12)
(ApplyTT @x9
@x10)
...
;; def=Prims.fst(441,29-441,97); use=Bug2066.fst(43,12-45,12)
(and 
;; def=Bug2066.fst(36,3-36,8); use=Bug2066.fst(38,12-38,17)
(or label_3
...
;; def=Prims.fst(441,62-441,78); use=Bug2066.fst(43,12-45,12)
(Valid 
;; def=Prims.fst(441,62-441,78); use=Bug2066.fst(43,12-45,12)
(ApplyTT @x3
@x10)
...
;; def=Bug2066.fst(44,8-44,16); use=Bug2066.fst(44,8-44,16)
(= (ApplyTT @x6
Tm_unit)
@x10)
)
...
;; def=Prims.fst(441,29-441,97); use=Bug2066.fst(43,12-45,12)
(and 
;; def=Bug2066.fst(39,20-39,29); use=Bug2066.fst(43,12-45,12)
(or label_4
...
;; def=Bug2066.fst(35,19-45,12); use=Bug2066.fst(43,12-45,12)
(= @x11
(ApplyTT (ApplyTT @x7
(ApplyTT @x6
Tm_unit))
...
;; def=Prims.fst(356,2-356,58); use=Bug2066.fst(43,4-45,12)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
@x1)

;; def=Prims.fst(356,26-356,41); use=Bug2066.fst(43,4-45,12)
(= @x12
@x11)
)

;; def=Prims.fst(356,46-356,58); use=Bug2066.fst(43,4-45,12)
(Valid 
;; def=Prims.fst(356,46-356,58); use=Bug2066.fst(43,4-45,12)
(ApplyTT @x9
@x12)
