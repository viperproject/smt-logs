...
; Internals for Bug2374


; encoding sigelt type Bug2374.r1


; <Start encoding type Bug2374.r1>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2374.r1 () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2374.Mkr1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2374.Mkr1_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2374.Mkr1
(declare-fun Bug2374.Mkr1@tok () Term)
;;;;;;;;;;;;;;;;a: Prims.bool -> r1
(declare-fun Tm_arrow_4e962d9015d6e5025de1f09416f5ad71 () Term)

; <start constructor Bug2374.r1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2374.r1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
Bug2374.r1)))

; </end constructor Bug2374.r1>


; <start constructor Bug2374.Mkr1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2374.Mkr1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
130)
(= __@x0
(Bug2374.Mkr1 (Bug2374.Mkr1_a __@x0)))))

; </end constructor Bug2374.Mkr1>


; </end encoding type Bug2374.r1>


; encoding sigelt assume Bug2374.r1__uu___haseq


; <Start encoding assume Bug2374.r1__uu___haseq>


; </end encoding assume Bug2374.r1__uu___haseq>


; encoding sigelt val Bug2374.__proj__Mkr1__item__a


; <Start encoding val Bug2374.__proj__Mkr1__item__a>

(declare-fun Bug2374.__proj__Mkr1__item__a (Term) Term)
;;;;;;;;;;;;;;;;projectee: r1 -> Prims.bool
(declare-fun Tm_arrow_98d928801392b46249fbc437383de48b () Term)
(declare-fun Bug2374.__proj__Mkr1__item__a@tok () Term)

; </end encoding val Bug2374.__proj__Mkr1__item__a>


; encoding sigelt let __proj__Mkr1__item__a


; <Skipped let __proj__Mkr1__item__a/>


; encoding sigelt type Bug2374.r2


; <Start encoding type Bug2374.r2>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2374.r2 () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug2374.Mkr2 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug2374.Mkr2_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug2374.Mkr2
(declare-fun Bug2374.Mkr2@tok () Term)
;;;;;;;;;;;;;;;;a: Prims.bool -> r2
(declare-fun Tm_arrow_f951deba7b08130508f51c6867eac72e () Term)

; <start constructor Bug2374.r2>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2374.r2 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
156)
(= __@x0
Bug2374.r2)))

; </end constructor Bug2374.r2>


; <start constructor Bug2374.Mkr2>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug2374.Mkr2 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
162)
(= __@x0
(Bug2374.Mkr2 (Bug2374.Mkr2_a __@x0)))))

; </end constructor Bug2374.Mkr2>


; </end encoding type Bug2374.r2>


; encoding sigelt assume Bug2374.r2__uu___haseq


; <Start encoding assume Bug2374.r2__uu___haseq>


; </end encoding assume Bug2374.r2__uu___haseq>


; encoding sigelt val Bug2374.__proj__Mkr2__item__a


; <Start encoding val Bug2374.__proj__Mkr2__item__a>

(declare-fun Bug2374.__proj__Mkr2__item__a (Term) Term)
;;;;;;;;;;;;;;;;projectee: r2 -> Prims.bool
(declare-fun Tm_arrow_c52f2ffcbd2e082ed75259adb0b7620c () Term)
(declare-fun Bug2374.__proj__Mkr2__item__a@tok () Term)

; </end encoding val Bug2374.__proj__Mkr2__item__a>


; encoding sigelt let __proj__Mkr2__item__a


; <Skipped let __proj__Mkr2__item__a/>


; encoding sigelt let r1_refined


; <Start encoding let r1_refined>

(declare-fun Bug2374.r1_refined () Term)
(declare-fun Tm_refine_d4eb83f08922a94cef40cb25011fc2e4 () Term)

; </end encoding let r1_refined>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2374.__proj__Mkr1__item__a; Namespace Bug2374
(assert (! 
;; def=Bug2374.fst(3,12-3,13); use=Bug2374.fst(3,12-3,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug2374.r1)
(HasType (Bug2374.__proj__Mkr1__item__a @x0)
Prims.bool))
 

:pattern ((Bug2374.__proj__Mkr1__item__a @x0))
:qid typing_Bug2374.__proj__Mkr1__item__a))

:named typing_Bug2374.__proj__Mkr1__item__a))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug2374.r1; Namespace Bug2374; Name Bug2374.Mkr1; Namespace Bug2374
(assert (! 
;; def=Bug2374.fst(3,5-3,7); use=Bug2374.fst(3,5-3,7)
...
(Bug2374.Mkr1 @x1)
Bug2374.r1))
:qid subterm_ordering_Bug2374.Mkr1))

:named subterm_ordering_Bug2374.Mkr1))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug2374.r1_refined; Namespace Bug2374
(assert (! (HasType Tm_refine_d4eb83f08922a94cef40cb25011fc2e4
Tm_type)
:named refinement_kinding_Tm_refine_d4eb83f08922a94cef40cb25011fc2e4))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Bug2374.r1_refined; Namespace Bug2374
(assert (! 
;; def=Bug2374.fst(5,17-5,34); use=Bug2374.fst(5,17-5,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_d4eb83f08922a94cef40cb25011fc2e4)
(and (HasTypeFuel @u0
@x1
Bug2374.r1)

;; def=Bug2374.fst(5,22-5,33); use=Bug2374.fst(5,22-5,33)
(= (Bug2374.__proj__Mkr1__item__a @x1)
(BoxBool true))
))
...
@x1
Tm_refine_d4eb83f08922a94cef40cb25011fc2e4))
:qid refinement_interpretation_Tm_refine_d4eb83f08922a94cef40cb25011fc2e4))

:named refinement_interpretation_Tm_refine_d4eb83f08922a94cef40cb25011fc2e4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
...
;; def=Bug2374.fst(3,5-3,7); use=Bug2374.fst(3,5-3,7)
(forall ((@x0 Term))
 (! (= (Bug2374.Mkr1_a (Bug2374.Mkr1 @x0))
@x0)
 

:pattern ((Bug2374.Mkr1 @x0))
:qid projection_inverse_Bug2374.Mkr1_a))

:named projection_inverse_Bug2374.Mkr1_a))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug2374.__proj__Mkr1__item__a; Namespace Bug2374
(assert (! 
;; def=Bug2374.fst(3,12-3,13); use=Bug2374.fst(3,12-3,13)
(forall ((@x0 Term))
 (! (= (Bug2374.__proj__Mkr1__item__a @x0)
(Bug2374.Mkr1_a @x0))
 

:pattern ((Bug2374.__proj__Mkr1__item__a @x0))
:qid proj_equation_Bug2374.Mkr1_a))

:named proj_equation_Bug2374.Mkr1_a))
;;; Fact-ids: Name Bug2374.r1; Namespace Bug2374; Name Bug2374.Mkr1; Namespace Bug2374
(assert (! (HasType Bug2374.r1
Tm_type)
:named kinding_Bug2374.r1@tok))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_d4eb83f08922a94cef40cb25011fc2e4
;;; Fact-ids: Name Bug2374.r1_refined; Namespace Bug2374
(assert (! (iff (Valid (Prims.hasEq Tm_refine_d4eb83f08922a94cef40cb25011fc2e4))
(Valid (Prims.hasEq Bug2374.r1)))
:named haseqTm_refine_d4eb83f08922a94cef40cb25011fc2e4))
...
@x1
Bug2374.r1))
:qid fuel_guarded_inversion_Bug2374.r1))

:named fuel_guarded_inversion_Bug2374.r1))
...
(Bug2374.Mkr1 @x1)
Bug2374.r1))
:qid data_typing_intro_Bug2374.Mkr1@tok))

:named data_typing_intro_Bug2374.Mkr1@tok))
...
(Bug2374.Mkr1 @x1)
Bug2374.r1))
:qid data_elim_Bug2374.Mkr1))

:named data_elim_Bug2374.Mkr1))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Bug2374.r1; Namespace Bug2374; Name Bug2374.Mkr1; Namespace Bug2374
(assert (! (= 124
(Term_constr_id Bug2374.r1))
:named constructor_distinct_Bug2374.r1))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug2374.r1; Namespace Bug2374; Name Bug2374.Mkr1; Namespace Bug2374
(assert (! 
;; def=Bug2374.fst(3,5-3,7); use=Bug2374.fst(3,5-3,7)
(forall ((@x0 Term))
 (! (= 130
(Term_constr_id (Bug2374.Mkr1 @x0)))
 

:pattern ((Bug2374.Mkr1 @x0))
:qid constructor_distinct_Bug2374.Mkr1))

:named constructor_distinct_Bug2374.Mkr1))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
;;;;;;;;;;;;;;;;Assumption: Bug2374.r1__uu___haseq
;;; Fact-ids: Name Bug2374.r1__uu___haseq; Namespace Bug2374
(assert (! (Valid (Prims.hasEq Bug2374.r1))
:named assumption_Bug2374.r1__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Bug2374.r1))
:qid Bug2374_pretyping_ecd72c2943291514fc78583b7d603e45))

:named Bug2374_pretyping_ecd72c2943291514fc78583b7d603e45))
(push) ;; push{2

; Starting query at Bug2374.fst(8,2-8,14)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Prims.unit). (*  - Could not prove post-condition
; *) (Bug2374.Mkr1 true).a == true


; Context: While encoding a query
; While typechecking the top-level declaration `let test_refine_1`
...
;; def=Bug2374.fst(5,22-5,33); use=Bug2374.fst(8,2-8,14)
(or label_1

;; def=Bug2374.fst(5,22-5,33); use=Bug2374.fst(8,2-8,14)
(= (Bug2374.__proj__Mkr1__item__a (Bug2374.Mkr1 (BoxBool true)))
(BoxBool true))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2374.test_refine_1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, proj_equation_Bug2374.Mkr1_a, projection_inverse_Bug2374.Mkr1_a
...
; encoding sigelt let test_refine_1


; <Start encoding let test_refine_1>

(declare-fun Bug2374.test_refine_1 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> r1_refined
(declare-fun Tm_arrow_dfdeccbb14f77d5e7ce8a0c086ed9ce0 () Term)
(declare-fun Bug2374.test_refine_1@tok () Term)

; </end encoding let test_refine_1>

(push) ;; push{2

; Starting query at Bug2374.fst(11,2-11,20)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let test_refine_1_fix`
...
;; def=Bug2374.fst(5,22-5,33); use=Bug2374.fst(11,4-11,12)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2374.test_refine_1_fix, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, proj_equation_Bug2374.Mkr1_a, projection_inverse_Bug2374.Mkr1_a
...
; encoding sigelt let test_refine_1_fix


; <Start encoding let test_refine_1_fix>

(declare-fun Bug2374.test_refine_1_fix (Term) Term)

(declare-fun Bug2374.test_refine_1_fix@tok () Term)

; </end encoding let test_refine_1_fix>


; encoding sigelt let test_refine_2


; <Start encoding let test_refine_2>

(declare-fun Bug2374.test_refine_2 (Term) Term)
;;;;;;;;;;;;;;;;x: r1_refined -> Prims.bool
(declare-fun Tm_arrow_0ba31623a707025ed10a32e6ed451f11 () Term)
(declare-fun Bug2374.test_refine_2@tok () Term)

; </end encoding let test_refine_2>


; encoding sigelt let test_refine_2_fix


; <Start encoding let test_refine_2_fix>

(declare-fun Bug2374.test_refine_2_fix (Term) Term)

(declare-fun Bug2374.test_refine_2_fix@tok () Term)

; </end encoding let test_refine_2_fix>
...
(declare-fun Bug2374.r1_refined_ () Term)
(declare-fun Tm_refine_ab85577fb0a651b3e2a063a0e341f34d () Term)

; </end encoding let r1_refined'>

(push) ;; push{2

; Starting query at Bug2374.fst(23,2-23,14)
...
; *)
;   (Bug2374.Mkr1 true).a == true /\ (Bug2374.Mkr1 true).a == true
...
;; def=Bug2374.fst(5,22-20,42); use=Bug2374.fst(23,2-23,14)
(and 
;; def=Bug2374.fst(5,22-5,33); use=Bug2374.fst(23,2-23,14)
(or label_1
...
;; def=Bug2374.fst(20,31-20,42); use=Bug2374.fst(23,2-23,14)
(or label_2
...
(declare-fun Bug2374.test_refine_1_ (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> r1_refined'
(declare-fun Tm_arrow_ca86f11f90a0c076813b25b6617a0e98 () Term)
(declare-fun Bug2374.test_refine_1_@tok () Term)
...
(declare-fun Bug2374.test_refine_2_ (Term) Term)
;;;;;;;;;;;;;;;;x: r1_refined' -> Prims.bool
(declare-fun Tm_arrow_a9837a8c9cbd46f1a9346e580dbad1e2 () Term)
(declare-fun Bug2374.test_refine_2_@tok () Term)

; </end encoding let test_refine_2'>

(push) ;; push{2

; Starting query at Bug2374.fst(30,2-30,14)
...
;; def=Bug2374.fst(5,22-20,42); use=Bug2374.fst(30,2-30,14)
(and 
;; def=Bug2374.fst(5,22-5,33); use=Bug2374.fst(30,2-30,14)
(or label_1
...
;; def=Bug2374.fst(20,31-20,42); use=Bug2374.fst(30,2-30,14)
(or label_2
