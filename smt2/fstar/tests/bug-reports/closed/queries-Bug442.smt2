...
; encoding sigelt type Bug442.dList1


; <Start encoding type Bug442.dList1>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug442.dList1 (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug442.dList1@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug442.Nil (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug442.Nil__t (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug442.Nil
(declare-fun Bug442.Nil@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug442.Unit (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug442.Unit__t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug442.Unit__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug442.Unit
(declare-fun Bug442.Unit@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug442.Join (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug442.Join__t (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug442.Join__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug442.Join__1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug442.Join__2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug442.Join
(declare-fun Bug442.Join@tok () Term)
;;;;;;;;;;;;;;;;dList1 't
(declare-fun Tm_arrow_635d64d5eebc9f541f5ac05ee46c9d7b () Term)
;;;;;;;;;;;;;;;;_0: 't -> dList1 't
(declare-fun Tm_arrow_dba9d7e4a89f18773b6b1fde5494e787 () Term)
;;;;;;;;;;;;;;;;_0: dList1 't -> _1: dList1 't -> _2: Prims.nat -> dList1 't
(declare-fun Tm_arrow_fa7814c3601c16254a7d56f293060452 () Term)

; <start constructor Bug442.dList1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug442.dList1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
125)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-Bug442.dList1))))

; </end constructor Bug442.dList1>


; <start constructor Bug442.Nil>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug442.Nil ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
132)
(= __@x0
(Bug442.Nil (Bug442.Nil__t __@x0)))))

; </end constructor Bug442.Nil>


; <start constructor Bug442.Unit>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug442.Unit ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
137)
(= __@x0
(Bug442.Unit (Bug442.Unit__t __@x0)
(Bug442.Unit__0 __@x0)))))

; </end constructor Bug442.Unit>


; <start constructor Bug442.Join>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug442.Join ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
142)
(= __@x0
(Bug442.Join (Bug442.Join__t __@x0)
(Bug442.Join__0 __@x0)
(Bug442.Join__1 __@x0)
(Bug442.Join__2 __@x0)))))

; </end constructor Bug442.Join>


; </end encoding type Bug442.dList1>
...
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(20,5-20,11); use=Bug442.fst(20,5-20,11)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug442.dList1@tok
@x0)
(Bug442.dList1 @x0))
 

:pattern ((ApplyTT Bug442.dList1@tok
@x0))

:pattern ((Bug442.dList1 @x0))
:qid token_correspondence_Bug442.dList1@tok))

:named token_correspondence_Bug442.dList1@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
...
@x2)
(Bug442.dList1 @x3)))
:qid subterm_ordering_Bug442.Unit))

:named subterm_ordering_Bug442.Unit))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
...
@x4)
(Bug442.dList1 @x5)))
:qid subterm_ordering_Bug442.Join))

:named subterm_ordering_Bug442.Join))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug442.Unit__t (Bug442.Unit @x0
@x1))
@x0)
 

:pattern ((Bug442.Unit @x0
@x1))
:qid projection_inverse_Bug442.Unit__t))

:named projection_inverse_Bug442.Unit__t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug442.Unit__0 (Bug442.Unit @x0
@x1))
@x1)
...
:pattern ((Bug442.Unit @x0
@x1))
:qid projection_inverse_Bug442.Unit__0))

:named projection_inverse_Bug442.Unit__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(21,6-21,9); use=Bug442.fst(21,6-21,9)
(forall ((@x0 Term))
 (! (= (Bug442.Nil__t (Bug442.Nil @x0))
@x0)
 

:pattern ((Bug442.Nil @x0))
:qid projection_inverse_Bug442.Nil__t))

:named projection_inverse_Bug442.Nil__t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug442.Join__t (Bug442.Join @x0
@x1
@x2
@x3))
@x0)
...
:pattern ((Bug442.Join @x0
@x1
@x2
@x3))
:qid projection_inverse_Bug442.Join__t))

:named projection_inverse_Bug442.Join__t))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug442.Join__2 (Bug442.Join @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_Bug442.Join__2))

:named projection_inverse_Bug442.Join__2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug442.Join__1 (Bug442.Join @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Bug442.Join__1))

:named projection_inverse_Bug442.Join__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug442.Join__0 (Bug442.Join @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Bug442.Join__0))

:named projection_inverse_Bug442.Join__0))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! (is-Tm_arrow (PreType Bug442.dList1@tok))
:named pre_kinding_Bug442.dList1@tok))
...
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! (and (IsTotFun Bug442.dList1@tok)

;; def=Bug442.fst(20,5-20,11); use=Bug442.fst(20,5-20,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Bug442.dList1 @x0)
Tm_type))
 

:pattern ((Bug442.dList1 @x0))
:qid kinding_Bug442.dList1@tok))
)
:named kinding_Bug442.dList1@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
@x1
(Bug442.dList1 @x2))
(or (and (is-Bug442.Nil @x1)
(= @x2
(Bug442.Nil__t @x1)))
(and (is-Bug442.Unit @x1)
(= @x2
(Bug442.Unit__t @x1)))
(and (is-Bug442.Join @x1)
(= @x2
(Bug442.Join__t @x1)))))
...
@x1
(Bug442.dList1 @x2)))
:qid fuel_guarded_inversion_Bug442.dList1))

:named fuel_guarded_inversion_Bug442.dList1))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! (= 126
(Term_constr_id Bug442.dList1@tok))
:named fresh_token_Bug442.dList1@tok))
...
@x2)
(Bug442.dList1 @x1)))
:qid data_typing_intro_Bug442.Unit@tok))

:named data_typing_intro_Bug442.Unit@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(21,6-21,9); use=Bug442.fst(21,6-21,9)
...
(Bug442.Nil @x1)
(Bug442.dList1 @x1)))
:qid data_typing_intro_Bug442.Nil@tok))

:named data_typing_intro_Bug442.Nil@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
...
@x4)
(Bug442.dList1 @x1)))
:qid data_typing_intro_Bug442.Join@tok))

:named data_typing_intro_Bug442.Join@tok))
...
@x2)
(Bug442.dList1 @x3)))
:qid data_elim_Bug442.Unit))

:named data_elim_Bug442.Unit))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(21,6-21,9); use=Bug442.fst(21,6-21,9)
...
(Bug442.Nil @x1)
(Bug442.dList1 @x2)))
:qid data_elim_Bug442.Nil))

:named data_elim_Bug442.Nil))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
...
@x4)
(Bug442.dList1 @x5)))
:qid data_elim_Bug442.Join))

:named data_elim_Bug442.Join))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 125
(Term_constr_id (Bug442.dList1 @x0)))
 

:pattern ((Bug442.dList1 @x0))
:qid constructor_distinct_Bug442.dList1))

:named constructor_distinct_Bug442.dList1))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= 137
(Term_constr_id (Bug442.Unit @x0
@x1)))
 

:pattern ((Bug442.Unit @x0
@x1))
:qid constructor_distinct_Bug442.Unit))

:named constructor_distinct_Bug442.Unit))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(21,6-21,9); use=Bug442.fst(21,6-21,9)
(forall ((@x0 Term))
 (! (= 132
(Term_constr_id (Bug442.Nil @x0)))
 

:pattern ((Bug442.Nil @x0))
:qid constructor_distinct_Bug442.Nil))

:named constructor_distinct_Bug442.Nil))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
...
@x2
@x3))
:qid constructor_distinct_Bug442.Join))

:named constructor_distinct_Bug442.Join))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
(Bug442.dList1 @x2)))
:qid Bug442_pretyping_9af0c670938d9b125bcc7f038d3b7e84))

:named Bug442_pretyping_9af0c670938d9b125bcc7f038d3b7e84))
(push) ;; push{4

; Starting query at Bug442.fst(20,0-23,55)
...
;   Prims.hasEq 't /\
;   (forall ('t: Type). {:pattern Prims.hasEq (Bug442.dList1 't)}
;       Prims.hasEq 't ==> Prims.hasEq (Bug442.dList1 't)) ==>
;   (forall (_0: 't).
...
; *)
;       Prims.hasEq 't) /\
;   (forall (_0: Bug442.dList1 't) (_1: Bug442.dList1 't) (_2: Prims.nat).
;       Prims.hasEq (Bug442.dList1 't) /\ Prims.hasEq (Bug442.dList1 't) /\ Prims.hasEq Prims.nat)


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug442.dList1`
...
;; def=Bug442.fst(20,0-23,55); use=Bug442.fst(20,0-23,55)
(Valid 
;; def=Bug442.fst(20,0-23,55); use=Bug442.fst(20,0-23,55)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=Bug442.fst(20,0-23,55); use=Bug442.fst(20,0-23,55)
(Prims.hasEq (Bug442.dList1 @x1))
)
)
 

:pattern ((Prims.hasEq (Bug442.dList1 @x1)))
:qid @query.1))
)
...
;; def=Bug442.fst(20,0-23,55); use=Bug442.fst(22,13-22,15)
(or label_1
...
;; def=Bug442.fst(20,0-23,55); use=Bug442.fst(20,0-23,55)
(and 
;; def=Bug442.fst(20,0-23,55); use=Bug442.fst(23,13-23,22)
(or label_2

;; def=Bug442.fst(20,0-23,55); use=Bug442.fst(20,0-23,55)
(Valid 
;; def=Bug442.fst(20,0-23,55); use=Bug442.fst(20,0-23,55)
(Prims.hasEq (Bug442.dList1 @x0))
)
)


;; def=Bug442.fst(20,0-23,55); use=Bug442.fst(23,26-23,35)
(or label_3
...
;; def=Bug442.fst(20,0-23,55); use=Bug442.fst(23,39-23,42)
(or label_4
...
; encoding sigelt assume Bug442.dList1__uu___haseq


; <Start encoding assume Bug442.dList1__uu___haseq>


; </end encoding assume Bug442.dList1__uu___haseq>


; encoding sigelt val Bug442.uu___is_Nil


; <Start encoding val Bug442.uu___is_Nil>

(declare-fun Bug442.uu___is_Nil (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: dList1 't -> Prims.bool
(declare-fun Tm_arrow_e5a753eec25eedf56d894bb126bd4665 () Term)
(declare-fun Bug442.uu___is_Nil@tok () Term)

; </end encoding val Bug442.uu___is_Nil>
...
; encoding sigelt val Bug442.uu___is_Unit


; <Start encoding val Bug442.uu___is_Unit>

(declare-fun Bug442.uu___is_Unit (Term Term) Term)

(declare-fun Bug442.uu___is_Unit@tok () Term)

; </end encoding val Bug442.uu___is_Unit>
...
; encoding sigelt val Bug442.__proj__Unit__item___0


; <Start encoding val Bug442.__proj__Unit__item___0>

(declare-fun Tm_refine_282d2343f4d149a96e73dfb3e3022a06 (Term) Term)
(declare-fun Bug442.__proj__Unit__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: dList1 't {Unit? _} -> 't
(declare-fun Tm_arrow_1b89e0ca77ea2a2851d11e998905737e () Term)
(declare-fun Bug442.__proj__Unit__item___0@tok () Term)

; </end encoding val Bug442.__proj__Unit__item___0>
...
:named typing_FStar.Monotonic.Heap.core_mref))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug442.uu___is_Unit; Namespace Bug442
(assert (! 
;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Bug442.dList1 @x0)))
(HasType (Bug442.uu___is_Unit @x0
@x1)
Prims.bool))
 

:pattern ((Bug442.uu___is_Unit @x0
@x1))
:qid typing_Bug442.uu___is_Unit))

:named typing_Bug442.uu___is_Unit))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug442.dList1; Namespace Bug442; Name Bug442.Nil; Namespace Bug442; Name Bug442.Unit; Namespace Bug442; Name Bug442.Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(20,5-20,11); use=Bug442.fst(20,5-20,11)
...
:named refinement_kinding_Tm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug442.__proj__Unit__item___0; Namespace Bug442
(assert (! 
;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_282d2343f4d149a96e73dfb3e3022a06 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_282d2343f4d149a96e73dfb3e3022a06 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_282d2343f4d149a96e73dfb3e3022a06))

:named refinement_kinding_Tm_refine_282d2343f4d149a96e73dfb3e3022a06))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! (HasType Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_282d2343f4d149a96e73dfb3e3022a06 @x2))
(and (HasTypeFuel @u0
@x1
(Bug442.dList1 @x2))

;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
(BoxBool_proj_0 (Bug442.uu___is_Unit @x2
@x1))
))
...
@x1
(Tm_refine_282d2343f4d149a96e73dfb3e3022a06 @x2)))
:qid refinement_interpretation_Tm_refine_282d2343f4d149a96e73dfb3e3022a06))

:named refinement_interpretation_Tm_refine_282d2343f4d149a96e73dfb3e3022a06))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
;; def=Prims.fst(686,15-686,29); use=Prims.fst(686,15-686,29)
...
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_282d2343f4d149a96e73dfb3e3022a06
;;; Fact-ids: Name Bug442.__proj__Unit__item___0; Namespace Bug442
(assert (! 
;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_282d2343f4d149a96e73dfb3e3022a06 @x0)))
(Valid (Prims.hasEq (Bug442.dList1 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_282d2343f4d149a96e73dfb3e3022a06 @x0))))
:qid haseqTm_refine_282d2343f4d149a96e73dfb3e3022a06))

:named haseqTm_refine_282d2343f4d149a96e73dfb3e3022a06))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f))
(Valid (Prims.hasEq Prims.int)))
...
;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug442.uu___is_Unit @x0
@x1)
(BoxBool (is-Bug442.Unit @x1)))
 

:pattern ((Bug442.uu___is_Unit @x0
@x1))
:qid disc_equation_Bug442.Unit))

:named disc_equation_Bug442.Unit))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: Bug442.dList1__uu___haseq
;;; Fact-ids: Name Bug442.dList1__uu___haseq; Namespace Bug442
...
:pattern ((Prims.hasEq (Bug442.dList1 @x0)))
:qid assumption_Bug442.dList1__uu___haseq))
:named assumption_Bug442.dList1__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Encoding query formula : forall ('t: Type) (projectee: _: Bug442.dList1 't {Unit? _}).
;   (*  - Could not prove post-condition
; *) ~(Unit? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Unit__item___0`
...
Tm_type)
(HasType @x1
(Tm_refine_282d2343f4d149a96e73dfb3e3022a06 @x0))

;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
(not 
;; def=Bug442.fst(22,6-22,10); use=Bug442.fst(22,6-22,10)
(BoxBool_proj_0 (Bug442.uu___is_Unit @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug442.__proj__Unit__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_282d2343f4d149a96e73dfb3e3022a06
...
; encoding sigelt let __proj__Unit__item___0


; <Skipped let __proj__Unit__item___0/>


; encoding sigelt val Bug442.uu___is_Join


; <Start encoding val Bug442.uu___is_Join>

(declare-fun Bug442.uu___is_Join (Term Term) Term)

(declare-fun Bug442.uu___is_Join@tok () Term)

; </end encoding val Bug442.uu___is_Join>


; encoding sigelt let uu___is_Join


; <Skipped let uu___is_Join/>


; encoding sigelt val Bug442.__proj__Join__item___0


; <Start encoding val Bug442.__proj__Join__item___0>

(declare-fun Tm_refine_55d37cc4215d7c096ad6f1e75c907170 (Term) Term)
(declare-fun Bug442.__proj__Join__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: dList1 't {Join? _} -> dList1 't
(declare-fun Tm_arrow_7678873cc9f94773f6c7cb9db1a1effc () Term)
(declare-fun Bug442.__proj__Join__item___0@tok () Term)

; </end encoding val Bug442.__proj__Join__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug442.uu___is_Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Bug442.dList1 @x0)))
(HasType (Bug442.uu___is_Join @x0
@x1)
Prims.bool))
 

:pattern ((Bug442.uu___is_Join @x0
@x1))
:qid typing_Bug442.uu___is_Join))

:named typing_Bug442.uu___is_Join))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug442.__proj__Join__item___0; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_55d37cc4215d7c096ad6f1e75c907170 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_55d37cc4215d7c096ad6f1e75c907170 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_55d37cc4215d7c096ad6f1e75c907170))

:named refinement_kinding_Tm_refine_55d37cc4215d7c096ad6f1e75c907170))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug442.__proj__Join__item___0; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_55d37cc4215d7c096ad6f1e75c907170 @x2))
(and (HasTypeFuel @u0
@x1
(Bug442.dList1 @x2))

;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(BoxBool_proj_0 (Bug442.uu___is_Join @x2
@x1))
))
...
@x1
(Tm_refine_55d37cc4215d7c096ad6f1e75c907170 @x2)))
:qid refinement_interpretation_Tm_refine_55d37cc4215d7c096ad6f1e75c907170))

:named refinement_interpretation_Tm_refine_55d37cc4215d7c096ad6f1e75c907170))
;;;;;;;;;;;;;;;;haseq for Tm_refine_55d37cc4215d7c096ad6f1e75c907170
;;; Fact-ids: Name Bug442.__proj__Join__item___0; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_55d37cc4215d7c096ad6f1e75c907170 @x0)))
(Valid (Prims.hasEq (Bug442.dList1 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_55d37cc4215d7c096ad6f1e75c907170 @x0))))
:qid haseqTm_refine_55d37cc4215d7c096ad6f1e75c907170))

:named haseqTm_refine_55d37cc4215d7c096ad6f1e75c907170))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug442.uu___is_Join; Namespace Bug442
(assert (! 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug442.uu___is_Join @x0
@x1)
(BoxBool (is-Bug442.Join @x1)))
 

:pattern ((Bug442.uu___is_Join @x0
@x1))
:qid disc_equation_Bug442.Join))

:named disc_equation_Bug442.Join))
(push) ;; push{2
...
; Encoding query formula : forall ('t: Type) (projectee: _: Bug442.dList1 't {Join? _}).
;   (*  - Could not prove post-condition
; *) ~(Join? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Join__item___0`
...
Tm_type)
(HasType @x1
(Tm_refine_55d37cc4215d7c096ad6f1e75c907170 @x0))

;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(not 
;; def=Bug442.fst(23,6-23,10); use=Bug442.fst(23,6-23,10)
(BoxBool_proj_0 (Bug442.uu___is_Join @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug442.__proj__Join__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_55d37cc4215d7c096ad6f1e75c907170
...
; encoding sigelt let __proj__Join__item___0


; <Skipped let __proj__Join__item___0/>


; encoding sigelt val Bug442.__proj__Join__item___1


; <Start encoding val Bug442.__proj__Join__item___1>


(declare-fun Bug442.__proj__Join__item___1 (Term Term) Term)


(declare-fun Bug442.__proj__Join__item___1@tok () Term)

; </end encoding val Bug442.__proj__Join__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Join__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug442.__proj__Join__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_55d37cc4215d7c096ad6f1e75c907170
...
; encoding sigelt let __proj__Join__item___1


; <Skipped let __proj__Join__item___1/>


; encoding sigelt val Bug442.__proj__Join__item___2


; <Start encoding val Bug442.__proj__Join__item___2>


(declare-fun Bug442.__proj__Join__item___2 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: dList1 't {Join? _} -> Prims.nat
(declare-fun Tm_arrow_b9b9dc603b34638bcac179986b89f9a8 () Term)
(declare-fun Bug442.__proj__Join__item___2@tok () Term)

; </end encoding val Bug442.__proj__Join__item___2>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Join__item___2`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug442.__proj__Join__item___2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_55d37cc4215d7c096ad6f1e75c907170
...
; encoding sigelt let __proj__Join__item___2


; <Skipped let __proj__Join__item___2/>


; encoding sigelt val Bug442.isCorrectJoined


; <Skipped val Bug442.isCorrectJoined/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug442.uu___is_Nil; Namespace Bug442
(assert (! 
;; def=Bug442.fst(21,6-21,9); use=Bug442.fst(21,6-21,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Bug442.dList1 @x0)))
(HasType (Bug442.uu___is_Nil @x0
@x1)
Prims.bool))
 

:pattern ((Bug442.uu___is_Nil @x0
@x1))
:qid typing_Bug442.uu___is_Nil))

:named typing_Bug442.uu___is_Nil))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug442.__proj__Join__item___0; Namespace Bug442
...
(HasType @x1
(Tm_refine_55d37cc4215d7c096ad6f1e75c907170 @x0)))
(HasType (Bug442.__proj__Join__item___0 @x0
@x1)
(Bug442.dList1 @x0)))
 

:pattern ((Bug442.__proj__Join__item___0 @x0
@x1))
:qid typing_Bug442.__proj__Join__item___0))
:named typing_Bug442.__proj__Join__item___0))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;; Fact-ids: Name Bug442.__proj__Join__item___0; Namespace Bug442
(assert (! (forall ((@x0 Term) (@x1 Term))
 (! (= (Bug442.__proj__Join__item___0 @x0
@x1)
(Bug442.Join__0 @x1))
...
:pattern ((Bug442.__proj__Join__item___0 @x0
@x1))
:qid proj_equation_Bug442.Join__0))
:named proj_equation_Bug442.Join__0))
...
;; def=Bug442.fst(21,6-21,9); use=Bug442.fst(21,6-21,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug442.uu___is_Nil @x0
@x1)
(BoxBool (is-Bug442.Nil @x1)))
 

:pattern ((Bug442.uu___is_Nil @x0
@x1))
:qid disc_equation_Bug442.Nil))

:named disc_equation_Bug442.Nil))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
; Starting query at Bug442.fst(27,4-31,58)
...
;;;;;;;;;;;;;;;;l : Bug442.dList1 't (Bug442.dList1 't)
(declare-fun x_edd6cb1544aa88ef8c834760793a3a13_2 () Term)
;;;;;;;;;;;;;;;;binder_x_edd6cb1544aa88ef8c834760793a3a13_2
;;; Fact-ids: 
(assert (! (HasType x_edd6cb1544aa88ef8c834760793a3a13_2
(Bug442.dList1 x_fe28d8bcde588226b4e538b35321de05_1))
:named binder_x_edd6cb1544aa88ef8c834760793a3a13_2))
(declare-fun Tm_refine_03bc8bdd211e5afdd60c682ec25f2896 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(25,22-31,58); use=Bug442.fst(25,22-31,58)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_03bc8bdd211e5afdd60c682ec25f2896 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_03bc8bdd211e5afdd60c682ec25f2896 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_03bc8bdd211e5afdd60c682ec25f2896))

:named refinement_kinding_Tm_refine_03bc8bdd211e5afdd60c682ec25f2896))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(25,22-31,58); use=Bug442.fst(25,22-31,58)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_03bc8bdd211e5afdd60c682ec25f2896 @x2))
(and (HasTypeFuel @u0
@x1
(Bug442.dList1 @x2))

;; def=Bug442.fst(27,4-31,58); use=Bug442.fst(27,4-31,58)

;; def=Bug442.fst(27,4-31,58); use=Bug442.fst(27,4-31,58)
(Valid 
;; def=Bug442.fst(27,4-31,58); use=Bug442.fst(27,4-31,58)
(Prims.precedes (Bug442.dList1 @x2)
(Bug442.dList1 x_fe28d8bcde588226b4e538b35321de05_1)
@x1
x_edd6cb1544aa88ef8c834760793a3a13_2)
)
...
@x1
(Tm_refine_03bc8bdd211e5afdd60c682ec25f2896 @x2)))
:qid refinement_interpretation_Tm_refine_03bc8bdd211e5afdd60c682ec25f2896))

:named refinement_interpretation_Tm_refine_03bc8bdd211e5afdd60c682ec25f2896))
;;;;;;;;;;;;;;;;haseq for Tm_refine_03bc8bdd211e5afdd60c682ec25f2896
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(25,22-31,58); use=Bug442.fst(25,22-31,58)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_03bc8bdd211e5afdd60c682ec25f2896 @x0)))
(Valid (Prims.hasEq (Bug442.dList1 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_03bc8bdd211e5afdd60c682ec25f2896 @x0))))
:qid haseqTm_refine_03bc8bdd211e5afdd60c682ec25f2896))

:named haseqTm_refine_03bc8bdd211e5afdd60c682ec25f2896))
(declare-fun Bug442.isCorrectJoined (Term Term) Term)

;;;;;;;;;;;;;;;;l: dList1 't {l << l} -> Prims.bool
(declare-fun Tm_arrow_90fba667854df7b511441aaf86de7e94 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_90fba667854df7b511441aaf86de7e94
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_90fba667854df7b511441aaf86de7e94
Tm_type)
:named kinding_Tm_arrow_90fba667854df7b511441aaf86de7e94))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(25,22-31,58); use=Bug442.fst(25,22-31,58)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_90fba667854df7b511441aaf86de7e94)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_90fba667854df7b511441aaf86de7e94))
:qid Bug442_pre_typing_Tm_arrow_90fba667854df7b511441aaf86de7e94))

:named Bug442_pre_typing_Tm_arrow_90fba667854df7b511441aaf86de7e94))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_90fba667854df7b511441aaf86de7e94
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(25,22-31,58); use=Bug442.fst(25,22-31,58)
(forall ((@x0 Term))
...
Tm_type)
(HasType @x2
(Tm_refine_03bc8bdd211e5afdd60c682ec25f2896 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
Prims.bool))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_90fba667854df7b511441aaf86de7e94.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_90fba667854df7b511441aaf86de7e94.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_90fba667854df7b511441aaf86de7e94))
:qid Bug442_interpretation_Tm_arrow_90fba667854df7b511441aaf86de7e94))

:named Bug442_interpretation_Tm_arrow_90fba667854df7b511441aaf86de7e94))
(declare-fun Bug442.isCorrectJoined@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(26,8-26,23); use=Bug442.fst(26,8-26,23)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug442.isCorrectJoined@tok
@x0)
@x1)
(Bug442.isCorrectJoined @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Bug442.isCorrectJoined@tok
@x0)
@x1))
:qid token_correspondence_Bug442.isCorrectJoined))

:named token_correspondence_Bug442.isCorrectJoined))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(26,8-26,23); use=Bug442.fst(26,8-26,23)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Bug442.isCorrectJoined@tok
Tm_arrow_90fba667854df7b511441aaf86de7e94))
...
@x1)
@x2)
(Bug442.isCorrectJoined @x1
@x2))
 

:pattern ((Bug442.isCorrectJoined @x1
@x2))
:qid function_token_typing_Bug442.isCorrectJoined.1))
)
 

:pattern ((ApplyTT @x0
Bug442.isCorrectJoined@tok))
:qid function_token_typing_Bug442.isCorrectJoined))

:named function_token_typing_Bug442.isCorrectJoined))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(26,8-26,23); use=Bug442.fst(26,8-26,23)
...
Tm_type)
(HasType @x1
(Tm_refine_03bc8bdd211e5afdd60c682ec25f2896 @x0)))
(HasType (Bug442.isCorrectJoined @x0
@x1)
Prims.bool))
 

:pattern ((Bug442.isCorrectJoined @x0
@x1))
:qid typing_Bug442.isCorrectJoined))

:named typing_Bug442.isCorrectJoined))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(Nil? l) /\ ~(Unit? l) /\ ~(Join? l && Nil? l._0) /\ ~(Join? l) ==> Prims.l_False) /\
;   (~(Nil? l) ==>
;     ~(Unit? l) ==>
;     ~(Join? l && Nil? l._0) ==>
;     (forall (b: Bug442.dList1 't) (b: Bug442.dList1 't) (b: Prims.nat).
;         l == Bug442.Join b b b ==> b << l /\ (Bug442.isCorrectJoined b ==> b << l)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec isCorrectJoined`
...
;; def=Prims.fst(402,27-402,88); use=Bug442.fst(27,4-31,58)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(27,4-31,58)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(27,4-31,58)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(27,4-31,58)
(and (implies 
;; def=Bug442.fst(26,24-30,10); use=Bug442.fst(27,10-30,10)
(and 
;; def=Bug442.fst(26,24-26,25); use=Bug442.fst(27,10-27,11)
(not 
;; def=Bug442.fst(26,24-26,25); use=Bug442.fst(27,10-27,11)
(BoxBool_proj_0 (Bug442.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_edd6cb1544aa88ef8c834760793a3a13_2))
)
...
(not 
;; def=Bug442.fst(26,24-26,25); use=Bug442.fst(27,10-27,11)
(BoxBool_proj_0 (Bug442.uu___is_Unit x_fe28d8bcde588226b4e538b35321de05_1
x_edd6cb1544aa88ef8c834760793a3a13_2))
)
...
(not 
;; def=Bug442.fst(26,24-30,10); use=Bug442.fst(27,10-30,10)
(and (BoxBool_proj_0 (Bug442.uu___is_Join x_fe28d8bcde588226b4e538b35321de05_1
x_edd6cb1544aa88ef8c834760793a3a13_2))
(BoxBool_proj_0 (Bug442.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
(Bug442.__proj__Join__item___0 x_fe28d8bcde588226b4e538b35321de05_1
x_edd6cb1544aa88ef8c834760793a3a13_2))))
)
...
(not 
;; def=Bug442.fst(26,24-26,25); use=Bug442.fst(27,10-27,11)
(BoxBool_proj_0 (Bug442.uu___is_Join x_fe28d8bcde588226b4e538b35321de05_1
x_edd6cb1544aa88ef8c834760793a3a13_2))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,18-389,39); use=Bug442.fst(27,4-31,58)
(and 
;; def=Prims.fst(389,19-389,21); use=Bug442.fst(27,4-31,58)
(not 
;; def=Bug442.fst(26,24-26,25); use=Bug442.fst(27,10-27,11)
(BoxBool_proj_0 (Bug442.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_edd6cb1544aa88ef8c834760793a3a13_2))
...
;; def=Prims.fst(413,99-413,120); use=Bug442.fst(27,4-31,58)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(Bug442.dList1 x_fe28d8bcde588226b4e538b35321de05_1))
...
;; def=Bug442.fst(26,24-31,16); use=Bug442.fst(27,10-31,16)
(= x_edd6cb1544aa88ef8c834760793a3a13_2
(Bug442.Join x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
@x3))
)

;; def=Bug442.fst(31,11-31,37); use=Bug442.fst(31,20-31,58)
(and 
;; def=Bug442.fst(27,4-31,58); use=Bug442.fst(31,36-31,37)
(or label_2

;; def=Bug442.fst(27,4-31,58); use=Bug442.fst(31,36-31,37)
(Valid 
;; def=Bug442.fst(27,4-31,58); use=Bug442.fst(31,36-31,37)
(Prims.precedes (Bug442.dList1 x_fe28d8bcde588226b4e538b35321de05_1)
(Bug442.dList1 x_fe28d8bcde588226b4e538b35321de05_1)
@x1
x_edd6cb1544aa88ef8c834760793a3a13_2)
)
...
(implies 
;; def=Bug442.fst(31,20-31,37); use=Bug442.fst(31,20-31,37)
(BoxBool_proj_0 (Bug442.isCorrectJoined x_fe28d8bcde588226b4e538b35321de05_1
@x1))


;; def=Bug442.fst(27,4-31,58); use=Bug442.fst(31,57-31,58)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug442.isCorrectJoined, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_edd6cb1544aa88ef8c834760793a3a13_2, disc_equation_Bug442.Join, disc_equation_Bug442.Nil, disc_equation_Bug442.Unit, fuel_guarded_inversion_Bug442.dList1, projection_inverse_BoxBool_proj_0, projection_inverse_Bug442.Join__0, projection_inverse_Bug442.Join__1, subterm_ordering_Bug442.Join
...
; encoding sigelt let rec isCorrectJoined


; <Start encoding let rec isCorrectJoined>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug442.isCorrectJoined.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug442.isCorrectJoined.fuel_instrumented_token () Term)
(declare-fun Bug442.isCorrectJoined (Term Term) Term)
(declare-fun Bug442.isCorrectJoined@tok () Term)


; </end encoding let rec isCorrectJoined>


; encoding sigelt let dList


; <Start encoding let dList>

(declare-fun Bug442.dList (Term) Term)

(declare-fun Bug442.dList@tok () Term)
(declare-fun Tm_refine_3ead50dd0e0b905474660e381a6a1021 (Term) Term)

; </end encoding let dList>


; encoding sigelt val Bug442.ld


; <Skipped val Bug442.ld/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug442.isCorrectJoined; Namespace Bug442
(assert (! 
;; def=Bug442.fst(26,8-26,23); use=Bug442.fst(26,8-26,23)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
:named typing_Bug442.isCorrectJoined))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug442.dList; Namespace Bug442
(assert (! 
;; def=Bug442.fst(34,5-34,10); use=Bug442.fst(34,5-34,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Bug442.dList @x0)
Tm_type))
 

:pattern ((Bug442.dList @x0))
:qid typing_Bug442.dList))

:named typing_Bug442.dList))
...
(HasType @x2
(Bug442.dList1 @x1)))
(HasType (Bug442.isCorrectJoined.fuel_instrumented @u0
@x1
@x2)
Prims.bool))
 

:pattern ((Bug442.isCorrectJoined.fuel_instrumented @u0
@x1
@x2))
:qid token_correspondence_Bug442.isCorrectJoined.fuel_instrumented))

:named token_correspondence_Bug442.isCorrectJoined.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug442.dList; Namespace Bug442
(assert (! 
;; def=Bug442.fst(34,16-34,48); use=Bug442.fst(34,16-34,48)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_3ead50dd0e0b905474660e381a6a1021 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_3ead50dd0e0b905474660e381a6a1021 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_3ead50dd0e0b905474660e381a6a1021))

:named refinement_kinding_Tm_refine_3ead50dd0e0b905474660e381a6a1021))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug442.dList; Namespace Bug442
(assert (! 
;; def=Bug442.fst(34,16-34,48); use=Bug442.fst(34,16-34,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3ead50dd0e0b905474660e381a6a1021 @x2))
(and (HasTypeFuel @u0
@x1
(Bug442.dList1 @x2))

;; def=Bug442.fst(34,30-34,47); use=Bug442.fst(34,30-34,47)
(BoxBool_proj_0 (Bug442.isCorrectJoined @x2
@x1))
))
...
@x1
(Tm_refine_3ead50dd0e0b905474660e381a6a1021 @x2)))
:qid refinement_interpretation_Tm_refine_3ead50dd0e0b905474660e381a6a1021))

:named refinement_interpretation_Tm_refine_3ead50dd0e0b905474660e381a6a1021))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_3ead50dd0e0b905474660e381a6a1021
;;; Fact-ids: Name Bug442.dList; Namespace Bug442
(assert (! 
;; def=Bug442.fst(34,16-34,48); use=Bug442.fst(34,16-34,48)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3ead50dd0e0b905474660e381a6a1021 @x0)))
(Valid (Prims.hasEq (Bug442.dList1 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3ead50dd0e0b905474660e381a6a1021 @x0))))
:qid haseqTm_refine_3ead50dd0e0b905474660e381a6a1021))

:named haseqTm_refine_3ead50dd0e0b905474660e381a6a1021))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Bug442.isCorrectJoined
;;; Fact-ids: Name Bug442.isCorrectJoined; Namespace Bug442
(assert (! 
;; def=Bug442.fst(26,8-26,23); use=Bug442.fst(26,8-26,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Bug442.dList1 @x1)))
(= (Bug442.isCorrectJoined.fuel_instrumented (SFuel @u0)
@x1
@x2)
(let ((@lb3 @x2))
(ite (is-Bug442.Nil @lb3)
(BoxBool true)
(ite (is-Bug442.Unit @lb3)
(BoxBool true)
(ite (and (is-Bug442.Join @lb3)
(is-Bug442.Nil (Bug442.Join__0 @lb3)))
(BoxBool false)
(ite (is-Bug442.Join @lb3)
(Prims.op_AmpAmp (Bug442.isCorrectJoined.fuel_instrumented @u0
@x1
(Bug442.Join__0 @lb3))
(Bug442.isCorrectJoined.fuel_instrumented @u0
@x1
(Bug442.Join__1 @lb3)))
Tm_unit)))))))
 :weight 0
...
:pattern ((Bug442.isCorrectJoined.fuel_instrumented (SFuel @u0)
@x1
@x2))
:qid equation_with_fuel_Bug442.isCorrectJoined.fuel_instrumented))

:named equation_with_fuel_Bug442.isCorrectJoined.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for Bug442.dList
;;; Fact-ids: Name Bug442.dList; Namespace Bug442
(assert (! 
;; def=Bug442.fst(34,5-34,10); use=Bug442.fst(34,5-34,10)
(forall ((@x0 Term))
 (! (= (Bug442.dList @x0)
(Tm_refine_3ead50dd0e0b905474660e381a6a1021 @x0))
 

:pattern ((Bug442.dList @x0))
:qid equation_Bug442.dList))

:named equation_Bug442.dList))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Bug442.isCorrectJoined; Namespace Bug442
(assert (! 
;; def=Bug442.fst(26,8-26,23); use=Bug442.fst(26,8-26,23)
...
@x1
@x2)
(Bug442.isCorrectJoined.fuel_instrumented ZFuel
@x1
@x2))
...
@x1
@x2))
:qid @fuel_irrelevance_Bug442.isCorrectJoined.fuel_instrumented))

:named @fuel_irrelevance_Bug442.isCorrectJoined.fuel_instrumented))
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug442.isCorrectJoined @x0
@x1)
(Bug442.isCorrectJoined.fuel_instrumented MaxFuel
@x0
@x1))
...
:pattern ((Bug442.isCorrectJoined @x0
@x1))
:qid @fuel_correspondence_Bug442.isCorrectJoined.fuel_instrumented))

:named @fuel_correspondence_Bug442.isCorrectJoined.fuel_instrumented))
(push) ;; push{2

; Starting query at Bug442.fst(41,4-44,35)
...
Tm_type)
:named binder_x_fe28d8bcde588226b4e538b35321de05_1))
;;;;;;;;;;;;;;;;t : Bug442.dList 't (Bug442.dList 't)
(declare-fun x_8a1329006d5a12d96dc3e47cbb3b4147_2 () Term)
;;;;;;;;;;;;;;;;binder_x_8a1329006d5a12d96dc3e47cbb3b4147_2
;;; Fact-ids: 
(assert (! (HasType x_8a1329006d5a12d96dc3e47cbb3b4147_2
(Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1))
:named binder_x_8a1329006d5a12d96dc3e47cbb3b4147_2))
(declare-fun Tm_refine_bb7d9a573f4336466842294de23fa6a8 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(39,8-44,35); use=Bug442.fst(39,8-44,35)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_bb7d9a573f4336466842294de23fa6a8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_bb7d9a573f4336466842294de23fa6a8 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_bb7d9a573f4336466842294de23fa6a8))

:named refinement_kinding_Tm_refine_bb7d9a573f4336466842294de23fa6a8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(39,8-44,35); use=Bug442.fst(39,8-44,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_bb7d9a573f4336466842294de23fa6a8 @x2))
(and (HasTypeFuel @u0
@x1
(Bug442.dList @x2))

;; def=Bug442.fst(41,4-44,35); use=Bug442.fst(41,4-44,35)

;; def=Bug442.fst(41,4-44,35); use=Bug442.fst(41,4-44,35)
(Valid 
;; def=Bug442.fst(41,4-44,35); use=Bug442.fst(41,4-44,35)
(Prims.precedes (Bug442.dList @x2)
(Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)
@x1
x_8a1329006d5a12d96dc3e47cbb3b4147_2)
)
...
@x1
(Tm_refine_bb7d9a573f4336466842294de23fa6a8 @x2)))
:qid refinement_interpretation_Tm_refine_bb7d9a573f4336466842294de23fa6a8))

:named refinement_interpretation_Tm_refine_bb7d9a573f4336466842294de23fa6a8))
;;;;;;;;;;;;;;;;haseq for Tm_refine_bb7d9a573f4336466842294de23fa6a8
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(39,8-44,35); use=Bug442.fst(39,8-44,35)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_bb7d9a573f4336466842294de23fa6a8 @x0)))
(Valid (Prims.hasEq (Bug442.dList @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_bb7d9a573f4336466842294de23fa6a8 @x0))))
:qid haseqTm_refine_bb7d9a573f4336466842294de23fa6a8))

:named haseqTm_refine_bb7d9a573f4336466842294de23fa6a8))
(declare-fun Bug442.ld (Term Term) Term)

;;;;;;;;;;;;;;;;l: dList 't {l << t} -> Prims.nat
(declare-fun Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957
Tm_type)
:named kinding_Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(39,8-44,35); use=Bug442.fst(39,8-44,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957))
:qid Bug442_pre_typing_Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957))

:named Bug442_pre_typing_Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(39,8-44,35); use=Bug442.fst(39,8-44,35)
(forall ((@x0 Term))
...
Tm_type)
(HasType @x2
(Tm_refine_bb7d9a573f4336466842294de23fa6a8 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
Prims.nat))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957))
:qid Bug442_interpretation_Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957))

:named Bug442_interpretation_Tm_arrow_70d451a0c1a6e727d8aa19dfdabb1957))
(declare-fun Bug442.ld@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(40,8-40,10); use=Bug442.fst(40,8-40,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug442.ld@tok
@x0)
@x1)
(Bug442.ld @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Bug442.ld@tok
@x0)
@x1))
:qid token_correspondence_Bug442.ld))

:named token_correspondence_Bug442.ld))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(40,8-40,10); use=Bug442.fst(40,8-40,10)
...
:pattern ((Bug442.ld @x1
@x2))
:qid function_token_typing_Bug442.ld.1))
)
 

:pattern ((ApplyTT @x0
Bug442.ld@tok))
:qid function_token_typing_Bug442.ld))

:named function_token_typing_Bug442.ld))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(40,8-40,10); use=Bug442.fst(40,8-40,10)
...
Tm_type)
(HasType @x1
(Tm_refine_bb7d9a573f4336466842294de23fa6a8 @x0)))
(HasType (Bug442.ld @x0
@x1)
Prims.nat))
 

:pattern ((Bug442.ld @x0
@x1))
:qid typing_Bug442.ld))

:named typing_Bug442.ld))
...
;   (~(Nil? t) /\ ~(Unit? t) /\ ~(Join? t) ==> Prims.l_False) /\
;   (~(Nil? t) ==>
;     ~(Unit? t) ==>
;     (forall (b: Bug442.dList1 't) (b: Bug442.dList1 't) (b: Prims.nat).
;         t == Bug442.Join b b b ==>
;         Bug442.isCorrectJoined b /\ b << t /\
;         (forall (any_result: Bug442.dList1 't).
;             b == any_result ==>
;             (forall (any_result: Prims.nat).
;                 Bug442.ld b == any_result ==>
;                 (forall (return_val: Prims.nat).
;                     return_val == Bug442.ld b ==>
;                     Bug442.ld b == return_val ==>
;                     (forall (any_result: Prims.int).
;                         1 + Bug442.ld b == any_result ==>
;                         Bug442.isCorrectJoined b /\ b << t /\
;                         (forall (any_result: Bug442.dList1 't).
;                             b == any_result ==>
;                             (forall (any_result: Prims.nat).
...
;                                     Bug442.ld b == return_val ==>
;                                     (forall (any_result: Prims.int).
;                                         1 + Bug442.ld b + Bug442.ld b == any_result ==>
;                                         1 + Bug442.ld b + Bug442.ld b >= 0))))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec ld`
...
;; def=Prims.fst(402,27-402,88); use=Bug442.fst(41,4-44,35)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(41,4-44,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(41,4-44,35)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(41,4-44,35)
(and (implies 
;; def=Bug442.fst(40,11-40,12); use=Bug442.fst(41,10-41,11)
(and 
;; def=Bug442.fst(40,11-40,12); use=Bug442.fst(41,10-41,11)
(not 
;; def=Bug442.fst(40,11-40,12); use=Bug442.fst(41,10-41,11)
...
label_1)
(implies 
;; def=Prims.fst(389,18-389,39); use=Bug442.fst(41,4-44,35)
(and 
;; def=Prims.fst(389,19-389,21); use=Bug442.fst(41,4-44,35)
(not 
;; def=Bug442.fst(40,11-40,12); use=Bug442.fst(41,10-41,11)
(BoxBool_proj_0 (Bug442.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_8a1329006d5a12d96dc3e47cbb3b4147_2))
...
;; def=Prims.fst(413,99-413,120); use=Bug442.fst(41,4-44,35)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(Bug442.dList1 x_fe28d8bcde588226b4e538b35321de05_1))
...
;; def=Bug442.fst(40,11-44,16); use=Bug442.fst(41,10-44,16)
(= x_8a1329006d5a12d96dc3e47cbb3b4147_2
(Bug442.Join x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(41,4-44,35)
(and 
;; def=Bug442.fst(34,30-34,47); use=Bug442.fst(44,27-44,28)
(or label_2
...
;; def=Bug442.fst(41,4-44,35); use=Bug442.fst(44,27-44,28)
(or label_3

;; def=Bug442.fst(41,4-44,35); use=Bug442.fst(44,27-44,28)
(Valid 
;; def=Bug442.fst(41,4-44,35); use=Bug442.fst(44,27-44,28)
(Prims.precedes (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)
(Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)
@x1
x_8a1329006d5a12d96dc3e47cbb3b4147_2)
)
...
;; def=Prims.fst(451,66-451,102); use=Bug442.fst(41,4-44,35)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Bug442.dList1 x_fe28d8bcde588226b4e538b35321de05_1))

;; def=Bug442.fst(39,8-44,12); use=Bug442.fst(41,4-44,35)
(= @x1
@x4)
)
...
;; def=Bug442.fst(39,29-44,28); use=Bug442.fst(44,24-44,28)
(= (Bug442.ld x_fe28d8bcde588226b4e538b35321de05_1
@x1)
@x5)
)

;; def=Prims.fst(356,2-356,58); use=Bug442.fst(41,4-44,35)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Bug442.fst(41,4-44,35)
(= @x6
(Bug442.ld x_fe28d8bcde588226b4e538b35321de05_1
@x1))


;; def=dummy(0,0-0,0); use=Bug442.fst(41,4-44,35)
(= (Bug442.ld x_fe28d8bcde588226b4e538b35321de05_1
@x1)
@x6)
)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(41,4-44,35)
(and 
;; def=Bug442.fst(34,30-34,47); use=Bug442.fst(44,34-44,35)
(or label_4
...
;; def=Bug442.fst(41,4-44,35); use=Bug442.fst(44,34-44,35)
(or label_5
...
;; def=Bug442.fst(39,8-44,14); use=Bug442.fst(41,4-44,35)
(= @x2
@x8)
)
...
;; def=Bug442.fst(39,29-44,35); use=Bug442.fst(44,31-44,35)
(= (Bug442.ld x_fe28d8bcde588226b4e538b35321de05_1
@x2)
@x9)
)
...
;; def=Bug442.fst(39,29-44,35); use=Bug442.fst(41,4-44,35)
...
;; def=Prims.fst(680,18-680,24); use=Bug442.fst(44,20-44,35)
(or label_6
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug442.ld, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_Bug442.isCorrectJoined.fuel_instrumented, @fuel_irrelevance_Bug442.isCorrectJoined.fuel_instrumented, @query, binder_x_8a1329006d5a12d96dc3e47cbb3b4147_2, binder_x_fe28d8bcde588226b4e538b35321de05_1, bool_inversion, disc_equation_Bug442.Join, disc_equation_Bug442.Nil, disc_equation_Bug442.Unit, equation_Bug442.dList, equation_Prims.nat, equation_with_fuel_Bug442.isCorrectJoined.fuel_instrumented, fuel_guarded_inversion_Bug442.dList1, primitive_Prims.op_Addition, primitive_Prims.op_AmpAmp, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_Bug442.Join__0, projection_inverse_Bug442.Join__1, refinement_interpretation_Tm_refine_3ead50dd0e0b905474660e381a6a1021, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, subterm_ordering_Bug442.Join, token_correspondence_Bug442.isCorrectJoined.fuel_instrumented, typing_Bug442.isCorrectJoined
...
; encoding sigelt let rec ld


; <Start encoding let rec ld>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug442.ld.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug442.ld.fuel_instrumented_token () Term)
(declare-fun Bug442.ld (Term Term) Term)
(declare-fun Bug442.ld@tok () Term)
;;;;;;;;;;;;;;;;l: dList 't -> Prims.nat
(declare-fun Tm_arrow_44745194e5f29348853dafffc2e545d0 () Term)

; </end encoding let rec ld>


; encoding sigelt val Bug442.lt


; <Skipped val Bug442.lt/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug442.ld; Namespace Bug442
(assert (! 
;; def=Bug442.fst(40,8-40,10); use=Bug442.fst(40,8-40,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x2
(Bug442.dList @x1)))
(HasType (Bug442.ld.fuel_instrumented @u0
@x1
@x2)
Prims.nat))
 

:pattern ((Bug442.ld.fuel_instrumented @u0
@x1
@x2))
:qid token_correspondence_Bug442.ld.fuel_instrumented))

:named token_correspondence_Bug442.ld.fuel_instrumented))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(616,4-616,8); use=Prims.fst(616,4-616,8)
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Bug442.ld
;;; Fact-ids: Name Bug442.ld; Namespace Bug442
(assert (! 
;; def=Bug442.fst(40,8-40,10); use=Bug442.fst(40,8-40,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Bug442.dList @x1)))
(= (Bug442.ld.fuel_instrumented (SFuel @u0)
@x1
@x2)
(let ((@lb3 @x2))
(ite (is-Bug442.Nil @lb3)
...
(ite (is-Bug442.Join @lb3)
(Prims.op_Addition (Prims.op_Addition (BoxInt 1)
(Bug442.ld.fuel_instrumented @u0
@x1
(Bug442.Join__0 @lb3)))
(Bug442.ld.fuel_instrumented @u0
@x1
...
:pattern ((Bug442.ld.fuel_instrumented (SFuel @u0)
@x1
@x2))
:qid equation_with_fuel_Bug442.ld.fuel_instrumented))

:named equation_with_fuel_Bug442.ld.fuel_instrumented))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Prims.uu___is_Nil; Namespace Prims
(assert (! 
;; def=Prims.fst(615,4-615,7); use=Prims.fst(615,4-615,7)
...
@x1
@x2)
(Bug442.ld.fuel_instrumented ZFuel
@x1
@x2))
...
@x1
@x2))
:qid @fuel_irrelevance_Bug442.ld.fuel_instrumented))

:named @fuel_irrelevance_Bug442.ld.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name Bug442.ld; Namespace Bug442
(assert (! 
;; def=Bug442.fst(40,8-40,10); use=Bug442.fst(40,8-40,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug442.ld @x0
@x1)
(Bug442.ld.fuel_instrumented MaxFuel
@x0
@x1))
...
:pattern ((Bug442.ld @x0
@x1))
:qid @fuel_correspondence_Bug442.ld.fuel_instrumented))

:named @fuel_correspondence_Bug442.ld.fuel_instrumented))
(push) ;; push{2

; Starting query at Bug442.fst(48,4-50,31)
...
Tm_type)
:named binder_x_fe28d8bcde588226b4e538b35321de05_1))
;;;;;;;;;;;;;;;;l : Prims.list (Bug442.dList 't) (Prims.list (Bug442.dList 't))
(declare-fun x_ae8bc5256c55976e18f280230b4e2516_2 () Term)
;;;;;;;;;;;;;;;;binder_x_ae8bc5256c55976e18f280230b4e2516_2
;;; Fact-ids: 
(assert (! (HasType x_ae8bc5256c55976e18f280230b4e2516_2
(Prims.list (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)))
:named binder_x_ae8bc5256c55976e18f280230b4e2516_2))
(declare-fun Tm_refine_39a33544eb804b051f49218dde5f2a9e (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(46,8-50,31); use=Bug442.fst(46,8-50,31)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_39a33544eb804b051f49218dde5f2a9e @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_39a33544eb804b051f49218dde5f2a9e @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_39a33544eb804b051f49218dde5f2a9e))

:named refinement_kinding_Tm_refine_39a33544eb804b051f49218dde5f2a9e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(46,8-50,31); use=Bug442.fst(46,8-50,31)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_39a33544eb804b051f49218dde5f2a9e @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list (Bug442.dList @x2)))

;; def=Bug442.fst(48,4-50,31); use=Bug442.fst(48,4-50,31)

;; def=Bug442.fst(48,4-50,31); use=Bug442.fst(48,4-50,31)
(Valid 
;; def=Bug442.fst(48,4-50,31); use=Bug442.fst(48,4-50,31)
(Prims.precedes (Prims.list (Bug442.dList @x2))
(Prims.list (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1))
@x1
x_ae8bc5256c55976e18f280230b4e2516_2)
)
...
@x1
(Tm_refine_39a33544eb804b051f49218dde5f2a9e @x2)))
:qid refinement_interpretation_Tm_refine_39a33544eb804b051f49218dde5f2a9e))

:named refinement_interpretation_Tm_refine_39a33544eb804b051f49218dde5f2a9e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_39a33544eb804b051f49218dde5f2a9e
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(46,8-50,31); use=Bug442.fst(46,8-50,31)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_39a33544eb804b051f49218dde5f2a9e @x0)))
(Valid (Prims.hasEq (Prims.list (Bug442.dList @x0)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_39a33544eb804b051f49218dde5f2a9e @x0))))
:qid haseqTm_refine_39a33544eb804b051f49218dde5f2a9e))

:named haseqTm_refine_39a33544eb804b051f49218dde5f2a9e))
(declare-fun Bug442.lt (Term Term) Term)

;;;;;;;;;;;;;;;;l: Prims.list (dList 't) {l << l} -> Prims.nat
(declare-fun Tm_arrow_02b0728221cff8687225ef5b23055b61 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_02b0728221cff8687225ef5b23055b61
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_02b0728221cff8687225ef5b23055b61
Tm_type)
:named kinding_Tm_arrow_02b0728221cff8687225ef5b23055b61))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(46,8-50,31); use=Bug442.fst(46,8-50,31)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_02b0728221cff8687225ef5b23055b61)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_02b0728221cff8687225ef5b23055b61))
:qid Bug442_pre_typing_Tm_arrow_02b0728221cff8687225ef5b23055b61))

:named Bug442_pre_typing_Tm_arrow_02b0728221cff8687225ef5b23055b61))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_02b0728221cff8687225ef5b23055b61
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(46,8-50,31); use=Bug442.fst(46,8-50,31)
(forall ((@x0 Term))
...
Tm_type)
(HasType @x2
(Tm_refine_39a33544eb804b051f49218dde5f2a9e @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
Prims.nat))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_02b0728221cff8687225ef5b23055b61.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_02b0728221cff8687225ef5b23055b61.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_02b0728221cff8687225ef5b23055b61))
:qid Bug442_interpretation_Tm_arrow_02b0728221cff8687225ef5b23055b61))

:named Bug442_interpretation_Tm_arrow_02b0728221cff8687225ef5b23055b61))
(declare-fun Bug442.lt@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(47,8-47,10); use=Bug442.fst(47,8-47,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug442.lt@tok
@x0)
@x1)
(Bug442.lt @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Bug442.lt@tok
@x0)
@x1))
:qid token_correspondence_Bug442.lt))

:named token_correspondence_Bug442.lt))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(47,8-47,10); use=Bug442.fst(47,8-47,10)
...
:pattern ((Bug442.lt @x1
@x2))
:qid function_token_typing_Bug442.lt.1))
)
 

:pattern ((ApplyTT @x0
Bug442.lt@tok))
:qid function_token_typing_Bug442.lt))

:named function_token_typing_Bug442.lt))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(47,8-47,10); use=Bug442.fst(47,8-47,10)
...
Tm_type)
(HasType @x1
(Tm_refine_39a33544eb804b051f49218dde5f2a9e @x0)))
(HasType (Bug442.lt @x0
@x1)
Prims.nat))
 

:pattern ((Bug442.lt @x0
@x1))
:qid typing_Bug442.lt))

:named typing_Bug442.lt))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(Nil? l) ==>
;     (forall (b: Bug442.dList 't) (b: Prims.list (Bug442.dList 't)).
;         l == b :: b ==>
;         b << l /\
;         (forall (any_result: Prims.list (Bug442.dList 't)).
;             b == any_result ==>
;             (forall (any_result: Prims.nat).
;                 Bug442.lt b == any_result ==>
;                 (forall (return_val: Prims.nat).
;                     return_val == Bug442.lt b ==>
;                     Bug442.lt b == return_val ==>
;                     (forall (any_result: Prims.int).
;                         Bug442.ld b + Bug442.lt b == any_result ==> Bug442.ld b + Bug442.lt b >= 0))
;             ))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec lt`
...
;; def=Prims.fst(402,27-402,88); use=Bug442.fst(48,4-50,31)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(48,4-50,31)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(48,4-50,31)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(48,4-50,31)
(and (implies 
;; def=Bug442.fst(47,11-47,12); use=Bug442.fst(48,10-48,11)
(and 
;; def=Bug442.fst(47,11-47,12); use=Bug442.fst(48,10-48,11)
(not 
;; def=Bug442.fst(47,11-47,12); use=Bug442.fst(48,10-48,11)
(BoxBool_proj_0 (Prims.uu___is_Nil (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)
x_ae8bc5256c55976e18f280230b4e2516_2))
)
...
(not 
;; def=Bug442.fst(47,11-47,12); use=Bug442.fst(48,10-48,11)
(BoxBool_proj_0 (Prims.uu___is_Cons (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)
x_ae8bc5256c55976e18f280230b4e2516_2))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Bug442.fst(48,4-50,31)
(not 
;; def=Bug442.fst(47,11-47,12); use=Bug442.fst(48,10-48,11)
(BoxBool_proj_0 (Prims.uu___is_Nil (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)
x_ae8bc5256c55976e18f280230b4e2516_2))
...
;; def=Prims.fst(413,99-413,120); use=Bug442.fst(48,4-50,31)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1))
...
;; def=Bug442.fst(47,11-50,14); use=Bug442.fst(48,10-50,14)
(= x_ae8bc5256c55976e18f280230b4e2516_2
(Prims.Cons (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)
@x1
@x2))
)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(48,4-50,31)
(and 
;; def=Bug442.fst(48,4-50,31); use=Bug442.fst(50,29-50,31)
(or label_2

;; def=Bug442.fst(48,4-50,31); use=Bug442.fst(50,29-50,31)
(Valid 
;; def=Bug442.fst(48,4-50,31); use=Bug442.fst(50,29-50,31)
(Prims.precedes (Prims.list (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1))
(Prims.list (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1))
@x2
x_ae8bc5256c55976e18f280230b4e2516_2)
)
...
;; def=Prims.fst(451,66-451,102); use=Bug442.fst(48,4-50,31)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.list (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)))

;; def=Bug442.fst(46,8-50,14); use=Bug442.fst(48,4-50,31)
(= @x2
@x3)
)
...
;; def=Bug442.fst(46,35-50,31); use=Bug442.fst(50,26-50,31)
(= (Bug442.lt x_fe28d8bcde588226b4e538b35321de05_1
@x2)
@x4)
)

;; def=Prims.fst(356,2-356,58); use=Bug442.fst(48,4-50,31)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Bug442.fst(48,4-50,31)
(= @x5
(Bug442.lt x_fe28d8bcde588226b4e538b35321de05_1
@x2))


;; def=dummy(0,0-0,0); use=Bug442.fst(48,4-50,31)
(= (Bug442.lt x_fe28d8bcde588226b4e538b35321de05_1
@x2)
@x5)
)
...
;; def=Bug442.fst(46,35-50,31); use=Bug442.fst(48,4-50,31)
(= (Prims.op_Addition (Bug442.ld x_fe28d8bcde588226b4e538b35321de05_1
@x1)
(Bug442.lt x_fe28d8bcde588226b4e538b35321de05_1
@x2))
@x6)
...
;; def=Prims.fst(680,18-680,24); use=Bug442.fst(50,18-50,31)
(or label_3

;; def=Prims.fst(680,18-680,24); use=Bug442.fst(50,18-50,31)
(>= (BoxInt_proj_0 (Prims.op_Addition (Bug442.ld x_fe28d8bcde588226b4e538b35321de05_1
@x1)
(Bug442.lt x_fe28d8bcde588226b4e538b35321de05_1
@x2)))
(BoxInt_proj_0 (BoxInt 0)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug442.lt, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @fuel_correspondence_Bug442.ld.fuel_instrumented, @query, binder_x_ae8bc5256c55976e18f280230b4e2516_2, binder_x_fe28d8bcde588226b4e538b35321de05_1, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_Bug442.dList, equation_Prims.nat, fuel_guarded_inversion_Prims.list, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, subterm_ordering_Prims.Cons, typing_Bug442.ld
...
; encoding sigelt let rec lt


; <Start encoding let rec lt>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug442.lt.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug442.lt.fuel_instrumented_token () Term)
(declare-fun Bug442.lt (Term Term) Term)
(declare-fun Bug442.lt@tok () Term)
;;;;;;;;;;;;;;;;l: Prims.list (dList 't) -> Prims.nat
(declare-fun Tm_arrow_65eaa23358ebb9331c3efbee751ecf59 () Term)

; </end encoding let rec lt>


; encoding sigelt val Bug442.finish


; <Skipped val Bug442.finish/>


; encoding sigelt val Bug442.walk


; <Skipped val Bug442.walk/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug442.lt; Namespace Bug442
(assert (! 
;; def=Bug442.fst(47,8-47,10); use=Bug442.fst(47,8-47,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
Tm_type)
(HasType @x2
(Prims.list (Bug442.dList @x1))))
(HasType (Bug442.lt.fuel_instrumented @u0
@x1
@x2)
Prims.nat))
 

:pattern ((Bug442.lt.fuel_instrumented @u0
@x1
@x2))
:qid token_correspondence_Bug442.lt.fuel_instrumented))

:named token_correspondence_Bug442.lt.fuel_instrumented))
...
(assert (! 
;; def=FStar.List.Tot.Base.fst(187,18-187,19); use=FStar.List.Tot.Base.fst(187,18-187,19)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Bug442.lt
;;; Fact-ids: Name Bug442.lt; Namespace Bug442
(assert (! 
;; def=Bug442.fst(47,8-47,10); use=Bug442.fst(47,8-47,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Prims.list (Bug442.dList @x1))))
(= (Bug442.lt.fuel_instrumented (SFuel @u0)
@x1
@x2)
(let ((@lb3 @x2))
...
(Prims.op_Addition (Bug442.ld @x1
(Prims.Cons_hd @lb3))
(Bug442.lt.fuel_instrumented @u0
@x1
(Prims.Cons_tl @lb3)))
Tm_unit)))))
 :weight 0
...
:pattern ((Bug442.lt.fuel_instrumented (SFuel @u0)
@x1
@x2))
:qid equation_with_fuel_Bug442.lt.fuel_instrumented))

:named equation_with_fuel_Bug442.lt.fuel_instrumented))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.List.Tot.Base.fold_left; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(187,18-187,19); use=FStar.List.Tot.Base.fst(187,18-187,19)
...
(Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x2
@x3)))
:qid FStar.List.Tot.Base_pre_typing_Tm_arrow_f0225aaf6b987d44876e7f498390aa39))

:named FStar.List.Tot.Base_pre_typing_Tm_arrow_f0225aaf6b987d44876e7f498390aa39))
...
@x3)
@x4))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_f0225aaf6b987d44876e7f498390aa39.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_f0225aaf6b987d44876e7f498390aa39.2))
))
...
(Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x1
@x2)))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_f0225aaf6b987d44876e7f498390aa39))

:named FStar.List.Tot.Base_interpretation_Tm_arrow_f0225aaf6b987d44876e7f498390aa39))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Bug442.lt; Namespace Bug442
(assert (! 
;; def=Bug442.fst(47,8-47,10); use=Bug442.fst(47,8-47,10)
...
@x1
@x2)
(Bug442.lt.fuel_instrumented ZFuel
@x1
@x2))
...
@x1
@x2))
:qid @fuel_irrelevance_Bug442.lt.fuel_instrumented))

:named @fuel_irrelevance_Bug442.lt.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name Bug442.lt; Namespace Bug442
(assert (! 
;; def=Bug442.fst(47,8-47,10); use=Bug442.fst(47,8-47,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug442.lt @x0
@x1)
(Bug442.lt.fuel_instrumented MaxFuel
@x0
@x1))
...
:pattern ((Bug442.lt @x0
@x1))
:qid @fuel_correspondence_Bug442.lt.fuel_instrumented))

:named @fuel_correspondence_Bug442.lt.fuel_instrumented))
(push) ;; push{2

; Starting query at Bug442.fst(58,4-61,44)
...
Tm_type)
:named binder_x_fe28d8bcde588226b4e538b35321de05_1))
;;;;;;;;;;;;;;;;rights : Prims.list (Bug442.dList t) (Prims.list (Bug442.dList t))
(declare-fun x_ae8bc5256c55976e18f280230b4e2516_2 () Term)
;;;;;;;;;;;;;;;;binder_x_ae8bc5256c55976e18f280230b4e2516_2
;;; Fact-ids: 
(assert (! (HasType x_ae8bc5256c55976e18f280230b4e2516_2
(Prims.list (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)))
:named binder_x_ae8bc5256c55976e18f280230b4e2516_2))
;;;;;;;;;;;;;;;;l : Bug442.dList t (Bug442.dList t)
(declare-fun x_8a1329006d5a12d96dc3e47cbb3b4147_3 () Term)
;;;;;;;;;;;;;;;;binder_x_8a1329006d5a12d96dc3e47cbb3b4147_3
;;; Fact-ids: 
(assert (! (HasType x_8a1329006d5a12d96dc3e47cbb3b4147_3
(Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1))
:named binder_x_8a1329006d5a12d96dc3e47cbb3b4147_3))
;;;;;;;;;;;;;;;;xs : a (a)
(declare-fun x_6781041e5072f14a03af8b07643f1f30_4 () Term)
;;;;;;;;;;;;;;;;binder_x_6781041e5072f14a03af8b07643f1f30_4
;;; Fact-ids: 
(assert (! (HasType x_6781041e5072f14a03af8b07643f1f30_4
x_fe28d8bcde588226b4e538b35321de05_0)
:named binder_x_6781041e5072f14a03af8b07643f1f30_4))
;;;;;;;;;;;;;;;;f : _: a -> _: t -> a (_: a -> _: t -> a)
(declare-fun x_2b0e3ce706781c7835382ede7f2f4710_5 () Term)
;;;;;;;;;;;;;;;;_: a -> _: t -> a
(declare-fun Tm_arrow_70310faa7dae64dad2eb8a81ba97e836 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_70310faa7dae64dad2eb8a81ba97e836
Tm_type)
:named kinding_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(57,14-57,18); use=Bug442.fst(57,14-57,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_70310faa7dae64dad2eb8a81ba97e836)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_70310faa7dae64dad2eb8a81ba97e836))
:qid Bug442_pre_typing_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836))

:named Bug442_pre_typing_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(57,14-57,18); use=Bug442.fst(57,14-57,18)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_70310faa7dae64dad2eb8a81ba97e836))
:qid Bug442_interpretation_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836))

:named Bug442_interpretation_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836))
;;;;;;;;;;;;;;;;binder_x_2b0e3ce706781c7835382ede7f2f4710_5
;;; Fact-ids: 
(assert (! (HasType x_2b0e3ce706781c7835382ede7f2f4710_5
Tm_arrow_70310faa7dae64dad2eb8a81ba97e836)
:named binder_x_2b0e3ce706781c7835382ede7f2f4710_5))

(declare-fun Tm_refine_b8b96c0267ec7e43e94063a918a39393 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(52,74-61,44); use=Bug442.fst(52,74-62,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_b8b96c0267ec7e43e94063a918a39393 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_b8b96c0267ec7e43e94063a918a39393 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_b8b96c0267ec7e43e94063a918a39393))

:named refinement_kinding_Tm_refine_b8b96c0267ec7e43e94063a918a39393))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(52,74-61,44); use=Bug442.fst(52,74-62,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b8b96c0267ec7e43e94063a918a39393 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x3
@x2))

;; def=Bug442.fst(53,23-61,44); use=Bug442.fst(57,8-62,10)

;; def=Bug442.fst(53,23-61,44); use=Bug442.fst(57,8-62,10)
(or 
;; def=Bug442.fst(58,4-61,44); use=Bug442.fst(58,4-61,44)
(Valid 
;; def=Bug442.fst(58,4-61,44); use=Bug442.fst(58,4-61,44)
...
@x4)
(Prims.op_Addition (Bug442.ld x_fe28d8bcde588226b4e538b35321de05_1
x_8a1329006d5a12d96dc3e47cbb3b4147_3)
(Bug442.lt x_fe28d8bcde588226b4e538b35321de05_1
x_ae8bc5256c55976e18f280230b4e2516_2)))
)
...
;; def=Bug442.fst(53,23-61,44); use=Bug442.fst(57,8-62,10)
(and 
;; def=Bug442.fst(53,23-55,38); use=Bug442.fst(57,8-62,10)
(Valid 
;; def=Bug442.fst(53,23-55,38); use=Bug442.fst(57,8-62,10)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_b8b96c0267ec7e43e94063a918a39393))

:named refinement_interpretation_Tm_refine_b8b96c0267ec7e43e94063a918a39393))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b8b96c0267ec7e43e94063a918a39393
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(52,74-61,44); use=Bug442.fst(52,74-62,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b8b96c0267ec7e43e94063a918a39393 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x1
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b8b96c0267ec7e43e94063a918a39393 @x0
@x1
@x2))))
:qid haseqTm_refine_b8b96c0267ec7e43e94063a918a39393))

:named haseqTm_refine_b8b96c0267ec7e43e94063a918a39393))
(declare-fun Bug442.finish (Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;rights: Prims.list (dList t) ->     xs: a ->     f:       (_: a -> _: t -> a){lt rights << ld l + lt rights \/ lt rights === ld l + lt rights /\ 1 << 0}   -> Prims.Tot a
(declare-fun Tm_arrow_0381d9d72da187a61dff31fae12ec965 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0381d9d72da187a61dff31fae12ec965
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_0381d9d72da187a61dff31fae12ec965
Tm_type)
:named kinding_Tm_arrow_0381d9d72da187a61dff31fae12ec965))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(52,14-61,44); use=Bug442.fst(52,69-62,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_0381d9d72da187a61dff31fae12ec965)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_0381d9d72da187a61dff31fae12ec965))
:qid Bug442_pre_typing_Tm_arrow_0381d9d72da187a61dff31fae12ec965))

:named Bug442_pre_typing_Tm_arrow_0381d9d72da187a61dff31fae12ec965))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0381d9d72da187a61dff31fae12ec965
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(52,14-61,44); use=Bug442.fst(52,69-62,10)
(forall ((@x0 Term))
...
@x1)
(HasType @x5
(Tm_refine_b8b96c0267ec7e43e94063a918a39393 @x1
@x2
@x3)))
...
@x4)
@x5))
:qid Bug442_interpretation_Tm_arrow_0381d9d72da187a61dff31fae12ec965.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_0381d9d72da187a61dff31fae12ec965.2))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_0381d9d72da187a61dff31fae12ec965.3))
...
@x2)
@x3))
:qid Bug442_interpretation_Tm_arrow_0381d9d72da187a61dff31fae12ec965.4))
...
@x3)
@x4))
:qid Bug442_interpretation_Tm_arrow_0381d9d72da187a61dff31fae12ec965.5))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_0381d9d72da187a61dff31fae12ec965))
:qid Bug442_interpretation_Tm_arrow_0381d9d72da187a61dff31fae12ec965))

:named Bug442_interpretation_Tm_arrow_0381d9d72da187a61dff31fae12ec965))
(declare-fun Bug442.finish@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(62,4-62,10); use=Bug442.fst(62,4-62,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug442.finish@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug442.finish@tok
@x0)
@x1)
@x2)
@x3)
@x4))
:qid token_correspondence_Bug442.finish))

:named token_correspondence_Bug442.finish))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(62,4-62,10); use=Bug442.fst(62,4-62,10)
...
:pattern ((Bug442.finish @x1
@x2
@x3
@x4
@x5))
:qid function_token_typing_Bug442.finish.1))
)
 

:pattern ((ApplyTT @x0
Bug442.finish@tok))
:qid function_token_typing_Bug442.finish))

:named function_token_typing_Bug442.finish))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(62,4-62,10); use=Bug442.fst(62,4-62,10)
...
@x0)
(HasType @x4
(Tm_refine_b8b96c0267ec7e43e94063a918a39393 @x0
@x1
@x2)))
(HasType (Bug442.finish @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Bug442.finish @x0
@x1
@x2
@x3
@x4))
:qid typing_Bug442.finish))

:named typing_Bug442.finish))

(declare-fun Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(54,88-61,44); use=Bug442.fst(54,88-61,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3))

:named refinement_kinding_Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(54,88-61,44); use=Bug442.fst(54,88-61,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Bug442.fst(55,22-61,44); use=Bug442.fst(57,8-61,44)
...
(Prims.precedes Prims.int
Prims.int
(Prims.op_Addition (Bug442.ld @x3
@x4)
(Bug442.lt @x3
@x5))
(Prims.op_Addition (Bug442.ld x_fe28d8bcde588226b4e538b35321de05_1
...
;; def=Bug442.fst(55,22-61,44); use=Bug442.fst(57,8-61,44)
(and 
;; def=Bug442.fst(55,22-55,38); use=Bug442.fst(57,8-57,12)
(Valid 
;; def=Bug442.fst(55,22-55,38); use=Bug442.fst(57,8-57,12)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3))

:named refinement_interpretation_Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(54,88-61,44); use=Bug442.fst(54,88-61,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x1
...
:pattern ((Valid (Prims.hasEq (Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_c2b58c744dd2350bb95f45ccb29ca3f3))

:named haseqTm_refine_c2b58c744dd2350bb95f45ccb29ca3f3))
(declare-fun Bug442.walk (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;rights: Prims.list (dList t) ->     l: dList t ->     xs: a ->     f:       (_: a -> _: t -> a)         {ld l + lt rights << ld l + lt rights \/ ld l + lt rights === ld l + lt rights /\ 0 << 0}   -> Prims.Tot a
(declare-fun Tm_arrow_60f1294f278109d10f08998182f8cd4b () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_60f1294f278109d10f08998182f8cd4b
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_60f1294f278109d10f08998182f8cd4b
Tm_type)
:named kinding_Tm_arrow_60f1294f278109d10f08998182f8cd4b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(54,12-61,44); use=Bug442.fst(54,83-61,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_60f1294f278109d10f08998182f8cd4b)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_60f1294f278109d10f08998182f8cd4b))
:qid Bug442_pre_typing_Tm_arrow_60f1294f278109d10f08998182f8cd4b))

:named Bug442_pre_typing_Tm_arrow_60f1294f278109d10f08998182f8cd4b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_60f1294f278109d10f08998182f8cd4b
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(54,12-61,44); use=Bug442.fst(54,83-61,44)
(forall ((@x0 Term))
...
@x1)
(HasType @x6
(Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3 @x1
@x2
@x4
@x3)))
...
@x5)
@x6))
:qid Bug442_interpretation_Tm_arrow_60f1294f278109d10f08998182f8cd4b.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_60f1294f278109d10f08998182f8cd4b.2))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_60f1294f278109d10f08998182f8cd4b.3))
...
@x2)
@x3))
:qid Bug442_interpretation_Tm_arrow_60f1294f278109d10f08998182f8cd4b.4))
...
@x3)
@x4))
:qid Bug442_interpretation_Tm_arrow_60f1294f278109d10f08998182f8cd4b.5))
...
@x4)
@x5))
:qid Bug442_interpretation_Tm_arrow_60f1294f278109d10f08998182f8cd4b.6))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_60f1294f278109d10f08998182f8cd4b))
:qid Bug442_interpretation_Tm_arrow_60f1294f278109d10f08998182f8cd4b))

:named Bug442_interpretation_Tm_arrow_60f1294f278109d10f08998182f8cd4b))
(declare-fun Bug442.walk@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(57,8-57,12); use=Bug442.fst(57,8-57,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug442.walk@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug442.walk@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5))
:qid token_correspondence_Bug442.walk))

:named token_correspondence_Bug442.walk))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(57,8-57,12); use=Bug442.fst(57,8-57,12)
...
:pattern ((Bug442.walk @x1
@x2
@x3
@x4
@x5
@x6))
:qid function_token_typing_Bug442.walk.1))
)
 

:pattern ((ApplyTT @x0
Bug442.walk@tok))
:qid function_token_typing_Bug442.walk))

:named function_token_typing_Bug442.walk))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(57,8-57,12); use=Bug442.fst(57,8-57,12)
...
@x0)
(HasType @x5
(Tm_refine_c2b58c744dd2350bb95f45ccb29ca3f3 @x0
@x1
@x3
@x2)))
(HasType (Bug442.walk @x0
@x1
@x2
@x3
@x4
...
:pattern ((Bug442.walk @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_Bug442.walk))

:named typing_Bug442.walk))
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
...
;   (~(Nil? l) /\ ~(Unit? l) /\ ~(Join? l) ==> Prims.l_False) /\
;   (l == Bug442.Nil ==>
;     Bug442.lt rights << Bug442.ld l + Bug442.lt rights \/
;     Bug442.lt rights === Bug442.ld l + Bug442.lt rights /\ 1 << 0) /\
;   (~(Nil? l) ==>
;     (forall (b: t).
;         l == Bug442.Unit b ==>
;         Bug442.lt rights << Bug442.ld l + Bug442.lt rights \/
...
;                   (forall (any_result: Bug442.dList1 t).
;                       b == any_result ==>
;                       Bug442.ld b + Bug442.lt (b :: rights) << Bug442.ld l + Bug442.lt rights \/
;                       Bug442.ld b + Bug442.lt (b :: rights) === Bug442.ld l + Bug442.lt rights /\
;                       0 << 0))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec walk and finish`
...
;; def=Prims.fst(402,27-402,88); use=Bug442.fst(58,4-61,44)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(58,4-61,44)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(58,4-61,44)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(58,4-61,44)
(and (implies 
;; def=Bug442.fst(57,26-57,27); use=Bug442.fst(58,10-58,11)
(and 
;; def=Bug442.fst(57,26-57,27); use=Bug442.fst(58,10-58,11)
(not 
;; def=Bug442.fst(57,26-57,27); use=Bug442.fst(58,10-58,11)
...
label_1)
(implies 
;; def=Bug442.fst(57,26-59,9); use=Bug442.fst(58,10-59,9)
(= x_8a1329006d5a12d96dc3e47cbb3b4147_3
(Bug442.Nil x_fe28d8bcde588226b4e538b35321de05_1))


;; def=Bug442.fst(53,23-61,44); use=Bug442.fst(59,44-59,45)
(or label_2

;; def=Bug442.fst(58,4-61,44); use=Bug442.fst(59,44-59,45)
(Valid 
;; def=Bug442.fst(58,4-61,44); use=Bug442.fst(59,44-59,45)
(Prims.precedes Prims.int
Prims.int
...
;; def=Bug442.fst(53,23-61,44); use=Bug442.fst(59,44-59,45)
(and 
;; def=Bug442.fst(53,23-55,38); use=Bug442.fst(59,44-59,45)
(Valid 
;; def=Bug442.fst(53,23-55,38); use=Bug442.fst(59,44-59,45)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Bug442.fst(58,4-61,44)
(not 
;; def=Bug442.fst(57,26-57,27); use=Bug442.fst(58,10-58,11)
(BoxBool_proj_0 (Bug442.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_8a1329006d5a12d96dc3e47cbb3b4147_3))
...
;; def=Prims.fst(389,2-389,39); use=Bug442.fst(58,4-61,44)
(and 
;; def=Prims.fst(413,99-413,120); use=Bug442.fst(58,4-61,44)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)

;; def=Bug442.fst(57,26-60,12); use=Bug442.fst(58,10-60,12)
(= x_8a1329006d5a12d96dc3e47cbb3b4147_3
(Bug442.Unit x_fe28d8bcde588226b4e538b35321de05_1
@x1))
)

;; def=Bug442.fst(53,23-61,44); use=Bug442.fst(60,44-60,45)
(or label_3

;; def=Bug442.fst(58,4-61,44); use=Bug442.fst(60,44-60,45)
(Valid 
;; def=Bug442.fst(58,4-61,44); use=Bug442.fst(60,44-60,45)
(Prims.precedes Prims.int
Prims.int
...
;; def=Bug442.fst(53,23-61,44); use=Bug442.fst(60,44-60,45)
(and 
;; def=Bug442.fst(53,23-55,38); use=Bug442.fst(60,44-60,45)
(Valid 
;; def=Bug442.fst(53,23-55,38); use=Bug442.fst(60,44-60,45)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
;; def=Bug442.fst(57,26-61,16); use=Bug442.fst(58,10-61,16)
(= x_8a1329006d5a12d96dc3e47cbb3b4147_3
(Bug442.Join x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(58,4-61,44)
(and 
;; def=Bug442.fst(34,30-34,47); use=Bug442.fst(61,27-61,28)
(or label_4
...
;; def=Prims.fst(451,66-451,102); use=Bug442.fst(58,4-61,44)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Bug442.dList1 x_fe28d8bcde588226b4e538b35321de05_1))

;; def=Prims.fst(616,11-616,13); use=Bug442.fst(58,4-61,44)
(= @x2
@x4)
)
...
;; def=Bug442.fst(54,35-61,37); use=Bug442.fst(58,4-61,44)
(= (Prims.Cons (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)
@x2
x_ae8bc5256c55976e18f280230b4e2516_2)
@x5)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(58,4-61,44)
(and 
;; def=Bug442.fst(34,30-34,47); use=Bug442.fst(61,38-61,39)
(or label_5
...
;; def=Bug442.fst(54,63-61,12); use=Bug442.fst(58,4-61,44)
(= @x1
@x6)
)

;; def=Bug442.fst(55,22-61,44); use=Bug442.fst(61,43-61,44)
(or label_6

;; def=Bug442.fst(58,4-61,44); use=Bug442.fst(61,43-61,44)
(Valid 
;; def=Bug442.fst(58,4-61,44); use=Bug442.fst(61,43-61,44)
(Prims.precedes Prims.int
Prims.int
...
;; def=Bug442.fst(55,22-61,44); use=Bug442.fst(61,43-61,44)
(and 
;; def=Bug442.fst(55,22-55,38); use=Bug442.fst(61,43-61,44)
(Valid 
;; def=Bug442.fst(55,22-55,38); use=Bug442.fst(61,43-61,44)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
; Starting query at Bug442.fst(63,4-65,31)
...
:named binder_x_ae8bc5256c55976e18f280230b4e2516_2))
;;;;;;;;;;;;;;;;xs : a (a)
(declare-fun x_6781041e5072f14a03af8b07643f1f30_3 () Term)
;;;;;;;;;;;;;;;;binder_x_6781041e5072f14a03af8b07643f1f30_3
;;; Fact-ids: 
(assert (! (HasType x_6781041e5072f14a03af8b07643f1f30_3
x_fe28d8bcde588226b4e538b35321de05_0)
:named binder_x_6781041e5072f14a03af8b07643f1f30_3))
;;;;;;;;;;;;;;;;f : _: a -> _: t -> a (_: a -> _: t -> a)
(declare-fun x_2b0e3ce706781c7835382ede7f2f4710_4 () Term)
;;;;;;;;;;;;;;;;_: a -> _: t -> a
(declare-fun Tm_arrow_70310faa7dae64dad2eb8a81ba97e836 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836
;;; Fact-ids: 
...
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(62,12-62,16); use=Bug442.fst(62,12-62,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_70310faa7dae64dad2eb8a81ba97e836)
...
:named Bug442_interpretation_Tm_arrow_70310faa7dae64dad2eb8a81ba97e836))
;;;;;;;;;;;;;;;;binder_x_2b0e3ce706781c7835382ede7f2f4710_4
;;; Fact-ids: 
(assert (! (HasType x_2b0e3ce706781c7835382ede7f2f4710_4
Tm_arrow_70310faa7dae64dad2eb8a81ba97e836)
:named binder_x_2b0e3ce706781c7835382ede7f2f4710_4))

(declare-fun Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(52,74-65,31); use=Bug442.fst(52,74-65,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d))

:named refinement_kinding_Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(52,74-65,31); use=Bug442.fst(52,74-65,31)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(62,4-65,31)

;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(62,4-65,31)
(or 
;; def=Bug442.fst(63,4-65,31); use=Bug442.fst(63,4-65,31)
(Valid 
;; def=Bug442.fst(63,4-65,31); use=Bug442.fst(63,4-65,31)
(Prims.precedes Prims.int
Prims.int
...
;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(62,4-65,31)
(and 
;; def=Bug442.fst(53,23-53,34); use=Bug442.fst(62,4-62,10)
(Valid 
;; def=Bug442.fst(53,23-53,34); use=Bug442.fst(62,4-62,10)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d))

:named refinement_interpretation_Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(52,74-65,31); use=Bug442.fst(52,74-65,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d @x0
@x1
@x2)))
(Valid (Prims.hasEq (Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x1
@x0))))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d @x0
@x1
@x2))))
:qid haseqTm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d))

:named haseqTm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d))
(declare-fun Bug442.finish (Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;rights: Prims.list (dList t) ->     xs: a ->     f: (_: a -> _: t -> a){lt rights << lt rights \/ lt rights === lt rights /\ 1 << 1}   -> Prims.Tot a
(declare-fun Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174
Tm_type)
:named kinding_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(52,14-65,31); use=Bug442.fst(52,69-65,31)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174))
:qid Bug442_pre_typing_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174))

:named Bug442_pre_typing_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(52,14-65,31); use=Bug442.fst(52,69-65,31)
(forall ((@x0 Term))
...
@x1)
(HasType @x5
(Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d @x1
@x2
@x3)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
...
@x4)
@x5))
:qid Bug442_interpretation_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174.2))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174.3))
...
@x2)
@x3))
:qid Bug442_interpretation_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174.4))
...
@x3)
@x4))
:qid Bug442_interpretation_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174.5))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174))
:qid Bug442_interpretation_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174))

:named Bug442_interpretation_Tm_arrow_ade075b900dc7fc15ca9c8f1ae000174))
(declare-fun Bug442.finish@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
...
@x0)
(HasType @x4
(Tm_refine_cd16ea43e0cebfe8e898bc5d8fc8b90d @x0
@x1
@x2)))
(HasType (Bug442.finish @x0
@x1
...
(declare-fun Tm_refine_ba1778f38a122ee570a540d82f2b1db0 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(54,88-65,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_ba1778f38a122ee570a540d82f2b1db0 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_ba1778f38a122ee570a540d82f2b1db0 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_ba1778f38a122ee570a540d82f2b1db0))

:named refinement_kinding_Tm_refine_ba1778f38a122ee570a540d82f2b1db0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(54,88-65,31)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ba1778f38a122ee570a540d82f2b1db0 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(57,8-65,31)
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_ba1778f38a122ee570a540d82f2b1db0))

:named refinement_interpretation_Tm_refine_ba1778f38a122ee570a540d82f2b1db0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ba1778f38a122ee570a540d82f2b1db0
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(54,88-65,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ba1778f38a122ee570a540d82f2b1db0 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x1
...
:pattern ((Valid (Prims.hasEq (Tm_refine_ba1778f38a122ee570a540d82f2b1db0 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_ba1778f38a122ee570a540d82f2b1db0))

:named haseqTm_refine_ba1778f38a122ee570a540d82f2b1db0))
(declare-fun Bug442.walk (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;rights: Prims.list (dList t) ->     l: dList t ->     xs: a ->     f:       (_: a -> _: t -> a){ld l + lt rights << lt rights \/ ld l + lt rights === lt rights /\ 0 << 1}   -> Prims.Tot a
(declare-fun Tm_arrow_c1627531a01091ad51f249677dbcad3f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c1627531a01091ad51f249677dbcad3f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_c1627531a01091ad51f249677dbcad3f
Tm_type)
:named kinding_Tm_arrow_c1627531a01091ad51f249677dbcad3f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(54,83-65,31)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_c1627531a01091ad51f249677dbcad3f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_c1627531a01091ad51f249677dbcad3f))
:qid Bug442_pre_typing_Tm_arrow_c1627531a01091ad51f249677dbcad3f))

:named Bug442_pre_typing_Tm_arrow_c1627531a01091ad51f249677dbcad3f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c1627531a01091ad51f249677dbcad3f
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(54,83-65,31)
(forall ((@x0 Term))
...
@x1)
(HasType @x6
(Tm_refine_ba1778f38a122ee570a540d82f2b1db0 @x1
@x2
@x4
@x3)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
...
@x5)
@x6))
:qid Bug442_interpretation_Tm_arrow_c1627531a01091ad51f249677dbcad3f.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_c1627531a01091ad51f249677dbcad3f.2))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_c1627531a01091ad51f249677dbcad3f.3))
...
@x2)
@x3))
:qid Bug442_interpretation_Tm_arrow_c1627531a01091ad51f249677dbcad3f.4))
...
@x3)
@x4))
:qid Bug442_interpretation_Tm_arrow_c1627531a01091ad51f249677dbcad3f.5))
...
@x4)
@x5))
:qid Bug442_interpretation_Tm_arrow_c1627531a01091ad51f249677dbcad3f.6))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_c1627531a01091ad51f249677dbcad3f))
:qid Bug442_interpretation_Tm_arrow_c1627531a01091ad51f249677dbcad3f))

:named Bug442_interpretation_Tm_arrow_c1627531a01091ad51f249677dbcad3f))
(declare-fun Bug442.walk@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
...
@x0)
(HasType @x5
(Tm_refine_ba1778f38a122ee570a540d82f2b1db0 @x0
@x1
@x3
@x2)))
(HasType (Bug442.walk @x0
...
; Encoding query formula : forall (k: Prims.pure_post a).
;   (forall (x: a). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Nil? rights) /\ ~(Cons? rights) ==> Prims.l_False) /\
;   (~(Nil? rights) ==>
;     (forall (b: Bug442.dList t) (b: Prims.list (Bug442.dList t)).
;         rights == b :: b ==>
;         Bug442.ld b + Bug442.lt b << Bug442.lt rights \/
;         Bug442.ld b + Bug442.lt b === Bug442.lt rights /\ 0 << 1))
...
;; def=Prims.fst(402,27-402,88); use=Bug442.fst(63,4-65,31)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(63,4-65,31)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(63,4-65,31)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(63,4-65,31)
(and (implies 
;; def=Bug442.fst(62,17-62,23); use=Bug442.fst(63,10-63,16)
(and 
;; def=Bug442.fst(62,17-62,23); use=Bug442.fst(63,10-63,16)
(not 
;; def=Bug442.fst(62,17-62,23); use=Bug442.fst(63,10-63,16)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Bug442.fst(63,4-65,31)
(not 
;; def=Bug442.fst(62,17-62,23); use=Bug442.fst(63,10-63,16)
(BoxBool_proj_0 (Prims.uu___is_Nil (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)
x_ae8bc5256c55976e18f280230b4e2516_2))
...
;; def=Prims.fst(413,99-413,120); use=Bug442.fst(63,4-65,31)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1))
...
;; def=Bug442.fst(62,17-65,12); use=Bug442.fst(63,10-65,12)
(= x_ae8bc5256c55976e18f280230b4e2516_2
(Prims.Cons (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_1)
@x1
@x2))
...
;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(65,30-65,31)
(or label_2

;; def=Bug442.fst(63,4-65,31); use=Bug442.fst(65,30-65,31)
(Valid 
;; def=Bug442.fst(63,4-65,31); use=Bug442.fst(65,30-65,31)
(Prims.precedes Prims.int
Prims.int
...
;; def=Bug442.fst(53,23-65,31); use=Bug442.fst(65,30-65,31)
(and 
;; def=Bug442.fst(53,23-55,38); use=Bug442.fst(65,30-65,31)
(Valid 
;; def=Bug442.fst(53,23-55,38); use=Bug442.fst(65,30-65,31)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
; encoding sigelt let rec walk and finish


; <Start encoding let rec walk and finish>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug442.finish.fuel_instrumented (Fuel Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug442.finish.fuel_instrumented_token () Term)
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug442.walk.fuel_instrumented (Fuel Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug442.walk.fuel_instrumented_token () Term)
(declare-fun Bug442.walk (Term Term Term Term Term Term) Term)
(declare-fun Bug442.walk@tok () Term)
(declare-fun Bug442.finish (Term Term Term Term Term) Term)
(declare-fun Bug442.finish@tok () Term)
...
;;;;;;;;;;;;;;;;rights: Prims.list (dList t) -> l: dList t -> xs: a -> f: (_: a -> _: t -> a) -> Prims.Tot a
(declare-fun Tm_arrow_e4d0b84e2f5efe08f02eabc503e1808c () Term)


;;;;;;;;;;;;;;;;rights: Prims.list (dList t) -> xs: a -> f: (_: a -> _: t -> a) -> Prims.Tot a
(declare-fun Tm_arrow_f5b53fdf5f78412283ea8dab61b75b04 () Term)

; </end encoding let rec walk and finish>


; encoding sigelt val Bug442.walk_alt


; <Skipped val Bug442.walk_alt/>


; encoding sigelt val Bug442.fold


; <Skipped val Bug442.fold/>


; encoding sigelt let fold


; <Start encoding let fold>


(declare-fun Bug442.fold (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;f: (_: a -> _: t -> a) -> st: a -> l: dList t -> a
(declare-fun Tm_arrow_938b80e75fe3078fd9fc939c25522c88 () Term)
(declare-fun Bug442.fold@tok () Term)


; </end encoding let fold>
...
; Starting query at Bug442.fst(78,38-87,46)
...
;;;;;;;;;;;;;;;;rights : Prims.list (Bug442.dList t) (Prims.list (Bug442.dList t))
(declare-fun x_c729c9a6b7d93f2292adbef7925012bf_4 () Term)
;;;;;;;;;;;;;;;;binder_x_c729c9a6b7d93f2292adbef7925012bf_4
;;; Fact-ids: 
(assert (! (HasType x_c729c9a6b7d93f2292adbef7925012bf_4
(Prims.list (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3)))
:named binder_x_c729c9a6b7d93f2292adbef7925012bf_4))
;;;;;;;;;;;;;;;;l : Bug442.dList t (Bug442.dList t)
(declare-fun x_cbe65e0bce0d143b0043591548223bcf_5 () Term)
;;;;;;;;;;;;;;;;binder_x_cbe65e0bce0d143b0043591548223bcf_5
;;; Fact-ids: 
(assert (! (HasType x_cbe65e0bce0d143b0043591548223bcf_5
(Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3))
:named binder_x_cbe65e0bce0d143b0043591548223bcf_5))
;;;;;;;;;;;;;;;;xs : a (a)
(declare-fun x_64a6f2da4341770a4dee8aa1d0d4ae69_6 () Term)
;;;;;;;;;;;;;;;;binder_x_64a6f2da4341770a4dee8aa1d0d4ae69_6
;;; Fact-ids: 
(assert (! (HasType x_64a6f2da4341770a4dee8aa1d0d4ae69_6
x_fe28d8bcde588226b4e538b35321de05_2)
:named binder_x_64a6f2da4341770a4dee8aa1d0d4ae69_6))
;;;;;;;;;;;;;;;;f : _: a -> _: t -> a (_: a -> _: t -> a)
(declare-fun x_826520cae9e0ae3eb514d24fcb1e4a87_7 () Term)
;;;;;;;;;;;;;;;;_: a -> _: t -> a
(declare-fun Tm_arrow_c5b5bef37265cbbc69929745655ae84f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c5b5bef37265cbbc69929745655ae84f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_c5b5bef37265cbbc69929745655ae84f
Tm_type)
:named kinding_Tm_arrow_c5b5bef37265cbbc69929745655ae84f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(78,18-78,22); use=Bug442.fst(78,18-78,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_c5b5bef37265cbbc69929745655ae84f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_c5b5bef37265cbbc69929745655ae84f))
:qid Bug442_pre_typing_Tm_arrow_c5b5bef37265cbbc69929745655ae84f))

:named Bug442_pre_typing_Tm_arrow_c5b5bef37265cbbc69929745655ae84f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c5b5bef37265cbbc69929745655ae84f
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(78,18-78,22); use=Bug442.fst(78,18-78,22)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_c5b5bef37265cbbc69929745655ae84f.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_c5b5bef37265cbbc69929745655ae84f.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_c5b5bef37265cbbc69929745655ae84f))
:qid Bug442_interpretation_Tm_arrow_c5b5bef37265cbbc69929745655ae84f))

:named Bug442_interpretation_Tm_arrow_c5b5bef37265cbbc69929745655ae84f))
;;;;;;;;;;;;;;;;binder_x_826520cae9e0ae3eb514d24fcb1e4a87_7
;;; Fact-ids: 
(assert (! (HasType x_826520cae9e0ae3eb514d24fcb1e4a87_7
Tm_arrow_c5b5bef37265cbbc69929745655ae84f)
:named binder_x_826520cae9e0ae3eb514d24fcb1e4a87_7))

(declare-fun Tm_refine_98f3e9c345dfc4c03765000697f5fc5d (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(69,98-87,46); use=Bug442.fst(69,98-87,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_98f3e9c345dfc4c03765000697f5fc5d @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_98f3e9c345dfc4c03765000697f5fc5d @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_98f3e9c345dfc4c03765000697f5fc5d))

:named refinement_kinding_Tm_refine_98f3e9c345dfc4c03765000697f5fc5d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(69,98-87,46); use=Bug442.fst(69,98-87,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_98f3e9c345dfc4c03765000697f5fc5d @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Bug442.fst(70,22-87,46); use=Bug442.fst(78,8-87,46)

;; def=Bug442.fst(70,22-87,46); use=Bug442.fst(78,8-87,46)
(or 
;; def=Bug442.fst(78,38-87,46); use=Bug442.fst(78,38-87,46)
(Valid 
;; def=Bug442.fst(78,38-87,46); use=Bug442.fst(78,38-87,46)
(Prims.precedes Prims.int
Prims.int
...
(Bug442.lt @x3
@x5))
(Prims.op_Addition (Bug442.ld x_fe28d8bcde588226b4e538b35321de05_3
x_cbe65e0bce0d143b0043591548223bcf_5)
(Bug442.lt x_fe28d8bcde588226b4e538b35321de05_3
x_c729c9a6b7d93f2292adbef7925012bf_4)))
)


;; def=Bug442.fst(70,22-87,46); use=Bug442.fst(78,8-87,46)
(and 
;; def=Bug442.fst(70,22-70,38); use=Bug442.fst(78,8-78,16)
(Valid 
;; def=Bug442.fst(70,22-70,38); use=Bug442.fst(78,8-78,16)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_98f3e9c345dfc4c03765000697f5fc5d))

:named refinement_interpretation_Tm_refine_98f3e9c345dfc4c03765000697f5fc5d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_98f3e9c345dfc4c03765000697f5fc5d
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(69,98-87,46); use=Bug442.fst(69,98-87,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_98f3e9c345dfc4c03765000697f5fc5d @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x1
...
:pattern ((Valid (Prims.hasEq (Tm_refine_98f3e9c345dfc4c03765000697f5fc5d @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_98f3e9c345dfc4c03765000697f5fc5d))

:named haseqTm_refine_98f3e9c345dfc4c03765000697f5fc5d))
(declare-fun Bug442.walk_alt (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;rights: Prims.list (dList t) ->     l: dList t ->     xs: a ->     f:       (_: a -> _: t -> a)         {ld l + lt rights << ld l + lt rights \/ ld l + lt rights === ld l + lt rights /\ 0 << 0}   -> Prims.Tot a
(declare-fun Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0
Tm_type)
:named kinding_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(69,16-87,46); use=Bug442.fst(69,93-87,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0))
:qid Bug442_pre_typing_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0))

:named Bug442_pre_typing_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(69,16-87,46); use=Bug442.fst(69,93-87,46)
(forall ((@x0 Term))
...
@x1)
(HasType @x6
(Tm_refine_98f3e9c345dfc4c03765000697f5fc5d @x1
@x2
@x4
@x3)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
...
@x5)
@x6))
:qid Bug442_interpretation_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0.2))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0.3))
...
@x2)
@x3))
:qid Bug442_interpretation_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0.4))
...
@x3)
@x4))
:qid Bug442_interpretation_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0.5))
...
@x4)
@x5))
:qid Bug442_interpretation_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0.6))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0))
:qid Bug442_interpretation_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0))

:named Bug442_interpretation_Tm_arrow_04be5c8b1fbe639c69151e98b4ab79a0))
(declare-fun Bug442.walk_alt@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(78,8-78,16); use=Bug442.fst(78,8-78,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug442.walk_alt@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug442.walk_alt@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5))
:qid token_correspondence_Bug442.walk_alt))

:named token_correspondence_Bug442.walk_alt))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(78,8-78,16); use=Bug442.fst(78,8-78,16)
...
:pattern ((Bug442.walk_alt @x1
@x2
@x3
@x4
@x5
@x6))
:qid function_token_typing_Bug442.walk_alt.1))
)
 

:pattern ((ApplyTT @x0
Bug442.walk_alt@tok))
:qid function_token_typing_Bug442.walk_alt))

:named function_token_typing_Bug442.walk_alt))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(78,8-78,16); use=Bug442.fst(78,8-78,16)
...
@x0)
(HasType @x5
(Tm_refine_98f3e9c345dfc4c03765000697f5fc5d @x0
@x1
@x3
@x2)))
(HasType (Bug442.walk_alt @x0
@x1
@x2
@x3
@x4
...
:pattern ((Bug442.walk_alt @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_Bug442.walk_alt))

:named typing_Bug442.walk_alt))
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_9b177e30c3ed7cd63e71d5a51b16b712 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_9b177e30c3ed7cd63e71d5a51b16b712
Tm_type)
:named refinement_kinding_Tm_refine_9b177e30c3ed7cd63e71d5a51b16b712))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(79,13-79,103); use=Bug442.fst(79,13-79,103)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_9b177e30c3ed7cd63e71d5a51b16b712)
(and (HasTypeFuel @u0
@x1
(Prims.list (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3)))

;; def=Bug442.fst(79,37-79,101); use=Bug442.fst(79,37-79,101)
(or 
;; def=Bug442.fst(79,37-79,54); use=Bug442.fst(79,37-79,54)
(= @x1
x_c729c9a6b7d93f2292adbef7925012bf_4)


;; def=Bug442.fst(79,58-79,101); use=Bug442.fst(79,58-79,101)
(and 
;; def=Bug442.fst(79,58-79,71); use=Bug442.fst(79,58-79,71)
(BoxBool_proj_0 (Prims.uu___is_Cons (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3)
@x1))


;; def=Bug442.fst(79,75-79,101); use=Bug442.fst(79,75-79,101)
(= (Prims.__proj__Cons__item__tl (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3)
@x1)
x_c729c9a6b7d93f2292adbef7925012bf_4)
)
)
...
@x1
Tm_refine_9b177e30c3ed7cd63e71d5a51b16b712))
:qid refinement_interpretation_Tm_refine_9b177e30c3ed7cd63e71d5a51b16b712))

:named refinement_interpretation_Tm_refine_9b177e30c3ed7cd63e71d5a51b16b712))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9b177e30c3ed7cd63e71d5a51b16b712
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_9b177e30c3ed7cd63e71d5a51b16b712))
(Valid (Prims.hasEq (Prims.list (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3)))))
:named haseqTm_refine_9b177e30c3ed7cd63e71d5a51b16b712))



;;;;;;;;;;;;;;;;rights': Prims.list (dList t) {rights' == rights \/ Cons? rights' /\ rights'.tl == rights} ->     xs: a ->     f: (_: a -> _: t -> a)   -> a
(declare-fun Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0
Tm_type)
:named kinding_Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(78,18-79,103); use=Bug442.fst(78,38-87,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0))
:qid Bug442_pre_typing_Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0))

:named Bug442_pre_typing_Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(78,18-79,103); use=Bug442.fst(78,38-87,46)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid Bug442_interpretation_Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug442_interpretation_Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0.2))
...
@x1)
@x2))
:qid Bug442_interpretation_Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0))
:qid Bug442_interpretation_Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0))

:named Bug442_interpretation_Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0))





(declare-fun Tm_abs_56655e28d431c6322619bf34070e3c9b () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_56655e28d431c6322619bf34070e3c9b
;;; Fact-ids: 
(assert (! (HasType Tm_abs_56655e28d431c6322619bf34070e3c9b
Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0)
:named typing_Tm_abs_56655e28d431c6322619bf34070e3c9b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_56655e28d431c6322619bf34070e3c9b
;;; Fact-ids: 
(assert (! 
;; def=Bug442.fst(80,6-82,37); use=Bug442.fst(80,6-82,37)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Tm_abs_56655e28d431c6322619bf34070e3c9b
@x0)
@x1)
@x2)
(let ((@lb3 x_c729c9a6b7d93f2292adbef7925012bf_4))
(ite (is-Prims.Nil @lb3)
@x1
(ite (is-Prims.Cons @lb3)
(Bug442.walk_alt x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3
(Prims.Cons_tl @lb3)
(Prims.Cons_hd @lb3)
@x1
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Tm_abs_56655e28d431c6322619bf34070e3c9b
@x0)
@x1)
@x2))
:qid interpretation_Tm_abs_56655e28d431c6322619bf34070e3c9b))

:named interpretation_Tm_abs_56655e28d431c6322619bf34070e3c9b))

; Encoding query formula : (forall (rights':
;     Prims.list (Bug442.dList t) {rights' == rights \/ Cons? rights' /\ rights'.tl == rights})
;     (xs: a)
;     (f: (_: a -> _: t -> a)).
;     (*  - Could not prove post-condition
; *)
...
;         (forall (b: Bug442.dList t) (b: Prims.list (Bug442.dList t)).
;             rights == b :: b ==>
;             Bug442.ld b + Bug442.lt b << Bug442.ld l + Bug442.lt rights \/
;             Bug442.ld b + Bug442.lt b === Bug442.ld l + Bug442.lt rights /\ 0 << 0))) /\
; (forall (any_result:
;     (
;           rights':
;             Prims.list (Bug442.dList t) {rights' == rights \/ Cons? rights' /\ rights'.tl == rights} ->
...
;         (match rights with
;           | [] -> xs
;           | hd :: tl -> Bug442.walk_alt tl hd xs f)
;         <:
;         a) ==
;     any_result ==>
;     (forall (k: Prims.pure_post a).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec walk_alt`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(78,38-87,46)
(and 
;; def=dummy(0,0-0,0); use=Bug442.fst(78,38-87,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_refine_9b177e30c3ed7cd63e71d5a51b16b712)
(HasType @x1
...
;; def=Prims.fst(402,27-402,88); use=Bug442.fst(80,6-82,37)
(forall ((@x4 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(80,6-82,37)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(80,6-82,37)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(80,6-82,37)
(and (implies 
;; def=Bug442.fst(78,23-78,29); use=Bug442.fst(80,12-80,18)
(and 
;; def=Bug442.fst(78,23-78,29); use=Bug442.fst(80,12-80,18)
(not 
;; def=Bug442.fst(78,23-78,29); use=Bug442.fst(80,12-80,18)
(BoxBool_proj_0 (Prims.uu___is_Nil (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3)
x_c729c9a6b7d93f2292adbef7925012bf_4))
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Bug442.fst(80,6-82,37)
(not 
;; def=Bug442.fst(78,23-78,29); use=Bug442.fst(80,12-80,18)
(BoxBool_proj_0 (Prims.uu___is_Nil (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3)
x_c729c9a6b7d93f2292adbef7925012bf_4))
...
;; def=Prims.fst(413,99-413,120); use=Bug442.fst(80,6-82,37)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3))
...
;; def=Bug442.fst(78,23-82,14); use=Bug442.fst(80,12-82,14)
(= x_c729c9a6b7d93f2292adbef7925012bf_4
(Prims.Cons (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3)
@x4
@x5))
)

;; def=Bug442.fst(70,22-87,46); use=Bug442.fst(82,36-82,37)
(or label_2

;; def=Bug442.fst(78,38-87,46); use=Bug442.fst(82,36-82,37)
(Valid 
;; def=Bug442.fst(78,38-87,46); use=Bug442.fst(82,36-82,37)
(Prims.precedes Prims.int
Prims.int
...
;; def=Bug442.fst(70,22-87,46); use=Bug442.fst(82,36-82,37)
(and 
;; def=Bug442.fst(70,22-70,38); use=Bug442.fst(82,36-82,37)
(Valid 
;; def=Bug442.fst(70,22-70,38); use=Bug442.fst(82,36-82,37)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
;; def=Prims.fst(451,66-451,102); use=Bug442.fst(78,38-87,46)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Tm_arrow_36ec9dbea0b2e518d2eb1b4bb52cc0e0)

;; def=Bug442.fst(79,6-82,37); use=Bug442.fst(79,6-82,37)
(= Tm_abs_56655e28d431c6322619bf34070e3c9b
@x0)
)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
...
;; def=Prims.fst(402,27-402,88); use=Bug442.fst(78,38-87,46)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(78,38-87,46)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug442.fst(78,38-87,46)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(78,38-87,46)
(and (implies 
;; def=Bug442.fst(78,30-78,31); use=Bug442.fst(84,8-84,9)
(and 
;; def=Bug442.fst(78,30-78,31); use=Bug442.fst(84,8-84,9)
(not 
;; def=Bug442.fst(78,30-78,31); use=Bug442.fst(84,8-84,9)
(BoxBool_proj_0 (Bug442.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_3
x_cbe65e0bce0d143b0043591548223bcf_5))
)
...
(not 
;; def=Bug442.fst(78,30-78,31); use=Bug442.fst(84,8-84,9)
(BoxBool_proj_0 (Bug442.uu___is_Unit x_fe28d8bcde588226b4e538b35321de05_3
x_cbe65e0bce0d143b0043591548223bcf_5))
)
...
(not 
;; def=Bug442.fst(78,30-78,31); use=Bug442.fst(84,8-84,9)
(BoxBool_proj_0 (Bug442.uu___is_Join x_fe28d8bcde588226b4e538b35321de05_3
x_cbe65e0bce0d143b0043591548223bcf_5))
)
)
...
label_3)
(implies 
;; def=Prims.fst(389,18-389,39); use=Bug442.fst(78,38-87,46)
(and 
;; def=Prims.fst(389,19-389,21); use=Bug442.fst(78,38-87,46)
(not 
;; def=Bug442.fst(78,30-78,31); use=Bug442.fst(84,8-84,9)
(BoxBool_proj_0 (Bug442.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_3
x_cbe65e0bce0d143b0043591548223bcf_5))
...
;; def=Prims.fst(413,99-413,120); use=Bug442.fst(78,38-87,46)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Bug442.dList1 x_fe28d8bcde588226b4e538b35321de05_3))
...
;; def=Bug442.fst(78,30-87,14); use=Bug442.fst(84,8-87,14)
(= x_cbe65e0bce0d143b0043591548223bcf_5
(Bug442.Join x_fe28d8bcde588226b4e538b35321de05_3
@x2
@x3
@x4))
)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(78,38-87,46)
(and 
;; def=Bug442.fst(34,30-34,47); use=Bug442.fst(87,29-87,30)
(or label_4

;; def=Bug442.fst(34,30-34,47); use=Bug442.fst(87,29-87,30)
(BoxBool_proj_0 (Bug442.isCorrectJoined x_fe28d8bcde588226b4e538b35321de05_3
@x3))
)
...
;; def=Prims.fst(616,11-616,13); use=Bug442.fst(78,38-87,46)
(= @x3
@x5)
)
...
;; def=Bug442.fst(69,45-87,39); use=Bug442.fst(78,38-87,46)
(= (Prims.Cons (Bug442.dList x_fe28d8bcde588226b4e538b35321de05_3)
@x3
x_c729c9a6b7d93f2292adbef7925012bf_4)
@x6)
...
;; def=Prims.fst(459,77-459,89); use=Bug442.fst(78,38-87,46)
(and 
;; def=Bug442.fst(34,30-34,47); use=Bug442.fst(87,40-87,41)
(or label_5
...
;; def=Bug442.fst(69,73-87,10); use=Bug442.fst(78,38-87,46)
(= @x2
@x7)
)

;; def=Bug442.fst(70,22-87,46); use=Bug442.fst(87,45-87,46)
(or label_6

;; def=Bug442.fst(78,38-87,46); use=Bug442.fst(87,45-87,46)
(Valid 
;; def=Bug442.fst(78,38-87,46); use=Bug442.fst(87,45-87,46)
(Prims.precedes Prims.int
Prims.int
...
;; def=Bug442.fst(70,22-87,46); use=Bug442.fst(87,45-87,46)
(and 
;; def=Bug442.fst(70,22-70,38); use=Bug442.fst(87,45-87,46)
(Valid 
;; def=Bug442.fst(70,22-70,38); use=Bug442.fst(87,45-87,46)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug442.walk_alt, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_Bug442.isCorrectJoined.fuel_instrumented, @fuel_correspondence_Bug442.ld.fuel_instrumented, @fuel_correspondence_Bug442.lt.fuel_instrumented, @fuel_irrelevance_Bug442.isCorrectJoined.fuel_instrumented, @fuel_irrelevance_Bug442.ld.fuel_instrumented, @fuel_irrelevance_Bug442.lt.fuel_instrumented, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_c729c9a6b7d93f2292adbef7925012bf_4, binder_x_cbe65e0bce0d143b0043591548223bcf_5, binder_x_fe28d8bcde588226b4e538b35321de05_3, bool_inversion, constructor_distinct_Prims.Cons, data_elim_Bug442.Join, disc_equation_Bug442.Join, disc_equation_Bug442.Nil, disc_equation_Bug442.Unit, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_Bug442.dList, equation_Prims.nat, equation_with_fuel_Bug442.isCorrectJoined.fuel_instrumented, equation_with_fuel_Bug442.ld.fuel_instrumented, equation_with_fuel_Bug442.lt.fuel_instrumented, fuel_guarded_inversion_Bug442.dList1, fuel_guarded_inversion_Prims.list, function_token_typing_Prims.__cache_version_number__, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_AmpAmp, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_Bug442.Join__0, projection_inverse_Bug442.Join__1, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, refinement_interpretation_Tm_refine_3ead50dd0e0b905474660e381a6a1021, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_Bug442.isCorrectJoined.fuel_instrumented, token_correspondence_Bug442.ld.fuel_instrumented, typing_Bug442.ld, typing_Bug442.lt, typing_Bug442.uu___is_Nil, well-founded-ordering-on-nat
