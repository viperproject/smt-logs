...
; encoding sigelt type Bug1521.path


; <Start encoding type Bug1521.path>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1521.path () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1521.L (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug1521.L__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1521.L
(declare-fun Bug1521.L@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1521.O () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1521.O
(declare-fun Bug1521.O@tok () Term)
;;;;;;;;;;;;;;;;_0: path -> path
(declare-fun Tm_arrow_125636df61a3b48361cfdf4a0c95ad0a () Term)

; <start constructor Bug1521.path>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1521.path ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
Bug1521.path)))

; </end constructor Bug1521.path>


; <start constructor Bug1521.L>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1521.L ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
(Bug1521.L (Bug1521.L__0 __@x0)))))

; </end constructor Bug1521.L>


; <start constructor Bug1521.O>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1521.O ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
127)
(= __@x0
Bug1521.O)))

; </end constructor Bug1521.O>


; </end encoding type Bug1521.path>
...
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! (HasType Bug1521.O@tok
Bug1521.path)
:named typing_tok_Bug1521.O@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(18,14-18,15); use=Bug1521.fst(18,14-18,15)
...
(Bug1521.L @x1)
Bug1521.path))
:qid subterm_ordering_Bug1521.L))

:named subterm_ordering_Bug1521.L))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=Bug1521.fst(18,14-18,15); use=Bug1521.fst(18,14-18,15)
(forall ((@x0 Term))
 (! (= (Bug1521.L__0 (Bug1521.L @x0))
@x0)
 

:pattern ((Bug1521.L @x0))
:qid projection_inverse_Bug1521.L__0))

:named projection_inverse_Bug1521.L__0))
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! (HasType Bug1521.path
Tm_type)
:named kinding_Bug1521.path@tok))
...
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(18,5-18,9); use=Bug1521.fst(18,5-18,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Bug1521.path)
...
@x1
Bug1521.path))
:qid fuel_guarded_inversion_Bug1521.path))

:named fuel_guarded_inversion_Bug1521.path))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! (= Bug1521.O@tok
Bug1521.O)
:named equality_tok_Bug1521.O@tok))
...
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(18,26-18,27); use=Bug1521.fst(18,26-18,27)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug1521.O
Bug1521.path)
...
Bug1521.O
Bug1521.path))
:qid data_typing_intro_Bug1521.O@tok))

:named data_typing_intro_Bug1521.O@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(18,14-18,15); use=Bug1521.fst(18,14-18,15)
...
(Bug1521.L @x1)
Bug1521.path))
:qid data_typing_intro_Bug1521.L@tok))

:named data_typing_intro_Bug1521.L@tok))
...
(Bug1521.L @x1)
Bug1521.path))
:qid data_elim_Bug1521.L))

:named data_elim_Bug1521.L))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! (= 116
(Term_constr_id Bug1521.path))
:named constructor_distinct_Bug1521.path))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! (= 127
(Term_constr_id Bug1521.O))
:named constructor_distinct_Bug1521.O))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(18,14-18,15); use=Bug1521.fst(18,14-18,15)
(forall ((@x0 Term))
 (! (= 122
(Term_constr_id (Bug1521.L @x0)))
 

:pattern ((Bug1521.L @x0))
:qid constructor_distinct_Bug1521.L))

:named constructor_distinct_Bug1521.L))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Bug1521.path))
:qid Bug1521_pretyping_538b050355c5823fce12a10739d2b4f7))

:named Bug1521_pretyping_538b050355c5823fce12a10739d2b4f7))
(push) ;; push{4

; Starting query at Bug1521.fst(18,0-18,27)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq Bug1521.path ==>
; (forall (_0: Bug1521.path).
...
; *)
;     Prims.hasEq Bug1521.path)


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug1521.path`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=Bug1521.fst(18,0-18,27); use=Bug1521.fst(18,0-18,27)
(Valid 
;; def=Bug1521.fst(18,0-18,27); use=Bug1521.fst(18,0-18,27)
(Prims.hasEq Bug1521.path)
)
...
;; def=Bug1521.fst(18,0-18,27); use=Bug1521.fst(18,19-18,23)
(or label_1
...
; encoding sigelt assume Bug1521.path__uu___haseq


; <Start encoding assume Bug1521.path__uu___haseq>


; </end encoding assume Bug1521.path__uu___haseq>


; encoding sigelt val Bug1521.uu___is_L


; <Start encoding val Bug1521.uu___is_L>

(declare-fun Bug1521.uu___is_L (Term) Term)
;;;;;;;;;;;;;;;;projectee: path -> Prims.bool
(declare-fun Tm_arrow_a76ebb6b0850ac07b334379a49c37f53 () Term)
(declare-fun Bug1521.uu___is_L@tok () Term)

; </end encoding val Bug1521.uu___is_L>


; encoding sigelt let uu___is_L


; <Skipped let uu___is_L/>


; encoding sigelt val Bug1521.__proj__L__item___0


; <Start encoding val Bug1521.__proj__L__item___0>

(declare-fun Tm_refine_2ee8b37671e156e8fc8e545cda428828 () Term)
(declare-fun Bug1521.__proj__L__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: path{L? _} -> path
(declare-fun Tm_arrow_511fcb6f72b56fe61e97ae9ee2ae23c1 () Term)
(declare-fun Bug1521.__proj__L__item___0@tok () Term)

; </end encoding val Bug1521.__proj__L__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1521.uu___is_L; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(18,14-18,15); use=Bug1521.fst(18,14-18,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1521.path)
(HasType (Bug1521.uu___is_L @x0)
Prims.bool))
 

:pattern ((Bug1521.uu___is_L @x0))
:qid typing_Bug1521.uu___is_L))

:named typing_Bug1521.uu___is_L))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(18,14-18,15); use=Bug1521.fst(18,14-18,15)
...
:named refinement_kinding_Tm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug1521.__proj__L__item___0; Namespace Bug1521
(assert (! (HasType Tm_refine_2ee8b37671e156e8fc8e545cda428828
Tm_type)
:named refinement_kinding_Tm_refine_2ee8b37671e156e8fc8e545cda428828))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(772,26-772,42); use=FStar.Pervasives.fsti(772,26-772,42)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_2ee8b37671e156e8fc8e545cda428828)
(and (HasTypeFuel @u0
@x1
Bug1521.path)

;; def=Bug1521.fst(18,14-18,15); use=Bug1521.fst(18,14-18,15)
(BoxBool_proj_0 (Bug1521.uu___is_L @x1))
))
...
@x1
Tm_refine_2ee8b37671e156e8fc8e545cda428828))
:qid refinement_interpretation_Tm_refine_2ee8b37671e156e8fc8e545cda428828))

:named refinement_interpretation_Tm_refine_2ee8b37671e156e8fc8e545cda428828))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug1521.path; Namespace Bug1521; Name Bug1521.L; Namespace Bug1521; Name Bug1521.O; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(18,14-18,15); use=Bug1521.fst(18,14-18,15)
...
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_2ee8b37671e156e8fc8e545cda428828
;;; Fact-ids: Name Bug1521.__proj__L__item___0; Namespace Bug1521
(assert (! (iff (Valid (Prims.hasEq Tm_refine_2ee8b37671e156e8fc8e545cda428828))
(Valid (Prims.hasEq Bug1521.path)))
:named haseqTm_refine_2ee8b37671e156e8fc8e545cda428828))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
;; def=Bug1521.fst(18,14-18,15); use=Bug1521.fst(18,14-18,15)
(forall ((@x0 Term))
 (! (= (Bug1521.uu___is_L @x0)
(BoxBool (is-Bug1521.L @x0)))
 

:pattern ((Bug1521.uu___is_L @x0))
:qid disc_equation_Bug1521.L))

:named disc_equation_Bug1521.L))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: Bug1521.path__uu___haseq
;;; Fact-ids: Name Bug1521.path__uu___haseq; Namespace Bug1521
(assert (! (Valid (Prims.hasEq Bug1521.path))
:named assumption_Bug1521.path__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Encoding query formula : forall (projectee: _: Bug1521.path{L? _}).
;   (*  - Could not prove post-condition
; *) ~(L? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__L__item___0`
...
(not 
;; def=Bug1521.fst(18,14-18,15); use=Bug1521.fst(18,14-18,15)
(BoxBool_proj_0 (Bug1521.uu___is_L @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1521.__proj__L__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_2ee8b37671e156e8fc8e545cda428828
...
; encoding sigelt let __proj__L__item___0


; <Skipped let __proj__L__item___0/>


; encoding sigelt val Bug1521.uu___is_O


; <Start encoding val Bug1521.uu___is_O>

(declare-fun Bug1521.uu___is_O (Term) Term)

(declare-fun Bug1521.uu___is_O@tok () Term)

; </end encoding val Bug1521.uu___is_O>
...
; encoding sigelt type Bug1521.heap


; <Start encoding type Bug1521.heap>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1521.heap () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1521.Mkheap (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug1521.Mkheap_pos (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1521.Mkheap
(declare-fun Bug1521.Mkheap@tok () Term)
;;;;;;;;;;;;;;;;pos: path -> Bug1521.heap
(declare-fun Tm_arrow_07b5d9f3cf95be32127a0db4efd47107 () Term)

; <start constructor Bug1521.heap>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1521.heap ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
149)
(= __@x0
Bug1521.heap)))

; </end constructor Bug1521.heap>


; <start constructor Bug1521.Mkheap>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1521.Mkheap ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
155)
(= __@x0
(Bug1521.Mkheap (Bug1521.Mkheap_pos __@x0)))))

; </end constructor Bug1521.Mkheap>


; </end encoding type Bug1521.heap>


; encoding sigelt val Bug1521.__proj__Mkheap__item__pos


; <Start encoding val Bug1521.__proj__Mkheap__item__pos>

(declare-fun Bug1521.__proj__Mkheap__item__pos (Term) Term)
;;;;;;;;;;;;;;;;projectee: Bug1521.heap -> path
(declare-fun Tm_arrow_bd4a251bb1234be3883a42f545e173e2 () Term)
(declare-fun Bug1521.__proj__Mkheap__item__pos@tok () Term)

; </end encoding val Bug1521.__proj__Mkheap__item__pos>


; encoding sigelt let __proj__Mkheap__item__pos


; <Skipped let __proj__Mkheap__item__pos/>


; encoding sigelt let prefix


; <Start encoding let prefix>

(declare-fun Bug1521.prefix (Term Term) Term)
;;;;;;;;;;;;;;;;p1: path -> p2: path -> Prims.logical
(declare-fun Tm_arrow_d73725a02bbc3f7be330be6990ba6360 () Term)
(declare-fun Bug1521.prefix@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1521.prefix; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(24,4-24,10); use=Bug1521.fst(24,4-24,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Bug1521.path)
(HasType @x1
Bug1521.path))
(HasType (Bug1521.prefix @x0
@x1)
Prims.logical))
 

:pattern ((Bug1521.prefix @x0
@x1))
:qid typing_Bug1521.prefix))

:named typing_Bug1521.prefix))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for Bug1521.prefix
;;; Fact-ids: Name Bug1521.prefix; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(24,4-24,10); use=Bug1521.fst(24,4-24,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (Bug1521.prefix @x0
@x1))

;; def=Bug1521.fst(24,28-24,33); use=Bug1521.fst(24,28-24,33)
false
)
...
:pattern ((Bug1521.prefix @x0
@x1))
:qid equation_Bug1521.prefix))

:named equation_Bug1521.prefix))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
:named equality_tok_Prims.T@tok))
;;;;;;;;;;;;;;;;Prop-typing for Bug1521.prefix
;;; Fact-ids: Name Bug1521.prefix; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(24,4-24,10); use=Bug1521.fst(24,4-24,10)
(forall ((@x0 Term) (@x1 Term))
...
(HasType @x1
Bug1521.path))
(Valid (Prims.subtype_of (Bug1521.prefix @x0
@x1)
Prims.unit)))
 

:pattern ((Prims.subtype_of (Bug1521.prefix @x0
@x1)
Prims.unit))
:qid defn_equation_Bug1521.prefix))

:named defn_equation_Bug1521.prefix))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
; Starting query at Bug1521.fst(28,94-28,96)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (p1: Bug1521.path) (p2: Bug1521.path) (p3: Bug1521.path).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     Bug1521.prefix p1 p2 /\ Bug1521.prefix p2 p3 /\
;     (forall (pure_result: Prims.unit). Bug1521.prefix p1 p3 ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let prefix_trans`
...
;; def=Bug1521.fst(26,54-26,66); use=Bug1521.fst(28,94-28,96)
(Valid 
;; def=Bug1521.fst(26,54-26,66); use=Bug1521.fst(28,94-28,96)
(Bug1521.prefix @x0
@x1)
...
;; def=Bug1521.fst(26,70-26,82); use=Bug1521.fst(28,94-28,96)
(Valid 
;; def=Bug1521.fst(26,70-26,82); use=Bug1521.fst(28,94-28,96)
(Bug1521.prefix @x1
@x2)
...
;; def=Prims.fst(441,36-441,97); use=Bug1521.fst(28,94-28,96)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=Bug1521.fst(27,52-27,66); use=Bug1521.fst(28,94-28,96)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(28,94-28,96)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(28,94-28,96)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1521.prefix_trans, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Bug1521.prefix
...
; encoding sigelt let prefix_trans


; <Start encoding let prefix_trans>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug1521.prefix_trans (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug1521.prefix_trans@tok () Term)

; </end encoding let prefix_trans>
...
(declare-fun Bug1521.heap_rel (Term Term) Term)
;;;;;;;;;;;;;;;;h1: Bug1521.heap -> h2: Bug1521.heap -> Prims.logical
(declare-fun Tm_arrow_c0c36b60ee089d8321bcc3ef838845c2 () Term)
(declare-fun Bug1521.heap_rel@tok () Term)

; </end encoding let heap_rel>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1521.heap_rel; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(30,4-30,12); use=Bug1521.fst(30,4-30,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Bug1521.heap)
(HasType @x1
Bug1521.heap))
(HasType (Bug1521.heap_rel @x0
@x1)
Prims.logical))
 

:pattern ((Bug1521.heap_rel @x0
@x1))
:qid typing_Bug1521.heap_rel))

:named typing_Bug1521.heap_rel))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1521.__proj__Mkheap__item__pos; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(21,2-21,5); use=Bug1521.fst(21,2-21,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug1521.heap)
(HasType (Bug1521.__proj__Mkheap__item__pos @x0)
Bug1521.path))
 

:pattern ((Bug1521.__proj__Mkheap__item__pos @x0))
:qid typing_Bug1521.__proj__Mkheap__item__pos))

:named typing_Bug1521.__proj__Mkheap__item__pos))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug1521.heap; Namespace Bug1521; Name Bug1521.Mkheap; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(20,18-20,22); use=Bug1521.fst(20,18-20,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Bug1521.Mkheap @x1)
Bug1521.heap)
...
(Bug1521.Mkheap @x1)
Bug1521.heap))
:qid subterm_ordering_Bug1521.Mkheap))

:named subterm_ordering_Bug1521.Mkheap))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug1521.heap; Namespace Bug1521; Name Bug1521.Mkheap; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(20,18-20,22); use=Bug1521.fst(20,18-20,22)
(forall ((@x0 Term))
 (! (= (Bug1521.Mkheap_pos (Bug1521.Mkheap @x0))
@x0)
 

:pattern ((Bug1521.Mkheap @x0))
:qid projection_inverse_Bug1521.Mkheap_pos))

:named projection_inverse_Bug1521.Mkheap_pos))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Bug1521.__proj__Mkheap__item__pos; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(21,2-21,5); use=Bug1521.fst(21,2-21,5)
(forall ((@x0 Term))
 (! (= (Bug1521.__proj__Mkheap__item__pos @x0)
(Bug1521.Mkheap_pos @x0))
 

:pattern ((Bug1521.__proj__Mkheap__item__pos @x0))
:qid proj_equation_Bug1521.Mkheap_pos))

:named proj_equation_Bug1521.Mkheap_pos))
;;;;;;;;;;;;;;;;Lemma: Bug1521.prefix_trans
;;; Fact-ids: Name Bug1521.prefix_trans; Namespace Bug1521
...
;; def=Bug1521.fst(26,54-26,66); use=Bug1521.fst(26,54-26,66)
(Valid 
;; def=Bug1521.fst(26,54-26,66); use=Bug1521.fst(26,54-26,66)
(Bug1521.prefix @x0
@x1)
...
;; def=Bug1521.fst(26,70-26,82); use=Bug1521.fst(26,70-26,82)
(Valid 
;; def=Bug1521.fst(26,70-26,82); use=Bug1521.fst(26,70-26,82)
(Bug1521.prefix @x1
@x2)
...
;; def=Bug1521.fst(27,52-27,66); use=Bug1521.fst(27,52-27,66)
(Valid 
;; def=Bug1521.fst(27,52-27,66); use=Bug1521.fst(27,52-27,66)
(Bug1521.prefix @x0
@x2)
...
:pattern ((Bug1521.prefix @x0
@x1) (Bug1521.prefix @x1
@x2))
:qid lemma_Bug1521.prefix_trans))
:named lemma_Bug1521.prefix_trans))
;;; Fact-ids: Name Bug1521.heap; Namespace Bug1521; Name Bug1521.Mkheap; Namespace Bug1521
(assert (! (HasType Bug1521.heap
Tm_type)
:named kinding_Bug1521.heap@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug1521.heap; Namespace Bug1521; Name Bug1521.Mkheap; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(20,18-20,22); use=Bug1521.fst(20,18-20,22)
...
@x1
Bug1521.heap)
(is-Bug1521.Mkheap @x1))
 

:pattern ((HasTypeFuel @u0
@x1
Bug1521.heap))
:qid fuel_guarded_inversion_Bug1521.heap))

:named fuel_guarded_inversion_Bug1521.heap))
;;;;;;;;;;;;;;;;Equation for Bug1521.heap_rel
;;; Fact-ids: Name Bug1521.heap_rel; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(30,4-30,12); use=Bug1521.fst(30,4-30,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (Bug1521.heap_rel @x0
@x1))

;; def=Bug1521.fst(30,35-30,55); use=Bug1521.fst(30,35-30,55)
(Valid 
;; def=Bug1521.fst(30,35-30,55); use=Bug1521.fst(30,35-30,55)
(Bug1521.prefix (Bug1521.__proj__Mkheap__item__pos @x0)
(Bug1521.__proj__Mkheap__item__pos @x1))
)
)
...
:pattern ((Bug1521.heap_rel @x0
@x1))
:qid equation_Bug1521.heap_rel))

:named equation_Bug1521.heap_rel))
;;;;;;;;;;;;;;;;Equation for Bug1521.heap_rel
;;; Fact-ids: Name Bug1521.heap_rel; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(30,4-30,12); use=Bug1521.fst(30,4-30,12)
...
:pattern ((Prims.subtype_of (Bug1521.heap_rel @x0
@x1)
Prims.unit))
:qid defn_equation_Bug1521.heap_rel))

:named defn_equation_Bug1521.heap_rel))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug1521.heap; Namespace Bug1521; Name Bug1521.Mkheap; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(20,18-20,22); use=Bug1521.fst(20,18-20,22)
...
(Bug1521.Mkheap @x1)
Bug1521.heap))
:qid data_typing_intro_Bug1521.Mkheap@tok))

:named data_typing_intro_Bug1521.Mkheap@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug1521.heap; Namespace Bug1521; Name Bug1521.Mkheap; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(20,18-20,22); use=Bug1521.fst(20,18-20,22)
...
(Bug1521.Mkheap @x1)
Bug1521.heap))
:qid data_elim_Bug1521.Mkheap))

:named data_elim_Bug1521.Mkheap))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug1521.heap; Namespace Bug1521; Name Bug1521.Mkheap; Namespace Bug1521
(assert (! (= 149
(Term_constr_id Bug1521.heap))
:named constructor_distinct_Bug1521.heap))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug1521.heap; Namespace Bug1521; Name Bug1521.Mkheap; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(20,18-20,22); use=Bug1521.fst(20,18-20,22)
(forall ((@x0 Term))
 (! (= 155
(Term_constr_id (Bug1521.Mkheap @x0)))
 

:pattern ((Bug1521.Mkheap @x0))
:qid constructor_distinct_Bug1521.Mkheap))

:named constructor_distinct_Bug1521.Mkheap))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug1521.heap; Namespace Bug1521; Name Bug1521.Mkheap; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(20,18-20,22); use=Bug1521.fst(20,18-20,22)
...
@x0
Bug1521.heap))
:qid Bug1521_pretyping_4e1b23f985743022cd8e46460a63280d))

:named Bug1521_pretyping_4e1b23f985743022cd8e46460a63280d))
(push) ;; push{2

; Starting query at Bug1521.fst(33,2-33,25)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_82a3291aab6fa34e6b2f50c9328babba (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(32,34-32,68); use=Bug1521.fst(32,34-32,68)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_82a3291aab6fa34e6b2f50c9328babba @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_82a3291aab6fa34e6b2f50c9328babba @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_82a3291aab6fa34e6b2f50c9328babba))

:named refinement_kinding_Tm_refine_82a3291aab6fa34e6b2f50c9328babba))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(32,34-32,68); use=Bug1521.fst(32,34-32,68)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_82a3291aab6fa34e6b2f50c9328babba @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Bug1521.fst(32,35-32,49); use=Bug1521.fst(32,35-32,49)
(Valid 
;; def=Bug1521.fst(32,35-32,49); use=Bug1521.fst(32,35-32,49)
(Bug1521.heap_rel @x2
@x3)
...
;; def=Bug1521.fst(32,53-32,67); use=Bug1521.fst(32,53-32,67)
(Valid 
;; def=Bug1521.fst(32,53-32,67); use=Bug1521.fst(32,53-32,67)
(Bug1521.heap_rel @x3
@x4)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_82a3291aab6fa34e6b2f50c9328babba))

:named refinement_interpretation_Tm_refine_82a3291aab6fa34e6b2f50c9328babba))
;;;;;;;;;;;;;;;;haseq for Tm_refine_82a3291aab6fa34e6b2f50c9328babba
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(32,34-32,68); use=Bug1521.fst(32,34-32,68)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_82a3291aab6fa34e6b2f50c9328babba @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_82a3291aab6fa34e6b2f50c9328babba @x0
@x1
@x2))))
:qid haseqTm_refine_82a3291aab6fa34e6b2f50c9328babba))

:named haseqTm_refine_82a3291aab6fa34e6b2f50c9328babba))

; Encoding query formula : forall (h1: Bug1521.heap)
;   (h2: Bug1521.heap)
;   (h3: Bug1521.heap)
;   (_: _: Prims.unit{Bug1521.heap_rel h1 h2 /\ Bug1521.heap_rel h2 h3}).
;   (*  - Could not prove post-condition
; *) Prims.auto_squash (Bug1521.heap_rel h1 h3)


; Context: While encoding a query
; While typechecking the top-level declaration `let rtest0`
...
Bug1521.heap)
(HasType @x3
(Tm_refine_82a3291aab6fa34e6b2f50c9328babba @x0
@x1
@x2)))

;; def=Bug1521.fst(33,9-33,25); use=Bug1521.fst(33,9-33,25)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1521.rtest0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Bug1521.heap_rel, equation_Bug1521.prefix, fuel_guarded_inversion_Bug1521.heap, proj_equation_Bug1521.Mkheap_pos, refinement_interpretation_Tm_refine_82a3291aab6fa34e6b2f50c9328babba
...
; encoding sigelt let rtest0


; <Start encoding let rtest0>

(declare-fun Bug1521.rtest0 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;h1: Bug1521.heap -> h2: Bug1521.heap -> h3: Bug1521.heap -> _: heap_rel h1 h2 /\ heap_rel h2 h3   -> Prims.unit
(declare-fun Tm_arrow_7bd533cadf6f3f466440b6c1fc336372 () Term)
(declare-fun Bug1521.rtest0@tok () Term)

; </end encoding let rtest0>

(push) ;; push{2

; Starting query at Bug1521.fst(36,2-36,25)
...
;   (h2: Bug1521.heap)
;   (h3: Bug1521.heap)
;   (_: Prims.squash (Bug1521.heap_rel h1 h2))
;   (_: Prims.squash (Bug1521.heap_rel h2 h3)).
;   (*  - Could not prove post-condition
; *) Prims.auto_squash (Bug1521.heap_rel h1 h3)


; Context: While encoding a query
; While typechecking the top-level declaration `let rtest1`
...
Bug1521.heap)
(HasType @x3
(Prims.squash (Bug1521.heap_rel @x0
@x1)))
(HasType @x4
(Prims.squash (Bug1521.heap_rel @x1
@x2))))

;; def=Bug1521.fst(36,9-36,25); use=Bug1521.fst(36,9-36,25)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1521.rtest1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Bug1521.heap_rel, equation_Bug1521.prefix, equation_Prims.squash, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c
...
; encoding sigelt let rtest1


; <Start encoding let rtest1>

(declare-fun Bug1521.rtest1 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;h1: Bug1521.heap ->     h2: Bug1521.heap ->     h3: Bug1521.heap ->     _: Prims.squash (heap_rel h1 h2) ->     _: Prims.squash (heap_rel h2 h3)   -> Prims.unit
(declare-fun Tm_arrow_c119059bd538e35af8c7d1cf782dee96 () Term)
(declare-fun Bug1521.rtest1@tok () Term)

; </end encoding let rtest1>

(push) ;; push{2

; Starting query at Bug1521.fst(39,2-39,25)
...
;   (h2: Bug1521.heap)
;   (h3: Bug1521.heap)
;   (_: Bug1521.heap_rel h1 h2)
;   (_: Bug1521.heap_rel h2 h3).
;   (*  - Could not prove post-condition
; *) Prims.auto_squash (Bug1521.heap_rel h1 h3)


; Context: While encoding a query
; While typechecking the top-level declaration `let rtest2`
...
;; def=Bug1521.fst(39,9-39,25); use=Bug1521.fst(39,9-39,25)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1521.rtest2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Bug1521.heap_rel, equation_Bug1521.prefix
...
; encoding sigelt let rtest2


; <Start encoding let rtest2>

(declare-fun Bug1521.rtest2 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;h1: Bug1521.heap -> h2: Bug1521.heap -> h3: Bug1521.heap -> _: heap_rel h1 h2 -> _: heap_rel h2 h3   -> Prims.unit
(declare-fun Tm_arrow_ca7aba989ab7968bece97b3980a5cc55 () Term)
(declare-fun Bug1521.rtest2@tok () Term)

; </end encoding let rtest2>

(push) ;; push{2

; Starting query at Bug1521.fst(42,2-43,25)
...
;   (*  - Could not prove post-condition
; *)
;   Bug1521.heap_rel h1 h2 /\
;   (forall (pure_result: Prims.unit). Bug1521.heap_rel h1 h2 ==> Bug1521.heap_rel h1 h3)
...
;; def=Prims.fst(441,29-441,97); use=Bug1521.fst(42,2-42,8)
(and 
;; def=Bug1521.fst(42,9-42,25); use=Bug1521.fst(42,2-42,8)
(or label_1
...
;; def=Prims.fst(441,36-441,97); use=Bug1521.fst(42,2-42,8)
(forall ((@x5 Term))
...
;; def=Bug1521.fst(43,9-43,25); use=Bug1521.fst(43,2-43,8)
(or label_2
...
(declare-fun Bug1521.rtest2_ (Term Term Term Term Term) Term)

(declare-fun Bug1521.rtest2_@tok () Term)

; </end encoding let rtest2'>

(push) ;; push{2

; Starting query at Bug1521.fst(46,2-47,25)
...
;   (*  - Could not prove post-condition
; *)
;   Bug1521.heap_rel h2 h3 /\
;   (forall (pure_result: Prims.unit). Bug1521.heap_rel h2 h3 ==> Bug1521.heap_rel h1 h3)
...
;; def=Prims.fst(441,29-441,97); use=Bug1521.fst(46,2-46,8)
(and 
;; def=Bug1521.fst(46,9-46,25); use=Bug1521.fst(46,2-46,8)
(or label_1
...
;; def=Prims.fst(441,36-441,97); use=Bug1521.fst(46,2-46,8)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)
...
;; def=Bug1521.fst(47,9-47,25); use=Bug1521.fst(47,2-47,8)
(or label_2
...
(declare-fun Bug1521.rtest2__ (Term Term Term Term Term) Term)

(declare-fun Bug1521.rtest2__@tok () Term)

; </end encoding let rtest2''>

(push) ;; push{2

; Starting query at Bug1521.fst(50,2-50,23)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (p1: Bug1521.path)
;   (p2: Bug1521.path)
;   (p3: Bug1521.path)
;   (_: Prims.squash (Bug1521.prefix p1 p2))
;   (_: Prims.squash (Bug1521.prefix p2 p3)).
;   (*  - Could not prove post-condition
; *) Prims.auto_squash (Bug1521.prefix p1 p3)


; Context: While encoding a query
; While typechecking the top-level declaration `let ptest1`
...
Bug1521.path)
(HasType @x3
(Prims.squash (Bug1521.prefix @x0
@x1)))
(HasType @x4
(Prims.squash (Bug1521.prefix @x1
@x2))))

;; def=Bug1521.fst(50,9-50,23); use=Bug1521.fst(50,9-50,23)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1521.ptest1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Bug1521.prefix, equation_Prims.squash, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c
...
; encoding sigelt let ptest1


; <Start encoding let ptest1>

(declare-fun Bug1521.ptest1 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;p1: path -> p2: path -> p3: path -> _: Prims.squash (prefix p1 p2) -> _: Prims.squash (prefix p2 p3)   -> Prims.unit
(declare-fun Tm_arrow_fdc4ab8e3796161c34cda6a7837ab3e3 () Term)
(declare-fun Bug1521.ptest1@tok () Term)

; </end encoding let ptest1>

(push) ;; push{2

; Starting query at Bug1521.fst(53,2-53,23)
...
;   (p2: Bug1521.path)
;   (p3: Bug1521.path)
;   (_: Bug1521.prefix p1 p2)
;   (_: Bug1521.prefix p2 p3).
;   (*  - Could not prove post-condition
; *) Prims.auto_squash (Bug1521.prefix p1 p3)


; Context: While encoding a query
; While typechecking the top-level declaration `let ptest2`
...
;; def=Bug1521.fst(53,9-53,23); use=Bug1521.fst(53,9-53,23)
(or label_1
...
; encoding sigelt let ptest2


; <Start encoding let ptest2>

(declare-fun Bug1521.ptest2 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;p1: path -> p2: path -> p3: path -> _: prefix p1 p2 -> _: prefix p2 p3 -> Prims.unit
(declare-fun Tm_arrow_dcc8018212b5c31ccfaf8eb3ca715669 () Term)
(declare-fun Bug1521.ptest2@tok () Term)

; </end encoding let ptest2>
...
; Starting query at Bug1521.fst(57,24-57,26)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(55,12-55,29); use=Bug1521.fst(55,20-55,29)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_81e65de2755319ee661cc1adc7d951e3 @x2)))
:qid Bug1521_pre_typing_Tm_arrow_81e65de2755319ee661cc1adc7d951e3))

:named Bug1521_pre_typing_Tm_arrow_81e65de2755319ee661cc1adc7d951e3))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug1521_interpretation_Tm_arrow_81e65de2755319ee661cc1adc7d951e3.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_81e65de2755319ee661cc1adc7d951e3 @x1)))
:qid Bug1521_interpretation_Tm_arrow_81e65de2755319ee661cc1adc7d951e3))

:named Bug1521_interpretation_Tm_arrow_81e65de2755319ee661cc1adc7d951e3))
(declare-fun Tm_refine_df2d65c00128265e81a98d1694fa32db (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(55,36-55,56); use=Bug1521.fst(55,36-55,56)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_df2d65c00128265e81a98d1694fa32db @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_df2d65c00128265e81a98d1694fa32db @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_df2d65c00128265e81a98d1694fa32db))

:named refinement_kinding_Tm_refine_df2d65c00128265e81a98d1694fa32db))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(55,36-55,56); use=Bug1521.fst(55,36-55,56)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_df2d65c00128265e81a98d1694fa32db @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Bug1521.fst(55,51-55,54); use=Bug1521.fst(55,51-55,54)
(Valid 
;; def=Bug1521.fst(55,51-55,54); use=Bug1521.fst(55,51-55,54)
(ApplyTT @x3
@x4)
...
;;no pats
:qid refinement_interpretation_Tm_refine_df2d65c00128265e81a98d1694fa32db.1))
))
...
(Tm_refine_df2d65c00128265e81a98d1694fa32db @x2
@x3)))
:qid refinement_interpretation_Tm_refine_df2d65c00128265e81a98d1694fa32db))

:named refinement_interpretation_Tm_refine_df2d65c00128265e81a98d1694fa32db))
;;;;;;;;;;;;;;;;haseq for Tm_refine_df2d65c00128265e81a98d1694fa32db
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(55,36-55,56); use=Bug1521.fst(55,36-55,56)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_df2d65c00128265e81a98d1694fa32db @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_df2d65c00128265e81a98d1694fa32db @x0
@x1))))
:qid haseqTm_refine_df2d65c00128265e81a98d1694fa32db))

:named haseqTm_refine_df2d65c00128265e81a98d1694fa32db))

; Encoding query formula : forall (a: Type)
;   (p: (_: a -> Prims.prop))
;   (_: _: Prims.unit{Prims.squash (x: a & p x)})
;   (phi: Prims.prop).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (x: a). p x ==> phi) /\ (forall (pure_result: Prims.unit). phi ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let sklem0`
...
(HasType @x2
(Tm_refine_df2d65c00128265e81a98d1694fa32db @x0
@x1))
(HasType @x3
Prims.prop))
...
;; def=Bug1521.fst(56,18-56,41); use=Bug1521.fst(57,24-57,26)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
@x0)

;; def=Bug1521.fst(56,29-56,32); use=Bug1521.fst(57,24-57,26)
(Valid 
;; def=Bug1521.fst(56,29-56,32); use=Bug1521.fst(57,24-57,26)
(ApplyTT @x1
@x5)
...
;; def=Bug1521.fst(55,59-55,62); use=Bug1521.fst(56,37-56,40)
(Valid 
;; def=Bug1521.fst(55,59-55,62); use=Bug1521.fst(56,37-56,40)
@x3
)
...
;; def=Prims.fst(441,36-441,97); use=Bug1521.fst(57,24-57,26)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Bug1521.fst(55,59-55,62); use=Bug1521.fst(57,17-57,20)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(57,24-57,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(57,24-57,26)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1521.sklem0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_df2d65c00128265e81a98d1694fa32db
...
; encoding sigelt let sklem0


; <Start encoding let sklem0>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug1521.sklem0 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug1521.sklem0@tok () Term)

; </end encoding let sklem0>

(push) ;; push{2

; Starting query at Bug1521.fst(61,24-61,26)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(59,12-59,29); use=Bug1521.fst(59,20-59,29)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_81e65de2755319ee661cc1adc7d951e3 @x0)
Tm_type)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(59,36-59,55); use=Bug1521.fst(59,36-59,55)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_df2d65c00128265e81a98d1694fa32db @x0
@x1)
Tm_type)
...
;; def=Bug1521.fst(59,51-59,54); use=Bug1521.fst(59,51-59,54)
(Valid 
;; def=Bug1521.fst(59,51-59,54); use=Bug1521.fst(59,51-59,54)
(ApplyTT @x3
@x4)
...
; Encoding query formula : forall (a: Type) (p: (_: a -> Prims.prop)) (_: _: Prims.unit{exists (x: a). p x}) (phi: Prims.prop).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (x: a). p x ==> phi) /\ (forall (pure_result: Prims.unit). phi ==> p pure_result) ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let sklem1`
...
;; def=Bug1521.fst(60,18-60,41); use=Bug1521.fst(61,24-61,26)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
@x0)

;; def=Bug1521.fst(60,29-60,32); use=Bug1521.fst(61,24-61,26)
(Valid 
;; def=Bug1521.fst(60,29-60,32); use=Bug1521.fst(61,24-61,26)
(ApplyTT @x1
@x5)
...
;; def=Bug1521.fst(59,58-59,61); use=Bug1521.fst(60,37-60,40)
(Valid 
;; def=Bug1521.fst(59,58-59,61); use=Bug1521.fst(60,37-60,40)
@x3
)
...
;; def=Prims.fst(441,36-441,97); use=Bug1521.fst(61,24-61,26)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Bug1521.fst(59,58-59,61); use=Bug1521.fst(61,17-61,20)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(61,24-61,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(61,24-61,26)
(ApplyTT @x4
@x5)
...
; encoding sigelt let sklem1


; <Start encoding let sklem1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug1521.sklem1 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug1521.sklem1@tok () Term)

; </end encoding let sklem1>

(push) ;; push{2

; Starting query at Bug1521.fst(65,24-65,26)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(63,12-63,29); use=Bug1521.fst(63,20-63,29)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_81e65de2755319ee661cc1adc7d951e3 @x0)
Tm_type)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(63,36-63,65); use=Bug1521.fst(63,36-63,65)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_df2d65c00128265e81a98d1694fa32db @x0
@x1)
Tm_type)
...
;; def=Bug1521.fst(63,44-63,63); use=Bug1521.fst(63,44-63,63)
(exists ((@x4 Term))
 (! (and (HasType @x4
@x2)

;; def=Bug1521.fst(63,59-63,62); use=Bug1521.fst(63,59-63,62)
(Valid 
;; def=Bug1521.fst(63,59-63,62); use=Bug1521.fst(63,59-63,62)
(ApplyTT @x3
@x4)
...
; Encoding query formula : forall (a: Type)
;   (p: (_: a -> Prims.prop))
;   (_: u313: Prims.unit{exists (x: a). p x})
;   (phi: Prims.prop).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let sklem2`
...
;; def=Bug1521.fst(64,18-64,41); use=Bug1521.fst(65,24-65,26)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
@x0)

;; def=Bug1521.fst(64,29-64,32); use=Bug1521.fst(65,24-65,26)
(Valid 
;; def=Bug1521.fst(64,29-64,32); use=Bug1521.fst(65,24-65,26)
(ApplyTT @x1
@x5)
...
;; def=Bug1521.fst(63,68-63,71); use=Bug1521.fst(64,37-64,40)
(Valid 
;; def=Bug1521.fst(63,68-63,71); use=Bug1521.fst(64,37-64,40)
@x3
)
...
;; def=Prims.fst(441,36-441,97); use=Bug1521.fst(65,24-65,26)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Bug1521.fst(63,68-63,71); use=Bug1521.fst(65,17-65,20)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(65,24-65,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(65,24-65,26)
(ApplyTT @x4
@x5)
...
; encoding sigelt let sklem2


; <Start encoding let sklem2>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug1521.sklem2 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug1521.sklem2@tok () Term)

; </end encoding let sklem2>

(push) ;; push{2

; Starting query at Bug1521.fst(69,24-69,26)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(67,12-67,29); use=Bug1521.fst(67,20-67,29)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_81e65de2755319ee661cc1adc7d951e3 @x0)
Tm_type)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(67,43-67,62); use=Bug1521.fst(67,43-67,62)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_df2d65c00128265e81a98d1694fa32db @x0
@x1)
Tm_type)
...
;; def=Bug1521.fst(67,58-67,61); use=Bug1521.fst(67,58-67,61)
(Valid 
;; def=Bug1521.fst(67,58-67,61); use=Bug1521.fst(67,58-67,61)
(ApplyTT @x3
@x4)
...
; Encoding query formula : forall (a: Type) (p: (_: a -> Prims.prop)) (_: Prims.squash (exists (x: a). p x)) (phi: Prims.prop).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (x: a). p x ==> phi) /\ (forall (pure_result: Prims.unit). phi ==> p pure_result) ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let sklem3`
...
;; def=Bug1521.fst(68,18-68,41); use=Bug1521.fst(69,24-69,26)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
@x0)

;; def=Bug1521.fst(68,29-68,32); use=Bug1521.fst(69,24-69,26)
(Valid 
;; def=Bug1521.fst(68,29-68,32); use=Bug1521.fst(69,24-69,26)
(ApplyTT @x1
@x5)
...
;; def=Bug1521.fst(67,65-67,68); use=Bug1521.fst(68,37-68,40)
(Valid 
;; def=Bug1521.fst(67,65-67,68); use=Bug1521.fst(68,37-68,40)
@x3
)
...
;; def=Prims.fst(441,36-441,97); use=Bug1521.fst(69,24-69,26)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Bug1521.fst(67,65-67,68); use=Bug1521.fst(69,17-69,20)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(69,24-69,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(69,24-69,26)
(ApplyTT @x4
@x5)
...
; encoding sigelt let sklem3


; <Start encoding let sklem3>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug1521.sklem3 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug1521.sklem3@tok () Term)

; </end encoding let sklem3>
...
(declare-fun Bug1521.id (Term) Term)

(declare-fun Bug1521.id@tok () Term)

; </end encoding let id>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1521.id; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(71,4-71,6); use=Bug1521.fst(71,4-71,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Bug1521.id @x0)
Tm_type))
 

:pattern ((Bug1521.id @x0))
:qid typing_Bug1521.id))

:named typing_Bug1521.id))
;;;;;;;;;;;;;;;;Equation for Bug1521.id
;;; Fact-ids: Name Bug1521.id; Namespace Bug1521
(assert (! 
;; def=Bug1521.fst(71,4-71,6); use=Bug1521.fst(71,4-71,6)
(forall ((@x0 Term))
...
:pattern ((Bug1521.id @x0))
:qid equation_Bug1521.id))

:named equation_Bug1521.id))
(push) ;; push{2

; Starting query at Bug1521.fst(74,24-74,26)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(72,13-72,30); use=Bug1521.fst(72,21-72,30)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_81e65de2755319ee661cc1adc7d951e3 @x0)
Tm_type)
...
:named Bug1521_interpretation_Tm_arrow_81e65de2755319ee661cc1adc7d951e3))
(declare-fun Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(72,44-72,68); use=Bug1521.fst(72,44-72,68)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c))

:named refinement_kinding_Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(72,44-72,68); use=Bug1521.fst(72,44-72,68)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Bug1521.fst(72,59-72,67); use=Bug1521.fst(72,59-72,67)
(Valid 
;; def=Bug1521.fst(72,59-72,67); use=Bug1521.fst(72,59-72,67)
(Bug1521.id (ApplyTT @x3
@x4))
)
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c.1))
))
...
(Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c @x2
@x3)))
:qid refinement_interpretation_Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c))

:named refinement_interpretation_Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c
;;; Fact-ids: 
(assert (! 
;; def=Bug1521.fst(72,44-72,68); use=Bug1521.fst(72,44-72,68)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c @x0
@x1))))
:qid haseqTm_refine_99dd2283cbb3854d3d50ecf79b8c853c))

:named haseqTm_refine_99dd2283cbb3854d3d50ecf79b8c853c))

; Encoding query formula : forall (a: Type)
;   (p: (_: a -> Prims.prop))
;   (_: Prims.squash (exists (x: a). Bug1521.id (p x)))
;   (phi: Prims.prop).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
...
(Tm_arrow_81e65de2755319ee661cc1adc7d951e3 @x0))
(HasType @x2
(Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c @x0
@x1))
(HasType @x3
Prims.prop))
...
;; def=Bug1521.fst(73,18-73,41); use=Bug1521.fst(74,24-74,26)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
@x0)

;; def=Bug1521.fst(73,29-73,32); use=Bug1521.fst(74,24-74,26)
(Valid 
;; def=Bug1521.fst(73,29-73,32); use=Bug1521.fst(74,24-74,26)
(ApplyTT @x1
@x5)
...
;; def=Bug1521.fst(72,71-72,74); use=Bug1521.fst(73,37-73,40)
(Valid 
;; def=Bug1521.fst(72,71-72,74); use=Bug1521.fst(73,37-73,40)
@x3
)
...
;; def=Prims.fst(441,36-441,97); use=Bug1521.fst(74,24-74,26)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Bug1521.fst(72,71-72,74); use=Bug1521.fst(74,17-74,20)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(74,24-74,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug1521.fst(74,24-74,26)
(ApplyTT @x4
@x5)
...
; QUERY ID: (Bug1521.sklem3', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Bug1521.id, refinement_interpretation_Tm_refine_99dd2283cbb3854d3d50ecf79b8c853c
