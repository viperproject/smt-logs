...
; Internals for Bug2614


; encoding sigelt val Bug2614.t


; <Start encoding val Bug2614.t>

(declare-fun Bug2614.t (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Type
(declare-fun Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2 () Term)
(declare-fun Bug2614.t@tok () Term)

; </end encoding val Bug2614.t>


; encoding sigelt val Bug2614.p


; <Start encoding val Bug2614.p>

(declare-fun Bug2614.p (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: t x -> Prims.prop
(declare-fun Tm_arrow_72060478cbc03561fc58606bd653e42d () Term)
(declare-fun Bug2614.p@tok () Term)

; </end encoding val Bug2614.p>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2614.t; Namespace Bug2614
(assert (! 
;; def=Bug2614.fst(3,11-3,12); use=Bug2614.fst(3,11-3,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (Bug2614.t @x0)
Tm_type))
 

:pattern ((Bug2614.t @x0))
:qid typing_Bug2614.t))

:named typing_Bug2614.t))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2614.p; Namespace Bug2614
(assert (! 
;; def=Bug2614.fst(4,11-4,12); use=Bug2614.fst(4,11-4,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
(Bug2614.t @x0)))
(HasType (Bug2614.p @x0
@x1)
Prims.prop))
 

:pattern ((Bug2614.p @x0
@x1))
:qid typing_Bug2614.p))

:named typing_Bug2614.p))
;;;;;;;;;;;;;;;;refinement kinding
...
; Starting query at Bug2614.fst(9,2-11,8)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Prims.int) (y: Bug2614.t x) (_: Prims.squash (Bug2614.p x y)).
...
;     forall (_: Prims.unit).
;       (*  - Could not prove post-condition
; *) Prims.auto_squash (Bug2614.p x y)


; Context: While encoding a query
; While typechecking the top-level declaration `let test_exists_intro`
...
(Bug2614.t @x0))
(HasType @x2
(Prims.squash (Bug2614.p @x0
@x1))))

;; def=dummy(0,0-0,0); use=Bug2614.fst(9,2-11,8)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)
...
;; def=Bug2614.fst(9,36-9,41); use=Bug2614.fst(11,6-11,8)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2614.test_exists_intro, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.squash, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c
...
; encoding sigelt let test_exists_intro


; <Start encoding let test_exists_intro>

(declare-fun Bug2614.test_exists_intro (Term Term Term) Term)
(declare-fun Tm_refine_352cf091232e38964329636e9f05f695 () Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: t x -> _: Prims.squash (p x y)   -> Prims.squash (exists (x: Prims.int) (b: t x). p x b)
(declare-fun Tm_arrow_c23ab8a84a662b194a72116d39c1893f () Term)
(declare-fun Bug2614.test_exists_intro@tok () Term)


; </end encoding let test_exists_intro>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug2614.test_exists_intro; Namespace Bug2614
(assert (! (HasType Tm_refine_352cf091232e38964329636e9f05f695
Tm_type)
:named refinement_kinding_Tm_refine_352cf091232e38964329636e9f05f695))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug2614.test_exists_intro; Namespace Bug2614
(assert (! 
;; def=FStar.Classical.Sugar.fsti(117,16-117,31); use=FStar.Classical.Sugar.fsti(117,16-117,31)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_352cf091232e38964329636e9f05f695)
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Bug2614.fst(9,2-11,8); use=FStar.Classical.Sugar.fsti(112,0-117,32)
(exists ((@x3 Term))
 (! (and (HasType @x3
(Bug2614.t @x2))

;; def=Bug2614.fst(9,36-9,41); use=FStar.Classical.Sugar.fsti(112,0-117,32)
(Valid 
;; def=Bug2614.fst(9,36-9,41); use=FStar.Classical.Sugar.fsti(112,0-117,32)
(Bug2614.p @x2
@x3)
...
;;no pats
:qid refinement_interpretation_Tm_refine_352cf091232e38964329636e9f05f695.2))
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_352cf091232e38964329636e9f05f695.1))
))
...
@x1
Tm_refine_352cf091232e38964329636e9f05f695))
:qid refinement_interpretation_Tm_refine_352cf091232e38964329636e9f05f695))

:named refinement_interpretation_Tm_refine_352cf091232e38964329636e9f05f695))
;;;;;;;;;;;;;;;;haseq for Tm_refine_352cf091232e38964329636e9f05f695
;;; Fact-ids: Name Bug2614.test_exists_intro; Namespace Bug2614
(assert (! (iff (Valid (Prims.hasEq Tm_refine_352cf091232e38964329636e9f05f695))
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_352cf091232e38964329636e9f05f695))
(push) ;; push{2

; Starting query at Bug2614.fst(15,2-19,3)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let test_exists_intro_workaround`
...
;; def=dummy(0,0-0,0); use=Bug2614.fst(15,2-19,3)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=dummy(0,0-0,0); use=Bug2614.fst(16,13-19,3)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.unit)

;; def=Bug2614.fst(17,30-17,35); use=Bug2614.fst(18,15-18,17)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2614.test_exists_intro_workaround, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.squash, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c
...
; encoding sigelt let test_exists_intro_workaround


; <Start encoding let test_exists_intro_workaround>

(declare-fun Bug2614.test_exists_intro_workaround (Term Term Term) Term)


(declare-fun Bug2614.test_exists_intro_workaround@tok () Term)


; </end encoding let test_exists_intro_workaround>

(push) ;; push{2

; Starting query at Bug2614.fst(22,20-22,41)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2
Tm_type)
:named refinement_kinding_Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug2614.fst(21,30-21,61); use=Bug2614.fst(21,30-21,61)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2)
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Bug2614.fst(21,55-21,60); use=Bug2614.fst(21,55-21,60)
(Valid 
;; def=Bug2614.fst(21,55-21,60); use=Bug2614.fst(21,55-21,60)
(Bug2614.p @x2
@x3)
...
;;no pats
:qid refinement_interpretation_Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2.1))
))
...
@x1
Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2))
:qid refinement_interpretation_Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2))

:named refinement_interpretation_Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2))
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2))

; Encoding query formula : forall (_: Prims.squash (exists (x: Prims.int) (y: Bug2614.t x). Bug2614.p x y)).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.unit). exists (x: Prims.int) (y: Bug2614.t x). Bug2614.p x y


; Context: While encoding a query
; While typechecking the top-level declaration `let test_exists_elim`
...
;; def=dummy(0,0-0,0); use=Bug2614.fst(22,20-22,41)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.unit)

;; def=FStar.Classical.Sugar.fsti(66,22-66,41); use=Bug2614.fst(22,20-22,41)
(or label_1
...
;; def=Bug2614.fst(22,36-22,41); use=Bug2614.fst(22,36-22,41)
(exists ((@x3 Term))
 (! (and (HasType @x3
(Bug2614.t @x2))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2614.test_exists_elim, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2
...
; encoding sigelt let test_exists_elim


; <Start encoding let test_exists_elim>

(declare-fun Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2 () Term)
(declare-fun Bug2614.test_exists_elim (Term) Term)

(declare-fun Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9 () Term)
;;;;;;;;;;;;;;;;_: Prims.squash (exists (x: Prims.int) (y: t x). p x y) -> Prims.squash Prims.l_True
(declare-fun Tm_arrow_4d11acb5414a978911d62cbf84bae01a () Term)
(declare-fun Bug2614.test_exists_elim@tok () Term)



; </end encoding let test_exists_elim>


; encoding sigelt let test_forall_intro


; <Start encoding let test_forall_intro>

;;;;;;;;;;;;;;;;x: Prims.int -> y: t x -> Prims.squash (p x y)
(declare-fun Tm_arrow_012f0637bf65013e75015db64161e01a () Term)
(declare-fun Bug2614.test_forall_intro (Term) Term)

(declare-fun Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0 () Term)
;;;;;;;;;;;;;;;;f: (x: Prims.int -> y: t x -> Prims.squash (p x y))   -> Prims.squash (forall (x: Prims.int) (y: t x). p x y)
(declare-fun Tm_arrow_e2b523ed5dbced07c0fc7d1341099c24 () Term)
(declare-fun Bug2614.test_forall_intro@tok () Term)



; </end encoding let test_forall_intro>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug2614.test_exists_elim; Namespace Bug2614
(assert (! (HasType Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2
Tm_type)
:named refinement_kinding_Tm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug2614.test_forall_intro; Namespace Bug2614
(assert (! (HasType Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0
Tm_type)
:named refinement_kinding_Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug2614.test_exists_elim; Namespace Bug2614
...
;;; Fact-ids: Name Bug2614.test_forall_intro; Namespace Bug2614
(assert (! 
;; def=FStar.Classical.Sugar.fsti(109,16-109,31); use=FStar.Classical.Sugar.fsti(109,16-109,31)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0)
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Bug2614.fst(27,2-28,12); use=FStar.Classical.Sugar.fsti(105,0-109,32)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Bug2614.t @x2))

;; def=Bug2614.fst(27,37-27,42); use=FStar.Classical.Sugar.fsti(105,0-109,32)
(Valid 
;; def=Bug2614.fst(27,37-27,42); use=FStar.Classical.Sugar.fsti(105,0-109,32)
(Bug2614.p @x2
@x3)
...
;;no pats
:qid refinement_interpretation_Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0.2))
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0.1))
))
...
@x1
Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0))
:qid refinement_interpretation_Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0))

:named refinement_interpretation_Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug2614.test_exists_elim; Namespace Bug2614
(assert (! 
;; def=Bug2614.fst(23,10-23,14); use=Bug2614.fst(22,36-22,41)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_73d5d177cf7f3a8fa42d7f32f957ecd2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0
;;; Fact-ids: Name Bug2614.test_forall_intro; Namespace Bug2614
(assert (! (iff (Valid (Prims.hasEq Tm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0))
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_5f4da9bf4f1637bcdfc1a0b64c1ef0a0))
...
; Starting query at Bug2614.fst(33,20-33,41)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_6593cb9b578614a16f8c9151c76a66d5 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_6593cb9b578614a16f8c9151c76a66d5
Tm_type)
:named refinement_kinding_Tm_refine_6593cb9b578614a16f8c9151c76a66d5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug2614.fst(32,46-32,77); use=Bug2614.fst(32,46-32,77)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_6593cb9b578614a16f8c9151c76a66d5)
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Bug2614.fst(32,71-32,76); use=Bug2614.fst(32,71-32,76)
(Valid 
;; def=Bug2614.fst(32,71-32,76); use=Bug2614.fst(32,71-32,76)
(Bug2614.p @x2
@x3)
...
;;no pats
:qid refinement_interpretation_Tm_refine_6593cb9b578614a16f8c9151c76a66d5.1))
))
...
@x1
Tm_refine_6593cb9b578614a16f8c9151c76a66d5))
:qid refinement_interpretation_Tm_refine_6593cb9b578614a16f8c9151c76a66d5))

:named refinement_interpretation_Tm_refine_6593cb9b578614a16f8c9151c76a66d5))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6593cb9b578614a16f8c9151c76a66d5
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_6593cb9b578614a16f8c9151c76a66d5))
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_6593cb9b578614a16f8c9151c76a66d5))

; Encoding query formula : forall (a: Prims.int)
;   (b: Bug2614.t a)
;   (_: Prims.squash (forall (x: Prims.int) (y: Bug2614.t x). Bug2614.p x y)).
;   (*  - Could not prove post-condition
; *) forall (x: Prims.int) (y: Bug2614.t x). Bug2614.p x y


; Context: While encoding a query
; While typechecking the top-level declaration `let test_forall_elim`
...
;; def=FStar.Classical.Sugar.fsti(58,17-58,36); use=Bug2614.fst(33,20-33,41)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.int)

;; def=Bug2614.fst(33,20-33,41); use=Bug2614.fst(33,20-33,41)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Bug2614.t @x3))

;; def=Bug2614.fst(33,36-33,41); use=Bug2614.fst(33,36-33,41)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2614.test_forall_elim, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, int_inversion, refinement_interpretation_Tm_refine_6593cb9b578614a16f8c9151c76a66d5
...
; encoding sigelt let test_forall_elim


; <Start encoding let test_forall_elim>

(declare-fun Tm_refine_6593cb9b578614a16f8c9151c76a66d5 () Term)
(declare-fun Bug2614.test_forall_elim (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Prims.int -> b: t a -> _: Prims.squash (forall (x: Prims.int) (y: t x). p x y)   -> Prims.squash (p a b)
(declare-fun Tm_arrow_df90db613318a742ec3b64c95a099aba () Term)
(declare-fun Bug2614.test_forall_elim@tok () Term)


; </end encoding let test_forall_elim>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug2614.test_forall_elim; Namespace Bug2614
(assert (! (HasType Tm_refine_6593cb9b578614a16f8c9151c76a66d5
Tm_type)
:named refinement_kinding_Tm_refine_6593cb9b578614a16f8c9151c76a66d5))
;;;;;;;;;;;;;;;;refinement_interpretation
...
; Starting query at Bug2614.fst(38,2-41,8)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

(declare-fun Tm_refine_4637509073bcc6bf14373799311a7d93 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug2614.fst(38,28-38,51); use=Bug2614.fst(38,2-41,8)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_4637509073bcc6bf14373799311a7d93 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_4637509073bcc6bf14373799311a7d93 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_4637509073bcc6bf14373799311a7d93))

:named refinement_kinding_Tm_refine_4637509073bcc6bf14373799311a7d93))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug2614.fst(38,28-38,51); use=Bug2614.fst(38,2-41,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4637509073bcc6bf14373799311a7d93 @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=Bug2614.fst(38,45-38,50); use=Bug2614.fst(38,2-41,8)
(Valid 
;; def=Bug2614.fst(38,45-38,50); use=Bug2614.fst(38,2-41,8)
(Bug2614.p @x2
@x3)
...
;;no pats
:qid refinement_interpretation_Tm_refine_4637509073bcc6bf14373799311a7d93.1))
))
...
@x1
(Tm_refine_4637509073bcc6bf14373799311a7d93 @x2)))
:qid refinement_interpretation_Tm_refine_4637509073bcc6bf14373799311a7d93))

:named refinement_interpretation_Tm_refine_4637509073bcc6bf14373799311a7d93))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4637509073bcc6bf14373799311a7d93
;;; Fact-ids: 
(assert (! 
;; def=Bug2614.fst(38,28-38,51); use=Bug2614.fst(38,2-41,8)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4637509073bcc6bf14373799311a7d93 @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4637509073bcc6bf14373799311a7d93 @x0))))
:qid haseqTm_refine_4637509073bcc6bf14373799311a7d93))

:named haseqTm_refine_4637509073bcc6bf14373799311a7d93))
...
;       (any_result: Prims.squash (forall (y: Bug2614.t a). Bug2614.p a y))
;       (any_result: Prims.squash (forall (y: Bug2614.t a). Bug2614.p a y))
;       (x: Bug2614.t a).
;       Bug2614.p a x)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let test_forall_elim_workaround`
...
;; def=Prims.fst(459,77-459,89); use=Bug2614.fst(38,2-41,8)
(and 
;; def=FStar.Classical.Sugar.fsti(58,17-58,36); use=Bug2614.fst(38,20-38,51)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.int)

;; def=Bug2614.fst(38,28-38,51); use=Bug2614.fst(38,28-38,51)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Bug2614.t @x3))

;; def=Bug2614.fst(38,45-38,50); use=Bug2614.fst(38,45-38,50)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=Bug2614.fst(38,2-41,8)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)
...
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Tm_refine_4637509073bcc6bf14373799311a7d93 @x0))
...
;; def=FStar.Classical.Sugar.fsti(58,17-58,36); use=Bug2614.fst(40,20-40,33)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(Bug2614.t @x0))

;; def=Bug2614.fst(40,28-40,33); use=Bug2614.fst(40,28-40,33)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2614.test_forall_elim_workaround, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, int_inversion, refinement_interpretation_Tm_refine_6593cb9b578614a16f8c9151c76a66d5
