...
(declare-fun Bug3616.f (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.int
(declare-fun Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52 () Term)
(declare-fun Bug3616.f@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug3616.f; Namespace Bug3616
(assert (! 
;; def=Bug3616.fst(4,4-4,5); use=Bug3616.fst(4,4-4,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.unit)
(HasType (Bug3616.f @x0)
Prims.int))
 

:pattern ((Bug3616.f @x0))
:qid typing_Bug3616.f))

:named typing_Bug3616.f))
;;;;;;;;;;;;;;;;refinement kinding
...
; Starting query at Bug3616.fst(7,0-8,19)

(declare-fun label_1 () Bool)

; Encoding query formula : Bug3616.f () == 0
...
;;; Fact-ids: 
(assert (! (not 
;; def=Bug3616.fst(8,8-8,19); use=Bug3616.fst(8,2-8,8)
(or label_1
...
;; def=Bug3616.fst(4,4-4,5); use=Bug3616.fst(4,4-4,5)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug3616.f@tok
@x0)
(Bug3616.f @x0))
 

:pattern ((ApplyTT Bug3616.f@tok
@x0))
:qid token_correspondence_Bug3616.f))

:named token_correspondence_Bug3616.f))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! (HasType Tm_refine_f1ecc6ab6882a651504f328937700647
Tm_type)
...
:named refinement_interpretation_Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52
;;; Fact-ids: Name Bug3616.f; Namespace Bug3616
(assert (! (HasType Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52
Tm_type)
:named kinding_Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Bug3616.f@tok
Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52))
...
:pattern ((Bug3616.f @x1))
:qid function_token_typing_Bug3616.f.1))
)
 

:pattern ((ApplyTT @x0
Bug3616.f@tok))
:qid function_token_typing_Bug3616.f))

:named function_token_typing_Bug3616.f))
;;;;;;;;;;;;;;;;Equation for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;; Fact-ids: Name Bug3616.f; Namespace Bug3616
(assert (! 
;; def=Bug3616.fst(4,6-4,13); use=Bug3616.fst(4,6-4,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52)
...
@x1
Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52))
:qid Bug3616_pre_typing_Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52))

:named Bug3616_pre_typing_Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52
;;; Fact-ids: Name Bug3616.f; Namespace Bug3616
(assert (! 
;; def=Bug3616.fst(4,6-4,13); use=Bug3616.fst(4,6-4,13)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug3616_interpretation_Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52))
:qid Bug3616_interpretation_Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52))

:named Bug3616_interpretation_Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52))
(push) ;; push{2

; Starting query at Bug3616.fst(10,0-12,19)

(declare-fun label_1 () Bool)

(declare-fun Tm_abs_c33e034cd21b92460910766fda9c9129 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_c33e034cd21b92460910766fda9c9129
;;; Fact-ids: 
(assert (! (HasType Tm_abs_c33e034cd21b92460910766fda9c9129
Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52)
:named typing_Tm_abs_c33e034cd21b92460910766fda9c9129))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c33e034cd21b92460910766fda9c9129
;;; Fact-ids: 
(assert (! 
;; def=Bug3616.fst(4,16-4,17); use=Bug3616.fst(4,16-4,17)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_c33e034cd21b92460910766fda9c9129
@x0)
(BoxInt 0))
 

:pattern ((ApplyTT Tm_abs_c33e034cd21b92460910766fda9c9129
@x0))
:qid interpretation_Tm_abs_c33e034cd21b92460910766fda9c9129))

:named interpretation_Tm_abs_c33e034cd21b92460910766fda9c9129))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
Bug3616.f@tok))
:named @kick_partial_app_d39f91266fb14b7dddcea7bd069905f1))

; Encoding query formula : forall (pure_result: Prims.unit). (fun _ -> 0 <: Prims.int) == Bug3616.f ==> Bug3616.f () == 0
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(441,36-441,97); use=Bug3616.fst(11,2-11,15)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Prims.unit)

;; def=FStar.Pervasives.fsti(328,60-328,78); use=Bug3616.fst(11,2-11,15)
(= Tm_abs_c33e034cd21b92460910766fda9c9129
Bug3616.f@tok)
)

;; def=Bug3616.fst(12,8-12,19); use=Bug3616.fst(12,2-12,8)
(or label_1
...
; QUERY ID: (Bug3616.uu___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, function_token_typing_Bug3616.f, interpretation_Tm_abs_c33e034cd21b92460910766fda9c9129
...
(declare-fun Bug3616.uu___0 (Dummy_sort) Term)

; </end encoding let uu___0>


; encoding sigelt let rec f_rec


; <Start encoding let rec f_rec>

(declare-fun Bug3616.f_rec (Term) Term)

(declare-fun Bug3616.f_rec@tok () Term)

; </end encoding let rec f_rec>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug3616.f_rec; Namespace Bug3616
(assert (! 
;; def=Bug3616.fst(15,8-15,13); use=Bug3616.fst(15,8-15,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.unit)
(HasType (Bug3616.f_rec @x0)
Prims.int))
 

:pattern ((Bug3616.f_rec @x0))
:qid typing_Bug3616.f_rec))

:named typing_Bug3616.f_rec))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Bug3616.f_rec; Namespace Bug3616
(assert (! 
;; def=Bug3616.fst(15,8-15,13); use=Bug3616.fst(15,8-15,13)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug3616.f_rec@tok
@x0)
(Bug3616.f_rec @x0))
 

:pattern ((ApplyTT Bug3616.f_rec@tok
@x0))
:qid token_correspondence_Bug3616.f_rec))

:named token_correspondence_Bug3616.f_rec))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Bug3616.f_rec; Namespace Bug3616
(assert (! 
;; def=Bug3616.fst(15,8-15,13); use=Bug3616.fst(15,8-15,13)
...
:pattern ((Bug3616.f_rec @x1))
:qid function_token_typing_Bug3616.f_rec.1))
)
 

:pattern ((ApplyTT @x0
Bug3616.f_rec@tok))
:qid function_token_typing_Bug3616.f_rec))

:named function_token_typing_Bug3616.f_rec))
(push) ;; push{2

; Starting query at Bug3616.fst(17,0-19,23)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug3616.fst(15,24-15,25); use=Bug3616.fst(15,24-15,25)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_c33e034cd21b92460910766fda9c9129
@x0)
(BoxInt 0))
...
(assert (! (Valid (ApplyTT __uu__PartialApp
Bug3616.f_rec@tok))
:named @kick_partial_app_a64bf8ea300dc1d44811d3699e58434e))

; Encoding query formula : forall (pure_result: Prims.unit).
;   (fun _ -> 0 <: Prims.int) == Bug3616.f_rec ==> Bug3616.f_rec () == 0
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(441,36-441,97); use=Bug3616.fst(18,2-18,15)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Prims.unit)

;; def=FStar.Pervasives.fsti(328,60-328,78); use=Bug3616.fst(18,2-18,15)
(= Tm_abs_c33e034cd21b92460910766fda9c9129
Bug3616.f_rec@tok)
)

;; def=Bug3616.fst(19,8-19,23); use=Bug3616.fst(19,2-19,8)
(or label_1

;; def=Bug3616.fst(19,8-19,23); use=Bug3616.fst(19,2-19,8)
(= (Bug3616.f_rec Tm_unit)
(BoxInt 0))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3616.uu___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, function_token_typing_Bug3616.f_rec, interpretation_Tm_abs_c33e034cd21b92460910766fda9c9129
