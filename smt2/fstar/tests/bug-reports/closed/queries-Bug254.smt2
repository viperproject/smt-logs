...
; Internals for Bug254


; encoding sigelt val Bug254.foo


; <Skipped val Bug254.foo/>
...
(declare-fun Bug254.foo (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.list Prims.nat -> Prims.bool
(declare-fun Tm_arrow_d8c63117c1f7bf5df02ced630bb9f412 () Term)
(declare-fun Bug254.foo@tok () Term)
...
; Starting query at Bug254.fst(22,0-26,22)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (ms1: Prims.list (Prims.nat & Prims.nat)).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (ms2: Prims.list (Prims.nat & Prims.nat)).
;     (*  - Subtyping check failed
;   - Expected type Prims.eqtype got type Type0
; *)
;     Prims.hasEq (Prims.list Prims.nat)


; Context: While encoding a query
; While typechecking the top-level declaration `val Bug254.bar`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Bug254.fst(22,0-26,22)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(Prims.list (FStar.Pervasives.Native.tuple2 Prims.nat
Prims.nat)))

;; def=dummy(0,0-0,0); use=Bug254.fst(22,14-26,22)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(Prims.list (FStar.Pervasives.Native.tuple2 Prims.nat
Prims.nat)))

;; def=Prims.fst(73,23-73,30); use=Bug254.fst(23,32-23,36)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug254.bar, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Prims.list__uu___haseq, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_Prims.int
...
; encoding sigelt val Bug254.bar


; <Skipped val Bug254.bar/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.List.mapT; Namespace FStar.List
(assert (! 
;; def=FStar.List.fst(124,4-124,8); use=FStar.List.fst(124,4-124,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((FStar.List.mapT @x0
@x1
@x2
@x3))
:qid typing_FStar.List.mapT))

:named typing_FStar.List.mapT))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug254.foo; Namespace Bug254
(assert (! 
;; def=Bug254.fst(20,4-20,7); use=Bug254.fst(20,4-20,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(Prims.list Prims.nat))
(HasType (Bug254.foo @x0)
Prims.bool))
 

:pattern ((Bug254.foo @x0))
:qid typing_Bug254.foo))

:named typing_Bug254.foo))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
@x2
@x3))
:qid equation_FStar.List.mapT))

:named equation_FStar.List.mapT))
;;;;;;;;;;;;;;;;Equation for Bug254.foo
;;; Fact-ids: Name Bug254.foo; Namespace Bug254
(assert (! 
;; def=Bug254.fst(20,4-20,7); use=Bug254.fst(20,4-20,7)
(forall ((@x0 Term))
...
:pattern ((Bug254.foo @x0))
:qid equation_Bug254.foo))

:named equation_Bug254.foo))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at Bug254.fst(27,17-33,2)
...
FStar.Pervasives.Native.fst@tok))
:named @kick_partial_app_8a5bfeaf280e6d1ad02d3c6f0198bd2e))

(declare-fun Tm_refine_a46278218f4c76eafa827f5a69e25c74 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug254.fst(23,11-23,76); use=Bug254.fst(27,4-27,7)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_a46278218f4c76eafa827f5a69e25c74 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_a46278218f4c76eafa827f5a69e25c74 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_a46278218f4c76eafa827f5a69e25c74))

:named refinement_kinding_Tm_refine_a46278218f4c76eafa827f5a69e25c74))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug254.fst(23,11-23,76); use=Bug254.fst(27,4-27,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a46278218f4c76eafa827f5a69e25c74 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list (FStar.Pervasives.Native.tuple2 Prims.nat
Prims.nat)))

;; def=Bug254.fst(23,32-23,75); use=Bug254.fst(27,4-27,7)
(= (FStar.List.mapT (FStar.Pervasives.Native.tuple2 Prims.nat
Prims.nat)
Prims.nat
...
@x1
(Tm_refine_a46278218f4c76eafa827f5a69e25c74 @x2)))
:qid refinement_interpretation_Tm_refine_a46278218f4c76eafa827f5a69e25c74))

:named refinement_interpretation_Tm_refine_a46278218f4c76eafa827f5a69e25c74))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a46278218f4c76eafa827f5a69e25c74
;;; Fact-ids: 
(assert (! 
;; def=Bug254.fst(23,11-23,76); use=Bug254.fst(27,4-27,7)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a46278218f4c76eafa827f5a69e25c74 @x0)))
(Valid (Prims.hasEq (Prims.list (FStar.Pervasives.Native.tuple2 Prims.nat
Prims.nat)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a46278218f4c76eafa827f5a69e25c74 @x0))))
:qid haseqTm_refine_a46278218f4c76eafa827f5a69e25c74))

:named haseqTm_refine_a46278218f4c76eafa827f5a69e25c74))
...
; Encoding query formula : forall (ms1: Prims.list (Prims.nat & Prims.nat))
;   (ms2:
;   Prims.list (Prims.nat & Prims.nat)
;     { FStar.List.mapT FStar.Pervasives.Native.fst ms1 =
;       FStar.List.mapT FStar.Pervasives.Native.fst ms2 }).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     Bug254.foo (FStar.List.mapT FStar.Pervasives.Native.fst ms1) /\
...
;             return_val == Prims.list Prims.nat ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let bar`
...
Prims.nat)))
(HasType @x1
(Tm_refine_a46278218f4c76eafa827f5a69e25c74 @x0)))
...
;; def=Bug254.fst(25,18-25,38); use=Bug254.fst(27,17-33,2)
(BoxBool_proj_0 (Bug254.foo (FStar.List.mapT (FStar.Pervasives.Native.tuple2 Prims.nat
Prims.nat)
Prims.nat
(ApplyTT (ApplyTT FStar.Pervasives.Native.fst@tok
Prims.nat)
...
;; def=Prims.fst(441,36-441,97); use=Bug254.fst(27,17-33,2)
(forall ((@x3 Term))
 (! (implies (or label_1
(HasType @x3
Prims.unit))

;; def=Prims.fst(441,83-441,96); use=Bug254.fst(27,17-33,2)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug254.fst(27,17-33,2)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(441,29-441,97); use=Bug254.fst(31,8-31,14)
(and 
;; def=Bug254.fst(31,15-31,22); use=Bug254.fst(31,8-31,14)
(or label_2
...
;; def=Prims.fst(441,36-441,97); use=Bug254.fst(31,8-31,14)
(forall ((@x3 Term))
...
;; def=Prims.fst(459,77-459,89); use=Bug254.fst(27,17-33,2)
(and 
;; def=Prims.fst(73,23-73,30); use=Bug254.fst(32,20-32,21)
(or label_3
...
;; def=Prims.fst(356,2-356,58); use=Bug254.fst(27,17-33,2)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.eqtype)

;; def=Prims.fst(356,26-356,41); use=Bug254.fst(27,17-33,2)
(= @x4
(Prims.list Prims.nat))
)

;; def=Prims.fst(451,66-451,102); use=Bug254.fst(27,17-33,2)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=Prims.fst(180,10-180,11); use=Bug254.fst(27,17-33,2)
(= (Prims.op_Equality (Prims.list Prims.nat)
(FStar.List.mapT (FStar.Pervasives.Native.tuple2 Prims.nat
Prims.nat)
Prims.nat
(ApplyTT (ApplyTT FStar.Pervasives.Native.fst@tok
...
;; def=Prims.fst(672,13-672,14); use=Bug254.fst(27,17-33,2)
(= (Prims.b2t (Prims.op_Equality (Prims.list Prims.nat)
(FStar.List.mapT (FStar.Pervasives.Native.tuple2 Prims.nat
Prims.nat)
Prims.nat
(ApplyTT (ApplyTT FStar.Pervasives.Native.fst@tok
...
;; def=Prims.fst(441,29-441,97); use=Bug254.fst(32,8-32,14)
(and 
;; def=Bug254.fst(32,15-32,22); use=Bug254.fst(32,8-32,14)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=Bug254.fst(32,8-32,14)
(forall ((@x7 Term))
...
;; def=Prims.fst(451,90-451,102); use=Bug254.fst(27,17-33,2)
(Valid 
;; def=Prims.fst(451,90-451,102); use=Bug254.fst(27,17-33,2)
(ApplyTT @x2
@x8)
...
; Starting query at Bug254.fst(27,0-33,2)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (ms1: Prims.list (Prims.nat & Prims.nat)) (ms2: Prims.list (Prims.nat & Prims.nat)).
;   (*  - Subtyping check failed
;   - Expected type Prims.eqtype got type Type0
; *)
;   Prims.hasEq (Prims.list Prims.nat)
...
;; def=Prims.fst(73,23-73,30); use=Bug254.fst(27,4-27,7)
(or label_1
