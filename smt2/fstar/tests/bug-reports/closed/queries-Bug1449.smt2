...
; Internals for Bug1449


; encoding sigelt val Bug1449.acc


; <Start encoding val Bug1449.acc>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug1449.acc (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug1449.acc@tok () Term)

; </end encoding val Bug1449.acc>
...
; Starting query at Bug1449.fst(21,2-23,29)

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug1449.f (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug1449.f@tok () Term)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Prims.string) (l: Prims.list Prims.string).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.string).
;     (forall (any_result: Prims.string). p any_result) ==>
;     (forall (k: Prims.pure_post Prims.string).
;         (forall (x: Prims.string). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;         ~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False)


; Context: While encoding a query
; While typechecking the top-level declaration `let rec f`
...
;; def=Prims.fst(402,27-402,88); use=Bug1449.fst(21,2-23,29)
(forall ((@x4 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug1449.fst(21,2-23,29)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug1449.fst(21,2-23,29)
(ApplyTT @x3
@x4)
...
;; def=Bug1449.fst(20,12-20,13); use=Bug1449.fst(21,8-21,9)
(not 
;; def=Bug1449.fst(20,12-20,13); use=Bug1449.fst(21,8-21,9)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.string
@x1))
)
...
(not 
;; def=Bug1449.fst(20,12-20,13); use=Bug1449.fst(21,8-21,9)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.string
@x1))
)
)
label_2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1449.f, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, projection_inverse_BoxBool_proj_0
