...
; Internals for Bug2422


; encoding sigelt val Bug2422.t


; <Start encoding val Bug2422.t>

(declare-fun Bug2422.t (Term) Term)
;;;;;;;;;;;;;;;;n: Prims.nat -> Type
(declare-fun Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e () Term)
(declare-fun Bug2422.t@tok () Term)

; </end encoding val Bug2422.t>


; encoding sigelt val Bug2422.mkt


; <Start encoding val Bug2422.mkt>

(declare-fun Bug2422.mkt (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.list (Prims.bool & Prims.int) -> t (FStar.List.Tot.Base.length x)
(declare-fun Tm_arrow_816847dc8d38eb64aa61f55ee42c8b2b () Term)
(declare-fun Bug2422.mkt@tok () Term)

; </end encoding val Bug2422.mkt>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2422.t; Namespace Bug2422
(assert (! 
;; def=Bug2422.fst(6,4-6,5); use=Bug2422.fst(6,4-6,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (Bug2422.t @x0)
Tm_type))
 

:pattern ((Bug2422.t @x0))
:qid typing_Bug2422.t))

:named typing_Bug2422.t))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug2422.mkt; Namespace Bug2422
(assert (! 
;; def=Bug2422.fst(9,4-9,7); use=Bug2422.fst(9,4-9,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(Prims.list (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)))
(HasType (Bug2422.mkt @x0)
(Bug2422.t (FStar.List.Tot.Base.length (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)
@x0))))
 

:pattern ((Bug2422.mkt @x0))
:qid typing_Bug2422.mkt))

:named typing_Bug2422.mkt))
...
; Starting query at Bug2422.fst(15,6-15,36)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_52babd3414e743c3cc66311e1b1f64b1 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug2422.fst(13,19-13,56); use=Bug2422.fst(13,19-13,56)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_52babd3414e743c3cc66311e1b1f64b1 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_52babd3414e743c3cc66311e1b1f64b1 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_52babd3414e743c3cc66311e1b1f64b1))

:named refinement_kinding_Tm_refine_52babd3414e743c3cc66311e1b1f64b1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug2422.fst(13,19-13,56); use=Bug2422.fst(13,19-13,56)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_52babd3414e743c3cc66311e1b1f64b1 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=Bug2422.fst(13,20-13,44); use=Bug2422.fst(13,20-13,44)
(= (FStar.List.Tot.Base.length Prims.int
@x2)
(FStar.List.Tot.Base.length (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)
@x3))


;; def=Bug2422.fst(13,48-13,55); use=Bug2422.fst(13,48-13,55)
(BoxBool_proj_0 (Prims.uu___is_Cons (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)
@x3))
))
...
(Tm_refine_52babd3414e743c3cc66311e1b1f64b1 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_52babd3414e743c3cc66311e1b1f64b1))

:named refinement_interpretation_Tm_refine_52babd3414e743c3cc66311e1b1f64b1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_52babd3414e743c3cc66311e1b1f64b1
;;; Fact-ids: 
(assert (! 
;; def=Bug2422.fst(13,19-13,56); use=Bug2422.fst(13,19-13,56)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_52babd3414e743c3cc66311e1b1f64b1 @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_52babd3414e743c3cc66311e1b1f64b1 @x0
@x1))))
:qid haseqTm_refine_52babd3414e743c3cc66311e1b1f64b1))

:named haseqTm_refine_52babd3414e743c3cc66311e1b1f64b1))

; Encoding query formula : forall (x: Prims.list Prims.int)
;   (y: Prims.list (Prims.bool & Prims.int))
;   (_: Prims.squash (FStar.List.Tot.Base.length x == FStar.List.Tot.Base.length y /\ Cons? y)).
;   (*  - Could not prove post-condition
; *)
;   Cons? y /\
;   (forall (any_result: Prims.list (Prims.bool & Prims.int)).
;       y == any_result ==>
;       (forall (any_result: Prims.list (Prims.bool & Prims.int)).
;           y.tl == any_result ==>
;           (forall (any_result: Prims.list (Prims.bool & Prims.int)).
;               (false, 0) :: y.tl == any_result ==>
;               (forall (any_result: Bug2422.t (FStar.List.Tot.Base.length ((false, 0) :: y.tl))).
;                   Bug2422.mkt ((false, 0) :: y.tl) == any_result ==>
;                   FStar.List.Tot.Base.length ((false, 0) :: y.tl) == FStar.List.Tot.Base.length x)))
;   )
...
Prims.int)))
(HasType @x2
(Tm_refine_52babd3414e743c3cc66311e1b1f64b1 @x0
@x1)))

;; def=Prims.fst(459,77-459,89); use=Bug2422.fst(15,6-15,36)
(and 
;; def=Prims.fst(616,4-616,8); use=Bug2422.fst(15,34-15,35)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=Bug2422.fst(15,6-15,36)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.list (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)))

;; def=Prims.fst(616,4-616,8); use=Bug2422.fst(15,6-15,36)
(= @x1
@x3)
)
...
;; def=Prims.fst(616,20-616,22); use=Bug2422.fst(15,6-15,36)
(= (Prims.__proj__Cons__item__tl (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)
@x1)
@x4)
)
...
;; def=Bug2422.fst(9,9-15,36); use=Bug2422.fst(15,6-15,36)
(= (Prims.Cons (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)
...
;; def=Bug2422.fst(14,6-15,36); use=Bug2422.fst(15,6-15,36)
(= (Bug2422.mkt (Prims.Cons (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)
(FStar.Pervasives.Native.Mktuple2 Prims.bool
Prims.int
(BoxBool false)
...
;; def=Bug2422.fst(9,34-14,20); use=Bug2422.fst(15,6-15,36)
(or label_2
...
(declare-fun Tm_refine_52babd3414e743c3cc66311e1b1f64b1 (Term Term) Term)
(declare-fun Bug2422.test (Term Term Term) Term)

;;;;;;;;;;;;;;;;x: Prims.list Prims.int ->     y: Prims.list (Prims.bool & Prims.int) ->     _: Prims.squash (FStar.List.Tot.Base.length x == FStar.List.Tot.Base.length y /\ Cons? y)   -> t (FStar.List.Tot.Base.length x)
(declare-fun Tm_arrow_029b17ccb92eba844dd786e1c0a1ba15 () Term)
(declare-fun Bug2422.test@tok () Term)


; </end encoding let test>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug2422.test; Namespace Bug2422
(assert (! 
;; def=Bug2422.fst(13,19-13,56); use=Bug2422.fst(13,19-13,56)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_52babd3414e743c3cc66311e1b1f64b1 @x0
...
; Starting query at Bug2422.fst(21,6-21,53)
...
;; def=Prims.fst(459,77-459,89); use=Bug2422.fst(21,6-21,53)
(and 
;; def=Prims.fst(616,4-616,8); use=Bug2422.fst(21,51-21,52)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=Bug2422.fst(21,6-21,53)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.list (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)))

;; def=Prims.fst(616,4-616,8); use=Bug2422.fst(21,6-21,53)
(= @x1
@x3)
)
...
;; def=Prims.fst(616,20-616,22); use=Bug2422.fst(21,6-21,53)
(= (Prims.__proj__Cons__item__tl (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)
@x1)
@x4)
...
;; def=Bug2422.fst(9,9-21,53); use=Bug2422.fst(21,6-21,53)
(= (Prims.Cons (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)
(FStar.Pervasives.Native.Mktuple2 Prims.bool
Prims.int
...
;; def=Bug2422.fst(20,6-21,53); use=Bug2422.fst(21,6-21,53)
(= (Bug2422.mkt (Prims.Cons (FStar.Pervasives.Native.tuple2 Prims.bool
Prims.int)
(FStar.Pervasives.Native.Mktuple2 Prims.bool
Prims.int
...
;; def=Bug2422.fst(9,34-20,20); use=Bug2422.fst(21,6-21,53)
(or label_2
