...
(declare-fun Bug1536.ex (Term) Term)

(declare-fun Bug1536.ex@tok () Term)
...
; encoding sigelt val Bug1536.return_ex


; <Skipped val Bug1536.return_ex/>
...
(declare-fun Bug1536.return_ex (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> ex a
(declare-fun Tm_arrow_257b87247910bcd7d4f639f124f459ae () Term)
(declare-fun Bug1536.return_ex@tok () Term)
(declare-fun Tm_abs_3699bd5e0109c03428c7b6d4d2039b10 (Term Term) Term)

; </end encoding let return_ex>


; encoding sigelt val Bug1536.bind_ex


; <Skipped val Bug1536.bind_ex/>
...
;;;;;;;;;;;;;;;;g: a -> ex b
(declare-fun Tm_arrow_17ca8a0258ef970b59d13d527c47dbd7 (Term Term) Term)
(declare-fun Bug1536.bind_ex (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> f: ex a -> g: (g: a -> ex b) -> ex b
(declare-fun Tm_arrow_c4a4a3e62b0d6fe8e38f311b85265492 () Term)
(declare-fun Bug1536.bind_ex@tok () Term)
...
(declare-fun Bug1536.raise0 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> e: Prims.exn -> ex a
(declare-fun Tm_arrow_c84f60eb3642f17f8f4aae62ac80074c () Term)
(declare-fun Bug1536.raise0@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_lift_from_pure (Term Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_lift_from_pure@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_return_wp (Term Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_return_wp@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_return_elab (Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_return_elab@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_bind_wp (Term Term Term Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_bind_wp@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_bind_elab (Term Term Term Term Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_bind_elab@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN___proj__EXN__item__raise_elab (Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN___proj__EXN__item__raise_elab@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN___proj__EXN__item__raise_complete_type () Term)
...
(declare-fun Bug1536._dm4f_EXN_repr (Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_repr@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_pre () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Type
...
(declare-fun Bug1536._dm4f_EXN_post (Term) Term)

(declare-fun Bug1536._dm4f_EXN_post@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_wp (Term) Term)

(declare-fun Bug1536._dm4f_EXN_wp@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_ctx (Term Term) Term)

(declare-fun Bug1536._dm4f_EXN_ctx@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_gctx (Term Term) Term)

(declare-fun Bug1536._dm4f_EXN_gctx@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_pure (Term Term Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_pure@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_app (Term Term Term Term Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_app@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_lift1 (Term Term Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_lift1@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_lift2 (Term Term Term Term Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_lift2@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_push (Term Term Term Term Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_push@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_wp_if_then_else (Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_wp_if_then_else@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_wp_close (Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_wp_close@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_stronger (Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_stronger@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_ite_wp (Term Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_ite_wp@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_null_wp (Term Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_null_wp@tok () Term)
...
(declare-fun Bug1536._dm4f_EXN_wp_trivial (Term Term) Term)
...
(declare-fun Bug1536._dm4f_EXN_wp_trivial@tok () Term)
...
;;;;;;;;;;;;;;;;Action
(declare-fun Bug1536.__proj__EXN__item__raise (Term Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun Bug1536.__proj__EXN__item__raise@tok () Term)
...
(declare-fun Bug1536.ret (Term Term) Term)
(declare-fun Non_total_Tm_arrow_849619dde1d5412fc1a7bea27d736f54 () Term)
(declare-fun Bug1536.ret@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Pervasives.either a Prims.exn)
(declare-fun Tm_arrow_314a0c3aaa2224f40711b40b3eb5ec91 (Term Term) Term)
...
(declare-fun Bug1536.raise (Term Term) Term)
(declare-fun Non_total_Tm_arrow_a377dc7a196917611e12fa6867f4af0a () Term)
(declare-fun Bug1536.raise@tok () Term)
...
; encoding sigelt datacon Bug1536.EE for type Prims.exn


; <Start encoding datacon Bug1536.EE for type Prims.exn>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug1536.EE () Term)
;;;;;;;;;;;;;;;;Constructor base
(declare-fun Bug1536.EE@base () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug1536.EE
(declare-fun Bug1536.EE@tok () Term)

; <start constructor Bug1536.EE>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug1536.EE ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
726)
(= __@x0
Bug1536.EE)))

; </end constructor Bug1536.EE>


; </end encoding datacon Bug1536.EE for type Prims.exn>


; encoding sigelt val Bug1536.uu___is_EE


; <Start encoding val Bug1536.uu___is_EE>

(declare-fun Bug1536.uu___is_EE (Term) Term)
;;;;;;;;;;;;;;;;projectee: Prims.exn -> Prims.bool
(declare-fun Tm_arrow_81ab3356926b82578fcb92e97b412345 () Term)
(declare-fun Bug1536.uu___is_EE@tok () Term)

; </end encoding val Bug1536.uu___is_EE>


; encoding sigelt let uu___is_EE


; <Skipped let uu___is_EE/>


; encoding sigelt #set-options "--using_facts_from 'Prims'"


; <Skipped #set-options "--using_facts_from 'Prims'"/>
...
; Starting query at Bug1536.fst(55,11-55,78)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_93fd51b7065e740a7ad07cbf877ed6d5 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_93fd51b7065e740a7ad07cbf877ed6d5
Tm_type)
:named refinement_kinding_Tm_refine_93fd51b7065e740a7ad07cbf877ed6d5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug1536.fst(18,28-18,42); use=FStar.Pervasives.fsti(416,7-416,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_93fd51b7065e740a7ad07cbf877ed6d5)
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.either Prims.int
Prims.exn))

;; def=Prims.fst(635,71-635,97); use=FStar.Pervasives.fsti(416,7-416,9)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.Pervasives.fsti(416,7-416,9)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.Pervasives.fsti(416,7-416,9)
...
@x1
Tm_refine_93fd51b7065e740a7ad07cbf877ed6d5))
:qid refinement_interpretation_Tm_refine_93fd51b7065e740a7ad07cbf877ed6d5))

:named refinement_interpretation_Tm_refine_93fd51b7065e740a7ad07cbf877ed6d5))
;;;;;;;;;;;;;;;;haseq for Tm_refine_93fd51b7065e740a7ad07cbf877ed6d5
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_93fd51b7065e740a7ad07cbf877ed6d5))
(Valid (Prims.hasEq (FStar.Pervasives.either Prims.int
Prims.exn))))
:named haseqTm_refine_93fd51b7065e740a7ad07cbf877ed6d5))
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Pervasives.either Prims.int Prims.exn)
(declare-fun Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb
Tm_type)
:named kinding_Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug1536.fst(18,18-18,42); use=FStar.Pervasives.fsti(416,7-416,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb)
...
@x1
Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb))
:qid Bug1536_pre_typing_Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb))

:named Bug1536_pre_typing_Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb
;;; Fact-ids: 
(assert (! 
;; def=Bug1536.fst(18,18-18,42); use=FStar.Pervasives.fsti(416,7-416,9)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug1536_interpretation_Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb))
:qid Bug1536_interpretation_Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb))

:named Bug1536_interpretation_Tm_arrow_220c9dd7d80b2106ba9f9b1e6893a1bb))

; Encoding query formula : forall (_: Prims.unit)
;   (any_result: (_: Prims.unit -> Prims.PURE (FStar.Pervasives.either Prims.int Prims.exn))).
;   FStar.Pervasives.Inl 1 == any_result () ==>
;   (forall (return_val: FStar.Pervasives.either Prims.int Prims.exn).
;       return_val == FStar.Pervasives.Inl 1 ==>
;       (forall (return_val: FStar.Pervasives.either Prims.int Prims.exn).
;           return_val == return_val ==>
;           (forall (return_val: Type0).
;               return_val == (return_val == FStar.Pervasives.Inl 1) ==> return_val)))
...
;; def=Bug1536.fst(55,43-55,61); use=Bug1536.fst(55,43-55,64)
(= (FStar.Pervasives.Inl Prims.int
Prims.exn
(BoxInt 1))
(ApplyTT @x1
...
;; def=Prims.fst(356,26-356,41); use=FStar.Pervasives.fsti(341,2-341,14)
(= @x4
(Prims.eq2 (FStar.Pervasives.either Prims.int
Prims.exn)
@x3
(FStar.Pervasives.Inl Prims.int
Prims.exn
...
;; def=Prims.fst(356,10-356,20); use=Prims.fst(356,48-356,58)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1536.t1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, eq2-interp
...
; encoding sigelt let t1


; <Start encoding let t1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug1536.t1 (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug1536.t1@tok () Term)

; </end encoding let t1>

(push) ;; push{2

; Starting query at Bug1536.fst(57,12-57,72)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_f5d2ad357fdc3ea1b9d8191d9171a2a1 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_f5d2ad357fdc3ea1b9d8191d9171a2a1
Tm_type)
:named refinement_kinding_Tm_refine_f5d2ad357fdc3ea1b9d8191d9171a2a1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug1536.fst(18,28-18,42); use=FStar.Pervasives.fsti(416,7-416,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f5d2ad357fdc3ea1b9d8191d9171a2a1)
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.either Prims.int
Prims.exn))
...
@x1
Tm_refine_f5d2ad357fdc3ea1b9d8191d9171a2a1))
:qid refinement_interpretation_Tm_refine_f5d2ad357fdc3ea1b9d8191d9171a2a1))

:named refinement_interpretation_Tm_refine_f5d2ad357fdc3ea1b9d8191d9171a2a1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f5d2ad357fdc3ea1b9d8191d9171a2a1
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_f5d2ad357fdc3ea1b9d8191d9171a2a1))
(Valid (Prims.hasEq (FStar.Pervasives.either Prims.int
Prims.exn))))
:named haseqTm_refine_f5d2ad357fdc3ea1b9d8191d9171a2a1))
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Pervasives.either Prims.int Prims.exn)
(declare-fun Tm_arrow_8aa032335b056036301fe325e12c155e () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8aa032335b056036301fe325e12c155e
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_8aa032335b056036301fe325e12c155e
Tm_type)
:named kinding_Tm_arrow_8aa032335b056036301fe325e12c155e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug1536.fst(18,18-18,42); use=FStar.Pervasives.fsti(416,7-416,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8aa032335b056036301fe325e12c155e)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_8aa032335b056036301fe325e12c155e))
:qid Bug1536_pre_typing_Tm_arrow_8aa032335b056036301fe325e12c155e))

:named Bug1536_pre_typing_Tm_arrow_8aa032335b056036301fe325e12c155e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8aa032335b056036301fe325e12c155e
;;; Fact-ids: 
(assert (! 
;; def=Bug1536.fst(18,18-18,42); use=FStar.Pervasives.fsti(416,7-416,9)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug1536_interpretation_Tm_arrow_8aa032335b056036301fe325e12c155e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_8aa032335b056036301fe325e12c155e))
:qid Bug1536_interpretation_Tm_arrow_8aa032335b056036301fe325e12c155e))

:named Bug1536_interpretation_Tm_arrow_8aa032335b056036301fe325e12c155e))

; Encoding query formula : forall (_: Prims.unit)
;   (any_result: (_: Prims.unit -> Prims.PURE (FStar.Pervasives.either Prims.int Prims.exn))).
;   FStar.Pervasives.Inr Bug1536.EE == any_result () ==>
;   (forall (return_val: FStar.Pervasives.either Prims.int Prims.exn).
;       return_val == FStar.Pervasives.Inr Bug1536.EE ==>
;       (forall (return_val: FStar.Pervasives.either Prims.int Prims.exn).
;           return_val == return_val ==>
;           (forall (return_val: Type0).
;               return_val == (return_val == FStar.Pervasives.Inr Bug1536.EE) ==> return_val)))
...
;; def=Bug1536.fst(18,28-57,61); use=Bug1536.fst(18,28-57,61)
(= (FStar.Pervasives.Inr Prims.int
Prims.exn
Bug1536.EE@tok)
(ApplyTT @x1
