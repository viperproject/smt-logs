...
; Starting query at Bug3213b.fst(4,56-4,58)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (p: (_: a -> Prims.GTot Type)) (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (x: a). p x) /\ (forall (pure_result: Prims.unit). p x ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let forall_elim`
...
;; def=Bug3213b.fst(4,20-4,38); use=Bug3213b.fst(4,56-4,58)
(forall ((@x4 Term))
 (! (implies (HasType @x4
@x0)

;; def=Bug3213b.fst(4,35-4,38); use=Bug3213b.fst(4,56-4,58)
(Valid 
;; def=Bug3213b.fst(4,35-4,38); use=Bug3213b.fst(4,56-4,58)
(ApplyTT @x1
@x4)
...
;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(4,56-4,58)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=Bug3213b.fst(4,49-4,52); use=Bug3213b.fst(4,56-4,58)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug3213b.fst(4,56-4,58)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug3213b.fst(4,56-4,58)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3213b.forall_elim, 1)
; STATUS: unsat
...
; encoding sigelt let forall_elim


; <Start encoding let forall_elim>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug3213b.forall_elim (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug3213b.forall_elim@tok () Term)

; </end encoding let forall_elim>
...
; Starting query at Bug3213b.fst(8,98-8,100)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: Prims.nat -> Type
(declare-fun Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e
Tm_type)
:named kinding_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug3213b.fst(8,24-8,36); use=Bug3213b.fst(8,98-8,100)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid Bug3213b_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named Bug3213b_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e
;;; Fact-ids: 
(assert (! 
;; def=Bug3213b.fst(8,24-8,36); use=Bug3213b.fst(8,98-8,100)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug3213b_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid Bug3213b_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named Bug3213b_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

(declare-fun Tm_abs_09b386911dac9b1410a9e8a99c8454c7 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_09b386911dac9b1410a9e8a99c8454c7
;;; Fact-ids: 
(assert (! (HasType Tm_abs_09b386911dac9b1410a9e8a99c8454c7
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)
:named typing_Tm_abs_09b386911dac9b1410a9e8a99c8454c7))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_09b386911dac9b1410a9e8a99c8454c7
;;; Fact-ids: 
(assert (! 
;; def=Bug3213b.fst(8,84-8,88); use=Bug3213b.fst(8,98-8,100)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_09b386911dac9b1410a9e8a99c8454c7
@x0)
Prims.l_True)
 

:pattern ((ApplyTT Tm_abs_09b386911dac9b1410a9e8a99c8454c7
@x0))
:qid interpretation_Tm_abs_09b386911dac9b1410a9e8a99c8454c7))

:named interpretation_Tm_abs_09b386911dac9b1410a9e8a99c8454c7))
...
;         (forall (f: (_: Prims.nat -> Type0)).
;             (forall (x: Prims.nat). f x) ==> (fun _ -> Prims.l_True) == f) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let also_bad`
; While typechecking the top-level declaration `[@@expect_failure] let also_bad`
...
;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(8,98-8,100)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=Bug3213b.fst(8,10-8,95); use=Bug3213b.fst(8,98-8,100)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)

;; def=Bug3213b.fst(8,40-8,63); use=Bug3213b.fst(8,98-8,100)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.nat)

;; def=Bug3213b.fst(8,59-8,62); use=Bug3213b.fst(8,98-8,100)
(Valid 
;; def=Bug3213b.fst(8,59-8,62); use=Bug3213b.fst(8,98-8,100)
(ApplyTT @x3
@x4)
...
;; def=Bug3213b.fst(8,68-8,94); use=Bug3213b.fst(8,98-8,100)
(or label_2

;; def=Bug3213b.fst(8,68-8,94); use=Bug3213b.fst(8,98-8,100)
(= Tm_abs_09b386911dac9b1410a9e8a99c8454c7
@x3)
)
)
...
;; def=Prims.fst(441,83-441,96); use=Bug3213b.fst(8,98-8,100)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug3213b.fst(8,98-8,100)
(ApplyTT @x1
@x2)
...
; encoding sigelt let also_bad_assumed


; <Start encoding let also_bad_assumed>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug3213b.also_bad_assumed (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug3213b.also_bad_assumed@tok () Term)

; </end encoding let also_bad_assumed>
...
; Starting query at Bug3213b.fst(13,88-13,90)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug3213b.fst(13,26-13,37); use=Bug3213b.fst(13,20-13,28)
(forall ((@x0 Term) (@x1 Term))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x2
@x3)))
:qid Bug3213b_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named Bug3213b_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
...
:pattern ((ApplyTT @x0
@x3))
:qid Bug3213b_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe.1))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x2)))
:qid Bug3213b_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named Bug3213b_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
...
;   (f2: (_: 'a -> 'b))
;   (x: 'a)
;   (_: Prims.squash (f1 == f2)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). f1 x == f2 x ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let eq_fun`
...
;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(13,88-13,90)
(forall ((@x7 Term))
 (! (implies (and (or label_1
(HasType @x7
Prims.unit))

;; def=Bug3213b.fst(13,71-13,85); use=Bug3213b.fst(13,88-13,90)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Bug3213b.fst(13,88-13,90)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Bug3213b.fst(13,88-13,90)
(ApplyTT @x6
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3213b.eq_fun, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0dee8cb03258a67c2f7ec66427696212
...
; encoding sigelt let eq_fun


; <Start encoding let eq_fun>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug3213b.eq_fun (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug3213b.eq_fun@tok () Term)

; </end encoding let eq_fun>
...
; Starting query at Bug3213b.fst(15,13-30,4)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug3213b.fst(21,16-21,28); use=Bug3213b.fst(21,2-21,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug3213b.fst(21,84-21,88); use=Bug3213b.fst(21,2-21,13)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_09b386911dac9b1410a9e8a99c8454c7
@x0)
Prims.l_True)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug3213b.fst(16,11-16,23); use=Bug3213b.fst(23,2-23,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid Bug3213b_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named Bug3213b_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug3213b_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid Bug3213b_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named Bug3213b_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
(declare-fun Tm_abs_7abdf5a5f13e7e6a87c8f777c806807b () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_7abdf5a5f13e7e6a87c8f777c806807b
;;; Fact-ids: 
(assert (! (HasType Tm_abs_7abdf5a5f13e7e6a87c8f777c806807b
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
:named typing_Tm_abs_7abdf5a5f13e7e6a87c8f777c806807b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_7abdf5a5f13e7e6a87c8f777c806807b
;;; Fact-ids: 
(assert (! 
;; def=Bug3213b.fst(16,35-16,39); use=Bug3213b.fst(23,2-23,8)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_7abdf5a5f13e7e6a87c8f777c806807b
@x0)
Prims.l_True)
 

:pattern ((ApplyTT Tm_abs_7abdf5a5f13e7e6a87c8f777c806807b
@x0))
:qid interpretation_Tm_abs_7abdf5a5f13e7e6a87c8f777c806807b))

:named interpretation_Tm_abs_7abdf5a5f13e7e6a87c8f777c806807b))



(declare-fun Tm_abs_938b27e088cbd01016d92b642296a545 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_938b27e088cbd01016d92b642296a545
;;; Fact-ids: 
(assert (! (HasType Tm_abs_938b27e088cbd01016d92b642296a545
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
:named typing_Tm_abs_938b27e088cbd01016d92b642296a545))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_938b27e088cbd01016d92b642296a545
;;; Fact-ids: 
(assert (! 
;; def=Bug3213b.fst(17,35-17,41); use=Bug3213b.fst(24,2-24,8)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_938b27e088cbd01016d92b642296a545
@x0)
(Prims.b2t (Prims.op_GreaterThanOrEqual @x0
(BoxInt 0))))
 

:pattern ((ApplyTT Tm_abs_938b27e088cbd01016d92b642296a545
@x0))
:qid interpretation_Tm_abs_938b27e088cbd01016d92b642296a545))

:named interpretation_Tm_abs_938b27e088cbd01016d92b642296a545))
...
;     (forall (f: (_: Prims.nat -> Type0)).
;         (forall (x: Prims.nat). f x) ==> (fun _ -> Prims.l_True) == f) ==>
;     (forall (x: (_: Prims.nat -> Type0)).
;         (forall (x: Prims.nat). x x) ==> (fun _ -> Prims.l_True) == x) /\
;     (forall (pure_result: Prims.unit).
;         (fun _ -> Prims.l_True) == (fun _ -> Prims.l_True) ==>
;         (forall (x: (_: Prims.nat -> Type0)).
;             (forall (x: Prims.nat). x x) ==> (fun _ -> Prims.l_True) == x) /\
;         (forall (pure_result: Prims.unit).
;             ((forall (x: Prims.nat). x >= 0) ==> (fun _ -> Prims.l_True) == (fun x -> x >= 0)) ==>
;             (fun _ -> Prims.l_True) == (fun _ -> Prims.l_True) /\
;             (forall (pure_result: Prims.unit).
;                 (fun _ -> Prims.l_True) == (fun _ -> Prims.l_True) ==>
;                 (fun x -> x >= 0) == (fun _ -> Prims.l_True) /\
;                 (forall (pure_result: Prims.unit).
;                     (fun x -> x >= 0) == (fun _ -> Prims.l_True) ==>
;                     (forall (pure_result: Prims.unit) (pure_result: Prims.unit).
;                         (fun _ -> Prims.l_True) == (fun x -> x >= 0) /\
;                         (forall (pure_result: Prims.unit).
;                             (fun _ -> Prims.l_True) == (fun x -> x >= 0) ==>
;                             (fun _ -> Prims.l_True) == (fun x -> x >= 0) /\
;                             (forall (any_result: Prims.unit) (pure_result: Prims.unit).
;                                 Prims.l_True == Prims.l_False ==> Prims.l_False)))))))
...
;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(18,2-18,18)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.unit)

;; def=Bug3213b.fst(11,10-11,95); use=Bug3213b.fst(18,2-18,18)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)

;; def=Bug3213b.fst(11,40-11,63); use=Bug3213b.fst(18,2-18,18)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.nat)

;; def=Bug3213b.fst(11,59-11,62); use=Bug3213b.fst(18,2-18,18)
(Valid 
;; def=Bug3213b.fst(11,59-11,62); use=Bug3213b.fst(18,2-18,18)
(ApplyTT @x2
@x3)
...
;; def=Bug3213b.fst(11,68-11,94); use=Bug3213b.fst(18,2-18,18)
(= Tm_abs_09b386911dac9b1410a9e8a99c8454c7
@x2)
)
...
;; def=Prims.fst(441,29-441,97); use=Bug3213b.fst(21,2-21,13)
(and 
;; def=Bug3213b.fst(4,20-4,38); use=Bug3213b.fst(21,2-21,13)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)

;; def=Bug3213b.fst(21,40-21,63); use=Bug3213b.fst(21,2-21,13)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.nat)

;; def=Bug3213b.fst(21,59-21,62); use=Bug3213b.fst(21,2-21,13)
(Valid 
;; def=Bug3213b.fst(21,59-21,62); use=Bug3213b.fst(21,2-21,13)
(ApplyTT @x2
@x3)
...
;; def=Bug3213b.fst(21,68-21,94); use=Bug3213b.fst(21,2-21,13)
(or label_1
...
;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(21,2-21,13)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)
...
;; def=Bug3213b.fst(21,68-21,94); use=Bug3213b.fst(21,2-21,13)
(= Tm_abs_09b386911dac9b1410a9e8a99c8454c7
Tm_abs_7abdf5a5f13e7e6a87c8f777c806807b)
)

;; def=Prims.fst(441,29-441,97); use=Bug3213b.fst(22,2-22,13)
(and 
;; def=Bug3213b.fst(4,20-4,38); use=Bug3213b.fst(22,2-22,13)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)

;; def=Bug3213b.fst(22,40-22,63); use=Bug3213b.fst(22,2-22,13)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.nat)

;; def=Bug3213b.fst(22,59-22,62); use=Bug3213b.fst(22,2-22,13)
(Valid 
;; def=Bug3213b.fst(22,59-22,62); use=Bug3213b.fst(22,2-22,13)
(ApplyTT @x3
@x4)
...
;; def=Bug3213b.fst(22,68-22,94); use=Bug3213b.fst(22,2-22,13)
(or label_2
...
;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(22,2-22,13)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=Bug3213b.fst(22,40-22,94); use=Bug3213b.fst(22,2-22,13)
(implies 
;; def=Bug3213b.fst(22,40-22,63); use=Bug3213b.fst(22,2-22,13)
(forall ((@x4 Term))
 (! (implies (HasType @x4
...
;; def=Bug3213b.fst(17,35-17,41); use=Bug3213b.fst(22,2-22,13)
(>= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 (BoxInt 0)))
)
...
;; def=Bug3213b.fst(22,68-22,94); use=Bug3213b.fst(22,2-22,13)
(= Tm_abs_09b386911dac9b1410a9e8a99c8454c7
Tm_abs_938b27e088cbd01016d92b642296a545)
)
)

;; def=Prims.fst(441,29-441,97); use=Bug3213b.fst(23,2-23,8)
(and 
;; def=Bug3213b.fst(23,9-23,39); use=Bug3213b.fst(23,2-23,8)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(23,2-23,8)
(forall ((@x4 Term))
...
;; def=Prims.fst(441,29-441,97); use=Bug3213b.fst(24,2-24,8)
(and 
;; def=Bug3213b.fst(24,9-24,39); use=Bug3213b.fst(24,2-24,8)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(24,2-24,8)
(forall ((@x5 Term))
...
;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(25,2-25,8)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.unit)

;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(26,2-26,8)
(forall ((@x7 Term))
 (! (implies (HasType @x7
Prims.unit)

;; def=Prims.fst(441,29-441,97); use=Bug3213b.fst(27,2-27,8)
(and 
;; def=Bug3213b.fst(27,9-27,19); use=Bug3213b.fst(27,2-27,8)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(27,2-27,8)
(forall ((@x8 Term))
...
;; def=Prims.fst(459,77-459,89); use=Bug3213b.fst(15,13-30,4)
(and 
;; def=Bug3213b.fst(13,51-13,61); use=Bug3213b.fst(28,20-28,22)
(or label_6
...
;; def=Prims.fst(451,66-451,102); use=Bug3213b.fst(15,13-30,4)
(forall ((@x9 Term))
 (! (implies (HasType @x9
Prims.unit)

;; def=Prims.fst(441,36-441,97); use=Bug3213b.fst(28,2-28,8)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=Bug3213b.fst(13,71-13,85); use=Bug3213b.fst(28,2-28,8)
(= Prims.l_True
Prims.l_False)
)
label_7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3213b.bad2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, false_interp, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, true_interp
