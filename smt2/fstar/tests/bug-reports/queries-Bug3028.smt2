...
; Internals for Bug3028


; encoding sigelt let mk


; <Start encoding let mk>

(declare-fun Bug3028.mk (Term) Term)

(declare-fun Bug3028.mk@tok () Term)
(declare-fun Non_total_Tm_arrow_51f6bb3e0c48ea00ec13c9b922d3ff04 (Term) Term)

; </end encoding let mk>


; encoding sigelt let mk2


; <Start encoding let mk2>

(declare-fun Bug3028.mk2 (Term) Term)

(declare-fun Bug3028.mk2@tok () Term)

; </end encoding let mk2>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug3028.mk2; Namespace Bug3028
(assert (! 
;; def=Bug3028.fst(4,4-4,7); use=Bug3028.fst(4,4-4,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Bug3028.mk2 @x0)
Tm_type))
 

:pattern ((Bug3028.mk2 @x0))
:qid typing_Bug3028.mk2))

:named typing_Bug3028.mk2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug3028.mk; Namespace Bug3028
(assert (! 
;; def=Bug3028.fst(3,4-3,6); use=Bug3028.fst(3,4-3,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Bug3028.mk @x0)
Tm_type))
 

:pattern ((Bug3028.mk @x0))
:qid typing_Bug3028.mk))

:named typing_Bug3028.mk))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Bug3028.mk; Namespace Bug3028
(assert (! 
;; def=Bug3028.fst(3,7-3,15); use=Bug3028.fst(3,11-3,23)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Non_total_Tm_arrow_51f6bb3e0c48ea00ec13c9b922d3ff04 @x0)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_51f6bb3e0c48ea00ec13c9b922d3ff04 @x0)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_51f6bb3e0c48ea00ec13c9b922d3ff04))

:named non_total_function_typing_Non_total_Tm_arrow_51f6bb3e0c48ea00ec13c9b922d3ff04))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
:pattern ((Bug3028.mk2 @x0))
:qid equation_Bug3028.mk2))

:named equation_Bug3028.mk2))
;;;;;;;;;;;;;;;;Equation for Bug3028.mk
;;; Fact-ids: Name Bug3028.mk; Namespace Bug3028
(assert (! 
;; def=Bug3028.fst(3,4-3,6); use=Bug3028.fst(3,4-3,6)
(forall ((@x0 Term))
 (! (= (Bug3028.mk @x0)
(Non_total_Tm_arrow_51f6bb3e0c48ea00ec13c9b922d3ff04 @x0))
 

:pattern ((Bug3028.mk @x0))
:qid equation_Bug3028.mk))

:named equation_Bug3028.mk))
...
; Starting query at Bug3028.fst(6,0-6,34)

(declare-fun label_1 () Bool)

; Encoding query formula : Bug3028.mk Prims.int == Bug3028.mk2 Prims.int
...
;;; Fact-ids: 
(assert (! (not 
;; def=Bug3028.fst(6,15-6,34); use=Bug3028.fst(6,8-6,14)
(or label_1

;; def=Bug3028.fst(6,15-6,34); use=Bug3028.fst(6,8-6,14)
(= (Bug3028.mk Prims.int)
(Bug3028.mk2 Prims.int))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug3028.uu___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Bug3028.mk2
...
(declare-fun Bug3028.uu___0 (Dummy_sort) Term)
...
; Starting query at Bug3028.fst(9,0-9,34)

(declare-fun label_1 () Bool)

; Encoding query formula : Bug3028.mk Prims.int == Bug3028.mk Prims.bool
...
;;; Fact-ids: 
(assert (! (not 
;; def=Bug3028.fst(9,15-9,34); use=Bug3028.fst(9,8-9,14)
(or label_1

;; def=Bug3028.fst(9,15-9,34); use=Bug3028.fst(9,8-9,14)
(= (Bug3028.mk Prims.int)
(Bug3028.mk Prims.bool))
)
)
:named @query))
(set-option :rlimit 2723280)
...
; Starting query at Bug3028.fst(12,0-12,35)

(declare-fun label_1 () Bool)

; Encoding query formula : Bug3028.mk Prims.int == Bug3028.mk2 Prims.bool
...
;;; Fact-ids: 
(assert (! (not 
;; def=Bug3028.fst(12,15-12,35); use=Bug3028.fst(12,8-12,14)
(or label_1

;; def=Bug3028.fst(12,15-12,35); use=Bug3028.fst(12,8-12,14)
(= (Bug3028.mk Prims.int)
(Bug3028.mk2 Prims.bool))
)
)
:named @query))
(set-option :rlimit 2723280)
...
; encoding sigelt let mka


; <Start encoding let mka>

(declare-fun Bug3028.mka (Term) Term)
(declare-fun Non_total_Tm_arrow_b4d1efba4e90e1046e8807da2dec2679 () Term)
;;;;;;;;;;;;;;;;x: Prims.int -> _: Prims.unit -> FStar.Pervasives.Dv Prims.int
(declare-fun Tm_arrow_2d77d33981e504442ed0a10c3883612b () Term)
(declare-fun Bug3028.mka@tok () Term)

;;;;;;;;;;;;;;;;Imprecise function encoding
(declare-fun Tm_abs_Bug3028_122 (Term) Term)

; </end encoding let mka>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug3028.mka; Namespace Bug3028
(assert (! 
;; def=Bug3028.fst(14,4-14,7); use=Bug3028.fst(14,4-14,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (Bug3028.mka @x0)
Non_total_Tm_arrow_b4d1efba4e90e1046e8807da2dec2679))
 

:pattern ((Bug3028.mka @x0))
:qid typing_Bug3028.mka))

:named typing_Bug3028.mka))
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: Name Bug3028.mka; Namespace Bug3028
(assert (! (HasType Non_total_Tm_arrow_b4d1efba4e90e1046e8807da2dec2679
Tm_type)
:named non_total_function_typing_Non_total_Tm_arrow_b4d1efba4e90e1046e8807da2dec2679))
;;;;;;;;;;;;;;;;Equation for Bug3028.mka
;;; Fact-ids: Name Bug3028.mka; Namespace Bug3028
(assert (! 
;; def=Bug3028.fst(14,4-14,7); use=Bug3028.fst(14,4-14,7)
(forall ((@x0 Term))
 (! (= (Bug3028.mka @x0)
(Tm_abs_Bug3028_122 @x0))
 

:pattern ((Bug3028.mka @x0))
:qid equation_Bug3028.mka))

:named equation_Bug3028.mka))
(push) ;; push{3

; Starting query at Bug3028.fst(18,2-18,25)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Prims.unit). (*  - Could not prove post-condition
; *) Bug3028.mka 1 == Bug3028.mka 2
...
;; def=Bug3028.fst(18,9-18,25); use=Bug3028.fst(18,9-18,25)
(or label_1

;; def=Bug3028.fst(18,9-18,25); use=Bug3028.fst(18,9-18,25)
(= (Bug3028.mka (BoxInt 1))
(Bug3028.mka (BoxInt 2)))
)
)
...
; encoding sigelt val Bug3028.st


; <Start encoding val Bug3028.st>

(declare-fun Bug3028.st (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Type
(declare-fun Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2 () Term)
(declare-fun Bug3028.st@tok () Term)

; </end encoding val Bug3028.st>


; encoding sigelt let t2


; <Start encoding let t2>

(declare-fun Bug3028.t2 () Term)
(declare-fun Non_total_Tm_arrow_d7e33f5a32f85f0e28432904f3245cd3 (Term) Term)
;;;;;;;;;;;;;;;;i: FStar.Ghost.erased Prims.int -> _: st i -> FStar.Pervasives.Dv Prims.unit
(declare-fun Tm_arrow_0445f9a55b903e7a90f97b51854b7a28 () Term)
...
; Starting query at Bug3028.fst(45,0-45,34)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Prims.int). x + 1 > x
...
;;; Fact-ids: 
(assert (! (not 
;; def=Bug3028.fst(45,15-45,34); use=Bug3028.fst(45,8-45,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)

;; def=Bug3028.fst(45,26-45,33); use=Bug3028.fst(45,8-45,14)
(or label_1
...
; QUERY ID: (Bug3028.uu___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0
