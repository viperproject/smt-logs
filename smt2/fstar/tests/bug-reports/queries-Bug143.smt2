...
; encoding sigelt type Bug143.empty


; <Start encoding type Bug143.empty>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug143.empty () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug143.Empty (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug143.Empty__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug143.Empty
(declare-fun Bug143.Empty@tok () Term)
;;;;;;;;;;;;;;;;_0: empty -> empty
(declare-fun Tm_arrow_a96e88329343e681e34120f89692af26 () Term)

; <start constructor Bug143.empty>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug143.empty ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
114)
(= __@x0
Bug143.empty)))

; </end constructor Bug143.empty>
...
120)
(= __@x0
(Bug143.Empty (Bug143.Empty__0 __@x0)))))

; </end constructor Bug143.Empty>


; </end encoding type Bug143.empty>
...
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug143.empty; Namespace Bug143; Name Bug143.Empty; Namespace Bug143
(assert (! 
;; def=Bug143.fst(19,15-19,20); use=Bug143.fst(19,15-19,20)
...
(Bug143.Empty @x1)
Bug143.empty))
:qid subterm_ordering_Bug143.Empty))

:named subterm_ordering_Bug143.Empty))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=Bug143.fst(19,15-19,20); use=Bug143.fst(19,15-19,20)
(forall ((@x0 Term))
 (! (= (Bug143.Empty__0 (Bug143.Empty @x0))
@x0)
 

:pattern ((Bug143.Empty @x0))
:qid projection_inverse_Bug143.Empty__0))

:named projection_inverse_Bug143.Empty__0))
;;; Fact-ids: Name Bug143.empty; Namespace Bug143; Name Bug143.Empty; Namespace Bug143
(assert (! (HasType Bug143.empty
Tm_type)
:named kinding_Bug143.empty@tok))
...
;;; Fact-ids: Name Bug143.empty; Namespace Bug143; Name Bug143.Empty; Namespace Bug143
(assert (! 
;; def=Bug143.fst(19,5-19,10); use=Bug143.fst(19,5-19,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Bug143.empty)
...
@x1
Bug143.empty))
:qid fuel_guarded_inversion_Bug143.empty))

:named fuel_guarded_inversion_Bug143.empty))
...
(Bug143.Empty @x1)
Bug143.empty))
:qid data_typing_intro_Bug143.Empty@tok))

:named data_typing_intro_Bug143.Empty@tok))
...
(Bug143.Empty @x1)
Bug143.empty))
:qid data_elim_Bug143.Empty))

:named data_elim_Bug143.Empty))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Bug143.empty; Namespace Bug143; Name Bug143.Empty; Namespace Bug143
(assert (! (= 114
(Term_constr_id Bug143.empty))
:named constructor_distinct_Bug143.empty))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug143.empty; Namespace Bug143; Name Bug143.Empty; Namespace Bug143
(assert (! 
;; def=Bug143.fst(19,15-19,20); use=Bug143.fst(19,15-19,20)
(forall ((@x0 Term))
 (! (= 120
(Term_constr_id (Bug143.Empty @x0)))
 

:pattern ((Bug143.Empty @x0))
:qid constructor_distinct_Bug143.Empty))
...
@x0
Bug143.empty))
:qid Bug143_pretyping_c7915f706c7f0f3e61546f01ca66918a))

:named Bug143_pretyping_c7915f706c7f0f3e61546f01ca66918a))
(push) ;; push{4

; Starting query at Bug143.fst(19,0-19,37)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq Bug143.empty ==>
; (forall (_0: Bug143.empty).
...
; *)
;     Prims.hasEq Bug143.empty)


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug143.empty`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=Bug143.fst(19,0-19,37); use=Bug143.fst(19,0-19,37)
(Valid 
;; def=Bug143.fst(19,0-19,37); use=Bug143.fst(19,0-19,37)
(Prims.hasEq Bug143.empty)
)
...
;; def=Bug143.fst(19,0-19,37); use=Bug143.fst(19,23-19,28)
(or label_1
...
; encoding sigelt assume Bug143.empty__uu___haseq


; <Start encoding assume Bug143.empty__uu___haseq>


; </end encoding assume Bug143.empty__uu___haseq>


; encoding sigelt val Bug143.uu___is_Empty


; <Start encoding val Bug143.uu___is_Empty>

(declare-fun Bug143.uu___is_Empty (Term) Term)
;;;;;;;;;;;;;;;;projectee: empty -> Prims.bool
(declare-fun Tm_arrow_fdc2223f459ed03ed2e85c5caf97910f () Term)
(declare-fun Bug143.uu___is_Empty@tok () Term)

; </end encoding val Bug143.uu___is_Empty>
...
; encoding sigelt val Bug143.__proj__Empty__item___0


; <Start encoding val Bug143.__proj__Empty__item___0>

(declare-fun Bug143.__proj__Empty__item___0 (Term) Term)

(declare-fun Bug143.__proj__Empty__item___0@tok () Term)

; </end encoding val Bug143.__proj__Empty__item___0>


; encoding sigelt let __proj__Empty__item___0


; <Skipped let __proj__Empty__item___0/>


; encoding sigelt val Bug143.empty_is_empty


; <Skipped val Bug143.empty_is_empty/>
...
:named constructor_distinct_Bug143.Empty))
;;;;;;;;;;;;;;;;Assumption: Bug143.empty__uu___haseq
;;; Fact-ids: Name Bug143.empty__uu___haseq; Namespace Bug143
(assert (! (Valid (Prims.hasEq Bug143.empty))
:named assumption_Bug143.empty__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Starting query at Bug143.fst(23,25-23,63)

;;;;;;;;;;;;;;;;uu___0 : Bug143.empty (Bug143.empty)
(declare-fun x_c7915f706c7f0f3e61546f01ca66918a_0 () Term)
;;;;;;;;;;;;;;;;binder_x_c7915f706c7f0f3e61546f01ca66918a_0
;;; Fact-ids: 
(assert (! (HasType x_c7915f706c7f0f3e61546f01ca66918a_0
Bug143.empty)
:named binder_x_c7915f706c7f0f3e61546f01ca66918a_0))
(declare-fun Tm_refine_c34e7231453e7ec8f3e133e31037be45 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_c34e7231453e7ec8f3e133e31037be45
Tm_type)
:named refinement_kinding_Tm_refine_c34e7231453e7ec8f3e133e31037be45))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug143.fst(23,25-23,63); use=Bug143.fst(23,25-23,63)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_c34e7231453e7ec8f3e133e31037be45)
(and (HasTypeFuel @u0
@x1
Bug143.empty)
...
(Valid 
;; def=Bug143.fst(23,25-23,63); use=Bug143.fst(23,25-23,63)
(Prims.precedes Bug143.empty
Bug143.empty
@x1
x_c7915f706c7f0f3e61546f01ca66918a_0)
)
...
@x1
Tm_refine_c34e7231453e7ec8f3e133e31037be45))
:qid refinement_interpretation_Tm_refine_c34e7231453e7ec8f3e133e31037be45))

:named refinement_interpretation_Tm_refine_c34e7231453e7ec8f3e133e31037be45))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c34e7231453e7ec8f3e133e31037be45
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_c34e7231453e7ec8f3e133e31037be45))
(Valid (Prims.hasEq Bug143.empty)))
:named haseqTm_refine_c34e7231453e7ec8f3e133e31037be45))
(declare-fun Bug143.empty_is_empty (Term) Term)


;;;;;;;;;;;;;;;;_: _: empty{_ << _} -> u218: Prims.unit{Prims.l_False}
(declare-fun Tm_arrow_09ea85a02dcb3265927db54b932b6e05 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_09ea85a02dcb3265927db54b932b6e05
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_09ea85a02dcb3265927db54b932b6e05
Tm_type)
:named kinding_Tm_arrow_09ea85a02dcb3265927db54b932b6e05))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug143.fst(22,34-23,63); use=Bug143.fst(23,8-23,63)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_09ea85a02dcb3265927db54b932b6e05)
...
@x1
Tm_arrow_09ea85a02dcb3265927db54b932b6e05))
:qid Bug143_pre_typing_Tm_arrow_09ea85a02dcb3265927db54b932b6e05))

:named Bug143_pre_typing_Tm_arrow_09ea85a02dcb3265927db54b932b6e05))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_09ea85a02dcb3265927db54b932b6e05
;;; Fact-ids: 
(assert (! 
;; def=Bug143.fst(22,34-23,63); use=Bug143.fst(23,8-23,63)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug143_interpretation_Tm_arrow_09ea85a02dcb3265927db54b932b6e05.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_09ea85a02dcb3265927db54b932b6e05))
:qid Bug143_interpretation_Tm_arrow_09ea85a02dcb3265927db54b932b6e05))

:named Bug143_interpretation_Tm_arrow_09ea85a02dcb3265927db54b932b6e05))
(declare-fun Bug143.empty_is_empty@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug143.fst(23,8-23,22); use=Bug143.fst(23,8-23,22)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug143.empty_is_empty@tok
@x0)
(Bug143.empty_is_empty @x0))
 

:pattern ((ApplyTT Bug143.empty_is_empty@tok
@x0))
:qid token_correspondence_Bug143.empty_is_empty))

:named token_correspondence_Bug143.empty_is_empty))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug143.fst(23,8-23,22); use=Bug143.fst(23,8-23,22)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Bug143.empty_is_empty@tok
Tm_arrow_09ea85a02dcb3265927db54b932b6e05))
...
(forall ((@x1 Term))
 (! (= (ApplyTT Bug143.empty_is_empty@tok
@x1)
(Bug143.empty_is_empty @x1))
 

:pattern ((Bug143.empty_is_empty @x1))
:qid function_token_typing_Bug143.empty_is_empty.1))
)
 

:pattern ((ApplyTT @x0
Bug143.empty_is_empty@tok))
:qid function_token_typing_Bug143.empty_is_empty))

:named function_token_typing_Bug143.empty_is_empty))
...
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_c34e7231453e7ec8f3e133e31037be45)
(HasType (Bug143.empty_is_empty @x0)
Tm_refine_f1ecc6ab6882a651504f328937700647))
 

:pattern ((Bug143.empty_is_empty @x0))
:qid typing_Bug143.empty_is_empty))

:named typing_Bug143.empty_is_empty))
(declare-fun label_1 () Bool)

; Encoding query formula : forall (b: Bug143.empty). _ == Bug143.Empty b ==> b << _


; Context: While encoding a query
; While typechecking the top-level declaration `let rec empty_is_empty`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(413,99-413,120); use=Bug143.fst(23,25-23,63)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Bug143.empty)
...
;; def=Bug143.fst(23,25-23,63); use=Bug143.fst(23,62-23,63)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug143.empty_is_empty, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_c7915f706c7f0f3e61546f01ca66918a_0, subterm_ordering_Bug143.Empty
...
; encoding sigelt let rec empty_is_empty


; <Start encoding let rec empty_is_empty>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug143.empty_is_empty.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug143.empty_is_empty.fuel_instrumented_token () Term)
(declare-fun Bug143.empty_is_empty (Term) Term)
(declare-fun Bug143.empty_is_empty@tok () Term)


;;;;;;;;;;;;;;;;_: empty -> u249: Prims.unit{Prims.l_False}
(declare-fun Tm_arrow_88d07c9aa73e98b8ae9d2099315705cf () Term)


; </end encoding let rec empty_is_empty>


; encoding sigelt type Bug143.lam


; <Start encoding type Bug143.lam>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug143.lam () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug143.Lam (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug143.Lam__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug143.Lam
(declare-fun Bug143.Lam@tok () Term)
(declare-fun Non_total_Tm_arrow_afaa4b64e0c27e528ae269fcf93e5920 () Term)

;;;;;;;;;;;;;;;;_0: (_: lam -> FStar.Pervasives.Dv empty) -> lam
(declare-fun Tm_arrow_3932e471fddec3c0edd8f45912c015c2 () Term)

; <start constructor Bug143.lam>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug143.lam ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
150)
(= __@x0
Bug143.lam)))

; </end constructor Bug143.lam>
...
160)
(= __@x0
(Bug143.Lam (Bug143.Lam__0 __@x0)))))

; </end constructor Bug143.Lam>


; </end encoding type Bug143.lam>


; encoding sigelt val Bug143.uu___is_Lam


; <Start encoding val Bug143.uu___is_Lam>

(declare-fun Bug143.uu___is_Lam (Term) Term)
;;;;;;;;;;;;;;;;projectee: lam -> Prims.bool
(declare-fun Tm_arrow_90bd1f0a0a8b9137ebb19a6f1b794794 () Term)
(declare-fun Bug143.uu___is_Lam@tok () Term)

; </end encoding val Bug143.uu___is_Lam>
...
; encoding sigelt val Bug143.__proj__Lam__item___0


; <Start encoding val Bug143.__proj__Lam__item___0>

(declare-fun Bug143.__proj__Lam__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: lam -> _: lam -> FStar.Pervasives.Dv empty
(declare-fun Tm_arrow_c4e0dfd087f2202a48195fd453d71714 () Term)
(declare-fun Bug143.__proj__Lam__item___0@tok () Term)


; </end encoding val Bug143.__proj__Lam__item___0>
...
; encoding sigelt val Bug143.f


; <Skipped val Bug143.f/>
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug143.f (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug143.f@tok () Term)

; </end encoding let f>


; encoding sigelt val Bug143.delta


; <Skipped val Bug143.delta/>
...
(declare-fun Bug143.delta (Dummy_sort) Term)

; </end encoding let delta>


; encoding sigelt val Bug143.omega


; <Skipped val Bug143.omega/>


; encoding sigelt let omega


; <Start encoding let omega>

(declare-fun Bug143.omega (Dummy_sort) Term)

; </end encoding let omega>


; encoding sigelt val Bug143.bug


; <Skipped val Bug143.bug/>
...
; Starting query at Bug143.fst(42,13-42,33)
...
;     (b: u212: Prims.unit{Prims.l_False})
;     (any_result: u214: Prims.unit{Prims.l_False}).
;     p any_result
...
;; def=Prims.fst(413,99-413,120); use=Bug143.fst(42,13-42,33)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Tm_refine_f1ecc6ab6882a651504f328937700647)

;; def=Prims.fst(451,66-451,102); use=Bug143.fst(42,13-42,33)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_refine_f1ecc6ab6882a651504f328937700647)

;; def=Prims.fst(451,90-451,102); use=Bug143.fst(42,13-42,33)
(or label_1
