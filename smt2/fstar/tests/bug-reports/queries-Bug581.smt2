...
; Internals for Bug581


; encoding sigelt val Bug581.p


; <Start encoding val Bug581.p>

(declare-fun Bug581.p (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Type
(declare-fun Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2 () Term)
(declare-fun Bug581.p@tok () Term)

; </end encoding val Bug581.p>


; encoding sigelt val Bug581.f


; <Start encoding val Bug581.f>

(declare-fun Tm_refine_027dc1b3b9135cccfe3a3ac48e8d7060 () Term)
(declare-fun Bug581.f (Term) Term)

;;;;;;;;;;;;;;;;n: Prims.int{p n} -> Prims.int
(declare-fun Tm_arrow_d456d03cc8422021ce04da6919ad4c57 () Term)
(declare-fun Bug581.f@tok () Term)

; </end encoding val Bug581.f>


; encoding sigelt val Bug581.g


; <Skipped val Bug581.g/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug581.p; Namespace Bug581
(assert (! 
;; def=Bug581.fst(22,16-22,17); use=Bug581.fst(22,16-22,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (Bug581.p @x0)
...
:named typing_Bug581.p))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug581.f; Namespace Bug581
(assert (! 
;; def=Bug581.fst(24,11-24,12); use=Bug581.fst(24,11-24,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_027dc1b3b9135cccfe3a3ac48e8d7060)
(HasType (Bug581.f @x0)
Prims.int))
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug581.f; Namespace Bug581
(assert (! (HasType Tm_refine_027dc1b3b9135cccfe3a3ac48e8d7060
Tm_type)
:named refinement_kinding_Tm_refine_027dc1b3b9135cccfe3a3ac48e8d7060))
...
;;; Fact-ids: Name Bug581.f; Namespace Bug581
(assert (! 
;; def=Bug581.fst(24,14-24,24); use=Bug581.fst(24,14-24,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_027dc1b3b9135cccfe3a3ac48e8d7060)
...
;; def=Bug581.fst(24,20-24,23); use=Bug581.fst(24,20-24,23)
(Valid 
;; def=Bug581.fst(24,20-24,23); use=Bug581.fst(24,20-24,23)
(Bug581.p @x1)
)
...
@x1
Tm_refine_027dc1b3b9135cccfe3a3ac48e8d7060))
:qid refinement_interpretation_Tm_refine_027dc1b3b9135cccfe3a3ac48e8d7060))

:named refinement_interpretation_Tm_refine_027dc1b3b9135cccfe3a3ac48e8d7060))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.Pervasives.result; Namespace FStar.Pervasives; Name FStar.Pervasives.V; Namespace FStar.Pervasives; Name FStar.Pervasives.E; Namespace FStar.Pervasives; Name FStar.Pervasives.Err; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(520,4-520,5); use=FStar.Pervasives.fsti(520,4-520,5)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_027dc1b3b9135cccfe3a3ac48e8d7060
;;; Fact-ids: Name Bug581.f; Namespace Bug581
(assert (! (iff (Valid (Prims.hasEq Tm_refine_027dc1b3b9135cccfe3a3ac48e8d7060))
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_027dc1b3b9135cccfe3a3ac48e8d7060))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
(forall ((@x0 Term))
 (! (= 106
(Term_constr_id (Bug581.p @x0)))
 

:pattern ((Bug581.p @x0))
:qid constructor_distinct_Bug581.p))

:named constructor_distinct_Bug581.p))
;;;;;;;;;;;;;;;;Constructor base
;;; Fact-ids: Name FStar.All.Failure; Namespace FStar.All
(assert (! 
;; def=FStar.All.fsti(42,10-42,17); use=FStar.All.fsti(42,10-42,17)
...
@x0
(Bug581.p @x2)))
:qid Bug581_pretyping_ff3dc563966e1399b0c92257de4c278e))

:named Bug581_pretyping_ff3dc563966e1399b0c92257de4c278e))
(push) ;; push{2

; Starting query at Bug581.fst(34,11-34,14)
...
; *)
;   forall (p: FStar.Pervasives.all_post_h FStar.Monotonic.Heap.heap Prims.int)
;     (h: FStar.Monotonic.Heap.heap).
;     Bug581.p 0 /\
;     (forall (a: FStar.Pervasives.result Prims.int) (h: FStar.Monotonic.Heap.heap). p a h) ==>
;     Prims.auto_squash (Bug581.p 0) /\
;     (forall (any_result: Prims.int).
;         0 == any_result ==>
;         (forall (any_result: Prims.int).
;             any_result == Bug581.f 0 ==>
;             (forall (return_val: Prims.int).
;                 return_val == any_result ==> p (FStar.Pervasives.V return_val) h)))
...
;; def=Bug581.fst(32,38-32,41); use=Bug581.fst(34,11-34,14)
(Valid 
;; def=Bug581.fst(32,38-32,41); use=Bug581.fst(34,11-34,14)
(Bug581.p (BoxInt 0))
)
...
;; def=Bug581.fst(32,45-32,67); use=Bug581.fst(34,11-34,14)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (or label_1
(HasType @x3
(FStar.Pervasives.result Prims.int)))
(or label_2
(HasType @x4
FStar.Monotonic.Heap.heap)))

;; def=Bug581.fst(32,58-32,66); use=Bug581.fst(34,11-34,14)
(Valid 
;; def=Bug581.fst(32,58-32,66); use=Bug581.fst(34,11-34,14)
(ApplyTT (ApplyTT @x1
@x3)
...
;; def=Prims.fst(459,77-459,89); use=Bug581.fst(34,11-34,14)
(and 
;; def=Bug581.fst(24,20-24,23); use=Bug581.fst(34,13-34,14)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=Bug581.fst(34,11-34,14)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.int)

;; def=Bug581.fst(24,14-34,14); use=Bug581.fst(34,11-34,14)
(= (BoxInt 0)
@x3)
)
...
;; def=Bug581.fst(32,19-34,14); use=Bug581.fst(34,11-34,14)
(= @x4
(Bug581.f (BoxInt 0)))
)
...
;; def=FStar.All.fsti(31,87-31,93); use=FStar.All.fsti(32,34-32,46)
(Valid 
;; def=FStar.All.fsti(31,87-31,93); use=FStar.All.fsti(32,34-32,46)
(ApplyTT (ApplyTT @x1
(FStar.Pervasives.V Prims.int
@x5))
@x2)
)
)
...
; QUERY ID: (Bug581.g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_typing_intro_FStar.Pervasives.V@tok, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
