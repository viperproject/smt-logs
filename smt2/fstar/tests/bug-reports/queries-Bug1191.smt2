...
; Starting query at Bug1191.fst(4,2-5,48)
...
(declare-fun Tm_refine_b5ec071eb029bab924e83eb6df8bb856 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_b5ec071eb029bab924e83eb6df8bb856
Tm_type)
:named refinement_kinding_Tm_refine_b5ec071eb029bab924e83eb6df8bb856))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug1191.fst(3,44-5,48); use=Bug1191.fst(3,44-5,48)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_b5ec071eb029bab924e83eb6df8bb856)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=Bug1191.fst(4,2-5,48); use=Bug1191.fst(4,2-5,48)
...
@x1
Tm_refine_b5ec071eb029bab924e83eb6df8bb856))
:qid refinement_interpretation_Tm_refine_b5ec071eb029bab924e83eb6df8bb856))

:named refinement_interpretation_Tm_refine_b5ec071eb029bab924e83eb6df8bb856))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b5ec071eb029bab924e83eb6df8bb856
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_b5ec071eb029bab924e83eb6df8bb856))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_b5ec071eb029bab924e83eb6df8bb856))
(declare-fun Bug1191.mk_nary_function (Term Term Term) Term)

;;;;;;;;;;;;;;;;dom: Type -> codom: Type -> n: Prims.nat{n << n} -> Type
(declare-fun Tm_arrow_69d1b2408732b98c7bd24d324554d3c8 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_69d1b2408732b98c7bd24d324554d3c8
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_69d1b2408732b98c7bd24d324554d3c8
Tm_type)
:named kinding_Tm_arrow_69d1b2408732b98c7bd24d324554d3c8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug1191.fst(3,37-5,48); use=Bug1191.fst(3,37-5,48)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_69d1b2408732b98c7bd24d324554d3c8)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_69d1b2408732b98c7bd24d324554d3c8))
:qid Bug1191_pre_typing_Tm_arrow_69d1b2408732b98c7bd24d324554d3c8))

:named Bug1191_pre_typing_Tm_arrow_69d1b2408732b98c7bd24d324554d3c8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_69d1b2408732b98c7bd24d324554d3c8
;;; Fact-ids: 
(assert (! 
;; def=Bug1191.fst(3,37-5,48); use=Bug1191.fst(3,37-5,48)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid Bug1191_interpretation_Tm_arrow_69d1b2408732b98c7bd24d324554d3c8.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug1191_interpretation_Tm_arrow_69d1b2408732b98c7bd24d324554d3c8.2))
...
@x1)
@x2))
:qid Bug1191_interpretation_Tm_arrow_69d1b2408732b98c7bd24d324554d3c8.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_69d1b2408732b98c7bd24d324554d3c8))
:qid Bug1191_interpretation_Tm_arrow_69d1b2408732b98c7bd24d324554d3c8))

:named Bug1191_interpretation_Tm_arrow_69d1b2408732b98c7bd24d324554d3c8))
(declare-fun Bug1191.mk_nary_function@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug1191.fst(3,8-3,24); use=Bug1191.fst(3,8-3,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Bug1191.mk_nary_function@tok
@x0)
@x1)
@x2)
(Bug1191.mk_nary_function @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT Bug1191.mk_nary_function@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Bug1191.mk_nary_function))

:named token_correspondence_Bug1191.mk_nary_function))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug1191.fst(3,8-3,24); use=Bug1191.fst(3,8-3,24)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Bug1191.mk_nary_function@tok
Tm_arrow_69d1b2408732b98c7bd24d324554d3c8))
...
@x2)
@x3)
(Bug1191.mk_nary_function @x1
@x2
@x3))
 

:pattern ((Bug1191.mk_nary_function @x1
@x2
@x3))
:qid function_token_typing_Bug1191.mk_nary_function.1))
)
 

:pattern ((ApplyTT @x0
Bug1191.mk_nary_function@tok))
:qid function_token_typing_Bug1191.mk_nary_function))

:named function_token_typing_Bug1191.mk_nary_function))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug1191.fst(3,8-3,24); use=Bug1191.fst(3,8-3,24)
...
(HasType @x2
Tm_refine_b5ec071eb029bab924e83eb6df8bb856))
(HasType (Bug1191.mk_nary_function @x0
@x1
@x2)
Tm_type))
 

:pattern ((Bug1191.mk_nary_function @x0
@x1
@x2))
:qid typing_Bug1191.mk_nary_function))

:named typing_Bug1191.mk_nary_function))
...
;   - Expected type n: Prims.nat{n << n} got type Prims.int
; *)
;           n - 1 >= 0 /\ n - 1 << n))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec mk_nary_function`
...
;; def=Prims.fst(402,27-402,88); use=Bug1191.fst(4,2-5,48)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug1191.fst(4,2-5,48)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug1191.fst(4,2-5,48)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=Bug1191.fst(4,2-5,48)
(not 
;; def=Bug1191.fst(4,5-4,10); use=Bug1191.fst(4,5-4,10)
...
;; def=Prims.fst(413,99-413,120); use=Bug1191.fst(4,2-5,48)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=Bug1191.fst(4,5-5,48); use=Bug1191.fst(4,5-5,48)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_3
(BoxInt 0))
@x1)
...
;; def=dummy(0,0-0,0); use=Bug1191.fst(4,2-5,48)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_fe28d8bcde588226b4e538b35321de05_1)

;; def=Bug1191.fst(4,2-5,48); use=Bug1191.fst(5,41-5,48)
(and 
;; def=Prims.fst(680,18-680,24); use=Bug1191.fst(5,41-5,48)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Bug1191.fst(5,41-5,48)
(>= (BoxInt_proj_0 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_3
(BoxInt 1)))
(BoxInt_proj_0 (BoxInt 0)))
)
...
(Prims.precedes Prims.nat
Prims.nat
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_3
(BoxInt 1))
x_bb4e1c9af0265270f8e7a5f250f730e2_3)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug1191.mk_nary_function, 1)
; STATUS: unsat
