...
; Internals for Bug210b


; encoding sigelt #set-options "--print_implicits --print_universes"


; <Skipped #set-options "--print_implicits --print_universes"/>


; encoding sigelt type Bug210b.acc


; <Start encoding type Bug210b.acc>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug210b.acc (Term Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug210b.acc@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug210b.AccIntro (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug210b.AccIntro_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug210b.AccIntro_r (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug210b.AccIntro_x (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug210b.AccIntro__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug210b.AccIntro
(declare-fun Bug210b.AccIntro@tok () Term)
;;;;;;;;;;;;;;;;_: a -> _: a -> Prims.Tot Type
(declare-fun Tm_arrow_a19f9d49348d4e0038f0ded87d87802f (Term) Term)

;;;;;;;;;;;;;;;;y: a -> _: r y x -> Prims.Tot (acc a r y)
(declare-fun Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 (Term Term Term) Term)


;;;;;;;;;;;;;;;;#a: Type ->     #r: (_: a -> _: a -> Prims.Tot Type) ->     #x: a ->     _0: (y: a -> _: r y x -> Prims.Tot (acc a r y))   -> Prims.Tot (acc a r x)
(declare-fun Tm_arrow_11d1728364a8a201a9e823d255c5082f () Term)

; <start constructor Bug210b.acc>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug210b.acc ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
106)
(exists ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= __@x0
...
; </end constructor Bug210b.acc>


; <start constructor Bug210b.AccIntro>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug210b.AccIntro ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
117)
(= __@x0
(Bug210b.AccIntro (Bug210b.AccIntro_a __@x0)
(Bug210b.AccIntro_r __@x0)
(Bug210b.AccIntro_x __@x0)
(Bug210b.AccIntro__0 __@x0)))))

; </end constructor Bug210b.AccIntro>


; </end encoding type Bug210b.acc>


; encoding sigelt val Bug210b.uu___is_AccIntro


; <Start encoding val Bug210b.uu___is_AccIntro>


(declare-fun Bug210b.uu___is_AccIntro (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;#a: Type -> #r: (_: a -> _: a -> Prims.Tot Type) -> #x: a -> projectee: acc a r x   -> Prims.Tot Prims.bool
(declare-fun Tm_arrow_03ff40614a7b7b1b459e3183be99e61f () Term)
(declare-fun Bug210b.uu___is_AccIntro@tok () Term)

; </end encoding val Bug210b.uu___is_AccIntro>


; encoding sigelt let uu___is_AccIntro


; <Skipped let uu___is_AccIntro/>


; encoding sigelt val Bug210b.__proj__AccIntro__item___0


; <Start encoding val Bug210b.__proj__AccIntro__item___0>


(declare-fun Bug210b.__proj__AccIntro__item___0 (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;#a: Type ->     #r: (_: a -> _: a -> Prims.Tot Type) ->     #x: a ->     projectee: acc a r x ->     y: a ->     _: r y x   -> Prims.Tot (acc a r y)
(declare-fun Tm_arrow_2bed3c35a969495ccd25fe5b4ea155ac () Term)
(declare-fun Bug210b.__proj__AccIntro__item___0@tok () Term)


; </end encoding val Bug210b.__proj__AccIntro__item___0>


; encoding sigelt let __proj__AccIntro__item___0


; <Skipped let __proj__AccIntro__item___0/>


; encoding sigelt val Bug210b.acc_inv


; <Skipped val Bug210b.acc_inv/>
...
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(21,4-21,12); use=Bug210b.fst(21,4-21,12)
...
@x3
@x4))))
:qid well_founded_ordering_on_codomain_Bug210b.AccIntro.1))
...
@x6
@x7)))
:qid well_founded_ordering_on_codomain_Bug210b.AccIntro))

:named well_founded_ordering_on_codomain_Bug210b.AccIntro))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(20,10-20,13); use=Bug210b.fst(20,10-20,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Bug210b.acc@tok
@x0)
@x1)
@x2)
(Bug210b.acc @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Bug210b.acc@tok
@x0)
@x1)
@x2))

:pattern ((Bug210b.acc @x0
@x1
@x2))
:qid token_correspondence_Bug210b.acc@tok))

:named token_correspondence_Bug210b.acc@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(21,4-21,12); use=Bug210b.fst(21,4-21,12)
...
@x6
@x7)))
:qid subterm_ordering_Bug210b.AccIntro))

:named subterm_ordering_Bug210b.AccIntro))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(21,4-21,12); use=Bug210b.fst(21,4-21,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug210b.AccIntro_x (Bug210b.AccIntro @x0
@x1
@x2
@x3))
@x2)
...
:pattern ((Bug210b.AccIntro @x0
@x1
@x2
@x3))
:qid projection_inverse_Bug210b.AccIntro_x))

:named projection_inverse_Bug210b.AccIntro_x))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(21,4-21,12); use=Bug210b.fst(21,4-21,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug210b.AccIntro_r (Bug210b.AccIntro @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Bug210b.AccIntro_r))

:named projection_inverse_Bug210b.AccIntro_r))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(21,4-21,12); use=Bug210b.fst(21,4-21,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug210b.AccIntro_a (Bug210b.AccIntro @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_Bug210b.AccIntro_a))

:named projection_inverse_Bug210b.AccIntro_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(21,4-21,12); use=Bug210b.fst(21,4-21,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Bug210b.AccIntro__0 (Bug210b.AccIntro @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_Bug210b.AccIntro__0))

:named projection_inverse_Bug210b.AccIntro__0))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! (is-Tm_arrow (PreType Bug210b.acc@tok))
:named pre_kinding_Bug210b.acc@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(20,15-20,41); use=Bug210b.fst(20,27-20,41)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(20,15-21,47); use=Bug210b.fst(21,18-21,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9))

:named kinding_Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9))
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! (and (IsTotFun Bug210b.acc@tok)

;; def=Bug210b.fst(20,10-20,13); use=Bug210b.fst(20,10-20,13)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Bug210b.acc@tok
@x0))
 

:pattern ((ApplyTT Bug210b.acc@tok
@x0))
:qid kinding_Bug210b.acc@tok))


;; def=Bug210b.fst(20,10-20,13); use=Bug210b.fst(20,10-20,13)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (ApplyTT (ApplyTT Bug210b.acc@tok
@x0)
@x1))
 

:pattern ((ApplyTT (ApplyTT Bug210b.acc@tok
@x0)
@x1))
:qid kinding_Bug210b.acc@tok.1))
...
@x1
@x2))
:qid kinding_Bug210b.acc@tok.2))
)
:named kinding_Bug210b.acc@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(20,10-20,13); use=Bug210b.fst(20,10-20,13)
...
@x3
@x4))
(and (is-Bug210b.AccIntro @x1)
(= @x2
(Bug210b.AccIntro_a @x1))
(= @x3
(Bug210b.AccIntro_r @x1))
(= @x4
(Bug210b.AccIntro_x @x1))))
...
@x3
@x4)))
:qid fuel_guarded_inversion_Bug210b.acc))

:named fuel_guarded_inversion_Bug210b.acc))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! (= 107
(Term_constr_id Bug210b.acc@tok))
:named fresh_token_Bug210b.acc@tok))
...
(HasTypeFuel @u0
@x4
(Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 @x3
@x2
@x1)))
(HasTypeFuel @u0
(Bug210b.AccIntro @x1
...
@x2
@x3)))
:qid data_typing_intro_Bug210b.AccIntro@tok))

:named data_typing_intro_Bug210b.AccIntro@tok))
...
(HasTypeFuel @u0
@x6
(Tm_arrow_a19f9d49348d4e0038f0ded87d87802f @x5))
(HasTypeFuel @u0
@x7
@x5)
(HasTypeFuel @u0
@x4
(Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 @x7
@x6
@x5))))
...
@x6
@x7)))
:qid data_elim_Bug210b.AccIntro))

:named data_elim_Bug210b.AccIntro))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(20,10-20,13); use=Bug210b.fst(20,10-20,13)
...
@x1
@x2))
:qid constructor_distinct_Bug210b.acc))

:named constructor_distinct_Bug210b.acc))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(21,4-21,12); use=Bug210b.fst(21,4-21,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 117
(Term_constr_id (Bug210b.AccIntro @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_Bug210b.AccIntro))

:named constructor_distinct_Bug210b.AccIntro))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(20,10-20,13); use=Bug210b.fst(20,10-20,13)
...
@x3
@x4)))
:qid Bug210b_pretyping_088671d86d4b0e1d9944b9c1a8380418))

:named Bug210b_pretyping_088671d86d4b0e1d9944b9c1a8380418))
...
@x1
(Tm_arrow_a19f9d49348d4e0038f0ded87d87802f @x2)))
:qid Bug210b_pre_typing_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))

:named Bug210b_pre_typing_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(20,15-21,47); use=Bug210b.fst(21,18-21,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid Bug210b_pre_typing_Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9))

:named Bug210b_pre_typing_Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9))
...
@x2)
@x3))
:qid Bug210b_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug210b_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_a19f9d49348d4e0038f0ded87d87802f @x1)))
:qid Bug210b_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))

:named Bug210b_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9
;;; Fact-ids: Name Bug210b.acc; Namespace Bug210b; Name Bug210b.AccIntro; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(20,15-21,47); use=Bug210b.fst(21,18-21,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 @x1
@x2
@x3))
(and 
;; def=Bug210b.fst(20,15-21,47); use=Bug210b.fst(21,18-21,47)
...
@x4)
@x5))
:qid Bug210b_interpretation_Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid Bug210b_interpretation_Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9.2))
))
...
@x2
@x3)))
:qid Bug210b_interpretation_Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9))

:named Bug210b_interpretation_Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9))
(push) ;; push{2

; Starting query at Bug210b.fst(25,18-25,50)
...
; Encoding query formula : forall (aa: Type) (r: (_: aa -> _: aa -> Prims.Tot Type)) (x: aa) (a: Bug210b.acc aa r x).
;   (*  - Could not prove post-condition
; *)
;   forall (b: (y: aa -> _: r y x -> Prims.Tot (Bug210b.acc u#uu___135 aa r y))).
;     Prims.eq2 u#uu___135
;       #(Bug210b.acc u#uu___135 aa r x)
;       a
;       (Bug210b.AccIntro u#uu___135 #aa #r #x b) ==>
;     Prims.precedes u#uu___135
;       u#uu___135
;       #(_: aa -> _: r _ x -> Prims.Tot (Bug210b.acc u#uu___135 aa r _))
;       #(Bug210b.acc u#uu___135 aa r x)
;       b
;       a
...
; While typechecking the top-level declaration `let acc_inv`
...
;; def=Prims.fst(413,99-413,120); use=Bug210b.fst(25,18-25,50)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 @x2
@x1
...
;; def=Bug210b.fst(25,14-25,44); use=Bug210b.fst(25,24-25,44)
(= @x3
(Bug210b.AccIntro @x0
@x1
@x2
...
;; def=Bug210b.fst(24,57-24,63); use=Bug210b.fst(25,48-25,50)
(or label_1

;; def=Bug210b.fst(24,57-24,63); use=Bug210b.fst(25,48-25,50)
(Valid 
;; def=Bug210b.fst(24,57-24,63); use=Bug210b.fst(25,48-25,50)
(Prims.precedes (Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 @x2
@x1
@x0)
(Bug210b.acc @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug210b.acc_inv, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, subterm_ordering_Bug210b.AccIntro
...
; encoding sigelt let acc_inv


; <Start encoding let acc_inv>


(declare-fun Bug210b.acc_inv (Term Term Term Term) Term)



(declare-fun Tm_refine_9141d51e9965635853c0c46992e39ec0 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;#aa: Type -> #r: (_: aa -> _: aa -> Prims.Tot Type) -> x: aa -> a: acc aa r x   -> Prims.Tot     (e:       (y: aa -> _: r y x -> Prims.Tot (acc aa r y))         {Prims.precedes #(_: aa -> _: r _ x -> Prims.Tot (acc aa r _)) #(acc aa r x) e a})
(declare-fun Tm_arrow_7da105864d192cf517a653a8246f339b () Term)
(declare-fun Bug210b.acc_inv@tok () Term)





; </end encoding let acc_inv>


; encoding sigelt val Bug210b.axiom1_dep


; <Start encoding val Bug210b.axiom1_dep>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug210b.axiom1_dep (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug210b.axiom1_dep@tok () Term)

; </end encoding val Bug210b.axiom1_dep>


; encoding sigelt val Bug210b.axiom1


; <Skipped val Bug210b.axiom1/>


; encoding sigelt let axiom1


; <Start encoding let axiom1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug210b.axiom1 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug210b.axiom1@tok () Term)

; </end encoding let axiom1>


; encoding sigelt val Bug210b.aa


; <Start encoding val Bug210b.aa>

(declare-fun Bug210b.aa () Term)

; </end encoding val Bug210b.aa>


; encoding sigelt val Bug210b.r


; <Start encoding val Bug210b.r>

(declare-fun Bug210b.r (Term Term) Term)
;;;;;;;;;;;;;;;;_: aa -> _: aa -> Prims.Tot Type
(declare-fun Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c () Term)
(declare-fun Bug210b.r@tok () Term)

; </end encoding val Bug210b.r>


; encoding sigelt val Bug210b.fix_F


; <Skipped val Bug210b.fix_F/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug210b.r; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(35,12-35,13); use=Bug210b.fst(35,12-35,13)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Bug210b.aa)
(HasType @x1
Bug210b.aa))
(HasType (Bug210b.r @x0
@x1)
Tm_type))
 

:pattern ((Bug210b.r @x0
@x1))
:qid typing_Bug210b.r))

:named typing_Bug210b.r))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug210b.acc_inv; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(25,4-25,11); use=Bug210b.fst(25,4-25,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
@x1
@x2)))
(HasType (Bug210b.acc_inv @x0
@x1
@x2
@x3)
(Tm_refine_9141d51e9965635853c0c46992e39ec0 @x2
@x1
@x0
@x3)))
 

:pattern ((Bug210b.acc_inv @x0
@x1
@x2
@x3))
:qid typing_Bug210b.acc_inv))

:named typing_Bug210b.acc_inv))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug210b.aa; Namespace Bug210b
(assert (! (HasType Bug210b.aa
Tm_type)
:named typing_Bug210b.aa))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Bug210b.r; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(35,12-35,13); use=Bug210b.fst(35,12-35,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug210b.r@tok
@x0)
@x1)
(Bug210b.r @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Bug210b.r@tok
@x0)
@x1))
:qid token_correspondence_Bug210b.r))

:named token_correspondence_Bug210b.r))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Bug210b.acc_inv; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(24,18-24,65); use=Bug210b.fst(25,4-25,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_9141d51e9965635853c0c46992e39ec0 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_9141d51e9965635853c0c46992e39ec0 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_9141d51e9965635853c0c46992e39ec0))

:named refinement_kinding_Tm_refine_9141d51e9965635853c0c46992e39ec0))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=Bug210b.fst(24,57-24,63); use=Bug210b.fst(25,4-25,11)
(Valid 
;; def=Bug210b.fst(24,57-24,63); use=Bug210b.fst(25,4-25,11)
(Prims.precedes (Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 @x2
@x3
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_9141d51e9965635853c0c46992e39ec0))

:named refinement_interpretation_Tm_refine_9141d51e9965635853c0c46992e39ec0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c
;;; Fact-ids: Name Bug210b.r; Namespace Bug210b
(assert (! (HasType Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c
Tm_type)
:named kinding_Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_9141d51e9965635853c0c46992e39ec0
;;; Fact-ids: Name Bug210b.acc_inv; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(24,18-24,65); use=Bug210b.fst(25,4-25,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9141d51e9965635853c0c46992e39ec0 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (Tm_arrow_268b63d433d5a7cbbc26076b01f35bd9 @x0
@x1
@x2))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9141d51e9965635853c0c46992e39ec0 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_9141d51e9965635853c0c46992e39ec0))

:named haseqTm_refine_9141d51e9965635853c0c46992e39ec0))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Bug210b.r@tok
Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c))
...
:pattern ((Bug210b.r @x1
@x2))
:qid function_token_typing_Bug210b.r.1))
)
 

:pattern ((ApplyTT @x0
Bug210b.r@tok))
:qid function_token_typing_Bug210b.r))

:named function_token_typing_Bug210b.r))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Bug210b.aa; Namespace Bug210b
(assert (! (HasType Bug210b.aa
Tm_type)
:named function_token_typing_Bug210b.aa))
...
@x2
@x3))
:qid equation_Bug210b.acc_inv))

:named equation_Bug210b.acc_inv))
...
;;; Fact-ids: Name Bug210b.r; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(35,17-35,39); use=Bug210b.fst(35,17-35,39)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c)
...
@x1
Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c))
:qid Bug210b_pre_typing_Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c))

:named Bug210b_pre_typing_Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c
;;; Fact-ids: Name Bug210b.r; Namespace Bug210b
(assert (! 
;; def=Bug210b.fst(35,17-35,39); use=Bug210b.fst(35,17-35,39)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Bug210b_interpretation_Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug210b_interpretation_Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c))
:qid Bug210b_interpretation_Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c))

:named Bug210b_interpretation_Tm_arrow_86bc20f1ca82c067e81967cdb301ce8c))
(push) ;; push{2

; Starting query at Bug210b.fst(43,2-52,37)

;;;;;;;;;;;;;;;;p : _: Bug210b.aa -> Prims.Tot (Type u#uu___1006) (_: Bug210b.aa -> Prims.Tot Type)
(declare-fun x_085883b9bacf17242e80fe4f690946f8_1 () Term)
;;;;;;;;;;;;;;;;_: aa -> Prims.Tot Type
(declare-fun Tm_arrow_d9dbe49d2d93f602c896d855124ff926 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d9dbe49d2d93f602c896d855124ff926
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_d9dbe49d2d93f602c896d855124ff926
Tm_type)
:named kinding_Tm_arrow_d9dbe49d2d93f602c896d855124ff926))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(39,16-39,26); use=Bug210b.fst(42,8-42,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d9dbe49d2d93f602c896d855124ff926)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_d9dbe49d2d93f602c896d855124ff926))
:qid Bug210b_pre_typing_Tm_arrow_d9dbe49d2d93f602c896d855124ff926))

:named Bug210b_pre_typing_Tm_arrow_d9dbe49d2d93f602c896d855124ff926))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d9dbe49d2d93f602c896d855124ff926
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(39,16-39,26); use=Bug210b.fst(42,8-42,13)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug210b_interpretation_Tm_arrow_d9dbe49d2d93f602c896d855124ff926.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_d9dbe49d2d93f602c896d855124ff926))
:qid Bug210b_interpretation_Tm_arrow_d9dbe49d2d93f602c896d855124ff926))

:named Bug210b_interpretation_Tm_arrow_d9dbe49d2d93f602c896d855124ff926))
;;;;;;;;;;;;;;;;binder_x_085883b9bacf17242e80fe4f690946f8_1
;;; Fact-ids: 
(assert (! (HasType x_085883b9bacf17242e80fe4f690946f8_1
Tm_arrow_d9dbe49d2d93f602c896d855124ff926)
:named binder_x_085883b9bacf17242e80fe4f690946f8_1))
;;;;;;;;;;;;;;;;f : x: Bug210b.aa -> _: (y: Bug210b.aa -> _: Bug210b.r y x -> Prims.Tot (p y)) -> Prims.Tot (p x) (x: Bug210b.aa -> _: (y: Bug210b.aa -> _: Bug210b.r y x -> Prims.Tot (p y)) -> Prims.Tot (p x))
(declare-fun x_20b9d33fa5b51d14ca5e392b2c2cc291_2 () Term)
;;;;;;;;;;;;;;;;y: aa -> _: r y x -> Prims.Tot (p y)
(declare-fun Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,24-40,48); use=Bug210b.fst(42,8-42,13)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f @x0)
Tm_type))
:qid kinding_Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f))

:named kinding_Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,24-40,48); use=Bug210b.fst(42,8-42,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f @x2)))
:qid Bug210b_pre_typing_Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f))

:named Bug210b_pre_typing_Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,24-40,48); use=Bug210b.fst(42,8-42,13)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f @x1))
(and 
;; def=Bug210b.fst(40,24-40,48); use=Bug210b.fst(42,8-42,13)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
...
@x2)
@x3)
(ApplyTT x_085883b9bacf17242e80fe4f690946f8_1
@x2)))
...
@x2)
@x3))
:qid Bug210b_interpretation_Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug210b_interpretation_Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f @x1)))
:qid Bug210b_interpretation_Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f))

:named Bug210b_interpretation_Tm_arrow_df3ac5f4b498fdbdc44a2d31622e043f))
;;;;;;;;;;;;;;;;x: aa -> _: (y: aa -> _: r y x -> Prims.Tot (p y)) -> Prims.Tot (p x)
(declare-fun Tm_arrow_a13f22a3d797353b61d7bcd995def9c8 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a13f22a3d797353b61d7bcd995def9c8
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a13f22a3d797353b61d7bcd995def9c8
Tm_type)
:named kinding_Tm_arrow_a13f22a3d797353b61d7bcd995def9c8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,15-40,62); use=Bug210b.fst(42,8-42,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a13f22a3d797353b61d7bcd995def9c8)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a13f22a3d797353b61d7bcd995def9c8))
:qid Bug210b_pre_typing_Tm_arrow_a13f22a3d797353b61d7bcd995def9c8))

:named Bug210b_pre_typing_Tm_arrow_a13f22a3d797353b61d7bcd995def9c8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a13f22a3d797353b61d7bcd995def9c8
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,15-40,62); use=Bug210b.fst(42,8-42,13)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Bug210b_interpretation_Tm_arrow_a13f22a3d797353b61d7bcd995def9c8.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug210b_interpretation_Tm_arrow_a13f22a3d797353b61d7bcd995def9c8.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_a13f22a3d797353b61d7bcd995def9c8))
:qid Bug210b_interpretation_Tm_arrow_a13f22a3d797353b61d7bcd995def9c8))

:named Bug210b_interpretation_Tm_arrow_a13f22a3d797353b61d7bcd995def9c8))
;;;;;;;;;;;;;;;;binder_x_20b9d33fa5b51d14ca5e392b2c2cc291_2
;;; Fact-ids: 
(assert (! (HasType x_20b9d33fa5b51d14ca5e392b2c2cc291_2
Tm_arrow_a13f22a3d797353b61d7bcd995def9c8)
:named binder_x_20b9d33fa5b51d14ca5e392b2c2cc291_2))
;;;;;;;;;;;;;;;;x : Bug210b.aa (Bug210b.aa)
(declare-fun x_033d56f25836fd4f93deeeceddab6f00_3 () Term)
;;;;;;;;;;;;;;;;binder_x_033d56f25836fd4f93deeeceddab6f00_3
;;; Fact-ids: 
(assert (! (HasType x_033d56f25836fd4f93deeeceddab6f00_3
Bug210b.aa)
:named binder_x_033d56f25836fd4f93deeeceddab6f00_3))
;;;;;;;;;;;;;;;;a : Bug210b.acc u#101 Bug210b.aa Bug210b.r x (Bug210b.acc Bug210b.aa Bug210b.r x)
(declare-fun x_a1ab9ed073dedeffdcecc0772c114d05_4 () Term)
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
Bug210b.r@tok))
:named @kick_partial_app_c05f351a0e3bbebc8317192e96ab18c5))
;;;;;;;;;;;;;;;;binder_x_a1ab9ed073dedeffdcecc0772c114d05_4
;;; Fact-ids: 
(assert (! (HasType x_a1ab9ed073dedeffdcecc0772c114d05_4
(Bug210b.acc Bug210b.aa
Bug210b.r@tok
x_033d56f25836fd4f93deeeceddab6f00_3))
:named binder_x_a1ab9ed073dedeffdcecc0772c114d05_4))

;;;;;;;;;;;;;;;;y: aa -> _: r y x -> Prims.Tot (p y)
(declare-fun Tm_arrow_0897052f227388e70b6286b28f4513cd (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0897052f227388e70b6286b28f4513cd
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,24-40,48); use=Bug210b.fst(42,8-42,13)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_0897052f227388e70b6286b28f4513cd @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_0897052f227388e70b6286b28f4513cd @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_0897052f227388e70b6286b28f4513cd))

:named kinding_Tm_arrow_0897052f227388e70b6286b28f4513cd))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,24-40,48); use=Bug210b.fst(42,8-42,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_0897052f227388e70b6286b28f4513cd @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_0897052f227388e70b6286b28f4513cd @x2
@x3)))
:qid Bug210b_pre_typing_Tm_arrow_0897052f227388e70b6286b28f4513cd))

:named Bug210b_pre_typing_Tm_arrow_0897052f227388e70b6286b28f4513cd))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0897052f227388e70b6286b28f4513cd
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,24-40,48); use=Bug210b.fst(42,8-42,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_0897052f227388e70b6286b28f4513cd @x1
@x2))
(and 
;; def=Bug210b.fst(40,24-40,48); use=Bug210b.fst(42,8-42,13)
...
@x3)
@x4))
:qid Bug210b_interpretation_Tm_arrow_0897052f227388e70b6286b28f4513cd.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Bug210b_interpretation_Tm_arrow_0897052f227388e70b6286b28f4513cd.2))
))
...
(Tm_arrow_0897052f227388e70b6286b28f4513cd @x1
@x2)))
:qid Bug210b_interpretation_Tm_arrow_0897052f227388e70b6286b28f4513cd))

:named Bug210b_interpretation_Tm_arrow_0897052f227388e70b6286b28f4513cd))
;;;;;;;;;;;;;;;;x: aa -> _: (y: aa -> _: r y x -> Prims.Tot (p y)) -> Prims.Tot (p x)
(declare-fun Tm_arrow_9add0998d0d428415a12c57d10952c52 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9add0998d0d428415a12c57d10952c52
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,15-40,62); use=Bug210b.fst(42,8-42,13)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_9add0998d0d428415a12c57d10952c52 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_9add0998d0d428415a12c57d10952c52 @x0)
Tm_type))
:qid kinding_Tm_arrow_9add0998d0d428415a12c57d10952c52))

:named kinding_Tm_arrow_9add0998d0d428415a12c57d10952c52))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,15-40,62); use=Bug210b.fst(42,8-42,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_9add0998d0d428415a12c57d10952c52 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_9add0998d0d428415a12c57d10952c52 @x2)))
:qid Bug210b_pre_typing_Tm_arrow_9add0998d0d428415a12c57d10952c52))

:named Bug210b_pre_typing_Tm_arrow_9add0998d0d428415a12c57d10952c52))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9add0998d0d428415a12c57d10952c52
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(40,15-40,62); use=Bug210b.fst(42,8-42,13)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_9add0998d0d428415a12c57d10952c52 @x1))
(and 
;; def=Bug210b.fst(40,15-40,62); use=Bug210b.fst(42,8-42,13)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
...
@x2)
@x3))
:qid Bug210b_interpretation_Tm_arrow_9add0998d0d428415a12c57d10952c52.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid Bug210b_interpretation_Tm_arrow_9add0998d0d428415a12c57d10952c52.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_9add0998d0d428415a12c57d10952c52 @x1)))
:qid Bug210b_interpretation_Tm_arrow_9add0998d0d428415a12c57d10952c52))

:named Bug210b_interpretation_Tm_arrow_9add0998d0d428415a12c57d10952c52))



(declare-fun Tm_refine_9c8c285716e2a06d1049e953f623c3fb (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(41,20-52,37); use=Bug210b.fst(41,20-52,37)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_9c8c285716e2a06d1049e953f623c3fb @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_9c8c285716e2a06d1049e953f623c3fb @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_9c8c285716e2a06d1049e953f623c3fb))

:named refinement_kinding_Tm_refine_9c8c285716e2a06d1049e953f623c3fb))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(41,20-52,37); use=Bug210b.fst(41,20-52,37)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9c8c285716e2a06d1049e953f623c3fb @x2))
(and (HasTypeFuel @u0
@x1
(Bug210b.acc Bug210b.aa
Bug210b.r@tok
...
;; def=Bug210b.fst(43,2-52,37); use=Bug210b.fst(43,2-52,37)

;; def=Bug210b.fst(43,2-52,37); use=Bug210b.fst(43,2-52,37)
(Valid 
;; def=Bug210b.fst(43,2-52,37); use=Bug210b.fst(43,2-52,37)
(Prims.precedes (Bug210b.acc Bug210b.aa
Bug210b.r@tok
@x2)
(Bug210b.acc Bug210b.aa
Bug210b.r@tok
x_033d56f25836fd4f93deeeceddab6f00_3)
@x1
x_a1ab9ed073dedeffdcecc0772c114d05_4)
)
...
@x1
(Tm_refine_9c8c285716e2a06d1049e953f623c3fb @x2)))
:qid refinement_interpretation_Tm_refine_9c8c285716e2a06d1049e953f623c3fb))

:named refinement_interpretation_Tm_refine_9c8c285716e2a06d1049e953f623c3fb))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9c8c285716e2a06d1049e953f623c3fb
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(41,20-52,37); use=Bug210b.fst(41,20-52,37)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9c8c285716e2a06d1049e953f623c3fb @x0)))
(Valid (Prims.hasEq (Bug210b.acc Bug210b.aa
Bug210b.r@tok
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9c8c285716e2a06d1049e953f623c3fb @x0))))
:qid haseqTm_refine_9c8c285716e2a06d1049e953f623c3fb))

:named haseqTm_refine_9c8c285716e2a06d1049e953f623c3fb))
(declare-fun Bug210b.fix_F (Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;#p: (_: aa -> Prims.Tot Type) ->     _: (x: aa -> _: (y: aa -> _: r y x -> Prims.Tot (p y)) -> Prims.Tot (p x)) ->     x: aa ->     a: acc aa r x {Prims.precedes #(acc aa r x) #(acc aa r x) a a}   -> Prims.Tot (p x)
(declare-fun Tm_arrow_1d001e3a43775a4c672bac05e3c44171 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1d001e3a43775a4c672bac05e3c44171
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_1d001e3a43775a4c672bac05e3c44171
Tm_type)
:named kinding_Tm_arrow_1d001e3a43775a4c672bac05e3c44171))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(39,16-52,37); use=Bug210b.fst(41,20-52,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_1d001e3a43775a4c672bac05e3c44171)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_1d001e3a43775a4c672bac05e3c44171))
:qid Bug210b_pre_typing_Tm_arrow_1d001e3a43775a4c672bac05e3c44171))

:named Bug210b_pre_typing_Tm_arrow_1d001e3a43775a4c672bac05e3c44171))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1d001e3a43775a4c672bac05e3c44171
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(39,16-52,37); use=Bug210b.fst(41,20-52,37)
(forall ((@x0 Term))
...
Bug210b.aa)
(HasType @x4
(Tm_refine_9c8c285716e2a06d1049e953f623c3fb @x3)))
...
@x3)
@x4))
:qid Bug210b_interpretation_Tm_arrow_1d001e3a43775a4c672bac05e3c44171.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug210b_interpretation_Tm_arrow_1d001e3a43775a4c672bac05e3c44171.2))
...
@x1)
@x2))
:qid Bug210b_interpretation_Tm_arrow_1d001e3a43775a4c672bac05e3c44171.3))
...
@x2)
@x3))
:qid Bug210b_interpretation_Tm_arrow_1d001e3a43775a4c672bac05e3c44171.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_1d001e3a43775a4c672bac05e3c44171))
:qid Bug210b_interpretation_Tm_arrow_1d001e3a43775a4c672bac05e3c44171))

:named Bug210b_interpretation_Tm_arrow_1d001e3a43775a4c672bac05e3c44171))
(declare-fun Bug210b.fix_F@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(42,8-42,13); use=Bug210b.fst(42,8-42,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug210b.fix_F@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Bug210b.fix_F@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Bug210b.fix_F))

:named token_correspondence_Bug210b.fix_F))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(42,8-42,13); use=Bug210b.fst(42,8-42,13)
...
:pattern ((Bug210b.fix_F @x1
@x2
@x3
@x4))
:qid function_token_typing_Bug210b.fix_F.1))
)
 

:pattern ((ApplyTT @x0
Bug210b.fix_F@tok))
:qid function_token_typing_Bug210b.fix_F))

:named function_token_typing_Bug210b.fix_F))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(42,8-42,13); use=Bug210b.fst(42,8-42,13)
...
Tm_arrow_d9dbe49d2d93f602c896d855124ff926)
(HasType @x1
(Tm_arrow_9add0998d0d428415a12c57d10952c52 @x0))
(HasType @x2
Bug210b.aa)
(HasType @x3
(Tm_refine_9c8c285716e2a06d1049e953f623c3fb @x2)))
(HasType (Bug210b.fix_F @x0
@x1
@x2
@x3)
(ApplyTT @x0
...
:pattern ((Bug210b.fix_F @x0
@x1
@x2
@x3))
:qid typing_Bug210b.fix_F))

:named typing_Bug210b.fix_F))
(declare-fun label_1 () Bool)

;;;;;;;;;;;;;;;;_: aa -> _: r _ x -> Prims.Tot (acc u#101 aa r _)
(declare-fun Tm_arrow_e84859e592ab6a4782d089a71754c570 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e84859e592ab6a4782d089a71754c570
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_e84859e592ab6a4782d089a71754c570
Tm_type)
:named kinding_Tm_arrow_e84859e592ab6a4782d089a71754c570))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(24,30-41,29); use=Bug210b.fst(44,9-44,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_e84859e592ab6a4782d089a71754c570)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_e84859e592ab6a4782d089a71754c570))
:qid Bug210b_pre_typing_Tm_arrow_e84859e592ab6a4782d089a71754c570))

:named Bug210b_pre_typing_Tm_arrow_e84859e592ab6a4782d089a71754c570))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e84859e592ab6a4782d089a71754c570
;;; Fact-ids: 
(assert (! 
;; def=Bug210b.fst(24,30-41,29); use=Bug210b.fst(44,9-44,15)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Bug210b_interpretation_Tm_arrow_e84859e592ab6a4782d089a71754c570.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug210b_interpretation_Tm_arrow_e84859e592ab6a4782d089a71754c570.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_e84859e592ab6a4782d089a71754c570))
:qid Bug210b_interpretation_Tm_arrow_e84859e592ab6a4782d089a71754c570))

:named Bug210b_interpretation_Tm_arrow_e84859e592ab6a4782d089a71754c570))



; Encoding query formula : forall (y: Bug210b.aa) (h: Bug210b.r y x).
;   (*  - Could not prove post-condition
; *)
;   Prims.precedes u#101
;     u#101
;     #(_: Bug210b.aa -> _: Bug210b.r _ x -> Prims.Tot (Bug210b.acc u#101 Bug210b.aa Bug210b.r _))
;     #(Bug210b.acc u#101 Bug210b.aa Bug210b.r x)
;     (Bug210b.acc_inv u#101 #Bug210b.aa #Bug210b.r x a)
;     a


; Context: While encoding a query
; While typechecking the top-level declaration `let rec fix_F`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Bug210b.fst(43,2-52,37)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Bug210b.aa)
(HasType @x1
...
;; def=Bug210b.fst(44,15-44,33); use=Bug210b.fst(44,9-44,15)
(or label_1

;; def=Bug210b.fst(44,15-44,33); use=Bug210b.fst(44,9-44,15)
(Valid 
;; def=Bug210b.fst(44,15-44,33); use=Bug210b.fst(44,9-44,15)
(Prims.precedes Tm_arrow_e84859e592ab6a4782d089a71754c570
(Bug210b.acc Bug210b.aa
Bug210b.r@tok
x_033d56f25836fd4f93deeeceddab6f00_3)
(Bug210b.acc_inv Bug210b.aa
Bug210b.r@tok
x_033d56f25836fd4f93deeeceddab6f00_3
x_a1ab9ed073dedeffdcecc0772c114d05_4)
x_a1ab9ed073dedeffdcecc0772c114d05_4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug210b.fix_F, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_a1ab9ed073dedeffdcecc0772c114d05_4, equation_Bug210b.acc_inv, fuel_guarded_inversion_Bug210b.acc, subterm_ordering_Bug210b.AccIntro
