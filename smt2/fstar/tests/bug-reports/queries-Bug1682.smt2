...
; Internals for Bug1682


; encoding sigelt val Bug1682.f


; <Start encoding val Bug1682.f>

(declare-fun Bug1682.f (Term) Term)
;;;;;;;;;;;;;;;;n: Prims.int -> Prims.GTot Prims.int
(declare-fun Tm_ghost_arrow_13f9dfaf6434e51312536aae3cfdde82 () Term)
(declare-fun Bug1682.f@tok () Term)

; </end encoding val Bug1682.f>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug1682.f; Namespace Bug1682
(assert (! 
;; def=Bug1682.fst(3,11-3,12); use=Bug1682.fst(3,11-3,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (Bug1682.f @x0)
Prims.int))
 

:pattern ((Bug1682.f @x0))
:qid typing_Bug1682.f))

:named typing_Bug1682.f))
;;;;;;;;;;;;;;;;refinement kinding
...
; Starting query at Bug1682.fst(6,2-10,3)
...
;     Bug1682.f 1 == any_result ==>
;     (forall (any_result: Prims.int).
;         Bug1682.f 2 == any_result ==>
...
;; def=Prims.fst(451,66-451,102); use=Bug1682.fst(6,2-10,3)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=FStar.Calc.fsti(79,4-79,5); use=Bug1682.fst(6,2-10,3)
(= (Bug1682.f (BoxInt 1))
@x1)
)
...
;; def=FStar.Calc.fsti(79,7-79,8); use=Bug1682.fst(6,2-10,3)
(= (Bug1682.f (BoxInt 2))
@x2)
)
...
;; def=Bug1682.fst(8,4-8,6); use=Bug1682.fst(6,2-10,3)
(= @x5
@x4)
)
...
;; def=Bug1682.fst(6,7-6,11); use=Bug1682.fst(6,2-10,3)
(or label_1
