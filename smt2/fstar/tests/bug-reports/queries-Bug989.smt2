...
; Starting query at Bug989.fst(19,2-20,16)
...
(declare-fun Tm_refine_ee79f8e0f4b36a2afb2b9ee9b4463373 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_ee79f8e0f4b36a2afb2b9ee9b4463373
Tm_type)
:named refinement_kinding_Tm_refine_ee79f8e0f4b36a2afb2b9ee9b4463373))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug989.fst(18,11-20,16); use=Bug989.fst(18,11-20,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ee79f8e0f4b36a2afb2b9ee9b4463373)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=Bug989.fst(19,2-20,16); use=Bug989.fst(19,2-20,16)
...
@x1
Tm_refine_ee79f8e0f4b36a2afb2b9ee9b4463373))
:qid refinement_interpretation_Tm_refine_ee79f8e0f4b36a2afb2b9ee9b4463373))

:named refinement_interpretation_Tm_refine_ee79f8e0f4b36a2afb2b9ee9b4463373))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ee79f8e0f4b36a2afb2b9ee9b4463373
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ee79f8e0f4b36a2afb2b9ee9b4463373))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_ee79f8e0f4b36a2afb2b9ee9b4463373))
(declare-fun Bug989.g (Term) Term)

;;;;;;;;;;;;;;;;n: Prims.nat{n << n} -> Prims.bool
(declare-fun Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea
Tm_type)
:named kinding_Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug989.fst(18,11-20,16); use=Bug989.fst(18,11-20,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea))
:qid Bug989_pre_typing_Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea))

:named Bug989_pre_typing_Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea
;;; Fact-ids: 
(assert (! 
;; def=Bug989.fst(18,11-20,16); use=Bug989.fst(18,11-20,16)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug989_interpretation_Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea))
:qid Bug989_interpretation_Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea))

:named Bug989_interpretation_Tm_arrow_d40eb6f6cf23252c635b4d601d78f3ea))
(declare-fun Bug989.g@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug989.fst(18,8-18,9); use=Bug989.fst(18,8-18,9)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug989.g@tok
@x0)
(Bug989.g @x0))
 

:pattern ((ApplyTT Bug989.g@tok
@x0))
:qid token_correspondence_Bug989.g))

:named token_correspondence_Bug989.g))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug989.fst(18,8-18,9); use=Bug989.fst(18,8-18,9)
...
:pattern ((Bug989.g @x1))
:qid function_token_typing_Bug989.g.1))
)
 

:pattern ((ApplyTT @x0
Bug989.g@tok))
:qid function_token_typing_Bug989.g))

:named function_token_typing_Bug989.g))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug989.fst(18,8-18,9); use=Bug989.fst(18,8-18,9)
...
;   ~(n = 0 = true) ==> (forall (b: Prims.bool). n = 0 == b ==> n - 1 >= 0 /\ n - 1 << n)


; Context: While encoding a query
; While typechecking the top-level declaration `let rec g`
...
;; def=Prims.fst(402,27-402,88); use=Bug989.fst(19,2-20,16)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug989.fst(19,2-20,16)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug989.fst(19,2-20,16)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=Bug989.fst(19,2-20,16)
(not 
;; def=Bug989.fst(19,5-19,10); use=Bug989.fst(19,5-19,10)
...
;; def=Prims.fst(413,99-413,120); use=Bug989.fst(19,2-20,16)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=Bug989.fst(19,5-20,16); use=Bug989.fst(19,5-20,16)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
@x1)
...
;; def=Bug989.fst(19,2-20,16); use=Bug989.fst(20,9-20,16)
(and 
;; def=Prims.fst(680,18-680,24); use=Bug989.fst(20,9-20,16)
(or label_1
...
; QUERY ID: (Bug989.g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, primitive_Prims.op_Equality, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec g


; <Start encoding let rec g>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Bug989.g.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Bug989.g.fuel_instrumented_token () Term)
(declare-fun Bug989.g (Term) Term)
(declare-fun Bug989.g@tok () Term)
;;;;;;;;;;;;;;;;n: Prims.nat -> Prims.bool
(declare-fun Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c () Term)

; </end encoding let rec g>


; encoding sigelt #set-options "--initial_fuel 0 --max_fuel 1 --initial_ifuel 0 --max_ifuel 0"


; <Skipped #set-options "--initial_fuel 0 --max_fuel 1 --initial_ifuel 0 --max_ifuel 0"/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug989.g; Namespace Bug989
(assert (! 
;; def=Bug989.fst(18,8-18,9); use=Bug989.fst(18,8-18,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
Prims.nat)
(HasType (Bug989.g.fuel_instrumented @u0
@x1)
Prims.bool))
 

:pattern ((Bug989.g.fuel_instrumented @u0
@x1))
:qid token_correspondence_Bug989.g.fuel_instrumented))

:named token_correspondence_Bug989.g.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Bug989.g
;;; Fact-ids: Name Bug989.g; Namespace Bug989
(assert (! 
;; def=Bug989.fst(18,8-18,9); use=Bug989.fst(18,8-18,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
Prims.nat)
(= (Bug989.g.fuel_instrumented (SFuel @u0)
@x1)
...
(BoxBool true))
(BoxBool true)
(Bug989.g.fuel_instrumented @u0
(Prims.op_Subtraction @x1
(BoxInt 1)))))))
 :weight 0


:pattern ((Bug989.g.fuel_instrumented (SFuel @u0)
@x1))
:qid equation_with_fuel_Bug989.g.fuel_instrumented))

:named equation_with_fuel_Bug989.g.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Bug989.g; Namespace Bug989
(assert (! 
;; def=Bug989.fst(18,8-18,9); use=Bug989.fst(18,8-18,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (= (Bug989.g.fuel_instrumented (SFuel @u0)
@x1)
(Bug989.g.fuel_instrumented ZFuel
@x1))
 

:pattern ((Bug989.g.fuel_instrumented (SFuel @u0)
@x1))
:qid @fuel_irrelevance_Bug989.g.fuel_instrumented))

:named @fuel_irrelevance_Bug989.g.fuel_instrumented))
...
(forall ((@x0 Term))
 (! (= (Bug989.g @x0)
(Bug989.g.fuel_instrumented MaxFuel
@x0))
 

:pattern ((Bug989.g @x0))
:qid @fuel_correspondence_Bug989.g.fuel_instrumented))

:named @fuel_correspondence_Bug989.g.fuel_instrumented))
(push) ;; push{2

; Starting query at Bug989.fst(24,0-24,30)

(declare-fun label_1 () Bool)

; Encoding query formula : Bug989.g 0 == true


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let foo`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Bug989.fst(24,17-24,30); use=Bug989.fst(24,10-24,16)
(or label_1
...
; encoding sigelt let foo


; <Start encoding let foo>

(declare-fun Bug989.foo (Dummy_sort) Term)

; </end encoding let foo>


; encoding sigelt type Bug989.t


; <Start encoding type Bug989.t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug989.t () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug989.A () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug989.A
(declare-fun Bug989.A@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug989.B () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug989.B
(declare-fun Bug989.B@tok () Term)

; <start constructor Bug989.t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug989.t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
129)
(= __@x0
Bug989.t)))

; </end constructor Bug989.t>


; <start constructor Bug989.A>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug989.A ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
135)
(= __@x0
Bug989.A)))

; </end constructor Bug989.A>


; <start constructor Bug989.B>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug989.B ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
137)
(= __@x0
Bug989.B)))

; </end constructor Bug989.B>


; </end encoding type Bug989.t>


; encoding sigelt assume Bug989.t__uu___haseq


; <Start encoding assume Bug989.t__uu___haseq>


; </end encoding assume Bug989.t__uu___haseq>


; encoding sigelt val Bug989.uu___is_A


; <Start encoding val Bug989.uu___is_A>

(declare-fun Bug989.uu___is_A (Term) Term)
;;;;;;;;;;;;;;;;projectee: t -> Prims.bool
(declare-fun Tm_arrow_168b4a391f3b5b3eda7500a1ee4a8098 () Term)
(declare-fun Bug989.uu___is_A@tok () Term)

; </end encoding val Bug989.uu___is_A>
...
; encoding sigelt val Bug989.uu___is_B


; <Start encoding val Bug989.uu___is_B>

(declare-fun Bug989.uu___is_B (Term) Term)

(declare-fun Bug989.uu___is_B@tok () Term)

; </end encoding val Bug989.uu___is_B>
...
; encoding sigelt #set-options "--initial_fuel 0 --max_fuel 0 --initial_ifuel 0 --max_ifuel 1"


; <Skipped #set-options "--initial_fuel 0 --max_fuel 0 --initial_ifuel 0 --max_ifuel 1"/>


; encoding sigelt #set-options "--initial_fuel 0 --max_fuel 0 --initial_ifuel 1 --max_ifuel 1"


; <Skipped #set-options "--initial_fuel 0 --max_fuel 0 --initial_ifuel 1 --max_ifuel 1"/>

;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! (HasType Bug989.B@tok
Bug989.t)
:named typing_tok_Bug989.B@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! (HasType Bug989.A@tok
Bug989.t)
:named typing_tok_Bug989.A@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug989.uu___is_B; Namespace Bug989
(assert (! 
;; def=Bug989.fst(29,3-29,4); use=Bug989.fst(29,3-29,4)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug989.t)
(HasType (Bug989.uu___is_B @x0)
Prims.bool))
 

:pattern ((Bug989.uu___is_B @x0))
:qid typing_Bug989.uu___is_B))

:named typing_Bug989.uu___is_B))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug989.uu___is_A; Namespace Bug989
(assert (! 
;; def=Bug989.fst(28,3-28,4); use=Bug989.fst(28,3-28,4)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug989.t)
(HasType (Bug989.uu___is_A @x0)
Prims.bool))
 

:pattern ((Bug989.uu___is_A @x0))
:qid typing_Bug989.uu___is_A))

:named typing_Bug989.uu___is_A))
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! (HasType Bug989.t
Tm_type)
:named kinding_Bug989.t@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! 
;; def=Bug989.fst(27,5-27,6); use=Bug989.fst(27,5-27,6)
(forall ((@u0 Fuel) (@x1 Term))
...
@x1
Bug989.t))
:qid fuel_guarded_inversion_Bug989.t))

:named fuel_guarded_inversion_Bug989.t))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! (= Bug989.B@tok
Bug989.B)
:named equality_tok_Bug989.B@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! (= Bug989.A@tok
Bug989.A)
:named equality_tok_Bug989.A@tok))
...
(forall ((@x0 Term))
 (! (= (Bug989.uu___is_B @x0)
(BoxBool (is-Bug989.B @x0)))
 

:pattern ((Bug989.uu___is_B @x0))
:qid disc_equation_Bug989.B))

:named disc_equation_Bug989.B))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Bug989.uu___is_A; Namespace Bug989
(assert (! 
;; def=Bug989.fst(28,3-28,4); use=Bug989.fst(28,3-28,4)
(forall ((@x0 Term))
 (! (= (Bug989.uu___is_A @x0)
(BoxBool (is-Bug989.A @x0)))
 

:pattern ((Bug989.uu___is_A @x0))
:qid disc_equation_Bug989.A))

:named disc_equation_Bug989.A))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! 
;; def=Bug989.fst(29,3-29,4); use=Bug989.fst(29,3-29,4)
...
Bug989.B
Bug989.t))
:qid data_typing_intro_Bug989.B@tok))

:named data_typing_intro_Bug989.B@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! 
;; def=Bug989.fst(28,3-28,4); use=Bug989.fst(28,3-28,4)
...
Bug989.A
Bug989.t))
:qid data_typing_intro_Bug989.A@tok))

:named data_typing_intro_Bug989.A@tok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! (= 129
(Term_constr_id Bug989.t))
:named constructor_distinct_Bug989.t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! (= 137
(Term_constr_id Bug989.B))
:named constructor_distinct_Bug989.B))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! (= 135
(Term_constr_id Bug989.A))
:named constructor_distinct_Bug989.A))
;;;;;;;;;;;;;;;;Assumption: Bug989.t__uu___haseq
;;; Fact-ids: Name Bug989.t__uu___haseq; Namespace Bug989
(assert (! (Valid (Prims.hasEq Bug989.t))
:named assumption_Bug989.t__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug989.t; Namespace Bug989; Name Bug989.A; Namespace Bug989; Name Bug989.B; Namespace Bug989
(assert (! 
;; def=Bug989.fst(27,5-27,6); use=Bug989.fst(27,5-27,6)
...
@x0
Bug989.t))
:qid Bug989_pretyping_6799fecba3db07433c04ec43076dbc4f))

:named Bug989_pretyping_6799fecba3db07433c04ec43076dbc4f))
(push) ;; push{2

; Starting query at Bug989.fst(34,2-36,11)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Bug989.t).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Prims.unit).
;     (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(A? x) /\ ~(B? x) ==> Prims.l_False
...
;; def=Prims.fst(402,27-402,88); use=Bug989.fst(34,2-36,11)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug989.fst(34,2-36,11)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug989.fst(34,2-36,11)
(ApplyTT @x1
@x2)
...
;; def=Bug989.fst(33,7-33,8); use=Bug989.fst(34,8-34,9)
(not 
;; def=Bug989.fst(33,7-33,8); use=Bug989.fst(34,8-34,9)
(BoxBool_proj_0 (Bug989.uu___is_A @x0))
)
...
(not 
;; def=Bug989.fst(33,7-33,8); use=Bug989.fst(34,8-34,9)
(BoxBool_proj_0 (Bug989.uu___is_B @x0))
)
)
label_1)
...
; QUERY ID: (Bug989.f, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Bug989.A, disc_equation_Bug989.B, fuel_guarded_inversion_Bug989.t, projection_inverse_BoxBool_proj_0
