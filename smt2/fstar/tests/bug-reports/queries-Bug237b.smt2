...
; encoding sigelt type Bug237b.knd


; <Start encoding type Bug237b.knd>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug237b.knd () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug237b.KType () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug237b.KType
(declare-fun Bug237b.KType@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug237b.KKArr (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug237b.KKArr__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug237b.KKArr
(declare-fun Bug237b.KKArr@tok () Term)
;;;;;;;;;;;;;;;;_0: knd -> knd
(declare-fun Tm_arrow_9f6bf315f4f9523d9e83288113925e32 () Term)

; <start constructor Bug237b.knd>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug237b.knd ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
Bug237b.knd)))

; </end constructor Bug237b.knd>


; <start constructor Bug237b.KType>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug237b.KType ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
Bug237b.KType)))

; </end constructor Bug237b.KType>


; <start constructor Bug237b.KKArr>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug237b.KKArr ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
(Bug237b.KKArr (Bug237b.KKArr__0 __@x0)))))

; </end constructor Bug237b.KKArr>


; </end encoding type Bug237b.knd>
...
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! (HasType Bug237b.KType@tok
Bug237b.knd)
:named typing_tok_Bug237b.KType@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(23,4-23,9); use=Bug237b.fst(23,4-23,9)
...
(Bug237b.KKArr @x1)
Bug237b.knd))
:qid subterm_ordering_Bug237b.KKArr))

:named subterm_ordering_Bug237b.KKArr))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=Bug237b.fst(23,4-23,9); use=Bug237b.fst(23,4-23,9)
(forall ((@x0 Term))
 (! (= (Bug237b.KKArr__0 (Bug237b.KKArr @x0))
@x0)
 

:pattern ((Bug237b.KKArr @x0))
:qid projection_inverse_Bug237b.KKArr__0))

:named projection_inverse_Bug237b.KKArr__0))
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! (HasType Bug237b.knd
Tm_type)
:named kinding_Bug237b.knd@tok))
...
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(21,5-21,8); use=Bug237b.fst(21,5-21,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Bug237b.knd)
(or (is-Bug237b.KType @x1)
(is-Bug237b.KKArr @x1)))
...
@x1
Bug237b.knd))
:qid fuel_guarded_inversion_Bug237b.knd))

:named fuel_guarded_inversion_Bug237b.knd))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! (= Bug237b.KType@tok
Bug237b.KType)
:named equality_tok_Bug237b.KType@tok))
...
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(22,4-22,9); use=Bug237b.fst(22,4-22,9)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
Bug237b.KType
Bug237b.knd)
...
Bug237b.KType
Bug237b.knd))
:qid data_typing_intro_Bug237b.KType@tok))

:named data_typing_intro_Bug237b.KType@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(23,4-23,9); use=Bug237b.fst(23,4-23,9)
...
(Bug237b.KKArr @x1)
Bug237b.knd))
:qid data_typing_intro_Bug237b.KKArr@tok))

:named data_typing_intro_Bug237b.KKArr@tok))
...
(Bug237b.KKArr @x1)
Bug237b.knd))
:qid data_elim_Bug237b.KKArr))

:named data_elim_Bug237b.KKArr))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! (= 116
(Term_constr_id Bug237b.knd))
:named constructor_distinct_Bug237b.knd))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! (= 122
(Term_constr_id Bug237b.KType))
:named constructor_distinct_Bug237b.KType))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(23,4-23,9); use=Bug237b.fst(23,4-23,9)
(forall ((@x0 Term))
 (! (= 124
(Term_constr_id (Bug237b.KKArr @x0)))
 

:pattern ((Bug237b.KKArr @x0))
:qid constructor_distinct_Bug237b.KKArr))

:named constructor_distinct_Bug237b.KKArr))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Bug237b.knd))
:qid Bug237b_pretyping_83ef960d702117f3ff5c237d3e96f955))

:named Bug237b_pretyping_83ef960d702117f3ff5c237d3e96f955))
(push) ;; push{4

; Starting query at Bug237b.fst(21,0-23,22)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq Bug237b.knd ==>
; (forall (_0: Bug237b.knd).
...
; *)
;     Prims.hasEq Bug237b.knd)


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug237b.knd`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=Bug237b.fst(21,0-23,22); use=Bug237b.fst(21,0-23,22)
(Valid 
;; def=Bug237b.fst(21,0-23,22); use=Bug237b.fst(21,0-23,22)
(Prims.hasEq Bug237b.knd)
)
...
;; def=Bug237b.fst(21,0-23,22); use=Bug237b.fst(23,12-23,15)
(or label_1
...
; encoding sigelt assume Bug237b.knd__uu___haseq


; <Start encoding assume Bug237b.knd__uu___haseq>


; </end encoding assume Bug237b.knd__uu___haseq>


; encoding sigelt val Bug237b.uu___is_KType


; <Start encoding val Bug237b.uu___is_KType>

(declare-fun Bug237b.uu___is_KType (Term) Term)
;;;;;;;;;;;;;;;;projectee: knd -> Prims.bool
(declare-fun Tm_arrow_b15c5c25558153cfaa761e117b627c43 () Term)
(declare-fun Bug237b.uu___is_KType@tok () Term)

; </end encoding val Bug237b.uu___is_KType>


; encoding sigelt let uu___is_KType


; <Skipped let uu___is_KType/>


; encoding sigelt val Bug237b.uu___is_KKArr


; <Start encoding val Bug237b.uu___is_KKArr>

(declare-fun Bug237b.uu___is_KKArr (Term) Term)

(declare-fun Bug237b.uu___is_KKArr@tok () Term)

; </end encoding val Bug237b.uu___is_KKArr>


; encoding sigelt let uu___is_KKArr


; <Skipped let uu___is_KKArr/>


; encoding sigelt val Bug237b.__proj__KKArr__item___0


; <Start encoding val Bug237b.__proj__KKArr__item___0>

(declare-fun Tm_refine_5c691036dc4779e118afb73673a21bac () Term)
(declare-fun Bug237b.__proj__KKArr__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: knd{KKArr? _} -> knd
(declare-fun Tm_arrow_7899dbf5b13e9a5816c953eeac79dd78 () Term)
(declare-fun Bug237b.__proj__KKArr__item___0@tok () Term)

; </end encoding val Bug237b.__proj__KKArr__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug237b.uu___is_KKArr; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(23,4-23,9); use=Bug237b.fst(23,4-23,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug237b.knd)
(HasType (Bug237b.uu___is_KKArr @x0)
Prims.bool))
 

:pattern ((Bug237b.uu___is_KKArr @x0))
:qid typing_Bug237b.uu___is_KKArr))

:named typing_Bug237b.uu___is_KKArr))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug237b.knd; Namespace Bug237b; Name Bug237b.KType; Namespace Bug237b; Name Bug237b.KKArr; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(23,4-23,9); use=Bug237b.fst(23,4-23,9)
...
:named refinement_kinding_Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug237b.__proj__KKArr__item___0; Namespace Bug237b
(assert (! (HasType Tm_refine_5c691036dc4779e118afb73673a21bac
Tm_type)
:named refinement_kinding_Tm_refine_5c691036dc4779e118afb73673a21bac))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! (HasType Tm_refine_414d0a9f578ab0048252f8c8f552b99f
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_5c691036dc4779e118afb73673a21bac)
(and (HasTypeFuel @u0
@x1
Bug237b.knd)

;; def=Bug237b.fst(23,4-23,9); use=Bug237b.fst(23,4-23,9)
(BoxBool_proj_0 (Bug237b.uu___is_KKArr @x1))
))
...
@x1
Tm_refine_5c691036dc4779e118afb73673a21bac))
:qid refinement_interpretation_Tm_refine_5c691036dc4779e118afb73673a21bac))

:named refinement_interpretation_Tm_refine_5c691036dc4779e118afb73673a21bac))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
;; def=Prims.fst(73,14-73,31); use=Prims.fst(73,14-73,31)
...
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5c691036dc4779e118afb73673a21bac
;;; Fact-ids: Name Bug237b.__proj__KKArr__item___0; Namespace Bug237b
(assert (! (iff (Valid (Prims.hasEq Tm_refine_5c691036dc4779e118afb73673a21bac))
(Valid (Prims.hasEq Bug237b.knd)))
:named haseqTm_refine_5c691036dc4779e118afb73673a21bac))
;;;;;;;;;;;;;;;;haseq for Tm_refine_414d0a9f578ab0048252f8c8f552b99f
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_414d0a9f578ab0048252f8c8f552b99f))
(Valid (Prims.hasEq Tm_type)))
...
;; def=Bug237b.fst(23,4-23,9); use=Bug237b.fst(23,4-23,9)
(forall ((@x0 Term))
 (! (= (Bug237b.uu___is_KKArr @x0)
(BoxBool (is-Bug237b.KKArr @x0)))
 

:pattern ((Bug237b.uu___is_KKArr @x0))
:qid disc_equation_Bug237b.KKArr))

:named disc_equation_Bug237b.KKArr))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: Bug237b.knd__uu___haseq
;;; Fact-ids: Name Bug237b.knd__uu___haseq; Namespace Bug237b
(assert (! (Valid (Prims.hasEq Bug237b.knd))
:named assumption_Bug237b.knd__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Encoding query formula : forall (projectee: _: Bug237b.knd{KKArr? _}).
;   (*  - Could not prove post-condition
; *) ~(KKArr? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__KKArr__item___0`
...
(not 
;; def=Bug237b.fst(23,4-23,9); use=Bug237b.fst(23,4-23,9)
(BoxBool_proj_0 (Bug237b.uu___is_KKArr @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug237b.__proj__KKArr__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_5c691036dc4779e118afb73673a21bac
...
; encoding sigelt let __proj__KKArr__item___0


; <Skipped let __proj__KKArr__item___0/>


; encoding sigelt val Bug237b.ktsubst_beta


; <Skipped val Bug237b.ktsubst_beta/>


; encoding sigelt let ktsubst_beta


; <Start encoding let ktsubst_beta>

(declare-fun Bug237b.ktsubst_beta (Term) Term)

(declare-fun Bug237b.ktsubst_beta@tok () Term)

; </end encoding let ktsubst_beta>


; encoding sigelt val Bug237b.tconsts


; <Skipped val Bug237b.tconsts/>


; encoding sigelt let tconsts


; <Start encoding let tconsts>

(declare-fun Bug237b.tconsts (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> knd
(declare-fun Tm_arrow_86624fbe7e13df147737b3317a55c1b5 () Term)
(declare-fun Bug237b.tconsts@tok () Term)

; </end encoding let tconsts>
...
; encoding sigelt type Bug237b.kinding


; <Start encoding type Bug237b.kinding>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug237b.kinding (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Bug237b.kinding@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug237b.KConst () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug237b.KConst
(declare-fun Bug237b.KConst@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Bug237b.KTApp (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug237b.KTApp_k_ (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Bug237b.KTApp_hk1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Bug237b.KTApp
(declare-fun Bug237b.KTApp@tok () Term)
;;;;;;;;;;;;;;;;hk1: kinding (KKArr k') -> kinding (ktsubst_beta k')
(declare-fun Tm_arrow_08f9b374b872521e48e40344789501aa () Term)

; <start constructor Bug237b.kinding>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug237b.kinding ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
168)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-Bug237b.kinding))))

; </end constructor Bug237b.kinding>


; <start constructor Bug237b.KConst>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug237b.KConst ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
175)
(= __@x0
Bug237b.KConst)))

; </end constructor Bug237b.KConst>


; <start constructor Bug237b.KTApp>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Bug237b.KTApp ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
178)
(= __@x0
(Bug237b.KTApp (Bug237b.KTApp_k_ __@x0)
(Bug237b.KTApp_hk1 __@x0)))))

; </end constructor Bug237b.KTApp>


; </end encoding type Bug237b.kinding>

;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! (HasType Bug237b.KConst@tok
(Bug237b.kinding (Bug237b.tconsts Tm_unit)))
:named typing_tok_Bug237b.KConst@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug237b.tconsts; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(29,4-29,11); use=Bug237b.fst(29,4-29,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.unit)
(HasType (Bug237b.tconsts @x0)
Bug237b.knd))
 

:pattern ((Bug237b.tconsts @x0))
:qid typing_Bug237b.tconsts))

:named typing_Bug237b.tconsts))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug237b.ktsubst_beta; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(26,4-26,16); use=Bug237b.fst(26,4-26,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug237b.knd)
(HasType (Bug237b.ktsubst_beta @x0)
Bug237b.knd))
 

:pattern ((Bug237b.ktsubst_beta @x0))
:qid typing_Bug237b.ktsubst_beta))

:named typing_Bug237b.ktsubst_beta))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(31,5-31,12); use=Bug237b.fst(31,5-31,12)
(forall ((@x0 Term))
 (! (= (ApplyTT Bug237b.kinding@tok
@x0)
(Bug237b.kinding @x0))
 

:pattern ((ApplyTT Bug237b.kinding@tok
@x0))

:pattern ((Bug237b.kinding @x0))
:qid token_correspondence_Bug237b.kinding@tok))

:named token_correspondence_Bug237b.kinding@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
...
@x2)
(Bug237b.kinding @x3)))
:qid subterm_ordering_Bug237b.KTApp))

:named subterm_ordering_Bug237b.KTApp))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug237b.KTApp_k_ (Bug237b.KTApp @x0
@x1))
@x0)
 

:pattern ((Bug237b.KTApp @x0
@x1))
:qid projection_inverse_Bug237b.KTApp_k_))

:named projection_inverse_Bug237b.KTApp_k_))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug237b.KTApp_hk1 (Bug237b.KTApp @x0
@x1))
@x1)
...
:pattern ((Bug237b.KTApp @x0
@x1))
:qid projection_inverse_Bug237b.KTApp_hk1))

:named projection_inverse_Bug237b.KTApp_hk1))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! (is-Tm_arrow (PreType Bug237b.kinding@tok))
:named pre_kinding_Bug237b.kinding@tok))
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! (and (IsTotFun Bug237b.kinding@tok)

;; def=Bug237b.fst(31,5-31,12); use=Bug237b.fst(31,5-31,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Bug237b.knd)
(HasType (Bug237b.kinding @x0)
Tm_type))
 

:pattern ((Bug237b.kinding @x0))
:qid kinding_Bug237b.kinding@tok))
)
:named kinding_Bug237b.kinding@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(31,5-31,12); use=Bug237b.fst(31,5-31,12)
...
@x1
(Bug237b.kinding @x2))
(or (and (is-Bug237b.KConst @x1)
(= @x2
(Bug237b.tconsts Tm_unit)))
(and (is-Bug237b.KTApp @x1)
(= @x2
(Bug237b.ktsubst_beta (Bug237b.KTApp_k_ @x1))))))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
(Bug237b.kinding @x2)))
:qid fuel_guarded_inversion_Bug237b.kinding))

:named fuel_guarded_inversion_Bug237b.kinding))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! (= 169
(Term_constr_id Bug237b.kinding@tok))
:named fresh_token_Bug237b.kinding@tok))
;;;;;;;;;;;;;;;;Equation for Bug237b.tconsts
;;; Fact-ids: Name Bug237b.tconsts; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(29,4-29,11); use=Bug237b.fst(29,4-29,11)
(forall ((@x0 Term))
 (! (= (Bug237b.tconsts @x0)
(Bug237b.KKArr Bug237b.KType@tok))
 

:pattern ((Bug237b.tconsts @x0))
:qid equation_Bug237b.tconsts))

:named equation_Bug237b.tconsts))
;;;;;;;;;;;;;;;;Equation for Bug237b.ktsubst_beta
;;; Fact-ids: Name Bug237b.ktsubst_beta; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(26,4-26,16); use=Bug237b.fst(26,4-26,16)
(forall ((@x0 Term))
 (! (= (Bug237b.ktsubst_beta @x0)
@x0)
 

:pattern ((Bug237b.ktsubst_beta @x0))
:qid equation_Bug237b.ktsubst_beta))

:named equation_Bug237b.ktsubst_beta))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! (= Bug237b.KConst@tok
Bug237b.KConst)
:named equality_tok_Bug237b.KConst@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
...
(HasTypeFuel @u0
@x2
(Bug237b.kinding (Bug237b.KKArr @x1)))
(= (Bug237b.ktsubst_beta @x1)
@x3))
(HasTypeFuel @u0
(Bug237b.KTApp @x1
@x2)
...
@x2)
(Bug237b.kinding @x3)))
:qid data_typing_intro_Bug237b.KTApp@tok))

:named data_typing_intro_Bug237b.KTApp@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(32,2-32,8); use=Bug237b.fst(32,2-32,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (= (Bug237b.tconsts Tm_unit)
@x1)
(HasTypeFuel @u0
Bug237b.KConst
(Bug237b.kinding @x1)))
...
Bug237b.KConst
(Bug237b.kinding @x1)))
:qid data_typing_intro_Bug237b.KConst@tok))

:named data_typing_intro_Bug237b.KConst@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
...
@x2)
(Bug237b.kinding @x3)))
:qid data_elim_Bug237b.KTApp))

:named data_elim_Bug237b.KTApp))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(32,2-32,8); use=Bug237b.fst(32,2-32,8)
...
Bug237b.KConst
(Bug237b.kinding @x1)))
:qid data_elim_Bug237b.KConst))

:named data_elim_Bug237b.KConst))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(31,5-31,12); use=Bug237b.fst(31,5-31,12)
(forall ((@x0 Term))
 (! (= 168
(Term_constr_id (Bug237b.kinding @x0)))
 

:pattern ((Bug237b.kinding @x0))
:qid constructor_distinct_Bug237b.kinding))

:named constructor_distinct_Bug237b.kinding))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= 178
(Term_constr_id (Bug237b.KTApp @x0
@x1)))
 

:pattern ((Bug237b.KTApp @x0
@x1))
:qid constructor_distinct_Bug237b.KTApp))

:named constructor_distinct_Bug237b.KTApp))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! (= 175
(Term_constr_id Bug237b.KConst))
:named constructor_distinct_Bug237b.KConst))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(31,5-31,12); use=Bug237b.fst(31,5-31,12)
...
@x0
(Bug237b.kinding @x2)))
:qid Bug237b_pretyping_fb76649496f422cd598f47be98a75a34))

:named Bug237b_pretyping_fb76649496f422cd598f47be98a75a34))
(push) ;; push{4

; Starting query at Bug237b.fst(31,0-33,72)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Bug237b.knd).
;   (forall (k: Bug237b.knd). {:pattern Prims.hasEq (Bug237b.kinding k)}
;       Prims.hasEq (Bug237b.kinding k)) ==>
;   (forall (k': Bug237b.knd) (hk1: Bug237b.kinding (Bug237b.KKArr k')).
;       Prims.hasEq Bug237b.knd /\ Prims.hasEq (Bug237b.kinding (Bug237b.KKArr k')))


; Context: While encoding a query
; While typechecking the top-level declaration `type Bug237b.kinding`
...
;; def=Bug237b.fst(31,0-33,72); use=Bug237b.fst(31,0-33,72)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Bug237b.knd)
...
(Valid 
;; def=Bug237b.fst(31,0-33,72); use=Bug237b.fst(31,0-33,72)
(Prims.hasEq (Bug237b.kinding @x1))
)
)
 

:pattern ((Prims.hasEq (Bug237b.kinding @x1)))
:qid @query.1))
)
...
;; def=Bug237b.fst(31,0-33,72); use=Bug237b.fst(31,0-33,72)
(and 
;; def=Bug237b.fst(31,0-33,72); use=Bug237b.fst(33,14-33,17)
(or label_1
...
;; def=Bug237b.fst(31,0-33,72); use=Bug237b.fst(33,25-33,43)
(or label_2

;; def=Bug237b.fst(31,0-33,72); use=Bug237b.fst(31,0-33,72)
(Valid 
;; def=Bug237b.fst(31,0-33,72); use=Bug237b.fst(31,0-33,72)
(Prims.hasEq (Bug237b.kinding (Bug237b.KKArr @x1)))
)
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug237b.kinding, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Bug237b.knd__uu___haseq, data_typing_intro_Bug237b.KKArr@tok
...
; encoding sigelt assume Bug237b.kinding__uu___haseq


; <Start encoding assume Bug237b.kinding__uu___haseq>


; </end encoding assume Bug237b.kinding__uu___haseq>


; encoding sigelt val Bug237b.uu___is_KConst


; <Start encoding val Bug237b.uu___is_KConst>

(declare-fun Bug237b.uu___is_KConst (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: kinding k -> Prims.bool
(declare-fun Tm_arrow_9b9c9527e726af730843b37064968fb8 () Term)
(declare-fun Bug237b.uu___is_KConst@tok () Term)

; </end encoding val Bug237b.uu___is_KConst>


; encoding sigelt let uu___is_KConst


; <Skipped let uu___is_KConst/>


; encoding sigelt val Bug237b.uu___is_KTApp


; <Start encoding val Bug237b.uu___is_KTApp>

(declare-fun Bug237b.uu___is_KTApp (Term Term) Term)

(declare-fun Bug237b.uu___is_KTApp@tok () Term)

; </end encoding val Bug237b.uu___is_KTApp>


; encoding sigelt let uu___is_KTApp


; <Skipped let uu___is_KTApp/>


; encoding sigelt val Bug237b.__proj__KTApp__item__k'


; <Start encoding val Bug237b.__proj__KTApp__item__k'>

(declare-fun Tm_refine_ab9267cf714b6e732ad5733047d371de (Term) Term)
(declare-fun Bug237b.__proj__KTApp__item__k_ (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: kinding k {KTApp? _} -> knd
(declare-fun Tm_arrow_504c6ea5317b297273dae418383c8904 () Term)
(declare-fun Bug237b.__proj__KTApp__item__k_@tok () Term)

; </end encoding val Bug237b.__proj__KTApp__item__k'>
...
:named typing_tok_Bug237b.KConst@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug237b.uu___is_KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Bug237b.kinding @x0)))
(HasType (Bug237b.uu___is_KTApp @x0
@x1)
Prims.bool))
 

:pattern ((Bug237b.uu___is_KTApp @x0
@x1))
:qid typing_Bug237b.uu___is_KTApp))

:named typing_Bug237b.uu___is_KTApp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Bug237b.tconsts; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(29,4-29,11); use=Bug237b.fst(29,4-29,11)
...
:named subterm_ordering_Bug237b.KTApp))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Bug237b.__proj__KTApp__item__k'; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_ab9267cf714b6e732ad5733047d371de @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_ab9267cf714b6e732ad5733047d371de @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_ab9267cf714b6e732ad5733047d371de))

:named refinement_kinding_Tm_refine_ab9267cf714b6e732ad5733047d371de))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Bug237b.__proj__KTApp__item__k'; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ab9267cf714b6e732ad5733047d371de @x2))
(and (HasTypeFuel @u0
@x1
(Bug237b.kinding @x2))

;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
(BoxBool_proj_0 (Bug237b.uu___is_KTApp @x2
@x1))
))
...
@x1
(Tm_refine_ab9267cf714b6e732ad5733047d371de @x2)))
:qid refinement_interpretation_Tm_refine_ab9267cf714b6e732ad5733047d371de))

:named refinement_interpretation_Tm_refine_ab9267cf714b6e732ad5733047d371de))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
...
:named kinding_Bug237b.kinding@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ab9267cf714b6e732ad5733047d371de
;;; Fact-ids: Name Bug237b.__proj__KTApp__item__k'; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ab9267cf714b6e732ad5733047d371de @x0)))
(Valid (Prims.hasEq (Bug237b.kinding @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ab9267cf714b6e732ad5733047d371de @x0))))
:qid haseqTm_refine_ab9267cf714b6e732ad5733047d371de))

:named haseqTm_refine_ab9267cf714b6e732ad5733047d371de))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(31,5-31,12); use=Bug237b.fst(31,5-31,12)
...
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Bug237b.uu___is_KTApp @x0
@x1)
(BoxBool (is-Bug237b.KTApp @x1)))
 

:pattern ((Bug237b.uu___is_KTApp @x0
@x1))
:qid disc_equation_Bug237b.KTApp))

:named disc_equation_Bug237b.KTApp))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,2-33,7)
...
(Term_constr_id Bug237b.KConst))
:named constructor_distinct_Bug237b.KConst))
;;;;;;;;;;;;;;;;Assumption: Bug237b.kinding__uu___haseq
;;; Fact-ids: Name Bug237b.kinding__uu___haseq; Namespace Bug237b
...
:pattern ((Prims.hasEq (Bug237b.kinding @x0)))
:qid assumption_Bug237b.kinding__uu___haseq))
:named assumption_Bug237b.kinding__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Bug237b.kinding; Namespace Bug237b; Name Bug237b.KConst; Namespace Bug237b; Name Bug237b.KTApp; Namespace Bug237b
(assert (! 
;; def=Bug237b.fst(31,5-31,12); use=Bug237b.fst(31,5-31,12)
...
; Starting query at Bug237b.fst(33,11-33,13)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (k: Bug237b.knd) (projectee: _: Bug237b.kinding k {KTApp? _}).
;   (*  - Could not prove post-condition
; *) ~(KTApp? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__KTApp__item__k'`
...
Bug237b.knd)
(HasType @x1
(Tm_refine_ab9267cf714b6e732ad5733047d371de @x0))

;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,11-33,13)
(not 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,11-33,13)
(BoxBool_proj_0 (Bug237b.uu___is_KTApp @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug237b.__proj__KTApp__item__k', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_ab9267cf714b6e732ad5733047d371de
...
; encoding sigelt let __proj__KTApp__item__k'


; <Skipped let __proj__KTApp__item__k'/>


; encoding sigelt val Bug237b.__proj__KTApp__item__hk1


; <Start encoding val Bug237b.__proj__KTApp__item__hk1>


(declare-fun Bug237b.__proj__KTApp__item__hk1 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: kinding k {KTApp? _} -> kinding (KKArr projectee.k')
(declare-fun Tm_arrow_83b71fc579c6c9ac9139ed2a83c15ede () Term)
(declare-fun Bug237b.__proj__KTApp__item__hk1@tok () Term)

; </end encoding val Bug237b.__proj__KTApp__item__hk1>

(push) ;; push{2

; Starting query at Bug237b.fst(33,21-33,24)
...
; *)
;   (~(KTApp? projectee) ==> Prims.l_False) /\
;   (forall (b: Bug237b.knd) (b: Bug237b.kinding (Bug237b.KKArr b)).
;       projectee == Bug237b.KTApp b ==> Bug237b.ktsubst_beta b == k /\ KTApp? (Bug237b.KTApp b))


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__KTApp__item__hk1`
...
;; def=Prims.fst(459,77-459,89); use=Bug237b.fst(33,21-33,24)
(and (implies 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,21-33,24)
(not 
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,21-33,24)
(BoxBool_proj_0 (Bug237b.uu___is_KTApp @x0
@x1))
...
;; def=Prims.fst(413,99-413,120); use=Bug237b.fst(33,21-33,24)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Bug237b.knd)
...
(Bug237b.kinding (Bug237b.KKArr @x2)))
...
;; def=Bug237b.fst(33,2-33,7); use=Bug237b.fst(33,21-33,24)
(and 
;; def=Bug237b.fst(31,15-33,72); use=Bug237b.fst(33,2-33,7)
(or label_2

;; def=Bug237b.fst(31,15-33,72); use=Bug237b.fst(33,21-33,24)
(= (Bug237b.ktsubst_beta @x2)
@x0)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug237b.__proj__KTApp__item__hk1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Bug237b.KTApp, refinement_interpretation_Tm_refine_ab9267cf714b6e732ad5733047d371de
