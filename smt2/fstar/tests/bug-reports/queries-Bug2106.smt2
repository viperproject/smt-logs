...
; Internals for Bug2106


; encoding sigelt val Bug2106.loop


; <Skipped val Bug2106.loop/>


; encoding sigelt let rec loop


; <Start encoding let rec loop>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Bug2106.loop (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Bug2106.loop@tok () Term)

; </end encoding let rec loop>


; encoding sigelt val Bug2106.last


; <Skipped val Bug2106.last/>
...
; Starting query at Bug2106.fst(8,2-10,20)
...
;;;;;;;;;;;;;;;;l : l: Prims.list a {Cons? l} (l: Prims.list a {Cons? l})
(declare-fun x_59bd78df6a193fb43bc86d1138fd4d51_2 () Term)
...
;;; Fact-ids: 
(assert (! 
;; def=Bug2106.fst(6,28-6,47); use=Bug2106.fst(7,8-7,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=Bug2106.fst(6,39-6,46); use=Bug2106.fst(7,8-7,12)
...
;;;;;;;;;;;;;;;;binder_x_59bd78df6a193fb43bc86d1138fd4d51_2
;;; Fact-ids: 
(assert (! (HasType x_59bd78df6a193fb43bc86d1138fd4d51_2
Tm_refine_89abfbf1dd7254ec2f6bfc654aa43591)
:named binder_x_59bd78df6a193fb43bc86d1138fd4d51_2))
(declare-fun Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Bug2106.fst(6,28-10,20); use=Bug2106.fst(6,28-10,20)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a))

:named refinement_kinding_Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Bug2106.fst(6,28-10,20); use=Bug2106.fst(6,28-10,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
;; def=Bug2106.fst(8,2-10,20); use=Bug2106.fst(8,2-10,20)
...
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
@x1
x_59bd78df6a193fb43bc86d1138fd4d51_2)
)
...
@x1
(Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a @x2)))
:qid refinement_interpretation_Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a))

:named refinement_interpretation_Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a
;;; Fact-ids: 
(assert (! 
;; def=Bug2106.fst(6,28-10,20); use=Bug2106.fst(6,28-10,20)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a @x0)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a @x0))))
:qid haseqTm_refine_96baf9d89bf11668f2abfe0d7b74ec7a))

:named haseqTm_refine_96baf9d89bf11668f2abfe0d7b74ec7a))
(declare-fun Bug2106.last (Term Term) Term)

;;;;;;;;;;;;;;;;l: (l: Prims.list a {Cons? l}){l << l} -> a
(declare-fun Tm_arrow_3e264379d85eddf92d762679732200cb () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3e264379d85eddf92d762679732200cb
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3e264379d85eddf92d762679732200cb
Tm_type)
:named kinding_Tm_arrow_3e264379d85eddf92d762679732200cb))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Bug2106.fst(6,13-10,20); use=Bug2106.fst(6,28-10,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3e264379d85eddf92d762679732200cb)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_3e264379d85eddf92d762679732200cb))
:qid Bug2106_pre_typing_Tm_arrow_3e264379d85eddf92d762679732200cb))

:named Bug2106_pre_typing_Tm_arrow_3e264379d85eddf92d762679732200cb))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3e264379d85eddf92d762679732200cb
;;; Fact-ids: 
(assert (! 
;; def=Bug2106.fst(6,13-10,20); use=Bug2106.fst(6,28-10,20)
(forall ((@x0 Term))
...
Tm_type)
(HasType @x2
(Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a @x1)))
...
@x1)
@x2))
:qid Bug2106_interpretation_Tm_arrow_3e264379d85eddf92d762679732200cb.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Bug2106_interpretation_Tm_arrow_3e264379d85eddf92d762679732200cb.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_3e264379d85eddf92d762679732200cb))
:qid Bug2106_interpretation_Tm_arrow_3e264379d85eddf92d762679732200cb))

:named Bug2106_interpretation_Tm_arrow_3e264379d85eddf92d762679732200cb))
(declare-fun Bug2106.last@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Bug2106.fst(7,8-7,12); use=Bug2106.fst(7,8-7,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Bug2106.last@tok
@x0)
@x1)
(Bug2106.last @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Bug2106.last@tok
@x0)
@x1))
:qid token_correspondence_Bug2106.last))

:named token_correspondence_Bug2106.last))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Bug2106.fst(7,8-7,12); use=Bug2106.fst(7,8-7,12)
...
:pattern ((Bug2106.last @x1
@x2))
:qid function_token_typing_Bug2106.last.1))
)
 

:pattern ((ApplyTT @x0
Bug2106.last@tok))
:qid function_token_typing_Bug2106.last))

:named function_token_typing_Bug2106.last))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Bug2106.fst(7,8-7,12); use=Bug2106.fst(7,8-7,12)
...
Tm_type)
(HasType @x1
(Tm_refine_96baf9d89bf11668f2abfe0d7b74ec7a @x0)))
(HasType (Bug2106.last @x0
@x1)
@x0))
 

:pattern ((Bug2106.last @x0
@x1))
:qid typing_Bug2106.last))

:named typing_Bug2106.last))
...
;   (~(Cons? l && Nil? l.tl) ==> (forall (b: a) (b: Prims.list a). l == b :: b ==> Cons? b /\ b << l))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec last`
...
;; def=Prims.fst(402,27-402,88); use=Bug2106.fst(8,2-10,20)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Bug2106.fst(8,2-10,20)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Bug2106.fst(8,2-10,20)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Bug2106.fst(8,2-10,20)
(and (implies 
;; def=Bug2106.fst(7,13-10,20); use=Bug2106.fst(8,2-10,20)
(and 
;; def=Bug2106.fst(8,2-10,20); use=Bug2106.fst(8,2-10,20)
(not 
;; def=Bug2106.fst(8,2-10,20); use=Bug2106.fst(8,2-10,20)
...
;; def=Bug2106.fst(7,13-7,14); use=Bug2106.fst(8,8-8,9)
(not 
;; def=Bug2106.fst(7,13-7,14); use=Bug2106.fst(8,8-8,9)
(BoxBool_proj_0 (Prims.uu___is_Cons x_fe28d8bcde588226b4e538b35321de05_1
x_59bd78df6a193fb43bc86d1138fd4d51_2))
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Bug2106.fst(8,2-10,20)
(not 
;; def=Bug2106.fst(8,2-10,20); use=Bug2106.fst(8,2-10,20)
(and (BoxBool_proj_0 (Prims.uu___is_Cons x_fe28d8bcde588226b4e538b35321de05_1
x_59bd78df6a193fb43bc86d1138fd4d51_2))
...
;; def=Prims.fst(413,99-413,120); use=Bug2106.fst(8,2-10,20)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=Bug2106.fst(7,13-10,9); use=Bug2106.fst(8,8-10,9)
(= x_59bd78df6a193fb43bc86d1138fd4d51_2
...
;; def=Bug2106.fst(6,39-10,20); use=Bug2106.fst(10,18-10,20)
(and 
;; def=Bug2106.fst(6,39-6,46); use=Bug2106.fst(10,18-10,20)
(or label_2
...
;; def=Bug2106.fst(8,2-10,20); use=Bug2106.fst(10,18-10,20)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Bug2106.last, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_59bd78df6a193fb43bc86d1138fd4d51_2, constructor_distinct_Prims.Cons, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, proj_equation_Prims.Cons_tl, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, refinement_interpretation_Tm_refine_89abfbf1dd7254ec2f6bfc654aa43591, subterm_ordering_Prims.Cons
