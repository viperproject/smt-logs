...
; Starting query at <input>(3,2-3,49)
...
(declare-fun Tm_refine_615ac8983db5ec8b0bc642c5f1232dbb () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_615ac8983db5ec8b0bc642c5f1232dbb
Tm_type)
:named refinement_kinding_Tm_refine_615ac8983db5ec8b0bc642c5f1232dbb))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=<input>(2,12-3,49); use=<input>(2,12-3,49)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_615ac8983db5ec8b0bc642c5f1232dbb)
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=<input>(3,2-3,49); use=<input>(3,2-3,49)
...
@x1
Tm_refine_615ac8983db5ec8b0bc642c5f1232dbb))
:qid refinement_interpretation_Tm_refine_615ac8983db5ec8b0bc642c5f1232dbb))

:named refinement_interpretation_Tm_refine_615ac8983db5ec8b0bc642c5f1232dbb))
;;;;;;;;;;;;;;;;haseq for Tm_refine_615ac8983db5ec8b0bc642c5f1232dbb
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_615ac8983db5ec8b0bc642c5f1232dbb))
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_615ac8983db5ec8b0bc642c5f1232dbb))
(declare-fun Fib.fib (Term) Term)

;;;;;;;;;;;;;;;;n: int{n << n} -> int
(declare-fun Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1
Tm_type)
:named kinding_Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=<input>(2,12-3,49); use=<input>(2,12-3,49)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1))
:qid Fib_pre_typing_Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1))

:named Fib_pre_typing_Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1
;;; Fact-ids: 
(assert (! 
;; def=<input>(2,12-3,49); use=<input>(2,12-3,49)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Fib_interpretation_Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1))
:qid Fib_interpretation_Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1))

:named Fib_interpretation_Tm_arrow_bfc61914bd4ad62f3e938b89823f33c1))
(declare-fun Fib.fib@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=<input>(2,8-2,11); use=<input>(2,8-2,11)
(forall ((@x0 Term))
 (! (= (ApplyTT Fib.fib@tok
@x0)
(Fib.fib @x0))
...
:pattern ((ApplyTT Fib.fib@tok
@x0))
:qid token_correspondence_Fib.fib))

:named token_correspondence_Fib.fib))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=<input>(2,8-2,11); use=<input>(2,8-2,11)
...
:pattern ((Fib.fib @x1))
:qid function_token_typing_Fib.fib.1))
)
 

:pattern ((ApplyTT @x0
Fib.fib@tok))
:qid function_token_typing_Fib.fib))

:named function_token_typing_Fib.fib))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=<input>(2,8-2,11); use=<input>(2,8-2,11)
...
;       n <= 1 == b ==>
;       n - 1 << n /\
;       (forall (return_val: n: Prims.int{n << n}).
;           return_val == n - 1 ==>
;           (forall (any_result: Prims.int). Fib.fib (n - 1) == any_result ==> n - 2 << n)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec fib`
...
;; def=Prims.fst(402,27-402,88); use=<input>(3,2-3,49)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=<input>(3,2-3,49)
(Valid 
;; def=Prims.fst(402,84-402,87); use=<input>(3,2-3,49)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=<input>(3,2-3,49)
(not 
;; def=<input>(3,5-3,11); use=<input>(3,5-3,11)
...
;; def=Prims.fst(413,99-413,120); use=<input>(3,2-3,49)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=<input>(3,5-3,49); use=<input>(3,5-3,49)
(= (Prims.op_LessThanOrEqual x_ae567c2fb75be05905677af440075565_0
(BoxInt 1))
@x1)
)

;; def=Prims.fst(459,77-459,89); use=<input>(3,2-3,49)
(and 
;; def=<input>(3,2-3,49); use=<input>(3,28-3,35)
(or label_1
...
;; def=Prims.fst(356,2-356,58); use=<input>(3,2-3,49)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_615ac8983db5ec8b0bc642c5f1232dbb)

;; def=Prims.fst(356,26-356,41); use=<input>(3,2-3,49)
(= @x2
(Prims.op_Subtraction x_ae567c2fb75be05905677af440075565_0
(BoxInt 1)))
)

;; def=Prims.fst(451,66-451,102); use=<input>(3,2-3,49)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.int)

;; def=dummy(0,0-0,0); use=<input>(3,2-3,49)
(= (Fib.fib (Prims.op_Subtraction x_ae567c2fb75be05905677af440075565_0
(BoxInt 1)))
@x3)
)

;; def=<input>(3,2-3,49); use=<input>(3,42-3,49)
(or label_2
...
; QUERY ID: (Fib.fib, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_ae567c2fb75be05905677af440075565_0, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, well-founded-ordering-on-nat
