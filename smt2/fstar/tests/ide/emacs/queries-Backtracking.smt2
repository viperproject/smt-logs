...
; Starting query at <input>(3,0-3,24)
...
; While typechecking the top-level declaration `let a`
...
; Starting query at <input>(3,0-3,25)
...
(declare-fun Backtracking.a (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Backtracking.a; Namespace Backtracking
(assert (! 
;; def=<input>(3,4-3,5); use=<input>(3,4-3,5)
(forall ((@u0 Dummy_sort))
 (! (HasType (Backtracking.a @u0)
Tm_refine_afd51579b90d50ea23e03b743a1fa001)
 

:pattern ((Backtracking.a @u0))
:qid typing_Backtracking.a))

:named typing_Backtracking.a))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Backtracking.a; Namespace Backtracking
(assert (! 
;; def=<input>(3,8-3,20); use=<input>(3,8-3,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_afd51579b90d50ea23e03b743a1fa001)
...
;; def=<input>(3,14-3,19); use=<input>(3,14-3,19)
(> (BoxInt_proj_0 @x1)
...
:qid equation_Backtracking.a))

:named equation_Backtracking.a))
...
; Starting query at <input>(5,0-5,31)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Backtracking.a + Backtracking.a - 1 >= 0 /\ Backtracking.a + Backtracking.a - 1 > 1


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let b`
...
;;; Fact-ids: 
(assert (! (not 
;; def=<input>(5,13-5,18); use=<input>(5,22-5,31)
(and 
;; def=Prims.fst(680,18-680,24); use=<input>(5,22-5,31)
(or label_1

;; def=Prims.fst(680,18-680,24); use=<input>(5,22-5,31)
(>= (BoxInt_proj_0 (Prims.op_Subtraction (Prims.op_Addition (Backtracking.a Dummy_value)
(Backtracking.a Dummy_value))
(BoxInt 1)))
(BoxInt_proj_0 (BoxInt 0)))
)
...
; Starting query at <input>(5,0-5,34)
...
;;; Fact-ids: 
(assert (! (not 
;; def=<input>(5,13-5,18); use=<input>(5,22-5,34)
(and 
;; def=Prims.fst(680,18-680,24); use=<input>(5,22-5,34)
(or label_1
...
; QUERY ID: (Backtracking.b, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Backtracking.a, primitive_Prims.op_Addition, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0
