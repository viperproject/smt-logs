...
; Externals for interface FStar.String


; <Start encoding let char>

(declare-fun FStar.String.char (Dummy_sort) Term)

; </end encoding let char>


; <Start encoding val FStar.String.list_of_string>
...
; </end encoding val FStar.String.list_of_string>


; <Start encoding val FStar.String.string_of_list>
...
; </end encoding val FStar.String.string_of_list>


; <Start encoding val FStar.String.string_of_list_of_string>
...
; </end encoding val FStar.String.string_of_list_of_string>


; <Start encoding val FStar.String.list_of_string_of_list>
...
; </end encoding val FStar.String.list_of_string_of_list>


; <Start encoding let strlen>
...
; </end encoding let maxlen>


; <Start encoding val FStar.String.make>
...
; </end encoding val FStar.String.make>


; <Start encoding let string_of_char>
...
; </end encoding let string_of_char>


; <Start encoding val FStar.String.split>
...
; </end encoding val FStar.String.split>


; <Start encoding val FStar.String.concat>
...
; </end encoding val FStar.String.concat>


; <Start encoding val FStar.String.compare>
...
; </end encoding val FStar.String.compare>


; <Start encoding val FStar.String.lowercase>
...
; </end encoding val FStar.String.lowercase>


; <Start encoding val FStar.String.uppercase>

(declare-fun FStar.String.uppercase (Term) Term)

(declare-fun FStar.String.uppercase@tok () Term)

; </end encoding val FStar.String.uppercase>


; <Start encoding val FStar.String.index>
...
; </end encoding val FStar.String.index>


; <Start encoding val FStar.String.index_of>
...
; </end encoding val FStar.String.index_of>


; <Start encoding val FStar.String.sub>

(declare-fun Tm_refine_01729ae4a969ac9da9ca55c528b50bff (Term Term) Term)
(declare-fun FStar.String.sub (Term Term Term) Term)


(declare-fun Tm_arrow_6fd3ac4a846c3f66d7ec05709370a567 () Term)
(declare-fun FStar.String.sub@tok () Term)


; </end encoding val FStar.String.sub>


; <Start encoding val FStar.String.collect>
...
; </end encoding val FStar.String.collect>


; <Start encoding val FStar.String.substring>
...
; </end encoding val FStar.String.substring>


; <Start encoding val FStar.String.get>
...
; </end encoding val FStar.String.get>


; <Start encoding val FStar.String.concat_length>
...
; </end encoding val FStar.String.concat_length>


; <Start encoding val FStar.String.list_of_concat>
...
; </end encoding val FStar.String.list_of_concat>


; <Start encoding val FStar.String.index_string_of_list>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.String.index_string_of_list (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.String.index_string_of_list@tok () Term)

; </end encoding val FStar.String.index_string_of_list>


; <Start encoding let index_list_of_string>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.String.index_list_of_string (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.String.index_list_of_string@tok () Term)

; </end encoding let index_list_of_string>


; <Start encoding let concat_injective>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.String.concat_injective (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.String.concat_injective@tok () Term)

; </end encoding let concat_injective>


; End Externals for interface FStar.String
...
; encoding sigelt let filename


; <Start encoding let filename>

(declare-fun Tutorial.filename (Dummy_sort) Term)

; </end encoding let filename>
...
; encoding sigelt let canWrite


; <Start encoding let canWrite>

(declare-fun Tutorial.canWrite (Term) Term)
;;;;;;;;;;;;;;;;f: filename -> bool
(declare-fun Tm_arrow_3009efcbb21f7c1b32b9ab3c582869c7 () Term)
(declare-fun Tutorial.canWrite@tok () Term)

; </end encoding let canWrite>
...
; encoding sigelt let canRead


; <Start encoding let canRead>

(declare-fun Tutorial.canRead (Term) Term)

(declare-fun Tutorial.canRead@tok () Term)

; </end encoding let canRead>
...
; encoding sigelt val Tutorial.read


; <Skipped val Tutorial.read/>
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Tutorial.read (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Tutorial.read@tok () Term)
...
; encoding sigelt val Tutorial.write


; <Skipped val Tutorial.write/>
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Tutorial.write (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Tutorial.write@tok () Term)
...
; encoding sigelt let passwd


; <Start encoding let passwd>

(declare-fun Tutorial.passwd (Dummy_sort) Term)

; </end encoding let passwd>


; encoding sigelt let readme


; <Start encoding let readme>

(declare-fun Tutorial.readme (Dummy_sort) Term)

; </end encoding let readme>


; encoding sigelt let tmp


; <Start encoding let tmp>

(declare-fun Tutorial.tmp (Dummy_sort) Term)

; </end encoding let tmp>
...
; encoding sigelt val Tutorial.staticChecking


; <Skipped val Tutorial.staticChecking/>
...
;;;;;;;;;;;;;;;;Constructor base
;;; Fact-ids: Name FStar.IO.EOF; Namespace FStar.IO
(assert (! (implies (is-FStar.IO.EOF FStar.IO.EOF)
(= FStar.IO.EOF
FStar.IO.EOF@base))
:named constructor_base_FStar.IO.EOF))
;;;;;;;;;;;;;;;;unit typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Tutorial.tmp; Namespace Tutorial
(assert (! 
;; def=<input>(28,4-28,7); use=<input>(28,4-28,7)
(forall ((@u0 Dummy_sort))
 (! (HasType (Tutorial.tmp @u0)
Prims.string)
 

:pattern ((Tutorial.tmp @u0))
:qid typing_Tutorial.tmp))

:named typing_Tutorial.tmp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Tutorial.readme; Namespace Tutorial
(assert (! 
;; def=<input>(27,4-27,10); use=<input>(27,4-27,10)
(forall ((@u0 Dummy_sort))
 (! (HasType (Tutorial.readme @u0)
Prims.string)
 

:pattern ((Tutorial.readme @u0))
:qid typing_Tutorial.readme))

:named typing_Tutorial.readme))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Tutorial.filename; Namespace Tutorial
(assert (! 
;; def=<input>(5,5-5,13); use=<input>(5,5-5,13)
(forall ((@u0 Dummy_sort))
 (! (HasType (Tutorial.filename @u0)
Prims.eqtype)
 

:pattern ((Tutorial.filename @u0))
:qid typing_Tutorial.filename))

:named typing_Tutorial.filename))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Tutorial.canWrite; Namespace Tutorial
(assert (! 
;; def=<input>(8,4-8,12); use=<input>(8,4-8,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(Tutorial.filename Dummy_value))
(HasType (Tutorial.canWrite @x0)
Prims.bool))
 

:pattern ((Tutorial.canWrite @x0))
:qid typing_Tutorial.canWrite))

:named typing_Tutorial.canWrite))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Tutorial.canRead; Namespace Tutorial
(assert (! 
;; def=<input>(14,4-14,11); use=<input>(14,4-14,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(Tutorial.filename Dummy_value))
(HasType (Tutorial.canRead @x0)
Prims.bool))
 

:pattern ((Tutorial.canRead @x0))
:qid typing_Tutorial.canRead))

:named typing_Tutorial.canRead))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
:qid equation_Tutorial.tmp))

:named equation_Tutorial.tmp))
;;;;;;;;;;;;;;;;Equation for Tutorial.readme
;;; Fact-ids: Name Tutorial.readme; Namespace Tutorial
(assert (! 
;; def=<input>(27,4-27,10); use=<input>(27,4-27,10)
(forall ((@u0 Dummy_sort))
...
:qid equation_Tutorial.readme))

:named equation_Tutorial.readme))
;;;;;;;;;;;;;;;;Equation for Tutorial.filename
;;; Fact-ids: Name Tutorial.filename; Namespace Tutorial
(assert (! 
;; def=<input>(5,5-5,13); use=<input>(5,5-5,13)
(forall ((@u0 Dummy_sort))
...
:qid equation_Tutorial.filename))

:named equation_Tutorial.filename))
;;;;;;;;;;;;;;;;Equation for Tutorial.canWrite
;;; Fact-ids: Name Tutorial.canWrite; Namespace Tutorial
(assert (! 
;; def=<input>(8,4-8,12); use=<input>(8,4-8,12)
(forall ((@x0 Term))
 (! (= (Tutorial.canWrite @x0)
(let ((@lb1 @x0))
(ite (= @lb1
(BoxString (FString_const 0)))
(BoxBool true)
...
:pattern ((Tutorial.canWrite @x0))
:qid equation_Tutorial.canWrite))

:named equation_Tutorial.canWrite))
;;;;;;;;;;;;;;;;Equation for Tutorial.canRead
;;; Fact-ids: Name Tutorial.canRead; Namespace Tutorial
(assert (! 
;; def=<input>(14,4-14,11); use=<input>(14,4-14,11)
(forall ((@x0 Term))
 (! (= (Tutorial.canRead @x0)
(Prims.op_BarBar (Tutorial.canWrite @x0)
(Prims.op_Equality Prims.string
@x0
(BoxString (FString_const 1)))))
 

:pattern ((Tutorial.canRead @x0))
:qid equation_Tutorial.canRead))

:named equation_Tutorial.canRead))
...
; Starting query at <input>(32,23-36,20)
...
;     Tutorial.canRead Tutorial.tmp /\
;     (forall (any_result: Prims.string).
;         (forall (a: FStar.Pervasives.result Prims.string) (h: FStar.Monotonic.Heap.heap).
;             (match a with
;               | FStar.Pervasives.V _ ->
;                 Tutorial.canRead Tutorial.readme /\
;                 (forall (any_result: Prims.string).
;                     (forall (a: FStar.Pervasives.result Prims.string)
;                         (h: FStar.Monotonic.Heap.heap).
;                         (match a with
;                           | FStar.Pervasives.V _ ->
;                             Tutorial.canWrite Tutorial.tmp <: Prims.GTot Type0
;                           | FStar.Pervasives.E _ -> Prims.l_True
;                           | FStar.Pervasives.Err _ -> Prims.l_True)
;                         <:
;                         Type0)
;                     <:
;                     Type0)
...
; While typechecking the top-level declaration `let staticChecking`
...
;; def=FStar.Pervasives.fsti(685,55-685,100); use=FStar.Pervasives.fsti(697,14-697,25)
(forall ((@x1 Term))
 (! (implies (HasType @x1
FStar.Monotonic.Heap.heap)

;; def=Prims.fst(459,77-459,89); use=<input>(32,23-36,20)
(and 
;; def=<input>(19,23-19,32); use=<input>(33,16-33,19)
(or label_1

;; def=<input>(19,23-19,32); use=<input>(33,16-33,19)
(BoxBool_proj_0 (Tutorial.canRead (Tutorial.tmp Dummy_value)))
)


;; def=Prims.fst(451,66-451,102); use=<input>(32,23-36,20)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.string)

;; def=FStar.All.fsti(37,59-37,94); use=<input>(33,11-33,15)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
(FStar.Pervasives.result Prims.string))
(HasType @x4
FStar.Monotonic.Heap.heap))
(let ((@lb5 @x3))
...
;; def=Prims.fst(459,77-459,89); use=<input>(32,23-36,20)
(and 
;; def=<input>(19,23-19,32); use=<input>(34,16-34,22)
(or label_2

;; def=<input>(19,23-19,32); use=<input>(34,16-34,22)
(BoxBool_proj_0 (Tutorial.canRead (Tutorial.readme Dummy_value)))
)
...
;; def=FStar.All.fsti(37,59-37,94); use=<input>(34,11-34,15)
...
;; def=<input>(22,23-22,33); use=<input>(36,8-36,11)
(or label_3

;; def=<input>(22,23-22,33); use=<input>(36,8-36,11)
(BoxBool_proj_0 (Tutorial.canWrite (Tutorial.tmp Dummy_value)))
)

(implies (and (not (is-FStar.Pervasives.E @lb9))
(not (is-FStar.Pervasives.Err @lb9)))
Unreachable))))
...
(implies (and (not (is-FStar.Pervasives.E @lb5))
(not (is-FStar.Pervasives.Err @lb5)))
Unreachable))))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Tutorial.staticChecking, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ce036b6b736ef4e0bc3a9ff132a12aed, constructor_distinct_FStar.Pervasives.V, equation_Tutorial.canRead, equation_Tutorial.canWrite, equation_Tutorial.readme, equation_Tutorial.tmp, fuel_guarded_inversion_FStar.Pervasives.result, primitive_Prims.op_BarBar, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let staticChecking


; <Start encoding let staticChecking>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Tutorial.staticChecking (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Tutorial.staticChecking@tok () Term)

; </end encoding let staticChecking>


; encoding sigelt datacon Tutorial.InvalidRead for type Prims.exn


; <Start encoding datacon Tutorial.InvalidRead for type Prims.exn>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Tutorial.InvalidRead () Term)
;;;;;;;;;;;;;;;;Constructor base
(declare-fun Tutorial.InvalidRead@base () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Tutorial.InvalidRead
(declare-fun Tutorial.InvalidRead@tok () Term)

; <start constructor Tutorial.InvalidRead>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Tutorial.InvalidRead ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
109)
(= __@x0
Tutorial.InvalidRead)))

; </end constructor Tutorial.InvalidRead>


; </end encoding datacon Tutorial.InvalidRead for type Prims.exn>


; encoding sigelt val Tutorial.uu___is_InvalidRead


; <Start encoding val Tutorial.uu___is_InvalidRead>

(declare-fun Tutorial.uu___is_InvalidRead (Term) Term)

(declare-fun Tutorial.uu___is_InvalidRead@tok () Term)

; </end encoding val Tutorial.uu___is_InvalidRead>


; encoding sigelt let uu___is_InvalidRead


; <Skipped let uu___is_InvalidRead/>


; encoding sigelt val Tutorial.checkedRead


; <Skipped val Tutorial.checkedRead/>

;;;;;;;;;;;;;;;;Constructor base
;;; Fact-ids: Name Tutorial.InvalidRead; Namespace Tutorial
(assert (! (implies (is-Tutorial.InvalidRead Tutorial.InvalidRead)
(= Tutorial.InvalidRead
Tutorial.InvalidRead@base))
:named constructor_base_Tutorial.InvalidRead))
...
; Starting query at <input>(43,2-43,49)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (f: Tutorial.filename).
;   (*  - Could not prove post-condition
; *)
;   forall (h0: FStar.Monotonic.Heap.heap)
;     (k: FStar.Pervasives.all_post_h FStar.Monotonic.Heap.heap Prims.string).
;     (forall (x: FStar.Pervasives.result Prims.string) (h: FStar.Monotonic.Heap.heap).
;         {:pattern Prims.guard_free (k x h)}
;         Prims.auto_squash (k x h)) ==>
;     Tutorial.canRead f == true ==> Tutorial.canRead f


; Context: While encoding a query
; While typechecking the top-level declaration `let checkedRead`
...
;; def=FStar.Pervasives.fsti(667,4-667,88); use=<input>(43,2-43,49)
(forall ((@x3 Term) (@x4 Term))
 (! 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=<input>(43,2-43,49)
(Valid 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=<input>(43,2-43,49)
(ApplyTT (ApplyTT @x2
@x3)
...
:pattern ((ApplyTT (ApplyTT @x2
@x3)
@x4))
:qid @query.3))


;; def=<input>(43,5-43,14); use=<input>(43,5-43,14)
(= (Tutorial.canRead @x0)
(BoxBool true))
)

;; def=<input>(19,23-19,32); use=<input>(43,25-43,26)
(or label_1

;; def=<input>(19,23-19,32); use=<input>(43,25-43,26)
(BoxBool_proj_0 (Tutorial.canRead @x0))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Tutorial.checkedRead, 1)
; STATUS: unsat
