...
; encoding sigelt let f1


; <Start encoding let f1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Micro.f1 (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Micro.f1@tok () Term)

; </end encoding let f1>


; encoding sigelt let g1


; <Start encoding let g1>

(declare-fun Micro.g1 (Term) Term)

(declare-fun Micro.g1@tok () Term)

; </end encoding let g1>


; encoding sigelt let h2


; <Start encoding let h2>
...
;;;;;;;;;;;;;;;;x: Prims.int -> FStar.Pervasives.Lemma (ensures post x)
(declare-fun Tm_arrow_d67b06d7f5dbe35694dcf4f59b12283b (Term) Term)
(declare-fun Micro.h2 (Term Term) Term)



;;;;;;;;;;;;;;;;$f: (x: Prims.int -> FStar.Pervasives.Lemma (ensures post x)) -> Prims.unit
(declare-fun Tm_arrow_00705be6d8fe061d8b45404f4659f64d () Term)
(declare-fun Micro.h2@tok () Term)
...
; encoding sigelt let i2


; <Start encoding let i2>

(declare-fun Micro.i2 (Term) Term)

(declare-fun Micro.i2@tok () Term)

; </end encoding let i2>


; encoding sigelt let h3


; <Start encoding let h3>




(declare-fun Micro.h3 (Term Term Term) Term)



;;;;;;;;;;;;;;;;$f: (x: Prims.int -> FStar.Pervasives.Lemma (ensures post x)) -> x: Prims.int -> Prims.int
(declare-fun Tm_arrow_a48cb55dc27a377c15d030d8ff40a87a () Term)
(declare-fun Micro.h3@tok () Term)
...
; encoding sigelt let i3


; <Start encoding let i3>

(declare-fun Micro.i3 (Term) Term)

(declare-fun Micro.i3@tok () Term)
...
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Micro.i3; Namespace Micro
(assert (! (Valid (ApplyTT __uu__PartialApp
Micro.f1@tok))
:named @kick_partial_app_f7c9e3b42130ca98b6d21a31e2b36a9e))
(push) ;; push{2

; Starting query at Micro.fst(28,2-28,6)
...
;     a == Prims.unit /\ (forall (pure_result: a). Prims.auto_squash (p pure_result)) ==>
;     (forall (pure_result: Prims.unit).
;         Prims.has_type pure_result a /\
;         (forall (return_val: a).
;             return_val == pure_result ==>
;             return_val == Micro.f1 0 ==>
;             (forall (return_val: a). return_val == return_val ==> p return_val)))


; Context: While encoding a query
; While typechecking the top-level declaration `let weird0`
...
;; def=Micro.fst(27,39-27,50); use=Micro.fst(28,2-28,6)
(= @x0
Prims.unit)


;; def=Prims.fst(441,36-441,97); use=Micro.fst(28,2-28,6)
(forall ((@x2 Term))
 (! (implies (or label_1
(HasType @x2
@x0))

;; def=Prims.fst(441,83-441,96); use=Micro.fst(28,2-28,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Micro.fst(28,2-28,6)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(441,36-441,97); use=Micro.fst(28,2-28,4)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(459,77-459,89); use=Micro.fst(28,2-28,6)
(and 
;; def=Micro.fst(28,2-28,6); use=Micro.fst(28,2-28,6)
(or label_2
(HasType @x2
@x0))


;; def=Prims.fst(356,2-356,58); use=Micro.fst(28,2-28,6)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
@x0)

;; def=Prims.fst(356,26-356,41); use=Micro.fst(28,2-28,6)
(= @x3
@x2)


;; def=Micro.fst(27,12-28,6); use=Micro.fst(28,2-28,6)
(= @x3
(Micro.f1 (BoxInt 0)))
)
...
; encoding sigelt let weird0


; <Start encoding let weird0>

(declare-fun Micro.weird0 (Term) Term)
(declare-fun Tm_refine_c16bc1b61f58b349bf6fc1c94dcaf83b (Term) Term)
;;;;;;;;;;;;;;;;a: Type -> Prims.Pure a
(declare-fun Tm_arrow_75082ffca5c2563f07a77eaf27e21ed3 () Term)
(declare-fun Micro.weird0@tok () Term)


; </end encoding let weird0>
...
; Starting query at Micro.fst(31,2-31,6)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (f: (_: Prims.int -> Prims.unit)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post a).
;     a == Prims.unit /\ (forall (pure_result: a). Prims.auto_squash (p pure_result)) ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let weird1`
...
;; def=Micro.fst(30,58-30,69); use=Micro.fst(31,2-31,6)
(= @x0
Prims.unit)


;; def=Prims.fst(441,36-441,97); use=Micro.fst(31,2-31,6)
(forall ((@x3 Term))
 (! (implies (or label_1
(HasType @x3
@x0))

;; def=Prims.fst(441,83-441,96); use=Micro.fst(31,2-31,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Micro.fst(31,2-31,6)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(441,36-441,97); use=Micro.fst(31,2-31,4)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=Prims.fst(459,77-459,89); use=Micro.fst(31,2-31,6)
(and 
;; def=Micro.fst(31,2-31,6); use=Micro.fst(31,2-31,6)
(or label_2
(HasType @x3
@x0))


;; def=Prims.fst(356,2-356,58); use=Micro.fst(31,2-31,6)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
@x0)

;; def=Prims.fst(356,26-356,41); use=Micro.fst(31,2-31,6)
(= @x4
@x3)


;; def=Micro.fst(30,12-31,6); use=Micro.fst(31,2-31,6)
(= @x4
(Micro.f1 (BoxInt 0)))
)
