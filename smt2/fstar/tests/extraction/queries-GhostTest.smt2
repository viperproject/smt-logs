...
; encoding sigelt type GhostTest.sizedListNonGhost


; <Start encoding type GhostTest.sizedListNonGhost>

;;;;;;;;;;;;;;;;Constructor
(declare-fun GhostTest.sizedListNonGhost () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun GhostTest.MkSListNG (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun GhostTest.MkSListNG_maxsize (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun GhostTest.MkSListNG_cont (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: GhostTest.MkSListNG
(declare-fun GhostTest.MkSListNG@tok () Term)
(declare-fun Tm_refine_82c9e8a47e7badc03adc7985a421bfb3 (Term) Term)

;;;;;;;;;;;;;;;;maxsize: Prims.nat -> cont: Prims.list Prims.int {FStar.List.Tot.Base.length cont < maxsize}   -> sizedListNonGhost
(declare-fun Tm_arrow_e166d34ad5d755b4eeb995c9cee41019 () Term)

; <start constructor GhostTest.sizedListNonGhost>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-GhostTest.sizedListNonGhost ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
GhostTest.sizedListNonGhost)))

; </end constructor GhostTest.sizedListNonGhost>


; <start constructor GhostTest.MkSListNG>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-GhostTest.MkSListNG ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
123)
(= __@x0
(GhostTest.MkSListNG (GhostTest.MkSListNG_maxsize __@x0)
(GhostTest.MkSListNG_cont __@x0)))))

; </end constructor GhostTest.MkSListNG>


; </end encoding type GhostTest.sizedListNonGhost>
...
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name GhostTest.sizedListNonGhost; Namespace GhostTest; Name GhostTest.MkSListNG; Namespace GhostTest
(assert (! 
;; def=GhostTest.fst(21,2-21,11); use=GhostTest.fst(21,2-21,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(GhostTest.MkSListNG @x1
@x2)
GhostTest.sizedListNonGhost)
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
...
@x2)
GhostTest.sizedListNonGhost))
:qid subterm_ordering_GhostTest.MkSListNG))

:named subterm_ordering_GhostTest.MkSListNG))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name GhostTest.sizedListNonGhost; Namespace GhostTest; Name GhostTest.MkSListNG; Namespace GhostTest
(assert (! 
;; def=GhostTest.fst(21,28-21,68); use=GhostTest.fst(21,28-21,68)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_82c9e8a47e7badc03adc7985a421bfb3 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_82c9e8a47e7badc03adc7985a421bfb3 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_82c9e8a47e7badc03adc7985a421bfb3))

:named refinement_kinding_Tm_refine_82c9e8a47e7badc03adc7985a421bfb3))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_82c9e8a47e7badc03adc7985a421bfb3 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=GhostTest.fst(21,44-21,67); use=GhostTest.fst(21,44-21,67)
...
@x1
(Tm_refine_82c9e8a47e7badc03adc7985a421bfb3 @x2)))
:qid refinement_interpretation_Tm_refine_82c9e8a47e7badc03adc7985a421bfb3))

:named refinement_interpretation_Tm_refine_82c9e8a47e7badc03adc7985a421bfb3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
...
;; def=GhostTest.fst(21,2-21,11); use=GhostTest.fst(21,2-21,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (GhostTest.MkSListNG_maxsize (GhostTest.MkSListNG @x0
@x1))
@x0)
 

:pattern ((GhostTest.MkSListNG @x0
@x1))
:qid projection_inverse_GhostTest.MkSListNG_maxsize))

:named projection_inverse_GhostTest.MkSListNG_maxsize))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name GhostTest.sizedListNonGhost; Namespace GhostTest; Name GhostTest.MkSListNG; Namespace GhostTest
(assert (! 
;; def=GhostTest.fst(21,2-21,11); use=GhostTest.fst(21,2-21,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (GhostTest.MkSListNG_cont (GhostTest.MkSListNG @x0
@x1))
@x1)
...
:pattern ((GhostTest.MkSListNG @x0
@x1))
:qid projection_inverse_GhostTest.MkSListNG_cont))

:named projection_inverse_GhostTest.MkSListNG_cont))
...
;;; Fact-ids: Name GhostTest.sizedListNonGhost; Namespace GhostTest; Name GhostTest.MkSListNG; Namespace GhostTest
(assert (! (HasType GhostTest.sizedListNonGhost
Tm_type)
:named kinding_GhostTest.sizedListNonGhost@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_82c9e8a47e7badc03adc7985a421bfb3
;;; Fact-ids: Name GhostTest.sizedListNonGhost; Namespace GhostTest; Name GhostTest.MkSListNG; Namespace GhostTest
(assert (! 
;; def=GhostTest.fst(21,28-21,68); use=GhostTest.fst(21,28-21,68)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_82c9e8a47e7badc03adc7985a421bfb3 @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_82c9e8a47e7badc03adc7985a421bfb3 @x0))))
:qid haseqTm_refine_82c9e8a47e7badc03adc7985a421bfb3))

:named haseqTm_refine_82c9e8a47e7badc03adc7985a421bfb3))
...
;;; Fact-ids: Name GhostTest.sizedListNonGhost; Namespace GhostTest; Name GhostTest.MkSListNG; Namespace GhostTest
(assert (! 
;; def=GhostTest.fst(20,5-20,22); use=GhostTest.fst(20,5-20,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
GhostTest.sizedListNonGhost)
(is-GhostTest.MkSListNG @x1))
 

:pattern ((HasTypeFuel @u0
@x1
GhostTest.sizedListNonGhost))
:qid fuel_guarded_inversion_GhostTest.sizedListNonGhost))

:named fuel_guarded_inversion_GhostTest.sizedListNonGhost))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! (= 319
...
(HasTypeFuel @u0
@x2
(Tm_refine_82c9e8a47e7badc03adc7985a421bfb3 @x1)))
(HasTypeFuel @u0
(GhostTest.MkSListNG @x1
@x2)
GhostTest.sizedListNonGhost))
...
@x2)
GhostTest.sizedListNonGhost))
:qid data_typing_intro_GhostTest.MkSListNG@tok))

:named data_typing_intro_GhostTest.MkSListNG@tok))
...
@x2)
GhostTest.sizedListNonGhost))
:qid data_elim_GhostTest.MkSListNG))

:named data_elim_GhostTest.MkSListNG))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name GhostTest.sizedListNonGhost; Namespace GhostTest; Name GhostTest.MkSListNG; Namespace GhostTest
(assert (! (= 116
(Term_constr_id GhostTest.sizedListNonGhost))
:named constructor_distinct_GhostTest.sizedListNonGhost))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name GhostTest.sizedListNonGhost; Namespace GhostTest; Name GhostTest.MkSListNG; Namespace GhostTest
(assert (! 
;; def=GhostTest.fst(21,2-21,11); use=GhostTest.fst(21,2-21,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= 123
(Term_constr_id (GhostTest.MkSListNG @x0
@x1)))
 

:pattern ((GhostTest.MkSListNG @x0
@x1))
:qid constructor_distinct_GhostTest.MkSListNG))

:named constructor_distinct_GhostTest.MkSListNG))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Monotonic.Heap.core_mref; Namespace FStar.Monotonic.Heap
(assert (! 
;; def=FStar.Monotonic.Heap.fsti(39,4-39,13); use=FStar.Monotonic.Heap.fsti(39,4-39,13)
...
@x0
GhostTest.sizedListNonGhost))
:qid GhostTest_pretyping_1ea565317ba4f532a3ce2837a3d4ea3a))

:named GhostTest_pretyping_1ea565317ba4f532a3ce2837a3d4ea3a))
...
; Starting query at GhostTest.fst(20,0-21,89)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


; Encoding query formula : Prims.hasEq GhostTest.sizedListNonGhost ==>
; (forall (maxsize: Prims.nat)
;     (cont: Prims.list Prims.int {FStar.List.Tot.Base.length cont < maxsize}).
;     Prims.hasEq Prims.nat /\ Prims.hasEq (Prims.list Prims.int))


; Context: While encoding a query
; While typechecking the top-level declaration `type GhostTest.sizedListNonGhost`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=GhostTest.fst(20,0-21,89); use=GhostTest.fst(20,0-21,89)
(Valid 
;; def=GhostTest.fst(20,0-21,89); use=GhostTest.fst(20,0-21,89)
(Prims.hasEq GhostTest.sizedListNonGhost)
)
...
Prims.nat)
(HasType @x1
(Tm_refine_82c9e8a47e7badc03adc7985a421bfb3 @x0)))

;; def=GhostTest.fst(20,0-21,89); use=GhostTest.fst(20,0-21,89)
(and 
;; def=GhostTest.fst(20,0-21,89); use=GhostTest.fst(21,21-21,24)
(or label_1
...
;; def=GhostTest.fst(21,33-21,43); use=GhostTest.fst(21,33-21,43)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GhostTest.sizedListNonGhost, 1)
; STATUS: unsat
...
; encoding sigelt assume GhostTest.sizedListNonGhost__uu___haseq


; <Start encoding assume GhostTest.sizedListNonGhost__uu___haseq>


; </end encoding assume GhostTest.sizedListNonGhost__uu___haseq>


; encoding sigelt val GhostTest.uu___is_MkSListNG


; <Start encoding val GhostTest.uu___is_MkSListNG>

(declare-fun GhostTest.uu___is_MkSListNG (Term) Term)
;;;;;;;;;;;;;;;;projectee: sizedListNonGhost -> Prims.bool
(declare-fun Tm_arrow_05e756d5c475743fb76e9bfc7aae5eb1 () Term)
(declare-fun GhostTest.uu___is_MkSListNG@tok () Term)

; </end encoding val GhostTest.uu___is_MkSListNG>


; encoding sigelt let uu___is_MkSListNG


; <Skipped let uu___is_MkSListNG/>


; encoding sigelt val GhostTest.__proj__MkSListNG__item__maxsize


; <Start encoding val GhostTest.__proj__MkSListNG__item__maxsize>

(declare-fun GhostTest.__proj__MkSListNG__item__maxsize (Term) Term)
;;;;;;;;;;;;;;;;projectee: sizedListNonGhost -> Prims.nat
(declare-fun Tm_arrow_c233167c3a9c8c1b67a4f7f22b30d067 () Term)
(declare-fun GhostTest.__proj__MkSListNG__item__maxsize@tok () Term)

; </end encoding val GhostTest.__proj__MkSListNG__item__maxsize>


; encoding sigelt let __proj__MkSListNG__item__maxsize


; <Skipped let __proj__MkSListNG__item__maxsize/>


; encoding sigelt val GhostTest.__proj__MkSListNG__item__cont


; <Start encoding val GhostTest.__proj__MkSListNG__item__cont>

(declare-fun GhostTest.__proj__MkSListNG__item__cont (Term) Term)
(declare-fun Tm_refine_895ae3dc0334c748ff1f5d4d11853338 (Term) Term)
;;;;;;;;;;;;;;;;projectee: sizedListNonGhost   -> cont: Prims.list Prims.int {FStar.List.Tot.Base.length cont < projectee.maxsize}
(declare-fun Tm_arrow_857aa52bc8960b2e4e19d71863c0fa5f () Term)
(declare-fun GhostTest.__proj__MkSListNG__item__cont@tok () Term)


; </end encoding val GhostTest.__proj__MkSListNG__item__cont>


; encoding sigelt let __proj__MkSListNG__item__cont


; <Skipped let __proj__MkSListNG__item__cont/>


; encoding sigelt val GhostTest.aSizedListNG


; <Skipped val GhostTest.aSizedListNG/>
...
; Starting query at GhostTest.fst(24,0-24,37)

(declare-fun label_1 () Bool)

; Encoding query formula : FStar.List.Tot.Base.length [1] < 2


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let aSizedListNG`
...
;;; Fact-ids: 
(assert (! (not 
;; def=GhostTest.fst(21,44-21,67); use=GhostTest.fst(24,34-24,37)
(or label_1
...
; encoding sigelt let aSizedListNG


; <Start encoding let aSizedListNG>

(declare-fun GhostTest.aSizedListNG (Dummy_sort) Term)

; </end encoding let aSizedListNG>


; encoding sigelt type GhostTest.sizedList


; <Start encoding type GhostTest.sizedList>

;;;;;;;;;;;;;;;;Constructor
(declare-fun GhostTest.sizedList () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun GhostTest.MkSList (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun GhostTest.MkSList_maxsize (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun GhostTest.MkSList_cont (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: GhostTest.MkSList
(declare-fun GhostTest.MkSList@tok () Term)
(declare-fun Tm_refine_d9d4d384163eec3325cfbbcc37301e0d (Term) Term)

;;;;;;;;;;;;;;;;maxsize: FStar.Ghost.erased Prims.nat ->     cont: Prims.list Prims.int {FStar.List.Tot.Base.length cont < maxsize}   -> sizedList
(declare-fun Tm_arrow_3ce9e42dc0132fde73e99be55e35a672 () Term)

; <start constructor GhostTest.sizedList>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-GhostTest.sizedList ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
149)
(= __@x0
GhostTest.sizedList)))

; </end constructor GhostTest.sizedList>


; <start constructor GhostTest.MkSList>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-GhostTest.MkSList ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
156)
(= __@x0
(GhostTest.MkSList (GhostTest.MkSList_maxsize __@x0)
(GhostTest.MkSList_cont __@x0)))))

; </end constructor GhostTest.MkSList>


; </end encoding type GhostTest.sizedList>


; encoding sigelt val GhostTest.uu___is_MkSList


; <Start encoding val GhostTest.uu___is_MkSList>

(declare-fun GhostTest.uu___is_MkSList (Term) Term)
;;;;;;;;;;;;;;;;projectee: sizedList -> Prims.bool
(declare-fun Tm_arrow_6a21d32138b94dae6e08439b9d9b8fb2 () Term)
(declare-fun GhostTest.uu___is_MkSList@tok () Term)

; </end encoding val GhostTest.uu___is_MkSList>


; encoding sigelt let uu___is_MkSList


; <Skipped let uu___is_MkSList/>


; encoding sigelt val GhostTest.__proj__MkSList__item__maxsize


; <Start encoding val GhostTest.__proj__MkSList__item__maxsize>

(declare-fun GhostTest.__proj__MkSList__item__maxsize (Term) Term)
;;;;;;;;;;;;;;;;projectee: sizedList -> FStar.Ghost.erased Prims.nat
(declare-fun Tm_arrow_09610f0a60916b7201c59eb2873ceaf2 () Term)
(declare-fun GhostTest.__proj__MkSList__item__maxsize@tok () Term)

; </end encoding val GhostTest.__proj__MkSList__item__maxsize>


; encoding sigelt let __proj__MkSList__item__maxsize


; <Skipped let __proj__MkSList__item__maxsize/>


; encoding sigelt val GhostTest.__proj__MkSList__item__cont


; <Start encoding val GhostTest.__proj__MkSList__item__cont>

(declare-fun GhostTest.__proj__MkSList__item__cont (Term) Term)
(declare-fun Tm_refine_80bcff45a1bb4ff04754ceac9b39d11e (Term) Term)
;;;;;;;;;;;;;;;;projectee: sizedList   -> cont: Prims.list Prims.int {FStar.List.Tot.Base.length cont < projectee.maxsize}
(declare-fun Tm_arrow_f98efaaf9b1decbd92a7eee8c6782bb1 () Term)
(declare-fun GhostTest.__proj__MkSList__item__cont@tok () Term)


; </end encoding val GhostTest.__proj__MkSList__item__cont>


; encoding sigelt let __proj__MkSList__item__cont


; <Skipped let __proj__MkSList__item__cont/>


; encoding sigelt val GhostTest.aSizedList


; <Skipped val GhostTest.aSizedList/>

(push) ;; push{2

; Starting query at GhostTest.fst(31,0-31,38)
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let aSizedList`
...
;;; Fact-ids: 
(assert (! (not 
;; def=GhostTest.fst(28,51-28,81); use=GhostTest.fst(31,35-31,38)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GhostTest.aSizedList, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, @query, constructor_distinct_Prims.Cons, constructor_distinct_Prims.Nil, data_typing_intro_Prims.Cons@tok, data_typing_intro_Prims.Nil@tok, equation_Prims.eqtype, equation_with_fuel_FStar.List.Tot.Base.length.fuel_instrumented, int_typing, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, projection_inverse_Prims.Nil_a, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
