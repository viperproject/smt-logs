...
; Internals for Eta_expand


; encoding sigelt type Eta_expand.t


; <Start encoding type Eta_expand.t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Eta_expand.t () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Eta_expand.A () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Eta_expand.A
(declare-fun Eta_expand.A@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Eta_expand.B () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Eta_expand.B
(declare-fun Eta_expand.B@tok () Term)

; <start constructor Eta_expand.t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eta_expand.t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
Eta_expand.t)))

; </end constructor Eta_expand.t>


; <start constructor Eta_expand.A>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eta_expand.A ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
128)
(= __@x0
Eta_expand.A)))

; </end constructor Eta_expand.A>


; <start constructor Eta_expand.B>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eta_expand.B ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
130)
(= __@x0
Eta_expand.B)))

; </end constructor Eta_expand.B>


; </end encoding type Eta_expand.t>


; encoding sigelt assume Eta_expand.t__uu___haseq


; <Start encoding assume Eta_expand.t__uu___haseq>


; </end encoding assume Eta_expand.t__uu___haseq>


; encoding sigelt val Eta_expand.uu___is_A


; <Start encoding val Eta_expand.uu___is_A>

(declare-fun Eta_expand.uu___is_A (Term) Term)
;;;;;;;;;;;;;;;;projectee: t -> Prims.bool
(declare-fun Tm_arrow_807cf4087b9b67f4b37177b708568b50 () Term)
(declare-fun Eta_expand.uu___is_A@tok () Term)

; </end encoding val Eta_expand.uu___is_A>
...
; encoding sigelt val Eta_expand.uu___is_B


; <Start encoding val Eta_expand.uu___is_B>

(declare-fun Eta_expand.uu___is_B (Term) Term)

(declare-fun Eta_expand.uu___is_B@tok () Term)

; </end encoding val Eta_expand.uu___is_B>
...
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Eta_expand.t; Namespace Eta_expand; Name Eta_expand.A; Namespace Eta_expand; Name Eta_expand.B; Namespace Eta_expand
(assert (! (HasType Eta_expand.B@tok
Eta_expand.t)
:named typing_tok_Eta_expand.B@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Eta_expand.t; Namespace Eta_expand; Name Eta_expand.A; Namespace Eta_expand; Name Eta_expand.B; Namespace Eta_expand
(assert (! (HasType Eta_expand.A@tok
Eta_expand.t)
:named typing_tok_Eta_expand.A@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eta_expand.uu___is_B; Namespace Eta_expand
(assert (! 
;; def=Eta_expand.fst(22,4-22,5); use=Eta_expand.fst(22,4-22,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Eta_expand.t)
(HasType (Eta_expand.uu___is_B @x0)
Prims.bool))
 

:pattern ((Eta_expand.uu___is_B @x0))
:qid typing_Eta_expand.uu___is_B))

:named typing_Eta_expand.uu___is_B))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eta_expand.uu___is_A; Namespace Eta_expand
(assert (! 
;; def=Eta_expand.fst(21,4-21,5); use=Eta_expand.fst(21,4-21,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Eta_expand.t)
(HasType (Eta_expand.uu___is_A @x0)
Prims.bool))
 

:pattern ((Eta_expand.uu___is_A @x0))
:qid typing_Eta_expand.uu___is_A))

:named typing_Eta_expand.uu___is_A))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;; Fact-ids: Name Eta_expand.t; Namespace Eta_expand; Name Eta_expand.A; Namespace Eta_expand; Name Eta_expand.B; Namespace Eta_expand
(assert (! (HasType Eta_expand.t
Tm_type)
:named kinding_Eta_expand.t@tok))
...
;;; Fact-ids: Name Eta_expand.t; Namespace Eta_expand; Name Eta_expand.A; Namespace Eta_expand; Name Eta_expand.B; Namespace Eta_expand
(assert (! 
;; def=Eta_expand.fst(20,5-20,6); use=Eta_expand.fst(20,5-20,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
Eta_expand.t)
(or (is-Eta_expand.A @x1)
(is-Eta_expand.B @x1)))
...
@x1
Eta_expand.t))
:qid fuel_guarded_inversion_Eta_expand.t))

:named fuel_guarded_inversion_Eta_expand.t))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Eta_expand.t; Namespace Eta_expand; Name Eta_expand.A; Namespace Eta_expand; Name Eta_expand.B; Namespace Eta_expand
(assert (! (= Eta_expand.B@tok
Eta_expand.B)
:named equality_tok_Eta_expand.B@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Eta_expand.t; Namespace Eta_expand; Name Eta_expand.A; Namespace Eta_expand; Name Eta_expand.B; Namespace Eta_expand
(assert (! (= Eta_expand.A@tok
Eta_expand.A)
:named equality_tok_Eta_expand.A@tok))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Eta_expand.uu___is_B; Namespace Eta_expand
(assert (! 
;; def=Eta_expand.fst(22,4-22,5); use=Eta_expand.fst(22,4-22,5)
(forall ((@x0 Term))
 (! (= (Eta_expand.uu___is_B @x0)
(BoxBool (is-Eta_expand.B @x0)))
 

:pattern ((Eta_expand.uu___is_B @x0))
:qid disc_equation_Eta_expand.B))

:named disc_equation_Eta_expand.B))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Eta_expand.uu___is_A; Namespace Eta_expand
(assert (! 
;; def=Eta_expand.fst(21,4-21,5); use=Eta_expand.fst(21,4-21,5)
(forall ((@x0 Term))
 (! (= (Eta_expand.uu___is_A @x0)
(BoxBool (is-Eta_expand.A @x0)))
 

:pattern ((Eta_expand.uu___is_A @x0))
:qid disc_equation_Eta_expand.A))

:named disc_equation_Eta_expand.A))
...
Eta_expand.B
Eta_expand.t))
:qid data_typing_intro_Eta_expand.B@tok))

:named data_typing_intro_Eta_expand.B@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Eta_expand.t; Namespace Eta_expand; Name Eta_expand.A; Namespace Eta_expand; Name Eta_expand.B; Namespace Eta_expand
(assert (! 
;; def=Eta_expand.fst(21,4-21,5); use=Eta_expand.fst(21,4-21,5)
...
Eta_expand.A
Eta_expand.t))
:qid data_typing_intro_Eta_expand.A@tok))

:named data_typing_intro_Eta_expand.A@tok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Eta_expand.t; Namespace Eta_expand; Name Eta_expand.A; Namespace Eta_expand; Name Eta_expand.B; Namespace Eta_expand
(assert (! (= 122
(Term_constr_id Eta_expand.t))
:named constructor_distinct_Eta_expand.t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Eta_expand.t; Namespace Eta_expand; Name Eta_expand.A; Namespace Eta_expand; Name Eta_expand.B; Namespace Eta_expand
(assert (! (= 130
(Term_constr_id Eta_expand.B))
:named constructor_distinct_Eta_expand.B))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Eta_expand.t; Namespace Eta_expand; Name Eta_expand.A; Namespace Eta_expand; Name Eta_expand.B; Namespace Eta_expand
(assert (! (= 128
(Term_constr_id Eta_expand.A))
:named constructor_distinct_Eta_expand.A))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
;;;;;;;;;;;;;;;;Assumption: Eta_expand.t__uu___haseq
;;; Fact-ids: Name Eta_expand.t__uu___haseq; Namespace Eta_expand
(assert (! (Valid (Prims.hasEq Eta_expand.t))
:named assumption_Eta_expand.t__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Eta_expand.t))
:qid Eta_expand_pretyping_e7bbf82314af0c50a80723a8fbf6ebfb))

:named Eta_expand_pretyping_e7bbf82314af0c50a80723a8fbf6ebfb))
(push) ;; push{2

; Starting query at Eta_expand.fst(24,22-26,13)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Eta_expand.t).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Type0).
;     (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(A? _) /\ ~(B? _) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let dec`
...
;; def=Prims.fst(402,27-402,88); use=Eta_expand.fst(24,22-26,13)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Eta_expand.fst(24,22-26,13)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Eta_expand.fst(24,22-26,13)
(ApplyTT @x1
@x2)
...
;; def=Eta_expand.fst(24,22-26,13); use=Eta_expand.fst(24,22-26,13)
(not 
;; def=Eta_expand.fst(24,22-26,13); use=Eta_expand.fst(24,22-26,13)
(BoxBool_proj_0 (Eta_expand.uu___is_A @x0))
)
...
(not 
;; def=Eta_expand.fst(24,22-26,13); use=Eta_expand.fst(24,22-26,13)
(BoxBool_proj_0 (Eta_expand.uu___is_B @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eta_expand.dec, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Eta_expand.A, disc_equation_Eta_expand.B, fuel_guarded_inversion_Eta_expand.t, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let dec


; <Start encoding let dec>

(declare-fun Eta_expand.dec (Term) Term)
;;;;;;;;;;;;;;;;_: t -> Type
(declare-fun Tm_arrow_1f986604337870838a6975dca5c19916 () Term)
(declare-fun Eta_expand.dec@tok () Term)

; </end encoding let dec>


; encoding sigelt let fun_a


; <Start encoding let fun_a>

(declare-fun Eta_expand.fun_a (Term Term) Term)

(declare-fun Eta_expand.fun_a@tok () Term)

; </end encoding let fun_a>


; encoding sigelt let fun_b


; <Start encoding let fun_b>

(declare-fun Eta_expand.fun_b (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.bool -> s: Prims.int -> Prims.bool
(declare-fun Tm_arrow_8aac434aca2240bc6439f9b2e584c23c () Term)
(declare-fun Eta_expand.fun_b@tok () Term)

; </end encoding let fun_b>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eta_expand.dec; Namespace Eta_expand
(assert (! 
;; def=Eta_expand.fst(24,4-24,7); use=Eta_expand.fst(24,4-24,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Eta_expand.t)
(HasType (Eta_expand.dec @x0)
Tm_type))
 

:pattern ((Eta_expand.dec @x0))
:qid typing_Eta_expand.dec))

:named typing_Eta_expand.dec))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@x0 Term))
 (! (= (Eta_expand.dec @x0)
(let ((@lb1 @x0))
(ite (is-Eta_expand.A @lb1)
Prims.int
(ite (is-Eta_expand.B @lb1)
Prims.bool
Tm_unit))))
 

:pattern ((Eta_expand.dec @x0))
:qid equation_Eta_expand.dec))

:named equation_Eta_expand.dec))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
; Starting query at Eta_expand.fst(31,43-33,14)
...
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: dec _ -> _: Prims.int -> dec _
(declare-fun Tm_arrow_49003dbae11a72f456aff6fe669caaee (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_49003dbae11a72f456aff6fe669caaee
;;; Fact-ids: 
(assert (! 
;; def=Eta_expand.fst(31,19-31,40); use=Eta_expand.fst(31,43-33,14)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_49003dbae11a72f456aff6fe669caaee @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_49003dbae11a72f456aff6fe669caaee @x0)
Tm_type))
:qid kinding_Tm_arrow_49003dbae11a72f456aff6fe669caaee))

:named kinding_Tm_arrow_49003dbae11a72f456aff6fe669caaee))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Eta_expand.fst(31,19-31,40); use=Eta_expand.fst(31,43-33,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_49003dbae11a72f456aff6fe669caaee @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_49003dbae11a72f456aff6fe669caaee @x2)))
:qid Eta_expand_pre_typing_Tm_arrow_49003dbae11a72f456aff6fe669caaee))

:named Eta_expand_pre_typing_Tm_arrow_49003dbae11a72f456aff6fe669caaee))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_49003dbae11a72f456aff6fe669caaee
;;; Fact-ids: 
(assert (! 
;; def=Eta_expand.fst(31,19-31,40); use=Eta_expand.fst(31,43-33,14)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_49003dbae11a72f456aff6fe669caaee @x1))
(and 
;; def=Eta_expand.fst(31,19-31,40); use=Eta_expand.fst(31,43-33,14)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
...
@x2)
@x3))
:qid Eta_expand_interpretation_Tm_arrow_49003dbae11a72f456aff6fe669caaee.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid Eta_expand_interpretation_Tm_arrow_49003dbae11a72f456aff6fe669caaee.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_49003dbae11a72f456aff6fe669caaee @x1)))
:qid Eta_expand_interpretation_Tm_arrow_49003dbae11a72f456aff6fe669caaee))

:named Eta_expand_interpretation_Tm_arrow_49003dbae11a72f456aff6fe669caaee))


; Encoding query formula : forall (_: Eta_expand.t).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post (_: Eta_expand.dec _ -> _: Prims.int -> Eta_expand.dec _)).
;     (forall (x: (_: Eta_expand.dec _ -> _: Prims.int -> Eta_expand.dec _)).
;         {:pattern Prims.guard_free (k x)}
;         Prims.auto_squash (k x)) ==>
;     (~(A? _) /\ ~(B? _) ==> Prims.l_False) /\
;     (_ == Eta_expand.A ==>
;       (forall (_: Eta_expand.dec _). Prims.has_type _ Prims.int) /\
;       (forall (x: Prims.int) (s: Prims.int) (_: Prims.int). Prims.has_type _ (Eta_expand.dec _))) /\
;     (~(A? _) ==>
;       _ == Eta_expand.B ==>
;       (forall (_: Eta_expand.dec _). Prims.has_type _ Prims.bool) /\
;       (forall (x: Prims.bool) (s: Prims.int) (_: Prims.bool). Prims.has_type _ (Eta_expand.dec _)))


; Context: While encoding a query
; While typechecking the top-level declaration `let choose`
...
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post (Tm_arrow_49003dbae11a72f456aff6fe669caaee @x0)))

;; def=Prims.fst(402,27-402,88); use=Eta_expand.fst(31,43-33,14)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Eta_expand.fst(31,43-33,14)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Eta_expand.fst(31,43-33,14)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=Eta_expand.fst(31,43-33,14)
(and (implies 
;; def=Eta_expand.fst(31,43-33,14); use=Eta_expand.fst(31,43-33,14)
(and 
;; def=Eta_expand.fst(31,43-33,14); use=Eta_expand.fst(31,43-33,14)
(not 
;; def=Eta_expand.fst(31,43-33,14); use=Eta_expand.fst(31,43-33,14)
...
;; def=dummy(0,0-0,0); use=Eta_expand.fst(32,9-32,14)
(and 
;; def=dummy(0,0-0,0); use=Eta_expand.fst(32,9-32,14)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
;; def=Eta_expand.fst(32,9-32,14); use=Eta_expand.fst(32,9-32,14)
(or label_2
(HasType @x2
Prims.int))
)
...
(implies 
;; def=Prims.fst(389,18-389,39); use=Eta_expand.fst(31,43-33,14)
(and 
;; def=Prims.fst(389,19-389,21); use=Eta_expand.fst(31,43-33,14)
(not 
;; def=Eta_expand.fst(31,43-33,14); use=Eta_expand.fst(31,43-33,14)
(BoxBool_proj_0 (Eta_expand.uu___is_A @x0))
)
...
;; def=dummy(0,0-0,0); use=Eta_expand.fst(33,9-33,14)
(and 
;; def=dummy(0,0-0,0); use=Eta_expand.fst(33,9-33,14)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
;; def=Eta_expand.fst(33,9-33,14); use=Eta_expand.fst(33,9-33,14)
(or label_4
(HasType @x2
Prims.bool))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eta_expand.choose, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_Eta_expand.A, constructor_distinct_Eta_expand.B, disc_equation_Eta_expand.A, disc_equation_Eta_expand.B, equality_tok_Eta_expand.A@tok, equality_tok_Eta_expand.B@tok, equation_Eta_expand.dec, fuel_guarded_inversion_Eta_expand.t, projection_inverse_BoxBool_proj_0
