...
; <Start encoding let rec mult2>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun ExtTest1.mult2.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun ExtTest1.mult2.fuel_instrumented_token () Term)
(declare-fun ExtTest1.mult2 (Term Term) Term)
(declare-fun ExtTest1.mult2@tok () Term)


; </end encoding let rec mult2>


; End Externals for module ExtTest1

(push) ;; push{1

; Internals for ExtTest2


; encoding sigelt val ExtTest2.mult


; <Skipped val ExtTest2.mult/>
...
; Starting query at ExtTest2.fst(22,0-24,27)
...
(declare-fun Tm_refine_45b73744d5a318eb7327620f7120874c (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ExtTest2.fst(20,11-24,27); use=ExtTest2.fst(20,11-24,27)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_45b73744d5a318eb7327620f7120874c @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_45b73744d5a318eb7327620f7120874c @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_45b73744d5a318eb7327620f7120874c))

:named refinement_kinding_Tm_refine_45b73744d5a318eb7327620f7120874c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ExtTest2.fst(20,11-24,27); use=ExtTest2.fst(20,11-24,27)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_45b73744d5a318eb7327620f7120874c @x2))
(and (HasTypeFuel @u0
@x1
ExtTest1.nnat)
...
;; def=ExtTest2.fst(20,11-24,27); use=ExtTest2.fst(20,11-24,27)
(or 
;; def=ExtTest2.fst(22,0-24,27); use=ExtTest2.fst(22,0-24,27)
(Valid 
;; def=ExtTest2.fst(22,0-24,27); use=ExtTest2.fst(22,0-24,27)
...
;; def=ExtTest2.fst(20,11-24,27); use=ExtTest2.fst(20,11-24,27)
(and 
;; def=ExtTest2.fst(20,11-21,14); use=ExtTest2.fst(20,11-21,14)
(Valid 
;; def=ExtTest2.fst(20,11-21,14); use=ExtTest2.fst(20,11-21,14)
...
@x1
(Tm_refine_45b73744d5a318eb7327620f7120874c @x2)))
:qid refinement_interpretation_Tm_refine_45b73744d5a318eb7327620f7120874c))

:named refinement_interpretation_Tm_refine_45b73744d5a318eb7327620f7120874c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_45b73744d5a318eb7327620f7120874c
;;; Fact-ids: 
(assert (! 
;; def=ExtTest2.fst(20,11-24,27); use=ExtTest2.fst(20,11-24,27)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_45b73744d5a318eb7327620f7120874c @x0)))
(Valid (Prims.hasEq ExtTest1.nnat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_45b73744d5a318eb7327620f7120874c @x0))))
:qid haseqTm_refine_45b73744d5a318eb7327620f7120874c))

:named haseqTm_refine_45b73744d5a318eb7327620f7120874c))
(declare-fun ExtTest2.mult (Term Term) Term)

;;;;;;;;;;;;;;;;a: ExtTest1.nnat -> b: ExtTest1.nnat{a << a \/ a === a /\ b << b} -> ExtTest1.nnat
(declare-fun Tm_arrow_575e4aace508aede37b3b09acd329c01 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_575e4aace508aede37b3b09acd329c01
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_575e4aace508aede37b3b09acd329c01
Tm_type)
:named kinding_Tm_arrow_575e4aace508aede37b3b09acd329c01))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ExtTest2.fst(20,11-24,27); use=ExtTest2.fst(20,11-24,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_575e4aace508aede37b3b09acd329c01)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_575e4aace508aede37b3b09acd329c01))
:qid ExtTest2_pre_typing_Tm_arrow_575e4aace508aede37b3b09acd329c01))

:named ExtTest2_pre_typing_Tm_arrow_575e4aace508aede37b3b09acd329c01))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_575e4aace508aede37b3b09acd329c01
;;; Fact-ids: 
(assert (! 
;; def=ExtTest2.fst(20,11-24,27); use=ExtTest2.fst(20,11-24,27)
(forall ((@x0 Term))
...
ExtTest1.nnat)
(HasType @x2
(Tm_refine_45b73744d5a318eb7327620f7120874c @x1)))
...
@x1)
@x2))
:qid ExtTest2_interpretation_Tm_arrow_575e4aace508aede37b3b09acd329c01.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ExtTest2_interpretation_Tm_arrow_575e4aace508aede37b3b09acd329c01.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_575e4aace508aede37b3b09acd329c01))
:qid ExtTest2_interpretation_Tm_arrow_575e4aace508aede37b3b09acd329c01))

:named ExtTest2_interpretation_Tm_arrow_575e4aace508aede37b3b09acd329c01))
(declare-fun ExtTest2.mult@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=ExtTest2.fst(21,8-21,12); use=ExtTest2.fst(21,8-21,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT ExtTest2.mult@tok
@x0)
@x1)
(ExtTest2.mult @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT ExtTest2.mult@tok
@x0)
@x1))
:qid token_correspondence_ExtTest2.mult))

:named token_correspondence_ExtTest2.mult))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=ExtTest2.fst(21,8-21,12); use=ExtTest2.fst(21,8-21,12)
...
:pattern ((ExtTest2.mult @x1
@x2))
:qid function_token_typing_ExtTest2.mult.1))
)
 

:pattern ((ApplyTT @x0
ExtTest2.mult@tok))
:qid function_token_typing_ExtTest2.mult))

:named function_token_typing_ExtTest2.mult))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=ExtTest2.fst(21,8-21,12); use=ExtTest2.fst(21,8-21,12)
...
ExtTest1.nnat)
(HasType @x1
(Tm_refine_45b73744d5a318eb7327620f7120874c @x0)))
(HasType (ExtTest2.mult @x0
@x1)
ExtTest1.nnat))
 

:pattern ((ExtTest2.mult @x0
@x1))
:qid typing_ExtTest2.mult))

:named typing_ExtTest2.mult))
...
;; def=Prims.fst(402,27-402,88); use=ExtTest2.fst(22,0-24,27)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=ExtTest2.fst(22,0-24,27)
(Valid 
;; def=Prims.fst(402,84-402,87); use=ExtTest2.fst(22,0-24,27)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=ExtTest2.fst(22,0-24,27)
(and (implies 
;; def=ExtTest2.fst(21,13-21,14); use=ExtTest2.fst(22,6-22,7)
(and 
;; def=ExtTest2.fst(21,13-21,14); use=ExtTest2.fst(22,6-22,7)
(not 
;; def=ExtTest2.fst(21,13-21,14); use=ExtTest2.fst(22,6-22,7)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=ExtTest2.fst(22,0-24,27)
(not 
;; def=ExtTest2.fst(21,13-21,14); use=ExtTest2.fst(22,6-22,7)
(BoxBool_proj_0 (ExtTest1.uu___is_O x_a8b5e426a09ec12a88cf341e4c26379c_0))
)
...
;; def=Prims.fst(413,99-413,120); use=ExtTest2.fst(22,0-24,27)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
ExtTest1.nnat)

;; def=ExtTest2.fst(21,13-24,6); use=ExtTest2.fst(22,6-24,6)
(= x_a8b5e426a09ec12a88cf341e4c26379c_0
(ExtTest1.S @x1))
)

;; def=ExtTest2.fst(20,11-24,27); use=ExtTest2.fst(24,25-24,26)
(or label_2

;; def=ExtTest2.fst(22,0-24,27); use=ExtTest2.fst(24,25-24,26)
(Valid 
;; def=ExtTest2.fst(22,0-24,27); use=ExtTest2.fst(24,25-24,26)
(Prims.precedes ExtTest1.nnat
ExtTest1.nnat
...
;; def=ExtTest2.fst(20,11-24,27); use=ExtTest2.fst(24,25-24,26)
(and 
;; def=ExtTest2.fst(20,11-21,14); use=ExtTest2.fst(24,25-24,26)
(Valid 
;; def=ExtTest2.fst(20,11-21,14); use=ExtTest2.fst(24,25-24,26)
(Prims.op_Equals_Equals_Equals ExtTest1.nnat
ExtTest1.nnat
