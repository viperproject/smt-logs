...
; encoding sigelt type ExtTest1.nnat


; <Start encoding type ExtTest1.nnat>

;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.nnat () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.O () Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.O
(declare-fun ExtTest1.O@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.S (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.S__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.S
(declare-fun ExtTest1.S@tok () Term)
;;;;;;;;;;;;;;;;_0: nnat -> nnat
(declare-fun Tm_arrow_42294e4353333a6dad8cbf746305d72a () Term)

; <start constructor ExtTest1.nnat>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.nnat ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
118)
(= __@x0
ExtTest1.nnat)))

; </end constructor ExtTest1.nnat>


; <start constructor ExtTest1.O>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.O ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
ExtTest1.O)))

; </end constructor ExtTest1.O>


; <start constructor ExtTest1.S>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.S ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
126)
(= __@x0
(ExtTest1.S (ExtTest1.S__0 __@x0)))))

; </end constructor ExtTest1.S>


; </end encoding type ExtTest1.nnat>
...
;;; Fact-ids: Name ExtTest1.nnat; Namespace ExtTest1; Name ExtTest1.O; Namespace ExtTest1; Name ExtTest1.S; Namespace ExtTest1
(assert (! (HasType ExtTest1.O@tok
ExtTest1.nnat)
:named typing_tok_ExtTest1.O@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name ExtTest1.nnat; Namespace ExtTest1; Name ExtTest1.O; Namespace ExtTest1; Name ExtTest1.S; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(22,2-22,3); use=ExtTest1.fst(22,2-22,3)
...
(ExtTest1.S @x1)
ExtTest1.nnat))
:qid subterm_ordering_ExtTest1.S))

:named subterm_ordering_ExtTest1.S))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=ExtTest1.fst(22,2-22,3); use=ExtTest1.fst(22,2-22,3)
(forall ((@x0 Term))
 (! (= (ExtTest1.S__0 (ExtTest1.S @x0))
@x0)
 

:pattern ((ExtTest1.S @x0))
:qid projection_inverse_ExtTest1.S__0))

:named projection_inverse_ExtTest1.S__0))
;;; Fact-ids: Name ExtTest1.nnat; Namespace ExtTest1; Name ExtTest1.O; Namespace ExtTest1; Name ExtTest1.S; Namespace ExtTest1
(assert (! (HasType ExtTest1.nnat
Tm_type)
:named kinding_ExtTest1.nnat@tok))
...
;;; Fact-ids: Name ExtTest1.nnat; Namespace ExtTest1; Name ExtTest1.O; Namespace ExtTest1; Name ExtTest1.S; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(20,5-20,9); use=ExtTest1.fst(20,5-20,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
ExtTest1.nnat)
...
@x1
ExtTest1.nnat))
:qid fuel_guarded_inversion_ExtTest1.nnat))

:named fuel_guarded_inversion_ExtTest1.nnat))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name ExtTest1.nnat; Namespace ExtTest1; Name ExtTest1.O; Namespace ExtTest1; Name ExtTest1.S; Namespace ExtTest1
(assert (! (= ExtTest1.O@tok
ExtTest1.O)
:named equality_tok_ExtTest1.O@tok))
...
(ExtTest1.S @x1)
ExtTest1.nnat))
:qid data_typing_intro_ExtTest1.S@tok))

:named data_typing_intro_ExtTest1.S@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.nnat; Namespace ExtTest1; Name ExtTest1.O; Namespace ExtTest1; Name ExtTest1.S; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(21,2-21,3); use=ExtTest1.fst(21,2-21,3)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
ExtTest1.O
ExtTest1.nnat)
...
ExtTest1.O
ExtTest1.nnat))
:qid data_typing_intro_ExtTest1.O@tok))

:named data_typing_intro_ExtTest1.O@tok))
...
(ExtTest1.S @x1)
ExtTest1.nnat))
:qid data_elim_ExtTest1.S))

:named data_elim_ExtTest1.S))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name ExtTest1.nnat; Namespace ExtTest1; Name ExtTest1.O; Namespace ExtTest1; Name ExtTest1.S; Namespace ExtTest1
(assert (! (= 118
(Term_constr_id ExtTest1.nnat))
:named constructor_distinct_ExtTest1.nnat))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.nnat; Namespace ExtTest1; Name ExtTest1.O; Namespace ExtTest1; Name ExtTest1.S; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(22,2-22,3); use=ExtTest1.fst(22,2-22,3)
(forall ((@x0 Term))
 (! (= 126
(Term_constr_id (ExtTest1.S @x0)))
 

:pattern ((ExtTest1.S @x0))
:qid constructor_distinct_ExtTest1.S))

:named constructor_distinct_ExtTest1.S))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.nnat; Namespace ExtTest1; Name ExtTest1.O; Namespace ExtTest1; Name ExtTest1.S; Namespace ExtTest1
(assert (! (= 124
(Term_constr_id ExtTest1.O))
:named constructor_distinct_ExtTest1.O))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
ExtTest1.nnat))
:qid ExtTest1_pretyping_a8b5e426a09ec12a88cf341e4c26379c))

:named ExtTest1_pretyping_a8b5e426a09ec12a88cf341e4c26379c))
(push) ;; push{4

; Starting query at ExtTest1.fst(20,0-22,18)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq ExtTest1.nnat ==>
; (forall (_0: ExtTest1.nnat).
...
; *)
;     Prims.hasEq ExtTest1.nnat)


; Context: While encoding a query
; While typechecking the top-level declaration `type ExtTest1.nnat`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=ExtTest1.fst(20,0-22,18); use=ExtTest1.fst(20,0-22,18)
(Valid 
;; def=ExtTest1.fst(20,0-22,18); use=ExtTest1.fst(20,0-22,18)
(Prims.hasEq ExtTest1.nnat)
)
...
;; def=ExtTest1.fst(20,0-22,18); use=ExtTest1.fst(22,6-22,10)
(or label_1
...
; encoding sigelt assume ExtTest1.nnat__uu___haseq


; <Start encoding assume ExtTest1.nnat__uu___haseq>


; </end encoding assume ExtTest1.nnat__uu___haseq>


; encoding sigelt val ExtTest1.uu___is_O


; <Start encoding val ExtTest1.uu___is_O>

(declare-fun ExtTest1.uu___is_O (Term) Term)
;;;;;;;;;;;;;;;;projectee: nnat -> Prims.bool
(declare-fun Tm_arrow_6463aff4ae9a3f81a99daeb9c49f9eda () Term)
(declare-fun ExtTest1.uu___is_O@tok () Term)

; </end encoding val ExtTest1.uu___is_O>
...
; encoding sigelt val ExtTest1.uu___is_S


; <Start encoding val ExtTest1.uu___is_S>

(declare-fun ExtTest1.uu___is_S (Term) Term)

(declare-fun ExtTest1.uu___is_S@tok () Term)

; </end encoding val ExtTest1.uu___is_S>
...
; encoding sigelt val ExtTest1.__proj__S__item___0


; <Start encoding val ExtTest1.__proj__S__item___0>

(declare-fun Tm_refine_ebb12e78d2982b25bfce9a6693f3553b () Term)
(declare-fun ExtTest1.__proj__S__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: nnat{S? _} -> nnat
(declare-fun Tm_arrow_702e3d0e61221508281111f4c9757e67 () Term)
(declare-fun ExtTest1.__proj__S__item___0@tok () Term)

; </end encoding val ExtTest1.__proj__S__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ExtTest1.uu___is_S; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(22,2-22,3); use=ExtTest1.fst(22,2-22,3)
(forall ((@x0 Term))
 (! (implies (HasType @x0
ExtTest1.nnat)
(HasType (ExtTest1.uu___is_S @x0)
Prims.bool))
 

:pattern ((ExtTest1.uu___is_S @x0))
:qid typing_ExtTest1.uu___is_S))

:named typing_ExtTest1.uu___is_S))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ExtTest1.nnat; Namespace ExtTest1; Name ExtTest1.O; Namespace ExtTest1; Name ExtTest1.S; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(22,2-22,3); use=ExtTest1.fst(22,2-22,3)
...
:named refinement_kinding_Tm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ExtTest1.__proj__S__item___0; Namespace ExtTest1
(assert (! (HasType Tm_refine_ebb12e78d2982b25bfce9a6693f3553b
Tm_type)
:named refinement_kinding_Tm_refine_ebb12e78d2982b25bfce9a6693f3553b))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ebb12e78d2982b25bfce9a6693f3553b)
(and (HasTypeFuel @u0
@x1
ExtTest1.nnat)

;; def=ExtTest1.fst(22,2-22,3); use=ExtTest1.fst(22,2-22,3)
(BoxBool_proj_0 (ExtTest1.uu___is_S @x1))
))
...
@x1
Tm_refine_ebb12e78d2982b25bfce9a6693f3553b))
:qid refinement_interpretation_Tm_refine_ebb12e78d2982b25bfce9a6693f3553b))

:named refinement_interpretation_Tm_refine_ebb12e78d2982b25bfce9a6693f3553b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
;; def=Prims.fst(304,12-304,41); use=Prims.fst(304,12-304,41)
...
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ebb12e78d2982b25bfce9a6693f3553b
;;; Fact-ids: Name ExtTest1.__proj__S__item___0; Namespace ExtTest1
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ebb12e78d2982b25bfce9a6693f3553b))
(Valid (Prims.hasEq ExtTest1.nnat)))
:named haseqTm_refine_ebb12e78d2982b25bfce9a6693f3553b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
(Valid (Prims.hasEq Tm_type)))
...
;; def=ExtTest1.fst(22,2-22,3); use=ExtTest1.fst(22,2-22,3)
(forall ((@x0 Term))
 (! (= (ExtTest1.uu___is_S @x0)
(BoxBool (is-ExtTest1.S @x0)))
 

:pattern ((ExtTest1.uu___is_S @x0))
:qid disc_equation_ExtTest1.S))

:named disc_equation_ExtTest1.S))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: ExtTest1.nnat__uu___haseq
;;; Fact-ids: Name ExtTest1.nnat__uu___haseq; Namespace ExtTest1
(assert (! (Valid (Prims.hasEq ExtTest1.nnat))
:named assumption_ExtTest1.nnat__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Encoding query formula : forall (projectee: _: ExtTest1.nnat{S? _}).
...
(not 
;; def=ExtTest1.fst(22,2-22,3); use=ExtTest1.fst(22,2-22,3)
(BoxBool_proj_0 (ExtTest1.uu___is_S @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.__proj__S__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_ebb12e78d2982b25bfce9a6693f3553b
...
; encoding sigelt val ExtTest1.isPositive


; <Skipped val ExtTest1.isPositive/>


; encoding sigelt let isPositive


; <Start encoding let isPositive>

(declare-fun ExtTest1.isPositive (Term) Term)

(declare-fun ExtTest1.isPositive@tok () Term)

; </end encoding let isPositive>
...
(declare-fun ExtTest1.idnat (Term) Term)

(declare-fun ExtTest1.idnat@tok () Term)
...
(declare-fun ExtTest1.idnat2 (Term) Term)

(declare-fun ExtTest1.idnat2@tok () Term)
...
(declare-fun ExtTest1.id (Term Term) Term)

(declare-fun ExtTest1.id@tok () Term)
...
(declare-fun ExtTest1.idp (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: _ -> _
(declare-fun Tm_arrow_c526915b1fc00c73866b6fc021418608 () Term)
(declare-fun ExtTest1.idp@tok () Term)
...
(declare-fun ExtTest1.idp_ (Term Term) Term)

(declare-fun ExtTest1.idp_@tok () Term)
...
(declare-fun ExtTest1.add1 (Term) Term)

(declare-fun ExtTest1.add1@tok () Term)
...
(declare-fun ExtTest1.add2 (Term) Term)

(declare-fun ExtTest1.add2@tok () Term)
...
(declare-fun ExtTest1.eval_order (Term Term) Term)
...
(declare-fun ExtTest1.eval_order@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ExtTest1.uu___is_O; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(21,2-21,3); use=ExtTest1.fst(21,2-21,3)
(forall ((@x0 Term))
 (! (implies (HasType @x0
ExtTest1.nnat)
(HasType (ExtTest1.uu___is_O @x0)
Prims.bool))
 

:pattern ((ExtTest1.uu___is_O @x0))
:qid typing_ExtTest1.uu___is_O))

:named typing_ExtTest1.uu___is_O))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;; def=ExtTest1.fst(21,2-21,3); use=ExtTest1.fst(21,2-21,3)
(forall ((@x0 Term))
 (! (= (ExtTest1.uu___is_O @x0)
(BoxBool (is-ExtTest1.O @x0)))
 

:pattern ((ExtTest1.uu___is_O @x0))
:qid disc_equation_ExtTest1.O))

:named disc_equation_ExtTest1.O))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
; Starting query at ExtTest1.fst(51,11-53,12)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: ExtTest1.nnat).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post ExtTest1.nnat).
;     (forall (x: ExtTest1.nnat). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
...
(Prims.pure_post ExtTest1.nnat))

;; def=Prims.fst(402,27-402,88); use=ExtTest1.fst(51,11-53,12)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=ExtTest1.fst(51,11-53,12)
(Valid 
;; def=Prims.fst(402,84-402,87); use=ExtTest1.fst(51,11-53,12)
(ApplyTT @x1
@x2)
...
;; def=ExtTest1.fst(51,11-53,12); use=ExtTest1.fst(51,11-53,12)
(not 
;; def=ExtTest1.fst(51,11-53,12); use=ExtTest1.fst(51,11-53,12)
(BoxBool_proj_0 (ExtTest1.uu___is_O @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.prev, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_ExtTest1.O, disc_equation_ExtTest1.S, fuel_guarded_inversion_ExtTest1.nnat, projection_inverse_BoxBool_proj_0
...
(declare-fun ExtTest1.prev (Term) Term)

(declare-fun ExtTest1.prev@tok () Term)

; </end encoding let prev>


; encoding sigelt val ExtTest1.add


; <Skipped val ExtTest1.add/>
...
; Starting query at ExtTest1.fst(57,2-59,22)

;;;;;;;;;;;;;;;;a : ExtTest1.nnat (ExtTest1.nnat)
(declare-fun x_a8b5e426a09ec12a88cf341e4c26379c_0 () Term)
;;;;;;;;;;;;;;;;binder_x_a8b5e426a09ec12a88cf341e4c26379c_0
;;; Fact-ids: 
(assert (! (HasType x_a8b5e426a09ec12a88cf341e4c26379c_0
ExtTest1.nnat)
:named binder_x_a8b5e426a09ec12a88cf341e4c26379c_0))
;;;;;;;;;;;;;;;;b : ExtTest1.nnat (ExtTest1.nnat)
(declare-fun x_a8b5e426a09ec12a88cf341e4c26379c_1 () Term)
;;;;;;;;;;;;;;;;binder_x_a8b5e426a09ec12a88cf341e4c26379c_1
;;; Fact-ids: 
(assert (! (HasType x_a8b5e426a09ec12a88cf341e4c26379c_1
ExtTest1.nnat)
:named binder_x_a8b5e426a09ec12a88cf341e4c26379c_1))
(declare-fun Tm_refine_e280e47258bdc3c116f3d9d99b737096 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(56,12-59,22); use=ExtTest1.fst(56,12-59,22)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_e280e47258bdc3c116f3d9d99b737096 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_e280e47258bdc3c116f3d9d99b737096 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_e280e47258bdc3c116f3d9d99b737096))

:named refinement_kinding_Tm_refine_e280e47258bdc3c116f3d9d99b737096))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(56,12-59,22); use=ExtTest1.fst(56,12-59,22)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e280e47258bdc3c116f3d9d99b737096 @x2))
(and (HasTypeFuel @u0
@x1
ExtTest1.nnat)
...
;; def=ExtTest1.fst(56,12-59,22); use=ExtTest1.fst(56,12-59,22)
(or 
;; def=ExtTest1.fst(57,2-59,22); use=ExtTest1.fst(57,2-59,22)
(Valid 
;; def=ExtTest1.fst(57,2-59,22); use=ExtTest1.fst(57,2-59,22)
(Prims.precedes ExtTest1.nnat
ExtTest1.nnat
@x2
x_a8b5e426a09ec12a88cf341e4c26379c_0)
)


;; def=ExtTest1.fst(56,12-59,22); use=ExtTest1.fst(56,12-59,22)
(and 
;; def=ExtTest1.fst(56,12-56,13); use=ExtTest1.fst(56,12-56,13)
(Valid 
;; def=ExtTest1.fst(56,12-56,13); use=ExtTest1.fst(56,12-56,13)
(Prims.op_Equals_Equals_Equals ExtTest1.nnat
ExtTest1.nnat
@x2
x_a8b5e426a09ec12a88cf341e4c26379c_0)
)
...
ExtTest1.nnat
@x1
x_a8b5e426a09ec12a88cf341e4c26379c_1)
)
)
)
...
@x1
(Tm_refine_e280e47258bdc3c116f3d9d99b737096 @x2)))
:qid refinement_interpretation_Tm_refine_e280e47258bdc3c116f3d9d99b737096))

:named refinement_interpretation_Tm_refine_e280e47258bdc3c116f3d9d99b737096))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e280e47258bdc3c116f3d9d99b737096
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(56,12-59,22); use=ExtTest1.fst(56,12-59,22)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e280e47258bdc3c116f3d9d99b737096 @x0)))
(Valid (Prims.hasEq ExtTest1.nnat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e280e47258bdc3c116f3d9d99b737096 @x0))))
:qid haseqTm_refine_e280e47258bdc3c116f3d9d99b737096))

:named haseqTm_refine_e280e47258bdc3c116f3d9d99b737096))
(declare-fun ExtTest1.add (Term Term) Term)

;;;;;;;;;;;;;;;;_: nnat -> _: _: nnat{_ << a \/ _ === a /\ _ << b} -> nnat
(declare-fun Tm_arrow_3031baa275ad5da3cac89388d0854001 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3031baa275ad5da3cac89388d0854001
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3031baa275ad5da3cac89388d0854001
Tm_type)
:named kinding_Tm_arrow_3031baa275ad5da3cac89388d0854001))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(55,10-59,22); use=ExtTest1.fst(56,8-59,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3031baa275ad5da3cac89388d0854001)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_3031baa275ad5da3cac89388d0854001))
:qid ExtTest1_pre_typing_Tm_arrow_3031baa275ad5da3cac89388d0854001))

:named ExtTest1_pre_typing_Tm_arrow_3031baa275ad5da3cac89388d0854001))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3031baa275ad5da3cac89388d0854001
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(55,10-59,22); use=ExtTest1.fst(56,8-59,22)
(forall ((@x0 Term))
...
ExtTest1.nnat)
(HasType @x2
(Tm_refine_e280e47258bdc3c116f3d9d99b737096 @x1)))
...
@x1)
@x2))
:qid ExtTest1_interpretation_Tm_arrow_3031baa275ad5da3cac89388d0854001.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ExtTest1_interpretation_Tm_arrow_3031baa275ad5da3cac89388d0854001.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_3031baa275ad5da3cac89388d0854001))
:qid ExtTest1_interpretation_Tm_arrow_3031baa275ad5da3cac89388d0854001))

:named ExtTest1_interpretation_Tm_arrow_3031baa275ad5da3cac89388d0854001))
(declare-fun ExtTest1.add@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(56,8-56,11); use=ExtTest1.fst(56,8-56,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT ExtTest1.add@tok
@x0)
@x1)
(ExtTest1.add @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT ExtTest1.add@tok
@x0)
@x1))
:qid token_correspondence_ExtTest1.add))

:named token_correspondence_ExtTest1.add))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(56,8-56,11); use=ExtTest1.fst(56,8-56,11)
...
:pattern ((ExtTest1.add @x1
@x2))
:qid function_token_typing_ExtTest1.add.1))
)
 

:pattern ((ApplyTT @x0
ExtTest1.add@tok))
:qid function_token_typing_ExtTest1.add))

:named function_token_typing_ExtTest1.add))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(56,8-56,11); use=ExtTest1.fst(56,8-56,11)
...
ExtTest1.nnat)
(HasType @x1
(Tm_refine_e280e47258bdc3c116f3d9d99b737096 @x0)))
(HasType (ExtTest1.add @x0
@x1)
ExtTest1.nnat))
 

:pattern ((ExtTest1.add @x0
@x1))
:qid typing_ExtTest1.add))

:named typing_ExtTest1.add))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post ExtTest1.nnat).
;   (forall (x: ExtTest1.nnat). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(O? a) /\ ~(S? a) ==> Prims.l_False) /\
;   (~(O? a) ==> (forall (b: ExtTest1.nnat). a == ExtTest1.S b ==> b << a \/ b === a /\ b << b))
...
;; def=Prims.fst(402,27-402,88); use=ExtTest1.fst(57,2-59,22)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=ExtTest1.fst(57,2-59,22)
(Valid 
;; def=Prims.fst(402,84-402,87); use=ExtTest1.fst(57,2-59,22)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=ExtTest1.fst(57,2-59,22)
(and (implies 
;; def=ExtTest1.fst(56,12-56,13); use=ExtTest1.fst(57,8-57,9)
(and 
;; def=ExtTest1.fst(56,12-56,13); use=ExtTest1.fst(57,8-57,9)
(not 
;; def=ExtTest1.fst(56,12-56,13); use=ExtTest1.fst(57,8-57,9)
(BoxBool_proj_0 (ExtTest1.uu___is_O x_a8b5e426a09ec12a88cf341e4c26379c_0))
)
...
(not 
;; def=ExtTest1.fst(56,12-56,13); use=ExtTest1.fst(57,8-57,9)
(BoxBool_proj_0 (ExtTest1.uu___is_S x_a8b5e426a09ec12a88cf341e4c26379c_0))
)
)

label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=ExtTest1.fst(57,2-59,22)
(not 
;; def=ExtTest1.fst(56,12-56,13); use=ExtTest1.fst(57,8-57,9)
(BoxBool_proj_0 (ExtTest1.uu___is_O x_a8b5e426a09ec12a88cf341e4c26379c_0))
)
...
;; def=Prims.fst(413,99-413,120); use=ExtTest1.fst(57,2-59,22)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
ExtTest1.nnat)

;; def=ExtTest1.fst(56,12-59,6); use=ExtTest1.fst(57,8-59,6)
(= x_a8b5e426a09ec12a88cf341e4c26379c_0
(ExtTest1.S @x1))
)

;; def=ExtTest1.fst(56,12-59,22); use=ExtTest1.fst(59,20-59,21)
(or label_2

;; def=ExtTest1.fst(57,2-59,22); use=ExtTest1.fst(59,20-59,21)
(Valid 
;; def=ExtTest1.fst(57,2-59,22); use=ExtTest1.fst(59,20-59,21)
(Prims.precedes ExtTest1.nnat
ExtTest1.nnat
...
;; def=ExtTest1.fst(56,12-59,22); use=ExtTest1.fst(59,20-59,21)
(and 
;; def=ExtTest1.fst(56,12-56,13); use=ExtTest1.fst(59,20-59,21)
(Valid 
;; def=ExtTest1.fst(56,12-56,13); use=ExtTest1.fst(59,20-59,21)
(Prims.op_Equals_Equals_Equals ExtTest1.nnat
ExtTest1.nnat
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.add, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, ExtTest1_pretyping_a8b5e426a09ec12a88cf341e4c26379c, binder_x_a8b5e426a09ec12a88cf341e4c26379c_0, disc_equation_ExtTest1.O, disc_equation_ExtTest1.S, equality_tok_ExtTest1.O@tok, fuel_guarded_inversion_ExtTest1.nnat, projection_inverse_BoxBool_proj_0, projection_inverse_ExtTest1.S__0, subterm_ordering_ExtTest1.S, typing_tok_ExtTest1.O@tok
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun ExtTest1.add.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun ExtTest1.add.fuel_instrumented_token () Term)
(declare-fun ExtTest1.add (Term Term) Term)
(declare-fun ExtTest1.add@tok () Term)
;;;;;;;;;;;;;;;;a: nnat -> b: nnat -> nnat
(declare-fun Tm_arrow_d2021ca9d303ff535b915bfbda99b85c () Term)
...
; encoding sigelt type ExtTest1.prod


; <Start encoding type ExtTest1.prod>

;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.prod (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun ExtTest1.prod@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.Pair (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Pair__a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Pair__b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Pair_fst (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Pair_snd (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.Pair
(declare-fun ExtTest1.Pair@tok () Term)
;;;;;;;;;;;;;;;;fst: 'a -> snd: 'b -> prod 'a 'b
(declare-fun Tm_arrow_e1348bc32f347abc04924eb7ee814462 () Term)

; <start constructor ExtTest1.prod>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.prod ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
201)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
;;no pats
:qid is-ExtTest1.prod))))

; </end constructor ExtTest1.prod>


; <start constructor ExtTest1.Pair>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.Pair ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
208)
(= __@x0
(ExtTest1.Pair (ExtTest1.Pair__a __@x0)
(ExtTest1.Pair__b __@x0)
(ExtTest1.Pair_fst __@x0)
(ExtTest1.Pair_snd __@x0)))))

; </end constructor ExtTest1.Pair>


; </end encoding type ExtTest1.prod>

;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT ExtTest1.prod@tok
@x0)
@x1)
(ExtTest1.prod @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT ExtTest1.prod@tok
@x0)
@x1))

:pattern ((ExtTest1.prod @x0
@x1))
:qid token_correspondence_ExtTest1.prod@tok))

:named token_correspondence_ExtTest1.prod@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
...
(ExtTest1.prod @x5
@x6)))
:qid subterm_ordering_ExtTest1.Pair))

:named subterm_ordering_ExtTest1.Pair))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ExtTest1.Pair_snd (ExtTest1.Pair @x0
@x1
@x2
@x3))
@x3)
...
:pattern ((ExtTest1.Pair @x0
@x1
@x2
@x3))
:qid projection_inverse_ExtTest1.Pair_snd))

:named projection_inverse_ExtTest1.Pair_snd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ExtTest1.Pair_fst (ExtTest1.Pair @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_ExtTest1.Pair_fst))

:named projection_inverse_ExtTest1.Pair_fst))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ExtTest1.Pair__b (ExtTest1.Pair @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_ExtTest1.Pair__b))

:named projection_inverse_ExtTest1.Pair__b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ExtTest1.Pair__a (ExtTest1.Pair @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_ExtTest1.Pair__a))

:named projection_inverse_ExtTest1.Pair__a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! (is-Tm_arrow (PreType ExtTest1.prod@tok))
:named pre_kinding_ExtTest1.prod@tok))
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! (and (IsTotFun ExtTest1.prod@tok)

;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT ExtTest1.prod@tok
@x0))
 

:pattern ((ApplyTT ExtTest1.prod@tok
@x0))
:qid kinding_ExtTest1.prod@tok))
...
:pattern ((ExtTest1.prod @x0
@x1))
:qid kinding_ExtTest1.prod@tok.1))
)
:named kinding_ExtTest1.prod@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
...
(ExtTest1.prod @x2
@x3)))
:qid fuel_guarded_inversion_ExtTest1.prod))

:named fuel_guarded_inversion_ExtTest1.prod))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! (= 202
(Term_constr_id ExtTest1.prod@tok))
:named fresh_token_ExtTest1.prod@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
...
(ExtTest1.prod @x1
@x2)))
:qid data_typing_intro_ExtTest1.Pair@tok))

:named data_typing_intro_ExtTest1.Pair@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
...
(ExtTest1.prod @x5
@x6)))
:qid data_elim_ExtTest1.Pair))

:named data_elim_ExtTest1.Pair))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= 201
(Term_constr_id (ExtTest1.prod @x0
@x1)))
 

:pattern ((ExtTest1.prod @x0
@x1))
:qid constructor_distinct_ExtTest1.prod))

:named constructor_distinct_ExtTest1.prod))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 208
(Term_constr_id (ExtTest1.Pair @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_ExtTest1.Pair))

:named constructor_distinct_ExtTest1.Pair))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
...
(ExtTest1.prod @x2
@x3)))
:qid ExtTest1_pretyping_50067959dbfd2275fe8f4666b5b5e143))

:named ExtTest1_pretyping_50067959dbfd2275fe8f4666b5b5e143))
(push) ;; push{4

; Starting query at ExtTest1.fst(62,0-63,41)
...
;   (forall ('a: Type) ('b: Type). {:pattern Prims.hasEq (ExtTest1.prod 'a 'b)}
;       Prims.hasEq 'a /\ Prims.hasEq 'b ==> Prims.hasEq (ExtTest1.prod 'a 'b)) ==>
;   (forall (fst: 'a) (snd: 'b). Prims.hasEq 'a /\ Prims.hasEq 'b)


; Context: While encoding a query
; While typechecking the top-level declaration `type ExtTest1.prod`
...
;; def=ExtTest1.fst(62,0-63,41); use=ExtTest1.fst(62,0-63,41)
(Valid 
;; def=ExtTest1.fst(62,0-63,41); use=ExtTest1.fst(62,0-63,41)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=ExtTest1.fst(62,0-63,41); use=ExtTest1.fst(62,0-63,41)
(Prims.hasEq (ExtTest1.prod @x2
@x3))
)
)
 

:pattern ((Prims.hasEq (ExtTest1.prod @x2
@x3)))
:qid @query.1))
)
...
;; def=ExtTest1.fst(62,0-63,41); use=ExtTest1.fst(62,0-63,41)
(and 
;; def=ExtTest1.fst(62,0-63,41); use=ExtTest1.fst(63,13-63,15)
(or label_1
...
;; def=ExtTest1.fst(62,0-63,41); use=ExtTest1.fst(63,23-63,25)
(or label_2
...
; encoding sigelt assume ExtTest1.prod__uu___haseq


; <Start encoding assume ExtTest1.prod__uu___haseq>


; </end encoding assume ExtTest1.prod__uu___haseq>


; encoding sigelt val ExtTest1.uu___is_Pair


; <Start encoding val ExtTest1.uu___is_Pair>

(declare-fun ExtTest1.uu___is_Pair (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: prod 'a 'b -> Prims.bool
(declare-fun Tm_arrow_bd46262785a3d4321c4a4b0682a5ccf5 () Term)
(declare-fun ExtTest1.uu___is_Pair@tok () Term)

; </end encoding val ExtTest1.uu___is_Pair>
...
; encoding sigelt val ExtTest1.__proj__Pair__item__fst


; <Start encoding val ExtTest1.__proj__Pair__item__fst>

(declare-fun ExtTest1.__proj__Pair__item__fst (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: prod 'a 'b -> 'a
(declare-fun Tm_arrow_5bf3656325bb594670d665a01ee200fe () Term)
(declare-fun ExtTest1.__proj__Pair__item__fst@tok () Term)

; </end encoding val ExtTest1.__proj__Pair__item__fst>


; encoding sigelt let __proj__Pair__item__fst


; <Skipped let __proj__Pair__item__fst/>


; encoding sigelt val ExtTest1.__proj__Pair__item__snd


; <Start encoding val ExtTest1.__proj__Pair__item__snd>

(declare-fun ExtTest1.__proj__Pair__item__snd (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: prod 'a 'b -> 'b
(declare-fun Tm_arrow_428674380c61b2042a0fe05af14efef5 () Term)
(declare-fun ExtTest1.__proj__Pair__item__snd@tok () Term)

; </end encoding val ExtTest1.__proj__Pair__item__snd>


; encoding sigelt let __proj__Pair__item__snd


; <Skipped let __proj__Pair__item__snd/>
...
; encoding sigelt type ExtTest1.list


; <Start encoding type ExtTest1.list>

;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.list (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun ExtTest1.list@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.Nil (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Nil_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.Nil
(declare-fun ExtTest1.Nil@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.Cons (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.Cons
(declare-fun ExtTest1.Cons@tok () Term)
;;;;;;;;;;;;;;;;list a
(declare-fun Tm_arrow_33209723efa3d4e7c9dcab5685b9c272 () Term)
;;;;;;;;;;;;;;;;hd: a -> tl: list a -> list a
(declare-fun Tm_arrow_83428e13b3cb8cfec023990380e041d5 () Term)

; <start constructor ExtTest1.list>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.list ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
245)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-ExtTest1.list))))

; </end constructor ExtTest1.list>


; <start constructor ExtTest1.Nil>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.Nil ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
252)
(= __@x0
(ExtTest1.Nil (ExtTest1.Nil_a __@x0)))))

; </end constructor ExtTest1.Nil>


; <start constructor ExtTest1.Cons>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.Cons ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
257)
(= __@x0
(ExtTest1.Cons (ExtTest1.Cons_a __@x0)
(ExtTest1.Cons_hd __@x0)
(ExtTest1.Cons_tl __@x0)))))

; </end constructor ExtTest1.Cons>


; </end encoding type ExtTest1.list>

;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(65,5-65,9); use=ExtTest1.fst(65,5-65,9)
(forall ((@x0 Term))
 (! (= (ApplyTT ExtTest1.list@tok
@x0)
(ExtTest1.list @x0))
 

:pattern ((ApplyTT ExtTest1.list@tok
@x0))

:pattern ((ExtTest1.list @x0))
:qid token_correspondence_ExtTest1.list@tok))

:named token_correspondence_ExtTest1.list@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(ExtTest1.Cons @x1
@x2
...
@x3)
(ExtTest1.list @x4)))
:qid subterm_ordering_ExtTest1.Cons))

:named subterm_ordering_ExtTest1.Cons))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(66,4-66,7); use=ExtTest1.fst(66,4-66,7)
(forall ((@x0 Term))
 (! (= (ExtTest1.Nil_a (ExtTest1.Nil @x0))
@x0)
 

:pattern ((ExtTest1.Nil @x0))
:qid projection_inverse_ExtTest1.Nil_a))

:named projection_inverse_ExtTest1.Nil_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.Cons_tl (ExtTest1.Cons @x0
@x1
@x2))
@x2)
 

:pattern ((ExtTest1.Cons @x0
@x1
@x2))
:qid projection_inverse_ExtTest1.Cons_tl))

:named projection_inverse_ExtTest1.Cons_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.Cons_hd (ExtTest1.Cons @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_ExtTest1.Cons_hd))

:named projection_inverse_ExtTest1.Cons_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.Cons_a (ExtTest1.Cons @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_ExtTest1.Cons_a))

:named projection_inverse_ExtTest1.Cons_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! (is-Tm_arrow (PreType ExtTest1.list@tok))
:named pre_kinding_ExtTest1.list@tok))
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! (and (IsTotFun ExtTest1.list@tok)

;; def=ExtTest1.fst(65,5-65,9); use=ExtTest1.fst(65,5-65,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (ExtTest1.list @x0)
Tm_type))
 

:pattern ((ExtTest1.list @x0))
:qid kinding_ExtTest1.list@tok))
)
:named kinding_ExtTest1.list@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(65,5-65,9); use=ExtTest1.fst(65,5-65,9)
...
@x1
(ExtTest1.list @x2))
(or (and (is-ExtTest1.Nil @x1)
(= @x2
(ExtTest1.Nil_a @x1)))
(and (is-ExtTest1.Cons @x1)
(= @x2
(ExtTest1.Cons_a @x1)))))
...
@x1
(ExtTest1.list @x2)))
:qid fuel_guarded_inversion_ExtTest1.list))

:named fuel_guarded_inversion_ExtTest1.list))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! (= 246
(Term_constr_id ExtTest1.list@tok))
:named fresh_token_ExtTest1.list@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(66,4-66,7); use=ExtTest1.fst(66,4-66,7)
...
(ExtTest1.Nil @x1)
(ExtTest1.list @x1)))
:qid data_typing_intro_ExtTest1.Nil@tok))

:named data_typing_intro_ExtTest1.Nil@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
...
@x3)
(ExtTest1.list @x1)))
:qid data_typing_intro_ExtTest1.Cons@tok))

:named data_typing_intro_ExtTest1.Cons@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(66,4-66,7); use=ExtTest1.fst(66,4-66,7)
...
(ExtTest1.Nil @x1)
(ExtTest1.list @x2)))
:qid data_elim_ExtTest1.Nil))

:named data_elim_ExtTest1.Nil))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
...
@x3)
(ExtTest1.list @x4)))
:qid data_elim_ExtTest1.Cons))

:named data_elim_ExtTest1.Cons))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(65,5-65,9); use=ExtTest1.fst(65,5-65,9)
(forall ((@x0 Term))
 (! (= 245
(Term_constr_id (ExtTest1.list @x0)))
 

:pattern ((ExtTest1.list @x0))
:qid constructor_distinct_ExtTest1.list))

:named constructor_distinct_ExtTest1.list))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(66,4-66,7); use=ExtTest1.fst(66,4-66,7)
(forall ((@x0 Term))
 (! (= 252
(Term_constr_id (ExtTest1.Nil @x0)))
 

:pattern ((ExtTest1.Nil @x0))
:qid constructor_distinct_ExtTest1.Nil))

:named constructor_distinct_ExtTest1.Nil))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 257
(Term_constr_id (ExtTest1.Cons @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_ExtTest1.Cons))

:named constructor_distinct_ExtTest1.Cons))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(65,5-65,9); use=ExtTest1.fst(65,5-65,9)
...
@x0
(ExtTest1.list @x2)))
:qid ExtTest1_pretyping_445c06aac6f91fa3e1187dd59f433674))

:named ExtTest1_pretyping_445c06aac6f91fa3e1187dd59f433674))
(push) ;; push{4

; Starting query at ExtTest1.fst(65,0-67,38)
...
;   Prims.hasEq a /\
;   (forall (a: Type). {:pattern Prims.hasEq (ExtTest1.list a)}
;       Prims.hasEq a ==> Prims.hasEq (ExtTest1.list a)) ==>
;   (forall (hd: a) (tl: ExtTest1.list a). Prims.hasEq a /\ Prims.hasEq (ExtTest1.list a))


; Context: While encoding a query
; While typechecking the top-level declaration `type ExtTest1.list`
...
;; def=ExtTest1.fst(65,0-67,38); use=ExtTest1.fst(65,0-67,38)
(Valid 
;; def=ExtTest1.fst(65,0-67,38); use=ExtTest1.fst(65,0-67,38)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=ExtTest1.fst(65,0-67,38); use=ExtTest1.fst(65,0-67,38)
(Prims.hasEq (ExtTest1.list @x1))
)
)
 

:pattern ((Prims.hasEq (ExtTest1.list @x1)))
:qid @query.1))
)
...
;; def=ExtTest1.fst(65,0-67,38); use=ExtTest1.fst(65,0-67,38)
(and 
;; def=ExtTest1.fst(65,0-67,38); use=ExtTest1.fst(67,14-67,15)
(or label_1
...
;; def=ExtTest1.fst(65,0-67,38); use=ExtTest1.fst(67,22-67,28)
(or label_2

;; def=ExtTest1.fst(65,0-67,38); use=ExtTest1.fst(65,0-67,38)
(Valid 
;; def=ExtTest1.fst(65,0-67,38); use=ExtTest1.fst(65,0-67,38)
(Prims.hasEq (ExtTest1.list @x0))
)
)
)
)
...
; encoding sigelt assume ExtTest1.list__uu___haseq


; <Start encoding assume ExtTest1.list__uu___haseq>


; </end encoding assume ExtTest1.list__uu___haseq>


; encoding sigelt val ExtTest1.uu___is_Nil


; <Start encoding val ExtTest1.uu___is_Nil>

(declare-fun ExtTest1.uu___is_Nil (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: list a -> Prims.bool
(declare-fun Tm_arrow_2469f4acaf989cbfe1404af4183bf6df () Term)
(declare-fun ExtTest1.uu___is_Nil@tok () Term)

; </end encoding val ExtTest1.uu___is_Nil>
...
; encoding sigelt val ExtTest1.uu___is_Cons


; <Start encoding val ExtTest1.uu___is_Cons>

(declare-fun ExtTest1.uu___is_Cons (Term Term) Term)

(declare-fun ExtTest1.uu___is_Cons@tok () Term)

; </end encoding val ExtTest1.uu___is_Cons>
...
; encoding sigelt val ExtTest1.__proj__Cons__item__hd


; <Start encoding val ExtTest1.__proj__Cons__item__hd>

(declare-fun Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe (Term) Term)
(declare-fun ExtTest1.__proj__Cons__item__hd (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: list a {Cons? _} -> a
(declare-fun Tm_arrow_04f870b23a22a4c382ae35b4bf194802 () Term)
(declare-fun ExtTest1.__proj__Cons__item__hd@tok () Term)

; </end encoding val ExtTest1.__proj__Cons__item__hd>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ExtTest1.uu___is_Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(ExtTest1.list @x0)))
(HasType (ExtTest1.uu___is_Cons @x0
@x1)
Prims.bool))
 

:pattern ((ExtTest1.uu___is_Cons @x0
@x1))
:qid typing_ExtTest1.uu___is_Cons))

:named typing_ExtTest1.uu___is_Cons))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(65,5-65,9); use=ExtTest1.fst(65,5-65,9)
...
:named subterm_ordering_ExtTest1.Cons))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ExtTest1.__proj__Cons__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe))

:named refinement_kinding_Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name ExtTest1.__proj__Cons__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe @x2))
(and (HasTypeFuel @u0
@x1
(ExtTest1.list @x2))

;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(BoxBool_proj_0 (ExtTest1.uu___is_Cons @x2
@x1))
))
...
@x1
(Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe @x2)))
:qid refinement_interpretation_Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe))

:named refinement_interpretation_Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(66,4-66,7); use=ExtTest1.fst(66,4-66,7)
...
:named kinding_ExtTest1.list@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe
;;; Fact-ids: Name ExtTest1.__proj__Cons__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe @x0)))
(Valid (Prims.hasEq (ExtTest1.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe @x0))))
:qid haseqTm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe))

:named haseqTm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(65,5-65,9); use=ExtTest1.fst(65,5-65,9)
...
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,4-67,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ExtTest1.uu___is_Cons @x0
@x1)
(BoxBool (is-ExtTest1.Cons @x1)))
 

:pattern ((ExtTest1.uu___is_Cons @x0
@x1))
:qid disc_equation_ExtTest1.Cons))

:named disc_equation_ExtTest1.Cons))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(66,4-66,7); use=ExtTest1.fst(66,4-66,7)
...
:named constructor_distinct_ExtTest1.Cons))
;;;;;;;;;;;;;;;;Assumption: ExtTest1.list__uu___haseq
;;; Fact-ids: Name ExtTest1.list__uu___haseq; Namespace ExtTest1
...
:pattern ((Prims.hasEq (ExtTest1.list @x0)))
:qid assumption_ExtTest1.list__uu___haseq))
:named assumption_ExtTest1.list__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ExtTest1.list; Namespace ExtTest1; Name ExtTest1.Nil; Namespace ExtTest1; Name ExtTest1.Cons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(65,5-65,9); use=ExtTest1.fst(65,5-65,9)
...
; Starting query at ExtTest1.fst(67,11-67,13)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (projectee: _: ExtTest1.list a {Cons? _}).
;   (*  - Could not prove post-condition
; *) ~(Cons? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Cons__item__hd`
...
Tm_type)
(HasType @x1
(Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe @x0))

;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,11-67,13)
(not 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,11-67,13)
(BoxBool_proj_0 (ExtTest1.uu___is_Cons @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.__proj__Cons__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe
...
; encoding sigelt let __proj__Cons__item__hd


; <Skipped let __proj__Cons__item__hd/>


; encoding sigelt val ExtTest1.__proj__Cons__item__tl


; <Start encoding val ExtTest1.__proj__Cons__item__tl>


(declare-fun ExtTest1.__proj__Cons__item__tl (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: list a {Cons? _} -> list a
(declare-fun Tm_arrow_4fed37354843b3b286bae51a906b7103 () Term)
(declare-fun ExtTest1.__proj__Cons__item__tl@tok () Term)

; </end encoding val ExtTest1.__proj__Cons__item__tl>

(push) ;; push{2

; Starting query at ExtTest1.fst(67,19-67,21)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Cons__item__tl`
...
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,19-67,21)
(not 
;; def=ExtTest1.fst(67,4-67,8); use=ExtTest1.fst(67,19-67,21)
(BoxBool_proj_0 (ExtTest1.uu___is_Cons @x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.__proj__Cons__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_faaa8f6ddeecfea62c8c5bb02293ebbe
...
; encoding sigelt let __proj__Cons__item__tl
...
(declare-fun ExtTest1.prepend0 (Term) Term)
;;;;;;;;;;;;;;;;tll: list nnat -> list nnat
(declare-fun Tm_arrow_9c7fed293d975e35c280d5428287aada () Term)
(declare-fun ExtTest1.prepend0@tok () Term)
...
; encoding sigelt type ExtTest1.list2


; <Start encoding type ExtTest1.list2>

;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.list2 (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun ExtTest1.list2@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.Nil2 (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Nil2__a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Nil2_b (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.Nil2
(declare-fun ExtTest1.Nil2@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.Cons2 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons2__a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons2_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons2_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons2_hd2 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons2_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.Cons2
(declare-fun ExtTest1.Cons2@tok () Term)
;;;;;;;;;;;;;;;;list2 'a b
(declare-fun Tm_arrow_6dea0c532cbf1297151e2384bc395086 () Term)
;;;;;;;;;;;;;;;;hd: 'a -> hd2: b -> tl: list2 'a b -> list2 'a b
(declare-fun Tm_arrow_e73590f4a28c79996a1e28e718dc34a6 () Term)

; <start constructor ExtTest1.list2>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.list2 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
309)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
;;no pats
:qid is-ExtTest1.list2))))

; </end constructor ExtTest1.list2>


; <start constructor ExtTest1.Nil2>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.Nil2 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
316)
(= __@x0
(ExtTest1.Nil2 (ExtTest1.Nil2__a __@x0)
(ExtTest1.Nil2_b __@x0)))))

; </end constructor ExtTest1.Nil2>


; <start constructor ExtTest1.Cons2>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.Cons2 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
321)
(= __@x0
(ExtTest1.Cons2 (ExtTest1.Cons2__a __@x0)
(ExtTest1.Cons2_b __@x0)
(ExtTest1.Cons2_hd __@x0)
(ExtTest1.Cons2_hd2 __@x0)
(ExtTest1.Cons2_tl __@x0)))))

; </end constructor ExtTest1.Cons2>


; </end encoding type ExtTest1.list2>

;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(71,5-71,10); use=ExtTest1.fst(71,5-71,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT ExtTest1.list2@tok
@x0)
@x1)
(ExtTest1.list2 @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT ExtTest1.list2@tok
@x0)
@x1))

:pattern ((ExtTest1.list2 @x0
@x1))
:qid token_correspondence_ExtTest1.list2@tok))

:named token_correspondence_ExtTest1.list2@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
...
(ExtTest1.list2 @x6
@x7)))
:qid subterm_ordering_ExtTest1.Cons2))

:named subterm_ordering_ExtTest1.Cons2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(72,4-72,8); use=ExtTest1.fst(72,4-72,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ExtTest1.Nil2_b (ExtTest1.Nil2 @x0
@x1))
@x1)
 

:pattern ((ExtTest1.Nil2 @x0
@x1))
:qid projection_inverse_ExtTest1.Nil2_b))

:named projection_inverse_ExtTest1.Nil2_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(72,4-72,8); use=ExtTest1.fst(72,4-72,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ExtTest1.Nil2__a (ExtTest1.Nil2 @x0
@x1))
@x0)
...
:pattern ((ExtTest1.Nil2 @x0
@x1))
:qid projection_inverse_ExtTest1.Nil2__a))

:named projection_inverse_ExtTest1.Nil2__a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ExtTest1.Cons2_tl (ExtTest1.Cons2 @x0
@x1
@x2
@x3
@x4))
...
:pattern ((ExtTest1.Cons2 @x0
@x1
@x2
@x3
@x4))
:qid projection_inverse_ExtTest1.Cons2_tl))

:named projection_inverse_ExtTest1.Cons2_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ExtTest1.Cons2_hd2 (ExtTest1.Cons2 @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_ExtTest1.Cons2_hd2))

:named projection_inverse_ExtTest1.Cons2_hd2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ExtTest1.Cons2_hd (ExtTest1.Cons2 @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_ExtTest1.Cons2_hd))

:named projection_inverse_ExtTest1.Cons2_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ExtTest1.Cons2_b (ExtTest1.Cons2 @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_ExtTest1.Cons2_b))

:named projection_inverse_ExtTest1.Cons2_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ExtTest1.Cons2__a (ExtTest1.Cons2 @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_ExtTest1.Cons2__a))

:named projection_inverse_ExtTest1.Cons2__a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! (is-Tm_arrow (PreType ExtTest1.list2@tok))
:named pre_kinding_ExtTest1.list2@tok))
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! (and (IsTotFun ExtTest1.list2@tok)

;; def=ExtTest1.fst(71,5-71,10); use=ExtTest1.fst(71,5-71,10)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT ExtTest1.list2@tok
@x0))
 

:pattern ((ApplyTT ExtTest1.list2@tok
@x0))
:qid kinding_ExtTest1.list2@tok))
...
:pattern ((ExtTest1.list2 @x0
@x1))
:qid kinding_ExtTest1.list2@tok.1))
)
:named kinding_ExtTest1.list2@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(71,5-71,10); use=ExtTest1.fst(71,5-71,10)
...
(ExtTest1.list2 @x2
@x3))
(or (and (is-ExtTest1.Nil2 @x1)
(= @x2
(ExtTest1.Nil2__a @x1))
(= @x3
(ExtTest1.Nil2_b @x1)))
(and (is-ExtTest1.Cons2 @x1)
(= @x2
(ExtTest1.Cons2__a @x1))
(= @x3
(ExtTest1.Cons2_b @x1)))))
...
(ExtTest1.list2 @x2
@x3)))
:qid fuel_guarded_inversion_ExtTest1.list2))

:named fuel_guarded_inversion_ExtTest1.list2))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! (= 310
(Term_constr_id ExtTest1.list2@tok))
:named fresh_token_ExtTest1.list2@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(72,4-72,8); use=ExtTest1.fst(72,4-72,8)
...
(ExtTest1.list2 @x1
@x2)))
:qid data_typing_intro_ExtTest1.Nil2@tok))

:named data_typing_intro_ExtTest1.Nil2@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
...
(ExtTest1.list2 @x1
@x2)))
:qid data_typing_intro_ExtTest1.Cons2@tok))

:named data_typing_intro_ExtTest1.Cons2@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(72,4-72,8); use=ExtTest1.fst(72,4-72,8)
...
(ExtTest1.list2 @x3
@x4)))
:qid data_elim_ExtTest1.Nil2))

:named data_elim_ExtTest1.Nil2))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
...
(ExtTest1.list2 @x6
@x7)))
:qid data_elim_ExtTest1.Cons2))

:named data_elim_ExtTest1.Cons2))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(71,5-71,10); use=ExtTest1.fst(71,5-71,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= 309
(Term_constr_id (ExtTest1.list2 @x0
@x1)))
 

:pattern ((ExtTest1.list2 @x0
@x1))
:qid constructor_distinct_ExtTest1.list2))

:named constructor_distinct_ExtTest1.list2))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(72,4-72,8); use=ExtTest1.fst(72,4-72,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 316
(Term_constr_id (ExtTest1.Nil2 @x0
@x1)))
 

:pattern ((ExtTest1.Nil2 @x0
@x1))
:qid constructor_distinct_ExtTest1.Nil2))

:named constructor_distinct_ExtTest1.Nil2))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= 321
(Term_constr_id (ExtTest1.Cons2 @x0
@x1
@x2
@x3
@x4)))
...
@x3
@x4))
:qid constructor_distinct_ExtTest1.Cons2))

:named constructor_distinct_ExtTest1.Cons2))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(71,5-71,10); use=ExtTest1.fst(71,5-71,10)
...
(ExtTest1.list2 @x2
@x3)))
:qid ExtTest1_pretyping_9f8acc27556255ddf1a896e39f513aef))

:named ExtTest1_pretyping_9f8acc27556255ddf1a896e39f513aef))
(push) ;; push{4

; Starting query at ExtTest1.fst(71,0-73,58)
...
; Encoding query formula : forall ('a: Type) (b: Type).
;   Prims.hasEq 'a /\ Prims.hasEq b /\
;   (forall ('a: Type) (b: Type). {:pattern Prims.hasEq (ExtTest1.list2 'a b)}
;       Prims.hasEq 'a /\ Prims.hasEq b ==> Prims.hasEq (ExtTest1.list2 'a b)) ==>
;   (forall (hd: 'a) (hd2: b) (tl: ExtTest1.list2 'a b).
;       Prims.hasEq 'a /\ Prims.hasEq b /\ Prims.hasEq (ExtTest1.list2 'a b))


; Context: While encoding a query
; While typechecking the top-level declaration `type ExtTest1.list2`
...
;; def=ExtTest1.fst(71,0-73,58); use=ExtTest1.fst(71,0-73,58)
(Valid 
;; def=ExtTest1.fst(71,0-73,58); use=ExtTest1.fst(71,0-73,58)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=ExtTest1.fst(71,0-73,58); use=ExtTest1.fst(71,0-73,58)
(Prims.hasEq (ExtTest1.list2 @x2
@x3))
)
)
 

:pattern ((Prims.hasEq (ExtTest1.list2 @x2
@x3)))
:qid @query.1))
)
...
;; def=ExtTest1.fst(71,0-73,58); use=ExtTest1.fst(71,0-73,58)
(and 
;; def=ExtTest1.fst(71,0-73,58); use=ExtTest1.fst(73,15-73,17)
(or label_1
...
;; def=ExtTest1.fst(71,0-73,58); use=ExtTest1.fst(73,25-73,26)
(or label_2
...
;; def=ExtTest1.fst(71,0-73,58); use=ExtTest1.fst(73,34-73,44)
(or label_3

;; def=ExtTest1.fst(71,0-73,58); use=ExtTest1.fst(71,0-73,58)
(Valid 
;; def=ExtTest1.fst(71,0-73,58); use=ExtTest1.fst(71,0-73,58)
(Prims.hasEq (ExtTest1.list2 @x0
@x1))
)
)
)
...
; encoding sigelt assume ExtTest1.list2__uu___haseq


; <Start encoding assume ExtTest1.list2__uu___haseq>


; </end encoding assume ExtTest1.list2__uu___haseq>


; encoding sigelt val ExtTest1.uu___is_Nil2


; <Start encoding val ExtTest1.uu___is_Nil2>

(declare-fun ExtTest1.uu___is_Nil2 (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: list2 'a b -> Prims.bool
(declare-fun Tm_arrow_fab925f2fb1b9ebc8c34009a13349411 () Term)
(declare-fun ExtTest1.uu___is_Nil2@tok () Term)

; </end encoding val ExtTest1.uu___is_Nil2>
...
; encoding sigelt val ExtTest1.uu___is_Cons2


; <Start encoding val ExtTest1.uu___is_Cons2>

(declare-fun ExtTest1.uu___is_Cons2 (Term Term Term) Term)

(declare-fun ExtTest1.uu___is_Cons2@tok () Term)

; </end encoding val ExtTest1.uu___is_Cons2>
...
; encoding sigelt val ExtTest1.__proj__Cons2__item__hd


; <Start encoding val ExtTest1.__proj__Cons2__item__hd>

(declare-fun Tm_refine_96b4a762449a5aa098e49432836a0cd9 (Term Term) Term)
(declare-fun ExtTest1.__proj__Cons2__item__hd (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: list2 'a b {Cons2? _} -> 'a
(declare-fun Tm_arrow_35d0f36188fdd0b4c35af0eb51d01c2a () Term)
(declare-fun ExtTest1.__proj__Cons2__item__hd@tok () Term)

; </end encoding val ExtTest1.__proj__Cons2__item__hd>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ExtTest1.uu___is_Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(ExtTest1.list2 @x0
@x1)))
(HasType (ExtTest1.uu___is_Cons2 @x0
@x1
@x2)
Prims.bool))
 

:pattern ((ExtTest1.uu___is_Cons2 @x0
@x1
@x2))
:qid typing_ExtTest1.uu___is_Cons2))

:named typing_ExtTest1.uu___is_Cons2))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(71,5-71,10); use=ExtTest1.fst(71,5-71,10)
...
:named subterm_ordering_ExtTest1.Cons2))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ExtTest1.__proj__Cons2__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_96b4a762449a5aa098e49432836a0cd9 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_96b4a762449a5aa098e49432836a0cd9 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_96b4a762449a5aa098e49432836a0cd9))

:named refinement_kinding_Tm_refine_96b4a762449a5aa098e49432836a0cd9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name ExtTest1.__proj__Cons2__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_96b4a762449a5aa098e49432836a0cd9 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(ExtTest1.list2 @x2
...
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(BoxBool_proj_0 (ExtTest1.uu___is_Cons2 @x2
@x3
@x1))
))
...
(Tm_refine_96b4a762449a5aa098e49432836a0cd9 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_96b4a762449a5aa098e49432836a0cd9))

:named refinement_interpretation_Tm_refine_96b4a762449a5aa098e49432836a0cd9))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(72,4-72,8); use=ExtTest1.fst(72,4-72,8)
...
:named kinding_ExtTest1.list2@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_96b4a762449a5aa098e49432836a0cd9
;;; Fact-ids: Name ExtTest1.__proj__Cons2__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_96b4a762449a5aa098e49432836a0cd9 @x0
@x1)))
(Valid (Prims.hasEq (ExtTest1.list2 @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_96b4a762449a5aa098e49432836a0cd9 @x0
@x1))))
:qid haseqTm_refine_96b4a762449a5aa098e49432836a0cd9))

:named haseqTm_refine_96b4a762449a5aa098e49432836a0cd9))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(71,5-71,10); use=ExtTest1.fst(71,5-71,10)
...
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,4-73,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.uu___is_Cons2 @x0
@x1
@x2)
(BoxBool (is-ExtTest1.Cons2 @x2)))
 

:pattern ((ExtTest1.uu___is_Cons2 @x0
@x1
@x2))
:qid disc_equation_ExtTest1.Cons2))

:named disc_equation_ExtTest1.Cons2))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(72,4-72,8); use=ExtTest1.fst(72,4-72,8)
...
:named constructor_distinct_ExtTest1.Cons2))
;;;;;;;;;;;;;;;;Assumption: ExtTest1.list2__uu___haseq
;;; Fact-ids: Name ExtTest1.list2__uu___haseq; Namespace ExtTest1
...
:pattern ((Prims.hasEq (ExtTest1.list2 @x0
@x1)))
:qid assumption_ExtTest1.list2__uu___haseq))
:named assumption_ExtTest1.list2__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ExtTest1.list2; Namespace ExtTest1; Name ExtTest1.Nil2; Namespace ExtTest1; Name ExtTest1.Cons2; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(71,5-71,10); use=ExtTest1.fst(71,5-71,10)
...
; Starting query at ExtTest1.fst(73,12-73,14)

(declare-fun label_1 () Bool)


; Encoding query formula : forall ('a: Type) (b: Type) (projectee: _: ExtTest1.list2 'a b {Cons2? _}).
;   (*  - Could not prove post-condition
...
Tm_type)
(HasType @x2
(Tm_refine_96b4a762449a5aa098e49432836a0cd9 @x0
@x1))

;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,12-73,14)
(not 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,12-73,14)
(BoxBool_proj_0 (ExtTest1.uu___is_Cons2 @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.__proj__Cons2__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_96b4a762449a5aa098e49432836a0cd9
...
; encoding sigelt val ExtTest1.__proj__Cons2__item__hd2


; <Start encoding val ExtTest1.__proj__Cons2__item__hd2>


(declare-fun ExtTest1.__proj__Cons2__item__hd2 (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: list2 'a b {Cons2? _} -> b
(declare-fun Tm_arrow_d4e4a6df10f92a715947ad8e60f6510a () Term)
(declare-fun ExtTest1.__proj__Cons2__item__hd2@tok () Term)

; </end encoding val ExtTest1.__proj__Cons2__item__hd2>

(push) ;; push{2

; Starting query at ExtTest1.fst(73,21-73,24)
...
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,21-73,24)
(not 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,21-73,24)
(BoxBool_proj_0 (ExtTest1.uu___is_Cons2 @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.__proj__Cons2__item__hd2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_96b4a762449a5aa098e49432836a0cd9
...
; encoding sigelt val ExtTest1.__proj__Cons2__item__tl


; <Start encoding val ExtTest1.__proj__Cons2__item__tl>


(declare-fun ExtTest1.__proj__Cons2__item__tl (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: list2 'a b {Cons2? _} -> list2 'a b
(declare-fun Tm_arrow_9cc46bce51c2240da327205857d22190 () Term)
(declare-fun ExtTest1.__proj__Cons2__item__tl@tok () Term)

; </end encoding val ExtTest1.__proj__Cons2__item__tl>

(push) ;; push{2

; Starting query at ExtTest1.fst(73,31-73,33)
...
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,31-73,33)
(not 
;; def=ExtTest1.fst(73,4-73,9); use=ExtTest1.fst(73,31-73,33)
(BoxBool_proj_0 (ExtTest1.uu___is_Cons2 @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.__proj__Cons2__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_96b4a762449a5aa098e49432836a0cd9
...
(declare-fun ExtTest1.distr_pair () Term)

;;;;;;;;;;;;;;;;_: (x: Type -> _: x -> x) -> prod nnat (list nnat)
(declare-fun Tm_arrow_a386226cdb38c1b2a048049f003c96c9 () Term)
...
; encoding sigelt type ExtTest1.list2p


; <Start encoding type ExtTest1.list2p>

;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.list2p (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun ExtTest1.list2p@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.Nil2p (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Nil2p__a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.Nil2p
(declare-fun ExtTest1.Nil2p@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.Cons2p (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons2p__a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons2p_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.Cons2p_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.Cons2p
(declare-fun ExtTest1.Cons2p@tok () Term)
;;;;;;;;;;;;;;;;list2p 'a
(declare-fun Tm_arrow_be6e4bd1a2cedc36e7d3a6522bfa2bce () Term)
;;;;;;;;;;;;;;;;hd: 'a -> tl: list2p (prod 'a 'a) -> list2p 'a
(declare-fun Tm_arrow_64e0dde6cda42c6a3f110be487bad269 () Term)

; <start constructor ExtTest1.list2p>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.list2p ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
380)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-ExtTest1.list2p))))

; </end constructor ExtTest1.list2p>


; <start constructor ExtTest1.Nil2p>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.Nil2p ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
387)
(= __@x0
(ExtTest1.Nil2p (ExtTest1.Nil2p__a __@x0)))))

; </end constructor ExtTest1.Nil2p>


; <start constructor ExtTest1.Cons2p>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.Cons2p ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
392)
(= __@x0
(ExtTest1.Cons2p (ExtTest1.Cons2p__a __@x0)
(ExtTest1.Cons2p_hd __@x0)
(ExtTest1.Cons2p_tl __@x0)))))

; </end constructor ExtTest1.Cons2p>


; </end encoding type ExtTest1.list2p>
...
:named token_correspondence_ExtTest1.prod@tok))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(80,5-80,11); use=ExtTest1.fst(80,5-80,11)
(forall ((@x0 Term))
 (! (= (ApplyTT ExtTest1.list2p@tok
@x0)
(ExtTest1.list2p @x0))
 

:pattern ((ApplyTT ExtTest1.list2p@tok
@x0))

:pattern ((ExtTest1.list2p @x0))
:qid token_correspondence_ExtTest1.list2p@tok))

:named token_correspondence_ExtTest1.list2p@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
...
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(ExtTest1.Cons2p @x1
@x2
...
@x3)
(ExtTest1.list2p @x4)))
:qid subterm_ordering_ExtTest1.Cons2p))

:named subterm_ordering_ExtTest1.Cons2p))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
...
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(81,4-81,9); use=ExtTest1.fst(81,4-81,9)
(forall ((@x0 Term))
 (! (= (ExtTest1.Nil2p__a (ExtTest1.Nil2p @x0))
@x0)
 

:pattern ((ExtTest1.Nil2p @x0))
:qid projection_inverse_ExtTest1.Nil2p__a))

:named projection_inverse_ExtTest1.Nil2p__a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.Cons2p_tl (ExtTest1.Cons2p @x0
@x1
@x2))
@x2)
 

:pattern ((ExtTest1.Cons2p @x0
@x1
@x2))
:qid projection_inverse_ExtTest1.Cons2p_tl))

:named projection_inverse_ExtTest1.Cons2p_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.Cons2p_hd (ExtTest1.Cons2p @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_ExtTest1.Cons2p_hd))

:named projection_inverse_ExtTest1.Cons2p_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.Cons2p__a (ExtTest1.Cons2p @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_ExtTest1.Cons2p__a))

:named projection_inverse_ExtTest1.Cons2p__a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! (is-Tm_arrow (PreType ExtTest1.prod@tok))
:named pre_kinding_ExtTest1.prod@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! (is-Tm_arrow (PreType ExtTest1.list2p@tok))
:named pre_kinding_ExtTest1.list2p@tok))
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! (and (IsTotFun ExtTest1.prod@tok)
...
:named kinding_ExtTest1.prod@tok))
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! (and (IsTotFun ExtTest1.list2p@tok)

;; def=ExtTest1.fst(80,5-80,11); use=ExtTest1.fst(80,5-80,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (ExtTest1.list2p @x0)
Tm_type))
 

:pattern ((ExtTest1.list2p @x0))
:qid kinding_ExtTest1.list2p@tok))
)
:named kinding_ExtTest1.list2p@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
...
@x1
(ExtTest1.list2p @x2))
(or (and (is-ExtTest1.Nil2p @x1)
(= @x2
(ExtTest1.Nil2p__a @x1)))
(and (is-ExtTest1.Cons2p @x1)
(= @x2
(ExtTest1.Cons2p__a @x1)))))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
(ExtTest1.list2p @x2)))
:qid fuel_guarded_inversion_ExtTest1.list2p))

:named fuel_guarded_inversion_ExtTest1.list2p))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! (= 213
(Term_constr_id ExtTest1.prod@tok))
...
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! (= 381
(Term_constr_id ExtTest1.list2p@tok))
:named fresh_token_ExtTest1.list2p@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
...
(ExtTest1.Nil2p @x1)
(ExtTest1.list2p @x1)))
:qid data_typing_intro_ExtTest1.Nil2p@tok))

:named data_typing_intro_ExtTest1.Nil2p@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
...
(HasTypeFuel @u0
@x3
(ExtTest1.list2p (ExtTest1.prod @x1
@x1))))
(HasTypeFuel @u0
(ExtTest1.Cons2p @x1
@x2
...
@x3)
(ExtTest1.list2p @x1)))
:qid data_typing_intro_ExtTest1.Cons2p@tok))

:named data_typing_intro_ExtTest1.Cons2p@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
...
(ExtTest1.Nil2p @x1)
(ExtTest1.list2p @x2)))
:qid data_elim_ExtTest1.Nil2p))

:named data_elim_ExtTest1.Nil2p))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
...
(HasTypeFuel @u0
@x3
(ExtTest1.list2p (ExtTest1.prod @x4
@x4)))))
...
@x3)
(ExtTest1.list2p @x4)))
:qid data_elim_ExtTest1.Cons2p))

:named data_elim_ExtTest1.Cons2p))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
...
(forall ((@x0 Term))
 (! (= 380
(Term_constr_id (ExtTest1.list2p @x0)))
 

:pattern ((ExtTest1.list2p @x0))
:qid constructor_distinct_ExtTest1.list2p))

:named constructor_distinct_ExtTest1.list2p))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
...
(forall ((@x0 Term))
 (! (= 387
(Term_constr_id (ExtTest1.Nil2p @x0)))
 

:pattern ((ExtTest1.Nil2p @x0))
:qid constructor_distinct_ExtTest1.Nil2p))

:named constructor_distinct_ExtTest1.Nil2p))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.list2p; Namespace ExtTest1; Name ExtTest1.Nil2p; Namespace ExtTest1; Name ExtTest1.Cons2p; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 392
(Term_constr_id (ExtTest1.Cons2p @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_ExtTest1.Cons2p))

:named constructor_distinct_ExtTest1.Cons2p))
;;;;;;;;;;;;;;;;Assumption: ExtTest1.prod__uu___haseq
;;; Fact-ids: Name ExtTest1.prod__uu___haseq; Namespace ExtTest1
(assert (! (forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Valid (Prims.hasEq @x0))
(Valid (Prims.hasEq @x1)))
(Valid (Prims.hasEq (ExtTest1.prod @x0
@x1))))
 

:pattern ((Prims.hasEq (ExtTest1.prod @x0
@x1)))
:qid assumption_ExtTest1.prod__uu___haseq))
:named assumption_ExtTest1.prod__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
...
@x0
(ExtTest1.list2p @x2)))
:qid ExtTest1_pretyping_01ca954f1b99ce7ddde93cf022ecaf61))

:named ExtTest1_pretyping_01ca954f1b99ce7ddde93cf022ecaf61))
(push) ;; push{4

; Starting query at ExtTest1.fst(80,0-82,60)
...
; Encoding query formula : forall ('a: Type).
;   Prims.hasEq 'a /\
;   (forall ('a: Type). {:pattern Prims.hasEq (ExtTest1.list2p 'a)}
;       Prims.hasEq 'a ==> Prims.hasEq (ExtTest1.list2p 'a)) ==>
;   (forall (hd: 'a) (tl: ExtTest1.list2p (ExtTest1.prod 'a 'a)).
;       Prims.hasEq 'a /\ Prims.hasEq (ExtTest1.list2p (ExtTest1.prod 'a 'a)))


; Context: While encoding a query
; While typechecking the top-level declaration `type ExtTest1.list2p`
...
;; def=ExtTest1.fst(80,0-82,60); use=ExtTest1.fst(80,0-82,60)
(Valid 
;; def=ExtTest1.fst(80,0-82,60); use=ExtTest1.fst(80,0-82,60)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=ExtTest1.fst(80,0-82,60); use=ExtTest1.fst(80,0-82,60)
(Prims.hasEq (ExtTest1.list2p @x1))
)
)
 

:pattern ((Prims.hasEq (ExtTest1.list2p @x1)))
:qid @query.1))
)
...
@x0)
(HasType @x2
(ExtTest1.list2p (ExtTest1.prod @x0
@x0))))

;; def=ExtTest1.fst(80,0-82,60); use=ExtTest1.fst(80,0-82,60)
(and 
;; def=ExtTest1.fst(80,0-82,60); use=ExtTest1.fst(82,16-82,18)
(or label_1
...
;; def=ExtTest1.fst(80,0-82,60); use=ExtTest1.fst(82,27-82,46)
(or label_2

;; def=ExtTest1.fst(80,0-82,60); use=ExtTest1.fst(80,0-82,60)
(Valid 
;; def=ExtTest1.fst(80,0-82,60); use=ExtTest1.fst(80,0-82,60)
(Prims.hasEq (ExtTest1.list2p (ExtTest1.prod @x0
@x0)))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.list2p, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_ExtTest1.prod__uu___haseq, kinding_ExtTest1.prod@tok
...
; encoding sigelt assume ExtTest1.list2p__uu___haseq


; <Start encoding assume ExtTest1.list2p__uu___haseq>


; </end encoding assume ExtTest1.list2p__uu___haseq>


; encoding sigelt val ExtTest1.uu___is_Nil2p


; <Start encoding val ExtTest1.uu___is_Nil2p>

(declare-fun ExtTest1.uu___is_Nil2p (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: list2p 'a -> Prims.bool
(declare-fun Tm_arrow_a752323410ed67e05987c042e2778cb4 () Term)
(declare-fun ExtTest1.uu___is_Nil2p@tok () Term)

; </end encoding val ExtTest1.uu___is_Nil2p>
...
; encoding sigelt val ExtTest1.uu___is_Cons2p


; <Start encoding val ExtTest1.uu___is_Cons2p>

(declare-fun ExtTest1.uu___is_Cons2p (Term Term) Term)

(declare-fun ExtTest1.uu___is_Cons2p@tok () Term)

; </end encoding val ExtTest1.uu___is_Cons2p>
...
; encoding sigelt val ExtTest1.__proj__Cons2p__item__hd


; <Start encoding val ExtTest1.__proj__Cons2p__item__hd>

(declare-fun Tm_refine_4addc42291a9a525be4aa93372365c56 (Term) Term)
(declare-fun ExtTest1.__proj__Cons2p__item__hd (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: list2p 'a {Cons2p? _} -> 'a
(declare-fun Tm_arrow_0a5481e9dbab99c81b95ce3d4b61a0bd () Term)
(declare-fun ExtTest1.__proj__Cons2p__item__hd@tok () Term)

; </end encoding val ExtTest1.__proj__Cons2p__item__hd>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ExtTest1.uu___is_Cons2p; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(ExtTest1.list2p @x0)))
(HasType (ExtTest1.uu___is_Cons2p @x0
@x1)
Prims.bool))
 

:pattern ((ExtTest1.uu___is_Cons2p @x0
@x1))
:qid typing_ExtTest1.uu___is_Cons2p))

:named typing_ExtTest1.uu___is_Cons2p))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
...
:named subterm_ordering_ExtTest1.Cons2p))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ExtTest1.__proj__Cons2p__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_4addc42291a9a525be4aa93372365c56 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_4addc42291a9a525be4aa93372365c56 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_4addc42291a9a525be4aa93372365c56))

:named refinement_kinding_Tm_refine_4addc42291a9a525be4aa93372365c56))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name ExtTest1.__proj__Cons2p__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4addc42291a9a525be4aa93372365c56 @x2))
(and (HasTypeFuel @u0
@x1
(ExtTest1.list2p @x2))

;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(BoxBool_proj_0 (ExtTest1.uu___is_Cons2p @x2
@x1))
))
...
@x1
(Tm_refine_4addc42291a9a525be4aa93372365c56 @x2)))
:qid refinement_interpretation_Tm_refine_4addc42291a9a525be4aa93372365c56))

:named refinement_interpretation_Tm_refine_4addc42291a9a525be4aa93372365c56))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
...
:named kinding_ExtTest1.list2p@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4addc42291a9a525be4aa93372365c56
;;; Fact-ids: Name ExtTest1.__proj__Cons2p__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4addc42291a9a525be4aa93372365c56 @x0)))
(Valid (Prims.hasEq (ExtTest1.list2p @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4addc42291a9a525be4aa93372365c56 @x0))))
:qid haseqTm_refine_4addc42291a9a525be4aa93372365c56))

:named haseqTm_refine_4addc42291a9a525be4aa93372365c56))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
...
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,4-82,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ExtTest1.uu___is_Cons2p @x0
@x1)
(BoxBool (is-ExtTest1.Cons2p @x1)))
 

:pattern ((ExtTest1.uu___is_Cons2p @x0
@x1))
:qid disc_equation_ExtTest1.Cons2p))

:named disc_equation_ExtTest1.Cons2p))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(63,2-63,6); use=ExtTest1.fst(63,2-63,6)
...
:qid assumption_ExtTest1.prod__uu___haseq))
:named assumption_ExtTest1.prod__uu___haseq))
;;;;;;;;;;;;;;;;Assumption: ExtTest1.list2p__uu___haseq
;;; Fact-ids: Name ExtTest1.list2p__uu___haseq; Namespace ExtTest1
(assert (! (forall ((@x0 Term))
 (! (implies (and (HasType @x0
Tm_type)
(Valid (Prims.hasEq @x0)))
...
:pattern ((Prims.hasEq (ExtTest1.list2p @x0)))
:qid assumption_ExtTest1.list2p__uu___haseq))
:named assumption_ExtTest1.list2p__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ExtTest1.prod; Namespace ExtTest1; Name ExtTest1.Pair; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(62,5-62,9); use=ExtTest1.fst(62,5-62,9)
...
; Starting query at ExtTest1.fst(82,13-82,15)

(declare-fun label_1 () Bool)


; Encoding query formula : forall ('a: Type) (projectee: _: ExtTest1.list2p 'a {Cons2p? _}).
;   (*  - Could not prove post-condition
...
Tm_type)
(HasType @x1
(Tm_refine_4addc42291a9a525be4aa93372365c56 @x0))

;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,13-82,15)
(not 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,13-82,15)
(BoxBool_proj_0 (ExtTest1.uu___is_Cons2p @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.__proj__Cons2p__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_4addc42291a9a525be4aa93372365c56
...
; encoding sigelt val ExtTest1.__proj__Cons2p__item__tl


; <Start encoding val ExtTest1.__proj__Cons2p__item__tl>


(declare-fun ExtTest1.__proj__Cons2p__item__tl (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: list2p 'a {Cons2p? _} -> list2p (prod 'a 'a)
(declare-fun Tm_arrow_e79dde415595f8d420170298b98b7e27 () Term)
(declare-fun ExtTest1.__proj__Cons2p__item__tl@tok () Term)

; </end encoding val ExtTest1.__proj__Cons2p__item__tl>

(push) ;; push{2

; Starting query at ExtTest1.fst(82,24-82,26)
...
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,24-82,26)
(not 
;; def=ExtTest1.fst(82,4-82,10); use=ExtTest1.fst(82,24-82,26)
(BoxBool_proj_0 (ExtTest1.uu___is_Cons2p @x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.__proj__Cons2p__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_4addc42291a9a525be4aa93372365c56
...
(declare-fun ExtTest1.sch (Term) Term)

(declare-fun ExtTest1.sch@tok () Term)
;;;;;;;;;;;;;;;;_: x -> x
...
;;;;;;;;;;;;;;;;_: nnat -> Type
(declare-fun Tm_arrow_a27c28b43f43146068a58bdc75a070d2 () Term)
(declare-fun ExtTest1.sch3param (Term) Term)

;;;;;;;;;;;;;;;;x: (_: nnat -> Type) -> Type
(declare-fun Tm_arrow_be996ccb5aae393a04cdb6eecd63be8a () Term)
(declare-fun ExtTest1.sch3param@tok () Term)

;;;;;;;;;;;;;;;;_: x O -> x (S O)
(declare-fun Tm_arrow_12fb69ad4b8431593856fff764c79bbc (Term) Term)
...
(declare-fun ExtTest1.listalias (Term) Term)

(declare-fun ExtTest1.listalias@tok () Term)
...
; encoding sigelt type ExtTest1.evenlist


; <Start encoding type ExtTest1.evenlist>

;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.evenlist (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun ExtTest1.evenlist@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.oddlist (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun ExtTest1.oddlist@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.ENil (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.ENil_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.ENil
(declare-fun ExtTest1.ENil@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.ECons (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.ECons_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.ECons_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.ECons_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.ECons
(declare-fun ExtTest1.ECons@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ExtTest1.OCons (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.OCons_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.OCons_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ExtTest1.OCons_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ExtTest1.OCons
(declare-fun ExtTest1.OCons@tok () Term)
;;;;;;;;;;;;;;;;evenlist a
(declare-fun Tm_arrow_151db0a5de9c906d8b67a7b663265356 () Term)
;;;;;;;;;;;;;;;;hd: a -> tl: oddlist a -> evenlist a
(declare-fun Tm_arrow_118f91c8265cec42505834681434ffd4 () Term)
;;;;;;;;;;;;;;;;hd: a -> tl: evenlist a -> oddlist a
(declare-fun Tm_arrow_6148268f350b75f0c77505fe9deae7c1 () Term)

; <start constructor ExtTest1.evenlist>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.evenlist ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
473)
(exists ((@x0 Term))
 (! (= __@x0
(ExtTest1.evenlist @x0))
 
;;no pats
:qid is-ExtTest1.evenlist))))

; </end constructor ExtTest1.evenlist>


; <start constructor ExtTest1.oddlist>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.oddlist ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
479)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-ExtTest1.oddlist))))

; </end constructor ExtTest1.oddlist>


; <start constructor ExtTest1.ENil>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.ENil ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
486)
(= __@x0
(ExtTest1.ENil (ExtTest1.ENil_a __@x0)))))

; </end constructor ExtTest1.ENil>


; <start constructor ExtTest1.ECons>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.ECons ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
491)
(= __@x0
(ExtTest1.ECons (ExtTest1.ECons_a __@x0)
(ExtTest1.ECons_hd __@x0)
(ExtTest1.ECons_tl __@x0)))))

; </end constructor ExtTest1.ECons>


; <start constructor ExtTest1.OCons>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ExtTest1.OCons ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
496)
(= __@x0
(ExtTest1.OCons (ExtTest1.OCons_a __@x0)
(ExtTest1.OCons_hd __@x0)
(ExtTest1.OCons_tl __@x0)))))

; </end constructor ExtTest1.OCons>


; </end encoding type ExtTest1.evenlist>

;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(133,4-133,11); use=ExtTest1.fst(133,4-133,11)
(forall ((@x0 Term))
 (! (= (ApplyTT ExtTest1.oddlist@tok
@x0)
(ExtTest1.oddlist @x0))
 

:pattern ((ApplyTT ExtTest1.oddlist@tok
@x0))

:pattern ((ExtTest1.oddlist @x0))
:qid token_correspondence_ExtTest1.oddlist@tok))

:named token_correspondence_ExtTest1.oddlist@tok))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(130,5-130,13); use=ExtTest1.fst(130,5-130,13)
(forall ((@x0 Term))
 (! (= (ApplyTT ExtTest1.evenlist@tok
@x0)
(ExtTest1.evenlist @x0))
 

:pattern ((ApplyTT ExtTest1.evenlist@tok
@x0))

:pattern ((ExtTest1.evenlist @x0))
:qid token_correspondence_ExtTest1.evenlist@tok))

:named token_correspondence_ExtTest1.evenlist@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(134,4-134,9); use=ExtTest1.fst(134,4-134,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(ExtTest1.OCons @x1
@x2
...
@x3)
(ExtTest1.oddlist @x4)))
:qid subterm_ordering_ExtTest1.OCons))

:named subterm_ordering_ExtTest1.OCons))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(ExtTest1.ECons @x1
@x2
@x3)
(ExtTest1.evenlist @x4))
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(ExtTest1.ECons @x1
...
@x3)
(ExtTest1.evenlist @x4)))
:qid subterm_ordering_ExtTest1.ECons))

:named subterm_ordering_ExtTest1.ECons))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(134,4-134,9); use=ExtTest1.fst(134,4-134,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.OCons_tl (ExtTest1.OCons @x0
@x1
@x2))
@x2)
 

:pattern ((ExtTest1.OCons @x0
@x1
@x2))
:qid projection_inverse_ExtTest1.OCons_tl))

:named projection_inverse_ExtTest1.OCons_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(134,4-134,9); use=ExtTest1.fst(134,4-134,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.OCons_hd (ExtTest1.OCons @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_ExtTest1.OCons_hd))

:named projection_inverse_ExtTest1.OCons_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(134,4-134,9); use=ExtTest1.fst(134,4-134,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.OCons_a (ExtTest1.OCons @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_ExtTest1.OCons_a))

:named projection_inverse_ExtTest1.OCons_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(131,4-131,8); use=ExtTest1.fst(131,4-131,8)
(forall ((@x0 Term))
 (! (= (ExtTest1.ENil_a (ExtTest1.ENil @x0))
@x0)
 

:pattern ((ExtTest1.ENil @x0))
:qid projection_inverse_ExtTest1.ENil_a))

:named projection_inverse_ExtTest1.ENil_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.ECons_tl (ExtTest1.ECons @x0
@x1
@x2))
@x2)
 

:pattern ((ExtTest1.ECons @x0
@x1
@x2))
:qid projection_inverse_ExtTest1.ECons_tl))

:named projection_inverse_ExtTest1.ECons_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.ECons_hd (ExtTest1.ECons @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_ExtTest1.ECons_hd))

:named projection_inverse_ExtTest1.ECons_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ExtTest1.ECons_a (ExtTest1.ECons @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_ExtTest1.ECons_a))

:named projection_inverse_ExtTest1.ECons_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! (is-Tm_arrow (PreType ExtTest1.oddlist@tok))
:named pre_kinding_ExtTest1.oddlist@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! (is-Tm_arrow (PreType ExtTest1.evenlist@tok))
:named pre_kinding_ExtTest1.evenlist@tok))
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! (and (IsTotFun ExtTest1.oddlist@tok)

;; def=ExtTest1.fst(133,4-133,11); use=ExtTest1.fst(133,4-133,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (ExtTest1.oddlist @x0)
Tm_type))
 

:pattern ((ExtTest1.oddlist @x0))
:qid kinding_ExtTest1.oddlist@tok))
)
:named kinding_ExtTest1.oddlist@tok))
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! (and (IsTotFun ExtTest1.evenlist@tok)

;; def=ExtTest1.fst(130,5-130,13); use=ExtTest1.fst(130,5-130,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (ExtTest1.evenlist @x0)
Tm_type))
 

:pattern ((ExtTest1.evenlist @x0))
:qid kinding_ExtTest1.evenlist@tok))
)
:named kinding_ExtTest1.evenlist@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(133,4-133,11); use=ExtTest1.fst(133,4-133,11)
...
@x1
(ExtTest1.oddlist @x2)))
:qid fuel_guarded_inversion_ExtTest1.oddlist))

:named fuel_guarded_inversion_ExtTest1.oddlist))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(130,5-130,13); use=ExtTest1.fst(130,5-130,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
(ExtTest1.evenlist @x2))
(or (and (is-ExtTest1.ENil @x1)
(= @x2
(ExtTest1.ENil_a @x1)))
(and (is-ExtTest1.ECons @x1)
(= @x2
(ExtTest1.ECons_a @x1)))))
...
@x1
(ExtTest1.evenlist @x2)))
:qid fuel_guarded_inversion_ExtTest1.evenlist))

:named fuel_guarded_inversion_ExtTest1.evenlist))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! (= 480
(Term_constr_id ExtTest1.oddlist@tok))
:named fresh_token_ExtTest1.oddlist@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! (= 474
(Term_constr_id ExtTest1.evenlist@tok))
:named fresh_token_ExtTest1.evenlist@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(134,4-134,9); use=ExtTest1.fst(134,4-134,9)
...
@x3)
(ExtTest1.oddlist @x1)))
:qid data_typing_intro_ExtTest1.OCons@tok))

:named data_typing_intro_ExtTest1.OCons@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(131,4-131,8); use=ExtTest1.fst(131,4-131,8)
...
(ExtTest1.ENil @x1)
(ExtTest1.evenlist @x1)))
:qid data_typing_intro_ExtTest1.ENil@tok))

:named data_typing_intro_ExtTest1.ENil@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
...
@x3)
(ExtTest1.evenlist @x1)))
:qid data_typing_intro_ExtTest1.ECons@tok))

:named data_typing_intro_ExtTest1.ECons@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(134,4-134,9); use=ExtTest1.fst(134,4-134,9)
...
@x3)
(ExtTest1.oddlist @x4)))
:qid data_elim_ExtTest1.OCons))

:named data_elim_ExtTest1.OCons))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(131,4-131,8); use=ExtTest1.fst(131,4-131,8)
...
(ExtTest1.ENil @x1)
(ExtTest1.evenlist @x2)))
:qid data_elim_ExtTest1.ENil))

:named data_elim_ExtTest1.ENil))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
...
@x3)
(ExtTest1.evenlist @x4)))
:qid data_elim_ExtTest1.ECons))

:named data_elim_ExtTest1.ECons))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(133,4-133,11); use=ExtTest1.fst(133,4-133,11)
(forall ((@x0 Term))
 (! (= 479
(Term_constr_id (ExtTest1.oddlist @x0)))
 

:pattern ((ExtTest1.oddlist @x0))
:qid constructor_distinct_ExtTest1.oddlist))

:named constructor_distinct_ExtTest1.oddlist))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(130,5-130,13); use=ExtTest1.fst(130,5-130,13)
(forall ((@x0 Term))
 (! (= 473
(Term_constr_id (ExtTest1.evenlist @x0)))
 

:pattern ((ExtTest1.evenlist @x0))
:qid constructor_distinct_ExtTest1.evenlist))

:named constructor_distinct_ExtTest1.evenlist))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(134,4-134,9); use=ExtTest1.fst(134,4-134,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 496
(Term_constr_id (ExtTest1.OCons @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_ExtTest1.OCons))

:named constructor_distinct_ExtTest1.OCons))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(131,4-131,8); use=ExtTest1.fst(131,4-131,8)
(forall ((@x0 Term))
 (! (= 486
(Term_constr_id (ExtTest1.ENil @x0)))
 

:pattern ((ExtTest1.ENil @x0))
:qid constructor_distinct_ExtTest1.ENil))

:named constructor_distinct_ExtTest1.ENil))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 491
(Term_constr_id (ExtTest1.ECons @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_ExtTest1.ECons))

:named constructor_distinct_ExtTest1.ECons))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(133,4-133,11); use=ExtTest1.fst(133,4-133,11)
...
@x0
(ExtTest1.oddlist @x2)))
:qid ExtTest1_pretyping_89ed3bd2d0b582a2570e32bc0169276a))

:named ExtTest1_pretyping_89ed3bd2d0b582a2570e32bc0169276a))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(130,5-130,13); use=ExtTest1.fst(130,5-130,13)
...
@x0
(ExtTest1.evenlist @x2)))
:qid ExtTest1_pretyping_06c41cd7b7246ea229ed6612c2d8f0a9))

:named ExtTest1_pretyping_06c41cd7b7246ea229ed6612c2d8f0a9))
(push) ;; push{4

; Starting query at ExtTest1.fst(130,0-134,46)
...
;   Prims.hasEq a /\
;   (forall (a: Type). {:pattern Prims.hasEq (ExtTest1.evenlist a)}
;       Prims.hasEq a ==> Prims.hasEq (ExtTest1.evenlist a)) /\
;   Prims.hasEq a /\
;   (forall (a: Type). {:pattern Prims.hasEq (ExtTest1.oddlist a)}
;       Prims.hasEq a ==> Prims.hasEq (ExtTest1.oddlist a)) ==>
;   (forall (hd: a) (tl: ExtTest1.oddlist a). Prims.hasEq a /\ Prims.hasEq (ExtTest1.oddlist a)) /\
;   (forall (hd: a) (tl: ExtTest1.evenlist a). Prims.hasEq a /\ Prims.hasEq (ExtTest1.evenlist a))


; Context: While encoding a query
; While typechecking the top-level declaration `type ExtTest1.evenlist`
...
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(130,0-134,46)
(Valid 
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(130,0-134,46)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(130,0-134,46)
(Prims.hasEq (ExtTest1.evenlist @x2))
)
)
 

:pattern ((Prims.hasEq (ExtTest1.evenlist @x2)))
:qid @query.1))
...
(Valid 
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(130,0-134,46)
(Prims.hasEq (ExtTest1.oddlist @x2))
)
)
 

:pattern ((Prims.hasEq (ExtTest1.oddlist @x2)))
:qid @query.2))
)
...
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(130,0-134,46)
(and 
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(132,15-132,16)
(or label_1
...
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(132,23-132,32)
(or label_2

;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(130,0-134,46)
(Valid 
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(130,0-134,46)
(Prims.hasEq (ExtTest1.oddlist @x0))
)
)
)
)
...
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(130,0-134,46)
(and 
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(134,15-134,16)
(or label_3
...
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(134,23-134,33)
(or label_4

;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(130,0-134,46)
(Valid 
;; def=ExtTest1.fst(130,0-134,46); use=ExtTest1.fst(130,0-134,46)
(Prims.hasEq (ExtTest1.evenlist @x1))
)
)
)
)
...
; encoding sigelt assume ExtTest1.evenlist__uu___haseq


; <Start encoding assume ExtTest1.evenlist__uu___haseq>


; </end encoding assume ExtTest1.evenlist__uu___haseq>


; encoding sigelt assume ExtTest1.oddlist__uu___haseq


; <Start encoding assume ExtTest1.oddlist__uu___haseq>


; </end encoding assume ExtTest1.oddlist__uu___haseq>


; encoding sigelt val ExtTest1.uu___is_ENil


; <Start encoding val ExtTest1.uu___is_ENil>

(declare-fun ExtTest1.uu___is_ENil (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: evenlist a -> Prims.bool
(declare-fun Tm_arrow_403bc0295f16d74475d9593efba3c57d () Term)
(declare-fun ExtTest1.uu___is_ENil@tok () Term)

; </end encoding val ExtTest1.uu___is_ENil>
...
; encoding sigelt val ExtTest1.uu___is_ECons


; <Start encoding val ExtTest1.uu___is_ECons>

(declare-fun ExtTest1.uu___is_ECons (Term Term) Term)

(declare-fun ExtTest1.uu___is_ECons@tok () Term)

; </end encoding val ExtTest1.uu___is_ECons>
...
; encoding sigelt val ExtTest1.__proj__ECons__item__hd


; <Start encoding val ExtTest1.__proj__ECons__item__hd>

(declare-fun Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0 (Term) Term)
(declare-fun ExtTest1.__proj__ECons__item__hd (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: evenlist a {ECons? _} -> a
(declare-fun Tm_arrow_a0a478fcdb1ad0c193f6e91ff1e3bbf4 () Term)
(declare-fun ExtTest1.__proj__ECons__item__hd@tok () Term)

; </end encoding val ExtTest1.__proj__ECons__item__hd>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ExtTest1.uu___is_ECons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(ExtTest1.evenlist @x0)))
(HasType (ExtTest1.uu___is_ECons @x0
@x1)
Prims.bool))
 

:pattern ((ExtTest1.uu___is_ECons @x0
@x1))
:qid typing_ExtTest1.uu___is_ECons))

:named typing_ExtTest1.uu___is_ECons))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(133,4-133,11); use=ExtTest1.fst(133,4-133,11)
...
:named subterm_ordering_ExtTest1.ECons))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ExtTest1.__proj__ECons__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0))

:named refinement_kinding_Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name ExtTest1.__proj__ECons__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0 @x2))
(and (HasTypeFuel @u0
@x1
(ExtTest1.evenlist @x2))

;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(BoxBool_proj_0 (ExtTest1.uu___is_ECons @x2
@x1))
))
...
@x1
(Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0 @x2)))
:qid refinement_interpretation_Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0))

:named refinement_interpretation_Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(134,4-134,9); use=ExtTest1.fst(134,4-134,9)
...
:named kinding_ExtTest1.evenlist@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0
;;; Fact-ids: Name ExtTest1.__proj__ECons__item__hd; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0 @x0)))
(Valid (Prims.hasEq (ExtTest1.evenlist @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0 @x0))))
:qid haseqTm_refine_e20ce8993c26b104b7973ee87cf7aeb0))

:named haseqTm_refine_e20ce8993c26b104b7973ee87cf7aeb0))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(133,4-133,11); use=ExtTest1.fst(133,4-133,11)
...
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,4-132,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ExtTest1.uu___is_ECons @x0
@x1)
(BoxBool (is-ExtTest1.ECons @x1)))
 

:pattern ((ExtTest1.uu___is_ECons @x0
@x1))
:qid disc_equation_ExtTest1.ECons))

:named disc_equation_ExtTest1.ECons))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(134,4-134,9); use=ExtTest1.fst(134,4-134,9)
...
:named constructor_distinct_ExtTest1.ECons))
;;;;;;;;;;;;;;;;Assumption: ExtTest1.oddlist__uu___haseq
;;; Fact-ids: Name ExtTest1.oddlist__uu___haseq; Namespace ExtTest1
(assert (! (forall ((@x0 Term))
 (! (implies (and (HasType @x0
Tm_type)
(Valid (Prims.hasEq @x0)))
(Valid (Prims.hasEq (ExtTest1.oddlist @x0))))
 

:pattern ((Prims.hasEq (ExtTest1.oddlist @x0)))
:qid assumption_ExtTest1.oddlist__uu___haseq))
:named assumption_ExtTest1.oddlist__uu___haseq))
;;;;;;;;;;;;;;;;Assumption: ExtTest1.evenlist__uu___haseq
;;; Fact-ids: Name ExtTest1.evenlist__uu___haseq; Namespace ExtTest1
(assert (! (forall ((@x0 Term))
 (! (implies (and (HasType @x0
Tm_type)
(Valid (Prims.hasEq @x0)))
...
:pattern ((Prims.hasEq (ExtTest1.evenlist @x0)))
:qid assumption_ExtTest1.evenlist__uu___haseq))
:named assumption_ExtTest1.evenlist__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ExtTest1.evenlist; Namespace ExtTest1; Name ExtTest1.ENil; Namespace ExtTest1; Name ExtTest1.ECons; Namespace ExtTest1; Name ExtTest1.oddlist; Namespace ExtTest1; Name ExtTest1.OCons; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(133,4-133,11); use=ExtTest1.fst(133,4-133,11)
...
; Starting query at ExtTest1.fst(132,12-132,14)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (projectee: _: ExtTest1.evenlist a {ECons? _}).
;   (*  - Could not prove post-condition
...
Tm_type)
(HasType @x1
(Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0 @x0))

;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,12-132,14)
(not 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,12-132,14)
(BoxBool_proj_0 (ExtTest1.uu___is_ECons @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.__proj__ECons__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0
...
; encoding sigelt val ExtTest1.__proj__ECons__item__tl


; <Start encoding val ExtTest1.__proj__ECons__item__tl>


(declare-fun ExtTest1.__proj__ECons__item__tl (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: evenlist a {ECons? _} -> oddlist a
(declare-fun Tm_arrow_cb72f90659221961dfc0d60d40daec68 () Term)
(declare-fun ExtTest1.__proj__ECons__item__tl@tok () Term)

; </end encoding val ExtTest1.__proj__ECons__item__tl>

(push) ;; push{2

; Starting query at ExtTest1.fst(132,20-132,22)
...
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,20-132,22)
(not 
;; def=ExtTest1.fst(132,4-132,9); use=ExtTest1.fst(132,20-132,22)
(BoxBool_proj_0 (ExtTest1.uu___is_ECons @x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.__proj__ECons__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_e20ce8993c26b104b7973ee87cf7aeb0
...
; encoding sigelt val ExtTest1.uu___is_OCons


; <Start encoding val ExtTest1.uu___is_OCons>

(declare-fun ExtTest1.uu___is_OCons (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: oddlist a -> Prims.bool
(declare-fun Tm_arrow_ebb050b462e8ca449d2a0ba0664a86d4 () Term)
(declare-fun ExtTest1.uu___is_OCons@tok () Term)

; </end encoding val ExtTest1.uu___is_OCons>
...
; encoding sigelt val ExtTest1.__proj__OCons__item__hd


; <Start encoding val ExtTest1.__proj__OCons__item__hd>

(declare-fun ExtTest1.__proj__OCons__item__hd (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: oddlist a -> a
(declare-fun Tm_arrow_30838449ff7afc9cfaec8dafdb0aa227 () Term)
(declare-fun ExtTest1.__proj__OCons__item__hd@tok () Term)

; </end encoding val ExtTest1.__proj__OCons__item__hd>
...
; encoding sigelt val ExtTest1.__proj__OCons__item__tl


; <Start encoding val ExtTest1.__proj__OCons__item__tl>

(declare-fun ExtTest1.__proj__OCons__item__tl (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: oddlist a -> evenlist a
(declare-fun Tm_arrow_98e239e1bd6d29fd32f81406835319e1 () Term)
(declare-fun ExtTest1.__proj__OCons__item__tl@tok () Term)

; </end encoding val ExtTest1.__proj__OCons__item__tl>
...
(declare-fun ExtTest1.someLemmaStatement () Term)
;;;;;;;;;;;;;;;;_: nnat -> _: nnat -> Prims.unit
(declare-fun Tm_arrow_c36fee0c2a09cc5fc145aa14e566eabb () Term)
...
(declare-fun ExtTest1.trivialLemmaSatement () Term)
(declare-fun Tm_refine_dea048d4f3c48100478c1d8d889cea9b (Term Term) Term)
;;;;;;;;;;;;;;;;n: nnat -> m: nnat -> FStar.Pervasives.Lemma (ensures add n m == add m n)
(declare-fun Tm_arrow_5d76daa26233d4dbe51cf256cd40b731 () Term)

; </end encoding let trivialLemmaSatement>


; encoding sigelt val ExtTest1.add0Comm


; <Skipped val ExtTest1.add0Comm/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ExtTest1.add; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(56,8-56,11); use=ExtTest1.fst(56,8-56,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x2
ExtTest1.nnat))
(HasType (ExtTest1.add.fuel_instrumented @u0
@x1
@x2)
ExtTest1.nnat))
 

:pattern ((ExtTest1.add.fuel_instrumented @u0
@x1
@x2))
:qid token_correspondence_ExtTest1.add.fuel_instrumented))

:named token_correspondence_ExtTest1.add.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: ExtTest1.add
;;; Fact-ids: Name ExtTest1.add; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(56,8-56,11); use=ExtTest1.fst(56,8-56,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
...
(HasType @x2
ExtTest1.nnat))
(= (ExtTest1.add.fuel_instrumented (SFuel @u0)
@x1
@x2)
(let ((@lb3 @x1))
(ite (is-ExtTest1.O @lb3)
@x2
(ite (is-ExtTest1.S @lb3)
(ExtTest1.S (ExtTest1.add.fuel_instrumented @u0
(ExtTest1.S__0 @lb3)
@x2))
Tm_unit)))))
 :weight 0
...
:pattern ((ExtTest1.add.fuel_instrumented (SFuel @u0)
@x1
@x2))
:qid equation_with_fuel_ExtTest1.add.fuel_instrumented))

:named equation_with_fuel_ExtTest1.add.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name ExtTest1.add; Namespace ExtTest1
(assert (! 
;; def=ExtTest1.fst(56,8-56,11); use=ExtTest1.fst(56,8-56,11)
...
@x1
@x2)
(ExtTest1.add.fuel_instrumented ZFuel
@x1
@x2))
...
@x1
@x2))
:qid @fuel_irrelevance_ExtTest1.add.fuel_instrumented))

:named @fuel_irrelevance_ExtTest1.add.fuel_instrumented))
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (ExtTest1.add @x0
@x1)
(ExtTest1.add.fuel_instrumented MaxFuel
@x0
@x1))
...
:pattern ((ExtTest1.add @x0
@x1))
:qid @fuel_correspondence_ExtTest1.add.fuel_instrumented))

:named @fuel_correspondence_ExtTest1.add.fuel_instrumented))
(push) ;; push{2

; Starting query at ExtTest1.fst(145,0-147,21)

;;;;;;;;;;;;;;;;n : ExtTest1.nnat (ExtTest1.nnat)
(declare-fun x_a8b5e426a09ec12a88cf341e4c26379c_0 () Term)
;;;;;;;;;;;;;;;;binder_x_a8b5e426a09ec12a88cf341e4c26379c_0
;;; Fact-ids: 
(assert (! (HasType x_a8b5e426a09ec12a88cf341e4c26379c_0
...
:named binder_x_a8b5e426a09ec12a88cf341e4c26379c_0))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ExtTest1.add0Comm (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ExtTest1.add0Comm@tok () Term)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;       ExtTest1.add n ExtTest1.O == ExtTest1.add ExtTest1.O n ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(O? n) /\ ~(S? n) ==> Prims.l_False) /\
;       (n == ExtTest1.O ==> (forall (any_result: Prims.unit). k any_result)) /\
;       (~(O? n) ==>
;         (forall (b: ExtTest1.nnat).
;             n == ExtTest1.S b ==>
;             b << n /\
;             (forall (any_result: ExtTest1.nnat).
;                 b == any_result ==>
;                 (forall (pure_result: Prims.unit).
;                     ExtTest1.add b ExtTest1.O == ExtTest1.add ExtTest1.O b ==> k pure_result)))))
...
;;; Fact-ids: 
(assert (! (not 
;; def=ExtTest1.fst(145,0-147,21); use=ExtTest1.fst(145,0-147,21)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=ExtTest1.fst(145,0-147,21)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=ExtTest1.fst(143,32-143,52); use=ExtTest1.fst(145,0-147,21)
(or label_2

;; def=ExtTest1.fst(143,32-143,52); use=ExtTest1.fst(145,0-147,21)
(= (ExtTest1.add x_a8b5e426a09ec12a88cf341e4c26379c_0
ExtTest1.O@tok)
(ExtTest1.add ExtTest1.O@tok
x_a8b5e426a09ec12a88cf341e4c26379c_0))
)
)

;; def=Prims.fst(441,83-441,96); use=ExtTest1.fst(145,0-147,21)
(Valid 
;; def=Prims.fst(441,83-441,96); use=ExtTest1.fst(145,0-147,21)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=ExtTest1.fst(145,0-147,21)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=ExtTest1.fst(145,0-147,21)
(Valid 
;; def=Prims.fst(402,73-402,79); use=ExtTest1.fst(145,0-147,21)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=ExtTest1.fst(145,0-147,21)
(Valid 
;; def=Prims.fst(402,84-402,87); use=ExtTest1.fst(145,0-147,21)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=ExtTest1.fst(145,0-147,21)
(and (implies 
;; def=ExtTest1.fst(144,17-144,18); use=ExtTest1.fst(145,6-145,7)
(and 
;; def=ExtTest1.fst(144,17-144,18); use=ExtTest1.fst(145,6-145,7)
(not 
;; def=ExtTest1.fst(144,17-144,18); use=ExtTest1.fst(145,6-145,7)
...
label_3)
(implies 
;; def=ExtTest1.fst(144,17-146,3); use=ExtTest1.fst(145,6-146,3)
(= x_a8b5e426a09ec12a88cf341e4c26379c_0
ExtTest1.O@tok)


;; def=Prims.fst(451,66-451,102); use=ExtTest1.fst(145,0-147,21)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=ExtTest1.fst(145,0-147,21)
(Valid 
;; def=Prims.fst(451,90-451,102); use=ExtTest1.fst(145,0-147,21)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=ExtTest1.fst(145,0-147,21)
(not 
;; def=ExtTest1.fst(144,17-144,18); use=ExtTest1.fst(145,6-145,7)
(BoxBool_proj_0 (ExtTest1.uu___is_O x_a8b5e426a09ec12a88cf341e4c26379c_0))
)
...
;; def=Prims.fst(413,99-413,120); use=ExtTest1.fst(145,0-147,21)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
ExtTest1.nnat)

;; def=ExtTest1.fst(144,17-147,6); use=ExtTest1.fst(145,6-147,6)
(= x_a8b5e426a09ec12a88cf341e4c26379c_0
(ExtTest1.S @x2))
)
...
;; def=Prims.fst(459,77-459,89); use=ExtTest1.fst(145,0-147,21)
(and 
;; def=ExtTest1.fst(145,0-147,21); use=ExtTest1.fst(147,19-147,21)
(or label_4
...
;; def=ExtTest1.fst(143,16-147,6); use=ExtTest1.fst(145,0-147,21)
(= @x2
@x3)
)

;; def=Prims.fst(441,36-441,97); use=ExtTest1.fst(147,10-147,18)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=ExtTest1.fst(143,32-143,52); use=ExtTest1.fst(147,10-147,18)
(= (ExtTest1.add @x2
ExtTest1.O@tok)
(ExtTest1.add ExtTest1.O@tok
@x2))
...
;; def=Prims.fst(441,83-441,96); use=ExtTest1.fst(147,10-147,18)
(Valid 
;; def=Prims.fst(441,83-441,96); use=ExtTest1.fst(147,10-147,18)
(ApplyTT @x1
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ExtTest1.add0Comm, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_ExtTest1.add.fuel_instrumented, @fuel_irrelevance_ExtTest1.add.fuel_instrumented, @query, ExtTest1_pretyping_a8b5e426a09ec12a88cf341e4c26379c, binder_x_a8b5e426a09ec12a88cf341e4c26379c_0, constructor_distinct_ExtTest1.O, constructor_distinct_ExtTest1.S, disc_equation_ExtTest1.O, disc_equation_ExtTest1.S, equality_tok_ExtTest1.O@tok, equation_with_fuel_ExtTest1.add.fuel_instrumented, fuel_guarded_inversion_ExtTest1.nnat, projection_inverse_BoxBool_proj_0, projection_inverse_ExtTest1.S__0, subterm_ordering_ExtTest1.S, typing_tok_ExtTest1.O@tok
...
; encoding sigelt val ExtTest1.add0CommUse


; <Skipped val ExtTest1.add0CommUse/>
...
(declare-fun ExtTest1.add0CommUse (Term) Term)
;;;;;;;;;;;;;;;;n: nnat -> Prims.unit
(declare-fun Tm_arrow_89ef1f84716629657b8efd345d914745 () Term)
(declare-fun ExtTest1.add0CommUse@tok () Term)

; </end encoding let add0CommUse>


; encoding sigelt val ExtTest1.add0CommUse2


; <Skipped val ExtTest1.add0CommUse2/>
...
(declare-fun ExtTest1.add0CommUse2 (Term) Term)

(declare-fun ExtTest1.add0CommUse2@tok () Term)

; </end encoding let add0CommUse2>


; encoding sigelt val ExtTest1.unitAsNat


; <Skipped val ExtTest1.unitAsNat/>
...
(declare-fun ExtTest1.unitAsNat (Term) Term)
;;;;;;;;;;;;;;;;u20: Prims.unit -> nnat
(declare-fun Tm_arrow_7791d909bd4f0b79d25a598fce4c4ac0 () Term)
(declare-fun ExtTest1.unitAsNat@tok () Term)

; </end encoding let unitAsNat>


; encoding sigelt val ExtTest1.add0CommUse3


; <Skipped val ExtTest1.add0CommUse3/>
...
(declare-fun ExtTest1.add0CommUse3 (Term) Term)

(declare-fun ExtTest1.add0CommUse3@tok () Term)

; </end encoding let add0CommUse3>


; encoding sigelt val ExtTest1.add0CommAlias


; <Skipped val ExtTest1.add0CommAlias/>
...
(declare-fun ExtTest1.add0CommAlias (Term) Term)

(declare-fun ExtTest1.add0CommAlias@tok () Term)

; </end encoding let add0CommAlias>


; encoding sigelt val ExtTest1.mult2


; <Skipped val ExtTest1.mult2/>

(push) ;; push{2

; Starting query at ExtTest1.fst(173,0-175,28)
...
ExtTest1.nnat)
:named binder_x_a8b5e426a09ec12a88cf341e4c26379c_1))
(declare-fun Tm_refine_368444a94a585efef7d3a79def583f06 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(171,12-175,28); use=ExtTest1.fst(171,12-175,28)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_368444a94a585efef7d3a79def583f06 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_368444a94a585efef7d3a79def583f06 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_368444a94a585efef7d3a79def583f06))

:named refinement_kinding_Tm_refine_368444a94a585efef7d3a79def583f06))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(171,12-175,28); use=ExtTest1.fst(171,12-175,28)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_368444a94a585efef7d3a79def583f06 @x2))
(and (HasTypeFuel @u0
@x1
ExtTest1.nnat)
...
;; def=ExtTest1.fst(171,12-175,28); use=ExtTest1.fst(171,12-175,28)
(or 
;; def=ExtTest1.fst(173,0-175,28); use=ExtTest1.fst(173,0-175,28)
(Valid 
;; def=ExtTest1.fst(173,0-175,28); use=ExtTest1.fst(173,0-175,28)
(Prims.precedes ExtTest1.nnat
ExtTest1.nnat
...
;; def=ExtTest1.fst(171,12-175,28); use=ExtTest1.fst(171,12-175,28)
(and 
;; def=ExtTest1.fst(171,12-172,15); use=ExtTest1.fst(171,12-172,15)
(Valid 
;; def=ExtTest1.fst(171,12-172,15); use=ExtTest1.fst(171,12-172,15)
(Prims.op_Equals_Equals_Equals ExtTest1.nnat
ExtTest1.nnat
...
@x1
(Tm_refine_368444a94a585efef7d3a79def583f06 @x2)))
:qid refinement_interpretation_Tm_refine_368444a94a585efef7d3a79def583f06))

:named refinement_interpretation_Tm_refine_368444a94a585efef7d3a79def583f06))
;;;;;;;;;;;;;;;;haseq for Tm_refine_368444a94a585efef7d3a79def583f06
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(171,12-175,28); use=ExtTest1.fst(171,12-175,28)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_368444a94a585efef7d3a79def583f06 @x0)))
(Valid (Prims.hasEq ExtTest1.nnat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_368444a94a585efef7d3a79def583f06 @x0))))
:qid haseqTm_refine_368444a94a585efef7d3a79def583f06))

:named haseqTm_refine_368444a94a585efef7d3a79def583f06))
(declare-fun ExtTest1.mult2 (Term Term) Term)

;;;;;;;;;;;;;;;;a: nnat -> b: nnat{a << a \/ a === a /\ b << b} -> nnat
(declare-fun Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0
Tm_type)
:named kinding_Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(171,12-175,28); use=ExtTest1.fst(171,12-175,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0))
:qid ExtTest1_pre_typing_Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0))

:named ExtTest1_pre_typing_Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(171,12-175,28); use=ExtTest1.fst(171,12-175,28)
(forall ((@x0 Term))
...
ExtTest1.nnat)
(HasType @x2
(Tm_refine_368444a94a585efef7d3a79def583f06 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
ExtTest1.nnat))
...
@x1)
@x2))
:qid ExtTest1_interpretation_Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ExtTest1_interpretation_Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0))
:qid ExtTest1_interpretation_Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0))

:named ExtTest1_interpretation_Tm_arrow_e53fa50d1ed6eb473b0a0abf395be8d0))
(declare-fun ExtTest1.mult2@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(172,8-172,13); use=ExtTest1.fst(172,8-172,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT ExtTest1.mult2@tok
@x0)
@x1)
(ExtTest1.mult2 @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT ExtTest1.mult2@tok
@x0)
@x1))
:qid token_correspondence_ExtTest1.mult2))

:named token_correspondence_ExtTest1.mult2))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(172,8-172,13); use=ExtTest1.fst(172,8-172,13)
...
:pattern ((ExtTest1.mult2 @x1
@x2))
:qid function_token_typing_ExtTest1.mult2.1))
)
 

:pattern ((ApplyTT @x0
ExtTest1.mult2@tok))
:qid function_token_typing_ExtTest1.mult2))

:named function_token_typing_ExtTest1.mult2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=ExtTest1.fst(172,8-172,13); use=ExtTest1.fst(172,8-172,13)
...
ExtTest1.nnat)
(HasType @x1
(Tm_refine_368444a94a585efef7d3a79def583f06 @x0)))
(HasType (ExtTest1.mult2 @x0
@x1)
ExtTest1.nnat))
 

:pattern ((ExtTest1.mult2 @x0
@x1))
:qid typing_ExtTest1.mult2))

:named typing_ExtTest1.mult2))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;; def=Prims.fst(402,27-402,88); use=ExtTest1.fst(173,0-175,28)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=ExtTest1.fst(173,0-175,28)
(Valid 
;; def=Prims.fst(402,84-402,87); use=ExtTest1.fst(173,0-175,28)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=ExtTest1.fst(173,0-175,28)
(and (implies 
;; def=ExtTest1.fst(172,14-172,15); use=ExtTest1.fst(173,6-173,7)
(and 
;; def=ExtTest1.fst(172,14-172,15); use=ExtTest1.fst(173,6-173,7)
(not 
;; def=ExtTest1.fst(172,14-172,15); use=ExtTest1.fst(173,6-173,7)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=ExtTest1.fst(173,0-175,28)
(not 
;; def=ExtTest1.fst(172,14-172,15); use=ExtTest1.fst(173,6-173,7)
(BoxBool_proj_0 (ExtTest1.uu___is_O x_a8b5e426a09ec12a88cf341e4c26379c_0))
)
...
;; def=Prims.fst(413,99-413,120); use=ExtTest1.fst(173,0-175,28)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
ExtTest1.nnat)

;; def=ExtTest1.fst(172,14-175,6); use=ExtTest1.fst(173,6-175,6)
(= x_a8b5e426a09ec12a88cf341e4c26379c_0
(ExtTest1.S @x1))
)

;; def=ExtTest1.fst(171,12-175,28); use=ExtTest1.fst(175,26-175,27)
(or label_2

;; def=ExtTest1.fst(173,0-175,28); use=ExtTest1.fst(175,26-175,27)
(Valid 
;; def=ExtTest1.fst(173,0-175,28); use=ExtTest1.fst(175,26-175,27)
(Prims.precedes ExtTest1.nnat
ExtTest1.nnat
...
;; def=ExtTest1.fst(171,12-175,28); use=ExtTest1.fst(175,26-175,27)
(and 
;; def=ExtTest1.fst(171,12-172,15); use=ExtTest1.fst(175,26-175,27)
(Valid 
;; def=ExtTest1.fst(171,12-172,15); use=ExtTest1.fst(175,26-175,27)
(Prims.op_Equals_Equals_Equals ExtTest1.nnat
ExtTest1.nnat
