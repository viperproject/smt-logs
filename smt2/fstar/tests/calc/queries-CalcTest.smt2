...
; Starting query at CalcTest.fst(6,41-6,43)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Prims.pos).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). 2 * a > a ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lem1`
...
;; def=Prims.fst(441,36-441,97); use=CalcTest.fst(6,41-6,43)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=CalcTest.fst(6,27-6,38); use=CalcTest.fst(6,41-6,43)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=CalcTest.fst(6,41-6,43)
(Valid 
;; def=Prims.fst(441,83-441,96); use=CalcTest.fst(6,41-6,43)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcTest.lem1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.pos, primitive_Prims.op_Multiply, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5
...
; encoding sigelt let lem1


; <Start encoding let lem1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CalcTest.lem1 (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CalcTest.lem1@tok () Term)

; </end encoding let lem1>
...
; Starting query at CalcTest.fst(9,2-15,3)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;x6: Prims.int -> y7: Prims.int -> Type
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(570,20-570,23); use=CalcTest.fst(9,2-15,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))
:qid CalcTest_pre_typing_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))

:named CalcTest_pre_typing_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))
...
@x1)
@x2))
:qid CalcTest_interpretation_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CalcTest_interpretation_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))
:qid CalcTest_interpretation_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))

:named CalcTest_interpretation_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0))
(declare-fun Tm_abs_ea4827c179aa59f14127eb343a8b02db () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_ea4827c179aa59f14127eb343a8b02db
;;; Fact-ids: 
(assert (! (HasType Tm_abs_ea4827c179aa59f14127eb343a8b02db
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0)
:named typing_Tm_abs_ea4827c179aa59f14127eb343a8b02db))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_ea4827c179aa59f14127eb343a8b02db
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(13,5-13,5); use=CalcTest.fst(9,2-15,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_ea4827c179aa59f14127eb343a8b02db
@x0)
@x1)
...
:pattern ((ApplyTT (ApplyTT Tm_abs_ea4827c179aa59f14127eb343a8b02db
@x0)
@x1))
:qid interpretation_Tm_abs_ea4827c179aa59f14127eb343a8b02db))

:named interpretation_Tm_abs_ea4827c179aa59f14127eb343a8b02db))

(declare-fun Tm_abs_2d12df642cab58f318db60ed4861d203 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_2d12df642cab58f318db60ed4861d203
;;; Fact-ids: 
(assert (! (HasType Tm_abs_2d12df642cab58f318db60ed4861d203
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0)
:named typing_Tm_abs_2d12df642cab58f318db60ed4861d203))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2d12df642cab58f318db60ed4861d203
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(11,4-11,6); use=CalcTest.fst(9,2-15,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_2d12df642cab58f318db60ed4861d203
@x0)
@x1)
(Prims.eq2 Prims.int
@x0
...
:pattern ((ApplyTT (ApplyTT Tm_abs_2d12df642cab58f318db60ed4861d203
@x0)
@x1))
:qid interpretation_Tm_abs_2d12df642cab58f318db60ed4861d203))

:named interpretation_Tm_abs_2d12df642cab58f318db60ed4861d203))
;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.Calc.calc_pack [(fun x6 y7 -> x6 > y7 <: Type); fun x4 y5 -> x4 == y5 <: Type] (a + a) a
(declare-fun Tm_arrow_70900d71aa8d7795e066e223db598daa (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_70900d71aa8d7795e066e223db598daa
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(9,2-15,3)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_70900d71aa8d7795e066e223db598daa @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_70900d71aa8d7795e066e223db598daa @x0)
Tm_type))
:qid kinding_Tm_arrow_70900d71aa8d7795e066e223db598daa))

:named kinding_Tm_arrow_70900d71aa8d7795e066e223db598daa))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(9,2-15,3)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_70900d71aa8d7795e066e223db598daa @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_70900d71aa8d7795e066e223db598daa @x2)))
:qid CalcTest_pre_typing_Tm_arrow_70900d71aa8d7795e066e223db598daa))

:named CalcTest_pre_typing_Tm_arrow_70900d71aa8d7795e066e223db598daa))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_70900d71aa8d7795e066e223db598daa
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(9,2-15,3)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_70900d71aa8d7795e066e223db598daa @x1))
(and 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(9,2-15,3)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
Tm_abs_ea4827c179aa59f14127eb343a8b02db
(Prims.Cons (FStar.Preorder.relation Prims.int)
Tm_abs_2d12df642cab58f318db60ed4861d203
...
:pattern ((ApplyTT @x0
@x2))
:qid CalcTest_interpretation_Tm_arrow_70900d71aa8d7795e066e223db598daa.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_70900d71aa8d7795e066e223db598daa @x1)))
:qid CalcTest_interpretation_Tm_arrow_70900d71aa8d7795e066e223db598daa))

:named CalcTest_interpretation_Tm_arrow_70900d71aa8d7795e066e223db598daa))

; Encoding query formula : forall (a: Prims.pos).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). a + a > a ==> p pure_result) ==>
;     (forall (_: Prims.unit).
;         (*  - Could not prove post-condition
; *)
;         forall (_: Prims.unit).
...
;                   (fun x6 y7 -> x6 > y7 <: Type0);
;                   fun x4 y5 -> x4 == y5 <: Type0
;                 ]
;                 (a + a)
;                 a)).
...
;               (exists (w: Prims.int). (exists (w: Prims.int). x == w /\ w == w) /\ w > y) ==> x > y) /\
;         (forall (pure_result: Prims.unit). a + a > a ==> p pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let calc0`
...
;; def=Prims.fst(441,36-441,97); use=CalcTest.fst(9,2-15,3)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=CalcTest.fst(8,28-8,39); use=CalcTest.fst(9,2-15,3)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=CalcTest.fst(9,2-15,3)
(Valid 
;; def=Prims.fst(441,83-441,96); use=CalcTest.fst(9,2-15,3)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=CalcTest.fst(9,2-15,3)
(and 
;; def=dummy(0,0-0,0); use=CalcTest.fst(9,2-15,3)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)
...
;; def=CalcTest.fst(11,4-11,6); use=CalcTest.fst(11,7-11,9)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=CalcTest.fst(9,2-15,3)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Tm_arrow_70900d71aa8d7795e066e223db598daa @x0))

;; def=Prims.fst(441,29-441,97); use=CalcTest.fst(9,2-15,3)
(and 
...
;; def=CalcTest.fst(9,7-9,10); use=CalcTest.fst(9,2-15,3)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcTest.calc0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.pos, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_Multiply, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5
...
; encoding sigelt let calc0


; <Start encoding let calc0>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CalcTest.calc0 (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CalcTest.calc0@tok () Term)

; </end encoding let calc0>

(push) ;; push{2

; Starting query at CalcTest.fst(20,2-26,3)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(570,20-570,23); use=CalcTest.fst(20,2-26,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0)
...
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(21,26-21,33); use=CalcTest.fst(20,2-26,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_ea4827c179aa59f14127eb343a8b02db
@x0)
@x1)
...
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(22,28-22,36); use=CalcTest.fst(20,2-26,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_2d12df642cab58f318db60ed4861d203
@x0)
@x1)
...
:named interpretation_Tm_abs_2d12df642cab58f318db60ed4861d203))
;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.Calc.calc_pack [(fun x y -> x > y <: Type); fun x y -> x == y <: Type] (a + a) a
(declare-fun Tm_arrow_70900d71aa8d7795e066e223db598daa (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_70900d71aa8d7795e066e223db598daa
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(20,2-26,3)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_70900d71aa8d7795e066e223db598daa @x0)
Tm_type)
...
;     (forall (any_result:
;         (_: Prims.unit
;             -> FStar.Calc.calc_pack [(fun x y -> x > y <: Type0); fun x y -> x == y <: Type0]
;                 (a + a)
;                 a)).
;         FStar.Range.labeled (FStar.Sealed.seal FStar.Calc.fsti(86,37-86,50))
;           "Could not prove that this calc-chain is compatible"
...
; Context: While encoding a query
; While typechecking the top-level declaration `let calc0_desugared`
...
;; def=Prims.fst(441,36-441,97); use=CalcTest.fst(20,2-26,3)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=CalcTest.fst(19,38-19,49); use=CalcTest.fst(20,2-26,3)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=CalcTest.fst(20,2-26,3)
(Valid 
;; def=Prims.fst(441,83-441,96); use=CalcTest.fst(20,2-26,3)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=CalcTest.fst(20,2-26,3)
(and 
;; def=dummy(0,0-0,0); use=CalcTest.fst(20,2-26,3)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=dummy(0,0-0,0); use=CalcTest.fst(21,4-25,24)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=dummy(0,0-0,0); use=CalcTest.fst(22,6-24,22)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.unit)

;; def=CalcTest.fst(22,28-22,36); use=CalcTest.fst(24,19-24,21)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=CalcTest.fst(20,2-26,3)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Tm_arrow_70900d71aa8d7795e066e223db598daa @x0))

;; def=Prims.fst(441,29-441,97); use=CalcTest.fst(20,2-20,13)
(and 
;; def=FStar.Calc.fsti(47,4-47,55); use=FStar.Calc.fsti(47,4-47,55)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
...
;; def=CalcTest.fst(22,28-22,36); use=CalcTest.fst(20,2-20,13)
(= @x6
@x5)
)
...
;; def=CalcTest.fst(21,26-21,33); use=CalcTest.fst(20,2-20,13)
(> (BoxInt_proj_0 @x5)
(BoxInt_proj_0 @x4))
)
...
;; def=CalcTest.fst(20,26-20,33); use=CalcTest.fst(20,2-20,13)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=CalcTest.fst(20,2-20,13)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)
...
;; def=Prims.fst(441,83-441,96); use=CalcTest.fst(20,2-20,13)
(Valid 
;; def=Prims.fst(441,83-441,96); use=CalcTest.fst(20,2-20,13)
(ApplyTT @x1
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcTest.calc0_desugared, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.pos, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_Multiply, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5
...
; encoding sigelt let calc0_desugared


; <Start encoding let calc0_desugared>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CalcTest.calc0_desugared (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CalcTest.calc0_desugared@tok () Term)

; </end encoding let calc0_desugared>
...
; Starting query at CalcTest.fst(32,2-46,3)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(29,24-29,48); use=CalcTest.fst(29,24-29,48)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc))

:named refinement_kinding_Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(29,24-29,48); use=CalcTest.fst(29,24-29,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=Prims.fst(635,71-635,97); use=CalcTest.fst(29,24-29,48)
(not 
;; def=Prims.fst(441,29-441,97); use=CalcTest.fst(29,24-29,29)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=CalcTest.fst(29,30-29,48); use=CalcTest.fst(29,24-29,29)
...
;; def=Prims.fst(635,86-635,95); use=CalcTest.fst(29,24-29,48)
(not 
;; def=Prims.fst(635,86-635,95); use=CalcTest.fst(29,24-29,48)
(= @x4
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc.1))
)
))
...
(Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc @x2
@x3)))
:qid refinement_interpretation_Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc))

:named refinement_interpretation_Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(29,24-29,48); use=CalcTest.fst(29,24-29,48)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc @x0
@x1))))
:qid haseqTm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc))

:named haseqTm_refine_e79d4741fe8af7b6d6e1d15ce6223bbc))
;;;;;;;;;;;;;;;;_: Prims.unit -> FStar.Pervasives.Lemma (ensures a * (c + 1) = 24)
(declare-fun Tm_arrow_d2d066811fa2658b6666642aab706063 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d2d066811fa2658b6666642aab706063
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(29,16-29,48); use=CalcTest.fst(29,16-29,48)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_d2d066811fa2658b6666642aab706063 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_d2d066811fa2658b6666642aab706063 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_d2d066811fa2658b6666642aab706063))

:named kinding_Tm_arrow_d2d066811fa2658b6666642aab706063))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(29,16-29,48); use=CalcTest.fst(29,16-29,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_d2d066811fa2658b6666642aab706063 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_d2d066811fa2658b6666642aab706063 @x2
@x3)))
:qid CalcTest_pre_typing_Tm_arrow_d2d066811fa2658b6666642aab706063))

:named CalcTest_pre_typing_Tm_arrow_d2d066811fa2658b6666642aab706063))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d2d066811fa2658b6666642aab706063
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(29,16-29,48); use=CalcTest.fst(29,16-29,48)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_d2d066811fa2658b6666642aab706063 @x1
@x2))
(and 
;; def=CalcTest.fst(29,16-29,48); use=CalcTest.fst(29,16-29,48)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid CalcTest_interpretation_Tm_arrow_d2d066811fa2658b6666642aab706063.1))
...
(Tm_arrow_d2d066811fa2658b6666642aab706063 @x1
@x2)))
:qid CalcTest_interpretation_Tm_arrow_d2d066811fa2658b6666642aab706063))

:named CalcTest_interpretation_Tm_arrow_d2d066811fa2658b6666642aab706063))
(declare-fun Tm_refine_b474ff7d64e93784e6458287b2a7f358 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(30,24-30,43); use=CalcTest.fst(30,24-30,43)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_b474ff7d64e93784e6458287b2a7f358 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_b474ff7d64e93784e6458287b2a7f358 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_b474ff7d64e93784e6458287b2a7f358))

:named refinement_kinding_Tm_refine_b474ff7d64e93784e6458287b2a7f358))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(30,24-30,43); use=CalcTest.fst(30,24-30,43)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b474ff7d64e93784e6458287b2a7f358 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=Prims.fst(635,71-635,97); use=CalcTest.fst(30,24-30,43)
(not 
;; def=Prims.fst(441,29-441,97); use=CalcTest.fst(30,24-30,29)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=CalcTest.fst(30,30-30,43); use=CalcTest.fst(30,24-30,29)
(= (Prims.op_Addition @x2
@x3)
(BoxInt 25))
)

;; def=Prims.fst(635,86-635,95); use=CalcTest.fst(30,24-30,43)
(not 
;; def=Prims.fst(635,86-635,95); use=CalcTest.fst(30,24-30,43)
(= @x4
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_b474ff7d64e93784e6458287b2a7f358.1))
)
))
...
(Tm_refine_b474ff7d64e93784e6458287b2a7f358 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_b474ff7d64e93784e6458287b2a7f358))

:named refinement_interpretation_Tm_refine_b474ff7d64e93784e6458287b2a7f358))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b474ff7d64e93784e6458287b2a7f358
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(30,24-30,43); use=CalcTest.fst(30,24-30,43)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b474ff7d64e93784e6458287b2a7f358 @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b474ff7d64e93784e6458287b2a7f358 @x0
@x1))))
:qid haseqTm_refine_b474ff7d64e93784e6458287b2a7f358))

:named haseqTm_refine_b474ff7d64e93784e6458287b2a7f358))
;;;;;;;;;;;;;;;;_: Prims.unit -> FStar.Pervasives.Lemma (ensures b + d == 25)
(declare-fun Tm_arrow_46db6a96236e2b5254792df772fae5ad (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_46db6a96236e2b5254792df772fae5ad
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(30,16-30,43); use=CalcTest.fst(30,16-30,43)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_46db6a96236e2b5254792df772fae5ad @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_46db6a96236e2b5254792df772fae5ad @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_46db6a96236e2b5254792df772fae5ad))

:named kinding_Tm_arrow_46db6a96236e2b5254792df772fae5ad))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(30,16-30,43); use=CalcTest.fst(30,16-30,43)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_46db6a96236e2b5254792df772fae5ad @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_46db6a96236e2b5254792df772fae5ad @x2
@x3)))
:qid CalcTest_pre_typing_Tm_arrow_46db6a96236e2b5254792df772fae5ad))

:named CalcTest_pre_typing_Tm_arrow_46db6a96236e2b5254792df772fae5ad))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_46db6a96236e2b5254792df772fae5ad
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(30,16-30,43); use=CalcTest.fst(30,16-30,43)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_46db6a96236e2b5254792df772fae5ad @x1
@x2))
(and 
;; def=CalcTest.fst(30,16-30,43); use=CalcTest.fst(30,16-30,43)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid CalcTest_interpretation_Tm_arrow_46db6a96236e2b5254792df772fae5ad.1))
...
(Tm_arrow_46db6a96236e2b5254792df772fae5ad @x1
@x2)))
:qid CalcTest_interpretation_Tm_arrow_46db6a96236e2b5254792df772fae5ad))

:named CalcTest_interpretation_Tm_arrow_46db6a96236e2b5254792df772fae5ad))
;;;;;;;;;;;;;;;;x14: Prims.int -> y15: Prims.int -> Type
(declare-fun Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(546,38-546,41); use=CalcTest.fst(32,2-46,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0)
...
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(34,3-34,5); use=CalcTest.fst(32,2-46,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_2d12df642cab58f318db60ed4861d203
@x0)
@x1)
...
:named interpretation_Tm_abs_2d12df642cab58f318db60ed4861d203))
;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.Calc.calc_pack [fun x14 y15 -> x14 == y15 <: Type]       (a + b + a * c + d - (e - e))       (a + a * c + b + d)
(declare-fun Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcTest.fst(32,2-46,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2 @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid kinding_Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2))

:named kinding_Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcTest.fst(32,2-46,3)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2 @x2
@x3
@x4
@x5
@x6))
...
@x5
@x6)))
:qid CalcTest_pre_typing_Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2))

:named CalcTest_pre_typing_Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcTest.fst(32,2-46,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2 @x1
@x2
@x3
@x4
@x5))
...
Tm_abs_2d12df642cab58f318db60ed4861d203
(Prims.Nil (FStar.Preorder.relation Prims.int)))
(Prims.op_Subtraction (Prims.op_Addition (Prims.op_Addition (Prims.op_Addition @x5
@x4)
...
@x1))
(Prims.op_Addition (Prims.op_Addition (Prims.op_Addition @x5
(Prims.op_Multiply @x5
@x3))
@x4)
@x2))))
...
:pattern ((ApplyTT @x0
@x6))
:qid CalcTest_interpretation_Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2.1))
...
@x4
@x5)))
:qid CalcTest_interpretation_Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2))

:named CalcTest_interpretation_Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2))




;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.Calc.calc_pack [(fun x16 y17 -> x16 == y17 <: Type); fun x14 y15 -> x14 == y15 <: Type]       (a + b + a * c + d - (e - e))       (a * (c + 1) + b + d)
(declare-fun Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcTest.fst(32,2-46,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid kinding_Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed))

:named kinding_Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcTest.fst(32,2-46,3)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed @x2
@x3
@x4
@x5
@x6))
...
@x5
@x6)))
:qid CalcTest_pre_typing_Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed))

:named CalcTest_pre_typing_Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcTest.fst(32,2-46,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed @x1
@x2
@x3
@x4
@x5))
...
(Prims.op_Subtraction @x1
@x1))
(Prims.op_Addition (Prims.op_Addition (Prims.op_Multiply @x5
(Prims.op_Addition @x3
(BoxInt 1)))
@x4)
@x2))))
...
:pattern ((ApplyTT @x0
@x6))
:qid CalcTest_interpretation_Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed.1))
...
@x4
@x5)))
:qid CalcTest_interpretation_Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed))

:named CalcTest_interpretation_Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed))
...
;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.Calc.calc_pack [         (fun x18 y19 -> x18 == y19 <: Type);         (fun x16 y17 -> x16 == y17 <: Type);         fun x14 y15 -> x14 == y15 <: Type       ]       (a + b + a * c + d - (e - e))       (24 + b + d)
(declare-fun Tm_arrow_b631087a41bc0a10445b2c101fbb8c58 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b631087a41bc0a10445b2c101fbb8c58
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcTest.fst(32,2-46,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_arrow_b631087a41bc0a10445b2c101fbb8c58 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_arrow_b631087a41bc0a10445b2c101fbb8c58 @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid kinding_Tm_arrow_b631087a41bc0a10445b2c101fbb8c58))

:named kinding_Tm_arrow_b631087a41bc0a10445b2c101fbb8c58))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcTest.fst(32,2-46,3)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_b631087a41bc0a10445b2c101fbb8c58 @x2
@x3
@x4
@x5
@x6))
...
@x5
@x6)))
:qid CalcTest_pre_typing_Tm_arrow_b631087a41bc0a10445b2c101fbb8c58))

:named CalcTest_pre_typing_Tm_arrow_b631087a41bc0a10445b2c101fbb8c58))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b631087a41bc0a10445b2c101fbb8c58
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(69,6-69,36); use=CalcTest.fst(32,2-46,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_b631087a41bc0a10445b2c101fbb8c58 @x1
@x2
@x3
@x4
@x5))
...
(Prims.op_Subtraction @x1
@x1))
(Prims.op_Addition (Prims.op_Addition (BoxInt 24)
@x4)
@x2))))
...
:pattern ((ApplyTT @x0
@x6))
:qid CalcTest_interpretation_Tm_arrow_b631087a41bc0a10445b2c101fbb8c58.1))
...
@x4
@x5)))
:qid CalcTest_interpretation_Tm_arrow_b631087a41bc0a10445b2c101fbb8c58))

:named CalcTest_interpretation_Tm_arrow_b631087a41bc0a10445b2c101fbb8c58))
...
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(44,4-44,4); use=CalcTest.fst(32,2-46,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_ea4827c179aa59f14127eb343a8b02db
@x0)
@x1)
...
;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.Calc.calc_pack [         (fun x24 y25 -> x24 > y25 <: Type);         (fun x22 y23 -> x22 == y23 <: Type);         (fun x20 y21 -> x20 == y21 <: Type);         (fun x18 y19 -> x18 == y19 <: Type);         (fun x16 y17 -> x16 == y17 <: Type);         fun x14 y15 -> x14 == y15 <: Type       ]       (a + b + a * c + d - (e - e))       30
(declare-fun Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(32,2-46,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22 @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid kinding_Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22))

:named kinding_Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(32,2-46,3)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22 @x2
@x3
@x4
@x5
@x6))
...
@x5
@x6)))
:qid CalcTest_pre_typing_Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22))

:named CalcTest_pre_typing_Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(32,2-46,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22 @x1
@x2
@x3
@x4
@x5))
...
:pattern ((ApplyTT @x0
@x6))
:qid CalcTest_interpretation_Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22.1))
...
@x4
@x5)))
:qid CalcTest_interpretation_Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22))

:named CalcTest_interpretation_Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22))
...
;   (d: Prims.int)
;   (e: Prims.int)
;   (h1: (_: Prims.unit -> FStar.Pervasives.Lemma (ensures a * (c + 1) = 24)))
;   (h2: (_: Prims.unit -> FStar.Pervasives.Lemma (ensures b + d == 25))).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). a + b + a * c + d - (e - e) > 30 ==> p pure_result) ==>
;     (forall (_: Prims.unit).
;         (*  - Could not prove post-condition
; *)
;         forall (_: Prims.unit).
...
;                 (*  - Could not prove post-condition
; *)
;                 forall (pure_result: Prims.unit). b + d == 25 ==> 24 + b + d == 49)) /\
;     (forall (any_result:
;         (_: Prims.unit
;             -> FStar.Calc.calc_pack [
;                   (fun x24 y25 -> x24 > y25 <: Type0);
...
;                           (exists (w: Prims.int).
;                               (exists (w: Prims.int).
;                                   (exists (w: Prims.int). x == w /\ w == w) /\ w == w) /\ w == w) /\
;                           w == w) /\ w == w) /\ w > y) ==>
;               x > y) /\
;         (forall (pure_result: Prims.unit). a + b + a * c + d - (e - e) > 30 ==> p pure_result))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let calc1`
...
@x0))
(HasType @x6
(Tm_arrow_46db6a96236e2b5254792df772fae5ad @x3
@x1)))
...
;; def=Prims.fst(441,36-441,97); use=CalcTest.fst(32,2-46,3)
(forall ((@x8 Term))
 (! (implies (and (or label_1
(HasType @x8
Prims.unit))

;; def=CalcTest.fst(31,15-31,49); use=CalcTest.fst(32,2-46,3)
(or label_2

;; def=CalcTest.fst(31,15-31,49); use=CalcTest.fst(32,2-46,3)
(> (BoxInt_proj_0 (Prims.op_Subtraction (Prims.op_Addition (Prims.op_Addition (Prims.op_Addition @x0
@x1)
(Prims.op_Multiply @x0
@x2))
@x3)
...
@x4)))
(BoxInt_proj_0 (BoxInt 30)))
)
)

;; def=Prims.fst(441,83-441,96); use=CalcTest.fst(32,2-46,3)
(Valid 
;; def=Prims.fst(441,83-441,96); use=CalcTest.fst(32,2-46,3)
(ApplyTT @x7
@x8)
...
;; def=Prims.fst(459,77-459,89); use=CalcTest.fst(32,2-46,3)
(and 
;; def=dummy(0,0-0,0); use=CalcTest.fst(32,2-46,3)
(forall ((@x8 Term))
 (! (implies (HasType @x8
Prims.unit)
...
;; def=CalcTest.fst(34,3-34,5); use=CalcTest.fst(34,6-34,32)
(or label_3

;; def=CalcTest.fst(34,3-34,5); use=CalcTest.fst(34,6-34,32)
(= (Prims.op_Subtraction (Prims.op_Addition (Prims.op_Addition (Prims.op_Addition @x0
@x1)
(Prims.op_Multiply @x0
@x2))
@x3)
(Prims.op_Subtraction @x4
@x4))
(Prims.op_Addition (Prims.op_Addition (Prims.op_Addition @x0
(Prims.op_Multiply @x0
@x2))
@x1)
@x3))
...
;; def=Prims.fst(451,66-451,102); use=CalcTest.fst(32,2-46,3)
(forall ((@x13 Term))
 (! (implies (HasType @x13
(Tm_arrow_dcbbc827e6fab09f883cc1838a8aacf2 @x4
@x3
@x2
@x1
@x0))
...
;; def=CalcTest.fst(36,3-36,5); use=CalcTest.fst(36,6-36,30)
(or label_4
...
@x1)
@x3)
(Prims.op_Addition (Prims.op_Addition (Prims.op_Multiply @x0
(Prims.op_Addition @x2
(BoxInt 1)))
@x1)
@x3))
...
(forall ((@x12 Term))
 (! (implies (HasType @x12
(Tm_arrow_8ff2e1e1d762126a4c584e6ea46806ed @x4
@x3
@x2
@x1
@x0))
...
;; def=Prims.fst(441,36-441,97); use=CalcTest.fst(38,8-38,10)
(forall ((@x14 Term))
 (! (implies (and (HasType @x14
Prims.unit)

;; def=CalcTest.fst(29,30-29,48); use=CalcTest.fst(38,8-38,10)
(= (Prims.op_Multiply @x0
(Prims.op_Addition @x2
(BoxInt 1)))
(BoxInt 24))
...
;; def=CalcTest.fst(38,3-38,5); use=CalcTest.fst(38,8-38,13)
(or label_5
...
(forall ((@x11 Term))
 (! (implies (HasType @x11
(Tm_arrow_b631087a41bc0a10445b2c101fbb8c58 @x4
@x3
@x2
@x1
@x0))
...
;; def=Prims.fst(441,36-441,97); use=CalcTest.fst(40,8-40,10)
(forall ((@x13 Term))
 (! (implies (and (HasType @x13
Prims.unit)

;; def=CalcTest.fst(30,30-30,43); use=CalcTest.fst(40,8-40,10)
(= (Prims.op_Addition @x1
@x3)
(BoxInt 25))
)

;; def=CalcTest.fst(40,3-40,5); use=CalcTest.fst(40,8-40,13)
(or label_6
...
(forall ((@x8 Term))
 (! (implies (HasType @x8
(Tm_arrow_5f71e60b14f8fe0c49075ff60d357a22 @x4
@x3
@x2
@x1
@x0))

;; def=Prims.fst(441,29-441,97); use=CalcTest.fst(32,2-46,3)
(and 
;; def=FStar.Calc.fsti(47,4-47,55); use=FStar.Calc.fsti(47,4-47,55)
...
;; def=CalcTest.fst(36,3-36,5); use=CalcTest.fst(32,2-46,3)
(= @x15
@x14)
)
...
;; def=CalcTest.fst(38,3-38,5); use=CalcTest.fst(32,2-46,3)
(= @x14
@x13)
)
...
;; def=CalcTest.fst(40,3-40,5); use=CalcTest.fst(32,2-46,3)
(= @x13
@x12)
)
...
;; def=CalcTest.fst(42,3-42,5); use=CalcTest.fst(32,2-46,3)
(= @x12
@x11)
)
...
;; def=CalcTest.fst(32,7-32,10); use=CalcTest.fst(32,2-46,3)
(or label_7
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcTest.calc1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_Multiply, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0
...
; encoding sigelt let calc1


; <Start encoding let calc1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CalcTest.calc1 (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CalcTest.calc1@tok () Term)

; </end encoding let calc1>

(push) ;; push{2

; Starting query at CalcTest.fst(49,2-59,3)
...
;             (exists (w: Prims.int).
;                 (exists (w: Prims.int).
;                     (exists (w: Prims.int). (exists (w: Prims.int). x == w /\ w >= w) /\ w >= w) /\
;                     w == w) /\ w >= y) ==>
;             x >= y))


; Context: While encoding a query
; While typechecking the top-level declaration `let test_ge`
...
;; def=CalcTest.fst(51,4-51,5); use=CalcTest.fst(49,2-59,3)
(>= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x5))
)
...
;; def=CalcTest.fst(53,4-53,5); use=CalcTest.fst(49,2-59,3)
(>= (BoxInt_proj_0 @x5)
(BoxInt_proj_0 @x4))
)
...
;; def=CalcTest.fst(55,3-55,5); use=CalcTest.fst(49,2-59,3)
(= @x4
@x3)
)
...
;; def=CalcTest.fst(57,4-57,5); use=CalcTest.fst(49,2-59,3)
(>= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x2))
)
...
;; def=CalcTest.fst(49,7-49,11); use=CalcTest.fst(49,2-59,3)
(or label_1
...
; encoding sigelt let test_ge


; <Start encoding let test_ge>

(declare-fun CalcTest.test_ge (Term) Term)

(declare-fun CalcTest.test_ge@tok () Term)

; </end encoding let test_ge>

(push) ;; push{2

; Starting query at CalcTest.fst(61,19-75,7)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let test_erase`
...
;; def=CalcTest.fst(65,4-65,5); use=CalcTest.fst(61,19-75,7)
(>= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x5))
)
...
;; def=CalcTest.fst(67,4-67,5); use=CalcTest.fst(61,19-75,7)
(>= (BoxInt_proj_0 @x5)
(BoxInt_proj_0 @x4))
)
...
;; def=CalcTest.fst(69,3-69,5); use=CalcTest.fst(61,19-75,7)
(= @x4
@x3)
)
...
;; def=CalcTest.fst(71,4-71,5); use=CalcTest.fst(61,19-75,7)
(>= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x2))
)
...
;; def=CalcTest.fst(63,7-63,11); use=CalcTest.fst(61,19-75,7)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcTest.test_erase, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt let test_erase


; <Start encoding let test_erase>

(declare-fun CalcTest.test_erase (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.int
(declare-fun Tm_arrow_c1d8c665015e0aa908fc486d6f4a3d52 () Term)
(declare-fun CalcTest.test_erase@tok () Term)

; </end encoding let test_erase>

(push) ;; push{2

; Starting query at CalcTest.fst(78,2-88,3)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let test_gt`
...
;; def=CalcTest.fst(80,4-80,5); use=CalcTest.fst(78,2-88,3)
(>= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x5))
)
...
;; def=CalcTest.fst(82,4-82,4); use=CalcTest.fst(78,2-88,3)
(> (BoxInt_proj_0 @x5)
(BoxInt_proj_0 @x4))
)
...
;; def=CalcTest.fst(84,3-84,5); use=CalcTest.fst(78,2-88,3)
(= @x4
@x3)
)
...
;; def=CalcTest.fst(86,4-86,5); use=CalcTest.fst(78,2-88,3)
(>= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x2))
)
...
;; def=CalcTest.fst(78,7-78,10); use=CalcTest.fst(78,2-88,3)
(or label_1
...
; encoding sigelt let test_gt


; <Start encoding let test_gt>

(declare-fun CalcTest.test_gt (Term) Term)

(declare-fun CalcTest.test_gt@tok () Term)

; </end encoding let test_gt>
...
; Starting query at CalcTest.fst(92,2-98,3)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let test_gt_lt`
; While typechecking the top-level declaration `[@@expect_failure] let test_gt_lt`
...
;; def=CalcTest.fst(94,4-94,5); use=CalcTest.fst(92,2-98,3)
(>= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 @x3))
)
...
;; def=CalcTest.fst(96,3-96,5); use=CalcTest.fst(92,2-98,3)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x2))
)
...
;; def=CalcTest.fst(92,7-92,11); use=CalcTest.fst(92,2-98,3)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcTest.test_gt_lt, 1)
...
; Starting query at CalcTest.fst(102,2-110,3)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;x7: Prims.int -> y8: Prims.int -> Type
(declare-fun Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0
...
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=CalcTest.fst(102,2-110,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0)
...
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(108,3-108,5); use=CalcTest.fst(102,2-110,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_2d12df642cab58f318db60ed4861d203
@x0)
@x1)
...
;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.Calc.calc_pack [         (fun x7 y8 -> x7 == y8 <: Type);         (fun x5 y6 -> x5 == y6 <: Type);         fun x3 y4 -> x3 == y4 <: Type       ]       1       4
(declare-fun Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da
Tm_type)
:named kinding_Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(102,2-110,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da))
:qid CalcTest_pre_typing_Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da))

:named CalcTest_pre_typing_Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(102,2-110,3)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid CalcTest_interpretation_Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da))
:qid CalcTest_interpretation_Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da))

:named CalcTest_interpretation_Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let fail1`
; While typechecking the top-level declaration `[@@expect_failure] let fail1`
...
;; def=Prims.fst(459,77-459,89); use=CalcTest.fst(102,2-110,3)
(and 
;; def=dummy(0,0-0,0); use=CalcTest.fst(102,2-110,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=Prims.fst(451,66-451,102); use=CalcTest.fst(102,2-110,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da)
...
;; def=CalcTest.fst(104,3-104,5); use=CalcTest.fst(102,2-110,3)
(= @x6
@x5)
)
...
;; def=CalcTest.fst(106,3-106,5); use=CalcTest.fst(102,2-110,3)
(= @x5
@x4)
)
...
;; def=CalcTest.fst(102,7-102,11); use=CalcTest.fst(102,2-110,3)
(or label_2
...
; Starting query at CalcTest.fst(114,2-122,3)
...
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=CalcTest.fst(114,2-122,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0)
...
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(120,3-120,5); use=CalcTest.fst(114,2-122,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_2d12df642cab58f318db60ed4861d203
@x0)
@x1)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(114,2-122,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let fail2`
; While typechecking the top-level declaration `[@@expect_failure] let fail2`
...
;; def=Prims.fst(459,77-459,89); use=CalcTest.fst(114,2-122,3)
(and 
;; def=dummy(0,0-0,0); use=CalcTest.fst(114,2-122,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=Prims.fst(451,66-451,102); use=CalcTest.fst(114,2-122,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da)
...
;; def=CalcTest.fst(116,3-116,5); use=CalcTest.fst(114,2-122,3)
(= @x6
@x5)
)
...
;; def=CalcTest.fst(118,3-118,5); use=CalcTest.fst(114,2-122,3)
(= @x5
@x4)
)
...
;; def=CalcTest.fst(114,7-114,11); use=CalcTest.fst(114,2-122,3)
(or label_2
...
; Starting query at CalcTest.fst(126,2-134,3)
...
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=CalcTest.fst(126,2-134,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0)
...
;;; Fact-ids: 
(assert (! 
;; def=CalcTest.fst(132,3-132,5); use=CalcTest.fst(126,2-134,3)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_2d12df642cab58f318db60ed4861d203
@x0)
@x1)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Calc.fsti(81,6-81,36); use=CalcTest.fst(126,2-134,3)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let fail3`
; While typechecking the top-level declaration `[@@expect_failure] let fail3`
...
;; def=Prims.fst(459,77-459,89); use=CalcTest.fst(126,2-134,3)
(and 
;; def=dummy(0,0-0,0); use=CalcTest.fst(126,2-134,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=Prims.fst(451,66-451,102); use=CalcTest.fst(126,2-134,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Tm_arrow_34a655f4c10c5de3bb1fd0f25835b3da)
...
;; def=CalcTest.fst(128,3-128,5); use=CalcTest.fst(126,2-134,3)
(= @x6
@x5)
)
...
;; def=CalcTest.fst(130,3-130,5); use=CalcTest.fst(126,2-134,3)
(= @x5
@x4)
)
...
;; def=CalcTest.fst(126,7-126,11); use=CalcTest.fst(126,2-134,3)
(or label_2
