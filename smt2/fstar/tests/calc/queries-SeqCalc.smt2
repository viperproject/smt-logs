...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Seq.Base.op_At_Bar; Namespace FStar.Seq.Base
(assert (! 
;; def=FStar.Seq.Base.fsti(62,4-62,13); use=FStar.Seq.Base.fsti(62,4-62,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(FStar.Seq.Base.seq @x0)))
(HasType (FStar.Seq.Base.op_At_Bar @x0
@x1
@x2)
(FStar.Seq.Base.seq @x0)))
 

:pattern ((FStar.Seq.Base.op_At_Bar @x0
@x1
@x2))
:qid typing_FStar.Seq.Base.op_At_Bar))

:named typing_FStar.Seq.Base.op_At_Bar))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Equation for FStar.Seq.Base.op_At_Bar
;;; Fact-ids: Name FStar.Seq.Base.op_At_Bar; Namespace FStar.Seq.Base
(assert (! 
;; def=FStar.Seq.Base.fsti(62,4-62,13); use=FStar.Seq.Base.fsti(62,4-62,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.Seq.Base.op_At_Bar @x0
@x1
@x2)
...
@x1
@x2))
:qid equation_FStar.Seq.Base.op_At_Bar))

:named equation_FStar.Seq.Base.op_At_Bar))
...
; Starting query at SeqCalc.fst(11,4-15,5)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;x8: FStar.Seq.Base.seq 'a -> y9: FStar.Seq.Base.seq 'a -> Type0
(declare-fun Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(58,45-58,52); use=SeqCalc.fst(11,4-15,5)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0 @x0)
Tm_type))
:qid kinding_Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0))

:named kinding_Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(58,45-58,52); use=SeqCalc.fst(11,4-15,5)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0 @x2)))
:qid SeqCalc_pre_typing_Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0))

:named SeqCalc_pre_typing_Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(58,45-58,52); use=SeqCalc.fst(11,4-15,5)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0 @x1))
(and 
;; def=FStar.Seq.Base.fsti(58,45-58,52); use=SeqCalc.fst(11,4-15,5)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
...
@x2)
@x3))
:qid SeqCalc_interpretation_Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid SeqCalc_interpretation_Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0 @x1)))
:qid SeqCalc_interpretation_Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0))

:named SeqCalc_interpretation_Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0))
(declare-fun Tm_abs_024cb5871f35cc448c4a91319e1ad248 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_024cb5871f35cc448c4a91319e1ad248
;;; Fact-ids: 
(assert (! 
;; def=SeqCalc.fst(13,6-13,8); use=SeqCalc.fst(13,6-13,8)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_024cb5871f35cc448c4a91319e1ad248 @x0)
(Tm_arrow_01eef7b9cc93630fa6b7355d3be4e2e0 @x0))
 

:pattern ((Tm_abs_024cb5871f35cc448c4a91319e1ad248 @x0))
:qid typing_Tm_abs_024cb5871f35cc448c4a91319e1ad248))

:named typing_Tm_abs_024cb5871f35cc448c4a91319e1ad248))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_024cb5871f35cc448c4a91319e1ad248
;;; Fact-ids: 
(assert (! 
;; def=SeqCalc.fst(13,6-13,8); use=SeqCalc.fst(13,6-13,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_024cb5871f35cc448c4a91319e1ad248 @x2)
@x0)
@x1)
(Prims.eq2 (FStar.Seq.Base.seq @x2)
@x0
@x1))
 

:pattern ((ApplyTT (ApplyTT (Tm_abs_024cb5871f35cc448c4a91319e1ad248 @x2)
@x0)
@x1))
:qid interpretation_Tm_abs_024cb5871f35cc448c4a91319e1ad248))

:named interpretation_Tm_abs_024cb5871f35cc448c4a91319e1ad248))
...
;   (s3: FStar.Seq.Base.seq 'a)
;   (s4: FStar.Seq.Base.seq 'a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         ((s1 @| s2) @| s3) @| s4 == s1 @| s2 @| s3 @| s4 ==> p pure_result) ==>
;     (forall (return_val: Type).
;         return_val == FStar.Preorder.relation (FStar.Seq.Base.seq 'a) ==>
;         (forall (return_val: Type).
;             return_val == FStar.Preorder.relation (FStar.Seq.Base.seq 'a) ==>
;             (forall (any_result: Prims.list (FStar.Preorder.relation (FStar.Seq.Base.seq 'a))).
;                 [] == any_result ==>
;                 (forall (return_val: Prims.list (FStar.Preorder.relation (FStar.Seq.Base.seq 'a))).
;                     return_val == [] ==>
;                     [] == return_val ==>
;                     (forall (any_result:
;                         Prims.list (FStar.Preorder.relation (FStar.Seq.Base.seq 'a))).
;                         [fun x8 y9 -> x8 == y9 <: Type0] == any_result ==>
;                         (forall (return_val:
;                             Prims.list (FStar.Preorder.relation (FStar.Seq.Base.seq 'a))).
;                             return_val == [fun x8 y9 -> x8 == y9 <: Type0] ==>
;                             [fun x8 y9 -> x8 == y9 <: Type0] == return_val ==>
;                             FStar.Range.labeled (FStar.Sealed.seal FStar.Calc.fsti(86,37-86,50))
;                               "Could not prove that this calc-chain is compatible"
;                               (forall (x: FStar.Seq.Base.seq 'a) (y: FStar.Seq.Base.seq 'a).
;                                   (exists (w: FStar.Seq.Base.seq 'a). x == w /\ w == y) ==> x == y) /\
;                             (forall (pure_result: Prims.unit).
;                                 ((s1 @| s2) @| s3) @| s4 == s1 @| s2 @| s3 @| s4 ==> p pure_result))
;                     )))))
...
; While typechecking the top-level declaration `let seq_assoc_4`
...
;; def=Prims.fst(441,36-441,97); use=SeqCalc.fst(11,4-15,5)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=SeqCalc.fst(9,10-10,39); use=SeqCalc.fst(11,4-15,5)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=SeqCalc.fst(11,4-15,5)
(Valid 
;; def=Prims.fst(441,83-441,96); use=SeqCalc.fst(11,4-15,5)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(356,2-356,58); use=SeqCalc.fst(11,4-15,5)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Tm_type)

;; def=Prims.fst(356,26-356,41); use=SeqCalc.fst(11,4-15,5)
(= @x6
(FStar.Preorder.relation (FStar.Seq.Base.seq @x0)))
)
...
;; def=Prims.fst(451,66-451,102); use=SeqCalc.fst(11,4-15,5)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Prims.list (FStar.Preorder.relation (FStar.Seq.Base.seq @x0))))

;; def=Prims.fst(616,24-616,30); use=SeqCalc.fst(11,4-15,5)
(= (Prims.Nil (FStar.Preorder.relation (FStar.Seq.Base.seq @x0)))
@x8)
)
...
;; def=Prims.fst(616,20-616,22); use=SeqCalc.fst(11,4-15,5)
(= (Prims.Nil (FStar.Preorder.relation (FStar.Seq.Base.seq @x0)))
@x9)
)
...
;; def=FStar.Calc.fsti(71,19-80,24); use=SeqCalc.fst(11,4-15,5)
(= (Prims.Cons (FStar.Preorder.relation (FStar.Seq.Base.seq @x0))
(Tm_abs_024cb5871f35cc448c4a91319e1ad248 @x0)
(Prims.Nil (FStar.Preorder.relation (FStar.Seq.Base.seq @x0))))
@x10)
)
...
;; def=FStar.Calc.fsti(71,19-80,6); use=SeqCalc.fst(11,4-15,5)
(= (Prims.Cons (FStar.Preorder.relation (FStar.Seq.Base.seq @x0))
(Tm_abs_024cb5871f35cc448c4a91319e1ad248 @x0)
(Prims.Nil (FStar.Preorder.relation (FStar.Seq.Base.seq @x0))))
@x11)
...
;; def=Prims.fst(441,29-441,97); use=SeqCalc.fst(11,4-15,5)
(and 
...
;; def=SeqCalc.fst(13,6-13,8); use=SeqCalc.fst(11,4-15,5)
(= @x14
@x13)
)
...
;; def=SeqCalc.fst(11,9-11,13); use=SeqCalc.fst(11,4-15,5)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SeqCalc.seq_assoc_4, 1)
; STATUS: unsat
