...
; Internals for CalcInference


; encoding sigelt let lem


; <Start encoding let lem>

(declare-fun CalcInference.lem (Term) Term)
(declare-fun Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.squash Prims.l_True
(declare-fun Tm_arrow_b9171250478a65c33a5d3386ea3ff07d () Term)
(declare-fun CalcInference.lem@tok () Term)


; </end encoding let lem>
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CalcInference.lem; Namespace CalcInference
...
;;; Fact-ids: Name CalcInference.lem; Namespace CalcInference
(assert (! 
;; def=CalcInference.fst(3,23-3,25); use=CalcInference.fst(3,23-3,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
; Starting query at CalcInference.fst(6,2-10,3)
...
;         (forall (x: Prims.int) (y: Prims.int). (exists (w: Prims.int). x == w /\ w == y) ==> x == y)
;     )
...
;; def=CalcInference.fst(8,2-8,4); use=CalcInference.fst(6,2-10,3)
(= @x3
@x2)
)
...
;; def=CalcInference.fst(6,7-6,11); use=CalcInference.fst(6,2-10,3)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcInference.test1, 1)
; STATUS: unsat
...
(declare-fun CalcInference.test1 (Term) Term)


(declare-fun CalcInference.test1@tok () Term)
...
; Starting query at CalcInference.fst(13,2-17,3)
...
;; def=CalcInference.fst(15,2-15,4); use=CalcInference.fst(13,2-17,3)
(= @x3
@x2)
)
...
;; def=CalcInference.fst(13,7-13,11); use=CalcInference.fst(13,2-17,3)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcInference.test2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
(declare-fun CalcInference.test2 (Term) Term)


(declare-fun CalcInference.test2@tok () Term)
...
; Starting query at CalcInference.fst(20,2-24,3)
...
;; def=CalcInference.fst(22,2-22,4); use=CalcInference.fst(20,2-24,3)
(= @x3
@x2)
)
...
;; def=CalcInference.fst(20,7-20,11); use=CalcInference.fst(20,2-24,3)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CalcInference.test3, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
