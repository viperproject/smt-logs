...
(declare-fun BasicTests.op_Less_Equals (Dummy_sort) Term)

; </end encoding let op_Less_Equals>


; encoding sigelt let op_Greater_Equals


; <Start encoding let op_Greater_Equals>

(declare-fun BasicTests.op_Greater_Equals (Dummy_sort) Term)

; </end encoding let op_Greater_Equals>


; encoding sigelt let op_Greater


; <Start encoding let op_Greater>

(declare-fun BasicTests.op_Greater (Dummy_sort) Term)

; </end encoding let op_Greater>
...
(declare-fun BasicTests.op_Less (Dummy_sort) Term)
...
; Starting query at BasicTests.fst(12,15-12,66)
...
;       (exists (w: Prims.int). (exists (w: Prims.int). x == w /\ w <= w == true) /\ w < y == true) ==>
;       x < y == true)
;   <:
;   Type0
...
;; def=Prims.fst(180,31-180,42); use=BasicTests.fst(12,15-12,66)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BasicTests.test1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_Prims.op_LessThan, primitive_Prims.op_LessThanOrEqual, projection_inverse_BoxBool_proj_0
...
(declare-fun BasicTests.test1 (Term) Term)

(declare-fun BasicTests.test1@tok () Term)

; </end encoding let test1>

(push) ;; push{2

; Starting query at BasicTests.fst(13,15-13,66)
...
;; def=Prims.fst(180,31-180,42); use=BasicTests.fst(13,15-13,66)
(or label_1
...
(declare-fun BasicTests.test2 (Term) Term)

(declare-fun BasicTests.test2@tok () Term)

; </end encoding let test2>

(push) ;; push{2

; Starting query at BasicTests.fst(14,15-14,65)
...
;; def=Prims.fst(180,31-180,42); use=BasicTests.fst(14,15-14,65)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BasicTests.test3, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_Prims.op_LessThan, projection_inverse_BoxBool_proj_0
...
(declare-fun BasicTests.test3 (Term) Term)

(declare-fun BasicTests.test3@tok () Term)

; </end encoding let test3>

(push) ;; push{2

; Starting query at BasicTests.fst(15,15-15,60)
...
; *)
;   (forall (x: Prims.int) (y: Prims.int).
;       (exists (w: Prims.int). x == w /\ w < y == true) ==> x < y == true)
;   <:
;   Type0
...
;; def=Prims.fst(180,31-180,42); use=BasicTests.fst(15,15-15,60)
(or label_1
...
(declare-fun BasicTests.test4 (Term) Term)

(declare-fun BasicTests.test4@tok () Term)

; </end encoding let test4>

(push) ;; push{2

; Starting query at BasicTests.fst(16,15-16,72)
...
;   (forall (x: Prims.int) (y: Prims.int).
;       (exists (w: Prims.int).
;           (exists (w: Prims.int). (exists (w: Prims.int). x == w /\ w <= w == true) /\ w == w) /\
;           w < y == true) ==>
;       x < y == true)
;   <:
;   Type0
...
;; def=FStar.Calc.fsti(42,59-42,65); use=FStar.Calc.fsti(42,59-42,65)
(= @x4
@x3)
)
...
;; def=Prims.fst(180,31-180,42); use=BasicTests.fst(16,15-16,72)
(or label_1
...
(declare-fun BasicTests.test5 (Term) Term)

(declare-fun BasicTests.test5@tok () Term)
...
; Starting query at BasicTests.fst(19,34-19,80)
...
;; def=Prims.fst(180,31-180,42); use=BasicTests.fst(19,34-19,80)
(or label_1
