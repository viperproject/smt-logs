...
; Externals for module FriendProvider


; <Skipped val FriendProvider.x/>


; <Start encoding let x>

(declare-fun FriendProvider.x (Dummy_sort) Term)
...
; encoding sigelt val FriendConsumer.test


; <Skipped val FriendConsumer.test/>
...
(assert (! 
;; def=FriendProvider.fst(17,4-17,5); use=FriendProvider.fst(17,4-17,5)
(forall ((@u0 Dummy_sort))
 (! (HasType (FriendProvider.x @u0)
Prims.int)
 

:pattern ((FriendProvider.x @u0))
:qid typing_FriendProvider.x))

:named typing_FriendProvider.x))
;;;;;;;;;;;;;;;;refinement kinding
...
:qid equation_FriendProvider.x))

:named equation_FriendProvider.x))
