...
; Internals for X64.Machine_s


; encoding sigelt let nat32_max
...
; encoding sigelt val X64.Machine_s.int_to_nat64
...
; encoding sigelt type X64.Machine_s.reg
...
; encoding sigelt assume X64.Machine_s.reg__uu___haseq
...
; encoding sigelt val X64.Machine_s.uu___is_Rax
...
; encoding sigelt val X64.Machine_s.uu___is_Rbx
...
; encoding sigelt val X64.Machine_s.uu___is_Rcx
...
; encoding sigelt val X64.Machine_s.uu___is_Rdx
...
; encoding sigelt val X64.Machine_s.uu___is_Rsi
...
; encoding sigelt let uu___is_Rsi


; <Skipped let uu___is_Rsi/>


; encoding sigelt val X64.Machine_s.uu___is_Rdi
...
; encoding sigelt let uu___is_Rdi


; <Skipped let uu___is_Rdi/>


; encoding sigelt val X64.Machine_s.uu___is_Rbp
...
; encoding sigelt let uu___is_Rbp


; <Skipped let uu___is_Rbp/>


; encoding sigelt val X64.Machine_s.uu___is_Rsp
...
; encoding sigelt let uu___is_Rsp


; <Skipped let uu___is_Rsp/>


; encoding sigelt val X64.Machine_s.uu___is_R8
...
; encoding sigelt let uu___is_R8


; <Skipped let uu___is_R8/>


; encoding sigelt val X64.Machine_s.uu___is_R9
...
; encoding sigelt let uu___is_R9


; <Skipped let uu___is_R9/>


; encoding sigelt val X64.Machine_s.uu___is_R10
...
; encoding sigelt let uu___is_R10


; <Skipped let uu___is_R10/>


; encoding sigelt val X64.Machine_s.uu___is_R11
...
; encoding sigelt let uu___is_R11


; <Skipped let uu___is_R11/>


; encoding sigelt val X64.Machine_s.uu___is_R12
...
; encoding sigelt let uu___is_R12


; <Skipped let uu___is_R12/>


; encoding sigelt val X64.Machine_s.uu___is_R13
...
; encoding sigelt let uu___is_R13


; <Skipped let uu___is_R13/>


; encoding sigelt val X64.Machine_s.uu___is_R14
...
; encoding sigelt let uu___is_R14


; <Skipped let uu___is_R14/>


; encoding sigelt val X64.Machine_s.uu___is_R15
...
; encoding sigelt let uu___is_R15
...
; encoding sigelt type X64.Machine_s.maddr
...
; Starting query at X64.Machine_s.fst(49,0-52,69)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq X64.Machine_s.maddr ==>
; (forall (r: X64.Machine_s.reg) (offset: Prims.int).
...
; (forall (base: X64.Machine_s.reg) (scale: Prims.int) (index: X64.Machine_s.reg) (offset: Prims.int).
;     Prims.hasEq X64.Machine_s.reg /\ Prims.hasEq X64.Machine_s.reg)


; Context: While encoding a query
; While typechecking the top-level declaration `type X64.Machine_s.maddr`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=X64.Machine_s.fst(49,0-52,69); use=X64.Machine_s.fst(49,0-52,69)
(Valid 
;; def=X64.Machine_s.fst(49,0-52,69); use=X64.Machine_s.fst(49,0-52,69)
(Prims.hasEq X64.Machine_s.maddr)
)
...
;; def=X64.Machine_s.fst(49,0-52,69); use=X64.Machine_s.fst(51,12-51,15)
(or label_1
...
;; def=X64.Machine_s.fst(49,0-52,69); use=X64.Machine_s.fst(49,0-52,69)
(and 
;; def=X64.Machine_s.fst(49,0-52,69); use=X64.Machine_s.fst(52,17-52,20)
(or label_2
...
;; def=X64.Machine_s.fst(49,0-52,69); use=X64.Machine_s.fst(52,43-52,46)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.maddr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_X64.Machine_s.reg__uu___haseq
...
; encoding sigelt assume X64.Machine_s.maddr__uu___haseq
...
; encoding sigelt val X64.Machine_s.uu___is_MConst
...
; encoding sigelt let uu___is_MConst


; <Skipped let uu___is_MConst/>


; encoding sigelt val X64.Machine_s.__proj__MConst__item__n
...
; Starting query at X64.Machine_s.fst(50,12-50,13)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: X64.Machine_s.maddr{MConst? _}).
;   (*  - Could not prove post-condition
; *) ~(MConst? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__MConst__item__n`
...
;; def=X64.Machine_s.fst(50,4-50,10); use=X64.Machine_s.fst(50,12-50,13)
(not 
;; def=X64.Machine_s.fst(50,4-50,10); use=X64.Machine_s.fst(50,12-50,13)
(BoxBool_proj_0 (X64.Machine_s.uu___is_MConst @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__MConst__item__n, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_ad649c559db000bf1dd08bb4e261413e
...
; encoding sigelt let __proj__MConst__item__n


; <Skipped let __proj__MConst__item__n/>


; encoding sigelt val X64.Machine_s.uu___is_MReg
...
; encoding sigelt let uu___is_MReg


; <Skipped let uu___is_MReg/>


; encoding sigelt val X64.Machine_s.__proj__MReg__item__r
...
; Starting query at X64.Machine_s.fst(51,10-51,11)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: X64.Machine_s.maddr{MReg? _}).
;   (*  - Could not prove post-condition
; *) ~(MReg? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__MReg__item__r`
...
;; def=X64.Machine_s.fst(51,4-51,8); use=X64.Machine_s.fst(51,10-51,11)
(not 
;; def=X64.Machine_s.fst(51,4-51,8); use=X64.Machine_s.fst(51,10-51,11)
(BoxBool_proj_0 (X64.Machine_s.uu___is_MReg @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__MReg__item__r, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_49b6b7afc081bac09ce40febdab68891
...
; encoding sigelt let __proj__MReg__item__r


; <Skipped let __proj__MReg__item__r/>


; encoding sigelt val X64.Machine_s.__proj__MReg__item__offset
...
; Starting query at X64.Machine_s.fst(51,19-51,25)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__MReg__item__offset`
...
;; def=X64.Machine_s.fst(51,4-51,8); use=X64.Machine_s.fst(51,19-51,25)
(not 
;; def=X64.Machine_s.fst(51,4-51,8); use=X64.Machine_s.fst(51,19-51,25)
(BoxBool_proj_0 (X64.Machine_s.uu___is_MReg @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__MReg__item__offset, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_49b6b7afc081bac09ce40febdab68891
...
; encoding sigelt let __proj__MReg__item__offset


; <Skipped let __proj__MReg__item__offset/>


; encoding sigelt val X64.Machine_s.uu___is_MIndex
...
; encoding sigelt let uu___is_MIndex


; <Skipped let uu___is_MIndex/>


; encoding sigelt val X64.Machine_s.__proj__MIndex__item__base
...
; Starting query at X64.Machine_s.fst(52,12-52,16)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: X64.Machine_s.maddr{MIndex? _}).
;   (*  - Could not prove post-condition
; *) ~(MIndex? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__MIndex__item__base`
...
;; def=X64.Machine_s.fst(52,4-52,10); use=X64.Machine_s.fst(52,12-52,16)
(not 
;; def=X64.Machine_s.fst(52,4-52,10); use=X64.Machine_s.fst(52,12-52,16)
(BoxBool_proj_0 (X64.Machine_s.uu___is_MIndex @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__MIndex__item__base, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0c01fa907bf3fbb9b7c15b0e05d45125
...
; encoding sigelt let __proj__MIndex__item__base


; <Skipped let __proj__MIndex__item__base/>


; encoding sigelt val X64.Machine_s.__proj__MIndex__item__scale
...
; Starting query at X64.Machine_s.fst(52,24-52,29)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__MIndex__item__scale`
...
;; def=X64.Machine_s.fst(52,4-52,10); use=X64.Machine_s.fst(52,24-52,29)
(not 
;; def=X64.Machine_s.fst(52,4-52,10); use=X64.Machine_s.fst(52,24-52,29)
(BoxBool_proj_0 (X64.Machine_s.uu___is_MIndex @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__MIndex__item__scale, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0c01fa907bf3fbb9b7c15b0e05d45125
...
; encoding sigelt let __proj__MIndex__item__scale


; <Skipped let __proj__MIndex__item__scale/>


; encoding sigelt val X64.Machine_s.__proj__MIndex__item__index
...
; Starting query at X64.Machine_s.fst(52,37-52,42)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__MIndex__item__index`
...
;; def=X64.Machine_s.fst(52,4-52,10); use=X64.Machine_s.fst(52,37-52,42)
(not 
;; def=X64.Machine_s.fst(52,4-52,10); use=X64.Machine_s.fst(52,37-52,42)
(BoxBool_proj_0 (X64.Machine_s.uu___is_MIndex @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__MIndex__item__index, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0c01fa907bf3fbb9b7c15b0e05d45125
...
; encoding sigelt let __proj__MIndex__item__index


; <Skipped let __proj__MIndex__item__index/>


; encoding sigelt val X64.Machine_s.__proj__MIndex__item__offset
...
; Starting query at X64.Machine_s.fst(52,50-52,56)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__MIndex__item__offset`
...
;; def=X64.Machine_s.fst(52,4-52,10); use=X64.Machine_s.fst(52,50-52,56)
(not 
;; def=X64.Machine_s.fst(52,4-52,10); use=X64.Machine_s.fst(52,50-52,56)
(BoxBool_proj_0 (X64.Machine_s.uu___is_MIndex @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__MIndex__item__offset, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0c01fa907bf3fbb9b7c15b0e05d45125
...
; encoding sigelt let __proj__MIndex__item__offset
...
; encoding sigelt type X64.Machine_s.operand
...
; Starting query at X64.Machine_s.fst(54,0-57,28)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq X64.Machine_s.operand ==>
; (forall (r: X64.Machine_s.reg).
;     (*  - Failed to prove that the type
;     'X64.Machine_s.operand'
;     supports decidable equality because of this argument.
;   - Add either the 'noeq' or 'unopteq' qualifier
...
; Context: While encoding a query
; While typechecking the top-level declaration `type X64.Machine_s.operand`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=X64.Machine_s.fst(54,0-57,28); use=X64.Machine_s.fst(54,0-57,28)
(Valid 
;; def=X64.Machine_s.fst(54,0-57,28); use=X64.Machine_s.fst(54,0-57,28)
...
;; def=X64.Machine_s.fst(54,0-57,28); use=X64.Machine_s.fst(56,12-56,15)
(or label_1
...
;; def=X64.Machine_s.fst(54,0-57,28); use=X64.Machine_s.fst(57,12-57,17)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.operand, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_X64.Machine_s.maddr__uu___haseq, assumption_X64.Machine_s.reg__uu___haseq
...
; encoding sigelt assume X64.Machine_s.operand__uu___haseq
...
; encoding sigelt val X64.Machine_s.uu___is_OConst
...
; encoding sigelt val X64.Machine_s.__proj__OConst__item__n
...
; Starting query at X64.Machine_s.fst(55,12-55,13)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: X64.Machine_s.operand{OConst? _}).
;   (*  - Could not prove post-condition
...
;; def=X64.Machine_s.fst(55,4-55,10); use=X64.Machine_s.fst(55,12-55,13)
(not 
;; def=X64.Machine_s.fst(55,4-55,10); use=X64.Machine_s.fst(55,12-55,13)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__OConst__item__n, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_7efc3fb0a0ebacf4e999ae215f7b60a8
...
; encoding sigelt val X64.Machine_s.uu___is_OReg
...
; encoding sigelt val X64.Machine_s.__proj__OReg__item__r
...
; Starting query at X64.Machine_s.fst(56,10-56,11)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: X64.Machine_s.operand{OReg? _}).
;   (*  - Could not prove post-condition
...
;; def=X64.Machine_s.fst(56,4-56,8); use=X64.Machine_s.fst(56,10-56,11)
(not 
;; def=X64.Machine_s.fst(56,4-56,8); use=X64.Machine_s.fst(56,10-56,11)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__OReg__item__r, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_7c9e5bdb9582a858897946d48f9f4d58
...
; encoding sigelt val X64.Machine_s.uu___is_OMem
...
; encoding sigelt let uu___is_OMem


; <Skipped let uu___is_OMem/>


; encoding sigelt val X64.Machine_s.__proj__OMem__item__m
...
; Starting query at X64.Machine_s.fst(57,10-57,11)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: X64.Machine_s.operand{OMem? _}).
;   (*  - Could not prove post-condition
; *) ~(OMem? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__OMem__item__m`
...
;; def=X64.Machine_s.fst(57,4-57,8); use=X64.Machine_s.fst(57,10-57,11)
(not 
;; def=X64.Machine_s.fst(57,4-57,8); use=X64.Machine_s.fst(57,10-57,11)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__OMem__item__m, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_1ffc672b65f59d0fc5f2be00bff120b6
...
; encoding sigelt let __proj__OMem__item__m
...
; encoding sigelt type X64.Machine_s.precode
...
; Starting query at X64.Machine_s.fst(59,0-63,85)
...
; Encoding query formula : forall (t_ins: Type) (t_ocmp: Type).
;   Prims.hasEq t_ins /\ Prims.hasEq t_ocmp /\
;   (forall (t_ins: Type0) (t_ocmp: Type0).
;       {:pattern Prims.hasEq (X64.Machine_s.precode t_ins t_ocmp)}
;       Prims.hasEq t_ins /\ Prims.hasEq t_ocmp ==> Prims.hasEq (X64.Machine_s.precode t_ins t_ocmp)) ==>
;   (forall (ins: t_ins).
;       (*  - Failed to prove that the type
;     'X64.Machine_s.precode'
;     supports decidable equality because of this argument.
;   - Add either the 'noeq' or 'unopteq' qualifier
; *)
;       Prims.hasEq t_ins) /\
;   (forall (block: Prims.list (X64.Machine_s.precode t_ins t_ocmp)).
;       (*  - Failed to prove that the type
;     'X64.Machine_s.precode'
;     supports decidable equality because of this argument.
;   - Add either the 'noeq' or 'unopteq' qualifier
; *)
;       Prims.hasEq (Prims.list (X64.Machine_s.precode t_ins t_ocmp))) /\
;   (forall (ifCond: t_ocmp)
;       (ifTrue: X64.Machine_s.precode t_ins t_ocmp)
;       (ifFalse: X64.Machine_s.precode t_ins t_ocmp).
;       Prims.hasEq t_ocmp /\ Prims.hasEq (X64.Machine_s.precode t_ins t_ocmp) /\
;       Prims.hasEq (X64.Machine_s.precode t_ins t_ocmp)) /\
;   (forall (whileCond: t_ocmp) (whileBody: X64.Machine_s.precode t_ins t_ocmp).
;       Prims.hasEq t_ocmp /\ Prims.hasEq (X64.Machine_s.precode t_ins t_ocmp))


; Context: While encoding a query
; While typechecking the top-level declaration `type X64.Machine_s.precode`
...
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(59,0-63,85)
(Valid 
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(59,0-63,85)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(59,0-63,85)
(Prims.hasEq (X64.Machine_s.precode @x2
@x3))
)
)
 

:pattern ((Prims.hasEq (X64.Machine_s.precode @x2
@x3)))
:qid @query.1))
)
...
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(60,13-60,18)
(or label_1
...
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Prims.list (X64.Machine_s.precode @x0
@x1)))

;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(61,17-61,44)
(or label_2

;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(59,0-63,85)
(Valid 
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(59,0-63,85)
(Prims.hasEq (Prims.list (X64.Machine_s.precode @x0
@x1)))
)
)
)
...
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(59,0-63,85)
(and 
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(62,19-62,25)
(or label_3
...
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(62,36-62,56)
(or label_4

;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(59,0-63,85)
(Valid 
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(59,0-63,85)
(Prims.hasEq (X64.Machine_s.precode @x0
@x1))
)
)


;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(62,68-62,88)
(or label_5
...
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(59,0-63,85)
(and 
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(63,21-63,27)
(or label_6
...
;; def=X64.Machine_s.fst(59,0-63,85); use=X64.Machine_s.fst(63,41-63,61)
(or label_7
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.precode, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_Prims.list__uu___haseq, kinding_X64.Machine_s.precode@tok
...
; encoding sigelt assume X64.Machine_s.precode__uu___haseq
...
; encoding sigelt val X64.Machine_s.uu___is_Ins
...
; encoding sigelt val X64.Machine_s.__proj__Ins__item__ins
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name X64.Machine_s.uu___is_Ins; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(60,4-60,7); use=X64.Machine_s.fst(60,4-60,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(X64.Machine_s.precode @x0
@x1)))
(HasType (X64.Machine_s.uu___is_Ins @x0
@x1
@x2)
Prims.bool))
 

:pattern ((X64.Machine_s.uu___is_Ins @x0
@x1
@x2))
:qid typing_X64.Machine_s.uu___is_Ins))

:named typing_X64.Machine_s.uu___is_Ins))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name X64.Machine_s.precode; Namespace X64.Machine_s; Name X64.Machine_s.Ins; Namespace X64.Machine_s; Name X64.Machine_s.Block; Namespace X64.Machine_s; Name X64.Machine_s.IfElse; Namespace X64.Machine_s; Name X64.Machine_s.While; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(59,5-59,12); use=X64.Machine_s.fst(59,5-59,12)
...
:named subterm_ordering_Prims.Cons))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name X64.Machine_s.__proj__Ins__item__ins; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(60,4-60,7); use=X64.Machine_s.fst(60,4-60,7)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_8d23bd498b85d9ef871e961295abeefa @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_8d23bd498b85d9ef871e961295abeefa @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_8d23bd498b85d9ef871e961295abeefa))

:named refinement_kinding_Tm_refine_8d23bd498b85d9ef871e961295abeefa))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name X64.Machine_s.__proj__Ins__item__ins; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(60,4-60,7); use=X64.Machine_s.fst(60,4-60,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8d23bd498b85d9ef871e961295abeefa @x2
@x3))
(and (HasTypeFuel @u0
@x1
(X64.Machine_s.precode @x2
...
;; def=X64.Machine_s.fst(60,4-60,7); use=X64.Machine_s.fst(60,4-60,7)
(BoxBool_proj_0 (X64.Machine_s.uu___is_Ins @x2
@x3
@x1))
))
...
(Tm_refine_8d23bd498b85d9ef871e961295abeefa @x2
@x3)))
:qid refinement_interpretation_Tm_refine_8d23bd498b85d9ef871e961295abeefa))

:named refinement_interpretation_Tm_refine_8d23bd498b85d9ef871e961295abeefa))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name X64.Machine_s.precode; Namespace X64.Machine_s; Name X64.Machine_s.Ins; Namespace X64.Machine_s; Name X64.Machine_s.Block; Namespace X64.Machine_s; Name X64.Machine_s.IfElse; Namespace X64.Machine_s; Name X64.Machine_s.While; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,4-63,9)
...
:named kinding_Prims.list@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8d23bd498b85d9ef871e961295abeefa
;;; Fact-ids: Name X64.Machine_s.__proj__Ins__item__ins; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(60,4-60,7); use=X64.Machine_s.fst(60,4-60,7)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8d23bd498b85d9ef871e961295abeefa @x0
@x1)))
(Valid (Prims.hasEq (X64.Machine_s.precode @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8d23bd498b85d9ef871e961295abeefa @x0
@x1))))
:qid haseqTm_refine_8d23bd498b85d9ef871e961295abeefa))

:named haseqTm_refine_8d23bd498b85d9ef871e961295abeefa))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name X64.Machine_s.precode; Namespace X64.Machine_s; Name X64.Machine_s.Ins; Namespace X64.Machine_s; Name X64.Machine_s.Block; Namespace X64.Machine_s; Name X64.Machine_s.IfElse; Namespace X64.Machine_s; Name X64.Machine_s.While; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(59,5-59,12); use=X64.Machine_s.fst(59,5-59,12)
...
;; def=X64.Machine_s.fst(60,4-60,7); use=X64.Machine_s.fst(60,4-60,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (X64.Machine_s.uu___is_Ins @x0
@x1
@x2)
(BoxBool (is-X64.Machine_s.Ins @x2)))
 

:pattern ((X64.Machine_s.uu___is_Ins @x0
@x1
@x2))
:qid disc_equation_X64.Machine_s.Ins))

:named disc_equation_X64.Machine_s.Ins))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name X64.Machine_s.precode; Namespace X64.Machine_s; Name X64.Machine_s.Ins; Namespace X64.Machine_s; Name X64.Machine_s.Block; Namespace X64.Machine_s; Name X64.Machine_s.IfElse; Namespace X64.Machine_s; Name X64.Machine_s.While; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,4-63,9)
...
; Starting query at X64.Machine_s.fst(60,9-60,12)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (t_ins: Type) (t_ocmp: Type) (projectee: _: X64.Machine_s.precode t_ins t_ocmp {Ins? _}).
;   (*  - Could not prove post-condition
...
Tm_type)
(HasType @x2
(Tm_refine_8d23bd498b85d9ef871e961295abeefa @x0
@x1))

;; def=X64.Machine_s.fst(60,4-60,7); use=X64.Machine_s.fst(60,9-60,12)
(not 
;; def=X64.Machine_s.fst(60,4-60,7); use=X64.Machine_s.fst(60,9-60,12)
(BoxBool_proj_0 (X64.Machine_s.uu___is_Ins @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__Ins__item__ins, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_8d23bd498b85d9ef871e961295abeefa
...
; encoding sigelt val X64.Machine_s.uu___is_Block
...
; encoding sigelt val X64.Machine_s.__proj__Block__item__block
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name X64.Machine_s.__proj__Block__item__block; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(61,4-61,9); use=X64.Machine_s.fst(61,4-61,9)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_7931b24c4e7900a01f262ca0e3574c0e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_7931b24c4e7900a01f262ca0e3574c0e @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_7931b24c4e7900a01f262ca0e3574c0e))

:named refinement_kinding_Tm_refine_7931b24c4e7900a01f262ca0e3574c0e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name X64.Machine_s.__proj__Block__item__block; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(61,4-61,9); use=X64.Machine_s.fst(61,4-61,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7931b24c4e7900a01f262ca0e3574c0e @x2
@x3))
(and (HasTypeFuel @u0
@x1
(X64.Machine_s.precode @x2
...
;; def=X64.Machine_s.fst(61,4-61,9); use=X64.Machine_s.fst(61,4-61,9)
(BoxBool_proj_0 (X64.Machine_s.uu___is_Block @x2
@x3
@x1))
))
...
(Tm_refine_7931b24c4e7900a01f262ca0e3574c0e @x2
@x3)))
:qid refinement_interpretation_Tm_refine_7931b24c4e7900a01f262ca0e3574c0e))

:named refinement_interpretation_Tm_refine_7931b24c4e7900a01f262ca0e3574c0e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7931b24c4e7900a01f262ca0e3574c0e
;;; Fact-ids: Name X64.Machine_s.__proj__Block__item__block; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(61,4-61,9); use=X64.Machine_s.fst(61,4-61,9)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7931b24c4e7900a01f262ca0e3574c0e @x0
@x1)))
(Valid (Prims.hasEq (X64.Machine_s.precode @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7931b24c4e7900a01f262ca0e3574c0e @x0
@x1))))
:qid haseqTm_refine_7931b24c4e7900a01f262ca0e3574c0e))

:named haseqTm_refine_7931b24c4e7900a01f262ca0e3574c0e))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name X64.Machine_s.uu___is_Block; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(61,4-61,9); use=X64.Machine_s.fst(61,4-61,9)
...
; Starting query at X64.Machine_s.fst(61,11-61,16)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (t_ins: Type) (t_ocmp: Type) (projectee: _: X64.Machine_s.precode t_ins t_ocmp {Block? _}).
;   (*  - Could not prove post-condition
...
Tm_type)
(HasType @x2
(Tm_refine_7931b24c4e7900a01f262ca0e3574c0e @x0
@x1))

;; def=X64.Machine_s.fst(61,4-61,9); use=X64.Machine_s.fst(61,11-61,16)
(not 
;; def=X64.Machine_s.fst(61,4-61,9); use=X64.Machine_s.fst(61,11-61,16)
(BoxBool_proj_0 (X64.Machine_s.uu___is_Block @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__Block__item__block, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_7931b24c4e7900a01f262ca0e3574c0e
...
; encoding sigelt val X64.Machine_s.uu___is_IfElse
...
; encoding sigelt let uu___is_IfElse


; <Skipped let uu___is_IfElse/>


; encoding sigelt val X64.Machine_s.__proj__IfElse__item__ifCond
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name X64.Machine_s.__proj__IfElse__item__ifCond; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,4-62,10)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_4377826c4723fe1b7a6258fac9438e3d @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_4377826c4723fe1b7a6258fac9438e3d @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_4377826c4723fe1b7a6258fac9438e3d))

:named refinement_kinding_Tm_refine_4377826c4723fe1b7a6258fac9438e3d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name X64.Machine_s.__proj__IfElse__item__ifCond; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,4-62,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4377826c4723fe1b7a6258fac9438e3d @x2
@x3))
(and (HasTypeFuel @u0
@x1
(X64.Machine_s.precode @x2
...
;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,4-62,10)
(BoxBool_proj_0 (X64.Machine_s.uu___is_IfElse @x2
@x3
@x1))
))
...
(Tm_refine_4377826c4723fe1b7a6258fac9438e3d @x2
@x3)))
:qid refinement_interpretation_Tm_refine_4377826c4723fe1b7a6258fac9438e3d))

:named refinement_interpretation_Tm_refine_4377826c4723fe1b7a6258fac9438e3d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4377826c4723fe1b7a6258fac9438e3d
;;; Fact-ids: Name X64.Machine_s.__proj__IfElse__item__ifCond; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,4-62,10)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4377826c4723fe1b7a6258fac9438e3d @x0
@x1)))
(Valid (Prims.hasEq (X64.Machine_s.precode @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4377826c4723fe1b7a6258fac9438e3d @x0
@x1))))
:qid haseqTm_refine_4377826c4723fe1b7a6258fac9438e3d))

:named haseqTm_refine_4377826c4723fe1b7a6258fac9438e3d))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name X64.Machine_s.uu___is_IfElse; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,4-62,10)
...
; Starting query at X64.Machine_s.fst(62,12-62,18)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (t_ins: Type) (t_ocmp: Type) (projectee: _: X64.Machine_s.precode t_ins t_ocmp {IfElse? _}).
;   (*  - Could not prove post-condition
; *) ~(IfElse? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__IfElse__item__ifCond`
...
Tm_type)
(HasType @x2
(Tm_refine_4377826c4723fe1b7a6258fac9438e3d @x0
@x1))

;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,12-62,18)
(not 
;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,12-62,18)
(BoxBool_proj_0 (X64.Machine_s.uu___is_IfElse @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__IfElse__item__ifCond, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_4377826c4723fe1b7a6258fac9438e3d
...
; encoding sigelt let __proj__IfElse__item__ifCond


; <Skipped let __proj__IfElse__item__ifCond/>


; encoding sigelt val X64.Machine_s.__proj__IfElse__item__ifTrue
...
; Starting query at X64.Machine_s.fst(62,29-62,35)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__IfElse__item__ifTrue`
...
;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,29-62,35)
(not 
;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,29-62,35)
(BoxBool_proj_0 (X64.Machine_s.uu___is_IfElse @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__IfElse__item__ifTrue, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_4377826c4723fe1b7a6258fac9438e3d
...
; encoding sigelt let __proj__IfElse__item__ifTrue


; <Skipped let __proj__IfElse__item__ifTrue/>


; encoding sigelt val X64.Machine_s.__proj__IfElse__item__ifFalse
...
; Starting query at X64.Machine_s.fst(62,60-62,67)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__IfElse__item__ifFalse`
...
;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,60-62,67)
(not 
;; def=X64.Machine_s.fst(62,4-62,10); use=X64.Machine_s.fst(62,60-62,67)
(BoxBool_proj_0 (X64.Machine_s.uu___is_IfElse @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__IfElse__item__ifFalse, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_4377826c4723fe1b7a6258fac9438e3d
...
; encoding sigelt let __proj__IfElse__item__ifFalse


; <Skipped let __proj__IfElse__item__ifFalse/>


; encoding sigelt val X64.Machine_s.uu___is_While
...
; encoding sigelt let uu___is_While


; <Skipped let uu___is_While/>


; encoding sigelt val X64.Machine_s.__proj__While__item__whileCond
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name X64.Machine_s.__proj__While__item__whileCond; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,4-63,9)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_45c3c142e427e91690ff415ec1656ffb @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_45c3c142e427e91690ff415ec1656ffb @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_45c3c142e427e91690ff415ec1656ffb))

:named refinement_kinding_Tm_refine_45c3c142e427e91690ff415ec1656ffb))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name X64.Machine_s.__proj__While__item__whileCond; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,4-63,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_45c3c142e427e91690ff415ec1656ffb @x2
@x3))
(and (HasTypeFuel @u0
@x1
(X64.Machine_s.precode @x2
...
;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,4-63,9)
(BoxBool_proj_0 (X64.Machine_s.uu___is_While @x2
@x3
@x1))
))
...
(Tm_refine_45c3c142e427e91690ff415ec1656ffb @x2
@x3)))
:qid refinement_interpretation_Tm_refine_45c3c142e427e91690ff415ec1656ffb))

:named refinement_interpretation_Tm_refine_45c3c142e427e91690ff415ec1656ffb))
;;;;;;;;;;;;;;;;haseq for Tm_refine_45c3c142e427e91690ff415ec1656ffb
;;; Fact-ids: Name X64.Machine_s.__proj__While__item__whileCond; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,4-63,9)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_45c3c142e427e91690ff415ec1656ffb @x0
@x1)))
(Valid (Prims.hasEq (X64.Machine_s.precode @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_45c3c142e427e91690ff415ec1656ffb @x0
@x1))))
:qid haseqTm_refine_45c3c142e427e91690ff415ec1656ffb))

:named haseqTm_refine_45c3c142e427e91690ff415ec1656ffb))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name X64.Machine_s.uu___is_While; Namespace X64.Machine_s
(assert (! 
;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,4-63,9)
...
; Starting query at X64.Machine_s.fst(63,11-63,20)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (t_ins: Type) (t_ocmp: Type) (projectee: _: X64.Machine_s.precode t_ins t_ocmp {While? _}).
;   (*  - Could not prove post-condition
; *) ~(While? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__While__item__whileCond`
...
Tm_type)
(HasType @x2
(Tm_refine_45c3c142e427e91690ff415ec1656ffb @x0
@x1))

;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,11-63,20)
(not 
;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,11-63,20)
(BoxBool_proj_0 (X64.Machine_s.uu___is_While @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__While__item__whileCond, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_45c3c142e427e91690ff415ec1656ffb
...
; encoding sigelt let __proj__While__item__whileCond


; <Skipped let __proj__While__item__whileCond/>


; encoding sigelt val X64.Machine_s.__proj__While__item__whileBody
...
; Starting query at X64.Machine_s.fst(63,31-63,40)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__While__item__whileBody`
...
;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,31-63,40)
(not 
;; def=X64.Machine_s.fst(63,4-63,9); use=X64.Machine_s.fst(63,31-63,40)
(BoxBool_proj_0 (X64.Machine_s.uu___is_While @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Machine_s.__proj__While__item__whileBody, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_45c3c142e427e91690ff415ec1656ffb
