...
(declare-fun Asm2.map (Term Term) Term)

(declare-fun Asm2.map@tok () Term)
...
(declare-fun Asm2.op_String_Access (Term Term) Term)
...
(declare-fun Asm2.op_String_Access@tok () Term)
...
(declare-fun Asm2.op_String_Assignment (Term Term) Term)
...
(declare-fun Asm2.op_String_Assignment@tok () Term)
...
(declare-fun Asm2.contains (Term Term) Term)
...
(declare-fun Asm2.contains@tok () Term)
...
(declare-fun Tm_refine_d4cd743945002dbdb9ac467d0fd505c9 (Term Term) Term)
(declare-fun Asm2.lemma_load (Term Term Term) Term)


(declare-fun Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca (Term Term Term) Term)
;;;;;;;;;;;;;;;;src: Prims.int -> offset: Prims.int -> s0: state{contains s0 (src + offset)}   -> dst: Prims.int{dst == s0.[ src + offset ]}
(declare-fun Tm_arrow_d9ce393e6f4a4f3e5aebd1d4d257b1b9 () Term)
(declare-fun Asm2.lemma_load@tok () Term)
...
(declare-fun Asm2.lemma_store (Term Term Term Term) Term)


(declare-fun Tm_refine_460edf46599d63cff3eaff288ed58cf8 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;dst: Prims.int -> offset: Prims.int -> src: Prims.int -> s0: state{contains s0 (dst + offset)}   -> s1: state{s1 == (s0.[ dst + offset ] <- src)}
(declare-fun Tm_arrow_1df39d4d70452366cb91e19b605da819 () Term)
(declare-fun Asm2.lemma_store@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Asm2.state; Namespace Asm2
(assert (! (HasType Asm2.state
Tm_type)
:named typing_Asm2.state))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Asm2.op_String_Assignment; Namespace Asm2
(assert (! 
;; def=Asm2.fst(21,4-21,24); use=Asm2.fst(21,4-21,24)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
Tm_type))
(HasType (Asm2.op_String_Assignment @x0
@x1)
(Tm_arrow_e76ad7ea1b49a51ebc304bcd6e344d98 @x1
@x0)))
 

:pattern ((Asm2.op_String_Assignment @x0
@x1))
:qid typing_Asm2.op_String_Assignment))

:named typing_Asm2.op_String_Assignment))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Asm2.op_String_Access; Namespace Asm2
(assert (! 
;; def=Asm2.fst(20,4-20,20); use=Asm2.fst(20,4-20,20)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
Tm_type))
(HasType (Asm2.op_String_Access @x0
@x1)
(Tm_arrow_9c859e8a1c6526d3222abd12b06f56e6 @x1
@x0)))
 

:pattern ((Asm2.op_String_Access @x0
@x1))
:qid typing_Asm2.op_String_Access))

:named typing_Asm2.op_String_Access))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Asm2.map; Namespace Asm2
(assert (! 
;; def=Asm2.fst(19,4-19,7); use=Asm2.fst(19,4-19,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
:named typing_Asm2.map))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Asm2.lemma_store; Namespace Asm2
(assert (! 
;; def=Asm2.fst(30,4-30,15); use=Asm2.fst(30,4-30,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
...
Prims.int)
(HasType @x3
(Tm_refine_d4cd743945002dbdb9ac467d0fd505c9 @x0
@x1)))
(HasType (Asm2.lemma_store @x0
@x1
@x2
@x3)
(Tm_refine_460edf46599d63cff3eaff288ed58cf8 @x3
@x0
@x1
@x2)))
 

:pattern ((Asm2.lemma_store @x0
@x1
@x2
@x3))
:qid typing_Asm2.lemma_store))

:named typing_Asm2.lemma_store))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Asm2.lemma_load; Namespace Asm2
(assert (! 
;; def=Asm2.fst(26,4-26,14); use=Asm2.fst(26,4-26,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
...
(Tm_refine_d4cd743945002dbdb9ac467d0fd505c9 @x0
@x1)))
(HasType (Asm2.lemma_load @x0
@x1
@x2)
(Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca @x2
@x0
@x1)))
 

:pattern ((Asm2.lemma_load @x0
@x1
@x2))
:qid typing_Asm2.lemma_load))

:named typing_Asm2.lemma_load))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Asm2.contains; Namespace Asm2
(assert (! 
;; def=Asm2.fst(22,4-22,12); use=Asm2.fst(22,4-22,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
Tm_type))
(HasType (Asm2.contains @x0
@x1)
(Tm_arrow_9f4db3187888091a832b0a323f1b9876 @x1
@x0)))
 

:pattern ((Asm2.contains @x0
@x1))
:qid typing_Asm2.contains))

:named typing_Asm2.contains))
...
;; def=Asm2.fst(21,4-21,24); use=Asm2.fst(21,4-21,24)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Asm2.op_String_Assignment@tok
@x0)
@x1)
(Asm2.op_String_Assignment @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Asm2.op_String_Assignment@tok
@x0)
@x1))
:qid token_correspondence_Asm2.op_String_Assignment))

:named token_correspondence_Asm2.op_String_Assignment))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Asm2.op_String_Access; Namespace Asm2
(assert (! 
;; def=Asm2.fst(20,4-20,20); use=Asm2.fst(20,4-20,20)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Asm2.op_String_Access@tok
@x0)
@x1)
(Asm2.op_String_Access @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Asm2.op_String_Access@tok
@x0)
@x1))
:qid token_correspondence_Asm2.op_String_Access))

:named token_correspondence_Asm2.op_String_Access))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Asm2.contains; Namespace Asm2
(assert (! 
;; def=Asm2.fst(22,4-22,12); use=Asm2.fst(22,4-22,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Asm2.contains@tok
@x0)
@x1)
(Asm2.contains @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Asm2.contains@tok
@x0)
@x1))
:qid token_correspondence_Asm2.contains))

:named token_correspondence_Asm2.contains))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Asm2.lemma_load; Namespace Asm2
(assert (! 
;; def=Asm2.fst(26,38-26,79); use=Asm2.fst(26,38-26,79)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_d4cd743945002dbdb9ac467d0fd505c9 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_d4cd743945002dbdb9ac467d0fd505c9 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_d4cd743945002dbdb9ac467d0fd505c9))

:named refinement_kinding_Tm_refine_d4cd743945002dbdb9ac467d0fd505c9))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Asm2.lemma_store; Namespace Asm2
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(31,6-31,52)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_460edf46599d63cff3eaff288ed58cf8 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_460edf46599d63cff3eaff288ed58cf8 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_460edf46599d63cff3eaff288ed58cf8))

:named refinement_kinding_Tm_refine_460edf46599d63cff3eaff288ed58cf8))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
;;; Fact-ids: Name Asm2.lemma_load; Namespace Asm2
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(27,6-27,43)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca))

:named refinement_kinding_Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d4cd743945002dbdb9ac467d0fd505c9 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Asm2.state)

;; def=Asm2.fst(26,50-26,76); use=Asm2.fst(26,50-26,76)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
(Tm_refine_d4cd743945002dbdb9ac467d0fd505c9 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_d4cd743945002dbdb9ac467d0fd505c9))

:named refinement_interpretation_Tm_refine_d4cd743945002dbdb9ac467d0fd505c9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_460edf46599d63cff3eaff288ed58cf8 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Asm2.fst(31,18-31,50); use=Asm2.fst(31,18-31,50)
(= @x1
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.op_String_Assignment@tok
Prims.int)
Prims.int)
@x2)
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_460edf46599d63cff3eaff288ed58cf8))

:named refinement_interpretation_Tm_refine_460edf46599d63cff3eaff288ed58cf8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
;; def=Asm2.fst(27,17-27,41); use=Asm2.fst(27,17-27,41)
(= @x1
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.op_String_Access@tok
Prims.int)
Prims.int)
@x2)
(BoxInt (+ (BoxInt_proj_0 @x3)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca))

:named refinement_interpretation_Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name Asm2.op_String_Assignment; Namespace Asm2
(assert (! 
;; def=Asm2.fst(21,0-21,34); use=Asm2.fst(21,0-21,34)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name Asm2.contains; Namespace Asm2
(assert (! 
;; def=Asm2.fst(22,0-22,27); use=Asm2.fst(22,0-22,27)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name Asm2.op_String_Access; Namespace Asm2
(assert (! 
;; def=Asm2.fst(20,0-20,30); use=Asm2.fst(20,0-20,30)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_d4cd743945002dbdb9ac467d0fd505c9
;;; Fact-ids: Name Asm2.lemma_load; Namespace Asm2
(assert (! 
;; def=Asm2.fst(26,38-26,79); use=Asm2.fst(26,38-26,79)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d4cd743945002dbdb9ac467d0fd505c9 @x0
@x1)))
(Valid (Prims.hasEq Asm2.state)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d4cd743945002dbdb9ac467d0fd505c9 @x0
@x1))))
:qid haseqTm_refine_d4cd743945002dbdb9ac467d0fd505c9))

:named haseqTm_refine_d4cd743945002dbdb9ac467d0fd505c9))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_460edf46599d63cff3eaff288ed58cf8
;;; Fact-ids: Name Asm2.lemma_store; Namespace Asm2
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(31,6-31,52)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_460edf46599d63cff3eaff288ed58cf8 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Asm2.state)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_460edf46599d63cff3eaff288ed58cf8 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_460edf46599d63cff3eaff288ed58cf8))

:named haseqTm_refine_460edf46599d63cff3eaff288ed58cf8))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca
;;; Fact-ids: Name Asm2.lemma_load; Namespace Asm2
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(27,6-27,43)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_2c32c4fbf0f0de5d7d88a55e873904ca @x0
@x1
@x2))))
:qid haseqTm_refine_2c32c4fbf0f0de5d7d88a55e873904ca))

:named haseqTm_refine_2c32c4fbf0f0de5d7d88a55e873904ca))
...
(assert (! (HasType Asm2.state
Tm_type)
:named function_token_typing_Asm2.state))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Asm2.op_String_Assignment; Namespace Asm2
(assert (! 
;; def=Asm2.fst(21,4-21,24); use=Asm2.fst(21,4-21,24)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Asm2.op_String_Assignment@tok
...
@x1)
@x2)
(Asm2.op_String_Assignment @x1
@x2))
 

:pattern ((Asm2.op_String_Assignment @x1
@x2))
:qid function_token_typing_Asm2.op_String_Assignment.1))
)
 

:pattern ((ApplyTT @x0
Asm2.op_String_Assignment@tok))
:qid function_token_typing_Asm2.op_String_Assignment))

:named function_token_typing_Asm2.op_String_Assignment))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Asm2.op_String_Access; Namespace Asm2
(assert (! 
;; def=Asm2.fst(20,4-20,20); use=Asm2.fst(20,4-20,20)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Asm2.op_String_Access@tok
...
@x1)
@x2)
(Asm2.op_String_Access @x1
@x2))
 

:pattern ((Asm2.op_String_Access @x1
@x2))
:qid function_token_typing_Asm2.op_String_Access.1))
)
 

:pattern ((ApplyTT @x0
Asm2.op_String_Access@tok))
:qid function_token_typing_Asm2.op_String_Access))

:named function_token_typing_Asm2.op_String_Access))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Asm2.contains; Namespace Asm2
(assert (! 
;; def=Asm2.fst(22,4-22,12); use=Asm2.fst(22,4-22,12)
...
:pattern ((Asm2.contains @x1
@x2))
:qid function_token_typing_Asm2.contains.1))
)
 

:pattern ((ApplyTT @x0
Asm2.contains@tok))
:qid function_token_typing_Asm2.contains))

:named function_token_typing_Asm2.contains))
...
;;;;;;;;;;;;;;;;Equation for Asm2.state
;;; Fact-ids: Name Asm2.state; Namespace Asm2
(assert (! (= Asm2.state
(Asm2.map Prims.int
Prims.int))
:named equation_Asm2.state))
;;;;;;;;;;;;;;;;Equation for Asm2.op_String_Assignment
;;; Fact-ids: Name Asm2.op_String_Assignment; Namespace Asm2
(assert (! 
;; def=Asm2.fst(21,4-21,24); use=Asm2.fst(21,4-21,24)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((Asm2.op_String_Assignment @x0
@x1))
:qid equation_Asm2.op_String_Assignment))

:named equation_Asm2.op_String_Assignment))
;;;;;;;;;;;;;;;;Equation for Asm2.op_String_Access
;;; Fact-ids: Name Asm2.op_String_Access; Namespace Asm2
(assert (! 
;; def=Asm2.fst(20,4-20,20); use=Asm2.fst(20,4-20,20)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((Asm2.op_String_Access @x0
@x1))
:qid equation_Asm2.op_String_Access))

:named equation_Asm2.op_String_Access))
;;;;;;;;;;;;;;;;Equation for Asm2.map
;;; Fact-ids: Name Asm2.map; Namespace Asm2
(assert (! 
;; def=Asm2.fst(19,4-19,7); use=Asm2.fst(19,4-19,7)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((Asm2.map @x0
@x1))
:qid equation_Asm2.map))

:named equation_Asm2.map))
;;;;;;;;;;;;;;;;Equation for Asm2.lemma_store
;;; Fact-ids: Name Asm2.lemma_store; Namespace Asm2
(assert (! 
;; def=Asm2.fst(30,4-30,15); use=Asm2.fst(30,4-30,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3))
:qid equation_Asm2.lemma_store))

:named equation_Asm2.lemma_store))
;;;;;;;;;;;;;;;;Equation for Asm2.lemma_load
;;; Fact-ids: Name Asm2.lemma_load; Namespace Asm2
(assert (! 
;; def=Asm2.fst(26,4-26,14); use=Asm2.fst(26,4-26,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x1
@x2))
:qid equation_Asm2.lemma_load))

:named equation_Asm2.lemma_load))
;;;;;;;;;;;;;;;;Equation for Asm2.contains
;;; Fact-ids: Name Asm2.contains; Namespace Asm2
(assert (! 
;; def=Asm2.fst(22,4-22,12); use=Asm2.fst(22,4-22,12)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((Asm2.contains @x0
@x1))
:qid equation_Asm2.contains))

:named equation_Asm2.contains))
...
;;; Fact-ids: Name Asm2.op_String_Assignment; Namespace Asm2
(assert (! 
;; def=FStar.Map.fsti(42,14-42,35); use=Asm2.fst(21,0-21,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ecbe25e460c8c11eb9fd7d4047b093d0)
...
@x1
Tm_arrow_ecbe25e460c8c11eb9fd7d4047b093d0))
:qid Asm2_pre_typing_Tm_arrow_ecbe25e460c8c11eb9fd7d4047b093d0))

:named Asm2_pre_typing_Tm_arrow_ecbe25e460c8c11eb9fd7d4047b093d0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Asm2.op_String_Assignment; Namespace Asm2
(assert (! 
;; def=Asm2.fst(21,0-21,34); use=Asm2.fst(21,0-21,34)
...
(Tm_arrow_e76ad7ea1b49a51ebc304bcd6e344d98 @x2
@x3)))
:qid Asm2_pre_typing_Tm_arrow_e76ad7ea1b49a51ebc304bcd6e344d98))

:named Asm2_pre_typing_Tm_arrow_e76ad7ea1b49a51ebc304bcd6e344d98))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Asm2.contains; Namespace Asm2
(assert (! 
;; def=Asm2.fst(22,0-22,27); use=Asm2.fst(22,0-22,27)
...
(Tm_arrow_9f4db3187888091a832b0a323f1b9876 @x2
@x3)))
:qid Asm2_pre_typing_Tm_arrow_9f4db3187888091a832b0a323f1b9876))

:named Asm2_pre_typing_Tm_arrow_9f4db3187888091a832b0a323f1b9876))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Asm2.contains; Namespace Asm2
(assert (! 
;; def=FStar.Map.fsti(51,19-51,40); use=Asm2.fst(22,0-22,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9d4a2d0290cfa26edf8ed23de72a5126)
...
@x1
Tm_arrow_9d4a2d0290cfa26edf8ed23de72a5126))
:qid Asm2_pre_typing_Tm_arrow_9d4a2d0290cfa26edf8ed23de72a5126))

:named Asm2_pre_typing_Tm_arrow_9d4a2d0290cfa26edf8ed23de72a5126))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Asm2.op_String_Access; Namespace Asm2
(assert (! 
;; def=Asm2.fst(20,0-20,30); use=Asm2.fst(20,0-20,30)
...
(Tm_arrow_9c859e8a1c6526d3222abd12b06f56e6 @x2
@x3)))
:qid Asm2_pre_typing_Tm_arrow_9c859e8a1c6526d3222abd12b06f56e6))

:named Asm2_pre_typing_Tm_arrow_9c859e8a1c6526d3222abd12b06f56e6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Asm2.op_String_Access; Namespace Asm2
(assert (! 
;; def=FStar.Map.fsti(39,14-39,35); use=Asm2.fst(20,0-20,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_6bba04b4885461a0e9e5b22b0a94469a)
...
@x1
Tm_arrow_6bba04b4885461a0e9e5b22b0a94469a))
:qid Asm2_pre_typing_Tm_arrow_6bba04b4885461a0e9e5b22b0a94469a))

:named Asm2_pre_typing_Tm_arrow_6bba04b4885461a0e9e5b22b0a94469a))
...
@x1)
@x2))
:qid Asm2_interpretation_Tm_arrow_ecbe25e460c8c11eb9fd7d4047b093d0.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Asm2_interpretation_Tm_arrow_ecbe25e460c8c11eb9fd7d4047b093d0.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_ecbe25e460c8c11eb9fd7d4047b093d0))
:qid Asm2_interpretation_Tm_arrow_ecbe25e460c8c11eb9fd7d4047b093d0))

:named Asm2_interpretation_Tm_arrow_ecbe25e460c8c11eb9fd7d4047b093d0))
...
@x4)
@x5))
:qid Asm2_interpretation_Tm_arrow_e76ad7ea1b49a51ebc304bcd6e344d98.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Asm2_interpretation_Tm_arrow_e76ad7ea1b49a51ebc304bcd6e344d98.2))
...
@x3)
@x4))
:qid Asm2_interpretation_Tm_arrow_e76ad7ea1b49a51ebc304bcd6e344d98.3))
))
...
(Tm_arrow_e76ad7ea1b49a51ebc304bcd6e344d98 @x1
@x2)))
:qid Asm2_interpretation_Tm_arrow_e76ad7ea1b49a51ebc304bcd6e344d98))

:named Asm2_interpretation_Tm_arrow_e76ad7ea1b49a51ebc304bcd6e344d98))
...
@x3)
@x4))
:qid Asm2_interpretation_Tm_arrow_9f4db3187888091a832b0a323f1b9876.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Asm2_interpretation_Tm_arrow_9f4db3187888091a832b0a323f1b9876.2))
))
...
(Tm_arrow_9f4db3187888091a832b0a323f1b9876 @x1
@x2)))
:qid Asm2_interpretation_Tm_arrow_9f4db3187888091a832b0a323f1b9876))

:named Asm2_interpretation_Tm_arrow_9f4db3187888091a832b0a323f1b9876))
...
@x1)
@x2))
:qid Asm2_interpretation_Tm_arrow_9d4a2d0290cfa26edf8ed23de72a5126.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Asm2_interpretation_Tm_arrow_9d4a2d0290cfa26edf8ed23de72a5126.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_9d4a2d0290cfa26edf8ed23de72a5126))
:qid Asm2_interpretation_Tm_arrow_9d4a2d0290cfa26edf8ed23de72a5126))

:named Asm2_interpretation_Tm_arrow_9d4a2d0290cfa26edf8ed23de72a5126))
...
@x3)
@x4))
:qid Asm2_interpretation_Tm_arrow_9c859e8a1c6526d3222abd12b06f56e6.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Asm2_interpretation_Tm_arrow_9c859e8a1c6526d3222abd12b06f56e6.2))
))
...
(Tm_arrow_9c859e8a1c6526d3222abd12b06f56e6 @x1
@x2)))
:qid Asm2_interpretation_Tm_arrow_9c859e8a1c6526d3222abd12b06f56e6))

:named Asm2_interpretation_Tm_arrow_9c859e8a1c6526d3222abd12b06f56e6))
...
@x1)
@x2))
:qid Asm2_interpretation_Tm_arrow_6bba04b4885461a0e9e5b22b0a94469a.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Asm2_interpretation_Tm_arrow_6bba04b4885461a0e9e5b22b0a94469a.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_6bba04b4885461a0e9e5b22b0a94469a))
:qid Asm2_interpretation_Tm_arrow_6bba04b4885461a0e9e5b22b0a94469a))

:named Asm2_interpretation_Tm_arrow_6bba04b4885461a0e9e5b22b0a94469a))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Asm2.contains; Namespace Asm2
...
(assert (! (Valid (ApplyTT __uu__PartialApp
Asm2.op_String_Assignment@tok))
:named @kick_partial_app_7bad2d59a148901d552e3778de7cb9c3))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Asm2.lemma_load; Namespace Asm2
(assert (! (Valid (ApplyTT __uu__PartialApp
Asm2.op_String_Access@tok))
:named @kick_partial_app_551863a91aa00e5cbeefebea48215272))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Asm2.lemma_load; Namespace Asm2
(assert (! (Valid (ApplyTT __uu__PartialApp
Asm2.contains@tok))
:named @kick_partial_app_5513c6274fb17b9fc1522c9ef2db1bfc))
(push) ;; push{2

; Starting query at Asm2.fst(49,39-56,4)
...
(declare-fun Tm_refine_25811cedadda807e5c53d24f7e2e1016 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(34,24-42,31); use=Asm2.fst(34,24-42,31)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_25811cedadda807e5c53d24f7e2e1016 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_25811cedadda807e5c53d24f7e2e1016 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_25811cedadda807e5c53d24f7e2e1016))

:named refinement_kinding_Tm_refine_25811cedadda807e5c53d24f7e2e1016))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(34,24-42,31); use=Asm2.fst(34,24-42,31)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_25811cedadda807e5c53d24f7e2e1016 @x2))
(and (HasTypeFuel @u0
@x1
Asm2.state)

;; def=Asm2.fst(37,10-37,28); use=Asm2.fst(37,10-37,28)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(38,10-38,28); use=Asm2.fst(38,10-38,28)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(39,10-39,28); use=Asm2.fst(39,10-39,28)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(40,10-40,29); use=Asm2.fst(40,10-40,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(41,10-41,29); use=Asm2.fst(41,10-41,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(42,10-42,29); use=Asm2.fst(42,10-42,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
@x1
(Tm_refine_25811cedadda807e5c53d24f7e2e1016 @x2)))
:qid refinement_interpretation_Tm_refine_25811cedadda807e5c53d24f7e2e1016))

:named refinement_interpretation_Tm_refine_25811cedadda807e5c53d24f7e2e1016))
;;;;;;;;;;;;;;;;haseq for Tm_refine_25811cedadda807e5c53d24f7e2e1016
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(34,24-42,31); use=Asm2.fst(34,24-42,31)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_25811cedadda807e5c53d24f7e2e1016 @x0)))
(Valid (Prims.hasEq Asm2.state)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_25811cedadda807e5c53d24f7e2e1016 @x0))))
:qid haseqTm_refine_25811cedadda807e5c53d24f7e2e1016))

:named haseqTm_refine_25811cedadda807e5c53d24f7e2e1016))
...
(declare-fun Tm_refine_24411fada6585229e73747b229b8f1a3 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_24411fada6585229e73747b229b8f1a3 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_24411fada6585229e73747b229b8f1a3 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_24411fada6585229e73747b229b8f1a3))

:named refinement_kinding_Tm_refine_24411fada6585229e73747b229b8f1a3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(49,39-56,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_24411fada6585229e73747b229b8f1a3 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=Asm2.fst(27,17-27,41); use=Asm2.fst(49,39-56,4)
(= @x1
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.op_String_Access@tok
Prims.int)
Prims.int)
...
(Tm_refine_24411fada6585229e73747b229b8f1a3 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_24411fada6585229e73747b229b8f1a3))

:named refinement_interpretation_Tm_refine_24411fada6585229e73747b229b8f1a3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_24411fada6585229e73747b229b8f1a3
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_24411fada6585229e73747b229b8f1a3 @x0
@x1)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_24411fada6585229e73747b229b8f1a3 @x0
@x1))))
:qid haseqTm_refine_24411fada6585229e73747b229b8f1a3))

:named haseqTm_refine_24411fada6585229e73747b229b8f1a3))
...
(declare-fun Tm_refine_026aaac48ee6fd9eb4372b527051a6a9 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_026aaac48ee6fd9eb4372b527051a6a9 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_026aaac48ee6fd9eb4372b527051a6a9 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_026aaac48ee6fd9eb4372b527051a6a9))

:named refinement_kinding_Tm_refine_026aaac48ee6fd9eb4372b527051a6a9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(49,39-56,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_026aaac48ee6fd9eb4372b527051a6a9 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.int)
...
(Tm_refine_026aaac48ee6fd9eb4372b527051a6a9 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_026aaac48ee6fd9eb4372b527051a6a9))

:named refinement_interpretation_Tm_refine_026aaac48ee6fd9eb4372b527051a6a9))
;;;;;;;;;;;;;;;;haseq for Tm_refine_026aaac48ee6fd9eb4372b527051a6a9
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_026aaac48ee6fd9eb4372b527051a6a9 @x0
@x1)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_026aaac48ee6fd9eb4372b527051a6a9 @x0
@x1))))
:qid haseqTm_refine_026aaac48ee6fd9eb4372b527051a6a9))

:named haseqTm_refine_026aaac48ee6fd9eb4372b527051a6a9))
...
(declare-fun Tm_refine_18da1ab55359e5f6b7c2b8981abdf423 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_18da1ab55359e5f6b7c2b8981abdf423 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_18da1ab55359e5f6b7c2b8981abdf423 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_18da1ab55359e5f6b7c2b8981abdf423))

:named refinement_kinding_Tm_refine_18da1ab55359e5f6b7c2b8981abdf423))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(49,39-56,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_18da1ab55359e5f6b7c2b8981abdf423 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.int)
...
(Tm_refine_18da1ab55359e5f6b7c2b8981abdf423 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_18da1ab55359e5f6b7c2b8981abdf423))

:named refinement_interpretation_Tm_refine_18da1ab55359e5f6b7c2b8981abdf423))
;;;;;;;;;;;;;;;;haseq for Tm_refine_18da1ab55359e5f6b7c2b8981abdf423
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(27,6-27,43); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_18da1ab55359e5f6b7c2b8981abdf423 @x0
@x1)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_18da1ab55359e5f6b7c2b8981abdf423 @x0
@x1))))
:qid haseqTm_refine_18da1ab55359e5f6b7c2b8981abdf423))

:named haseqTm_refine_18da1ab55359e5f6b7c2b8981abdf423))
...
(declare-fun Tm_refine_d0e677217d63b81a6c38149e76ddab88 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_d0e677217d63b81a6c38149e76ddab88 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_d0e677217d63b81a6c38149e76ddab88 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_d0e677217d63b81a6c38149e76ddab88))

:named refinement_kinding_Tm_refine_d0e677217d63b81a6c38149e76ddab88))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(49,39-56,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d0e677217d63b81a6c38149e76ddab88 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Asm2.state)

;; def=Asm2.fst(31,18-31,50); use=Asm2.fst(49,39-56,4)
(= @x1
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.op_String_Assignment@tok
Prims.int)
Prims.int)
...
(Tm_refine_d0e677217d63b81a6c38149e76ddab88 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_d0e677217d63b81a6c38149e76ddab88))

:named refinement_interpretation_Tm_refine_d0e677217d63b81a6c38149e76ddab88))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d0e677217d63b81a6c38149e76ddab88
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d0e677217d63b81a6c38149e76ddab88 @x0
@x1)))
(Valid (Prims.hasEq Asm2.state)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d0e677217d63b81a6c38149e76ddab88 @x0
@x1))))
:qid haseqTm_refine_d0e677217d63b81a6c38149e76ddab88))

:named haseqTm_refine_d0e677217d63b81a6c38149e76ddab88))





(declare-fun Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b))

:named refinement_kinding_Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(49,39-56,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b @x2
@x3))
(and (HasTypeFuel @u0
@x1
Asm2.state)
...
(Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b @x2
@x3)))
:qid refinement_interpretation_Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b))

:named refinement_interpretation_Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b @x0
@x1)))
(Valid (Prims.hasEq Asm2.state)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b @x0
@x1))))
:qid haseqTm_refine_15ad8abc8ff0aeab250120c7dafaf73b))

:named haseqTm_refine_15ad8abc8ff0aeab250120c7dafaf73b))





(declare-fun Tm_refine_8bead5a9698fb1977bdbdaa40b51221b (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_8bead5a9698fb1977bdbdaa40b51221b @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_8bead5a9698fb1977bdbdaa40b51221b @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_8bead5a9698fb1977bdbdaa40b51221b))

:named refinement_kinding_Tm_refine_8bead5a9698fb1977bdbdaa40b51221b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(49,39-56,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8bead5a9698fb1977bdbdaa40b51221b @x2
@x3))
(and (HasTypeFuel @u0
@x1
Asm2.state)
...
(Tm_refine_8bead5a9698fb1977bdbdaa40b51221b @x2
@x3)))
:qid refinement_interpretation_Tm_refine_8bead5a9698fb1977bdbdaa40b51221b))

:named refinement_interpretation_Tm_refine_8bead5a9698fb1977bdbdaa40b51221b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8bead5a9698fb1977bdbdaa40b51221b
;;; Fact-ids: 
(assert (! 
;; def=Asm2.fst(31,6-31,52); use=Asm2.fst(49,39-56,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8bead5a9698fb1977bdbdaa40b51221b @x0
@x1)))
(Valid (Prims.hasEq Asm2.state)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8bead5a9698fb1977bdbdaa40b51221b @x0
@x1))))
:qid haseqTm_refine_8bead5a9698fb1977bdbdaa40b51221b))

:named haseqTm_refine_8bead5a9698fb1977bdbdaa40b51221b))
...
; Encoding query formula : forall (r3: Prims.int)
;   (s0:
;   Asm2.state
;     { Asm2.contains s0 (r3 + 0) /\ Asm2.contains s0 (r3 + 1) /\ Asm2.contains s0 (r3 + 2) /\
;       Asm2.contains s0 (r3 + 20) /\ Asm2.contains s0 (r3 + 21) /\ Asm2.contains s0 (r3 + 22) }).
;   (*  - Could not prove post-condition
; *)
;   (Asm2.contains s0 (r3 + 0) /\ Asm2.contains s0 (r3 + 1) /\ Asm2.contains s0 (r3 + 2) /\
;     Asm2.contains s0 (r3 + 20) /\ Asm2.contains s0 (r3 + 21) /\ Asm2.contains s0 (r3 + 22) ==>
;     Asm2.contains s0 (r3 + 0)) /\
;   (forall (any_result:
;       s0:
;       Asm2.state
;         { Asm2.contains s0 (r3 + 0) /\ Asm2.contains s0 (r3 + 1) /\ Asm2.contains s0 (r3 + 2) /\
;           Asm2.contains s0 (r3 + 20) /\ Asm2.contains s0 (r3 + 21) /\ Asm2.contains s0 (r3 + 22) }).
;       s0 == any_result ==>
;       (forall (any_result: dst: Prims.int{dst == s0.[ r3 + 0 ]}).
;           Asm2.lemma_load r3 0 s0 == any_result ==>
;           (Asm2.contains s0 (r3 + 0) /\ Asm2.contains s0 (r3 + 1) /\ Asm2.contains s0 (r3 + 2) /\
;             Asm2.contains s0 (r3 + 20) /\ Asm2.contains s0 (r3 + 21) /\ Asm2.contains s0 (r3 + 22) ==>
;             Asm2.contains s0 (r3 + 1)) /\
;           (forall (any_result:
;               s0:
;               Asm2.state
;                 { Asm2.contains s0 (r3 + 0) /\ Asm2.contains s0 (r3 + 1) /\
;                   Asm2.contains s0 (r3 + 2) /\ Asm2.contains s0 (r3 + 20) /\
;                   Asm2.contains s0 (r3 + 21) /\ Asm2.contains s0 (r3 + 22) }).
;               s0 == any_result ==>
;               (forall (any_result: dst: Prims.int{dst == s0.[ r3 + 1 ]}).
;                   Asm2.lemma_load r3 1 s0 == any_result ==>
;                   (Asm2.contains s0 (r3 + 0) /\ Asm2.contains s0 (r3 + 1) /\
;                     Asm2.contains s0 (r3 + 2) /\ Asm2.contains s0 (r3 + 20) /\
;                     Asm2.contains s0 (r3 + 21) /\ Asm2.contains s0 (r3 + 22) ==>
;                     Asm2.contains s0 (r3 + 2)) /\
;                   (forall (any_result:
;                       s0:
;                       Asm2.state
;                         { Asm2.contains s0 (r3 + 0) /\ Asm2.contains s0 (r3 + 1) /\
...
;                           Asm2.contains s0 (r3 + 21) /\ Asm2.contains s0 (r3 + 22) }).
;                       s0 == any_result ==>
;                       (forall (any_result: dst: Prims.int{dst == s0.[ r3 + 2 ]}).
;                           Asm2.lemma_load r3 2 s0 == any_result ==>
;                           (Asm2.contains s0 (r3 + 0) /\ Asm2.contains s0 (r3 + 1) /\
;                             Asm2.contains s0 (r3 + 2) /\ Asm2.contains s0 (r3 + 20) /\
;                             Asm2.contains s0 (r3 + 21) /\ Asm2.contains s0 (r3 + 22) ==>
;                             Asm2.contains s0 (r3 + 20)) /\
;                           (forall (any_result:
;                               s0:
;                               Asm2.state
;                                 { Asm2.contains s0 (r3 + 0) /\ Asm2.contains s0 (r3 + 1) /\
...
;                               s0 == any_result ==>
;                               (forall (any_result:
;                                   s1: Asm2.state{s1 == (s0.[ r3 + 20 ] <- Asm2.lemma_load r3 0 s0)})
;                                 .
;                                   Asm2.lemma_store r3 20 (Asm2.lemma_load r3 0 s0) s0 == any_result ==>
;                                   (Asm2.lemma_store r3 20 (Asm2.lemma_load r3 0 s0) s0 ==
;                                     (s0.[ r3 + 20 ] <- Asm2.lemma_load r3 0 s0) ==>
;                                     Asm2.contains (Asm2.lemma_store r3
;                                           20
;                                           (Asm2.lemma_load r3 0 s0)
;                                           s0)
;                                       (r3 + 21)) /\
;                                   (forall (any_result:
;                                       s1:
;                                       Asm2.state{s1 == (s0.[ r3 + 20 ] <- Asm2.lemma_load r3 0 s0)})
;                                     .
;                                       Asm2.lemma_store r3 20 (Asm2.lemma_load r3 0 s0) s0 ==
;                                       any_result ==>
;                                       (forall (any_result:
...
;                                             { s1 ==
;                                               ((Asm2.lemma_store r3 20 (Asm2.lemma_load r3 0 s0) s0).[
;                                                   r3 + 21 ] <- Asm2.lemma_load r3 1 s0) }).
;                                           Asm2.lemma_store r3
;                                             21
;                                             (Asm2.lemma_load r3 1 s0)
;                                             (Asm2.lemma_store r3 20 (Asm2.lemma_load r3 0 s0) s0) ==
;                                           any_result ==>
;                                           (Asm2.lemma_store r3
;                                               21
...
;                                                         20
;                                                         (Asm2.lemma_load r3 0 s0)
;                                                         s0).[ r3 + 21 ] <- Asm2.lemma_load r3 1 s0)
;                                                 }).
;                                               Asm2.lemma_store r3
;                                                 21
;                                                 (Asm2.lemma_load r3 1 s0)
...
Prims.int)
(HasType @x1
(Tm_refine_25811cedadda807e5c53d24f7e2e1016 @x0)))

;; def=Prims.fst(459,77-459,89); use=Asm2.fst(49,39-56,4)
(and (implies 
;; def=Asm2.fst(37,10-42,29); use=Asm2.fst(50,27-50,29)
(and 
;; def=Asm2.fst(37,10-37,28); use=Asm2.fst(50,27-50,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(38,10-38,28); use=Asm2.fst(50,27-50,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(39,10-39,28); use=Asm2.fst(50,27-50,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(40,10-40,29); use=Asm2.fst(50,27-50,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(41,10-41,29); use=Asm2.fst(50,27-50,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(42,10-42,29); use=Asm2.fst(50,27-50,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(26,50-26,76); use=Asm2.fst(50,27-50,29)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=Asm2.fst(49,39-56,4)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Tm_refine_25811cedadda807e5c53d24f7e2e1016 @x0))

;; def=Asm2.fst(26,39-34,27); use=Asm2.fst(49,39-56,4)
(= @x1
@x2)
)
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Tm_refine_24411fada6585229e73747b229b8f1a3 @x1
@x0))

;; def=Asm2.fst(50,6-50,29); use=Asm2.fst(50,6-50,29)
(= (Asm2.lemma_load @x0
(BoxInt 0)
@x1)
@x3)
...
;; def=Prims.fst(459,77-459,89); use=Asm2.fst(49,39-56,4)
(and (implies 
;; def=Asm2.fst(37,10-42,29); use=Asm2.fst(51,27-51,29)
(and 
;; def=Asm2.fst(37,10-37,28); use=Asm2.fst(51,27-51,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(38,10-38,28); use=Asm2.fst(51,27-51,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(39,10-39,28); use=Asm2.fst(51,27-51,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(40,10-40,29); use=Asm2.fst(51,27-51,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(41,10-41,29); use=Asm2.fst(51,27-51,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(42,10-42,29); use=Asm2.fst(51,27-51,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(26,50-26,76); use=Asm2.fst(51,27-51,29)
(or label_2
...
(Tm_refine_026aaac48ee6fd9eb4372b527051a6a9 @x1
@x0))

;; def=Asm2.fst(51,6-51,29); use=Asm2.fst(51,6-51,29)
(= (Asm2.lemma_load @x0
(BoxInt 1)
@x1)
@x5)
...
;; def=Prims.fst(459,77-459,89); use=Asm2.fst(49,39-56,4)
(and (implies 
;; def=Asm2.fst(37,10-42,29); use=Asm2.fst(52,27-52,29)
(and 
;; def=Asm2.fst(37,10-37,28); use=Asm2.fst(52,27-52,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(38,10-38,28); use=Asm2.fst(52,27-52,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(39,10-39,28); use=Asm2.fst(52,27-52,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(40,10-40,29); use=Asm2.fst(52,27-52,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(41,10-41,29); use=Asm2.fst(52,27-52,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(42,10-42,29); use=Asm2.fst(52,27-52,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(26,50-26,76); use=Asm2.fst(52,27-52,29)
(or label_3
...
(Tm_refine_18da1ab55359e5f6b7c2b8981abdf423 @x1
@x0))

;; def=Asm2.fst(52,6-52,29); use=Asm2.fst(52,6-52,29)
(= (Asm2.lemma_load @x0
(BoxInt 2)
@x1)
@x7)
...
;; def=Prims.fst(459,77-459,89); use=Asm2.fst(49,39-56,4)
(and (implies 
;; def=Asm2.fst(37,10-42,29); use=Asm2.fst(53,32-53,34)
(and 
;; def=Asm2.fst(37,10-37,28); use=Asm2.fst(53,32-53,34)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(38,10-38,28); use=Asm2.fst(53,32-53,34)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(39,10-39,28); use=Asm2.fst(53,32-53,34)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(40,10-40,29); use=Asm2.fst(53,32-53,34)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(41,10-41,29); use=Asm2.fst(53,32-53,34)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(42,10-42,29); use=Asm2.fst(53,32-53,34)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Asm2.contains@tok
Prims.int)
Prims.int)
@x1)
...
;; def=Asm2.fst(30,61-30,87); use=Asm2.fst(53,32-53,34)
(or label_4
...
;; def=Asm2.fst(30,50-34,27); use=Asm2.fst(49,39-56,4)
(= @x1
@x8)
)
...
(Tm_refine_d0e677217d63b81a6c38149e76ddab88 @x1
@x0))

;; def=Asm2.fst(53,6-53,34); use=Asm2.fst(53,6-53,34)
(= (Asm2.lemma_store @x0
(BoxInt 20)
(Asm2.lemma_load @x0
(BoxInt 0)
...
;; def=Prims.fst(459,77-459,89); use=Asm2.fst(49,39-56,4)
(and (implies 
;; def=Asm2.fst(31,18-31,50); use=Asm2.fst(54,32-54,34)
(= (Asm2.lemma_store @x0
(BoxInt 20)
(Asm2.lemma_load @x0
(BoxInt 0)
...
;; def=Asm2.fst(30,61-30,87); use=Asm2.fst(54,32-54,34)
(or label_5
...
;; def=Asm2.fst(30,50-53,8); use=Asm2.fst(49,39-56,4)
(= (Asm2.lemma_store @x0
(BoxInt 20)
(Asm2.lemma_load @x0
(BoxInt 0)
...
(Tm_refine_15ad8abc8ff0aeab250120c7dafaf73b @x0
@x1))

;; def=Asm2.fst(54,6-54,34); use=Asm2.fst(54,6-54,34)
(= (Asm2.lemma_store @x0
(BoxInt 21)
(Asm2.lemma_load @x0
(BoxInt 1)
...
;; def=Prims.fst(459,77-459,89); use=Asm2.fst(49,39-56,4)
(and (implies 
;; def=Asm2.fst(31,18-31,50); use=Asm2.fst(55,32-55,34)
(= (Asm2.lemma_store @x0
(BoxInt 21)
(Asm2.lemma_load @x0
(BoxInt 1)
...
;; def=Asm2.fst(30,61-30,87); use=Asm2.fst(55,32-55,34)
(or label_6
...
;; def=Asm2.fst(30,50-54,8); use=Asm2.fst(49,39-56,4)
(= (Asm2.lemma_store @x0
(BoxInt 21)
(Asm2.lemma_load @x0
(BoxInt 1)
...
(Tm_refine_8bead5a9698fb1977bdbdaa40b51221b @x0
@x1))

;; def=Asm2.fst(55,6-55,34); use=Asm2.fst(55,6-55,34)
(= (Asm2.lemma_store @x0
(BoxInt 22)
(Asm2.lemma_load @x0
(BoxInt 2)
...
;; def=Asm2.fst(31,18-31,50); use=Asm2.fst(56,2-56,4)
(= (Asm2.lemma_store @x0
(BoxInt 22)
(Asm2.lemma_load @x0
(BoxInt 2)
...
;; def=Asm2.fst(47,10-49,35); use=Asm2.fst(56,2-56,4)
(and 
;; def=Asm2.fst(47,10-47,35); use=Asm2.fst(56,2-56,4)
(or label_7
...
;; def=Asm2.fst(48,10-48,35); use=Asm2.fst(56,2-56,4)
(or label_8
...
;; def=Asm2.fst(49,10-49,35); use=Asm2.fst(56,2-56,4)
(or label_9
