...
; Internals for X64.Vale.StateLemmas_i
...
; encoding sigelt val X64.Vale.StateLemmas_i.state_to_S


; <Skipped val X64.Vale.StateLemmas_i.state_to_S/>
...
; Starting query at X64.Vale.StateLemmas_i.fst(28,2-33,44)
...
(declare-fun Tm_abs_b59262a89c54ab08c57246cf5b2254f9 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_b59262a89c54ab08c57246cf5b2254f9
;;; Fact-ids: 
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(29,34-29,48); use=X64.Vale.StateLemmas_i.fst(29,34-29,48)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_b59262a89c54ab08c57246cf5b2254f9 @x0)
Tm_arrow_645426269fc615b2b182027e55cc5771)
 

:pattern ((Tm_abs_b59262a89c54ab08c57246cf5b2254f9 @x0))
:qid typing_Tm_abs_b59262a89c54ab08c57246cf5b2254f9))

:named typing_Tm_abs_b59262a89c54ab08c57246cf5b2254f9))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_b59262a89c54ab08c57246cf5b2254f9
;;; Fact-ids: 
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(29,34-29,48); use=X64.Vale.StateLemmas_i.fst(29,34-29,48)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_b59262a89c54ab08c57246cf5b2254f9 @x1)
@x0)
(X64.Semantics_s.u (ApplyTT (ApplyTT X64.Vale.State_i.__proj__Mkstate__item__regs@tok
@x1)
@x0)))
 

:pattern ((ApplyTT (Tm_abs_b59262a89c54ab08c57246cf5b2254f9 @x1)
@x0))
:qid interpretation_Tm_abs_b59262a89c54ab08c57246cf5b2254f9))

:named interpretation_Tm_abs_b59262a89c54ab08c57246cf5b2254f9))
...
;       (*  - Could not prove post-condition
; *)
;       s.regs r >= 0 /\ s.regs r < 0x10000000000000000 ==> FStar.UInt.fits (s.regs r) 64) /\
;   (forall (any_result: (x: X64.Machine_s.reg -> X64.Semantics_s.uint64)).
;       (fun r -> X64.Semantics_s.u (s.regs r)) == any_result ==>
;       (forall (any_result:
;           FStar.FunctionalExtensionality.restricted_t X64.Machine_s.reg
;             (fun _ -> X64.Semantics_s.uint64)).
;           FStar.FunctionalExtensionality.on_domain X64.Machine_s.reg
;             (fun r -> X64.Semantics_s.u (s.regs r)) ==
;           any_result ==>
;           (X64.Machine_s.int_to_nat64 s.flags >= 0 /\
;             X64.Machine_s.int_to_nat64 s.flags < 0x10000000000000000 /\
;             (0 <= s.flags && s.flags < 0x10000000000000000 ==>
;               s.flags == X64.Machine_s.int_to_nat64 s.flags) ==>
;             FStar.UInt.fits (X64.Machine_s.int_to_nat64 s.flags) 64) /\
;           (forall (return_val: i: Prims.int{FStar.UInt.fits i 64}).
;               return_val == X64.Machine_s.int_to_nat64 s.flags ==>
;               (forall (any_result: X64.Semantics_s.uint64).
;                   X64.Semantics_s.u (X64.Machine_s.int_to_nat64 s.flags) == any_result ==>
;                   (forall (i: Prims.int).
;                       (*  - Could not prove post-condition
; *)
;                       FStar.Map.sel s.mem i >= 0 /\ FStar.Map.sel s.mem i < 0x10000000000000000 ==>
;                       FStar.UInt.fits (FStar.Map.sel s.mem i) 64)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let state_to_S`
...
;; def=Prims.fst(459,77-459,89); use=X64.Vale.StateLemmas_i.fst(28,2-33,44)
(and 
;; def=dummy(0,0-0,0); use=X64.Vale.StateLemmas_i.fst(28,2-33,44)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
X64.Machine_s.reg)

;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fst(29,38-29,48)
...
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fst(29,38-29,48)
(< (BoxInt_proj_0 (ApplyTT (ApplyTT X64.Vale.State_i.__proj__Mkstate__item__regs@tok
@x0)
@x1))
18446744073709551616)
...
;; def=X64.Semantics_s.fst(73,13-73,33); use=X64.Vale.StateLemmas_i.fst(29,38-29,48)
(or label_1

;; def=X64.Semantics_s.fst(73,13-73,33); use=X64.Vale.StateLemmas_i.fst(29,38-29,48)
(BoxBool_proj_0 (FStar.UInt.fits (ApplyTT (ApplyTT X64.Vale.State_i.__proj__Mkstate__item__regs@tok
@x0)
@x1)
(BoxInt 64)))
)
...
;; def=Prims.fst(451,66-451,102); use=X64.Vale.StateLemmas_i.fst(28,2-33,44)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Tm_arrow_645426269fc615b2b182027e55cc5771)

;; def=FStar.FunctionalExtensionality.fsti(117,40-117,41); use=X64.Vale.StateLemmas_i.fst(28,2-33,44)
(= (Tm_abs_b59262a89c54ab08c57246cf5b2254f9 @x0)
@x1)
)
...
;; def=X64.Semantics_s.fst(68,2-68,6); use=X64.Vale.StateLemmas_i.fst(28,2-33,44)
(= (FStar.FunctionalExtensionality.on_domain X64.Machine_s.reg
Tm_abs_2da3d120bd5ce08465191535a1915477
(Tm_abs_b59262a89c54ab08c57246cf5b2254f9 @x0))
@x2)
...
;; def=Prims.fst(459,77-459,89); use=X64.Vale.StateLemmas_i.fst(28,2-33,44)
(and (implies 
;; def=X64.Machine_s.fst(27,19-28,77); use=X64.Vale.StateLemmas_i.fst(30,17-30,29)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fst(30,16-30,38)
(>= (BoxInt_proj_0 (X64.Machine_s.int_to_nat64 (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)))
0)


;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fst(30,16-30,38)
(< (BoxInt_proj_0 (X64.Machine_s.int_to_nat64 (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)))
18446744073709551616)


;; def=X64.Machine_s.fst(28,43-28,77); use=X64.Vale.StateLemmas_i.fst(30,16-30,38)
(implies 
;; def=X64.Machine_s.fst(28,43-28,66); use=X64.Vale.StateLemmas_i.fst(30,16-30,38)
(and (BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
(X64.Vale.State_i.__proj__Mkstate__item__flags @x0)))
(BoxBool_proj_0 (Prims.op_LessThan (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)
(BoxInt 18446744073709551616))))


;; def=X64.Machine_s.fst(28,71-28,77); use=X64.Vale.StateLemmas_i.fst(30,16-30,38)
(= (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)
(X64.Machine_s.int_to_nat64 (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)))
)
)


;; def=X64.Semantics_s.fst(73,13-73,33); use=X64.Vale.StateLemmas_i.fst(30,16-30,38)
(or label_2

;; def=X64.Semantics_s.fst(73,13-73,33); use=X64.Vale.StateLemmas_i.fst(30,16-30,38)
(BoxBool_proj_0 (FStar.UInt.fits (X64.Machine_s.int_to_nat64 (X64.Vale.State_i.__proj__Mkstate__item__flags @x0))
(BoxInt 64)))
)
)

;; def=Prims.fst(356,2-356,58); use=X64.Vale.StateLemmas_i.fst(28,2-33,44)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_4a56532dbb80b238f6b7d86890fac538)

;; def=Prims.fst(356,26-356,41); use=X64.Vale.StateLemmas_i.fst(28,2-33,44)
(= @x3
(X64.Machine_s.int_to_nat64 (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)))
)
...
;; def=X64.Semantics_s.fst(69,2-69,7); use=X64.Vale.StateLemmas_i.fst(28,2-33,44)
(= (X64.Semantics_s.u (X64.Machine_s.int_to_nat64 (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)))
@x4)
)
...
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fst(32,26-32,43)
(>= (BoxInt_proj_0 (FStar.Map.sel Prims.int
X64.Machine_s.nat64
(X64.Vale.State_i.__proj__Mkstate__item__mem @x0)
@x5))
0)
...
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fst(32,26-32,43)
(< (BoxInt_proj_0 (FStar.Map.sel Prims.int
X64.Machine_s.nat64
(X64.Vale.State_i.__proj__Mkstate__item__mem @x0)
@x5))
...
;; def=X64.Semantics_s.fst(73,13-73,33); use=X64.Vale.StateLemmas_i.fst(32,26-32,43)
(or label_3

;; def=X64.Semantics_s.fst(73,13-73,33); use=X64.Vale.StateLemmas_i.fst(32,26-32,43)
(BoxBool_proj_0 (FStar.UInt.fits (FStar.Map.sel Prims.int
X64.Machine_s.nat64
(X64.Vale.State_i.__proj__Mkstate__item__mem @x0)
@x5)
(BoxInt 64)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.state_to_S, 1)
; STATUS: unsat
...
; encoding sigelt let state_to_S


; <Start encoding let state_to_S>
...
(declare-fun Tm_abs_b59262a89c54ab08c57246cf5b2254f9 (Term) Term)
;;;;;;;;;;;;;;;;i: Prims.int -> X64.Semantics_s.uint64
(declare-fun Tm_arrow_510ffde50cba047426243ffc68c85113 () Term)
(declare-fun Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6 (Term) Term)

; </end encoding let state_to_S>


; encoding sigelt val X64.Vale.StateLemmas_i.state_of_S


; <Skipped val X64.Vale.StateLemmas_i.state_of_S/>
...
; Starting query at X64.Vale.StateLemmas_i.fst(36,36-44,3)
...
(declare-fun Tm_abs_df5fee5ecee368c0044326eeb687043f (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_df5fee5ecee368c0044326eeb687043f
;;; Fact-ids: 
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(39,34-39,62); use=X64.Vale.StateLemmas_i.fst(39,34-39,62)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_df5fee5ecee368c0044326eeb687043f @x0)
Tm_arrow_1093f8e31085b67d2aaada502a6d45cd)
 

:pattern ((Tm_abs_df5fee5ecee368c0044326eeb687043f @x0))
:qid typing_Tm_abs_df5fee5ecee368c0044326eeb687043f))

:named typing_Tm_abs_df5fee5ecee368c0044326eeb687043f))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_df5fee5ecee368c0044326eeb687043f
;;; Fact-ids: 
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(39,34-39,62); use=X64.Vale.StateLemmas_i.fst(39,34-39,62)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_df5fee5ecee368c0044326eeb687043f @x1)
@x0)
(FStar.UInt64.v (ApplyTT @x1
@x0)))
 

:pattern ((ApplyTT (Tm_abs_df5fee5ecee368c0044326eeb687043f @x1)
@x0))
:qid interpretation_Tm_abs_df5fee5ecee368c0044326eeb687043f))

:named interpretation_Tm_abs_df5fee5ecee368c0044326eeb687043f))
...
; Encoding query formula : forall (s: X64.Semantics_s.state).
;   (*  - Could not prove post-condition
; *)
;   forall (b: Prims.bool)
;     (b:
;     FStar.FunctionalExtensionality.restricted_t X64.Machine_s.reg (fun _ -> X64.Semantics_s.uint64))
;     (b: X64.Semantics_s.uint64)
;     (b: X64.Semantics_s.mem).
;     s == X64.Semantics_s.Mkstate b b b b ==>
;     (forall (r: X64.Machine_s.reg).
;         (*  - Could not prove post-condition
; *)
;         FStar.UInt.size (FStar.UInt64.v (b r)) 64 ==>
;         FStar.UInt64.v (b r) >= 0 /\ FStar.UInt64.v (b r) < 0x10000000000000000) /\
;     (forall (any_result: (x: X64.Machine_s.reg -> X64.Machine_s.nat64)).
;         (fun r -> FStar.UInt64.v (b r) <: X64.Machine_s.nat64) == any_result ==>
;         (forall (any_result:
;             FStar.FunctionalExtensionality.restricted_t X64.Machine_s.reg
;               (fun _ -> X64.Machine_s.nat64)).
;             FStar.FunctionalExtensionality.on_domain X64.Machine_s.reg
;               (fun r -> FStar.UInt64.v (b r) <: X64.Machine_s.nat64) ==
;             any_result ==>
;             (forall (return_val:
;                 FStar.FunctionalExtensionality.restricted_t X64.Machine_s.reg
;                   (fun _ -> X64.Machine_s.nat64)).
...
;                   (fun r -> FStar.UInt64.v (b r) <: X64.Machine_s.nat64) ==
;                 return_val ==>
;                 (FStar.UInt.size (FStar.UInt64.v b) 64 ==>
;                   FStar.UInt64.v b >= 0 /\ FStar.UInt64.v b < 0x10000000000000000) /\
;                 (forall (return_val: X64.Machine_s.nat64).
;                     return_val == FStar.UInt64.v b ==>
;                     (forall (i: Prims.int) (x: Prims.int).
;                         FStar.UInt.size x 64 ==> x >= 0 /\ x < 0x10000000000000000)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let state_of_S`
...
;; def=Prims.fst(413,99-413,120); use=X64.Vale.StateLemmas_i.fst(36,36-44,3)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.bool)
...
;; def=X64.Vale.StateLemmas_i.fst(37,6-37,64); use=X64.Vale.StateLemmas_i.fst(37,6-37,64)
(= @x0
(X64.Semantics_s.Mkstate @x1
@x2
@x3
...
;; def=Prims.fst(459,77-459,89); use=X64.Vale.StateLemmas_i.fst(36,36-44,3)
(and 
;; def=dummy(0,0-0,0); use=X64.Vale.StateLemmas_i.fst(36,36-44,3)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
X64.Machine_s.reg)

;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fst(39,35-39,52)
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fst(39,35-39,52)
(FStar.UInt.size (FStar.UInt64.v (ApplyTT @x2
@x5))
(BoxInt 64))
)
)

;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fst(39,35-39,52)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fst(39,35-39,52)
(or label_1

;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fst(39,35-39,52)
(>= (BoxInt_proj_0 (FStar.UInt64.v (ApplyTT @x2
@x5)))
0)
)
...
;; def=Prims.fst(451,66-451,102); use=X64.Vale.StateLemmas_i.fst(36,36-44,3)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Tm_arrow_1093f8e31085b67d2aaada502a6d45cd)

;; def=FStar.FunctionalExtensionality.fsti(117,40-117,41); use=X64.Vale.StateLemmas_i.fst(36,36-44,3)
(= (Tm_abs_df5fee5ecee368c0044326eeb687043f @x2)
@x5)
)
...
;; def=FStar.FunctionalExtensionality.fsti(117,56-117,72); use=X64.Vale.StateLemmas_i.fst(39,11-39,63)
(= (FStar.FunctionalExtensionality.on_domain X64.Machine_s.reg
Tm_abs_bde726dfeb2837d96e43a155f7c873f5
(Tm_abs_df5fee5ecee368c0044326eeb687043f @x2))
@x6)
...
;; def=Prims.fst(356,2-356,58); use=X64.Vale.StateLemmas_i.fst(36,36-44,3)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.FunctionalExtensionality.restricted_t X64.Machine_s.reg
Tm_abs_bde726dfeb2837d96e43a155f7c873f5))

;; def=Prims.fst(356,26-356,41); use=X64.Vale.StateLemmas_i.fst(36,36-44,3)
(= @x7
(FStar.FunctionalExtensionality.on_domain X64.Machine_s.reg
Tm_abs_bde726dfeb2837d96e43a155f7c873f5
(Tm_abs_df5fee5ecee368c0044326eeb687043f @x2)))
...
;; def=X64.Vale.State_i.fsti(28,2-28,6); use=X64.Vale.StateLemmas_i.fst(36,36-44,3)
(= (FStar.FunctionalExtensionality.on_domain X64.Machine_s.reg
Tm_abs_bde726dfeb2837d96e43a155f7c873f5
(Tm_abs_df5fee5ecee368c0044326eeb687043f @x2))
@x7)
...
;; def=Prims.fst(459,77-459,89); use=X64.Vale.StateLemmas_i.fst(36,36-44,3)
(and (implies 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fst(40,12-40,26)
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fst(40,12-40,26)
(FStar.UInt.size (FStar.UInt64.v @x3)
(BoxInt 64))
)


;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fst(40,12-40,26)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fst(40,12-40,26)
(or label_3
...
;; def=dummy(0,0-0,0); use=X64.Vale.StateLemmas_i.fst(43,17-43,25)
...
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fst(43,17-43,25)
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fst(43,17-43,25)
(FStar.UInt.size @x10
(BoxInt 64))
...
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fst(43,17-43,25)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fst(43,17-43,25)
(or label_5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.state_of_S, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_Prims.pow2.fuel_instrumented, @fuel_irrelevance_Prims.pow2.fuel_instrumented, @query, b2t_def, equation_FStar.UInt.fits, equation_FStar.UInt.max_int, equation_FStar.UInt.min_int, equation_FStar.UInt.size, equation_Prims.nat, int_inversion, int_typing, lemma_FStar.UInt.pow2_values, primitive_Prims.op_AmpAmp, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
...
; encoding sigelt let state_of_S


; <Start encoding let state_of_S>
...
(declare-fun Tm_abs_a5012c08528796224c24bad70477fdf4 (Term) Term)
;;;;;;;;;;;;;;;;i: Prims.int -> FStar.UInt.uint_t 64
(declare-fun Tm_arrow_85d255d373ae89160427176258498414 () Term)
(declare-fun Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e (Term) Term)

; </end encoding let state_of_S>


; encoding sigelt val X64.Vale.StateLemmas_i.lemma_to_ok


; <Skipped val X64.Vale.StateLemmas_i.lemma_to_ok/>
...
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(27,4-27,14); use=X64.Vale.StateLemmas_i.fst(27,4-27,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
X64.Vale.State_i.state)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name X64.Semantics_s.mem_make; Namespace X64.Semantics_s
(assert (! 
;; def=X64.Semantics_s.fst(62,11-62,19); use=X64.Semantics_s.fst(62,11-62,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType (X64.Semantics_s.mem_make @x0
@x1
@x2)
(Tm_refine_c644247a73759f086aca82c4165d2bf4 @x0
@x2
@x1)))
 

:pattern ((X64.Semantics_s.mem_make @x0
@x1
@x2))
:qid typing_X64.Semantics_s.mem_make))

:named typing_X64.Semantics_s.mem_make))
;;;;;;;;;;;;;;;;free var typing
...
:named typing_Tm_abs_b59262a89c54ab08c57246cf5b2254f9))
;;;;;;;;;;;;;;;;typing_Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_to_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(32,22-32,43); use=X64.Vale.StateLemmas_i.fst(32,22-32,43)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6 @x0)
Tm_arrow_510ffde50cba047426243ffc68c85113)
 

:pattern ((Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6 @x0))
:qid typing_Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6))

:named typing_Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name X64.Semantics_s.mem_make; Namespace X64.Semantics_s
(assert (! 
;; def=X64.Semantics_s.fst(62,74-64,70); use=X64.Semantics_s.fst(62,74-64,70)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_c644247a73759f086aca82c4165d2bf4 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_c644247a73759f086aca82c4165d2bf4 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_c644247a73759f086aca82c4165d2bf4))

:named refinement_kinding_Tm_refine_c644247a73759f086aca82c4165d2bf4))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.pure_post'; Namespace Prims
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c644247a73759f086aca82c4165d2bf4 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=X64.Semantics_s.fst(63,2-63,33); use=X64.Semantics_s.fst(63,2-63,33)
(Valid 
;; def=X64.Semantics_s.fst(63,2-63,33); use=X64.Semantics_s.fst(63,2-63,33)
(FStar.Set.equal Prims.int
(FStar.Map.domain Prims.int
@x2
@x1)
@x3)
)
...
;; def=X64.Semantics_s.fst(64,2-64,69); use=X64.Semantics_s.fst(64,2-64,69)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.int)

;; def=X64.Semantics_s.fst(64,43-64,68); use=X64.Semantics_s.fst(64,43-64,68)
...
@x1
@x5))
:qid refinement_interpretation_Tm_refine_c644247a73759f086aca82c4165d2bf4.1))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_c644247a73759f086aca82c4165d2bf4))

:named refinement_interpretation_Tm_refine_c644247a73759f086aca82c4165d2bf4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pure_post'; Namespace Prims
(assert (! 
;; def=Prims.fst(315,31-315,40); use=Prims.fst(315,31-315,40)
...
;;; Fact-ids: Name X64.Semantics_s.mem_make; Namespace X64.Semantics_s
(assert (! 
;; def=X64.Semantics_s.fst(62,22-62,44); use=X64.Semantics_s.fst(62,41-62,49)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_510ffde50cba047426243ffc68c85113
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_to_S; Namespace X64.Vale.StateLemmas_i
(assert (! (HasType Tm_arrow_510ffde50cba047426243ffc68c85113
Tm_type)
:named kinding_Tm_arrow_510ffde50cba047426243ffc68c85113))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
:named interpretation_Tm_abs_b59262a89c54ab08c57246cf5b2254f9))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_to_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(32,22-32,43); use=X64.Vale.StateLemmas_i.fst(32,22-32,43)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6 @x1)
@x0)
(X64.Semantics_s.u (FStar.Map.sel Prims.int
X64.Machine_s.nat64
(X64.Vale.State_i.__proj__Mkstate__item__mem @x1)
@x0)))
 

:pattern ((ApplyTT (Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6 @x1)
@x0))
:qid interpretation_Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6))

:named interpretation_Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c644247a73759f086aca82c4165d2bf4
;;; Fact-ids: Name X64.Semantics_s.mem_make; Namespace X64.Semantics_s
(assert (! 
;; def=X64.Semantics_s.fst(62,74-64,70); use=X64.Semantics_s.fst(62,74-64,70)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c644247a73759f086aca82c4165d2bf4 @x0
@x1
@x2)))
(Valid (Prims.hasEq (X64.Semantics_s.map Prims.int
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c644247a73759f086aca82c4165d2bf4 @x0
@x1
@x2))))
:qid haseqTm_refine_c644247a73759f086aca82c4165d2bf4))

:named haseqTm_refine_c644247a73759f086aca82c4165d2bf4))
...
;;;;;;;;;;;;;;;;Equation for X64.Vale.StateLemmas_i.state_to_S
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_to_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(27,4-27,14); use=X64.Vale.StateLemmas_i.fst(27,4-27,14)
(forall ((@x0 Term))
 (! (= (X64.Vale.StateLemmas_i.state_to_S @x0)
(X64.Semantics_s.Mkstate (X64.Vale.State_i.__proj__Mkstate__item__ok @x0)
(FStar.FunctionalExtensionality.on_domain X64.Machine_s.reg
Tm_abs_2da3d120bd5ce08465191535a1915477
(Tm_abs_b59262a89c54ab08c57246cf5b2254f9 @x0))
(X64.Semantics_s.u (X64.Machine_s.int_to_nat64 (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)))
(X64.Semantics_s.mem_make (X64.Semantics_s.uint64 Dummy_value)
(Tm_abs_8c737d96c61c8ee61a7b3dd6a50d6ac6 @x0)
(FStar.Map.domain Prims.int
X64.Machine_s.nat64
(X64.Vale.State_i.__proj__Mkstate__item__mem @x0)))))
...
:pattern ((X64.Vale.StateLemmas_i.state_to_S @x0))
:qid equation_X64.Vale.StateLemmas_i.state_to_S))

:named equation_X64.Vale.StateLemmas_i.state_to_S))
...
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_to_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.State_i.fsti(24,23-24,26); use=X64.Vale.StateLemmas_i.fst(32,24-32,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_510ffde50cba047426243ffc68c85113)
...
@x1
Tm_arrow_510ffde50cba047426243ffc68c85113))
:qid X64.Vale.StateLemmas_i_pre_typing_Tm_arrow_510ffde50cba047426243ffc68c85113))

:named X64.Vale.StateLemmas_i_pre_typing_Tm_arrow_510ffde50cba047426243ffc68c85113))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_510ffde50cba047426243ffc68c85113
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_to_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.State_i.fsti(24,23-24,26); use=X64.Vale.StateLemmas_i.fst(32,24-32,34)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid X64.Vale.StateLemmas_i_interpretation_Tm_arrow_510ffde50cba047426243ffc68c85113.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_510ffde50cba047426243ffc68c85113))
:qid X64.Vale.StateLemmas_i_interpretation_Tm_arrow_510ffde50cba047426243ffc68c85113))

:named X64.Vale.StateLemmas_i_interpretation_Tm_arrow_510ffde50cba047426243ffc68c85113))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name X64.Semantics_s.mem_make; Namespace X64.Semantics_s
(assert (! 
;; def=X64.Semantics_s.fst(62,22-62,44); use=X64.Semantics_s.fst(62,41-62,49)
...
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2)))
:qid X64.Semantics_s_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named X64.Semantics_s_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
...
:pattern ((ApplyTT @x0
@x2))
:qid X64.Semantics_s_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x1)))
:qid X64.Semantics_s_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named X64.Semantics_s_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
;; def=Prims.fst(91,5-91,12); use=Prims.fst(91,5-91,12)
...
; Starting query at X64.Vale.StateLemmas_i.fst(46,20-46,22)
...
;         s.ok == (X64.Vale.StateLemmas_i.state_to_S s).ok ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_to_ok`
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(46,20-46,22)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=X64.Vale.StateLemmas_i.fsti(33,11-33,37); use=X64.Vale.StateLemmas_i.fst(46,20-46,22)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(46,20-46,22)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(46,20-46,22)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.lemma_to_ok, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_X64.Vale.StateLemmas_i.state_to_S, proj_equation_X64.Semantics_s.Mkstate_ok, proj_equation_X64.Vale.State_i.Mkstate_ok, projection_inverse_X64.Semantics_s.Mkstate_ok
...
; encoding sigelt let lemma_to_ok


; <Start encoding let lemma_to_ok>
...
;; def=X64.Vale.StateLemmas_i.fsti(33,11-33,37); use=X64.Vale.StateLemmas_i.fst(46,4-46,15)
(= (X64.Vale.State_i.__proj__Mkstate__item__ok @x0)
(X64.Semantics_s.__proj__Mkstate__item__ok (X64.Vale.StateLemmas_i.state_to_S @x0)))
)
...
; Starting query at X64.Vale.StateLemmas_i.fsti(36,0-38,18)
...
;;; Fact-ids: 
(assert (! 
;; def=X64.Vale.StateLemmas_i.fsti(36,32-38,18); use=X64.Vale.StateLemmas_i.fsti(36,32-36,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
; Encoding query formula : forall (s: X64.Vale.State_i.state) (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   (s.flags >= 0 /\ s.flags < 0x10000000000000000 ==>
;     s.flags >= 0 /\ s.flags < 0x10000000000000000 \/ FStar.UInt.size s.flags 64) /\
;   (forall (return_val: i: Prims.int{i >= 0 /\ i < 0x10000000000000000 \/ FStar.UInt.size i 64}).
;       return_val == s.flags ==>
;       FStar.UInt.size (FStar.UInt64.v (X64.Vale.StateLemmas_i.state_to_S s).flags) 64 ==>
;       FStar.UInt64.v (X64.Vale.StateLemmas_i.state_to_S s).flags >= 0 /\
;       FStar.UInt64.v (X64.Vale.StateLemmas_i.state_to_S s).flags < 0x10000000000000000 \/
;       FStar.UInt.size (FStar.UInt64.v (X64.Vale.StateLemmas_i.state_to_S s).flags) 64)


; Context: While encoding a query
; While typechecking the top-level declaration `val X64.Vale.StateLemmas_i.lemma_to_flags`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=X64.Vale.StateLemmas_i.fsti(36,0-38,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
X64.Vale.State_i.state)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=X64.Vale.StateLemmas_i.fsti(37,11-37,54)
(and (implies 
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(37,11-37,18)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(37,11-37,18)
(>= (BoxInt_proj_0 (X64.Vale.State_i.__proj__Mkstate__item__flags @x0))
0)
...
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(37,11-37,18)
(or label_1

;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(37,13-37,18)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(37,11-37,18)
(>= (BoxInt_proj_0 (X64.Vale.State_i.__proj__Mkstate__item__flags @x0))
0)
...
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(37,11-37,18)
(FStar.UInt.size (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)
(BoxInt 64))
)
)
)

;; def=Prims.fst(356,2-356,58); use=X64.Vale.StateLemmas_i.fsti(37,11-37,54)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_9e523552080158c04fafd9dbbcf2e767)

;; def=Prims.fst(356,26-356,41); use=X64.Vale.StateLemmas_i.fsti(37,11-37,54)
(= @x2
(X64.Vale.State_i.__proj__Mkstate__item__flags @x0))


;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(37,22-37,54)
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(37,22-37,54)
(FStar.UInt.size (FStar.UInt64.v (X64.Semantics_s.__proj__Mkstate__item__flags (X64.Vale.StateLemmas_i.state_to_S @x0)))
(BoxInt 64))
)
)
...
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(37,22-37,54)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(37,22-37,54)
(>= (BoxInt_proj_0 (FStar.UInt64.v (X64.Semantics_s.__proj__Mkstate__item__flags (X64.Vale.StateLemmas_i.state_to_S @x0))))
0)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.lemma_to_flags, 1)
; STATUS: unsat
...
; encoding sigelt val X64.Vale.StateLemmas_i.lemma_to_flags


; <Skipped val X64.Vale.StateLemmas_i.lemma_to_flags/>

(push) ;; push{2

; Starting query at X64.Vale.StateLemmas_i.fst(47,23-47,25)
...
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         s.flags == FStar.UInt64.v (X64.Vale.StateLemmas_i.state_to_S s).flags ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_to_flags`
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(47,23-47,25)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=X64.Vale.StateLemmas_i.fsti(37,11-37,54); use=X64.Vale.StateLemmas_i.fst(47,23-47,25)
(or label_2

;; def=X64.Vale.StateLemmas_i.fsti(37,11-37,54); use=X64.Vale.StateLemmas_i.fst(47,23-47,25)
(= (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)
(FStar.UInt64.v (X64.Semantics_s.__proj__Mkstate__item__flags (X64.Vale.StateLemmas_i.state_to_S @x0))))
)
)

;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(47,23-47,25)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(47,23-47,25)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.lemma_to_flags, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_Prims.pow2.fuel_instrumented, @fuel_irrelevance_Prims.pow2.fuel_instrumented, @query, b2t_def, bool_inversion, bool_typing, equation_FStar.UInt.fits, equation_FStar.UInt.max_int, equation_FStar.UInt.min_int, equation_FStar.UInt.size, equation_FStar.UInt.uint_t, equation_Prims.nat, equation_X64.Machine_s.nat64, equation_X64.Semantics_s.u, equation_X64.Semantics_s.uint64, equation_X64.Vale.StateLemmas_i.state_to_S, int_typing, lemma_FStar.UInt.pow2_values, lemma_FStar.UInt64.vu_inv, primitive_Prims.op_AmpAmp, primitive_Prims.op_LessThan, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Subtraction, proj_equation_X64.Semantics_s.Mkstate_flags, proj_equation_X64.Vale.State_i.Mkstate_flags, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_X64.Semantics_s.Mkstate_flags, refinement_interpretation_Tm_refine_33c23e946048d3d79f362ad9f81ccafe, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_a608a89bbc0a207d5920d37d906f7f40, refinement_interpretation_Tm_refine_f13070840248fced9d9d60d77bdae3ec, typing_FStar.UInt64.v, typing_X64.Machine_s.int_to_nat64, typing_X64.Semantics_s.__proj__Mkstate__item__flags, typing_X64.Vale.StateLemmas_i.state_to_S, typing_X64.Vale.State_i.__proj__Mkstate__item__flags
...
; encoding sigelt let lemma_to_flags


; <Start encoding let lemma_to_flags>
...
; </end encoding let lemma_to_flags>


; encoding sigelt val X64.Vale.StateLemmas_i.lemma_to_mem_contains


; <Skipped val X64.Vale.StateLemmas_i.lemma_to_mem_contains/>
...
;;;;;;;;;;;;;;;;Lemma: X64.Vale.StateLemmas_i.lemma_to_flags
;;; Fact-ids: Name X64.Vale.StateLemmas_i.lemma_to_flags; Namespace X64.Vale.StateLemmas_i
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
X64.Vale.State_i.state)

;; def=X64.Vale.StateLemmas_i.fsti(37,11-37,54); use=X64.Vale.StateLemmas_i.fst(47,4-47,18)
(= (X64.Vale.State_i.__proj__Mkstate__item__flags @x0)
(FStar.UInt64.v (X64.Semantics_s.__proj__Mkstate__item__flags (X64.Vale.StateLemmas_i.state_to_S @x0))))
)
...
:pattern ((X64.Vale.State_i.__proj__Mkstate__item__flags @x0))
:qid lemma_X64.Vale.StateLemmas_i.lemma_to_flags))
:named lemma_X64.Vale.StateLemmas_i.lemma_to_flags))
(push) ;; push{2

; Starting query at X64.Vale.StateLemmas_i.fst(48,32-48,34)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (s: X64.Vale.State_i.state) (i: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.Map.contains s.mem i = FStar.Map.contains (X64.Vale.StateLemmas_i.state_to_S s).mem i ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_to_mem_contains`
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(48,32-48,34)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=X64.Vale.StateLemmas_i.fsti(41,11-41,70); use=X64.Vale.StateLemmas_i.fst(48,32-48,34)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(48,32-48,34)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(48,32-48,34)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.lemma_to_mem_contains, 1)
; STATUS: unsat
...
; encoding sigelt let lemma_to_mem_contains


; <Start encoding let lemma_to_mem_contains>
...
; </end encoding let lemma_to_mem_contains>
...
;; def=X64.Vale.StateLemmas_i.fsti(41,11-41,70); use=X64.Vale.StateLemmas_i.fst(48,4-48,25)
(= (FStar.Map.contains Prims.int
X64.Machine_s.nat64
(X64.Vale.State_i.__proj__Mkstate__item__mem @x0)
@x1)
...
; Starting query at X64.Vale.StateLemmas_i.fsti(44,0-46,28)
...
;;; Fact-ids: 
(assert (! 
;; def=X64.Vale.StateLemmas_i.fsti(44,43-46,28); use=X64.Vale.StateLemmas_i.fsti(44,43-44,48)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
; Encoding query formula : forall (s: X64.Vale.State_i.state) (i: Prims.int) (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   (FStar.Map.sel s.mem i >= 0 /\ FStar.Map.sel s.mem i < 0x10000000000000000 ==>
;     FStar.Map.sel s.mem i >= 0 /\ FStar.Map.sel s.mem i < 0x10000000000000000 \/
;     FStar.UInt.size (FStar.Map.sel s.mem i) 64) /\
;   (forall (return_val: i: Prims.int{i >= 0 /\ i < 0x10000000000000000 \/ FStar.UInt.size i 64}).
;       return_val == FStar.Map.sel s.mem i ==>
;       FStar.UInt.size (FStar.UInt64.v (FStar.Map.sel (X64.Vale.StateLemmas_i.state_to_S s).mem i))
;         64 ==>
;       FStar.UInt64.v (FStar.Map.sel (X64.Vale.StateLemmas_i.state_to_S s).mem i) >= 0 /\
;       FStar.UInt64.v (FStar.Map.sel (X64.Vale.StateLemmas_i.state_to_S s).mem i) <
;       0x10000000000000000 \/
;       FStar.UInt.size (FStar.UInt64.v (FStar.Map.sel (X64.Vale.StateLemmas_i.state_to_S s).mem i))
;         64)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val X64.Vale.StateLemmas_i.lemma_to_mem_sel`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=X64.Vale.StateLemmas_i.fsti(44,0-46,28)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
X64.Vale.State_i.state)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=X64.Vale.StateLemmas_i.fsti(45,11-45,72)
(and (implies 
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(45,11-45,26)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(45,11-45,26)
(>= (BoxInt_proj_0 (FStar.Map.sel Prims.int
X64.Machine_s.nat64
(X64.Vale.State_i.__proj__Mkstate__item__mem @x0)
@x1))
...
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(45,11-45,26)
(or label_1

;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(45,11-45,18)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(45,11-45,26)
(>= (BoxInt_proj_0 (FStar.Map.sel Prims.int
X64.Machine_s.nat64
...
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(45,11-45,26)
(FStar.UInt.size (FStar.Map.sel Prims.int
X64.Machine_s.nat64
(X64.Vale.State_i.__proj__Mkstate__item__mem @x0)
@x1)
(BoxInt 64))
...
;; def=Prims.fst(356,2-356,58); use=X64.Vale.StateLemmas_i.fsti(45,11-45,72)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_9e523552080158c04fafd9dbbcf2e767)

;; def=Prims.fst(356,26-356,41); use=X64.Vale.StateLemmas_i.fsti(45,11-45,72)
(= @x3
(FStar.Map.sel Prims.int
X64.Machine_s.nat64
(X64.Vale.State_i.__proj__Mkstate__item__mem @x0)
...
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(45,30-45,72)
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(45,30-45,72)
(FStar.UInt.size (FStar.UInt64.v (FStar.Map.sel Prims.int
(X64.Semantics_s.uint64 Dummy_value)
(X64.Semantics_s.__proj__Mkstate__item__mem (X64.Vale.StateLemmas_i.state_to_S @x0))
@x1))
(BoxInt 64))
...
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(45,30-45,72)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(45,30-45,72)
(>= (BoxInt_proj_0 (FStar.UInt64.v (FStar.Map.sel Prims.int
(X64.Semantics_s.uint64 Dummy_value)
(X64.Semantics_s.__proj__Mkstate__item__mem (X64.Vale.StateLemmas_i.state_to_S @x0))
@x1)))
0)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.lemma_to_mem_sel, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt val X64.Vale.StateLemmas_i.lemma_to_mem_sel


; <Skipped val X64.Vale.StateLemmas_i.lemma_to_mem_sel/>

(push) ;; push{2

; Starting query at X64.Vale.StateLemmas_i.fst(49,27-49,29)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_to_mem_sel`
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(49,27-49,29)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=X64.Vale.StateLemmas_i.fsti(45,11-45,72); use=X64.Vale.StateLemmas_i.fst(49,27-49,29)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(49,27-49,29)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(49,27-49,29)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.lemma_to_mem_sel, 2)
; STATUS: unsat
...
; encoding sigelt let lemma_to_mem_sel


; <Start encoding let lemma_to_mem_sel>
...
; </end encoding let lemma_to_mem_sel>
...
;; def=X64.Vale.StateLemmas_i.fsti(45,11-45,72); use=X64.Vale.StateLemmas_i.fst(49,4-49,20)
(= (FStar.Map.sel Prims.int
X64.Machine_s.nat64
(X64.Vale.State_i.__proj__Mkstate__item__mem @x0)
@x1)
...
; Starting query at X64.Vale.StateLemmas_i.fsti(48,0-50,21)
...
;;; Fact-ids: 
(assert (! 
;; def=X64.Vale.StateLemmas_i.fsti(48,39-50,21); use=X64.Vale.StateLemmas_i.fsti(48,39-48,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
; Encoding query formula : forall (s: X64.Vale.State_i.state) (r: X64.Machine_s.reg) (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   (s.regs r >= 0 /\ s.regs r < 0x10000000000000000 ==>
;     s.regs r >= 0 /\ s.regs r < 0x10000000000000000 \/ FStar.UInt.size (s.regs r) 64) /\
;   (forall (return_val: i: Prims.int{i >= 0 /\ i < 0x10000000000000000 \/ FStar.UInt.size i 64}).
;       return_val == s.regs r ==>
;       FStar.UInt.size (FStar.UInt64.v ((X64.Vale.StateLemmas_i.state_to_S s).regs r)) 64 ==>
;       FStar.UInt64.v ((X64.Vale.StateLemmas_i.state_to_S s).regs r) >= 0 /\
;       FStar.UInt64.v ((X64.Vale.StateLemmas_i.state_to_S s).regs r) < 0x10000000000000000 \/
;       FStar.UInt.size (FStar.UInt64.v ((X64.Vale.StateLemmas_i.state_to_S s).regs r)) 64)


; Context: While encoding a query
; While typechecking the top-level declaration `val X64.Vale.StateLemmas_i.lemma_to_reg`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=X64.Vale.StateLemmas_i.fsti(48,0-50,21)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
X64.Vale.State_i.state)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=X64.Vale.StateLemmas_i.fsti(49,11-49,56)
(and (implies 
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(49,11-49,19)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(49,11-49,19)
(>= (BoxInt_proj_0 (ApplyTT (ApplyTT X64.Vale.State_i.__proj__Mkstate__item__regs@tok
@x0)
@x1))
0)
...
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(49,11-49,19)
(or label_1
...
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(49,11-49,19)
(FStar.UInt.size (ApplyTT (ApplyTT X64.Vale.State_i.__proj__Mkstate__item__regs@tok
@x0)
@x1)
(BoxInt 64))
)
...
;; def=Prims.fst(356,2-356,58); use=X64.Vale.StateLemmas_i.fsti(49,11-49,56)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_9e523552080158c04fafd9dbbcf2e767)

;; def=Prims.fst(356,26-356,41); use=X64.Vale.StateLemmas_i.fsti(49,11-49,56)
(= @x3
...
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(49,23-49,56)
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(49,23-49,56)
(FStar.UInt.size (FStar.UInt64.v (ApplyTT (ApplyTT X64.Semantics_s.__proj__Mkstate__item__regs@tok
(X64.Vale.StateLemmas_i.state_to_S @x0))
@x1))
(BoxInt 64))
)
...
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(49,23-49,56)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(49,23-49,56)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.lemma_to_reg, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt val X64.Vale.StateLemmas_i.lemma_to_reg


; <Skipped val X64.Vale.StateLemmas_i.lemma_to_reg/>

(push) ;; push{2

; Starting query at X64.Vale.StateLemmas_i.fst(50,23-50,25)
...
; Encoding query formula : forall (s: X64.Vale.State_i.state) (r: X64.Machine_s.reg).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         s.regs r == FStar.UInt64.v ((X64.Vale.StateLemmas_i.state_to_S s).regs r) ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_to_reg`
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(50,23-50,25)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=X64.Vale.StateLemmas_i.fsti(49,11-49,56); use=X64.Vale.StateLemmas_i.fst(50,23-50,25)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(50,23-50,25)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(50,23-50,25)
(ApplyTT @x2
@x3)
...
; encoding sigelt let lemma_to_reg


; <Start encoding let lemma_to_reg>
...
;; def=X64.Vale.StateLemmas_i.fsti(49,11-49,56); use=X64.Vale.StateLemmas_i.fst(50,4-50,16)
(= (ApplyTT (ApplyTT X64.Vale.State_i.__proj__Mkstate__item__regs@tok
@x0)
@x1)
(FStar.UInt64.v (ApplyTT (ApplyTT X64.Semantics_s.__proj__Mkstate__item__regs@tok
...
; Starting query at X64.Vale.StateLemmas_i.fsti(52,0-54,29)
...
;;; Fact-ids: 
(assert (! 
;; def=X64.Vale.StateLemmas_i.fsti(52,52-54,29); use=X64.Vale.StateLemmas_i.fsti(52,52-52,57)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
; Encoding query formula : forall (s: X64.Vale.State_i.state) (o: X64.Machine_s.operand) (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   (X64.Vale.State_i.eval_operand o s >= 0 /\ X64.Vale.State_i.eval_operand o s < 0x10000000000000000 ==>
;     X64.Vale.State_i.eval_operand o s >= 0 /\
;     X64.Vale.State_i.eval_operand o s < 0x10000000000000000 \/
;     FStar.UInt.size (X64.Vale.State_i.eval_operand o s) 64) /\
;   (forall (return_val: i: Prims.int{i >= 0 /\ i < 0x10000000000000000 \/ FStar.UInt.size i 64}).
;       return_val == X64.Vale.State_i.eval_operand o s ==>
;       FStar.UInt.size (FStar.UInt64.v (X64.Semantics_s.eval_operand o
;                 (X64.Vale.StateLemmas_i.state_to_S s)))
;         64 ==>
;       FStar.UInt64.v (X64.Semantics_s.eval_operand o (X64.Vale.StateLemmas_i.state_to_S s)) >= 0 /\
;       FStar.UInt64.v (X64.Semantics_s.eval_operand o (X64.Vale.StateLemmas_i.state_to_S s)) <
;       0x10000000000000000 \/
;       FStar.UInt.size (FStar.UInt64.v (X64.Semantics_s.eval_operand o
;                 (X64.Vale.StateLemmas_i.state_to_S s)))
;         64)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val X64.Vale.StateLemmas_i.lemma_to_eval_operand`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=X64.Vale.StateLemmas_i.fsti(52,0-54,29)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
X64.Vale.State_i.state)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=X64.Vale.StateLemmas_i.fsti(53,11-53,73)
(and (implies 
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(53,11-53,27)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(53,11-53,27)
...
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(53,11-53,27)
(or label_1

;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(53,11-53,23)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(53,11-53,27)
(>= (BoxInt_proj_0 (X64.Vale.State_i.eval_operand @x1
@x0))
...
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(53,11-53,27)
(FStar.UInt.size (X64.Vale.State_i.eval_operand @x1
@x0)
(BoxInt 64))
)
)
...
;; def=Prims.fst(356,2-356,58); use=X64.Vale.StateLemmas_i.fsti(53,11-53,73)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_9e523552080158c04fafd9dbbcf2e767)

;; def=Prims.fst(356,26-356,41); use=X64.Vale.StateLemmas_i.fsti(53,11-53,73)
(= @x3
(X64.Vale.State_i.eval_operand @x1
@x0))


;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(53,31-53,73)
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Vale.StateLemmas_i.fsti(53,31-53,73)
(FStar.UInt.size (FStar.UInt64.v (X64.Semantics_s.eval_operand @x1
(X64.Vale.StateLemmas_i.state_to_S @x0)))
(BoxInt 64))
)
)
...
;; def=X64.Machine_s.fst(27,19-27,32); use=X64.Vale.StateLemmas_i.fsti(53,31-53,73)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Vale.StateLemmas_i.fsti(53,31-53,73)
(>= (BoxInt_proj_0 (FStar.UInt64.v (X64.Semantics_s.eval_operand @x1
(X64.Vale.StateLemmas_i.state_to_S @x0))))
0)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.lemma_to_eval_operand, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt val X64.Vale.StateLemmas_i.lemma_to_eval_operand


; <Skipped val X64.Vale.StateLemmas_i.lemma_to_eval_operand/>

(push) ;; push{2

; Starting query at X64.Vale.StateLemmas_i.fst(51,32-51,34)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (s: X64.Vale.State_i.state) (o: X64.Machine_s.operand).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         X64.Vale.State_i.eval_operand o s ==
;         FStar.UInt64.v (X64.Semantics_s.eval_operand o (X64.Vale.StateLemmas_i.state_to_S s)) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_to_eval_operand`
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(51,32-51,34)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=X64.Vale.StateLemmas_i.fsti(53,11-53,73); use=X64.Vale.StateLemmas_i.fst(51,32-51,34)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(51,32-51,34)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(51,32-51,34)
(ApplyTT @x2
@x3)
...
; encoding sigelt let lemma_to_eval_operand


; <Start encoding let lemma_to_eval_operand>
...
; </end encoding let lemma_to_eval_operand>


; encoding sigelt val X64.Vale.StateLemmas_i.lemma_to_valid_operand


; <Skipped val X64.Vale.StateLemmas_i.lemma_to_valid_operand/>
...
; Starting query at X64.Vale.StateLemmas_i.fst(52,33-52,35)
...
;           X64.Semantics_s.valid_operand o (X64.Vale.StateLemmas_i.state_to_S s)) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_to_valid_operand`
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(52,33-52,35)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))
(implies 
;; def=X64.Vale.StateLemmas_i.fsti(57,11-57,28); use=X64.Vale.StateLemmas_i.fst(52,33-52,35)
(Valid 
;; def=X64.Vale.StateLemmas_i.fsti(57,11-57,28); use=X64.Vale.StateLemmas_i.fst(52,33-52,35)
(X64.Vale.State_i.valid_operand @x1
@x0)
)


;; def=X64.Vale.StateLemmas_i.fsti(57,33-57,65); use=X64.Vale.StateLemmas_i.fst(52,33-52,35)
(or label_2

;; def=X64.Vale.StateLemmas_i.fsti(57,33-57,65); use=X64.Vale.StateLemmas_i.fst(52,33-52,35)
(BoxBool_proj_0 (X64.Semantics_s.valid_operand @x1
(X64.Vale.StateLemmas_i.state_to_S @x0)))
)
))

;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(52,33-52,35)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(52,33-52,35)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.lemma_to_valid_operand, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, X64.Machine_s_pretyping_a2ddd26f94eaa436cfe753563bf0547b, X64.Machine_s_pretyping_b7c45855ed90996ceceb34aa61de24e7, b2t_def, bool_inversion, data_elim_X64.Machine_s.MIndex, data_elim_X64.Machine_s.MReg, data_elim_X64.Machine_s.OMem, equality_tok_X64.Machine_s.Rsp@tok, equation_FStar.UInt.fits, equation_FStar.UInt.min_int, equation_FStar.UInt.size, equation_FStar.UInt.uint_t, equation_Prims.eqtype, equation_Prims.nat, equation_X64.Machine_s.nat64, equation_X64.Semantics_s.eval_maddr, equation_X64.Semantics_s.map, equation_X64.Semantics_s.mem, equation_X64.Semantics_s.uint64, equation_X64.Semantics_s.valid_maddr, equation_X64.Semantics_s.valid_operand, equation_X64.Vale.StateLemmas_i.state_to_S, equation_X64.Vale.State_i.eval_maddr, equation_X64.Vale.State_i.valid_maddr, equation_X64.Vale.State_i.valid_operand, fuel_guarded_inversion_X64.Machine_s.maddr, fuel_guarded_inversion_X64.Machine_s.operand, fuel_guarded_inversion_X64.Vale.State_i.state, function_token_typing_Prims.__cache_version_number__, lemma_FStar.Map.lemma_ContainsDom, lemma_FStar.Set.lemma_equal_elim, lemma_FStar.Set.lemma_equal_intro, lemma_X64.Vale.StateLemmas_i.lemma_to_flags, lemma_X64.Vale.StateLemmas_i.lemma_to_mem_contains, lemma_X64.Vale.StateLemmas_i.lemma_to_reg, primitive_Prims.op_AmpAmp, primitive_Prims.op_LessThanOrEqual, proj_equation_X64.Semantics_s.Mkstate_flags, proj_equation_X64.Semantics_s.Mkstate_mem, proj_equation_X64.Vale.State_i.Mkstate_flags, proj_equation_X64.Vale.State_i.Mkstate_mem, projection_inverse_BoxBool_proj_0, projection_inverse_X64.Semantics_s.Mkstate_flags, projection_inverse_X64.Semantics_s.Mkstate_mem, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_a608a89bbc0a207d5920d37d906f7f40, refinement_interpretation_Tm_refine_f13070840248fced9d9d60d77bdae3ec, refinement_kinding_Tm_refine_a608a89bbc0a207d5920d37d906f7f40, typing_FStar.Map.contains, typing_FStar.Map.domain, typing_FStar.UInt64.t, typing_FStar.UInt64.v, typing_Prims.int, typing_X64.Semantics_s.__proj__Mkstate__item__flags, typing_X64.Semantics_s.__proj__Mkstate__item__mem, typing_X64.Semantics_s.eval_maddr, typing_X64.Vale.StateLemmas_i.state_to_S, typing_X64.Vale.State_i.__proj__Mkstate__item__flags, typing_X64.Vale.State_i.__proj__Mkstate__item__mem, typing_X64.Vale.State_i.eval_maddr, typing_tok_X64.Machine_s.Rsp@tok
...
; encoding sigelt let lemma_to_valid_operand


; <Start encoding let lemma_to_valid_operand>
...
; </end encoding let lemma_to_valid_operand>


; encoding sigelt val X64.Vale.StateLemmas_i.lemma_of_to


; <Skipped val X64.Vale.StateLemmas_i.lemma_of_to/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_of_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(36,4-36,14); use=X64.Vale.StateLemmas_i.fst(36,4-36,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
X64.Semantics_s.state)
(HasType (X64.Vale.StateLemmas_i.state_of_S @x0)
X64.Vale.State_i.state))
 

:pattern ((X64.Vale.StateLemmas_i.state_of_S @x0))
:qid typing_X64.Vale.StateLemmas_i.state_of_S))

:named typing_X64.Vale.StateLemmas_i.state_of_S))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;typing_Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_of_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(42,24-42,48); use=X64.Vale.StateLemmas_i.fst(42,24-42,48)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e @x0)
Tm_arrow_85d255d373ae89160427176258498414)
 

:pattern ((Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e @x0))
:qid typing_Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e))

:named typing_Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e))
;;;;;;;;;;;;;;;;typing_Tm_abs_a5012c08528796224c24bad70477fdf4
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_of_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(39,34-39,62); use=X64.Vale.StateLemmas_i.fst(39,34-39,62)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_a5012c08528796224c24bad70477fdf4 @x0)
Tm_arrow_1093f8e31085b67d2aaada502a6d45cd)
 

:pattern ((Tm_abs_a5012c08528796224c24bad70477fdf4 @x0))
:qid typing_Tm_abs_a5012c08528796224c24bad70477fdf4))

:named typing_Tm_abs_a5012c08528796224c24bad70477fdf4))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.prop; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_85d255d373ae89160427176258498414
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_of_S; Namespace X64.Vale.StateLemmas_i
(assert (! (HasType Tm_arrow_85d255d373ae89160427176258498414
Tm_type)
:named kinding_Tm_arrow_85d255d373ae89160427176258498414))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_of_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(42,24-42,48); use=X64.Vale.StateLemmas_i.fst(42,24-42,48)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e @x1)
@x0)
(FStar.UInt64.v (FStar.Map.sel Prims.int
(X64.Semantics_s.uint64 Dummy_value)
(X64.Semantics_s.Mkstate_mem @x1)
@x0)))
 

:pattern ((ApplyTT (Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e @x1)
@x0))
:qid interpretation_Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e))

:named interpretation_Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_a5012c08528796224c24bad70477fdf4
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_of_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(39,34-39,62); use=X64.Vale.StateLemmas_i.fst(39,34-39,62)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_a5012c08528796224c24bad70477fdf4 @x1)
@x0)
(FStar.UInt64.v (ApplyTT (X64.Semantics_s.Mkstate_regs @x1)
@x0)))
 

:pattern ((ApplyTT (Tm_abs_a5012c08528796224c24bad70477fdf4 @x1)
@x0))
:qid interpretation_Tm_abs_a5012c08528796224c24bad70477fdf4))

:named interpretation_Tm_abs_a5012c08528796224c24bad70477fdf4))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Prims.prop
Tm_type)
...
;;;;;;;;;;;;;;;;Equation for X64.Vale.StateLemmas_i.state_of_S
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_of_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Vale.StateLemmas_i.fst(36,4-36,14); use=X64.Vale.StateLemmas_i.fst(36,4-36,14)
(forall ((@x0 Term))
 (! (= (X64.Vale.StateLemmas_i.state_of_S @x0)
(let ((@lb1 @x0))
(X64.Vale.State_i.Mkstate (X64.Semantics_s.Mkstate_ok @lb1)
(FStar.FunctionalExtensionality.on_domain X64.Machine_s.reg
Tm_abs_bde726dfeb2837d96e43a155f7c873f5
(Tm_abs_a5012c08528796224c24bad70477fdf4 @lb1))
(FStar.UInt64.v (X64.Semantics_s.Mkstate_flags @lb1))
(X64.Semantics_s.mem_make X64.Machine_s.nat64
(Tm_abs_b5b7b19c983042ee6b5a605e6ef6029e @lb1)
(FStar.Map.domain Prims.int
(X64.Semantics_s.uint64 Dummy_value)
(X64.Semantics_s.Mkstate_mem @lb1))))))
 

:pattern ((X64.Vale.StateLemmas_i.state_of_S @x0))
:qid equation_X64.Vale.StateLemmas_i.state_of_S))

:named equation_X64.Vale.StateLemmas_i.state_of_S))
...
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_of_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Semantics_s.fst(61,15-61,18); use=X64.Vale.StateLemmas_i.fst(42,31-42,41)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_85d255d373ae89160427176258498414)
...
@x1
Tm_arrow_85d255d373ae89160427176258498414))
:qid X64.Vale.StateLemmas_i_pre_typing_Tm_arrow_85d255d373ae89160427176258498414))

:named X64.Vale.StateLemmas_i_pre_typing_Tm_arrow_85d255d373ae89160427176258498414))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_85d255d373ae89160427176258498414
;;; Fact-ids: Name X64.Vale.StateLemmas_i.state_of_S; Namespace X64.Vale.StateLemmas_i
(assert (! 
;; def=X64.Semantics_s.fst(61,15-61,18); use=X64.Vale.StateLemmas_i.fst(42,31-42,41)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid X64.Vale.StateLemmas_i_interpretation_Tm_arrow_85d255d373ae89160427176258498414.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_85d255d373ae89160427176258498414))
:qid X64.Vale.StateLemmas_i_interpretation_Tm_arrow_85d255d373ae89160427176258498414))

:named X64.Vale.StateLemmas_i_interpretation_Tm_arrow_85d255d373ae89160427176258498414))
(push) ;; push{2

; Starting query at X64.Vale.StateLemmas_i.fst(55,2-56,4)
...
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         s == X64.Vale.StateLemmas_i.state_of_S (X64.Vale.StateLemmas_i.state_to_S s) ==>
;         p pure_result) ==>
;     X64.Vale.State_i.state_eq s
;       (X64.Vale.StateLemmas_i.state_of_S (X64.Vale.StateLemmas_i.state_to_S s)) /\
;     (forall (pure_result: Prims.unit).
;         X64.Vale.State_i.state_eq s
;           (X64.Vale.StateLemmas_i.state_of_S (X64.Vale.StateLemmas_i.state_to_S s)) ==>
;         (forall (any_result: Prims.unit). p any_result))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_of_to`
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(55,2-56,4)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=X64.Vale.StateLemmas_i.fsti(61,11-61,41); use=X64.Vale.StateLemmas_i.fst(55,2-56,4)
(or label_2

;; def=X64.Vale.StateLemmas_i.fsti(61,11-61,41); use=X64.Vale.StateLemmas_i.fst(55,2-56,4)
(= @x0
(X64.Vale.StateLemmas_i.state_of_S (X64.Vale.StateLemmas_i.state_to_S @x0)))
)
)

;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(55,2-56,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(55,2-56,4)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(441,29-441,97); use=X64.Vale.StateLemmas_i.fst(55,2-55,8)
(and 
;; def=X64.Vale.StateLemmas_i.fst(55,9-55,49); use=X64.Vale.StateLemmas_i.fst(55,2-55,8)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(55,2-55,8)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)
...
;; def=Prims.fst(451,66-451,102); use=X64.Vale.StateLemmas_i.fst(55,2-56,4)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=X64.Vale.StateLemmas_i.fst(55,2-56,4)
(Valid 
;; def=Prims.fst(451,90-451,102); use=X64.Vale.StateLemmas_i.fst(55,2-56,4)
(ApplyTT @x1
@x3)
...
; encoding sigelt let lemma_of_to


; <Start encoding let lemma_of_to>
...
; </end encoding let lemma_of_to>


; encoding sigelt val X64.Vale.StateLemmas_i.lemma_to_of


; <Skipped val X64.Vale.StateLemmas_i.lemma_to_of/>

;;;;;;;;;;;;;;;;Lemma: X64.Vale.StateLemmas_i.lemma_of_to
;;; Fact-ids: Name X64.Vale.StateLemmas_i.lemma_of_to; Namespace X64.Vale.StateLemmas_i
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
X64.Vale.State_i.state)

;; def=X64.Vale.StateLemmas_i.fsti(61,11-61,41); use=X64.Vale.StateLemmas_i.fst(54,4-54,15)
(= @x0
(X64.Vale.StateLemmas_i.state_of_S (X64.Vale.StateLemmas_i.state_to_S @x0)))
)
 

:pattern ((X64.Vale.StateLemmas_i.state_of_S (X64.Vale.StateLemmas_i.state_to_S @x0)))
:qid lemma_X64.Vale.StateLemmas_i.lemma_of_to))
:named lemma_X64.Vale.StateLemmas_i.lemma_of_to))
(push) ;; push{2

; Starting query at X64.Vale.StateLemmas_i.fst(58,19-65,4)
...
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         s == X64.Vale.StateLemmas_i.state_to_S (X64.Vale.StateLemmas_i.state_of_S s) ==>
;         p pure_result) ==>
;     (forall (b: Prims.bool)
;         (b:
;         FStar.FunctionalExtensionality.restricted_t X64.Machine_s.reg
...
;             (b: X64.Semantics_s.uint64)
;             (b: X64.Semantics_s.mem).
;             X64.Vale.StateLemmas_i.state_to_S (X64.Vale.StateLemmas_i.state_of_S s) ==
;             X64.Semantics_s.Mkstate b b b b ==>
;             FStar.FunctionalExtensionality.feq b b /\
;             (forall (pure_result: Prims.unit).
;                 FStar.FunctionalExtensionality.feq b b ==>
;                 FStar.Map.equal b b /\
;                 (forall (pure_result: Prims.unit).
;                     FStar.Map.equal b b ==> (forall (any_result: Prims.unit). p any_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_to_of`
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(58,19-65,4)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=X64.Vale.StateLemmas_i.fsti(65,11-65,41); use=X64.Vale.StateLemmas_i.fst(58,19-65,4)
(or label_2

;; def=X64.Vale.StateLemmas_i.fsti(65,11-65,41); use=X64.Vale.StateLemmas_i.fst(58,19-65,4)
(= @x0
(X64.Vale.StateLemmas_i.state_to_S (X64.Vale.StateLemmas_i.state_of_S @x0)))
)
)

;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(58,19-65,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.StateLemmas_i.fst(58,19-65,4)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(413,99-413,120); use=X64.Vale.StateLemmas_i.fst(58,19-65,4)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.bool)
...
;; def=X64.Vale.StateLemmas_i.fst(61,6-61,64); use=X64.Vale.StateLemmas_i.fst(61,6-61,64)
(= @x0
(X64.Semantics_s.Mkstate @x2
@x3
@x4
@x5))
)
...
;; def=X64.Vale.StateLemmas_i.fst(62,6-62,72); use=X64.Vale.StateLemmas_i.fst(62,6-62,72)
(= (X64.Vale.StateLemmas_i.state_to_S (X64.Vale.StateLemmas_i.state_of_S @x0))
(X64.Semantics_s.Mkstate @x6
@x7
@x8
@x9))
)

;; def=Prims.fst(441,29-441,97); use=X64.Vale.StateLemmas_i.fst(63,2-63,8)
(and 
;; def=X64.Vale.StateLemmas_i.fst(63,9-63,26); use=X64.Vale.StateLemmas_i.fst(63,2-63,8)
(or label_3

;; def=X64.Vale.StateLemmas_i.fst(63,9-63,26); use=X64.Vale.StateLemmas_i.fst(63,2-63,8)
(Valid 
;; def=X64.Vale.StateLemmas_i.fst(63,9-63,26); use=X64.Vale.StateLemmas_i.fst(63,2-63,8)
(FStar.FunctionalExtensionality.feq X64.Machine_s.reg
Tm_abs_2da3d120bd5ce08465191535a1915477
@x3
@x7)
)
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(63,2-63,8)
(forall ((@x10 Term))
...
;; def=Prims.fst(441,29-441,97); use=X64.Vale.StateLemmas_i.fst(64,2-64,8)
(and 
;; def=X64.Vale.StateLemmas_i.fst(64,9-64,30); use=X64.Vale.StateLemmas_i.fst(64,2-64,8)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.StateLemmas_i.fst(64,2-64,8)
(forall ((@x11 Term))
...
;; def=Prims.fst(451,66-451,102); use=X64.Vale.StateLemmas_i.fst(58,19-65,4)
(forall ((@x12 Term))
 (! (implies (HasType @x12
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=X64.Vale.StateLemmas_i.fst(58,19-65,4)
(Valid 
;; def=Prims.fst(451,90-451,102); use=X64.Vale.StateLemmas_i.fst(58,19-65,4)
(ApplyTT @x1
@x12)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.StateLemmas_i.lemma_to_of, 1)
; STATUS: unsat
