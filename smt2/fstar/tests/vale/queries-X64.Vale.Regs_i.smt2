...
; encoding sigelt val X64.Vale.Regs_i.equal


; <Skipped val X64.Vale.Regs_i.equal/>
...
; encoding sigelt val X64.Vale.Regs_i.lemma_equal_intro


; <Skipped val X64.Vale.Regs_i.lemma_equal_intro/>
...
(assert (! 
;; def=X64.Vale.Regs_i.fst(20,4-20,9); use=X64.Vale.Regs_i.fst(20,4-20,9)
...
;;;;;;;;;;;;;;;;Equation for X64.Vale.Regs_i.equal
;;; Fact-ids: Name X64.Vale.Regs_i.equal; Namespace X64.Vale.Regs_i
(assert (! 
;; def=X64.Vale.Regs_i.fst(20,4-20,9); use=X64.Vale.Regs_i.fst(20,4-20,9)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((X64.Vale.Regs_i.equal @x0
@x1))
:qid equation_X64.Vale.Regs_i.equal))

:named equation_X64.Vale.Regs_i.equal))
...
; Starting query at X64.Vale.Regs_i.fst(21,36-21,38)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (regs1: X64.Vale.Regs_i.t) (regs2: X64.Vale.Regs_i.t).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (r: X64.Machine_s.reg). regs1 r == regs2 r) /\
;     (forall (pure_result: Prims.unit). X64.Vale.Regs_i.equal regs1 regs2 ==> p pure_result) ==>
...
;; def=X64.Vale.Regs_i.fsti(28,12-28,40); use=X64.Vale.Regs_i.fst(21,36-21,38)
(forall ((@x3 Term))
 (! (implies (HasType @x3
X64.Machine_s.reg)

;; def=X64.Vale.Regs_i.fsti(28,22-28,40); use=X64.Vale.Regs_i.fst(21,36-21,38)
(= (ApplyTT @x0
@x3)
(ApplyTT @x1
@x3))
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.Regs_i.fst(21,36-21,38)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=X64.Vale.Regs_i.fsti(29,11-29,28); use=X64.Vale.Regs_i.fst(21,36-21,38)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=X64.Vale.Regs_i.fst(21,36-21,38)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.Regs_i.fst(21,36-21,38)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Vale.Regs_i.lemma_equal_intro, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, X64.Machine_s_pretyping_b7c45855ed90996ceceb34aa61de24e7, equality_tok_X64.Machine_s.Rsp@tok, equation_FStar.FunctionalExtensionality.feq, equation_X64.Vale.Regs_i.equal, typing_tok_X64.Machine_s.Rsp@tok
...
; encoding sigelt val X64.Vale.Regs_i.lemma_equal_elim


; <Skipped val X64.Vale.Regs_i.lemma_equal_elim/>
...
;; def=X64.Vale.Regs_i.fsti(28,12-28,40); use=X64.Vale.Regs_i.fst(21,4-21,21)
(forall ((@x2 Term))
 (! (implies (HasType @x2
X64.Machine_s.reg)

;; def=X64.Vale.Regs_i.fsti(28,22-28,40); use=X64.Vale.Regs_i.fst(21,4-21,21)
(= (ApplyTT @x0
@x2)
(ApplyTT @x1
@x2))
...
;; def=X64.Vale.Regs_i.fsti(29,11-29,28); use=X64.Vale.Regs_i.fst(21,4-21,21)
(Valid 
;; def=X64.Vale.Regs_i.fsti(29,11-29,28); use=X64.Vale.Regs_i.fst(21,4-21,21)
(X64.Vale.Regs_i.equal @x0
@x1)
...
; Starting query at X64.Vale.Regs_i.fst(22,35-22,37)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     X64.Vale.Regs_i.equal regs1 regs2 /\
;     (forall (pure_result: Prims.unit). regs1 == regs2 ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)
...
;; def=X64.Vale.Regs_i.fsti(33,12-33,29); use=X64.Vale.Regs_i.fst(22,35-22,37)
(Valid 
;; def=X64.Vale.Regs_i.fsti(33,12-33,29); use=X64.Vale.Regs_i.fst(22,35-22,37)
(X64.Vale.Regs_i.equal @x0
@x1)
...
;; def=Prims.fst(441,36-441,97); use=X64.Vale.Regs_i.fst(22,35-22,37)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=X64.Vale.Regs_i.fsti(34,11-34,25); use=X64.Vale.Regs_i.fst(22,35-22,37)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=X64.Vale.Regs_i.fst(22,35-22,37)
(Valid 
;; def=Prims.fst(441,83-441,96); use=X64.Vale.Regs_i.fst(22,35-22,37)
(ApplyTT @x2
@x3)
