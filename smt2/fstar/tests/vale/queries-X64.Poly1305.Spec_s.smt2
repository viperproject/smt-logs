...
; Internals for X64.Poly1305.Spec_s
...
(declare-fun X64.Poly1305.Spec_s.map (Term Term) Term)

(declare-fun X64.Poly1305.Spec_s.map@tok () Term)
...
(declare-fun X64.Poly1305.Spec_s.op_String_Access (Term Term) Term)
...
(declare-fun X64.Poly1305.Spec_s.op_String_Access@tok () Term)
...
(declare-fun X64.Poly1305.Spec_s.op_String_Assignment (Term Term) Term)
...
(declare-fun X64.Poly1305.Spec_s.op_String_Assignment@tok () Term)


; </end encoding let op_String_Assignment>


; encoding sigelt let nat128_max


; <Start encoding let nat128_max>

(declare-fun X64.Poly1305.Spec_s.nat128_max (Dummy_sort) Term)
...
(declare-fun X64.Poly1305.Spec_s.uu___0 (Dummy_sort) Term)

; </end encoding let uu___0>


; encoding sigelt let nat128


; <Start encoding let nat128>

(declare-fun X64.Poly1305.Spec_s.nat128 () Term)
(declare-fun Tm_refine_427d1cd916b8c1dbe323e65700d7fb73 () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name X64.Poly1305.Spec_s.nat128_max; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(27,4-27,14); use=X64.Poly1305.Spec_s.fst(27,4-27,14)
(forall ((@u0 Dummy_sort))
 (! (HasType (X64.Poly1305.Spec_s.nat128_max @u0)
Prims.int)
 

:pattern ((X64.Poly1305.Spec_s.nat128_max @u0))
:qid typing_X64.Poly1305.Spec_s.nat128_max))

:named typing_X64.Poly1305.Spec_s.nat128_max))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name X64.Poly1305.Spec_s.nat128; Namespace X64.Poly1305.Spec_s
(assert (! (HasType Tm_refine_427d1cd916b8c1dbe323e65700d7fb73
Tm_type)
:named refinement_kinding_Tm_refine_427d1cd916b8c1dbe323e65700d7fb73))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
;;; Fact-ids: Name X64.Poly1305.Spec_s.nat128; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(29,14-29,45); use=X64.Poly1305.Spec_s.fst(29,14-29,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_427d1cd916b8c1dbe323e65700d7fb73)
(and (HasTypeFuel @u0
@x1
Prims.int)
...
(X64.Poly1305.Spec_s.nat128_max Dummy_value)))))
 

:pattern ((HasTypeFuel @u0
@x1
Tm_refine_427d1cd916b8c1dbe323e65700d7fb73))
:qid refinement_interpretation_Tm_refine_427d1cd916b8c1dbe323e65700d7fb73))

:named refinement_interpretation_Tm_refine_427d1cd916b8c1dbe323e65700d7fb73))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_427d1cd916b8c1dbe323e65700d7fb73
;;; Fact-ids: Name X64.Poly1305.Spec_s.nat128; Namespace X64.Poly1305.Spec_s
(assert (! (iff (Valid (Prims.hasEq Tm_refine_427d1cd916b8c1dbe323e65700d7fb73))
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_427d1cd916b8c1dbe323e65700d7fb73))
...
;;;;;;;;;;;;;;;;Equation for X64.Poly1305.Spec_s.nat128_max
;;; Fact-ids: Name X64.Poly1305.Spec_s.nat128_max; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(27,4-27,14); use=X64.Poly1305.Spec_s.fst(27,4-27,14)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=X64.Poly1305.Spec_s.fst(27,4-27,14); use=X64.Poly1305.Spec_s.fst(27,4-27,14)
(X64.Poly1305.Spec_s.nat128_max @u0)
...
:qid equation_X64.Poly1305.Spec_s.nat128_max))

:named equation_X64.Poly1305.Spec_s.nat128_max))
...
; Starting query at X64.Poly1305.Spec_s.fst(32,2-32,26)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Prims.int).
;   (*  - Could not prove post-condition
; *) X64.Poly1305.Spec_s.nat128_max * 4 - 5 <> 0


; Context: While encoding a query
; While typechecking the top-level declaration `let modp'`
...
;; def=Prims.fst(686,22-686,28); use=X64.Poly1305.Spec_s.fst(32,6-32,26)
(or label_1

;; def=Prims.fst(686,22-686,28); use=X64.Poly1305.Spec_s.fst(32,6-32,26)
(not (= (- (_mul (BoxInt_proj_0 (X64.Poly1305.Spec_s.nat128_max Dummy_value))
4)
5)
0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (X64.Poly1305.Spec_s.modp', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_X64.Poly1305.Spec_s.nat128_max, projection_inverse_BoxInt_proj_0
...
; encoding sigelt let modp'


; <Start encoding let modp'>

(declare-fun X64.Poly1305.Spec_s.modp_ (Term) Term)

(declare-fun X64.Poly1305.Spec_s.modp_@tok () Term)

; </end encoding let modp'>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name X64.Poly1305.Spec_s.nat128; Namespace X64.Poly1305.Spec_s
(assert (! (HasType X64.Poly1305.Spec_s.nat128
Tm_type)
:named typing_X64.Poly1305.Spec_s.nat128))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.prop; Namespace Prims
...
(assert (! (HasType X64.Poly1305.Spec_s.nat128
Tm_type)
:named function_token_typing_X64.Poly1305.Spec_s.nat128))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Prims.prop
Tm_type)
...
;;;;;;;;;;;;;;;;Equation for X64.Poly1305.Spec_s.nat128
;;; Fact-ids: Name X64.Poly1305.Spec_s.nat128; Namespace X64.Poly1305.Spec_s
(assert (! (= X64.Poly1305.Spec_s.nat128
Tm_refine_427d1cd916b8c1dbe323e65700d7fb73)
:named equation_X64.Poly1305.Spec_s.nat128))
...
; Starting query at X64.Poly1305.Spec_s.fst(35,2-35,17)
...
; Encoding query formula : forall (x: X64.Poly1305.Spec_s.nat128) (y: X64.Poly1305.Spec_s.nat128).
;   (*  - Could not prove post-condition
; *)
;   (0 <= x && x < X64.Poly1305.Spec_s.nat128_max ==> FStar.UInt.size x 128) /\
;   (forall (any_result: X64.Poly1305.Spec_s.nat128).
;       x == any_result ==>
;       (0 <= y && y < X64.Poly1305.Spec_s.nat128_max ==> FStar.UInt.size y 128) /\
;       (forall (any_result: X64.Poly1305.Spec_s.nat128).
;           y == any_result ==>
;           (forall (any_result: FStar.UInt.uint_t 128).
;               FStar.UInt.logand x y == any_result ==>
;               FStar.UInt.size (FStar.UInt.logand x y) 128 ==>
;               0 <= FStar.UInt.logand x y && FStar.UInt.logand x y < X64.Poly1305.Spec_s.nat128_max))
;   )


; Context: While encoding a query
; While typechecking the top-level declaration `let and128`
...
(assert (! (not (forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
X64.Poly1305.Spec_s.nat128)
(HasType @x1
X64.Poly1305.Spec_s.nat128))

;; def=Prims.fst(459,77-459,89); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(and (implies 
;; def=X64.Poly1305.Spec_s.fst(29,20-29,44); use=X64.Poly1305.Spec_s.fst(35,14-35,15)
...
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Poly1305.Spec_s.fst(35,14-35,15)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
X64.Poly1305.Spec_s.nat128)

;; def=FStar.UInt.fsti(299,21-299,22); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(= @x0
@x2)
)
...
;; def=Prims.fst(459,77-459,89); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(and (implies 
;; def=X64.Poly1305.Spec_s.fst(29,20-29,44); use=X64.Poly1305.Spec_s.fst(35,16-35,17)
(and (BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
@x1))
(BoxBool_proj_0 (Prims.op_LessThan @x1
(X64.Poly1305.Spec_s.nat128_max Dummy_value))))
...
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Poly1305.Spec_s.fst(35,16-35,17)
(or label_2
...
;; def=FStar.UInt.fsti(299,34-299,35); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(= @x1
@x3)
)
...
(FStar.UInt.uint_t (BoxInt 128)))

;; def=X64.Poly1305.Spec_s.fst(34,34-35,17); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(= (FStar.UInt.logand (BoxInt 128)
@x0
@x1)
@x4)


;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(FStar.UInt.size (FStar.UInt.logand (BoxInt 128)
@x0
@x1)
(BoxInt 128))
)
...
;; def=X64.Poly1305.Spec_s.fst(29,20-29,44); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(and 
;; def=X64.Poly1305.Spec_s.fst(35,2-35,17); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(or label_3
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
(FStar.UInt.logand (BoxInt 128)
@x0
...
;; def=X64.Poly1305.Spec_s.fst(35,2-35,17); use=X64.Poly1305.Spec_s.fst(35,2-35,17)
(or label_4
(BoxBool_proj_0 (Prims.op_LessThan (FStar.UInt.logand (BoxInt 128)
@x0
@x1)
(X64.Poly1305.Spec_s.nat128_max Dummy_value))))
)
...
; encoding sigelt let and128


; <Start encoding let and128>

(declare-fun X64.Poly1305.Spec_s.and128 (Term Term) Term)
;;;;;;;;;;;;;;;;x: nat128 -> y: nat128 -> nat128
(declare-fun Tm_arrow_10682b1e083c373b342835a51239c426 () Term)
(declare-fun X64.Poly1305.Spec_s.and128@tok () Term)

; </end encoding let and128>
...
; Starting query at X64.Poly1305.Spec_s.fst(38,2-42,35)
...
;;;;;;;;;;;;;;;;inp : _: Prims.int -> X64.Poly1305.Spec_s.nat128 (_: Prims.int -> X64.Poly1305.Spec_s.nat128)
(declare-fun x_c4e704a747d42e0c8ac69940987061d3_3 () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> nat128
(declare-fun Tm_arrow_a59d302710f4314b88cbb32063552186 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a59d302710f4314b88cbb32063552186
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a59d302710f4314b88cbb32063552186
Tm_type)
:named kinding_Tm_arrow_a59d302710f4314b88cbb32063552186))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,60-37,71); use=X64.Poly1305.Spec_s.fst(37,60-37,71)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a59d302710f4314b88cbb32063552186)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a59d302710f4314b88cbb32063552186))
:qid X64.Poly1305.Spec_s_pre_typing_Tm_arrow_a59d302710f4314b88cbb32063552186))

:named X64.Poly1305.Spec_s_pre_typing_Tm_arrow_a59d302710f4314b88cbb32063552186))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a59d302710f4314b88cbb32063552186
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,60-37,71); use=X64.Poly1305.Spec_s.fst(37,60-37,71)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid X64.Poly1305.Spec_s_interpretation_Tm_arrow_a59d302710f4314b88cbb32063552186.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_a59d302710f4314b88cbb32063552186))
:qid X64.Poly1305.Spec_s_interpretation_Tm_arrow_a59d302710f4314b88cbb32063552186))

:named X64.Poly1305.Spec_s_interpretation_Tm_arrow_a59d302710f4314b88cbb32063552186))
;;;;;;;;;;;;;;;;binder_x_c4e704a747d42e0c8ac69940987061d3_3
;;; Fact-ids: 
(assert (! (HasType x_c4e704a747d42e0c8ac69940987061d3_3
Tm_arrow_a59d302710f4314b88cbb32063552186)
:named binder_x_c4e704a747d42e0c8ac69940987061d3_3))
;;;;;;;;;;;;;;;;i : Prims.int (Prims.int)
(declare-fun x_ae567c2fb75be05905677af440075565_4 () Term)
;;;;;;;;;;;;;;;;binder_x_ae567c2fb75be05905677af440075565_4
;;; Fact-ids: 
(assert (! (HasType x_ae567c2fb75be05905677af440075565_4
Prims.int)
:named binder_x_ae567c2fb75be05905677af440075565_4))
;;;;;;;;;;;;;;;;k : k: Prims.int{k >= i && (k - i) % 16 = 0} (k: Prims.int{k >= i && (k - i) % 16 = 0})
(declare-fun x_608f5c658b95d65ae2ecfa2917e7b83b_5 () Term)
(declare-fun Tm_refine_0fc49f466cba9c222662033ec341dfa2 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_0fc49f466cba9c222662033ec341dfa2
Tm_type)
:named refinement_kinding_Tm_refine_0fc49f466cba9c222662033ec341dfa2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,81-37,112); use=X64.Poly1305.Spec_s.fst(37,81-37,112)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_0fc49f466cba9c222662033ec341dfa2)
(and (HasTypeFuel @u0
@x1
Prims.int)
(BoxBool_proj_0 (Prims.op_GreaterThanOrEqual @x1
x_ae567c2fb75be05905677af440075565_4))
(BoxBool_proj_0 (Prims.op_Equality Prims.int
(BoxInt (_mod (- (BoxInt_proj_0 @x1)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_4))
16))
(BoxInt 0)))))
...
@x1
Tm_refine_0fc49f466cba9c222662033ec341dfa2))
:qid refinement_interpretation_Tm_refine_0fc49f466cba9c222662033ec341dfa2))

:named refinement_interpretation_Tm_refine_0fc49f466cba9c222662033ec341dfa2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0fc49f466cba9c222662033ec341dfa2
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0fc49f466cba9c222662033ec341dfa2))
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_0fc49f466cba9c222662033ec341dfa2))
;;;;;;;;;;;;;;;;binder_x_608f5c658b95d65ae2ecfa2917e7b83b_5
;;; Fact-ids: 
(assert (! (HasType x_608f5c658b95d65ae2ecfa2917e7b83b_5
Tm_refine_0fc49f466cba9c222662033ec341dfa2)
:named binder_x_608f5c658b95d65ae2ecfa2917e7b83b_5))

(declare-fun Tm_refine_28c3b24a3ff145fb1368871093965bcd (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,82-42,35); use=X64.Poly1305.Spec_s.fst(37,82-42,35)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_28c3b24a3ff145fb1368871093965bcd @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_28c3b24a3ff145fb1368871093965bcd @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_28c3b24a3ff145fb1368871093965bcd))

:named refinement_kinding_Tm_refine_28c3b24a3ff145fb1368871093965bcd))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,82-42,35); use=X64.Poly1305.Spec_s.fst(37,82-42,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_28c3b24a3ff145fb1368871093965bcd @x2))
(and (HasTypeFuel @u0
@x1
Prims.int)
(BoxBool_proj_0 (Prims.op_GreaterThanOrEqual @x1
...
;; def=X64.Poly1305.Spec_s.fst(38,2-42,35); use=X64.Poly1305.Spec_s.fst(38,2-42,35)
...
(BoxInt_proj_0 @x2)))
(BoxInt (- (BoxInt_proj_0 x_608f5c658b95d65ae2ecfa2917e7b83b_5)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_4))))
)
...
@x1
(Tm_refine_28c3b24a3ff145fb1368871093965bcd @x2)))
:qid refinement_interpretation_Tm_refine_28c3b24a3ff145fb1368871093965bcd))

:named refinement_interpretation_Tm_refine_28c3b24a3ff145fb1368871093965bcd))
;;;;;;;;;;;;;;;;haseq for Tm_refine_28c3b24a3ff145fb1368871093965bcd
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,82-42,35); use=X64.Poly1305.Spec_s.fst(37,82-42,35)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_28c3b24a3ff145fb1368871093965bcd @x0)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_28c3b24a3ff145fb1368871093965bcd @x0))))
:qid haseqTm_refine_28c3b24a3ff145fb1368871093965bcd))

:named haseqTm_refine_28c3b24a3ff145fb1368871093965bcd))
(declare-fun X64.Poly1305.Spec_s.poly1305_hash_blocks (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;h: Prims.int ->     pad: Prims.int ->     r: Prims.int ->     inp: (_: Prims.int -> nat128) ->     i: Prims.int ->     k: (k: Prims.int{k >= i && (k - i) % 16 = 0}){k - i << k - i}   -> Prims.Tot Prims.int
(declare-fun Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b
Tm_type)
:named kinding_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,32-42,35); use=X64.Poly1305.Spec_s.fst(37,32-42,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b))
:qid X64.Poly1305.Spec_s_pre_typing_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b))

:named X64.Poly1305.Spec_s_pre_typing_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,32-42,35); use=X64.Poly1305.Spec_s.fst(37,32-42,35)
(forall ((@x0 Term))
...
Prims.int)
(HasType @x6
(Tm_refine_28c3b24a3ff145fb1368871093965bcd @x5)))
...
@x5)
@x6))
:qid X64.Poly1305.Spec_s_interpretation_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid X64.Poly1305.Spec_s_interpretation_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b.2))
...
@x1)
@x2))
:qid X64.Poly1305.Spec_s_interpretation_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b.3))
...
@x2)
@x3))
:qid X64.Poly1305.Spec_s_interpretation_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b.4))
...
@x3)
@x4))
:qid X64.Poly1305.Spec_s_interpretation_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b.5))
...
@x4)
@x5))
:qid X64.Poly1305.Spec_s_interpretation_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b.6))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b))
:qid X64.Poly1305.Spec_s_interpretation_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b))

:named X64.Poly1305.Spec_s_interpretation_Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b))
(declare-fun X64.Poly1305.Spec_s.poly1305_hash_blocks@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,8-37,28); use=X64.Poly1305.Spec_s.fst(37,8-37,28)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT X64.Poly1305.Spec_s.poly1305_hash_blocks@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5)
(X64.Poly1305.Spec_s.poly1305_hash_blocks @x0
@x1
@x2
@x3
@x4
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT X64.Poly1305.Spec_s.poly1305_hash_blocks@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5))
:qid token_correspondence_X64.Poly1305.Spec_s.poly1305_hash_blocks))

:named token_correspondence_X64.Poly1305.Spec_s.poly1305_hash_blocks))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,8-37,28); use=X64.Poly1305.Spec_s.fst(37,8-37,28)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType X64.Poly1305.Spec_s.poly1305_hash_blocks@tok
Tm_arrow_a37f33aa1005c3bf2f1d91b7f5f9118b))
...
@x5)
@x6)
(X64.Poly1305.Spec_s.poly1305_hash_blocks @x1
@x2
@x3
@x4
@x5
...
:pattern ((X64.Poly1305.Spec_s.poly1305_hash_blocks @x1
@x2
@x3
@x4
@x5
@x6))
:qid function_token_typing_X64.Poly1305.Spec_s.poly1305_hash_blocks.1))
)
 

:pattern ((ApplyTT @x0
X64.Poly1305.Spec_s.poly1305_hash_blocks@tok))
:qid function_token_typing_X64.Poly1305.Spec_s.poly1305_hash_blocks))

:named function_token_typing_X64.Poly1305.Spec_s.poly1305_hash_blocks))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,8-37,28); use=X64.Poly1305.Spec_s.fst(37,8-37,28)
...
Prims.int)
(HasType @x5
(Tm_refine_28c3b24a3ff145fb1368871093965bcd @x4)))
(HasType (X64.Poly1305.Spec_s.poly1305_hash_blocks @x0
@x1
@x2
@x3
@x4
...
:pattern ((X64.Poly1305.Spec_s.poly1305_hash_blocks @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_X64.Poly1305.Spec_s.poly1305_hash_blocks))

:named typing_X64.Poly1305.Spec_s.poly1305_hash_blocks))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   ~(i = k = true) ==>
;   (forall (b: Prims.bool).
;       i = k == b ==> k - 16 >= i && (k - 16 - i) % 16 = 0 /\ k - 16 - i << k - i)


; Context: While encoding a query
; While typechecking the top-level declaration `let rec poly1305_hash_blocks`
...
;; def=Prims.fst(402,27-402,88); use=X64.Poly1305.Spec_s.fst(38,2-42,35)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=X64.Poly1305.Spec_s.fst(38,2-42,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=X64.Poly1305.Spec_s.fst(38,2-42,35)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=X64.Poly1305.Spec_s.fst(38,2-42,35)
(not 
;; def=X64.Poly1305.Spec_s.fst(38,5-38,10); use=X64.Poly1305.Spec_s.fst(38,5-38,10)
(= (Prims.op_Equality Prims.int
x_ae567c2fb75be05905677af440075565_4
x_608f5c658b95d65ae2ecfa2917e7b83b_5)
(BoxBool true))
)
)

;; def=Prims.fst(413,99-413,120); use=X64.Poly1305.Spec_s.fst(38,2-42,35)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=X64.Poly1305.Spec_s.fst(38,5-42,35); use=X64.Poly1305.Spec_s.fst(38,5-42,35)
(= (Prims.op_Equality Prims.int
x_ae567c2fb75be05905677af440075565_4
x_608f5c658b95d65ae2ecfa2917e7b83b_5)
@x1)
...
;; def=X64.Poly1305.Spec_s.fst(37,88-42,35); use=X64.Poly1305.Spec_s.fst(41,48-41,50)
(and 
;; def=X64.Poly1305.Spec_s.fst(40,8-40,10); use=X64.Poly1305.Spec_s.fst(41,48-41,50)
(or label_1
(BoxBool_proj_0 (Prims.op_GreaterThanOrEqual (BoxInt (- (BoxInt_proj_0 x_608f5c658b95d65ae2ecfa2917e7b83b_5)
16))
x_ae567c2fb75be05905677af440075565_4)))
...
(or label_2
(BoxBool_proj_0 (Prims.op_Equality Prims.int
(BoxInt (_mod (- (- (BoxInt_proj_0 x_608f5c658b95d65ae2ecfa2917e7b83b_5)
16)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_4))
16))
(BoxInt 0))))
...
;; def=X64.Poly1305.Spec_s.fst(38,2-42,35); use=X64.Poly1305.Spec_s.fst(41,48-41,50)
(or label_3
...
; encoding sigelt let rec poly1305_hash_blocks


; <Start encoding let rec poly1305_hash_blocks>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented (Fuel Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented_token () Term)
(declare-fun X64.Poly1305.Spec_s.poly1305_hash_blocks (Term Term Term Term Term Term) Term)
(declare-fun X64.Poly1305.Spec_s.poly1305_hash_blocks@tok () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> nat128
(declare-fun Tm_arrow_a59d302710f4314b88cbb32063552186 () Term)
(declare-fun Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 (Term) Term)




;;;;;;;;;;;;;;;;h: Prims.int ->     pad: Prims.int ->     r: Prims.int ->     inp: (_: Prims.int -> nat128) ->     i: Prims.int ->     k: Prims.int{k >= i && (k - i) % 16 = 0}   -> Prims.Tot Prims.int
(declare-fun Tm_arrow_6cff791f7b64b37a4fa858c0fcfdcd4d () Term)

; </end encoding let rec poly1305_hash_blocks>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name X64.Poly1305.Spec_s.poly1305_hash_blocks; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,8-37,28); use=X64.Poly1305.Spec_s.fst(37,8-37,28)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x0
...
Prims.int)
(HasType @x5
(Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 @x4)))
(HasType (X64.Poly1305.Spec_s.poly1305_hash_blocks @x0
@x1
@x2
@x3
...
:named typing_X64.Poly1305.Spec_s.poly1305_hash_blocks))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name X64.Poly1305.Spec_s.modp'; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(31,4-31,9); use=X64.Poly1305.Spec_s.fst(31,4-31,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (X64.Poly1305.Spec_s.modp_ @x0)
Prims.int))
 

:pattern ((X64.Poly1305.Spec_s.modp_ @x0))
:qid typing_X64.Poly1305.Spec_s.modp_))

:named typing_X64.Poly1305.Spec_s.modp_))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name X64.Poly1305.Spec_s.poly1305_hash_blocks; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,8-37,28); use=X64.Poly1305.Spec_s.fst(37,8-37,28)
...
Prims.int)
(HasType @x6
(Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 @x5)))
(HasType (X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented @u0
@x1
@x2
@x3
@x4
...
:pattern ((X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented @u0
@x1
@x2
@x3
@x4
@x5
@x6))
:qid token_correspondence_X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented))

:named token_correspondence_X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name X64.Poly1305.Spec_s.poly1305_hash_blocks; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,81-37,112); use=X64.Poly1305.Spec_s.fst(37,81-37,112)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84))

:named refinement_kinding_Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name X64.Poly1305.Spec_s.poly1305_hash_blocks; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,81-37,112); use=X64.Poly1305.Spec_s.fst(37,81-37,112)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 @x2))
(and (HasTypeFuel @u0
@x1
Prims.int)
(BoxBool_proj_0 (Prims.op_GreaterThanOrEqual @x1
...
@x1
(Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 @x2)))
:qid refinement_interpretation_Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84))

:named refinement_interpretation_Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a59d302710f4314b88cbb32063552186
;;; Fact-ids: Name X64.Poly1305.Spec_s.poly1305_hash_blocks; Namespace X64.Poly1305.Spec_s
(assert (! (HasType Tm_arrow_a59d302710f4314b88cbb32063552186
Tm_type)
:named kinding_Tm_arrow_a59d302710f4314b88cbb32063552186))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84
;;; Fact-ids: Name X64.Poly1305.Spec_s.poly1305_hash_blocks; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,81-37,112); use=X64.Poly1305.Spec_s.fst(37,81-37,112)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 @x0)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 @x0))))
:qid haseqTm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84))

:named haseqTm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: X64.Poly1305.Spec_s.poly1305_hash_blocks
;;; Fact-ids: Name X64.Poly1305.Spec_s.poly1305_hash_blocks; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,8-37,28); use=X64.Poly1305.Spec_s.fst(37,8-37,28)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
...
(HasType @x6
(Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 @x5)))
(= (X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4
@x5
@x6)
(let ((@lb7 (Prims.op_Equality Prims.int
@x5
@x6)))
(ite (= @lb7
(BoxBool true))
@x1
(X64.Poly1305.Spec_s.modp_ (BoxInt (_mul (+ (+ (BoxInt_proj_0 (X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented @u0
@x1
@x2
@x3
@x4
...
:pattern ((X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4
@x5
@x6))
:qid equation_with_fuel_X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented))

:named equation_with_fuel_X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for X64.Poly1305.Spec_s.modp'
;;; Fact-ids: Name X64.Poly1305.Spec_s.modp'; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(31,4-31,9); use=X64.Poly1305.Spec_s.fst(31,4-31,9)
(forall ((@x0 Term))
 (! (= (X64.Poly1305.Spec_s.modp_ @x0)
(BoxInt (_mod (BoxInt_proj_0 @x0)
(- (_mul (BoxInt_proj_0 (X64.Poly1305.Spec_s.nat128_max Dummy_value))
4)
5))))
 

:pattern ((X64.Poly1305.Spec_s.modp_ @x0))
:qid equation_X64.Poly1305.Spec_s.modp_))

:named equation_X64.Poly1305.Spec_s.modp_))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name X64.Poly1305.Spec_s.poly1305_hash_blocks; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,60-37,71); use=X64.Poly1305.Spec_s.fst(37,60-37,71)
...
@x5
@x6)
(X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4
...
@x5
@x6))
:qid @fuel_irrelevance_X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented))

:named @fuel_irrelevance_X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name X64.Poly1305.Spec_s.poly1305_hash_blocks; Namespace X64.Poly1305.Spec_s
(assert (! 
;; def=X64.Poly1305.Spec_s.fst(37,8-37,28); use=X64.Poly1305.Spec_s.fst(37,8-37,28)
...
@x4
@x5)
(X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3
...
@x4
@x5))
:qid @fuel_correspondence_X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented))

:named @fuel_correspondence_X64.Poly1305.Spec_s.poly1305_hash_blocks.fuel_instrumented))
(push) ;; push{2

; Starting query at X64.Poly1305.Spec_s.fst(44,94-56,32)
...
; Encoding query formula : forall (key_r: X64.Poly1305.Spec_s.nat128)
;   (key_s: X64.Poly1305.Spec_s.nat128)
;   (inp: (_: Prims.int -> X64.Poly1305.Spec_s.nat128))
;   (start: Prims.int)
;   (len: Prims.nat).
;   (*  - Could not prove post-condition
; *)
;   (0 <= key_r && key_r < X64.Poly1305.Spec_s.nat128_max ==> FStar.UInt.size key_r 128) /\
;   (forall (any_result: X64.Poly1305.Spec_s.nat128).
;       key_r == any_result ==>
;       Prims.auto_squash (FStar.UInt.size 0x0ffffffc0ffffffc0ffffffc0fffffff 128) /\
;       (forall (any_result: Prims.int).
;           0x0ffffffc0ffffffc0ffffffc0fffffff == any_result ==>
;           (forall (any_result: FStar.UInt.uint_t 128).
;               FStar.UInt.logand key_r 0x0ffffffc0ffffffc0ffffffc0fffffff == any_result ==>
;               start + 16 * (len / 16) >= start && (start + 16 * (len / 16) - start) % 16 = 0 /\
;               (forall (return_val: k: Prims.int{k >= start && (k - start) % 16 = 0}).
;                   return_val == start + 16 * (len / 16) ==>
;                   (forall (any_result: Prims.int).
;                       X64.Poly1305.Spec_s.poly1305_hash_blocks 0
;                         X64.Poly1305.Spec_s.nat128_max
;                         (FStar.UInt.logand key_r 0x0ffffffc0ffffffc0ffffffc0fffffff)
;                         inp
;                         start
;                         (start + 16 * (len / 16)) ==
;                       any_result ==>
...
;                           (len % 16 = 0 == true ==> X64.Poly1305.Spec_s.nat128_max <> 0) /\
;                           (~(len % 16 = 0 = true) ==>
;                             (forall (b: Prims.bool).
;                                 len % 16 = 0 == b ==>
;                                 len % 16 * 8 >= 0 /\
...
;                                         Prims.pow2 (len % 16 * 8) == any_result ==>
;                                         (Prims.pow2 (len % 16 * 8) > 0 ==>
;                                           Prims.pow2 (len % 16 * 8) <> 0) /\
;                                         (forall (any_result: Prims.pos).
;                                             Prims.pow2 (len % 16 * 8) == any_result ==>
;                                             (forall (any_result: Prims.int).
...
;                                                         any_result ==>
;                                                         (forall (any_result: Prims.int).
;                                                             X64.Poly1305.Spec_s.modp' ((X64.Poly1305.Spec_s.poly1305_hash_blocks
;                                                                     0
;                                                                     X64.Poly1305.Spec_s.nat128_max
;                                                                     (FStar.UInt.logand key_r
;                                                                         0x0ffffffc0ffffffc0ffffffc0fffffff
...
;                                                               ) ==
;                                                             any_result ==>
;                                                             X64.Poly1305.Spec_s.nat128_max <> 0)))))
;                                     ))))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let poly1305_hash`
...
;; def=Prims.fst(459,77-459,89); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(and (implies 
;; def=X64.Poly1305.Spec_s.fst(29,20-29,44); use=X64.Poly1305.Spec_s.fst(45,22-45,27)
(and (BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
@x0))
(BoxBool_proj_0 (Prims.op_LessThan @x0
(X64.Poly1305.Spec_s.nat128_max Dummy_value))))
...
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Poly1305.Spec_s.fst(45,22-45,27)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
X64.Poly1305.Spec_s.nat128)

;; def=FStar.UInt.fsti(299,21-299,22); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(= @x0
@x5)
)
...
;; def=Prims.fst(459,77-459,89); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(and 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Poly1305.Spec_s.fst(45,28-45,62)
(or label_2

;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Poly1305.Spec_s.fst(45,28-45,62)
(Valid 
;; def=FStar.UInt.fsti(54,28-54,36); use=X64.Poly1305.Spec_s.fst(45,28-45,62)
(FStar.UInt.size (BoxInt 21267647620597763993911028882763415551)
(BoxInt 128))
)
)
...
;; def=FStar.UInt.fsti(299,34-299,35); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(= (BoxInt 21267647620597763993911028882763415551)
@x6)
)
...
;; def=X64.Poly1305.Spec_s.fst(45,6-45,62); use=X64.Poly1305.Spec_s.fst(45,6-45,62)
(= (FStar.UInt.logand (BoxInt 128)
@x0
(BoxInt 21267647620597763993911028882763415551))
@x7)
...
;; def=Prims.fst(459,77-459,89); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(and 
;; def=X64.Poly1305.Spec_s.fst(49,61-49,83); use=X64.Poly1305.Spec_s.fst(49,61-49,83)
(or label_3
(BoxBool_proj_0 (Prims.op_GreaterThanOrEqual (BoxInt (+ (BoxInt_proj_0 @x3)
(_mul 16
(_div (BoxInt_proj_0 @x4)
16))))
@x3)))
...
;; def=Prims.fst(356,2-356,58); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Tm_refine_ee8d7c5ffdd6652dcd2ab4e6be5c5a84 @x3))

;; def=Prims.fst(356,26-356,41); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(= @x8
...
;; def=X64.Poly1305.Spec_s.fst(49,6-49,83); use=X64.Poly1305.Spec_s.fst(49,6-49,83)
(= (X64.Poly1305.Spec_s.poly1305_hash_blocks (BoxInt 0)
(X64.Poly1305.Spec_s.nat128_max Dummy_value)
(FStar.UInt.logand (BoxInt 128)
@x0
(BoxInt 21267647620597763993911028882763415551))
...
;; def=Prims.fst(402,27-402,88); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(forall ((@x11 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(Valid 
;; def=Prims.fst(402,84-402,87); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(ApplyTT @x10
@x11)
...
;; def=Prims.fst(389,2-389,39); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(and (implies 
;; def=X64.Poly1305.Spec_s.fst(50,5-50,15); use=X64.Poly1305.Spec_s.fst(50,5-50,15)
(= (Prims.op_Equality Prims.int
(BoxInt (_mod (BoxInt_proj_0 @x4)
16))
(BoxInt 0))
(BoxBool true))


;; def=Prims.fst(686,22-686,28); use=X64.Poly1305.Spec_s.fst(51,24-51,34)
(or label_5

;; def=Prims.fst(686,22-686,28); use=X64.Poly1305.Spec_s.fst(51,24-51,34)
(not (= (X64.Poly1305.Spec_s.nat128_max Dummy_value)
(BoxInt 0)))
)
)
(implies 
;; def=Prims.fst(389,19-389,21); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(not 
;; def=X64.Poly1305.Spec_s.fst(50,5-50,15); use=X64.Poly1305.Spec_s.fst(50,5-50,15)
(= (Prims.op_Equality Prims.int
(BoxInt (_mod (BoxInt_proj_0 @x4)
...
;; def=Prims.fst(413,99-413,120); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
Prims.bool)

;; def=X64.Poly1305.Spec_s.fst(50,5-56,32); use=X64.Poly1305.Spec_s.fst(50,5-56,32)
(= (Prims.op_Equality Prims.int
(BoxInt (_mod (BoxInt_proj_0 @x4)
16))
(BoxInt 0))
...
;; def=Prims.fst(459,77-459,89); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(and 
;; def=Prims.fst(680,18-680,24); use=X64.Poly1305.Spec_s.fst(54,22-54,34)
(or label_6

;; def=Prims.fst(680,18-680,24); use=X64.Poly1305.Spec_s.fst(54,22-54,34)
(>= (_mul (_mod (BoxInt_proj_0 @x4)
16)
8)
0)
)
...
;; def=Prims.fst(356,26-356,41); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(= @x12
(BoxInt (_mul (_mod (BoxInt_proj_0 @x4)
16)
8)))
)
...
;; def=X64.Poly1305.Spec_s.fst(54,8-54,34); use=X64.Poly1305.Spec_s.fst(54,8-54,34)
(= (Prims.pow2 (BoxInt (_mul (_mod (BoxInt_proj_0 @x4)
16)
8)))
@x13)
)
...
;; def=Prims.fst(459,77-459,89); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(and (implies 
;; def=Prims.fst(683,18-683,23); use=X64.Poly1305.Spec_s.fst(55,55-55,62)
(> (BoxInt_proj_0 (Prims.pow2 (BoxInt (_mul (_mod (BoxInt_proj_0 @x4)
16)
8))))
0)


;; def=Prims.fst(686,22-686,28); use=X64.Poly1305.Spec_s.fst(55,55-55,62)
(or label_7

;; def=Prims.fst(686,22-686,28); use=X64.Poly1305.Spec_s.fst(55,55-55,62)
(not (= (Prims.pow2 (BoxInt (_mul (_mod (BoxInt_proj_0 @x4)
16)
8)))
(BoxInt 0)))
)
...
;; def=dummy(0,0-0,0); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(= (Prims.pow2 (BoxInt (_mul (_mod (BoxInt_proj_0 @x4)
16)
8)))
@x14)
...
;; def=dummy(0,0-0,0); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(= (BoxInt (_mod (BoxInt_proj_0 (ApplyTT @x2
(BoxInt (+ (BoxInt_proj_0 @x3)
(_mul 16
(_div (BoxInt_proj_0 @x4)
16))))))
...
;; def=dummy(0,0-0,0); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(= (BoxInt (+ (+ (BoxInt_proj_0 (X64.Poly1305.Spec_s.poly1305_hash_blocks (BoxInt 0)
(X64.Poly1305.Spec_s.nat128_max Dummy_value)
(FStar.UInt.logand (BoxInt 128)
@x0
(BoxInt 21267647620597763993911028882763415551))
...
;; def=X64.Poly1305.Spec_s.fst(31,10-55,69); use=X64.Poly1305.Spec_s.fst(44,94-56,32)
(= (BoxInt (_mul (+ (+ (BoxInt_proj_0 (X64.Poly1305.Spec_s.poly1305_hash_blocks (BoxInt 0)
(X64.Poly1305.Spec_s.nat128_max Dummy_value)
(FStar.UInt.logand (BoxInt 128)
@x0
(BoxInt 21267647620597763993911028882763415551))
...
16)
8))))))
(BoxInt_proj_0 (FStar.UInt.logand (BoxInt 128)
@x0
(BoxInt 21267647620597763993911028882763415551)))))
@x17)
)
...
;; def=X64.Poly1305.Spec_s.fst(55,8-55,69); use=X64.Poly1305.Spec_s.fst(55,8-55,69)
(= (X64.Poly1305.Spec_s.modp_ (BoxInt (_mul (+ (+ (BoxInt_proj_0 (X64.Poly1305.Spec_s.poly1305_hash_blocks (BoxInt 0)
(X64.Poly1305.Spec_s.nat128_max Dummy_value)
(FStar.UInt.logand (BoxInt 128)
@x0
(BoxInt 21267647620597763993911028882763415551))
...
;; def=Prims.fst(686,22-686,28); use=X64.Poly1305.Spec_s.fst(56,22-56,32)
(or label_8
