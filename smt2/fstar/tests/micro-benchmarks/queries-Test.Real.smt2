...
; Externals for interface FStar.Real


; <Start encoding val FStar.Real.real>

(declare-fun FStar.Real.real () Term)

; </end encoding val FStar.Real.real>


; <Start encoding val FStar.Real.of_int>

(declare-fun FStar.Real.of_int (Term) Term)
(declare-fun FStar.Real.of_int@tok () Term)

; </end encoding val FStar.Real.of_int>


; <Start encoding val FStar.Real.op_Plus_Dot>

(declare-fun FStar.Real.op_Plus_Dot (Term Term) Term)
(declare-fun FStar.Real.op_Plus_Dot@tok () Term)

; </end encoding val FStar.Real.op_Plus_Dot>


; <Start encoding val FStar.Real.op_Subtraction_Dot>

(declare-fun FStar.Real.op_Subtraction_Dot (Term Term) Term)
(declare-fun FStar.Real.op_Subtraction_Dot@tok () Term)

; </end encoding val FStar.Real.op_Subtraction_Dot>


; <Start encoding val FStar.Real.op_Star_Dot>

(declare-fun FStar.Real.op_Star_Dot (Term Term) Term)
(declare-fun FStar.Real.op_Star_Dot@tok () Term)

; </end encoding val FStar.Real.op_Star_Dot>


; <Start encoding val FStar.Real.op_Slash_Dot>

(declare-fun FStar.Real.op_Slash_Dot (Term Term) Term)
(declare-fun FStar.Real.op_Slash_Dot@tok () Term)

; </end encoding val FStar.Real.op_Slash_Dot>


; <Start encoding val FStar.Real.op_Greater_Dot>

(declare-fun FStar.Real.op_Greater_Dot (Term Term) Term)
(declare-fun FStar.Real.op_Greater_Dot@tok () Term)

; </end encoding val FStar.Real.op_Greater_Dot>


; <Start encoding val FStar.Real.op_Greater_Equals_Dot>

(declare-fun FStar.Real.op_Greater_Equals_Dot (Term Term) Term)
(declare-fun FStar.Real.op_Greater_Equals_Dot@tok () Term)

; </end encoding val FStar.Real.op_Greater_Equals_Dot>


; <Start encoding val FStar.Real.op_Less_Dot>

(declare-fun FStar.Real.op_Less_Dot (Term Term) Term)
(declare-fun FStar.Real.op_Less_Dot@tok () Term)

; </end encoding val FStar.Real.op_Less_Dot>


; <Start encoding val FStar.Real.op_Less_Equals_Dot>

(declare-fun FStar.Real.op_Less_Equals_Dot (Term Term) Term)
(declare-fun FStar.Real.op_Less_Equals_Dot@tok () Term)

; </end encoding val FStar.Real.op_Less_Equals_Dot>


; <Start encoding let zero>

(declare-fun FStar.Real.zero (Dummy_sort) Term)
...
(declare-fun FStar.Real.one (Dummy_sort) Term)
...
(declare-fun FStar.Real.two (Dummy_sort) Term)

; </end encoding let two>


; <Start encoding val FStar.Real.sqrt_2>

(declare-fun FStar.Real.sqrt_2 (Dummy_sort) Term)
(declare-fun Tm_refine_724b3567cc043f81c2fc07ed69fc406d () Term)


; </end encoding val FStar.Real.sqrt_2>


; End Externals for interface FStar.Real

(push) ;; push{1

; Internals for Test.Real


; encoding sigelt #push-options "--smtencoding.elim_box true --smtencoding.l_arith_repr native --smtencoding.nl_arith_repr native"


; <Skipped #push-options "--smtencoding.elim_box true --smtencoding.l_arith_repr native --smtencoding.nl_arith_repr native"/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Real.two; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(49,4-49,7); use=FStar.Real.fsti(49,4-49,7)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.Real.two @u0)
FStar.Real.real)
 

:pattern ((FStar.Real.two @u0))
:qid typing_FStar.Real.two))

:named typing_FStar.Real.two))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Real.real; Namespace FStar.Real
(assert (! (HasType FStar.Real.real
Tm_type)
:named typing_FStar.Real.real))
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Real.sqrt_2; Namespace FStar.Real
(assert (! (HasType Tm_refine_724b3567cc043f81c2fc07ed69fc406d
Tm_type)
:named refinement_kinding_Tm_refine_724b3567cc043f81c2fc07ed69fc406d))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
;;; Fact-ids: Name FStar.Real.sqrt_2; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(50,13-50,48); use=FStar.Real.fsti(50,13-50,48)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_724b3567cc043f81c2fc07ed69fc406d)
(and (HasTypeFuel @u0
@x1
FStar.Real.real)

;; def=FStar.Real.fsti(50,20-50,30); use=FStar.Real.fsti(50,20-50,30)
(Valid 
;; def=FStar.Real.fsti(50,20-50,30); use=FStar.Real.fsti(50,20-50,30)
(FStar.Real.op_Greater_Equals_Dot @x1
(BoxReal 0.0))
)


;; def=FStar.Real.fsti(50,34-50,47); use=FStar.Real.fsti(50,34-50,47)
(= (FStar.Real.op_Star_Dot @x1
@x1)
(FStar.Real.two Dummy_value))
))
...
@x1
Tm_refine_724b3567cc043f81c2fc07ed69fc406d))
:qid refinement_interpretation_Tm_refine_724b3567cc043f81c2fc07ed69fc406d))

:named refinement_interpretation_Tm_refine_724b3567cc043f81c2fc07ed69fc406d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
FStar.Real.real))
:qid real_inversion))
:named real_inversion))
;;; Fact-ids: Name FStar.Real.op_Star_Dot; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(38,6-38,8); use=FStar.Real.fsti(38,6-38,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.Real.op_Star_Dot @x0
@x1)
(BoxReal (* (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x1))))
 

:pattern ((FStar.Real.op_Star_Dot @x0
@x1))
:qid primitive_FStar.Real.op_Star_Dot))

:named primitive_FStar.Real.op_Star_Dot))
;;; Fact-ids: Name FStar.Real.op_Greater_Equals_Dot; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(42,7-42,9); use=FStar.Real.fsti(42,7-42,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (FStar.Real.op_Greater_Equals_Dot @x0
@x1))
(>= (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x1)))
 

:pattern ((FStar.Real.op_Greater_Equals_Dot @x0
@x1))
:qid primitive_FStar.Real.op_Greater_Equals_Dot))

:named primitive_FStar.Real.op_Greater_Equals_Dot))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_724b3567cc043f81c2fc07ed69fc406d
;;; Fact-ids: Name FStar.Real.sqrt_2; Namespace FStar.Real
(assert (! (iff (Valid (Prims.hasEq Tm_refine_724b3567cc043f81c2fc07ed69fc406d))
(Valid (Prims.hasEq FStar.Real.real)))
:named haseqTm_refine_724b3567cc043f81c2fc07ed69fc406d))
...
(assert (! (HasType FStar.Real.real
Tm_type)
:named function_token_typing_FStar.Real.real))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
(assert (! 
;; def=Prims.fst(165,5-165,11); use=Prims.fst(165,5-165,11)
...
:qid equation_FStar.Real.two))

:named equation_FStar.Real.two))
;;;;;;;;;;;;;;;;Eq2 interpretation
;;; Fact-ids: Name Prims.eq2; Namespace Prims
...
; Starting query at Test.Real.fst(6,54-6,89)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_b908214a99d6c8576e2baa4031c16cd3 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_b908214a99d6c8576e2baa4031c16cd3
Tm_type)
:named refinement_kinding_Tm_refine_b908214a99d6c8576e2baa4031c16cd3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Test.Real.fst(6,14-6,51); use=Test.Real.fst(6,14-6,51)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_b908214a99d6c8576e2baa4031c16cd3)
(and (HasTypeFuel @u0
@x1
FStar.Real.real)

;; def=Test.Real.fst(6,22-6,32); use=Test.Real.fst(6,22-6,32)
(not 
;; def=Test.Real.fst(6,22-6,32); use=Test.Real.fst(6,22-6,32)
(= @x1
(BoxReal 0.0))
...
;; def=Test.Real.fst(6,36-6,49); use=Test.Real.fst(6,36-6,49)
(not 
;; def=Test.Real.fst(6,36-6,49); use=Test.Real.fst(6,36-6,49)
(= (* (BoxReal_proj_0 @x1)
(BoxReal_proj_0 @x1))
...
@x1
Tm_refine_b908214a99d6c8576e2baa4031c16cd3))
:qid refinement_interpretation_Tm_refine_b908214a99d6c8576e2baa4031c16cd3))

:named refinement_interpretation_Tm_refine_b908214a99d6c8576e2baa4031c16cd3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b908214a99d6c8576e2baa4031c16cd3
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_b908214a99d6c8576e2baa4031c16cd3))
(Valid (Prims.hasEq FStar.Real.real)))
:named haseqTm_refine_b908214a99d6c8576e2baa4031c16cd3))
(declare-fun Tm_refine_9e0f88e4acb351412af94f4da769e2c3 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_9e0f88e4acb351412af94f4da769e2c3
Tm_type)
:named refinement_kinding_Tm_refine_9e0f88e4acb351412af94f4da769e2c3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Real.fsti(39,21-39,39); use=Test.Real.fst(6,64-6,66)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_9e0f88e4acb351412af94f4da769e2c3)
(and (HasTypeFuel @u0
@x1
FStar.Real.real)

;; def=FStar.Real.fsti(39,28-39,38); use=Test.Real.fst(6,64-6,66)
(not 
;; def=FStar.Real.fsti(39,28-39,38); use=Test.Real.fst(6,64-6,66)
(= @x1
(BoxReal 0.0))
...
@x1
Tm_refine_9e0f88e4acb351412af94f4da769e2c3))
:qid refinement_interpretation_Tm_refine_9e0f88e4acb351412af94f4da769e2c3))

:named refinement_interpretation_Tm_refine_9e0f88e4acb351412af94f4da769e2c3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9e0f88e4acb351412af94f4da769e2c3
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_9e0f88e4acb351412af94f4da769e2c3))
(Valid (Prims.hasEq FStar.Real.real)))
:named haseqTm_refine_9e0f88e4acb351412af94f4da769e2c3))


; Encoding query formula : forall (n: FStar.Real.real{~(n == 0.0R) /\ ~(n *. n == 0.0R)}).
;   (*  - Could not prove post-condition
; *)
;   ~(n *. n == 0.0R) /\
;   (forall (return_val: d: FStar.Real.real{~(d == 0.0R)}).
;       return_val == n *. n ==>
;       (forall (any_result: FStar.Real.real).
;           n /. (n *. n) == any_result ==>
;           (~(n == 0.0R) /\ ~(n *. n == 0.0R) ==> ~(n == 0.0R)) /\
;           (forall (any_result: n: FStar.Real.real{~(n == 0.0R) /\ ~(n *. n == 0.0R)}).
;               n == any_result ==>
;               (forall (any_result: FStar.Real.real).
;                   1.0R /. n == any_result ==>
;                   (forall (any_result: Prims.logical).
;                       n /. (n *. n) == 1.0R /. n == any_result ==> n /. (n *. n) == 1.0R /. n)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let n_over_n2`
...
;; def=Prims.fst(459,77-459,89); use=Test.Real.fst(6,54-6,89)
(and 
;; def=FStar.Real.fsti(39,28-39,38); use=Test.Real.fst(6,67-6,75)
(or label_1
...
;; def=Prims.fst(356,2-356,58); use=Test.Real.fst(6,54-6,89)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Tm_refine_9e0f88e4acb351412af94f4da769e2c3)

;; def=Prims.fst(356,26-356,41); use=Test.Real.fst(6,54-6,89)
(= @x1
(BoxReal (* (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x0))))
)

;; def=Prims.fst(451,66-451,102); use=Test.Real.fst(6,54-6,89)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
FStar.Real.real)

;; def=Prims.fst(175,35-175,36); use=Test.Real.fst(6,54-6,89)
(= (BoxReal (/ (BoxReal_proj_0 @x0)
(* (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x0))))
@x2)
...
;; def=Prims.fst(459,77-459,89); use=Test.Real.fst(6,54-6,89)
(and (implies 
;; def=Test.Real.fst(6,22-6,49); use=Test.Real.fst(6,87-6,88)
(and 
;; def=Test.Real.fst(6,22-6,32); use=Test.Real.fst(6,87-6,88)
(not 
;; def=Test.Real.fst(6,22-6,32); use=Test.Real.fst(6,87-6,88)
(= @x0
(BoxReal 0.0))
...
;; def=Test.Real.fst(6,36-6,49); use=Test.Real.fst(6,87-6,88)
(not 
;; def=Test.Real.fst(6,36-6,49); use=Test.Real.fst(6,87-6,88)
(= (* (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x0))
...
;; def=FStar.Real.fsti(39,28-39,38); use=Test.Real.fst(6,87-6,88)
(or label_2
...
;; def=FStar.Real.fsti(39,21-39,22); use=Test.Real.fst(6,54-6,89)
(= @x0
@x3)
)
...
;; def=Prims.fst(175,42-175,43); use=Test.Real.fst(6,54-6,89)
(= (BoxReal (/ 1.0
(BoxReal_proj_0 @x0)))
@x4)
)
...
;; def=Prims.fst(672,13-672,14); use=Test.Real.fst(6,54-6,89)
(= (Prims.eq2 FStar.Real.real
(BoxReal (/ (BoxReal_proj_0 @x0)
(* (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x0))))
(BoxReal (/ 1.0
...
;; def=Test.Real.fst(6,61-6,89); use=Test.Real.fst(6,54-6,60)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.n_over_n2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, real_inversion, refinement_interpretation_Tm_refine_b908214a99d6c8576e2baa4031c16cd3
...
; encoding sigelt let n_over_n2


; <Start encoding let n_over_n2>

(declare-fun Tm_refine_b908214a99d6c8576e2baa4031c16cd3 () Term)
(declare-fun Test.Real.n_over_n2 (Term) Term)

;;;;;;;;;;;;;;;;n: FStar.Real.real{~(n == 0.0R) /\ ~(n *. n == 0.0R)} -> Prims.unit
(declare-fun Tm_arrow_1325b45bb290fb7c172c6a891baf4eba () Term)
(declare-fun Test.Real.n_over_n2@tok () Term)


; </end encoding let n_over_n2>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Real.one; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(48,4-48,7); use=FStar.Real.fsti(48,4-48,7)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.Real.one @u0)
FStar.Real.real)
 

:pattern ((FStar.Real.one @u0))
:qid typing_FStar.Real.one))

:named typing_FStar.Real.one))
;;; Fact-ids: Name FStar.Real.op_Greater_Dot; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(41,7-41,8); use=FStar.Real.fsti(41,7-41,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (FStar.Real.op_Greater_Dot @x0
@x1))
(> (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x1)))
 

:pattern ((FStar.Real.op_Greater_Dot @x0
@x1))
:qid primitive_FStar.Real.op_Greater_Dot))

:named primitive_FStar.Real.op_Greater_Dot))
;;;;;;;;;;;;;;;;Equation for FStar.Real.one
;;; Fact-ids: Name FStar.Real.one; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(48,4-48,7); use=FStar.Real.fsti(48,4-48,7)
(forall ((@u0 Dummy_sort))
...
:qid equation_FStar.Real.one))

:named equation_FStar.Real.one))
(push) ;; push{2

; Starting query at Test.Real.fst(9,0-9,30)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (FStar.Real.two >. FStar.Real.one)
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(9,18-9,30); use=Test.Real.fst(9,11-9,17)
(or label_1

;; def=Test.Real.fst(9,18-9,30); use=Test.Real.fst(9,11-9,17)
(Valid 
;; def=Test.Real.fst(9,18-9,30); use=Test.Real.fst(9,11-9,17)
(FStar.Real.op_Greater_Dot (FStar.Real.two Dummy_value)
(FStar.Real.one Dummy_value))
)
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.Real.one, equation_FStar.Real.two, primitive_FStar.Real.op_Greater_Dot, projection_inverse_BoxReal_proj_0
...
(declare-fun Test.Real.test (Dummy_sort) Term)

; </end encoding let test>

(push) ;; push{2

; Starting query at Test.Real.fst(10,0-10,32)

(declare-fun label_1 () Bool)

; Encoding query formula : FStar.Real.one == 1.0R
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(10,19-10,32); use=Test.Real.fst(10,12-10,18)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.Real.one
...
(declare-fun Test.Real.test1 (Dummy_sort) Term)

; </end encoding let test1>

;;; Fact-ids: Name FStar.Real.op_Less_Dot; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(44,6-44,8); use=FStar.Real.fsti(44,6-44,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (FStar.Real.op_Less_Dot @x0
@x1))
(< (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x1)))
 

:pattern ((FStar.Real.op_Less_Dot @x0
@x1))
:qid primitive_FStar.Real.op_Less_Dot))

:named primitive_FStar.Real.op_Less_Dot))
(push) ;; push{2

; Starting query at Test.Real.fst(12,0-12,36)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (1.0R <. 2.0R)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_lt1`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(12,22-12,36); use=Test.Real.fst(12,15-12,21)
(or label_1

;; def=Test.Real.fst(12,22-12,36); use=Test.Real.fst(12,15-12,21)
(Valid 
;; def=Test.Real.fst(12,22-12,36); use=Test.Real.fst(12,15-12,21)
(FStar.Real.op_Less_Dot (BoxReal 1.0)
(BoxReal 2.0))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_lt1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_FStar.Real.op_Less_Dot, projection_inverse_BoxReal_proj_0
...
; encoding sigelt let test_lt1


; <Start encoding let test_lt1>

(declare-fun Test.Real.test_lt1 (Dummy_sort) Term)

; </end encoding let test_lt1>


; encoding sigelt let test_lt2


; <Start encoding let test_lt2>

(declare-fun Test.Real.test_lt2 (Dummy_sort) Term)

; </end encoding let test_lt2>

(push) ;; push{2

; Starting query at Test.Real.fst(14,0-14,40)

(declare-fun label_1 () Bool)

; Encoding query formula : ~(2.0R <. 1.0R)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_lt3`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(14,22-14,40); use=Test.Real.fst(14,15-14,21)
(or label_1

;; def=Test.Real.fst(14,22-14,40); use=Test.Real.fst(14,15-14,21)
(not 
;; def=Test.Real.fst(14,25-14,39); use=Test.Real.fst(14,15-14,21)
(Valid 
;; def=Test.Real.fst(14,25-14,39); use=Test.Real.fst(14,15-14,21)
(FStar.Real.op_Less_Dot (BoxReal 2.0)
(BoxReal 1.0))
)
)
)
...
; encoding sigelt let test_lt3


; <Start encoding let test_lt3>

(declare-fun Test.Real.test_lt3 (Dummy_sort) Term)

; </end encoding let test_lt3>

;;; Fact-ids: Name FStar.Real.op_Less_Equals_Dot; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(45,6-45,9); use=FStar.Real.fsti(45,6-45,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (FStar.Real.op_Less_Equals_Dot @x0
@x1))
(<= (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x1)))
 

:pattern ((FStar.Real.op_Less_Equals_Dot @x0
@x1))
:qid primitive_FStar.Real.op_Less_Equals_Dot))

:named primitive_FStar.Real.op_Less_Equals_Dot))
(push) ;; push{2

; Starting query at Test.Real.fst(16,0-16,37)
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_le1`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(16,22-16,37); use=Test.Real.fst(16,15-16,21)
(or label_1

;; def=Test.Real.fst(16,22-16,37); use=Test.Real.fst(16,15-16,21)
(Valid 
;; def=Test.Real.fst(16,22-16,37); use=Test.Real.fst(16,15-16,21)
(FStar.Real.op_Less_Equals_Dot (BoxReal 1.0)
(BoxReal 2.0))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_le1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_FStar.Real.op_Less_Equals_Dot, projection_inverse_BoxReal_proj_0
...
; encoding sigelt let test_le1


; <Start encoding let test_le1>

(declare-fun Test.Real.test_le1 (Dummy_sort) Term)

; </end encoding let test_le1>


; encoding sigelt let test_le2


; <Start encoding let test_le2>

(declare-fun Test.Real.test_le2 (Dummy_sort) Term)

; </end encoding let test_le2>

(push) ;; push{2

; Starting query at Test.Real.fst(18,0-18,41)
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_le3`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(18,22-18,41); use=Test.Real.fst(18,15-18,21)
(or label_1

;; def=Test.Real.fst(18,22-18,41); use=Test.Real.fst(18,15-18,21)
(not 
;; def=Test.Real.fst(18,25-18,40); use=Test.Real.fst(18,15-18,21)
(Valid 
;; def=Test.Real.fst(18,25-18,40); use=Test.Real.fst(18,15-18,21)
(FStar.Real.op_Less_Equals_Dot (BoxReal 2.0)
(BoxReal 1.0))
)
)
)
...
; encoding sigelt let test_le3


; <Start encoding let test_le3>

(declare-fun Test.Real.test_le3 (Dummy_sort) Term)

; </end encoding let test_le3>

(push) ;; push{2

; Starting query at Test.Real.fst(20,0-20,40)

(declare-fun label_1 () Bool)

; Encoding query formula : ~(1.0R >. 2.0R)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_gt1`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(20,22-20,40); use=Test.Real.fst(20,15-20,21)
(or label_1

;; def=Test.Real.fst(20,22-20,40); use=Test.Real.fst(20,15-20,21)
(not 
;; def=Test.Real.fst(20,25-20,39); use=Test.Real.fst(20,15-20,21)
(Valid 
;; def=Test.Real.fst(20,25-20,39); use=Test.Real.fst(20,15-20,21)
(FStar.Real.op_Greater_Dot (BoxReal 1.0)
(BoxReal 2.0))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_gt1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_FStar.Real.op_Greater_Dot, projection_inverse_BoxReal_proj_0
...
; encoding sigelt let test_gt1


; <Start encoding let test_gt1>

(declare-fun Test.Real.test_gt1 (Dummy_sort) Term)

; </end encoding let test_gt1>


; encoding sigelt let test_gt2


; <Start encoding let test_gt2>

(declare-fun Test.Real.test_gt2 (Dummy_sort) Term)

; </end encoding let test_gt2>

(push) ;; push{2

; Starting query at Test.Real.fst(22,0-22,36)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (2.0R >. 1.0R)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_gt3`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(22,22-22,36); use=Test.Real.fst(22,15-22,21)
(or label_1

;; def=Test.Real.fst(22,22-22,36); use=Test.Real.fst(22,15-22,21)
(Valid 
;; def=Test.Real.fst(22,22-22,36); use=Test.Real.fst(22,15-22,21)
(FStar.Real.op_Greater_Dot (BoxReal 2.0)
(BoxReal 1.0))
)
)
)
...
; encoding sigelt let test_gt3


; <Start encoding let test_gt3>

(declare-fun Test.Real.test_gt3 (Dummy_sort) Term)

; </end encoding let test_gt3>

(push) ;; push{2

; Starting query at Test.Real.fst(24,0-24,41)
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_ge1`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(24,22-24,41); use=Test.Real.fst(24,15-24,21)
(or label_1

;; def=Test.Real.fst(24,22-24,41); use=Test.Real.fst(24,15-24,21)
(not 
;; def=Test.Real.fst(24,25-24,40); use=Test.Real.fst(24,15-24,21)
(Valid 
;; def=Test.Real.fst(24,25-24,40); use=Test.Real.fst(24,15-24,21)
(FStar.Real.op_Greater_Equals_Dot (BoxReal 1.0)
(BoxReal 2.0))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_ge1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_FStar.Real.op_Greater_Equals_Dot, projection_inverse_BoxReal_proj_0
...
; encoding sigelt let test_ge1


; <Start encoding let test_ge1>

(declare-fun Test.Real.test_ge1 (Dummy_sort) Term)

; </end encoding let test_ge1>


; encoding sigelt let test_ge2


; <Start encoding let test_ge2>

(declare-fun Test.Real.test_ge2 (Dummy_sort) Term)

; </end encoding let test_ge2>

(push) ;; push{2

; Starting query at Test.Real.fst(26,0-26,37)
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_ge3`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(26,22-26,37); use=Test.Real.fst(26,15-26,21)
(or label_1

;; def=Test.Real.fst(26,22-26,37); use=Test.Real.fst(26,15-26,21)
(Valid 
;; def=Test.Real.fst(26,22-26,37); use=Test.Real.fst(26,15-26,21)
(FStar.Real.op_Greater_Equals_Dot (BoxReal 2.0)
(BoxReal 1.0))
)
)
)
...
; encoding sigelt let test_ge3


; <Start encoding let test_ge3>

(declare-fun Test.Real.test_ge3 (Dummy_sort) Term)

; </end encoding let test_ge3>

;;; Fact-ids: Name FStar.Real.op_Plus_Dot; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(36,6-36,8); use=FStar.Real.fsti(36,6-36,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.Real.op_Plus_Dot @x0
@x1)
(BoxReal (+ (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x1))))
 

:pattern ((FStar.Real.op_Plus_Dot @x0
@x1))
:qid primitive_FStar.Real.op_Plus_Dot))

:named primitive_FStar.Real.op_Plus_Dot))
(push) ;; push{2

; Starting query at Test.Real.fst(28,0-28,47)

(declare-fun label_1 () Bool)

; Encoding query formula : 1.0R +. 1.0R == 2.0R


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_add_eq`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(28,25-28,47); use=Test.Real.fst(28,18-28,24)
(or label_1

;; def=Test.Real.fst(28,25-28,47); use=Test.Real.fst(28,18-28,24)
(= (FStar.Real.op_Plus_Dot (BoxReal 1.0)
(BoxReal 1.0))
(BoxReal 2.0))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_add_eq, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_FStar.Real.op_Plus_Dot, projection_inverse_BoxReal_proj_0
...
; encoding sigelt let test_add_eq


; <Start encoding let test_add_eq>

(declare-fun Test.Real.test_add_eq (Dummy_sort) Term)

; </end encoding let test_add_eq>

(push) ;; push{2

; Starting query at Test.Real.fst(29,0-29,48)

(declare-fun label_1 () Bool)

; Encoding query formula : 1.0R +. 3.0R == 4.0R
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(29,26-29,48); use=Test.Real.fst(29,19-29,25)
(or label_1
...
(declare-fun Test.Real.test_add_eq_ (Dummy_sort) Term)

; </end encoding let test_add_eq'>

(push) ;; push{2

; Starting query at Test.Real.fst(30,0-30,47)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (1.0R +. 1.0R <. 3.0R)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_add_lt`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(30,25-30,47); use=Test.Real.fst(30,18-30,24)
(or label_1

;; def=Test.Real.fst(30,25-30,47); use=Test.Real.fst(30,18-30,24)
(Valid 
;; def=Test.Real.fst(30,25-30,47); use=Test.Real.fst(30,18-30,24)
(FStar.Real.op_Less_Dot (FStar.Real.op_Plus_Dot (BoxReal 1.0)
(BoxReal 1.0))
(BoxReal 3.0))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_add_lt, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_FStar.Real.op_Less_Dot, primitive_FStar.Real.op_Plus_Dot, projection_inverse_BoxReal_proj_0
...
; encoding sigelt let test_add_lt


; <Start encoding let test_add_lt>

(declare-fun Test.Real.test_add_lt (Dummy_sort) Term)

; </end encoding let test_add_lt>

(push) ;; push{2

; Starting query at Test.Real.fst(32,0-32,47)

(declare-fun label_1 () Bool)

; Encoding query formula : 2.0R *. 2.0R == 4.0R


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_mul_eq`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(32,25-32,47); use=Test.Real.fst(32,18-32,24)
(or label_1

;; def=Test.Real.fst(32,25-32,47); use=Test.Real.fst(32,18-32,24)
(= (FStar.Real.op_Star_Dot (BoxReal 2.0)
(BoxReal 2.0))
(BoxReal 4.0))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_mul_eq, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_FStar.Real.op_Star_Dot, projection_inverse_BoxReal_proj_0
...
; encoding sigelt let test_mul_eq


; <Start encoding let test_mul_eq>

(declare-fun Test.Real.test_mul_eq (Dummy_sort) Term)

; </end encoding let test_mul_eq>

(push) ;; push{2

; Starting query at Test.Real.fst(33,0-33,47)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (2.0R *. 2.0R <. 5.0R)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_mul_lt`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(33,25-33,47); use=Test.Real.fst(33,18-33,24)
(or label_1

;; def=Test.Real.fst(33,25-33,47); use=Test.Real.fst(33,18-33,24)
(Valid 
;; def=Test.Real.fst(33,25-33,47); use=Test.Real.fst(33,18-33,24)
(FStar.Real.op_Less_Dot (FStar.Real.op_Star_Dot (BoxReal 2.0)
(BoxReal 2.0))
(BoxReal 5.0))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_mul_lt, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_FStar.Real.op_Less_Dot, primitive_FStar.Real.op_Star_Dot, projection_inverse_BoxReal_proj_0
...
; encoding sigelt let test_mul_lt


; <Start encoding let test_mul_lt>

(declare-fun Test.Real.test_mul_lt (Dummy_sort) Term)

; </end encoding let test_mul_lt>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Test.Real.n_over_n2; Namespace Test.Real
(assert (! (HasType Tm_refine_b908214a99d6c8576e2baa4031c16cd3
Tm_type)
:named refinement_kinding_Tm_refine_b908214a99d6c8576e2baa4031c16cd3))
;;;;;;;;;;;;;;;;refinement_interpretation
...
:named refinement_interpretation_Tm_refine_b908214a99d6c8576e2baa4031c16cd3))
;;; Fact-ids: Name FStar.Real.op_Slash_Dot; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(39,6-39,8); use=FStar.Real.fsti(39,6-39,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (not (= (BoxReal_proj_0 @x1)
0))
(= (FStar.Real.op_Slash_Dot @x0
@x1)
(BoxReal (/ (BoxReal_proj_0 @x0)
(BoxReal_proj_0 @x1)))))
 

:pattern ((FStar.Real.op_Slash_Dot @x0
@x1))
:qid primitive_FStar.Real.op_Slash_Dot))

:named primitive_FStar.Real.op_Slash_Dot))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b908214a99d6c8576e2baa4031c16cd3
;;; Fact-ids: Name Test.Real.n_over_n2; Namespace Test.Real
(assert (! (iff (Valid (Prims.hasEq Tm_refine_b908214a99d6c8576e2baa4031c16cd3))
(Valid (Prims.hasEq FStar.Real.real)))
...
; Starting query at Test.Real.fst(35,0-35,47)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : ~(2.0R == 0.0R) /\
; (forall (any_result: FStar.Real.real).
;     2.0R == any_result ==>
;     (forall (any_result: FStar.Real.real).
;         8.0R /. 2.0R == any_result ==>
;         (forall (any_result: Prims.logical).
;             8.0R /. 2.0R == 4.0R == any_result ==> 8.0R /. 2.0R == 4.0R)))


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_div_eq`
...
(and 
;; def=FStar.Real.fsti(39,28-39,38); use=Test.Real.fst(35,34-35,38)
(or label_1
...
;; def=FStar.Real.fsti(39,21-39,22); use=FStar.Real.fsti(39,21-39,22)
(= (BoxReal 2.0)
@x0)
)
...
(= (FStar.Real.op_Slash_Dot (BoxReal 8.0)
(BoxReal 2.0))
@x1)
)
...
;; def=Test.Real.fst(35,25-35,47); use=Test.Real.fst(35,18-35,24)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_div_eq, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_FStar.Real.op_Slash_Dot, projection_inverse_BoxReal_proj_0
...
; encoding sigelt let test_div_eq


; <Start encoding let test_div_eq>

(declare-fun Test.Real.test_div_eq (Dummy_sort) Term)

; </end encoding let test_div_eq>
...
; Starting query at Test.Real.fst(36,0-36,47)
...
;             8.0R /. 2.0R <. 5.0R == any_result ==>
;             (forall (return_val: Prims.prop).
;                 return_val == (8.0R /. 2.0R <. 5.0R) ==>
;                 8.0R /. 2.0R <. 5.0R == return_val ==> 8.0R /. 2.0R <. 5.0R))))


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_div_lt`
...
;; def=Prims.fst(459,77-459,89); use=Prims.fst(459,77-459,89)
(and 
;; def=FStar.Real.fsti(39,28-39,38); use=Test.Real.fst(36,34-36,38)
(or label_1
...
;; def=FStar.Real.fsti(44,30-44,34); use=Test.Real.fst(36,25-36,47)
(= (FStar.Real.op_Less_Dot (FStar.Real.op_Slash_Dot (BoxReal 8.0)
(BoxReal 2.0))
(BoxReal 5.0))
@x2)
)
...
;; def=Test.Real.fst(36,25-36,47); use=Test.Real.fst(36,18-36,24)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_div_lt, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_FStar.Real.op_Less_Dot, primitive_FStar.Real.op_Slash_Dot, projection_inverse_BoxReal_proj_0
...
; encoding sigelt let test_div_lt


; <Start encoding let test_div_lt>

(declare-fun Test.Real.test_div_lt (Dummy_sort) Term)

; </end encoding let test_div_lt>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Real.sqrt_2; Namespace FStar.Real
(assert (! 
;; def=FStar.Real.fsti(50,4-50,10); use=FStar.Real.fsti(50,4-50,10)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.Real.sqrt_2 @u0)
Tm_refine_724b3567cc043f81c2fc07ed69fc406d)
 

:pattern ((FStar.Real.sqrt_2 @u0))
:qid typing_FStar.Real.sqrt_2))

:named typing_FStar.Real.sqrt_2))
(push) ;; push{2

; Starting query at Test.Real.fst(38,0-38,55)

(declare-fun label_1 () Bool)

; Encoding query formula : FStar.Real.sqrt_2 *. FStar.Real.sqrt_2 == 2.0R


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_sqrt_2_mul`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(38,29-38,55); use=Test.Real.fst(38,22-38,28)
(or label_1

;; def=Test.Real.fst(38,29-38,55); use=Test.Real.fst(38,22-38,28)
(= (FStar.Real.op_Star_Dot (FStar.Real.sqrt_2 Dummy_value)
(FStar.Real.sqrt_2 Dummy_value))
(BoxReal 2.0))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_sqrt_2_mul, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Real.two, refinement_interpretation_Tm_refine_724b3567cc043f81c2fc07ed69fc406d, typing_FStar.Real.sqrt_2
...
; encoding sigelt let test_sqrt_2_mul


; <Start encoding let test_sqrt_2_mul>

(declare-fun Test.Real.test_sqrt_2_mul (Dummy_sort) Term)

; </end encoding let test_sqrt_2_mul>

(push) ;; push{2

; Starting query at Test.Real.fst(40,0-40,45)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (FStar.Real.sqrt_2 >. 1.0R)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let test_sqrt_2_add`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Test.Real.fst(40,29-40,45); use=Test.Real.fst(40,22-40,28)
(or label_1

;; def=Test.Real.fst(40,29-40,45); use=Test.Real.fst(40,22-40,28)
(Valid 
;; def=Test.Real.fst(40,29-40,45); use=Test.Real.fst(40,22-40,28)
(FStar.Real.op_Greater_Dot (FStar.Real.sqrt_2 Dummy_value)
(BoxReal 1.0))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Test.Real.test_sqrt_2_add, 1)
; STATUS: unknown because (incomplete (theory arithmetic))
