...
; <Start encoding val FStar.BV.bv_t>
...
; </end encoding val FStar.BV.bv_t>


; <Start encoding val FStar.BV.bv_uext>
...
; </end encoding val FStar.BV.bv_uext>


; <Start encoding val FStar.BV.int2bv>
...
; </end encoding val FStar.BV.int2bv>


; <Start encoding val FStar.BV.bv2int>
...
; </end encoding val FStar.BV.bv2int>


; <Start encoding val FStar.BV.int2bv_lemma_1>
...
; </end encoding val FStar.BV.int2bv_lemma_1>


; <Start encoding val FStar.BV.int2bv_lemma_2>
...
; </end encoding val FStar.BV.int2bv_lemma_2>


; <Start encoding val FStar.BV.inverse_vec_lemma>
...
; </end encoding val FStar.BV.inverse_vec_lemma>


; <Start encoding val FStar.BV.inverse_num_lemma>
...
; </end encoding val FStar.BV.inverse_num_lemma>


; <Start encoding val FStar.BV.list2bv>
...
; </end encoding val FStar.BV.list2bv>


; <Start encoding val FStar.BV.bv2list>
...
; </end encoding val FStar.BV.bv2list>


; <Start encoding val FStar.BV.list2bv_bij>
...
; </end encoding val FStar.BV.list2bv_bij>


; <Start encoding val FStar.BV.bv2list_bij>
...
; </end encoding val FStar.BV.bv2list_bij>


; <Start encoding val FStar.BV.bvand>
...
; </end encoding val FStar.BV.bvand>


; <Start encoding val FStar.BV.int2bv_logand>
...
; </end encoding val FStar.BV.int2bv_logand>


; <Start encoding val FStar.BV.bvxor>

(declare-fun FStar.BV.bvxor (Term Term Term) Term)

(declare-fun FStar.BV.bvxor@tok () Term)

; </end encoding val FStar.BV.bvxor>


; <Start encoding val FStar.BV.int2bv_logxor>
...
; </end encoding val FStar.BV.int2bv_logxor>


; <Start encoding val FStar.BV.bvor>

(declare-fun FStar.BV.bvor (Term Term Term) Term)

(declare-fun FStar.BV.bvor@tok () Term)

; </end encoding val FStar.BV.bvor>


; <Start encoding val FStar.BV.int2bv_logor>
...
; </end encoding val FStar.BV.int2bv_logor>


; <Start encoding val FStar.BV.bvnot>
...
; </end encoding val FStar.BV.bvnot>


; <Start encoding val FStar.BV.int2bv_lognot>
...
; </end encoding val FStar.BV.int2bv_lognot>


; <Start encoding val FStar.BV.bvshl'>

(declare-fun FStar.BV.bvshl_ (Term Term Term) Term)

(declare-fun FStar.BV.bvshl_@tok () Term)

; </end encoding val FStar.BV.bvshl'>
...
; <Start encoding val FStar.BV.int2bv_shl'>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.BV.int2bv_shl_ (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.BV.int2bv_shl_@tok () Term)

; </end encoding val FStar.BV.int2bv_shl'>
...
; <Start encoding val FStar.BV.bvshr'>

(declare-fun FStar.BV.bvshr_ (Term Term Term) Term)

(declare-fun FStar.BV.bvshr_@tok () Term)

; </end encoding val FStar.BV.bvshr'>
...
; <Start encoding val FStar.BV.int2bv_shr'>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.BV.int2bv_shr_ (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.BV.int2bv_shr_@tok () Term)

; </end encoding val FStar.BV.int2bv_shr'>
...
; </end encoding let bv_zero>


; <Start encoding val FStar.BV.bvult>
...
; </end encoding val FStar.BV.bvult>


; <Start encoding val FStar.BV.int2bv_lemma_ult_1>
...
; </end encoding val FStar.BV.int2bv_lemma_ult_1>


; <Start encoding val FStar.BV.int2bv_lemma_ult_2>
...
; </end encoding val FStar.BV.int2bv_lemma_ult_2>


; <Start encoding val FStar.BV.bvadd>

(declare-fun FStar.BV.bvadd (Term Term Term) Term)

(declare-fun FStar.BV.bvadd@tok () Term)

; </end encoding val FStar.BV.bvadd>


; <Start encoding val FStar.BV.int2bv_add>
...
; </end encoding val FStar.BV.int2bv_add>


; <Start encoding val FStar.BV.bvsub>

(declare-fun FStar.BV.bvsub (Term Term Term) Term)

(declare-fun FStar.BV.bvsub@tok () Term)

; </end encoding val FStar.BV.bvsub>


; <Start encoding val FStar.BV.int2bv_sub>
...
; </end encoding val FStar.BV.int2bv_sub>


; <Start encoding val FStar.BV.bvdiv>
...
; </end encoding val FStar.BV.bvdiv>


; <Start encoding val FStar.BV.int2bv_div>
...
; </end encoding val FStar.BV.int2bv_div>


; <Start encoding val FStar.BV.bvdiv_unsafe>

(declare-fun FStar.BV.bvdiv_unsafe (Term Term Term) Term)

(declare-fun FStar.BV.bvdiv_unsafe@tok () Term)

; </end encoding val FStar.BV.bvdiv_unsafe>


; <Start encoding val FStar.BV.bvdiv_unsafe_sound>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.BV.bvdiv_unsafe_sound (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.BV.bvdiv_unsafe_sound@tok () Term)

; </end encoding val FStar.BV.bvdiv_unsafe_sound>


; <Start encoding val FStar.BV.bvmod>
...
; </end encoding val FStar.BV.bvmod>


; <Start encoding val FStar.BV.int2bv_mod>
...
; </end encoding val FStar.BV.int2bv_mod>


; <Start encoding val FStar.BV.bvmod_unsafe>

(declare-fun FStar.BV.bvmod_unsafe (Term Term Term) Term)

(declare-fun FStar.BV.bvmod_unsafe@tok () Term)

; </end encoding val FStar.BV.bvmod_unsafe>


; <Start encoding val FStar.BV.bvmod_unsafe_sound>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.BV.bvmod_unsafe_sound (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.BV.bvmod_unsafe_sound@tok () Term)

; </end encoding val FStar.BV.bvmod_unsafe_sound>


; <Start encoding val FStar.BV.bvmul>
...
; </end encoding val FStar.BV.bvmul>


; <Start encoding val FStar.BV.int2bv_mul>
...
; </end encoding val FStar.BV.int2bv_mul>


; <Start encoding val FStar.BV.bvmul'>

(declare-fun FStar.BV.bvmul_ (Term Term Term) Term)

(declare-fun FStar.BV.bvmul_@tok () Term)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.BV.int2bv_mul_ (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.BV.int2bv_mul_@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.BV.int2bv; Namespace FStar.BV
(assert (! 
;; def=FStar.BV.fsti(66,4-66,10); use=FStar.BV.fsti(66,4-66,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.pos)
(HasType @x1
(FStar.UInt.uint_t @x0)))
(HasType (FStar.BV.int2bv @x0
@x1)
(FStar.BV.bv_t @x0)))
 

:pattern ((FStar.BV.int2bv @x0
@x1))
:qid typing_FStar.BV.int2bv))

:named typing_FStar.BV.int2bv))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.BV.bv_t; Namespace FStar.BV
(assert (! 
;; def=FStar.BV.fsti(46,4-46,8); use=FStar.BV.fsti(46,4-46,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (FStar.BV.bv_t @x0)
Prims.eqtype))
 

:pattern ((FStar.BV.bv_t @x0))
:qid typing_FStar.BV.bv_t))

:named typing_FStar.BV.bv_t))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
; Starting query at IntBV.fst(7,102-7,113)
...
; Encoding query formula : forall (n: Prims.pos) (x: Prims.int).
;   (n > 0 ==> n >= 0) /\
;   (forall (any_result: Prims.pos).
;       n == any_result ==>
;       (forall (any_result: Prims.eqtype).
;           FStar.BV.bv_t n == any_result ==>
;           (forall (return_val: Prims.eqtype).
;               return_val == FStar.BV.bv_t n ==>
;               FStar.BV.bv_t n == return_val ==>
;               (n > 0 ==> n >= 0) /\
;               (forall (any_result: Prims.pos).
;                   n == any_result ==>
;                   (forall (any_result: Prims.bool).
;                       FStar.UInt.fits x n == any_result ==>
;                       (forall (any_result: Prims.logical).
;                           FStar.UInt.fits x n == any_result ==>
;                           (n > 0 ==> n >= 0) /\
;                           (forall (_: FStar.BV.bv_t n).
;                               (*  - Subtyping check failed
;   - Expected type Prims.nat got type Prims.pos
; *)
;                               n > 0 ==> n >= 0))))))) /\
;   (forall (p: Prims.pure_post (FStar.BV.bv_t n)).
;       FStar.UInt.fits x n /\
;       (forall (pure_result: FStar.BV.bv_t n). Prims.auto_squash (p pure_result)) ==>
;       Prims.auto_squash (FStar.UInt.size x n) /\
;       (forall (any_result: Prims.int).
;           x == any_result ==>
;           (forall (any_result: FStar.BV.bv_t n).
;               any_result == FStar.BV.int2bv x ==>
;               (forall (return_val: FStar.BV.bv_t n). return_val == any_result ==> p return_val))))


; Context: While encoding a query
; While typechecking the top-level declaration `let int_to_bv1`
...
(and (implies 
;; def=Prims.fst(683,18-683,23); use=IntBV.fst(7,102-7,113)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))


;; def=Prims.fst(680,18-680,24); use=IntBV.fst(7,52-7,53)
(or label_1

;; def=Prims.fst(680,18-680,24); use=IntBV.fst(7,102-7,113)
(>= (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
)
)

;; def=Prims.fst(451,66-451,102); use=IntBV.fst(7,102-7,113)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.pos)

;; def=FStar.BV.fsti(46,10-46,11); use=IntBV.fst(7,102-7,113)
(= @x0
@x2)
)
...
;; def=FStar.BV.fsti(46,20-46,26); use=IntBV.fst(7,102-7,113)
(= (FStar.BV.bv_t @x0)
@x3)
)

;; def=Prims.fst(356,2-356,58); use=IntBV.fst(7,102-7,113)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.eqtype)

;; def=Prims.fst(356,26-356,41); use=IntBV.fst(7,102-7,113)
(= @x4
(FStar.BV.bv_t @x0))


;; def=Prims.fst(439,13-439,14); use=IntBV.fst(7,102-7,113)
(= (FStar.BV.bv_t @x0)
@x4)
)

;; def=Prims.fst(459,77-459,89); use=IntBV.fst(7,102-7,113)
(and (implies 
;; def=Prims.fst(683,18-683,23); use=IntBV.fst(7,102-7,113)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
...
;; def=Prims.fst(680,18-680,24); use=IntBV.fst(7,72-7,73)
(or label_2
...
;; def=FStar.UInt.fsti(49,18-49,19); use=IntBV.fst(7,102-7,113)
(= @x0
@x5)
)
...
;; def=Prims.fst(180,10-180,11); use=IntBV.fst(7,102-7,113)
(= (FStar.UInt.fits @x1
@x0)
@x6)
)
...
;; def=Prims.fst(439,23-439,26); use=IntBV.fst(7,102-7,113)
(= (Prims.b2t (FStar.UInt.fits @x1
@x0))
@x7)
)

;; def=dummy(0,0-0,0); use=IntBV.fst(7,102-7,113)
(and (implies 
;; def=Prims.fst(683,18-683,23); use=IntBV.fst(7,102-7,113)
(> (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
...
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.pure_post (FStar.BV.bv_t @x0)))

;; def=IntBV.fst(7,65-7,73); use=IntBV.fst(7,102-7,113)
(BoxBool_proj_0 (FStar.UInt.fits @x1
@x0))


;; def=Prims.fst(441,36-441,97); use=IntBV.fst(7,102-7,113)
(forall ((@x3 Term))
 (! (implies (or label_5
(HasType @x3
(FStar.BV.bv_t @x0)))

;; def=Prims.fst(441,83-441,96); use=IntBV.fst(7,102-7,113)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IntBV.fst(7,102-7,113)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(459,77-459,89); use=IntBV.fst(7,102-7,113)
(and 
;; def=FStar.UInt.fsti(54,28-54,36); use=IntBV.fst(7,112-7,113)
(or label_6
...
;; def=FStar.BV.fsti(66,22-66,25); use=IntBV.fst(7,102-7,113)
(= @x1
@x3)
)
...
;; def=IntBV.fst(7,43-7,113); use=IntBV.fst(7,102-7,113)
(= @x4
(FStar.BV.int2bv @x0
@x1))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IntBV.int_to_bv1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, b2t_def, equation_FStar.UInt.fits, equation_FStar.UInt.size, equation_Prims.pos, int_inversion, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5
...
; encoding sigelt let int_to_bv1


; <Start encoding let int_to_bv1>

(declare-fun IntBV.int_to_bv1 (Term Term) Term)
(declare-fun Tm_refine_057574b436422c15a8ea3b300d0920ac (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> Prims.Pure (FStar.BV.bv_t n)
(declare-fun Tm_arrow_64f4e58deb9d5914c2147b6fb0fdf2d1 () Term)
(declare-fun IntBV.int_to_bv1@tok () Term)


; </end encoding let int_to_bv1>

(push) ;; push{2

; Starting query at IntBV.fst(9,0-9,25)

(declare-fun label_1 () Bool)

; Encoding query formula : FStar.UInt.fits 1 2
...
;;; Fact-ids: 
(assert (! (not 
;; def=IntBV.fst(7,65-7,73); use=IntBV.fst(7,4-7,14)
(or label_1

;; def=IntBV.fst(7,65-7,73); use=IntBV.fst(7,4-7,14)
(BoxBool_proj_0 (FStar.UInt.fits (BoxInt 1)
(BoxInt 2)))
)
)
:named @query))
...
(declare-fun IntBV.test1 (Dummy_sort) Term)

; </end encoding let test1>

(push) ;; push{2

; Starting query at IntBV.fst(10,0-10,25)

(declare-fun label_1 () Bool)

; Encoding query formula : FStar.UInt.fits 1 3
...
(declare-fun IntBV.test2 (Dummy_sort) Term)

; </end encoding let test2>

(push) ;; push{2

; Starting query at IntBV.fst(11,0-11,25)

(declare-fun label_1 () Bool)

; Encoding query formula : FStar.UInt.fits 1 4
