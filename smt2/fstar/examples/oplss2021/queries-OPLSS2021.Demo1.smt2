...
; Starting query at OPLSS2021.Demo1.fst(7,0-12,29)

(declare-fun OPLSS2021.Demo1.vector (Term Term) Term)
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,15-7,34); use=OPLSS2021.Demo1.fst(7,15-7,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_67c7b2626869cb316f118144000415b9))
:qid OPLSS2021.Demo1_pre_typing_Tm_arrow_67c7b2626869cb316f118144000415b9))

:named OPLSS2021.Demo1_pre_typing_Tm_arrow_67c7b2626869cb316f118144000415b9))
...
@x1)
@x2))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_67c7b2626869cb316f118144000415b9))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9))

:named OPLSS2021.Demo1_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9))
(declare-fun OPLSS2021.Demo1.vector@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,5-7,11); use=OPLSS2021.Demo1.fst(7,5-7,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT OPLSS2021.Demo1.vector@tok
@x0)
@x1)
(OPLSS2021.Demo1.vector @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT OPLSS2021.Demo1.vector@tok
@x0)
@x1))
:qid token_correspondence_OPLSS2021.Demo1.vector))

:named token_correspondence_OPLSS2021.Demo1.vector))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,5-7,11); use=OPLSS2021.Demo1.fst(7,5-7,11)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Demo1.vector@tok
Tm_arrow_67c7b2626869cb316f118144000415b9))
...
@x1)
@x2)
(OPLSS2021.Demo1.vector @x1
@x2))
 

:pattern ((OPLSS2021.Demo1.vector @x1
@x2))
:qid function_token_typing_OPLSS2021.Demo1.vector.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Demo1.vector@tok))
:qid function_token_typing_OPLSS2021.Demo1.vector))

:named function_token_typing_OPLSS2021.Demo1.vector))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,5-7,11); use=OPLSS2021.Demo1.fst(7,5-7,11)
...
(HasType @x1
Prims.nat))
(HasType (OPLSS2021.Demo1.vector @x0
@x1)
Tm_type))
 

:pattern ((OPLSS2021.Demo1.vector @x0
@x1))
:qid typing_OPLSS2021.Demo1.vector))

:named typing_OPLSS2021.Demo1.vector))
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (hd: a) (n: Prims.nat) (tl: OPLSS2021.Demo1.vector a n).
...
; While typechecking the top-level declaration `type OPLSS2021.Demo1.vector`
...
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Demo1.fst(12,22-12,29)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.vector, 1)
; STATUS: unsat
...
; encoding sigelt type OPLSS2021.Demo1.vector


; <Start encoding type OPLSS2021.Demo1.vector>
...
(declare-fun OPLSS2021.Demo1.vector@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun OPLSS2021.Demo1.VNil (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun OPLSS2021.Demo1.VNil_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: OPLSS2021.Demo1.VNil
(declare-fun OPLSS2021.Demo1.VNil@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun OPLSS2021.Demo1.VCons (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun OPLSS2021.Demo1.VCons_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun OPLSS2021.Demo1.VCons_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun OPLSS2021.Demo1.VCons_n (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun OPLSS2021.Demo1.VCons_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: OPLSS2021.Demo1.VCons
(declare-fun OPLSS2021.Demo1.VCons@tok () Term)
;;;;;;;;;;;;;;;;vector a 0
(declare-fun Tm_arrow_de01ff787af2625fb5719f16d436308a () Term)
;;;;;;;;;;;;;;;;hd: a -> tl: vector a n -> vector a (n + 1)
(declare-fun Tm_arrow_ee56d0c687a80b712783aef4238b9851 () Term)

; <start constructor OPLSS2021.Demo1.vector>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-OPLSS2021.Demo1.vector ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
;;no pats
:qid is-OPLSS2021.Demo1.vector))))

; </end constructor OPLSS2021.Demo1.vector>


; <start constructor OPLSS2021.Demo1.VNil>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-OPLSS2021.Demo1.VNil ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
131)
(= __@x0
(OPLSS2021.Demo1.VNil (OPLSS2021.Demo1.VNil_a __@x0)))))

; </end constructor OPLSS2021.Demo1.VNil>


; <start constructor OPLSS2021.Demo1.VCons>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-OPLSS2021.Demo1.VCons ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
137)
(= __@x0
(OPLSS2021.Demo1.VCons (OPLSS2021.Demo1.VCons_a __@x0)
(OPLSS2021.Demo1.VCons_hd __@x0)
(OPLSS2021.Demo1.VCons_n __@x0)
(OPLSS2021.Demo1.VCons_tl __@x0)))))

; </end constructor OPLSS2021.Demo1.VCons>


; </end encoding type OPLSS2021.Demo1.vector>
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,5-7,11); use=OPLSS2021.Demo1.fst(7,5-7,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT OPLSS2021.Demo1.vector@tok
...
:pattern ((OPLSS2021.Demo1.vector @x0
@x1))
:qid token_correspondence_OPLSS2021.Demo1.vector@tok))

:named token_correspondence_OPLSS2021.Demo1.vector@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(OPLSS2021.Demo1.VCons @x1
@x2
@x3
@x4)
(OPLSS2021.Demo1.vector @x5
@x6))
...
(OPLSS2021.Demo1.vector @x5
@x6)))
:qid subterm_ordering_OPLSS2021.Demo1.VCons))

:named subterm_ordering_OPLSS2021.Demo1.VCons))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(8,4-8,8); use=OPLSS2021.Demo1.fst(8,4-8,8)
(forall ((@x0 Term))
 (! (= (OPLSS2021.Demo1.VNil_a (OPLSS2021.Demo1.VNil @x0))
@x0)
 

:pattern ((OPLSS2021.Demo1.VNil @x0))
:qid projection_inverse_OPLSS2021.Demo1.VNil_a))

:named projection_inverse_OPLSS2021.Demo1.VNil_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (OPLSS2021.Demo1.VCons_tl (OPLSS2021.Demo1.VCons @x0
@x1
@x2
@x3))
@x3)
...
:pattern ((OPLSS2021.Demo1.VCons @x0
@x1
@x2
@x3))
:qid projection_inverse_OPLSS2021.Demo1.VCons_tl))

:named projection_inverse_OPLSS2021.Demo1.VCons_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (OPLSS2021.Demo1.VCons_n (OPLSS2021.Demo1.VCons @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_OPLSS2021.Demo1.VCons_n))

:named projection_inverse_OPLSS2021.Demo1.VCons_n))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (OPLSS2021.Demo1.VCons_hd (OPLSS2021.Demo1.VCons @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_OPLSS2021.Demo1.VCons_hd))

:named projection_inverse_OPLSS2021.Demo1.VCons_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (OPLSS2021.Demo1.VCons_a (OPLSS2021.Demo1.VCons @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_OPLSS2021.Demo1.VCons_a))

:named projection_inverse_OPLSS2021.Demo1.VCons_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! (is-Tm_arrow (PreType OPLSS2021.Demo1.vector@tok))
:named pre_kinding_OPLSS2021.Demo1.vector@tok))
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! (and (IsTotFun OPLSS2021.Demo1.vector@tok)

;; def=OPLSS2021.Demo1.fst(7,5-7,11); use=OPLSS2021.Demo1.fst(7,5-7,11)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT OPLSS2021.Demo1.vector@tok
@x0))
 

:pattern ((ApplyTT OPLSS2021.Demo1.vector@tok
@x0))
:qid kinding_OPLSS2021.Demo1.vector@tok))
...
:pattern ((OPLSS2021.Demo1.vector @x0
@x1))
:qid kinding_OPLSS2021.Demo1.vector@tok.1))
)
:named kinding_OPLSS2021.Demo1.vector@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,5-7,11); use=OPLSS2021.Demo1.fst(7,5-7,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
(OPLSS2021.Demo1.vector @x2
@x3))
(or (and (is-OPLSS2021.Demo1.VNil @x1)
(= @x2
(OPLSS2021.Demo1.VNil_a @x1))
(= @x3
(BoxInt 0)))
(and (is-OPLSS2021.Demo1.VCons @x1)
(= @x2
(OPLSS2021.Demo1.VCons_a @x1))
(= @x3
(Prims.op_Addition (OPLSS2021.Demo1.VCons_n @x1)
(BoxInt 1))))))
...
(OPLSS2021.Demo1.vector @x2
@x3)))
:qid fuel_guarded_inversion_OPLSS2021.Demo1.vector))

:named fuel_guarded_inversion_OPLSS2021.Demo1.vector))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! (= 125
(Term_constr_id OPLSS2021.Demo1.vector@tok))
:named fresh_token_OPLSS2021.Demo1.vector@tok))
...
(OPLSS2021.Demo1.vector @x1
@x2)))
:qid data_typing_intro_OPLSS2021.Demo1.VNil@tok))

:named data_typing_intro_OPLSS2021.Demo1.VNil@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
...
(OPLSS2021.Demo1.vector @x1
@x5)))
:qid data_typing_intro_OPLSS2021.Demo1.VCons@tok))

:named data_typing_intro_OPLSS2021.Demo1.VCons@tok))
...
(OPLSS2021.Demo1.vector @x2
@x3)))
:qid data_elim_OPLSS2021.Demo1.VNil))

:named data_elim_OPLSS2021.Demo1.VNil))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
...
(OPLSS2021.Demo1.vector @x5
@x6)))
:qid data_elim_OPLSS2021.Demo1.VCons))

:named data_elim_OPLSS2021.Demo1.VCons))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,5-7,11); use=OPLSS2021.Demo1.fst(7,5-7,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= 124
(Term_constr_id (OPLSS2021.Demo1.vector @x0
@x1)))
 

:pattern ((OPLSS2021.Demo1.vector @x0
@x1))
:qid constructor_distinct_OPLSS2021.Demo1.vector))

:named constructor_distinct_OPLSS2021.Demo1.vector))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(8,4-8,8); use=OPLSS2021.Demo1.fst(8,4-8,8)
(forall ((@x0 Term))
 (! (= 131
(Term_constr_id (OPLSS2021.Demo1.VNil @x0)))
 

:pattern ((OPLSS2021.Demo1.VNil @x0))
:qid constructor_distinct_OPLSS2021.Demo1.VNil))

:named constructor_distinct_OPLSS2021.Demo1.VNil))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 137
(Term_constr_id (OPLSS2021.Demo1.VCons @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_OPLSS2021.Demo1.VCons))

:named constructor_distinct_OPLSS2021.Demo1.VCons))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,5-7,11); use=OPLSS2021.Demo1.fst(7,5-7,11)
...
(OPLSS2021.Demo1.vector @x2
@x3)))
:qid OPLSS2021.Demo1_pretyping_ff5996c4034b6bf960205975a7880d13))

:named OPLSS2021.Demo1_pretyping_ff5996c4034b6bf960205975a7880d13))
(push) ;; push{4
...
;   Prims.hasEq a /\
;   (forall (a: Type) (_: Prims.nat). {:pattern Prims.hasEq (OPLSS2021.Demo1.vector a _)}
;       Prims.hasEq a ==> Prims.hasEq (OPLSS2021.Demo1.vector a _)) ==>
;   (forall (hd: a) (n: Prims.nat) (tl: OPLSS2021.Demo1.vector a n).
;       Prims.hasEq a /\ Prims.hasEq Prims.nat /\ Prims.hasEq (OPLSS2021.Demo1.vector a n))
...
;; def=OPLSS2021.Demo1.fst(7,0-12,29); use=OPLSS2021.Demo1.fst(7,0-12,29)
(Valid 
;; def=OPLSS2021.Demo1.fst(7,0-12,29); use=OPLSS2021.Demo1.fst(7,0-12,29)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=OPLSS2021.Demo1.fst(7,0-12,29); use=OPLSS2021.Demo1.fst(7,0-12,29)
(Prims.hasEq (OPLSS2021.Demo1.vector @x2
@x3))
)
)
 

:pattern ((Prims.hasEq (OPLSS2021.Demo1.vector @x2
@x3)))
:qid @query.1))
)
...
;; def=OPLSS2021.Demo1.fst(7,0-12,29); use=OPLSS2021.Demo1.fst(7,0-12,29)
(and 
;; def=OPLSS2021.Demo1.fst(7,0-12,29); use=OPLSS2021.Demo1.fst(9,15-9,16)
(or label_1
...
;; def=OPLSS2021.Demo1.fst(7,0-12,29); use=OPLSS2021.Demo1.fst(10,16-10,19)
(or label_2
...
;; def=OPLSS2021.Demo1.fst(7,0-12,29); use=OPLSS2021.Demo1.fst(11,16-11,26)
(or label_3

;; def=OPLSS2021.Demo1.fst(7,0-12,29); use=OPLSS2021.Demo1.fst(7,0-12,29)
(Valid 
;; def=OPLSS2021.Demo1.fst(7,0-12,29); use=OPLSS2021.Demo1.fst(7,0-12,29)
(Prims.hasEq (OPLSS2021.Demo1.vector @x0
@x3))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.vector, 2)
; STATUS: unsat
...
; encoding sigelt assume OPLSS2021.Demo1.vector__uu___haseq


; <Start encoding assume OPLSS2021.Demo1.vector__uu___haseq>


; </end encoding assume OPLSS2021.Demo1.vector__uu___haseq>


; encoding sigelt val OPLSS2021.Demo1.uu___is_VNil


; <Start encoding val OPLSS2021.Demo1.uu___is_VNil>

(declare-fun OPLSS2021.Demo1.uu___is_VNil (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: vector a _ -> Prims.bool
(declare-fun Tm_arrow_18d6e8100203e8b0495da2754417c0b0 () Term)
(declare-fun OPLSS2021.Demo1.uu___is_VNil@tok () Term)

; </end encoding val OPLSS2021.Demo1.uu___is_VNil>
...
; encoding sigelt val OPLSS2021.Demo1.uu___is_VCons


; <Start encoding val OPLSS2021.Demo1.uu___is_VCons>

(declare-fun OPLSS2021.Demo1.uu___is_VCons (Term Term Term) Term)

(declare-fun OPLSS2021.Demo1.uu___is_VCons@tok () Term)

; </end encoding val OPLSS2021.Demo1.uu___is_VCons>
...
; encoding sigelt val OPLSS2021.Demo1.__proj__VCons__item__hd


; <Start encoding val OPLSS2021.Demo1.__proj__VCons__item__hd>

(declare-fun Tm_refine_5b0227c873718a1e2db17d2a1798a462 (Term Term) Term)
(declare-fun OPLSS2021.Demo1.__proj__VCons__item__hd (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vector a _ {VCons? _} -> a
(declare-fun Tm_arrow_d7c304808280383a46bc22fa1b9e7af4 () Term)
(declare-fun OPLSS2021.Demo1.__proj__VCons__item__hd@tok () Term)

; </end encoding val OPLSS2021.Demo1.__proj__VCons__item__hd>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.Demo1.uu___is_VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
...
(OPLSS2021.Demo1.vector @x0
@x1)))
(HasType (OPLSS2021.Demo1.uu___is_VCons @x0
@x1
@x2)
Prims.bool))
 

:pattern ((OPLSS2021.Demo1.uu___is_VCons @x0
@x1
@x2))
:qid typing_OPLSS2021.Demo1.uu___is_VCons))

:named typing_OPLSS2021.Demo1.uu___is_VCons))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name OPLSS2021.Demo1.vector; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VNil; Namespace OPLSS2021.Demo1; Name OPLSS2021.Demo1.VCons; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,5-7,11); use=OPLSS2021.Demo1.fst(7,5-7,11)
...
:named refinement_kinding_Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name OPLSS2021.Demo1.__proj__VCons__item__hd; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_5b0227c873718a1e2db17d2a1798a462 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_5b0227c873718a1e2db17d2a1798a462 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_5b0227c873718a1e2db17d2a1798a462))

:named refinement_kinding_Tm_refine_5b0227c873718a1e2db17d2a1798a462))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! (HasType Tm_refine_542f9d4f129664613f2483a6c88bc7c2
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5b0227c873718a1e2db17d2a1798a462 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(OPLSS2021.Demo1.vector @x2
...
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VCons @x2
@x3
@x1))
))
...
(Tm_refine_5b0227c873718a1e2db17d2a1798a462 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_5b0227c873718a1e2db17d2a1798a462))

:named refinement_interpretation_Tm_refine_5b0227c873718a1e2db17d2a1798a462))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! 
;; def=Prims.fst(680,11-680,25); use=Prims.fst(680,11-680,25)
...
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5b0227c873718a1e2db17d2a1798a462
;;; Fact-ids: Name OPLSS2021.Demo1.__proj__VCons__item__hd; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5b0227c873718a1e2db17d2a1798a462 @x0
@x1)))
(Valid (Prims.hasEq (OPLSS2021.Demo1.vector @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5b0227c873718a1e2db17d2a1798a462 @x0
@x1))))
:qid haseqTm_refine_5b0227c873718a1e2db17d2a1798a462))

:named haseqTm_refine_5b0227c873718a1e2db17d2a1798a462))
;;;;;;;;;;;;;;;;haseq for Tm_refine_542f9d4f129664613f2483a6c88bc7c2
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_542f9d4f129664613f2483a6c88bc7c2))
(Valid (Prims.hasEq Prims.int)))
...
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (OPLSS2021.Demo1.uu___is_VCons @x0
@x1
@x2)
(BoxBool (is-OPLSS2021.Demo1.VCons @x2)))
 

:pattern ((OPLSS2021.Demo1.uu___is_VCons @x0
@x1
@x2))
:qid disc_equation_OPLSS2021.Demo1.VCons))

:named disc_equation_OPLSS2021.Demo1.VCons))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: OPLSS2021.Demo1.vector__uu___haseq
;;; Fact-ids: Name OPLSS2021.Demo1.vector__uu___haseq; Namespace OPLSS2021.Demo1
...
:pattern ((Prims.hasEq (OPLSS2021.Demo1.vector @x0
@x1)))
:qid assumption_OPLSS2021.Demo1.vector__uu___haseq))
:named assumption_OPLSS2021.Demo1.vector__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Starting query at OPLSS2021.Demo1.fst(9,12-9,14)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (_: Prims.nat) (projectee: _: OPLSS2021.Demo1.vector a _ {VCons? _}).
...
Prims.nat)
(HasType @x2
(Tm_refine_5b0227c873718a1e2db17d2a1798a462 @x0
@x1))

;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,12-9,14)
(not 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(9,12-9,14)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VCons @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.__proj__VCons__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_5b0227c873718a1e2db17d2a1798a462
...
; encoding sigelt val OPLSS2021.Demo1.__proj__VCons__item__n


; <Start encoding val OPLSS2021.Demo1.__proj__VCons__item__n>


(declare-fun OPLSS2021.Demo1.__proj__VCons__item__n (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vector a _ {VCons? _} -> Prims.nat
(declare-fun Tm_arrow_879c7c69aec7b135e4bd6b8d27fa0e37 () Term)
(declare-fun OPLSS2021.Demo1.__proj__VCons__item__n@tok () Term)

; </end encoding val OPLSS2021.Demo1.__proj__VCons__item__n>

(push) ;; push{2

; Starting query at OPLSS2021.Demo1.fst(10,14-10,15)
...
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(10,14-10,15)
(not 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(10,14-10,15)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VCons @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.__proj__VCons__item__n, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_5b0227c873718a1e2db17d2a1798a462
...
; encoding sigelt val OPLSS2021.Demo1.__proj__VCons__item__tl


; <Start encoding val OPLSS2021.Demo1.__proj__VCons__item__tl>


(declare-fun OPLSS2021.Demo1.__proj__VCons__item__tl (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vector a _ {VCons? _} -> vector a projectee.n
(declare-fun Tm_arrow_d6fe2c8224bf23752d1fc30c2b87eb60 () Term)
(declare-fun OPLSS2021.Demo1.__proj__VCons__item__tl@tok () Term)

; </end encoding val OPLSS2021.Demo1.__proj__VCons__item__tl>

(push) ;; push{2

; Starting query at OPLSS2021.Demo1.fst(11,13-11,15)
...
; *)
;   (~(VCons? projectee) ==> Prims.l_False) /\
;   (forall (b: a) (b: Prims.nat) (b: OPLSS2021.Demo1.vector a b).
;       projectee == OPLSS2021.Demo1.VCons b b ==> b + 1 == _ /\ VCons? (OPLSS2021.Demo1.VCons b b))
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(11,13-11,15)
(and (implies 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(11,13-11,15)
(not 
;; def=OPLSS2021.Demo1.fst(9,4-9,9); use=OPLSS2021.Demo1.fst(11,13-11,15)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VCons @x0
@x1
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Demo1.fst(11,13-11,15)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x0)
...
;; def=dummy(0,0-0,0); use=OPLSS2021.Demo1.fst(11,13-11,15)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.__proj__VCons__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_OPLSS2021.Demo1.VCons, refinement_interpretation_Tm_refine_5b0227c873718a1e2db17d2a1798a462
...
; Starting query at OPLSS2021.Demo1.fst(15,2-16,19)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(14,10-14,76); use=OPLSS2021.Demo1.fst(14,10-14,76)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee))

:named refinement_kinding_Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(14,10-14,76); use=OPLSS2021.Demo1.fst(14,10-14,76)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee @x2
@x3))
(and (HasTypeFuel @u0
@x1
(OPLSS2021.Demo1.vector @x2
@x3))
(let ((@lb4 @x1))
(implies (not (is-OPLSS2021.Demo1.VCons @lb4))

;; def=OPLSS2021.Demo1.fst(14,67-14,72); use=OPLSS2021.Demo1.fst(14,67-14,72)
false
))))
...
(Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee @x2
@x3)))
:qid refinement_interpretation_Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee))

:named refinement_interpretation_Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee))
;;;;;;;;;;;;;;;;haseq for Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(14,10-14,76); use=OPLSS2021.Demo1.fst(14,10-14,76)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee @x0
@x1)))
(Valid (Prims.hasEq (OPLSS2021.Demo1.vector @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee @x0
@x1))))
:qid haseqTm_refine_48a5e5a94fc23eb2b0f97db27e5248ee))

:named haseqTm_refine_48a5e5a94fc23eb2b0f97db27e5248ee))

; Encoding query formula : forall ('a: Type)
;   ('n: Prims.nat)
;   (v:
;   OPLSS2021.Demo1.vector 'a 'n
;     { (match v with
;         | OPLSS2021.Demo1.VCons _ _ -> Prims.l_True
;         | _ -> Prims.l_False)
;       <:
;       Type }).
;   (*  - Could not prove post-condition
...
Prims.nat)
(HasType @x2
(Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee @x0
@x1))

;; def=OPLSS2021.Demo1.fst(14,11-14,12); use=OPLSS2021.Demo1.fst(15,8-15,9)
(not 
;; def=OPLSS2021.Demo1.fst(14,11-14,12); use=OPLSS2021.Demo1.fst(15,8-15,9)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VCons @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.head', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_OPLSS2021.Demo1.VCons, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee
...
(declare-fun Tm_refine_48a5e5a94fc23eb2b0f97db27e5248ee (Term Term) Term)
(declare-fun OPLSS2021.Demo1.head_ (Term Term Term) Term)

;;;;;;;;;;;;;;;;v:       vector 'a 'n         { (match v with             | OPLSS2021.Demo1.VCons _ _ -> Prims.l_True             | _ -> Prims.l_False)           <:           Type }   -> 'a
(declare-fun Tm_arrow_cdc9beed518c9cc921e2d559382e1d20 () Term)
(declare-fun OPLSS2021.Demo1.head_@tok () Term)
...
; Starting query at OPLSS2021.Demo1.fst(20,2-21,19)

(declare-fun label_1 () Bool)


; Encoding query formula : forall ('a: Type) ('n: Prims.nat) (v: OPLSS2021.Demo1.vector 'a 'n {VCons? v}).
;   (*  - Could not prove post-condition
; *) ~(VCons? v) ==> Prims.l_False
...
;; def=OPLSS2021.Demo1.fst(19,10-19,11); use=OPLSS2021.Demo1.fst(20,8-20,9)
(not 
;; def=OPLSS2021.Demo1.fst(19,10-19,11); use=OPLSS2021.Demo1.fst(20,8-20,9)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VCons @x0
@x1
...
(declare-fun OPLSS2021.Demo1.head (Term Term Term) Term)


(declare-fun OPLSS2021.Demo1.head@tok () Term)
...
; Starting query at OPLSS2021.Demo1.fst(23,59-27,19)
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(23,23-23,38); use=OPLSS2021.Demo1.fst(23,23-23,38)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=OPLSS2021.Demo1.fst(23,31-23,36); use=OPLSS2021.Demo1.fst(23,31-23,36)
(> (BoxInt_proj_0 @x1)
...
;;;;;;;;;;;;;;;;v : OPLSS2021.Demo1.vector a m (OPLSS2021.Demo1.vector a m)
(declare-fun x_b94e6fda1875b4a7231deddad8e14717_4 () Term)
;;;;;;;;;;;;;;;;binder_x_b94e6fda1875b4a7231deddad8e14717_4
;;; Fact-ids: 
(assert (! (HasType x_b94e6fda1875b4a7231deddad8e14717_4
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3))
:named binder_x_b94e6fda1875b4a7231deddad8e14717_4))
...
(declare-fun Tm_refine_f29159daab86284b6cb256ea39ef5b69 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(23,16-27,19); use=OPLSS2021.Demo1.fst(23,16-27,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_f29159daab86284b6cb256ea39ef5b69 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_f29159daab86284b6cb256ea39ef5b69 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_f29159daab86284b6cb256ea39ef5b69))

:named refinement_kinding_Tm_refine_f29159daab86284b6cb256ea39ef5b69))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(23,16-27,19); use=OPLSS2021.Demo1.fst(23,16-27,19)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f29159daab86284b6cb256ea39ef5b69 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
(OPLSS2021.Demo1.vector @x4
@x3))
...
;; def=OPLSS2021.Demo1.fst(23,16-27,19); use=OPLSS2021.Demo1.fst(23,16-27,19)
(or 
;; def=OPLSS2021.Demo1.fst(23,59-27,19); use=OPLSS2021.Demo1.fst(23,59-27,19)
(Valid 
;; def=OPLSS2021.Demo1.fst(23,59-27,19); use=OPLSS2021.Demo1.fst(23,59-27,19)
...
;; def=OPLSS2021.Demo1.fst(23,16-27,19); use=OPLSS2021.Demo1.fst(23,16-27,19)
(and 
;; def=OPLSS2021.Demo1.fst(23,16-23,17); use=OPLSS2021.Demo1.fst(23,16-23,17)
(Valid 
;; def=OPLSS2021.Demo1.fst(23,16-23,17); use=OPLSS2021.Demo1.fst(23,16-23,17)
...
;; def=OPLSS2021.Demo1.fst(23,25-27,19); use=OPLSS2021.Demo1.fst(23,25-27,19)
(or 
;; def=OPLSS2021.Demo1.fst(23,59-27,19); use=OPLSS2021.Demo1.fst(23,59-27,19)
(Valid 
;; def=OPLSS2021.Demo1.fst(23,59-27,19); use=OPLSS2021.Demo1.fst(23,59-27,19)
...
;; def=OPLSS2021.Demo1.fst(23,25-27,19); use=OPLSS2021.Demo1.fst(23,25-27,19)
(and 
;; def=OPLSS2021.Demo1.fst(23,25-23,26); use=OPLSS2021.Demo1.fst(23,25-23,26)
(Valid 
;; def=OPLSS2021.Demo1.fst(23,25-23,26); use=OPLSS2021.Demo1.fst(23,25-23,26)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=OPLSS2021.Demo1.fst(23,59-27,19); use=OPLSS2021.Demo1.fst(23,59-27,19)
(Prims.precedes (OPLSS2021.Demo1.vector @x4
@x3)
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3)
@x1
x_b94e6fda1875b4a7231deddad8e14717_4)
)
)
)
)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_f29159daab86284b6cb256ea39ef5b69))

:named refinement_interpretation_Tm_refine_f29159daab86284b6cb256ea39ef5b69))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f29159daab86284b6cb256ea39ef5b69
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(23,16-27,19); use=OPLSS2021.Demo1.fst(23,16-27,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f29159daab86284b6cb256ea39ef5b69 @x0
@x1
@x2)))
(Valid (Prims.hasEq (OPLSS2021.Demo1.vector @x2
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f29159daab86284b6cb256ea39ef5b69 @x0
@x1
@x2))))
:qid haseqTm_refine_f29159daab86284b6cb256ea39ef5b69))

:named haseqTm_refine_f29159daab86284b6cb256ea39ef5b69))
(declare-fun OPLSS2021.Demo1.nth (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;n: Prims.nat -> v: vector a m {n << n \/ n === n /\ (m << m \/ m === m /\ v << v)} -> a
(declare-fun Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e
Tm_type)
:named kinding_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,15-27,19); use=OPLSS2021.Demo1.fst(23,13-27,19)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e))
:qid OPLSS2021.Demo1_pre_typing_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e))

:named OPLSS2021.Demo1_pre_typing_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,15-27,19); use=OPLSS2021.Demo1.fst(23,13-27,19)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e.2))
...
@x1)
@x2))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e.3))
...
@x2)
@x3))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e))

:named OPLSS2021.Demo1_interpretation_Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e))
(declare-fun OPLSS2021.Demo1.nth@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(23,8-23,11); use=OPLSS2021.Demo1.fst(23,8-23,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Demo1.nth@tok
@x0)
@x1)
@x2)
@x3)
(OPLSS2021.Demo1.nth @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Demo1.nth@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_OPLSS2021.Demo1.nth))

:named token_correspondence_OPLSS2021.Demo1.nth))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(23,8-23,11); use=OPLSS2021.Demo1.fst(23,8-23,11)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Demo1.nth@tok
Tm_arrow_a0d719b2cf8819193d1a5bcdfe25457e))
...
@x3)
@x4)
(OPLSS2021.Demo1.nth @x1
@x2
@x3
@x4))
 

:pattern ((OPLSS2021.Demo1.nth @x1
@x2
@x3
@x4))
:qid function_token_typing_OPLSS2021.Demo1.nth.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Demo1.nth@tok))
:qid function_token_typing_OPLSS2021.Demo1.nth))

:named function_token_typing_OPLSS2021.Demo1.nth))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(23,8-23,11); use=OPLSS2021.Demo1.fst(23,8-23,11)
...
(HasType @x3
(Tm_refine_f29159daab86284b6cb256ea39ef5b69 @x1
@x2
@x0)))
(HasType (OPLSS2021.Demo1.nth @x0
@x1
@x2
@x3)
@x0))
...
:pattern ((OPLSS2021.Demo1.nth @x0
@x1
@x2
@x3))
:qid typing_OPLSS2021.Demo1.nth))

:named typing_OPLSS2021.Demo1.nth))
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(23,59-27,19)
(and (implies 
;; def=OPLSS2021.Demo1.fst(24,6-24,16); use=OPLSS2021.Demo1.fst(24,6-24,16)
(not 
;; def=OPLSS2021.Demo1.fst(24,6-24,16); use=OPLSS2021.Demo1.fst(24,6-24,16)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VCons x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3
x_b94e6fda1875b4a7231deddad8e14717_4))
)
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Demo1.fst(23,59-27,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
...
;; def=OPLSS2021.Demo1.fst(24,6-24,16); use=OPLSS2021.Demo1.fst(24,6-24,16)
(= x_b94e6fda1875b4a7231deddad8e14717_4
(OPLSS2021.Demo1.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x0
@x1
@x2))
)
...
;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Demo1.fst(23,59-27,19)
(forall ((@x4 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Demo1.fst(23,59-27,19)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Demo1.fst(23,59-27,19)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Demo1.fst(23,59-27,19)
(not 
;; def=OPLSS2021.Demo1.fst(25,5-25,10); use=OPLSS2021.Demo1.fst(25,5-25,10)
...
;; def=OPLSS2021.Demo1.fst(25,5-27,19); use=OPLSS2021.Demo1.fst(25,5-27,19)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_2
(BoxInt 0))
@x4)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(23,59-27,19)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Demo1.fst(27,11-27,16)
(or label_2
...
;; def=Prims.fst(356,2-356,58); use=OPLSS2021.Demo1.fst(23,59-27,19)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=OPLSS2021.Demo1.fst(23,59-27,19)
(= @x5
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(23,59-27,19)
(and 
;; def=OPLSS2021.Demo1.fst(23,31-23,36); use=OPLSS2021.Demo1.fst(24,14-24,16)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Demo1.fst(23,59-27,19)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=OPLSS2021.Demo1.fst(23,25-24,16); use=OPLSS2021.Demo1.fst(23,59-27,19)
(= @x1
@x6)
)

;; def=OPLSS2021.Demo1.fst(23,16-27,19); use=OPLSS2021.Demo1.fst(27,17-27,19)
(or label_4

;; def=OPLSS2021.Demo1.fst(23,59-27,19); use=OPLSS2021.Demo1.fst(27,17-27,19)
(Valid 
;; def=OPLSS2021.Demo1.fst(23,59-27,19); use=OPLSS2021.Demo1.fst(27,17-27,19)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(23,16-27,19); use=OPLSS2021.Demo1.fst(27,17-27,19)
(and 
;; def=OPLSS2021.Demo1.fst(23,16-23,17); use=OPLSS2021.Demo1.fst(27,17-27,19)
(Valid 
;; def=OPLSS2021.Demo1.fst(23,16-23,17); use=OPLSS2021.Demo1.fst(27,17-27,19)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(23,25-27,19); use=OPLSS2021.Demo1.fst(27,17-27,19)
(or 
;; def=OPLSS2021.Demo1.fst(23,59-27,19); use=OPLSS2021.Demo1.fst(27,17-27,19)
(Valid 
;; def=OPLSS2021.Demo1.fst(23,59-27,19); use=OPLSS2021.Demo1.fst(27,17-27,19)
...
;; def=OPLSS2021.Demo1.fst(23,25-27,19); use=OPLSS2021.Demo1.fst(27,17-27,19)
(and 
;; def=OPLSS2021.Demo1.fst(23,25-23,26); use=OPLSS2021.Demo1.fst(27,17-27,19)
(Valid 
;; def=OPLSS2021.Demo1.fst(23,25-23,26); use=OPLSS2021.Demo1.fst(27,17-27,19)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=OPLSS2021.Demo1.fst(23,59-27,19); use=OPLSS2021.Demo1.fst(27,17-27,19)
(Prims.precedes (OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
@x1)
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3)
@x2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.nth, 1)
; STATUS: unsat
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun OPLSS2021.Demo1.nth.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun OPLSS2021.Demo1.nth.fuel_instrumented_token () Term)
(declare-fun OPLSS2021.Demo1.nth (Term Term Term Term) Term)
(declare-fun OPLSS2021.Demo1.nth@tok () Term)
(declare-fun Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d (Term) Term)
...
(declare-fun Tm_arrow_f3d32f7f28a49e2b7c103a596fd452c5 () Term)

; </end encoding let rec nth>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.Demo1.uu___is_VNil; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(8,4-8,8); use=OPLSS2021.Demo1.fst(8,4-8,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(OPLSS2021.Demo1.vector @x0
@x1)))
(HasType (OPLSS2021.Demo1.uu___is_VNil @x0
@x1
@x2)
Prims.bool))
 

:pattern ((OPLSS2021.Demo1.uu___is_VNil @x0
@x1
@x2))
:qid typing_OPLSS2021.Demo1.uu___is_VNil))

:named typing_OPLSS2021.Demo1.uu___is_VNil))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name OPLSS2021.Demo1.uu___is_VNil; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(8,4-8,8); use=OPLSS2021.Demo1.fst(8,4-8,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (OPLSS2021.Demo1.uu___is_VNil @x0
@x1
@x2)
(BoxBool (is-OPLSS2021.Demo1.VNil @x2)))
 

:pattern ((OPLSS2021.Demo1.uu___is_VNil @x0
@x1
@x2))
:qid disc_equation_OPLSS2021.Demo1.VNil))

:named disc_equation_OPLSS2021.Demo1.VNil))
(push) ;; push{2

; Starting query at OPLSS2021.Demo1.fst(31,4-33,44)
...
;;;;;;;;;;;;;;;;v1 : OPLSS2021.Demo1.vector a n1 (OPLSS2021.Demo1.vector a n1)
(declare-fun x_8aaebb2bf7be4b0d35e8b90e6323b818_4 () Term)
;;;;;;;;;;;;;;;;binder_x_8aaebb2bf7be4b0d35e8b90e6323b818_4
;;; Fact-ids: 
(assert (! (HasType x_8aaebb2bf7be4b0d35e8b90e6323b818_4
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2))
:named binder_x_8aaebb2bf7be4b0d35e8b90e6323b818_4))
;;;;;;;;;;;;;;;;v2 : OPLSS2021.Demo1.vector a n2 (OPLSS2021.Demo1.vector a n2)
(declare-fun x_f708f7815e3bebf326e0afeb55b8189f_5 () Term)
;;;;;;;;;;;;;;;;binder_x_f708f7815e3bebf326e0afeb55b8189f_5
;;; Fact-ids: 
(assert (! (HasType x_f708f7815e3bebf326e0afeb55b8189f_5
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_3))
:named binder_x_f708f7815e3bebf326e0afeb55b8189f_5))
(declare-fun Tm_refine_961642e9c44ee17647a9e8b6e75466a0 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,19-33,44); use=OPLSS2021.Demo1.fst(29,19-33,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_961642e9c44ee17647a9e8b6e75466a0 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_961642e9c44ee17647a9e8b6e75466a0 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_961642e9c44ee17647a9e8b6e75466a0))

:named refinement_kinding_Tm_refine_961642e9c44ee17647a9e8b6e75466a0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,19-33,44); use=OPLSS2021.Demo1.fst(29,19-33,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_961642e9c44ee17647a9e8b6e75466a0 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=OPLSS2021.Demo1.fst(29,19-33,44); use=OPLSS2021.Demo1.fst(29,19-33,44)
(or 
;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(31,4-33,44)
(Valid 
;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(31,4-33,44)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(29,19-33,44); use=OPLSS2021.Demo1.fst(29,19-33,44)
(and 
;; def=OPLSS2021.Demo1.fst(29,19-29,21); use=OPLSS2021.Demo1.fst(29,19-29,21)
(Valid 
;; def=OPLSS2021.Demo1.fst(29,19-29,21); use=OPLSS2021.Demo1.fst(29,19-29,21)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(29,23-33,44); use=OPLSS2021.Demo1.fst(29,23-33,44)
(or 
;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(31,4-33,44)
(Valid 
;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(31,4-33,44)
...
;; def=OPLSS2021.Demo1.fst(29,23-33,44); use=OPLSS2021.Demo1.fst(29,23-33,44)
(and 
;; def=OPLSS2021.Demo1.fst(29,23-29,25); use=OPLSS2021.Demo1.fst(29,23-29,25)
(Valid 
;; def=OPLSS2021.Demo1.fst(29,23-29,25); use=OPLSS2021.Demo1.fst(29,23-29,25)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(29,27-33,44); use=OPLSS2021.Demo1.fst(29,27-33,44)
(or 
;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(31,4-33,44)
(Valid 
;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(31,4-33,44)
...
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x5
x_8aaebb2bf7be4b0d35e8b90e6323b818_4)
)


;; def=OPLSS2021.Demo1.fst(29,27-33,44); use=OPLSS2021.Demo1.fst(29,27-33,44)
(and 
;; def=OPLSS2021.Demo1.fst(29,27-29,29); use=OPLSS2021.Demo1.fst(29,27-29,29)
(Valid 
;; def=OPLSS2021.Demo1.fst(29,27-29,29); use=OPLSS2021.Demo1.fst(29,27-29,29)
(Prims.op_Equals_Equals_Equals (OPLSS2021.Demo1.vector @x4
@x2)
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x5
...
x_bb4e1c9af0265270f8e7a5f250f730e2_3)
@x1
x_f708f7815e3bebf326e0afeb55b8189f_5)
)
)
)
)
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_961642e9c44ee17647a9e8b6e75466a0))

:named refinement_interpretation_Tm_refine_961642e9c44ee17647a9e8b6e75466a0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_961642e9c44ee17647a9e8b6e75466a0
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,19-33,44); use=OPLSS2021.Demo1.fst(29,19-33,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_961642e9c44ee17647a9e8b6e75466a0 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (OPLSS2021.Demo1.vector @x2
...
:pattern ((Valid (Prims.hasEq (Tm_refine_961642e9c44ee17647a9e8b6e75466a0 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_961642e9c44ee17647a9e8b6e75466a0))

:named haseqTm_refine_961642e9c44ee17647a9e8b6e75466a0))
(declare-fun OPLSS2021.Demo1.append (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;v1: vector a n1 ->     v2:       vector a n2         {n1 << n1 \/ n1 === n1 /\ (n2 << n2 \/ n2 === n2 /\ (v1 << v1 \/ v1 === v1 /\ v2 << v2))}   -> vector a (n1 + n2)
(declare-fun Tm_arrow_a2a29658d7253ba9962a3ea36ba53996 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a2a29658d7253ba9962a3ea36ba53996
Tm_type)
:named kinding_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,15-33,44); use=OPLSS2021.Demo1.fst(29,16-33,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a2a29658d7253ba9962a3ea36ba53996)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a2a29658d7253ba9962a3ea36ba53996))
:qid OPLSS2021.Demo1_pre_typing_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996))

:named OPLSS2021.Demo1_pre_typing_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,15-33,44); use=OPLSS2021.Demo1.fst(29,16-33,44)
(forall ((@x0 Term))
...
@x4)
@x5))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996.2))
...
@x1)
@x2))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996.3))
...
@x2)
@x3))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996.4))
...
@x3)
@x4))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996.5))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_a2a29658d7253ba9962a3ea36ba53996))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996))

:named OPLSS2021.Demo1_interpretation_Tm_arrow_a2a29658d7253ba9962a3ea36ba53996))
(declare-fun OPLSS2021.Demo1.append@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,8-29,14); use=OPLSS2021.Demo1.fst(29,8-29,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Demo1.append@tok
@x0)
@x1)
@x2)
@x3)
@x4)
(OPLSS2021.Demo1.append @x0
@x1
@x2
@x3
@x4))
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Demo1.append@tok
@x0)
@x1)
@x2)
@x3)
@x4))
:qid token_correspondence_OPLSS2021.Demo1.append))

:named token_correspondence_OPLSS2021.Demo1.append))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,8-29,14); use=OPLSS2021.Demo1.fst(29,8-29,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Demo1.append@tok
Tm_arrow_a2a29658d7253ba9962a3ea36ba53996))
...
:pattern ((OPLSS2021.Demo1.append @x1
@x2
@x3
@x4
@x5))
:qid function_token_typing_OPLSS2021.Demo1.append.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Demo1.append@tok))
:qid function_token_typing_OPLSS2021.Demo1.append))

:named function_token_typing_OPLSS2021.Demo1.append))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,8-29,14); use=OPLSS2021.Demo1.fst(29,8-29,14)
...
@x1))
(HasType @x4
(Tm_refine_961642e9c44ee17647a9e8b6e75466a0 @x1
@x2
@x0
@x3)))
(HasType (OPLSS2021.Demo1.append @x0
@x1
@x2
@x3
@x4)
...
:pattern ((OPLSS2021.Demo1.append @x0
@x1
@x2
@x3
@x4))
:qid typing_OPLSS2021.Demo1.append))

:named typing_OPLSS2021.Demo1.append))
...
; (forall (k: Prims.pure_post (OPLSS2021.Demo1.vector a (n1 + n2))).
;     (forall (x: OPLSS2021.Demo1.vector a (n1 + n2)). {:pattern Prims.guard_free (k x)}
;         Prims.auto_squash (k x)) ==>
;     (~(VNil? v1) /\ ~(VCons? v1) ==> Prims.l_False) /\
;     (v1 == OPLSS2021.Demo1.VNil ==> n2 == n1 + n2) /\
;     (~(VNil? v1) ==>
;       (forall (b: a) (b: Prims.nat) (b: OPLSS2021.Demo1.vector a b).
;           v1 == OPLSS2021.Demo1.VCons b b ==>
;           b + n2 >= 0 /\
;           (forall (return_val: Prims.nat).
;               return_val == b + n2 ==>
;               (b << n1 \/ b === n1 /\ (n2 << n2 \/ (b << v1 \/ b === v1 /\ v2 << v2))) /\
;               (forall (any_result: OPLSS2021.Demo1.vector a n2).
;                   v2 == any_result ==>
;                   (forall (any_result: OPLSS2021.Demo1.vector a (b + n2)).
;                       OPLSS2021.Demo1.append b v2 == any_result ==>
;                       (forall (any_result: OPLSS2021.Demo1.vector a (b + n2 + 1)).
;                           OPLSS2021.Demo1.VCons b (OPLSS2021.Demo1.append b v2) == any_result ==>
;                           b + n2 + 1 == n1 + n2)))))))
...
;;; Fact-ids: 
(assert (! (not (and 
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Demo1.fst(30,13-30,22)
(or label_1

;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Demo1.fst(31,4-33,44)
...
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
(Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_2
x_bb4e1c9af0265270f8e7a5f250f730e2_3))))

;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Demo1.fst(31,4-33,44)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Demo1.fst(31,4-33,44)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Demo1.fst(31,4-33,44)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(31,4-33,44)
(and (implies 
;; def=OPLSS2021.Demo1.fst(29,27-29,29); use=OPLSS2021.Demo1.fst(31,10-31,12)
(and 
;; def=OPLSS2021.Demo1.fst(29,27-29,29); use=OPLSS2021.Demo1.fst(31,10-31,12)
(not 
;; def=OPLSS2021.Demo1.fst(29,27-29,29); use=OPLSS2021.Demo1.fst(31,10-31,12)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2
x_8aaebb2bf7be4b0d35e8b90e6323b818_4))
)
...
label_2)
(implies 
;; def=OPLSS2021.Demo1.fst(29,27-32,10); use=OPLSS2021.Demo1.fst(31,10-32,10)
(= x_8aaebb2bf7be4b0d35e8b90e6323b818_4
(OPLSS2021.Demo1.VNil x_fe28d8bcde588226b4e538b35321de05_1))


;; def=OPLSS2021.Demo1.fst(29,23-30,22); use=OPLSS2021.Demo1.fst(32,14-32,16)
(or label_3
...
(implies 
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Demo1.fst(31,4-33,44)
(not 
;; def=OPLSS2021.Demo1.fst(29,27-29,29); use=OPLSS2021.Demo1.fst(31,10-31,12)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Demo1.fst(31,4-33,44)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=OPLSS2021.Demo1.fst(29,27-33,17); use=OPLSS2021.Demo1.fst(31,10-33,17)
(= x_8aaebb2bf7be4b0d35e8b90e6323b818_4
(OPLSS2021.Demo1.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(31,4-33,44)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Demo1.fst(33,31-33,37)
(or label_4
...
;; def=Prims.fst(356,2-356,58); use=OPLSS2021.Demo1.fst(31,4-33,44)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=OPLSS2021.Demo1.fst(31,4-33,44)
(= @x4
(Prims.op_Addition @x2
x_bb4e1c9af0265270f8e7a5f250f730e2_3))
)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(31,4-33,44)
(and 
;; def=OPLSS2021.Demo1.fst(29,19-33,44); use=OPLSS2021.Demo1.fst(33,41-33,43)
(or label_5

;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(33,41-33,43)
(Valid 
;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(33,41-33,43)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(29,19-33,44); use=OPLSS2021.Demo1.fst(33,41-33,43)
(and 
;; def=OPLSS2021.Demo1.fst(29,19-29,21); use=OPLSS2021.Demo1.fst(33,41-33,43)
(Valid 
;; def=OPLSS2021.Demo1.fst(29,19-29,21); use=OPLSS2021.Demo1.fst(33,41-33,43)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(29,23-33,44); use=OPLSS2021.Demo1.fst(33,41-33,43)
(or 
;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(33,41-33,43)
(Valid 
;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(33,41-33,43)
...
;; def=OPLSS2021.Demo1.fst(29,27-33,44); use=OPLSS2021.Demo1.fst(33,41-33,43)
(and 
;; def=OPLSS2021.Demo1.fst(29,27-29,29); use=OPLSS2021.Demo1.fst(33,41-33,43)
(Valid 
;; def=OPLSS2021.Demo1.fst(29,27-29,29); use=OPLSS2021.Demo1.fst(33,41-33,43)
(Prims.op_Equals_Equals_Equals (OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
@x2)
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x3
...
;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Demo1.fst(31,4-33,44)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_3))

;; def=OPLSS2021.Demo1.fst(29,44-29,46); use=OPLSS2021.Demo1.fst(31,4-33,44)
(= x_f708f7815e3bebf326e0afeb55b8189f_5
@x5)
)
...
;; def=OPLSS2021.Demo1.fst(11,13-33,44); use=OPLSS2021.Demo1.fst(31,4-33,44)
(= (OPLSS2021.Demo1.append x_fe28d8bcde588226b4e538b35321de05_1
@x2
x_bb4e1c9af0265270f8e7a5f250f730e2_3
@x3
x_f708f7815e3bebf326e0afeb55b8189f_5)
...
;; def=OPLSS2021.Demo1.fst(30,4-33,44); use=OPLSS2021.Demo1.fst(31,4-33,44)
(= (OPLSS2021.Demo1.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x1
(Prims.op_Addition @x2
x_bb4e1c9af0265270f8e7a5f250f730e2_3)
...
;; def=OPLSS2021.Demo1.fst(12,22-30,22); use=OPLSS2021.Demo1.fst(33,21-33,44)
(or label_6
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.append, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_8aaebb2bf7be4b0d35e8b90e6323b818_4, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_2, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_3, binder_x_f708f7815e3bebf326e0afeb55b8189f_5, data_elim_OPLSS2021.Demo1.VCons, data_elim_OPLSS2021.Demo1.VNil, disc_equation_OPLSS2021.Demo1.VCons, disc_equation_OPLSS2021.Demo1.VNil, equation_Prims.nat, fuel_guarded_inversion_OPLSS2021.Demo1.vector, int_inversion, int_typing, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_OPLSS2021.Demo1.VCons_n, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; Starting query at OPLSS2021.Demo1.fst(29,0-33,44)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_656ea773d5fdf4159c67fb69993f6f73 (Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,19-33,44); use=OPLSS2021.Demo1.fst(29,19-33,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (HasType (Tm_refine_656ea773d5fdf4159c67fb69993f6f73 @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_656ea773d5fdf4159c67fb69993f6f73 @x0
@x1
@x2
@x3
@x4
...
@x8)
Tm_type))
:qid refinement_kinding_Tm_refine_656ea773d5fdf4159c67fb69993f6f73))

:named refinement_kinding_Tm_refine_656ea773d5fdf4159c67fb69993f6f73))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,19-33,44); use=OPLSS2021.Demo1.fst(29,19-33,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_656ea773d5fdf4159c67fb69993f6f73 @x2
@x3
@x4
@x5
@x6
...
(Valid 
;; def=OPLSS2021.Demo1.fst(31,4-33,44); use=OPLSS2021.Demo1.fst(31,4-33,44)
(Prims.precedes (OPLSS2021.Demo1.vector @x6
@x2)
(OPLSS2021.Demo1.vector @x7
@x3)
@x8
@x9)
)
...
(Valid 
;; def=OPLSS2021.Demo1.fst(29,27-29,29); use=OPLSS2021.Demo1.fst(29,27-29,29)
(Prims.op_Equals_Equals_Equals (OPLSS2021.Demo1.vector @x6
@x2)
(OPLSS2021.Demo1.vector @x7
@x3)
@x8
...
@x9
@x10)))
:qid refinement_interpretation_Tm_refine_656ea773d5fdf4159c67fb69993f6f73))

:named refinement_interpretation_Tm_refine_656ea773d5fdf4159c67fb69993f6f73))
;;;;;;;;;;;;;;;;haseq for Tm_refine_656ea773d5fdf4159c67fb69993f6f73
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,19-33,44); use=OPLSS2021.Demo1.fst(29,19-33,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_656ea773d5fdf4159c67fb69993f6f73 @x0
@x1
@x2
@x3
@x4
...
@x7
@x8)))
(Valid (Prims.hasEq (OPLSS2021.Demo1.vector @x4
@x2))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_656ea773d5fdf4159c67fb69993f6f73 @x0
@x1
@x2
@x3
@x4
...
@x7
@x8))))
:qid haseqTm_refine_656ea773d5fdf4159c67fb69993f6f73))

:named haseqTm_refine_656ea773d5fdf4159c67fb69993f6f73))

; Encoding query formula : forall (a: Type) (n1: Prims.nat) (n2: Prims.nat) (v1: OPLSS2021.Demo1.vector a n1)
;   (v2: OPLSS2021.Demo1.vector a n2) (a: Type) (n1: Prims.nat) (n2: Prims.nat)
;   (v1: OPLSS2021.Demo1.vector a n1)
;   (v2:
;   OPLSS2021.Demo1.vector a n2
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=OPLSS2021.Demo1.fst(29,0-33,44)
...
@x6))
(HasType @x9
(Tm_refine_656ea773d5fdf4159c67fb69993f6f73 @x6
@x1
@x7
@x2
@x5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.append, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun OPLSS2021.Demo1.append.fuel_instrumented (Fuel Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun OPLSS2021.Demo1.append.fuel_instrumented_token () Term)
(declare-fun OPLSS2021.Demo1.append (Term Term Term Term Term) Term)
(declare-fun OPLSS2021.Demo1.append@tok () Term)
;;;;;;;;;;;;;;;;v1: vector a n1 -> v2: vector a n2 -> vector a (n1 + n2)
(declare-fun Tm_arrow_d41576a4fda4d51bf2826c1211199c82 () Term)

; </end encoding let rec append>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.Demo1.append; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,8-29,14); use=OPLSS2021.Demo1.fst(29,8-29,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
...
(OPLSS2021.Demo1.vector @x1
@x3)))
(HasType (OPLSS2021.Demo1.append.fuel_instrumented @u0
@x1
@x2
@x3
@x4
...
:pattern ((OPLSS2021.Demo1.append.fuel_instrumented @u0
@x1
@x2
@x3
@x4
@x5))
:qid token_correspondence_OPLSS2021.Demo1.append.fuel_instrumented))

:named token_correspondence_OPLSS2021.Demo1.append.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: OPLSS2021.Demo1.append
;;; Fact-ids: Name OPLSS2021.Demo1.append; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,8-29,14); use=OPLSS2021.Demo1.fst(29,8-29,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
...
(OPLSS2021.Demo1.vector @x1
@x3)))
(= (OPLSS2021.Demo1.append.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4
@x5)
(let ((@lb6 @x4))
(ite (is-OPLSS2021.Demo1.VNil @lb6)
@x5
(ite (is-OPLSS2021.Demo1.VCons @lb6)
(OPLSS2021.Demo1.VCons @x1
(OPLSS2021.Demo1.VCons_hd @lb6)
(Prims.op_Addition (OPLSS2021.Demo1.VCons_n @lb6)
@x3)
(OPLSS2021.Demo1.append.fuel_instrumented @u0
@x1
(OPLSS2021.Demo1.VCons_n @lb6)
@x3
(OPLSS2021.Demo1.VCons_tl @lb6)
@x5))
Tm_unit)))))
 :weight 0


:pattern ((OPLSS2021.Demo1.append.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4
@x5))
:qid equation_with_fuel_OPLSS2021.Demo1.append.fuel_instrumented))

:named equation_with_fuel_OPLSS2021.Demo1.append.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name OPLSS2021.Demo1.append; Namespace OPLSS2021.Demo1
(assert (! 
;; def=OPLSS2021.Demo1.fst(29,8-29,14); use=OPLSS2021.Demo1.fst(29,8-29,14)
...
@x4
@x5)
(OPLSS2021.Demo1.append.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid @fuel_irrelevance_OPLSS2021.Demo1.append.fuel_instrumented))

:named @fuel_irrelevance_OPLSS2021.Demo1.append.fuel_instrumented))
...
@x3
@x4)
(OPLSS2021.Demo1.append.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3
...
@x3
@x4))
:qid @fuel_correspondence_OPLSS2021.Demo1.append.fuel_instrumented))

:named @fuel_correspondence_OPLSS2021.Demo1.append.fuel_instrumented))
(push) ;; push{2

; Starting query at OPLSS2021.Demo1.fst(37,4-39,56)
...
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_2))
;;;;;;;;;;;;;;;;v : OPLSS2021.Demo1.vector a n (OPLSS2021.Demo1.vector a n)
(declare-fun x_8aaebb2bf7be4b0d35e8b90e6323b818_3 () Term)
;;;;;;;;;;;;;;;;binder_x_8aaebb2bf7be4b0d35e8b90e6323b818_3
;;; Fact-ids: 
(assert (! (HasType x_8aaebb2bf7be4b0d35e8b90e6323b818_3
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2))
:named binder_x_8aaebb2bf7be4b0d35e8b90e6323b818_3))
(declare-fun Tm_refine_a69225ca5544e5ec79dc66d275c58982 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(35,20-39,56); use=OPLSS2021.Demo1.fst(35,20-39,56)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_a69225ca5544e5ec79dc66d275c58982 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_a69225ca5544e5ec79dc66d275c58982 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_a69225ca5544e5ec79dc66d275c58982))

:named refinement_kinding_Tm_refine_a69225ca5544e5ec79dc66d275c58982))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(35,20-39,56); use=OPLSS2021.Demo1.fst(35,20-39,56)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a69225ca5544e5ec79dc66d275c58982 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(OPLSS2021.Demo1.vector @x3
@x2))
...
;; def=OPLSS2021.Demo1.fst(35,20-39,56); use=OPLSS2021.Demo1.fst(35,20-39,56)
(or 
;; def=OPLSS2021.Demo1.fst(37,4-39,56); use=OPLSS2021.Demo1.fst(37,4-39,56)
(Valid 
;; def=OPLSS2021.Demo1.fst(37,4-39,56); use=OPLSS2021.Demo1.fst(37,4-39,56)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(35,20-39,56); use=OPLSS2021.Demo1.fst(35,20-39,56)
(and 
;; def=OPLSS2021.Demo1.fst(35,20-35,21); use=OPLSS2021.Demo1.fst(35,20-35,21)
(Valid 
;; def=OPLSS2021.Demo1.fst(35,20-35,21); use=OPLSS2021.Demo1.fst(35,20-35,21)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=OPLSS2021.Demo1.fst(37,4-39,56); use=OPLSS2021.Demo1.fst(37,4-39,56)
(Prims.precedes (OPLSS2021.Demo1.vector @x3
@x2)
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x1
x_8aaebb2bf7be4b0d35e8b90e6323b818_3)
)
)
)
...
(Tm_refine_a69225ca5544e5ec79dc66d275c58982 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_a69225ca5544e5ec79dc66d275c58982))

:named refinement_interpretation_Tm_refine_a69225ca5544e5ec79dc66d275c58982))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a69225ca5544e5ec79dc66d275c58982
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(35,20-39,56); use=OPLSS2021.Demo1.fst(35,20-39,56)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a69225ca5544e5ec79dc66d275c58982 @x0
@x1)))
(Valid (Prims.hasEq (OPLSS2021.Demo1.vector @x1
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a69225ca5544e5ec79dc66d275c58982 @x0
@x1))))
:qid haseqTm_refine_a69225ca5544e5ec79dc66d275c58982))

:named haseqTm_refine_a69225ca5544e5ec79dc66d275c58982))
(declare-fun OPLSS2021.Demo1.reverse (Term Term Term) Term)

;;;;;;;;;;;;;;;;v: vector a n {n << n \/ n === n /\ v << v} -> vector a n
(declare-fun Tm_arrow_9b626a20366a58ff6960ecb8c8d11864 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9b626a20366a58ff6960ecb8c8d11864
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_9b626a20366a58ff6960ecb8c8d11864
Tm_type)
:named kinding_Tm_arrow_9b626a20366a58ff6960ecb8c8d11864))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,15-39,56); use=OPLSS2021.Demo1.fst(35,17-39,56)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9b626a20366a58ff6960ecb8c8d11864)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_9b626a20366a58ff6960ecb8c8d11864))
:qid OPLSS2021.Demo1_pre_typing_Tm_arrow_9b626a20366a58ff6960ecb8c8d11864))

:named OPLSS2021.Demo1_pre_typing_Tm_arrow_9b626a20366a58ff6960ecb8c8d11864))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9b626a20366a58ff6960ecb8c8d11864
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,15-39,56); use=OPLSS2021.Demo1.fst(35,17-39,56)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_9b626a20366a58ff6960ecb8c8d11864.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_9b626a20366a58ff6960ecb8c8d11864.2))
...
@x1)
@x2))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_9b626a20366a58ff6960ecb8c8d11864.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_9b626a20366a58ff6960ecb8c8d11864))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_9b626a20366a58ff6960ecb8c8d11864))

:named OPLSS2021.Demo1_interpretation_Tm_arrow_9b626a20366a58ff6960ecb8c8d11864))
(declare-fun OPLSS2021.Demo1.reverse@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(35,8-35,15); use=OPLSS2021.Demo1.fst(35,8-35,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Demo1.reverse@tok
@x0)
@x1)
@x2)
(OPLSS2021.Demo1.reverse @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT OPLSS2021.Demo1.reverse@tok
@x0)
@x1)
@x2))
:qid token_correspondence_OPLSS2021.Demo1.reverse))

:named token_correspondence_OPLSS2021.Demo1.reverse))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(35,8-35,15); use=OPLSS2021.Demo1.fst(35,8-35,15)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Demo1.reverse@tok
Tm_arrow_9b626a20366a58ff6960ecb8c8d11864))
...
@x2)
@x3)
(OPLSS2021.Demo1.reverse @x1
@x2
@x3))
 

:pattern ((OPLSS2021.Demo1.reverse @x1
@x2
@x3))
:qid function_token_typing_OPLSS2021.Demo1.reverse.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Demo1.reverse@tok))
:qid function_token_typing_OPLSS2021.Demo1.reverse))

:named function_token_typing_OPLSS2021.Demo1.reverse))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(35,8-35,15); use=OPLSS2021.Demo1.fst(35,8-35,15)
...
Prims.nat)
(HasType @x2
(Tm_refine_a69225ca5544e5ec79dc66d275c58982 @x1
@x0)))
(HasType (OPLSS2021.Demo1.reverse @x0
@x1
@x2)
(OPLSS2021.Demo1.vector @x0
@x1)))
...
:pattern ((OPLSS2021.Demo1.reverse @x0
@x1
@x2))
:qid typing_OPLSS2021.Demo1.reverse))

:named typing_OPLSS2021.Demo1.reverse))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (OPLSS2021.Demo1.vector a n)).
;   (forall (x: OPLSS2021.Demo1.vector a n). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)
;   ) ==>
;   (~(VNil? v) /\ ~(VCons? v) ==> Prims.l_False) /\
;   (v == OPLSS2021.Demo1.VNil ==> 0 == n) /\
;   (~(VNil? v) ==>
;     (forall (b: a) (b: Prims.nat) (b: OPLSS2021.Demo1.vector a b).
;         v == OPLSS2021.Demo1.VCons b b ==>
;         (b << n \/ b === n /\ b << v) /\
;         (forall (any_result: OPLSS2021.Demo1.vector a b).
;             b == any_result ==>
;             (forall (any_result: OPLSS2021.Demo1.vector a b).
;                 OPLSS2021.Demo1.reverse b == any_result ==>
;                 (forall (any_result: OPLSS2021.Demo1.vector a (b + 1)).
;                     OPLSS2021.Demo1.append (OPLSS2021.Demo1.reverse b)
;                       (OPLSS2021.Demo1.VCons b OPLSS2021.Demo1.VNil) ==
;                     any_result ==>
;                     b + 1 == n)))))
...
;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Demo1.fst(37,4-39,56)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Demo1.fst(37,4-39,56)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Demo1.fst(37,4-39,56)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(37,4-39,56)
(and (implies 
;; def=OPLSS2021.Demo1.fst(35,23-35,24); use=OPLSS2021.Demo1.fst(37,10-37,11)
(and 
;; def=OPLSS2021.Demo1.fst(35,23-35,24); use=OPLSS2021.Demo1.fst(37,10-37,11)
(not 
;; def=OPLSS2021.Demo1.fst(35,23-35,24); use=OPLSS2021.Demo1.fst(37,10-37,11)
...
label_1)
(implies 
;; def=OPLSS2021.Demo1.fst(35,23-38,10); use=OPLSS2021.Demo1.fst(37,10-38,10)
(= x_8aaebb2bf7be4b0d35e8b90e6323b818_3
(OPLSS2021.Demo1.VNil x_fe28d8bcde588226b4e538b35321de05_1))


;; def=OPLSS2021.Demo1.fst(8,20-35,21); use=OPLSS2021.Demo1.fst(38,14-38,18)
(or label_2
...
(implies 
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Demo1.fst(37,4-39,56)
(not 
;; def=OPLSS2021.Demo1.fst(35,23-35,24); use=OPLSS2021.Demo1.fst(37,10-37,11)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Demo1.fst(37,4-39,56)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=OPLSS2021.Demo1.fst(35,23-39,17); use=OPLSS2021.Demo1.fst(37,10-39,17)
(= x_8aaebb2bf7be4b0d35e8b90e6323b818_3
(OPLSS2021.Demo1.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(37,4-39,56)
(and 
;; def=OPLSS2021.Demo1.fst(35,20-39,56); use=OPLSS2021.Demo1.fst(39,37-39,39)
(or label_3

;; def=OPLSS2021.Demo1.fst(37,4-39,56); use=OPLSS2021.Demo1.fst(39,37-39,39)
(Valid 
;; def=OPLSS2021.Demo1.fst(37,4-39,56); use=OPLSS2021.Demo1.fst(39,37-39,39)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(35,20-39,56); use=OPLSS2021.Demo1.fst(39,37-39,39)
(and 
;; def=OPLSS2021.Demo1.fst(35,20-35,21); use=OPLSS2021.Demo1.fst(39,37-39,39)
(Valid 
;; def=OPLSS2021.Demo1.fst(35,20-35,21); use=OPLSS2021.Demo1.fst(39,37-39,39)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Demo1.fst(37,4-39,56)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_1
@x2))

;; def=OPLSS2021.Demo1.fst(35,23-39,17); use=OPLSS2021.Demo1.fst(37,4-39,56)
(= @x3
@x4)
)
...
;; def=OPLSS2021.Demo1.fst(29,27-39,40); use=OPLSS2021.Demo1.fst(37,4-39,56)
(= (OPLSS2021.Demo1.reverse x_fe28d8bcde588226b4e538b35321de05_1
@x2
@x3)
@x5)
)
...
;; def=OPLSS2021.Demo1.fst(36,4-39,56); use=OPLSS2021.Demo1.fst(37,4-39,56)
(= (OPLSS2021.Demo1.append x_fe28d8bcde588226b4e538b35321de05_1
@x2
(BoxInt 1)
(OPLSS2021.Demo1.reverse x_fe28d8bcde588226b4e538b35321de05_1
...
;; def=OPLSS2021.Demo1.fst(30,13-35,21); use=OPLSS2021.Demo1.fst(39,21-39,56)
(or label_4
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun OPLSS2021.Demo1.reverse.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun OPLSS2021.Demo1.reverse.fuel_instrumented_token () Term)
(declare-fun OPLSS2021.Demo1.reverse (Term Term Term) Term)
(declare-fun OPLSS2021.Demo1.reverse@tok () Term)
;;;;;;;;;;;;;;;;v: vector a n -> vector a n
(declare-fun Tm_arrow_d13c2638901405a180d90b5c55a06e42 () Term)

; </end encoding let rec reverse>

(push) ;; push{2

; Starting query at OPLSS2021.Demo1.fst(43,4-45,44)
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(41,13-41,17); use=OPLSS2021.Demo1.fst(41,21-41,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
:qid OPLSS2021.Demo1_pre_typing_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))

:named OPLSS2021.Demo1_pre_typing_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))

:named OPLSS2021.Demo1_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
...
;;;;;;;;;;;;;;;;v : OPLSS2021.Demo1.vector a n (OPLSS2021.Demo1.vector a n)
(declare-fun x_2ac079267751153fdc1a5e442c7f75e4_6 () Term)
;;;;;;;;;;;;;;;;binder_x_2ac079267751153fdc1a5e442c7f75e4_6
;;; Fact-ids: 
(assert (! (HasType x_2ac079267751153fdc1a5e442c7f75e4_6
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5))
:named binder_x_2ac079267751153fdc1a5e442c7f75e4_6))
;;;;;;;;;;;;;;;;_: a -> b
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x2
@x3)))
:qid OPLSS2021.Demo1_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named OPLSS2021.Demo1_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
...
:pattern ((ApplyTT @x0
@x3))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe.1))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x2)))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named OPLSS2021.Demo1_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
(declare-fun Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(41,30-45,44); use=OPLSS2021.Demo1.fst(41,30-45,44)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a))

:named refinement_kinding_Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(41,30-45,44); use=OPLSS2021.Demo1.fst(41,30-45,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a @x2
@x3))
(and (HasTypeFuel @u0
@x1
(OPLSS2021.Demo1.vector @x3
...
;; def=OPLSS2021.Demo1.fst(41,30-45,44); use=OPLSS2021.Demo1.fst(41,30-45,44)
(or 
;; def=OPLSS2021.Demo1.fst(43,4-45,44); use=OPLSS2021.Demo1.fst(43,4-45,44)
(Valid 
;; def=OPLSS2021.Demo1.fst(43,4-45,44); use=OPLSS2021.Demo1.fst(43,4-45,44)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(41,30-45,44); use=OPLSS2021.Demo1.fst(41,30-45,44)
(and 
;; def=OPLSS2021.Demo1.fst(41,30-41,31); use=OPLSS2021.Demo1.fst(41,30-41,31)
(Valid 
;; def=OPLSS2021.Demo1.fst(41,30-41,31); use=OPLSS2021.Demo1.fst(41,30-41,31)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x1
x_2ac079267751153fdc1a5e442c7f75e4_6)
)
)
)
...
(Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a @x2
@x3)))
:qid refinement_interpretation_Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a))

:named refinement_interpretation_Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(41,30-45,44); use=OPLSS2021.Demo1.fst(41,30-45,44)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a @x0
@x1)))
(Valid (Prims.hasEq (OPLSS2021.Demo1.vector @x1
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a @x0
@x1))))
:qid haseqTm_refine_93795f2bedaba7c51e0ba53ebe83f84a))

:named haseqTm_refine_93795f2bedaba7c51e0ba53ebe83f84a))
(declare-fun OPLSS2021.Demo1.map (Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;f: (_: a -> b) -> v: vector a n {n << n \/ n === n /\ v << v} -> vector b n
(declare-fun Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f
Tm_type)
:named kinding_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,23-45,44); use=OPLSS2021.Demo1.fst(41,21-45,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f))
:qid OPLSS2021.Demo1_pre_typing_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f))

:named OPLSS2021.Demo1_pre_typing_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,23-45,44); use=OPLSS2021.Demo1.fst(41,21-45,44)
(forall ((@x0 Term))
...
Prims.nat)
(HasType @x5
(Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a @x4
@x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x4)
@x5))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f.2))
...
@x1)
@x2))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f.3))
...
@x2)
@x3))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f.4))
...
@x3)
@x4))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f.5))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f))

:named OPLSS2021.Demo1_interpretation_Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f))
(declare-fun OPLSS2021.Demo1.map@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(41,8-41,11); use=OPLSS2021.Demo1.fst(41,8-41,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Demo1.map@tok
@x0)
@x1)
@x2)
@x3)
@x4)
(OPLSS2021.Demo1.map @x0
@x1
@x2
@x3
@x4))
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Demo1.map@tok
@x0)
@x1)
@x2)
@x3)
@x4))
:qid token_correspondence_OPLSS2021.Demo1.map))

:named token_correspondence_OPLSS2021.Demo1.map))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(41,8-41,11); use=OPLSS2021.Demo1.fst(41,8-41,11)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Demo1.map@tok
Tm_arrow_dedf77ff1ba4a43b690489524c4a4f9f))
...
:pattern ((OPLSS2021.Demo1.map @x1
@x2
@x3
@x4
@x5))
:qid function_token_typing_OPLSS2021.Demo1.map.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Demo1.map@tok))
:qid function_token_typing_OPLSS2021.Demo1.map))

:named function_token_typing_OPLSS2021.Demo1.map))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(41,8-41,11); use=OPLSS2021.Demo1.fst(41,8-41,11)
...
Prims.nat)
(HasType @x4
(Tm_refine_93795f2bedaba7c51e0ba53ebe83f84a @x3
@x0)))
(HasType (OPLSS2021.Demo1.map @x0
@x1
@x2
@x3
@x4)
...
:pattern ((OPLSS2021.Demo1.map @x0
@x1
@x2
@x3
@x4))
:qid typing_OPLSS2021.Demo1.map))

:named typing_OPLSS2021.Demo1.map))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (OPLSS2021.Demo1.vector b n)).
;   (forall (x: OPLSS2021.Demo1.vector b n). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)
;   ) ==>
;   (~(VNil? v) /\ ~(VCons? v) ==> Prims.l_False) /\
;   (v == OPLSS2021.Demo1.VNil ==> 0 == n) /\
;   (~(VNil? v) ==>
...
;         (forall (any_result: OPLSS2021.Demo1.vector a b).
;             b == any_result ==>
;             (forall (any_result: OPLSS2021.Demo1.vector b b).
;                 OPLSS2021.Demo1.map f b == any_result ==>
;                 (forall (any_result: OPLSS2021.Demo1.vector b (b + 1)).
;                     OPLSS2021.Demo1.VCons (f b) (OPLSS2021.Demo1.map f b) == any_result ==>
;                     b + 1 == n)))))
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_3
x_bb4e1c9af0265270f8e7a5f250f730e2_5)))

;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Demo1.fst(43,4-45,44)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Demo1.fst(43,4-45,44)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Demo1.fst(43,4-45,44)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(43,4-45,44)
(and (implies 
;; def=OPLSS2021.Demo1.fst(41,33-41,34); use=OPLSS2021.Demo1.fst(43,10-43,11)
(and 
;; def=OPLSS2021.Demo1.fst(41,33-41,34); use=OPLSS2021.Demo1.fst(43,10-43,11)
(not 
;; def=OPLSS2021.Demo1.fst(41,33-41,34); use=OPLSS2021.Demo1.fst(43,10-43,11)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
x_2ac079267751153fdc1a5e442c7f75e4_6))
)
...
(not 
;; def=OPLSS2021.Demo1.fst(41,33-41,34); use=OPLSS2021.Demo1.fst(43,10-43,11)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VCons x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
x_2ac079267751153fdc1a5e442c7f75e4_6))
)
)
...
label_1)
(implies 
;; def=OPLSS2021.Demo1.fst(41,33-44,10); use=OPLSS2021.Demo1.fst(43,10-44,10)
(= x_2ac079267751153fdc1a5e442c7f75e4_6
(OPLSS2021.Demo1.VNil x_fe28d8bcde588226b4e538b35321de05_2))


;; def=OPLSS2021.Demo1.fst(8,20-41,31); use=OPLSS2021.Demo1.fst(44,14-44,18)
(or label_2
...
(implies 
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Demo1.fst(43,4-45,44)
(not 
;; def=OPLSS2021.Demo1.fst(41,33-41,34); use=OPLSS2021.Demo1.fst(43,10-43,11)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Demo1.fst(43,4-45,44)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=OPLSS2021.Demo1.fst(41,33-45,17); use=OPLSS2021.Demo1.fst(43,10-45,17)
(= x_2ac079267751153fdc1a5e442c7f75e4_6
(OPLSS2021.Demo1.VCons x_fe28d8bcde588226b4e538b35321de05_2
@x1
@x2
@x3))
)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(43,4-45,44)
(and 
;; def=OPLSS2021.Demo1.fst(41,30-45,44); use=OPLSS2021.Demo1.fst(45,41-45,43)
(or label_3

;; def=OPLSS2021.Demo1.fst(43,4-45,44); use=OPLSS2021.Demo1.fst(45,41-45,43)
(Valid 
;; def=OPLSS2021.Demo1.fst(43,4-45,44); use=OPLSS2021.Demo1.fst(45,41-45,43)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(41,30-45,44); use=OPLSS2021.Demo1.fst(45,41-45,43)
(and 
;; def=OPLSS2021.Demo1.fst(41,30-41,31); use=OPLSS2021.Demo1.fst(45,41-45,43)
(Valid 
;; def=OPLSS2021.Demo1.fst(41,30-41,31); use=OPLSS2021.Demo1.fst(45,41-45,43)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=OPLSS2021.Demo1.fst(43,4-45,44); use=OPLSS2021.Demo1.fst(45,41-45,43)
(Prims.precedes (OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_2
@x2)
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x3
...
;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Demo1.fst(43,4-45,44)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_2
@x2))

;; def=OPLSS2021.Demo1.fst(41,33-45,17); use=OPLSS2021.Demo1.fst(43,4-45,44)
(= @x3
@x4)
)
...
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_3
@x2))

;; def=OPLSS2021.Demo1.fst(11,13-45,44); use=OPLSS2021.Demo1.fst(43,4-45,44)
(= (OPLSS2021.Demo1.map x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3
...
;; def=OPLSS2021.Demo1.fst(42,4-45,44); use=OPLSS2021.Demo1.fst(43,4-45,44)
(= (OPLSS2021.Demo1.VCons x_fe28d8bcde588226b4e538b35321de05_3
...
;; def=OPLSS2021.Demo1.fst(12,22-41,31); use=OPLSS2021.Demo1.fst(45,21-45,44)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.map, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_2ac079267751153fdc1a5e442c7f75e4_6, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_5, constructor_distinct_OPLSS2021.Demo1.VNil, data_elim_OPLSS2021.Demo1.VCons, disc_equation_OPLSS2021.Demo1.VCons, disc_equation_OPLSS2021.Demo1.VNil, equation_Prims.nat, fuel_guarded_inversion_OPLSS2021.Demo1.vector, int_inversion, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun OPLSS2021.Demo1.map.fuel_instrumented (Fuel Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun OPLSS2021.Demo1.map.fuel_instrumented_token () Term)
(declare-fun OPLSS2021.Demo1.map (Term Term Term Term Term) Term)
(declare-fun OPLSS2021.Demo1.map@tok () Term)
;;;;;;;;;;;;;;;;_: a -> b
(declare-fun Tm_arrow_6980332764c4493a7b0df5c02f7aefbe (Term Term) Term)
...
(declare-fun Tm_arrow_d32b6024952695709bf6b2dd94adf336 () Term)

; </end encoding let rec map>

(push) ;; push{2

; Starting query at OPLSS2021.Demo1.fst(49,4-51,47)
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(47,20-47,24); use=OPLSS2021.Demo1.fst(47,29-47,40)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
:qid OPLSS2021.Demo1_pre_typing_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))

:named OPLSS2021.Demo1_pre_typing_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
...
@x1)
@x2))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))

:named OPLSS2021.Demo1_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
...
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x2
@x3)))
:qid OPLSS2021.Demo1_pre_typing_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))

:named OPLSS2021.Demo1_pre_typing_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))
...
@x3)
@x4))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81.2))
))
...
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x1
@x2)))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))

:named OPLSS2021.Demo1_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))
(declare-fun Tm_refine_20b9354dce9bdb6747a0d80db7864f8e (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(47,43-51,47); use=OPLSS2021.Demo1.fst(47,43-51,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_20b9354dce9bdb6747a0d80db7864f8e @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_20b9354dce9bdb6747a0d80db7864f8e @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_20b9354dce9bdb6747a0d80db7864f8e))

:named refinement_kinding_Tm_refine_20b9354dce9bdb6747a0d80db7864f8e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(47,43-51,47); use=OPLSS2021.Demo1.fst(47,43-51,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_20b9354dce9bdb6747a0d80db7864f8e @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=OPLSS2021.Demo1.fst(47,43-51,47); use=OPLSS2021.Demo1.fst(47,43-51,47)
(or 
;; def=OPLSS2021.Demo1.fst(49,4-51,47); use=OPLSS2021.Demo1.fst(49,4-51,47)
(Valid 
;; def=OPLSS2021.Demo1.fst(49,4-51,47); use=OPLSS2021.Demo1.fst(49,4-51,47)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(47,43-51,47); use=OPLSS2021.Demo1.fst(47,43-51,47)
(and 
;; def=OPLSS2021.Demo1.fst(47,43-47,44); use=OPLSS2021.Demo1.fst(47,43-47,44)
(Valid 
;; def=OPLSS2021.Demo1.fst(47,43-47,44); use=OPLSS2021.Demo1.fst(47,43-47,44)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(47,46-51,47); use=OPLSS2021.Demo1.fst(47,46-51,47)
(or 
;; def=OPLSS2021.Demo1.fst(49,4-51,47); use=OPLSS2021.Demo1.fst(49,4-51,47)
(Valid 
;; def=OPLSS2021.Demo1.fst(49,4-51,47); use=OPLSS2021.Demo1.fst(49,4-51,47)
...
;; def=OPLSS2021.Demo1.fst(47,46-51,47); use=OPLSS2021.Demo1.fst(47,46-51,47)
(and 
;; def=OPLSS2021.Demo1.fst(47,46-47,47); use=OPLSS2021.Demo1.fst(47,46-47,47)
(Valid 
;; def=OPLSS2021.Demo1.fst(47,46-47,47); use=OPLSS2021.Demo1.fst(47,46-47,47)
(Prims.op_Equals_Equals_Equals (OPLSS2021.Demo1.vector @x3
@x2)
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x4
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_20b9354dce9bdb6747a0d80db7864f8e))

:named refinement_interpretation_Tm_refine_20b9354dce9bdb6747a0d80db7864f8e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_20b9354dce9bdb6747a0d80db7864f8e
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(47,43-51,47); use=OPLSS2021.Demo1.fst(47,43-51,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_20b9354dce9bdb6747a0d80db7864f8e @x0
@x1
@x2
@x3)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_20b9354dce9bdb6747a0d80db7864f8e @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_20b9354dce9bdb6747a0d80db7864f8e))

:named haseqTm_refine_20b9354dce9bdb6747a0d80db7864f8e))
(declare-fun OPLSS2021.Demo1.fold_right (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;f: (_: a -> _: b -> b) ->     v: vector a n ->     acc: b{n << n \/ n === n /\ (v << v \/ v === v /\ acc << acc)}   -> b
(declare-fun Tm_arrow_92a0598363ff8b0e6630ef3c367719c7 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_92a0598363ff8b0e6630ef3c367719c7
Tm_type)
:named kinding_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,23-51,47); use=OPLSS2021.Demo1.fst(47,29-51,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_92a0598363ff8b0e6630ef3c367719c7)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_92a0598363ff8b0e6630ef3c367719c7))
:qid OPLSS2021.Demo1_pre_typing_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7))

:named OPLSS2021.Demo1_pre_typing_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(7,23-51,47); use=OPLSS2021.Demo1.fst(47,29-51,47)
(forall ((@x0 Term))
...
@x4))
(HasType @x6
(Tm_refine_20b9354dce9bdb6747a0d80db7864f8e @x4
@x1
@x5
@x2)))
...
@x5)
@x6))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7.2))
...
@x1)
@x2))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7.3))
...
@x2)
@x3))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7.4))
...
@x3)
@x4))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7.5))
...
@x4)
@x5))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7.6))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_92a0598363ff8b0e6630ef3c367719c7))
:qid OPLSS2021.Demo1_interpretation_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7))

:named OPLSS2021.Demo1_interpretation_Tm_arrow_92a0598363ff8b0e6630ef3c367719c7))
(declare-fun OPLSS2021.Demo1.fold_right@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(47,8-47,18); use=OPLSS2021.Demo1.fst(47,8-47,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Demo1.fold_right@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Demo1.fold_right@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5))
:qid token_correspondence_OPLSS2021.Demo1.fold_right))

:named token_correspondence_OPLSS2021.Demo1.fold_right))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(47,8-47,18); use=OPLSS2021.Demo1.fst(47,8-47,18)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Demo1.fold_right@tok
Tm_arrow_92a0598363ff8b0e6630ef3c367719c7))
...
:pattern ((OPLSS2021.Demo1.fold_right @x1
@x2
@x3
@x4
@x5
@x6))
:qid function_token_typing_OPLSS2021.Demo1.fold_right.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Demo1.fold_right@tok))
:qid function_token_typing_OPLSS2021.Demo1.fold_right))

:named function_token_typing_OPLSS2021.Demo1.fold_right))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Demo1.fst(47,8-47,18); use=OPLSS2021.Demo1.fst(47,8-47,18)
...
@x3))
(HasType @x5
(Tm_refine_20b9354dce9bdb6747a0d80db7864f8e @x3
@x0
@x4
@x1)))
(HasType (OPLSS2021.Demo1.fold_right @x0
@x1
@x2
@x3
@x4
...
:pattern ((OPLSS2021.Demo1.fold_right @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_OPLSS2021.Demo1.fold_right))

:named typing_OPLSS2021.Demo1.fold_right))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(VNil? v) ==>
;     (forall (b: a) (b: Prims.nat) (b: OPLSS2021.Demo1.vector a b).
;         v == OPLSS2021.Demo1.VCons b b ==> b << n \/ b === n /\ (b << v \/ b === v /\ acc << acc)))
...
;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Demo1.fst(49,4-51,47)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Demo1.fst(49,4-51,47)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Demo1.fst(49,4-51,47)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Demo1.fst(49,4-51,47)
(and (implies 
;; def=OPLSS2021.Demo1.fst(47,46-47,47); use=OPLSS2021.Demo1.fst(49,10-49,11)
(and 
;; def=OPLSS2021.Demo1.fst(47,46-47,47); use=OPLSS2021.Demo1.fst(49,10-49,11)
(not 
;; def=OPLSS2021.Demo1.fst(47,46-47,47); use=OPLSS2021.Demo1.fst(49,10-49,11)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Demo1.fst(49,4-51,47)
(not 
;; def=OPLSS2021.Demo1.fst(47,46-47,47); use=OPLSS2021.Demo1.fst(49,10-49,11)
(BoxBool_proj_0 (OPLSS2021.Demo1.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Demo1.fst(49,4-51,47)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=OPLSS2021.Demo1.fst(47,46-51,17); use=OPLSS2021.Demo1.fst(49,10-51,17)
(= x_2ac079267751153fdc1a5e442c7f75e4_6
(OPLSS2021.Demo1.VCons x_fe28d8bcde588226b4e538b35321de05_2
@x1
@x2
...
;; def=OPLSS2021.Demo1.fst(47,43-51,47); use=OPLSS2021.Demo1.fst(51,43-51,46)
(or label_2

;; def=OPLSS2021.Demo1.fst(49,4-51,47); use=OPLSS2021.Demo1.fst(51,43-51,46)
(Valid 
;; def=OPLSS2021.Demo1.fst(49,4-51,47); use=OPLSS2021.Demo1.fst(51,43-51,46)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(47,43-51,47); use=OPLSS2021.Demo1.fst(51,43-51,46)
(and 
;; def=OPLSS2021.Demo1.fst(47,43-47,44); use=OPLSS2021.Demo1.fst(51,43-51,46)
(Valid 
;; def=OPLSS2021.Demo1.fst(47,43-47,44); use=OPLSS2021.Demo1.fst(51,43-51,46)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Demo1.fst(47,46-51,47); use=OPLSS2021.Demo1.fst(51,43-51,46)
(or 
;; def=OPLSS2021.Demo1.fst(49,4-51,47); use=OPLSS2021.Demo1.fst(51,43-51,46)
(Valid 
;; def=OPLSS2021.Demo1.fst(49,4-51,47); use=OPLSS2021.Demo1.fst(51,43-51,46)
...
;; def=OPLSS2021.Demo1.fst(47,46-51,47); use=OPLSS2021.Demo1.fst(51,43-51,46)
(and 
;; def=OPLSS2021.Demo1.fst(47,46-47,47); use=OPLSS2021.Demo1.fst(51,43-51,46)
(Valid 
;; def=OPLSS2021.Demo1.fst(47,46-47,47); use=OPLSS2021.Demo1.fst(51,43-51,46)
(Prims.op_Equals_Equals_Equals (OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_2
@x2)
(OPLSS2021.Demo1.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Demo1.fold_right, 1)
; STATUS: unsat
