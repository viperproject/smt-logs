...
; encoding sigelt layered_effect { NDS ... }
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.NDS.tape; Namespace OPLSS2021.NDS
(assert (! (HasType OPLSS2021.NDS.tape
Tm_type)
:named typing_OPLSS2021.NDS.tape))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c
;;; Fact-ids: Name OPLSS2021.NDS.tape; Namespace OPLSS2021.NDS
(assert (! (HasType Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c
Tm_type)
:named kinding_Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
(assert (! (HasType OPLSS2021.NDS.tape
Tm_type)
:named function_token_typing_OPLSS2021.NDS.tape))
...
;;;;;;;;;;;;;;;;Equation for OPLSS2021.NDS.tape
;;; Fact-ids: Name OPLSS2021.NDS.tape; Namespace OPLSS2021.NDS
(assert (! (= OPLSS2021.NDS.tape
Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c)
:named equation_OPLSS2021.NDS.tape))
...
;;; Fact-ids: Name OPLSS2021.NDS.tape; Namespace OPLSS2021.NDS
(assert (! 
;; def=OPLSS2021.NDS.fst(21,11-21,22); use=OPLSS2021.NDS.fst(21,11-21,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c)
...
@x1
Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c))
:qid OPLSS2021.NDS_pre_typing_Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c))

:named OPLSS2021.NDS_pre_typing_Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c
;;; Fact-ids: Name OPLSS2021.NDS.tape; Namespace OPLSS2021.NDS
(assert (! 
;; def=OPLSS2021.NDS.fst(21,11-21,22); use=OPLSS2021.NDS.fst(21,11-21,22)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.NDS_interpretation_Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c))
:qid OPLSS2021.NDS_interpretation_Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c))

:named OPLSS2021.NDS_interpretation_Tm_arrow_67d1eb0e2b2b0432bd883bf79e9b388c))
(push) ;; push{2

; Starting query at OPLSS2021.NDS.fst(59,4-59,45)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (s: Type) (_: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (t: OPLSS2021.NDS.tape) (n: Prims.nat) (s: s).
;     (*  - Could not prove post-condition
; *) n + 1 >= 0
...
;; def=dummy(0,0-0,0); use=OPLSS2021.NDS.fst(59,31-59,44)
...
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.NDS.fst(59,39-59,44)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.NDS.sample, 1)
; STATUS: unsat
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.NDS.nds; Namespace OPLSS2021.NDS
(assert (! 
;; def=OPLSS2021.NDS.fst(26,4-26,7); use=OPLSS2021.NDS.fst(26,4-26,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (OPLSS2021.NDS.nds @x0
@x1)
Tm_type))
 

:pattern ((OPLSS2021.NDS.nds @x0
@x1))
:qid typing_OPLSS2021.NDS.nds))

:named typing_OPLSS2021.NDS.nds))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2
;;; Fact-ids: Name OPLSS2021.NDS.nds; Namespace OPLSS2021.NDS
(assert (! 
;; def=OPLSS2021.NDS.fst(26,18-27,33); use=OPLSS2021.NDS.fst(27,2-27,33)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2))

:named kinding_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2))
...
;;;;;;;;;;;;;;;;Equation for OPLSS2021.NDS.nds
;;; Fact-ids: Name OPLSS2021.NDS.nds; Namespace OPLSS2021.NDS
(assert (! 
;; def=OPLSS2021.NDS.fst(26,4-26,7); use=OPLSS2021.NDS.fst(26,4-26,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (OPLSS2021.NDS.nds @x0
@x1)
(Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2 @x0
@x1))
 

:pattern ((OPLSS2021.NDS.nds @x0
@x1))
:qid equation_OPLSS2021.NDS.nds))

:named equation_OPLSS2021.NDS.nds))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2 @x2
@x3)))
:qid OPLSS2021.NDS_pre_typing_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2))

:named OPLSS2021.NDS_pre_typing_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2
;;; Fact-ids: Name OPLSS2021.NDS.nds; Namespace OPLSS2021.NDS
(assert (! 
;; def=OPLSS2021.NDS.fst(26,18-27,33); use=OPLSS2021.NDS.fst(27,2-27,33)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2 @x1
@x2))
(and 
;; def=OPLSS2021.NDS.fst(26,18-27,33); use=OPLSS2021.NDS.fst(27,2-27,33)
...
@x4)
@x5))
:qid OPLSS2021.NDS_interpretation_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid OPLSS2021.NDS_interpretation_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2.2))
...
@x3)
@x4))
:qid OPLSS2021.NDS_interpretation_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2.3))
))
...
(Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2 @x1
@x2)))
:qid OPLSS2021.NDS_interpretation_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2))

:named OPLSS2021.NDS_interpretation_Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name FStar.Pervasives.Native.tuple3; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple3; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(65,5-65,11); use=FStar.Pervasives.Native.fst(65,5-65,11)
...
; Starting query at OPLSS2021.NDS.fst(65,4-65,27)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=OPLSS2021.NDS.fst(61,55-61,56)
(forall ((@x0 Term))
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,54); use=OPLSS2021.NDS.fst(61,55-61,56)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_61bb9550f39772f18eaab129c43c3788 @x2)))
:qid OPLSS2021.NDS_pre_typing_Tm_arrow_61bb9550f39772f18eaab129c43c3788))

:named OPLSS2021.NDS_pre_typing_Tm_arrow_61bb9550f39772f18eaab129c43c3788))
...
:pattern ((ApplyTT @x0
@x2))
:qid OPLSS2021.NDS_interpretation_Tm_arrow_61bb9550f39772f18eaab129c43c3788.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_61bb9550f39772f18eaab129c43c3788 @x1)))
:qid OPLSS2021.NDS_interpretation_Tm_arrow_61bb9550f39772f18eaab129c43c3788))

:named OPLSS2021.NDS_interpretation_Tm_arrow_61bb9550f39772f18eaab129c43c3788))
(declare-fun Tm_abs_6ffc06f5d789cf42c73d4f163a977cc0 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_6ffc06f5d789cf42c73d4f163a977cc0
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(635,86-635,95); use=OPLSS2021.NDS.fst(61,55-61,56)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.NDS.fst(61,18-61,19); use=OPLSS2021.NDS.fst(61,55-61,56)
(forall ((@x0 Term) (@x1 Term))
...
;; def=Prims.fst(635,71-635,97); use=OPLSS2021.NDS.fst(61,55-61,56)
(not 
;; def=Prims.fst(635,72-635,97); use=OPLSS2021.NDS.fst(61,55-61,56)
(Valid 
;; def=Prims.fst(635,72-635,97); use=OPLSS2021.NDS.fst(61,55-61,56)
(ApplyTT @x2
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(630,69-630,73); use=OPLSS2021.NDS.fst(61,55-61,56)
(forall ((@x0 Term))
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.NDS.fst(61,18-61,46); use=OPLSS2021.NDS.fst(61,42-61,56)
(forall ((@x0 Term) (@x1 Term))
...
(Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd @x2
@x3)))
:qid OPLSS2021.NDS_pre_typing_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))

:named OPLSS2021.NDS_pre_typing_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))
...
(forall ((@x3 Term))
 (! (implies (and 
;; def=Prims.fst(630,56-630,74); use=OPLSS2021.NDS.fst(61,55-61,56)
(Valid 
;; def=Prims.fst(630,56-630,74); use=OPLSS2021.NDS.fst(61,55-61,56)
(ApplyTT @x2
...
:pattern ((ApplyTT @x0
@x3))
:qid OPLSS2021.NDS_interpretation_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd.1))
...
(Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd @x1
@x2)))
:qid OPLSS2021.NDS_interpretation_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))

:named OPLSS2021.NDS_interpretation_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))



(declare-fun Tm_abs_4838ca366a97900efe4a6fcd127c7888 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_4838ca366a97900efe4a6fcd127c7888
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.NDS.fst(65,17-65,27); use=OPLSS2021.NDS.fst(65,17-65,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_4838ca366a97900efe4a6fcd127c7888 @x0
@x1
@x2)
(Tm_arrow_cb2e75952d1c72346f7bfe63295ff9f2 @x1
@x2))
...
:pattern ((Tm_abs_4838ca366a97900efe4a6fcd127c7888 @x0
@x1
@x2))
:qid typing_Tm_abs_4838ca366a97900efe4a6fcd127c7888))

:named typing_Tm_abs_4838ca366a97900efe4a6fcd127c7888))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_4838ca366a97900efe4a6fcd127c7888
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.NDS.fst(65,17-65,27); use=OPLSS2021.NDS.fst(65,17-65,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_4838ca366a97900efe4a6fcd127c7888 @x3
@x4
@x5)
@x0)
@x1)
@x2)
(FStar.Pervasives.Native.Mktuple3 @x4
@x5
Prims.nat
(ApplyTT @x3
Tm_unit)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_4838ca366a97900efe4a6fcd127c7888 @x3
@x4
@x5)
@x0)
@x1)
@x2))
:qid interpretation_Tm_abs_4838ca366a97900efe4a6fcd127c7888))

:named interpretation_Tm_abs_4838ca366a97900efe4a6fcd127c7888))



; Encoding query formula : forall (a: Type) (wp: Prims.pure_wp a) (s: Type) (f: (_: Prims.unit -> Prims.PURE a)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (OPLSS2021.NDS.nds a s)).
;     wp (fun _ -> Prims.l_True) /\
;     (forall (pure_result: OPLSS2021.NDS.nds a s). Prims.auto_squash (p pure_result)) ==>
;     (forall (t: OPLSS2021.NDS.tape) (n: Prims.nat) (s: s).
;         (*  - Could not prove post-condition
; *) Prims.auto_squash (wp (fun _ -> Prims.l_True))) /\
;     (forall (any_result: OPLSS2021.NDS.nds a s).
;         any_result == (fun _ n s -> f (), s, n) ==>
;         (forall (return_val: OPLSS2021.NDS.nds a s). return_val == any_result ==> p return_val))


; Context: While encoding a query
; While typechecking the top-level declaration `let lift_pure_nds`
...
(Prims.pure_post (OPLSS2021.NDS.nds @x0
@x2)))

;; def=OPLSS2021.NDS.fst(63,19-63,37); use=OPLSS2021.NDS.fst(65,4-65,27)
(Valid 
;; def=OPLSS2021.NDS.fst(63,19-63,37); use=OPLSS2021.NDS.fst(65,4-65,27)
(ApplyTT @x1
...
;; def=Prims.fst(441,36-441,97); use=OPLSS2021.NDS.fst(65,4-65,27)
(forall ((@x5 Term))
 (! (implies (or label_1
(HasType @x5
(OPLSS2021.NDS.nds @x0
...
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.NDS.fst(65,4-65,27)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.NDS.fst(65,4-65,27)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.NDS.fst(65,4-65,27)
(and 
;; def=dummy(0,0-0,0); use=OPLSS2021.NDS.fst(65,4-65,27)
...
;; def=Prims.fst(369,7-369,58); use=OPLSS2021.NDS.fst(65,17-65,27)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=OPLSS2021.NDS.fst(65,4-65,27)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(OPLSS2021.NDS.nds @x0
@x2))

;; def=OPLSS2021.NDS.fst(62,9-65,27); use=OPLSS2021.NDS.fst(65,4-65,27)
(= @x5
(Tm_abs_4838ca366a97900efe4a6fcd127c7888 @x3
@x0
@x2))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.NDS.lift_pure_nds, 1)
; STATUS: unsat
...
; encoding sigelt let lift_pure_nds
...
; Starting query at OPLSS2021.NDS.fst(67,0-67,38)
...
;   (wp: Prims.pure_wp a)
;   (s: Type0)
;   (p: Prims.pure_post (OPLSS2021.NDS.nds a s))
;   (q: Prims.pure_post (OPLSS2021.NDS.nds a s)).
;   (forall (x: OPLSS2021.NDS.nds a s). p x ==> q x) ==>
;   wp (fun _ -> Prims.l_True) /\
;   (forall (pure_result: OPLSS2021.NDS.nds a s). Prims.auto_squash (p pure_result)) ==>
;   wp (fun _ -> Prims.l_True) /\
;   (forall (pure_result: OPLSS2021.NDS.nds a s). Prims.auto_squash (q pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `sub_effect PURE ~> NDS`
...
;; def=OPLSS2021.NDS.fst(63,19-63,37); use=OPLSS2021.NDS.fst(67,25-67,38)
(Valid 
;; def=OPLSS2021.NDS.fst(63,19-63,37); use=OPLSS2021.NDS.fst(67,25-67,38)
(ApplyTT @x1
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x0))
...
;; def=Prims.fst(441,36-441,97); use=OPLSS2021.NDS.fst(67,25-67,38)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(OPLSS2021.NDS.nds @x0
@x2))

;; def=Prims.fst(441,83-441,96); use=OPLSS2021.NDS.fst(67,25-67,38)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.NDS.fst(67,25-67,38)
(ApplyTT @x3
@x5)
...
;; def=Prims.fst(441,29-441,97); use=OPLSS2021.NDS.fst(67,25-67,38)
(and 
;; def=OPLSS2021.NDS.fst(63,19-63,37); use=OPLSS2021.NDS.fst(67,25-67,38)
(or label_1
