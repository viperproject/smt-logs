...
; Internals for OPLSS2021.Vector
...
; Starting query at OPLSS2021.Vector.fst(7,0-12,29)

(declare-fun OPLSS2021.Vector.vector (Term Term) Term)
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,15-7,34); use=OPLSS2021.Vector.fst(7,15-7,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_67c7b2626869cb316f118144000415b9))
:qid OPLSS2021.Vector_pre_typing_Tm_arrow_67c7b2626869cb316f118144000415b9))

:named OPLSS2021.Vector_pre_typing_Tm_arrow_67c7b2626869cb316f118144000415b9))
...
@x1)
@x2))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_67c7b2626869cb316f118144000415b9))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9))

:named OPLSS2021.Vector_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9))
(declare-fun OPLSS2021.Vector.vector@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,5-7,11); use=OPLSS2021.Vector.fst(7,5-7,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT OPLSS2021.Vector.vector@tok
@x0)
@x1)
(OPLSS2021.Vector.vector @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT OPLSS2021.Vector.vector@tok
@x0)
@x1))
:qid token_correspondence_OPLSS2021.Vector.vector))

:named token_correspondence_OPLSS2021.Vector.vector))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,5-7,11); use=OPLSS2021.Vector.fst(7,5-7,11)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Vector.vector@tok
Tm_arrow_67c7b2626869cb316f118144000415b9))
...
@x1)
@x2)
(OPLSS2021.Vector.vector @x1
@x2))
 

:pattern ((OPLSS2021.Vector.vector @x1
@x2))
:qid function_token_typing_OPLSS2021.Vector.vector.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Vector.vector@tok))
:qid function_token_typing_OPLSS2021.Vector.vector))

:named function_token_typing_OPLSS2021.Vector.vector))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,5-7,11); use=OPLSS2021.Vector.fst(7,5-7,11)
...
(HasType @x1
Prims.nat))
(HasType (OPLSS2021.Vector.vector @x0
@x1)
Tm_type))
 

:pattern ((OPLSS2021.Vector.vector @x0
@x1))
:qid typing_OPLSS2021.Vector.vector))

:named typing_OPLSS2021.Vector.vector))
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (hd: a) (n: Prims.nat) (tl: OPLSS2021.Vector.vector a n).
...
; While typechecking the top-level declaration `type OPLSS2021.Vector.vector`
...
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Vector.fst(12,22-12,29)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.vector, 1)
; STATUS: unsat
...
; encoding sigelt type OPLSS2021.Vector.vector


; <Start encoding type OPLSS2021.Vector.vector>
...
(declare-fun OPLSS2021.Vector.vector@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun OPLSS2021.Vector.VNil (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun OPLSS2021.Vector.VNil_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: OPLSS2021.Vector.VNil
(declare-fun OPLSS2021.Vector.VNil@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun OPLSS2021.Vector.VCons (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun OPLSS2021.Vector.VCons_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun OPLSS2021.Vector.VCons_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun OPLSS2021.Vector.VCons_n (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun OPLSS2021.Vector.VCons_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: OPLSS2021.Vector.VCons
(declare-fun OPLSS2021.Vector.VCons@tok () Term)
;;;;;;;;;;;;;;;;vector a 0
(declare-fun Tm_arrow_c347d5a1cc5c184b6641caaaaa5802df () Term)
;;;;;;;;;;;;;;;;hd: a -> tl: vector a n -> vector a (n + 1)
(declare-fun Tm_arrow_4ba1911a0a38d03d3170d1c09a300b6d () Term)

; <start constructor OPLSS2021.Vector.vector>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-OPLSS2021.Vector.vector ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
;;no pats
:qid is-OPLSS2021.Vector.vector))))

; </end constructor OPLSS2021.Vector.vector>


; <start constructor OPLSS2021.Vector.VNil>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-OPLSS2021.Vector.VNil ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
131)
(= __@x0
(OPLSS2021.Vector.VNil (OPLSS2021.Vector.VNil_a __@x0)))))

; </end constructor OPLSS2021.Vector.VNil>


; <start constructor OPLSS2021.Vector.VCons>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-OPLSS2021.Vector.VCons ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
137)
(= __@x0
(OPLSS2021.Vector.VCons (OPLSS2021.Vector.VCons_a __@x0)
(OPLSS2021.Vector.VCons_hd __@x0)
(OPLSS2021.Vector.VCons_n __@x0)
(OPLSS2021.Vector.VCons_tl __@x0)))))

; </end constructor OPLSS2021.Vector.VCons>


; </end encoding type OPLSS2021.Vector.vector>
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(7,5-7,11); use=OPLSS2021.Vector.fst(7,5-7,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT OPLSS2021.Vector.vector@tok
...
:pattern ((OPLSS2021.Vector.vector @x0
@x1))
:qid token_correspondence_OPLSS2021.Vector.vector@tok))

:named token_correspondence_OPLSS2021.Vector.vector@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(OPLSS2021.Vector.VCons @x1
@x2
@x3
@x4)
(OPLSS2021.Vector.vector @x5
@x6))
...
(OPLSS2021.Vector.vector @x5
@x6)))
:qid subterm_ordering_OPLSS2021.Vector.VCons))

:named subterm_ordering_OPLSS2021.Vector.VCons))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(8,4-8,8); use=OPLSS2021.Vector.fst(8,4-8,8)
(forall ((@x0 Term))
 (! (= (OPLSS2021.Vector.VNil_a (OPLSS2021.Vector.VNil @x0))
@x0)
 

:pattern ((OPLSS2021.Vector.VNil @x0))
:qid projection_inverse_OPLSS2021.Vector.VNil_a))

:named projection_inverse_OPLSS2021.Vector.VNil_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (OPLSS2021.Vector.VCons_tl (OPLSS2021.Vector.VCons @x0
@x1
@x2
@x3))
@x3)
...
:pattern ((OPLSS2021.Vector.VCons @x0
@x1
@x2
@x3))
:qid projection_inverse_OPLSS2021.Vector.VCons_tl))

:named projection_inverse_OPLSS2021.Vector.VCons_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (OPLSS2021.Vector.VCons_n (OPLSS2021.Vector.VCons @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_OPLSS2021.Vector.VCons_n))

:named projection_inverse_OPLSS2021.Vector.VCons_n))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (OPLSS2021.Vector.VCons_hd (OPLSS2021.Vector.VCons @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_OPLSS2021.Vector.VCons_hd))

:named projection_inverse_OPLSS2021.Vector.VCons_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (OPLSS2021.Vector.VCons_a (OPLSS2021.Vector.VCons @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_OPLSS2021.Vector.VCons_a))

:named projection_inverse_OPLSS2021.Vector.VCons_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! (is-Tm_arrow (PreType OPLSS2021.Vector.vector@tok))
:named pre_kinding_OPLSS2021.Vector.vector@tok))
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! (and (IsTotFun OPLSS2021.Vector.vector@tok)

;; def=OPLSS2021.Vector.fst(7,5-7,11); use=OPLSS2021.Vector.fst(7,5-7,11)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT OPLSS2021.Vector.vector@tok
@x0))
 

:pattern ((ApplyTT OPLSS2021.Vector.vector@tok
@x0))
:qid kinding_OPLSS2021.Vector.vector@tok))
...
:pattern ((OPLSS2021.Vector.vector @x0
@x1))
:qid kinding_OPLSS2021.Vector.vector@tok.1))
)
:named kinding_OPLSS2021.Vector.vector@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(7,5-7,11); use=OPLSS2021.Vector.fst(7,5-7,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
(OPLSS2021.Vector.vector @x2
@x3))
(or (and (is-OPLSS2021.Vector.VNil @x1)
(= @x2
(OPLSS2021.Vector.VNil_a @x1))
(= @x3
(BoxInt 0)))
(and (is-OPLSS2021.Vector.VCons @x1)
(= @x2
(OPLSS2021.Vector.VCons_a @x1))
(= @x3
(Prims.op_Addition (OPLSS2021.Vector.VCons_n @x1)
(BoxInt 1))))))
...
(OPLSS2021.Vector.vector @x2
@x3)))
:qid fuel_guarded_inversion_OPLSS2021.Vector.vector))

:named fuel_guarded_inversion_OPLSS2021.Vector.vector))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! (= 125
(Term_constr_id OPLSS2021.Vector.vector@tok))
:named fresh_token_OPLSS2021.Vector.vector@tok))
...
(OPLSS2021.Vector.vector @x1
@x2)))
:qid data_typing_intro_OPLSS2021.Vector.VNil@tok))

:named data_typing_intro_OPLSS2021.Vector.VNil@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
...
(OPLSS2021.Vector.vector @x1
@x5)))
:qid data_typing_intro_OPLSS2021.Vector.VCons@tok))

:named data_typing_intro_OPLSS2021.Vector.VCons@tok))
...
(OPLSS2021.Vector.vector @x2
@x3)))
:qid data_elim_OPLSS2021.Vector.VNil))

:named data_elim_OPLSS2021.Vector.VNil))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
...
(OPLSS2021.Vector.vector @x5
@x6)))
:qid data_elim_OPLSS2021.Vector.VCons))

:named data_elim_OPLSS2021.Vector.VCons))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(7,5-7,11); use=OPLSS2021.Vector.fst(7,5-7,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= 124
(Term_constr_id (OPLSS2021.Vector.vector @x0
@x1)))
 

:pattern ((OPLSS2021.Vector.vector @x0
@x1))
:qid constructor_distinct_OPLSS2021.Vector.vector))

:named constructor_distinct_OPLSS2021.Vector.vector))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(8,4-8,8); use=OPLSS2021.Vector.fst(8,4-8,8)
(forall ((@x0 Term))
 (! (= 131
(Term_constr_id (OPLSS2021.Vector.VNil @x0)))
 

:pattern ((OPLSS2021.Vector.VNil @x0))
:qid constructor_distinct_OPLSS2021.Vector.VNil))

:named constructor_distinct_OPLSS2021.Vector.VNil))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 137
(Term_constr_id (OPLSS2021.Vector.VCons @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_OPLSS2021.Vector.VCons))

:named constructor_distinct_OPLSS2021.Vector.VCons))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(7,5-7,11); use=OPLSS2021.Vector.fst(7,5-7,11)
...
(OPLSS2021.Vector.vector @x2
@x3)))
:qid OPLSS2021.Vector_pretyping_a836ac2784be399886ffdbcdcf10a0cb))

:named OPLSS2021.Vector_pretyping_a836ac2784be399886ffdbcdcf10a0cb))
(push) ;; push{4
...
;   Prims.hasEq a /\
;   (forall (a: Type) (_: Prims.nat). {:pattern Prims.hasEq (OPLSS2021.Vector.vector a _)}
;       Prims.hasEq a ==> Prims.hasEq (OPLSS2021.Vector.vector a _)) ==>
;   (forall (hd: a) (n: Prims.nat) (tl: OPLSS2021.Vector.vector a n).
;       Prims.hasEq a /\ Prims.hasEq Prims.nat /\ Prims.hasEq (OPLSS2021.Vector.vector a n))
...
;; def=OPLSS2021.Vector.fst(7,0-12,29); use=OPLSS2021.Vector.fst(7,0-12,29)
(Valid 
;; def=OPLSS2021.Vector.fst(7,0-12,29); use=OPLSS2021.Vector.fst(7,0-12,29)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=OPLSS2021.Vector.fst(7,0-12,29); use=OPLSS2021.Vector.fst(7,0-12,29)
(Prims.hasEq (OPLSS2021.Vector.vector @x2
@x3))
)
)
 

:pattern ((Prims.hasEq (OPLSS2021.Vector.vector @x2
@x3)))
:qid @query.1))
)
...
;; def=OPLSS2021.Vector.fst(7,0-12,29); use=OPLSS2021.Vector.fst(7,0-12,29)
(and 
;; def=OPLSS2021.Vector.fst(7,0-12,29); use=OPLSS2021.Vector.fst(9,15-9,16)
(or label_1
...
;; def=OPLSS2021.Vector.fst(7,0-12,29); use=OPLSS2021.Vector.fst(10,16-10,19)
(or label_2
...
;; def=OPLSS2021.Vector.fst(7,0-12,29); use=OPLSS2021.Vector.fst(11,16-11,26)
(or label_3

;; def=OPLSS2021.Vector.fst(7,0-12,29); use=OPLSS2021.Vector.fst(7,0-12,29)
(Valid 
;; def=OPLSS2021.Vector.fst(7,0-12,29); use=OPLSS2021.Vector.fst(7,0-12,29)
(Prims.hasEq (OPLSS2021.Vector.vector @x0
@x3))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.vector, 2)
; STATUS: unsat
...
; encoding sigelt assume OPLSS2021.Vector.vector__uu___haseq


; <Start encoding assume OPLSS2021.Vector.vector__uu___haseq>


; </end encoding assume OPLSS2021.Vector.vector__uu___haseq>


; encoding sigelt val OPLSS2021.Vector.uu___is_VNil


; <Start encoding val OPLSS2021.Vector.uu___is_VNil>

(declare-fun OPLSS2021.Vector.uu___is_VNil (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: vector a _ -> Prims.bool
(declare-fun Tm_arrow_dc4ac394cc31c17e38f0baeba3d5401e () Term)
(declare-fun OPLSS2021.Vector.uu___is_VNil@tok () Term)

; </end encoding val OPLSS2021.Vector.uu___is_VNil>
...
; encoding sigelt val OPLSS2021.Vector.uu___is_VCons


; <Start encoding val OPLSS2021.Vector.uu___is_VCons>

(declare-fun OPLSS2021.Vector.uu___is_VCons (Term Term Term) Term)

(declare-fun OPLSS2021.Vector.uu___is_VCons@tok () Term)

; </end encoding val OPLSS2021.Vector.uu___is_VCons>
...
; encoding sigelt val OPLSS2021.Vector.__proj__VCons__item__hd


; <Start encoding val OPLSS2021.Vector.__proj__VCons__item__hd>

(declare-fun Tm_refine_2cb127f228a689d92b063741e0d7b001 (Term Term) Term)
(declare-fun OPLSS2021.Vector.__proj__VCons__item__hd (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vector a _ {VCons? _} -> a
(declare-fun Tm_arrow_a145212dc1b010b9d482f5773c7e1479 () Term)
(declare-fun OPLSS2021.Vector.__proj__VCons__item__hd@tok () Term)

; </end encoding val OPLSS2021.Vector.__proj__VCons__item__hd>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.Vector.uu___is_VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
...
(OPLSS2021.Vector.vector @x0
@x1)))
(HasType (OPLSS2021.Vector.uu___is_VCons @x0
@x1
@x2)
Prims.bool))
 

:pattern ((OPLSS2021.Vector.uu___is_VCons @x0
@x1
@x2))
:qid typing_OPLSS2021.Vector.uu___is_VCons))

:named typing_OPLSS2021.Vector.uu___is_VCons))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name OPLSS2021.Vector.vector; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VNil; Namespace OPLSS2021.Vector; Name OPLSS2021.Vector.VCons; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(7,5-7,11); use=OPLSS2021.Vector.fst(7,5-7,11)
...
:named refinement_kinding_Tm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name OPLSS2021.Vector.__proj__VCons__item__hd; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_2cb127f228a689d92b063741e0d7b001 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_2cb127f228a689d92b063741e0d7b001 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_2cb127f228a689d92b063741e0d7b001))

:named refinement_kinding_Tm_refine_2cb127f228a689d92b063741e0d7b001))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! (HasType Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_2cb127f228a689d92b063741e0d7b001 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(OPLSS2021.Vector.vector @x2
...
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VCons @x2
@x3
@x1))
))
...
(Tm_refine_2cb127f228a689d92b063741e0d7b001 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_2cb127f228a689d92b063741e0d7b001))

:named refinement_interpretation_Tm_refine_2cb127f228a689d92b063741e0d7b001))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
;; def=Prims.fst(686,15-686,29); use=Prims.fst(686,15-686,29)
...
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_2cb127f228a689d92b063741e0d7b001
;;; Fact-ids: Name OPLSS2021.Vector.__proj__VCons__item__hd; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_2cb127f228a689d92b063741e0d7b001 @x0
@x1)))
(Valid (Prims.hasEq (OPLSS2021.Vector.vector @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_2cb127f228a689d92b063741e0d7b001 @x0
@x1))))
:qid haseqTm_refine_2cb127f228a689d92b063741e0d7b001))

:named haseqTm_refine_2cb127f228a689d92b063741e0d7b001))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f))
(Valid (Prims.hasEq Prims.int)))
...
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,4-9,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (OPLSS2021.Vector.uu___is_VCons @x0
@x1
@x2)
(BoxBool (is-OPLSS2021.Vector.VCons @x2)))
 

:pattern ((OPLSS2021.Vector.uu___is_VCons @x0
@x1
@x2))
:qid disc_equation_OPLSS2021.Vector.VCons))

:named disc_equation_OPLSS2021.Vector.VCons))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: OPLSS2021.Vector.vector__uu___haseq
;;; Fact-ids: Name OPLSS2021.Vector.vector__uu___haseq; Namespace OPLSS2021.Vector
...
:pattern ((Prims.hasEq (OPLSS2021.Vector.vector @x0
@x1)))
:qid assumption_OPLSS2021.Vector.vector__uu___haseq))
:named assumption_OPLSS2021.Vector.vector__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Starting query at OPLSS2021.Vector.fst(9,12-9,14)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (_: Prims.nat) (projectee: _: OPLSS2021.Vector.vector a _ {VCons? _}).
...
Prims.nat)
(HasType @x2
(Tm_refine_2cb127f228a689d92b063741e0d7b001 @x0
@x1))

;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,12-9,14)
(not 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(9,12-9,14)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VCons @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.__proj__VCons__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_2cb127f228a689d92b063741e0d7b001
...
; encoding sigelt val OPLSS2021.Vector.__proj__VCons__item__n


; <Start encoding val OPLSS2021.Vector.__proj__VCons__item__n>


(declare-fun OPLSS2021.Vector.__proj__VCons__item__n (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vector a _ {VCons? _} -> Prims.nat
(declare-fun Tm_arrow_42b2b72a17c6d38fb6a6d12ab7f68cc5 () Term)
(declare-fun OPLSS2021.Vector.__proj__VCons__item__n@tok () Term)

; </end encoding val OPLSS2021.Vector.__proj__VCons__item__n>

(push) ;; push{2

; Starting query at OPLSS2021.Vector.fst(10,14-10,15)
...
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(10,14-10,15)
(not 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(10,14-10,15)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VCons @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.__proj__VCons__item__n, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_2cb127f228a689d92b063741e0d7b001
...
; encoding sigelt val OPLSS2021.Vector.__proj__VCons__item__tl


; <Start encoding val OPLSS2021.Vector.__proj__VCons__item__tl>


(declare-fun OPLSS2021.Vector.__proj__VCons__item__tl (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vector a _ {VCons? _} -> vector a projectee.n
(declare-fun Tm_arrow_1b23f07b3c1257d1876bb2fecfa0dc84 () Term)
(declare-fun OPLSS2021.Vector.__proj__VCons__item__tl@tok () Term)

; </end encoding val OPLSS2021.Vector.__proj__VCons__item__tl>

(push) ;; push{2

; Starting query at OPLSS2021.Vector.fst(11,13-11,15)
...
; *)
;   (~(VCons? projectee) ==> Prims.l_False) /\
;   (forall (b: a) (b: Prims.nat) (b: OPLSS2021.Vector.vector a b).
;       projectee == OPLSS2021.Vector.VCons b b ==> b + 1 == _ /\ VCons? (OPLSS2021.Vector.VCons b b))
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(11,13-11,15)
(and (implies 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(11,13-11,15)
(not 
;; def=OPLSS2021.Vector.fst(9,4-9,9); use=OPLSS2021.Vector.fst(11,13-11,15)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VCons @x0
@x1
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Vector.fst(11,13-11,15)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x0)
...
;; def=dummy(0,0-0,0); use=OPLSS2021.Vector.fst(11,13-11,15)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.__proj__VCons__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_OPLSS2021.Vector.VCons, refinement_interpretation_Tm_refine_2cb127f228a689d92b063741e0d7b001
...
; Starting query at OPLSS2021.Vector.fst(15,2-16,19)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_039b68a29747696797a6e7240d4505a6 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(14,10-14,76); use=OPLSS2021.Vector.fst(14,10-14,76)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_039b68a29747696797a6e7240d4505a6 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_039b68a29747696797a6e7240d4505a6 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_039b68a29747696797a6e7240d4505a6))

:named refinement_kinding_Tm_refine_039b68a29747696797a6e7240d4505a6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(14,10-14,76); use=OPLSS2021.Vector.fst(14,10-14,76)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_039b68a29747696797a6e7240d4505a6 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(OPLSS2021.Vector.vector @x2
@x3))
(let ((@lb4 @x1))
(implies (not (is-OPLSS2021.Vector.VCons @lb4))

;; def=OPLSS2021.Vector.fst(14,67-14,72); use=OPLSS2021.Vector.fst(14,67-14,72)
false
))))
...
(Tm_refine_039b68a29747696797a6e7240d4505a6 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_039b68a29747696797a6e7240d4505a6))

:named refinement_interpretation_Tm_refine_039b68a29747696797a6e7240d4505a6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_039b68a29747696797a6e7240d4505a6
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(14,10-14,76); use=OPLSS2021.Vector.fst(14,10-14,76)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_039b68a29747696797a6e7240d4505a6 @x0
@x1)))
(Valid (Prims.hasEq (OPLSS2021.Vector.vector @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_039b68a29747696797a6e7240d4505a6 @x0
@x1))))
:qid haseqTm_refine_039b68a29747696797a6e7240d4505a6))

:named haseqTm_refine_039b68a29747696797a6e7240d4505a6))

; Encoding query formula : forall ('a: Type)
;   ('n: Prims.nat)
;   (v:
;   OPLSS2021.Vector.vector 'a 'n
;     { (match v with
;         | OPLSS2021.Vector.VCons _ _ -> Prims.l_True
;         | _ -> Prims.l_False)
;       <:
;       Type }).
;   (*  - Could not prove post-condition
...
Prims.nat)
(HasType @x2
(Tm_refine_039b68a29747696797a6e7240d4505a6 @x0
@x1))

;; def=OPLSS2021.Vector.fst(14,11-14,12); use=OPLSS2021.Vector.fst(15,8-15,9)
(not 
;; def=OPLSS2021.Vector.fst(14,11-14,12); use=OPLSS2021.Vector.fst(15,8-15,9)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VCons @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.head', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_OPLSS2021.Vector.VCons, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_039b68a29747696797a6e7240d4505a6
...
(declare-fun Tm_refine_039b68a29747696797a6e7240d4505a6 (Term Term) Term)
(declare-fun OPLSS2021.Vector.head_ (Term Term Term) Term)

;;;;;;;;;;;;;;;;v:       vector 'a 'n         { (match v with             | OPLSS2021.Vector.VCons _ _ -> Prims.l_True             | _ -> Prims.l_False)           <:           Type }   -> 'a
(declare-fun Tm_arrow_71f78787fe824c6ddcb930111cc577d2 () Term)
(declare-fun OPLSS2021.Vector.head_@tok () Term)
...
; Starting query at OPLSS2021.Vector.fst(20,2-21,19)

(declare-fun label_1 () Bool)


; Encoding query formula : forall ('a: Type) ('n: Prims.nat) (v: OPLSS2021.Vector.vector 'a 'n {VCons? v}).
;   (*  - Could not prove post-condition
; *) ~(VCons? v) ==> Prims.l_False
...
;; def=OPLSS2021.Vector.fst(19,10-19,11); use=OPLSS2021.Vector.fst(20,8-20,9)
(not 
;; def=OPLSS2021.Vector.fst(19,10-19,11); use=OPLSS2021.Vector.fst(20,8-20,9)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VCons @x0
@x1
...
(declare-fun OPLSS2021.Vector.head (Term Term Term) Term)


(declare-fun OPLSS2021.Vector.head@tok () Term)
...
; Starting query at OPLSS2021.Vector.fst(23,59-27,19)
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(23,23-23,38); use=OPLSS2021.Vector.fst(23,23-23,38)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=OPLSS2021.Vector.fst(23,31-23,36); use=OPLSS2021.Vector.fst(23,31-23,36)
(> (BoxInt_proj_0 @x1)
...
;;;;;;;;;;;;;;;;v : OPLSS2021.Vector.vector a m (OPLSS2021.Vector.vector a m)
(declare-fun x_87482a9309e1807e69fdfbecad0b1ed1_4 () Term)
;;;;;;;;;;;;;;;;binder_x_87482a9309e1807e69fdfbecad0b1ed1_4
;;; Fact-ids: 
(assert (! (HasType x_87482a9309e1807e69fdfbecad0b1ed1_4
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3))
:named binder_x_87482a9309e1807e69fdfbecad0b1ed1_4))
...
(declare-fun Tm_refine_aa91e9815a2164de28c0b33f9c827cbb (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(23,16-27,19); use=OPLSS2021.Vector.fst(23,16-27,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_aa91e9815a2164de28c0b33f9c827cbb @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_aa91e9815a2164de28c0b33f9c827cbb @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_aa91e9815a2164de28c0b33f9c827cbb))

:named refinement_kinding_Tm_refine_aa91e9815a2164de28c0b33f9c827cbb))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(23,16-27,19); use=OPLSS2021.Vector.fst(23,16-27,19)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_aa91e9815a2164de28c0b33f9c827cbb @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
(OPLSS2021.Vector.vector @x4
@x3))
...
;; def=OPLSS2021.Vector.fst(23,16-27,19); use=OPLSS2021.Vector.fst(23,16-27,19)
(or 
;; def=OPLSS2021.Vector.fst(23,59-27,19); use=OPLSS2021.Vector.fst(23,59-27,19)
(Valid 
;; def=OPLSS2021.Vector.fst(23,59-27,19); use=OPLSS2021.Vector.fst(23,59-27,19)
...
;; def=OPLSS2021.Vector.fst(23,16-27,19); use=OPLSS2021.Vector.fst(23,16-27,19)
(and 
;; def=OPLSS2021.Vector.fst(23,16-23,17); use=OPLSS2021.Vector.fst(23,16-23,17)
(Valid 
;; def=OPLSS2021.Vector.fst(23,16-23,17); use=OPLSS2021.Vector.fst(23,16-23,17)
...
;; def=OPLSS2021.Vector.fst(23,25-27,19); use=OPLSS2021.Vector.fst(23,25-27,19)
(or 
;; def=OPLSS2021.Vector.fst(23,59-27,19); use=OPLSS2021.Vector.fst(23,59-27,19)
(Valid 
;; def=OPLSS2021.Vector.fst(23,59-27,19); use=OPLSS2021.Vector.fst(23,59-27,19)
...
;; def=OPLSS2021.Vector.fst(23,25-27,19); use=OPLSS2021.Vector.fst(23,25-27,19)
(and 
;; def=OPLSS2021.Vector.fst(23,25-23,26); use=OPLSS2021.Vector.fst(23,25-23,26)
(Valid 
;; def=OPLSS2021.Vector.fst(23,25-23,26); use=OPLSS2021.Vector.fst(23,25-23,26)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=OPLSS2021.Vector.fst(23,59-27,19); use=OPLSS2021.Vector.fst(23,59-27,19)
(Prims.precedes (OPLSS2021.Vector.vector @x4
@x3)
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3)
@x1
x_87482a9309e1807e69fdfbecad0b1ed1_4)
)
)
)
)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_aa91e9815a2164de28c0b33f9c827cbb))

:named refinement_interpretation_Tm_refine_aa91e9815a2164de28c0b33f9c827cbb))
;;;;;;;;;;;;;;;;haseq for Tm_refine_aa91e9815a2164de28c0b33f9c827cbb
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(23,16-27,19); use=OPLSS2021.Vector.fst(23,16-27,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_aa91e9815a2164de28c0b33f9c827cbb @x0
@x1
@x2)))
(Valid (Prims.hasEq (OPLSS2021.Vector.vector @x2
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_aa91e9815a2164de28c0b33f9c827cbb @x0
@x1
@x2))))
:qid haseqTm_refine_aa91e9815a2164de28c0b33f9c827cbb))

:named haseqTm_refine_aa91e9815a2164de28c0b33f9c827cbb))
(declare-fun OPLSS2021.Vector.nth (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;n: Prims.nat -> v: vector a m {n << n \/ n === n /\ (m << m \/ m === m /\ v << v)} -> a
(declare-fun Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d
Tm_type)
:named kinding_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,15-27,19); use=OPLSS2021.Vector.fst(23,13-27,19)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d))
:qid OPLSS2021.Vector_pre_typing_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d))

:named OPLSS2021.Vector_pre_typing_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,15-27,19); use=OPLSS2021.Vector.fst(23,13-27,19)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d.2))
...
@x1)
@x2))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d.3))
...
@x2)
@x3))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d))

:named OPLSS2021.Vector_interpretation_Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d))
(declare-fun OPLSS2021.Vector.nth@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(23,8-23,11); use=OPLSS2021.Vector.fst(23,8-23,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Vector.nth@tok
@x0)
@x1)
@x2)
@x3)
(OPLSS2021.Vector.nth @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Vector.nth@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_OPLSS2021.Vector.nth))

:named token_correspondence_OPLSS2021.Vector.nth))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(23,8-23,11); use=OPLSS2021.Vector.fst(23,8-23,11)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Vector.nth@tok
Tm_arrow_8bdc7ab85dfb86adc99f757c341ffd3d))
...
@x3)
@x4)
(OPLSS2021.Vector.nth @x1
@x2
@x3
@x4))
 

:pattern ((OPLSS2021.Vector.nth @x1
@x2
@x3
@x4))
:qid function_token_typing_OPLSS2021.Vector.nth.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Vector.nth@tok))
:qid function_token_typing_OPLSS2021.Vector.nth))

:named function_token_typing_OPLSS2021.Vector.nth))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(23,8-23,11); use=OPLSS2021.Vector.fst(23,8-23,11)
...
(HasType @x3
(Tm_refine_aa91e9815a2164de28c0b33f9c827cbb @x1
@x2
@x0)))
(HasType (OPLSS2021.Vector.nth @x0
@x1
@x2
@x3)
@x0))
...
:pattern ((OPLSS2021.Vector.nth @x0
@x1
@x2
@x3))
:qid typing_OPLSS2021.Vector.nth))

:named typing_OPLSS2021.Vector.nth))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : (~(VCons? v) ==> Prims.l_False) /\
; (forall (b: a) (b: Prims.nat) (b: OPLSS2021.Vector.vector a b).
;     v == OPLSS2021.Vector.VCons b b ==>
...
;                     b == any_result ==> n - 1 << n \/ n - 1 === n /\ (b << m \/ b === m /\ b << v)))
;         )))
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(23,59-27,19)
(and (implies 
;; def=OPLSS2021.Vector.fst(24,6-24,16); use=OPLSS2021.Vector.fst(24,6-24,16)
(not 
;; def=OPLSS2021.Vector.fst(24,6-24,16); use=OPLSS2021.Vector.fst(24,6-24,16)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VCons x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3
x_87482a9309e1807e69fdfbecad0b1ed1_4))
)
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Vector.fst(23,59-27,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
...
;; def=OPLSS2021.Vector.fst(24,6-24,16); use=OPLSS2021.Vector.fst(24,6-24,16)
(= x_87482a9309e1807e69fdfbecad0b1ed1_4
(OPLSS2021.Vector.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x0
@x1
@x2))
)
...
;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Vector.fst(23,59-27,19)
(forall ((@x4 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Vector.fst(23,59-27,19)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Vector.fst(23,59-27,19)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Vector.fst(23,59-27,19)
(not 
;; def=OPLSS2021.Vector.fst(25,5-25,10); use=OPLSS2021.Vector.fst(25,5-25,10)
...
;; def=OPLSS2021.Vector.fst(25,5-27,19); use=OPLSS2021.Vector.fst(25,5-27,19)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_2
(BoxInt 0))
@x4)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(23,59-27,19)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Vector.fst(27,11-27,16)
(or label_2
...
;; def=Prims.fst(356,2-356,58); use=OPLSS2021.Vector.fst(23,59-27,19)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=OPLSS2021.Vector.fst(23,59-27,19)
(= @x5
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(23,59-27,19)
(and 
;; def=OPLSS2021.Vector.fst(23,31-23,36); use=OPLSS2021.Vector.fst(24,14-24,16)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Vector.fst(23,59-27,19)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=OPLSS2021.Vector.fst(23,25-24,16); use=OPLSS2021.Vector.fst(23,59-27,19)
(= @x1
@x6)
)

;; def=OPLSS2021.Vector.fst(23,16-27,19); use=OPLSS2021.Vector.fst(27,17-27,19)
(or label_4

;; def=OPLSS2021.Vector.fst(23,59-27,19); use=OPLSS2021.Vector.fst(27,17-27,19)
(Valid 
;; def=OPLSS2021.Vector.fst(23,59-27,19); use=OPLSS2021.Vector.fst(27,17-27,19)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(23,16-27,19); use=OPLSS2021.Vector.fst(27,17-27,19)
(and 
;; def=OPLSS2021.Vector.fst(23,16-23,17); use=OPLSS2021.Vector.fst(27,17-27,19)
(Valid 
;; def=OPLSS2021.Vector.fst(23,16-23,17); use=OPLSS2021.Vector.fst(27,17-27,19)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(23,25-27,19); use=OPLSS2021.Vector.fst(27,17-27,19)
(or 
;; def=OPLSS2021.Vector.fst(23,59-27,19); use=OPLSS2021.Vector.fst(27,17-27,19)
(Valid 
;; def=OPLSS2021.Vector.fst(23,59-27,19); use=OPLSS2021.Vector.fst(27,17-27,19)
...
;; def=OPLSS2021.Vector.fst(23,25-27,19); use=OPLSS2021.Vector.fst(27,17-27,19)
(and 
;; def=OPLSS2021.Vector.fst(23,25-23,26); use=OPLSS2021.Vector.fst(27,17-27,19)
(Valid 
;; def=OPLSS2021.Vector.fst(23,25-23,26); use=OPLSS2021.Vector.fst(27,17-27,19)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=OPLSS2021.Vector.fst(23,59-27,19); use=OPLSS2021.Vector.fst(27,17-27,19)
(Prims.precedes (OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
@x1)
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3)
@x2
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun OPLSS2021.Vector.nth.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun OPLSS2021.Vector.nth.fuel_instrumented_token () Term)
(declare-fun OPLSS2021.Vector.nth (Term Term Term Term) Term)
(declare-fun OPLSS2021.Vector.nth@tok () Term)
(declare-fun Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d (Term) Term)


;;;;;;;;;;;;;;;;n: Prims.nat -> v: vector a m -> a
(declare-fun Tm_arrow_8aacbebb5c23f4b9133f17866198ffe7 () Term)

; </end encoding let rec nth>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.Vector.uu___is_VNil; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(8,4-8,8); use=OPLSS2021.Vector.fst(8,4-8,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(OPLSS2021.Vector.vector @x0
@x1)))
(HasType (OPLSS2021.Vector.uu___is_VNil @x0
@x1
@x2)
Prims.bool))
 

:pattern ((OPLSS2021.Vector.uu___is_VNil @x0
@x1
@x2))
:qid typing_OPLSS2021.Vector.uu___is_VNil))

:named typing_OPLSS2021.Vector.uu___is_VNil))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name OPLSS2021.Vector.uu___is_VNil; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(8,4-8,8); use=OPLSS2021.Vector.fst(8,4-8,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (OPLSS2021.Vector.uu___is_VNil @x0
@x1
@x2)
(BoxBool (is-OPLSS2021.Vector.VNil @x2)))
 

:pattern ((OPLSS2021.Vector.uu___is_VNil @x0
@x1
@x2))
:qid disc_equation_OPLSS2021.Vector.VNil))

:named disc_equation_OPLSS2021.Vector.VNil))
(push) ;; push{2

; Starting query at OPLSS2021.Vector.fst(31,4-33,44)
...
;;;;;;;;;;;;;;;;v1 : OPLSS2021.Vector.vector a n1 (OPLSS2021.Vector.vector a n1)
(declare-fun x_abcb2536fd6b41e346b3f673d0db35d7_4 () Term)
;;;;;;;;;;;;;;;;binder_x_abcb2536fd6b41e346b3f673d0db35d7_4
;;; Fact-ids: 
(assert (! (HasType x_abcb2536fd6b41e346b3f673d0db35d7_4
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2))
:named binder_x_abcb2536fd6b41e346b3f673d0db35d7_4))
;;;;;;;;;;;;;;;;v2 : OPLSS2021.Vector.vector a n2 (OPLSS2021.Vector.vector a n2)
(declare-fun x_8e035785e2473bceac662146c4c2e5ba_5 () Term)
;;;;;;;;;;;;;;;;binder_x_8e035785e2473bceac662146c4c2e5ba_5
;;; Fact-ids: 
(assert (! (HasType x_8e035785e2473bceac662146c4c2e5ba_5
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_3))
:named binder_x_8e035785e2473bceac662146c4c2e5ba_5))
(declare-fun Tm_refine_4a83bacb76baf450d53c5f1fca02843b (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(29,19-33,44); use=OPLSS2021.Vector.fst(29,19-33,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_4a83bacb76baf450d53c5f1fca02843b @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_4a83bacb76baf450d53c5f1fca02843b @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_4a83bacb76baf450d53c5f1fca02843b))

:named refinement_kinding_Tm_refine_4a83bacb76baf450d53c5f1fca02843b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(29,19-33,44); use=OPLSS2021.Vector.fst(29,19-33,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4a83bacb76baf450d53c5f1fca02843b @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=OPLSS2021.Vector.fst(29,19-33,44); use=OPLSS2021.Vector.fst(29,19-33,44)
(or 
;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(31,4-33,44)
(Valid 
;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(31,4-33,44)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(29,19-33,44); use=OPLSS2021.Vector.fst(29,19-33,44)
(and 
;; def=OPLSS2021.Vector.fst(29,19-29,21); use=OPLSS2021.Vector.fst(29,19-29,21)
(Valid 
;; def=OPLSS2021.Vector.fst(29,19-29,21); use=OPLSS2021.Vector.fst(29,19-29,21)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(29,23-33,44); use=OPLSS2021.Vector.fst(29,23-33,44)
(or 
;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(31,4-33,44)
(Valid 
;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(31,4-33,44)
...
;; def=OPLSS2021.Vector.fst(29,23-33,44); use=OPLSS2021.Vector.fst(29,23-33,44)
(and 
;; def=OPLSS2021.Vector.fst(29,23-29,25); use=OPLSS2021.Vector.fst(29,23-29,25)
(Valid 
;; def=OPLSS2021.Vector.fst(29,23-29,25); use=OPLSS2021.Vector.fst(29,23-29,25)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(29,27-33,44); use=OPLSS2021.Vector.fst(29,27-33,44)
(or 
;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(31,4-33,44)
(Valid 
;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(31,4-33,44)
...
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x5
x_abcb2536fd6b41e346b3f673d0db35d7_4)
)


;; def=OPLSS2021.Vector.fst(29,27-33,44); use=OPLSS2021.Vector.fst(29,27-33,44)
(and 
;; def=OPLSS2021.Vector.fst(29,27-29,29); use=OPLSS2021.Vector.fst(29,27-29,29)
(Valid 
;; def=OPLSS2021.Vector.fst(29,27-29,29); use=OPLSS2021.Vector.fst(29,27-29,29)
(Prims.op_Equals_Equals_Equals (OPLSS2021.Vector.vector @x4
@x2)
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x5
...
x_bb4e1c9af0265270f8e7a5f250f730e2_3)
@x1
x_8e035785e2473bceac662146c4c2e5ba_5)
)
)
)
)
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_4a83bacb76baf450d53c5f1fca02843b))

:named refinement_interpretation_Tm_refine_4a83bacb76baf450d53c5f1fca02843b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4a83bacb76baf450d53c5f1fca02843b
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(29,19-33,44); use=OPLSS2021.Vector.fst(29,19-33,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4a83bacb76baf450d53c5f1fca02843b @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (OPLSS2021.Vector.vector @x2
...
:pattern ((Valid (Prims.hasEq (Tm_refine_4a83bacb76baf450d53c5f1fca02843b @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_4a83bacb76baf450d53c5f1fca02843b))

:named haseqTm_refine_4a83bacb76baf450d53c5f1fca02843b))
(declare-fun OPLSS2021.Vector.append (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;v1: vector a n1 ->     v2:       vector a n2         {n1 << n1 \/ n1 === n1 /\ (n2 << n2 \/ n2 === n2 /\ (v1 << v1 \/ v1 === v1 /\ v2 << v2))}   -> vector a (n1 + n2)
(declare-fun Tm_arrow_cde2c6e51cc815c76c88a77c960e175f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_cde2c6e51cc815c76c88a77c960e175f
Tm_type)
:named kinding_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,15-33,44); use=OPLSS2021.Vector.fst(29,16-33,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_cde2c6e51cc815c76c88a77c960e175f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_cde2c6e51cc815c76c88a77c960e175f))
:qid OPLSS2021.Vector_pre_typing_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f))

:named OPLSS2021.Vector_pre_typing_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,15-33,44); use=OPLSS2021.Vector.fst(29,16-33,44)
(forall ((@x0 Term))
...
@x4)
@x5))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f.2))
...
@x1)
@x2))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f.3))
...
@x2)
@x3))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f.4))
...
@x3)
@x4))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f.5))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_cde2c6e51cc815c76c88a77c960e175f))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f))

:named OPLSS2021.Vector_interpretation_Tm_arrow_cde2c6e51cc815c76c88a77c960e175f))
(declare-fun OPLSS2021.Vector.append@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(29,8-29,14); use=OPLSS2021.Vector.fst(29,8-29,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Vector.append@tok
@x0)
@x1)
@x2)
@x3)
@x4)
(OPLSS2021.Vector.append @x0
@x1
@x2
@x3
@x4))
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Vector.append@tok
@x0)
@x1)
@x2)
@x3)
@x4))
:qid token_correspondence_OPLSS2021.Vector.append))

:named token_correspondence_OPLSS2021.Vector.append))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(29,8-29,14); use=OPLSS2021.Vector.fst(29,8-29,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Vector.append@tok
Tm_arrow_cde2c6e51cc815c76c88a77c960e175f))
...
:pattern ((OPLSS2021.Vector.append @x1
@x2
@x3
@x4
@x5))
:qid function_token_typing_OPLSS2021.Vector.append.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Vector.append@tok))
:qid function_token_typing_OPLSS2021.Vector.append))

:named function_token_typing_OPLSS2021.Vector.append))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(29,8-29,14); use=OPLSS2021.Vector.fst(29,8-29,14)
...
@x1))
(HasType @x4
(Tm_refine_4a83bacb76baf450d53c5f1fca02843b @x1
@x2
@x0
@x3)))
(HasType (OPLSS2021.Vector.append @x0
@x1
@x2
@x3
@x4)
...
:pattern ((OPLSS2021.Vector.append @x0
@x1
@x2
@x3
@x4))
:qid typing_OPLSS2021.Vector.append))

:named typing_OPLSS2021.Vector.append))
...
; (forall (k: Prims.pure_post (OPLSS2021.Vector.vector a (n1 + n2))).
;     (forall (x: OPLSS2021.Vector.vector a (n1 + n2)). {:pattern Prims.guard_free (k x)}
;         Prims.auto_squash (k x)) ==>
;     (~(VNil? v1) /\ ~(VCons? v1) ==> Prims.l_False) /\
;     (v1 == OPLSS2021.Vector.VNil ==> n2 == n1 + n2) /\
;     (~(VNil? v1) ==>
;       (forall (b: a) (b: Prims.nat) (b: OPLSS2021.Vector.vector a b).
;           v1 == OPLSS2021.Vector.VCons b b ==>
;           b + n2 >= 0 /\
;           (forall (return_val: Prims.nat).
;               return_val == b + n2 ==>
;               (b << n1 \/ b === n1 /\ (n2 << n2 \/ (b << v1 \/ b === v1 /\ v2 << v2))) /\
;               (forall (any_result: OPLSS2021.Vector.vector a n2).
;                   v2 == any_result ==>
;                   (forall (any_result: OPLSS2021.Vector.vector a (b + n2)).
;                       OPLSS2021.Vector.append b v2 == any_result ==>
;                       (forall (any_result: OPLSS2021.Vector.vector a (b + n2 + 1)).
;                           OPLSS2021.Vector.VCons b (OPLSS2021.Vector.append b v2) == any_result ==>
;                           b + n2 + 1 == n1 + n2)))))))
...
;;; Fact-ids: 
(assert (! (not (and 
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Vector.fst(30,13-30,22)
(or label_1

;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Vector.fst(31,4-33,44)
...
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
(Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_2
x_bb4e1c9af0265270f8e7a5f250f730e2_3))))

;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Vector.fst(31,4-33,44)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Vector.fst(31,4-33,44)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Vector.fst(31,4-33,44)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(31,4-33,44)
(and (implies 
;; def=OPLSS2021.Vector.fst(29,27-29,29); use=OPLSS2021.Vector.fst(31,10-31,12)
(and 
;; def=OPLSS2021.Vector.fst(29,27-29,29); use=OPLSS2021.Vector.fst(31,10-31,12)
(not 
;; def=OPLSS2021.Vector.fst(29,27-29,29); use=OPLSS2021.Vector.fst(31,10-31,12)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2
x_abcb2536fd6b41e346b3f673d0db35d7_4))
)
...
label_2)
(implies 
;; def=OPLSS2021.Vector.fst(29,27-32,10); use=OPLSS2021.Vector.fst(31,10-32,10)
(= x_abcb2536fd6b41e346b3f673d0db35d7_4
(OPLSS2021.Vector.VNil x_fe28d8bcde588226b4e538b35321de05_1))


;; def=OPLSS2021.Vector.fst(29,23-30,22); use=OPLSS2021.Vector.fst(32,14-32,16)
(or label_3
...
(implies 
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Vector.fst(31,4-33,44)
(not 
;; def=OPLSS2021.Vector.fst(29,27-29,29); use=OPLSS2021.Vector.fst(31,10-31,12)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Vector.fst(31,4-33,44)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=OPLSS2021.Vector.fst(29,27-33,17); use=OPLSS2021.Vector.fst(31,10-33,17)
(= x_abcb2536fd6b41e346b3f673d0db35d7_4
(OPLSS2021.Vector.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(31,4-33,44)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Vector.fst(33,31-33,37)
(or label_4
...
;; def=Prims.fst(356,2-356,58); use=OPLSS2021.Vector.fst(31,4-33,44)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=OPLSS2021.Vector.fst(31,4-33,44)
(= @x4
(Prims.op_Addition @x2
x_bb4e1c9af0265270f8e7a5f250f730e2_3))
)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(31,4-33,44)
(and 
;; def=OPLSS2021.Vector.fst(29,19-33,44); use=OPLSS2021.Vector.fst(33,41-33,43)
(or label_5

;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(33,41-33,43)
(Valid 
;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(33,41-33,43)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(29,19-33,44); use=OPLSS2021.Vector.fst(33,41-33,43)
(and 
;; def=OPLSS2021.Vector.fst(29,19-29,21); use=OPLSS2021.Vector.fst(33,41-33,43)
(Valid 
;; def=OPLSS2021.Vector.fst(29,19-29,21); use=OPLSS2021.Vector.fst(33,41-33,43)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(29,23-33,44); use=OPLSS2021.Vector.fst(33,41-33,43)
(or 
;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(33,41-33,43)
(Valid 
;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(33,41-33,43)
...
;; def=OPLSS2021.Vector.fst(29,27-33,44); use=OPLSS2021.Vector.fst(33,41-33,43)
(and 
;; def=OPLSS2021.Vector.fst(29,27-29,29); use=OPLSS2021.Vector.fst(33,41-33,43)
(Valid 
;; def=OPLSS2021.Vector.fst(29,27-29,29); use=OPLSS2021.Vector.fst(33,41-33,43)
(Prims.op_Equals_Equals_Equals (OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
@x2)
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x3
...
;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Vector.fst(31,4-33,44)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_3))

;; def=OPLSS2021.Vector.fst(29,44-29,46); use=OPLSS2021.Vector.fst(31,4-33,44)
(= x_8e035785e2473bceac662146c4c2e5ba_5
@x5)
)
...
;; def=OPLSS2021.Vector.fst(11,13-33,44); use=OPLSS2021.Vector.fst(31,4-33,44)
(= (OPLSS2021.Vector.append x_fe28d8bcde588226b4e538b35321de05_1
@x2
x_bb4e1c9af0265270f8e7a5f250f730e2_3
@x3
x_8e035785e2473bceac662146c4c2e5ba_5)
...
;; def=OPLSS2021.Vector.fst(30,4-33,44); use=OPLSS2021.Vector.fst(31,4-33,44)
(= (OPLSS2021.Vector.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x1
(Prims.op_Addition @x2
x_bb4e1c9af0265270f8e7a5f250f730e2_3)
...
;; def=OPLSS2021.Vector.fst(12,22-30,22); use=OPLSS2021.Vector.fst(33,21-33,44)
(or label_6
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.append, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_abcb2536fd6b41e346b3f673d0db35d7_4, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_2, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_3, data_elim_OPLSS2021.Vector.VCons, data_elim_OPLSS2021.Vector.VNil, disc_equation_OPLSS2021.Vector.VCons, disc_equation_OPLSS2021.Vector.VNil, equation_Prims.nat, fuel_guarded_inversion_OPLSS2021.Vector.vector, int_inversion, int_typing, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; Starting query at OPLSS2021.Vector.fst(29,0-33,44)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_d5acd636a573da8f88ce4b0046c4081a (Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(29,19-33,44); use=OPLSS2021.Vector.fst(29,19-33,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (HasType (Tm_refine_d5acd636a573da8f88ce4b0046c4081a @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_d5acd636a573da8f88ce4b0046c4081a @x0
@x1
@x2
@x3
@x4
...
@x8)
Tm_type))
:qid refinement_kinding_Tm_refine_d5acd636a573da8f88ce4b0046c4081a))

:named refinement_kinding_Tm_refine_d5acd636a573da8f88ce4b0046c4081a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(29,19-33,44); use=OPLSS2021.Vector.fst(29,19-33,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d5acd636a573da8f88ce4b0046c4081a @x2
@x3
@x4
@x5
@x6
...
(Valid 
;; def=OPLSS2021.Vector.fst(31,4-33,44); use=OPLSS2021.Vector.fst(31,4-33,44)
(Prims.precedes (OPLSS2021.Vector.vector @x6
@x2)
(OPLSS2021.Vector.vector @x7
@x3)
@x8
@x9)
)
...
(Valid 
;; def=OPLSS2021.Vector.fst(29,27-29,29); use=OPLSS2021.Vector.fst(29,27-29,29)
(Prims.op_Equals_Equals_Equals (OPLSS2021.Vector.vector @x6
@x2)
(OPLSS2021.Vector.vector @x7
@x3)
@x8
...
@x9
@x10)))
:qid refinement_interpretation_Tm_refine_d5acd636a573da8f88ce4b0046c4081a))

:named refinement_interpretation_Tm_refine_d5acd636a573da8f88ce4b0046c4081a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d5acd636a573da8f88ce4b0046c4081a
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(29,19-33,44); use=OPLSS2021.Vector.fst(29,19-33,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d5acd636a573da8f88ce4b0046c4081a @x0
@x1
@x2
@x3
@x4
...
@x7
@x8)))
(Valid (Prims.hasEq (OPLSS2021.Vector.vector @x4
@x2))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d5acd636a573da8f88ce4b0046c4081a @x0
@x1
@x2
@x3
@x4
...
@x7
@x8))))
:qid haseqTm_refine_d5acd636a573da8f88ce4b0046c4081a))

:named haseqTm_refine_d5acd636a573da8f88ce4b0046c4081a))

; Encoding query formula : forall (a: Type) (n1: Prims.nat) (n2: Prims.nat) (v1: OPLSS2021.Vector.vector a n1)
;   (v2: OPLSS2021.Vector.vector a n2) (a: Type) (n1: Prims.nat) (n2: Prims.nat)
;   (v1: OPLSS2021.Vector.vector a n1)
;   (v2:
;   OPLSS2021.Vector.vector a n2
;     {n1 << n1 \/ n1 === n1 /\ (n2 << n2 \/ n2 === n2 /\ (v1 << v1 \/ v1 === v1 /\ v2 << v2))}).
;   (*  - Subtyping check failed
;   - Expected type Prims.nat got type Prims.int
; *) n1 + n2 >= 0
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=OPLSS2021.Vector.fst(29,0-33,44)
...
@x6))
(HasType @x9
(Tm_refine_d5acd636a573da8f88ce4b0046c4081a @x6
@x1
@x7
@x2
@x5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.append, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun OPLSS2021.Vector.append.fuel_instrumented (Fuel Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun OPLSS2021.Vector.append.fuel_instrumented_token () Term)
(declare-fun OPLSS2021.Vector.append (Term Term Term Term Term) Term)
(declare-fun OPLSS2021.Vector.append@tok () Term)
;;;;;;;;;;;;;;;;v1: vector a n1 -> v2: vector a n2 -> vector a (n1 + n2)
(declare-fun Tm_arrow_5feae99c4f85aca8d4524716482f55cc () Term)

; </end encoding let rec append>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.Vector.append; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(29,8-29,14); use=OPLSS2021.Vector.fst(29,8-29,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
...
(OPLSS2021.Vector.vector @x1
@x3)))
(HasType (OPLSS2021.Vector.append.fuel_instrumented @u0
@x1
@x2
@x3
@x4
...
:pattern ((OPLSS2021.Vector.append.fuel_instrumented @u0
@x1
@x2
@x3
@x4
@x5))
:qid token_correspondence_OPLSS2021.Vector.append.fuel_instrumented))

:named token_correspondence_OPLSS2021.Vector.append.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: OPLSS2021.Vector.append
;;; Fact-ids: Name OPLSS2021.Vector.append; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(29,8-29,14); use=OPLSS2021.Vector.fst(29,8-29,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
...
(OPLSS2021.Vector.vector @x1
@x3)))
(= (OPLSS2021.Vector.append.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4
@x5)
(let ((@lb6 @x4))
(ite (is-OPLSS2021.Vector.VNil @lb6)
@x5
(ite (is-OPLSS2021.Vector.VCons @lb6)
(OPLSS2021.Vector.VCons @x1
(OPLSS2021.Vector.VCons_hd @lb6)
(Prims.op_Addition (OPLSS2021.Vector.VCons_n @lb6)
@x3)
(OPLSS2021.Vector.append.fuel_instrumented @u0
@x1
(OPLSS2021.Vector.VCons_n @lb6)
@x3
(OPLSS2021.Vector.VCons_tl @lb6)
@x5))
Tm_unit)))))
 :weight 0


:pattern ((OPLSS2021.Vector.append.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4
@x5))
:qid equation_with_fuel_OPLSS2021.Vector.append.fuel_instrumented))

:named equation_with_fuel_OPLSS2021.Vector.append.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name OPLSS2021.Vector.append; Namespace OPLSS2021.Vector
(assert (! 
;; def=OPLSS2021.Vector.fst(29,8-29,14); use=OPLSS2021.Vector.fst(29,8-29,14)
...
@x4
@x5)
(OPLSS2021.Vector.append.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid @fuel_irrelevance_OPLSS2021.Vector.append.fuel_instrumented))

:named @fuel_irrelevance_OPLSS2021.Vector.append.fuel_instrumented))
...
@x3
@x4)
(OPLSS2021.Vector.append.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3
...
@x3
@x4))
:qid @fuel_correspondence_OPLSS2021.Vector.append.fuel_instrumented))

:named @fuel_correspondence_OPLSS2021.Vector.append.fuel_instrumented))
(push) ;; push{2

; Starting query at OPLSS2021.Vector.fst(37,4-39,56)
...
(declare-fun x_abcb2536fd6b41e346b3f673d0db35d7_3 () Term)
;;;;;;;;;;;;;;;;binder_x_abcb2536fd6b41e346b3f673d0db35d7_3
;;; Fact-ids: 
(assert (! (HasType x_abcb2536fd6b41e346b3f673d0db35d7_3
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2))
:named binder_x_abcb2536fd6b41e346b3f673d0db35d7_3))
(declare-fun Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(35,20-39,56); use=OPLSS2021.Vector.fst(35,20-39,56)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf))

:named refinement_kinding_Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(35,20-39,56); use=OPLSS2021.Vector.fst(35,20-39,56)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf @x2
@x3))
(and (HasTypeFuel @u0
@x1
(OPLSS2021.Vector.vector @x3
@x2))
...
;; def=OPLSS2021.Vector.fst(35,20-39,56); use=OPLSS2021.Vector.fst(35,20-39,56)
(or 
;; def=OPLSS2021.Vector.fst(37,4-39,56); use=OPLSS2021.Vector.fst(37,4-39,56)
(Valid 
;; def=OPLSS2021.Vector.fst(37,4-39,56); use=OPLSS2021.Vector.fst(37,4-39,56)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(35,20-39,56); use=OPLSS2021.Vector.fst(35,20-39,56)
(and 
;; def=OPLSS2021.Vector.fst(35,20-35,21); use=OPLSS2021.Vector.fst(35,20-35,21)
(Valid 
;; def=OPLSS2021.Vector.fst(35,20-35,21); use=OPLSS2021.Vector.fst(35,20-35,21)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=OPLSS2021.Vector.fst(37,4-39,56); use=OPLSS2021.Vector.fst(37,4-39,56)
(Prims.precedes (OPLSS2021.Vector.vector @x3
@x2)
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x1
x_abcb2536fd6b41e346b3f673d0db35d7_3)
)
)
)
...
(Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf @x2
@x3)))
:qid refinement_interpretation_Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf))

:named refinement_interpretation_Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(35,20-39,56); use=OPLSS2021.Vector.fst(35,20-39,56)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf @x0
@x1)))
(Valid (Prims.hasEq (OPLSS2021.Vector.vector @x1
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf @x0
@x1))))
:qid haseqTm_refine_f49c6cfced6a1704709cb4e014bdbcbf))

:named haseqTm_refine_f49c6cfced6a1704709cb4e014bdbcbf))
(declare-fun OPLSS2021.Vector.reverse (Term Term Term) Term)

;;;;;;;;;;;;;;;;v: vector a n {n << n \/ n === n /\ v << v} -> vector a n
(declare-fun Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1
Tm_type)
:named kinding_Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,15-39,56); use=OPLSS2021.Vector.fst(35,17-39,56)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1))
:qid OPLSS2021.Vector_pre_typing_Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1))

:named OPLSS2021.Vector_pre_typing_Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,15-39,56); use=OPLSS2021.Vector.fst(35,17-39,56)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1.2))
...
@x1)
@x2))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1))

:named OPLSS2021.Vector_interpretation_Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1))
(declare-fun OPLSS2021.Vector.reverse@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(35,8-35,15); use=OPLSS2021.Vector.fst(35,8-35,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Vector.reverse@tok
@x0)
@x1)
@x2)
(OPLSS2021.Vector.reverse @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT OPLSS2021.Vector.reverse@tok
@x0)
@x1)
@x2))
:qid token_correspondence_OPLSS2021.Vector.reverse))

:named token_correspondence_OPLSS2021.Vector.reverse))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(35,8-35,15); use=OPLSS2021.Vector.fst(35,8-35,15)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Vector.reverse@tok
Tm_arrow_a8feac3f496f4bcad924e36ddbcd86a1))
...
@x2)
@x3)
(OPLSS2021.Vector.reverse @x1
@x2
@x3))
 

:pattern ((OPLSS2021.Vector.reverse @x1
@x2
@x3))
:qid function_token_typing_OPLSS2021.Vector.reverse.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Vector.reverse@tok))
:qid function_token_typing_OPLSS2021.Vector.reverse))

:named function_token_typing_OPLSS2021.Vector.reverse))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(35,8-35,15); use=OPLSS2021.Vector.fst(35,8-35,15)
...
Prims.nat)
(HasType @x2
(Tm_refine_f49c6cfced6a1704709cb4e014bdbcbf @x1
@x0)))
(HasType (OPLSS2021.Vector.reverse @x0
@x1
@x2)
(OPLSS2021.Vector.vector @x0
@x1)))
...
:pattern ((OPLSS2021.Vector.reverse @x0
@x1
@x2))
:qid typing_OPLSS2021.Vector.reverse))

:named typing_OPLSS2021.Vector.reverse))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (OPLSS2021.Vector.vector a n)).
;   (forall (x: OPLSS2021.Vector.vector a n). {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(VNil? v) /\ ~(VCons? v) ==> Prims.l_False) /\
;   (v == OPLSS2021.Vector.VNil ==> 0 == n) /\
;   (~(VNil? v) ==>
;     (forall (b: a) (b: Prims.nat) (b: OPLSS2021.Vector.vector a b).
;         v == OPLSS2021.Vector.VCons b b ==>
;         (b << n \/ b === n /\ b << v) /\
;         (forall (any_result: OPLSS2021.Vector.vector a b).
;             b == any_result ==>
;             (forall (any_result: OPLSS2021.Vector.vector a b).
;                 OPLSS2021.Vector.reverse b == any_result ==>
;                 (forall (any_result: OPLSS2021.Vector.vector a (b + 1)).
;                     OPLSS2021.Vector.append (OPLSS2021.Vector.reverse b)
;                       (OPLSS2021.Vector.VCons b OPLSS2021.Vector.VNil) ==
;                     any_result ==>
;                     b + 1 == n)))))
...
;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Vector.fst(37,4-39,56)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Vector.fst(37,4-39,56)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Vector.fst(37,4-39,56)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(37,4-39,56)
(and (implies 
;; def=OPLSS2021.Vector.fst(35,23-35,24); use=OPLSS2021.Vector.fst(37,10-37,11)
(and 
;; def=OPLSS2021.Vector.fst(35,23-35,24); use=OPLSS2021.Vector.fst(37,10-37,11)
(not 
;; def=OPLSS2021.Vector.fst(35,23-35,24); use=OPLSS2021.Vector.fst(37,10-37,11)
...
label_1)
(implies 
;; def=OPLSS2021.Vector.fst(35,23-38,10); use=OPLSS2021.Vector.fst(37,10-38,10)
(= x_abcb2536fd6b41e346b3f673d0db35d7_3
(OPLSS2021.Vector.VNil x_fe28d8bcde588226b4e538b35321de05_1))


;; def=OPLSS2021.Vector.fst(8,20-35,21); use=OPLSS2021.Vector.fst(38,14-38,18)
(or label_2
...
(implies 
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Vector.fst(37,4-39,56)
(not 
;; def=OPLSS2021.Vector.fst(35,23-35,24); use=OPLSS2021.Vector.fst(37,10-37,11)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Vector.fst(37,4-39,56)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=OPLSS2021.Vector.fst(35,23-39,17); use=OPLSS2021.Vector.fst(37,10-39,17)
(= x_abcb2536fd6b41e346b3f673d0db35d7_3
(OPLSS2021.Vector.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(37,4-39,56)
(and 
;; def=OPLSS2021.Vector.fst(35,20-39,56); use=OPLSS2021.Vector.fst(39,37-39,39)
(or label_3

;; def=OPLSS2021.Vector.fst(37,4-39,56); use=OPLSS2021.Vector.fst(39,37-39,39)
(Valid 
;; def=OPLSS2021.Vector.fst(37,4-39,56); use=OPLSS2021.Vector.fst(39,37-39,39)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(35,20-39,56); use=OPLSS2021.Vector.fst(39,37-39,39)
(and 
;; def=OPLSS2021.Vector.fst(35,20-35,21); use=OPLSS2021.Vector.fst(39,37-39,39)
(Valid 
;; def=OPLSS2021.Vector.fst(35,20-35,21); use=OPLSS2021.Vector.fst(39,37-39,39)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Vector.fst(37,4-39,56)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
@x2))

;; def=OPLSS2021.Vector.fst(35,23-39,17); use=OPLSS2021.Vector.fst(37,4-39,56)
(= @x3
@x4)
)
...
;; def=OPLSS2021.Vector.fst(29,27-39,40); use=OPLSS2021.Vector.fst(37,4-39,56)
(= (OPLSS2021.Vector.reverse x_fe28d8bcde588226b4e538b35321de05_1
@x2
@x3)
@x5)
)
...
;; def=OPLSS2021.Vector.fst(36,4-39,56); use=OPLSS2021.Vector.fst(37,4-39,56)
(= (OPLSS2021.Vector.append x_fe28d8bcde588226b4e538b35321de05_1
@x2
(BoxInt 1)
(OPLSS2021.Vector.reverse x_fe28d8bcde588226b4e538b35321de05_1
...
;; def=OPLSS2021.Vector.fst(30,13-35,21); use=OPLSS2021.Vector.fst(39,21-39,56)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.reverse, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_abcb2536fd6b41e346b3f673d0db35d7_3, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_2, constructor_distinct_OPLSS2021.Vector.VNil, data_elim_OPLSS2021.Vector.VCons, disc_equation_OPLSS2021.Vector.VCons, disc_equation_OPLSS2021.Vector.VNil, equation_Prims.nat, fuel_guarded_inversion_OPLSS2021.Vector.vector, int_inversion, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun OPLSS2021.Vector.reverse.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun OPLSS2021.Vector.reverse.fuel_instrumented_token () Term)
(declare-fun OPLSS2021.Vector.reverse (Term Term Term) Term)
(declare-fun OPLSS2021.Vector.reverse@tok () Term)
;;;;;;;;;;;;;;;;v: vector a n -> vector a n
(declare-fun Tm_arrow_8ffd4d3a333ae6575ea1a5dddb22097b () Term)

; </end encoding let rec reverse>

(push) ;; push{2

; Starting query at OPLSS2021.Vector.fst(43,4-45,44)
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(41,13-41,17); use=OPLSS2021.Vector.fst(41,21-41,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
:qid OPLSS2021.Vector_pre_typing_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))

:named OPLSS2021.Vector_pre_typing_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))

:named OPLSS2021.Vector_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
...
;;;;;;;;;;;;;;;;v : OPLSS2021.Vector.vector a n (OPLSS2021.Vector.vector a n)
(declare-fun x_afbf7c56af8378e385ccd2b2dc34583b_6 () Term)
;;;;;;;;;;;;;;;;binder_x_afbf7c56af8378e385ccd2b2dc34583b_6
;;; Fact-ids: 
(assert (! (HasType x_afbf7c56af8378e385ccd2b2dc34583b_6
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5))
:named binder_x_afbf7c56af8378e385ccd2b2dc34583b_6))
;;;;;;;;;;;;;;;;_: a -> b
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x2
@x3)))
:qid OPLSS2021.Vector_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named OPLSS2021.Vector_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
...
:pattern ((ApplyTT @x0
@x3))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe.1))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x2)))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named OPLSS2021.Vector_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
(declare-fun Tm_refine_dda61f273a109763a421eeb3c7e5ad5d (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(41,30-45,44); use=OPLSS2021.Vector.fst(41,30-45,44)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_dda61f273a109763a421eeb3c7e5ad5d @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_dda61f273a109763a421eeb3c7e5ad5d @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_dda61f273a109763a421eeb3c7e5ad5d))

:named refinement_kinding_Tm_refine_dda61f273a109763a421eeb3c7e5ad5d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(41,30-45,44); use=OPLSS2021.Vector.fst(41,30-45,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_dda61f273a109763a421eeb3c7e5ad5d @x2
@x3))
(and (HasTypeFuel @u0
@x1
(OPLSS2021.Vector.vector @x3
...
;; def=OPLSS2021.Vector.fst(41,30-45,44); use=OPLSS2021.Vector.fst(41,30-45,44)
(or 
;; def=OPLSS2021.Vector.fst(43,4-45,44); use=OPLSS2021.Vector.fst(43,4-45,44)
(Valid 
;; def=OPLSS2021.Vector.fst(43,4-45,44); use=OPLSS2021.Vector.fst(43,4-45,44)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(41,30-45,44); use=OPLSS2021.Vector.fst(41,30-45,44)
(and 
;; def=OPLSS2021.Vector.fst(41,30-41,31); use=OPLSS2021.Vector.fst(41,30-41,31)
(Valid 
;; def=OPLSS2021.Vector.fst(41,30-41,31); use=OPLSS2021.Vector.fst(41,30-41,31)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x1
x_afbf7c56af8378e385ccd2b2dc34583b_6)
)
)
)
...
(Tm_refine_dda61f273a109763a421eeb3c7e5ad5d @x2
@x3)))
:qid refinement_interpretation_Tm_refine_dda61f273a109763a421eeb3c7e5ad5d))

:named refinement_interpretation_Tm_refine_dda61f273a109763a421eeb3c7e5ad5d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_dda61f273a109763a421eeb3c7e5ad5d
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(41,30-45,44); use=OPLSS2021.Vector.fst(41,30-45,44)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_dda61f273a109763a421eeb3c7e5ad5d @x0
@x1)))
(Valid (Prims.hasEq (OPLSS2021.Vector.vector @x1
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_dda61f273a109763a421eeb3c7e5ad5d @x0
@x1))))
:qid haseqTm_refine_dda61f273a109763a421eeb3c7e5ad5d))

:named haseqTm_refine_dda61f273a109763a421eeb3c7e5ad5d))
(declare-fun OPLSS2021.Vector.map (Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;f: (_: a -> b) -> v: vector a n {n << n \/ n === n /\ v << v} -> vector b n
(declare-fun Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520
Tm_type)
:named kinding_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,23-45,44); use=OPLSS2021.Vector.fst(41,21-45,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520))
:qid OPLSS2021.Vector_pre_typing_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520))

:named OPLSS2021.Vector_pre_typing_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,23-45,44); use=OPLSS2021.Vector.fst(41,21-45,44)
(forall ((@x0 Term))
...
Prims.nat)
(HasType @x5
(Tm_refine_dda61f273a109763a421eeb3c7e5ad5d @x4
@x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x4)
@x5))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520.2))
...
@x1)
@x2))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520.3))
...
@x2)
@x3))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520.4))
...
@x3)
@x4))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520.5))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520))

:named OPLSS2021.Vector_interpretation_Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520))
(declare-fun OPLSS2021.Vector.map@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(41,8-41,11); use=OPLSS2021.Vector.fst(41,8-41,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Vector.map@tok
@x0)
@x1)
@x2)
@x3)
@x4)
(OPLSS2021.Vector.map @x0
@x1
@x2
@x3
@x4))
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Vector.map@tok
@x0)
@x1)
@x2)
@x3)
@x4))
:qid token_correspondence_OPLSS2021.Vector.map))

:named token_correspondence_OPLSS2021.Vector.map))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(41,8-41,11); use=OPLSS2021.Vector.fst(41,8-41,11)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Vector.map@tok
Tm_arrow_de12a5ebadc6ba0a4e531b90e8001520))
...
:pattern ((OPLSS2021.Vector.map @x1
@x2
@x3
@x4
@x5))
:qid function_token_typing_OPLSS2021.Vector.map.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Vector.map@tok))
:qid function_token_typing_OPLSS2021.Vector.map))

:named function_token_typing_OPLSS2021.Vector.map))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(41,8-41,11); use=OPLSS2021.Vector.fst(41,8-41,11)
...
Prims.nat)
(HasType @x4
(Tm_refine_dda61f273a109763a421eeb3c7e5ad5d @x3
@x0)))
(HasType (OPLSS2021.Vector.map @x0
@x1
@x2
@x3
@x4)
...
:pattern ((OPLSS2021.Vector.map @x0
@x1
@x2
@x3
@x4))
:qid typing_OPLSS2021.Vector.map))

:named typing_OPLSS2021.Vector.map))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (OPLSS2021.Vector.vector b n)).
;   (forall (x: OPLSS2021.Vector.vector b n). {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(VNil? v) /\ ~(VCons? v) ==> Prims.l_False) /\
;   (v == OPLSS2021.Vector.VNil ==> 0 == n) /\
;   (~(VNil? v) ==>
...
;         (forall (any_result: OPLSS2021.Vector.vector a b).
;             b == any_result ==>
;             (forall (any_result: OPLSS2021.Vector.vector b b).
;                 OPLSS2021.Vector.map f b == any_result ==>
;                 (forall (any_result: OPLSS2021.Vector.vector b (b + 1)).
;                     OPLSS2021.Vector.VCons (f b) (OPLSS2021.Vector.map f b) == any_result ==>
;                     b + 1 == n)))))
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_3
x_bb4e1c9af0265270f8e7a5f250f730e2_5)))

;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Vector.fst(43,4-45,44)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Vector.fst(43,4-45,44)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Vector.fst(43,4-45,44)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(43,4-45,44)
(and (implies 
;; def=OPLSS2021.Vector.fst(41,33-41,34); use=OPLSS2021.Vector.fst(43,10-43,11)
(and 
;; def=OPLSS2021.Vector.fst(41,33-41,34); use=OPLSS2021.Vector.fst(43,10-43,11)
(not 
;; def=OPLSS2021.Vector.fst(41,33-41,34); use=OPLSS2021.Vector.fst(43,10-43,11)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
x_afbf7c56af8378e385ccd2b2dc34583b_6))
)
...
(not 
;; def=OPLSS2021.Vector.fst(41,33-41,34); use=OPLSS2021.Vector.fst(43,10-43,11)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VCons x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
x_afbf7c56af8378e385ccd2b2dc34583b_6))
)
)
...
label_1)
(implies 
;; def=OPLSS2021.Vector.fst(41,33-44,10); use=OPLSS2021.Vector.fst(43,10-44,10)
(= x_afbf7c56af8378e385ccd2b2dc34583b_6
(OPLSS2021.Vector.VNil x_fe28d8bcde588226b4e538b35321de05_2))


;; def=OPLSS2021.Vector.fst(8,20-41,31); use=OPLSS2021.Vector.fst(44,14-44,18)
(or label_2
...
(implies 
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Vector.fst(43,4-45,44)
(not 
;; def=OPLSS2021.Vector.fst(41,33-41,34); use=OPLSS2021.Vector.fst(43,10-43,11)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Vector.fst(43,4-45,44)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=OPLSS2021.Vector.fst(41,33-45,17); use=OPLSS2021.Vector.fst(43,10-45,17)
(= x_afbf7c56af8378e385ccd2b2dc34583b_6
(OPLSS2021.Vector.VCons x_fe28d8bcde588226b4e538b35321de05_2
@x1
@x2
@x3))
)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(43,4-45,44)
(and 
;; def=OPLSS2021.Vector.fst(41,30-45,44); use=OPLSS2021.Vector.fst(45,41-45,43)
(or label_3

;; def=OPLSS2021.Vector.fst(43,4-45,44); use=OPLSS2021.Vector.fst(45,41-45,43)
(Valid 
;; def=OPLSS2021.Vector.fst(43,4-45,44); use=OPLSS2021.Vector.fst(45,41-45,43)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(41,30-45,44); use=OPLSS2021.Vector.fst(45,41-45,43)
(and 
;; def=OPLSS2021.Vector.fst(41,30-41,31); use=OPLSS2021.Vector.fst(45,41-45,43)
(Valid 
;; def=OPLSS2021.Vector.fst(41,30-41,31); use=OPLSS2021.Vector.fst(45,41-45,43)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=OPLSS2021.Vector.fst(43,4-45,44); use=OPLSS2021.Vector.fst(45,41-45,43)
(Prims.precedes (OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
@x2)
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x3
...
;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Vector.fst(43,4-45,44)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
@x2))

;; def=OPLSS2021.Vector.fst(41,33-45,17); use=OPLSS2021.Vector.fst(43,4-45,44)
(= @x3
@x4)
)
...
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_3
@x2))

;; def=OPLSS2021.Vector.fst(11,13-45,44); use=OPLSS2021.Vector.fst(43,4-45,44)
(= (OPLSS2021.Vector.map x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3
...
;; def=OPLSS2021.Vector.fst(42,4-45,44); use=OPLSS2021.Vector.fst(43,4-45,44)
(= (OPLSS2021.Vector.VCons x_fe28d8bcde588226b4e538b35321de05_3
...
;; def=OPLSS2021.Vector.fst(12,22-41,31); use=OPLSS2021.Vector.fst(45,21-45,44)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.map, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_afbf7c56af8378e385ccd2b2dc34583b_6, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_5, constructor_distinct_OPLSS2021.Vector.VNil, data_elim_OPLSS2021.Vector.VCons, disc_equation_OPLSS2021.Vector.VCons, disc_equation_OPLSS2021.Vector.VNil, equation_Prims.nat, fuel_guarded_inversion_OPLSS2021.Vector.vector, int_inversion, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun OPLSS2021.Vector.map.fuel_instrumented (Fuel Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun OPLSS2021.Vector.map.fuel_instrumented_token () Term)
(declare-fun OPLSS2021.Vector.map (Term Term Term Term Term) Term)
(declare-fun OPLSS2021.Vector.map@tok () Term)
;;;;;;;;;;;;;;;;_: a -> b
(declare-fun Tm_arrow_6980332764c4493a7b0df5c02f7aefbe (Term Term) Term)
...
(declare-fun Tm_arrow_37024638fd755ed608e72069f2e50df0 () Term)

; </end encoding let rec map>

(push) ;; push{2

; Starting query at OPLSS2021.Vector.fst(49,4-51,47)
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(47,20-47,24); use=OPLSS2021.Vector.fst(47,29-47,40)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
:qid OPLSS2021.Vector_pre_typing_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))

:named OPLSS2021.Vector_pre_typing_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
...
@x1)
@x2))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))

:named OPLSS2021.Vector_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
...
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x2
@x3)))
:qid OPLSS2021.Vector_pre_typing_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))

:named OPLSS2021.Vector_pre_typing_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))
...
@x3)
@x4))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81.2))
))
...
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x1
@x2)))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))

:named OPLSS2021.Vector_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))
(declare-fun Tm_refine_fd111dcc57cdf55e0927071c6b917e04 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(47,43-51,47); use=OPLSS2021.Vector.fst(47,43-51,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_fd111dcc57cdf55e0927071c6b917e04 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_fd111dcc57cdf55e0927071c6b917e04 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_fd111dcc57cdf55e0927071c6b917e04))

:named refinement_kinding_Tm_refine_fd111dcc57cdf55e0927071c6b917e04))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(47,43-51,47); use=OPLSS2021.Vector.fst(47,43-51,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_fd111dcc57cdf55e0927071c6b917e04 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=OPLSS2021.Vector.fst(47,43-51,47); use=OPLSS2021.Vector.fst(47,43-51,47)
(or 
;; def=OPLSS2021.Vector.fst(49,4-51,47); use=OPLSS2021.Vector.fst(49,4-51,47)
(Valid 
;; def=OPLSS2021.Vector.fst(49,4-51,47); use=OPLSS2021.Vector.fst(49,4-51,47)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(47,43-51,47); use=OPLSS2021.Vector.fst(47,43-51,47)
(and 
;; def=OPLSS2021.Vector.fst(47,43-47,44); use=OPLSS2021.Vector.fst(47,43-47,44)
(Valid 
;; def=OPLSS2021.Vector.fst(47,43-47,44); use=OPLSS2021.Vector.fst(47,43-47,44)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(47,46-51,47); use=OPLSS2021.Vector.fst(47,46-51,47)
(or 
;; def=OPLSS2021.Vector.fst(49,4-51,47); use=OPLSS2021.Vector.fst(49,4-51,47)
(Valid 
;; def=OPLSS2021.Vector.fst(49,4-51,47); use=OPLSS2021.Vector.fst(49,4-51,47)
...
;; def=OPLSS2021.Vector.fst(47,46-51,47); use=OPLSS2021.Vector.fst(47,46-51,47)
(and 
;; def=OPLSS2021.Vector.fst(47,46-47,47); use=OPLSS2021.Vector.fst(47,46-47,47)
(Valid 
;; def=OPLSS2021.Vector.fst(47,46-47,47); use=OPLSS2021.Vector.fst(47,46-47,47)
(Prims.op_Equals_Equals_Equals (OPLSS2021.Vector.vector @x3
@x2)
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x4
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_fd111dcc57cdf55e0927071c6b917e04))

:named refinement_interpretation_Tm_refine_fd111dcc57cdf55e0927071c6b917e04))
;;;;;;;;;;;;;;;;haseq for Tm_refine_fd111dcc57cdf55e0927071c6b917e04
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(47,43-51,47); use=OPLSS2021.Vector.fst(47,43-51,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_fd111dcc57cdf55e0927071c6b917e04 @x0
@x1
@x2
@x3)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_fd111dcc57cdf55e0927071c6b917e04 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_fd111dcc57cdf55e0927071c6b917e04))

:named haseqTm_refine_fd111dcc57cdf55e0927071c6b917e04))
(declare-fun OPLSS2021.Vector.fold_right (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;f: (_: a -> _: b -> b) ->     v: vector a n ->     acc: b{n << n \/ n === n /\ (v << v \/ v === v /\ acc << acc)}   -> b
(declare-fun Tm_arrow_1fc84c3712068e6f76bf1b42c150a869 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_1fc84c3712068e6f76bf1b42c150a869
Tm_type)
:named kinding_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,23-51,47); use=OPLSS2021.Vector.fst(47,29-51,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_1fc84c3712068e6f76bf1b42c150a869)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_1fc84c3712068e6f76bf1b42c150a869))
:qid OPLSS2021.Vector_pre_typing_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869))

:named OPLSS2021.Vector_pre_typing_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(7,23-51,47); use=OPLSS2021.Vector.fst(47,29-51,47)
(forall ((@x0 Term))
...
@x4))
(HasType @x6
(Tm_refine_fd111dcc57cdf55e0927071c6b917e04 @x4
@x1
@x5
@x2)))
...
@x5)
@x6))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869.2))
...
@x1)
@x2))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869.3))
...
@x2)
@x3))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869.4))
...
@x3)
@x4))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869.5))
...
@x4)
@x5))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869.6))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_1fc84c3712068e6f76bf1b42c150a869))
:qid OPLSS2021.Vector_interpretation_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869))

:named OPLSS2021.Vector_interpretation_Tm_arrow_1fc84c3712068e6f76bf1b42c150a869))
(declare-fun OPLSS2021.Vector.fold_right@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(47,8-47,18); use=OPLSS2021.Vector.fst(47,8-47,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Vector.fold_right@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5)
(OPLSS2021.Vector.fold_right @x0
@x1
@x2
@x3
@x4
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT OPLSS2021.Vector.fold_right@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5))
:qid token_correspondence_OPLSS2021.Vector.fold_right))

:named token_correspondence_OPLSS2021.Vector.fold_right))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(47,8-47,18); use=OPLSS2021.Vector.fst(47,8-47,18)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Vector.fold_right@tok
Tm_arrow_1fc84c3712068e6f76bf1b42c150a869))
...
@x5)
@x6)
(OPLSS2021.Vector.fold_right @x1
@x2
@x3
@x4
@x5
...
:pattern ((OPLSS2021.Vector.fold_right @x1
@x2
@x3
@x4
@x5
@x6))
:qid function_token_typing_OPLSS2021.Vector.fold_right.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Vector.fold_right@tok))
:qid function_token_typing_OPLSS2021.Vector.fold_right))

:named function_token_typing_OPLSS2021.Vector.fold_right))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Vector.fst(47,8-47,18); use=OPLSS2021.Vector.fst(47,8-47,18)
...
@x3))
(HasType @x5
(Tm_refine_fd111dcc57cdf55e0927071c6b917e04 @x3
@x0
@x4
@x1)))
(HasType (OPLSS2021.Vector.fold_right @x0
@x1
@x2
@x3
@x4
...
:pattern ((OPLSS2021.Vector.fold_right @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_OPLSS2021.Vector.fold_right))

:named typing_OPLSS2021.Vector.fold_right))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(VNil? v) ==>
;     (forall (b: a) (b: Prims.nat) (b: OPLSS2021.Vector.vector a b).
;         v == OPLSS2021.Vector.VCons b b ==> b << n \/ b === n /\ (b << v \/ b === v /\ acc << acc)))
...
;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Vector.fst(49,4-51,47)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Vector.fst(49,4-51,47)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Vector.fst(49,4-51,47)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Vector.fst(49,4-51,47)
(and (implies 
;; def=OPLSS2021.Vector.fst(47,46-47,47); use=OPLSS2021.Vector.fst(49,10-49,11)
(and 
;; def=OPLSS2021.Vector.fst(47,46-47,47); use=OPLSS2021.Vector.fst(49,10-49,11)
(not 
;; def=OPLSS2021.Vector.fst(47,46-47,47); use=OPLSS2021.Vector.fst(49,10-49,11)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Vector.fst(49,4-51,47)
(not 
;; def=OPLSS2021.Vector.fst(47,46-47,47); use=OPLSS2021.Vector.fst(49,10-49,11)
(BoxBool_proj_0 (OPLSS2021.Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Vector.fst(49,4-51,47)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=OPLSS2021.Vector.fst(47,46-51,17); use=OPLSS2021.Vector.fst(49,10-51,17)
(= x_afbf7c56af8378e385ccd2b2dc34583b_6
(OPLSS2021.Vector.VCons x_fe28d8bcde588226b4e538b35321de05_2
@x1
@x2
...
;; def=OPLSS2021.Vector.fst(47,43-51,47); use=OPLSS2021.Vector.fst(51,43-51,46)
(or label_2

;; def=OPLSS2021.Vector.fst(49,4-51,47); use=OPLSS2021.Vector.fst(51,43-51,46)
(Valid 
;; def=OPLSS2021.Vector.fst(49,4-51,47); use=OPLSS2021.Vector.fst(51,43-51,46)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(47,43-51,47); use=OPLSS2021.Vector.fst(51,43-51,46)
(and 
;; def=OPLSS2021.Vector.fst(47,43-47,44); use=OPLSS2021.Vector.fst(51,43-51,46)
(Valid 
;; def=OPLSS2021.Vector.fst(47,43-47,44); use=OPLSS2021.Vector.fst(51,43-51,46)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=OPLSS2021.Vector.fst(47,46-51,47); use=OPLSS2021.Vector.fst(51,43-51,46)
(or 
;; def=OPLSS2021.Vector.fst(49,4-51,47); use=OPLSS2021.Vector.fst(51,43-51,46)
(Valid 
;; def=OPLSS2021.Vector.fst(49,4-51,47); use=OPLSS2021.Vector.fst(51,43-51,46)
...
;; def=OPLSS2021.Vector.fst(47,46-51,47); use=OPLSS2021.Vector.fst(51,43-51,46)
(and 
;; def=OPLSS2021.Vector.fst(47,46-47,47); use=OPLSS2021.Vector.fst(51,43-51,46)
(Valid 
;; def=OPLSS2021.Vector.fst(47,46-47,47); use=OPLSS2021.Vector.fst(51,43-51,46)
(Prims.op_Equals_Equals_Equals (OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
@x2)
(OPLSS2021.Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Vector.fold_right, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_afbf7c56af8378e385ccd2b2dc34583b_6, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_5, data_elim_OPLSS2021.Vector.VCons, disc_equation_OPLSS2021.Vector.VCons, disc_equation_OPLSS2021.Vector.VNil, equation_Prims.nat, fuel_guarded_inversion_OPLSS2021.Vector.vector, int_inversion, int_typing, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_OPLSS2021.Vector.VCons_n, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
