...
; Internals for OPLSS2021.BasicState
...
(declare-fun OPLSS2021.BasicState.st (Term Term) Term)

(declare-fun OPLSS2021.BasicState.st@tok () Term)
;;;;;;;;;;;;;;;;_: s -> a & s
...
(declare-fun OPLSS2021.BasicState.return (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> s: Type -> st a s
(declare-fun Tm_arrow_b10636ced15dddac2dbc3cc503f771dc () Term)
(declare-fun OPLSS2021.BasicState.return@tok () Term)
...
;;;;;;;;;;;;;;;;_: a -> st b s
(declare-fun Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc (Term Term Term) Term)
(declare-fun OPLSS2021.BasicState.bind (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> s: Type -> f: st a s -> g: (_: a -> st b s) -> st b s
(declare-fun Tm_arrow_abb11b48cebca31c1f0b6dcbd4e5d72f () Term)
(declare-fun OPLSS2021.BasicState.bind@tok () Term)
...
(declare-fun OPLSS2021.BasicState.get (Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> st s s
(declare-fun Tm_arrow_7c8e7be29de1c53fbea507e1cfc3b019 () Term)
(declare-fun OPLSS2021.BasicState.get@tok () Term)
;;;;;;;;;;;;;;;;s: s -> s & s
...
(declare-fun OPLSS2021.BasicState.put (Term Term) Term)
;;;;;;;;;;;;;;;;x: s -> st Prims.unit s
(declare-fun Tm_arrow_1ec33282cf753fd825bff2bca0135d70 () Term)
(declare-fun OPLSS2021.BasicState.put@tok () Term)
;;;;;;;;;;;;;;;;s: s -> Prims.unit & s
(declare-fun Tm_arrow_49b2624aa26b413e2f62db699cf87966 (Term) Term)
(declare-fun Tm_abs_da8b16755fd23aa6b25d249de5b5cefd (Term) Term)
...
;;; Fact-ids: Name OPLSS2021.BasicState.return; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(28,13-28,17); use=OPLSS2021.BasicState.fst(28,13-28,17)
...
;;; Fact-ids: Name OPLSS2021.BasicState.bind; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(33,12-35,12); use=OPLSS2021.BasicState.fst(33,12-35,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.BasicState.st; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(23,4-23,6); use=OPLSS2021.BasicState.fst(23,4-23,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (OPLSS2021.BasicState.st @x0
@x1)
Tm_type))
 

:pattern ((OPLSS2021.BasicState.st @x0
@x1))
:qid typing_OPLSS2021.BasicState.st))

:named typing_OPLSS2021.BasicState.st))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.BasicState.return; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(26,4-26,10); use=OPLSS2021.BasicState.fst(26,4-26,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
Tm_type))
(HasType (OPLSS2021.BasicState.return @x0
@x1
@x2)
(OPLSS2021.BasicState.st @x0
@x2)))
 

:pattern ((OPLSS2021.BasicState.return @x0
@x1
@x2))
:qid typing_OPLSS2021.BasicState.return))

:named typing_OPLSS2021.BasicState.return))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.BasicState.bind; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(31,4-31,8); use=OPLSS2021.BasicState.fst(31,4-31,8)
...
@x2))
(HasType @x4
(Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc @x2
@x1
@x0)))
(HasType (OPLSS2021.BasicState.bind @x0
@x1
@x2
@x3
@x4)
(OPLSS2021.BasicState.st @x1
@x2)))
 

:pattern ((OPLSS2021.BasicState.bind @x0
@x1
@x2
@x3
@x4))
:qid typing_OPLSS2021.BasicState.bind))

:named typing_OPLSS2021.BasicState.bind))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name OPLSS2021.BasicState.st; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(23,17-23,38); use=OPLSS2021.BasicState.fst(23,28-23,38)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc
;;; Fact-ids: Name OPLSS2021.BasicState.bind; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(31,9-31,40); use=OPLSS2021.BasicState.fst(31,29-31,40)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc))

:named kinding_Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc))
...
;;;;;;;;;;;;;;;;Equation for OPLSS2021.BasicState.st
;;; Fact-ids: Name OPLSS2021.BasicState.st; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(23,4-23,6); use=OPLSS2021.BasicState.fst(23,4-23,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (OPLSS2021.BasicState.st @x0
@x1)
(Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe @x0
@x1))
 

:pattern ((OPLSS2021.BasicState.st @x0
@x1))
:qid equation_OPLSS2021.BasicState.st))

:named equation_OPLSS2021.BasicState.st))
;;;;;;;;;;;;;;;;Equation for OPLSS2021.BasicState.return
;;; Fact-ids: Name OPLSS2021.BasicState.return; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(26,4-26,10); use=OPLSS2021.BasicState.fst(26,4-26,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (OPLSS2021.BasicState.return @x0
@x1
@x2)
(Tm_abs_a02c4ab615d86c1fd4d6707b08902221 @x1
@x0
@x2))
...
@x1
@x2))
:qid equation_OPLSS2021.BasicState.return))

:named equation_OPLSS2021.BasicState.return))
;;;;;;;;;;;;;;;;Equation for OPLSS2021.BasicState.bind
;;; Fact-ids: Name OPLSS2021.BasicState.bind; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(31,4-31,8); use=OPLSS2021.BasicState.fst(31,4-31,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (OPLSS2021.BasicState.bind @x0
@x1
@x2
@x3
@x4)
...
@x3
@x4))
:qid equation_OPLSS2021.BasicState.bind))

:named equation_OPLSS2021.BasicState.bind))
...
(Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe @x2
@x3)))
:qid OPLSS2021.BasicState_pre_typing_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))

:named OPLSS2021.BasicState_pre_typing_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name OPLSS2021.BasicState.bind; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(31,9-31,40); use=OPLSS2021.BasicState.fst(31,29-31,40)
...
@x3
@x4)))
:qid OPLSS2021.BasicState_pre_typing_Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc))

:named OPLSS2021.BasicState_pre_typing_Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc))
...
:pattern ((ApplyTT @x0
@x3))
:qid OPLSS2021.BasicState_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe.1))
...
(Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe @x1
@x2)))
:qid OPLSS2021.BasicState_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))

:named OPLSS2021.BasicState_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc
;;; Fact-ids: Name OPLSS2021.BasicState.bind; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(31,9-31,40); use=OPLSS2021.BasicState.fst(31,29-31,40)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc @x1
@x2
@x3))
(and 
;; def=OPLSS2021.BasicState.fst(31,9-31,40); use=OPLSS2021.BasicState.fst(31,29-31,40)
...
(HasType (ApplyTT @x0
@x4)
(OPLSS2021.BasicState.st @x2
@x1)))
 

:pattern ((ApplyTT @x0
@x4))
:qid OPLSS2021.BasicState_interpretation_Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc.1))
...
@x2
@x3)))
:qid OPLSS2021.BasicState_interpretation_Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc))

:named OPLSS2021.BasicState_interpretation_Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,5-59,11); use=FStar.Pervasives.Native.fst(59,5-59,11)
...
; Starting query at OPLSS2021.BasicState.fst(45,4-45,6)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


(declare-fun Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(23,33-23,38); use=OPLSS2021.BasicState.fst(45,4-45,6)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x0
@x1)
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x1))
 

:pattern ((Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x0
@x1))
:qid typing_Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a))

:named typing_Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(23,33-23,38); use=OPLSS2021.BasicState.fst(45,4-45,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x1
@x2)
@x0)
(FStar.Pervasives.Native.tuple2 @x1
@x2))
...
:pattern ((ApplyTT (Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x1
@x2)
@x0))
:qid interpretation_Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a))

:named interpretation_Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a))

; Encoding query formula : forall (a: Type) (b: Type) (s: Type) (x: a) (f: (_: a -> OPLSS2021.BasicState.st b s)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.FunctionalExtensionality.feq (OPLSS2021.BasicState.bind a
;               b
;               s
;               (OPLSS2021.BasicState.return a x s)
;               f)
;           (f x) ==>
;         p pure_result) ==>
...
;; def=Prims.fst(441,36-441,97); use=OPLSS2021.BasicState.fst(45,4-45,6)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=OPLSS2021.BasicState.fst(44,10-44,51); use=OPLSS2021.BasicState.fst(45,4-45,6)
(or label_2
...
(Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x1
@x2)
(OPLSS2021.BasicState.bind @x0
@x1
@x2
...
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.BasicState.fst(45,4-45,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.BasicState.fst(45,4-45,6)
(ApplyTT @x5
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.BasicState.left_unit, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.FunctionalExtensionality.feq, equation_OPLSS2021.BasicState.bind, equation_OPLSS2021.BasicState.return, interpretation_Tm_abs_7706f980135a89a687c904d968136d5b, interpretation_Tm_abs_a02c4ab615d86c1fd4d6707b08902221, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun OPLSS2021.BasicState.left_unit (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun OPLSS2021.BasicState.left_unit@tok () Term)

; </end encoding let left_unit>

(push) ;; push{2

; Starting query at OPLSS2021.BasicState.fst(49,4-49,6)
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(23,33-23,38); use=OPLSS2021.BasicState.fst(49,4-49,6)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x0
@x1)
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x1))
...
:named interpretation_Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a))
;;;;;;;;;;;;;;;;x: a -> st a s
(declare-fun Tm_arrow_81757cfa327f539eb864fd7010aa056e (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_81757cfa327f539eb864fd7010aa056e
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(31,34-47,16); use=OPLSS2021.BasicState.fst(48,16-49,6)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_81757cfa327f539eb864fd7010aa056e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_81757cfa327f539eb864fd7010aa056e @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_81757cfa327f539eb864fd7010aa056e))

:named kinding_Tm_arrow_81757cfa327f539eb864fd7010aa056e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(31,34-47,16); use=OPLSS2021.BasicState.fst(48,16-49,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_81757cfa327f539eb864fd7010aa056e @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_81757cfa327f539eb864fd7010aa056e @x2
@x3)))
:qid OPLSS2021.BasicState_pre_typing_Tm_arrow_81757cfa327f539eb864fd7010aa056e))

:named OPLSS2021.BasicState_pre_typing_Tm_arrow_81757cfa327f539eb864fd7010aa056e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_81757cfa327f539eb864fd7010aa056e
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(31,34-47,16); use=OPLSS2021.BasicState.fst(48,16-49,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_81757cfa327f539eb864fd7010aa056e @x1
@x2))
(and 
;; def=OPLSS2021.BasicState.fst(31,34-47,16); use=OPLSS2021.BasicState.fst(48,16-49,6)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid OPLSS2021.BasicState_interpretation_Tm_arrow_81757cfa327f539eb864fd7010aa056e.1))
...
(Tm_arrow_81757cfa327f539eb864fd7010aa056e @x1
@x2)))
:qid OPLSS2021.BasicState_interpretation_Tm_arrow_81757cfa327f539eb864fd7010aa056e))

:named OPLSS2021.BasicState_interpretation_Tm_arrow_81757cfa327f539eb864fd7010aa056e))
(declare-fun Tm_abs_691963f23579a36e889cc7f98eaa1210 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_691963f23579a36e889cc7f98eaa1210
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(48,34-48,46); use=OPLSS2021.BasicState.fst(49,4-49,6)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_691963f23579a36e889cc7f98eaa1210 @x0
@x1)
(Tm_arrow_81757cfa327f539eb864fd7010aa056e @x0
@x1))
 

:pattern ((Tm_abs_691963f23579a36e889cc7f98eaa1210 @x0
@x1))
:qid typing_Tm_abs_691963f23579a36e889cc7f98eaa1210))

:named typing_Tm_abs_691963f23579a36e889cc7f98eaa1210))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_691963f23579a36e889cc7f98eaa1210
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(48,34-48,46); use=OPLSS2021.BasicState.fst(49,4-49,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_691963f23579a36e889cc7f98eaa1210 @x1
@x2)
@x0)
(OPLSS2021.BasicState.return @x2
@x0
@x1))
 

:pattern ((ApplyTT (Tm_abs_691963f23579a36e889cc7f98eaa1210 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_691963f23579a36e889cc7f98eaa1210))

:named interpretation_Tm_abs_691963f23579a36e889cc7f98eaa1210))

; Encoding query formula : forall (a: Type) (s: Type) (f: OPLSS2021.BasicState.st a s).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
...
;               s
;               f
;               (fun x -> OPLSS2021.BasicState.return a x s))
;           f ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)
...
;; def=Prims.fst(441,36-441,97); use=OPLSS2021.BasicState.fst(49,4-49,6)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=OPLSS2021.BasicState.fst(48,10-48,58); use=OPLSS2021.BasicState.fst(49,4-49,6)
(or label_2

;; def=OPLSS2021.BasicState.fst(48,10-48,58); use=OPLSS2021.BasicState.fst(49,4-49,6)
(Valid 
;; def=OPLSS2021.BasicState.fst(48,10-48,58); use=OPLSS2021.BasicState.fst(49,4-49,6)
(FStar.FunctionalExtensionality.feq @x1
(Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x0
@x1)
(OPLSS2021.BasicState.bind @x0
@x0
@x1
@x2
(Tm_abs_691963f23579a36e889cc7f98eaa1210 @x1
@x0))
@x2)
)
)
...
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.BasicState.fst(49,4-49,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.BasicState.fst(49,4-49,6)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.BasicState.right_unit, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, OPLSS2021.BasicState_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe, equation_FStar.FunctionalExtensionality.feq, equation_OPLSS2021.BasicState.bind, equation_OPLSS2021.BasicState.return, equation_OPLSS2021.BasicState.st, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, interpretation_Tm_abs_691963f23579a36e889cc7f98eaa1210, interpretation_Tm_abs_7706f980135a89a687c904d968136d5b, interpretation_Tm_abs_a02c4ab615d86c1fd4d6707b08902221
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun OPLSS2021.BasicState.right_unit (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun OPLSS2021.BasicState.right_unit@tok () Term)

; </end encoding let right_unit>

(push) ;; push{2

; Starting query at OPLSS2021.BasicState.fst(54,4-54,6)
...
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(23,33-23,38); use=OPLSS2021.BasicState.fst(54,4-54,6)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x0
@x1)
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x1))
...
(declare-fun Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(53,34-53,52); use=OPLSS2021.BasicState.fst(54,4-54,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (HasType (Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a @x0
@x1
@x2
@x3
@x4
@x5)
(Tm_arrow_4f5c8ee507cf690dfeaeaa0ce1dd18cc @x3
@x4
@x5))
 

:pattern ((Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a))

:named typing_Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(53,34-53,52); use=OPLSS2021.BasicState.fst(54,4-54,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (ApplyTT (Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a @x1
@x2
@x3
@x4
@x5
...
:pattern ((ApplyTT (Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a @x1
@x2
@x3
@x4
@x5
@x6)
@x0))
:qid interpretation_Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a))

:named interpretation_Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (c: Type)
;   (s: Type)
;   (f: OPLSS2021.BasicState.st a s)
;   (g: (_: a -> OPLSS2021.BasicState.st b s))
;   (h: (_: b -> OPLSS2021.BasicState.st c s)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.FunctionalExtensionality.feq (OPLSS2021.BasicState.bind b
;               c
;               s
;               (OPLSS2021.BasicState.bind a b s f g)
;               h)
;           (OPLSS2021.BasicState.bind a c s f (fun x -> OPLSS2021.BasicState.bind b c s (g x) h)) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let assoc`
...
;; def=Prims.fst(441,36-441,97); use=OPLSS2021.BasicState.fst(54,4-54,6)
(forall ((@x8 Term))
 (! (implies (and (or label_1
(HasType @x8
Prims.unit))

;; def=OPLSS2021.BasicState.fst(52,10-53,54); use=OPLSS2021.BasicState.fst(54,4-54,6)
(or label_2
...
(Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x2
@x3)
(OPLSS2021.BasicState.bind @x1
@x2
@x3
...
@x3
@x4
(Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a @x1
@x5
@x6
@x3
@x2
...
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.BasicState.fst(54,4-54,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.BasicState.fst(54,4-54,6)
(ApplyTT @x7
@x8)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.BasicState.assoc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.FunctionalExtensionality.feq, equation_OPLSS2021.BasicState.bind, interpretation_Tm_abs_7706f980135a89a687c904d968136d5b, interpretation_Tm_abs_e92ddfe3fe3bd3ce88f858edd91a0f1a
...
; encoding sigelt let assoc


; <Start encoding let assoc>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun OPLSS2021.BasicState.assoc (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun OPLSS2021.BasicState.assoc@tok () Term)

; </end encoding let assoc>
...
(declare-fun OPLSS2021.BasicState.pure (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> Type
(declare-fun Tm_arrow_f4c25a8bbe10635e54f7128744564e67 () Term)
(declare-fun OPLSS2021.BasicState.pure@tok () Term)
...
;;; Fact-ids: Name OPLSS2021.BasicState.pure; Namespace OPLSS2021.BasicState
(assert (! 
;; def=Prims.fst(630,69-630,73); use=OPLSS2021.BasicState.fst(93,29-93,30)
(forall ((@x0 Term))
...
;;; Fact-ids: Name OPLSS2021.BasicState.pure; Namespace OPLSS2021.BasicState
(assert (! 
;; def=Prims.fst(635,86-635,95); use=OPLSS2021.BasicState.fst(93,29-93,30)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name OPLSS2021.BasicState.pure; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(93,4-93,8); use=OPLSS2021.BasicState.fst(93,4-93,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Prims.pure_wp @x0)))
(HasType (OPLSS2021.BasicState.pure @x0
@x1)
Tm_type))
 

:pattern ((OPLSS2021.BasicState.pure @x0
@x1))
:qid typing_OPLSS2021.BasicState.pure))

:named typing_OPLSS2021.BasicState.pure))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;; Fact-ids: Name OPLSS2021.BasicState.pure; Namespace OPLSS2021.BasicState
(assert (! 
;; def=Prims.fst(315,31-315,40); use=OPLSS2021.BasicState.fst(93,29-93,30)
(forall ((@x0 Term))
...
;;; Fact-ids: Name OPLSS2021.BasicState.pure; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(93,9-93,10); use=OPLSS2021.BasicState.fst(93,29-93,30)
(forall ((@x0 Term) (@x1 Term))
...
;; def=Prims.fst(635,71-635,97); use=OPLSS2021.BasicState.fst(93,29-93,30)
(not 
;; def=Prims.fst(635,72-635,97); use=OPLSS2021.BasicState.fst(93,29-93,30)
(Valid 
;; def=Prims.fst(635,72-635,97); use=OPLSS2021.BasicState.fst(93,29-93,30)
(ApplyTT @x2
...
;;; Fact-ids: Name OPLSS2021.BasicState.pure; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(93,9-93,20); use=OPLSS2021.BasicState.fst(93,16-93,30)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name OPLSS2021.BasicState.pure; Namespace OPLSS2021.BasicState
(assert (! 
;; def=Prims.fst(315,31-315,54); use=OPLSS2021.BasicState.fst(93,29-93,30)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;Equation for OPLSS2021.BasicState.pure
;;; Fact-ids: Name OPLSS2021.BasicState.pure; Namespace OPLSS2021.BasicState
(assert (! 
;; def=OPLSS2021.BasicState.fst(93,4-93,8); use=OPLSS2021.BasicState.fst(93,4-93,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (OPLSS2021.BasicState.pure @x0
@x1)
...
:pattern ((OPLSS2021.BasicState.pure @x0
@x1))
:qid equation_OPLSS2021.BasicState.pure))

:named equation_OPLSS2021.BasicState.pure))
;;;;;;;;;;;;;;;;Eq2 interpretation
;;; Fact-ids: Name Prims.eq2; Namespace Prims
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (= @x1
...
(Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd @x2
@x3)))
:qid OPLSS2021.BasicState_pre_typing_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))

:named OPLSS2021.BasicState_pre_typing_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name OPLSS2021.BasicState.pure; Namespace OPLSS2021.BasicState
(assert (! 
;; def=Prims.fst(315,31-315,54); use=OPLSS2021.BasicState.fst(93,29-93,30)
...
@x1
(Tm_arrow_61bb9550f39772f18eaab129c43c3788 @x2)))
:qid OPLSS2021.BasicState_pre_typing_Tm_arrow_61bb9550f39772f18eaab129c43c3788))

:named OPLSS2021.BasicState_pre_typing_Tm_arrow_61bb9550f39772f18eaab129c43c3788))
...
(forall ((@x3 Term))
 (! (implies (and 
;; def=Prims.fst(630,56-630,74); use=OPLSS2021.BasicState.fst(93,29-93,30)
(Valid 
;; def=Prims.fst(630,56-630,74); use=OPLSS2021.BasicState.fst(93,29-93,30)
(ApplyTT @x2
...
:pattern ((ApplyTT @x0
@x3))
:qid OPLSS2021.BasicState_interpretation_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd.1))
...
(Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd @x1
@x2)))
:qid OPLSS2021.BasicState_interpretation_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))

:named OPLSS2021.BasicState_interpretation_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))
...
:pattern ((ApplyTT @x0
@x2))
:qid OPLSS2021.BasicState_interpretation_Tm_arrow_61bb9550f39772f18eaab129c43c3788.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_61bb9550f39772f18eaab129c43c3788 @x1)))
:qid OPLSS2021.BasicState_interpretation_Tm_arrow_61bb9550f39772f18eaab129c43c3788))

:named OPLSS2021.BasicState_interpretation_Tm_arrow_61bb9550f39772f18eaab129c43c3788))
(push) ;; push{2

; Starting query at OPLSS2021.BasicState.fst(101,4-101,19)
...
(declare-fun Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(101,13-101,19); use=OPLSS2021.BasicState.fst(101,13-101,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921 @x0
@x1
@x2)
(Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe @x1
@x2))
...
:pattern ((Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921 @x0
@x1
@x2))
:qid typing_Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921))

:named typing_Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.BasicState.fst(101,13-101,19); use=OPLSS2021.BasicState.fst(101,13-101,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921 @x1
@x2
@x3)
@x0)
(FStar.Pervasives.Native.Mktuple2 @x2
...
:pattern ((ApplyTT (Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921))

:named interpretation_Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921))



; Encoding query formula : forall (a: Type) (s: Type) (wp: Prims.pure_wp a) (f: OPLSS2021.BasicState.pure a wp).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (OPLSS2021.BasicState.st a s)).
;     wp (fun _ -> Prims.l_True) /\
;     (forall (pure_result: OPLSS2021.BasicState.st a s). Prims.auto_squash (p pure_result)) ==>
;     (forall (s: s).
;         (*  - Could not prove post-condition
; *) Prims.auto_squash (wp (fun _ -> Prims.l_True))) /\
;     (forall (any_result: OPLSS2021.BasicState.st a s).
;         any_result == (fun s -> f (), s) ==>
;         (forall (return_val: OPLSS2021.BasicState.st a s). return_val == any_result ==> p return_val
;         ))
...
(Prims.pure_post (OPLSS2021.BasicState.st @x0
@x1)))

;; def=OPLSS2021.BasicState.fst(99,19-99,37); use=OPLSS2021.BasicState.fst(101,4-101,19)
(Valid 
;; def=OPLSS2021.BasicState.fst(99,19-99,37); use=OPLSS2021.BasicState.fst(101,4-101,19)
(ApplyTT @x2
...
;; def=Prims.fst(441,36-441,97); use=OPLSS2021.BasicState.fst(101,4-101,19)
(forall ((@x5 Term))
 (! (implies (or label_1
(HasType @x5
(OPLSS2021.BasicState.st @x0
...
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.BasicState.fst(101,4-101,19)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.BasicState.fst(101,4-101,19)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.BasicState.fst(101,4-101,19)
(and 
;; def=dummy(0,0-0,0); use=OPLSS2021.BasicState.fst(101,4-101,19)
(forall ((@x5 Term))
 (! (implies (HasType @x5
@x1)

;; def=Prims.fst(369,7-369,58); use=OPLSS2021.BasicState.fst(101,13-101,19)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=OPLSS2021.BasicState.fst(101,4-101,19)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(OPLSS2021.BasicState.st @x0
@x1))

;; def=OPLSS2021.BasicState.fst(98,9-101,19); use=OPLSS2021.BasicState.fst(101,4-101,19)
(= @x5
(Tm_abs_e4d112c5a3f3bef4c5d9b3cafa3db921 @x3
@x0
@x1))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.BasicState.lift_pure_st, 1)
; STATUS: unsat
...
(declare-fun OPLSS2021.BasicState.lift_pure_st (Term Term Term Term) Term)
(declare-fun Tm_refine_f641e27622d8df7ebe5b839a2a25414d (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> s: Type -> wp: Prims.pure_wp a -> f: pure a wp -> Prims.Pure (st a s)
(declare-fun Tm_arrow_ba69927f14de1359c246fedb527c7d6e () Term)
(declare-fun OPLSS2021.BasicState.lift_pure_st@tok () Term)
...
; Starting query at OPLSS2021.BasicState.fst(105,0-105,36)
...
;   (s: Type0)
;   (wp: Prims.pure_wp a)
;   (p: Prims.pure_post (OPLSS2021.BasicState.st a s))
;   (q: Prims.pure_post (OPLSS2021.BasicState.st a s)).
;   (forall (x: OPLSS2021.BasicState.st a s). p x ==> q x) ==>
;   wp (fun _ -> Prims.l_True) /\
;   (forall (pure_result: OPLSS2021.BasicState.st a s). Prims.auto_squash (p pure_result)) ==>
;   wp (fun _ -> Prims.l_True) /\
;   (forall (pure_result: OPLSS2021.BasicState.st a s). Prims.auto_squash (q pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `sub_effect PURE ~> ST`
...
;; def=OPLSS2021.BasicState.fst(99,19-99,37); use=OPLSS2021.BasicState.fst(105,24-105,36)
(Valid 
;; def=OPLSS2021.BasicState.fst(99,19-99,37); use=OPLSS2021.BasicState.fst(105,24-105,36)
(ApplyTT @x2
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x0))
...
;; def=Prims.fst(441,36-441,97); use=OPLSS2021.BasicState.fst(105,24-105,36)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(OPLSS2021.BasicState.st @x0
@x1))

;; def=Prims.fst(441,83-441,96); use=OPLSS2021.BasicState.fst(105,24-105,36)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.BasicState.fst(105,24-105,36)
(ApplyTT @x3
@x5)
...
;; def=Prims.fst(441,29-441,97); use=OPLSS2021.BasicState.fst(105,24-105,36)
(and 
;; def=OPLSS2021.BasicState.fst(99,19-99,37); use=OPLSS2021.BasicState.fst(105,24-105,36)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.BasicState.0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
