...
; Internals for OPLSS2021.Factorial
...
; Starting query at OPLSS2021.Factorial.fst(6,4-6,46)
...
(declare-fun Tm_refine_1db4443cda0c2d8990721d6beef63005 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_1db4443cda0c2d8990721d6beef63005
Tm_type)
:named refinement_kinding_Tm_refine_1db4443cda0c2d8990721d6beef63005))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(4,19-6,46); use=OPLSS2021.Factorial.fst(4,19-6,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_1db4443cda0c2d8990721d6beef63005)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=OPLSS2021.Factorial.fst(6,4-6,46); use=OPLSS2021.Factorial.fst(6,4-6,46)
...
@x1
Tm_refine_1db4443cda0c2d8990721d6beef63005))
:qid refinement_interpretation_Tm_refine_1db4443cda0c2d8990721d6beef63005))

:named refinement_interpretation_Tm_refine_1db4443cda0c2d8990721d6beef63005))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1db4443cda0c2d8990721d6beef63005
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_1db4443cda0c2d8990721d6beef63005))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_1db4443cda0c2d8990721d6beef63005))
(declare-fun OPLSS2021.Factorial.factorial (Term) Term)

;;;;;;;;;;;;;;;;n: Prims.nat{n << n} -> Prims.nat
(declare-fun Tm_arrow_2d425a8a190d08ab11e380d8f051deba () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2d425a8a190d08ab11e380d8f051deba
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_2d425a8a190d08ab11e380d8f051deba
Tm_type)
:named kinding_Tm_arrow_2d425a8a190d08ab11e380d8f051deba))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(4,19-6,46); use=OPLSS2021.Factorial.fst(4,19-6,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2d425a8a190d08ab11e380d8f051deba)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_2d425a8a190d08ab11e380d8f051deba))
:qid OPLSS2021.Factorial_pre_typing_Tm_arrow_2d425a8a190d08ab11e380d8f051deba))

:named OPLSS2021.Factorial_pre_typing_Tm_arrow_2d425a8a190d08ab11e380d8f051deba))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2d425a8a190d08ab11e380d8f051deba
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(4,19-6,46); use=OPLSS2021.Factorial.fst(4,19-6,46)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Factorial_interpretation_Tm_arrow_2d425a8a190d08ab11e380d8f051deba.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_2d425a8a190d08ab11e380d8f051deba))
:qid OPLSS2021.Factorial_interpretation_Tm_arrow_2d425a8a190d08ab11e380d8f051deba))

:named OPLSS2021.Factorial_interpretation_Tm_arrow_2d425a8a190d08ab11e380d8f051deba))
(declare-fun OPLSS2021.Factorial.factorial@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(4,8-4,17); use=OPLSS2021.Factorial.fst(4,8-4,17)
(forall ((@x0 Term))
 (! (= (ApplyTT OPLSS2021.Factorial.factorial@tok
@x0)
(OPLSS2021.Factorial.factorial @x0))
 

:pattern ((ApplyTT OPLSS2021.Factorial.factorial@tok
@x0))
:qid token_correspondence_OPLSS2021.Factorial.factorial))

:named token_correspondence_OPLSS2021.Factorial.factorial))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(4,8-4,17); use=OPLSS2021.Factorial.fst(4,8-4,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Factorial.factorial@tok
Tm_arrow_2d425a8a190d08ab11e380d8f051deba))
...
(forall ((@x1 Term))
 (! (= (ApplyTT OPLSS2021.Factorial.factorial@tok
@x1)
(OPLSS2021.Factorial.factorial @x1))
 

:pattern ((OPLSS2021.Factorial.factorial @x1))
:qid function_token_typing_OPLSS2021.Factorial.factorial.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Factorial.factorial@tok))
:qid function_token_typing_OPLSS2021.Factorial.factorial))

:named function_token_typing_OPLSS2021.Factorial.factorial))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(4,8-4,17); use=OPLSS2021.Factorial.fst(4,8-4,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_1db4443cda0c2d8990721d6beef63005)
(HasType (OPLSS2021.Factorial.factorial @x0)
Prims.nat))
 

:pattern ((OPLSS2021.Factorial.factorial @x0))
:qid typing_OPLSS2021.Factorial.factorial))

:named typing_OPLSS2021.Factorial.factorial))
...
;               OPLSS2021.Factorial.factorial (n - 1) == any_result ==>
;               (forall (return_val: Prims.nat).
;                   return_val == OPLSS2021.Factorial.factorial (n - 1) ==>
;                   OPLSS2021.Factorial.factorial (n - 1) == return_val ==>
;                   (forall (any_result: Prims.int).
;                       n * OPLSS2021.Factorial.factorial (n - 1) == any_result ==>
;                       n * OPLSS2021.Factorial.factorial (n - 1) >= 0)))))
...
;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Factorial.fst(6,4-6,46)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Factorial.fst(6,4-6,46)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Factorial.fst(6,4-6,46)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Factorial.fst(6,4-6,46)
(not 
;; def=OPLSS2021.Factorial.fst(6,7-6,12); use=OPLSS2021.Factorial.fst(6,7-6,12)
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Factorial.fst(6,4-6,46)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=OPLSS2021.Factorial.fst(6,7-6,46); use=OPLSS2021.Factorial.fst(6,7-6,46)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
@x1)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Factorial.fst(6,4-6,46)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Factorial.fst(6,39-6,46)
(or label_1
...
;; def=OPLSS2021.Factorial.fst(6,4-6,46); use=OPLSS2021.Factorial.fst(6,39-6,46)
(or label_2
...
;; def=Prims.fst(356,2-356,58); use=OPLSS2021.Factorial.fst(6,4-6,46)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_1db4443cda0c2d8990721d6beef63005)

;; def=Prims.fst(356,26-356,41); use=OPLSS2021.Factorial.fst(6,4-6,46)
(= @x2
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
)

;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Factorial.fst(6,4-6,46)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)

;; def=OPLSS2021.Factorial.fst(5,4-6,46); use=OPLSS2021.Factorial.fst(6,29-6,46)
(= (OPLSS2021.Factorial.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
@x3)
)
...
;; def=dummy(0,0-0,0); use=OPLSS2021.Factorial.fst(6,4-6,46)
(= (OPLSS2021.Factorial.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
@x4)
)
...
;; def=OPLSS2021.Factorial.fst(5,4-6,46); use=OPLSS2021.Factorial.fst(6,4-6,46)
...
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Factorial.fst(6,25-6,46)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Factorial.factorial, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0, equation_Prims.nat, int_inversion, int_typing, primitive_Prims.op_Equality, primitive_Prims.op_Multiply, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_1db4443cda0c2d8990721d6beef63005, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun OPLSS2021.Factorial.factorial.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun OPLSS2021.Factorial.factorial.fuel_instrumented_token () Term)
(declare-fun OPLSS2021.Factorial.factorial (Term) Term)
(declare-fun OPLSS2021.Factorial.factorial@tok () Term)
;;;;;;;;;;;;;;;;n: Prims.nat -> Prims.nat
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS2021.Factorial.factorial; Namespace OPLSS2021.Factorial
(assert (! 
;; def=OPLSS2021.Factorial.fst(4,8-4,17); use=OPLSS2021.Factorial.fst(4,8-4,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
Prims.nat)
(HasType (OPLSS2021.Factorial.factorial.fuel_instrumented @u0
@x1)
Prims.nat))
 

:pattern ((OPLSS2021.Factorial.factorial.fuel_instrumented @u0
@x1))
:qid token_correspondence_OPLSS2021.Factorial.factorial.fuel_instrumented))

:named token_correspondence_OPLSS2021.Factorial.factorial.fuel_instrumented))
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: OPLSS2021.Factorial.factorial
;;; Fact-ids: Name OPLSS2021.Factorial.factorial; Namespace OPLSS2021.Factorial
(assert (! 
;; def=OPLSS2021.Factorial.fst(4,8-4,17); use=OPLSS2021.Factorial.fst(4,8-4,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
Prims.nat)
(= (OPLSS2021.Factorial.factorial.fuel_instrumented (SFuel @u0)
@x1)
...
(OPLSS2021.Factorial.factorial.fuel_instrumented @u0
(Prims.op_Subtraction @x1
(BoxInt 1))))))))
 :weight 0


:pattern ((OPLSS2021.Factorial.factorial.fuel_instrumented (SFuel @u0)
@x1))
:qid equation_with_fuel_OPLSS2021.Factorial.factorial.fuel_instrumented))

:named equation_with_fuel_OPLSS2021.Factorial.factorial.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name OPLSS2021.Factorial.factorial; Namespace OPLSS2021.Factorial
(assert (! 
;; def=OPLSS2021.Factorial.fst(4,8-4,17); use=OPLSS2021.Factorial.fst(4,8-4,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (= (OPLSS2021.Factorial.factorial.fuel_instrumented (SFuel @u0)
@x1)
(OPLSS2021.Factorial.factorial.fuel_instrumented ZFuel
@x1))
 

:pattern ((OPLSS2021.Factorial.factorial.fuel_instrumented (SFuel @u0)
@x1))
:qid @fuel_irrelevance_OPLSS2021.Factorial.factorial.fuel_instrumented))

:named @fuel_irrelevance_OPLSS2021.Factorial.factorial.fuel_instrumented))
...
(forall ((@x0 Term))
 (! (= (OPLSS2021.Factorial.factorial @x0)
(OPLSS2021.Factorial.factorial.fuel_instrumented MaxFuel
@x0))
 

:pattern ((OPLSS2021.Factorial.factorial @x0))
:qid @fuel_correspondence_OPLSS2021.Factorial.factorial.fuel_instrumented))

:named @fuel_correspondence_OPLSS2021.Factorial.factorial.fuel_instrumented))
(push) ;; push{2

; Starting query at OPLSS2021.Factorial.fst(10,4-11,37)
...
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0))
(declare-fun Tm_refine_edab8b77a3178283688e5ff2650b3282 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_edab8b77a3178283688e5ff2650b3282
Tm_type)
:named refinement_kinding_Tm_refine_edab8b77a3178283688e5ff2650b3282))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(8,30-11,37); use=OPLSS2021.Factorial.fst(8,30-11,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_edab8b77a3178283688e5ff2650b3282)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=OPLSS2021.Factorial.fst(10,4-11,37); use=OPLSS2021.Factorial.fst(10,4-11,37)
...
@x1
Tm_refine_edab8b77a3178283688e5ff2650b3282))
:qid refinement_interpretation_Tm_refine_edab8b77a3178283688e5ff2650b3282))

:named refinement_interpretation_Tm_refine_edab8b77a3178283688e5ff2650b3282))
;;;;;;;;;;;;;;;;haseq for Tm_refine_edab8b77a3178283688e5ff2650b3282
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_edab8b77a3178283688e5ff2650b3282))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_edab8b77a3178283688e5ff2650b3282))
(declare-fun OPLSS2021.Factorial.factorial_increasing (Term) Term)

(declare-fun Tm_refine_805d547d18d5feb07962ce5257ae60bf (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(9,4-9,28); use=OPLSS2021.Factorial.fst(9,4-9,28)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_805d547d18d5feb07962ce5257ae60bf @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_805d547d18d5feb07962ce5257ae60bf @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_805d547d18d5feb07962ce5257ae60bf))

:named refinement_kinding_Tm_refine_805d547d18d5feb07962ce5257ae60bf))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(9,4-9,28); use=OPLSS2021.Factorial.fst(9,4-9,28)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_805d547d18d5feb07962ce5257ae60bf @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=OPLSS2021.Factorial.fst(9,11-9,27); use=OPLSS2021.Factorial.fst(9,11-9,27)
(>= (BoxInt_proj_0 (OPLSS2021.Factorial.factorial @x2))
(BoxInt_proj_0 @x2))
))
...
@x1
(Tm_refine_805d547d18d5feb07962ce5257ae60bf @x2)))
:qid refinement_interpretation_Tm_refine_805d547d18d5feb07962ce5257ae60bf))

:named refinement_interpretation_Tm_refine_805d547d18d5feb07962ce5257ae60bf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_805d547d18d5feb07962ce5257ae60bf
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(9,4-9,28); use=OPLSS2021.Factorial.fst(9,4-9,28)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_805d547d18d5feb07962ce5257ae60bf @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_805d547d18d5feb07962ce5257ae60bf @x0))))
:qid haseqTm_refine_805d547d18d5feb07962ce5257ae60bf))

:named haseqTm_refine_805d547d18d5feb07962ce5257ae60bf))
;;;;;;;;;;;;;;;;n: Prims.nat{n << n} -> _: Prims.unit{factorial n >= n}
(declare-fun Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f
Tm_type)
:named kinding_Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(8,30-11,37); use=OPLSS2021.Factorial.fst(8,30-11,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f))
:qid OPLSS2021.Factorial_pre_typing_Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f))

:named OPLSS2021.Factorial_pre_typing_Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(8,30-11,37); use=OPLSS2021.Factorial.fst(8,30-11,37)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_refine_805d547d18d5feb07962ce5257ae60bf @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid OPLSS2021.Factorial_interpretation_Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f))
:qid OPLSS2021.Factorial_interpretation_Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f))

:named OPLSS2021.Factorial_interpretation_Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f))
(declare-fun OPLSS2021.Factorial.factorial_increasing@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(8,8-8,28); use=OPLSS2021.Factorial.fst(8,8-8,28)
(forall ((@x0 Term))
 (! (= (ApplyTT OPLSS2021.Factorial.factorial_increasing@tok
@x0)
(OPLSS2021.Factorial.factorial_increasing @x0))
 

:pattern ((ApplyTT OPLSS2021.Factorial.factorial_increasing@tok
@x0))
:qid token_correspondence_OPLSS2021.Factorial.factorial_increasing))

:named token_correspondence_OPLSS2021.Factorial.factorial_increasing))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(8,8-8,28); use=OPLSS2021.Factorial.fst(8,8-8,28)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType OPLSS2021.Factorial.factorial_increasing@tok
Tm_arrow_545123a4e8ec3265c2afa833eceb8a7f))
...
(forall ((@x1 Term))
 (! (= (ApplyTT OPLSS2021.Factorial.factorial_increasing@tok
@x1)
(OPLSS2021.Factorial.factorial_increasing @x1))
 

:pattern ((OPLSS2021.Factorial.factorial_increasing @x1))
:qid function_token_typing_OPLSS2021.Factorial.factorial_increasing.1))
)
 

:pattern ((ApplyTT @x0
OPLSS2021.Factorial.factorial_increasing@tok))
:qid function_token_typing_OPLSS2021.Factorial.factorial_increasing))

:named function_token_typing_OPLSS2021.Factorial.factorial_increasing))
...
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_edab8b77a3178283688e5ff2650b3282)
(HasType (OPLSS2021.Factorial.factorial_increasing @x0)
(Tm_refine_805d547d18d5feb07962ce5257ae60bf @x0)))
 

:pattern ((OPLSS2021.Factorial.factorial_increasing @x0))
:qid typing_OPLSS2021.Factorial.factorial_increasing))

:named typing_OPLSS2021.Factorial.factorial_increasing))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_87100403787d445abf4e9081e88289da () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_87100403787d445abf4e9081e88289da
Tm_type)
:named refinement_kinding_Tm_refine_87100403787d445abf4e9081e88289da))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(9,4-9,28); use=OPLSS2021.Factorial.fst(10,4-11,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_87100403787d445abf4e9081e88289da)
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=OPLSS2021.Factorial.fst(9,11-9,27); use=OPLSS2021.Factorial.fst(10,4-11,37)
(>= (BoxInt_proj_0 (OPLSS2021.Factorial.factorial x_bb4e1c9af0265270f8e7a5f250f730e2_0))
...
@x1
Tm_refine_87100403787d445abf4e9081e88289da))
:qid refinement_interpretation_Tm_refine_87100403787d445abf4e9081e88289da))

:named refinement_interpretation_Tm_refine_87100403787d445abf4e9081e88289da))
;;;;;;;;;;;;;;;;haseq for Tm_refine_87100403787d445abf4e9081e88289da
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_87100403787d445abf4e9081e88289da))
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_87100403787d445abf4e9081e88289da))

(declare-fun Tm_refine_3bc03000e79592eb4fc737dbd6bb2bf9 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_3bc03000e79592eb4fc737dbd6bb2bf9
Tm_type)
:named refinement_kinding_Tm_refine_3bc03000e79592eb4fc737dbd6bb2bf9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(9,4-9,28); use=OPLSS2021.Factorial.fst(10,4-11,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_3bc03000e79592eb4fc737dbd6bb2bf9)
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=OPLSS2021.Factorial.fst(9,11-9,27); use=OPLSS2021.Factorial.fst(10,4-11,37)
(>= (BoxInt_proj_0 (OPLSS2021.Factorial.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))))
(BoxInt_proj_0 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))))
))
...
@x1
Tm_refine_3bc03000e79592eb4fc737dbd6bb2bf9))
:qid refinement_interpretation_Tm_refine_3bc03000e79592eb4fc737dbd6bb2bf9))

:named refinement_interpretation_Tm_refine_3bc03000e79592eb4fc737dbd6bb2bf9))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3bc03000e79592eb4fc737dbd6bb2bf9
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_3bc03000e79592eb4fc737dbd6bb2bf9))
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_3bc03000e79592eb4fc737dbd6bb2bf9))


; Encoding query formula : forall (k: Prims.pure_post (_: Prims.unit{OPLSS2021.Factorial.factorial n >= n})).
;   (forall (x: _: Prims.unit{OPLSS2021.Factorial.factorial n >= n}).
;       {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (n <= 2 == true ==> OPLSS2021.Factorial.factorial n >= n) /\
;   (~(n <= 2 = true) ==>
;     (forall (b: Prims.bool).
;         n <= 2 == b ==>
;         n - 1 >= 0 /\ n - 1 << n /\
;         (forall (return_val: n: Prims.nat{n << n}).
;             return_val == n - 1 ==>
;             (forall (any_result: _: Prims.unit{OPLSS2021.Factorial.factorial (n - 1) >= n - 1}).
;                 OPLSS2021.Factorial.factorial (n - 1) >= n - 1 ==>
;                 OPLSS2021.Factorial.factorial n >= n))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec factorial_increasing`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Tm_refine_87100403787d445abf4e9081e88289da))

;; def=Prims.fst(402,27-402,88); use=OPLSS2021.Factorial.fst(10,4-11,37)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Factorial.fst(10,4-11,37)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Factorial.fst(10,4-11,37)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,2-389,39); use=OPLSS2021.Factorial.fst(10,4-11,37)
(and (implies 
;; def=OPLSS2021.Factorial.fst(10,7-10,13); use=OPLSS2021.Factorial.fst(10,7-10,13)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2))
(BoxBool true))


;; def=OPLSS2021.Factorial.fst(9,11-9,27); use=OPLSS2021.Factorial.fst(10,19-10,21)
(or label_1
...
(implies 
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Factorial.fst(10,4-11,37)
(not 
;; def=OPLSS2021.Factorial.fst(10,7-10,13); use=OPLSS2021.Factorial.fst(10,7-10,13)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2))
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Factorial.fst(10,4-11,37)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=OPLSS2021.Factorial.fst(10,7-11,37); use=OPLSS2021.Factorial.fst(10,7-11,37)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2))
@x1)
)

;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Factorial.fst(10,4-11,37)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Factorial.fst(11,30-11,37)
(or label_2
...
;; def=OPLSS2021.Factorial.fst(10,4-11,37); use=OPLSS2021.Factorial.fst(11,30-11,37)
(or label_3
...
;; def=Prims.fst(356,2-356,58); use=OPLSS2021.Factorial.fst(10,4-11,37)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_edab8b77a3178283688e5ff2650b3282)

;; def=Prims.fst(356,26-356,41); use=OPLSS2021.Factorial.fst(10,4-11,37)
(= @x2
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
)

;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Factorial.fst(10,4-11,37)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_3bc03000e79592eb4fc737dbd6bb2bf9)

;; def=OPLSS2021.Factorial.fst(9,11-9,27); use=OPLSS2021.Factorial.fst(11,9-11,37)
(>= (BoxInt_proj_0 (OPLSS2021.Factorial.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))))
(BoxInt_proj_0 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Factorial.factorial_increasing, 1)
...
; QUERY ID: (OPLSS2021.Factorial.factorial_increasing, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_OPLSS2021.Factorial.factorial.fuel_instrumented, @fuel_irrelevance_OPLSS2021.Factorial.factorial.fuel_instrumented, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0, equation_Prims.nat, equation_with_fuel_OPLSS2021.Factorial.factorial.fuel_instrumented, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, primitive_Prims.op_Equality, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Multiply, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_OPLSS2021.Factorial.factorial, well-founded-ordering-on-nat
...
; encoding sigelt let rec factorial_increasing


; <Start encoding let rec factorial_increasing>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun OPLSS2021.Factorial.factorial_increasing.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun OPLSS2021.Factorial.factorial_increasing.fuel_instrumented_token () Term)
(declare-fun OPLSS2021.Factorial.factorial_increasing (Term) Term)
(declare-fun OPLSS2021.Factorial.factorial_increasing@tok () Term)
(declare-fun Tm_refine_805d547d18d5feb07962ce5257ae60bf (Term) Term)

;;;;;;;;;;;;;;;;n: Prims.nat -> _: Prims.unit{factorial n >= n}
(declare-fun Tm_arrow_76fdd407572f1bee98f5d6c2ee142cd1 () Term)


; </end encoding let rec factorial_increasing>

(push) ;; push{2

; Starting query at OPLSS2021.Factorial.fst(15,4-16,43)
...
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun OPLSS2021.Factorial.factorial_increasing_lemma (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun OPLSS2021.Factorial.factorial_increasing_lemma@tok () Term)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_0e94307fef231dbbc98f0dd7dd7c1c99 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_0e94307fef231dbbc98f0dd7dd7c1c99
Tm_type)
:named refinement_kinding_Tm_refine_0e94307fef231dbbc98f0dd7dd7c1c99))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS2021.Factorial.fst(13,36-16,43); use=OPLSS2021.Factorial.fst(16,9-16,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_0e94307fef231dbbc98f0dd7dd7c1c99)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=OPLSS2021.Factorial.fst(15,4-16,43); use=OPLSS2021.Factorial.fst(16,9-16,35)
...
@x1
Tm_refine_0e94307fef231dbbc98f0dd7dd7c1c99))
:qid refinement_interpretation_Tm_refine_0e94307fef231dbbc98f0dd7dd7c1c99))

:named refinement_interpretation_Tm_refine_0e94307fef231dbbc98f0dd7dd7c1c99))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0e94307fef231dbbc98f0dd7dd7c1c99
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0e94307fef231dbbc98f0dd7dd7c1c99))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_0e94307fef231dbbc98f0dd7dd7c1c99))

; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit). OPLSS2021.Factorial.factorial n >= n ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (n <= 2 == true ==> (forall (any_result: Prims.unit). k any_result)) /\
;       (~(n <= 2 = true) ==>
;         (forall (b: Prims.bool).
;             n <= 2 == b ==>
;             n - 1 >= 0 /\ n - 1 << n /\
...
;                     OPLSS2021.Factorial.factorial (n - 1) >= n - 1 ==> k pure_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec factorial_increasing_lemma`
...
;;; Fact-ids: 
(assert (! (not 
;; def=OPLSS2021.Factorial.fst(15,4-16,43); use=OPLSS2021.Factorial.fst(15,4-16,43)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=OPLSS2021.Factorial.fst(15,4-16,43)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=OPLSS2021.Factorial.fst(14,10-14,28); use=OPLSS2021.Factorial.fst(15,4-16,43)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.Factorial.fst(15,4-16,43)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.Factorial.fst(15,4-16,43)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=OPLSS2021.Factorial.fst(15,4-16,43)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=OPLSS2021.Factorial.fst(15,4-16,43)
(Valid 
;; def=Prims.fst(402,73-402,79); use=OPLSS2021.Factorial.fst(15,4-16,43)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Factorial.fst(15,4-16,43)
(Valid 
;; def=Prims.fst(402,84-402,87); use=OPLSS2021.Factorial.fst(15,4-16,43)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(389,2-389,39); use=OPLSS2021.Factorial.fst(15,4-16,43)
(and (implies 
;; def=OPLSS2021.Factorial.fst(15,7-15,13); use=OPLSS2021.Factorial.fst(15,7-15,13)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2))
(BoxBool true))


;; def=Prims.fst(451,66-451,102); use=OPLSS2021.Factorial.fst(15,4-16,43)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=OPLSS2021.Factorial.fst(15,4-16,43)
(Valid 
;; def=Prims.fst(451,90-451,102); use=OPLSS2021.Factorial.fst(15,4-16,43)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=OPLSS2021.Factorial.fst(15,4-16,43)
(not 
;; def=OPLSS2021.Factorial.fst(15,7-15,13); use=OPLSS2021.Factorial.fst(15,7-15,13)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2))
...
;; def=Prims.fst(413,99-413,120); use=OPLSS2021.Factorial.fst(15,4-16,43)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.bool)

;; def=OPLSS2021.Factorial.fst(15,7-16,43); use=OPLSS2021.Factorial.fst(15,7-16,43)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2))
@x2)
)

;; def=Prims.fst(459,77-459,89); use=OPLSS2021.Factorial.fst(15,4-16,43)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS2021.Factorial.fst(16,36-16,43)
(or label_3
...
;; def=OPLSS2021.Factorial.fst(15,4-16,43); use=OPLSS2021.Factorial.fst(16,36-16,43)
(or label_4
...
;; def=Prims.fst(356,2-356,58); use=OPLSS2021.Factorial.fst(15,4-16,43)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_0e94307fef231dbbc98f0dd7dd7c1c99)

;; def=Prims.fst(356,26-356,41); use=OPLSS2021.Factorial.fst(15,4-16,43)
(= @x3
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
)

;; def=Prims.fst(441,36-441,97); use=OPLSS2021.Factorial.fst(16,9-16,35)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=OPLSS2021.Factorial.fst(14,10-14,28); use=OPLSS2021.Factorial.fst(16,9-16,35)
(>= (BoxInt_proj_0 (OPLSS2021.Factorial.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))))
(BoxInt_proj_0 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))))
...
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.Factorial.fst(16,9-16,35)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS2021.Factorial.fst(16,9-16,35)
(ApplyTT @x1
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS2021.Factorial.factorial_increasing_lemma, 1)
; STATUS: unknown because (incomplete quantifiers)
