...
; encoding sigelt val Eq.__proj__Mkdeq__item__eq
...
; encoding sigelt let __proj__Mkdeq__item__eq


; <Skipped let __proj__Mkdeq__item__eq/>


; encoding sigelt val Eq.__proj__Mkdeq__item__eq_ok
...
; encoding sigelt let __proj__Mkdeq__item__eq_ok
...
; Starting query at Eq.fst(32,2-32,42)
...
;       (forall (pure_result: Prims.unit). (x = y <==> x == y) ==> p pure_result) ==>
;       (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let eq_instance_of_eqtype`
...
;; def=dummy(0,0-0,0); use=Eq.fst(32,2-32,42)
...
;; def=Prims.fst(406,51-406,91); use=Eq.fst(32,2-32,42)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=Eq.fst(32,39-32,41)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=Eq.fst(23,34-23,54); use=Eq.fst(32,39-32,41)
(or label_2

;; def=Eq.fst(23,34-23,54); use=Eq.fst(32,39-32,41)
(iff 
;; def=Eq.fst(23,35-23,41); use=Eq.fst(32,39-32,41)
(= @x1
@x2)


;; def=Eq.fst(23,47-23,53); use=Eq.fst(32,39-32,41)
(= @x1
@x2)
)
)
...
;; def=Prims.fst(441,83-441,96); use=Eq.fst(32,39-32,41)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Eq.fst(32,39-32,41)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(451,66-451,102); use=Eq.fst(32,2-32,42)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=Eq.fst(32,2-32,42)
(Valid 
;; def=Prims.fst(451,90-451,102); use=Eq.fst(32,2-32,42)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eq.eq_instance_of_eqtype, 1)
; STATUS: unsat
...
; encoding sigelt let eq_instance_of_eqtype
...
;;;;;;;;;;;;;;;;typing_Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa
;;; Fact-ids: Name Eq.eq; Namespace Eq
(assert (! 
;; def=Eq.fst(22,2-22,4); use=Eq.fst(22,2-22,4)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa @x0)
(Tm_arrow_f8f69472a0776db7a176ba1f82e77adb @x0))
 

:pattern ((Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa @x0))
:qid typing_Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa))

:named typing_Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa))
;;;;;;;;;;;;;;;;free var typing
...
:named typing_Eq.eq))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eq.__proj__Mkdeq__item__eq; Namespace Eq
(assert (! 
;; def=Eq.fst(22,2-22,4); use=Eq.fst(22,2-22,4)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Eq.deq @x0)))
(HasType (Eq.__proj__Mkdeq__item__eq @x0
@x1)
(Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e @x0)))
 

:pattern ((Eq.__proj__Mkdeq__item__eq @x0
@x1))
:qid typing_Eq.__proj__Mkdeq__item__eq))

:named typing_Eq.__proj__Mkdeq__item__eq))
...
:pattern ((ApplyTT Eq.eq@tok
@x0))
:qid token_correspondence_Eq.eq))
:named token_correspondence_Eq.eq))
;;;;;;;;;;;;;;;;name-token correspondence
...
;; def=Eq.fst(22,2-22,4); use=Eq.fst(22,2-22,4)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Eq.__proj__Mkdeq__item__eq@tok
@x0)
@x1)
(Eq.__proj__Mkdeq__item__eq @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Eq.__proj__Mkdeq__item__eq@tok
@x0)
@x1))
:qid token_correspondence_Eq.__proj__Mkdeq__item__eq))

:named token_correspondence_Eq.__proj__Mkdeq__item__eq))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(616,4-616,8); use=Prims.fst(616,4-616,8)
...
:pattern ((Eq.__proj__Mkdeq__item__eq @x0
@x1))
:qid proj_equation_Eq.Mkdeq_eq))

:named proj_equation_Eq.Mkdeq_eq))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f8f69472a0776db7a176ba1f82e77adb
;;; Fact-ids: Name Eq.eq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,10-22,4)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_f8f69472a0776db7a176ba1f82e77adb @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_f8f69472a0776db7a176ba1f82e77adb @x0)
Tm_type))
:qid kinding_Tm_arrow_f8f69472a0776db7a176ba1f82e77adb))

:named kinding_Tm_arrow_f8f69472a0776db7a176ba1f82e77adb))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_89234680f2f2b9e34fb406917228ab69
;;; Fact-ids: Name Eq.__proj__Mkdeq__item__eq; Namespace Eq
(assert (! (HasType Tm_arrow_89234680f2f2b9e34fb406917228ab69
Tm_type)
:named kinding_Tm_arrow_89234680f2f2b9e34fb406917228ab69))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_69cb689ec71962d9ded15915f1d629d0
;;; Fact-ids: Name Eq.eq; Namespace Eq
(assert (! (HasType Tm_arrow_69cb689ec71962d9ded15915f1d629d0
Tm_type)
:named kinding_Tm_arrow_69cb689ec71962d9ded15915f1d629d0))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_649a0684309abaa78e673cf48ebf1183
;;; Fact-ids: Name Eq.eq; Namespace Eq
(assert (! 
;; def=dummy(0,0-0,0); use=Eq.fst(21,10-22,4)
(forall ((@x0 Term))
...
;; def=Eq.fst(22,2-22,4); use=Eq.fst(22,2-22,4)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa @x1)
@x0)
(let ((@lb2 @x0))
(Eq.Mkdeq_eq @lb2)))
 

:pattern ((ApplyTT (Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa @x1)
@x0))
:qid interpretation_Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa))

:named interpretation_Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa))
...
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Eq.eq@tok
Tm_arrow_69cb689ec71962d9ded15915f1d629d0))
(forall ((@x1 Term))
 (! (= (ApplyTT Eq.eq@tok
@x1)
(Eq.eq @x1))
...
:pattern ((Eq.eq @x1))
:qid function_token_typing_Eq.eq.1)))
 

:pattern ((ApplyTT @x0
Eq.eq@tok))
:qid function_token_typing_Eq.eq))
:named function_token_typing_Eq.eq))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Eq.__proj__Mkdeq__item__eq; Namespace Eq
(assert (! 
;; def=Eq.fst(22,2-22,4); use=Eq.fst(22,2-22,4)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Eq.__proj__Mkdeq__item__eq@tok
Tm_arrow_89234680f2f2b9e34fb406917228ab69))
...
@x1)
@x2)
(Eq.__proj__Mkdeq__item__eq @x1
@x2))
 

:pattern ((Eq.__proj__Mkdeq__item__eq @x1
@x2))
:qid function_token_typing_Eq.__proj__Mkdeq__item__eq.1))
)
 

:pattern ((ApplyTT @x0
Eq.__proj__Mkdeq__item__eq@tok))
:qid function_token_typing_Eq.__proj__Mkdeq__item__eq))

:named function_token_typing_Eq.__proj__Mkdeq__item__eq))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(614,5-614,9); use=Prims.fst(614,5-614,9)
...
(assert (! (forall ((@x0 Term))
 (! (= (Eq.eq @x0)
(Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa @x0))
 

:pattern ((Eq.eq @x0))
:qid equation_Eq.eq))
:named equation_Eq.eq))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_f8f69472a0776db7a176ba1f82e77adb @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_f8f69472a0776db7a176ba1f82e77adb @x2)))
:qid Eq_pre_typing_Tm_arrow_f8f69472a0776db7a176ba1f82e77adb))

:named Eq_pre_typing_Tm_arrow_f8f69472a0776db7a176ba1f82e77adb))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Eq.__proj__Mkdeq__item__eq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-22,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_89234680f2f2b9e34fb406917228ab69)
...
@x1
Tm_arrow_89234680f2f2b9e34fb406917228ab69))
:qid Eq_pre_typing_Tm_arrow_89234680f2f2b9e34fb406917228ab69))

:named Eq_pre_typing_Tm_arrow_89234680f2f2b9e34fb406917228ab69))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Eq.eq; Namespace Eq
(assert (! 
;; def=dummy(0,0-0,0); use=Eq.fst(21,10-22,4)
...
@x1
Tm_arrow_69cb689ec71962d9ded15915f1d629d0))
:qid Eq_pre_typing_Tm_arrow_69cb689ec71962d9ded15915f1d629d0))

:named Eq_pre_typing_Tm_arrow_69cb689ec71962d9ded15915f1d629d0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Eq.eq; Namespace Eq
(assert (! 
;; def=dummy(0,0-0,0); use=Eq.fst(21,10-22,4)
...
@x1
(Tm_arrow_649a0684309abaa78e673cf48ebf1183 @x2)))
:qid Eq_pre_typing_Tm_arrow_649a0684309abaa78e673cf48ebf1183))

:named Eq_pre_typing_Tm_arrow_649a0684309abaa78e673cf48ebf1183))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,10-23,54); use=Eq.fst(23,13-23,54)
...
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f8f69472a0776db7a176ba1f82e77adb
;;; Fact-ids: Name Eq.eq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,10-22,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f8f69472a0776db7a176ba1f82e77adb @x1))
(and 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,10-22,4)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid Eq_interpretation_Tm_arrow_f8f69472a0776db7a176ba1f82e77adb.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_f8f69472a0776db7a176ba1f82e77adb @x1)))
:qid Eq_interpretation_Tm_arrow_f8f69472a0776db7a176ba1f82e77adb))

:named Eq_interpretation_Tm_arrow_f8f69472a0776db7a176ba1f82e77adb))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_89234680f2f2b9e34fb406917228ab69
;;; Fact-ids: Name Eq.__proj__Mkdeq__item__eq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-22,24)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Eq_interpretation_Tm_arrow_89234680f2f2b9e34fb406917228ab69.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Eq_interpretation_Tm_arrow_89234680f2f2b9e34fb406917228ab69.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_89234680f2f2b9e34fb406917228ab69))
:qid Eq_interpretation_Tm_arrow_89234680f2f2b9e34fb406917228ab69))

:named Eq_interpretation_Tm_arrow_89234680f2f2b9e34fb406917228ab69))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_69cb689ec71962d9ded15915f1d629d0
;;; Fact-ids: Name Eq.eq; Namespace Eq
(assert (! 
;; def=dummy(0,0-0,0); use=Eq.fst(21,10-22,4)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Eq_interpretation_Tm_arrow_69cb689ec71962d9ded15915f1d629d0.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_69cb689ec71962d9ded15915f1d629d0))
:qid Eq_interpretation_Tm_arrow_69cb689ec71962d9ded15915f1d629d0))

:named Eq_interpretation_Tm_arrow_69cb689ec71962d9ded15915f1d629d0))
...
:pattern ((ApplyTT @x0
@x2))
:qid Eq_interpretation_Tm_arrow_649a0684309abaa78e673cf48ebf1183.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_649a0684309abaa78e673cf48ebf1183 @x1)))
:qid Eq_interpretation_Tm_arrow_649a0684309abaa78e673cf48ebf1183))

:named Eq_interpretation_Tm_arrow_649a0684309abaa78e673cf48ebf1183))
...
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Eq.__proj__Mkdeq__item__eq_ok; Namespace Eq
(assert (! (Valid (ApplyTT __uu__PartialApp
Eq.__proj__Mkdeq__item__eq@tok))
:named @kick_partial_app_799d08c25c8b836fcf0029bdba78ab3d))
(push) ;; push{2

; Starting query at Eq.fst(40,2-43,17)
...
;;;;;;;;;;;;;;;;uu___0 : Eq.deq 'a (Eq.deq 'a)
(declare-fun x_dd3d262bf5e0d05562baf51429ed91f0_2 () Term)
;;;;;;;;;;;;;;;;binder_x_dd3d262bf5e0d05562baf51429ed91f0_2
;;; Fact-ids: 
(assert (! (HasType x_dd3d262bf5e0d05562baf51429ed91f0_2
(Eq.deq x_fe28d8bcde588226b4e538b35321de05_1))
:named binder_x_dd3d262bf5e0d05562baf51429ed91f0_2))
...
(declare-fun Tm_refine_49eb3e00e3605abc387db3eb90cecd43 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,15-43,17); use=Eq.fst(39,15-43,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_49eb3e00e3605abc387db3eb90cecd43 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_49eb3e00e3605abc387db3eb90cecd43 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_49eb3e00e3605abc387db3eb90cecd43))

:named refinement_kinding_Tm_refine_49eb3e00e3605abc387db3eb90cecd43))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,15-43,17); use=Eq.fst(39,15-43,17)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_49eb3e00e3605abc387db3eb90cecd43 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Eq.fst(39,15-43,17); use=Eq.fst(39,15-43,17)
(or 
;; def=Eq.fst(40,2-43,17); use=Eq.fst(40,2-43,17)
(Valid 
;; def=Eq.fst(40,2-43,17); use=Eq.fst(40,2-43,17)
(Prims.precedes (Eq.deq @x2)
(Eq.deq x_fe28d8bcde588226b4e538b35321de05_1)
@x3
x_dd3d262bf5e0d05562baf51429ed91f0_2)
)


;; def=Eq.fst(39,15-43,17); use=Eq.fst(39,15-43,17)
(and 
;; def=Eq.fst(39,15-39,25); use=Eq.fst(39,15-39,25)
(Valid 
;; def=Eq.fst(39,15-39,25); use=Eq.fst(39,15-39,25)
(Prims.op_Equals_Equals_Equals (Eq.deq @x2)
(Eq.deq x_fe28d8bcde588226b4e538b35321de05_1)
@x3
x_dd3d262bf5e0d05562baf51429ed91f0_2)
)
...
;; def=Eq.fst(39,27-43,17); use=Eq.fst(39,27-43,17)
(or 
;; def=Eq.fst(40,2-43,17); use=Eq.fst(40,2-43,17)
(Valid 
;; def=Eq.fst(40,2-43,17); use=Eq.fst(40,2-43,17)
...
;; def=Eq.fst(39,27-43,17); use=Eq.fst(39,27-43,17)
(and 
;; def=Eq.fst(39,27-39,29); use=Eq.fst(39,27-39,29)
(Valid 
;; def=Eq.fst(39,27-39,29); use=Eq.fst(39,27-39,29)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_49eb3e00e3605abc387db3eb90cecd43))

:named refinement_interpretation_Tm_refine_49eb3e00e3605abc387db3eb90cecd43))
;;;;;;;;;;;;;;;;haseq for Tm_refine_49eb3e00e3605abc387db3eb90cecd43
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,15-43,17); use=Eq.fst(39,15-43,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_49eb3e00e3605abc387db3eb90cecd43 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_49eb3e00e3605abc387db3eb90cecd43 @x0
@x1
@x2))))
:qid haseqTm_refine_49eb3e00e3605abc387db3eb90cecd43))

:named haseqTm_refine_49eb3e00e3605abc387db3eb90cecd43))
...
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,50-39,75); use=Eq.fst(39,50-39,75)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f))

:named refinement_kinding_Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,50-39,75); use=Eq.fst(39,50-39,75)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.bool)

;; def=Eq.fst(39,58-39,73); use=Eq.fst(39,58-39,73)
(iff 
;; def=Eq.fst(39,51-39,52); use=Eq.fst(39,58-39,59)
(BoxBool_proj_0 @x1)


;; def=Eq.fst(39,65-39,73); use=Eq.fst(39,65-39,73)
(= @x2
@x3)
)
))
...
(Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f @x2
@x3)))
:qid refinement_interpretation_Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f))

:named refinement_interpretation_Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,50-39,75); use=Eq.fst(39,50-39,75)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f @x0
@x1)))
(Valid (Prims.hasEq Prims.bool)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f @x0
@x1))))
:qid haseqTm_refine_f0ac051651fa0e095f1b2c1241fd6a3f))

:named haseqTm_refine_f0ac051651fa0e095f1b2c1241fd6a3f))
;;;;;;;;;;;;;;;;{| _: deq 'a |} ->     xs: Prims.list 'a ->     ys: Prims.list 'a {_ << _ \/ _ === _ /\ (xs << xs \/ xs === xs /\ ys << ys)}   -> b: Prims.bool{b <==> xs == ys}
(declare-fun Tm_arrow_2dc301de8d326461d6ade8cffec2afd1 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_2dc301de8d326461d6ade8cffec2afd1
Tm_type)
:named kinding_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,15-43,17); use=Eq.fst(39,15-43,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2dc301de8d326461d6ade8cffec2afd1)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_2dc301de8d326461d6ade8cffec2afd1))
:qid Eq_pre_typing_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1))

:named Eq_pre_typing_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,15-43,17); use=Eq.fst(39,15-43,17)
(forall ((@x0 Term))
...
(Prims.list @x1))
(HasType @x4
(Tm_refine_49eb3e00e3605abc387db3eb90cecd43 @x1
@x2
@x3)))
...
@x3)
@x4)
(Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f @x3
@x4)))
...
@x3)
@x4))
:qid Eq_interpretation_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Eq_interpretation_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1.2))
...
@x1)
@x2))
:qid Eq_interpretation_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1.3))
...
@x2)
@x3))
:qid Eq_interpretation_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_2dc301de8d326461d6ade8cffec2afd1))
:qid Eq_interpretation_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1))

:named Eq_interpretation_Tm_arrow_2dc301de8d326461d6ade8cffec2afd1))
(declare-fun Eq.eqList@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,8-39,14); use=Eq.fst(39,8-39,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.eqList@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.eqList@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Eq.eqList))

:named token_correspondence_Eq.eqList))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,8-39,14); use=Eq.fst(39,8-39,14)
...
:pattern ((Eq.eqList @x1
@x2
@x3
@x4))
:qid function_token_typing_Eq.eqList.1))
)
 

:pattern ((ApplyTT @x0
Eq.eqList@tok))
:qid function_token_typing_Eq.eqList))

:named function_token_typing_Eq.eqList))
...
(Prims.list @x0))
(HasType @x3
(Tm_refine_49eb3e00e3605abc387db3eb90cecd43 @x0
@x1
@x2)))
(HasType (Eq.eqList @x0
@x1
@x2
@x3)
(Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f @x2
...
:pattern ((Eq.eqList @x0
@x1
@x2
@x3))
:qid typing_Eq.eqList))

:named typing_Eq.eqList))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_7124cf2db74b3e5af97f064e2eceb8a7 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_7124cf2db74b3e5af97f064e2eceb8a7
Tm_type)
:named refinement_kinding_Tm_refine_7124cf2db74b3e5af97f064e2eceb8a7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Eq.fst(39,50-39,75); use=Eq.fst(40,2-43,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_7124cf2db74b3e5af97f064e2eceb8a7)
(and (HasTypeFuel @u0
@x1
Prims.bool)

;; def=Eq.fst(39,58-39,73); use=Eq.fst(40,2-43,17)
(iff 
;; def=Eq.fst(39,51-39,52); use=Eq.fst(40,2-43,17)
(BoxBool_proj_0 @x1)


;; def=Eq.fst(39,65-39,73); use=Eq.fst(40,2-43,17)
(= x_0a56e3de562c08d8ab59f4ac6f626a98_3
x_0a56e3de562c08d8ab59f4ac6f626a98_4)
)
))
...
@x1
Tm_refine_7124cf2db74b3e5af97f064e2eceb8a7))
:qid refinement_interpretation_Tm_refine_7124cf2db74b3e5af97f064e2eceb8a7))

:named refinement_interpretation_Tm_refine_7124cf2db74b3e5af97f064e2eceb8a7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7124cf2db74b3e5af97f064e2eceb8a7
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_7124cf2db74b3e5af97f064e2eceb8a7))
(Valid (Prims.hasEq Prims.bool)))
:named haseqTm_refine_7124cf2db74b3e5af97f064e2eceb8a7))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
Eq.eq@tok))
:named @kick_partial_app_7a580120e8a3581dfa84bb8c3798b851))





; Encoding query formula : forall (k: Prims.pure_post (b: Prims.bool{b <==> xs == ys})).
;   (forall (x: b: Prims.bool{b <==> xs == ys}). {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   ((xs, ys) == ([], []) ==> xs == ys) /\
;   (~(Nil? (xs, ys)._1 && Nil? (xs, ys)._2) ==>
;     (forall (b: 'a) (b: Prims.list 'a) (b: 'a) (b: Prims.list 'a).
;         (xs, ys) == (b :: b, b :: b) ==>
;         (forall (pure_result: Prims.unit).
;             (_.eq b b <==> b == b) ==>
;             (Eq.eq b b ==> _ << _ \/ (b << xs \/ b === xs /\ b << ys)) /\
;             (forall (any_result: Prims.bool).
;                 (Eq.eq b b && Eq.eqList b b) == any_result ==>
;                 (Eq.eq b b && Eq.eqList b b <==> xs == ys)))) /\
;     (~(Cons? (xs, ys)._1 && Cons? (xs, ys)._2) ==>
;       (forall (b: Prims.list 'a) (b: Prims.list 'a). (xs, ys) == (b, b) ==> ~(xs == ys))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec eqList`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Tm_refine_7124cf2db74b3e5af97f064e2eceb8a7))

;; def=Prims.fst(402,27-402,88); use=Eq.fst(40,2-43,17)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Eq.fst(40,2-43,17)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Eq.fst(40,2-43,17)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,2-389,39); use=Eq.fst(40,2-43,17)
(and (implies 
;; def=Eq.fst(40,8-41,10); use=Eq.fst(40,8-41,10)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
x_0a56e3de562c08d8ab59f4ac6f626a98_3
x_0a56e3de562c08d8ab59f4ac6f626a98_4)
(FStar.Pervasives.Native.Mktuple2 (Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=Eq.fst(39,65-39,73); use=Eq.fst(41,14-41,18)
(or label_1
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Eq.fst(40,2-43,17)
(not 
;; def=Eq.fst(41,4-41,10); use=Eq.fst(41,4-41,10)
(and (BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
(FStar.Pervasives.Native.Mktuple2 (Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
x_0a56e3de562c08d8ab59f4ac6f626a98_3
...
(FStar.Pervasives.Native.__proj__Mktuple2__item___2 (Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
(FStar.Pervasives.Native.Mktuple2 (Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
x_0a56e3de562c08d8ab59f4ac6f626a98_3
...
;; def=Prims.fst(389,2-389,39); use=Eq.fst(40,2-43,17)
(and 
;; def=Prims.fst(413,99-413,120); use=Eq.fst(40,2-43,17)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=Eq.fst(40,8-42,16); use=Eq.fst(40,8-42,16)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
x_0a56e3de562c08d8ab59f4ac6f626a98_3
x_0a56e3de562c08d8ab59f4ac6f626a98_4)
...
;; def=Prims.fst(441,36-441,97); use=Eq.fst(42,20-42,25)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=Eq.fst(23,34-23,54); use=Eq.fst(42,20-42,25)
(iff 
;; def=Eq.fst(23,35-23,41); use=Eq.fst(42,20-42,25)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.__proj__Mkdeq__item__eq@tok
x_fe28d8bcde588226b4e538b35321de05_1)
x_dd3d262bf5e0d05562baf51429ed91f0_2)
@x1)
@x3))
...
;; def=Eq.fst(23,47-23,53); use=Eq.fst(42,20-42,25)
(= @x1
@x3)
)
)

;; def=Prims.fst(459,77-459,89); use=Eq.fst(40,2-43,17)
(and (implies 
;; def=Eq.fst(42,31-42,37); use=Eq.fst(42,31-42,37)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.eq@tok
x_fe28d8bcde588226b4e538b35321de05_1)
x_dd3d262bf5e0d05562baf51429ed91f0_2)
@x1)
@x3))
...
;; def=Eq.fst(39,15-43,17); use=Eq.fst(42,51-42,53)
(or label_2

;; def=Eq.fst(40,2-43,17); use=Eq.fst(42,51-42,53)
(Valid 
;; def=Eq.fst(40,2-43,17); use=Eq.fst(42,51-42,53)
(Prims.precedes (Eq.deq x_fe28d8bcde588226b4e538b35321de05_1)
(Eq.deq x_fe28d8bcde588226b4e538b35321de05_1)
x_dd3d262bf5e0d05562baf51429ed91f0_2
x_dd3d262bf5e0d05562baf51429ed91f0_2)
)
...
;; def=Eq.fst(39,27-43,17); use=Eq.fst(42,51-42,53)
(and 
;; def=Eq.fst(39,27-39,29); use=Eq.fst(42,51-42,53)
(Valid 
;; def=Eq.fst(39,27-39,29); use=Eq.fst(42,51-42,53)
...
;; def=Prims.fst(451,66-451,102); use=Eq.fst(40,2-43,17)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.bool)

;; def=Eq.fst(39,50-42,53); use=Eq.fst(40,2-43,17)
(= (Prims.op_AmpAmp (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.eq@tok
x_fe28d8bcde588226b4e538b35321de05_1)
x_dd3d262bf5e0d05562baf51429ed91f0_2)
@x1)
@x3)
(Eq.eqList x_fe28d8bcde588226b4e538b35321de05_1
x_dd3d262bf5e0d05562baf51429ed91f0_2
@x2
@x4))
@x6)
...
;; def=Eq.fst(39,58-39,73); use=Eq.fst(42,31-42,53)
(or label_3

;; def=Eq.fst(39,58-39,73); use=Eq.fst(42,31-42,53)
(iff 
;; def=Eq.fst(39,51-39,52); use=Eq.fst(42,31-42,53)
(and (BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.eq@tok
x_fe28d8bcde588226b4e538b35321de05_1)
x_dd3d262bf5e0d05562baf51429ed91f0_2)
@x1)
@x3))
(BoxBool_proj_0 (Eq.eqList x_fe28d8bcde588226b4e538b35321de05_1
x_dd3d262bf5e0d05562baf51429ed91f0_2
@x2
@x4)))


;; def=Eq.fst(39,65-39,73); use=Eq.fst(42,31-42,53)
(= x_0a56e3de562c08d8ab59f4ac6f626a98_3
x_0a56e3de562c08d8ab59f4ac6f626a98_4)
)
)
...
;; def=Prims.fst(389,19-389,21); use=Eq.fst(40,2-43,17)
(not 
;; def=Eq.fst(42,4-42,16); use=Eq.fst(42,4-42,16)
...
;; def=Eq.fst(40,8-43,8); use=Eq.fst(40,8-43,8)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
x_0a56e3de562c08d8ab59f4ac6f626a98_3
x_0a56e3de562c08d8ab59f4ac6f626a98_4)
...
;; def=Eq.fst(39,65-39,73); use=Eq.fst(43,12-43,17)
(or label_4
...
; encoding sigelt let rec eqList
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eq.eqList; Namespace Eq
(assert (! 
;; def=Eq.fst(39,8-39,14); use=Eq.fst(39,8-39,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
...
(HasType @x4
(Prims.list @x1)))
(HasType (Eq.eqList.fuel_instrumented @u0
@x1
@x2
@x3
@x4)
...
:pattern ((Eq.eqList.fuel_instrumented @u0
@x1
@x2
@x3
@x4))
:qid token_correspondence_Eq.eqList.fuel_instrumented))

:named token_correspondence_Eq.eqList.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Eq.eqList; Namespace Eq
(assert (! 
;; def=Eq.fst(39,50-39,75); use=Eq.fst(39,50-39,75)
...
:named haseqTm_refine_f0ac051651fa0e095f1b2c1241fd6a3f))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Eq.eqList
;;; Fact-ids: Name Eq.eqList; Namespace Eq
(assert (! 
;; def=Eq.fst(39,8-39,14); use=Eq.fst(39,8-39,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
(HasType @x4
(Prims.list @x1)))
(= (Eq.eqList.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4)
...
@x3
@x4)))
(ite (and (is-Prims.Nil (FStar.Pervasives.Native.Mktuple2__1 @lb5))
(is-Prims.Nil (FStar.Pervasives.Native.Mktuple2__2 @lb5)))
(BoxBool true)
...
(Eq.eqList.fuel_instrumented @u0
@x1
@x2
...
:pattern ((Eq.eqList.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4))
:qid equation_with_fuel_Eq.eqList.fuel_instrumented))

:named equation_with_fuel_Eq.eqList.fuel_instrumented))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Eq.eqList; Namespace Eq
(assert (! (Valid (ApplyTT __uu__PartialApp
Eq.eq@tok))
...
@x3
@x4)
(Eq.eqList.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid @fuel_irrelevance_Eq.eqList.fuel_instrumented))

:named @fuel_irrelevance_Eq.eqList.fuel_instrumented))
...
@x2
@x3)
(Eq.eqList.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_correspondence_Eq.eqList.fuel_instrumented))

:named @fuel_correspondence_Eq.eqList.fuel_instrumented))
(push) ;; push{2

; Starting query at Eq.fst(47,2-47,30)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall ('a: Type) (_: Eq.deq 'a).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.list 'a) (y: Prims.list 'a).
;     (*  - Could not prove post-condition
; *)
;     forall (p: Prims.pure_post Prims.unit).
;       (forall (pure_result: Prims.unit). (Eq.eqList x y <==> x == y) ==> p pure_result) ==>
;       (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let eq_list`
...
;; def=dummy(0,0-0,0); use=Eq.fst(47,2-47,30)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
(Prims.list @x0))
(HasType @x3
...
;; def=Prims.fst(406,51-406,91); use=Eq.fst(47,2-47,30)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=Eq.fst(47,27-47,29)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Eq.fst(23,34-23,54); use=Eq.fst(47,27-47,29)
(or label_2

;; def=Eq.fst(23,34-23,54); use=Eq.fst(47,27-47,29)
(iff 
;; def=Eq.fst(23,35-23,41); use=Eq.fst(47,27-47,29)
(BoxBool_proj_0 (Eq.eqList @x0
@x1
@x2
@x3))


;; def=Eq.fst(23,47-23,53); use=Eq.fst(47,27-47,29)
(= @x2
@x3)
)
)
...
;; def=Prims.fst(441,83-441,96); use=Eq.fst(47,27-47,29)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Eq.fst(47,27-47,29)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(451,66-451,102); use=Eq.fst(47,2-47,30)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=Eq.fst(47,2-47,30)
(Valid 
;; def=Prims.fst(451,90-451,102); use=Eq.fst(47,2-47,30)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eq.eq_list, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @fuel_correspondence_Eq.eqList.fuel_instrumented, @query, refinement_interpretation_Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f, typing_Eq.eqList
...
; Starting query at Eq.fst(50,2-51,49)
...
; Encoding query formula : forall ('a: Type) ('b: Type) (_: Eq.deq 'a) (_: Eq.deq 'b).
;   (*  - Could not prove post-condition
; *)
...
;                 _ == _) ==>
;               p pure_result) ==>
;           (forall (b: 'a) (b: 'b) (b: 'a) (b: 'b).
;               (_, _) == ((b, b), (b, b)) ==>
;               (forall (pure_result: Prims.unit).
;                   (_.eq b b <==> b == b) ==>
;                   (forall (pure_result: Prims.unit). (_.eq b b <==> b == b) ==> p pure_result))))


; Context: While encoding a query
; While typechecking the top-level declaration `let eq_pair`
...
;; def=Prims.fst(356,2-356,58); use=Eq.fst(50,2-51,49)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_type)

;; def=Prims.fst(356,26-356,41); use=Eq.fst(50,2-51,49)
(= @x4
(FStar.Pervasives.Native.tuple2 @x0
@x1))
)

;; def=dummy(0,0-0,0); use=Eq.fst(50,2-51,49)
...
;; def=Prims.fst(406,51-406,91); use=Eq.fst(50,2-51,49)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=Eq.fst(51,28-51,48)
(forall ((@x8 Term))
 (! (implies (and (or label_1
(HasType @x8
Prims.unit))

;; def=Eq.fst(23,34-23,54); use=Eq.fst(51,28-51,48)
(or label_2

;; def=Eq.fst(23,34-23,54); use=Eq.fst(51,28-51,48)
(iff 
;; def=Eq.fst(23,35-23,41); use=Eq.fst(51,28-51,48)
(BoxBool_proj_0 (let ((@lb9 (FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.tuple2 @x0
@x1)
(FStar.Pervasives.Native.tuple2 @x0
@x1)
@x5
...
@x0)
@x2)
(FStar.Pervasives.Native.Mktuple2__1 (FStar.Pervasives.Native.Mktuple2__1 @lb9)))
(FStar.Pervasives.Native.Mktuple2__1 (FStar.Pervasives.Native.Mktuple2__2 @lb9)))
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.eq@tok
@x1)
@x3)
(FStar.Pervasives.Native.Mktuple2__2 (FStar.Pervasives.Native.Mktuple2__1 @lb9)))
(FStar.Pervasives.Native.Mktuple2__2 (FStar.Pervasives.Native.Mktuple2__2 @lb9))))))


;; def=Eq.fst(23,47-23,53); use=Eq.fst(51,28-51,48)
(= @x5
@x6)
)
)
...
;; def=Prims.fst(441,83-441,96); use=Eq.fst(51,28-51,48)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Eq.fst(51,28-51,48)
(ApplyTT @x7
@x8)
...
;; def=Prims.fst(413,99-413,120); use=Eq.fst(51,28-51,48)
(forall ((@x8 Term))
 (! (implies (HasType @x8
@x0)
...
;; def=Eq.fst(51,8-51,49); use=Eq.fst(51,28-51,48)
...
;; def=Prims.fst(441,36-441,97); use=Eq.fst(51,28-51,33)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
Prims.unit)

;; def=Eq.fst(23,34-23,54); use=Eq.fst(51,28-51,33)
(iff 
;; def=Eq.fst(23,35-23,41); use=Eq.fst(51,28-51,33)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.__proj__Mkdeq__item__eq@tok
@x0)
@x2)
@x8)
...
;; def=Eq.fst(23,47-23,53); use=Eq.fst(51,28-51,33)
(= @x8
@x10)
)
)

;; def=Prims.fst(441,36-441,97); use=Eq.fst(51,39-51,44)
(forall ((@x13 Term))
 (! (implies (and (HasType @x13
Prims.unit)

;; def=Eq.fst(23,34-23,54); use=Eq.fst(51,39-51,44)
(iff 
;; def=Eq.fst(23,35-23,41); use=Eq.fst(51,39-51,44)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.__proj__Mkdeq__item__eq@tok
@x1)
@x3)
@x9)
...
;; def=Eq.fst(23,47-23,53); use=Eq.fst(51,39-51,44)
(= @x9
@x11)
)
)

;; def=Prims.fst(441,83-441,96); use=Eq.fst(51,39-51,44)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Eq.fst(51,39-51,44)
(ApplyTT @x7
@x13)
...
; Starting query at Eq.fst(54,0-54,23)

(declare-fun label_1 () Bool)


; Encoding query formula : Eq.eq 1 1
...
;;; Fact-ids: 
(assert (! (not 
;; def=Eq.fst(54,15-54,23); use=Eq.fst(54,8-54,14)
(or label_1
...
; Starting query at Eq.fst(55,0-55,29)

(declare-fun label_1 () Bool)


; Encoding query formula : Prims.op_Negation (Eq.eq 1 2)
...
;;;;;;;;;;;;;;;;query
;;; Fact-ids: 
(assert (! (not (or label_1
(not (BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.eq@tok
Prims.int)
(Eq.uu___0 Dummy_value))
(BoxInt 1))
(BoxInt 2))))))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eq.uu___4, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, equation_Eq.eq, equation_Eq.eq_instance_of_eqtype, equation_Eq.uu___0, function_token_typing_Prims.__cache_version_number__, interpretation_Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa, interpretation_Tm_abs_e98f4b71ef47e83d53da8f81c925bb67, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_Eq.Mkdeq_eq, token_correspondence_Eq.eq
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eq.uu___1; Namespace Eq
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (Eq.uu___1 @u0)
(Eq.deq Prims.bool))
 

:pattern ((Eq.uu___1 @u0))
:qid typing_Eq.uu___1))
:named typing_Eq.uu___1))
;;;;;;;;;;;;;;;;Equation for Eq.uu___1
;;; Fact-ids: Name Eq.uu___1; Namespace Eq
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (Eq.uu___1 @u0)
(Eq.eq_instance_of_eqtype Prims.bool))
 

:pattern ((Eq.uu___1 @u0))
:qid equation_Eq.uu___1))
:named equation_Eq.uu___1))
(push) ;; push{2

; Starting query at Eq.fst(57,0-57,29)

(declare-fun label_1 () Bool)


; Encoding query formula : Eq.eq true true
...
;;; Fact-ids: 
(assert (! (not 
;; def=Eq.fst(57,15-57,29); use=Eq.fst(57,8-57,14)
(or label_1

;; def=Eq.fst(57,15-57,29); use=Eq.fst(57,8-57,14)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.eq@tok
Prims.bool)
(Eq.uu___1 Dummy_value))
(BoxBool true))
(BoxBool true)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eq.uu___5, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Eq.eq, equation_Eq.eq_instance_of_eqtype, equation_Eq.uu___1, interpretation_Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa, interpretation_Tm_abs_e98f4b71ef47e83d53da8f81c925bb67, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, projection_inverse_Eq.Mkdeq_eq, token_correspondence_Eq.eq
...
; Starting query at Eq.fst(58,0-58,36)

(declare-fun label_1 () Bool)


; Encoding query formula : Prims.op_Negation (Eq.eq true false)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eq.eq_list; Namespace Eq
(assert (! 
;; def=Eq.fst(46,9-46,16); use=Eq.fst(46,9-46,16)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Eq.deq @x0)))
(HasType (Eq.eq_list @x0
@x1)
(Eq.deq (Prims.list @x0))))
 

:pattern ((Eq.eq_list @x0
@x1))
:qid typing_Eq.eq_list))

:named typing_Eq.eq_list))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_70fa578c350595a5bde8fba9e51e1f6a
;;; Fact-ids: Name Eq.eq_list; Namespace Eq
(assert (! 
;; def=Eq.fst(47,27-47,29); use=Eq.fst(47,27-47,29)
(forall ((@x0 Term))
 (! (IsTotFun (Tm_abs_70fa578c350595a5bde8fba9e51e1f6a @x0))
 

:pattern ((Tm_abs_70fa578c350595a5bde8fba9e51e1f6a @x0))
:qid tot_fun_Tm_abs_70fa578c350595a5bde8fba9e51e1f6a))

:named tot_fun_Tm_abs_70fa578c350595a5bde8fba9e51e1f6a))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Eq.eqList; Namespace Eq
(assert (! 
;; def=Eq.fst(39,8-39,14); use=Eq.fst(39,8-39,14)
...
:named token_correspondence_Eq.eqList))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca
;;; Fact-ids: Name Eq.eqList; Namespace Eq
(assert (! (HasType Tm_arrow_7aa492a2d1bcc16697b15f18414834ca
Tm_type)
:named kinding_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_70fa578c350595a5bde8fba9e51e1f6a
;;; Fact-ids: Name Eq.eq_list; Namespace Eq
(assert (! 
;; def=Eq.fst(47,27-47,29); use=Eq.fst(47,27-47,29)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_70fa578c350595a5bde8fba9e51e1f6a @x2)
@x0)
@x1)
Tm_unit)
 

:pattern ((ApplyTT (ApplyTT (Tm_abs_70fa578c350595a5bde8fba9e51e1f6a @x2)
@x0)
@x1))
:qid interpretation_Tm_abs_70fa578c350595a5bde8fba9e51e1f6a))

:named interpretation_Tm_abs_70fa578c350595a5bde8fba9e51e1f6a))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Eq.eqList; Namespace Eq
(assert (! 
;; def=Eq.fst(39,8-39,14); use=Eq.fst(39,8-39,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Eq.eqList@tok
Tm_arrow_7aa492a2d1bcc16697b15f18414834ca))
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (Eq.eq_list @x0
@x1)
(Eq.Mkdeq (Prims.list @x0)
(ApplyTT (ApplyTT Eq.eqList@tok
@x0)
@x1)
(Tm_abs_70fa578c350595a5bde8fba9e51e1f6a @x0)))
 

:pattern ((Eq.eq_list @x0
@x1))
:qid equation_Eq.eq_list))

:named equation_Eq.eq_list))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Eq.eqList; Namespace Eq
(assert (! 
;; def=Eq.fst(39,17-39,42); use=Eq.fst(39,17-39,75)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7aa492a2d1bcc16697b15f18414834ca)
...
@x1
Tm_arrow_7aa492a2d1bcc16697b15f18414834ca))
:qid Eq_pre_typing_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca))

:named Eq_pre_typing_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca
;;; Fact-ids: Name Eq.eqList; Namespace Eq
(assert (! 
;; def=Eq.fst(39,17-39,42); use=Eq.fst(39,17-39,75)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid Eq_interpretation_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Eq_interpretation_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca.2))
...
@x1)
@x2))
:qid Eq_interpretation_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca.3))
...
@x2)
@x3))
:qid Eq_interpretation_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_7aa492a2d1bcc16697b15f18414834ca))
:qid Eq_interpretation_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca))

:named Eq_interpretation_Tm_arrow_7aa492a2d1bcc16697b15f18414834ca))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Eq.eq_list; Namespace Eq
(assert (! (Valid (ApplyTT __uu__PartialApp
Eq.eqList@tok))
:named @kick_partial_app_459d9cd2f6c81ea018fad93220713f6a))
(push) ;; push{2

; Starting query at Eq.fst(60,0-60,31)

(declare-fun label_1 () Bool)


; Encoding query formula : Eq.eq [1; 2] [1; 2]
...
;;; Fact-ids: 
(assert (! (not 
;; def=Eq.fst(60,15-60,31); use=Eq.fst(60,8-60,14)
(or label_1

;; def=Eq.fst(60,15-60,31); use=Eq.fst(60,8-60,14)
(BoxBool_proj_0 (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.eq@tok
(Prims.list Prims.int))
(Eq.eq_list Prims.int
(Eq.uu___0 Dummy_value)))
...
; Starting query at Eq.fst(61,0-61,37)

(declare-fun label_1 () Bool)


; Encoding query formula : Prims.op_Negation (Eq.eq [2; 1] [1; 2])
...
;;;;;;;;;;;;;;;;typing_Tm_abs_af9a9fad24ef4b376771ad8eab3c0844
;;; Fact-ids: Name Eq.eq_pair; Namespace Eq
(assert (! 
;; def=Eq.fst(50,28-50,44); use=Eq.fst(50,28-50,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_af9a9fad24ef4b376771ad8eab3c0844 @x0
@x1
@x2
@x3)
(Tm_arrow_c3bd8208ce1c592d617103bb20e42f20 @x2
@x3))
 

:pattern ((Tm_abs_af9a9fad24ef4b376771ad8eab3c0844 @x0
@x1
@x2
@x3))
:qid typing_Tm_abs_af9a9fad24ef4b376771ad8eab3c0844))

:named typing_Tm_abs_af9a9fad24ef4b376771ad8eab3c0844))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eq.uu___2; Namespace Eq
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (Eq.uu___2 @u0)
(Eq.deq Prims.string))
 

:pattern ((Eq.uu___2 @u0))
:qid typing_Eq.uu___2))
:named typing_Eq.uu___2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eq.eq_pair; Namespace Eq
(assert (! 
;; def=Eq.fst(49,9-49,16); use=Eq.fst(49,9-49,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x3
(Eq.deq @x1)))
(HasType (Eq.eq_pair @x0
@x1
@x2
@x3)
(Eq.deq (FStar.Pervasives.Native.tuple2 @x0
@x1))))
 

:pattern ((Eq.eq_pair @x0
@x1
@x2
@x3))
:qid typing_Eq.eq_pair))

:named typing_Eq.eq_pair))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_666798151111a3c67f9fe6a529302e93
;;; Fact-ids: Name Eq.eq_pair; Namespace Eq
(assert (! 
;; def=Eq.fst(51,28-51,48); use=Eq.fst(51,28-51,48)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (Tm_abs_666798151111a3c67f9fe6a529302e93 @x0
@x1))
 

:pattern ((Tm_abs_666798151111a3c67f9fe6a529302e93 @x0
@x1))
:qid tot_fun_Tm_abs_666798151111a3c67f9fe6a529302e93))

:named tot_fun_Tm_abs_666798151111a3c67f9fe6a529302e93))
;;;;;;;;;;;;;;;;string typing
;;; Fact-ids: Name Prims.string; Namespace Prims
(assert (! (forall ((@u0 FString))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c3bd8208ce1c592d617103bb20e42f20
;;; Fact-ids: Name Eq.eq_pair; Namespace Eq
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=Eq.fst(50,2-50,7)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_c3bd8208ce1c592d617103bb20e42f20 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_c3bd8208ce1c592d617103bb20e42f20 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_c3bd8208ce1c592d617103bb20e42f20))

:named kinding_Tm_arrow_c3bd8208ce1c592d617103bb20e42f20))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_af9a9fad24ef4b376771ad8eab3c0844
;;; Fact-ids: Name Eq.eq_pair; Namespace Eq
(assert (! 
;; def=Eq.fst(50,28-50,44); use=Eq.fst(50,28-50,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_af9a9fad24ef4b376771ad8eab3c0844 @x2
@x3
@x4
@x5)
@x0)
@x1)
(let ((@lb6 (FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.tuple2 @x5
@x4)
(FStar.Pervasives.Native.tuple2 @x5
@x4)
@x0
...
@x5)
@x2)
(FStar.Pervasives.Native.Mktuple2__1 (FStar.Pervasives.Native.Mktuple2__1 @lb6)))
(FStar.Pervasives.Native.Mktuple2__1 (FStar.Pervasives.Native.Mktuple2__2 @lb6)))
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Eq.eq@tok
@x4)
@x3)
(FStar.Pervasives.Native.Mktuple2__2 (FStar.Pervasives.Native.Mktuple2__1 @lb6)))
(FStar.Pervasives.Native.Mktuple2__2 (FStar.Pervasives.Native.Mktuple2__2 @lb6))))))
 

:pattern ((ApplyTT (ApplyTT (Tm_abs_af9a9fad24ef4b376771ad8eab3c0844 @x2
@x3
@x4
@x5)
@x0)
@x1))
:qid interpretation_Tm_abs_af9a9fad24ef4b376771ad8eab3c0844))

:named interpretation_Tm_abs_af9a9fad24ef4b376771ad8eab3c0844))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_666798151111a3c67f9fe6a529302e93
;;; Fact-ids: Name Eq.eq_pair; Namespace Eq
(assert (! 
;; def=Eq.fst(51,28-51,48); use=Eq.fst(51,28-51,48)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_666798151111a3c67f9fe6a529302e93 @x2
@x3)
@x0)
@x1)
Tm_unit)
...
:pattern ((ApplyTT (ApplyTT (Tm_abs_666798151111a3c67f9fe6a529302e93 @x2
@x3)
@x0)
@x1))
:qid interpretation_Tm_abs_666798151111a3c67f9fe6a529302e93))

:named interpretation_Tm_abs_666798151111a3c67f9fe6a529302e93))
...
;;;;;;;;;;;;;;;;Equation for Eq.uu___2
;;; Fact-ids: Name Eq.uu___2; Namespace Eq
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (Eq.uu___2 @u0)
(Eq.eq_instance_of_eqtype Prims.string))
 

:pattern ((Eq.uu___2 @u0))
:qid equation_Eq.uu___2))
:named equation_Eq.uu___2))
;;;;;;;;;;;;;;;;Equation for Eq.eq_pair
;;; Fact-ids: Name Eq.eq_pair; Namespace Eq
(assert (! 
;; def=Eq.fst(49,9-49,16); use=Eq.fst(49,9-49,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3)
(Eq.Mkdeq (FStar.Pervasives.Native.tuple2 @x0
@x1)
(Tm_abs_af9a9fad24ef4b376771ad8eab3c0844 @x2
@x3
@x1
@x0)
(Tm_abs_666798151111a3c67f9fe6a529302e93 @x1
@x0)))
...
@x2
@x3))
:qid equation_Eq.eq_pair))

:named equation_Eq.eq_pair))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.string; Namespace Prims
(assert (! (= 207
...
(Tm_arrow_c3bd8208ce1c592d617103bb20e42f20 @x2
@x3)))
:qid Eq_pre_typing_Tm_arrow_c3bd8208ce1c592d617103bb20e42f20))

:named Eq_pre_typing_Tm_arrow_c3bd8208ce1c592d617103bb20e42f20))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c3bd8208ce1c592d617103bb20e42f20
;;; Fact-ids: Name Eq.eq_pair; Namespace Eq
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=Eq.fst(50,2-50,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_c3bd8208ce1c592d617103bb20e42f20 @x1
@x2))
(and 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=Eq.fst(50,2-50,7)
(forall ((@x3 Term) (@x4 Term))
...
@x3)
@x4))
:qid Eq_interpretation_Tm_arrow_c3bd8208ce1c592d617103bb20e42f20.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Eq_interpretation_Tm_arrow_c3bd8208ce1c592d617103bb20e42f20.2))
))
...
(Tm_arrow_c3bd8208ce1c592d617103bb20e42f20 @x1
@x2)))
:qid Eq_interpretation_Tm_arrow_c3bd8208ce1c592d617103bb20e42f20))

:named Eq_interpretation_Tm_arrow_c3bd8208ce1c592d617103bb20e42f20))
(push) ;; push{2

; Starting query at Eq.fst(63,0-63,37)

(declare-fun label_1 () Bool)


; Encoding query formula : Eq.eq (1, "A") (1, "A")


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let uu___9`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Eq.fst(63,15-63,37); use=Eq.fst(63,8-63,14)
(or label_1
...
Prims.string))
(Eq.eq_pair Prims.int
Prims.string
(Eq.uu___0 Dummy_value)
(Eq.uu___2 Dummy_value)))
...
; Starting query at Eq.fst(64,0-64,43)

(declare-fun label_1 () Bool)


; Encoding query formula : Prims.op_Negation (Eq.eq (1, "A") (1, "B"))


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let uu___10`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eq.uu___10, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Eq.eq, equation_Eq.eq_instance_of_eqtype, equation_Eq.eq_pair, equation_Eq.uu___0, equation_Eq.uu___2, interpretation_Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa, interpretation_Tm_abs_af9a9fad24ef4b376771ad8eab3c0844, interpretation_Tm_abs_e98f4b71ef47e83d53da8f81c925bb67, primitive_Prims.op_AmpAmp, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, projection_inverse_BoxString_proj_0, projection_inverse_Eq.Mkdeq_eq, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FString_const_proj_0, token_correspondence_Eq.eq
...
; Starting query at Eq.fst(65,0-65,43)

(declare-fun label_1 () Bool)


; Encoding query formula : Prims.op_Negation (Eq.eq (2, "A") (1, "B"))
...
; Starting query at Eq.fst(66,0-66,43)

(declare-fun label_1 () Bool)


; Encoding query formula : Prims.op_Negation (Eq.eq (2, "A") (1, "A"))


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let uu___12`
