...
; Externals for module Add


; <Start encoding type Add.additive>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Add.additive (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Add.additive@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Add.Mkadditive (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Add.Mkadditive_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Add.Mkadditive_zero (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Add.Mkadditive_plus (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Add.Mkadditive_zero_l (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Add.Mkadditive_zero_r (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Add.Mkadditive_plus_assoc (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Add.Mkadditive
(declare-fun Add.Mkadditive@tok () Term)
;;;;;;;;;;;;;;;;_: a -> _: a -> a
...
;;;;;;;;;;;;;;;;x: a -> FStar.Pervasives.Lemma (ensures plus zero x == x)
(declare-fun Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2 (Term Term Term) Term)
(declare-fun Tm_refine_012bcd968e4f958cde3ef315e32c8ae5 (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> FStar.Pervasives.Lemma (ensures plus x zero == x)
(declare-fun Tm_arrow_c50378e6555d46933f317679ca8c6e54 (Term Term Term) Term)
(declare-fun Tm_refine_bc7da5704acd37a40f84289399f6cbf8 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> z: a -> FStar.Pervasives.Lemma (ensures plus (plus x y) z == plus x (plus y z))
...
;;;;;;;;;;;;;;;;zero: a ->     plus: (_: a -> _: a -> a) ->     zero_l: (x: a -> FStar.Pervasives.Lemma (ensures plus zero x == x)) ->     zero_r: (x: a -> FStar.Pervasives.Lemma (ensures plus x zero == x)) ->     plus_assoc:       (x: a -> y: a -> z: a           -> FStar.Pervasives.Lemma (ensures plus (plus x y) z == plus x (plus y z)))   -> additive a
(declare-fun Tm_arrow_3d98507cd7632954285ed7dbae464705 () Term)

; <start constructor Add.additive>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Add.additive ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
101)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor Add.additive>


; <start constructor Add.Mkadditive>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Add.Mkadditive ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
119)
(= __@x0
(Add.Mkadditive (Add.Mkadditive_a __@x0)
(Add.Mkadditive_zero __@x0)
(Add.Mkadditive_plus __@x0)
(Add.Mkadditive_zero_l __@x0)
(Add.Mkadditive_zero_r __@x0)
(Add.Mkadditive_plus_assoc __@x0)))))

; </end constructor Add.Mkadditive>


; </end encoding type Add.additive>


; <Start encoding val Add.__proj__Mkadditive__item__zero>

(declare-fun Add.__proj__Mkadditive__item__zero (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: additive a -> a
(declare-fun Tm_arrow_fc7746f937aed61a1889cb25850da161 () Term)
(declare-fun Add.__proj__Mkadditive__item__zero@tok () Term)

; </end encoding val Add.__proj__Mkadditive__item__zero>


; <Skipped let __proj__Mkadditive__item__zero/>


; <Start encoding val Add.__proj__Mkadditive__item__plus>

(declare-fun Add.__proj__Mkadditive__item__plus (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: additive a -> _: a -> _: a -> a
(declare-fun Tm_arrow_56e2a21c05cb89e8445514c04cf61825 () Term)
(declare-fun Add.__proj__Mkadditive__item__plus@tok () Term)


; </end encoding val Add.__proj__Mkadditive__item__plus>


; <Skipped let __proj__Mkadditive__item__plus/>


; <Start encoding val Add.__proj__Mkadditive__item__zero_l>

(declare-fun Add.__proj__Mkadditive__item__zero_l (Term Term) Term)
(declare-fun Tm_refine_ec596fc054c205d3fec939f1cfff66cf (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> FStar.Pervasives.Lemma (ensures projectee.plus projectee.zero x == x)
(declare-fun Tm_arrow_56bcd032cf4c3ee5b5f3b22bdc1e15dd (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: additive a -> x: a   -> FStar.Pervasives.Lemma (ensures projectee.plus projectee.zero x == x)
(declare-fun Tm_arrow_d74622b3ec24e4c099334c841640a07e () Term)
(declare-fun Add.__proj__Mkadditive__item__zero_l@tok () Term)




; </end encoding val Add.__proj__Mkadditive__item__zero_l>


; <Skipped let __proj__Mkadditive__item__zero_l/>


; <Start encoding val Add.__proj__Mkadditive__item__zero_r>

(declare-fun Add.__proj__Mkadditive__item__zero_r (Term Term) Term)

(declare-fun Tm_refine_bfa8c80f8f7ee535300ea584715cec31 (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> FStar.Pervasives.Lemma (ensures projectee.plus x projectee.zero == x)
(declare-fun Tm_arrow_16d5a5a3c5d1da7eedb9fef8c46fafb1 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: additive a -> x: a   -> FStar.Pervasives.Lemma (ensures projectee.plus x projectee.zero == x)
(declare-fun Tm_arrow_29b1d0289e27822f33acacae79acf626 () Term)
(declare-fun Add.__proj__Mkadditive__item__zero_r@tok () Term)




; </end encoding val Add.__proj__Mkadditive__item__zero_r>


; <Skipped let __proj__Mkadditive__item__zero_r/>


; <Start encoding val Add.__proj__Mkadditive__item__plus_assoc>

(declare-fun Add.__proj__Mkadditive__item__plus_assoc (Term Term) Term)




(declare-fun Tm_refine_a5457c39d155dc0aa9fc0dcf38103a52 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma     (ensures projectee.plus (projectee.plus x y) z == projectee.plus x (projectee.plus y z))
(declare-fun Tm_arrow_7216bf0a523883a235595743a7d65021 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: additive a -> x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma     (ensures projectee.plus (projectee.plus x y) z == projectee.plus x (projectee.plus y z))
(declare-fun Tm_arrow_0ff3b5ba0fd8326dc11c27a525f466ac () Term)
(declare-fun Add.__proj__Mkadditive__item__plus_assoc@tok () Term)
...
; </end encoding val Add.__proj__Mkadditive__item__plus_assoc>


; <Skipped let __proj__Mkadditive__item__plus_assoc/>


; <Start encoding let zero>

(declare-fun Add.zero (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: additive a |} -> a
(declare-fun Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: additive a |} -> a
(declare-fun Tm_arrow_1e166f7c3978cec871a132fdfd911834 () Term)
(declare-fun Add.zero@tok () Term)


(declare-fun Tm_abs_2a17ec8012a10516658a371204669585 (Term) Term)

; </end encoding let zero>


; <Start encoding let plus>

(declare-fun Add.plus (Term) Term)
;;;;;;;;;;;;;;;;_: a -> a
(declare-fun Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 (Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: a -> a
(declare-fun Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: additive a |} -> _: a -> _: a -> a
(declare-fun Tm_arrow_d7439c04278b9188e182a3b35f94854a (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: additive a |} -> _: a -> _: a -> a
(declare-fun Tm_arrow_4758961aabfefbefddf5f91ef90829e3 () Term)
(declare-fun Add.plus@tok () Term)
...
(declare-fun Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e (Term) Term)

; </end encoding let plus>


; <Start encoding let zero_l>

(declare-fun Add.zero_l (Term) Term)
(declare-fun Non_total_Tm_arrow_f0180bb4c28dce5e7b80b8aa3fa5d428 (Term Term) Term)
;;;;;;;;;;;;;;;;{| projectee: additive a |} -> x: a   -> FStar.Pervasives.Lemma (ensures projectee.plus projectee.zero x == x)
(declare-fun Tm_arrow_8d676c52ff5c5c2bc321127aaa0a9f36 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: additive a |} -> x: a   -> FStar.Pervasives.Lemma (ensures projectee.plus projectee.zero x == x)
(declare-fun Tm_arrow_3269cf9724e9128b3a05e471dc786a90 () Term)
(declare-fun Add.zero_l@tok () Term)




(declare-fun Tm_abs_a71626b9743c8545738f0c8bdb535e13 (Term) Term)

; </end encoding let zero_l>


; <Start encoding let zero_r>

(declare-fun Add.zero_r (Term) Term)
(declare-fun Non_total_Tm_arrow_e63b6b3f40bad03180813d3e0d75b0f0 (Term Term) Term)
;;;;;;;;;;;;;;;;{| projectee: additive a |} -> x: a   -> FStar.Pervasives.Lemma (ensures projectee.plus x projectee.zero == x)
(declare-fun Tm_arrow_7905b2fe499b4f4d53f64997010be0c4 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: additive a |} -> x: a   -> FStar.Pervasives.Lemma (ensures projectee.plus x projectee.zero == x)
(declare-fun Tm_arrow_9754d1bf977e29bb9ac0ee007476a0e4 () Term)
(declare-fun Add.zero_r@tok () Term)




(declare-fun Tm_abs_d77bb3480e4a4aa34cbacd6a9ea6a69b (Term) Term)

; </end encoding let zero_r>


; <Start encoding let plus_assoc>

(declare-fun Add.plus_assoc (Term) Term)
(declare-fun Non_total_Tm_arrow_38601d5d12dff9e5ec00728536d89242 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;y: a -> z: a   -> FStar.Pervasives.Lemma     (ensures projectee.plus (projectee.plus x y) z == projectee.plus x (projectee.plus y z))
(declare-fun Tm_arrow_4741871afcf81f8030fc46068eda3330 (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma     (ensures projectee.plus (projectee.plus x y) z == projectee.plus x (projectee.plus y z))
(declare-fun Tm_arrow_74a83e396d7a329c489da8ad9e1cae4f (Term Term) Term)
;;;;;;;;;;;;;;;;{| projectee: additive a |} -> x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma     (ensures projectee.plus (projectee.plus x y) z == projectee.plus x (projectee.plus y z))
(declare-fun Tm_arrow_ff2657e50c6e10b5b330f14a5771d837 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: additive a |} -> x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma     (ensures projectee.plus (projectee.plus x y) z == projectee.plus x (projectee.plus y z))
(declare-fun Tm_arrow_35fffca7430e70c79b994317996a1f33 () Term)
(declare-fun Add.plus_assoc@tok () Term)
...
(declare-fun Tm_abs_89cdfafb23ac4c619e7f63bbdc4c5657 (Term) Term)

; </end encoding let plus_assoc>


; <Skipped val Add.mkadd/>


; <Start encoding let mkadd>


(declare-fun Add.mkadd (Term Term Term) Term)

(declare-fun Tm_refine_5326efd3f23fff3a5a77c081ed400501 (Term Term Term) Term)
;;;;;;;;;;;;;;;;zero: a -> plus: (_: a -> _: a -> a) -> Prims.Pure (additive a)
(declare-fun Tm_arrow_b1eb5f5c8bd298a03575c67978b22deb () Term)
(declare-fun Add.mkadd@tok () Term)
...
; </end encoding let mkadd>


; <Start encoding let add_int>

(declare-fun Add.add_int (Dummy_sort) Term)

; </end encoding let add_int>


; <Start encoding let add_bool>

(declare-fun Add.add_bool (Dummy_sort) Term)

; </end encoding let add_bool>


; <Start encoding let add_list>

(declare-fun Add.add_list (Term) Term)
;;;;;;;;;;;;;;;;additive (Prims.list a)
(declare-fun Tm_arrow_1ce23b83fd9201ce9dc2a3bc3ab2a30e () Term)
(declare-fun Add.add_list@tok () Term)

; </end encoding let add_list>


; <Start encoding let uu___0>

(declare-fun Add.uu___0 (Dummy_sort) Term)
...
(declare-fun Add.uu___1 (Dummy_sort) Term)
...
(declare-fun Add.uu___2 (Dummy_sort) Term)

; </end encoding let uu___2>


; <Start encoding let uu___3>

(declare-fun Add.uu___3 (Dummy_sort) Term)

; </end encoding let uu___3>


; End Externals for module Add


; Externals for module Eq


; <Start encoding type Eq.deq>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Eq.deq (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Eq.deq@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Eq.Mkdeq (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eq.Mkdeq_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eq.Mkdeq_eq (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eq.Mkdeq_eq_ok (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Eq.Mkdeq
(declare-fun Eq.Mkdeq@tok () Term)

(declare-fun Tm_refine_77b95d311db48f3e487387252c8b47fe (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> FStar.Pervasives.Lemma (ensures eq x y <==> x == y)
(declare-fun Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f (Term Term) Term)



;;;;;;;;;;;;;;;;eq: (_: a -> _: a -> Prims.bool) ->     eq_ok: (x: a -> y: a -> FStar.Pervasives.Lemma (ensures eq x y <==> x == y))   -> deq a
(declare-fun Tm_arrow_f93b4b451960eba2e1ba20d4aaa9ef1a () Term)

; <start constructor Eq.deq>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eq.deq ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
101)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor Eq.deq>


; <start constructor Eq.Mkdeq>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eq.Mkdeq ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
113)
(= __@x0
(Eq.Mkdeq (Eq.Mkdeq_a __@x0)
(Eq.Mkdeq_eq __@x0)
(Eq.Mkdeq_eq_ok __@x0)))))

; </end constructor Eq.Mkdeq>


; </end encoding type Eq.deq>


; <Start encoding val Eq.__proj__Mkdeq__item__eq>

(declare-fun Eq.__proj__Mkdeq__item__eq (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: deq a -> _: a -> _: a -> Prims.bool
(declare-fun Tm_arrow_89234680f2f2b9e34fb406917228ab69 () Term)
(declare-fun Eq.__proj__Mkdeq__item__eq@tok () Term)


; </end encoding val Eq.__proj__Mkdeq__item__eq>


; <Skipped let __proj__Mkdeq__item__eq/>


; <Start encoding val Eq.__proj__Mkdeq__item__eq_ok>

(declare-fun Eq.__proj__Mkdeq__item__eq_ok (Term Term) Term)
(declare-fun Tm_refine_badd6543c72c41a99eef6168eb1c8c65 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> FStar.Pervasives.Lemma (ensures projectee.eq x y <==> x == y)
(declare-fun Tm_arrow_bcf6e573a6fdb388f59287b60d714c09 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: deq a -> x: a -> y: a -> FStar.Pervasives.Lemma (ensures projectee.eq x y <==> x == y)
(declare-fun Tm_arrow_a66425d6a8f2d8044cb4e3347ac414da () Term)
(declare-fun Eq.__proj__Mkdeq__item__eq_ok@tok () Term)




; </end encoding val Eq.__proj__Mkdeq__item__eq_ok>


; <Skipped let __proj__Mkdeq__item__eq_ok/>


; <Start encoding let eq>

(declare-fun Eq.eq (Term) Term)

;;;;;;;;;;;;;;;;_: a -> _: a -> Prims.bool
(declare-fun Tm_arrow_649a0684309abaa78e673cf48ebf1183 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: deq a |} -> _: a -> _: a -> Prims.bool
(declare-fun Tm_arrow_f8f69472a0776db7a176ba1f82e77adb (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: deq a |} -> _: a -> _: a -> Prims.bool
(declare-fun Tm_arrow_69cb689ec71962d9ded15915f1d629d0 () Term)
(declare-fun Eq.eq@tok () Term)
...
(declare-fun Tm_abs_1882061b6497b0ef7b8bcc1e4f3bbdaa (Term) Term)

; </end encoding let eq>


; <Start encoding let eq_ok>

(declare-fun Eq.eq_ok (Term) Term)
(declare-fun Non_total_Tm_arrow_4470123c685533aea4579ecd76286fe5 (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> FStar.Pervasives.Lemma (ensures projectee.eq x y <==> x == y)
(declare-fun Tm_arrow_6dae6ce78d25276f4ad07cde05493d22 (Term Term) Term)
;;;;;;;;;;;;;;;;{| projectee: deq a |} -> x: a -> y: a   -> FStar.Pervasives.Lemma (ensures projectee.eq x y <==> x == y)
(declare-fun Tm_arrow_9de2cfdd784d40b76c7f7bb1001dfa29 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: deq a |} -> x: a -> y: a   -> FStar.Pervasives.Lemma (ensures projectee.eq x y <==> x == y)
(declare-fun Tm_arrow_e19ed959ae3705522b5e5b20f9f3eee2 () Term)
(declare-fun Eq.eq_ok@tok () Term)
...
(declare-fun Tm_abs_2b493b1c29582029f8e5c6c91d4764a7 (Term) Term)

; </end encoding let eq_ok>


; <Start encoding let eq_instance_of_eqtype>

(declare-fun Eq.eq_instance_of_eqtype (Term) Term)
;;;;;;;;;;;;;;;;deq a
(declare-fun Tm_arrow_3aa6f4dd86577cce0ce72611b58b54dd () Term)
(declare-fun Eq.eq_instance_of_eqtype@tok () Term)

(declare-fun Tm_abs_e98f4b71ef47e83d53da8f81c925bb67 (Term) Term)
(declare-fun Tm_abs_805426822673ada0617375120788033b (Term) Term)

; </end encoding let eq_instance_of_eqtype>


; <Start encoding let uu___0>

(declare-fun Eq.uu___0 (Dummy_sort) Term)
...
(declare-fun Eq.uu___1 (Dummy_sort) Term)
...
(declare-fun Eq.uu___2 (Dummy_sort) Term)

; </end encoding let uu___2>


; <Start encoding let rec eqList>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Eq.eqList.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Eq.eqList.fuel_instrumented_token () Term)
(declare-fun Eq.eqList (Term Term Term Term) Term)
(declare-fun Eq.eqList@tok () Term)
(declare-fun Tm_refine_f0ac051651fa0e095f1b2c1241fd6a3f (Term Term) Term)

;;;;;;;;;;;;;;;;{| _: deq 'a |} -> xs: Prims.list 'a -> ys: Prims.list 'a -> b: Prims.bool{b <==> xs == ys}
(declare-fun Tm_arrow_7aa492a2d1bcc16697b15f18414834ca () Term)


; </end encoding let rec eqList>


; <Start encoding let eq_list>

(declare-fun Eq.eq_list (Term Term) Term)
;;;;;;;;;;;;;;;;_: deq 'a -> deq (Prims.list 'a)
(declare-fun Tm_arrow_16bc93c5452372a68560bc0cfb09e022 () Term)
(declare-fun Eq.eq_list@tok () Term)
(declare-fun Tm_abs_70fa578c350595a5bde8fba9e51e1f6a (Term) Term)

; </end encoding let eq_list>


; <Start encoding let eq_pair>

(declare-fun Eq.eq_pair (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: deq 'a -> _: deq 'b -> deq ('a & 'b)
(declare-fun Tm_arrow_e376bb55b0c5c5fefbde46bddaa9d718 () Term)
(declare-fun Eq.eq_pair@tok () Term)


;;;;;;;;;;;;;;;;_: 'a & 'b -> _: 'a & 'b -> Prims.bool
(declare-fun Tm_arrow_c3bd8208ce1c592d617103bb20e42f20 (Term Term) Term)
(declare-fun Tm_abs_af9a9fad24ef4b376771ad8eab3c0844 (Term Term Term Term) Term)
(declare-fun Tm_abs_666798151111a3c67f9fe6a529302e93 (Term Term) Term)

; </end encoding let eq_pair>


; <Start encoding let uu___3>

(declare-fun Eq.uu___3 (Dummy_sort) Term)

; </end encoding let uu___3>


; <Start encoding let uu___4>

(declare-fun Eq.uu___4 (Dummy_sort) Term)

; </end encoding let uu___4>


; <Start encoding let uu___5>

(declare-fun Eq.uu___5 (Dummy_sort) Term)

; </end encoding let uu___5>


; <Start encoding let uu___6>

(declare-fun Eq.uu___6 (Dummy_sort) Term)

; </end encoding let uu___6>


; <Start encoding let uu___7>

(declare-fun Eq.uu___7 (Dummy_sort) Term)

; </end encoding let uu___7>


; <Start encoding let uu___8>

(declare-fun Eq.uu___8 (Dummy_sort) Term)

; </end encoding let uu___8>


; <Start encoding let uu___9>

(declare-fun Eq.uu___9 (Dummy_sort) Term)

; </end encoding let uu___9>


; <Start encoding let uu___10>

(declare-fun Eq.uu___10 (Dummy_sort) Term)

; </end encoding let uu___10>


; <Start encoding let uu___11>

(declare-fun Eq.uu___11 (Dummy_sort) Term)

; </end encoding let uu___11>


; <Start encoding let uu___12>

(declare-fun Eq.uu___12 (Dummy_sort) Term)

; </end encoding let uu___12>


; End Externals for module Eq


; Externals for module Num


; <Start encoding type Num.num>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Num.num (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Num.num@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Num.Mknum (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Num.Mknum_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Num.Mknum_eq_super (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Num.Mknum_add_super (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Num.Mknum_minus (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Num.Mknum
(declare-fun Num.Mknum@tok () Term)


;;;;;;;;;;;;;;;;eq_super: Eq.deq a -> add_super: Add.additive a -> minus: (_: a -> _: a -> a) -> num a
(declare-fun Tm_arrow_15d112340a02a73566bf0bbf79518c4e () Term)

; <start constructor Num.num>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Num.num ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
101)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor Num.num>


; <start constructor Num.Mknum>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Num.Mknum ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
110)
(= __@x0
(Num.Mknum (Num.Mknum_a __@x0)
(Num.Mknum_eq_super __@x0)
(Num.Mknum_add_super __@x0)
(Num.Mknum_minus __@x0)))))

; </end constructor Num.Mknum>


; </end encoding type Num.num>


; <Start encoding val Num.__proj__Mknum__item__eq_super>

(declare-fun Num.__proj__Mknum__item__eq_super (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: num a -> Eq.deq a
(declare-fun Tm_arrow_39c0db601fd46f62252c5ab51e6ec464 () Term)
(declare-fun Num.__proj__Mknum__item__eq_super@tok () Term)

; </end encoding val Num.__proj__Mknum__item__eq_super>


; <Skipped let __proj__Mknum__item__eq_super/>


; <Start encoding val Num.__proj__Mknum__item__add_super>

(declare-fun Num.__proj__Mknum__item__add_super (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: num a -> Add.additive a
(declare-fun Tm_arrow_d097fe72d18024d73e34f04fd4ab4a59 () Term)
(declare-fun Num.__proj__Mknum__item__add_super@tok () Term)

; </end encoding val Num.__proj__Mknum__item__add_super>


; <Skipped let __proj__Mknum__item__add_super/>


; <Start encoding val Num.__proj__Mknum__item__minus>

(declare-fun Num.__proj__Mknum__item__minus (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: num a -> _: a -> _: a -> a
(declare-fun Tm_arrow_5f959ddb736401b8c9efa21039f9e95d () Term)
(declare-fun Num.__proj__Mknum__item__minus@tok () Term)


; </end encoding val Num.__proj__Mknum__item__minus>


; <Skipped let __proj__Mknum__item__minus/>


; <Start encoding let eq_super>

(declare-fun Num.eq_super (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: num a |} -> Eq.deq a
(declare-fun Tm_arrow_716e4d80ce136006302ec28d80c0d529 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: num a |} -> Eq.deq a
(declare-fun Tm_arrow_0eea14f622477cd1474ee0dd13efbb55 () Term)
(declare-fun Num.eq_super@tok () Term)


(declare-fun Tm_abs_a46e71e1777e36cb3ef47af14f652bbe (Term) Term)

; </end encoding let eq_super>


; <Start encoding let add_super>

(declare-fun Num.add_super (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: num a |} -> Add.additive a
(declare-fun Tm_arrow_95b6ca42dab91824ff088381b47110ca (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: num a |} -> Add.additive a
(declare-fun Tm_arrow_8837c28cce2efd15e0263f2b80937312 () Term)
(declare-fun Num.add_super@tok () Term)


(declare-fun Tm_abs_43700c66b2b0895929361a62886cc789 (Term) Term)

; </end encoding let add_super>


; <Start encoding let minus>

(declare-fun Num.minus (Term) Term)


;;;;;;;;;;;;;;;;{| projectee: num a |} -> _: a -> _: a -> a
(declare-fun Tm_arrow_f99c8652c211e1bb0d410c61fff6627f (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: num a |} -> _: a -> _: a -> a
(declare-fun Tm_arrow_388e801b5cee50cb6b2225217ba294fd () Term)
(declare-fun Num.minus@tok () Term)
...
(declare-fun Tm_abs_73a7b9c27305555126e8994d285f754f (Term) Term)

; </end encoding let minus>


; <Start encoding let num_eq>

(declare-fun Num.num_eq (Term Term) Term)

(declare-fun Num.num_eq@tok () Term)

; </end encoding let num_eq>


; <Start encoding let add_num>

(declare-fun Num.add_num (Term Term) Term)

(declare-fun Num.add_num@tok () Term)

; </end encoding let add_num>


; <Start encoding let mknum>
...
; </end encoding let mknum>


; <Start encoding let num_int>

(declare-fun Num.num_int (Dummy_sort) Term)

(declare-fun Tm_abs_12ddde8171c888fa95f826be9c2a1fe9 () Term)

; </end encoding let num_int>


; <Start encoding let num_bool>

(declare-fun Num.num_bool (Dummy_sort) Term)

(declare-fun Tm_abs_dbb07a25cb8c9e3a3913226e20cbe5b8 () Term)

; </end encoding let num_bool>


; End Externals for module Num
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,6-21,14)
(forall ((@x0 Term))
 (! (= (ApplyTT Add.additive@tok
@x0)
(Add.additive @x0))
 

:pattern ((ApplyTT Add.additive@tok
@x0))

:pattern ((Add.additive @x0))
:qid token_correspondence_Add.additive@tok))

:named token_correspondence_Add.additive@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(616,4-616,8); use=Prims.fst(616,4-616,8)
...
@x6)
(Add.additive @x7)))
:qid subterm_ordering_Add.Mkadditive))

:named subterm_ordering_Add.Mkadditive))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(27,21-27,67); use=Add.fst(27,21-27,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_bc7da5704acd37a40f84289399f6cbf8 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_bc7da5704acd37a40f84289399f6cbf8 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_bc7da5704acd37a40f84289399f6cbf8))

:named refinement_kinding_Tm_refine_bc7da5704acd37a40f84289399f6cbf8))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(24,27-24,51); use=Add.fst(24,27-24,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d))

:named refinement_kinding_Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(25,27-25,51); use=Add.fst(25,27-25,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_012bcd968e4f958cde3ef315e32c8ae5 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_012bcd968e4f958cde3ef315e32c8ae5 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_012bcd968e4f958cde3ef315e32c8ae5))

:named refinement_kinding_Tm_refine_012bcd968e4f958cde3ef315e32c8ae5))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_bc7da5704acd37a40f84289399f6cbf8 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Prims.fst(635,71-635,97); use=Add.fst(27,21-27,67)
(not 
;; def=Prims.fst(441,29-441,97); use=Add.fst(27,21-27,26)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=Add.fst(27,27-27,67); use=Add.fst(27,21-27,26)
(= (ApplyTT (ApplyTT @x2
(ApplyTT (ApplyTT @x2
@x3)
@x4))
...
;; def=Prims.fst(635,86-635,95); use=Add.fst(27,21-27,67)
(not 
;; def=Prims.fst(635,86-635,95); use=Add.fst(27,21-27,67)
(= @x6
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_bc7da5704acd37a40f84289399f6cbf8.1))
)
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_bc7da5704acd37a40f84289399f6cbf8))

:named refinement_interpretation_Tm_refine_bc7da5704acd37a40f84289399f6cbf8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Stubs.Tactics.Types.tracepoint; Namespace FStar.Stubs.Tactics.Types
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=Add.fst(24,27-24,51)
(not 
;; def=Prims.fst(441,29-441,97); use=Add.fst(24,27-24,32)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=Add.fst(24,33-24,51); use=Add.fst(24,27-24,32)
(= (ApplyTT (ApplyTT @x2
@x3)
@x4)
@x4)
...
;; def=Prims.fst(635,86-635,95); use=Add.fst(24,27-24,51)
(not 
;; def=Prims.fst(635,86-635,95); use=Add.fst(24,27-24,51)
(= @x5
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d.1))
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d))

:named refinement_interpretation_Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_012bcd968e4f958cde3ef315e32c8ae5 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=Add.fst(25,27-25,51)
(not 
;; def=Prims.fst(441,29-441,97); use=Add.fst(25,27-25,32)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=Add.fst(25,33-25,51); use=Add.fst(25,27-25,32)
(= (ApplyTT (ApplyTT @x2
@x3)
@x4)
@x3)
...
;; def=Prims.fst(635,86-635,95); use=Add.fst(25,27-25,51)
(not 
;; def=Prims.fst(635,86-635,95); use=Add.fst(25,27-25,51)
(= @x5
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_012bcd968e4f958cde3ef315e32c8ae5.1))
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_012bcd968e4f958cde3ef315e32c8ae5))

:named refinement_interpretation_Tm_refine_012bcd968e4f958cde3ef315e32c8ae5))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(615,4-615,7); use=Prims.fst(615,4-615,7)
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Add.Mkadditive_zero_r (Add.Mkadditive @x0
@x1
@x2
@x3
@x4
...
:pattern ((Add.Mkadditive @x0
@x1
@x2
@x3
@x4
@x5))
:qid projection_inverse_Add.Mkadditive_zero_r))

:named projection_inverse_Add.Mkadditive_zero_r))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,6-21,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Add.Mkadditive_zero_l (Add.Mkadditive @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Add.Mkadditive_zero_l))

:named projection_inverse_Add.Mkadditive_zero_l))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,6-21,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Add.Mkadditive_zero (Add.Mkadditive @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Add.Mkadditive_zero))

:named projection_inverse_Add.Mkadditive_zero))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,6-21,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Add.Mkadditive_plus_assoc (Add.Mkadditive @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Add.Mkadditive_plus_assoc))

:named projection_inverse_Add.Mkadditive_plus_assoc))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,6-21,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Add.Mkadditive_plus (Add.Mkadditive @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Add.Mkadditive_plus))

:named projection_inverse_Add.Mkadditive_plus))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,6-21,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Add.Mkadditive_a (Add.Mkadditive @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Add.Mkadditive_a))

:named projection_inverse_Add.Mkadditive_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! (is-Tm_arrow (PreType Add.additive@tok))
:named pre_kinding_Add.additive@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c50378e6555d46933f317679ca8c6e54
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-25,51); use=Add.fst(25,21-25,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_c50378e6555d46933f317679ca8c6e54 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_c50378e6555d46933f317679ca8c6e54 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_c50378e6555d46933f317679ca8c6e54))

:named kinding_Tm_arrow_c50378e6555d46933f317679ca8c6e54))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-24,51); use=Add.fst(24,21-24,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2))

:named kinding_Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9975d018af81a325c298730f866f4b56
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-27,67); use=Add.fst(26,21-27,67)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_9975d018af81a325c298730f866f4b56 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_9975d018af81a325c298730f866f4b56 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_9975d018af81a325c298730f866f4b56))

:named kinding_Tm_arrow_9975d018af81a325c298730f866f4b56))
...
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-21,16); use=Add.fst(23,15-23,26)
(forall ((@x0 Term))
...
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! (and (IsTotFun Add.additive@tok)

;; def=Add.fst(21,6-21,14); use=Add.fst(21,6-21,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Add.additive @x0)
Tm_type))
 

:pattern ((Add.additive @x0))
:qid kinding_Add.additive@tok))
)
:named kinding_Add.additive@tok))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_bc7da5704acd37a40f84289399f6cbf8
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(27,21-27,67); use=Add.fst(27,21-27,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_bc7da5704acd37a40f84289399f6cbf8 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_bc7da5704acd37a40f84289399f6cbf8 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_bc7da5704acd37a40f84289399f6cbf8))

:named haseqTm_refine_bc7da5704acd37a40f84289399f6cbf8))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(24,27-24,51); use=Add.fst(24,27-24,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d @x0
@x1
@x2))))
:qid haseqTm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d))

:named haseqTm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_012bcd968e4f958cde3ef315e32c8ae5
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(25,27-25,51); use=Add.fst(25,27-25,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_012bcd968e4f958cde3ef315e32c8ae5 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_012bcd968e4f958cde3ef315e32c8ae5 @x0
@x1
@x2))))
:qid haseqTm_refine_012bcd968e4f958cde3ef315e32c8ae5))

:named haseqTm_refine_012bcd968e4f958cde3ef315e32c8ae5))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
@x1
(Add.additive @x2)))
:qid fuel_guarded_inversion_Add.additive))

:named fuel_guarded_inversion_Add.additive))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! (= 319
...
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! (= 102
(Term_constr_id Add.additive@tok))
:named fresh_token_Add.additive@tok))
...
(HasTypeFuel @u0
@x4
(Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2 @x2
@x3
@x1))
(HasTypeFuel @u0
@x5
(Tm_arrow_c50378e6555d46933f317679ca8c6e54 @x2
@x3
@x1))
(HasTypeFuel @u0
@x6
(Tm_arrow_9975d018af81a325c298730f866f4b56 @x3
@x1)))
(HasTypeFuel @u0
(Add.Mkadditive @x1
@x2
...
@x6)
(Add.additive @x1)))
:qid data_typing_intro_Add.Mkadditive@tok))

:named data_typing_intro_Add.Mkadditive@tok))
...
@x6)
(Add.additive @x7)))
:qid data_elim_Add.Mkadditive))

:named data_elim_Add.Mkadditive))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 101
(Term_constr_id (Add.additive @x0)))
 

:pattern ((Add.additive @x0))
:qid constructor_distinct_Add.additive))

:named constructor_distinct_Add.additive))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,6-21,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= 119
(Term_constr_id (Add.Mkadditive @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid constructor_distinct_Add.Mkadditive))

:named constructor_distinct_Add.Mkadditive))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x0
(Add.additive @x2)))
:qid Add_pretyping_7cb4eac687eb9cb615d896a76af2c24f))

:named Add_pretyping_7cb4eac687eb9cb615d896a76af2c24f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-25,51); use=Add.fst(25,21-25,51)
...
@x3
@x4)))
:qid Add_pre_typing_Tm_arrow_c50378e6555d46933f317679ca8c6e54))

:named Add_pre_typing_Tm_arrow_c50378e6555d46933f317679ca8c6e54))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-24,51); use=Add.fst(24,21-24,51)
...
@x3
@x4)))
:qid Add_pre_typing_Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2))

:named Add_pre_typing_Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-27,67); use=Add.fst(26,21-27,67)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_9975d018af81a325c298730f866f4b56 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_9975d018af81a325c298730f866f4b56 @x2
@x3)))
:qid Add_pre_typing_Tm_arrow_9975d018af81a325c298730f866f4b56))

:named Add_pre_typing_Tm_arrow_9975d018af81a325c298730f866f4b56))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-21,16); use=Add.fst(23,15-23,26)
...
@x1
(Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x2)))
:qid Add_pre_typing_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))

:named Add_pre_typing_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c50378e6555d46933f317679ca8c6e54
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-25,51); use=Add.fst(25,21-25,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_c50378e6555d46933f317679ca8c6e54 @x1
@x2
@x3))
(and 
;; def=Add.fst(21,15-25,51); use=Add.fst(25,21-25,51)
...
:pattern ((ApplyTT @x0
@x4))
:qid Add_interpretation_Tm_arrow_c50378e6555d46933f317679ca8c6e54.1))
...
@x2
@x3)))
:qid Add_interpretation_Tm_arrow_c50378e6555d46933f317679ca8c6e54))

:named Add_interpretation_Tm_arrow_c50378e6555d46933f317679ca8c6e54))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-24,51); use=Add.fst(24,21-24,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2 @x1
@x2
@x3))
(and 
;; def=Add.fst(21,15-24,51); use=Add.fst(24,21-24,51)
...
:pattern ((ApplyTT @x0
@x4))
:qid Add_interpretation_Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2.1))
...
@x2
@x3)))
:qid Add_interpretation_Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2))

:named Add_interpretation_Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56
;;; Fact-ids: Name Add.additive; Namespace Add; Name Add.Mkadditive; Namespace Add
(assert (! 
;; def=Add.fst(21,15-27,67); use=Add.fst(26,21-27,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_9975d018af81a325c298730f866f4b56 @x1
@x2))
(and 
;; def=Add.fst(21,15-27,67); use=Add.fst(26,21-27,67)
...
@x4)
@x5)
(Tm_refine_bc7da5704acd37a40f84289399f6cbf8 @x1
@x3
@x4
@x5)))
...
@x4)
@x5))
:qid Add_interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Add_interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56.2))
...
@x3)
@x4))
:qid Add_interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56.3))
))
...
(Tm_arrow_9975d018af81a325c298730f866f4b56 @x1
@x2)))
:qid Add_interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56))

:named Add_interpretation_Tm_arrow_9975d018af81a325c298730f866f4b56))
...
@x2)
@x3))
:qid Add_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid Add_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x1)))
:qid Add_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))

:named Add_interpretation_Tm_arrow_72ac2ec523211f8603e00b25deb1543b))
(push) ;; push{2

; Starting query at Tests.fst(23,4-25,30)
...
;;;;;;;;;;;;;;;;uu___0 : Add.additive a (Add.additive a)
(declare-fun x_029153658607d4ade672ec4c8454839e_2 () Term)
;;;;;;;;;;;;;;;;binder_x_029153658607d4ade672ec4c8454839e_2
;;; Fact-ids: 
(assert (! (HasType x_029153658607d4ade672ec4c8454839e_2
(Add.additive x_fe28d8bcde588226b4e538b35321de05_1))
:named binder_x_029153658607d4ade672ec4c8454839e_2))
...
(declare-fun Tm_refine_feb2d3f2763bf50370a9155d8cb74a23 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Tests.fst(22,22-25,30); use=Tests.fst(22,22-25,30)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_feb2d3f2763bf50370a9155d8cb74a23 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_feb2d3f2763bf50370a9155d8cb74a23 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_feb2d3f2763bf50370a9155d8cb74a23))

:named refinement_kinding_Tm_refine_feb2d3f2763bf50370a9155d8cb74a23))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Tests.fst(22,22-25,30); use=Tests.fst(22,22-25,30)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_feb2d3f2763bf50370a9155d8cb74a23 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
;; def=Tests.fst(22,22-25,30); use=Tests.fst(22,22-25,30)
(or 
;; def=Tests.fst(23,4-25,30); use=Tests.fst(23,4-25,30)
(Valid 
;; def=Tests.fst(23,4-25,30); use=Tests.fst(23,4-25,30)
(Prims.precedes (Add.additive @x2)
(Add.additive x_fe28d8bcde588226b4e538b35321de05_1)
@x3
x_029153658607d4ade672ec4c8454839e_2)
)


;; def=Tests.fst(22,22-25,30); use=Tests.fst(22,22-25,30)
(and 
;; def=Tests.fst(22,22-22,36); use=Tests.fst(22,22-22,36)
(Valid 
;; def=Tests.fst(22,22-22,36); use=Tests.fst(22,22-22,36)
(Prims.op_Equals_Equals_Equals (Add.additive @x2)
(Add.additive x_fe28d8bcde588226b4e538b35321de05_1)
@x3
x_029153658607d4ade672ec4c8454839e_2)
)
...
(Tm_refine_feb2d3f2763bf50370a9155d8cb74a23 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_feb2d3f2763bf50370a9155d8cb74a23))

:named refinement_interpretation_Tm_refine_feb2d3f2763bf50370a9155d8cb74a23))
;;;;;;;;;;;;;;;;haseq for Tm_refine_feb2d3f2763bf50370a9155d8cb74a23
;;; Fact-ids: 
(assert (! 
;; def=Tests.fst(22,22-25,30); use=Tests.fst(22,22-25,30)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_feb2d3f2763bf50370a9155d8cb74a23 @x0
@x1)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_feb2d3f2763bf50370a9155d8cb74a23 @x0
@x1))))
:qid haseqTm_refine_feb2d3f2763bf50370a9155d8cb74a23))

:named haseqTm_refine_feb2d3f2763bf50370a9155d8cb74a23))
(declare-fun Tests.sum (Term Term Term) Term)

;;;;;;;;;;;;;;;;{| _: Add.additive a |} -> l: Prims.list a {_ << _ \/ _ === _ /\ l << l} -> a
(declare-fun Tm_arrow_58a17ba86df33c034845e5f760e62721 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_58a17ba86df33c034845e5f760e62721
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_58a17ba86df33c034845e5f760e62721
Tm_type)
:named kinding_Tm_arrow_58a17ba86df33c034845e5f760e62721))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Tests.fst(22,14-25,30); use=Tests.fst(22,16-25,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_58a17ba86df33c034845e5f760e62721)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_58a17ba86df33c034845e5f760e62721))
:qid Tests_pre_typing_Tm_arrow_58a17ba86df33c034845e5f760e62721))

:named Tests_pre_typing_Tm_arrow_58a17ba86df33c034845e5f760e62721))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_58a17ba86df33c034845e5f760e62721
;;; Fact-ids: 
(assert (! 
;; def=Tests.fst(22,14-25,30); use=Tests.fst(22,16-25,30)
(forall ((@x0 Term))
...
(Add.additive @x1))
(HasType @x3
(Tm_refine_feb2d3f2763bf50370a9155d8cb74a23 @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x2)
@x3))
:qid Tests_interpretation_Tm_arrow_58a17ba86df33c034845e5f760e62721.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Tests_interpretation_Tm_arrow_58a17ba86df33c034845e5f760e62721.2))
...
@x1)
@x2))
:qid Tests_interpretation_Tm_arrow_58a17ba86df33c034845e5f760e62721.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_58a17ba86df33c034845e5f760e62721))
:qid Tests_interpretation_Tm_arrow_58a17ba86df33c034845e5f760e62721))

:named Tests_interpretation_Tm_arrow_58a17ba86df33c034845e5f760e62721))
(declare-fun Tests.sum@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Tests.fst(22,8-22,11); use=Tests.fst(22,8-22,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Tests.sum@tok
@x0)
@x1)
@x2)
(Tests.sum @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Tests.sum@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Tests.sum))

:named token_correspondence_Tests.sum))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Tests.fst(22,8-22,11); use=Tests.fst(22,8-22,11)
...
:pattern ((Tests.sum @x1
@x2
@x3))
:qid function_token_typing_Tests.sum.1))
)
 

:pattern ((ApplyTT @x0
Tests.sum@tok))
:qid function_token_typing_Tests.sum))

:named function_token_typing_Tests.sum))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Tests.fst(22,8-22,11); use=Tests.fst(22,8-22,11)
...
(Add.additive @x0))
(HasType @x2
(Tm_refine_feb2d3f2763bf50370a9155d8cb74a23 @x0
@x1)))
(HasType (Tests.sum @x0
@x1
@x2)
@x0))
 

:pattern ((Tests.sum @x0
@x1
@x2))
:qid typing_Tests.sum))

:named typing_Tests.sum))
...
;   (~(Nil? l) ==> (forall (b: a) (b: Prims.list a). l == b :: b ==> _ << _ \/ b << l))
...
;; def=Prims.fst(402,27-402,88); use=Tests.fst(23,4-25,30)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Tests.fst(23,4-25,30)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Tests.fst(23,4-25,30)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Tests.fst(23,4-25,30)
(and (implies 
;; def=Tests.fst(22,38-22,39); use=Tests.fst(23,10-23,11)
(and 
;; def=Tests.fst(22,38-22,39); use=Tests.fst(23,10-23,11)
(not 
;; def=Tests.fst(22,38-22,39); use=Tests.fst(23,10-23,11)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Tests.fst(23,4-25,30)
(not 
;; def=Tests.fst(22,38-22,39); use=Tests.fst(23,10-23,11)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_0a56e3de562c08d8ab59f4ac6f626a98_3))
...
;; def=Prims.fst(413,99-413,120); use=Tests.fst(23,4-25,30)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=Tests.fst(22,38-25,11); use=Tests.fst(23,10-25,11)
(= x_0a56e3de562c08d8ab59f4ac6f626a98_3
...
;; def=Tests.fst(22,22-25,30); use=Tests.fst(25,27-25,29)
(or label_2

;; def=Tests.fst(23,4-25,30); use=Tests.fst(25,27-25,29)
(Valid 
;; def=Tests.fst(23,4-25,30); use=Tests.fst(25,27-25,29)
(Prims.precedes (Add.additive x_fe28d8bcde588226b4e538b35321de05_1)
(Add.additive x_fe28d8bcde588226b4e538b35321de05_1)
x_029153658607d4ade672ec4c8454839e_2
x_029153658607d4ade672ec4c8454839e_2)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Tests.sum, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_029153658607d4ade672ec4c8454839e_2, binder_x_0a56e3de562c08d8ab59f4ac6f626a98_3, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Add.additive, fuel_guarded_inversion_Prims.list, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Tests.sum.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Tests.sum.fuel_instrumented_token () Term)
(declare-fun Tests.sum (Term Term Term) Term)
(declare-fun Tests.sum@tok () Term)
;;;;;;;;;;;;;;;;{| _: Add.additive a |} -> l: Prims.list a -> a
(declare-fun Tm_arrow_3a3d34f3bb84d43932083d48ef8af6a9 () Term)

; </end encoding let rec sum>


; encoding sigelt let sum2


; <Start encoding let sum2>

(declare-fun Tests.sum2 (Term Term Term) Term)

(declare-fun Tests.sum2@tok () Term)



; </end encoding let sum2>
...
(declare-fun Tests.uu___0 (Dummy_sort) Term)
...
(declare-fun Tests.uu___1 (Dummy_sort) Term)

; </end encoding let uu___1>


; encoding sigelt let sandwich


; <Start encoding let sandwich>

(declare-fun Tests.sandwich (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;{| _: Num.num a |} -> x: a -> y: a -> z: a -> a
(declare-fun Tm_arrow_7fd9212c01d84302b688c5d76d26d468 () Term)
(declare-fun Tests.sandwich@tok () Term)



; </end encoding let sandwich>
...
;;;;;;;;;;;;;;;;typing_Tm_abs_e98f4b71ef47e83d53da8f81c925bb67
;;; Fact-ids: Name Eq.eq_instance_of_eqtype; Namespace Eq
(assert (! 
;; def=Eq.fst(32,20-32,25); use=Eq.fst(32,20-32,25)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_e98f4b71ef47e83d53da8f81c925bb67 @x0)
(Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e @x0))
 

:pattern ((Tm_abs_e98f4b71ef47e83d53da8f81c925bb67 @x0))
:qid typing_Tm_abs_e98f4b71ef47e83d53da8f81c925bb67))

:named typing_Tm_abs_e98f4b71ef47e83d53da8f81c925bb67))
;;;;;;;;;;;;;;;;typing_Tm_abs_2a17ec8012a10516658a371204669585
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! 
;; def=Add.fst(22,2-22,6); use=Add.fst(22,2-22,6)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_2a17ec8012a10516658a371204669585 @x0)
(Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78 @x0))
 

:pattern ((Tm_abs_2a17ec8012a10516658a371204669585 @x0))
:qid typing_Tm_abs_2a17ec8012a10516658a371204669585))

:named typing_Tm_abs_2a17ec8012a10516658a371204669585))
;;;;;;;;;;;;;;;;typing_Tm_abs_12ddde8171c888fa95f826be9c2a1fe9
;;; Fact-ids: Name Num.num_int; Namespace Num
(assert (! (HasType Tm_abs_12ddde8171c888fa95f826be9c2a1fe9
Tm_arrow_47fc285d7b44e13bcb7e420cbfc55623)
:named typing_Tm_abs_12ddde8171c888fa95f826be9c2a1fe9))
;;;;;;;;;;;;;;;;typing_Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=Add.fst(23,2-23,6); use=Add.fst(23,2-23,6)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e @x0)
(Tm_arrow_d7439c04278b9188e182a3b35f94854a @x0))
 

:pattern ((Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e @x0))
:qid typing_Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e))

:named typing_Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Tests.sum; Namespace Tests
(assert (! 
;; def=Tests.fst(22,8-22,11); use=Tests.fst(22,8-22,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
;;; Fact-ids: Name Num.num_int; Namespace Num
(assert (! 
;; def=Num.fst(43,9-43,16); use=Num.fst(43,9-43,16)
(forall ((@u0 Dummy_sort))
 (! (HasType (Num.num_int @u0)
(Num.num Prims.int))
 

:pattern ((Num.num_int @u0))
:qid typing_Num.num_int))

:named typing_Num.num_int))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Num.mknum; Namespace Num
(assert (! 
;; def=Num.fst(38,4-38,9); use=Num.fst(38,4-38,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((Num.mknum @x0
@x1
@x2
@x3))
:qid typing_Num.mknum))

:named typing_Num.mknum))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Num.add_num; Namespace Num
(assert (! 
;; def=Num.fst(36,9-36,16); use=Num.fst(36,9-36,16)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Num.num @x0)))
(HasType (Num.add_num @x0
@x1)
(Add.additive @x0)))
 

:pattern ((Num.add_num @x0
@x1))
:qid typing_Num.add_num))

:named typing_Num.add_num))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Num.__proj__Mknum__item__add_super; Namespace Num
(assert (! 
;; def=Num.fst(26,4-26,13); use=Num.fst(26,4-26,13)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Num.num @x0)))
(HasType (Num.__proj__Mknum__item__add_super @x0
@x1)
(Add.additive @x0)))
 

:pattern ((Num.__proj__Mknum__item__add_super @x0
@x1))
:qid typing_Num.__proj__Mknum__item__add_super))

:named typing_Num.__proj__Mknum__item__add_super))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eq.uu___0; Namespace Eq
(assert (! (forall ((@u0 Dummy_sort))
 (! (HasType (Eq.uu___0 @u0)
(Eq.deq Prims.int))
 

:pattern ((Eq.uu___0 @u0))
:qid typing_Eq.uu___0))
:named typing_Eq.uu___0))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eq.eq_instance_of_eqtype; Namespace Eq
(assert (! 
;; def=Eq.fst(31,4-31,25); use=Eq.fst(31,4-31,25)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.eqtype)
(HasType (Eq.eq_instance_of_eqtype @x0)
(Eq.deq @x0)))
 

:pattern ((Eq.eq_instance_of_eqtype @x0))
:qid typing_Eq.eq_instance_of_eqtype))

:named typing_Eq.eq_instance_of_eqtype))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
...
:pattern ((Add.plus @x0))
:qid typing_Add.plus))
:named typing_Add.plus))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Add.mkadd; Namespace Add
(assert (! 
;; def=Add.fst(41,4-41,9); use=Add.fst(41,4-41,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and 
;; def=Add.fst(37,30-37,64); use=Add.fst(41,4-41,9)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x0)

;; def=Add.fst(37,47-37,63); use=Add.fst(41,4-41,9)
(= (ApplyTT (ApplyTT @x2
@x1)
@x3)
@x3)
...
;;no pats
:qid typing_Add.mkadd.1))


;; def=Add.fst(38,31-38,65); use=Add.fst(41,4-41,9)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x0)

;; def=Add.fst(38,48-38,64); use=Add.fst(41,4-41,9)
(= (ApplyTT (ApplyTT @x2
@x3)
@x1)
@x3)
...
;;no pats
:qid typing_Add.mkadd.2))


;; def=Add.fst(39,31-39,90); use=Add.fst(41,4-41,9)
(forall ((@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x3
@x0)
(HasType @x4
...
;; def=Add.fst(39,51-39,89); use=Add.fst(41,4-41,9)
(= (ApplyTT (ApplyTT @x2
(ApplyTT (ApplyTT @x2
@x3)
@x4))
...
(HasType @x2
(Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x0)))
(HasType (Add.mkadd @x0
@x1
@x2)
(Tm_refine_5326efd3f23fff3a5a77c081ed400501 @x0
@x1
@x2)))
 

:pattern ((Add.mkadd @x0
@x1
@x2))
:qid typing_Add.mkadd))

:named typing_Add.mkadd))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Add.add_int; Namespace Add
(assert (! 
;; def=Add.fst(51,9-51,16); use=Add.fst(51,9-51,16)
(forall ((@u0 Dummy_sort))
 (! (HasType (Add.add_int @u0)
(Add.additive Prims.int))
 

:pattern ((Add.add_int @u0))
:qid typing_Add.add_int))

:named typing_Add.add_int))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Add.__proj__Mkadditive__item__zero; Namespace Add
(assert (! 
;; def=Add.fst(22,2-22,6); use=Add.fst(22,2-22,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Add.additive @x0)))
(HasType (Add.__proj__Mkadditive__item__zero @x0
@x1)
@x0))
 

:pattern ((Add.__proj__Mkadditive__item__zero @x0
@x1))
:qid typing_Add.__proj__Mkadditive__item__zero))

:named typing_Add.__proj__Mkadditive__item__zero))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Add.__proj__Mkadditive__item__plus; Namespace Add
(assert (! 
;; def=Add.fst(23,2-23,6); use=Add.fst(23,2-23,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Add.additive @x0)))
(HasType (Add.__proj__Mkadditive__item__plus @x0
@x1)
(Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x0)))
 

:pattern ((Add.__proj__Mkadditive__item__plus @x0
@x1))
:qid typing_Add.__proj__Mkadditive__item__plus))

:named typing_Add.__proj__Mkadditive__item__plus))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b
;;; Fact-ids: Name Add.mkadd; Namespace Add
(assert (! 
;; def=Add.fst(41,88-41,90); use=Add.fst(41,88-41,90)
(forall ((@x0 Term))
 (! (and (IsTotFun (Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b @x0))

;; def=Add.fst(41,88-41,90); use=Add.fst(41,88-41,90)
(forall ((@x1 Term))
 (! (IsTotFun (ApplyTT (Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b @x0)
@x1))
 

:pattern ((ApplyTT (Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b @x0)
@x1))
:qid tot_fun_Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b.1))
)
 

:pattern ((Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b @x0))
:qid tot_fun_Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b))

:named tot_fun_Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_805426822673ada0617375120788033b
;;; Fact-ids: Name Eq.eq_instance_of_eqtype; Namespace Eq
(assert (! 
;; def=Eq.fst(32,39-32,41); use=Eq.fst(32,39-32,41)
(forall ((@x0 Term))
 (! (IsTotFun (Tm_abs_805426822673ada0617375120788033b @x0))
 

:pattern ((Tm_abs_805426822673ada0617375120788033b @x0))
:qid tot_fun_Tm_abs_805426822673ada0617375120788033b))

:named tot_fun_Tm_abs_805426822673ada0617375120788033b))
...
(HasType @x3
(Prims.list @x1)))
(HasType (Tests.sum.fuel_instrumented @u0
@x1
@x2
@x3)
@x1))
...
:pattern ((Tests.sum.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_Tests.sum.fuel_instrumented))

:named token_correspondence_Tests.sum.fuel_instrumented))
;;;;;;;;;;;;;;;;Name-token correspondence
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,6-24,9)
(forall ((@x0 Term))
 (! (= (ApplyTT Num.num@tok
@x0)
(Num.num @x0))
...
:pattern ((ApplyTT Num.num@tok
@x0))

:pattern ((Num.num @x0))
:qid token_correspondence_Num.num@tok))

:named token_correspondence_Num.num@tok))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-21,9)
(forall ((@x0 Term))
 (! (= (ApplyTT Eq.deq@tok
@x0)
(Eq.deq @x0))
...
:pattern ((ApplyTT Eq.deq@tok
@x0))

:pattern ((Eq.deq @x0))
:qid token_correspondence_Eq.deq@tok))

:named token_correspondence_Eq.deq@tok))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT Add.zero@tok
@x0)
(Add.zero @x0))
 

:pattern ((ApplyTT Add.zero@tok
@x0))
:qid token_correspondence_Add.zero))
:named token_correspondence_Add.zero))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT Add.plus@tok
@x0)
(Add.plus @x0))
 

:pattern ((ApplyTT Add.plus@tok
@x0))
:qid token_correspondence_Add.plus))
:named token_correspondence_Add.plus))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Add.__proj__Mkadditive__item__plus; Namespace Add
(assert (! 
;; def=Add.fst(23,2-23,6); use=Add.fst(23,2-23,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Add.__proj__Mkadditive__item__plus@tok
@x0)
@x1)
(Add.__proj__Mkadditive__item__plus @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Add.__proj__Mkadditive__item__plus@tok
@x0)
@x1))
:qid token_correspondence_Add.__proj__Mkadditive__item__plus))

:named token_correspondence_Add.__proj__Mkadditive__item__plus))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,6-24,9)
...
@x4)
(Num.num @x5)))
:qid subterm_ordering_Num.Mknum))

:named subterm_ordering_Num.Mknum))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-21,9)
...
@x3)
(Eq.deq @x4)))
:qid subterm_ordering_Eq.Mkdeq))

:named subterm_ordering_Eq.Mkdeq))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(23,28-23,54); use=Eq.fst(23,28-23,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_77b95d311db48f3e487387252c8b47fe @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_77b95d311db48f3e487387252c8b47fe @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_77b95d311db48f3e487387252c8b47fe))

:named refinement_kinding_Tm_refine_77b95d311db48f3e487387252c8b47fe))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Add.mkadd; Namespace Add
(assert (! 
;; def=Add.fst(36,21-36,33); use=Add.fst(41,4-41,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_5326efd3f23fff3a5a77c081ed400501 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_5326efd3f23fff3a5a77c081ed400501 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_5326efd3f23fff3a5a77c081ed400501))

:named refinement_kinding_Tm_refine_5326efd3f23fff3a5a77c081ed400501))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_77b95d311db48f3e487387252c8b47fe @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=Eq.fst(23,28-23,54)
(not 
;; def=Prims.fst(441,29-441,97); use=Eq.fst(23,28-23,33)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=Eq.fst(23,34-23,54); use=Eq.fst(23,28-23,33)
(iff 
;; def=Eq.fst(23,35-23,41); use=Eq.fst(23,28-23,33)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x2
@x3)
@x4))


;; def=Eq.fst(23,47-23,53); use=Eq.fst(23,28-23,33)
(= @x3
@x4)
)
)

;; def=Prims.fst(635,86-635,95); use=Eq.fst(23,28-23,54)
(not 
;; def=Prims.fst(635,86-635,95); use=Eq.fst(23,28-23,54)
(= @x5
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_77b95d311db48f3e487387252c8b47fe.1))
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_77b95d311db48f3e487387252c8b47fe))

:named refinement_interpretation_Tm_refine_77b95d311db48f3e487387252c8b47fe))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5326efd3f23fff3a5a77c081ed400501 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Add.fst(40,39-40,65); use=Add.fst(41,4-41,9)
(= (Add.__proj__Mkadditive__item__zero @x2
@x1)
@x3)


;; def=Add.fst(40,69-40,95); use=Add.fst(41,4-41,9)
(= (Add.__proj__Mkadditive__item__plus @x2
@x1)
@x4)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_5326efd3f23fff3a5a77c081ed400501))

:named refinement_interpretation_Tm_refine_5326efd3f23fff3a5a77c081ed400501))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
...
@x2
@x3))
:qid projection_inverse_Num.Mknum_minus))

:named projection_inverse_Num.Mknum_minus))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,6-24,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Num.Mknum_eq_super (Num.Mknum @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Num.Mknum_eq_super))

:named projection_inverse_Num.Mknum_eq_super))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,6-24,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Num.Mknum_add_super (Num.Mknum @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Num.Mknum_add_super))

:named projection_inverse_Num.Mknum_add_super))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,6-24,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Num.Mknum_a (Num.Mknum @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_Num.Mknum_a))

:named projection_inverse_Num.Mknum_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-21,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eq.Mkdeq_eq_ok (Eq.Mkdeq @x0
@x1
@x2))
@x2)
...
@x1
@x2))
:qid projection_inverse_Eq.Mkdeq_eq_ok))

:named projection_inverse_Eq.Mkdeq_eq_ok))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-21,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eq.Mkdeq_eq (Eq.Mkdeq @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_Eq.Mkdeq_eq))

:named projection_inverse_Eq.Mkdeq_eq))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-21,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eq.Mkdeq_a (Eq.Mkdeq @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_Eq.Mkdeq_a))

:named projection_inverse_Eq.Mkdeq_a))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Num.__proj__Mknum__item__add_super; Namespace Num
(assert (! 
;; def=Num.fst(26,4-26,13); use=Num.fst(26,4-26,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Num.__proj__Mknum__item__add_super @x0
@x1)
(Num.Mknum_add_super @x1))
 

:pattern ((Num.__proj__Mknum__item__add_super @x0
@x1))
:qid proj_equation_Num.Mknum_add_super))

:named proj_equation_Num.Mknum_add_super))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Add.__proj__Mkadditive__item__zero; Namespace Add
(assert (! 
;; def=Add.fst(22,2-22,6); use=Add.fst(22,2-22,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Add.__proj__Mkadditive__item__zero @x0
@x1)
(Add.Mkadditive_zero @x1))
 

:pattern ((Add.__proj__Mkadditive__item__zero @x0
@x1))
:qid proj_equation_Add.Mkadditive_zero))

:named proj_equation_Add.Mkadditive_zero))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Add.__proj__Mkadditive__item__plus; Namespace Add
(assert (! 
;; def=Add.fst(23,2-23,6); use=Add.fst(23,2-23,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Add.__proj__Mkadditive__item__plus @x0
@x1)
(Add.Mkadditive_plus @x1))
 

:pattern ((Add.__proj__Mkadditive__item__plus @x0
@x1))
:qid proj_equation_Add.Mkadditive_plus))

:named proj_equation_Add.Mkadditive_plus))
;;; Fact-ids: Name Prims.op_Addition; Namespace Prims
(assert (! 
;; def=Prims.fst(552,4-552,15); use=Prims.fst(552,4-552,15)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! (is-Tm_arrow (PreType Num.num@tok))
:named pre_kinding_Num.num@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! (is-Tm_arrow (PreType Eq.deq@tok))
:named pre_kinding_Eq.deq@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=dummy(0,0-0,0); use=Add.fst(21,15-21,16)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d7439c04278b9188e182a3b35f94854a
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,15-23,6)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_d7439c04278b9188e182a3b35f94854a @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_d7439c04278b9188e182a3b35f94854a @x0)
Tm_type))
:qid kinding_Tm_arrow_d7439c04278b9188e182a3b35f94854a))

:named kinding_Tm_arrow_d7439c04278b9188e182a3b35f94854a))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,15-22,6)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78 @x0)
Tm_type))
:qid kinding_Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78))

:named kinding_Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,10-23,54); use=Eq.fst(23,13-23,54)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f))

:named kinding_Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_56e2a21c05cb89e8445514c04cf61825
;;; Fact-ids: Name Add.__proj__Mkadditive__item__plus; Namespace Add
(assert (! (HasType Tm_arrow_56e2a21c05cb89e8445514c04cf61825
Tm_type)
:named kinding_Tm_arrow_56e2a21c05cb89e8445514c04cf61825))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=dummy(0,0-0,0); use=Add.fst(21,15-21,16)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62 @x0)
Tm_type))
:qid kinding_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62))

:named kinding_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4758961aabfefbefddf5f91ef90829e3
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! (HasType Tm_arrow_4758961aabfefbefddf5f91ef90829e3
Tm_type)
:named kinding_Tm_arrow_4758961aabfefbefddf5f91ef90829e3))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1e166f7c3978cec871a132fdfd911834
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! (HasType Tm_arrow_1e166f7c3978cec871a132fdfd911834
Tm_type)
:named kinding_Tm_arrow_1e166f7c3978cec871a132fdfd911834))
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! (and (IsTotFun Num.num@tok)
...
:pattern ((Num.num @x0))
:qid kinding_Num.num@tok))
)
:named kinding_Num.num@tok))
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! (and (IsTotFun Eq.deq@tok)
...
:pattern ((Eq.deq @x0))
:qid kinding_Eq.deq@tok))
)
:named kinding_Eq.deq@tok))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e98f4b71ef47e83d53da8f81c925bb67
;;; Fact-ids: Name Eq.eq_instance_of_eqtype; Namespace Eq
(assert (! 
;; def=Eq.fst(32,20-32,25); use=Eq.fst(32,20-32,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_e98f4b71ef47e83d53da8f81c925bb67 @x2)
@x0)
@x1)
(Prims.op_Equality @x2
@x0
@x1))
 

:pattern ((ApplyTT (ApplyTT (Tm_abs_e98f4b71ef47e83d53da8f81c925bb67 @x2)
@x0)
@x1))
:qid interpretation_Tm_abs_e98f4b71ef47e83d53da8f81c925bb67))

:named interpretation_Tm_abs_e98f4b71ef47e83d53da8f81c925bb67))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_b5e807b4621ccabcb9be39d32c543135
;;; Fact-ids: Name Add.mkadd; Namespace Add
(assert (! 
;; def=Add.fst(41,56-41,58); use=Add.fst(41,56-41,58)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_b5e807b4621ccabcb9be39d32c543135 @x1)
@x0)
Tm_unit)
 

:pattern ((ApplyTT (Tm_abs_b5e807b4621ccabcb9be39d32c543135 @x1)
@x0))
:qid interpretation_Tm_abs_b5e807b4621ccabcb9be39d32c543135))

:named interpretation_Tm_abs_b5e807b4621ccabcb9be39d32c543135))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b
;;; Fact-ids: Name Add.mkadd; Namespace Add
(assert (! 
;; def=Add.fst(41,88-41,90); use=Add.fst(41,88-41,90)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b @x3)
@x0)
@x1)
@x2)
Tm_unit)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b @x3)
@x0)
@x1)
@x2))
:qid interpretation_Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b))

:named interpretation_Tm_abs_a1d5fea9bc74b4493ebdde3d7166613b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_805426822673ada0617375120788033b
;;; Fact-ids: Name Eq.eq_instance_of_eqtype; Namespace Eq
(assert (! 
;; def=Eq.fst(32,39-32,41); use=Eq.fst(32,39-32,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_805426822673ada0617375120788033b @x2)
@x0)
@x1)
Tm_unit)
 

:pattern ((ApplyTT (ApplyTT (Tm_abs_805426822673ada0617375120788033b @x2)
@x0)
@x1))
:qid interpretation_Tm_abs_805426822673ada0617375120788033b))

:named interpretation_Tm_abs_805426822673ada0617375120788033b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2a17ec8012a10516658a371204669585
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! 
;; def=Add.fst(22,2-22,6); use=Add.fst(22,2-22,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_2a17ec8012a10516658a371204669585 @x1)
@x0)
(let ((@lb2 @x0))
(Add.Mkadditive_zero @lb2)))
 

:pattern ((ApplyTT (Tm_abs_2a17ec8012a10516658a371204669585 @x1)
@x0))
:qid interpretation_Tm_abs_2a17ec8012a10516658a371204669585))

:named interpretation_Tm_abs_2a17ec8012a10516658a371204669585))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_12ddde8171c888fa95f826be9c2a1fe9
;;; Fact-ids: Name Num.num_int; Namespace Num
(assert (! 
;; def=Num.fst(43,47-43,52); use=Num.fst(43,47-43,52)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_12ddde8171c888fa95f826be9c2a1fe9
@x0)
@x1)
(Prims.op_Subtraction @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Tm_abs_12ddde8171c888fa95f826be9c2a1fe9
@x0)
@x1))
:qid interpretation_Tm_abs_12ddde8171c888fa95f826be9c2a1fe9))

:named interpretation_Tm_abs_12ddde8171c888fa95f826be9c2a1fe9))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=Add.fst(23,2-23,6); use=Add.fst(23,2-23,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e @x1)
@x0)
(let ((@lb2 @x0))
(Add.Mkadditive_plus @lb2)))
 

:pattern ((ApplyTT (Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e @x1)
@x0))
:qid interpretation_Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e))

:named interpretation_Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
:qid int_inversion))
:named int_inversion))
;;;;;;;;;;;;;;;;haseq for Tm_refine_77b95d311db48f3e487387252c8b47fe
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(23,28-23,54); use=Eq.fst(23,28-23,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_77b95d311db48f3e487387252c8b47fe @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_77b95d311db48f3e487387252c8b47fe @x0
@x1
@x2))))
:qid haseqTm_refine_77b95d311db48f3e487387252c8b47fe))

:named haseqTm_refine_77b95d311db48f3e487387252c8b47fe))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_5326efd3f23fff3a5a77c081ed400501
;;; Fact-ids: Name Add.mkadd; Namespace Add
(assert (! 
;; def=Add.fst(36,21-36,33); use=Add.fst(41,4-41,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5326efd3f23fff3a5a77c081ed400501 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Add.additive @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5326efd3f23fff3a5a77c081ed400501 @x0
@x1
@x2))))
:qid haseqTm_refine_5326efd3f23fff3a5a77c081ed400501))

:named haseqTm_refine_5326efd3f23fff3a5a77c081ed400501))
...
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Add.zero@tok
Tm_arrow_1e166f7c3978cec871a132fdfd911834))
(forall ((@x1 Term))
 (! (= (ApplyTT Add.zero@tok
@x1)
(Add.zero @x1))
...
:pattern ((Add.zero @x1))
:qid function_token_typing_Add.zero.1)))
 

:pattern ((ApplyTT @x0
Add.zero@tok))
:qid function_token_typing_Add.zero))
:named function_token_typing_Add.zero))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Add.plus@tok
Tm_arrow_4758961aabfefbefddf5f91ef90829e3))
(forall ((@x1 Term))
 (! (= (ApplyTT Add.plus@tok
@x1)
(Add.plus @x1))
...
:pattern ((Add.plus @x1))
:qid function_token_typing_Add.plus.1)))
 

:pattern ((ApplyTT @x0
Add.plus@tok))
:qid function_token_typing_Add.plus))
:named function_token_typing_Add.plus))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Add.__proj__Mkadditive__item__plus; Namespace Add
(assert (! 
;; def=Add.fst(23,2-23,6); use=Add.fst(23,2-23,6)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Add.__proj__Mkadditive__item__plus@tok
Tm_arrow_56e2a21c05cb89e8445514c04cf61825))
...
@x1)
@x2)
(Add.__proj__Mkadditive__item__plus @x1
@x2))
 

:pattern ((Add.__proj__Mkadditive__item__plus @x1
@x2))
:qid function_token_typing_Add.__proj__Mkadditive__item__plus.1))
)
 

:pattern ((ApplyTT @x0
Add.__proj__Mkadditive__item__plus@tok))
:qid function_token_typing_Add.__proj__Mkadditive__item__plus))

:named function_token_typing_Add.__proj__Mkadditive__item__plus))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,6-24,9)
...
@x1
(Num.num @x2)))
:qid fuel_guarded_inversion_Num.num))

:named fuel_guarded_inversion_Num.num))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-21,9)
...
@x1
(Eq.deq @x2)))
:qid fuel_guarded_inversion_Eq.deq))

:named fuel_guarded_inversion_Eq.deq))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! (= 102
(Term_constr_id Num.num@tok))
:named fresh_token_Num.num@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! (= 102
(Term_constr_id Eq.deq@tok))
:named fresh_token_Eq.deq@tok))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Tests.sum
;;; Fact-ids: Name Tests.sum; Namespace Tests
(assert (! 
;; def=Tests.fst(22,8-22,11); use=Tests.fst(22,8-22,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Prims.list @x1)))
(= (Tests.sum.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x3))
(ite (is-Prims.Nil @lb4)
(ApplyTT (ApplyTT Add.zero@tok
@x1)
@x2)
(ite (is-Prims.Cons @lb4)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Add.plus@tok
@x1)
@x2)
(Prims.Cons_hd @lb4))
(Tests.sum.fuel_instrumented @u0
@x1
@x2
(Prims.Cons_tl @lb4)))
Tm_unit)))))
...
:pattern ((Tests.sum.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_Tests.sum.fuel_instrumented))

:named equation_with_fuel_Tests.sum.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for Num.num_int
;;; Fact-ids: Name Num.num_int; Namespace Num
(assert (! 
;; def=Num.fst(43,9-43,16); use=Num.fst(43,9-43,16)
(forall ((@u0 Dummy_sort))
...
(Num.mknum Prims.int
(Eq.uu___0 Dummy_value)
(Add.add_int Dummy_value)
Tm_abs_12ddde8171c888fa95f826be9c2a1fe9))
...
:qid equation_Num.num_int))

:named equation_Num.num_int))
;;;;;;;;;;;;;;;;Equation for Num.mknum
;;; Fact-ids: Name Num.mknum; Namespace Num
(assert (! 
;; def=Num.fst(38,4-38,9); use=Num.fst(38,4-38,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3))
:qid equation_Num.mknum))

:named equation_Num.mknum))
;;;;;;;;;;;;;;;;Equation for Num.add_num
;;; Fact-ids: Name Num.add_num; Namespace Num
(assert (! 
;; def=Num.fst(36,9-36,16); use=Num.fst(36,9-36,16)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((Num.add_num @x0
@x1))
:qid equation_Num.add_num))

:named equation_Num.add_num))
;;;;;;;;;;;;;;;;Equation for Eq.uu___0
;;; Fact-ids: Name Eq.uu___0; Namespace Eq
(assert (! (forall ((@u0 Dummy_sort))
 (! (= (Eq.uu___0 @u0)
(Eq.eq_instance_of_eqtype Prims.int))
 

:pattern ((Eq.uu___0 @u0))
:qid equation_Eq.uu___0))
:named equation_Eq.uu___0))
;;;;;;;;;;;;;;;;Equation for Eq.eq_instance_of_eqtype
;;; Fact-ids: Name Eq.eq_instance_of_eqtype; Namespace Eq
(assert (! 
;; def=Eq.fst(31,4-31,25); use=Eq.fst(31,4-31,25)
(forall ((@x0 Term))
 (! (= (Eq.eq_instance_of_eqtype @x0)
(Eq.Mkdeq @x0
(Tm_abs_e98f4b71ef47e83d53da8f81c925bb67 @x0)
(Tm_abs_805426822673ada0617375120788033b @x0)))
 

:pattern ((Eq.eq_instance_of_eqtype @x0))
:qid equation_Eq.eq_instance_of_eqtype))

:named equation_Eq.eq_instance_of_eqtype))
;;;;;;;;;;;;;;;;Equation for Add.zero
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! (forall ((@x0 Term))
 (! (= (Add.zero @x0)
(Tm_abs_2a17ec8012a10516658a371204669585 @x0))
 

:pattern ((Add.zero @x0))
:qid equation_Add.zero))
:named equation_Add.zero))
;;;;;;;;;;;;;;;;Equation for Add.plus
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! (forall ((@x0 Term))
 (! (= (Add.plus @x0)
(Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e @x0))
 

:pattern ((Add.plus @x0))
:qid equation_Add.plus))
:named equation_Add.plus))
;;;;;;;;;;;;;;;;Equation for Add.mkadd
;;; Fact-ids: Name Add.mkadd; Namespace Add
(assert (! 
;; def=Add.fst(41,4-41,9); use=Add.fst(41,4-41,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x1
@x2))
:qid equation_Add.mkadd))

:named equation_Add.mkadd))
;;;;;;;;;;;;;;;;Equation for Add.add_int
;;; Fact-ids: Name Add.add_int; Namespace Add
(assert (! 
;; def=Add.fst(51,9-51,16); use=Add.fst(51,9-51,16)
(forall ((@u0 Dummy_sort))
...
:qid equation_Add.add_int))

:named equation_Add.add_int))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,6-24,9)
...
@x4)
(Num.num @x1)))
:qid data_typing_intro_Num.Mknum@tok))

:named data_typing_intro_Num.Mknum@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-21,9)
...
(HasTypeFuel @u0
@x3
(Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f @x2
@x1)))
(HasTypeFuel @u0
(Eq.Mkdeq @x1
@x2
...
@x3)
(Eq.deq @x1)))
:qid data_typing_intro_Eq.Mkdeq@tok))

:named data_typing_intro_Eq.Mkdeq@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,6-24,9)
...
(HasTypeFuel @u0
@x4
(Tm_arrow_72ac2ec523211f8603e00b25deb1543b @x5))))
...
@x4)
(Num.num @x5)))
:qid data_elim_Num.Mknum))

:named data_elim_Num.Mknum))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-21,9)
...
@x3)
(Eq.deq @x4)))
:qid data_elim_Eq.Mkdeq))

:named data_elim_Eq.Mkdeq))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
(forall ((@x0 Term))
 (! (= 101
(Term_constr_id (Num.num @x0)))
 

:pattern ((Num.num @x0))
:qid constructor_distinct_Num.num))

:named constructor_distinct_Num.num))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Num.num; Namespace Num; Name Num.Mknum; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,6-24,9)
...
@x2
@x3))
:qid constructor_distinct_Num.Mknum))

:named constructor_distinct_Num.Mknum))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-21,9)
(forall ((@x0 Term))
 (! (= 101
(Term_constr_id (Eq.deq @x0)))
 

:pattern ((Eq.deq @x0))
:qid constructor_distinct_Eq.deq))

:named constructor_distinct_Eq.deq))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,6-21,9); use=Eq.fst(21,6-21,9)
...
@x1
@x2))
:qid constructor_distinct_Eq.Mkdeq))

:named constructor_distinct_Eq.Mkdeq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! 
...
@x0
(Num.num @x2)))
:qid Num_pretyping_6aa898afce062d06d4f211cfdab44258))

:named Num_pretyping_6aa898afce062d06d4f211cfdab44258))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.List.Tot.Base.compare_of_bool; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(509,23-509,54); use=FStar.List.Tot.Base.fst(509,36-510,19)
...
@x0
(Eq.deq @x2)))
:qid Eq_pretyping_67dbd7a79332d6ba3f568d98de685d80))

:named Eq_pretyping_67dbd7a79332d6ba3f568d98de685d80))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,10-23,54); use=Eq.fst(23,13-23,54)
...
(Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f @x2
@x3)))
:qid Eq_pre_typing_Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f))

:named Eq_pre_typing_Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f
;;; Fact-ids: Name Eq.deq; Namespace Eq; Name Eq.Mkdeq; Namespace Eq
(assert (! 
;; def=Eq.fst(21,10-23,54); use=Eq.fst(23,13-23,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f @x1
@x2))
(and 
;; def=Eq.fst(21,10-23,54); use=Eq.fst(23,13-23,54)
(forall ((@x3 Term) (@x4 Term))
...
@x3)
@x4)
(Tm_refine_77b95d311db48f3e487387252c8b47fe @x1
@x3
@x4)))
...
@x3)
@x4))
:qid Eq_interpretation_Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Eq_interpretation_Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f.2))
))
...
(Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f @x1
@x2)))
:qid Eq_interpretation_Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f))

:named Eq_interpretation_Tm_arrow_61f1f38e3b26f7a115fd56a0015aea8f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=dummy(0,0-0,0); use=Add.fst(21,15-21,16)
...
@x1
(Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 @x2)))
:qid Add_pre_typing_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))

:named Add_pre_typing_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,15-23,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_d7439c04278b9188e182a3b35f94854a @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_d7439c04278b9188e182a3b35f94854a @x2)))
:qid Add_pre_typing_Tm_arrow_d7439c04278b9188e182a3b35f94854a))

:named Add_pre_typing_Tm_arrow_d7439c04278b9188e182a3b35f94854a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,15-22,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78 @x2)))
:qid Add_pre_typing_Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78))

:named Add_pre_typing_Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.__proj__Mkadditive__item__plus; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,6-21,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_56e2a21c05cb89e8445514c04cf61825)
...
@x1
Tm_arrow_56e2a21c05cb89e8445514c04cf61825))
:qid Add_pre_typing_Tm_arrow_56e2a21c05cb89e8445514c04cf61825))

:named Add_pre_typing_Tm_arrow_56e2a21c05cb89e8445514c04cf61825))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=dummy(0,0-0,0); use=Add.fst(21,15-21,16)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62 @x2)))
:qid Add_pre_typing_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62))

:named Add_pre_typing_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=dummy(0,0-0,0); use=Add.fst(21,15-23,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4758961aabfefbefddf5f91ef90829e3)
...
@x1
Tm_arrow_4758961aabfefbefddf5f91ef90829e3))
:qid Add_pre_typing_Tm_arrow_4758961aabfefbefddf5f91ef90829e3))

:named Add_pre_typing_Tm_arrow_4758961aabfefbefddf5f91ef90829e3))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! 
;; def=dummy(0,0-0,0); use=Add.fst(21,15-22,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_1e166f7c3978cec871a132fdfd911834)
...
@x1
Tm_arrow_1e166f7c3978cec871a132fdfd911834))
:qid Add_pre_typing_Tm_arrow_1e166f7c3978cec871a132fdfd911834))

:named Add_pre_typing_Tm_arrow_1e166f7c3978cec871a132fdfd911834))
...
:pattern ((ApplyTT @x0
@x2))
:qid Add_interpretation_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 @x1)))
:qid Add_interpretation_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))

:named Add_interpretation_Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d7439c04278b9188e182a3b35f94854a
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,15-23,6)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_d7439c04278b9188e182a3b35f94854a @x1))
(and 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,15-23,6)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
(HasType (ApplyTT @x0
@x2)
(Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62 @x1)))
 

:pattern ((ApplyTT @x0
@x2))
:qid Add_interpretation_Tm_arrow_d7439c04278b9188e182a3b35f94854a.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_d7439c04278b9188e182a3b35f94854a @x1)))
:qid Add_interpretation_Tm_arrow_d7439c04278b9188e182a3b35f94854a))

:named Add_interpretation_Tm_arrow_d7439c04278b9188e182a3b35f94854a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,15-22,6)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78 @x1))
(and 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,15-22,6)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid Add_interpretation_Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78 @x1)))
:qid Add_interpretation_Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78))

:named Add_interpretation_Tm_arrow_a9ebab83db89eb8e0b8caa3ed1e25c78))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_56e2a21c05cb89e8445514c04cf61825
;;; Fact-ids: Name Add.__proj__Mkadditive__item__plus; Namespace Add
(assert (! 
;; def=Add.fst(21,6-21,14); use=Add.fst(21,6-21,16)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Add_interpretation_Tm_arrow_56e2a21c05cb89e8445514c04cf61825.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Add_interpretation_Tm_arrow_56e2a21c05cb89e8445514c04cf61825.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_56e2a21c05cb89e8445514c04cf61825))
:qid Add_interpretation_Tm_arrow_56e2a21c05cb89e8445514c04cf61825))

:named Add_interpretation_Tm_arrow_56e2a21c05cb89e8445514c04cf61825))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=dummy(0,0-0,0); use=Add.fst(21,15-21,16)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid Add_interpretation_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62 @x1)))
:qid Add_interpretation_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62))

:named Add_interpretation_Tm_arrow_519fe22d5298333d7e79cfb3a2b03f62))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4758961aabfefbefddf5f91ef90829e3
;;; Fact-ids: Name Add.plus; Namespace Add
(assert (! 
;; def=dummy(0,0-0,0); use=Add.fst(21,15-23,6)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Add_interpretation_Tm_arrow_4758961aabfefbefddf5f91ef90829e3.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_4758961aabfefbefddf5f91ef90829e3))
:qid Add_interpretation_Tm_arrow_4758961aabfefbefddf5f91ef90829e3))

:named Add_interpretation_Tm_arrow_4758961aabfefbefddf5f91ef90829e3))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1e166f7c3978cec871a132fdfd911834
;;; Fact-ids: Name Add.zero; Namespace Add
(assert (! 
;; def=dummy(0,0-0,0); use=Add.fst(21,15-22,6)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Add_interpretation_Tm_arrow_1e166f7c3978cec871a132fdfd911834.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_1e166f7c3978cec871a132fdfd911834))
:qid Add_interpretation_Tm_arrow_1e166f7c3978cec871a132fdfd911834))

:named Add_interpretation_Tm_arrow_1e166f7c3978cec871a132fdfd911834))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Tests.sum; Namespace Tests
(assert (! (Valid (ApplyTT __uu__PartialApp
Add.plus@tok))
:named @kick_partial_app_f6614dfcc41e12448ab5b4385b1de27b))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Add.add_int; Namespace Add
(assert (! (Valid (ApplyTT __uu__PartialApp
Prims.op_Addition@tok))
...
(assert (! (Valid (ApplyTT __uu__PartialApp
Add.zero@tok))
:named @kick_partial_app_e118393172a8653ed1180a7a73a9b1ca))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Add.__proj__Mkadditive__item__zero_l; Namespace Add
(assert (! (Valid (ApplyTT __uu__PartialApp
Add.__proj__Mkadditive__item__plus@tok))
:named @kick_partial_app_cc481cff5eaf59f4d009faf65b296179))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Tests.sum; Namespace Tests
(assert (! 
;; def=Tests.fst(22,8-22,11); use=Tests.fst(22,8-22,11)
...
@x2
@x3)
(Tests.sum.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_Tests.sum.fuel_instrumented))

:named @fuel_irrelevance_Tests.sum.fuel_instrumented))
...
@x1
@x2)
(Tests.sum.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_Tests.sum.fuel_instrumented))

:named @fuel_correspondence_Tests.sum.fuel_instrumented))
(push) ;; push{2

; Starting query at Tests.fst(38,0-38,44)

(declare-fun label_1 () Bool)

; Encoding query formula : Tests.sum [1; 2; 3; 4; 5; 6] == 21
...
;;; Fact-ids: 
(assert (! (not 
;; def=Tests.fst(38,19-38,44); use=Tests.fst(38,12-38,18)
(or label_1

;; def=Tests.fst(38,19-38,44); use=Tests.fst(38,12-38,18)
(= (Tests.sum Prims.int
(Num.add_num Prims.int
(Num.num_int Dummy_value))
...
(declare-fun Tests.test1 (Dummy_sort) Term)

; </end encoding let test1>

;;;;;;;;;;;;;;;;typing_Tm_abs_73a7b9c27305555126e8994d285f754f
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! 
;; def=Num.fst(27,4-27,9); use=Num.fst(27,4-27,9)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_73a7b9c27305555126e8994d285f754f @x0)
(Tm_arrow_f99c8652c211e1bb0d410c61fff6627f @x0))
 

:pattern ((Tm_abs_73a7b9c27305555126e8994d285f754f @x0))
:qid typing_Tm_abs_73a7b9c27305555126e8994d285f754f))

:named typing_Tm_abs_73a7b9c27305555126e8994d285f754f))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Num.minus @x0)
(Tm_arrow_f99c8652c211e1bb0d410c61fff6627f @x0)))
 

:pattern ((Num.minus @x0))
:qid typing_Num.minus))
:named typing_Num.minus))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT Num.minus@tok
@x0)
(Num.minus @x0))
 

:pattern ((ApplyTT Num.minus@tok
@x0))
:qid token_correspondence_Num.minus))
:named token_correspondence_Num.minus))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f99c8652c211e1bb0d410c61fff6627f
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,10-27,9)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_f99c8652c211e1bb0d410c61fff6627f @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_f99c8652c211e1bb0d410c61fff6627f @x0)
Tm_type))
:qid kinding_Tm_arrow_f99c8652c211e1bb0d410c61fff6627f))

:named kinding_Tm_arrow_f99c8652c211e1bb0d410c61fff6627f))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_388e801b5cee50cb6b2225217ba294fd
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! (HasType Tm_arrow_388e801b5cee50cb6b2225217ba294fd
Tm_type)
:named kinding_Tm_arrow_388e801b5cee50cb6b2225217ba294fd))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_73a7b9c27305555126e8994d285f754f
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! 
;; def=Num.fst(27,4-27,9); use=Num.fst(27,4-27,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_73a7b9c27305555126e8994d285f754f @x1)
@x0)
(let ((@lb2 @x0))
(Num.Mknum_minus @lb2)))
 

:pattern ((ApplyTT (Tm_abs_73a7b9c27305555126e8994d285f754f @x1)
@x0))
:qid interpretation_Tm_abs_73a7b9c27305555126e8994d285f754f))

:named interpretation_Tm_abs_73a7b9c27305555126e8994d285f754f))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Num.minus@tok
Tm_arrow_388e801b5cee50cb6b2225217ba294fd))
(forall ((@x1 Term))
 (! (= (ApplyTT Num.minus@tok
@x1)
(Num.minus @x1))
...
:pattern ((Num.minus @x1))
:qid function_token_typing_Num.minus.1)))
 

:pattern ((ApplyTT @x0
Num.minus@tok))
:qid function_token_typing_Num.minus))
:named function_token_typing_Num.minus))
;;;;;;;;;;;;;;;;Equation for Num.minus
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! (forall ((@x0 Term))
 (! (= (Num.minus @x0)
(Tm_abs_73a7b9c27305555126e8994d285f754f @x0))
 

:pattern ((Num.minus @x0))
:qid equation_Num.minus))
:named equation_Num.minus))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,10-27,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_f99c8652c211e1bb0d410c61fff6627f @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_f99c8652c211e1bb0d410c61fff6627f @x2)))
:qid Num_pre_typing_Tm_arrow_f99c8652c211e1bb0d410c61fff6627f))

:named Num_pre_typing_Tm_arrow_f99c8652c211e1bb0d410c61fff6627f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! 
;; def=dummy(0,0-0,0); use=Num.fst(24,10-27,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_388e801b5cee50cb6b2225217ba294fd)
...
@x1
Tm_arrow_388e801b5cee50cb6b2225217ba294fd))
:qid Num_pre_typing_Tm_arrow_388e801b5cee50cb6b2225217ba294fd))

:named Num_pre_typing_Tm_arrow_388e801b5cee50cb6b2225217ba294fd))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f99c8652c211e1bb0d410c61fff6627f
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,10-27,9)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f99c8652c211e1bb0d410c61fff6627f @x1))
(and 
;; def=Num.fst(24,6-24,9); use=Num.fst(24,10-27,9)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid Num_interpretation_Tm_arrow_f99c8652c211e1bb0d410c61fff6627f.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_f99c8652c211e1bb0d410c61fff6627f @x1)))
:qid Num_interpretation_Tm_arrow_f99c8652c211e1bb0d410c61fff6627f))

:named Num_interpretation_Tm_arrow_f99c8652c211e1bb0d410c61fff6627f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_388e801b5cee50cb6b2225217ba294fd
;;; Fact-ids: Name Num.minus; Namespace Num
(assert (! 
;; def=dummy(0,0-0,0); use=Num.fst(24,10-27,9)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Num_interpretation_Tm_arrow_388e801b5cee50cb6b2225217ba294fd.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_388e801b5cee50cb6b2225217ba294fd))
:qid Num_interpretation_Tm_arrow_388e801b5cee50cb6b2225217ba294fd))

:named Num_interpretation_Tm_arrow_388e801b5cee50cb6b2225217ba294fd))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Tests.sandwich; Namespace Tests
(assert (! (Valid (ApplyTT __uu__PartialApp
Num.minus@tok))
:named @kick_partial_app_0a2662246132a64921c92ccb654b0399))
(push) ;; push{2

; Starting query at Tests.fst(39,0-39,47)

(declare-fun label_1 () Bool)



; Encoding query formula : Add.plus 40 (Num.minus 10 8) == 42
...
;;; Fact-ids: 
(assert (! (not 
;; def=Tests.fst(39,19-39,47); use=Tests.fst(39,12-39,18)
(or label_1
...
(Num.num_int Dummy_value)))
(BoxInt 40))
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Num.minus@tok
Prims.int)
(Num.num_int Dummy_value))
(BoxInt 10))
(BoxInt 8)))
