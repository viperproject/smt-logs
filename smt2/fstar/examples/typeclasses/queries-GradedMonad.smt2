...
; Internals for GradedMonad


; encoding sigelt #set-options "--warn_error -350"


; <Skipped #set-options "--warn_error -350"/>


; encoding sigelt type GradedMonad.monoid


; <Start encoding type GradedMonad.monoid>

;;;;;;;;;;;;;;;;Constructor
(declare-fun GradedMonad.monoid (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun GradedMonad.monoid@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun GradedMonad.Mkmonoid (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun GradedMonad.Mkmonoid_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun GradedMonad.Mkmonoid_op (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun GradedMonad.Mkmonoid_one (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun GradedMonad.Mkmonoid_properties (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: GradedMonad.Mkmonoid
(declare-fun GradedMonad.Mkmonoid@tok () Term)
;;;;;;;;;;;;;;;;_: a -> _: a -> a
(declare-fun Tm_arrow_72ac2ec523211f8603e00b25deb1543b (Term) Term)
(declare-fun Tm_refine_5a1d9e78a104770b32521f29c612076a (Term Term Term) Term)


;;;;;;;;;;;;;;;;op: (_: a -> _: a -> a) ->     one: a ->     properties:       Prims.squash ((forall (x: a). op one x == x /\ op x one == x) /\           (forall (x: a) (y: a) (z: a). op x (op y z) == op (op x y) z))   -> monoid a
(declare-fun Tm_arrow_f7b27f2addeb50aca74b43441cdfdbc0 () Term)

; <start constructor GradedMonad.monoid>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-GradedMonad.monoid ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
(GradedMonad.monoid @x0))
 
;;no pats
:qid is-GradedMonad.monoid))))

; </end constructor GradedMonad.monoid>


; <start constructor GradedMonad.Mkmonoid>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-GradedMonad.Mkmonoid ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
114)
(= __@x0
(GradedMonad.Mkmonoid (GradedMonad.Mkmonoid_a __@x0)
(GradedMonad.Mkmonoid_op __@x0)
(GradedMonad.Mkmonoid_one __@x0)
(GradedMonad.Mkmonoid_properties __@x0)))))

; </end constructor GradedMonad.Mkmonoid>


; </end encoding type GradedMonad.monoid>


; encoding sigelt val GradedMonad.__proj__Mkmonoid__item__op


; <Start encoding val GradedMonad.__proj__Mkmonoid__item__op>

(declare-fun GradedMonad.__proj__Mkmonoid__item__op (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: monoid a -> _: a -> _: a -> a
(declare-fun Tm_arrow_44bee60d7816aedeca61945b6241d52c () Term)
(declare-fun GradedMonad.__proj__Mkmonoid__item__op@tok () Term)


; </end encoding val GradedMonad.__proj__Mkmonoid__item__op>


; encoding sigelt let __proj__Mkmonoid__item__op


; <Skipped let __proj__Mkmonoid__item__op/>


; encoding sigelt val GradedMonad.__proj__Mkmonoid__item__one


; <Start encoding val GradedMonad.__proj__Mkmonoid__item__one>

(declare-fun GradedMonad.__proj__Mkmonoid__item__one (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: monoid a -> a
(declare-fun Tm_arrow_418f8d50788c9c8372caa6451ad73f8b () Term)
(declare-fun GradedMonad.__proj__Mkmonoid__item__one@tok () Term)

; </end encoding val GradedMonad.__proj__Mkmonoid__item__one>


; encoding sigelt let __proj__Mkmonoid__item__one


; <Skipped let __proj__Mkmonoid__item__one/>


; encoding sigelt val GradedMonad.__proj__Mkmonoid__item__properties


; <Start encoding val GradedMonad.__proj__Mkmonoid__item__properties>

(declare-fun GradedMonad.__proj__Mkmonoid__item__properties (Term Term) Term)





(declare-fun Tm_refine_41ca44e8014332723b8879934d53be4e (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: monoid a   -> Prims.squash ((forall (x: a).             projectee.op projectee.one x == x /\ projectee.op x projectee.one == x) /\         (forall (x: a) (y: a) (z: a).             projectee.op x (projectee.op y z) == projectee.op (projectee.op x y) z))
(declare-fun Tm_arrow_0e9d2ad55ab3268f79ebb9ac9ee1c855 () Term)
(declare-fun GradedMonad.__proj__Mkmonoid__item__properties@tok () Term)
...
; </end encoding val GradedMonad.__proj__Mkmonoid__item__properties>


; encoding sigelt let __proj__Mkmonoid__item__properties


; <Skipped let __proj__Mkmonoid__item__properties/>


; encoding sigelt let op


; <Start encoding let op>

(declare-fun GradedMonad.op (Term) Term)
;;;;;;;;;;;;;;;;_: a -> a
...
;;;;;;;;;;;;;;;;{| projectee: monoid a |} -> _: a -> _: a -> a
(declare-fun Tm_arrow_030882a0c8472843e0398fc00c36b7c9 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monoid a |} -> _: a -> _: a -> a
(declare-fun Tm_arrow_878b180e8824407428c576755f502118 () Term)
(declare-fun GradedMonad.op@tok () Term)
...
(declare-fun Tm_abs_b0987a120c89a6d2b49c23c91b387ebc (Term) Term)

; </end encoding let op>


; encoding sigelt let one


; <Start encoding let one>

(declare-fun GradedMonad.one (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monoid a |} -> a
(declare-fun Tm_arrow_ae261a0484e8a8148785144d79117df4 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monoid a |} -> a
(declare-fun Tm_arrow_8bda643635ae144e12ec9578accfa488 () Term)
(declare-fun GradedMonad.one@tok () Term)


(declare-fun Tm_abs_7c350a6868ee8cd179f26215060f21b3 (Term) Term)

; </end encoding let one>


; encoding sigelt let properties


; <Start encoding let properties>

(declare-fun GradedMonad.properties (Term) Term)
...
;;;;;;;;;;;;;;;;{| projectee: monoid a |}   -> Prims.squash ((forall (x: a).             projectee.op projectee.one x == x /\ projectee.op x projectee.one == x) /\         (forall (x: a) (y: a) (z: a).             projectee.op x (projectee.op y z) == projectee.op (projectee.op x y) z))
(declare-fun Tm_arrow_cf18df90556acfa6001b6d982346f80b (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monoid a |}   -> Prims.squash ((forall (x: a).             projectee.op projectee.one x == x /\ projectee.op x projectee.one == x) /\         (forall (x: a) (y: a) (z: a).             projectee.op x (projectee.op y z) == projectee.op (projectee.op x y) z))
(declare-fun Tm_arrow_7f70b8148169e6b7ef9cc8079e5a218e () Term)
(declare-fun GradedMonad.properties@tok () Term)
...
(declare-fun Tm_abs_9b9e6e3760f523f6090a283bc14d63e1 (Term) Term)

; </end encoding let properties>
...
; Starting query at GradedMonad.fst(21,0-26,1)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: Prims.nat -> _: Prims.nat -> Prims.nat
...
;;; Fact-ids: 
(assert (! 
;; def=GradedMonad.fst(23,17-23,20); use=Prims.fst(454,7-454,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_2bb228db8432d0cdc106cb64c22e55ba))
:qid GradedMonad_pre_typing_Tm_arrow_2bb228db8432d0cdc106cb64c22e55ba))

:named GradedMonad_pre_typing_Tm_arrow_2bb228db8432d0cdc106cb64c22e55ba))
...
@x1)
@x2))
:qid GradedMonad_interpretation_Tm_arrow_2bb228db8432d0cdc106cb64c22e55ba.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid GradedMonad_interpretation_Tm_arrow_2bb228db8432d0cdc106cb64c22e55ba.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_2bb228db8432d0cdc106cb64c22e55ba))
:qid GradedMonad_interpretation_Tm_arrow_2bb228db8432d0cdc106cb64c22e55ba))

:named GradedMonad_interpretation_Tm_arrow_2bb228db8432d0cdc106cb64c22e55ba))
...
;;; Fact-ids: 
(assert (! 
;; def=GradedMonad.fst(23,25-23,30); use=GradedMonad.fst(23,25-23,30)
(forall ((@x0 Term) (@x1 Term))
...
; *) x + y >= 0) /\
; (forall (any_result: (_: Prims.nat -> _: Prims.nat -> Prims.nat)).
;     (fun x y -> x + y) == any_result ==>
;     (forall (x: Prims.nat). 0 + x == x /\ x + 0 == x) /\
;     (forall (x: Prims.nat) (y: Prims.nat) (z: Prims.nat). x + (y + z) == x + y + z))


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let monoid_nat_plus`
...
;; def=Prims.fst(680,18-680,24); use=GradedMonad.fst(23,25-23,30)
(or label_1
...
;; def=GradedMonad.fst(13,3-23,30); use=GradedMonad.fst(13,3-23,30)
(= Tm_abs_cfa108ea2e44f8f80ea74d6b8d851c76
@x0)
)

;; def=GradedMonad.fst(15,22-18,4); use=GradedMonad.fst(25,15-25,17)
(and 
;; def=GradedMonad.fst(16,5-16,51); use=GradedMonad.fst(25,15-25,17)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.nat)

;; def=GradedMonad.fst(16,20-16,50); use=GradedMonad.fst(25,15-25,17)
(and 
;; def=GradedMonad.fst(16,20-16,33); use=GradedMonad.fst(25,15-25,17)
(or label_2

;; def=GradedMonad.fst(16,20-16,33); use=GradedMonad.fst(25,15-25,17)
(= (Prims.op_Addition (BoxInt 0)
@x1)
@x1)
)


;; def=GradedMonad.fst(16,37-16,50); use=GradedMonad.fst(25,15-25,17)
(or label_3
...
;; def=GradedMonad.fst(17,5-17,55); use=GradedMonad.fst(25,15-25,17)
...
;; def=GradedMonad.fst(17,24-17,54); use=GradedMonad.fst(25,15-25,17)
(or label_4
...
@x3))
(Prims.op_Addition (Prims.op_Addition @x1
@x2)
@x3))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GradedMonad.monoid_nat_plus, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, int_inversion, int_typing, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
