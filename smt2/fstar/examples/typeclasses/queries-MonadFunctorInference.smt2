...
; Internals for MonadFunctorInference


; encoding sigelt type MonadFunctorInference.monad


; <Start encoding type MonadFunctorInference.monad>

;;;;;;;;;;;;;;;;Constructor
(declare-fun MonadFunctorInference.monad (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun MonadFunctorInference.monad@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun MonadFunctorInference.Mkmonad (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFunctorInference.Mkmonad_m (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFunctorInference.Mkmonad_return (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFunctorInference.Mkmonad_bind (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: MonadFunctorInference.Mkmonad
(declare-fun MonadFunctorInference.Mkmonad@tok () Term)
...
;;;;;;;;;;;;;;;;return: (_: a -> m a) -> bind: (f: m a -> g: (_: a -> m b) -> m b) -> monad m
(declare-fun Tm_arrow_f6f0e835b27dd47aaf63014e7907bb89 () Term)

; <start constructor MonadFunctorInference.monad>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-MonadFunctorInference.monad ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
106)
(exists ((@x0 Term))
 (! (= __@x0
(MonadFunctorInference.monad @x0))
 
;;no pats
:qid is-MonadFunctorInference.monad))))

; </end constructor MonadFunctorInference.monad>


; <start constructor MonadFunctorInference.Mkmonad>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-MonadFunctorInference.Mkmonad ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
121)
(= __@x0
(MonadFunctorInference.Mkmonad (MonadFunctorInference.Mkmonad_m __@x0)
(MonadFunctorInference.Mkmonad_return __@x0)
(MonadFunctorInference.Mkmonad_bind __@x0)))))

; </end constructor MonadFunctorInference.Mkmonad>


; </end encoding type MonadFunctorInference.monad>


; encoding sigelt val MonadFunctorInference.__proj__Mkmonad__item__return


; <Start encoding val MonadFunctorInference.__proj__Mkmonad__item__return>


(declare-fun MonadFunctorInference.__proj__Mkmonad__item__return (Term Term) Term)


;;;;;;;;;;;;;;;;projectee: monad m -> _: a -> m a
(declare-fun Tm_arrow_de0fbf03dc7f2fba4260cc02104324b9 () Term)
(declare-fun MonadFunctorInference.__proj__Mkmonad__item__return@tok () Term)


; </end encoding val MonadFunctorInference.__proj__Mkmonad__item__return>
...
; encoding sigelt val MonadFunctorInference.__proj__Mkmonad__item__bind


; <Start encoding val MonadFunctorInference.__proj__Mkmonad__item__bind>


(declare-fun MonadFunctorInference.__proj__Mkmonad__item__bind (Term Term) Term)



;;;;;;;;;;;;;;;;projectee: monad m -> f: m a -> g: (_: a -> m b) -> m b
(declare-fun Tm_arrow_628bbddf5bf79f12ae0df35a3b08c617 () Term)
(declare-fun MonadFunctorInference.__proj__Mkmonad__item__bind@tok () Term)



; </end encoding val MonadFunctorInference.__proj__Mkmonad__item__bind>
...
(declare-fun MonadFunctorInference.return (Term) Term)
...
;;;;;;;;;;;;;;;;{| projectee: monad m |} -> _: a -> m a
(declare-fun Tm_arrow_d981403bed414063e9d85d76c38c216a (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monad m |} -> _: a -> m a
(declare-fun Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1 () Term)
(declare-fun MonadFunctorInference.return@tok () Term)
...
(declare-fun Tm_abs_1cd3aec29fb640351fe3d81d618ff192 (Term) Term)
...
(declare-fun MonadFunctorInference.bind (Term) Term)
...
;;;;;;;;;;;;;;;;{| projectee: monad m |} -> f: m a -> g: (_: a -> m b) -> m b
(declare-fun Tm_arrow_547fb53b87925b41e512f53d7c51265f (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monad m |} -> f: m a -> g: (_: a -> m b) -> m b
(declare-fun Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360 () Term)
(declare-fun MonadFunctorInference.bind@tok () Term)
...
(declare-fun Tm_abs_149cffba6cd41c85a270a196659747b3 (Term) Term)
...
(declare-fun MonadFunctorInference.st (Term Term) Term)

(declare-fun MonadFunctorInference.st@tok () Term)
;;;;;;;;;;;;;;;;_: s -> a & s
...
; encoding sigelt let st_monad


; <Start encoding let st_monad>

(declare-fun MonadFunctorInference.st_monad (Term) Term)
;;;;;;;;;;;;;;;;s: Type -> monad (st s)
(declare-fun Tm_arrow_d5aacf38252f33560b20181a4cb77b41 () Term)
(declare-fun MonadFunctorInference.st_monad@tok () Term)



(declare-fun Tm_abs_5a22fdb811a787bb8871a2f55797480a (Term) Term)
;;;;;;;;;;;;;;;;x: a -> s: s -> a & s
(declare-fun Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc (Term) Term)
(declare-fun Tm_abs_c0d0000c389ad35def48694f32ab1308 (Term) Term)
;;;;;;;;;;;;;;;;_: a -> st s b
(declare-fun Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0 (Term Term Term) Term)

;;;;;;;;;;;;;;;;f: st s a -> g: (_: a -> st s b) -> s0: s -> b & s
(declare-fun Tm_arrow_7efbe35f944217e818c0830066ab319c (Term) Term)
(declare-fun Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b (Term) Term)

; </end encoding let st_monad>
...
(declare-fun MonadFunctorInference.get (Term) Term)
;;;;;;;;;;;;;;;;st s s
(declare-fun Tm_arrow_20ba073f867fe405bee8aaf34a7f860c () Term)
(declare-fun MonadFunctorInference.get@tok () Term)
;;;;;;;;;;;;;;;;s: s -> s & s
...
(declare-fun MonadFunctorInference.put (Term Term) Term)
;;;;;;;;;;;;;;;;x: s -> st s Prims.unit
(declare-fun Tm_arrow_5c1ddab30831bdb1d25c542937a55177 () Term)
(declare-fun MonadFunctorInference.put@tok () Term)
;;;;;;;;;;;;;;;;_: s -> Prims.unit & s
...
; encoding sigelt let get_inc


; <Start encoding let get_inc>

(declare-fun MonadFunctorInference.get_inc (Dummy_sort) Term)



;;;;;;;;;;;;;;;;x: Prims.int -> st Prims.int Prims.int
(declare-fun Tm_arrow_2371a70a5f189dea9f057014c59897fc () Term)
(declare-fun Tm_abs_16e495a5a3b2d8f6f89f6d5814ec0424 () Term)

; </end encoding let get_inc>


; encoding sigelt let test_st2


; <Start encoding let test_st2>

(declare-fun MonadFunctorInference.test_st2 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> st Prims.int Prims.unit
(declare-fun Tm_arrow_3191724b6d1d2aa6a7b7b3455818cd5b () Term)
(declare-fun MonadFunctorInference.test_st2@tok () Term)



;;;;;;;;;;;;;;;;x: Prims.int -> st Prims.int Prims.unit
(declare-fun Tm_arrow_4a2dc5a70bad5bd41b4f77418dfeb24c () Term)
(declare-fun Tm_abs_9b16ed3c3b26c5dd537eec49b37fb9f6 (Term) Term)



(declare-fun Tm_abs_055330cf6c1743f6d4d67a6aefe2e60c () Term)


; </end encoding let test_st2>


; encoding sigelt let get_put


; <Start encoding let get_put>

(declare-fun MonadFunctorInference.get_put (Term) Term)
;;;;;;;;;;;;;;;;st s Prims.unit
(declare-fun Tm_arrow_b790de9bb1e8b41b1b0f55b8292b19e3 () Term)
(declare-fun MonadFunctorInference.get_put@tok () Term)


;;;;;;;;;;;;;;;;x: s -> st s Prims.unit
(declare-fun Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3 (Term) Term)
(declare-fun Tm_abs_4628f1461cec5c8004766c30bae7344c (Term) Term)


; </end encoding let get_put>


; encoding sigelt let noop


; <Start encoding let noop>

(declare-fun MonadFunctorInference.noop (Term) Term)

(declare-fun MonadFunctorInference.noop@tok () Term)



; </end encoding let noop>
...
;;; Fact-ids: Name MonadFunctorInference.put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(30,13-30,18); use=MonadFunctorInference.fst(30,13-30,18)
...
;;;;;;;;;;;;;;;;typing_Tm_abs_c0d0000c389ad35def48694f32ab1308
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(16,39-16,43); use=MonadFunctorInference.fst(16,39-16,43)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_c0d0000c389ad35def48694f32ab1308 @x0)
(Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc @x0))
 

:pattern ((Tm_abs_c0d0000c389ad35def48694f32ab1308 @x0))
:qid typing_Tm_abs_c0d0000c389ad35def48694f32ab1308))

:named typing_Tm_abs_c0d0000c389ad35def48694f32ab1308))
;;;;;;;;;;;;;;;;typing_Tm_abs_79991cb66008561c642fa3e96942b94c
;;; Fact-ids: Name MonadFunctorInference.get; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(26,13-26,17); use=MonadFunctorInference.fst(26,13-26,17)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;typing_Tm_abs_5a22fdb811a787bb8871a2f55797480a
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(14,18-14,19); use=MonadFunctorInference.fst(16,39-17,31)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_5a22fdb811a787bb8871a2f55797480a @x0)
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
 

:pattern ((Tm_abs_5a22fdb811a787bb8871a2f55797480a @x0))
:qid typing_Tm_abs_5a22fdb811a787bb8871a2f55797480a))

:named typing_Tm_abs_5a22fdb811a787bb8871a2f55797480a))
;;;;;;;;;;;;;;;;typing_Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(17,61-19,21); use=MonadFunctorInference.fst(17,61-19,21)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b @x0)
(Tm_arrow_7efbe35f944217e818c0830066ab319c @x0))
 

:pattern ((Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b @x0))
:qid typing_Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b))

:named typing_Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b))
;;;;;;;;;;;;;;;;typing_Tm_abs_4628f1461cec5c8004766c30bae7344c
;;; Fact-ids: Name MonadFunctorInference.get_put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(47,2-47,7); use=MonadFunctorInference.fst(47,2-47,7)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_4628f1461cec5c8004766c30bae7344c @x0)
(Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3 @x0))
 

:pattern ((Tm_abs_4628f1461cec5c8004766c30bae7344c @x0))
:qid typing_Tm_abs_4628f1461cec5c8004766c30bae7344c))

:named typing_Tm_abs_4628f1461cec5c8004766c30bae7344c))
;;;;;;;;;;;;;;;;typing_Tm_abs_1cd3aec29fb640351fe3d81d618ff192
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(6,3-6,9); use=MonadFunctorInference.fst(6,3-6,9)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_1cd3aec29fb640351fe3d81d618ff192 @x0)
(Tm_arrow_d981403bed414063e9d85d76c38c216a @x0))
 

:pattern ((Tm_abs_1cd3aec29fb640351fe3d81d618ff192 @x0))
:qid typing_Tm_abs_1cd3aec29fb640351fe3d81d618ff192))

:named typing_Tm_abs_1cd3aec29fb640351fe3d81d618ff192))
;;;;;;;;;;;;;;;;typing_Tm_abs_149cffba6cd41c85a270a196659747b3
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,3-7,7); use=MonadFunctorInference.fst(7,3-7,7)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_149cffba6cd41c85a270a196659747b3 @x0)
(Tm_arrow_547fb53b87925b41e512f53d7c51265f @x0))
 

:pattern ((Tm_abs_149cffba6cd41c85a270a196659747b3 @x0))
:qid typing_Tm_abs_149cffba6cd41c85a270a196659747b3))

:named typing_Tm_abs_149cffba6cd41c85a270a196659747b3))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(14,9-14,17); use=MonadFunctorInference.fst(14,9-14,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (MonadFunctorInference.st_monad @x0)
(MonadFunctorInference.monad (ApplyTT MonadFunctorInference.st@tok
@x0))))
 

:pattern ((MonadFunctorInference.st_monad @x0))
:qid typing_MonadFunctorInference.st_monad))

:named typing_MonadFunctorInference.st_monad))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadFunctorInference.st; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(12,4-12,6); use=MonadFunctorInference.fst(12,4-12,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (MonadFunctorInference.st @x0
@x1)
Tm_type))
 

:pattern ((MonadFunctorInference.st @x0
@x1))
:qid typing_MonadFunctorInference.st))

:named typing_MonadFunctorInference.st))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (MonadFunctorInference.return @x0)
(Tm_arrow_d981403bed414063e9d85d76c38c216a @x0)))
 

:pattern ((MonadFunctorInference.return @x0))
:qid typing_MonadFunctorInference.return))
:named typing_MonadFunctorInference.return))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadFunctorInference.put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(28,4-28,7); use=MonadFunctorInference.fst(28,4-28,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
@x0))
(HasType (MonadFunctorInference.put @x0
@x1)
(MonadFunctorInference.st @x0
Prims.unit)))
 

:pattern ((MonadFunctorInference.put @x0
@x1))
:qid typing_MonadFunctorInference.put))

:named typing_MonadFunctorInference.put))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadFunctorInference.noop; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(49,4-49,8); use=MonadFunctorInference.fst(49,4-49,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (MonadFunctorInference.noop @x0)
(MonadFunctorInference.st @x0
Prims.unit)))
 

:pattern ((MonadFunctorInference.noop @x0))
:qid typing_MonadFunctorInference.noop))

:named typing_MonadFunctorInference.noop))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadFunctorInference.get_put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(45,4-45,11); use=MonadFunctorInference.fst(45,4-45,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (MonadFunctorInference.get_put @x0)
(MonadFunctorInference.st @x0
Prims.unit)))
 

:pattern ((MonadFunctorInference.get_put @x0))
:qid typing_MonadFunctorInference.get_put))

:named typing_MonadFunctorInference.get_put))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadFunctorInference.get; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(24,4-24,7); use=MonadFunctorInference.fst(24,4-24,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (MonadFunctorInference.get @x0)
(MonadFunctorInference.st @x0
@x0)))
 

:pattern ((MonadFunctorInference.get @x0))
:qid typing_MonadFunctorInference.get))

:named typing_MonadFunctorInference.get))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (MonadFunctorInference.bind @x0)
(Tm_arrow_547fb53b87925b41e512f53d7c51265f @x0)))
 

:pattern ((MonadFunctorInference.bind @x0))
:qid typing_MonadFunctorInference.bind))
:named typing_MonadFunctorInference.bind))
;;;;;;;;;;;;;;;;free var typing
...
;; def=MonadFunctorInference.fst(12,4-12,6); use=MonadFunctorInference.fst(12,4-12,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT MonadFunctorInference.st@tok
@x0)
@x1)
(MonadFunctorInference.st @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT MonadFunctorInference.st@tok
@x0)
@x1))
:qid token_correspondence_MonadFunctorInference.st))

:named token_correspondence_MonadFunctorInference.st))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT MonadFunctorInference.return@tok
@x0)
(MonadFunctorInference.return @x0))
 

:pattern ((ApplyTT MonadFunctorInference.return@tok
@x0))
:qid token_correspondence_MonadFunctorInference.return))
:named token_correspondence_MonadFunctorInference.return))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-4,11); use=MonadFunctorInference.fst(4,6-4,11)
(forall ((@x0 Term))
 (! (= (ApplyTT MonadFunctorInference.monad@tok
@x0)
(MonadFunctorInference.monad @x0))
 

:pattern ((ApplyTT MonadFunctorInference.monad@tok
@x0))

:pattern ((MonadFunctorInference.monad @x0))
:qid token_correspondence_MonadFunctorInference.monad@tok))

:named token_correspondence_MonadFunctorInference.monad@tok))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT MonadFunctorInference.bind@tok
@x0)
(MonadFunctorInference.bind @x0))
 

:pattern ((ApplyTT MonadFunctorInference.bind@tok
@x0))
:qid token_correspondence_MonadFunctorInference.bind))
:named token_correspondence_MonadFunctorInference.bind))
;;;;;;;;;;;;;;;;name-token correspondence
...
(MonadFunctorInference.Mkmonad @x1
@x2
@x3)
(MonadFunctorInference.monad @x4))
...
@x3)
(MonadFunctorInference.monad @x4)))
:qid subterm_ordering_MonadFunctorInference.Mkmonad))

:named subterm_ordering_MonadFunctorInference.Mkmonad))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
...
;; def=MonadFunctorInference.fst(4,6-4,11); use=MonadFunctorInference.fst(4,6-4,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (MonadFunctorInference.Mkmonad_return (MonadFunctorInference.Mkmonad @x0
@x1
@x2))
@x1)
 

:pattern ((MonadFunctorInference.Mkmonad @x0
@x1
@x2))
:qid projection_inverse_MonadFunctorInference.Mkmonad_return))

:named projection_inverse_MonadFunctorInference.Mkmonad_return))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-4,11); use=MonadFunctorInference.fst(4,6-4,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (MonadFunctorInference.Mkmonad_m (MonadFunctorInference.Mkmonad @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_MonadFunctorInference.Mkmonad_m))

:named projection_inverse_MonadFunctorInference.Mkmonad_m))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-4,11); use=MonadFunctorInference.fst(4,6-4,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (MonadFunctorInference.Mkmonad_bind (MonadFunctorInference.Mkmonad @x0
@x1
@x2))
@x2)
...
@x1
@x2))
:qid projection_inverse_MonadFunctorInference.Mkmonad_bind))

:named projection_inverse_MonadFunctorInference.Mkmonad_bind))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,22-59,30); use=FStar.Pervasives.Native.fst(59,22-59,30)
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! (is-Tm_arrow (PreType MonadFunctorInference.monad@tok))
:named pre_kinding_MonadFunctorInference.monad@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
...
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,14-7,67); use=MonadFunctorInference.fst(7,16-7,67)
(forall ((@x0 Term))
...
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=dummy(0,0-0,0); use=MonadFunctorInference.fst(7,3-7,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,14-7,58); use=MonadFunctorInference.fst(7,50-7,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(6,14-6,32); use=MonadFunctorInference.fst(6,16-6,32)
(forall ((@x0 Term))
...
;;; Fact-ids: Name MonadFunctorInference.get; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(12,32-24,10); use=MonadFunctorInference.fst(12,32-25,8)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d981403bed414063e9d85d76c38c216a
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-6,20); use=MonadFunctorInference.fst(6,3-6,25)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_d981403bed414063e9d85d76c38c216a @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_d981403bed414063e9d85d76c38c216a @x0)
Tm_type))
:qid kinding_Tm_arrow_d981403bed414063e9d85d76c38c216a))

:named kinding_Tm_arrow_d981403bed414063e9d85d76c38c216a))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(17,18-17,50); use=MonadFunctorInference.fst(17,39-17,50)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0))

:named kinding_Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(6,16-16,19); use=MonadFunctorInference.fst(16,3-19,23)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc @x0)
Tm_type))
:qid kinding_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc))

:named kinding_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc))
...
;;; Fact-ids: Name MonadFunctorInference.st; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(12,8-12,37); use=MonadFunctorInference.fst(12,27-12,37)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(6,16-6,20); use=MonadFunctorInference.fst(6,3-6,25)
(forall ((@x0 Term))
...
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=dummy(0,0-0,0); use=MonadFunctorInference.fst(6,3-6,25)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7efbe35f944217e818c0830066ab319c
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,16-17,50); use=MonadFunctorInference.fst(16,3-19,23)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_7efbe35f944217e818c0830066ab319c @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_7efbe35f944217e818c0830066ab319c @x0)
Tm_type))
:qid kinding_Tm_arrow_7efbe35f944217e818c0830066ab319c))

:named kinding_Tm_arrow_7efbe35f944217e818c0830066ab319c))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! (HasType Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360
Tm_type)
:named kinding_Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_547fb53b87925b41e512f53d7c51265f
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-7,41); use=MonadFunctorInference.fst(7,3-7,51)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_547fb53b87925b41e512f53d7c51265f @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_547fb53b87925b41e512f53d7c51265f @x0)
Tm_type))
:qid kinding_Tm_arrow_547fb53b87925b41e512f53d7c51265f))

:named kinding_Tm_arrow_547fb53b87925b41e512f53d7c51265f))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_49b2624aa26b413e2f62db699cf87966
;;; Fact-ids: Name MonadFunctorInference.put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(12,32-28,10); use=MonadFunctorInference.fst(12,32-29,8)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! (HasType Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1
Tm_type)
:named kinding_Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,16-7,41); use=MonadFunctorInference.fst(7,3-7,51)
(forall ((@x0 Term))
...
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,27-7,41); use=MonadFunctorInference.fst(7,3-7,51)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,38-7,41); use=MonadFunctorInference.fst(7,3-7,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3
;;; Fact-ids: Name MonadFunctorInference.get_put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,55-45,14); use=MonadFunctorInference.fst(46,2-46,14)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3 @x0)
Tm_type))
:qid kinding_Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3))

:named kinding_Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (HasType Prims.trivial
Tm_type)
:named kinding_Prims.trivial@tok))
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! (and (IsTotFun MonadFunctorInference.monad@tok)

;; def=MonadFunctorInference.fst(4,6-4,11); use=MonadFunctorInference.fst(4,6-4,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (MonadFunctorInference.monad @x0)
Tm_type))
 

:pattern ((MonadFunctorInference.monad @x0))
:qid kinding_MonadFunctorInference.monad@tok))
)
:named kinding_MonadFunctorInference.monad@tok))
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c0d0000c389ad35def48694f32ab1308
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(16,39-16,43); use=MonadFunctorInference.fst(16,39-16,43)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_c0d0000c389ad35def48694f32ab1308 @x3)
@x0)
@x1)
@x2)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_c0d0000c389ad35def48694f32ab1308 @x3)
@x0)
@x1)
@x2))
:qid interpretation_Tm_abs_c0d0000c389ad35def48694f32ab1308))

:named interpretation_Tm_abs_c0d0000c389ad35def48694f32ab1308))
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_5a22fdb811a787bb8871a2f55797480a
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(14,18-14,19); use=MonadFunctorInference.fst(16,39-17,31)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_5a22fdb811a787bb8871a2f55797480a @x1)
@x0)
(Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe @x0
@x1))
 

:pattern ((ApplyTT (Tm_abs_5a22fdb811a787bb8871a2f55797480a @x1)
@x0))
:qid interpretation_Tm_abs_5a22fdb811a787bb8871a2f55797480a))

:named interpretation_Tm_abs_5a22fdb811a787bb8871a2f55797480a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(17,61-19,21); use=MonadFunctorInference.fst(17,61-19,21)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b @x5)
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b @x5)
@x0)
@x1)
@x2)
@x3)
@x4))
:qid interpretation_Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b))

:named interpretation_Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_4628f1461cec5c8004766c30bae7344c
;;; Fact-ids: Name MonadFunctorInference.get_put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(47,2-47,7); use=MonadFunctorInference.fst(47,2-47,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_4628f1461cec5c8004766c30bae7344c @x1)
@x0)
(MonadFunctorInference.put @x1
@x0))
 

:pattern ((ApplyTT (Tm_abs_4628f1461cec5c8004766c30bae7344c @x1)
@x0))
:qid interpretation_Tm_abs_4628f1461cec5c8004766c30bae7344c))

:named interpretation_Tm_abs_4628f1461cec5c8004766c30bae7344c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_1cd3aec29fb640351fe3d81d618ff192
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(6,3-6,9); use=MonadFunctorInference.fst(6,3-6,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_1cd3aec29fb640351fe3d81d618ff192 @x1)
@x0)
(let ((@lb2 @x0))
(MonadFunctorInference.Mkmonad_return @lb2)))
 

:pattern ((ApplyTT (Tm_abs_1cd3aec29fb640351fe3d81d618ff192 @x1)
@x0))
:qid interpretation_Tm_abs_1cd3aec29fb640351fe3d81d618ff192))

:named interpretation_Tm_abs_1cd3aec29fb640351fe3d81d618ff192))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_149cffba6cd41c85a270a196659747b3
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,3-7,7); use=MonadFunctorInference.fst(7,3-7,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_149cffba6cd41c85a270a196659747b3 @x1)
@x0)
(let ((@lb2 @x0))
(MonadFunctorInference.Mkmonad_bind @lb2)))
 

:pattern ((ApplyTT (Tm_abs_149cffba6cd41c85a270a196659747b3 @x1)
@x0))
:qid interpretation_Tm_abs_149cffba6cd41c85a270a196659747b3))

:named interpretation_Tm_abs_149cffba6cd41c85a270a196659747b3))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MonadFunctorInference.st@tok
...
@x1)
@x2)
(MonadFunctorInference.st @x1
@x2))
 

:pattern ((MonadFunctorInference.st @x1
@x2))
:qid function_token_typing_MonadFunctorInference.st.1))
)
 

:pattern ((ApplyTT @x0
MonadFunctorInference.st@tok))
:qid function_token_typing_MonadFunctorInference.st))

:named function_token_typing_MonadFunctorInference.st))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MonadFunctorInference.return@tok
Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1))
(forall ((@x1 Term))
 (! (= (ApplyTT MonadFunctorInference.return@tok
@x1)
(MonadFunctorInference.return @x1))
 

:pattern ((MonadFunctorInference.return @x1))
:qid function_token_typing_MonadFunctorInference.return.1)))
 

:pattern ((ApplyTT @x0
MonadFunctorInference.return@tok))
:qid function_token_typing_MonadFunctorInference.return))
:named function_token_typing_MonadFunctorInference.return))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MonadFunctorInference.bind@tok
Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360))
(forall ((@x1 Term))
 (! (= (ApplyTT MonadFunctorInference.bind@tok
@x1)
(MonadFunctorInference.bind @x1))
 

:pattern ((MonadFunctorInference.bind @x1))
:qid function_token_typing_MonadFunctorInference.bind.1)))
 

:pattern ((ApplyTT @x0
MonadFunctorInference.bind@tok))
:qid function_token_typing_MonadFunctorInference.bind))
:named function_token_typing_MonadFunctorInference.bind))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(MonadFunctorInference.monad @x2))
(and (is-MonadFunctorInference.Mkmonad @x1)
(= @x2
(MonadFunctorInference.Mkmonad_m @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(MonadFunctorInference.monad @x2)))
:qid fuel_guarded_inversion_MonadFunctorInference.monad))

:named fuel_guarded_inversion_MonadFunctorInference.monad))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,5-59,11); use=FStar.Pervasives.Native.fst(59,5-59,11)
...
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! (= 107
(Term_constr_id MonadFunctorInference.monad@tok))
:named fresh_token_MonadFunctorInference.monad@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! (= 126
...
;;;;;;;;;;;;;;;;Equation for MonadFunctorInference.st_monad
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(14,9-14,17); use=MonadFunctorInference.fst(14,9-14,17)
(forall ((@x0 Term))
 (! (= (MonadFunctorInference.st_monad @x0)
(MonadFunctorInference.Mkmonad (Tm_abs_5a22fdb811a787bb8871a2f55797480a @x0)
(Tm_abs_c0d0000c389ad35def48694f32ab1308 @x0)
(Tm_abs_4896c8b1c1f351c5ce7ba2d35d5b179b @x0)))
 

:pattern ((MonadFunctorInference.st_monad @x0))
:qid equation_MonadFunctorInference.st_monad))

:named equation_MonadFunctorInference.st_monad))
;;;;;;;;;;;;;;;;Equation for MonadFunctorInference.st
;;; Fact-ids: Name MonadFunctorInference.st; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(12,4-12,6); use=MonadFunctorInference.fst(12,4-12,6)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((MonadFunctorInference.st @x0
@x1))
:qid equation_MonadFunctorInference.st))

:named equation_MonadFunctorInference.st))
;;;;;;;;;;;;;;;;Equation for MonadFunctorInference.return
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! (forall ((@x0 Term))
 (! (= (MonadFunctorInference.return @x0)
(Tm_abs_1cd3aec29fb640351fe3d81d618ff192 @x0))
 

:pattern ((MonadFunctorInference.return @x0))
:qid equation_MonadFunctorInference.return))
:named equation_MonadFunctorInference.return))
;;;;;;;;;;;;;;;;Equation for MonadFunctorInference.put
;;; Fact-ids: Name MonadFunctorInference.put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(28,4-28,7); use=MonadFunctorInference.fst(28,4-28,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (MonadFunctorInference.put @x0
@x1)
...
:pattern ((MonadFunctorInference.put @x0
@x1))
:qid equation_MonadFunctorInference.put))

:named equation_MonadFunctorInference.put))
;;;;;;;;;;;;;;;;Equation for MonadFunctorInference.noop
;;; Fact-ids: Name MonadFunctorInference.noop; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(49,4-49,8); use=MonadFunctorInference.fst(49,4-49,8)
(forall ((@x0 Term))
 (! (= (MonadFunctorInference.noop @x0)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT MonadFunctorInference.return@tok
(ApplyTT MonadFunctorInference.st@tok
@x0))
(MonadFunctorInference.st_monad @x0))
Prims.unit)
Tm_unit))
...
:pattern ((MonadFunctorInference.noop @x0))
:qid equation_MonadFunctorInference.noop))

:named equation_MonadFunctorInference.noop))
;;;;;;;;;;;;;;;;Equation for MonadFunctorInference.get_put
;;; Fact-ids: Name MonadFunctorInference.get_put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(45,4-45,11); use=MonadFunctorInference.fst(45,4-45,11)
(forall ((@x0 Term))
 (! (= (MonadFunctorInference.get_put @x0)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT MonadFunctorInference.bind@tok
(ApplyTT MonadFunctorInference.st@tok
@x0))
(MonadFunctorInference.st_monad @x0))
@x0)
Prims.unit)
(MonadFunctorInference.get @x0))
(Tm_abs_4628f1461cec5c8004766c30bae7344c @x0)))
 

:pattern ((MonadFunctorInference.get_put @x0))
:qid equation_MonadFunctorInference.get_put))

:named equation_MonadFunctorInference.get_put))
;;;;;;;;;;;;;;;;Equation for MonadFunctorInference.get
;;; Fact-ids: Name MonadFunctorInference.get; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(24,4-24,7); use=MonadFunctorInference.fst(24,4-24,7)
(forall ((@x0 Term))
...
:pattern ((MonadFunctorInference.get @x0))
:qid equation_MonadFunctorInference.get))

:named equation_MonadFunctorInference.get))
;;;;;;;;;;;;;;;;Equation for MonadFunctorInference.bind
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! (forall ((@x0 Term))
 (! (= (MonadFunctorInference.bind @x0)
(Tm_abs_149cffba6cd41c85a270a196659747b3 @x0))
 

:pattern ((MonadFunctorInference.bind @x0))
:qid equation_MonadFunctorInference.bind))
:named equation_MonadFunctorInference.bind))
...
@x2
@x3)
(MonadFunctorInference.monad @x1)))
...
@x3)
(MonadFunctorInference.monad @x1)))
:qid data_typing_intro_MonadFunctorInference.Mkmonad@tok))

:named data_typing_intro_MonadFunctorInference.Mkmonad@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,22-59,30); use=FStar.Pervasives.Native.fst(59,22-59,30)
...
(HasTypeFuel @u0
@x2
(Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c @x4))
(HasTypeFuel @u0
@x3
(Tm_arrow_fe96ea64440933a872257514e1912843 @x4))))
...
@x3)
(MonadFunctorInference.monad @x4)))
:qid data_elim_MonadFunctorInference.Mkmonad))

:named data_elim_MonadFunctorInference.Mkmonad))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,22-59,30); use=FStar.Pervasives.Native.fst(59,22-59,30)
...
(forall ((@x0 Term))
 (! (= 106
(Term_constr_id (MonadFunctorInference.monad @x0)))
 

:pattern ((MonadFunctorInference.monad @x0))
:qid constructor_distinct_MonadFunctorInference.monad))

:named constructor_distinct_MonadFunctorInference.monad))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-4,11); use=MonadFunctorInference.fst(4,6-4,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 121
(Term_constr_id (MonadFunctorInference.Mkmonad @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_MonadFunctorInference.Mkmonad))

:named constructor_distinct_MonadFunctorInference.Mkmonad))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,5-59,11); use=FStar.Pervasives.Native.fst(59,5-59,11)
...
@x0
(MonadFunctorInference.monad @x2)))
:qid MonadFunctorInference_pretyping_e9256dc6980f53ebe7c749adefb37584))

:named MonadFunctorInference_pretyping_e9256dc6980f53ebe7c749adefb37584))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,14-7,67); use=MonadFunctorInference.fst(7,16-7,67)
...
@x1
(Tm_arrow_fe96ea64440933a872257514e1912843 @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_fe96ea64440933a872257514e1912843))

:named MonadFunctorInference_pre_typing_Tm_arrow_fe96ea64440933a872257514e1912843))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=dummy(0,0-0,0); use=MonadFunctorInference.fst(7,3-7,51)
...
@x3
@x4)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566))

:named MonadFunctorInference_pre_typing_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,14-7,58); use=MonadFunctorInference.fst(7,50-7,58)
...
@x3
@x4)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))

:named MonadFunctorInference_pre_typing_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.monad; Namespace MonadFunctorInference; Name MonadFunctorInference.Mkmonad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(6,14-6,32); use=MonadFunctorInference.fst(6,16-6,32)
...
@x1
(Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))

:named MonadFunctorInference_pre_typing_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.get; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(12,32-24,10); use=MonadFunctorInference.fst(12,32-25,8)
...
@x1
(Tm_arrow_dfea4a8020add2504b31d30cd18f4a45 @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_dfea4a8020add2504b31d30cd18f4a45))

:named MonadFunctorInference_pre_typing_Tm_arrow_dfea4a8020add2504b31d30cd18f4a45))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-6,20); use=MonadFunctorInference.fst(6,3-6,25)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_d981403bed414063e9d85d76c38c216a @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_d981403bed414063e9d85d76c38c216a @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_d981403bed414063e9d85d76c38c216a))

:named MonadFunctorInference_pre_typing_Tm_arrow_d981403bed414063e9d85d76c38c216a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(17,18-17,50); use=MonadFunctorInference.fst(17,39-17,50)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0))

:named MonadFunctorInference_pre_typing_Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(6,16-16,19); use=MonadFunctorInference.fst(16,3-19,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc))

:named MonadFunctorInference_pre_typing_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.st; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(12,8-12,37); use=MonadFunctorInference.fst(12,27-12,37)
...
(Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe @x2
@x3)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))

:named MonadFunctorInference_pre_typing_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(6,16-6,20); use=MonadFunctorInference.fst(6,3-6,25)
...
@x1
(Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd))

:named MonadFunctorInference_pre_typing_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=dummy(0,0-0,0); use=MonadFunctorInference.fst(6,3-6,25)
...
(Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x2
@x3)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))

:named MonadFunctorInference_pre_typing_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,16-17,50); use=MonadFunctorInference.fst(16,3-19,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_7efbe35f944217e818c0830066ab319c @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_7efbe35f944217e818c0830066ab319c @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_7efbe35f944217e818c0830066ab319c))

:named MonadFunctorInference_pre_typing_Tm_arrow_7efbe35f944217e818c0830066ab319c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-7,41); use=MonadFunctorInference.fst(7,3-7,51)
...
@x1
Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360))
:qid MonadFunctorInference_pre_typing_Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360))

:named MonadFunctorInference_pre_typing_Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-7,41); use=MonadFunctorInference.fst(7,3-7,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_547fb53b87925b41e512f53d7c51265f @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_547fb53b87925b41e512f53d7c51265f @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_547fb53b87925b41e512f53d7c51265f))

:named MonadFunctorInference_pre_typing_Tm_arrow_547fb53b87925b41e512f53d7c51265f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(12,32-28,10); use=MonadFunctorInference.fst(12,32-29,8)
...
@x1
(Tm_arrow_49b2624aa26b413e2f62db699cf87966 @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_49b2624aa26b413e2f62db699cf87966))

:named MonadFunctorInference_pre_typing_Tm_arrow_49b2624aa26b413e2f62db699cf87966))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-6,20); use=MonadFunctorInference.fst(6,3-6,25)
...
@x1
Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1))
:qid MonadFunctorInference_pre_typing_Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1))

:named MonadFunctorInference_pre_typing_Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,16-7,41); use=MonadFunctorInference.fst(7,3-7,51)
...
@x1
(Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64 @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64))

:named MonadFunctorInference_pre_typing_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,27-7,41); use=MonadFunctorInference.fst(7,3-7,51)
...
(Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02 @x2
@x3)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02))

:named MonadFunctorInference_pre_typing_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,38-7,41); use=MonadFunctorInference.fst(7,3-7,51)
...
@x3
@x4)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac))

:named MonadFunctorInference_pre_typing_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadFunctorInference.get_put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,55-45,14); use=MonadFunctorInference.fst(46,2-46,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3 @x2)))
:qid MonadFunctorInference_pre_typing_Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3))

:named MonadFunctorInference_pre_typing_Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3))
...
@x4)
@x5))
:qid MonadFunctorInference_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.2))
...
@x2)
@x3))
:qid MonadFunctorInference_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.3))
...
@x3)
@x4))
:qid MonadFunctorInference_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.4))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_fe96ea64440933a872257514e1912843 @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843))

:named MonadFunctorInference_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843))
...
:pattern ((ApplyTT @x0
@x4))
:qid MonadFunctorInference_interpretation_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566.1))
...
@x2
@x3)))
:qid MonadFunctorInference_interpretation_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566))

:named MonadFunctorInference_interpretation_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566))
...
:pattern ((ApplyTT @x0
@x4))
:qid MonadFunctorInference_interpretation_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96.1))
...
@x2
@x3)))
:qid MonadFunctorInference_interpretation_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))

:named MonadFunctorInference_interpretation_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))
...
@x2)
@x3))
:qid MonadFunctorInference_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))

:named MonadFunctorInference_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_dfea4a8020add2504b31d30cd18f4a45.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_dfea4a8020add2504b31d30cd18f4a45 @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_dfea4a8020add2504b31d30cd18f4a45))

:named MonadFunctorInference_interpretation_Tm_arrow_dfea4a8020add2504b31d30cd18f4a45))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d981403bed414063e9d85d76c38c216a
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-6,20); use=MonadFunctorInference.fst(6,3-6,25)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_d981403bed414063e9d85d76c38c216a @x1))
(and 
;; def=MonadFunctorInference.fst(4,6-6,20); use=MonadFunctorInference.fst(6,3-6,25)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_d981403bed414063e9d85d76c38c216a.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_d981403bed414063e9d85d76c38c216a @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_d981403bed414063e9d85d76c38c216a))

:named MonadFunctorInference_interpretation_Tm_arrow_d981403bed414063e9d85d76c38c216a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(17,18-17,50); use=MonadFunctorInference.fst(17,39-17,50)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0 @x1
@x2
@x3))
(and 
;; def=MonadFunctorInference.fst(17,18-17,50); use=MonadFunctorInference.fst(17,39-17,50)
...
(HasType (ApplyTT @x0
@x4)
(MonadFunctorInference.st @x2
@x1)))
 

:pattern ((ApplyTT @x0
@x4))
:qid MonadFunctorInference_interpretation_Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0.1))
...
@x2
@x3)))
:qid MonadFunctorInference_interpretation_Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0))

:named MonadFunctorInference_interpretation_Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(6,16-16,19); use=MonadFunctorInference.fst(16,3-19,23)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc @x1))
(and 
;; def=MonadFunctorInference.fst(6,16-16,19); use=MonadFunctorInference.fst(16,3-19,23)
(forall ((@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x2
...
@x3)
@x4))
:qid MonadFunctorInference_interpretation_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc.2))
...
@x2)
@x3))
:qid MonadFunctorInference_interpretation_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc.3))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc))

:named MonadFunctorInference_interpretation_Tm_arrow_b35066d6cd6c33b9a115ba7a969cf3bc))
...
:pattern ((ApplyTT @x0
@x3))
:qid MonadFunctorInference_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe.1))
...
(Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe @x1
@x2)))
:qid MonadFunctorInference_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))

:named MonadFunctorInference_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd))

:named MonadFunctorInference_interpretation_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd))
...
:pattern ((ApplyTT @x0
@x3))
:qid MonadFunctorInference_interpretation_Tm_arrow_8c46a296e41552271b43886f97a4b7b1.1))
...
(Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x1
@x2)))
:qid MonadFunctorInference_interpretation_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))

:named MonadFunctorInference_interpretation_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7efbe35f944217e818c0830066ab319c
;;; Fact-ids: Name MonadFunctorInference.st_monad; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,16-17,50); use=MonadFunctorInference.fst(16,3-19,23)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_7efbe35f944217e818c0830066ab319c @x1))
(and 
;; def=MonadFunctorInference.fst(7,16-17,50); use=MonadFunctorInference.fst(16,3-19,23)
...
@x2))
(HasType @x5
(Tm_arrow_b830a0c00549e925e7ec3bcb4035f3e0 @x3
@x1
@x2))
(HasType @x6
@x1))
...
@x5)
@x6))
:qid MonadFunctorInference_interpretation_Tm_arrow_7efbe35f944217e818c0830066ab319c.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_7efbe35f944217e818c0830066ab319c.2))
...
@x2)
@x3))
:qid MonadFunctorInference_interpretation_Tm_arrow_7efbe35f944217e818c0830066ab319c.3))
...
@x3)
@x4))
:qid MonadFunctorInference_interpretation_Tm_arrow_7efbe35f944217e818c0830066ab319c.4))
...
@x4)
@x5))
:qid MonadFunctorInference_interpretation_Tm_arrow_7efbe35f944217e818c0830066ab319c.5))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_7efbe35f944217e818c0830066ab319c @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_7efbe35f944217e818c0830066ab319c))

:named MonadFunctorInference_interpretation_Tm_arrow_7efbe35f944217e818c0830066ab319c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-7,41); use=MonadFunctorInference.fst(7,3-7,51)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_547fb53b87925b41e512f53d7c51265f @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid MonadFunctorInference_interpretation_Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360))
:qid MonadFunctorInference_interpretation_Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360))

:named MonadFunctorInference_interpretation_Tm_arrow_7a12f20f5b39013ff09ecf3c6b04f360))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_547fb53b87925b41e512f53d7c51265f
;;; Fact-ids: Name MonadFunctorInference.bind; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-7,41); use=MonadFunctorInference.fst(7,3-7,51)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_547fb53b87925b41e512f53d7c51265f.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_547fb53b87925b41e512f53d7c51265f @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_547fb53b87925b41e512f53d7c51265f))

:named MonadFunctorInference_interpretation_Tm_arrow_547fb53b87925b41e512f53d7c51265f))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_49b2624aa26b413e2f62db699cf87966.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_49b2624aa26b413e2f62db699cf87966 @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_49b2624aa26b413e2f62db699cf87966))

:named MonadFunctorInference_interpretation_Tm_arrow_49b2624aa26b413e2f62db699cf87966))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1
;;; Fact-ids: Name MonadFunctorInference.return; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(4,6-6,20); use=MonadFunctorInference.fst(6,3-6,25)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid MonadFunctorInference_interpretation_Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1))
:qid MonadFunctorInference_interpretation_Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1))

:named MonadFunctorInference_interpretation_Tm_arrow_3d07c4367bd315b70b0c14b466f76fa1))
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64 @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64))

:named MonadFunctorInference_interpretation_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64))
...
:pattern ((ApplyTT @x0
@x3))
:qid MonadFunctorInference_interpretation_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02.1))
...
(Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02 @x1
@x2)))
:qid MonadFunctorInference_interpretation_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02))

:named MonadFunctorInference_interpretation_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02))
...
:pattern ((ApplyTT @x0
@x4))
:qid MonadFunctorInference_interpretation_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac.1))
...
@x2
@x3)))
:qid MonadFunctorInference_interpretation_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac))

:named MonadFunctorInference_interpretation_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3
;;; Fact-ids: Name MonadFunctorInference.get_put; Namespace MonadFunctorInference
(assert (! 
;; def=MonadFunctorInference.fst(7,55-45,14); use=MonadFunctorInference.fst(46,2-46,14)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3 @x1))
(and 
;; def=MonadFunctorInference.fst(7,55-45,14); use=MonadFunctorInference.fst(46,2-46,14)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid MonadFunctorInference_interpretation_Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3 @x1)))
:qid MonadFunctorInference_interpretation_Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3))

:named MonadFunctorInference_interpretation_Tm_arrow_05bd8fc0bd285197e503cc9864cd78d3))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,5-59,11); use=FStar.Pervasives.Native.fst(59,5-59,11)
...
MonadFunctorInference.st@tok))
:named @kick_partial_app_6e6b8bd78f9176c59fa13a2aaa8913bb))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name MonadFunctorInference.get_inc; Namespace MonadFunctorInference
(assert (! (Valid (ApplyTT __uu__PartialApp
MonadFunctorInference.bind@tok))
:named @kick_partial_app_5475c61a6bc5fcc0f8149b06cc5f69c7))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name MonadFunctorInference.get_inc; Namespace MonadFunctorInference
(assert (! (Valid (ApplyTT __uu__PartialApp
MonadFunctorInference.return@tok))
:named @kick_partial_app_36ec203c9bfb5f0e2039f4a8b729cd6d))
(push) ;; push{2

; Starting query at MonadFunctorInference.fst(53,4-53,6)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

(declare-fun Tm_abs_a7217ae31961491c25eae2df751ec6d7 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_a7217ae31961491c25eae2df751ec6d7
;;; Fact-ids: 
(assert (! 
;; def=MonadFunctorInference.fst(12,32-12,37); use=MonadFunctorInference.fst(53,4-53,6)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_a7217ae31961491c25eae2df751ec6d7 @x0)
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x0))
 

:pattern ((Tm_abs_a7217ae31961491c25eae2df751ec6d7 @x0))
:qid typing_Tm_abs_a7217ae31961491c25eae2df751ec6d7))

:named typing_Tm_abs_a7217ae31961491c25eae2df751ec6d7))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_a7217ae31961491c25eae2df751ec6d7
;;; Fact-ids: 
(assert (! 
;; def=MonadFunctorInference.fst(12,32-12,37); use=MonadFunctorInference.fst(53,4-53,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_a7217ae31961491c25eae2df751ec6d7 @x1)
@x0)
(FStar.Pervasives.Native.tuple2 Prims.unit
@x1))
 

:pattern ((ApplyTT (Tm_abs_a7217ae31961491c25eae2df751ec6d7 @x1)
@x0))
:qid interpretation_Tm_abs_a7217ae31961491c25eae2df751ec6d7))

:named interpretation_Tm_abs_a7217ae31961491c25eae2df751ec6d7))
...
;         FStar.FunctionalExtensionality.feq MonadFunctorInference.get_put MonadFunctorInference.noop ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let get_put_identity`
...
;; def=Prims.fst(441,36-441,97); use=MonadFunctorInference.fst(53,4-53,6)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=MonadFunctorInference.fst(52,10-52,67); use=MonadFunctorInference.fst(53,4-53,6)
(or label_2
...
;; def=MonadFunctorInference.fst(52,10-52,67); use=MonadFunctorInference.fst(53,4-53,6)
(FStar.FunctionalExtensionality.feq @x0
(Tm_abs_a7217ae31961491c25eae2df751ec6d7 @x0)
(MonadFunctorInference.get_put @x0)
(MonadFunctorInference.noop @x0))
)
)
...
;; def=Prims.fst(441,83-441,96); use=MonadFunctorInference.fst(53,4-53,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MonadFunctorInference.fst(53,4-53,6)
(ApplyTT @x1
@x2)
...
; encoding sigelt let get_put_identity


; <Start encoding let get_put_identity>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MonadFunctorInference.get_put_identity (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MonadFunctorInference.get_put_identity@tok () Term)

; </end encoding let get_put_identity>
...
; Starting query at MonadFunctorInference.fst(57,0-64,1)
...
;   (y: (_: a -> FStar.Pervasives.Native.option b)).
;   (*  - Could not prove post-condition
; *)
...
; While typechecking the top-level declaration `let opt_monad`
...
;; def=Prims.fst(402,27-402,88); use=MonadFunctorInference.fst(61,13-63,28)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadFunctorInference.fst(61,13-63,28)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadFunctorInference.fst(61,13-63,28)
(ApplyTT @x4
@x5)
...
;; def=MonadFunctorInference.fst(60,22-60,23); use=MonadFunctorInference.fst(61,19-61,20)
(not 
;; def=MonadFunctorInference.fst(60,22-60,23); use=MonadFunctorInference.fst(61,19-61,20)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x0
@x2))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadFunctorInference.opt_monad, 1)
; STATUS: unsat
...
; encoding sigelt let opt_monad


; <Start encoding let opt_monad>

(declare-fun MonadFunctorInference.opt_monad (Dummy_sort) Term)



(declare-fun Tm_abs_3f52c42452ee8b6d24c43961a7fe16a0 () Term)


;;;;;;;;;;;;;;;;x: FStar.Pervasives.Native.option a -> y: (_: a -> FStar.Pervasives.Native.option b)   -> FStar.Pervasives.Native.option b
(declare-fun Tm_arrow_a273ef2cc9fc82e9581085ed97b33fbb () Term)
(declare-fun Tm_abs_a4461b34bd8e2fde15a2b6d996007ad9 () Term)

; </end encoding let opt_monad>
...
(declare-fun MonadFunctorInference.raise (Term) Term)

(declare-fun MonadFunctorInference.raise@tok () Term)
...
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name MonadFunctorInference.opt_monad; Namespace MonadFunctorInference
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.Pervasives.Native.option@tok))
:named @kick_partial_app_15810a664baab1062d72d3e1cdfc7fee))
(push) ;; push{2

; Starting query at MonadFunctorInference.fst(69,2-70,21)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (n: Prims.int) (m: Prims.int).
;   (*  - Could not prove post-condition
; *)
...
;         Prims.auto_squash (k x)) ==>
;     ~(m = 0 = true) ==> (forall (b: Prims.bool). m = 0 == b ==> m <> 0)


; Context: While encoding a query
; While typechecking the top-level declaration `let div`
...
;; def=Prims.fst(402,27-402,88); use=MonadFunctorInference.fst(69,2-70,21)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadFunctorInference.fst(69,2-70,21)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadFunctorInference.fst(69,2-70,21)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(389,19-389,21); use=MonadFunctorInference.fst(69,2-70,21)
(not 
;; def=MonadFunctorInference.fst(69,5-69,10); use=MonadFunctorInference.fst(69,5-69,10)
...
;; def=Prims.fst(413,99-413,120); use=MonadFunctorInference.fst(69,2-70,21)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.bool)

;; def=MonadFunctorInference.fst(69,5-70,21); use=MonadFunctorInference.fst(69,5-70,21)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
@x3)
...
;; def=Prims.fst(686,22-686,28); use=MonadFunctorInference.fst(70,19-70,20)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadFunctorInference.div, 1)
; STATUS: unsat
...
; encoding sigelt let div


; <Start encoding let div>

(declare-fun MonadFunctorInference.div (Term Term) Term)
;;;;;;;;;;;;;;;;n: Prims.int -> m: Prims.int -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_ae5c91f2bddfddb5710964f5fa83e4b0 () Term)
(declare-fun MonadFunctorInference.div@tok () Term)
...
; encoding sigelt let test_opt_monad


; <Start encoding let test_opt_monad>

(declare-fun MonadFunctorInference.test_opt_monad (Term Term Term) Term)
;;;;;;;;;;;;;;;;i: Prims.nat -> j: Prims.nat -> k: Prims.nat -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_6412c5b491652e0ec1df5de01adfeb7d () Term)
(declare-fun MonadFunctorInference.test_opt_monad@tok () Term)




;;;;;;;;;;;;;;;;y: Prims.int -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_d35a343232bbd3568f776882493e21c0 () Term)
(declare-fun Tm_abs_c26662555bd57933c2cca40dcc39c2e8 (Term) Term)


(declare-fun Tm_abs_35a2a61094495cda6512d5a412337b39 (Term Term) Term)


; </end encoding let test_opt_monad>


; encoding sigelt type MonadFunctorInference.functor


; <Start encoding type MonadFunctorInference.functor>

;;;;;;;;;;;;;;;;Constructor
(declare-fun MonadFunctorInference.functor (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun MonadFunctorInference.functor@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun MonadFunctorInference.Mkfunctor (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFunctorInference.Mkfunctor_m (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadFunctorInference.Mkfunctor_fmap (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: MonadFunctorInference.Mkfunctor
(declare-fun MonadFunctorInference.Mkfunctor@tok () Term)
...
;;;;;;;;;;;;;;;;fmap: (_: (_: a -> b) -> _: m a -> m b) -> functor m
(declare-fun Tm_arrow_a36ebae62fa1eccf226eb863eee05c67 () Term)

; <start constructor MonadFunctorInference.functor>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-MonadFunctorInference.functor ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
291)
(exists ((@x0 Term))
 (! (= __@x0
(MonadFunctorInference.functor @x0))
 
;;no pats
:qid is-MonadFunctorInference.functor))))

; </end constructor MonadFunctorInference.functor>


; <start constructor MonadFunctorInference.Mkfunctor>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-MonadFunctorInference.Mkfunctor ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
304)
(= __@x0
(MonadFunctorInference.Mkfunctor (MonadFunctorInference.Mkfunctor_m __@x0)
(MonadFunctorInference.Mkfunctor_fmap __@x0)))))

; </end constructor MonadFunctorInference.Mkfunctor>


; </end encoding type MonadFunctorInference.functor>


; encoding sigelt val MonadFunctorInference.__proj__Mkfunctor__item__fmap


; <Start encoding val MonadFunctorInference.__proj__Mkfunctor__item__fmap>


(declare-fun MonadFunctorInference.__proj__Mkfunctor__item__fmap (Term Term) Term)



;;;;;;;;;;;;;;;;projectee: functor m -> _: (_: a -> b) -> _: m a -> m b
(declare-fun Tm_arrow_9aa27979939965fefd612e862ac0a5b0 () Term)
(declare-fun MonadFunctorInference.__proj__Mkfunctor__item__fmap@tok () Term)



; </end encoding val MonadFunctorInference.__proj__Mkfunctor__item__fmap>


; encoding sigelt let __proj__Mkfunctor__item__fmap


; <Skipped let __proj__Mkfunctor__item__fmap/>


; encoding sigelt let fmap


; <Start encoding let fmap>


(declare-fun MonadFunctorInference.fmap (Term) Term)
...
;;;;;;;;;;;;;;;;{| projectee: functor m |} -> _: (_: a -> b) -> _: m a -> m b
(declare-fun Tm_arrow_b37790625bdaa6a6a6d6dc5937ad7c1f (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: functor m |} -> _: (_: a -> b) -> _: m a -> m b
(declare-fun Tm_arrow_6377f24f99bf63931929e2714eb1bb35 () Term)
(declare-fun MonadFunctorInference.fmap@tok () Term)
...
(declare-fun Tm_abs_085648d1da0061187545d605ef4785ad (Term) Term)
...
(declare-fun MonadFunctorInference.id (Term) Term)

(declare-fun MonadFunctorInference.id@tok () Term)

; </end encoding let id>


; encoding sigelt let id_functor


; <Start encoding let id_functor>

(declare-fun MonadFunctorInference.id_functor (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;f: (_: a -> b) -> _: a -> b
(declare-fun Tm_arrow_177dcc5bfd47aa8b2fb97fd698a6eaf1 () Term)
(declare-fun Tm_abs_cde25e63533dff8be0ec9050afcff13b () Term)

; </end encoding let id_functor>


; encoding sigelt let test_id


; <Start encoding let test_id>

;;;;;;;;;;;;;;;;_: a -> a
(declare-fun Tm_arrow_fcd589b21e6efcf1e5d17b07c282a015 (Term) Term)
(declare-fun MonadFunctorInference.test_id (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> f: (_: a -> a) -> x: id a -> id a
(declare-fun Tm_arrow_e103ec19577fbdb18901faf6480d1aad () Term)
(declare-fun MonadFunctorInference.test_id@tok () Term)



; </end encoding let test_id>
...
; Starting query at MonadFunctorInference.fst(94,0-100,1)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (b: Type) (f: (_: a -> b)) (x: FStar.Pervasives.Native.option a).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post (FStar.Pervasives.Native.option b)).
;     (forall (x: FStar.Pervasives.Native.option b). {:pattern Prims.guard_free (k x)}
...
; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let option_functor`
...
;; def=Prims.fst(402,27-402,88); use=MonadFunctorInference.fst(97,12-99,34)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadFunctorInference.fst(97,12-99,34)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadFunctorInference.fst(97,12-99,34)
(ApplyTT @x4
@x5)
...
;; def=MonadFunctorInference.fst(96,32-96,33); use=MonadFunctorInference.fst(97,18-97,19)
(not 
;; def=MonadFunctorInference.fst(96,32-96,33); use=MonadFunctorInference.fst(97,18-97,19)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x0
@x3))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadFunctorInference.option_functor, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, lemma_FStar.Pervasives.invertOption
