...
; encoding sigelt type Add.additive
...
; encoding sigelt val Add.__proj__Mkadditive__item__zero
...
; encoding sigelt let __proj__Mkadditive__item__zero


; <Skipped let __proj__Mkadditive__item__zero/>


; encoding sigelt val Add.__proj__Mkadditive__item__plus
...
; encoding sigelt let __proj__Mkadditive__item__plus


; <Skipped let __proj__Mkadditive__item__plus/>


; encoding sigelt val Add.__proj__Mkadditive__item__zero_l
...
; encoding sigelt let __proj__Mkadditive__item__zero_l


; <Skipped let __proj__Mkadditive__item__zero_l/>


; encoding sigelt val Add.__proj__Mkadditive__item__zero_r
...
; encoding sigelt let __proj__Mkadditive__item__zero_r


; <Skipped let __proj__Mkadditive__item__zero_r/>


; encoding sigelt val Add.__proj__Mkadditive__item__plus_assoc
...
; encoding sigelt let __proj__Mkadditive__item__plus_assoc


; <Skipped let __proj__Mkadditive__item__plus_assoc/>


; encoding sigelt let zero
...
; encoding sigelt let plus_assoc
...
; Starting query at Add.fst(41,25-41,91)
...
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_b5e807b4621ccabcb9be39d32c543135
;;; Fact-ids: 
(assert (! true
:named tot_fun_Tm_abs_b5e807b4621ccabcb9be39d32c543135))
...
; Encoding query formula : forall (a: Type) (zero: a) (plus: (_: a -> _: a -> a)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (Add.additive a)).
;     (forall (x: a). plus zero x == x) /\ (forall (x: a). plus x zero == x) /\
;     (forall (x: a) (y: a) (z: a). plus (plus x y) z == plus x (plus y z)) /\
;     (forall (pure_result: Add.additive a).
;         pure_result.zero == zero /\ pure_result.plus == plus ==> p pure_result) ==>
;     (forall (x: a).
;         (*  - Could not prove post-condition
; *)
;         forall (p: Prims.pure_post Prims.unit).
;           (forall (pure_result: Prims.unit). plus zero x == x ==> p pure_result) ==>
;           (forall (any_result: Prims.unit). p any_result)) /\
;     (forall (any_result: (x: a -> FStar.Pervasives.Lemma (ensures plus zero x == x))).
;         (forall (x: a).
;             (*  - Could not prove post-condition
; *)
;             forall (p: Prims.pure_post Prims.unit).
;               (forall (pure_result: Prims.unit). plus x zero == x ==> p pure_result) ==>
;               (forall (any_result: Prims.unit). p any_result)) /\
;         (forall (any_result: (x: a -> FStar.Pervasives.Lemma (ensures plus x zero == x))).
;             (forall (x: a) (y: a) (z: a).
;                 (*  - Could not prove post-condition
; *)
;                 forall (p: Prims.pure_post Prims.unit).
;                   (forall (pure_result: Prims.unit).
;                       plus (plus x y) z == plus x (plus y z) ==> p pure_result) ==>
;                   (forall (any_result: Prims.unit). p any_result)) /\
;             (forall (any_result:
;                 (x: a -> y: a -> z: a
;                     -> FStar.Pervasives.Lemma (ensures plus (plus x y) z == plus x (plus y z))))
;                 (any_result: Add.additive a).
;                 any_result == Add.Mkadditive zero plus (fun _ -> ()) (fun _ -> ()) (fun _ _ _ -> ()) ==>
;                 (forall (return_val: Add.additive a). return_val == any_result ==> p return_val))))


; Context: While encoding a query
; While typechecking the top-level declaration `let mkadd`
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post (Add.additive @x0)))

;; def=Add.fst(37,30-37,64); use=Add.fst(41,25-41,91)
(forall ((@x4 Term))
 (! (implies (HasType @x4
@x0)

;; def=Add.fst(37,47-37,63); use=Add.fst(41,25-41,91)
(= (ApplyTT (ApplyTT @x2
@x1)
@x4)
@x4)
...
;; def=Add.fst(38,31-38,65); use=Add.fst(41,25-41,91)
(forall ((@x4 Term))
 (! (implies (HasType @x4
@x0)

;; def=Add.fst(38,48-38,64); use=Add.fst(41,25-41,91)
(= (ApplyTT (ApplyTT @x2
@x4)
@x1)
@x4)
...
;; def=Add.fst(39,31-39,90); use=Add.fst(41,25-41,91)
...
;; def=Add.fst(39,51-39,89); use=Add.fst(41,25-41,91)
(= (ApplyTT (ApplyTT @x2
(ApplyTT (ApplyTT @x2
@x4)
@x5))
...
;; def=Prims.fst(441,36-441,97); use=Add.fst(41,25-41,91)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
(Add.additive @x0)))

;; def=Add.fst(40,39-40,65); use=Add.fst(41,25-41,91)
(or label_2
...
;; def=Add.fst(40,69-40,95); use=Add.fst(41,25-41,91)
(or label_3
...
;; def=Prims.fst(441,83-441,96); use=Add.fst(41,25-41,91)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Add.fst(41,25-41,91)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=Add.fst(41,25-41,91)
(and 
;; def=dummy(0,0-0,0); use=Add.fst(41,25-41,91)
(forall ((@x4 Term))
 (! (implies (HasType @x4
@x0)

;; def=Prims.fst(406,51-406,91); use=Add.fst(41,25-41,91)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=Add.fst(41,56-41,58)
(forall ((@x6 Term))
 (! (implies (and (or label_4
(HasType @x6
Prims.unit))

;; def=Add.fst(24,33-24,51); use=Add.fst(41,56-41,58)
(or label_5
...
;; def=Prims.fst(441,83-441,96); use=Add.fst(41,56-41,58)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Add.fst(41,56-41,58)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(451,66-451,102); use=Add.fst(41,25-41,91)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=Add.fst(41,25-41,91)
(Valid 
;; def=Prims.fst(451,90-451,102); use=Add.fst(41,25-41,91)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(441,36-441,97); use=Add.fst(41,70-41,72)
(forall ((@x7 Term))
 (! (implies (and (or label_6
(HasType @x7
Prims.unit))

;; def=Add.fst(25,33-25,51); use=Add.fst(41,70-41,72)
(or label_7
...
;; def=Prims.fst(441,83-441,96); use=Add.fst(41,70-41,72)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Add.fst(41,70-41,72)
(ApplyTT @x6
@x7)
...
;; def=Prims.fst(441,36-441,97); use=Add.fst(41,88-41,90)
(forall ((@x10 Term))
 (! (implies (and (or label_8
(HasType @x10
Prims.unit))

;; def=Add.fst(27,27-27,67); use=Add.fst(41,88-41,90)
(or label_9
...
;; def=Prims.fst(441,83-441,96); use=Add.fst(41,88-41,90)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Add.fst(41,88-41,90)
(ApplyTT @x9
@x10)
...
;; def=Add.fst(36,21-41,91); use=Add.fst(41,25-41,91)
(= @x7
(Add.Mkadditive @x0
@x1
@x2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Add.mkadd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, proj_equation_Add.Mkadditive_plus, proj_equation_Add.Mkadditive_zero, projection_inverse_Add.Mkadditive_plus, projection_inverse_Add.Mkadditive_zero
...
; Starting query at Add.fst(51,0-51,45)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : (forall (x: Prims.int). 0 + x == x) /\ (forall (x: Prims.int). x + 0 == x) /\
; (forall (x: Prims.int) (y: Prims.int) (z: Prims.int). x + y + z == x + (y + z))


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let add_int`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Add.fst(37,30-39,90); use=Add.fst(51,34-51,39)
(and 
;; def=Add.fst(37,30-37,64); use=Add.fst(51,34-51,39)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)

;; def=Add.fst(37,47-37,63); use=Add.fst(51,34-51,39)
(or label_1
...
;; def=Add.fst(38,31-38,65); use=Add.fst(51,34-51,39)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)

;; def=Add.fst(38,48-38,64); use=Add.fst(51,34-51,39)
(or label_2
...
;; def=Add.fst(39,31-39,90); use=Add.fst(51,34-51,39)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
...
;; def=Add.fst(39,51-39,89); use=Add.fst(51,34-51,39)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Add.add_int, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, int_inversion, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0
...
; Starting query at Add.fst(53,0-53,54)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : (forall (x: Prims.bool). (x || false) == x) /\
; (forall (x: Prims.bool) (y: Prims.bool) (z: Prims.bool). (x || y || z) == (x || (y || z)))


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let add_bool`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Add.fst(37,30-39,90); use=Add.fst(53,36-53,41)
(and 
;; def=Add.fst(38,31-38,65); use=Add.fst(53,36-53,41)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.bool)

;; def=Add.fst(38,48-38,64); use=Add.fst(53,36-53,41)
(or label_1
...
;; def=Add.fst(39,31-39,90); use=Add.fst(53,36-53,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.bool)
(HasType @x1
...
;; def=Add.fst(39,51-39,89); use=Add.fst(53,36-53,41)
(or label_2

;; def=Add.fst(39,51-39,89); use=Add.fst(53,36-53,41)
(= (Prims.op_BarBar (Prims.op_BarBar @x0
@x1)
@x2)
(Prims.op_BarBar @x0
(Prims.op_BarBar @x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Add.add_bool, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, bool_inversion, bool_typing, primitive_Prims.op_BarBar, projection_inverse_BoxBool_proj_0
...
; Starting query at Add.fst(57,2-58,58)
...
;   (*  - Could not prove post-condition
; *)
;   forall (l1: Prims.list a) (l2: Prims.list a) (l3: Prims.list a) (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). (l1 @ l2) @ l3 == l1 @ l2 @ l3 ==> p pure_result) ==>
;     (forall (pure_result: Prims.unit). l1 @ l2 @ l3 == (l1 @ l2) @ l3 ==> p pure_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let add_list`
...
;; def=dummy(0,0-0,0); use=Add.fst(58,46-58,58)
...
;; def=Prims.fst(441,36-441,97); use=Add.fst(58,46-58,58)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=Add.fst(27,27-27,67); use=Add.fst(58,46-58,58)
(= (FStar.List.Tot.Base.op_At @x0
(FStar.List.Tot.Base.op_At @x0
@x1
@x2)
...
;; def=Prims.fst(441,83-441,96); use=Add.fst(58,46-58,58)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Add.fst(58,46-58,58)
(ApplyTT @x4
@x5)
...
;; def=FStar.List.Tot.Properties.fsti(135,17-135,47); use=Add.fst(58,46-58,58)
(= (FStar.List.Tot.Base.op_At @x0
@x1
(FStar.List.Tot.Base.op_At @x0
@x2
...
; Starting query at Add.fst(61,0-61,29)
...
; Encoding query formula : Add.plus 1 2 = 3
...
;;; Fact-ids: 
(assert (! (not 
;; def=Add.fst(61,15-61,29); use=Add.fst(61,8-61,14)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Add.uu___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, equation_Add.add_int, equation_Add.mkadd, equation_Add.plus, function_token_typing_Prims.__cache_version_number__, interpretation_Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e, primitive_Prims.op_Addition, projection_inverse_Add.Mkadditive_plus, projection_inverse_BoxInt_proj_0, token_correspondence_Add.plus, token_correspondence_Prims.op_Addition
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Add.add_bool; Namespace Add
(assert (! 
;; def=Add.fst(53,9-53,17); use=Add.fst(53,9-53,17)
(forall ((@u0 Dummy_sort))
 (! (HasType (Add.add_bool @u0)
(Add.additive Prims.bool))
 

:pattern ((Add.add_bool @u0))
:qid typing_Add.add_bool))

:named typing_Add.add_bool))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Prims.op_BarBar; Namespace Prims
(assert (! 
;; def=Prims.fst(528,4-528,13); use=Prims.fst(528,4-528,13)
...
:qid equation_Add.add_bool))

:named equation_Add.add_bool))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Add.add_bool; Namespace Add
(assert (! (Valid (ApplyTT __uu__PartialApp
Prims.op_BarBar@tok))
:named @kick_partial_app_2908c1a80df0aa3928920b8f5e7b821f))
(push) ;; push{2

; Starting query at Add.fst(62,0-62,41)
...
; Encoding query formula : Add.plus false false = false
...
;;; Fact-ids: 
(assert (! (not 
;; def=Add.fst(62,15-62,41); use=Add.fst(62,8-62,14)
(or label_1

;; def=Add.fst(62,15-62,41); use=Add.fst(62,8-62,14)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Add.plus@tok
Prims.bool)
(Add.add_bool Dummy_value))
(BoxBool false))
(BoxBool false))
(BoxBool false))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Add.uu___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Add.add_bool, equation_Add.mkadd, equation_Add.plus, interpretation_Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e, primitive_Prims.op_BarBar, projection_inverse_Add.Mkadditive_plus, projection_inverse_BoxBool_proj_0, token_correspondence_Add.plus, token_correspondence_Prims.op_BarBar
...
; Starting query at Add.fst(63,0-63,39)
...
; Encoding query formula : Add.plus true false = true
...
;;; Fact-ids: 
(assert (! (not 
;; def=Add.fst(63,15-63,39); use=Add.fst(63,8-63,14)
(or label_1
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Add.add_list; Namespace Add
(assert (! 
;; def=Add.fst(55,9-55,17); use=Add.fst(55,9-55,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Add.add_list @x0)
(Add.additive (Prims.list @x0))))
 

:pattern ((Add.add_list @x0))
:qid typing_Add.add_list))

:named typing_Add.add_list))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name FStar.List.Tot.Base.op_At; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(124,4-124,9); use=FStar.List.Tot.Base.fst(124,4-124,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT FStar.List.Tot.Base.op_At@tok
@x0)
@x1)
@x2)
(FStar.List.Tot.Base.op_At @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT FStar.List.Tot.Base.op_At@tok
@x0)
@x1)
@x2))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c
;;; Fact-ids: Name FStar.List.Tot.Base.rev_acc; Namespace FStar.List.Tot.Base
(assert (! (HasType Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c
Tm_type)
:named kinding_Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name FStar.List.Tot.Base.op_At; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(124,4-124,9); use=FStar.List.Tot.Base.fst(124,4-124,9)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.List.Tot.Base.op_At@tok
Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c))
...
@x2)
@x3)
(FStar.List.Tot.Base.op_At @x1
@x2
@x3))
 

:pattern ((FStar.List.Tot.Base.op_At @x1
@x2
@x3))
:qid function_token_typing_FStar.List.Tot.Base.op_At.1))
)
...
;;;;;;;;;;;;;;;;Equation for Add.add_list
;;; Fact-ids: Name Add.add_list; Namespace Add
(assert (! 
;; def=Add.fst(55,9-55,17); use=Add.fst(55,9-55,17)
(forall ((@x0 Term))
 (! (= (Add.add_list @x0)
(Add.Mkadditive (Prims.list @x0)
(Prims.Nil @x0)
(ApplyTT FStar.List.Tot.Base.op_At@tok
@x0)
(ApplyTT FStar.List.Tot.Properties.append_nil_l@tok
@x0)
(ApplyTT FStar.List.Tot.Properties.append_l_nil@tok
@x0)
(ApplyTT FStar.List.Tot.Properties.append_assoc@tok
@x0)))
 

:pattern ((Add.add_list @x0))
:qid equation_Add.add_list))

:named equation_Add.add_list))
;;;;;;;;;;;;;;;;b2t typing
...
@x1
Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c))
:qid FStar.List.Tot.Base_pre_typing_Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c))

:named FStar.List.Tot.Base_pre_typing_Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c
;;; Fact-ids: Name FStar.List.Tot.Base.rev_acc; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(107,13-107,48); use=FStar.List.Tot.Base.fst(108,8-108,15)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c.2))
...
@x1)
@x2))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c))

:named FStar.List.Tot.Base_interpretation_Tm_arrow_54e38bdd456bab4cdb32b5d540c2274c))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Add.add_list; Namespace Add
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.List.Tot.Properties.append_l_nil@tok))
:named @kick_partial_app_ee58d70b2d239193a31056edbc8a1e80))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Add.add_list; Namespace Add
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.List.Tot.Properties.append_assoc@tok))
:named @kick_partial_app_449a8fe54fc10adda1238c4beeda7013))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Add.add_list; Namespace Add
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.List.Tot.Base.op_At@tok))
...
;;; Fact-ids: Name Add.add_list; Namespace Add
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.List.Tot.Properties.append_nil_l@tok))
:named @kick_partial_app_30bfd856494822a51b5d9d87fa596db8))
(push) ;; push{2

; Starting query at Add.fst(64,0-64,37)
...
; Encoding query formula : Prims.hasEq (Prims.list Prims.int) /\
; (forall (return_val: Prims.eqtype).
;     return_val == Prims.list Prims.int ==>
;     (forall (any_result: Prims.bool).
;         Add.plus [1] [2] = [1; 2] == any_result ==>
;         (forall (any_result: Prims.logical).
;             Add.plus [1] [2] = [1; 2] == any_result ==> Add.plus [1] [2] = [1; 2])))
...
(and 
;; def=Prims.fst(73,23-73,30); use=Add.fst(64,29-64,30)
(or label_1
...
;; def=Prims.fst(180,10-180,11); use=Prims.fst(180,10-180,11)
(= (Prims.op_Equality (Prims.list Prims.int)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Add.plus@tok
(Prims.list Prims.int))
(Add.add_list Prims.int))
...
(= (Prims.b2t (Prims.op_Equality (Prims.list Prims.int)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Add.plus@tok
(Prims.list Prims.int))
(Add.add_list Prims.int))
(Prims.Cons Prims.int
...
;; def=Add.fst(64,15-64,37); use=Add.fst(64,8-64,14)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Add.uu___3, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_FStar.List.Tot.Base.append.fuel_instrumented, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, assumption_Prims.list__uu___haseq, constructor_distinct_Prims.Cons, constructor_distinct_Prims.Nil, data_elim_Add.Mkadditive, data_typing_intro_Prims.Cons@tok, equation_Add.add_list, equation_Add.plus, equation_FStar.List.Tot.Base.op_At, equation_Prims.eqtype, equation_with_fuel_FStar.List.Tot.Base.append.fuel_instrumented, function_token_typing_Prims.__cache_version_number__, int_typing, interpretation_Tm_abs_02fabfb7065cb4bfb39d0ca2f7a9802e, projection_inverse_Add.Mkadditive_plus, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, projection_inverse_Prims.Nil_a, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, token_correspondence_Add.plus, token_correspondence_FStar.List.Tot.Base.op_At, typing_Add.add_list, typing_Prims.int
