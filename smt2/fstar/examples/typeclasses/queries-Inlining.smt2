...
; Internals for Inlining


; encoding sigelt type Inlining.inhab


; <Start encoding type Inlining.inhab>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Inlining.inhab (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Inlining.inhab@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Inlining.Mkinhab (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Inlining.Mkinhab_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Inlining.Mkinhab_elem (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Inlining.Mkinhab
(declare-fun Inlining.Mkinhab@tok () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> a
(declare-fun Tm_arrow_f733943e720921049fb5d7431c9f04d2 (Term) Term)

;;;;;;;;;;;;;;;;elem: (_: Prims.unit -> a) -> inhab a
(declare-fun Tm_arrow_d2c674706a198689f00eab61ec694e42 () Term)

; <start constructor Inlining.inhab>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Inlining.inhab ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-Inlining.inhab))))

; </end constructor Inlining.inhab>


; <start constructor Inlining.Mkinhab>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Inlining.Mkinhab ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
113)
(= __@x0
(Inlining.Mkinhab (Inlining.Mkinhab_a __@x0)
(Inlining.Mkinhab_elem __@x0)))))

; </end constructor Inlining.Mkinhab>


; </end encoding type Inlining.inhab>


; encoding sigelt val Inlining.__proj__Mkinhab__item__elem


; <Start encoding val Inlining.__proj__Mkinhab__item__elem>

(declare-fun Inlining.__proj__Mkinhab__item__elem (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: inhab a -> _: Prims.unit -> a
(declare-fun Tm_arrow_fd913aebd89672f5a7a68fbfc65754ab () Term)
(declare-fun Inlining.__proj__Mkinhab__item__elem@tok () Term)


; </end encoding val Inlining.__proj__Mkinhab__item__elem>


; encoding sigelt let __proj__Mkinhab__item__elem


; <Skipped let __proj__Mkinhab__item__elem/>
...
(declare-fun Inlining.elem (Term) Term)

;;;;;;;;;;;;;;;;{| projectee: inhab a |} -> _: Prims.unit -> a
(declare-fun Tm_arrow_7107eef66b087dcb5a680d3a65455b87 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: inhab a |} -> _: Prims.unit -> a
(declare-fun Tm_arrow_33693973e01fa53f9bbc592c1d23c0e3 () Term)
(declare-fun Inlining.elem@tok () Term)




(declare-fun Tm_abs_7f97bd358c42c2a5845011ff9e67dfed (Term) Term)
...
(declare-fun Inlining.elem_ (Term Term) Term)


(declare-fun Inlining.elem_@tok () Term)


; </end encoding let elem'>


; encoding sigelt let inhab_unit


; <Start encoding let inhab_unit>

(declare-fun Inlining.inhab_unit (Dummy_sort) Term)

(declare-fun Tm_abs_f9d8fefdf398b52e5a533ad11136108e () Term)

; </end encoding let inhab_unit>
...
(declare-fun Inlining.f (Term) Term)

(declare-fun Inlining.f@tok () Term)

; </end encoding let f>


; encoding sigelt #push-options "--tcnorm false"


; <Skipped #push-options "--tcnorm false"/>
...
; Starting query at Inlining.fst(51,21-53,27)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u163: Prims.unit). (*  - Could not prove post-condition
; *) forall (y: Prims.int). y == 1


; Context: While encoding a query
; While typechecking the top-level declaration `let f_fail`
; While typechecking the top-level declaration `[@@expect_failure] let f_fail`
...
;; def=Inlining.fst(53,9-53,27); use=Inlining.fst(53,9-53,27)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)

;; def=Inlining.fst(53,20-53,26); use=Inlining.fst(53,20-53,26)
(or label_1
