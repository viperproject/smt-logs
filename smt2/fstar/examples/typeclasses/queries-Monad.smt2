...
; Externals for module Functor


; <Start encoding type Functor.functor>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Functor.functor (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Functor.functor@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Functor.Mkfunctor (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Functor.Mkfunctor_f (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Functor.Mkfunctor_fmap (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Functor.Mkfunctor
(declare-fun Functor.Mkfunctor@tok () Term)



;;;;;;;;;;;;;;;;_: (_: a -> b) -> _: f a -> f b
(declare-fun Tm_arrow_c065714a7cbb31e737f30cc3daa43df9 (Term) Term)



;;;;;;;;;;;;;;;;fmap: (_: (_: a -> b) -> _: f a -> f b) -> functor f
(declare-fun Tm_arrow_794ba86c6d6c269e52db357a24e04ee3 () Term)

; <start constructor Functor.functor>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Functor.functor ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
103)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-Functor.functor))))

; </end constructor Functor.functor>


; <start constructor Functor.Mkfunctor>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Functor.Mkfunctor ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
(Functor.Mkfunctor (Functor.Mkfunctor_f __@x0)
(Functor.Mkfunctor_fmap __@x0)))))

; </end constructor Functor.Mkfunctor>


; </end encoding type Functor.functor>


; <Start encoding val Functor.__proj__Mkfunctor__item__fmap>


(declare-fun Functor.__proj__Mkfunctor__item__fmap (Term Term) Term)



;;;;;;;;;;;;;;;;projectee: functor f -> _: (_: a -> b) -> _: f a -> f b
(declare-fun Tm_arrow_c17dfa2bb0d63206431c4a192bb5701f () Term)
(declare-fun Functor.__proj__Mkfunctor__item__fmap@tok () Term)



; </end encoding val Functor.__proj__Mkfunctor__item__fmap>


; <Skipped let __proj__Mkfunctor__item__fmap/>


; <Start encoding let fmap>


(declare-fun Functor.fmap (Term) Term)


;;;;;;;;;;;;;;;;_: f a -> f b
(declare-fun Tm_arrow_f95975a3cfa89a709bb86112d7c7b726 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: (_: a -> b) -> _: f a -> f b
(declare-fun Tm_arrow_0dfd3107c2a63c765323c2ad9aec9f6f (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: (_: a -> b) -> _: f a -> f b
(declare-fun Tm_arrow_69337175ded3c4266df4df2333f2bdf1 (Term Term) Term)
;;;;;;;;;;;;;;;;_: (_: a -> b) -> _: f a -> f b
(declare-fun Tm_arrow_95b5f2e3902c8da3ec709ee518a46918 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: functor f |} -> _: (_: a -> b) -> _: f a -> f b
(declare-fun Tm_arrow_5d0850ca559dd92cbbe5cce50f7e609d (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: functor f |} -> _: (_: a -> b) -> _: f a -> f b
(declare-fun Tm_arrow_5d870b26c9a623ea692d9eafc128aa7a () Term)
(declare-fun Functor.fmap@tok () Term)
...
(declare-fun Tm_abs_557ee0639295006fe1ae4970cba83f16 (Term) Term)

; </end encoding let fmap>


; <Start encoding let functor_list>

(declare-fun Functor.functor_list (Dummy_sort) Term)



; </end encoding let functor_list>


; <Start encoding let functor_id>

(declare-fun Functor.functor_id (Dummy_sort) Term)
...
(declare-fun Tm_abs_416713a7b243078aaabd12aebd8ce147 () Term)

; </end encoding let functor_id>
...
(declare-fun Functor.compose (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;t1: (_: _ -> _) -> t2: (_: _ -> _) -> x: _ -> _
(declare-fun Tm_arrow_0e671300b027a382c3ad8af661e6bfe8 () Term)
(declare-fun Functor.compose@tok () Term)
...
(declare-fun Functor.comp (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;_: functor ff -> _: functor gg -> functor (compose ff gg)
(declare-fun Tm_arrow_7eced138241d6f7d106c6050950a792f () Term)
(declare-fun Functor.comp@tok () Term)




(declare-fun Tm_abs_06d1eede69d54c94738265bb5a3426e5 (Term Term) Term)



;;;;;;;;;;;;;;;;f: (_: a -> b) -> x: ff (gg a) -> ff (gg b)
(declare-fun Tm_arrow_e2168142222dfa3d88949cb1f0fff826 (Term Term) Term)
(declare-fun Tm_abs_c3c1060309f4788b4a3d2cbad910998a (Term Term Term Term) Term)

; </end encoding let comp>


; <Start encoding let t1>

(declare-fun Functor.t1 (Dummy_sort) Term)


(declare-fun Tm_abs_b0ccd7de28a6672e541735f7bc00b394 () Term)


; </end encoding let t1>


; <Start encoding let t2>

(declare-fun Functor.t2 (Dummy_sort) Term)
...
(declare-fun Functor.fmap_ (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;{| _: functor f |} -> g: (_: a -> b) -> x: f a -> f b
(declare-fun Tm_arrow_ed7c0a82f15ac6a6622ff9a028450f78 () Term)
(declare-fun Functor.fmap_@tok () Term)
...
; End Externals for module Functor
...
; encoding sigelt type Monad.monad_laws


; <Start encoding type Monad.monad_laws>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Monad.monad_laws (Term Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Monad.monad_laws@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Monad.Mkmonad_laws (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Monad.Mkmonad_laws_m (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Monad.Mkmonad_laws_return (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Monad.Mkmonad_laws_bind (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Monad.Mkmonad_laws_idL (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Monad.Mkmonad_laws_idR (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Monad.Mkmonad_laws_assoc (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Monad.Mkmonad_laws
(declare-fun Monad.Mkmonad_laws@tok () Term)
...
(declare-fun Tm_refine_933b648d18b593f5ba5ea49e6611349c (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> f: (_: a -> m b) -> FStar.Pervasives.Lemma (ensures bind (return x) f == f x)
(declare-fun Tm_arrow_826caaf1f5a068be489ec69d8e350705 (Term Term Term) Term)
(declare-fun Tm_refine_6f526a89acef290c6d9f3eef07afb17f (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: m a -> FStar.Pervasives.Lemma (ensures bind x return == x)
...
(declare-fun Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b (Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: m a -> f: (_: a -> m b) -> g: (_: b -> m c)   -> FStar.Pervasives.Lemma (ensures bind (bind x f) g == bind x (fun y -> bind (f y) g))
(declare-fun Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 (Term Term) Term)
...
;;;;;;;;;;;;;;;;idL: (x: a -> f: (_: a -> m b) -> FStar.Pervasives.Lemma (ensures bind (return x) f == f x)) ->     idR: (x: m a -> FStar.Pervasives.Lemma (ensures bind x return == x)) ->     assoc:       (x: m a -> f: (_: a -> m b) -> g: (_: b -> m c)           -> FStar.Pervasives.Lemma (ensures bind (bind x f) g == bind x (fun y -> bind (f y) g)))   -> monad_laws m return bind
(declare-fun Tm_arrow_c66221c2be7d59a1a6299067818ad793 () Term)

; <start constructor Monad.monad_laws>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Monad.monad_laws ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
112)
(exists ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= __@x0
...
;;no pats
:qid is-Monad.monad_laws))))

; </end constructor Monad.monad_laws>


; <start constructor Monad.Mkmonad_laws>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Monad.Mkmonad_laws ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
144)
(= __@x0
(Monad.Mkmonad_laws (Monad.Mkmonad_laws_m __@x0)
(Monad.Mkmonad_laws_return __@x0)
(Monad.Mkmonad_laws_bind __@x0)
(Monad.Mkmonad_laws_idL __@x0)
(Monad.Mkmonad_laws_idR __@x0)
(Monad.Mkmonad_laws_assoc __@x0)))))

; </end constructor Monad.Mkmonad_laws>


; </end encoding type Monad.monad_laws>


; encoding sigelt val Monad.__proj__Mkmonad_laws__item__idL


; <Start encoding val Monad.__proj__Mkmonad_laws__item__idL>





(declare-fun Monad.__proj__Mkmonad_laws__item__idL (Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;projectee: monad_laws m return bind -> x: a -> f: (_: a -> m b)   -> FStar.Pervasives.Lemma (ensures bind (return x) f == f x)
(declare-fun Tm_arrow_5c84a0c2e603982725c8fe2baa351cc3 () Term)
(declare-fun Monad.__proj__Mkmonad_laws__item__idL@tok () Term)




; </end encoding val Monad.__proj__Mkmonad_laws__item__idL>


; encoding sigelt let __proj__Mkmonad_laws__item__idL


; <Skipped let __proj__Mkmonad_laws__item__idL/>


; encoding sigelt val Monad.__proj__Mkmonad_laws__item__idR


; <Start encoding val Monad.__proj__Mkmonad_laws__item__idR>





(declare-fun Monad.__proj__Mkmonad_laws__item__idR (Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;projectee: monad_laws m return bind -> x: m a -> FStar.Pervasives.Lemma (ensures bind x return == x)
(declare-fun Tm_arrow_66bb8caf0101774614eb200e96bf2cbb () Term)
(declare-fun Monad.__proj__Mkmonad_laws__item__idR@tok () Term)



; </end encoding val Monad.__proj__Mkmonad_laws__item__idR>


; encoding sigelt let __proj__Mkmonad_laws__item__idR


; <Skipped let __proj__Mkmonad_laws__item__idR/>


; encoding sigelt val Monad.__proj__Mkmonad_laws__item__assoc


; <Start encoding val Monad.__proj__Mkmonad_laws__item__assoc>





(declare-fun Monad.__proj__Mkmonad_laws__item__assoc (Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;projectee: monad_laws m return bind -> x: m a -> f: (_: a -> m b) -> g: (_: b -> m c)   -> FStar.Pervasives.Lemma (ensures bind (bind x f) g == bind x (fun y -> bind (f y) g))
(declare-fun Tm_arrow_5657676d4e172fc53c9c081eec4acd31 () Term)
(declare-fun Monad.__proj__Mkmonad_laws__item__assoc@tok () Term)
...
; </end encoding val Monad.__proj__Mkmonad_laws__item__assoc>


; encoding sigelt let __proj__Mkmonad_laws__item__assoc


; <Skipped let __proj__Mkmonad_laws__item__assoc/>


; encoding sigelt type Monad.monad


; <Start encoding type Monad.monad>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Monad.monad (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Monad.monad@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Monad.Mkmonad (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Monad.Mkmonad_m (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Monad.Mkmonad_return (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Monad.Mkmonad_bind (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Monad.Mkmonad_laws (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Monad.Mkmonad
(declare-fun Monad.Mkmonad@tok () Term)
...
;;;;;;;;;;;;;;;;return: (_: a -> m a) -> bind: (_: m a -> _: (_: a -> m b) -> m b) -> laws: monad_laws m return bind   -> monad m
(declare-fun Tm_arrow_2ffcff03e8b958f9557d6349d77281a5 () Term)

; <start constructor Monad.monad>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Monad.monad ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
263)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor Monad.monad>


; <start constructor Monad.Mkmonad>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Monad.Mkmonad ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
278)
(= __@x0
(Monad.Mkmonad (Monad.Mkmonad_m __@x0)
(Monad.Mkmonad_return __@x0)
(Monad.Mkmonad_bind __@x0)
(Monad.Mkmonad_laws __@x0)))))

; </end constructor Monad.Mkmonad>


; </end encoding type Monad.monad>


; encoding sigelt val Monad.__proj__Mkmonad__item__return


; <Start encoding val Monad.__proj__Mkmonad__item__return>


(declare-fun Monad.__proj__Mkmonad__item__return (Term Term) Term)


;;;;;;;;;;;;;;;;projectee: monad m -> _: a -> m a
(declare-fun Tm_arrow_652cb631c827d14e874241f18577d114 () Term)
(declare-fun Monad.__proj__Mkmonad__item__return@tok () Term)


; </end encoding val Monad.__proj__Mkmonad__item__return>


; encoding sigelt let __proj__Mkmonad__item__return


; <Skipped let __proj__Mkmonad__item__return/>


; encoding sigelt val Monad.__proj__Mkmonad__item__bind


; <Start encoding val Monad.__proj__Mkmonad__item__bind>


(declare-fun Monad.__proj__Mkmonad__item__bind (Term Term) Term)



;;;;;;;;;;;;;;;;projectee: monad m -> _: m a -> _: (_: a -> m b) -> m b
(declare-fun Tm_arrow_04261eddc9b40c4cf9088803b730a42c () Term)
(declare-fun Monad.__proj__Mkmonad__item__bind@tok () Term)



; </end encoding val Monad.__proj__Mkmonad__item__bind>


; encoding sigelt let __proj__Mkmonad__item__bind


; <Skipped let __proj__Mkmonad__item__bind/>


; encoding sigelt val Monad.__proj__Mkmonad__item__laws


; <Start encoding val Monad.__proj__Mkmonad__item__laws>


(declare-fun Monad.__proj__Mkmonad__item__laws (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: monad m -> monad_laws m projectee.return projectee.bind
(declare-fun Tm_arrow_4902b80759e9ad61d4b7d9f0183321c6 () Term)
(declare-fun Monad.__proj__Mkmonad__item__laws@tok () Term)

; </end encoding val Monad.__proj__Mkmonad__item__laws>


; encoding sigelt let __proj__Mkmonad__item__laws


; <Skipped let __proj__Mkmonad__item__laws/>
...
(declare-fun Monad.return (Term) Term)

;;;;;;;;;;;;;;;;_: a -> m a
(declare-fun Tm_arrow_8c46a296e41552271b43886f97a4b7b1 (Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> m a
(declare-fun Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monad m |} -> _: a -> m a
(declare-fun Tm_arrow_403631340cf419d370f9eb39963c3cb0 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monad m |} -> _: a -> m a
(declare-fun Tm_arrow_8f1d51e3dfafe2c5703a947539599744 () Term)
(declare-fun Monad.return@tok () Term)
...
(declare-fun Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8 (Term) Term)
...
(declare-fun Monad.bind (Term) Term)


;;;;;;;;;;;;;;;;_: (_: a -> m b) -> m b
(declare-fun Tm_arrow_f528ff54ee63a89d1c18ddac5d069566 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: m a -> _: (_: a -> m b) -> m b
(declare-fun Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: m a -> _: (_: a -> m b) -> m b
(declare-fun Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02 (Term Term) Term)
;;;;;;;;;;;;;;;;_: m a -> _: (_: a -> m b) -> m b
(declare-fun Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monad m |} -> _: m a -> _: (_: a -> m b) -> m b
(declare-fun Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monad m |} -> _: m a -> _: (_: a -> m b) -> m b
(declare-fun Tm_arrow_9e575de7a70ba4ac266a6d63979096d4 () Term)
(declare-fun Monad.bind@tok () Term)
...
(declare-fun Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e (Term) Term)

; </end encoding let bind>


; encoding sigelt let laws


; <Start encoding let laws>


(declare-fun Monad.laws (Term) Term)

;;;;;;;;;;;;;;;;{| projectee: monad m |} -> monad_laws m projectee.return projectee.bind
(declare-fun Tm_arrow_463f4b231baa47197f837c43dcbd4d32 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: monad m |} -> monad_laws m projectee.return projectee.bind
(declare-fun Tm_arrow_215fff3790471cc4bc04720846f09d67 () Term)
(declare-fun Monad.laws@tok () Term)



(declare-fun Tm_abs_317fae54d26665d1c9442d6b5e1940e5 (Term) Term)

; </end encoding let laws>
...
(declare-fun Monad.f (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;{| _: monad m |} -> x: m (_: a -> b) -> y: m a -> m b
(declare-fun Tm_arrow_9ce78933d40b50fd550ecbaad093ebb7 () Term)
(declare-fun Monad.f@tok () Term)





(declare-fun Tm_abs_5649b1dc06ef718014a5c0ac24eacd9a (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: (_: a -> b) -> m b
(declare-fun Tm_arrow_8d960ce3ab6cbb188de0a10a19926e00 (Term Term Term) Term)
(declare-fun Tm_abs_9f709c578020abc2f1ce0de8a77c9592 (Term Term Term Term Term) Term)
...
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(37,28-37,40); use=Monad.fst(36,4-36,9)
...
;;;;;;;;;;;;;;;;typing_Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(42,2-42,6); use=Monad.fst(42,2-42,6)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e @x0)
(Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8 @x0))
 

:pattern ((Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e @x0))
:qid typing_Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e))

:named typing_Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e))
;;;;;;;;;;;;;;;;typing_Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=Monad.fst(41,2-41,8); use=Monad.fst(41,2-41,8)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8 @x0)
(Tm_arrow_403631340cf419d370f9eb39963c3cb0 @x0))
 

:pattern ((Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8 @x0))
:qid typing_Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8))

:named typing_Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
(HasType (Monad.return @x0)
(Tm_arrow_403631340cf419d370f9eb39963c3cb0 @x0)))
 

:pattern ((Monad.return @x0))
:qid typing_Monad.return))
:named typing_Monad.return))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (Monad.bind @x0)
(Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8 @x0)))
 

:pattern ((Monad.bind @x0))
:qid typing_Monad.bind))
:named typing_Monad.bind))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__return; Namespace Monad
(assert (! 
;; def=Monad.fst(41,2-41,8); use=Monad.fst(41,2-41,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Monad.monad @x0)))
(HasType (Monad.__proj__Mkmonad__item__return @x0
@x1)
(Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c @x0)))
 

:pattern ((Monad.__proj__Mkmonad__item__return @x0
@x1))
:qid typing_Monad.__proj__Mkmonad__item__return))

:named typing_Monad.__proj__Mkmonad__item__return))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__bind; Namespace Monad
(assert (! 
;; def=Monad.fst(42,2-42,6); use=Monad.fst(42,2-42,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Monad.monad @x0)))
(HasType (Monad.__proj__Mkmonad__item__bind @x0
@x1)
(Tm_arrow_fe96ea64440933a872257514e1912843 @x0)))
 

:pattern ((Monad.__proj__Mkmonad__item__bind @x0
@x1))
:qid typing_Monad.__proj__Mkmonad__item__bind))

:named typing_Monad.__proj__Mkmonad__item__bind))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT Monad.return@tok
@x0)
(Monad.return @x0))
 

:pattern ((ApplyTT Monad.return@tok
@x0))
:qid token_correspondence_Monad.return))
:named token_correspondence_Monad.return))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Monad.monad_laws@tok
@x0)
@x1)
@x2)
(Monad.monad_laws @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Monad.monad_laws@tok
@x0)
@x1)
@x2))

:pattern ((Monad.monad_laws @x0
@x1
@x2))
:qid token_correspondence_Monad.monad_laws@tok))

:named token_correspondence_Monad.monad_laws@tok))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
(forall ((@x0 Term))
 (! (= (ApplyTT Monad.monad@tok
@x0)
(Monad.monad @x0))
 

:pattern ((ApplyTT Monad.monad@tok
@x0))

:pattern ((Monad.monad @x0))
:qid token_correspondence_Monad.monad@tok))

:named token_correspondence_Monad.monad@tok))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! (forall ((@x0 Term))
 (! (= (ApplyTT Monad.bind@tok
@x0)
(Monad.bind @x0))
 

:pattern ((ApplyTT Monad.bind@tok
@x0))
:qid token_correspondence_Monad.bind))
:named token_correspondence_Monad.bind))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__return; Namespace Monad
(assert (! 
;; def=Monad.fst(41,2-41,8); use=Monad.fst(41,2-41,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Monad.__proj__Mkmonad__item__return@tok
@x0)
@x1)
(Monad.__proj__Mkmonad__item__return @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Monad.__proj__Mkmonad__item__return@tok
@x0)
@x1))
:qid token_correspondence_Monad.__proj__Mkmonad__item__return))

:named token_correspondence_Monad.__proj__Mkmonad__item__return))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__bind; Namespace Monad
(assert (! 
;; def=Monad.fst(42,2-42,6); use=Monad.fst(42,2-42,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Monad.__proj__Mkmonad__item__bind@tok
@x0)
@x1)
(Monad.__proj__Mkmonad__item__bind @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Monad.__proj__Mkmonad__item__bind@tok
@x0)
@x1))
:qid token_correspondence_Monad.__proj__Mkmonad__item__bind))

:named token_correspondence_Monad.__proj__Mkmonad__item__bind))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
...
@x8
@x9)))
:qid subterm_ordering_Monad.Mkmonad_laws))

:named subterm_ordering_Monad.Mkmonad_laws))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
...
@x4)
(Monad.monad @x5)))
:qid subterm_ordering_Monad.Mkmonad))

:named subterm_ordering_Monad.Mkmonad))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(36,4-37,42); use=Monad.fst(36,4-37,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (HasType (Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b @x0
@x1
@x2
@x3
@x4
...
@x7)
Tm_type))
:qid refinement_kinding_Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b))

:named refinement_kinding_Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(33,50-33,82); use=Monad.fst(33,50-33,82)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (HasType (Tm_refine_933b648d18b593f5ba5ea49e6611349c @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_933b648d18b593f5ba5ea49e6611349c @x0
@x1
@x2
@x3
@x4
@x5)
Tm_type))
:qid refinement_kinding_Tm_refine_933b648d18b593f5ba5ea49e6611349c))

:named refinement_kinding_Tm_refine_933b648d18b593f5ba5ea49e6611349c))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(34,28-34,54); use=Monad.fst(34,28-34,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b @x2
@x3
@x4
@x5
@x6
...
;; def=Prims.fst(635,71-635,97); use=Monad.fst(36,4-37,42)
(not 
;; def=Prims.fst(441,29-441,97); use=Monad.fst(36,4-36,9)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=Monad.fst(36,10-37,42); use=Monad.fst(36,4-36,9)
...
@x4)
@x6)
(Tm_abs_ee660f2b85638cf061c69b2816eebf0d @x2
@x3
@x7
@x8
@x4
...
;; def=Prims.fst(635,86-635,95); use=Monad.fst(36,4-37,42)
(not 
;; def=Prims.fst(635,86-635,95); use=Monad.fst(36,4-37,42)
(= @x10
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b.1))
)
))
...
@x8
@x9)))
:qid refinement_interpretation_Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b))

:named refinement_interpretation_Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(33,50-33,82); use=Monad.fst(33,50-33,82)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_933b648d18b593f5ba5ea49e6611349c @x2
@x3
@x4
@x5
@x6
...
;; def=Prims.fst(635,71-635,97); use=Monad.fst(33,50-33,82)
(not 
;; def=Prims.fst(441,29-441,97); use=Monad.fst(33,50-33,55)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=Monad.fst(33,56-33,82); use=Monad.fst(33,50-33,55)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x2
@x3)
@x4)
(ApplyTT (ApplyTT @x5
...
;; def=Prims.fst(635,86-635,95); use=Monad.fst(33,50-33,82)
(not 
;; def=Prims.fst(635,86-635,95); use=Monad.fst(33,50-33,82)
(= @x8
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_933b648d18b593f5ba5ea49e6611349c.1))
)
))
...
@x6
@x7)))
:qid refinement_interpretation_Tm_refine_933b648d18b593f5ba5ea49e6611349c))

:named refinement_interpretation_Tm_refine_933b648d18b593f5ba5ea49e6611349c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
...
;; def=Prims.fst(635,71-635,97); use=Monad.fst(34,28-34,54)
(not 
;; def=Prims.fst(441,29-441,97); use=Monad.fst(34,28-34,33)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=Monad.fst(34,34-34,54); use=Monad.fst(34,28-34,33)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x2
@x3)
@x3)
@x4)
...
;; def=Prims.fst(635,86-635,95); use=Monad.fst(34,28-34,54)
(not 
;; def=Prims.fst(635,86-635,95); use=Monad.fst(34,28-34,54)
(= @x6
@x1)
...
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Monad.Mkmonad_return (Monad.Mkmonad @x0
@x1
@x2
@x3))
@x1)
...
:pattern ((Monad.Mkmonad @x0
@x1
@x2
@x3))
:qid projection_inverse_Monad.Mkmonad_return))

:named projection_inverse_Monad.Mkmonad_return))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Monad.Mkmonad_m (Monad.Mkmonad @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_Monad.Mkmonad_m))

:named projection_inverse_Monad.Mkmonad_m))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Monad.Mkmonad_laws_return (Monad.Mkmonad_laws @x0
@x1
@x2
@x3
@x4
...
:pattern ((Monad.Mkmonad_laws @x0
@x1
@x2
@x3
@x4
@x5))
:qid projection_inverse_Monad.Mkmonad_laws_return))

:named projection_inverse_Monad.Mkmonad_laws_return))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Monad.Mkmonad_laws_m (Monad.Mkmonad_laws @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Monad.Mkmonad_laws_m))

:named projection_inverse_Monad.Mkmonad_laws_m))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Monad.Mkmonad_laws_idR (Monad.Mkmonad_laws @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Monad.Mkmonad_laws_idR))

:named projection_inverse_Monad.Mkmonad_laws_idR))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Monad.Mkmonad_laws_idL (Monad.Mkmonad_laws @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Monad.Mkmonad_laws_idL))

:named projection_inverse_Monad.Mkmonad_laws_idL))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Monad.Mkmonad_laws_bind (Monad.Mkmonad_laws @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Monad.Mkmonad_laws_bind))

:named projection_inverse_Monad.Mkmonad_laws_bind))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Monad.Mkmonad_laws_assoc (Monad.Mkmonad_laws @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Monad.Mkmonad_laws_assoc))

:named projection_inverse_Monad.Mkmonad_laws_assoc))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Monad.Mkmonad_laws (Monad.Mkmonad @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_Monad.Mkmonad_laws))

:named projection_inverse_Monad.Mkmonad_laws))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Monad.Mkmonad_bind (Monad.Mkmonad @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Monad.Mkmonad_bind))

:named projection_inverse_Monad.Mkmonad_bind))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__return; Namespace Monad
(assert (! 
;; def=Monad.fst(41,2-41,8); use=Monad.fst(41,2-41,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Monad.__proj__Mkmonad__item__return @x0
@x1)
(Monad.Mkmonad_return @x1))
 

:pattern ((Monad.__proj__Mkmonad__item__return @x0
@x1))
:qid proj_equation_Monad.Mkmonad_return))

:named proj_equation_Monad.Mkmonad_return))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__bind; Namespace Monad
(assert (! 
;; def=Monad.fst(42,2-42,6); use=Monad.fst(42,2-42,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Monad.__proj__Mkmonad__item__bind @x0
@x1)
(Monad.Mkmonad_bind @x1))
 

:pattern ((Monad.__proj__Mkmonad__item__bind @x0
@x1))
:qid proj_equation_Monad.Mkmonad_bind))

:named proj_equation_Monad.Mkmonad_bind))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! (is-Tm_arrow (PreType Monad.monad_laws@tok))
:named pre_kinding_Monad.monad_laws@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! (is-Tm_arrow (PreType Monad.monad@tok))
:named pre_kinding_Monad.monad@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fe96ea64440933a872257514e1912843
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,19-32,114); use=Monad.fst(32,90-32,114)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-42,30); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8 @x0)
Tm_type))
:qid kinding_Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8))

:named kinding_Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=dummy(0,0-0,0); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_f528ff54ee63a89d1c18ddac5d069566 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_f528ff54ee63a89d1c18ddac5d069566 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566))

:named kinding_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566))
...
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,75-32,106); use=Monad.fst(32,98-32,106)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,47-32,48); use=Monad.fst(32,54-32,55)
(forall ((@x0 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9e575de7a70ba4ac266a6d63979096d4
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! (HasType Tm_arrow_9e575de7a70ba4ac266a6d63979096d4
Tm_type)
:named kinding_Tm_arrow_9e575de7a70ba4ac266a6d63979096d4))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8f1d51e3dfafe2c5703a947539599744
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! (HasType Tm_arrow_8f1d51e3dfafe2c5703a947539599744
Tm_type)
:named kinding_Tm_arrow_8f1d51e3dfafe2c5703a947539599744))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=dummy(0,0-0,0); use=Monad.fst(41,2-41,20)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd @x0)
Tm_type))
:qid kinding_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd))

:named kinding_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8c46a296e41552271b43886f97a4b7b1
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=dummy(0,0-0,0); use=Monad.fst(41,2-41,20)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))

:named kinding_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_826caaf1f5a068be489ec69d8e350705
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,19-33,45); use=Monad.fst(33,29-33,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_826caaf1f5a068be489ec69d8e350705 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_826caaf1f5a068be489ec69d8e350705 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_826caaf1f5a068be489ec69d8e350705))

:named kinding_Tm_arrow_826caaf1f5a068be489ec69d8e350705))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_652cb631c827d14e874241f18577d114
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__return; Namespace Monad
(assert (! (HasType Tm_arrow_652cb631c827d14e874241f18577d114
Tm_type)
:named kinding_Tm_arrow_652cb631c827d14e874241f18577d114))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_403631340cf419d370f9eb39963c3cb0
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(41,2-41,20)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_403631340cf419d370f9eb39963c3cb0 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_403631340cf419d370f9eb39963c3cb0 @x0)
Tm_type))
:qid kinding_Tm_arrow_403631340cf419d370f9eb39963c3cb0))

:named kinding_Tm_arrow_403631340cf419d370f9eb39963c3cb0))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,19-37,42); use=Monad.fst(35,37-37,42)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42))

:named kinding_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,17-42,30); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64 @x0)
Tm_type))
:qid kinding_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64))

:named kinding_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,17-42,30); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02))

:named kinding_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(42,27-42,30); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac))

:named kinding_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_04261eddc9b40c4cf9088803b730a42c
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__bind; Namespace Monad
(assert (! (HasType Tm_arrow_04261eddc9b40c4cf9088803b730a42c
Tm_type)
:named kinding_Tm_arrow_04261eddc9b40c4cf9088803b730a42c))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0343debff6b5862c3d3aa654609340e8
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,19-34,54); use=Monad.fst(34,21-34,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! (and (IsTotFun Monad.monad_laws@tok)

;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Monad.monad_laws@tok
@x0))
 

:pattern ((ApplyTT Monad.monad_laws@tok
@x0))
:qid kinding_Monad.monad_laws@tok))


;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (ApplyTT (ApplyTT Monad.monad_laws@tok
@x0)
@x1))
 

:pattern ((ApplyTT (ApplyTT Monad.monad_laws@tok
@x0)
@x1))
:qid kinding_Monad.monad_laws@tok.1))
...
@x1
@x2))
:qid kinding_Monad.monad_laws@tok.2))
)
:named kinding_Monad.monad_laws@tok))
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! (and (IsTotFun Monad.monad@tok)

;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (Monad.monad @x0)
Tm_type))
 

:pattern ((Monad.monad @x0))
:qid kinding_Monad.monad@tok))
)
:named kinding_Monad.monad@tok))
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(42,2-42,6); use=Monad.fst(42,2-42,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e @x1)
@x0)
(let ((@lb2 @x0))
(Monad.Mkmonad_bind @lb2)))
 

:pattern ((ApplyTT (Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e @x1)
@x0))
:qid interpretation_Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e))

:named interpretation_Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=Monad.fst(41,2-41,8); use=Monad.fst(41,2-41,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8 @x1)
@x0)
(let ((@lb2 @x0))
(Monad.Mkmonad_return @lb2)))
 

:pattern ((ApplyTT (Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8 @x1)
@x0))
:qid interpretation_Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8))

:named interpretation_Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(36,4-37,42); use=Monad.fst(36,4-37,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b @x0
@x1
@x2
@x3
@x4
...
@x6
@x7))))
:qid haseqTm_refine_c3a1c2e45afd5fd00cb86c031b5a034b))

:named haseqTm_refine_c3a1c2e45afd5fd00cb86c031b5a034b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_933b648d18b593f5ba5ea49e6611349c
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(33,50-33,82); use=Monad.fst(33,50-33,82)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_933b648d18b593f5ba5ea49e6611349c @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_933b648d18b593f5ba5ea49e6611349c @x0
@x1
@x2
@x3
@x4
@x5))))
:qid haseqTm_refine_933b648d18b593f5ba5ea49e6611349c))

:named haseqTm_refine_933b648d18b593f5ba5ea49e6611349c))
...
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Monad.return@tok
Tm_arrow_8f1d51e3dfafe2c5703a947539599744))
(forall ((@x1 Term))
 (! (= (ApplyTT Monad.return@tok
@x1)
(Monad.return @x1))
...
:pattern ((Monad.return @x1))
:qid function_token_typing_Monad.return.1)))
 

:pattern ((ApplyTT @x0
Monad.return@tok))
:qid function_token_typing_Monad.return))
:named function_token_typing_Monad.return))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! (forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Monad.bind@tok
Tm_arrow_9e575de7a70ba4ac266a6d63979096d4))
(forall ((@x1 Term))
 (! (= (ApplyTT Monad.bind@tok
@x1)
(Monad.bind @x1))
...
:pattern ((Monad.bind @x1))
:qid function_token_typing_Monad.bind.1)))
 

:pattern ((ApplyTT @x0
Monad.bind@tok))
:qid function_token_typing_Monad.bind))
:named function_token_typing_Monad.bind))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__return; Namespace Monad
(assert (! 
;; def=Monad.fst(41,2-41,8); use=Monad.fst(41,2-41,8)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Monad.__proj__Mkmonad__item__return@tok
Tm_arrow_652cb631c827d14e874241f18577d114))
...
@x1)
@x2)
(Monad.__proj__Mkmonad__item__return @x1
@x2))
 

:pattern ((Monad.__proj__Mkmonad__item__return @x1
@x2))
:qid function_token_typing_Monad.__proj__Mkmonad__item__return.1))
)
 

:pattern ((ApplyTT @x0
Monad.__proj__Mkmonad__item__return@tok))
:qid function_token_typing_Monad.__proj__Mkmonad__item__return))

:named function_token_typing_Monad.__proj__Mkmonad__item__return))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__bind; Namespace Monad
(assert (! 
;; def=Monad.fst(42,2-42,6); use=Monad.fst(42,2-42,6)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Monad.__proj__Mkmonad__item__bind@tok
Tm_arrow_04261eddc9b40c4cf9088803b730a42c))
...
@x1)
@x2)
(Monad.__proj__Mkmonad__item__bind @x1
@x2))
 

:pattern ((Monad.__proj__Mkmonad__item__bind @x1
@x2))
:qid function_token_typing_Monad.__proj__Mkmonad__item__bind.1))
)
 

:pattern ((ApplyTT @x0
Monad.__proj__Mkmonad__item__bind@tok))
:qid function_token_typing_Monad.__proj__Mkmonad__item__bind))

:named function_token_typing_Monad.__proj__Mkmonad__item__bind))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
...
@x3
@x4))
(and (is-Monad.Mkmonad_laws @x1)
(= @x2
(Monad.Mkmonad_laws_m @x1))
(= @x3
(Monad.Mkmonad_laws_return @x1))
(= @x4
(Monad.Mkmonad_laws_bind @x1))))
...
@x3
@x4)))
:qid fuel_guarded_inversion_Monad.monad_laws))

:named fuel_guarded_inversion_Monad.monad_laws))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
...
@x1
(Monad.monad @x2)))
:qid fuel_guarded_inversion_Monad.monad))

:named fuel_guarded_inversion_Monad.monad))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! (= 113
(Term_constr_id Monad.monad_laws@tok))
:named fresh_token_Monad.monad_laws@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! (= 264
(Term_constr_id Monad.monad@tok))
:named fresh_token_Monad.monad@tok))
...
;;;;;;;;;;;;;;;;Equation for Monad.return
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! (forall ((@x0 Term))
 (! (= (Monad.return @x0)
(Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8 @x0))
 

:pattern ((Monad.return @x0))
:qid equation_Monad.return))
:named equation_Monad.return))
;;;;;;;;;;;;;;;;Equation for Monad.bind
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! (forall ((@x0 Term))
 (! (= (Monad.bind @x0)
(Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e @x0))
 

:pattern ((Monad.bind @x0))
:qid equation_Monad.bind))
:named equation_Monad.bind))
...
(HasTypeFuel @u0
@x4
(Tm_arrow_826caaf1f5a068be489ec69d8e350705 @x2
@x3
@x1))
(HasTypeFuel @u0
@x5
...
(HasTypeFuel @u0
@x6
(Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 @x3
@x1)))
(HasTypeFuel @u0
(Monad.Mkmonad_laws @x1
@x2
...
@x2
@x3)))
:qid data_typing_intro_Monad.Mkmonad_laws@tok))

:named data_typing_intro_Monad.Mkmonad_laws@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
...
@x4)
(Monad.monad @x1)))
:qid data_typing_intro_Monad.Mkmonad@tok))

:named data_typing_intro_Monad.Mkmonad@tok))
...
(HasTypeFuel @u0
@x8
(Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c @x7))
(HasTypeFuel @u0
@x9
(Tm_arrow_fe96ea64440933a872257514e1912843 @x7))
(HasTypeFuel @u0
@x4
(Tm_arrow_826caaf1f5a068be489ec69d8e350705 @x8
@x9
@x7))
(HasTypeFuel @u0
@x5
(Tm_arrow_0343debff6b5862c3d3aa654609340e8 @x8
@x9
@x7))
(HasTypeFuel @u0
@x6
(Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 @x9
@x7))))
...
@x8
@x9)))
:qid data_elim_Monad.Mkmonad_laws))

:named data_elim_Monad.Mkmonad_laws))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
...
(HasTypeFuel @u0
@x2
(Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c @x5))
(HasTypeFuel @u0
@x3
(Tm_arrow_fe96ea64440933a872257514e1912843 @x5))
(HasTypeFuel @u0
@x4
(Monad.monad_laws @x5
@x2
...
@x4)
(Monad.monad @x5)))
:qid data_elim_Monad.Mkmonad))

:named data_elim_Monad.Mkmonad))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 112
(Term_constr_id (Monad.monad_laws @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_Monad.monad_laws))

:named constructor_distinct_Monad.monad_laws))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
(forall ((@x0 Term))
 (! (= 263
(Term_constr_id (Monad.monad @x0)))
 

:pattern ((Monad.monad @x0))
:qid constructor_distinct_Monad.monad))

:named constructor_distinct_Monad.monad))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= 144
(Term_constr_id (Monad.Mkmonad_laws @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid constructor_distinct_Monad.Mkmonad_laws))

:named constructor_distinct_Monad.Mkmonad_laws))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Monad.monad; Namespace Monad; Name Monad.Mkmonad; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(40,6-40,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 278
(Term_constr_id (Monad.Mkmonad @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_Monad.Mkmonad))

:named constructor_distinct_Monad.Mkmonad))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
(Monad.monad @x2)))
:qid Monad_pretyping_d5f3b3a4f21e2ce73ed4c1df15884511))

:named Monad_pretyping_d5f3b3a4f21e2ce73ed4c1df15884511))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,5-32,15); use=Monad.fst(32,5-32,15)
...
@x3
@x4)))
:qid Monad_pretyping_2c08313129d109215d160d9531c61939))

:named Monad_pretyping_2c08313129d109215d160d9531c61939))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,19-32,114); use=Monad.fst(32,90-32,114)
...
@x1
(Tm_arrow_fe96ea64440933a872257514e1912843 @x2)))
:qid Monad_pre_typing_Tm_arrow_fe96ea64440933a872257514e1912843))

:named Monad_pre_typing_Tm_arrow_fe96ea64440933a872257514e1912843))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-42,30); use=Monad.fst(42,2-42,36)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8 @x2)))
:qid Monad_pre_typing_Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8))

:named Monad_pre_typing_Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=dummy(0,0-0,0); use=Monad.fst(42,2-42,36)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_f528ff54ee63a89d1c18ddac5d069566 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid Monad_pre_typing_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566))

:named Monad_pre_typing_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,75-32,106); use=Monad.fst(32,98-32,106)
...
@x3
@x4)))
:qid Monad_pre_typing_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))

:named Monad_pre_typing_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,47-32,48); use=Monad.fst(32,54-32,55)
...
@x1
(Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c @x2)))
:qid Monad_pre_typing_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))

:named Monad_pre_typing_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-42,30); use=Monad.fst(42,2-42,36)
...
@x1
Tm_arrow_9e575de7a70ba4ac266a6d63979096d4))
:qid Monad_pre_typing_Tm_arrow_9e575de7a70ba4ac266a6d63979096d4))

:named Monad_pre_typing_Tm_arrow_9e575de7a70ba4ac266a6d63979096d4))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,31); use=Monad.fst(41,2-41,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8f1d51e3dfafe2c5703a947539599744)
...
@x1
Tm_arrow_8f1d51e3dfafe2c5703a947539599744))
:qid Monad_pre_typing_Tm_arrow_8f1d51e3dfafe2c5703a947539599744))

:named Monad_pre_typing_Tm_arrow_8f1d51e3dfafe2c5703a947539599744))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=dummy(0,0-0,0); use=Monad.fst(41,2-41,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd @x2)))
:qid Monad_pre_typing_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd))

:named Monad_pre_typing_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=dummy(0,0-0,0); use=Monad.fst(41,2-41,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x2
@x3)))
:qid Monad_pre_typing_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))

:named Monad_pre_typing_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,19-33,45); use=Monad.fst(33,29-33,45)
...
@x3
@x4)))
:qid Monad_pre_typing_Tm_arrow_826caaf1f5a068be489ec69d8e350705))

:named Monad_pre_typing_Tm_arrow_826caaf1f5a068be489ec69d8e350705))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__return; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-41,13); use=Monad.fst(40,6-41,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_652cb631c827d14e874241f18577d114)
...
@x1
Tm_arrow_652cb631c827d14e874241f18577d114))
:qid Monad_pre_typing_Tm_arrow_652cb631c827d14e874241f18577d114))

:named Monad_pre_typing_Tm_arrow_652cb631c827d14e874241f18577d114))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(41,2-41,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_403631340cf419d370f9eb39963c3cb0 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_403631340cf419d370f9eb39963c3cb0 @x2)))
:qid Monad_pre_typing_Tm_arrow_403631340cf419d370f9eb39963c3cb0))

:named Monad_pre_typing_Tm_arrow_403631340cf419d370f9eb39963c3cb0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,19-37,42); use=Monad.fst(35,37-37,42)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 @x2
@x3)))
:qid Monad_pre_typing_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42))

:named Monad_pre_typing_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,17-42,30); use=Monad.fst(42,2-42,36)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64 @x2)))
:qid Monad_pre_typing_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64))

:named Monad_pre_typing_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,17-42,30); use=Monad.fst(42,2-42,36)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02 @x2
@x3)))
:qid Monad_pre_typing_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02))

:named Monad_pre_typing_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(42,27-42,30); use=Monad.fst(42,2-42,36)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid Monad_pre_typing_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac))

:named Monad_pre_typing_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-42,51); use=Monad.fst(40,6-42,51)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_04261eddc9b40c4cf9088803b730a42c)
...
@x1
Tm_arrow_04261eddc9b40c4cf9088803b730a42c))
:qid Monad_pre_typing_Tm_arrow_04261eddc9b40c4cf9088803b730a42c))

:named Monad_pre_typing_Tm_arrow_04261eddc9b40c4cf9088803b730a42c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,19-34,54); use=Monad.fst(34,21-34,54)
...
@x3
@x4)))
:qid Monad_pre_typing_Tm_arrow_0343debff6b5862c3d3aa654609340e8))

:named Monad_pre_typing_Tm_arrow_0343debff6b5862c3d3aa654609340e8))
...
@x4)
@x5))
:qid Monad_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid Monad_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.2))
...
@x2)
@x3))
:qid Monad_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.3))
...
@x3)
@x4))
:qid Monad_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843.4))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_fe96ea64440933a872257514e1912843 @x1)))
:qid Monad_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843))

:named Monad_interpretation_Tm_arrow_fe96ea64440933a872257514e1912843))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-42,30); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8 @x1))
(and 
;; def=Monad.fst(40,6-42,30); use=Monad.fst(42,2-42,36)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
(HasType (ApplyTT @x0
@x2)
(Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64 @x1)))
 

:pattern ((ApplyTT @x0
@x2))
:qid Monad_interpretation_Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8 @x1)))
:qid Monad_interpretation_Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8))

:named Monad_interpretation_Tm_arrow_f81f56aa42318b314c373bbeb0da3ee8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=dummy(0,0-0,0); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f528ff54ee63a89d1c18ddac5d069566 @x1
@x2
@x3))
(and 
;; def=dummy(0,0-0,0); use=Monad.fst(42,2-42,36)
...
:pattern ((ApplyTT @x0
@x4))
:qid Monad_interpretation_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566.1))
...
@x2
@x3)))
:qid Monad_interpretation_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566))

:named Monad_interpretation_Tm_arrow_f528ff54ee63a89d1c18ddac5d069566))
...
:pattern ((ApplyTT @x0
@x4))
:qid Monad_interpretation_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96.1))
...
@x2
@x3)))
:qid Monad_interpretation_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))

:named Monad_interpretation_Tm_arrow_e9ffc6ced04f6112d664a374947b4d96))
...
@x2)
@x3))
:qid Monad_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid Monad_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c @x1)))
:qid Monad_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))

:named Monad_interpretation_Tm_arrow_e6dd8d368f8c55490d812218e3e78b9c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9e575de7a70ba4ac266a6d63979096d4
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-42,30); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Monad_interpretation_Tm_arrow_9e575de7a70ba4ac266a6d63979096d4.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_9e575de7a70ba4ac266a6d63979096d4))
:qid Monad_interpretation_Tm_arrow_9e575de7a70ba4ac266a6d63979096d4))

:named Monad_interpretation_Tm_arrow_9e575de7a70ba4ac266a6d63979096d4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8f1d51e3dfafe2c5703a947539599744
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,31); use=Monad.fst(41,2-41,20)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_403631340cf419d370f9eb39963c3cb0 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid Monad_interpretation_Tm_arrow_8f1d51e3dfafe2c5703a947539599744.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_8f1d51e3dfafe2c5703a947539599744))
:qid Monad_interpretation_Tm_arrow_8f1d51e3dfafe2c5703a947539599744))

:named Monad_interpretation_Tm_arrow_8f1d51e3dfafe2c5703a947539599744))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=dummy(0,0-0,0); use=Monad.fst(41,2-41,20)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd @x1))
(and 
;; def=dummy(0,0-0,0); use=Monad.fst(41,2-41,20)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
(HasType (ApplyTT @x0
@x2)
(Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x1
@x2)))
 

:pattern ((ApplyTT @x0
@x2))
:qid Monad_interpretation_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd @x1)))
:qid Monad_interpretation_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd))

:named Monad_interpretation_Tm_arrow_8d5a3ea34f3859d9691d2e00008329fd))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8c46a296e41552271b43886f97a4b7b1
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=dummy(0,0-0,0); use=Monad.fst(41,2-41,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid Monad_interpretation_Tm_arrow_8c46a296e41552271b43886f97a4b7b1.1))
...
(Tm_arrow_8c46a296e41552271b43886f97a4b7b1 @x1
@x2)))
:qid Monad_interpretation_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))

:named Monad_interpretation_Tm_arrow_8c46a296e41552271b43886f97a4b7b1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,19-33,45); use=Monad.fst(33,29-33,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_826caaf1f5a068be489ec69d8e350705 @x1
@x2
@x3))
(and 
;; def=Monad.fst(32,19-33,45); use=Monad.fst(33,29-33,45)
...
@x4)
(HasType @x7
(Tm_arrow_e9ffc6ced04f6112d664a374947b4d96 @x5
@x3
@x4)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x4)
...
@x6)
@x7))
:qid Monad_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid Monad_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705.2))
...
@x4)
@x5))
:qid Monad_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705.3))
...
@x5)
@x6))
:qid Monad_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705.4))
))
...
@x2
@x3)))
:qid Monad_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705))

:named Monad_interpretation_Tm_arrow_826caaf1f5a068be489ec69d8e350705))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_652cb631c827d14e874241f18577d114
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__return; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-41,13); use=Monad.fst(40,6-41,20)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Monad_interpretation_Tm_arrow_652cb631c827d14e874241f18577d114.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Monad_interpretation_Tm_arrow_652cb631c827d14e874241f18577d114.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_652cb631c827d14e874241f18577d114))
:qid Monad_interpretation_Tm_arrow_652cb631c827d14e874241f18577d114))

:named Monad_interpretation_Tm_arrow_652cb631c827d14e874241f18577d114))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_403631340cf419d370f9eb39963c3cb0
;;; Fact-ids: Name Monad.return; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-40,11); use=Monad.fst(41,2-41,20)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid Monad_interpretation_Tm_arrow_403631340cf419d370f9eb39963c3cb0.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_403631340cf419d370f9eb39963c3cb0 @x1)))
:qid Monad_interpretation_Tm_arrow_403631340cf419d370f9eb39963c3cb0))

:named Monad_interpretation_Tm_arrow_403631340cf419d370f9eb39963c3cb0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42
;;; Fact-ids: Name Monad.monad_laws; Namespace Monad; Name Monad.Mkmonad_laws; Namespace Monad
(assert (! 
;; def=Monad.fst(32,19-37,42); use=Monad.fst(35,37-37,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 @x1
@x2))
(and 
;; def=Monad.fst(32,19-37,42); use=Monad.fst(35,37-37,42)
...
@x7)
@x8)
(Tm_refine_c3a1c2e45afd5fd00cb86c031b5a034b @x1
@x4
@x5
@x3
@x6
...
@x7)
@x8))
:qid Monad_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Monad_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.2))
...
@x3)
@x4))
:qid Monad_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.3))
...
@x4)
@x5))
:qid Monad_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.4))
...
@x5)
@x6))
:qid Monad_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.5))
...
@x6)
@x7))
:qid Monad_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42.6))
))
...
(Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42 @x1
@x2)))
:qid Monad_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42))

:named Monad_interpretation_Tm_arrow_3b3da8cdaaa550c63d9da61fefd77f42))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,17-42,30); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term) (@x1 Term))
...
(HasType (ApplyTT @x0
@x2)
(Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02 @x1
@x2)))
 

:pattern ((ApplyTT @x0
@x2))
:qid Monad_interpretation_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64 @x1)))
:qid Monad_interpretation_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64))

:named Monad_interpretation_Tm_arrow_318f7c5c8a46c5239ac50e640bb05a64))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,17-42,30); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType (ApplyTT @x0
@x3)
(Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac @x3
@x2
@x1)))
...
:pattern ((ApplyTT @x0
@x3))
:qid Monad_interpretation_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02.1))
...
(Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02 @x1
@x2)))
:qid Monad_interpretation_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02))

:named Monad_interpretation_Tm_arrow_1c0bb9b146c91c1dbff3b2b9b8478d02))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac
;;; Fact-ids: Name Monad.bind; Namespace Monad
(assert (! 
;; def=Monad.fst(42,27-42,30); use=Monad.fst(42,2-42,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac @x1
@x2
@x3))
(and 
;; def=Monad.fst(42,27-42,30); use=Monad.fst(42,2-42,36)
...
:pattern ((ApplyTT @x0
@x4))
:qid Monad_interpretation_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac.1))
...
@x2
@x3)))
:qid Monad_interpretation_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac))

:named Monad_interpretation_Tm_arrow_1404f0607dc4381f3c789a8bc0d065ac))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_04261eddc9b40c4cf9088803b730a42c
;;; Fact-ids: Name Monad.__proj__Mkmonad__item__bind; Namespace Monad
(assert (! 
;; def=Monad.fst(40,6-42,51); use=Monad.fst(40,6-42,51)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Monad_interpretation_Tm_arrow_04261eddc9b40c4cf9088803b730a42c.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Monad_interpretation_Tm_arrow_04261eddc9b40c4cf9088803b730a42c.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_04261eddc9b40c4cf9088803b730a42c))
:qid Monad_interpretation_Tm_arrow_04261eddc9b40c4cf9088803b730a42c))

:named Monad_interpretation_Tm_arrow_04261eddc9b40c4cf9088803b730a42c))
...
@x4)
@x5))
:qid Monad_interpretation_Tm_arrow_0343debff6b5862c3d3aa654609340e8.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid Monad_interpretation_Tm_arrow_0343debff6b5862c3d3aa654609340e8.2))
))
...
@x2
@x3)))
:qid Monad_interpretation_Tm_arrow_0343debff6b5862c3d3aa654609340e8))

:named Monad_interpretation_Tm_arrow_0343debff6b5862c3d3aa654609340e8))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Monad.f; Namespace Monad
(assert (! (Valid (ApplyTT __uu__PartialApp
Monad.return@tok))
:named @kick_partial_app_e6908dd1f1b44651c787367fb58a3be6))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Monad.f; Namespace Monad
(assert (! (Valid (ApplyTT __uu__PartialApp
Monad.bind@tok))
:named @kick_partial_app_53a4a71dbe165ed6d7bbfa4b16ea1d9a))
(push) ;; push{2

; Starting query at Monad.fst(52,2-54,72)
...
;;;;;;;;;;;;;;;;_: Prims.unit -> m a
(declare-fun Tm_arrow_333f6418e70a95ba99fb73a0d169a395 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_333f6418e70a95ba99fb73a0d169a395
;;; Fact-ids: 
(assert (! 
;; def=Monad.fst(42,40-54,65); use=Monad.fst(54,2-54,8)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_333f6418e70a95ba99fb73a0d169a395 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_333f6418e70a95ba99fb73a0d169a395 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_333f6418e70a95ba99fb73a0d169a395))

:named kinding_Tm_arrow_333f6418e70a95ba99fb73a0d169a395))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Monad.fst(42,40-54,65); use=Monad.fst(54,2-54,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_333f6418e70a95ba99fb73a0d169a395 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_333f6418e70a95ba99fb73a0d169a395 @x2
@x3)))
:qid Monad_pre_typing_Tm_arrow_333f6418e70a95ba99fb73a0d169a395))

:named Monad_pre_typing_Tm_arrow_333f6418e70a95ba99fb73a0d169a395))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_333f6418e70a95ba99fb73a0d169a395
;;; Fact-ids: 
(assert (! 
;; def=Monad.fst(42,40-54,65); use=Monad.fst(54,2-54,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_333f6418e70a95ba99fb73a0d169a395 @x1
@x2))
(and 
;; def=Monad.fst(42,40-54,65); use=Monad.fst(54,2-54,8)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid Monad_interpretation_Tm_arrow_333f6418e70a95ba99fb73a0d169a395.1))
...
(Tm_arrow_333f6418e70a95ba99fb73a0d169a395 @x1
@x2)))
:qid Monad_interpretation_Tm_arrow_333f6418e70a95ba99fb73a0d169a395))

:named Monad_interpretation_Tm_arrow_333f6418e70a95ba99fb73a0d169a395))
(declare-fun Tm_abs_3ac48754d31ba575bcf0343adef17df7 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_3ac48754d31ba575bcf0343adef17df7
;;; Fact-ids: 
(assert (! 
;; def=Monad.fst(51,34-51,35); use=Monad.fst(54,2-54,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_3ac48754d31ba575bcf0343adef17df7 @x0
@x1
@x2)
(Tm_arrow_333f6418e70a95ba99fb73a0d169a395 @x1
@x2))
...
:pattern ((Tm_abs_3ac48754d31ba575bcf0343adef17df7 @x0
@x1
@x2))
:qid typing_Tm_abs_3ac48754d31ba575bcf0343adef17df7))

:named typing_Tm_abs_3ac48754d31ba575bcf0343adef17df7))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3ac48754d31ba575bcf0343adef17df7
;;; Fact-ids: 
(assert (! 
;; def=Monad.fst(51,34-51,35); use=Monad.fst(54,2-54,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_3ac48754d31ba575bcf0343adef17df7 @x1
@x2
@x3)
@x0)
@x1)
...
:pattern ((ApplyTT (Tm_abs_3ac48754d31ba575bcf0343adef17df7 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_3ac48754d31ba575bcf0343adef17df7))

:named interpretation_Tm_abs_3ac48754d31ba575bcf0343adef17df7))

;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
Monad.__proj__Mkmonad__item__return@tok))
:named @kick_partial_app_3a208083116e879b0bc3456e1613a9a6))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
Monad.__proj__Mkmonad__item__bind@tok))
:named @kick_partial_app_e98c939ec325d09be0de8ea69cc3c188))





; Encoding query formula : forall (_: Type) (a: Type) (b: _) (m: (_: Type -> Type)) (d: Monad.monad m) (x: m a).
;   (*  - Could not prove post-condition
; *)
;   forall (pure_result: Prims.unit).
;     d.bind (d.return ()) (fun _ -> x) == x ==>
;     (forall (pure_result: Prims.unit).
;         d.bind x d.return == x ==>
;         Monad.bind x Monad.return == Monad.bind (Monad.return ()) (fun _ -> x))
...
;; def=Prims.fst(441,36-441,97); use=Monad.fst(52,9-52,12)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=Monad.fst(33,56-33,82); use=Monad.fst(52,9-52,12)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Monad.__proj__Mkmonad__item__bind@tok
@x3)
@x4)
Prims.unit)
@x1)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Monad.__proj__Mkmonad__item__return@tok
@x3)
@x4)
Prims.unit)
Tm_unit))
(Tm_abs_3ac48754d31ba575bcf0343adef17df7 @x5
@x1
@x3))
@x5)
)

;; def=Prims.fst(441,36-441,97); use=Monad.fst(53,9-53,12)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=Monad.fst(34,34-34,54); use=Monad.fst(53,9-53,12)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Monad.__proj__Mkmonad__item__bind@tok
@x3)
@x4)
@x1)
@x1)
@x5)
(ApplyTT (ApplyTT (ApplyTT Monad.__proj__Mkmonad__item__return@tok
@x3)
@x4)
@x1))
@x5)
...
;; def=Monad.fst(54,9-54,72); use=Monad.fst(54,2-54,8)
(or label_1

;; def=Monad.fst(54,9-54,72); use=Monad.fst(54,2-54,8)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Monad.bind@tok
@x3)
@x4)
@x1)
@x1)
@x5)
(ApplyTT (ApplyTT (ApplyTT Monad.return@tok
@x3)
@x4)
@x1))
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Monad.bind@tok
...
Prims.unit)
@x1)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Monad.return@tok
@x3)
@x4)
Prims.unit)
Tm_unit))
...
; QUERY ID: (Monad.g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Monad.bind, equation_Monad.return, fuel_guarded_inversion_Monad.monad, interpretation_Tm_abs_0adce631eac67f824f4c0bb34d3ca4d8, interpretation_Tm_abs_18e4cb8b775f6da62be8dae2bc35e95e, proj_equation_Monad.Mkmonad_bind, proj_equation_Monad.Mkmonad_return, token_correspondence_Monad.__proj__Mkmonad__item__bind, token_correspondence_Monad.__proj__Mkmonad__item__return, token_correspondence_Monad.bind, token_correspondence_Monad.return
...
(declare-fun Monad.g (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;{| d: monad m |} -> x: m a -> Prims.unit
(declare-fun Tm_arrow_df0bc5b5def13eda4d4e8c168d34e7df () Term)
(declare-fun Monad.g@tok () Term)
...
; Starting query at Monad.fst(58,2-60,72)
...
;;; Fact-ids: 
(assert (! 
;; def=Monad.fst(42,40-60,65); use=Monad.fst(60,2-60,8)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_333f6418e70a95ba99fb73a0d169a395 @x0
@x1)
Tm_type)
...
;;; Fact-ids: 
(assert (! 
;; def=Monad.fst(57,31-57,32); use=Monad.fst(60,2-60,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_3ac48754d31ba575bcf0343adef17df7 @x0
@x1
@x2)
...
; Encoding query formula : forall (_: Type) (a: Type) (b: _) (m: (_: Type -> Type)) (_: Monad.monad m) (x: m a).
;   (*  - Could not prove post-condition
; *)
;   forall (pure_result: Prims.unit).
;     _.bind (_.return ()) (fun _ -> x) == x ==>
;     (forall (pure_result: Prims.unit).
;         _.bind x _.return == x ==>
;         Monad.bind x Monad.return == Monad.bind (Monad.return ()) (fun _ -> x))
...
;; def=Prims.fst(441,36-441,97); use=Monad.fst(58,12-58,15)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=Monad.fst(33,56-33,82); use=Monad.fst(58,12-58,15)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Monad.__proj__Mkmonad__item__bind@tok
@x3)
@x4)
Prims.unit)
...
;; def=Prims.fst(441,36-441,97); use=Monad.fst(59,12-59,15)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=Monad.fst(34,34-34,54); use=Monad.fst(59,12-59,15)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Monad.__proj__Mkmonad__item__bind@tok
@x3)
@x4)
@x1)
...
;; def=Monad.fst(60,9-60,72); use=Monad.fst(60,2-60,8)
(or label_1
