...
; Starting query at Problem01.fst(20,0-20,92)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (p: Prims.list Prims.nat) (str: Prims.list Prims.nat).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (b: Prims.bool) (l: Prims.list Prims.nat).
;     (*  - Subtyping check failed
...
; While typechecking the top-level declaration `val Problem01.prefix`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Problem01.fst(20,0-20,92)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
;; def=dummy(0,0-0,0); use=Problem01.fst(20,14-20,92)
...
;; def=Prims.fst(73,23-73,30); use=Problem01.fst(20,86-20,89)
(or label_1
...
; encoding sigelt val Problem01.prefix


; <Skipped val Problem01.prefix/>
...
; Starting query at Problem01.fst(22,2-25,57)

;;;;;;;;;;;;;;;;p : Prims.list Prims.nat (Prims.list Prims.nat)
...
;;;;;;;;;;;;;;;;str : Prims.list Prims.nat (Prims.list Prims.nat)
(declare-fun x_b46f9febde162e476374095e6787c208_1 () Term)
;;;;;;;;;;;;;;;;binder_x_b46f9febde162e476374095e6787c208_1
;;; Fact-ids: 
(assert (! (HasType x_b46f9febde162e476374095e6787c208_1
(Prims.list Prims.nat))
:named binder_x_b46f9febde162e476374095e6787c208_1))
(declare-fun Tm_refine_df712bf0b370bc497367bb8c0c0dcc31 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(20,12-25,57)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_df712bf0b370bc497367bb8c0c0dcc31 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_df712bf0b370bc497367bb8c0c0dcc31 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_df712bf0b370bc497367bb8c0c0dcc31))

:named refinement_kinding_Tm_refine_df712bf0b370bc497367bb8c0c0dcc31))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(20,12-25,57)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_df712bf0b370bc497367bb8c0c0dcc31 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.nat))
...
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(20,12-25,57)
(or 
;; def=Problem01.fst(22,2-25,57); use=Problem01.fst(22,2-25,57)
(Valid 
;; def=Problem01.fst(22,2-25,57); use=Problem01.fst(22,2-25,57)
...
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(20,12-25,57)
(and 
;; def=Problem01.fst(20,12-21,16); use=Problem01.fst(20,12-21,16)
(Valid 
;; def=Problem01.fst(20,12-21,16); use=Problem01.fst(20,12-21,16)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.nat)
(Prims.list Prims.nat)
@x2
x_b46f9febde162e476374095e6787c208_0)
)
...
(Prims.list Prims.nat)
@x1
x_b46f9febde162e476374095e6787c208_1)
)
)
)
...
@x1
(Tm_refine_df712bf0b370bc497367bb8c0c0dcc31 @x2)))
:qid refinement_interpretation_Tm_refine_df712bf0b370bc497367bb8c0c0dcc31))

:named refinement_interpretation_Tm_refine_df712bf0b370bc497367bb8c0c0dcc31))
;;;;;;;;;;;;;;;;haseq for Tm_refine_df712bf0b370bc497367bb8c0c0dcc31
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(20,12-25,57)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_df712bf0b370bc497367bb8c0c0dcc31 @x0)))
(Valid (Prims.hasEq (Prims.list Prims.nat))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_df712bf0b370bc497367bb8c0c0dcc31 @x0))))
:qid haseqTm_refine_df712bf0b370bc497367bb8c0c0dcc31))

:named haseqTm_refine_df712bf0b370bc497367bb8c0c0dcc31))
(declare-fun Problem01.prefix (Term Term) Term)

(declare-fun Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,46-20,92); use=Problem01.fst(21,8-21,14)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b))

:named refinement_kinding_Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,46-20,92); use=Problem01.fst(21,8-21,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.bool)

;; def=Problem01.fst(20,55-20,90); use=Problem01.fst(21,8-21,14)
(iff 
;; def=Problem01.fst(20,47-20,48); use=Problem01.fst(21,8-21,14)
(BoxBool_proj_0 @x1)


;; def=Problem01.fst(20,62-20,90); use=Problem01.fst(21,8-21,14)
(exists ((@x4 Term))
 (! (and (HasType @x4
(Prims.list Prims.nat))

;; def=Problem01.fst(20,73-20,89); use=Problem01.fst(21,8-21,14)
(= (FStar.List.Tot.Base.append Prims.nat
@x2
@x4)
@x3)
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b.1))
)
))
...
(Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b @x2
@x3)))
:qid refinement_interpretation_Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b))

:named refinement_interpretation_Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,46-20,92); use=Problem01.fst(21,8-21,14)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b @x0
@x1)))
(Valid (Prims.hasEq Prims.bool)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b @x0
@x1))))
:qid haseqTm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b))

:named haseqTm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b))
;;;;;;;;;;;;;;;;p: Prims.list Prims.nat -> str: Prims.list Prims.nat {p << p \/ p === p /\ str << str}   -> b: Prims.bool{b <==> (exists (l: Prims.list Prims.nat). p @ l = str)}
(declare-fun Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f
Tm_type)
:named kinding_Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(20,12-25,57)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f))
:qid Problem01_pre_typing_Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f))

:named Problem01_pre_typing_Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(20,12-25,57)
(forall ((@x0 Term))
...
(Prims.list Prims.nat))
(HasType @x2
(Tm_refine_df712bf0b370bc497367bb8c0c0dcc31 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
(Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b @x1
@x2)))
...
@x1)
@x2))
:qid Problem01_interpretation_Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Problem01_interpretation_Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f))
:qid Problem01_interpretation_Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f))

:named Problem01_interpretation_Tm_arrow_6a71b1b079bc973d7e4e13bc678d090f))
(declare-fun Problem01.prefix@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(21,8-21,14); use=Problem01.fst(21,8-21,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Problem01.prefix@tok
@x0)
@x1)
(Problem01.prefix @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Problem01.prefix@tok
@x0)
@x1))
:qid token_correspondence_Problem01.prefix))

:named token_correspondence_Problem01.prefix))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(21,8-21,14); use=Problem01.fst(21,8-21,14)
...
:pattern ((Problem01.prefix @x1
@x2))
:qid function_token_typing_Problem01.prefix.1))
)
 

:pattern ((ApplyTT @x0
Problem01.prefix@tok))
:qid function_token_typing_Problem01.prefix))

:named function_token_typing_Problem01.prefix))
...
(Prims.list Prims.nat))
(HasType @x1
(Tm_refine_df712bf0b370bc497367bb8c0c0dcc31 @x0)))
(HasType (Problem01.prefix @x0
@x1)
(Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b @x0
@x1)))
 

:pattern ((Problem01.prefix @x0
@x1))
:qid typing_Problem01.prefix))

:named typing_Problem01.prefix))
...
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78
Tm_type)
:named refinement_kinding_Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,46-20,92); use=Problem01.fst(22,2-25,57)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78)
(and (HasTypeFuel @u0
@x1
Prims.bool)

;; def=Problem01.fst(20,55-20,90); use=Problem01.fst(22,2-25,57)
(iff 
;; def=Problem01.fst(20,47-20,48); use=Problem01.fst(22,2-25,57)
(BoxBool_proj_0 @x1)


;; def=Problem01.fst(20,62-20,90); use=Problem01.fst(22,2-25,57)
(exists ((@x2 Term))
 (! (and (HasType @x2
(Prims.list Prims.nat))

;; def=Problem01.fst(20,73-20,89); use=Problem01.fst(22,2-25,57)
(= (FStar.List.Tot.Base.append Prims.nat
x_b46f9febde162e476374095e6787c208_0
@x2)
x_b46f9febde162e476374095e6787c208_1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78.1))
)
))
...
@x1
Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78))
:qid refinement_interpretation_Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78))

:named refinement_interpretation_Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78))
;;;;;;;;;;;;;;;;haseq for Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78))
(Valid (Prims.hasEq Prims.bool)))
:named haseqTm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78))





; Encoding query formula : (forall (b: Prims.bool) (l: Prims.list Prims.nat).
;     (*  - Subtyping check failed
;   - Expected type Prims.eqtype got type Type0
; *)
;     Prims.hasEq (Prims.list Prims.nat)) /\
; (forall (k: Prims.pure_post (b: Prims.bool{b <==> (exists (l: Prims.list Prims.nat). p @ l = str)}))
;   .
;     (forall (x: b: Prims.bool{b <==> (exists (l: Prims.list Prims.nat). p @ l = str)}).
;         {:pattern Prims.guard_free (k x)}
;         Prims.auto_squash (k x)) ==>
;     (~(Nil? (p, str)._1) /\ ~(Cons? (p, str)._1 && Nil? (p, str)._2) /\
;       ~(Cons? (p, str)._1 && Cons? (p, str)._2) ==>
;       Prims.l_False) /\
;     (forall (b: Prims.list Prims.nat).
;         (p, str) == ([], b) ==> (exists (l: Prims.list Prims.nat). p @ l = str)) /\
;     (~(Nil? (p, str)._1) ==>
;       (forall (b: Prims.nat) (b: Prims.list Prims.nat).
;           (p, str) == (b :: b, []) ==> ~(exists (l: Prims.list Prims.nat). p @ l = str)) /\
;       (~(Cons? (p, str)._1 && Nil? (p, str)._2) ==>
;         (forall (b: Prims.nat) (b: Prims.list Prims.nat) (b: Prims.nat) (b: Prims.list Prims.nat).
;             (p, str) == (b :: b, b :: b) ==>
;             (forall (b: Prims.bool) (l: Prims.list Prims.nat).
;                 (*  - Subtyping check failed
;   - Expected type Prims.eqtype got type Type0
...
;                     (forall (k:
;                         Prims.pure_post (b:
;                             Prims.bool{b <==> (exists (l: Prims.list Prims.nat). p @ l = str)})).
;                         (forall (x:
;                             b: Prims.bool{b <==> (exists (l: Prims.list Prims.nat). p @ l = str)}).
;                             {:pattern Prims.guard_free (k x)}
;                             Prims.auto_squash (k x)) ==>
;                         (b = b == true ==>
;                           (b << p \/ b === p /\ b << str) /\
...
;                               (forall (any_result:
;                                   b:
;                                   Prims.bool{b <==> (exists (l: Prims.list Prims.nat). b @ l = b)}).
;                                   Problem01.prefix b b == any_result ==>
;                                   (Problem01.prefix b b <==>
;                                     (exists (l: Prims.list Prims.nat). b @ l = b)) ==>
;                                   (Problem01.prefix b b <==>
;                                     (exists (l: Prims.list Prims.nat). p @ l = str))))) /\
;                         (~(b = b = true) ==>
;                           (forall (b: Prims.bool).
;                               b = b == b ==> ~(exists (l: Prims.list Prims.nat). p @ l = str))))))))
;     ))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec prefix`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(22,2-25,57)
(and 
;; def=dummy(0,0-0,0); use=Problem01.fst(22,2-25,57)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.bool)
(HasType @x1
...
;; def=Prims.fst(73,23-73,30); use=Problem01.fst(21,8-21,14)
(or label_1

;; def=Prims.fst(73,23-73,30); use=Problem01.fst(22,2-25,57)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Problem01.fst(22,2-25,57)
(Prims.hasEq (Prims.list Prims.nat))
)
...
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Tm_refine_18fe7e4e1ba326bd47cac6f27d1d2f78))

;; def=Prims.fst(402,27-402,88); use=Problem01.fst(22,2-25,57)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Problem01.fst(22,2-25,57)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Problem01.fst(22,2-25,57)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(22,2-25,57)
(and (implies 
;; def=Problem01.fst(23,4-25,16); use=Problem01.fst(23,4-25,16)
(and 
;; def=Problem01.fst(23,4-23,9); use=Problem01.fst(23,4-23,9)
(not 
;; def=Problem01.fst(23,4-23,9); use=Problem01.fst(23,4-23,9)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.nat
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list Prims.nat)
(Prims.list Prims.nat)
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.nat)
(Prims.list Prims.nat)
x_b46f9febde162e476374095e6787c208_0
x_b46f9febde162e476374095e6787c208_1))))
)
...
;; def=Problem01.fst(24,4-24,12); use=Problem01.fst(24,4-24,12)
(not 
;; def=Problem01.fst(24,4-24,12); use=Problem01.fst(24,4-24,12)
(and (BoxBool_proj_0 (Prims.uu___is_Cons Prims.nat
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list Prims.nat)
(Prims.list Prims.nat)
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
x_b46f9febde162e476374095e6787c208_1))))
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.nat
(FStar.Pervasives.Native.__proj__Mktuple2__item___2 (Prims.list Prims.nat)
(Prims.list Prims.nat)
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.nat)
(Prims.list Prims.nat)
x_b46f9febde162e476374095e6787c208_0
...
;; def=Problem01.fst(25,4-25,16); use=Problem01.fst(25,4-25,16)
(not 
;; def=Problem01.fst(25,4-25,16); use=Problem01.fst(25,4-25,16)
(and (BoxBool_proj_0 (Prims.uu___is_Cons Prims.nat
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list Prims.nat)
...
;; def=Prims.fst(413,99-413,120); use=Problem01.fst(22,2-25,57)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.list Prims.nat))

;; def=Problem01.fst(22,8-23,9); use=Problem01.fst(22,8-23,9)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.nat)
(Prims.list Prims.nat)
x_b46f9febde162e476374095e6787c208_0
x_b46f9febde162e476374095e6787c208_1)
...
;; def=Problem01.fst(20,62-20,90); use=Problem01.fst(23,13-23,17)
(or label_3
...
;; def=Problem01.fst(20,73-20,89); use=Problem01.fst(23,13-23,17)
(= (FStar.List.Tot.Base.append Prims.nat
x_b46f9febde162e476374095e6787c208_0
@x2)
x_b46f9febde162e476374095e6787c208_1)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Problem01.fst(22,2-25,57)
(not 
;; def=Problem01.fst(23,4-23,9); use=Problem01.fst(23,4-23,9)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.nat
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list Prims.nat)
...
;; def=Prims.fst(389,2-389,39); use=Problem01.fst(22,2-25,57)
(and 
;; def=Prims.fst(413,99-413,120); use=Problem01.fst(22,2-25,57)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=Problem01.fst(22,8-24,12); use=Problem01.fst(22,8-24,12)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.nat)
(Prims.list Prims.nat)
x_b46f9febde162e476374095e6787c208_0
x_b46f9febde162e476374095e6787c208_1)
...
;; def=Problem01.fst(20,62-20,90); use=Problem01.fst(24,16-24,21)
(or label_4
...
;; def=Problem01.fst(20,73-20,89); use=Problem01.fst(24,16-24,21)
(= (FStar.List.Tot.Base.append Prims.nat
x_b46f9febde162e476374095e6787c208_0
@x3)
x_b46f9febde162e476374095e6787c208_1)
...
;; def=Problem01.fst(22,8-25,16); use=Problem01.fst(22,8-25,16)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.nat)
(Prims.list Prims.nat)
x_b46f9febde162e476374095e6787c208_0
x_b46f9febde162e476374095e6787c208_1)
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(22,2-25,57)
(and 
;; def=dummy(0,0-0,0); use=Problem01.fst(25,20-25,57)
...
;; def=Prims.fst(73,23-73,30); use=Problem01.fst(25,20-25,57)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Problem01.fst(25,20-25,57)
(Prims.hasEq (Prims.list Prims.nat))
)
...
;; def=Prims.fst(73,23-73,30); use=Problem01.fst(25,23-25,24)
(or label_6
...
;; def=Prims.fst(451,66-451,102); use=Problem01.fst(22,2-25,57)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Tm_type)

;; def=Prims.fst(588,31-588,32); use=Problem01.fst(22,2-25,57)
(= Prims.nat
@x5)
)
...
;; def=Problem01.fst(25,23-25,29); use=Problem01.fst(25,23-25,29)
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(22,2-25,57)
(and 
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(25,44-25,46)
(or label_7

;; def=Problem01.fst(22,2-25,57); use=Problem01.fst(25,44-25,46)
(Valid 
;; def=Problem01.fst(22,2-25,57); use=Problem01.fst(25,44-25,46)
(Prims.precedes (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(25,44-25,46)
(and 
;; def=Problem01.fst(20,12-21,16); use=Problem01.fst(25,44-25,46)
(Valid 
;; def=Problem01.fst(20,12-21,16); use=Problem01.fst(25,44-25,46)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
;; def=Problem01.fst(20,26-25,16); use=Problem01.fst(22,2-25,57)
(= @x4
@x8)
)
...
;; def=Problem01.fst(20,46-25,46); use=Problem01.fst(22,2-25,57)
(= (Problem01.prefix @x2
@x4)
@x9)


;; def=Problem01.fst(20,55-20,90); use=Problem01.fst(25,35-25,46)
(iff 
;; def=Problem01.fst(20,47-20,48); use=Problem01.fst(25,35-25,46)
(BoxBool_proj_0 (Problem01.prefix @x2
@x4))


;; def=Problem01.fst(20,62-20,90); use=Problem01.fst(25,35-25,46)
(exists ((@x10 Term))
 (! (and (HasType @x10
(Prims.list Prims.nat))

;; def=Problem01.fst(20,73-20,89); use=Problem01.fst(25,35-25,46)
(= (FStar.List.Tot.Base.append Prims.nat
@x2
@x10)
@x4)
...
;; def=Problem01.fst(25,23-25,57); use=Problem01.fst(25,23-25,57)
(= (Prims.op_Equality Prims.nat
@x1
@x3)
@x8)
...
;; def=Problem01.fst(20,62-20,90); use=Problem01.fst(25,52-25,57)
(or label_9
...
;; def=Problem01.fst(20,73-20,89); use=Problem01.fst(25,52-25,57)
(= (FStar.List.Tot.Base.append Prims.nat
x_b46f9febde162e476374095e6787c208_0
@x9)
x_b46f9febde162e476374095e6787c208_1)
...
; Starting query at Problem01.fst(21,0-25,57)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_db1bd60f3b07549131b025d19b6390be (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(21,0-25,57)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_db1bd60f3b07549131b025d19b6390be @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_db1bd60f3b07549131b025d19b6390be @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_db1bd60f3b07549131b025d19b6390be))

:named refinement_kinding_Tm_refine_db1bd60f3b07549131b025d19b6390be))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(21,0-25,57)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_db1bd60f3b07549131b025d19b6390be @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(21,0-25,57)
(and 
;; def=Problem01.fst(20,12-21,16); use=Problem01.fst(21,0-25,57)
(Valid 
;; def=Problem01.fst(20,12-21,16); use=Problem01.fst(21,0-25,57)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_db1bd60f3b07549131b025d19b6390be))

:named refinement_interpretation_Tm_refine_db1bd60f3b07549131b025d19b6390be))
;;;;;;;;;;;;;;;;haseq for Tm_refine_db1bd60f3b07549131b025d19b6390be
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(20,12-25,57); use=Problem01.fst(21,0-25,57)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_db1bd60f3b07549131b025d19b6390be @x0
@x1
@x2)))
(Valid (Prims.hasEq (Prims.list Prims.nat))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_db1bd60f3b07549131b025d19b6390be @x0
@x1
@x2))))
:qid haseqTm_refine_db1bd60f3b07549131b025d19b6390be))

:named haseqTm_refine_db1bd60f3b07549131b025d19b6390be))

; Encoding query formula : forall (p: Prims.list Prims.nat)
;   (str: Prims.list Prims.nat)
;   (p: Prims.list Prims.nat)
;   (str: Prims.list Prims.nat {p << p \/ p === p /\ str << str}).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (b: Prims.bool) (l: Prims.list Prims.nat).
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Problem01.fst(21,0-25,57)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
(Prims.list Prims.nat))
(HasType @x1
...
; encoding sigelt let rec prefix


; <Start encoding let rec prefix>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Problem01.prefix.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Problem01.prefix.fuel_instrumented_token () Term)
(declare-fun Problem01.prefix (Term Term) Term)
(declare-fun Problem01.prefix@tok () Term)
(declare-fun Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b (Term Term) Term)

;;;;;;;;;;;;;;;;p: Prims.list Prims.nat -> str: Prims.list Prims.nat   -> b: Prims.bool{b <==> (exists (l: Prims.list Prims.nat). p @ l = str)}
(declare-fun Tm_arrow_4ffe243c82de1354cf852cf1ce7f7c3d () Term)


; </end encoding let rec prefix>


; encoding sigelt val Problem01.remove_elem_from_list


; <Skipped val Problem01.remove_elem_from_list/>
...
; Starting query at Problem01.fst(29,2-30,65)
...
(Prims.list Prims.nat))
:named binder_x_b46f9febde162e476374095e6787c208_0))
;;;;;;;;;;;;;;;;i : i: Prims.nat{i < FStar.List.Tot.Base.length p} (i: Prims.nat{i < FStar.List.Tot.Base.length p})
(declare-fun x_cead0a6ed392996b481ea4c63547a885_1 () Term)
(declare-fun Tm_refine_f7dce0fb4d4620c1462f9a7589022c50 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_f7dce0fb4d4620c1462f9a7589022c50
Tm_type)
:named refinement_kinding_Tm_refine_f7dce0fb4d4620c1462f9a7589022c50))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(27,41-27,60); use=Problem01.fst(28,8-28,29)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f7dce0fb4d4620c1462f9a7589022c50)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(28,8-28,29)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.nat
x_b46f9febde162e476374095e6787c208_0)))
))
...
@x1
Tm_refine_f7dce0fb4d4620c1462f9a7589022c50))
:qid refinement_interpretation_Tm_refine_f7dce0fb4d4620c1462f9a7589022c50))

:named refinement_interpretation_Tm_refine_f7dce0fb4d4620c1462f9a7589022c50))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f7dce0fb4d4620c1462f9a7589022c50
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_f7dce0fb4d4620c1462f9a7589022c50))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_f7dce0fb4d4620c1462f9a7589022c50))
;;;;;;;;;;;;;;;;binder_x_cead0a6ed392996b481ea4c63547a885_1
;;; Fact-ids: 
(assert (! (HasType x_cead0a6ed392996b481ea4c63547a885_1
Tm_refine_f7dce0fb4d4620c1462f9a7589022c50)
:named binder_x_cead0a6ed392996b481ea4c63547a885_1))
(declare-fun Tm_refine_7a623dd1065a0ee513d9f577758a3d7e (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(27,27-30,65); use=Problem01.fst(27,27-30,65)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_7a623dd1065a0ee513d9f577758a3d7e @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_7a623dd1065a0ee513d9f577758a3d7e @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_7a623dd1065a0ee513d9f577758a3d7e))

:named refinement_kinding_Tm_refine_7a623dd1065a0ee513d9f577758a3d7e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(27,27-30,65); use=Problem01.fst(27,27-30,65)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7a623dd1065a0ee513d9f577758a3d7e @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
;; def=Problem01.fst(27,27-30,65); use=Problem01.fst(27,27-30,65)
(or 
;; def=Problem01.fst(29,2-30,65); use=Problem01.fst(29,2-30,65)
(Valid 
;; def=Problem01.fst(29,2-30,65); use=Problem01.fst(29,2-30,65)
(Prims.precedes (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
;; def=Problem01.fst(27,27-30,65); use=Problem01.fst(27,27-30,65)
(and 
;; def=Problem01.fst(27,27-28,31); use=Problem01.fst(27,27-28,31)
(Valid 
;; def=Problem01.fst(27,27-28,31); use=Problem01.fst(27,27-28,31)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
Prims.nat
@x1
x_cead0a6ed392996b481ea4c63547a885_1)
)
)
)
...
@x1
(Tm_refine_7a623dd1065a0ee513d9f577758a3d7e @x2)))
:qid refinement_interpretation_Tm_refine_7a623dd1065a0ee513d9f577758a3d7e))

:named refinement_interpretation_Tm_refine_7a623dd1065a0ee513d9f577758a3d7e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7a623dd1065a0ee513d9f577758a3d7e
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(27,27-30,65); use=Problem01.fst(27,27-30,65)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7a623dd1065a0ee513d9f577758a3d7e @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7a623dd1065a0ee513d9f577758a3d7e @x0))))
:qid haseqTm_refine_7a623dd1065a0ee513d9f577758a3d7e))

:named haseqTm_refine_7a623dd1065a0ee513d9f577758a3d7e))
(declare-fun Problem01.remove_elem_from_list (Term Term) Term)

;;;;;;;;;;;;;;;;p: Prims.list Prims.nat ->     i: (i: Prims.nat{i < FStar.List.Tot.Base.length p}){p << p \/ p === p /\ i << i}   -> Prims.list Prims.nat
(declare-fun Tm_arrow_96db75591f9ecd5b8035dddcc75127a8 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_96db75591f9ecd5b8035dddcc75127a8
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_96db75591f9ecd5b8035dddcc75127a8
Tm_type)
:named kinding_Tm_arrow_96db75591f9ecd5b8035dddcc75127a8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(27,27-30,65); use=Problem01.fst(27,27-30,65)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_96db75591f9ecd5b8035dddcc75127a8)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_96db75591f9ecd5b8035dddcc75127a8))
:qid Problem01_pre_typing_Tm_arrow_96db75591f9ecd5b8035dddcc75127a8))

:named Problem01_pre_typing_Tm_arrow_96db75591f9ecd5b8035dddcc75127a8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_96db75591f9ecd5b8035dddcc75127a8
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(27,27-30,65); use=Problem01.fst(27,27-30,65)
(forall ((@x0 Term))
...
(Prims.list Prims.nat))
(HasType @x2
(Tm_refine_7a623dd1065a0ee513d9f577758a3d7e @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
(Prims.list Prims.nat)))
...
@x1)
@x2))
:qid Problem01_interpretation_Tm_arrow_96db75591f9ecd5b8035dddcc75127a8.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Problem01_interpretation_Tm_arrow_96db75591f9ecd5b8035dddcc75127a8.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_96db75591f9ecd5b8035dddcc75127a8))
:qid Problem01_interpretation_Tm_arrow_96db75591f9ecd5b8035dddcc75127a8))

:named Problem01_interpretation_Tm_arrow_96db75591f9ecd5b8035dddcc75127a8))
(declare-fun Problem01.remove_elem_from_list@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(28,8-28,29); use=Problem01.fst(28,8-28,29)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Problem01.remove_elem_from_list@tok
@x0)
@x1)
(Problem01.remove_elem_from_list @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Problem01.remove_elem_from_list@tok
@x0)
@x1))
:qid token_correspondence_Problem01.remove_elem_from_list))

:named token_correspondence_Problem01.remove_elem_from_list))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(28,8-28,29); use=Problem01.fst(28,8-28,29)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Problem01.remove_elem_from_list@tok
Tm_arrow_96db75591f9ecd5b8035dddcc75127a8))
...
@x1)
@x2)
(Problem01.remove_elem_from_list @x1
@x2))
 

:pattern ((Problem01.remove_elem_from_list @x1
@x2))
:qid function_token_typing_Problem01.remove_elem_from_list.1))
)
 

:pattern ((ApplyTT @x0
Problem01.remove_elem_from_list@tok))
:qid function_token_typing_Problem01.remove_elem_from_list))

:named function_token_typing_Problem01.remove_elem_from_list))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(28,8-28,29); use=Problem01.fst(28,8-28,29)
...
(Prims.list Prims.nat))
(HasType @x1
(Tm_refine_7a623dd1065a0ee513d9f577758a3d7e @x0)))
(HasType (Problem01.remove_elem_from_list @x0
@x1)
(Prims.list Prims.nat)))
 

:pattern ((Problem01.remove_elem_from_list @x0
@x1))
:qid typing_Problem01.remove_elem_from_list))

:named typing_Problem01.remove_elem_from_list))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : (~(Cons? p) ==> Prims.l_False) /\
; (forall (b: Prims.nat) (b: Prims.list Prims.nat).
;     p == b :: b ==>
;     (forall (k: Prims.pure_post (Prims.list Prims.nat)).
;         (forall (x: Prims.list Prims.nat). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)
;         ) ==>
;         ~(i = 0 = true) ==>
;         (forall (b: Prims.bool).
;             i = 0 == b ==>
;             i - 1 >= 0 /\ i - 1 < FStar.List.Tot.Base.length b /\ (b << p \/ b === p /\ i - 1 << i))
;     ))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec remove_elem_from_list`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(29,2-30,65)
(and (implies 
;; def=Problem01.fst(28,30-28,31); use=Problem01.fst(29,8-29,9)
(not 
;; def=Problem01.fst(28,30-28,31); use=Problem01.fst(29,8-29,9)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.nat
x_b46f9febde162e476374095e6787c208_0))
...
;; def=Prims.fst(413,99-413,120); use=Problem01.fst(29,2-30,65)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
...
;; def=Problem01.fst(28,30-30,8); use=Problem01.fst(29,8-30,8)
(= x_b46f9febde162e476374095e6787c208_0
(Prims.Cons Prims.nat
@x0
@x1))
...
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.pure_post (Prims.list Prims.nat)))

;; def=Prims.fst(402,27-402,88); use=Problem01.fst(29,2-30,65)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Problem01.fst(29,2-30,65)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Problem01.fst(29,2-30,65)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(389,19-389,21); use=Problem01.fst(29,2-30,65)
(not 
;; def=Problem01.fst(30,15-30,20); use=Problem01.fst(30,15-30,20)
...
;; def=Problem01.fst(30,15-30,65); use=Problem01.fst(30,15-30,65)
(= (Prims.op_Equality Prims.int
x_cead0a6ed392996b481ea4c63547a885_1
(BoxInt 0))
@x3)
...
;; def=Problem01.fst(27,27-30,65); use=Problem01.fst(30,60-30,65)
(and 
;; def=Prims.fst(680,18-680,24); use=Problem01.fst(30,60-30,65)
(or label_2

;; def=Prims.fst(680,18-680,24); use=Problem01.fst(30,60-30,65)
(>= (BoxInt_proj_0 (Prims.op_Subtraction x_cead0a6ed392996b481ea4c63547a885_1
(BoxInt 1)))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(30,60-30,65)
(or label_3
...
;; def=Problem01.fst(29,2-30,65); use=Problem01.fst(30,60-30,65)
(Valid 
;; def=Problem01.fst(29,2-30,65); use=Problem01.fst(30,60-30,65)
(Prims.precedes (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
;; def=Problem01.fst(27,27-30,65); use=Problem01.fst(30,60-30,65)
(and 
;; def=Problem01.fst(27,27-28,31); use=Problem01.fst(30,60-30,65)
(Valid 
;; def=Problem01.fst(27,27-28,31); use=Problem01.fst(30,60-30,65)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
(Prims.precedes Prims.nat
Prims.nat
(Prims.op_Subtraction x_cead0a6ed392996b481ea4c63547a885_1
(BoxInt 1))
x_cead0a6ed392996b481ea4c63547a885_1)
)
)
...
; encoding sigelt let rec remove_elem_from_list


; <Start encoding let rec remove_elem_from_list>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Problem01.remove_elem_from_list.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Problem01.remove_elem_from_list.fuel_instrumented_token () Term)
(declare-fun Problem01.remove_elem_from_list (Term Term) Term)
(declare-fun Problem01.remove_elem_from_list@tok () Term)
(declare-fun Tm_refine_500911408eb15f82fac1b31c6fbc48ba (Term) Term)


;;;;;;;;;;;;;;;;p: Prims.list Prims.nat -> i: Prims.nat{i < FStar.List.Tot.Base.length p} -> Prims.list Prims.nat
(declare-fun Tm_arrow_5b72ea38e9ea9bc8676731889bad199e () Term)

; </end encoding let rec remove_elem_from_list>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Problem01.remove_elem_from_list; Namespace Problem01
(assert (! 
;; def=Problem01.fst(27,41-27,60); use=Problem01.fst(28,8-28,29)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_500911408eb15f82fac1b31c6fbc48ba))

:named refinement_kinding_Tm_refine_500911408eb15f82fac1b31c6fbc48ba))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Problem01.remove_elem_from_list; Namespace Problem01
(assert (! 
;; def=Problem01.fst(27,41-27,60); use=Problem01.fst(28,8-28,29)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
@x1
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x2)))
:qid refinement_interpretation_Tm_refine_500911408eb15f82fac1b31c6fbc48ba))

:named refinement_interpretation_Tm_refine_500911408eb15f82fac1b31c6fbc48ba))
;;;;;;;;;;;;;;;;haseq for Tm_refine_500911408eb15f82fac1b31c6fbc48ba
;;; Fact-ids: Name Problem01.remove_elem_from_list; Namespace Problem01
(assert (! 
;; def=Problem01.fst(27,41-27,60); use=Problem01.fst(28,8-28,29)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x0))))
:qid haseqTm_refine_500911408eb15f82fac1b31c6fbc48ba))

:named haseqTm_refine_500911408eb15f82fac1b31c6fbc48ba))
(push) ;; push{2

; Starting query at Problem01.fst(32,0-33,88)
...
;   - Expected type Type0 got type Type0
; *)
;   forall (b: Prims.bool). b ==> (forall (i: Prims.nat). i <= n ==> i < FStar.List.Tot.Base.length p)


; Context: While encoding a query
; While typechecking the top-level declaration `val Problem01.test_prefix`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Problem01.fst(32,0-33,88)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(Prims.list Prims.nat))
(HasType @x1
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x0))
(HasType @x2
(Prims.list Prims.nat)))

;; def=dummy(0,0-0,0); use=Problem01.fst(32,19-33,88)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.bool)

;; def=Problem01.fst(33,7-33,8); use=Problem01.fst(33,14-33,15)
(BoxBool_proj_0 @x3)
)

;; def=dummy(0,0-0,0); use=Problem01.fst(33,14-33,86)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Problem01.fst(33,37-33,43); use=Problem01.fst(33,37-33,43)
(<= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 @x1))
)

;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(33,79-33,80)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Problem01.test_prefix, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_500911408eb15f82fac1b31c6fbc48ba
...
; encoding sigelt val Problem01.test_prefix


; <Skipped val Problem01.test_prefix/>
...
:named typing_Problem01.remove_elem_from_list))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Problem01.prefix; Namespace Problem01
(assert (! 
;; def=Problem01.fst(21,8-21,14); use=Problem01.fst(21,8-21,14)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(Prims.list Prims.nat))
(HasType @x2
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x1)))
(HasType (Problem01.remove_elem_from_list.fuel_instrumented @u0
@x1
@x2)
(Prims.list Prims.nat)))
 

:pattern ((Problem01.remove_elem_from_list.fuel_instrumented @u0
@x1
@x2))
:qid token_correspondence_Problem01.remove_elem_from_list.fuel_instrumented))

:named token_correspondence_Problem01.remove_elem_from_list.fuel_instrumented))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name Problem01.prefix; Namespace Problem01
(assert (! 
;; def=Problem01.fst(21,8-21,14); use=Problem01.fst(21,8-21,14)
...
(HasType @x2
(Prims.list Prims.nat)))
(HasType (Problem01.prefix.fuel_instrumented @u0
@x1
@x2)
(Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b @x1
@x2)))
...
:pattern ((Problem01.prefix.fuel_instrumented @u0
@x1
@x2))
:qid token_correspondence_Problem01.prefix.fuel_instrumented))

:named token_correspondence_Problem01.prefix.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Problem01.prefix; Namespace Problem01
(assert (! 
;; def=Problem01.fst(20,46-20,92); use=Problem01.fst(21,8-21,14)
...
:named haseqTm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Problem01.remove_elem_from_list
;;; Fact-ids: Name Problem01.remove_elem_from_list; Namespace Problem01
(assert (! 
;; def=Problem01.fst(28,8-28,29); use=Problem01.fst(28,8-28,29)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x1)))
(= (Problem01.remove_elem_from_list.fuel_instrumented (SFuel @u0)
@x1
@x2)
(let ((@lb3 @x1))
(ite (is-Prims.Cons @lb3)
...
(Prims.Cons Prims.nat
(Prims.Cons_hd @lb3)
(Problem01.remove_elem_from_list.fuel_instrumented @u0
(Prims.Cons_tl @lb3)
...
:pattern ((Problem01.remove_elem_from_list.fuel_instrumented (SFuel @u0)
@x1
@x2))
:qid equation_with_fuel_Problem01.remove_elem_from_list.fuel_instrumented))

:named equation_with_fuel_Problem01.remove_elem_from_list.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Problem01.prefix
;;; Fact-ids: Name Problem01.prefix; Namespace Problem01
(assert (! 
;; def=Problem01.fst(21,8-21,14); use=Problem01.fst(21,8-21,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Prims.list Prims.nat)))
(= (Problem01.prefix.fuel_instrumented (SFuel @u0)
@x1
@x2)
(let ((@lb3 (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.nat)
(Prims.list Prims.nat)
@x1
@x2)))
...
(is-Prims.Nil (FStar.Pervasives.Native.Mktuple2__2 @lb3)))
(BoxBool false)
(ite (and (is-Prims.Cons (FStar.Pervasives.Native.Mktuple2__1 @lb3))
...
(ite (= @lb4
(BoxBool true))
(Problem01.prefix.fuel_instrumented @u0
...
:pattern ((Problem01.prefix.fuel_instrumented (SFuel @u0)
@x1
@x2))
:qid equation_with_fuel_Problem01.prefix.fuel_instrumented))

:named equation_with_fuel_Problem01.prefix.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Problem01.remove_elem_from_list; Namespace Problem01
(assert (! 
;; def=Problem01.fst(28,8-28,29); use=Problem01.fst(28,8-28,29)
...
@x1
@x2)
(Problem01.remove_elem_from_list.fuel_instrumented ZFuel
@x1
@x2))
...
@x1
@x2))
:qid @fuel_irrelevance_Problem01.remove_elem_from_list.fuel_instrumented))

:named @fuel_irrelevance_Problem01.remove_elem_from_list.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Problem01.prefix; Namespace Problem01
(assert (! 
;; def=Problem01.fst(21,8-21,14); use=Problem01.fst(21,8-21,14)
...
@x1
@x2)
(Problem01.prefix.fuel_instrumented ZFuel
@x1
@x2))
...
@x1
@x2))
:qid @fuel_irrelevance_Problem01.prefix.fuel_instrumented))

:named @fuel_irrelevance_Problem01.prefix.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name Problem01.remove_elem_from_list; Namespace Problem01
(assert (! 
;; def=Problem01.fst(28,8-28,29); use=Problem01.fst(28,8-28,29)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Problem01.remove_elem_from_list @x0
@x1)
(Problem01.remove_elem_from_list.fuel_instrumented MaxFuel
@x0
@x1))
...
:pattern ((Problem01.remove_elem_from_list @x0
@x1))
:qid @fuel_correspondence_Problem01.remove_elem_from_list.fuel_instrumented))

:named @fuel_correspondence_Problem01.remove_elem_from_list.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name Problem01.prefix; Namespace Problem01
(assert (! 
;; def=Problem01.fst(21,8-21,14); use=Problem01.fst(21,8-21,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Problem01.prefix @x0
@x1)
(Problem01.prefix.fuel_instrumented MaxFuel
@x0
@x1))
...
:pattern ((Problem01.prefix @x0
@x1))
:qid @fuel_correspondence_Problem01.prefix.fuel_instrumented))

:named @fuel_correspondence_Problem01.prefix.fuel_instrumented))
(push) ;; push{2

; Starting query at Problem01.fst(35,2-37,76)
...
(Prims.list Prims.nat))
:named binder_x_b46f9febde162e476374095e6787c208_0))
;;;;;;;;;;;;;;;;n : n: Prims.nat{n < FStar.List.Tot.Base.length p} (n: Prims.nat{n < FStar.List.Tot.Base.length p})
(declare-fun x_cead0a6ed392996b481ea4c63547a885_1 () Term)
(declare-fun Tm_refine_f7dce0fb4d4620c1462f9a7589022c50 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
...
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,31-32,50); use=Problem01.fst(34,8-34,19)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f7dce0fb4d4620c1462f9a7589022c50)
...
;; def=Problem01.fst(32,37-32,49); use=Problem01.fst(34,8-34,19)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.nat
x_b46f9febde162e476374095e6787c208_0)))
))
...
(declare-fun Tm_refine_1abc69c281fa085ba969c2e835b0e058 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(32,17-37,76)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_1abc69c281fa085ba969c2e835b0e058 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_1abc69c281fa085ba969c2e835b0e058 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_1abc69c281fa085ba969c2e835b0e058))

:named refinement_kinding_Tm_refine_1abc69c281fa085ba969c2e835b0e058))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(32,17-37,76)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1abc69c281fa085ba969c2e835b0e058 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.nat))
...
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(32,17-37,76)
(or 
;; def=Problem01.fst(35,2-37,76); use=Problem01.fst(35,2-37,76)
(Valid 
;; def=Problem01.fst(35,2-37,76); use=Problem01.fst(35,2-37,76)
(Prims.precedes (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(32,17-37,76)
(and 
;; def=Problem01.fst(32,17-34,21); use=Problem01.fst(32,17-34,21)
(Valid 
;; def=Problem01.fst(32,17-34,21); use=Problem01.fst(32,17-34,21)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
;; def=Problem01.fst(32,31-37,76); use=Problem01.fst(32,31-37,76)
(or 
;; def=Problem01.fst(35,2-37,76); use=Problem01.fst(35,2-37,76)
(Valid 
;; def=Problem01.fst(35,2-37,76); use=Problem01.fst(35,2-37,76)
...
;; def=Problem01.fst(32,31-37,76); use=Problem01.fst(32,31-37,76)
(and 
;; def=Problem01.fst(32,31-34,23); use=Problem01.fst(32,31-34,23)
(Valid 
;; def=Problem01.fst(32,31-34,23); use=Problem01.fst(32,31-34,23)
...
(Tm_refine_1abc69c281fa085ba969c2e835b0e058 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_1abc69c281fa085ba969c2e835b0e058))

:named refinement_interpretation_Tm_refine_1abc69c281fa085ba969c2e835b0e058))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1abc69c281fa085ba969c2e835b0e058
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(32,17-37,76)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1abc69c281fa085ba969c2e835b0e058 @x0
@x1)))
(Valid (Prims.hasEq (Prims.list Prims.nat))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_1abc69c281fa085ba969c2e835b0e058 @x0
@x1))))
:qid haseqTm_refine_1abc69c281fa085ba969c2e835b0e058))

:named haseqTm_refine_1abc69c281fa085ba969c2e835b0e058))
(declare-fun Problem01.test_prefix (Term Term Term) Term)


(declare-fun Tm_refine_066ec34605b99f46d413e3ab3b1e988e (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(33,6-33,88); use=Problem01.fst(34,8-34,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_066ec34605b99f46d413e3ab3b1e988e @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_066ec34605b99f46d413e3ab3b1e988e @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_066ec34605b99f46d413e3ab3b1e988e))

:named refinement_kinding_Tm_refine_066ec34605b99f46d413e3ab3b1e988e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(33,6-33,88); use=Problem01.fst(34,8-34,19)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_066ec34605b99f46d413e3ab3b1e988e @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Problem01.fst(33,14-33,86); use=Problem01.fst(34,8-34,19)
(implies 
;; def=Problem01.fst(33,7-33,8); use=Problem01.fst(34,8-34,19)
(BoxBool_proj_0 @x1)


;; def=Problem01.fst(33,20-33,86); use=Problem01.fst(34,8-34,19)
(exists ((@x5 Term))
 (! (and (HasType @x5
Prims.nat)

;; def=Problem01.fst(33,37-33,43); use=Problem01.fst(34,8-34,19)
(<= (BoxInt_proj_0 @x5)
(BoxInt_proj_0 @x2))


;; def=Problem01.fst(33,47-33,85); use=Problem01.fst(34,8-34,19)
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list @x3
@x5)
@x4))
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_066ec34605b99f46d413e3ab3b1e988e.1))
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_066ec34605b99f46d413e3ab3b1e988e))

:named refinement_interpretation_Tm_refine_066ec34605b99f46d413e3ab3b1e988e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_066ec34605b99f46d413e3ab3b1e988e
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(33,6-33,88); use=Problem01.fst(34,8-34,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_066ec34605b99f46d413e3ab3b1e988e @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.bool)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_066ec34605b99f46d413e3ab3b1e988e @x0
@x1
@x2))))
:qid haseqTm_refine_066ec34605b99f46d413e3ab3b1e988e))

:named haseqTm_refine_066ec34605b99f46d413e3ab3b1e988e))
;;;;;;;;;;;;;;;;p: Prims.list Prims.nat ->     n: Prims.nat{n < FStar.List.Tot.Base.length p} ->     str: Prims.list Prims.nat {p << p \/ p === p /\ (n << n \/ n === n /\ str << str)}   -> b: Prims.bool{b ==> (exists (i: Prims.nat). i <= n /\ prefix (remove_elem_from_list p i) str)}
(declare-fun Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce
Tm_type)
:named kinding_Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(32,17-37,76)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce))
:qid Problem01_pre_typing_Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce))

:named Problem01_pre_typing_Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(32,17-37,76)
(forall ((@x0 Term))
...
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x1))
(HasType @x3
(Tm_refine_1abc69c281fa085ba969c2e835b0e058 @x1
@x2)))
...
@x2)
@x3))
:qid Problem01_interpretation_Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Problem01_interpretation_Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce.2))
...
@x1)
@x2))
:qid Problem01_interpretation_Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce))
:qid Problem01_interpretation_Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce))

:named Problem01_interpretation_Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce))
(declare-fun Problem01.test_prefix@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(34,8-34,19); use=Problem01.fst(34,8-34,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Problem01.test_prefix@tok
@x0)
@x1)
@x2)
(Problem01.test_prefix @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT Problem01.test_prefix@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Problem01.test_prefix))

:named token_correspondence_Problem01.test_prefix))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(34,8-34,19); use=Problem01.fst(34,8-34,19)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Problem01.test_prefix@tok
Tm_arrow_dbfee22136f8754d7794e57d2c3bd9ce))
...
@x2)
@x3)
(Problem01.test_prefix @x1
@x2
@x3))
 

:pattern ((Problem01.test_prefix @x1
@x2
@x3))
:qid function_token_typing_Problem01.test_prefix.1))
)
 

:pattern ((ApplyTT @x0
Problem01.test_prefix@tok))
:qid function_token_typing_Problem01.test_prefix))

:named function_token_typing_Problem01.test_prefix))
...
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x0))
(HasType @x2
(Tm_refine_1abc69c281fa085ba969c2e835b0e058 @x0
@x1)))
(HasType (Problem01.test_prefix @x0
@x1
@x2)
(Tm_refine_066ec34605b99f46d413e3ab3b1e988e @x1
@x0
@x2)))
 

:pattern ((Problem01.test_prefix @x0
@x1
@x2))
:qid typing_Problem01.test_prefix))

:named typing_Problem01.test_prefix))
(declare-fun label_8 () Bool)
(declare-fun label_7 () Bool)
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_3e6fb829d85ca3c8c655d368f1e75062 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_3e6fb829d85ca3c8c655d368f1e75062
Tm_type)
:named refinement_kinding_Tm_refine_3e6fb829d85ca3c8c655d368f1e75062))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(33,6-33,88); use=Problem01.fst(35,2-37,76)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_3e6fb829d85ca3c8c655d368f1e75062)
(and (HasTypeFuel @u0
@x1
Prims.bool)

;; def=Problem01.fst(33,14-33,86); use=Problem01.fst(35,2-37,76)
(implies 
;; def=Problem01.fst(33,7-33,8); use=Problem01.fst(35,2-37,76)
(BoxBool_proj_0 @x1)


;; def=Problem01.fst(33,20-33,86); use=Problem01.fst(35,2-37,76)
(exists ((@x2 Term))
 (! (and (HasType @x2
Prims.nat)

;; def=Problem01.fst(33,37-33,43); use=Problem01.fst(35,2-37,76)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 x_cead0a6ed392996b481ea4c63547a885_1))


;; def=Problem01.fst(33,47-33,85); use=Problem01.fst(35,2-37,76)
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list x_b46f9febde162e476374095e6787c208_0
@x2)
x_b46f9febde162e476374095e6787c208_2))
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_3e6fb829d85ca3c8c655d368f1e75062.1))
)
))
...
@x1
Tm_refine_3e6fb829d85ca3c8c655d368f1e75062))
:qid refinement_interpretation_Tm_refine_3e6fb829d85ca3c8c655d368f1e75062))

:named refinement_interpretation_Tm_refine_3e6fb829d85ca3c8c655d368f1e75062))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3e6fb829d85ca3c8c655d368f1e75062
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_3e6fb829d85ca3c8c655d368f1e75062))
(Valid (Prims.hasEq Prims.bool)))
:named haseqTm_refine_3e6fb829d85ca3c8c655d368f1e75062))



; Encoding query formula : (forall (b: Prims.bool). b ==> (forall (i: Prims.nat). i <= n ==> i < FStar.List.Tot.Base.length p)) /\
; (forall (k:
;     Prims.pure_post (b:
;         Prims.bool
;           { b ==>
...
;         Prims.auto_squash (k x)) ==>
;     (n == 0 ==>
;       (Problem01.prefix (Problem01.remove_elem_from_list p n) str <==>
;         (exists (l: Prims.list Prims.nat). Problem01.remove_elem_from_list p n @ l = str)) ==>
;       Problem01.prefix (Problem01.remove_elem_from_list p n) str ==>
;       (exists (i: Prims.nat). i <= n /\ Problem01.prefix (Problem01.remove_elem_from_list p i) str)) /\
;     (~(n = 0) ==>
;       (forall (b: Prims.int).
;           n == b ==>
;           b >= 0 /\ b < FStar.List.Tot.Base.length p /\
;           (~(Problem01.prefix (Problem01.remove_elem_from_list p b) str) ==>
;             b - 1 >= 0 /\ b - 1 < FStar.List.Tot.Base.length p /\
;             (forall (return_val: n: Prims.nat{n < FStar.List.Tot.Base.length p}).
;                 return_val == b - 1 ==> p << p \/ (b - 1 << n \/ b - 1 === n /\ str << str))) /\
;           (forall (any_result: Prims.bool).
;               (Problem01.prefix (Problem01.remove_elem_from_list p b) str ||
;               Problem01.test_prefix p (b - 1) str) ==
;               any_result ==>
;               Problem01.prefix (Problem01.remove_elem_from_list p b) str ||
;               Problem01.test_prefix p (b - 1) str ==>
;               (exists (i: Prims.nat).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec test_prefix`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(35,2-37,76)
(and 
;; def=dummy(0,0-0,0); use=Problem01.fst(35,2-37,76)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Prims.bool)
...
;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(35,2-37,76)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.nat
x_b46f9febde162e476374095e6787c208_0)))
)
...
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Tm_refine_3e6fb829d85ca3c8c655d368f1e75062))

;; def=Prims.fst(402,27-402,88); use=Problem01.fst(35,2-37,76)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Problem01.fst(35,2-37,76)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Problem01.fst(35,2-37,76)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,2-389,39); use=Problem01.fst(35,2-37,76)
(and (implies (and 
;; def=Problem01.fst(34,22-36,5); use=Problem01.fst(35,8-36,5)
(= x_cead0a6ed392996b481ea4c63547a885_1
(BoxInt 0))


;; def=Problem01.fst(20,55-20,90); use=Problem01.fst(36,9-36,47)
(iff 
;; def=Problem01.fst(20,47-20,48); use=Problem01.fst(36,9-36,47)
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list x_b46f9febde162e476374095e6787c208_0
x_cead0a6ed392996b481ea4c63547a885_1)
x_b46f9febde162e476374095e6787c208_2))


;; def=Problem01.fst(20,62-20,90); use=Problem01.fst(36,9-36,47)
(exists ((@x1 Term))
 (! (and (HasType @x1
(Prims.list Prims.nat))

;; def=Problem01.fst(20,73-20,89); use=Problem01.fst(36,9-36,47)
(= (FStar.List.Tot.Base.append Prims.nat
(Problem01.remove_elem_from_list x_b46f9febde162e476374095e6787c208_0
x_cead0a6ed392996b481ea4c63547a885_1)
@x1)
x_b46f9febde162e476374095e6787c208_2)
)
...
;; def=Problem01.fst(33,7-33,8); use=Problem01.fst(36,9-36,47)
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list x_b46f9febde162e476374095e6787c208_0
x_cead0a6ed392996b481ea4c63547a885_1)
x_b46f9febde162e476374095e6787c208_2))
)

;; def=Problem01.fst(33,20-33,86); use=Problem01.fst(36,9-36,47)
(or label_2
...
;; def=Problem01.fst(33,37-33,43); use=Problem01.fst(36,9-36,47)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 x_cead0a6ed392996b481ea4c63547a885_1))


;; def=Problem01.fst(33,47-33,85); use=Problem01.fst(36,9-36,47)
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list x_b46f9febde162e476374095e6787c208_0
@x1)
x_b46f9febde162e476374095e6787c208_2))
)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Problem01.fst(35,2-37,76)
(not 
;; def=Problem01.fst(34,22-36,5); use=Problem01.fst(35,8-36,5)
(= x_cead0a6ed392996b481ea4c63547a885_1
(BoxInt 0))
...
;; def=Prims.fst(413,99-413,120); use=Problem01.fst(35,2-37,76)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=Problem01.fst(34,22-37,5); use=Problem01.fst(35,8-37,5)
(= x_cead0a6ed392996b481ea4c63547a885_1
@x1)
)
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(35,2-37,76)
(and 
;; def=Prims.fst(680,18-680,24); use=Problem01.fst(37,41-37,42)
(or label_3
...
;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(37,41-37,42)
(or label_4
...
(implies 
;; def=Problem01.fst(37,9-37,47); use=Problem01.fst(37,9-37,47)
(not 
;; def=Problem01.fst(37,9-37,47); use=Problem01.fst(37,9-37,47)
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list x_b46f9febde162e476374095e6787c208_0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(37,9-37,76)
(and 
;; def=Prims.fst(680,18-680,24); use=Problem01.fst(37,65-37,72)
(or label_5
...
;; def=Problem01.fst(32,37-32,49); use=Problem01.fst(37,65-37,72)
(or label_6
...
;; def=Prims.fst(356,2-356,58); use=Problem01.fst(37,9-37,76)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_f7dce0fb4d4620c1462f9a7589022c50)

;; def=Prims.fst(356,26-356,41); use=Problem01.fst(37,9-37,76)
(= @x2
(Prims.op_Subtraction @x1
(BoxInt 1)))
)

;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(37,73-37,76)
(or label_7

;; def=Problem01.fst(35,2-37,76); use=Problem01.fst(37,73-37,76)
(Valid 
;; def=Problem01.fst(35,2-37,76); use=Problem01.fst(37,73-37,76)
(Prims.precedes (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
;; def=Problem01.fst(32,31-37,76); use=Problem01.fst(37,73-37,76)
(and 
;; def=Problem01.fst(32,31-34,23); use=Problem01.fst(37,73-37,76)
(Valid 
;; def=Problem01.fst(32,31-34,23); use=Problem01.fst(37,73-37,76)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Prims.fst(451,66-451,102); use=Problem01.fst(35,2-37,76)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.bool)

;; def=Problem01.fst(33,6-37,76); use=Problem01.fst(35,2-37,76)
(= (Prims.op_BarBar (Problem01.prefix (Problem01.remove_elem_from_list x_b46f9febde162e476374095e6787c208_0
@x1)
x_b46f9febde162e476374095e6787c208_2)
(Problem01.test_prefix x_b46f9febde162e476374095e6787c208_0
(Prims.op_Subtraction @x1
(BoxInt 1))
x_b46f9febde162e476374095e6787c208_2))
@x2)
...
;; def=Problem01.fst(33,7-33,8); use=Problem01.fst(37,9-37,76)
(or (BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list x_b46f9febde162e476374095e6787c208_0
@x1)
x_b46f9febde162e476374095e6787c208_2))
(BoxBool_proj_0 (Problem01.test_prefix x_b46f9febde162e476374095e6787c208_0
(Prims.op_Subtraction @x1
(BoxInt 1))
x_b46f9febde162e476374095e6787c208_2)))
)

;; def=Problem01.fst(33,20-33,86); use=Problem01.fst(37,9-37,76)
(or label_8
...
;; def=Problem01.fst(33,37-33,43); use=Problem01.fst(37,9-37,76)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 x_cead0a6ed392996b481ea4c63547a885_1))


;; def=Problem01.fst(33,47-33,85); use=Problem01.fst(37,9-37,76)
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list x_b46f9febde162e476374095e6787c208_0
@x3)
x_b46f9febde162e476374095e6787c208_2))
)
...
; Starting query at Problem01.fst(34,0-37,76)

(declare-fun label_1 () Bool)


(declare-fun Tm_refine_55d26841a30db6d8ee6ff4286be669aa (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(34,0-37,76)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_refine_55d26841a30db6d8ee6ff4286be669aa @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_refine_55d26841a30db6d8ee6ff4286be669aa @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid refinement_kinding_Tm_refine_55d26841a30db6d8ee6ff4286be669aa))

:named refinement_kinding_Tm_refine_55d26841a30db6d8ee6ff4286be669aa))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(34,0-37,76)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_55d26841a30db6d8ee6ff4286be669aa @x2
@x3
@x4
@x5
@x6))
...
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(34,0-37,76)
(and 
;; def=Problem01.fst(32,17-34,21); use=Problem01.fst(34,0-37,76)
(Valid 
;; def=Problem01.fst(32,17-34,21); use=Problem01.fst(34,0-37,76)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.nat)
(Prims.list Prims.nat)
...
;; def=Problem01.fst(32,31-37,76); use=Problem01.fst(34,0-37,76)
(or 
;; def=Problem01.fst(35,2-37,76); use=Problem01.fst(35,2-37,76)
(Valid 
;; def=Problem01.fst(35,2-37,76); use=Problem01.fst(35,2-37,76)
...
;; def=Problem01.fst(32,31-37,76); use=Problem01.fst(34,0-37,76)
(and 
;; def=Problem01.fst(32,31-34,23); use=Problem01.fst(34,0-37,76)
(Valid 
;; def=Problem01.fst(32,31-34,23); use=Problem01.fst(34,0-37,76)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
@x5
@x6)))
:qid refinement_interpretation_Tm_refine_55d26841a30db6d8ee6ff4286be669aa))

:named refinement_interpretation_Tm_refine_55d26841a30db6d8ee6ff4286be669aa))
;;;;;;;;;;;;;;;;haseq for Tm_refine_55d26841a30db6d8ee6ff4286be669aa
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,17-37,76); use=Problem01.fst(34,0-37,76)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_55d26841a30db6d8ee6ff4286be669aa @x0
@x1
@x2
@x3
@x4)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_55d26841a30db6d8ee6ff4286be669aa @x0
@x1
@x2
@x3
@x4))))
:qid haseqTm_refine_55d26841a30db6d8ee6ff4286be669aa))

:named haseqTm_refine_55d26841a30db6d8ee6ff4286be669aa))
...
;   (p: Prims.list Prims.nat)
;   (n: Prims.nat{n < FStar.List.Tot.Base.length p})
;   (str: Prims.list Prims.nat {p << p \/ p === p /\ (n << n \/ n === n /\ str << str)}).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (b: Prims.bool). b ==> (forall (i: Prims.nat). i <= n ==> i < FStar.List.Tot.Base.length p)
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Problem01.fst(34,0-37,76)
...
(Prims.list Prims.nat))
(HasType @x4
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x3))
(HasType @x5
(Tm_refine_55d26841a30db6d8ee6ff4286be669aa @x3
@x0
@x4
@x1
@x2)))
...
;; def=dummy(0,0-0,0); use=Problem01.fst(34,8-34,19)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)
...
;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(34,8-34,19)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.nat
@x3)))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Problem01.test_prefix, 3)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_500911408eb15f82fac1b31c6fbc48ba
...
; encoding sigelt let rec test_prefix


; <Start encoding let rec test_prefix>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Problem01.test_prefix.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Problem01.test_prefix.fuel_instrumented_token () Term)
(declare-fun Problem01.test_prefix (Term Term Term) Term)
(declare-fun Problem01.test_prefix@tok () Term)
...
;;;;;;;;;;;;;;;;p: Prims.list Prims.nat ->     n: Prims.nat{n < FStar.List.Tot.Base.length p} ->     str: Prims.list Prims.nat   -> b: Prims.bool{b ==> (exists (i: Prims.nat). i <= n /\ prefix (remove_elem_from_list p i) str)}
(declare-fun Tm_arrow_bf5058b08a988218e2ece8b00001bcff () Term)


; </end encoding let rec test_prefix>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Problem01.test_prefix; Namespace Problem01
(assert (! 
;; def=Problem01.fst(34,8-34,19); use=Problem01.fst(34,8-34,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(HasType @x3
(Prims.list Prims.nat)))
(HasType (Problem01.test_prefix.fuel_instrumented @u0
@x1
@x2
@x3)
(Tm_refine_066ec34605b99f46d413e3ab3b1e988e @x2
...
:pattern ((Problem01.test_prefix.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_Problem01.test_prefix.fuel_instrumented))

:named token_correspondence_Problem01.test_prefix.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Problem01.test_prefix; Namespace Problem01
(assert (! 
;; def=Problem01.fst(33,6-33,88); use=Problem01.fst(34,8-34,19)
...
:named haseqTm_refine_066ec34605b99f46d413e3ab3b1e988e))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Problem01.test_prefix
;;; Fact-ids: Name Problem01.test_prefix; Namespace Problem01
(assert (! 
;; def=Problem01.fst(34,8-34,19); use=Problem01.fst(34,8-34,19)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Prims.list Prims.nat)))
(= (Problem01.test_prefix.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x2))
(ite (= @lb4
(BoxInt 0))
(Problem01.prefix (Problem01.remove_elem_from_list @x1
@x2)
@x3)
(Prims.op_BarBar (Problem01.prefix (Problem01.remove_elem_from_list @x1
@lb4)
@x3)
(Problem01.test_prefix.fuel_instrumented @u0
@x1
(Prims.op_Subtraction @lb4
(BoxInt 1))
@x3))))))
 :weight 0


:pattern ((Problem01.test_prefix.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_Problem01.test_prefix.fuel_instrumented))

:named equation_with_fuel_Problem01.test_prefix.fuel_instrumented))
;;;;;;;;;;;;;;;;b2t typing
...
@x2
@x3)
(Problem01.test_prefix.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_Problem01.test_prefix.fuel_instrumented))

:named @fuel_irrelevance_Problem01.test_prefix.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name Problem01.test_prefix; Namespace Problem01
(assert (! 
;; def=Problem01.fst(34,8-34,19); use=Problem01.fst(34,8-34,19)
...
@x1
@x2)
(Problem01.test_prefix.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_Problem01.test_prefix.fuel_instrumented))

:named @fuel_correspondence_Problem01.test_prefix.fuel_instrumented))
(push) ;; push{2

; Starting query at Problem01.fst(42,3-46,44)
...
(declare-fun Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(40,12-40,78); use=Problem01.fst(40,12-40,78)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f))

:named refinement_kinding_Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(40,12-40,78); use=Problem01.fst(40,12-40,78)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
(exists ((@x5 Term))
 (! (and (HasType @x5
Prims.nat)
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x5
@x2))
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list @x3
@x5)
@x4)))
...
;;no pats
:qid refinement_interpretation_Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f.1))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f))

:named refinement_interpretation_Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(40,12-40,78); use=Problem01.fst(40,12-40,78)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f @x0
@x1
@x2))))
:qid haseqTm_refine_8e95f1b955d5dd9da17c006cf4c0229f))

:named haseqTm_refine_8e95f1b955d5dd9da17c006cf4c0229f))



;;;;;;;;;;;;;;;;n: Prims.nat{n < FStar.List.Tot.Base.length p}   -> b: Prims.bool{b ==> (exists (i: Prims.nat). i <= n /\ prefix (remove_elem_from_list p i) str)}
(declare-fun Tm_arrow_5822b3397a94c1b1b8ec318d976c2340 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5822b3397a94c1b1b8ec318d976c2340
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,31-33,88); use=Problem01.fst(42,3-46,44)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_5822b3397a94c1b1b8ec318d976c2340 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_5822b3397a94c1b1b8ec318d976c2340 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_5822b3397a94c1b1b8ec318d976c2340))

:named kinding_Tm_arrow_5822b3397a94c1b1b8ec318d976c2340))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,31-33,88); use=Problem01.fst(42,3-46,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_5822b3397a94c1b1b8ec318d976c2340 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_5822b3397a94c1b1b8ec318d976c2340 @x2
@x3)))
:qid Problem01_pre_typing_Tm_arrow_5822b3397a94c1b1b8ec318d976c2340))

:named Problem01_pre_typing_Tm_arrow_5822b3397a94c1b1b8ec318d976c2340))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5822b3397a94c1b1b8ec318d976c2340
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(32,31-33,88); use=Problem01.fst(42,3-46,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_5822b3397a94c1b1b8ec318d976c2340 @x1
@x2))
(and 
;; def=Problem01.fst(32,31-33,88); use=Problem01.fst(42,3-46,44)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(Tm_refine_066ec34605b99f46d413e3ab3b1e988e @x3
@x2
@x1)))
...
:pattern ((ApplyTT @x0
@x3))
:qid Problem01_interpretation_Tm_arrow_5822b3397a94c1b1b8ec318d976c2340.1))
...
(Tm_arrow_5822b3397a94c1b1b8ec318d976c2340 @x1
@x2)))
:qid Problem01_interpretation_Tm_arrow_5822b3397a94c1b1b8ec318d976c2340))

:named Problem01_interpretation_Tm_arrow_5822b3397a94c1b1b8ec318d976c2340))


(declare-fun Tm_refine_bd7707ef1973b09faaafda82bae2a4da (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,38-43,95); use=Problem01.fst(43,38-43,95)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_bd7707ef1973b09faaafda82bae2a4da @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_bd7707ef1973b09faaafda82bae2a4da @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_bd7707ef1973b09faaafda82bae2a4da))

:named refinement_kinding_Tm_refine_bd7707ef1973b09faaafda82bae2a4da))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,38-43,95); use=Problem01.fst(43,38-43,95)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_bd7707ef1973b09faaafda82bae2a4da @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Problem01.fst(43,45-43,51); use=Problem01.fst(43,45-43,51)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x2))


;; def=Problem01.fst(43,55-43,93); use=Problem01.fst(43,55-43,93)
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list @x3
@x1)
@x4))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_bd7707ef1973b09faaafda82bae2a4da))

:named refinement_interpretation_Tm_refine_bd7707ef1973b09faaafda82bae2a4da))
;;;;;;;;;;;;;;;;haseq for Tm_refine_bd7707ef1973b09faaafda82bae2a4da
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,38-43,95); use=Problem01.fst(43,38-43,95)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_bd7707ef1973b09faaafda82bae2a4da @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_bd7707ef1973b09faaafda82bae2a4da @x0
@x1
@x2))))
:qid haseqTm_refine_bd7707ef1973b09faaafda82bae2a4da))

:named haseqTm_refine_bd7707ef1973b09faaafda82bae2a4da))




(declare-fun Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,17-44,35); use=Problem01.fst(43,17-44,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84 @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid refinement_kinding_Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84))

:named refinement_kinding_Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,17-44,35); use=Problem01.fst(43,17-44,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84 @x2
@x3
@x4
@x5
@x6))
...
;; def=Problem01.fst(43,17-44,35); use=Problem01.fst(43,17-44,35)
(or 
;; def=Problem01.fst(44,8-44,35); use=Problem01.fst(44,8-44,35)
(Valid 
;; def=Problem01.fst(44,8-44,35); use=Problem01.fst(44,8-44,35)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Problem01.fst(43,17-44,35); use=Problem01.fst(43,17-44,35)
(and 
;; def=Problem01.fst(43,17-43,18); use=Problem01.fst(43,17-43,18)
(Valid 
;; def=Problem01.fst(43,17-43,18); use=Problem01.fst(43,17-43,18)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
@x5
@x6)))
:qid refinement_interpretation_Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84))

:named refinement_interpretation_Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,17-44,35); use=Problem01.fst(43,17-44,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84 @x0
@x1
@x2
@x3
@x4)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84 @x0
@x1
@x2
@x3
@x4))))
:qid haseqTm_refine_ab0aecb05ee8225b9d5b20498cb9ed84))

:named haseqTm_refine_ab0aecb05ee8225b9d5b20498cb9ed84))
;;;;;;;;;;;;;;;;n: Prims.nat{n < FStar.List.Tot.Base.length p} ->     i: (i: Prims.nat{i <= n /\ prefix (remove_elem_from_list p i) str}){n << n \/ n === n /\ i << i}   -> Prims.GTot (Prims.squash (test_prefix p n str))
(declare-fun Tm_arrow_8d9b861fbc267fddef20a99cb67ff990 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8d9b861fbc267fddef20a99cb67ff990
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,16-44,35); use=Problem01.fst(43,16-44,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_arrow_8d9b861fbc267fddef20a99cb67ff990 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_arrow_8d9b861fbc267fddef20a99cb67ff990 @x0
@x1
@x2
@x3)
Tm_type))
:qid kinding_Tm_arrow_8d9b861fbc267fddef20a99cb67ff990))

:named kinding_Tm_arrow_8d9b861fbc267fddef20a99cb67ff990))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,16-44,35); use=Problem01.fst(43,16-44,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_8d9b861fbc267fddef20a99cb67ff990 @x2
@x3
@x4
@x5))
(is-Tm_arrow (PreType @x1)))
...
@x4
@x5)))
:qid Problem01_pre_typing_Tm_arrow_8d9b861fbc267fddef20a99cb67ff990))

:named Problem01_pre_typing_Tm_arrow_8d9b861fbc267fddef20a99cb67ff990))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8d9b861fbc267fddef20a99cb67ff990
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,16-44,35); use=Problem01.fst(43,16-44,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_8d9b861fbc267fddef20a99cb67ff990 @x1
@x2
@x3
@x4))
(and 
...
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x4))
(HasType @x6
(Tm_refine_ab0aecb05ee8225b9d5b20498cb9ed84 @x5
@x4
@x3
@x2
@x1)))
...
@x5)
@x6)
(Prims.squash (Prims.b2t (Problem01.test_prefix @x4
@x5
@x3)))))
...
@x5)
@x6))
:qid Problem01_interpretation_Tm_arrow_8d9b861fbc267fddef20a99cb67ff990.1))
...
:pattern ((ApplyTT @x0
@x5))
:qid Problem01_interpretation_Tm_arrow_8d9b861fbc267fddef20a99cb67ff990.2))
))
...
@x3
@x4)))
:qid Problem01_interpretation_Tm_arrow_8d9b861fbc267fddef20a99cb67ff990))

:named Problem01_interpretation_Tm_arrow_8d9b861fbc267fddef20a99cb67ff990))




;;;;;;;;;;;;;;;;n: Prims.nat{n < FStar.List.Tot.Base.length p} ->     i: Prims.nat{i <= n /\ prefix (remove_elem_from_list p i) str}   -> Prims.GTot (Prims.squash (test_prefix p n str))
(declare-fun Tm_arrow_cdfe989430680920219d3641d4853351 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_cdfe989430680920219d3641d4853351
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,16-43,120); use=Problem01.fst(43,16-43,120)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_cdfe989430680920219d3641d4853351 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_cdfe989430680920219d3641d4853351 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_cdfe989430680920219d3641d4853351))

:named kinding_Tm_arrow_cdfe989430680920219d3641d4853351))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,16-43,120); use=Problem01.fst(43,16-43,120)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_cdfe989430680920219d3641d4853351 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_cdfe989430680920219d3641d4853351 @x2
@x3)))
:qid Problem01_pre_typing_Tm_arrow_cdfe989430680920219d3641d4853351))

:named Problem01_pre_typing_Tm_arrow_cdfe989430680920219d3641d4853351))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_cdfe989430680920219d3641d4853351
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(43,16-43,120); use=Problem01.fst(43,16-43,120)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_cdfe989430680920219d3641d4853351 @x1
@x2))
(and 
;; def=Problem01.fst(43,16-43,120); use=Problem01.fst(43,16-43,120)
...
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x2))
(HasType @x4
(Tm_refine_bd7707ef1973b09faaafda82bae2a4da @x3
@x2
@x1)))
(HasType (ApplyTT (ApplyTT @x0
@x3)
@x4)
(Prims.squash (Prims.b2t (Problem01.test_prefix @x2
@x3
@x1)))))
...
@x3)
@x4))
:qid Problem01_interpretation_Tm_arrow_cdfe989430680920219d3641d4853351.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Problem01_interpretation_Tm_arrow_cdfe989430680920219d3641d4853351.2))
))
...
(Tm_arrow_cdfe989430680920219d3641d4853351 @x1
@x2)))
:qid Problem01_interpretation_Tm_arrow_cdfe989430680920219d3641d4853351))

:named Problem01_interpretation_Tm_arrow_cdfe989430680920219d3641d4853351))
;;;;;;;;;;;;;;;;_: Prims.nat -> Type
...
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(40,23-40,26); use=Problem01.fst(42,3-46,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid Problem01_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named Problem01_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
...
:pattern ((ApplyTT @x0
@x1))
:qid Problem01_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid Problem01_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named Problem01_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

(declare-fun Tm_refine_d1574464992e7b3a73046938c36f03af (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(389,11-389,20); use=Problem01.fst(46,14-46,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_d1574464992e7b3a73046938c36f03af @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_d1574464992e7b3a73046938c36f03af @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_d1574464992e7b3a73046938c36f03af))

:named refinement_kinding_Tm_refine_d1574464992e7b3a73046938c36f03af))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(389,11-389,20); use=Problem01.fst(46,14-46,25)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d1574464992e7b3a73046938c36f03af @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_d1574464992e7b3a73046938c36f03af))

:named refinement_interpretation_Tm_refine_d1574464992e7b3a73046938c36f03af))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d1574464992e7b3a73046938c36f03af
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(389,11-389,20); use=Problem01.fst(46,14-46,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d1574464992e7b3a73046938c36f03af @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d1574464992e7b3a73046938c36f03af @x0
@x1
@x2))))
:qid haseqTm_refine_d1574464992e7b3a73046938c36f03af))

:named haseqTm_refine_d1574464992e7b3a73046938c36f03af))
;;;;;;;;;;;;;;;;x: Prims.nat{x <= n && prefix (remove_elem_from_list p x) str}   -> Prims.GTot (Prims.squash (test_prefix p n str))
(declare-fun Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(389,11-389,42); use=Problem01.fst(46,14-46,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6))

:named kinding_Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(389,11-389,42); use=Problem01.fst(46,14-46,25)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid Problem01_pre_typing_Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6))

:named Problem01_pre_typing_Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(389,11-389,42); use=Problem01.fst(46,14-46,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6 @x1
@x2
@x3))
(and 
;; def=FStar.Classical.fsti(389,11-389,42); use=Problem01.fst(46,14-46,25)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Tm_refine_d1574464992e7b3a73046938c36f03af @x3
@x2
@x1))
(HasType (ApplyTT @x0
@x4)
...
:pattern ((ApplyTT @x0
@x4))
:qid Problem01_interpretation_Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6.1))
...
@x2
@x3)))
:qid Problem01_interpretation_Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6))

:named Problem01_interpretation_Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6))

(declare-fun Tm_abs_71ba75c22fab480373b3eddcfc6a2606 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_71ba75c22fab480373b3eddcfc6a2606
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(40,29-40,77); use=Problem01.fst(46,35-46,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_71ba75c22fab480373b3eddcfc6a2606 @x0
@x1
@x2)
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)
 

:pattern ((Tm_abs_71ba75c22fab480373b3eddcfc6a2606 @x0
@x1
@x2))
:qid typing_Tm_abs_71ba75c22fab480373b3eddcfc6a2606))

:named typing_Tm_abs_71ba75c22fab480373b3eddcfc6a2606))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_71ba75c22fab480373b3eddcfc6a2606
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(40,29-40,77); use=Problem01.fst(46,35-46,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_71ba75c22fab480373b3eddcfc6a2606 @x1
@x2
@x3)
@x0)
(Prims.b2t (Prims.op_AmpAmp (Prims.op_LessThanOrEqual @x0
@x1)
(Problem01.prefix (Problem01.remove_elem_from_list @x2
@x0)
@x3))))
 

:pattern ((ApplyTT (Tm_abs_71ba75c22fab480373b3eddcfc6a2606 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_71ba75c22fab480373b3eddcfc6a2606))

:named interpretation_Tm_abs_71ba75c22fab480373b3eddcfc6a2606))




(declare-fun Tm_abs_81b2eeb1c5da81d363060592009ddc69 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_81b2eeb1c5da81d363060592009ddc69
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(42,17-42,36); use=Problem01.fst(42,17-42,36)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_81b2eeb1c5da81d363060592009ddc69 @x0
@x1)
(Tm_arrow_5822b3397a94c1b1b8ec318d976c2340 @x0
@x1))
 

:pattern ((Tm_abs_81b2eeb1c5da81d363060592009ddc69 @x0
@x1))
:qid typing_Tm_abs_81b2eeb1c5da81d363060592009ddc69))

:named typing_Tm_abs_81b2eeb1c5da81d363060592009ddc69))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_81b2eeb1c5da81d363060592009ddc69
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(42,17-42,36); use=Problem01.fst(42,17-42,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_81b2eeb1c5da81d363060592009ddc69 @x1
@x2)
@x0)
(Problem01.test_prefix @x2
@x0
@x1))
 

:pattern ((ApplyTT (Tm_abs_81b2eeb1c5da81d363060592009ddc69 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_81b2eeb1c5da81d363060592009ddc69))

:named interpretation_Tm_abs_81b2eeb1c5da81d363060592009ddc69))
...
;     (forall (pure_result: Prims.unit). Problem01.test_prefix p n str ==> p pure_result) ==>
;     (forall (n: Prims.nat{n < FStar.List.Tot.Base.length p}).
;         (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;         forall (b: Prims.bool).
;           b ==> (forall (i: Prims.nat). i <= n ==> i < FStar.List.Tot.Base.length p)) /\
;     (forall (any_result:
;         (n: Prims.nat{n < FStar.List.Tot.Base.length p}
;             -> b:
;               Prims.bool
...
;                   (exists (i: Prims.nat).
;                       i <= n /\ Problem01.prefix (Problem01.remove_elem_from_list p i) str) })).
;         (fun n -> Problem01.test_prefix p n str) == any_result ==>
;         (forall (n: Prims.nat{n < FStar.List.Tot.Base.length p}) (i: Prims.nat).
;             i <= n ==> i < FStar.List.Tot.Base.length p) /\
;         (forall (n: Prims.nat{n < FStar.List.Tot.Base.length p})
;             (i: Prims.nat{i <= n /\ Problem01.prefix (Problem01.remove_elem_from_list p i) str})
;             (n: Prims.nat{n < FStar.List.Tot.Base.length p}).
;             (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;             forall (i: Prims.nat). i <= n ==> i < FStar.List.Tot.Base.length p) /\
;         (forall (n: Prims.nat{n < FStar.List.Tot.Base.length p})
;             (i: Prims.nat{i <= n /\ Problem01.prefix (Problem01.remove_elem_from_list p i) str})
;             (aux:
;             (
...
;                         {i <= n /\ Problem01.prefix (Problem01.remove_elem_from_list p i) str})
;                       {n << n \/ n === n /\ i << i}
;                 -> Prims.GTot (Prims.squash (Problem01.test_prefix p n str)))).
;             (*  - Could not prove post-condition
; *)
;             forall (k: Prims.pure_post (Prims.squash (Problem01.test_prefix p n str))).
;               (forall (x: Prims.squash (Problem01.test_prefix p n str)).
;                   {:pattern Prims.guard_free (k x)}
;                   Prims.auto_squash (k x)) ==>
;               (n > i == true ==>
;                 n - 1 >= 0 /\ n - 1 < FStar.List.Tot.Base.length p /\
;                 (forall (return_val: n: Prims.nat{n < FStar.List.Tot.Base.length p}).
;                     return_val == n - 1 ==>
;                     (i <= n /\ Problem01.prefix (Problem01.remove_elem_from_list p i) str ==>
;                       i <= n - 1 /\ Problem01.prefix (Problem01.remove_elem_from_list p i) str /\
;                       (n - 1 << n \/ n - 1 === n /\ i << i)) /\
;                     (forall (any_result:
;                         i:
;                         Prims.nat
;                           {i <= n /\ Problem01.prefix (Problem01.remove_elem_from_list p i) str}).
;                         i == any_result ==>
;                         (forall (any_result: Prims.squash (Problem01.test_prefix p (n - 1) str)).
;                             Problem01.test_prefix p (n - 1) str ==> Problem01.test_prefix p n str)))
;               ) /\
;               (~(n > i = true) ==>
;                 (forall (b: Prims.bool). n > i == b ==> Problem01.test_prefix p n str))) /\
;         (forall (b:
;             (
;                   n: Prims.nat{n < FStar.List.Tot.Base.length p} ->
;                   i: Prims.nat{i <= n /\ Problem01.prefix (Problem01.remove_elem_from_list p i) str}
...
;                 (*  - Could not prove post-condition
; *) i <= n ==> i < FStar.List.Tot.Base.length p) /\
;             (forall (any_result: (_: Prims.nat -> Type0)).
;                 (fun i -> i <= n && Problem01.prefix (Problem01.remove_elem_from_list p i) str) ==
;                 any_result ==>
;                 (forall (b:
;                     Prims.squash (exists (x: Prims.nat).
;                           x <= n && Problem01.prefix (Problem01.remove_elem_from_list p x) str)).
;                     (forall (x: Prims.nat).
;                         x <= n && Problem01.prefix (Problem01.remove_elem_from_list p x) str ==>
;                         x <= n /\ Problem01.prefix (Problem01.remove_elem_from_list p x) str) /\
;                     (forall (return_val:
...
;                                 Prims.nat
;                                   { x <= n &&
;                                     Problem01.prefix (Problem01.remove_elem_from_list p x) str }
;                             -> Prims.GTot (Prims.squash (Problem01.test_prefix p n str)))).
;                         return_val == b n ==>
;                         (forall (pure_result: Prims.unit).
;                             Problem01.test_prefix p n str ==> p pure_result))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let test_prefix_exists_to_b`
...
(Prims.list Prims.nat))
(HasType @x3
(Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f @x1
@x0
@x2)))
...
;; def=Prims.fst(441,36-441,97); use=Problem01.fst(42,3-46,44)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Problem01.fst(41,10-41,31); use=Problem01.fst(42,3-46,44)
(or label_2

;; def=Problem01.fst(41,10-41,31); use=Problem01.fst(42,3-46,44)
(BoxBool_proj_0 (Problem01.test_prefix @x0
@x1
@x2))
)
)

;; def=Prims.fst(441,83-441,96); use=Problem01.fst(42,3-46,44)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Problem01.fst(42,3-46,44)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(42,3-46,44)
(and 
;; def=dummy(0,0-0,0); use=Problem01.fst(42,3-46,44)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x0))

;; def=dummy(0,0-0,0); use=Problem01.fst(42,17-42,28)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.bool)

;; def=Problem01.fst(33,7-33,8); use=Problem01.fst(42,17-42,28)
(BoxBool_proj_0 @x6)
)
...
;; def=Problem01.fst(33,37-33,43); use=Problem01.fst(42,17-42,28)
(<= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 @x5))
)
...
;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(42,17-42,28)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.nat
@x0)))
)
...
;; def=Prims.fst(451,66-451,102); use=Problem01.fst(42,3-46,44)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Tm_arrow_5822b3397a94c1b1b8ec318d976c2340 @x2
@x0))

;; def=Problem01.fst(42,8-42,36); use=Problem01.fst(42,8-42,36)
(= (Tm_abs_81b2eeb1c5da81d363060592009ddc69 @x2
@x0)
@x5)
)
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(42,3-46,44)
(and 
;; def=dummy(0,0-0,0); use=Problem01.fst(42,39-46,44)
...
;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(43,87-43,88)
(or label_4
...
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x0))
(HasType @x7
(Tm_refine_bd7707ef1973b09faaafda82bae2a4da @x6
@x0
@x2))
(HasType @x8
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x0)))

;; def=dummy(0,0-0,0); use=Problem01.fst(43,17-44,35)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.nat)
...
@x2))
(HasType @x8
(Tm_arrow_8d9b861fbc267fddef20a99cb67ff990 @x7
@x6
@x2
@x0)))
...
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(Prims.pure_post (Prims.squash (Prims.b2t (Problem01.test_prefix @x0
@x6
@x2)))))

;; def=Prims.fst(402,27-402,88); use=Problem01.fst(44,8-44,35)
(forall ((@x10 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Problem01.fst(44,8-44,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Problem01.fst(44,8-44,35)
(ApplyTT @x9
@x10)
...
;; def=Prims.fst(389,2-389,39); use=Problem01.fst(44,8-44,35)
(and (implies 
;; def=Problem01.fst(44,11-44,16); use=Problem01.fst(44,11-44,16)
(= (Prims.op_GreaterThan @x6
@x7)
(BoxBool true))


;; def=Prims.fst(459,77-459,89); use=Problem01.fst(44,8-44,35)
(and 
;; def=Prims.fst(680,18-680,24); use=Problem01.fst(44,26-44,33)
(or label_6
...
;; def=Problem01.fst(43,23-43,35); use=Problem01.fst(44,26-44,33)
(or label_7
...
;; def=Prims.fst(356,2-356,58); use=Problem01.fst(44,8-44,35)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(Tm_refine_500911408eb15f82fac1b31c6fbc48ba @x0))

;; def=Prims.fst(356,26-356,41); use=Problem01.fst(44,8-44,35)
(= @x10
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(44,8-44,35)
(and (implies 
;; def=Problem01.fst(43,45-43,93); use=Problem01.fst(44,34-44,35)
(and 
;; def=Problem01.fst(43,45-43,51); use=Problem01.fst(44,34-44,35)
(<= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 @x6))


;; def=Problem01.fst(43,55-43,93); use=Problem01.fst(44,34-44,35)
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list @x0
@x7)
@x2))
)


;; def=Problem01.fst(43,17-44,35); use=Problem01.fst(44,34-44,35)
(and 
;; def=Problem01.fst(43,45-43,51); use=Problem01.fst(44,34-44,35)
(or label_8
...
;; def=Problem01.fst(44,8-44,35); use=Problem01.fst(44,34-44,35)
(Valid 
;; def=Problem01.fst(44,8-44,35); use=Problem01.fst(44,34-44,35)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Problem01.fst(43,17-44,35); use=Problem01.fst(44,34-44,35)
(and 
;; def=Problem01.fst(43,17-43,18); use=Problem01.fst(44,34-44,35)
(Valid 
;; def=Problem01.fst(43,17-43,18); use=Problem01.fst(44,34-44,35)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Prims.fst(451,66-451,102); use=Problem01.fst(44,8-44,35)
(forall ((@x11 Term))
...
;; def=Problem01.fst(43,39-43,40); use=Problem01.fst(44,8-44,35)
(= @x7
@x11)
)
...
(Prims.squash (Prims.b2t (Problem01.test_prefix @x0
(Prims.op_Subtraction @x6
(BoxInt 1))
@x2))))

;; def=Problem01.fst(43,111-43,119); use=Problem01.fst(44,22-44,25)
(BoxBool_proj_0 (Problem01.test_prefix @x0
(Prims.op_Subtraction @x6
(BoxInt 1))
@x2))
...
;; def=Problem01.fst(43,111-43,119); use=Problem01.fst(44,22-44,35)
(or label_11
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Problem01.fst(44,8-44,35)
(not 
;; def=Problem01.fst(44,11-44,16); use=Problem01.fst(44,11-44,16)
(= (Prims.op_GreaterThan @x6
@x7)
...
;; def=Prims.fst(413,99-413,120); use=Problem01.fst(44,8-44,35)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.bool)
...
;; def=Problem01.fst(43,111-43,119); use=Problem01.fst(44,8-44,35)
(or label_12
...
;; def=Prims.fst(413,99-413,120); use=Problem01.fst(42,3-46,44)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(Tm_arrow_cdfe989430680920219d3641d4853351 @x2
@x0))
...
;; def=Problem01.fst(40,29-40,35); use=Problem01.fst(46,35-46,36)
(<= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 @x1))
)

;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(40,71-40,72)
(or label_13

;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(46,35-46,36)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.nat
@x0)))
)
...
;; def=FStar.Classical.fsti(387,8-387,9); use=Problem01.fst(42,3-46,44)
(= (Tm_abs_71ba75c22fab480373b3eddcfc6a2606 @x1
@x0
@x2)
@x7)
)
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(42,3-46,44)
(and 
;; def=dummy(0,0-0,0); use=Problem01.fst(46,37-46,44)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.nat)
...
;; def=Problem01.fst(43,45-43,93); use=Problem01.fst(46,37-46,44)
(and 
;; def=Problem01.fst(43,45-43,51); use=Problem01.fst(46,37-46,44)
(or label_14
...
;; def=Problem01.fst(43,55-43,93); use=Problem01.fst(46,37-46,44)
(or label_15
...
;; def=Prims.fst(356,2-356,58); use=Problem01.fst(42,3-46,44)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(Tm_arrow_24a9e376aa6c6ee0a6dad6c359a833a6 @x2
@x0
...
;; def=Prims.fst(356,26-356,41); use=Problem01.fst(42,3-46,44)
(= @x9
(ApplyTT @x6
@x1))
)

;; def=Prims.fst(441,36-441,97); use=Problem01.fst(46,14-46,25)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=Problem01.fst(46,26-46,34); use=Problem01.fst(46,14-46,25)
(BoxBool_proj_0 (Problem01.test_prefix @x0
@x1
@x2))
)

;; def=Prims.fst(441,83-441,96); use=Problem01.fst(46,14-46,25)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Problem01.fst(46,14-46,25)
(ApplyTT @x4
@x10)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Problem01.test_prefix_exists_to_b, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_Problem01.prefix.fuel_instrumented, @fuel_correspondence_Problem01.remove_elem_from_list.fuel_instrumented, @fuel_correspondence_Problem01.test_prefix.fuel_instrumented, @fuel_irrelevance_Problem01.test_prefix.fuel_instrumented, @query, bool_inversion, equation_Prims.nat, equation_with_fuel_Problem01.test_prefix.fuel_instrumented, int_inversion, int_typing, primitive_Prims.op_BarBar, primitive_Prims.op_GreaterThan, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_066ec34605b99f46d413e3ab3b1e988e, refinement_interpretation_Tm_refine_500911408eb15f82fac1b31c6fbc48ba, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f, refinement_interpretation_Tm_refine_a90d3e0b4d9b545e6a4fa0dee16eb22b, refinement_interpretation_Tm_refine_bd7707ef1973b09faaafda82bae2a4da, token_correspondence_Problem01.test_prefix.fuel_instrumented, typing_Problem01.prefix, typing_Problem01.remove_elem_from_list, typing_Problem01.test_prefix, well-founded-ordering-on-nat
...
; Starting query at Problem01.fst(39,0-46,44)
...
;; def=Problem01.fst(40,29-40,35); use=Problem01.fst(42,3-46,44)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x1))
)
...
;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(42,3-46,44)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.nat
@x0)))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Problem01.test_prefix_exists_to_b, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_500911408eb15f82fac1b31c6fbc48ba
...
; encoding sigelt let test_prefix_exists_to_b


; <Start encoding let test_prefix_exists_to_b>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Problem01.test_prefix_exists_to_b (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Problem01.test_prefix_exists_to_b@tok () Term)

; </end encoding let test_prefix_exists_to_b>
...
; Starting query at Problem01.fst(51,4-51,58)
...
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(49,4-50,40); use=Problem01.fst(51,4-51,58)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(40,23-40,26); use=Problem01.fst(51,4-51,58)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)
...
;;; Fact-ids: 
(assert (! 
;; def=Problem01.fst(40,12-40,78); use=Problem01.fst(51,26-51,49)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f @x0
@x1
@x2)
...
;; def=Problem01.fst(40,12-40,78); use=Problem01.fst(51,26-51,49)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.l_Exists Prims.nat
(Tm_abs_71ba75c22fab480373b3eddcfc6a2606 @x2
@x1
@x0)))
...
@x2))
(BoxBool_proj_0 (Problem01.prefix (Problem01.remove_elem_from_list @x1
@x3)
@x0)))
 
;;no pats
:qid l_quant_interp_8ff6be6ea84fdcc852f4e9a51a42781d.1))
)
 

:pattern ((Valid (Prims.l_Exists Prims.nat
(Tm_abs_71ba75c22fab480373b3eddcfc6a2606 @x2
@x1
@x0))))
:qid l_quant_interp_8ff6be6ea84fdcc852f4e9a51a42781d))

:named l_quant_interp_8ff6be6ea84fdcc852f4e9a51a42781d))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let test_prefix_iff`
...
;; def=Prims.fst(406,51-406,91); use=Prims.fst(430,19-430,32)
(and 
;; def=dummy(0,0-0,0); use=Problem01.fst(51,4-51,58)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
;; def=Problem01.fst(49,53-49,59); use=Problem01.fst(51,4-51,58)
(<= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 @x1))
)

;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(49,95-49,96)
(or label_1

;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(51,4-51,58)
(< (BoxInt_proj_0 @x4)
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.nat
@x0)))
)
...
;; def=Prims.fst(441,36-441,97); use=Problem01.fst(51,4-51,58)
(forall ((@x4 Term))
 (! (implies (and (or label_2
(HasType @x4
Prims.unit))

;; def=Problem01.fst(49,10-49,103); use=Problem01.fst(51,4-51,58)
(or label_3

;; def=Problem01.fst(49,10-49,103); use=Problem01.fst(51,4-51,58)
(iff 
;; def=Problem01.fst(49,11-49,30); use=Problem01.fst(51,4-51,58)
(BoxBool_proj_0 (Problem01.test_prefix @x0
@x1
@x2))


;; def=Problem01.fst(49,36-49,102); use=Problem01.fst(51,4-51,58)
(exists ((@x5 Term))
 (! (and (HasType @x5
Prims.nat)
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x5
...
;; def=Prims.fst(441,83-441,96); use=Problem01.fst(51,4-51,58)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Problem01.fst(51,4-51,58)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(51,4-51,58)
(and 
;; def=dummy(0,0-0,0); use=Problem01.fst(51,4-51,58)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
...
;; def=Problem01.fst(40,29-40,35); use=Problem01.fst(51,26-51,49)
(<= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 @x1))
)
...
;; def=Problem01.fst(27,47-27,59); use=Problem01.fst(51,26-51,49)
(< (BoxInt_proj_0 @x4)
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.nat
@x0)))
)
...
;; def=Prims.fst(451,66-451,102); use=Problem01.fst(51,4-51,58)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)

;; def=Prims.fst(509,26-509,27); use=Problem01.fst(51,4-51,58)
(= (Tm_abs_71ba75c22fab480373b3eddcfc6a2606 @x1
@x0
@x2)
@x4)
...
;; def=Prims.fst(117,13-117,14); use=Problem01.fst(51,4-51,58)
(= (Prims.l_Exists Prims.nat
(Tm_abs_71ba75c22fab480373b3eddcfc6a2606 @x1
@x0
@x2))
@x5)
...
;; def=FStar.Classical.fsti(72,17-72,18); use=Problem01.fst(51,4-51,58)
(= (Tm_refine_8e95f1b955d5dd9da17c006cf4c0229f @x1
@x0
@x2)
@x6)
...
;; def=Prims.fst(441,36-441,97); use=Problem01.fst(51,14-51,24)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=FStar.Classical.fsti(72,59-72,68); use=Problem01.fst(51,14-51,24)
(implies 
;; def=Problem01.fst(40,12-40,78); use=Problem01.fst(51,14-51,24)
(exists ((@x8 Term))
 (! (and (HasType @x8
Prims.nat)
...
;; def=Problem01.fst(41,10-41,31); use=Problem01.fst(51,14-51,24)
(BoxBool_proj_0 (Problem01.test_prefix @x0
@x1
@x2))
)
...
;; def=Prims.fst(441,83-441,96); use=Problem01.fst(51,14-51,24)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Problem01.fst(51,14-51,24)
(ApplyTT @x3
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Problem01.test_prefix_iff, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @fuel_correspondence_Problem01.test_prefix.fuel_instrumented, @query, bool_inversion, equation_Prims.nat, int_inversion, primitive_Prims.op_LessThanOrEqual, refinement_interpretation_Tm_refine_066ec34605b99f46d413e3ab3b1e988e, refinement_interpretation_Tm_refine_500911408eb15f82fac1b31c6fbc48ba, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_Problem01.test_prefix
...
; encoding sigelt let test_prefix_iff


; <Start encoding let test_prefix_iff>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Problem01.test_prefix_iff (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Problem01.test_prefix_iff@tok () Term)
(declare-fun Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7 (Term) Term)

; </end encoding let test_prefix_iff>


; encoding sigelt val Problem01.test_relaxed_prefix


; <Skipped val Problem01.test_relaxed_prefix/>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Problem01.test_prefix_iff; Namespace Problem01
(assert (! 
;; def=Problem01.fst(48,33-48,54); use=Problem01.fst(48,33-48,54)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7))

:named refinement_kinding_Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Problem01.test_prefix_iff; Namespace Problem01
(assert (! 
;; def=Problem01.fst(48,33-48,54); use=Problem01.fst(48,33-48,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7 @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=Problem01.fst(48,40-48,52); use=Problem01.fst(48,40-48,52)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.List.Tot.Base.length.fuel_instrumented ZFuel
Prims.nat
@x2)))
))
...
@x1
(Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7 @x2)))
:qid refinement_interpretation_Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7))

:named refinement_interpretation_Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7))
...
;;;;;;;;;;;;;;;;Lemma: Problem01.test_prefix_iff
;;; Fact-ids: Name Problem01.test_prefix_iff; Namespace Problem01
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(Prims.list Prims.nat))
(HasType @x1
(Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7 @x0))
(HasType @x2
(Prims.list Prims.nat)))

;; def=Problem01.fst(49,10-49,103); use=Problem01.fst(49,10-49,103)
(iff 
;; def=Problem01.fst(49,11-49,30); use=Problem01.fst(49,11-49,30)
(BoxBool_proj_0 (Problem01.test_prefix.fuel_instrumented ZFuel
@x0
@x1
@x2))


;; def=Problem01.fst(49,36-49,102); use=Problem01.fst(49,36-49,102)
(exists ((@x3 Term))
 (! (and (HasType @x3
Prims.nat)
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x3
@x1))
(BoxBool_proj_0 (Problem01.prefix.fuel_instrumented ZFuel
(Problem01.remove_elem_from_list.fuel_instrumented ZFuel
@x0
@x3)
@x2)))
...
;;no pats
:qid lemma_Problem01.test_prefix_iff.1))
)
)
 

:pattern ((Problem01.test_prefix.fuel_instrumented ZFuel
@x0
@x1
@x2))
:qid lemma_Problem01.test_prefix_iff))
:named lemma_Problem01.test_prefix_iff))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7
;;; Fact-ids: Name Problem01.test_prefix_iff; Namespace Problem01
(assert (! 
;; def=Problem01.fst(48,33-48,54); use=Problem01.fst(48,33-48,54)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7 @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4dfb0d0332735a597c1b866c1a8e05e7 @x0))))
:qid haseqTm_refine_4dfb0d0332735a597c1b866c1a8e05e7))

:named haseqTm_refine_4dfb0d0332735a597c1b866c1a8e05e7))
(push) ;; push{2

; Starting query at Problem01.fst(57,2-57,84)
...
;         FStar.List.Tot.Base.length p > 0 == true ==>
;         FStar.List.Tot.Base.length p - 1 >= 0 /\
;         FStar.List.Tot.Base.length p - 1 < FStar.List.Tot.Base.length p)) /\
;   (forall (any_result: Prims.bool).
;       (Problem01.prefix p str ||
;       (match FStar.List.Tot.Base.length p > 0 with
;         | true -> Problem01.test_prefix p (FStar.List.Tot.Base.length p - 1) str
;         | _ -> false)) ==
;       any_result ==>
;       (Problem01.prefix p str ||
;         (match FStar.List.Tot.Base.length p > 0 with
...
;             Problem01.prefix (Problem01.remove_elem_from_list p i) str)))


; Context: While encoding a query
; While typechecking the top-level declaration `let test_relaxed_prefix`
...
;; def=Prims.fst(459,77-459,89); use=Problem01.fst(57,2-57,84)
(and (implies 
;; def=Problem01.fst(57,2-57,14); use=Problem01.fst(57,2-57,14)
(not 
;; def=Problem01.fst(57,2-57,14); use=Problem01.fst(57,2-57,14)
(BoxBool_proj_0 (Problem01.prefix @x0
@x1))
)


;; def=dummy(0,0-0,0); use=Problem01.fst(57,2-57,84)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.pure_post Prims.bool))

;; def=Prims.fst(402,27-402,88); use=Problem01.fst(57,2-57,84)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Problem01.fst(57,2-57,84)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Problem01.fst(57,2-57,84)
(ApplyTT @x2
@x3)
...
;; def=Problem01.fst(57,22-57,34); use=Problem01.fst(57,22-57,34)
(= (Prims.op_GreaterThan (FStar.List.Tot.Base.length Prims.nat
@x0)
(BoxInt 0))
(BoxBool true))
)

;; def=Problem01.fst(32,37-32,49); use=Problem01.fst(57,54-57,68)
(and 
;; def=Prims.fst(680,18-680,24); use=Problem01.fst(57,54-57,68)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Problem01.fst(57,54-57,68)
(>= (BoxInt_proj_0 (Prims.op_Subtraction (FStar.List.Tot.Base.length Prims.nat
@x0)
(BoxInt 1)))
(BoxInt_proj_0 (BoxInt 0)))
)
...
;; def=Prims.fst(451,66-451,102); use=Problem01.fst(57,2-57,84)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.bool)

;; def=Problem01.fst(54,6-57,84); use=Problem01.fst(57,2-57,84)
(= (Prims.op_BarBar (Problem01.prefix @x0
@x1)
(let ((@lb3 (Prims.op_GreaterThan (FStar.List.Tot.Base.length Prims.nat
@x0)
(BoxInt 0))))
(ite (= @lb3
(BoxBool true))
(Problem01.test_prefix @x0
(Prims.op_Subtraction (FStar.List.Tot.Base.length Prims.nat
@x0)
(BoxInt 1))
@x1)
(BoxBool false))))
...
;; def=Problem01.fst(54,14-55,89); use=Problem01.fst(57,2-57,84)
(or label_3

;; def=Problem01.fst(54,14-55,89); use=Problem01.fst(57,2-57,84)
(iff 
;; def=Problem01.fst(54,7-54,8); use=Problem01.fst(57,2-57,84)
(or (BoxBool_proj_0 (Problem01.prefix @x0
@x1))
(BoxBool_proj_0 (let ((@lb3 (Prims.op_GreaterThan (FStar.List.Tot.Base.length Prims.nat
@x0)
(BoxInt 0))))
(ite (= @lb3
(BoxBool true))
...
;; def=Problem01.fst(54,21-55,89); use=Problem01.fst(57,2-57,84)
(or 
;; def=Problem01.fst(54,22-54,40); use=Problem01.fst(57,2-57,84)
(BoxBool_proj_0 (Problem01.prefix @x0
@x1))


;; def=Problem01.fst(55,16-55,88); use=Problem01.fst(57,2-57,84)
(exists ((@x3 Term))
 (! (and (HasType @x3
Prims.nat)
(BoxBool_proj_0 (Prims.op_LessThan @x3
