...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.propExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(26,4-26,16); use=PropositionalExtensionalityInconsistent.fst(26,4-26,16)
(forall ((@u0 Dummy_sort))
 (! (HasType (PropositionalExtensionalityInconsistent.propExt_Type @u0)
Prims.logical)
 

:pattern ((PropositionalExtensionalityInconsistent.propExt_Type @u0))
:qid typing_PropositionalExtensionalityInconsistent.propExt_Type))

:named typing_PropositionalExtensionalityInconsistent.propExt_Type))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for PropositionalExtensionalityInconsistent.propExt_Type
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.propExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(26,4-26,16); use=PropositionalExtensionalityInconsistent.fst(26,4-26,16)
(forall ((@u0 Dummy_sort))
...
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(26,4-26,16); use=PropositionalExtensionalityInconsistent.fst(26,4-26,16)
(PropositionalExtensionalityInconsistent.propExt_Type @u0)
)


;; def=PropositionalExtensionalityInconsistent.fst(26,19-26,65); use=PropositionalExtensionalityInconsistent.fst(26,19-26,65)
...
;; def=PropositionalExtensionalityInconsistent.fst(26,41-26,65); use=PropositionalExtensionalityInconsistent.fst(26,41-26,65)
(iff 
;; def=PropositionalExtensionalityInconsistent.fst(26,41-26,53); use=PropositionalExtensionalityInconsistent.fst(26,41-26,53)
(iff 
;; def=PropositionalExtensionalityInconsistent.fst(26,27-26,29); use=PropositionalExtensionalityInconsistent.fst(26,42-26,44)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(26,27-26,29); use=PropositionalExtensionalityInconsistent.fst(26,42-26,44)
@x1
)
...
;; def=PropositionalExtensionalityInconsistent.fst(26,30-26,32); use=PropositionalExtensionalityInconsistent.fst(26,50-26,52)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(26,30-26,32); use=PropositionalExtensionalityInconsistent.fst(26,50-26,52)
@x2
)
...
;; def=PropositionalExtensionalityInconsistent.fst(26,59-26,65); use=PropositionalExtensionalityInconsistent.fst(26,59-26,65)
(= @x1
@x2)
)
)
...
;;no pats
:qid equation_PropositionalExtensionalityInconsistent.propExt_Type.1))
)
...
:qid equation_PropositionalExtensionalityInconsistent.propExt_Type))

:named equation_PropositionalExtensionalityInconsistent.propExt_Type))
...
;;;;;;;;;;;;;;;;Prop-typing for PropositionalExtensionalityInconsistent.propExt_Type
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.propExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(26,4-26,16); use=PropositionalExtensionalityInconsistent.fst(26,4-26,16)
(forall ((@u0 Dummy_sort))
...
:qid defn_equation_PropositionalExtensionalityInconsistent.propExt_Type))

:named defn_equation_PropositionalExtensionalityInconsistent.propExt_Type))
...
; Starting query at PropositionalExtensionalityInconsistent.fst(31,3-32,23)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3
Tm_type)
:named refinement_kinding_Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(31,35-31,56); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3)
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=Prims.fst(635,71-635,97); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(not 
;; def=Prims.fst(441,29-441,97); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=PropositionalExtensionalityInconsistent.fst(31,41-31,56); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(iff 
;; def=PropositionalExtensionalityInconsistent.fst(31,42-31,45); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(31,42-31,45); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
Prims.int
)
...
;; def=PropositionalExtensionalityInconsistent.fst(31,51-31,55); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(31,51-31,55); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
Prims.unit
)
...
;; def=Prims.fst(635,86-635,95); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(not 
;; def=Prims.fst(635,86-635,95); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(= @x2
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3.1))
)
))
...
@x1
Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3))
:qid refinement_interpretation_Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3))

:named refinement_interpretation_Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3))
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_bec701fab1d9b97bec3a2b1c70a90ee3))
;;;;;;;;;;;;;;;;x: Prims.int -> FStar.Pervasives.Lemma (ensures Prims.int <==> Prims.unit)
(declare-fun Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3
Tm_type)
:named kinding_Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(31,28-31,56); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3))
:qid PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3))

:named PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3
;;; Fact-ids: 
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(31,28-31,56); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3))

:named PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_5dcc332d2b6107e507490f5b9817b2c3))

; Encoding query formula : forall (_: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     PropositionalExtensionalityInconsistent.propExt_Type ==>
;     (forall (x: Prims.int).
;         (*  - Could not prove post-condition
; *)
;         forall (p: Prims.pure_post Prims.unit).
;           (forall (pure_result: Prims.unit). (Prims.int <==> Prims.unit) ==> p pure_result) ==>
;           (forall (any_result: Prims.unit). p any_result)) /\
;     (forall (any_result:
;         (x: Prims.int -> FStar.Pervasives.Lemma (ensures Prims.int <==> Prims.unit)))
;         (pure_result: Prims.unit).
;         (Prims.int <==> Prims.unit) ==> p pure_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let propExt_Type_inconsistent`
...
;; def=PropositionalExtensionalityInconsistent.fst(29,20-29,32); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(29,20-29,32); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(PropositionalExtensionalityInconsistent.propExt_Type Dummy_value)
)
)

;; def=Prims.fst(459,77-459,89); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(and 
;; def=dummy(0,0-0,0); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=Prims.fst(406,51-406,91); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=PropositionalExtensionalityInconsistent.fst(31,59-31,61)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=PropositionalExtensionalityInconsistent.fst(31,41-31,56); use=PropositionalExtensionalityInconsistent.fst(31,59-31,61)
(or label_2

;; def=PropositionalExtensionalityInconsistent.fst(31,41-31,56); use=PropositionalExtensionalityInconsistent.fst(31,59-31,61)
(iff 
;; def=PropositionalExtensionalityInconsistent.fst(31,42-31,45); use=PropositionalExtensionalityInconsistent.fst(31,59-31,61)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(31,42-31,45); use=PropositionalExtensionalityInconsistent.fst(31,59-31,61)
Prims.int
)
...
;; def=PropositionalExtensionalityInconsistent.fst(31,51-31,55); use=PropositionalExtensionalityInconsistent.fst(31,59-31,61)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(31,51-31,55); use=PropositionalExtensionalityInconsistent.fst(31,59-31,61)
Prims.unit
)
...
;; def=Prims.fst(441,83-441,96); use=PropositionalExtensionalityInconsistent.fst(31,59-31,61)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PropositionalExtensionalityInconsistent.fst(31,59-31,61)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(451,66-451,102); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(Valid 
;; def=Prims.fst(451,90-451,102); use=PropositionalExtensionalityInconsistent.fst(31,3-32,23)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,36-441,97); use=PropositionalExtensionalityInconsistent.fst(32,4-32,20)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=PropositionalExtensionalityInconsistent.fst(31,41-31,56); use=PropositionalExtensionalityInconsistent.fst(32,4-32,20)
(iff 
;; def=PropositionalExtensionalityInconsistent.fst(31,42-31,45); use=PropositionalExtensionalityInconsistent.fst(32,4-32,20)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(31,42-31,45); use=PropositionalExtensionalityInconsistent.fst(32,4-32,20)
Prims.int
)
...
;; def=PropositionalExtensionalityInconsistent.fst(31,51-31,55); use=PropositionalExtensionalityInconsistent.fst(32,4-32,20)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(31,51-31,55); use=PropositionalExtensionalityInconsistent.fst(32,4-32,20)
Prims.unit
)
...
;; def=Prims.fst(441,83-441,96); use=PropositionalExtensionalityInconsistent.fst(32,4-32,20)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropositionalExtensionalityInconsistent.propExt_Type_inconsistent, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, Prims_pretyping_f8666440faa91836cc5a13998af863fc, constructor_distinct_Prims.int, constructor_distinct_Prims.unit, equation_Prims.eqtype, equation_PropositionalExtensionalityInconsistent.propExt_Type, function_token_typing_Prims.__cache_version_number__, haseqTm_refine_bec701fab1d9b97bec3a2b1c70a90ee3, int_inversion, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_kinding_Tm_refine_bec701fab1d9b97bec3a2b1c70a90ee3, typing_Prims.hasEq, typing_Prims.int, typing_Prims.unit, unit_typing
