...
; Internals for PropositionalExtensionalityInconsistent


; encoding sigelt let propExt_Type


; <Start encoding let propExt_Type>

(declare-fun PropositionalExtensionalityInconsistent.propExt_Type (Dummy_sort) Term)

; </end encoding let propExt_Type>


; encoding sigelt let propExt_Type_inconsistent


; <Start encoding let propExt_Type_inconsistent>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PropositionalExtensionalityInconsistent.propExt_Type_inconsistent (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PropositionalExtensionalityInconsistent.propExt_Type_inconsistent@tok () Term)

; </end encoding let propExt_Type_inconsistent>


; encoding sigelt let sub_singleton


; <Start encoding let sub_singleton>

(declare-fun PropositionalExtensionalityInconsistent.sub_singleton () Term)
(declare-fun Tm_refine_a5a4b976760c8ff6c395fec345e05f6d () Term)

; </end encoding let sub_singleton>


; encoding sigelt let propExt_sub_singleton


; <Start encoding let propExt_sub_singleton>

(declare-fun PropositionalExtensionalityInconsistent.propExt_sub_singleton (Dummy_sort) Term)

; </end encoding let propExt_sub_singleton>


; encoding sigelt #push-options "--smtencoding.valid_intro true --smtencoding.valid_elim true"


; <Skipped #push-options "--smtencoding.valid_intro true --smtencoding.valid_elim true"/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.sub_singleton; Namespace PropositionalExtensionalityInconsistent
(assert (! (HasType PropositionalExtensionalityInconsistent.sub_singleton
Tm_type)
:named typing_PropositionalExtensionalityInconsistent.sub_singleton))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.propExt_sub_singleton; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(37,4-37,25); use=PropositionalExtensionalityInconsistent.fst(37,4-37,25)
(forall ((@u0 Dummy_sort))
 (! (HasType (PropositionalExtensionalityInconsistent.propExt_sub_singleton @u0)
Prims.logical)
 

:pattern ((PropositionalExtensionalityInconsistent.propExt_sub_singleton @u0))
:qid typing_PropositionalExtensionalityInconsistent.propExt_sub_singleton))

:named typing_PropositionalExtensionalityInconsistent.propExt_sub_singleton))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.sub_singleton; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(36,20-36,50); use=PropositionalExtensionalityInconsistent.fst(36,20-36,50)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=PropositionalExtensionalityInconsistent.fst(36,27-36,49); use=PropositionalExtensionalityInconsistent.fst(36,27-36,49)
...
;; def=PropositionalExtensionalityInconsistent.fst(36,43-36,49); use=PropositionalExtensionalityInconsistent.fst(36,43-36,49)
(= @x2
@x3)
)
...
(assert (! (HasType PropositionalExtensionalityInconsistent.sub_singleton
Tm_type)
:named function_token_typing_PropositionalExtensionalityInconsistent.sub_singleton))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
;;;;;;;;;;;;;;;;Equation for PropositionalExtensionalityInconsistent.sub_singleton
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.sub_singleton; Namespace PropositionalExtensionalityInconsistent
(assert (! (= PropositionalExtensionalityInconsistent.sub_singleton
Tm_refine_a5a4b976760c8ff6c395fec345e05f6d)
:named equation_PropositionalExtensionalityInconsistent.sub_singleton))
;;;;;;;;;;;;;;;;Equation for PropositionalExtensionalityInconsistent.propExt_sub_singleton
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.propExt_sub_singleton; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(37,4-37,25); use=PropositionalExtensionalityInconsistent.fst(37,4-37,25)
(forall ((@u0 Dummy_sort))
...
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(37,4-37,25); use=PropositionalExtensionalityInconsistent.fst(37,4-37,25)
(PropositionalExtensionalityInconsistent.propExt_sub_singleton @u0)
)


;; def=PropositionalExtensionalityInconsistent.fst(37,28-37,82); use=PropositionalExtensionalityInconsistent.fst(37,28-37,82)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
PropositionalExtensionalityInconsistent.sub_singleton)
(HasType @x2
PropositionalExtensionalityInconsistent.sub_singleton))

;; def=PropositionalExtensionalityInconsistent.fst(37,58-37,82); use=PropositionalExtensionalityInconsistent.fst(37,58-37,82)
(iff 
;; def=PropositionalExtensionalityInconsistent.fst(37,58-37,70); use=PropositionalExtensionalityInconsistent.fst(37,58-37,70)
(iff 
;; def=PropositionalExtensionalityInconsistent.fst(37,36-37,38); use=PropositionalExtensionalityInconsistent.fst(37,59-37,61)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(37,36-37,38); use=PropositionalExtensionalityInconsistent.fst(37,59-37,61)
@x1
)
...
;; def=PropositionalExtensionalityInconsistent.fst(37,39-37,41); use=PropositionalExtensionalityInconsistent.fst(37,67-37,69)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(37,39-37,41); use=PropositionalExtensionalityInconsistent.fst(37,67-37,69)
@x2
)
...
;; def=PropositionalExtensionalityInconsistent.fst(37,76-37,82); use=PropositionalExtensionalityInconsistent.fst(37,76-37,82)
(= @x1
@x2)
)
)
...
;;no pats
:qid equation_PropositionalExtensionalityInconsistent.propExt_sub_singleton.1))
)
...
:qid equation_PropositionalExtensionalityInconsistent.propExt_sub_singleton))

:named equation_PropositionalExtensionalityInconsistent.propExt_sub_singleton))
...
;;;;;;;;;;;;;;;;Prop-typing for PropositionalExtensionalityInconsistent.propExt_sub_singleton
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.propExt_sub_singleton; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(37,4-37,25); use=PropositionalExtensionalityInconsistent.fst(37,4-37,25)
(forall ((@u0 Dummy_sort))
...
:qid defn_equation_PropositionalExtensionalityInconsistent.propExt_sub_singleton))

:named defn_equation_PropositionalExtensionalityInconsistent.propExt_sub_singleton))
...
; Starting query at PropositionalExtensionalityInconsistent.fst(43,4-43,6)
...
;     PropositionalExtensionalityInconsistent.propExt_sub_singleton ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let propExt_sub_singleton_inconsistent`
...
;; def=PropositionalExtensionalityInconsistent.fst(41,20-41,41); use=PropositionalExtensionalityInconsistent.fst(43,4-43,6)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(41,20-41,41); use=PropositionalExtensionalityInconsistent.fst(43,4-43,6)
(PropositionalExtensionalityInconsistent.propExt_sub_singleton Dummy_value)
)
)
...
;; def=Prims.fst(451,90-451,102); use=PropositionalExtensionalityInconsistent.fst(43,4-43,6)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropositionalExtensionalityInconsistent.propExt_sub_singleton_inconsistent, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_e8ffb7d227a1bbf69407a8d2ad2c4c83, constructor_distinct_Prims.T, constructor_distinct_Tm_unit, equality_tok_Prims.T@tok, equation_Prims.l_True, equation_Prims.logical, equation_Prims.squash, equation_PropositionalExtensionalityInconsistent.propExt_sub_singleton, equation_PropositionalExtensionalityInconsistent.sub_singleton, fuel_guarded_inversion_Prims.trivial, kinding_Prims.trivial@tok, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c, refinement_interpretation_Tm_refine_a5a4b976760c8ff6c395fec345e05f6d, true_interp, typing_Prims.l_True, typing_tok_Prims.T@tok, unit_inversion
