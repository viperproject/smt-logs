...
; encoding sigelt let propExt_sub_singleton_inconsistent


; <Start encoding let propExt_sub_singleton_inconsistent>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PropositionalExtensionalityInconsistent.propExt_sub_singleton_inconsistent (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PropositionalExtensionalityInconsistent.propExt_sub_singleton_inconsistent@tok () Term)

; </end encoding let propExt_sub_singleton_inconsistent>
...
; encoding sigelt let predicate


; <Start encoding let predicate>

(declare-fun PropositionalExtensionalityInconsistent.predicate (Term) Term)

(declare-fun PropositionalExtensionalityInconsistent.predicate@tok () Term)


; </end encoding let predicate>


; encoding sigelt let peq


; <Start encoding let peq>

(declare-fun PropositionalExtensionalityInconsistent.peq (Term Term Term) Term)
;;;;;;;;;;;;;;;;p1: predicate a -> p2: predicate a -> Prims.logical
(declare-fun Tm_arrow_461b9105bf1d6a9061d8ebcb90f980bd () Term)
(declare-fun PropositionalExtensionalityInconsistent.peq@tok () Term)

; </end encoding let peq>


; encoding sigelt let predExt_Type


; <Start encoding let predExt_Type>

(declare-fun PropositionalExtensionalityInconsistent.predExt_Type () Term)
(declare-fun Tm_refine_03534bb61551390ff3b5a06f66b521e6 (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> p1: predicate a -> p2: predicate a   -> FStar.Pervasives.Lemma (requires peq p1 p2) (ensures p1 == p2)
(declare-fun Tm_arrow_5343c1071af99cea453d57ab5629f3a5 () Term)

; </end encoding let predExt_Type>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predicate; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(53,4-53,13); use=PropositionalExtensionalityInconsistent.fst(53,4-53,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (PropositionalExtensionalityInconsistent.predicate @x0)
Tm_type))
 

:pattern ((PropositionalExtensionalityInconsistent.predicate @x0))
:qid typing_PropositionalExtensionalityInconsistent.predicate))

:named typing_PropositionalExtensionalityInconsistent.predicate))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! (HasType PropositionalExtensionalityInconsistent.predExt_Type
Tm_type)
:named typing_PropositionalExtensionalityInconsistent.predExt_Type))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.peq; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(54,4-54,7); use=PropositionalExtensionalityInconsistent.fst(54,4-54,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(PropositionalExtensionalityInconsistent.predicate @x0))
(HasType @x2
(PropositionalExtensionalityInconsistent.predicate @x0)))
(HasType (PropositionalExtensionalityInconsistent.peq @x0
@x1
@x2)
Prims.logical))
 

:pattern ((PropositionalExtensionalityInconsistent.peq @x0
@x1
@x2))
:qid typing_PropositionalExtensionalityInconsistent.peq))

:named typing_PropositionalExtensionalityInconsistent.peq))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(60,7-61,32); use=PropositionalExtensionalityInconsistent.fst(60,7-61,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_03534bb61551390ff3b5a06f66b521e6 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_03534bb61551390ff3b5a06f66b521e6 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_03534bb61551390ff3b5a06f66b521e6))

:named refinement_kinding_Tm_refine_03534bb61551390ff3b5a06f66b521e6))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_03534bb61551390ff3b5a06f66b521e6 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=PropositionalExtensionalityInconsistent.fst(60,7-61,32)
(not 
;; def=Prims.fst(441,29-441,97); use=PropositionalExtensionalityInconsistent.fst(60,7-60,12)
(and 
;; def=PropositionalExtensionalityInconsistent.fst(60,23-60,34); use=PropositionalExtensionalityInconsistent.fst(60,7-60,12)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(60,23-60,34); use=PropositionalExtensionalityInconsistent.fst(60,7-60,12)
(PropositionalExtensionalityInconsistent.peq @x2
@x3
@x4)
)


;; def=Prims.fst(441,36-441,97); use=PropositionalExtensionalityInconsistent.fst(60,7-60,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=PropositionalExtensionalityInconsistent.fst(61,21-61,31); use=PropositionalExtensionalityInconsistent.fst(60,7-60,12)
(= @x3
@x4)
)

;; def=Prims.fst(635,86-635,95); use=PropositionalExtensionalityInconsistent.fst(60,7-61,32)
(not 
;; def=Prims.fst(635,86-635,95); use=PropositionalExtensionalityInconsistent.fst(60,7-61,32)
(= @x5
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_03534bb61551390ff3b5a06f66b521e6.1))
)
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_03534bb61551390ff3b5a06f66b521e6))

:named refinement_interpretation_Tm_refine_03534bb61551390ff3b5a06f66b521e6))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5343c1071af99cea453d57ab5629f3a5
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! (HasType Tm_arrow_5343c1071af99cea453d57ab5629f3a5
Tm_type)
:named kinding_Tm_arrow_5343c1071af99cea453d57ab5629f3a5))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_03534bb61551390ff3b5a06f66b521e6
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(60,7-61,32); use=PropositionalExtensionalityInconsistent.fst(60,7-61,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_03534bb61551390ff3b5a06f66b521e6 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_03534bb61551390ff3b5a06f66b521e6 @x0
@x1
@x2))))
:qid haseqTm_refine_03534bb61551390ff3b5a06f66b521e6))

:named haseqTm_refine_03534bb61551390ff3b5a06f66b521e6))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! (HasType PropositionalExtensionalityInconsistent.predExt_Type
Tm_type)
:named function_token_typing_PropositionalExtensionalityInconsistent.predExt_Type))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
;;;;;;;;;;;;;;;;Equation for PropositionalExtensionalityInconsistent.predicate
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predicate; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(53,4-53,13); use=PropositionalExtensionalityInconsistent.fst(53,4-53,13)
(forall ((@x0 Term))
...
:pattern ((PropositionalExtensionalityInconsistent.predicate @x0))
:qid equation_PropositionalExtensionalityInconsistent.predicate))

:named equation_PropositionalExtensionalityInconsistent.predicate))
;;;;;;;;;;;;;;;;Equation for PropositionalExtensionalityInconsistent.predExt_Type
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! (= PropositionalExtensionalityInconsistent.predExt_Type
Tm_arrow_5343c1071af99cea453d57ab5629f3a5)
:named equation_PropositionalExtensionalityInconsistent.predExt_Type))
;;;;;;;;;;;;;;;;Equation for PropositionalExtensionalityInconsistent.peq
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.peq; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(54,4-54,7); use=PropositionalExtensionalityInconsistent.fst(54,4-54,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (PropositionalExtensionalityInconsistent.peq @x0
@x1
@x2))

;; def=PropositionalExtensionalityInconsistent.fst(55,2-55,26); use=PropositionalExtensionalityInconsistent.fst(55,2-55,26)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x0)

;; def=PropositionalExtensionalityInconsistent.fst(55,12-55,26); use=PropositionalExtensionalityInconsistent.fst(55,12-55,26)
(iff 
;; def=PropositionalExtensionalityInconsistent.fst(55,12-55,16); use=PropositionalExtensionalityInconsistent.fst(55,12-55,16)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(55,12-55,16); use=PropositionalExtensionalityInconsistent.fst(55,12-55,16)
(ApplyTT @x1
@x3)
...
;; def=PropositionalExtensionalityInconsistent.fst(55,22-55,26); use=PropositionalExtensionalityInconsistent.fst(55,22-55,26)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(55,22-55,26); use=PropositionalExtensionalityInconsistent.fst(55,22-55,26)
(ApplyTT @x2
@x3)
...
;;no pats
:qid equation_PropositionalExtensionalityInconsistent.peq.1))
)
...
@x1
@x2))
:qid equation_PropositionalExtensionalityInconsistent.peq))

:named equation_PropositionalExtensionalityInconsistent.peq))
...
;;;;;;;;;;;;;;;;Prop-typing for PropositionalExtensionalityInconsistent.peq
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.peq; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(54,4-54,7); use=PropositionalExtensionalityInconsistent.fst(54,4-54,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(PropositionalExtensionalityInconsistent.predicate @x0)))
(Valid (Prims.subtype_of (PropositionalExtensionalityInconsistent.peq @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (PropositionalExtensionalityInconsistent.peq @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_PropositionalExtensionalityInconsistent.peq))

:named defn_equation_PropositionalExtensionalityInconsistent.peq))
...
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(57,6-61,32); use=PropositionalExtensionalityInconsistent.fst(57,6-61,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_5343c1071af99cea453d57ab5629f3a5)
...
@x1
Tm_arrow_5343c1071af99cea453d57ab5629f3a5))
:qid PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_5343c1071af99cea453d57ab5629f3a5))

:named PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_5343c1071af99cea453d57ab5629f3a5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5343c1071af99cea453d57ab5629f3a5
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_Type; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(57,6-61,32); use=PropositionalExtensionalityInconsistent.fst(57,6-61,32)
(forall ((@x0 Term))
...
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(60,23-60,34); use=PropositionalExtensionalityInconsistent.fst(60,7-60,12)
(PropositionalExtensionalityInconsistent.peq @x1
@x2
@x3)
)
...
Tm_type)
(HasType @x2
(PropositionalExtensionalityInconsistent.predicate @x1))
(HasType @x3
(PropositionalExtensionalityInconsistent.predicate @x1)))
...
@x2)
@x3)
(Tm_refine_03534bb61551390ff3b5a06f66b521e6 @x1
@x2
@x3)))
...
@x2)
@x3))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_5343c1071af99cea453d57ab5629f3a5.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_5343c1071af99cea453d57ab5629f3a5.2))
...
@x1)
@x2))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_5343c1071af99cea453d57ab5629f3a5.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_5343c1071af99cea453d57ab5629f3a5))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_5343c1071af99cea453d57ab5629f3a5))

:named PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_5343c1071af99cea453d57ab5629f3a5))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
; Starting query at PropositionalExtensionalityInconsistent.fst(64,3-66,16)
...
;;; Fact-ids: 
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(53,35-64,26); use=PropositionalExtensionalityInconsistent.fst(64,3-66,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
...
:pattern ((ApplyTT @x0
@x1))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
(declare-fun Tm_abs_2a2be7203c611e1ab329e9b7791756a0 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_2a2be7203c611e1ab329e9b7791756a0
;;; Fact-ids: 
(assert (! (HasType Tm_abs_2a2be7203c611e1ab329e9b7791756a0
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
:named typing_Tm_abs_2a2be7203c611e1ab329e9b7791756a0))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2a2be7203c611e1ab329e9b7791756a0
;;; Fact-ids: 
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(64,38-64,45); use=PropositionalExtensionalityInconsistent.fst(64,38-64,45)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_2a2be7203c611e1ab329e9b7791756a0
@x0)
Prims.trivial)
 

:pattern ((ApplyTT Tm_abs_2a2be7203c611e1ab329e9b7791756a0
@x0))
:qid interpretation_Tm_abs_2a2be7203c611e1ab329e9b7791756a0))

:named interpretation_Tm_abs_2a2be7203c611e1ab329e9b7791756a0))

(declare-fun Tm_abs_5f478a51ba82de0380aaee3374dfcd4b () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_5f478a51ba82de0380aaee3374dfcd4b
;;; Fact-ids: 
(assert (! (HasType Tm_abs_5f478a51ba82de0380aaee3374dfcd4b
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
:named typing_Tm_abs_5f478a51ba82de0380aaee3374dfcd4b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_5f478a51ba82de0380aaee3374dfcd4b
;;; Fact-ids: 
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(65,38-65,42); use=PropositionalExtensionalityInconsistent.fst(65,38-65,42)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_5f478a51ba82de0380aaee3374dfcd4b
@x0)
Prims.unit)
 

:pattern ((ApplyTT Tm_abs_5f478a51ba82de0380aaee3374dfcd4b
@x0))
:qid interpretation_Tm_abs_5f478a51ba82de0380aaee3374dfcd4b))

:named interpretation_Tm_abs_5f478a51ba82de0380aaee3374dfcd4b))





; Encoding query formula : forall (ax: PropositionalExtensionalityInconsistent.predExt_Type).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     PropositionalExtensionalityInconsistent.peq (fun _ -> Prims.trivial) (fun _ -> Prims.unit) /\
;     (forall (pure_result: Prims.unit).
;         (fun _ -> Prims.trivial) == (fun _ -> Prims.unit) ==> p pure_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let predExt_Type_inconsistent`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (HasType @x0
PropositionalExtensionalityInconsistent.predExt_Type)
...
;; def=Prims.fst(441,29-441,97); use=PropositionalExtensionalityInconsistent.fst(64,3-66,16)
(and 
;; def=PropositionalExtensionalityInconsistent.fst(60,23-60,34); use=PropositionalExtensionalityInconsistent.fst(64,3-66,16)
(or label_1

;; def=PropositionalExtensionalityInconsistent.fst(60,23-60,34); use=PropositionalExtensionalityInconsistent.fst(64,3-66,16)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(60,23-60,34); use=PropositionalExtensionalityInconsistent.fst(64,3-66,16)
(PropositionalExtensionalityInconsistent.peq Prims.int
Tm_abs_2a2be7203c611e1ab329e9b7791756a0
Tm_abs_5f478a51ba82de0380aaee3374dfcd4b)
)
)


;; def=Prims.fst(441,36-441,97); use=PropositionalExtensionalityInconsistent.fst(64,3-66,16)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=PropositionalExtensionalityInconsistent.fst(61,21-61,31); use=PropositionalExtensionalityInconsistent.fst(64,3-66,16)
(= Tm_abs_2a2be7203c611e1ab329e9b7791756a0
Tm_abs_5f478a51ba82de0380aaee3374dfcd4b)
)

;; def=Prims.fst(441,83-441,96); use=PropositionalExtensionalityInconsistent.fst(64,3-66,16)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropositionalExtensionalityInconsistent.predExt_Type_inconsistent, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, Prims_pretyping_e8ffb7d227a1bbf69407a8d2ad2c4c83, Prims_pretyping_f8666440faa91836cc5a13998af863fc, constructor_distinct_Prims.trivial, constructor_distinct_Prims.unit, equality_tok_Prims.T@tok, equation_PropositionalExtensionalityInconsistent.peq, function_token_typing_Prims.__cache_version_number__, interpretation_Tm_abs_2a2be7203c611e1ab329e9b7791756a0, interpretation_Tm_abs_5f478a51ba82de0380aaee3374dfcd4b, typing_tok_Prims.T@tok, unit_typing
...
; encoding sigelt let predExt_Type_inconsistent


; <Start encoding let predExt_Type_inconsistent>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PropositionalExtensionalityInconsistent.predExt_Type_inconsistent (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PropositionalExtensionalityInconsistent.predExt_Type_inconsistent@tok () Term)

; </end encoding let predExt_Type_inconsistent>


; encoding sigelt let predicate_ss


; <Start encoding let predicate_ss>

(declare-fun PropositionalExtensionalityInconsistent.predicate_ss (Term) Term)

(declare-fun PropositionalExtensionalityInconsistent.predicate_ss@tok () Term)
;;;;;;;;;;;;;;;;_: a -> sub_singleton
(declare-fun Tm_arrow_6ab287aea706e2c9e2c3f12001591b92 (Term) Term)

; </end encoding let predicate_ss>


; encoding sigelt let peq_ss


; <Start encoding let peq_ss>

(declare-fun PropositionalExtensionalityInconsistent.peq_ss (Term Term Term) Term)
;;;;;;;;;;;;;;;;p1: predicate_ss a -> p2: predicate_ss a -> Prims.logical
(declare-fun Tm_arrow_913f796d54afff5be91c568f81a23419 () Term)
(declare-fun PropositionalExtensionalityInconsistent.peq_ss@tok () Term)

; </end encoding let peq_ss>


; encoding sigelt let predExt_ss


; <Start encoding let predExt_ss>

(declare-fun PropositionalExtensionalityInconsistent.predExt_ss () Term)
(declare-fun Tm_refine_7067a7c86995431ca722a99c30c9430f (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> p1: predicate_ss a -> p2: predicate_ss a   -> FStar.Pervasives.Lemma (requires peq_ss p1 p2) (ensures p1 == p2)
(declare-fun Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7 () Term)

; </end encoding let predExt_ss>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predicate_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(70,4-70,16); use=PropositionalExtensionalityInconsistent.fst(70,4-70,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (PropositionalExtensionalityInconsistent.predicate_ss @x0)
Tm_type))
 

:pattern ((PropositionalExtensionalityInconsistent.predicate_ss @x0))
:qid typing_PropositionalExtensionalityInconsistent.predicate_ss))

:named typing_PropositionalExtensionalityInconsistent.predicate_ss))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! (HasType PropositionalExtensionalityInconsistent.predExt_ss
Tm_type)
:named typing_PropositionalExtensionalityInconsistent.predExt_ss))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.peq_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(71,4-71,10); use=PropositionalExtensionalityInconsistent.fst(71,4-71,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(PropositionalExtensionalityInconsistent.predicate_ss @x0))
(HasType @x2
(PropositionalExtensionalityInconsistent.predicate_ss @x0)))
(HasType (PropositionalExtensionalityInconsistent.peq_ss @x0
@x1
@x2)
Prims.logical))
 

:pattern ((PropositionalExtensionalityInconsistent.peq_ss @x0
@x1
@x2))
:qid typing_PropositionalExtensionalityInconsistent.peq_ss))

:named typing_PropositionalExtensionalityInconsistent.peq_ss))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(77,7-78,32); use=PropositionalExtensionalityInconsistent.fst(77,7-78,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_7067a7c86995431ca722a99c30c9430f @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_7067a7c86995431ca722a99c30c9430f @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_7067a7c86995431ca722a99c30c9430f))

:named refinement_kinding_Tm_refine_7067a7c86995431ca722a99c30c9430f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(77,7-78,32); use=PropositionalExtensionalityInconsistent.fst(77,7-78,32)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7067a7c86995431ca722a99c30c9430f @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=PropositionalExtensionalityInconsistent.fst(77,7-78,32)
(not 
;; def=Prims.fst(441,29-441,97); use=PropositionalExtensionalityInconsistent.fst(77,7-77,12)
(and 
;; def=PropositionalExtensionalityInconsistent.fst(77,23-77,37); use=PropositionalExtensionalityInconsistent.fst(77,7-77,12)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(77,23-77,37); use=PropositionalExtensionalityInconsistent.fst(77,7-77,12)
(PropositionalExtensionalityInconsistent.peq_ss @x2
@x3
@x4)
)


;; def=Prims.fst(441,36-441,97); use=PropositionalExtensionalityInconsistent.fst(77,7-77,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=PropositionalExtensionalityInconsistent.fst(78,21-78,31); use=PropositionalExtensionalityInconsistent.fst(77,7-77,12)
(= @x3
@x4)
)

;; def=Prims.fst(635,86-635,95); use=PropositionalExtensionalityInconsistent.fst(77,7-78,32)
(not 
;; def=Prims.fst(635,86-635,95); use=PropositionalExtensionalityInconsistent.fst(77,7-78,32)
(= @x5
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_7067a7c86995431ca722a99c30c9430f.1))
)
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_7067a7c86995431ca722a99c30c9430f))

:named refinement_interpretation_Tm_refine_7067a7c86995431ca722a99c30c9430f))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! (HasType Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7
Tm_type)
:named kinding_Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6ab287aea706e2c9e2c3f12001591b92
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predicate_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(70,18-70,51); use=PropositionalExtensionalityInconsistent.fst(70,29-70,51)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_6ab287aea706e2c9e2c3f12001591b92 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_6ab287aea706e2c9e2c3f12001591b92 @x0)
Tm_type))
:qid kinding_Tm_arrow_6ab287aea706e2c9e2c3f12001591b92))

:named kinding_Tm_arrow_6ab287aea706e2c9e2c3f12001591b92))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7067a7c86995431ca722a99c30c9430f
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(77,7-78,32); use=PropositionalExtensionalityInconsistent.fst(77,7-78,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7067a7c86995431ca722a99c30c9430f @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7067a7c86995431ca722a99c30c9430f @x0
@x1
@x2))))
:qid haseqTm_refine_7067a7c86995431ca722a99c30c9430f))

:named haseqTm_refine_7067a7c86995431ca722a99c30c9430f))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.sub_singleton; Namespace PropositionalExtensionalityInconsistent
(assert (! (HasType PropositionalExtensionalityInconsistent.sub_singleton
Tm_type)
...
(assert (! (HasType PropositionalExtensionalityInconsistent.predExt_ss
Tm_type)
:named function_token_typing_PropositionalExtensionalityInconsistent.predExt_ss))
...
;;;;;;;;;;;;;;;;Equation for PropositionalExtensionalityInconsistent.predicate_ss
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predicate_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(70,4-70,16); use=PropositionalExtensionalityInconsistent.fst(70,4-70,16)
(forall ((@x0 Term))
 (! (= (PropositionalExtensionalityInconsistent.predicate_ss @x0)
(Tm_arrow_6ab287aea706e2c9e2c3f12001591b92 @x0))
 

:pattern ((PropositionalExtensionalityInconsistent.predicate_ss @x0))
:qid equation_PropositionalExtensionalityInconsistent.predicate_ss))

:named equation_PropositionalExtensionalityInconsistent.predicate_ss))
;;;;;;;;;;;;;;;;Equation for PropositionalExtensionalityInconsistent.predExt_ss
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! (= PropositionalExtensionalityInconsistent.predExt_ss
Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7)
:named equation_PropositionalExtensionalityInconsistent.predExt_ss))
;;;;;;;;;;;;;;;;Equation for PropositionalExtensionalityInconsistent.peq_ss
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.peq_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(71,4-71,10); use=PropositionalExtensionalityInconsistent.fst(71,4-71,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (PropositionalExtensionalityInconsistent.peq_ss @x0
@x1
@x2))

;; def=PropositionalExtensionalityInconsistent.fst(72,4-72,28); use=PropositionalExtensionalityInconsistent.fst(72,4-72,28)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x0)

;; def=PropositionalExtensionalityInconsistent.fst(72,14-72,28); use=PropositionalExtensionalityInconsistent.fst(72,14-72,28)
(iff 
;; def=PropositionalExtensionalityInconsistent.fst(72,14-72,18); use=PropositionalExtensionalityInconsistent.fst(72,14-72,18)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(72,14-72,18); use=PropositionalExtensionalityInconsistent.fst(72,14-72,18)
(ApplyTT @x1
@x3)
...
;; def=PropositionalExtensionalityInconsistent.fst(72,24-72,28); use=PropositionalExtensionalityInconsistent.fst(72,24-72,28)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(72,24-72,28); use=PropositionalExtensionalityInconsistent.fst(72,24-72,28)
(ApplyTT @x2
@x3)
...
;;no pats
:qid equation_PropositionalExtensionalityInconsistent.peq_ss.1))
)
...
@x1
@x2))
:qid equation_PropositionalExtensionalityInconsistent.peq_ss))

:named equation_PropositionalExtensionalityInconsistent.peq_ss))
;;;;;;;;;;;;;;;;Prop-typing for PropositionalExtensionalityInconsistent.peq_ss
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.peq_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(71,4-71,10); use=PropositionalExtensionalityInconsistent.fst(71,4-71,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(PropositionalExtensionalityInconsistent.predicate_ss @x0)))
(Valid (Prims.subtype_of (PropositionalExtensionalityInconsistent.peq_ss @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (PropositionalExtensionalityInconsistent.peq_ss @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_PropositionalExtensionalityInconsistent.peq_ss))

:named defn_equation_PropositionalExtensionalityInconsistent.peq_ss))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(74,6-78,32); use=PropositionalExtensionalityInconsistent.fst(74,6-78,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7)
...
@x1
Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7))
:qid PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7))

:named PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predicate_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(70,18-70,51); use=PropositionalExtensionalityInconsistent.fst(70,29-70,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_6ab287aea706e2c9e2c3f12001591b92 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_6ab287aea706e2c9e2c3f12001591b92 @x2)))
:qid PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_6ab287aea706e2c9e2c3f12001591b92))

:named PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_6ab287aea706e2c9e2c3f12001591b92))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predExt_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(74,6-78,32); use=PropositionalExtensionalityInconsistent.fst(74,6-78,32)
(forall ((@x0 Term))
...
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(77,23-77,37); use=PropositionalExtensionalityInconsistent.fst(77,7-77,12)
(PropositionalExtensionalityInconsistent.peq_ss @x1
@x2
@x3)
)
...
Tm_type)
(HasType @x2
(PropositionalExtensionalityInconsistent.predicate_ss @x1))
(HasType @x3
(PropositionalExtensionalityInconsistent.predicate_ss @x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
@x3)
(Tm_refine_7067a7c86995431ca722a99c30c9430f @x1
@x2
@x3)))
...
@x2)
@x3))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7.2))
...
@x1)
@x2))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7))

:named PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_dd7ad7b78c2a0ccfd8e04ad90a91aec7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_6ab287aea706e2c9e2c3f12001591b92
;;; Fact-ids: Name PropositionalExtensionalityInconsistent.predicate_ss; Namespace PropositionalExtensionalityInconsistent
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(70,18-70,51); use=PropositionalExtensionalityInconsistent.fst(70,29-70,51)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_6ab287aea706e2c9e2c3f12001591b92 @x1))
(and 
;; def=PropositionalExtensionalityInconsistent.fst(70,18-70,51); use=PropositionalExtensionalityInconsistent.fst(70,29-70,51)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_6ab287aea706e2c9e2c3f12001591b92.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_6ab287aea706e2c9e2c3f12001591b92 @x1)))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_6ab287aea706e2c9e2c3f12001591b92))

:named PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_6ab287aea706e2c9e2c3f12001591b92))
(push) ;; push{2

; Starting query at PropositionalExtensionalityInconsistent.fst(81,3-83,16)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;n: Prims.int -> sub_singleton
(declare-fun Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0
Tm_type)
:named kinding_Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(70,38-81,29); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0))
:qid PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0))

:named PropositionalExtensionalityInconsistent_pre_typing_Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0
;;; Fact-ids: 
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(70,38-81,29); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0))
:qid PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0))

:named PropositionalExtensionalityInconsistent_interpretation_Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0))
(declare-fun Tm_abs_8c158db07e7c84dd65bd96a94faf93c7 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_8c158db07e7c84dd65bd96a94faf93c7
;;; Fact-ids: 
(assert (! (HasType Tm_abs_8c158db07e7c84dd65bd96a94faf93c7
Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0)
:named typing_Tm_abs_8c158db07e7c84dd65bd96a94faf93c7))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_8c158db07e7c84dd65bd96a94faf93c7
;;; Fact-ids: 
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(81,41-81,48); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_8c158db07e7c84dd65bd96a94faf93c7
@x0)
Prims.trivial)
 

:pattern ((ApplyTT Tm_abs_8c158db07e7c84dd65bd96a94faf93c7
@x0))
:qid interpretation_Tm_abs_8c158db07e7c84dd65bd96a94faf93c7))

:named interpretation_Tm_abs_8c158db07e7c84dd65bd96a94faf93c7))

(declare-fun Tm_abs_fe99e319c4155387f8c311f51229dd3a () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_fe99e319c4155387f8c311f51229dd3a
;;; Fact-ids: 
(assert (! (HasType Tm_abs_fe99e319c4155387f8c311f51229dd3a
Tm_arrow_8bd4adbf9a474445ae23216c1c21b4f0)
:named typing_Tm_abs_fe99e319c4155387f8c311f51229dd3a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_fe99e319c4155387f8c311f51229dd3a
;;; Fact-ids: 
(assert (! 
;; def=PropositionalExtensionalityInconsistent.fst(82,41-82,45); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_fe99e319c4155387f8c311f51229dd3a
@x0)
Prims.unit)
 

:pattern ((ApplyTT Tm_abs_fe99e319c4155387f8c311f51229dd3a
@x0))
:qid interpretation_Tm_abs_fe99e319c4155387f8c311f51229dd3a))

:named interpretation_Tm_abs_fe99e319c4155387f8c311f51229dd3a))
...
; Encoding query formula : forall (ax: PropositionalExtensionalityInconsistent.predExt_ss).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (n: Prims.int).
;         (*  - Could not prove post-condition
; *) forall (x: Prims.trivial) (y: Prims.trivial). x == y
;     ) /\
;     (forall (any_result: PropositionalExtensionalityInconsistent.predicate_ss Prims.int).
;         (fun _ -> Prims.trivial) == any_result ==>
;         (forall (n: Prims.int).
;             (*  - Could not prove post-condition
; *) forall (x: Prims.unit) (y: Prims.unit). x == y) /\
;         (forall (any_result: PropositionalExtensionalityInconsistent.predicate_ss Prims.int).
;             (fun _ -> Prims.unit) == any_result ==>
;             PropositionalExtensionalityInconsistent.peq_ss (fun _ -> Prims.trivial)
;               (fun _ -> Prims.unit) /\
;             (forall (pure_result: Prims.unit).
;                 (fun _ -> Prims.trivial) == (fun _ -> Prims.unit) ==> p pure_result)))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let predExt_ss_inconsistent`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (HasType @x0
PropositionalExtensionalityInconsistent.predExt_ss)
...
;; def=Prims.fst(459,77-459,89); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(and 
;; def=dummy(0,0-0,0); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=PropositionalExtensionalityInconsistent.fst(36,27-36,49); use=PropositionalExtensionalityInconsistent.fst(81,41-81,48)
...
;; def=PropositionalExtensionalityInconsistent.fst(36,43-36,49); use=PropositionalExtensionalityInconsistent.fst(81,41-81,48)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(PropositionalExtensionalityInconsistent.predicate_ss Prims.int))

;; def=PropositionalExtensionalityInconsistent.fst(81,8-81,48); use=PropositionalExtensionalityInconsistent.fst(81,8-81,48)
(= Tm_abs_8c158db07e7c84dd65bd96a94faf93c7
@x2)
)
...
;; def=PropositionalExtensionalityInconsistent.fst(36,27-36,49); use=PropositionalExtensionalityInconsistent.fst(82,41-82,45)
...
;; def=PropositionalExtensionalityInconsistent.fst(36,43-36,49); use=PropositionalExtensionalityInconsistent.fst(82,41-82,45)
(or label_2
...
;; def=PropositionalExtensionalityInconsistent.fst(82,8-82,45); use=PropositionalExtensionalityInconsistent.fst(82,8-82,45)
(= Tm_abs_fe99e319c4155387f8c311f51229dd3a
@x3)
)

;; def=Prims.fst(441,29-441,97); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(and 
;; def=PropositionalExtensionalityInconsistent.fst(77,23-77,37); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(or label_3

;; def=PropositionalExtensionalityInconsistent.fst(77,23-77,37); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(Valid 
;; def=PropositionalExtensionalityInconsistent.fst(77,23-77,37); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(PropositionalExtensionalityInconsistent.peq_ss Prims.int
Tm_abs_8c158db07e7c84dd65bd96a94faf93c7
Tm_abs_fe99e319c4155387f8c311f51229dd3a)
)
)
...
;; def=Prims.fst(441,36-441,97); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=PropositionalExtensionalityInconsistent.fst(78,21-78,31); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(= Tm_abs_8c158db07e7c84dd65bd96a94faf93c7
Tm_abs_fe99e319c4155387f8c311f51229dd3a)
)

;; def=Prims.fst(441,83-441,96); use=PropositionalExtensionalityInconsistent.fst(81,3-83,16)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropositionalExtensionalityInconsistent.predExt_ss_inconsistent, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, Prims_pretyping_e8ffb7d227a1bbf69407a8d2ad2c4c83, Prims_pretyping_f8666440faa91836cc5a13998af863fc, constructor_distinct_Prims.trivial, constructor_distinct_Prims.unit, equality_tok_Prims.T@tok, equation_PropositionalExtensionalityInconsistent.peq_ss, fuel_guarded_inversion_Prims.trivial, function_token_typing_Prims.__cache_version_number__, interpretation_Tm_abs_8c158db07e7c84dd65bd96a94faf93c7, interpretation_Tm_abs_fe99e319c4155387f8c311f51229dd3a, typing_tok_Prims.T@tok, unit_inversion, unit_typing
