...
; Internals for InjectiveTypeFormers.Explicit
...
; Starting query at InjectiveTypeFormers.Explicit.fst(3,35-3,36)
...
;;; Fact-ids: 
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(3,11-3,27); use=InjectiveTypeFormers.Explicit.fst(3,11-3,27)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_754b00004f4a881ff74d076ab276dfe1 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_754b00004f4a881ff74d076ab276dfe1 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_754b00004f4a881ff74d076ab276dfe1))

:named refinement_kinding_Tm_refine_754b00004f4a881ff74d076ab276dfe1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(3,11-3,27); use=InjectiveTypeFormers.Explicit.fst(3,11-3,27)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_754b00004f4a881ff74d076ab276dfe1 @x2
@x3))
(and (HasTypeFuel @u0
@x1
@x2)

;; def=InjectiveTypeFormers.Explicit.fst(3,17-3,25); use=InjectiveTypeFormers.Explicit.fst(3,17-3,25)
(= @x2
@x3)
))
...
(Tm_refine_754b00004f4a881ff74d076ab276dfe1 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_754b00004f4a881ff74d076ab276dfe1))

:named refinement_interpretation_Tm_refine_754b00004f4a881ff74d076ab276dfe1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_754b00004f4a881ff74d076ab276dfe1
;;; Fact-ids: 
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(3,11-3,27); use=InjectiveTypeFormers.Explicit.fst(3,11-3,27)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_754b00004f4a881ff74d076ab276dfe1 @x0
@x1)))
(Valid (Prims.hasEq @x0)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_754b00004f4a881ff74d076ab276dfe1 @x0
@x1))))
:qid haseqTm_refine_754b00004f4a881ff74d076ab276dfe1))

:named haseqTm_refine_754b00004f4a881ff74d076ab276dfe1))

; Encoding query formula : forall ('a: Type) ('b: Type) (x: 'a{'a == 'b}).
;   (*  - Could not prove post-condition
; *) Prims.has_type x 'b


; Context: While encoding a query
; While typechecking the top-level declaration `let coerce`
...
Tm_type)
(HasType @x2
(Tm_refine_754b00004f4a881ff74d076ab276dfe1 @x0
@x1)))

;; def=InjectiveTypeFormers.Explicit.fst(3,12-3,13); use=InjectiveTypeFormers.Explicit.fst(3,35-3,36)
(or label_1
(HasType @x2
@x1))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InjectiveTypeFormers.Explicit.coerce, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_754b00004f4a881ff74d076ab276dfe1
...
; encoding sigelt let coerce


; <Start encoding let coerce>

(declare-fun Tm_refine_754b00004f4a881ff74d076ab276dfe1 (Term Term) Term)
(declare-fun InjectiveTypeFormers.Explicit.coerce (Term Term Term) Term)

;;;;;;;;;;;;;;;;x: 'a{'a == 'b} -> 'b
(declare-fun Tm_arrow_b0d5ef0913a0bd9e084f24fb97f71f79 () Term)
(declare-fun InjectiveTypeFormers.Explicit.coerce@tok () Term)
...
; Starting query at InjectiveTypeFormers.Explicit.fst(4,47-4,49)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall ('a: Type) (x: Prims.squash 'a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). 'a ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_of_squash`
...
;; def=Prims.fst(441,36-441,97); use=InjectiveTypeFormers.Explicit.fst(4,47-4,49)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=InjectiveTypeFormers.Explicit.fst(4,30-4,32); use=InjectiveTypeFormers.Explicit.fst(4,42-4,44)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=InjectiveTypeFormers.Explicit.fst(4,47-4,49)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InjectiveTypeFormers.Explicit.fst(4,47-4,49)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InjectiveTypeFormers.Explicit.lemma_of_squash, 1)
; STATUS: unsat
...
; encoding sigelt let lemma_of_squash


; <Start encoding let lemma_of_squash>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InjectiveTypeFormers.Explicit.lemma_of_squash (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InjectiveTypeFormers.Explicit.lemma_of_squash@tok () Term)

; </end encoding let lemma_of_squash>


; encoding sigelt type InjectiveTypeFormers.Explicit.i


; <Start encoding type InjectiveTypeFormers.Explicit.i>

;;;;;;;;;;;;;;;;Constructor
(declare-fun InjectiveTypeFormers.Explicit.i (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun InjectiveTypeFormers.Explicit.i@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun InjectiveTypeFormers.Explicit.Mkinj (Term) Term)
;;;;;;;;;;;;;;;;Constructor base
(declare-fun InjectiveTypeFormers.Explicit.Mkinj@base () Term)
;;;;;;;;;;;;;;;;data constructor proxy: InjectiveTypeFormers.Explicit.Mkinj
(declare-fun InjectiveTypeFormers.Explicit.Mkinj@tok () Term)



;;;;;;;;;;;;;;;;i f
(declare-fun Tm_arrow_6e5cdce217441349ad26a67c26ae9ede () Term)

; <start constructor InjectiveTypeFormers.Explicit.i>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-InjectiveTypeFormers.Explicit.i ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
146)
(exists ((@x0 Term))
 (! (= __@x0
(InjectiveTypeFormers.Explicit.i @x0))
 
;;no pats
:qid is-InjectiveTypeFormers.Explicit.i))))

; </end constructor InjectiveTypeFormers.Explicit.i>


; <start constructor InjectiveTypeFormers.Explicit.Mkinj>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-InjectiveTypeFormers.Explicit.Mkinj ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
155)
(exists ((@x0 Term))
 (! (= __@x0
(InjectiveTypeFormers.Explicit.Mkinj @x0))
 
;;no pats
:qid is-InjectiveTypeFormers.Explicit.Mkinj))))

; </end constructor InjectiveTypeFormers.Explicit.Mkinj>


; </end encoding type InjectiveTypeFormers.Explicit.i>


; encoding sigelt assume InjectiveTypeFormers.Explicit.i__uu___haseq


; <Start encoding assume InjectiveTypeFormers.Explicit.i__uu___haseq>



; </end encoding assume InjectiveTypeFormers.Explicit.i__uu___haseq>


; encoding sigelt val InjectiveTypeFormers.Explicit.uu___is_Mkinj


; <Start encoding val InjectiveTypeFormers.Explicit.uu___is_Mkinj>


(declare-fun InjectiveTypeFormers.Explicit.uu___is_Mkinj (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: i f -> Prims.bool
(declare-fun Tm_arrow_2798757ee93044228b5cb06e92341d02 () Term)
(declare-fun InjectiveTypeFormers.Explicit.uu___is_Mkinj@tok () Term)

; </end encoding val InjectiveTypeFormers.Explicit.uu___is_Mkinj>


; encoding sigelt let uu___is_Mkinj


; <Skipped let uu___is_Mkinj/>
...
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.i; Namespace InjectiveTypeFormers.Explicit; Name InjectiveTypeFormers.Explicit.Mkinj; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(6,5-6,6); use=InjectiveTypeFormers.Explicit.fst(6,5-6,6)
(forall ((@x0 Term))
 (! (= (ApplyTT InjectiveTypeFormers.Explicit.i@tok
@x0)
(InjectiveTypeFormers.Explicit.i @x0))
 

:pattern ((ApplyTT InjectiveTypeFormers.Explicit.i@tok
@x0))

:pattern ((InjectiveTypeFormers.Explicit.i @x0))
:qid token_correspondence_InjectiveTypeFormers.Explicit.i@tok))

:named token_correspondence_InjectiveTypeFormers.Explicit.i@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.i; Namespace InjectiveTypeFormers.Explicit; Name InjectiveTypeFormers.Explicit.Mkinj; Namespace InjectiveTypeFormers.Explicit
(assert (! (is-Tm_arrow (PreType InjectiveTypeFormers.Explicit.i@tok))
:named pre_kinding_InjectiveTypeFormers.Explicit.i@tok))
...
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.i; Namespace InjectiveTypeFormers.Explicit; Name InjectiveTypeFormers.Explicit.Mkinj; Namespace InjectiveTypeFormers.Explicit
(assert (! (and (IsTotFun InjectiveTypeFormers.Explicit.i@tok)

;; def=InjectiveTypeFormers.Explicit.fst(6,5-6,6); use=InjectiveTypeFormers.Explicit.fst(6,5-6,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (InjectiveTypeFormers.Explicit.i @x0)
Tm_type))
 

:pattern ((InjectiveTypeFormers.Explicit.i @x0))
:qid kinding_InjectiveTypeFormers.Explicit.i@tok))
)
:named kinding_InjectiveTypeFormers.Explicit.i@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.i; Namespace InjectiveTypeFormers.Explicit; Name InjectiveTypeFormers.Explicit.Mkinj; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(6,5-6,6); use=InjectiveTypeFormers.Explicit.fst(6,5-6,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(InjectiveTypeFormers.Explicit.i @x2))
(is-InjectiveTypeFormers.Explicit.Mkinj @x1))
 

:pattern ((HasTypeFuel @u0
@x1
(InjectiveTypeFormers.Explicit.i @x2)))
:qid fuel_guarded_inversion_InjectiveTypeFormers.Explicit.i))

:named fuel_guarded_inversion_InjectiveTypeFormers.Explicit.i))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.i; Namespace InjectiveTypeFormers.Explicit; Name InjectiveTypeFormers.Explicit.Mkinj; Namespace InjectiveTypeFormers.Explicit
(assert (! (= 147
(Term_constr_id InjectiveTypeFormers.Explicit.i@tok))
:named fresh_token_InjectiveTypeFormers.Explicit.i@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.i; Namespace InjectiveTypeFormers.Explicit; Name InjectiveTypeFormers.Explicit.Mkinj; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(7,4-7,9); use=InjectiveTypeFormers.Explicit.fst(7,4-7,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasTypeFuel @u0
(InjectiveTypeFormers.Explicit.Mkinj @x1)
(InjectiveTypeFormers.Explicit.i @x1)))
 

:pattern ((HasTypeFuel @u0
(InjectiveTypeFormers.Explicit.Mkinj @x1)
(InjectiveTypeFormers.Explicit.i @x1)))
:qid data_typing_intro_InjectiveTypeFormers.Explicit.Mkinj@tok))

:named data_typing_intro_InjectiveTypeFormers.Explicit.Mkinj@tok))
...
(InjectiveTypeFormers.Explicit.Mkinj @x1)
(InjectiveTypeFormers.Explicit.i @x2)))
:qid data_elim_InjectiveTypeFormers.Explicit.Mkinj))

:named data_elim_InjectiveTypeFormers.Explicit.Mkinj))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.i; Namespace InjectiveTypeFormers.Explicit; Name InjectiveTypeFormers.Explicit.Mkinj; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(6,5-6,6); use=InjectiveTypeFormers.Explicit.fst(6,5-6,6)
(forall ((@x0 Term))
 (! (= 146
(Term_constr_id (InjectiveTypeFormers.Explicit.i @x0)))
 

:pattern ((InjectiveTypeFormers.Explicit.i @x0))
:qid constructor_distinct_InjectiveTypeFormers.Explicit.i))

:named constructor_distinct_InjectiveTypeFormers.Explicit.i))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.i; Namespace InjectiveTypeFormers.Explicit; Name InjectiveTypeFormers.Explicit.Mkinj; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(7,4-7,9); use=InjectiveTypeFormers.Explicit.fst(7,4-7,9)
(forall ((@x0 Term))
 (! (= 155
(Term_constr_id (InjectiveTypeFormers.Explicit.Mkinj @x0)))
 

:pattern ((InjectiveTypeFormers.Explicit.Mkinj @x0))
:qid constructor_distinct_InjectiveTypeFormers.Explicit.Mkinj))

:named constructor_distinct_InjectiveTypeFormers.Explicit.Mkinj))
;;;;;;;;;;;;;;;;Constructor base
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.i; Namespace InjectiveTypeFormers.Explicit; Name InjectiveTypeFormers.Explicit.Mkinj; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(7,4-7,9); use=InjectiveTypeFormers.Explicit.fst(7,4-7,9)
(forall ((@x0 Term))
 (! (implies (is-InjectiveTypeFormers.Explicit.Mkinj (InjectiveTypeFormers.Explicit.Mkinj @x0))
(= (InjectiveTypeFormers.Explicit.Mkinj @x0)
InjectiveTypeFormers.Explicit.Mkinj@base))
 

:pattern ((InjectiveTypeFormers.Explicit.Mkinj @x0))
:qid constructor_base_InjectiveTypeFormers.Explicit.Mkinj))

:named constructor_base_InjectiveTypeFormers.Explicit.Mkinj))
;;;;;;;;;;;;;;;;Assumption: InjectiveTypeFormers.Explicit.i__uu___haseq
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.i__uu___haseq; Namespace InjectiveTypeFormers.Explicit
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(Valid (Prims.hasEq (InjectiveTypeFormers.Explicit.i @x0))))
 

:pattern ((Prims.hasEq (InjectiveTypeFormers.Explicit.i @x0)))
:qid assumption_InjectiveTypeFormers.Explicit.i__uu___haseq))
:named assumption_InjectiveTypeFormers.Explicit.i__uu___haseq))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Prims.hasEq; Namespace Prims
(assert (! 
...
@x0
(InjectiveTypeFormers.Explicit.i @x2))
(= (Term_constr_id (InjectiveTypeFormers.Explicit.i @x2))
...
@x0
(InjectiveTypeFormers.Explicit.i @x2)))
:qid InjectiveTypeFormers.Explicit_pretyping_78756cae0bbaba9a2354ea1eec0f4d38))

:named InjectiveTypeFormers.Explicit_pretyping_78756cae0bbaba9a2354ea1eec0f4d38))
(push) ;; push{3

; Starting query at InjectiveTypeFormers.Explicit.fst(12,4-12,6)
...
; Encoding query formula : forall (x: (_: Type -> Type)) (y: (_: Type -> Type)) (w: InjectiveTypeFormers.Explicit.i x).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         (InjectiveTypeFormers.Explicit.i x == InjectiveTypeFormers.Explicit.i y ==> x == y) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let isInj`
; While typechecking the top-level declaration `[@@expect_failure] let isInj`
...
;; def=Prims.fst(441,36-441,97); use=InjectiveTypeFormers.Explicit.fst(12,4-12,6)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))
(implies 
;; def=InjectiveTypeFormers.Explicit.fst(11,11-11,21); use=InjectiveTypeFormers.Explicit.fst(12,4-12,6)
(= (InjectiveTypeFormers.Explicit.i @x0)
(InjectiveTypeFormers.Explicit.i @x1))


;; def=InjectiveTypeFormers.Explicit.fst(11,26-11,32); use=InjectiveTypeFormers.Explicit.fst(12,4-12,6)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=InjectiveTypeFormers.Explicit.fst(12,4-12,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InjectiveTypeFormers.Explicit.fst(12,4-12,6)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InjectiveTypeFormers.Explicit.isInj, 1)
