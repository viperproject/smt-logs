...
; encoding sigelt val InjectiveTypeFormers.Explicit.isInj_admit


; <Start encoding val InjectiveTypeFormers.Explicit.isInj_admit>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InjectiveTypeFormers.Explicit.isInj_admit (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InjectiveTypeFormers.Explicit.isInj_admit@tok () Term)

; </end encoding val InjectiveTypeFormers.Explicit.isInj_admit>


; encoding sigelt let pa


; <Start encoding let pa>


(declare-fun InjectiveTypeFormers.Explicit.pa (Term Term) Term)

;;;;;;;;;;;;;;;;x: Type -> a: (_: Type -> Type) -> Prims.logical
(declare-fun Tm_arrow_16517fc74a0df6bfe536ea4f010a502b () Term)
(declare-fun InjectiveTypeFormers.Explicit.pa@tok () Term)
...
(declare-fun InjectiveTypeFormers.Explicit.p (Term) Term)

(declare-fun InjectiveTypeFormers.Explicit.p@tok () Term)
...
(declare-fun InjectiveTypeFormers.Explicit.w (Dummy_sort) Term)
...
(declare-fun InjectiveTypeFormers.Explicit.uu___0 () Term)
...
(declare-fun InjectiveTypeFormers.Explicit.q () Term)
...
(declare-fun InjectiveTypeFormers.Explicit.uu___1 () Term)

; </end encoding let uu___1>


; encoding sigelt val InjectiveTypeFormers.Explicit.false_of_pq


; <Skipped val InjectiveTypeFormers.Explicit.false_of_pq/>
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InjectiveTypeFormers.Explicit.false_of_pq (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InjectiveTypeFormers.Explicit.false_of_pq@tok () Term)
...
; encoding sigelt let false_of_pq_squash


; <Start encoding let false_of_pq_squash>

(declare-fun InjectiveTypeFormers.Explicit.false_of_pq_squash (Term) Term)
;;;;;;;;;;;;;;;;pq: p q -> Prims.GTot Prims.l_False
(declare-fun Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1 () Term)
(declare-fun InjectiveTypeFormers.Explicit.false_of_pq_squash@tok () Term)

; </end encoding let false_of_pq_squash>
...
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.uu___0; Namespace InjectiveTypeFormers.Explicit
(assert (! (HasType InjectiveTypeFormers.Explicit.uu___0
(Prims.squash (FStar.Pervasives.ambient (InjectiveTypeFormers.Explicit.i InjectiveTypeFormers.Explicit.p@tok)
(InjectiveTypeFormers.Explicit.w Dummy_value))))
:named function_token_typing_InjectiveTypeFormers.Explicit.uu___0))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.uu___0; Namespace InjectiveTypeFormers.Explicit
(assert (! (HasType InjectiveTypeFormers.Explicit.uu___0
(Prims.squash (FStar.Pervasives.ambient (InjectiveTypeFormers.Explicit.i InjectiveTypeFormers.Explicit.p@tok)
(InjectiveTypeFormers.Explicit.w Dummy_value))))
:named typing_InjectiveTypeFormers.Explicit.uu___0))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.uu___1; Namespace InjectiveTypeFormers.Explicit
(assert (! (HasType InjectiveTypeFormers.Explicit.uu___1
(Prims.squash (FStar.Pervasives.ambient Tm_type
InjectiveTypeFormers.Explicit.q)))
:named function_token_typing_InjectiveTypeFormers.Explicit.uu___1))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.uu___1; Namespace InjectiveTypeFormers.Explicit
(assert (! (HasType InjectiveTypeFormers.Explicit.uu___1
(Prims.squash (FStar.Pervasives.ambient Tm_type
InjectiveTypeFormers.Explicit.q)))
:named typing_InjectiveTypeFormers.Explicit.uu___1))
;;;;;;;;;;;;;;;;unit typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.w; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(24,4-24,5); use=InjectiveTypeFormers.Explicit.fst(24,4-24,5)
(forall ((@u0 Dummy_sort))
 (! (HasType (InjectiveTypeFormers.Explicit.w @u0)
(InjectiveTypeFormers.Explicit.i InjectiveTypeFormers.Explicit.p@tok))
 

:pattern ((InjectiveTypeFormers.Explicit.w @u0))
:qid typing_InjectiveTypeFormers.Explicit.w))

:named typing_InjectiveTypeFormers.Explicit.w))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.q; Namespace InjectiveTypeFormers.Explicit
(assert (! (HasType InjectiveTypeFormers.Explicit.q
Tm_type)
:named typing_InjectiveTypeFormers.Explicit.q))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.pa; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(18,4-18,6); use=InjectiveTypeFormers.Explicit.fst(18,4-18,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_arrow_ef9cb512a25ee351fa5536d617490497))
(HasType (InjectiveTypeFormers.Explicit.pa @x0
@x1)
Prims.logical))
 

:pattern ((InjectiveTypeFormers.Explicit.pa @x0
@x1))
:qid typing_InjectiveTypeFormers.Explicit.pa))

:named typing_InjectiveTypeFormers.Explicit.pa))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.p; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(21,4-21,5); use=InjectiveTypeFormers.Explicit.fst(21,4-21,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (InjectiveTypeFormers.Explicit.p @x0)
Tm_type))
 

:pattern ((InjectiveTypeFormers.Explicit.p @x0))
:qid typing_InjectiveTypeFormers.Explicit.p))

:named typing_InjectiveTypeFormers.Explicit.p))
;;;;;;;;;;;;;;;;free var typing
...
;; def=InjectiveTypeFormers.Explicit.fst(21,4-21,5); use=InjectiveTypeFormers.Explicit.fst(21,4-21,5)
(forall ((@x0 Term))
 (! (= (ApplyTT InjectiveTypeFormers.Explicit.p@tok
@x0)
(InjectiveTypeFormers.Explicit.p @x0))
 

:pattern ((ApplyTT InjectiveTypeFormers.Explicit.p@tok
@x0))
:qid token_correspondence_InjectiveTypeFormers.Explicit.p))

:named token_correspondence_InjectiveTypeFormers.Explicit.p))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.false_of_pq_squash; Namespace InjectiveTypeFormers.Explicit
(assert (! (HasType Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1
Tm_type)
:named kinding_Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1))
...
(assert (! (HasType InjectiveTypeFormers.Explicit.q
Tm_type)
:named function_token_typing_InjectiveTypeFormers.Explicit.q))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.p; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(21,4-21,5); use=InjectiveTypeFormers.Explicit.fst(21,4-21,5)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType InjectiveTypeFormers.Explicit.p@tok
Tm_arrow_ef9cb512a25ee351fa5536d617490497))
...
(forall ((@x1 Term))
 (! (= (ApplyTT InjectiveTypeFormers.Explicit.p@tok
@x1)
(InjectiveTypeFormers.Explicit.p @x1))
 

:pattern ((InjectiveTypeFormers.Explicit.p @x1))
:qid function_token_typing_InjectiveTypeFormers.Explicit.p.1))
)
 

:pattern ((ApplyTT @x0
InjectiveTypeFormers.Explicit.p@tok))
:qid function_token_typing_InjectiveTypeFormers.Explicit.p))

:named function_token_typing_InjectiveTypeFormers.Explicit.p))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.empty; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.Explicit.w
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.w; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(24,4-24,5); use=InjectiveTypeFormers.Explicit.fst(24,4-24,5)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=InjectiveTypeFormers.Explicit.fst(24,4-24,5); use=InjectiveTypeFormers.Explicit.fst(24,4-24,5)
(InjectiveTypeFormers.Explicit.w @u0)

(InjectiveTypeFormers.Explicit.Mkinj InjectiveTypeFormers.Explicit.p@tok))
...
:qid equation_InjectiveTypeFormers.Explicit.w))

:named equation_InjectiveTypeFormers.Explicit.w))
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.Explicit.uu___1
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.uu___1; Namespace InjectiveTypeFormers.Explicit
(assert (! (= InjectiveTypeFormers.Explicit.uu___1
Tm_unit)
:named equation_InjectiveTypeFormers.Explicit.uu___1))
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.Explicit.uu___0
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.uu___0; Namespace InjectiveTypeFormers.Explicit
(assert (! (= InjectiveTypeFormers.Explicit.uu___0
Tm_unit)
:named equation_InjectiveTypeFormers.Explicit.uu___0))
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.Explicit.q
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.q; Namespace InjectiveTypeFormers.Explicit
(assert (! (= InjectiveTypeFormers.Explicit.q
(InjectiveTypeFormers.Explicit.i InjectiveTypeFormers.Explicit.p@tok))
:named equation_InjectiveTypeFormers.Explicit.q))
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.Explicit.pa
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.pa; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(18,4-18,6); use=InjectiveTypeFormers.Explicit.fst(18,4-18,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (InjectiveTypeFormers.Explicit.pa @x0
@x1))

;; def=InjectiveTypeFormers.Explicit.fst(19,2-19,20); use=InjectiveTypeFormers.Explicit.fst(19,2-19,20)
(and 
;; def=InjectiveTypeFormers.Explicit.fst(19,2-19,10); use=InjectiveTypeFormers.Explicit.fst(19,2-19,10)
(= (InjectiveTypeFormers.Explicit.i @x1)
@x0)


;; def=InjectiveTypeFormers.Explicit.fst(19,14-19,20); use=InjectiveTypeFormers.Explicit.fst(19,14-19,20)
(not 
;; def=InjectiveTypeFormers.Explicit.fst(19,15-19,20); use=InjectiveTypeFormers.Explicit.fst(19,15-19,20)
(Valid 
;; def=InjectiveTypeFormers.Explicit.fst(19,15-19,20); use=InjectiveTypeFormers.Explicit.fst(19,15-19,20)
(ApplyTT @x1
@x0)
...
:pattern ((InjectiveTypeFormers.Explicit.pa @x0
@x1))
:qid equation_InjectiveTypeFormers.Explicit.pa))

:named equation_InjectiveTypeFormers.Explicit.pa))
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.Explicit.p
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.p; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(21,4-21,5); use=InjectiveTypeFormers.Explicit.fst(21,4-21,5)
(forall ((@x0 Term))
 (! (= (Valid (InjectiveTypeFormers.Explicit.p @x0))

;; def=InjectiveTypeFormers.Explicit.fst(22,2-22,18); use=InjectiveTypeFormers.Explicit.fst(22,2-22,18)
(exists ((@x1 Term))
 (! (and (HasType @x1
Tm_arrow_ef9cb512a25ee351fa5536d617490497)

;; def=InjectiveTypeFormers.Explicit.fst(22,12-22,18); use=InjectiveTypeFormers.Explicit.fst(22,12-22,18)
(Valid 
;; def=InjectiveTypeFormers.Explicit.fst(22,12-22,18); use=InjectiveTypeFormers.Explicit.fst(22,12-22,18)
(InjectiveTypeFormers.Explicit.pa @x0
@x1)
)
)
 
;;no pats
:qid equation_InjectiveTypeFormers.Explicit.p.1))
)
 

:pattern ((InjectiveTypeFormers.Explicit.p @x0))
:qid equation_InjectiveTypeFormers.Explicit.p))

:named equation_InjectiveTypeFormers.Explicit.p))
...
;;;;;;;;;;;;;;;;Prop-typing for InjectiveTypeFormers.Explicit.pa
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.pa; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(18,4-18,6); use=InjectiveTypeFormers.Explicit.fst(18,4-18,6)
(forall ((@x0 Term) (@x1 Term))
...
(HasType @x1
Tm_arrow_ef9cb512a25ee351fa5536d617490497))
(Valid (Prims.subtype_of (InjectiveTypeFormers.Explicit.pa @x0
@x1)
Prims.unit)))
 

:pattern ((Prims.subtype_of (InjectiveTypeFormers.Explicit.pa @x0
@x1)
Prims.unit))
:qid defn_equation_InjectiveTypeFormers.Explicit.pa))

:named defn_equation_InjectiveTypeFormers.Explicit.pa))
;;;;;;;;;;;;;;;;Prop-typing for InjectiveTypeFormers.Explicit.p
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.p; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(21,4-21,5); use=InjectiveTypeFormers.Explicit.fst(21,4-21,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(Valid (Prims.subtype_of (InjectiveTypeFormers.Explicit.p @x0)
Prims.unit)))
 

:pattern ((Prims.subtype_of (InjectiveTypeFormers.Explicit.p @x0)
Prims.unit))
:qid defn_equation_InjectiveTypeFormers.Explicit.p))

:named defn_equation_InjectiveTypeFormers.Explicit.p))
...
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.false_of_pq_squash; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(41,28-41,45); use=InjectiveTypeFormers.Explicit.fst(41,28-41,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1))
:qid InjectiveTypeFormers.Explicit_pre_typing_Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1))

:named InjectiveTypeFormers.Explicit_pre_typing_Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.false_of_pq_squash; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(41,28-41,45); use=InjectiveTypeFormers.Explicit.fst(41,28-41,45)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid InjectiveTypeFormers.Explicit_interpretation_Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1))
:qid InjectiveTypeFormers.Explicit_interpretation_Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1))

:named InjectiveTypeFormers.Explicit_interpretation_Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.w; Namespace InjectiveTypeFormers.Explicit
(assert (! (Valid (ApplyTT __uu__PartialApp
InjectiveTypeFormers.Explicit.p@tok))
:named @kick_partial_app_8a94a0f5d4b867a1ab0a94d7d3e40869))
(push) ;; push{2

; Starting query at InjectiveTypeFormers.Explicit.fst(45,0-47,43)
...
;   _: InjectiveTypeFormers.Explicit.p InjectiveTypeFormers.Explicit.q -> Prims.GTot Prims.l_False ==>
;   Prims.auto_squash (_: InjectiveTypeFormers.Explicit.p InjectiveTypeFormers.Explicit.q
;         -> Prims.GTot Prims.l_False)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let not_pq`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(441,36-441,97); use=InjectiveTypeFormers.Explicit.fst(46,18-46,30)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Prims.unit)

;; def=InjectiveTypeFormers.Explicit.fst(47,6-47,23); use=InjectiveTypeFormers.Explicit.fst(46,18-46,30)
(Valid 
;; def=InjectiveTypeFormers.Explicit.fst(47,6-47,23); use=InjectiveTypeFormers.Explicit.fst(46,18-46,30)
Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1
)
...
;; def=InjectiveTypeFormers.Explicit.fst(45,15-45,20); use=InjectiveTypeFormers.Explicit.fst(46,2-47,43)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InjectiveTypeFormers.Explicit.not_pq, 1)
; STATUS: unsat
...
; encoding sigelt let not_pq


; <Start encoding let not_pq>

(declare-fun InjectiveTypeFormers.Explicit.not_pq (Dummy_sort) Term)


; </end encoding let not_pq>
...
(declare-fun InjectiveTypeFormers.Explicit.uu___2 () Term)

; </end encoding let uu___2>

;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.uu___2; Namespace InjectiveTypeFormers.Explicit
(assert (! (HasType InjectiveTypeFormers.Explicit.uu___2
(Prims.squash (FStar.Pervasives.ambient (Prims.l_not (InjectiveTypeFormers.Explicit.p InjectiveTypeFormers.Explicit.q))
(InjectiveTypeFormers.Explicit.not_pq Dummy_value))))
:named function_token_typing_InjectiveTypeFormers.Explicit.uu___2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.uu___2; Namespace InjectiveTypeFormers.Explicit
(assert (! (HasType InjectiveTypeFormers.Explicit.uu___2
(Prims.squash (FStar.Pervasives.ambient (Prims.l_not (InjectiveTypeFormers.Explicit.p InjectiveTypeFormers.Explicit.q))
(InjectiveTypeFormers.Explicit.not_pq Dummy_value))))
:named typing_InjectiveTypeFormers.Explicit.uu___2))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.not_pq; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(45,4-45,10); use=InjectiveTypeFormers.Explicit.fst(45,4-45,10)
(forall ((@u0 Dummy_sort))
 (! (HasType (InjectiveTypeFormers.Explicit.not_pq @u0)
(Prims.l_not (InjectiveTypeFormers.Explicit.p InjectiveTypeFormers.Explicit.q)))
 

:pattern ((InjectiveTypeFormers.Explicit.not_pq @u0))
:qid typing_InjectiveTypeFormers.Explicit.not_pq))

:named typing_InjectiveTypeFormers.Explicit.not_pq))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.false_of_pq_squash; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(41,4-41,22); use=InjectiveTypeFormers.Explicit.fst(41,4-41,22)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(InjectiveTypeFormers.Explicit.p InjectiveTypeFormers.Explicit.q))
(HasType (InjectiveTypeFormers.Explicit.false_of_pq_squash @x0)
Prims.l_False))
 

:pattern ((InjectiveTypeFormers.Explicit.false_of_pq_squash @x0))
:qid typing_InjectiveTypeFormers.Explicit.false_of_pq_squash))

:named typing_InjectiveTypeFormers.Explicit.false_of_pq_squash))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.coerce; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(3,4-3,10); use=InjectiveTypeFormers.Explicit.fst(3,4-3,10)
...
@x1)))
(HasType (InjectiveTypeFormers.Explicit.coerce @x0
@x1
@x2)
@x1))
 

:pattern ((InjectiveTypeFormers.Explicit.coerce @x0
@x1
@x2))
:qid typing_InjectiveTypeFormers.Explicit.coerce))

:named typing_InjectiveTypeFormers.Explicit.coerce))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Squash.return_squash; Namespace FStar.Squash
(assert (! 
;; def=FStar.Squash.fsti(40,4-40,17); use=FStar.Squash.fsti(40,4-40,17)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
@x0))
(HasType (FStar.Squash.return_squash @x0
@x1)
(Prims.squash @x0)))
 

:pattern ((FStar.Squash.return_squash @x0
@x1))
:qid typing_FStar.Squash.return_squash))

:named typing_FStar.Squash.return_squash))
;;;;;;;;;;;;;;;;name-token correspondence
...
;; def=InjectiveTypeFormers.Explicit.fst(41,4-41,22); use=InjectiveTypeFormers.Explicit.fst(41,4-41,22)
(forall ((@x0 Term))
 (! (= (ApplyTT InjectiveTypeFormers.Explicit.false_of_pq_squash@tok
@x0)
(InjectiveTypeFormers.Explicit.false_of_pq_squash @x0))
 

:pattern ((ApplyTT InjectiveTypeFormers.Explicit.false_of_pq_squash@tok
@x0))
:qid token_correspondence_InjectiveTypeFormers.Explicit.false_of_pq_squash))

:named token_correspondence_InjectiveTypeFormers.Explicit.false_of_pq_squash))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Prims.dtuple2; Namespace Prims; Name Prims.Mkdtuple2; Namespace Prims
(assert (! 
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType InjectiveTypeFormers.Explicit.false_of_pq_squash@tok
Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1))
...
(forall ((@x1 Term))
 (! (= (ApplyTT InjectiveTypeFormers.Explicit.false_of_pq_squash@tok
@x1)
(InjectiveTypeFormers.Explicit.false_of_pq_squash @x1))
 

:pattern ((InjectiveTypeFormers.Explicit.false_of_pq_squash @x1))
:qid function_token_typing_InjectiveTypeFormers.Explicit.false_of_pq_squash.1))
)
 

:pattern ((ApplyTT @x0
InjectiveTypeFormers.Explicit.false_of_pq_squash@tok))
:qid function_token_typing_InjectiveTypeFormers.Explicit.false_of_pq_squash))

:named function_token_typing_InjectiveTypeFormers.Explicit.false_of_pq_squash))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.dtuple2; Namespace Prims; Name Prims.Mkdtuple2; Namespace Prims
(assert (! 
;; def=Prims.fst(503,5-503,12); use=Prims.fst(503,5-503,12)
...
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.Explicit.uu___2
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.uu___2; Namespace InjectiveTypeFormers.Explicit
(assert (! (= InjectiveTypeFormers.Explicit.uu___2
Tm_unit)
:named equation_InjectiveTypeFormers.Explicit.uu___2))
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.Explicit.not_pq
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.not_pq; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(45,4-45,10); use=InjectiveTypeFormers.Explicit.fst(45,4-45,10)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=InjectiveTypeFormers.Explicit.fst(45,4-45,10); use=InjectiveTypeFormers.Explicit.fst(45,4-45,10)
(InjectiveTypeFormers.Explicit.not_pq @u0)

(FStar.Classical.give_witness Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1
InjectiveTypeFormers.Explicit.false_of_pq_squash@tok))
...
:qid equation_InjectiveTypeFormers.Explicit.not_pq))

:named equation_InjectiveTypeFormers.Explicit.not_pq))
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.Explicit.false_of_pq_squash
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.false_of_pq_squash; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(41,4-41,22); use=InjectiveTypeFormers.Explicit.fst(41,4-41,22)
(forall ((@x0 Term))
 (! (= (InjectiveTypeFormers.Explicit.false_of_pq_squash @x0)
(InjectiveTypeFormers.Explicit.coerce (Prims.squash Prims.empty)
Prims.l_False
(FStar.Squash.return_squash Prims.empty
(let ((@lb1 Tm_unit))
Tm_unit))))
 

:pattern ((InjectiveTypeFormers.Explicit.false_of_pq_squash @x0))
:qid equation_InjectiveTypeFormers.Explicit.false_of_pq_squash))

:named equation_InjectiveTypeFormers.Explicit.false_of_pq_squash))
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.Explicit.coerce
;;; Fact-ids: Name InjectiveTypeFormers.Explicit.coerce; Namespace InjectiveTypeFormers.Explicit
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(3,4-3,10); use=InjectiveTypeFormers.Explicit.fst(3,4-3,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (InjectiveTypeFormers.Explicit.coerce @x0
@x1
@x2)
@x2)
...
@x1
@x2))
:qid equation_InjectiveTypeFormers.Explicit.coerce))

:named equation_InjectiveTypeFormers.Explicit.coerce))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.dtuple2; Namespace Prims; Name Prims.Mkdtuple2; Namespace Prims
(assert (! 
;; def=Prims.fst(504,4-504,13); use=Prims.fst(504,4-504,13)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
InjectiveTypeFormers.Explicit.false_of_pq_squash@tok))
:named @kick_partial_app_c26465b3b88f81d052f092659598753b))
(push) ;; push{2

; Starting query at InjectiveTypeFormers.Explicit.fst(51,0-54,26)
...
;;; Fact-ids: 
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(18,24-18,44); use=InjectiveTypeFormers.Explicit.fst(54,4-54,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))
:qid InjectiveTypeFormers.Explicit_pre_typing_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))

:named InjectiveTypeFormers.Explicit_pre_typing_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))
...
:pattern ((ApplyTT @x0
@x1))
:qid InjectiveTypeFormers.Explicit_interpretation_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))
:qid InjectiveTypeFormers.Explicit_interpretation_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))

:named InjectiveTypeFormers.Explicit_interpretation_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))
(declare-fun Tm_abs_6a2cf0525c336c2163f5d513ed2be2ea () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_6a2cf0525c336c2163f5d513ed2be2ea
;;; Fact-ids: 
(assert (! (HasType Tm_abs_6a2cf0525c336c2163f5d513ed2be2ea
Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7)
:named typing_Tm_abs_6a2cf0525c336c2163f5d513ed2be2ea))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_6a2cf0525c336c2163f5d513ed2be2ea
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(509,75-509,78); use=InjectiveTypeFormers.Explicit.fst(54,4-54,25)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_6a2cf0525c336c2163f5d513ed2be2ea
@x0)
(InjectiveTypeFormers.Explicit.pa InjectiveTypeFormers.Explicit.q
@x0))
 

:pattern ((ApplyTT Tm_abs_6a2cf0525c336c2163f5d513ed2be2ea
@x0))
:qid interpretation_Tm_abs_6a2cf0525c336c2163f5d513ed2be2ea))

:named interpretation_Tm_abs_6a2cf0525c336c2163f5d513ed2be2ea))



; Encoding query formula : forall (b:
;   Prims.squash (_: InjectiveTypeFormers.Explicit.p InjectiveTypeFormers.Explicit.q
;         -> Prims.GTot Prims.l_False))
;   (pure_result: Prims.unit).
;   _: InjectiveTypeFormers.Explicit.p InjectiveTypeFormers.Explicit.q -> Prims.GTot Prims.l_False ==>
;   InjectiveTypeFormers.Explicit.pa InjectiveTypeFormers.Explicit.q InjectiveTypeFormers.Explicit.p /\
;   (forall (pure_result: Prims.unit).
;       (exists (x: (_: Type -> Type0)).
;           InjectiveTypeFormers.Explicit.pa InjectiveTypeFormers.Explicit.q x) ==>
...
(forall ((@x0 Term))
 (! (implies (HasType @x0
(Prims.squash Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1))

;; def=Prims.fst(441,36-441,97); use=InjectiveTypeFormers.Explicit.fst(53,4-53,19)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.unit)

;; def=InjectiveTypeFormers.Explicit.fst(45,15-45,20); use=InjectiveTypeFormers.Explicit.fst(53,4-53,19)
(Valid 
;; def=InjectiveTypeFormers.Explicit.fst(45,15-45,20); use=InjectiveTypeFormers.Explicit.fst(53,4-53,19)
Tm_arrow_30b62ccc4675d54c9735d26dd1a56ce1
)
...
;; def=Prims.fst(441,29-441,97); use=InjectiveTypeFormers.Explicit.fst(54,4-54,16)
(and 
;; def=FStar.Classical.fsti(355,22-355,33); use=InjectiveTypeFormers.Explicit.fst(54,4-54,16)
(or label_1
...
;; def=Prims.fst(441,36-441,97); use=InjectiveTypeFormers.Explicit.fst(54,4-54,16)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=FStar.Classical.fsti(355,44-355,64); use=InjectiveTypeFormers.Explicit.fst(54,4-54,16)
(exists ((@x3 Term))
 (! (and (HasType @x3
Tm_arrow_ef9cb512a25ee351fa5536d617490497)

;; def=FStar.Classical.fsti(355,60-355,63); use=InjectiveTypeFormers.Explicit.fst(54,4-54,16)
(Valid 
;; def=FStar.Classical.fsti(355,60-355,63); use=InjectiveTypeFormers.Explicit.fst(54,4-54,16)
(InjectiveTypeFormers.Explicit.pa InjectiveTypeFormers.Explicit.q
@x3)
...
;; def=Prims.fst(509,67-509,79); use=InjectiveTypeFormers.Explicit.fst(54,4-54,25)
(or label_2
...
Tm_abs_6a2cf0525c336c2163f5d513ed2be2ea)
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InjectiveTypeFormers.Explicit.pq, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: equation_InjectiveTypeFormers.Explicit.not_pq, equation_InjectiveTypeFormers.Explicit.p, equation_InjectiveTypeFormers.Explicit.pa, equation_InjectiveTypeFormers.Explicit.q, equation_Prims.l_not, function_token_typing_InjectiveTypeFormers.Explicit.p, l_not-interp, typing_InjectiveTypeFormers.Explicit.not_pq
