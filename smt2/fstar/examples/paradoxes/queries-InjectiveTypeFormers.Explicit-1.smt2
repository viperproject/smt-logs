...
; Starting query at InjectiveTypeFormers.Explicit.fst(34,4-38,26)
...
(declare-fun Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3
Tm_type)
:named refinement_kinding_Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(388,17-388,37); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3)
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=InjectiveTypeFormers.Explicit.fst(37,37-37,45); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(= (InjectiveTypeFormers.Explicit.i @x2)
InjectiveTypeFormers.Explicit.q)


;; def=InjectiveTypeFormers.Explicit.fst(37,49-37,55); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(not 
;; def=InjectiveTypeFormers.Explicit.fst(37,50-37,55); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(Valid 
;; def=InjectiveTypeFormers.Explicit.fst(37,50-37,55); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(ApplyTT @x2
InjectiveTypeFormers.Explicit.q)
...
;;no pats
:qid refinement_interpretation_Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3.1))
))
...
@x1
Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3))
:qid refinement_interpretation_Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3))

:named refinement_interpretation_Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3))
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_7d06ee641cb67ec2f47aa64938a26ed3))

(declare-fun Tm_refine_f8d77454f67999dfa4ab72b69f8c092c () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_f8d77454f67999dfa4ab72b69f8c092c
Tm_type)
:named refinement_kinding_Tm_refine_f8d77454f67999dfa4ab72b69f8c092c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InjectiveTypeFormers.Explicit.fst(37,11-37,57); use=InjectiveTypeFormers.Explicit.fst(37,11-37,57)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f8d77454f67999dfa4ab72b69f8c092c)
(and (HasTypeFuel @u0
@x1
Tm_arrow_ef9cb512a25ee351fa5536d617490497)

;; def=InjectiveTypeFormers.Explicit.fst(37,37-37,45); use=InjectiveTypeFormers.Explicit.fst(37,37-37,45)
(= (InjectiveTypeFormers.Explicit.i @x1)
InjectiveTypeFormers.Explicit.q)


;; def=InjectiveTypeFormers.Explicit.fst(37,49-37,55); use=InjectiveTypeFormers.Explicit.fst(37,49-37,55)
(not 
;; def=InjectiveTypeFormers.Explicit.fst(37,50-37,55); use=InjectiveTypeFormers.Explicit.fst(37,50-37,55)
(Valid 
;; def=InjectiveTypeFormers.Explicit.fst(37,50-37,55); use=InjectiveTypeFormers.Explicit.fst(37,50-37,55)
(ApplyTT @x1
InjectiveTypeFormers.Explicit.q)
...
@x1
Tm_refine_f8d77454f67999dfa4ab72b69f8c092c))
:qid refinement_interpretation_Tm_refine_f8d77454f67999dfa4ab72b69f8c092c))

:named refinement_interpretation_Tm_refine_f8d77454f67999dfa4ab72b69f8c092c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f8d77454f67999dfa4ab72b69f8c092c
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_f8d77454f67999dfa4ab72b69f8c092c))
(Valid (Prims.hasEq Tm_arrow_ef9cb512a25ee351fa5536d617490497)))
:named haseqTm_refine_f8d77454f67999dfa4ab72b69f8c092c))




;;;;;;;;;;;;;;;;x: (_: Type -> Type){i x == q /\ ~(x q)} -> Prims.GTot (Prims.squash Prims.empty)
(declare-fun Tm_arrow_c2bfacfd0519a2f94607a44657f13871 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c2bfacfd0519a2f94607a44657f13871
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_c2bfacfd0519a2f94607a44657f13871
Tm_type)
:named kinding_Tm_arrow_c2bfacfd0519a2f94607a44657f13871))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(389,11-389,42); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_c2bfacfd0519a2f94607a44657f13871)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_c2bfacfd0519a2f94607a44657f13871))
:qid InjectiveTypeFormers.Explicit_pre_typing_Tm_arrow_c2bfacfd0519a2f94607a44657f13871))

:named InjectiveTypeFormers.Explicit_pre_typing_Tm_arrow_c2bfacfd0519a2f94607a44657f13871))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c2bfacfd0519a2f94607a44657f13871
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(389,11-389,42); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid InjectiveTypeFormers.Explicit_interpretation_Tm_arrow_c2bfacfd0519a2f94607a44657f13871.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_c2bfacfd0519a2f94607a44657f13871))
:qid InjectiveTypeFormers.Explicit_interpretation_Tm_arrow_c2bfacfd0519a2f94607a44657f13871))

:named InjectiveTypeFormers.Explicit_interpretation_Tm_arrow_c2bfacfd0519a2f94607a44657f13871))

; Encoding query formula : forall (pq: InjectiveTypeFormers.Explicit.p InjectiveTypeFormers.Explicit.q).
...
;         InjectiveTypeFormers.Explicit.i x == InjectiveTypeFormers.Explicit.q /\
;         ~(x InjectiveTypeFormers.Explicit.q)) /\
;     (forall (any_result:
;         Prims.squash (exists (x: (_: Type -> Type0)).
;               InjectiveTypeFormers.Explicit.i x == InjectiveTypeFormers.Explicit.q /\
;               ~(x InjectiveTypeFormers.Explicit.q))).
;         (forall (a:
;             (_: Type -> Type0)
;               { InjectiveTypeFormers.Explicit.i a == InjectiveTypeFormers.Explicit.q /\
;                 ~(a InjectiveTypeFormers.Explicit.q) }).
;             (*  - Could not prove post-condition
; *)
;             forall (pure_result: Prims.unit).
;               (InjectiveTypeFormers.Explicit.i InjectiveTypeFormers.Explicit.p ==
;                 InjectiveTypeFormers.Explicit.i a ==>
;                 InjectiveTypeFormers.Explicit.p == a) ==>
;               Prims.auto_squash Prims.empty) /\
;         (forall (any_result:
;             (
;                   x:
;                     (_: Type -> Type0)
;                       { InjectiveTypeFormers.Explicit.i x == InjectiveTypeFormers.Explicit.q /\
;                         ~(x InjectiveTypeFormers.Explicit.q) }
;                 -> Prims.GTot (Prims.squash Prims.empty)))
;             (pure_result: Prims.unit).
;             Prims.empty ==> p pure_result))
...
;; def=Prims.fst(441,36-441,97); use=InjectiveTypeFormers.Explicit.fst(36,7-36,19)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=InjectiveTypeFormers.Explicit.fst(29,18-29,21); use=InjectiveTypeFormers.Explicit.fst(36,7-36,19)
(Valid 
;; def=InjectiveTypeFormers.Explicit.fst(29,18-29,21); use=InjectiveTypeFormers.Explicit.fst(36,7-36,19)
(InjectiveTypeFormers.Explicit.p InjectiveTypeFormers.Explicit.q)
)
...
;; def=Prims.fst(459,77-459,89); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(and 
;; def=FStar.Classical.fsti(388,17-388,37); use=InjectiveTypeFormers.Explicit.fst(36,6-36,23)
(or label_1
...
;; def=InjectiveTypeFormers.Explicit.fst(37,37-37,45); use=InjectiveTypeFormers.Explicit.fst(36,6-36,23)
(= (InjectiveTypeFormers.Explicit.i @x3)
InjectiveTypeFormers.Explicit.q)


;; def=InjectiveTypeFormers.Explicit.fst(37,49-37,55); use=InjectiveTypeFormers.Explicit.fst(36,6-36,23)
(not 
;; def=InjectiveTypeFormers.Explicit.fst(37,50-37,55); use=InjectiveTypeFormers.Explicit.fst(36,6-36,23)
(Valid 
;; def=InjectiveTypeFormers.Explicit.fst(37,50-37,55); use=InjectiveTypeFormers.Explicit.fst(36,6-36,23)
(ApplyTT @x3
InjectiveTypeFormers.Explicit.q)
...
;; def=Prims.fst(451,66-451,102); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_refine_7d06ee641cb67ec2f47aa64938a26ed3)
...
;; def=Prims.fst(459,77-459,89); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(and 
;; def=dummy(0,0-0,0); use=InjectiveTypeFormers.Explicit.fst(34,4-38,26)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Tm_refine_f8d77454f67999dfa4ab72b69f8c092c)

;; def=Prims.fst(441,36-441,97); use=InjectiveTypeFormers.Explicit.fst(38,8-38,19)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=InjectiveTypeFormers.Explicit.fst(16,10-16,33); use=InjectiveTypeFormers.Explicit.fst(38,8-38,19)
(implies 
;; def=InjectiveTypeFormers.Explicit.fst(16,11-16,21); use=InjectiveTypeFormers.Explicit.fst(38,8-38,19)
(= (InjectiveTypeFormers.Explicit.i InjectiveTypeFormers.Explicit.p@tok)
(InjectiveTypeFormers.Explicit.i @x4))


;; def=InjectiveTypeFormers.Explicit.fst(16,26-16,32); use=InjectiveTypeFormers.Explicit.fst(38,8-38,19)
(= InjectiveTypeFormers.Explicit.p@tok
@x4)
)
)

;; def=InjectiveTypeFormers.Explicit.fst(35,6-35,17); use=InjectiveTypeFormers.Explicit.fst(38,8-38,25)
(or label_2
...
;; def=Prims.fst(441,36-441,97); use=InjectiveTypeFormers.Explicit.fst(34,4-34,15)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=InjectiveTypeFormers.Explicit.fst(35,6-35,17); use=InjectiveTypeFormers.Explicit.fst(34,4-34,15)
(Valid 
;; def=InjectiveTypeFormers.Explicit.fst(35,6-35,17); use=InjectiveTypeFormers.Explicit.fst(34,4-34,15)
Prims.empty
)
...
;; def=Prims.fst(441,83-441,96); use=InjectiveTypeFormers.Explicit.fst(34,4-34,15)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InjectiveTypeFormers.Explicit.false_of_pq, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_InjectiveTypeFormers.Explicit.p, equation_InjectiveTypeFormers.Explicit.pa, equation_InjectiveTypeFormers.Explicit.q, fuel_guarded_inversion_Prims.empty, function_token_typing_InjectiveTypeFormers.Explicit.p, refinement_interpretation_Tm_refine_f8d77454f67999dfa4ab72b69f8c092c
