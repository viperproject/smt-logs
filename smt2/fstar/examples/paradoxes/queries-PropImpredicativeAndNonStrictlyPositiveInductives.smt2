...
; Internals for PropImpredicativeAndNonStrictlyPositiveInductives
...
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.prop () Term)
...
; encoding sigelt type PropImpredicativeAndNonStrictlyPositiveInductives.a


; <Start encoding type PropImpredicativeAndNonStrictlyPositiveInductives.a>

;;;;;;;;;;;;;;;;Constructor
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.a () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.IntroA (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.IntroA__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: PropImpredicativeAndNonStrictlyPositiveInductives.IntroA
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.IntroA@tok () Term)
;;;;;;;;;;;;;;;;_: a -> prop
(declare-fun Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4 () Term)
;;;;;;;;;;;;;;;;_: (_: a -> prop) -> prop
(declare-fun Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8 () Term)


;;;;;;;;;;;;;;;;_0: (_: (_: a -> prop) -> prop) -> a
(declare-fun Tm_arrow_19c73e70aea6ab8503a3d024613c845f () Term)

; <start constructor PropImpredicativeAndNonStrictlyPositiveInductives.a>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PropImpredicativeAndNonStrictlyPositiveInductives.a ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
105)
(= __@x0
PropImpredicativeAndNonStrictlyPositiveInductives.a)))

; </end constructor PropImpredicativeAndNonStrictlyPositiveInductives.a>


; <start constructor PropImpredicativeAndNonStrictlyPositiveInductives.IntroA>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PropImpredicativeAndNonStrictlyPositiveInductives.IntroA ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
115)
(= __@x0
(PropImpredicativeAndNonStrictlyPositiveInductives.IntroA (PropImpredicativeAndNonStrictlyPositiveInductives.IntroA__0 __@x0)))))

; </end constructor PropImpredicativeAndNonStrictlyPositiveInductives.IntroA>


; </end encoding type PropImpredicativeAndNonStrictlyPositiveInductives.a>


; encoding sigelt val PropImpredicativeAndNonStrictlyPositiveInductives.uu___is_IntroA


; <Start encoding val PropImpredicativeAndNonStrictlyPositiveInductives.uu___is_IntroA>

(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.uu___is_IntroA (Term) Term)
;;;;;;;;;;;;;;;;projectee: a -> Prims.bool
(declare-fun Tm_arrow_6339c597677192335022a4b4899aada8 () Term)
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.uu___is_IntroA@tok () Term)

; </end encoding val PropImpredicativeAndNonStrictlyPositiveInductives.uu___is_IntroA>


; encoding sigelt let uu___is_IntroA


; <Skipped let uu___is_IntroA/>


; encoding sigelt val PropImpredicativeAndNonStrictlyPositiveInductives.__proj__IntroA__item___0


; <Start encoding val PropImpredicativeAndNonStrictlyPositiveInductives.__proj__IntroA__item___0>

(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.__proj__IntroA__item___0 (Term) Term)


;;;;;;;;;;;;;;;;projectee: a -> _: (_: a -> prop) -> prop
(declare-fun Tm_arrow_b76c73f16214656b59ec58093c63ab00 () Term)
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.__proj__IntroA__item___0@tok () Term)



; </end encoding val PropImpredicativeAndNonStrictlyPositiveInductives.__proj__IntroA__item___0>


; encoding sigelt let __proj__IntroA__item___0


; <Skipped let __proj__IntroA__item___0/>
...
; encoding sigelt let introA_injective


; <Start encoding let introA_injective>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.introA_injective (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.introA_injective@tok () Term)

; </end encoding let introA_injective>
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.prop; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
...
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.prop; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(33,11-33,42); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(33,11-33,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(33,19-33,41); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(33,19-33,41)
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(33,35-33,41); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(33,35-33,41)
(= @x2
@x3)
)
...
; Starting query at PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,39-43,60)
...
;; def=dummy(0,0-0,0); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,39-43,60)
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(33,19-33,41); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,52-43,60)
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(33,35-33,41); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,52-43,60)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropImpredicativeAndNonStrictlyPositiveInductives.inj, 1)
; STATUS: unsat
...
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.inj (Term) Term)
;;;;;;;;;;;;;;;;_: x -> prop
(declare-fun Tm_arrow_818a3238db389d59263417efd8e0c083 (Term) Term)
;;;;;;;;;;;;;;;;_: x -> _: x -> prop
(declare-fun Tm_arrow_0e9a739b31819e150c7949c644434511 (Term) Term)
;;;;;;;;;;;;;;;;_: x -> _: x -> prop
(declare-fun Tm_arrow_e1c31413b749ba13c4d5be975e9cb623 () Term)
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok () Term)


;;;;;;;;;;;;;;;;x0: x -> y0: x -> prop
(declare-fun Tm_arrow_c60091f9ac253960ed055d285688642e (Term) Term)
(declare-fun Tm_abs_9951d8bbbf25b027bdea9053a3abd95b (Term) Term)
...
;;;;;;;;;;;;;;;;typing_Tm_abs_9951d8bbbf25b027bdea9053a3abd95b
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,52-43,60); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,52-43,60)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_9951d8bbbf25b027bdea9053a3abd95b @x0)
(Tm_arrow_c60091f9ac253960ed055d285688642e @x0))
 

:pattern ((Tm_abs_9951d8bbbf25b027bdea9053a3abd95b @x0))
:qid typing_Tm_abs_9951d8bbbf25b027bdea9053a3abd95b))

:named typing_Tm_abs_9951d8bbbf25b027bdea9053a3abd95b))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.prop; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! (HasType PropImpredicativeAndNonStrictlyPositiveInductives.prop
Tm_type)
:named typing_PropImpredicativeAndNonStrictlyPositiveInductives.prop))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,4-43,7); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,4-43,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (PropImpredicativeAndNonStrictlyPositiveInductives.inj @x0)
(Tm_arrow_0e9a739b31819e150c7949c644434511 @x0)))
 

:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.inj @x0))
:qid typing_PropImpredicativeAndNonStrictlyPositiveInductives.inj))

:named typing_PropImpredicativeAndNonStrictlyPositiveInductives.inj))
;;;;;;;;;;;;;;;;free var typing
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,4-43,7); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,4-43,7)
(forall ((@x0 Term))
 (! (= (ApplyTT PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok
@x0)
(PropImpredicativeAndNonStrictlyPositiveInductives.inj @x0))
 

:pattern ((ApplyTT PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok
@x0))
:qid token_correspondence_PropImpredicativeAndNonStrictlyPositiveInductives.inj))

:named token_correspondence_PropImpredicativeAndNonStrictlyPositiveInductives.inj))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.pure_post'; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e1c31413b749ba13c4d5be975e9cb623
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! (HasType Tm_arrow_e1c31413b749ba13c4d5be975e9cb623
Tm_type)
:named kinding_Tm_arrow_e1c31413b749ba13c4d5be975e9cb623))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c60091f9ac253960ed055d285688642e
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,20-43,35)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_c60091f9ac253960ed055d285688642e @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_c60091f9ac253960ed055d285688642e @x0)
Tm_type))
:qid kinding_Tm_arrow_c60091f9ac253960ed055d285688642e))

:named kinding_Tm_arrow_c60091f9ac253960ed055d285688642e))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_818a3238db389d59263417efd8e0c083
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,26-43,35)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_818a3238db389d59263417efd8e0c083 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_818a3238db389d59263417efd8e0c083 @x0)
Tm_type))
:qid kinding_Tm_arrow_818a3238db389d59263417efd8e0c083))

:named kinding_Tm_arrow_818a3238db389d59263417efd8e0c083))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0e9a739b31819e150c7949c644434511
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,20-43,35)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_0e9a739b31819e150c7949c644434511 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_0e9a739b31819e150c7949c644434511 @x0)
Tm_type))
:qid kinding_Tm_arrow_0e9a739b31819e150c7949c644434511))

:named kinding_Tm_arrow_0e9a739b31819e150c7949c644434511))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,52-43,60); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,52-43,60)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_9951d8bbbf25b027bdea9053a3abd95b @x2)
@x0)
@x1)
(Prims.eq2 @x2
@x0
...
:pattern ((ApplyTT (ApplyTT (Tm_abs_9951d8bbbf25b027bdea9053a3abd95b @x2)
@x0)
@x1))
:qid interpretation_Tm_abs_9951d8bbbf25b027bdea9053a3abd95b))

:named interpretation_Tm_abs_9951d8bbbf25b027bdea9053a3abd95b))
...
(assert (! (HasType PropImpredicativeAndNonStrictlyPositiveInductives.prop
Tm_type)
:named function_token_typing_PropImpredicativeAndNonStrictlyPositiveInductives.prop))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,4-43,7); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,4-43,7)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok
Tm_arrow_e1c31413b749ba13c4d5be975e9cb623))

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,4-43,7); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,4-43,7)
(forall ((@x1 Term))
 (! (= (ApplyTT PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok
@x1)
(PropImpredicativeAndNonStrictlyPositiveInductives.inj @x1))
 

:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.inj @x1))
:qid function_token_typing_PropImpredicativeAndNonStrictlyPositiveInductives.inj.1))
)
 

:pattern ((ApplyTT @x0
PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok))
:qid function_token_typing_PropImpredicativeAndNonStrictlyPositiveInductives.inj))

:named function_token_typing_PropImpredicativeAndNonStrictlyPositiveInductives.inj))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.l_True; Namespace Prims
(assert (! (HasType Prims.l_True
Prims.logical)
...
;;;;;;;;;;;;;;;;Equation for PropImpredicativeAndNonStrictlyPositiveInductives.prop
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.prop; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! (= PropImpredicativeAndNonStrictlyPositiveInductives.prop
Tm_refine_a5a4b976760c8ff6c395fec345e05f6d)
:named equation_PropImpredicativeAndNonStrictlyPositiveInductives.prop))
;;;;;;;;;;;;;;;;Equation for PropImpredicativeAndNonStrictlyPositiveInductives.inj
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,4-43,7); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,4-43,7)
(forall ((@x0 Term))
 (! (= (PropImpredicativeAndNonStrictlyPositiveInductives.inj @x0)
(Tm_abs_9951d8bbbf25b027bdea9053a3abd95b @x0))
 

:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.inj @x0))
:qid equation_PropImpredicativeAndNonStrictlyPositiveInductives.inj))

:named equation_PropImpredicativeAndNonStrictlyPositiveInductives.inj))
...
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,12-43,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_e1c31413b749ba13c4d5be975e9cb623)
...
@x1
Tm_arrow_e1c31413b749ba13c4d5be975e9cb623))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_e1c31413b749ba13c4d5be975e9cb623))

:named PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_e1c31413b749ba13c4d5be975e9cb623))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,20-43,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_c60091f9ac253960ed055d285688642e @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_c60091f9ac253960ed055d285688642e @x2)))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_c60091f9ac253960ed055d285688642e))

:named PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_c60091f9ac253960ed055d285688642e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,26-43,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_818a3238db389d59263417efd8e0c083 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_818a3238db389d59263417efd8e0c083 @x2)))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_818a3238db389d59263417efd8e0c083))

:named PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_818a3238db389d59263417efd8e0c083))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,20-43,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_0e9a739b31819e150c7949c644434511 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_0e9a739b31819e150c7949c644434511 @x2)))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_0e9a739b31819e150c7949c644434511))

:named PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_0e9a739b31819e150c7949c644434511))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e1c31413b749ba13c4d5be975e9cb623
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,12-43,35)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_0e9a739b31819e150c7949c644434511 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_e1c31413b749ba13c4d5be975e9cb623.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_e1c31413b749ba13c4d5be975e9cb623))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_e1c31413b749ba13c4d5be975e9cb623))

:named PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_e1c31413b749ba13c4d5be975e9cb623))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c60091f9ac253960ed055d285688642e
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,20-43,35)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_c60091f9ac253960ed055d285688642e @x1))
(and 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,20-43,35)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
...
@x2)
@x3)
PropImpredicativeAndNonStrictlyPositiveInductives.prop))
 

:pattern ((ApplyTT (ApplyTT @x0
@x2)
@x3))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_c60091f9ac253960ed055d285688642e.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_c60091f9ac253960ed055d285688642e.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_c60091f9ac253960ed055d285688642e @x1)))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_c60091f9ac253960ed055d285688642e))

:named PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_c60091f9ac253960ed055d285688642e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_818a3238db389d59263417efd8e0c083
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,26-43,35)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_818a3238db389d59263417efd8e0c083 @x1))
(and 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,26-43,35)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_818a3238db389d59263417efd8e0c083.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_818a3238db389d59263417efd8e0c083 @x1)))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_818a3238db389d59263417efd8e0c083))

:named PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_818a3238db389d59263417efd8e0c083))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0e9a739b31819e150c7949c644434511
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.inj; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,10-43,35); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(43,20-43,35)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_0e9a739b31819e150c7949c644434511.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_0e9a739b31819e150c7949c644434511 @x1)))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_0e9a739b31819e150c7949c644434511))

:named PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_0e9a739b31819e150c7949c644434511))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
;; def=Prims.fst(91,5-91,12); use=Prims.fst(91,5-91,12)
...
; Starting query at PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-47,21)
...
PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok))
:named @kick_partial_app_2a6eb7cbd23791ec7d215bbe425de8e5))
...
;     PropImpredicativeAndNonStrictlyPositiveInductives.inj x0 x0 /\
;     (forall (pure_result: Prims.unit).
;         PropImpredicativeAndNonStrictlyPositiveInductives.inj x0 x0 ==>
;         PropImpredicativeAndNonStrictlyPositiveInductives.inj x0' x0 /\
;         (forall (pure_result: Prims.unit).
;             PropImpredicativeAndNonStrictlyPositiveInductives.inj x0' x0 ==> p pure_result))
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(45,57-45,76); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-47,21)
(= (ApplyTT (ApplyTT PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok
@x0)
@x1)
(ApplyTT (ApplyTT PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok
@x0)
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-47,21)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(45,87-45,98); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-47,21)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-47,21)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-47,21)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,29-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-46,8)
(and 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,9-46,20); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-46,8)
(or label_3

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,9-46,20); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-46,8)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,9-46,20); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-46,8)
(ApplyTT (ApplyTT (ApplyTT PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok
@x0)
@x1)
@x1)
)
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(46,2-46,8)
(forall ((@x4 Term))
...
;; def=Prims.fst(441,29-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(47,2-47,8)
(and 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(47,9-47,21); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(47,2-47,8)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(47,2-47,8)
(forall ((@x5 Term))
...
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(47,2-47,8)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(47,2-47,8)
(ApplyTT @x3
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropImpredicativeAndNonStrictlyPositiveInductives.inj_injective, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, eq2-interp, equation_PropImpredicativeAndNonStrictlyPositiveInductives.inj, interpretation_Tm_abs_9951d8bbbf25b027bdea9053a3abd95b, token_correspondence_PropImpredicativeAndNonStrictlyPositiveInductives.inj
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.inj_injective (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.inj_injective@tok () Term)
...
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.f (Term) Term)

;;;;;;;;;;;;;;;;x: (_: a -> prop) -> a
(declare-fun Tm_arrow_1df1cc296597fc6ab636aec56aec61dc () Term)
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.f@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.f; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(49,4-49,5); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(49,4-49,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4)
(HasType (PropImpredicativeAndNonStrictlyPositiveInductives.f @x0)
PropImpredicativeAndNonStrictlyPositiveInductives.a))
 

:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.f @x0))
:qid typing_PropImpredicativeAndNonStrictlyPositiveInductives.f))

:named typing_PropImpredicativeAndNonStrictlyPositiveInductives.f))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,16-38,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,16-38,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(PropImpredicativeAndNonStrictlyPositiveInductives.IntroA @x1)
PropImpredicativeAndNonStrictlyPositiveInductives.a)
...
(PropImpredicativeAndNonStrictlyPositiveInductives.IntroA @x1)
PropImpredicativeAndNonStrictlyPositiveInductives.a))
:qid subterm_ordering_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA))

:named subterm_ordering_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,16-38,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,16-38,22)
(forall ((@x0 Term))
 (! (= (PropImpredicativeAndNonStrictlyPositiveInductives.IntroA__0 (PropImpredicativeAndNonStrictlyPositiveInductives.IntroA @x0))
@x0)
 

:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.IntroA @x0))
:qid projection_inverse_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA__0))

:named projection_inverse_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA__0))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! (HasType Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8
Tm_type)
:named kinding_Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! (HasType Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4
Tm_type)
:named kinding_Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4))
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! (HasType PropImpredicativeAndNonStrictlyPositiveInductives.a
Tm_type)
:named kinding_PropImpredicativeAndNonStrictlyPositiveInductives.a@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,10-38,11); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,10-38,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
PropImpredicativeAndNonStrictlyPositiveInductives.a)
(is-PropImpredicativeAndNonStrictlyPositiveInductives.IntroA @x1))
 

:pattern ((HasTypeFuel @u0
@x1
PropImpredicativeAndNonStrictlyPositiveInductives.a))
:qid fuel_guarded_inversion_PropImpredicativeAndNonStrictlyPositiveInductives.a))

:named fuel_guarded_inversion_PropImpredicativeAndNonStrictlyPositiveInductives.a))
;;;;;;;;;;;;;;;;Equation for PropImpredicativeAndNonStrictlyPositiveInductives.f
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.f; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(49,4-49,5); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(49,4-49,5)
(forall ((@x0 Term))
 (! (= (PropImpredicativeAndNonStrictlyPositiveInductives.f @x0)
(PropImpredicativeAndNonStrictlyPositiveInductives.IntroA (ApplyTT (ApplyTT PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok
Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4)
@x0)))
 

:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.f @x0))
:qid equation_PropImpredicativeAndNonStrictlyPositiveInductives.f))

:named equation_PropImpredicativeAndNonStrictlyPositiveInductives.f))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,16-38,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,16-38,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8)
(HasTypeFuel @u0
(PropImpredicativeAndNonStrictlyPositiveInductives.IntroA @x1)
PropImpredicativeAndNonStrictlyPositiveInductives.a))
...
(PropImpredicativeAndNonStrictlyPositiveInductives.IntroA @x1)
PropImpredicativeAndNonStrictlyPositiveInductives.a))
:qid data_typing_intro_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA@tok))

:named data_typing_intro_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,16-38,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,16-38,22)
...
(PropImpredicativeAndNonStrictlyPositiveInductives.IntroA @x1)
PropImpredicativeAndNonStrictlyPositiveInductives.a))
:qid data_elim_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA))

:named data_elim_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! (= 105
(Term_constr_id PropImpredicativeAndNonStrictlyPositiveInductives.a))
:named constructor_distinct_PropImpredicativeAndNonStrictlyPositiveInductives.a))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,16-38,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,16-38,22)
(forall ((@x0 Term))
 (! (= 115
(Term_constr_id (PropImpredicativeAndNonStrictlyPositiveInductives.IntroA @x0)))
 

:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.IntroA @x0))
:qid constructor_distinct_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA))

:named constructor_distinct_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,10-38,11); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,10-38,11)
...
@x0
PropImpredicativeAndNonStrictlyPositiveInductives.a))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_pretyping_e77166be5c531e34cf7861096bcf2a5b))

:named PropImpredicativeAndNonStrictlyPositiveInductives_pretyping_e77166be5c531e34cf7861096bcf2a5b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,27-38,45); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,27-38,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8)
...
@x1
Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8))

:named PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,27-38,36); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,27-38,36)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4)
...
@x1
Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4))

:named PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,27-38,45); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,27-38,45)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8))

:named PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_8af4c7ae6cac1b23f9dc9e376c2acac8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.a; Namespace PropImpredicativeAndNonStrictlyPositiveInductives; Name PropImpredicativeAndNonStrictlyPositiveInductives.IntroA; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,27-38,36); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(38,27-38,36)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4))

:named PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.f; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! (Valid (ApplyTT __uu__PartialApp
PropImpredicativeAndNonStrictlyPositiveInductives.inj@tok))
...
; Starting query at PropImpredicativeAndNonStrictlyPositiveInductives.fst(52,2-53,35)
...
;   (_: PropImpredicativeAndNonStrictlyPositiveInductives.a
;       -> PropImpredicativeAndNonStrictlyPositiveInductives.prop))
;   (p':
;   (_: PropImpredicativeAndNonStrictlyPositiveInductives.a
;       -> PropImpredicativeAndNonStrictlyPositiveInductives.prop)).
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     PropImpredicativeAndNonStrictlyPositiveInductives.f p ==
;     PropImpredicativeAndNonStrictlyPositiveInductives.f p' /\
;     (forall (pure_result: Prims.unit). p == p' ==> p pure_result) ==>
;     PropImpredicativeAndNonStrictlyPositiveInductives.inj p ==
;     PropImpredicativeAndNonStrictlyPositiveInductives.inj p' /\
;     (forall (pure_result: Prims.unit).
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(51,53-51,66); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(52,2-53,35)
(= (PropImpredicativeAndNonStrictlyPositiveInductives.f @x0)
(PropImpredicativeAndNonStrictlyPositiveInductives.f @x1))


;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(52,2-53,35)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(51,77-51,86); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(52,2-53,35)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(52,2-53,35)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(52,2-53,35)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(441,29-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(52,2-52,15)
(and 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(45,57-45,76); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(52,2-52,15)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(52,2-52,15)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(45,87-45,98); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(52,2-52,15)
(= @x0
@x1)
)

;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(53,2-53,18)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.unit)

;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(53,2-53,18)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(53,2-53,18)
(ApplyTT @x2
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropImpredicativeAndNonStrictlyPositiveInductives.f_injective, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_PropImpredicativeAndNonStrictlyPositiveInductives.f, projection_inverse_PropImpredicativeAndNonStrictlyPositiveInductives.IntroA__0
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.f_injective (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.f_injective@tok () Term)
...
; Starting query at PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22)

(declare-fun label_1 () Bool)



;;;;;;;;;;;;;;;;p: (_: a -> prop) -> Prims.GTot Type
(declare-fun Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd
Tm_type)
:named kinding_Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,12-58,21); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,9-58,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd))

:named PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd
;;; Fact-ids: 
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,12-58,21); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,9-58,22)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd))

:named PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd))
(declare-fun Tm_abs_b79455a5ec05fef267eeaab30a5c3345 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_b79455a5ec05fef267eeaab30a5c3345
;;; Fact-ids: 
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_b79455a5ec05fef267eeaab30a5c3345 @x0)
Tm_arrow_44c9413abbe9685d14d66a4f48cbb7bd)
 

:pattern ((Tm_abs_b79455a5ec05fef267eeaab30a5c3345 @x0))
:qid typing_Tm_abs_b79455a5ec05fef267eeaab30a5c3345))

:named typing_Tm_abs_b79455a5ec05fef267eeaab30a5c3345))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_b79455a5ec05fef267eeaab30a5c3345
;;; Fact-ids: 
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_b79455a5ec05fef267eeaab30a5c3345 @x1)
@x0)
(Prims.l_and (Prims.eq2 PropImpredicativeAndNonStrictlyPositiveInductives.a
(PropImpredicativeAndNonStrictlyPositiveInductives.f @x0)
@x1)
...
:pattern ((ApplyTT (Tm_abs_b79455a5ec05fef267eeaab30a5c3345 @x1)
@x0))
:qid interpretation_Tm_abs_b79455a5ec05fef267eeaab30a5c3345))

:named interpretation_Tm_abs_b79455a5ec05fef267eeaab30a5c3345))
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.l_Exists Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4
(Tm_abs_b79455a5ec05fef267eeaab30a5c3345 @x0)))
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(61,4-61,12); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(61,4-61,12)
(= (PropImpredicativeAndNonStrictlyPositiveInductives.f @x1)
@x0)


;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(61,16-61,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(61,16-61,22)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(61,17-61,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(61,17-61,22)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(61,17-61,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(61,17-61,22)
(ApplyTT @x1
@x0)
...
;;no pats
:qid l_quant_interp_47acc1ba6e48f85f7ef66adc112f8bce.1))
)
 

:pattern ((Valid (Prims.l_Exists Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4
(Tm_abs_b79455a5ec05fef267eeaab30a5c3345 @x0))))
:qid l_quant_interp_47acc1ba6e48f85f7ef66adc112f8bce))

:named l_quant_interp_47acc1ba6e48f85f7ef66adc112f8bce))
...
; Encoding query formula : forall (x: PropImpredicativeAndNonStrictlyPositiveInductives.a).
;   (*  - Could not prove post-condition
; *)
;   forall (x:
;     (exists (p:
;         (_: PropImpredicativeAndNonStrictlyPositiveInductives.a
;             -> PropImpredicativeAndNonStrictlyPositiveInductives.prop)).
;         PropImpredicativeAndNonStrictlyPositiveInductives.f p == x /\ ~(p x)))
;     (y:
;     (exists (p:
;         (_: PropImpredicativeAndNonStrictlyPositiveInductives.a
;             -> PropImpredicativeAndNonStrictlyPositiveInductives.prop)).
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(33,19-33,41); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
(Prims.l_Exists Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4
(Tm_abs_b79455a5ec05fef267eeaab30a5c3345 @x0)))
(HasType @x2
(Prims.l_Exists Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4
(Tm_abs_b79455a5ec05fef267eeaab30a5c3345 @x0))))

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(33,35-33,41); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropImpredicativeAndNonStrictlyPositiveInductives.p0, 1)
; STATUS: unsat
...
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.p0 (Term) Term)

(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.p0@tok () Term)
...
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.x0 (Dummy_sort) Term)

; </end encoding let x0>

;;;;;;;;;;;;;;;;typing_Tm_abs_b79455a5ec05fef267eeaab30a5c3345
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.p0; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_b79455a5ec05fef267eeaab30a5c3345 @x0)
...
:named typing_Tm_abs_b79455a5ec05fef267eeaab30a5c3345))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.x0; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(62,4-62,6); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(62,4-62,6)
(forall ((@u0 Dummy_sort))
 (! (HasType (PropImpredicativeAndNonStrictlyPositiveInductives.x0 @u0)
PropImpredicativeAndNonStrictlyPositiveInductives.a)
 

:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.x0 @u0))
:qid typing_PropImpredicativeAndNonStrictlyPositiveInductives.x0))

:named typing_PropImpredicativeAndNonStrictlyPositiveInductives.x0))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.p0; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(57,4-57,6); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(57,4-57,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
PropImpredicativeAndNonStrictlyPositiveInductives.a)
(HasType (PropImpredicativeAndNonStrictlyPositiveInductives.p0 @x0)
PropImpredicativeAndNonStrictlyPositiveInductives.prop))
 

:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.p0 @x0))
:qid typing_PropImpredicativeAndNonStrictlyPositiveInductives.p0))

:named typing_PropImpredicativeAndNonStrictlyPositiveInductives.p0))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.p0; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(57,4-57,6); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(57,4-57,6)
(forall ((@x0 Term))
 (! (= (ApplyTT PropImpredicativeAndNonStrictlyPositiveInductives.p0@tok
@x0)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 @x0))
 

:pattern ((ApplyTT PropImpredicativeAndNonStrictlyPositiveInductives.p0@tok
@x0))
:qid token_correspondence_PropImpredicativeAndNonStrictlyPositiveInductives.p0))

:named token_correspondence_PropImpredicativeAndNonStrictlyPositiveInductives.p0))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.p0; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,2-61,22)
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType PropImpredicativeAndNonStrictlyPositiveInductives.p0@tok
Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4))
...
(forall ((@x1 Term))
 (! (= (ApplyTT PropImpredicativeAndNonStrictlyPositiveInductives.p0@tok
@x1)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 @x1))
 

:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.p0 @x1))
:qid function_token_typing_PropImpredicativeAndNonStrictlyPositiveInductives.p0.1))
)
 

:pattern ((ApplyTT @x0
PropImpredicativeAndNonStrictlyPositiveInductives.p0@tok))
:qid function_token_typing_PropImpredicativeAndNonStrictlyPositiveInductives.p0))

:named function_token_typing_PropImpredicativeAndNonStrictlyPositiveInductives.p0))
;;;;;;;;;;;;;;;;Equation for PropImpredicativeAndNonStrictlyPositiveInductives.x0
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.x0; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(62,4-62,6); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(62,4-62,6)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(62,4-62,6); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(62,4-62,6)
(PropImpredicativeAndNonStrictlyPositiveInductives.x0 @u0)

(PropImpredicativeAndNonStrictlyPositiveInductives.f PropImpredicativeAndNonStrictlyPositiveInductives.p0@tok))
...
:qid equation_PropImpredicativeAndNonStrictlyPositiveInductives.x0))

:named equation_PropImpredicativeAndNonStrictlyPositiveInductives.x0))
;;;;;;;;;;;;;;;;Equation for PropImpredicativeAndNonStrictlyPositiveInductives.p0
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.p0; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(57,4-57,6); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(57,4-57,6)
(forall ((@x0 Term))
...
:pattern ((PropImpredicativeAndNonStrictlyPositiveInductives.p0 @x0))
:qid equation_PropImpredicativeAndNonStrictlyPositiveInductives.p0))

:named equation_PropImpredicativeAndNonStrictlyPositiveInductives.p0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PropImpredicativeAndNonStrictlyPositiveInductives.p0; Namespace PropImpredicativeAndNonStrictlyPositiveInductives
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,12-58,21); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(58,9-58,22)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
PropImpredicativeAndNonStrictlyPositiveInductives.p0@tok))
:named @kick_partial_app_e2cf614a2f2f3f556f8c52296e446f16))
(push) ;; push{2

; Starting query at PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
...
(declare-fun Tm_refine_104aa28b549e0db1b9235eb785e4cc79 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_104aa28b549e0db1b9235eb785e4cc79
Tm_type)
:named refinement_kinding_Tm_refine_104aa28b549e0db1b9235eb785e4cc79))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,13-67,50); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,13-67,50)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_104aa28b549e0db1b9235eb785e4cc79)
(and (HasTypeFuel @u0
@x1
Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4)

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,28-67,37); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,28-67,37)
(= (PropImpredicativeAndNonStrictlyPositiveInductives.f @x1)
(PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))


;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,41-67,48); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,41-67,48)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,42-67,48); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,42-67,48)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,42-67,48); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,42-67,48)
(ApplyTT @x1
(PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
...
@x1
Tm_refine_104aa28b549e0db1b9235eb785e4cc79))
:qid refinement_interpretation_Tm_refine_104aa28b549e0db1b9235eb785e4cc79))

:named refinement_interpretation_Tm_refine_104aa28b549e0db1b9235eb785e4cc79))
;;;;;;;;;;;;;;;;haseq for Tm_refine_104aa28b549e0db1b9235eb785e4cc79
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_104aa28b549e0db1b9235eb785e4cc79))
(Valid (Prims.hasEq Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4)))
:named haseqTm_refine_104aa28b549e0db1b9235eb785e4cc79))




(declare-fun Tm_refine_e011623890154ad37bdbafa1b1334049 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_e011623890154ad37bdbafa1b1334049
Tm_type)
:named refinement_kinding_Tm_refine_e011623890154ad37bdbafa1b1334049))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,66-67,76); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_e011623890154ad37bdbafa1b1334049)
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,66-67,76); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,68-67,75); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,68-67,75); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
)
))
...
@x1
Tm_refine_e011623890154ad37bdbafa1b1334049))
:qid refinement_interpretation_Tm_refine_e011623890154ad37bdbafa1b1334049))

:named refinement_interpretation_Tm_refine_e011623890154ad37bdbafa1b1334049))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e011623890154ad37bdbafa1b1334049
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_e011623890154ad37bdbafa1b1334049))
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_e011623890154ad37bdbafa1b1334049))
;;;;;;;;;;;;;;;;p: (_: a -> prop){f p == x0 /\ ~(p x0)} -> Prims.GTot (Prims.squash (~(p0 x0)))
(declare-fun Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0
Tm_type)
:named kinding_Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,13-67,77); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0))

:named PropImpredicativeAndNonStrictlyPositiveInductives_pre_typing_Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0
;;; Fact-ids: 
(assert (! 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,13-67,77); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0))
:qid PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0))

:named PropImpredicativeAndNonStrictlyPositiveInductives_interpretation_Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0))

; Encoding query formula : forall (_: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     PropImpredicativeAndNonStrictlyPositiveInductives.p0 PropImpredicativeAndNonStrictlyPositiveInductives.x0
;      /\
;     (forall (pure_result: Prims.unit).
;         ~(PropImpredicativeAndNonStrictlyPositiveInductives.p0 PropImpredicativeAndNonStrictlyPositiveInductives.x0
;           ) ==>
...
;             -> PropImpredicativeAndNonStrictlyPositiveInductives.prop)
;           { PropImpredicativeAndNonStrictlyPositiveInductives.f p ==
;             PropImpredicativeAndNonStrictlyPositiveInductives.x0 /\
;             ~(p PropImpredicativeAndNonStrictlyPositiveInductives.x0) }).
;         (*  - Could not prove post-condition
; *)
;         PropImpredicativeAndNonStrictlyPositiveInductives.f p ==
;         PropImpredicativeAndNonStrictlyPositiveInductives.f PropImpredicativeAndNonStrictlyPositiveInductives.p0
;          /\
;         (forall (pure_result: Prims.unit).
;             p == PropImpredicativeAndNonStrictlyPositiveInductives.p0 ==>
;             ~(PropImpredicativeAndNonStrictlyPositiveInductives.p0 PropImpredicativeAndNonStrictlyPositiveInductives.x0
;               ))) /\
;     (forall (any_result:
;         (
...
;                     ~(p PropImpredicativeAndNonStrictlyPositiveInductives.x0) }
;             -> Prims.GTot
;               (Prims.squash (~(PropImpredicativeAndNonStrictlyPositiveInductives.p0 PropImpredicativeAndNonStrictlyPositiveInductives.x0
;                       ))))).
;         PropImpredicativeAndNonStrictlyPositiveInductives.p0 PropImpredicativeAndNonStrictlyPositiveInductives.x0
;          /\
;         (forall (pure_result:
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,30-66,37); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,30-66,37); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,48-66,58); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(or label_2

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,48-66,58); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,50-66,57); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,50-66,57); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(and 
;; def=dummy(0,0-0,0); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Tm_refine_104aa28b549e0db1b9235eb785e4cc79)

;; def=Prims.fst(441,29-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(68,4-68,15)
(and 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(51,53-51,66); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(68,4-68,15)
(or label_3

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(51,53-51,66); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(68,4-68,15)
(= (PropImpredicativeAndNonStrictlyPositiveInductives.f @x2)
(PropImpredicativeAndNonStrictlyPositiveInductives.f PropImpredicativeAndNonStrictlyPositiveInductives.p0@tok))
)


;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(68,4-68,15)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(51,77-51,86); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(68,4-68,15)
(= @x2
PropImpredicativeAndNonStrictlyPositiveInductives.p0@tok)
)

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,66-67,76); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(68,4-68,20)
(or label_4

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,66-67,76); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(68,4-68,20)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,68-67,75); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(68,4-68,20)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(67,68-67,75); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(68,4-68,20)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=Prims.fst(451,66-451,102); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,61-70,64)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Tm_arrow_679c9c737f8ec3fd0e765340dd750aa0)

;; def=Prims.fst(441,29-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,39-70,48)
(and 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,49-70,56); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,39-70,48)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,39-70,48)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Prims.squash (PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))))
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,2-70,13)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,14-70,24); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,2-70,13)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,16-70,23); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,2-70,13)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,16-70,23); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,2-70,13)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,2-70,13)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(70,2-70,13)
(ApplyTT @x1
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropImpredicativeAndNonStrictlyPositiveInductives.bad1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_PropImpredicativeAndNonStrictlyPositiveInductives.x0, function_token_typing_PropImpredicativeAndNonStrictlyPositiveInductives.p0, refinement_interpretation_Tm_refine_104aa28b549e0db1b9235eb785e4cc79
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.bad1 (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.bad1@tok () Term)

; </end encoding let bad1>

(push) ;; push{2

; Starting query at PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-76,28)
...
;             (_: PropImpredicativeAndNonStrictlyPositiveInductives.a
;                 -> PropImpredicativeAndNonStrictlyPositiveInductives.prop)).
;             PropImpredicativeAndNonStrictlyPositiveInductives.f x ==
;             PropImpredicativeAndNonStrictlyPositiveInductives.x0 /\
;             ~(x PropImpredicativeAndNonStrictlyPositiveInductives.x0)) ==>
;         p pure_result)
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(72,30-72,40); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-76,28)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(72,32-72,39); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-76,28)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(72,32-72,39); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-76,28)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-76,28)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(72,51-72,58); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-76,28)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-76,28)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-76,28)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(441,29-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-76,28)
(and 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(76,4-76,13); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-73,14)
(or label_3
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(76,17-76,24); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-73,14)
(or label_4

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(76,17-76,24); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-73,14)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(76,18-76,24); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-73,14)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(76,18-76,24); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-73,14)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=FStar.Classical.fsti(355,44-355,64); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-73,14)
(exists ((@x3 Term))
 (! (and (HasType @x3
Tm_arrow_2c6c8f413f0a38c21ca320f9b59043e4)

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(76,4-76,13); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(73,2-73,14)
(= (PropImpredicativeAndNonStrictlyPositiveInductives.f @x3)
(PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropImpredicativeAndNonStrictlyPositiveInductives.bad2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_PropImpredicativeAndNonStrictlyPositiveInductives.p0, equation_PropImpredicativeAndNonStrictlyPositiveInductives.x0, function_token_typing_PropImpredicativeAndNonStrictlyPositiveInductives.p0, l_quant_interp_47acc1ba6e48f85f7ef66adc112f8bce
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.bad2 (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.bad2@tok () Term)

; </end encoding let bad2>

(push) ;; push{2

; Starting query at PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,19-78,40); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
(or label_2

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,19-78,40); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
(iff 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,20-78,25); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,20-78,25); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,31-78,39); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,32-78,39); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,32-78,39); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-80,23)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-79,15)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=FStar.Classical.fsti(83,12-83,25); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-79,15)
(implies 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,30-66,37); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-79,15)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,30-66,37); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-79,15)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,48-66,58); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-79,15)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,50-66,57); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-79,15)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(66,50-66,57); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(79,2-79,15)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(80,2-80,15)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=FStar.Classical.fsti(83,12-83,25); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(80,2-80,15)
(implies 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(72,30-72,40); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(80,2-80,15)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(72,32-72,39); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(80,2-80,15)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(72,32-72,39); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(80,2-80,15)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(72,51-72,58); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(80,2-80,15)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(72,51-72,58); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(80,2-80,15)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(80,2-80,15)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(80,2-80,15)
(ApplyTT @x1
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropImpredicativeAndNonStrictlyPositiveInductives.bad, 1)
; STATUS: unsat
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.bad (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PropImpredicativeAndNonStrictlyPositiveInductives.bad@tok () Term)

; </end encoding let bad>

(push) ;; push{2

; Starting query at PropImpredicativeAndNonStrictlyPositiveInductives.fst(82,29-82,35)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let worse`
...
;; def=Prims.fst(441,36-441,97); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(82,29-82,35)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,19-78,40); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(82,29-82,32)
(iff 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,20-78,25); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(82,29-82,32)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,20-78,25); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(82,29-82,32)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,31-78,39); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(82,29-82,32)
(not 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,32-78,39); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(82,29-82,32)
(Valid 
;; def=PropImpredicativeAndNonStrictlyPositiveInductives.fst(78,32-78,39); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(82,29-82,32)
(PropImpredicativeAndNonStrictlyPositiveInductives.p0 (PropImpredicativeAndNonStrictlyPositiveInductives.x0 Dummy_value))
)
...
;; def=Prims.fst(441,83-441,96); use=PropImpredicativeAndNonStrictlyPositiveInductives.fst(82,29-82,35)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PropImpredicativeAndNonStrictlyPositiveInductives.worse, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
