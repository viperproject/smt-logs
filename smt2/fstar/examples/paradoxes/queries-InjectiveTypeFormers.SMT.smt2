...
; Internals for InjectiveTypeFormers.SMT


; encoding sigelt type InjectiveTypeFormers.SMT.i


; <Start encoding type InjectiveTypeFormers.SMT.i>

;;;;;;;;;;;;;;;;Constructor
(declare-fun InjectiveTypeFormers.SMT.i (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun InjectiveTypeFormers.SMT.i@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun InjectiveTypeFormers.SMT.Mkinj (Term) Term)
;;;;;;;;;;;;;;;;Constructor base
(declare-fun InjectiveTypeFormers.SMT.Mkinj@base () Term)
;;;;;;;;;;;;;;;;data constructor proxy: InjectiveTypeFormers.SMT.Mkinj
(declare-fun InjectiveTypeFormers.SMT.Mkinj@tok () Term)



;;;;;;;;;;;;;;;;i f
(declare-fun Tm_arrow_9dda59c5bd734f83a18237bf222dcf3a () Term)

; <start constructor InjectiveTypeFormers.SMT.i>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-InjectiveTypeFormers.SMT.i ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
140)
(exists ((@x0 Term))
 (! (= __@x0
(InjectiveTypeFormers.SMT.i @x0))
 
;;no pats
:qid is-InjectiveTypeFormers.SMT.i))))

; </end constructor InjectiveTypeFormers.SMT.i>


; <start constructor InjectiveTypeFormers.SMT.Mkinj>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-InjectiveTypeFormers.SMT.Mkinj ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
149)
(exists ((@x0 Term))
 (! (= __@x0
(InjectiveTypeFormers.SMT.Mkinj @x0))
 
;;no pats
:qid is-InjectiveTypeFormers.SMT.Mkinj))))

; </end constructor InjectiveTypeFormers.SMT.Mkinj>


; </end encoding type InjectiveTypeFormers.SMT.i>


; encoding sigelt assume InjectiveTypeFormers.SMT.i__uu___haseq


; <Start encoding assume InjectiveTypeFormers.SMT.i__uu___haseq>



; </end encoding assume InjectiveTypeFormers.SMT.i__uu___haseq>


; encoding sigelt val InjectiveTypeFormers.SMT.uu___is_Mkinj


; <Start encoding val InjectiveTypeFormers.SMT.uu___is_Mkinj>


(declare-fun InjectiveTypeFormers.SMT.uu___is_Mkinj (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: i f -> Prims.bool
(declare-fun Tm_arrow_3caecff896b60c3a425c1a8573f8ea28 () Term)
(declare-fun InjectiveTypeFormers.SMT.uu___is_Mkinj@tok () Term)

; </end encoding val InjectiveTypeFormers.SMT.uu___is_Mkinj>
...
;;; Fact-ids: Name InjectiveTypeFormers.SMT.i; Namespace InjectiveTypeFormers.SMT; Name InjectiveTypeFormers.SMT.Mkinj; Namespace InjectiveTypeFormers.SMT
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(2,5-2,6); use=InjectiveTypeFormers.SMT.fst(2,5-2,6)
(forall ((@x0 Term))
 (! (= (ApplyTT InjectiveTypeFormers.SMT.i@tok
@x0)
(InjectiveTypeFormers.SMT.i @x0))
 

:pattern ((ApplyTT InjectiveTypeFormers.SMT.i@tok
@x0))

:pattern ((InjectiveTypeFormers.SMT.i @x0))
:qid token_correspondence_InjectiveTypeFormers.SMT.i@tok))

:named token_correspondence_InjectiveTypeFormers.SMT.i@tok))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name InjectiveTypeFormers.SMT.i; Namespace InjectiveTypeFormers.SMT; Name InjectiveTypeFormers.SMT.Mkinj; Namespace InjectiveTypeFormers.SMT
(assert (! (is-Tm_arrow (PreType InjectiveTypeFormers.SMT.i@tok))
:named pre_kinding_InjectiveTypeFormers.SMT.i@tok))
...
;;; Fact-ids: Name InjectiveTypeFormers.SMT.i; Namespace InjectiveTypeFormers.SMT; Name InjectiveTypeFormers.SMT.Mkinj; Namespace InjectiveTypeFormers.SMT
(assert (! (and (IsTotFun InjectiveTypeFormers.SMT.i@tok)

;; def=InjectiveTypeFormers.SMT.fst(2,5-2,6); use=InjectiveTypeFormers.SMT.fst(2,5-2,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasType (InjectiveTypeFormers.SMT.i @x0)
Tm_type))
 

:pattern ((InjectiveTypeFormers.SMT.i @x0))
:qid kinding_InjectiveTypeFormers.SMT.i@tok))
)
:named kinding_InjectiveTypeFormers.SMT.i@tok))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(InjectiveTypeFormers.SMT.i @x2))
(is-InjectiveTypeFormers.SMT.Mkinj @x1))
 

:pattern ((HasTypeFuel @u0
@x1
(InjectiveTypeFormers.SMT.i @x2)))
:qid fuel_guarded_inversion_InjectiveTypeFormers.SMT.i))

:named fuel_guarded_inversion_InjectiveTypeFormers.SMT.i))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name InjectiveTypeFormers.SMT.i; Namespace InjectiveTypeFormers.SMT; Name InjectiveTypeFormers.SMT.Mkinj; Namespace InjectiveTypeFormers.SMT
(assert (! (= 141
(Term_constr_id InjectiveTypeFormers.SMT.i@tok))
:named fresh_token_InjectiveTypeFormers.SMT.i@tok))
...
;;; Fact-ids: Name InjectiveTypeFormers.SMT.i; Namespace InjectiveTypeFormers.SMT; Name InjectiveTypeFormers.SMT.Mkinj; Namespace InjectiveTypeFormers.SMT
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(3,4-3,9); use=InjectiveTypeFormers.SMT.fst(3,4-3,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(HasTypeFuel @u0
(InjectiveTypeFormers.SMT.Mkinj @x1)
(InjectiveTypeFormers.SMT.i @x1)))
 

:pattern ((HasTypeFuel @u0
(InjectiveTypeFormers.SMT.Mkinj @x1)
(InjectiveTypeFormers.SMT.i @x1)))
:qid data_typing_intro_InjectiveTypeFormers.SMT.Mkinj@tok))

:named data_typing_intro_InjectiveTypeFormers.SMT.Mkinj@tok))
...
(InjectiveTypeFormers.SMT.Mkinj @x1)
(InjectiveTypeFormers.SMT.i @x2)))
:qid data_elim_InjectiveTypeFormers.SMT.Mkinj))

:named data_elim_InjectiveTypeFormers.SMT.Mkinj))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 140
(Term_constr_id (InjectiveTypeFormers.SMT.i @x0)))
 

:pattern ((InjectiveTypeFormers.SMT.i @x0))
:qid constructor_distinct_InjectiveTypeFormers.SMT.i))

:named constructor_distinct_InjectiveTypeFormers.SMT.i))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name InjectiveTypeFormers.SMT.i; Namespace InjectiveTypeFormers.SMT; Name InjectiveTypeFormers.SMT.Mkinj; Namespace InjectiveTypeFormers.SMT
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(3,4-3,9); use=InjectiveTypeFormers.SMT.fst(3,4-3,9)
(forall ((@x0 Term))
 (! (= 149
(Term_constr_id (InjectiveTypeFormers.SMT.Mkinj @x0)))
 

:pattern ((InjectiveTypeFormers.SMT.Mkinj @x0))
:qid constructor_distinct_InjectiveTypeFormers.SMT.Mkinj))

:named constructor_distinct_InjectiveTypeFormers.SMT.Mkinj))
;;;;;;;;;;;;;;;;Constructor base
;;; Fact-ids: Name InjectiveTypeFormers.SMT.i; Namespace InjectiveTypeFormers.SMT; Name InjectiveTypeFormers.SMT.Mkinj; Namespace InjectiveTypeFormers.SMT
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(3,4-3,9); use=InjectiveTypeFormers.SMT.fst(3,4-3,9)
(forall ((@x0 Term))
 (! (implies (is-InjectiveTypeFormers.SMT.Mkinj (InjectiveTypeFormers.SMT.Mkinj @x0))
(= (InjectiveTypeFormers.SMT.Mkinj @x0)
InjectiveTypeFormers.SMT.Mkinj@base))
 

:pattern ((InjectiveTypeFormers.SMT.Mkinj @x0))
:qid constructor_base_InjectiveTypeFormers.SMT.Mkinj))

:named constructor_base_InjectiveTypeFormers.SMT.Mkinj))
;;;;;;;;;;;;;;;;Assumption: InjectiveTypeFormers.SMT.i__uu___haseq
;;; Fact-ids: Name InjectiveTypeFormers.SMT.i__uu___haseq; Namespace InjectiveTypeFormers.SMT
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
(Valid (Prims.hasEq (InjectiveTypeFormers.SMT.i @x0))))
 

:pattern ((Prims.hasEq (InjectiveTypeFormers.SMT.i @x0)))
:qid assumption_InjectiveTypeFormers.SMT.i__uu___haseq))
:named assumption_InjectiveTypeFormers.SMT.i__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
(InjectiveTypeFormers.SMT.i @x2))
(= (Term_constr_id (InjectiveTypeFormers.SMT.i @x2))
...
@x0
(InjectiveTypeFormers.SMT.i @x2)))
:qid InjectiveTypeFormers.SMT_pretyping_638e86b723a109792369bfb0a2a391cf))

:named InjectiveTypeFormers.SMT_pretyping_638e86b723a109792369bfb0a2a391cf))
(push) ;; push{3

; Starting query at InjectiveTypeFormers.SMT.fst(8,4-8,6)
...
; Encoding query formula : forall (x: (_: Type -> Type)) (y: (_: Type -> Type)) (w: InjectiveTypeFormers.SMT.i x).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         (InjectiveTypeFormers.SMT.i x == InjectiveTypeFormers.SMT.i y ==> x == y) ==> p pure_result) ==>
...
;; def=Prims.fst(441,36-441,97); use=InjectiveTypeFormers.SMT.fst(8,4-8,6)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))
(implies 
;; def=InjectiveTypeFormers.SMT.fst(7,11-7,21); use=InjectiveTypeFormers.SMT.fst(8,4-8,6)
(= (InjectiveTypeFormers.SMT.i @x0)
(InjectiveTypeFormers.SMT.i @x1))


;; def=InjectiveTypeFormers.SMT.fst(7,26-7,32); use=InjectiveTypeFormers.SMT.fst(8,4-8,6)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=InjectiveTypeFormers.SMT.fst(8,4-8,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InjectiveTypeFormers.SMT.fst(8,4-8,6)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InjectiveTypeFormers.SMT.isInj, 1)
...
; encoding sigelt val InjectiveTypeFormers.SMT.isInj_admit


; <Start encoding val InjectiveTypeFormers.SMT.isInj_admit>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InjectiveTypeFormers.SMT.isInj_admit (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InjectiveTypeFormers.SMT.isInj_admit@tok () Term)



; </end encoding val InjectiveTypeFormers.SMT.isInj_admit>


; encoding sigelt let p


; <Start encoding let p>

(declare-fun InjectiveTypeFormers.SMT.p (Term) Term)

(declare-fun InjectiveTypeFormers.SMT.p@tok () Term)


; </end encoding let p>


; encoding sigelt let w


; <Start encoding let w>

(declare-fun InjectiveTypeFormers.SMT.w (Dummy_sort) Term)
...
; encoding sigelt let q


; <Start encoding let q>

(declare-fun InjectiveTypeFormers.SMT.q () Term)


; </end encoding let q>


; encoding sigelt val InjectiveTypeFormers.SMT.false_of_pq


; <Skipped val InjectiveTypeFormers.SMT.false_of_pq/>
...
:named typing_Prims.eqtype))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.SMT.q; Namespace InjectiveTypeFormers.SMT
(assert (! (HasType InjectiveTypeFormers.SMT.q
Tm_type)
:named typing_InjectiveTypeFormers.SMT.q))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InjectiveTypeFormers.SMT.p; Namespace InjectiveTypeFormers.SMT
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(16,4-16,5); use=InjectiveTypeFormers.SMT.fst(16,4-16,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (InjectiveTypeFormers.SMT.p @x0)
Tm_type))
 

:pattern ((InjectiveTypeFormers.SMT.p @x0))
:qid typing_InjectiveTypeFormers.SMT.p))

:named typing_InjectiveTypeFormers.SMT.p))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
(assert (! (Valid Prims.l_True)
:named true_interp))
...
;; def=InjectiveTypeFormers.SMT.fst(16,4-16,5); use=InjectiveTypeFormers.SMT.fst(16,4-16,5)
(forall ((@x0 Term))
 (! (= (ApplyTT InjectiveTypeFormers.SMT.p@tok
@x0)
(InjectiveTypeFormers.SMT.p @x0))
 

:pattern ((ApplyTT InjectiveTypeFormers.SMT.p@tok
@x0))
:qid token_correspondence_InjectiveTypeFormers.SMT.p))

:named token_correspondence_InjectiveTypeFormers.SMT.p))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name InjectiveTypeFormers.SMT.i; Namespace InjectiveTypeFormers.SMT; Name InjectiveTypeFormers.SMT.Mkinj; Namespace InjectiveTypeFormers.SMT
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(2,5-2,6); use=InjectiveTypeFormers.SMT.fst(2,5-2,6)
...
(assert (! (is-Tm_arrow (PreType InjectiveTypeFormers.SMT.i@tok))
:named pre_kinding_InjectiveTypeFormers.SMT.i@tok))
;;;;;;;;;;;;;;;;Lemma: InjectiveTypeFormers.SMT.isInj_admit
;;; Fact-ids: Name InjectiveTypeFormers.SMT.isInj_admit; Namespace InjectiveTypeFormers.SMT
...
;; def=InjectiveTypeFormers.SMT.fst(12,11-12,21); use=InjectiveTypeFormers.SMT.fst(12,11-12,21)
(= (InjectiveTypeFormers.SMT.i @x0)
(InjectiveTypeFormers.SMT.i @x1))
)

;; def=InjectiveTypeFormers.SMT.fst(12,26-12,32); use=InjectiveTypeFormers.SMT.fst(12,26-12,32)
(= @x0
@x1)
)
 

:pattern ((InjectiveTypeFormers.SMT.i @x0) (InjectiveTypeFormers.SMT.i @x1))
:qid lemma_InjectiveTypeFormers.SMT.isInj_admit))
:named lemma_InjectiveTypeFormers.SMT.isInj_admit))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ef9cb512a25ee351fa5536d617490497
;;; Fact-ids: Name Prims.hasEq; Namespace Prims
(assert (! (HasType Tm_arrow_ef9cb512a25ee351fa5536d617490497
Tm_type)
...
(assert (! (HasType InjectiveTypeFormers.SMT.q
Tm_type)
:named function_token_typing_InjectiveTypeFormers.SMT.q))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name InjectiveTypeFormers.SMT.p; Namespace InjectiveTypeFormers.SMT
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(16,4-16,5); use=InjectiveTypeFormers.SMT.fst(16,4-16,5)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType InjectiveTypeFormers.SMT.p@tok
Tm_arrow_ef9cb512a25ee351fa5536d617490497))
...
(forall ((@x1 Term))
 (! (= (ApplyTT InjectiveTypeFormers.SMT.p@tok
@x1)
(InjectiveTypeFormers.SMT.p @x1))
 

:pattern ((InjectiveTypeFormers.SMT.p @x1))
:qid function_token_typing_InjectiveTypeFormers.SMT.p.1))
)
 

:pattern ((ApplyTT @x0
InjectiveTypeFormers.SMT.p@tok))
:qid function_token_typing_InjectiveTypeFormers.SMT.p))

:named function_token_typing_InjectiveTypeFormers.SMT.p))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
;; def=Prims.fst(91,5-91,12); use=Prims.fst(91,5-91,12)
...
Tm_refine_414d0a9f578ab0048252f8c8f552b99f)
:named equation_Prims.eqtype))
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.SMT.q
;;; Fact-ids: Name InjectiveTypeFormers.SMT.q; Namespace InjectiveTypeFormers.SMT
(assert (! (= InjectiveTypeFormers.SMT.q
(InjectiveTypeFormers.SMT.i InjectiveTypeFormers.SMT.p@tok))
:named equation_InjectiveTypeFormers.SMT.q))
;;;;;;;;;;;;;;;;Equation for InjectiveTypeFormers.SMT.p
;;; Fact-ids: Name InjectiveTypeFormers.SMT.p; Namespace InjectiveTypeFormers.SMT
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(16,4-16,5); use=InjectiveTypeFormers.SMT.fst(16,4-16,5)
(forall ((@x0 Term))
 (! (= (Valid (InjectiveTypeFormers.SMT.p @x0))

;; def=InjectiveTypeFormers.SMT.fst(17,2-17,30); use=InjectiveTypeFormers.SMT.fst(17,2-17,30)
(exists ((@x1 Term))
 (! (and (HasType @x1
Tm_arrow_ef9cb512a25ee351fa5536d617490497)

;; def=InjectiveTypeFormers.SMT.fst(17,12-17,20); use=InjectiveTypeFormers.SMT.fst(17,12-17,20)
(= (InjectiveTypeFormers.SMT.i @x1)
@x0)


;; def=InjectiveTypeFormers.SMT.fst(17,24-17,30); use=InjectiveTypeFormers.SMT.fst(17,24-17,30)
(not 
;; def=InjectiveTypeFormers.SMT.fst(17,25-17,30); use=InjectiveTypeFormers.SMT.fst(17,25-17,30)
(Valid 
;; def=InjectiveTypeFormers.SMT.fst(17,25-17,30); use=InjectiveTypeFormers.SMT.fst(17,25-17,30)
(ApplyTT @x1
@x0)
...
;;no pats
:qid equation_InjectiveTypeFormers.SMT.p.1))
)
 

:pattern ((InjectiveTypeFormers.SMT.p @x0))
:qid equation_InjectiveTypeFormers.SMT.p))

:named equation_InjectiveTypeFormers.SMT.p))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
:named defn_equation_Prims.subtype_of))
;;;;;;;;;;;;;;;;Prop-typing for InjectiveTypeFormers.SMT.p
;;; Fact-ids: Name InjectiveTypeFormers.SMT.p; Namespace InjectiveTypeFormers.SMT
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(16,4-16,5); use=InjectiveTypeFormers.SMT.fst(16,4-16,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(Valid (Prims.subtype_of (InjectiveTypeFormers.SMT.p @x0)
Prims.unit)))
 

:pattern ((Prims.subtype_of (InjectiveTypeFormers.SMT.p @x0)
Prims.unit))
:qid defn_equation_InjectiveTypeFormers.SMT.p))

:named defn_equation_InjectiveTypeFormers.SMT.p))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
;; def=Prims.fst(91,17-91,18); use=Prims.fst(91,17-91,18)
...
:named InjectiveTypeFormers.SMT_pretyping_638e86b723a109792369bfb0a2a391cf))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name InjectiveTypeFormers.SMT.w; Namespace InjectiveTypeFormers.SMT
(assert (! (Valid (ApplyTT __uu__PartialApp
InjectiveTypeFormers.SMT.p@tok))
:named @kick_partial_app_7449ab4faebd82b17fd79250c6507e3f))
(push) ;; push{2

; Starting query at InjectiveTypeFormers.SMT.fst(24,21-24,23)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (pq: InjectiveTypeFormers.SMT.p InjectiveTypeFormers.SMT.q).
;   (*  - Could not prove post-condition
; *)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let false_of_pq`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (HasType @x0
(InjectiveTypeFormers.SMT.p InjectiveTypeFormers.SMT.q))
...
;; def=Prims.fst(451,90-451,102); use=InjectiveTypeFormers.SMT.fst(24,21-24,23)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InjectiveTypeFormers.SMT.false_of_pq, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_InjectiveTypeFormers.SMT.p, equation_InjectiveTypeFormers.SMT.q, function_token_typing_InjectiveTypeFormers.SMT.p, lemma_InjectiveTypeFormers.SMT.isInj_admit
...
; encoding sigelt let false_of_pq


; <Start encoding let false_of_pq>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InjectiveTypeFormers.SMT.false_of_pq (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InjectiveTypeFormers.SMT.false_of_pq@tok () Term)

; </end encoding let false_of_pq>
...
; Starting query at InjectiveTypeFormers.SMT.fst(26,0-26,52)
...
;;;;;;;;;;;;;;;;x: (_: Type -> Type0) -> Prims.GTot Type0
(declare-fun Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7
Tm_type)
:named kinding_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(2,12-2,32); use=InjectiveTypeFormers.SMT.fst(26,15-26,52)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))
:qid InjectiveTypeFormers.SMT_pre_typing_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))

:named InjectiveTypeFormers.SMT_pre_typing_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7
;;; Fact-ids: 
(assert (! 
;; def=InjectiveTypeFormers.SMT.fst(2,12-2,32); use=InjectiveTypeFormers.SMT.fst(26,15-26,52)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid InjectiveTypeFormers.SMT_interpretation_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))
:qid InjectiveTypeFormers.SMT_interpretation_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))

:named InjectiveTypeFormers.SMT_interpretation_Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7))
(declare-fun Tm_abs_c9c56b19c6e7ff6c5dca06a04317fb3c () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_c9c56b19c6e7ff6c5dca06a04317fb3c
;;; Fact-ids: 
(assert (! (HasType Tm_abs_c9c56b19c6e7ff6c5dca06a04317fb3c
Tm_arrow_b4c837608f7b4c31cd084de0445fe5a7)
:named typing_Tm_abs_c9c56b19c6e7ff6c5dca06a04317fb3c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c9c56b19c6e7ff6c5dca06a04317fb3c
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(509,75-509,78); use=InjectiveTypeFormers.SMT.fst(26,15-26,52)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_c9c56b19c6e7ff6c5dca06a04317fb3c
@x0)
(Prims.l_and (Prims.eq2 Tm_type
(InjectiveTypeFormers.SMT.i @x0)
InjectiveTypeFormers.SMT.q)
(Prims.l_not (ApplyTT @x0
InjectiveTypeFormers.SMT.q))))
 

:pattern ((ApplyTT Tm_abs_c9c56b19c6e7ff6c5dca06a04317fb3c
@x0))
:qid interpretation_Tm_abs_c9c56b19c6e7ff6c5dca06a04317fb3c))

:named interpretation_Tm_abs_c9c56b19c6e7ff6c5dca06a04317fb3c))


; Encoding query formula : (exists (a: (_: Type -> Type0)).
;     InjectiveTypeFormers.SMT.i a == InjectiveTypeFormers.SMT.q /\ ~(a InjectiveTypeFormers.SMT.q)) /\
; (forall (pure_result: Prims.unit).
;     (exists (a: (_: Type -> Type0)).
;         InjectiveTypeFormers.SMT.i a == InjectiveTypeFormers.SMT.q /\
;         ~(a InjectiveTypeFormers.SMT.q)) ==>
;     Prims.auto_squash (x: (_: Type -> Type0) &
;         (InjectiveTypeFormers.SMT.i x == InjectiveTypeFormers.SMT.q) /\
;         ~(x InjectiveTypeFormers.SMT.q)))


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let pq`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(441,29-441,97); use=InjectiveTypeFormers.SMT.fst(26,15-26,21)
(and 
;; def=InjectiveTypeFormers.SMT.fst(26,22-26,52); use=InjectiveTypeFormers.SMT.fst(26,15-26,21)
(or label_1
...
;; def=InjectiveTypeFormers.SMT.fst(26,33-26,41); use=InjectiveTypeFormers.SMT.fst(26,15-26,21)
(= (InjectiveTypeFormers.SMT.i @x0)
InjectiveTypeFormers.SMT.q)


;; def=InjectiveTypeFormers.SMT.fst(26,45-26,51); use=InjectiveTypeFormers.SMT.fst(26,15-26,21)
(not 
;; def=InjectiveTypeFormers.SMT.fst(26,46-26,51); use=InjectiveTypeFormers.SMT.fst(26,15-26,21)
(Valid 
;; def=InjectiveTypeFormers.SMT.fst(26,46-26,51); use=InjectiveTypeFormers.SMT.fst(26,15-26,21)
(ApplyTT @x0
InjectiveTypeFormers.SMT.q)
...
;; def=Prims.fst(441,36-441,97); use=InjectiveTypeFormers.SMT.fst(26,15-26,21)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Prims.unit)
...
;; def=Prims.fst(509,67-509,79); use=InjectiveTypeFormers.SMT.fst(26,15-26,52)
(or label_2

;; def=Prims.fst(509,67-509,79); use=InjectiveTypeFormers.SMT.fst(26,15-26,52)
(Valid 
;; def=Prims.fst(509,67-509,79); use=InjectiveTypeFormers.SMT.fst(26,15-26,52)
(Prims.dtuple2 Tm_arrow_ef9cb512a25ee351fa5536d617490497
Tm_abs_c9c56b19c6e7ff6c5dca06a04317fb3c)
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InjectiveTypeFormers.SMT.pq, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_InjectiveTypeFormers.SMT.p, equation_InjectiveTypeFormers.SMT.q, function_token_typing_InjectiveTypeFormers.SMT.p, lemma_InjectiveTypeFormers.SMT.isInj_admit, token_correspondence_InjectiveTypeFormers.SMT.p
