...
; encoding sigelt type PositiveRelaxed.nat


; <Start encoding type PositiveRelaxed.nat>

;;;;;;;;;;;;;;;;Constructor
(declare-fun PositiveRelaxed.nat () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PositiveRelaxed.O () Term)
;;;;;;;;;;;;;;;;data constructor proxy: PositiveRelaxed.O
(declare-fun PositiveRelaxed.O@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PositiveRelaxed.S (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PositiveRelaxed.S_pre (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: PositiveRelaxed.S
(declare-fun PositiveRelaxed.S@tok () Term)
;;;;;;;;;;;;;;;;pre: nat -> nat
(declare-fun Tm_arrow_5c050ff4fa7607d7e4077fa86dbd40e4 () Term)

; <start constructor PositiveRelaxed.nat>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PositiveRelaxed.nat ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
PositiveRelaxed.nat)))

; </end constructor PositiveRelaxed.nat>


; <start constructor PositiveRelaxed.O>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PositiveRelaxed.O ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
PositiveRelaxed.O)))

; </end constructor PositiveRelaxed.O>


; <start constructor PositiveRelaxed.S>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PositiveRelaxed.S ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
(PositiveRelaxed.S (PositiveRelaxed.S_pre __@x0)))))

; </end constructor PositiveRelaxed.S>


; </end encoding type PositiveRelaxed.nat>
...
;;; Fact-ids: Name PositiveRelaxed.nat; Namespace PositiveRelaxed; Name PositiveRelaxed.O; Namespace PositiveRelaxed; Name PositiveRelaxed.S; Namespace PositiveRelaxed
(assert (! (HasType PositiveRelaxed.O@tok
PositiveRelaxed.nat)
:named typing_tok_PositiveRelaxed.O@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name PositiveRelaxed.nat; Namespace PositiveRelaxed; Name PositiveRelaxed.O; Namespace PositiveRelaxed; Name PositiveRelaxed.S; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(20,4-20,5); use=PositiveRelaxed.fst(20,4-20,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(PositiveRelaxed.S @x1)
PositiveRelaxed.nat)
...
(PositiveRelaxed.S @x1)
PositiveRelaxed.nat))
:qid subterm_ordering_PositiveRelaxed.S))

:named subterm_ordering_PositiveRelaxed.S))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=PositiveRelaxed.fst(20,4-20,5); use=PositiveRelaxed.fst(20,4-20,5)
(forall ((@x0 Term))
 (! (= (PositiveRelaxed.S_pre (PositiveRelaxed.S @x0))
@x0)
 

:pattern ((PositiveRelaxed.S @x0))
:qid projection_inverse_PositiveRelaxed.S_pre))

:named projection_inverse_PositiveRelaxed.S_pre))
;;; Fact-ids: Name PositiveRelaxed.nat; Namespace PositiveRelaxed; Name PositiveRelaxed.O; Namespace PositiveRelaxed; Name PositiveRelaxed.S; Namespace PositiveRelaxed
(assert (! (HasType PositiveRelaxed.nat
Tm_type)
:named kinding_PositiveRelaxed.nat@tok))
...
;;; Fact-ids: Name PositiveRelaxed.nat; Namespace PositiveRelaxed; Name PositiveRelaxed.O; Namespace PositiveRelaxed; Name PositiveRelaxed.S; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(18,5-18,8); use=PositiveRelaxed.fst(18,5-18,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
PositiveRelaxed.nat)
(or (is-PositiveRelaxed.O @x1)
(is-PositiveRelaxed.S @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
PositiveRelaxed.nat))
:qid fuel_guarded_inversion_PositiveRelaxed.nat))

:named fuel_guarded_inversion_PositiveRelaxed.nat))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name PositiveRelaxed.nat; Namespace PositiveRelaxed; Name PositiveRelaxed.O; Namespace PositiveRelaxed; Name PositiveRelaxed.S; Namespace PositiveRelaxed
(assert (! (= PositiveRelaxed.O@tok
PositiveRelaxed.O)
:named equality_tok_PositiveRelaxed.O@tok))
...
(PositiveRelaxed.S @x1)
PositiveRelaxed.nat))
:qid data_typing_intro_PositiveRelaxed.S@tok))

:named data_typing_intro_PositiveRelaxed.S@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name PositiveRelaxed.nat; Namespace PositiveRelaxed; Name PositiveRelaxed.O; Namespace PositiveRelaxed; Name PositiveRelaxed.S; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(19,4-19,5); use=PositiveRelaxed.fst(19,4-19,5)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
PositiveRelaxed.O
PositiveRelaxed.nat)
...
PositiveRelaxed.O
PositiveRelaxed.nat))
:qid data_typing_intro_PositiveRelaxed.O@tok))

:named data_typing_intro_PositiveRelaxed.O@tok))
...
(PositiveRelaxed.S @x1)
PositiveRelaxed.nat))
:qid data_elim_PositiveRelaxed.S))

:named data_elim_PositiveRelaxed.S))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name PositiveRelaxed.nat; Namespace PositiveRelaxed; Name PositiveRelaxed.O; Namespace PositiveRelaxed; Name PositiveRelaxed.S; Namespace PositiveRelaxed
(assert (! (= 116
(Term_constr_id PositiveRelaxed.nat))
:named constructor_distinct_PositiveRelaxed.nat))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PositiveRelaxed.nat; Namespace PositiveRelaxed; Name PositiveRelaxed.O; Namespace PositiveRelaxed; Name PositiveRelaxed.S; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(20,4-20,5); use=PositiveRelaxed.fst(20,4-20,5)
(forall ((@x0 Term))
 (! (= 124
(Term_constr_id (PositiveRelaxed.S @x0)))
 

:pattern ((PositiveRelaxed.S @x0))
:qid constructor_distinct_PositiveRelaxed.S))

:named constructor_distinct_PositiveRelaxed.S))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PositiveRelaxed.nat; Namespace PositiveRelaxed; Name PositiveRelaxed.O; Namespace PositiveRelaxed; Name PositiveRelaxed.S; Namespace PositiveRelaxed
(assert (! (= 122
(Term_constr_id PositiveRelaxed.O))
:named constructor_distinct_PositiveRelaxed.O))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
PositiveRelaxed.nat))
:qid PositiveRelaxed_pretyping_17dcf40042e0dce669cb0cc9cd939cb9))

:named PositiveRelaxed_pretyping_17dcf40042e0dce669cb0cc9cd939cb9))
(push) ;; push{4

; Starting query at PositiveRelaxed.fst(18,0-20,22)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq PositiveRelaxed.nat ==>
; (forall (pre: PositiveRelaxed.nat).
...
; *)
;     Prims.hasEq PositiveRelaxed.nat)


; Context: While encoding a query
; While typechecking the top-level declaration `type PositiveRelaxed.nat`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=PositiveRelaxed.fst(18,0-20,22); use=PositiveRelaxed.fst(18,0-20,22)
(Valid 
;; def=PositiveRelaxed.fst(18,0-20,22); use=PositiveRelaxed.fst(18,0-20,22)
(Prims.hasEq PositiveRelaxed.nat)
)
...
;; def=PositiveRelaxed.fst(18,0-20,22); use=PositiveRelaxed.fst(20,12-20,15)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PositiveRelaxed.nat, 1)
; STATUS: unsat
...
; encoding sigelt assume PositiveRelaxed.nat__uu___haseq


; <Start encoding assume PositiveRelaxed.nat__uu___haseq>


; </end encoding assume PositiveRelaxed.nat__uu___haseq>


; encoding sigelt val PositiveRelaxed.uu___is_O


; <Start encoding val PositiveRelaxed.uu___is_O>

(declare-fun PositiveRelaxed.uu___is_O (Term) Term)
;;;;;;;;;;;;;;;;projectee: nat -> Prims.bool
(declare-fun Tm_arrow_86c85fe6e988686c8dc009e778950f5b () Term)
(declare-fun PositiveRelaxed.uu___is_O@tok () Term)

; </end encoding val PositiveRelaxed.uu___is_O>
...
; encoding sigelt val PositiveRelaxed.uu___is_S


; <Start encoding val PositiveRelaxed.uu___is_S>

(declare-fun PositiveRelaxed.uu___is_S (Term) Term)

(declare-fun PositiveRelaxed.uu___is_S@tok () Term)

; </end encoding val PositiveRelaxed.uu___is_S>
...
; encoding sigelt val PositiveRelaxed.__proj__S__item__pre


; <Start encoding val PositiveRelaxed.__proj__S__item__pre>

(declare-fun Tm_refine_629234387675c267a369c7d87670b9af () Term)
(declare-fun PositiveRelaxed.__proj__S__item__pre (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: nat{S? _} -> nat
(declare-fun Tm_arrow_469ba39650a56797e16d062f41d679e6 () Term)
(declare-fun PositiveRelaxed.__proj__S__item__pre@tok () Term)

; </end encoding val PositiveRelaxed.__proj__S__item__pre>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PositiveRelaxed.uu___is_S; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(20,4-20,5); use=PositiveRelaxed.fst(20,4-20,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
PositiveRelaxed.nat)
(HasType (PositiveRelaxed.uu___is_S @x0)
Prims.bool))
 

:pattern ((PositiveRelaxed.uu___is_S @x0))
:qid typing_PositiveRelaxed.uu___is_S))

:named typing_PositiveRelaxed.uu___is_S))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name PositiveRelaxed.nat; Namespace PositiveRelaxed; Name PositiveRelaxed.O; Namespace PositiveRelaxed; Name PositiveRelaxed.S; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(20,4-20,5); use=PositiveRelaxed.fst(20,4-20,5)
...
:named refinement_kinding_Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name PositiveRelaxed.__proj__S__item__pre; Namespace PositiveRelaxed
(assert (! (HasType Tm_refine_629234387675c267a369c7d87670b9af
Tm_type)
:named refinement_kinding_Tm_refine_629234387675c267a369c7d87670b9af))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! (HasType Tm_refine_414d0a9f578ab0048252f8c8f552b99f
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_629234387675c267a369c7d87670b9af)
(and (HasTypeFuel @u0
@x1
PositiveRelaxed.nat)

;; def=PositiveRelaxed.fst(20,4-20,5); use=PositiveRelaxed.fst(20,4-20,5)
(BoxBool_proj_0 (PositiveRelaxed.uu___is_S @x1))
))
...
@x1
Tm_refine_629234387675c267a369c7d87670b9af))
:qid refinement_interpretation_Tm_refine_629234387675c267a369c7d87670b9af))

:named refinement_interpretation_Tm_refine_629234387675c267a369c7d87670b9af))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
;; def=Prims.fst(73,14-73,31); use=Prims.fst(73,14-73,31)
...
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_629234387675c267a369c7d87670b9af
;;; Fact-ids: Name PositiveRelaxed.__proj__S__item__pre; Namespace PositiveRelaxed
(assert (! (iff (Valid (Prims.hasEq Tm_refine_629234387675c267a369c7d87670b9af))
(Valid (Prims.hasEq PositiveRelaxed.nat)))
:named haseqTm_refine_629234387675c267a369c7d87670b9af))
;;;;;;;;;;;;;;;;haseq for Tm_refine_414d0a9f578ab0048252f8c8f552b99f
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_414d0a9f578ab0048252f8c8f552b99f))
(Valid (Prims.hasEq Tm_type)))
...
;; def=PositiveRelaxed.fst(20,4-20,5); use=PositiveRelaxed.fst(20,4-20,5)
(forall ((@x0 Term))
 (! (= (PositiveRelaxed.uu___is_S @x0)
(BoxBool (is-PositiveRelaxed.S @x0)))
 

:pattern ((PositiveRelaxed.uu___is_S @x0))
:qid disc_equation_PositiveRelaxed.S))

:named disc_equation_PositiveRelaxed.S))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: PositiveRelaxed.nat__uu___haseq
;;; Fact-ids: Name PositiveRelaxed.nat__uu___haseq; Namespace PositiveRelaxed
(assert (! (Valid (Prims.hasEq PositiveRelaxed.nat))
:named assumption_PositiveRelaxed.nat__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Starting query at PositiveRelaxed.fst(20,8-20,11)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (projectee: _: PositiveRelaxed.nat{S? _}).
;   (*  - Could not prove post-condition
; *) ~(S? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__S__item__pre`
...
;; def=PositiveRelaxed.fst(20,4-20,5); use=PositiveRelaxed.fst(20,8-20,11)
(not 
;; def=PositiveRelaxed.fst(20,4-20,5); use=PositiveRelaxed.fst(20,8-20,11)
(BoxBool_proj_0 (PositiveRelaxed.uu___is_S @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PositiveRelaxed.__proj__S__item__pre, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_629234387675c267a369c7d87670b9af
...
; encoding sigelt let __proj__S__item__pre


; <Skipped let __proj__S__item__pre/>
...
; encoding sigelt type PositiveRelaxed.p


; <Start encoding type PositiveRelaxed.p>

;;;;;;;;;;;;;;;;Constructor
(declare-fun PositiveRelaxed.p (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun PositiveRelaxed.p@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PositiveRelaxed.PSO (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PositiveRelaxed.PSO_f (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: PositiveRelaxed.PSO
(declare-fun PositiveRelaxed.PSO@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PositiveRelaxed.POd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PositiveRelaxed.POd_h (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: PositiveRelaxed.POd
(declare-fun PositiveRelaxed.POd@tok () Term)
;;;;;;;;;;;;;;;;_: p O -> p (S O)
(declare-fun Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d () Term)

;;;;;;;;;;;;;;;;f: (_: p O -> p (S O)) -> p (S O)
(declare-fun Tm_arrow_81275c0708031e75629582b44581f189 () Term)
;;;;;;;;;;;;;;;;h: p (S O) -> p O
(declare-fun Tm_arrow_ef74408c3c152625d28f12e4a67a04d0 () Term)

; <start constructor PositiveRelaxed.p>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PositiveRelaxed.p ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
149)
(exists ((@x0 Term))
 (! (= __@x0
(PositiveRelaxed.p @x0))
 
;;no pats
:qid is-PositiveRelaxed.p))))

; </end constructor PositiveRelaxed.p>


; <start constructor PositiveRelaxed.PSO>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PositiveRelaxed.PSO ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
158)
(= __@x0
(PositiveRelaxed.PSO (PositiveRelaxed.PSO_f __@x0)))))

; </end constructor PositiveRelaxed.PSO>


; <start constructor PositiveRelaxed.POd>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PositiveRelaxed.POd ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
166)
(= __@x0
(PositiveRelaxed.POd (PositiveRelaxed.POd_h __@x0)))))

; </end constructor PositiveRelaxed.POd>


; </end encoding type PositiveRelaxed.p>


; encoding sigelt val PositiveRelaxed.uu___is_PSO


; <Start encoding val PositiveRelaxed.uu___is_PSO>

(declare-fun PositiveRelaxed.uu___is_PSO (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: p _ -> Prims.bool
(declare-fun Tm_arrow_02bb3bff946d3a0c52d878cd5724eb2e () Term)
(declare-fun PositiveRelaxed.uu___is_PSO@tok () Term)

; </end encoding val PositiveRelaxed.uu___is_PSO>


; encoding sigelt let uu___is_PSO


; <Skipped let uu___is_PSO/>


; encoding sigelt val PositiveRelaxed.__proj__PSO__item__f


; <Start encoding val PositiveRelaxed.__proj__PSO__item__f>

(declare-fun Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd (Term) Term)
(declare-fun PositiveRelaxed.__proj__PSO__item__f (Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: p _ {PSO? _} -> _: p O -> p (S O)
(declare-fun Tm_arrow_a20d15f416332ed625403453b42d3637 () Term)
(declare-fun PositiveRelaxed.__proj__PSO__item__f@tok () Term)


; </end encoding val PositiveRelaxed.__proj__PSO__item__f>

;;;;;;;;;;;;;;;;well-founded ordering on codomain
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(forall ((@x3 Term))
 (! (implies (and (HasTypeFuel @u0
(PositiveRelaxed.PSO @x1)
(PositiveRelaxed.p (PositiveRelaxed.S PositiveRelaxed.O@tok)))
(HasType @x3
(PositiveRelaxed.p PositiveRelaxed.O@tok)))
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
(ApplyTT @x1
@x3)
...
@x3)
(PositiveRelaxed.PSO @x1))))
:qid well_founded_ordering_on_codomain_PositiveRelaxed.PSO.1))

 

:pattern ((HasTypeFuel (SFuel @u0)
(PositiveRelaxed.PSO @x1)
(PositiveRelaxed.p @x2)))
:qid well_founded_ordering_on_codomain_PositiveRelaxed.PSO))

:named well_founded_ordering_on_codomain_PositiveRelaxed.PSO))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PositiveRelaxed.uu___is_PSO; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(PositiveRelaxed.p @x0)))
(HasType (PositiveRelaxed.uu___is_PSO @x0
@x1)
Prims.bool))
 

:pattern ((PositiveRelaxed.uu___is_PSO @x0
@x1))
:qid typing_PositiveRelaxed.uu___is_PSO))

:named typing_PositiveRelaxed.uu___is_PSO))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(26,5-26,6); use=PositiveRelaxed.fst(26,5-26,6)
(forall ((@x0 Term))
 (! (= (ApplyTT PositiveRelaxed.p@tok
@x0)
(PositiveRelaxed.p @x0))
 

:pattern ((ApplyTT PositiveRelaxed.p@tok
@x0))

:pattern ((PositiveRelaxed.p @x0))
:qid token_correspondence_PositiveRelaxed.p@tok))

:named token_correspondence_PositiveRelaxed.p@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
...
(PositiveRelaxed.PSO @x1)
(PositiveRelaxed.p @x2)))
:qid subterm_ordering_PositiveRelaxed.PSO))

:named subterm_ordering_PositiveRelaxed.PSO))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(PositiveRelaxed.POd @x1)
(PositiveRelaxed.p @x2))
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x1
...
(PositiveRelaxed.POd @x1)
(PositiveRelaxed.p @x2)))
:qid subterm_ordering_PositiveRelaxed.POd))

:named subterm_ordering_PositiveRelaxed.POd))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name PositiveRelaxed.__proj__PSO__item__f; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd))

:named refinement_kinding_Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name PositiveRelaxed.__proj__PSO__item__f; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd @x2))
(and (HasTypeFuel @u0
@x1
(PositiveRelaxed.p @x2))

;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(BoxBool_proj_0 (PositiveRelaxed.uu___is_PSO @x2
@x1))
))
...
@x1
(Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd @x2)))
:qid refinement_interpretation_Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd))

:named refinement_interpretation_Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(forall ((@x0 Term))
 (! (= (PositiveRelaxed.PSO_f (PositiveRelaxed.PSO @x0))
@x0)
 

:pattern ((PositiveRelaxed.PSO @x0))
:qid projection_inverse_PositiveRelaxed.PSO_f))

:named projection_inverse_PositiveRelaxed.PSO_f))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
(forall ((@x0 Term))
 (! (= (PositiveRelaxed.POd_h (PositiveRelaxed.POd @x0))
@x0)
 

:pattern ((PositiveRelaxed.POd @x0))
:qid projection_inverse_PositiveRelaxed.POd_h))

:named projection_inverse_PositiveRelaxed.POd_h))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! (is-Tm_arrow (PreType PositiveRelaxed.p@tok))
:named pre_kinding_PositiveRelaxed.p@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! (HasType Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d
Tm_type)
:named kinding_Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d))
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! (and (IsTotFun PositiveRelaxed.p@tok)

;; def=PositiveRelaxed.fst(26,5-26,6); use=PositiveRelaxed.fst(26,5-26,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
PositiveRelaxed.nat)
(HasType (PositiveRelaxed.p @x0)
Tm_type))
 

:pattern ((PositiveRelaxed.p @x0))
:qid kinding_PositiveRelaxed.p@tok))
)
:named kinding_PositiveRelaxed.p@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd
;;; Fact-ids: Name PositiveRelaxed.__proj__PSO__item__f; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd @x0)))
(Valid (Prims.hasEq (PositiveRelaxed.p @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd @x0))))
:qid haseqTm_refine_b3056343c7f1c6b9a52e7e02a8379fbd))

:named haseqTm_refine_b3056343c7f1c6b9a52e7e02a8379fbd))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(26,5-26,6); use=PositiveRelaxed.fst(26,5-26,6)
...
@x1
(PositiveRelaxed.p @x2))
(or (and (is-PositiveRelaxed.PSO @x1)
(= @x2
(PositiveRelaxed.S PositiveRelaxed.O@tok)))
(and (is-PositiveRelaxed.POd @x1)
(= @x2
PositiveRelaxed.O@tok))))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
(PositiveRelaxed.p @x2)))
:qid fuel_guarded_inversion_PositiveRelaxed.p))

:named fuel_guarded_inversion_PositiveRelaxed.p))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! (= 150
(Term_constr_id PositiveRelaxed.p@tok))
:named fresh_token_PositiveRelaxed.p@tok))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name PositiveRelaxed.uu___is_PSO; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (PositiveRelaxed.uu___is_PSO @x0
@x1)
(BoxBool (is-PositiveRelaxed.PSO @x1)))
 

:pattern ((PositiveRelaxed.uu___is_PSO @x0
@x1))
:qid disc_equation_PositiveRelaxed.PSO))

:named disc_equation_PositiveRelaxed.PSO))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (and (HasTypeFuel @u0
@x1
Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d)
(= (PositiveRelaxed.S PositiveRelaxed.O@tok)
@x2))
(HasTypeFuel @u0
(PositiveRelaxed.PSO @x1)
...
(PositiveRelaxed.PSO @x1)
(PositiveRelaxed.p @x2)))
:qid data_typing_intro_PositiveRelaxed.PSO@tok))

:named data_typing_intro_PositiveRelaxed.PSO@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
...
(PositiveRelaxed.POd @x1)
(PositiveRelaxed.p @x2)))
:qid data_typing_intro_PositiveRelaxed.POd@tok))

:named data_typing_intro_PositiveRelaxed.POd@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
...
(PositiveRelaxed.PSO @x1)
(PositiveRelaxed.p @x2))
(and (= (PositiveRelaxed.S PositiveRelaxed.O@tok)
@x2)
(HasTypeFuel @u0
@x1
Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d)))
...
(PositiveRelaxed.PSO @x1)
(PositiveRelaxed.p @x2)))
:qid data_elim_PositiveRelaxed.PSO))

:named data_elim_PositiveRelaxed.PSO))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
...
(PositiveRelaxed.POd @x1)
(PositiveRelaxed.p @x2)))
:qid data_elim_PositiveRelaxed.POd))

:named data_elim_PositiveRelaxed.POd))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(26,5-26,6); use=PositiveRelaxed.fst(26,5-26,6)
(forall ((@x0 Term))
 (! (= 149
(Term_constr_id (PositiveRelaxed.p @x0)))
 

:pattern ((PositiveRelaxed.p @x0))
:qid constructor_distinct_PositiveRelaxed.p))

:named constructor_distinct_PositiveRelaxed.p))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,4-27,7)
(forall ((@x0 Term))
 (! (= 158
(Term_constr_id (PositiveRelaxed.PSO @x0)))
 

:pattern ((PositiveRelaxed.PSO @x0))
:qid constructor_distinct_PositiveRelaxed.PSO))

:named constructor_distinct_PositiveRelaxed.PSO))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
(forall ((@x0 Term))
 (! (= 166
(Term_constr_id (PositiveRelaxed.POd @x0)))
 

:pattern ((PositiveRelaxed.POd @x0))
:qid constructor_distinct_PositiveRelaxed.POd))

:named constructor_distinct_PositiveRelaxed.POd))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(26,5-26,6); use=PositiveRelaxed.fst(26,5-26,6)
...
@x0
(PositiveRelaxed.p @x2)))
:qid PositiveRelaxed_pretyping_22fd08e7b59675e15e0fc8ecbaa1ee1d))

:named PositiveRelaxed_pretyping_22fd08e7b59675e15e0fc8ecbaa1ee1d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,13-27,33); use=PositiveRelaxed.fst(27,13-27,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d)
...
@x1
Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d))
:qid PositiveRelaxed_pre_typing_Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d))

:named PositiveRelaxed_pre_typing_Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d
;;; Fact-ids: Name PositiveRelaxed.p; Namespace PositiveRelaxed; Name PositiveRelaxed.PSO; Namespace PositiveRelaxed; Name PositiveRelaxed.POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(27,13-27,33); use=PositiveRelaxed.fst(27,13-27,33)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid PositiveRelaxed_interpretation_Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d))
:qid PositiveRelaxed_interpretation_Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d))

:named PositiveRelaxed_interpretation_Tm_arrow_343ba3cfc2224233fff104fe3d5c3b3d))
(push) ;; push{2

; Starting query at PositiveRelaxed.fst(27,10-27,11)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: PositiveRelaxed.nat) (projectee: _: PositiveRelaxed.p _ {PSO? _}).
;   (*  - Could not prove post-condition
; *) ~(PSO? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__PSO__item__f`
...
PositiveRelaxed.nat)
(HasType @x1
(Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd @x0))

;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,10-27,11)
(not 
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(27,10-27,11)
(BoxBool_proj_0 (PositiveRelaxed.uu___is_PSO @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PositiveRelaxed.__proj__PSO__item__f, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_b3056343c7f1c6b9a52e7e02a8379fbd
...
; encoding sigelt let __proj__PSO__item__f


; <Skipped let __proj__PSO__item__f/>


; encoding sigelt val PositiveRelaxed.uu___is_POd


; <Start encoding val PositiveRelaxed.uu___is_POd>

(declare-fun PositiveRelaxed.uu___is_POd (Term Term) Term)

(declare-fun PositiveRelaxed.uu___is_POd@tok () Term)

; </end encoding val PositiveRelaxed.uu___is_POd>


; encoding sigelt let uu___is_POd


; <Skipped let uu___is_POd/>


; encoding sigelt val PositiveRelaxed.__proj__POd__item__h


; <Start encoding val PositiveRelaxed.__proj__POd__item__h>

(declare-fun Tm_refine_10093c564537c9c0559bbc0a0a24fba4 (Term) Term)
(declare-fun PositiveRelaxed.__proj__POd__item__h (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: p _ {POd? _} -> p (S O)
(declare-fun Tm_arrow_bc9430519a48cc61a308ba9d2a3ba1d3 () Term)
(declare-fun PositiveRelaxed.__proj__POd__item__h@tok () Term)

; </end encoding val PositiveRelaxed.__proj__POd__item__h>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PositiveRelaxed.uu___is_POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(PositiveRelaxed.p @x0)))
(HasType (PositiveRelaxed.uu___is_POd @x0
@x1)
Prims.bool))
 

:pattern ((PositiveRelaxed.uu___is_POd @x0
@x1))
:qid typing_PositiveRelaxed.uu___is_POd))

:named typing_PositiveRelaxed.uu___is_POd))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name PositiveRelaxed.__proj__POd__item__h; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_10093c564537c9c0559bbc0a0a24fba4 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_10093c564537c9c0559bbc0a0a24fba4 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_10093c564537c9c0559bbc0a0a24fba4))

:named refinement_kinding_Tm_refine_10093c564537c9c0559bbc0a0a24fba4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name PositiveRelaxed.__proj__POd__item__h; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_10093c564537c9c0559bbc0a0a24fba4 @x2))
(and (HasTypeFuel @u0
@x1
(PositiveRelaxed.p @x2))

;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
(BoxBool_proj_0 (PositiveRelaxed.uu___is_POd @x2
@x1))
))
...
@x1
(Tm_refine_10093c564537c9c0559bbc0a0a24fba4 @x2)))
:qid refinement_interpretation_Tm_refine_10093c564537c9c0559bbc0a0a24fba4))

:named refinement_interpretation_Tm_refine_10093c564537c9c0559bbc0a0a24fba4))
;;;;;;;;;;;;;;;;haseq for Tm_refine_10093c564537c9c0559bbc0a0a24fba4
;;; Fact-ids: Name PositiveRelaxed.__proj__POd__item__h; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_10093c564537c9c0559bbc0a0a24fba4 @x0)))
(Valid (Prims.hasEq (PositiveRelaxed.p @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_10093c564537c9c0559bbc0a0a24fba4 @x0))))
:qid haseqTm_refine_10093c564537c9c0559bbc0a0a24fba4))

:named haseqTm_refine_10093c564537c9c0559bbc0a0a24fba4))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name PositiveRelaxed.uu___is_POd; Namespace PositiveRelaxed
(assert (! 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,4-28,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (PositiveRelaxed.uu___is_POd @x0
@x1)
(BoxBool (is-PositiveRelaxed.POd @x1)))
 

:pattern ((PositiveRelaxed.uu___is_POd @x0
@x1))
:qid disc_equation_PositiveRelaxed.POd))

:named disc_equation_PositiveRelaxed.POd))
(push) ;; push{2

; Starting query at PositiveRelaxed.fst(28,10-28,11)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: PositiveRelaxed.nat) (projectee: _: PositiveRelaxed.p _ {POd? _}).
;   (*  - Could not prove post-condition
; *) ~(POd? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__POd__item__h`
...
PositiveRelaxed.nat)
(HasType @x1
(Tm_refine_10093c564537c9c0559bbc0a0a24fba4 @x0))

;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,10-28,11)
(not 
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(28,10-28,11)
(BoxBool_proj_0 (PositiveRelaxed.uu___is_POd @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PositiveRelaxed.__proj__POd__item__h, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_10093c564537c9c0559bbc0a0a24fba4
...
; encoding sigelt let __proj__POd__item__h


; <Skipped let __proj__POd__item__h/>
...
; encoding sigelt val PositiveRelaxed.bad


; <Skipped val PositiveRelaxed.bad/>

(push) ;; push{2

; Starting query at PositiveRelaxed.fst(32,12-32,30)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (h: PositiveRelaxed.p (PositiveRelaxed.S PositiveRelaxed.O)).
;   (*  - Could not prove post-condition
; *) PSO? h


; Context: While encoding a query
; While typechecking the top-level declaration `let bad`
...
;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(32,20-32,21)
(or label_1

;; def=PositiveRelaxed.fst(27,4-27,7); use=PositiveRelaxed.fst(32,20-32,21)
(BoxBool_proj_0 (PositiveRelaxed.uu___is_PSO (PositiveRelaxed.S PositiveRelaxed.O@tok)
@x0))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PositiveRelaxed.bad, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_PositiveRelaxed.O, constructor_distinct_PositiveRelaxed.S, disc_equation_PositiveRelaxed.PSO, equality_tok_PositiveRelaxed.O@tok, fuel_guarded_inversion_PositiveRelaxed.p, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let bad


; <Start encoding let bad>

(declare-fun PositiveRelaxed.bad (Term) Term)
;;;;;;;;;;;;;;;;h: p (S O) -> p (S O)
(declare-fun Tm_arrow_28e2e195f754902823285bcf2e855c72 () Term)
(declare-fun PositiveRelaxed.bad@tok () Term)

; </end encoding let bad>


; encoding sigelt val PositiveRelaxed.loop


; <Skipped val PositiveRelaxed.loop/>

(push) ;; push{2

; Starting query at PositiveRelaxed.fst(35,0-35,46)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (h: PositiveRelaxed.p PositiveRelaxed.O). (*  - Could not prove post-condition
; *) POd? h


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let loop`
...
;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(35,42-35,43)
(or label_1

;; def=PositiveRelaxed.fst(28,4-28,7); use=PositiveRelaxed.fst(35,42-35,43)
(BoxBool_proj_0 (PositiveRelaxed.uu___is_POd PositiveRelaxed.O@tok
@x0))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PositiveRelaxed.loop, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_PositiveRelaxed.O, constructor_distinct_PositiveRelaxed.S, disc_equation_PositiveRelaxed.POd, equality_tok_PositiveRelaxed.O@tok, fuel_guarded_inversion_PositiveRelaxed.p, projection_inverse_BoxBool_proj_0
