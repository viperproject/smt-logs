...
; Internals for PrecedesRank


; encoding sigelt type PrecedesRank.pack


; <Start encoding type PrecedesRank.pack>

;;;;;;;;;;;;;;;;Constructor
(declare-fun PrecedesRank.pack () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PrecedesRank.Mk (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PrecedesRank.Mk_f (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: PrecedesRank.Mk
(declare-fun PrecedesRank.Mk@tok () Term)


;;;;;;;;;;;;;;;;f: (_: Prims.int -> Prims.int) -> pack
(declare-fun Tm_arrow_876e9d613f80c4f3c968003ce72b1b08 () Term)

; <start constructor PrecedesRank.pack>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PrecedesRank.pack ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(= __@x0
PrecedesRank.pack)))

; </end constructor PrecedesRank.pack>


; <start constructor PrecedesRank.Mk>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PrecedesRank.Mk ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
112)
(= __@x0
(PrecedesRank.Mk (PrecedesRank.Mk_f __@x0)))))

; </end constructor PrecedesRank.Mk>


; </end encoding type PrecedesRank.pack>


; encoding sigelt val PrecedesRank.uu___is_Mk


; <Start encoding val PrecedesRank.uu___is_Mk>

(declare-fun PrecedesRank.uu___is_Mk (Term) Term)
;;;;;;;;;;;;;;;;projectee: pack -> Prims.bool
(declare-fun Tm_arrow_8b8e93fbc0ca28e0b0347ebb174fddcf () Term)
(declare-fun PrecedesRank.uu___is_Mk@tok () Term)

; </end encoding val PrecedesRank.uu___is_Mk>
...
; encoding sigelt val PrecedesRank.__proj__Mk__item__f


; <Start encoding val PrecedesRank.__proj__Mk__item__f>

(declare-fun PrecedesRank.__proj__Mk__item__f (Term) Term)

;;;;;;;;;;;;;;;;projectee: pack -> _: Prims.int -> Prims.int
(declare-fun Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb () Term)
(declare-fun PrecedesRank.__proj__Mk__item__f@tok () Term)


; </end encoding val PrecedesRank.__proj__Mk__item__f>


; encoding sigelt let __proj__Mk__item__f


; <Skipped let __proj__Mk__item__f/>


; encoding sigelt let pid


; <Start encoding let pid>

(declare-fun PrecedesRank.pid (Dummy_sort) Term)

(declare-fun Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d () Term)

; </end encoding let pid>
...
;;; Fact-ids: Name PrecedesRank.pid; Namespace PrecedesRank
...
;;; Fact-ids: Name PrecedesRank.pid; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(18,4-18,7); use=PrecedesRank.fst(18,4-18,7)
(forall ((@u0 Dummy_sort))
 (! (HasType (PrecedesRank.pid @u0)
PrecedesRank.pack)
 

:pattern ((PrecedesRank.pid @u0))
:qid typing_PrecedesRank.pid))

:named typing_PrecedesRank.pid))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PrecedesRank.__proj__Mk__item__f; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(16,19-16,20); use=PrecedesRank.fst(16,19-16,20)
(forall ((@x0 Term))
 (! (implies (HasType @x0
PrecedesRank.pack)
(HasType (PrecedesRank.__proj__Mk__item__f @x0)
Tm_arrow_35447810753695c4fe25c93af1251992))
 

:pattern ((PrecedesRank.__proj__Mk__item__f @x0))
:qid typing_PrecedesRank.__proj__Mk__item__f))

:named typing_PrecedesRank.__proj__Mk__item__f))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;; def=PrecedesRank.fst(16,19-16,20); use=PrecedesRank.fst(16,19-16,20)
(forall ((@x0 Term))
 (! (= (ApplyTT PrecedesRank.__proj__Mk__item__f@tok
@x0)
(PrecedesRank.__proj__Mk__item__f @x0))
 

:pattern ((ApplyTT PrecedesRank.__proj__Mk__item__f@tok
@x0))
:qid token_correspondence_PrecedesRank.__proj__Mk__item__f))

:named token_correspondence_PrecedesRank.__proj__Mk__item__f))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name PrecedesRank.pack; Namespace PrecedesRank; Name PrecedesRank.Mk; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(16,14-16,16); use=PrecedesRank.fst(16,14-16,16)
...
(PrecedesRank.Mk @x1)
PrecedesRank.pack))
:qid subterm_ordering_PrecedesRank.Mk))

:named subterm_ordering_PrecedesRank.Mk))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=PrecedesRank.fst(16,14-16,16); use=PrecedesRank.fst(16,14-16,16)
(forall ((@x0 Term))
 (! (= (PrecedesRank.Mk_f (PrecedesRank.Mk @x0))
@x0)
 

:pattern ((PrecedesRank.Mk @x0))
:qid projection_inverse_PrecedesRank.Mk_f))

:named projection_inverse_PrecedesRank.Mk_f))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name PrecedesRank.__proj__Mk__item__f; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(16,19-16,20); use=PrecedesRank.fst(16,19-16,20)
(forall ((@x0 Term))
 (! (= (PrecedesRank.__proj__Mk__item__f @x0)
(PrecedesRank.Mk_f @x0))
 

:pattern ((PrecedesRank.__proj__Mk__item__f @x0))
:qid proj_equation_PrecedesRank.Mk_f))

:named proj_equation_PrecedesRank.Mk_f))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb
;;; Fact-ids: Name PrecedesRank.__proj__Mk__item__f; Namespace PrecedesRank
(assert (! (HasType Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb
Tm_type)
:named kinding_Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb))
...
;;; Fact-ids: Name PrecedesRank.pack; Namespace PrecedesRank; Name PrecedesRank.Mk; Namespace PrecedesRank
(assert (! (HasType PrecedesRank.pack
Tm_type)
:named kinding_PrecedesRank.pack@tok))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d
;;; Fact-ids: Name PrecedesRank.pid; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(18,25-18,26); use=PrecedesRank.fst(18,30-18,31)
(forall ((@x0 Term))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType PrecedesRank.__proj__Mk__item__f@tok
Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb))

;; def=PrecedesRank.fst(16,19-16,20); use=PrecedesRank.fst(16,19-16,20)
(forall ((@x1 Term))
 (! (= (ApplyTT PrecedesRank.__proj__Mk__item__f@tok
@x1)
(PrecedesRank.__proj__Mk__item__f @x1))
 

:pattern ((PrecedesRank.__proj__Mk__item__f @x1))
:qid function_token_typing_PrecedesRank.__proj__Mk__item__f.1))
)
 

:pattern ((ApplyTT @x0
PrecedesRank.__proj__Mk__item__f@tok))
:qid function_token_typing_PrecedesRank.__proj__Mk__item__f))

:named function_token_typing_PrecedesRank.__proj__Mk__item__f))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name PrecedesRank.pack; Namespace PrecedesRank; Name PrecedesRank.Mk; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(16,5-16,9); use=PrecedesRank.fst(16,5-16,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
PrecedesRank.pack)
(is-PrecedesRank.Mk @x1))
 

:pattern ((HasTypeFuel @u0
@x1
PrecedesRank.pack))
:qid fuel_guarded_inversion_PrecedesRank.pack))

:named fuel_guarded_inversion_PrecedesRank.pack))
...
(PrecedesRank.Mk Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d))
...
:qid equation_PrecedesRank.pid))

:named equation_PrecedesRank.pid))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(PrecedesRank.Mk @x1)
PrecedesRank.pack))
:qid data_typing_intro_PrecedesRank.Mk@tok))

:named data_typing_intro_PrecedesRank.Mk@tok))
...
(PrecedesRank.Mk @x1)
PrecedesRank.pack))
:qid data_elim_PrecedesRank.Mk))

:named data_elim_PrecedesRank.Mk))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name PrecedesRank.pack; Namespace PrecedesRank; Name PrecedesRank.Mk; Namespace PrecedesRank
(assert (! (= 104
(Term_constr_id PrecedesRank.pack))
:named constructor_distinct_PrecedesRank.pack))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PrecedesRank.pack; Namespace PrecedesRank; Name PrecedesRank.Mk; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(16,14-16,16); use=PrecedesRank.fst(16,14-16,16)
(forall ((@x0 Term))
 (! (= 112
(Term_constr_id (PrecedesRank.Mk @x0)))
 

:pattern ((PrecedesRank.Mk @x0))
:qid constructor_distinct_PrecedesRank.Mk))

:named constructor_distinct_PrecedesRank.Mk))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
PrecedesRank.pack))
:qid PrecedesRank_pretyping_7f0fff55dd9ab045ef4964fc97f433be))

:named PrecedesRank_pretyping_7f0fff55dd9ab045ef4964fc97f433be))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PrecedesRank.__proj__Mk__item__f; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(16,5-16,32); use=PrecedesRank.fst(16,5-16,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb)
...
@x1
Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb))
:qid PrecedesRank_pre_typing_Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb))

:named PrecedesRank_pre_typing_Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb
;;; Fact-ids: Name PrecedesRank.__proj__Mk__item__f; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(16,5-16,32); use=PrecedesRank.fst(16,5-16,32)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid PrecedesRank_interpretation_Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb))
:qid PrecedesRank_interpretation_Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb))

:named PrecedesRank_interpretation_Tm_arrow_3a5797885de0dcb7b0e9eec4284fa8fb))
(push) ;; push{2

; Starting query at PrecedesRank.fst(23,2-24,4)
...
PrecedesRank.__proj__Mk__item__f@tok))
:named @kick_partial_app_ed0ee9f783aa134d57e448968ba6c7c7))

; Encoding query formula : forall (x: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). x << PrecedesRank.pid ==> p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         PrecedesRank.pid.f x << PrecedesRank.pid ==> (forall (any_result: Prims.unit). p any_result)
;     )


; Context: While encoding a query
; While typechecking the top-level declaration `let pid_ge_n`
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(23,2-24,4)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=PrecedesRank.fst(22,29-22,39); use=PrecedesRank.fst(23,2-24,4)
(or label_2
...
PrecedesRank.pack
@x0
(PrecedesRank.pid Dummy_value))
)
)
)

;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(23,2-24,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(23,2-24,4)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(23,2-23,8)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=PrecedesRank.fst(23,9-23,29); use=PrecedesRank.fst(23,2-23,8)
(Valid 
;; def=PrecedesRank.fst(23,9-23,29); use=PrecedesRank.fst(23,2-23,8)
(Prims.precedes Prims.int
PrecedesRank.pack
(ApplyTT (ApplyTT PrecedesRank.__proj__Mk__item__f@tok
(PrecedesRank.pid Dummy_value))
@x0)
(PrecedesRank.pid Dummy_value))
)
...
;; def=Prims.fst(451,66-451,102); use=PrecedesRank.fst(23,2-24,4)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=PrecedesRank.fst(23,2-24,4)
(Valid 
;; def=Prims.fst(451,90-451,102); use=PrecedesRank.fst(23,2-24,4)
(ApplyTT @x1
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PrecedesRank.pid_ge_n, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_PrecedesRank.pid, int_inversion, interpretation_Tm_abs_f8b7175ad4f28c0bc3c11371abe1d18d, proj_equation_PrecedesRank.Mk_f, projection_inverse_PrecedesRank.Mk_f, token_correspondence_PrecedesRank.__proj__Mk__item__f
...
; encoding sigelt let pid_ge_n


; <Start encoding let pid_ge_n>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PrecedesRank.pid_ge_n (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PrecedesRank.pid_ge_n@tok () Term)

; </end encoding let pid_ge_n>


; encoding sigelt type PrecedesRank.ras


; <Start encoding type PrecedesRank.ras>

;;;;;;;;;;;;;;;;Constructor
(declare-fun PrecedesRank.ras () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun PrecedesRank.Mkras (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PrecedesRank.Mkras_rank (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun PrecedesRank.Mkras_rank_lem (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: PrecedesRank.Mkras
(declare-fun PrecedesRank.Mkras@tok () Term)
;;;;;;;;;;;;;;;;_: a -> Prims.int
(declare-fun Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431 () Term)
(declare-fun Tm_refine_e96b98fb7f602bfa4518cc52da76007d (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: b -> FStar.Pervasives.Lemma (ensures x << y <==> rank x < rank y)
(declare-fun Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8 (Term) Term)



;;;;;;;;;;;;;;;;rank: (_: a -> Prims.int) ->     rank_lem: (x: a -> y: b -> FStar.Pervasives.Lemma (ensures x << y <==> rank x < rank y))   -> ras
(declare-fun Tm_arrow_7d674e028bc33a91422c1397550d7125 () Term)

; <start constructor PrecedesRank.ras>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PrecedesRank.ras ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
128)
(= __@x0
PrecedesRank.ras)))

; </end constructor PrecedesRank.ras>


; <start constructor PrecedesRank.Mkras>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-PrecedesRank.Mkras ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
139)
(= __@x0
(PrecedesRank.Mkras (PrecedesRank.Mkras_rank __@x0)
(PrecedesRank.Mkras_rank_lem __@x0)))))

; </end constructor PrecedesRank.Mkras>


; </end encoding type PrecedesRank.ras>


; encoding sigelt val PrecedesRank.__proj__Mkras__item__rank


; <Start encoding val PrecedesRank.__proj__Mkras__item__rank>

(declare-fun PrecedesRank.__proj__Mkras__item__rank (Term) Term)

;;;;;;;;;;;;;;;;projectee: ras -> _: a -> Prims.int
(declare-fun Tm_arrow_df07aeeaac54a282afbd083ead2b9639 () Term)
(declare-fun PrecedesRank.__proj__Mkras__item__rank@tok () Term)


; </end encoding val PrecedesRank.__proj__Mkras__item__rank>


; encoding sigelt let __proj__Mkras__item__rank


; <Skipped let __proj__Mkras__item__rank/>


; encoding sigelt val PrecedesRank.__proj__Mkras__item__rank_lem


; <Start encoding val PrecedesRank.__proj__Mkras__item__rank_lem>

(declare-fun PrecedesRank.__proj__Mkras__item__rank_lem (Term) Term)

(declare-fun Tm_refine_34b918c9e60d461022742c5f1fea16a1 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: b -> FStar.Pervasives.Lemma (ensures x << y <==> projectee.rank x < projectee.rank y)
(declare-fun Tm_arrow_83c3ed3e631499e3819e95dbf79be484 (Term) Term)
;;;;;;;;;;;;;;;;projectee: ras -> x: a -> y: b   -> FStar.Pervasives.Lemma (ensures x << y <==> projectee.rank x < projectee.rank y)
(declare-fun Tm_arrow_38e113e76500dbc1e7b43fa4b4d8e661 () Term)
(declare-fun PrecedesRank.__proj__Mkras__item__rank_lem@tok () Term)





; </end encoding val PrecedesRank.__proj__Mkras__item__rank_lem>


; encoding sigelt let __proj__Mkras__item__rank_lem


; <Skipped let __proj__Mkras__item__rank_lem/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PrecedesRank.__proj__Mkras__item__rank; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(29,2-29,6); use=PrecedesRank.fst(29,2-29,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
PrecedesRank.ras)
(HasType (PrecedesRank.__proj__Mkras__item__rank @x0)
Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431))
 

:pattern ((PrecedesRank.__proj__Mkras__item__rank @x0))
:qid typing_PrecedesRank.__proj__Mkras__item__rank))

:named typing_PrecedesRank.__proj__Mkras__item__rank))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name PrecedesRank.__proj__Mkras__item__rank; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(29,2-29,6); use=PrecedesRank.fst(29,2-29,6)
(forall ((@x0 Term))
 (! (= (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0)
(PrecedesRank.__proj__Mkras__item__rank @x0))
 

:pattern ((ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0))
:qid token_correspondence_PrecedesRank.__proj__Mkras__item__rank))

:named token_correspondence_PrecedesRank.__proj__Mkras__item__rank))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(28,5-28,8); use=PrecedesRank.fst(28,5-28,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(PrecedesRank.Mkras @x1
@x2)
PrecedesRank.ras)
...
@x2)
PrecedesRank.ras))
:qid subterm_ordering_PrecedesRank.Mkras))

:named subterm_ordering_PrecedesRank.Mkras))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(30,49-30,84); use=PrecedesRank.fst(30,49-30,84)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_refine_e96b98fb7f602bfa4518cc52da76007d @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_refine_e96b98fb7f602bfa4518cc52da76007d @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid refinement_kinding_Tm_refine_e96b98fb7f602bfa4518cc52da76007d))

:named refinement_kinding_Tm_refine_e96b98fb7f602bfa4518cc52da76007d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(30,49-30,84); use=PrecedesRank.fst(30,49-30,84)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e96b98fb7f602bfa4518cc52da76007d @x2
@x3
@x4
@x5
@x6))
...
;; def=Prims.fst(635,71-635,97); use=PrecedesRank.fst(30,49-30,84)
(not 
;; def=Prims.fst(441,29-441,97); use=PrecedesRank.fst(30,49-30,54)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=PrecedesRank.fst(30,55-30,84); use=PrecedesRank.fst(30,49-30,54)
(iff 
;; def=PrecedesRank.fst(30,56-30,62); use=PrecedesRank.fst(30,49-30,54)
(Valid 
;; def=PrecedesRank.fst(30,56-30,62); use=PrecedesRank.fst(30,49-30,54)
(Prims.precedes @x2
@x3
...
;; def=PrecedesRank.fst(30,68-30,83); use=PrecedesRank.fst(30,49-30,54)
(< (BoxInt_proj_0 (ApplyTT (ApplyTT @x6
@x2)
@x4))
(BoxInt_proj_0 (ApplyTT (ApplyTT @x6
@x3)
...
;; def=Prims.fst(635,86-635,95); use=PrecedesRank.fst(30,49-30,84)
(not 
;; def=Prims.fst(635,86-635,95); use=PrecedesRank.fst(30,49-30,84)
(= @x7
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_e96b98fb7f602bfa4518cc52da76007d.1))
)
))
...
@x5
@x6)))
:qid refinement_interpretation_Tm_refine_e96b98fb7f602bfa4518cc52da76007d))

:named refinement_interpretation_Tm_refine_e96b98fb7f602bfa4518cc52da76007d))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(28,5-28,8); use=PrecedesRank.fst(28,5-28,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (PrecedesRank.Mkras_rank_lem (PrecedesRank.Mkras @x0
@x1))
@x1)
 

:pattern ((PrecedesRank.Mkras @x0
@x1))
:qid projection_inverse_PrecedesRank.Mkras_rank_lem))

:named projection_inverse_PrecedesRank.Mkras_rank_lem))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(28,5-28,8); use=PrecedesRank.fst(28,5-28,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (PrecedesRank.Mkras_rank (PrecedesRank.Mkras @x0
@x1))
@x0)
...
:pattern ((PrecedesRank.Mkras @x0
@x1))
:qid projection_inverse_PrecedesRank.Mkras_rank))

:named projection_inverse_PrecedesRank.Mkras_rank))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name PrecedesRank.__proj__Mkras__item__rank; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(29,2-29,6); use=PrecedesRank.fst(29,2-29,6)
(forall ((@x0 Term))
 (! (= (PrecedesRank.__proj__Mkras__item__rank @x0)
(PrecedesRank.Mkras_rank @x0))
 

:pattern ((PrecedesRank.__proj__Mkras__item__rank @x0))
:qid proj_equation_PrecedesRank.Mkras_rank))

:named proj_equation_PrecedesRank.Mkras_rank))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_df07aeeaac54a282afbd083ead2b9639
;;; Fact-ids: Name PrecedesRank.__proj__Mkras__item__rank; Namespace PrecedesRank
(assert (! (HasType Tm_arrow_df07aeeaac54a282afbd083ead2b9639
Tm_type)
:named kinding_Tm_arrow_df07aeeaac54a282afbd083ead2b9639))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! (HasType Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431
Tm_type)
:named kinding_Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(30,14-30,84); use=PrecedesRank.fst(30,16-30,84)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8 @x0)
Tm_type))
:qid kinding_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8))

:named kinding_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8))
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! (HasType PrecedesRank.ras
Tm_type)
:named kinding_PrecedesRank.ras@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e96b98fb7f602bfa4518cc52da76007d
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(30,49-30,84); use=PrecedesRank.fst(30,49-30,84)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e96b98fb7f602bfa4518cc52da76007d @x0
@x1
@x2
@x3
@x4)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_e96b98fb7f602bfa4518cc52da76007d @x0
@x1
@x2
@x3
@x4))))
:qid haseqTm_refine_e96b98fb7f602bfa4518cc52da76007d))

:named haseqTm_refine_e96b98fb7f602bfa4518cc52da76007d))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! (HasType Prims.nat
Tm_type)
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType PrecedesRank.__proj__Mkras__item__rank@tok
Tm_arrow_df07aeeaac54a282afbd083ead2b9639))

;; def=PrecedesRank.fst(29,2-29,6); use=PrecedesRank.fst(29,2-29,6)
(forall ((@x1 Term))
 (! (= (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x1)
(PrecedesRank.__proj__Mkras__item__rank @x1))
 

:pattern ((PrecedesRank.__proj__Mkras__item__rank @x1))
:qid function_token_typing_PrecedesRank.__proj__Mkras__item__rank.1))
)
 

:pattern ((ApplyTT @x0
PrecedesRank.__proj__Mkras__item__rank@tok))
:qid function_token_typing_PrecedesRank.__proj__Mkras__item__rank))

:named function_token_typing_PrecedesRank.__proj__Mkras__item__rank))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(28,5-28,8); use=PrecedesRank.fst(28,5-28,8)
...
@x1
PrecedesRank.ras)
(is-PrecedesRank.Mkras @x1))
 

:pattern ((HasTypeFuel @u0
@x1
PrecedesRank.ras))
:qid fuel_guarded_inversion_PrecedesRank.ras))

:named fuel_guarded_inversion_PrecedesRank.ras))
...
(HasTypeFuel @u0
@x2
(Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8 @x1)))
(HasTypeFuel @u0
(PrecedesRank.Mkras @x1
@x2)
PrecedesRank.ras))
...
@x2)
PrecedesRank.ras))
:qid data_typing_intro_PrecedesRank.Mkras@tok))

:named data_typing_intro_PrecedesRank.Mkras@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(28,5-28,8); use=PrecedesRank.fst(28,5-28,8)
...
@x2)
PrecedesRank.ras))
:qid data_elim_PrecedesRank.Mkras))

:named data_elim_PrecedesRank.Mkras))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (= 107
...
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! (= 128
(Term_constr_id PrecedesRank.ras))
:named constructor_distinct_PrecedesRank.ras))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(28,5-28,8); use=PrecedesRank.fst(28,5-28,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 139
(Term_constr_id (PrecedesRank.Mkras @x0
@x1)))
 

:pattern ((PrecedesRank.Mkras @x0
@x1))
:qid constructor_distinct_PrecedesRank.Mkras))

:named constructor_distinct_PrecedesRank.Mkras))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x0
PrecedesRank.ras))
:qid PrecedesRank_pretyping_8aa422300faccaa218c4237ab35f72a6))

:named PrecedesRank_pretyping_8aa422300faccaa218c4237ab35f72a6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PrecedesRank.__proj__Mkras__item__rank; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(28,5-29,28); use=PrecedesRank.fst(28,5-29,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_df07aeeaac54a282afbd083ead2b9639)
...
@x1
Tm_arrow_df07aeeaac54a282afbd083ead2b9639))
:qid PrecedesRank_pre_typing_Tm_arrow_df07aeeaac54a282afbd083ead2b9639))

:named PrecedesRank_pre_typing_Tm_arrow_df07aeeaac54a282afbd083ead2b9639))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(29,10-29,28); use=PrecedesRank.fst(29,12-29,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431)
...
@x1
Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431))
:qid PrecedesRank_pre_typing_Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431))

:named PrecedesRank_pre_typing_Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(30,14-30,84); use=PrecedesRank.fst(30,16-30,84)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8 @x2)))
:qid PrecedesRank_pre_typing_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8))

:named PrecedesRank_pre_typing_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_df07aeeaac54a282afbd083ead2b9639
;;; Fact-ids: Name PrecedesRank.__proj__Mkras__item__rank; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(28,5-29,28); use=PrecedesRank.fst(28,5-29,28)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid PrecedesRank_interpretation_Tm_arrow_df07aeeaac54a282afbd083ead2b9639.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_df07aeeaac54a282afbd083ead2b9639))
:qid PrecedesRank_interpretation_Tm_arrow_df07aeeaac54a282afbd083ead2b9639))

:named PrecedesRank_interpretation_Tm_arrow_df07aeeaac54a282afbd083ead2b9639))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(29,10-29,28); use=PrecedesRank.fst(29,12-29,28)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid PrecedesRank_interpretation_Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid PrecedesRank_interpretation_Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431))
:qid PrecedesRank_interpretation_Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431))

:named PrecedesRank_interpretation_Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8
;;; Fact-ids: Name PrecedesRank.ras; Namespace PrecedesRank; Name PrecedesRank.Mkras; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(30,14-30,84); use=PrecedesRank.fst(30,16-30,84)
(forall ((@x0 Term) (@x1 Term))
...
@x4)
@x5))
:qid PrecedesRank_interpretation_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid PrecedesRank_interpretation_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8.2))
...
@x2)
@x3))
:qid PrecedesRank_interpretation_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8.3))
...
@x3)
@x4))
:qid PrecedesRank_interpretation_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8.4))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8 @x1)))
:qid PrecedesRank_interpretation_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8))

:named PrecedesRank_interpretation_Tm_arrow_4ea892a7a6c232ca9b0d68062511c0e8))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name PrecedesRank.__proj__Mkras__item__rank_lem; Namespace PrecedesRank
(assert (! (Valid (ApplyTT __uu__PartialApp
PrecedesRank.__proj__Mkras__item__rank@tok))
:named @kick_partial_app_2c9199ead2e49421566d28a830b5056a))
(push) ;; push{2

; Starting query at PrecedesRank.fst(35,2-38,5)

;;;;;;;;;;;;;;;;r : PrecedesRank.ras (PrecedesRank.ras)
(declare-fun x_8aa422300faccaa218c4237ab35f72a6_0 () Term)
;;;;;;;;;;;;;;;;binder_x_8aa422300faccaa218c4237ab35f72a6_0
;;; Fact-ids: 
(assert (! (HasType x_8aa422300faccaa218c4237ab35f72a6_0
PrecedesRank.ras)
:named binder_x_8aa422300faccaa218c4237ab35f72a6_0))
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PrecedesRank.rank_n_ge_n (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PrecedesRank.rank_n_ge_n@tok () Term)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_e6a1dcfa3288f279d1bb382f0285c6d8 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_e6a1dcfa3288f279d1bb382f0285c6d8
Tm_type)
:named refinement_kinding_Tm_refine_e6a1dcfa3288f279d1bb382f0285c6d8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=PrecedesRank.fst(34,21-38,5); use=PrecedesRank.fst(36,4-36,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_e6a1dcfa3288f279d1bb382f0285c6d8)
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
;; def=PrecedesRank.fst(34,21-38,5); use=PrecedesRank.fst(36,4-36,15)
(or 
;; def=PrecedesRank.fst(35,2-38,5); use=PrecedesRank.fst(36,4-36,15)
(Valid 
;; def=PrecedesRank.fst(35,2-38,5); use=PrecedesRank.fst(36,4-36,15)
(Prims.precedes PrecedesRank.ras
PrecedesRank.ras
x_8aa422300faccaa218c4237ab35f72a6_0
x_8aa422300faccaa218c4237ab35f72a6_0)
)
...
@x1
Tm_refine_e6a1dcfa3288f279d1bb382f0285c6d8))
:qid refinement_interpretation_Tm_refine_e6a1dcfa3288f279d1bb382f0285c6d8))

:named refinement_interpretation_Tm_refine_e6a1dcfa3288f279d1bb382f0285c6d8))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e6a1dcfa3288f279d1bb382f0285c6d8
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_e6a1dcfa3288f279d1bb382f0285c6d8))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_e6a1dcfa3288f279d1bb382f0285c6d8))
...
;   (forall (pure_result: Prims.unit). r.rank n >= r.rank 0 + n ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (n <> 0 == true ==>
;         n - 1 >= 0 /\ (r << r \/ n - 1 << n) /\
;         (forall (return_val: n: Prims.nat{r << r \/ n << n}).
;             return_val == n - 1 ==>
;             (forall (pure_result: Prims.unit).
;                 r.rank (n - 1) >= r.rank 0 + (n - 1) ==>
;                 (forall (pure_result: Prims.unit).
;                     (n - 1 << n <==> r.rank (n - 1) < r.rank n) ==> k pure_result)))) /\
;       (~(n <> 0 = true) ==>
;         (forall (b: Prims.bool). n <> 0 == b ==> (forall (any_result: Prims.unit). k any_result))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec rank_n_ge_n`
...
;;; Fact-ids: 
(assert (! (not 
;; def=PrecedesRank.fst(35,2-38,5); use=PrecedesRank.fst(35,2-38,5)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(35,2-38,5)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=PrecedesRank.fst(34,44-34,80); use=PrecedesRank.fst(35,2-38,5)
(or label_2

;; def=PrecedesRank.fst(34,44-34,80); use=PrecedesRank.fst(35,2-38,5)
(>= (BoxInt_proj_0 (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
x_8aa422300faccaa218c4237ab35f72a6_0)
Prims.int)
x_bb4e1c9af0265270f8e7a5f250f730e2_1))
(BoxInt_proj_0 (Prims.op_Addition (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
x_8aa422300faccaa218c4237ab35f72a6_0)
Prims.int)
(BoxInt 0))
x_bb4e1c9af0265270f8e7a5f250f730e2_1)))
...
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(35,2-38,5)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(35,2-38,5)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=PrecedesRank.fst(35,2-38,5)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=PrecedesRank.fst(35,2-38,5)
(Valid 
;; def=Prims.fst(402,73-402,79); use=PrecedesRank.fst(35,2-38,5)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=PrecedesRank.fst(35,2-38,5)
(Valid 
;; def=Prims.fst(402,84-402,87); use=PrecedesRank.fst(35,2-38,5)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(389,2-389,39); use=PrecedesRank.fst(35,2-38,5)
(and (implies 
;; def=PrecedesRank.fst(35,5-35,11); use=PrecedesRank.fst(35,5-35,11)
...
;; def=Prims.fst(459,77-459,89); use=PrecedesRank.fst(35,2-38,5)
(and 
;; def=Prims.fst(680,18-680,24); use=PrecedesRank.fst(36,18-36,23)
(or label_3
...
;; def=PrecedesRank.fst(34,21-38,5); use=PrecedesRank.fst(36,18-36,23)
(or label_4

;; def=PrecedesRank.fst(35,2-38,5); use=PrecedesRank.fst(36,18-36,23)
(Valid 
;; def=PrecedesRank.fst(35,2-38,5); use=PrecedesRank.fst(36,18-36,23)
(Prims.precedes PrecedesRank.ras
PrecedesRank.ras
...
;; def=Prims.fst(356,2-356,58); use=PrecedesRank.fst(35,2-38,5)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_e6a1dcfa3288f279d1bb382f0285c6d8)

;; def=Prims.fst(356,26-356,41); use=PrecedesRank.fst(35,2-38,5)
(= @x2
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 1)))
)

;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(36,4-36,15)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=PrecedesRank.fst(34,44-34,80); use=PrecedesRank.fst(36,4-36,15)
(>= (BoxInt_proj_0 (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
x_8aa422300faccaa218c4237ab35f72a6_0)
Prims.int)
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_1
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(37,6-37,14)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=PrecedesRank.fst(30,55-30,84); use=PrecedesRank.fst(37,6-37,14)
(iff 
;; def=PrecedesRank.fst(30,56-30,62); use=PrecedesRank.fst(37,6-37,14)
(Valid 
;; def=PrecedesRank.fst(30,56-30,62); use=PrecedesRank.fst(37,6-37,14)
(Prims.precedes Prims.int
Prims.int
...
;; def=PrecedesRank.fst(30,68-30,83); use=PrecedesRank.fst(37,6-37,14)
(< (BoxInt_proj_0 (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
x_8aa422300faccaa218c4237ab35f72a6_0)
Prims.int)
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_1
...
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(37,6-37,14)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(37,6-37,14)
(ApplyTT @x1
@x4)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=PrecedesRank.fst(35,2-38,5)
(not 
;; def=PrecedesRank.fst(35,5-35,11); use=PrecedesRank.fst(35,5-35,11)
(= (Prims.op_disEquality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_1
...
;; def=Prims.fst(413,99-413,120); use=PrecedesRank.fst(35,2-38,5)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.bool)
...
;; def=Prims.fst(451,66-451,102); use=PrecedesRank.fst(35,2-38,5)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=PrecedesRank.fst(35,2-38,5)
(Valid 
;; def=Prims.fst(451,90-451,102); use=PrecedesRank.fst(35,2-38,5)
(ApplyTT @x1
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PrecedesRank.rank_n_ge_n, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_1, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_Subtraction, primitive_Prims.op_disEquality, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec rank_n_ge_n


; <Start encoding let rec rank_n_ge_n>
...
; </end encoding let rec rank_n_ge_n>
...
; Starting query at PrecedesRank.fst(41,58-49,5)
...
(declare-fun Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=PrecedesRank.fst(41,32-41,56); use=PrecedesRank.fst(41,58-49,5)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad))

:named refinement_kinding_Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=PrecedesRank.fst(41,32-41,56); use=PrecedesRank.fst(41,58-49,5)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=PrecedesRank.fst(41,38-41,55); use=PrecedesRank.fst(41,58-49,5)
(> (BoxInt_proj_0 (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x2)
Prims.int)
@x1))
...
(Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad @x2
@x3)))
:qid refinement_interpretation_Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad))

:named refinement_interpretation_Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad
;;; Fact-ids: 
(assert (! 
;; def=PrecedesRank.fst(41,32-41,56); use=PrecedesRank.fst(41,58-49,5)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad @x0
@x1)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad @x0
@x1))))
:qid haseqTm_refine_a949dfb718b32fd8ed52a101c1bfd3ad))

:named haseqTm_refine_a949dfb718b32fd8ed52a101c1bfd3ad))
...
; Encoding query formula : forall (r: PrecedesRank.ras) (n: Prims.int).
;   (*  - Could not prove post-condition
; *)
...
;             | _ -> n) ==
;           x ==>
;           (forall (k: Prims.pure_post (i: Prims.int{r.rank i > n})).
;               (forall (x: i: Prims.int{r.rank i > n}). {:pattern Prims.guard_free (k x)}
...
;                             n)))))) ==>
;         k x) ==>
;     (n < 0 == true ==> (forall (any_result: Prims.int). k any_result)) /\
;     (~(n < 0 = true) ==>
;       (forall (b: Prims.bool). n < 0 == b ==> (forall (any_result: Prims.int). k any_result)))


; Context: While encoding a query
; While typechecking the top-level declaration `let bigrank_n`
...
;; def=Prims.fst(402,2-402,97); use=PrecedesRank.fst(41,58-49,5)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.pure_post Prims.int))

;; def=Prims.fst(402,27-402,88); use=PrecedesRank.fst(41,58-49,5)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,73-402,87); use=PrecedesRank.fst(41,58-49,5)
(implies (implies 
;; def=PrecedesRank.fst(42,6-42,32); use=PrecedesRank.fst(42,6-42,32)
(= (let ((@lb4 (Prims.op_LessThan @x1
(BoxInt 0))))
(ite (= @lb4
(BoxBool true))
(BoxInt 0)
...
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.pure_post (Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad @x0
@x1)))

;; def=Prims.fst(402,27-402,88); use=PrecedesRank.fst(41,58-49,5)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=PrecedesRank.fst(41,58-49,5)
(Valid 
;; def=Prims.fst(402,84-402,87); use=PrecedesRank.fst(41,58-49,5)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(389,2-389,39); use=PrecedesRank.fst(41,58-49,5)
(and (implies 
;; def=PrecedesRank.fst(43,5-43,23); use=PrecedesRank.fst(43,5-43,23)
(= (Prims.op_GreaterThanOrEqual (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0)
Prims.int)
(BoxInt 0))
(BoxInt 0))
...
;; def=Prims.fst(459,77-459,89); use=PrecedesRank.fst(41,58-49,5)
(and 
;; def=Prims.fst(680,18-680,24); use=PrecedesRank.fst(44,18-44,23)
(or label_1

;; def=Prims.fst(680,18-680,24); use=PrecedesRank.fst(44,18-44,23)
(>= (BoxInt_proj_0 (Prims.op_Addition (let ((@lb5 (Prims.op_LessThan @x1
(BoxInt 0))))
(ite (= @lb5
(BoxBool true))
(BoxInt 0)
...
;; def=Prims.fst(356,2-356,58); use=PrecedesRank.fst(41,58-49,5)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=PrecedesRank.fst(41,58-49,5)
(= @x5
(Prims.op_Addition (let ((@lb6 (Prims.op_LessThan @x1
(BoxInt 0))))
(ite (= @lb6
(BoxBool true))
(BoxInt 0)
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(44,4-44,15)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=PrecedesRank.fst(34,44-34,80); use=PrecedesRank.fst(44,4-44,15)
(>= (BoxInt_proj_0 (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0)
Prims.int)
(Prims.op_Addition (let ((@lb7 (Prims.op_LessThan @x1
(BoxInt 0))))
(ite (= @lb7
(BoxBool true))
(BoxInt 0)
...
;; def=PrecedesRank.fst(41,38-41,55); use=PrecedesRank.fst(45,4-45,9)
(or label_2
...
(implies 
;; def=Prims.fst(389,19-389,21); use=PrecedesRank.fst(41,58-49,5)
(not 
;; def=PrecedesRank.fst(43,5-43,23); use=PrecedesRank.fst(43,5-43,23)
(= (Prims.op_GreaterThanOrEqual (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0)
...
;; def=Prims.fst(413,99-413,120); use=PrecedesRank.fst(41,58-49,5)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=PrecedesRank.fst(43,5-48,23); use=PrecedesRank.fst(43,5-48,23)
(= (Prims.op_GreaterThanOrEqual (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0)
Prims.int)
(BoxInt 0))
...
;; def=Prims.fst(459,77-459,89); use=PrecedesRank.fst(41,58-49,5)
(and 
;; def=Prims.fst(680,18-680,24); use=PrecedesRank.fst(47,18-47,39)
(or label_3

;; def=Prims.fst(680,18-680,24); use=PrecedesRank.fst(47,18-47,39)
(>= (BoxInt_proj_0 (Prims.op_Subtraction (Prims.op_Addition (let ((@lb6 (Prims.op_LessThan @x1
(BoxInt 0))))
(ite (= @lb6
(BoxBool true))
(BoxInt 0)
@x1))
(BoxInt 1))
(ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0)
Prims.int)
(BoxInt 0))))
(BoxInt_proj_0 (BoxInt 0)))
...
;; def=Prims.fst(356,26-356,41); use=PrecedesRank.fst(41,58-49,5)
(= @x6
(Prims.op_Subtraction (Prims.op_Addition (let ((@lb7 (Prims.op_LessThan @x1
(BoxInt 0))))
(ite (= @lb7
(BoxBool true))
(BoxInt 0)
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(47,4-47,15)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=PrecedesRank.fst(34,44-34,80); use=PrecedesRank.fst(47,4-47,15)
(>= (BoxInt_proj_0 (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0)
Prims.int)
(Prims.op_Subtraction (Prims.op_Addition (let ((@lb8 (Prims.op_LessThan @x1
(BoxInt 0))))
(ite (= @lb8
(BoxBool true))
(BoxInt 0)
...
;; def=PrecedesRank.fst(41,38-41,55); use=PrecedesRank.fst(48,4-48,23)
(or label_4
...
;; def=Prims.fst(389,2-389,39); use=PrecedesRank.fst(41,58-49,5)
(and (implies 
;; def=PrecedesRank.fst(42,13-42,18); use=PrecedesRank.fst(42,13-42,18)
(= (Prims.op_LessThan @x1
(BoxInt 0))
(BoxBool true))


;; def=Prims.fst(451,66-451,102); use=PrecedesRank.fst(41,58-49,5)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.int)

;; def=Prims.fst(451,90-451,102); use=PrecedesRank.fst(41,58-49,5)
(Valid 
;; def=Prims.fst(451,90-451,102); use=PrecedesRank.fst(41,58-49,5)
(ApplyTT @x2
@x3)
...
;; def=PrecedesRank.fst(42,13-42,32); use=PrecedesRank.fst(42,13-42,32)
(= (Prims.op_LessThan @x1
(BoxInt 0))
@x3)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PrecedesRank.bigrank_n, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, int_inversion, primitive_Prims.op_Addition, primitive_Prims.op_GreaterThanOrEqual, primitive_Prims.op_LessThan, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0
...
; encoding sigelt let bigrank_n


; <Start encoding let bigrank_n>

(declare-fun PrecedesRank.bigrank_n (Term Term) Term)

(declare-fun Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad (Term Term) Term)
;;;;;;;;;;;;;;;;r: ras -> n: Prims.int -> i: Prims.int{r.rank i > n}
(declare-fun Tm_arrow_eaccf9289ce6bc2988201f00ffe63870 () Term)
(declare-fun PrecedesRank.bigrank_n@tok () Term)





; </end encoding let bigrank_n>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name PrecedesRank.bigrank_n; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(41,4-41,13); use=PrecedesRank.fst(41,4-41,13)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
PrecedesRank.ras)
(HasType @x1
Prims.int))
(HasType (PrecedesRank.bigrank_n @x0
@x1)
(Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad @x0
@x1)))
 

:pattern ((PrecedesRank.bigrank_n @x0
@x1))
:qid typing_PrecedesRank.bigrank_n))

:named typing_PrecedesRank.bigrank_n))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name PrecedesRank.bigrank_n; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(41,32-41,56); use=PrecedesRank.fst(41,32-41,56)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad @x0
@x1)
Tm_type)
...
;; def=PrecedesRank.fst(41,38-41,55); use=PrecedesRank.fst(41,38-41,55)
(> (BoxInt_proj_0 (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x2)
Prims.int)
@x1))
...
:named haseqTm_refine_a949dfb718b32fd8ed52a101c1bfd3ad))
;;;;;;;;;;;;;;;;Equation for PrecedesRank.bigrank_n
;;; Fact-ids: Name PrecedesRank.bigrank_n; Namespace PrecedesRank
(assert (! 
;; def=PrecedesRank.fst(41,4-41,13); use=PrecedesRank.fst(41,4-41,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (PrecedesRank.bigrank_n @x0
@x1)
(let ((@lb2 (Prims.op_GreaterThanOrEqual (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0)
Prims.int)
(BoxInt 0))
(BoxInt 0))))
(ite (= @lb2
(BoxBool true))
(Prims.op_Addition (let ((@lb3 (Prims.op_LessThan @x1
(BoxInt 0))))
(ite (= @lb3
(BoxBool true))
(BoxInt 0)
@x1))
(BoxInt 1))
(Prims.op_Subtraction (Prims.op_Addition (let ((@lb3 (Prims.op_LessThan @x1
(BoxInt 0))))
(ite (= @lb3
(BoxBool true))
(BoxInt 0)
...
:pattern ((PrecedesRank.bigrank_n @x0
@x1))
:qid equation_PrecedesRank.bigrank_n))

:named equation_PrecedesRank.bigrank_n))
(push) ;; push{2

; Starting query at PrecedesRank.fst(56,52-64,4)
...
(declare-fun Tm_refine_afd45851fee572515110d6d74bd20903 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=PrecedesRank.fst(41,32-41,56); use=PrecedesRank.fst(62,2-62,8)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_afd45851fee572515110d6d74bd20903 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_afd45851fee572515110d6d74bd20903 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_afd45851fee572515110d6d74bd20903))

:named refinement_kinding_Tm_refine_afd45851fee572515110d6d74bd20903))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=PrecedesRank.fst(41,32-41,56); use=PrecedesRank.fst(62,2-62,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_afd45851fee572515110d6d74bd20903 @x2))
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=PrecedesRank.fst(41,38-41,55); use=PrecedesRank.fst(62,2-62,8)
(> (BoxInt_proj_0 (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x2)
Prims.int)
@x1))
...
@x1
(Tm_refine_afd45851fee572515110d6d74bd20903 @x2)))
:qid refinement_interpretation_Tm_refine_afd45851fee572515110d6d74bd20903))

:named refinement_interpretation_Tm_refine_afd45851fee572515110d6d74bd20903))
;;;;;;;;;;;;;;;;haseq for Tm_refine_afd45851fee572515110d6d74bd20903
;;; Fact-ids: 
(assert (! 
;; def=PrecedesRank.fst(41,32-41,56); use=PrecedesRank.fst(62,2-62,8)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_afd45851fee572515110d6d74bd20903 @x0)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_afd45851fee572515110d6d74bd20903 @x0))))
:qid haseqTm_refine_afd45851fee572515110d6d74bd20903))

:named haseqTm_refine_afd45851fee572515110d6d74bd20903))
...
; Encoding query formula : forall (r: PrecedesRank.ras).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         r.rank PrecedesRank.pid > r.rank PrecedesRank.pid ==> p pure_result) ==>
;     r.rank (PrecedesRank.bigrank_n r (r.rank PrecedesRank.pid)) > r.rank PrecedesRank.pid /\
;     (forall (pure_result: Prims.unit).
;         r.rank (PrecedesRank.bigrank_n r (r.rank PrecedesRank.pid)) > r.rank PrecedesRank.pid ==>
;         r.rank PrecedesRank.pid < r.rank (PrecedesRank.bigrank_n r (r.rank PrecedesRank.pid)) /\
;         (forall (pure_result: Prims.unit).
;             r.rank PrecedesRank.pid < r.rank (PrecedesRank.bigrank_n r (r.rank PrecedesRank.pid)) ==>
;             (forall (pure_result: Prims.unit).
;                 (PrecedesRank.pid << PrecedesRank.bigrank_n r (r.rank PrecedesRank.pid) <==>
;                   r.rank PrecedesRank.pid <
;                   r.rank (PrecedesRank.bigrank_n r (r.rank PrecedesRank.pid))) ==>
;                 PrecedesRank.pid << PrecedesRank.bigrank_n r (r.rank PrecedesRank.pid) /\
;                 (forall (pure_result: Prims.unit).
;                     PrecedesRank.pid << PrecedesRank.bigrank_n r (r.rank PrecedesRank.pid) ==>
;                     (forall (pure_result: Prims.unit).
;                         PrecedesRank.bigrank_n r (r.rank PrecedesRank.pid) << PrecedesRank.pid ==>
;                         (forall (any_result: Prims.unit). p any_result))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let diag`
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(56,52-64,4)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=PrecedesRank.fst(56,25-56,50); use=PrecedesRank.fst(56,52-64,4)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(56,52-64,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(56,52-64,4)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(441,29-441,97); use=PrecedesRank.fst(59,2-59,8)
(and 
;; def=PrecedesRank.fst(59,9-59,38); use=PrecedesRank.fst(59,2-59,8)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(59,2-59,8)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)
...
;; def=Prims.fst(441,29-441,97); use=PrecedesRank.fst(60,2-60,8)
(and 
;; def=PrecedesRank.fst(60,9-60,38); use=PrecedesRank.fst(60,2-60,8)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(60,2-60,8)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(61,4-61,12)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=PrecedesRank.fst(30,55-30,84); use=PrecedesRank.fst(61,4-61,12)
(iff 
;; def=PrecedesRank.fst(30,56-30,62); use=PrecedesRank.fst(61,4-61,12)
(Valid 
;; def=PrecedesRank.fst(30,56-30,62); use=PrecedesRank.fst(61,4-61,12)
(Prims.precedes PrecedesRank.pack
Prims.int
(PrecedesRank.pid Dummy_value)
(PrecedesRank.bigrank_n @x0
(ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
...
;; def=PrecedesRank.fst(30,68-30,83); use=PrecedesRank.fst(61,4-61,12)
(< (BoxInt_proj_0 (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0)
PrecedesRank.pack)
(PrecedesRank.pid Dummy_value)))
...
;; def=Prims.fst(441,29-441,97); use=PrecedesRank.fst(62,2-62,8)
(and 
;; def=PrecedesRank.fst(62,9-62,20); use=PrecedesRank.fst(62,2-62,8)
(or label_5
...
;; def=PrecedesRank.fst(62,9-62,20); use=PrecedesRank.fst(62,2-62,8)
(Prims.precedes PrecedesRank.pack
(Tm_refine_afd45851fee572515110d6d74bd20903 @x0)
(PrecedesRank.pid Dummy_value)
(PrecedesRank.bigrank_n @x0
(ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x0)
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(62,2-62,8)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(63,2-63,10)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=PrecedesRank.fst(22,29-22,39); use=PrecedesRank.fst(63,2-63,10)
(Valid 
;; def=PrecedesRank.fst(22,29-22,39); use=PrecedesRank.fst(63,2-63,10)
(Prims.precedes Prims.int
PrecedesRank.pack
...
;; def=Prims.fst(451,66-451,102); use=PrecedesRank.fst(56,52-64,4)
(forall ((@x7 Term))
 (! (implies (HasType @x7
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=PrecedesRank.fst(56,52-64,4)
(Valid 
;; def=Prims.fst(451,90-451,102); use=PrecedesRank.fst(56,52-64,4)
(ApplyTT @x1
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (PrecedesRank.diag, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, PrecedesRank_interpretation_Tm_arrow_b62b4b876cae10c4c2e392fcd0f00431, PrecedesRank_pretyping_7f0fff55dd9ab045ef4964fc97f433be, Prims_pretyping_ae567c2fb75be05905677af440075565, data_elim_PrecedesRank.Mkras, equation_PrecedesRank.bigrank_n, equation_PrecedesRank.pid, fuel_guarded_inversion_PrecedesRank.ras, function_token_typing_Prims.__cache_version_number__, kinding_PrecedesRank.pack@tok, proj_equation_PrecedesRank.Mkras_rank, refinement_interpretation_Tm_refine_a949dfb718b32fd8ed52a101c1bfd3ad, token_correspondence_PrecedesRank.__proj__Mkras__item__rank, typing_PrecedesRank.bigrank_n, typing_PrecedesRank.pid
...
; encoding sigelt let diag


; <Start encoding let diag>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun PrecedesRank.diag (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun PrecedesRank.diag@tok () Term)

; </end encoding let diag>

(push) ;; push{2

; Starting query at PrecedesRank.fst(67,48-69,32)
...
;;;;;;;;;;;;;;;;r: ras -> FStar.Pervasives.Lemma (ensures Prims.l_False)
(declare-fun Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767
Tm_type)
:named kinding_Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=PrecedesRank.fst(68,13-68,42); use=PrecedesRank.fst(67,48-69,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767))
:qid PrecedesRank_pre_typing_Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767))

:named PrecedesRank_pre_typing_Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767
;;; Fact-ids: 
(assert (! 
;; def=PrecedesRank.fst(68,13-68,42); use=PrecedesRank.fst(67,48-69,32)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid PrecedesRank_interpretation_Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767))
:qid PrecedesRank_interpretation_Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767))

:named PrecedesRank_interpretation_Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767))
...
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         ~(exists (r: PrecedesRank.ras). Prims.l_True) ==> p pure_result) ==>
;     (forall (r: PrecedesRank.ras).
;         (*  - Could not prove post-condition
; *)
;         forall (p: Prims.pure_post Prims.unit) (pure_result: Prims.unit).
;           r.rank PrecedesRank.pid > r.rank PrecedesRank.pid ==> p pure_result) /\
;     (forall (any_result: (r: PrecedesRank.ras -> FStar.Pervasives.Lemma (ensures Prims.l_False)))
;         (pure_result: Prims.unit).
;         ((exists (x: PrecedesRank.ras). Prims.l_True) ==> Prims.l_False) ==> p pure_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let falso`
...
;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(67,48-69,32)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=PrecedesRank.fst(67,21-67,46); use=PrecedesRank.fst(67,48-69,32)
(or label_2

;; def=PrecedesRank.fst(67,21-67,46); use=PrecedesRank.fst(67,48-69,32)
(not 
;; def=PrecedesRank.fst(67,23-67,45); use=PrecedesRank.fst(67,48-69,32)
(exists ((@x3 Term))
 (! (HasType @x3
PrecedesRank.ras)
...
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(67,48-69,32)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(67,48-69,32)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=PrecedesRank.fst(67,48-69,32)
(and 
;; def=dummy(0,0-0,0); use=PrecedesRank.fst(67,48-69,32)
(forall ((@x2 Term))
 (! (implies (HasType @x2
PrecedesRank.ras)

;; def=Prims.fst(406,51-406,91); use=PrecedesRank.fst(67,48-69,32)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(68,45-68,51)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=PrecedesRank.fst(56,25-56,50); use=PrecedesRank.fst(68,45-68,49)
(> (BoxInt_proj_0 (ApplyTT (ApplyTT (ApplyTT PrecedesRank.__proj__Mkras__item__rank@tok
@x2)
PrecedesRank.pack)
(PrecedesRank.pid Dummy_value)))
...
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(68,45-68,51)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=PrecedesRank.fst(67,48-69,32)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Tm_arrow_ed25c6f2ca8160604abd71a81c2f1767)

;; def=Prims.fst(441,36-441,97); use=PrecedesRank.fst(69,12-69,28)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=FStar.Classical.fsti(367,12-367,40); use=PrecedesRank.fst(69,12-69,28)
(implies 
;; def=FStar.Classical.fsti(367,13-367,33); use=PrecedesRank.fst(69,12-69,28)
(exists ((@x4 Term))
 (! (HasType @x4
PrecedesRank.ras)
...
;; def=PrecedesRank.fst(68,36-68,41); use=PrecedesRank.fst(69,12-69,28)
false
)
)

;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(69,12-69,28)
(Valid 
;; def=Prims.fst(441,83-441,96); use=PrecedesRank.fst(69,12-69,28)
(ApplyTT @x1
@x3)
