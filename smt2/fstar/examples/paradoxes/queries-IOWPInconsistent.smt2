...
; Internals for IOWPInconsistent


; encoding sigelt #set-options "--__no_positivity"


; <Skipped #set-options "--__no_positivity"/>


; encoding sigelt let prop


; <Start encoding let prop>

(declare-fun IOWPInconsistent.prop () Term)
(declare-fun Tm_refine_a5a4b976760c8ff6c395fec345e05f6d () Term)

; </end encoding let prop>


; encoding sigelt type IOWPInconsistent.out_wp


; <Start encoding type IOWPInconsistent.out_wp>

;;;;;;;;;;;;;;;;Constructor
(declare-fun IOWPInconsistent.out_wp (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun IOWPInconsistent.out_wp@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun IOWPInconsistent.Intro (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun IOWPInconsistent.Intro_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun IOWPInconsistent.Intro__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: IOWPInconsistent.Intro
(declare-fun IOWPInconsistent.Intro@tok () Term)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.either (out_wp a) a -> prop
(declare-fun Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 (Term) Term)
;;;;;;;;;;;;;;;;_: (_: FStar.Pervasives.either (out_wp a) a -> prop) -> prop
(declare-fun Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417 (Term) Term)


;;;;;;;;;;;;;;;;_0: (_: (_: FStar.Pervasives.either (out_wp a) a -> prop) -> prop) -> out_wp a
(declare-fun Tm_arrow_9fda942efdada9351f73d7c8dcf7d130 () Term)

; <start constructor IOWPInconsistent.out_wp>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-IOWPInconsistent.out_wp ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
105)
(exists ((@x0 Term))
 (! (= __@x0
(IOWPInconsistent.out_wp @x0))
 
;;no pats
:qid is-IOWPInconsistent.out_wp))))

; </end constructor IOWPInconsistent.out_wp>


; <start constructor IOWPInconsistent.Intro>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-IOWPInconsistent.Intro ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
(IOWPInconsistent.Intro (IOWPInconsistent.Intro_a __@x0)
(IOWPInconsistent.Intro__0 __@x0)))))

; </end constructor IOWPInconsistent.Intro>


; </end encoding type IOWPInconsistent.out_wp>


; encoding sigelt val IOWPInconsistent.uu___is_Intro


; <Start encoding val IOWPInconsistent.uu___is_Intro>

(declare-fun IOWPInconsistent.uu___is_Intro (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: out_wp a -> Prims.bool
(declare-fun Tm_arrow_7ec87594255989d7271f75cd52bba416 () Term)
(declare-fun IOWPInconsistent.uu___is_Intro@tok () Term)

; </end encoding val IOWPInconsistent.uu___is_Intro>


; encoding sigelt let uu___is_Intro


; <Skipped let uu___is_Intro/>


; encoding sigelt val IOWPInconsistent.__proj__Intro__item___0


; <Start encoding val IOWPInconsistent.__proj__Intro__item___0>

(declare-fun IOWPInconsistent.__proj__Intro__item___0 (Term Term) Term)


;;;;;;;;;;;;;;;;projectee: out_wp a -> _: (_: FStar.Pervasives.either (out_wp a) a -> prop) -> prop
(declare-fun Tm_arrow_0c68a8f060c7ebf329046664607afa25 () Term)
(declare-fun IOWPInconsistent.__proj__Intro__item___0@tok () Term)



; </end encoding val IOWPInconsistent.__proj__Intro__item___0>


; encoding sigelt let __proj__Intro__item___0


; <Skipped let __proj__Intro__item___0/>


; encoding sigelt let intro_injective


; <Start encoding let intro_injective>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IOWPInconsistent.intro_injective (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IOWPInconsistent.intro_injective@tok () Term)

; </end encoding let intro_injective>
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name IOWPInconsistent.prop; Namespace IOWPInconsistent
(assert (! (HasType Tm_refine_a5a4b976760c8ff6c395fec345e05f6d
Tm_type)
:named refinement_kinding_Tm_refine_a5a4b976760c8ff6c395fec345e05f6d))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name IOWPInconsistent.prop; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(42,11-42,42); use=IOWPInconsistent.fst(42,11-42,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_a5a4b976760c8ff6c395fec345e05f6d)
(and (HasTypeFuel @u0
@x1
Tm_type)

;; def=IOWPInconsistent.fst(42,19-42,41); use=IOWPInconsistent.fst(42,19-42,41)
...
;; def=IOWPInconsistent.fst(42,35-42,41); use=IOWPInconsistent.fst(42,35-42,41)
(= @x2
@x3)
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_a5a4b976760c8ff6c395fec345e05f6d.1))
))
...
@x1
Tm_refine_a5a4b976760c8ff6c395fec345e05f6d))
:qid refinement_interpretation_Tm_refine_a5a4b976760c8ff6c395fec345e05f6d))

:named refinement_interpretation_Tm_refine_a5a4b976760c8ff6c395fec345e05f6d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_a5a4b976760c8ff6c395fec345e05f6d
;;; Fact-ids: Name IOWPInconsistent.prop; Namespace IOWPInconsistent
(assert (! (iff (Valid (Prims.hasEq Tm_refine_a5a4b976760c8ff6c395fec345e05f6d))
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_a5a4b976760c8ff6c395fec345e05f6d))
...
; Starting query at IOWPInconsistent.fst(53,39-53,60)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Type).
;   (*  - Could not prove post-condition
; *)
;   forall (x0: x) (y0: x).
;     (*  - Could not prove post-condition
; *) forall (x: x0 == y0) (y: x0 == y0). x == y


; Context: While encoding a query
; While typechecking the top-level declaration `let inj`
...
;; def=dummy(0,0-0,0); use=IOWPInconsistent.fst(53,39-53,60)
...
;; def=IOWPInconsistent.fst(42,19-42,41); use=IOWPInconsistent.fst(53,52-53,60)
...
;; def=IOWPInconsistent.fst(42,35-42,41); use=IOWPInconsistent.fst(53,52-53,60)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IOWPInconsistent.inj, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eq2, equation_Prims.squash, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c, unit_inversion
...
; encoding sigelt let inj


; <Start encoding let inj>

(declare-fun IOWPInconsistent.inj (Term) Term)
;;;;;;;;;;;;;;;;_: x -> prop
(declare-fun Tm_arrow_485b2477f1f17069934d13f934511424 (Term) Term)
;;;;;;;;;;;;;;;;_: x -> _: x -> prop
(declare-fun Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1 (Term) Term)
;;;;;;;;;;;;;;;;_: x -> _: x -> prop
(declare-fun Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df () Term)
(declare-fun IOWPInconsistent.inj@tok () Term)


;;;;;;;;;;;;;;;;x0: x -> y0: x -> prop
(declare-fun Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05 (Term) Term)
(declare-fun Tm_abs_a918fb8b14539788a7a532dc6f6a04a3 (Term) Term)

; </end encoding let inj>
...
;;;;;;;;;;;;;;;;typing_Tm_abs_a918fb8b14539788a7a532dc6f6a04a3
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,52-53,60); use=IOWPInconsistent.fst(53,52-53,60)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_a918fb8b14539788a7a532dc6f6a04a3 @x0)
(Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05 @x0))
 

:pattern ((Tm_abs_a918fb8b14539788a7a532dc6f6a04a3 @x0))
:qid typing_Tm_abs_a918fb8b14539788a7a532dc6f6a04a3))

:named typing_Tm_abs_a918fb8b14539788a7a532dc6f6a04a3))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IOWPInconsistent.prop; Namespace IOWPInconsistent
(assert (! (HasType IOWPInconsistent.prop
Tm_type)
:named typing_IOWPInconsistent.prop))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,4-53,7); use=IOWPInconsistent.fst(53,4-53,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (IOWPInconsistent.inj @x0)
(Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1 @x0)))
 

:pattern ((IOWPInconsistent.inj @x0))
:qid typing_IOWPInconsistent.inj))

:named typing_IOWPInconsistent.inj))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;; def=IOWPInconsistent.fst(53,4-53,7); use=IOWPInconsistent.fst(53,4-53,7)
(forall ((@x0 Term))
 (! (= (ApplyTT IOWPInconsistent.inj@tok
@x0)
(IOWPInconsistent.inj @x0))
 

:pattern ((ApplyTT IOWPInconsistent.inj@tok
@x0))
:qid token_correspondence_IOWPInconsistent.inj))

:named token_correspondence_IOWPInconsistent.inj))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.pure_post'; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,20-53,35)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05 @x0)
Tm_type))
:qid kinding_Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05))

:named kinding_Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_485b2477f1f17069934d13f934511424
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,26-53,35)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_485b2477f1f17069934d13f934511424 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_485b2477f1f17069934d13f934511424 @x0)
Tm_type))
:qid kinding_Tm_arrow_485b2477f1f17069934d13f934511424))

:named kinding_Tm_arrow_485b2477f1f17069934d13f934511424))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,20-53,35)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1 @x0)
Tm_type))
:qid kinding_Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1))

:named kinding_Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! (HasType Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df
Tm_type)
:named kinding_Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (HasType Prims.trivial
Tm_type)
:named kinding_Prims.trivial@tok))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_a918fb8b14539788a7a532dc6f6a04a3
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,52-53,60); use=IOWPInconsistent.fst(53,52-53,60)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_a918fb8b14539788a7a532dc6f6a04a3 @x2)
@x0)
@x1)
(Prims.eq2 @x2
@x0
...
:pattern ((ApplyTT (ApplyTT (Tm_abs_a918fb8b14539788a7a532dc6f6a04a3 @x2)
@x0)
@x1))
:qid interpretation_Tm_abs_a918fb8b14539788a7a532dc6f6a04a3))

:named interpretation_Tm_abs_a918fb8b14539788a7a532dc6f6a04a3))
...
(assert (! (HasType IOWPInconsistent.prop
Tm_type)
:named function_token_typing_IOWPInconsistent.prop))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,4-53,7); use=IOWPInconsistent.fst(53,4-53,7)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType IOWPInconsistent.inj@tok
Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df))

;; def=IOWPInconsistent.fst(53,4-53,7); use=IOWPInconsistent.fst(53,4-53,7)
(forall ((@x1 Term))
 (! (= (ApplyTT IOWPInconsistent.inj@tok
@x1)
(IOWPInconsistent.inj @x1))
 

:pattern ((IOWPInconsistent.inj @x1))
:qid function_token_typing_IOWPInconsistent.inj.1))
)
 

:pattern ((ApplyTT @x0
IOWPInconsistent.inj@tok))
:qid function_token_typing_IOWPInconsistent.inj))

:named function_token_typing_IOWPInconsistent.inj))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;Equation for IOWPInconsistent.prop
;;; Fact-ids: Name IOWPInconsistent.prop; Namespace IOWPInconsistent
(assert (! (= IOWPInconsistent.prop
Tm_refine_a5a4b976760c8ff6c395fec345e05f6d)
:named equation_IOWPInconsistent.prop))
;;;;;;;;;;;;;;;;Equation for IOWPInconsistent.inj
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,4-53,7); use=IOWPInconsistent.fst(53,4-53,7)
(forall ((@x0 Term))
 (! (= (IOWPInconsistent.inj @x0)
(Tm_abs_a918fb8b14539788a7a532dc6f6a04a3 @x0))
 

:pattern ((IOWPInconsistent.inj @x0))
:qid equation_IOWPInconsistent.inj))

:named equation_IOWPInconsistent.inj))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05 @x2)))
:qid IOWPInconsistent_pre_typing_Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05))

:named IOWPInconsistent_pre_typing_Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,26-53,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_485b2477f1f17069934d13f934511424 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_485b2477f1f17069934d13f934511424 @x2)))
:qid IOWPInconsistent_pre_typing_Tm_arrow_485b2477f1f17069934d13f934511424))

:named IOWPInconsistent_pre_typing_Tm_arrow_485b2477f1f17069934d13f934511424))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,20-53,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1 @x2)))
:qid IOWPInconsistent_pre_typing_Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1))

:named IOWPInconsistent_pre_typing_Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,12-53,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df)
...
@x1
Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df))
:qid IOWPInconsistent_pre_typing_Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df))

:named IOWPInconsistent_pre_typing_Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,20-53,35)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05 @x1))
(and 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,20-53,35)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
...
@x2)
@x3))
:qid IOWPInconsistent_interpretation_Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid IOWPInconsistent_interpretation_Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05 @x1)))
:qid IOWPInconsistent_interpretation_Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05))

:named IOWPInconsistent_interpretation_Tm_arrow_f2ee0e1d075b4cf93fdad7d7c2d71b05))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_485b2477f1f17069934d13f934511424
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,26-53,35)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_485b2477f1f17069934d13f934511424 @x1))
(and 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,26-53,35)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid IOWPInconsistent_interpretation_Tm_arrow_485b2477f1f17069934d13f934511424.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_485b2477f1f17069934d13f934511424 @x1)))
:qid IOWPInconsistent_interpretation_Tm_arrow_485b2477f1f17069934d13f934511424))

:named IOWPInconsistent_interpretation_Tm_arrow_485b2477f1f17069934d13f934511424))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,20-53,35)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1 @x1))
(and 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,20-53,35)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid IOWPInconsistent_interpretation_Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1 @x1)))
:qid IOWPInconsistent_interpretation_Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1))

:named IOWPInconsistent_interpretation_Tm_arrow_116b7454a4d50b8a3cfbc27131d350a1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df
;;; Fact-ids: Name IOWPInconsistent.inj; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(53,10-53,35); use=IOWPInconsistent.fst(53,12-53,35)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid IOWPInconsistent_interpretation_Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df))
:qid IOWPInconsistent_interpretation_Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df))

:named IOWPInconsistent_interpretation_Tm_arrow_0425f83a7a7d5fa6d1c974049c98c5df))
(push) ;; push{2

; Starting query at IOWPInconsistent.fst(58,2-59,21)
...
IOWPInconsistent.inj@tok))
:named @kick_partial_app_debd42c9849b30cee1248d6a1c100c09))
...
; Encoding query formula : forall (x: Type) (x0: x) (x0': x).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     IOWPInconsistent.inj x0 == IOWPInconsistent.inj x0' /\
;     (forall (pure_result: Prims.unit). x0 == x0' ==> p pure_result) ==>
;     IOWPInconsistent.inj x0 x0 /\
;     (forall (pure_result: Prims.unit).
;         IOWPInconsistent.inj x0 x0 ==>
;         IOWPInconsistent.inj x0' x0 /\
;         (forall (pure_result: Prims.unit). IOWPInconsistent.inj x0' x0 ==> p pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let inj_injective`
...
;; def=IOWPInconsistent.fst(56,20-56,39); use=IOWPInconsistent.fst(58,2-59,21)
(= (ApplyTT (ApplyTT IOWPInconsistent.inj@tok
@x0)
@x1)
(ApplyTT (ApplyTT IOWPInconsistent.inj@tok
@x0)
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(58,2-59,21)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=IOWPInconsistent.fst(57,20-57,31); use=IOWPInconsistent.fst(58,2-59,21)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(58,2-59,21)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(58,2-59,21)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,29-441,97); use=IOWPInconsistent.fst(58,2-58,8)
(and 
;; def=IOWPInconsistent.fst(58,9-58,20); use=IOWPInconsistent.fst(58,2-58,8)
(or label_3

;; def=IOWPInconsistent.fst(58,9-58,20); use=IOWPInconsistent.fst(58,2-58,8)
(Valid 
;; def=IOWPInconsistent.fst(58,9-58,20); use=IOWPInconsistent.fst(58,2-58,8)
(ApplyTT (ApplyTT (ApplyTT IOWPInconsistent.inj@tok
@x0)
@x1)
@x1)
)
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(58,2-58,8)
(forall ((@x4 Term))
...
;; def=Prims.fst(441,29-441,97); use=IOWPInconsistent.fst(59,2-59,8)
(and 
;; def=IOWPInconsistent.fst(59,9-59,21); use=IOWPInconsistent.fst(59,2-59,8)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(59,2-59,8)
(forall ((@x5 Term))
...
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(59,2-59,8)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(59,2-59,8)
(ApplyTT @x3
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IOWPInconsistent.inj_injective, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, eq2-interp, equation_IOWPInconsistent.inj, interpretation_Tm_abs_a918fb8b14539788a7a532dc6f6a04a3, token_correspondence_IOWPInconsistent.inj
...
; encoding sigelt let inj_injective


; <Start encoding let inj_injective>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IOWPInconsistent.inj_injective (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IOWPInconsistent.inj_injective@tok () Term)

; </end encoding let inj_injective>


; encoding sigelt let f


; <Start encoding let f>


(declare-fun IOWPInconsistent.f (Term Term) Term)

;;;;;;;;;;;;;;;;p: (_: FStar.Pervasives.either (out_wp a) a -> prop) -> FStar.Pervasives.either (out_wp a) a
(declare-fun Tm_arrow_1af30449de3aaa9bdbd8909e091836a5 () Term)
(declare-fun IOWPInconsistent.f@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IOWPInconsistent.f; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(61,4-61,5); use=IOWPInconsistent.fst(61,4-61,5)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x0)))
(HasType (IOWPInconsistent.f @x0
@x1)
(FStar.Pervasives.either (IOWPInconsistent.out_wp @x0)
@x0)))
 

:pattern ((IOWPInconsistent.f @x0
@x1))
:qid typing_IOWPInconsistent.f))

:named typing_IOWPInconsistent.f))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(44,10-44,16); use=IOWPInconsistent.fst(44,10-44,16)
(forall ((@x0 Term))
 (! (= (ApplyTT IOWPInconsistent.out_wp@tok
@x0)
(IOWPInconsistent.out_wp @x0))
 

:pattern ((ApplyTT IOWPInconsistent.out_wp@tok
@x0))

:pattern ((IOWPInconsistent.out_wp @x0))
:qid token_correspondence_IOWPInconsistent.out_wp@tok))

:named token_correspondence_IOWPInconsistent.out_wp@tok))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(45,4-45,9); use=IOWPInconsistent.fst(45,4-45,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(IOWPInconsistent.Intro @x1
@x2)
(IOWPInconsistent.out_wp @x3))
...
@x2)
(IOWPInconsistent.out_wp @x3)))
:qid subterm_ordering_IOWPInconsistent.Intro))

:named subterm_ordering_IOWPInconsistent.Intro))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
(assert (! 
...
;; def=IOWPInconsistent.fst(45,4-45,9); use=IOWPInconsistent.fst(45,4-45,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (IOWPInconsistent.Intro_a (IOWPInconsistent.Intro @x0
@x1))
@x0)
 

:pattern ((IOWPInconsistent.Intro @x0
@x1))
:qid projection_inverse_IOWPInconsistent.Intro_a))

:named projection_inverse_IOWPInconsistent.Intro_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(45,4-45,9); use=IOWPInconsistent.fst(45,4-45,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (IOWPInconsistent.Intro__0 (IOWPInconsistent.Intro @x0
@x1))
@x1)
...
:pattern ((IOWPInconsistent.Intro @x0
@x1))
:qid projection_inverse_IOWPInconsistent.Intro__0))

:named projection_inverse_IOWPInconsistent.Intro__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(732,4-732,7); use=FStar.Pervasives.fsti(732,4-732,7)
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! (is-Tm_arrow (PreType IOWPInconsistent.out_wp@tok))
:named pre_kinding_IOWPInconsistent.out_wp@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
(assert (! (is-Tm_arrow (PreType FStar.Pervasives.either@tok))
:named pre_kinding_FStar.Pervasives.either@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_95fe26a97d19951315ce73c0c69f9af3
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(45,14-45,41); use=IOWPInconsistent.fst(45,14-45,41)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x0)
Tm_type))
:qid kinding_Tm_arrow_95fe26a97d19951315ce73c0c69f9af3))

:named kinding_Tm_arrow_95fe26a97d19951315ce73c0c69f9af3))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(45,14-45,50); use=IOWPInconsistent.fst(45,14-45,50)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417 @x0)
Tm_type))
:qid kinding_Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417))

:named kinding_Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417))
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! (and (IsTotFun IOWPInconsistent.out_wp@tok)

;; def=IOWPInconsistent.fst(44,10-44,16); use=IOWPInconsistent.fst(44,10-44,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (IOWPInconsistent.out_wp @x0)
Tm_type))
 

:pattern ((IOWPInconsistent.out_wp @x0))
:qid kinding_IOWPInconsistent.out_wp@tok))
)
:named kinding_IOWPInconsistent.out_wp@tok))
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(IOWPInconsistent.out_wp @x2))
(and (is-IOWPInconsistent.Intro @x1)
(= @x2
(IOWPInconsistent.Intro_a @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(IOWPInconsistent.out_wp @x2)))
:qid fuel_guarded_inversion_IOWPInconsistent.out_wp))

:named fuel_guarded_inversion_IOWPInconsistent.out_wp))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(730,5-730,11); use=FStar.Pervasives.fsti(730,5-730,11)
...
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! (= 106
(Term_constr_id IOWPInconsistent.out_wp@tok))
:named fresh_token_IOWPInconsistent.out_wp@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
(assert (! (= 403
(Term_constr_id FStar.Pervasives.either@tok))
:named fresh_token_FStar.Pervasives.either@tok))
;;;;;;;;;;;;;;;;Equation for IOWPInconsistent.f
;;; Fact-ids: Name IOWPInconsistent.f; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(61,4-61,5); use=IOWPInconsistent.fst(61,4-61,5)
(forall ((@x0 Term) (@x1 Term))
 (! (= (IOWPInconsistent.f @x0
@x1)
(FStar.Pervasives.Inl (IOWPInconsistent.out_wp @x0)
@x0
(IOWPInconsistent.Intro @x0
(ApplyTT (ApplyTT IOWPInconsistent.inj@tok
(Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x0))
@x1))))
...
:pattern ((IOWPInconsistent.f @x0
@x1))
:qid equation_IOWPInconsistent.f))

:named equation_IOWPInconsistent.f))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(45,4-45,9); use=IOWPInconsistent.fst(45,4-45,9)
...
(HasTypeFuel @u0
@x2
(Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417 @x1)))
(HasTypeFuel @u0
(IOWPInconsistent.Intro @x1
@x2)
(IOWPInconsistent.out_wp @x1)))
...
@x2)
(IOWPInconsistent.out_wp @x1)))
:qid data_typing_intro_IOWPInconsistent.Intro@tok))

:named data_typing_intro_IOWPInconsistent.Intro@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(732,4-732,7); use=FStar.Pervasives.fsti(732,4-732,7)
...
(HasTypeFuel @u0
@x2
(Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417 @x3))))
...
@x2)
(IOWPInconsistent.out_wp @x3)))
:qid data_elim_IOWPInconsistent.Intro))

:named data_elim_IOWPInconsistent.Intro))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(732,4-732,7); use=FStar.Pervasives.fsti(732,4-732,7)
...
(forall ((@x0 Term))
 (! (= 105
(Term_constr_id (IOWPInconsistent.out_wp @x0)))
 

:pattern ((IOWPInconsistent.out_wp @x0))
:qid constructor_distinct_IOWPInconsistent.out_wp))

:named constructor_distinct_IOWPInconsistent.out_wp))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(45,4-45,9); use=IOWPInconsistent.fst(45,4-45,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= 116
(Term_constr_id (IOWPInconsistent.Intro @x0
@x1)))
 

:pattern ((IOWPInconsistent.Intro @x0
@x1))
:qid constructor_distinct_IOWPInconsistent.Intro))

:named constructor_distinct_IOWPInconsistent.Intro))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(730,5-730,11); use=FStar.Pervasives.fsti(730,5-730,11)
...
@x0
(IOWPInconsistent.out_wp @x2)))
:qid IOWPInconsistent_pretyping_56fae3e6a0f4a3175e119046adc4627c))

:named IOWPInconsistent_pretyping_56fae3e6a0f4a3175e119046adc4627c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(45,14-45,41); use=IOWPInconsistent.fst(45,14-45,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x2)))
:qid IOWPInconsistent_pre_typing_Tm_arrow_95fe26a97d19951315ce73c0c69f9af3))

:named IOWPInconsistent_pre_typing_Tm_arrow_95fe26a97d19951315ce73c0c69f9af3))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(45,14-45,50); use=IOWPInconsistent.fst(45,14-45,50)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417 @x2)))
:qid IOWPInconsistent_pre_typing_Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417))

:named IOWPInconsistent_pre_typing_Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_95fe26a97d19951315ce73c0c69f9af3
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(45,14-45,41); use=IOWPInconsistent.fst(45,14-45,41)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x1))
(and 
;; def=IOWPInconsistent.fst(45,14-45,41); use=IOWPInconsistent.fst(45,14-45,41)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.Pervasives.either (IOWPInconsistent.out_wp @x1)
@x1))
(HasType (ApplyTT @x0
@x2)
IOWPInconsistent.prop))
...
:pattern ((ApplyTT @x0
@x2))
:qid IOWPInconsistent_interpretation_Tm_arrow_95fe26a97d19951315ce73c0c69f9af3.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x1)))
:qid IOWPInconsistent_interpretation_Tm_arrow_95fe26a97d19951315ce73c0c69f9af3))

:named IOWPInconsistent_interpretation_Tm_arrow_95fe26a97d19951315ce73c0c69f9af3))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417
;;; Fact-ids: Name IOWPInconsistent.out_wp; Namespace IOWPInconsistent; Name IOWPInconsistent.Intro; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(45,14-45,50); use=IOWPInconsistent.fst(45,14-45,50)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid IOWPInconsistent_interpretation_Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417 @x1)))
:qid IOWPInconsistent_interpretation_Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417))

:named IOWPInconsistent_interpretation_Tm_arrow_5579d0233ecc1fbbd5e34288cb2bc417))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(730,5-730,11); use=FStar.Pervasives.fsti(730,5-730,11)
...
; Starting query at IOWPInconsistent.fst(67,2-68,34)
...
;   (p: (_: FStar.Pervasives.either (IOWPInconsistent.out_wp a) a -> IOWPInconsistent.prop))
;   (p': (_: FStar.Pervasives.either (IOWPInconsistent.out_wp a) a -> IOWPInconsistent.prop)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     IOWPInconsistent.f p == IOWPInconsistent.f p' /\
;     (forall (pure_result: Prims.unit). p == p' ==> p pure_result) ==>
;     IOWPInconsistent.inj p == IOWPInconsistent.inj p' /\
;     (forall (pure_result: Prims.unit).
;         p == p' ==> (forall (pure_result: Prims.unit). Prims.auto_squash (p pure_result)))


; Context: While encoding a query
; While typechecking the top-level declaration `let f_injective`
...
;; def=IOWPInconsistent.fst(65,20-65,33); use=IOWPInconsistent.fst(67,2-68,34)
(= (IOWPInconsistent.f @x0
@x1)
(IOWPInconsistent.f @x0
@x2))
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(67,2-68,34)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=IOWPInconsistent.fst(66,20-66,29); use=IOWPInconsistent.fst(67,2-68,34)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(67,2-68,34)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(67,2-68,34)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,29-441,97); use=IOWPInconsistent.fst(67,2-67,15)
(and 
;; def=IOWPInconsistent.fst(56,20-56,39); use=IOWPInconsistent.fst(67,2-67,15)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(67,2-67,15)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=IOWPInconsistent.fst(57,20-57,31); use=IOWPInconsistent.fst(67,2-67,15)
(= @x1
@x2)
)

;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(68,2-68,17)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.unit)

;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(68,2-68,17)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(68,2-68,17)
(ApplyTT @x3
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IOWPInconsistent.f_injective, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_IOWPInconsistent.f, projection_inverse_FStar.Pervasives.Inl_v, projection_inverse_IOWPInconsistent.Intro__0
...
; encoding sigelt let f_injective


; <Start encoding let f_injective>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IOWPInconsistent.f_injective (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IOWPInconsistent.f_injective@tok () Term)

; </end encoding let f_injective>
...
; Starting query at IOWPInconsistent.fst(71,2-72,25)

(declare-fun label_1 () Bool)



;;;;;;;;;;;;;;;;p: (_: FStar.Pervasives.either (out_wp a) a -> prop) -> Prims.GTot Type
(declare-fun Tm_arrow_888443e6e5e9eeb40c32e45451290d3e (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(71,12-71,39); use=IOWPInconsistent.fst(71,9-71,40)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_888443e6e5e9eeb40c32e45451290d3e @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_888443e6e5e9eeb40c32e45451290d3e @x0)
Tm_type))
:qid kinding_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e))

:named kinding_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(71,12-71,39); use=IOWPInconsistent.fst(71,9-71,40)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_888443e6e5e9eeb40c32e45451290d3e @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_888443e6e5e9eeb40c32e45451290d3e @x2)))
:qid IOWPInconsistent_pre_typing_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e))

:named IOWPInconsistent_pre_typing_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(71,12-71,39); use=IOWPInconsistent.fst(71,9-71,40)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_888443e6e5e9eeb40c32e45451290d3e @x1))
(and 
;; def=IOWPInconsistent.fst(71,12-71,39); use=IOWPInconsistent.fst(71,9-71,40)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid IOWPInconsistent_interpretation_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_888443e6e5e9eeb40c32e45451290d3e @x1)))
:qid IOWPInconsistent_interpretation_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e))

:named IOWPInconsistent_interpretation_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e))
(declare-fun Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(71,2-72,25); use=IOWPInconsistent.fst(71,2-72,25)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622 @x0
@x1)
(Tm_arrow_888443e6e5e9eeb40c32e45451290d3e @x1))
 

:pattern ((Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622 @x0
@x1))
:qid typing_Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622))

:named typing_Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(71,2-72,25); use=IOWPInconsistent.fst(71,2-72,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622 @x1
@x2)
@x0)
(Prims.l_and (Prims.eq2 (FStar.Pervasives.either (IOWPInconsistent.out_wp @x2)
@x2)
(IOWPInconsistent.f @x2
@x0)
@x1)
(Prims.l_not (ApplyTT @x0
@x1))))
 

:pattern ((ApplyTT (Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622))

:named interpretation_Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622))
...
;; def=IOWPInconsistent.fst(71,2-72,25); use=IOWPInconsistent.fst(71,2-72,25)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.l_Exists (Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x1)
(Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622 @x0
@x1)))
...
;; def=IOWPInconsistent.fst(72,4-72,15); use=IOWPInconsistent.fst(72,4-72,15)
(= (IOWPInconsistent.f @x1
@x2)
@x0)


;; def=IOWPInconsistent.fst(72,19-72,25); use=IOWPInconsistent.fst(72,19-72,25)
(not 
;; def=IOWPInconsistent.fst(72,20-72,25); use=IOWPInconsistent.fst(72,20-72,25)
(Valid 
;; def=IOWPInconsistent.fst(72,20-72,25); use=IOWPInconsistent.fst(72,20-72,25)
(ApplyTT @x2
@x0)
...
;;no pats
:qid l_quant_interp_3d5f610aa0975e34cfaa0a7c62d6f069.1))
)
 

:pattern ((Valid (Prims.l_Exists (Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x1)
(Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622 @x0
@x1))))
:qid l_quant_interp_3d5f610aa0975e34cfaa0a7c62d6f069))

:named l_quant_interp_3d5f610aa0975e34cfaa0a7c62d6f069))
...
; Encoding query formula : forall (a: Type) (x: FStar.Pervasives.either (IOWPInconsistent.out_wp a) a).
;   (*  - Could not prove post-condition
; *)
;   forall (x:
;     (exists (p: (_: FStar.Pervasives.either (IOWPInconsistent.out_wp a) a -> IOWPInconsistent.prop))
;       .
;         IOWPInconsistent.f p == x /\ ~(p x)))
;     (y:
;     (exists (p: (_: FStar.Pervasives.either (IOWPInconsistent.out_wp a) a -> IOWPInconsistent.prop))
;       .
;         IOWPInconsistent.f p == x /\ ~(p x))).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let p0`
...
;; def=IOWPInconsistent.fst(42,19-42,41); use=IOWPInconsistent.fst(71,2-72,25)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
(Prims.l_Exists (Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x0)
(Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622 @x1
@x0)))
(HasType @x3
(Prims.l_Exists (Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x0)
(Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622 @x1
...
;; def=IOWPInconsistent.fst(42,35-42,41); use=IOWPInconsistent.fst(71,2-72,25)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IOWPInconsistent.p0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.l_Exists, equation_Prims.squash, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c, unit_inversion
...
; encoding sigelt let p0


; <Start encoding let p0>

(declare-fun IOWPInconsistent.p0 (Term Term) Term)
;;;;;;;;;;;;;;;;x: FStar.Pervasives.either (out_wp a) a -> prop
(declare-fun Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51 () Term)
(declare-fun IOWPInconsistent.p0@tok () Term)
...
; encoding sigelt let x0


; <Start encoding let x0>

(declare-fun IOWPInconsistent.x0 (Term) Term)
;;;;;;;;;;;;;;;;FStar.Pervasives.either (out_wp a) a
(declare-fun Tm_arrow_1354b0080a7f4d76b2695b9d6f5a7378 () Term)
(declare-fun IOWPInconsistent.x0@tok () Term)

; </end encoding let x0>

;;;;;;;;;;;;;;;;typing_Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(71,2-72,25); use=IOWPInconsistent.fst(71,2-72,25)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622 @x0
...
:named typing_Tm_abs_dfe6d44e7cf3bf49b6315cf26891b622))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IOWPInconsistent.x0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(73,4-73,6); use=IOWPInconsistent.fst(73,4-73,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (IOWPInconsistent.x0 @x0)
(FStar.Pervasives.either (IOWPInconsistent.out_wp @x0)
@x0)))
 

:pattern ((IOWPInconsistent.x0 @x0))
:qid typing_IOWPInconsistent.x0))

:named typing_IOWPInconsistent.x0))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(70,4-70,6); use=IOWPInconsistent.fst(70,4-70,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(FStar.Pervasives.either (IOWPInconsistent.out_wp @x0)
@x0)))
(HasType (IOWPInconsistent.p0 @x0
@x1)
IOWPInconsistent.prop))
 

:pattern ((IOWPInconsistent.p0 @x0
@x1))
:qid typing_IOWPInconsistent.p0))

:named typing_IOWPInconsistent.p0))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(70,4-70,6); use=IOWPInconsistent.fst(70,4-70,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT IOWPInconsistent.p0@tok
@x0)
@x1)
(IOWPInconsistent.p0 @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT IOWPInconsistent.p0@tok
@x0)
@x1))
:qid token_correspondence_IOWPInconsistent.p0))

:named token_correspondence_IOWPInconsistent.p0))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(71,2-72,25); use=IOWPInconsistent.fst(71,2-72,25)
...
:named l_quant_interp_3d5f610aa0975e34cfaa0a7c62d6f069))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! (HasType Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51
Tm_type)
:named kinding_Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(71,12-71,39); use=IOWPInconsistent.fst(71,9-71,40)
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType IOWPInconsistent.p0@tok
Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51))
...
@x1)
@x2)
(IOWPInconsistent.p0 @x1
@x2))
 

:pattern ((IOWPInconsistent.p0 @x1
@x2))
:qid function_token_typing_IOWPInconsistent.p0.1))
)
 

:pattern ((ApplyTT @x0
IOWPInconsistent.p0@tok))
:qid function_token_typing_IOWPInconsistent.p0))

:named function_token_typing_IOWPInconsistent.p0))
;;;;;;;;;;;;;;;;Equation for IOWPInconsistent.x0
;;; Fact-ids: Name IOWPInconsistent.x0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(73,4-73,6); use=IOWPInconsistent.fst(73,4-73,6)
(forall ((@x0 Term))
 (! (= (IOWPInconsistent.x0 @x0)
(IOWPInconsistent.f @x0
(ApplyTT IOWPInconsistent.p0@tok
@x0)))
 

:pattern ((IOWPInconsistent.x0 @x0))
:qid equation_IOWPInconsistent.x0))

:named equation_IOWPInconsistent.x0))
;;;;;;;;;;;;;;;;Equation for IOWPInconsistent.p0
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(70,4-70,6); use=IOWPInconsistent.fst(70,4-70,6)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((IOWPInconsistent.p0 @x0
@x1))
:qid equation_IOWPInconsistent.p0))

:named equation_IOWPInconsistent.p0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(70,12-70,47); use=IOWPInconsistent.fst(70,12-70,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51)
...
@x1
Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51))
:qid IOWPInconsistent_pre_typing_Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51))

:named IOWPInconsistent_pre_typing_Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(71,12-71,39); use=IOWPInconsistent.fst(71,9-71,40)
...
:named IOWPInconsistent_pre_typing_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(70,12-70,47); use=IOWPInconsistent.fst(70,12-70,47)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid IOWPInconsistent_interpretation_Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid IOWPInconsistent_interpretation_Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51))
:qid IOWPInconsistent_interpretation_Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51))

:named IOWPInconsistent_interpretation_Tm_arrow_f84dd8412cc1f0a34c9cd3ee37760d51))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_888443e6e5e9eeb40c32e45451290d3e
;;; Fact-ids: Name IOWPInconsistent.p0; Namespace IOWPInconsistent
(assert (! 
;; def=IOWPInconsistent.fst(71,12-71,39); use=IOWPInconsistent.fst(71,9-71,40)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
IOWPInconsistent.p0@tok))
:named @kick_partial_app_be96ba8dd0462f19944a0980280ed7c0))
(push) ;; push{2

; Starting query at IOWPInconsistent.fst(79,38-84,71)
...
(declare-fun Tm_refine_6725bf085bac499ccfe650045e02384d (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(80,10-80,75); use=IOWPInconsistent.fst(80,10-80,75)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_6725bf085bac499ccfe650045e02384d @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_6725bf085bac499ccfe650045e02384d @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_6725bf085bac499ccfe650045e02384d))

:named refinement_kinding_Tm_refine_6725bf085bac499ccfe650045e02384d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(80,10-80,75); use=IOWPInconsistent.fst(80,10-80,75)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6725bf085bac499ccfe650045e02384d @x2))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x2))

;; def=IOWPInconsistent.fst(80,43-80,57); use=IOWPInconsistent.fst(80,43-80,57)
(= (IOWPInconsistent.f @x2
@x1)
(IOWPInconsistent.x0 @x2))


;; def=IOWPInconsistent.fst(80,61-80,73); use=IOWPInconsistent.fst(80,61-80,73)
(not 
;; def=IOWPInconsistent.fst(80,62-80,73); use=IOWPInconsistent.fst(80,62-80,73)
(Valid 
;; def=IOWPInconsistent.fst(80,62-80,73); use=IOWPInconsistent.fst(80,62-80,73)
(ApplyTT @x1
(IOWPInconsistent.x0 @x2))
...
@x1
(Tm_refine_6725bf085bac499ccfe650045e02384d @x2)))
:qid refinement_interpretation_Tm_refine_6725bf085bac499ccfe650045e02384d))

:named refinement_interpretation_Tm_refine_6725bf085bac499ccfe650045e02384d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6725bf085bac499ccfe650045e02384d
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(80,10-80,75); use=IOWPInconsistent.fst(80,10-80,75)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6725bf085bac499ccfe650045e02384d @x0)))
(Valid (Prims.hasEq (Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6725bf085bac499ccfe650045e02384d @x0))))
:qid haseqTm_refine_6725bf085bac499ccfe650045e02384d))

:named haseqTm_refine_6725bf085bac499ccfe650045e02384d))




(declare-fun Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(81,19-81,34); use=IOWPInconsistent.fst(79,38-84,71)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c))

:named refinement_kinding_Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(81,19-81,34); use=IOWPInconsistent.fst(79,38-84,71)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=IOWPInconsistent.fst(81,19-81,34); use=IOWPInconsistent.fst(79,38-84,71)
(not 
;; def=IOWPInconsistent.fst(81,21-81,33); use=IOWPInconsistent.fst(79,38-84,71)
(Valid 
;; def=IOWPInconsistent.fst(81,21-81,33); use=IOWPInconsistent.fst(79,38-84,71)
(IOWPInconsistent.p0 @x2
(IOWPInconsistent.x0 @x2))
)
)
))
...
@x1
(Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c @x2)))
:qid refinement_interpretation_Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c))

:named refinement_interpretation_Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(81,19-81,34); use=IOWPInconsistent.fst(79,38-84,71)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c @x0))))
:qid haseqTm_refine_725aef195f27e6fbc7a6e56ef6eae75c))

:named haseqTm_refine_725aef195f27e6fbc7a6e56ef6eae75c))
;;;;;;;;;;;;;;;;p: (_: FStar.Pervasives.either (out_wp a) a -> prop){f p == x0 /\ ~(p x0)}   -> Prims.GTot (Prims.squash (~(p0 x0)))
(declare-fun Tm_arrow_1162fffd6dc721b75dc80effffb72f62 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1162fffd6dc721b75dc80effffb72f62
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(80,10-81,35); use=IOWPInconsistent.fst(79,38-84,71)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_1162fffd6dc721b75dc80effffb72f62 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_1162fffd6dc721b75dc80effffb72f62 @x0)
Tm_type))
:qid kinding_Tm_arrow_1162fffd6dc721b75dc80effffb72f62))

:named kinding_Tm_arrow_1162fffd6dc721b75dc80effffb72f62))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(80,10-81,35); use=IOWPInconsistent.fst(79,38-84,71)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_1162fffd6dc721b75dc80effffb72f62 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_1162fffd6dc721b75dc80effffb72f62 @x2)))
:qid IOWPInconsistent_pre_typing_Tm_arrow_1162fffd6dc721b75dc80effffb72f62))

:named IOWPInconsistent_pre_typing_Tm_arrow_1162fffd6dc721b75dc80effffb72f62))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1162fffd6dc721b75dc80effffb72f62
;;; Fact-ids: 
(assert (! 
;; def=IOWPInconsistent.fst(80,10-81,35); use=IOWPInconsistent.fst(79,38-84,71)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_1162fffd6dc721b75dc80effffb72f62 @x1))
(and 
;; def=IOWPInconsistent.fst(80,10-81,35); use=IOWPInconsistent.fst(79,38-84,71)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Tm_refine_6725bf085bac499ccfe650045e02384d @x1))
(HasType (ApplyTT @x0
@x2)
(Tm_refine_725aef195f27e6fbc7a6e56ef6eae75c @x1)))
 

:pattern ((ApplyTT @x0
@x2))
:qid IOWPInconsistent_interpretation_Tm_arrow_1162fffd6dc721b75dc80effffb72f62.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_1162fffd6dc721b75dc80effffb72f62 @x1)))
:qid IOWPInconsistent_interpretation_Tm_arrow_1162fffd6dc721b75dc80effffb72f62))

:named IOWPInconsistent_interpretation_Tm_arrow_1162fffd6dc721b75dc80effffb72f62))

; Encoding query formula : forall (a: Type).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     IOWPInconsistent.p0 IOWPInconsistent.x0 /\
;     (forall (pure_result: Prims.unit). ~(IOWPInconsistent.p0 IOWPInconsistent.x0) ==> p pure_result) ==>
;     (forall (p:
;         (_: FStar.Pervasives.either (IOWPInconsistent.out_wp a) a -> IOWPInconsistent.prop)
;           {IOWPInconsistent.f p == IOWPInconsistent.x0 /\ ~(p IOWPInconsistent.x0)}).
;         (*  - Could not prove post-condition
; *)
;         IOWPInconsistent.f p == IOWPInconsistent.f IOWPInconsistent.p0 /\
;         (forall (pure_result: Prims.unit).
;             p == IOWPInconsistent.p0 ==> ~(IOWPInconsistent.p0 IOWPInconsistent.x0))) /\
;     (forall (any_result:
;         (
;               p:
;                 (_: FStar.Pervasives.either (IOWPInconsistent.out_wp a) a -> IOWPInconsistent.prop)
;                   {IOWPInconsistent.f p == IOWPInconsistent.x0 /\ ~(p IOWPInconsistent.x0)}
;             -> Prims.GTot (Prims.squash (~(IOWPInconsistent.p0 IOWPInconsistent.x0))))).
;         IOWPInconsistent.p0 IOWPInconsistent.x0 /\
;         (forall (pure_result: Prims.squash (IOWPInconsistent.p0 IOWPInconsistent.x0))
;             (any_result: Prims.squash (IOWPInconsistent.p0 IOWPInconsistent.x0))
;             (pure_result: Prims.unit).
;             ~(IOWPInconsistent.p0 IOWPInconsistent.x0) ==> p pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let bad1`
...
;; def=IOWPInconsistent.fst(78,20-78,32); use=IOWPInconsistent.fst(79,38-84,71)
(Valid 
;; def=IOWPInconsistent.fst(78,20-78,32); use=IOWPInconsistent.fst(79,38-84,71)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(79,38-84,71)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=IOWPInconsistent.fst(79,20-79,35); use=IOWPInconsistent.fst(79,38-84,71)
(or label_2

;; def=IOWPInconsistent.fst(79,20-79,35); use=IOWPInconsistent.fst(79,38-84,71)
(not 
;; def=IOWPInconsistent.fst(79,22-79,34); use=IOWPInconsistent.fst(79,38-84,71)
(Valid 
;; def=IOWPInconsistent.fst(79,22-79,34); use=IOWPInconsistent.fst(79,38-84,71)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(79,38-84,71)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(79,38-84,71)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=IOWPInconsistent.fst(79,38-84,71)
(and 
;; def=dummy(0,0-0,0); use=IOWPInconsistent.fst(79,38-84,71)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Tm_refine_6725bf085bac499ccfe650045e02384d @x0))

;; def=Prims.fst(441,29-441,97); use=IOWPInconsistent.fst(82,4-82,15)
(and 
;; def=IOWPInconsistent.fst(65,20-65,33); use=IOWPInconsistent.fst(82,4-82,15)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(82,4-82,15)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=IOWPInconsistent.fst(66,20-66,29); use=IOWPInconsistent.fst(82,4-82,15)
(= @x2
(ApplyTT IOWPInconsistent.p0@tok
@x0))
)

;; def=IOWPInconsistent.fst(81,19-81,34); use=IOWPInconsistent.fst(82,4-82,20)
(or label_4

;; def=IOWPInconsistent.fst(81,19-81,34); use=IOWPInconsistent.fst(82,4-82,20)
(not 
;; def=IOWPInconsistent.fst(81,21-81,33); use=IOWPInconsistent.fst(82,4-82,20)
(Valid 
;; def=IOWPInconsistent.fst(81,21-81,33); use=IOWPInconsistent.fst(82,4-82,20)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=Prims.fst(451,66-451,102); use=IOWPInconsistent.fst(79,38-84,71)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Tm_arrow_1162fffd6dc721b75dc80effffb72f62 @x0))

;; def=Prims.fst(441,29-441,97); use=IOWPInconsistent.fst(84,44-84,53)
(and 
;; def=IOWPInconsistent.fst(84,54-84,66); use=IOWPInconsistent.fst(84,44-84,53)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(84,44-84,53)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Prims.squash (IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))))
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(84,2-84,13)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=IOWPInconsistent.fst(84,14-84,29); use=IOWPInconsistent.fst(84,2-84,13)
(not 
;; def=IOWPInconsistent.fst(84,16-84,28); use=IOWPInconsistent.fst(84,2-84,13)
(Valid 
;; def=IOWPInconsistent.fst(84,16-84,28); use=IOWPInconsistent.fst(84,2-84,13)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(84,2-84,13)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(84,2-84,13)
(ApplyTT @x1
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IOWPInconsistent.bad1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_IOWPInconsistent.x0, function_token_typing_IOWPInconsistent.p0, refinement_interpretation_Tm_refine_6725bf085bac499ccfe650045e02384d
...
; encoding sigelt let bad1


; <Start encoding let bad1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IOWPInconsistent.bad1 (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IOWPInconsistent.bad1@tok () Term)

; </end encoding let bad1>

(push) ;; push{2

; Starting query at IOWPInconsistent.fst(89,2-90,36)
...
;     ~(IOWPInconsistent.p0 IOWPInconsistent.x0) /\
;     (forall (pure_result: Prims.unit). IOWPInconsistent.p0 IOWPInconsistent.x0 ==> p pure_result) ==>
;     IOWPInconsistent.f IOWPInconsistent.p0 == IOWPInconsistent.x0 /\
;     ~(IOWPInconsistent.p0 IOWPInconsistent.x0) /\
;     (forall (pure_result: Prims.unit).
;         (exists (x:
;             (_: FStar.Pervasives.either (IOWPInconsistent.out_wp a) a -> IOWPInconsistent.prop)).
;             IOWPInconsistent.f x == IOWPInconsistent.x0 /\ ~(x IOWPInconsistent.x0)) ==>
;         p pure_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let bad2`
...
;; def=IOWPInconsistent.fst(87,20-87,35); use=IOWPInconsistent.fst(89,2-90,36)
(not 
;; def=IOWPInconsistent.fst(87,22-87,34); use=IOWPInconsistent.fst(89,2-90,36)
(Valid 
;; def=IOWPInconsistent.fst(87,22-87,34); use=IOWPInconsistent.fst(89,2-90,36)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(89,2-90,36)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=IOWPInconsistent.fst(88,20-88,32); use=IOWPInconsistent.fst(89,2-90,36)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(89,2-90,36)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IOWPInconsistent.fst(89,2-90,36)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(441,29-441,97); use=IOWPInconsistent.fst(89,2-90,36)
(and 
;; def=IOWPInconsistent.fst(90,4-90,16); use=IOWPInconsistent.fst(89,2-89,14)
(or label_3
...
;; def=IOWPInconsistent.fst(90,20-90,32); use=IOWPInconsistent.fst(89,2-89,14)
(or label_4

;; def=IOWPInconsistent.fst(90,20-90,32); use=IOWPInconsistent.fst(89,2-89,14)
(not 
;; def=IOWPInconsistent.fst(90,21-90,32); use=IOWPInconsistent.fst(89,2-89,14)
(Valid 
;; def=IOWPInconsistent.fst(90,21-90,32); use=IOWPInconsistent.fst(89,2-89,14)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=FStar.Classical.fsti(355,44-355,64); use=IOWPInconsistent.fst(89,2-89,14)
(exists ((@x3 Term))
 (! (and (HasType @x3
(Tm_arrow_95fe26a97d19951315ce73c0c69f9af3 @x0))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IOWPInconsistent.bad2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_IOWPInconsistent.p0, equation_IOWPInconsistent.x0, l_quant_interp_3d5f610aa0975e34cfaa0a7c62d6f069
...
; encoding sigelt let bad2


; <Start encoding let bad2>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IOWPInconsistent.bad2 (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IOWPInconsistent.bad2@tok () Term)

; </end encoding let bad2>

(push) ;; push{2

; Starting query at IOWPInconsistent.fst(94,2-97,16)
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit) (pure_result: Prims.unit).
;     (IOWPInconsistent.p0 IOWPInconsistent.x0 ==> ~(IOWPInconsistent.p0 IOWPInconsistent.x0)) ==>
;     (forall (pure_result: Prims.unit).
;         (~(IOWPInconsistent.p0 IOWPInconsistent.x0) ==> IOWPInconsistent.p0 IOWPInconsistent.x0) ==>
;         ~(IOWPInconsistent.p0 IOWPInconsistent.x0) /\ IOWPInconsistent.p0 IOWPInconsistent.x0 /\
;         (forall (pure_result: Prims.unit).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let out_wp_inconsistent`
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(94,2-94,15)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=FStar.Classical.fsti(83,12-83,25); use=IOWPInconsistent.fst(94,2-94,15)
(implies 
;; def=IOWPInconsistent.fst(78,20-78,32); use=IOWPInconsistent.fst(94,2-94,15)
(Valid 
;; def=IOWPInconsistent.fst(78,20-78,32); use=IOWPInconsistent.fst(94,2-94,15)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=IOWPInconsistent.fst(79,20-79,35); use=IOWPInconsistent.fst(94,2-94,15)
(not 
;; def=IOWPInconsistent.fst(79,22-79,34); use=IOWPInconsistent.fst(94,2-94,15)
(Valid 
;; def=IOWPInconsistent.fst(79,22-79,34); use=IOWPInconsistent.fst(94,2-94,15)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(95,2-95,15)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=FStar.Classical.fsti(83,12-83,25); use=IOWPInconsistent.fst(95,2-95,15)
(implies 
;; def=IOWPInconsistent.fst(87,20-87,35); use=IOWPInconsistent.fst(95,2-95,15)
(not 
;; def=IOWPInconsistent.fst(87,22-87,34); use=IOWPInconsistent.fst(95,2-95,15)
(Valid 
;; def=IOWPInconsistent.fst(87,22-87,34); use=IOWPInconsistent.fst(95,2-95,15)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=IOWPInconsistent.fst(88,20-88,32); use=IOWPInconsistent.fst(95,2-95,15)
(Valid 
;; def=IOWPInconsistent.fst(88,20-88,32); use=IOWPInconsistent.fst(95,2-95,15)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=Prims.fst(441,29-441,97); use=IOWPInconsistent.fst(96,2-96,8)
(and 
;; def=IOWPInconsistent.fst(96,10-96,23); use=IOWPInconsistent.fst(96,2-96,8)
(or label_1

;; def=IOWPInconsistent.fst(96,10-96,23); use=IOWPInconsistent.fst(96,2-96,8)
(not 
;; def=IOWPInconsistent.fst(96,11-96,23); use=IOWPInconsistent.fst(96,2-96,8)
(Valid 
;; def=IOWPInconsistent.fst(96,11-96,23); use=IOWPInconsistent.fst(96,2-96,8)
(IOWPInconsistent.p0 @x0
(IOWPInconsistent.x0 @x0))
...
;; def=IOWPInconsistent.fst(96,27-96,37); use=IOWPInconsistent.fst(96,2-96,8)
(or label_2
...
;; def=Prims.fst(441,36-441,97); use=IOWPInconsistent.fst(96,2-96,8)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IOWPInconsistent.out_wp_inconsistent, 1)
; STATUS: unsat
