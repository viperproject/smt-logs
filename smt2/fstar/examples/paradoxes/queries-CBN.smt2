...
; encoding sigelt val CBN.diverge


; <Skipped val CBN.diverge/>


; encoding sigelt let rec diverge


; <Start encoding let rec diverge>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CBN.diverge (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CBN.diverge@tok () Term)

; </end encoding let rec diverge>


; encoding sigelt val CBN.explode


; <Skipped val CBN.explode/>


; encoding sigelt let explode


; <Start encoding let explode>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CBN.explode (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CBN.explode@tok () Term)

; </end encoding let explode>


; encoding sigelt val CBN.explode2


; <Skipped val CBN.explode2/>


; encoding sigelt let explode2


; <Start encoding let explode2>


;;;;;;;;;;;;;;;;_: Prims.unit -> FStar.Pervasives.Lemma (ensures Prims.l_False)
(declare-fun Tm_arrow_e17dd31217a415fe6fee34da93cd459d () Term)
(declare-fun CBN.explode2 (Term Term) Term)


;;;;;;;;;;;;;;;;diverge2: (_: Prims.unit -> FStar.Pervasives.Lemma (ensures Prims.l_False)) -> x: Prims.int   -> Prims.int
(declare-fun Tm_arrow_e1571ff6ec7075df407f6821cc9cc67c () Term)
(declare-fun CBN.explode2@tok () Term)



; </end encoding let explode2>


; encoding sigelt val CBN.explode3


; <Skipped val CBN.explode3/>


; encoding sigelt let explode3


; <Start encoding let explode3>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CBN.explode3 (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CBN.explode3@tok () Term)

; </end encoding let explode3>


; encoding sigelt val CBN.g
...
(declare-fun CBN.g (Term) Term)

(declare-fun CBN.g@tok () Term)

; </end encoding let g>


; encoding sigelt val CBN.xxx


; <Skipped val CBN.xxx/>


; encoding sigelt let xxx


; <Start encoding let xxx>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CBN.xxx (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CBN.xxx@tok () Term)

; </end encoding let xxx>
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun CBN.diverge_.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun CBN.diverge_.fuel_instrumented_token () Term)
(declare-fun CBN.diverge_ (Term) Term)
(declare-fun CBN.diverge_@tok () Term)
(declare-fun Tm_refine_1588d9cc9cb691265bea0ce2c66abf3c () Term)

;;;;;;;;;;;;;;;;x: Prims.unit -> Prims.Pure Prims.bool
(declare-fun Tm_arrow_a75899db682060fb8355571ea3abedbe () Term)
...
; Starting query at CBN.fst(89,26-89,45)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (u93: u94: Prims.unit{Prims.l_False}) (u': Prims.unit). Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let tg`
...
; QUERY ID: (CBN.tg, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_f1ecc6ab6882a651504f328937700647
