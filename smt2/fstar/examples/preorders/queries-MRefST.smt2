...
; Externals for interface MRefHeap
...
; <Start encoding val MRefHeap.heap>

(declare-fun MRefHeap.heap () Term)

; </end encoding val MRefHeap.heap>


; <Start encoding val MRefHeap.mref>
...
; </end encoding val MRefHeap.mref>


; <Start encoding val MRefHeap.addr_of>
...
; </end encoding val MRefHeap.addr_of>


; <Start encoding val MRefHeap.contains>
...
; </end encoding val MRefHeap.contains>


; <Start encoding val MRefHeap.contains_same_addr_lemma>
...
; </end encoding val MRefHeap.contains_same_addr_lemma>


; <Start encoding val MRefHeap.contains_diff_addr_lemma>
...
; </end encoding val MRefHeap.contains_diff_addr_lemma>


; <Start encoding val MRefHeap.sel>
...
; </end encoding val MRefHeap.sel>


; <Start encoding val MRefHeap.alloc_ref>
...
; </end encoding val MRefHeap.alloc_ref>


; <Start encoding val MRefHeap.upd>
...
; </end encoding val MRefHeap.upd>


; <Start encoding val MRefHeap.emp>

(declare-fun MRefHeap.emp (Dummy_sort) Term)

; </end encoding val MRefHeap.emp>


; End Externals for interface MRefHeap

(push) ;; push{1

; Internals for MRefST
...
(declare-fun MRefST.st (Term) Term)

(declare-fun MRefST.st@tok () Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.M (a & MRefHeap.heap)
(declare-fun Tm_arrow_0a92567e99643d96eac3b6cbd92d2695 (Term) Term)

; </end encoding let st>


; encoding sigelt val MRefST.return_st


; <Skipped val MRefST.return_st/>
...
(declare-fun MRefST.return_st (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> st a
(declare-fun Tm_arrow_62c8b60b1985f60eb219587a6814fe04 () Term)
(declare-fun MRefST.return_st@tok () Term)
(declare-fun Tm_abs_280054e4dbb66c0a99033448de5912ba (Term Term) Term)

; </end encoding let return_st>


; encoding sigelt val MRefST.bind_st


; <Skipped val MRefST.bind_st/>
...
;;;;;;;;;;;;;;;;_: a -> st b
(declare-fun Tm_arrow_5e03fdd705c418f0b11b97f6878e27f8 (Term Term) Term)
(declare-fun MRefST.bind_st (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> f: st a -> g: (_: a -> st b) -> st b
(declare-fun Tm_arrow_dfd4de062fa1ba1f2c1412a3b6aa7dfc () Term)
(declare-fun MRefST.bind_st@tok () Term)

(declare-fun Tm_abs_46e402ea73f0b8ad9a474ccf5ed39b30 (Term Term) Term)
...
(declare-fun MRefST.get (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> st MRefHeap.heap
(declare-fun Tm_arrow_6ac3b191e76e15a87845c7f3087c101b () Term)
(declare-fun MRefST.get@tok () Term)
(declare-fun Tm_abs_995f969dac438efe578aeaf520be40a8 () Term)
...
(declare-fun MRefST.put (Term) Term)
;;;;;;;;;;;;;;;;x: MRefHeap.heap -> st Prims.unit
(declare-fun Tm_arrow_fd59db1db294759d05cd199024a19a04 () Term)
(declare-fun MRefST.put@tok () Term)
(declare-fun Tm_abs_566737b4b183d6c587dfd9e1c3306eb5 (Term) Term)

; </end encoding let put>


; encoding sigelt let _dm4f_ISTATE_lift_from_pure


; <Start encoding let _dm4f_ISTATE_lift_from_pure>


;;;;;;;;;;;;;;;;_: (_: a -> Type) -> Type
(declare-fun Tm_arrow_11b93b1a25b26195b88e72dd87199600 (Term) Term)
;;;;;;;;;;;;;;;;_: a & MRefHeap.heap -> Type
(declare-fun Tm_arrow_02486e68ad8d7de83f2663dc6b1e4b14 (Term) Term)
(declare-fun MRefST._dm4f_ISTATE_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type -> wp: (_: (_: a -> Type) -> Type) -> s: MRefHeap.heap -> p': (_: a & MRefHeap.heap -> Type)   -> Type
(declare-fun Tm_arrow_d42c92c0beda87d3c9c4a553c226c714 () Term)
(declare-fun MRefST._dm4f_ISTATE_lift_from_pure@tok () Term)




(declare-fun Tm_abs_517dcbec3f6da6aece51d69a515d84f3 (Term Term Term) Term)

; </end encoding let _dm4f_ISTATE_lift_from_pure>


; encoding sigelt let _dm4f_ISTATE_return_wp


; <Start encoding let _dm4f_ISTATE_return_wp>


(declare-fun MRefST._dm4f_ISTATE_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> s: MRefHeap.heap -> p': (_: a & MRefHeap.heap -> Type) -> Type
(declare-fun Tm_arrow_21f0b69132a1c224d11f623b568ea65b () Term)
(declare-fun MRefST._dm4f_ISTATE_return_wp@tok () Term)


; </end encoding let _dm4f_ISTATE_return_wp>


; encoding sigelt let _dm4f_ISTATE_return_elab


; <Start encoding let _dm4f_ISTATE_return_elab>

(declare-fun MRefST._dm4f_ISTATE_return_elab (Term Term Term) Term)
(declare-fun Tm_refine_b7ba57195d452fcdcd7fdfb6dba81813 (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> s: MRefHeap.heap -> Prims.PURE (a & MRefHeap.heap)
(declare-fun Tm_arrow_995e5c957b853a1e73913b7f46bd84f1 () Term)
(declare-fun MRefST._dm4f_ISTATE_return_elab@tok () Term)


; </end encoding let _dm4f_ISTATE_return_elab>


; encoding sigelt let _dm4f_ISTATE_bind_wp


; <Start encoding let _dm4f_ISTATE_bind_wp>


;;;;;;;;;;;;;;;;_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type
(declare-fun Tm_arrow_9a105b4dc9ad9b8fbb30cf535771a58b (Term) Term)


;;;;;;;;;;;;;;;;_: a -> _: MRefHeap.heap -> _: (_: b & MRefHeap.heap -> Type) -> Type
(declare-fun Tm_arrow_dfbd67bf185a02e3390091674375365a (Term Term) Term)

(declare-fun MRefST._dm4f_ISTATE_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) ->     g: (_: a -> _: MRefHeap.heap -> _: (_: b & MRefHeap.heap -> Type) -> Type) ->     s0: MRefHeap.heap ->     p'': (_: b & MRefHeap.heap -> Type)   -> Type
(declare-fun Tm_arrow_184d12deab9aacaa202c1e7027a4f03a () Term)
(declare-fun MRefST._dm4f_ISTATE_bind_wp@tok () Term)
...
(declare-fun Tm_abs_606068e6911036061a9818f1ba3680d2 (Term Term Term) Term)

; </end encoding let _dm4f_ISTATE_bind_wp>


; encoding sigelt let _dm4f_ISTATE_bind_elab


; <Start encoding let _dm4f_ISTATE_bind_elab>



(declare-fun Tm_refine_6dbdd02c687d0b02b75e9dcc630ec88e (Term) Term)

;;;;;;;;;;;;;;;;y: _: (a & MRefHeap.heap){Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_9526ea12f3b8fcd9243137291b1248bb (Term) Term)
(declare-fun Tm_abs_4ee549db07198f9c6bdf034fc60439be (Term Term) Term)
(declare-fun Tm_refine_46c526534084fbc8ccf2c97130c85e9e (Term Term Term) Term)



(declare-fun Tm_abs_c92fa893841ad6c1c60027237b799798 (Term) Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.PURE (a & MRefHeap.heap)
(declare-fun Tm_arrow_60c1640300f89c854af862979f226868 (Term Term) Term)
...
(declare-fun Tm_refine_780ddc7736daaccecef9cfa540edb412 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.PURE (b & MRefHeap.heap)
(declare-fun Tm_arrow_c6bb90b746df5fdac12f1e9132bbfdcd (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: MRefHeap.heap -> Prims.PURE (b & MRefHeap.heap)
(declare-fun Tm_arrow_d4b012229cd1ab68b72c5ab93dc4f6a2 (Term Term Term) Term)





(declare-fun Tm_abs_e78680b595769ce2dd5df7870a72397a (Term Term Term) Term)
(declare-fun MRefST._dm4f_ISTATE_bind_elab (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_e9f18ed71f96cb72dd288f3be632f703 (Term Term Term Term) Term)
(declare-fun Tm_refine_43cef15a0909ad80043da472d0115479 (Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f__w: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) ->     f: (_: MRefHeap.heap -> Prims.PURE (a & MRefHeap.heap)) ->     g__w: (_: a -> _: MRefHeap.heap -> _: (_: b & MRefHeap.heap -> Type) -> Type) ->     g: (_: a -> _: MRefHeap.heap -> Prims.PURE (b & MRefHeap.heap)) ->     s0: MRefHeap.heap   -> Prims.PURE (b & MRefHeap.heap)
(declare-fun Tm_arrow_b1a78238907095ad19b4ff1d219c4594 () Term)
(declare-fun MRefST._dm4f_ISTATE_bind_elab@tok () Term)
...
; </end encoding let _dm4f_ISTATE_bind_elab>


; encoding sigelt let _dm4f_ISTATE___proj__ISTATE__item__get_elab


; <Start encoding let _dm4f_ISTATE___proj__ISTATE__item__get_elab>

(declare-fun MRefST._dm4f_ISTATE___proj__ISTATE__item__get_elab (Term) Term)
(declare-fun Tm_refine_1b0464aedae3d840d7f4be6007250f89 (Term) Term)
;;;;;;;;;;;;;;;;x__x: MRefHeap.heap -> Prims.PURE (MRefHeap.heap & MRefHeap.heap)
(declare-fun Tm_arrow_8e537aef50dfa77a378bb2d5c8c47289 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> x__x: MRefHeap.heap -> Prims.PURE (MRefHeap.heap & MRefHeap.heap)
(declare-fun Tm_arrow_8d697156bd06780b75a08bf023132465 () Term)
(declare-fun MRefST._dm4f_ISTATE___proj__ISTATE__item__get_elab@tok () Term)




; </end encoding let _dm4f_ISTATE___proj__ISTATE__item__get_elab>


; encoding sigelt let _dm4f_ISTATE___proj__ISTATE__item__get_complete_type


; <Start encoding let _dm4f_ISTATE___proj__ISTATE__item__get_complete_type>

(declare-fun MRefST._dm4f_ISTATE___proj__ISTATE__item__get_complete_type () Term)




; </end encoding let _dm4f_ISTATE___proj__ISTATE__item__get_complete_type>


; encoding sigelt let _dm4f_ISTATE___proj__ISTATE__item__put_elab


; <Start encoding let _dm4f_ISTATE___proj__ISTATE__item__put_elab>

(declare-fun MRefST._dm4f_ISTATE___proj__ISTATE__item__put_elab (Term) Term)
(declare-fun Tm_refine_8d11027b4c80888b5ec783be6466d9ae (Term) Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.PURE (Prims.unit & MRefHeap.heap)
(declare-fun Tm_arrow_508a60d478dc075d5fb29623fb8f352f (Term) Term)
;;;;;;;;;;;;;;;;x: MRefHeap.heap -> _: MRefHeap.heap -> Prims.PURE (Prims.unit & MRefHeap.heap)
(declare-fun Tm_arrow_1ba1d670cea360ffe9a185e48e33cc68 () Term)
(declare-fun MRefST._dm4f_ISTATE___proj__ISTATE__item__put_elab@tok () Term)




; </end encoding let _dm4f_ISTATE___proj__ISTATE__item__put_elab>


; encoding sigelt let _dm4f_ISTATE___proj__ISTATE__item__put_complete_type


; <Start encoding let _dm4f_ISTATE___proj__ISTATE__item__put_complete_type>

(declare-fun MRefST._dm4f_ISTATE___proj__ISTATE__item__put_complete_type () Term)




; </end encoding let _dm4f_ISTATE___proj__ISTATE__item__put_complete_type>


; encoding sigelt let _dm4f_ISTATE_repr


; <Start encoding let _dm4f_ISTATE_repr>



(declare-fun MRefST._dm4f_ISTATE_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp_a: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) -> Type
(declare-fun Tm_arrow_5ae0bad57287edec6b8d836a4f2e8fd7 () Term)
(declare-fun MRefST._dm4f_ISTATE_repr@tok () Term)
...
; </end encoding let _dm4f_ISTATE_repr>


; encoding sigelt let _dm4f_ISTATE_pre


; <Start encoding let _dm4f_ISTATE_pre>

(declare-fun MRefST._dm4f_ISTATE_pre () Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Type
(declare-fun Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86 () Term)

; </end encoding let _dm4f_ISTATE_pre>


; encoding sigelt let _dm4f_ISTATE_post


; <Start encoding let _dm4f_ISTATE_post>

(declare-fun MRefST._dm4f_ISTATE_post (Term) Term)

(declare-fun MRefST._dm4f_ISTATE_post@tok () Term)


; </end encoding let _dm4f_ISTATE_post>


; encoding sigelt let _dm4f_ISTATE_wp


; <Start encoding let _dm4f_ISTATE_wp>

(declare-fun MRefST._dm4f_ISTATE_wp (Term) Term)

(declare-fun MRefST._dm4f_ISTATE_wp@tok () Term)



; </end encoding let _dm4f_ISTATE_wp>


; encoding sigelt let _dm4f_ISTATE_ctx


; <Start encoding let _dm4f_ISTATE_ctx>

(declare-fun MRefST._dm4f_ISTATE_ctx (Term Term) Term)

(declare-fun MRefST._dm4f_ISTATE_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> t
(declare-fun Tm_arrow_2b9aa13fcaf6738676b68f507774a055 (Term Term) Term)

; </end encoding let _dm4f_ISTATE_ctx>


; encoding sigelt let _dm4f_ISTATE_gctx


; <Start encoding let _dm4f_ISTATE_gctx>

(declare-fun MRefST._dm4f_ISTATE_gctx (Term Term) Term)

(declare-fun MRefST._dm4f_ISTATE_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot t
(declare-fun Tm_ghost_arrow_61dfaeaacfe9228457195294411202c0 (Term Term) Term)

; </end encoding let _dm4f_ISTATE_gctx>


; encoding sigelt let _dm4f_ISTATE_pure


; <Start encoding let _dm4f_ISTATE_pure>


(declare-fun MRefST._dm4f_ISTATE_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> t
(declare-fun Tm_arrow_b2a9b22059984f90639e329273069237 () Term)
(declare-fun MRefST._dm4f_ISTATE_pure@tok () Term)


; </end encoding let _dm4f_ISTATE_pure>


; encoding sigelt let _dm4f_ISTATE_app


; <Start encoding let _dm4f_ISTATE_app>



;;;;;;;;;;;;;;;;_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_f0364fe0d45cd5c8b6f2dd12e9a8fb1e (Term Term Term) Term)



(declare-fun MRefST._dm4f_ISTATE_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot t1) ->     _: MRefHeap.heap ->     _: (_: a & MRefHeap.heap -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_bab73bc1d772bf9aa04f4628c7b4db2a () Term)
(declare-fun MRefST._dm4f_ISTATE_app@tok () Term)
...
; </end encoding let _dm4f_ISTATE_app>


; encoding sigelt let _dm4f_ISTATE_lift1


; <Start encoding let _dm4f_ISTATE_lift1>




(declare-fun MRefST._dm4f_ISTATE_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot t1) ->     _: MRefHeap.heap ->     _: (_: a & MRefHeap.heap -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_44cb067257fd7d0248c0acd115ec5e5b () Term)
(declare-fun MRefST._dm4f_ISTATE_lift1@tok () Term)
...
(declare-fun Tm_abs_c29edc13ed1db0a0c6c6e43e7af05e7d (Term Term Term Term) Term)

; </end encoding let _dm4f_ISTATE_lift1>


; encoding sigelt let _dm4f_ISTATE_lift2


; <Start encoding let _dm4f_ISTATE_lift2>
...
(declare-fun MRefST._dm4f_ISTATE_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot t1) ->     a2: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot t2) ->     _: MRefHeap.heap ->     _: (_: a & MRefHeap.heap -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_a480a442f848925fa350f171c10ef445 () Term)
(declare-fun MRefST._dm4f_ISTATE_lift2@tok () Term)
...
(declare-fun Tm_abs_45f788f9b75aac56f81727aa942499ed (Term Term Term Term Term) Term)

; </end encoding let _dm4f_ISTATE_lift2>


; encoding sigelt let _dm4f_ISTATE_push


; <Start encoding let _dm4f_ISTATE_push>



;;;;;;;;;;;;;;;;_: t1 -> _: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot t2
(declare-fun Tm_arrow_0f177cf4aad19ded6fe99e81401d5205 (Term Term Term) Term)

(declare-fun MRefST._dm4f_ISTATE_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f: (_: t1 -> _: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot t2) ->     _: MRefHeap.heap ->     _: (_: a & MRefHeap.heap -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_ffd81b72e0eee0473eadb9419eb70018 () Term)
(declare-fun MRefST._dm4f_ISTATE_push@tok () Term)





; </end encoding let _dm4f_ISTATE_push>


; encoding sigelt let _dm4f_ISTATE_wp_if_then_else


; <Start encoding let _dm4f_ISTATE_wp_if_then_else>

(declare-fun MRefST._dm4f_ISTATE_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) ->     _: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) ->     _: MRefHeap.heap ->     _: (_: a & MRefHeap.heap -> Type)   -> Type
(declare-fun Tm_arrow_dc5eab6ef83f42d5ff6b754950c6bff5 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) ->     _: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) ->     _: MRefHeap.heap ->     _: (_: a & MRefHeap.heap -> Type)   -> Type
(declare-fun Tm_arrow_ab766a3ba30120883cd6acdc72bbdbc5 () Term)
(declare-fun MRefST._dm4f_ISTATE_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_b2b6df92a1f79c779c8cefc6e0353162 (Term) Term)
...
;;;;;;;;;;;;;;;;a1: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot Prims.logical) ->     a2: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.GTot Prims.logical) ->     _: MRefHeap.heap ->     _: (_: a & MRefHeap.heap -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_78a93419bb890018501c56f71c829487 (Term) Term)
(declare-fun Tm_abs_01bc829589f502c9cad4987eb1d89e3d (Term Term) Term)

; </end encoding let _dm4f_ISTATE_wp_if_then_else>


; encoding sigelt let _dm4f_ISTATE_wp_close


; <Start encoding let _dm4f_ISTATE_wp_close>




(declare-fun MRefST._dm4f_ISTATE_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: b -> _: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) ->     _: MRefHeap.heap ->     _: (_: a & MRefHeap.heap -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_3b41dd33c881a5a27db7a03f79dbd571 () Term)
(declare-fun MRefST._dm4f_ISTATE_wp_close@tok () Term)
...
(declare-fun Tm_abs_c9e3fd93f725c971e6880ccb09405007 (Term Term Term) Term)

; </end encoding let _dm4f_ISTATE_wp_close>


; encoding sigelt let _dm4f_ISTATE_stronger


; <Start encoding let _dm4f_ISTATE_stronger>





(declare-fun MRefST._dm4f_ISTATE_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) ->     wp2: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_a08c1c401608c5be065e1fa0a70baf79 () Term)
(declare-fun MRefST._dm4f_ISTATE_stronger@tok () Term)
...
; </end encoding let _dm4f_ISTATE_stronger>


; encoding sigelt let _dm4f_ISTATE_ite_wp


; <Start encoding let _dm4f_ISTATE_ite_wp>




(declare-fun MRefST._dm4f_ISTATE_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) ->     _: MRefHeap.heap ->     _: (_: a & MRefHeap.heap -> Type)   -> Prims.logical
(declare-fun Tm_arrow_193030f1faad4882caf9740a89e0df30 () Term)
(declare-fun MRefST._dm4f_ISTATE_ite_wp@tok () Term)





; </end encoding let _dm4f_ISTATE_ite_wp>


; encoding sigelt let _dm4f_ISTATE_null_wp


; <Start encoding let _dm4f_ISTATE_null_wp>


(declare-fun MRefST._dm4f_ISTATE_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> _: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Prims.logical
(declare-fun Tm_arrow_3b21d955934e2aca356b5e10f4f57c28 () Term)
(declare-fun MRefST._dm4f_ISTATE_null_wp@tok () Term)


; </end encoding let _dm4f_ISTATE_null_wp>


; encoding sigelt let _dm4f_ISTATE_wp_trivial


; <Start encoding let _dm4f_ISTATE_wp_trivial>



(declare-fun MRefST._dm4f_ISTATE_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: (_: MRefHeap.heap -> _: (_: a & MRefHeap.heap -> Type) -> Type) -> Prims.logical
(declare-fun Tm_arrow_2176cbe12271ef6564ea46ae4e1b99fb () Term)
(declare-fun MRefST._dm4f_ISTATE_wp_trivial@tok () Term)




; </end encoding let _dm4f_ISTATE_wp_trivial>


; encoding sigelt new_effect_for_free { ISTATE ... }


; <Start encoding new_effect_for_free { ISTATE ... }>





(declare-fun Tm_abs_f2972828e2d34f69339ec5edd1f99e9c () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun MRefST.__proj__ISTATE__item__get (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun MRefST.__proj__ISTATE__item__get@tok () Term)




(declare-fun Tm_abs_b02aeef8dc3e9cc3ccf30a9ae4a8859b () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun MRefST.__proj__ISTATE__item__put (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun MRefST.__proj__ISTATE__item__put@tok () Term)

; </end encoding new_effect_for_free { ISTATE ... }>


; encoding sigelt sub_effect PURE ~> ISTATE


; <Skipped sub_effect PURE ~> ISTATE/>
...
(declare-fun MRefST.contains (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;m: MRefHeap.mref a r -> h: MRefHeap.heap -> Type
(declare-fun Tm_arrow_8ff4538f6e47374cca3174ef0666d15e () Term)
(declare-fun MRefST.contains@tok () Term)

; </end encoding let contains>


; encoding sigelt val MRefST.contains_lemma


; <Skipped val MRefST.contains_lemma/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.contains; Namespace MRefST
(assert (! 
;; def=MRefST.fst(61,4-61,12); use=MRefST.fst(61,4-61,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((MRefST.contains @x0
@x1
@x2
@x3))
:qid typing_MRefST.contains))

:named typing_MRefST.contains))
;;;;;;;;;;;;;;;;free var typing
...
(assert (! 
;; def=MRefHeap.fsti(30,4-30,8); use=MRefHeap.fsti(30,4-30,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(assert (! 
;; def=MRefHeap.fsti(37,4-37,12); use=MRefHeap.fsti(37,4-37,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
@x2
@x3))
:qid equation_MRefST.contains))

:named equation_MRefST.contains))
...
; Starting query at MRefST.fst(70,31-70,33)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (r: FStar.Preorder.preorder a) (h: MRefHeap.heap) (m: MRefHeap.mref a r).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     MRefST.contains m h /\
;     (forall (pure_result: Prims.unit). MRefHeap.contains h m ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let contains_lemma`
...
;; def=MRefST.fst(67,23-67,37); use=MRefST.fst(70,31-70,33)
(Valid 
;; def=MRefST.fst(67,23-67,37); use=MRefST.fst(70,31-70,33)
(MRefST.contains @x0
@x1
...
;; def=Prims.fst(441,36-441,97); use=MRefST.fst(70,31-70,33)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=MRefST.fst(68,16-68,39); use=MRefST.fst(70,31-70,33)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MRefST.fst(70,31-70,33)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MRefST.fst(70,31-70,33)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.contains_lemma, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_MRefST.contains
...
; encoding sigelt let contains_lemma


; <Start encoding let contains_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MRefST.contains_lemma (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MRefST.contains_lemma@tok () Term)

; </end encoding let contains_lemma>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefHeap.sel; Namespace MRefHeap
(assert (! 
;; def=MRefHeap.fsti(49,4-49,7); use=MRefHeap.fsti(49,4-49,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;;; Fact-ids: Name MRefHeap.sel; Namespace MRefHeap
(assert (! 
;; def=MRefHeap.fsti(52,3-52,27); use=MRefHeap.fsti(52,3-52,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;; def=MRefHeap.fsti(52,14-52,26); use=MRefHeap.fsti(52,14-52,26)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=MRefHeap.fsti(52,14-52,26)
...
;;;;;;;;;;;;;;;;Lemma: MRefST.contains_lemma
;;; Fact-ids: Name MRefST.contains_lemma; Namespace MRefST
...
;; def=MRefST.fst(67,23-67,37); use=MRefST.fst(70,4-70,18)
(Valid 
;; def=MRefST.fst(67,23-67,37); use=MRefST.fst(70,4-70,18)
(MRefST.contains @x0
@x1
...
;; def=MRefST.fst(68,16-68,39); use=MRefST.fst(70,4-70,18)
(Valid 
;; def=MRefST.fst(68,16-68,39); use=MRefST.fst(70,4-70,18)
(MRefHeap.contains @x0
@x1
...
@x3
@x2))
:qid lemma_MRefST.contains_lemma))
:named lemma_MRefST.contains_lemma))
...
; Starting query at MRefST.fst(76,2-77,81)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_3568bcf9133bbe8512b3c2560361e2a6 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(77,27-77,54); use=MRefST.fst(77,27-77,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_3568bcf9133bbe8512b3c2560361e2a6 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_3568bcf9133bbe8512b3c2560361e2a6 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6))

:named refinement_kinding_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(77,27-77,54); use=MRefST.fst(77,27-77,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3568bcf9133bbe8512b3c2560361e2a6 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=MRefST.fst(77,39-77,52); use=MRefST.fst(77,39-77,52)
(Valid 
;; def=MRefST.fst(77,39-77,52); use=MRefST.fst(77,39-77,52)
(MRefST.contains @x2
@x3
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6))

:named refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3568bcf9133bbe8512b3c2560361e2a6
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(77,27-77,54); use=MRefST.fst(77,27-77,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3568bcf9133bbe8512b3c2560361e2a6 @x0
@x1
@x2)))
(Valid (Prims.hasEq (MRefHeap.mref @x0
@x1))))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_3568bcf9133bbe8512b3c2560361e2a6 @x0
@x1
@x2))))
:qid haseqTm_refine_3568bcf9133bbe8512b3c2560361e2a6))

:named haseqTm_refine_3568bcf9133bbe8512b3c2560361e2a6))


; Encoding query formula : forall (h0: MRefHeap.heap) (h1: MRefHeap.heap).
;   (*  - Could not prove post-condition
; *)
;   (forall (a: Type0) (r: MRefHeap.preorder_t a) (m: MRefHeap.mref a r).
;       MRefST.contains m h0 ==> MRefST.contains m h1) ==>
;   (forall (a: Type0).
;       (*  - Could not prove post-condition
; *)
;       forall (r: FStar.Preorder.preorder a).
;         (*  - Could not prove post-condition
; *)
;         forall (m: MRefHeap.mref a r {MRefST.contains m h0}).
;           (MRefST.contains m h0 ==> MRefHeap.contains h0 m) /\
;           (forall (any_result: m: MRefHeap.mref a r {MRefST.contains m h0}).
;               m == any_result ==>
;               (forall (any_result: a).
;                   MRefHeap.sel h0 m == any_result ==>
;                   MRefST.contains m h0 ==> MRefHeap.contains h1 m)))


; Context: While encoding a query
; While typechecking the top-level declaration `let heap_rel`
...
;; def=MRefST.fst(76,2-76,62); use=MRefST.fst(76,2-76,62)
(forall ((@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x2
Tm_type)
(HasType @x3
(MRefHeap.preorder_t @x2))
(HasType @x4
(MRefHeap.mref @x2
@x3))

;; def=MRefST.fst(76,29-76,42); use=MRefST.fst(76,29-76,42)
(Valid 
;; def=MRefST.fst(76,29-76,42); use=MRefST.fst(76,29-76,42)
(MRefST.contains @x2
@x3
...
;; def=MRefST.fst(76,48-76,61); use=MRefST.fst(76,48-76,61)
(Valid 
;; def=MRefST.fst(76,48-76,61); use=MRefST.fst(76,48-76,61)
(MRefST.contains @x2
@x3
...
;; def=dummy(0,0-0,0); use=MRefST.fst(76,2-77,81)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Tm_type)

;; def=dummy(0,0-0,0); use=MRefST.fst(77,12-77,80)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.Preorder.preorder @x2))

;; def=dummy(0,0-0,0); use=MRefST.fst(77,27-77,80)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Tm_refine_3568bcf9133bbe8512b3c2560361e2a6 @x2
@x3
...
;; def=Prims.fst(459,77-459,89); use=MRefST.fst(77,27-77,80)
(and (implies 
;; def=MRefST.fst(77,39-77,52); use=MRefST.fst(77,67-77,68)
(Valid 
;; def=MRefST.fst(77,39-77,52); use=MRefST.fst(77,67-77,68)
(MRefST.contains @x2
@x3
...
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(77,67-77,68)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=MRefST.fst(77,27-77,80)
(forall ((@x5 Term))
...
;; def=MRefHeap.fsti(52,3-52,4); use=MRefST.fst(77,27-77,80)
(= @x4
@x5)
)
...
;; def=MRefST.fst(77,39-77,52); use=MRefST.fst(77,78-77,79)
(Valid 
;; def=MRefST.fst(77,39-77,52); use=MRefST.fst(77,78-77,79)
(MRefST.contains @x2
@x3
...
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(77,78-77,79)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.heap_rel, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_MRefHeap.preorder_t, equation_MRefST.contains, refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6
...
; encoding sigelt let heap_rel


; <Start encoding let heap_rel>

(declare-fun MRefST.heap_rel (Term Term) Term)
;;;;;;;;;;;;;;;;h0: MRefHeap.heap -> h1: MRefHeap.heap -> Prims.logical
(declare-fun Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b () Term)
(declare-fun MRefST.heap_rel@tok () Term)
(declare-fun Tm_refine_3568bcf9133bbe8512b3c2560361e2a6 (Term Term Term) Term)

; </end encoding let heap_rel>


; encoding sigelt let ist_pre


; <Start encoding let ist_pre>

(declare-fun MRefST.ist_pre (Term) Term)

(declare-fun MRefST.ist_pre@tok () Term)


; </end encoding let ist_pre>


; encoding sigelt let ist_post


; <Start encoding let ist_post>

(declare-fun MRefST.ist_post (Term Term) Term)

(declare-fun MRefST.ist_post@tok () Term)
;;;;;;;;;;;;;;;;_: a & state -> Type
(declare-fun Tm_arrow_e582d335e47d6840e0aed28d317c4bc1 (Term Term) Term)

; </end encoding let ist_post>


; encoding sigelt let ist_wp


; <Start encoding let ist_wp>

(declare-fun MRefST.ist_wp (Term Term) Term)

(declare-fun MRefST.ist_wp@tok () Term)
;;;;;;;;;;;;;;;;_: ist_post state a -> ist_pre state
(declare-fun Tm_arrow_989219415dc31133d593ed11c0557957 (Term Term) Term)

; </end encoding let ist_wp>


; encoding sigelt let lift_pure_istate


; <Start encoding let lift_pure_istate>

(declare-fun MRefST.lift_pure_istate (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;state: Type ->     rel: FStar.Preorder.preorder state ->     a: Type ->     wp: Prims.pure_wp a ->     s: state ->     p: ist_post state a   -> Prims.pure_pre
(declare-fun Tm_arrow_38f19102b7f2fedbc9da30264a16b8e4 () Term)
(declare-fun MRefST.lift_pure_istate@tok () Term)

(declare-fun Tm_abs_963d181e5476598451a0d753ab150aec (Term Term Term Term) Term)

; </end encoding let lift_pure_istate>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.heap_rel; Namespace MRefST
(assert (! 
;; def=MRefST.fst(75,4-75,12); use=MRefST.fst(75,4-75,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
MRefHeap.heap)
(HasType @x1
MRefHeap.heap))
(HasType (MRefST.heap_rel @x0
@x1)
Prims.logical))
 

:pattern ((MRefST.heap_rel @x0
@x1))
:qid typing_MRefST.heap_rel))

:named typing_MRefST.heap_rel))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name MRefST.heap_rel; Namespace MRefST
(assert (! 
;; def=MRefST.fst(75,4-75,12); use=MRefST.fst(75,4-75,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT MRefST.heap_rel@tok
@x0)
@x1)
(MRefST.heap_rel @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT MRefST.heap_rel@tok
@x0)
@x1))
:qid token_correspondence_MRefST.heap_rel))

:named token_correspondence_MRefST.heap_rel))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name MRefST.heap_rel; Namespace MRefST
(assert (! 
;; def=MRefST.fst(77,27-77,54); use=MRefST.fst(77,27-77,54)
...
:named refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b
;;; Fact-ids: Name MRefST.heap_rel; Namespace MRefST
(assert (! (HasType Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b
Tm_type)
:named kinding_Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name MRefST.heap_rel; Namespace MRefST
(assert (! 
;; def=MRefST.fst(75,4-75,12); use=MRefST.fst(75,4-75,12)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MRefST.heap_rel@tok
Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b))
...
:pattern ((MRefST.heap_rel @x1
@x2))
:qid function_token_typing_MRefST.heap_rel.1))
)
 

:pattern ((ApplyTT @x0
MRefST.heap_rel@tok))
:qid function_token_typing_MRefST.heap_rel))

:named function_token_typing_MRefST.heap_rel))
;;;;;;;;;;;;;;;;Equation for MRefST.heap_rel
;;; Fact-ids: Name MRefST.heap_rel; Namespace MRefST
(assert (! 
;; def=MRefST.fst(75,4-75,12); use=MRefST.fst(75,4-75,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (MRefST.heap_rel @x0
@x1))

;; def=MRefST.fst(76,2-77,81); use=MRefST.fst(76,2-77,81)
(and 
;; def=MRefST.fst(76,2-76,62); use=MRefST.fst(76,2-76,62)
(forall ((@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x2
...
;;no pats
:qid equation_MRefST.heap_rel.1))


;; def=MRefST.fst(77,2-77,81); use=MRefST.fst(77,2-77,81)
(forall ((@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x2
Tm_type)
(HasType @x3
...
;; def=MRefST.fst(77,57-77,80); use=MRefST.fst(77,57-77,80)
(Valid 
;; def=MRefST.fst(77,57-77,80); use=MRefST.fst(77,57-77,80)
(ApplyTT (ApplyTT @x3
(MRefHeap.sel @x2
...
;;no pats
:qid equation_MRefST.heap_rel.2))
)
)
...
:pattern ((MRefST.heap_rel @x0
@x1))
:qid equation_MRefST.heap_rel))

:named equation_MRefST.heap_rel))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MRefST.heap_rel; Namespace MRefST
(assert (! 
;; def=MRefST.fst(75,17-75,31); use=MRefST.fst(75,17-76,65)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b)
...
@x1
Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b))
:qid MRefST_pre_typing_Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b))

:named MRefST_pre_typing_Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b
;;; Fact-ids: Name MRefST.heap_rel; Namespace MRefST
(assert (! 
;; def=MRefST.fst(75,17-75,31); use=MRefST.fst(75,17-76,65)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid MRefST_interpretation_Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid MRefST_interpretation_Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b))
:qid MRefST_interpretation_Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b))

:named MRefST_interpretation_Tm_arrow_5b210f47d73ba2aa451e0393c809bb7b))
(push) ;; push{2
...
MRefST.heap_rel@tok))
:named @kick_partial_app_e6b7e092e6235797c23c1f59aa6377b1))

; Encoding query formula : Prims.auto_squash (FStar.Preorder.preorder_rel MRefST.heap_rel)


; Context: While encoding a query
; While typechecking the top-level declaration `sub_effect PURE ~> ISTATE`
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Preorder.fst(33,40-33,56); use=MRefST.fst(103,50-103,58)
(or label_1

;; def=FStar.Preorder.fst(33,40-33,56); use=MRefST.fst(103,50-103,58)
(Valid 
;; def=FStar.Preorder.fst(33,40-33,56); use=MRefST.fst(103,50-103,58)
(FStar.Preorder.preorder_rel MRefHeap.heap
MRefST.heap_rel@tok)
)
)
)
...
; QUERY ID: (MRefST.0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_MRefHeap.preorder_t, equation_MRefST.contains, equation_MRefST.heap_rel, lemma_MRefST.contains_lemma, refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6, refinement_interpretation_Tm_refine_36453e3eb6145226f640e16ed9612466, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, token_correspondence_MRefST.heap_rel, typing_MRefHeap.sel
...
; encoding sigelt effect IST a pre post = MRefST.ISTATE a


; <Skipped effect IST a pre post = MRefST.ISTATE a/>


; encoding sigelt val MRefST.ist_get


; <Skipped val MRefST.ist_get/>
...
; Starting query at MRefST.fst(117,17-117,30)
...
;   (*  - Could not prove post-condition
; *)
;   forall (_: MRefHeap.heap) (p: Prims.pure_post (MRefHeap.heap & MRefHeap.heap)).
;     (forall (x: MRefHeap.heap) (s1: MRefHeap.heap). _ == x /\ x == s1 ==> p (x, s1)) ==> p (_, _)


; Context: While encoding a query
; While typechecking the top-level declaration `let ist_get`
...
;; def=dummy(0,0-0,0); use=MRefST.fst(117,17-117,30)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
MRefHeap.heap)
(HasType @x2
(Prims.pure_post (FStar.Pervasives.Native.tuple2 MRefHeap.heap
MRefHeap.heap)))

;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(117,17-117,30)
...
;; def=MRefST.fst(116,68-116,75); use=MRefST.fst(117,17-117,30)
(= @x1
@x3)


;; def=MRefST.fst(116,79-116,86); use=MRefST.fst(117,17-117,30)
(= @x3
@x4)
)

;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(117,17-117,30)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(117,17-117,30)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 MRefHeap.heap
MRefHeap.heap
@x3
@x4))
)
...
;; def=MRefST.fst(39,11-39,15); use=MRefST.fst(117,25-117,28)
(or label_1
...
; encoding sigelt let ist_get


; <Start encoding let ist_get>

(declare-fun MRefST.ist_get (Term) Term)
(declare-fun Non_total_Tm_arrow_b9665f1c8e4a8e7d4edb86b5ce301a8a () Term)
(declare-fun MRefST.ist_get@tok () Term)
(declare-fun Tm_refine_10ec071070ae57042c0afd71117e9924 (Term) Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.PURE (MRefHeap.heap & MRefHeap.heap)
(declare-fun Tm_arrow_eef770eed746a7a00a06c591f5f4aff7 () Term)

; </end encoding let ist_get>


; encoding sigelt val MRefST.ist_put


; <Skipped val MRefST.ist_put/>
...
:named haseqTm_refine_3568bcf9133bbe8512b3c2560361e2a6))
;;;;;;;;;;;;;;;;Prop-typing for MRefST.heap_rel
;;; Fact-ids: Name MRefST.heap_rel; Namespace MRefST
(assert (! 
;; def=MRefST.fst(75,4-75,12); use=MRefST.fst(75,4-75,12)
(forall ((@x0 Term) (@x1 Term))
...
(HasType @x1
MRefHeap.heap))
(Valid (Prims.subtype_of (MRefST.heap_rel @x0
@x1)
Prims.unit)))
 

:pattern ((Prims.subtype_of (MRefST.heap_rel @x0
@x1)
Prims.unit))
:qid defn_equation_MRefST.heap_rel))

:named defn_equation_MRefST.heap_rel))
(push) ;; push{2

; Starting query at MRefST.fst(121,16-121,29)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: MRefHeap.heap).
;   (*  - Could not prove post-condition
; *)
;   forall (_: MRefHeap.heap) (p: Prims.pure_post (Prims.unit & MRefHeap.heap)).
;     MRefST.heap_rel _ x /\
;     (forall (x: Prims.unit) (s1: MRefHeap.heap). MRefST.heap_rel _ x /\ s1 == x ==> p (x, s1)) ==>
;     p ((), x)


; Context: While encoding a query
; While typechecking the top-level declaration `let ist_put`
...
;; def=dummy(0,0-0,0); use=MRefST.fst(121,16-121,29)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
MRefHeap.heap)
(HasType @x2
...
;; def=MRefST.fst(120,24-120,37); use=MRefST.fst(121,16-121,29)
(Valid 
;; def=MRefST.fst(120,24-120,37); use=MRefST.fst(121,16-121,29)
(MRefST.heap_rel @x1
@x0)
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(121,16-121,29)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
Prims.unit)
(HasType @x4
...
;; def=MRefST.fst(120,55-120,62); use=MRefST.fst(121,16-121,29)
(= @x4
@x0)
)

;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(121,16-121,29)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(121,16-121,29)
(ApplyTT @x2
...
;; def=MRefST.fst(42,11-42,16); use=MRefST.fst(121,24-121,27)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.ist_put, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, unit_typing
...
; encoding sigelt let ist_put


; <Start encoding let ist_put>

(declare-fun MRefST.ist_put (Term) Term)
(declare-fun Non_total_Tm_arrow_717151ddb804530db338a75aa9b9834b () Term)
(declare-fun MRefST.ist_put@tok () Term)
(declare-fun Tm_refine_08a236117b4c56555a41346b57fda92e (Term Term) Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.PURE (Prims.unit & MRefHeap.heap)
(declare-fun Tm_arrow_dce5a84c97ac1a0e100c40b73d068094 (Term) Term)

; </end encoding let ist_put>
...
; Starting query at MRefST.fst(125,58-125,78)
...
MRefST.heap_rel@tok))
:named @kick_partial_app_e6b7e092e6235797c23c1f59aa6377b1))
(declare-fun Tm_refine_563c70843de6809436d12e24a4945aee () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_563c70843de6809436d12e24a4945aee
Tm_type)
:named refinement_kinding_Tm_refine_563c70843de6809436d12e24a4945aee))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(125,18-125,55); use=MRefST.fst(125,18-125,55)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_563c70843de6809436d12e24a4945aee)
(and (HasTypeFuel @u0
@x1
(FStar.Preorder.predicate MRefHeap.heap))

;; def=MRefST.fst(125,36-125,53); use=MRefST.fst(125,36-125,53)
(Valid 
;; def=MRefST.fst(125,36-125,53); use=MRefST.fst(125,36-125,53)
(FStar.Preorder.stable MRefHeap.heap
@x1
MRefST.heap_rel@tok)
)
))
...
@x1
Tm_refine_563c70843de6809436d12e24a4945aee))
:qid refinement_interpretation_Tm_refine_563c70843de6809436d12e24a4945aee))

:named refinement_interpretation_Tm_refine_563c70843de6809436d12e24a4945aee))
;;;;;;;;;;;;;;;;haseq for Tm_refine_563c70843de6809436d12e24a4945aee
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_563c70843de6809436d12e24a4945aee))
(Valid (Prims.hasEq (FStar.Preorder.predicate MRefHeap.heap))))
:named haseqTm_refine_563c70843de6809436d12e24a4945aee))


; Encoding query formula : forall (p: FStar.Preorder.predicate MRefHeap.heap {FStar.Preorder.stable p MRefST.heap_rel}).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash (FStar.Preorder.preorder_rel MRefST.heap_rel)


; Context: While encoding a query
; While typechecking the top-level declaration `let ist_witnessed`
...
;; def=FStar.Preorder.fst(33,40-33,56); use=MRefST.fst(125,68-125,76)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.ist_witnessed, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_MRefHeap.preorder_t, equation_MRefST.contains, equation_MRefST.heap_rel, lemma_MRefST.contains_lemma, refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6, refinement_interpretation_Tm_refine_36453e3eb6145226f640e16ed9612466, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, token_correspondence_MRefST.heap_rel, typing_MRefHeap.sel
...
; Starting query at MRefST.fst(125,0-125,78)
...
; Encoding query formula : forall (p: FStar.Preorder.predicate MRefHeap.heap).
;   (*  - Subtyping check failed
;   - Expected type
;       rel:
;       FStar.Preorder.relation MRefHeap.heap {FStar.Preorder.preorder_rel rel}
;     got type h0: MRefHeap.heap -> h1: MRefHeap.heap -> Prims.logical
; *)
;   Prims.auto_squash (FStar.Preorder.preorder_rel MRefST.heap_rel)
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MRefST.fst(125,58-125,78)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate MRefHeap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=MRefST.fst(125,45-125,53)
(or label_1

;; def=FStar.Preorder.fst(35,53-35,69); use=MRefST.fst(125,58-125,78)
(Valid 
;; def=FStar.Preorder.fst(35,53-35,69); use=MRefST.fst(125,58-125,78)
(FStar.Preorder.preorder_rel MRefHeap.heap
MRefST.heap_rel@tok)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.ist_witnessed, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_MRefHeap.preorder_t, equation_MRefST.contains, equation_MRefST.heap_rel, lemma_MRefST.contains_lemma, refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6, refinement_interpretation_Tm_refine_36453e3eb6145226f640e16ed9612466, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, token_correspondence_MRefST.heap_rel, typing_MRefHeap.sel
...
; encoding sigelt let ist_witnessed


; <Start encoding let ist_witnessed>

(declare-fun Tm_refine_563c70843de6809436d12e24a4945aee () Term)
(declare-fun MRefST.ist_witnessed (Term) Term)


;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate MRefHeap.heap {FStar.Preorder.stable p heap_rel} -> Type
(declare-fun Tm_arrow_6c164af0f4bc9b9d447fc20e5f7a064e () Term)
(declare-fun MRefST.ist_witnessed@tok () Term)




; </end encoding let ist_witnessed>

;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name MRefST.ist_witnessed; Namespace MRefST
(assert (! (Valid (ApplyTT __uu__PartialApp
MRefST.heap_rel@tok))
:named @kick_partial_app_e6b7e092e6235797c23c1f59aa6377b1))
(push) ;; push{2

; Starting query at MRefST.fst(127,7-128,81)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val MRefST.ist_witness`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MRefST.fst(127,25-128,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate MRefHeap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=MRefST.fst(127,51-127,59)
(or label_1
...
; encoding sigelt val MRefST.ist_witness


; <Start encoding val MRefST.ist_witness>



(declare-fun MRefST.ist_witness (Term) Term)
(declare-fun Non_total_Tm_arrow_fba461d43f412afb0a723e88183cd06d () Term)
(declare-fun MRefST.ist_witness@tok () Term)
(declare-fun Tm_refine_04086d969bbac74ce551bc0694b2ba76 (Term Term) Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.PURE (Prims.unit & MRefHeap.heap)
(declare-fun Tm_arrow_910811ad378f6df664e0b896aeeb3927 (Term) Term)

; </end encoding val MRefST.ist_witness>

(push) ;; push{2

; Starting query at MRefST.fst(131,7-132,80)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val MRefST.ist_recall`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MRefST.fst(131,25-132,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate MRefHeap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=MRefST.fst(131,51-131,59)
(or label_1
...
; encoding sigelt val MRefST.ist_recall


; <Start encoding val MRefST.ist_recall>



(declare-fun MRefST.ist_recall (Term) Term)
(declare-fun Non_total_Tm_arrow_b9465fab0f3b0a3aadc8a22160939587 () Term)
(declare-fun MRefST.ist_recall@tok () Term)
(declare-fun Tm_refine_da555e8303ced427eae4fef2d1b32233 (Term Term) Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.PURE (Prims.unit & MRefHeap.heap)
(declare-fun Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489 (Term) Term)

; </end encoding val MRefST.ist_recall>


; encoding sigelt let mref0


; <Start encoding let mref0>

(declare-fun MRefST.mref0 (Term Term) Term)

(declare-fun MRefST.mref0@tok () Term)

; </end encoding let mref0>
...
;; def=MRefST.fst(61,4-61,12); use=MRefST.fst(61,4-61,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_MRefST.contains))

:named token_correspondence_MRefST.contains))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e
;;; Fact-ids: Name MRefST.contains; Namespace MRefST
(assert (! (HasType Tm_arrow_8ff4538f6e47374cca3174ef0666d15e
Tm_type)
:named kinding_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name MRefST.contains; Namespace MRefST
(assert (! 
;; def=MRefST.fst(61,4-61,12); use=MRefST.fst(61,4-61,12)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MRefST.contains@tok
Tm_arrow_8ff4538f6e47374cca3174ef0666d15e))
...
:pattern ((MRefST.contains @x1
@x2
@x3
@x4))
:qid function_token_typing_MRefST.contains.1))
)
 

:pattern ((ApplyTT @x0
MRefST.contains@tok))
:qid function_token_typing_MRefST.contains))

:named function_token_typing_MRefST.contains))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MRefST.contains; Namespace MRefST
(assert (! 
;; def=MRefST.fst(61,17-61,59); use=MRefST.fst(61,17-61,71)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8ff4538f6e47374cca3174ef0666d15e)
...
@x1
Tm_arrow_8ff4538f6e47374cca3174ef0666d15e))
:qid MRefST_pre_typing_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e))

:named MRefST_pre_typing_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e
;;; Fact-ids: Name MRefST.contains; Namespace MRefST
(assert (! 
;; def=MRefST.fst(61,17-61,59); use=MRefST.fst(61,17-61,71)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid MRefST_interpretation_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid MRefST_interpretation_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e.2))
...
@x1)
@x2))
:qid MRefST_interpretation_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e.3))
...
@x2)
@x3))
:qid MRefST_interpretation_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_8ff4538f6e47374cca3174ef0666d15e))
:qid MRefST_interpretation_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e))

:named MRefST_interpretation_Tm_arrow_8ff4538f6e47374cca3174ef0666d15e))
(push) ;; push{2

; Starting query at MRefST.fst(140,36-140,74)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
MRefST.contains@tok))
:named @kick_partial_app_84d767ed3ad1947690e7415ced71ad39))


; Encoding query formula : forall (a: Type) (r: FStar.Preorder.preorder a) (m: MRefHeap.mref a r).
;   (*  - Subtyping check failed
;   - Expected type
;       p:
;       FStar.Preorder.predicate MRefHeap.heap {FStar.Preorder.stable p heap_rel}
;     got type h: MRefHeap.heap -> Type0
; *)
;   Prims.auto_squash (FStar.Preorder.stable (MRefST.contains m) MRefST.heap_rel)


; Context: While encoding a query
; While typechecking the top-level declaration `let mref`
...
;; def=MRefST.fst(125,36-125,53); use=MRefST.fst(140,61-140,73)
(or label_1
...
;; def=MRefST.fst(125,36-125,53); use=MRefST.fst(140,61-140,73)
(FStar.Preorder.stable MRefHeap.heap
(ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
@x1)
@x2)
MRefST.heap_rel@tok)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.mref, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.Preorder.stable, equation_MRefHeap.preorder_t, equation_MRefST.heap_rel, token_correspondence_MRefST.contains, token_correspondence_MRefST.heap_rel
...
(declare-fun MRefST.mref (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> r: FStar.Preorder.preorder a -> Type
(declare-fun Tm_arrow_5bf0606d629ecb30adc0c556c248cd8a () Term)
(declare-fun MRefST.mref@tok () Term)
(declare-fun Tm_refine_da9cbab0485332770e2f963089e2dda6 (Term Term) Term)

; </end encoding let mref>


; encoding sigelt let st_pre


; <Start encoding let st_pre>

(declare-fun MRefST.st_pre () Term)


; </end encoding let st_pre>


; encoding sigelt let st_post


; <Start encoding let st_post>

(declare-fun MRefST.st_post (Term) Term)

(declare-fun MRefST.st_post@tok () Term)
;;;;;;;;;;;;;;;;_: a -> _: MRefHeap.heap -> Type
(declare-fun Tm_arrow_2815b0b267f771e1a7a0276ceffaed01 (Term) Term)

; </end encoding let st_post>


; encoding sigelt let st_wp


; <Start encoding let st_wp>

(declare-fun MRefST.st_wp (Term) Term)

(declare-fun MRefST.st_wp@tok () Term)
;;;;;;;;;;;;;;;;_: st_post a -> st_pre
(declare-fun Tm_arrow_f17de417e51aa138e254463a91fba3a1 (Term) Term)

; </end encoding let st_wp>


; encoding sigelt effect MRefST a pre post = MRefST.IST a


; <Skipped effect MRefST a pre post = MRefST.IST a/>


; encoding sigelt val MRefST.alloc


; <Skipped val MRefST.alloc/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.mref; Namespace MRefST
(assert (! 
;; def=MRefST.fst(140,5-140,9); use=MRefST.fst(140,5-140,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(FStar.Preorder.preorder @x0)))
(HasType (MRefST.mref @x0
@x1)
Tm_type))
 

:pattern ((MRefST.mref @x0
@x1))
:qid typing_MRefST.mref))

:named typing_MRefST.mref))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.ist_witnessed; Namespace MRefST
(assert (! 
;; def=MRefST.fst(125,4-125,17); use=MRefST.fst(125,4-125,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_563c70843de6809436d12e24a4945aee)
(HasType (MRefST.ist_witnessed @x0)
Tm_type))
 

:pattern ((MRefST.ist_witnessed @x0))
:qid typing_MRefST.ist_witnessed))

:named typing_MRefST.ist_witnessed))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefHeap.alloc_ref; Namespace MRefHeap
(assert (! 
;; def=MRefHeap.fsti(58,4-58,13); use=MRefHeap.fsti(58,4-58,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
MRefHeap.heap)
(HasType @x1
...
(HasType @x3
@x1))
(HasType (MRefHeap.alloc_ref @x0
@x1
@x2
@x3)
(Tm_refine_f07337a29cfe3dbf224739cd84fc5577 @x1
@x2
@x0
@x3)))
 

:pattern ((MRefHeap.alloc_ref @x0
@x1
@x2
@x3))
:qid typing_MRefHeap.alloc_ref))

:named typing_MRefHeap.alloc_ref))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name MRefHeap.alloc_ref; Namespace MRefHeap
(assert (! 
;; def=MRefHeap.fsti(62,6-72,51); use=MRefHeap.fsti(62,6-72,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_f07337a29cfe3dbf224739cd84fc5577 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_f07337a29cfe3dbf224739cd84fc5577 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_f07337a29cfe3dbf224739cd84fc5577))

:named refinement_kinding_Tm_refine_f07337a29cfe3dbf224739cd84fc5577))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name MRefST.mref; Namespace MRefST
(assert (! 
;; def=MRefST.fst(140,36-140,74); use=MRefST.fst(140,36-140,74)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_da9cbab0485332770e2f963089e2dda6 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_da9cbab0485332770e2f963089e2dda6 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_da9cbab0485332770e2f963089e2dda6))

:named refinement_kinding_Tm_refine_da9cbab0485332770e2f963089e2dda6))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name MRefST.ist_witnessed; Namespace MRefST
(assert (! (HasType Tm_refine_563c70843de6809436d12e24a4945aee
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f07337a29cfe3dbf224739cd84fc5577 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (MRefHeap.mref @x2
@x3)
MRefHeap.heap))
...
@x3
@x4
(FStar.Pervasives.Native.fst (MRefHeap.mref @x2
@x3)
MRefHeap.heap
@x1))
)
...
(MRefHeap.contains @x2
@x3
(FStar.Pervasives.Native.snd (MRefHeap.mref @x2
@x3)
MRefHeap.heap
@x1)
(FStar.Pervasives.Native.fst (MRefHeap.mref @x2
...
;;no pats
:qid refinement_interpretation_Tm_refine_f07337a29cfe3dbf224739cd84fc5577.1))


;; def=MRefHeap.fsti(69,22-72,49); use=MRefHeap.fsti(69,22-72,49)
...
;; def=MRefHeap.fsti(72,25-72,48); use=MRefHeap.fsti(72,25-72,48)
(= (MRefHeap.sel @x6
@x7
(FStar.Pervasives.Native.snd (MRefHeap.mref @x2
@x3)
...
;;no pats
:qid refinement_interpretation_Tm_refine_f07337a29cfe3dbf224739cd84fc5577.2))
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_f07337a29cfe3dbf224739cd84fc5577))

:named refinement_interpretation_Tm_refine_f07337a29cfe3dbf224739cd84fc5577))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name MRefST.mref; Namespace MRefST
(assert (! 
;; def=MRefST.fst(140,36-140,74); use=MRefST.fst(140,36-140,74)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_da9cbab0485332770e2f963089e2dda6 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(MRefHeap.mref @x2
...
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(140,47-140,73)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(140,47-140,73)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x2)
@x3)
@x1))
)
...
(Tm_refine_da9cbab0485332770e2f963089e2dda6 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_da9cbab0485332770e2f963089e2dda6))

:named refinement_interpretation_Tm_refine_da9cbab0485332770e2f963089e2dda6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name MRefST.ist_witnessed; Namespace MRefST
(assert (! 
;; def=MRefST.fst(125,18-125,55); use=MRefST.fst(125,18-125,55)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_f07337a29cfe3dbf224739cd84fc5577
;;; Fact-ids: Name MRefHeap.alloc_ref; Namespace MRefHeap
(assert (! 
;; def=MRefHeap.fsti(62,6-72,51); use=MRefHeap.fsti(62,6-72,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f07337a29cfe3dbf224739cd84fc5577 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (MRefHeap.mref @x0
@x1)
MRefHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f07337a29cfe3dbf224739cd84fc5577 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_f07337a29cfe3dbf224739cd84fc5577))

:named haseqTm_refine_f07337a29cfe3dbf224739cd84fc5577))
;;;;;;;;;;;;;;;;haseq for Tm_refine_da9cbab0485332770e2f963089e2dda6
;;; Fact-ids: Name MRefST.mref; Namespace MRefST
(assert (! 
;; def=MRefST.fst(140,36-140,74); use=MRefST.fst(140,36-140,74)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_da9cbab0485332770e2f963089e2dda6 @x0
@x1)))
(Valid (Prims.hasEq (MRefHeap.mref @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_da9cbab0485332770e2f963089e2dda6 @x0
@x1))))
:qid haseqTm_refine_da9cbab0485332770e2f963089e2dda6))

:named haseqTm_refine_da9cbab0485332770e2f963089e2dda6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_563c70843de6809436d12e24a4945aee
;;; Fact-ids: Name MRefST.ist_witnessed; Namespace MRefST
(assert (! (iff (Valid (Prims.hasEq Tm_refine_563c70843de6809436d12e24a4945aee))
(Valid (Prims.hasEq (FStar.Preorder.predicate MRefHeap.heap))))
:named haseqTm_refine_563c70843de6809436d12e24a4945aee))
;;;;;;;;;;;;;;;;Equation for MRefST.mref
;;; Fact-ids: Name MRefST.mref; Namespace MRefST
(assert (! 
;; def=MRefST.fst(140,5-140,9); use=MRefST.fst(140,5-140,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (MRefST.mref @x0
@x1)
(Tm_refine_da9cbab0485332770e2f963089e2dda6 @x0
@x1))
 

:pattern ((MRefST.mref @x0
@x1))
:qid equation_MRefST.mref))

:named equation_MRefST.mref))
;;;;;;;;;;;;;;;;Equation for MRefST.ist_witnessed
;;; Fact-ids: Name MRefST.ist_witnessed; Namespace MRefST
(assert (! 
;; def=MRefST.fst(125,4-125,17); use=MRefST.fst(125,4-125,17)
(forall ((@x0 Term))
 (! (= (MRefST.ist_witnessed @x0)
(FStar.Monotonic.Witnessed.witnessed MRefHeap.heap
MRefST.heap_rel@tok
@x0))
 

:pattern ((MRefST.ist_witnessed @x0))
:qid equation_MRefST.ist_witnessed))

:named equation_MRefST.ist_witnessed))
...
; Starting query at MRefST.fst(168,18-173,9)
...
; Encoding query formula : forall (a: Type) (r: FStar.Preorder.preorder a) (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (_: MRefHeap.heap) (p: Prims.pure_post (MRefST.mref a r & MRefHeap.heap)).
;     (forall (x: MRefST.mref a r) (s1: MRefHeap.heap).
;         ~(MRefST.contains x _) /\ FStar.Pervasives.Native.fst (MRefHeap.alloc_ref _ a r x) == x /\
;         FStar.Pervasives.Native.snd (MRefHeap.alloc_ref _ a r x) == s1 ==>
;         p (x, s1)) ==>
;     (forall (x: MRefHeap.heap) (s1: MRefHeap.heap).
;         _ == x /\ x == s1 ==>
;         (forall (mh1: MRefHeap.mref a r & MRefHeap.heap).
;             (~(MRefHeap.contains x (FStar.Pervasives.Native.fst mh1)) /\
...
;                   MRefHeap.contains x m ==> MRefHeap.contains (FStar.Pervasives.Native.snd mh1) m) ==>
;               (forall (b: Type0).
;                   (*  - Could not prove post-condition
; *)
...
;                     (*  - Could not prove post-condition
; *)
;                     forall (m: MRefHeap.mref b r' {MRefHeap.contains x m}).
;                       (*  - Could not prove post-condition
; *)
;                       forall (y: b).
;                         MRefHeap.sel x m == y ==>
;                         MRefHeap.contains x m ==>
;                         MRefHeap.contains (FStar.Pervasives.Native.snd mh1) m))) /\
;         (forall (any_result:
;             mh1:
;             (MRefHeap.mref a r & MRefHeap.heap)
;               { ~(MRefHeap.contains x (FStar.Pervasives.Native.fst mh1)) /\
;                 MRefHeap.contains (FStar.Pervasives.Native.snd mh1)
;                   (FStar.Pervasives.Native.fst mh1) /\
;                 MRefHeap.sel (FStar.Pervasives.Native.snd mh1) (FStar.Pervasives.Native.fst mh1) ==
;                 x /\
;                 (forall (b: Type0) (r': MRefHeap.preorder_t b) (m: MRefHeap.mref b r').
;                     MRefHeap.contains x m ==> MRefHeap.contains (FStar.Pervasives.Native.snd mh1) m) /\
;                 (forall (b: Type0)
;                     (r': MRefHeap.preorder_t b)
;                     (m: MRefHeap.mref b r' {MRefHeap.contains x m})
;                     (y: b).
;                     MRefHeap.sel x m == y ==> MRefHeap.sel (FStar.Pervasives.Native.snd mh1) m == y)
;               }).
;             MRefHeap.alloc_ref x a r x == any_result ==>
;             MRefST.heap_rel s1 (FStar.Pervasives.Native.snd (MRefHeap.alloc_ref x a r x)) /\
;             (forall (x: Prims.unit) (s1: MRefHeap.heap).
;                 MRefST.heap_rel s1 (FStar.Pervasives.Native.snd (MRefHeap.alloc_ref x a r x)) /\
;                 s1 == FStar.Pervasives.Native.snd (MRefHeap.alloc_ref x a r x) ==>
;                 Prims.auto_squash (FStar.Preorder.stable (MRefST.contains (FStar.Pervasives.Native.fst
;                               (MRefHeap.alloc_ref x a r x)))
;                       MRefST.heap_rel) /\
;                 (forall (return_val:
;                     p:
;                     FStar.Preorder.predicate MRefHeap.heap {FStar.Preorder.stable p MRefST.heap_rel})
;                   .
;                     return_val ==
;                     MRefST.contains (FStar.Pervasives.Native.fst (MRefHeap.alloc_ref x a r x)) ==>
;                     MRefST.contains (FStar.Pervasives.Native.fst (MRefHeap.alloc_ref x a r x)) s1 /\
;                     (forall (x: Prims.unit) (s1: MRefHeap.heap).
;                         MRefST.contains (FStar.Pervasives.Native.fst (MRefHeap.alloc_ref x a r x))
;                           s1 /\
;                         (s1 == s1) /\
;                         MRefST.ist_witnessed (MRefST.contains (FStar.Pervasives.Native.fst (MRefHeap.alloc_ref
;                                       x
;                                       a
;                                       r
;                                       x))) ==>
;                         Prims.auto_squash (MRefST.ist_witnessed (MRefST.contains (FStar.Pervasives.Native.fst
;                                       (MRefHeap.alloc_ref x a r x)))) /\
;                         (forall (return_val: MRefST.mref a r).
;                             return_val == FStar.Pervasives.Native.fst (MRefHeap.alloc_ref x a r x) ==>
;                             return_val == FStar.Pervasives.Native.fst (MRefHeap.alloc_ref x a r x) ==>
;                             p (return_val, s1)))))
;             <:
;             Type0))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let alloc`
...
;; def=dummy(0,0-0,0); use=MRefST.fst(168,18-173,9)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
MRefHeap.heap)
(HasType @x4
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (MRefST.mref @x0
@x1)
MRefHeap.heap)))

;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(168,18-173,9)
...
;; def=MRefST.fst(165,46-165,62); use=MRefST.fst(168,18-173,9)
(not 
;; def=MRefST.fst(165,47-165,62); use=MRefST.fst(168,18-173,9)
(Valid 
;; def=MRefST.fst(165,47-165,62); use=MRefST.fst(168,18-173,9)
(MRefST.contains @x0
@x1
...
;; def=MRefST.fst(166,11-166,40); use=MRefST.fst(168,18-173,9)
(= (FStar.Pervasives.Native.fst (MRefHeap.mref @x0
@x1)
MRefHeap.heap
(MRefHeap.alloc_ref @x3
@x0
@x1
@x2))
@x5)
...
;; def=MRefST.fst(167,11-167,41); use=MRefST.fst(168,18-173,9)
(= (FStar.Pervasives.Native.snd (MRefHeap.mref @x0
@x1)
MRefHeap.heap
(MRefHeap.alloc_ref @x3
@x0
...
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(168,18-173,9)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(168,18-173,9)
(ApplyTT @x4
(FStar.Pervasives.Native.Mktuple2 (MRefST.mref @x0
@x1)
MRefHeap.heap
@x5
@x6))
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(169,11-169,18)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
MRefHeap.heap)
(HasType @x6
...
;; def=MRefST.fst(116,68-116,75); use=MRefST.fst(169,11-169,18)
(= @x3
@x5)


;; def=MRefST.fst(116,79-116,86); use=MRefST.fst(169,11-169,18)
(= @x5
@x6)
)

;; def=Prims.fst(459,77-459,89); use=MRefST.fst(168,18-173,9)
(and 
;; def=dummy(0,0-0,0); use=MRefST.fst(169,24-173,9)
(forall ((@x7 Term))
 (! (implies (HasType @x7
(FStar.Pervasives.Native.tuple2 (MRefHeap.mref @x0
@x1)
MRefHeap.heap))

;; def=dummy(0,0-0,0); use=MRefST.fst(170,12-170,21)
(and (implies 
;; def=MRefHeap.fsti(62,29-63,57); use=MRefST.fst(170,12-170,21)
(and 
;; def=MRefHeap.fsti(62,29-62,59); use=MRefST.fst(170,12-170,21)
(not 
;; def=MRefHeap.fsti(62,30-62,59); use=MRefST.fst(170,12-170,21)
(Valid 
;; def=MRefHeap.fsti(62,30-62,59); use=MRefST.fst(170,12-170,21)
(MRefHeap.contains @x0
@x1
...
;; def=MRefHeap.fsti(63,29-63,57); use=MRefST.fst(170,12-170,21)
(Valid 
;; def=MRefHeap.fsti(63,29-63,57); use=MRefST.fst(170,12-170,21)
(MRefHeap.contains @x0
@x1
...
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(170,12-170,21)
(or label_1
...
(implies 
;; def=MRefHeap.fsti(62,29-68,46); use=MRefST.fst(170,12-170,21)
(and 
;; def=MRefHeap.fsti(62,29-62,59); use=MRefST.fst(170,12-170,21)
(not 
;; def=MRefHeap.fsti(62,30-62,59); use=MRefST.fst(170,12-170,21)
...
;; def=MRefHeap.fsti(64,29-64,57); use=MRefST.fst(170,12-170,21)
(= (MRefHeap.sel @x0
@x1
(FStar.Pervasives.Native.snd (MRefHeap.mref @x0
@x1)
...
;; def=MRefHeap.fsti(65,8-68,46); use=MRefST.fst(170,12-170,21)
(forall ((@x8 Term) (@x9 Term) (@x10 Term))
 (! (implies (and (HasType @x8
Tm_type)
(HasType @x9
(MRefHeap.preorder_t @x8))
(HasType @x10
(MRefHeap.mref @x8
@x9))

;; def=MRefHeap.fsti(66,25-66,38); use=MRefST.fst(170,12-170,21)
(Valid 
;; def=MRefHeap.fsti(66,25-66,38); use=MRefST.fst(170,12-170,21)
(MRefHeap.contains @x8
@x9
@x5
@x10)
)
...
;; def=MRefHeap.fsti(68,25-68,45); use=MRefST.fst(170,12-170,21)
(Valid 
;; def=MRefHeap.fsti(68,25-68,45); use=MRefST.fst(170,12-170,21)
(MRefHeap.contains @x8
@x9
...
(forall ((@x10 Term))
 (! (implies (HasType @x10
(Tm_refine_36453e3eb6145226f640e16ed9612466 @x8
@x9
@x5))
...
;; def=MRefHeap.fsti(70,25-70,41); use=MRefST.fst(170,12-170,21)
(= (MRefHeap.sel @x8
@x9
@x5
@x10)
...
;; def=MRefHeap.fsti(69,48-69,61); use=MRefST.fst(170,12-170,21)
(Valid 
;; def=MRefHeap.fsti(69,48-69,61); use=MRefST.fst(170,12-170,21)
(MRefHeap.contains @x8
@x9
...
;; def=Prims.fst(451,66-451,102); use=MRefST.fst(168,18-173,9)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Tm_refine_f07337a29cfe3dbf224739cd84fc5577 @x0
@x1
@x5
@x2))

;; def=MRefST.fst(170,6-170,30); use=MRefST.fst(170,6-170,30)
(= (MRefHeap.alloc_ref @x5
@x0
@x1
@x2)
@x7)
...
;; def=MRefST.fst(112,29-112,91); use=MRefST.fst(171,2-171,9)
(and 
;; def=MRefST.fst(120,24-120,37); use=MRefST.fst(171,2-171,9)
(or label_3
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(171,2-171,9)
...
;; def=MRefST.fst(120,55-120,62); use=MRefST.fst(171,2-171,9)
(= @x9
(FStar.Pervasives.Native.snd (MRefHeap.mref @x0
@x1)
MRefHeap.heap
...
;; def=Prims.fst(459,77-459,89); use=MRefST.fst(168,18-173,9)
(and 
;; def=MRefST.fst(127,42-127,59); use=MRefST.fst(172,14-172,34)
(or label_4
...
;; def=Prims.fst(356,2-356,58); use=MRefST.fst(168,18-173,9)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Tm_refine_563c70843de6809436d12e24a4945aee)

;; def=Prims.fst(356,26-356,41); use=MRefST.fst(168,18-173,9)
(= @x10
(ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
@x1)
...
;; def=MRefST.fst(112,29-112,91); use=MRefST.fst(172,2-172,13)
(and 
;; def=MRefST.fst(128,31-128,35); use=MRefST.fst(172,2-172,13)
(or label_5
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(172,2-172,13)
...
;; def=MRefST.fst(128,53-128,61); use=MRefST.fst(172,2-172,13)
(= @x9
@x12)


;; def=MRefST.fst(128,65-128,80); use=MRefST.fst(172,2-172,13)
(Valid 
;; def=MRefST.fst(128,65-128,80); use=MRefST.fst(172,2-172,13)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
...
;; def=Prims.fst(459,77-459,89); use=MRefST.fst(168,18-173,9)
(and 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(173,2-173,9)
(or label_6
...
;; def=MRefST.fst(164,12-173,9); use=MRefST.fst(168,18-173,9)
(= @x13
(FStar.Pervasives.Native.fst (MRefHeap.mref @x0
@x1)
MRefHeap.heap
...
;; def=MRefST.fst(30,29-30,33); use=MRefST.fst(168,18-173,9)
(or label_7
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.alloc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.stable, equation_MRefHeap.preorder_t, equation_MRefST.contains, equation_MRefST.heap_rel, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, lemma_MRefST.contains_lemma, refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6, refinement_interpretation_Tm_refine_36453e3eb6145226f640e16ed9612466, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, refinement_interpretation_Tm_refine_f07337a29cfe3dbf224739cd84fc5577, token_correspondence_MRefST.contains, token_correspondence_MRefST.heap_rel, typing_FStar.Pervasives.Native.fst, typing_FStar.Pervasives.Native.snd, typing_MRefHeap.heap, typing_MRefHeap.mref, typing_MRefHeap.sel
...
; encoding sigelt let alloc


; <Start encoding let alloc>

(declare-fun MRefST.alloc (Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_e2e640097b779e039503461faccc6309 () Term)
(declare-fun MRefST.alloc@tok () Term)
(declare-fun Tm_refine_8fa6ed8c9af137cee52e5dfe43f8a28e (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.PURE (mref a r & MRefHeap.heap)
(declare-fun Tm_arrow_29da3f85fe1cdd3d1e2a3c72aca6776a (Term Term Term) Term)
...
; Starting query at MRefST.fst(176,0-182,22)
...
;   (*  - Could not prove post-condition
; *)
;   h0 == h1 /\ MRefST.contains m h1 ==>
;   MRefST.ist_witnessed (MRefST.contains m) ==> MRefHeap.contains h1 m


; Context: While encoding a query
; While typechecking the top-level declaration `val MRefST.read`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MRefST.fst(176,0-182,22)
...
;; def=MRefST.fst(180,36-180,44); use=MRefST.fst(176,14-179,12)
(= @x3
@x5)


;; def=MRefST.fst(181,22-181,35); use=MRefST.fst(176,14-179,12)
(Valid 
;; def=MRefST.fst(181,22-181,35); use=MRefST.fst(176,14-179,12)
(MRefST.contains @x0
@x1
...
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(176,14-179,12)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(176,14-179,12)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
...
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(182,15-182,16)
(or label_1

;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(176,14-179,12)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(176,14-179,12)
(MRefHeap.contains @x0
@x1
...
; encoding sigelt val MRefST.read


; <Skipped val MRefST.read/>

(push) ;; push{2

; Starting query at MRefST.fst(183,18-186,9)
...
; Encoding query formula : forall (a: Type) (r: FStar.Preorder.preorder a) (m: MRefST.mref a r).
;   (*  - Could not prove post-condition
; *)
;   forall (_: MRefHeap.heap) (p: Prims.pure_post (a & MRefHeap.heap)).
;     (forall (x: a) (s1: MRefHeap.heap).
;         _ == s1 /\ MRefST.contains m s1 /\ MRefHeap.sel s1 m == x ==> p (x, s1)) ==>
;     (forall (x: MRefHeap.heap) (s1: MRefHeap.heap).
;         _ == x /\ x == s1 ==>
;         Prims.auto_squash (FStar.Preorder.stable (MRefST.contains m) MRefST.heap_rel) /\
;         (forall (return_val:
;             p: FStar.Preorder.predicate MRefHeap.heap {FStar.Preorder.stable p MRefST.heap_rel}).
;             return_val == MRefST.contains m ==>
;             MRefST.ist_witnessed (MRefST.contains m) /\
;             (forall (x: Prims.unit) (s1: MRefHeap.heap).
;                 MRefST.ist_witnessed (MRefST.contains m) /\ (s1 == s1) /\ MRefST.contains m s1 ==>
;                 (MRefST.ist_witnessed (MRefST.contains m) ==> MRefHeap.contains x m) /\
;                 (forall (any_result: MRefST.mref a r).
;                     m == any_result ==>
;                     (forall (any_result: a).
;                         any_result == MRefHeap.sel x m ==> p (any_result, s1) <: Type0)))))
...
;; def=dummy(0,0-0,0); use=MRefST.fst(183,18-186,9)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
MRefHeap.heap)
(HasType @x4
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(183,18-186,9)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
@x0)
(HasType @x6
...
;; def=MRefST.fst(180,36-180,44); use=MRefST.fst(183,18-186,9)
(= @x3
@x6)


;; def=MRefST.fst(181,22-181,35); use=MRefST.fst(183,18-186,9)
(Valid 
;; def=MRefST.fst(181,22-181,35); use=MRefST.fst(183,18-186,9)
(MRefST.contains @x0
@x1
...
;; def=MRefST.fst(182,8-182,21); use=MRefST.fst(183,18-186,9)
(= (MRefHeap.sel @x0
@x1
@x6
@x2)
...
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(183,18-186,9)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(183,18-186,9)
(ApplyTT @x4
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(184,10-184,17)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
MRefHeap.heap)
(HasType @x6
...
;; def=MRefST.fst(116,68-116,75); use=MRefST.fst(184,10-184,17)
(= @x3
@x5)


;; def=MRefST.fst(116,79-116,86); use=MRefST.fst(184,10-184,17)
(= @x5
@x6)
)

;; def=Prims.fst(459,77-459,89); use=MRefST.fst(183,18-186,9)
(and 
;; def=MRefST.fst(131,42-131,59); use=MRefST.fst(185,13-185,25)
(or label_1
...
;; def=Prims.fst(356,2-356,58); use=MRefST.fst(183,18-186,9)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Tm_refine_563c70843de6809436d12e24a4945aee)

;; def=Prims.fst(356,26-356,41); use=MRefST.fst(183,18-186,9)
(= @x7
(ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
@x1)
...
;; def=MRefST.fst(112,29-112,91); use=MRefST.fst(185,2-185,12)
(and 
;; def=MRefST.fst(132,30-132,45); use=MRefST.fst(185,2-185,12)
(or label_2
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(185,2-185,12)
(forall ((@x8 Term) (@x9 Term))
 (! (implies (and (HasType @x8
Prims.unit)
(HasType @x9
...
;; def=MRefST.fst(132,63-132,71); use=MRefST.fst(185,2-185,12)
(= @x6
@x9)


;; def=MRefST.fst(132,75-132,79); use=MRefST.fst(185,2-185,12)
(Valid 
;; def=MRefST.fst(132,75-132,79); use=MRefST.fst(185,2-185,12)
(MRefST.contains @x0
@x1
...
;; def=Prims.fst(459,77-459,89); use=MRefST.fst(183,18-186,9)
(and (implies 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(186,8-186,9)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(186,8-186,9)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
...
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(186,8-186,9)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=MRefST.fst(183,18-186,9)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(MRefST.mref @x0
@x1))

;; def=MRefHeap.fsti(52,3-52,4); use=MRefST.fst(183,18-186,9)
(= @x2
@x10)
)
...
;; def=MRefST.fst(183,10-186,9); use=MRefST.fst(183,18-186,9)
(= @x11
(MRefHeap.sel @x0
@x1
@x5
...
;; def=MRefST.fst(30,29-30,33); use=MRefST.fst(183,18-186,9)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.read, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.stable, equation_MRefHeap.preorder_t, equation_MRefST.contains, equation_MRefST.heap_rel, equation_MRefST.mref, refinement_interpretation_Tm_refine_da9cbab0485332770e2f963089e2dda6, token_correspondence_MRefST.contains, token_correspondence_MRefST.heap_rel
...
(declare-fun MRefST.read (Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_bc9187eec8c2456a12f30c853e51c32a () Term)
(declare-fun MRefST.read@tok () Term)
(declare-fun Tm_refine_87f03f296d63b69d3013faedfefb3c4c (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.PURE (a & MRefHeap.heap)
(declare-fun Tm_arrow_4e12aa1377a8cdab69225f3b78c687a2 (Term Term Term) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.st_pre; Namespace MRefST
(assert (! (HasType MRefST.st_pre
Tm_type)
:named typing_MRefST.st_pre))
;;;;;;;;;;;;;;;;name-token correspondence
...
:qid l_and-interp))
:named l_and-interp))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86
;;; Fact-ids: Name MRefST._dm4f_ISTATE_pre; Namespace MRefST
(assert (! (HasType Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86
Tm_type)
:named kinding_Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86))
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
...
(assert (! (HasType MRefST.st_pre
Tm_type)
:named function_token_typing_MRefST.st_pre))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
;; def=Prims.fst(183,5-183,9); use=Prims.fst(183,5-183,9)
...
;;;;;;;;;;;;;;;;Equation for MRefST.st_pre
;;; Fact-ids: Name MRefST.st_pre; Namespace MRefST
(assert (! (= MRefST.st_pre
Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86)
:named equation_MRefST.st_pre))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
;; def=Prims.fst(183,34-183,38); use=Prims.fst(183,34-183,38)
...
;;; Fact-ids: Name MRefST._dm4f_ISTATE_pre; Namespace MRefST
(assert (! 
;; def=MRefST.fst(27,19-27,23); use=MRefST.fst(27,19-27,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86)
...
@x1
Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86))
:qid MRefST_pre_typing_Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86))

:named MRefST_pre_typing_Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86
;;; Fact-ids: Name MRefST._dm4f_ISTATE_pre; Namespace MRefST
(assert (! 
;; def=MRefST.fst(27,19-27,23); use=MRefST.fst(27,19-27,23)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid MRefST_interpretation_Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86))
:qid MRefST_interpretation_Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86))

:named MRefST_interpretation_Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86))
(push) ;; push{2

; Starting query at MRefST.fst(189,0-196,36)
...
(declare-fun Tm_abs_6f14991ab0a86280a16c9399e50f1959 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_6f14991ab0a86280a16c9399e50f1959
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(193,33-194,47); use=MRefST.fst(189,15-193,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_6f14991ab0a86280a16c9399e50f1959 @x0
@x1
@x2
@x3)
Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86)
...
:pattern ((Tm_abs_6f14991ab0a86280a16c9399e50f1959 @x0
@x1
@x2
@x3))
:qid typing_Tm_abs_6f14991ab0a86280a16c9399e50f1959))

:named typing_Tm_abs_6f14991ab0a86280a16c9399e50f1959))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_6f14991ab0a86280a16c9399e50f1959
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(193,33-194,47); use=MRefST.fst(189,15-193,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (Tm_abs_6f14991ab0a86280a16c9399e50f1959 @x1
@x2
@x3
@x4)
@x0)
(Prims.l_and (MRefST.contains @x1
@x2
@x3
@x0)
(ApplyTT (ApplyTT @x2
...
:pattern ((ApplyTT (Tm_abs_6f14991ab0a86280a16c9399e50f1959 @x1
@x2
@x3
@x4)
@x0))
:qid interpretation_Tm_abs_6f14991ab0a86280a16c9399e50f1959))

:named interpretation_Tm_abs_6f14991ab0a86280a16c9399e50f1959))

; Encoding query formula : forall (a: Type0) (r: FStar.Preorder.preorder a) (m: MRefST.mref a r) (x: a).
;   (forall (h0: MRefHeap.heap).
;       (*  - Could not prove post-condition
; *)
;       MRefST.contains m h0 ==> MRefST.ist_witnessed (MRefST.contains m) ==> MRefHeap.contains h0 m) /\
;   (forall (any_result: MRefST.st_pre).
;       (fun h0 -> MRefST.contains m h0 /\ r (MRefHeap.sel h0 m) x) == any_result ==>
;       (forall (h0: MRefHeap.heap) (_: Prims.unit) (h1: MRefHeap.heap).
;           (*  - Could not prove post-condition
; *)
;           MRefST.contains m h0 ==>
;           MRefST.ist_witnessed (MRefST.contains m) ==> MRefHeap.contains h0 m))


; Context: While encoding a query
; While typechecking the top-level declaration `val MRefST.write`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MRefST.fst(189,0-196,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=MRefST.fst(189,15-193,16)
(and 
;; def=dummy(0,0-0,0); use=MRefST.fst(189,15-193,16)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
MRefHeap.heap)

;; def=MRefST.fst(193,33-193,46); use=MRefST.fst(189,15-193,16)
(Valid 
;; def=MRefST.fst(193,33-193,46); use=MRefST.fst(189,15-193,16)
(MRefST.contains @x0
@x1
...
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(189,15-193,16)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(189,15-193,16)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
...
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(194,43-194,44)
(or label_1

;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(189,15-193,16)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(189,15-193,16)
(MRefHeap.contains @x0
@x1
...
;; def=Prims.fst(451,66-451,102); use=MRefST.fst(189,15-193,16)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
MRefST.st_pre)

;; def=MRefST.fst(153,16-194,47); use=MRefST.fst(189,15-193,16)
(= (Tm_abs_6f14991ab0a86280a16c9399e50f1959 @x0
@x1
@x2
@x3)
@x4)
...
;; def=MRefST.fst(195,40-195,53); use=MRefST.fst(189,15-193,16)
(Valid 
;; def=MRefST.fst(195,40-195,53); use=MRefST.fst(189,15-193,16)
(MRefST.contains @x0
@x1
...
;; def=MRefHeap.fsti(80,21-80,34); use=MRefST.fst(196,32-196,33)
(or label_2

;; def=MRefHeap.fsti(80,21-80,34); use=MRefST.fst(189,15-193,16)
(Valid 
;; def=MRefHeap.fsti(80,21-80,34); use=MRefST.fst(189,15-193,16)
(MRefHeap.contains @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.write, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_MRefST.mref, lemma_MRefST.contains_lemma, refinement_interpretation_Tm_refine_da9cbab0485332770e2f963089e2dda6
...
; encoding sigelt val MRefST.write


; <Skipped val MRefST.write/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefHeap.upd; Namespace MRefHeap
(assert (! 
;; def=MRefHeap.fsti(77,4-77,7); use=MRefHeap.fsti(77,4-77,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x4
@x0))
(HasType (MRefHeap.upd @x0
@x1
@x2
@x3
@x4)
(Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895 @x0
@x1
@x3
@x4
@x2)))
...
:pattern ((MRefHeap.upd @x0
@x1
@x2
@x3
@x4))
:qid typing_MRefHeap.upd))

:named typing_MRefHeap.upd))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefHeap.addr_of; Namespace MRefHeap
(assert (! 
;; def=MRefHeap.fsti(32,4-32,11); use=MRefHeap.fsti(32,4-32,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;;; Fact-ids: Name MRefHeap.upd; Namespace MRefHeap
(assert (! 
;; def=MRefHeap.fsti(82,14-91,30); use=MRefHeap.fsti(82,14-91,30)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895 @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid refinement_kinding_Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895))

:named refinement_kinding_Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895 @x2
@x3
@x4
@x5
@x6))
...
;;no pats
:qid refinement_interpretation_Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895.1))


;; def=MRefHeap.fsti(88,9-91,28); use=MRefHeap.fsti(88,9-91,28)
(forall ((@x7 Term) (@x8 Term) (@x9 Term))
 (! (implies (and (HasType @x7
Tm_type)
(HasType @x8
...
(Valid 
;; def=MRefHeap.fsti(90,28-90,38); use=MRefHeap.fsti(90,28-90,38)
(Prims.op_Equals_Equals_Equals (Tm_refine_36453e3eb6145226f640e16ed9612466 @x2
@x3
@x6)
(Tm_refine_36453e3eb6145226f640e16ed9612466 @x7
@x8
...
;; def=MRefHeap.fsti(91,5-91,27); use=MRefHeap.fsti(91,5-91,27)
(= (MRefHeap.sel @x7
@x8
@x6
@x9)
...
@x1
@x9))
:qid refinement_interpretation_Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895.2))
))
...
@x5
@x6)))
:qid refinement_interpretation_Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895))

:named refinement_interpretation_Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
...
;; def=MRefHeap.fsti(40,71-40,87); use=MRefHeap.fsti(40,71-40,87)
(and 
...
;; def=MRefHeap.fsti(40,81-40,87); use=MRefHeap.fsti(40,81-40,87)
(= @x2
@x3)
)
)
...
;; def=MRefHeap.fsti(44,44-44,69); use=MRefHeap.fsti(44,44-44,69)
(not 
;; def=MRefHeap.fsti(44,45-44,69); use=MRefHeap.fsti(44,45-44,69)
(= (MRefHeap.addr_of @x0
@x2
@x5)
(MRefHeap.addr_of @x1
...
;; def=MRefHeap.fsti(44,74-44,85); use=MRefHeap.fsti(44,74-44,85)
(not 
;; def=MRefHeap.fsti(44,75-44,85); use=MRefHeap.fsti(44,75-44,85)
(Valid 
;; def=MRefHeap.fsti(44,75-44,85); use=MRefHeap.fsti(44,75-44,85)
...
:qid int_inversion))
:named int_inversion))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895
;;; Fact-ids: Name MRefHeap.upd; Namespace MRefHeap
(assert (! 
;; def=MRefHeap.fsti(82,14-91,30); use=MRefHeap.fsti(82,14-91,30)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895 @x0
@x1
@x2
@x3
@x4)))
(Valid (Prims.hasEq MRefHeap.heap)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895 @x0
@x1
@x2
@x3
@x4))))
:qid haseqTm_refine_b1c28aa58737bfc2dbda63f66ce3b895))

:named haseqTm_refine_b1c28aa58737bfc2dbda63f66ce3b895))
...
; Starting query at MRefST.fst(197,21-201,12)
...
; Encoding query formula : forall (a: Type) (r: FStar.Preorder.preorder a) (m: MRefST.mref a r) (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (_: MRefHeap.heap) (p: Prims.pure_post (Prims.unit & MRefHeap.heap)).
;     MRefST.contains m _ /\ r (MRefHeap.sel _ m) x /\
;     (forall (x: Prims.unit) (s1: MRefHeap.heap).
;         MRefST.contains m _ /\ r (MRefHeap.sel _ m) x /\
;         MRefST.contains m _ /\ (s1 == MRefHeap.upd _ m x) ==>
;         p (x, s1)) ==>
;     (forall (x: MRefHeap.heap) (s1: MRefHeap.heap).
;         _ == x /\ x == s1 ==>
;         Prims.auto_squash (FStar.Preorder.stable (MRefST.contains m) MRefST.heap_rel) /\
...
;                     (MRefHeap.contains h1 m ==>
;                       MRefST.ist_witnessed (MRefST.contains m) ==> MRefHeap.contains h1 m) /\
;                     (MRefHeap.contains h1 m /\ MRefHeap.sel h1 m == x /\
;                       (forall (b: Type0) (r': MRefHeap.preorder_t b) (m': MRefHeap.mref b r').
;                           MRefHeap.contains x m' ==> MRefHeap.contains h1 m') ==>
;                       (forall (b: Type0).
;                           (*  - Could not prove post-condition
; *)
;                           forall (r': MRefHeap.preorder_t b).
...
;                                 (r': MRefHeap.preorder_t b)
;                                 (m': MRefHeap.mref b r' {MRefHeap.contains x m'}).
;                                 {:pattern MRefHeap.sel x m'\/MRefHeap.sel h1 m'}
;                                 MRefHeap.addr_of m' <> MRefHeap.addr_of m \/ ~(m === m') ==>
;                                 MRefHeap.sel x m' == MRefHeap.sel h1 m') }).
;                         MRefHeap.upd x m x == any_result ==>
;                         MRefST.heap_rel s1 (MRefHeap.upd x m x) /\
;                         (forall (x: Prims.unit) (s1: MRefHeap.heap).
;                             MRefST.heap_rel s1 (MRefHeap.upd x m x) /\ s1 == MRefHeap.upd x m x ==>
;                             p (x, s1))
;                         <:
;                         Type0)))))
...
;; def=dummy(0,0-0,0); use=MRefST.fst(197,21-201,12)
...
;; def=MRefST.fst(193,33-193,46); use=MRefST.fst(197,21-201,12)
(Valid 
;; def=MRefST.fst(193,33-193,46); use=MRefST.fst(197,21-201,12)
(MRefST.contains @x0
@x1
...
;; def=MRefST.fst(194,33-194,47); use=MRefST.fst(197,21-201,12)
(Valid 
;; def=MRefST.fst(194,33-194,47); use=MRefST.fst(197,21-201,12)
(ApplyTT (ApplyTT @x1
(MRefHeap.sel @x0
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(197,21-201,12)
...
;; def=MRefST.fst(195,40-195,53); use=MRefST.fst(197,21-201,12)
(Valid 
;; def=MRefST.fst(195,40-195,53); use=MRefST.fst(197,21-201,12)
(MRefST.contains @x0
@x1
...
;; def=MRefST.fst(196,19-196,35); use=MRefST.fst(197,21-201,12)
(= @x7
(MRefHeap.upd @x0
@x1
@x4
...
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(197,21-201,12)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(197,21-201,12)
(ApplyTT @x5
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(198,11-198,18)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
MRefHeap.heap)
(HasType @x7
...
;; def=MRefST.fst(116,68-116,75); use=MRefST.fst(198,11-198,18)
(= @x4
@x6)


;; def=MRefST.fst(116,79-116,86); use=MRefST.fst(198,11-198,18)
(= @x6
@x7)
)

;; def=Prims.fst(459,77-459,89); use=MRefST.fst(197,21-201,12)
(and 
;; def=MRefST.fst(131,42-131,59); use=MRefST.fst(199,13-199,25)
(or label_1
...
;; def=Prims.fst(356,2-356,58); use=MRefST.fst(197,21-201,12)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Tm_refine_563c70843de6809436d12e24a4945aee)

;; def=Prims.fst(356,26-356,41); use=MRefST.fst(197,21-201,12)
(= @x8
(ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
@x1)
...
;; def=MRefST.fst(112,29-112,91); use=MRefST.fst(199,2-199,12)
(and 
;; def=MRefST.fst(132,30-132,45); use=MRefST.fst(199,2-199,12)
(or label_2
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(199,2-199,12)
...
;; def=MRefST.fst(132,63-132,71); use=MRefST.fst(199,2-199,12)
(= @x7
@x10)


;; def=MRefST.fst(132,75-132,79); use=MRefST.fst(199,2-199,12)
(Valid 
;; def=MRefST.fst(132,75-132,79); use=MRefST.fst(199,2-199,12)
(MRefST.contains @x0
@x1
...
;; def=Prims.fst(459,77-459,89); use=MRefST.fst(197,21-201,12)
(and 
;; def=dummy(0,0-0,0); use=MRefST.fst(199,26-201,12)
(forall ((@x11 Term))
 (! (implies (HasType @x11
MRefHeap.heap)

;; def=dummy(0,0-0,0); use=MRefST.fst(200,11-200,14)
(and (implies (and 
;; def=MRefHeap.fsti(82,23-82,36); use=MRefST.fst(200,11-200,14)
(Valid 
;; def=MRefHeap.fsti(82,23-82,36); use=MRefST.fst(200,11-200,14)
(MRefHeap.contains @x0
@x1
...
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(200,11-200,14)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(200,11-200,14)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
...
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(200,18-200,19)
(or label_3

;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(200,11-200,14)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(200,11-200,14)
(MRefHeap.contains @x0
@x1
...
(implies 
;; def=MRefHeap.fsti(82,23-87,20); use=MRefST.fst(200,11-200,14)
(and 
;; def=MRefHeap.fsti(82,23-82,36); use=MRefST.fst(200,11-200,14)
(Valid 
;; def=MRefHeap.fsti(82,23-82,36); use=MRefST.fst(200,11-200,14)
...
;; def=MRefHeap.fsti(83,16-83,29); use=MRefST.fst(200,11-200,14)
(= (MRefHeap.sel @x0
@x1
@x11
@x2)
...
;; def=MRefHeap.fsti(84,9-87,20); use=MRefST.fst(200,11-200,14)
(forall ((@x12 Term) (@x13 Term) (@x14 Term))
 (! (implies (and (HasType @x12
Tm_type)
(HasType @x13
(MRefHeap.preorder_t @x12))
(HasType @x14
(MRefHeap.mref @x12
@x13))

;; def=MRefHeap.fsti(85,5-85,19); use=MRefST.fst(200,11-200,14)
(Valid 
;; def=MRefHeap.fsti(85,5-85,19); use=MRefST.fst(200,11-200,14)
(MRefHeap.contains @x12
@x13
@x6
@x14)
)
...
;; def=MRefHeap.fsti(87,5-87,19); use=MRefST.fst(200,11-200,14)
(Valid 
;; def=MRefHeap.fsti(87,5-87,19); use=MRefST.fst(200,11-200,14)
(MRefHeap.contains @x12
@x13
...
(forall ((@x14 Term))
 (! (implies (HasType @x14
(Tm_refine_36453e3eb6145226f640e16ed9612466 @x12
@x13
@x6))

;; def=MRefHeap.fsti(88,23-90,39); use=MRefST.fst(200,11-200,14)
(and 
;; def=Prims.fst(73,23-73,30); use=MRefST.fst(200,11-200,14)
(or label_4
...
(implies (and 
;; def=MRefHeap.fsti(89,13-89,38); use=MRefST.fst(200,11-200,14)
(not 
;; def=MRefHeap.fsti(89,13-89,38); use=MRefST.fst(200,11-200,14)
(not (= (MRefHeap.addr_of @x12
@x13
@x14)
(MRefHeap.addr_of @x0
@x1
...
;; def=MRefHeap.fsti(80,21-80,34); use=MRefST.fst(200,18-200,19)
(or label_5

;; def=MRefHeap.fsti(80,21-80,34); use=MRefST.fst(200,11-200,14)
(Valid 
;; def=MRefHeap.fsti(80,21-80,34); use=MRefST.fst(200,11-200,14)
(MRefHeap.contains @x0
@x1
...
(implies (and 
;; def=MRefHeap.fsti(89,12-90,39); use=MRefST.fst(200,11-200,14)
(or 
;; def=MRefHeap.fsti(89,13-89,38); use=MRefST.fst(200,11-200,14)
(not (= (MRefHeap.addr_of @x12
@x13
...
;; def=MRefHeap.fsti(90,27-90,38); use=MRefST.fst(200,11-200,14)
(not 
;; def=MRefHeap.fsti(90,28-90,38); use=MRefST.fst(200,11-200,14)
(Valid 
;; def=MRefHeap.fsti(90,28-90,38); use=MRefST.fst(200,11-200,14)
...
;; def=MRefHeap.fsti(88,36-88,50); use=MRefST.fst(200,11-200,14)
(Valid 
;; def=MRefHeap.fsti(88,36-88,50); use=MRefST.fst(200,11-200,14)
(MRefHeap.contains @x12
@x13
...
(implies 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(200,18-200,19)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(200,18-200,19)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
...
;; def=Prims.fst(451,66-451,102); use=MRefST.fst(197,21-201,12)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
(MRefST.mref @x0
@x1))

;; def=MRefHeap.fsti(80,10-80,11); use=MRefST.fst(197,21-201,12)
(= @x2
@x11)
)
...
;; def=MRefST.fst(200,6-200,21); use=MRefST.fst(200,6-200,21)
(= (MRefHeap.upd @x0
@x1
@x6
@x2
...
;; def=MRefST.fst(112,29-112,91); use=MRefST.fst(201,2-201,9)
(and 
;; def=MRefST.fst(120,24-120,37); use=MRefST.fst(201,2-201,9)
(or label_8
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(201,2-201,9)
...
;; def=MRefST.fst(120,55-120,62); use=MRefST.fst(201,2-201,9)
(= @x14
(MRefHeap.upd @x0
@x1
@x6
...
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(201,2-201,9)
(or label_9
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.write, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.stable, equation_MRefHeap.preorder_t, equation_MRefST.contains, equation_MRefST.heap_rel, equation_MRefST.mref, equation_Prims.eqtype, equation_Prims.nat, equation_Prims.op_Equals_Equals_Equals, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, lemma_MRefHeap.contains_same_addr_lemma, refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6, refinement_interpretation_Tm_refine_36453e3eb6145226f640e16ed9612466, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, refinement_interpretation_Tm_refine_da9cbab0485332770e2f963089e2dda6, token_correspondence_MRefST.contains, token_correspondence_MRefST.heap_rel, typing_MRefHeap.sel, typing_Prims.int
...
(declare-fun MRefST.write (Term Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_f5661170da4c3ca89a53a98373839df9 () Term)
(declare-fun MRefST.write@tok () Term)
(declare-fun Tm_refine_55c315f5b7e14685f0dcf2ceb0be148f (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> Prims.PURE (Prims.unit & MRefHeap.heap)
(declare-fun Tm_arrow_80a73390b9a7f7d340603c6e40719ff8 (Term Term Term Term) Term)
...
; Starting query at MRefST.fst(207,2-210,6)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let stable_on_heap_aux`
...
;; def=MRefST.fst(207,2-207,6); use=MRefST.fst(207,2-207,6)
(Valid 
;; def=MRefST.fst(207,2-207,6); use=MRefST.fst(207,2-207,6)
(ApplyTT @x3
@x4)
...
;; def=MRefST.fst(208,3-208,16); use=MRefST.fst(208,3-208,16)
(Valid 
;; def=MRefST.fst(208,3-208,16); use=MRefST.fst(208,3-208,16)
(MRefST.contains @x0
@x1
...
;; def=MRefST.fst(208,21-208,34); use=MRefST.fst(208,21-208,34)
(Valid 
;; def=MRefST.fst(208,21-208,34); use=MRefST.fst(208,21-208,34)
(MRefST.contains @x0
@x1
...
;; def=Prims.fst(459,77-459,89); use=MRefST.fst(208,21-208,61)
(and (implies 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(208,48-208,49)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(208,48-208,49)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
...
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(208,48-208,49)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=MRefST.fst(208,21-208,61)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(MRefST.mref @x0
@x1))

;; def=MRefHeap.fsti(52,3-52,4); use=MRefST.fst(208,21-208,61)
(= @x2
@x6)
)
...
;; def=dummy(0,0-0,0); use=MRefST.fst(208,21-208,61)
(= (MRefHeap.sel @x0
@x1
@x4
@x2)
...
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(208,59-208,60)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=MRefST.fst(208,59-208,60)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
@x0)
...
;; def=MRefHeap.fsti(52,14-52,26); use=MRefST.fst(208,59-208,60)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.stable_on_heap_aux, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_MRefST.contains
...
; encoding sigelt let stable_on_heap_aux


; <Start encoding let stable_on_heap_aux>

(declare-fun MRefST.stable_on_heap_aux (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;m: mref a r -> p: FStar.Preorder.predicate MRefHeap.heap -> h0: MRefHeap.heap -> h1: MRefHeap.heap   -> Prims.logical
(declare-fun Tm_arrow_ac8b22d8a3859fa481a47acfa1eb2b06 () Term)
(declare-fun MRefST.stable_on_heap_aux@tok () Term)

; </end encoding let stable_on_heap_aux>


; encoding sigelt let stable_on_heap


; <Start encoding let stable_on_heap>

(declare-fun MRefST.stable_on_heap (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;m: mref a r -> p: FStar.Preorder.predicate MRefHeap.heap -> Prims.logical
(declare-fun Tm_arrow_bd6cb27a701002d341975f2bb62931c9 () Term)
(declare-fun MRefST.stable_on_heap@tok () Term)

; </end encoding let stable_on_heap>


; encoding sigelt val MRefST.stable_on_heap_stable


; <Skipped val MRefST.stable_on_heap_stable/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.stable_on_heap_aux; Namespace MRefST
(assert (! 
;; def=MRefST.fst(206,4-206,22); use=MRefST.fst(206,4-206,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x5
MRefHeap.heap))
(HasType (MRefST.stable_on_heap_aux @x0
@x1
@x2
@x3
@x4
...
:pattern ((MRefST.stable_on_heap_aux @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_MRefST.stable_on_heap_aux))

:named typing_MRefST.stable_on_heap_aux))
;;;;;;;;;;;;;;;;Equation for MRefST.stable_on_heap_aux
;;; Fact-ids: Name MRefST.stable_on_heap_aux; Namespace MRefST
(assert (! 
;; def=MRefST.fst(206,4-206,22); use=MRefST.fst(206,4-206,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Valid (MRefST.stable_on_heap_aux @x0
@x1
@x2
@x3
@x4
...
;; def=MRefST.fst(207,2-210,6); use=MRefST.fst(207,2-210,6)
(implies 
;; def=MRefST.fst(207,2-208,62); use=MRefST.fst(207,2-208,62)
(and 
;; def=MRefST.fst(207,2-207,6); use=MRefST.fst(207,2-207,6)
(Valid 
;; def=MRefST.fst(207,2-207,6); use=MRefST.fst(207,2-207,6)
...
;; def=MRefST.fst(208,2-208,62); use=MRefST.fst(208,2-208,62)
(implies 
;; def=MRefST.fst(208,3-208,16); use=MRefST.fst(208,3-208,16)
(Valid 
;; def=MRefST.fst(208,3-208,16); use=MRefST.fst(208,3-208,16)
...
;; def=MRefST.fst(208,21-208,61); use=MRefST.fst(208,21-208,61)
(and 
;; def=MRefST.fst(208,21-208,34); use=MRefST.fst(208,21-208,34)
(Valid 
;; def=MRefST.fst(208,21-208,34); use=MRefST.fst(208,21-208,34)
...
;; def=MRefST.fst(208,38-208,61); use=MRefST.fst(208,38-208,61)
(Valid 
;; def=MRefST.fst(208,38-208,61); use=MRefST.fst(208,38-208,61)
(ApplyTT (ApplyTT @x1
(MRefHeap.sel @x0
...
;; def=MRefST.fst(210,2-210,6); use=MRefST.fst(210,2-210,6)
(Valid 
;; def=MRefST.fst(210,2-210,6); use=MRefST.fst(210,2-210,6)
(ApplyTT @x3
@x5)
...
@x4
@x5))
:qid equation_MRefST.stable_on_heap_aux))

:named equation_MRefST.stable_on_heap_aux))
;;;;;;;;;;;;;;;;Prop-typing for MRefST.stable_on_heap_aux
;;; Fact-ids: Name MRefST.stable_on_heap_aux; Namespace MRefST
(assert (! 
;; def=MRefST.fst(206,4-206,22); use=MRefST.fst(206,4-206,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
...
(HasType @x5
MRefHeap.heap))
(Valid (Prims.subtype_of (MRefST.stable_on_heap_aux @x0
@x1
@x2
@x3
@x4
...
:pattern ((Prims.subtype_of (MRefST.stable_on_heap_aux @x0
@x1
@x2
@x3
@x4
@x5)
Prims.unit))
:qid defn_equation_MRefST.stable_on_heap_aux))

:named defn_equation_MRefST.stable_on_heap_aux))
(push) ;; push{2

; Starting query at MRefST.fst(227,38-227,40)
...
;         (forall (h0: MRefHeap.heap) (h1: MRefHeap.heap).
;             MRefST.stable_on_heap_aux m p h0 h1 ==> p h0 /\ MRefST.heap_rel h0 h1 ==> p h1) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let stable_on_heap_stable`
...
;; def=Prims.fst(441,36-441,97); use=MRefST.fst(227,38-227,40)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=MRefST.fst(222,23-225,46); use=MRefST.fst(227,38-227,40)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
MRefHeap.heap)
(HasType @x7
...
;; def=MRefST.fst(223,19-223,47); use=MRefST.fst(227,38-227,40)
(Valid 
;; def=MRefST.fst(223,19-223,47); use=MRefST.fst(227,38-227,40)
(MRefST.stable_on_heap_aux @x0
@x1
@x2
@x3
@x6
...
;; def=MRefST.fst(225,13-225,17); use=MRefST.fst(227,38-227,40)
(Valid 
;; def=MRefST.fst(225,13-225,17); use=MRefST.fst(227,38-227,40)
(ApplyTT @x3
@x6)
...
;; def=MRefST.fst(225,21-225,35); use=MRefST.fst(227,38-227,40)
(Valid 
;; def=MRefST.fst(225,21-225,35); use=MRefST.fst(227,38-227,40)
(MRefST.heap_rel @x6
@x7)
...
;; def=MRefST.fst(225,40-225,44); use=MRefST.fst(227,38-227,40)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MRefST.fst(227,38-227,40)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MRefST.fst(227,38-227,40)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.stable_on_heap_stable, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_MRefHeap.preorder_t, equation_MRefST.heap_rel, equation_MRefST.mref, equation_MRefST.stable_on_heap_aux, refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6, refinement_interpretation_Tm_refine_da9cbab0485332770e2f963089e2dda6
...
; encoding sigelt let stable_on_heap_stable


; <Start encoding let stable_on_heap_stable>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MRefST.stable_on_heap_stable (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MRefST.stable_on_heap_stable@tok () Term)


; </end encoding let stable_on_heap_stable>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.stable_on_heap; Namespace MRefST
(assert (! 
;; def=MRefST.fst(213,4-213,18); use=MRefST.fst(213,4-213,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x3
(FStar.Preorder.predicate MRefHeap.heap)))
(HasType (MRefST.stable_on_heap @x0
@x1
@x2
@x3)
Prims.logical))
...
:pattern ((MRefST.stable_on_heap @x0
@x1
@x2
@x3))
:qid typing_MRefST.stable_on_heap))

:named typing_MRefST.stable_on_heap))
;;;;;;;;;;;;;;;;Lemma: MRefST.stable_on_heap_stable
;;; Fact-ids: Name MRefST.stable_on_heap_stable; Namespace MRefST
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=MRefST.fst(222,23-225,46); use=MRefST.fst(227,4-227,25)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
MRefHeap.heap)
(HasType @x5
...
;; def=MRefST.fst(223,19-223,47); use=MRefST.fst(227,4-227,25)
(Valid 
;; def=MRefST.fst(223,19-223,47); use=MRefST.fst(227,4-227,25)
(MRefST.stable_on_heap_aux @x0
@x1
...
;; def=MRefST.fst(225,13-225,17); use=MRefST.fst(227,4-227,25)
(Valid 
;; def=MRefST.fst(225,13-225,17); use=MRefST.fst(227,4-227,25)
(ApplyTT @x3
@x4)
...
;; def=MRefST.fst(225,21-225,35); use=MRefST.fst(227,4-227,25)
(Valid 
;; def=MRefST.fst(225,21-225,35); use=MRefST.fst(227,4-227,25)
(MRefST.heap_rel @x4
@x5)
...
;; def=MRefST.fst(225,40-225,44); use=MRefST.fst(227,4-227,25)
(Valid 
;; def=MRefST.fst(225,40-225,44); use=MRefST.fst(227,4-227,25)
(ApplyTT @x3
@x5)
...
;;no pats
:qid lemma_MRefST.stable_on_heap_stable.1))
)
...
@x1
@x2
@x3) (FStar.Preorder.stable MRefHeap.heap
@x3
MRefST.heap_rel@tok))
:qid lemma_MRefST.stable_on_heap_stable))
:named lemma_MRefST.stable_on_heap_stable))
;;;;;;;;;;;;;;;;Equation for MRefST.stable_on_heap
;;; Fact-ids: Name MRefST.stable_on_heap; Namespace MRefST
(assert (! 
;; def=MRefST.fst(213,4-213,18); use=MRefST.fst(213,4-213,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Valid (MRefST.stable_on_heap @x0
@x1
@x2
@x3))

;; def=MRefST.fst(214,2-214,45); use=MRefST.fst(214,2-214,45)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
MRefHeap.heap)
(HasType @x5
...
;; def=MRefST.fst(214,17-214,45); use=MRefST.fst(214,17-214,45)
(Valid 
;; def=MRefST.fst(214,17-214,45); use=MRefST.fst(214,17-214,45)
(MRefST.stable_on_heap_aux @x0
@x1
...
;;no pats
:qid equation_MRefST.stable_on_heap.1))
)
...
@x2
@x3))
:qid equation_MRefST.stable_on_heap))

:named equation_MRefST.stable_on_heap))
;;;;;;;;;;;;;;;;Prop-typing for MRefST.stable_on_heap
;;; Fact-ids: Name MRefST.stable_on_heap; Namespace MRefST
(assert (! 
;; def=MRefST.fst(213,4-213,18); use=MRefST.fst(213,4-213,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(FStar.Preorder.predicate MRefHeap.heap)))
(Valid (Prims.subtype_of (MRefST.stable_on_heap @x0
@x1
@x2
@x3)
Prims.unit)))
...
:pattern ((Prims.subtype_of (MRefST.stable_on_heap @x0
@x1
@x2
@x3)
Prims.unit))
:qid defn_equation_MRefST.stable_on_heap))

:named defn_equation_MRefST.stable_on_heap))
(push) ;; push{2

; Starting query at MRefST.fst(232,0-238,37)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_84103d4d35761d12d97de209c219f7ba (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(235,7-235,43); use=MRefST.fst(235,7-235,43)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_84103d4d35761d12d97de209c219f7ba @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_84103d4d35761d12d97de209c219f7ba @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_84103d4d35761d12d97de209c219f7ba))

:named refinement_kinding_Tm_refine_84103d4d35761d12d97de209c219f7ba))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(235,7-235,43); use=MRefST.fst(235,7-235,43)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_84103d4d35761d12d97de209c219f7ba @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=MRefST.fst(235,24-235,42); use=MRefST.fst(235,24-235,42)
(Valid 
;; def=MRefST.fst(235,24-235,42); use=MRefST.fst(235,24-235,42)
(MRefST.stable_on_heap @x2
@x3
@x4
@x1)
)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_84103d4d35761d12d97de209c219f7ba))

:named refinement_interpretation_Tm_refine_84103d4d35761d12d97de209c219f7ba))
;;;;;;;;;;;;;;;;haseq for Tm_refine_84103d4d35761d12d97de209c219f7ba
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(235,7-235,43); use=MRefST.fst(235,7-235,43)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_84103d4d35761d12d97de209c219f7ba @x0
@x1
@x2)))
(Valid (Prims.hasEq (FStar.Preorder.predicate MRefHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_84103d4d35761d12d97de209c219f7ba @x0
@x1
@x2))))
:qid haseqTm_refine_84103d4d35761d12d97de209c219f7ba))

:named haseqTm_refine_84103d4d35761d12d97de209c219f7ba))


; Encoding query formula : forall (a: Type0)
;   (r: FStar.Preorder.preorder a)
;   (m: MRefST.mref a r)
;   (p: FStar.Preorder.predicate MRefHeap.heap {MRefST.stable_on_heap m p})
;   (h0: MRefHeap.heap)
;   (_: Prims.unit)
;   (h1: MRefHeap.heap).
;   (*  - Could not prove post-condition
; *)
;   h0 == h1 ==> MRefST.stable_on_heap m p ==> FStar.Preorder.stable p MRefST.heap_rel


; Context: While encoding a query
; While typechecking the top-level declaration `val MRefST.witness`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MRefST.fst(232,0-238,37)
...
@x1))
(HasType @x3
(Tm_refine_84103d4d35761d12d97de209c219f7ba @x0
@x1
@x2))
(HasType @x4
MRefHeap.heap)
...
;; def=MRefST.fst(237,35-237,43); use=MRefST.fst(232,17-236,18)
(= @x4
@x6)


;; def=MRefST.fst(235,24-235,42); use=MRefST.fst(232,17-236,18)
(Valid 
;; def=MRefST.fst(235,24-235,42); use=MRefST.fst(232,17-236,18)
(MRefST.stable_on_heap @x0
@x1
@x2
@x3)
)
...
;; def=MRefST.fst(125,36-125,53); use=MRefST.fst(238,35-238,36)
(or label_1

;; def=MRefST.fst(125,36-125,53); use=MRefST.fst(232,17-236,18)
(Valid 
;; def=MRefST.fst(125,36-125,53); use=MRefST.fst(232,17-236,18)
(FStar.Preorder.stable MRefHeap.heap
@x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MRefST.witness, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.stable, equation_MRefST.stable_on_heap, lemma_MRefST.stable_on_heap_stable, refinement_interpretation_Tm_refine_84103d4d35761d12d97de209c219f7ba, token_correspondence_MRefST.heap_rel
...
; encoding sigelt val MRefST.witness


; <Skipped val MRefST.witness/>

(push) ;; push{2

; Starting query at MRefST.fst(240,2-240,15)
...
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(235,7-235,43); use=MRefST.fst(239,4-239,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_84103d4d35761d12d97de209c219f7ba @x0
@x1
@x2)
...
;; def=MRefST.fst(235,24-235,42); use=MRefST.fst(239,4-239,11)
(Valid 
;; def=MRefST.fst(235,24-235,42); use=MRefST.fst(239,4-239,11)
(MRefST.stable_on_heap @x2
@x3
...
;     p _ /\
;     (forall (x: Prims.unit) (s1: MRefHeap.heap).
;         p _ /\ (_ == s1) /\ MRefST.ist_witnessed p ==> p (x, s1)) ==>
;     (MRefST.stable_on_heap m p ==> FStar.Preorder.stable p MRefST.heap_rel) /\
;     (forall (any_result: p: FStar.Preorder.predicate MRefHeap.heap {MRefST.stable_on_heap m p}).
;         p == any_result ==>
;         p _ /\
;         (forall (x: Prims.unit) (s1: MRefHeap.heap).
;             p _ /\ (_ == s1) /\ MRefST.ist_witnessed p ==> p (x, s1))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let witness`
...
;; def=dummy(0,0-0,0); use=MRefST.fst(240,2-240,15)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
MRefHeap.heap)
(HasType @x5
...
;; def=MRefST.fst(236,35-236,39); use=MRefST.fst(240,2-240,15)
(Valid 
;; def=MRefST.fst(236,35-236,39); use=MRefST.fst(240,2-240,15)
(ApplyTT @x3
@x4)
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(240,2-240,15)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
Prims.unit)
(HasType @x7
...
;; def=MRefST.fst(237,35-237,43); use=MRefST.fst(240,2-240,15)
(= @x4
@x7)


;; def=MRefST.fst(238,21-238,36); use=MRefST.fst(240,2-240,15)
(Valid 
;; def=MRefST.fst(238,21-238,36); use=MRefST.fst(240,2-240,15)
(MRefST.ist_witnessed @x3)
)
)

;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(240,2-240,15)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(240,2-240,15)
(ApplyTT @x5
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=Prims.fst(459,77-459,89); use=MRefST.fst(240,2-240,15)
(and (implies 
;; def=MRefST.fst(235,24-235,42); use=MRefST.fst(240,14-240,15)
(Valid 
;; def=MRefST.fst(235,24-235,42); use=MRefST.fst(240,14-240,15)
(MRefST.stable_on_heap @x0
@x1
...
;; def=MRefST.fst(127,42-127,59); use=MRefST.fst(240,14-240,15)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=MRefST.fst(240,2-240,15)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_84103d4d35761d12d97de209c219f7ba @x0
@x1
...
;; def=MRefST.fst(127,25-239,21); use=MRefST.fst(240,2-240,15)
(= @x3
@x6)
)

;; def=MRefST.fst(112,29-112,91); use=MRefST.fst(240,2-240,13)
(and 
;; def=MRefST.fst(128,31-128,35); use=MRefST.fst(240,2-240,13)
(or label_2
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(240,2-240,13)
...
;; def=MRefST.fst(128,53-128,61); use=MRefST.fst(240,2-240,13)
(= @x4
@x8)


;; def=MRefST.fst(128,65-128,80); use=MRefST.fst(240,2-240,13)
(Valid 
;; def=MRefST.fst(128,65-128,80); use=MRefST.fst(240,2-240,13)
(MRefST.ist_witnessed @x3)
)
...
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(240,2-240,13)
(or label_3
...
(declare-fun Tm_refine_84103d4d35761d12d97de209c219f7ba (Term Term Term) Term)
(declare-fun MRefST.witness (Term Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_28abf1c499f423f24dc80e40cb08c314 () Term)
(declare-fun MRefST.witness@tok () Term)
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name MRefST.witness; Namespace MRefST
(assert (! 
;; def=MRefST.fst(235,7-235,43); use=MRefST.fst(239,4-239,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_84103d4d35761d12d97de209c219f7ba @x0
...
; Starting query at MRefST.fst(243,0-249,25)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val MRefST.recall`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MRefST.fst(243,0-249,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=MRefST.fst(246,23-246,41); use=MRefST.fst(243,16-247,17)
(Valid 
;; def=MRefST.fst(246,23-246,41); use=MRefST.fst(243,16-247,17)
(MRefST.stable_on_heap @x0
@x1
...
;; def=MRefST.fst(125,36-125,53); use=MRefST.fst(247,48-247,49)
(or label_1

;; def=MRefST.fst(125,36-125,53); use=MRefST.fst(243,16-247,17)
(Valid 
;; def=MRefST.fst(125,36-125,53); use=MRefST.fst(243,16-247,17)
(FStar.Preorder.stable MRefHeap.heap
@x3
...
; encoding sigelt val MRefST.recall


; <Skipped val MRefST.recall/>
...
; Starting query at MRefST.fst(251,2-251,14)
...
; *)
;   forall (_: MRefHeap.heap) (p: Prims.pure_post (Prims.unit & MRefHeap.heap)).
;     MRefST.ist_witnessed p /\
;     (forall (x: Prims.unit) (s1: MRefHeap.heap).
;         MRefST.ist_witnessed p /\ (_ == s1) /\ p s1 ==> p (x, s1)) ==>
;     (MRefST.stable_on_heap m p ==> FStar.Preorder.stable p MRefST.heap_rel) /\
;     (forall (any_result: p: FStar.Preorder.predicate MRefHeap.heap {MRefST.stable_on_heap m p}).
;         p == any_result ==>
;         MRefST.ist_witnessed p /\
...
; Context: While encoding a query
; While typechecking the top-level declaration `let recall`
...
;; def=dummy(0,0-0,0); use=MRefST.fst(251,2-251,14)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
MRefHeap.heap)
(HasType @x5
...
;; def=MRefST.fst(247,34-247,49); use=MRefST.fst(251,2-251,14)
(Valid 
;; def=MRefST.fst(247,34-247,49); use=MRefST.fst(251,2-251,14)
(MRefST.ist_witnessed @x3)
)
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(251,2-251,14)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
Prims.unit)
(HasType @x7
...
;; def=MRefST.fst(248,34-248,42); use=MRefST.fst(251,2-251,14)
(= @x4
@x7)


;; def=MRefST.fst(249,20-249,24); use=MRefST.fst(251,2-251,14)
(Valid 
;; def=MRefST.fst(249,20-249,24); use=MRefST.fst(251,2-251,14)
(ApplyTT @x3
@x7)
...
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(251,2-251,14)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(251,2-251,14)
(ApplyTT @x5
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=Prims.fst(459,77-459,89); use=MRefST.fst(251,2-251,14)
(and (implies 
;; def=MRefST.fst(246,23-246,41); use=MRefST.fst(251,13-251,14)
(Valid 
;; def=MRefST.fst(246,23-246,41); use=MRefST.fst(251,13-251,14)
(MRefST.stable_on_heap @x0
@x1
...
;; def=MRefST.fst(131,42-131,59); use=MRefST.fst(251,13-251,14)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=MRefST.fst(251,2-251,14)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_84103d4d35761d12d97de209c219f7ba @x0
@x1
...
;; def=MRefST.fst(131,25-250,20); use=MRefST.fst(251,2-251,14)
(= @x3
@x6)
)

;; def=MRefST.fst(112,29-112,91); use=MRefST.fst(251,2-251,12)
(and 
;; def=MRefST.fst(132,30-132,45); use=MRefST.fst(251,2-251,12)
(or label_2
...
;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(251,2-251,12)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Prims.unit)
(HasType @x8
...
;; def=MRefST.fst(132,63-132,71); use=MRefST.fst(251,2-251,12)
(= @x4
@x8)


;; def=MRefST.fst(132,75-132,79); use=MRefST.fst(251,2-251,12)
(Valid 
;; def=MRefST.fst(132,75-132,79); use=MRefST.fst(251,2-251,12)
(ApplyTT @x3
@x8)
...
;; def=MRefST.fst(112,81-112,90); use=MRefST.fst(251,2-251,12)
(or label_3
