...
(declare-fun MRefST.recall (Term Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_a1649fe8b27c89028257d82329c76c84 () Term)
(declare-fun MRefST.recall@tok () Term)
...
; End Externals for module MRefST

(push) ;; push{1

; Internals for ReifyTest


; encoding sigelt val ReifyTest.reify_


; <Start encoding val ReifyTest.reify_>

;;;;;;;;;;;;;;;;_: MRefHeap.heap -> MRefST.st_post a
(declare-fun Tm_arrow_9561abf04c6c0dd578b56fedaf811c14 (Term) Term)

(declare-fun Non_total_Tm_arrow_5e55219e40c3ccbabd600b1e7127903f (Term Term Term) Term)
(declare-fun ReifyTest.reify_ (Term Term Term Term Term) Term)



(declare-fun Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513 (Term Term Term) Term)
;;;;;;;;;;;;;;;;e: (_: Prims.unit -> MRefST.MRefST a) -> h0: MRefHeap.heap -> Prims.Pure (a & MRefHeap.heap)
(declare-fun Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15 () Term)
(declare-fun ReifyTest.reify_@tok () Term)


; </end encoding val ReifyTest.reify_>


; encoding sigelt val ReifyTest.test_reify_recall


; <Skipped val ReifyTest.test_reify_recall/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ReifyTest.reify_; Namespace ReifyTest
(assert (! 
;; def=ReifyTest.fst(25,11-25,17); use=ReifyTest.fst(25,11-25,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and 
;; def=ReifyTest.fst(30,21-30,29); use=ReifyTest.fst(30,21-30,29)
(Valid 
;; def=ReifyTest.fst(30,21-30,29); use=ReifyTest.fst(30,21-30,29)
(ApplyTT @x1
@x4)
...
MRefST.st_pre)
(HasType @x2
(Tm_arrow_9561abf04c6c0dd578b56fedaf811c14 @x0))
(HasType @x3
(Non_total_Tm_arrow_5e55219e40c3ccbabd600b1e7127903f @x0
@x1
@x2))
(HasType @x4
MRefHeap.heap))
(HasType (ReifyTest.reify_ @x0
@x1
@x2
@x3
@x4)
(Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513 @x4
@x0
@x2)))
 

:pattern ((ReifyTest.reify_ @x0
@x1
@x2
@x3
@x4))
:qid typing_ReifyTest.reify_))

:named typing_ReifyTest.reify_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
(assert (! 
;; def=MRefST.fst(239,4-239,11); use=MRefST.fst(239,4-239,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
@x1
@x2)))
(HasType (MRefST.witness @x0
@x1
@x2
@x3)
(Tm_arrow_910811ad378f6df664e0b896aeeb3927 @x3)))
 

:pattern ((MRefST.witness @x0
@x1
@x2
@x3))
:qid typing_MRefST.witness))

:named typing_MRefST.witness))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.st_post; Namespace MRefST
(assert (! 
;; def=MRefST.fst(146,4-146,11); use=MRefST.fst(146,4-146,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (MRefST.st_post @x0)
Tm_type))
 

:pattern ((MRefST.st_post @x0))
:qid typing_MRefST.st_post))

:named typing_MRefST.st_post))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.recall; Namespace MRefST
(assert (! 
;; def=MRefST.fst(250,4-250,10); use=MRefST.fst(250,4-250,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
@x1
@x2)))
(HasType (MRefST.recall @x0
@x1
@x2
@x3)
(Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489 @x3)))
 

:pattern ((MRefST.recall @x0
@x1
@x2
@x3))
:qid typing_MRefST.recall))

:named typing_MRefST.recall))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.ist_witness; Namespace MRefST
(assert (! 
;; def=MRefST.fst(127,11-127,22); use=MRefST.fst(127,11-127,22)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_563c70843de6809436d12e24a4945aee)
(HasType (MRefST.ist_witness @x0)
(Tm_arrow_910811ad378f6df664e0b896aeeb3927 @x0)))
 

:pattern ((MRefST.ist_witness @x0))
:qid typing_MRefST.ist_witness))

:named typing_MRefST.ist_witness))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MRefST.ist_recall; Namespace MRefST
(assert (! 
;; def=MRefST.fst(131,11-131,21); use=MRefST.fst(131,11-131,21)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_563c70843de6809436d12e24a4945aee)
(HasType (MRefST.ist_recall @x0)
(Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489 @x0)))
 

:pattern ((MRefST.ist_recall @x0))
:qid typing_MRefST.ist_recall))

:named typing_MRefST.ist_recall))
;;;;;;;;;;;;;;;;free var typing
...
;; def=ReifyTest.fst(25,11-25,17); use=ReifyTest.fst(25,11-25,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT ReifyTest.reify_@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT ReifyTest.reify_@tok
@x0)
@x1)
@x2)
@x3)
@x4))
:qid token_correspondence_ReifyTest.reify_))

:named token_correspondence_ReifyTest.reify_))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;; Fact-ids: Name MRefST.ist_recall; Namespace MRefST
(assert (! 
;; def=MRefST.fst(27,29-27,39); use=MRefST.fst(27,29-27,39)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_da555e8303ced427eae4fef2d1b32233 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_da555e8303ced427eae4fef2d1b32233 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_da555e8303ced427eae4fef2d1b32233))

:named refinement_kinding_Tm_refine_da555e8303ced427eae4fef2d1b32233))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Preorder.preorder; Namespace FStar.Preorder
(assert (! 
...
;;; Fact-ids: Name ReifyTest.reify_; Namespace ReifyTest
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(30,10-30,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513))

:named refinement_kinding_Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.squash; Namespace Prims
(assert (! 
...
;; def=MRefST.fst(27,29-27,39); use=MRefST.fst(27,29-27,39)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_04086d969bbac74ce551bc0694b2ba76 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_04086d969bbac74ce551bc0694b2ba76 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_04086d969bbac74ce551bc0694b2ba76))

:named refinement_kinding_Tm_refine_04086d969bbac74ce551bc0694b2ba76))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_da555e8303ced427eae4fef2d1b32233 @x2
@x3))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=MRefST.fst(27,29-27,39)
(not 
;; def=MRefST.fst(112,29-112,91); use=MRefST.fst(132,11-132,14)
(and 
;; def=MRefST.fst(132,30-132,45); use=MRefST.fst(132,30-132,45)
(Valid 
;; def=MRefST.fst(132,30-132,45); use=MRefST.fst(132,30-132,45)
(MRefST.ist_witnessed @x2)
)


;; def=MRefST.fst(112,39-112,91); use=MRefST.fst(112,39-112,91)
...
;; def=MRefST.fst(132,63-132,71); use=MRefST.fst(132,63-132,71)
(= @x3
@x5)


;; def=MRefST.fst(132,75-132,79); use=MRefST.fst(132,75-132,79)
(Valid 
;; def=MRefST.fst(132,75-132,79); use=MRefST.fst(132,75-132,79)
(ApplyTT @x2
@x5)
...
;; def=Prims.fst(635,86-635,95); use=MRefST.fst(27,29-27,39)
(not 
;; def=Prims.fst(635,86-635,95); use=MRefST.fst(27,29-27,39)
...
;;no pats
:qid refinement_interpretation_Tm_refine_da555e8303ced427eae4fef2d1b32233.1))
)
)
))
...
(Tm_refine_da555e8303ced427eae4fef2d1b32233 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_da555e8303ced427eae4fef2d1b32233))

:named refinement_interpretation_Tm_refine_da555e8303ced427eae4fef2d1b32233))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Preorder.preorder; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(33,25-33,57); use=FStar.Preorder.fst(33,25-33,57)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(30,42-30,63)
(Valid 
;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(30,42-30,63)
(MRefST.heap_rel @x2
...
;; def=ReifyTest.fst(30,67-30,94); use=ReifyTest.fst(30,67-30,94)
(Valid 
;; def=ReifyTest.fst(30,67-30,94); use=ReifyTest.fst(30,67-30,94)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513))

:named refinement_interpretation_Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.squash; Namespace Prims
(assert (! 
;; def=Prims.fst(117,32-117,42); use=Prims.fst(117,32-117,42)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_04086d969bbac74ce551bc0694b2ba76 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.unit
...
;; def=Prims.fst(635,71-635,97); use=MRefST.fst(27,29-27,39)
(not 
;; def=MRefST.fst(112,29-112,91); use=MRefST.fst(128,11-128,14)
(and 
;; def=MRefST.fst(128,31-128,35); use=MRefST.fst(128,31-128,35)
(Valid 
;; def=MRefST.fst(128,31-128,35); use=MRefST.fst(128,31-128,35)
(ApplyTT @x2
@x3)
...
;; def=MRefST.fst(128,53-128,61); use=MRefST.fst(128,53-128,61)
(= @x3
@x5)


;; def=MRefST.fst(128,65-128,80); use=MRefST.fst(128,65-128,80)
(Valid 
;; def=MRefST.fst(128,65-128,80); use=MRefST.fst(128,65-128,80)
(MRefST.ist_witnessed @x2)
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_04086d969bbac74ce551bc0694b2ba76.1))
)
)
))
...
(Tm_refine_04086d969bbac74ce551bc0694b2ba76 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_04086d969bbac74ce551bc0694b2ba76))

:named refinement_interpretation_Tm_refine_04086d969bbac74ce551bc0694b2ba76))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
;; def=Prims.fst(183,34-183,38); use=Prims.fst(183,34-183,38)
...
;;; Fact-ids: Name ReifyTest.reify_; Namespace ReifyTest
(assert (! 
;; def=ReifyTest.fst(25,21-28,19); use=ReifyTest.fst(28,15-28,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(Tm_arrow_9561abf04c6c0dd578b56fedaf811c14 @x0)))
(HasType (Non_total_Tm_arrow_5e55219e40c3ccbabd600b1e7127903f @x0
@x1
@x2)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_5e55219e40c3ccbabd600b1e7127903f @x0
@x1
@x2)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_5e55219e40c3ccbabd600b1e7127903f))

:named non_total_function_typing_Non_total_Tm_arrow_5e55219e40c3ccbabd600b1e7127903f))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9561abf04c6c0dd578b56fedaf811c14
;;; Fact-ids: Name ReifyTest.reify_; Namespace ReifyTest
(assert (! 
;; def=ReifyTest.fst(27,12-27,35); use=ReifyTest.fst(27,12-27,35)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_9561abf04c6c0dd578b56fedaf811c14 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_9561abf04c6c0dd578b56fedaf811c14 @x0)
Tm_type))
:qid kinding_Tm_arrow_9561abf04c6c0dd578b56fedaf811c14))

:named kinding_Tm_arrow_9561abf04c6c0dd578b56fedaf811c14))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_910811ad378f6df664e0b896aeeb3927
;;; Fact-ids: Name MRefST.ist_witness; Namespace MRefST
(assert (! 
;; def=MRefST.fst(27,19-27,39); use=MRefST.fst(27,19-27,39)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_910811ad378f6df664e0b896aeeb3927 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_910811ad378f6df664e0b896aeeb3927 @x0)
Tm_type))
:qid kinding_Tm_arrow_910811ad378f6df664e0b896aeeb3927))

:named kinding_Tm_arrow_910811ad378f6df664e0b896aeeb3927))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489
;;; Fact-ids: Name MRefST.ist_recall; Namespace MRefST
(assert (! 
;; def=MRefST.fst(27,19-27,39); use=MRefST.fst(27,19-27,39)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489 @x0)
Tm_type))
:qid kinding_Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489))

:named kinding_Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15
;;; Fact-ids: Name ReifyTest.reify_; Namespace ReifyTest
(assert (! (HasType Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15
Tm_type)
:named kinding_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2815b0b267f771e1a7a0276ceffaed01
;;; Fact-ids: Name MRefST.st_post; Namespace MRefST
(assert (! 
;; def=MRefST.fst(146,13-146,41); use=MRefST.fst(146,23-146,41)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_2815b0b267f771e1a7a0276ceffaed01 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_2815b0b267f771e1a7a0276ceffaed01 @x0)
Tm_type))
:qid kinding_Tm_arrow_2815b0b267f771e1a7a0276ceffaed01))

:named kinding_Tm_arrow_2815b0b267f771e1a7a0276ceffaed01))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_da555e8303ced427eae4fef2d1b32233
;;; Fact-ids: Name MRefST.ist_recall; Namespace MRefST
(assert (! 
;; def=MRefST.fst(27,29-27,39); use=MRefST.fst(27,29-27,39)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_da555e8303ced427eae4fef2d1b32233 @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_da555e8303ced427eae4fef2d1b32233 @x0
@x1))))
:qid haseqTm_refine_da555e8303ced427eae4fef2d1b32233))

:named haseqTm_refine_da555e8303ced427eae4fef2d1b32233))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513
;;; Fact-ids: Name ReifyTest.reify_; Namespace ReifyTest
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(30,10-30,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513 @x0
@x1
@x2)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513 @x0
@x1
@x2))))
:qid haseqTm_refine_33b89ecae4fc27dfb50b3d0b43c33513))

:named haseqTm_refine_33b89ecae4fc27dfb50b3d0b43c33513))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_04086d969bbac74ce551bc0694b2ba76
;;; Fact-ids: Name MRefST.ist_witness; Namespace MRefST
(assert (! 
;; def=MRefST.fst(27,29-27,39); use=MRefST.fst(27,29-27,39)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_04086d969bbac74ce551bc0694b2ba76 @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_04086d969bbac74ce551bc0694b2ba76 @x0
@x1))))
:qid haseqTm_refine_04086d969bbac74ce551bc0694b2ba76))

:named haseqTm_refine_04086d969bbac74ce551bc0694b2ba76))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name ReifyTest.reify_; Namespace ReifyTest
(assert (! 
;; def=ReifyTest.fst(25,11-25,17); use=ReifyTest.fst(25,11-25,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType ReifyTest.reify_@tok
Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15))
...
:pattern ((ReifyTest.reify_ @x1
@x2
@x3
@x4
@x5))
:qid function_token_typing_ReifyTest.reify_.1))
)
 

:pattern ((ApplyTT @x0
ReifyTest.reify_@tok))
:qid function_token_typing_ReifyTest.reify_))

:named function_token_typing_ReifyTest.reify_))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
@x2
@x3))
:qid equation_MRefST.witness))

:named equation_MRefST.witness))
...
;;;;;;;;;;;;;;;;Equation for MRefST.st_post
;;; Fact-ids: Name MRefST.st_post; Namespace MRefST
(assert (! 
;; def=MRefST.fst(146,4-146,11); use=MRefST.fst(146,4-146,11)
(forall ((@x0 Term))
 (! (= (MRefST.st_post @x0)
(Tm_arrow_2815b0b267f771e1a7a0276ceffaed01 @x0))
 

:pattern ((MRefST.st_post @x0))
:qid equation_MRefST.st_post))

:named equation_MRefST.st_post))
;;;;;;;;;;;;;;;;Equation for MRefST.recall
;;; Fact-ids: Name MRefST.recall; Namespace MRefST
(assert (! 
;; def=MRefST.fst(250,4-250,10); use=MRefST.fst(250,4-250,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3))
:qid equation_MRefST.recall))

:named equation_MRefST.recall))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_9561abf04c6c0dd578b56fedaf811c14 @x2))
...
@x1
(Tm_arrow_9561abf04c6c0dd578b56fedaf811c14 @x2)))
:qid ReifyTest_pre_typing_Tm_arrow_9561abf04c6c0dd578b56fedaf811c14))

:named ReifyTest_pre_typing_Tm_arrow_9561abf04c6c0dd578b56fedaf811c14))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name ReifyTest.reify_; Namespace ReifyTest
(assert (! 
;; def=ReifyTest.fst(25,21-30,20); use=ReifyTest.fst(25,23-30,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15)
...
@x1
Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15))
:qid ReifyTest_pre_typing_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15))

:named ReifyTest_pre_typing_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9561abf04c6c0dd578b56fedaf811c14
;;; Fact-ids: Name ReifyTest.reify_; Namespace ReifyTest
(assert (! 
;; def=ReifyTest.fst(27,12-27,35); use=ReifyTest.fst(27,12-27,35)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_9561abf04c6c0dd578b56fedaf811c14 @x1))
(and 
;; def=ReifyTest.fst(27,12-27,35); use=ReifyTest.fst(27,12-27,35)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid ReifyTest_interpretation_Tm_arrow_9561abf04c6c0dd578b56fedaf811c14.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_9561abf04c6c0dd578b56fedaf811c14 @x1)))
:qid ReifyTest_interpretation_Tm_arrow_9561abf04c6c0dd578b56fedaf811c14))

:named ReifyTest_interpretation_Tm_arrow_9561abf04c6c0dd578b56fedaf811c14))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15
;;; Fact-ids: Name ReifyTest.reify_; Namespace ReifyTest
(assert (! 
;; def=ReifyTest.fst(25,21-30,20); use=ReifyTest.fst(25,23-30,20)
(forall ((@x0 Term))
...
(Tm_arrow_9561abf04c6c0dd578b56fedaf811c14 @x1))
(HasType @x4
(Non_total_Tm_arrow_5e55219e40c3ccbabd600b1e7127903f @x1
@x2
@x3))
(HasType @x5
MRefHeap.heap))
...
@x4)
@x5)
(Tm_refine_33b89ecae4fc27dfb50b3d0b43c33513 @x5
@x1
@x3)))
...
@x4)
@x5))
:qid ReifyTest_interpretation_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ReifyTest_interpretation_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15.2))
...
@x1)
@x2))
:qid ReifyTest_interpretation_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15.3))
...
@x2)
@x3))
:qid ReifyTest_interpretation_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15.4))
...
@x3)
@x4))
:qid ReifyTest_interpretation_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15.5))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15))
:qid ReifyTest_interpretation_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15))

:named ReifyTest_interpretation_Tm_arrow_35275fb52ba8b7013ec0e5939c2f4a15))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_910811ad378f6df664e0b896aeeb3927 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_910811ad378f6df664e0b896aeeb3927 @x2)))
:qid MRefST_pre_typing_Tm_arrow_910811ad378f6df664e0b896aeeb3927))

:named MRefST_pre_typing_Tm_arrow_910811ad378f6df664e0b896aeeb3927))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MRefST.contains; Namespace MRefST
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489 @x2)))
:qid MRefST_pre_typing_Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489))

:named MRefST_pre_typing_Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MRefST.heap_rel; Namespace MRefST
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_2815b0b267f771e1a7a0276ceffaed01 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_2815b0b267f771e1a7a0276ceffaed01 @x2)))
:qid MRefST_pre_typing_Tm_arrow_2815b0b267f771e1a7a0276ceffaed01))

:named MRefST_pre_typing_Tm_arrow_2815b0b267f771e1a7a0276ceffaed01))
...
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_910811ad378f6df664e0b896aeeb3927
;;; Fact-ids: Name MRefST.ist_witness; Namespace MRefST
(assert (! 
;; def=MRefST.fst(27,19-27,39); use=MRefST.fst(27,19-27,39)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_910811ad378f6df664e0b896aeeb3927 @x1))
(and 
;; def=MRefST.fst(27,19-27,39); use=MRefST.fst(27,19-27,39)
(forall ((@x2 Term))
 (! (implies (and 
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_04086d969bbac74ce551bc0694b2ba76 @x1
@x2)))
 

:pattern ((ApplyTT @x0
@x2))
:qid MRefST_interpretation_Tm_arrow_910811ad378f6df664e0b896aeeb3927.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_910811ad378f6df664e0b896aeeb3927 @x1)))
:qid MRefST_interpretation_Tm_arrow_910811ad378f6df664e0b896aeeb3927))

:named MRefST_interpretation_Tm_arrow_910811ad378f6df664e0b896aeeb3927))
...
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489
;;; Fact-ids: Name MRefST.ist_recall; Namespace MRefST
(assert (! 
;; def=MRefST.fst(27,19-27,39); use=MRefST.fst(27,19-27,39)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489 @x1))
(and 
;; def=MRefST.fst(27,19-27,39); use=MRefST.fst(27,19-27,39)
(forall ((@x2 Term))
 (! (implies (and 
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_da555e8303ced427eae4fef2d1b32233 @x1
@x2)))
 

:pattern ((ApplyTT @x0
@x2))
:qid MRefST_interpretation_Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489 @x1)))
:qid MRefST_interpretation_Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489))

:named MRefST_interpretation_Tm_arrow_8c504d659cdaf7995ca7fdf8a2cb2489))
...
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2815b0b267f771e1a7a0276ceffaed01
;;; Fact-ids: Name MRefST.st_post; Namespace MRefST
(assert (! 
;; def=MRefST.fst(146,13-146,41); use=MRefST.fst(146,23-146,41)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_2815b0b267f771e1a7a0276ceffaed01 @x1))
(and 
;; def=MRefST.fst(146,13-146,41); use=MRefST.fst(146,23-146,41)
...
@x2)
@x3))
:qid MRefST_interpretation_Tm_arrow_2815b0b267f771e1a7a0276ceffaed01.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid MRefST_interpretation_Tm_arrow_2815b0b267f771e1a7a0276ceffaed01.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_2815b0b267f771e1a7a0276ceffaed01 @x1)))
:qid MRefST_interpretation_Tm_arrow_2815b0b267f771e1a7a0276ceffaed01))

:named MRefST_interpretation_Tm_arrow_2815b0b267f771e1a7a0276ceffaed01))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
; Starting query at ReifyTest.fst(38,25-69,4)

(declare-fun label_119 () Bool)
(declare-fun label_118 () Bool)
(declare-fun label_117 () Bool)
(declare-fun label_116 () Bool)
(declare-fun label_115 () Bool)
(declare-fun label_114 () Bool)
(declare-fun label_113 () Bool)
(declare-fun label_112 () Bool)
(declare-fun label_111 () Bool)
(declare-fun label_110 () Bool)
(declare-fun label_109 () Bool)
(declare-fun label_108 () Bool)
(declare-fun label_107 () Bool)
(declare-fun label_106 () Bool)
(declare-fun label_105 () Bool)
(declare-fun label_104 () Bool)
(declare-fun label_103 () Bool)
(declare-fun label_102 () Bool)
(declare-fun label_101 () Bool)
(declare-fun label_100 () Bool)
(declare-fun label_99 () Bool)
(declare-fun label_98 () Bool)
(declare-fun label_97 () Bool)
(declare-fun label_96 () Bool)
(declare-fun label_95 () Bool)
(declare-fun label_94 () Bool)
(declare-fun label_93 () Bool)
(declare-fun label_92 () Bool)
(declare-fun label_91 () Bool)
(declare-fun label_90 () Bool)
(declare-fun label_89 () Bool)
(declare-fun label_88 () Bool)
(declare-fun label_87 () Bool)
(declare-fun label_86 () Bool)
...
;;;;;;;;;;;;;;;;n: Prims.int -> m: Prims.int -> Prims.logical
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(180,21-564,34); use=ReifyTest.fst(40,10-40,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_7418b65d64c02ff38a120101f758e12a))
:qid ReifyTest_pre_typing_Tm_arrow_7418b65d64c02ff38a120101f758e12a))

:named ReifyTest_pre_typing_Tm_arrow_7418b65d64c02ff38a120101f758e12a))
...
@x1)
@x2))
:qid ReifyTest_interpretation_Tm_arrow_7418b65d64c02ff38a120101f758e12a.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ReifyTest_interpretation_Tm_arrow_7418b65d64c02ff38a120101f758e12a.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_7418b65d64c02ff38a120101f758e12a))
:qid ReifyTest_interpretation_Tm_arrow_7418b65d64c02ff38a120101f758e12a))

:named ReifyTest_interpretation_Tm_arrow_7418b65d64c02ff38a120101f758e12a))
...
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(40,33-40,45); use=ReifyTest.fst(40,10-40,15)
(forall ((@x0 Term) (@x1 Term))
...
(declare-fun Tm_abs_11b16c9203efa3f1f094acdf6d874065 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_11b16c9203efa3f1f094acdf6d874065
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(48,46-48,73); use=ReifyTest.fst(48,26-48,33)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x0)
Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86)
 

:pattern ((Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x0))
:qid typing_Tm_abs_11b16c9203efa3f1f094acdf6d874065))

:named typing_Tm_abs_11b16c9203efa3f1f094acdf6d874065))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_11b16c9203efa3f1f094acdf6d874065
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(48,46-48,73); use=ReifyTest.fst(48,26-48,33)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x1)
@x0)
(Prims.l_and (MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x1
@x0)
(Prims.b2t (Prims.op_GreaterThan (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x0
@x1)
(BoxInt 0)))))
...
:pattern ((ApplyTT (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x1)
@x0))
:qid interpretation_Tm_abs_11b16c9203efa3f1f094acdf6d874065))

:named interpretation_Tm_abs_11b16c9203efa3f1f094acdf6d874065))
...
(declare-fun Tm_refine_ef8aa84d4725bff65536849e87a726de (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(235,7-235,43); use=ReifyTest.fst(48,26-48,74)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_ef8aa84d4725bff65536849e87a726de @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_ef8aa84d4725bff65536849e87a726de @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_ef8aa84d4725bff65536849e87a726de))

:named refinement_kinding_Tm_refine_ef8aa84d4725bff65536849e87a726de))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(235,7-235,43); use=ReifyTest.fst(48,26-48,74)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ef8aa84d4725bff65536849e87a726de @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Preorder.predicate MRefHeap.heap))

;; def=MRefST.fst(235,24-235,42); use=ReifyTest.fst(48,26-48,74)
(Valid 
;; def=MRefST.fst(235,24-235,42); use=ReifyTest.fst(48,26-48,74)
(MRefST.stable_on_heap Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x2
@x1)
)
...
@x1
(Tm_refine_ef8aa84d4725bff65536849e87a726de @x2)))
:qid refinement_interpretation_Tm_refine_ef8aa84d4725bff65536849e87a726de))

:named refinement_interpretation_Tm_refine_ef8aa84d4725bff65536849e87a726de))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ef8aa84d4725bff65536849e87a726de
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(235,7-235,43); use=ReifyTest.fst(48,26-48,74)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ef8aa84d4725bff65536849e87a726de @x0)))
(Valid (Prims.hasEq (FStar.Preorder.predicate MRefHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ef8aa84d4725bff65536849e87a726de @x0))))
:qid haseqTm_refine_ef8aa84d4725bff65536849e87a726de))

:named haseqTm_refine_ef8aa84d4725bff65536849e87a726de))
...
(declare-fun Non_total_Tm_arrow_d63fb4bb9865ce46a3aa4eda28db4a45 (Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(48,17-48,21); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(MRefST.mref Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb))
(HasType (Non_total_Tm_arrow_d63fb4bb9865ce46a3aa4eda28db4a45 @x0)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_d63fb4bb9865ce46a3aa4eda28db4a45 @x0)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_d63fb4bb9865ce46a3aa4eda28db4a45))

:named non_total_function_typing_Non_total_Tm_arrow_d63fb4bb9865ce46a3aa4eda28db4a45))
...
(declare-fun Tm_refine_d68eb121664644607cbd234bb0124014 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=ReifyTest.fst(49,10-49,16)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_d68eb121664644607cbd234bb0124014 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_d68eb121664644607cbd234bb0124014 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_d68eb121664644607cbd234bb0124014))

:named refinement_kinding_Tm_refine_d68eb121664644607cbd234bb0124014))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=ReifyTest.fst(49,10-49,16)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d68eb121664644607cbd234bb0124014 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.unit
...
;; def=ReifyTest.fst(49,35-49,48); use=ReifyTest.fst(49,10-49,16)
(Valid 
;; def=ReifyTest.fst(49,35-49,48); use=ReifyTest.fst(49,10-49,16)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x2
@x3)
)
...
;; def=ReifyTest.fst(49,52-49,64); use=ReifyTest.fst(49,10-49,16)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x3
@x2))
(BoxInt_proj_0 (BoxInt 0)))
...
(Tm_refine_d68eb121664644607cbd234bb0124014 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_d68eb121664644607cbd234bb0124014))

:named refinement_interpretation_Tm_refine_d68eb121664644607cbd234bb0124014))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d68eb121664644607cbd234bb0124014
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=ReifyTest.fst(49,10-49,16)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d68eb121664644607cbd234bb0124014 @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d68eb121664644607cbd234bb0124014 @x0
@x1))))
:qid haseqTm_refine_d68eb121664644607cbd234bb0124014))

:named haseqTm_refine_d68eb121664644607cbd234bb0124014))
...
;;;;;;;;;;;;;;;;_: MRefHeap.heap -> MRefST.st_post Prims.unit
(declare-fun Tm_arrow_db03875a5cb0d115e6495f3e01f8d168 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_db03875a5cb0d115e6495f3e01f8d168
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_db03875a5cb0d115e6495f3e01f8d168
Tm_type)
:named kinding_Tm_arrow_db03875a5cb0d115e6495f3e01f8d168))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(27,12-27,35); use=ReifyTest.fst(38,25-69,4)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_db03875a5cb0d115e6495f3e01f8d168)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_db03875a5cb0d115e6495f3e01f8d168))
:qid ReifyTest_pre_typing_Tm_arrow_db03875a5cb0d115e6495f3e01f8d168))

:named ReifyTest_pre_typing_Tm_arrow_db03875a5cb0d115e6495f3e01f8d168))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_db03875a5cb0d115e6495f3e01f8d168
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(27,12-27,35); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(MRefST.st_post Prims.unit)))
 

:pattern ((ApplyTT @x0
@x1))
:qid ReifyTest_interpretation_Tm_arrow_db03875a5cb0d115e6495f3e01f8d168.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_db03875a5cb0d115e6495f3e01f8d168))
:qid ReifyTest_interpretation_Tm_arrow_db03875a5cb0d115e6495f3e01f8d168))

:named ReifyTest_interpretation_Tm_arrow_db03875a5cb0d115e6495f3e01f8d168))
...
(declare-fun Tm_refine_6162a3dce6268aaa3442f2178aefe06c (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_6162a3dce6268aaa3442f2178aefe06c @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_6162a3dce6268aaa3442f2178aefe06c @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_6162a3dce6268aaa3442f2178aefe06c))

:named refinement_kinding_Tm_refine_6162a3dce6268aaa3442f2178aefe06c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6162a3dce6268aaa3442f2178aefe06c @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.unit
...
;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(38,25-69,4)
(Valid 
;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(38,25-69,4)
(MRefST.heap_rel @x2
...
;; def=ReifyTest.fst(49,83-49,91); use=ReifyTest.fst(38,25-69,4)
(= @x2
(FStar.Pervasives.Native.snd Prims.unit
MRefHeap.heap
@x1))
...
;; def=ReifyTest.fst(49,95-49,147); use=ReifyTest.fst(38,25-69,4)
(Valid 
;; def=ReifyTest.fst(49,95-49,147); use=ReifyTest.fst(38,25-69,4)
(MRefST.ist_witnessed (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x3))
)
))
...
(Tm_refine_6162a3dce6268aaa3442f2178aefe06c @x2
@x3)))
:qid refinement_interpretation_Tm_refine_6162a3dce6268aaa3442f2178aefe06c))

:named refinement_interpretation_Tm_refine_6162a3dce6268aaa3442f2178aefe06c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6162a3dce6268aaa3442f2178aefe06c
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6162a3dce6268aaa3442f2178aefe06c @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6162a3dce6268aaa3442f2178aefe06c @x0
@x1))))
:qid haseqTm_refine_6162a3dce6268aaa3442f2178aefe06c))

:named haseqTm_refine_6162a3dce6268aaa3442f2178aefe06c))




;;;;;;;;;;;;;;;;h0: MRefHeap.heap -> Prims.Pure (Prims.unit & MRefHeap.heap)
(declare-fun Tm_arrow_d94672bde35300047ebb58a3cbc1d455 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d94672bde35300047ebb58a3cbc1d455
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_d94672bde35300047ebb58a3cbc1d455 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_d94672bde35300047ebb58a3cbc1d455 @x0)
Tm_type))
:qid kinding_Tm_arrow_d94672bde35300047ebb58a3cbc1d455))

:named kinding_Tm_arrow_d94672bde35300047ebb58a3cbc1d455))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_d94672bde35300047ebb58a3cbc1d455 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_d94672bde35300047ebb58a3cbc1d455 @x2)))
:qid ReifyTest_pre_typing_Tm_arrow_d94672bde35300047ebb58a3cbc1d455))

:named ReifyTest_pre_typing_Tm_arrow_d94672bde35300047ebb58a3cbc1d455))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d94672bde35300047ebb58a3cbc1d455
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_d94672bde35300047ebb58a3cbc1d455 @x1))
(and 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x2 Term))
 (! (implies (and 
;; def=ReifyTest.fst(49,35-49,48); use=ReifyTest.fst(38,25-69,4)
(Valid 
;; def=ReifyTest.fst(49,35-49,48); use=ReifyTest.fst(38,25-69,4)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=ReifyTest.fst(49,52-49,64); use=ReifyTest.fst(38,25-69,4)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x2
@x1))
...
:pattern ((ApplyTT @x0
@x2))
:qid ReifyTest_interpretation_Tm_arrow_d94672bde35300047ebb58a3cbc1d455.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_d94672bde35300047ebb58a3cbc1d455 @x1)))
:qid ReifyTest_interpretation_Tm_arrow_d94672bde35300047ebb58a3cbc1d455))

:named ReifyTest_interpretation_Tm_arrow_d94672bde35300047ebb58a3cbc1d455))
...
(declare-fun Tm_abs_c66f7e87d18c04430a63c341491495ae (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_c66f7e87d18c04430a63c341491495ae
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(51,47-51,74); use=ReifyTest.fst(51,27-51,34)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_c66f7e87d18c04430a63c341491495ae @x0)
Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86)
 

:pattern ((Tm_abs_c66f7e87d18c04430a63c341491495ae @x0))
:qid typing_Tm_abs_c66f7e87d18c04430a63c341491495ae))

:named typing_Tm_abs_c66f7e87d18c04430a63c341491495ae))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c66f7e87d18c04430a63c341491495ae
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(51,47-51,74); use=ReifyTest.fst(51,27-51,34)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_c66f7e87d18c04430a63c341491495ae @x1)
@x0)
(Prims.l_and (MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x1
...
:pattern ((ApplyTT (Tm_abs_c66f7e87d18c04430a63c341491495ae @x1)
@x0))
:qid interpretation_Tm_abs_c66f7e87d18c04430a63c341491495ae))

:named interpretation_Tm_abs_c66f7e87d18c04430a63c341491495ae))
...
(declare-fun Non_total_Tm_arrow_29799c310242d2055a2ac1e06c1efb69 (Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(51,18-51,22); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(MRefST.mref Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb))
(HasType (Non_total_Tm_arrow_29799c310242d2055a2ac1e06c1efb69 @x0)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_29799c310242d2055a2ac1e06c1efb69 @x0)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_29799c310242d2055a2ac1e06c1efb69))

:named non_total_function_typing_Non_total_Tm_arrow_29799c310242d2055a2ac1e06c1efb69))
...
(declare-fun Tm_refine_515dbcfa3aa0d72afef7e9cb72574707 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_515dbcfa3aa0d72afef7e9cb72574707 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_515dbcfa3aa0d72afef7e9cb72574707 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_515dbcfa3aa0d72afef7e9cb72574707))

:named refinement_kinding_Tm_refine_515dbcfa3aa0d72afef7e9cb72574707))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_515dbcfa3aa0d72afef7e9cb72574707 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))
...
@x1
(Tm_refine_515dbcfa3aa0d72afef7e9cb72574707 @x2)))
:qid refinement_interpretation_Tm_refine_515dbcfa3aa0d72afef7e9cb72574707))

:named refinement_interpretation_Tm_refine_515dbcfa3aa0d72afef7e9cb72574707))
;;;;;;;;;;;;;;;;haseq for Tm_refine_515dbcfa3aa0d72afef7e9cb72574707
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_515dbcfa3aa0d72afef7e9cb72574707 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_515dbcfa3aa0d72afef7e9cb72574707 @x0))))
:qid haseqTm_refine_515dbcfa3aa0d72afef7e9cb72574707))

:named haseqTm_refine_515dbcfa3aa0d72afef7e9cb72574707))




;;;;;;;;;;;;;;;;h0: MRefHeap.heap -> Prims.Pure (Prims.unit & MRefHeap.heap)
(declare-fun Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a @x0)
Tm_type))
:qid kinding_Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a))

:named kinding_Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a @x2)))
:qid ReifyTest_pre_typing_Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a))

:named ReifyTest_pre_typing_Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a @x1))
(and 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x2 Term))
 (! (implies (and 
;; def=ReifyTest.fst(52,36-52,49); use=ReifyTest.fst(38,25-69,4)
(Valid 
;; def=ReifyTest.fst(52,36-52,49); use=ReifyTest.fst(38,25-69,4)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=ReifyTest.fst(52,53-52,65); use=ReifyTest.fst(38,25-69,4)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x2
@x1))
(BoxInt_proj_0 (BoxInt 3)))
...
:pattern ((ApplyTT @x0
@x2))
:qid ReifyTest_interpretation_Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a @x1)))
:qid ReifyTest_interpretation_Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a))

:named ReifyTest_interpretation_Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a))
...
(declare-fun Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(247,34-247,49); use=ReifyTest.fst(58,26-58,32)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0 @x0)
Tm_arrow_fddf70d42854bcd0aeeb74533f06ee86)
 

:pattern ((Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0 @x0))
:qid typing_Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0))

:named typing_Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(247,34-247,49); use=ReifyTest.fst(58,26-58,32)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0 @x1)
@x0)
(MRefST.ist_witnessed (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x1)))
 

:pattern ((ApplyTT (Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0 @x1)
@x0))
:qid interpretation_Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0))

:named interpretation_Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0))
...
(declare-fun Non_total_Tm_arrow_27795e1622491572bb5e0c01e61d2138 (Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(58,17-58,21); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(MRefST.mref Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb))
(HasType (Non_total_Tm_arrow_27795e1622491572bb5e0c01e61d2138 @x0)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_27795e1622491572bb5e0c01e61d2138 @x0)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_27795e1622491572bb5e0c01e61d2138))

:named non_total_function_typing_Non_total_Tm_arrow_27795e1622491572bb5e0c01e61d2138))
...
(declare-fun Tm_refine_85bd48a266b4b4b849a096b42f2ffa97 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=ReifyTest.fst(59,10-59,16)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_85bd48a266b4b4b849a096b42f2ffa97 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_85bd48a266b4b4b849a096b42f2ffa97 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_85bd48a266b4b4b849a096b42f2ffa97))

:named refinement_kinding_Tm_refine_85bd48a266b4b4b849a096b42f2ffa97))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=ReifyTest.fst(59,10-59,16)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_85bd48a266b4b4b849a096b42f2ffa97 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))

;; def=ReifyTest.fst(59,35-59,87); use=ReifyTest.fst(59,10-59,16)
(Valid 
;; def=ReifyTest.fst(59,35-59,87); use=ReifyTest.fst(59,10-59,16)
(MRefST.ist_witnessed (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x2))
)
))
...
@x1
(Tm_refine_85bd48a266b4b4b849a096b42f2ffa97 @x2)))
:qid refinement_interpretation_Tm_refine_85bd48a266b4b4b849a096b42f2ffa97))

:named refinement_interpretation_Tm_refine_85bd48a266b4b4b849a096b42f2ffa97))
;;;;;;;;;;;;;;;;haseq for Tm_refine_85bd48a266b4b4b849a096b42f2ffa97
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=ReifyTest.fst(59,10-59,16)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_85bd48a266b4b4b849a096b42f2ffa97 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_85bd48a266b4b4b849a096b42f2ffa97 @x0))))
:qid haseqTm_refine_85bd48a266b4b4b849a096b42f2ffa97))

:named haseqTm_refine_85bd48a266b4b4b849a096b42f2ffa97))
...
(declare-fun Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa))

:named refinement_kinding_Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.unit
...
;; def=ReifyTest.fst(59,106-59,114); use=ReifyTest.fst(38,25-69,4)
(= @x2
(FStar.Pervasives.Native.snd Prims.unit
MRefHeap.heap
@x1))
...
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(38,25-69,4)
(Valid 
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(38,25-69,4)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=ReifyTest.fst(59,135-59,147); use=ReifyTest.fst(38,25-69,4)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
(FStar.Pervasives.Native.snd Prims.unit
MRefHeap.heap
...
(Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa @x2
@x3)))
:qid refinement_interpretation_Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa))

:named refinement_interpretation_Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa))
;;;;;;;;;;;;;;;;haseq for Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(30,10-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa @x0
@x1))))
:qid haseqTm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa))

:named haseqTm_refine_50cbbfe2bb5ebdb11b1296d4a0bb37aa))
...
;;;;;;;;;;;;;;;;h0: MRefHeap.heap -> Prims.Pure (Prims.unit & MRefHeap.heap)
(declare-fun Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23 @x0)
Tm_type))
:qid kinding_Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23))

:named kinding_Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23 @x2)))
:qid ReifyTest_pre_typing_Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23))

:named ReifyTest_pre_typing_Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23 @x1))
(and 
;; def=ReifyTest.fst(29,8-30,20); use=ReifyTest.fst(38,25-69,4)
(forall ((@x2 Term))
 (! (implies (and 
;; def=ReifyTest.fst(59,35-59,87); use=ReifyTest.fst(38,25-69,4)
(Valid 
;; def=ReifyTest.fst(59,35-59,87); use=ReifyTest.fst(38,25-69,4)
(MRefST.ist_witnessed (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x1))
)
...
:pattern ((ApplyTT @x0
@x2))
:qid ReifyTest_interpretation_Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23 @x1)))
:qid ReifyTest_interpretation_Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23))

:named ReifyTest_interpretation_Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23))
...
;;;;;;;;;;;;;;;;h0: MRefHeap.heap -> _: Prims.unit -> h1: MRefHeap.heap -> Type0
(declare-fun Tm_arrow_2b371d1da190fb9cb58578108c7b49d4 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2b371d1da190fb9cb58578108c7b49d4
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_2b371d1da190fb9cb58578108c7b49d4
Tm_type)
:named kinding_Tm_arrow_2b371d1da190fb9cb58578108c7b49d4))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(146,28-146,32); use=ReifyTest.fst(38,25-69,4)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2b371d1da190fb9cb58578108c7b49d4)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_2b371d1da190fb9cb58578108c7b49d4))
:qid ReifyTest_pre_typing_Tm_arrow_2b371d1da190fb9cb58578108c7b49d4))

:named ReifyTest_pre_typing_Tm_arrow_2b371d1da190fb9cb58578108c7b49d4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2b371d1da190fb9cb58578108c7b49d4
;;; Fact-ids: 
(assert (! 
;; def=MRefST.fst(146,28-146,32); use=ReifyTest.fst(38,25-69,4)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid ReifyTest_interpretation_Tm_arrow_2b371d1da190fb9cb58578108c7b49d4.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ReifyTest_interpretation_Tm_arrow_2b371d1da190fb9cb58578108c7b49d4.2))
...
@x1)
@x2))
:qid ReifyTest_interpretation_Tm_arrow_2b371d1da190fb9cb58578108c7b49d4.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_2b371d1da190fb9cb58578108c7b49d4))
:qid ReifyTest_interpretation_Tm_arrow_2b371d1da190fb9cb58578108c7b49d4))

:named ReifyTest_interpretation_Tm_arrow_2b371d1da190fb9cb58578108c7b49d4))
(declare-fun Tm_abs_b323ab8375c7c8424383dbcd3a486073 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_b323ab8375c7c8424383dbcd3a486073
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(59,106-59,147); use=ReifyTest.fst(59,106-59,147)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_b323ab8375c7c8424383dbcd3a486073 @x0)
Tm_arrow_2b371d1da190fb9cb58578108c7b49d4)
 

:pattern ((Tm_abs_b323ab8375c7c8424383dbcd3a486073 @x0))
:qid typing_Tm_abs_b323ab8375c7c8424383dbcd3a486073))

:named typing_Tm_abs_b323ab8375c7c8424383dbcd3a486073))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_b323ab8375c7c8424383dbcd3a486073
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(59,106-59,147); use=ReifyTest.fst(59,106-59,147)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_b323ab8375c7c8424383dbcd3a486073 @x3)
@x0)
@x1)
@x2)
(Prims.l_and (Prims.l_and (Prims.eq2 MRefHeap.heap
@x0
@x2)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_b323ab8375c7c8424383dbcd3a486073 @x3)
@x0)
@x1)
@x2))
:qid interpretation_Tm_abs_b323ab8375c7c8424383dbcd3a486073))

:named interpretation_Tm_abs_b323ab8375c7c8424383dbcd3a486073))
...
(declare-fun Tm_abs_5a9700791ea89db7b273ab12f39fd270 (Term) Term)
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_5a9700791ea89db7b273ab12f39fd270
;;; Fact-ids: 
(assert (! true
:named tot_fun_Tm_abs_5a9700791ea89db7b273ab12f39fd270))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_5a9700791ea89db7b273ab12f39fd270
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(58,26-58,73); use=ReifyTest.fst(58,26-58,73)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_5a9700791ea89db7b273ab12f39fd270 @x1)
@x0)
(MRefST.recall Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x1
(Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x1)))
 

:pattern ((ApplyTT (Tm_abs_5a9700791ea89db7b273ab12f39fd270 @x1)
@x0))
:qid interpretation_Tm_abs_5a9700791ea89db7b273ab12f39fd270))

:named interpretation_Tm_abs_5a9700791ea89db7b273ab12f39fd270))
...
(assert (! (Valid (ApplyTT __uu__PartialApp
ReifyTest.reify_@tok))
:named @kick_partial_app_de8c9bcc11a78f7e5ebce3c33a1413e8))
...
(declare-fun Tm_abs_230922f1ee3fe218902f537b21eddf03 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_230922f1ee3fe218902f537b21eddf03
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(49,83-49,147); use=ReifyTest.fst(49,83-49,147)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_230922f1ee3fe218902f537b21eddf03 @x0)
Tm_arrow_2b371d1da190fb9cb58578108c7b49d4)
 

:pattern ((Tm_abs_230922f1ee3fe218902f537b21eddf03 @x0))
:qid typing_Tm_abs_230922f1ee3fe218902f537b21eddf03))

:named typing_Tm_abs_230922f1ee3fe218902f537b21eddf03))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_230922f1ee3fe218902f537b21eddf03
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(49,83-49,147); use=ReifyTest.fst(49,83-49,147)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_230922f1ee3fe218902f537b21eddf03 @x3)
@x0)
@x1)
@x2)
(Prims.l_and (Prims.eq2 MRefHeap.heap
@x0
@x2)
(MRefST.ist_witnessed (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x3))))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_230922f1ee3fe218902f537b21eddf03 @x3)
@x0)
@x1)
@x2))
:qid interpretation_Tm_abs_230922f1ee3fe218902f537b21eddf03))

:named interpretation_Tm_abs_230922f1ee3fe218902f537b21eddf03))
...
(declare-fun Tm_abs_05672b4664841765d3343ccdced4cd78 (Term) Term)
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_05672b4664841765d3343ccdced4cd78
;;; Fact-ids: 
(assert (! true
:named tot_fun_Tm_abs_05672b4664841765d3343ccdced4cd78))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_05672b4664841765d3343ccdced4cd78
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(48,26-48,74); use=ReifyTest.fst(48,26-48,74)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_05672b4664841765d3343ccdced4cd78 @x1)
@x0)
(MRefST.witness Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x1
(Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x1)))
 

:pattern ((ApplyTT (Tm_abs_05672b4664841765d3343ccdced4cd78 @x1)
@x0))
:qid interpretation_Tm_abs_05672b4664841765d3343ccdced4cd78))

:named interpretation_Tm_abs_05672b4664841765d3343ccdced4cd78))
...
(declare-fun Tm_abs_6f53370f93d2a4384de4b9ba6c714e73 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_6f53370f93d2a4384de4b9ba6c714e73
;;; Fact-ids: 
(assert (! (HasType Tm_abs_6f53370f93d2a4384de4b9ba6c714e73
Tm_arrow_2b371d1da190fb9cb58578108c7b49d4)
:named typing_Tm_abs_6f53370f93d2a4384de4b9ba6c714e73))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_6f53370f93d2a4384de4b9ba6c714e73
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(52,82-52,86); use=ReifyTest.fst(52,82-52,86)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Tm_abs_6f53370f93d2a4384de4b9ba6c714e73
@x0)
@x1)
@x2)
Prims.l_True)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Tm_abs_6f53370f93d2a4384de4b9ba6c714e73
@x0)
@x1)
@x2))
:qid interpretation_Tm_abs_6f53370f93d2a4384de4b9ba6c714e73))

:named interpretation_Tm_abs_6f53370f93d2a4384de4b9ba6c714e73))
...
(declare-fun Tm_abs_2cd3632f06038c7f0bd444d4f517d527 (Term) Term)
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_2cd3632f06038c7f0bd444d4f517d527
;;; Fact-ids: 
(assert (! true
:named tot_fun_Tm_abs_2cd3632f06038c7f0bd444d4f517d527))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2cd3632f06038c7f0bd444d4f517d527
;;; Fact-ids: 
(assert (! 
;; def=ReifyTest.fst(51,27-51,75); use=ReifyTest.fst(51,27-51,75)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_2cd3632f06038c7f0bd444d4f517d527 @x1)
@x0)
(MRefST.witness Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x1
(Tm_abs_c66f7e87d18c04430a63c341491495ae @x1)))
 

:pattern ((ApplyTT (Tm_abs_2cd3632f06038c7f0bd444d4f517d527 @x1)
@x0))
:qid interpretation_Tm_abs_2cd3632f06038c7f0bd444d4f517d527))

:named interpretation_Tm_abs_2cd3632f06038c7f0bd444d4f517d527))
...
;     (forall (x: Prims.unit) (s1: MRefHeap.heap). Prims.auto_squash (p (x, s1))) ==>
;     (forall (x: MRefHeap.heap) (s1: MRefHeap.heap).
;         _ == x /\ x == s1 ==>
;         Prims.auto_squash (FStar.Preorder.preorder_rel (fun n m -> n <= m)) /\
;         Prims.auto_squash (FStar.Preorder.preorder_rel (fun n m -> n <= m)) /\
;         (forall (any_result: FStar.Preorder.preorder Prims.nat).
;             (fun n m -> n <= m) == any_result ==>
;             (forall (x: MRefST.mref Prims.nat (fun n m -> n <= m)) (s1: MRefHeap.heap).
;                 ~(MRefST.contains x s1) /\
;                 FStar.Pervasives.Native.fst (MRefHeap.alloc_ref s1 Prims.nat (fun n m -> n <= m) 0) ==
;                 x /\
;                 FStar.Pervasives.Native.snd (MRefHeap.alloc_ref s1 Prims.nat (fun n m -> n <= m) 0) ==
;                 s1 ==>
;                 Prims.auto_squash (FStar.Preorder.preorder_rel (fun n m -> n <= m)) /\
;                 (forall (any_result: FStar.Preorder.preorder Prims.nat).
;                     (fun n m -> n <= m) == any_result ==>
;                     (forall (h: MRefHeap.heap).
;                         (*  - Could not prove post-condition
; *)
;                         Prims.auto_squash (FStar.Preorder.preorder_rel (fun n m -> n <= m)) /\
;                         (MRefST.contains x h ==>
...
;                           (forall (any_result: FStar.Preorder.preorder Prims.nat).
;                               (fun n m -> n <= m) == any_result ==>
;                               MRefST.ist_witnessed (MRefST.contains x) ==> MRefHeap.contains h x))) /\
;                     (forall (any_result: FStar.Preorder.predicate MRefHeap.heap).
;                         (fun h -> MRefST.contains x h /\ MRefHeap.sel h x > 0) == any_result ==>
;                         (forall (any_result: Prims.logical).
;                             MRefST.stable_on_heap x
;                               (fun h -> MRefST.contains x h /\ MRefHeap.sel h x > 0) ==
;                             any_result ==>
...
;                                 (forall (any_result: FStar.Preorder.preorder Prims.nat).
;                                     (fun n m -> n <= m) == any_result ==>
;                                     (forall (x: Prims.nat) (s1: MRefHeap.heap).
;                                         s1 == s1 /\ MRefST.contains x s1 /\ MRefHeap.sel s1 x == x ==>
;                                         Prims.auto_squash (FStar.Preorder.preorder_rel (fun n m ->
;                                                   n <= m)) /\
;                                         (forall (any_result: FStar.Preorder.preorder Prims.nat).
;                                             (fun n m -> n <= m) == any_result ==>
;                                             x + 1 >= 0 /\
...
;                                                 return_val == x + 1 ==>
;                                                 MRefST.contains x s1 /\ MRefHeap.sel s1 x <= x + 1 /\
;                                                 (forall (x: Prims.unit) (s1: MRefHeap.heap).
;                                                     MRefST.contains x s1 /\
;                                                     MRefHeap.sel s1 x <= x + 1 /\
;                                                     MRefST.contains x s1 /\
;                                                     (s1 == MRefHeap.upd s1 x (x + 1)) ==>
;                                                     (forall (x: MRefHeap.heap) (s1: MRefHeap.heap).
;                                                         s1 == x /\ x == s1 ==>
;                                                         (forall (x: Prims.unit).
...
;                                                                 (*  - Could not prove post-condition
; *)
;                                                                 Prims.auto_squash (FStar.Preorder.preorder_rel
;                                                                       (fun n m -> n <= m)) /\
;                                                                 (MRefST.contains x h0 ==>
;                                                                   Prims.auto_squash (FStar.Preorder.preorder_rel
;                                                                         (fun n m -> n <= m)) /\
;                                                                   (forall (any_result:
...
;                                                                       (fun n m -> n <= m) ==
;                                                                       any_result ==>
;                                                                       MRefST.ist_witnessed (MRefST.contains
;                                                                             x) ==>
;                                                                       MRefHeap.contains h0 x))) /\
...
;                                                                                   x) ==>
;                                                                             MRefHeap.contains h x))) /\
;                                                                   Prims.auto_squash (MRefST.stable_on_heap
;                                                                         x
;                                                                         (fun h ->
;                                                                             MRefST.contains x h /\
;                                                                             MRefHeap.sel h x > 0)) /\
...
;                                                                               xh1) ==>
;                                                                         h0 ==
;                                                                         FStar.Pervasives.Native.snd xh1
;                                                                          ==>
;                                                                         (forall (h: MRefHeap.heap).
;                                                                             (*  - Could not prove post-condition
; *)
...
; While typechecking the top-level declaration `let test_reify_recall`
...
;; def=dummy(0,0-0,0); use=ReifyTest.fst(38,25-69,4)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
MRefHeap.heap)
(HasType @x2
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(38,25-69,4)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
Prims.unit)
(HasType @x4
...
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(38,25-69,4)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(38,25-69,4)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(39,11-39,18)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
MRefHeap.heap)
(HasType @x4
...
;; def=MRefST.fst(116,68-116,75); use=ReifyTest.fst(39,11-39,18)
(= @x1
@x3)


;; def=MRefST.fst(116,79-116,86); use=ReifyTest.fst(39,11-39,18)
(= @x3
@x4)
)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(40,10-40,15)
(or label_1
...
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(40,33-40,45)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(38,25-69,4)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Preorder.preorder Prims.nat))

;; def=MRefST.fst(162,12-162,13); use=ReifyTest.fst(38,25-69,4)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x5)
)

;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(40,10-40,15)
...
;; def=MRefST.fst(165,46-165,62); use=ReifyTest.fst(40,10-40,15)
(not 
;; def=MRefST.fst(165,47-165,62); use=ReifyTest.fst(40,10-40,15)
(Valid 
;; def=MRefST.fst(165,47-165,62); use=ReifyTest.fst(40,10-40,15)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=MRefST.fst(166,11-166,40); use=ReifyTest.fst(40,10-40,15)
(= (FStar.Pervasives.Native.fst (MRefHeap.mref Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb)
MRefHeap.heap
(MRefHeap.alloc_ref @x4
Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
(BoxInt 0)))
@x6)
...
;; def=MRefST.fst(167,11-167,41); use=ReifyTest.fst(40,10-40,15)
(= (FStar.Pervasives.Native.snd (MRefHeap.mref Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb)
MRefHeap.heap
(MRefHeap.alloc_ref @x4
Prims.nat
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(42,25-42,26)
(or label_3
...
;; def=MRefST.fst(213,31-213,32); use=ReifyTest.fst(38,25-69,4)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x8)
)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(42,37-42,64)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(42,46-42,47)
(or label_4
...
(implies 
;; def=ReifyTest.fst(42,37-42,49); use=ReifyTest.fst(42,37-42,49)
(Valid 
;; def=ReifyTest.fst(42,37-42,49); use=ReifyTest.fst(42,37-42,49)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(42,37-42,64)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(42,59-42,60)
(or label_5
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(42,37-42,64)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(42,37-42,64)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x10)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(42,59-42,60)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(42,59-42,60)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(42,59-42,60)
(or label_6

;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(42,59-42,60)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(42,59-42,60)
(MRefHeap.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x9
@x6)
)
...
;; def=MRefST.fst(213,59-213,60); use=ReifyTest.fst(38,25-69,4)
(= (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6)
@x9)
)
...
;; def=Prims.fst(642,13-642,14); use=ReifyTest.fst(38,25-69,4)
(= (MRefST.stable_on_heap Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x6
(Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6))
...
;; def=Prims.fst(441,36-441,97); use=ReifyTest.fst(42,2-42,8)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
Prims.unit)

;; def=ReifyTest.fst(42,9-42,66); use=ReifyTest.fst(42,2-42,8)
(Valid 
;; def=ReifyTest.fst(42,9-42,66); use=ReifyTest.fst(42,2-42,8)
(MRefST.stable_on_heap Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(44,15-44,16)
(or label_7
...
;; def=MRefST.fst(177,12-177,13); use=ReifyTest.fst(38,25-69,4)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x12)
)

;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(44,10-44,14)
...
;; def=MRefST.fst(180,36-180,44); use=ReifyTest.fst(44,10-44,14)
(= @x7
@x14)


;; def=MRefST.fst(181,22-181,35); use=ReifyTest.fst(44,10-44,14)
(Valid 
;; def=MRefST.fst(181,22-181,35); use=ReifyTest.fst(44,10-44,14)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=MRefST.fst(182,8-182,21); use=ReifyTest.fst(44,10-44,14)
(= (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x14
@x6)
@x13)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(45,16-45,17)
(or label_8
...
;; def=MRefST.fst(190,13-190,14); use=ReifyTest.fst(38,25-69,4)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x15)
)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=Prims.fst(680,18-680,24); use=ReifyTest.fst(45,18-45,25)
(or label_9
...
;; def=Prims.fst(356,2-356,58); use=ReifyTest.fst(38,25-69,4)
(forall ((@x16 Term))
 (! (implies (and (HasType @x16
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=ReifyTest.fst(38,25-69,4)
(= @x16
(Prims.op_Addition @x13
(BoxInt 1)))
)

;; def=MRefST.fst(112,29-112,91); use=ReifyTest.fst(45,10-45,15)
(and 
;; def=MRefST.fst(193,33-193,46); use=ReifyTest.fst(45,10-45,15)
(or label_10
...
;; def=ReifyTest.fst(40,33-40,45); use=ReifyTest.fst(45,10-45,15)
(or label_11
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(45,10-45,15)
...
;; def=MRefST.fst(195,40-195,53); use=ReifyTest.fst(45,10-45,15)
(Valid 
;; def=MRefST.fst(195,40-195,53); use=ReifyTest.fst(45,10-45,15)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=MRefST.fst(196,19-196,35); use=ReifyTest.fst(45,10-45,15)
(= @x18
(MRefHeap.upd Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x14
@x6
(Prims.op_Addition @x13
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(46,11-46,18)
...
;; def=MRefST.fst(116,68-116,75); use=ReifyTest.fst(46,11-46,18)
(= @x18
@x19)


;; def=MRefST.fst(116,79-116,86); use=ReifyTest.fst(46,11-46,18)
(= @x19
@x20)
)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(46,24-69,4)
(forall ((@x21 Term))
 (! (implies (HasType @x21
Prims.unit)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(48,17-48,33)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(48,17-48,33)
(forall ((@x22 Term))
 (! (implies (HasType @x22
MRefHeap.heap)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(48,26-48,33)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(48,26-48,33)
(or label_12
...
(implies 
;; def=ReifyTest.fst(48,46-48,58); use=ReifyTest.fst(48,26-48,33)
(Valid 
;; def=ReifyTest.fst(48,46-48,58); use=ReifyTest.fst(48,26-48,33)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(48,26-48,33)
(forall ((@x23 Term))
 (! (implies (and (HasType @x23
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(48,26-48,33)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x23)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(48,26-48,33)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(48,26-48,33)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(48,68-48,69)
(or label_14

;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(48,26-48,33)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(48,26-48,33)
(MRefHeap.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(48,17-48,33)
(forall ((@x22 Term))
 (! (implies (and (HasType @x22
MRefST.st_pre)

;; def=MRefST.fst(153,16-153,19); use=ReifyTest.fst(48,17-48,33)
(= (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6)
@x22)
)
...
;; def=MRefST.fst(237,35-237,43); use=ReifyTest.fst(48,26-48,33)
(= @x23
@x25)
)

;; def=MRefST.fst(125,36-125,53); use=ReifyTest.fst(48,26-48,33)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(48,26-48,33)
(forall ((@x26 Term))
 (! (implies (HasType @x26
MRefHeap.heap)
...
;; def=dummy(0,0-0,0); use=ReifyTest.fst(48,26-48,74)
...
;; def=ReifyTest.fst(48,62-48,73); use=ReifyTest.fst(48,26-48,33)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x22
@x6))
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(48,26-48,74)
...
;; def=MRefST.fst(238,21-238,36); use=ReifyTest.fst(48,26-48,33)
(Valid 
;; def=MRefST.fst(238,21-238,36); use=ReifyTest.fst(48,26-48,33)
(MRefST.ist_witnessed (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6))
)
)

;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(48,26-48,74)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(48,26-48,74)
(ApplyTT @x23
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(48,26-48,74)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(48,34-48,35)
(or label_19
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(48,26-48,74)
(forall ((@x24 Term))
 (! (implies (and (HasType @x24
(FStar.Preorder.preorder Prims.nat))

;; def=MRefST.fst(233,15-233,16); use=ReifyTest.fst(48,26-48,74)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x24)
)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(48,46-48,73)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(48,55-48,56)
(or label_20
...
(implies 
;; def=ReifyTest.fst(48,46-48,58); use=ReifyTest.fst(48,46-48,58)
(Valid 
;; def=ReifyTest.fst(48,46-48,58); use=ReifyTest.fst(48,46-48,58)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(48,46-48,73)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(48,68-48,69)
(or label_21
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(48,46-48,73)
(forall ((@x26 Term))
 (! (implies (and (HasType @x26
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(48,46-48,73)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x26)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(48,68-48,69)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(48,68-48,69)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefST.fst(235,24-235,42); use=ReifyTest.fst(48,46-48,73)
(or label_23
...
(Tm_refine_ef8aa84d4725bff65536849e87a726de @x6))

;; def=MRefST.fst(235,7-235,8); use=ReifyTest.fst(48,26-48,74)
(= (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6)
@x25)
)

;; def=MRefST.fst(112,29-112,91); use=ReifyTest.fst(48,26-48,33)
(and 
;; def=ReifyTest.fst(48,46-48,58); use=ReifyTest.fst(48,26-48,33)
(or label_24
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(48,26-48,33)
...
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(48,26-48,33)
(or label_26
...
(Non_total_Tm_arrow_d63fb4bb9865ce46a3aa4eda28db4a45 @x6))

;; def=ReifyTest.fst(48,6-48,74); use=ReifyTest.fst(48,6-48,74)
(= (Tm_abs_05672b4664841765d3343ccdced4cd78 @x6)
@x21)
)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(48,77-69,4)
(forall ((@x22 Term))
 (! (implies (HasType @x22
MRefHeap.heap)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(49,10-49,16)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(49,10-49,16)
(or label_27
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(49,10-49,16)
(forall ((@x23 Term))
 (! (implies (and (HasType @x23
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(49,10-49,16)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x23)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(49,10-49,16)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(49,10-49,16)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(49,59-49,60)
(or label_29

;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(49,10-49,16)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(49,10-49,16)
(MRefHeap.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(439,23-439,26); use=ReifyTest.fst(49,10-49,16)
(= (Prims.l_and (MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x6
@x22)
...
;; def=dummy(0,0-0,0); use=ReifyTest.fst(49,10-49,16)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(49,10-49,16)
(forall ((@x24 Term))
 (! (implies (HasType @x24
...
(forall ((@x24 Term))
 (! (implies (and (HasType @x24
(Tm_refine_d68eb121664644607cbd234bb0124014 @x6
@x22))

;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(49,10-49,16)
(Valid 
;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(49,10-49,16)
(MRefST.heap_rel @x22
(FStar.Pervasives.Native.snd Prims.unit
...
;; def=ReifyTest.fst(49,83-49,91); use=ReifyTest.fst(49,10-49,16)
(= @x22
(FStar.Pervasives.Native.snd Prims.unit
MRefHeap.heap
@x24))
...
;; def=MRefST.fst(125,36-125,53); use=ReifyTest.fst(49,10-49,16)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(49,10-49,16)
(forall ((@x25 Term))
 (! (implies (HasType @x25
...
(implies 
;; def=ReifyTest.fst(49,119-49,131); use=ReifyTest.fst(49,10-49,16)
(Valid 
;; def=ReifyTest.fst(49,119-49,131); use=ReifyTest.fst(49,10-49,16)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(49,141-49,142)
(or label_35
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(49,35-49,64)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(49,44-49,45)
(or label_37
...
(implies 
;; def=ReifyTest.fst(49,35-49,48); use=ReifyTest.fst(49,35-49,48)
(Valid 
;; def=ReifyTest.fst(49,35-49,48); use=ReifyTest.fst(49,35-49,48)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(49,35-49,64)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(49,59-49,60)
(or label_38
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(49,35-49,64)
(forall ((@x23 Term))
 (! (implies (and (HasType @x23
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(49,35-49,64)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x23)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(49,59-49,60)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(49,59-49,60)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=ReifyTest.fst(26,13-49,64); use=ReifyTest.fst(38,25-69,4)
(= (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6)
@x22)
)
...
;; def=ReifyTest.fst(49,83-49,91); use=ReifyTest.fst(49,83-49,91)
(= @x23
@x25)
)

;; def=MRefST.fst(125,36-125,53); use=ReifyTest.fst(49,119-49,146)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(49,83-49,147)
(forall ((@x26 Term))
 (! (implies (HasType @x26
MRefHeap.heap)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(49,119-49,146)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(49,128-49,129)
(or label_40
...
(implies 
;; def=ReifyTest.fst(49,119-49,131); use=ReifyTest.fst(49,119-49,131)
(Valid 
;; def=ReifyTest.fst(49,119-49,131); use=ReifyTest.fst(49,119-49,131)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(49,119-49,146)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(49,141-49,142)
(or label_41
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(49,119-49,146)
(forall ((@x27 Term))
 (! (implies (and (HasType @x27
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(49,119-49,146)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x27)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(49,141-49,142)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(49,141-49,142)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=ReifyTest.fst(27,6-49,147); use=ReifyTest.fst(38,25-69,4)
(= (Tm_abs_230922f1ee3fe218902f537b21eddf03 @x6)
@x23)
)
...
(forall ((@x24 Term))
 (! (implies (and (HasType @x24
(Tm_arrow_d94672bde35300047ebb58a3cbc1d455 @x6))

;; def=ReifyTest.fst(49,6-49,150); use=ReifyTest.fst(49,6-49,150)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT ReifyTest.reify_@tok
Prims.unit)
(Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6))
(Tm_abs_230922f1ee3fe218902f537b21eddf03 @x6))
(Tm_abs_05672b4664841765d3343ccdced4cd78 @x6))
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(49,153-69,4)
(forall ((@x25 Term))
 (! (implies (HasType @x25
Prims.unit)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(51,18-51,34)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(51,18-51,34)
(forall ((@x26 Term))
 (! (implies (HasType @x26
MRefHeap.heap)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(51,27-51,34)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(51,27-51,34)
(or label_44
...
(implies 
;; def=ReifyTest.fst(51,47-51,59); use=ReifyTest.fst(51,27-51,34)
(Valid 
;; def=ReifyTest.fst(51,47-51,59); use=ReifyTest.fst(51,27-51,34)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(51,27-51,34)
(forall ((@x27 Term))
 (! (implies (and (HasType @x27
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(51,27-51,34)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x27)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(51,27-51,34)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(51,27-51,34)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(51,69-51,70)
(or label_46

;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(51,27-51,34)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(51,27-51,34)
(MRefHeap.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(51,18-51,34)
(forall ((@x26 Term))
 (! (implies (and (HasType @x26
MRefST.st_pre)

;; def=MRefST.fst(153,16-153,19); use=ReifyTest.fst(51,18-51,34)
(= (Tm_abs_c66f7e87d18c04430a63c341491495ae @x6)
@x26)
)

;; def=dummy(0,0-0,0); use=ReifyTest.fst(51,18-51,34)
(forall ((@x27 Term) (@x28 Term) (@x29 Term))
 (! (implies (and (HasType @x27
MRefHeap.heap)
(HasType @x28
Prims.unit)
...
;; def=MRefST.fst(237,35-237,43); use=ReifyTest.fst(51,27-51,34)
(= @x27
@x29)
)

;; def=MRefST.fst(125,36-125,53); use=ReifyTest.fst(51,27-51,34)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(51,27-51,34)
(forall ((@x30 Term))
 (! (implies (HasType @x30
MRefHeap.heap)
...
;; def=dummy(0,0-0,0); use=ReifyTest.fst(51,27-51,75)
(forall ((@x26 Term) (@x27 Term))
 (! (implies (and (HasType @x26
MRefHeap.heap)
(HasType @x27
...
;; def=ReifyTest.fst(51,63-51,74); use=ReifyTest.fst(51,27-51,34)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x26
@x6))
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(51,27-51,75)
...
;; def=MRefST.fst(238,21-238,36); use=ReifyTest.fst(51,27-51,34)
(Valid 
;; def=MRefST.fst(238,21-238,36); use=ReifyTest.fst(51,27-51,34)
(MRefST.ist_witnessed (Tm_abs_c66f7e87d18c04430a63c341491495ae @x6))
)
)

;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(51,27-51,75)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(51,27-51,75)
(ApplyTT @x27
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(51,27-51,75)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(51,35-51,36)
(or label_51
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(51,27-51,75)
(forall ((@x28 Term))
 (! (implies (and (HasType @x28
(FStar.Preorder.preorder Prims.nat))

;; def=MRefST.fst(233,15-233,16); use=ReifyTest.fst(51,27-51,75)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x28)
)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(51,47-51,74)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(51,56-51,57)
(or label_52
...
(implies 
;; def=ReifyTest.fst(51,47-51,59); use=ReifyTest.fst(51,47-51,59)
(Valid 
;; def=ReifyTest.fst(51,47-51,59); use=ReifyTest.fst(51,47-51,59)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(51,47-51,74)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(51,69-51,70)
(or label_53
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(51,47-51,74)
(forall ((@x30 Term))
 (! (implies (and (HasType @x30
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(51,47-51,74)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x30)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(51,69-51,70)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(51,69-51,70)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefST.fst(235,24-235,42); use=ReifyTest.fst(51,47-51,74)
(or label_55
...
;; def=MRefST.fst(235,7-235,8); use=ReifyTest.fst(51,27-51,75)
(= (Tm_abs_c66f7e87d18c04430a63c341491495ae @x6)
@x29)
)

;; def=MRefST.fst(112,29-112,91); use=ReifyTest.fst(51,27-51,34)
(and 
;; def=ReifyTest.fst(51,47-51,59); use=ReifyTest.fst(51,27-51,34)
(or label_56
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(51,27-51,34)
...
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(51,27-51,34)
(or label_58
...
(forall ((@x25 Term))
 (! (implies (and (HasType @x25
(Non_total_Tm_arrow_29799c310242d2055a2ac1e06c1efb69 @x6))

;; def=ReifyTest.fst(51,6-51,75); use=ReifyTest.fst(51,6-51,75)
(= (Tm_abs_2cd3632f06038c7f0bd444d4f517d527 @x6)
@x25)
)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(51,78-69,4)
(forall ((@x26 Term))
 (! (implies (HasType @x26
MRefHeap.heap)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(52,11-52,17)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(52,11-52,17)
(or label_59
...
(implies 
;; def=ReifyTest.fst(52,36-52,49); use=ReifyTest.fst(52,11-52,17)
(Valid 
;; def=ReifyTest.fst(52,36-52,49); use=ReifyTest.fst(52,11-52,17)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(52,11-52,17)
(forall ((@x27 Term))
 (! (implies (and (HasType @x27
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(52,11-52,17)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x27)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(52,11-52,17)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(52,11-52,17)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(52,60-52,61)
(or label_61

;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(52,11-52,17)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(52,11-52,17)
(MRefHeap.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(439,23-439,26); use=ReifyTest.fst(52,11-52,17)
(= (Prims.l_and (MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x6
@x26)
...
;; def=dummy(0,0-0,0); use=ReifyTest.fst(52,11-52,17)
(forall ((@x28 Term))
 (! (implies (HasType @x28
(FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(52,36-52,65)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(52,45-52,46)
(or label_65
...
(implies 
;; def=ReifyTest.fst(52,36-52,49); use=ReifyTest.fst(52,36-52,49)
(Valid 
;; def=ReifyTest.fst(52,36-52,49); use=ReifyTest.fst(52,36-52,49)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(52,36-52,65)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(52,60-52,61)
(or label_66
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(52,36-52,65)
(forall ((@x27 Term))
 (! (implies (and (HasType @x27
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(52,36-52,65)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x27)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(52,60-52,61)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(52,60-52,61)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=ReifyTest.fst(26,13-52,65); use=ReifyTest.fst(38,25-69,4)
(= (Tm_abs_c66f7e87d18c04430a63c341491495ae @x6)
@x26)
)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(52,88-52,90)
(forall ((@x27 Term) (@x28 Term) (@x29 Term))
 (! (implies (and (HasType @x27
Prims.unit)
(HasType @x28
...
;; def=ReifyTest.fst(52,36-52,49); use=ReifyTest.fst(52,88-52,90)
(Valid 
;; def=ReifyTest.fst(52,36-52,49); use=ReifyTest.fst(52,88-52,90)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=ReifyTest.fst(52,53-52,65); use=ReifyTest.fst(52,88-52,90)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x28
@x6))
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(52,88-52,90)
(forall ((@x30 Term) (@x31 Term))
 (! (implies (and (HasType @x30
Prims.unit)
(HasType @x31
...
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(52,88-52,90)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(52,88-52,90)
(ApplyTT @x29
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=MRefST.fst(112,29-112,91); use=ReifyTest.fst(52,88-52,90)
(and 
;; def=ReifyTest.fst(51,47-51,59); use=ReifyTest.fst(52,88-52,90)
(or label_68
...
;; def=ReifyTest.fst(51,63-51,74); use=ReifyTest.fst(52,88-52,90)
(or label_69
...
;; def=MRefST.fst(237,35-237,43); use=ReifyTest.fst(52,88-52,90)
(= @x28
@x31)


;; def=MRefST.fst(238,21-238,36); use=ReifyTest.fst(52,88-52,90)
(Valid 
;; def=MRefST.fst(238,21-238,36); use=ReifyTest.fst(52,88-52,90)
(MRefST.ist_witnessed (Tm_abs_c66f7e87d18c04430a63c341491495ae @x6))
)
...
;; def=ReifyTest.fst(28,12-51,8); use=ReifyTest.fst(38,25-69,4)
(= (Tm_abs_2cd3632f06038c7f0bd444d4f517d527 @x6)
@x27)
)
...
(forall ((@x28 Term))
 (! (implies (and (HasType @x28
(Tm_arrow_e92d12868a3e66a7f4ad95c90a250a3a @x6))

;; def=ReifyTest.fst(52,6-52,90); use=ReifyTest.fst(52,6-52,90)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT ReifyTest.reify_@tok
Prims.unit)
(Tm_abs_c66f7e87d18c04430a63c341491495ae @x6))
Tm_abs_6f53370f93d2a4384de4b9ba6c714e73)
(Tm_abs_2cd3632f06038c7f0bd444d4f517d527 @x6))
@x28)
)

;; def=Prims.fst(441,29-441,97); use=ReifyTest.fst(54,10-54,11)
(and 
;; def=ReifyTest.fst(49,35-49,48); use=ReifyTest.fst(54,10-54,11)
(or label_71
...
;; def=ReifyTest.fst(49,52-49,64); use=ReifyTest.fst(54,10-54,11)
(or label_72
...
;; def=Prims.fst(441,36-441,97); use=ReifyTest.fst(54,10-54,11)
(forall ((@x29 Term))
 (! (implies (and (HasType @x29
(FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))

;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(54,10-54,11)
(Valid 
;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(54,10-54,11)
(MRefST.heap_rel @x19
(FStar.Pervasives.Native.snd Prims.unit
...
;; def=ReifyTest.fst(49,83-49,91); use=ReifyTest.fst(54,10-54,11)
(= @x19
(FStar.Pervasives.Native.snd Prims.unit
MRefHeap.heap
@x29))
...
;; def=ReifyTest.fst(49,95-49,147); use=ReifyTest.fst(54,10-54,11)
(Valid 
;; def=ReifyTest.fst(49,95-49,147); use=ReifyTest.fst(54,10-54,11)
(MRefST.ist_witnessed (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6))
)
...
;; def=ReifyTest.fst(54,6-54,14); use=ReifyTest.fst(54,6-54,14)
(= (ReifyTest.reify_ Prims.unit
(Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6)
(Tm_abs_230922f1ee3fe218902f537b21eddf03 @x6)
(Tm_abs_05672b4664841765d3343ccdced4cd78 @x6)
@x19)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(54,17-69,4)
(forall ((@x30 Term))
 (! (implies (HasType @x30
Prims.unit)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(58,17-58,32)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(58,17-58,32)
(forall ((@x31 Term))
 (! (implies (HasType @x31
MRefHeap.heap)

;; def=MRefST.fst(125,36-125,53); use=ReifyTest.fst(58,26-58,32)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(58,26-58,32)
(forall ((@x32 Term))
 (! (implies (HasType @x32
MRefHeap.heap)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(58,26-58,32)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(58,26-58,32)
(or label_73
...
(implies 
;; def=ReifyTest.fst(58,45-58,57); use=ReifyTest.fst(58,26-58,32)
(Valid 
;; def=ReifyTest.fst(58,45-58,57); use=ReifyTest.fst(58,26-58,32)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(58,26-58,32)
(forall ((@x33 Term))
 (! (implies (and (HasType @x33
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(58,26-58,32)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x33)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(58,26-58,32)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(58,26-58,32)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(58,67-58,68)
(or label_75

;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(58,26-58,32)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(58,26-58,32)
(MRefHeap.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(58,17-58,32)
(forall ((@x31 Term))
 (! (implies (and (HasType @x31
MRefST.st_pre)

;; def=MRefST.fst(153,16-247,49); use=ReifyTest.fst(58,17-58,32)
(= (Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0 @x6)
@x31)
)

;; def=dummy(0,0-0,0); use=ReifyTest.fst(58,17-58,32)
(forall ((@x32 Term) (@x33 Term) (@x34 Term))
...
;; def=MRefST.fst(248,34-248,42); use=ReifyTest.fst(58,26-58,32)
(= @x32
@x34)
)
...
;; def=dummy(0,0-0,0); use=ReifyTest.fst(58,26-58,73)
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(58,26-58,73)
...
;; def=ReifyTest.fst(58,61-58,72); use=ReifyTest.fst(58,26-58,32)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x34
@x6))
...
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(58,26-58,73)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(58,26-58,73)
(ApplyTT @x32
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(58,26-58,73)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(58,33-58,34)
(or label_80
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(58,26-58,73)
(forall ((@x33 Term))
 (! (implies (and (HasType @x33
(FStar.Preorder.preorder Prims.nat))

;; def=MRefST.fst(244,14-244,15); use=ReifyTest.fst(58,26-58,73)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x33)
)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(58,45-58,72)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(58,54-58,55)
(or label_81
...
(implies 
;; def=ReifyTest.fst(58,45-58,57); use=ReifyTest.fst(58,45-58,57)
(Valid 
;; def=ReifyTest.fst(58,45-58,57); use=ReifyTest.fst(58,45-58,57)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(58,45-58,72)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(58,67-58,68)
(or label_82
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(58,45-58,72)
(forall ((@x35 Term))
 (! (implies (and (HasType @x35
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(58,45-58,72)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x35)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(58,67-58,68)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(58,67-58,68)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefST.fst(246,23-246,41); use=ReifyTest.fst(58,45-58,72)
(or label_84
...
;; def=MRefST.fst(246,6-246,7); use=ReifyTest.fst(58,26-58,73)
(= (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6)
@x34)
)

;; def=MRefST.fst(112,29-112,91); use=ReifyTest.fst(58,26-58,32)
(and 
;; def=MRefST.fst(247,34-247,49); use=ReifyTest.fst(58,26-58,32)
(or label_85
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(58,26-58,32)
...
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(58,26-58,32)
(or label_86
...
(forall ((@x30 Term))
 (! (implies (and (HasType @x30
(Non_total_Tm_arrow_27795e1622491572bb5e0c01e61d2138 @x6))

;; def=ReifyTest.fst(58,6-58,73); use=ReifyTest.fst(58,6-58,73)
(= (Tm_abs_5a9700791ea89db7b273ab12f39fd270 @x6)
@x30)
)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(58,76-69,4)
(forall ((@x31 Term))
 (! (implies (HasType @x31
MRefHeap.heap)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(59,10-59,16)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(59,10-59,16)
(forall ((@x32 Term))
 (! (implies (HasType @x32
MRefHeap.heap)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(59,10-59,16)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(59,10-59,16)
(or label_87
...
(implies 
;; def=ReifyTest.fst(59,59-59,71); use=ReifyTest.fst(59,10-59,16)
(Valid 
;; def=ReifyTest.fst(59,59-59,71); use=ReifyTest.fst(59,10-59,16)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(59,10-59,16)
(forall ((@x33 Term))
 (! (implies (and (HasType @x33
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(59,10-59,16)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x33)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(59,10-59,16)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(59,10-59,16)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(59,81-59,82)
(or label_89

;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(59,10-59,16)
(Valid 
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(59,10-59,16)
(MRefHeap.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=MRefST.fst(125,36-125,53); use=ReifyTest.fst(59,10-59,16)
(or label_90
...
;; def=MRefST.fst(125,19-125,20); use=ReifyTest.fst(59,10-59,16)
(= (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6)
@x32)
)
...
;; def=Prims.fst(439,23-439,26); use=ReifyTest.fst(59,10-59,16)
(= (MRefST.ist_witnessed (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6))
@x33)
)
...
(forall ((@x34 Term))
 (! (implies (and (HasType @x34
(Tm_refine_85bd48a266b4b4b849a096b42f2ffa97 @x6))

;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(59,10-59,16)
(Valid 
;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(59,10-59,16)
(MRefST.heap_rel @x31
(FStar.Pervasives.Native.snd Prims.unit
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(59,10-59,16)
(and (implies 
;; def=ReifyTest.fst(59,106-59,114); use=ReifyTest.fst(59,10-59,16)
(= @x31
(FStar.Pervasives.Native.snd Prims.unit
MRefHeap.heap
@x34))
...
(implies 
;; def=ReifyTest.fst(59,106-59,131); use=ReifyTest.fst(59,10-59,16)
(and 
;; def=ReifyTest.fst(59,106-59,114); use=ReifyTest.fst(59,10-59,16)
(= @x31
(FStar.Pervasives.Native.snd Prims.unit
...
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(59,10-59,16)
(Valid 
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(59,10-59,16)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(59,142-59,143)
(or label_97
...
;; def=MRefST.fst(125,36-125,53); use=ReifyTest.fst(59,59-59,86)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(59,35-59,87)
(forall ((@x32 Term))
 (! (implies (HasType @x32
MRefHeap.heap)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(59,59-59,86)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(59,68-59,69)
(or label_98
...
(implies 
;; def=ReifyTest.fst(59,59-59,71); use=ReifyTest.fst(59,59-59,71)
(Valid 
;; def=ReifyTest.fst(59,59-59,71); use=ReifyTest.fst(59,59-59,71)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(59,59-59,86)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(59,81-59,82)
(or label_99
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(59,59-59,86)
(forall ((@x33 Term))
 (! (implies (and (HasType @x33
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(59,59-59,86)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x33)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(59,81-59,82)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(59,81-59,82)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=ReifyTest.fst(26,13-59,87); use=ReifyTest.fst(38,25-69,4)
(= (Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0 @x6)
@x31)
)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(59,106-59,147)
(and (implies 
;; def=ReifyTest.fst(59,106-59,114); use=ReifyTest.fst(59,106-59,114)
(= @x32
@x34)


;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(59,127-59,128)
(or label_102
...
(implies 
;; def=ReifyTest.fst(59,106-59,131); use=ReifyTest.fst(59,106-59,131)
(and 
;; def=ReifyTest.fst(59,106-59,114); use=ReifyTest.fst(59,106-59,114)
(= @x32
@x34)
...
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(59,118-59,131)
(Valid 
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(59,118-59,131)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(59,106-59,147)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(59,142-59,143)
(or label_103
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(59,106-59,147)
(forall ((@x35 Term))
 (! (implies (and (HasType @x35
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(59,106-59,147)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x35)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(59,142-59,143)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(59,142-59,143)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=ReifyTest.fst(27,6-59,147); use=ReifyTest.fst(38,25-69,4)
(= (Tm_abs_b323ab8375c7c8424383dbcd3a486073 @x6)
@x32)
)

;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=dummy(0,0-0,0); use=ReifyTest.fst(59,149-59,150)
(forall ((@x33 Term) (@x34 Term) (@x35 Term))
 (! (implies (and (HasType @x33
Prims.unit)
(HasType @x34
MRefHeap.heap)
...
;; def=ReifyTest.fst(59,35-59,87); use=ReifyTest.fst(59,149-59,150)
(Valid 
;; def=ReifyTest.fst(59,35-59,87); use=ReifyTest.fst(59,149-59,150)
(MRefST.ist_witnessed (Tm_abs_11b16c9203efa3f1f094acdf6d874065 @x6))
)
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(59,149-59,150)
...
;; def=ReifyTest.fst(59,106-59,114); use=ReifyTest.fst(59,149-59,150)
(= @x34
@x37)


;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(59,149-59,150)
(Valid 
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(59,149-59,150)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=ReifyTest.fst(59,135-59,147); use=ReifyTest.fst(59,149-59,150)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x37
@x6))
...
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(59,149-59,150)
(Valid 
;; def=MRefST.fst(112,81-112,90); use=ReifyTest.fst(59,149-59,150)
(ApplyTT @x35
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=MRefST.fst(112,29-112,91); use=ReifyTest.fst(59,149-59,150)
(and 
;; def=MRefST.fst(247,34-247,49); use=ReifyTest.fst(59,149-59,150)
(or label_105
...
;; def=MRefST.fst(248,34-248,42); use=ReifyTest.fst(59,149-59,150)
(= @x34
@x37)


;; def=ReifyTest.fst(58,45-58,57); use=ReifyTest.fst(59,149-59,150)
(Valid 
;; def=ReifyTest.fst(58,45-58,57); use=ReifyTest.fst(59,149-59,150)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=ReifyTest.fst(58,61-58,72); use=ReifyTest.fst(59,149-59,150)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x37
@x6))
...
;; def=ReifyTest.fst(28,12-58,7); use=ReifyTest.fst(38,25-69,4)
(= (Tm_abs_5a9700791ea89db7b273ab12f39fd270 @x6)
@x33)
)
...
(forall ((@x34 Term))
 (! (implies (and (HasType @x34
(Tm_arrow_a4e28b2ac1d86ee4c1cea508318d3f23 @x6))

;; def=ReifyTest.fst(59,6-59,150); use=ReifyTest.fst(59,6-59,150)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT ReifyTest.reify_@tok
Prims.unit)
(Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0 @x6))
(Tm_abs_b323ab8375c7c8424383dbcd3a486073 @x6))
...
;; def=MRefST.fst(112,39-112,91); use=ReifyTest.fst(61,11-61,18)
(forall ((@x35 Term) (@x36 Term))
 (! (implies (and (HasType @x35
MRefHeap.heap)
(HasType @x36
...
;; def=MRefST.fst(116,68-116,75); use=ReifyTest.fst(61,11-61,18)
(= @x20
@x35)


;; def=MRefST.fst(116,79-116,86); use=ReifyTest.fst(61,11-61,18)
(= @x35
@x36)
)

;; def=Prims.fst(441,29-441,97); use=ReifyTest.fst(63,10-63,11)
(and 
;; def=ReifyTest.fst(59,35-59,87); use=ReifyTest.fst(63,10-63,11)
(or label_107
...
;; def=Prims.fst(441,36-441,97); use=ReifyTest.fst(63,10-63,11)
(forall ((@x37 Term))
 (! (implies (and (HasType @x37
(FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))

;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(63,10-63,11)
(Valid 
;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(63,10-63,11)
(MRefST.heap_rel @x35
(FStar.Pervasives.Native.snd Prims.unit
...
;; def=ReifyTest.fst(59,106-59,114); use=ReifyTest.fst(63,10-63,11)
(= @x35
(FStar.Pervasives.Native.snd Prims.unit
MRefHeap.heap
@x37))
...
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(63,10-63,11)
(Valid 
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(63,10-63,11)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=ReifyTest.fst(59,135-59,147); use=ReifyTest.fst(63,10-63,11)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
(FStar.Pervasives.Native.snd Prims.unit
MRefHeap.heap
...
;; def=ReifyTest.fst(63,6-63,14); use=ReifyTest.fst(63,6-63,14)
(= (ReifyTest.reify_ Prims.unit
(Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0 @x6)
(Tm_abs_b323ab8375c7c8424383dbcd3a486073 @x6)
(Tm_abs_5a9700791ea89db7b273ab12f39fd270 @x6)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(64,19-64,20)
(or label_108
...
(implies 
;; def=ReifyTest.fst(64,10-64,23); use=ReifyTest.fst(64,10-64,23)
(Valid 
;; def=ReifyTest.fst(64,10-64,23); use=ReifyTest.fst(64,10-64,23)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(64,9-64,40)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(64,34-64,35)
(or label_109
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(64,9-64,40)
(forall ((@x38 Term))
 (! (implies (and (HasType @x38
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(64,9-64,40)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x38)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(64,34-64,35)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(64,34-64,35)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(64,34-64,35)
(or label_110
...
;; def=Prims.fst(672,13-672,14); use=ReifyTest.fst(38,25-69,4)
(= (Prims.l_and (MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x6
@x35)
...
;; def=Prims.fst(441,29-441,97); use=ReifyTest.fst(64,2-64,8)
(and 
;; def=ReifyTest.fst(64,10-64,23); use=ReifyTest.fst(64,2-64,8)
(or label_111
...
;; def=ReifyTest.fst(64,27-64,39); use=ReifyTest.fst(64,2-64,8)
(or label_112
...
;; def=Prims.fst(441,36-441,97); use=ReifyTest.fst(64,2-64,8)
(forall ((@x39 Term))
...
;; def=Prims.fst(441,29-441,97); use=ReifyTest.fst(66,10-66,11)
(and 
;; def=ReifyTest.fst(59,35-59,87); use=ReifyTest.fst(66,10-66,11)
(or label_113
...
;; def=Prims.fst(441,36-441,97); use=ReifyTest.fst(66,10-66,11)
(forall ((@x40 Term))
 (! (implies (and (HasType @x40
(FStar.Pervasives.Native.tuple2 Prims.unit
MRefHeap.heap))

;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(66,10-66,11)
(Valid 
;; def=ReifyTest.fst(30,42-30,63); use=ReifyTest.fst(66,10-66,11)
(MRefST.heap_rel @x3
(FStar.Pervasives.Native.snd Prims.unit
...
;; def=ReifyTest.fst(59,106-59,114); use=ReifyTest.fst(66,10-66,11)
(= @x3
(FStar.Pervasives.Native.snd Prims.unit
MRefHeap.heap
@x40))
...
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(66,10-66,11)
(Valid 
;; def=ReifyTest.fst(59,118-59,131); use=ReifyTest.fst(66,10-66,11)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=ReifyTest.fst(59,135-59,147); use=ReifyTest.fst(66,10-66,11)
(> (BoxInt_proj_0 (MRefHeap.sel Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
(FStar.Pervasives.Native.snd Prims.unit
MRefHeap.heap
...
;; def=ReifyTest.fst(66,6-66,14); use=ReifyTest.fst(66,6-66,14)
(= (ReifyTest.reify_ Prims.unit
(Tm_abs_3c0e23ce96ef16220c4b598dbe0d5cb0 @x6)
(Tm_abs_b323ab8375c7c8424383dbcd3a486073 @x6)
(Tm_abs_5a9700791ea89db7b273ab12f39fd270 @x6)
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(38,25-69,4)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(67,19-67,20)
(or label_114
...
(implies 
;; def=ReifyTest.fst(67,10-67,23); use=ReifyTest.fst(67,10-67,23)
(Valid 
;; def=ReifyTest.fst(67,10-67,23); use=ReifyTest.fst(67,10-67,23)
(MRefST.contains Prims.nat
Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
...
;; def=Prims.fst(459,77-459,89); use=ReifyTest.fst(67,9-67,40)
(and 
;; def=FStar.Preorder.fst(33,40-33,56); use=ReifyTest.fst(67,34-67,35)
(or label_115
...
;; def=Prims.fst(451,66-451,102); use=ReifyTest.fst(67,9-67,40)
(forall ((@x41 Term))
 (! (implies (and (HasType @x41
(FStar.Preorder.preorder Prims.nat))

;; def=MRefHeap.fsti(50,11-50,12); use=ReifyTest.fst(67,9-67,40)
(= Tm_abs_577bb0504d99bec50af9e2beb88b9dcb
@x41)


;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(67,34-67,35)
(Valid 
;; def=MRefST.fst(140,47-140,73); use=ReifyTest.fst(67,34-67,35)
(MRefST.ist_witnessed (ApplyTT (ApplyTT (ApplyTT MRefST.contains@tok
Prims.nat)
...
;; def=MRefHeap.fsti(52,14-52,26); use=ReifyTest.fst(67,34-67,35)
(or label_116
...
;; def=Prims.fst(441,29-441,97); use=ReifyTest.fst(67,2-67,8)
(and 
;; def=ReifyTest.fst(67,10-67,23); use=ReifyTest.fst(67,2-67,8)
(or label_117
...
;; def=ReifyTest.fst(67,27-67,39); use=ReifyTest.fst(67,2-67,8)
(or label_118
...
;; def=Prims.fst(441,36-441,97); use=ReifyTest.fst(67,2-67,8)
(forall ((@x42 Term))
...
;; def=MRefST.fst(102,97-102,105); use=ReifyTest.fst(38,25-69,4)
(or label_119
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ReifyTest.test_reify_recall, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, b2t_def, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.stable, equation_FStar.Preorder.transitive, equation_MRefHeap.preorder_t, equation_MRefST.contains, equation_MRefST.heap_rel, equation_MRefST.mref, equation_MRefST.stable_on_heap, equation_MRefST.stable_on_heap_aux, equation_Prims.nat, interpretation_Tm_abs_577bb0504d99bec50af9e2beb88b9dcb, interpretation_Tm_abs_c66f7e87d18c04430a63c341491495ae, l_and-interp, lemma_MRefST.stable_on_heap_stable, primitive_Prims.op_Addition, primitive_Prims.op_GreaterThan, primitive_Prims.op_LessThanOrEqual, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_3568bcf9133bbe8512b3c2560361e2a6, refinement_interpretation_Tm_refine_36453e3eb6145226f640e16ed9612466, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_b1c28aa58737bfc2dbda63f66ce3b895, refinement_interpretation_Tm_refine_da9cbab0485332770e2f963089e2dda6, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_MRefST.heap_rel, typing_MRefHeap.upd
