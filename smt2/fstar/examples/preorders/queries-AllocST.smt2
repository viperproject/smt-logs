...
(declare-fun AllocST.contains (Term Term Term) Term)
;;;;;;;;;;;;;;;;r: NatHeap.ref a -> h: NatHeap.heap -> Type
(declare-fun Tm_arrow_30f305aa8433b51692403b0179566424 () Term)
(declare-fun AllocST.contains@tok () Term)

; </end encoding let contains>


; encoding sigelt val AllocST.contains_lemma


; <Skipped val AllocST.contains_lemma/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocST.contains; Namespace AllocST
(assert (! 
;; def=AllocST.fst(26,4-26,12); use=AllocST.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
NatHeap.heap))
(HasType (AllocST.contains @x0
@x1
@x2)
Tm_type))
 

:pattern ((AllocST.contains @x0
@x1
@x2))
:qid typing_AllocST.contains))

:named typing_AllocST.contains))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
@x1
@x2))
:qid equation_AllocST.contains))

:named equation_AllocST.contains))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at AllocST.fst(34,28-34,30)
...
;; def=AllocST.fst(31,23-31,37); use=AllocST.fst(34,28-34,30)
(Valid 
;; def=AllocST.fst(31,23-31,37); use=AllocST.fst(34,28-34,30)
(AllocST.contains @x0
@x2
...
;; def=Prims.fst(441,36-441,97); use=AllocST.fst(34,28-34,30)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=AllocST.fst(32,16-32,38); use=AllocST.fst(34,28-34,30)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=AllocST.fst(34,28-34,30)
(Valid 
;; def=Prims.fst(441,83-441,96); use=AllocST.fst(34,28-34,30)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocST.contains_lemma, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocST.contains
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocST.contains_lemma (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocST.contains_lemma@tok () Term)
...
(declare-fun AllocST.ist_pre (Term) Term)

(declare-fun AllocST.ist_pre@tok () Term)
...
(declare-fun AllocST.ist_post (Term Term) Term)

(declare-fun AllocST.ist_post@tok () Term)
...
(declare-fun AllocST.ist_wp (Term Term) Term)

(declare-fun AllocST.ist_wp@tok () Term)
;;;;;;;;;;;;;;;;_: ist_post state a -> ist_pre state
(declare-fun Tm_arrow_ddd63782c6fbc58e5f8130fac572c799 (Term Term) Term)
...
(declare-fun AllocST.lift_div_istate (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;state: Type ->     rel: FStar.Preorder.preorder state ->     a: Type ->     wp: Prims.pure_wp a ->     p: ist_post state a ->     s: state   -> Prims.pure_pre
(declare-fun Tm_arrow_b90a63bd3a1319bcaccf99726db1c963 () Term)
(declare-fun AllocST.lift_div_istate@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocST.heap_rel; Namespace AllocST
(assert (! 
;; def=AllocST.fst(39,4-39,12); use=AllocST.fst(39,4-39,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
NatHeap.heap))
(HasType (AllocST.heap_rel @x0
@x1)
Prims.logical))
 

:pattern ((AllocST.heap_rel @x0
@x1))
:qid typing_AllocST.heap_rel))

:named typing_AllocST.heap_rel))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name AllocST.heap_rel; Namespace AllocST
(assert (! 
;; def=AllocST.fst(39,4-39,12); use=AllocST.fst(39,4-39,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT AllocST.heap_rel@tok
@x0)
@x1)
(AllocST.heap_rel @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT AllocST.heap_rel@tok
@x0)
@x1))
:qid token_correspondence_AllocST.heap_rel))

:named token_correspondence_AllocST.heap_rel))
;;;;;;;;;;;;;;;;Lemma: AllocST.contains_lemma
;;; Fact-ids: Name AllocST.contains_lemma; Namespace AllocST
...
;; def=AllocST.fst(31,23-31,37); use=AllocST.fst(34,4-34,18)
(Valid 
;; def=AllocST.fst(31,23-31,37); use=AllocST.fst(34,4-34,18)
(AllocST.contains @x0
@x2
...
;; def=AllocST.fst(32,16-32,38); use=AllocST.fst(34,4-34,18)
(Valid 
;; def=AllocST.fst(32,16-32,38); use=AllocST.fst(34,4-34,18)
(NatHeap.contains @x0
@x1
...
@x2
@x1))
:qid lemma_AllocST.contains_lemma))
:named lemma_AllocST.contains_lemma))
...
:pattern ((AllocST.heap_rel @x1
@x2))
:qid function_token_typing_AllocST.heap_rel.1))
)
 

:pattern ((ApplyTT @x0
AllocST.heap_rel@tok))
:qid function_token_typing_AllocST.heap_rel))

:named function_token_typing_AllocST.heap_rel))
...
;;;;;;;;;;;;;;;;Equation for AllocST.heap_rel
;;; Fact-ids: Name AllocST.heap_rel; Namespace AllocST
(assert (! 
;; def=AllocST.fst(39,4-39,12); use=AllocST.fst(39,4-39,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (AllocST.heap_rel @x0
@x1))

;; def=AllocST.fst(40,2-40,54); use=AllocST.fst(40,2-40,54)
...
;; def=AllocST.fst(40,23-40,36); use=AllocST.fst(40,23-40,36)
(Valid 
;; def=AllocST.fst(40,23-40,36); use=AllocST.fst(40,23-40,36)
(AllocST.contains @x2
@x3
...
;; def=AllocST.fst(40,41-40,54); use=AllocST.fst(40,41-40,54)
(Valid 
;; def=AllocST.fst(40,41-40,54); use=AllocST.fst(40,41-40,54)
(AllocST.contains @x2
@x3
...
;;no pats
:qid equation_AllocST.heap_rel.1))
)
 

:pattern ((AllocST.heap_rel @x0
@x1))
:qid equation_AllocST.heap_rel))

:named equation_AllocST.heap_rel))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
;;; Fact-ids: Name AllocST.heap_rel; Namespace AllocST
(assert (! 
;; def=AllocST.fst(39,17-39,31); use=AllocST.fst(39,17-40,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a)
...
@x1
Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))
:qid AllocST_pre_typing_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))

:named AllocST_pre_typing_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))
...
@x1)
@x2))
:qid AllocST_interpretation_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid AllocST_interpretation_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))
:qid AllocST_interpretation_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))

:named AllocST_interpretation_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))
(push) ;; push{2
...
AllocST.heap_rel@tok))
:named @kick_partial_app_c63a2bfc4307f6ec4cebd7ccbc1c6203))

; Encoding query formula : Prims.auto_squash (FStar.Preorder.preorder_rel AllocST.heap_rel)
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Preorder.fst(33,40-33,56); use=AllocST.fst(71,48-71,56)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocST.0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocST.heap_rel, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, token_correspondence_AllocST.heap_rel
...
; encoding sigelt effect IST a pre post = AllocST.ISTATE a


; <Skipped effect IST a pre post = AllocST.ISTATE a/>
...
;;;;;;;;;;;;;;;;Prop-typing for AllocST.heap_rel
;;; Fact-ids: Name AllocST.heap_rel; Namespace AllocST
(assert (! 
;; def=AllocST.fst(39,4-39,12); use=AllocST.fst(39,4-39,12)
(forall ((@x0 Term) (@x1 Term))
...
(HasType @x1
NatHeap.heap))
(Valid (Prims.subtype_of (AllocST.heap_rel @x0
@x1)
Prims.unit)))
 

:pattern ((Prims.subtype_of (AllocST.heap_rel @x0
@x1)
Prims.unit))
:qid defn_equation_AllocST.heap_rel))

:named defn_equation_AllocST.heap_rel))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Prims.l_Forall; Namespace Prims
(assert (! 
;; def=Prims.fst(286,16-286,45); use=Prims.fst(286,30-286,45)
...
; Starting query at AllocST.fst(85,58-85,78)
...
AllocST.heap_rel@tok))
:named @kick_partial_app_c63a2bfc4307f6ec4cebd7ccbc1c6203))
(declare-fun Tm_refine_57099c5168d44822e266f088fad8d714 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_57099c5168d44822e266f088fad8d714
Tm_type)
:named refinement_kinding_Tm_refine_57099c5168d44822e266f088fad8d714))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=AllocST.fst(85,18-85,55); use=AllocST.fst(85,18-85,55)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_57099c5168d44822e266f088fad8d714)
(and (HasTypeFuel @u0
@x1
(FStar.Preorder.predicate NatHeap.heap))

;; def=AllocST.fst(85,36-85,53); use=AllocST.fst(85,36-85,53)
(Valid 
;; def=AllocST.fst(85,36-85,53); use=AllocST.fst(85,36-85,53)
...
@x1
Tm_refine_57099c5168d44822e266f088fad8d714))
:qid refinement_interpretation_Tm_refine_57099c5168d44822e266f088fad8d714))

:named refinement_interpretation_Tm_refine_57099c5168d44822e266f088fad8d714))
;;;;;;;;;;;;;;;;haseq for Tm_refine_57099c5168d44822e266f088fad8d714
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_57099c5168d44822e266f088fad8d714))
(Valid (Prims.hasEq (FStar.Preorder.predicate NatHeap.heap))))
:named haseqTm_refine_57099c5168d44822e266f088fad8d714))


; Encoding query formula : forall (p: FStar.Preorder.predicate NatHeap.heap {FStar.Preorder.stable p AllocST.heap_rel}).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash (FStar.Preorder.preorder_rel AllocST.heap_rel)
...
;; def=FStar.Preorder.fst(33,40-33,56); use=AllocST.fst(85,68-85,76)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocST.ist_witnessed, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocST.heap_rel, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, token_correspondence_AllocST.heap_rel
...
; Starting query at AllocST.fst(85,0-85,78)
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=AllocST.fst(85,58-85,78)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate NatHeap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=AllocST.fst(85,45-85,53)
(or label_1

;; def=FStar.Preorder.fst(35,53-35,69); use=AllocST.fst(85,58-85,78)
(Valid 
;; def=FStar.Preorder.fst(35,53-35,69); use=AllocST.fst(85,58-85,78)
(FStar.Preorder.preorder_rel NatHeap.heap
AllocST.heap_rel@tok)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocST.ist_witnessed, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocST.heap_rel, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, token_correspondence_AllocST.heap_rel
...
(declare-fun Tm_refine_57099c5168d44822e266f088fad8d714 () Term)
(declare-fun AllocST.ist_witnessed (Term) Term)


;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate NatHeap.heap {FStar.Preorder.stable p heap_rel} -> Type
(declare-fun Tm_arrow_e44c72b49da6409a31c0cd50e8893776 () Term)
(declare-fun AllocST.ist_witnessed@tok () Term)
...
; encoding sigelt val AllocST.ist_get


; <Start encoding val AllocST.ist_get>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocST.ist_get (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocST.ist_get@tok () Term)

; </end encoding val AllocST.ist_get>


; encoding sigelt val AllocST.ist_put


; <Start encoding val AllocST.ist_put>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocST.ist_put (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocST.ist_put@tok () Term)

; </end encoding val AllocST.ist_put>

;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name AllocST.ist_witnessed; Namespace AllocST
(assert (! (Valid (ApplyTT __uu__PartialApp
AllocST.heap_rel@tok))
:named @kick_partial_app_c63a2bfc4307f6ec4cebd7ccbc1c6203))
(push) ;; push{2

; Starting query at AllocST.fst(95,7-96,81)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val AllocST.ist_witness`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=AllocST.fst(95,25-96,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate NatHeap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=AllocST.fst(95,51-95,59)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocST.ist_witness, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocST.heap_rel, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, token_correspondence_AllocST.heap_rel
...
; encoding sigelt val AllocST.ist_witness


; <Start encoding val AllocST.ist_witness>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocST.ist_witness (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocST.ist_witness@tok () Term)

; </end encoding val AllocST.ist_witness>

(push) ;; push{2

; Starting query at AllocST.fst(98,7-99,80)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val AllocST.ist_recall`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=AllocST.fst(98,25-99,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate NatHeap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=AllocST.fst(98,51-98,59)
(or label_1
...
; encoding sigelt val AllocST.ist_recall


; <Start encoding val AllocST.ist_recall>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocST.ist_recall (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocST.ist_recall@tok () Term)

; </end encoding val AllocST.ist_recall>
...
;; def=AllocST.fst(26,4-26,12); use=AllocST.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT AllocST.contains@tok
@x0)
@x1)
@x2)
(AllocST.contains @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT AllocST.contains@tok
@x0)
@x1)
@x2))
:qid token_correspondence_AllocST.contains))

:named token_correspondence_AllocST.contains))
...
:pattern ((AllocST.contains @x1
@x2
@x3))
:qid function_token_typing_AllocST.contains.1))
)
 

:pattern ((ApplyTT @x0
AllocST.contains@tok))
:qid function_token_typing_AllocST.contains))

:named function_token_typing_AllocST.contains))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name AllocST.contains; Namespace AllocST
(assert (! 
;; def=AllocST.fst(26,17-26,40); use=AllocST.fst(26,17-26,60)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_30f305aa8433b51692403b0179566424)
...
@x1
Tm_arrow_30f305aa8433b51692403b0179566424))
:qid AllocST_pre_typing_Tm_arrow_30f305aa8433b51692403b0179566424))

:named AllocST_pre_typing_Tm_arrow_30f305aa8433b51692403b0179566424))
...
@x2)
@x3))
:qid AllocST_interpretation_Tm_arrow_30f305aa8433b51692403b0179566424.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid AllocST_interpretation_Tm_arrow_30f305aa8433b51692403b0179566424.2))
...
@x1)
@x2))
:qid AllocST_interpretation_Tm_arrow_30f305aa8433b51692403b0179566424.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_30f305aa8433b51692403b0179566424))
:qid AllocST_interpretation_Tm_arrow_30f305aa8433b51692403b0179566424))

:named AllocST_interpretation_Tm_arrow_30f305aa8433b51692403b0179566424))
(push) ;; push{2

; Starting query at AllocST.fst(106,20-106,55)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
AllocST.contains@tok))
:named @kick_partial_app_e94fe9e6026abfbc36e1aafcd6fd0647))
...
; *)
;   Prims.auto_squash (FStar.Preorder.stable (AllocST.contains r) AllocST.heap_rel)
...
;; def=AllocST.fst(85,36-85,53); use=AllocST.fst(106,42-106,54)
(or label_1
...
;; def=AllocST.fst(85,36-85,53); use=AllocST.fst(106,42-106,54)
(FStar.Preorder.stable NatHeap.heap
(ApplyTT (ApplyTT AllocST.contains@tok
@x0)
@x1)
AllocST.heap_rel@tok)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocST.ref, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocST.heap_rel, equation_FStar.Preorder.stable, token_correspondence_AllocST.contains, token_correspondence_AllocST.heap_rel
...
(declare-fun AllocST.ref (Term) Term)

(declare-fun AllocST.ref@tok () Term)
(declare-fun Tm_refine_a8458d0cd2385c727af0fa1002df0eb2 (Term) Term)
...
(declare-fun AllocST.st_pre () Term)
;;;;;;;;;;;;;;;;_: NatHeap.heap -> Type
...
(declare-fun AllocST.st_post (Term) Term)

(declare-fun AllocST.st_post@tok () Term)
...
(declare-fun AllocST.st_wp (Term) Term)

(declare-fun AllocST.st_wp@tok () Term)
;;;;;;;;;;;;;;;;_: st_post a -> st_pre
(declare-fun Tm_arrow_8be75c23a361721f0d14753194df277b (Term) Term)

; </end encoding let st_wp>


; encoding sigelt effect AllocST a pre post = AllocST.IST a


; <Skipped effect AllocST a pre post = AllocST.IST a/>


; encoding sigelt val AllocST.alloc


; <Skipped val AllocST.alloc/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocST.ref; Namespace AllocST
(assert (! 
;; def=AllocST.fst(106,5-106,8); use=AllocST.fst(106,5-106,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (AllocST.ref @x0)
Tm_type))
 

:pattern ((AllocST.ref @x0))
:qid typing_AllocST.ref))

:named typing_AllocST.ref))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocST.ist_witnessed; Namespace AllocST
(assert (! 
;; def=AllocST.fst(85,4-85,17); use=AllocST.fst(85,4-85,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_57099c5168d44822e266f088fad8d714)
(HasType (AllocST.ist_witnessed @x0)
Tm_type))
 

:pattern ((AllocST.ist_witnessed @x0))
:qid typing_AllocST.ist_witnessed))

:named typing_AllocST.ist_witnessed))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;; Fact-ids: Name AllocST.ref; Namespace AllocST
(assert (! 
;; def=AllocST.fst(106,20-106,55); use=AllocST.fst(106,20-106,55)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_a8458d0cd2385c727af0fa1002df0eb2 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_a8458d0cd2385c727af0fa1002df0eb2 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_a8458d0cd2385c727af0fa1002df0eb2))

:named refinement_kinding_Tm_refine_a8458d0cd2385c727af0fa1002df0eb2))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name NatHeap.alloc_ref; Namespace NatHeap
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a8458d0cd2385c727af0fa1002df0eb2 @x2))
(and (HasTypeFuel @u0
@x1
(NatHeap.ref @x2))

;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(106,28-106,54)
(Valid 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(106,28-106,54)
(AllocST.ist_witnessed (ApplyTT (ApplyTT AllocST.contains@tok
@x2)
@x1))
)
))
...
@x1
(Tm_refine_a8458d0cd2385c727af0fa1002df0eb2 @x2)))
:qid refinement_interpretation_Tm_refine_a8458d0cd2385c727af0fa1002df0eb2))

:named refinement_interpretation_Tm_refine_a8458d0cd2385c727af0fa1002df0eb2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name NatHeap.alloc_ref; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(67,6-76,44); use=NatHeap.fsti(67,6-76,44)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_a8458d0cd2385c727af0fa1002df0eb2
;;; Fact-ids: Name AllocST.ref; Namespace AllocST
(assert (! 
;; def=AllocST.fst(106,20-106,55); use=AllocST.fst(106,20-106,55)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a8458d0cd2385c727af0fa1002df0eb2 @x0)))
(Valid (Prims.hasEq (NatHeap.ref @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a8458d0cd2385c727af0fa1002df0eb2 @x0))))
:qid haseqTm_refine_a8458d0cd2385c727af0fa1002df0eb2))

:named haseqTm_refine_a8458d0cd2385c727af0fa1002df0eb2))
...
;;;;;;;;;;;;;;;;Equation for AllocST.ref
;;; Fact-ids: Name AllocST.ref; Namespace AllocST
(assert (! 
;; def=AllocST.fst(106,5-106,8); use=AllocST.fst(106,5-106,8)
(forall ((@x0 Term))
 (! (= (AllocST.ref @x0)
(Tm_refine_a8458d0cd2385c727af0fa1002df0eb2 @x0))
 

:pattern ((AllocST.ref @x0))
:qid equation_AllocST.ref))

:named equation_AllocST.ref))
;;;;;;;;;;;;;;;;Equation for AllocST.ist_witnessed
;;; Fact-ids: Name AllocST.ist_witnessed; Namespace AllocST
(assert (! 
;; def=AllocST.fst(85,4-85,17); use=AllocST.fst(85,4-85,17)
(forall ((@x0 Term))
 (! (= (AllocST.ist_witnessed @x0)
...
:pattern ((AllocST.ist_witnessed @x0))
:qid equation_AllocST.ist_witnessed))

:named equation_AllocST.ist_witnessed))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,22-59,30); use=FStar.Pervasives.Native.fst(59,22-59,30)
...
; Starting query at AllocST.fst(133,16-138,9)
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h NatHeap.heap (AllocST.ref a)) (h: NatHeap.heap).
;     (forall (x: AllocST.ref a) (s1: NatHeap.heap).
;         ~(AllocST.contains x h) /\ FStar.Pervasives.Native.fst (NatHeap.alloc_ref h a x) == x /\
...
;             AllocST.heap_rel s1 (FStar.Pervasives.Native.snd (NatHeap.alloc_ref x a x)) /\
;             (forall (x: Prims.unit) (s1: NatHeap.heap).
;                 AllocST.heap_rel s1 (FStar.Pervasives.Native.snd (NatHeap.alloc_ref x a x)) /\
;                 s1 == FStar.Pervasives.Native.snd (NatHeap.alloc_ref x a x) ==>
;                 Prims.auto_squash (FStar.Preorder.stable (AllocST.contains (FStar.Pervasives.Native.fst
;                               (NatHeap.alloc_ref x a x)))
;                       AllocST.heap_rel) /\
;                 (forall (return_val:
;                     p:
;                     FStar.Preorder.predicate NatHeap.heap {FStar.Preorder.stable p AllocST.heap_rel})
;                   .
;                     return_val ==
;                     AllocST.contains (FStar.Pervasives.Native.fst (NatHeap.alloc_ref x a x)) ==>
;                     AllocST.contains (FStar.Pervasives.Native.fst (NatHeap.alloc_ref x a x)) s1 /\
;                     (forall (x: Prims.unit) (s1: NatHeap.heap).
;                         AllocST.contains (FStar.Pervasives.Native.fst (NatHeap.alloc_ref x a x)) s1 /\
;                         (s1 == s1) /\
;                         AllocST.ist_witnessed (AllocST.contains (FStar.Pervasives.Native.fst (NatHeap.alloc_ref
;                                       x
;                                       a
;                                       x))) ==>
;                         Prims.auto_squash (AllocST.ist_witnessed (AllocST.contains (FStar.Pervasives.Native.fst
;                                       (NatHeap.alloc_ref x a x)))) /\
;                         (forall (return_val: AllocST.ref a).
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(133,16-138,9)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (or label_1
(HasType @x4
(AllocST.ref @x0)))
...
;; def=AllocST.fst(130,44-130,60); use=AllocST.fst(133,16-138,9)
(or label_3

;; def=AllocST.fst(130,44-130,60); use=AllocST.fst(133,16-138,9)
(not 
;; def=AllocST.fst(130,45-130,60); use=AllocST.fst(133,16-138,9)
(Valid 
;; def=AllocST.fst(130,45-130,60); use=AllocST.fst(133,16-138,9)
(AllocST.contains @x0
@x4
...
;; def=AllocST.fst(131,9-131,36); use=AllocST.fst(133,16-138,9)
(or label_4
...
;; def=AllocST.fst(132,9-132,37); use=AllocST.fst(133,16-138,9)
(or label_5
...
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(133,16-138,9)
(Valid 
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(133,16-138,9)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(134,11-134,18)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
NatHeap.heap)
(HasType @x5
...
;; def=AllocST.fst(90,75-90,82); use=AllocST.fst(134,11-134,18)
(= @x3
@x4)


;; def=AllocST.fst(90,86-90,93); use=AllocST.fst(134,11-134,18)
(= @x4
@x5)
)

;; def=Prims.fst(459,77-459,89); use=AllocST.fst(133,16-138,9)
(and 
;; def=dummy(0,0-0,0); use=AllocST.fst(134,24-138,9)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(FStar.Pervasives.Native.tuple2 (NatHeap.ref @x0)
NatHeap.heap))

;; def=dummy(0,0-0,0); use=AllocST.fst(135,12-135,21)
(and (implies 
;; def=NatHeap.fsti(68,5-69,33); use=AllocST.fst(135,12-135,21)
(and 
;; def=NatHeap.fsti(68,5-68,29); use=AllocST.fst(135,12-135,21)
(not 
;; def=NatHeap.fsti(68,6-68,29); use=AllocST.fst(135,12-135,21)
(Valid 
;; def=NatHeap.fsti(68,6-68,29); use=AllocST.fst(135,12-135,21)
(NatHeap.contains @x0
@x4
...
;; def=NatHeap.fsti(69,5-69,33); use=AllocST.fst(135,12-135,21)
(Valid 
;; def=NatHeap.fsti(69,5-69,33); use=AllocST.fst(135,12-135,21)
(NatHeap.contains @x0
(FStar.Pervasives.Native.snd (NatHeap.ref @x0)
...
;; def=NatHeap.fsti(58,11-58,23); use=AllocST.fst(135,12-135,21)
(or label_6
...
(implies 
;; def=NatHeap.fsti(68,5-74,29); use=AllocST.fst(135,12-135,21)
(and 
;; def=NatHeap.fsti(68,5-68,29); use=AllocST.fst(135,12-135,21)
(not 
;; def=NatHeap.fsti(68,6-68,29); use=AllocST.fst(135,12-135,21)
...
;; def=NatHeap.fsti(70,12-70,40); use=AllocST.fst(135,12-135,21)
(= (NatHeap.sel @x0
(FStar.Pervasives.Native.snd (NatHeap.ref @x0)
NatHeap.heap
@x6)
...
;; def=NatHeap.fsti(71,5-74,29); use=AllocST.fst(135,12-135,21)
...
;; def=NatHeap.fsti(72,8-72,21); use=AllocST.fst(135,12-135,21)
(Valid 
;; def=NatHeap.fsti(72,8-72,21); use=AllocST.fst(135,12-135,21)
(NatHeap.contains @x7
@x4
...
;; def=NatHeap.fsti(74,8-74,28); use=AllocST.fst(135,12-135,21)
(Valid 
;; def=NatHeap.fsti(74,8-74,28); use=AllocST.fst(135,12-135,21)
(NatHeap.contains @x7
(FStar.Pervasives.Native.snd (NatHeap.ref @x0)
...
;; def=NatHeap.fsti(75,24-75,37); use=AllocST.fst(135,12-135,21)
(Valid 
;; def=NatHeap.fsti(75,24-75,37); use=AllocST.fst(135,12-135,21)
(NatHeap.contains @x7
@x4
...
;; def=Prims.fst(451,66-451,102); use=AllocST.fst(133,16-138,9)
(forall ((@x6 Term))
...
;; def=AllocST.fst(135,6-135,28); use=AllocST.fst(135,6-135,28)
...
;; def=AllocST.fst(80,29-80,88); use=AllocST.fst(136,2-136,9)
(and 
;; def=AllocST.fst(93,31-93,44); use=AllocST.fst(136,2-136,9)
(or label_8
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(136,2-136,9)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Prims.unit)
(HasType @x8
...
;; def=AllocST.fst(93,62-93,69); use=AllocST.fst(136,2-136,9)
(= @x8
(FStar.Pervasives.Native.snd (NatHeap.ref @x0)
NatHeap.heap
(NatHeap.alloc_ref @x4
...
;; def=Prims.fst(459,77-459,89); use=AllocST.fst(133,16-138,9)
(and 
;; def=AllocST.fst(95,42-95,59); use=AllocST.fst(137,14-137,34)
(or label_9
...
;; def=Prims.fst(356,2-356,58); use=AllocST.fst(133,16-138,9)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Tm_refine_57099c5168d44822e266f088fad8d714)

;; def=Prims.fst(356,26-356,41); use=AllocST.fst(133,16-138,9)
(= @x9
(ApplyTT (ApplyTT AllocST.contains@tok
@x0)
(FStar.Pervasives.Native.fst (NatHeap.ref @x0)
...
;; def=AllocST.fst(80,29-80,88); use=AllocST.fst(137,2-137,13)
(and 
;; def=AllocST.fst(96,31-96,35); use=AllocST.fst(137,2-137,13)
(or label_10
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(137,2-137,13)
...
;; def=AllocST.fst(96,53-96,61); use=AllocST.fst(137,2-137,13)
(= @x8
@x11)


;; def=AllocST.fst(96,65-96,80); use=AllocST.fst(137,2-137,13)
(Valid 
;; def=AllocST.fst(96,65-96,80); use=AllocST.fst(137,2-137,13)
(AllocST.ist_witnessed (ApplyTT (ApplyTT AllocST.contains@tok
@x0)
...
;; def=Prims.fst(459,77-459,89); use=AllocST.fst(133,16-138,9)
(and 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(138,2-138,9)
(or label_11
...
;; def=AllocST.fst(129,13-138,9); use=AllocST.fst(133,16-138,9)
(= @x12
(FStar.Pervasives.Native.fst (NatHeap.ref @x0)
NatHeap.heap
(NatHeap.alloc_ref @x4
...
;; def=FStar.Pervasives.fsti(463,24-463,34); use=AllocST.fst(133,16-138,9)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=AllocST.fst(133,16-138,9)
(ApplyTT (ApplyTT @x2
@x12)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocST.alloc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_AllocST.contains, equation_AllocST.heap_rel, equation_FStar.Preorder.stable, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, lemma_AllocST.contains_lemma, refinement_interpretation_Tm_refine_81559c2acf3805dd0108c30eedb8fa98, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96, token_correspondence_AllocST.contains, token_correspondence_AllocST.heap_rel, typing_FStar.Pervasives.Native.fst, typing_FStar.Pervasives.Native.snd, typing_NatHeap.heap, typing_NatHeap.ref
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocST.alloc (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocST.alloc@tok () Term)

; </end encoding let alloc>

(push) ;; push{2

; Starting query at AllocST.fst(141,0-146,23)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type0) (r: AllocST.ref a) (h0: NatHeap.heap) (x: a) (h1: NatHeap.heap).
;   (*  - Could not prove post-condition
; *)
;   h0 == h1 /\ AllocST.contains r h1 ==>
;   AllocST.ist_witnessed (AllocST.contains r) ==> NatHeap.contains h1 r


; Context: While encoding a query
; While typechecking the top-level declaration `val AllocST.read`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=AllocST.fst(141,0-146,23)
...
;; def=AllocST.fst(144,37-144,45); use=AllocST.fst(141,14-143,13)
(= @x2
@x4)


;; def=AllocST.fst(145,23-145,36); use=AllocST.fst(141,14-143,13)
(Valid 
;; def=AllocST.fst(145,23-145,36); use=AllocST.fst(141,14-143,13)
(AllocST.contains @x0
@x1
...
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(141,14-143,13)
(Valid 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(141,14-143,13)
(AllocST.ist_witnessed (ApplyTT (ApplyTT AllocST.contains@tok
@x0)
...
;; def=NatHeap.fsti(58,11-58,23); use=AllocST.fst(146,16-146,17)
(or label_1

;; def=NatHeap.fsti(58,11-58,23); use=AllocST.fst(141,14-143,13)
(Valid 
;; def=NatHeap.fsti(58,11-58,23); use=AllocST.fst(141,14-143,13)
(NatHeap.contains @x0
@x4
...
; encoding sigelt val AllocST.read


; <Skipped val AllocST.read/>

(push) ;; push{2

; Starting query at AllocST.fst(147,15-150,9)
...
; Encoding query formula : forall (a: Type) (r: AllocST.ref a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h NatHeap.heap a) (h: NatHeap.heap).
;     (forall (x: a) (s1: NatHeap.heap).
;         h == s1 /\ AllocST.contains r s1 /\ NatHeap.sel s1 r == x ==> p x s1) ==>
;     (forall (x: NatHeap.heap) (s1: NatHeap.heap).
;         h == x /\ x == s1 ==>
;         Prims.auto_squash (FStar.Preorder.stable (AllocST.contains r) AllocST.heap_rel) /\
;         (forall (return_val:
;             p: FStar.Preorder.predicate NatHeap.heap {FStar.Preorder.stable p AllocST.heap_rel}).
;             return_val == AllocST.contains r ==>
;             AllocST.ist_witnessed (AllocST.contains r) /\
;             (forall (x: Prims.unit) (s1: NatHeap.heap).
;                 AllocST.ist_witnessed (AllocST.contains r) /\ (s1 == s1) /\ AllocST.contains r s1 ==>
;                 (AllocST.ist_witnessed (AllocST.contains r) ==> NatHeap.contains x r) /\
;                 (forall (any_result: AllocST.ref a).
;                     r == any_result ==>
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(147,15-150,9)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (or label_1
(HasType @x4
@x0))
...
;; def=AllocST.fst(144,37-144,45); use=AllocST.fst(147,15-150,9)
(or label_3
...
;; def=AllocST.fst(145,23-145,36); use=AllocST.fst(147,15-150,9)
(or label_4
...
;; def=AllocST.fst(146,9-146,22); use=AllocST.fst(147,15-150,9)
(or label_5
...
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(147,15-150,9)
(Valid 
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(147,15-150,9)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(148,10-148,17)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
NatHeap.heap)
(HasType @x5
...
;; def=AllocST.fst(90,75-90,82); use=AllocST.fst(148,10-148,17)
(= @x3
@x4)


;; def=AllocST.fst(90,86-90,93); use=AllocST.fst(148,10-148,17)
(= @x4
@x5)
)

;; def=Prims.fst(459,77-459,89); use=AllocST.fst(147,15-150,9)
(and 
;; def=AllocST.fst(98,42-98,59); use=AllocST.fst(149,13-149,25)
(or label_6
...
;; def=Prims.fst(356,2-356,58); use=AllocST.fst(147,15-150,9)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Tm_refine_57099c5168d44822e266f088fad8d714)

;; def=Prims.fst(356,26-356,41); use=AllocST.fst(147,15-150,9)
(= @x6
(ApplyTT (ApplyTT AllocST.contains@tok
@x0)
@x1))
...
;; def=AllocST.fst(80,29-80,88); use=AllocST.fst(149,2-149,12)
(and 
;; def=AllocST.fst(99,30-99,45); use=AllocST.fst(149,2-149,12)
(or label_7
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(149,2-149,12)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Prims.unit)
(HasType @x8
...
;; def=AllocST.fst(99,63-99,71); use=AllocST.fst(149,2-149,12)
(= @x5
@x8)


;; def=AllocST.fst(99,75-99,79); use=AllocST.fst(149,2-149,12)
(Valid 
;; def=AllocST.fst(99,75-99,79); use=AllocST.fst(149,2-149,12)
(AllocST.contains @x0
@x1
...
;; def=Prims.fst(459,77-459,89); use=AllocST.fst(147,15-150,9)
(and (implies 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(150,8-150,9)
(Valid 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(150,8-150,9)
(AllocST.ist_witnessed (ApplyTT (ApplyTT AllocST.contains@tok
@x0)
...
;; def=NatHeap.fsti(58,11-58,23); use=AllocST.fst(150,8-150,9)
(or label_8
...
;; def=Prims.fst(451,66-451,102); use=AllocST.fst(147,15-150,9)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(AllocST.ref @x0))

;; def=NatHeap.fsti(58,3-58,4); use=AllocST.fst(147,15-150,9)
(= @x1
@x9)
)
...
;; def=AllocST.fst(147,10-150,9); use=AllocST.fst(147,15-150,9)
(= @x10
(NatHeap.sel @x0
@x4
@x1))
...
;; def=FStar.Pervasives.fsti(463,24-463,34); use=AllocST.fst(147,15-150,9)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=AllocST.fst(147,15-150,9)
(ApplyTT (ApplyTT @x2
@x10)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocST.read, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_AllocST.contains, equation_AllocST.heap_rel, equation_AllocST.ref, equation_FStar.Preorder.stable, refinement_interpretation_Tm_refine_a8458d0cd2385c727af0fa1002df0eb2, token_correspondence_AllocST.contains, token_correspondence_AllocST.heap_rel
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocST.read (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocST.read@tok () Term)

; </end encoding let read>

(push) ;; push{2

; Starting query at AllocST.fst(153,0-158,37)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type0) (r: AllocST.ref a) (x: a) (h0: NatHeap.heap) (_: Prims.unit) (h1: NatHeap.heap).
;   (*  - Could not prove post-condition
; *)
;   AllocST.contains r h0 ==> AllocST.ist_witnessed (AllocST.contains r) ==> NatHeap.contains h0 r


; Context: While encoding a query
; While typechecking the top-level declaration `val AllocST.write`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=AllocST.fst(153,0-158,37)
...
;; def=AllocST.fst(157,41-157,54); use=AllocST.fst(153,15-156,17)
(Valid 
;; def=AllocST.fst(157,41-157,54); use=AllocST.fst(153,15-156,17)
(AllocST.contains @x0
@x1
...
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(153,15-156,17)
(Valid 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(153,15-156,17)
(AllocST.ist_witnessed (ApplyTT (ApplyTT AllocST.contains@tok
@x0)
...
;; def=NatHeap.fsti(83,18-83,31); use=AllocST.fst(158,33-158,34)
(or label_1

;; def=NatHeap.fsti(83,18-83,31); use=AllocST.fst(153,15-156,17)
(Valid 
;; def=NatHeap.fsti(83,18-83,31); use=AllocST.fst(153,15-156,17)
(NatHeap.contains @x0
@x3
...
; encoding sigelt val AllocST.write


; <Skipped val AllocST.write/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NatHeap.upd; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(81,4-81,7); use=NatHeap.fsti(81,4-81,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x3
@x0))
(HasType (NatHeap.upd @x0
@x1
@x2
@x3)
(Tm_refine_4289597b21978a2daf74d6c05a34b053 @x0
@x2
@x3
@x1)))
 

:pattern ((NatHeap.upd @x0
@x1
@x2
@x3))
:qid typing_NatHeap.upd))

:named typing_NatHeap.upd))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name NatHeap.upd; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(85,14-93,30); use=NatHeap.fsti(85,14-93,30)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_4289597b21978a2daf74d6c05a34b053 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_4289597b21978a2daf74d6c05a34b053 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_4289597b21978a2daf74d6c05a34b053))

:named refinement_kinding_Tm_refine_4289597b21978a2daf74d6c05a34b053))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name NatHeap.upd; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(85,14-93,30); use=NatHeap.fsti(85,14-93,30)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4289597b21978a2daf74d6c05a34b053 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=NatHeap.fsti(85,23-85,36); use=NatHeap.fsti(85,23-85,36)
(Valid 
;; def=NatHeap.fsti(85,23-85,36); use=NatHeap.fsti(85,23-85,36)
(NatHeap.contains @x2
@x1
...
;; def=NatHeap.fsti(86,16-86,29); use=NatHeap.fsti(86,16-86,29)
(= (NatHeap.sel @x2
@x1
@x3)
@x4)
...
;; def=NatHeap.fsti(87,9-90,20); use=NatHeap.fsti(87,9-90,20)
...
;; def=NatHeap.fsti(88,5-88,19); use=NatHeap.fsti(88,5-88,19)
(Valid 
;; def=NatHeap.fsti(88,5-88,19); use=NatHeap.fsti(88,5-88,19)
(NatHeap.contains @x6
@x5
...
;; def=NatHeap.fsti(90,5-90,19); use=NatHeap.fsti(90,5-90,19)
(Valid 
;; def=NatHeap.fsti(90,5-90,19); use=NatHeap.fsti(90,5-90,19)
(NatHeap.contains @x6
@x1
...
:pattern ((NatHeap.contains @x6
@x5
@x7))
:qid refinement_interpretation_Tm_refine_4289597b21978a2daf74d6c05a34b053.1))


;; def=NatHeap.fsti(91,9-93,28); use=NatHeap.fsti(91,9-93,28)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
Tm_type)
(HasType @x7
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x6
@x5))

;; def=NatHeap.fsti(92,12-92,23); use=NatHeap.fsti(92,12-92,23)
(not 
;; def=NatHeap.fsti(92,13-92,23); use=NatHeap.fsti(92,13-92,23)
(Valid 
;; def=NatHeap.fsti(92,13-92,23); use=NatHeap.fsti(92,13-92,23)
(Prims.op_Equals_Equals_Equals (Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x2
@x5)
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x6
@x5)
@x3
...
;; def=NatHeap.fsti(93,5-93,27); use=NatHeap.fsti(93,5-93,27)
(= (NatHeap.sel @x6
@x5
@x7)
(NatHeap.sel @x6
...
:pattern ((NatHeap.sel @x6
@x5
@x7))
:qid refinement_interpretation_Tm_refine_4289597b21978a2daf74d6c05a34b053.2))
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_4289597b21978a2daf74d6c05a34b053))

:named refinement_interpretation_Tm_refine_4289597b21978a2daf74d6c05a34b053))
;;;;;;;;;;;;;;;;Lemma: NatHeap.upd_sel
;;; Fact-ids: Name NatHeap.upd_sel; Namespace NatHeap
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
Tm_type)
(HasType @x2
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x1
@x0)))

;; def=NatHeap.fsti(199,23-199,47); use=NatHeap.fsti(199,23-199,47)
(= (NatHeap.upd @x1
@x0
@x2
(NatHeap.sel @x1
...
:pattern ((NatHeap.upd @x1
@x0
@x2
(NatHeap.sel @x1
@x0
@x2)))
:qid lemma_NatHeap.upd_sel))
:named lemma_NatHeap.upd_sel))
;;;;;;;;;;;;;;;;Lemma: NatHeap.sel_upd2
;;; Fact-ids: Name NatHeap.sel_upd2; Namespace NatHeap
...
;; def=NatHeap.fsti(190,24-190,37); use=NatHeap.fsti(190,24-190,37)
(not 
;; def=NatHeap.fsti(190,26-190,36); use=NatHeap.fsti(190,26-190,36)
(Valid 
;; def=NatHeap.fsti(190,26-190,36); use=NatHeap.fsti(190,26-190,36)
(Prims.op_Equals_Equals_Equals (Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x1
@x0)
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x2
@x0)
@x3
...
;; def=NatHeap.fsti(191,24-191,56); use=NatHeap.fsti(191,24-191,56)
(= (NatHeap.sel @x2
(NatHeap.upd @x1
@x0
@x3
...
:pattern ((NatHeap.sel @x2
(NatHeap.upd @x1
@x0
@x3
@x4)
@x5))
:qid lemma_NatHeap.sel_upd2))
:named lemma_NatHeap.sel_upd2))
;;;;;;;;;;;;;;;;Lemma: NatHeap.sel_upd1
;;; Fact-ids: Name NatHeap.sel_upd1; Namespace NatHeap
...
;; def=NatHeap.fsti(180,24-180,48); use=NatHeap.fsti(180,24-180,48)
(= (NatHeap.sel @x1
(NatHeap.upd @x1
@x0
@x2
...
:pattern ((NatHeap.sel @x1
(NatHeap.upd @x1
@x0
@x2
@x3)
@x2))
:qid lemma_NatHeap.sel_upd1))
:named lemma_NatHeap.sel_upd1))
;;;;;;;;;;;;;;;;Lemma: NatHeap.contains_upd
;;; Fact-ids: Name NatHeap.contains_upd; Namespace NatHeap
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
...
;; def=NatHeap.fsti(161,21-161,36); use=NatHeap.fsti(161,21-161,36)
(Valid 
;; def=NatHeap.fsti(161,21-161,36); use=NatHeap.fsti(161,21-161,36)
(NatHeap.contains @x2
@x0
...
;; def=NatHeap.fsti(162,21-162,46); use=NatHeap.fsti(162,21-162,46)
(Valid 
;; def=NatHeap.fsti(162,21-162,46); use=NatHeap.fsti(162,21-162,46)
(NatHeap.contains @x2
(NatHeap.upd @x1
...
:pattern ((NatHeap.contains @x2
(NatHeap.upd @x1
@x0
@x3
@x4)
@x5))
:qid lemma_NatHeap.contains_upd))
:named lemma_NatHeap.contains_upd))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4289597b21978a2daf74d6c05a34b053
;;; Fact-ids: Name NatHeap.upd; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(85,14-93,30); use=NatHeap.fsti(85,14-93,30)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4289597b21978a2daf74d6c05a34b053 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq NatHeap.heap)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4289597b21978a2daf74d6c05a34b053 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_4289597b21978a2daf74d6c05a34b053))

:named haseqTm_refine_4289597b21978a2daf74d6c05a34b053))
...
; Starting query at AllocST.fst(159,18-163,12)
...
; Encoding query formula : forall (a: Type) (r: AllocST.ref a) (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h NatHeap.heap Prims.unit) (h: NatHeap.heap).
;     (forall (x: Prims.unit) (s1: NatHeap.heap).
;         AllocST.contains r h /\ s1 == NatHeap.upd h r x ==> p x s1) ==>
;     (forall (x: NatHeap.heap) (s1: NatHeap.heap).
;         h == x /\ x == s1 ==>
;         Prims.auto_squash (FStar.Preorder.stable (AllocST.contains r) AllocST.heap_rel) /\
;         (forall (return_val:
...
;             (forall (x: Prims.unit) (s1: NatHeap.heap).
;                 AllocST.ist_witnessed (AllocST.contains r) /\ (s1 == s1) /\ AllocST.contains r s1 ==>
;                 (forall (h1: NatHeap.heap).
;                     (NatHeap.contains h1 r ==>
;                       AllocST.ist_witnessed (AllocST.contains r) ==> NatHeap.contains h1 r) /\
;                     (NatHeap.contains h1 r /\ NatHeap.sel h1 r == x /\
;                       (forall (b: Type0) (r': NatHeap.ref b). {:pattern NatHeap.contains x r'}
;                           NatHeap.contains x r' ==> NatHeap.contains h1 r') ==>
;                       (forall (b: Type0).
;                           (*  - Could not prove post-condition
; *)
;                           forall (r': NatHeap.ref b {NatHeap.contains x r'}).
;                             (AllocST.ist_witnessed (AllocST.contains r) ==> NatHeap.contains x r) /\
;                             (~(r === r') ==> NatHeap.contains x r' ==> NatHeap.contains h1 r')))) /\
;                 (AllocST.ist_witnessed (AllocST.contains r) ==> NatHeap.contains x r) /\
;                 (forall (any_result: AllocST.ref a).
;                     r == any_result ==>
;                     (forall (any_result:
...
;                             (forall (b: Type0) (r': NatHeap.ref b {NatHeap.contains x r'}).
;                                 {:pattern NatHeap.sel x r'}
;                                 ~(r === r') ==> NatHeap.sel x r' == NatHeap.sel h1 r') }).
;                         NatHeap.upd x r x == any_result ==>
;                         AllocST.heap_rel s1 (NatHeap.upd x r x) /\
;                         (forall (x: Prims.unit) (s1: NatHeap.heap).
;                             AllocST.heap_rel s1 (NatHeap.upd x r x) /\ s1 == NatHeap.upd x r x ==>
;                             p x s1))))))
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(159,18-163,12)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))
...
;; def=AllocST.fst(157,41-157,54); use=AllocST.fst(159,18-163,12)
(or label_3
...
;; def=AllocST.fst(158,20-158,36); use=AllocST.fst(159,18-163,12)
(or label_4
...
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(159,18-163,12)
(Valid 
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(159,18-163,12)
(ApplyTT (ApplyTT @x3
@x5)
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(160,11-160,18)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
NatHeap.heap)
(HasType @x6
...
;; def=AllocST.fst(90,75-90,82); use=AllocST.fst(160,11-160,18)
(= @x4
@x5)


;; def=AllocST.fst(90,86-90,93); use=AllocST.fst(160,11-160,18)
(= @x5
@x6)
)

;; def=Prims.fst(459,77-459,89); use=AllocST.fst(159,18-163,12)
(and 
;; def=AllocST.fst(98,42-98,59); use=AllocST.fst(161,13-161,25)
(or label_5
...
;; def=Prims.fst(356,2-356,58); use=AllocST.fst(159,18-163,12)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Tm_refine_57099c5168d44822e266f088fad8d714)

;; def=Prims.fst(356,26-356,41); use=AllocST.fst(159,18-163,12)
(= @x7
(ApplyTT (ApplyTT AllocST.contains@tok
@x0)
@x1))
...
;; def=AllocST.fst(80,29-80,88); use=AllocST.fst(161,2-161,12)
(and 
;; def=AllocST.fst(99,30-99,45); use=AllocST.fst(161,2-161,12)
(or label_6
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(161,2-161,12)
...
;; def=AllocST.fst(99,63-99,71); use=AllocST.fst(161,2-161,12)
(= @x6
@x9)


;; def=AllocST.fst(99,75-99,79); use=AllocST.fst(161,2-161,12)
(Valid 
;; def=AllocST.fst(99,75-99,79); use=AllocST.fst(161,2-161,12)
(AllocST.contains @x0
@x1
...
;; def=Prims.fst(459,77-459,89); use=AllocST.fst(159,18-163,12)
(and 
;; def=dummy(0,0-0,0); use=AllocST.fst(161,26-163,12)
(forall ((@x10 Term))
 (! (implies (HasType @x10
NatHeap.heap)

;; def=dummy(0,0-0,0); use=AllocST.fst(162,11-162,14)
(and (implies (and 
;; def=NatHeap.fsti(85,23-85,36); use=AllocST.fst(162,11-162,14)
(Valid 
;; def=NatHeap.fsti(85,23-85,36); use=AllocST.fst(162,11-162,14)
(NatHeap.contains @x0
@x10
...
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(162,11-162,14)
(Valid 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(162,11-162,14)
(AllocST.ist_witnessed (ApplyTT (ApplyTT AllocST.contains@tok
@x0)
...
;; def=NatHeap.fsti(58,11-58,23); use=AllocST.fst(162,18-162,19)
(or label_7

;; def=NatHeap.fsti(58,11-58,23); use=AllocST.fst(162,11-162,14)
(Valid 
;; def=NatHeap.fsti(58,11-58,23); use=AllocST.fst(162,11-162,14)
(NatHeap.contains @x0
@x10
...
(implies 
;; def=NatHeap.fsti(85,23-90,20); use=AllocST.fst(162,11-162,14)
(and 
;; def=NatHeap.fsti(85,23-85,36); use=AllocST.fst(162,11-162,14)
(Valid 
;; def=NatHeap.fsti(85,23-85,36); use=AllocST.fst(162,11-162,14)
...
;; def=NatHeap.fsti(86,16-86,29); use=AllocST.fst(162,11-162,14)
(= (NatHeap.sel @x0
@x10
@x1)
@x2)
...
;; def=NatHeap.fsti(87,9-90,20); use=AllocST.fst(162,11-162,14)
...
;; def=NatHeap.fsti(88,5-88,19); use=AllocST.fst(162,11-162,14)
(Valid 
;; def=NatHeap.fsti(88,5-88,19); use=AllocST.fst(162,11-162,14)
(NatHeap.contains @x11
@x5
@x12)
)
)

;; def=NatHeap.fsti(90,5-90,19); use=AllocST.fst(162,11-162,14)
(Valid 
;; def=NatHeap.fsti(90,5-90,19); use=AllocST.fst(162,11-162,14)
(NatHeap.contains @x11
@x10
...
(forall ((@x12 Term))
 (! (implies (HasType @x12
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x11
@x5))

;; def=NatHeap.fsti(91,20-92,23); use=AllocST.fst(162,11-162,14)
(and (implies 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(162,11-162,14)
(Valid 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(162,11-162,14)
...
;; def=NatHeap.fsti(83,18-83,31); use=AllocST.fst(162,18-162,19)
(or label_8

;; def=NatHeap.fsti(83,18-83,31); use=AllocST.fst(162,11-162,14)
(Valid 
;; def=NatHeap.fsti(83,18-83,31); use=AllocST.fst(162,11-162,14)
(NatHeap.contains @x0
@x5
...
(implies (and 
;; def=NatHeap.fsti(92,12-92,23); use=AllocST.fst(162,11-162,14)
(not 
;; def=NatHeap.fsti(92,13-92,23); use=AllocST.fst(162,11-162,14)
(Valid 
;; def=NatHeap.fsti(92,13-92,23); use=AllocST.fst(162,11-162,14)
(Prims.op_Equals_Equals_Equals (Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x0
@x5)
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x11
@x5)
@x1
...
;; def=NatHeap.fsti(91,29-91,43); use=AllocST.fst(162,11-162,14)
(Valid 
;; def=NatHeap.fsti(91,29-91,43); use=AllocST.fst(162,11-162,14)
(NatHeap.contains @x11
@x5
...
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(93,25-93,27)
(or label_9
...
(implies 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(162,18-162,19)
(Valid 
;; def=AllocST.fst(106,28-106,54); use=AllocST.fst(162,18-162,19)
(AllocST.ist_witnessed (ApplyTT (ApplyTT AllocST.contains@tok
@x0)
...
;; def=Prims.fst(451,66-451,102); use=AllocST.fst(159,18-163,12)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(AllocST.ref @x0))

;; def=NatHeap.fsti(83,10-83,11); use=AllocST.fst(159,18-163,12)
(= @x1
@x10)
)
...
;; def=AllocST.fst(162,6-162,21); use=AllocST.fst(162,6-162,21)
(= (NatHeap.upd @x0
@x5
@x1
@x2)
...
;; def=AllocST.fst(80,29-80,88); use=AllocST.fst(163,2-163,9)
(and 
;; def=AllocST.fst(93,31-93,44); use=AllocST.fst(163,2-163,9)
(or label_11
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(163,2-163,9)
...
;; def=AllocST.fst(93,62-93,69); use=AllocST.fst(163,2-163,9)
(= @x13
(NatHeap.upd @x0
@x5
@x1
...
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(163,2-163,9)
(Valid 
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(163,2-163,9)
(ApplyTT (ApplyTT @x3
@x12)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocST.write, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_AllocST.contains, equation_AllocST.heap_rel, equation_AllocST.ref, equation_FStar.Preorder.stable, lemma_AllocST.contains_lemma, refinement_interpretation_Tm_refine_4289597b21978a2daf74d6c05a34b053, refinement_interpretation_Tm_refine_a8458d0cd2385c727af0fa1002df0eb2, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96, token_correspondence_AllocST.contains, token_correspondence_AllocST.heap_rel
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocST.write (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocST.write@tok () Term)

; </end encoding let write>


; encoding sigelt val AllocST.recall


; <Skipped val AllocST.recall/>

(push) ;; push{2

; Starting query at AllocST.fst(172,2-172,25)
...
; *)
;   forall (p: FStar.Pervasives.st_post_h NatHeap.heap Prims.unit) (h: NatHeap.heap).
;     (forall (x: Prims.unit) (s1: NatHeap.heap). h == s1 /\ AllocST.contains r s1 ==> p x s1) ==>
;     Prims.auto_squash (FStar.Preorder.stable (AllocST.contains r) AllocST.heap_rel) /\
;     (forall (return_val:
;         p: FStar.Preorder.predicate NatHeap.heap {FStar.Preorder.stable p AllocST.heap_rel}).
;         return_val == AllocST.contains r ==>
;         AllocST.ist_witnessed (AllocST.contains r) /\
;         (forall (x: Prims.unit) (s1: NatHeap.heap).
;             AllocST.ist_witnessed (AllocST.contains r) /\ (h == s1) /\ AllocST.contains r s1 ==>
;             p x s1))
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(172,2-172,25)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))
...
;; def=AllocST.fst(169,42-169,50); use=AllocST.fst(172,2-172,25)
(or label_3
...
;; def=AllocST.fst(170,21-170,34); use=AllocST.fst(172,2-172,25)
(or label_4
...
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(172,2-172,25)
(Valid 
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(172,2-172,25)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=Prims.fst(459,77-459,89); use=AllocST.fst(172,2-172,25)
(and 
;; def=AllocST.fst(98,42-98,59); use=AllocST.fst(172,13-172,25)
(or label_5
...
;; def=Prims.fst(356,2-356,58); use=AllocST.fst(172,2-172,25)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_refine_57099c5168d44822e266f088fad8d714)

;; def=Prims.fst(356,26-356,41); use=AllocST.fst(172,2-172,25)
(= @x4
(ApplyTT (ApplyTT AllocST.contains@tok
@x0)
@x1))
...
;; def=AllocST.fst(80,29-80,88); use=AllocST.fst(172,2-172,12)
(and 
;; def=AllocST.fst(99,30-99,45); use=AllocST.fst(172,2-172,12)
(or label_6
...
;; def=AllocST.fst(80,39-80,88); use=AllocST.fst(172,2-172,12)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.unit)
(HasType @x6
...
;; def=AllocST.fst(99,63-99,71); use=AllocST.fst(172,2-172,12)
(= @x3
@x6)


;; def=AllocST.fst(99,75-99,79); use=AllocST.fst(172,2-172,12)
(Valid 
;; def=AllocST.fst(99,75-99,79); use=AllocST.fst(172,2-172,12)
(AllocST.contains @x0
@x1
...
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(172,2-172,12)
(Valid 
;; def=AllocST.fst(80,81-80,87); use=AllocST.fst(172,2-172,12)
(ApplyTT (ApplyTT @x2
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocST.recall, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_AllocST.heap_rel, equation_AllocST.ref, equation_FStar.Preorder.stable, refinement_interpretation_Tm_refine_a8458d0cd2385c727af0fa1002df0eb2, token_correspondence_AllocST.contains, token_correspondence_AllocST.heap_rel
