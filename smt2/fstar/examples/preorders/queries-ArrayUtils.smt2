...
; Internals for ArrayUtils


; encoding sigelt let init_at_seq
...
; Starting query at ArrayUtils.fst(36,4-37,83)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type)
;   (s1: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a))
...
;       i < FStar.Seq.Base.length s2 /\
;       (forall (any_result: Prims.nat).
;           i == any_result ==>
;           (forall (any_result: a).
;               FStar.Seq.Base.index s2 i == any_result ==>
;               (forall (any_result: FStar.Pervasives.Native.option a).
;                   FStar.Pervasives.Native.Some (FStar.Seq.Base.index s2 i) == any_result ==>
;                   i < FStar.Seq.Base.length s1))))


; Context: While encoding a query
; While typechecking the top-level declaration `let some_equivalent_seqs`
...
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(36,4-37,83)
(forall ((@x3 Term))
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(37,21-37,82)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(37,62-37,63)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=ArrayUtils.fst(37,21-37,82)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=ArrayUtils.fst(37,21-37,82)
(= @x3
@x4)
)
...
;; def=FStar.Pervasives.Native.fst(33,11-33,12); use=ArrayUtils.fst(37,21-37,82)
...
;; def=Prims.fst(175,35-175,36); use=ArrayUtils.fst(37,21-37,82)
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(37,81-37,82)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayUtils.some_equivalent_seqs, 1)
; STATUS: unsat
...
; encoding sigelt let some_equivalent_seqs
...
; encoding sigelt val ArrayUtils.get_some_equivalent
...
; Starting query at ArrayUtils.fst(52,4-52,6)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (s: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     ArrayUtils.all_some s /\
;     (forall (pure_result: Prims.unit).
;         ArrayUtils.all_some s /\
;         FStar.Seq.Base.length (ArrayUtils.get_some_equivalent s) == FStar.Seq.Base.length s ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_get_some_equivalent_length`
...
;; def=ArrayUtils.fst(48,19-48,31); use=ArrayUtils.fst(52,4-52,6)
(Valid 
;; def=ArrayUtils.fst(48,19-48,31); use=ArrayUtils.fst(52,4-52,6)
(ArrayUtils.all_some @x0
@x1)
...
;; def=Prims.fst(441,36-441,97); use=ArrayUtils.fst(52,4-52,6)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=ArrayUtils.fst(49,20-49,30); use=ArrayUtils.fst(52,4-52,6)
(or label_2
...
;; def=ArrayUtils.fst(50,13-50,55); use=ArrayUtils.fst(52,4-52,6)
(or label_3
...
;; def=Prims.fst(441,83-441,96); use=ArrayUtils.fst(52,4-52,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=ArrayUtils.fst(52,4-52,6)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayUtils.lemma_get_some_equivalent_length, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_ArrayUtils.some_equivalent_seqs, refinement_interpretation_Tm_refine_e50addb6c1bbd8f85fb54bf03b146e15, typing_ArrayUtils.get_some_equivalent
...
; encoding sigelt let lemma_get_some_equivalent_length
...
; Starting query at ArrayUtils.fst(59,4-59,6)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_990df9a2546dd665311a590167b235b3 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(55,19-55,47); use=ArrayUtils.fst(59,4-59,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_990df9a2546dd665311a590167b235b3 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_990df9a2546dd665311a590167b235b3 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_990df9a2546dd665311a590167b235b3))

:named refinement_kinding_Tm_refine_990df9a2546dd665311a590167b235b3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(55,19-55,47); use=ArrayUtils.fst(59,4-59,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_990df9a2546dd665311a590167b235b3 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=ArrayUtils.fst(55,20-55,30); use=ArrayUtils.fst(59,4-59,6)
(Valid 
;; def=ArrayUtils.fst(55,20-55,30); use=ArrayUtils.fst(59,4-59,6)
(ArrayUtils.all_some @x2
@x3)
)


;; def=ArrayUtils.fst(55,34-55,46); use=ArrayUtils.fst(59,4-59,6)
(< (BoxInt_proj_0 @x4)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_990df9a2546dd665311a590167b235b3))

:named refinement_interpretation_Tm_refine_990df9a2546dd665311a590167b235b3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_990df9a2546dd665311a590167b235b3
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(55,19-55,47); use=ArrayUtils.fst(59,4-59,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_990df9a2546dd665311a590167b235b3 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_990df9a2546dd665311a590167b235b3 @x0
@x1
@x2))))
:qid haseqTm_refine_990df9a2546dd665311a590167b235b3))

:named haseqTm_refine_990df9a2546dd665311a590167b235b3))

; Encoding query formula : forall (a: Type) (s: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a)) (i: Prims.nat).
;   (forall (_: Prims.squash (ArrayUtils.all_some s /\ i < FStar.Seq.Base.length s)).
;       (*  - Could not prove post-condition
; *)
;       (ArrayUtils.all_some s /\ i < FStar.Seq.Base.length s ==> i < FStar.Seq.Base.length s) /\
;       (ArrayUtils.all_some s /\ i < FStar.Seq.Base.length s /\ Some? (FStar.Seq.Base.index s i) ==>
;         ArrayUtils.all_some s /\
;         (forall (pure_result: FStar.Seq.Base.seq a).
;             ArrayUtils.some_equivalent_seqs s pure_result ==>
;             ArrayUtils.get_some_equivalent s == pure_result ==>
;             i < FStar.Seq.Base.length (ArrayUtils.get_some_equivalent s) /\
;             (forall (any_result: Prims.nat).
;                 i == any_result ==>
;                 (forall (any_result: a).
;                     FStar.Seq.Base.index (ArrayUtils.get_some_equivalent s) i == any_result ==>
;                     (forall (any_result: FStar.Pervasives.Native.option a).
;                         FStar.Pervasives.Native.Some
;                         (FStar.Seq.Base.index (ArrayUtils.get_some_equivalent s) i) ==
;                         any_result ==>
;                         i < FStar.Seq.Base.length s)))))) /\
;   (forall (p: Prims.pure_post Prims.unit).
;       ArrayUtils.all_some s /\ i < FStar.Seq.Base.length s /\
;       (forall (pure_result: Prims.unit).
;           ArrayUtils.all_some s /\ i < FStar.Seq.Base.length s /\ Some? (FStar.Seq.Base.index s i) /\
;           FStar.Pervasives.Native.Some (FStar.Seq.Base.index (ArrayUtils.get_some_equivalent s) i) ==
...
; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_get_some_equivalent_index`
...
;; def=Prims.fst(406,51-406,91); use=Prims.fst(430,19-430,32)
(and 
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(59,4-59,6)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Tm_refine_990df9a2546dd665311a590167b235b3 @x0
@x1
@x2))

;; def=Prims.fst(441,29-441,97); use=ArrayUtils.fst(59,4-59,6)
(and (implies 
;; def=ArrayUtils.fst(56,20-56,46); use=ArrayUtils.fst(59,4-59,6)
(and 
;; def=ArrayUtils.fst(56,20-56,30); use=ArrayUtils.fst(59,4-59,6)
(Valid 
;; def=ArrayUtils.fst(56,20-56,30); use=ArrayUtils.fst(59,4-59,6)
(ArrayUtils.all_some @x0
@x1)
...
;; def=ArrayUtils.fst(56,34-56,46); use=ArrayUtils.fst(59,4-59,6)
(< (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
@x1)))
)
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(57,28-57,29)
(or label_1

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(59,4-59,6)
(< (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
@x1)))
)
...
(implies 
;; def=ArrayUtils.fst(56,20-57,30); use=ArrayUtils.fst(59,4-59,6)
(and 
;; def=ArrayUtils.fst(56,20-56,30); use=ArrayUtils.fst(59,4-59,6)
(Valid 
;; def=ArrayUtils.fst(56,20-56,30); use=ArrayUtils.fst(59,4-59,6)
...
;; def=ArrayUtils.fst(57,13-57,30); use=ArrayUtils.fst(59,4-59,6)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some @x0
(FStar.Seq.Base.index (FStar.Pervasives.Native.option @x0)
@x1
@x2)))
...
;; def=Prims.fst(441,29-441,97); use=ArrayUtils.fst(59,4-59,6)
(and 
;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(56,19-57,86)
(or label_2

;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(59,4-59,6)
(Valid 
;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(59,4-59,6)
(ArrayUtils.all_some @x0
@x1)
...
;; def=Prims.fst(441,36-441,97); use=ArrayUtils.fst(59,4-59,6)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Seq.Base.seq @x0))

;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(59,4-59,6)
(Valid 
;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(59,4-59,6)
(ArrayUtils.some_equivalent_seqs @x0
@x1
@x4)
)


;; def=FStar.Seq.Base.fsti(32,23-32,24); use=ArrayUtils.fst(59,4-59,6)
(= (ArrayUtils.get_some_equivalent @x0
@x1)
@x4)
)

;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(59,4-59,6)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(57,70-57,71)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=ArrayUtils.fst(59,4-59,6)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=ArrayUtils.fst(59,4-59,6)
(= @x2
@x5)
)
...
;; def=FStar.Pervasives.Native.fst(33,11-33,12); use=ArrayUtils.fst(59,4-59,6)
(= (FStar.Seq.Base.index @x0
(ArrayUtils.get_some_equivalent @x0
@x1)
@x2)
...
;; def=Prims.fst(175,35-175,36); use=ArrayUtils.fst(59,4-59,6)
(= (FStar.Pervasives.Native.Some @x0
(FStar.Seq.Base.index @x0
(ArrayUtils.get_some_equivalent @x0
@x1)
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(57,84-57,85)
(or label_4
...
;; def=ArrayUtils.fst(57,34-57,85); use=ArrayUtils.fst(59,4-59,6)
(or label_9
...
;; def=Prims.fst(441,83-441,96); use=ArrayUtils.fst(59,4-59,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=ArrayUtils.fst(59,4-59,6)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayUtils.lemma_get_some_equivalent_index, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_ArrayUtils.all_some, equation_ArrayUtils.some_equivalent_seqs, equation_Prims.nat, int_inversion, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_e50addb6c1bbd8f85fb54bf03b146e15, typing_ArrayUtils.get_some_equivalent
...
; encoding sigelt let lemma_get_some_equivalent_index
...
; Starting query at ArrayUtils.fst(61,7-65,109)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_ec2db2059f4bdbddf106bd2bd5445593 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(62,19-62,42); use=ArrayUtils.fst(62,3-62,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_ec2db2059f4bdbddf106bd2bd5445593 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_ec2db2059f4bdbddf106bd2bd5445593 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_ec2db2059f4bdbddf106bd2bd5445593))

:named refinement_kinding_Tm_refine_ec2db2059f4bdbddf106bd2bd5445593))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(62,19-62,42); use=ArrayUtils.fst(62,3-62,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ec2db2059f4bdbddf106bd2bd5445593 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=ArrayUtils.fst(62,20-62,30); use=ArrayUtils.fst(62,3-62,8)
(Valid 
;; def=ArrayUtils.fst(62,20-62,30); use=ArrayUtils.fst(62,3-62,8)
(ArrayUtils.all_some @x2
@x3)
...
;; def=ArrayUtils.fst(62,34-62,41); use=ArrayUtils.fst(62,3-62,8)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_ec2db2059f4bdbddf106bd2bd5445593))

:named refinement_interpretation_Tm_refine_ec2db2059f4bdbddf106bd2bd5445593))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ec2db2059f4bdbddf106bd2bd5445593
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(62,19-62,42); use=ArrayUtils.fst(62,3-62,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ec2db2059f4bdbddf106bd2bd5445593 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ec2db2059f4bdbddf106bd2bd5445593 @x0
@x1
@x2))))
:qid haseqTm_refine_ec2db2059f4bdbddf106bd2bd5445593))

:named haseqTm_refine_ec2db2059f4bdbddf106bd2bd5445593))
...
;   (_: Prims.squash (ArrayUtils.all_some s /\ Some? x)).
;   (*  - Could not prove post-condition
; *)
;   ArrayUtils.all_some s /\ Some? x ==>
;   ArrayUtils.all_some (FStar.Seq.Properties.snoc s x) /\
;   (forall (pure_result: FStar.Seq.Base.seq a).
;       ArrayUtils.some_equivalent_seqs (FStar.Seq.Properties.snoc s x) pure_result ==>
;       ArrayUtils.get_some_equivalent (FStar.Seq.Properties.snoc s x) == pure_result ==>
;       ArrayUtils.all_some s /\
;       (forall (pure_result: FStar.Seq.Base.seq a).
;           ArrayUtils.some_equivalent_seqs s pure_result ==>
;           ArrayUtils.get_some_equivalent s == pure_result ==> Some? x))


; Context: While encoding a query
; While typechecking the top-level declaration `val ArrayUtils.lemma_get_some_equivalent_snoc`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(61,7-65,109)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(FStar.Pervasives.Native.option @x0))
(HasType @x3
(Tm_refine_ec2db2059f4bdbddf106bd2bd5445593 @x0
@x1
@x2))
...
;; def=Prims.fst(441,29-441,97); use=ArrayUtils.fst(64,13-64,32)
(and 
;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(64,13-64,32)
(or label_1
...
;; def=Prims.fst(441,36-441,97); use=ArrayUtils.fst(64,13-64,32)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Seq.Base.seq @x0))

;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(64,13-64,32)
(Valid 
;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(64,13-64,32)
(ArrayUtils.some_equivalent_seqs @x0
(FStar.Seq.Properties.snoc (FStar.Pervasives.Native.option @x0)
...
;; def=Prims.fst(175,35-175,36); use=ArrayUtils.fst(63,19-64,88)
(= (ArrayUtils.get_some_equivalent @x0
(FStar.Seq.Properties.snoc (FStar.Pervasives.Native.option @x0)
@x1
@x2))
...
;; def=Prims.fst(441,29-441,97); use=ArrayUtils.fst(64,53-64,72)
(and 
;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(64,53-64,72)
(or label_2
...
;; def=Prims.fst(441,36-441,97); use=ArrayUtils.fst(64,53-64,72)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Seq.Base.seq @x0))

;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(64,53-64,72)
(Valid 
;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(64,53-64,72)
(ArrayUtils.some_equivalent_seqs @x0
@x1
...
;; def=FStar.Seq.Properties.fsti(316,20-316,21); use=ArrayUtils.fst(63,19-64,88)
(= (ArrayUtils.get_some_equivalent @x0
@x1)
@x5)
)

;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=ArrayUtils.fst(64,85-64,86)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayUtils.lemma_get_some_equivalent_snoc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_FStar.Pervasives.Native.None, disc_equation_FStar.Pervasives.Native.Some, equation_ArrayUtils.all_some, equation_FStar.Seq.Properties.snoc, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.option, int_inversion, int_typing, kinding_FStar.Pervasives.Native.option@tok, lemma_FStar.Pervasives.invertOption, lemma_FStar.Seq.Base.lemma_create_len, lemma_FStar.Seq.Base.lemma_index_app1, lemma_FStar.Seq.Base.lemma_index_app2, lemma_FStar.Seq.Base.lemma_index_create, lemma_FStar.Seq.Base.lemma_len_append, primitive_Prims.op_Addition, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_ac201cf927190d39c033967b63cb957b, refinement_interpretation_Tm_refine_c1424615841f28cac7fc34e92b7ff33c, refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55, typing_FStar.Seq.Base.create, typing_FStar.Seq.Base.index, typing_FStar.Seq.Base.length, typing_FStar.Seq.Properties.snoc
...
; encoding sigelt val ArrayUtils.lemma_get_some_equivalent_snoc
...
; Starting query at ArrayUtils.fst(67,7-71,129)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_a22d29e8d66257616f075b525c6c04b7 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(68,19-68,47); use=ArrayUtils.fst(68,3-68,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_a22d29e8d66257616f075b525c6c04b7 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_a22d29e8d66257616f075b525c6c04b7 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_a22d29e8d66257616f075b525c6c04b7))

:named refinement_kinding_Tm_refine_a22d29e8d66257616f075b525c6c04b7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(68,19-68,47); use=ArrayUtils.fst(68,3-68,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a22d29e8d66257616f075b525c6c04b7 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=ArrayUtils.fst(68,20-68,31); use=ArrayUtils.fst(68,3-68,8)
(Valid 
;; def=ArrayUtils.fst(68,20-68,31); use=ArrayUtils.fst(68,3-68,8)
(ArrayUtils.all_some @x2
@x3)
...
;; def=ArrayUtils.fst(68,35-68,46); use=ArrayUtils.fst(68,3-68,8)
(Valid 
;; def=ArrayUtils.fst(68,35-68,46); use=ArrayUtils.fst(68,3-68,8)
(ArrayUtils.all_some @x2
@x4)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_a22d29e8d66257616f075b525c6c04b7))

:named refinement_interpretation_Tm_refine_a22d29e8d66257616f075b525c6c04b7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a22d29e8d66257616f075b525c6c04b7
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(68,19-68,47); use=ArrayUtils.fst(68,3-68,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a22d29e8d66257616f075b525c6c04b7 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a22d29e8d66257616f075b525c6c04b7 @x0
@x1
@x2))))
:qid haseqTm_refine_a22d29e8d66257616f075b525c6c04b7))

:named haseqTm_refine_a22d29e8d66257616f075b525c6c04b7))

; Encoding query formula : forall (a: Type0)
;   (s1: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a))
;   (s2: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a))
;   (_: Prims.squash (ArrayUtils.all_some s1 /\ ArrayUtils.all_some s2)).
;   (*  - Could not prove post-condition
; *)
;   ArrayUtils.all_some s1 /\ ArrayUtils.all_some s2 ==>
;   ArrayUtils.all_some (FStar.Seq.Base.append s1 s2) /\
;   (forall (pure_result: FStar.Seq.Base.seq a).
;       ArrayUtils.some_equivalent_seqs (FStar.Seq.Base.append s1 s2) pure_result ==>
;       ArrayUtils.get_some_equivalent (FStar.Seq.Base.append s1 s2) == pure_result ==>
;       ArrayUtils.all_some s1 /\
;       (forall (pure_result: FStar.Seq.Base.seq a).
;           ArrayUtils.some_equivalent_seqs s1 pure_result ==>
;           ArrayUtils.get_some_equivalent s1 == pure_result ==> ArrayUtils.all_some s2))


; Context: While encoding a query
; While typechecking the top-level declaration `val ArrayUtils.lemma_get_some_equivalent_append`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(67,7-71,129)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(FStar.Seq.Base.seq (FStar.Pervasives.Native.option @x0)))
(HasType @x3
(Tm_refine_a22d29e8d66257616f075b525c6c04b7 @x0
@x1
@x2))
...
;; def=Prims.fst(441,29-441,97); use=ArrayUtils.fst(70,13-70,32)
(and 
;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(70,13-70,32)
(or label_1
...
;; def=Prims.fst(441,36-441,97); use=ArrayUtils.fst(70,13-70,32)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Seq.Base.seq @x0))

;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(70,13-70,32)
(Valid 
;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(70,13-70,32)
(ArrayUtils.some_equivalent_seqs @x0
(FStar.Seq.Base.append (FStar.Pervasives.Native.option @x0)
...
;; def=Prims.fst(175,35-175,36); use=ArrayUtils.fst(69,19-70,108)
(= (ArrayUtils.get_some_equivalent @x0
(FStar.Seq.Base.append (FStar.Pervasives.Native.option @x0)
@x1
@x2))
...
;; def=Prims.fst(441,29-441,97); use=ArrayUtils.fst(70,59-70,78)
(and 
;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(70,59-70,78)
(or label_2
...
;; def=Prims.fst(441,36-441,97); use=ArrayUtils.fst(70,59-70,78)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Seq.Base.seq @x0))

;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(70,59-70,78)
(Valid 
;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(70,59-70,78)
(ArrayUtils.some_equivalent_seqs @x0
@x1
...
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(69,19-70,108)
(= (ArrayUtils.get_some_equivalent @x0
@x1)
@x5)
)

;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(70,84-70,103)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayUtils.lemma_get_some_equivalent_append, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_FStar.Pervasives.Native.Some, equation_ArrayUtils.all_some, equation_Prims.nat, int_inversion, int_typing, kinding_FStar.Pervasives.Native.option@tok, lemma_FStar.Seq.Base.lemma_index_app1, lemma_FStar.Seq.Base.lemma_index_app2, lemma_FStar.Seq.Base.lemma_len_append, primitive_Prims.op_Addition, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_ac201cf927190d39c033967b63cb957b, refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55, typing_FStar.Seq.Base.length
...
; encoding sigelt val ArrayUtils.lemma_get_some_equivalent_append
...
; Starting query at ArrayUtils.fst(73,7-78,105)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_7d63bc7f74d8071c6967b25da79245f3 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(74,19-74,62); use=ArrayUtils.fst(74,3-74,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_7d63bc7f74d8071c6967b25da79245f3 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_7d63bc7f74d8071c6967b25da79245f3 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_7d63bc7f74d8071c6967b25da79245f3))

:named refinement_kinding_Tm_refine_7d63bc7f74d8071c6967b25da79245f3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(74,19-74,62); use=ArrayUtils.fst(74,3-74,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7d63bc7f74d8071c6967b25da79245f3 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=ArrayUtils.fst(74,20-74,30); use=ArrayUtils.fst(74,3-74,8)
(Valid 
;; def=ArrayUtils.fst(74,20-74,30); use=ArrayUtils.fst(74,3-74,8)
(ArrayUtils.all_some @x2
@x3)
...
;; def=ArrayUtils.fst(74,34-74,40); use=ArrayUtils.fst(74,3-74,8)
(>= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 @x5))


;; def=ArrayUtils.fst(74,44-74,61); use=ArrayUtils.fst(74,3-74,8)
(<= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x2)
@x3)))
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_7d63bc7f74d8071c6967b25da79245f3))

:named refinement_interpretation_Tm_refine_7d63bc7f74d8071c6967b25da79245f3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7d63bc7f74d8071c6967b25da79245f3
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(74,19-74,62); use=ArrayUtils.fst(74,3-74,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7d63bc7f74d8071c6967b25da79245f3 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_7d63bc7f74d8071c6967b25da79245f3 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_7d63bc7f74d8071c6967b25da79245f3))

:named haseqTm_refine_7d63bc7f74d8071c6967b25da79245f3))

; Encoding query formula : forall (a: Type0)
;   (s: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a))
;   (i: Prims.nat)
;   (j: Prims.nat)
;   (_: Prims.squash (ArrayUtils.all_some s /\ j >= i /\ j <= FStar.Seq.Base.length s)).
;   (*  - Could not prove post-condition
; *)
;   ArrayUtils.all_some s /\ j >= i /\ j <= FStar.Seq.Base.length s ==>
;   i <= j && j <= FStar.Seq.Base.length s /\
;   (forall (any_result: Prims.nat).
;       j == any_result ==>
;       (forall (any_result: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a)).
;           FStar.Seq.Base.slice s i j == any_result ==>
;           ArrayUtils.all_some (FStar.Seq.Base.slice s i j) /\
;           (forall (pure_result: FStar.Seq.Base.seq a).
;               ArrayUtils.some_equivalent_seqs (FStar.Seq.Base.slice s i j) pure_result ==>
;               ArrayUtils.get_some_equivalent (FStar.Seq.Base.slice s i j) == pure_result ==>
;               ArrayUtils.all_some s /\
;               (forall (pure_result: FStar.Seq.Base.seq a).
;                   ArrayUtils.some_equivalent_seqs s pure_result ==>
;                   ArrayUtils.get_some_equivalent s == pure_result ==>
;                   i <= j && j <= FStar.Seq.Base.length (ArrayUtils.get_some_equivalent s)))))


; Context: While encoding a query
; While typechecking the top-level declaration `val ArrayUtils.lemma_get_some_equivalent_slice`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(73,7-78,105)
...
Prims.nat)
(HasType @x4
(Tm_refine_7d63bc7f74d8071c6967b25da79245f3 @x0
@x1
@x3
@x2))
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(75,19-76,84)
(and 
;; def=ArrayUtils.fst(73,82-73,83); use=ArrayUtils.fst(76,44-76,45)
(or label_1
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x2
@x3)))
...
;; def=Prims.fst(451,66-451,102); use=ArrayUtils.fst(75,19-76,84)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=FStar.Seq.Base.fsti(64,43-64,44); use=ArrayUtils.fst(75,19-76,84)
(= @x3
@x5)
)
...
;; def=ArrayUtils.fst(42,43-76,46); use=ArrayUtils.fst(75,19-76,84)
...
;; def=Prims.fst(441,29-441,97); use=ArrayUtils.fst(76,13-76,32)
(and 
;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(76,13-76,32)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=ArrayUtils.fst(76,13-76,32)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.Seq.Base.seq @x0))

;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(76,13-76,32)
(Valid 
;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(76,13-76,32)
(ArrayUtils.some_equivalent_seqs @x0
(FStar.Seq.Base.slice (FStar.Pervasives.Native.option @x0)
...
;; def=Prims.fst(175,35-175,36); use=ArrayUtils.fst(75,19-76,84)
(= (ArrayUtils.get_some_equivalent @x0
(FStar.Seq.Base.slice (FStar.Pervasives.Native.option @x0)
@x1
@x2
...
;; def=Prims.fst(441,29-441,97); use=ArrayUtils.fst(76,57-76,76)
(and 
;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(76,57-76,76)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=ArrayUtils.fst(76,57-76,76)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(FStar.Seq.Base.seq @x0))

;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(76,57-76,76)
(Valid 
;; def=ArrayUtils.fst(45,22-45,46); use=ArrayUtils.fst(76,57-76,76)
(ArrayUtils.some_equivalent_seqs @x0
@x1
...
;; def=FStar.Seq.Base.fsti(64,23-64,24); use=ArrayUtils.fst(75,19-76,84)
(= (ArrayUtils.get_some_equivalent @x0
@x1)
@x8)
)

;; def=FStar.Seq.Base.fsti(64,49-64,72); use=ArrayUtils.fst(76,82-76,83)
(and 
;; def=ArrayUtils.fst(73,82-73,83); use=ArrayUtils.fst(76,82-76,83)
(or label_5
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x2
@x3)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayUtils.lemma_get_some_equivalent_slice, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_FStar.Pervasives.Native.Some, equation_ArrayUtils.all_some, equation_Prims.nat, int_inversion, int_typing, kinding_FStar.Pervasives.Native.option@tok, lemma_ArrayUtils.lemma_get_some_equivalent_length, lemma_FStar.Seq.Base.lemma_index_slice, lemma_FStar.Seq.Base.lemma_len_slice, primitive_Prims.op_Addition, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_35a0739c434508f48d0bb1d5cd5df9e8, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_81407705a0828c2c1b1976675443f647, refinement_interpretation_Tm_refine_d3d07693cd71377864ef84dc97d10ec1, typing_FStar.Seq.Base.length
...
; encoding sigelt val ArrayUtils.lemma_get_some_equivalent_slice
...
; Starting query at ArrayUtils.fst(90,4-90,12)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_22c0491ca45fdffdc13632c9fae6819f (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(83,19-85,91); use=ArrayUtils.fst(90,4-90,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_refine_22c0491ca45fdffdc13632c9fae6819f @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_refine_22c0491ca45fdffdc13632c9fae6819f @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid refinement_kinding_Tm_refine_22c0491ca45fdffdc13632c9fae6819f))

:named refinement_kinding_Tm_refine_22c0491ca45fdffdc13632c9fae6819f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(83,19-85,91); use=ArrayUtils.fst(90,4-90,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_22c0491ca45fdffdc13632c9fae6819f @x2
@x3
@x4
@x5
@x6))
...
;; def=ArrayUtils.fst(83,20-83,26); use=ArrayUtils.fst(90,4-90,12)
(>= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 @x3))


;; def=ArrayUtils.fst(83,30-83,47); use=ArrayUtils.fst(90,4-90,12)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x4)
@x5)))


;; def=ArrayUtils.fst(84,20-84,41); use=ArrayUtils.fst(90,4-90,12)
...
;; def=ArrayUtils.fst(85,6-85,90); use=ArrayUtils.fst(90,4-90,12)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)

;; def=ArrayUtils.fst(85,24-85,30); use=ArrayUtils.fst(90,4-90,12)
(>= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 @x3))


;; def=ArrayUtils.fst(85,34-85,39); use=ArrayUtils.fst(90,4-90,12)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 @x2))
)

;; def=ArrayUtils.fst(85,45-85,89); use=ArrayUtils.fst(90,4-90,12)
(= (FStar.Seq.Base.index (FStar.Pervasives.Native.option @x4)
@x5
@x7)
(FStar.Pervasives.Native.Some @x4
(FStar.Seq.Base.index @x4
@x6
(Prims.op_Subtraction @x7
@x3))))
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_22c0491ca45fdffdc13632c9fae6819f.1))
))
...
@x5
@x6)))
:qid refinement_interpretation_Tm_refine_22c0491ca45fdffdc13632c9fae6819f))

:named refinement_interpretation_Tm_refine_22c0491ca45fdffdc13632c9fae6819f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_22c0491ca45fdffdc13632c9fae6819f
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(83,19-85,91); use=ArrayUtils.fst(90,4-90,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_22c0491ca45fdffdc13632c9fae6819f @x0
@x1
@x2
@x3
@x4)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_22c0491ca45fdffdc13632c9fae6819f @x0
@x1
@x2
@x3
@x4))))
:qid haseqTm_refine_22c0491ca45fdffdc13632c9fae6819f))

:named haseqTm_refine_22c0491ca45fdffdc13632c9fae6819f))
;;;;;;;;;;;;;;;;k: Prims.nat -> Prims.GTot Type0
...
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(85,17-85,20); use=ArrayUtils.fst(90,4-90,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid ArrayUtils_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named ArrayUtils_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
...
:pattern ((ApplyTT @x0
@x1))
:qid ArrayUtils_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid ArrayUtils_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named ArrayUtils_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
(declare-fun Tm_abs_25c882958d8726e8ce492f753f476d39 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_25c882958d8726e8ce492f753f476d39
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(85,6-85,90); use=ArrayUtils.fst(90,4-90,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_25c882958d8726e8ce492f753f476d39 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Tm_abs_25c882958d8726e8ce492f753f476d39 @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_25c882958d8726e8ce492f753f476d39))

:named typing_Tm_abs_25c882958d8726e8ce492f753f476d39))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_25c882958d8726e8ce492f753f476d39
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(85,6-85,90); use=ArrayUtils.fst(90,4-90,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (Tm_abs_25c882958d8726e8ce492f753f476d39 @x1
@x2
@x3
@x4
@x5)
@x0)
(Prims.l_imp (Prims.l_and (Prims.b2t (Prims.op_GreaterThanOrEqual @x0
@x1))
(Prims.b2t (Prims.op_LessThan @x0
@x2)))
(Prims.eq2 (FStar.Pervasives.Native.option @x3)
(FStar.Seq.Base.index (FStar.Pervasives.Native.option @x3)
@x4
@x0)
(FStar.Pervasives.Native.Some @x3
(FStar.Seq.Base.index @x3
@x5
(Prims.op_Subtraction @x0
@x1))))))
 

:pattern ((ApplyTT (Tm_abs_25c882958d8726e8ce492f753f476d39 @x1
@x2
@x3
@x4
@x5)
@x0))
:qid interpretation_Tm_abs_25c882958d8726e8ce492f753f476d39))

:named interpretation_Tm_abs_25c882958d8726e8ce492f753f476d39))
...
(Tm_abs_25c882958d8726e8ce492f753f476d39 @x4
@x3
@x2
@x1
@x0)))
...
;;no pats
:qid l_quant_interp_cd224225cfca4c21393011b238bfd72a.1))
)
...
@x1
@x0))))
:qid l_quant_interp_cd224225cfca4c21393011b238bfd72a))

:named l_quant_interp_cd224225cfca4c21393011b238bfd72a))
...
;   (j >= i /\ j <= FStar.Seq.Base.length s /\ FStar.Seq.Base.length s' = j - i ==>
;     (forall (k: Prims.nat).
;         k >= i /\ k < j ==>
;         k < FStar.Seq.Base.length s /\
;         (forall (any_result: Prims.nat).
;             k == any_result ==>
;             (forall (any_result: FStar.Pervasives.Native.option a).
;                 FStar.Seq.Base.index s k == any_result ==>
;                 k - i >= 0 /\ k - i < FStar.Seq.Base.length s')))) /\
;   (forall (any_result: Prims.logical).
;       (j >= i) /\ (j <= FStar.Seq.Base.length s) /\ (FStar.Seq.Base.length s' = j - i) /\
;       (forall (k: Prims.nat).
;           k >= i /\ k < j ==>
;           FStar.Seq.Base.index s k == FStar.Pervasives.Native.Some (FStar.Seq.Base.index s' (k - i))
;       ) ==
;       any_result ==>
;       (j >= i /\ j <= FStar.Seq.Base.length s /\ FStar.Seq.Base.length s' = j - i ==>
;         (forall (k: Prims.nat).
...
;                     k - i >= 0 /\ k - i < FStar.Seq.Base.length s')))) /\
;       (forall (_:
;           Prims.squash (j >= i /\ j <= FStar.Seq.Base.length s /\ FStar.Seq.Base.length s' = j - i /\
;               (forall (k: Prims.nat).
;                   k >= i /\ k < j ==>
;                   FStar.Seq.Base.index s k ==
;                   FStar.Pervasives.Native.Some (FStar.Seq.Base.index s' (k - i))))).
;           (*  - Could not prove post-condition
; *)
;           (j >= i /\ j <= FStar.Seq.Base.length s /\ FStar.Seq.Base.length s' = j - i ==>
;             (forall (k: Prims.nat).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_get_equivalent_sequence_slice`
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(90,4-90,12)
(and (implies 
;; def=ArrayUtils.fst(83,20-84,41); use=ArrayUtils.fst(90,4-90,12)
(and 
;; def=ArrayUtils.fst(83,20-83,26); use=ArrayUtils.fst(90,4-90,12)
(>= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x2))
...
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(90,4-90,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(90,4-90,12)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(85,57-85,58)
(or label_1

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(90,4-90,12)
(< (BoxInt_proj_0 @x5)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
@x1)))
)
...
;; def=Prims.fst(451,66-451,102); use=ArrayUtils.fst(90,4-90,12)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=ArrayUtils.fst(90,4-90,12)
(= @x5
@x6)
)
...
;; def=Prims.fst(175,35-175,36); use=ArrayUtils.fst(90,4-90,12)
(= (FStar.Seq.Base.index (FStar.Pervasives.Native.option @x0)
@x1
@x5)
@x7)
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(90,4-90,12)
(and 
;; def=Prims.fst(680,18-680,24); use=ArrayUtils.fst(85,81-85,88)
(or label_2

;; def=Prims.fst(680,18-680,24); use=ArrayUtils.fst(90,4-90,12)
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(85,81-85,88)
(or label_3
...
;; def=FStar.Pervasives.fsti(112,28-112,31); use=ArrayUtils.fst(90,4-90,12)
(= (Prims.l_and (Prims.l_and (Prims.l_and (Prims.b2t (Prims.op_GreaterThanOrEqual @x3
@x2))
...
(Tm_abs_25c882958d8726e8ce492f753f476d39 @x2
@x3
@x0
@x1
@x4)))
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(90,4-90,12)
(and 
;; def=Prims.fst(680,18-680,24); use=ArrayUtils.fst(83,3-83,8)
(or label_5

;; def=Prims.fst(680,18-680,24); use=ArrayUtils.fst(90,4-90,12)
(>= (BoxInt_proj_0 (Prims.op_Subtraction @x6
@x2))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(83,3-83,8)
(or label_6
...
(forall ((@x6 Term))
 (! (implies (HasType @x6
(Tm_refine_22c0491ca45fdffdc13632c9fae6819f @x3
@x2
@x0
@x1
@x4))
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(90,4-90,12)
(and (implies 
;; def=ArrayUtils.fst(86,20-87,41); use=ArrayUtils.fst(90,4-90,12)
(and 
;; def=ArrayUtils.fst(86,20-86,26); use=ArrayUtils.fst(90,4-90,12)
(>= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x2))


;; def=ArrayUtils.fst(86,30-86,47); use=ArrayUtils.fst(90,4-90,12)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
@x1)))


;; def=ArrayUtils.fst(87,20-87,41); use=ArrayUtils.fst(90,4-90,12)
(= (FStar.Seq.Base.length @x0
@x4)
(Prims.op_Subtraction @x3
@x2))
...
;; def=ArrayUtils.fst(88,24-88,30); use=ArrayUtils.fst(90,4-90,12)
(>= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 @x2))


;; def=ArrayUtils.fst(88,34-88,39); use=ArrayUtils.fst(90,4-90,12)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 @x3))
)
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(90,4-90,12)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(88,57-88,58)
(or label_7
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(90,4-90,12)
(and 
;; def=Prims.fst(680,18-680,24); use=ArrayUtils.fst(88,81-88,88)
(or label_8

;; def=Prims.fst(680,18-680,24); use=ArrayUtils.fst(90,4-90,12)
(>= (BoxInt_proj_0 (Prims.op_Subtraction @x7
@x2))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(88,81-88,88)
(or label_9
...
(implies 
;; def=ArrayUtils.fst(86,20-88,90); use=ArrayUtils.fst(90,4-90,12)
(and 
;; def=ArrayUtils.fst(86,20-86,26); use=ArrayUtils.fst(90,4-90,12)
(>= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x2))
...
;; def=ArrayUtils.fst(88,6-88,90); use=ArrayUtils.fst(90,4-90,12)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)
...
;; def=ArrayUtils.fst(88,45-88,89); use=ArrayUtils.fst(90,4-90,12)
(= (FStar.Seq.Base.index (FStar.Pervasives.Native.option @x0)
@x1
@x7)
(FStar.Pervasives.Native.Some @x0
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(90,4-90,12)
(and 
;; def=ArrayUtils.fst(81,41-81,42); use=ArrayUtils.fst(89,48-89,49)
(or label_10
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x2
@x3)))
...
;; def=FStar.Seq.Base.fsti(64,43-64,44); use=ArrayUtils.fst(90,4-90,12)
(= @x3
@x7)
)
...
;; def=ArrayUtils.fst(42,43-89,50); use=ArrayUtils.fst(90,4-90,12)
(= (FStar.Seq.Base.slice (FStar.Pervasives.Native.option @x0)
@x1
@x2
@x3)
...
;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(86,19-89,57)
(or label_12

;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(90,4-90,12)
(Valid 
;; def=ArrayUtils.fst(44,19-44,31); use=ArrayUtils.fst(90,4-90,12)
(ArrayUtils.all_some @x0
(FStar.Seq.Base.slice (FStar.Pervasives.Native.option @x0)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayUtils.lemma_get_equivalent_sequence_slice, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.None, equation_ArrayUtils.all_some, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, kinding_FStar.Pervasives.Native.option@tok, lemma_FStar.Pervasives.invertOption, lemma_FStar.Seq.Base.lemma_index_slice, lemma_FStar.Seq.Base.lemma_len_slice, primitive_Prims.op_Addition, primitive_Prims.op_Equality, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_22c0491ca45fdffdc13632c9fae6819f, refinement_interpretation_Tm_refine_35a0739c434508f48d0bb1d5cd5df9e8, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_81407705a0828c2c1b1976675443f647, refinement_interpretation_Tm_refine_d3d07693cd71377864ef84dc97d10ec1, refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55, typing_FStar.Seq.Base.index, typing_FStar.Seq.Base.length
...
; encoding sigelt let lemma_get_equivalent_sequence_slice
...
; Starting query at ArrayUtils.fst(92,7-102,86)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_077237cabd91707d6b4c088d07b1fa1e (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=ArrayUtils.fst(92,24-93,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_refine_077237cabd91707d6b4c088d07b1fa1e @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_refine_077237cabd91707d6b4c088d07b1fa1e @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid refinement_kinding_Tm_refine_077237cabd91707d6b4c088d07b1fa1e))

:named refinement_kinding_Tm_refine_077237cabd91707d6b4c088d07b1fa1e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=ArrayUtils.fst(92,24-93,24)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_077237cabd91707d6b4c088d07b1fa1e @x2
@x3
@x4
@x5
@x6))
(and (HasTypeFuel @u0
@x1
(FStar.Seq.Base.seq (FStar.Pervasives.Native.option @x4)))

;; def=ArrayUtils.fst(94,19-94,25); use=ArrayUtils.fst(93,3-93,7)
(>= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 @x3))


;; def=ArrayUtils.fst(94,29-94,47); use=ArrayUtils.fst(93,3-93,7)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x4)
@x5)))


;; def=ArrayUtils.fst(94,51-94,72); use=ArrayUtils.fst(93,3-93,7)
(= (FStar.Seq.Base.length @x4
@x6)
(Prims.op_Subtraction @x2
@x3))
...
@x5
@x6)))
:qid refinement_interpretation_Tm_refine_077237cabd91707d6b4c088d07b1fa1e))

:named refinement_interpretation_Tm_refine_077237cabd91707d6b4c088d07b1fa1e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_077237cabd91707d6b4c088d07b1fa1e
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=ArrayUtils.fst(92,24-93,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_077237cabd91707d6b4c088d07b1fa1e @x0
@x1
@x2
@x3
@x4)))
(Valid (Prims.hasEq (FStar.Seq.Base.seq (FStar.Pervasives.Native.option @x2)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_077237cabd91707d6b4c088d07b1fa1e @x0
@x1
@x2
@x3
@x4))))
:qid haseqTm_refine_077237cabd91707d6b4c088d07b1fa1e))

:named haseqTm_refine_077237cabd91707d6b4c088d07b1fa1e))
(declare-fun Tm_refine_d90b8eae04635c5dcd9661827286f61c (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(64,43-64,73); use=ArrayUtils.fst(92,24-93,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_d90b8eae04635c5dcd9661827286f61c @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_d90b8eae04635c5dcd9661827286f61c @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_d90b8eae04635c5dcd9661827286f61c))

:named refinement_kinding_Tm_refine_d90b8eae04635c5dcd9661827286f61c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(64,43-64,73); use=ArrayUtils.fst(92,24-93,24)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d90b8eae04635c5dcd9661827286f61c @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
@x1))
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x1
(FStar.Seq.Base.length (FStar.Pervasives.Native.option @x3)
@x4)))))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_d90b8eae04635c5dcd9661827286f61c))

:named refinement_interpretation_Tm_refine_d90b8eae04635c5dcd9661827286f61c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d90b8eae04635c5dcd9661827286f61c
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(64,43-64,73); use=ArrayUtils.fst(92,24-93,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d90b8eae04635c5dcd9661827286f61c @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d90b8eae04635c5dcd9661827286f61c @x0
@x1
@x2))))
:qid haseqTm_refine_d90b8eae04635c5dcd9661827286f61c))

:named haseqTm_refine_d90b8eae04635c5dcd9661827286f61c))
...
;     {j >= i /\ j <= FStar.Seq.Base.length s1 /\ FStar.Seq.Base.length s2 = j - i}).
;   (*  - Could not prove post-condition
; *)
;   (j >= i /\ j <= FStar.Seq.Base.length s1 /\ FStar.Seq.Base.length s2 = j - i /\
;     FStar.Seq.Base.length r == FStar.Seq.Base.length s1 ==>
;     (forall (off: Prims.nat).
;         (*  - Could not prove post-condition
; *)
;         forall (n: Prims.nat).
;           off + n <= FStar.Seq.Base.length s1 /\ (off + n <= i \/ j <= off) ==>
;           off + n >= 0 /\ off <= off + n && off + n <= FStar.Seq.Base.length s1 /\
;           (forall (return_val: j: Prims.nat{off <= j && j <= FStar.Seq.Base.length s1}).
;               return_val == off + n ==>
;               (forall (any_result: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a)).
;                   FStar.Seq.Base.slice s1 off (off + n) == any_result ==>
;                   off + n >= 0 /\ off <= off + n && off + n <= FStar.Seq.Base.length r)))) /\
;   (j >= i /\ j <= FStar.Seq.Base.length s1 /\ FStar.Seq.Base.length s2 = j - i /\
;     FStar.Seq.Base.length r == FStar.Seq.Base.length s1 /\
;     (forall (off: Prims.nat) (n: Prims.nat).
;         off + n <= FStar.Seq.Base.length s1 /\ (off + n <= i \/ j <= off) ==>
;         FStar.Seq.Base.slice s1 off (off + n) == FStar.Seq.Base.slice r off (off + n)) ==>
;     (forall (k: Prims.nat).
;         (k < i ==>
;           k < FStar.Seq.Base.length r /\
;           (forall (any_result: Prims.nat).
;               k == any_result ==>
;               (forall (any_result: FStar.Pervasives.Native.option a).
;                   FStar.Seq.Base.index r k == any_result ==> k < FStar.Seq.Base.length s1))) /\
;         ((k < i ==> FStar.Seq.Base.index r k == FStar.Seq.Base.index s1 k) ==>
;           k >= i /\ k < j ==>
;           k < FStar.Seq.Base.length r /\
;           (forall (any_result: Prims.nat).
;               k == any_result ==>
;               (forall (any_result: FStar.Pervasives.Native.option a).
;                   FStar.Seq.Base.index r k == any_result ==>
;                   k - i >= 0 /\ k - i < FStar.Seq.Base.length s2))) /\
;         ((k < i ==> FStar.Seq.Base.index r k == FStar.Seq.Base.index s1 k) /\
;           (k >= i /\ k < j ==>
;             FStar.Seq.Base.index r k ==
;             FStar.Pervasives.Native.Some (FStar.Seq.Base.index s2 (k - i))) ==>
;           k >= j /\ k < FStar.Seq.Base.length s1 ==>
;           k < FStar.Seq.Base.length r /\
;           (forall (any_result: Prims.nat).
;               k == any_result ==>
;               (forall (any_result: FStar.Pervasives.Native.option a).
...
; Context: While encoding a query
; While typechecking the top-level declaration `val ArrayUtils.copy_seq`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(92,7-102,86)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(FStar.Seq.Base.seq @x0))
(HasType @x5
(Tm_refine_077237cabd91707d6b4c088d07b1fa1e @x3
@x2
@x0
@x1
@x4)))

;; def=dummy(0,0-0,0); use=ArrayUtils.fst(92,24-93,24)
(and (implies 
;; def=ArrayUtils.fst(95,21-96,47); use=ArrayUtils.fst(92,24-93,24)
(and 
;; def=ArrayUtils.fst(95,21-95,27); use=ArrayUtils.fst(92,24-93,24)
(>= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x2))


;; def=ArrayUtils.fst(95,31-95,49); use=ArrayUtils.fst(92,24-93,24)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
@x1)))


;; def=ArrayUtils.fst(95,53-95,74); use=ArrayUtils.fst(92,24-93,24)
(= (FStar.Seq.Base.length @x0
@x4)
(Prims.op_Subtraction @x3
@x2))
...
;; def=ArrayUtils.fst(96,18-96,47); use=ArrayUtils.fst(92,24-93,24)
(= (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
@x5)
(FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
@x1))
...
;; def=ArrayUtils.fst(97,32-97,56); use=ArrayUtils.fst(92,24-93,24)
...
;; def=ArrayUtils.fst(97,60-97,86); use=ArrayUtils.fst(92,24-93,24)
(or 
;; def=ArrayUtils.fst(97,61-97,73); use=ArrayUtils.fst(92,24-93,24)
(<= (BoxInt_proj_0 (Prims.op_Addition @x6
@x7))
(BoxInt_proj_0 @x2))


;; def=ArrayUtils.fst(97,77-97,85); use=ArrayUtils.fst(92,24-93,24)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x6))
)
)

;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(92,24-93,24)
(and 
;; def=Prims.fst(680,18-680,24); use=ArrayUtils.fst(98,40-98,49)
(or label_1

;; def=Prims.fst(680,18-680,24); use=ArrayUtils.fst(92,24-93,24)
(>= (BoxInt_proj_0 (Prims.op_Addition @x6
@x7))
(BoxInt_proj_0 (BoxInt 0)))
)
...
;; def=ArrayUtils.fst(98,40-98,49); use=ArrayUtils.fst(98,40-98,49)
(or label_2
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x6
...
;; def=ArrayUtils.fst(98,40-98,49); use=ArrayUtils.fst(98,40-98,49)
(or label_3
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (Prims.op_Addition @x6
@x7)
(FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
@x1))))


;; def=Prims.fst(356,2-356,58); use=ArrayUtils.fst(92,24-93,24)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Tm_refine_d90b8eae04635c5dcd9661827286f61c @x6
@x0
@x1))

;; def=Prims.fst(356,26-356,41); use=ArrayUtils.fst(92,24-93,24)
(= @x8
(Prims.op_Addition @x6
@x7))
)

;; def=Prims.fst(451,66-451,102); use=ArrayUtils.fst(92,24-93,24)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(FStar.Seq.Base.seq (FStar.Pervasives.Native.option @x0)))

;; def=Prims.fst(175,35-175,36); use=ArrayUtils.fst(92,24-93,24)
(= (FStar.Seq.Base.slice (FStar.Pervasives.Native.option @x0)
@x1
@x6
(Prims.op_Addition @x6
...
;; def=FStar.Seq.Base.fsti(64,49-64,72); use=ArrayUtils.fst(92,24-93,24)
(and 
;; def=Prims.fst(680,18-680,24); use=ArrayUtils.fst(98,69-98,78)
(or label_4
...
;; def=ArrayUtils.fst(98,69-98,78); use=ArrayUtils.fst(98,69-98,78)
(or label_5
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x6
(Prims.op_Addition @x6
@x7))))
...
(implies 
;; def=ArrayUtils.fst(95,21-98,79); use=ArrayUtils.fst(92,24-93,24)
(and 
;; def=ArrayUtils.fst(95,21-95,27); use=ArrayUtils.fst(92,24-93,24)
(>= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x2))
...
;; def=ArrayUtils.fst(97,4-98,79); use=ArrayUtils.fst(92,24-93,24)
...
;; def=ArrayUtils.fst(98,23-98,78); use=ArrayUtils.fst(92,24-93,24)
(= (FStar.Seq.Base.slice (FStar.Pervasives.Native.option @x0)
@x1
@x6
(Prims.op_Addition @x6
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(92,24-93,24)
(and (implies 
;; def=ArrayUtils.fst(100,8-100,13); use=ArrayUtils.fst(92,24-93,24)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x2))
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(92,24-93,24)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(100,31-100,32)
(or label_7

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(92,24-93,24)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
@x5)))
)
...
;; def=FStar.Seq.Base.fsti(32,34-32,35); use=ArrayUtils.fst(92,24-93,24)
(= @x6
@x7)
)
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(100,49-100,50)
(or label_8
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(92,24-93,24)
(and 
;; def=ArrayUtils.fst(100,7-100,52); use=ArrayUtils.fst(92,24-93,24)
(implies 
;; def=ArrayUtils.fst(100,8-100,13); use=ArrayUtils.fst(92,24-93,24)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x2))
...
;; def=ArrayUtils.fst(100,18-100,51); use=ArrayUtils.fst(92,24-93,24)
(= (FStar.Seq.Base.index (FStar.Pervasives.Native.option @x0)
@x5
@x6)
(FStar.Seq.Base.index (FStar.Pervasives.Native.option @x0)
...
;; def=ArrayUtils.fst(101,9-101,15); use=ArrayUtils.fst(92,24-93,24)
(>= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x2))


;; def=ArrayUtils.fst(101,19-101,24); use=ArrayUtils.fst(92,24-93,24)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x3))
)
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(92,24-93,24)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(101,43-101,44)
(or label_9
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(92,24-93,24)
(and 
;; def=Prims.fst(680,18-680,24); use=ArrayUtils.fst(101,67-101,74)
(or label_10
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(101,67-101,74)
(or label_11
...
;; def=ArrayUtils.fst(101,7-101,77); use=ArrayUtils.fst(92,24-93,24)
(implies 
;; def=ArrayUtils.fst(101,8-101,25); use=ArrayUtils.fst(92,24-93,24)
(and 
;; def=ArrayUtils.fst(101,9-101,15); use=ArrayUtils.fst(92,24-93,24)
(>= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x2))
...
;; def=ArrayUtils.fst(101,30-101,76); use=ArrayUtils.fst(92,24-93,24)
(= (FStar.Seq.Base.index (FStar.Pervasives.Native.option @x0)
@x5
@x6)
(FStar.Pervasives.Native.Some @x0
(FStar.Seq.Base.index @x0
@x4
(Prims.op_Subtraction @x6
@x2))))
)


;; def=ArrayUtils.fst(102,16-102,22); use=ArrayUtils.fst(92,24-93,24)
(>= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 @x3))


;; def=ArrayUtils.fst(102,26-102,43); use=ArrayUtils.fst(92,24-93,24)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
@x1)))
)
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(92,24-93,24)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(102,62-102,63)
(or label_12
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(102,80-102,81)
(or label_13
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayUtils.copy_seq, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, int_inversion, primitive_Prims.op_Addition, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_d90b8eae04635c5dcd9661827286f61c
...
; encoding sigelt val ArrayUtils.copy_seq
...
; Starting query at ArrayUtils.fst(105,4-106,72)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (s1: FStar.Seq.Base.seq a) (s2: FStar.Seq.Base.seq a).
;   (*  - Could not prove post-condition
; *)
;   FStar.Seq.Base.length s1 <= FStar.Seq.Base.length s2 ==>
;   (forall (i: Prims.nat).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let is_prefix_of`
...
;; def=ArrayUtils.fst(105,4-105,26); use=ArrayUtils.fst(105,4-105,26)
(<= (BoxInt_proj_0 (FStar.Seq.Base.length @x0
@x1))
(BoxInt_proj_0 (FStar.Seq.Base.length @x0
@x2)))
...
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(105,4-106,72)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)

;; def=ArrayUtils.fst(106,21-106,34); use=ArrayUtils.fst(106,21-106,34)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (FStar.Seq.Base.length @x0
@x1)))
)

;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(106,21-106,71)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(106,52-106,53)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=ArrayUtils.fst(106,21-106,71)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=ArrayUtils.fst(106,21-106,71)
(= @x3
@x4)
)
...
;; def=Prims.fst(175,35-175,36); use=ArrayUtils.fst(106,21-106,71)
(= (FStar.Seq.Base.index @x0
@x1
@x3)
@x5)
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(106,70-106,71)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayUtils.is_prefix_of, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ArrayUtils.is_prefix_of; Namespace ArrayUtils
(assert (! 
;; def=ArrayUtils.fst(104,4-104,16); use=ArrayUtils.fst(104,4-104,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(FStar.Seq.Base.seq @x0)))
(HasType (ArrayUtils.is_prefix_of @x0
@x1
@x2)
Tm_type))
 

:pattern ((ArrayUtils.is_prefix_of @x0
@x1
@x2))
:qid typing_ArrayUtils.is_prefix_of))

:named typing_ArrayUtils.is_prefix_of))
;;;;;;;;;;;;;;;;Equation for ArrayUtils.is_prefix_of
;;; Fact-ids: Name ArrayUtils.is_prefix_of; Namespace ArrayUtils
(assert (! 
;; def=ArrayUtils.fst(104,4-104,16); use=ArrayUtils.fst(104,4-104,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (ArrayUtils.is_prefix_of @x0
@x1
@x2))

;; def=ArrayUtils.fst(105,4-106,72); use=ArrayUtils.fst(105,4-106,72)
(and 
;; def=ArrayUtils.fst(105,4-105,26); use=ArrayUtils.fst(105,4-105,26)
(<= (BoxInt_proj_0 (FStar.Seq.Base.length @x0
@x1))
...
;; def=ArrayUtils.fst(106,4-106,72); use=ArrayUtils.fst(106,4-106,72)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)
...
;; def=ArrayUtils.fst(106,39-106,71); use=ArrayUtils.fst(106,39-106,71)
(= (FStar.Seq.Base.index @x0
@x1
@x3)
(FStar.Seq.Base.index @x0
...
;;no pats
:qid equation_ArrayUtils.is_prefix_of.1))
)
)
...
@x1
@x2))
:qid equation_ArrayUtils.is_prefix_of))

:named equation_ArrayUtils.is_prefix_of))
;;;;;;;;;;;;;;;;Prop-typing for ArrayUtils.is_prefix_of
;;; Fact-ids: Name ArrayUtils.is_prefix_of; Namespace ArrayUtils
(assert (! 
;; def=ArrayUtils.fst(104,4-104,16); use=ArrayUtils.fst(104,4-104,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(FStar.Seq.Base.seq @x0)))
(Valid (Prims.subtype_of (ArrayUtils.is_prefix_of @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (ArrayUtils.is_prefix_of @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_ArrayUtils.is_prefix_of))

:named defn_equation_ArrayUtils.is_prefix_of))
(push) ;; push{2

; Starting query at ArrayUtils.fst(113,4-113,12)
...
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(109,24-109,56); use=ArrayUtils.fst(109,24-109,56)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c1711d8a7b0919288364d7fa4be66673 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_c1711d8a7b0919288364d7fa4be66673 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_c1711d8a7b0919288364d7fa4be66673))

:named refinement_kinding_Tm_refine_c1711d8a7b0919288364d7fa4be66673))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(109,24-109,56); use=ArrayUtils.fst(109,24-109,56)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c1711d8a7b0919288364d7fa4be66673 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Seq.Base.seq @x2))

;; def=ArrayUtils.fst(109,34-109,54); use=ArrayUtils.fst(109,34-109,54)
(Valid 
;; def=ArrayUtils.fst(109,34-109,54); use=ArrayUtils.fst(109,34-109,54)
(ArrayUtils.is_prefix_of @x2
@x3
@x1)
)
))
...
(Tm_refine_c1711d8a7b0919288364d7fa4be66673 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_c1711d8a7b0919288364d7fa4be66673))

:named refinement_interpretation_Tm_refine_c1711d8a7b0919288364d7fa4be66673))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c1711d8a7b0919288364d7fa4be66673
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(109,24-109,56); use=ArrayUtils.fst(109,24-109,56)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c1711d8a7b0919288364d7fa4be66673 @x0
@x1)))
(Valid (Prims.hasEq (FStar.Seq.Base.seq @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c1711d8a7b0919288364d7fa4be66673 @x0
@x1))))
:qid haseqTm_refine_c1711d8a7b0919288364d7fa4be66673))

:named haseqTm_refine_c1711d8a7b0919288364d7fa4be66673))
...
;;; Fact-ids: 
(assert (! 
;; def=ArrayUtils.fst(110,19-110,23); use=ArrayUtils.fst(113,4-113,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;   (s2: FStar.Seq.Base.seq a {ArrayUtils.is_prefix_of s1 s2})
;   (i: Prims.nat)
;   (j: Prims.nat{j >= i /\ j <= FStar.Seq.Base.length s1})
;   (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   (j >= i /\ j <= FStar.Seq.Base.length s1 ==> i <= j && j <= FStar.Seq.Base.length s1) /\
;   (forall (any_result: j: Prims.nat{j >= i /\ j <= FStar.Seq.Base.length s1}).
;       j == any_result ==>
;       (forall (any_result: FStar.Seq.Base.seq a).
;           FStar.Seq.Base.slice s1 i j == any_result ==>
;           j >= i /\ j <= FStar.Seq.Base.length s1 ==> i <= j && j <= FStar.Seq.Base.length s2))


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_is_prefix_of_slice`
...
(FStar.Seq.Base.seq @x0))
(HasType @x2
(Tm_refine_c1711d8a7b0919288364d7fa4be66673 @x0
@x1))
(HasType @x3
Prims.nat)
(HasType @x4
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(113,4-113,12)
(and (implies 
;; def=ArrayUtils.fst(109,72-109,100); use=ArrayUtils.fst(113,4-113,12)
(and 
;; def=ArrayUtils.fst(109,72-109,78); use=ArrayUtils.fst(113,4-113,12)
(>= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 @x3))


;; def=ArrayUtils.fst(109,82-109,100); use=ArrayUtils.fst(113,4-113,12)
(<= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 (FStar.Seq.Base.length @x0
@x1)))
)
...
;; def=FStar.Seq.Base.fsti(64,49-64,72); use=ArrayUtils.fst(113,4-113,12)
(and 
;; def=ArrayUtils.fst(109,66-109,67); use=ArrayUtils.fst(111,35-111,36)
(or label_1
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x3
@x4)))
...
;; def=ArrayUtils.fst(109,66-109,67); use=ArrayUtils.fst(111,35-111,36)
(or label_2
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x4
(FStar.Seq.Base.length @x0
@x1))))
)
)

;; def=Prims.fst(451,66-451,102); use=ArrayUtils.fst(113,4-113,12)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_21ba3780ecd4c31fe9f89ff8d60a5f28 @x3
@x0
...
;; def=FStar.Seq.Base.fsti(64,43-64,44); use=ArrayUtils.fst(113,4-113,12)
(= @x4
@x6)
)
...
;; def=Prims.fst(175,35-175,36); use=ArrayUtils.fst(113,4-113,12)
(= (FStar.Seq.Base.slice @x0
@x1
@x3
@x4)
...
;; def=FStar.Seq.Base.fsti(64,49-64,72); use=ArrayUtils.fst(113,4-113,12)
(and 
;; def=ArrayUtils.fst(109,66-109,67); use=ArrayUtils.fst(111,55-111,56)
(or label_3
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x3
@x4)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayUtils.lemma_is_prefix_of_slice, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_ArrayUtils.is_prefix_of, equation_Prims.nat, int_inversion, primitive_Prims.op_LessThanOrEqual, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_21ba3780ecd4c31fe9f89ff8d60a5f28, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_c1711d8a7b0919288364d7fa4be66673, typing_FStar.Seq.Base.length
...
; Starting query at ArrayUtils.fst(115,7-117,108)
...
; Encoding query formula : forall (a: Type) (b: Type) (f: (_: a -> b)) (s: FStar.Seq.Base.seq a).
;   (*  - Subtyping check failed
;   - Expected type Type got type Type
; *)
;   forall (r: FStar.Seq.Base.seq b).
;     Prims.hasEq Prims.nat /\
;     (FStar.Seq.Base.length s = FStar.Seq.Base.length r ==>
;       (forall (i: Prims.nat).
;           i < FStar.Seq.Base.length s ==>
;           i < FStar.Seq.Base.length r /\
;           (forall (any_result: Prims.nat).
;               i == any_result ==>
;               (forall (any_result: b).
;                   FStar.Seq.Base.index r i == any_result ==> i < FStar.Seq.Base.length s))))


; Context: While encoding a query
; While typechecking the top-level declaration `val ArrayUtils.seq_map`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(115,7-117,108)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=dummy(0,0-0,0); use=ArrayUtils.fst(116,5-117,108)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.Seq.Base.seq @x1))

;; def=dummy(0,0-0,0); use=ArrayUtils.fst(117,14-117,106)
(and 
;; def=Prims.fst(73,23-73,30); use=ArrayUtils.fst(117,14-117,20)
(or label_1
...
;; def=Prims.fst(459,77-459,89); use=ArrayUtils.fst(117,54-117,105)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(117,83-117,84)
(or label_2

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(117,83-117,84)
(< (BoxInt_proj_0 @x5)
(BoxInt_proj_0 (FStar.Seq.Base.length @x1
@x4)))
)


;; def=Prims.fst(451,66-451,102); use=ArrayUtils.fst(117,54-117,105)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=ArrayUtils.fst(117,54-117,105)
(= @x5
@x6)
)
...
;; def=Prims.fst(175,35-175,36); use=ArrayUtils.fst(117,54-117,105)
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=ArrayUtils.fst(117,103-117,104)
(or label_3
