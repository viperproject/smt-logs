...
; Internals for ImmutableSTwHeaps


; encoding sigelt val ImmutableSTwHeaps.sel


; <Start encoding val ImmutableSTwHeaps.sel>

(declare-fun ImmutableSTwHeaps.sel (Term Term Term) Term)
(declare-fun Tm_refine_fcc3ae3430dace306efd930c647e1fda (Term Term Term) Term)
;;;;;;;;;;;;;;;;h: FStar.Monotonic.Heap.heap -> r: FStar.Heap.ref 'a -> x: 'a{x == FStar.Monotonic.Heap.sel h r}
(declare-fun Tm_arrow_215db81a337be6fd0b0d359ef0ba5a58 () Term)
(declare-fun ImmutableSTwHeaps.sel@tok () Term)


; </end encoding val ImmutableSTwHeaps.sel>


; encoding sigelt val ImmutableSTwHeaps.upd


; <Start encoding val ImmutableSTwHeaps.upd>

(declare-fun ImmutableSTwHeaps.upd (Term Term Term Term) Term)
(declare-fun Tm_refine_ec74995abaf3afbf48bfcaea8401c27c (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;h: FStar.Monotonic.Heap.heap -> r: FStar.Heap.ref 'a -> v: 'a   -> h': FStar.Monotonic.Heap.heap{h' == FStar.Monotonic.Heap.upd h r v}
(declare-fun Tm_arrow_ec2ab6285a6184d8e67f4fb6829db71a () Term)
(declare-fun ImmutableSTwHeaps.upd@tok () Term)


; </end encoding val ImmutableSTwHeaps.upd>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ImmutableSTwHeaps.sel; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(23,11-23,14); use=ImmutableSTwHeaps.fst(23,11-23,14)
...
(HasType @x2
(FStar.Heap.ref @x0)))
(HasType (ImmutableSTwHeaps.sel @x0
@x1
@x2)
(Tm_refine_fcc3ae3430dace306efd930c647e1fda @x0
@x1
@x2)))
 

:pattern ((ImmutableSTwHeaps.sel @x0
@x1
@x2))
:qid typing_ImmutableSTwHeaps.sel))

:named typing_ImmutableSTwHeaps.sel))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name ImmutableSTwHeaps.sel; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(23,42-23,67); use=ImmutableSTwHeaps.fst(23,42-23,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_fcc3ae3430dace306efd930c647e1fda @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_fcc3ae3430dace306efd930c647e1fda @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_fcc3ae3430dace306efd930c647e1fda))

:named refinement_kinding_Tm_refine_fcc3ae3430dace306efd930c647e1fda))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_fcc3ae3430dace306efd930c647e1fda @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=ImmutableSTwHeaps.fst(23,48-23,65); use=ImmutableSTwHeaps.fst(23,48-23,65)
(= @x1
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_fcc3ae3430dace306efd930c647e1fda))

:named refinement_interpretation_Tm_refine_fcc3ae3430dace306efd930c647e1fda))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! 
...
:qid int_inversion))
:named int_inversion))
;;;;;;;;;;;;;;;;haseq for Tm_refine_fcc3ae3430dace306efd930c647e1fda
;;; Fact-ids: Name ImmutableSTwHeaps.sel; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(23,42-23,67); use=ImmutableSTwHeaps.fst(23,42-23,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_fcc3ae3430dace306efd930c647e1fda @x0
@x1
@x2)))
(Valid (Prims.hasEq @x0)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_fcc3ae3430dace306efd930c647e1fda @x0
@x1
@x2))))
:qid haseqTm_refine_fcc3ae3430dace306efd930c647e1fda))

:named haseqTm_refine_fcc3ae3430dace306efd930c647e1fda))
...
; Starting query at ImmutableSTwHeaps.fst(30,2-30,79)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_6e28e2a2794eb58985e45828839900d6 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ImmutableSTwHeaps.fst(23,43-23,65); use=ImmutableSTwHeaps.fst(30,42-30,79)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_6e28e2a2794eb58985e45828839900d6 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_6e28e2a2794eb58985e45828839900d6 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_6e28e2a2794eb58985e45828839900d6))

:named refinement_kinding_Tm_refine_6e28e2a2794eb58985e45828839900d6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ImmutableSTwHeaps.fst(23,43-23,65); use=ImmutableSTwHeaps.fst(30,42-30,79)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6e28e2a2794eb58985e45828839900d6 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=ImmutableSTwHeaps.fst(23,48-23,65); use=ImmutableSTwHeaps.fst(30,59-30,74)
(or 
;; def=ImmutableSTwHeaps.fst(23,48-23,65); use=ImmutableSTwHeaps.fst(30,59-30,62)
(= @x1
(FStar.Monotonic.Heap.sel @x2
(FStar.Heap.trivial_preorder @x2)
@x3
...
;; def=ImmutableSTwHeaps.fst(23,48-23,65); use=ImmutableSTwHeaps.fst(30,71-30,74)
(= @x1
(FStar.Monotonic.Heap.sel @x2
(FStar.Heap.trivial_preorder @x2)
@x5
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_6e28e2a2794eb58985e45828839900d6))

:named refinement_interpretation_Tm_refine_6e28e2a2794eb58985e45828839900d6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6e28e2a2794eb58985e45828839900d6
;;; Fact-ids: 
(assert (! 
;; def=ImmutableSTwHeaps.fst(23,43-23,65); use=ImmutableSTwHeaps.fst(30,42-30,79)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6e28e2a2794eb58985e45828839900d6 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq @x0)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_6e28e2a2794eb58985e45828839900d6 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_6e28e2a2794eb58985e45828839900d6))

:named haseqTm_refine_6e28e2a2794eb58985e45828839900d6))

; Encoding query formula : forall (h0: FStar.Monotonic.Heap.heap) (h1: FStar.Monotonic.Heap.heap).
;   (*  - Could not prove post-condition
; *)
;   forall (a: Type0).
;     (*  - Could not prove post-condition
; *)
;     forall (r: FStar.Heap.ref a).
;       FStar.Monotonic.Heap.contains h0 r ==>
;       FStar.Monotonic.Heap.contains h1 r ==>
;       (ImmutableSTwHeaps.sel h0 r == FStar.Monotonic.Heap.sel h0 r ==>
;         ImmutableSTwHeaps.sel h0 r == FStar.Monotonic.Heap.sel h0 r \/
;         ImmutableSTwHeaps.sel h0 r == FStar.Monotonic.Heap.sel h1 r) /\
;       (forall (return_val:
;           x: a{x == FStar.Monotonic.Heap.sel h0 r \/ x == FStar.Monotonic.Heap.sel h1 r}).
;           return_val == ImmutableSTwHeaps.sel h0 r ==>
;           ImmutableSTwHeaps.sel h1 r == FStar.Monotonic.Heap.sel h1 r ==>
;           ImmutableSTwHeaps.sel h1 r == FStar.Monotonic.Heap.sel h0 r \/
;           ImmutableSTwHeaps.sel h1 r == FStar.Monotonic.Heap.sel h1 r)
...
;; def=dummy(0,0-0,0); use=ImmutableSTwHeaps.fst(30,2-30,79)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Tm_type)

;; def=dummy(0,0-0,0); use=ImmutableSTwHeaps.fst(30,11-30,79)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(FStar.Heap.ref @x2))

;; def=ImmutableSTwHeaps.fst(30,24-30,37); use=ImmutableSTwHeaps.fst(30,24-30,37)
(Valid 
;; def=ImmutableSTwHeaps.fst(30,24-30,37); use=ImmutableSTwHeaps.fst(30,24-30,37)
...
;; def=ImmutableSTwHeaps.fst(30,42-30,55); use=ImmutableSTwHeaps.fst(30,42-30,55)
(Valid 
;; def=ImmutableSTwHeaps.fst(30,42-30,55); use=ImmutableSTwHeaps.fst(30,42-30,55)
(FStar.Monotonic.Heap.contains @x2
(FStar.Heap.trivial_preorder @x2)
...
;; def=Prims.fst(459,77-459,89); use=ImmutableSTwHeaps.fst(30,42-30,79)
(and (implies 
;; def=ImmutableSTwHeaps.fst(23,48-23,65); use=ImmutableSTwHeaps.fst(30,59-30,67)
(= (ImmutableSTwHeaps.sel @x2
@x0
@x3)
(FStar.Monotonic.Heap.sel @x2
(FStar.Heap.trivial_preorder @x2)
...
;; def=Prims.fst(356,2-356,58); use=ImmutableSTwHeaps.fst(30,42-30,79)
(forall ((@x4 Term))
...
;; def=Prims.fst(356,26-356,41); use=ImmutableSTwHeaps.fst(30,42-30,79)
(= @x4
(ImmutableSTwHeaps.sel @x2
@x0
@x3))
...
;; def=ImmutableSTwHeaps.fst(23,48-23,65); use=ImmutableSTwHeaps.fst(30,71-30,79)
(= (ImmutableSTwHeaps.sel @x2
@x1
@x3)
(FStar.Monotonic.Heap.sel @x2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableSTwHeaps.heap_rel, 1)
; STATUS: unsat
...
(declare-fun ImmutableSTwHeaps.heap_rel (Term Term) Term)
...
(declare-fun ImmutableSTwHeaps.heap_rel@tok () Term)
...
(declare-fun ImmutableSTwHeaps.ist_pre (Term) Term)

(declare-fun ImmutableSTwHeaps.ist_pre@tok () Term)
...
(declare-fun ImmutableSTwHeaps.ist_post (Term Term) Term)

(declare-fun ImmutableSTwHeaps.ist_post@tok () Term)
...
(declare-fun ImmutableSTwHeaps.ist_wp (Term Term) Term)

(declare-fun ImmutableSTwHeaps.ist_wp@tok () Term)
;;;;;;;;;;;;;;;;_: ist_post state a -> ist_pre state
(declare-fun Tm_arrow_7c2860170f8d5f37a12bbbe2518db71b (Term Term) Term)
...
(declare-fun ImmutableSTwHeaps.lift_div_istate (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;state: Type ->     rel: FStar.Preorder.preorder state ->     a: Type ->     wp: Prims.pure_wp a ->     p: ist_post state a ->     s: state   -> Prims.pure_pre
(declare-fun Tm_arrow_49cf4c61bead67d006c4d417eea7691a () Term)
(declare-fun ImmutableSTwHeaps.lift_div_istate@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ImmutableSTwHeaps.heap_rel; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(29,4-29,12); use=ImmutableSTwHeaps.fst(29,4-29,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
FStar.Monotonic.Heap.heap)
(HasType @x1
FStar.Monotonic.Heap.heap))
(HasType (ImmutableSTwHeaps.heap_rel @x0
@x1)
Prims.logical))
 

:pattern ((ImmutableSTwHeaps.heap_rel @x0
@x1))
:qid typing_ImmutableSTwHeaps.heap_rel))

:named typing_ImmutableSTwHeaps.heap_rel))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name ImmutableSTwHeaps.heap_rel; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(29,4-29,12); use=ImmutableSTwHeaps.fst(29,4-29,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT ImmutableSTwHeaps.heap_rel@tok
@x0)
@x1)
(ImmutableSTwHeaps.heap_rel @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT ImmutableSTwHeaps.heap_rel@tok
@x0)
@x1))
:qid token_correspondence_ImmutableSTwHeaps.heap_rel))

:named token_correspondence_ImmutableSTwHeaps.heap_rel))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9
;;; Fact-ids: Name ImmutableSTwHeaps.heap_rel; Namespace ImmutableSTwHeaps
(assert (! (HasType Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9
Tm_type)
:named kinding_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name ImmutableSTwHeaps.heap_rel; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(29,4-29,12); use=ImmutableSTwHeaps.fst(29,4-29,12)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType ImmutableSTwHeaps.heap_rel@tok
Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))
...
@x1)
@x2)
(ImmutableSTwHeaps.heap_rel @x1
@x2))
 

:pattern ((ImmutableSTwHeaps.heap_rel @x1
@x2))
:qid function_token_typing_ImmutableSTwHeaps.heap_rel.1))
)
 

:pattern ((ApplyTT @x0
ImmutableSTwHeaps.heap_rel@tok))
:qid function_token_typing_ImmutableSTwHeaps.heap_rel))

:named function_token_typing_ImmutableSTwHeaps.heap_rel))
;;;;;;;;;;;;;;;;Equation for ImmutableSTwHeaps.heap_rel
;;; Fact-ids: Name ImmutableSTwHeaps.heap_rel; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(29,4-29,12); use=ImmutableSTwHeaps.fst(29,4-29,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (ImmutableSTwHeaps.heap_rel @x0
@x1))

;; def=ImmutableSTwHeaps.fst(30,2-30,79); use=ImmutableSTwHeaps.fst(30,2-30,79)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Tm_type)
(HasType @x3
...
;; def=ImmutableSTwHeaps.fst(30,42-30,79); use=ImmutableSTwHeaps.fst(30,42-30,79)
(and 
;; def=ImmutableSTwHeaps.fst(30,42-30,55); use=ImmutableSTwHeaps.fst(30,42-30,55)
(Valid 
;; def=ImmutableSTwHeaps.fst(30,42-30,55); use=ImmutableSTwHeaps.fst(30,42-30,55)
...
;; def=ImmutableSTwHeaps.fst(30,59-30,79); use=ImmutableSTwHeaps.fst(30,59-30,79)
(= (ImmutableSTwHeaps.sel @x2
@x0
@x3)
(ImmutableSTwHeaps.sel @x2
...
;;no pats
:qid equation_ImmutableSTwHeaps.heap_rel.1))
)
 

:pattern ((ImmutableSTwHeaps.heap_rel @x0
@x1))
:qid equation_ImmutableSTwHeaps.heap_rel))

:named equation_ImmutableSTwHeaps.heap_rel))
;;;;;;;;;;;;;;;;Prop-typing for ImmutableSTwHeaps.heap_rel
;;; Fact-ids: Name ImmutableSTwHeaps.heap_rel; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(29,4-29,12); use=ImmutableSTwHeaps.fst(29,4-29,12)
(forall ((@x0 Term) (@x1 Term))
...
(HasType @x1
FStar.Monotonic.Heap.heap))
(Valid (Prims.subtype_of (ImmutableSTwHeaps.heap_rel @x0
@x1)
Prims.unit)))
 

:pattern ((Prims.subtype_of (ImmutableSTwHeaps.heap_rel @x0
@x1)
Prims.unit))
:qid defn_equation_ImmutableSTwHeaps.heap_rel))

:named defn_equation_ImmutableSTwHeaps.heap_rel))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name ImmutableSTwHeaps.heap_rel; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(29,17-29,31); use=ImmutableSTwHeaps.fst(29,17-30,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9)
...
@x1
Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))
:qid ImmutableSTwHeaps_pre_typing_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))

:named ImmutableSTwHeaps_pre_typing_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9
;;; Fact-ids: Name ImmutableSTwHeaps.heap_rel; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(29,17-29,31); use=ImmutableSTwHeaps.fst(29,17-30,10)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid ImmutableSTwHeaps_interpretation_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ImmutableSTwHeaps_interpretation_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))
:qid ImmutableSTwHeaps_interpretation_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))

:named ImmutableSTwHeaps_interpretation_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))
(push) ;; push{2
...
ImmutableSTwHeaps.heap_rel@tok))
:named @kick_partial_app_932ed5fac9f963500da79e1367b20cf0))

; Encoding query formula : Prims.auto_squash (FStar.Preorder.preorder_rel ImmutableSTwHeaps.heap_rel)
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Preorder.fst(33,40-33,56); use=ImmutableSTwHeaps.fst(61,48-61,56)
(or label_1

;; def=FStar.Preorder.fst(33,40-33,56); use=ImmutableSTwHeaps.fst(61,48-61,56)
(Valid 
;; def=FStar.Preorder.fst(33,40-33,56); use=ImmutableSTwHeaps.fst(61,48-61,56)
(FStar.Preorder.preorder_rel FStar.Monotonic.Heap.heap
ImmutableSTwHeaps.heap_rel@tok)
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableSTwHeaps.0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_ImmutableSTwHeaps.heap_rel, token_correspondence_ImmutableSTwHeaps.heap_rel
...
; encoding sigelt effect IST a pre post = ImmutableSTwHeaps.ISTATE a


; <Skipped effect IST a pre post = ImmutableSTwHeaps.ISTATE a/>
...
; Starting query at ImmutableSTwHeaps.fst(75,58-75,78)
...
ImmutableSTwHeaps.heap_rel@tok))
:named @kick_partial_app_932ed5fac9f963500da79e1367b20cf0))
(declare-fun Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5
Tm_type)
:named refinement_kinding_Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ImmutableSTwHeaps.fst(75,18-75,55); use=ImmutableSTwHeaps.fst(75,18-75,55)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5)
(and (HasTypeFuel @u0
@x1
(FStar.Preorder.predicate FStar.Monotonic.Heap.heap))

;; def=ImmutableSTwHeaps.fst(75,36-75,53); use=ImmutableSTwHeaps.fst(75,36-75,53)
(Valid 
;; def=ImmutableSTwHeaps.fst(75,36-75,53); use=ImmutableSTwHeaps.fst(75,36-75,53)
(FStar.Preorder.stable FStar.Monotonic.Heap.heap
@x1
ImmutableSTwHeaps.heap_rel@tok)
)
))
...
@x1
Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5))
:qid refinement_interpretation_Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5))

:named refinement_interpretation_Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5))
;;;;;;;;;;;;;;;;haseq for Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5))
(Valid (Prims.hasEq (FStar.Preorder.predicate FStar.Monotonic.Heap.heap))))
:named haseqTm_refine_140bbe8c40d15fc9a6dc525f652ea8d5))


; Encoding query formula : forall (p:
;   FStar.Preorder.predicate FStar.Monotonic.Heap.heap
;     {FStar.Preorder.stable p ImmutableSTwHeaps.heap_rel}).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash (FStar.Preorder.preorder_rel ImmutableSTwHeaps.heap_rel)
...
;; def=FStar.Preorder.fst(33,40-33,56); use=ImmutableSTwHeaps.fst(75,68-75,76)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableSTwHeaps.ist_witnessed, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_ImmutableSTwHeaps.heap_rel, token_correspondence_ImmutableSTwHeaps.heap_rel
...
; Starting query at ImmutableSTwHeaps.fst(75,0-75,78)
...
; Encoding query formula : forall (p: FStar.Preorder.predicate FStar.Monotonic.Heap.heap).
;   (*  - Subtyping check failed
;   - Expected type
;       rel:
;       FStar.Preorder.relation FStar.Monotonic.Heap.heap
;         {FStar.Preorder.preorder_rel rel}
;     got type
;       h0: FStar.Monotonic.Heap.heap -> h1: FStar.Monotonic.Heap.heap
;         -> Prims.logical
; *)
;   Prims.auto_squash (FStar.Preorder.preorder_rel ImmutableSTwHeaps.heap_rel)
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ImmutableSTwHeaps.fst(75,58-75,78)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate FStar.Monotonic.Heap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=ImmutableSTwHeaps.fst(75,45-75,53)
(or label_1

;; def=FStar.Preorder.fst(35,53-35,69); use=ImmutableSTwHeaps.fst(75,58-75,78)
(Valid 
;; def=FStar.Preorder.fst(35,53-35,69); use=ImmutableSTwHeaps.fst(75,58-75,78)
(FStar.Preorder.preorder_rel FStar.Monotonic.Heap.heap
ImmutableSTwHeaps.heap_rel@tok)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableSTwHeaps.ist_witnessed, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_ImmutableSTwHeaps.heap_rel, token_correspondence_ImmutableSTwHeaps.heap_rel
...
(declare-fun Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5 () Term)
(declare-fun ImmutableSTwHeaps.ist_witnessed (Term) Term)


;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate FStar.Monotonic.Heap.heap {FStar.Preorder.stable p heap_rel} -> Type
(declare-fun Tm_arrow_93a63e0261f0c1a59ba152454014fb83 () Term)
(declare-fun ImmutableSTwHeaps.ist_witnessed@tok () Term)
...
; encoding sigelt val ImmutableSTwHeaps.ist_get


; <Start encoding val ImmutableSTwHeaps.ist_get>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableSTwHeaps.ist_get (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableSTwHeaps.ist_get@tok () Term)

; </end encoding val ImmutableSTwHeaps.ist_get>


; encoding sigelt val ImmutableSTwHeaps.ist_put


; <Start encoding val ImmutableSTwHeaps.ist_put>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableSTwHeaps.ist_put (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableSTwHeaps.ist_put@tok () Term)

; </end encoding val ImmutableSTwHeaps.ist_put>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ImmutableSTwHeaps.ist_witnessed; Namespace ImmutableSTwHeaps
(assert (! (HasType Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5
Tm_type)
:named refinement_kinding_Tm_refine_140bbe8c40d15fc9a6dc525f652ea8d5))
;;;;;;;;;;;;;;;;refinement_interpretation
...
; Starting query at ImmutableSTwHeaps.fst(85,7-86,81)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val ImmutableSTwHeaps.ist_witness`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ImmutableSTwHeaps.fst(85,25-86,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate FStar.Monotonic.Heap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=ImmutableSTwHeaps.fst(85,51-85,59)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableSTwHeaps.ist_witness, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_ImmutableSTwHeaps.heap_rel, token_correspondence_ImmutableSTwHeaps.heap_rel
...
; encoding sigelt val ImmutableSTwHeaps.ist_witness


; <Start encoding val ImmutableSTwHeaps.ist_witness>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableSTwHeaps.ist_witness (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableSTwHeaps.ist_witness@tok () Term)

; </end encoding val ImmutableSTwHeaps.ist_witness>

(push) ;; push{2

; Starting query at ImmutableSTwHeaps.fst(88,7-89,80)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val ImmutableSTwHeaps.ist_recall`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ImmutableSTwHeaps.fst(88,25-89,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate FStar.Monotonic.Heap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=ImmutableSTwHeaps.fst(88,51-88,59)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableSTwHeaps.ist_recall, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_ImmutableSTwHeaps.heap_rel, token_correspondence_ImmutableSTwHeaps.heap_rel
...
; encoding sigelt val ImmutableSTwHeaps.ist_recall


; <Start encoding val ImmutableSTwHeaps.ist_recall>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableSTwHeaps.ist_recall (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableSTwHeaps.ist_recall@tok () Term)

; </end encoding val ImmutableSTwHeaps.ist_recall>


; encoding sigelt val ImmutableSTwHeaps.gen_ref


; <Start encoding val ImmutableSTwHeaps.gen_ref>

(declare-fun ImmutableSTwHeaps.gen_ref (Term Term) Term)
(declare-fun Tm_refine_012d464f8c2a08388dffaf30b5904708 (Term Term) Term)
;;;;;;;;;;;;;;;;h: FStar.Monotonic.Heap.heap -> r: FStar.Heap.ref a {FStar.Monotonic.Heap.unused_in r h}
(declare-fun Tm_arrow_49e16cfd6ed566645e6dc7b4ec0467a9 () Term)
(declare-fun ImmutableSTwHeaps.gen_ref@tok () Term)


; </end encoding val ImmutableSTwHeaps.gen_ref>
...
(declare-fun ImmutableSTwHeaps.st_pre () Term)
...
(declare-fun ImmutableSTwHeaps.st_post (Term) Term)

(declare-fun ImmutableSTwHeaps.st_post@tok () Term)
;;;;;;;;;;;;;;;;_: a -> _: FStar.Monotonic.Heap.heap -> Type
(declare-fun Tm_arrow_ea3a67cd8ad73948b9383971b40f6864 (Term) Term)
...
(declare-fun ImmutableSTwHeaps.st_wp (Term) Term)

(declare-fun ImmutableSTwHeaps.st_wp@tok () Term)
;;;;;;;;;;;;;;;;_: st_post a -> st_pre
(declare-fun Tm_arrow_86e20ac9cbc8e1a8cf2373e749c86bd4 (Term) Term)

; </end encoding let st_wp>


; encoding sigelt effect ImmutableST a pre post = ImmutableSTwHeaps.IST a


; <Skipped effect ImmutableST a pre post = ImmutableSTwHeaps.IST a/>


; encoding sigelt val ImmutableSTwHeaps.alloc


; <Skipped val ImmutableSTwHeaps.alloc/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ImmutableSTwHeaps.upd; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(24,11-24,14); use=ImmutableSTwHeaps.fst(24,11-24,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x3
@x0))
(HasType (ImmutableSTwHeaps.upd @x0
@x1
@x2
@x3)
(Tm_refine_ec74995abaf3afbf48bfcaea8401c27c @x0
@x1
@x2
@x3)))
 

:pattern ((ImmutableSTwHeaps.upd @x0
@x1
@x2
@x3))
:qid typing_ImmutableSTwHeaps.upd))

:named typing_ImmutableSTwHeaps.upd))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ImmutableSTwHeaps.gen_ref; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(98,11-98,18); use=ImmutableSTwHeaps.fst(98,11-98,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
FStar.Monotonic.Heap.heap))
(HasType (ImmutableSTwHeaps.gen_ref @x0
@x1)
(Tm_refine_012d464f8c2a08388dffaf30b5904708 @x0
@x1)))
 

:pattern ((ImmutableSTwHeaps.gen_ref @x0
@x1))
:qid typing_ImmutableSTwHeaps.gen_ref))

:named typing_ImmutableSTwHeaps.gen_ref))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name ImmutableSTwHeaps.upd; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(24,50-24,81); use=ImmutableSTwHeaps.fst(24,50-24,81)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_ec74995abaf3afbf48bfcaea8401c27c @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_ec74995abaf3afbf48bfcaea8401c27c @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_ec74995abaf3afbf48bfcaea8401c27c))

:named refinement_kinding_Tm_refine_ec74995abaf3afbf48bfcaea8401c27c))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name ImmutableSTwHeaps.gen_ref; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(98,46-98,72); use=ImmutableSTwHeaps.fst(98,46-98,72)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_012d464f8c2a08388dffaf30b5904708 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_012d464f8c2a08388dffaf30b5904708 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_012d464f8c2a08388dffaf30b5904708))

:named refinement_kinding_Tm_refine_012d464f8c2a08388dffaf30b5904708))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name ImmutableSTwHeaps.upd; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(24,50-24,81); use=ImmutableSTwHeaps.fst(24,50-24,81)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ec74995abaf3afbf48bfcaea8401c27c @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=ImmutableSTwHeaps.fst(24,59-24,79); use=ImmutableSTwHeaps.fst(24,59-24,79)
(= @x1
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_ec74995abaf3afbf48bfcaea8401c27c))

:named refinement_interpretation_Tm_refine_ec74995abaf3afbf48bfcaea8401c27c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pure_post'; Namespace Prims
(assert (! 
;; def=Prims.fst(315,31-315,40); use=Prims.fst(315,31-315,40)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_012d464f8c2a08388dffaf30b5904708 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Heap.ref @x2))

;; def=ImmutableSTwHeaps.fst(98,55-98,70); use=ImmutableSTwHeaps.fst(98,55-98,70)
(Valid 
;; def=ImmutableSTwHeaps.fst(98,55-98,70); use=ImmutableSTwHeaps.fst(98,55-98,70)
...
(Tm_refine_012d464f8c2a08388dffaf30b5904708 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_012d464f8c2a08388dffaf30b5904708))

:named refinement_interpretation_Tm_refine_012d464f8c2a08388dffaf30b5904708))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_ec74995abaf3afbf48bfcaea8401c27c
;;; Fact-ids: Name ImmutableSTwHeaps.upd; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(24,50-24,81); use=ImmutableSTwHeaps.fst(24,50-24,81)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ec74995abaf3afbf48bfcaea8401c27c @x0
@x1
@x2
@x3)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_ec74995abaf3afbf48bfcaea8401c27c @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_ec74995abaf3afbf48bfcaea8401c27c))

:named haseqTm_refine_ec74995abaf3afbf48bfcaea8401c27c))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_012d464f8c2a08388dffaf30b5904708
;;; Fact-ids: Name ImmutableSTwHeaps.gen_ref; Namespace ImmutableSTwHeaps
(assert (! 
;; def=ImmutableSTwHeaps.fst(98,46-98,72); use=ImmutableSTwHeaps.fst(98,46-98,72)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_012d464f8c2a08388dffaf30b5904708 @x0
@x1)))
(Valid (Prims.hasEq (FStar.Heap.ref @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_012d464f8c2a08388dffaf30b5904708 @x0
@x1))))
:qid haseqTm_refine_012d464f8c2a08388dffaf30b5904708))

:named haseqTm_refine_012d464f8c2a08388dffaf30b5904708))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Prims.prop
Tm_type)
...
; Starting query at ImmutableSTwHeaps.fst(125,16-129,3)
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap (FStar.Heap.ref a))
;     (h: FStar.Monotonic.Heap.heap).
;     (forall (x: FStar.Heap.ref a) (s1: FStar.Monotonic.Heap.heap).
;         FStar.Monotonic.Heap.unused_in x h /\ FStar.Monotonic.Heap.contains s1 x /\
;         s1 == ImmutableSTwHeaps.upd h x x ==>
;         p x s1) ==>
;     (forall (x: FStar.Monotonic.Heap.heap) (s1: FStar.Monotonic.Heap.heap).
;         h == x /\ x == s1 ==>
;         ImmutableSTwHeaps.heap_rel s1 (ImmutableSTwHeaps.upd x (ImmutableSTwHeaps.gen_ref x) x) /\
;         (forall (x: Prims.unit) (s1: FStar.Monotonic.Heap.heap).
;             ImmutableSTwHeaps.heap_rel s1 (ImmutableSTwHeaps.upd x (ImmutableSTwHeaps.gen_ref x) x) /\
;             s1 == ImmutableSTwHeaps.upd x (ImmutableSTwHeaps.gen_ref x) x ==>
;             p (ImmutableSTwHeaps.gen_ref x) s1))
...
;; def=ImmutableSTwHeaps.fst(70,39-70,88); use=ImmutableSTwHeaps.fst(125,16-129,3)
(forall ((@x4 Term) (@x5 Term))
...
;; def=ImmutableSTwHeaps.fst(122,48-122,64); use=ImmutableSTwHeaps.fst(125,16-129,3)
(or label_3
...
;; def=ImmutableSTwHeaps.fst(123,13-123,26); use=ImmutableSTwHeaps.fst(125,16-129,3)
(or label_4
...
;; def=ImmutableSTwHeaps.fst(124,6-124,22); use=ImmutableSTwHeaps.fst(125,16-129,3)
(or label_5

;; def=ImmutableSTwHeaps.fst(124,6-124,22); use=ImmutableSTwHeaps.fst(125,16-129,3)
(= @x5
(ImmutableSTwHeaps.upd @x0
@x3
@x4
@x1))
)
...
;; def=ImmutableSTwHeaps.fst(70,81-70,87); use=ImmutableSTwHeaps.fst(125,16-129,3)
(Valid 
;; def=ImmutableSTwHeaps.fst(70,81-70,87); use=ImmutableSTwHeaps.fst(125,16-129,3)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=ImmutableSTwHeaps.fst(70,39-70,88); use=ImmutableSTwHeaps.fst(126,10-126,17)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
FStar.Monotonic.Heap.heap)
(HasType @x5
...
;; def=ImmutableSTwHeaps.fst(80,75-80,82); use=ImmutableSTwHeaps.fst(126,10-126,17)
(= @x3
@x4)


;; def=ImmutableSTwHeaps.fst(80,86-80,93); use=ImmutableSTwHeaps.fst(126,10-126,17)
(= @x4
@x5)
)

;; def=ImmutableSTwHeaps.fst(70,29-70,88); use=ImmutableSTwHeaps.fst(128,2-128,9)
(and 
;; def=ImmutableSTwHeaps.fst(83,31-83,44); use=ImmutableSTwHeaps.fst(128,2-128,9)
(or label_6

;; def=ImmutableSTwHeaps.fst(83,31-83,44); use=ImmutableSTwHeaps.fst(128,2-128,9)
(Valid 
;; def=ImmutableSTwHeaps.fst(83,31-83,44); use=ImmutableSTwHeaps.fst(128,2-128,9)
(ImmutableSTwHeaps.heap_rel @x5
(ImmutableSTwHeaps.upd @x0
@x4
(ImmutableSTwHeaps.gen_ref @x0
@x4)
@x1))
)
)
...
;; def=ImmutableSTwHeaps.fst(70,39-70,88); use=ImmutableSTwHeaps.fst(128,2-128,9)
...
;; def=ImmutableSTwHeaps.fst(83,62-83,69); use=ImmutableSTwHeaps.fst(128,2-128,9)
(= @x7
(ImmutableSTwHeaps.upd @x0
@x4
(ImmutableSTwHeaps.gen_ref @x0
...
;; def=FStar.Pervasives.fsti(463,24-463,34); use=ImmutableSTwHeaps.fst(125,16-129,3)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=ImmutableSTwHeaps.fst(125,16-129,3)
(ApplyTT (ApplyTT @x2
(ImmutableSTwHeaps.gen_ref @x0
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableSTwHeaps.alloc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Heap.ref, equation_FStar.Heap.trivial_preorder, equation_FStar.Monotonic.Heap.modifies, equation_FStar.Monotonic.Heap.modifies_t, equation_ImmutableSTwHeaps.heap_rel, lemma_FStar.Monotonic.Heap.lemma_contains_implies_used, lemma_FStar.Monotonic.Heap.lemma_distinct_addrs_unused, lemma_FStar.Monotonic.Heap.lemma_sel_upd2, lemma_FStar.Monotonic.Heap.lemma_unused_upd_modifies, lemma_FStar.Monotonic.Heap.lemma_upd_contains, refinement_interpretation_Tm_refine_012d464f8c2a08388dffaf30b5904708, refinement_interpretation_Tm_refine_ec74995abaf3afbf48bfcaea8401c27c, refinement_interpretation_Tm_refine_fcc3ae3430dace306efd930c647e1fda, typing_FStar.Heap.trivial_preorder, typing_ImmutableSTwHeaps.gen_ref, typing_ImmutableSTwHeaps.sel, typing_ImmutableSTwHeaps.upd
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableSTwHeaps.alloc (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableSTwHeaps.alloc@tok () Term)

; </end encoding let alloc>


; encoding sigelt val ImmutableSTwHeaps.read


; <Skipped val ImmutableSTwHeaps.read/>

(push) ;; push{2

; Starting query at ImmutableSTwHeaps.fst(137,15-139,9)
...
; Encoding query formula : forall (a: Type) (r: FStar.Heap.ref a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap a) (h: FStar.Monotonic.Heap.heap).
;     (forall (x: a) (s1: FStar.Monotonic.Heap.heap).
;         h == s1 /\ x == ImmutableSTwHeaps.sel s1 r ==> p x s1) ==>
;     (forall (x: FStar.Monotonic.Heap.heap) (s1: FStar.Monotonic.Heap.heap).
;         h == x /\ x == s1 ==> p (ImmutableSTwHeaps.sel x r) s1)
...
;; def=ImmutableSTwHeaps.fst(70,39-70,88); use=ImmutableSTwHeaps.fst(137,15-139,9)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (or label_1
(HasType @x4
@x0))
...
;; def=ImmutableSTwHeaps.fst(135,41-135,49); use=ImmutableSTwHeaps.fst(137,15-139,9)
(or label_3
...
;; def=ImmutableSTwHeaps.fst(136,6-136,19); use=ImmutableSTwHeaps.fst(137,15-139,9)
(or label_4

;; def=ImmutableSTwHeaps.fst(136,6-136,19); use=ImmutableSTwHeaps.fst(137,15-139,9)
(= @x4
(ImmutableSTwHeaps.sel @x0
@x5
@x1))
)
)

;; def=ImmutableSTwHeaps.fst(70,81-70,87); use=ImmutableSTwHeaps.fst(137,15-139,9)
(Valid 
;; def=ImmutableSTwHeaps.fst(70,81-70,87); use=ImmutableSTwHeaps.fst(137,15-139,9)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=ImmutableSTwHeaps.fst(70,39-70,88); use=ImmutableSTwHeaps.fst(138,10-138,17)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
FStar.Monotonic.Heap.heap)
(HasType @x5
...
;; def=ImmutableSTwHeaps.fst(80,75-80,82); use=ImmutableSTwHeaps.fst(138,10-138,17)
(= @x3
@x4)


;; def=ImmutableSTwHeaps.fst(80,86-80,93); use=ImmutableSTwHeaps.fst(138,10-138,17)
(= @x4
@x5)
)

;; def=FStar.Pervasives.fsti(463,24-463,34); use=ImmutableSTwHeaps.fst(137,15-139,9)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=ImmutableSTwHeaps.fst(137,15-139,9)
(ApplyTT (ApplyTT @x2
(ImmutableSTwHeaps.sel @x0
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableSTwHeaps.read, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_fcc3ae3430dace306efd930c647e1fda, typing_ImmutableSTwHeaps.sel
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableSTwHeaps.read (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableSTwHeaps.read@tok () Term)

; </end encoding let read>


; encoding sigelt val ImmutableSTwHeaps.write


; <Skipped val ImmutableSTwHeaps.write/>

(push) ;; push{2

; Starting query at ImmutableSTwHeaps.fst(149,18-153,21)
...
; Encoding query formula : forall (a: Type) (r: FStar.Heap.ref a) (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap Prims.unit)
;     (h: FStar.Monotonic.Heap.heap).
;     ImmutableSTwHeaps.sel h r == x /\ FStar.Monotonic.Heap.contains h r /\
;     (forall (x: Prims.unit) (s1: FStar.Monotonic.Heap.heap).
;         ImmutableSTwHeaps.sel h r == x /\ FStar.Monotonic.Heap.contains h r /\
;         s1 == ImmutableSTwHeaps.upd h r x ==>
;         p x s1) ==>
;     (forall (x: FStar.Monotonic.Heap.heap) (s1: FStar.Monotonic.Heap.heap).
;         h == x /\ x == s1 ==>
...
;                     FStar.Monotonic.Heap.addr_of r1 <> FStar.Monotonic.Heap.addr_of r2) ==>
;                 ImmutableSTwHeaps.heap_rel s1 (ImmutableSTwHeaps.upd x r x) /\
;                 (forall (x: Prims.unit) (s1: FStar.Monotonic.Heap.heap).
;                     ImmutableSTwHeaps.heap_rel s1 (ImmutableSTwHeaps.upd x r x) /\
;                     s1 == ImmutableSTwHeaps.upd x r x ==>
;                     p x s1))))
...
;; def=ImmutableSTwHeaps.fst(147,38-147,51); use=ImmutableSTwHeaps.fst(149,18-153,21)
(= (ImmutableSTwHeaps.sel @x0
@x4
@x1)
@x2)
...
;; def=ImmutableSTwHeaps.fst(147,55-147,70); use=ImmutableSTwHeaps.fst(149,18-153,21)
(Valid 
;; def=ImmutableSTwHeaps.fst(147,55-147,70); use=ImmutableSTwHeaps.fst(149,18-153,21)
(FStar.Monotonic.Heap.contains @x0
(FStar.Heap.trivial_preorder @x0)
...
;; def=ImmutableSTwHeaps.fst(70,39-70,88); use=ImmutableSTwHeaps.fst(149,18-153,21)
...
;; def=ImmutableSTwHeaps.fst(148,45-148,61); use=ImmutableSTwHeaps.fst(149,18-153,21)
(or label_5
...
;; def=ImmutableSTwHeaps.fst(70,81-70,87); use=ImmutableSTwHeaps.fst(149,18-153,21)
(Valid 
;; def=ImmutableSTwHeaps.fst(70,81-70,87); use=ImmutableSTwHeaps.fst(149,18-153,21)
(ApplyTT (ApplyTT @x3
@x5)
...
;; def=ImmutableSTwHeaps.fst(70,39-70,88); use=ImmutableSTwHeaps.fst(150,10-150,17)
(forall ((@x5 Term) (@x6 Term))
...
;; def=ImmutableSTwHeaps.fst(80,75-80,82); use=ImmutableSTwHeaps.fst(150,10-150,17)
(= @x4
@x5)


;; def=ImmutableSTwHeaps.fst(80,86-80,93); use=ImmutableSTwHeaps.fst(150,10-150,17)
(= @x5
@x6)
)

;; def=Prims.fst(441,36-441,97); use=ImmutableSTwHeaps.fst(151,7-151,46)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=FStar.Monotonic.Heap.fsti(123,9-125,88); use=ImmutableSTwHeaps.fst(151,7-151,46)
(forall ((@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term) (@x12 Term) (@x13 Term))
 (! (implies (and (HasType @x8
Tm_type)
(HasType @x9
(FStar.Preorder.preorder @x8))
(HasType @x10
(FStar.Preorder.preorder @x8))
(HasType @x11
(FStar.Monotonic.Heap.mref @x8
@x9))
(HasType @x12
(FStar.Monotonic.Heap.mref @x8
@x10))
...
;; def=FStar.Monotonic.Heap.fsti(125,6-125,21); use=ImmutableSTwHeaps.fst(151,7-151,46)
(Valid 
;; def=FStar.Monotonic.Heap.fsti(125,6-125,21); use=ImmutableSTwHeaps.fst(151,7-151,46)
(FStar.Monotonic.Heap.contains @x8
@x9
@x13
@x11)
)
...
;; def=FStar.Monotonic.Heap.fsti(125,25-125,40); use=ImmutableSTwHeaps.fst(151,7-151,46)
(Valid 
;; def=FStar.Monotonic.Heap.fsti(125,25-125,40); use=ImmutableSTwHeaps.fst(151,7-151,46)
(FStar.Monotonic.Heap.contains @x8
@x10
...
;; def=FStar.Monotonic.Heap.fsti(125,44-125,57); use=ImmutableSTwHeaps.fst(151,7-151,46)
(not 
;; def=FStar.Monotonic.Heap.fsti(125,44-125,57); use=ImmutableSTwHeaps.fst(151,7-151,46)
(= @x9
@x10)
...
;; def=FStar.Monotonic.Heap.fsti(125,63-125,87); use=ImmutableSTwHeaps.fst(151,7-151,46)
(not (= (FStar.Monotonic.Heap.addr_of @x8
@x9
@x11)
(FStar.Monotonic.Heap.addr_of @x8
@x10
@x12)))
)
 

:pattern ((FStar.Monotonic.Heap.contains @x8
@x9
@x13
@x11) (FStar.Monotonic.Heap.contains @x8
@x10
@x13
@x12))
:qid @query.5))
...
;; def=Prims.fst(441,36-441,97); use=ImmutableSTwHeaps.fst(152,7-152,39)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=FStar.Monotonic.Heap.fsti(128,9-130,96); use=ImmutableSTwHeaps.fst(152,7-152,39)
(forall ((@x9 Term) (@x10 Term) (@x11 Term) (@x12 Term) (@x13 Term) (@x14 Term) (@x15 Term))
 (! (implies (and (HasType @x9
Tm_type)
(HasType @x10
Tm_type)
(HasType @x11
(FStar.Preorder.preorder @x9))
(HasType @x12
(FStar.Preorder.preorder @x10))
(HasType @x13
(FStar.Monotonic.Heap.mref @x9
@x11))
(HasType @x14
(FStar.Monotonic.Heap.mref @x10
@x12))
(HasType @x15
FStar.Monotonic.Heap.heap)

;; def=FStar.Monotonic.Heap.fsti(130,6-130,21); use=ImmutableSTwHeaps.fst(152,7-152,39)
(Valid 
;; def=FStar.Monotonic.Heap.fsti(130,6-130,21); use=ImmutableSTwHeaps.fst(152,7-152,39)
(FStar.Monotonic.Heap.contains @x9
@x11
@x15
@x13)
)
...
;; def=FStar.Monotonic.Heap.fsti(130,25-130,40); use=ImmutableSTwHeaps.fst(152,7-152,39)
(Valid 
;; def=FStar.Monotonic.Heap.fsti(130,25-130,40); use=ImmutableSTwHeaps.fst(152,7-152,39)
(FStar.Monotonic.Heap.contains @x10
@x12
@x15
@x14)
)
...
;; def=FStar.Monotonic.Heap.fsti(130,44-130,65); use=ImmutableSTwHeaps.fst(152,7-152,39)
(not 
;; def=FStar.Monotonic.Heap.fsti(130,44-130,65); use=ImmutableSTwHeaps.fst(152,7-152,39)
(= (FStar.Monotonic.Heap.is_mm @x9
@x11
@x13)
(FStar.Monotonic.Heap.is_mm @x10
@x12
@x14))
)
)

;; def=FStar.Monotonic.Heap.fsti(130,71-130,95); use=ImmutableSTwHeaps.fst(152,7-152,39)
(not (= (FStar.Monotonic.Heap.addr_of @x9
@x11
@x13)
(FStar.Monotonic.Heap.addr_of @x10
@x12
@x14)))
)
 

:pattern ((FStar.Monotonic.Heap.contains @x9
@x11
@x15
@x13) (FStar.Monotonic.Heap.contains @x10
@x12
@x15
@x14))
:qid @query.7))
...
;; def=ImmutableSTwHeaps.fst(70,29-70,88); use=ImmutableSTwHeaps.fst(153,2-153,9)
(and 
;; def=ImmutableSTwHeaps.fst(83,31-83,44); use=ImmutableSTwHeaps.fst(153,2-153,9)
(or label_6

;; def=ImmutableSTwHeaps.fst(83,31-83,44); use=ImmutableSTwHeaps.fst(153,2-153,9)
(Valid 
;; def=ImmutableSTwHeaps.fst(83,31-83,44); use=ImmutableSTwHeaps.fst(153,2-153,9)
(ImmutableSTwHeaps.heap_rel @x6
(ImmutableSTwHeaps.upd @x0
@x5
@x1
@x2))
...
;; def=ImmutableSTwHeaps.fst(70,39-70,88); use=ImmutableSTwHeaps.fst(153,2-153,9)
...
;; def=ImmutableSTwHeaps.fst(83,62-83,69); use=ImmutableSTwHeaps.fst(153,2-153,9)
(= @x10
(ImmutableSTwHeaps.upd @x0
@x5
@x1
...
;; def=ImmutableSTwHeaps.fst(70,81-70,87); use=ImmutableSTwHeaps.fst(153,2-153,9)
(Valid 
;; def=ImmutableSTwHeaps.fst(70,81-70,87); use=ImmutableSTwHeaps.fst(153,2-153,9)
(ApplyTT (ApplyTT @x3
@x9)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableSTwHeaps.write, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Heap.ref, equation_FStar.Heap.trivial_preorder, equation_FStar.Monotonic.Heap.modifies, equation_FStar.Monotonic.Heap.modifies_t, equation_ImmutableSTwHeaps.heap_rel, lemma_FStar.Monotonic.Heap.lemma_contains_upd_modifies, lemma_FStar.Monotonic.Heap.lemma_distinct_addrs_distinct_types, lemma_FStar.Monotonic.Heap.lemma_sel_same_addr, lemma_FStar.Monotonic.Heap.lemma_sel_upd1, lemma_FStar.Monotonic.Heap.lemma_sel_upd2, refinement_interpretation_Tm_refine_ec74995abaf3afbf48bfcaea8401c27c, refinement_interpretation_Tm_refine_fcc3ae3430dace306efd930c647e1fda, typing_FStar.Heap.trivial_preorder, typing_ImmutableSTwHeaps.sel, typing_ImmutableSTwHeaps.upd
