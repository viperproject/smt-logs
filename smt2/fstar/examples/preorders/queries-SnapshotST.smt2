...
; Internals for SnapshotST


; encoding sigelt val SnapshotST.state


; <Start encoding val SnapshotST.state>

(declare-fun SnapshotST.state () Term)

; </end encoding val SnapshotST.state>


; encoding sigelt val SnapshotST.rel_s


; <Start encoding val SnapshotST.rel_s>

(declare-fun SnapshotST.rel_s (Dummy_sort) Term)

; </end encoding val SnapshotST.rel_s>


; encoding sigelt type SnapshotST.t


; <Start encoding type SnapshotST.t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun SnapshotST.t () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SnapshotST.Ok (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun SnapshotST.Ok__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: SnapshotST.Ok
(declare-fun SnapshotST.Ok@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SnapshotST.Tmp (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun SnapshotST.Tmp__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun SnapshotST.Tmp__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: SnapshotST.Tmp
(declare-fun SnapshotST.Tmp@tok () Term)
;;;;;;;;;;;;;;;;_0: state -> t
(declare-fun Tm_arrow_b3ab4c3d283ad83e86bfef24a9610efd () Term)
;;;;;;;;;;;;;;;;_0: state -> _1: state -> t
(declare-fun Tm_arrow_011888306feaaca106c7e51a76a842e8 () Term)

; <start constructor SnapshotST.t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SnapshotST.t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(= __@x0
SnapshotST.t)))

; </end constructor SnapshotST.t>


; <start constructor SnapshotST.Ok>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SnapshotST.Ok ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
110)
(= __@x0
(SnapshotST.Ok (SnapshotST.Ok__0 __@x0)))))

; </end constructor SnapshotST.Ok>


; <start constructor SnapshotST.Tmp>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SnapshotST.Tmp ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
115)
(= __@x0
(SnapshotST.Tmp (SnapshotST.Tmp__0 __@x0)
(SnapshotST.Tmp__1 __@x0)))))

; </end constructor SnapshotST.Tmp>


; </end encoding type SnapshotST.t>


; encoding sigelt val SnapshotST.uu___is_Ok


; <Start encoding val SnapshotST.uu___is_Ok>

(declare-fun SnapshotST.uu___is_Ok (Term) Term)
;;;;;;;;;;;;;;;;projectee: t -> Prims.bool
(declare-fun Tm_arrow_a18e3e0aa74d8c939965b35347abcd2e () Term)
(declare-fun SnapshotST.uu___is_Ok@tok () Term)

; </end encoding val SnapshotST.uu___is_Ok>
...
; encoding sigelt val SnapshotST.__proj__Ok__item___0


; <Start encoding val SnapshotST.__proj__Ok__item___0>

(declare-fun Tm_refine_abc8984d7fb6dc87dbd65572f74bda11 () Term)
(declare-fun SnapshotST.__proj__Ok__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t{Ok? _} -> state
(declare-fun Tm_arrow_3ab7fc872375a2d9b393dbf56cd101e7 () Term)
(declare-fun SnapshotST.__proj__Ok__item___0@tok () Term)

; </end encoding val SnapshotST.__proj__Ok__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SnapshotST.uu___is_Ok; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(36,4-36,6); use=SnapshotST.fst(36,4-36,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SnapshotST.t)
(HasType (SnapshotST.uu___is_Ok @x0)
Prims.bool))
 

:pattern ((SnapshotST.uu___is_Ok @x0))
:qid typing_SnapshotST.uu___is_Ok))

:named typing_SnapshotST.uu___is_Ok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SnapshotST.state; Namespace SnapshotST
(assert (! (HasType SnapshotST.state
Tm_type)
:named typing_SnapshotST.state))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(37,4-37,7); use=SnapshotST.fst(37,4-37,7)
...
@x2)
SnapshotST.t))
:qid subterm_ordering_SnapshotST.Tmp))

:named subterm_ordering_SnapshotST.Tmp))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(36,4-36,6); use=SnapshotST.fst(36,4-36,6)
...
(SnapshotST.Ok @x1)
SnapshotST.t))
:qid subterm_ordering_SnapshotST.Ok))

:named subterm_ordering_SnapshotST.Ok))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name SnapshotST.__proj__Ok__item___0; Namespace SnapshotST
(assert (! (HasType Tm_refine_abc8984d7fb6dc87dbd65572f74bda11
Tm_type)
:named refinement_kinding_Tm_refine_abc8984d7fb6dc87dbd65572f74bda11))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_abc8984d7fb6dc87dbd65572f74bda11)
(and (HasTypeFuel @u0
@x1
SnapshotST.t)

;; def=SnapshotST.fst(36,4-36,6); use=SnapshotST.fst(36,4-36,6)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x1))
))
...
@x1
Tm_refine_abc8984d7fb6dc87dbd65572f74bda11))
:qid refinement_interpretation_Tm_refine_abc8984d7fb6dc87dbd65572f74bda11))

:named refinement_interpretation_Tm_refine_abc8984d7fb6dc87dbd65572f74bda11))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
...
;; def=SnapshotST.fst(37,4-37,7); use=SnapshotST.fst(37,4-37,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (SnapshotST.Tmp__1 (SnapshotST.Tmp @x0
@x1))
@x1)
 

:pattern ((SnapshotST.Tmp @x0
@x1))
:qid projection_inverse_SnapshotST.Tmp__1))

:named projection_inverse_SnapshotST.Tmp__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(37,4-37,7); use=SnapshotST.fst(37,4-37,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (SnapshotST.Tmp__0 (SnapshotST.Tmp @x0
@x1))
@x0)
...
:pattern ((SnapshotST.Tmp @x0
@x1))
:qid projection_inverse_SnapshotST.Tmp__0))

:named projection_inverse_SnapshotST.Tmp__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(36,4-36,6); use=SnapshotST.fst(36,4-36,6)
(forall ((@x0 Term))
 (! (= (SnapshotST.Ok__0 (SnapshotST.Ok @x0))
@x0)
 

:pattern ((SnapshotST.Ok @x0))
:qid projection_inverse_SnapshotST.Ok__0))

:named projection_inverse_SnapshotST.Ok__0))
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! (HasType SnapshotST.t
Tm_type)
:named kinding_SnapshotST.t@tok))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_abc8984d7fb6dc87dbd65572f74bda11
;;; Fact-ids: Name SnapshotST.__proj__Ok__item___0; Namespace SnapshotST
(assert (! (iff (Valid (Prims.hasEq Tm_refine_abc8984d7fb6dc87dbd65572f74bda11))
(Valid (Prims.hasEq SnapshotST.t)))
:named haseqTm_refine_abc8984d7fb6dc87dbd65572f74bda11))
...
(assert (! (HasType SnapshotST.state
Tm_type)
:named function_token_typing_SnapshotST.state))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(35,10-35,11); use=SnapshotST.fst(35,10-35,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
SnapshotST.t)
(or (is-SnapshotST.Ok @x1)
(is-SnapshotST.Tmp @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
SnapshotST.t))
:qid fuel_guarded_inversion_SnapshotST.t))

:named fuel_guarded_inversion_SnapshotST.t))
...
;; def=SnapshotST.fst(36,4-36,6); use=SnapshotST.fst(36,4-36,6)
(forall ((@x0 Term))
 (! (= (SnapshotST.uu___is_Ok @x0)
(BoxBool (is-SnapshotST.Ok @x0)))
 

:pattern ((SnapshotST.uu___is_Ok @x0))
:qid disc_equation_SnapshotST.Ok))

:named disc_equation_SnapshotST.Ok))
...
@x2)
SnapshotST.t))
:qid data_typing_intro_SnapshotST.Tmp@tok))

:named data_typing_intro_SnapshotST.Tmp@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(36,4-36,6); use=SnapshotST.fst(36,4-36,6)
...
(SnapshotST.Ok @x1)
SnapshotST.t))
:qid data_typing_intro_SnapshotST.Ok@tok))

:named data_typing_intro_SnapshotST.Ok@tok))
...
@x2)
SnapshotST.t))
:qid data_elim_SnapshotST.Tmp))

:named data_elim_SnapshotST.Tmp))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(36,4-36,6); use=SnapshotST.fst(36,4-36,6)
...
(SnapshotST.Ok @x1)
SnapshotST.t))
:qid data_elim_SnapshotST.Ok))

:named data_elim_SnapshotST.Ok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! (= 104
(Term_constr_id SnapshotST.t))
:named constructor_distinct_SnapshotST.t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(37,4-37,7); use=SnapshotST.fst(37,4-37,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= 115
(Term_constr_id (SnapshotST.Tmp @x0
@x1)))
 

:pattern ((SnapshotST.Tmp @x0
@x1))
:qid constructor_distinct_SnapshotST.Tmp))

:named constructor_distinct_SnapshotST.Tmp))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SnapshotST.t; Namespace SnapshotST; Name SnapshotST.Ok; Namespace SnapshotST; Name SnapshotST.Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(36,4-36,6); use=SnapshotST.fst(36,4-36,6)
(forall ((@x0 Term))
 (! (= 110
(Term_constr_id (SnapshotST.Ok @x0)))
 

:pattern ((SnapshotST.Ok @x0))
:qid constructor_distinct_SnapshotST.Ok))

:named constructor_distinct_SnapshotST.Ok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
@x0
SnapshotST.t))
:qid SnapshotST_pretyping_1ed7584a366d2d38a675fc91a6e7e5f1))

:named SnapshotST_pretyping_1ed7584a366d2d38a675fc91a6e7e5f1))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
; Encoding query formula : forall (projectee: _: SnapshotST.t{Ok? _}).
;   (*  - Could not prove post-condition
; *) ~(Ok? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Ok__item___0`
...
(not 
;; def=SnapshotST.fst(36,4-36,6); use=SnapshotST.fst(36,4-36,6)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.__proj__Ok__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_abc8984d7fb6dc87dbd65572f74bda11
...
; encoding sigelt let __proj__Ok__item___0


; <Skipped let __proj__Ok__item___0/>


; encoding sigelt val SnapshotST.uu___is_Tmp


; <Start encoding val SnapshotST.uu___is_Tmp>

(declare-fun SnapshotST.uu___is_Tmp (Term) Term)

(declare-fun SnapshotST.uu___is_Tmp@tok () Term)

; </end encoding val SnapshotST.uu___is_Tmp>


; encoding sigelt let uu___is_Tmp


; <Skipped let uu___is_Tmp/>


; encoding sigelt val SnapshotST.__proj__Tmp__item___0


; <Start encoding val SnapshotST.__proj__Tmp__item___0>

(declare-fun Tm_refine_8373c0a53fce8bd921acbd00ee47726c () Term)
(declare-fun SnapshotST.__proj__Tmp__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t{Tmp? _} -> state
(declare-fun Tm_arrow_cea0b057a652c4dfad7d04572005efb7 () Term)
(declare-fun SnapshotST.__proj__Tmp__item___0@tok () Term)

; </end encoding val SnapshotST.__proj__Tmp__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SnapshotST.uu___is_Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(37,4-37,7); use=SnapshotST.fst(37,4-37,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SnapshotST.t)
(HasType (SnapshotST.uu___is_Tmp @x0)
Prims.bool))
 

:pattern ((SnapshotST.uu___is_Tmp @x0))
:qid typing_SnapshotST.uu___is_Tmp))

:named typing_SnapshotST.uu___is_Tmp))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name SnapshotST.__proj__Tmp__item___0; Namespace SnapshotST
(assert (! (HasType Tm_refine_8373c0a53fce8bd921acbd00ee47726c
Tm_type)
:named refinement_kinding_Tm_refine_8373c0a53fce8bd921acbd00ee47726c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name SnapshotST.__proj__Tmp__item___0; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(37,4-37,7); use=SnapshotST.fst(37,4-37,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_8373c0a53fce8bd921acbd00ee47726c)
(and (HasTypeFuel @u0
@x1
SnapshotST.t)

;; def=SnapshotST.fst(37,4-37,7); use=SnapshotST.fst(37,4-37,7)
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp @x1))
))
...
@x1
Tm_refine_8373c0a53fce8bd921acbd00ee47726c))
:qid refinement_interpretation_Tm_refine_8373c0a53fce8bd921acbd00ee47726c))

:named refinement_interpretation_Tm_refine_8373c0a53fce8bd921acbd00ee47726c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8373c0a53fce8bd921acbd00ee47726c
;;; Fact-ids: Name SnapshotST.__proj__Tmp__item___0; Namespace SnapshotST
(assert (! (iff (Valid (Prims.hasEq Tm_refine_8373c0a53fce8bd921acbd00ee47726c))
(Valid (Prims.hasEq SnapshotST.t)))
:named haseqTm_refine_8373c0a53fce8bd921acbd00ee47726c))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name SnapshotST.uu___is_Tmp; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(37,4-37,7); use=SnapshotST.fst(37,4-37,7)
(forall ((@x0 Term))
 (! (= (SnapshotST.uu___is_Tmp @x0)
(BoxBool (is-SnapshotST.Tmp @x0)))
 

:pattern ((SnapshotST.uu___is_Tmp @x0))
:qid disc_equation_SnapshotST.Tmp))

:named disc_equation_SnapshotST.Tmp))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: SnapshotST.t{Tmp? _}).
;   (*  - Could not prove post-condition
; *) ~(Tmp? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Tmp__item___0`
...
(not 
;; def=SnapshotST.fst(37,4-37,7); use=SnapshotST.fst(37,4-37,7)
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.__proj__Tmp__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_8373c0a53fce8bd921acbd00ee47726c
...
; encoding sigelt let __proj__Tmp__item___0


; <Skipped let __proj__Tmp__item___0/>


; encoding sigelt val SnapshotST.__proj__Tmp__item___1


; <Start encoding val SnapshotST.__proj__Tmp__item___1>


(declare-fun SnapshotST.__proj__Tmp__item___1 (Term) Term)


(declare-fun SnapshotST.__proj__Tmp__item___1@tok () Term)

; </end encoding val SnapshotST.__proj__Tmp__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Tmp__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.__proj__Tmp__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_8373c0a53fce8bd921acbd00ee47726c
...
; encoding sigelt let __proj__Tmp__item___1


; <Skipped let __proj__Tmp__item___1/>
...
; Starting query at SnapshotST.fst(42,3-46,39)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (t0: SnapshotST.t) (t1: SnapshotST.t).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Type0).
;     (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(Ok? (t0, t1)._1 && Ok? (t0, t1)._2) /\ ~(Ok? (t0, t1)._1 && Tmp? (t0, t1)._2) /\
;     ~(Tmp? (t0, t1)._1 && Ok? (t0, t1)._2) /\ ~(Tmp? (t0, t1)._1 && Tmp? (t0, t1)._2) ==>
;     Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let rel_t`
...
;; def=Prims.fst(402,27-402,88); use=SnapshotST.fst(42,3-46,39)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=SnapshotST.fst(42,3-46,39)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SnapshotST.fst(42,3-46,39)
(ApplyTT @x2
@x3)
...
;; def=SnapshotST.fst(43,5-43,21); use=SnapshotST.fst(43,5-43,21)
(not 
;; def=SnapshotST.fst(43,5-43,21); use=SnapshotST.fst(43,5-43,21)
(and (BoxBool_proj_0 (SnapshotST.uu___is_Ok (FStar.Pervasives.Native.__proj__Mktuple2__item___1 SnapshotST.t
SnapshotST.t
(FStar.Pervasives.Native.Mktuple2 SnapshotST.t
SnapshotST.t
@x0
@x1))))
(BoxBool_proj_0 (SnapshotST.uu___is_Ok (FStar.Pervasives.Native.__proj__Mktuple2__item___2 SnapshotST.t
SnapshotST.t
(FStar.Pervasives.Native.Mktuple2 SnapshotST.t
SnapshotST.t
@x0
...
;; def=SnapshotST.fst(44,5-44,24); use=SnapshotST.fst(44,5-44,24)
(not 
;; def=SnapshotST.fst(44,5-44,24); use=SnapshotST.fst(44,5-44,24)
(and (BoxBool_proj_0 (SnapshotST.uu___is_Ok (FStar.Pervasives.Native.__proj__Mktuple2__item___1 SnapshotST.t
SnapshotST.t
...
@x0
@x1))))
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp (FStar.Pervasives.Native.__proj__Mktuple2__item___2 SnapshotST.t
SnapshotST.t
(FStar.Pervasives.Native.Mktuple2 SnapshotST.t
SnapshotST.t
@x0
...
;; def=SnapshotST.fst(45,5-45,21); use=SnapshotST.fst(45,5-45,21)
(not 
;; def=SnapshotST.fst(45,5-45,21); use=SnapshotST.fst(45,5-45,21)
(and (BoxBool_proj_0 (SnapshotST.uu___is_Tmp (FStar.Pervasives.Native.__proj__Mktuple2__item___1 SnapshotST.t
SnapshotST.t
(FStar.Pervasives.Native.Mktuple2 SnapshotST.t
SnapshotST.t
@x0
...
;; def=SnapshotST.fst(46,5-46,24); use=SnapshotST.fst(46,5-46,24)
(not 
;; def=SnapshotST.fst(46,5-46,24); use=SnapshotST.fst(46,5-46,24)
(and (BoxBool_proj_0 (SnapshotST.uu___is_Tmp (FStar.Pervasives.Native.__proj__Mktuple2__item___1 SnapshotST.t
SnapshotST.t
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.rel_t, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, SnapshotST_pretyping_1ed7584a366d2d38a675fc91a6e7e5f1, disc_equation_SnapshotST.Ok, disc_equation_SnapshotST.Tmp, fuel_guarded_inversion_SnapshotST.t, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
; encoding sigelt let rel_t


; <Start encoding let rel_t>

(declare-fun SnapshotST.rel_t (Term Term) Term)
;;;;;;;;;;;;;;;;t0: t -> t1: t -> Type
(declare-fun Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9 () Term)
(declare-fun SnapshotST.rel_t@tok () Term)

; </end encoding let rel_t>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SnapshotST.rel_s; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(31,11-31,16); use=SnapshotST.fst(31,11-31,16)
(forall ((@u0 Dummy_sort))
 (! (HasType (SnapshotST.rel_s @u0)
(FStar.Preorder.preorder SnapshotST.state))
 

:pattern ((SnapshotST.rel_s @u0))
:qid typing_SnapshotST.rel_s))

:named typing_SnapshotST.rel_s))
;;;;;;;;;;;;;;;;free var typing
...
; Starting query at SnapshotST.fst(51,4-53,20)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_4919007296017533ad3fcdbcd84b282e () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_4919007296017533ad3fcdbcd84b282e
Tm_type)
:named refinement_kinding_Tm_refine_4919007296017533ad3fcdbcd84b282e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=SnapshotST.fst(50,19-50,54); use=SnapshotST.fst(50,19-50,54)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4919007296017533ad3fcdbcd84b282e)
(and (HasTypeFuel @u0
@x1
(FStar.Preorder.predicate SnapshotST.state))

;; def=SnapshotST.fst(50,38-50,52); use=SnapshotST.fst(50,38-50,52)
(Valid 
;; def=SnapshotST.fst(50,38-50,52); use=SnapshotST.fst(50,38-50,52)
(FStar.Preorder.stable SnapshotST.state
@x1
(SnapshotST.rel_s Dummy_value))
)
))
...
@x1
Tm_refine_4919007296017533ad3fcdbcd84b282e))
:qid refinement_interpretation_Tm_refine_4919007296017533ad3fcdbcd84b282e))

:named refinement_interpretation_Tm_refine_4919007296017533ad3fcdbcd84b282e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4919007296017533ad3fcdbcd84b282e
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_4919007296017533ad3fcdbcd84b282e))
(Valid (Prims.hasEq (FStar.Preorder.predicate SnapshotST.state))))
:named haseqTm_refine_4919007296017533ad3fcdbcd84b282e))

; Encoding query formula : forall (p: FStar.Preorder.predicate SnapshotST.state {FStar.Preorder.stable p SnapshotST.rel_s})
;   (t: SnapshotST.t).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Type0).
;     (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(Ok? t) /\ ~(Tmp? t) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let lift_predicate`
...
;; def=Prims.fst(402,27-402,88); use=SnapshotST.fst(51,4-53,20)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=SnapshotST.fst(51,4-53,20)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SnapshotST.fst(51,4-53,20)
(ApplyTT @x2
@x3)
...
;; def=SnapshotST.fst(50,56-50,57); use=SnapshotST.fst(51,10-51,11)
(not 
;; def=SnapshotST.fst(50,56-50,57); use=SnapshotST.fst(51,10-51,11)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x1))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.lift_predicate, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_SnapshotST.Ok, disc_equation_SnapshotST.Tmp, fuel_guarded_inversion_SnapshotST.t, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let lift_predicate


; <Start encoding let lift_predicate>

(declare-fun Tm_refine_4919007296017533ad3fcdbcd84b282e () Term)
(declare-fun SnapshotST.lift_predicate (Term Term) Term)

;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate state {FStar.Preorder.stable p rel_s} -> t: t -> Type
(declare-fun Tm_arrow_2487dd4e7d6a8b065d7da54438bc8d87 () Term)
(declare-fun SnapshotST.lift_predicate@tok () Term)


; </end encoding let lift_predicate>


; encoding sigelt val SnapshotST.lift_stability


; <Skipped val SnapshotST.lift_stability/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SnapshotST.rel_t; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(41,4-41,9); use=SnapshotST.fst(41,4-41,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
SnapshotST.t)
(HasType @x1
SnapshotST.t))
(HasType (SnapshotST.rel_t @x0
@x1)
Tm_type))
 

:pattern ((SnapshotST.rel_t @x0
@x1))
:qid typing_SnapshotST.rel_t))

:named typing_SnapshotST.rel_t))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SnapshotST.lift_predicate; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(50,4-50,18); use=SnapshotST.fst(50,4-50,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_refine_4919007296017533ad3fcdbcd84b282e)
(HasType @x1
SnapshotST.t))
(HasType (SnapshotST.lift_predicate @x0
@x1)
Tm_type))
 

:pattern ((SnapshotST.lift_predicate @x0
@x1))
:qid typing_SnapshotST.lift_predicate))

:named typing_SnapshotST.lift_predicate))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name SnapshotST.lift_predicate; Namespace SnapshotST
(assert (! (HasType Tm_refine_4919007296017533ad3fcdbcd84b282e
Tm_type)
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (SnapshotST.rel_t @x0
@x1)
(let ((@lb2 (FStar.Pervasives.Native.Mktuple2 SnapshotST.t
SnapshotST.t
@x0
@x1)))
(ite (and (is-SnapshotST.Ok (FStar.Pervasives.Native.Mktuple2__1 @lb2))
(is-SnapshotST.Ok (FStar.Pervasives.Native.Mktuple2__2 @lb2)))
(ApplyTT (ApplyTT (SnapshotST.rel_s Dummy_value)
(SnapshotST.Ok__0 (FStar.Pervasives.Native.Mktuple2__1 @lb2)))
(SnapshotST.Ok__0 (FStar.Pervasives.Native.Mktuple2__2 @lb2)))
(ite (and (is-SnapshotST.Ok (FStar.Pervasives.Native.Mktuple2__1 @lb2))
(is-SnapshotST.Tmp (FStar.Pervasives.Native.Mktuple2__2 @lb2)))
(ApplyTT (ApplyTT (SnapshotST.rel_s Dummy_value)
(SnapshotST.Ok__0 (FStar.Pervasives.Native.Mktuple2__1 @lb2)))
(SnapshotST.Tmp__0 (FStar.Pervasives.Native.Mktuple2__2 @lb2)))
(ite (and (is-SnapshotST.Tmp (FStar.Pervasives.Native.Mktuple2__1 @lb2))
(is-SnapshotST.Ok (FStar.Pervasives.Native.Mktuple2__2 @lb2)))
(ApplyTT (ApplyTT (SnapshotST.rel_s Dummy_value)
(SnapshotST.Tmp__0 (FStar.Pervasives.Native.Mktuple2__1 @lb2)))
(SnapshotST.Ok__0 (FStar.Pervasives.Native.Mktuple2__2 @lb2)))
(ite (and (is-SnapshotST.Tmp (FStar.Pervasives.Native.Mktuple2__1 @lb2))
(is-SnapshotST.Tmp (FStar.Pervasives.Native.Mktuple2__2 @lb2)))
(ApplyTT (ApplyTT (SnapshotST.rel_s Dummy_value)
...
:pattern ((SnapshotST.rel_t @x0
@x1))
:qid equation_SnapshotST.rel_t))

:named equation_SnapshotST.rel_t))
;;;;;;;;;;;;;;;;Equation for SnapshotST.lift_predicate
;;; Fact-ids: Name SnapshotST.lift_predicate; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(50,4-50,18); use=SnapshotST.fst(50,4-50,18)
(forall ((@x0 Term) (@x1 Term))
 (! (= (SnapshotST.lift_predicate @x0
@x1)
(let ((@lb2 @x1))
(ite (is-SnapshotST.Ok @lb2)
(ApplyTT @x0
(SnapshotST.Ok__0 @lb2))
(ite (is-SnapshotST.Tmp @lb2)
(ApplyTT @x0
(SnapshotST.Tmp__0 @lb2))
Tm_unit))))
 

:pattern ((SnapshotST.lift_predicate @x0
@x1))
:qid equation_SnapshotST.lift_predicate))

:named equation_SnapshotST.lift_predicate))
(push) ;; push{2

; Starting query at SnapshotST.fst(62,29-62,31)
...
;     SnapshotST.lift_predicate p t0 /\ SnapshotST.rel_t t0 t1 /\
;     (forall (pure_result: Prims.unit). SnapshotST.lift_predicate p t1 ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lift_stability`
...
;; def=SnapshotST.fst(60,24-60,43); use=SnapshotST.fst(62,29-62,31)
(Valid 
;; def=SnapshotST.fst(60,24-60,43); use=SnapshotST.fst(62,29-62,31)
(SnapshotST.lift_predicate @x0
@x1)
...
;; def=SnapshotST.fst(60,47-60,58); use=SnapshotST.fst(62,29-62,31)
(Valid 
;; def=SnapshotST.fst(60,47-60,58); use=SnapshotST.fst(62,29-62,31)
(SnapshotST.rel_t @x1
@x2)
...
;; def=Prims.fst(441,36-441,97); use=SnapshotST.fst(62,29-62,31)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=SnapshotST.fst(61,23-61,44); use=SnapshotST.fst(62,29-62,31)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=SnapshotST.fst(62,29-62,31)
(Valid 
;; def=Prims.fst(441,83-441,96); use=SnapshotST.fst(62,29-62,31)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.lift_stability, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, SnapshotST_pretyping_1ed7584a366d2d38a675fc91a6e7e5f1, data_elim_SnapshotST.Ok, data_elim_SnapshotST.Tmp, equation_FStar.Preorder.stable, equation_SnapshotST.lift_predicate, equation_SnapshotST.rel_t, fuel_guarded_inversion_SnapshotST.t, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_4919007296017533ad3fcdbcd84b282e
...
; encoding sigelt let lift_stability


; <Start encoding let lift_stability>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SnapshotST.lift_stability (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SnapshotST.lift_stability@tok () Term)

; </end encoding let lift_stability>


; encoding sigelt let mst_pre


; <Start encoding let mst_pre>

(declare-fun SnapshotST.mst_pre () Term)
;;;;;;;;;;;;;;;;_: t -> Type
(declare-fun Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46 () Term)

; </end encoding let mst_pre>


; encoding sigelt let mst_post


; <Start encoding let mst_post>

(declare-fun SnapshotST.mst_post (Term) Term)

(declare-fun SnapshotST.mst_post@tok () Term)
;;;;;;;;;;;;;;;;_: a -> _: t -> Type
(declare-fun Tm_arrow_780d0dbf3826d0dadb938e591e099ac7 (Term) Term)

; </end encoding let mst_post>
...
(declare-fun SnapshotST.mst_wp (Term) Term)

(declare-fun SnapshotST.mst_wp@tok () Term)
;;;;;;;;;;;;;;;;_: mst_post a -> mst_pre
(declare-fun Tm_arrow_130566aa726f03021734e304f8ab5ebe (Term) Term)

; </end encoding let mst_wp>


; encoding sigelt new_effect { MSTATE ... }


; <Skipped new_effect { MSTATE ... }/>


; encoding sigelt let div_lift


; <Start encoding let div_lift>

(declare-fun SnapshotST.div_lift (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> p: mst_post a -> x: t -> Prims.pure_pre
(declare-fun Tm_arrow_78c9f2b264b9040dd9f5074056ca8a07 () Term)
(declare-fun SnapshotST.div_lift@tok () Term)



; </end encoding let div_lift>


; encoding sigelt sub_effect DIV ~> MSTATE


; <Skipped sub_effect DIV ~> MSTATE/>


; encoding sigelt effect MST a pre post = SnapshotST.MSTATE a


; <Skipped effect MST a pre post = SnapshotST.MSTATE a/>
...
;; def=SnapshotST.fst(41,4-41,9); use=SnapshotST.fst(41,4-41,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT SnapshotST.rel_t@tok
@x0)
@x1)
(SnapshotST.rel_t @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT SnapshotST.rel_t@tok
@x0)
@x1))
:qid token_correspondence_SnapshotST.rel_t))

:named token_correspondence_SnapshotST.rel_t))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9
;;; Fact-ids: Name SnapshotST.rel_t; Namespace SnapshotST
(assert (! (HasType Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9
Tm_type)
:named kinding_Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name SnapshotST.rel_t; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(41,4-41,9); use=SnapshotST.fst(41,4-41,9)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType SnapshotST.rel_t@tok
Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9))
...
:pattern ((SnapshotST.rel_t @x1
@x2))
:qid function_token_typing_SnapshotST.rel_t.1))
)
 

:pattern ((ApplyTT @x0
SnapshotST.rel_t@tok))
:qid function_token_typing_SnapshotST.rel_t))

:named function_token_typing_SnapshotST.rel_t))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name SnapshotST.rel_t; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(41,14-41,22); use=SnapshotST.fst(41,14-41,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9)
...
@x1
Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9))
:qid SnapshotST_pre_typing_Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9))

:named SnapshotST_pre_typing_Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9
;;; Fact-ids: Name SnapshotST.rel_t; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(41,14-41,22); use=SnapshotST.fst(41,14-41,22)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid SnapshotST_interpretation_Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid SnapshotST_interpretation_Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9))
:qid SnapshotST_interpretation_Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9))

:named SnapshotST_interpretation_Tm_arrow_afe5b8348ec4c07a895044d12e8ddea9))
(push) ;; push{2

; Starting query at SnapshotST.fst(96,32-96,49)
...
SnapshotST.rel_t@tok))
:named @kick_partial_app_07c80dbfd3a6a8f499d4edf0e9b17369))

; Encoding query formula : forall (p: FStar.Preorder.predicate SnapshotST.t).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash (FStar.Preorder.preorder_rel SnapshotST.rel_t)


; Context: While encoding a query
; While typechecking the top-level declaration `let witnessed`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate SnapshotST.t))

;; def=FStar.Preorder.fst(33,40-33,56); use=SnapshotST.fst(96,42-96,47)
(or label_1

;; def=FStar.Preorder.fst(33,40-33,56); use=SnapshotST.fst(96,42-96,47)
(Valid 
;; def=FStar.Preorder.fst(33,40-33,56); use=SnapshotST.fst(96,42-96,47)
(FStar.Preorder.preorder_rel SnapshotST.t
SnapshotST.rel_t@tok)
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.witnessed, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, SnapshotST_pretyping_1ed7584a366d2d38a675fc91a6e7e5f1, constructor_distinct_SnapshotST.Ok, data_elim_SnapshotST.Ok, data_elim_SnapshotST.Tmp, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_SnapshotST.rel_t, fuel_guarded_inversion_SnapshotST.t, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, token_correspondence_SnapshotST.rel_t, typing_SnapshotST.rel_s
...
(declare-fun SnapshotST.witnessed (Term) Term)
;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate t -> Type
(declare-fun Tm_arrow_97b7c943bf8bb5c2f8371a338a04fa58 () Term)
(declare-fun SnapshotST.witnessed@tok () Term)

; </end encoding let witnessed>


; encoding sigelt val SnapshotST.get


; <Start encoding val SnapshotST.get>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SnapshotST.get (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SnapshotST.get@tok () Term)

; </end encoding val SnapshotST.get>


; encoding sigelt val SnapshotST.put


; <Start encoding val SnapshotST.put>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SnapshotST.put (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SnapshotST.put@tok () Term)

; </end encoding val SnapshotST.put>

;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name SnapshotST.witnessed; Namespace SnapshotST
(assert (! (Valid (ApplyTT __uu__PartialApp
SnapshotST.rel_t@tok))
:named @kick_partial_app_07c80dbfd3a6a8f499d4edf0e9b17369))
(push) ;; push{2

; Starting query at SnapshotST.fst(106,7-107,87)
...
;   - Expected type
;       rel: FStar.Preorder.relation t {FStar.Preorder.preorder_rel rel}
;     got type t0: t -> t1: t -> Type0
; *)
;   Prims.auto_squash (FStar.Preorder.preorder_rel SnapshotST.rel_t)


; Context: While encoding a query
; While typechecking the top-level declaration `val SnapshotST.witness`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=SnapshotST.fst(106,21-107,29)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate SnapshotST.t))

;; def=FStar.Preorder.fst(35,53-35,69); use=SnapshotST.fst(106,44-106,49)
(or label_1
...
; encoding sigelt val SnapshotST.witness


; <Start encoding val SnapshotST.witness>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SnapshotST.witness (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SnapshotST.witness@tok () Term)

; </end encoding val SnapshotST.witness>

(push) ;; push{2

; Starting query at SnapshotST.fst(109,7-110,86)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val SnapshotST.recall`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=SnapshotST.fst(109,21-110,29)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate SnapshotST.t))

;; def=FStar.Preorder.fst(35,53-35,69); use=SnapshotST.fst(109,44-109,49)
(or label_1
...
; encoding sigelt val SnapshotST.recall


; <Start encoding val SnapshotST.recall>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SnapshotST.recall (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SnapshotST.recall@tok () Term)

; </end encoding val SnapshotST.recall>


; encoding sigelt let witnessed_s


; <Start encoding let witnessed_s>


(declare-fun SnapshotST.witnessed_s (Term) Term)

;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate state {FStar.Preorder.stable p rel_s} -> Type
(declare-fun Tm_arrow_757f529ee501f29a776e4e7a6a3f174c () Term)
(declare-fun SnapshotST.witnessed_s@tok () Term)


(declare-fun Tm_abs_398a8dcc1d5750e1a61f0be4356584b9 (Term) Term)

; </end encoding let witnessed_s>

(push) ;; push{2

; Starting query at SnapshotST.fst(122,0-126,74)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Prims.unit) (t0: SnapshotST.t) (s: SnapshotST.state) (t1: SnapshotST.t).
;   (*  - Could not prove post-condition
; *)
;   t0 == t1 ==>
;   (forall (k: Prims.pure_post Prims.logical).
;       (forall (x: Prims.logical). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;       ~(Ok? t1) /\ ~(Tmp? t1) ==> Prims.l_False)


; Context: While encoding a query
; While typechecking the top-level declaration `val SnapshotST.get_s`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=SnapshotST.fst(122,0-126,74)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.unit)
(HasType @x1
...
;; def=SnapshotST.fst(124,31-124,39); use=SnapshotST.fst(122,12-123,21)
(= @x1
@x3)
)

;; def=dummy(0,0-0,0); use=SnapshotST.fst(122,12-123,21)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.pure_post Prims.logical))

;; def=Prims.fst(402,27-402,88); use=SnapshotST.fst(122,12-123,21)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=SnapshotST.fst(122,12-123,21)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SnapshotST.fst(122,12-123,21)
(ApplyTT @x4
@x5)
...
;; def=SnapshotST.fst(124,25-124,27); use=SnapshotST.fst(122,12-123,21)
(not 
;; def=SnapshotST.fst(124,25-124,27); use=SnapshotST.fst(122,12-123,21)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x3))
)
...
(not 
;; def=SnapshotST.fst(124,25-124,27); use=SnapshotST.fst(122,12-123,21)
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp @x3))
)
)
label_1)
...
; encoding sigelt val SnapshotST.get_s


; <Skipped val SnapshotST.get_s/>
...
; Starting query at SnapshotST.fst(127,13-131,16)
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h SnapshotST.t SnapshotST.state) (h: SnapshotST.t).
;     (forall (x: SnapshotST.state) (t1: SnapshotST.t).
;         h == t1 /\
;         (match t1 with
;           | SnapshotST.Ok s1 -> s1 == x
;           | SnapshotST.Tmp _ s1 -> s1 == x) ==>
;         p x t1) ==>
;     (forall (x: SnapshotST.t) (t1: SnapshotST.t).
;         h == x /\ x == t1 ==>
;         (forall (k: Prims.pure_post SnapshotST.state).
;             (forall (x: SnapshotST.state). {:pattern Prims.guard_free (k x)}
;                 (x ==
;                   (match x with
;                     | SnapshotST.Ok s -> s
;                     | SnapshotST.Tmp _ s -> s) ==>
;                   p x t1) ==>
;                 k x) ==>
;             (~(Ok? x) /\ ~(Tmp? x) ==> Prims.l_False) /\
;             (forall (b: SnapshotST.state).
;                 x == SnapshotST.Ok b ==> (forall (any_result: SnapshotST.state). k any_result)) /\
;             (~(Ok? x) ==>
;               (forall (b: SnapshotST.state) (b: SnapshotST.state).
;                   x == SnapshotST.Tmp b b ==> (forall (any_result: SnapshotST.state). k any_result))
;             )))


; Context: While encoding a query
; While typechecking the top-level declaration `let get_s`
...
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
(FStar.Pervasives.st_post_h SnapshotST.t
SnapshotST.state))
(HasType @x2
SnapshotST.t)

;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(127,13-131,16)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (or label_1
(HasType @x3
SnapshotST.state))
...
;; def=SnapshotST.fst(124,31-124,39); use=SnapshotST.fst(127,13-131,16)
(or label_3
...
(let ((@lb5 @x4))
(ite (is-SnapshotST.Ok @lb5)

;; def=SnapshotST.fst(125,65-125,72); use=SnapshotST.fst(127,13-131,16)
(or label_4

;; def=SnapshotST.fst(125,65-125,72); use=SnapshotST.fst(127,13-131,16)
(= (SnapshotST.Ok__0 @lb5)
@x3)
)

(ite (is-SnapshotST.Tmp @lb5)

;; def=SnapshotST.fst(126,65-126,72); use=SnapshotST.fst(127,13-131,16)
(or label_5

;; def=SnapshotST.fst(126,65-126,72); use=SnapshotST.fst(127,13-131,16)
(= (SnapshotST.Tmp__1 @lb5)
@x3)
)

Unreachable))))

;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(127,13-131,16)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(127,13-131,16)
(ApplyTT (ApplyTT @x1
@x3)
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(128,10-128,13)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
SnapshotST.t)
(HasType @x4
...
;; def=SnapshotST.fst(101,59-101,66); use=SnapshotST.fst(128,10-128,13)
(= @x2
@x3)


;; def=SnapshotST.fst(101,70-101,77); use=SnapshotST.fst(128,10-128,13)
(= @x3
@x4)
)

;; def=Prims.fst(402,2-402,97); use=SnapshotST.fst(127,13-131,16)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.pure_post SnapshotST.state))

;; def=Prims.fst(402,2-402,97); use=SnapshotST.fst(127,13-131,16)
(forall ((@x6 Term))
 (! (implies (implies 
;; def=SnapshotST.fst(123,16-131,16); use=SnapshotST.fst(127,13-131,16)
(= @x6
(let ((@lb7 @x3))
(ite (is-SnapshotST.Ok @lb7)
(SnapshotST.Ok__0 @lb7)
(ite (is-SnapshotST.Tmp @lb7)
(SnapshotST.Tmp__1 @lb7)
Tm_unit))))


;; def=FStar.Pervasives.fsti(463,24-463,34); use=SnapshotST.fst(127,13-131,16)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=SnapshotST.fst(127,13-131,16)
(ApplyTT (ApplyTT @x1
@x6)
...
;; def=Prims.fst(402,84-402,87); use=SnapshotST.fst(127,13-131,16)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SnapshotST.fst(127,13-131,16)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=SnapshotST.fst(127,13-131,16)
(and (implies 
;; def=SnapshotST.fst(128,6-128,7); use=SnapshotST.fst(129,8-129,9)
(and 
;; def=SnapshotST.fst(128,6-128,7); use=SnapshotST.fst(129,8-129,9)
(not 
;; def=SnapshotST.fst(128,6-128,7); use=SnapshotST.fst(129,8-129,9)
...
;; def=Prims.fst(413,99-413,120); use=SnapshotST.fst(127,13-131,16)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
SnapshotST.state)

;; def=SnapshotST.fst(128,6-130,8); use=SnapshotST.fst(129,8-130,8)
(= @x3
(SnapshotST.Ok @x6))
)

;; def=Prims.fst(451,66-451,102); use=SnapshotST.fst(127,13-131,16)
(forall ((@x7 Term))
 (! (implies (HasType @x7
SnapshotST.state)

;; def=Prims.fst(451,90-451,102); use=SnapshotST.fst(127,13-131,16)
(Valid 
;; def=Prims.fst(451,90-451,102); use=SnapshotST.fst(127,13-131,16)
(ApplyTT @x5
@x7)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=SnapshotST.fst(127,13-131,16)
(not 
;; def=SnapshotST.fst(128,6-128,7); use=SnapshotST.fst(129,8-129,9)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x3))
)
...
;; def=SnapshotST.fst(128,6-131,11); use=SnapshotST.fst(129,8-131,11)
(= @x3
(SnapshotST.Tmp @x6
@x7))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.get_s, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_SnapshotST.Ok, constructor_distinct_SnapshotST.Tmp, disc_equation_SnapshotST.Ok, disc_equation_SnapshotST.Tmp, fuel_guarded_inversion_SnapshotST.t, projection_inverse_BoxBool_proj_0, projection_inverse_SnapshotST.Ok__0, projection_inverse_SnapshotST.Tmp__0, projection_inverse_SnapshotST.Tmp__1
...
; encoding sigelt let get_s


; <Start encoding let get_s>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SnapshotST.get_s (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SnapshotST.get_s@tok () Term)

; </end encoding let get_s>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SnapshotST.mst_pre; Namespace SnapshotST
(assert (! (HasType SnapshotST.mst_pre
Tm_type)
:named typing_SnapshotST.mst_pre))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46
;;; Fact-ids: Name SnapshotST.mst_pre; Namespace SnapshotST
(assert (! (HasType Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46
Tm_type)
:named kinding_Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name SnapshotST.mst_pre; Namespace SnapshotST
(assert (! (HasType SnapshotST.mst_pre
Tm_type)
:named function_token_typing_SnapshotST.mst_pre))
;;;;;;;;;;;;;;;;Equation for SnapshotST.mst_pre
;;; Fact-ids: Name SnapshotST.mst_pre; Namespace SnapshotST
(assert (! (= SnapshotST.mst_pre
Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46)
:named equation_SnapshotST.mst_pre))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name SnapshotST.mst_pre; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(74,23-74,33); use=SnapshotST.fst(74,23-74,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46)
...
@x1
Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46))
:qid SnapshotST_pre_typing_Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46))

:named SnapshotST_pre_typing_Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46
;;; Fact-ids: Name SnapshotST.mst_pre; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(74,23-74,33); use=SnapshotST.fst(74,23-74,33)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid SnapshotST_interpretation_Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46))
:qid SnapshotST_interpretation_Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46))

:named SnapshotST_interpretation_Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46))
(push) ;; push{2

; Starting query at SnapshotST.fst(133,0-139,68)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

(declare-fun Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293
;;; Fact-ids: 
(assert (! 
;; def=SnapshotST.fst(134,37-136,61); use=SnapshotST.fst(133,14-134,20)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293 @x0)
Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46)
 

:pattern ((Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293 @x0))
:qid typing_Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293))

:named typing_Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293
;;; Fact-ids: 
(assert (! 
;; def=SnapshotST.fst(134,37-136,61); use=SnapshotST.fst(133,14-134,20)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293 @x1)
@x0)
(let ((@lb2 @x0))
(ite (is-SnapshotST.Ok @lb2)
(ApplyTT (ApplyTT (SnapshotST.rel_s Dummy_value)
...
:pattern ((ApplyTT (Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293 @x1)
@x0))
:qid interpretation_Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293))

:named interpretation_Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293))

; Encoding query formula : forall (s: SnapshotST.state).
;   (forall (t0: SnapshotST.t).
;       (*  - Could not prove post-condition
; *)
;       forall (k: Prims.pure_post Type0).
;         (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;         ~(Ok? t0) /\ ~(Tmp? t0) ==> Prims.l_False) /\
;   (forall (any_result: SnapshotST.mst_pre).
;       (fun t0 ->
;           (match t0 with
;             | SnapshotST.Ok s0 -> SnapshotST.rel_s s0 s
;             | SnapshotST.Tmp s0 _ -> SnapshotST.rel_s s0 s)
;           <:
;           Type0) ==
;       any_result ==>
;       (forall (t0: SnapshotST.t) (_: Prims.unit) (t1: SnapshotST.t).
;           (*  - Could not prove post-condition
; *)
;           forall (k: Prims.pure_post Type0).
;             (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `val SnapshotST.put_s`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=SnapshotST.fst(133,0-139,68)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SnapshotST.state)

;; def=Prims.fst(459,77-459,89); use=SnapshotST.fst(133,14-134,20)
(and 
;; def=dummy(0,0-0,0); use=SnapshotST.fst(133,14-134,20)
(forall ((@x1 Term))
 (! (implies (HasType @x1
SnapshotST.t)
...
;; def=Prims.fst(402,27-402,88); use=SnapshotST.fst(133,14-134,20)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=SnapshotST.fst(133,14-134,20)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SnapshotST.fst(133,14-134,20)
(ApplyTT @x2
@x3)
...
;; def=SnapshotST.fst(134,26-134,28); use=SnapshotST.fst(133,14-134,20)
(not 
;; def=SnapshotST.fst(134,26-134,28); use=SnapshotST.fst(133,14-134,20)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x1))
)
...
;; def=Prims.fst(451,66-451,102); use=SnapshotST.fst(133,14-134,20)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
SnapshotST.mst_pre)

;; def=SnapshotST.fst(90,21-136,61); use=SnapshotST.fst(133,14-134,20)
(= (Tm_abs_bc360f2ff80136e3b4fc8386bf4d4293 @x0)
@x1)
)
...
;; def=SnapshotST.fst(137,12-137,14); use=SnapshotST.fst(133,14-134,20)
(not 
;; def=SnapshotST.fst(137,12-137,14); use=SnapshotST.fst(133,14-134,20)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x2))
)
...
(not 
;; def=SnapshotST.fst(137,12-137,14); use=SnapshotST.fst(133,14-134,20)
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp @x2))
)
)
label_2)
...
; encoding sigelt val SnapshotST.put_s


; <Skipped val SnapshotST.put_s/>

(push) ;; push{2

; Starting query at SnapshotST.fst(140,13-144,30)
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h SnapshotST.t Prims.unit) (h: SnapshotST.t).
;     (match h with
;       | SnapshotST.Ok s0 -> SnapshotST.rel_s s0 s
;       | SnapshotST.Tmp s0 _ -> SnapshotST.rel_s s0 s) /\
;     (forall (x: Prims.unit) (t1: SnapshotST.t).
;         (match h with
;           | SnapshotST.Ok s0 -> SnapshotST.rel_s s0 s
;           | SnapshotST.Tmp s0 _ -> SnapshotST.rel_s s0 s) /\
;         (match h with
;           | SnapshotST.Ok _ -> t1 == SnapshotST.Ok s
;           | SnapshotST.Tmp s0 _ -> t1 == SnapshotST.Tmp s0 s) ==>
;         p x t1) ==>
;     (forall (x: SnapshotST.t) (t1: SnapshotST.t).
;         h == x /\ x == t1 ==>
;         (forall (k: FStar.Pervasives.st_post_h SnapshotST.t Prims.unit).
;             (forall (x: Prims.unit) (h: SnapshotST.t). {:pattern Prims.guard_free (k x h)}
;                 p x h ==> k x h) ==>
;             (~(Ok? x) /\ ~(Tmp? x) ==> Prims.l_False) /\
;             (forall (b: SnapshotST.state).
;                 x == SnapshotST.Ok b ==>
;                 SnapshotST.rel_t t1 (SnapshotST.Ok s) /\
;                 (forall (x: Prims.unit) (t1: SnapshotST.t).
;                     SnapshotST.rel_t t1 (SnapshotST.Ok s) /\ t1 == SnapshotST.Ok s ==> k x t1)) /\
;             (~(Ok? x) ==>
;               (forall (b: SnapshotST.state) (b: SnapshotST.state).
;                   x == SnapshotST.Tmp b b ==>
;                   SnapshotST.rel_t t1 (SnapshotST.Tmp b s) /\
;                   (forall (x: Prims.unit) (t1: SnapshotST.t).
;                       SnapshotST.rel_t t1 (SnapshotST.Tmp b s) /\ t1 == SnapshotST.Tmp b s ==>
;                       k x t1)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let put_s`
...
SnapshotST.t)
(let ((@lb3 @x2))
(ite (is-SnapshotST.Ok @lb3)

;; def=SnapshotST.fst(135,51-135,61); use=SnapshotST.fst(140,13-144,30)
(Valid 
;; def=SnapshotST.fst(135,51-135,61); use=SnapshotST.fst(140,13-144,30)
(ApplyTT (ApplyTT (SnapshotST.rel_s Dummy_value)
(SnapshotST.Ok__0 @lb3))
@x0)
)

(ite (is-SnapshotST.Tmp @lb3)

;; def=SnapshotST.fst(136,51-136,61); use=SnapshotST.fst(140,13-144,30)
(Valid 
;; def=SnapshotST.fst(136,51-136,61); use=SnapshotST.fst(140,13-144,30)
(ApplyTT (ApplyTT (SnapshotST.rel_s Dummy_value)
(SnapshotST.Tmp__0 @lb3))
@x0)
)

Unreachable)))

;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(140,13-144,30)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))
...
;; def=SnapshotST.fst(138,53-138,63); use=SnapshotST.fst(140,13-144,30)
(or label_5
...
;; def=SnapshotST.fst(139,53-139,67); use=SnapshotST.fst(140,13-144,30)
(or label_6

;; def=SnapshotST.fst(139,53-139,67); use=SnapshotST.fst(140,13-144,30)
(= @x4
(SnapshotST.Tmp (SnapshotST.Tmp__0 @lb5)
@x0))
)

Unreachable))))

;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(140,13-144,30)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(140,13-144,30)
(ApplyTT (ApplyTT @x1
@x3)
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(141,10-141,13)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
SnapshotST.t)
(HasType @x4
...
;; def=SnapshotST.fst(101,59-101,66); use=SnapshotST.fst(141,10-141,13)
(= @x2
@x3)


;; def=SnapshotST.fst(101,70-101,77); use=SnapshotST.fst(141,10-141,13)
(= @x3
@x4)
)

;; def=FStar.Pervasives.fsti(478,2-479,93); use=SnapshotST.fst(140,13-144,30)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Pervasives.st_post_h SnapshotST.t
Prims.unit))
...
(forall ((@x6 Term) (@x7 Term))
 (! (implies 
;; def=FStar.Pervasives.fsti(479,62-479,70); use=SnapshotST.fst(140,13-144,30)
(Valid 
;; def=FStar.Pervasives.fsti(479,62-479,70); use=SnapshotST.fst(140,13-144,30)
(ApplyTT (ApplyTT @x1
@x6)
...
;; def=FStar.Pervasives.fsti(479,75-479,80); use=SnapshotST.fst(140,13-144,30)
(Valid 
;; def=FStar.Pervasives.fsti(479,75-479,80); use=SnapshotST.fst(140,13-144,30)
(ApplyTT (ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=SnapshotST.fst(140,13-144,30)
(and (implies 
;; def=SnapshotST.fst(141,6-141,7); use=SnapshotST.fst(142,8-142,9)
(and 
;; def=SnapshotST.fst(141,6-141,7); use=SnapshotST.fst(142,8-142,9)
(not 
;; def=SnapshotST.fst(141,6-141,7); use=SnapshotST.fst(142,8-142,9)
...
;; def=FStar.Pervasives.fsti(489,2-489,27); use=SnapshotST.fst(140,13-144,30)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
SnapshotST.state)

;; def=SnapshotST.fst(141,6-143,8); use=SnapshotST.fst(142,8-143,8)
(= @x3
(SnapshotST.Ok @x6))
)

;; def=SnapshotST.fst(92,29-92,88); use=SnapshotST.fst(143,16-143,19)
(and 
;; def=SnapshotST.fst(104,41-104,51); use=SnapshotST.fst(143,16-143,19)
(or label_8
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(143,16-143,19)
...
;; def=SnapshotST.fst(104,68-104,75); use=SnapshotST.fst(143,16-143,19)
(= @x8
(SnapshotST.Ok @x0))
)

;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(143,16-143,19)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(143,16-143,19)
(ApplyTT (ApplyTT @x5
@x7)
...
(implies 
;; def=FStar.Pervasives.fsti(472,27-472,29); use=SnapshotST.fst(140,13-144,30)
(not 
;; def=SnapshotST.fst(141,6-141,7); use=SnapshotST.fst(142,8-142,9)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x3))
)
...
;; def=SnapshotST.fst(141,6-144,12); use=SnapshotST.fst(142,8-144,12)
(= @x3
(SnapshotST.Tmp @x6
@x7))
)

;; def=SnapshotST.fst(92,29-92,88); use=SnapshotST.fst(144,16-144,19)
(and 
;; def=SnapshotST.fst(104,41-104,51); use=SnapshotST.fst(144,16-144,19)
(or label_9
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(144,16-144,19)
...
;; def=SnapshotST.fst(104,68-104,75); use=SnapshotST.fst(144,16-144,19)
(= @x9
(SnapshotST.Tmp @x6
@x0))
)

;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(144,16-144,19)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(144,16-144,19)
(ApplyTT (ApplyTT @x5
@x8)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.put_s, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, SnapshotST_pretyping_1ed7584a366d2d38a675fc91a6e7e5f1, constructor_distinct_SnapshotST.Ok, constructor_distinct_SnapshotST.Tmp, data_typing_intro_SnapshotST.Ok@tok, data_typing_intro_SnapshotST.Tmp@tok, disc_equation_SnapshotST.Ok, disc_equation_SnapshotST.Tmp, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_SnapshotST.rel_t, fuel_guarded_inversion_SnapshotST.t, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_SnapshotST.Ok__0, projection_inverse_SnapshotST.Tmp__0, projection_inverse_SnapshotST.Tmp__1, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, typing_SnapshotST.rel_s, unit_inversion, unit_typing
...
; encoding sigelt let put_s


; <Start encoding let put_s>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SnapshotST.put_s (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SnapshotST.put_s@tok () Term)

; </end encoding let put_s>

(push) ;; push{2

; Starting query at SnapshotST.fst(148,0-150,46)
...
;   (t0: SnapshotST.t).
;   (*  - Could not prove post-condition
; *) Ok? t0 ==> ~(Ok? t0) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `val SnapshotST.witness_s`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=SnapshotST.fst(148,0-150,46)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_refine_4919007296017533ad3fcdbcd84b282e)
(HasType @x1
...
;; def=SnapshotST.fst(149,41-149,47); use=SnapshotST.fst(148,16-149,24)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x1))


;; def=SnapshotST.fst(149,56-149,60); use=SnapshotST.fst(148,16-149,24)
(not 
;; def=SnapshotST.fst(149,56-149,60); use=SnapshotST.fst(148,16-149,24)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x1))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.witness_s, 1)
; STATUS: unsat
...
; encoding sigelt val SnapshotST.witness_s


; <Skipped val SnapshotST.witness_s/>

;;;;;;;;;;;;;;;;typing_Tm_abs_398a8dcc1d5750e1a61f0be4356584b9
;;; Fact-ids: Name SnapshotST.witnessed_s; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(118,22-118,40); use=SnapshotST.fst(118,22-118,40)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_398a8dcc1d5750e1a61f0be4356584b9 @x0)
Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46)
 

:pattern ((Tm_abs_398a8dcc1d5750e1a61f0be4356584b9 @x0))
:qid typing_Tm_abs_398a8dcc1d5750e1a61f0be4356584b9))

:named typing_Tm_abs_398a8dcc1d5750e1a61f0be4356584b9))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SnapshotST.witnessed_s; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(117,4-117,15); use=SnapshotST.fst(117,4-117,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_4919007296017533ad3fcdbcd84b282e)
(HasType (SnapshotST.witnessed_s @x0)
Tm_type))
 

:pattern ((SnapshotST.witnessed_s @x0))
:qid typing_SnapshotST.witnessed_s))

:named typing_SnapshotST.witnessed_s))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SnapshotST.witnessed; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(96,4-96,13); use=SnapshotST.fst(96,4-96,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate SnapshotST.t))
(HasType (SnapshotST.witnessed @x0)
Tm_type))
 

:pattern ((SnapshotST.witnessed @x0))
:qid typing_SnapshotST.witnessed))

:named typing_SnapshotST.witnessed))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_398a8dcc1d5750e1a61f0be4356584b9
;;; Fact-ids: Name SnapshotST.witnessed_s; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(118,22-118,40); use=SnapshotST.fst(118,22-118,40)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_398a8dcc1d5750e1a61f0be4356584b9 @x1)
@x0)
(SnapshotST.lift_predicate @x1
@x0))
 

:pattern ((ApplyTT (Tm_abs_398a8dcc1d5750e1a61f0be4356584b9 @x1)
@x0))
:qid interpretation_Tm_abs_398a8dcc1d5750e1a61f0be4356584b9))

:named interpretation_Tm_abs_398a8dcc1d5750e1a61f0be4356584b9))
;;;;;;;;;;;;;;;;Equation for SnapshotST.witnessed_s
;;; Fact-ids: Name SnapshotST.witnessed_s; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(117,4-117,15); use=SnapshotST.fst(117,4-117,15)
(forall ((@x0 Term))
 (! (= (SnapshotST.witnessed_s @x0)
(SnapshotST.witnessed (Tm_abs_398a8dcc1d5750e1a61f0be4356584b9 @x0)))
 

:pattern ((SnapshotST.witnessed_s @x0))
:qid equation_SnapshotST.witnessed_s))

:named equation_SnapshotST.witnessed_s))
;;;;;;;;;;;;;;;;Equation for SnapshotST.witnessed
;;; Fact-ids: Name SnapshotST.witnessed; Namespace SnapshotST
(assert (! 
;; def=SnapshotST.fst(96,4-96,13); use=SnapshotST.fst(96,4-96,13)
(forall ((@x0 Term))
 (! (= (SnapshotST.witnessed @x0)
(FStar.Monotonic.Witnessed.witnessed SnapshotST.t
SnapshotST.rel_t@tok
@x0))
 

:pattern ((SnapshotST.witnessed @x0))
:qid equation_SnapshotST.witnessed))

:named equation_SnapshotST.witnessed))
(push) ;; push{2

; Starting query at SnapshotST.fst(152,2-152,39)
...
(declare-fun Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea
Tm_type)
:named refinement_kinding_Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=SnapshotST.fst(106,21-106,50); use=SnapshotST.fst(152,2-152,39)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea)
(and (HasTypeFuel @u0
@x1
(FStar.Preorder.predicate SnapshotST.t))

;; def=SnapshotST.fst(106,35-106,49); use=SnapshotST.fst(152,2-152,39)
(Valid 
;; def=SnapshotST.fst(106,35-106,49); use=SnapshotST.fst(152,2-152,39)
(FStar.Preorder.stable SnapshotST.t
@x1
SnapshotST.rel_t@tok)
)
))
...
@x1
Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea))
:qid refinement_interpretation_Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea))

:named refinement_interpretation_Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea))
;;;;;;;;;;;;;;;;haseq for Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea))
(Valid (Prims.hasEq (FStar.Preorder.predicate SnapshotST.t))))
:named haseqTm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea))
...
;   forall (p: FStar.Pervasives.st_post_h SnapshotST.t Prims.unit) (h: SnapshotST.t).
;     Ok? h /\
;     (let SnapshotST.Ok s = h in
;       p s) /\
;     (forall (x: Prims.unit) (t1: SnapshotST.t).
;         Ok? h /\
;         (let SnapshotST.Ok s = h in
;           p s) /\ (h == t1) /\ SnapshotST.witnessed_s p ==>
;         p x t1) ==>
;     Prims.auto_squash (FStar.Preorder.stable (fun s -> SnapshotST.lift_predicate p s)
;           SnapshotST.rel_t) /\
;     (forall (any_result:
;         p: FStar.Preorder.predicate SnapshotST.t {FStar.Preorder.stable p SnapshotST.rel_t}).
;         (fun s -> SnapshotST.lift_predicate p s) == any_result ==>
;         SnapshotST.lift_predicate p h /\
;         (forall (x: Prims.unit) (t1: SnapshotST.t).
;             SnapshotST.lift_predicate p h /\
;             (h == t1) /\ SnapshotST.witnessed (fun s -> SnapshotST.lift_predicate p s) ==>
;             p x t1))


; Context: While encoding a query
; While typechecking the top-level declaration `let witness_s`
...
;; def=SnapshotST.fst(149,41-149,47); use=SnapshotST.fst(152,2-152,39)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x2))

(let ((@lb3 @x2))
(ite (is-SnapshotST.Ok @lb3)

;; def=SnapshotST.fst(149,69-149,72); use=SnapshotST.fst(152,2-152,39)
(Valid 
;; def=SnapshotST.fst(149,69-149,72); use=SnapshotST.fst(152,2-152,39)
(ApplyTT @x0
(SnapshotST.Ok__0 @lb3))
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(152,2-152,39)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))
...
;; def=SnapshotST.fst(150,20-150,28); use=SnapshotST.fst(152,2-152,39)
(or label_5
...
;; def=SnapshotST.fst(150,32-150,45); use=SnapshotST.fst(152,2-152,39)
(or label_6
...
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(152,2-152,39)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(152,2-152,39)
(ApplyTT (ApplyTT @x1
@x3)
...
;; def=Prims.fst(459,77-459,89); use=SnapshotST.fst(152,2-152,39)
(and 
;; def=SnapshotST.fst(106,35-106,49); use=SnapshotST.fst(152,20-152,38)
(or label_7
...
;; def=SnapshotST.fst(106,35-106,49); use=SnapshotST.fst(152,20-152,38)
(FStar.Preorder.stable SnapshotST.t
(Tm_abs_398a8dcc1d5750e1a61f0be4356584b9 @x0)
SnapshotST.rel_t@tok)
)
)


;; def=Prims.fst(451,66-451,102); use=SnapshotST.fst(152,2-152,39)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea)

;; def=SnapshotST.fst(106,21-152,38); use=SnapshotST.fst(152,2-152,39)
(= (Tm_abs_398a8dcc1d5750e1a61f0be4356584b9 @x0)
@x3)
)

;; def=SnapshotST.fst(92,29-92,88); use=SnapshotST.fst(152,2-152,9)
(and 
;; def=SnapshotST.fst(152,20-152,38); use=SnapshotST.fst(152,2-152,9)
(or label_8
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(152,2-152,9)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
Prims.unit)
(HasType @x5
...
;; def=SnapshotST.fst(107,63-107,71); use=SnapshotST.fst(152,2-152,9)
(= @x2
@x5)


;; def=SnapshotST.fst(107,75-107,86); use=SnapshotST.fst(152,2-152,9)
(Valid 
;; def=SnapshotST.fst(107,75-107,86); use=SnapshotST.fst(152,2-152,9)
(SnapshotST.witnessed (Tm_abs_398a8dcc1d5750e1a61f0be4356584b9 @x0))
)
...
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(152,2-152,9)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(152,2-152,9)
(ApplyTT (ApplyTT @x1
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.witness_s, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, SnapshotST_pretyping_1ed7584a366d2d38a675fc91a6e7e5f1, data_elim_SnapshotST.Ok, data_elim_SnapshotST.Tmp, equation_FStar.Preorder.stable, equation_SnapshotST.lift_predicate, equation_SnapshotST.rel_t, equation_SnapshotST.witnessed_s, fuel_guarded_inversion_SnapshotST.t, interpretation_Tm_abs_398a8dcc1d5750e1a61f0be4356584b9, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_4919007296017533ad3fcdbcd84b282e, token_correspondence_SnapshotST.rel_t
...
; encoding sigelt let witness_s


; <Start encoding let witness_s>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SnapshotST.witness_s (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SnapshotST.witness_s@tok () Term)

; </end encoding let witness_s>

(push) ;; push{2

; Starting query at SnapshotST.fst(154,0-156,65)
...
;   (t1: SnapshotST.t).
;   (*  - Could not prove post-condition
; *) Ok? t0 /\ t0 == t1 ==> ~(Ok? t1) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `val SnapshotST.recall_s`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=SnapshotST.fst(154,0-156,65)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_refine_4919007296017533ad3fcdbcd84b282e)
(HasType @x1
...
;; def=SnapshotST.fst(156,20-156,26); use=SnapshotST.fst(154,15-155,23)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x1))


;; def=SnapshotST.fst(156,30-156,38); use=SnapshotST.fst(154,15-155,23)
(= @x1
@x3)


;; def=SnapshotST.fst(156,47-156,51); use=SnapshotST.fst(154,15-155,23)
(not 
;; def=SnapshotST.fst(156,47-156,51); use=SnapshotST.fst(154,15-155,23)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x3))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.recall_s, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt val SnapshotST.recall_s


; <Skipped val SnapshotST.recall_s/>

(push) ;; push{2

; Starting query at SnapshotST.fst(158,2-158,38)
...
;;; Fact-ids: 
(assert (! 
;; def=SnapshotST.fst(109,21-109,50); use=SnapshotST.fst(158,2-158,38)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea)
...
;; def=SnapshotST.fst(109,35-109,49); use=SnapshotST.fst(158,2-158,38)
(Valid 
;; def=SnapshotST.fst(109,35-109,49); use=SnapshotST.fst(158,2-158,38)
(FStar.Preorder.stable SnapshotST.t
@x1
...
; *)
;   forall (p: FStar.Pervasives.st_post_h SnapshotST.t Prims.unit) (h: SnapshotST.t).
;     Ok? h /\ SnapshotST.witnessed_s p /\
;     (forall (x: Prims.unit) (t1: SnapshotST.t).
;         Ok? h /\ SnapshotST.witnessed_s p /\
;         Ok? h /\ (h == t1) /\
;         (let SnapshotST.Ok s = t1 in
;           p s) ==>
;         p x t1) ==>
;     Prims.auto_squash (FStar.Preorder.stable (fun s -> SnapshotST.lift_predicate p s)
;           SnapshotST.rel_t) /\
...
;         p: FStar.Preorder.predicate SnapshotST.t {FStar.Preorder.stable p SnapshotST.rel_t}).
;         (fun s -> SnapshotST.lift_predicate p s) == any_result ==>
;         SnapshotST.witnessed (fun s -> SnapshotST.lift_predicate p s) /\
;         (forall (x: Prims.unit) (t1: SnapshotST.t).
;             SnapshotST.witnessed (fun s -> SnapshotST.lift_predicate p s) /\
;             (h == t1) /\ SnapshotST.lift_predicate p t1 ==>
;             p x t1))


; Context: While encoding a query
; While typechecking the top-level declaration `let recall_s`
...
;; def=SnapshotST.fst(155,41-155,47); use=SnapshotST.fst(158,2-158,38)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x2))


;; def=SnapshotST.fst(155,51-155,64); use=SnapshotST.fst(158,2-158,38)
(Valid 
;; def=SnapshotST.fst(155,51-155,64); use=SnapshotST.fst(158,2-158,38)
(SnapshotST.witnessed_s @x0)
)
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(158,2-158,38)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))
...
;; def=SnapshotST.fst(156,20-156,26); use=SnapshotST.fst(158,2-158,38)
(or label_5
...
;; def=SnapshotST.fst(156,30-156,38); use=SnapshotST.fst(158,2-158,38)
(or label_6
...
;; def=SnapshotST.fst(156,60-156,63); use=SnapshotST.fst(158,2-158,38)
(or label_7
...
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(158,2-158,38)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(158,2-158,38)
(ApplyTT (ApplyTT @x1
@x3)
...
;; def=Prims.fst(459,77-459,89); use=SnapshotST.fst(158,2-158,38)
(and 
;; def=SnapshotST.fst(109,35-109,49); use=SnapshotST.fst(158,19-158,37)
(or label_8
...
;; def=Prims.fst(451,66-451,102); use=SnapshotST.fst(158,2-158,38)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_147d11d6b1ba3f93f4ad10616cbdd9ea)

;; def=SnapshotST.fst(109,21-158,37); use=SnapshotST.fst(158,2-158,38)
(= (Tm_abs_398a8dcc1d5750e1a61f0be4356584b9 @x0)
@x3)
)

;; def=SnapshotST.fst(92,29-92,88); use=SnapshotST.fst(158,2-158,8)
(and 
;; def=SnapshotST.fst(110,40-110,51); use=SnapshotST.fst(158,2-158,8)
(or label_9
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(158,2-158,8)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
Prims.unit)
(HasType @x5
...
;; def=SnapshotST.fst(110,69-110,77); use=SnapshotST.fst(158,2-158,8)
(= @x2
@x5)


;; def=SnapshotST.fst(158,19-158,37); use=SnapshotST.fst(158,2-158,8)
(Valid 
;; def=SnapshotST.fst(158,19-158,37); use=SnapshotST.fst(158,2-158,8)
(SnapshotST.lift_predicate @x0
@x5)
...
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(158,2-158,8)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(158,2-158,8)
(ApplyTT (ApplyTT @x1
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.recall_s, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, SnapshotST_pretyping_1ed7584a366d2d38a675fc91a6e7e5f1, data_elim_SnapshotST.Ok, data_elim_SnapshotST.Tmp, disc_equation_SnapshotST.Ok, equation_FStar.Preorder.stable, equation_SnapshotST.lift_predicate, equation_SnapshotST.rel_t, equation_SnapshotST.witnessed_s, fuel_guarded_inversion_SnapshotST.t, interpretation_Tm_abs_398a8dcc1d5750e1a61f0be4356584b9, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_4919007296017533ad3fcdbcd84b282e, token_correspondence_SnapshotST.rel_t
...
; encoding sigelt let recall_s


; <Start encoding let recall_s>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SnapshotST.recall_s (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SnapshotST.recall_s@tok () Term)

; </end encoding let recall_s>

(push) ;; push{2

; Starting query at SnapshotST.fst(162,0-164,66)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Prims.unit) (t0: SnapshotST.t) (_: Prims.unit) (t1: SnapshotST.t).
;   (*  - Could not prove post-condition
; *) Ok? t0 ==> ~(Ok? t0) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `val SnapshotST.break`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=SnapshotST.fst(162,0-164,66)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.unit)
(HasType @x1
...
;; def=SnapshotST.fst(164,23-164,29); use=SnapshotST.fst(162,12-163,20)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x1))


;; def=SnapshotST.fst(164,38-164,42); use=SnapshotST.fst(162,12-163,20)
(not 
;; def=SnapshotST.fst(164,38-164,42); use=SnapshotST.fst(162,12-163,20)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x1))
)
...
; encoding sigelt val SnapshotST.break


; <Skipped val SnapshotST.break/>

(push) ;; push{2

; Starting query at SnapshotST.fst(165,13-167,15)
...
;         (forall (b: SnapshotST.state).
;             x == SnapshotST.Ok b ==>
;             SnapshotST.rel_t t1 (SnapshotST.Tmp b b) /\
;             (forall (x: Prims.unit) (t1: SnapshotST.t).
;                 SnapshotST.rel_t t1 (SnapshotST.Tmp b b) /\ t1 == SnapshotST.Tmp b b ==> p x t1)))


; Context: While encoding a query
; While typechecking the top-level declaration `let break`
...
;; def=SnapshotST.fst(163,37-163,43); use=SnapshotST.fst(165,13-167,15)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x2))


;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(165,13-167,15)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))
...
;; def=SnapshotST.fst(164,23-164,29); use=SnapshotST.fst(165,13-167,15)
(or label_4
...
;; def=SnapshotST.fst(164,51-164,64); use=SnapshotST.fst(165,13-167,15)
(or label_5

;; def=SnapshotST.fst(164,51-164,64); use=SnapshotST.fst(165,13-167,15)
(= @x4
(SnapshotST.Tmp (SnapshotST.Ok__0 @lb5)
(SnapshotST.Ok__0 @lb5)))
)

Unreachable)))

;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(165,13-167,15)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(165,13-167,15)
(ApplyTT (ApplyTT @x1
@x3)
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(166,13-166,16)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
SnapshotST.t)
(HasType @x4
...
;; def=SnapshotST.fst(101,59-101,66); use=SnapshotST.fst(166,13-166,16)
(= @x2
@x3)


;; def=SnapshotST.fst(101,70-101,77); use=SnapshotST.fst(166,13-166,16)
(= @x3
@x4)
)

;; def=Prims.fst(459,77-459,89); use=SnapshotST.fst(165,13-167,15)
(and (implies 
;; def=SnapshotST.fst(166,6-166,10); use=SnapshotST.fst(166,6-166,10)
(not 
;; def=SnapshotST.fst(166,6-166,10); use=SnapshotST.fst(166,6-166,10)
(BoxBool_proj_0 (SnapshotST.uu___is_Ok @x3))
)
...
;; def=FStar.Pervasives.fsti(489,2-489,27); use=SnapshotST.fst(165,13-167,15)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
SnapshotST.state)
...
;; def=SnapshotST.fst(92,29-92,88); use=SnapshotST.fst(167,2-167,5)
(and 
;; def=SnapshotST.fst(104,41-104,51); use=SnapshotST.fst(167,2-167,5)
(or label_7
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(167,2-167,5)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
Prims.unit)
(HasType @x7
...
;; def=SnapshotST.fst(104,68-104,75); use=SnapshotST.fst(167,2-167,5)
(= @x7
(SnapshotST.Tmp @x5
@x5))
)

;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(167,2-167,5)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(167,2-167,5)
(ApplyTT (ApplyTT @x1
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.break, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, SnapshotST_pretyping_1ed7584a366d2d38a675fc91a6e7e5f1, constructor_distinct_SnapshotST.Ok, constructor_distinct_SnapshotST.Tmp, data_typing_intro_SnapshotST.Tmp@tok, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_SnapshotST.rel_t, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_SnapshotST.Ok__0, projection_inverse_SnapshotST.Tmp__0, projection_inverse_SnapshotST.Tmp__1, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, typing_SnapshotST.rel_s
...
; encoding sigelt let break


; <Start encoding let break>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SnapshotST.break (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SnapshotST.break@tok () Term)

; </end encoding let break>
...
; Starting query at SnapshotST.fst(169,0-171,85)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

(declare-fun Tm_abs_30b78052b262613b5a81eb43d3175b12 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_30b78052b262613b5a81eb43d3175b12
;;; Fact-ids: 
(assert (! (HasType Tm_abs_30b78052b262613b5a81eb43d3175b12
Tm_arrow_5e4fb1eea01fd6911720647f0a3cbe46)
:named typing_Tm_abs_30b78052b262613b5a81eb43d3175b12))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_30b78052b262613b5a81eb43d3175b12
;;; Fact-ids: 
(assert (! 
;; def=SnapshotST.fst(170,39-170,85); use=SnapshotST.fst(169,14-170,22)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_30b78052b262613b5a81eb43d3175b12
@x0)
(Prims.l_and (Prims.b2t (SnapshotST.uu___is_Tmp @x0))
(let ((@lb1 @x0))
(ite (is-SnapshotST.Tmp @lb1)
(ApplyTT (ApplyTT (SnapshotST.rel_s Dummy_value)
(SnapshotST.Tmp__0 @lb1))
(SnapshotST.Tmp__1 @lb1))
Tm_unit))))
 

:pattern ((ApplyTT Tm_abs_30b78052b262613b5a81eb43d3175b12
@x0))
:qid interpretation_Tm_abs_30b78052b262613b5a81eb43d3175b12))

:named interpretation_Tm_abs_30b78052b262613b5a81eb43d3175b12))

; Encoding query formula : forall (_: Prims.unit).
;   (forall (t0: SnapshotST.t).
;       (*  - Could not prove post-condition
; *) Tmp? t0 ==> ~(Tmp? t0) ==> Prims.l_False) /\
;   (forall (any_result: SnapshotST.mst_pre).
;       (fun t0 ->
;           Tmp? t0 /\
;           (let SnapshotST.Tmp s0 s1 = t0 in
;             SnapshotST.rel_s s0 s1)) ==
;       any_result ==>
;       (forall (t0: SnapshotST.t) (_: Prims.unit) (t1: SnapshotST.t).
;           (*  - Could not prove post-condition
; *) Tmp? t0 ==> ~(Tmp? t0) ==> Prims.l_False))
...
; Context: While encoding a query
; While typechecking the top-level declaration `val SnapshotST.restore`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=SnapshotST.fst(169,0-171,85)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.unit)

;; def=Prims.fst(459,77-459,89); use=SnapshotST.fst(169,14-170,22)
(and 
;; def=dummy(0,0-0,0); use=SnapshotST.fst(169,14-170,22)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
SnapshotST.t)

;; def=SnapshotST.fst(170,39-170,46); use=SnapshotST.fst(169,14-170,22)
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp @x1))


;; def=SnapshotST.fst(170,55-170,64); use=SnapshotST.fst(169,14-170,22)
(not 
;; def=SnapshotST.fst(170,55-170,64); use=SnapshotST.fst(169,14-170,22)
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp @x1))
)
...
;; def=Prims.fst(451,66-451,102); use=SnapshotST.fst(169,14-170,22)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
SnapshotST.mst_pre)

;; def=SnapshotST.fst(90,21-170,85); use=SnapshotST.fst(169,14-170,22)
(= Tm_abs_30b78052b262613b5a81eb43d3175b12
@x1)
)
...
;; def=SnapshotST.fst(171,39-171,46); use=SnapshotST.fst(169,14-170,22)
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp @x2))


;; def=SnapshotST.fst(171,55-171,63); use=SnapshotST.fst(169,14-170,22)
(not 
;; def=SnapshotST.fst(171,55-171,63); use=SnapshotST.fst(169,14-170,22)
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp @x2))
)
...
; encoding sigelt val SnapshotST.restore


; <Skipped val SnapshotST.restore/>

(push) ;; push{2

; Starting query at SnapshotST.fst(172,15-174,12)
...
;         (forall (b: SnapshotST.state) (b: SnapshotST.state).
;             x == SnapshotST.Tmp b b ==>
;             SnapshotST.rel_t t1 (SnapshotST.Ok b) /\
;             (forall (x: Prims.unit) (t1: SnapshotST.t).
;                 SnapshotST.rel_t t1 (SnapshotST.Ok b) /\ t1 == SnapshotST.Ok b ==> p x t1)))


; Context: While encoding a query
; While typechecking the top-level declaration `let restore`
...
;; def=SnapshotST.fst(170,39-170,46); use=SnapshotST.fst(172,15-174,12)
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp @x2))

(let ((@lb3 @x2))
(ite (is-SnapshotST.Tmp @lb3)

;; def=SnapshotST.fst(170,73-170,84); use=SnapshotST.fst(172,15-174,12)
(Valid 
;; def=SnapshotST.fst(170,73-170,84); use=SnapshotST.fst(172,15-174,12)
(ApplyTT (ApplyTT (SnapshotST.rel_s Dummy_value)
(SnapshotST.Tmp__0 @lb3))
(SnapshotST.Tmp__1 @lb3))
)

Unreachable))

;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(172,15-174,12)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))
...
;; def=SnapshotST.fst(171,39-171,46); use=SnapshotST.fst(172,15-174,12)
(or label_5
...
;; def=SnapshotST.fst(171,72-171,83); use=SnapshotST.fst(172,15-174,12)
(or label_6

;; def=SnapshotST.fst(171,72-171,83); use=SnapshotST.fst(172,15-174,12)
(= @x4
(SnapshotST.Ok (SnapshotST.Tmp__1 @lb5)))
)

Unreachable)))

;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(172,15-174,12)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(172,15-174,12)
(ApplyTT (ApplyTT @x1
@x3)
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(173,16-173,19)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
SnapshotST.t)
(HasType @x4
...
;; def=SnapshotST.fst(101,59-101,66); use=SnapshotST.fst(173,16-173,19)
(= @x2
@x3)


;; def=SnapshotST.fst(101,70-101,77); use=SnapshotST.fst(173,16-173,19)
(= @x3
@x4)
)

;; def=Prims.fst(459,77-459,89); use=SnapshotST.fst(172,15-174,12)
(and (implies 
;; def=SnapshotST.fst(173,6-173,13); use=SnapshotST.fst(173,6-173,13)
(not 
;; def=SnapshotST.fst(173,6-173,13); use=SnapshotST.fst(173,6-173,13)
(BoxBool_proj_0 (SnapshotST.uu___is_Tmp @x3))
)
...
;; def=FStar.Pervasives.fsti(489,2-489,27); use=SnapshotST.fst(172,15-174,12)
(forall ((@x5 Term))
 (! (implies (HasType @x5
SnapshotST.state)
...
;; def=SnapshotST.fst(92,29-92,88); use=SnapshotST.fst(174,2-174,5)
(and 
;; def=SnapshotST.fst(104,41-104,51); use=SnapshotST.fst(174,2-174,5)
(or label_8
...
;; def=SnapshotST.fst(92,39-92,88); use=SnapshotST.fst(174,2-174,5)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Prims.unit)
(HasType @x8
...
;; def=SnapshotST.fst(104,68-104,75); use=SnapshotST.fst(174,2-174,5)
(= @x8
(SnapshotST.Ok @x6))
)

;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(174,2-174,5)
(Valid 
;; def=SnapshotST.fst(92,81-92,87); use=SnapshotST.fst(174,2-174,5)
(ApplyTT (ApplyTT @x1
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SnapshotST.restore, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, SnapshotST_pretyping_1ed7584a366d2d38a675fc91a6e7e5f1, constructor_distinct_SnapshotST.Ok, data_typing_intro_SnapshotST.Ok@tok, equation_SnapshotST.rel_t, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_SnapshotST.Ok__0, projection_inverse_SnapshotST.Tmp__1
