...
; Externals for interface NatHeap


; <Start encoding val NatHeap.heap>

(declare-fun NatHeap.heap () Term)

; </end encoding val NatHeap.heap>


; <Start encoding val NatHeap.consistent>

(declare-fun NatHeap.consistent (Term Term) Term)
;;;;;;;;;;;;;;;;h0: heap -> h1: heap -> Prims.GTot Type
(declare-fun Tm_arrow_89d1d33d63d069021281d58ffae91905 () Term)
(declare-fun NatHeap.consistent@tok () Term)

; </end encoding val NatHeap.consistent>


; <Start encoding val NatHeap.ref>

(declare-fun NatHeap.ref (Term) Term)

(declare-fun NatHeap.ref@tok () Term)

; </end encoding val NatHeap.ref>


; <Start encoding val NatHeap.contains>

(declare-fun NatHeap.contains (Term Term Term) Term)
;;;;;;;;;;;;;;;;h: heap -> r: ref a -> Prims.GTot Type
(declare-fun Tm_arrow_ceb45182a187725bf8d3e4e9b3cd4d6c () Term)
(declare-fun NatHeap.contains@tok () Term)

; </end encoding val NatHeap.contains>


; <Start encoding val NatHeap.sel>

(declare-fun Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 (Term Term) Term)
(declare-fun NatHeap.sel (Term Term Term) Term)

;;;;;;;;;;;;;;;;h: heap -> r: ref a {contains h r} -> a
(declare-fun Tm_arrow_15331b364d48ebbc075165f13acf4b2b () Term)
(declare-fun NatHeap.sel@tok () Term)

; </end encoding val NatHeap.sel>


; <Start encoding val NatHeap.alloc_ref>

(declare-fun NatHeap.alloc_ref (Term Term Term) Term)

(declare-fun Tm_refine_81559c2acf3805dd0108c30eedb8fa98 (Term Term Term) Term)
;;;;;;;;;;;;;;;;h0: heap -> a: Type -> x: a   -> rh1:     (ref a & heap)       { ~(contains h0 (FStar.Pervasives.Native.fst rh1)) /\         contains (FStar.Pervasives.Native.snd rh1) (FStar.Pervasives.Native.fst rh1) /\         sel (FStar.Pervasives.Native.snd rh1) (FStar.Pervasives.Native.fst rh1) == x /\         (forall (b: Type) (r: ref b). {:pattern contains h0 r}             contains h0 r ==> contains (FStar.Pervasives.Native.snd rh1) r) /\         (forall (b: Type) (r: ref b {contains h0 r}). {:pattern sel h0 r}             sel h0 r == sel (FStar.Pervasives.Native.snd rh1) r) }
(declare-fun Tm_arrow_dbf335e43531b7498e9700c1d03ef52c () Term)
(declare-fun NatHeap.alloc_ref@tok () Term)



; </end encoding val NatHeap.alloc_ref>


; <Start encoding val NatHeap.upd>


(declare-fun NatHeap.upd (Term Term Term Term) Term)




(declare-fun Tm_refine_4289597b21978a2daf74d6c05a34b053 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;h0: heap -> r: ref a {contains h0 r} -> x: a   -> h1:     heap       { contains h1 r /\ sel h1 r == x /\         (forall (b: Type) (r': ref b). {:pattern contains h0 r'} contains h0 r' ==> contains h1 r') /\         (forall (b: Type) (r': ref b {contains h0 r'}). {:pattern sel h0 r'}             ~(r === r') ==> sel h0 r' == sel h1 r') }
(declare-fun Tm_arrow_ca318191e24b912005fc3faf5e554d12 () Term)
(declare-fun NatHeap.upd@tok () Term)





; </end encoding val NatHeap.upd>


; <Start encoding val NatHeap.emp>

(declare-fun NatHeap.emp (Dummy_sort) Term)

; </end encoding val NatHeap.emp>


; <Start encoding let max>

(declare-fun NatHeap.max (Term Term) Term)
;;;;;;;;;;;;;;;;n: Prims.nat -> m: Prims.nat -> Prims.nat
(declare-fun Tm_arrow_2bb228db8432d0cdc106cb64c22e55ba () Term)
(declare-fun NatHeap.max@tok () Term)

; </end encoding let max>


; <Start encoding val NatHeap.concat>

(declare-fun Tm_refine_f2a7258a07d1d96cb6c864908ecae400 (Term) Term)
(declare-fun NatHeap.concat (Term Term) Term)

;;;;;;;;;;;;;;;;h0: heap -> h1: heap{consistent h0 h1} -> heap
(declare-fun Tm_arrow_64a24b4cc2e238d20a15701674ddbddb () Term)
(declare-fun NatHeap.concat@tok () Term)

; </end encoding val NatHeap.concat>


; <Start encoding val NatHeap.consistent_refl>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.consistent_refl (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.consistent_refl@tok () Term)

; </end encoding val NatHeap.consistent_refl>


; <Start encoding val NatHeap.emp_consistent>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.emp_consistent (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.emp_consistent@tok () Term)

; </end encoding val NatHeap.emp_consistent>


; <Start encoding val NatHeap.upd_consistent>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.upd_consistent (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.upd_consistent@tok () Term)

; </end encoding val NatHeap.upd_consistent>


; <Start encoding val NatHeap.alloc_ref_consistent>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.alloc_ref_consistent (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.alloc_ref_consistent@tok () Term)

; </end encoding val NatHeap.alloc_ref_consistent>


; <Start encoding val NatHeap.contains_sel>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.contains_sel (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.contains_sel@tok () Term)

; </end encoding val NatHeap.contains_sel>


; <Start encoding val NatHeap.contains_upd>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.contains_upd (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.contains_upd@tok () Term)


; </end encoding val NatHeap.contains_upd>


; <Start encoding val NatHeap.contains_emp>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.contains_emp (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.contains_emp@tok () Term)

; </end encoding val NatHeap.contains_emp>


; <Start encoding val NatHeap.sel_upd1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.sel_upd1 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.sel_upd1@tok () Term)


; </end encoding val NatHeap.sel_upd1>


; <Start encoding val NatHeap.sel_upd2>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.sel_upd2 (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.sel_upd2@tok () Term)





; </end encoding val NatHeap.sel_upd2>


; <Start encoding val NatHeap.upd_sel>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.upd_sel (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.upd_sel@tok () Term)


; </end encoding val NatHeap.upd_sel>


; <Start encoding val NatHeap.contains_concat1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.contains_concat1 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.contains_concat1@tok () Term)


; </end encoding val NatHeap.contains_concat1>


; <Start encoding val NatHeap.contains_concat2>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.contains_concat2 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.contains_concat2@tok () Term)


; </end encoding val NatHeap.contains_concat2>


; <Start encoding val NatHeap.sel_concat1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.sel_concat1 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.sel_concat1@tok () Term)

(declare-fun Tm_refine_241ad8bfe898ca08359d47be04127cb2 (Term Term Term) Term)

; </end encoding val NatHeap.sel_concat1>


; <Start encoding val NatHeap.sel_concat2>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun NatHeap.sel_concat2 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun NatHeap.sel_concat2@tok () Term)



; </end encoding val NatHeap.sel_concat2>


; End Externals for interface NatHeap

(push) ;; push{1

; Internals for ImmutableST
...
(declare-fun ImmutableST.contains (Term Term Term) Term)
;;;;;;;;;;;;;;;;r: NatHeap.ref a -> h: NatHeap.heap -> Type
(declare-fun Tm_arrow_30f305aa8433b51692403b0179566424 () Term)
(declare-fun ImmutableST.contains@tok () Term)

; </end encoding let contains>


; encoding sigelt val ImmutableST.contains_lemma


; <Skipped val ImmutableST.contains_lemma/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NatHeap.ref; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(38,4-38,7); use=NatHeap.fsti(38,4-38,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (NatHeap.ref @x0)
Tm_type))
 

:pattern ((NatHeap.ref @x0))
:qid typing_NatHeap.ref))

:named typing_NatHeap.ref))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NatHeap.heap; Namespace NatHeap
(assert (! (HasType NatHeap.heap
Tm_type)
:named typing_NatHeap.heap))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NatHeap.contains; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(45,4-45,12); use=NatHeap.fsti(45,4-45,12)
...
(HasType @x2
(NatHeap.ref @x0)))
(HasType (NatHeap.contains @x0
@x1
@x2)
Tm_type))
 

:pattern ((NatHeap.contains @x0
@x1
@x2))
:qid typing_NatHeap.contains))

:named typing_NatHeap.contains))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ImmutableST.contains; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(26,4-26,12); use=ImmutableST.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
NatHeap.heap))
(HasType (ImmutableST.contains @x0
@x1
@x2)
Tm_type))
 

:pattern ((ImmutableST.contains @x0
@x1
@x2))
:qid typing_ImmutableST.contains))

:named typing_ImmutableST.contains))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
(assert (! (HasType NatHeap.heap
Tm_type)
:named function_token_typing_NatHeap.heap))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;Equation for ImmutableST.contains
;;; Fact-ids: Name ImmutableST.contains; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(26,4-26,12); use=ImmutableST.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ImmutableST.contains @x0
@x1
@x2)
(NatHeap.contains @x0
@x2
...
@x1
@x2))
:qid equation_ImmutableST.contains))

:named equation_ImmutableST.contains))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at ImmutableST.fst(34,28-34,30)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (h: NatHeap.heap) (r: NatHeap.ref a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     ImmutableST.contains r h /\
;     (forall (pure_result: Prims.unit). NatHeap.contains h r ==> p pure_result) ==>
...
;; def=ImmutableST.fst(31,30-31,44); use=ImmutableST.fst(34,28-34,30)
(Valid 
;; def=ImmutableST.fst(31,30-31,44); use=ImmutableST.fst(34,28-34,30)
(ImmutableST.contains @x0
@x2
...
;; def=Prims.fst(441,36-441,97); use=ImmutableST.fst(34,28-34,30)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=ImmutableST.fst(32,16-32,38); use=ImmutableST.fst(34,28-34,30)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=ImmutableST.fst(34,28-34,30)
(Valid 
;; def=Prims.fst(441,83-441,96); use=ImmutableST.fst(34,28-34,30)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.contains_lemma, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_ImmutableST.contains
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableST.contains_lemma (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableST.contains_lemma@tok () Term)

; </end encoding let contains_lemma>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NatHeap.sel; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(56,4-56,7); use=NatHeap.fsti(56,4-56,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
NatHeap.heap)
(HasType @x2
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x0
@x1)))
(HasType (NatHeap.sel @x0
@x1
@x2)
@x0))
 

:pattern ((NatHeap.sel @x0
@x1
@x2))
:qid typing_NatHeap.sel))

:named typing_NatHeap.sel))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name NatHeap.sel; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(58,3-58,24); use=NatHeap.fsti(58,3-58,24)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96))

:named refinement_kinding_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name NatHeap.sel; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(58,3-58,24); use=NatHeap.fsti(58,3-58,24)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(NatHeap.ref @x2))

;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(58,11-58,23)
(Valid 
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(58,11-58,23)
(NatHeap.contains @x2
@x3
...
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96))

:named refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96))
;;;;;;;;;;;;;;;;Lemma: ImmutableST.contains_lemma
;;; Fact-ids: Name ImmutableST.contains_lemma; Namespace ImmutableST
...
;; def=ImmutableST.fst(31,30-31,44); use=ImmutableST.fst(34,4-34,18)
(Valid 
;; def=ImmutableST.fst(31,30-31,44); use=ImmutableST.fst(34,4-34,18)
(ImmutableST.contains @x0
@x2
...
;; def=ImmutableST.fst(32,16-32,38); use=ImmutableST.fst(34,4-34,18)
(Valid 
;; def=ImmutableST.fst(32,16-32,38); use=ImmutableST.fst(34,4-34,18)
(NatHeap.contains @x0
@x1
...
@x2
@x1))
:qid lemma_ImmutableST.contains_lemma))
:named lemma_ImmutableST.contains_lemma))
;;;;;;;;;;;;;;;;haseq for Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96
;;; Fact-ids: Name NatHeap.sel; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(58,3-58,24); use=NatHeap.fsti(58,3-58,24)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x0
@x1)))
(Valid (Prims.hasEq (NatHeap.ref @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x0
@x1))))
:qid haseqTm_refine_bd8b23217d2ca10ddfdabbb5d0948e96))

:named haseqTm_refine_bd8b23217d2ca10ddfdabbb5d0948e96))
(push) ;; push{2

; Starting query at ImmutableST.fst(41,2-42,60)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_6f8aef5da32367b0818e015b75ddf1d7 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ImmutableST.fst(42,12-42,36); use=ImmutableST.fst(42,12-42,36)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_6f8aef5da32367b0818e015b75ddf1d7 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_6f8aef5da32367b0818e015b75ddf1d7 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7))

:named refinement_kinding_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ImmutableST.fst(42,12-42,36); use=ImmutableST.fst(42,12-42,36)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6f8aef5da32367b0818e015b75ddf1d7 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(NatHeap.ref @x2))

;; def=ImmutableST.fst(42,21-42,34); use=ImmutableST.fst(42,21-42,34)
(Valid 
;; def=ImmutableST.fst(42,21-42,34); use=ImmutableST.fst(42,21-42,34)
(ImmutableST.contains @x2
@x1
@x3)
)
))
...
(Tm_refine_6f8aef5da32367b0818e015b75ddf1d7 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7))

:named refinement_interpretation_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6f8aef5da32367b0818e015b75ddf1d7
;;; Fact-ids: 
(assert (! 
;; def=ImmutableST.fst(42,12-42,36); use=ImmutableST.fst(42,12-42,36)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6f8aef5da32367b0818e015b75ddf1d7 @x0
@x1)))
(Valid (Prims.hasEq (NatHeap.ref @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6f8aef5da32367b0818e015b75ddf1d7 @x0
@x1))))
:qid haseqTm_refine_6f8aef5da32367b0818e015b75ddf1d7))

:named haseqTm_refine_6f8aef5da32367b0818e015b75ddf1d7))


; Encoding query formula : forall (h0: NatHeap.heap) (h1: NatHeap.heap).
;   (*  - Could not prove post-condition
; *)
;   (forall (a: Type0) (r: NatHeap.ref a). ImmutableST.contains r h0 ==> ImmutableST.contains r h1) ==>
;   (forall (a: Type0).
;       (*  - Could not prove post-condition
; *)
;       forall (r: NatHeap.ref a {ImmutableST.contains r h0}).
;         (ImmutableST.contains r h0 ==> NatHeap.contains h0 r) /\
;         (forall (any_result: r: NatHeap.ref a {ImmutableST.contains r h0}).
;             r == any_result ==>
;             (forall (any_result: a).
;                 NatHeap.sel h0 r == any_result ==>
;                 ImmutableST.contains r h0 ==> NatHeap.contains h1 r)))
...
;; def=ImmutableST.fst(41,2-41,56); use=ImmutableST.fst(41,2-41,56)
...
;; def=ImmutableST.fst(41,24-41,37); use=ImmutableST.fst(41,24-41,37)
(Valid 
;; def=ImmutableST.fst(41,24-41,37); use=ImmutableST.fst(41,24-41,37)
(ImmutableST.contains @x2
@x3
...
;; def=ImmutableST.fst(41,42-41,55); use=ImmutableST.fst(41,42-41,55)
(Valid 
;; def=ImmutableST.fst(41,42-41,55); use=ImmutableST.fst(41,42-41,55)
(ImmutableST.contains @x2
@x3
...
;; def=dummy(0,0-0,0); use=ImmutableST.fst(41,2-42,60)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Tm_type)

;; def=dummy(0,0-0,0); use=ImmutableST.fst(42,12-42,59)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Tm_refine_6f8aef5da32367b0818e015b75ddf1d7 @x2
@x0))

;; def=Prims.fst(459,77-459,89); use=ImmutableST.fst(42,12-42,59)
(and (implies 
;; def=ImmutableST.fst(42,21-42,34); use=ImmutableST.fst(42,46-42,47)
(Valid 
;; def=ImmutableST.fst(42,21-42,34); use=ImmutableST.fst(42,46-42,47)
(ImmutableST.contains @x2
@x3
...
;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(42,46-42,47)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=ImmutableST.fst(42,12-42,59)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Tm_refine_6f8aef5da32367b0818e015b75ddf1d7 @x2
@x0))

;; def=NatHeap.fsti(58,3-58,4); use=ImmutableST.fst(42,12-42,59)
(= @x3
@x4)
)
...
;; def=Prims.fst(175,35-175,36); use=ImmutableST.fst(42,12-42,59)
(= (NatHeap.sel @x2
@x0
@x3)
@x5)
...
;; def=ImmutableST.fst(42,21-42,34); use=ImmutableST.fst(42,58-42,59)
(Valid 
;; def=ImmutableST.fst(42,21-42,34); use=ImmutableST.fst(42,58-42,59)
(ImmutableST.contains @x2
@x3
...
;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(42,58-42,59)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.heap_rel, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_ImmutableST.contains, refinement_interpretation_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7
...
(declare-fun ImmutableST.heap_rel (Term Term) Term)
;;;;;;;;;;;;;;;;h0: NatHeap.heap -> h1: NatHeap.heap -> Prims.logical
(declare-fun Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a () Term)
(declare-fun ImmutableST.heap_rel@tok () Term)
(declare-fun Tm_refine_6f8aef5da32367b0818e015b75ddf1d7 (Term Term) Term)
...
(declare-fun ImmutableST.ist_pre (Term) Term)

(declare-fun ImmutableST.ist_pre@tok () Term)
...
(declare-fun ImmutableST.ist_post (Term Term) Term)

(declare-fun ImmutableST.ist_post@tok () Term)
...
(declare-fun ImmutableST.ist_wp (Term Term) Term)

(declare-fun ImmutableST.ist_wp@tok () Term)
;;;;;;;;;;;;;;;;_: ist_post state a -> ist_pre state
(declare-fun Tm_arrow_fffd2177611010550ed62f4645bffe04 (Term Term) Term)

; </end encoding let ist_wp>


; encoding sigelt new_effect { ISTATE ... }


; <Skipped new_effect { ISTATE ... }/>


; encoding sigelt let lift_div_istate


; <Start encoding let lift_div_istate>

(declare-fun ImmutableST.lift_div_istate (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;state: Type ->     rel: FStar.Preorder.preorder state ->     a: Type ->     wp: Prims.pure_wp a ->     p: ist_post state a ->     s: state   -> Prims.pure_pre
(declare-fun Tm_arrow_36fb3d9008ff855c1ebbcc47e0de962d () Term)
(declare-fun ImmutableST.lift_div_istate@tok () Term)



; </end encoding let lift_div_istate>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ImmutableST.heap_rel; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(40,4-40,12); use=ImmutableST.fst(40,4-40,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
NatHeap.heap))
(HasType (ImmutableST.heap_rel @x0
@x1)
Prims.logical))
 

:pattern ((ImmutableST.heap_rel @x0
@x1))
:qid typing_ImmutableST.heap_rel))

:named typing_ImmutableST.heap_rel))
;;;;;;;;;;;;;;;;free var typing
...
;; def=ImmutableST.fst(40,4-40,12); use=ImmutableST.fst(40,4-40,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT ImmutableST.heap_rel@tok
@x0)
@x1)
(ImmutableST.heap_rel @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT ImmutableST.heap_rel@tok
@x0)
@x1))
:qid token_correspondence_ImmutableST.heap_rel))

:named token_correspondence_ImmutableST.heap_rel))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ImmutableST.heap_rel; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(42,12-42,36); use=ImmutableST.fst(42,12-42,36)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a
;;; Fact-ids: Name ImmutableST.heap_rel; Namespace ImmutableST
(assert (! (HasType Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a
Tm_type)
:named kinding_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name ImmutableST.heap_rel; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(40,4-40,12); use=ImmutableST.fst(40,4-40,12)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType ImmutableST.heap_rel@tok
Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))
...
@x1)
@x2)
(ImmutableST.heap_rel @x1
@x2))
 

:pattern ((ImmutableST.heap_rel @x1
@x2))
:qid function_token_typing_ImmutableST.heap_rel.1))
)
 

:pattern ((ApplyTT @x0
ImmutableST.heap_rel@tok))
:qid function_token_typing_ImmutableST.heap_rel))

:named function_token_typing_ImmutableST.heap_rel))
;;;;;;;;;;;;;;;;Equation for ImmutableST.heap_rel
;;; Fact-ids: Name ImmutableST.heap_rel; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(40,4-40,12); use=ImmutableST.fst(40,4-40,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (ImmutableST.heap_rel @x0
@x1))

;; def=ImmutableST.fst(41,2-42,60); use=ImmutableST.fst(41,2-42,60)
(and 
;; def=ImmutableST.fst(41,2-41,56); use=ImmutableST.fst(41,2-41,56)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
...
;;no pats
:qid equation_ImmutableST.heap_rel.1))


;; def=ImmutableST.fst(42,2-42,60); use=ImmutableST.fst(42,2-42,60)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Tm_type)
(HasType @x3
...
;; def=ImmutableST.fst(42,39-42,59); use=ImmutableST.fst(42,39-42,59)
(= (NatHeap.sel @x2
@x0
@x3)
(NatHeap.sel @x2
...
;;no pats
:qid equation_ImmutableST.heap_rel.2))
)
)
...
:pattern ((ImmutableST.heap_rel @x0
@x1))
:qid equation_ImmutableST.heap_rel))

:named equation_ImmutableST.heap_rel))
...
;;; Fact-ids: Name ImmutableST.heap_rel; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(40,17-40,31); use=ImmutableST.fst(40,17-41,59)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a)
...
@x1
Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))
:qid ImmutableST_pre_typing_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))

:named ImmutableST_pre_typing_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a
;;; Fact-ids: Name ImmutableST.heap_rel; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(40,17-40,31); use=ImmutableST.fst(40,17-41,59)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid ImmutableST_interpretation_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ImmutableST_interpretation_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))
:qid ImmutableST_interpretation_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))

:named ImmutableST_interpretation_Tm_arrow_63af1ae9f3d6fe02ff3826a7d299966a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
ImmutableST.heap_rel@tok))
:named @kick_partial_app_79f6f68177811378d6a7fbd66fed9fce))

; Encoding query formula : Prims.auto_squash (FStar.Preorder.preorder_rel ImmutableST.heap_rel)


; Context: While encoding a query
; While typechecking the top-level declaration `sub_effect DIV ~> ISTATE`
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Preorder.fst(33,40-33,56); use=ImmutableST.fst(72,48-72,56)
(or label_1

;; def=FStar.Preorder.fst(33,40-33,56); use=ImmutableST.fst(72,48-72,56)
(Valid 
;; def=FStar.Preorder.fst(33,40-33,56); use=ImmutableST.fst(72,48-72,56)
(FStar.Preorder.preorder_rel NatHeap.heap
ImmutableST.heap_rel@tok)
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_ImmutableST.heap_rel, refinement_interpretation_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7, token_correspondence_ImmutableST.heap_rel
...
; encoding sigelt sub_effect DIV ~> ISTATE


; <Skipped sub_effect DIV ~> ISTATE/>


; encoding sigelt effect IST a pre post = ImmutableST.ISTATE a


; <Skipped effect IST a pre post = ImmutableST.ISTATE a/>
...
;;;;;;;;;;;;;;;;Prop-typing for ImmutableST.heap_rel
;;; Fact-ids: Name ImmutableST.heap_rel; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(40,4-40,12); use=ImmutableST.fst(40,4-40,12)
(forall ((@x0 Term) (@x1 Term))
...
(HasType @x1
NatHeap.heap))
(Valid (Prims.subtype_of (ImmutableST.heap_rel @x0
@x1)
Prims.unit)))
 

:pattern ((Prims.subtype_of (ImmutableST.heap_rel @x0
@x1)
Prims.unit))
:qid defn_equation_ImmutableST.heap_rel))

:named defn_equation_ImmutableST.heap_rel))
...
; Starting query at ImmutableST.fst(86,58-86,78)
...
ImmutableST.heap_rel@tok))
:named @kick_partial_app_79f6f68177811378d6a7fbd66fed9fce))
(declare-fun Tm_refine_8431f4900cf090788581684621f84985 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_8431f4900cf090788581684621f84985
Tm_type)
:named refinement_kinding_Tm_refine_8431f4900cf090788581684621f84985))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ImmutableST.fst(86,18-86,55); use=ImmutableST.fst(86,18-86,55)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_8431f4900cf090788581684621f84985)
(and (HasTypeFuel @u0
@x1
(FStar.Preorder.predicate NatHeap.heap))

;; def=ImmutableST.fst(86,36-86,53); use=ImmutableST.fst(86,36-86,53)
(Valid 
;; def=ImmutableST.fst(86,36-86,53); use=ImmutableST.fst(86,36-86,53)
(FStar.Preorder.stable NatHeap.heap
@x1
ImmutableST.heap_rel@tok)
)
))
...
@x1
Tm_refine_8431f4900cf090788581684621f84985))
:qid refinement_interpretation_Tm_refine_8431f4900cf090788581684621f84985))

:named refinement_interpretation_Tm_refine_8431f4900cf090788581684621f84985))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8431f4900cf090788581684621f84985
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_8431f4900cf090788581684621f84985))
(Valid (Prims.hasEq (FStar.Preorder.predicate NatHeap.heap))))
:named haseqTm_refine_8431f4900cf090788581684621f84985))


; Encoding query formula : forall (p: FStar.Preorder.predicate NatHeap.heap {FStar.Preorder.stable p ImmutableST.heap_rel}).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash (FStar.Preorder.preorder_rel ImmutableST.heap_rel)
...
;; def=FStar.Preorder.fst(33,40-33,56); use=ImmutableST.fst(86,68-86,76)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.ist_witnessed, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_ImmutableST.heap_rel, refinement_interpretation_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7, token_correspondence_ImmutableST.heap_rel
...
; Starting query at ImmutableST.fst(86,0-86,78)
...
; Encoding query formula : forall (p: FStar.Preorder.predicate NatHeap.heap).
;   (*  - Subtyping check failed
;   - Expected type
;       rel:
;       FStar.Preorder.relation NatHeap.heap {FStar.Preorder.preorder_rel rel}
;     got type h0: NatHeap.heap -> h1: NatHeap.heap -> Prims.logical
; *)
;   Prims.auto_squash (FStar.Preorder.preorder_rel ImmutableST.heap_rel)
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ImmutableST.fst(86,58-86,78)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate NatHeap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=ImmutableST.fst(86,45-86,53)
(or label_1

;; def=FStar.Preorder.fst(35,53-35,69); use=ImmutableST.fst(86,58-86,78)
(Valid 
;; def=FStar.Preorder.fst(35,53-35,69); use=ImmutableST.fst(86,58-86,78)
(FStar.Preorder.preorder_rel NatHeap.heap
ImmutableST.heap_rel@tok)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.ist_witnessed, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_ImmutableST.heap_rel, refinement_interpretation_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7, token_correspondence_ImmutableST.heap_rel
...
(declare-fun Tm_refine_8431f4900cf090788581684621f84985 () Term)
(declare-fun ImmutableST.ist_witnessed (Term) Term)


;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate NatHeap.heap {FStar.Preorder.stable p heap_rel} -> Type
(declare-fun Tm_arrow_22fa26013a42e6d2ac7e8b20f173cfc2 () Term)
(declare-fun ImmutableST.ist_witnessed@tok () Term)
...
; encoding sigelt val ImmutableST.ist_get


; <Start encoding val ImmutableST.ist_get>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableST.ist_get (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableST.ist_get@tok () Term)

; </end encoding val ImmutableST.ist_get>


; encoding sigelt val ImmutableST.ist_put


; <Start encoding val ImmutableST.ist_put>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableST.ist_put (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableST.ist_put@tok () Term)

; </end encoding val ImmutableST.ist_put>

;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name ImmutableST.ist_witnessed; Namespace ImmutableST
(assert (! (Valid (ApplyTT __uu__PartialApp
ImmutableST.heap_rel@tok))
:named @kick_partial_app_79f6f68177811378d6a7fbd66fed9fce))
(push) ;; push{2

; Starting query at ImmutableST.fst(96,7-97,81)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val ImmutableST.ist_witness`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ImmutableST.fst(96,25-97,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate NatHeap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=ImmutableST.fst(96,51-96,59)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.ist_witness, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_ImmutableST.heap_rel, refinement_interpretation_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7, token_correspondence_ImmutableST.heap_rel
...
; encoding sigelt val ImmutableST.ist_witness


; <Start encoding val ImmutableST.ist_witness>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableST.ist_witness (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableST.ist_witness@tok () Term)

; </end encoding val ImmutableST.ist_witness>

(push) ;; push{2

; Starting query at ImmutableST.fst(99,7-100,80)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val ImmutableST.ist_recall`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ImmutableST.fst(99,25-100,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate NatHeap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=ImmutableST.fst(99,51-99,59)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.ist_recall, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_ImmutableST.heap_rel, refinement_interpretation_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7, token_correspondence_ImmutableST.heap_rel
...
; encoding sigelt val ImmutableST.ist_recall


; <Start encoding val ImmutableST.ist_recall>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableST.ist_recall (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableST.ist_recall@tok () Term)

; </end encoding val ImmutableST.ist_recall>
...
;; def=ImmutableST.fst(26,4-26,12); use=ImmutableST.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
@x1)
@x2)
(ImmutableST.contains @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
@x1)
@x2))
:qid token_correspondence_ImmutableST.contains))

:named token_correspondence_ImmutableST.contains))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_30f305aa8433b51692403b0179566424
;;; Fact-ids: Name ImmutableST.contains; Namespace ImmutableST
(assert (! (HasType Tm_arrow_30f305aa8433b51692403b0179566424
Tm_type)
:named kinding_Tm_arrow_30f305aa8433b51692403b0179566424))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name ImmutableST.contains; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(26,4-26,12); use=ImmutableST.fst(26,4-26,12)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType ImmutableST.contains@tok
Tm_arrow_30f305aa8433b51692403b0179566424))
...
@x2)
@x3)
(ImmutableST.contains @x1
@x2
@x3))
 

:pattern ((ImmutableST.contains @x1
@x2
@x3))
:qid function_token_typing_ImmutableST.contains.1))
)
 

:pattern ((ApplyTT @x0
ImmutableST.contains@tok))
:qid function_token_typing_ImmutableST.contains))

:named function_token_typing_ImmutableST.contains))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name ImmutableST.contains; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(26,17-26,40); use=ImmutableST.fst(26,17-26,60)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_30f305aa8433b51692403b0179566424)
...
@x1
Tm_arrow_30f305aa8433b51692403b0179566424))
:qid ImmutableST_pre_typing_Tm_arrow_30f305aa8433b51692403b0179566424))

:named ImmutableST_pre_typing_Tm_arrow_30f305aa8433b51692403b0179566424))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_30f305aa8433b51692403b0179566424
;;; Fact-ids: Name ImmutableST.contains; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(26,17-26,40); use=ImmutableST.fst(26,17-26,60)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid ImmutableST_interpretation_Tm_arrow_30f305aa8433b51692403b0179566424.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ImmutableST_interpretation_Tm_arrow_30f305aa8433b51692403b0179566424.2))
...
@x1)
@x2))
:qid ImmutableST_interpretation_Tm_arrow_30f305aa8433b51692403b0179566424.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_30f305aa8433b51692403b0179566424))
:qid ImmutableST_interpretation_Tm_arrow_30f305aa8433b51692403b0179566424))

:named ImmutableST_interpretation_Tm_arrow_30f305aa8433b51692403b0179566424))
(push) ;; push{2

; Starting query at ImmutableST.fst(107,20-107,55)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
ImmutableST.contains@tok))
:named @kick_partial_app_9702ea17d32bd73982c5046ef6c85939))


; Encoding query formula : forall (a: Type) (r: NatHeap.ref a).
;   (*  - Subtyping check failed
;   - Expected type
;       p:
;       FStar.Preorder.predicate NatHeap.heap {FStar.Preorder.stable p heap_rel}
;     got type h: NatHeap.heap -> Type0
; *)
;   Prims.auto_squash (FStar.Preorder.stable (ImmutableST.contains r) ImmutableST.heap_rel)


; Context: While encoding a query
; While typechecking the top-level declaration `let ref`
...
;; def=ImmutableST.fst(86,36-86,53); use=ImmutableST.fst(107,42-107,54)
(or label_1
...
;; def=ImmutableST.fst(86,36-86,53); use=ImmutableST.fst(107,42-107,54)
(FStar.Preorder.stable NatHeap.heap
(ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
@x1)
ImmutableST.heap_rel@tok)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.ref, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.Preorder.stable, equation_ImmutableST.heap_rel, token_correspondence_ImmutableST.contains, token_correspondence_ImmutableST.heap_rel
...
(declare-fun ImmutableST.ref (Term) Term)

(declare-fun ImmutableST.ref@tok () Term)
(declare-fun Tm_refine_3b96159e2f11c189d5827512307ee48c (Term) Term)
...
(declare-fun ImmutableST.st_pre () Term)
;;;;;;;;;;;;;;;;_: NatHeap.heap -> Type
(declare-fun Tm_arrow_cd8db26d696e98bc935132760b5370b0 () Term)
...
(declare-fun ImmutableST.st_post (Term) Term)

(declare-fun ImmutableST.st_post@tok () Term)
;;;;;;;;;;;;;;;;_: a -> _: NatHeap.heap -> Type
(declare-fun Tm_arrow_755c966551ede6af5ea405a11937b5a2 (Term) Term)
...
(declare-fun ImmutableST.st_wp (Term) Term)

(declare-fun ImmutableST.st_wp@tok () Term)
;;;;;;;;;;;;;;;;_: st_post a -> st_pre
(declare-fun Tm_arrow_d59e7b3361c7dcb1132a6d49c7ef725b (Term) Term)

; </end encoding let st_wp>


; encoding sigelt effect ImmutableST a pre post = ImmutableST.IST a


; <Skipped effect ImmutableST a pre post = ImmutableST.IST a/>


; encoding sigelt val ImmutableST.alloc


; <Skipped val ImmutableST.alloc/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NatHeap.alloc_ref; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(64,4-64,13); use=NatHeap.fsti(64,4-64,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
...
(HasType @x2
@x1))
(HasType (NatHeap.alloc_ref @x0
@x1
@x2)
(Tm_refine_81559c2acf3805dd0108c30eedb8fa98 @x1
@x0
@x2)))
 

:pattern ((NatHeap.alloc_ref @x0
@x1
@x2))
:qid typing_NatHeap.alloc_ref))

:named typing_NatHeap.alloc_ref))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ImmutableST.ref; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(107,5-107,8); use=ImmutableST.fst(107,5-107,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (ImmutableST.ref @x0)
Tm_type))
 

:pattern ((ImmutableST.ref @x0))
:qid typing_ImmutableST.ref))

:named typing_ImmutableST.ref))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ImmutableST.ist_witnessed; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(86,4-86,17); use=ImmutableST.fst(86,4-86,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_8431f4900cf090788581684621f84985)
(HasType (ImmutableST.ist_witnessed @x0)
Tm_type))
 

:pattern ((ImmutableST.ist_witnessed @x0))
:qid typing_ImmutableST.ist_witnessed))

:named typing_ImmutableST.ist_witnessed))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Preorder.preorder; Namespace FStar.Preorder
(assert (! 
...
;;; Fact-ids: Name NatHeap.alloc_ref; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(67,6-76,44); use=NatHeap.fsti(67,6-76,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_81559c2acf3805dd0108c30eedb8fa98 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_81559c2acf3805dd0108c30eedb8fa98 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_81559c2acf3805dd0108c30eedb8fa98))

:named refinement_kinding_Tm_refine_81559c2acf3805dd0108c30eedb8fa98))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ImmutableST.ref; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(107,20-107,55); use=ImmutableST.fst(107,20-107,55)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_3b96159e2f11c189d5827512307ee48c @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_3b96159e2f11c189d5827512307ee48c @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_3b96159e2f11c189d5827512307ee48c))

:named refinement_kinding_Tm_refine_3b96159e2f11c189d5827512307ee48c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name ImmutableST.ist_witnessed; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(86,18-86,55); use=ImmutableST.fst(86,18-86,55)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_81559c2acf3805dd0108c30eedb8fa98 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (NatHeap.ref @x2)
NatHeap.heap))

;; def=NatHeap.fsti(68,5-68,29); use=NatHeap.fsti(68,5-68,29)
(not 
;; def=NatHeap.fsti(68,6-68,29); use=NatHeap.fsti(68,6-68,29)
(Valid 
;; def=NatHeap.fsti(68,6-68,29); use=NatHeap.fsti(68,6-68,29)
(NatHeap.contains @x2
@x3
(FStar.Pervasives.Native.fst (NatHeap.ref @x2)
NatHeap.heap
@x1))
)
)
...
;; def=NatHeap.fsti(69,5-69,33); use=NatHeap.fsti(69,5-69,33)
(Valid 
;; def=NatHeap.fsti(69,5-69,33); use=NatHeap.fsti(69,5-69,33)
(NatHeap.contains @x2
(FStar.Pervasives.Native.snd (NatHeap.ref @x2)
NatHeap.heap
@x1)
(FStar.Pervasives.Native.fst (NatHeap.ref @x2)
NatHeap.heap
...
;; def=NatHeap.fsti(70,12-70,40); use=NatHeap.fsti(70,12-70,40)
(= (NatHeap.sel @x2
(FStar.Pervasives.Native.snd (NatHeap.ref @x2)
NatHeap.heap
@x1)
...
;; def=NatHeap.fsti(71,5-74,29); use=NatHeap.fsti(71,5-74,29)
...
;; def=NatHeap.fsti(72,8-72,21); use=NatHeap.fsti(72,8-72,21)
(Valid 
;; def=NatHeap.fsti(72,8-72,21); use=NatHeap.fsti(72,8-72,21)
(NatHeap.contains @x5
@x3
...
;; def=NatHeap.fsti(74,8-74,28); use=NatHeap.fsti(74,8-74,28)
(Valid 
;; def=NatHeap.fsti(74,8-74,28); use=NatHeap.fsti(74,8-74,28)
(NatHeap.contains @x5
(FStar.Pervasives.Native.snd (NatHeap.ref @x2)
...
:pattern ((NatHeap.contains @x5
@x3
@x6))
:qid refinement_interpretation_Tm_refine_81559c2acf3805dd0108c30eedb8fa98.1))


;; def=NatHeap.fsti(75,5-76,42); use=NatHeap.fsti(75,5-76,42)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Tm_type)
(HasType @x6
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x5
@x3)))

;; def=NatHeap.fsti(76,8-76,41); use=NatHeap.fsti(76,8-76,41)
(= (NatHeap.sel @x5
@x3
@x6)
(NatHeap.sel @x5
...
:pattern ((NatHeap.sel @x5
@x3
@x6))
:qid refinement_interpretation_Tm_refine_81559c2acf3805dd0108c30eedb8fa98.2))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_81559c2acf3805dd0108c30eedb8fa98))

:named refinement_interpretation_Tm_refine_81559c2acf3805dd0108c30eedb8fa98))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name ImmutableST.ref; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(107,20-107,55); use=ImmutableST.fst(107,20-107,55)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3b96159e2f11c189d5827512307ee48c @x2))
(and (HasTypeFuel @u0
@x1
(NatHeap.ref @x2))

;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(107,28-107,54)
(Valid 
;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(107,28-107,54)
(ImmutableST.ist_witnessed (ApplyTT (ApplyTT ImmutableST.contains@tok
@x2)
@x1))
)
))
...
@x1
(Tm_refine_3b96159e2f11c189d5827512307ee48c @x2)))
:qid refinement_interpretation_Tm_refine_3b96159e2f11c189d5827512307ee48c))

:named refinement_interpretation_Tm_refine_3b96159e2f11c189d5827512307ee48c))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,22-59,30); use=FStar.Pervasives.Native.fst(59,22-59,30)
...
(Valid (Prims.hasEq (FStar.Preorder.predicate NatHeap.heap))))
:named haseqTm_refine_8431f4900cf090788581684621f84985))
;;;;;;;;;;;;;;;;haseq for Tm_refine_81559c2acf3805dd0108c30eedb8fa98
;;; Fact-ids: Name NatHeap.alloc_ref; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(67,6-76,44); use=NatHeap.fsti(67,6-76,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_81559c2acf3805dd0108c30eedb8fa98 @x0
@x1
@x2)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (NatHeap.ref @x0)
NatHeap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_81559c2acf3805dd0108c30eedb8fa98 @x0
@x1
@x2))))
:qid haseqTm_refine_81559c2acf3805dd0108c30eedb8fa98))

:named haseqTm_refine_81559c2acf3805dd0108c30eedb8fa98))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3b96159e2f11c189d5827512307ee48c
;;; Fact-ids: Name ImmutableST.ref; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(107,20-107,55); use=ImmutableST.fst(107,20-107,55)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3b96159e2f11c189d5827512307ee48c @x0)))
(Valid (Prims.hasEq (NatHeap.ref @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3b96159e2f11c189d5827512307ee48c @x0))))
:qid haseqTm_refine_3b96159e2f11c189d5827512307ee48c))

:named haseqTm_refine_3b96159e2f11c189d5827512307ee48c))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,5-59,11); use=FStar.Pervasives.Native.fst(59,5-59,11)
...
;;;;;;;;;;;;;;;;Equation for ImmutableST.ref
;;; Fact-ids: Name ImmutableST.ref; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(107,5-107,8); use=ImmutableST.fst(107,5-107,8)
(forall ((@x0 Term))
 (! (= (ImmutableST.ref @x0)
(Tm_refine_3b96159e2f11c189d5827512307ee48c @x0))
 

:pattern ((ImmutableST.ref @x0))
:qid equation_ImmutableST.ref))

:named equation_ImmutableST.ref))
;;;;;;;;;;;;;;;;Equation for ImmutableST.ist_witnessed
;;; Fact-ids: Name ImmutableST.ist_witnessed; Namespace ImmutableST
(assert (! 
;; def=ImmutableST.fst(86,4-86,17); use=ImmutableST.fst(86,4-86,17)
(forall ((@x0 Term))
 (! (= (ImmutableST.ist_witnessed @x0)
(FStar.Monotonic.Witnessed.witnessed NatHeap.heap
ImmutableST.heap_rel@tok
@x0))
 

:pattern ((ImmutableST.ist_witnessed @x0))
:qid equation_ImmutableST.ist_witnessed))

:named equation_ImmutableST.ist_witnessed))
...
; Starting query at ImmutableST.fst(134,16-139,9)
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h NatHeap.heap (ImmutableST.ref a)) (h: NatHeap.heap).
;     (forall (x: ImmutableST.ref a) (s1: NatHeap.heap).
;         ~(ImmutableST.contains x h) /\ FStar.Pervasives.Native.fst (NatHeap.alloc_ref h a x) == x /\
;         FStar.Pervasives.Native.snd (NatHeap.alloc_ref h a x) == s1 ==>
;         p x s1) ==>
;     (forall (x: NatHeap.heap) (s1: NatHeap.heap).
;         h == x /\ x == s1 ==>
;         (forall (rh1: NatHeap.ref a & NatHeap.heap).
;             (~(NatHeap.contains x (FStar.Pervasives.Native.fst rh1)) /\
;               NatHeap.contains (FStar.Pervasives.Native.snd rh1) (FStar.Pervasives.Native.fst rh1) ==>
;               Prims.auto_squash (NatHeap.contains (FStar.Pervasives.Native.snd rh1)
;                     (FStar.Pervasives.Native.fst rh1))) /\
;             (~(NatHeap.contains x (FStar.Pervasives.Native.fst rh1)) /\
;               NatHeap.contains (FStar.Pervasives.Native.snd rh1) (FStar.Pervasives.Native.fst rh1) /\
;               NatHeap.sel (FStar.Pervasives.Native.snd rh1) (FStar.Pervasives.Native.fst rh1) == x /\
;               (forall (b: Type0) (r: NatHeap.ref b). {:pattern NatHeap.contains x r}
;                   NatHeap.contains x r ==> NatHeap.contains (FStar.Pervasives.Native.snd rh1) r) ==>
;               (forall (b: Type0).
;                   (*  - Could not prove post-condition
; *)
;                   forall (r: NatHeap.ref b {NatHeap.contains x r}).
;                     (*  - Subtyping check failed
;   - Expected type
;       r: NatHeap.ref b {NatHeap.contains (FStar.Pervasives.Native.snd rh1) r}
;     got type r: NatHeap.ref b {NatHeap.contains h0 r}
; *)
;                     NatHeap.contains x r ==> NatHeap.contains (FStar.Pervasives.Native.snd rh1) r))) /\
;         (forall (any_result:
;             rh1:
;             (NatHeap.ref a & NatHeap.heap)
;               { ~(NatHeap.contains x (FStar.Pervasives.Native.fst rh1)) /\
;                 NatHeap.contains (FStar.Pervasives.Native.snd rh1) (FStar.Pervasives.Native.fst rh1) /\
;                 NatHeap.sel (FStar.Pervasives.Native.snd rh1) (FStar.Pervasives.Native.fst rh1) == x /\
;                 (forall (b: Type0) (r: NatHeap.ref b). {:pattern NatHeap.contains x r}
;                     NatHeap.contains x r ==> NatHeap.contains (FStar.Pervasives.Native.snd rh1) r) /\
;                 (forall (b: Type0) (r: NatHeap.ref b {NatHeap.contains x r}).
;                     {:pattern NatHeap.sel x r}
;                     NatHeap.sel x r == NatHeap.sel (FStar.Pervasives.Native.snd rh1) r) }).
;             NatHeap.alloc_ref x a x == any_result ==>
;             ImmutableST.heap_rel s1 (FStar.Pervasives.Native.snd (NatHeap.alloc_ref x a x)) /\
;             (forall (x: Prims.unit) (s1: NatHeap.heap).
;                 ImmutableST.heap_rel s1 (FStar.Pervasives.Native.snd (NatHeap.alloc_ref x a x)) /\
;                 s1 == FStar.Pervasives.Native.snd (NatHeap.alloc_ref x a x) ==>
;                 Prims.auto_squash (FStar.Preorder.stable (ImmutableST.contains (FStar.Pervasives.Native.fst
;                               (NatHeap.alloc_ref x a x)))
;                       ImmutableST.heap_rel) /\
;                 (forall (return_val:
;                     p:
;                     FStar.Preorder.predicate NatHeap.heap
;                       {FStar.Preorder.stable p ImmutableST.heap_rel}).
;                     return_val ==
;                     ImmutableST.contains (FStar.Pervasives.Native.fst (NatHeap.alloc_ref x a x)) ==>
;                     ImmutableST.contains (FStar.Pervasives.Native.fst (NatHeap.alloc_ref x a x)) s1 /\
;                     (forall (x: Prims.unit) (s1: NatHeap.heap).
;                         ImmutableST.contains (FStar.Pervasives.Native.fst (NatHeap.alloc_ref x a x))
;                           s1 /\
;                         (s1 == s1) /\
;                         ImmutableST.ist_witnessed (ImmutableST.contains (FStar.Pervasives.Native.fst
;                                   (NatHeap.alloc_ref x a x))) ==>
;                         Prims.auto_squash (ImmutableST.ist_witnessed (ImmutableST.contains (FStar.Pervasives.Native.fst
;                                       (NatHeap.alloc_ref x a x)))) /\
;                         (forall (return_val: ImmutableST.ref a).
;                             return_val == FStar.Pervasives.Native.fst (NatHeap.alloc_ref x a x) ==>
;                             return_val == FStar.Pervasives.Native.fst (NatHeap.alloc_ref x a x) ==>
;                             p return_val s1))))))
...
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
(FStar.Pervasives.st_post_h NatHeap.heap
(ImmutableST.ref @x0)))
(HasType @x3
NatHeap.heap)

;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(134,16-139,9)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (or label_1
(HasType @x4
(ImmutableST.ref @x0)))
...
;; def=ImmutableST.fst(131,48-131,64); use=ImmutableST.fst(134,16-139,9)
(or label_3

;; def=ImmutableST.fst(131,48-131,64); use=ImmutableST.fst(134,16-139,9)
(not 
;; def=ImmutableST.fst(131,49-131,64); use=ImmutableST.fst(134,16-139,9)
(Valid 
;; def=ImmutableST.fst(131,49-131,64); use=ImmutableST.fst(134,16-139,9)
(ImmutableST.contains @x0
@x4
...
;; def=ImmutableST.fst(132,13-132,40); use=ImmutableST.fst(134,16-139,9)
(or label_4

;; def=ImmutableST.fst(132,13-132,40); use=ImmutableST.fst(134,16-139,9)
(= (FStar.Pervasives.Native.fst (NatHeap.ref @x0)
NatHeap.heap
(NatHeap.alloc_ref @x3
@x0
@x1))
@x4)
)
...
;; def=ImmutableST.fst(133,6-133,34); use=ImmutableST.fst(134,16-139,9)
(or label_5

;; def=ImmutableST.fst(133,6-133,34); use=ImmutableST.fst(134,16-139,9)
(= (FStar.Pervasives.Native.snd (NatHeap.ref @x0)
NatHeap.heap
(NatHeap.alloc_ref @x3
@x0
@x1))
...
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(134,16-139,9)
(Valid 
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(134,16-139,9)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(135,11-135,18)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
NatHeap.heap)
(HasType @x5
...
;; def=ImmutableST.fst(91,75-91,82); use=ImmutableST.fst(135,11-135,18)
(= @x3
@x4)


;; def=ImmutableST.fst(91,86-91,93); use=ImmutableST.fst(135,11-135,18)
(= @x4
@x5)
)

;; def=Prims.fst(459,77-459,89); use=ImmutableST.fst(134,16-139,9)
(and 
;; def=dummy(0,0-0,0); use=ImmutableST.fst(135,24-139,9)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(FStar.Pervasives.Native.tuple2 (NatHeap.ref @x0)
NatHeap.heap))

;; def=dummy(0,0-0,0); use=ImmutableST.fst(136,12-136,21)
(and (implies 
;; def=NatHeap.fsti(68,5-69,33); use=ImmutableST.fst(136,12-136,21)
(and 
;; def=NatHeap.fsti(68,5-68,29); use=ImmutableST.fst(136,12-136,21)
(not 
;; def=NatHeap.fsti(68,6-68,29); use=ImmutableST.fst(136,12-136,21)
(Valid 
;; def=NatHeap.fsti(68,6-68,29); use=ImmutableST.fst(136,12-136,21)
(NatHeap.contains @x0
@x4
...
;; def=NatHeap.fsti(69,5-69,33); use=ImmutableST.fst(136,12-136,21)
(Valid 
;; def=NatHeap.fsti(69,5-69,33); use=ImmutableST.fst(136,12-136,21)
(NatHeap.contains @x0
(FStar.Pervasives.Native.snd (NatHeap.ref @x0)
...
;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(136,12-136,21)
(or label_6
...
(implies 
;; def=NatHeap.fsti(68,5-74,29); use=ImmutableST.fst(136,12-136,21)
(and 
;; def=NatHeap.fsti(68,5-68,29); use=ImmutableST.fst(136,12-136,21)
(not 
;; def=NatHeap.fsti(68,6-68,29); use=ImmutableST.fst(136,12-136,21)
...
;; def=NatHeap.fsti(70,12-70,40); use=ImmutableST.fst(136,12-136,21)
(= (NatHeap.sel @x0
(FStar.Pervasives.Native.snd (NatHeap.ref @x0)
NatHeap.heap
@x6)
...
;; def=NatHeap.fsti(71,5-74,29); use=ImmutableST.fst(136,12-136,21)
...
;; def=NatHeap.fsti(72,8-72,21); use=ImmutableST.fst(136,12-136,21)
(Valid 
;; def=NatHeap.fsti(72,8-72,21); use=ImmutableST.fst(136,12-136,21)
(NatHeap.contains @x7
@x4
...
;; def=NatHeap.fsti(74,8-74,28); use=ImmutableST.fst(136,12-136,21)
(Valid 
;; def=NatHeap.fsti(74,8-74,28); use=ImmutableST.fst(136,12-136,21)
(NatHeap.contains @x7
(FStar.Pervasives.Native.snd (NatHeap.ref @x0)
...
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x7
@x4))

;; def=NatHeap.fsti(75,24-75,37); use=ImmutableST.fst(136,12-136,21)
(Valid 
;; def=NatHeap.fsti(75,24-75,37); use=ImmutableST.fst(136,12-136,21)
(NatHeap.contains @x7
@x4
...
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(76,40-76,41)
(or label_7
...
;; def=Prims.fst(451,66-451,102); use=ImmutableST.fst(134,16-139,9)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_81559c2acf3805dd0108c30eedb8fa98 @x0
@x4
@x1))

;; def=ImmutableST.fst(136,6-136,28); use=ImmutableST.fst(136,6-136,28)
(= (NatHeap.alloc_ref @x4
@x0
@x1)
@x6)
)

;; def=ImmutableST.fst(81,29-81,88); use=ImmutableST.fst(137,2-137,9)
(and 
;; def=ImmutableST.fst(94,31-94,44); use=ImmutableST.fst(137,2-137,9)
(or label_8

;; def=ImmutableST.fst(94,31-94,44); use=ImmutableST.fst(137,2-137,9)
(Valid 
;; def=ImmutableST.fst(94,31-94,44); use=ImmutableST.fst(137,2-137,9)
(ImmutableST.heap_rel @x5
(FStar.Pervasives.Native.snd (NatHeap.ref @x0)
NatHeap.heap
(NatHeap.alloc_ref @x4
@x0
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(137,2-137,9)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Prims.unit)
(HasType @x8
...
;; def=ImmutableST.fst(94,62-94,69); use=ImmutableST.fst(137,2-137,9)
(= @x8
(FStar.Pervasives.Native.snd (NatHeap.ref @x0)
NatHeap.heap
(NatHeap.alloc_ref @x4
...
;; def=Prims.fst(459,77-459,89); use=ImmutableST.fst(134,16-139,9)
(and 
;; def=ImmutableST.fst(96,42-96,59); use=ImmutableST.fst(138,14-138,34)
(or label_9
...
;; def=Prims.fst(356,2-356,58); use=ImmutableST.fst(134,16-139,9)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Tm_refine_8431f4900cf090788581684621f84985)

;; def=Prims.fst(356,26-356,41); use=ImmutableST.fst(134,16-139,9)
(= @x9
(ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
(FStar.Pervasives.Native.fst (NatHeap.ref @x0)
...
;; def=ImmutableST.fst(81,29-81,88); use=ImmutableST.fst(138,2-138,13)
(and 
;; def=ImmutableST.fst(97,31-97,35); use=ImmutableST.fst(138,2-138,13)
(or label_10
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(138,2-138,13)
...
;; def=ImmutableST.fst(97,53-97,61); use=ImmutableST.fst(138,2-138,13)
(= @x8
@x11)


;; def=ImmutableST.fst(97,65-97,80); use=ImmutableST.fst(138,2-138,13)
(Valid 
;; def=ImmutableST.fst(97,65-97,80); use=ImmutableST.fst(138,2-138,13)
(ImmutableST.ist_witnessed (ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
...
;; def=Prims.fst(459,77-459,89); use=ImmutableST.fst(134,16-139,9)
(and 
;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(139,2-139,9)
(or label_11
...
;; def=ImmutableST.fst(130,17-139,9); use=ImmutableST.fst(134,16-139,9)
(= @x12
(FStar.Pervasives.Native.fst (NatHeap.ref @x0)
NatHeap.heap
(NatHeap.alloc_ref @x4
...
;; def=FStar.Pervasives.fsti(463,24-463,34); use=ImmutableST.fst(134,16-139,9)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=ImmutableST.fst(134,16-139,9)
(ApplyTT (ApplyTT @x2
@x12)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.alloc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.stable, equation_ImmutableST.contains, equation_ImmutableST.heap_rel, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, lemma_ImmutableST.contains_lemma, refinement_interpretation_Tm_refine_6f8aef5da32367b0818e015b75ddf1d7, refinement_interpretation_Tm_refine_81559c2acf3805dd0108c30eedb8fa98, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96, token_correspondence_ImmutableST.contains, token_correspondence_ImmutableST.heap_rel, typing_FStar.Pervasives.Native.fst, typing_FStar.Pervasives.Native.snd, typing_NatHeap.heap, typing_NatHeap.ref
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableST.alloc (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableST.alloc@tok () Term)

; </end encoding let alloc>

(push) ;; push{2

; Starting query at ImmutableST.fst(142,0-147,20)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type0) (r: ImmutableST.ref a) (h0: NatHeap.heap) (x: a) (h1: NatHeap.heap).
;   (*  - Could not prove post-condition
; *)
;   h0 == h1 /\ ImmutableST.contains r h1 ==>
;   ImmutableST.ist_witnessed (ImmutableST.contains r) ==> NatHeap.contains h1 r


; Context: While encoding a query
; While typechecking the top-level declaration `val ImmutableST.read`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ImmutableST.fst(142,0-147,20)
...
;; def=ImmutableST.fst(145,41-145,49); use=ImmutableST.fst(142,14-144,17)
(= @x2
@x4)


;; def=ImmutableST.fst(146,20-146,33); use=ImmutableST.fst(142,14-144,17)
(Valid 
;; def=ImmutableST.fst(146,20-146,33); use=ImmutableST.fst(142,14-144,17)
(ImmutableST.contains @x0
@x1
...
;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(142,14-144,17)
(Valid 
;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(142,14-144,17)
(ImmutableST.ist_witnessed (ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
...
;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(147,13-147,14)
(or label_1

;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(142,14-144,17)
(Valid 
;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(142,14-144,17)
(NatHeap.contains @x0
@x4
...
; encoding sigelt val ImmutableST.read


; <Skipped val ImmutableST.read/>

(push) ;; push{2

; Starting query at ImmutableST.fst(148,15-151,9)
...
; Encoding query formula : forall (a: Type) (r: ImmutableST.ref a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h NatHeap.heap a) (h: NatHeap.heap).
;     (forall (x: a) (s1: NatHeap.heap).
;         h == s1 /\ ImmutableST.contains r s1 /\ NatHeap.sel s1 r == x ==> p x s1) ==>
;     (forall (x: NatHeap.heap) (s1: NatHeap.heap).
;         h == x /\ x == s1 ==>
;         Prims.auto_squash (FStar.Preorder.stable (ImmutableST.contains r) ImmutableST.heap_rel) /\
;         (forall (return_val:
;             p: FStar.Preorder.predicate NatHeap.heap {FStar.Preorder.stable p ImmutableST.heap_rel})
;           .
;             return_val == ImmutableST.contains r ==>
;             ImmutableST.ist_witnessed (ImmutableST.contains r) /\
;             (forall (x: Prims.unit) (s1: NatHeap.heap).
;                 ImmutableST.ist_witnessed (ImmutableST.contains r) /\
;                 (s1 == s1) /\ ImmutableST.contains r s1 ==>
;                 (ImmutableST.ist_witnessed (ImmutableST.contains r) ==> NatHeap.contains x r) /\
;                 (forall (any_result: ImmutableST.ref a).
;                     r == any_result ==>
;                     (forall (any_result: a). any_result == NatHeap.sel x r ==> p any_result s1)))))
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(148,15-151,9)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (or label_1
(HasType @x4
@x0))
...
;; def=ImmutableST.fst(145,41-145,49); use=ImmutableST.fst(148,15-151,9)
(or label_3
...
;; def=ImmutableST.fst(146,20-146,33); use=ImmutableST.fst(148,15-151,9)
(or label_4
...
;; def=ImmutableST.fst(147,6-147,19); use=ImmutableST.fst(148,15-151,9)
(or label_5
...
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(148,15-151,9)
(Valid 
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(148,15-151,9)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(149,10-149,17)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
NatHeap.heap)
(HasType @x5
...
;; def=ImmutableST.fst(91,75-91,82); use=ImmutableST.fst(149,10-149,17)
(= @x3
@x4)


;; def=ImmutableST.fst(91,86-91,93); use=ImmutableST.fst(149,10-149,17)
(= @x4
@x5)
)

;; def=Prims.fst(459,77-459,89); use=ImmutableST.fst(148,15-151,9)
(and 
;; def=ImmutableST.fst(99,42-99,59); use=ImmutableST.fst(150,13-150,25)
(or label_6
...
;; def=Prims.fst(356,2-356,58); use=ImmutableST.fst(148,15-151,9)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Tm_refine_8431f4900cf090788581684621f84985)

;; def=Prims.fst(356,26-356,41); use=ImmutableST.fst(148,15-151,9)
(= @x6
(ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
@x1))
...
;; def=ImmutableST.fst(81,29-81,88); use=ImmutableST.fst(150,2-150,12)
(and 
;; def=ImmutableST.fst(100,30-100,45); use=ImmutableST.fst(150,2-150,12)
(or label_7
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(150,2-150,12)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Prims.unit)
(HasType @x8
...
;; def=ImmutableST.fst(100,63-100,71); use=ImmutableST.fst(150,2-150,12)
(= @x5
@x8)


;; def=ImmutableST.fst(100,75-100,79); use=ImmutableST.fst(150,2-150,12)
(Valid 
;; def=ImmutableST.fst(100,75-100,79); use=ImmutableST.fst(150,2-150,12)
(ImmutableST.contains @x0
@x1
...
;; def=Prims.fst(459,77-459,89); use=ImmutableST.fst(148,15-151,9)
(and (implies 
;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(151,8-151,9)
(Valid 
;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(151,8-151,9)
(ImmutableST.ist_witnessed (ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
...
;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(151,8-151,9)
(or label_8
...
;; def=Prims.fst(451,66-451,102); use=ImmutableST.fst(148,15-151,9)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(ImmutableST.ref @x0))

;; def=NatHeap.fsti(58,3-58,4); use=ImmutableST.fst(148,15-151,9)
(= @x1
@x9)
)
...
;; def=ImmutableST.fst(148,10-151,9); use=ImmutableST.fst(148,15-151,9)
(= @x10
(NatHeap.sel @x0
@x4
@x1))
...
;; def=FStar.Pervasives.fsti(463,24-463,34); use=ImmutableST.fst(148,15-151,9)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=ImmutableST.fst(148,15-151,9)
(ApplyTT (ApplyTT @x2
@x10)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.read, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.stable, equation_ImmutableST.contains, equation_ImmutableST.heap_rel, equation_ImmutableST.ref, refinement_interpretation_Tm_refine_3b96159e2f11c189d5827512307ee48c, token_correspondence_ImmutableST.contains, token_correspondence_ImmutableST.heap_rel
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableST.read (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableST.read@tok () Term)

; </end encoding let read>

(push) ;; push{2

; Starting query at ImmutableST.fst(154,0-159,54)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type0) (r: ImmutableST.ref a) (x: a) (h0: NatHeap.heap).
;   (*  - Could not prove post-condition
; *)
;   ImmutableST.contains r h0 ==>
;   ImmutableST.ist_witnessed (ImmutableST.contains r) ==> NatHeap.contains h0 r


; Context: While encoding a query
; While typechecking the top-level declaration `val ImmutableST.write`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ImmutableST.fst(154,0-159,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=ImmutableST.fst(157,38-157,51); use=ImmutableST.fst(154,15-157,21)
(Valid 
;; def=ImmutableST.fst(157,38-157,51); use=ImmutableST.fst(154,15-157,21)
(ImmutableST.contains @x0
@x1
...
;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(154,15-157,21)
(Valid 
;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(154,15-157,21)
(ImmutableST.ist_witnessed (ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
...
;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(158,45-158,46)
(or label_1

;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(154,15-157,21)
(Valid 
;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(154,15-157,21)
(NatHeap.contains @x0
@x3
...
; encoding sigelt val ImmutableST.write


; <Skipped val ImmutableST.write/>

(push) ;; push{2

; Starting query at ImmutableST.fst(160,18-162,11)
...
; Encoding query formula : forall (a: Type) (r: ImmutableST.ref a) (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h NatHeap.heap Prims.unit) (h: NatHeap.heap).
;     ImmutableST.contains r h /\ NatHeap.sel h r == x /\
;     (forall (x: Prims.unit) (s1: NatHeap.heap).
;         ImmutableST.contains r h /\ NatHeap.sel h r == x /\ h == s1 ==> p x s1) ==>
;     (forall (x: NatHeap.heap) (s1: NatHeap.heap).
;         h == x /\ x == s1 ==>
;         ImmutableST.heap_rel s1 x /\
;         (forall (x: Prims.unit) (s1: NatHeap.heap). ImmutableST.heap_rel s1 x /\ s1 == x ==> p x s1)
;     )
...
;; def=ImmutableST.fst(157,38-157,51); use=ImmutableST.fst(160,18-162,11)
(Valid 
;; def=ImmutableST.fst(157,38-157,51); use=ImmutableST.fst(160,18-162,11)
(ImmutableST.contains @x0
@x1
...
;; def=ImmutableST.fst(158,38-158,51); use=ImmutableST.fst(160,18-162,11)
(= (NatHeap.sel @x0
@x4
@x1)
@x2)
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(160,18-162,11)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))
...
;; def=ImmutableST.fst(159,45-159,53); use=ImmutableST.fst(160,18-162,11)
(or label_5
...
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(160,18-162,11)
(Valid 
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(160,18-162,11)
(ApplyTT (ApplyTT @x3
@x5)
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(161,10-161,17)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
NatHeap.heap)
(HasType @x6
...
;; def=ImmutableST.fst(91,75-91,82); use=ImmutableST.fst(161,10-161,17)
(= @x4
@x5)


;; def=ImmutableST.fst(91,86-91,93); use=ImmutableST.fst(161,10-161,17)
(= @x5
@x6)
)

;; def=ImmutableST.fst(81,29-81,88); use=ImmutableST.fst(162,2-162,9)
(and 
;; def=ImmutableST.fst(94,31-94,44); use=ImmutableST.fst(162,2-162,9)
(or label_6

;; def=ImmutableST.fst(94,31-94,44); use=ImmutableST.fst(162,2-162,9)
(Valid 
;; def=ImmutableST.fst(94,31-94,44); use=ImmutableST.fst(162,2-162,9)
(ImmutableST.heap_rel @x6
@x5)
)
)


;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(162,2-162,9)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Prims.unit)
(HasType @x8
...
;; def=ImmutableST.fst(94,62-94,69); use=ImmutableST.fst(162,2-162,9)
(= @x8
@x5)
)

;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(162,2-162,9)
(Valid 
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(162,2-162,9)
(ApplyTT (ApplyTT @x3
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.write, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_ImmutableST.heap_rel
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableST.write (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableST.write@tok () Term)

; </end encoding let write>

(push) ;; push{2

; Starting query at ImmutableST.fst(167,0-172,58)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val ImmutableST.write_nop`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=ImmutableST.fst(167,0-172,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=ImmutableST.fst(170,35-170,48); use=ImmutableST.fst(167,19-170,18)
(Valid 
;; def=ImmutableST.fst(170,35-170,48); use=ImmutableST.fst(167,19-170,18)
(ImmutableST.contains @x0
@x1
...
;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(167,19-170,18)
(Valid 
;; def=ImmutableST.fst(107,28-107,54); use=ImmutableST.fst(167,19-170,18)
(ImmutableST.ist_witnessed (ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
...
;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(171,42-171,43)
(or label_1

;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(167,19-170,18)
(Valid 
;; def=NatHeap.fsti(58,11-58,23); use=ImmutableST.fst(167,19-170,18)
(NatHeap.contains @x0
@x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.write_nop, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_ImmutableST.contains
...
; encoding sigelt val ImmutableST.write_nop


; <Skipped val ImmutableST.write_nop/>

(push) ;; push{2

; Starting query at ImmutableST.fst(173,23-173,25)
...
;     (forall (x: Prims.unit) (s1: NatHeap.heap).
;         ImmutableST.contains r h /\ NatHeap.sel h r == x /\ h == s1 ==> p x s1) ==>
;     (forall (any_result: Prims.unit). p any_result h)


; Context: While encoding a query
; While typechecking the top-level declaration `let write_nop`
...
;; def=ImmutableST.fst(170,35-170,48); use=ImmutableST.fst(173,23-173,25)
(Valid 
;; def=ImmutableST.fst(170,35-170,48); use=ImmutableST.fst(173,23-173,25)
(ImmutableST.contains @x0
@x1
...
;; def=ImmutableST.fst(171,35-171,48); use=ImmutableST.fst(173,23-173,25)
(= (NatHeap.sel @x0
@x4
@x1)
@x2)
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(173,23-173,25)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))
...
;; def=ImmutableST.fst(172,49-172,57); use=ImmutableST.fst(173,23-173,25)
(or label_5
...
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(173,23-173,25)
(Valid 
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(173,23-173,25)
(ApplyTT (ApplyTT @x3
@x5)
...
;; def=ImmutableST.fst(71,97-71,102); use=ImmutableST.fst(72,27-72,42)
(Valid 
;; def=ImmutableST.fst(71,97-71,102); use=ImmutableST.fst(72,27-72,42)
(ApplyTT (ApplyTT @x3
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.write_nop, 2)
; STATUS: unsat
...
; encoding sigelt let write_nop


; <Start encoding let write_nop>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun ImmutableST.write_nop (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun ImmutableST.write_nop@tok () Term)

; </end encoding let write_nop>


; encoding sigelt val ImmutableST.recall


; <Skipped val ImmutableST.recall/>

(push) ;; push{2

; Starting query at ImmutableST.fst(185,2-185,25)
...
; *)
;   forall (p: FStar.Pervasives.st_post_h NatHeap.heap Prims.unit) (h: NatHeap.heap).
;     (forall (x: Prims.unit) (s1: NatHeap.heap). h == s1 /\ ImmutableST.contains r s1 ==> p x s1) ==>
;     Prims.auto_squash (FStar.Preorder.stable (ImmutableST.contains r) ImmutableST.heap_rel) /\
;     (forall (return_val:
;         p: FStar.Preorder.predicate NatHeap.heap {FStar.Preorder.stable p ImmutableST.heap_rel}).
;         return_val == ImmutableST.contains r ==>
...
;         (forall (x: Prims.unit) (s1: NatHeap.heap).
;             ImmutableST.ist_witnessed (ImmutableST.contains r) /\
;             (h == s1) /\ ImmutableST.contains r s1 ==>
;             p x s1))
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(185,2-185,25)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))
...
;; def=ImmutableST.fst(182,46-182,54); use=ImmutableST.fst(185,2-185,25)
(or label_3
...
;; def=ImmutableST.fst(183,25-183,38); use=ImmutableST.fst(185,2-185,25)
(or label_4
...
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(185,2-185,25)
(Valid 
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(185,2-185,25)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=Prims.fst(459,77-459,89); use=ImmutableST.fst(185,2-185,25)
(and 
;; def=ImmutableST.fst(99,42-99,59); use=ImmutableST.fst(185,13-185,25)
(or label_5
...
;; def=Prims.fst(356,2-356,58); use=ImmutableST.fst(185,2-185,25)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_refine_8431f4900cf090788581684621f84985)

;; def=Prims.fst(356,26-356,41); use=ImmutableST.fst(185,2-185,25)
(= @x4
(ApplyTT (ApplyTT ImmutableST.contains@tok
@x0)
@x1))
...
;; def=ImmutableST.fst(81,29-81,88); use=ImmutableST.fst(185,2-185,12)
(and 
;; def=ImmutableST.fst(100,30-100,45); use=ImmutableST.fst(185,2-185,12)
(or label_6
...
;; def=ImmutableST.fst(81,39-81,88); use=ImmutableST.fst(185,2-185,12)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.unit)
(HasType @x6
...
;; def=ImmutableST.fst(100,63-100,71); use=ImmutableST.fst(185,2-185,12)
(= @x3
@x6)


;; def=ImmutableST.fst(100,75-100,79); use=ImmutableST.fst(185,2-185,12)
(Valid 
;; def=ImmutableST.fst(100,75-100,79); use=ImmutableST.fst(185,2-185,12)
(ImmutableST.contains @x0
@x1
...
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(185,2-185,12)
(Valid 
;; def=ImmutableST.fst(81,81-81,87); use=ImmutableST.fst(185,2-185,12)
(ApplyTT (ApplyTT @x2
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ImmutableST.recall, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.stable, equation_ImmutableST.heap_rel, equation_ImmutableST.ref, refinement_interpretation_Tm_refine_3b96159e2f11c189d5827512307ee48c, token_correspondence_ImmutableST.contains, token_correspondence_ImmutableST.heap_rel
