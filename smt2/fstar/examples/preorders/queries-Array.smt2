...
; encoding sigelt val Array.array


; <Start encoding val Array.array>

(declare-fun Array.array (Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.nat -> _: Type -> Type
(declare-fun Tm_arrow_505dc2449bd54cb861d3429f6cb919f3 () Term)
(declare-fun Array.array@tok () Term)

; </end encoding val Array.array>


; encoding sigelt val Array.fresh


; <Start encoding val Array.fresh>

(declare-fun Array.fresh (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: array n a -> h0: FStar.Monotonic.Heap.heap -> h1: FStar.Monotonic.Heap.heap -> Type
(declare-fun Tm_arrow_4e68ccfa0bd58587a8e32cc99bdec132 () Term)
(declare-fun Array.fresh@tok () Term)

; </end encoding val Array.fresh>


; encoding sigelt val Array.addr_of


; <Start encoding val Array.addr_of>

(declare-fun Array.addr_of (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: array n a -> Prims.GTot Prims.nat
(declare-fun Tm_ghost_arrow_2c0e1264695c985c87658157eb470d98 () Term)
(declare-fun Array.addr_of@tok () Term)

; </end encoding val Array.addr_of>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Array.fresh; Namespace Array
(assert (! 
;; def=Array.fsti(26,4-26,9); use=Array.fsti(26,4-26,9)
...
:pattern ((Array.fresh @x0
@x1
@x2
@x3
@x4))
:qid typing_Array.fresh))

:named typing_Array.fresh))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Array.array; Namespace Array
(assert (! 
;; def=Array.fsti(24,4-24,9); use=Array.fsti(24,4-24,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
Tm_type))
(HasType (Array.array @x0
@x1)
Tm_type))
 

:pattern ((Array.array @x0
@x1))
:qid typing_Array.array))

:named typing_Array.array))
;;;;;;;;;;;;;;;;refinement kinding
...
; Starting query at Array.fsti(30,0-32,72)
...
; *) Array.fresh x h0 h1 ==> Prims.hasEq Prims.nat


; Context: While encoding a query
; While typechecking the top-level declaration `val Array.create`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Array.fsti(30,0-32,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=Array.fsti(32,29-32,42); use=Array.fsti(30,14-30,45)
(Valid 
;; def=Array.fsti(32,29-32,42); use=Array.fsti(30,14-30,45)
(Array.fresh @x0
@x1
...
;; def=Prims.fst(73,23-73,30); use=Array.fsti(32,46-32,54)
(or label_1

;; def=Prims.fst(73,23-73,30); use=Array.fsti(30,14-30,45)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Array.fsti(30,14-30,45)
...
; encoding sigelt val Array.create


; <Start encoding val Array.create>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Array.create (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Array.create@tok () Term)

; </end encoding val Array.create>
...
(declare-fun Array.index (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: array n a -> Type
(declare-fun Tm_arrow_b0dd46400a9fc5c4d46fe66e4c874334 () Term)
(declare-fun Array.index@tok () Term)


; </end encoding let index>


; encoding sigelt val Array.sub


; <Start encoding val Array.sub>

(declare-fun Tm_refine_6f684e27d6af9965634108bcfe981953 (Term Term) Term)
(declare-fun Array.sub (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: array n a -> i: index x -> len: Prims.nat{i + len <= n} -> array len a
(declare-fun Tm_arrow_d15eae78e1b4a2be479760fcae0895d9 () Term)
(declare-fun Array.sub@tok () Term)

; </end encoding val Array.sub>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Array.index; Namespace Array
(assert (! 
;; def=Array.fsti(35,4-35,9); use=Array.fsti(35,4-35,9)
...
(Array.array @x1
@x0)))
(HasType (Array.index @x0
@x1
@x2)
Tm_type))
 

:pattern ((Array.index @x0
@x1
@x2))
:qid typing_Array.index))

:named typing_Array.index))
;;;;;;;;;;;;;;;;refinement kinding
...
@x1
@x2))
:qid equation_Array.index))

:named equation_Array.index))
(push) ;; push{2

; Starting query at Array.fsti(39,75-39,90)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (n: Prims.nat) (x: Array.array n a) (i: Array.index x).
;   n - i >= 0 /\ (n - i >= 0) /\ (i + (n - i) <= n)


; Context: While encoding a query
; While typechecking the top-level declaration `let suffix`
...
;; def=Array.fsti(39,63-39,90); use=Array.fsti(39,63-39,90)
(and 
;; def=Prims.fst(680,18-680,24); use=Array.fsti(39,63-39,70)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Array.fsti(39,75-39,90)
...
;; def=Prims.fst(680,18-680,24); use=Array.fsti(39,83-39,90)
(or label_2
...
;; def=Array.fsti(37,66-37,78); use=Array.fsti(39,83-39,90)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Array.suffix, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Array.index, equation_Prims.nat, int_inversion, primitive_Prims.op_Addition, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_c1424615841f28cac7fc34e92b7ff33c
...
; encoding sigelt let suffix


; <Start encoding let suffix>

(declare-fun Array.suffix (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: array n a -> i: index x -> array (n - i) a
(declare-fun Tm_arrow_f421ac59b836caefdc5ce5bf0963bb3e () Term)
(declare-fun Array.suffix@tok () Term)

; </end encoding let suffix>

(push) ;; push{2

; Starting query at Array.fsti(41,69-41,78)
...
;   (*  - Could not prove post-condition
; *)
;   0 < n /\ (forall (any_result: Prims.int). 0 == any_result ==> i < n ==> 0 + i <= n)


; Context: While encoding a query
; While typechecking the top-level declaration `let prefix`
...
;; def=Prims.fst(459,77-459,89); use=Array.fsti(41,69-41,78)
(and 
;; def=Array.fsti(35,51-35,56); use=Array.fsti(41,75-41,76)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=Array.fsti(41,69-41,78)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.int)

;; def=Array.fsti(37,45-41,76); use=Array.fsti(41,69-41,78)
(= (BoxInt 0)
@x4)


;; def=Array.fsti(35,51-35,56); use=Array.fsti(41,77-41,78)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x1))
)

;; def=Array.fsti(37,66-37,78); use=Array.fsti(41,77-41,78)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Array.prefix, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Array.index, equation_Prims.nat, int_inversion, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_c1424615841f28cac7fc34e92b7ff33c
...
(declare-fun Array.prefix (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: array n a -> i: index x -> array i a
(declare-fun Tm_arrow_e6d9318eb2f25cd5806b5bf174176d1c () Term)
(declare-fun Array.prefix@tok () Term)

; </end encoding let prefix>


; encoding sigelt val Array.op_String_Access


; <Start encoding val Array.op_String_Access>

(declare-fun Array.op_String_Access (Term Term Term Term) Term)
(declare-fun Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05 (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Monotonic.Heap.heap -> _: array n a   -> Prims.GTot     (s: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a) {FStar.Seq.Base.length s == n})
(declare-fun Tm_ghost_arrow_2630fe44c61d210edb6f0e39cb5f30c1 () Term)
(declare-fun Array.op_String_Access@tok () Term)


; </end encoding val Array.op_String_Access>


; encoding sigelt val Array.as_seq


; <Start encoding val Array.as_seq>

(declare-fun Array.as_seq (Term Term Term Term) Term)


(declare-fun Array.as_seq@tok () Term)


; </end encoding val Array.as_seq>


; encoding sigelt val Array.init_at


; <Start encoding val Array.init_at>

(declare-fun Array.init_at (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: array n a -> i: index x -> Type
(declare-fun Tm_arrow_ddcceb341f3ee5469fc9afc2a50c1a29 () Term)
(declare-fun Array.init_at@tok () Term)

; </end encoding val Array.init_at>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Array.op_String_Access; Namespace Array
(assert (! 
;; def=Array.fsti(44,4-44,20); use=Array.fsti(44,4-44,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Array.array @x1
@x0)))
(HasType (Array.op_String_Access @x0
@x1
@x2
@x3)
(Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05 @x0
@x1)))
 

:pattern ((Array.op_String_Access @x0
@x1
@x2
@x3))
:qid typing_Array.op_String_Access))

:named typing_Array.op_String_Access))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Array.addr_of; Namespace Array
(assert (! 
;; def=Array.fsti(27,4-27,11); use=Array.fsti(27,4-27,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Array.array @x1
@x0)))
(HasType (Array.addr_of @x0
@x1
@x2)
Prims.nat))
 

:pattern ((Array.addr_of @x0
@x1
@x2))
:qid typing_Array.addr_of))

:named typing_Array.addr_of))
...
;;; Fact-ids: Name Array.op_String_Access; Namespace Array
(assert (! 
;; def=Array.fsti(44,70-44,111); use=Array.fsti(44,70-44,111)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05))

:named refinement_kinding_Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Array.op_String_Access; Namespace Array
(assert (! 
;; def=Array.fsti(44,70-44,111); use=Array.fsti(44,70-44,111)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Seq.Base.seq (FStar.Pervasives.Native.option @x2)))

;; def=Array.fsti(44,92-44,109); use=Array.fsti(44,92-44,109)
(= (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x2)
@x1)
@x3)
))
...
(Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05))

:named refinement_interpretation_Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.Pervasives.Native.option; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.None; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Some; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=FStar.Pervasives.Native.fst(33,4-33,8)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05
;;; Fact-ids: Name Array.op_String_Access; Namespace Array
(assert (! 
;; def=Array.fsti(44,70-44,111); use=Array.fsti(44,70-44,111)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05 @x0
@x1)))
(Valid (Prims.hasEq (FStar.Seq.Base.seq (FStar.Pervasives.Native.option @x0)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05 @x0
@x1))))
:qid haseqTm_refine_f8748f2c4bb01ce8dbf24e61721eef05))

:named haseqTm_refine_f8748f2c4bb01ce8dbf24e61721eef05))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Prims.prop
Tm_type)
...
; Starting query at Array.fsti(50,0-52,130)
...
; *)
;   Prims.hasEq Prims.nat /\
;   (FStar.Monotonic.Heap.modifies (FStar.Set.singleton (Array.addr_of x)) h0 h1 ==>
;     (forall (any_result: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a)).
;         h1.[ x ] == any_result ==>
;         (forall (any_result: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a)).
;             h0.[ x ] == any_result ==> i < n ==> i < FStar.Seq.Base.length h0.[ x ])))


; Context: While encoding a query
; While typechecking the top-level declaration `val Array.write`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Array.fsti(50,0-52,130)
...
;; def=Prims.fst(451,66-451,102); use=Array.fsti(50,14-50,74)
(and 
;; def=Prims.fst(73,23-73,30); use=Array.fsti(52,30-52,38)
(or label_1

;; def=Prims.fst(73,23-73,30); use=Array.fsti(50,14-50,74)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Array.fsti(50,14-50,74)
(Prims.hasEq Prims.nat)
)
...
(implies 
;; def=Array.fsti(52,30-52,72); use=Array.fsti(50,14-50,74)
(Valid 
;; def=Array.fsti(52,30-52,72); use=Array.fsti(50,14-50,74)
...
;; def=Prims.fst(175,35-175,36); use=Array.fsti(50,14-50,74)
(= (Array.op_String_Access @x0
@x1
@x7
@x2)
@x8)
...
;; def=FStar.Seq.Base.fsti(56,20-56,21); use=Array.fsti(50,14-50,74)
(= (Array.op_String_Access @x0
@x1
@x5
@x2)
...
;; def=Array.fsti(35,51-35,56); use=Array.fsti(50,14-50,74)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x1))
)

;; def=FStar.Seq.Base.fsti(56,37-56,49); use=Array.fsti(52,101-52,102)
(or label_2

;; def=FStar.Seq.Base.fsti(56,37-56,49); use=Array.fsti(50,14-50,74)
(< (BoxInt_proj_0 @x3)
...
; encoding sigelt val Array.write


; <Start encoding val Array.write>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Array.write (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Array.write@tok () Term)

; </end encoding val Array.write>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Array.init_at; Namespace Array
(assert (! 
;; def=Array.fsti(48,4-48,11); use=Array.fsti(48,4-48,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((Array.init_at @x0
@x1
@x2
@x3))
:qid typing_Array.init_at))

:named typing_Array.init_at))
...
; Starting query at Array.fsti(54,0-56,87)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_1149e68b2ae79cad091412a2fe195a3c (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Array.fsti(54,46-54,70); use=Array.fsti(54,46-54,70)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_1149e68b2ae79cad091412a2fe195a3c @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_1149e68b2ae79cad091412a2fe195a3c @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_1149e68b2ae79cad091412a2fe195a3c))

:named refinement_kinding_Tm_refine_1149e68b2ae79cad091412a2fe195a3c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Array.fsti(54,46-54,70); use=Array.fsti(54,46-54,70)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1149e68b2ae79cad091412a2fe195a3c @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Array.fsti(54,56-54,69); use=Array.fsti(54,56-54,69)
(Valid 
;; def=Array.fsti(54,56-54,69); use=Array.fsti(54,56-54,69)
(Array.init_at @x2
@x3
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_1149e68b2ae79cad091412a2fe195a3c))

:named refinement_interpretation_Tm_refine_1149e68b2ae79cad091412a2fe195a3c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1149e68b2ae79cad091412a2fe195a3c
;;; Fact-ids: 
(assert (! 
;; def=Array.fsti(54,46-54,70); use=Array.fsti(54,46-54,70)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1149e68b2ae79cad091412a2fe195a3c @x0
@x1
@x2)))
(Valid (Prims.hasEq (Array.index @x0
@x1
@x2))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_1149e68b2ae79cad091412a2fe195a3c @x0
@x1
@x2))))
:qid haseqTm_refine_1149e68b2ae79cad091412a2fe195a3c))

:named haseqTm_refine_1149e68b2ae79cad091412a2fe195a3c))

; Encoding query formula : forall (a: Type0)
;   (n: Prims.nat)
;   (x: Array.array n a)
;   (i: Array.index x {Array.init_at x i})
;   (h0: FStar.Monotonic.Heap.heap)
;   (r: a)
;   (h1: FStar.Monotonic.Heap.heap).
;   (*  - Could not prove post-condition
; *)
;   Prims.hasEq Prims.nat /\
;   (FStar.Monotonic.Heap.modifies FStar.Set.empty h0 h1 ==>
;     (forall (any_result: FStar.Seq.Base.seq (FStar.Pervasives.Native.option a)).
;         h0.[ x ] == any_result ==> i < n /\ Array.init_at x i ==> i < FStar.Seq.Base.length h0.[ x ]
;     ))


; Context: While encoding a query
; While typechecking the top-level declaration `val Array.read`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Array.fsti(54,0-56,87)
...
@x0))
(HasType @x3
(Tm_refine_1149e68b2ae79cad091412a2fe195a3c @x0
@x1
@x2))
(HasType @x4
FStar.Monotonic.Heap.heap)
...
;; def=Prims.fst(451,66-451,102); use=Array.fsti(54,13-54,78)
(and 
;; def=Prims.fst(73,23-73,30); use=Array.fsti(56,29-56,37)
(or label_1

;; def=Prims.fst(73,23-73,30); use=Array.fsti(54,13-54,78)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Array.fsti(54,13-54,78)
(Prims.hasEq Prims.nat)
)
...
(implies 
;; def=Array.fsti(56,29-56,53); use=Array.fsti(54,13-54,78)
(Valid 
;; def=Array.fsti(56,29-56,53); use=Array.fsti(54,13-54,78)
...
;; def=FStar.Seq.Base.fsti(32,23-32,24); use=Array.fsti(54,13-54,78)
(= (Array.op_String_Access @x0
@x1
@x4
@x2)
...
;; def=Array.fsti(35,51-35,56); use=Array.fsti(54,13-54,78)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x1))


;; def=Array.fsti(54,56-54,69); use=Array.fsti(54,13-54,78)
(Valid 
;; def=Array.fsti(54,56-54,69); use=Array.fsti(54,13-54,78)
(Array.init_at @x0
@x1
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Array.fsti(56,84-56,85)
(or label_2

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Array.fsti(54,13-54,78)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.Pervasives.Native.option @x0)
(Array.op_String_Access @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Array.read, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, int_inversion, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_f8748f2c4bb01ce8dbf24e61721eef05, typing_Array.op_String_Access, typing_Prims.int
