...
; Internals for NatHeap


; encoding sigelt val NatHeap.heap


; <Skipped val NatHeap.heap/>
...
(declare-fun Tm_refine_facce1686c7a52366b131e42a1c2bdac () Term)

; </end encoding let heap>


; encoding sigelt val NatHeap.consistent


; <Skipped val NatHeap.consistent/>
...
; encoding sigelt val NatHeap.ref


; <Skipped val NatHeap.ref/>
...
; encoding sigelt val NatHeap.contains


; <Skipped val NatHeap.contains/>
...
; encoding sigelt val NatHeap.sel


; <Skipped val NatHeap.sel/>
...
(assert (! 
;; def=NatHeap.fst(41,4-41,7); use=NatHeap.fst(41,4-41,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
...
(assert (! 
;; def=NatHeap.fst(48,4-48,12); use=NatHeap.fst(48,4-48,12)
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name NatHeap.heap; Namespace NatHeap
(assert (! (HasType Tm_refine_facce1686c7a52366b131e42a1c2bdac
Tm_type)
:named refinement_kinding_Tm_refine_facce1686c7a52366b131e42a1c2bdac))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name NatHeap.heap; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(28,11-30,53); use=NatHeap.fst(28,11-30,53)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_facce1686c7a52366b131e42a1c2bdac)
(and (HasTypeFuel @u0
@x1
...
;; def=NatHeap.fst(29,10-29,73); use=NatHeap.fst(29,10-29,73)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.nat)

;; def=NatHeap.fst(29,28-29,37); use=NatHeap.fst(29,28-29,37)
(< (BoxInt_proj_0 @x2)
...
;; def=NatHeap.fst(29,42-29,72); use=NatHeap.fst(29,42-29,72)
(exists ((@x3 Term))
 (! (and (HasType @x3
(Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236))

;; def=NatHeap.fst(29,54-29,71); use=NatHeap.fst(29,54-29,71)
...
;;no pats
:qid refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac.2))
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac.1))


;; def=NatHeap.fst(30,3-30,52); use=NatHeap.fst(30,3-30,52)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.nat)

;; def=NatHeap.fst(30,21-30,31); use=NatHeap.fst(30,21-30,31)
(>= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
...
;; def=NatHeap.fst(30,36-30,51); use=NatHeap.fst(30,36-30,51)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;;no pats
:qid refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac.3))
))
...
@x1
Tm_refine_facce1686c7a52366b131e42a1c2bdac))
:qid refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac))

:named refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! 
...
;;; Fact-ids: Name NatHeap.heap; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(28,78-28,79); use=NatHeap.fst(28,83-28,84)
(forall ((@x0 Term))
...
;;; Fact-ids: Name NatHeap.heap; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(28,50-28,87); use=NatHeap.fst(28,50-28,87)
(forall ((@x0 Term))
...
:qid int_inversion))
:named int_inversion))
;;;;;;;;;;;;;;;;haseq for Tm_refine_facce1686c7a52366b131e42a1c2bdac
;;; Fact-ids: Name NatHeap.heap; Namespace NatHeap
(assert (! (iff (Valid (Prims.hasEq Tm_refine_facce1686c7a52366b131e42a1c2bdac))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)))))
:named haseqTm_refine_facce1686c7a52366b131e42a1c2bdac))
...
:pattern ((NatHeap.ref @x0))
:qid equation_NatHeap.ref))

:named equation_NatHeap.ref))
;;;;;;;;;;;;;;;;Equation for NatHeap.heap
;;; Fact-ids: Name NatHeap.heap; Namespace NatHeap
(assert (! (= NatHeap.heap
Tm_refine_facce1686c7a52366b131e42a1c2bdac)
:named equation_NatHeap.heap))
;;;;;;;;;;;;;;;;Equation for NatHeap.contains
;;; Fact-ids: Name NatHeap.contains; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(48,4-48,12); use=NatHeap.fst(48,4-48,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (NatHeap.contains @x0
@x1
@x2))

;; def=NatHeap.fst(49,2-49,40); use=NatHeap.fst(49,2-49,40)
(exists ((@x3 Term))
 (! (and (HasType @x3
@x0)

;; def=NatHeap.fst(49,13-49,40); use=NatHeap.fst(49,13-49,40)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;;no pats
:qid equation_NatHeap.contains.1))
)
...
@x1
@x2))
:qid equation_NatHeap.contains))

:named equation_NatHeap.contains))
...
;;;;;;;;;;;;;;;;Prop-typing for NatHeap.contains
;;; Fact-ids: Name NatHeap.contains; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(48,4-48,12); use=NatHeap.fst(48,4-48,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(NatHeap.ref @x0)))
(Valid (Prims.subtype_of (NatHeap.contains @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (NatHeap.contains @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_NatHeap.contains))

:named defn_equation_NatHeap.contains))
...
;;; Fact-ids: Name NatHeap.heap; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(28,36-28,39); use=NatHeap.fst(28,23-28,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)
...
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid NatHeap_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named NatHeap_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
...
:pattern ((ApplyTT @x0
@x1))
:qid NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name FStar.Pervasives.Native.option; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.None; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Some; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(31,5-31,11); use=FStar.Pervasives.Native.fst(31,5-31,11)
...
; Starting query at NatHeap.fst(62,2-63,25)
...
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(58,3-58,24); use=NatHeap.fst(61,4-61,7)
(forall ((@x0 Term) (@x1 Term))
...
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fst(61,4-61,7)
(Valid 
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fst(61,4-61,7)
(NatHeap.contains @x2
@x3
...
; Encoding query formula : forall (a: Type) (h: NatHeap.heap) (r: NatHeap.ref a {NatHeap.contains h r}).
;   (*  - Could not prove post-condition
; *)
;   (~(Some? (FStar.Pervasives.Native.snd h r)) ==> Prims.l_False) /\
;   (forall (b: Type0) (b: b).
;       FStar.Pervasives.Native.snd h r == FStar.Pervasives.Native.Some (| b, b |) ==>
;       Prims.has_type b a)
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(62,2-63,25)
(and (implies 
;; def=NatHeap.fst(62,8-62,15); use=NatHeap.fst(62,8-62,15)
(not 
;; def=NatHeap.fst(62,8-62,15); use=NatHeap.fst(62,8-62,15)
...
;; def=Prims.fst(413,99-413,120); use=NatHeap.fst(62,2-63,25)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_type)
...
;; def=NatHeap.fst(62,8-63,20); use=NatHeap.fst(62,8-63,20)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=NatHeap.fst(63,16-63,17); use=NatHeap.fst(63,24-63,25)
(or label_2
(HasType @x4
@x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.sel, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.Some, equation_NatHeap.contains, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, projection_inverse_Prims.Mkdtuple2__1, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96
...
(assert (! 
;; def=NatHeap.fst(61,4-61,7); use=NatHeap.fst(61,4-61,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
@x1
@x2)
(let ((@lb3 (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
@x1)
...
@x1
@x2))
:qid equation_NatHeap.sel))

:named equation_NatHeap.sel))
(push) ;; push{2

; Starting query at NatHeap.fsti(64,0-76,44)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


; Encoding query formula : forall (h0: NatHeap.heap) (a: Type0) (x: a).
;   (*  - Subtyping check failed
;   - Expected type Type got type Type
; *)
;   forall (rh1: NatHeap.ref a & NatHeap.heap).
;     (~(NatHeap.contains h0 (FStar.Pervasives.Native.fst rh1)) /\
...
;       (forall (b: Type0) (r: NatHeap.ref b). {:pattern NatHeap.contains h0 r}
;           NatHeap.contains h0 r ==> NatHeap.contains (FStar.Pervasives.Native.snd rh1) r) ==>
;       (forall (b: Type0).
;           (*  - Could not prove post-condition
; *)
;           forall (r: NatHeap.ref b {NatHeap.contains h0 r}).
;             (*  - Subtyping check failed
;   - Expected type r: ref b {contains (FStar.Pervasives.Native.snd rh1) r}
;     got type r: ref b {contains h0 r}
; *)
;             NatHeap.contains h0 r ==> NatHeap.contains (FStar.Pervasives.Native.snd rh1) r))


; Context: While encoding a query
; While typechecking the top-level declaration `val NatHeap.alloc_ref`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=NatHeap.fsti(64,0-76,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
...
;; def=dummy(0,0-0,0); use=NatHeap.fsti(64,19-76,44)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.Pervasives.Native.tuple2 (NatHeap.ref @x1)
NatHeap.heap))

;; def=dummy(0,0-0,0); use=NatHeap.fsti(68,5-76,42)
(and (implies 
;; def=NatHeap.fsti(68,5-69,33); use=NatHeap.fsti(68,5-69,33)
(and 
...
(NatHeap.contains @x1
@x0
(FStar.Pervasives.Native.fst (NatHeap.ref @x1)
NatHeap.heap
@x3))
)
)
...
;; def=NatHeap.fsti(69,5-69,33); use=NatHeap.fsti(69,5-69,33)
(NatHeap.contains @x1
(FStar.Pervasives.Native.snd (NatHeap.ref @x1)
NatHeap.heap
@x3)
(FStar.Pervasives.Native.fst (NatHeap.ref @x1)
NatHeap.heap
...
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(70,26-70,35)
(or label_1
...
(implies 
;; def=NatHeap.fsti(68,5-74,29); use=NatHeap.fsti(68,5-74,29)
(and 
;; def=NatHeap.fsti(68,5-68,29); use=NatHeap.fsti(68,5-68,29)
(not 
;; def=NatHeap.fsti(68,6-68,29); use=NatHeap.fsti(68,6-68,29)
...
;; def=dummy(0,0-0,0); use=NatHeap.fsti(75,15-76,41)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x4
@x0))

;; def=NatHeap.fsti(75,24-75,37); use=NatHeap.fsti(76,40-76,41)
(Valid 
;; def=NatHeap.fsti(75,24-75,37); use=NatHeap.fsti(76,40-76,41)
(NatHeap.contains @x4
@x0
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.alloc_ref, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96
...
; encoding sigelt val NatHeap.alloc_ref


; <Skipped val NatHeap.alloc_ref/>
...
; Starting query at NatHeap.fst(69,2-70,26)
...
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fst(28,50-69,38); use=NatHeap.fst(69,2-70,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_1486644300f12d6a82b0741645ed2191))
:qid NatHeap_pre_typing_Tm_arrow_1486644300f12d6a82b0741645ed2191))

:named NatHeap_pre_typing_Tm_arrow_1486644300f12d6a82b0741645ed2191))
...
:pattern ((ApplyTT @x0
@x1))
:qid NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_1486644300f12d6a82b0741645ed2191))
:qid NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191))

:named NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191))
...
(declare-fun Tm_abs_fa1972c58aa5d1db48df78048fae6a64 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_fa1972c58aa5d1db48df78048fae6a64
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fst(69,49-70,23); use=NatHeap.fst(69,49-70,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_fa1972c58aa5d1db48df78048fae6a64 @x0
@x1
@x2)
Tm_arrow_1486644300f12d6a82b0741645ed2191)
 

:pattern ((Tm_abs_fa1972c58aa5d1db48df78048fae6a64 @x0
@x1
@x2))
:qid typing_Tm_abs_fa1972c58aa5d1db48df78048fae6a64))

:named typing_Tm_abs_fa1972c58aa5d1db48df78048fae6a64))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_fa1972c58aa5d1db48df78048fae6a64
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fst(69,49-70,23); use=NatHeap.fst(69,49-70,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_fa1972c58aa5d1db48df78048fae6a64 @x1
@x2
@x3)
@x0)
...
:pattern ((ApplyTT (Tm_abs_fa1972c58aa5d1db48df78048fae6a64 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_fa1972c58aa5d1db48df78048fae6a64))

:named interpretation_Tm_abs_fa1972c58aa5d1db48df78048fae6a64))
...
; Encoding query formula : forall (h0: NatHeap.heap) (a: Type) (x: a).
;   (*  - Could not prove post-condition
; *)
;   FStar.Pervasives.Native.fst h0 + 1 >= 0 /\
;   (forall (return_val: Prims.nat).
;       return_val == FStar.Pervasives.Native.fst h0 + 1 ==>
...
;           (fun r ->
;               (match r = FStar.Pervasives.Native.fst h0 with
;                 | true -> FStar.Pervasives.Native.Some (| a, x |)
;                 | _ -> FStar.Pervasives.Native.snd h0 r)
;               <:
...
;                   FStar.FunctionalExtensionality.restricted_t Prims.nat
;                     (fun _ -> FStar.Pervasives.Native.option (a: Type0 & a))).
;                   (FStar.Pervasives.Native.fst h0 + 1,
;                   FStar.FunctionalExtensionality.on_domain Prims.nat
;                     (fun r ->
;                         (match r = FStar.Pervasives.Native.fst h0 with
;                           | true -> FStar.Pervasives.Native.Some (| a, x |)
...
;                   (forall (n: Prims.nat).
;                       n <
;                       FStar.Pervasives.Native.fst (FStar.Pervasives.Native.fst h0 + 1,
;                         FStar.FunctionalExtensionality.on_domain Prims.nat
;                           (fun r ->
;                               (match r = FStar.Pervasives.Native.fst h0 with
;                                 | true -> FStar.Pervasives.Native.Some (| a, x |)
...
;                               FStar.Pervasives.Native.option (a: Type0 & a))) ==>
;                       (exists (v: a: Type0 & a).
;                           FStar.Pervasives.Native.snd (FStar.Pervasives.Native.fst h0 + 1,
;                             FStar.FunctionalExtensionality.on_domain Prims.nat
;                               (fun r ->
;                                   (match r = FStar.Pervasives.Native.fst h0 with
;                                     | true -> FStar.Pervasives.Native.Some (| a, x |)
...
;                   (forall (return_val: NatHeap.heap).
;                       return_val ==
;                       (FStar.Pervasives.Native.fst h0 + 1,
;                       FStar.FunctionalExtensionality.on_domain Prims.nat
;                         (fun r ->
...
;                             FStar.Pervasives.Native.option (a: Type0 & a))) ==
;                       return_val ==>
;                       (forall (any_result: NatHeap.ref a & NatHeap.heap).
...
;                                         <:
;                                         FStar.Pervasives.Native.option (a: Type0 & a)))))) /\
;                           NatHeap.contains (FStar.Pervasives.Native.snd (FStar.Pervasives.Native.fst
;                                   h0,
;                                 (FStar.Pervasives.Native.fst h0 + 1,
;                                 FStar.FunctionalExtensionality.on_domain Prims.nat
;                                   (fun r ->
...
;                                       <:
;                                       FStar.Pervasives.Native.option (a: Type0 & a))))) /\
;                           NatHeap.sel (FStar.Pervasives.Native.snd (FStar.Pervasives.Native.fst h0,
;                                 (FStar.Pervasives.Native.fst h0 + 1,
;                                 FStar.FunctionalExtensionality.on_domain Prims.nat
;                                   (fun r ->
;                                       (match r = FStar.Pervasives.Native.fst h0 with
...
;                                           FStar.Pervasives.Native.option (a: Type0 & a)))))
;                                 r) /\
;                           (forall (b: Type0) (r: NatHeap.ref b {NatHeap.contains h0 r}).
;                               {:pattern NatHeap.sel h0 r}
;                               NatHeap.sel h0 r ==
;                               NatHeap.sel (FStar.Pervasives.Native.snd (FStar.Pervasives.Native.fst h0
;                                     ,
;                                     (FStar.Pervasives.Native.fst h0 + 1,
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(69,2-70,26)
(and 
;; def=Prims.fst(680,18-680,24); use=NatHeap.fst(69,13-69,23)
(or label_1
...
;; def=Prims.fst(356,2-356,58); use=NatHeap.fst(69,2-70,26)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=NatHeap.fst(69,2-70,26)
(= @x3
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(69,2-70,26)
(and 
;; def=dummy(0,0-0,0); use=NatHeap.fst(69,2-70,26)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.nat)

;; def=Prims.fst(73,23-73,30); use=NatHeap.fst(69,52-69,53)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=NatHeap.fst(69,2-70,26)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_arrow_1486644300f12d6a82b0741645ed2191)

;; def=FStar.FunctionalExtensionality.fsti(117,40-117,41); use=NatHeap.fst(69,2-70,26)
(= (Tm_abs_fa1972c58aa5d1db48df78048fae6a64 @x1
@x2
@x0)
@x4)
)
...
;; def=FStar.Pervasives.Native.fst(59,43-59,45); use=NatHeap.fst(69,2-70,26)
(= (FStar.FunctionalExtensionality.on_domain Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4
(Tm_abs_fa1972c58aa5d1db48df78048fae6a64 @x1
@x2
...
;; def=NatHeap.fsti(67,20-67,24); use=NatHeap.fst(69,2-70,26)
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(69,2-70,26)
(and 
;; def=NatHeap.fst(29,10-29,73); use=NatHeap.fst(69,12-70,25)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)

;; def=NatHeap.fst(29,28-29,37); use=NatHeap.fst(69,12-70,25)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
...
;; def=NatHeap.fst(29,42-29,72); use=NatHeap.fst(69,12-70,25)
(or label_3
...
;; def=NatHeap.fst(29,54-29,71); use=NatHeap.fst(69,12-70,25)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=NatHeap.fst(30,3-30,52); use=NatHeap.fst(69,12-70,25)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)

;; def=NatHeap.fst(30,21-30,31); use=NatHeap.fst(69,12-70,25)
(>= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
...
;; def=NatHeap.fst(30,36-30,51); use=NatHeap.fst(69,12-70,25)
(or label_4
...
;; def=NatHeap.fsti(67,6-76,44); use=NatHeap.fst(69,2-70,26)
(= (FStar.Pervasives.Native.Mktuple2 (NatHeap.ref @x1)
NatHeap.heap
(FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
...
;; def=NatHeap.fsti(68,5-76,42); use=NatHeap.fst(69,2-70,26)
(and 
;; def=NatHeap.fsti(68,5-68,29); use=NatHeap.fst(69,2-70,26)
(or label_5

;; def=NatHeap.fsti(68,5-68,29); use=NatHeap.fst(69,2-70,26)
(not 
;; def=NatHeap.fsti(68,6-68,29); use=NatHeap.fst(69,2-70,26)
(Valid 
;; def=NatHeap.fsti(68,6-68,29); use=NatHeap.fst(69,2-70,26)
(NatHeap.contains @x1
@x0
...
;; def=NatHeap.fsti(69,5-69,33); use=NatHeap.fst(69,2-70,26)
(or label_6
...
;; def=NatHeap.fsti(70,12-70,40); use=NatHeap.fst(69,2-70,26)
(or label_7
...
;; def=NatHeap.fsti(71,5-74,29); use=NatHeap.fst(69,2-70,26)
...
;; def=NatHeap.fsti(72,8-72,21); use=NatHeap.fst(69,2-70,26)
(Valid 
;; def=NatHeap.fsti(72,8-72,21); use=NatHeap.fst(69,2-70,26)
(NatHeap.contains @x9
@x0
...
;; def=NatHeap.fsti(74,8-74,28); use=NatHeap.fst(69,2-70,26)
(or label_8
...
:pattern ((NatHeap.contains @x9
@x0
@x10))
:qid @query.11))


;; def=NatHeap.fsti(75,5-76,42); use=NatHeap.fst(69,2-70,26)
(forall ((@x9 Term) (@x10 Term))
 (! (implies (and (HasType @x9
Tm_type)
(HasType @x10
(Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x9
@x0)))

;; def=NatHeap.fsti(76,8-76,41); use=NatHeap.fst(69,2-70,26)
(or label_9
...
; Starting query at NatHeap.fsti(81,0-93,30)
...
; Encoding query formula : forall (a: Type0) (h0: NatHeap.heap) (r: NatHeap.ref a {NatHeap.contains h0 r}) (x: a).
;   (*  - Subtyping check failed
;   - Expected type Type got type Type
; *)
;   forall (h1: NatHeap.heap).
;     (NatHeap.contains h1 r ==> NatHeap.contains h0 r ==> NatHeap.contains h1 r) /\
;     (NatHeap.contains h1 r /\ NatHeap.sel h1 r == x /\
;       (forall (b: Type0) (r': NatHeap.ref b). {:pattern NatHeap.contains h0 r'}
;           NatHeap.contains h0 r' ==> NatHeap.contains h1 r') ==>
;       (forall (b: Type0).
;           (*  - Could not prove post-condition
; *)
;           forall (r': NatHeap.ref b {NatHeap.contains h0 r'}).
;             ~(r === r') ==> NatHeap.contains h0 r' ==> NatHeap.contains h1 r'))


; Context: While encoding a query
; While typechecking the top-level declaration `val NatHeap.upd`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=NatHeap.fsti(81,0-93,30)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=dummy(0,0-0,0); use=NatHeap.fsti(81,13-93,30)
(forall ((@x4 Term))
 (! (implies (HasType @x4
NatHeap.heap)

;; def=dummy(0,0-0,0); use=NatHeap.fsti(85,23-93,28)
(and (implies (and 
...
;; def=NatHeap.fsti(83,18-83,31); use=NatHeap.fsti(86,23-86,24)
(Valid 
;; def=NatHeap.fsti(83,18-83,31); use=NatHeap.fsti(86,23-86,24)
(NatHeap.contains @x0
@x1
...
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(86,23-86,24)
(or label_1
...
(implies 
;; def=NatHeap.fsti(85,23-90,20); use=NatHeap.fsti(85,23-90,20)
(and 
;; def=NatHeap.fsti(85,23-85,36); use=NatHeap.fsti(85,23-85,36)
(Valid 
;; def=NatHeap.fsti(85,23-85,36); use=NatHeap.fsti(85,23-85,36)
...
;; def=dummy(0,0-0,0); use=NatHeap.fsti(91,19-93,27)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
...
;; def=NatHeap.fsti(91,29-91,43); use=NatHeap.fsti(93,25-93,27)
(Valid 
;; def=NatHeap.fsti(91,29-91,43); use=NatHeap.fsti(93,25-93,27)
(NatHeap.contains @x5
@x1
...
; encoding sigelt val NatHeap.upd


; <Skipped val NatHeap.upd/>
...
;;; Fact-ids: Name NatHeap.alloc_ref; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(69,35-69,38); use=NatHeap.fst(69,28-69,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_1486644300f12d6a82b0741645ed2191)
...
; Starting query at NatHeap.fst(76,2-77,48)
...
(declare-fun Tm_abs_278857eefeb5694cca21f6b3f1ee9f74 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fst(76,36-77,46); use=NatHeap.fst(76,36-77,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_278857eefeb5694cca21f6b3f1ee9f74 @x0
@x1
@x2
@x3)
Tm_arrow_1486644300f12d6a82b0741645ed2191)
...
:pattern ((Tm_abs_278857eefeb5694cca21f6b3f1ee9f74 @x0
@x1
@x2
@x3))
:qid typing_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74))

:named typing_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fst(76,36-77,46); use=NatHeap.fst(76,36-77,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (Tm_abs_278857eefeb5694cca21f6b3f1ee9f74 @x1
@x2
@x3
@x4)
@x0)
...
:pattern ((ApplyTT (Tm_abs_278857eefeb5694cca21f6b3f1ee9f74 @x1
@x2
@x3
@x4)
@x0))
:qid interpretation_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74))

:named interpretation_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74))
...
; Encoding query formula : forall (a: Type) (h0: NatHeap.heap) (r: NatHeap.ref a {NatHeap.contains h0 r}) (x: a).
;   (*  - Could not prove post-condition
; *)
;   (forall (r': Prims.nat). (*  - Could not prove post-condition
; *) Prims.hasEq Prims.nat) /\
...
;                     n ==
;                   FStar.Pervasives.Native.None) /\
;               NatHeap.contains (FStar.Pervasives.Native.fst h0,
;                 FStar.FunctionalExtensionality.on_domain Prims.nat
;                   (fun r' ->
;                       (match r = r' with
;                         | true -> FStar.Pervasives.Native.Some (| a, x |)
...
;                       FStar.Pervasives.Native.option (a: Type0 & a)))
;                 r /\
;               (NatHeap.sel (FStar.Pervasives.Native.fst h0,
;                   FStar.FunctionalExtensionality.on_domain Prims.nat
;                     (fun r' ->
;                         (match r = r' with
;                           | true -> FStar.Pervasives.Native.Some (| a, x |)
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(76,2-77,48)
(and 
;; def=dummy(0,0-0,0); use=NatHeap.fst(76,2-77,48)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.nat)

;; def=Prims.fst(73,23-73,30); use=NatHeap.fst(76,39-76,40)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=NatHeap.fst(76,2-77,48)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_arrow_1486644300f12d6a82b0741645ed2191)

;; def=FStar.FunctionalExtensionality.fsti(117,40-117,41); use=NatHeap.fst(76,2-77,48)
(= (Tm_abs_278857eefeb5694cca21f6b3f1ee9f74 @x0
@x3
@x1
@x2)
@x4)
...
;; def=FStar.Pervasives.Native.fst(59,43-59,45); use=NatHeap.fst(76,2-77,48)
(= (FStar.FunctionalExtensionality.on_domain Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4
(Tm_abs_278857eefeb5694cca21f6b3f1ee9f74 @x0
@x3
...
;; def=NatHeap.fsti(85,14-93,30); use=NatHeap.fst(76,2-77,48)
(= (FStar.Pervasives.Native.Mktuple2 Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
(FStar.Pervasives.Native.fst Prims.nat
...
;; def=NatHeap.fsti(85,23-93,28); use=NatHeap.fst(76,2-77,48)
(and 
;; def=NatHeap.fst(29,10-29,73); use=NatHeap.fst(76,2-77,48)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)

;; def=NatHeap.fst(29,28-29,37); use=NatHeap.fst(76,2-77,48)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
...
;; def=NatHeap.fst(29,42-29,72); use=NatHeap.fst(76,2-77,48)
(or label_2
...
;; def=NatHeap.fst(29,54-29,71); use=NatHeap.fst(76,2-77,48)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=NatHeap.fst(30,3-30,52); use=NatHeap.fst(76,2-77,48)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)

;; def=NatHeap.fst(30,21-30,31); use=NatHeap.fst(76,2-77,48)
(>= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
...
;; def=NatHeap.fst(30,36-30,51); use=NatHeap.fst(76,2-77,48)
(or label_3
...
;; def=NatHeap.fsti(85,23-85,36); use=NatHeap.fst(76,2-77,48)
(or label_4
...
;; def=NatHeap.fsti(86,16-86,29); use=NatHeap.fst(76,2-77,48)
(or label_5
...
;; def=NatHeap.fsti(87,9-90,20); use=NatHeap.fst(76,2-77,48)
...
;; def=NatHeap.fsti(88,5-88,19); use=NatHeap.fst(76,2-77,48)
(Valid 
;; def=NatHeap.fsti(88,5-88,19); use=NatHeap.fst(76,2-77,48)
(NatHeap.contains @x7
@x1
...
;; def=NatHeap.fsti(90,5-90,19); use=NatHeap.fst(76,2-77,48)
(or label_6
...
;; def=NatHeap.fsti(91,9-93,28); use=NatHeap.fst(76,2-77,48)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Tm_type)
(HasType @x8
...
;; def=NatHeap.fsti(92,12-92,23); use=NatHeap.fst(76,2-77,48)
(not 
;; def=NatHeap.fsti(92,13-92,23); use=NatHeap.fst(76,2-77,48)
(Valid 
;; def=NatHeap.fsti(92,13-92,23); use=NatHeap.fst(76,2-77,48)
(Prims.op_Equals_Equals_Equals (Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x0
@x1)
...
;; def=NatHeap.fsti(93,5-93,27); use=NatHeap.fst(76,2-77,48)
(or label_7
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.upd, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, data_elim_FStar.Pervasives.Native.Some, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, equation_NatHeap.contains, equation_NatHeap.heap, equation_NatHeap.ref, equation_NatHeap.sel, equation_Prims.eqtype, equation_Prims.nat, equation_Prims.op_Equals_Equals_Equals, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, int_inversion, interpretation_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, lemma_FStar.FunctionalExtensionality.feq_on_domain, primitive_Prims.op_Equality, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, projection_inverse_Prims.Mkdtuple2__1, projection_inverse_Prims.Mkdtuple2__2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_7e4a6c5999db731b5d17d0418dfeea3e, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_FStar.Pervasives.Native.snd, typing_Prims.int, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4
...
; encoding sigelt val NatHeap.emp


; <Skipped val NatHeap.emp/>

(push) ;; push{2

; Starting query at NatHeap.fst(80,0-80,57)
...
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fst(80,51-80,55); use=NatHeap.fst(80,51-80,55)
(forall ((@x0 Term))
...
;;; Fact-ids: 
(assert (! (not 
;; def=NatHeap.fst(29,10-30,52); use=NatHeap.fst(80,10-80,57)
(and 
;; def=NatHeap.fst(29,10-29,73); use=NatHeap.fst(80,10-80,57)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Prims.nat)

;; def=NatHeap.fst(29,28-29,37); use=NatHeap.fst(80,10-80,57)
(< (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
...
;; def=NatHeap.fst(29,42-29,72); use=NatHeap.fst(80,10-80,57)
(or label_1
...
;; def=NatHeap.fst(29,54-29,71); use=NatHeap.fst(80,10-80,57)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=NatHeap.fst(30,3-30,52); use=NatHeap.fst(80,10-80,57)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Prims.nat)

;; def=NatHeap.fst(30,21-30,31); use=NatHeap.fst(80,10-80,57)
(>= (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
...
;; def=NatHeap.fst(30,36-30,51); use=NatHeap.fst(80,10-80,57)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.emp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, equation_Prims.nat, int_inversion, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, interpretation_Tm_abs_e8508738f3611ef2f0f0a25d53a7fccc, lemma_FStar.FunctionalExtensionality.feq_on_domain, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_FStar.Pervasives.Native.snd, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4, typing_Tm_abs_e8508738f3611ef2f0f0a25d53a7fccc
...
; encoding sigelt val NatHeap.concat


; <Skipped val NatHeap.concat/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NatHeap.max; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(119,4-119,7); use=NatHeap.fsti(119,4-119,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
Prims.nat))
(HasType (NatHeap.max @x0
@x1)
Prims.nat))
 

:pattern ((NatHeap.max @x0
@x1))
:qid typing_NatHeap.max))

:named typing_NatHeap.max))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NatHeap.consistent; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(35,4-35,14); use=NatHeap.fst(35,4-35,14)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
NatHeap.heap))
(HasType (NatHeap.consistent @x0
@x1)
Tm_type))
 

:pattern ((NatHeap.consistent @x0
@x1))
:qid typing_NatHeap.consistent))

:named typing_NatHeap.consistent))
;;;;;;;;;;;;;;;;free var typing
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (NatHeap.max @x0
@x1)
(let ((@lb2 (Prims.op_GreaterThan @x0
@x1)))
(ite (= @lb2
(BoxBool true))
@x0
...
:pattern ((NatHeap.max @x0
@x1))
:qid equation_NatHeap.max))

:named equation_NatHeap.max))
;;;;;;;;;;;;;;;;Equation for NatHeap.consistent
;;; Fact-ids: Name NatHeap.consistent; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(35,4-35,14); use=NatHeap.fst(35,4-35,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (NatHeap.consistent @x0
@x1))

;; def=NatHeap.fst(36,2-36,81); use=NatHeap.fst(36,2-36,81)
...
;; def=NatHeap.fst(36,18-36,36); use=NatHeap.fst(36,18-36,36)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=NatHeap.fst(36,40-36,58); use=NatHeap.fst(36,40-36,58)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=NatHeap.fst(36,65-36,81); use=NatHeap.fst(36,65-36,81)
...
;;no pats
:qid equation_NatHeap.consistent.1))
)
 

:pattern ((NatHeap.consistent @x0
@x1))
:qid equation_NatHeap.consistent))

:named equation_NatHeap.consistent))
...
;;;;;;;;;;;;;;;;Prop-typing for NatHeap.consistent
;;; Fact-ids: Name NatHeap.consistent; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(35,4-35,14); use=NatHeap.fst(35,4-35,14)
(forall ((@x0 Term) (@x1 Term))
...
(HasType @x1
NatHeap.heap))
(Valid (Prims.subtype_of (NatHeap.consistent @x0
@x1)
Prims.unit)))
 

:pattern ((Prims.subtype_of (NatHeap.consistent @x0
@x1)
Prims.unit))
:qid defn_equation_NatHeap.consistent))

:named defn_equation_NatHeap.consistent))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
; Starting query at NatHeap.fst(84,2-89,38)
...
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(123,24-123,49); use=NatHeap.fst(83,4-83,10)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_f2a7258a07d1d96cb6c864908ecae400 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_f2a7258a07d1d96cb6c864908ecae400 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_f2a7258a07d1d96cb6c864908ecae400))

:named refinement_kinding_Tm_refine_f2a7258a07d1d96cb6c864908ecae400))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(123,24-123,49); use=NatHeap.fst(83,4-83,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f2a7258a07d1d96cb6c864908ecae400 @x2))
(and (HasTypeFuel @u0
@x1
NatHeap.heap)

;; def=NatHeap.fsti(123,32-123,48); use=NatHeap.fst(83,4-83,10)
(Valid 
;; def=NatHeap.fsti(123,32-123,48); use=NatHeap.fst(83,4-83,10)
(NatHeap.consistent @x2
@x1)
)
))
...
@x1
(Tm_refine_f2a7258a07d1d96cb6c864908ecae400 @x2)))
:qid refinement_interpretation_Tm_refine_f2a7258a07d1d96cb6c864908ecae400))

:named refinement_interpretation_Tm_refine_f2a7258a07d1d96cb6c864908ecae400))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f2a7258a07d1d96cb6c864908ecae400
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(123,24-123,49); use=NatHeap.fst(83,4-83,10)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f2a7258a07d1d96cb6c864908ecae400 @x0)))
(Valid (Prims.hasEq NatHeap.heap)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f2a7258a07d1d96cb6c864908ecae400 @x0))))
:qid haseqTm_refine_f2a7258a07d1d96cb6c864908ecae400))

:named haseqTm_refine_f2a7258a07d1d96cb6c864908ecae400))
...
(declare-fun Tm_abs_be68577b6111a37d97443f6d3a0dc9b7 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fst(84,50-89,36); use=NatHeap.fst(84,50-89,36)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_be68577b6111a37d97443f6d3a0dc9b7 @x0
@x1)
Tm_arrow_1486644300f12d6a82b0741645ed2191)
 

:pattern ((Tm_abs_be68577b6111a37d97443f6d3a0dc9b7 @x0
@x1))
:qid typing_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7))

:named typing_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fst(84,50-89,36); use=NatHeap.fst(84,50-89,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_be68577b6111a37d97443f6d3a0dc9b7 @x1
@x2)
@x0)
(let ((@lb3 (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
...
:pattern ((ApplyTT (Tm_abs_be68577b6111a37d97443f6d3a0dc9b7 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7))

:named interpretation_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7))
...
; Encoding query formula : forall (h0: NatHeap.heap) (h1: NatHeap.heap{NatHeap.consistent h0 h1}).
;   (*  - Could not prove post-condition
; *)
;   (forall (r: Prims.nat).
;       (*  - Could not prove post-condition
; *)
;       forall (k: Prims.pure_post (FStar.Pervasives.Native.option (a: Type0 & a))).
;         (forall (x: FStar.Pervasives.Native.option (a: Type0 & a)).
;             {:pattern Prims.guard_free (k x)}
;             Prims.auto_squash (k x)) ==>
;         (~(None? (FStar.Pervasives.Native.snd h0 r)) /\ ~(Some? (FStar.Pervasives.Native.snd h0 r)) ==>
;           Prims.l_False) /\
;         (~(None? (FStar.Pervasives.Native.snd h0 r)) ==>
;           (forall (b: a: Type0 & a).
;               FStar.Pervasives.Native.snd h0 r == FStar.Pervasives.Native.Some b ==>
;               (forall (k: Prims.pure_post (FStar.Pervasives.Native.option (a: Type0 & a))).
;                   (forall (x: FStar.Pervasives.Native.option (a: Type0 & a)).
;                       {:pattern Prims.guard_free (k x)}
;                       Prims.auto_squash (k x)) ==>
;                   ~(None? (FStar.Pervasives.Native.snd h1 r)) /\
;                   ~(Some? (FStar.Pervasives.Native.snd h1 r)) ==>
;                   Prims.l_False)))) /\
;   (forall (any_result: (x: Prims.nat -> FStar.Pervasives.Native.option (a: Type0 & a))).
;       (fun r ->
;           (match FStar.Pervasives.Native.snd h0 r with
;             | FStar.Pervasives.Native.None  -> FStar.Pervasives.Native.snd h1 r
;             | FStar.Pervasives.Native.Some v ->
;               (match FStar.Pervasives.Native.snd h1 r with
;                 | FStar.Pervasives.Native.None  -> FStar.Pervasives.Native.Some v
;                 | FStar.Pervasives.Native.Some v' -> FStar.Pervasives.Native.Some v')
;               <:
;               FStar.Pervasives.Native.option (a: Type0 & a))
;           <:
;           FStar.Pervasives.Native.option (a: Type0 & a)) ==
...
;               FStar.FunctionalExtensionality.restricted_t Prims.nat
;                 (fun _ -> FStar.Pervasives.Native.option (a: Type0 & a))).
;               (NatHeap.max (FStar.Pervasives.Native.fst h0) (FStar.Pervasives.Native.fst h1),
;               FStar.FunctionalExtensionality.on_domain Prims.nat
;                 (fun r ->
;                     (match FStar.Pervasives.Native.snd h0 r with
;                       | FStar.Pervasives.Native.None  -> FStar.Pervasives.Native.snd h1 r
...
;               (forall (n: Prims.nat).
;                   n <
;                   FStar.Pervasives.Native.fst (NatHeap.max (FStar.Pervasives.Native.fst h0)
;                       (FStar.Pervasives.Native.fst h1),
;                     FStar.FunctionalExtensionality.on_domain Prims.nat
;                       (fun r ->
;                           (match FStar.Pervasives.Native.snd h0 r with
;                             | FStar.Pervasives.Native.None  -> FStar.Pervasives.Native.snd h1 r
...
;                           FStar.Pervasives.Native.option (a: Type0 & a))) ==>
;                   (exists (v: a: Type0 & a).
;                       FStar.Pervasives.Native.snd (NatHeap.max (FStar.Pervasives.Native.fst h0)
;                           (FStar.Pervasives.Native.fst h1),
;                         FStar.FunctionalExtensionality.on_domain Prims.nat
;                           (fun r ->
;                               (match FStar.Pervasives.Native.snd h0 r with
...
; Context: While encoding a query
; While typechecking the top-level declaration `let concat`
...
NatHeap.heap)
(HasType @x1
(Tm_refine_f2a7258a07d1d96cb6c864908ecae400 @x0)))

;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(84,2-89,38)
(and 
;; def=dummy(0,0-0,0); use=NatHeap.fst(84,2-89,38)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.nat)
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post (FStar.Pervasives.Native.option (Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236))))

;; def=Prims.fst(402,27-402,88); use=NatHeap.fst(84,50-89,36)
(forall ((@x4 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=NatHeap.fst(84,50-89,36)
(Valid 
;; def=Prims.fst(402,84-402,87); use=NatHeap.fst(84,50-89,36)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(84,50-89,36)
(and (implies 
;; def=NatHeap.fst(84,56-84,64); use=NatHeap.fst(84,56-84,64)
(and 
;; def=NatHeap.fst(84,56-84,64); use=NatHeap.fst(84,56-84,64)
(not 
;; def=NatHeap.fst(84,56-84,64); use=NatHeap.fst(84,56-84,64)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=NatHeap.fst(84,50-89,36)
(not 
;; def=NatHeap.fst(84,56-84,64); use=NatHeap.fst(84,56-84,64)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236)
...
;; def=Prims.fst(413,99-413,120); use=NatHeap.fst(84,50-89,36)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236))

;; def=NatHeap.fst(84,56-86,27); use=NatHeap.fst(84,56-86,27)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=NatHeap.fst(87,28-87,36); use=NatHeap.fst(87,28-87,36)
(not 
;; def=NatHeap.fst(87,28-87,36); use=NatHeap.fst(87,28-87,36)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236)
...
;; def=Prims.fst(451,66-451,102); use=NatHeap.fst(84,2-89,38)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_arrow_1486644300f12d6a82b0741645ed2191)

;; def=FStar.FunctionalExtensionality.fsti(117,40-117,41); use=NatHeap.fst(84,2-89,38)
(= (Tm_abs_be68577b6111a37d97443f6d3a0dc9b7 @x1
@x0)
@x2)
)
...
;; def=FStar.Pervasives.Native.fst(59,43-59,45); use=NatHeap.fst(84,2-89,38)
(= (FStar.FunctionalExtensionality.on_domain Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4
(Tm_abs_be68577b6111a37d97443f6d3a0dc9b7 @x1
@x0))
...
;; def=NatHeap.fsti(123,57-123,61); use=NatHeap.fst(84,2-89,38)
(= (FStar.Pervasives.Native.Mktuple2 Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
(NatHeap.max (FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
@x0)
(FStar.Pervasives.Native.fst Prims.nat
...
;; def=NatHeap.fst(29,10-30,52); use=NatHeap.fst(84,2-89,38)
(and 
;; def=NatHeap.fst(29,10-29,73); use=NatHeap.fst(84,2-89,38)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=NatHeap.fst(29,28-29,37); use=NatHeap.fst(84,2-89,38)
(< (BoxInt_proj_0 @x5)
(BoxInt_proj_0 (FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
...
;; def=NatHeap.fst(29,42-29,72); use=NatHeap.fst(84,2-89,38)
(or label_3
...
;; def=NatHeap.fst(29,54-29,71); use=NatHeap.fst(84,2-89,38)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=NatHeap.fst(30,3-30,52); use=NatHeap.fst(84,2-89,38)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=NatHeap.fst(30,21-30,31); use=NatHeap.fst(84,2-89,38)
(>= (BoxInt_proj_0 @x5)
(BoxInt_proj_0 (FStar.Pervasives.Native.fst Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
...
;; def=NatHeap.fst(30,36-30,51); use=NatHeap.fst(84,2-89,38)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.concat, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.None, disc_equation_FStar.Pervasives.Native.Some, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, equation_NatHeap.heap, equation_NatHeap.max, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, function_token_typing_FStar.Pervasives.Native.snd, int_inversion, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, interpretation_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7, lemma_FStar.FunctionalExtensionality.feq_on_domain, primitive_Prims.op_GreaterThan, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.None_a, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_f2a7258a07d1d96cb6c864908ecae400, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_kinding_Tm_refine_7e4a6c5999db731b5d17d0418dfeea3e, typing_FStar.Pervasives.Native.fst, typing_NatHeap.max, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4
...
; encoding sigelt let concat


; <Start encoding let concat>
...
; </end encoding let concat>


; encoding sigelt val NatHeap.consistent_refl


; <Skipped val NatHeap.consistent_refl/>

(push) ;; push{2

; Starting query at NatHeap.fst(94,24-94,26)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (h: NatHeap.heap).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). NatHeap.consistent h h ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let consistent_refl`
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(94,24-94,26)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=NatHeap.fsti(128,28-128,44); use=NatHeap.fst(94,24-94,26)
(or label_2

;; def=NatHeap.fsti(128,28-128,44); use=NatHeap.fst(94,24-94,26)
(Valid 
;; def=NatHeap.fsti(128,28-128,44); use=NatHeap.fst(94,24-94,26)
(NatHeap.consistent @x0
@x0)
)
)
)

;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(94,24-94,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(94,24-94,26)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.consistent_refl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_NatHeap.consistent, projection_inverse_FStar.Pervasives.Native.Some_v
...
; encoding sigelt let consistent_refl


; <Start encoding let consistent_refl>
...
; </end encoding let consistent_refl>


; encoding sigelt val NatHeap.emp_consistent


; <Skipped val NatHeap.emp_consistent/>

;;;;;;;;;;;;;;;;typing_Tm_abs_e8508738f3611ef2f0f0a25d53a7fccc
;;; Fact-ids: Name NatHeap.emp; Namespace NatHeap
(assert (! (HasType Tm_abs_e8508738f3611ef2f0f0a25d53a7fccc
Tm_arrow_1486644300f12d6a82b0741645ed2191)
:named typing_Tm_abs_e8508738f3611ef2f0f0a25d53a7fccc))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NatHeap.emp; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(80,4-80,7); use=NatHeap.fst(80,4-80,7)
(forall ((@u0 Dummy_sort))
 (! (HasType (NatHeap.emp @u0)
NatHeap.heap)
 

:pattern ((NatHeap.emp @u0))
:qid typing_NatHeap.emp))

:named typing_NatHeap.emp))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e8508738f3611ef2f0f0a25d53a7fccc
;;; Fact-ids: Name NatHeap.emp; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(80,51-80,55); use=NatHeap.fst(80,51-80,55)
...
:qid equation_NatHeap.emp))

:named equation_NatHeap.emp))
(push) ;; push{2

; Starting query at NatHeap.fst(96,23-96,25)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). NatHeap.consistent NatHeap.emp h ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let emp_consistent`
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(96,23-96,25)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=NatHeap.fsti(132,27-132,45); use=NatHeap.fst(96,23-96,25)
(or label_2

;; def=NatHeap.fsti(132,27-132,45); use=NatHeap.fst(96,23-96,25)
(Valid 
;; def=NatHeap.fsti(132,27-132,45); use=NatHeap.fst(96,23-96,25)
(NatHeap.consistent (NatHeap.emp Dummy_value)
@x0)
)
)
)

;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(96,23-96,25)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(96,23-96,25)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.emp_consistent, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, data_elim_FStar.Pervasives.Native.Mktuple2, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, equation_NatHeap.consistent, equation_NatHeap.emp, equation_NatHeap.heap, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, int_inversion, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, interpretation_Tm_abs_e8508738f3611ef2f0f0a25d53a7fccc, lemma_FStar.FunctionalExtensionality.feq_on_domain, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_7e4a6c5999db731b5d17d0418dfeea3e, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_kinding_Tm_refine_7e4a6c5999db731b5d17d0418dfeea3e, token_correspondence_FStar.Pervasives.Native.snd, typing_FStar.Pervasives.Native.fst, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4, typing_Tm_abs_e8508738f3611ef2f0f0a25d53a7fccc
...
; encoding sigelt let emp_consistent


; <Start encoding let emp_consistent>
...
; </end encoding let emp_consistent>


; encoding sigelt val NatHeap.upd_consistent


; <Skipped val NatHeap.upd_consistent/>
...
;;; Fact-ids: Name NatHeap.upd; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(75,4-75,7); use=NatHeap.fst(75,4-75,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;;; Fact-ids: Name NatHeap.upd; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(85,14-93,30); use=NatHeap.fst(75,4-75,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;; def=NatHeap.fsti(85,23-85,36); use=NatHeap.fst(75,4-75,7)
(Valid 
;; def=NatHeap.fsti(85,23-85,36); use=NatHeap.fst(75,4-75,7)
(NatHeap.contains @x2
@x1
...
;; def=NatHeap.fsti(86,16-86,29); use=NatHeap.fst(75,4-75,7)
(= (NatHeap.sel @x2
@x1
@x3)
@x4)
...
;; def=NatHeap.fsti(87,9-90,20); use=NatHeap.fst(75,4-75,7)
...
;; def=NatHeap.fsti(88,5-88,19); use=NatHeap.fst(75,4-75,7)
(Valid 
;; def=NatHeap.fsti(88,5-88,19); use=NatHeap.fst(75,4-75,7)
(NatHeap.contains @x6
@x5
...
;; def=NatHeap.fsti(90,5-90,19); use=NatHeap.fst(75,4-75,7)
(Valid 
;; def=NatHeap.fsti(90,5-90,19); use=NatHeap.fst(75,4-75,7)
(NatHeap.contains @x6
@x1
...
;; def=NatHeap.fsti(91,9-93,28); use=NatHeap.fst(75,4-75,7)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
Tm_type)
(HasType @x7
...
;; def=NatHeap.fsti(92,12-92,23); use=NatHeap.fst(75,4-75,7)
(not 
;; def=NatHeap.fsti(92,13-92,23); use=NatHeap.fst(75,4-75,7)
(Valid 
;; def=NatHeap.fsti(92,13-92,23); use=NatHeap.fst(75,4-75,7)
...
;; def=NatHeap.fsti(93,5-93,27); use=NatHeap.fst(75,4-75,7)
(= (NatHeap.sel @x6
@x5
@x7)
(NatHeap.sel @x6
...
@x2
@x3))
:qid equation_NatHeap.upd))

:named equation_NatHeap.upd))
(push) ;; push{2

; Starting query at NatHeap.fst(98,29-98,31)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


; Encoding query formula : forall (h: NatHeap.heap) (a: Type) (r: NatHeap.ref a {NatHeap.contains h r}) (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). NatHeap.consistent h (NatHeap.upd h r x) ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let upd_consistent`
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(98,29-98,31)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=NatHeap.fsti(139,27-139,53); use=NatHeap.fst(98,29-98,31)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(98,29-98,31)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(98,29-98,31)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.upd_consistent, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.Some, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.snd, equation_FStar.Pervasives.dfst, equation_NatHeap.consistent, equation_NatHeap.contains, equation_NatHeap.heap, equation_NatHeap.ref, equation_NatHeap.sel, equation_NatHeap.upd, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, int_inversion, interpretation_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, lemma_FStar.FunctionalExtensionality.feq_on_domain, primitive_Prims.op_Equality, proj_equation_FStar.Pervasives.Native.Mktuple2__2, proj_equation_Prims.Mkdtuple2__1, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, projection_inverse_Prims.Mkdtuple2__1, projection_inverse_Prims.Mkdtuple2__2, refinement_interpretation_Tm_refine_4289597b21978a2daf74d6c05a34b053, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_FStar.Pervasives.Native.snd, typing_NatHeap.upd, typing_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4
...
; encoding sigelt let upd_consistent


; <Start encoding let upd_consistent>
...
; </end encoding let upd_consistent>


; encoding sigelt val NatHeap.alloc_ref_consistent


; <Skipped val NatHeap.alloc_ref_consistent/>
...
;;; Fact-ids: Name NatHeap.alloc_ref; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(68,4-68,13); use=NatHeap.fst(68,4-68,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
...
;;; Fact-ids: Name NatHeap.alloc_ref; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(67,6-76,44); use=NatHeap.fst(68,4-68,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;; def=NatHeap.fsti(68,5-68,29); use=NatHeap.fst(68,4-68,13)
(not 
;; def=NatHeap.fsti(68,6-68,29); use=NatHeap.fst(68,4-68,13)
(Valid 
;; def=NatHeap.fsti(68,6-68,29); use=NatHeap.fst(68,4-68,13)
(NatHeap.contains @x2
@x3
...
;; def=NatHeap.fsti(69,5-69,33); use=NatHeap.fst(68,4-68,13)
(Valid 
;; def=NatHeap.fsti(69,5-69,33); use=NatHeap.fst(68,4-68,13)
(NatHeap.contains @x2
...
;; def=NatHeap.fsti(70,12-70,40); use=NatHeap.fst(68,4-68,13)
(= (NatHeap.sel @x2
(FStar.Pervasives.Native.snd (NatHeap.ref @x2)
NatHeap.heap
@x1)
...
;; def=NatHeap.fsti(71,5-74,29); use=NatHeap.fst(68,4-68,13)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Tm_type)
(HasType @x6
...
;; def=NatHeap.fsti(72,8-72,21); use=NatHeap.fst(68,4-68,13)
(Valid 
;; def=NatHeap.fsti(72,8-72,21); use=NatHeap.fst(68,4-68,13)
(NatHeap.contains @x5
@x3
...
;; def=NatHeap.fsti(74,8-74,28); use=NatHeap.fst(68,4-68,13)
(Valid 
;; def=NatHeap.fsti(74,8-74,28); use=NatHeap.fst(68,4-68,13)
(NatHeap.contains @x5
(FStar.Pervasives.Native.snd (NatHeap.ref @x2)
...
;; def=NatHeap.fsti(75,5-76,42); use=NatHeap.fst(68,4-68,13)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Tm_type)
(HasType @x6
...
;; def=NatHeap.fsti(76,8-76,41); use=NatHeap.fst(68,4-68,13)
(= (NatHeap.sel @x5
@x3
@x6)
(NatHeap.sel @x5
...
;;;;;;;;;;;;;;;;Equation for NatHeap.alloc_ref
;;; Fact-ids: Name NatHeap.alloc_ref; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(68,4-68,13); use=NatHeap.fst(68,4-68,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (NatHeap.alloc_ref @x0
@x1
@x2)
(FStar.Pervasives.Native.Mktuple2 (NatHeap.ref @x1)
NatHeap.heap
...
@x1
@x2))
:qid equation_NatHeap.alloc_ref))

:named equation_NatHeap.alloc_ref))
(push) ;; push{2

; Starting query at NatHeap.fst(100,33-100,35)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (h: NatHeap.heap) (a: Type) (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         NatHeap.consistent h (FStar.Pervasives.Native.snd (NatHeap.alloc_ref h a x)) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let alloc_ref_consistent`
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(100,33-100,35)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=NatHeap.fsti(144,12-144,50); use=NatHeap.fst(100,33-100,35)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(100,33-100,35)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(100,33-100,35)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.alloc_ref_consistent, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.Some, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, equation_NatHeap.alloc_ref, equation_NatHeap.consistent, equation_NatHeap.heap, equation_NatHeap.ref, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, int_inversion, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, interpretation_Tm_abs_fa1972c58aa5d1db48df78048fae6a64, lemma_FStar.FunctionalExtensionality.feq_on_domain, primitive_Prims.op_Equality, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_81559c2acf3805dd0108c30eedb8fa98, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_kinding_Tm_refine_facce1686c7a52366b131e42a1c2bdac, token_correspondence_FStar.Pervasives.Native.snd, typing_FStar.Pervasives.Native.fst, typing_NatHeap.alloc_ref, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4, typing_Tm_abs_fa1972c58aa5d1db48df78048fae6a64
...
; encoding sigelt let alloc_ref_consistent


; <Start encoding let alloc_ref_consistent>
...
; </end encoding let alloc_ref_consistent>


; encoding sigelt val NatHeap.contains_sel


; <Skipped val NatHeap.contains_sel/>

(push) ;; push{2

; Starting query at NatHeap.fst(102,25-102,27)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


; Encoding query formula : forall (h: NatHeap.heap) (a: Type) (r: NatHeap.ref a {NatHeap.contains h r}).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). (exists (x: a). NatHeap.sel h r == x) ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let contains_sel`
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(102,25-102,27)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=NatHeap.fsti(152,11-152,36); use=NatHeap.fst(102,25-102,27)
(or label_2
...
;; def=NatHeap.fsti(152,23-152,35); use=NatHeap.fst(102,25-102,27)
(= (NatHeap.sel @x1
@x0
@x2)
@x5)
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(102,25-102,27)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(102,25-102,27)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.contains_sel, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_FStar.Pervasives.Native.Some, equation_FStar.FunctionalExtensionality.restricted_t, equation_NatHeap.contains, equation_NatHeap.heap, equation_NatHeap.sel, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, projection_inverse_Prims.Mkdtuple2__2, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac
...
; encoding sigelt let contains_sel


; <Start encoding let contains_sel>
...
; </end encoding let contains_sel>


; encoding sigelt val NatHeap.contains_upd


; <Skipped val NatHeap.contains_upd/>

(push) ;; push{2

; Starting query at NatHeap.fst(104,32-104,34)
...
;   (a: Type)
;   (b: Type)
;   (r: NatHeap.ref a {NatHeap.contains h r})
;   (x: a)
;   (r': NatHeap.ref b).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     NatHeap.contains h r' /\
;     (forall (pure_result: Prims.unit). NatHeap.contains (NatHeap.upd h r x) r' ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let contains_upd`
...
;; def=NatHeap.fsti(161,21-161,36); use=NatHeap.fst(104,32-104,34)
(Valid 
;; def=NatHeap.fsti(161,21-161,36); use=NatHeap.fst(104,32-104,34)
(NatHeap.contains @x2
@x0
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(104,32-104,34)
(forall ((@x7 Term))
 (! (implies (and (or label_1
(HasType @x7
Prims.unit))

;; def=NatHeap.fsti(162,21-162,46); use=NatHeap.fst(104,32-104,34)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(104,32-104,34)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(104,32-104,34)
(ApplyTT @x6
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.contains_upd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_NatHeap.ref, equation_NatHeap.upd, equation_Prims.nat, int_inversion, refinement_interpretation_Tm_refine_4289597b21978a2daf74d6c05a34b053, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_NatHeap.upd
...
; encoding sigelt let contains_upd


; <Start encoding let contains_upd>
...
; </end encoding let contains_upd>


; encoding sigelt val NatHeap.contains_emp


; <Skipped val NatHeap.contains_emp/>

(push) ;; push{2

; Starting query at NatHeap.fst(106,23-106,25)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). ~(NatHeap.contains NatHeap.emp r) ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let contains_emp`
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(106,23-106,25)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=NatHeap.fsti(169,21-169,40); use=NatHeap.fst(106,23-106,25)
(or label_2

;; def=NatHeap.fsti(169,21-169,40); use=NatHeap.fst(106,23-106,25)
(not 
;; def=NatHeap.fsti(169,23-169,39); use=NatHeap.fst(106,23-106,25)
(Valid 
;; def=NatHeap.fsti(169,23-169,39); use=NatHeap.fst(106,23-106,25)
(NatHeap.contains @x0
(NatHeap.emp Dummy_value)
@x1)
)
)
)
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(106,23-106,25)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(106,23-106,25)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.contains_emp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.snd, equation_NatHeap.contains, equation_NatHeap.emp, equation_NatHeap.ref, equation_Prims.nat, int_inversion, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, interpretation_Tm_abs_e8508738f3611ef2f0f0a25d53a7fccc, lemma_FStar.FunctionalExtensionality.feq_on_domain, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_FStar.Pervasives.Native.snd, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4, typing_Tm_abs_e8508738f3611ef2f0f0a25d53a7fccc
...
; encoding sigelt let contains_emp


; <Start encoding let contains_emp>
...
;; def=NatHeap.fsti(161,21-161,36); use=NatHeap.fst(104,4-104,16)
(Valid 
;; def=NatHeap.fsti(161,21-161,36); use=NatHeap.fst(104,4-104,16)
(NatHeap.contains @x2
@x0
...
;; def=NatHeap.fsti(162,21-162,46); use=NatHeap.fst(104,4-104,16)
(Valid 
;; def=NatHeap.fsti(162,21-162,46); use=NatHeap.fst(104,4-104,16)
(NatHeap.contains @x2
(NatHeap.upd @x1
...
; Starting query at NatHeap.fsti(175,0-181,36)
...
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(179,24-179,30); use=NatHeap.fsti(179,8-179,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;   (*  - Could not prove post-condition
; *)
;   NatHeap.contains h r ==> NatHeap.contains (NatHeap.upd h r x) r


; Context: While encoding a query
; While typechecking the top-level declaration `val NatHeap.sel_upd1`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=NatHeap.fsti(175,0-181,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
...
;; def=NatHeap.fsti(177,16-177,31); use=NatHeap.fsti(180,41-180,42)
(Valid 
;; def=NatHeap.fsti(177,16-177,31); use=NatHeap.fsti(180,41-180,42)
(NatHeap.contains @x1
@x0
...
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(180,41-180,42)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.sel_upd1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, lemma_NatHeap.contains_upd, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96
...
; encoding sigelt val NatHeap.sel_upd1


; <Skipped val NatHeap.sel_upd1/>

(push) ;; push{2

; Starting query at NatHeap.fst(108,23-108,25)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). NatHeap.sel (NatHeap.upd h r x) r == x ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(108,23-108,25)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=NatHeap.fsti(180,24-180,48); use=NatHeap.fst(108,23-108,25)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(108,23-108,25)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(108,23-108,25)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.sel_upd1, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_NatHeap.upd, refinement_interpretation_Tm_refine_4289597b21978a2daf74d6c05a34b053, typing_NatHeap.upd
...
;; def=NatHeap.fsti(180,24-180,48); use=NatHeap.fst(108,4-108,12)
(= (NatHeap.sel @x1
(NatHeap.upd @x1
@x0
@x2
...
; Starting query at NatHeap.fsti(184,0-192,37)
...
(declare-fun Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(190,24-190,37); use=NatHeap.fsti(190,8-190,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9 @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid refinement_kinding_Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9))

:named refinement_kinding_Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(190,24-190,37); use=NatHeap.fsti(190,8-190,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9 @x2
@x3
@x4
@x5
@x6))
...
;; def=NatHeap.fsti(190,24-190,37); use=NatHeap.fsti(190,8-190,13)
(not 
;; def=NatHeap.fsti(190,26-190,36); use=NatHeap.fsti(190,8-190,13)
(Valid 
;; def=NatHeap.fsti(190,26-190,36); use=NatHeap.fsti(190,8-190,13)
(Prims.op_Equals_Equals_Equals (Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x2
@x3)
...
@x5
@x6)))
:qid refinement_interpretation_Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9))

:named refinement_interpretation_Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9))
;;;;;;;;;;;;;;;;haseq for Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(190,24-190,37); use=NatHeap.fsti(190,8-190,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9 @x0
@x1
@x2
@x3
@x4)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9 @x0
@x1
@x2
@x3
@x4))))
:qid haseqTm_refine_84d5e5f12abd9e9039a61c9d57412dd9))

:named haseqTm_refine_84d5e5f12abd9e9039a61c9d57412dd9))
...
;   (r: NatHeap.ref a {NatHeap.contains h r})
;   (x: a)
;   (r': NatHeap.ref b {NatHeap.contains h r'})
;   (_: Prims.squash (~(r === r'))).
;   (*  - Could not prove post-condition
; *)
;   NatHeap.contains h r' ==> NatHeap.contains (NatHeap.upd h r x) r'
...
; Context: While encoding a query
; While typechecking the top-level declaration `val NatHeap.sel_upd2`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=NatHeap.fsti(184,0-192,37)
...
@x0))
(HasType @x6
(Tm_refine_84d5e5f12abd9e9039a61c9d57412dd9 @x1
@x0
@x2
@x3
@x5))

;; def=NatHeap.fsti(189,17-189,33); use=NatHeap.fsti(191,41-191,43)
(Valid 
;; def=NatHeap.fsti(189,17-189,33); use=NatHeap.fsti(191,41-191,43)
(NatHeap.contains @x2
@x0
...
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(191,41-191,43)
(or label_1
...
; encoding sigelt val NatHeap.sel_upd2


; <Skipped val NatHeap.sel_upd2/>

(push) ;; push{2

; Starting query at NatHeap.fst(110,28-110,30)
...
;     ~(r === r') /\
;     (forall (pure_result: Prims.unit).
;         NatHeap.sel (NatHeap.upd h r x) r' == NatHeap.sel h r' ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)
...
;; def=NatHeap.fsti(190,24-190,37); use=NatHeap.fst(110,28-110,30)
(not 
;; def=NatHeap.fsti(190,26-190,36); use=NatHeap.fst(110,28-110,30)
(Valid 
;; def=NatHeap.fsti(190,26-190,36); use=NatHeap.fst(110,28-110,30)
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(110,28-110,30)
(forall ((@x7 Term))
 (! (implies (and (or label_1
(HasType @x7
Prims.unit))

;; def=NatHeap.fsti(191,24-191,56); use=NatHeap.fst(110,28-110,30)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(110,28-110,30)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(110,28-110,30)
(ApplyTT @x6
@x7)
...
; encoding sigelt val NatHeap.upd_sel


; <Skipped val NatHeap.upd_sel/>
...
;; def=NatHeap.fsti(190,24-190,37); use=NatHeap.fst(110,4-110,12)
(not 
;; def=NatHeap.fsti(190,26-190,36); use=NatHeap.fst(110,4-110,12)
(Valid 
;; def=NatHeap.fsti(190,26-190,36); use=NatHeap.fst(110,4-110,12)
(Prims.op_Equals_Equals_Equals (Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96 @x1
@x0)
...
;; def=NatHeap.fsti(191,24-191,56); use=NatHeap.fst(110,4-110,12)
(= (NatHeap.sel @x2
(NatHeap.upd @x1
@x0
@x3
...
; Starting query at NatHeap.fst(113,2-113,79)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). NatHeap.upd h r (NatHeap.sel h r) == h ==> p pure_result) ==>
;     FStar.FunctionalExtensionality.feq (FStar.Pervasives.Native.snd (NatHeap.upd h
;               r
;               (NatHeap.sel h r)))
;       (FStar.Pervasives.Native.snd h) /\
;     (forall (pure_result: Prims.unit).
;         FStar.FunctionalExtensionality.feq (FStar.Pervasives.Native.snd (NatHeap.upd h
;                   r
;                   (NatHeap.sel h r)))
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(113,2-113,79)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=NatHeap.fsti(199,23-199,47); use=NatHeap.fst(113,2-113,79)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(113,2-113,79)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(113,2-113,79)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,29-441,97); use=NatHeap.fst(113,2-113,79)
(and 
;; def=NatHeap.fst(113,9-113,79); use=NatHeap.fst(113,9-113,79)
(or label_3
...
Tm_abs_93e14b647e5b70664580b7edd33040b4
(FStar.Pervasives.Native.snd Prims.nat
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4)
(NatHeap.upd @x1
@x0
...
;; def=NatHeap.fst(113,9-113,79); use=NatHeap.fst(113,2-113,8)
(Valid 
;; def=NatHeap.fst(113,9-113,79); use=NatHeap.fst(113,2-113,8)
(FStar.FunctionalExtensionality.feq Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.upd_sel, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, FStar.Pervasives.Native_interpretation_Tm_arrow_d952d001575ecb20c572af535c88dd2d, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, constructor_distinct_FStar.Pervasives.Native.Some, data_elim_FStar.Pervasives.Native.Mktuple2, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.is_restricted, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, equation_NatHeap.contains, equation_NatHeap.heap, equation_NatHeap.ref, equation_NatHeap.sel, equation_NatHeap.upd, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, function_token_typing_FStar.Pervasives.Native.snd, int_inversion, interpretation_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, lemma_FStar.FunctionalExtensionality.extensionality, lemma_FStar.FunctionalExtensionality.feq_on_domain, primitive_Prims.op_Equality, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, projection_inverse_Prims.Mkdtuple2__2, refinement_interpretation_Tm_refine_4289597b21978a2daf74d6c05a34b053, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_7e4a6c5999db731b5d17d0418dfeea3e, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_kinding_Tm_refine_7e4a6c5999db731b5d17d0418dfeea3e, token_correspondence_FStar.Pervasives.Native.snd, typing_NatHeap.upd, typing_Tm_abs_278857eefeb5694cca21f6b3f1ee9f74, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4
...
; encoding sigelt val NatHeap.contains_concat1


; <Skipped val NatHeap.contains_concat1/>

;;;;;;;;;;;;;;;;typing_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7
;;; Fact-ids: Name NatHeap.concat; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(84,50-89,36); use=NatHeap.fst(84,50-89,36)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_be68577b6111a37d97443f6d3a0dc9b7 @x0
...
;;; Fact-ids: Name NatHeap.concat; Namespace NatHeap
(assert (! 
;; def=NatHeap.fst(83,4-83,10); use=NatHeap.fst(83,4-83,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
(Tm_refine_f2a7258a07d1d96cb6c864908ecae400 @x0)))
(HasType (NatHeap.concat @x0
@x1)
NatHeap.heap))
 

:pattern ((NatHeap.concat @x0
@x1))
:qid typing_NatHeap.concat))

:named typing_NatHeap.concat))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name NatHeap.concat; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(123,24-123,49); use=NatHeap.fst(83,4-83,10)
...
:pattern ((NatHeap.concat @x0
@x1))
:qid equation_NatHeap.concat))

:named equation_NatHeap.concat))
(push) ;; push{2

; Starting query at NatHeap.fst(116,2-120,47)
...
; Encoding query formula : forall (h0: NatHeap.heap) (h1: NatHeap.heap{NatHeap.consistent h0 h1}) (a: Type) (r: NatHeap.ref a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     NatHeap.contains h0 r /\
;     (forall (pure_result: Prims.unit). NatHeap.contains (NatHeap.concat h0 h1) r ==> p pure_result) ==>
;     (~(Some? (FStar.Pervasives.Native.snd h0 r)) ==> Prims.l_False) /\
;     (forall (b: a: Type0 & a).
;         FStar.Pervasives.Native.snd h0 r == FStar.Pervasives.Native.Some b ==>
...
;               ~(Some? (FStar.Pervasives.Native.snd h1 r)) ==>
;               Prims.l_False) /\
;             (FStar.Pervasives.Native.snd h1 r == FStar.Pervasives.Native.None ==>
;               (forall (any_result: Prims.unit). k any_result)) /\
;             (~(None? (FStar.Pervasives.Native.snd h1 r)) ==>
;               (forall (b: a: Type0 & a).
;                   FStar.Pervasives.Native.snd h1 r == FStar.Pervasives.Native.Some b ==>
;                   FStar.Pervasives.dfst b == FStar.Pervasives.dfst b /\
;                   (forall (pure_result: Prims.unit).
;                       FStar.Pervasives.dfst b == FStar.Pervasives.dfst b ==> k pure_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let contains_concat1`
...
;; def=NatHeap.fsti(209,25-209,40); use=NatHeap.fst(116,2-120,47)
(Valid 
;; def=NatHeap.fsti(209,25-209,40); use=NatHeap.fst(116,2-120,47)
(NatHeap.contains @x2
@x0
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(116,2-120,47)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=NatHeap.fsti(210,39-210,66); use=NatHeap.fst(116,2-120,47)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(116,2-120,47)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(116,2-120,47)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(116,2-120,47)
(and (implies 
;; def=NatHeap.fst(116,8-116,16); use=NatHeap.fst(116,8-116,16)
(not 
;; def=NatHeap.fst(116,8-116,16); use=NatHeap.fst(116,8-116,16)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236)
...
;; def=Prims.fst(413,99-413,120); use=NatHeap.fst(116,2-120,47)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236))

;; def=NatHeap.fst(116,8-117,10); use=NatHeap.fst(116,8-117,10)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=Prims.fst(402,2-402,97); use=NatHeap.fst(116,2-120,47)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Prims.pure_post Prims.unit))
...
(forall ((@x7 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=NatHeap.fst(116,2-120,47)
(Valid 
;; def=Prims.fst(402,73-402,79); use=NatHeap.fst(116,2-120,47)
(ApplyTT @x4
@x7)
...
;; def=Prims.fst(402,84-402,87); use=NatHeap.fst(116,2-120,47)
(Valid 
;; def=Prims.fst(402,84-402,87); use=NatHeap.fst(116,2-120,47)
(ApplyTT @x6
@x7)
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(116,2-120,47)
(and (implies 
;; def=NatHeap.fst(118,13-118,21); use=NatHeap.fst(118,13-118,21)
(and 
;; def=NatHeap.fst(118,13-118,21); use=NatHeap.fst(118,13-118,21)
(not 
;; def=NatHeap.fst(118,13-118,21); use=NatHeap.fst(118,13-118,21)
...
label_4)
(implies 
;; def=NatHeap.fst(118,13-119,13); use=NatHeap.fst(118,13-119,13)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=Prims.fst(451,66-451,102); use=NatHeap.fst(116,2-120,47)
(forall ((@x7 Term))
 (! (implies (HasType @x7
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=NatHeap.fst(116,2-120,47)
(Valid 
;; def=Prims.fst(451,90-451,102); use=NatHeap.fst(116,2-120,47)
(ApplyTT @x6
@x7)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=NatHeap.fst(116,2-120,47)
(not 
;; def=NatHeap.fst(118,13-118,21); use=NatHeap.fst(118,13-118,21)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236)
...
;; def=NatHeap.fst(118,13-120,16); use=NatHeap.fst(118,13-120,16)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=Prims.fst(441,29-441,97); use=NatHeap.fst(120,20-120,26)
(and 
;; def=NatHeap.fst(120,27-120,46); use=NatHeap.fst(120,20-120,26)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(120,20-120,26)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(120,20-120,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(120,20-120,26)
(ApplyTT @x6
@x8)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.contains_concat1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, data_elim_FStar.Pervasives.Native.Mktuple2, data_elim_FStar.Pervasives.Native.Some, data_elim_Prims.Mkdtuple2, disc_equation_FStar.Pervasives.Native.None, disc_equation_FStar.Pervasives.Native.Some, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.snd, equation_FStar.Pervasives.dfst, equation_NatHeap.concat, equation_NatHeap.consistent, equation_NatHeap.contains, equation_NatHeap.heap, equation_NatHeap.ref, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, fuel_guarded_inversion_Prims.dtuple2, int_inversion, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, interpretation_Tm_abs_9706396db915b3a2ea86d4646a5b8236, interpretation_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7, lemma_FStar.FunctionalExtensionality.feq_on_domain, lemma_FStar.Pervasives.invertOption, proj_equation_FStar.Pervasives.Native.Mktuple2__2, proj_equation_Prims.Mkdtuple2__1, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.None_a, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, projection_inverse_Prims.Mkdtuple2__1, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_7e4a6c5999db731b5d17d0418dfeea3e, refinement_interpretation_Tm_refine_f2a7258a07d1d96cb6c864908ecae400, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_FStar.Pervasives.Native.snd, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4, typing_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7
...
; encoding sigelt let contains_concat1


; <Start encoding let contains_concat1>
...
; </end encoding let contains_concat1>


; encoding sigelt val NatHeap.contains_concat2


; <Skipped val NatHeap.contains_concat2/>

;;;;;;;;;;;;;;;;Lemma: NatHeap.contains_concat1
;;; Fact-ids: Name NatHeap.contains_concat1; Namespace NatHeap
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
...
;; def=NatHeap.fsti(209,25-209,40); use=NatHeap.fst(115,4-115,20)
(Valid 
;; def=NatHeap.fsti(209,25-209,40); use=NatHeap.fst(115,4-115,20)
(NatHeap.contains @x2
@x0
...
;; def=NatHeap.fsti(210,39-210,66); use=NatHeap.fst(115,4-115,20)
(Valid 
;; def=NatHeap.fsti(210,39-210,66); use=NatHeap.fst(115,4-115,20)
(NatHeap.contains @x2
(NatHeap.concat @x0
...
@x1)
@x3))
:qid lemma_NatHeap.contains_concat1))
:named lemma_NatHeap.contains_concat1))
(push) ;; push{2

; Starting query at NatHeap.fst(122,33-122,35)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let contains_concat2`
...
;; def=NatHeap.fsti(218,25-218,40); use=NatHeap.fst(122,33-122,35)
(Valid 
;; def=NatHeap.fsti(218,25-218,40); use=NatHeap.fst(122,33-122,35)
(NatHeap.contains @x2
@x1
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(122,33-122,35)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=NatHeap.fsti(219,39-219,66); use=NatHeap.fst(122,33-122,35)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(122,33-122,35)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(122,33-122,35)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.contains_concat2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, FStar.Pervasives.Native_pretyping_b53dbd183c526bc5d0f20d7b966ae125, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, Prims_pretyping_f8666440faa91836cc5a13998af863fc, constructor_distinct_FStar.Pervasives.Native.Some, constructor_distinct_FStar.Pervasives.Native.option, constructor_distinct_Prims.unit, data_elim_FStar.Pervasives.Native.Mktuple2, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.snd, equation_NatHeap.concat, equation_NatHeap.contains, equation_NatHeap.heap, equation_NatHeap.ref, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, int_inversion, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, interpretation_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7, lemma_FStar.FunctionalExtensionality.feq_on_domain, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_7e4a6c5999db731b5d17d0418dfeea3e, refinement_interpretation_Tm_refine_f2a7258a07d1d96cb6c864908ecae400, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_FStar.Pervasives.Native.snd, typing_NatHeap.concat, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4, typing_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7, unit_typing
...
; encoding sigelt let contains_concat2


; <Start encoding let contains_concat2>
...
; </end encoding let contains_concat2>

;;;;;;;;;;;;;;;;Lemma: NatHeap.contains_concat2
;;; Fact-ids: Name NatHeap.contains_concat2; Namespace NatHeap
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
...
;; def=NatHeap.fsti(218,25-218,40); use=NatHeap.fst(122,4-122,20)
(Valid 
;; def=NatHeap.fsti(218,25-218,40); use=NatHeap.fst(122,4-122,20)
(NatHeap.contains @x2
@x1
...
;; def=NatHeap.fsti(219,39-219,66); use=NatHeap.fst(122,4-122,20)
(Valid 
;; def=NatHeap.fsti(219,39-219,66); use=NatHeap.fst(122,4-122,20)
(NatHeap.contains @x2
(NatHeap.concat @x0
...
@x1)
@x3))
:qid lemma_NatHeap.contains_concat2))
:named lemma_NatHeap.contains_concat2))
(push) ;; push{2

; Starting query at NatHeap.fsti(223,0-229,42)
...
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(226,4-226,46); use=NatHeap.fsti(226,4-226,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_241ad8bfe898ca08359d47be04127cb2 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_241ad8bfe898ca08359d47be04127cb2 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_241ad8bfe898ca08359d47be04127cb2))

:named refinement_kinding_Tm_refine_241ad8bfe898ca08359d47be04127cb2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(226,4-226,46); use=NatHeap.fsti(226,4-226,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_241ad8bfe898ca08359d47be04127cb2 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=NatHeap.fsti(226,12-226,25); use=NatHeap.fsti(226,12-226,25)
(Valid 
;; def=NatHeap.fsti(226,12-226,25); use=NatHeap.fsti(226,12-226,25)
(NatHeap.contains @x2
@x3
...
;; def=NatHeap.fsti(226,29-226,45); use=NatHeap.fsti(226,29-226,45)
(not 
;; def=NatHeap.fsti(226,30-226,45); use=NatHeap.fsti(226,30-226,45)
(Valid 
;; def=NatHeap.fsti(226,30-226,45); use=NatHeap.fsti(226,30-226,45)
(NatHeap.contains @x2
@x4
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_241ad8bfe898ca08359d47be04127cb2))

:named refinement_interpretation_Tm_refine_241ad8bfe898ca08359d47be04127cb2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_241ad8bfe898ca08359d47be04127cb2
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(226,4-226,46); use=NatHeap.fsti(226,4-226,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_241ad8bfe898ca08359d47be04127cb2 @x0
@x1
@x2)))
(Valid (Prims.hasEq (NatHeap.ref @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_241ad8bfe898ca08359d47be04127cb2 @x0
@x1
@x2))))
:qid haseqTm_refine_241ad8bfe898ca08359d47be04127cb2))

:named haseqTm_refine_241ad8bfe898ca08359d47be04127cb2))
(declare-fun Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9
...
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(227,20-227,26); use=NatHeap.fsti(227,4-227,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
; Encoding query formula : forall (h0: NatHeap.heap)
;   (h1: NatHeap.heap{NatHeap.consistent h0 h1})
;   (a: Type0)
;   (r: NatHeap.ref a {NatHeap.contains h0 r /\ ~(NatHeap.contains h1 r)})
;   (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   (NatHeap.contains h0 r /\ ~(NatHeap.contains h1 r) ==> NatHeap.contains (NatHeap.concat h0 h1) r) /\
;   (forall (any_result: r: NatHeap.ref a {NatHeap.contains h0 r /\ ~(NatHeap.contains h1 r)}).
;       r == any_result ==>
;       (forall (any_result: a).
;           NatHeap.sel (NatHeap.concat h0 h1) r == any_result ==>
;           NatHeap.contains h0 r /\ ~(NatHeap.contains h1 r) ==> NatHeap.contains h0 r))


; Context: While encoding a query
; While typechecking the top-level declaration `val NatHeap.sel_concat1`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=NatHeap.fsti(223,0-229,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fsti(228,20-228,54)
(and (implies 
;; def=NatHeap.fsti(226,12-226,45); use=NatHeap.fsti(228,40-228,41)
(and 
;; def=NatHeap.fsti(226,12-226,25); use=NatHeap.fsti(228,40-228,41)
(Valid 
;; def=NatHeap.fsti(226,12-226,25); use=NatHeap.fsti(228,40-228,41)
(NatHeap.contains @x2
@x0
...
;; def=NatHeap.fsti(226,29-226,45); use=NatHeap.fsti(228,40-228,41)
(not 
;; def=NatHeap.fsti(226,30-226,45); use=NatHeap.fsti(228,40-228,41)
(Valid 
;; def=NatHeap.fsti(226,30-226,45); use=NatHeap.fsti(228,40-228,41)
(NatHeap.contains @x2
@x1
...
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(228,40-228,41)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=NatHeap.fsti(228,20-228,54)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Tm_refine_241ad8bfe898ca08359d47be04127cb2 @x2
@x0
...
;; def=NatHeap.fsti(58,3-226,5); use=NatHeap.fsti(228,20-228,54)
(= @x3
@x5)
)
...
;; def=Prims.fst(175,35-175,36); use=NatHeap.fsti(228,20-228,54)
(= (NatHeap.sel @x2
(NatHeap.concat @x0
@x1)
@x3)
...
;; def=NatHeap.fsti(226,12-226,25); use=NatHeap.fsti(228,52-228,53)
(Valid 
;; def=NatHeap.fsti(226,12-226,25); use=NatHeap.fsti(228,52-228,53)
(NatHeap.contains @x2
@x0
...
;; def=NatHeap.fsti(226,29-226,45); use=NatHeap.fsti(228,52-228,53)
(not 
;; def=NatHeap.fsti(226,30-226,45); use=NatHeap.fsti(228,52-228,53)
(Valid 
;; def=NatHeap.fsti(226,30-226,45); use=NatHeap.fsti(228,52-228,53)
(NatHeap.contains @x2
@x1
...
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(228,52-228,53)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.sel_concat1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, lemma_NatHeap.contains_concat1, refinement_interpretation_Tm_refine_241ad8bfe898ca08359d47be04127cb2
...
; encoding sigelt val NatHeap.sel_concat1


; <Skipped val NatHeap.sel_concat1/>

(push) ;; push{2

; Starting query at NatHeap.fst(125,2-129,45)
...
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(226,4-226,46); use=NatHeap.fst(124,4-124,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_241ad8bfe898ca08359d47be04127cb2 @x0
@x1
@x2)
...
;; def=NatHeap.fsti(226,12-226,25); use=NatHeap.fst(124,4-124,15)
(Valid 
;; def=NatHeap.fsti(226,12-226,25); use=NatHeap.fst(124,4-124,15)
(NatHeap.contains @x2
@x3
...
;; def=NatHeap.fsti(226,29-226,45); use=NatHeap.fst(124,4-124,15)
(not 
;; def=NatHeap.fsti(226,30-226,45); use=NatHeap.fst(124,4-124,15)
(Valid 
;; def=NatHeap.fsti(226,30-226,45); use=NatHeap.fst(124,4-124,15)
(NatHeap.contains @x2
@x4
...
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         NatHeap.sel (NatHeap.concat h0 h1) r == NatHeap.sel h0 r ==> p pure_result) ==>
;     (~(Some? (FStar.Pervasives.Native.snd h0 r)) ==> Prims.l_False) /\
;     (forall (b: a: Type0 & a).
;         FStar.Pervasives.Native.snd h0 r == FStar.Pervasives.Native.Some b ==>
;         (forall (k: Prims.pure_post Prims.unit).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let sel_concat1`
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(125,2-129,45)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=NatHeap.fsti(228,20-228,54); use=NatHeap.fst(125,2-129,45)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(125,2-129,45)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(125,2-129,45)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(125,2-129,45)
(and (implies 
;; def=NatHeap.fst(125,8-125,16); use=NatHeap.fst(125,8-125,16)
(not 
;; def=NatHeap.fst(125,8-125,16); use=NatHeap.fst(125,8-125,16)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236)
...
;; def=Prims.fst(413,99-413,120); use=NatHeap.fst(125,2-129,45)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236))

;; def=NatHeap.fst(125,8-126,10); use=NatHeap.fst(125,8-126,10)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=Prims.fst(402,2-402,97); use=NatHeap.fst(125,2-129,45)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Prims.pure_post Prims.unit))
...
(forall ((@x7 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=NatHeap.fst(125,2-129,45)
(Valid 
;; def=Prims.fst(402,73-402,79); use=NatHeap.fst(125,2-129,45)
(ApplyTT @x4
@x7)
...
;; def=Prims.fst(402,84-402,87); use=NatHeap.fst(125,2-129,45)
(Valid 
;; def=Prims.fst(402,84-402,87); use=NatHeap.fst(125,2-129,45)
(ApplyTT @x6
@x7)
...
;; def=Prims.fst(459,77-459,89); use=NatHeap.fst(125,2-129,45)
(and (implies 
;; def=NatHeap.fst(127,12-127,20); use=NatHeap.fst(127,12-127,20)
(and 
;; def=NatHeap.fst(127,12-127,20); use=NatHeap.fst(127,12-127,20)
(not 
;; def=NatHeap.fst(127,12-127,20); use=NatHeap.fst(127,12-127,20)
...
label_4)
(implies 
;; def=NatHeap.fst(127,12-128,12); use=NatHeap.fst(127,12-128,12)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=Prims.fst(451,66-451,102); use=NatHeap.fst(125,2-129,45)
(forall ((@x7 Term))
 (! (implies (HasType @x7
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=NatHeap.fst(125,2-129,45)
(Valid 
;; def=Prims.fst(451,90-451,102); use=NatHeap.fst(125,2-129,45)
(ApplyTT @x6
@x7)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=NatHeap.fst(125,2-129,45)
(not 
;; def=NatHeap.fst(127,12-127,20); use=NatHeap.fst(127,12-127,20)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (Prims.dtuple2 Tm_type
Tm_abs_9706396db915b3a2ea86d4646a5b8236)
...
;; def=NatHeap.fst(127,12-129,15); use=NatHeap.fst(127,12-129,15)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.Native.snd@tok
Prims.nat)
(FStar.FunctionalExtensionality.restricted_t Prims.nat
Tm_abs_93e14b647e5b70664580b7edd33040b4))
...
;; def=Prims.fst(441,29-441,97); use=NatHeap.fst(129,19-129,25)
(and 
;; def=NatHeap.fst(129,26-129,45); use=NatHeap.fst(129,19-129,25)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(129,19-129,25)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(129,19-129,25)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(129,19-129,25)
(ApplyTT @x6
@x8)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.sel_concat1, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, data_elim_FStar.Pervasives.Native.Mktuple2, data_elim_FStar.Pervasives.Native.Some, data_elim_Prims.Mkdtuple2, disc_equation_FStar.Pervasives.Native.Some, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.snd, equation_FStar.Pervasives.dfst, equation_NatHeap.concat, equation_NatHeap.consistent, equation_NatHeap.contains, equation_NatHeap.heap, equation_NatHeap.ref, equation_NatHeap.sel, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, fuel_guarded_inversion_Prims.dtuple2, int_inversion, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, interpretation_Tm_abs_9706396db915b3a2ea86d4646a5b8236, interpretation_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7, lemma_FStar.FunctionalExtensionality.feq_on_domain, lemma_FStar.Pervasives.invertOption, lemma_NatHeap.contains_concat1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, proj_equation_Prims.Mkdtuple2__1, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.None_a, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, projection_inverse_Prims.Mkdtuple2__1, refinement_interpretation_Tm_refine_241ad8bfe898ca08359d47be04127cb2, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_7e4a6c5999db731b5d17d0418dfeea3e, refinement_interpretation_Tm_refine_f2a7258a07d1d96cb6c864908ecae400, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_FStar.Pervasives.Native.snd, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4, typing_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7
...
; encoding sigelt let sel_concat1


; <Start encoding let sel_concat1>
...
; </end encoding let sel_concat1>

(push) ;; push{2

; Starting query at NatHeap.fsti(231,0-237,42)
...
;;; Fact-ids: 
(assert (! 
;; def=NatHeap.fsti(235,20-235,26); use=NatHeap.fsti(235,4-235,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
;   (h1: NatHeap.heap{NatHeap.consistent h0 h1})
;   (a: Type0)
;   (r: NatHeap.ref a {NatHeap.contains h1 r})
;   (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   NatHeap.contains h1 r ==> NatHeap.contains (NatHeap.concat h0 h1) r


; Context: While encoding a query
; While typechecking the top-level declaration `val NatHeap.sel_concat2`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=NatHeap.fsti(231,0-237,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
NatHeap.heap)
(HasType @x1
...
;; def=NatHeap.fsti(234,12-234,25); use=NatHeap.fsti(236,40-236,41)
(Valid 
;; def=NatHeap.fsti(234,12-234,25); use=NatHeap.fsti(236,40-236,41)
(NatHeap.contains @x2
@x1
...
;; def=NatHeap.fsti(58,11-58,23); use=NatHeap.fsti(236,40-236,41)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.sel_concat2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, lemma_NatHeap.contains_concat2, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96
...
; encoding sigelt val NatHeap.sel_concat2


; <Skipped val NatHeap.sel_concat2/>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name NatHeap.sel_concat1; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(226,4-226,46); use=NatHeap.fst(124,4-124,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_241ad8bfe898ca08359d47be04127cb2 @x0
...
;; def=NatHeap.fsti(228,20-228,54); use=NatHeap.fst(124,4-124,15)
(= (NatHeap.sel @x2
(NatHeap.concat @x0
@x1)
@x3)
...
@x1)
@x3))
:qid lemma_NatHeap.sel_concat1))
:named lemma_NatHeap.sel_concat1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_241ad8bfe898ca08359d47be04127cb2
;;; Fact-ids: Name NatHeap.sel_concat1; Namespace NatHeap
(assert (! 
;; def=NatHeap.fsti(226,4-226,46); use=NatHeap.fst(124,4-124,15)
...
; Starting query at NatHeap.fst(131,28-131,30)
...
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         NatHeap.sel (NatHeap.concat h0 h1) r == NatHeap.sel h1 r ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let sel_concat2`
...
;; def=Prims.fst(441,36-441,97); use=NatHeap.fst(131,28-131,30)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=NatHeap.fsti(236,20-236,54); use=NatHeap.fst(131,28-131,30)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(131,28-131,30)
(Valid 
;; def=Prims.fst(441,83-441,96); use=NatHeap.fst(131,28-131,30)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (NatHeap.sel_concat2, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.FunctionalExtensionality_interpretation_Tm_arrow_a7d5cc170be69663c495e8582d2bc62a, NatHeap_interpretation_Tm_arrow_1486644300f12d6a82b0741645ed2191, NatHeap_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e, Prims_interpretation_Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, equation_FStar.FunctionalExtensionality.feq, equation_FStar.FunctionalExtensionality.restricted_t, equation_FStar.Pervasives.Native.snd, equation_NatHeap.concat, equation_NatHeap.contains, equation_NatHeap.heap, equation_NatHeap.ref, equation_NatHeap.sel, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, int_inversion, interpretation_Tm_abs_93e14b647e5b70664580b7edd33040b4, interpretation_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7, lemma_FStar.FunctionalExtensionality.feq_on_domain, lemma_NatHeap.contains_concat2, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.None_a, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_bd8b23217d2ca10ddfdabbb5d0948e96, refinement_interpretation_Tm_refine_f2a7258a07d1d96cb6c864908ecae400, refinement_interpretation_Tm_refine_facce1686c7a52366b131e42a1c2bdac, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_FStar.Pervasives.Native.snd, typing_Tm_abs_93e14b647e5b70664580b7edd33040b4, typing_Tm_abs_be68577b6111a37d97443f6d3a0dc9b7
