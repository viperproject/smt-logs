...
; Internals for AllocSTwHeaps


; encoding sigelt val AllocSTwHeaps.sel


; <Start encoding val AllocSTwHeaps.sel>

(declare-fun AllocSTwHeaps.sel (Term Term Term) Term)
(declare-fun Tm_refine_fcc3ae3430dace306efd930c647e1fda (Term Term Term) Term)
;;;;;;;;;;;;;;;;h: FStar.Monotonic.Heap.heap -> r: FStar.ST.ref 'a -> x: 'a{x == FStar.Monotonic.Heap.sel h r}
(declare-fun Tm_arrow_d296c9ab751f6b29585662ed7084331d () Term)
(declare-fun AllocSTwHeaps.sel@tok () Term)


; </end encoding val AllocSTwHeaps.sel>


; encoding sigelt val AllocSTwHeaps.upd


; <Start encoding val AllocSTwHeaps.upd>

(declare-fun AllocSTwHeaps.upd (Term Term Term Term) Term)
(declare-fun Tm_refine_ec74995abaf3afbf48bfcaea8401c27c (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;h: FStar.Monotonic.Heap.heap -> r: FStar.ST.ref 'a -> v: 'a   -> h': FStar.Monotonic.Heap.heap{h' == FStar.Monotonic.Heap.upd h r v}
(declare-fun Tm_arrow_a1ac31f6c84b9fde3210f1fe3cc1fe2d () Term)
(declare-fun AllocSTwHeaps.upd@tok () Term)


; </end encoding val AllocSTwHeaps.upd>
...
(declare-fun AllocSTwHeaps.heap_rel (Term Term) Term)

(declare-fun AllocSTwHeaps.heap_rel@tok () Term)
...
(declare-fun AllocSTwHeaps.ist_pre (Term) Term)

(declare-fun AllocSTwHeaps.ist_pre@tok () Term)
...
(declare-fun AllocSTwHeaps.ist_post (Term Term) Term)

(declare-fun AllocSTwHeaps.ist_post@tok () Term)
...
(declare-fun AllocSTwHeaps.ist_wp (Term Term) Term)

(declare-fun AllocSTwHeaps.ist_wp@tok () Term)
;;;;;;;;;;;;;;;;_: ist_post state a -> ist_pre state
(declare-fun Tm_arrow_6a96f1e0d7e0cfc29556a4db07593d46 (Term Term) Term)
...
(declare-fun AllocSTwHeaps.lift_div_istate (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;state: Type ->     rel: FStar.Preorder.preorder state ->     a: Type ->     wp: Prims.pure_wp a ->     p: ist_post state a ->     s: state   -> Prims.pure_pre
(declare-fun Tm_arrow_44b2d09412af5f75062f86246d41640b () Term)
(declare-fun AllocSTwHeaps.lift_div_istate@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocSTwHeaps.heap_rel; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(33,4-33,12); use=AllocSTwHeaps.fst(33,4-33,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
FStar.Monotonic.Heap.heap)
(HasType @x1
FStar.Monotonic.Heap.heap))
(HasType (AllocSTwHeaps.heap_rel @x0
@x1)
Prims.logical))
 

:pattern ((AllocSTwHeaps.heap_rel @x0
@x1))
:qid typing_AllocSTwHeaps.heap_rel))

:named typing_AllocSTwHeaps.heap_rel))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;; def=AllocSTwHeaps.fst(33,4-33,12); use=AllocSTwHeaps.fst(33,4-33,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT AllocSTwHeaps.heap_rel@tok
@x0)
@x1)
(AllocSTwHeaps.heap_rel @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT AllocSTwHeaps.heap_rel@tok
@x0)
@x1))
:qid token_correspondence_AllocSTwHeaps.heap_rel))

:named token_correspondence_AllocSTwHeaps.heap_rel))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType AllocSTwHeaps.heap_rel@tok
...
@x1)
@x2)
(AllocSTwHeaps.heap_rel @x1
@x2))
 

:pattern ((AllocSTwHeaps.heap_rel @x1
@x2))
:qid function_token_typing_AllocSTwHeaps.heap_rel.1))
)
 

:pattern ((ApplyTT @x0
AllocSTwHeaps.heap_rel@tok))
:qid function_token_typing_AllocSTwHeaps.heap_rel))

:named function_token_typing_AllocSTwHeaps.heap_rel))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;Equation for AllocSTwHeaps.heap_rel
;;; Fact-ids: Name AllocSTwHeaps.heap_rel; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(33,4-33,12); use=AllocSTwHeaps.fst(33,4-33,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (AllocSTwHeaps.heap_rel @x0
@x1))

;; def=AllocSTwHeaps.fst(34,2-34,84); use=AllocSTwHeaps.fst(34,2-34,84)
...
;; def=AllocSTwHeaps.fst(34,31-34,55); use=AllocSTwHeaps.fst(34,31-34,55)
(Valid 
;; def=AllocSTwHeaps.fst(34,31-34,55); use=AllocSTwHeaps.fst(34,31-34,55)
(FStar.Monotonic.Heap.contains @x2
...
;; def=AllocSTwHeaps.fst(34,60-34,84); use=AllocSTwHeaps.fst(34,60-34,84)
(Valid 
;; def=AllocSTwHeaps.fst(34,60-34,84); use=AllocSTwHeaps.fst(34,60-34,84)
(FStar.Monotonic.Heap.contains @x2
(FStar.Heap.trivial_preorder @x2)
...
;;no pats
:qid equation_AllocSTwHeaps.heap_rel.1))
)
 

:pattern ((AllocSTwHeaps.heap_rel @x0
@x1))
:qid equation_AllocSTwHeaps.heap_rel))

:named equation_AllocSTwHeaps.heap_rel))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;;;;;;;;;;;;;;;;Prop-typing for AllocSTwHeaps.heap_rel
;;; Fact-ids: Name AllocSTwHeaps.heap_rel; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(33,4-33,12); use=AllocSTwHeaps.fst(33,4-33,12)
(forall ((@x0 Term) (@x1 Term))
...
(HasType @x1
FStar.Monotonic.Heap.heap))
(Valid (Prims.subtype_of (AllocSTwHeaps.heap_rel @x0
@x1)
Prims.unit)))
 

:pattern ((Prims.subtype_of (AllocSTwHeaps.heap_rel @x0
@x1)
Prims.unit))
:qid defn_equation_AllocSTwHeaps.heap_rel))

:named defn_equation_AllocSTwHeaps.heap_rel))
...
;;; Fact-ids: Name FStar.ST.heap_rel; Namespace FStar.ST
(assert (! 
;; def=FStar.ST.fst(36,17-36,31); use=FStar.ST.fst(36,17-37,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9)
...
@x1
Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))
:qid FStar.ST_pre_typing_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))

:named FStar.ST_pre_typing_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))
...
@x1)
@x2))
:qid FStar.ST_interpretation_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.ST_interpretation_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))
:qid FStar.ST_interpretation_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))

:named FStar.ST_interpretation_Tm_arrow_3ffd8da3a1b4fb5a75e097e2a7ead7a9))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
AllocSTwHeaps.heap_rel@tok))
:named @kick_partial_app_f05320f590e7d9c115a848bf3f2c1fc3))

; Encoding query formula : Prims.auto_squash (FStar.Preorder.preorder_rel AllocSTwHeaps.heap_rel)
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Preorder.fst(33,40-33,56); use=AllocSTwHeaps.fst(65,59-65,67)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocSTwHeaps.heap_rel, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, token_correspondence_AllocSTwHeaps.heap_rel
...
; encoding sigelt effect IST a pre post = AllocSTwHeaps.ISTATE a


; <Skipped effect IST a pre post = AllocSTwHeaps.ISTATE a/>
...
; Starting query at AllocSTwHeaps.fst(80,69-80,89)
...
AllocSTwHeaps.heap_rel@tok))
:named @kick_partial_app_f05320f590e7d9c115a848bf3f2c1fc3))
(declare-fun Tm_refine_2bada71192e8b020fbd6655cd171663b () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_2bada71192e8b020fbd6655cd171663b
Tm_type)
:named refinement_kinding_Tm_refine_2bada71192e8b020fbd6655cd171663b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=AllocSTwHeaps.fst(80,18-80,66); use=AllocSTwHeaps.fst(80,18-80,66)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_2bada71192e8b020fbd6655cd171663b)
(and (HasTypeFuel @u0
@x1
(FStar.Preorder.predicate FStar.Monotonic.Heap.heap))

;; def=AllocSTwHeaps.fst(80,47-80,64); use=AllocSTwHeaps.fst(80,47-80,64)
(Valid 
;; def=AllocSTwHeaps.fst(80,47-80,64); use=AllocSTwHeaps.fst(80,47-80,64)
...
@x1
Tm_refine_2bada71192e8b020fbd6655cd171663b))
:qid refinement_interpretation_Tm_refine_2bada71192e8b020fbd6655cd171663b))

:named refinement_interpretation_Tm_refine_2bada71192e8b020fbd6655cd171663b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_2bada71192e8b020fbd6655cd171663b
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_2bada71192e8b020fbd6655cd171663b))
(Valid (Prims.hasEq (FStar.Preorder.predicate FStar.Monotonic.Heap.heap))))
:named haseqTm_refine_2bada71192e8b020fbd6655cd171663b))
...
; *)
;   Prims.auto_squash (FStar.Preorder.preorder_rel AllocSTwHeaps.heap_rel)
...
;; def=FStar.Preorder.fst(33,40-33,56); use=AllocSTwHeaps.fst(80,79-80,87)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.ist_witnessed, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocSTwHeaps.heap_rel, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, token_correspondence_AllocSTwHeaps.heap_rel
...
; Starting query at AllocSTwHeaps.fst(80,0-80,89)
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=AllocSTwHeaps.fst(80,69-80,89)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate FStar.Monotonic.Heap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=AllocSTwHeaps.fst(80,56-80,64)
(or label_1

;; def=FStar.Preorder.fst(35,53-35,69); use=AllocSTwHeaps.fst(80,69-80,89)
(Valid 
;; def=FStar.Preorder.fst(35,53-35,69); use=AllocSTwHeaps.fst(80,69-80,89)
(FStar.Preorder.preorder_rel FStar.Monotonic.Heap.heap
AllocSTwHeaps.heap_rel@tok)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.ist_witnessed, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocSTwHeaps.heap_rel, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, token_correspondence_AllocSTwHeaps.heap_rel
...
(declare-fun Tm_refine_2bada71192e8b020fbd6655cd171663b () Term)
(declare-fun AllocSTwHeaps.ist_witnessed (Term) Term)


;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate FStar.Monotonic.Heap.heap {FStar.Preorder.stable p heap_rel} -> Type
(declare-fun Tm_arrow_ee70e4aeb9b09ce4e6785506051ac21f () Term)
(declare-fun AllocSTwHeaps.ist_witnessed@tok () Term)
...
; encoding sigelt val AllocSTwHeaps.ist_get


; <Start encoding val AllocSTwHeaps.ist_get>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocSTwHeaps.ist_get (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocSTwHeaps.ist_get@tok () Term)

; </end encoding val AllocSTwHeaps.ist_get>


; encoding sigelt val AllocSTwHeaps.ist_put


; <Start encoding val AllocSTwHeaps.ist_put>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocSTwHeaps.ist_put (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocSTwHeaps.ist_put@tok () Term)

; </end encoding val AllocSTwHeaps.ist_put>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name AllocSTwHeaps.ist_witnessed; Namespace AllocSTwHeaps
(assert (! (HasType Tm_refine_2bada71192e8b020fbd6655cd171663b
Tm_type)
:named refinement_kinding_Tm_refine_2bada71192e8b020fbd6655cd171663b))
;;;;;;;;;;;;;;;;refinement_interpretation
...
; Starting query at AllocSTwHeaps.fst(90,7-91,81)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val AllocSTwHeaps.ist_witness`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=AllocSTwHeaps.fst(90,25-91,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate FStar.Monotonic.Heap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=AllocSTwHeaps.fst(90,62-90,70)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.ist_witness, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocSTwHeaps.heap_rel, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, token_correspondence_AllocSTwHeaps.heap_rel
...
; encoding sigelt val AllocSTwHeaps.ist_witness


; <Start encoding val AllocSTwHeaps.ist_witness>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocSTwHeaps.ist_witness (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocSTwHeaps.ist_witness@tok () Term)

; </end encoding val AllocSTwHeaps.ist_witness>

(push) ;; push{2

; Starting query at AllocSTwHeaps.fst(93,7-94,80)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val AllocSTwHeaps.ist_recall`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=AllocSTwHeaps.fst(93,25-94,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate FStar.Monotonic.Heap.heap))

;; def=FStar.Preorder.fst(35,53-35,69); use=AllocSTwHeaps.fst(93,62-93,70)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.ist_recall, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AllocSTwHeaps.heap_rel, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, token_correspondence_AllocSTwHeaps.heap_rel
...
; encoding sigelt val AllocSTwHeaps.ist_recall


; <Start encoding val AllocSTwHeaps.ist_recall>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocSTwHeaps.ist_recall (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocSTwHeaps.ist_recall@tok () Term)

; </end encoding val AllocSTwHeaps.ist_recall>
...
(declare-fun AllocSTwHeaps.contains (Term Term Term) Term)
;;;;;;;;;;;;;;;;r: FStar.ST.ref a -> h: FStar.Monotonic.Heap.heap -> Prims.logical
(declare-fun Tm_arrow_028221882715371dbcd2cf289a98bf9f () Term)
(declare-fun AllocSTwHeaps.contains@tok () Term)

; </end encoding let contains>


; encoding sigelt val AllocSTwHeaps.contains_lemma


; <Skipped val AllocSTwHeaps.contains_lemma/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocSTwHeaps.contains; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(102,4-102,12); use=AllocSTwHeaps.fst(102,4-102,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
FStar.Monotonic.Heap.heap))
(HasType (AllocSTwHeaps.contains @x0
@x1
@x2)
Prims.logical))
 

:pattern ((AllocSTwHeaps.contains @x0
@x1
@x2))
:qid typing_AllocSTwHeaps.contains))

:named typing_AllocSTwHeaps.contains))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.pure_post'; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;Equation for AllocSTwHeaps.contains
;;; Fact-ids: Name AllocSTwHeaps.contains; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(102,4-102,12); use=AllocSTwHeaps.fst(102,4-102,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (AllocSTwHeaps.contains @x0
@x1
@x2))

;; def=AllocSTwHeaps.fst(103,2-103,83); use=AllocSTwHeaps.fst(103,2-103,83)
(BoxBool_proj_0 (FStar.StrongExcludedMiddle.strong_excluded_middle (FStar.Monotonic.Heap.contains @x0
(FStar.Heap.trivial_preorder @x0)
@x2
@x1)))
)
...
@x1
@x2))
:qid equation_AllocSTwHeaps.contains))

:named equation_AllocSTwHeaps.contains))
;;;;;;;;;;;;;;;;Prop-typing for AllocSTwHeaps.contains
;;; Fact-ids: Name AllocSTwHeaps.contains; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(102,4-102,12); use=AllocSTwHeaps.fst(102,4-102,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
FStar.Monotonic.Heap.heap))
(Valid (Prims.subtype_of (AllocSTwHeaps.contains @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (AllocSTwHeaps.contains @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_AllocSTwHeaps.contains))

:named defn_equation_AllocSTwHeaps.contains))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Prims.pure_post'; Namespace Prims
(assert (! 
;; def=Prims.fst(315,31-315,54); use=Prims.fst(315,31-315,54)
...
; Starting query at AllocSTwHeaps.fst(112,28-112,30)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (h: FStar.Monotonic.Heap.heap) (r: FStar.ST.ref a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     AllocSTwHeaps.contains r h /\
;     (forall (pure_result: Prims.unit). FStar.Monotonic.Heap.contains h r ==> p pure_result) ==>
...
;; def=AllocSTwHeaps.fst(109,23-109,37); use=AllocSTwHeaps.fst(112,28-112,30)
(Valid 
;; def=AllocSTwHeaps.fst(109,23-109,37); use=AllocSTwHeaps.fst(112,28-112,30)
(AllocSTwHeaps.contains @x0
@x2
@x1)
)


;; def=Prims.fst(441,36-441,97); use=AllocSTwHeaps.fst(112,28-112,30)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=AllocSTwHeaps.fst(110,23-110,48); use=AllocSTwHeaps.fst(112,28-112,30)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=AllocSTwHeaps.fst(112,28-112,30)
(Valid 
;; def=Prims.fst(441,83-441,96); use=AllocSTwHeaps.fst(112,28-112,30)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.contains_lemma, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, bool_inversion, equation_AllocSTwHeaps.contains, equation_FStar.Heap.trivial_preorder, equation_FStar.ST.mref, equation_FStar.ST.ref, equation_FStar.StrongExcludedMiddle.strong_excluded_middle, refinement_interpretation_Tm_refine_2c7ecebd8a41d0890aab4251b61d6458, refinement_interpretation_Tm_refine_e33ef751d600ad1c7f71142479103c47, typing_FStar.Heap.trivial_preorder, typing_FStar.Monotonic.Heap.contains, typing_FStar.StrongExcludedMiddle.strong_excluded_middle
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocSTwHeaps.contains_lemma (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocSTwHeaps.contains_lemma@tok () Term)
...
;; def=AllocSTwHeaps.fst(102,4-102,12); use=AllocSTwHeaps.fst(102,4-102,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT AllocSTwHeaps.contains@tok
@x0)
@x1)
@x2)
(AllocSTwHeaps.contains @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT AllocSTwHeaps.contains@tok
@x0)
@x1)
@x2))
:qid token_correspondence_AllocSTwHeaps.contains))

:named token_correspondence_AllocSTwHeaps.contains))
;;;;;;;;;;;;;;;;Lemma: AllocSTwHeaps.contains_lemma
;;; Fact-ids: Name AllocSTwHeaps.contains_lemma; Namespace AllocSTwHeaps
...
;; def=AllocSTwHeaps.fst(109,23-109,37); use=AllocSTwHeaps.fst(112,4-112,18)
(Valid 
;; def=AllocSTwHeaps.fst(109,23-109,37); use=AllocSTwHeaps.fst(112,4-112,18)
(AllocSTwHeaps.contains @x0
@x2
...
;; def=AllocSTwHeaps.fst(110,23-110,48); use=AllocSTwHeaps.fst(112,4-112,18)
(Valid 
;; def=AllocSTwHeaps.fst(110,23-110,48); use=AllocSTwHeaps.fst(112,4-112,18)
(FStar.Monotonic.Heap.contains @x0
(FStar.Heap.trivial_preorder @x0)
...
@x2
@x1))
:qid lemma_AllocSTwHeaps.contains_lemma))
:named lemma_AllocSTwHeaps.contains_lemma))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_028221882715371dbcd2cf289a98bf9f
;;; Fact-ids: Name AllocSTwHeaps.contains; Namespace AllocSTwHeaps
(assert (! (HasType Tm_arrow_028221882715371dbcd2cf289a98bf9f
Tm_type)
:named kinding_Tm_arrow_028221882715371dbcd2cf289a98bf9f))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name AllocSTwHeaps.contains; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(102,4-102,12); use=AllocSTwHeaps.fst(102,4-102,12)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType AllocSTwHeaps.contains@tok
Tm_arrow_028221882715371dbcd2cf289a98bf9f))
...
@x2)
@x3)
(AllocSTwHeaps.contains @x1
@x2
@x3))
 

:pattern ((AllocSTwHeaps.contains @x1
@x2
@x3))
:qid function_token_typing_AllocSTwHeaps.contains.1))
)
 

:pattern ((ApplyTT @x0
AllocSTwHeaps.contains@tok))
:qid function_token_typing_AllocSTwHeaps.contains))

:named function_token_typing_AllocSTwHeaps.contains))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name AllocSTwHeaps.contains; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(102,17-102,51); use=AllocSTwHeaps.fst(102,17-103,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_028221882715371dbcd2cf289a98bf9f)
...
@x1
Tm_arrow_028221882715371dbcd2cf289a98bf9f))
:qid AllocSTwHeaps_pre_typing_Tm_arrow_028221882715371dbcd2cf289a98bf9f))

:named AllocSTwHeaps_pre_typing_Tm_arrow_028221882715371dbcd2cf289a98bf9f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_028221882715371dbcd2cf289a98bf9f
;;; Fact-ids: Name AllocSTwHeaps.contains; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(102,17-102,51); use=AllocSTwHeaps.fst(102,17-103,5)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid AllocSTwHeaps_interpretation_Tm_arrow_028221882715371dbcd2cf289a98bf9f.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid AllocSTwHeaps_interpretation_Tm_arrow_028221882715371dbcd2cf289a98bf9f.2))
...
@x1)
@x2))
:qid AllocSTwHeaps_interpretation_Tm_arrow_028221882715371dbcd2cf289a98bf9f.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_028221882715371dbcd2cf289a98bf9f))
:qid AllocSTwHeaps_interpretation_Tm_arrow_028221882715371dbcd2cf289a98bf9f))

:named AllocSTwHeaps_interpretation_Tm_arrow_028221882715371dbcd2cf289a98bf9f))
(push) ;; push{2

; Starting query at AllocSTwHeaps.fst(118,13-118,48)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
AllocSTwHeaps.contains@tok))
:named @kick_partial_app_3e489670b68125051f9cd234f4a0b4aa))


; Encoding query formula : forall (a: Type) (r: FStar.ST.ref a).
;   (*  - Subtyping check failed
;   - Expected type
;       p:
;       FStar.Preorder.predicate FStar.Monotonic.Heap.heap
;         {FStar.Preorder.stable p heap_rel}
;     got type h: FStar.Monotonic.Heap.heap -> Prims.logical
; *)
;   Prims.auto_squash (FStar.Preorder.stable (AllocSTwHeaps.contains r) AllocSTwHeaps.heap_rel)
...
;; def=AllocSTwHeaps.fst(80,47-80,64); use=AllocSTwHeaps.fst(118,35-118,47)
(or label_1
...
;; def=AllocSTwHeaps.fst(80,47-80,64); use=AllocSTwHeaps.fst(118,35-118,47)
(FStar.Preorder.stable FStar.Monotonic.Heap.heap
(ApplyTT (ApplyTT AllocSTwHeaps.contains@tok
@x0)
@x1)
AllocSTwHeaps.heap_rel@tok)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.ref, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_AllocSTwHeaps.contains, equation_AllocSTwHeaps.heap_rel, equation_FStar.Heap.trivial_preorder, equation_FStar.Preorder.stable, equation_FStar.ST.mref, equation_FStar.ST.ref, equation_FStar.StrongExcludedMiddle.strong_excluded_middle, lemma_AllocSTwHeaps.contains_lemma, refinement_interpretation_Tm_refine_2c7ecebd8a41d0890aab4251b61d6458, refinement_interpretation_Tm_refine_e33ef751d600ad1c7f71142479103c47, token_correspondence_AllocSTwHeaps.contains, token_correspondence_AllocSTwHeaps.heap_rel, typing_FStar.Heap.trivial_preorder, typing_FStar.Monotonic.Heap.contains, typing_FStar.StrongExcludedMiddle.strong_excluded_middle
...
(declare-fun AllocSTwHeaps.ref (Term) Term)

(declare-fun AllocSTwHeaps.ref@tok () Term)
(declare-fun Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8 (Term) Term)

; </end encoding let ref>


; encoding sigelt val AllocSTwHeaps.gen_ref


; <Start encoding val AllocSTwHeaps.gen_ref>

(declare-fun AllocSTwHeaps.gen_ref (Term Term) Term)
(declare-fun Tm_refine_5694aa6cb032c1a787a03895fe77cef3 (Term Term) Term)
;;;;;;;;;;;;;;;;h: FStar.Monotonic.Heap.heap -> r: ref a {FStar.Monotonic.Heap.unused_in r h}
(declare-fun Tm_arrow_178ffcb2f96d83de5764bab4bf1db82f () Term)
(declare-fun AllocSTwHeaps.gen_ref@tok () Term)


; </end encoding val AllocSTwHeaps.gen_ref>
...
(declare-fun AllocSTwHeaps.st_pre () Term)
...
(declare-fun AllocSTwHeaps.st_post (Term) Term)

(declare-fun AllocSTwHeaps.st_post@tok () Term)
...
(declare-fun AllocSTwHeaps.st_wp (Term) Term)

(declare-fun AllocSTwHeaps.st_wp@tok () Term)
;;;;;;;;;;;;;;;;_: st_post a -> st_pre
(declare-fun Tm_arrow_fa0d9c87ed64bc6734504bc94e89980e (Term) Term)

; </end encoding let st_wp>


; encoding sigelt effect AllocST a pre post = AllocSTwHeaps.IST a


; <Skipped effect AllocST a pre post = AllocSTwHeaps.IST a/>


; encoding sigelt val AllocSTwHeaps.alloc


; <Skipped val AllocSTwHeaps.alloc/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocSTwHeaps.upd; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(23,11-23,14); use=AllocSTwHeaps.fst(23,11-23,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((AllocSTwHeaps.upd @x0
@x1
@x2
@x3))
:qid typing_AllocSTwHeaps.upd))

:named typing_AllocSTwHeaps.upd))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocSTwHeaps.ref; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(118,5-118,8); use=AllocSTwHeaps.fst(118,5-118,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (AllocSTwHeaps.ref @x0)
Tm_type))
 

:pattern ((AllocSTwHeaps.ref @x0))
:qid typing_AllocSTwHeaps.ref))

:named typing_AllocSTwHeaps.ref))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocSTwHeaps.ist_witnessed; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(80,4-80,17); use=AllocSTwHeaps.fst(80,4-80,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_2bada71192e8b020fbd6655cd171663b)
(HasType (AllocSTwHeaps.ist_witnessed @x0)
Tm_type))
 

:pattern ((AllocSTwHeaps.ist_witnessed @x0))
:qid typing_AllocSTwHeaps.ist_witnessed))

:named typing_AllocSTwHeaps.ist_witnessed))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocSTwHeaps.gen_ref; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(123,11-123,18); use=AllocSTwHeaps.fst(123,11-123,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
FStar.Monotonic.Heap.heap))
(HasType (AllocSTwHeaps.gen_ref @x0
@x1)
(Tm_refine_5694aa6cb032c1a787a03895fe77cef3 @x0
@x1)))
 

:pattern ((AllocSTwHeaps.gen_ref @x0
@x1))
:qid typing_AllocSTwHeaps.gen_ref))

:named typing_AllocSTwHeaps.gen_ref))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name AllocSTwHeaps.upd; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(23,61-23,109); use=AllocSTwHeaps.fst(23,61-23,109)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;;; Fact-ids: Name AllocSTwHeaps.ref; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(118,13-118,48); use=AllocSTwHeaps.fst(118,13-118,48)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8))

:named refinement_kinding_Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name AllocSTwHeaps.gen_ref; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(125,11-125,42); use=AllocSTwHeaps.fst(125,11-125,42)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_5694aa6cb032c1a787a03895fe77cef3 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_5694aa6cb032c1a787a03895fe77cef3 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_5694aa6cb032c1a787a03895fe77cef3))

:named refinement_kinding_Tm_refine_5694aa6cb032c1a787a03895fe77cef3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name AllocSTwHeaps.upd; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(23,61-23,109); use=AllocSTwHeaps.fst(23,61-23,109)
...
;; def=AllocSTwHeaps.fst(23,81-23,107); use=AllocSTwHeaps.fst(23,81-23,107)
(= @x1
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.ST.ref @x2))

;; def=AllocSTwHeaps.fst(118,21-118,47); use=AllocSTwHeaps.fst(118,21-118,47)
(Valid 
;; def=AllocSTwHeaps.fst(118,21-118,47); use=AllocSTwHeaps.fst(118,21-118,47)
(AllocSTwHeaps.ist_witnessed (ApplyTT (ApplyTT AllocSTwHeaps.contains@tok
@x2)
@x1))
)
))
...
@x1
(Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8 @x2)))
:qid refinement_interpretation_Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8))

:named refinement_interpretation_Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name AllocSTwHeaps.gen_ref; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(125,11-125,42); use=AllocSTwHeaps.fst(125,11-125,42)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5694aa6cb032c1a787a03895fe77cef3 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(AllocSTwHeaps.ref @x2))

;; def=AllocSTwHeaps.fst(125,20-125,40); use=AllocSTwHeaps.fst(125,20-125,40)
(Valid 
;; def=AllocSTwHeaps.fst(125,20-125,40); use=AllocSTwHeaps.fst(125,20-125,40)
...
(Tm_refine_5694aa6cb032c1a787a03895fe77cef3 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_5694aa6cb032c1a787a03895fe77cef3))

:named refinement_interpretation_Tm_refine_5694aa6cb032c1a787a03895fe77cef3))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8
;;; Fact-ids: Name AllocSTwHeaps.ref; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(118,13-118,48); use=AllocSTwHeaps.fst(118,13-118,48)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8 @x0)))
(Valid (Prims.hasEq (FStar.ST.ref @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8 @x0))))
:qid haseqTm_refine_7d1ecf302207478c2c2b5f3c521f42f8))

:named haseqTm_refine_7d1ecf302207478c2c2b5f3c521f42f8))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5694aa6cb032c1a787a03895fe77cef3
;;; Fact-ids: Name AllocSTwHeaps.gen_ref; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(125,11-125,42); use=AllocSTwHeaps.fst(125,11-125,42)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5694aa6cb032c1a787a03895fe77cef3 @x0
@x1)))
(Valid (Prims.hasEq (AllocSTwHeaps.ref @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5694aa6cb032c1a787a03895fe77cef3 @x0
@x1))))
:qid haseqTm_refine_5694aa6cb032c1a787a03895fe77cef3))

:named haseqTm_refine_5694aa6cb032c1a787a03895fe77cef3))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Prims.prop
Tm_type)
...
;;;;;;;;;;;;;;;;Equation for AllocSTwHeaps.ref
;;; Fact-ids: Name AllocSTwHeaps.ref; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(118,5-118,8); use=AllocSTwHeaps.fst(118,5-118,8)
(forall ((@x0 Term))
 (! (= (AllocSTwHeaps.ref @x0)
(Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8 @x0))
 

:pattern ((AllocSTwHeaps.ref @x0))
:qid equation_AllocSTwHeaps.ref))

:named equation_AllocSTwHeaps.ref))
;;;;;;;;;;;;;;;;Equation for AllocSTwHeaps.ist_witnessed
;;; Fact-ids: Name AllocSTwHeaps.ist_witnessed; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(80,4-80,17); use=AllocSTwHeaps.fst(80,4-80,17)
(forall ((@x0 Term))
 (! (= (AllocSTwHeaps.ist_witnessed @x0)
(FStar.Monotonic.Witnessed.witnessed FStar.Monotonic.Heap.heap
AllocSTwHeaps.heap_rel@tok
@x0))
 

:pattern ((AllocSTwHeaps.ist_witnessed @x0))
:qid equation_AllocSTwHeaps.ist_witnessed))

:named equation_AllocSTwHeaps.ist_witnessed))
...
; Starting query at AllocSTwHeaps.fst(152,16-157,3)
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap (AllocSTwHeaps.ref a))
;     (h: FStar.Monotonic.Heap.heap).
;     (forall (x: AllocSTwHeaps.ref a) (s1: FStar.Monotonic.Heap.heap).
;         FStar.Monotonic.Heap.unused_in x h /\ FStar.Monotonic.Heap.contains s1 x /\
;         s1 == FStar.Monotonic.Heap.upd h x x ==>
;         p x s1) ==>
;     (forall (x: FStar.Monotonic.Heap.heap) (s1: FStar.Monotonic.Heap.heap).
;         h == x /\ x == s1 ==>
;         AllocSTwHeaps.heap_rel s1 (AllocSTwHeaps.upd x (AllocSTwHeaps.gen_ref x) x) /\
;         (forall (x: Prims.unit) (s1: FStar.Monotonic.Heap.heap).
;             AllocSTwHeaps.heap_rel s1 (AllocSTwHeaps.upd x (AllocSTwHeaps.gen_ref x) x) /\
;             s1 == AllocSTwHeaps.upd x (AllocSTwHeaps.gen_ref x) x ==>
;             Prims.auto_squash (FStar.Preorder.stable (AllocSTwHeaps.contains (AllocSTwHeaps.gen_ref x
;                         ))
...
;                 FStar.Preorder.predicate FStar.Monotonic.Heap.heap
;                   {FStar.Preorder.stable p AllocSTwHeaps.heap_rel}).
;                 return_val == AllocSTwHeaps.contains (AllocSTwHeaps.gen_ref x) ==>
;                 AllocSTwHeaps.contains (AllocSTwHeaps.gen_ref x) s1 /\
;                 (forall (x: Prims.unit) (s1: FStar.Monotonic.Heap.heap).
;                     AllocSTwHeaps.contains (AllocSTwHeaps.gen_ref x) s1 /\
;                     (s1 == s1) /\
;                     AllocSTwHeaps.ist_witnessed (AllocSTwHeaps.contains (AllocSTwHeaps.gen_ref x)) ==>
;                     p (AllocSTwHeaps.gen_ref x) s1))))
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(152,16-157,3)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (or label_1
(HasType @x4
(AllocSTwHeaps.ref @x0)))
...
;; def=AllocSTwHeaps.fst(149,44-149,65); use=AllocSTwHeaps.fst(152,16-157,3)
(or label_3
...
;; def=AllocSTwHeaps.fst(150,9-150,33); use=AllocSTwHeaps.fst(152,16-157,3)
(or label_4
...
;; def=AllocSTwHeaps.fst(151,16-151,43); use=AllocSTwHeaps.fst(152,16-157,3)
(or label_5
...
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(152,16-157,3)
(Valid 
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(152,16-157,3)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(153,10-153,17)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
FStar.Monotonic.Heap.heap)
(HasType @x5
...
;; def=AllocSTwHeaps.fst(85,86-85,93); use=AllocSTwHeaps.fst(153,10-153,17)
(= @x3
@x4)


;; def=AllocSTwHeaps.fst(85,97-85,104); use=AllocSTwHeaps.fst(153,10-153,17)
(= @x4
@x5)
)

;; def=AllocSTwHeaps.fst(75,29-75,88); use=AllocSTwHeaps.fst(155,2-155,9)
(and 
;; def=AllocSTwHeaps.fst(88,31-88,44); use=AllocSTwHeaps.fst(155,2-155,9)
(or label_6

;; def=AllocSTwHeaps.fst(88,31-88,44); use=AllocSTwHeaps.fst(155,2-155,9)
(Valid 
;; def=AllocSTwHeaps.fst(88,31-88,44); use=AllocSTwHeaps.fst(155,2-155,9)
(AllocSTwHeaps.heap_rel @x5
(AllocSTwHeaps.upd @x0
@x4
(AllocSTwHeaps.gen_ref @x0
@x4)
@x1))
)
)
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(155,2-155,9)
...
;; def=AllocSTwHeaps.fst(88,62-88,69); use=AllocSTwHeaps.fst(155,2-155,9)
(= @x7
(AllocSTwHeaps.upd @x0
@x4
(AllocSTwHeaps.gen_ref @x0
...
;; def=Prims.fst(459,77-459,89); use=AllocSTwHeaps.fst(152,16-157,3)
(and 
;; def=AllocSTwHeaps.fst(90,53-90,70); use=AllocSTwHeaps.fst(156,14-156,26)
(or label_7
...
;; def=Prims.fst(356,2-356,58); use=AllocSTwHeaps.fst(152,16-157,3)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Tm_refine_2bada71192e8b020fbd6655cd171663b)

;; def=Prims.fst(356,26-356,41); use=AllocSTwHeaps.fst(152,16-157,3)
(= @x8
(ApplyTT (ApplyTT AllocSTwHeaps.contains@tok
@x0)
(AllocSTwHeaps.gen_ref @x0
...
;; def=AllocSTwHeaps.fst(75,29-75,88); use=AllocSTwHeaps.fst(156,2-156,13)
(and 
;; def=AllocSTwHeaps.fst(91,31-91,35); use=AllocSTwHeaps.fst(156,2-156,13)
(or label_8
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(156,2-156,13)
...
;; def=AllocSTwHeaps.fst(91,53-91,61); use=AllocSTwHeaps.fst(156,2-156,13)
(= @x7
@x10)


;; def=AllocSTwHeaps.fst(91,65-91,80); use=AllocSTwHeaps.fst(156,2-156,13)
(Valid 
;; def=AllocSTwHeaps.fst(91,65-91,80); use=AllocSTwHeaps.fst(156,2-156,13)
(AllocSTwHeaps.ist_witnessed (ApplyTT (ApplyTT AllocSTwHeaps.contains@tok
@x0)
...
;; def=FStar.Pervasives.fsti(463,24-463,34); use=AllocSTwHeaps.fst(152,16-157,3)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=AllocSTwHeaps.fst(152,16-157,3)
(ApplyTT (ApplyTT @x2
(AllocSTwHeaps.gen_ref @x0
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.alloc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_AllocSTwHeaps.contains, equation_AllocSTwHeaps.heap_rel, equation_AllocSTwHeaps.ref, equation_FStar.Heap.trivial_preorder, equation_FStar.Preorder.stable, equation_FStar.ST.mref, equation_FStar.ST.ref, equation_FStar.StrongExcludedMiddle.strong_excluded_middle, lemma_AllocSTwHeaps.contains_lemma, lemma_FStar.Monotonic.Heap.lemma_unused_upd_contains, lemma_FStar.Monotonic.Heap.lemma_upd_contains, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_2c7ecebd8a41d0890aab4251b61d6458, refinement_interpretation_Tm_refine_5694aa6cb032c1a787a03895fe77cef3, refinement_interpretation_Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8, refinement_interpretation_Tm_refine_e33ef751d600ad1c7f71142479103c47, refinement_interpretation_Tm_refine_ec74995abaf3afbf48bfcaea8401c27c, token_correspondence_AllocSTwHeaps.contains, token_correspondence_AllocSTwHeaps.heap_rel, typing_AllocSTwHeaps.gen_ref, typing_AllocSTwHeaps.upd, typing_FStar.Heap.trivial_preorder, typing_FStar.Monotonic.Heap.contains, typing_FStar.StrongExcludedMiddle.strong_excluded_middle
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocSTwHeaps.alloc (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocSTwHeaps.alloc@tok () Term)

; </end encoding let alloc>


; encoding sigelt val AllocSTwHeaps.read


; <Skipped val AllocSTwHeaps.read/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AllocSTwHeaps.sel; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(22,11-22,14); use=AllocSTwHeaps.fst(22,11-22,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((AllocSTwHeaps.sel @x0
@x1
@x2))
:qid typing_AllocSTwHeaps.sel))

:named typing_AllocSTwHeaps.sel))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name AllocSTwHeaps.sel; Namespace AllocSTwHeaps
(assert (! 
;; def=AllocSTwHeaps.fst(22,53-22,84); use=AllocSTwHeaps.fst(22,53-22,84)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;; def=AllocSTwHeaps.fst(22,59-22,82); use=AllocSTwHeaps.fst(22,59-22,82)
(= @x1
(FStar.Monotonic.Heap.sel @x2
(FStar.Heap.trivial_preorder @x2)
@x3
...
; Starting query at AllocSTwHeaps.fst(165,15-167,9)
...
; Encoding query formula : forall (a: Type) (r: AllocSTwHeaps.ref a).
;   (*  - Could not prove post-condition
; *)
...
;         h == s1 /\ x == FStar.Monotonic.Heap.sel s1 r ==> p x s1) ==>
;     (forall (x: FStar.Monotonic.Heap.heap) (s1: FStar.Monotonic.Heap.heap).
;         h == x /\ x == s1 ==> p (AllocSTwHeaps.sel x r) s1)
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(165,15-167,9)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (or label_1
(HasType @x4
@x0))
...
;; def=AllocSTwHeaps.fst(163,37-163,45); use=AllocSTwHeaps.fst(165,15-167,9)
(or label_3
...
;; def=AllocSTwHeaps.fst(164,23-164,47); use=AllocSTwHeaps.fst(165,15-167,9)
(or label_4
...
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(165,15-167,9)
(Valid 
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(165,15-167,9)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(166,10-166,17)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
FStar.Monotonic.Heap.heap)
(HasType @x5
...
;; def=AllocSTwHeaps.fst(85,86-85,93); use=AllocSTwHeaps.fst(166,10-166,17)
(= @x3
@x4)


;; def=AllocSTwHeaps.fst(85,97-85,104); use=AllocSTwHeaps.fst(166,10-166,17)
(= @x4
@x5)
)

;; def=FStar.Pervasives.fsti(463,24-463,34); use=AllocSTwHeaps.fst(165,15-167,9)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=AllocSTwHeaps.fst(165,15-167,9)
(ApplyTT (ApplyTT @x2
(AllocSTwHeaps.sel @x0
@x4
@x1))
@x5)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.read, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_AllocSTwHeaps.ref, refinement_interpretation_Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8, refinement_interpretation_Tm_refine_fcc3ae3430dace306efd930c647e1fda, typing_AllocSTwHeaps.sel
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocSTwHeaps.read (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocSTwHeaps.read@tok () Term)

; </end encoding let read>


; encoding sigelt val AllocSTwHeaps.write


; <Skipped val AllocSTwHeaps.write/>

(push) ;; push{2

; Starting query at AllocSTwHeaps.fst(175,18-177,21)
...
; Encoding query formula : forall (a: Type) (r: AllocSTwHeaps.ref a) (x: a).
;   (*  - Could not prove post-condition
; *)
...
;     (forall (x: Prims.unit) (s1: FStar.Monotonic.Heap.heap).
;         FStar.Monotonic.Heap.contains h r /\ s1 == FStar.Monotonic.Heap.upd h r x ==> p x s1) ==>
;     (forall (x: FStar.Monotonic.Heap.heap) (s1: FStar.Monotonic.Heap.heap).
;         h == x /\ x == s1 ==>
;         AllocSTwHeaps.heap_rel s1 (AllocSTwHeaps.upd x r x) /\
;         (forall (x: Prims.unit) (s1: FStar.Monotonic.Heap.heap).
;             AllocSTwHeaps.heap_rel s1 (AllocSTwHeaps.upd x r x) /\ s1 == AllocSTwHeaps.upd x r x ==>
;             p x s1))
...
;; def=AllocSTwHeaps.fst(173,35-173,59); use=AllocSTwHeaps.fst(175,18-177,21)
(Valid 
;; def=AllocSTwHeaps.fst(173,35-173,59); use=AllocSTwHeaps.fst(175,18-177,21)
(FStar.Monotonic.Heap.contains @x0
(FStar.Heap.trivial_preorder @x0)
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(175,18-177,21)
...
;; def=AllocSTwHeaps.fst(174,41-174,68); use=AllocSTwHeaps.fst(175,18-177,21)
(or label_4
...
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(175,18-177,21)
(Valid 
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(175,18-177,21)
(ApplyTT (ApplyTT @x3
@x5)
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(176,10-176,17)
(forall ((@x5 Term) (@x6 Term))
...
;; def=AllocSTwHeaps.fst(85,86-85,93); use=AllocSTwHeaps.fst(176,10-176,17)
(= @x4
@x5)


;; def=AllocSTwHeaps.fst(85,97-85,104); use=AllocSTwHeaps.fst(176,10-176,17)
(= @x5
@x6)
)

;; def=AllocSTwHeaps.fst(75,29-75,88); use=AllocSTwHeaps.fst(177,2-177,9)
(and 
;; def=AllocSTwHeaps.fst(88,31-88,44); use=AllocSTwHeaps.fst(177,2-177,9)
(or label_5

;; def=AllocSTwHeaps.fst(88,31-88,44); use=AllocSTwHeaps.fst(177,2-177,9)
(Valid 
;; def=AllocSTwHeaps.fst(88,31-88,44); use=AllocSTwHeaps.fst(177,2-177,9)
(AllocSTwHeaps.heap_rel @x6
(AllocSTwHeaps.upd @x0
@x5
@x1
@x2))
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(177,2-177,9)
...
;; def=AllocSTwHeaps.fst(88,62-88,69); use=AllocSTwHeaps.fst(177,2-177,9)
(= @x8
(AllocSTwHeaps.upd @x0
@x5
@x1
...
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(177,2-177,9)
(Valid 
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(177,2-177,9)
(ApplyTT (ApplyTT @x3
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.write, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_AllocSTwHeaps.heap_rel, equation_AllocSTwHeaps.ref, equation_FStar.Heap.trivial_preorder, equation_FStar.ST.mref, equation_FStar.ST.ref, lemma_FStar.Monotonic.Heap.lemma_well_typed_upd_contains, refinement_interpretation_Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8, refinement_interpretation_Tm_refine_e33ef751d600ad1c7f71142479103c47, refinement_interpretation_Tm_refine_ec74995abaf3afbf48bfcaea8401c27c, typing_AllocSTwHeaps.upd, typing_FStar.Heap.trivial_preorder
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocSTwHeaps.write (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocSTwHeaps.write@tok () Term)

; </end encoding let write>


; encoding sigelt val AllocSTwHeaps.precise_write


; <Skipped val AllocSTwHeaps.precise_write/>

(push) ;; push{2

; Starting query at AllocSTwHeaps.fst(187,26-189,21)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let precise_write`
...
;; def=AllocSTwHeaps.fst(185,35-185,59); use=AllocSTwHeaps.fst(187,26-189,21)
(Valid 
;; def=AllocSTwHeaps.fst(185,35-185,59); use=AllocSTwHeaps.fst(187,26-189,21)
(FStar.Monotonic.Heap.contains @x0
(FStar.Heap.trivial_preorder @x0)
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(187,26-189,21)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))
...
;; def=AllocSTwHeaps.fst(186,49-186,76); use=AllocSTwHeaps.fst(187,26-189,21)
(or label_4
...
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(187,26-189,21)
(Valid 
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(187,26-189,21)
(ApplyTT (ApplyTT @x3
@x5)
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(188,10-188,17)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
FStar.Monotonic.Heap.heap)
(HasType @x6
...
;; def=AllocSTwHeaps.fst(85,86-85,93); use=AllocSTwHeaps.fst(188,10-188,17)
(= @x4
@x5)


;; def=AllocSTwHeaps.fst(85,97-85,104); use=AllocSTwHeaps.fst(188,10-188,17)
(= @x5
@x6)
)

;; def=AllocSTwHeaps.fst(75,29-75,88); use=AllocSTwHeaps.fst(189,2-189,9)
(and 
;; def=AllocSTwHeaps.fst(88,31-88,44); use=AllocSTwHeaps.fst(189,2-189,9)
(or label_5
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(189,2-189,9)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Prims.unit)
(HasType @x8
...
;; def=AllocSTwHeaps.fst(88,62-88,69); use=AllocSTwHeaps.fst(189,2-189,9)
(= @x8
(AllocSTwHeaps.upd @x0
@x5
@x1
...
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(189,2-189,9)
(Valid 
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(189,2-189,9)
(ApplyTT (ApplyTT @x3
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.precise_write, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_AllocSTwHeaps.heap_rel, equation_AllocSTwHeaps.ref, equation_FStar.Heap.trivial_preorder, equation_FStar.ST.mref, equation_FStar.ST.ref, lemma_FStar.Monotonic.Heap.lemma_well_typed_upd_contains, refinement_interpretation_Tm_refine_7d1ecf302207478c2c2b5f3c521f42f8, refinement_interpretation_Tm_refine_e33ef751d600ad1c7f71142479103c47, refinement_interpretation_Tm_refine_ec74995abaf3afbf48bfcaea8401c27c, typing_AllocSTwHeaps.upd, typing_FStar.Heap.trivial_preorder
...
; encoding sigelt let precise_write


; <Start encoding let precise_write>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AllocSTwHeaps.precise_write (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AllocSTwHeaps.precise_write@tok () Term)

; </end encoding let precise_write>


; encoding sigelt val AllocSTwHeaps.recall


; <Skipped val AllocSTwHeaps.recall/>

(push) ;; push{2

; Starting query at AllocSTwHeaps.fst(200,2-200,25)
...
;     (h: FStar.Monotonic.Heap.heap).
;     (forall (x: Prims.unit) (s1: FStar.Monotonic.Heap.heap).
;         h == s1 /\ FStar.Monotonic.Heap.contains s1 r ==> p x s1) ==>
;     Prims.auto_squash (FStar.Preorder.stable (AllocSTwHeaps.contains r) AllocSTwHeaps.heap_rel) /\
;     (forall (return_val:
;         p:
;         FStar.Preorder.predicate FStar.Monotonic.Heap.heap
;           {FStar.Preorder.stable p AllocSTwHeaps.heap_rel}).
;         return_val == AllocSTwHeaps.contains r ==>
;         AllocSTwHeaps.ist_witnessed (AllocSTwHeaps.contains r) /\
;         (forall (x: Prims.unit) (s1: FStar.Monotonic.Heap.heap).
;             AllocSTwHeaps.ist_witnessed (AllocSTwHeaps.contains r) /\
;             (h == s1) /\ AllocSTwHeaps.contains r s1 ==>
;             p x s1))
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(200,2-200,25)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))
...
;; def=AllocSTwHeaps.fst(197,21-197,29); use=AllocSTwHeaps.fst(200,2-200,25)
(or label_3
...
;; def=AllocSTwHeaps.fst(198,21-198,45); use=AllocSTwHeaps.fst(200,2-200,25)
(or label_4
...
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(200,2-200,25)
(Valid 
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(200,2-200,25)
(ApplyTT (ApplyTT @x2
@x4)
...
;; def=Prims.fst(459,77-459,89); use=AllocSTwHeaps.fst(200,2-200,25)
(and 
;; def=AllocSTwHeaps.fst(93,53-93,70); use=AllocSTwHeaps.fst(200,13-200,25)
(or label_5
...
;; def=Prims.fst(356,2-356,58); use=AllocSTwHeaps.fst(200,2-200,25)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_refine_2bada71192e8b020fbd6655cd171663b)

;; def=Prims.fst(356,26-356,41); use=AllocSTwHeaps.fst(200,2-200,25)
(= @x4
(ApplyTT (ApplyTT AllocSTwHeaps.contains@tok
@x0)
@x1))
...
;; def=AllocSTwHeaps.fst(75,29-75,88); use=AllocSTwHeaps.fst(200,2-200,12)
(and 
;; def=AllocSTwHeaps.fst(94,30-94,45); use=AllocSTwHeaps.fst(200,2-200,12)
(or label_6
...
;; def=AllocSTwHeaps.fst(75,39-75,88); use=AllocSTwHeaps.fst(200,2-200,12)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.unit)
(HasType @x6
...
;; def=AllocSTwHeaps.fst(94,63-94,71); use=AllocSTwHeaps.fst(200,2-200,12)
(= @x3
@x6)


;; def=AllocSTwHeaps.fst(94,75-94,79); use=AllocSTwHeaps.fst(200,2-200,12)
(Valid 
;; def=AllocSTwHeaps.fst(94,75-94,79); use=AllocSTwHeaps.fst(200,2-200,12)
(AllocSTwHeaps.contains @x0
@x1
...
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(200,2-200,12)
(Valid 
;; def=AllocSTwHeaps.fst(75,81-75,87); use=AllocSTwHeaps.fst(200,2-200,12)
(ApplyTT (ApplyTT @x2
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AllocSTwHeaps.recall, 1)
; STATUS: unsat
