...
; Internals for FullReductionInterpreter
...
(declare-fun FullReductionInterpreter.index () Term)

; </end encoding let index>


; encoding sigelt let atom


; <Start encoding let atom>

(declare-fun FullReductionInterpreter.atom () Term)

; </end encoding let atom>
...
; encoding sigelt type FullReductionInterpreter.term


; <Start encoding type FullReductionInterpreter.term>

;;;;;;;;;;;;;;;;Constructor
(declare-fun FullReductionInterpreter.term () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FullReductionInterpreter.BV (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FullReductionInterpreter.BV__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: FullReductionInterpreter.BV
(declare-fun FullReductionInterpreter.BV@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FullReductionInterpreter.FV (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FullReductionInterpreter.FV__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: FullReductionInterpreter.FV
(declare-fun FullReductionInterpreter.FV@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FullReductionInterpreter.App (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FullReductionInterpreter.App__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FullReductionInterpreter.App__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: FullReductionInterpreter.App
(declare-fun FullReductionInterpreter.App@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FullReductionInterpreter.Lam (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FullReductionInterpreter.Lam__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: FullReductionInterpreter.Lam
(declare-fun FullReductionInterpreter.Lam@tok () Term)
;;;;;;;;;;;;;;;;_0: index -> term
(declare-fun Tm_arrow_37d0132e4dea55c46c894fcc5f7c1711 () Term)
;;;;;;;;;;;;;;;;_0: atom -> term
(declare-fun Tm_arrow_0af315e09f37eb3d4654314950b97f3c () Term)
;;;;;;;;;;;;;;;;_0: term -> _1: term -> term
(declare-fun Tm_arrow_891f8e374142f4178d953b76978c0825 () Term)
;;;;;;;;;;;;;;;;_0: term -> term
(declare-fun Tm_arrow_0824a3849ecea05a93dccaa6bf7af0e9 () Term)

; <start constructor FullReductionInterpreter.term>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FullReductionInterpreter.term ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
129)
(= __@x0
FullReductionInterpreter.term)))

; </end constructor FullReductionInterpreter.term>


; <start constructor FullReductionInterpreter.BV>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FullReductionInterpreter.BV ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
135)
(= __@x0
(FullReductionInterpreter.BV (FullReductionInterpreter.BV__0 __@x0)))))

; </end constructor FullReductionInterpreter.BV>


; <start constructor FullReductionInterpreter.FV>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FullReductionInterpreter.FV ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
140)
(= __@x0
(FullReductionInterpreter.FV (FullReductionInterpreter.FV__0 __@x0)))))

; </end constructor FullReductionInterpreter.FV>


; <start constructor FullReductionInterpreter.App>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FullReductionInterpreter.App ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
145)
(= __@x0
(FullReductionInterpreter.App (FullReductionInterpreter.App__0 __@x0)
(FullReductionInterpreter.App__1 __@x0)))))

; </end constructor FullReductionInterpreter.App>


; <start constructor FullReductionInterpreter.Lam>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FullReductionInterpreter.Lam ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
150)
(= __@x0
(FullReductionInterpreter.Lam (FullReductionInterpreter.Lam__0 __@x0)))))

; </end constructor FullReductionInterpreter.Lam>


; </end encoding type FullReductionInterpreter.term>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FullReductionInterpreter.index; Namespace FullReductionInterpreter
(assert (! (HasType FullReductionInterpreter.index
Tm_type)
:named typing_FullReductionInterpreter.index))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FullReductionInterpreter.atom; Namespace FullReductionInterpreter
(assert (! (HasType FullReductionInterpreter.atom
Tm_type)
:named typing_FullReductionInterpreter.atom))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(37,4-37,7); use=FullReductionInterpreter.fst(37,4-37,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(FullReductionInterpreter.Lam @x1)
FullReductionInterpreter.term)
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x1
...
(FullReductionInterpreter.Lam @x1)
FullReductionInterpreter.term))
:qid subterm_ordering_FullReductionInterpreter.Lam))

:named subterm_ordering_FullReductionInterpreter.Lam))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(35,4-35,6); use=FullReductionInterpreter.fst(35,4-35,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(FullReductionInterpreter.FV @x1)
FullReductionInterpreter.term)
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x1
...
(FullReductionInterpreter.FV @x1)
FullReductionInterpreter.term))
:qid subterm_ordering_FullReductionInterpreter.FV))

:named subterm_ordering_FullReductionInterpreter.FV))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(34,4-34,6); use=FullReductionInterpreter.fst(34,4-34,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(FullReductionInterpreter.BV @x1)
FullReductionInterpreter.term)
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x1
...
(FullReductionInterpreter.BV @x1)
FullReductionInterpreter.term))
:qid subterm_ordering_FullReductionInterpreter.BV))

:named subterm_ordering_FullReductionInterpreter.BV))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(FullReductionInterpreter.App @x1
@x2)
FullReductionInterpreter.term)
...
@x2)
FullReductionInterpreter.term))
:qid subterm_ordering_FullReductionInterpreter.App))

:named subterm_ordering_FullReductionInterpreter.App))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=FullReductionInterpreter.fst(37,4-37,7); use=FullReductionInterpreter.fst(37,4-37,7)
(forall ((@x0 Term))
 (! (= (FullReductionInterpreter.Lam__0 (FullReductionInterpreter.Lam @x0))
@x0)
 

:pattern ((FullReductionInterpreter.Lam @x0))
:qid projection_inverse_FullReductionInterpreter.Lam__0))

:named projection_inverse_FullReductionInterpreter.Lam__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(35,4-35,6); use=FullReductionInterpreter.fst(35,4-35,6)
(forall ((@x0 Term))
 (! (= (FullReductionInterpreter.FV__0 (FullReductionInterpreter.FV @x0))
@x0)
 

:pattern ((FullReductionInterpreter.FV @x0))
:qid projection_inverse_FullReductionInterpreter.FV__0))

:named projection_inverse_FullReductionInterpreter.FV__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(34,4-34,6); use=FullReductionInterpreter.fst(34,4-34,6)
(forall ((@x0 Term))
 (! (= (FullReductionInterpreter.BV__0 (FullReductionInterpreter.BV @x0))
@x0)
 

:pattern ((FullReductionInterpreter.BV @x0))
:qid projection_inverse_FullReductionInterpreter.BV__0))

:named projection_inverse_FullReductionInterpreter.BV__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FullReductionInterpreter.App__1 (FullReductionInterpreter.App @x0
@x1))
@x1)
 

:pattern ((FullReductionInterpreter.App @x0
@x1))
:qid projection_inverse_FullReductionInterpreter.App__1))

:named projection_inverse_FullReductionInterpreter.App__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FullReductionInterpreter.App__0 (FullReductionInterpreter.App @x0
@x1))
@x0)
...
:pattern ((FullReductionInterpreter.App @x0
@x1))
:qid projection_inverse_FullReductionInterpreter.App__0))

:named projection_inverse_FullReductionInterpreter.App__0))
...
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! (HasType FullReductionInterpreter.term
Tm_type)
:named kinding_FullReductionInterpreter.term@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
(assert (! (HasType FullReductionInterpreter.index
Tm_type)
:named function_token_typing_FullReductionInterpreter.index))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name FullReductionInterpreter.atom; Namespace FullReductionInterpreter
(assert (! (HasType FullReductionInterpreter.atom
Tm_type)
:named function_token_typing_FullReductionInterpreter.atom))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(33,5-33,9); use=FullReductionInterpreter.fst(33,5-33,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
FullReductionInterpreter.term)
(or (is-FullReductionInterpreter.BV @x1)
(is-FullReductionInterpreter.FV @x1)
(is-FullReductionInterpreter.App @x1)
(is-FullReductionInterpreter.Lam @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
FullReductionInterpreter.term))
:qid fuel_guarded_inversion_FullReductionInterpreter.term))

:named fuel_guarded_inversion_FullReductionInterpreter.term))
...
;;;;;;;;;;;;;;;;Equation for FullReductionInterpreter.index
;;; Fact-ids: Name FullReductionInterpreter.index; Namespace FullReductionInterpreter
(assert (! (= FullReductionInterpreter.index
Prims.nat)
:named equation_FullReductionInterpreter.index))
;;;;;;;;;;;;;;;;Equation for FullReductionInterpreter.atom
;;; Fact-ids: Name FullReductionInterpreter.atom; Namespace FullReductionInterpreter
(assert (! (= FullReductionInterpreter.atom
Prims.nat)
:named equation_FullReductionInterpreter.atom))
...
(FullReductionInterpreter.Lam @x1)
FullReductionInterpreter.term))
:qid data_typing_intro_FullReductionInterpreter.Lam@tok))

:named data_typing_intro_FullReductionInterpreter.Lam@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(35,4-35,6); use=FullReductionInterpreter.fst(35,4-35,6)
...
(FullReductionInterpreter.FV @x1)
FullReductionInterpreter.term))
:qid data_typing_intro_FullReductionInterpreter.FV@tok))

:named data_typing_intro_FullReductionInterpreter.FV@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(34,4-34,6); use=FullReductionInterpreter.fst(34,4-34,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
FullReductionInterpreter.index)
(HasTypeFuel @u0
(FullReductionInterpreter.BV @x1)
FullReductionInterpreter.term))
...
(FullReductionInterpreter.BV @x1)
FullReductionInterpreter.term))
:qid data_typing_intro_FullReductionInterpreter.BV@tok))

:named data_typing_intro_FullReductionInterpreter.BV@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
...
@x2)
FullReductionInterpreter.term))
:qid data_typing_intro_FullReductionInterpreter.App@tok))

:named data_typing_intro_FullReductionInterpreter.App@tok))
...
(FullReductionInterpreter.Lam @x1)
FullReductionInterpreter.term))
:qid data_elim_FullReductionInterpreter.Lam))

:named data_elim_FullReductionInterpreter.Lam))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(35,4-35,6); use=FullReductionInterpreter.fst(35,4-35,6)
...
(FullReductionInterpreter.FV @x1)
FullReductionInterpreter.term))
:qid data_elim_FullReductionInterpreter.FV))

:named data_elim_FullReductionInterpreter.FV))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(34,4-34,6); use=FullReductionInterpreter.fst(34,4-34,6)
...
(FullReductionInterpreter.BV @x1)
FullReductionInterpreter.term))
:qid data_elim_FullReductionInterpreter.BV))

:named data_elim_FullReductionInterpreter.BV))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
...
@x2)
FullReductionInterpreter.term))
:qid data_elim_FullReductionInterpreter.App))

:named data_elim_FullReductionInterpreter.App))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! (= 129
(Term_constr_id FullReductionInterpreter.term))
:named constructor_distinct_FullReductionInterpreter.term))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(37,4-37,7); use=FullReductionInterpreter.fst(37,4-37,7)
(forall ((@x0 Term))
 (! (= 150
(Term_constr_id (FullReductionInterpreter.Lam @x0)))
 

:pattern ((FullReductionInterpreter.Lam @x0))
:qid constructor_distinct_FullReductionInterpreter.Lam))

:named constructor_distinct_FullReductionInterpreter.Lam))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(35,4-35,6); use=FullReductionInterpreter.fst(35,4-35,6)
(forall ((@x0 Term))
 (! (= 140
(Term_constr_id (FullReductionInterpreter.FV @x0)))
 

:pattern ((FullReductionInterpreter.FV @x0))
:qid constructor_distinct_FullReductionInterpreter.FV))

:named constructor_distinct_FullReductionInterpreter.FV))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(34,4-34,6); use=FullReductionInterpreter.fst(34,4-34,6)
(forall ((@x0 Term))
 (! (= 135
(Term_constr_id (FullReductionInterpreter.BV @x0)))
 

:pattern ((FullReductionInterpreter.BV @x0))
:qid constructor_distinct_FullReductionInterpreter.BV))

:named constructor_distinct_FullReductionInterpreter.BV))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FullReductionInterpreter.term; Namespace FullReductionInterpreter; Name FullReductionInterpreter.BV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.FV; Namespace FullReductionInterpreter; Name FullReductionInterpreter.App; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= 145
(Term_constr_id (FullReductionInterpreter.App @x0
@x1)))
 

:pattern ((FullReductionInterpreter.App @x0
@x1))
:qid constructor_distinct_FullReductionInterpreter.App))

:named constructor_distinct_FullReductionInterpreter.App))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Monotonic.Heap.core_mref; Namespace FStar.Monotonic.Heap
(assert (! 
;; def=FStar.Monotonic.Heap.fsti(39,4-39,13); use=FStar.Monotonic.Heap.fsti(39,4-39,13)
...
@x0
FullReductionInterpreter.term))
:qid FullReductionInterpreter_pretyping_492c9857f193c5cd2315fa92f4dee678))

:named FullReductionInterpreter_pretyping_492c9857f193c5cd2315fa92f4dee678))
...
; Starting query at FullReductionInterpreter.fst(33,0-37,22)
...
; Encoding query formula : Prims.hasEq FullReductionInterpreter.term ==>
; (forall (_0: FullReductionInterpreter.index).
...
; *)
;     Prims.hasEq FullReductionInterpreter.index) /\
; (forall (_0: FullReductionInterpreter.atom).
;     (*  - Failed to prove that the type
;     'FullReductionInterpreter.term'
;     supports decidable equality because of this argument.
;   - Add either the 'noeq' or 'unopteq' qualifier
; *)
;     Prims.hasEq FullReductionInterpreter.atom) /\
; (forall (_0: FullReductionInterpreter.term) (_1: FullReductionInterpreter.term).
;     Prims.hasEq FullReductionInterpreter.term /\ Prims.hasEq FullReductionInterpreter.term) /\
; (forall (_0: FullReductionInterpreter.term).
;     (*  - Failed to prove that the type
;     'FullReductionInterpreter.term'
;     supports decidable equality because of this argument.
;   - Add either the 'noeq' or 'unopteq' qualifier
; *)
;     Prims.hasEq FullReductionInterpreter.term)


; Context: While encoding a query
; While typechecking the top-level declaration `type FullReductionInterpreter.term`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=FullReductionInterpreter.fst(33,0-37,22); use=FullReductionInterpreter.fst(33,0-37,22)
(Valid 
;; def=FullReductionInterpreter.fst(33,0-37,22); use=FullReductionInterpreter.fst(33,0-37,22)
(Prims.hasEq FullReductionInterpreter.term)
)
...
;; def=FullReductionInterpreter.fst(33,0-37,22); use=FullReductionInterpreter.fst(34,10-34,15)
(or label_1
...
;; def=FullReductionInterpreter.fst(33,0-37,22); use=FullReductionInterpreter.fst(35,10-35,14)
(or label_2
...
;; def=FullReductionInterpreter.fst(33,0-37,22); use=FullReductionInterpreter.fst(33,0-37,22)
(and 
;; def=FullReductionInterpreter.fst(33,0-37,22); use=FullReductionInterpreter.fst(36,10-36,14)
(or label_3
...
;; def=FullReductionInterpreter.fst(33,0-37,22); use=FullReductionInterpreter.fst(36,19-36,23)
(or label_4
...
;; def=FullReductionInterpreter.fst(33,0-37,22); use=FullReductionInterpreter.fst(37,10-37,14)
(or label_5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.term, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FullReductionInterpreter.atom, equation_FullReductionInterpreter.index, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
; encoding sigelt assume FullReductionInterpreter.term__uu___haseq


; <Start encoding assume FullReductionInterpreter.term__uu___haseq>


; </end encoding assume FullReductionInterpreter.term__uu___haseq>


; encoding sigelt val FullReductionInterpreter.uu___is_BV


; <Start encoding val FullReductionInterpreter.uu___is_BV>

(declare-fun FullReductionInterpreter.uu___is_BV (Term) Term)
;;;;;;;;;;;;;;;;projectee: term -> Prims.bool
(declare-fun Tm_arrow_2a8a419aa0b4d99f5a29234d56e3797f () Term)
(declare-fun FullReductionInterpreter.uu___is_BV@tok () Term)

; </end encoding val FullReductionInterpreter.uu___is_BV>


; encoding sigelt let uu___is_BV


; <Skipped let uu___is_BV/>


; encoding sigelt val FullReductionInterpreter.__proj__BV__item___0


; <Start encoding val FullReductionInterpreter.__proj__BV__item___0>

(declare-fun Tm_refine_91ab4e301fa8f3e1b96495d7ec898c9e () Term)
(declare-fun FullReductionInterpreter.__proj__BV__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: term{BV? _} -> index
(declare-fun Tm_arrow_b166503a1c2d2b2220a793acc2fecd21 () Term)
(declare-fun FullReductionInterpreter.__proj__BV__item___0@tok () Term)

; </end encoding val FullReductionInterpreter.__proj__BV__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FullReductionInterpreter.uu___is_BV; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(34,4-34,6); use=FullReductionInterpreter.fst(34,4-34,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FullReductionInterpreter.term)
(HasType (FullReductionInterpreter.uu___is_BV @x0)
Prims.bool))
 

:pattern ((FullReductionInterpreter.uu___is_BV @x0))
:qid typing_FullReductionInterpreter.uu___is_BV))

:named typing_FullReductionInterpreter.uu___is_BV))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FullReductionInterpreter.index; Namespace FullReductionInterpreter
(assert (! (HasType FullReductionInterpreter.index
Tm_type)
...
:named refinement_kinding_Tm_refine_afd51579b90d50ea23e03b743a1fa001))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FullReductionInterpreter.__proj__BV__item___0; Namespace FullReductionInterpreter
(assert (! (HasType Tm_refine_91ab4e301fa8f3e1b96495d7ec898c9e
Tm_type)
:named refinement_kinding_Tm_refine_91ab4e301fa8f3e1b96495d7ec898c9e))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! (HasType Tm_refine_774ba3f728d91ead8ef40be66c9802e5
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_91ab4e301fa8f3e1b96495d7ec898c9e)
(and (HasTypeFuel @u0
@x1
FullReductionInterpreter.term)

;; def=FullReductionInterpreter.fst(34,4-34,6); use=FullReductionInterpreter.fst(34,4-34,6)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_BV @x1))
))
...
@x1
Tm_refine_91ab4e301fa8f3e1b96495d7ec898c9e))
:qid refinement_interpretation_Tm_refine_91ab4e301fa8f3e1b96495d7ec898c9e))

:named refinement_interpretation_Tm_refine_91ab4e301fa8f3e1b96495d7ec898c9e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
;; def=Prims.fst(683,11-683,24); use=Prims.fst(683,11-683,24)
...
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_afd51579b90d50ea23e03b743a1fa001))
;;;;;;;;;;;;;;;;haseq for Tm_refine_91ab4e301fa8f3e1b96495d7ec898c9e
;;; Fact-ids: Name FullReductionInterpreter.__proj__BV__item___0; Namespace FullReductionInterpreter
(assert (! (iff (Valid (Prims.hasEq Tm_refine_91ab4e301fa8f3e1b96495d7ec898c9e))
(Valid (Prims.hasEq FullReductionInterpreter.term)))
:named haseqTm_refine_91ab4e301fa8f3e1b96495d7ec898c9e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_774ba3f728d91ead8ef40be66c9802e5
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_774ba3f728d91ead8ef40be66c9802e5))
(Valid (Prims.hasEq Prims.int)))
...
;; def=FullReductionInterpreter.fst(34,4-34,6); use=FullReductionInterpreter.fst(34,4-34,6)
(forall ((@x0 Term))
 (! (= (FullReductionInterpreter.uu___is_BV @x0)
(BoxBool (is-FullReductionInterpreter.BV @x0)))
 

:pattern ((FullReductionInterpreter.uu___is_BV @x0))
:qid disc_equation_FullReductionInterpreter.BV))

:named disc_equation_FullReductionInterpreter.BV))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: FullReductionInterpreter.term__uu___haseq
;;; Fact-ids: Name FullReductionInterpreter.term__uu___haseq; Namespace FullReductionInterpreter
(assert (! (Valid (Prims.hasEq FullReductionInterpreter.term))
:named assumption_FullReductionInterpreter.term__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Encoding query formula : forall (projectee: _: FullReductionInterpreter.term{BV? _}).
;   (*  - Could not prove post-condition
; *) ~(BV? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__BV__item___0`
...
(not 
;; def=FullReductionInterpreter.fst(34,4-34,6); use=FullReductionInterpreter.fst(34,4-34,6)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_BV @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.__proj__BV__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_91ab4e301fa8f3e1b96495d7ec898c9e
...
; encoding sigelt let __proj__BV__item___0


; <Skipped let __proj__BV__item___0/>


; encoding sigelt val FullReductionInterpreter.uu___is_FV


; <Start encoding val FullReductionInterpreter.uu___is_FV>

(declare-fun FullReductionInterpreter.uu___is_FV (Term) Term)

(declare-fun FullReductionInterpreter.uu___is_FV@tok () Term)

; </end encoding val FullReductionInterpreter.uu___is_FV>


; encoding sigelt let uu___is_FV


; <Skipped let uu___is_FV/>


; encoding sigelt val FullReductionInterpreter.__proj__FV__item___0


; <Start encoding val FullReductionInterpreter.__proj__FV__item___0>

(declare-fun Tm_refine_094461b4c2bb56eb4c22e68e681b710b () Term)
(declare-fun FullReductionInterpreter.__proj__FV__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: term{FV? _} -> atom
(declare-fun Tm_arrow_fcf3ddcbeeeda0b3a4378efecc243088 () Term)
(declare-fun FullReductionInterpreter.__proj__FV__item___0@tok () Term)

; </end encoding val FullReductionInterpreter.__proj__FV__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FullReductionInterpreter.uu___is_FV; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(35,4-35,6); use=FullReductionInterpreter.fst(35,4-35,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FullReductionInterpreter.term)
(HasType (FullReductionInterpreter.uu___is_FV @x0)
Prims.bool))
 

:pattern ((FullReductionInterpreter.uu___is_FV @x0))
:qid typing_FullReductionInterpreter.uu___is_FV))

:named typing_FullReductionInterpreter.uu___is_FV))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FullReductionInterpreter.__proj__FV__item___0; Namespace FullReductionInterpreter
(assert (! (HasType Tm_refine_094461b4c2bb56eb4c22e68e681b710b
Tm_type)
:named refinement_kinding_Tm_refine_094461b4c2bb56eb4c22e68e681b710b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FullReductionInterpreter.__proj__FV__item___0; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(35,4-35,6); use=FullReductionInterpreter.fst(35,4-35,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_094461b4c2bb56eb4c22e68e681b710b)
(and (HasTypeFuel @u0
@x1
FullReductionInterpreter.term)

;; def=FullReductionInterpreter.fst(35,4-35,6); use=FullReductionInterpreter.fst(35,4-35,6)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_FV @x1))
))
...
@x1
Tm_refine_094461b4c2bb56eb4c22e68e681b710b))
:qid refinement_interpretation_Tm_refine_094461b4c2bb56eb4c22e68e681b710b))

:named refinement_interpretation_Tm_refine_094461b4c2bb56eb4c22e68e681b710b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_094461b4c2bb56eb4c22e68e681b710b
;;; Fact-ids: Name FullReductionInterpreter.__proj__FV__item___0; Namespace FullReductionInterpreter
(assert (! (iff (Valid (Prims.hasEq Tm_refine_094461b4c2bb56eb4c22e68e681b710b))
(Valid (Prims.hasEq FullReductionInterpreter.term)))
:named haseqTm_refine_094461b4c2bb56eb4c22e68e681b710b))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name FullReductionInterpreter.uu___is_FV; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(35,4-35,6); use=FullReductionInterpreter.fst(35,4-35,6)
(forall ((@x0 Term))
 (! (= (FullReductionInterpreter.uu___is_FV @x0)
(BoxBool (is-FullReductionInterpreter.FV @x0)))
 

:pattern ((FullReductionInterpreter.uu___is_FV @x0))
:qid disc_equation_FullReductionInterpreter.FV))

:named disc_equation_FullReductionInterpreter.FV))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: FullReductionInterpreter.term{FV? _}).
;   (*  - Could not prove post-condition
; *) ~(FV? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__FV__item___0`
...
(not 
;; def=FullReductionInterpreter.fst(35,4-35,6); use=FullReductionInterpreter.fst(35,4-35,6)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_FV @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.__proj__FV__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_094461b4c2bb56eb4c22e68e681b710b
...
; encoding sigelt let __proj__FV__item___0


; <Skipped let __proj__FV__item___0/>


; encoding sigelt val FullReductionInterpreter.uu___is_App


; <Start encoding val FullReductionInterpreter.uu___is_App>

(declare-fun FullReductionInterpreter.uu___is_App (Term) Term)

(declare-fun FullReductionInterpreter.uu___is_App@tok () Term)

; </end encoding val FullReductionInterpreter.uu___is_App>


; encoding sigelt let uu___is_App


; <Skipped let uu___is_App/>


; encoding sigelt val FullReductionInterpreter.__proj__App__item___0


; <Start encoding val FullReductionInterpreter.__proj__App__item___0>

(declare-fun Tm_refine_345f58576b733730f2fa0aaeeff79575 () Term)
(declare-fun FullReductionInterpreter.__proj__App__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: term{App? _} -> term
(declare-fun Tm_arrow_876ffe105505771bbbe350f9bfeb8871 () Term)
(declare-fun FullReductionInterpreter.__proj__App__item___0@tok () Term)

; </end encoding val FullReductionInterpreter.__proj__App__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FullReductionInterpreter.uu___is_App; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FullReductionInterpreter.term)
(HasType (FullReductionInterpreter.uu___is_App @x0)
Prims.bool))
 

:pattern ((FullReductionInterpreter.uu___is_App @x0))
:qid typing_FullReductionInterpreter.uu___is_App))

:named typing_FullReductionInterpreter.uu___is_App))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FullReductionInterpreter.__proj__App__item___0; Namespace FullReductionInterpreter
(assert (! (HasType Tm_refine_345f58576b733730f2fa0aaeeff79575
Tm_type)
:named refinement_kinding_Tm_refine_345f58576b733730f2fa0aaeeff79575))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FullReductionInterpreter.__proj__App__item___0; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_345f58576b733730f2fa0aaeeff79575)
(and (HasTypeFuel @u0
@x1
FullReductionInterpreter.term)

;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_App @x1))
))
...
@x1
Tm_refine_345f58576b733730f2fa0aaeeff79575))
:qid refinement_interpretation_Tm_refine_345f58576b733730f2fa0aaeeff79575))

:named refinement_interpretation_Tm_refine_345f58576b733730f2fa0aaeeff79575))
;;;;;;;;;;;;;;;;haseq for Tm_refine_345f58576b733730f2fa0aaeeff79575
;;; Fact-ids: Name FullReductionInterpreter.__proj__App__item___0; Namespace FullReductionInterpreter
(assert (! (iff (Valid (Prims.hasEq Tm_refine_345f58576b733730f2fa0aaeeff79575))
(Valid (Prims.hasEq FullReductionInterpreter.term)))
:named haseqTm_refine_345f58576b733730f2fa0aaeeff79575))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name FullReductionInterpreter.uu___is_App; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
(forall ((@x0 Term))
 (! (= (FullReductionInterpreter.uu___is_App @x0)
(BoxBool (is-FullReductionInterpreter.App @x0)))
 

:pattern ((FullReductionInterpreter.uu___is_App @x0))
:qid disc_equation_FullReductionInterpreter.App))

:named disc_equation_FullReductionInterpreter.App))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: FullReductionInterpreter.term{App? _}).
;   (*  - Could not prove post-condition
; *) ~(App? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__App__item___0`
...
(not 
;; def=FullReductionInterpreter.fst(36,4-36,7); use=FullReductionInterpreter.fst(36,4-36,7)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_App @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.__proj__App__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_345f58576b733730f2fa0aaeeff79575
...
; encoding sigelt let __proj__App__item___0


; <Skipped let __proj__App__item___0/>


; encoding sigelt val FullReductionInterpreter.__proj__App__item___1


; <Start encoding val FullReductionInterpreter.__proj__App__item___1>


(declare-fun FullReductionInterpreter.__proj__App__item___1 (Term) Term)


(declare-fun FullReductionInterpreter.__proj__App__item___1@tok () Term)

; </end encoding val FullReductionInterpreter.__proj__App__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__App__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.__proj__App__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_345f58576b733730f2fa0aaeeff79575
...
; encoding sigelt let __proj__App__item___1


; <Skipped let __proj__App__item___1/>


; encoding sigelt val FullReductionInterpreter.uu___is_Lam


; <Start encoding val FullReductionInterpreter.uu___is_Lam>

(declare-fun FullReductionInterpreter.uu___is_Lam (Term) Term)

(declare-fun FullReductionInterpreter.uu___is_Lam@tok () Term)

; </end encoding val FullReductionInterpreter.uu___is_Lam>


; encoding sigelt let uu___is_Lam


; <Skipped let uu___is_Lam/>


; encoding sigelt val FullReductionInterpreter.__proj__Lam__item___0


; <Start encoding val FullReductionInterpreter.__proj__Lam__item___0>

(declare-fun Tm_refine_e026cbffab79c42fcebe3dd2c4498d1e () Term)
(declare-fun FullReductionInterpreter.__proj__Lam__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: term{Lam? _} -> term
(declare-fun Tm_arrow_8bc9f8187f329648078fe8ad8c7b950b () Term)
(declare-fun FullReductionInterpreter.__proj__Lam__item___0@tok () Term)

; </end encoding val FullReductionInterpreter.__proj__Lam__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FullReductionInterpreter.uu___is_Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(37,4-37,7); use=FullReductionInterpreter.fst(37,4-37,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FullReductionInterpreter.term)
(HasType (FullReductionInterpreter.uu___is_Lam @x0)
Prims.bool))
 

:pattern ((FullReductionInterpreter.uu___is_Lam @x0))
:qid typing_FullReductionInterpreter.uu___is_Lam))

:named typing_FullReductionInterpreter.uu___is_Lam))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FullReductionInterpreter.__proj__Lam__item___0; Namespace FullReductionInterpreter
(assert (! (HasType Tm_refine_e026cbffab79c42fcebe3dd2c4498d1e
Tm_type)
:named refinement_kinding_Tm_refine_e026cbffab79c42fcebe3dd2c4498d1e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FullReductionInterpreter.__proj__Lam__item___0; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(37,4-37,7); use=FullReductionInterpreter.fst(37,4-37,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_e026cbffab79c42fcebe3dd2c4498d1e)
(and (HasTypeFuel @u0
@x1
FullReductionInterpreter.term)

;; def=FullReductionInterpreter.fst(37,4-37,7); use=FullReductionInterpreter.fst(37,4-37,7)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Lam @x1))
))
...
@x1
Tm_refine_e026cbffab79c42fcebe3dd2c4498d1e))
:qid refinement_interpretation_Tm_refine_e026cbffab79c42fcebe3dd2c4498d1e))

:named refinement_interpretation_Tm_refine_e026cbffab79c42fcebe3dd2c4498d1e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e026cbffab79c42fcebe3dd2c4498d1e
;;; Fact-ids: Name FullReductionInterpreter.__proj__Lam__item___0; Namespace FullReductionInterpreter
(assert (! (iff (Valid (Prims.hasEq Tm_refine_e026cbffab79c42fcebe3dd2c4498d1e))
(Valid (Prims.hasEq FullReductionInterpreter.term)))
:named haseqTm_refine_e026cbffab79c42fcebe3dd2c4498d1e))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name FullReductionInterpreter.uu___is_Lam; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(37,4-37,7); use=FullReductionInterpreter.fst(37,4-37,7)
(forall ((@x0 Term))
 (! (= (FullReductionInterpreter.uu___is_Lam @x0)
(BoxBool (is-FullReductionInterpreter.Lam @x0)))
 

:pattern ((FullReductionInterpreter.uu___is_Lam @x0))
:qid disc_equation_FullReductionInterpreter.Lam))

:named disc_equation_FullReductionInterpreter.Lam))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: FullReductionInterpreter.term{Lam? _}).
;   (*  - Could not prove post-condition
; *) ~(Lam? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Lam__item___0`
...
(not 
;; def=FullReductionInterpreter.fst(37,4-37,7); use=FullReductionInterpreter.fst(37,4-37,7)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Lam @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.__proj__Lam__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_e026cbffab79c42fcebe3dd2c4498d1e
...
; encoding sigelt let __proj__Lam__item___0


; <Skipped let __proj__Lam__item___0/>
...
; Starting query at FullReductionInterpreter.fst(40,4-48,33)

;;;;;;;;;;;;;;;;t : FullReductionInterpreter.term (FullReductionInterpreter.term)
(declare-fun x_492c9857f193c5cd2315fa92f4dee678_0 () Term)
;;;;;;;;;;;;;;;;binder_x_492c9857f193c5cd2315fa92f4dee678_0
;;; Fact-ids: 
(assert (! (HasType x_492c9857f193c5cd2315fa92f4dee678_0
FullReductionInterpreter.term)
:named binder_x_492c9857f193c5cd2315fa92f4dee678_0))
;;;;;;;;;;;;;;;;i : FullReductionInterpreter.index (FullReductionInterpreter.index)
(declare-fun x_d73bdab5bc0a2d78768de5ed9a64d135_1 () Term)
;;;;;;;;;;;;;;;;binder_x_d73bdab5bc0a2d78768de5ed9a64d135_1
;;; Fact-ids: 
(assert (! (HasType x_d73bdab5bc0a2d78768de5ed9a64d135_1
FullReductionInterpreter.index)
:named binder_x_d73bdab5bc0a2d78768de5ed9a64d135_1))
;;;;;;;;;;;;;;;;a : FullReductionInterpreter.atom (FullReductionInterpreter.atom)
(declare-fun x_00bdacec2575c08fd0637f9bd68e2708_2 () Term)
;;;;;;;;;;;;;;;;binder_x_00bdacec2575c08fd0637f9bd68e2708_2
;;; Fact-ids: 
(assert (! (HasType x_00bdacec2575c08fd0637f9bd68e2708_2
FullReductionInterpreter.atom)
:named binder_x_00bdacec2575c08fd0637f9bd68e2708_2))
(declare-fun Tm_refine_11c1314df3507688fa440e71e3b01524 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(39,19-48,33)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_11c1314df3507688fa440e71e3b01524 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_11c1314df3507688fa440e71e3b01524 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_11c1314df3507688fa440e71e3b01524))

:named refinement_kinding_Tm_refine_11c1314df3507688fa440e71e3b01524))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(39,19-48,33)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_11c1314df3507688fa440e71e3b01524 @x2
@x3))
(and (HasTypeFuel @u0
@x1
FullReductionInterpreter.atom)
...
;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(39,19-48,33)
(or 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(40,4-48,33)
(Valid 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(40,4-48,33)
(Prims.precedes FullReductionInterpreter.term
FullReductionInterpreter.term
@x2
x_492c9857f193c5cd2315fa92f4dee678_0)
)


;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(39,19-48,33)
(and 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(39,19-39,20)
(Valid 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(39,19-39,20)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.term
FullReductionInterpreter.term
@x2
x_492c9857f193c5cd2315fa92f4dee678_0)
)
...
;; def=FullReductionInterpreter.fst(39,28-48,33); use=FullReductionInterpreter.fst(39,28-48,33)
(or 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(40,4-48,33)
(Valid 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(40,4-48,33)
(Prims.precedes FullReductionInterpreter.index
FullReductionInterpreter.index
@x3
x_d73bdab5bc0a2d78768de5ed9a64d135_1)
)


;; def=FullReductionInterpreter.fst(39,28-48,33); use=FullReductionInterpreter.fst(39,28-48,33)
(and 
;; def=FullReductionInterpreter.fst(39,28-39,29); use=FullReductionInterpreter.fst(39,28-39,29)
(Valid 
;; def=FullReductionInterpreter.fst(39,28-39,29); use=FullReductionInterpreter.fst(39,28-39,29)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.index
FullReductionInterpreter.index
@x3
x_d73bdab5bc0a2d78768de5ed9a64d135_1)
)
...
(Valid 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(40,4-48,33)
(Prims.precedes FullReductionInterpreter.atom
FullReductionInterpreter.atom
@x1
x_00bdacec2575c08fd0637f9bd68e2708_2)
)
)
)
)
...
(Tm_refine_11c1314df3507688fa440e71e3b01524 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_11c1314df3507688fa440e71e3b01524))

:named refinement_interpretation_Tm_refine_11c1314df3507688fa440e71e3b01524))
;;;;;;;;;;;;;;;;haseq for Tm_refine_11c1314df3507688fa440e71e3b01524
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(39,19-48,33)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_11c1314df3507688fa440e71e3b01524 @x0
@x1)))
(Valid (Prims.hasEq FullReductionInterpreter.atom)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_11c1314df3507688fa440e71e3b01524 @x0
@x1))))
:qid haseqTm_refine_11c1314df3507688fa440e71e3b01524))

:named haseqTm_refine_11c1314df3507688fa440e71e3b01524))
(declare-fun FullReductionInterpreter.open_term (Term Term Term) Term)

;;;;;;;;;;;;;;;;t: term -> i: index -> a: atom{t << t \/ t === t /\ (i << i \/ i === i /\ a << a)} -> term
(declare-fun Tm_arrow_f735c27b94516aab2c82902bc5bd578f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f735c27b94516aab2c82902bc5bd578f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_f735c27b94516aab2c82902bc5bd578f
Tm_type)
:named kinding_Tm_arrow_f735c27b94516aab2c82902bc5bd578f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(36,10-48,33); use=FullReductionInterpreter.fst(39,19-48,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f735c27b94516aab2c82902bc5bd578f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_f735c27b94516aab2c82902bc5bd578f))
:qid FullReductionInterpreter_pre_typing_Tm_arrow_f735c27b94516aab2c82902bc5bd578f))

:named FullReductionInterpreter_pre_typing_Tm_arrow_f735c27b94516aab2c82902bc5bd578f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f735c27b94516aab2c82902bc5bd578f
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(36,10-48,33); use=FullReductionInterpreter.fst(39,19-48,33)
(forall ((@x0 Term))
...
FullReductionInterpreter.index)
(HasType @x3
(Tm_refine_11c1314df3507688fa440e71e3b01524 @x1
@x2)))
...
@x2)
@x3))
:qid FullReductionInterpreter_interpretation_Tm_arrow_f735c27b94516aab2c82902bc5bd578f.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid FullReductionInterpreter_interpretation_Tm_arrow_f735c27b94516aab2c82902bc5bd578f.2))
...
@x1)
@x2))
:qid FullReductionInterpreter_interpretation_Tm_arrow_f735c27b94516aab2c82902bc5bd578f.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_f735c27b94516aab2c82902bc5bd578f))
:qid FullReductionInterpreter_interpretation_Tm_arrow_f735c27b94516aab2c82902bc5bd578f))

:named FullReductionInterpreter_interpretation_Tm_arrow_f735c27b94516aab2c82902bc5bd578f))
(declare-fun FullReductionInterpreter.open_term@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(39,8-39,17); use=FullReductionInterpreter.fst(39,8-39,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT FullReductionInterpreter.open_term@tok
@x0)
@x1)
@x2)
(FullReductionInterpreter.open_term @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT FullReductionInterpreter.open_term@tok
@x0)
@x1)
@x2))
:qid token_correspondence_FullReductionInterpreter.open_term))

:named token_correspondence_FullReductionInterpreter.open_term))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(39,8-39,17); use=FullReductionInterpreter.fst(39,8-39,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FullReductionInterpreter.open_term@tok
Tm_arrow_f735c27b94516aab2c82902bc5bd578f))
...
@x2)
@x3)
(FullReductionInterpreter.open_term @x1
@x2
@x3))
 

:pattern ((FullReductionInterpreter.open_term @x1
@x2
@x3))
:qid function_token_typing_FullReductionInterpreter.open_term.1))
)
 

:pattern ((ApplyTT @x0
FullReductionInterpreter.open_term@tok))
:qid function_token_typing_FullReductionInterpreter.open_term))

:named function_token_typing_FullReductionInterpreter.open_term))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(39,8-39,17); use=FullReductionInterpreter.fst(39,8-39,17)
...
FullReductionInterpreter.index)
(HasType @x2
(Tm_refine_11c1314df3507688fa440e71e3b01524 @x0
@x1)))
(HasType (FullReductionInterpreter.open_term @x0
@x1
@x2)
FullReductionInterpreter.term))
 

:pattern ((FullReductionInterpreter.open_term @x0
@x1
@x2))
:qid typing_FullReductionInterpreter.open_term))

:named typing_FullReductionInterpreter.open_term))
...
; Encoding query formula : forall (k: Prims.pure_post FullReductionInterpreter.term).
;   (forall (x: FullReductionInterpreter.term). {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(BV? t) /\ ~(FV? t) /\ ~(App? t) /\ ~(Lam? t) ==> Prims.l_False) /\
;   (forall (b: FullReductionInterpreter.index).
;       t == FullReductionInterpreter.BV b ==> Prims.hasEq FullReductionInterpreter.index) /\
;   (~(BV? t) ==>
;     ~(FV? t) ==>
;     (forall (b: FullReductionInterpreter.term) (b: FullReductionInterpreter.term).
;         t == FullReductionInterpreter.App b b ==>
;         (b << t \/ b === t /\ (i << i \/ a << a)) /\
;         (forall (any_result: FullReductionInterpreter.atom).
;             a == any_result ==>
;             (forall (any_result: FullReductionInterpreter.term).
;                 FullReductionInterpreter.open_term b i a == any_result ==>
;                 b << t \/ b === t /\ (i << i \/ a << a)))) /\
;     (~(App? t) ==>
;       (forall (b: FullReductionInterpreter.term).
;           t == FullReductionInterpreter.Lam b ==>
;           i + 1 >= 0 /\
;           (forall (return_val: FullReductionInterpreter.index).
;               return_val == i + 1 ==> b << t \/ b === t /\ (i + 1 << i \/ i + 1 === i /\ a << a)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec open_term`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post FullReductionInterpreter.term))

;; def=Prims.fst(402,27-402,88); use=FullReductionInterpreter.fst(40,4-48,33)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FullReductionInterpreter.fst(40,4-48,33)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FullReductionInterpreter.fst(40,4-48,33)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=FullReductionInterpreter.fst(40,4-48,33)
(and (implies 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(40,10-40,11)
(and 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(40,10-40,11)
(not 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(40,10-40,11)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_BV x_492c9857f193c5cd2315fa92f4dee678_0))
)
...
(not 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(40,10-40,11)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_FV x_492c9857f193c5cd2315fa92f4dee678_0))
)
...
(not 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(40,10-40,11)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_App x_492c9857f193c5cd2315fa92f4dee678_0))
)
...
(not 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(40,10-40,11)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Lam x_492c9857f193c5cd2315fa92f4dee678_0))
)
)

label_1)

;; def=Prims.fst(413,99-413,120); use=FullReductionInterpreter.fst(40,4-48,33)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
FullReductionInterpreter.index)

;; def=FullReductionInterpreter.fst(39,19-41,10); use=FullReductionInterpreter.fst(40,10-41,10)
(= x_492c9857f193c5cd2315fa92f4dee678_0
(FullReductionInterpreter.BV @x1))
)

;; def=Prims.fst(73,23-73,30); use=FullReductionInterpreter.fst(42,9-42,10)
(or label_2
...
(implies 
;; def=Prims.fst(389,18-389,39); use=FullReductionInterpreter.fst(40,4-48,33)
(and 
;; def=Prims.fst(389,19-389,21); use=FullReductionInterpreter.fst(40,4-48,33)
(not 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(40,10-40,11)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_BV x_492c9857f193c5cd2315fa92f4dee678_0))
)
...
;; def=Prims.fst(389,2-389,39); use=FullReductionInterpreter.fst(40,4-48,33)
(and 
;; def=Prims.fst(413,99-413,120); use=FullReductionInterpreter.fst(40,4-48,33)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=FullReductionInterpreter.fst(39,19-45,15); use=FullReductionInterpreter.fst(40,10-45,15)
(= x_492c9857f193c5cd2315fa92f4dee678_0
(FullReductionInterpreter.App @x1
@x2))
)
...
;; def=Prims.fst(459,77-459,89); use=FullReductionInterpreter.fst(40,4-48,33)
(and 
;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(46,26-46,27)
(or label_3

;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(46,26-46,27)
(Valid 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(46,26-46,27)
(Prims.precedes FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(46,26-46,27)
(and 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(46,26-46,27)
(Valid 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(46,26-46,27)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(39,28-48,33); use=FullReductionInterpreter.fst(46,26-46,27)
(or 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(46,26-46,27)
(Valid 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(46,26-46,27)
...
;; def=Prims.fst(451,66-451,102); use=FullReductionInterpreter.fst(40,4-48,33)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
FullReductionInterpreter.atom)

;; def=FullReductionInterpreter.fst(39,38-39,39); use=FullReductionInterpreter.fst(40,4-48,33)
(= x_00bdacec2575c08fd0637f9bd68e2708_2
@x3)
)
...
;; def=dummy(0,0-0,0); use=FullReductionInterpreter.fst(40,4-48,33)
(= (FullReductionInterpreter.open_term @x1
x_d73bdab5bc0a2d78768de5ed9a64d135_1
x_00bdacec2575c08fd0637f9bd68e2708_2)
@x4)
...
;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(46,45-46,46)
(or label_4

;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(46,45-46,46)
(Valid 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(46,45-46,46)
(Prims.precedes FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(46,45-46,46)
(and 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(46,45-46,46)
(Valid 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(46,45-46,46)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(39,28-48,33); use=FullReductionInterpreter.fst(46,45-46,46)
(or 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(46,45-46,46)
(Valid 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(46,45-46,46)
...
;; def=FullReductionInterpreter.fst(39,19-47,11); use=FullReductionInterpreter.fst(40,10-47,11)
(= x_492c9857f193c5cd2315fa92f4dee678_0
(FullReductionInterpreter.Lam @x1))
)
...
;; def=Prims.fst(459,77-459,89); use=FullReductionInterpreter.fst(40,4-48,33)
(and 
;; def=Prims.fst(680,18-680,24); use=FullReductionInterpreter.fst(48,23-48,30)
(or label_5

;; def=Prims.fst(680,18-680,24); use=FullReductionInterpreter.fst(48,23-48,30)
(>= (BoxInt_proj_0 (Prims.op_Addition x_d73bdab5bc0a2d78768de5ed9a64d135_1
(BoxInt 1)))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=Prims.fst(356,2-356,58); use=FullReductionInterpreter.fst(40,4-48,33)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
FullReductionInterpreter.index)

;; def=Prims.fst(356,26-356,41); use=FullReductionInterpreter.fst(40,4-48,33)
(= @x2
(Prims.op_Addition x_d73bdab5bc0a2d78768de5ed9a64d135_1
(BoxInt 1)))
)

;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(48,31-48,32)
(or label_6

;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(48,31-48,32)
(Valid 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(48,31-48,32)
(Prims.precedes FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(39,19-48,33); use=FullReductionInterpreter.fst(48,31-48,32)
(and 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(48,31-48,32)
(Valid 
;; def=FullReductionInterpreter.fst(39,19-39,20); use=FullReductionInterpreter.fst(48,31-48,32)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(39,28-48,33); use=FullReductionInterpreter.fst(48,31-48,32)
(or 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(48,31-48,32)
(Valid 
;; def=FullReductionInterpreter.fst(40,4-48,33); use=FullReductionInterpreter.fst(48,31-48,32)
...
;; def=FullReductionInterpreter.fst(39,28-48,33); use=FullReductionInterpreter.fst(48,31-48,32)
(and 
;; def=FullReductionInterpreter.fst(39,28-39,29); use=FullReductionInterpreter.fst(48,31-48,32)
(Valid 
;; def=FullReductionInterpreter.fst(39,28-39,29); use=FullReductionInterpreter.fst(48,31-48,32)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.index
FullReductionInterpreter.index
...
; encoding sigelt let rec open_term


; <Start encoding let rec open_term>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun FullReductionInterpreter.open_term.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun FullReductionInterpreter.open_term.fuel_instrumented_token () Term)
(declare-fun FullReductionInterpreter.open_term (Term Term Term) Term)
(declare-fun FullReductionInterpreter.open_term@tok () Term)
;;;;;;;;;;;;;;;;t: term -> i: index -> a: atom -> term
(declare-fun Tm_arrow_52aaae360b01957900a49a410d4be99c () Term)

; </end encoding let rec open_term>

(push) ;; push{2

; Starting query at FullReductionInterpreter.fst(51,4-58,34)
...
FullReductionInterpreter.atom)
:named binder_x_00bdacec2575c08fd0637f9bd68e2708_2))
(declare-fun Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(50,20-58,34)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e))

:named refinement_kinding_Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(50,20-58,34)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e @x2
@x3))
(and (HasTypeFuel @u0
@x1
FullReductionInterpreter.atom)
...
;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(50,20-58,34)
(or 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(51,4-58,34)
(Valid 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(51,4-58,34)
(Prims.precedes FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(50,20-58,34)
(and 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(50,20-50,21)
(Valid 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(50,20-50,21)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(50,29-58,34); use=FullReductionInterpreter.fst(50,29-58,34)
(or 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(51,4-58,34)
(Valid 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(51,4-58,34)
...
;; def=FullReductionInterpreter.fst(50,29-58,34); use=FullReductionInterpreter.fst(50,29-58,34)
(and 
;; def=FullReductionInterpreter.fst(50,29-50,30); use=FullReductionInterpreter.fst(50,29-50,30)
(Valid 
;; def=FullReductionInterpreter.fst(50,29-50,30); use=FullReductionInterpreter.fst(50,29-50,30)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.index
FullReductionInterpreter.index
...
(Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e @x2
@x3)))
:qid refinement_interpretation_Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e))

:named refinement_interpretation_Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(50,20-58,34)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e @x0
@x1)))
(Valid (Prims.hasEq FullReductionInterpreter.atom)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e @x0
@x1))))
:qid haseqTm_refine_1b82d8b7d166d15483739fa0a8dd0c2e))

:named haseqTm_refine_1b82d8b7d166d15483739fa0a8dd0c2e))
(declare-fun FullReductionInterpreter.close_term (Term Term Term) Term)

;;;;;;;;;;;;;;;;t: term -> i: index -> a: atom{t << t \/ t === t /\ (i << i \/ i === i /\ a << a)} -> term
(declare-fun Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb
Tm_type)
:named kinding_Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(36,10-58,34); use=FullReductionInterpreter.fst(50,20-58,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb))
:qid FullReductionInterpreter_pre_typing_Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb))

:named FullReductionInterpreter_pre_typing_Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(36,10-58,34); use=FullReductionInterpreter.fst(50,20-58,34)
(forall ((@x0 Term))
...
FullReductionInterpreter.index)
(HasType @x3
(Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x2)
@x3))
:qid FullReductionInterpreter_interpretation_Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid FullReductionInterpreter_interpretation_Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb.2))
...
@x1)
@x2))
:qid FullReductionInterpreter_interpretation_Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb))
:qid FullReductionInterpreter_interpretation_Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb))

:named FullReductionInterpreter_interpretation_Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb))
(declare-fun FullReductionInterpreter.close_term@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(50,8-50,18); use=FullReductionInterpreter.fst(50,8-50,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT FullReductionInterpreter.close_term@tok
@x0)
@x1)
@x2)
(FullReductionInterpreter.close_term @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT FullReductionInterpreter.close_term@tok
@x0)
@x1)
@x2))
:qid token_correspondence_FullReductionInterpreter.close_term))

:named token_correspondence_FullReductionInterpreter.close_term))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(50,8-50,18); use=FullReductionInterpreter.fst(50,8-50,18)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FullReductionInterpreter.close_term@tok
Tm_arrow_360d63f44cc4a8552ed7756cb7fd95fb))
...
@x2)
@x3)
(FullReductionInterpreter.close_term @x1
@x2
@x3))
 

:pattern ((FullReductionInterpreter.close_term @x1
@x2
@x3))
:qid function_token_typing_FullReductionInterpreter.close_term.1))
)
 

:pattern ((ApplyTT @x0
FullReductionInterpreter.close_term@tok))
:qid function_token_typing_FullReductionInterpreter.close_term))

:named function_token_typing_FullReductionInterpreter.close_term))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=FullReductionInterpreter.fst(50,8-50,18); use=FullReductionInterpreter.fst(50,8-50,18)
...
FullReductionInterpreter.index)
(HasType @x2
(Tm_refine_1b82d8b7d166d15483739fa0a8dd0c2e @x0
@x1)))
(HasType (FullReductionInterpreter.close_term @x0
@x1
@x2)
FullReductionInterpreter.term))
 

:pattern ((FullReductionInterpreter.close_term @x0
@x1
@x2))
:qid typing_FullReductionInterpreter.close_term))

:named typing_FullReductionInterpreter.close_term))
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
...
;   (~(BV? t) /\ ~(FV? t) /\ ~(App? t) /\ ~(Lam? t) ==> Prims.l_False) /\
;   (~(BV? t) ==>
;     (forall (b: FullReductionInterpreter.atom).
;         t == FullReductionInterpreter.FV b ==> Prims.hasEq FullReductionInterpreter.atom) /\
;     (~(FV? t) ==>
;       (forall (b: FullReductionInterpreter.term) (b: FullReductionInterpreter.term).
;           t == FullReductionInterpreter.App b b ==>
;           (b << t \/ b === t /\ (i << i \/ a << a)) /\
...
;               a == any_result ==>
;               (forall (any_result: FullReductionInterpreter.term).
;                   FullReductionInterpreter.close_term b i a == any_result ==>
;                   b << t \/ b === t /\ (i << i \/ a << a)))) /\
;       (~(App? t) ==>
;         (forall (b: FullReductionInterpreter.term).
;             t == FullReductionInterpreter.Lam b ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec close_term`
...
;; def=Prims.fst(402,27-402,88); use=FullReductionInterpreter.fst(51,4-58,34)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FullReductionInterpreter.fst(51,4-58,34)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FullReductionInterpreter.fst(51,4-58,34)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=FullReductionInterpreter.fst(51,4-58,34)
(and (implies 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(51,10-51,11)
(and 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(51,10-51,11)
(not 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(51,10-51,11)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=FullReductionInterpreter.fst(51,4-58,34)
(not 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(51,10-51,11)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_BV x_492c9857f193c5cd2315fa92f4dee678_0))
)
...
;; def=Prims.fst(389,2-389,39); use=FullReductionInterpreter.fst(51,4-58,34)
(and 
;; def=Prims.fst(413,99-413,120); use=FullReductionInterpreter.fst(51,4-58,34)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
FullReductionInterpreter.atom)

;; def=FullReductionInterpreter.fst(50,20-53,10); use=FullReductionInterpreter.fst(51,10-53,10)
(= x_492c9857f193c5cd2315fa92f4dee678_0
(FullReductionInterpreter.FV @x1))
)

;; def=Prims.fst(73,23-73,30); use=FullReductionInterpreter.fst(54,13-54,14)
(or label_2
...
;; def=FullReductionInterpreter.fst(50,20-55,15); use=FullReductionInterpreter.fst(51,10-55,15)
(= x_492c9857f193c5cd2315fa92f4dee678_0
(FullReductionInterpreter.App @x1
@x2))
)
...
;; def=Prims.fst(459,77-459,89); use=FullReductionInterpreter.fst(51,4-58,34)
(and 
;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(56,27-56,28)
(or label_3

;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(56,27-56,28)
(Valid 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(56,27-56,28)
(Prims.precedes FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(56,27-56,28)
(and 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(56,27-56,28)
(Valid 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(56,27-56,28)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(50,29-58,34); use=FullReductionInterpreter.fst(56,27-56,28)
(or 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(56,27-56,28)
(Valid 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(56,27-56,28)
...
;; def=Prims.fst(451,66-451,102); use=FullReductionInterpreter.fst(51,4-58,34)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
FullReductionInterpreter.atom)

;; def=FullReductionInterpreter.fst(50,39-50,40); use=FullReductionInterpreter.fst(51,4-58,34)
(= x_00bdacec2575c08fd0637f9bd68e2708_2
@x3)
)
...
;; def=dummy(0,0-0,0); use=FullReductionInterpreter.fst(51,4-58,34)
(= (FullReductionInterpreter.close_term @x1
x_d73bdab5bc0a2d78768de5ed9a64d135_1
x_00bdacec2575c08fd0637f9bd68e2708_2)
@x4)
...
;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(56,47-56,48)
(or label_4

;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(56,47-56,48)
(Valid 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(56,47-56,48)
(Prims.precedes FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(56,47-56,48)
(and 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(56,47-56,48)
(Valid 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(56,47-56,48)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(50,29-58,34); use=FullReductionInterpreter.fst(56,47-56,48)
(or 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(56,47-56,48)
(Valid 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(56,47-56,48)
...
;; def=FullReductionInterpreter.fst(50,20-57,11); use=FullReductionInterpreter.fst(51,10-57,11)
(= x_492c9857f193c5cd2315fa92f4dee678_0
(FullReductionInterpreter.Lam @x1))
)
...
;; def=Prims.fst(459,77-459,89); use=FullReductionInterpreter.fst(51,4-58,34)
(and 
;; def=Prims.fst(680,18-680,24); use=FullReductionInterpreter.fst(58,24-58,31)
(or label_5
...
;; def=Prims.fst(356,2-356,58); use=FullReductionInterpreter.fst(51,4-58,34)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
FullReductionInterpreter.index)

;; def=Prims.fst(356,26-356,41); use=FullReductionInterpreter.fst(51,4-58,34)
(= @x2
(Prims.op_Addition x_d73bdab5bc0a2d78768de5ed9a64d135_1
(BoxInt 1)))
)

;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(58,32-58,33)
(or label_6

;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(58,32-58,33)
(Valid 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(58,32-58,33)
(Prims.precedes FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(50,20-58,34); use=FullReductionInterpreter.fst(58,32-58,33)
(and 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(58,32-58,33)
(Valid 
;; def=FullReductionInterpreter.fst(50,20-50,21); use=FullReductionInterpreter.fst(58,32-58,33)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.term
FullReductionInterpreter.term
...
;; def=FullReductionInterpreter.fst(50,29-58,34); use=FullReductionInterpreter.fst(58,32-58,33)
(or 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(58,32-58,33)
(Valid 
;; def=FullReductionInterpreter.fst(51,4-58,34); use=FullReductionInterpreter.fst(58,32-58,33)
...
;; def=FullReductionInterpreter.fst(50,29-58,34); use=FullReductionInterpreter.fst(58,32-58,33)
(and 
;; def=FullReductionInterpreter.fst(50,29-50,30); use=FullReductionInterpreter.fst(58,32-58,33)
(Valid 
;; def=FullReductionInterpreter.fst(50,29-50,30); use=FullReductionInterpreter.fst(58,32-58,33)
(Prims.op_Equals_Equals_Equals FullReductionInterpreter.index
FullReductionInterpreter.index
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.close_term, 1)
; STATUS: unsat
...
; encoding sigelt let rec close_term


; <Start encoding let rec close_term>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun FullReductionInterpreter.close_term.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun FullReductionInterpreter.close_term.fuel_instrumented_token () Term)
(declare-fun FullReductionInterpreter.close_term (Term Term Term) Term)
(declare-fun FullReductionInterpreter.close_term@tok () Term)


; </end encoding let rec close_term>
...
(declare-fun FullReductionInterpreter.abs (Term Term) Term)
;;;;;;;;;;;;;;;;a: atom -> t: term -> term
(declare-fun Tm_arrow_135bb56d873d87bceee0bfd0e516b3b4 () Term)
(declare-fun FullReductionInterpreter.abs@tok () Term)

; </end encoding let abs>


; encoding sigelt #push-options "--warn_error -272"


; <Skipped #push-options "--warn_error -272"/>
...
; Starting query at FullReductionInterpreter.fst(63,0-68,5)
...
; Encoding query formula : forall (h0: FStar.Monotonic.Heap.heap)
;   (a:
;   FStar.ST.mref FullReductionInterpreter.atom
;     (FStar.Heap.trivial_preorder FullReductionInterpreter.atom))
;   (h1: FStar.Monotonic.Heap.heap).
;   FStar.Monotonic.Heap.fresh a h0 h1 /\ FStar.Monotonic.Heap.modifies FStar.Set.empty h0 h1 /\
;   FStar.Monotonic.Heap.sel h1 a == 0 ==>
;   (forall (_: Prims.unit).
;       (*  - Could not prove post-condition
; *)
;       forall (h0: FStar.Monotonic.Heap.heap).
;         FStar.Monotonic.Heap.sel h0 a + 1 >= 0 /\
;         (forall (return_val: FullReductionInterpreter.atom).
;             return_val == FStar.Monotonic.Heap.sel h0 a + 1 ==>
;             FStar.Heap.trivial_preorder FullReductionInterpreter.atom
;               (FStar.Monotonic.Heap.sel h0 a)
;               (FStar.Monotonic.Heap.sel h0 a + 1)))


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let fresh_atom`
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Pervasives.fsti(493,53-493,90); use=FStar.Pervasives.fsti(505,14-505,24)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FStar.Monotonic.Heap.heap)

;; def=FStar.ST.fst(76,50-76,87); use=FullReductionInterpreter.fst(64,21-64,26)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
(FStar.ST.mref FullReductionInterpreter.atom
(FStar.Heap.trivial_preorder FullReductionInterpreter.atom)))
...
;; def=FStar.ST.fst(89,22-89,35); use=FullReductionInterpreter.fst(64,21-64,26)
(Valid 
;; def=FStar.ST.fst(89,22-89,35); use=FullReductionInterpreter.fst(64,21-64,26)
(FStar.Monotonic.Heap.fresh FullReductionInterpreter.atom
(FStar.Heap.trivial_preorder FullReductionInterpreter.atom)
@x1
@x0
@x2)
...
;; def=FStar.ST.fst(89,39-89,63); use=FullReductionInterpreter.fst(64,21-64,26)
(Valid 
;; def=FStar.ST.fst(89,39-89,63); use=FullReductionInterpreter.fst(64,21-64,26)
...
;; def=FStar.ST.fst(89,67-89,83); use=FullReductionInterpreter.fst(64,21-64,26)
(= (FStar.Monotonic.Heap.sel FullReductionInterpreter.atom
(FStar.Heap.trivial_preorder FullReductionInterpreter.atom)
@x2
@x1)
(BoxInt 0))
...
;; def=Prims.fst(459,77-459,89); use=FullReductionInterpreter.fst(65,11-68,5)
(and 
;; def=Prims.fst(680,18-680,24); use=FullReductionInterpreter.fst(67,9-67,14)
(or label_1

;; def=Prims.fst(680,18-680,24); use=FullReductionInterpreter.fst(67,9-67,14)
(>= (BoxInt_proj_0 (Prims.op_Addition (FStar.Monotonic.Heap.sel FullReductionInterpreter.atom
(FStar.Heap.trivial_preorder FullReductionInterpreter.atom)
@x4
@x1)
(BoxInt 1)))
...
;; def=Prims.fst(356,2-356,58); use=FullReductionInterpreter.fst(65,11-68,5)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
FullReductionInterpreter.atom)

;; def=Prims.fst(356,26-356,41); use=FullReductionInterpreter.fst(65,11-68,5)
(= @x5
(Prims.op_Addition (FStar.Monotonic.Heap.sel FullReductionInterpreter.atom
(FStar.Heap.trivial_preorder FullReductionInterpreter.atom)
@x4
@x1)
(BoxInt 1)))
...
;; def=FStar.ST.fst(124,14-124,29); use=FullReductionInterpreter.fst(67,6-67,8)
(or label_2
...
; encoding sigelt let fresh_atom


; <Start encoding let fresh_atom>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FullReductionInterpreter.fresh_atom (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FullReductionInterpreter.fresh_atom@tok () Term)

; </end encoding let fresh_atom>
...
; encoding sigelt let abs_body


; <Start encoding let abs_body>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FullReductionInterpreter.abs_body (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FullReductionInterpreter.abs_body@tok () Term)

; </end encoding let abs_body>


; encoding sigelt type FullReductionInterpreter.t


; <Start encoding type FullReductionInterpreter.t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun FullReductionInterpreter.t () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FullReductionInterpreter.Fun (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FullReductionInterpreter.Fun__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: FullReductionInterpreter.Fun
(declare-fun FullReductionInterpreter.Fun@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FullReductionInterpreter.Acc (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FullReductionInterpreter.Acc__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FullReductionInterpreter.Acc__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: FullReductionInterpreter.Acc
(declare-fun FullReductionInterpreter.Acc@tok () Term)
(declare-fun Non_total_Tm_arrow_d0a2c4192783e46c53da9382875fd18a () Term)

;;;;;;;;;;;;;;;;_0: (_: t -> FStar.All.ML t) -> t
(declare-fun Tm_arrow_00f42cf7fe51b6e997eb875c0ff66eea () Term)
;;;;;;;;;;;;;;;;_0: atom -> _1: Prims.list t -> t
(declare-fun Tm_arrow_e4400a604ee9691e58c7becbe22297a7 () Term)

; <start constructor FullReductionInterpreter.t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FullReductionInterpreter.t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
228)
(= __@x0
FullReductionInterpreter.t)))

; </end constructor FullReductionInterpreter.t>


; <start constructor FullReductionInterpreter.Fun>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FullReductionInterpreter.Fun ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
240)
(= __@x0
(FullReductionInterpreter.Fun (FullReductionInterpreter.Fun__0 __@x0)))))

; </end constructor FullReductionInterpreter.Fun>


; <start constructor FullReductionInterpreter.Acc>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FullReductionInterpreter.Acc ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
251)
(= __@x0
(FullReductionInterpreter.Acc (FullReductionInterpreter.Acc__0 __@x0)
(FullReductionInterpreter.Acc__1 __@x0)))))

; </end constructor FullReductionInterpreter.Acc>


; </end encoding type FullReductionInterpreter.t>


; encoding sigelt val FullReductionInterpreter.uu___is_Fun


; <Start encoding val FullReductionInterpreter.uu___is_Fun>

(declare-fun FullReductionInterpreter.uu___is_Fun (Term) Term)
;;;;;;;;;;;;;;;;projectee: t -> Prims.bool
(declare-fun Tm_arrow_952b8e176cedfa7bf0ddb5cd5e4ffccf () Term)
(declare-fun FullReductionInterpreter.uu___is_Fun@tok () Term)

; </end encoding val FullReductionInterpreter.uu___is_Fun>


; encoding sigelt let uu___is_Fun


; <Skipped let uu___is_Fun/>


; encoding sigelt val FullReductionInterpreter.__proj__Fun__item___0


; <Start encoding val FullReductionInterpreter.__proj__Fun__item___0>

(declare-fun Tm_refine_6eaf1255ebd74636f904133dfcd28995 () Term)
(declare-fun FullReductionInterpreter.__proj__Fun__item___0 (Term) Term)


;;;;;;;;;;;;;;;;projectee: _: t{Fun? _} -> _: t -> FStar.All.ML t
(declare-fun Tm_arrow_67072f01c08f9e6abbf00b03d2cb2a50 () Term)
(declare-fun FullReductionInterpreter.__proj__Fun__item___0@tok () Term)


; </end encoding val FullReductionInterpreter.__proj__Fun__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FullReductionInterpreter.uu___is_Fun; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(80,4-80,7); use=FullReductionInterpreter.fst(80,4-80,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FullReductionInterpreter.t)
(HasType (FullReductionInterpreter.uu___is_Fun @x0)
Prims.bool))
 

:pattern ((FullReductionInterpreter.uu___is_Fun @x0))
:qid typing_FullReductionInterpreter.uu___is_Fun))

:named typing_FullReductionInterpreter.uu___is_Fun))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(80,4-80,7); use=FullReductionInterpreter.fst(80,4-80,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(FullReductionInterpreter.Fun @x1)
FullReductionInterpreter.t)
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x1
...
(FullReductionInterpreter.Fun @x1)
FullReductionInterpreter.t))
:qid subterm_ordering_FullReductionInterpreter.Fun))

:named subterm_ordering_FullReductionInterpreter.Fun))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(FullReductionInterpreter.Acc @x1
@x2)
FullReductionInterpreter.t)
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
...
@x2)
FullReductionInterpreter.t))
:qid subterm_ordering_FullReductionInterpreter.Acc))

:named subterm_ordering_FullReductionInterpreter.Acc))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FullReductionInterpreter.__proj__Fun__item___0; Namespace FullReductionInterpreter
(assert (! (HasType Tm_refine_6eaf1255ebd74636f904133dfcd28995
Tm_type)
:named refinement_kinding_Tm_refine_6eaf1255ebd74636f904133dfcd28995))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FullReductionInterpreter.__proj__Fun__item___0; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(80,4-80,7); use=FullReductionInterpreter.fst(80,4-80,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_6eaf1255ebd74636f904133dfcd28995)
(and (HasTypeFuel @u0
@x1
FullReductionInterpreter.t)

;; def=FullReductionInterpreter.fst(80,4-80,7); use=FullReductionInterpreter.fst(80,4-80,7)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Fun @x1))
))
...
@x1
Tm_refine_6eaf1255ebd74636f904133dfcd28995))
:qid refinement_interpretation_Tm_refine_6eaf1255ebd74636f904133dfcd28995))

:named refinement_interpretation_Tm_refine_6eaf1255ebd74636f904133dfcd28995))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
...
;; def=FullReductionInterpreter.fst(80,4-80,7); use=FullReductionInterpreter.fst(80,4-80,7)
(forall ((@x0 Term))
 (! (= (FullReductionInterpreter.Fun__0 (FullReductionInterpreter.Fun @x0))
@x0)
 

:pattern ((FullReductionInterpreter.Fun @x0))
:qid projection_inverse_FullReductionInterpreter.Fun__0))

:named projection_inverse_FullReductionInterpreter.Fun__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FullReductionInterpreter.Acc__1 (FullReductionInterpreter.Acc @x0
@x1))
@x1)
 

:pattern ((FullReductionInterpreter.Acc @x0
@x1))
:qid projection_inverse_FullReductionInterpreter.Acc__1))

:named projection_inverse_FullReductionInterpreter.Acc__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FullReductionInterpreter.Acc__0 (FullReductionInterpreter.Acc @x0
@x1))
@x0)
...
:pattern ((FullReductionInterpreter.Acc @x0
@x1))
:qid projection_inverse_FullReductionInterpreter.Acc__0))

:named projection_inverse_FullReductionInterpreter.Acc__0))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
...
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! (HasType Non_total_Tm_arrow_d0a2c4192783e46c53da9382875fd18a
Tm_type)
:named non_total_function_typing_Non_total_Tm_arrow_d0a2c4192783e46c53da9382875fd18a))
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
...
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! (HasType FullReductionInterpreter.t
Tm_type)
:named kinding_FullReductionInterpreter.t@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6eaf1255ebd74636f904133dfcd28995
;;; Fact-ids: Name FullReductionInterpreter.__proj__Fun__item___0; Namespace FullReductionInterpreter
(assert (! (iff (Valid (Prims.hasEq Tm_refine_6eaf1255ebd74636f904133dfcd28995))
(Valid (Prims.hasEq FullReductionInterpreter.t)))
:named haseqTm_refine_6eaf1255ebd74636f904133dfcd28995))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(614,5-614,9); use=Prims.fst(614,5-614,9)
...
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(79,5-79,6); use=FullReductionInterpreter.fst(79,5-79,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
FullReductionInterpreter.t)
(or (is-FullReductionInterpreter.Fun @x1)
(is-FullReductionInterpreter.Acc @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
FullReductionInterpreter.t))
:qid fuel_guarded_inversion_FullReductionInterpreter.t))

:named fuel_guarded_inversion_FullReductionInterpreter.t))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! (= 319
...
;; def=FullReductionInterpreter.fst(80,4-80,7); use=FullReductionInterpreter.fst(80,4-80,7)
(forall ((@x0 Term))
 (! (= (FullReductionInterpreter.uu___is_Fun @x0)
(BoxBool (is-FullReductionInterpreter.Fun @x0)))
 

:pattern ((FullReductionInterpreter.uu___is_Fun @x0))
:qid disc_equation_FullReductionInterpreter.Fun))

:named disc_equation_FullReductionInterpreter.Fun))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(615,4-615,7); use=Prims.fst(615,4-615,7)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Non_total_Tm_arrow_d0a2c4192783e46c53da9382875fd18a)
(HasTypeFuel @u0
(FullReductionInterpreter.Fun @x1)
FullReductionInterpreter.t))
...
(FullReductionInterpreter.Fun @x1)
FullReductionInterpreter.t))
:qid data_typing_intro_FullReductionInterpreter.Fun@tok))

:named data_typing_intro_FullReductionInterpreter.Fun@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
...
(HasTypeFuel @u0
@x2
(Prims.list FullReductionInterpreter.t)))
(HasTypeFuel @u0
(FullReductionInterpreter.Acc @x1
@x2)
FullReductionInterpreter.t))
...
@x2)
FullReductionInterpreter.t))
:qid data_typing_intro_FullReductionInterpreter.Acc@tok))

:named data_typing_intro_FullReductionInterpreter.Acc@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(615,4-615,7); use=Prims.fst(615,4-615,7)
...
(FullReductionInterpreter.Fun @x1)
FullReductionInterpreter.t))
:qid data_elim_FullReductionInterpreter.Fun))

:named data_elim_FullReductionInterpreter.Fun))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
...
@x2)
FullReductionInterpreter.t))
:qid data_elim_FullReductionInterpreter.Acc))

:named data_elim_FullReductionInterpreter.Acc))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(614,5-614,9); use=Prims.fst(614,5-614,9)
...
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! (= 228
(Term_constr_id FullReductionInterpreter.t))
:named constructor_distinct_FullReductionInterpreter.t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(80,4-80,7); use=FullReductionInterpreter.fst(80,4-80,7)
(forall ((@x0 Term))
 (! (= 240
(Term_constr_id (FullReductionInterpreter.Fun @x0)))
 

:pattern ((FullReductionInterpreter.Fun @x0))
:qid constructor_distinct_FullReductionInterpreter.Fun))

:named constructor_distinct_FullReductionInterpreter.Fun))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FullReductionInterpreter.t; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Fun; Namespace FullReductionInterpreter; Name FullReductionInterpreter.Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= 251
(Term_constr_id (FullReductionInterpreter.Acc @x0
@x1)))
 

:pattern ((FullReductionInterpreter.Acc @x0
@x1))
:qid constructor_distinct_FullReductionInterpreter.Acc))

:named constructor_distinct_FullReductionInterpreter.Acc))
...
@x0
FullReductionInterpreter.t))
:qid FullReductionInterpreter_pretyping_6ab84720137e4e57aebb6d6c3ad67ae2))

:named FullReductionInterpreter_pretyping_6ab84720137e4e57aebb6d6c3ad67ae2))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: FullReductionInterpreter.t{Fun? _}).
;   (*  - Could not prove post-condition
; *) ~(Fun? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Fun__item___0`
...
(not 
;; def=FullReductionInterpreter.fst(80,4-80,7); use=FullReductionInterpreter.fst(80,4-80,7)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Fun @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.__proj__Fun__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_6eaf1255ebd74636f904133dfcd28995
...
; encoding sigelt let __proj__Fun__item___0


; <Skipped let __proj__Fun__item___0/>


; encoding sigelt val FullReductionInterpreter.uu___is_Acc


; <Start encoding val FullReductionInterpreter.uu___is_Acc>

(declare-fun FullReductionInterpreter.uu___is_Acc (Term) Term)

(declare-fun FullReductionInterpreter.uu___is_Acc@tok () Term)

; </end encoding val FullReductionInterpreter.uu___is_Acc>


; encoding sigelt let uu___is_Acc


; <Skipped let uu___is_Acc/>


; encoding sigelt val FullReductionInterpreter.__proj__Acc__item___0


; <Start encoding val FullReductionInterpreter.__proj__Acc__item___0>

(declare-fun Tm_refine_c1dabe24910280b4a12783d0aa11a5ac () Term)
(declare-fun FullReductionInterpreter.__proj__Acc__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t{Acc? _} -> atom
(declare-fun Tm_arrow_89778490fabe8cd56df5bbcb2be6c498 () Term)
(declare-fun FullReductionInterpreter.__proj__Acc__item___0@tok () Term)

; </end encoding val FullReductionInterpreter.__proj__Acc__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FullReductionInterpreter.uu___is_Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FullReductionInterpreter.t)
(HasType (FullReductionInterpreter.uu___is_Acc @x0)
Prims.bool))
 

:pattern ((FullReductionInterpreter.uu___is_Acc @x0))
:qid typing_FullReductionInterpreter.uu___is_Acc))

:named typing_FullReductionInterpreter.uu___is_Acc))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FullReductionInterpreter.__proj__Acc__item___0; Namespace FullReductionInterpreter
(assert (! (HasType Tm_refine_c1dabe24910280b4a12783d0aa11a5ac
Tm_type)
:named refinement_kinding_Tm_refine_c1dabe24910280b4a12783d0aa11a5ac))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FullReductionInterpreter.__proj__Acc__item___0; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_c1dabe24910280b4a12783d0aa11a5ac)
(and (HasTypeFuel @u0
@x1
FullReductionInterpreter.t)

;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Acc @x1))
))
...
@x1
Tm_refine_c1dabe24910280b4a12783d0aa11a5ac))
:qid refinement_interpretation_Tm_refine_c1dabe24910280b4a12783d0aa11a5ac))

:named refinement_interpretation_Tm_refine_c1dabe24910280b4a12783d0aa11a5ac))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c1dabe24910280b4a12783d0aa11a5ac
;;; Fact-ids: Name FullReductionInterpreter.__proj__Acc__item___0; Namespace FullReductionInterpreter
(assert (! (iff (Valid (Prims.hasEq Tm_refine_c1dabe24910280b4a12783d0aa11a5ac))
(Valid (Prims.hasEq FullReductionInterpreter.t)))
:named haseqTm_refine_c1dabe24910280b4a12783d0aa11a5ac))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name FullReductionInterpreter.uu___is_Acc; Namespace FullReductionInterpreter
(assert (! 
;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
(forall ((@x0 Term))
 (! (= (FullReductionInterpreter.uu___is_Acc @x0)
(BoxBool (is-FullReductionInterpreter.Acc @x0)))
 

:pattern ((FullReductionInterpreter.uu___is_Acc @x0))
:qid disc_equation_FullReductionInterpreter.Acc))

:named disc_equation_FullReductionInterpreter.Acc))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: FullReductionInterpreter.t{Acc? _}).
;   (*  - Could not prove post-condition
; *) ~(Acc? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Acc__item___0`
...
(not 
;; def=FullReductionInterpreter.fst(81,4-81,7); use=FullReductionInterpreter.fst(81,4-81,7)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Acc @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.__proj__Acc__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_c1dabe24910280b4a12783d0aa11a5ac
...
; encoding sigelt let __proj__Acc__item___0


; <Skipped let __proj__Acc__item___0/>


; encoding sigelt val FullReductionInterpreter.__proj__Acc__item___1


; <Start encoding val FullReductionInterpreter.__proj__Acc__item___1>


(declare-fun FullReductionInterpreter.__proj__Acc__item___1 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t{Acc? _} -> Prims.list t
(declare-fun Tm_arrow_f1b976c1cb700f7793fcf9bbf2d15854 () Term)
(declare-fun FullReductionInterpreter.__proj__Acc__item___1@tok () Term)

; </end encoding val FullReductionInterpreter.__proj__Acc__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Acc__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.__proj__Acc__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_c1dabe24910280b4a12783d0aa11a5ac
...
; encoding sigelt let __proj__Acc__item___1


; <Skipped let __proj__Acc__item___1/>
...
; Starting query at FullReductionInterpreter.fst(84,2-86,41)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (hd: FullReductionInterpreter.t)
;   (arg: FullReductionInterpreter.t)
;   (h0: FStar.Monotonic.Heap.heap)
;   (k: FStar.Pervasives.all_post_h FStar.Monotonic.Heap.heap FullReductionInterpreter.t).
;   (forall (x: FStar.Pervasives.result FullReductionInterpreter.t) (h: FStar.Monotonic.Heap.heap).
;       {:pattern Prims.guard_free (k x h)}
;       Prims.auto_squash (k x h)) ==>
;   ~(Fun? hd) /\ ~(Acc? hd) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let extend_app`
...
;; def=FStar.Pervasives.fsti(667,4-667,88); use=FStar.Pervasives.fsti(694,13-694,23)
(forall ((@x4 Term) (@x5 Term))
 (! 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=FStar.Pervasives.fsti(694,13-694,23)
(Valid 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=FStar.Pervasives.fsti(694,13-694,23)
(ApplyTT (ApplyTT @x3
@x4)
...
:pattern ((ApplyTT (ApplyTT @x3
@x4)
@x5))
:qid @query.2))


;; def=FullReductionInterpreter.fst(83,16-83,18); use=FullReductionInterpreter.fst(84,8-84,10)
(not 
;; def=FullReductionInterpreter.fst(83,16-83,18); use=FullReductionInterpreter.fst(84,8-84,10)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Fun @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.extend_app, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_FullReductionInterpreter.Acc, disc_equation_FullReductionInterpreter.Fun, fuel_guarded_inversion_FullReductionInterpreter.t, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let extend_app


; <Start encoding let extend_app>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FullReductionInterpreter.extend_app (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FullReductionInterpreter.extend_app@tok () Term)

; </end encoding let extend_app>
...
(HasType @x2
Prims.nat))
(HasType (FStar.List.Tot.Base.nth @x0
@x1
@x2)
(FStar.Pervasives.Native.option @x0)))
...
@x1
@x2))
:qid typing_FStar.List.Tot.Base.nth))

:named typing_FStar.List.Tot.Base.nth))
;;;;;;;;;;;;;;;;name-token correspondence
...
(HasType @x3
Prims.nat))
(HasType (FStar.List.Tot.Base.nth.fuel_instrumented @u0
@x1
@x2
@x3)
...
:pattern ((FStar.List.Tot.Base.nth.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_FStar.List.Tot.Base.nth.fuel_instrumented))

:named token_correspondence_FStar.List.Tot.Base.nth.fuel_instrumented))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FStar.Pervasives.Native.option; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.None; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Some; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=FStar.Pervasives.Native.fst(33,4-33,8)
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: FStar.List.Tot.Base.nth
;;; Fact-ids: Name FStar.List.Tot.Base.nth; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(82,8-82,11); use=FStar.List.Tot.Base.fst(82,8-82,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(FStar.Pervasives.Native.Some @x1
(Prims.Cons_hd @lb4))
(FStar.List.Tot.Base.nth.fuel_instrumented @u0
@x1
(Prims.Cons_tl @lb4)
...
@x2
@x3))
:qid equation_with_fuel_FStar.List.Tot.Base.nth.fuel_instrumented))

:named equation_with_fuel_FStar.List.Tot.Base.nth.fuel_instrumented))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name FStar.Pervasives.Native.uu___is_Some; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=FStar.Pervasives.Native.fst(33,4-33,8)
...
; Starting query at FullReductionInterpreter.fst(92,4-106,41)

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FullReductionInterpreter.translate (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FullReductionInterpreter.translate@tok () Term)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (ctx: Prims.list FullReductionInterpreter.t) (x: FullReductionInterpreter.term).
;   (*  - Could not prove post-condition
; *)
;   forall (h0: FStar.Monotonic.Heap.heap)
;     (k: FStar.Pervasives.all_post_h FStar.Monotonic.Heap.heap FullReductionInterpreter.t).
...
;         {:pattern Prims.guard_free (k x h)}
;         Prims.auto_squash (k x h)) ==>
;     (~(BV? x) /\ ~(FV? x) /\ ~(App? x) /\ ~(Lam? x) ==> Prims.l_False) /\
;     (forall (b: FullReductionInterpreter.index).
;         x == FullReductionInterpreter.BV b ==>
;         (forall (k:
;             FStar.Pervasives.all_post_h FStar.Monotonic.Heap.heap FullReductionInterpreter.t).
;             (forall (x: FStar.Pervasives.result FullReductionInterpreter.t)
;                 (h: FStar.Monotonic.Heap.heap).
;                 {:pattern Prims.guard_free (k x h)}
;                 Prims.auto_squash (k x h)) ==>
;             ~(None? (FStar.List.Tot.Base.nth ctx b)) /\ ~(Some? (FStar.List.Tot.Base.nth ctx b)) ==>
;             Prims.l_False)
;         <:
;         Prims.GTot Type0) /\
;     (~(BV? x) ==>
;       ~(FV? x) ==>
;       (forall (b: FullReductionInterpreter.term) (b: FullReductionInterpreter.term).
;           x == FullReductionInterpreter.App b b ==>
;           (forall (a: FStar.Pervasives.result FullReductionInterpreter.t)
;               (h: FStar.Monotonic.Heap.heap).
;               (match a with
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec translate`
...
;; def=FStar.Pervasives.fsti(667,4-667,88); use=FullReductionInterpreter.fst(92,4-106,41)
(forall ((@x4 Term) (@x5 Term))
 (! 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=FullReductionInterpreter.fst(92,4-106,41)
(Valid 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=FullReductionInterpreter.fst(92,4-106,41)
(ApplyTT (ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=FullReductionInterpreter.fst(92,4-106,41)
(and (implies 
;; def=FullReductionInterpreter.fst(90,32-90,33); use=FullReductionInterpreter.fst(92,10-92,11)
(and 
;; def=FullReductionInterpreter.fst(90,32-90,33); use=FullReductionInterpreter.fst(92,10-92,11)
(not 
;; def=FullReductionInterpreter.fst(90,32-90,33); use=FullReductionInterpreter.fst(92,10-92,11)
...
;; def=FStar.Pervasives.fsti(681,7-681,32); use=FullReductionInterpreter.fst(92,4-106,41)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
FullReductionInterpreter.index)

;; def=FullReductionInterpreter.fst(90,32-93,10); use=FullReductionInterpreter.fst(92,10-93,10)
(= @x1
(FullReductionInterpreter.BV @x4))
)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Pervasives.all_post_h FStar.Monotonic.Heap.heap
...
;; def=FullReductionInterpreter.fst(95,12-95,23); use=FullReductionInterpreter.fst(95,12-95,23)
(not 
;; def=FullReductionInterpreter.fst(95,12-95,23); use=FullReductionInterpreter.fst(95,12-95,23)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None FullReductionInterpreter.t
(FStar.List.Tot.Base.nth FullReductionInterpreter.t
@x0
@x4)))
)
...
(not 
;; def=FullReductionInterpreter.fst(95,12-95,23); use=FullReductionInterpreter.fst(95,12-95,23)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some FullReductionInterpreter.t
(FStar.List.Tot.Base.nth FullReductionInterpreter.t
@x0
@x4)))
)
...
(implies 
;; def=FStar.Pervasives.fsti(661,26-661,50); use=FullReductionInterpreter.fst(92,4-106,41)
(and 
;; def=FStar.Pervasives.fsti(661,27-661,29); use=FullReductionInterpreter.fst(92,4-106,41)
(not 
;; def=FullReductionInterpreter.fst(90,32-90,33); use=FullReductionInterpreter.fst(92,10-92,11)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_BV @x1))
)
...
;; def=FullReductionInterpreter.fst(90,32-103,15); use=FullReductionInterpreter.fst(92,10-103,15)
(= @x1
(FullReductionInterpreter.App @x4
@x5))
)

;; def=FStar.All.fsti(37,59-37,94); use=FullReductionInterpreter.fst(104,18-104,27)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
(FStar.Pervasives.result FullReductionInterpreter.t))
(HasType @x7
FStar.Monotonic.Heap.heap))
(let ((@lb8 @x6))
(ite (is-FStar.Pervasives.V @lb8)

;; def=FStar.All.fsti(37,59-37,94); use=FullReductionInterpreter.fst(104,37-104,46)
...
FStar.Monotonic.Heap.heap))
(let ((@lb11 @x9))
(ite (is-FStar.Pervasives.V @lb11)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
(FStar.Pervasives.all_post_h FStar.Monotonic.Heap.heap
FullReductionInterpreter.t))

;; def=FStar.Pervasives.fsti(667,4-667,88); use=FullReductionInterpreter.fst(104,6-104,16)
(forall ((@x13 Term) (@x14 Term))
 (! 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=FullReductionInterpreter.fst(104,6-104,16)
(Valid 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=FullReductionInterpreter.fst(104,6-104,16)
(ApplyTT (ApplyTT @x12
@x13)
...
;; def=FullReductionInterpreter.fst(83,16-83,18); use=FullReductionInterpreter.fst(104,6-104,16)
(not 
;; def=FullReductionInterpreter.fst(83,16-83,18); use=FullReductionInterpreter.fst(104,6-104,16)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Fun (FStar.Pervasives.V_v @lb8)))
)
...
(not 
;; def=FullReductionInterpreter.fst(83,16-83,18); use=FullReductionInterpreter.fst(104,6-104,16)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Acc (FStar.Pervasives.V_v @lb8)))
)
)
label_3)
...
;;no pats
:qid @query.11))
(implies (and (not (is-FStar.Pervasives.E @lb11))
(not (is-FStar.Pervasives.Err @lb11)))
Unreachable))))
 
;;no pats
:qid @query.10))

(implies (and (not (is-FStar.Pervasives.E @lb8))
(not (is-FStar.Pervasives.Err @lb8)))
Unreachable))))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FullReductionInterpreter.translate, 1)
...
; encoding sigelt let rec translate


; <Start encoding let rec translate>
...
; </end encoding let rec translate>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FullReductionInterpreter.__proj__Acc__item___1; Namespace FullReductionInterpreter
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_c1dabe24910280b4a12783d0aa11a5ac)
(HasType (FullReductionInterpreter.__proj__Acc__item___1 @x0)
(Prims.list FullReductionInterpreter.t)))
 

:pattern ((FullReductionInterpreter.__proj__Acc__item___1 @x0))
:qid typing_FullReductionInterpreter.__proj__Acc__item___1))
:named typing_FullReductionInterpreter.__proj__Acc__item___1))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name FullReductionInterpreter.__proj__Acc__item___1; Namespace FullReductionInterpreter
(assert (! (forall ((@x0 Term))
 (! (= (FullReductionInterpreter.__proj__Acc__item___1 @x0)
(FullReductionInterpreter.Acc__1 @x0))
 

:pattern ((FullReductionInterpreter.__proj__Acc__item___1 @x0))
:qid proj_equation_FullReductionInterpreter.Acc__1))
:named proj_equation_FullReductionInterpreter.Acc__1))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Prims.uu___is_Nil; Namespace Prims
(assert (! 
;; def=Prims.fst(615,4-615,7); use=Prims.fst(615,4-615,7)
...
; Starting query at FullReductionInterpreter.fst(110,4-117,37)

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FullReductionInterpreter.readback (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FullReductionInterpreter.readback@tok () Term)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: FullReductionInterpreter.t).
;   (*  - Could not prove post-condition
; *)
;   forall (h0: FStar.Monotonic.Heap.heap)
;     (k: FStar.Pervasives.all_post_h FStar.Monotonic.Heap.heap FullReductionInterpreter.term).
;     (forall (x: FStar.Pervasives.result FullReductionInterpreter.term)
;         (h: FStar.Monotonic.Heap.heap).
;         {:pattern Prims.guard_free (k x h)}
;         Prims.auto_squash (k x h)) ==>
;     ~(Acc? x && Nil? x._1) /\ ~(Acc? x && Cons? x._1) /\ ~(Fun? x) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let rec readback`
...
;; def=FStar.Pervasives.fsti(667,4-667,88); use=FullReductionInterpreter.fst(110,4-117,37)
(forall ((@x3 Term) (@x4 Term))
 (! 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=FullReductionInterpreter.fst(110,4-117,37)
(Valid 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=FullReductionInterpreter.fst(110,4-117,37)
(ApplyTT (ApplyTT @x2
@x3)
...
;; def=FullReductionInterpreter.fst(108,18-111,9); use=FullReductionInterpreter.fst(110,10-111,9)
(not 
;; def=FullReductionInterpreter.fst(108,18-111,9); use=FullReductionInterpreter.fst(110,10-111,9)
(and (BoxBool_proj_0 (FullReductionInterpreter.uu___is_Acc @x0))
(BoxBool_proj_0 (Prims.uu___is_Nil FullReductionInterpreter.t
(FullReductionInterpreter.__proj__Acc__item___1 @x0))))
)


;; def=FullReductionInterpreter.fst(108,18-113,9); use=FullReductionInterpreter.fst(110,10-113,9)
(not 
;; def=FullReductionInterpreter.fst(108,18-113,9); use=FullReductionInterpreter.fst(110,10-113,9)
(and (BoxBool_proj_0 (FullReductionInterpreter.uu___is_Acc @x0))
(BoxBool_proj_0 (Prims.uu___is_Cons FullReductionInterpreter.t
(FullReductionInterpreter.__proj__Acc__item___1 @x0))))
)


;; def=FullReductionInterpreter.fst(108,18-108,19); use=FullReductionInterpreter.fst(110,10-110,11)
(not 
;; def=FullReductionInterpreter.fst(108,18-108,19); use=FullReductionInterpreter.fst(110,10-110,11)
(BoxBool_proj_0 (FullReductionInterpreter.uu___is_Fun @x0))
)
