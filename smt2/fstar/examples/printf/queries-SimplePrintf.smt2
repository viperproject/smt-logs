...
; Internals for SimplePrintf


; encoding sigelt type SimplePrintf.arg


; <Start encoding type SimplePrintf.arg>

;;;;;;;;;;;;;;;;Constructor
(declare-fun SimplePrintf.arg () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SimplePrintf.Bool () Term)
;;;;;;;;;;;;;;;;data constructor proxy: SimplePrintf.Bool
(declare-fun SimplePrintf.Bool@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SimplePrintf.Int () Term)
;;;;;;;;;;;;;;;;data constructor proxy: SimplePrintf.Int
(declare-fun SimplePrintf.Int@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SimplePrintf.Char () Term)
;;;;;;;;;;;;;;;;data constructor proxy: SimplePrintf.Char
(declare-fun SimplePrintf.Char@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SimplePrintf.String () Term)
;;;;;;;;;;;;;;;;data constructor proxy: SimplePrintf.String
(declare-fun SimplePrintf.String@tok () Term)

; <start constructor SimplePrintf.arg>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SimplePrintf.arg ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
130)
(= __@x0
SimplePrintf.arg)))

; </end constructor SimplePrintf.arg>


; <start constructor SimplePrintf.Bool>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SimplePrintf.Bool ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
136)
(= __@x0
SimplePrintf.Bool)))

; </end constructor SimplePrintf.Bool>


; <start constructor SimplePrintf.Int>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SimplePrintf.Int ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
138)
(= __@x0
SimplePrintf.Int)))

; </end constructor SimplePrintf.Int>


; <start constructor SimplePrintf.Char>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SimplePrintf.Char ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
140)
(= __@x0
SimplePrintf.Char)))

; </end constructor SimplePrintf.Char>


; <start constructor SimplePrintf.String>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SimplePrintf.String ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
142)
(= __@x0
SimplePrintf.String)))

; </end constructor SimplePrintf.String>


; </end encoding type SimplePrintf.arg>


; encoding sigelt assume SimplePrintf.arg__uu___haseq


; <Start encoding assume SimplePrintf.arg__uu___haseq>


; </end encoding assume SimplePrintf.arg__uu___haseq>


; encoding sigelt val SimplePrintf.uu___is_Bool


; <Start encoding val SimplePrintf.uu___is_Bool>

(declare-fun SimplePrintf.uu___is_Bool (Term) Term)
;;;;;;;;;;;;;;;;projectee: arg -> Prims.bool
(declare-fun Tm_arrow_9f9123cb0f85cc6705e0e1235671d24a () Term)
(declare-fun SimplePrintf.uu___is_Bool@tok () Term)

; </end encoding val SimplePrintf.uu___is_Bool>
...
; encoding sigelt val SimplePrintf.uu___is_Int


; <Start encoding val SimplePrintf.uu___is_Int>

(declare-fun SimplePrintf.uu___is_Int (Term) Term)

(declare-fun SimplePrintf.uu___is_Int@tok () Term)

; </end encoding val SimplePrintf.uu___is_Int>
...
; encoding sigelt val SimplePrintf.uu___is_Char


; <Start encoding val SimplePrintf.uu___is_Char>

(declare-fun SimplePrintf.uu___is_Char (Term) Term)

(declare-fun SimplePrintf.uu___is_Char@tok () Term)

; </end encoding val SimplePrintf.uu___is_Char>


; encoding sigelt let uu___is_Char


; <Skipped let uu___is_Char/>


; encoding sigelt val SimplePrintf.uu___is_String


; <Start encoding val SimplePrintf.uu___is_String>

(declare-fun SimplePrintf.uu___is_String (Term) Term)

(declare-fun SimplePrintf.uu___is_String@tok () Term)

; </end encoding val SimplePrintf.uu___is_String>


; encoding sigelt let uu___is_String


; <Skipped let uu___is_String/>
...
; encoding sigelt type SimplePrintf.dir


; <Start encoding type SimplePrintf.dir>

;;;;;;;;;;;;;;;;Constructor
(declare-fun SimplePrintf.dir () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SimplePrintf.Lit (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun SimplePrintf.Lit__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: SimplePrintf.Lit
(declare-fun SimplePrintf.Lit@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SimplePrintf.Arg (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun SimplePrintf.Arg__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: SimplePrintf.Arg
(declare-fun SimplePrintf.Arg@tok () Term)
;;;;;;;;;;;;;;;;_0: FStar.String.char -> dir
(declare-fun Tm_arrow_b293b7da552156cf6ce26ed62030ee0b () Term)
;;;;;;;;;;;;;;;;_0: arg -> dir
(declare-fun Tm_arrow_4d121eced7533fcbade80faede946a76 () Term)

; <start constructor SimplePrintf.dir>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SimplePrintf.dir ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
166)
(= __@x0
SimplePrintf.dir)))

; </end constructor SimplePrintf.dir>


; <start constructor SimplePrintf.Lit>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SimplePrintf.Lit ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
172)
(= __@x0
(SimplePrintf.Lit (SimplePrintf.Lit__0 __@x0)))))

; </end constructor SimplePrintf.Lit>
...
177)
(= __@x0
(SimplePrintf.Arg (SimplePrintf.Arg__0 __@x0)))))

; </end constructor SimplePrintf.Arg>


; </end encoding type SimplePrintf.dir>
...
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (HasType SimplePrintf.String@tok
SimplePrintf.arg)
:named typing_tok_SimplePrintf.String@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (HasType SimplePrintf.Int@tok
SimplePrintf.arg)
:named typing_tok_SimplePrintf.Int@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (HasType SimplePrintf.Char@tok
SimplePrintf.arg)
:named typing_tok_SimplePrintf.Char@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (HasType SimplePrintf.Bool@tok
SimplePrintf.arg)
:named typing_tok_SimplePrintf.Bool@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.String.char; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(36,5-36,9); use=FStar.String.fsti(36,5-36,9)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.String.char @u0)
Prims.eqtype)
 

:pattern ((FStar.String.char @u0))
:qid typing_FStar.String.char))

:named typing_FStar.String.char))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Char.char; Namespace FStar.Char
(assert (! 
;; def=FStar.Char.fsti(33,4-33,8); use=FStar.Char.fsti(33,4-33,8)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.Char.char @u0)
Prims.eqtype)
 

:pattern ((FStar.Char.char @u0))
:qid typing_FStar.Char.char))

:named typing_FStar.Char.char))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(30,4-30,7); use=SimplePrintf.fst(30,4-30,7)
...
(SimplePrintf.Lit @x1)
SimplePrintf.dir))
:qid subterm_ordering_SimplePrintf.Lit))

:named subterm_ordering_SimplePrintf.Lit))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(31,4-31,7); use=SimplePrintf.fst(31,4-31,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(SimplePrintf.Arg @x1)
SimplePrintf.dir)
...
(SimplePrintf.Arg @x1)
SimplePrintf.dir))
:qid subterm_ordering_SimplePrintf.Arg))

:named subterm_ordering_SimplePrintf.Arg))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=SimplePrintf.fst(30,4-30,7); use=SimplePrintf.fst(30,4-30,7)
(forall ((@x0 Term))
 (! (= (SimplePrintf.Lit__0 (SimplePrintf.Lit @x0))
@x0)
 

:pattern ((SimplePrintf.Lit @x0))
:qid projection_inverse_SimplePrintf.Lit__0))

:named projection_inverse_SimplePrintf.Lit__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(31,4-31,7); use=SimplePrintf.fst(31,4-31,7)
(forall ((@x0 Term))
 (! (= (SimplePrintf.Arg__0 (SimplePrintf.Arg @x0))
@x0)
 

:pattern ((SimplePrintf.Arg @x0))
:qid projection_inverse_SimplePrintf.Arg__0))

:named projection_inverse_SimplePrintf.Arg__0))
...
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! (HasType SimplePrintf.dir
Tm_type)
:named kinding_SimplePrintf.dir@tok))
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (HasType SimplePrintf.arg
Tm_type)
:named kinding_SimplePrintf.arg@tok))
...
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(29,5-29,8); use=SimplePrintf.fst(29,5-29,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
SimplePrintf.dir)
(or (is-SimplePrintf.Lit @x1)
(is-SimplePrintf.Arg @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
SimplePrintf.dir))
:qid fuel_guarded_inversion_SimplePrintf.dir))

:named fuel_guarded_inversion_SimplePrintf.dir))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(22,5-22,8); use=SimplePrintf.fst(22,5-22,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
SimplePrintf.arg)
(or (is-SimplePrintf.Bool @x1)
(is-SimplePrintf.Int @x1)
(is-SimplePrintf.Char @x1)
(is-SimplePrintf.String @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
SimplePrintf.arg))
:qid fuel_guarded_inversion_SimplePrintf.arg))

:named fuel_guarded_inversion_SimplePrintf.arg))
...
;;;;;;;;;;;;;;;;Equation for FStar.String.char
;;; Fact-ids: Name FStar.String.char; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(36,5-36,9); use=FStar.String.fsti(36,5-36,9)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=FStar.String.fsti(36,5-36,9); use=FStar.String.fsti(36,5-36,9)
(FStar.String.char @u0)

(FStar.Char.char Dummy_value))
...
:qid equation_FStar.String.char))

:named equation_FStar.String.char))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (= SimplePrintf.String@tok
SimplePrintf.String)
:named equality_tok_SimplePrintf.String@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (= SimplePrintf.Int@tok
SimplePrintf.Int)
:named equality_tok_SimplePrintf.Int@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (= SimplePrintf.Char@tok
SimplePrintf.Char)
:named equality_tok_SimplePrintf.Char@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (= SimplePrintf.Bool@tok
SimplePrintf.Bool)
:named equality_tok_SimplePrintf.Bool@tok))
...
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(26,4-26,10); use=SimplePrintf.fst(26,4-26,10)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
SimplePrintf.String
SimplePrintf.arg)
...
SimplePrintf.String
SimplePrintf.arg))
:qid data_typing_intro_SimplePrintf.String@tok))

:named data_typing_intro_SimplePrintf.String@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(30,4-30,7); use=SimplePrintf.fst(30,4-30,7)
...
(SimplePrintf.Lit @x1)
SimplePrintf.dir))
:qid data_typing_intro_SimplePrintf.Lit@tok))

:named data_typing_intro_SimplePrintf.Lit@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(24,4-24,7); use=SimplePrintf.fst(24,4-24,7)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
SimplePrintf.Int
SimplePrintf.arg)
...
SimplePrintf.Int
SimplePrintf.arg))
:qid data_typing_intro_SimplePrintf.Int@tok))

:named data_typing_intro_SimplePrintf.Int@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(25,4-25,8); use=SimplePrintf.fst(25,4-25,8)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
SimplePrintf.Char
SimplePrintf.arg)
...
SimplePrintf.Char
SimplePrintf.arg))
:qid data_typing_intro_SimplePrintf.Char@tok))

:named data_typing_intro_SimplePrintf.Char@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(23,4-23,8); use=SimplePrintf.fst(23,4-23,8)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
SimplePrintf.Bool
SimplePrintf.arg)
...
SimplePrintf.Bool
SimplePrintf.arg))
:qid data_typing_intro_SimplePrintf.Bool@tok))

:named data_typing_intro_SimplePrintf.Bool@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(31,4-31,7); use=SimplePrintf.fst(31,4-31,7)
...
(SimplePrintf.Arg @x1)
SimplePrintf.dir))
:qid data_typing_intro_SimplePrintf.Arg@tok))

:named data_typing_intro_SimplePrintf.Arg@tok))
...
(SimplePrintf.Lit @x1)
SimplePrintf.dir))
:qid data_elim_SimplePrintf.Lit))

:named data_elim_SimplePrintf.Lit))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(31,4-31,7); use=SimplePrintf.fst(31,4-31,7)
...
(SimplePrintf.Arg @x1)
SimplePrintf.dir))
:qid data_elim_SimplePrintf.Arg))

:named data_elim_SimplePrintf.Arg))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! (= 166
(Term_constr_id SimplePrintf.dir))
:named constructor_distinct_SimplePrintf.dir))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (= 130
(Term_constr_id SimplePrintf.arg))
:named constructor_distinct_SimplePrintf.arg))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (= 142
(Term_constr_id SimplePrintf.String))
:named constructor_distinct_SimplePrintf.String))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(30,4-30,7); use=SimplePrintf.fst(30,4-30,7)
(forall ((@x0 Term))
 (! (= 172
(Term_constr_id (SimplePrintf.Lit @x0)))
 

:pattern ((SimplePrintf.Lit @x0))
:qid constructor_distinct_SimplePrintf.Lit))

:named constructor_distinct_SimplePrintf.Lit))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (= 138
(Term_constr_id SimplePrintf.Int))
:named constructor_distinct_SimplePrintf.Int))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (= 140
(Term_constr_id SimplePrintf.Char))
:named constructor_distinct_SimplePrintf.Char))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! (= 136
(Term_constr_id SimplePrintf.Bool))
:named constructor_distinct_SimplePrintf.Bool))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(31,4-31,7); use=SimplePrintf.fst(31,4-31,7)
(forall ((@x0 Term))
 (! (= 177
(Term_constr_id (SimplePrintf.Arg @x0)))
 

:pattern ((SimplePrintf.Arg @x0))
:qid constructor_distinct_SimplePrintf.Arg))
...
(forall ((@u0 Dummy_sort))
 (! (= 101
(Term_constr_id (FStar.Char.char @u0)))
 

:pattern ((FStar.Char.char @u0))
:qid constructor_distinct_FStar.Char.char))

:named constructor_distinct_FStar.Char.char))
;;;;;;;;;;;;;;;;Assumption: SimplePrintf.arg__uu___haseq
;;; Fact-ids: Name SimplePrintf.arg__uu___haseq; Namespace SimplePrintf
(assert (! (Valid (Prims.hasEq SimplePrintf.arg))
:named assumption_SimplePrintf.arg__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name SimplePrintf.arg; Namespace SimplePrintf; Name SimplePrintf.Bool; Namespace SimplePrintf; Name SimplePrintf.Int; Namespace SimplePrintf; Name SimplePrintf.Char; Namespace SimplePrintf; Name SimplePrintf.String; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(22,5-22,8); use=SimplePrintf.fst(22,5-22,8)
...
@x0
SimplePrintf.arg))
:qid SimplePrintf_pretyping_cbadf840f86d51d8d76d853bba9f74c4))

:named SimplePrintf_pretyping_cbadf840f86d51d8d76d853bba9f74c4))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name SimplePrintf.dir; Namespace SimplePrintf; Name SimplePrintf.Lit; Namespace SimplePrintf; Name SimplePrintf.Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(29,5-29,8); use=SimplePrintf.fst(29,5-29,8)
...
@x0
SimplePrintf.dir))
:qid SimplePrintf_pretyping_55d9237c8bdacaf33b4e9964a930548e))

:named SimplePrintf_pretyping_55d9237c8bdacaf33b4e9964a930548e))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
(FStar.Char.char @u2)))
:qid FStar.Char_pretyping_dc6ef56115bc91878da75a1e0625bb73))

:named FStar.Char_pretyping_dc6ef56115bc91878da75a1e0625bb73))
(push) ;; push{4

; Starting query at SimplePrintf.fst(29,0-31,14)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq SimplePrintf.dir ==>
; (forall (_0: FStar.String.char).
...
; *)
;     Prims.hasEq FStar.String.char) /\
; (forall (_0: SimplePrintf.arg).
;     (*  - Failed to prove that the type
;     'SimplePrintf.dir'
;     supports decidable equality because of this argument.
;   - Add either the 'noeq' or 'unopteq' qualifier
; *)
;     Prims.hasEq SimplePrintf.arg)


; Context: While encoding a query
; While typechecking the top-level declaration `type SimplePrintf.dir`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=SimplePrintf.fst(29,0-31,14); use=SimplePrintf.fst(29,0-31,14)
(Valid 
;; def=SimplePrintf.fst(29,0-31,14); use=SimplePrintf.fst(29,0-31,14)
(Prims.hasEq SimplePrintf.dir)
)
...
;; def=SimplePrintf.fst(29,0-31,14); use=SimplePrintf.fst(30,11-30,15)
(or label_1

;; def=SimplePrintf.fst(29,0-31,14); use=SimplePrintf.fst(29,0-31,14)
(Valid 
;; def=SimplePrintf.fst(29,0-31,14); use=SimplePrintf.fst(29,0-31,14)
(Prims.hasEq (FStar.String.char Dummy_value))
)
)
)
...
;; def=SimplePrintf.fst(29,0-31,14); use=SimplePrintf.fst(31,11-31,14)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SimplePrintf.dir, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_SimplePrintf.arg__uu___haseq, equation_FStar.String.char, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.String.char
...
; encoding sigelt assume SimplePrintf.dir__uu___haseq


; <Start encoding assume SimplePrintf.dir__uu___haseq>


; </end encoding assume SimplePrintf.dir__uu___haseq>


; encoding sigelt val SimplePrintf.uu___is_Lit


; <Start encoding val SimplePrintf.uu___is_Lit>

(declare-fun SimplePrintf.uu___is_Lit (Term) Term)
;;;;;;;;;;;;;;;;projectee: dir -> Prims.bool
(declare-fun Tm_arrow_273ac9c0a9b38ebaec480fce62860495 () Term)
(declare-fun SimplePrintf.uu___is_Lit@tok () Term)

; </end encoding val SimplePrintf.uu___is_Lit>


; encoding sigelt let uu___is_Lit


; <Skipped let uu___is_Lit/>


; encoding sigelt val SimplePrintf.__proj__Lit__item___0


; <Start encoding val SimplePrintf.__proj__Lit__item___0>

(declare-fun Tm_refine_4c947cba4356c53de258d6a2aaf1bdcf () Term)
(declare-fun SimplePrintf.__proj__Lit__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: dir{Lit? _} -> FStar.String.char
(declare-fun Tm_arrow_edddd1225d05b5b4fa43fb0d14037fd1 () Term)
(declare-fun SimplePrintf.__proj__Lit__item___0@tok () Term)

; </end encoding val SimplePrintf.__proj__Lit__item___0>
...
:named typing_tok_SimplePrintf.Bool@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.uu___is_Lit; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(30,4-30,7); use=SimplePrintf.fst(30,4-30,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SimplePrintf.dir)
(HasType (SimplePrintf.uu___is_Lit @x0)
Prims.bool))
 

:pattern ((SimplePrintf.uu___is_Lit @x0))
:qid typing_SimplePrintf.uu___is_Lit))

:named typing_SimplePrintf.uu___is_Lit))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
:named refinement_kinding_Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name SimplePrintf.__proj__Lit__item___0; Namespace SimplePrintf
(assert (! (HasType Tm_refine_4c947cba4356c53de258d6a2aaf1bdcf
Tm_type)
:named refinement_kinding_Tm_refine_4c947cba4356c53de258d6a2aaf1bdcf))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! (HasType Tm_refine_414d0a9f578ab0048252f8c8f552b99f
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4c947cba4356c53de258d6a2aaf1bdcf)
(and (HasTypeFuel @u0
@x1
SimplePrintf.dir)

;; def=SimplePrintf.fst(30,4-30,7); use=SimplePrintf.fst(30,4-30,7)
(BoxBool_proj_0 (SimplePrintf.uu___is_Lit @x1))
))
...
@x1
Tm_refine_4c947cba4356c53de258d6a2aaf1bdcf))
:qid refinement_interpretation_Tm_refine_4c947cba4356c53de258d6a2aaf1bdcf))

:named refinement_interpretation_Tm_refine_4c947cba4356c53de258d6a2aaf1bdcf))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
;; def=Prims.fst(73,14-73,31); use=Prims.fst(73,14-73,31)
...
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_73f210ca6e0061ed4a3150f69b8f33bf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4c947cba4356c53de258d6a2aaf1bdcf
;;; Fact-ids: Name SimplePrintf.__proj__Lit__item___0; Namespace SimplePrintf
(assert (! (iff (Valid (Prims.hasEq Tm_refine_4c947cba4356c53de258d6a2aaf1bdcf))
(Valid (Prims.hasEq SimplePrintf.dir)))
:named haseqTm_refine_4c947cba4356c53de258d6a2aaf1bdcf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_414d0a9f578ab0048252f8c8f552b99f
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_414d0a9f578ab0048252f8c8f552b99f))
(Valid (Prims.hasEq Tm_type)))
...
;; def=SimplePrintf.fst(30,4-30,7); use=SimplePrintf.fst(30,4-30,7)
(forall ((@x0 Term))
 (! (= (SimplePrintf.uu___is_Lit @x0)
(BoxBool (is-SimplePrintf.Lit @x0)))
 

:pattern ((SimplePrintf.uu___is_Lit @x0))
:qid disc_equation_SimplePrintf.Lit))

:named disc_equation_SimplePrintf.Lit))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: SimplePrintf.dir__uu___haseq
;;; Fact-ids: Name SimplePrintf.dir__uu___haseq; Namespace SimplePrintf
(assert (! (Valid (Prims.hasEq SimplePrintf.dir))
:named assumption_SimplePrintf.dir__uu___haseq))
;;;;;;;;;;;;;;;;Assumption: SimplePrintf.arg__uu___haseq
;;; Fact-ids: Name SimplePrintf.arg__uu___haseq; Namespace SimplePrintf
(assert (! (Valid (Prims.hasEq SimplePrintf.arg))
:named assumption_SimplePrintf.arg__uu___haseq))
...
; Encoding query formula : forall (projectee: _: SimplePrintf.dir{Lit? _}).
;   (*  - Could not prove post-condition
; *) ~(Lit? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Lit__item___0`
...
(not 
;; def=SimplePrintf.fst(30,4-30,7); use=SimplePrintf.fst(30,4-30,7)
(BoxBool_proj_0 (SimplePrintf.uu___is_Lit @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SimplePrintf.__proj__Lit__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_4c947cba4356c53de258d6a2aaf1bdcf
...
; encoding sigelt let __proj__Lit__item___0


; <Skipped let __proj__Lit__item___0/>


; encoding sigelt val SimplePrintf.uu___is_Arg


; <Start encoding val SimplePrintf.uu___is_Arg>

(declare-fun SimplePrintf.uu___is_Arg (Term) Term)

(declare-fun SimplePrintf.uu___is_Arg@tok () Term)

; </end encoding val SimplePrintf.uu___is_Arg>


; encoding sigelt let uu___is_Arg


; <Skipped let uu___is_Arg/>


; encoding sigelt val SimplePrintf.__proj__Arg__item___0


; <Start encoding val SimplePrintf.__proj__Arg__item___0>

(declare-fun Tm_refine_18496ceb9c66ce4705128a993a338a20 () Term)
(declare-fun SimplePrintf.__proj__Arg__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: dir{Arg? _} -> arg
(declare-fun Tm_arrow_fa96f57cdf26e020ec9da73d6b5569c9 () Term)
(declare-fun SimplePrintf.__proj__Arg__item___0@tok () Term)

; </end encoding val SimplePrintf.__proj__Arg__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.uu___is_Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(31,4-31,7); use=SimplePrintf.fst(31,4-31,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SimplePrintf.dir)
(HasType (SimplePrintf.uu___is_Arg @x0)
Prims.bool))
 

:pattern ((SimplePrintf.uu___is_Arg @x0))
:qid typing_SimplePrintf.uu___is_Arg))

:named typing_SimplePrintf.uu___is_Arg))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name SimplePrintf.__proj__Arg__item___0; Namespace SimplePrintf
(assert (! (HasType Tm_refine_18496ceb9c66ce4705128a993a338a20
Tm_type)
:named refinement_kinding_Tm_refine_18496ceb9c66ce4705128a993a338a20))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name SimplePrintf.__proj__Arg__item___0; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(31,4-31,7); use=SimplePrintf.fst(31,4-31,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_18496ceb9c66ce4705128a993a338a20)
(and (HasTypeFuel @u0
@x1
SimplePrintf.dir)

;; def=SimplePrintf.fst(31,4-31,7); use=SimplePrintf.fst(31,4-31,7)
(BoxBool_proj_0 (SimplePrintf.uu___is_Arg @x1))
))
...
@x1
Tm_refine_18496ceb9c66ce4705128a993a338a20))
:qid refinement_interpretation_Tm_refine_18496ceb9c66ce4705128a993a338a20))

:named refinement_interpretation_Tm_refine_18496ceb9c66ce4705128a993a338a20))
;;;;;;;;;;;;;;;;haseq for Tm_refine_18496ceb9c66ce4705128a993a338a20
;;; Fact-ids: Name SimplePrintf.__proj__Arg__item___0; Namespace SimplePrintf
(assert (! (iff (Valid (Prims.hasEq Tm_refine_18496ceb9c66ce4705128a993a338a20))
(Valid (Prims.hasEq SimplePrintf.dir)))
:named haseqTm_refine_18496ceb9c66ce4705128a993a338a20))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name SimplePrintf.uu___is_Arg; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(31,4-31,7); use=SimplePrintf.fst(31,4-31,7)
(forall ((@x0 Term))
 (! (= (SimplePrintf.uu___is_Arg @x0)
(BoxBool (is-SimplePrintf.Arg @x0)))
 

:pattern ((SimplePrintf.uu___is_Arg @x0))
:qid disc_equation_SimplePrintf.Arg))

:named disc_equation_SimplePrintf.Arg))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: SimplePrintf.dir{Arg? _}).
;   (*  - Could not prove post-condition
; *) ~(Arg? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Arg__item___0`
...
(not 
;; def=SimplePrintf.fst(31,4-31,7); use=SimplePrintf.fst(31,4-31,7)
(BoxBool_proj_0 (SimplePrintf.uu___is_Arg @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SimplePrintf.__proj__Arg__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_18496ceb9c66ce4705128a993a338a20
...
; encoding sigelt let __proj__Arg__item___0


; <Skipped let __proj__Arg__item___0/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.uu___is_String; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(26,4-26,10); use=SimplePrintf.fst(26,4-26,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SimplePrintf.arg)
(HasType (SimplePrintf.uu___is_String @x0)
Prims.bool))
 

:pattern ((SimplePrintf.uu___is_String @x0))
:qid typing_SimplePrintf.uu___is_String))

:named typing_SimplePrintf.uu___is_String))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.uu___is_Int; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(24,4-24,7); use=SimplePrintf.fst(24,4-24,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SimplePrintf.arg)
(HasType (SimplePrintf.uu___is_Int @x0)
Prims.bool))
 

:pattern ((SimplePrintf.uu___is_Int @x0))
:qid typing_SimplePrintf.uu___is_Int))

:named typing_SimplePrintf.uu___is_Int))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.uu___is_Char; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(25,4-25,8); use=SimplePrintf.fst(25,4-25,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SimplePrintf.arg)
(HasType (SimplePrintf.uu___is_Char @x0)
Prims.bool))
 

:pattern ((SimplePrintf.uu___is_Char @x0))
:qid typing_SimplePrintf.uu___is_Char))

:named typing_SimplePrintf.uu___is_Char))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.uu___is_Bool; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(23,4-23,8); use=SimplePrintf.fst(23,4-23,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SimplePrintf.arg)
(HasType (SimplePrintf.uu___is_Bool @x0)
Prims.bool))
 

:pattern ((SimplePrintf.uu___is_Bool @x0))
:qid typing_SimplePrintf.uu___is_Bool))

:named typing_SimplePrintf.uu___is_Bool))
;;;;;;;;;;;;;;;;free var typing
...
;; def=SimplePrintf.fst(26,4-26,10); use=SimplePrintf.fst(26,4-26,10)
(forall ((@x0 Term))
 (! (= (SimplePrintf.uu___is_String @x0)
(BoxBool (is-SimplePrintf.String @x0)))
 

:pattern ((SimplePrintf.uu___is_String @x0))
:qid disc_equation_SimplePrintf.String))

:named disc_equation_SimplePrintf.String))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name SimplePrintf.uu___is_Int; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(24,4-24,7); use=SimplePrintf.fst(24,4-24,7)
(forall ((@x0 Term))
 (! (= (SimplePrintf.uu___is_Int @x0)
(BoxBool (is-SimplePrintf.Int @x0)))
 

:pattern ((SimplePrintf.uu___is_Int @x0))
:qid disc_equation_SimplePrintf.Int))

:named disc_equation_SimplePrintf.Int))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name SimplePrintf.uu___is_Char; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(25,4-25,8); use=SimplePrintf.fst(25,4-25,8)
(forall ((@x0 Term))
 (! (= (SimplePrintf.uu___is_Char @x0)
(BoxBool (is-SimplePrintf.Char @x0)))
 

:pattern ((SimplePrintf.uu___is_Char @x0))
:qid disc_equation_SimplePrintf.Char))

:named disc_equation_SimplePrintf.Char))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name SimplePrintf.uu___is_Bool; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(23,4-23,8); use=SimplePrintf.fst(23,4-23,8)
(forall ((@x0 Term))
 (! (= (SimplePrintf.uu___is_Bool @x0)
(BoxBool (is-SimplePrintf.Bool @x0)))
 

:pattern ((SimplePrintf.uu___is_Bool @x0))
:qid disc_equation_SimplePrintf.Bool))

:named disc_equation_SimplePrintf.Bool))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
; Starting query at SimplePrintf.fst(34,2-38,20)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: SimplePrintf.arg).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Type0).
;     (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(Bool? a) /\ ~(Int? a) /\ ~(Char? a) /\ ~(String? a) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let arg_type`
...
;; def=Prims.fst(402,27-402,88); use=SimplePrintf.fst(34,2-38,20)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(34,2-38,20)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(34,2-38,20)
(ApplyTT @x1
@x2)
...
;; def=SimplePrintf.fst(33,14-33,15); use=SimplePrintf.fst(34,8-34,9)
(not 
;; def=SimplePrintf.fst(33,14-33,15); use=SimplePrintf.fst(34,8-34,9)
(BoxBool_proj_0 (SimplePrintf.uu___is_Bool @x0))
)
...
(not 
;; def=SimplePrintf.fst(33,14-33,15); use=SimplePrintf.fst(34,8-34,9)
(BoxBool_proj_0 (SimplePrintf.uu___is_Int @x0))
)
...
(not 
;; def=SimplePrintf.fst(33,14-33,15); use=SimplePrintf.fst(34,8-34,9)
(BoxBool_proj_0 (SimplePrintf.uu___is_Char @x0))
)
...
(not 
;; def=SimplePrintf.fst(33,14-33,15); use=SimplePrintf.fst(34,8-34,9)
(BoxBool_proj_0 (SimplePrintf.uu___is_String @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SimplePrintf.arg_type, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_SimplePrintf.Bool, disc_equation_SimplePrintf.Char, disc_equation_SimplePrintf.Int, disc_equation_SimplePrintf.String, fuel_guarded_inversion_SimplePrintf.arg, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let arg_type


; <Start encoding let arg_type>

(declare-fun SimplePrintf.arg_type (Term) Term)
;;;;;;;;;;;;;;;;a: arg -> Type
(declare-fun Tm_arrow_020785339877f0f78544a6e8067956db () Term)
(declare-fun SimplePrintf.arg_type@tok () Term)

; </end encoding let arg_type>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.arg_type; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(33,4-33,12); use=SimplePrintf.fst(33,4-33,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SimplePrintf.arg)
(HasType (SimplePrintf.arg_type @x0)
Tm_type))
 

:pattern ((SimplePrintf.arg_type @x0))
:qid typing_SimplePrintf.arg_type))

:named typing_SimplePrintf.arg_type))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Equation for SimplePrintf.arg_type
;;; Fact-ids: Name SimplePrintf.arg_type; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(33,4-33,12); use=SimplePrintf.fst(33,4-33,12)
(forall ((@x0 Term))
 (! (= (SimplePrintf.arg_type @x0)
(let ((@lb1 @x0))
(ite (is-SimplePrintf.Bool @lb1)
Prims.bool
(ite (is-SimplePrintf.Int @lb1)
Prims.int
(ite (is-SimplePrintf.Char @lb1)
(FStar.String.char Dummy_value)
(ite (is-SimplePrintf.String @lb1)
Prims.string
Tm_unit))))))
 

:pattern ((SimplePrintf.arg_type @x0))
:qid equation_SimplePrintf.arg_type))

:named equation_SimplePrintf.arg_type))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Prims.uu___is_Nil; Namespace Prims
(assert (! 
;; def=Prims.fst(615,4-615,7); use=Prims.fst(615,4-615,7)
...
; Starting query at SimplePrintf.fst(41,2-44,52)

;;;;;;;;;;;;;;;;ds : Prims.list SimplePrintf.dir (Prims.list SimplePrintf.dir)
(declare-fun x_513418ee1a9bd16c03f003addbbcba09_0 () Term)
;;;;;;;;;;;;;;;;binder_x_513418ee1a9bd16c03f003addbbcba09_0
;;; Fact-ids: 
(assert (! (HasType x_513418ee1a9bd16c03f003addbbcba09_0
(Prims.list SimplePrintf.dir))
:named binder_x_513418ee1a9bd16c03f003addbbcba09_0))
(declare-fun Tm_refine_619117f169dd835608666256e662cb22 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_619117f169dd835608666256e662cb22
Tm_type)
:named refinement_kinding_Tm_refine_619117f169dd835608666256e662cb22))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(40,18-44,52); use=SimplePrintf.fst(40,18-44,52)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_619117f169dd835608666256e662cb22)
(and (HasTypeFuel @u0
@x1
(Prims.list SimplePrintf.dir))

;; def=SimplePrintf.fst(41,2-44,52); use=SimplePrintf.fst(41,2-44,52)

;; def=SimplePrintf.fst(41,2-44,52); use=SimplePrintf.fst(41,2-44,52)
(Valid 
;; def=SimplePrintf.fst(41,2-44,52); use=SimplePrintf.fst(41,2-44,52)
(Prims.precedes (Prims.list SimplePrintf.dir)
(Prims.list SimplePrintf.dir)
@x1
x_513418ee1a9bd16c03f003addbbcba09_0)
)
...
@x1
Tm_refine_619117f169dd835608666256e662cb22))
:qid refinement_interpretation_Tm_refine_619117f169dd835608666256e662cb22))

:named refinement_interpretation_Tm_refine_619117f169dd835608666256e662cb22))
;;;;;;;;;;;;;;;;haseq for Tm_refine_619117f169dd835608666256e662cb22
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_619117f169dd835608666256e662cb22))
(Valid (Prims.hasEq (Prims.list SimplePrintf.dir))))
:named haseqTm_refine_619117f169dd835608666256e662cb22))
(declare-fun SimplePrintf.dir_type (Term) Term)

;;;;;;;;;;;;;;;;ds: Prims.list dir {ds << ds} -> Type
(declare-fun Tm_arrow_957c390f8e383f0c146b9b122739dcc4 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_957c390f8e383f0c146b9b122739dcc4
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_957c390f8e383f0c146b9b122739dcc4
Tm_type)
:named kinding_Tm_arrow_957c390f8e383f0c146b9b122739dcc4))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(40,18-44,52); use=SimplePrintf.fst(40,18-44,52)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_957c390f8e383f0c146b9b122739dcc4)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_957c390f8e383f0c146b9b122739dcc4))
:qid SimplePrintf_pre_typing_Tm_arrow_957c390f8e383f0c146b9b122739dcc4))

:named SimplePrintf_pre_typing_Tm_arrow_957c390f8e383f0c146b9b122739dcc4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_957c390f8e383f0c146b9b122739dcc4
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(40,18-44,52); use=SimplePrintf.fst(40,18-44,52)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid SimplePrintf_interpretation_Tm_arrow_957c390f8e383f0c146b9b122739dcc4.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_957c390f8e383f0c146b9b122739dcc4))
:qid SimplePrintf_interpretation_Tm_arrow_957c390f8e383f0c146b9b122739dcc4))

:named SimplePrintf_interpretation_Tm_arrow_957c390f8e383f0c146b9b122739dcc4))
(declare-fun SimplePrintf.dir_type@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(40,8-40,16); use=SimplePrintf.fst(40,8-40,16)
(forall ((@x0 Term))
 (! (= (ApplyTT SimplePrintf.dir_type@tok
@x0)
(SimplePrintf.dir_type @x0))
 

:pattern ((ApplyTT SimplePrintf.dir_type@tok
@x0))
:qid token_correspondence_SimplePrintf.dir_type))

:named token_correspondence_SimplePrintf.dir_type))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(40,8-40,16); use=SimplePrintf.fst(40,8-40,16)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType SimplePrintf.dir_type@tok
Tm_arrow_957c390f8e383f0c146b9b122739dcc4))
...
(forall ((@x1 Term))
 (! (= (ApplyTT SimplePrintf.dir_type@tok
@x1)
(SimplePrintf.dir_type @x1))
 

:pattern ((SimplePrintf.dir_type @x1))
:qid function_token_typing_SimplePrintf.dir_type.1))
)
 

:pattern ((ApplyTT @x0
SimplePrintf.dir_type@tok))
:qid function_token_typing_SimplePrintf.dir_type))

:named function_token_typing_SimplePrintf.dir_type))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(40,8-40,16); use=SimplePrintf.fst(40,8-40,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_619117f169dd835608666256e662cb22)
(HasType (SimplePrintf.dir_type @x0)
Tm_type))
 

:pattern ((SimplePrintf.dir_type @x0))
:qid typing_SimplePrintf.dir_type))

:named typing_SimplePrintf.dir_type))
...
;   (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Nil? ds) /\ ~(Cons? ds && Lit? ds.hd) /\ ~(Cons? ds && Arg? ds.hd) ==> Prims.l_False) /\
;   (~(Nil? ds) ==>
;     (forall (b: FStar.String.char) (b: Prims.list SimplePrintf.dir).
;         ds == SimplePrintf.Lit b :: b ==> b << ds) /\
;     (~(Cons? ds && Lit? ds.hd) ==>
;       (forall (b: SimplePrintf.arg) (b: Prims.list SimplePrintf.dir).
;           ds == SimplePrintf.Arg b :: b ==>
;           (forall (_: SimplePrintf.arg_type b).
;               (*  - Subtyping check failed
;   - Expected type ds: Prims.list dir {ds << ds} got type Prims.list dir
; *)
;               b << ds))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec dir_type`
...
;; def=Prims.fst(402,27-402,88); use=SimplePrintf.fst(41,2-44,52)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(41,2-44,52)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(41,2-44,52)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=SimplePrintf.fst(41,2-44,52)
(and (implies 
;; def=SimplePrintf.fst(40,18-44,52); use=SimplePrintf.fst(41,2-44,52)
(and 
;; def=SimplePrintf.fst(40,18-40,20); use=SimplePrintf.fst(41,8-41,10)
(not 
;; def=SimplePrintf.fst(40,18-40,20); use=SimplePrintf.fst(41,8-41,10)
(BoxBool_proj_0 (Prims.uu___is_Nil SimplePrintf.dir
x_513418ee1a9bd16c03f003addbbcba09_0))
)
...
(not 
;; def=SimplePrintf.fst(41,2-44,52); use=SimplePrintf.fst(41,2-44,52)
(and (BoxBool_proj_0 (Prims.uu___is_Cons SimplePrintf.dir
x_513418ee1a9bd16c03f003addbbcba09_0))
(BoxBool_proj_0 (SimplePrintf.uu___is_Lit (Prims.__proj__Cons__item__hd SimplePrintf.dir
x_513418ee1a9bd16c03f003addbbcba09_0))))
)
...
(and (BoxBool_proj_0 (Prims.uu___is_Cons SimplePrintf.dir
x_513418ee1a9bd16c03f003addbbcba09_0))
(BoxBool_proj_0 (SimplePrintf.uu___is_Arg (Prims.__proj__Cons__item__hd SimplePrintf.dir
x_513418ee1a9bd16c03f003addbbcba09_0))))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=SimplePrintf.fst(41,2-44,52)
(not 
;; def=SimplePrintf.fst(40,18-40,20); use=SimplePrintf.fst(41,8-41,10)
(BoxBool_proj_0 (Prims.uu___is_Nil SimplePrintf.dir
x_513418ee1a9bd16c03f003addbbcba09_0))
...
;; def=Prims.fst(389,2-389,39); use=SimplePrintf.fst(41,2-44,52)
(and 
;; def=Prims.fst(413,99-413,120); use=SimplePrintf.fst(41,2-44,52)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.String.char Dummy_value))
...
;; def=SimplePrintf.fst(40,18-43,16); use=SimplePrintf.fst(41,8-43,16)
(= x_513418ee1a9bd16c03f003addbbcba09_0
(Prims.Cons SimplePrintf.dir
(SimplePrintf.Lit @x1)
@x2))
)

;; def=SimplePrintf.fst(41,2-44,52); use=SimplePrintf.fst(43,29-43,32)
(or label_2
...
;; def=SimplePrintf.fst(40,18-44,16); use=SimplePrintf.fst(41,8-44,16)
(= x_513418ee1a9bd16c03f003addbbcba09_0
(Prims.Cons SimplePrintf.dir
(SimplePrintf.Arg @x1)
@x2))
...
;; def=dummy(0,0-0,0); use=SimplePrintf.fst(41,2-44,52)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(SimplePrintf.arg_type @x1))

;; def=SimplePrintf.fst(41,2-44,52); use=SimplePrintf.fst(44,48-44,51)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SimplePrintf.dir_type, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_513418ee1a9bd16c03f003addbbcba09_0, data_elim_Prims.Cons, disc_equation_Prims.Cons, disc_equation_Prims.Nil, disc_equation_SimplePrintf.Arg, disc_equation_SimplePrintf.Lit, fuel_guarded_inversion_Prims.list, fuel_guarded_inversion_SimplePrintf.dir, proj_equation_Prims.Cons_hd, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
; encoding sigelt let rec dir_type


; <Start encoding let rec dir_type>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun SimplePrintf.dir_type.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun SimplePrintf.dir_type.fuel_instrumented_token () Term)
(declare-fun SimplePrintf.dir_type (Term) Term)
(declare-fun SimplePrintf.dir_type@tok () Term)
;;;;;;;;;;;;;;;;_: arg_type a -> dir_type ds'
(declare-fun Tm_arrow_04517b06830101b5b49a227952fd3ff1 (Fuel Term) Term)
;;;;;;;;;;;;;;;;ds: Prims.list dir -> Type
(declare-fun Tm_arrow_cc6b76e36970474b5e92100e27c25e0f () Term)

; </end encoding let rec dir_type>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.dir_type; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(40,8-40,16); use=SimplePrintf.fst(40,8-40,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.String.strlen; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(51,4-51,10); use=FStar.String.fsti(51,4-51,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.string)
(HasType (FStar.String.strlen @x0)
Prims.nat))
 

:pattern ((FStar.String.strlen @x0))
:qid typing_FStar.String.strlen))

:named typing_FStar.String.strlen))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.String.string_of_char; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(70,4-70,18); use=FStar.String.fsti(70,4-70,18)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.String.char Dummy_value))
(HasType (FStar.String.string_of_char @x0)
Prims.string))
 

:pattern ((FStar.String.string_of_char @x0))
:qid typing_FStar.String.string_of_char))

:named typing_FStar.String.string_of_char))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.String.make; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(67,4-67,8); use=FStar.String.fsti(67,4-67,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
(FStar.String.char Dummy_value)))
(HasType (FStar.String.make @x0
@x1)
(Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669 @x0)))
 

:pattern ((FStar.String.make @x0
@x1))
:qid typing_FStar.String.make))

:named typing_FStar.String.make))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.String.list_of_string; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(40,4-40,18); use=FStar.String.fsti(40,4-40,18)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.string)
(HasType (FStar.String.list_of_string @x0)
(Prims.list (FStar.String.char Dummy_value))))
 

:pattern ((FStar.String.list_of_string @x0))
:qid typing_FStar.String.list_of_string))

:named typing_FStar.String.list_of_string))
;;;;;;;;;;;;;;;;free var typing
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
(Prims.list SimplePrintf.dir))
(HasType (SimplePrintf.dir_type.fuel_instrumented @u0
@x1)
Tm_type))
 

:pattern ((SimplePrintf.dir_type.fuel_instrumented @u0
@x1))
:qid token_correspondence_SimplePrintf.dir_type.fuel_instrumented))

:named token_correspondence_SimplePrintf.dir_type.fuel_instrumented))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name FStar.List.Tot.Base.length; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(74,8-74,14); use=FStar.List.Tot.Base.fst(74,8-74,14)
...
;;; Fact-ids: Name FStar.String.make; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(67,31-67,56); use=FStar.String.fsti(67,31-67,56)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669))

:named refinement_kinding_Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669 @x2))
(and (HasTypeFuel @u0
@x1
Prims.string)

;; def=FStar.String.fsti(67,42-67,54); use=FStar.String.fsti(67,42-67,54)
(= (FStar.String.strlen @x1)
@x2)
))
...
@x1
(Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669 @x2)))
:qid refinement_interpretation_Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669))

:named refinement_interpretation_Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Char.char_of_int; Namespace FStar.Char
(assert (! 
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_70affe4dada4ca8ba18740c614ba5211
;;; Fact-ids: Name FStar.String.lowercase; Namespace FStar.String
(assert (! (HasType Tm_arrow_70affe4dada4ca8ba18740c614ba5211
Tm_type)
:named kinding_Tm_arrow_70affe4dada4ca8ba18740c614ba5211))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_04517b06830101b5b49a227952fd3ff1
;;; Fact-ids: Name SimplePrintf.dir_type; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(44,20-44,52); use=SimplePrintf.fst(44,20-44,52)
(forall ((@u0 Fuel) (@x1 Term))
 (! (HasType (Tm_arrow_04517b06830101b5b49a227952fd3ff1 @u0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_04517b06830101b5b49a227952fd3ff1 @u0
@x1)
Tm_type))
:qid kinding_Tm_arrow_04517b06830101b5b49a227952fd3ff1))

:named kinding_Tm_arrow_04517b06830101b5b49a227952fd3ff1))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669
;;; Fact-ids: Name FStar.String.make; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(67,31-67,56); use=FStar.String.fsti(67,31-67,56)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669 @x0)))
(Valid (Prims.hasEq Prims.string)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669 @x0))))
:qid haseqTm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669))

:named haseqTm_refine_5bd57a2b9b9fc8ea75ce9775c54c0669))
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: SimplePrintf.dir_type
;;; Fact-ids: Name SimplePrintf.dir_type; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(40,8-40,16); use=SimplePrintf.fst(40,8-40,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
(Prims.list SimplePrintf.dir))
(= (SimplePrintf.dir_type.fuel_instrumented (SFuel @u0)
@x1)
(let ((@lb2 @x1))
(ite (is-Prims.Nil @lb2)
Prims.string
(ite (and (is-Prims.Cons @lb2)
(is-SimplePrintf.Lit (Prims.Cons_hd @lb2)))
(SimplePrintf.dir_type.fuel_instrumented @u0
(Prims.Cons_tl @lb2))
(ite (and (is-Prims.Cons @lb2)
(is-SimplePrintf.Arg (Prims.Cons_hd @lb2)))
(Tm_arrow_04517b06830101b5b49a227952fd3ff1 @u0
@lb2)
Tm_unit))))))
 :weight 0


:pattern ((SimplePrintf.dir_type.fuel_instrumented (SFuel @u0)
@x1))
:qid equation_with_fuel_SimplePrintf.dir_type.fuel_instrumented))

:named equation_with_fuel_SimplePrintf.dir_type.fuel_instrumented))
...
;;;;;;;;;;;;;;;;Equation for FStar.String.strlen
;;; Fact-ids: Name FStar.String.strlen; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(51,4-51,10); use=FStar.String.fsti(51,4-51,10)
(forall ((@x0 Term))
 (! (= (FStar.String.strlen @x0)
(FStar.List.Tot.Base.length (FStar.String.char Dummy_value)
(FStar.String.list_of_string @x0)))
 

:pattern ((FStar.String.strlen @x0))
:qid equation_FStar.String.strlen))

:named equation_FStar.String.strlen))
;;;;;;;;;;;;;;;;Equation for FStar.String.string_of_char
;;; Fact-ids: Name FStar.String.string_of_char; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(70,4-70,18); use=FStar.String.fsti(70,4-70,18)
(forall ((@x0 Term))
 (! (= (FStar.String.string_of_char @x0)
(FStar.String.make (BoxInt 1)
@x0))
 

:pattern ((FStar.String.string_of_char @x0))
:qid equation_FStar.String.string_of_char))

:named equation_FStar.String.string_of_char))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name SimplePrintf.dir_type; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(44,20-44,52); use=SimplePrintf.fst(44,20-44,52)
(forall ((@u0 Fuel) (@x1 Term) (@u2 Fuel) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_04517b06830101b5b49a227952fd3ff1 @u2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_04517b06830101b5b49a227952fd3ff1 @u2
@x3)))
:qid SimplePrintf_pre_typing_Tm_arrow_04517b06830101b5b49a227952fd3ff1))

:named SimplePrintf_pre_typing_Tm_arrow_04517b06830101b5b49a227952fd3ff1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_04517b06830101b5b49a227952fd3ff1
;;; Fact-ids: Name SimplePrintf.dir_type; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(44,20-44,52); use=SimplePrintf.fst(44,20-44,52)
(forall ((@x0 Term) (@u1 Fuel) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_04517b06830101b5b49a227952fd3ff1 @u1
@x2))
(and 
;; def=SimplePrintf.fst(44,20-44,52); use=SimplePrintf.fst(44,20-44,52)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(SimplePrintf.arg_type (SimplePrintf.Arg__0 (Prims.Cons_hd @x2))))
(HasType (ApplyTT @x0
@x3)
(SimplePrintf.dir_type.fuel_instrumented @u1
(Prims.Cons_tl @x2))))
 

:pattern ((ApplyTT @x0
@x3))
:qid SimplePrintf_interpretation_Tm_arrow_04517b06830101b5b49a227952fd3ff1.1))
...
(Tm_arrow_04517b06830101b5b49a227952fd3ff1 @u1
@x2)))
:qid SimplePrintf_interpretation_Tm_arrow_04517b06830101b5b49a227952fd3ff1))

:named SimplePrintf_interpretation_Tm_arrow_04517b06830101b5b49a227952fd3ff1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.String.lowercase; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(82,16-82,36); use=FStar.String.fsti(82,16-82,36)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_70affe4dada4ca8ba18740c614ba5211)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_70affe4dada4ca8ba18740c614ba5211))
:qid FStar.String_pre_typing_Tm_arrow_70affe4dada4ca8ba18740c614ba5211))

:named FStar.String_pre_typing_Tm_arrow_70affe4dada4ca8ba18740c614ba5211))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_70affe4dada4ca8ba18740c614ba5211
;;; Fact-ids: Name FStar.String.lowercase; Namespace FStar.String
(assert (! 
;; def=FStar.String.fsti(82,16-82,36); use=FStar.String.fsti(82,16-82,36)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.String_interpretation_Tm_arrow_70affe4dada4ca8ba18740c614ba5211.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_70affe4dada4ca8ba18740c614ba5211))
:qid FStar.String_interpretation_Tm_arrow_70affe4dada4ca8ba18740c614ba5211))

:named FStar.String_interpretation_Tm_arrow_70affe4dada4ca8ba18740c614ba5211))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name SimplePrintf.dir_type; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(40,8-40,16); use=SimplePrintf.fst(40,8-40,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (= (SimplePrintf.dir_type.fuel_instrumented (SFuel @u0)
@x1)
(SimplePrintf.dir_type.fuel_instrumented ZFuel
@x1))
 

:pattern ((SimplePrintf.dir_type.fuel_instrumented (SFuel @u0)
@x1))
:qid @fuel_irrelevance_SimplePrintf.dir_type.fuel_instrumented))

:named @fuel_irrelevance_SimplePrintf.dir_type.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name FStar.List.Tot.Base.length; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(74,8-74,14); use=FStar.List.Tot.Base.fst(74,8-74,14)
...
(forall ((@x0 Term))
 (! (= (SimplePrintf.dir_type @x0)
(SimplePrintf.dir_type.fuel_instrumented MaxFuel
@x0))
 

:pattern ((SimplePrintf.dir_type @x0))
:qid @fuel_correspondence_SimplePrintf.dir_type.fuel_instrumented))

:named @fuel_correspondence_SimplePrintf.dir_type.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name FStar.List.Tot.Base.length; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(74,8-74,14); use=FStar.List.Tot.Base.fst(74,8-74,14)
...
; Starting query at SimplePrintf.fst(49,4-60,61)
...
(Prims.list SimplePrintf.dir))
:named binder_x_513418ee1a9bd16c03f003addbbcba09_0))
;;;;;;;;;;;;;;;;k : _: Prims.string -> Prims.string (_: Prims.string -> Prims.string)
(declare-fun x_2b7d8f2dadd0193f4caa6b86ea292a53_1 () Term)

;;;;;;;;;;;;;;;;binder_x_2b7d8f2dadd0193f4caa6b86ea292a53_1
;;; Fact-ids: 
(assert (! (HasType x_2b7d8f2dadd0193f4caa6b86ea292a53_1
Tm_arrow_70affe4dada4ca8ba18740c614ba5211)
:named binder_x_2b7d8f2dadd0193f4caa6b86ea292a53_1))

(declare-fun Tm_refine_516dceba788ccef4a578863530979ea8 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(47,27-60,61); use=SimplePrintf.fst(47,27-60,61)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_516dceba788ccef4a578863530979ea8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_516dceba788ccef4a578863530979ea8 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_516dceba788ccef4a578863530979ea8))

:named refinement_kinding_Tm_refine_516dceba788ccef4a578863530979ea8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(47,27-60,61); use=SimplePrintf.fst(47,27-60,61)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_516dceba788ccef4a578863530979ea8 @x2))
(and (HasTypeFuel @u0
@x1
Tm_arrow_70affe4dada4ca8ba18740c614ba5211)

;; def=SimplePrintf.fst(49,4-60,61); use=SimplePrintf.fst(49,4-60,61)
...
@x1
(Tm_refine_516dceba788ccef4a578863530979ea8 @x2)))
:qid refinement_interpretation_Tm_refine_516dceba788ccef4a578863530979ea8))

:named refinement_interpretation_Tm_refine_516dceba788ccef4a578863530979ea8))
;;;;;;;;;;;;;;;;haseq for Tm_refine_516dceba788ccef4a578863530979ea8
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(47,27-60,61); use=SimplePrintf.fst(47,27-60,61)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_516dceba788ccef4a578863530979ea8 @x0)))
(Valid (Prims.hasEq Tm_arrow_70affe4dada4ca8ba18740c614ba5211)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_516dceba788ccef4a578863530979ea8 @x0))))
:qid haseqTm_refine_516dceba788ccef4a578863530979ea8))

:named haseqTm_refine_516dceba788ccef4a578863530979ea8))
(declare-fun SimplePrintf.string_of_dirs (Term Term) Term)


;;;;;;;;;;;;;;;;ds: Prims.list dir -> k: (_: Prims.string -> Prims.string){ds << ds} -> dir_type ds
(declare-fun Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b
Tm_type)
:named kinding_Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(40,21-60,61); use=SimplePrintf.fst(47,23-60,61)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b))
:qid SimplePrintf_pre_typing_Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b))

:named SimplePrintf_pre_typing_Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(40,21-60,61); use=SimplePrintf.fst(47,23-60,61)
(forall ((@x0 Term))
...
(Prims.list SimplePrintf.dir))
(HasType @x2
(Tm_refine_516dceba788ccef4a578863530979ea8 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
(SimplePrintf.dir_type @x1)))
...
@x1)
@x2))
:qid SimplePrintf_interpretation_Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid SimplePrintf_interpretation_Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b))
:qid SimplePrintf_interpretation_Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b))

:named SimplePrintf_interpretation_Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b))
(declare-fun SimplePrintf.string_of_dirs@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(47,8-47,22); use=SimplePrintf.fst(47,8-47,22)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT SimplePrintf.string_of_dirs@tok
@x0)
@x1)
(SimplePrintf.string_of_dirs @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT SimplePrintf.string_of_dirs@tok
@x0)
@x1))
:qid token_correspondence_SimplePrintf.string_of_dirs))

:named token_correspondence_SimplePrintf.string_of_dirs))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(47,8-47,22); use=SimplePrintf.fst(47,8-47,22)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType SimplePrintf.string_of_dirs@tok
Tm_arrow_f9cc488f92b98ff5f3cb241e4f3e703b))
...
@x1)
@x2)
(SimplePrintf.string_of_dirs @x1
@x2))
 

:pattern ((SimplePrintf.string_of_dirs @x1
@x2))
:qid function_token_typing_SimplePrintf.string_of_dirs.1))
)
 

:pattern ((ApplyTT @x0
SimplePrintf.string_of_dirs@tok))
:qid function_token_typing_SimplePrintf.string_of_dirs))

:named function_token_typing_SimplePrintf.string_of_dirs))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(47,8-47,22); use=SimplePrintf.fst(47,8-47,22)
...
(Prims.list SimplePrintf.dir))
(HasType @x1
(Tm_refine_516dceba788ccef4a578863530979ea8 @x0)))
(HasType (SimplePrintf.string_of_dirs @x0
@x1)
(SimplePrintf.dir_type @x0)))
 

:pattern ((SimplePrintf.string_of_dirs @x0
@x1))
:qid typing_SimplePrintf.string_of_dirs))

:named typing_SimplePrintf.string_of_dirs))
...
(declare-fun Tm_abs_aae9189e706781daa21165edc15cbd3c (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_aae9189e706781daa21165edc15cbd3c
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(52,37-52,63); use=SimplePrintf.fst(52,37-52,63)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_aae9189e706781daa21165edc15cbd3c @x0)
Tm_arrow_70affe4dada4ca8ba18740c614ba5211)
 

:pattern ((Tm_abs_aae9189e706781daa21165edc15cbd3c @x0))
:qid typing_Tm_abs_aae9189e706781daa21165edc15cbd3c))

:named typing_Tm_abs_aae9189e706781daa21165edc15cbd3c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_aae9189e706781daa21165edc15cbd3c
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(52,37-52,63); use=SimplePrintf.fst(52,37-52,63)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_aae9189e706781daa21165edc15cbd3c @x1)
@x0)
(ApplyTT x_2b7d8f2dadd0193f4caa6b86ea292a53_1
(Prims.strcat (FStar.String.string_of_char @x1)
@x0)))
 

:pattern ((ApplyTT (Tm_abs_aae9189e706781daa21165edc15cbd3c @x1)
@x0))
:qid interpretation_Tm_abs_aae9189e706781daa21165edc15cbd3c))

:named interpretation_Tm_abs_aae9189e706781daa21165edc15cbd3c))
;;;;;;;;;;;;;;;;_: arg_type a -> dir_type ds'
(declare-fun Tm_arrow_3873417a0c5a715c94309020865ce362 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3873417a0c5a715c94309020865ce362
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(44,20-44,52); use=SimplePrintf.fst(52,6-52,64)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_3873417a0c5a715c94309020865ce362 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_3873417a0c5a715c94309020865ce362 @x0)
Tm_type))
:qid kinding_Tm_arrow_3873417a0c5a715c94309020865ce362))

:named kinding_Tm_arrow_3873417a0c5a715c94309020865ce362))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(44,20-44,52); use=SimplePrintf.fst(52,6-52,64)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_3873417a0c5a715c94309020865ce362 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_3873417a0c5a715c94309020865ce362 @x2)))
:qid SimplePrintf_pre_typing_Tm_arrow_3873417a0c5a715c94309020865ce362))

:named SimplePrintf_pre_typing_Tm_arrow_3873417a0c5a715c94309020865ce362))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3873417a0c5a715c94309020865ce362
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(44,20-44,52); use=SimplePrintf.fst(52,6-52,64)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_3873417a0c5a715c94309020865ce362 @x1))
(and 
;; def=SimplePrintf.fst(44,20-44,52); use=SimplePrintf.fst(52,6-52,64)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(SimplePrintf.arg_type (SimplePrintf.Arg__0 (Prims.Cons_hd @x1))))
(HasType (ApplyTT @x0
@x2)
(SimplePrintf.dir_type (Prims.Cons_tl @x1))))
 

:pattern ((ApplyTT @x0
@x2))
:qid SimplePrintf_interpretation_Tm_arrow_3873417a0c5a715c94309020865ce362.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_3873417a0c5a715c94309020865ce362 @x1)))
:qid SimplePrintf_interpretation_Tm_arrow_3873417a0c5a715c94309020865ce362))

:named SimplePrintf_interpretation_Tm_arrow_3873417a0c5a715c94309020865ce362))
...
(declare-fun Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(56,39-60,60); use=SimplePrintf.fst(56,39-60,60)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc @x0
@x1)
Tm_arrow_70affe4dada4ca8ba18740c614ba5211)
 

:pattern ((Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc @x0
@x1))
:qid typing_Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc))

:named typing_Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(56,39-60,60); use=SimplePrintf.fst(56,39-60,60)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc @x1
@x2)
@x0)
(Prims.strcat (ApplyTT x_2b7d8f2dadd0193f4caa6b86ea292a53_1
(let ((@lb3 @x2))
(ite (is-SimplePrintf.Bool @lb3)
(Prims.string_of_bool @x1)
(ite (is-SimplePrintf.Int @lb3)
(Prims.string_of_int @x1)
(ite (is-SimplePrintf.Char @lb3)
(FStar.String.string_of_char @x1)
(ite (is-SimplePrintf.String @lb3)
@x1
Tm_unit))))))
@x0))
 

:pattern ((ApplyTT (Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc @x1
@x2)
@x0))
:qid interpretation_Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc))

:named interpretation_Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc))
;;;;;;;;;;;;;;;;x: arg_type b -> dir_type b
(declare-fun Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(48,4-55,25); use=SimplePrintf.fst(55,15-56,22)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab))

:named kinding_Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(48,4-55,25); use=SimplePrintf.fst(55,15-56,22)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab @x2
@x3)))
:qid SimplePrintf_pre_typing_Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab))

:named SimplePrintf_pre_typing_Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(48,4-55,25); use=SimplePrintf.fst(55,15-56,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab @x1
@x2))
(and 
;; def=SimplePrintf.fst(48,4-55,25); use=SimplePrintf.fst(55,15-56,22)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(SimplePrintf.arg_type @x2))
(HasType (ApplyTT @x0
@x3)
(SimplePrintf.dir_type @x1)))
...
:pattern ((ApplyTT @x0
@x3))
:qid SimplePrintf_interpretation_Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab.1))
...
(Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab @x1
@x2)))
:qid SimplePrintf_interpretation_Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab))

:named SimplePrintf_interpretation_Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab))
(declare-fun Tm_abs_55d28017a0da5d545c9b30c6c0d37957 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_55d28017a0da5d545c9b30c6c0d37957
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(56,8-60,61); use=SimplePrintf.fst(56,8-60,61)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_55d28017a0da5d545c9b30c6c0d37957 @x0
@x1)
(Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab @x0
@x1))
 

:pattern ((Tm_abs_55d28017a0da5d545c9b30c6c0d37957 @x0
@x1))
:qid typing_Tm_abs_55d28017a0da5d545c9b30c6c0d37957))

:named typing_Tm_abs_55d28017a0da5d545c9b30c6c0d37957))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_55d28017a0da5d545c9b30c6c0d37957
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(56,8-60,61); use=SimplePrintf.fst(56,8-60,61)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_55d28017a0da5d545c9b30c6c0d37957 @x1
@x2)
@x0)
(SimplePrintf.string_of_dirs @x1
(Tm_abs_978cb44e0ef9ee009707de2f74f5bcdc @x0
@x2)))
 

:pattern ((ApplyTT (Tm_abs_55d28017a0da5d545c9b30c6c0d37957 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_55d28017a0da5d545c9b30c6c0d37957))

:named interpretation_Tm_abs_55d28017a0da5d545c9b30c6c0d37957))


; Encoding query formula : forall (k: Prims.pure_post (SimplePrintf.dir_type ds)).
;   (forall (x: SimplePrintf.dir_type ds). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Nil? ds) /\ ~(Cons? ds && Lit? ds.hd) /\ ~(Cons? ds && Arg? ds.hd) ==> Prims.l_False) /\
;   (ds == [] ==> Prims.has_type (k "") (SimplePrintf.dir_type ds)) /\
;   (~(Nil? ds) ==>
;     (forall (b: FStar.String.char) (b: Prims.list SimplePrintf.dir).
;         ds == SimplePrintf.Lit b :: b ==>
;         b << ds /\
;         (forall (any_result: k: (_: Prims.string -> Prims.string){b << ds}).
;             (fun res -> k (Prims.strcat (FStar.String.string_of_char b) res)) == any_result ==>
;             (forall (any_result: SimplePrintf.dir_type b).
;                 SimplePrintf.string_of_dirs b
;                   (fun res -> k (Prims.strcat (FStar.String.string_of_char b) res)) ==
;                 any_result ==>
;                 Prims.has_type (SimplePrintf.string_of_dirs b
;                       (fun res -> k (Prims.strcat (FStar.String.string_of_char b) res)))
;                   (match b with
;                     | [] -> Prims.string
;                     | SimplePrintf.Lit _ :: ds' -> SimplePrintf.dir_type ds'
;                     | SimplePrintf.Arg a :: ds' ->
;                       _: SimplePrintf.arg_type a -> SimplePrintf.dir_type ds') /\
;                 (forall (return_val:
;                     ((match b with
;                         | [] -> Prims.string
;                         | SimplePrintf.Lit _ :: ds' -> SimplePrintf.dir_type ds'
...
;                     Prims.has_type (SimplePrintf.string_of_dirs b
;                           (fun res -> k (Prims.strcat (FStar.String.string_of_char b) res)))
;                       (SimplePrintf.dir_type ds))))) /\
;     (~(Cons? ds && Lit? ds.hd) ==>
;       (forall (b: SimplePrintf.arg) (b: Prims.list SimplePrintf.dir).
;           ds == SimplePrintf.Arg b :: b ==>
;           (forall (x: SimplePrintf.arg_type b).
;               (*  - Could not prove post-condition
; *)
;               (forall (res: Prims.string).
;                   (*  - Could not prove post-condition
; *)
;                   forall (k: Prims.pure_post Prims.string).
;                     (forall (x: Prims.string). {:pattern Prims.guard_free (k x)}
;                         Prims.auto_squash (k x)) ==>
;                     (~(Bool? b) /\ ~(Int? b) /\ ~(Char? b) /\ ~(String? b) ==> Prims.l_False) /\
;                     (b == SimplePrintf.Bool ==> Prims.has_type x Prims.bool) /\
;                     (~(Bool? b) ==>
;                       (b == SimplePrintf.Int ==> Prims.has_type x Prims.int) /\
;                       (~(Int? b) ==>
;                         (b == SimplePrintf.Char ==> Prims.has_type x FStar.String.char) /\
;                         (~(Char? b) ==> b == SimplePrintf.String ==> Prims.has_type x Prims.string))
;                     )) /\ b << ds) /\
;           Prims.has_type (fun x ->
;                 SimplePrintf.string_of_dirs b
;                   (fun res ->
;                       Prims.strcat (k (match b with
;                               | SimplePrintf.Bool -> Prims.string_of_bool x
;                               | SimplePrintf.Int -> Prims.string_of_int x
;                               | SimplePrintf.Char -> FStar.String.string_of_char x
;                               | SimplePrintf.String -> x))
;                         res))
;             (match ds with
;               | [] -> Prims.string
;               | SimplePrintf.Lit _ :: ds' -> SimplePrintf.dir_type ds'
;               | SimplePrintf.Arg a :: ds' -> _: SimplePrintf.arg_type a -> SimplePrintf.dir_type ds'
;             ))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec string_of_dirs`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (SimplePrintf.dir_type x_513418ee1a9bd16c03f003addbbcba09_0)))

;; def=Prims.fst(402,27-402,88); use=SimplePrintf.fst(49,4-60,61)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(49,4-60,61)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(49,4-60,61)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=SimplePrintf.fst(49,4-60,61)
(and (implies 
;; def=SimplePrintf.fst(47,23-60,61); use=SimplePrintf.fst(49,4-60,61)
(and 
;; def=SimplePrintf.fst(47,23-47,25); use=SimplePrintf.fst(49,10-49,12)
(not 
;; def=SimplePrintf.fst(47,23-47,25); use=SimplePrintf.fst(49,10-49,12)
(BoxBool_proj_0 (Prims.uu___is_Nil SimplePrintf.dir
x_513418ee1a9bd16c03f003addbbcba09_0))
...
label_1)
(implies 
;; def=SimplePrintf.fst(47,23-50,8); use=SimplePrintf.fst(49,10-50,8)
(= x_513418ee1a9bd16c03f003addbbcba09_0
(Prims.Nil SimplePrintf.dir))


;; def=SimplePrintf.fst(50,12-50,16); use=SimplePrintf.fst(50,12-50,16)
(or label_2
(HasType (ApplyTT x_2b7d8f2dadd0193f4caa6b86ea292a53_1
(BoxString (FString_const 0)))
(SimplePrintf.dir_type x_513418ee1a9bd16c03f003addbbcba09_0)))
)
(implies 
;; def=Prims.fst(389,19-389,21); use=SimplePrintf.fst(49,4-60,61)
(not 
;; def=SimplePrintf.fst(47,23-47,25); use=SimplePrintf.fst(49,10-49,12)
(BoxBool_proj_0 (Prims.uu___is_Nil SimplePrintf.dir
x_513418ee1a9bd16c03f003addbbcba09_0))
...
;; def=Prims.fst(389,2-389,39); use=SimplePrintf.fst(49,4-60,61)
(and 
;; def=Prims.fst(413,99-413,120); use=SimplePrintf.fst(49,4-60,61)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.String.char Dummy_value))
...
;; def=SimplePrintf.fst(47,23-51,18); use=SimplePrintf.fst(49,10-51,18)
(= x_513418ee1a9bd16c03f003addbbcba09_0
(Prims.Cons SimplePrintf.dir
(SimplePrintf.Lit @x1)
@x2))
...
;; def=Prims.fst(459,77-459,89); use=SimplePrintf.fst(49,4-60,61)
(and 
;; def=SimplePrintf.fst(49,4-60,61); use=SimplePrintf.fst(52,37-52,63)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=SimplePrintf.fst(49,4-60,61)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Tm_refine_516dceba788ccef4a578863530979ea8 @x2))

;; def=SimplePrintf.fst(47,27-52,63); use=SimplePrintf.fst(49,4-60,61)
(= (Tm_abs_aae9189e706781daa21165edc15cbd3c @x1)
@x3)
)
...
(SimplePrintf.dir_type @x2))

;; def=SimplePrintf.fst(52,6-53,38); use=SimplePrintf.fst(52,6-53,38)
(= (SimplePrintf.string_of_dirs @x2
(Tm_abs_aae9189e706781daa21165edc15cbd3c @x1))
@x4)
)
...
;; def=Prims.fst(459,77-459,89); use=SimplePrintf.fst(49,4-60,61)
(and 
;; def=SimplePrintf.fst(52,6-52,64); use=SimplePrintf.fst(52,6-52,64)
(or label_4
(HasType (SimplePrintf.string_of_dirs @x2
(Tm_abs_aae9189e706781daa21165edc15cbd3c @x1))
(let ((@lb5 @x2))
(ite (is-Prims.Nil @lb5)
Prims.string
(ite (and (is-Prims.Cons @lb5)
(is-SimplePrintf.Lit (Prims.Cons_hd @lb5)))
(SimplePrintf.dir_type (Prims.Cons_tl @lb5))
(ite (and (is-Prims.Cons @lb5)
(is-SimplePrintf.Arg (Prims.Cons_hd @lb5)))
(Tm_arrow_3873417a0c5a715c94309020865ce362 @lb5)
Tm_unit))))))


;; def=Prims.fst(356,2-356,58); use=SimplePrintf.fst(49,4-60,61)
(forall ((@x5 Term))
...
(is-SimplePrintf.Lit (Prims.Cons_hd @lb6)))
(SimplePrintf.dir_type (Prims.Cons_tl @lb6))
(ite (and (is-Prims.Cons @lb6)
(is-SimplePrintf.Arg (Prims.Cons_hd @lb6)))
(Tm_arrow_3873417a0c5a715c94309020865ce362 @lb6)
Tm_unit)))))

;; def=Prims.fst(356,26-356,41); use=SimplePrintf.fst(49,4-60,61)
(= @x5
(SimplePrintf.string_of_dirs @x2
(Tm_abs_aae9189e706781daa21165edc15cbd3c @x1)))


;; def=SimplePrintf.fst(48,4-52,64); use=SimplePrintf.fst(49,4-60,61)
(= (SimplePrintf.string_of_dirs @x2
(Tm_abs_aae9189e706781daa21165edc15cbd3c @x1))
@x5)
)
...
;; def=SimplePrintf.fst(47,23-54,18); use=SimplePrintf.fst(49,10-54,18)
(= x_513418ee1a9bd16c03f003addbbcba09_0
(Prims.Cons SimplePrintf.dir
(SimplePrintf.Arg @x1)
@x2))
...
;; def=dummy(0,0-0,0); use=SimplePrintf.fst(56,8-60,61)
(and 
;; def=dummy(0,0-0,0); use=SimplePrintf.fst(49,4-60,61)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(SimplePrintf.arg_type @x1))

;; def=SimplePrintf.fst(49,4-60,61); use=SimplePrintf.fst(56,8-60,61)
(and 
;; def=dummy(0,0-0,0); use=SimplePrintf.fst(56,8-60,61)
(forall ((@x4 Term))
 (! (implies (HasType @x4
...
;; def=Prims.fst(402,27-402,88); use=SimplePrintf.fst(56,39-60,60)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(56,39-60,60)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(56,39-60,60)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=SimplePrintf.fst(56,39-60,60)
(and (implies 
;; def=SimplePrintf.fst(54,10-54,11); use=SimplePrintf.fst(56,48-56,49)
(and 
;; def=SimplePrintf.fst(54,10-54,11); use=SimplePrintf.fst(56,48-56,49)
(not 
;; def=SimplePrintf.fst(54,10-54,11); use=SimplePrintf.fst(56,48-56,49)
(BoxBool_proj_0 (SimplePrintf.uu___is_Bool @x1))
)
...
(not 
;; def=SimplePrintf.fst(54,10-54,11); use=SimplePrintf.fst(56,48-56,49)
(BoxBool_proj_0 (SimplePrintf.uu___is_Int @x1))
)
...
(not 
;; def=SimplePrintf.fst(54,10-54,11); use=SimplePrintf.fst(56,48-56,49)
(BoxBool_proj_0 (SimplePrintf.uu___is_Char @x1))
)
...
(not 
;; def=SimplePrintf.fst(54,10-54,11); use=SimplePrintf.fst(56,48-56,49)
(BoxBool_proj_0 (SimplePrintf.uu___is_String @x1))
)
)

label_6)
(implies 
;; def=SimplePrintf.fst(54,10-57,46); use=SimplePrintf.fst(56,48-57,46)
(= @x1
SimplePrintf.Bool@tok)


;; def=SimplePrintf.fst(55,11-55,12); use=SimplePrintf.fst(57,65-57,66)
(or label_7
(HasType @x3
Prims.bool))
)
(implies 
;; def=Prims.fst(389,19-389,21); use=SimplePrintf.fst(56,39-60,60)
(not 
;; def=SimplePrintf.fst(54,10-54,11); use=SimplePrintf.fst(56,48-56,49)
(BoxBool_proj_0 (SimplePrintf.uu___is_Bool @x1))
)
...
;; def=Prims.fst(389,2-389,39); use=SimplePrintf.fst(56,39-60,60)
(and (implies 
;; def=SimplePrintf.fst(54,10-58,45); use=SimplePrintf.fst(56,48-58,45)
(= @x1
SimplePrintf.Int@tok)


;; def=SimplePrintf.fst(55,11-55,12); use=SimplePrintf.fst(58,63-58,64)
(or label_8
(HasType @x3
Prims.int))
)
...
;; def=Prims.fst(389,2-389,39); use=SimplePrintf.fst(56,39-60,60)
(and (implies 
;; def=SimplePrintf.fst(54,10-59,46); use=SimplePrintf.fst(56,48-59,46)
(= @x1
SimplePrintf.Char@tok)


;; def=SimplePrintf.fst(55,11-55,12); use=SimplePrintf.fst(59,65-59,66)
(or label_9
(HasType @x3
(FStar.String.char Dummy_value)))
)
(implies 
;; def=Prims.fst(389,18-389,39); use=SimplePrintf.fst(56,39-60,60)
(and 
;; def=Prims.fst(389,19-389,21); use=SimplePrintf.fst(56,39-60,60)
(not 
;; def=SimplePrintf.fst(54,10-54,11); use=SimplePrintf.fst(56,48-56,49)
...
;; def=SimplePrintf.fst(54,10-60,48); use=SimplePrintf.fst(56,48-60,48)
(= @x1
SimplePrintf.String@tok)
)


;; def=SimplePrintf.fst(55,11-55,12); use=SimplePrintf.fst(60,52-60,53)
(or label_10
(HasType @x3
Prims.string))
))
...
;; def=SimplePrintf.fst(49,4-60,61); use=SimplePrintf.fst(56,39-60,60)
(or label_11
...
;; def=SimplePrintf.fst(56,8-60,61); use=SimplePrintf.fst(56,8-60,61)
(or label_12
(HasType (Tm_abs_55d28017a0da5d545c9b30c6c0d37957 @x2
@x1)
(let ((@lb3 x_513418ee1a9bd16c03f003addbbcba09_0))
(ite (is-Prims.Nil @lb3)
Prims.string
(ite (and (is-Prims.Cons @lb3)
(is-SimplePrintf.Lit (Prims.Cons_hd @lb3)))
(SimplePrintf.dir_type (Prims.Cons_tl @lb3))
(ite (and (is-Prims.Cons @lb3)
(is-SimplePrintf.Arg (Prims.Cons_hd @lb3)))
(Tm_arrow_3873417a0c5a715c94309020865ce362 @lb3)
Tm_unit))))))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SimplePrintf.string_of_dirs, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_SimplePrintf.dir_type.fuel_instrumented, @fuel_irrelevance_SimplePrintf.dir_type.fuel_instrumented, @query, FStar.String_interpretation_Tm_arrow_70affe4dada4ca8ba18740c614ba5211, SimplePrintf_interpretation_Tm_arrow_04517b06830101b5b49a227952fd3ff1, SimplePrintf_interpretation_Tm_arrow_3873417a0c5a715c94309020865ce362, SimplePrintf_interpretation_Tm_arrow_e1ef6ee49e1437584d148eed1eb1d9ab, binder_x_2b7d8f2dadd0193f4caa6b86ea292a53_1, binder_x_513418ee1a9bd16c03f003addbbcba09_0, constructor_distinct_Prims.Nil, constructor_distinct_SimplePrintf.Arg, constructor_distinct_SimplePrintf.Bool, constructor_distinct_SimplePrintf.Char, constructor_distinct_SimplePrintf.Int, constructor_distinct_SimplePrintf.Lit, constructor_distinct_SimplePrintf.String, data_elim_Prims.Cons, disc_equation_Prims.Cons, disc_equation_Prims.Nil, disc_equation_SimplePrintf.Arg, disc_equation_SimplePrintf.Bool, disc_equation_SimplePrintf.Char, disc_equation_SimplePrintf.Int, disc_equation_SimplePrintf.Lit, disc_equation_SimplePrintf.String, equality_tok_SimplePrintf.Bool@tok, equality_tok_SimplePrintf.Char@tok, equality_tok_SimplePrintf.Int@tok, equality_tok_SimplePrintf.String@tok, equation_SimplePrintf.arg_type, equation_with_fuel_SimplePrintf.dir_type.fuel_instrumented, fuel_guarded_inversion_Prims.list, fuel_guarded_inversion_SimplePrintf.arg, fuel_guarded_inversion_SimplePrintf.dir, proj_equation_Prims.Cons_hd, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, projection_inverse_Prims.Nil_a, projection_inverse_SimplePrintf.Arg__0, projection_inverse_SimplePrintf.Lit__0, string_typing, subterm_ordering_Prims.Cons, typing_Tm_abs_55d28017a0da5d545c9b30c6c0d37957
...
; encoding sigelt let rec string_of_dirs


; <Start encoding let rec string_of_dirs>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun SimplePrintf.string_of_dirs.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun SimplePrintf.string_of_dirs.fuel_instrumented_token () Term)
(declare-fun SimplePrintf.string_of_dirs (Term Term) Term)
(declare-fun SimplePrintf.string_of_dirs@tok () Term)


(declare-fun Tm_abs_38ff19cc99169dfd57f9a39a25e91a03 (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: arg_type a -> dir_type ds'
(declare-fun Tm_arrow_3873417a0c5a715c94309020865ce362 (Term) Term)
(declare-fun Tm_abs_38f0e3de21ebfcefba9633e487c58028 (Fuel Term Term) Term)

(declare-fun Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56 (Term Term) Term)


;;;;;;;;;;;;;;;;ds: Prims.list dir -> k: (_: Prims.string -> Prims.string) -> dir_type ds
(declare-fun Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9 () Term)

; </end encoding let rec string_of_dirs>


; encoding sigelt let example1


; <Start encoding let example1>

(declare-fun SimplePrintf.example1 (Dummy_sort) Term)

(declare-fun Tm_abs_7de968e83fab2a5ec34920f38db5f8bf () Term)

; </end encoding let example1>
...
; Starting query at SimplePrintf.fst(81,6-83,31)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (d: SimplePrintf.dir) (ods: FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir)).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post (FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir))).
;     (forall (x: FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir)).
;         {:pattern Prims.guard_free (k x)}
;         Prims.auto_squash (k x)) ==>
;     ~(None? ods) /\ ~(Some? ods) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let add_dir`
...
SimplePrintf.dir)
(HasType @x1
(FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir))))
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.pure_post (FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir))))

;; def=Prims.fst(402,27-402,88); use=SimplePrintf.fst(81,6-83,31)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(81,6-83,31)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(81,6-83,31)
(ApplyTT @x2
@x3)
...
;; def=SimplePrintf.fst(79,21-79,24); use=SimplePrintf.fst(81,12-81,15)
(not 
;; def=SimplePrintf.fst(79,21-79,24); use=SimplePrintf.fst(81,12-81,15)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (Prims.list SimplePrintf.dir)
@x1))
)
...
(not 
;; def=SimplePrintf.fst(79,21-79,24); use=SimplePrintf.fst(81,12-81,15)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (Prims.list SimplePrintf.dir)
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SimplePrintf.add_dir, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, kinding_Prims.list@tok, kinding_SimplePrintf.dir@tok, lemma_FStar.Pervasives.invertOption
...
; encoding sigelt let add_dir


; <Start encoding let add_dir>

(declare-fun SimplePrintf.add_dir (Term Term) Term)
;;;;;;;;;;;;;;;;d: dir -> ods: FStar.Pervasives.Native.option (Prims.list dir)   -> FStar.Pervasives.Native.option (Prims.list dir)
(declare-fun Tm_arrow_217ffdd1d451ca704f02c3aae84c6dc9 () Term)
(declare-fun SimplePrintf.add_dir@tok () Term)

; </end encoding let add_dir>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Char.u32_of_char; Namespace FStar.Char
(assert (! 
;; def=FStar.Char.fsti(41,4-41,15); use=FStar.Char.fsti(41,4-41,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Char.char Dummy_value))
(HasType (FStar.Char.u32_of_char @x0)
FStar.Char.char_code))
 

:pattern ((FStar.Char.u32_of_char @x0))
:qid typing_FStar.Char.u32_of_char))

:named typing_FStar.Char.u32_of_char))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Char.char_of_u32; Namespace FStar.Char
(assert (! 
;; def=FStar.Char.fsti(44,4-44,15); use=FStar.Char.fsti(44,4-44,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FStar.Char.char_code)
(HasType (FStar.Char.char_of_u32 @x0)
(FStar.Char.char Dummy_value)))
 

:pattern ((FStar.Char.char_of_u32 @x0))
:qid typing_FStar.Char.char_of_u32))

:named typing_FStar.Char.char_of_u32))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Char.char_of_int; Namespace FStar.Char
(assert (! 
;; def=FStar.Char.fsti(57,4-57,15); use=FStar.Char.fsti(57,4-57,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_41bb1fe33d2856748d537571528d32a1)
(HasType (FStar.Char.char_of_int @x0)
(FStar.Char.char Dummy_value)))
 

:pattern ((FStar.Char.char_of_int @x0))
:qid typing_FStar.Char.char_of_int))

:named typing_FStar.Char.char_of_int))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Char.char_code; Namespace FStar.Char
(assert (! (HasType FStar.Char.char_code
Tm_type)
:named typing_FStar.Char.char_code))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Char.__char_of_int; Namespace FStar.Char
(assert (! 
;; def=FStar.Char.fsti(73,4-73,17); use=FStar.Char.fsti(73,4-73,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (FStar.Char.__char_of_int @x0)
(FStar.Char.char Dummy_value)))
 

:pattern ((FStar.Char.__char_of_int @x0))
:qid typing_FStar.Char.__char_of_int))

:named typing_FStar.Char.__char_of_int))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name Prims.pow2; Namespace Prims
(assert (! 
;; def=Prims.fst(708,8-708,12); use=Prims.fst(708,8-708,12)
...
;;;;;;;;;;;;;;;;Lemma: FStar.Char.u32_of_char_of_u32
;;; Fact-ids: Name FStar.Char.u32_of_char_of_u32; Namespace FStar.Char
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
FStar.Char.char_code)

;; def=FStar.Char.fsti(52,21-52,55); use=FStar.Char.fsti(52,21-52,55)
(= (FStar.Char.u32_of_char (FStar.Char.char_of_u32 @x0))
@x0)
)
 

:pattern ((FStar.Char.char_of_u32 @x0))
:qid lemma_FStar.Char.u32_of_char_of_u32))
:named lemma_FStar.Char.u32_of_char_of_u32))
;;;;;;;;;;;;;;;;Lemma: FStar.Char.char_of_u32_of_char
;;; Fact-ids: Name FStar.Char.char_of_u32_of_char; Namespace FStar.Char
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Char.char Dummy_value))

;; def=FStar.Char.fsti(48,21-48,55); use=FStar.Char.fsti(48,21-48,55)
(= (FStar.Char.char_of_u32 (FStar.Char.u32_of_char @x0))
@x0)
)
 

:pattern ((FStar.Char.u32_of_char @x0))
:qid lemma_FStar.Char.char_of_u32_of_char))
:named lemma_FStar.Char.char_of_u32_of_char))
...
(assert (! (HasType FStar.Char.char_code
Tm_type)
:named function_token_typing_FStar.Char.char_code))
...
;;;;;;;;;;;;;;;;Equation for FStar.Char.char_of_int
;;; Fact-ids: Name FStar.Char.char_of_int; Namespace FStar.Char
(assert (! 
;; def=FStar.Char.fsti(57,4-57,15); use=FStar.Char.fsti(57,4-57,15)
(forall ((@x0 Term))
 (! (= (FStar.Char.char_of_int @x0)
(FStar.Char.char_of_u32 (FStar.UInt32.uint_to_t @x0)))
 

:pattern ((FStar.Char.char_of_int @x0))
:qid equation_FStar.Char.char_of_int))

:named equation_FStar.Char.char_of_int))
;;;;;;;;;;;;;;;;Equation for FStar.Char.char_code
;;; Fact-ids: Name FStar.Char.char_code; Namespace FStar.Char
(assert (! (= FStar.Char.char_code
Tm_refine_96af4a84eae6a9bae92bc908a1c3c24c)
:named equation_FStar.Char.char_code))
;;;;;;;;;;;;;;;;Equation for FStar.Char.__char_of_int
;;; Fact-ids: Name FStar.Char.__char_of_int; Namespace FStar.Char
(assert (! 
;; def=FStar.Char.fsti(73,4-73,17); use=FStar.Char.fsti(73,4-73,17)
(forall ((@x0 Term))
 (! (= (FStar.Char.__char_of_int @x0)
(FStar.Char.char_of_int @x0))
 

:pattern ((FStar.Char.__char_of_int @x0))
:qid equation_FStar.Char.__char_of_int))

:named equation_FStar.Char.__char_of_int))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.UInt32.t; Namespace FStar.UInt32
(assert (! 
;; def=FStar.UInt32.fsti(50,8-50,9); use=FStar.UInt32.fsti(50,8-50,9)
...
; Starting query at SimplePrintf.fst(87,6-100,46)

;;;;;;;;;;;;;;;;s : Prims.list FStar.String.char (Prims.list FStar.String.char)
(declare-fun x_4bb2ecabb8dd73bd801eb57f838ec7dc_0 () Term)
;;;;;;;;;;;;;;;;binder_x_4bb2ecabb8dd73bd801eb57f838ec7dc_0
;;; Fact-ids: 
(assert (! (HasType x_4bb2ecabb8dd73bd801eb57f838ec7dc_0
(Prims.list (FStar.String.char Dummy_value)))
:named binder_x_4bb2ecabb8dd73bd801eb57f838ec7dc_0))
(declare-fun Tm_refine_ff923434180db6e0653ab2b31ffb2a91 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_ff923434180db6e0653ab2b31ffb2a91
Tm_type)
:named refinement_kinding_Tm_refine_ff923434180db6e0653ab2b31ffb2a91))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(85,27-100,46); use=SimplePrintf.fst(85,27-100,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ff923434180db6e0653ab2b31ffb2a91)
(and (HasTypeFuel @u0
@x1
(Prims.list (FStar.String.char Dummy_value)))

;; def=SimplePrintf.fst(87,6-100,46); use=SimplePrintf.fst(87,6-100,46)

;; def=SimplePrintf.fst(87,6-100,46); use=SimplePrintf.fst(87,6-100,46)
(Valid 
;; def=SimplePrintf.fst(87,6-100,46); use=SimplePrintf.fst(87,6-100,46)
(Prims.precedes (Prims.list (FStar.String.char Dummy_value))
(Prims.list (FStar.String.char Dummy_value))
@x1
x_4bb2ecabb8dd73bd801eb57f838ec7dc_0)
)
...
@x1
Tm_refine_ff923434180db6e0653ab2b31ffb2a91))
:qid refinement_interpretation_Tm_refine_ff923434180db6e0653ab2b31ffb2a91))

:named refinement_interpretation_Tm_refine_ff923434180db6e0653ab2b31ffb2a91))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ff923434180db6e0653ab2b31ffb2a91
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ff923434180db6e0653ab2b31ffb2a91))
(Valid (Prims.hasEq (Prims.list (FStar.String.char Dummy_value)))))
:named haseqTm_refine_ff923434180db6e0653ab2b31ffb2a91))
(declare-fun SimplePrintf.parse_format_pure (Term) Term)

;;;;;;;;;;;;;;;;s: Prims.list FStar.String.char {s << s} -> FStar.Pervasives.Native.option (Prims.list dir)
(declare-fun Tm_arrow_5a69b6cadb2e0c1776666830272a712b () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5a69b6cadb2e0c1776666830272a712b
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_5a69b6cadb2e0c1776666830272a712b
Tm_type)
:named kinding_Tm_arrow_5a69b6cadb2e0c1776666830272a712b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(85,27-100,46); use=SimplePrintf.fst(85,27-100,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_5a69b6cadb2e0c1776666830272a712b)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_5a69b6cadb2e0c1776666830272a712b))
:qid SimplePrintf_pre_typing_Tm_arrow_5a69b6cadb2e0c1776666830272a712b))

:named SimplePrintf_pre_typing_Tm_arrow_5a69b6cadb2e0c1776666830272a712b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5a69b6cadb2e0c1776666830272a712b
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(85,27-100,46); use=SimplePrintf.fst(85,27-100,46)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid SimplePrintf_interpretation_Tm_arrow_5a69b6cadb2e0c1776666830272a712b.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_5a69b6cadb2e0c1776666830272a712b))
:qid SimplePrintf_interpretation_Tm_arrow_5a69b6cadb2e0c1776666830272a712b))

:named SimplePrintf_interpretation_Tm_arrow_5a69b6cadb2e0c1776666830272a712b))
(declare-fun SimplePrintf.parse_format_pure@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(85,8-85,25); use=SimplePrintf.fst(85,8-85,25)
(forall ((@x0 Term))
 (! (= (ApplyTT SimplePrintf.parse_format_pure@tok
@x0)
(SimplePrintf.parse_format_pure @x0))
 

:pattern ((ApplyTT SimplePrintf.parse_format_pure@tok
@x0))
:qid token_correspondence_SimplePrintf.parse_format_pure))

:named token_correspondence_SimplePrintf.parse_format_pure))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(85,8-85,25); use=SimplePrintf.fst(85,8-85,25)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType SimplePrintf.parse_format_pure@tok
Tm_arrow_5a69b6cadb2e0c1776666830272a712b))
...
(forall ((@x1 Term))
 (! (= (ApplyTT SimplePrintf.parse_format_pure@tok
@x1)
(SimplePrintf.parse_format_pure @x1))
 

:pattern ((SimplePrintf.parse_format_pure @x1))
:qid function_token_typing_SimplePrintf.parse_format_pure.1))
)
 

:pattern ((ApplyTT @x0
SimplePrintf.parse_format_pure@tok))
:qid function_token_typing_SimplePrintf.parse_format_pure))

:named function_token_typing_SimplePrintf.parse_format_pure))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(85,8-85,25); use=SimplePrintf.fst(85,8-85,25)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_ff923434180db6e0653ab2b31ffb2a91)
(HasType (SimplePrintf.parse_format_pure @x0)
(FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir))))
 

:pattern ((SimplePrintf.parse_format_pure @x0))
:qid typing_SimplePrintf.parse_format_pure))

:named typing_SimplePrintf.parse_format_pure))
(declare-fun label_7 () Bool)
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
...
; Encoding query formula : forall (k: Prims.pure_post (FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir))).
;   (forall (x: FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir)).
;       {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(Nil? s) /\ ~(Cons? s && s.hd = '%' && Nil? s.tl) /\ ~(Cons? s && s.hd = '%' && Cons? s.tl) /\
;     ~(Cons? s) ==>
;     Prims.l_False) /\
;   (~(Nil? s) ==>
;     ~(Cons? s && s.hd = '%' && Nil? s.tl) ==>
;     (forall (b: FStar.String.char) (b: Prims.list FStar.String.char).
;         s == '%' :: b :: b ==>
;         (forall (k: Prims.pure_post (FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir))).
;             (forall (x: FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir)).
;                 {:pattern Prims.guard_free (k x)}
...
;               (~(b = 'b') ==>
;                 (b == 'd' ==> b << s) /\
;                 (~(b = 'd') ==> (b == 'c' ==> b << s) /\ (~(b = 'c') ==> b == 's' ==> b << s)))))) /\
;     (~(Cons? s && s.hd = '%' && Cons? s.tl) ==>
;       (forall (b: FStar.String.char) (b: Prims.list FStar.String.char). s == b :: b ==> b << s)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec parse_format_pure`
...
;; def=Prims.fst(402,27-402,88); use=SimplePrintf.fst(87,6-100,46)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(87,6-100,46)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SimplePrintf.fst(87,6-100,46)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=SimplePrintf.fst(87,6-100,46)
(and (implies 
;; def=SimplePrintf.fst(85,27-100,46); use=SimplePrintf.fst(87,6-100,46)
(and 
;; def=SimplePrintf.fst(85,27-85,28); use=SimplePrintf.fst(87,12-87,13)
(not 
;; def=SimplePrintf.fst(85,27-85,28); use=SimplePrintf.fst(87,12-87,13)
(BoxBool_proj_0 (Prims.uu___is_Nil (FStar.String.char Dummy_value)
x_4bb2ecabb8dd73bd801eb57f838ec7dc_0))
)
...
(not 
;; def=SimplePrintf.fst(87,6-100,46); use=SimplePrintf.fst(87,6-100,46)
(and (BoxBool_proj_0 (Prims.op_AmpAmp (Prims.uu___is_Cons (FStar.String.char Dummy_value)
x_4bb2ecabb8dd73bd801eb57f838ec7dc_0)
(Prims.op_Equality (FStar.Char.char Dummy_value)
(Prims.__proj__Cons__item__hd (FStar.String.char Dummy_value)
x_4bb2ecabb8dd73bd801eb57f838ec7dc_0)
(FStar.Char.__char_of_int (BoxInt 37)))))
(BoxBool_proj_0 (Prims.uu___is_Nil (FStar.String.char Dummy_value)
(Prims.__proj__Cons__item__tl (FStar.String.char Dummy_value)
x_4bb2ecabb8dd73bd801eb57f838ec7dc_0))))
)
...
x_4bb2ecabb8dd73bd801eb57f838ec7dc_0)
(FStar.Char.__char_of_int (BoxInt 37)))))
(BoxBool_proj_0 (Prims.uu___is_Cons (FStar.String.char Dummy_value)
(Prims.__proj__Cons__item__tl (FStar.String.char Dummy_value)
x_4bb2ecabb8dd73bd801eb57f838ec7dc_0))))
)
...
label_1)
(implies 
;; def=Prims.fst(389,18-389,39); use=SimplePrintf.fst(87,6-100,46)
(and 
;; def=Prims.fst(389,19-389,21); use=SimplePrintf.fst(87,6-100,46)
(not 
;; def=SimplePrintf.fst(85,27-85,28); use=SimplePrintf.fst(87,12-87,13)
(BoxBool_proj_0 (Prims.uu___is_Nil (FStar.String.char Dummy_value)
x_4bb2ecabb8dd73bd801eb57f838ec7dc_0))
...
;; def=Prims.fst(389,2-389,39); use=SimplePrintf.fst(87,6-100,46)
(and 
;; def=Prims.fst(413,99-413,120); use=SimplePrintf.fst(87,6-100,46)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.String.char Dummy_value))
...
;; def=SimplePrintf.fst(85,27-90,22); use=SimplePrintf.fst(87,12-90,22)
(= x_4bb2ecabb8dd73bd801eb57f838ec7dc_0
(Prims.Cons (FStar.String.char Dummy_value)
(FStar.Char.__char_of_int (BoxInt 37))
(Prims.Cons (FStar.String.char Dummy_value)
@x1
@x2)))
...
;; def=Prims.fst(389,2-389,39); use=SimplePrintf.fst(87,6-100,46)
(and (implies 
;; def=SimplePrintf.fst(90,15-92,13); use=SimplePrintf.fst(91,14-92,13)
(= @x1
(FStar.Char.__char_of_int (BoxInt 37)))


;; def=SimplePrintf.fst(87,6-100,46); use=SimplePrintf.fst(92,54-92,56)
(or label_2
...
;; def=Prims.fst(389,2-389,39); use=SimplePrintf.fst(87,6-100,46)
(and (implies 
;; def=SimplePrintf.fst(90,15-93,13); use=SimplePrintf.fst(91,14-93,13)
(= @x1
(FStar.Char.__char_of_int (BoxInt 98)))


;; def=SimplePrintf.fst(87,6-100,46); use=SimplePrintf.fst(93,55-93,57)
(or label_3
...
;; def=Prims.fst(389,2-389,39); use=SimplePrintf.fst(87,6-100,46)
(and (implies 
;; def=SimplePrintf.fst(90,15-94,13); use=SimplePrintf.fst(91,14-94,13)
(= @x1
(FStar.Char.__char_of_int (BoxInt 100)))


;; def=SimplePrintf.fst(87,6-100,46); use=SimplePrintf.fst(94,54-94,56)
(or label_4
...
;; def=Prims.fst(389,2-389,39); use=SimplePrintf.fst(87,6-100,46)
(and (implies 
;; def=SimplePrintf.fst(90,15-95,13); use=SimplePrintf.fst(91,14-95,13)
(= @x1
(FStar.Char.__char_of_int (BoxInt 99)))


;; def=SimplePrintf.fst(87,6-100,46); use=SimplePrintf.fst(95,55-95,57)
(or label_5
...
;; def=SimplePrintf.fst(90,15-96,13); use=SimplePrintf.fst(91,14-96,13)
(= @x1
(FStar.Char.__char_of_int (BoxInt 115)))
)


;; def=SimplePrintf.fst(87,6-100,46); use=SimplePrintf.fst(96,57-96,59)
(or label_6
...
;; def=SimplePrintf.fst(85,27-99,15); use=SimplePrintf.fst(87,12-99,15)
(= x_4bb2ecabb8dd73bd801eb57f838ec7dc_0
(Prims.Cons (FStar.String.char Dummy_value)
@x1
@x2))
...
;; def=SimplePrintf.fst(87,6-100,46); use=SimplePrintf.fst(100,43-100,45)
(or label_7
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SimplePrintf.parse_format_pure, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_4bb2ecabb8dd73bd801eb57f838ec7dc_0, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_FStar.String.char, equation_Prims.eqtype, fuel_guarded_inversion_Prims.list, proj_equation_Prims.Cons_tl, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_7aac12c24449a22c34d98a0ea8ed4a32, subterm_ordering_Prims.Cons, typing_FStar.String.char, typing_Prims.__proj__Cons__item__tl
...
; encoding sigelt let rec parse_format_pure


; <Start encoding let rec parse_format_pure>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun SimplePrintf.parse_format_pure.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun SimplePrintf.parse_format_pure.fuel_instrumented_token () Term)
(declare-fun SimplePrintf.parse_format_pure (Term) Term)
(declare-fun SimplePrintf.parse_format_pure@tok () Term)
;;;;;;;;;;;;;;;;s: Prims.list FStar.String.char -> FStar.Pervasives.Native.option (Prims.list dir)
(declare-fun Tm_arrow_5d75536b42da98bbd7f68d5cb5c978ff () Term)

; </end encoding let rec parse_format_pure>


; encoding sigelt let parse_format_string


; <Start encoding let parse_format_string>

(declare-fun SimplePrintf.parse_format_string (Term) Term)
;;;;;;;;;;;;;;;;s: Prims.string -> FStar.Pervasives.Native.option (Prims.list dir)
(declare-fun Tm_arrow_18ce7624dfdf5d43c3fa863d1810e8ae () Term)
(declare-fun SimplePrintf.parse_format_string@tok () Term)

; </end encoding let parse_format_string>


; encoding sigelt let valid_format_string


; <Start encoding let valid_format_string>

(declare-fun SimplePrintf.valid_format_string () Term)
(declare-fun Tm_refine_4135b6ad5efaf29d2e623d5bcd8ce1c5 () Term)

; </end encoding let valid_format_string>

;;;;;;;;;;;;;;;;typing_Tm_abs_7de968e83fab2a5ec34920f38db5f8bf
;;; Fact-ids: Name SimplePrintf.example1; Namespace SimplePrintf
(assert (! (HasType Tm_abs_7de968e83fab2a5ec34920f38db5f8bf
Tm_arrow_70affe4dada4ca8ba18740c614ba5211)
:named typing_Tm_abs_7de968e83fab2a5ec34920f38db5f8bf))
;;;;;;;;;;;;;;;;typing_Tm_abs_38ff19cc99169dfd57f9a39a25e91a03
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(56,39-60,60); use=SimplePrintf.fst(56,39-60,60)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_38ff19cc99169dfd57f9a39a25e91a03 @x0
@x1
@x2)
Tm_arrow_70affe4dada4ca8ba18740c614ba5211)
 

:pattern ((Tm_abs_38ff19cc99169dfd57f9a39a25e91a03 @x0
@x1
@x2))
:qid typing_Tm_abs_38ff19cc99169dfd57f9a39a25e91a03))

:named typing_Tm_abs_38ff19cc99169dfd57f9a39a25e91a03))
;;;;;;;;;;;;;;;;typing_Tm_abs_38f0e3de21ebfcefba9633e487c58028
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(56,8-60,61); use=SimplePrintf.fst(56,8-60,61)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_38f0e3de21ebfcefba9633e487c58028 @u0
@x1
@x2)
(Tm_arrow_3873417a0c5a715c94309020865ce362 @x2))
 

:pattern ((Tm_abs_38f0e3de21ebfcefba9633e487c58028 @u0
@x1
@x2))
:qid typing_Tm_abs_38f0e3de21ebfcefba9633e487c58028))

:named typing_Tm_abs_38f0e3de21ebfcefba9633e487c58028))
;;;;;;;;;;;;;;;;typing_Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(52,37-52,63); use=SimplePrintf.fst(52,37-52,63)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56 @x0
@x1)
Tm_arrow_70affe4dada4ca8ba18740c614ba5211)
 

:pattern ((Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56 @x0
@x1))
:qid typing_Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56))

:named typing_Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(47,8-47,22); use=SimplePrintf.fst(47,8-47,22)
...
:named typing_SimplePrintf.string_of_dirs))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.parse_format_string; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(102,4-102,23); use=SimplePrintf.fst(102,4-102,23)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.string)
(HasType (SimplePrintf.parse_format_string @x0)
(FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir))))
 

:pattern ((SimplePrintf.parse_format_string @x0))
:qid typing_SimplePrintf.parse_format_string))

:named typing_SimplePrintf.parse_format_string))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.parse_format_pure; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(85,8-85,25); use=SimplePrintf.fst(85,8-85,25)
(forall ((@x0 Term))
 (! (implies (HasType @x0
...
:named typing_SimplePrintf.parse_format_pure))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SimplePrintf.add_dir; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(79,4-79,11); use=SimplePrintf.fst(79,4-79,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
SimplePrintf.dir)
(HasType @x1
(FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir))))
(HasType (SimplePrintf.add_dir @x0
@x1)
(FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir))))
 

:pattern ((SimplePrintf.add_dir @x0
@x1))
:qid typing_SimplePrintf.add_dir))

:named typing_SimplePrintf.add_dir))
;;;;;;;;;;;;;;;;free var typing
...
(HasType @x2
Tm_arrow_70affe4dada4ca8ba18740c614ba5211))
(HasType (SimplePrintf.string_of_dirs.fuel_instrumented @u0
@x1
@x2)
(SimplePrintf.dir_type @x1)))
 

:pattern ((SimplePrintf.string_of_dirs.fuel_instrumented @u0
@x1
@x2))
:qid token_correspondence_SimplePrintf.string_of_dirs.fuel_instrumented))

:named token_correspondence_SimplePrintf.string_of_dirs.fuel_instrumented))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(47,8-47,22); use=SimplePrintf.fst(47,8-47,22)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
(Prims.list (FStar.String.char Dummy_value)))
(HasType (SimplePrintf.parse_format_pure.fuel_instrumented @u0
@x1)
(FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir))))
 

:pattern ((SimplePrintf.parse_format_pure.fuel_instrumented @u0
@x1))
:qid token_correspondence_SimplePrintf.parse_format_pure.fuel_instrumented))

:named token_correspondence_SimplePrintf.parse_format_pure.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Pervasives.Native.__proj__Some__item__v; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=FStar.Pervasives.Native.fst(33,4-33,8)
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name SimplePrintf.valid_format_string; Namespace SimplePrintf
(assert (! (HasType Tm_refine_4135b6ad5efaf29d2e623d5bcd8ce1c5
Tm_type)
:named refinement_kinding_Tm_refine_4135b6ad5efaf29d2e623d5bcd8ce1c5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.Native.__proj__Some__item__v; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=FStar.Pervasives.Native.fst(33,4-33,8)
...
;;; Fact-ids: Name SimplePrintf.valid_format_string; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(105,26-105,65); use=SimplePrintf.fst(105,26-105,65)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4135b6ad5efaf29d2e623d5bcd8ce1c5)
(and (HasTypeFuel @u0
@x1
Prims.string)

;; def=SimplePrintf.fst(105,35-105,64); use=SimplePrintf.fst(105,35-105,64)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (Prims.list SimplePrintf.dir)
(SimplePrintf.parse_format_string @x1)))
))
...
@x1
Tm_refine_4135b6ad5efaf29d2e623d5bcd8ce1c5))
:qid refinement_interpretation_Tm_refine_4135b6ad5efaf29d2e623d5bcd8ce1c5))

:named refinement_interpretation_Tm_refine_4135b6ad5efaf29d2e623d5bcd8ce1c5))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name FStar.Pervasives.Native.__proj__Some__item__v; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,11-33,12); use=FStar.Pervasives.Native.fst(33,11-33,12)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! (HasType Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9
Tm_type)
:named kinding_Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3873417a0c5a715c94309020865ce362
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(48,4-55,25); use=SimplePrintf.fst(55,15-56,22)
...
:named kinding_Tm_arrow_3873417a0c5a715c94309020865ce362))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_7de968e83fab2a5ec34920f38db5f8bf
;;; Fact-ids: Name SimplePrintf.example1; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(63,44-63,45); use=SimplePrintf.fst(63,49-63,50)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_7de968e83fab2a5ec34920f38db5f8bf
@x0)
@x0)
 

:pattern ((ApplyTT Tm_abs_7de968e83fab2a5ec34920f38db5f8bf
@x0))
:qid interpretation_Tm_abs_7de968e83fab2a5ec34920f38db5f8bf))

:named interpretation_Tm_abs_7de968e83fab2a5ec34920f38db5f8bf))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_38ff19cc99169dfd57f9a39a25e91a03
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(56,39-60,60); use=SimplePrintf.fst(56,39-60,60)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_38ff19cc99169dfd57f9a39a25e91a03 @x1
@x2
@x3)
@x0)
(Prims.strcat (ApplyTT @x1
(let ((@lb4 (SimplePrintf.Arg__0 (Prims.Cons_hd @x3))))
(ite (is-SimplePrintf.Bool @lb4)
(Prims.string_of_bool @x2)
(ite (is-SimplePrintf.Int @lb4)
(Prims.string_of_int @x2)
(ite (is-SimplePrintf.Char @lb4)
(FStar.String.string_of_char @x2)
(ite (is-SimplePrintf.String @lb4)
@x2
Tm_unit))))))
@x0))
 

:pattern ((ApplyTT (Tm_abs_38ff19cc99169dfd57f9a39a25e91a03 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_38ff19cc99169dfd57f9a39a25e91a03))

:named interpretation_Tm_abs_38ff19cc99169dfd57f9a39a25e91a03))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_38f0e3de21ebfcefba9633e487c58028
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(56,8-60,61); use=SimplePrintf.fst(56,8-60,61)
(forall ((@x0 Term) (@u1 Fuel) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_38f0e3de21ebfcefba9633e487c58028 @u1
@x2
@x3)
@x0)
(SimplePrintf.string_of_dirs.fuel_instrumented @u1
(Prims.Cons_tl @x3)
(Tm_abs_38ff19cc99169dfd57f9a39a25e91a03 @x2
@x0
@x3)))
 

:pattern ((ApplyTT (Tm_abs_38f0e3de21ebfcefba9633e487c58028 @u1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_38f0e3de21ebfcefba9633e487c58028))

:named interpretation_Tm_abs_38f0e3de21ebfcefba9633e487c58028))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(52,37-52,63); use=SimplePrintf.fst(52,37-52,63)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56 @x1
@x2)
@x0)
(ApplyTT @x1
(Prims.strcat (FStar.String.string_of_char (SimplePrintf.Lit__0 (Prims.Cons_hd @x2)))
@x0)))
 

:pattern ((ApplyTT (Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56))

:named interpretation_Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_4135b6ad5efaf29d2e623d5bcd8ce1c5
;;; Fact-ids: Name SimplePrintf.valid_format_string; Namespace SimplePrintf
(assert (! (iff (Valid (Prims.hasEq Tm_refine_4135b6ad5efaf29d2e623d5bcd8ce1c5))
(Valid (Prims.hasEq Prims.string)))
:named haseqTm_refine_4135b6ad5efaf29d2e623d5bcd8ce1c5))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(47,8-47,22); use=SimplePrintf.fst(47,8-47,22)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType SimplePrintf.string_of_dirs@tok
Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9))
...
:named function_token_typing_SimplePrintf.string_of_dirs))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: SimplePrintf.string_of_dirs
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(47,8-47,22); use=SimplePrintf.fst(47,8-47,22)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
...
(HasType @x2
Tm_arrow_70affe4dada4ca8ba18740c614ba5211))
(= (SimplePrintf.string_of_dirs.fuel_instrumented (SFuel @u0)
@x1
@x2)
(let ((@lb3 @x1))
(ite (is-Prims.Nil @lb3)
...
(ite (and (is-Prims.Cons @lb3)
(is-SimplePrintf.Lit (Prims.Cons_hd @lb3)))
(SimplePrintf.string_of_dirs.fuel_instrumented @u0
(Prims.Cons_tl @lb3)
(Tm_abs_0bd56dd4c7bfbd5ea1a6e0a2d18c2e56 @x2
@lb3))
(ite (and (is-Prims.Cons @lb3)
(is-SimplePrintf.Arg (Prims.Cons_hd @lb3)))
(Tm_abs_38f0e3de21ebfcefba9633e487c58028 @u0
@x2
@lb3)
Tm_unit))))))
 :weight 0
...
:pattern ((SimplePrintf.string_of_dirs.fuel_instrumented (SFuel @u0)
@x1
@x2))
:qid equation_with_fuel_SimplePrintf.string_of_dirs.fuel_instrumented))

:named equation_with_fuel_SimplePrintf.string_of_dirs.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: SimplePrintf.parse_format_pure
;;; Fact-ids: Name SimplePrintf.parse_format_pure; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(85,8-85,25); use=SimplePrintf.fst(85,8-85,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
(Prims.list (FStar.String.char Dummy_value)))
(= (SimplePrintf.parse_format_pure.fuel_instrumented (SFuel @u0)
@x1)
(let ((@lb2 @x1))
(ite (is-Prims.Nil @lb2)
(FStar.Pervasives.Native.Some (Prims.list SimplePrintf.dir)
(Prims.Nil SimplePrintf.dir))
(ite (and (is-Prims.Cons @lb2)
(= (Prims.Cons_hd @lb2)
(FStar.Char.__char_of_int (BoxInt 37)))
(is-Prims.Nil (Prims.Cons_tl @lb2)))
(FStar.Pervasives.Native.None (Prims.list SimplePrintf.dir))
(ite (and (is-Prims.Cons @lb2)
(= (Prims.Cons_hd @lb2)
(FStar.Char.__char_of_int (BoxInt 37)))
(is-Prims.Cons (Prims.Cons_tl @lb2)))
(let ((@lb3 (Prims.Cons_hd (Prims.Cons_tl @lb2))))
(ite (= @lb3
(FStar.Char.__char_of_int (BoxInt 37)))
(SimplePrintf.add_dir (SimplePrintf.Lit (FStar.Char.__char_of_int (BoxInt 37)))
(SimplePrintf.parse_format_pure.fuel_instrumented @u0
(Prims.Cons_tl (Prims.Cons_tl @lb2))))
(ite (= @lb3
(FStar.Char.__char_of_int (BoxInt 98)))
(SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Bool@tok)
(SimplePrintf.parse_format_pure.fuel_instrumented @u0
(Prims.Cons_tl (Prims.Cons_tl @lb2))))
(ite (= @lb3
(FStar.Char.__char_of_int (BoxInt 100)))
(SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Int@tok)
(SimplePrintf.parse_format_pure.fuel_instrumented @u0
(Prims.Cons_tl (Prims.Cons_tl @lb2))))
(ite (= @lb3
(FStar.Char.__char_of_int (BoxInt 99)))
(SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Char@tok)
(SimplePrintf.parse_format_pure.fuel_instrumented @u0
(Prims.Cons_tl (Prims.Cons_tl @lb2))))
(ite (= @lb3
(FStar.Char.__char_of_int (BoxInt 115)))
(SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.String@tok)
(SimplePrintf.parse_format_pure.fuel_instrumented @u0
(Prims.Cons_tl (Prims.Cons_tl @lb2))))
(FStar.Pervasives.Native.None (Prims.list SimplePrintf.dir))))))))
(ite (is-Prims.Cons @lb2)
(SimplePrintf.add_dir (SimplePrintf.Lit (Prims.Cons_hd @lb2))
(SimplePrintf.parse_format_pure.fuel_instrumented @u0
(Prims.Cons_tl @lb2)))
Tm_unit)))))))
 :weight 0
...
:pattern ((SimplePrintf.parse_format_pure.fuel_instrumented (SFuel @u0)
@x1))
:qid equation_with_fuel_SimplePrintf.parse_format_pure.fuel_instrumented))

:named equation_with_fuel_SimplePrintf.parse_format_pure.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for SimplePrintf.parse_format_string
;;; Fact-ids: Name SimplePrintf.parse_format_string; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(102,4-102,23); use=SimplePrintf.fst(102,4-102,23)
(forall ((@x0 Term))
 (! (= (SimplePrintf.parse_format_string @x0)
(SimplePrintf.parse_format_pure (FStar.String.list_of_string @x0)))
 

:pattern ((SimplePrintf.parse_format_string @x0))
:qid equation_SimplePrintf.parse_format_string))

:named equation_SimplePrintf.parse_format_string))
;;;;;;;;;;;;;;;;Equation for SimplePrintf.add_dir
;;; Fact-ids: Name SimplePrintf.add_dir; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(79,4-79,11); use=SimplePrintf.fst(79,4-79,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (SimplePrintf.add_dir @x0
@x1)
(let ((@lb2 @x1))
(ite (is-FStar.Pervasives.Native.None @lb2)
(FStar.Pervasives.Native.None (Prims.list SimplePrintf.dir))
(ite (is-FStar.Pervasives.Native.Some @lb2)
(FStar.Pervasives.Native.Some (Prims.list SimplePrintf.dir)
(Prims.Cons SimplePrintf.dir
@x0
(FStar.Pervasives.Native.Some_v @lb2)))
Tm_unit))))
 

:pattern ((SimplePrintf.add_dir @x0
@x1))
:qid equation_SimplePrintf.add_dir))

:named equation_SimplePrintf.add_dir))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(40,21-48,15); use=SimplePrintf.fst(47,23-48,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9)
...
@x1
Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9))
:qid SimplePrintf_pre_typing_Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9))

:named SimplePrintf_pre_typing_Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(48,4-55,25); use=SimplePrintf.fst(55,15-56,22)
...
:named SimplePrintf_pre_typing_Tm_arrow_3873417a0c5a715c94309020865ce362))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(40,21-48,15); use=SimplePrintf.fst(47,23-48,15)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid SimplePrintf_interpretation_Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid SimplePrintf_interpretation_Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9))
:qid SimplePrintf_interpretation_Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9))

:named SimplePrintf_interpretation_Tm_arrow_4d0f1b84ba8e0ad172ca858c9d7c2aa9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3873417a0c5a715c94309020865ce362
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(48,4-55,25); use=SimplePrintf.fst(55,15-56,22)
...
SimplePrintf.string_of_dirs@tok))
:named @kick_partial_app_360a1cc39c78f54f2776dbae1a996fb4))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(47,8-47,22); use=SimplePrintf.fst(47,8-47,22)
...
@x1
@x2)
(SimplePrintf.string_of_dirs.fuel_instrumented ZFuel
@x1
@x2))
...
@x1
@x2))
:qid @fuel_irrelevance_SimplePrintf.string_of_dirs.fuel_instrumented))

:named @fuel_irrelevance_SimplePrintf.string_of_dirs.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name SimplePrintf.parse_format_pure; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(85,8-85,25); use=SimplePrintf.fst(85,8-85,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (= (SimplePrintf.parse_format_pure.fuel_instrumented (SFuel @u0)
@x1)
(SimplePrintf.parse_format_pure.fuel_instrumented ZFuel
@x1))
 

:pattern ((SimplePrintf.parse_format_pure.fuel_instrumented (SFuel @u0)
@x1))
:qid @fuel_irrelevance_SimplePrintf.parse_format_pure.fuel_instrumented))

:named @fuel_irrelevance_SimplePrintf.parse_format_pure.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name SimplePrintf.string_of_dirs; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(47,8-47,22); use=SimplePrintf.fst(47,8-47,22)
(forall ((@x0 Term) (@x1 Term))
 (! (= (SimplePrintf.string_of_dirs @x0
@x1)
(SimplePrintf.string_of_dirs.fuel_instrumented MaxFuel
@x0
@x1))
...
:pattern ((SimplePrintf.string_of_dirs @x0
@x1))
:qid @fuel_correspondence_SimplePrintf.string_of_dirs.fuel_instrumented))

:named @fuel_correspondence_SimplePrintf.string_of_dirs.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name SimplePrintf.parse_format_pure; Namespace SimplePrintf
(assert (! 
;; def=SimplePrintf.fst(85,8-85,25); use=SimplePrintf.fst(85,8-85,25)
(forall ((@x0 Term))
 (! (= (SimplePrintf.parse_format_pure @x0)
(SimplePrintf.parse_format_pure.fuel_instrumented MaxFuel
@x0))
 

:pattern ((SimplePrintf.parse_format_pure @x0))
:qid @fuel_correspondence_SimplePrintf.parse_format_pure.fuel_instrumented))

:named @fuel_correspondence_SimplePrintf.parse_format_pure.fuel_instrumented))
(push) ;; push{2

; Starting query at SimplePrintf.fst(110,6-110,67)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_126f729eec635bc6a3e5b51a6eb88afb () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_126f729eec635bc6a3e5b51a6eb88afb
Tm_type)
:named refinement_kinding_Tm_refine_126f729eec635bc6a3e5b51a6eb88afb))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=SimplePrintf.fst(108,4-108,68); use=SimplePrintf.fst(108,4-108,68)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_126f729eec635bc6a3e5b51a6eb88afb)
(and (HasTypeFuel @u0
@x1
Prims.string)

;; def=Prims.fst(180,31-180,42); use=Prims.fst(180,31-180,42)
(= (let ((@lb2 (let ((@lb2 (FStar.String.list_of_string @x1)))
(ite (is-Prims.Nil @lb2)
(FStar.Pervasives.Native.Some (Prims.list SimplePrintf.dir)
(Prims.Nil SimplePrintf.dir))
(ite (and (is-Prims.Cons @lb2)
...
(FStar.Char.__char_of_int (BoxInt 37)))
(SimplePrintf.add_dir (SimplePrintf.Lit (FStar.Char.__char_of_int (BoxInt 37)))
(SimplePrintf.parse_format_pure (Prims.Cons_tl (Prims.Cons_tl @lb2))))
(ite (= @lb3
(FStar.Char.__char_of_int (BoxInt 98)))
(SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Bool@tok)
(SimplePrintf.parse_format_pure (Prims.Cons_tl (Prims.Cons_tl @lb2))))
...
(ite (is-Prims.Cons @lb2)
(SimplePrintf.add_dir (SimplePrintf.Lit (Prims.Cons_hd @lb2))
(SimplePrintf.parse_format_pure (Prims.Cons_tl @lb2)))
Tm_unit)))))))
(ite (is-FStar.Pervasives.Native.Some @lb2)
(BoxBool true)
(BoxBool false)))
...
@x1
Tm_refine_126f729eec635bc6a3e5b51a6eb88afb))
:qid refinement_interpretation_Tm_refine_126f729eec635bc6a3e5b51a6eb88afb))

:named refinement_interpretation_Tm_refine_126f729eec635bc6a3e5b51a6eb88afb))
;;;;;;;;;;;;;;;;haseq for Tm_refine_126f729eec635bc6a3e5b51a6eb88afb
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_126f729eec635bc6a3e5b51a6eb88afb))
(Valid (Prims.hasEq Prims.string)))
:named haseqTm_refine_126f729eec635bc6a3e5b51a6eb88afb))
(declare-fun Tm_refine_fc71fc3a750dc06b1ee94f3965f657c3 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_fc71fc3a750dc06b1ee94f3965f657c3
Tm_type)
:named refinement_kinding_Tm_refine_fc71fc3a750dc06b1ee94f3965f657c3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=SimplePrintf.fst(110,28-110,29)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_fc71fc3a750dc06b1ee94f3965f657c3)
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir)))
...
@x1
Tm_refine_fc71fc3a750dc06b1ee94f3965f657c3))
:qid refinement_interpretation_Tm_refine_fc71fc3a750dc06b1ee94f3965f657c3))

:named refinement_interpretation_Tm_refine_fc71fc3a750dc06b1ee94f3965f657c3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_fc71fc3a750dc06b1ee94f3965f657c3
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_fc71fc3a750dc06b1ee94f3965f657c3))
(Valid (Prims.hasEq (FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir)))))
:named haseqTm_refine_fc71fc3a750dc06b1ee94f3965f657c3))
...
; Encoding query formula : forall (s:
;   Prims.string
;     { (match
...
;             (match c with
;               | '%' ->
;                 SimplePrintf.add_dir (SimplePrintf.Lit '%') (SimplePrintf.parse_format_pure s')
;               | 'b' ->
;                 SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Bool)
;                   (SimplePrintf.parse_format_pure s')
;               | 'd' ->
;                 SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Int)
;                   (SimplePrintf.parse_format_pure s')
;               | 'c' ->
;                 SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Char)
;                   (SimplePrintf.parse_format_pure s')
;               | 's' ->
;                 SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.String)
;                   (SimplePrintf.parse_format_pure s')
;               | _ -> FStar.Pervasives.Native.None)
;             <:
;             FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir)
;           | c :: s' -> SimplePrintf.add_dir (SimplePrintf.Lit c) (SimplePrintf.parse_format_pure s')
;         with
;         | FStar.Pervasives.Native.Some _ -> true
;         | _ -> false) ==
;       true }).
;   Some? (SimplePrintf.parse_format_string s) /\
;   Some? (SimplePrintf.parse_format_string s) /\
;   (forall (return_val: _: FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir) {Some? _}).
;       return_val == SimplePrintf.parse_format_string s ==>
;       (forall (any_result: Prims.list SimplePrintf.dir).
;           (SimplePrintf.parse_format_string s).v == any_result ==>
;           (forall (any_result: SimplePrintf.dir_type (SimplePrintf.parse_format_string s).v).
;               SimplePrintf.string_of_dirs (SimplePrintf.parse_format_string s).v (fun s -> s) ==
;               any_result ==>
;               Prims.has_type (SimplePrintf.string_of_dirs (SimplePrintf.parse_format_string s).v
;                     (fun s -> s))
;                 (match
;                     match
;                       match FStar.String.list_of_string s with
...
;                         (match c with
;                           | '%' ->
;                             SimplePrintf.add_dir (SimplePrintf.Lit '%')
;                               (SimplePrintf.parse_format_pure s')
;                           | 'b' ->
;                             SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Bool)
;                               (SimplePrintf.parse_format_pure s')
...
;                         FStar.Pervasives.Native.option (Prims.list SimplePrintf.dir)
;                       | c :: s' ->
;                         SimplePrintf.add_dir (SimplePrintf.Lit c)
;                           (SimplePrintf.parse_format_pure s')
;                         as proj_ret returns$ Prims.list SimplePrintf.dir
;                     with
;                     | FStar.Pervasives.Native.Some v -> v
;                   with
;                   | [] -> Prims.string
;                   | SimplePrintf.Lit _ :: ds' -> SimplePrintf.dir_type ds'
;                   | SimplePrintf.Arg a :: ds' ->
...
; Context: While encoding a query
; While typechecking the top-level declaration `let sprintf`
...
;; def=Prims.fst(459,77-459,89); use=SimplePrintf.fst(109,40-110,67)
(and 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=SimplePrintf.fst(109,40-109,63)
(or label_1

;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=SimplePrintf.fst(110,6-110,67)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (Prims.list SimplePrintf.dir)
(SimplePrintf.parse_format_string @x0)))
)


;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=SimplePrintf.fst(110,30-110,53)
(or label_2
...
;; def=Prims.fst(356,2-356,58); use=SimplePrintf.fst(110,6-110,67)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Tm_refine_fc71fc3a750dc06b1ee94f3965f657c3)

;; def=Prims.fst(356,26-356,41); use=SimplePrintf.fst(110,6-110,67)
(= @x1
(SimplePrintf.parse_format_string @x0))
)

;; def=Prims.fst(451,66-451,102); use=SimplePrintf.fst(110,6-110,67)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.list SimplePrintf.dir))

;; def=SimplePrintf.fst(47,23-110,54); use=SimplePrintf.fst(110,6-110,67)
(= (FStar.Pervasives.Native.__proj__Some__item__v (Prims.list SimplePrintf.dir)
(SimplePrintf.parse_format_string @x0))
@x2)
)
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(SimplePrintf.dir_type (FStar.Pervasives.Native.__proj__Some__item__v (Prims.list SimplePrintf.dir)
(SimplePrintf.parse_format_string @x0))))

;; def=SimplePrintf.fst(109,6-110,67); use=SimplePrintf.fst(110,6-110,67)
(= (SimplePrintf.string_of_dirs (FStar.Pervasives.Native.__proj__Some__item__v (Prims.list SimplePrintf.dir)
(SimplePrintf.parse_format_string @x0))
Tm_abs_7de968e83fab2a5ec34920f38db5f8bf)
@x3)
)

;; def=SimplePrintf.fst(110,6-110,67); use=SimplePrintf.fst(110,6-110,67)
(or label_3
(HasType (SimplePrintf.string_of_dirs (FStar.Pervasives.Native.__proj__Some__item__v (Prims.list SimplePrintf.dir)
(SimplePrintf.parse_format_string @x0))
Tm_abs_7de968e83fab2a5ec34920f38db5f8bf)
(let ((@lb4 (let ((@lb4 (let ((@lb4 (FStar.String.list_of_string @x0)))
...
(= (Prims.Cons_hd @lb4)
(FStar.Char.__char_of_int (BoxInt 37)))
(is-Prims.Nil (Prims.Cons_tl @lb4)))
(FStar.Pervasives.Native.None (Prims.list SimplePrintf.dir))
(ite (and (is-Prims.Cons @lb4)
(= (Prims.Cons_hd @lb4)
(FStar.Char.__char_of_int (BoxInt 37)))
(is-Prims.Cons (Prims.Cons_tl @lb4)))
(let ((@lb5 (Prims.Cons_hd (Prims.Cons_tl @lb4))))
(ite (= @lb5
(FStar.Char.__char_of_int (BoxInt 37)))
(SimplePrintf.add_dir (SimplePrintf.Lit (FStar.Char.__char_of_int (BoxInt 37)))
(SimplePrintf.parse_format_pure (Prims.Cons_tl (Prims.Cons_tl @lb4))))
(ite (= @lb5
(FStar.Char.__char_of_int (BoxInt 98)))
(SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Bool@tok)
(SimplePrintf.parse_format_pure (Prims.Cons_tl (Prims.Cons_tl @lb4))))
...
(SimplePrintf.add_dir (SimplePrintf.Lit (Prims.Cons_hd @lb4))
(SimplePrintf.parse_format_pure (Prims.Cons_tl @lb4)))
Tm_unit)))))))
...
Prims.string
(ite (and (is-Prims.Cons @lb4)
(is-SimplePrintf.Lit (Prims.Cons_hd @lb4)))
(SimplePrintf.dir_type (Prims.Cons_tl @lb4))
(ite (and (is-Prims.Cons @lb4)
(is-SimplePrintf.Arg (Prims.Cons_hd @lb4)))
(Tm_arrow_3873417a0c5a715c94309020865ce362 @lb4)
Tm_unit))))))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SimplePrintf.sprintf, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_SimplePrintf.dir_type.fuel_instrumented, @fuel_correspondence_SimplePrintf.parse_format_pure.fuel_instrumented, @fuel_correspondence_SimplePrintf.string_of_dirs.fuel_instrumented, @fuel_irrelevance_SimplePrintf.dir_type.fuel_instrumented, @fuel_irrelevance_SimplePrintf.parse_format_pure.fuel_instrumented, @query, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_Prims.Nil, constructor_distinct_Tm_unit, disc_equation_FStar.Pervasives.Native.None, disc_equation_FStar.Pervasives.Native.Some, equation_SimplePrintf.parse_format_string, equation_with_fuel_SimplePrintf.dir_type.fuel_instrumented, equation_with_fuel_SimplePrintf.parse_format_pure.fuel_instrumented, equation_with_fuel_SimplePrintf.string_of_dirs.fuel_instrumented, fuel_guarded_inversion_Prims.list, kinding_Prims.list@tok, kinding_SimplePrintf.dir@tok, lemma_FStar.Pervasives.invertOption, proj_equation_FStar.Pervasives.Native.Some_v, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_126f729eec635bc6a3e5b51a6eb88afb, string_inversion, typing_FStar.String.list_of_string, typing_SimplePrintf.parse_format_string, typing_Tm_abs_38f0e3de21ebfcefba9633e487c58028, typing_Tm_abs_7de968e83fab2a5ec34920f38db5f8bf
