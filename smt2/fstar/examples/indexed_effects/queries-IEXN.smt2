...
; Externals for interface FStar.GSet


; <Skipped #set-options "--initial_fuel 0 --max_fuel 0 --initial_ifuel 0 --max_ifuel 0"/>


; <Start encoding val FStar.GSet.set>

(declare-fun FStar.GSet.set (Term) Term)

(declare-fun FStar.GSet.set@tok () Term)

; </end encoding val FStar.GSet.set>


; <Start encoding val FStar.GSet.equal>

(declare-fun FStar.GSet.equal (Term Term Term) Term)
(declare-fun Tm_arrow_35cb1052d0366adb52076333542bb840 () Term)
(declare-fun FStar.GSet.equal@tok () Term)

; </end encoding val FStar.GSet.equal>


; <Start encoding val FStar.GSet.mem>

(declare-fun FStar.GSet.mem (Term Term Term) Term)
(declare-fun Tm_ghost_arrow_15da4f73668ada884d50a83d03d70ccb () Term)
(declare-fun FStar.GSet.mem@tok () Term)

; </end encoding val FStar.GSet.mem>


; <Start encoding val FStar.GSet.empty>

(declare-fun FStar.GSet.empty (Term) Term)
(declare-fun Tm_arrow_0ae7b6935f44a69f6cf17e49c49b2a2a () Term)
(declare-fun FStar.GSet.empty@tok () Term)

; </end encoding val FStar.GSet.empty>


; <Start encoding val FStar.GSet.singleton>

(declare-fun FStar.GSet.singleton (Term Term) Term)
(declare-fun Tm_arrow_6633841f96bf9b8725c16710303e4e5d () Term)
(declare-fun FStar.GSet.singleton@tok () Term)

; </end encoding val FStar.GSet.singleton>


; <Start encoding val FStar.GSet.union>

(declare-fun FStar.GSet.union (Term Term Term) Term)
(declare-fun Tm_arrow_fb385855314199003ca481b7c0dfc610 () Term)
(declare-fun FStar.GSet.union@tok () Term)

; </end encoding val FStar.GSet.union>


; <Start encoding val FStar.GSet.intersect>

(declare-fun FStar.GSet.intersect (Term Term Term) Term)

(declare-fun FStar.GSet.intersect@tok () Term)

; </end encoding val FStar.GSet.intersect>


; <Start encoding val FStar.GSet.complement>

(declare-fun FStar.GSet.complement (Term Term) Term)
(declare-fun Tm_arrow_b62933ab04a9203e4324a94a69b40af1 () Term)
(declare-fun FStar.GSet.complement@tok () Term)

; </end encoding val FStar.GSet.complement>


; <Start encoding val FStar.GSet.comprehend>

(declare-fun Tm_ghost_arrow_9a34a9deaac3ca72ad48c3ec79b6656c (Term) Term)
(declare-fun FStar.GSet.comprehend (Term Term) Term)

(declare-fun Tm_arrow_929b3a7e500dd332e501d0a68e92077d () Term)
(declare-fun FStar.GSet.comprehend@tok () Term)

; </end encoding val FStar.GSet.comprehend>


; <Start encoding val FStar.GSet.of_set>

(declare-fun FStar.GSet.of_set (Term Term) Term)
(declare-fun Tm_arrow_10987d563e4467dec40be3a47225b6a7 () Term)
(declare-fun FStar.GSet.of_set@tok () Term)

; </end encoding val FStar.GSet.of_set>


; <Start encoding let disjoint>

(declare-fun FStar.GSet.disjoint (Term Term Term) Term)

(declare-fun FStar.GSet.disjoint@tok () Term)
...
(declare-fun FStar.GSet.subset (Term Term Term) Term)

(declare-fun FStar.GSet.subset@tok () Term)

; </end encoding let subset>


; <Start encoding val FStar.GSet.mem_empty>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.mem_empty (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.mem_empty@tok () Term)

; </end encoding val FStar.GSet.mem_empty>


; <Start encoding val FStar.GSet.mem_singleton>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.mem_singleton (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.mem_singleton@tok () Term)

; </end encoding val FStar.GSet.mem_singleton>


; <Start encoding val FStar.GSet.mem_union>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.mem_union (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.mem_union@tok () Term)

; </end encoding val FStar.GSet.mem_union>


; <Start encoding val FStar.GSet.mem_intersect>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.mem_intersect (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.mem_intersect@tok () Term)

; </end encoding val FStar.GSet.mem_intersect>


; <Start encoding val FStar.GSet.mem_complement>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.mem_complement (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.mem_complement@tok () Term)

; </end encoding val FStar.GSet.mem_complement>


; <Start encoding val FStar.GSet.mem_subset>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.mem_subset (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.mem_subset@tok () Term)

; </end encoding val FStar.GSet.mem_subset>


; <Start encoding val FStar.GSet.subset_mem>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.subset_mem (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.subset_mem@tok () Term)

; </end encoding val FStar.GSet.subset_mem>


; <Start encoding val FStar.GSet.comprehend_mem>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.comprehend_mem (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.comprehend_mem@tok () Term)


; </end encoding val FStar.GSet.comprehend_mem>


; <Start encoding val FStar.GSet.mem_of_set>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.mem_of_set (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.mem_of_set@tok () Term)

; </end encoding val FStar.GSet.mem_of_set>


; <Start encoding val FStar.GSet.lemma_equal_intro>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.lemma_equal_intro (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.lemma_equal_intro@tok () Term)

; </end encoding val FStar.GSet.lemma_equal_intro>


; <Start encoding val FStar.GSet.lemma_equal_elim>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.lemma_equal_elim (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.lemma_equal_elim@tok () Term)

; </end encoding val FStar.GSet.lemma_equal_elim>


; <Start encoding val FStar.GSet.lemma_equal_refl>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.lemma_equal_refl (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.lemma_equal_refl@tok () Term)

; </end encoding val FStar.GSet.lemma_equal_refl>


; <Start encoding let disjoint_not_in_both>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.disjoint_not_in_both (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.disjoint_not_in_both@tok () Term)

; </end encoding let disjoint_not_in_both>
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun FStar.GSet.as_set_.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun FStar.GSet.as_set_.fuel_instrumented_token () Term)
(declare-fun FStar.GSet.as_set_ (Term Term) Term)
(declare-fun FStar.GSet.as_set_@tok () Term)
(declare-fun Tm_arrow_cf257d5502972d122cd9e39658e00c68 () Term)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.GSet.lemma_disjoint_subset (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.GSet.lemma_disjoint_subset@tok () Term)

; </end encoding let lemma_disjoint_subset>


; End Externals for interface FStar.GSet
...
; encoding sigelt let exns


; <Start encoding let exns>

(declare-fun IEXN.exns () Term)

; </end encoding let exns>


; encoding sigelt type IEXN.result


; <Start encoding type IEXN.result>

;;;;;;;;;;;;;;;;Constructor
(declare-fun IEXN.result (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun IEXN.result@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun IEXN.V (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun IEXN.V_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun IEXN.V_v (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: IEXN.V
(declare-fun IEXN.V@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun IEXN.E (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun IEXN.E_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun IEXN.E_e (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: IEXN.E
(declare-fun IEXN.E@tok () Term)
;;;;;;;;;;;;;;;;v: a -> result a
(declare-fun Tm_arrow_252f23f60eab38f17ef9168949d3287c () Term)
;;;;;;;;;;;;;;;;e: Prims.exn -> result a
(declare-fun Tm_arrow_5d2cc4e9e1b6e3b8214b6ee4cc07a843 () Term)

; <start constructor IEXN.result>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-IEXN.result ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor IEXN.result>


; <start constructor IEXN.V>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-IEXN.V ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
111)
(= __@x0
(IEXN.V (IEXN.V_a __@x0)
(IEXN.V_v __@x0)))))

; </end constructor IEXN.V>


; <start constructor IEXN.E>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-IEXN.E ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
(IEXN.E (IEXN.E_a __@x0)
(IEXN.E_e __@x0)))))

; </end constructor IEXN.E>


; </end encoding type IEXN.result>


; encoding sigelt val IEXN.uu___is_V


; <Start encoding val IEXN.uu___is_V>

(declare-fun IEXN.uu___is_V (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: result a -> Prims.bool
(declare-fun Tm_arrow_e98bdb5301a2a5019b2188348f09fde2 () Term)
(declare-fun IEXN.uu___is_V@tok () Term)

; </end encoding val IEXN.uu___is_V>


; encoding sigelt let uu___is_V


; <Skipped let uu___is_V/>


; encoding sigelt val IEXN.__proj__V__item__v


; <Start encoding val IEXN.__proj__V__item__v>

(declare-fun Tm_refine_7238506d51a0bcd660adb39c15951fa1 (Term) Term)
(declare-fun IEXN.__proj__V__item__v (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: result a {V? _} -> a
(declare-fun Tm_arrow_110c27a6db38a34189baf3febc01949c () Term)
(declare-fun IEXN.__proj__V__item__v@tok () Term)

; </end encoding val IEXN.__proj__V__item__v>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IEXN.uu___is_V; Namespace IEXN
(assert (! 
;; def=IEXN.fst(28,4-28,5); use=IEXN.fst(28,4-28,5)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(IEXN.result @x0)))
(HasType (IEXN.uu___is_V @x0
@x1)
Prims.bool))
 

:pattern ((IEXN.uu___is_V @x0
@x1))
:qid typing_IEXN.uu___is_V))

:named typing_IEXN.uu___is_V))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(27,10-27,16); use=IEXN.fst(27,10-27,16)
(forall ((@x0 Term))
 (! (= (ApplyTT IEXN.result@tok
@x0)
(IEXN.result @x0))
 

:pattern ((ApplyTT IEXN.result@tok
@x0))

:pattern ((IEXN.result @x0))
:qid token_correspondence_IEXN.result@tok))

:named token_correspondence_IEXN.result@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(28,4-28,5); use=IEXN.fst(28,4-28,5)
...
@x2)
(IEXN.result @x3)))
:qid subterm_ordering_IEXN.V))

:named subterm_ordering_IEXN.V))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(IEXN.E @x1
@x2)
...
@x2)
(IEXN.result @x3)))
:qid subterm_ordering_IEXN.E))

:named subterm_ordering_IEXN.E))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name IEXN.__proj__V__item__v; Namespace IEXN
(assert (! 
;; def=IEXN.fst(28,4-28,5); use=IEXN.fst(28,4-28,5)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_7238506d51a0bcd660adb39c15951fa1 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_7238506d51a0bcd660adb39c15951fa1 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_7238506d51a0bcd660adb39c15951fa1))

:named refinement_kinding_Tm_refine_7238506d51a0bcd660adb39c15951fa1))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7238506d51a0bcd660adb39c15951fa1 @x2))
(and (HasTypeFuel @u0
@x1
(IEXN.result @x2))

;; def=IEXN.fst(28,4-28,5); use=IEXN.fst(28,4-28,5)
(BoxBool_proj_0 (IEXN.uu___is_V @x2
@x1))
))
...
@x1
(Tm_refine_7238506d51a0bcd660adb39c15951fa1 @x2)))
:qid refinement_interpretation_Tm_refine_7238506d51a0bcd660adb39c15951fa1))

:named refinement_interpretation_Tm_refine_7238506d51a0bcd660adb39c15951fa1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
:pattern ((IEXN.V @x0
@x1))
:qid projection_inverse_IEXN.V_v))

:named projection_inverse_IEXN.V_v))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(28,4-28,5); use=IEXN.fst(28,4-28,5)
...
:pattern ((IEXN.V @x0
@x1))
:qid projection_inverse_IEXN.V_a))

:named projection_inverse_IEXN.V_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
...
:pattern ((IEXN.E @x0
@x1))
:qid projection_inverse_IEXN.E_e))

:named projection_inverse_IEXN.E_e))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
...
:pattern ((IEXN.E @x0
@x1))
:qid projection_inverse_IEXN.E_a))

:named projection_inverse_IEXN.E_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! (is-Tm_arrow (PreType IEXN.result@tok))
:named pre_kinding_IEXN.result@tok))
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! (and (IsTotFun IEXN.result@tok)

;; def=IEXN.fst(27,10-27,16); use=IEXN.fst(27,10-27,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (IEXN.result @x0)
Tm_type))
 

:pattern ((IEXN.result @x0))
:qid kinding_IEXN.result@tok))
)
:named kinding_IEXN.result@tok))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_7238506d51a0bcd660adb39c15951fa1
;;; Fact-ids: Name IEXN.__proj__V__item__v; Namespace IEXN
(assert (! 
;; def=IEXN.fst(28,4-28,5); use=IEXN.fst(28,4-28,5)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7238506d51a0bcd660adb39c15951fa1 @x0)))
(Valid (Prims.hasEq (IEXN.result @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7238506d51a0bcd660adb39c15951fa1 @x0))))
:qid haseqTm_refine_7238506d51a0bcd660adb39c15951fa1))

:named haseqTm_refine_7238506d51a0bcd660adb39c15951fa1))
...
@x1
(IEXN.result @x2)))
:qid fuel_guarded_inversion_IEXN.result))

:named fuel_guarded_inversion_IEXN.result))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! (= 105
(Term_constr_id IEXN.result@tok))
:named fresh_token_IEXN.result@tok))
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (IEXN.uu___is_V @x0
@x1)
(BoxBool (is-IEXN.V @x1)))
 

:pattern ((IEXN.uu___is_V @x0
@x1))
:qid disc_equation_IEXN.V))

:named disc_equation_IEXN.V))
...
@x2)
(IEXN.result @x1)))
:qid data_typing_intro_IEXN.V@tok))

:named data_typing_intro_IEXN.V@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
...
@x2)
(IEXN.result @x1)))
:qid data_typing_intro_IEXN.E@tok))

:named data_typing_intro_IEXN.E@tok))
...
@x2)
(IEXN.result @x3)))
:qid data_elim_IEXN.V))

:named data_elim_IEXN.V))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
...
@x2)
(IEXN.result @x3)))
:qid data_elim_IEXN.E))

:named data_elim_IEXN.E))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 104
(Term_constr_id (IEXN.result @x0)))
 

:pattern ((IEXN.result @x0))
:qid constructor_distinct_IEXN.result))

:named constructor_distinct_IEXN.result))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(28,4-28,5); use=IEXN.fst(28,4-28,5)
(forall ((@x0 Term) (@x1 Term))
 (! (= 111
(Term_constr_id (IEXN.V @x0
@x1)))
 

:pattern ((IEXN.V @x0
@x1))
:qid constructor_distinct_IEXN.V))

:named constructor_distinct_IEXN.V))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name IEXN.result; Namespace IEXN; Name IEXN.V; Namespace IEXN; Name IEXN.E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
(forall ((@x0 Term) (@x1 Term))
 (! (= 116
(Term_constr_id (IEXN.E @x0
@x1)))
 

:pattern ((IEXN.E @x0
@x1))
:qid constructor_distinct_IEXN.E))

:named constructor_distinct_IEXN.E))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x0
(IEXN.result @x2)))
:qid IEXN_pretyping_058b1b287b2f186afb65e01a1d201487))

:named IEXN_pretyping_058b1b287b2f186afb65e01a1d201487))
(push) ;; push{2

; Starting query at IEXN.fst(28,10-28,11)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (projectee: _: IEXN.result a {V? _}).
;   (*  - Could not prove post-condition
; *) ~(V? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__V__item__v`
...
Tm_type)
(HasType @x1
(Tm_refine_7238506d51a0bcd660adb39c15951fa1 @x0))

;; def=IEXN.fst(28,4-28,5); use=IEXN.fst(28,10-28,11)
(not 
;; def=IEXN.fst(28,4-28,5); use=IEXN.fst(28,10-28,11)
(BoxBool_proj_0 (IEXN.uu___is_V @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IEXN.__proj__V__item__v, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_7238506d51a0bcd660adb39c15951fa1
...
; encoding sigelt let __proj__V__item__v


; <Skipped let __proj__V__item__v/>


; encoding sigelt val IEXN.uu___is_E


; <Start encoding val IEXN.uu___is_E>

(declare-fun IEXN.uu___is_E (Term Term) Term)

(declare-fun IEXN.uu___is_E@tok () Term)

; </end encoding val IEXN.uu___is_E>
...
; encoding sigelt val IEXN.__proj__E__item__e


; <Start encoding val IEXN.__proj__E__item__e>

(declare-fun Tm_refine_c4a45b085cc780dedd2505084f3c2549 (Term) Term)
(declare-fun IEXN.__proj__E__item__e (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: result a {E? _} -> Prims.exn
(declare-fun Tm_arrow_1030de00e13aac3b0d4f86c2f3ec3f6c () Term)
(declare-fun IEXN.__proj__E__item__e@tok () Term)

; </end encoding val IEXN.__proj__E__item__e>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IEXN.uu___is_E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(IEXN.result @x0)))
(HasType (IEXN.uu___is_E @x0
@x1)
Prims.bool))
 

:pattern ((IEXN.uu___is_E @x0
@x1))
:qid typing_IEXN.uu___is_E))

:named typing_IEXN.uu___is_E))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name IEXN.__proj__E__item__e; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_c4a45b085cc780dedd2505084f3c2549 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_c4a45b085cc780dedd2505084f3c2549 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_c4a45b085cc780dedd2505084f3c2549))

:named refinement_kinding_Tm_refine_c4a45b085cc780dedd2505084f3c2549))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name IEXN.__proj__E__item__e; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c4a45b085cc780dedd2505084f3c2549 @x2))
(and (HasTypeFuel @u0
@x1
(IEXN.result @x2))

;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
(BoxBool_proj_0 (IEXN.uu___is_E @x2
@x1))
))
...
@x1
(Tm_refine_c4a45b085cc780dedd2505084f3c2549 @x2)))
:qid refinement_interpretation_Tm_refine_c4a45b085cc780dedd2505084f3c2549))

:named refinement_interpretation_Tm_refine_c4a45b085cc780dedd2505084f3c2549))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c4a45b085cc780dedd2505084f3c2549
;;; Fact-ids: Name IEXN.__proj__E__item__e; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c4a45b085cc780dedd2505084f3c2549 @x0)))
(Valid (Prims.hasEq (IEXN.result @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c4a45b085cc780dedd2505084f3c2549 @x0))))
:qid haseqTm_refine_c4a45b085cc780dedd2505084f3c2549))

:named haseqTm_refine_c4a45b085cc780dedd2505084f3c2549))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name IEXN.uu___is_E; Namespace IEXN
(assert (! 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,4-29,5)
(forall ((@x0 Term) (@x1 Term))
 (! (= (IEXN.uu___is_E @x0
@x1)
(BoxBool (is-IEXN.E @x1)))
 

:pattern ((IEXN.uu___is_E @x0
@x1))
:qid disc_equation_IEXN.E))

:named disc_equation_IEXN.E))
(push) ;; push{2

; Starting query at IEXN.fst(29,10-29,11)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (projectee: _: IEXN.result a {E? _}).
;   (*  - Could not prove post-condition
; *) ~(E? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__E__item__e`
...
Tm_type)
(HasType @x1
(Tm_refine_c4a45b085cc780dedd2505084f3c2549 @x0))

;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,10-29,11)
(not 
;; def=IEXN.fst(29,4-29,5); use=IEXN.fst(29,10-29,11)
(BoxBool_proj_0 (IEXN.uu___is_E @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IEXN.__proj__E__item__e, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_c4a45b085cc780dedd2505084f3c2549
...
; encoding sigelt let __proj__E__item__e


; <Skipped let __proj__E__item__e/>


; encoding sigelt let iex_pre


; <Start encoding let iex_pre>

(declare-fun IEXN.iex_pre () Term)

; </end encoding let iex_pre>


; encoding sigelt let iex_post'


; <Start encoding let iex_post'>

(declare-fun IEXN.iex_post_ (Term Term) Term)

(declare-fun IEXN.iex_post_@tok () Term)
(declare-fun Tm_refine_4c9132b1955edfb54d5f404e6d82a28b (Term Term) Term)
;;;;;;;;;;;;;;;;_: result a {pre} -> Prims.GTot Type
(declare-fun Tm_arrow_cfa61d3541f04736bab25048ee332d1f (Term Term) Term)

; </end encoding let iex_post'>
...
(declare-fun IEXN.iex_post (Term) Term)

(declare-fun IEXN.iex_post@tok () Term)

; </end encoding let iex_post>


; encoding sigelt let iex_wp


; <Start encoding let iex_wp>

(declare-fun IEXN.iex_wp (Term) Term)

(declare-fun IEXN.iex_wp@tok () Term)
;;;;;;;;;;;;;;;;es: exns -> _: iex_post a -> Prims.GTot FStar.Pervasives.ex_pre
(declare-fun Tm_arrow_91efedbd438237a87d6367cde0aa61e4 (Term) Term)

; </end encoding let iex_wp>


; encoding sigelt let iex_return


; <Start encoding let iex_return>

(declare-fun IEXN.iex_return (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> es: exns -> p: iex_post a -> Prims.GTot Type
(declare-fun Tm_arrow_59d5c9d475b972859b45be5792511512 () Term)
(declare-fun IEXN.iex_return@tok () Term)

; </end encoding let iex_return>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IEXN.iex_wp; Namespace IEXN
(assert (! 
;; def=IEXN.fst(35,4-35,10); use=IEXN.fst(35,4-35,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (IEXN.iex_wp @x0)
Tm_type))
 

:pattern ((IEXN.iex_wp @x0))
:qid typing_IEXN.iex_wp))

:named typing_IEXN.iex_wp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IEXN.iex_post'; Namespace IEXN
(assert (! 
;; def=IEXN.fst(33,4-33,13); use=IEXN.fst(33,4-33,13)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (IEXN.iex_post_ @x0
@x1)
Tm_type))
 

:pattern ((IEXN.iex_post_ @x0
@x1))
:qid typing_IEXN.iex_post_))

:named typing_IEXN.iex_post_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IEXN.iex_post; Namespace IEXN
(assert (! 
;; def=IEXN.fst(34,4-34,12); use=IEXN.fst(34,4-34,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (IEXN.iex_post @x0)
Tm_type))
 

:pattern ((IEXN.iex_post @x0))
:qid typing_IEXN.iex_post))

:named typing_IEXN.iex_post))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IEXN.exns; Namespace IEXN
(assert (! (HasType IEXN.exns
Tm_type)
:named typing_IEXN.exns))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.GSet.set; Namespace FStar.GSet
(assert (! 
;; def=FStar.GSet.fsti(25,4-25,7); use=FStar.GSet.fsti(25,4-25,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.GSet.set @x0)
Tm_type))
 

:pattern ((FStar.GSet.set @x0))
:qid typing_FStar.GSet.set))

:named typing_FStar.GSet.set))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;; Fact-ids: Name IEXN.iex_post'; Namespace IEXN
(assert (! 
;; def=IEXN.fst(33,36-33,53); use=IEXN.fst(33,36-33,53)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_4c9132b1955edfb54d5f404e6d82a28b @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_4c9132b1955edfb54d5f404e6d82a28b @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_4c9132b1955edfb54d5f404e6d82a28b))

:named refinement_kinding_Tm_refine_4c9132b1955edfb54d5f404e6d82a28b))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.squash; Namespace Prims
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4c9132b1955edfb54d5f404e6d82a28b @x2
@x3))
(and (HasTypeFuel @u0
@x1
(IEXN.result @x2))

;; def=IEXN.fst(33,24-33,27); use=IEXN.fst(33,48-33,51)
(Valid 
;; def=IEXN.fst(33,24-33,27); use=IEXN.fst(33,48-33,51)
@x3
)
...
(Tm_refine_4c9132b1955edfb54d5f404e6d82a28b @x2
@x3)))
:qid refinement_interpretation_Tm_refine_4c9132b1955edfb54d5f404e6d82a28b))

:named refinement_interpretation_Tm_refine_4c9132b1955edfb54d5f404e6d82a28b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.squash; Namespace Prims
(assert (! 
;; def=Prims.fst(117,32-117,42); use=Prims.fst(117,32-117,42)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_cfa61d3541f04736bab25048ee332d1f
;;; Fact-ids: Name IEXN.iex_post'; Namespace IEXN
(assert (! 
;; def=IEXN.fst(33,36-33,67); use=IEXN.fst(33,36-33,67)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_cfa61d3541f04736bab25048ee332d1f @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_cfa61d3541f04736bab25048ee332d1f @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_cfa61d3541f04736bab25048ee332d1f))

:named kinding_Tm_arrow_cfa61d3541f04736bab25048ee332d1f))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_91efedbd438237a87d6367cde0aa61e4
;;; Fact-ids: Name IEXN.iex_wp; Namespace IEXN
(assert (! 
;; def=IEXN.fst(35,28-35,61); use=IEXN.fst(35,28-35,61)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_91efedbd438237a87d6367cde0aa61e4 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_91efedbd438237a87d6367cde0aa61e4 @x0)
Tm_type))
:qid kinding_Tm_arrow_91efedbd438237a87d6367cde0aa61e4))

:named kinding_Tm_arrow_91efedbd438237a87d6367cde0aa61e4))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_4c9132b1955edfb54d5f404e6d82a28b
;;; Fact-ids: Name IEXN.iex_post'; Namespace IEXN
(assert (! 
;; def=IEXN.fst(33,36-33,53); use=IEXN.fst(33,36-33,53)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4c9132b1955edfb54d5f404e6d82a28b @x0
@x1)))
(Valid (Prims.hasEq (IEXN.result @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4c9132b1955edfb54d5f404e6d82a28b @x0
@x1))))
:qid haseqTm_refine_4c9132b1955edfb54d5f404e6d82a28b))

:named haseqTm_refine_4c9132b1955edfb54d5f404e6d82a28b))
...
(assert (! (HasType IEXN.exns
Tm_type)
:named function_token_typing_IEXN.exns))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name FStar.Pervasives.ex_pre; Namespace FStar.Pervasives
(assert (! (HasType FStar.Pervasives.ex_pre
Tm_type)
...
;;;;;;;;;;;;;;;;Equation for IEXN.iex_wp
;;; Fact-ids: Name IEXN.iex_wp; Namespace IEXN
(assert (! 
;; def=IEXN.fst(35,4-35,10); use=IEXN.fst(35,4-35,10)
(forall ((@x0 Term))
 (! (= (IEXN.iex_wp @x0)
(Tm_arrow_91efedbd438237a87d6367cde0aa61e4 @x0))
 

:pattern ((IEXN.iex_wp @x0))
:qid equation_IEXN.iex_wp))

:named equation_IEXN.iex_wp))
;;;;;;;;;;;;;;;;Equation for IEXN.iex_post'
;;; Fact-ids: Name IEXN.iex_post'; Namespace IEXN
(assert (! 
;; def=IEXN.fst(33,4-33,13); use=IEXN.fst(33,4-33,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (IEXN.iex_post_ @x0
@x1)
(Tm_arrow_cfa61d3541f04736bab25048ee332d1f @x1
@x0))
 

:pattern ((IEXN.iex_post_ @x0
@x1))
:qid equation_IEXN.iex_post_))

:named equation_IEXN.iex_post_))
;;;;;;;;;;;;;;;;Equation for IEXN.iex_post
;;; Fact-ids: Name IEXN.iex_post; Namespace IEXN
(assert (! 
;; def=IEXN.fst(34,4-34,12); use=IEXN.fst(34,4-34,12)
...
:pattern ((IEXN.iex_post @x0))
:qid equation_IEXN.iex_post))

:named equation_IEXN.iex_post))
;;;;;;;;;;;;;;;;Equation for IEXN.exns
;;; Fact-ids: Name IEXN.exns; Namespace IEXN
(assert (! (= IEXN.exns
(FStar.GSet.set Prims.exn))
:named equation_IEXN.exns))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_cfa61d3541f04736bab25048ee332d1f @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_cfa61d3541f04736bab25048ee332d1f @x2
@x3)))
:qid IEXN_pre_typing_Tm_arrow_cfa61d3541f04736bab25048ee332d1f))

:named IEXN_pre_typing_Tm_arrow_cfa61d3541f04736bab25048ee332d1f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name IEXN.iex_wp; Namespace IEXN
(assert (! 
;; def=IEXN.fst(35,28-35,61); use=IEXN.fst(35,28-35,61)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_91efedbd438237a87d6367cde0aa61e4 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_91efedbd438237a87d6367cde0aa61e4 @x2)))
:qid IEXN_pre_typing_Tm_arrow_91efedbd438237a87d6367cde0aa61e4))

:named IEXN_pre_typing_Tm_arrow_91efedbd438237a87d6367cde0aa61e4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_cfa61d3541f04736bab25048ee332d1f
;;; Fact-ids: Name IEXN.iex_post'; Namespace IEXN
(assert (! 
;; def=IEXN.fst(33,36-33,67); use=IEXN.fst(33,36-33,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid IEXN_interpretation_Tm_arrow_cfa61d3541f04736bab25048ee332d1f.1))
...
(Tm_arrow_cfa61d3541f04736bab25048ee332d1f @x1
@x2)))
:qid IEXN_interpretation_Tm_arrow_cfa61d3541f04736bab25048ee332d1f))

:named IEXN_interpretation_Tm_arrow_cfa61d3541f04736bab25048ee332d1f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_91efedbd438237a87d6367cde0aa61e4
;;; Fact-ids: Name IEXN.iex_wp; Namespace IEXN
(assert (! 
;; def=IEXN.fst(35,28-35,61); use=IEXN.fst(35,28-35,61)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_91efedbd438237a87d6367cde0aa61e4 @x1))
(and 
;; def=IEXN.fst(35,28-35,61); use=IEXN.fst(35,28-35,61)
...
@x2)
@x3))
:qid IEXN_interpretation_Tm_arrow_91efedbd438237a87d6367cde0aa61e4.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid IEXN_interpretation_Tm_arrow_91efedbd438237a87d6367cde0aa61e4.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_91efedbd438237a87d6367cde0aa61e4 @x1)))
:qid IEXN_interpretation_Tm_arrow_91efedbd438237a87d6367cde0aa61e4))

:named IEXN_interpretation_Tm_arrow_91efedbd438237a87d6367cde0aa61e4))
(push) ;; push{2

; Starting query at IEXN.fst(45,2-49,36)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> Prims.GTot (iex_wp b)
(declare-fun Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552
;;; Fact-ids: 
(assert (! 
;; def=IEXN.fst(41,17-43,32); use=IEXN.fst(43,12-43,32)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552))

:named kinding_Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=IEXN.fst(41,17-43,32); use=IEXN.fst(43,12-43,32)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552 @x2
@x3)))
:qid IEXN_pre_typing_Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552))

:named IEXN_pre_typing_Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552
;;; Fact-ids: 
(assert (! 
;; def=IEXN.fst(41,17-43,32); use=IEXN.fst(43,12-43,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552 @x1
@x2))
(and 
;; def=IEXN.fst(41,17-43,32); use=IEXN.fst(43,12-43,32)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid IEXN_interpretation_Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552.1))
...
(Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552 @x1
@x2)))
:qid IEXN_interpretation_Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552))

:named IEXN_interpretation_Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (wp1: IEXN.iex_wp a)
;   (wp2: (_: a -> Prims.GTot (IEXN.iex_wp b)))
;   (es: IEXN.exns)
;   (p: IEXN.iex_post b).
;   (*  - Could not prove post-condition
; *)
;   forall (return_val: Type).
;     return_val == IEXN.iex_post b ==>
;     (forall (k: IEXN.iex_post b).
;         (forall (rb: IEXN.result b). {:pattern Prims.guard_free (k rb)} p rb ==> k rb) ==>
;         (forall (_: IEXN.result a).
;             (*  - Could not prove post-condition
; *)
;             forall (k: Prims.pure_post Type0).
;               (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;               ~(V? _) /\ ~(E? _) ==> Prims.l_False))


; Context: While encoding a query
; While typechecking the top-level declaration `let iex_bind_wp`
...
;; def=Prims.fst(356,2-356,58); use=IEXN.fst(45,2-49,36)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Tm_type)

;; def=Prims.fst(356,26-356,41); use=IEXN.fst(45,2-49,36)
(= @x6
(IEXN.iex_post @x1))
)

;; def=dummy(0,0-0,0); use=IEXN.fst(45,2-49,36)
(forall ((@x7 Term))
...
(forall ((@x8 Term))
 (! (implies 
;; def=IEXN.fst(46,58-46,62); use=IEXN.fst(46,58-46,62)
(or label_1
...
;; def=IEXN.fst(46,67-46,71); use=IEXN.fst(46,67-46,71)
(Valid 
;; def=IEXN.fst(46,67-46,71); use=IEXN.fst(46,67-46,71)
(ApplyTT @x7
@x8)
...
;; def=dummy(0,0-0,0); use=IEXN.fst(46,5-49,36)
(forall ((@x8 Term))
 (! (implies (HasType @x8
(IEXN.result @x0))
...
;; def=Prims.fst(402,27-402,88); use=IEXN.fst(47,17-49,35)
(forall ((@x10 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=IEXN.fst(47,17-49,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=IEXN.fst(47,17-49,35)
(ApplyTT @x9
@x10)
...
;; def=IEXN.fst(47,18-49,34); use=IEXN.fst(47,18-49,34)
(not 
;; def=IEXN.fst(47,18-49,34); use=IEXN.fst(47,18-49,34)
(BoxBool_proj_0 (IEXN.uu___is_V @x0
@x8))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IEXN.iex_bind_wp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_IEXN.E, disc_equation_IEXN.V, fuel_guarded_inversion_IEXN.result, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let iex_bind_wp


; <Start encoding let iex_bind_wp>

;;;;;;;;;;;;;;;;_: a -> Prims.GTot (iex_wp b)
(declare-fun Tm_arrow_27e3ffe7f7bc2fab3b06d8b5422e0552 (Term Term) Term)
(declare-fun IEXN.iex_bind_wp (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     wp1: iex_wp a ->     wp2: (_: a -> Prims.GTot (iex_wp b)) ->     es: exns ->     p: iex_post b   -> Prims.GTot Type
(declare-fun Tm_arrow_14404311e98051c414cc12147f59948c () Term)
(declare-fun IEXN.iex_bind_wp@tok () Term)

;;;;;;;;;;;;;;;;_: result a -> Prims.GTot Type
(declare-fun Tm_arrow_1be71f19d0a5194a8f9c827bc208ac67 (Term) Term)
(declare-fun Tm_abs_ab844309a35d4c8a9f16ffe4ad068a74 (Term Term Term Term Term) Term)

; </end encoding let iex_bind_wp>


; encoding sigelt let iex_ite_wp


; <Start encoding let iex_ite_wp>

(declare-fun IEXN.iex_ite_wp (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: iex_wp a -> es: exns -> post: iex_post a -> Prims.logical
(declare-fun Tm_arrow_b66d4c105e4a286dbf6dcf7bc1fcbac7 () Term)
(declare-fun IEXN.iex_ite_wp@tok () Term)

; </end encoding let iex_ite_wp>


; encoding sigelt let iex_if_then_else


; <Start encoding let iex_if_then_else>

(declare-fun IEXN.iex_if_then_else (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> p: Type -> wp_then: iex_wp a -> wp_else: iex_wp a -> es: exns -> post: iex_post a   -> Prims.logical
(declare-fun Tm_arrow_418ad2f67329c453e6060c66d9b2032a () Term)
(declare-fun IEXN.iex_if_then_else@tok () Term)

; </end encoding let iex_if_then_else>


; encoding sigelt let iex_stronger


; <Start encoding let iex_stronger>

(declare-fun IEXN.iex_stronger (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp1: iex_wp a -> wp2: iex_wp a -> Prims.logical
(declare-fun Tm_arrow_888b927c18a336c4f9acd0ab15c7fb64 () Term)
(declare-fun IEXN.iex_stronger@tok () Term)

; </end encoding let iex_stronger>


; encoding sigelt let iex_close_wp


; <Start encoding let iex_close_wp>


(declare-fun IEXN.iex_close_wp (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> wp: (_: b -> Prims.GTot (iex_wp a)) -> es: exns -> p: iex_post a   -> Prims.logical
(declare-fun Tm_arrow_50b73ccb44dcd78f4361309056f7b11d () Term)
(declare-fun IEXN.iex_close_wp@tok () Term)


; </end encoding let iex_close_wp>


; encoding sigelt let iex_trivial


; <Start encoding let iex_trivial>

(declare-fun IEXN.iex_trivial (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: iex_wp a -> Prims.logical
(declare-fun Tm_arrow_3e2de23a2197ea856b68e895386f6260 () Term)
(declare-fun IEXN.iex_trivial@tok () Term)

(declare-fun Tm_abs_92e53c4be637ff1df5af2e6f0f9133af (Term) Term)

; </end encoding let iex_trivial>


; encoding sigelt new_effect { IEXN ... }


; <Skipped new_effect { IEXN ... }/>


; encoding sigelt let lift_div_iexn


; <Start encoding let lift_div_iexn>

(declare-fun IEXN.lift_div_iexn (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> es: exns -> p: iex_post a -> Prims.pure_pre
(declare-fun Tm_arrow_8221b6f9043804d3e06ae1dc063216ea () Term)
(declare-fun IEXN.lift_div_iexn@tok () Term)

(declare-fun Tm_abs_34adfb19acbc33f0bc769330c51816d3 (Term Term) Term)

; </end encoding let lift_div_iexn>


; encoding sigelt sub_effect DIV ~> IEXN


; <Skipped sub_effect DIV ~> IEXN/>
...
(declare-fun IEXN.iex_wp_ (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> es: exns -> Type
(declare-fun Tm_arrow_b302b2ee202f3fb078fe82215fe0f55d () Term)
(declare-fun IEXN.iex_wp_@tok () Term)
;;;;;;;;;;;;;;;;_: iex_post a -> iex_pre
(declare-fun Tm_arrow_10fc7cbcb26c365a3d5e435a271308a1 (Term) Term)

; </end encoding let iex_wp'>


; encoding sigelt let op_Greater_Less


; <Start encoding let op_Greater_Less>

(declare-fun IEXN.op_Greater_Less (Term Term Term) Term)
;;;;;;;;;;;;;;;;es: exns -> wp: iex_wp' a es -> iex_wp a
(declare-fun Tm_arrow_4f935b5ce7d66049c6b2fbb584166bc4 () Term)
(declare-fun IEXN.op_Greater_Less@tok () Term)

(declare-fun Tm_abs_a7e999f70d37028aacde650ca99fc193 (Term Term Term) Term)

; </end encoding let op_Greater_Less>


; encoding sigelt val IEXN.raise


; <Start encoding val IEXN.raise>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IEXN.raise (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IEXN.raise@tok () Term)

; </end encoding val IEXN.raise>


; encoding sigelt val IEXN.exception1


; <Start encoding val IEXN.exception1>

(declare-fun IEXN.exception1 (Dummy_sort) Term)

; </end encoding val IEXN.exception1>


; encoding sigelt val IEXN.exception2


; <Start encoding val IEXN.exception2>

(declare-fun IEXN.exception2 (Dummy_sort) Term)

; </end encoding val IEXN.exception2>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.GSet.subset; Namespace FStar.GSet
(assert (! 
;; def=FStar.GSet.fsti(47,5-47,11); use=FStar.GSet.fsti(47,5-47,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(FStar.GSet.set @x0)))
(HasType (FStar.GSet.subset @x0
@x1
@x2)
Tm_type))
 

:pattern ((FStar.GSet.subset @x0
@x1
@x2))
:qid typing_FStar.GSet.subset))

:named typing_FStar.GSet.subset))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.GSet.mem; Namespace FStar.GSet
(assert (! 
;; def=FStar.GSet.fsti(31,4-31,7); use=FStar.GSet.fsti(31,4-31,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(FStar.GSet.set @x0)))
(HasType (FStar.GSet.mem @x0
@x1
@x2)
Prims.bool))
 

:pattern ((FStar.GSet.mem @x0
@x1
@x2))
:qid typing_FStar.GSet.mem))

:named typing_FStar.GSet.mem))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.GSet.empty; Namespace FStar.GSet
(assert (! 
;; def=FStar.GSet.fsti(34,4-34,9); use=FStar.GSet.fsti(34,4-34,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.GSet.empty @x0)
(FStar.GSet.set @x0)))
 

:pattern ((FStar.GSet.empty @x0))
:qid typing_FStar.GSet.empty))

:named typing_FStar.GSet.empty))
;;;;;;;;;;;;;;;;Lemma: FStar.GSet.subset_mem
;;; Fact-ids: Name FStar.GSet.subset_mem; Namespace FStar.GSet
...
;; def=FStar.GSet.fsti(81,13-81,27); use=FStar.GSet.fsti(81,13-81,27)
(Valid 
;; def=FStar.GSet.fsti(81,13-81,27); use=FStar.GSet.fsti(81,13-81,27)
(FStar.GSet.subset @x0
@x1
@x2)
)
)

;; def=FStar.GSet.fsti(82,12-82,45); use=FStar.GSet.fsti(82,12-82,45)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
@x0)

;; def=FStar.GSet.fsti(82,23-82,31); use=FStar.GSet.fsti(82,23-82,31)
(BoxBool_proj_0 (FStar.GSet.mem @x0
@x3
@x1))
)

;; def=FStar.GSet.fsti(82,36-82,44); use=FStar.GSet.fsti(82,36-82,44)
(BoxBool_proj_0 (FStar.GSet.mem @x0
@x3
@x2))
)
...
;;no pats
:qid lemma_FStar.GSet.subset_mem.1))
)
...
@x1
@x2))
:qid lemma_FStar.GSet.subset_mem))
:named lemma_FStar.GSet.subset_mem))
;;;;;;;;;;;;;;;;Lemma: FStar.GSet.mem_subset
;;; Fact-ids: Name FStar.GSet.mem_subset; Namespace FStar.GSet
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=FStar.GSet.fsti(76,13-76,46); use=FStar.GSet.fsti(76,13-76,46)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
@x0)

;; def=FStar.GSet.fsti(76,24-76,32); use=FStar.GSet.fsti(76,24-76,32)
(BoxBool_proj_0 (FStar.GSet.mem @x0
@x3
@x1))
)

;; def=FStar.GSet.fsti(76,37-76,45); use=FStar.GSet.fsti(76,37-76,45)
(BoxBool_proj_0 (FStar.GSet.mem @x0
@x3
@x2))
)
...
;;no pats
:qid lemma_FStar.GSet.mem_subset.1))
)

;; def=FStar.GSet.fsti(77,12-77,26); use=FStar.GSet.fsti(77,12-77,26)
(Valid 
;; def=FStar.GSet.fsti(77,12-77,26); use=FStar.GSet.fsti(77,12-77,26)
(FStar.GSet.subset @x0
@x1
...
@x1
@x2))
:qid lemma_FStar.GSet.mem_subset))
:named lemma_FStar.GSet.mem_subset))
;;;;;;;;;;;;;;;;Lemma: FStar.GSet.mem_empty
;;; Fact-ids: Name FStar.GSet.mem_empty; Namespace FStar.GSet
(assert (! (forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
@x0))
(not (BoxBool_proj_0 (FStar.GSet.mem @x0
@x1
(FStar.GSet.empty @x0)))))
...
@x1
(FStar.GSet.empty @x0)))
:qid lemma_FStar.GSet.mem_empty))
:named lemma_FStar.GSet.mem_empty))
;;;;;;;;;;;;;;;;Equation for FStar.GSet.subset
;;; Fact-ids: Name FStar.GSet.subset; Namespace FStar.GSet
(assert (! 
;; def=FStar.GSet.fsti(47,5-47,11); use=FStar.GSet.fsti(47,5-47,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (FStar.GSet.subset @x0
@x1
@x2))

;; def=FStar.GSet.fsti(47,53-47,84); use=FStar.GSet.fsti(47,53-47,84)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
@x0)

;; def=FStar.GSet.fsti(47,63-47,71); use=FStar.GSet.fsti(47,63-47,71)
(BoxBool_proj_0 (FStar.GSet.mem @x0
@x3
@x1))
)

;; def=FStar.GSet.fsti(47,76-47,84); use=FStar.GSet.fsti(47,76-47,84)
(BoxBool_proj_0 (FStar.GSet.mem @x0
@x3
@x2))
)
...
;;no pats
:qid equation_FStar.GSet.subset.1))
)
...
@x1
@x2))
:qid equation_FStar.GSet.subset))

:named equation_FStar.GSet.subset))
;;;;;;;;;;;;;;;;Prop-typing for FStar.GSet.subset
;;; Fact-ids: Name FStar.GSet.subset; Namespace FStar.GSet
(assert (! 
;; def=FStar.GSet.fsti(47,5-47,11); use=FStar.GSet.fsti(47,5-47,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(FStar.GSet.set @x0)))
(Valid (Prims.subtype_of (FStar.GSet.subset @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (FStar.GSet.subset @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_FStar.GSet.subset))

:named defn_equation_FStar.GSet.subset))
(push) ;; push{2

; Starting query at IEXN.fst(124,4-124,6)
...
;   (*  - Could not prove post-condition
; *)
;   forall (es: IEXN.exns) (p: IEXN.iex_post Prims.unit).
;     FStar.GSet.subset FStar.GSet.empty es /\ p (IEXN.V ()) ==>
;     (forall (any_result: Prims.unit). p (IEXN.V any_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let f`
...
;; def=IEXN.fst(67,2-67,56); use=IEXN.fst(86,19-86,31)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
IEXN.exns)
(HasType @x2
(IEXN.iex_post Prims.unit))

;; def=IEXN.fst(108,20-108,44); use=IEXN.fst(122,23-122,24)
(Valid 
;; def=IEXN.fst(108,20-108,44); use=IEXN.fst(122,23-122,24)
(FStar.GSet.subset Prims.exn
(FStar.GSet.empty Prims.exn)
@x1)
)


;; def=IEXN.fst(123,32-123,40); use=IEXN.fst(124,4-124,6)
(Valid 
;; def=IEXN.fst(123,32-123,40); use=IEXN.fst(124,4-124,6)
(ApplyTT @x2
(IEXN.V Prims.unit
...
;; def=IEXN.fst(96,15-96,22); use=IEXN.fst(124,4-124,6)
(or label_1

;; def=IEXN.fst(96,15-96,22); use=IEXN.fst(98,25-98,38)
(Valid 
;; def=IEXN.fst(96,15-96,22); use=IEXN.fst(98,25-98,38)
(ApplyTT @x2
(IEXN.V Prims.unit
...
; QUERY ID: (IEXN.f, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, unit_inversion
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IEXN.f (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IEXN.f@tok () Term)

; </end encoding let f>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IEXN.exception2; Namespace IEXN
(assert (! 
;; def=IEXN.fst(119,11-119,21); use=IEXN.fst(119,11-119,21)
(forall ((@u0 Dummy_sort))
 (! (HasType (IEXN.exception2 @u0)
Prims.exn)
 

:pattern ((IEXN.exception2 @u0))
:qid typing_IEXN.exception2))

:named typing_IEXN.exception2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IEXN.exception1; Namespace IEXN
(assert (! 
;; def=IEXN.fst(118,11-118,21); use=IEXN.fst(118,11-118,21)
(forall ((@u0 Dummy_sort))
 (! (HasType (IEXN.exception1 @u0)
Prims.exn)
 

:pattern ((IEXN.exception1 @u0))
:qid typing_IEXN.exception1))

:named typing_IEXN.exception1))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.GSet.union; Namespace FStar.GSet
(assert (! 
;; def=FStar.GSet.fsti(36,4-36,9); use=FStar.GSet.fsti(36,4-36,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(FStar.GSet.set @x0)))
(HasType (FStar.GSet.union @x0
@x1
@x2)
(FStar.GSet.set @x0)))
 

:pattern ((FStar.GSet.union @x0
@x1
@x2))
:qid typing_FStar.GSet.union))

:named typing_FStar.GSet.union))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.GSet.singleton; Namespace FStar.GSet
(assert (! 
;; def=FStar.GSet.fsti(35,4-35,13); use=FStar.GSet.fsti(35,4-35,13)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
@x0))
(HasType (FStar.GSet.singleton @x0
@x1)
(FStar.GSet.set @x0)))
 

:pattern ((FStar.GSet.singleton @x0
@x1))
:qid typing_FStar.GSet.singleton))

:named typing_FStar.GSet.singleton))
...
;;;;;;;;;;;;;;;;Lemma: FStar.GSet.mem_union
;;; Fact-ids: Name FStar.GSet.mem_union; Namespace FStar.GSet
...
;; def=FStar.GSet.fsti(62,12-62,58); use=FStar.GSet.fsti(62,12-62,58)
(= (FStar.GSet.mem @x0
@x1
(FStar.GSet.union @x0
@x2
@x3))
(Prims.op_BarBar (FStar.GSet.mem @x0
@x1
@x2)
(FStar.GSet.mem @x0
@x1
...
@x2
@x3)))
:qid lemma_FStar.GSet.mem_union))
:named lemma_FStar.GSet.mem_union))
;;;;;;;;;;;;;;;;Lemma: FStar.GSet.mem_singleton
;;; Fact-ids: Name FStar.GSet.mem_singleton; Namespace FStar.GSet
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=FStar.GSet.fsti(57,12-57,45); use=FStar.GSet.fsti(57,12-57,45)
(iff 
;; def=FStar.GSet.fsti(57,13-57,32); use=FStar.GSet.fsti(57,13-57,32)
(BoxBool_proj_0 (FStar.GSet.mem @x0
@x2
(FStar.GSet.singleton @x0
@x1)))


;; def=FStar.GSet.fsti(57,38-57,44); use=FStar.GSet.fsti(57,38-57,44)
(= @x1
@x2)
)
)
...
(FStar.GSet.singleton @x0
@x1)))
:qid lemma_FStar.GSet.mem_singleton))
:named lemma_FStar.GSet.mem_singleton))
(push) ;; push{2

; Starting query at IEXN.fst(129,4-129,58)
...
; *)
;   forall (es: IEXN.exns) (p: IEXN.iex_post Prims.unit).
;     FStar.GSet.subset (FStar.GSet.union (FStar.GSet.singleton IEXN.exception1)
;           (FStar.GSet.singleton IEXN.exception2))
;       es /\ p (IEXN.E IEXN.exception1) ==>
;     (forall (k: IEXN.iex_post Prims.unit).
;         (forall (rb: IEXN.result Prims.unit). {:pattern Prims.guard_free (k rb)} p rb ==> k rb) ==>
;         FStar.GSet.mem IEXN.exception1 (FStar.GSet.singleton IEXN.exception1) /\
;         (forall (any_result: Prims.exn).
;             (forall (k: IEXN.iex_post Prims.unit).
;                 (forall (rb: IEXN.result Prims.unit). {:pattern Prims.guard_free (k rb)}
;                     k rb ==> k rb) ==>
;                 IEXN.exception1 == any_result ==>
;                 FStar.GSet.subset (FStar.GSet.singleton IEXN.exception1) es /\
;                 k (IEXN.E IEXN.exception1))
;             <:
;             Type0))


; Context: While encoding a query
; While typechecking the top-level declaration `let g`
...
;; def=IEXN.fst(108,20-108,44); use=IEXN.fst(127,23-127,24)
(Valid 
;; def=IEXN.fst(108,20-108,44); use=IEXN.fst(127,23-127,24)
(FStar.GSet.subset Prims.exn
(FStar.GSet.union Prims.exn
(FStar.GSet.singleton Prims.exn
(IEXN.exception1 Dummy_value))
(FStar.GSet.singleton Prims.exn
(IEXN.exception2 Dummy_value)))
@x1)
)


;; def=IEXN.fst(128,32-128,48); use=IEXN.fst(129,4-129,58)
(Valid 
;; def=IEXN.fst(128,32-128,48); use=IEXN.fst(129,4-129,58)
(ApplyTT @x2
(IEXN.E Prims.unit
...
;; def=IEXN.fst(45,2-49,36); use=IEXN.fst(129,4-129,58)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(IEXN.iex_post Prims.unit))
...
(forall ((@x4 Term))
 (! (implies 
;; def=IEXN.fst(46,58-46,62); use=IEXN.fst(129,4-129,58)
(or label_1
...
;; def=IEXN.fst(46,67-46,71); use=IEXN.fst(129,4-129,58)
(Valid 
;; def=IEXN.fst(46,67-46,71); use=IEXN.fst(129,4-129,58)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=IEXN.fst(129,4-129,58)
(and 
;; def=IEXN.fst(113,45-113,64); use=IEXN.fst(129,48-129,58)
(or label_2

;; def=IEXN.fst(113,45-113,64); use=IEXN.fst(129,48-129,58)
(BoxBool_proj_0 (FStar.GSet.mem Prims.exn
(IEXN.exception1 Dummy_value)
(FStar.GSet.singleton Prims.exn
(IEXN.exception1 Dummy_value))))
)
...
;; def=Prims.fst(451,66-451,102); use=IEXN.fst(129,4-129,58)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.exn)
...
;; def=IEXN.fst(113,39-129,58); use=IEXN.fst(129,4-129,58)
(= (IEXN.exception1 Dummy_value)
@x4)
)

;; def=IEXN.fst(108,20-108,55); use=IEXN.fst(129,4-129,58)
(and 
;; def=IEXN.fst(108,20-108,44); use=IEXN.fst(129,4-129,58)
(or label_3
...
;; def=IEXN.fst(113,93-113,100); use=IEXN.fst(129,4-129,9)
(Valid 
;; def=IEXN.fst(113,93-113,100); use=IEXN.fst(129,4-129,9)
(ApplyTT @x5
(IEXN.E Prims.unit
...
; QUERY ID: (IEXN.g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_2feddfe489e78a01f5d2e9b55172b46a, bool_inversion, equation_FStar.GSet.subset, lemma_FStar.GSet.mem_singleton, lemma_FStar.GSet.mem_union, primitive_Prims.op_BarBar, typing_FStar.GSet.mem, typing_FStar.GSet.singleton, typing_IEXN.exception1, typing_IEXN.exception2, typing_Prims.exn
...
; encoding sigelt let g


; <Start encoding let g>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IEXN.g (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IEXN.g@tok () Term)

; </end encoding let g>

(push) ;; push{2

; Starting query at IEXN.fst(134,4-134,76)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (b: Prims.bool).
;   (*  - Could not prove post-condition
; *)
;   forall (es: IEXN.exns) (p: IEXN.iex_post Prims.unit).
;     FStar.GSet.subset (FStar.GSet.union (FStar.GSet.singleton IEXN.exception1)
;           (FStar.GSet.singleton IEXN.exception2))
;       es /\ (forall (r: IEXN.result Prims.unit). p r) ==>
;     (forall (k: IEXN.iex_post Prims.unit).
;         (forall (rb: IEXN.result Prims.unit). {:pattern Prims.guard_free (k rb)} p rb ==> k rb) ==>
;         (forall (k: IEXN.iex_post Prims.unit).
;             (forall (rb: IEXN.result Prims.unit). {:pattern Prims.guard_free (k rb)} k rb ==> k rb) ==>
;             (b = true ==> b == true ==> (forall (any_result: Prims.unit). k (IEXN.V any_result))) /\
;             (~(b = true) ==>
;               (forall (x: Prims.bool).
;                   (forall (k: IEXN.iex_post Prims.unit).
;                       (forall (rb: IEXN.result Prims.unit). {:pattern Prims.guard_free (k rb)}
...
;                           (forall (rb: IEXN.result Prims.unit). {:pattern Prims.guard_free (k rb)}
;                               k rb ==> k rb) ==>
;                           FStar.GSet.mem IEXN.exception2 (FStar.GSet.singleton IEXN.exception2) /\
;                           (forall (any_result: Prims.exn).
;                               (forall (k: IEXN.iex_post Prims.unit).
;                                   (forall (rb: IEXN.result Prims.unit).
;                                       {:pattern Prims.guard_free (k rb)}
;                                       k rb ==> k rb) ==>
;                                   IEXN.exception2 == any_result ==>
;                                   FStar.GSet.subset (FStar.GSet.singleton IEXN.exception2) es /\
;                                   k (IEXN.E IEXN.exception2))
;                               <:
;                               Type0)))
;                   <:
;                   Prims.GTot Type0))))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let h`
...
;; def=IEXN.fst(108,20-108,44); use=IEXN.fst(132,29-132,30)
(Valid 
;; def=IEXN.fst(108,20-108,44); use=IEXN.fst(132,29-132,30)
(FStar.GSet.subset Prims.exn
(FStar.GSet.union Prims.exn
...
;; def=IEXN.fst(133,38-133,52); use=IEXN.fst(134,4-134,76)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(IEXN.result Prims.unit))

;; def=IEXN.fst(133,49-133,52); use=IEXN.fst(134,4-134,76)
(Valid 
;; def=IEXN.fst(133,49-133,52); use=IEXN.fst(134,4-134,76)
(ApplyTT @x2
@x3)
...
;; def=IEXN.fst(53,2-55,16); use=IEXN.fst(134,4-134,76)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(IEXN.iex_post Prims.unit))
...
(forall ((@x4 Term))
 (! (implies 
;; def=IEXN.fst(54,58-54,65); use=IEXN.fst(134,4-134,76)
(or label_1
...
;; def=IEXN.fst(54,70-54,74); use=IEXN.fst(134,4-134,76)
(Valid 
;; def=IEXN.fst(54,70-54,74); use=IEXN.fst(134,4-134,76)
(ApplyTT @x3
@x4)
...
;; def=IEXN.fst(45,2-49,36); use=IEXN.fst(134,4-134,76)
(forall ((@x4 Term))
...
(forall ((@x5 Term))
 (! (implies 
;; def=IEXN.fst(46,58-46,62); use=IEXN.fst(134,4-134,76)
(Valid 
;; def=IEXN.fst(46,58-46,62); use=IEXN.fst(134,4-134,76)
(ApplyTT @x3
@x5)
...
;; def=IEXN.fst(46,67-46,71); use=IEXN.fst(134,4-134,76)
(Valid 
;; def=IEXN.fst(46,67-46,71); use=IEXN.fst(134,4-134,76)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(221,62-221,85); use=IEXN.fst(134,4-134,76)
(and (implies 
;; def=Prims.fst(221,62-221,71); use=IEXN.fst(134,4-134,76)
(and 
;; def=IEXN.fst(131,7-134,8); use=IEXN.fst(134,7-134,8)
(= @x0
(BoxBool true))
...
;; def=Prims.fst(451,66-451,102); use=IEXN.fst(134,4-134,76)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.unit)

;; def=IEXN.fst(96,15-96,22); use=IEXN.fst(134,4-134,76)
(Valid 
;; def=IEXN.fst(96,15-96,22); use=IEXN.fst(134,4-134,76)
(ApplyTT @x4
(IEXN.V Prims.unit
...
(implies 
;; def=Prims.fst(221,76-221,78); use=IEXN.fst(134,4-134,76)
(not 
;; def=IEXN.fst(131,7-134,8); use=IEXN.fst(134,7-134,8)
(= @x0
(BoxBool true))
...
;; def=IEXN.fst(72,2-72,25); use=IEXN.fst(134,4-134,76)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.bool)
...
;; def=IEXN.fst(131,7-134,76); use=IEXN.fst(134,7-134,76)
(= @x0
@x5)
)
...
;; def=Prims.fst(459,77-459,89); use=IEXN.fst(134,4-134,76)
(and 
;; def=IEXN.fst(113,45-113,64); use=IEXN.fst(134,66-134,76)
(or label_2
...
;; def=IEXN.fst(113,39-134,76); use=IEXN.fst(134,4-134,76)
(= (IEXN.exception2 Dummy_value)
@x8)
)

;; def=IEXN.fst(108,20-108,55); use=IEXN.fst(134,4-134,76)
(and 
;; def=IEXN.fst(108,20-108,44); use=IEXN.fst(134,4-134,76)
(or label_3
...
;; def=IEXN.fst(113,93-113,100); use=IEXN.fst(134,22-134,27)
(Valid 
;; def=IEXN.fst(113,93-113,100); use=IEXN.fst(134,22-134,27)
(ApplyTT @x9
(IEXN.E Prims.unit
...
; QUERY ID: (IEXN.h, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_2feddfe489e78a01f5d2e9b55172b46a, Prims_pretyping_f8666440faa91836cc5a13998af863fc, bool_inversion, data_typing_intro_IEXN.E@tok, data_typing_intro_IEXN.V@tok, equation_FStar.GSet.subset, equation_IEXN.exns, equation_Prims.eqtype, lemma_FStar.GSet.mem_singleton, lemma_FStar.GSet.mem_union, primitive_Prims.op_BarBar, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.GSet.mem, typing_FStar.GSet.singleton, typing_IEXN.exception1, typing_IEXN.exception2, typing_Prims.exn, typing_Prims.unit, unit_typing
