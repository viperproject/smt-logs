...
; encoding sigelt let exn


; <Start encoding let exn>

(declare-fun GEXN.exn (Dummy_sort) Term)

; </end encoding let exn>


; encoding sigelt let gex


; <Start encoding let gex>

(declare-fun GEXN.gex (Term) Term)

(declare-fun GEXN.gex@tok () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.M (FStar.Set.set exn & FStar.Pervasives.either a exn)
(declare-fun Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f (Term) Term)

; </end encoding let gex>
...
(declare-fun GEXN.gex_ (Term) Term)

(declare-fun GEXN.gex_@tok () Term)
(declare-fun Tm_refine_a8b0e90f74fd30aa16787ba3c6f2bea0 (Term) Term)
;;;;;;;;;;;;;;;;s: FStar.Set.set exn -> Prims.GTot Type
(declare-fun Tm_arrow_102e4c524a96c9b0ec56010ca9ebc4dc () Term)
(declare-fun Tm_abs_ccde267d878d218d52aa53462aed08a0 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit   -> Prims.M (s: FStar.Set.set exn & FStar.Pervasives.either a (e: exn{FStar.Set.mem e s}))
(declare-fun Tm_arrow_d941961cdc45207e7df2c7c76a369468 (Term) Term)

; </end encoding let gex'>


; encoding sigelt val GEXN.return_gex


; <Skipped val GEXN.return_gex/>


; encoding sigelt let return_gex


; <Start encoding let return_gex>

(declare-fun GEXN.return_gex (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> gex a
(declare-fun Tm_arrow_b8d8d10e273f7c79e06c1fcdaad7e28d () Term)
(declare-fun GEXN.return_gex@tok () Term)
(declare-fun Tm_abs_673155893f563b8d632c31518f2b4e9a (Term Term) Term)

; </end encoding let return_gex>


; encoding sigelt val GEXN.bind_gex


; <Skipped val GEXN.bind_gex/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GEXN.gex; Namespace GEXN
(assert (! 
;; def=GEXN.fst(27,4-27,7); use=GEXN.fst(27,4-27,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (GEXN.gex @x0)
...
:named typing_GEXN.gex))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GEXN.exn; Namespace GEXN
(assert (! 
;; def=GEXN.fst(25,4-25,7); use=GEXN.fst(25,4-25,7)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f
;;; Fact-ids: Name GEXN.gex; Namespace GEXN
(assert (! 
;; def=GEXN.fst(27,19-27,55); use=GEXN.fst(27,19-27,55)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f @x0)
Tm_type))
:qid kinding_Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f))

:named kinding_Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f))
...
;;;;;;;;;;;;;;;;Equation for GEXN.gex
;;; Fact-ids: Name GEXN.gex; Namespace GEXN
(assert (! 
;; def=GEXN.fst(27,4-27,7); use=GEXN.fst(27,4-27,7)
(forall ((@x0 Term))
 (! (= (GEXN.gex @x0)
(Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f @x0))
 

:pattern ((GEXN.gex @x0))
:qid equation_GEXN.gex))

:named equation_GEXN.gex))
;;;;;;;;;;;;;;;;Equation for GEXN.exn
;;; Fact-ids: Name GEXN.exn; Namespace GEXN
(assert (! 
;; def=GEXN.fst(25,4-25,7); use=GEXN.fst(25,4-25,7)
(forall ((@u0 Dummy_sort))
...
:qid equation_GEXN.exn))

:named equation_GEXN.exn))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f @x2)))
:qid GEXN_pre_typing_Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f))

:named GEXN_pre_typing_Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f
;;; Fact-ids: Name GEXN.gex; Namespace GEXN
(assert (! 
;; def=GEXN.fst(27,19-27,55); use=GEXN.fst(27,19-27,55)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f @x1))
(and 
;; def=GEXN.fst(27,19-27,55); use=GEXN.fst(27,19-27,55)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
(HasType (ApplyTT @x0
@x2)
(FStar.Pervasives.Native.tuple2 (FStar.Set.set (GEXN.exn Dummy_value))
(FStar.Pervasives.either @x1
(GEXN.exn Dummy_value)))))
 

:pattern ((ApplyTT @x0
@x2))
:qid GEXN_interpretation_Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f @x1)))
:qid GEXN_interpretation_Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f))

:named GEXN_interpretation_Tm_arrow_fdee1462658a3d2583ecdce17f0f7e5f))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name FStar.Pervasives.either; Namespace FStar.Pervasives; Name FStar.Pervasives.Inl; Namespace FStar.Pervasives; Name FStar.Pervasives.Inr; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(730,5-730,11); use=FStar.Pervasives.fsti(730,5-730,11)
...
; Starting query at GEXN.fst(38,31-42,19)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;g: a -> gex b
(declare-fun Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f
;;; Fact-ids: 
(assert (! 
;; def=GEXN.fst(37,60-38,14); use=GEXN.fst(38,4-38,14)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f))

:named kinding_Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GEXN.fst(37,60-38,14); use=GEXN.fst(38,4-38,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f @x2
@x3)))
:qid GEXN_pre_typing_Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f))

:named GEXN_pre_typing_Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f
;;; Fact-ids: 
(assert (! 
;; def=GEXN.fst(37,60-38,14); use=GEXN.fst(38,4-38,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f @x1
@x2))
(and 
;; def=GEXN.fst(37,60-38,14); use=GEXN.fst(38,4-38,14)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid GEXN_interpretation_Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f.1))
...
(Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f @x1
@x2)))
:qid GEXN_interpretation_Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f))

:named GEXN_interpretation_Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f))

; Encoding query formula : forall (a: Type) (b: Type) (f: GEXN.gex a) (g: (g: a -> GEXN.gex b)) (_: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (b: FStar.Set.set GEXN.exn) (b: FStar.Pervasives.either a GEXN.exn).
;     f () == (b, b) ==>
;     (forall (k: Prims.pure_post (FStar.Set.set GEXN.exn & FStar.Pervasives.either b GEXN.exn)).
;         (forall (x: FStar.Set.set GEXN.exn & FStar.Pervasives.either b GEXN.exn).
;             {:pattern Prims.guard_free (k x)}
;             Prims.auto_squash (k x)) ==>
;         ~(Inr? b) /\ ~(Inl? b) ==> Prims.l_False)


; Context: While encoding a query
; While typechecking the top-level declaration `let bind_gex`
...
;; def=Prims.fst(413,99-413,120); use=GEXN.fst(38,31-42,19)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(FStar.Set.set (GEXN.exn Dummy_value)))
...
;; def=GEXN.fst(39,7-39,10); use=GEXN.fst(39,7-39,10)
(= (ApplyTT @x2
Tm_unit)
(FStar.Pervasives.Native.Mktuple2 (FStar.Set.set (GEXN.exn Dummy_value))
(FStar.Pervasives.either @x0
(GEXN.exn Dummy_value))
@x5
@x6))
...
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (FStar.Set.set (GEXN.exn Dummy_value))
(FStar.Pervasives.either @x1
(GEXN.exn Dummy_value)))))

;; def=Prims.fst(402,27-402,88); use=GEXN.fst(38,31-42,19)
(forall ((@x8 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=GEXN.fst(38,31-42,19)
(Valid 
;; def=Prims.fst(402,84-402,87); use=GEXN.fst(38,31-42,19)
(ApplyTT @x7
@x8)
...
;; def=GEXN.fst(39,9-39,10); use=GEXN.fst(40,8-40,9)
(not 
;; def=GEXN.fst(39,9-39,10); use=GEXN.fst(40,8-40,9)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GEXN.bind_gex, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_FStar.Pervasives.Inl, disc_equation_FStar.Pervasives.Inr, fuel_guarded_inversion_FStar.Pervasives.either, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let bind_gex


; <Start encoding let bind_gex>

;;;;;;;;;;;;;;;;g: a -> gex b
(declare-fun Tm_arrow_932b11264cbbf705bf81e7b47c4ddd4f (Term Term) Term)
(declare-fun GEXN.bind_gex (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> f: gex a -> g: (g: a -> gex b) -> gex b
(declare-fun Tm_arrow_9df2ed7b35258f0b56ae47d9efc3064f () Term)
(declare-fun GEXN.bind_gex@tok () Term)

(declare-fun Tm_abs_8bc6f79f3e08807d0241ab67d49f1cd0 (Term Term Term) Term)

; </end encoding let bind_gex>
...
(declare-fun GEXN.raise0 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> e: exn -> gex a
(declare-fun Tm_arrow_ac8240253baa8c99c0aa40ab93e04fa6 () Term)
(declare-fun GEXN.raise0@tok () Term)
(declare-fun Tm_abs_68135bf57e404c20be1508507c877370 (Term Term) Term)

; </end encoding let raise0>


; encoding sigelt let _dm4f_GEXN_lift_from_pure


; <Start encoding let _dm4f_GEXN_lift_from_pure>


;;;;;;;;;;;;;;;;_: (_: a -> Type) -> Type
(declare-fun Tm_arrow_11b93b1a25b26195b88e72dd87199600 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type
(declare-fun Tm_arrow_e4ca4a4f5f9337389102f74f66b404d3 (Term) Term)
(declare-fun GEXN._dm4f_GEXN_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     _: Prims.unit ->     p': (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Type
(declare-fun Tm_arrow_e13eb328448f347e675a3d7d30e881ca () Term)
(declare-fun GEXN._dm4f_GEXN_lift_from_pure@tok () Term)




(declare-fun Tm_abs_20d1eb8f9d0a78ae49c85932fe997b20 (Term Term) Term)

; </end encoding let _dm4f_GEXN_lift_from_pure>


; encoding sigelt let _dm4f_GEXN_return_wp


; <Start encoding let _dm4f_GEXN_return_wp>


(declare-fun GEXN._dm4f_GEXN_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     x: a ->     _: Prims.unit ->     p': (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Type
(declare-fun Tm_arrow_e8b65afbca0d7c9fb72fa1de78f37470 () Term)
(declare-fun GEXN._dm4f_GEXN_return_wp@tok () Term)


; </end encoding let _dm4f_GEXN_return_wp>


; encoding sigelt let _dm4f_GEXN_return_elab


; <Start encoding let _dm4f_GEXN_return_elab>

(declare-fun GEXN._dm4f_GEXN_return_elab (Term Term Term) Term)
(declare-fun Tm_refine_cc9d66ea51008b731ecc027e1e05349c (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> _: Prims.unit   -> Prims.PURE (FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string)
(declare-fun Tm_arrow_bd9e002d5b66974cb4b759e6d9e59369 () Term)
(declare-fun GEXN._dm4f_GEXN_return_elab@tok () Term)


; </end encoding let _dm4f_GEXN_return_elab>


; encoding sigelt let _dm4f_GEXN_bind_wp


; <Start encoding let _dm4f_GEXN_bind_wp>


;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Type
(declare-fun Tm_arrow_ce38b287460465a4f478a9a5aa6bdfa0 (Term) Term)


;;;;;;;;;;;;;;;;g: a ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either b Prims.string -> Type)   -> Type
(declare-fun Tm_arrow_937143d802ddd950de977827b1b60548 (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Set.set exn & FStar.Pervasives.either b exn -> Type
(declare-fun Tm_arrow_bb2e5154f577cc7e878c999067a09956 (Term) Term)
(declare-fun GEXN._dm4f_GEXN_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type) ->     g:       (             g: a ->             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either b Prims.string -> Type)           -> Type) ->     _: Prims.unit ->     p'': (_: FStar.Set.set exn & FStar.Pervasives.either b exn -> Type)   -> Type
(declare-fun Tm_arrow_01352cd7b1b569356aabd3c790f4b58d () Term)
(declare-fun GEXN._dm4f_GEXN_bind_wp@tok () Term)
...
(declare-fun Tm_abs_f60abd2500a9e0078ff3e3d1ba409267 (Term Term Term Term) Term)

; </end encoding let _dm4f_GEXN_bind_wp>


; encoding sigelt let _dm4f_GEXN_bind_elab


; <Start encoding let _dm4f_GEXN_bind_elab>



(declare-fun Tm_refine_30ba7bed69a31fc1689a9014bac8775b (Term) Term)

;;;;;;;;;;;;;;;;y: _: (FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string){Prims.l_True}   -> Prims.GTot Type
(declare-fun Tm_arrow_4bdcd7fefea549c5212a131de65bf12a (Term) Term)
(declare-fun Tm_abs_5c317a4ec345e6c14047f5b097b187fa (Term Term) Term)
(declare-fun Tm_refine_69673b214bb45dafc3ff5d1a3db6b064 (Term Term Term) Term)



(declare-fun Tm_abs_cc3aa1a3c1cbe9c38536246ef0c61903 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string)
(declare-fun Tm_arrow_6d4291c8ccd4af501ddf948e268ff64f (Term Term) Term)
...
(declare-fun Tm_refine_de6c7bce740739c19c266b8c4c037430 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Set.set Prims.string & FStar.Pervasives.either b Prims.string)
(declare-fun Tm_arrow_8502b9b158af2411c91c13fe389da0ab (Term Term Term) Term)
;;;;;;;;;;;;;;;;g__x: a -> _: Prims.unit   -> Prims.PURE (FStar.Set.set Prims.string & FStar.Pervasives.either b Prims.string)
(declare-fun Tm_arrow_107ee868b40d7b4667ec4887581d6e9f (Term Term Term) Term)
(declare-fun Tm_refine_02de55c3ebde9fc8a860f8d5bcab2050 (Term) Term)

;;;;;;;;;;;;;;;;x: _: (FStar.Set.set exn & FStar.Pervasives.either b exn){Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_0e1eb23e65d73dbca7db019681d4fa2f (Term) Term)
(declare-fun Tm_abs_6f5468c5baaa415e9a6f87b940d0a943 (Term) Term)

(declare-fun Tm_abs_8f9eb6c53076165b45f8d87083f4d5c4 (Term Term Term) Term)
(declare-fun GEXN._dm4f_GEXN_bind_elab (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_678f2416bae01be5c5bc405942d41be6 (Term Term) Term)

(declare-fun Tm_abs_d1431672ca2643f72adffd16e5cde7f9 (Term Term Term Term) Term)
(declare-fun Tm_refine_e2557d634505032ff9b071725b89709f (Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f__w:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type) ->     f:       (_: Prims.unit           -> Prims.PURE (FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string)) ->     g__w:       (             g: a ->             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either b Prims.string -> Type)           -> Type) ->     g:       (g__x: a -> _: Prims.unit           -> Prims.PURE (FStar.Set.set Prims.string & FStar.Pervasives.either b Prims.string)) ->     _: Prims.unit   -> Prims.PURE (FStar.Set.set exn & FStar.Pervasives.either b exn)
(declare-fun Tm_arrow_cca432a1bb7ce692f2034fc4fcf0f515 () Term)
(declare-fun GEXN._dm4f_GEXN_bind_elab@tok () Term)
...
; </end encoding let _dm4f_GEXN_bind_elab>


; encoding sigelt let _dm4f_GEXN___proj__GEXN__item__raise_elab


; <Start encoding let _dm4f_GEXN___proj__GEXN__item__raise_elab>

(declare-fun GEXN._dm4f_GEXN___proj__GEXN__item__raise_elab (Term Term) Term)
(declare-fun Tm_refine_3afe32586ce4858b83368c90e113def5 (Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string)
(declare-fun Tm_arrow_ae5e70ef702b68d344d056f80b3da0f4 (Term Term) Term)
;;;;;;;;;;;;;;;;e: Prims.string -> _: Prims.unit   -> Prims.PURE (FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string)
(declare-fun Tm_arrow_2dbd1ba3604108ec78a650ee32c05e13 () Term)
(declare-fun GEXN._dm4f_GEXN___proj__GEXN__item__raise_elab@tok () Term)


(declare-fun Tm_abs_5d04085e741e6029aeb34cf6341b57ca (Term Term) Term)

; </end encoding let _dm4f_GEXN___proj__GEXN__item__raise_elab>


; encoding sigelt let _dm4f_GEXN___proj__GEXN__item__raise_complete_type


; <Start encoding let _dm4f_GEXN___proj__GEXN__item__raise_complete_type>

(declare-fun GEXN._dm4f_GEXN___proj__GEXN__item__raise_complete_type () Term)




; </end encoding let _dm4f_GEXN___proj__GEXN__item__raise_complete_type>


; encoding sigelt let _dm4f_GEXN_repr


; <Start encoding let _dm4f_GEXN_repr>



(declare-fun GEXN._dm4f_GEXN_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp_a:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type)   -> Type
(declare-fun Tm_arrow_594be8e326a229ea4662f76bce9f17df () Term)
(declare-fun GEXN._dm4f_GEXN_repr@tok () Term)
...
; </end encoding let _dm4f_GEXN_repr>


; encoding sigelt let _dm4f_GEXN_pre


; <Start encoding let _dm4f_GEXN_pre>

(declare-fun GEXN._dm4f_GEXN_pre () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Type
(declare-fun Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe () Term)

; </end encoding let _dm4f_GEXN_pre>


; encoding sigelt let _dm4f_GEXN_post


; <Start encoding let _dm4f_GEXN_post>

(declare-fun GEXN._dm4f_GEXN_post (Term) Term)

(declare-fun GEXN._dm4f_GEXN_post@tok () Term)


; </end encoding let _dm4f_GEXN_post>


; encoding sigelt let _dm4f_GEXN_wp


; <Start encoding let _dm4f_GEXN_wp>

(declare-fun GEXN._dm4f_GEXN_wp (Term) Term)

(declare-fun GEXN._dm4f_GEXN_wp@tok () Term)



; </end encoding let _dm4f_GEXN_wp>


; encoding sigelt let _dm4f_GEXN_ctx


; <Start encoding let _dm4f_GEXN_ctx>

(declare-fun GEXN._dm4f_GEXN_ctx (Term Term) Term)

(declare-fun GEXN._dm4f_GEXN_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> t
(declare-fun Tm_arrow_9a5222e37466cef10bf89686acb73a73 (Term Term) Term)

; </end encoding let _dm4f_GEXN_ctx>


; encoding sigelt let _dm4f_GEXN_gctx


; <Start encoding let _dm4f_GEXN_gctx>

(declare-fun GEXN._dm4f_GEXN_gctx (Term Term) Term)

(declare-fun GEXN._dm4f_GEXN_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.GTot t
(declare-fun Tm_ghost_arrow_e4f31957990984e30a7f82b144b987ba (Term Term) Term)

; </end encoding let _dm4f_GEXN_gctx>


; encoding sigelt let _dm4f_GEXN_pure


; <Start encoding let _dm4f_GEXN_pure>


(declare-fun GEXN._dm4f_GEXN_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> t
(declare-fun Tm_arrow_b7cebb27d6f1026774ac67de62480457 () Term)
(declare-fun GEXN._dm4f_GEXN_pure@tok () Term)


; </end encoding let _dm4f_GEXN_pure>


; encoding sigelt let _dm4f_GEXN_app


; <Start encoding let _dm4f_GEXN_app>



;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_fa3dce379913102448ddadbe96af4b2d (Term Term Term) Term)



(declare-fun GEXN._dm4f_GEXN_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Prims.GTot t1) ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_92ce912b6dbc4b4264ac13ffa9aeee90 () Term)
(declare-fun GEXN._dm4f_GEXN_app@tok () Term)
...
; </end encoding let _dm4f_GEXN_app>


; encoding sigelt let _dm4f_GEXN_lift1


; <Start encoding let _dm4f_GEXN_lift1>




(declare-fun GEXN._dm4f_GEXN_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Prims.GTot t1) ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_3408c486778e77c97d919886c3bd992f () Term)
(declare-fun GEXN._dm4f_GEXN_lift1@tok () Term)
...
(declare-fun Tm_abs_64daf354074239041dcf1324d4b28461 (Term Term Term Term) Term)

; </end encoding let _dm4f_GEXN_lift1>


; encoding sigelt let _dm4f_GEXN_lift2


; <Start encoding let _dm4f_GEXN_lift2>
...
(declare-fun GEXN._dm4f_GEXN_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Prims.GTot t1) ->     a2:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Prims.GTot t2) ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_8d68ee34e2a0fb5959060b7c4e044e99 () Term)
(declare-fun GEXN._dm4f_GEXN_lift2@tok () Term)
...
(declare-fun Tm_abs_4de5512be8b314743d987a2e14d7a483 (Term Term Term Term Term) Term)

; </end encoding let _dm4f_GEXN_lift2>


; encoding sigelt let _dm4f_GEXN_push


; <Start encoding let _dm4f_GEXN_push>



;;;;;;;;;;;;;;;;_: t1 ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_aa8de3041d4c9fc927bb117f5f9adf06 (Term Term Term) Term)

(declare-fun GEXN._dm4f_GEXN_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f:       (             _: t1 ->             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Prims.GTot t2) ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_ff92ef1a08092b8e51d3d330464caa50 () Term)
(declare-fun GEXN._dm4f_GEXN_push@tok () Term)





; </end encoding let _dm4f_GEXN_push>


; encoding sigelt let _dm4f_GEXN_wp_if_then_else


; <Start encoding let _dm4f_GEXN_wp_if_then_else>

(declare-fun GEXN._dm4f_GEXN_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type) ->     _:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type) ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Type
(declare-fun Tm_arrow_894e0a30559902ea3a67d65dc3a0d970 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type) ->     _:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type) ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Type
(declare-fun Tm_arrow_562f8461bf481cb9e9d2072fd82fa089 () Term)
(declare-fun GEXN._dm4f_GEXN_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_14a113dfd01241fa9fb83570073935c3 (Term) Term)
...
;;;;;;;;;;;;;;;;a1:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Prims.GTot Prims.logical) ->     a2:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Prims.GTot Prims.logical) ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_964c4c5fe5a755da4c26000102f1bef9 (Term) Term)
(declare-fun Tm_abs_bfc761cf71a907a7e78978980cd74bac (Term Term) Term)

; </end encoding let _dm4f_GEXN_wp_if_then_else>


; encoding sigelt let _dm4f_GEXN_wp_close


; <Start encoding let _dm4f_GEXN_wp_close>




(declare-fun GEXN._dm4f_GEXN_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f:       (             _: b ->             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type) ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_e165b506b7adba2679054dc3d628bc68 () Term)
(declare-fun GEXN._dm4f_GEXN_wp_close@tok () Term)
...
(declare-fun Tm_abs_a38fa0c6b6e08137d0a69cf0bebb9fdd (Term Term Term) Term)

; </end encoding let _dm4f_GEXN_wp_close>


; encoding sigelt let _dm4f_GEXN_stronger


; <Start encoding let _dm4f_GEXN_stronger>





(declare-fun GEXN._dm4f_GEXN_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type) ->     wp2:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_509425c71847c0be6a989b351de46085 () Term)
(declare-fun GEXN._dm4f_GEXN_stronger@tok () Term)
...
; </end encoding let _dm4f_GEXN_stronger>


; encoding sigelt let _dm4f_GEXN_ite_wp


; <Start encoding let _dm4f_GEXN_ite_wp>




(declare-fun GEXN._dm4f_GEXN_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type) ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.logical
(declare-fun Tm_arrow_4816249f8c945fc47b214b1ea220733e () Term)
(declare-fun GEXN._dm4f_GEXN_ite_wp@tok () Term)





; </end encoding let _dm4f_GEXN_ite_wp>


; encoding sigelt let _dm4f_GEXN_null_wp


; <Start encoding let _dm4f_GEXN_null_wp>


(declare-fun GEXN._dm4f_GEXN_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     _: Prims.unit ->     _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)   -> Prims.logical
(declare-fun Tm_arrow_976fd338f1eb71d3080145ac1b3d90e4 () Term)
(declare-fun GEXN._dm4f_GEXN_null_wp@tok () Term)


; </end encoding let _dm4f_GEXN_null_wp>


; encoding sigelt let _dm4f_GEXN_wp_trivial


; <Start encoding let _dm4f_GEXN_wp_trivial>



(declare-fun GEXN._dm4f_GEXN_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp:       (             _: Prims.unit ->             _: (_: FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_7f2428ed7646940e4f0fc5294f1da4cd () Term)
(declare-fun GEXN._dm4f_GEXN_wp_trivial@tok () Term)




; </end encoding let _dm4f_GEXN_wp_trivial>


; encoding sigelt new_effect_for_free { GEXN ... }


; <Start encoding new_effect_for_free { GEXN ... }>





(declare-fun Tm_abs_06bc5a39b51d9b8a00f0b2a819c3ccb2 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun GEXN.__proj__GEXN__item__raise (Term Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun GEXN.__proj__GEXN__item__raise@tok () Term)

; </end encoding new_effect_for_free { GEXN ... }>


; encoding sigelt sub_effect PURE ~> GEXN


; <Skipped sub_effect PURE ~> GEXN/>


; encoding sigelt let gexn_wp


; <Start encoding let gexn_wp>

(declare-fun GEXN.gexn_wp (Term) Term)

(declare-fun GEXN.gexn_wp@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Set.set exn & FStar.Pervasives.either a exn -> Type) -> Type
(declare-fun Tm_arrow_c01475dcdbf15f26138103ee1dcaa5e6 (Term) Term)

; </end encoding let gexn_wp>


; encoding sigelt let exn_wp


; <Start encoding let exn_wp>

(declare-fun GEXN.exn_wp (Term) Term)

(declare-fun GEXN.exn_wp@tok () Term)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.either a exn -> Type
(declare-fun Tm_arrow_4713f638d30cc3c6e1d17ac59a05345d (Term) Term)
;;;;;;;;;;;;;;;;_: (_: FStar.Pervasives.either a exn -> Type) -> Type
(declare-fun Tm_arrow_cad1ad2bb8eebcb0d6cc571bfb9deb2b (Term) Term)

; </end encoding let exn_wp>
...
(declare-fun GEXN.op_Greater_Less (Term Term Term) Term)
;;;;;;;;;;;;;;;;s: FStar.Set.set exn -> wp: exn_wp a -> gexn_wp a
(declare-fun Tm_arrow_af169e53788eaf7efbb939c89f142edf () Term)
(declare-fun GEXN.op_Greater_Less@tok () Term)


(declare-fun Tm_abs_c552160edfc25749f8b7a7249ee47253 (Term Term Term) Term)


(declare-fun Tm_abs_a81ecf65bc55bfe8507641fed0345d33 (Term Term Term) Term)
...
; Starting query at GEXN.fst(65,4-65,17)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (e: GEXN.exn).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.unit)
;     (p: Prims.pure_post (FStar.Set.set Prims.string & FStar.Pervasives.either a Prims.string)).
;     p (FStar.Set.singleton e, FStar.Pervasives.Inr e) ==>
;     p (FStar.Set.singleton e, FStar.Pervasives.Inr e)


; Context: While encoding a query
; While typechecking the top-level declaration `let raise`
...
;; def=dummy(0,0-0,0); use=GEXN.fst(65,4-65,17)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.unit)
(HasType @x3
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (FStar.Set.set Prims.string)
(FStar.Pervasives.either @x0
Prims.string))))

;; def=GEXN.fst(62,31-62,41); use=GEXN.fst(64,51-64,52)
(Valid 
;; def=GEXN.fst(62,31-62,41); use=GEXN.fst(64,51-64,52)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 (FStar.Set.set (GEXN.exn Dummy_value))
(FStar.Pervasives.either @x0
(GEXN.exn Dummy_value))
(FStar.Set.singleton (GEXN.exn Dummy_value)
@x1)
...
;; def=GEXN.fst(44,47-44,66); use=GEXN.fst(65,10-65,15)
(or label_1
...
;; def=GEXN.fst(44,47-44,66); use=GEXN.fst(65,10-65,15)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 (FStar.Set.set Prims.string)
(FStar.Pervasives.either @x0
Prims.string)
(FStar.Set.singleton Prims.string
@x1)
(FStar.Pervasives.Inr @x0
Prims.string
@x1)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GEXN.raise, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_GEXN.exn
