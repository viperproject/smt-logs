...
(declare-fun IST.st_pre (Term) Term)

(declare-fun IST.st_pre@tok () Term)
...
(declare-fun IST.st_post_ (Term Term Term) Term)

(declare-fun IST.st_post_@tok () Term)
...
(declare-fun IST.st_post (Term Term) Term)

(declare-fun IST.st_post@tok () Term)
...
(declare-fun IST.st_wp (Term) Term)

(declare-fun IST.st_wp@tok () Term)
;;;;;;;;;;;;;;;;s: Type -> _: FStar.Pervasives.st_post_h s a -> FStar.Pervasives.st_pre_h s
(declare-fun Tm_arrow_4515c24ac51a2ceb87fad65deadd01cc (Term) Term)
...
(declare-fun IST.st_return (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> s: Type -> post: st_post s a -> _: s -> Prims.GTot Type
(declare-fun Tm_arrow_89595b17532b3b04fd594dd52c241e7e () Term)
(declare-fun IST.st_return@tok () Term)


; </end encoding let st_return>


; encoding sigelt let st_bind_wp


; <Start encoding let st_bind_wp>

;;;;;;;;;;;;;;;;_: a -> Prims.GTot (st_wp b)
(declare-fun Tm_arrow_8d5be5015d8642269ba6b26962366824 (Term Term) Term)
(declare-fun IST.st_bind_wp (Term Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     wp1: st_wp a ->     wp2: (_: a -> Prims.GTot (st_wp b)) ->     s: Type ->     post: st_post s b ->     s0: s   -> Type
(declare-fun Tm_arrow_0a3ecd7fc7d4a52c7f4e8df864c48f74 () Term)
(declare-fun IST.st_bind_wp@tok () Term)


(declare-fun Tm_abs_912b23ded1438ea7e599a4ca045c4392 (Term Term Term Term) Term)
...
(declare-fun IST.st_if_then_else (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     p: Type ->     wp_then: st_wp a ->     wp_else: st_wp a ->     s: Type ->     post: FStar.Pervasives.st_post_h s a ->     s0: s   -> Prims.logical
(declare-fun Tm_arrow_5c5af99e69dca3ee7ffe7e5358f68ba9 () Term)
(declare-fun IST.st_if_then_else@tok () Term)

; </end encoding let st_if_then_else>


; encoding sigelt let st_ite_wp


; <Start encoding let st_ite_wp>

(declare-fun IST.st_ite_wp (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: st_wp a -> s: Type -> post: st_post s a -> s0: s -> Prims.logical
(declare-fun Tm_arrow_497833a33f0511ba44575c3351c087a2 () Term)
(declare-fun IST.st_ite_wp@tok () Term)
...
(declare-fun IST.st_stronger (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp1: st_wp a -> wp2: st_wp a -> Prims.logical
(declare-fun Tm_arrow_a5d1126f2d42060ffdd9a92969a985a6 () Term)
(declare-fun IST.st_stronger@tok () Term)

; </end encoding let st_stronger>


; encoding sigelt let st_close_wp


; <Start encoding let st_close_wp>


(declare-fun IST.st_close_wp (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> wp: (_: b -> Prims.GTot (st_wp a)) -> s: Type -> post: st_post s a -> s0: s   -> Prims.logical
(declare-fun Tm_arrow_661ba58dbdbc326d55d7707b3464923d () Term)
(declare-fun IST.st_close_wp@tok () Term)
...
(declare-fun IST.st_trivial (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: st_wp a -> Prims.logical
(declare-fun Tm_arrow_65f973a7cb3d9aa901b1822218bbad06 () Term)
(declare-fun IST.st_trivial@tok () Term)
...
; encoding sigelt new_effect { STATE ... }


; <Skipped new_effect { STATE ... }/>


; encoding sigelt let lift_div_st


; <Start encoding let lift_div_st>

(declare-fun IST.lift_div_st (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> s: Type -> p: st_post s a -> s0: s -> Prims.pure_pre
(declare-fun Tm_arrow_6edb6eca3263d7b9bc49af63a6e362a1 () Term)
(declare-fun IST.lift_div_st@tok () Term)



; </end encoding let lift_div_st>


; encoding sigelt sub_effect DIV ~> STATE
...
(declare-fun IST.st_wp_ (Term Term) Term)

(declare-fun IST.st_wp_@tok () Term)
;;;;;;;;;;;;;;;;_: st_post s a -> st_pre s
(declare-fun Tm_arrow_8b4848919572460b02bccfcb169db4b9 (Term Term) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IST.st_wp'; Namespace IST
(assert (! 
;; def=IST.fst(96,4-96,10); use=IST.fst(96,4-96,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (IST.st_wp_ @x0
@x1)
Tm_type))
 

:pattern ((IST.st_wp_ @x0
@x1))
:qid typing_IST.st_wp_))

:named typing_IST.st_wp_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IST.st_pre; Namespace IST
(assert (! 
;; def=IST.fst(28,4-28,10); use=IST.fst(28,4-28,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (IST.st_pre @x0)
Tm_type))
 

:pattern ((IST.st_pre @x0))
:qid typing_IST.st_pre))

:named typing_IST.st_pre))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IST.st_post; Namespace IST
(assert (! 
;; def=IST.fst(30,4-30,11); use=IST.fst(30,4-30,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (IST.st_post @x0
@x1)
Tm_type))
 

:pattern ((IST.st_post @x0
@x1))
:qid typing_IST.st_post))

:named typing_IST.st_post))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8b4848919572460b02bccfcb169db4b9
;;; Fact-ids: Name IST.st_wp'; Namespace IST
(assert (! 
;; def=IST.fst(96,34-96,57); use=IST.fst(96,34-96,57)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_8b4848919572460b02bccfcb169db4b9 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_8b4848919572460b02bccfcb169db4b9 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_8b4848919572460b02bccfcb169db4b9))

:named kinding_Tm_arrow_8b4848919572460b02bccfcb169db4b9))
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (IST.st_wp_ @x0
@x1)
(Tm_arrow_8b4848919572460b02bccfcb169db4b9 @x0
@x1))
 

:pattern ((IST.st_wp_ @x0
@x1))
:qid equation_IST.st_wp_))

:named equation_IST.st_wp_))
;;;;;;;;;;;;;;;;Equation for IST.st_pre
;;; Fact-ids: Name IST.st_pre; Namespace IST
(assert (! 
;; def=IST.fst(28,4-28,10); use=IST.fst(28,4-28,10)
(forall ((@x0 Term))
...
:pattern ((IST.st_pre @x0))
:qid equation_IST.st_pre))

:named equation_IST.st_pre))
;;;;;;;;;;;;;;;;Equation for IST.st_post
;;; Fact-ids: Name IST.st_post; Namespace IST
(assert (! 
;; def=IST.fst(30,4-30,11); use=IST.fst(30,4-30,11)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((IST.st_post @x0
@x1))
:qid equation_IST.st_post))

:named equation_IST.st_post))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_8b4848919572460b02bccfcb169db4b9 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_8b4848919572460b02bccfcb169db4b9 @x2
@x3)))
:qid IST_pre_typing_Tm_arrow_8b4848919572460b02bccfcb169db4b9))

:named IST_pre_typing_Tm_arrow_8b4848919572460b02bccfcb169db4b9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8b4848919572460b02bccfcb169db4b9
;;; Fact-ids: Name IST.st_wp'; Namespace IST
(assert (! 
;; def=IST.fst(96,34-96,57); use=IST.fst(96,34-96,57)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_8b4848919572460b02bccfcb169db4b9 @x1
@x2))
(and 
;; def=IST.fst(96,34-96,57); use=IST.fst(96,34-96,57)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid IST_interpretation_Tm_arrow_8b4848919572460b02bccfcb169db4b9.1))
...
(Tm_arrow_8b4848919572460b02bccfcb169db4b9 @x1
@x2)))
:qid IST_interpretation_Tm_arrow_8b4848919572460b02bccfcb169db4b9))

:named IST_interpretation_Tm_arrow_8b4848919572460b02bccfcb169db4b9))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Pervasives.st_post_h'; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(442,21-442,67); use=FStar.Pervasives.fsti(442,36-442,67)
...
; Starting query at IST.fst(100,4-100,43)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (s: Type) (wp: IST.st_wp' a s).
;   (*  - Could not prove post-condition
; *)
;   forall (s': Type0) (post: FStar.Pervasives.st_post_h s' a) (s0: s').
;     (*  - Could not prove post-condition
; *)
;     s == s' ==>
;     (forall (_: a) (_: s). Prims.has_type _ s') /\
;     (forall (any_result: FStar.Pervasives.st_post_h s' a).
;         post == any_result ==> (forall (any_result: IST.st_pre s). Prims.has_type s0 s))
...
;; def=dummy(0,0-0,0); use=IST.fst(100,4-100,43)
...
;; def=IST.fst(100,22-100,29); use=IST.fst(100,22-100,29)
(= @x1
@x3)
)

;; def=Prims.fst(459,77-459,89); use=IST.fst(100,22-100,43)
(and 
;; def=dummy(0,0-0,0); use=IST.fst(100,36-100,40)
...
;; def=IST.fst(100,11-100,15); use=IST.fst(100,36-100,40)
(or label_1
(HasType @x7
@x3))
)
...
;; def=Prims.fst(451,66-451,102); use=IST.fst(100,22-100,43)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(FStar.Pervasives.st_post_h @x3
@x0))

;; def=dummy(0,0-0,0); use=IST.fst(100,22-100,43)
(= @x4
@x6)
)
...
;; def=IST.fst(100,16-100,18); use=IST.fst(100,41-100,43)
(or label_2
(HasType @x5
@x1))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IST.op_Greater_Less, 1)
; STATUS: unsat
...
(declare-fun IST.op_Greater_Less (Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> wp: st_wp' a s -> st_wp a
(declare-fun Tm_arrow_03b23559c1ed130973c1bdde4b8fbe2b () Term)
(declare-fun IST.op_Greater_Less@tok () Term)
;;;;;;;;;;;;;;;;s': Type -> post: FStar.Pervasives.st_post_h s' a -> s0: s' -> Prims.GTot Type
(declare-fun Tm_arrow_1a0096e1db926794f9dc1a9d4d9f91b0 (Term) Term)
(declare-fun Tm_abs_3c0cf3251ddf2fdb863e8d3c446489b5 (Term Term Term) Term)

; </end encoding let op_Greater_Less>


; encoding sigelt val IST.get


; <Start encoding val IST.get>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IST.get (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IST.get@tok () Term)

; </end encoding val IST.get>


; encoding sigelt val IST.put


; <Start encoding val IST.put>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IST.put (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IST.put@tok () Term)

; </end encoding val IST.put>
...
; Starting query at IST.fst(113,4-113,6)
...
;   (*  - Could not prove post-condition
; *)
;   forall (s: Type0) (post: IST.st_post s Prims.unit) (s0: s).
;     Prims.int == s /\ post () s0 ==> (forall (any_result: Prims.unit). post any_result s0)
...
;; def=IST.fst(59,4-59,79); use=IST.fst(79,22-79,33)
...
;; def=IST.fst(100,22-100,29); use=IST.fst(112,28-112,29)
(= Prims.int
@x1)


;; def=IST.fst(112,43-112,50); use=IST.fst(113,4-113,6)
(Valid 
;; def=IST.fst(112,43-112,50); use=IST.fst(113,4-113,6)
(ApplyTT (ApplyTT @x2
Tm_unit)
...
;; def=IST.fst(90,17-90,23); use=IST.fst(113,4-113,6)
(or label_1

;; def=IST.fst(90,17-90,23); use=IST.fst(91,26-91,37)
(Valid 
;; def=IST.fst(90,17-90,23); use=IST.fst(91,26-91,37)
(ApplyTT (ApplyTT @x2
@x4)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IST.f (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IST.f@tok () Term)
...
; Starting query at IST.fst(117,3-117,36)
...
;;; Fact-ids: 
(assert (! 
;; def=IST.fst(115,6-115,20); use=IST.fst(115,6-115,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=IST.fst(115,13-115,18); use=IST.fst(115,13-115,18)
(> (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (BoxInt 0)))
))
...
; Encoding query formula : forall (i: Prims.nat{i > 0}).
;   (*  - Could not prove post-condition
; *)
;   forall (s: Type0) (post: IST.st_post s Prims.int) (s0: s).
;     Prims.int == s /\ (forall (k: Prims.int). k > s0 ==> post s0 k) ==>
;     Prims.int == s /\ (Prims.int == s) /\ post s0 (i + s0)
...
;; def=IST.fst(100,22-100,29); use=IST.fst(116,20-116,21)
(= Prims.int
@x1)


;; def=IST.fst(116,35-116,63); use=IST.fst(117,3-117,36)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.int)

;; def=IST.fst(116,46-116,52); use=IST.fst(117,3-117,36)
(> (BoxInt_proj_0 @x4)
(BoxInt_proj_0 @x3))
)

;; def=IST.fst(116,57-116,63); use=IST.fst(117,3-117,36)
(Valid 
;; def=IST.fst(116,57-116,63); use=IST.fst(117,3-117,36)
(ApplyTT (ApplyTT @x2
@x3)
...
;; def=IST.fst(100,22-100,43); use=IST.fst(117,3-117,36)
(and 
;; def=IST.fst(100,22-100,29); use=IST.fst(117,3-117,36)
(or label_1
...
;; def=IST.fst(41,23-41,38); use=IST.fst(117,3-117,36)
(or label_3
...
; QUERY ID: (IST.g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, int_typing, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_afd51579b90d50ea23e03b743a1fa001
