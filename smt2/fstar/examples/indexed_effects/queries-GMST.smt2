...
; encoding sigelt let gmst_post


; <Start encoding let gmst_post>

(declare-fun GMST.gmst_post (Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> a: Type -> s0: s -> Type
(declare-fun Tm_arrow_6bccb0a2b1b1f939f098ecb8863085cf () Term)
(declare-fun GMST.gmst_post@tok () Term)
(declare-fun Tm_refine_08698b4b6e166624b5bf789ac071b4cf (Term Term Term) Term)
;;;;;;;;;;;;;;;;rel: FStar.Preorder.relation s -> _: a -> s1: s{rel s0 s1} -> Prims.GTot Type
(declare-fun Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9 (Term Term Term) Term)

; </end encoding let gmst_post>


; encoding sigelt let gmst_wp


; <Start encoding let gmst_wp>

(declare-fun GMST.gmst_wp (Term Term) Term)

(declare-fun GMST.gmst_wp@tok () Term)
;;;;;;;;;;;;;;;;s0: s -> _: gmst_post s a s0 -> Prims.GTot Type
(declare-fun Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0 (Term Term) Term)

; </end encoding let gmst_wp>


; encoding sigelt let op_At


; <Start encoding let op_At>

(declare-fun GMST.op_At (Term Term Term) Term)
;;;;;;;;;;;;;;;;rel1: FStar.Preorder.relation a -> rel0: FStar.Preorder.relation a -> FStar.Preorder.relation a
(declare-fun Tm_arrow_ef2307ba2d40dd285730e57a4684420d () Term)
(declare-fun GMST.op_At@tok () Term)

(declare-fun Tm_abs_977f4587185e5670a5fb0917e4ca37a4 (Term Term Term Term Term) Term)

(declare-fun Tm_abs_52fe06aa3756057d09f0d03f1113e61e (Term Term Term) Term)

; </end encoding let op_At>


; encoding sigelt let gmst_return


; <Start encoding let gmst_return>

(declare-fun GMST.gmst_return (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> a: Type -> x: a -> s0: s -> p: gmst_post s a s0 -> Prims.logical
(declare-fun Tm_arrow_a0a4549329b60b925668c5311e2248ac () Term)
(declare-fun GMST.gmst_return@tok () Term)

(declare-fun Tm_abs_d82b071f52606d28a1f5f5870f4b75f9 (Term) Term)

; </end encoding let gmst_return>
...
;;;;;;;;;;;;;;;;typing_Tm_abs_977f4587185e5670a5fb0917e4ca37a4
;;; Fact-ids: Name GMST.op_At; Namespace GMST
(assert (! 
;; def=GMST.fst(33,15-33,46); use=GMST.fst(33,15-33,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_977f4587185e5670a5fb0917e4ca37a4 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Tm_abs_977f4587185e5670a5fb0917e4ca37a4 @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_977f4587185e5670a5fb0917e4ca37a4))

:named typing_Tm_abs_977f4587185e5670a5fb0917e4ca37a4))
...
;;;;;;;;;;;;;;;;typing_Tm_abs_52fe06aa3756057d09f0d03f1113e61e
;;; Fact-ids: Name GMST.op_At; Namespace GMST
(assert (! 
;; def=GMST.fst(33,15-33,46); use=GMST.fst(33,15-33,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_52fe06aa3756057d09f0d03f1113e61e @x0
@x1
@x2)
(Tm_arrow_a19f9d49348d4e0038f0ded87d87802f @x2))
 

:pattern ((Tm_abs_52fe06aa3756057d09f0d03f1113e61e @x0
@x1
@x2))
:qid typing_Tm_abs_52fe06aa3756057d09f0d03f1113e61e))

:named typing_Tm_abs_52fe06aa3756057d09f0d03f1113e61e))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name GMST.op_At; Namespace GMST
(assert (! 
;; def=GMST.fst(32,5-32,6); use=GMST.fst(32,5-32,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(FStar.Preorder.relation @x0)))
(HasType (GMST.op_At @x0
@x1
@x2)
(FStar.Preorder.relation @x0)))
 

:pattern ((GMST.op_At @x0
@x1
@x2))
:qid typing_GMST.op_At))

:named typing_GMST.op_At))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GMST.gmst_wp; Namespace GMST
(assert (! 
;; def=GMST.fst(30,4-30,11); use=GMST.fst(30,4-30,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (GMST.gmst_wp @x0
@x1)
Tm_type))
 

:pattern ((GMST.gmst_wp @x0
@x1))
:qid typing_GMST.gmst_wp))

:named typing_GMST.gmst_wp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GMST.gmst_post; Namespace GMST
(assert (! 
;; def=GMST.fst(29,4-29,13); use=GMST.fst(29,4-29,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
@x0))
(HasType (GMST.gmst_post @x0
@x1
@x2)
Tm_type))
 

:pattern ((GMST.gmst_post @x0
@x1
@x2))
:qid typing_GMST.gmst_post))

:named typing_GMST.gmst_post))
;;;;;;;;;;;;;;;;free var typing
...
;; def=GMST.fst(32,5-32,6); use=GMST.fst(32,5-32,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT GMST.op_At@tok
@x0)
@x1)
@x2)
(GMST.op_At @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT GMST.op_At@tok
@x0)
@x1)
@x2))
:qid token_correspondence_GMST.op_At))

:named token_correspondence_GMST.op_At))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name GMST.gmst_post; Namespace GMST
(assert (! 
;; def=GMST.fst(29,64-29,79); use=GMST.fst(29,64-29,79)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;; def=GMST.fst(29,69-29,78); use=GMST.fst(29,69-29,78)
(Valid 
;; def=GMST.fst(29,69-29,78); use=GMST.fst(29,69-29,78)
(ApplyTT (ApplyTT @x3
@x4)
...
;; def=GMST.fst(33,15-33,46); use=GMST.fst(33,15-33,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.l_Exists @x4
(Tm_abs_977f4587185e5670a5fb0917e4ca37a4 @x3
@x2
@x1
@x0
@x4)))
...
;; def=GMST.fst(33,26-33,34); use=GMST.fst(33,26-33,34)
(Valid 
;; def=GMST.fst(33,26-33,34); use=GMST.fst(33,26-33,34)
(ApplyTT (ApplyTT @x3
@x2)
...
;; def=GMST.fst(33,38-33,46); use=GMST.fst(33,38-33,46)
(Valid 
;; def=GMST.fst(33,38-33,46); use=GMST.fst(33,38-33,46)
(ApplyTT (ApplyTT @x1
@x5)
...
;;no pats
:qid l_quant_interp_0d4740bac0e7318c12dd62f1c939a21c.1))
)
 

:pattern ((Valid (Prims.l_Exists @x4
(Tm_abs_977f4587185e5670a5fb0917e4ca37a4 @x3
@x2
@x1
@x0
@x4))))
:qid l_quant_interp_0d4740bac0e7318c12dd62f1c939a21c))

:named l_quant_interp_0d4740bac0e7318c12dd62f1c939a21c))
;;;;;;;;;;;;;;;;/\ interpretation
;;; Fact-ids: Name Prims.l_and; Namespace Prims
...
:qid l_and-interp))
:named l_and-interp))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ef2307ba2d40dd285730e57a4684420d
;;; Fact-ids: Name GMST.op_At; Namespace GMST
(assert (! (HasType Tm_arrow_ef2307ba2d40dd285730e57a4684420d
Tm_type)
:named kinding_Tm_arrow_ef2307ba2d40dd285730e57a4684420d))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0
;;; Fact-ids: Name GMST.gmst_wp; Namespace GMST
(assert (! 
;; def=GMST.fst(30,15-30,79); use=GMST.fst(30,44-30,79)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0))

:named kinding_Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9
;;; Fact-ids: Name GMST.gmst_post; Namespace GMST
(assert (! 
;; def=GMST.fst(29,24-29,93); use=GMST.fst(29,45-29,93)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9))

:named kinding_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9))
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_977f4587185e5670a5fb0917e4ca37a4
;;; Fact-ids: Name GMST.op_At; Namespace GMST
(assert (! 
;; def=GMST.fst(33,15-33,46); use=GMST.fst(33,15-33,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (Tm_abs_977f4587185e5670a5fb0917e4ca37a4 @x1
@x2
@x3
@x4
@x5)
...
:pattern ((ApplyTT (Tm_abs_977f4587185e5670a5fb0917e4ca37a4 @x1
@x2
@x3
@x4
@x5)
@x0))
:qid interpretation_Tm_abs_977f4587185e5670a5fb0917e4ca37a4))

:named interpretation_Tm_abs_977f4587185e5670a5fb0917e4ca37a4))
...
;; def=GMST.fst(33,15-33,46); use=GMST.fst(33,15-33,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_52fe06aa3756057d09f0d03f1113e61e @x2
@x3
@x4)
@x0)
@x1)
(Prims.l_Exists @x4
(Tm_abs_977f4587185e5670a5fb0917e4ca37a4 @x2
@x0
@x3
@x1
@x4)))
...
:pattern ((ApplyTT (ApplyTT (Tm_abs_52fe06aa3756057d09f0d03f1113e61e @x2
@x3
@x4)
@x0)
@x1))
:qid interpretation_Tm_abs_52fe06aa3756057d09f0d03f1113e61e))

:named interpretation_Tm_abs_52fe06aa3756057d09f0d03f1113e61e))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType GMST.op_At@tok
Tm_arrow_ef2307ba2d40dd285730e57a4684420d))
...
:pattern ((GMST.op_At @x1
@x2
@x3))
:qid function_token_typing_GMST.op_At.1))
)
 

:pattern ((ApplyTT @x0
GMST.op_At@tok))
:qid function_token_typing_GMST.op_At))

:named function_token_typing_GMST.op_At))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
;; def=Prims.fst(183,5-183,9); use=Prims.fst(183,5-183,9)
...
@x1
@x2)
(Tm_abs_52fe06aa3756057d09f0d03f1113e61e @x2
@x1
@x0))
...
@x1
@x2))
:qid equation_GMST.op_At))

:named equation_GMST.op_At))
;;;;;;;;;;;;;;;;Equation for GMST.gmst_wp
;;; Fact-ids: Name GMST.gmst_wp; Namespace GMST
(assert (! 
;; def=GMST.fst(30,4-30,11); use=GMST.fst(30,4-30,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (GMST.gmst_wp @x0
@x1)
(Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0 @x1
@x0))
 

:pattern ((GMST.gmst_wp @x0
@x1))
:qid equation_GMST.gmst_wp))

:named equation_GMST.gmst_wp))
;;;;;;;;;;;;;;;;Equation for GMST.gmst_post
;;; Fact-ids: Name GMST.gmst_post; Namespace GMST
(assert (! 
;; def=GMST.fst(29,4-29,13); use=GMST.fst(29,4-29,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x1
@x2)
(Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9 @x2
@x1
@x0))
...
@x1
@x2))
:qid equation_GMST.gmst_post))

:named equation_GMST.gmst_post))
...
;;; Fact-ids: Name GMST.op_At; Namespace GMST
(assert (! 
;; def=GMST.fst(32,12-32,66); use=GMST.fst(32,12-32,66)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ef2307ba2d40dd285730e57a4684420d)
...
@x1
Tm_arrow_ef2307ba2d40dd285730e57a4684420d))
:qid GMST_pre_typing_Tm_arrow_ef2307ba2d40dd285730e57a4684420d))

:named GMST_pre_typing_Tm_arrow_ef2307ba2d40dd285730e57a4684420d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name GMST.gmst_wp; Namespace GMST
(assert (! 
;; def=GMST.fst(30,15-30,79); use=GMST.fst(30,44-30,79)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0 @x2
@x3)))
:qid GMST_pre_typing_Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0))

:named GMST_pre_typing_Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name GMST.gmst_post; Namespace GMST
(assert (! 
;; def=GMST.fst(29,24-29,93); use=GMST.fst(29,45-29,93)
...
@x3
@x4)))
:qid GMST_pre_typing_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9))

:named GMST_pre_typing_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ef2307ba2d40dd285730e57a4684420d
;;; Fact-ids: Name GMST.op_At; Namespace GMST
(assert (! 
;; def=GMST.fst(32,12-32,66); use=GMST.fst(32,12-32,66)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid GMST_interpretation_Tm_arrow_ef2307ba2d40dd285730e57a4684420d.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid GMST_interpretation_Tm_arrow_ef2307ba2d40dd285730e57a4684420d.2))
...
@x1)
@x2))
:qid GMST_interpretation_Tm_arrow_ef2307ba2d40dd285730e57a4684420d.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_ef2307ba2d40dd285730e57a4684420d))
:qid GMST_interpretation_Tm_arrow_ef2307ba2d40dd285730e57a4684420d))

:named GMST_interpretation_Tm_arrow_ef2307ba2d40dd285730e57a4684420d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0
;;; Fact-ids: Name GMST.gmst_wp; Namespace GMST
(assert (! 
;; def=GMST.fst(30,15-30,79); use=GMST.fst(30,44-30,79)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x3)
@x4))
:qid GMST_interpretation_Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid GMST_interpretation_Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0.2))
))
...
(Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0 @x1
@x2)))
:qid GMST_interpretation_Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0))

:named GMST_interpretation_Tm_arrow_7861f6b1f15d3c27e7628d9feaea6ef0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9
;;; Fact-ids: Name GMST.gmst_post; Namespace GMST
(assert (! 
;; def=GMST.fst(29,24-29,93); use=GMST.fst(29,45-29,93)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9 @x1
@x2
@x3))
(and 
;; def=GMST.fst(29,24-29,93); use=GMST.fst(29,45-29,93)
...
(FStar.Preorder.relation @x3))
(HasType @x5
@x2)
(HasType @x6
(Tm_refine_08698b4b6e166624b5bf789ac071b4cf @x3
@x4
@x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x4)
...
@x5)
@x6))
:qid GMST_interpretation_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid GMST_interpretation_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9.2))
...
@x4)
@x5))
:qid GMST_interpretation_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9.3))
))
...
@x2
@x3)))
:qid GMST_interpretation_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9))

:named GMST_interpretation_Tm_arrow_3f55dbf67c9c69f66053453c562eb8a9))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
; Starting query at GMST.fst(43,4-43,68)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> Prims.GTot (gmst_wp s b)
(declare-fun Tm_arrow_1750cb68c50a44daa32cdb4b7b748166 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1750cb68c50a44daa32cdb4b7b748166
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(40,24-41,62); use=GMST.fst(41,39-41,62)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_1750cb68c50a44daa32cdb4b7b748166 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_1750cb68c50a44daa32cdb4b7b748166 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_1750cb68c50a44daa32cdb4b7b748166))

:named kinding_Tm_arrow_1750cb68c50a44daa32cdb4b7b748166))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(40,24-41,62); use=GMST.fst(41,39-41,62)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_1750cb68c50a44daa32cdb4b7b748166 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid GMST_pre_typing_Tm_arrow_1750cb68c50a44daa32cdb4b7b748166))

:named GMST_pre_typing_Tm_arrow_1750cb68c50a44daa32cdb4b7b748166))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1750cb68c50a44daa32cdb4b7b748166
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(40,24-41,62); use=GMST.fst(41,39-41,62)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_1750cb68c50a44daa32cdb4b7b748166 @x1
@x2
@x3))
(and 
;; def=GMST.fst(40,24-41,62); use=GMST.fst(41,39-41,62)
...
:pattern ((ApplyTT @x0
@x4))
:qid GMST_interpretation_Tm_arrow_1750cb68c50a44daa32cdb4b7b748166.1))
...
@x2
@x3)))
:qid GMST_interpretation_Tm_arrow_1750cb68c50a44daa32cdb4b7b748166))

:named GMST_interpretation_Tm_arrow_1750cb68c50a44daa32cdb4b7b748166))

;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
GMST.op_At@tok))
:named @kick_partial_app_4a5880bcdcd0d1fa5bef035350e0cbdc))
...
; *)
;   forall (rel1: FStar.Preorder.relation s) (x: a) (s1: s{rel1 s0 s1}).
;     (*  - Could not prove post-condition
; *)
;     forall (rel2: FStar.Preorder.relation s).
;       (*  - Could not prove post-condition
; *)
;       forall (_: b) (s1: s). rel2 s1 s1 ==> (rel2 @ rel1) s0 s1


; Context: While encoding a query
; While typechecking the top-level declaration `let gmst_bind`
...
;; def=dummy(0,0-0,0); use=GMST.fst(43,4-43,68)
...
;; def=dummy(0,0-0,0); use=GMST.fst(43,29-43,67)
(forall ((@x10 Term))
 (! (implies (HasType @x10
(FStar.Preorder.relation @x0))

;; def=dummy(0,0-0,0); use=GMST.fst(43,51-43,66)
...
;; def=GMST.fst(29,69-29,78); use=GMST.fst(43,51-43,66)
(Valid 
;; def=GMST.fst(29,69-29,78); use=GMST.fst(43,51-43,66)
(ApplyTT (ApplyTT @x10
@x9)
...
(Valid 
;; def=GMST.fst(29,69-29,78); use=GMST.fst(43,51-43,66)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT GMST.op_At@tok
@x0)
@x10)
@x7)
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GMST.gmst_bind, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_GMST.op_At, interpretation_Tm_abs_52fe06aa3756057d09f0d03f1113e61e, l_quant_interp_0d4740bac0e7318c12dd62f1c939a21c, refinement_interpretation_Tm_refine_08698b4b6e166624b5bf789ac071b4cf, token_correspondence_GMST.op_At
...
; encoding sigelt let gmst_bind


; <Start encoding let gmst_bind>

;;;;;;;;;;;;;;;;_: a -> Prims.GTot (gmst_wp s b)
(declare-fun Tm_arrow_1750cb68c50a44daa32cdb4b7b748166 (Term Term Term) Term)
(declare-fun GMST.gmst_bind (Term Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;s: Type ->     a: Type ->     b: Type ->     wp1: gmst_wp s a ->     wp2: (_: a -> Prims.GTot (gmst_wp s b)) ->     s0: s ->     p: gmst_post s b s0   -> Type
(declare-fun Tm_arrow_07cd9aba96913ab2462a59ebb0fba03d () Term)
(declare-fun GMST.gmst_bind@tok () Term)



;;;;;;;;;;;;;;;;_: b -> s1: s{rel2 s1 s1} -> Prims.GTot Type
(declare-fun Tm_arrow_f5437a96a3633a02f87814d68497e8e9 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;rel2: FStar.Preorder.relation s -> _: b -> s1: s{rel2 s1 s1} -> Prims.GTot Type
(declare-fun Tm_arrow_f14480b7cf9bb3828a25e4815fe81318 (Term Term Term) Term)
(declare-fun Tm_abs_48d9717cab08650a428ddb322f24b74d (Term Term Term Term Term) Term)


(declare-fun Tm_abs_25052a2aaa47ca64ffb36627f580a37c (Term Term Term Term Term Term) Term)

; </end encoding let gmst_bind>


; encoding sigelt let gmst_if_then_else


; <Start encoding let gmst_if_then_else>

(declare-fun GMST.gmst_if_then_else (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type ->     a: Type ->     p: Type ->     wp_then: gmst_wp s a ->     wp_else: gmst_wp s a ->     s0: s ->     post: gmst_post s a s0   -> Prims.logical
(declare-fun Tm_arrow_94318d3bd4d066634d6c19686cf6bb0d () Term)
(declare-fun GMST.gmst_if_then_else@tok () Term)

; </end encoding let gmst_if_then_else>


; encoding sigelt let gmst_ite


; <Start encoding let gmst_ite>

(declare-fun GMST.gmst_ite (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> a: Type -> wp: gmst_wp s a -> s0: s -> post: gmst_post s a s0 -> Type
(declare-fun Tm_arrow_51b9db456eb9077cf24a67e8d1a375e7 () Term)
(declare-fun GMST.gmst_ite@tok () Term)

; </end encoding let gmst_ite>


; encoding sigelt let gmst_stronger


; <Start encoding let gmst_stronger>

(declare-fun GMST.gmst_stronger (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> a: Type -> wp1: gmst_wp s a -> wp2: gmst_wp s a -> Prims.logical
(declare-fun Tm_arrow_11faf0e1afd634e64ba3490043e2fbce () Term)
(declare-fun GMST.gmst_stronger@tok () Term)

; </end encoding let gmst_stronger>


; encoding sigelt let gmst_close


; <Start encoding let gmst_close>


(declare-fun GMST.gmst_close (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;s: Type ->     a: Type ->     b: Type ->     wp: (_: b -> Prims.GTot (gmst_wp s a)) ->     s0: s ->     p: gmst_post s a s0   -> Prims.logical
(declare-fun Tm_arrow_757e0f8ed55f4a5745846d93cbca203e () Term)
(declare-fun GMST.gmst_close@tok () Term)


; </end encoding let gmst_close>


; encoding sigelt let gmst_trivial


; <Start encoding let gmst_trivial>

(declare-fun GMST.gmst_trivial (Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> a: Type -> wp: gmst_wp s a -> Prims.logical
(declare-fun Tm_arrow_305ad4ea63780313b1403975cb4679c1 () Term)
(declare-fun GMST.gmst_trivial@tok () Term)



(declare-fun Tm_abs_db104cc0f45c12461a5bfb4d4131d76f (Term Term Term) Term)

; </end encoding let gmst_trivial>


; encoding sigelt new_effect { GMST_h ... }


; <Skipped new_effect { GMST_h ... }/>
...
(declare-fun GMST.state (Dummy_sort) Term)

; </end encoding let state>


; encoding sigelt new_effect { GMST ... }


; <Skipped new_effect { GMST ... }/>


; encoding sigelt let lift_div_gmst


; <Start encoding let lift_div_gmst>

(declare-fun GMST.lift_div_gmst (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> s0: state -> p: gmst_post state a s0 -> Prims.pure_pre
(declare-fun Tm_arrow_ae7b317e75632b14f346d537feb30cd4 () Term)
(declare-fun GMST.lift_div_gmst@tok () Term)
;;;;;;;;;;;;;;;;s0: state -> s1: state -> Type
(declare-fun Tm_arrow_9185270b76eefe318bba365668d1bb6f () Term)
(declare-fun Tm_abs_82ec778de9d1387a32415d51903dbca7 () Term)

(declare-fun Tm_abs_9b728148fdfbb433bf963274e0ec60de (Term Term Term) Term)

; </end encoding let lift_div_gmst>


; encoding sigelt sub_effect DIV ~> GMST


; <Skipped sub_effect DIV ~> GMST/>


; encoding sigelt let mst_wp


; <Start encoding let mst_wp>

(declare-fun GMST.mst_wp (Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> a: Type -> rel: FStar.Preorder.relation s -> Type
(declare-fun Tm_arrow_1f8a51ca0f8a9089bb1543bb31b67fa0 () Term)
(declare-fun GMST.mst_wp@tok () Term)


;;;;;;;;;;;;;;;;s0: s -> _: (_: a -> s1: s{rel s0 s1} -> Type) -> Type
(declare-fun Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74 (Term Term Term) Term)

; </end encoding let mst_wp>
...
(declare-fun GMST.op_Greater_Less (Term Term Term) Term)
;;;;;;;;;;;;;;;;rel: FStar.Preorder.relation state -> wp: mst_wp state a rel -> gmst_wp state a
(declare-fun Tm_arrow_6a0cfd5d4a8f8ede3e8c27d6359d8e02 () Term)
(declare-fun GMST.op_Greater_Less@tok () Term)
;;;;;;;;;;;;;;;;s0: state -> post: gmst_post state a s0 -> Prims.GTot Type
(declare-fun Tm_arrow_91ffe90f8e81b390bd7062dae1d306f5 (Term) Term)
(declare-fun Tm_abs_5cf2e92d8cfe1141f1138fb5088d95a8 (Term Term Term) Term)

; </end encoding let op_Greater_Less>


; encoding sigelt val GMST.gst_get


; <Start encoding val GMST.gst_get>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GMST.gst_get (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GMST.gst_get@tok () Term)

; </end encoding val GMST.gst_get>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GMST.state; Namespace GMST
(assert (! 
;; def=GMST.fst(91,4-91,9); use=GMST.fst(91,4-91,9)
(forall ((@u0 Dummy_sort))
 (! (HasType (GMST.state @u0)
Prims.eqtype)
 

:pattern ((GMST.state @u0))
:qid typing_GMST.state))

:named typing_GMST.state))
;;;;;;;;;;;;;;;;refinement kinding
...
:qid equation_GMST.state))

:named equation_GMST.state))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
; Starting query at GMST.fst(111,7-111,114)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_2dbcc642e30c94354080ed8b90217c10 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(111,25-111,64)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_2dbcc642e30c94354080ed8b90217c10))

:named refinement_kinding_Tm_refine_2dbcc642e30c94354080ed8b90217c10))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(111,25-111,64)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(GMST.state Dummy_value))

;; def=GMST.fst(101,70-101,79); use=GMST.fst(111,25-111,64)
(Valid 
;; def=GMST.fst(101,70-101,79); use=GMST.fst(111,25-111,64)
(ApplyTT (ApplyTT @x2
@x3)
...
(Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_2dbcc642e30c94354080ed8b90217c10))

:named refinement_interpretation_Tm_refine_2dbcc642e30c94354080ed8b90217c10))
;;;;;;;;;;;;;;;;haseq for Tm_refine_2dbcc642e30c94354080ed8b90217c10
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(111,25-111,64)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x0
@x1)))
(Valid (Prims.hasEq (GMST.state Dummy_value))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x0
@x1))))
:qid haseqTm_refine_2dbcc642e30c94354080ed8b90217c10))

:named haseqTm_refine_2dbcc642e30c94354080ed8b90217c10))
;;;;;;;;;;;;;;;;_: Prims.unit -> s1: state{rel s0 s1} -> Type
(declare-fun Tm_arrow_426834afc8d16dced6ae553effa35544 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_426834afc8d16dced6ae553effa35544
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(111,25-111,64)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_426834afc8d16dced6ae553effa35544 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_426834afc8d16dced6ae553effa35544 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_426834afc8d16dced6ae553effa35544))

:named kinding_Tm_arrow_426834afc8d16dced6ae553effa35544))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(111,25-111,64)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_426834afc8d16dced6ae553effa35544 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_426834afc8d16dced6ae553effa35544 @x2
@x3)))
:qid GMST_pre_typing_Tm_arrow_426834afc8d16dced6ae553effa35544))

:named GMST_pre_typing_Tm_arrow_426834afc8d16dced6ae553effa35544))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_426834afc8d16dced6ae553effa35544
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(111,25-111,64)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_426834afc8d16dced6ae553effa35544 @x1
@x2))
(and 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(111,25-111,64)
(forall ((@x3 Term) (@x4 Term))
...
@x3)
@x4))
:qid GMST_interpretation_Tm_arrow_426834afc8d16dced6ae553effa35544.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid GMST_interpretation_Tm_arrow_426834afc8d16dced6ae553effa35544.2))
))
...
(Tm_arrow_426834afc8d16dced6ae553effa35544 @x1
@x2)))
:qid GMST_interpretation_Tm_arrow_426834afc8d16dced6ae553effa35544))

:named GMST_interpretation_Tm_arrow_426834afc8d16dced6ae553effa35544))

; Encoding query formula : forall (rel: FStar.Preorder.relation GMST.state)
;   (s1: GMST.state)
;   (s0: GMST.state)
;   (post: (_: Prims.unit -> s1: GMST.state{rel s0 s1} -> Type0)).
;   (*  - Could not prove post-condition
; *) rel s0 s1 ==> Prims.auto_squash (rel s0 s1)


; Context: While encoding a query
; While typechecking the top-level declaration `val GMST.gst_put`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GMST.fst(111,7-111,114)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
(FStar.Preorder.relation (GMST.state Dummy_value)))
(HasType @x1
(GMST.state Dummy_value))
(HasType @x2
(GMST.state Dummy_value))
...
;; def=GMST.fst(111,89-111,98); use=GMST.fst(111,25-111,64)
(Valid 
;; def=GMST.fst(111,89-111,98); use=GMST.fst(111,25-111,64)
(ApplyTT (ApplyTT @x0
@x2)
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(111,110-111,112)
(or label_1
...
; encoding sigelt val GMST.gst_put


; <Start encoding val GMST.gst_put>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GMST.gst_put (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GMST.gst_put@tok () Term)

; </end encoding val GMST.gst_put>


; encoding sigelt val GMST.witnessed


; <Start encoding val GMST.witnessed>

(declare-fun GMST.witnessed (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Preorder.predicate state -> Type
(declare-fun Tm_arrow_548993e7bec6879c385dabcbb383e13f () Term)
(declare-fun GMST.witnessed@tok () Term)

; </end encoding val GMST.witnessed>
...
(declare-fun GMST.stable (Term Term Term) Term)
;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate a -> rel: FStar.Preorder.preorder a -> Prims.logical
(declare-fun Tm_arrow_f02310e06ec7978f95d211791fc4f83e () Term)
(declare-fun GMST.stable@tok () Term)

; </end encoding let stable>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GMST.witnessed; Namespace GMST
(assert (! 
;; def=GMST.fst(113,11-113,20); use=GMST.fst(113,11-113,20)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Preorder.predicate (GMST.state Dummy_value)))
(HasType (GMST.witnessed @x0)
Tm_type))
 

:pattern ((GMST.witnessed @x0))
:qid typing_GMST.witnessed))

:named typing_GMST.witnessed))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GMST.stable; Namespace GMST
(assert (! 
;; def=GMST.fst(115,4-115,10); use=GMST.fst(115,4-115,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType (GMST.stable @x0
@x1
@x2)
Prims.logical))
 

:pattern ((GMST.stable @x0
@x1
@x2))
:qid typing_GMST.stable))

:named typing_GMST.stable))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Equation for GMST.stable
;;; Fact-ids: Name GMST.stable; Namespace GMST
(assert (! 
;; def=GMST.fst(115,4-115,10); use=GMST.fst(115,4-115,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (GMST.stable @x0
@x1
@x2))

;; def=GMST.fst(116,4-116,39); use=GMST.fst(116,4-116,39)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
@x0)
(HasType @x4
...
;; def=GMST.fst(116,17-116,20); use=GMST.fst(116,17-116,20)
(Valid 
;; def=GMST.fst(116,17-116,20); use=GMST.fst(116,17-116,20)
(ApplyTT @x1
@x3)
...
;; def=GMST.fst(116,24-116,31); use=GMST.fst(116,24-116,31)
(Valid 
;; def=GMST.fst(116,24-116,31); use=GMST.fst(116,24-116,31)
(ApplyTT (ApplyTT @x2
@x3)
...
;; def=GMST.fst(116,36-116,39); use=GMST.fst(116,36-116,39)
(Valid 
;; def=GMST.fst(116,36-116,39); use=GMST.fst(116,36-116,39)
(ApplyTT @x1
@x4)
...
@x1
@x2))
:qid equation_GMST.stable))

:named equation_GMST.stable))
...
(HasType @x2
(FStar.Preorder.preorder @x0)))
(Valid (Prims.subtype_of (GMST.stable @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (GMST.stable @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_GMST.stable))

:named defn_equation_GMST.stable))
...
; Starting query at GMST.fst(118,7-118,156)
...
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(118,29-118,77)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x0
@x1)
Tm_type)
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(118,29-118,77)
(Valid 
;; def=GMST.fst(101,70-101,79); use=GMST.fst(118,29-118,77)
(ApplyTT (ApplyTT @x2
@x3)
...
; Encoding query formula : forall (rel: FStar.Preorder.preorder GMST.state)
;   (p: FStar.Preorder.predicate GMST.state)
;   (s0: GMST.state)
;   (post: (_: Prims.unit -> s1: GMST.state{rel s0 s1} -> Type0)).
;   (*  - Could not prove post-condition
; *)
;   GMST.stable p rel /\ p s0 ==> GMST.witnessed p ==> Prims.auto_squash (rel s0 s0)


; Context: While encoding a query
; While typechecking the top-level declaration `val GMST.gst_witness`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GMST.fst(118,7-118,156)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
(FStar.Preorder.preorder (GMST.state Dummy_value)))
(HasType @x1
(FStar.Preorder.predicate (GMST.state Dummy_value)))
(HasType @x2
(GMST.state Dummy_value))
...
;; def=GMST.fst(118,102-118,114); use=GMST.fst(118,29-118,77)
(Valid 
;; def=GMST.fst(118,102-118,114); use=GMST.fst(118,29-118,77)
(GMST.stable (GMST.state Dummy_value)
@x1
@x0)
)


;; def=GMST.fst(118,118-118,122); use=GMST.fst(118,29-118,77)
(Valid 
;; def=GMST.fst(118,118-118,122); use=GMST.fst(118,29-118,77)
(ApplyTT @x1
@x2)
...
;; def=GMST.fst(118,127-118,138); use=GMST.fst(118,29-118,77)
(Valid 
;; def=GMST.fst(118,127-118,138); use=GMST.fst(118,29-118,77)
(GMST.witnessed @x1)
)
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(118,151-118,153)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GMST.gst_witness, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_GMST.state, int_inversion, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c
...
; encoding sigelt val GMST.gst_witness


; <Start encoding val GMST.gst_witness>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GMST.gst_witness (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GMST.gst_witness@tok () Term)

; </end encoding val GMST.gst_witness>

(push) ;; push{2

; Starting query at GMST.fst(119,7-119,156)
...
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(119,29-119,77)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x0
@x1)
Tm_type)
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(119,29-119,77)
(Valid 
;; def=GMST.fst(101,70-101,79); use=GMST.fst(119,29-119,77)
(ApplyTT (ApplyTT @x2
@x3)
...
;   (*  - Could not prove post-condition
; *)
;   GMST.stable p rel /\ GMST.witnessed p ==> p s0 ==> Prims.auto_squash (rel s0 s0)


; Context: While encoding a query
; While typechecking the top-level declaration `val GMST.gst_recall`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GMST.fst(119,7-119,156)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
(FStar.Preorder.preorder (GMST.state Dummy_value)))
(HasType @x1
...
;; def=GMST.fst(119,102-119,114); use=GMST.fst(119,29-119,77)
(Valid 
;; def=GMST.fst(119,102-119,114); use=GMST.fst(119,29-119,77)
(GMST.stable (GMST.state Dummy_value)
@x1
...
;; def=GMST.fst(119,118-119,129); use=GMST.fst(119,29-119,77)
(Valid 
;; def=GMST.fst(119,118-119,129); use=GMST.fst(119,29-119,77)
(GMST.witnessed @x1)
)
...
;; def=GMST.fst(119,134-119,138); use=GMST.fst(119,29-119,77)
(Valid 
;; def=GMST.fst(119,134-119,138); use=GMST.fst(119,29-119,77)
(ApplyTT @x1
@x2)
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(119,151-119,153)
(or label_1
...
; encoding sigelt val GMST.gst_recall


; <Start encoding val GMST.gst_recall>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GMST.gst_recall (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GMST.gst_recall@tok () Term)

; </end encoding val GMST.gst_recall>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GMST.mst_wp; Namespace GMST
(assert (! 
;; def=GMST.fst(101,4-101,10); use=GMST.fst(101,4-101,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(FStar.Preorder.relation @x0)))
(HasType (GMST.mst_wp @x0
@x1
@x2)
Tm_type))
 

:pattern ((GMST.mst_wp @x0
@x1
@x2))
:qid typing_GMST.mst_wp))

:named typing_GMST.mst_wp))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f5437a96a3633a02f87814d68497e8e9
;;; Fact-ids: Name GMST.gmst_bind; Namespace GMST
(assert (! 
;; def=GMST.fst(29,64-40,34); use=GMST.fst(29,64-41,61)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_arrow_f5437a96a3633a02f87814d68497e8e9 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_arrow_f5437a96a3633a02f87814d68497e8e9 @x0
@x1
@x2
@x3)
Tm_type))
:qid kinding_Tm_arrow_f5437a96a3633a02f87814d68497e8e9))

:named kinding_Tm_arrow_f5437a96a3633a02f87814d68497e8e9))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74
;;; Fact-ids: Name GMST.mst_wp; Namespace GMST
(assert (! 
;; def=GMST.fst(101,15-101,99); use=GMST.fst(101,54-101,99)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74))

:named kinding_Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74))
;;;;;;;;;;;;;;;;Equation for GMST.mst_wp
;;; Fact-ids: Name GMST.mst_wp; Namespace GMST
(assert (! 
;; def=GMST.fst(101,4-101,10); use=GMST.fst(101,4-101,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x1
@x2)
(Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74 @x1
@x2
@x0))
...
@x1
@x2))
:qid equation_GMST.mst_wp))

:named equation_GMST.mst_wp))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name GMST.gmst_bind; Namespace GMST
(assert (! 
;; def=GMST.fst(29,64-40,34); use=GMST.fst(29,64-41,61)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_f5437a96a3633a02f87814d68497e8e9 @x2
@x3
@x4
@x5))
(is-Tm_arrow (PreType @x1)))
...
@x4
@x5)))
:qid GMST_pre_typing_Tm_arrow_f5437a96a3633a02f87814d68497e8e9))

:named GMST_pre_typing_Tm_arrow_f5437a96a3633a02f87814d68497e8e9))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name GMST.mst_wp; Namespace GMST
(assert (! 
;; def=GMST.fst(101,15-101,99); use=GMST.fst(101,54-101,99)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid GMST_pre_typing_Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74))

:named GMST_pre_typing_Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f5437a96a3633a02f87814d68497e8e9
;;; Fact-ids: Name GMST.gmst_bind; Namespace GMST
(assert (! 
;; def=GMST.fst(29,64-40,34); use=GMST.fst(29,64-41,61)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f5437a96a3633a02f87814d68497e8e9 @x1
@x2
@x3
@x4))
(and 
...
@x5)
@x6))
:qid GMST_interpretation_Tm_arrow_f5437a96a3633a02f87814d68497e8e9.1))
...
:pattern ((ApplyTT @x0
@x5))
:qid GMST_interpretation_Tm_arrow_f5437a96a3633a02f87814d68497e8e9.2))
))
...
@x3
@x4)))
:qid GMST_interpretation_Tm_arrow_f5437a96a3633a02f87814d68497e8e9))

:named GMST_interpretation_Tm_arrow_f5437a96a3633a02f87814d68497e8e9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74
;;; Fact-ids: Name GMST.mst_wp; Namespace GMST
(assert (! 
;; def=GMST.fst(101,15-101,99); use=GMST.fst(101,54-101,99)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x3)
(HasType @x5
(Tm_arrow_f5437a96a3633a02f87814d68497e8e9 @x4
@x2
@x3
@x1)))
(HasType (ApplyTT (ApplyTT @x0
...
@x4)
@x5))
:qid GMST_interpretation_Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid GMST_interpretation_Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74.2))
))
...
@x2
@x3)))
:qid GMST_interpretation_Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74))

:named GMST_interpretation_Tm_arrow_159fb2e5bf886f9bb6d2c7ee349add74))
(push) ;; push{2

; Starting query at GMST.fst(132,4-132,12)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> mst_wp state b rel2
(declare-fun Tm_arrow_225a6e314a082a3aa78a44f387d5b025 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_225a6e314a082a3aa78a44f387d5b025
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(124,10-128,38); use=GMST.fst(128,14-128,38)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_225a6e314a082a3aa78a44f387d5b025 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_225a6e314a082a3aa78a44f387d5b025 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_225a6e314a082a3aa78a44f387d5b025))

:named kinding_Tm_arrow_225a6e314a082a3aa78a44f387d5b025))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(124,10-128,38); use=GMST.fst(128,14-128,38)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_225a6e314a082a3aa78a44f387d5b025 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid GMST_pre_typing_Tm_arrow_225a6e314a082a3aa78a44f387d5b025))

:named GMST_pre_typing_Tm_arrow_225a6e314a082a3aa78a44f387d5b025))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_225a6e314a082a3aa78a44f387d5b025
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(124,10-128,38); use=GMST.fst(128,14-128,38)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_225a6e314a082a3aa78a44f387d5b025 @x1
@x2
@x3))
(and 
;; def=GMST.fst(124,10-128,38); use=GMST.fst(128,14-128,38)
...
(HasType (ApplyTT @x0
@x4)
(GMST.mst_wp (GMST.state Dummy_value)
@x2
@x1)))
...
:pattern ((ApplyTT @x0
@x4))
:qid GMST_interpretation_Tm_arrow_225a6e314a082a3aa78a44f387d5b025.1))
...
@x2
@x3)))
:qid GMST_interpretation_Tm_arrow_225a6e314a082a3aa78a44f387d5b025))

:named GMST_interpretation_Tm_arrow_225a6e314a082a3aa78a44f387d5b025))
(declare-fun Non_total_Tm_arrow_db71a6e8f54af0b3f691f40c48dcf26e (Term Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(124,10-129,15); use=GMST.fst(129,11-129,25)
(forall ((@x0 Term))
 (! 
;; def=GMST.fst(124,10-129,15); use=GMST.fst(129,11-129,25)
(forall ((@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(FStar.Preorder.relation (GMST.state Dummy_value))))
(HasType (Non_total_Tm_arrow_db71a6e8f54af0b3f691f40c48dcf26e @x1
@x2
@x3)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_db71a6e8f54af0b3f691f40c48dcf26e @x1
@x2
@x3)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_db71a6e8f54af0b3f691f40c48dcf26e.1))

 
;;no pats
:qid non_total_function_typing_Non_total_Tm_arrow_db71a6e8f54af0b3f691f40c48dcf26e))

:named non_total_function_typing_Non_total_Tm_arrow_db71a6e8f54af0b3f691f40c48dcf26e))

(declare-fun Non_total_Tm_arrow_a7b148a7fec6c247c5797c4358a4fa55 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(124,10-124,21); use=GMST.fst(130,14-130,25)
(forall ((@x0 Term))
 (! 
;; def=GMST.fst(124,10-124,21); use=GMST.fst(130,14-130,25)
...
Tm_type)
(HasType @x3
(Tm_arrow_225a6e314a082a3aa78a44f387d5b025 @x0
@x2
@x1))
(HasType @x4
(FStar.Preorder.relation (GMST.state Dummy_value))))
(HasType (Non_total_Tm_arrow_a7b148a7fec6c247c5797c4358a4fa55 @x1
@x2
@x3
@x4)
Tm_type))
...
:pattern ((HasType (Non_total_Tm_arrow_a7b148a7fec6c247c5797c4358a4fa55 @x1
@x2
@x3
@x4)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_a7b148a7fec6c247c5797c4358a4fa55.1))

 
;;no pats
:qid non_total_function_typing_Non_total_Tm_arrow_a7b148a7fec6c247c5797c4358a4fa55))

:named non_total_function_typing_Non_total_Tm_arrow_a7b148a7fec6c247c5797c4358a4fa55))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
GMST.op_At@tok))
:named @kick_partial_app_4a5880bcdcd0d1fa5bef035350e0cbdc))
(declare-fun Tm_refine_beed318eb044f064dc4f5845e3fbae65 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(132,4-132,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_beed318eb044f064dc4f5845e3fbae65 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_beed318eb044f064dc4f5845e3fbae65 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_beed318eb044f064dc4f5845e3fbae65))

:named refinement_kinding_Tm_refine_beed318eb044f064dc4f5845e3fbae65))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(132,4-132,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_beed318eb044f064dc4f5845e3fbae65 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(132,4-132,12)
(Valid 
;; def=GMST.fst(101,70-101,79); use=GMST.fst(132,4-132,12)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT GMST.op_At@tok
(GMST.state Dummy_value))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_beed318eb044f064dc4f5845e3fbae65))

:named refinement_interpretation_Tm_refine_beed318eb044f064dc4f5845e3fbae65))
;;;;;;;;;;;;;;;;haseq for Tm_refine_beed318eb044f064dc4f5845e3fbae65
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(132,4-132,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_beed318eb044f064dc4f5845e3fbae65 @x0
@x1
@x2)))
(Valid (Prims.hasEq (GMST.state Dummy_value))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_beed318eb044f064dc4f5845e3fbae65 @x0
@x1
@x2))))
:qid haseqTm_refine_beed318eb044f064dc4f5845e3fbae65))

:named haseqTm_refine_beed318eb044f064dc4f5845e3fbae65))
;;;;;;;;;;;;;;;;_: b -> s1: state{(rel2 @ rel1) s0 s1} -> Type
(declare-fun Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-124,21); use=GMST.fst(128,32-132,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958 @x0
@x1
@x2
@x3)
Tm_type))
:qid kinding_Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958))

:named kinding_Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-124,21); use=GMST.fst(128,32-132,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958 @x2
@x3
@x4
@x5))
(is-Tm_arrow (PreType @x1)))
...
@x4
@x5)))
:qid GMST_pre_typing_Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958))

:named GMST_pre_typing_Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-124,21); use=GMST.fst(128,32-132,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958 @x1
@x2
@x3
@x4))
(and 
...
@x4)
(HasType @x6
(Tm_refine_beed318eb044f064dc4f5845e3fbae65 @x3
@x2
@x1)))
(HasType (ApplyTT (ApplyTT @x0
@x5)
...
@x5)
@x6))
:qid GMST_interpretation_Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958.1))
...
:pattern ((ApplyTT @x0
@x5))
:qid GMST_interpretation_Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958.2))
))
...
@x3
@x4)))
:qid GMST_interpretation_Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958))

:named GMST_interpretation_Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958))
(declare-fun Tm_refine_2dbcc642e30c94354080ed8b90217c10 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
...
; Encoding query formula : forall (a: Type) (b: Type) (rel1: FStar.Preorder.relation GMST.state)
;   (rel2: FStar.Preorder.relation GMST.state) (wp1: GMST.mst_wp GMST.state a rel1)
;   (wp2: (_: a -> GMST.mst_wp GMST.state b rel2)) (f: (_: Prims.unit -> GMST.GMST a))
;   (g: (x: a -> GMST.GMST b)) (s0: GMST.state)
;   (p: (_: b -> s1: GMST.state{(rel2 @ rel1) s0 s1} -> Type0)).
;   (*  - Could not prove post-condition
; *)
;   forall (x: a) (s1: GMST.state{rel1 s0 s1}).
;     (*  - Could not prove post-condition
; *)
;     forall (_: b) (s1: GMST.state). rel2 s1 s1 ==> (rel2 @ rel1) s0 s1


; Context: While encoding a query
; While typechecking the top-level declaration `let app`
...
@x2))
(HasType @x5
(Tm_arrow_225a6e314a082a3aa78a44f387d5b025 @x3
@x1
@x0))
(HasType @x6
(Non_total_Tm_arrow_db71a6e8f54af0b3f691f40c48dcf26e @x0
@x4
@x2))
(HasType @x7
(Non_total_Tm_arrow_a7b148a7fec6c247c5797c4358a4fa55 @x0
@x1
@x5
@x3))
(HasType @x8
(GMST.state Dummy_value))
(HasType @x9
(Tm_arrow_103f5c09e93b28e8a3a2d8fc7eb11958 @x8
@x2
@x3
@x1)))

;; def=dummy(0,0-0,0); use=GMST.fst(132,4-132,12)
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(131,71-131,72)
(or label_1
...
; QUERY ID: (GMST.app, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_GMST.op_At, equation_GMST.state, int_inversion, interpretation_Tm_abs_52fe06aa3756057d09f0d03f1113e61e, l_quant_interp_0d4740bac0e7318c12dd62f1c939a21c, refinement_interpretation_Tm_refine_2dbcc642e30c94354080ed8b90217c10, token_correspondence_GMST.op_At
...
; encoding sigelt let app


; <Start encoding let app>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GMST.app (Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GMST.app@tok () Term)

; </end encoding let app>
...
; Starting query at GMST.fst(153,4-153,6)
...
; Encoding query formula : forall (a: Type) (rel: FStar.Preorder.preorder a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         (forall (x: a) (y: a). (rel @ rel) x y <==> rel x y) ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_preorder_comp_equiv`
...
;; def=Prims.fst(441,36-441,97); use=GMST.fst(153,4-153,6)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=GMST.fst(152,10-152,53); use=GMST.fst(153,4-153,6)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
@x0)
(HasType @x5
...
;; def=GMST.fst(152,24-152,52); use=GMST.fst(153,4-153,6)
(or label_2

;; def=GMST.fst(152,24-152,52); use=GMST.fst(153,4-153,6)
(iff 
;; def=GMST.fst(152,24-152,39); use=GMST.fst(153,4-153,6)
(Valid 
;; def=GMST.fst(152,24-152,39); use=GMST.fst(153,4-153,6)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT GMST.op_At@tok
@x0)
...
;; def=GMST.fst(152,45-152,52); use=GMST.fst(153,4-153,6)
(Valid 
;; def=GMST.fst(152,45-152,52); use=GMST.fst(153,4-153,6)
(ApplyTT (ApplyTT @x1
@x4)
...
;; def=Prims.fst(441,83-441,96); use=GMST.fst(153,4-153,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GMST.fst(153,4-153,6)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GMST.lemma_preorder_comp_equiv, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_GMST.op_At, interpretation_Tm_abs_52fe06aa3756057d09f0d03f1113e61e, l_quant_interp_0d4740bac0e7318c12dd62f1c939a21c, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, token_correspondence_GMST.op_At
...
; encoding sigelt let lemma_preorder_comp_equiv


; <Start encoding let lemma_preorder_comp_equiv>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GMST.lemma_preorder_comp_equiv (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GMST.lemma_preorder_comp_equiv@tok () Term)

; </end encoding let lemma_preorder_comp_equiv>


; encoding sigelt let lemma_preorder_comp_equal


; <Start encoding let lemma_preorder_comp_equal>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GMST.lemma_preorder_comp_equal (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GMST.lemma_preorder_comp_equal@tok () Term)

; </end encoding let lemma_preorder_comp_equal>

;;;;;;;;;;;;;;;;Lemma: GMST.lemma_preorder_comp_equal
;;; Fact-ids: Name GMST.lemma_preorder_comp_equal; Namespace GMST
(assert (! (forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=GMST.fst(156,10-156,28); use=GMST.fst(156,10-156,28)
(= (GMST.op_At @x0
@x1
@x1)
@x1)
...
@x1
@x1))
:qid lemma_GMST.lemma_preorder_comp_equal))
:named lemma_GMST.lemma_preorder_comp_equal))
(push) ;; push{2

; Starting query at GMST.fst(170,4-170,12)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> mst_wp state b rel
(declare-fun Tm_arrow_225a6e314a082a3aa78a44f387d5b025 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_225a6e314a082a3aa78a44f387d5b025
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(163,20-166,47); use=GMST.fst(166,24-166,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_225a6e314a082a3aa78a44f387d5b025 @x0
@x1
@x2)
...
:named GMST_interpretation_Tm_arrow_225a6e314a082a3aa78a44f387d5b025))
(declare-fun Non_total_Tm_arrow_8a76705362716aca6708a06dc4949318 (Term Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(163,20-167,25); use=GMST.fst(167,21-167,35)
(forall ((@x0 Term))
 (! 
;; def=GMST.fst(163,20-167,25); use=GMST.fst(167,21-167,35)
(forall ((@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(FStar.Preorder.preorder (GMST.state Dummy_value))))
(HasType (Non_total_Tm_arrow_8a76705362716aca6708a06dc4949318 @x1
@x2
@x3)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_8a76705362716aca6708a06dc4949318 @x1
@x2
@x3)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_8a76705362716aca6708a06dc4949318.1))

 
;;no pats
:qid non_total_function_typing_Non_total_Tm_arrow_8a76705362716aca6708a06dc4949318))

:named non_total_function_typing_Non_total_Tm_arrow_8a76705362716aca6708a06dc4949318))

(declare-fun Non_total_Tm_arrow_631c8ea407da6bc086dcf80eff3fa8c3 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(163,20-163,31); use=GMST.fst(168,24-168,35)
(forall ((@x0 Term))
 (! 
;; def=GMST.fst(163,20-163,31); use=GMST.fst(168,24-168,35)
(forall ((@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
(HasType @x4
(FStar.Preorder.preorder (GMST.state Dummy_value))))
(HasType (Non_total_Tm_arrow_631c8ea407da6bc086dcf80eff3fa8c3 @x1
@x2
@x3
@x4)
Tm_type))
...
:pattern ((HasType (Non_total_Tm_arrow_631c8ea407da6bc086dcf80eff3fa8c3 @x1
@x2
@x3
@x4)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_631c8ea407da6bc086dcf80eff3fa8c3.1))

 
;;no pats
:qid non_total_function_typing_Non_total_Tm_arrow_631c8ea407da6bc086dcf80eff3fa8c3))

:named non_total_function_typing_Non_total_Tm_arrow_631c8ea407da6bc086dcf80eff3fa8c3))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
GMST.op_At@tok))
:named @kick_partial_app_4a5880bcdcd0d1fa5bef035350e0cbdc))
(declare-fun Tm_refine_c2abe642570c05f9b1ff65e5224a615a (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(170,4-170,12)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c2abe642570c05f9b1ff65e5224a615a @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_c2abe642570c05f9b1ff65e5224a615a @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_c2abe642570c05f9b1ff65e5224a615a))

:named refinement_kinding_Tm_refine_c2abe642570c05f9b1ff65e5224a615a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(170,4-170,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c2abe642570c05f9b1ff65e5224a615a @x2
@x3))
(and (HasTypeFuel @u0
@x1
(GMST.state Dummy_value))

;; def=GMST.fst(101,70-101,79); use=GMST.fst(170,4-170,12)
(Valid 
;; def=GMST.fst(101,70-101,79); use=GMST.fst(170,4-170,12)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT GMST.op_At@tok
(GMST.state Dummy_value))
...
(Tm_refine_c2abe642570c05f9b1ff65e5224a615a @x2
@x3)))
:qid refinement_interpretation_Tm_refine_c2abe642570c05f9b1ff65e5224a615a))

:named refinement_interpretation_Tm_refine_c2abe642570c05f9b1ff65e5224a615a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c2abe642570c05f9b1ff65e5224a615a
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(170,4-170,12)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c2abe642570c05f9b1ff65e5224a615a @x0
@x1)))
(Valid (Prims.hasEq (GMST.state Dummy_value))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c2abe642570c05f9b1ff65e5224a615a @x0
@x1))))
:qid haseqTm_refine_c2abe642570c05f9b1ff65e5224a615a))

:named haseqTm_refine_c2abe642570c05f9b1ff65e5224a615a))
;;;;;;;;;;;;;;;;_: b -> s1: state{(rel @ rel) s0 s1} -> Type
(declare-fun Tm_arrow_75ade134e6af182990b00d93a998b3fd (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_75ade134e6af182990b00d93a998b3fd
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-163,31); use=GMST.fst(166,42-170,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_75ade134e6af182990b00d93a998b3fd @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_75ade134e6af182990b00d93a998b3fd @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_75ade134e6af182990b00d93a998b3fd))

:named kinding_Tm_arrow_75ade134e6af182990b00d93a998b3fd))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-163,31); use=GMST.fst(166,42-170,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_75ade134e6af182990b00d93a998b3fd @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid GMST_pre_typing_Tm_arrow_75ade134e6af182990b00d93a998b3fd))

:named GMST_pre_typing_Tm_arrow_75ade134e6af182990b00d93a998b3fd))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_75ade134e6af182990b00d93a998b3fd
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-163,31); use=GMST.fst(166,42-170,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_75ade134e6af182990b00d93a998b3fd @x1
@x2
@x3))
(and 
;; def=GMST.fst(101,65-163,31); use=GMST.fst(166,42-170,12)
...
@x4)
@x5))
:qid GMST_interpretation_Tm_arrow_75ade134e6af182990b00d93a998b3fd.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid GMST_interpretation_Tm_arrow_75ade134e6af182990b00d93a998b3fd.2))
))
...
@x2
@x3)))
:qid GMST_interpretation_Tm_arrow_75ade134e6af182990b00d93a998b3fd))

:named GMST_interpretation_Tm_arrow_75ade134e6af182990b00d93a998b3fd))
(declare-fun Tm_refine_2dbcc642e30c94354080ed8b90217c10 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
...
;   (b: Type)
;   (rel: FStar.Preorder.preorder GMST.state)
;   (wp1: GMST.mst_wp GMST.state a rel)
;   (wp2: (_: a -> GMST.mst_wp GMST.state b rel))
;   (f: (_: Prims.unit -> GMST.GMST a))
;   (g: (x: a -> GMST.GMST b))
;   (s0: GMST.state)
;   (p: (_: b -> s1: GMST.state{(rel @ rel) s0 s1} -> Type0)).
;   (*  - Could not prove post-condition
; *)
;   forall (x: a) (s1: GMST.state{rel s0 s1}).
;     (*  - Could not prove post-condition
; *)
;     forall (_: b) (s1: GMST.state). rel s1 s1 ==> (rel @ rel) s0 s1


; Context: While encoding a query
; While typechecking the top-level declaration `let preorder_app'`
...
@x0))
(HasType @x5
(Non_total_Tm_arrow_8a76705362716aca6708a06dc4949318 @x0
@x3
@x2))
(HasType @x6
(Non_total_Tm_arrow_631c8ea407da6bc086dcf80eff3fa8c3 @x0
@x1
@x4
@x2))
(HasType @x7
(GMST.state Dummy_value))
(HasType @x8
(Tm_arrow_75ade134e6af182990b00d93a998b3fd @x7
@x2
@x1)))

;; def=dummy(0,0-0,0); use=GMST.fst(170,4-170,12)
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(169,67-169,68)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GMST.preorder_app', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_GMST.op_At, equation_GMST.state, equation_Prims.eqtype, int_inversion, interpretation_Tm_abs_52fe06aa3756057d09f0d03f1113e61e, l_quant_interp_0d4740bac0e7318c12dd62f1c939a21c, lemma_GMST.lemma_preorder_comp_equal, refinement_interpretation_Tm_refine_2dbcc642e30c94354080ed8b90217c10, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, token_correspondence_GMST.op_At, typing_Prims.int
...
; encoding sigelt let preorder_app'


; <Start encoding let preorder_app'>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GMST.preorder_app_ (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GMST.preorder_app_@tok () Term)

; </end encoding let preorder_app'>

(push) ;; push{2

; Starting query at GMST.fst(178,4-178,8)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_bdc975851b597885266e1bf07a144b19 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(175,56-175,92); use=GMST.fst(175,56-175,92)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_bdc975851b597885266e1bf07a144b19 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_bdc975851b597885266e1bf07a144b19 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_bdc975851b597885266e1bf07a144b19))

:named refinement_kinding_Tm_refine_bdc975851b597885266e1bf07a144b19))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(175,56-175,92); use=GMST.fst(175,56-175,92)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_bdc975851b597885266e1bf07a144b19 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Preorder.relation (GMST.state Dummy_value)))

;; def=GMST.fst(175,78-175,90); use=GMST.fst(175,78-175,90)
(= @x2
@x1)
))
...
@x1
(Tm_refine_bdc975851b597885266e1bf07a144b19 @x2)))
:qid refinement_interpretation_Tm_refine_bdc975851b597885266e1bf07a144b19))

:named refinement_interpretation_Tm_refine_bdc975851b597885266e1bf07a144b19))
;;;;;;;;;;;;;;;;haseq for Tm_refine_bdc975851b597885266e1bf07a144b19
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(175,56-175,92); use=GMST.fst(175,56-175,92)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_bdc975851b597885266e1bf07a144b19 @x0)))
(Valid (Prims.hasEq (FStar.Preorder.relation (GMST.state Dummy_value)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_bdc975851b597885266e1bf07a144b19 @x0))))
:qid haseqTm_refine_bdc975851b597885266e1bf07a144b19))

:named haseqTm_refine_bdc975851b597885266e1bf07a144b19))
(declare-fun Non_total_Tm_arrow_b1695a7c1b177941b463ea254c44985b (Term Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(175,25-177,30); use=GMST.fst(177,26-177,40)
(forall ((@x0 Term))
 (! 
;; def=GMST.fst(175,25-177,30); use=GMST.fst(177,26-177,40)
(forall ((@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(FStar.Preorder.relation (GMST.state Dummy_value))))
(HasType (Non_total_Tm_arrow_b1695a7c1b177941b463ea254c44985b @x1
@x2
@x3)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_b1695a7c1b177941b463ea254c44985b @x1
@x2
@x3)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_b1695a7c1b177941b463ea254c44985b.1))

 
;;no pats
:qid non_total_function_typing_Non_total_Tm_arrow_b1695a7c1b177941b463ea254c44985b))

:named non_total_function_typing_Non_total_Tm_arrow_b1695a7c1b177941b463ea254c44985b))

; Encoding query formula : forall (a: Type)
;   (rel1: FStar.Preorder.relation GMST.state)
;   (rel2: FStar.Preorder.relation GMST.state {rel1 == rel2})
;   (wp: GMST.mst_wp GMST.state a rel1)
;   (f: (_: Prims.unit -> GMST.GMST a)).
;   (forall (s0: GMST.state) (_: a) (s1: GMST.state). rel1 s0 s1 ==> rel2 s0 s1) /\
;   (forall (s0: GMST.state) (p: GMST.gmst_post GMST.state a s0). wp s0 (p rel2) ==> wp s0 (p rel1))


; Context: While encoding a query
; While typechecking the top-level declaration `let transport_gmst_rel`
...
(FStar.Preorder.relation (GMST.state Dummy_value)))
(HasType @x2
(Tm_refine_bdc975851b597885266e1bf07a144b19 @x1))
(HasType @x3
(GMST.mst_wp (GMST.state Dummy_value)
@x0
@x1))
(HasType @x4
(Non_total_Tm_arrow_b1695a7c1b177941b463ea254c44985b @x0
@x3
@x1)))

;; def=GMST.fst(56,2-176,27); use=GMST.fst(75,22-177,75)
(and 
;; def=dummy(0,0-0,0); use=GMST.fst(178,4-178,8)
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(178,4-178,8)
(Valid 
;; def=GMST.fst(101,70-101,79); use=GMST.fst(178,4-178,8)
(ApplyTT (ApplyTT @x1
@x5)
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(177,73-177,75)
(or label_1
...
;; def=GMST.fst(56,2-56,36); use=GMST.fst(75,22-75,35)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
(GMST.state Dummy_value))
(HasType @x6
(GMST.gmst_post (GMST.state Dummy_value)
@x0
@x5))

;; def=GMST.fst(105,19-105,35); use=GMST.fst(177,71-177,72)
(Valid 
;; def=GMST.fst(105,19-105,35); use=GMST.fst(177,71-177,72)
(ApplyTT (ApplyTT @x3
@x5)
...
;; def=GMST.fst(105,19-105,35); use=GMST.fst(178,4-178,8)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GMST.transport_gmst_rel, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_bdc975851b597885266e1bf07a144b19
...
; encoding sigelt let transport_gmst_rel


; <Start encoding let transport_gmst_rel>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GMST.transport_gmst_rel (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GMST.transport_gmst_rel@tok () Term)

; </end encoding let transport_gmst_rel>

;;;;;;;;;;;;;;;;typing_Tm_abs_9b728148fdfbb433bf963274e0ec60de
;;; Fact-ids: Name GMST.lift_div_gmst; Namespace GMST
(assert (! 
;; def=GMST.fst(95,93-95,123); use=GMST.fst(95,93-95,123)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_9b728148fdfbb433bf963274e0ec60de @x0
@x1
@x2)
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x2))
 

:pattern ((Tm_abs_9b728148fdfbb433bf963274e0ec60de @x0
@x1
@x2))
:qid typing_Tm_abs_9b728148fdfbb433bf963274e0ec60de))

:named typing_Tm_abs_9b728148fdfbb433bf963274e0ec60de))
;;;;;;;;;;;;;;;;typing_Tm_abs_82ec778de9d1387a32415d51903dbca7
;;; Fact-ids: Name GMST.lift_div_gmst; Namespace GMST
(assert (! (HasType Tm_abs_82ec778de9d1387a32415d51903dbca7
Tm_arrow_9185270b76eefe318bba365668d1bb6f)
:named typing_Tm_abs_82ec778de9d1387a32415d51903dbca7))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name GMST.lift_div_gmst; Namespace GMST
(assert (! 
;; def=GMST.fst(95,4-95,17); use=GMST.fst(95,4-95,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((GMST.lift_div_gmst @x0
@x1
@x2
@x3))
:qid typing_GMST.lift_div_gmst))

:named typing_GMST.lift_div_gmst))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9185270b76eefe318bba365668d1bb6f
;;; Fact-ids: Name GMST.lift_div_gmst; Namespace GMST
(assert (! (HasType Tm_arrow_9185270b76eefe318bba365668d1bb6f
Tm_type)
:named kinding_Tm_arrow_9185270b76eefe318bba365668d1bb6f))
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_9b728148fdfbb433bf963274e0ec60de
;;; Fact-ids: Name GMST.lift_div_gmst; Namespace GMST
(assert (! 
;; def=GMST.fst(95,93-95,123); use=GMST.fst(95,93-95,123)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_9b728148fdfbb433bf963274e0ec60de @x1
@x2
@x3)
@x0)
(ApplyTT (ApplyTT (ApplyTT @x1
Tm_abs_82ec778de9d1387a32415d51903dbca7)
@x0)
@x2))
 

:pattern ((ApplyTT (Tm_abs_9b728148fdfbb433bf963274e0ec60de @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_9b728148fdfbb433bf963274e0ec60de))

:named interpretation_Tm_abs_9b728148fdfbb433bf963274e0ec60de))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_82ec778de9d1387a32415d51903dbca7
;;; Fact-ids: Name GMST.lift_div_gmst; Namespace GMST
(assert (! 
;; def=GMST.fst(95,109-95,117); use=GMST.fst(95,109-95,117)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_82ec778de9d1387a32415d51903dbca7
@x0)
@x1)
(Prims.eq2 (GMST.state Dummy_value)
@x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Tm_abs_82ec778de9d1387a32415d51903dbca7
@x0)
@x1))
:qid interpretation_Tm_abs_82ec778de9d1387a32415d51903dbca7))

:named interpretation_Tm_abs_82ec778de9d1387a32415d51903dbca7))
...
;;;;;;;;;;;;;;;;Equation for GMST.lift_div_gmst
;;; Fact-ids: Name GMST.lift_div_gmst; Namespace GMST
(assert (! 
;; def=GMST.fst(95,4-95,17); use=GMST.fst(95,4-95,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (GMST.lift_div_gmst @x0
@x1
@x2
@x3)
(ApplyTT @x1
(Tm_abs_9b728148fdfbb433bf963274e0ec60de @x3
@x2
@x0)))
...
@x2
@x3))
:qid equation_GMST.lift_div_gmst))

:named equation_GMST.lift_div_gmst))
;;;;;;;;;;;;;;;;Eq2 interpretation
;;; Fact-ids: Name Prims.eq2; Namespace Prims
...
;;; Fact-ids: Name GMST.lift_div_gmst; Namespace GMST
(assert (! 
;; def=GMST.fst(95,66-95,71); use=GMST.fst(95,93-95,94)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9185270b76eefe318bba365668d1bb6f)
...
@x1
Tm_arrow_9185270b76eefe318bba365668d1bb6f))
:qid GMST_pre_typing_Tm_arrow_9185270b76eefe318bba365668d1bb6f))

:named GMST_pre_typing_Tm_arrow_9185270b76eefe318bba365668d1bb6f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9185270b76eefe318bba365668d1bb6f
;;; Fact-ids: Name GMST.lift_div_gmst; Namespace GMST
(assert (! 
;; def=GMST.fst(95,66-95,71); use=GMST.fst(95,93-95,94)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid GMST_interpretation_Tm_arrow_9185270b76eefe318bba365668d1bb6f.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid GMST_interpretation_Tm_arrow_9185270b76eefe318bba365668d1bb6f.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_9185270b76eefe318bba365668d1bb6f))
:qid GMST_interpretation_Tm_arrow_9185270b76eefe318bba365668d1bb6f))

:named GMST_interpretation_Tm_arrow_9185270b76eefe318bba365668d1bb6f))
(push) ;; push{2

; Starting query at GMST.fst(187,4-191,72)
...
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(180,19-183,46); use=GMST.fst(183,23-183,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_225a6e314a082a3aa78a44f387d5b025 @x0
@x1
@x2)
...
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(180,19-184,24); use=GMST.fst(184,20-184,34)
(forall ((@x0 Term))
 (! 
;; def=GMST.fst(180,19-184,24); use=GMST.fst(184,20-184,34)
(forall ((@x1 Term) (@x2 Term) (@x3 Term))
...
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(180,19-180,30); use=GMST.fst(185,23-185,34)
(forall ((@x0 Term))
 (! 
;; def=GMST.fst(180,19-180,30); use=GMST.fst(185,23-185,34)
(forall ((@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c2abe642570c05f9b1ff65e5224a615a @x0
@x1)
Tm_type)
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(187,4-191,72)
(Valid 
;; def=GMST.fst(101,70-101,79); use=GMST.fst(187,4-191,72)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT GMST.op_At@tok
(GMST.state Dummy_value))
...
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-180,30); use=GMST.fst(183,41-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_75ade134e6af182990b00d93a998b3fd @x0
@x1
@x2)
...
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(187,4-187,29); use=GMST.fst(187,4-187,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
:qid GMST_pre_typing_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))

:named GMST_pre_typing_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
...
:pattern ((ApplyTT @x0
@x1))
:qid GMST_interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
:qid GMST_interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))

:named GMST_interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
(declare-fun Tm_abs_284489d352eb71a90324e065019a50a1 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_284489d352eb71a90324e065019a50a1
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,36-441,97); use=GMST.fst(187,4-187,10)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_284489d352eb71a90324e065019a50a1 @x0
@x1)
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe)
 

:pattern ((Tm_abs_284489d352eb71a90324e065019a50a1 @x0
@x1))
:qid typing_Tm_abs_284489d352eb71a90324e065019a50a1))

:named typing_Tm_abs_284489d352eb71a90324e065019a50a1))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_284489d352eb71a90324e065019a50a1
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,36-441,97); use=GMST.fst(187,4-187,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_284489d352eb71a90324e065019a50a1 @x1
@x2)
@x0)
(Prims.l_imp (Prims.eq2 (FStar.Preorder.relation (GMST.state Dummy_value))
(GMST.op_At (GMST.state Dummy_value)
@x1
@x1)
@x1)
(ApplyTT @x2
...
:pattern ((ApplyTT (Tm_abs_284489d352eb71a90324e065019a50a1 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_284489d352eb71a90324e065019a50a1))

:named interpretation_Tm_abs_284489d352eb71a90324e065019a50a1))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,36-441,97); use=GMST.fst(187,4-187,10)
...
(Tm_abs_284489d352eb71a90324e065019a50a1 @x1
@x0)))
...
;; def=GMST.fst(187,11-187,29); use=GMST.fst(187,4-187,10)
(= (GMST.op_At (GMST.state Dummy_value)
@x1
@x1)
@x1)
...
;; def=Prims.fst(441,83-441,96); use=GMST.fst(187,4-187,10)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GMST.fst(187,4-187,10)
(ApplyTT @x0
@x2)
...
;;no pats
:qid l_quant_interp_8e7f59dbbf720f12c514120d6e5684ae.1))
)
...
(Tm_abs_284489d352eb71a90324e065019a50a1 @x1
@x0))))
:qid l_quant_interp_8e7f59dbbf720f12c514120d6e5684ae))

:named l_quant_interp_8e7f59dbbf720f12c514120d6e5684ae))
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(188,39-441,24); use=GMST.fst(187,4-187,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))
:qid GMST_pre_typing_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))

:named GMST_pre_typing_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))
...
:pattern ((ApplyTT @x0
@x1))
:qid GMST_interpretation_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))
:qid GMST_interpretation_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))

:named GMST_interpretation_Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21))
(declare-fun Tm_abs_4d7637bca3e5b88941eab785af8392f4 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_4d7637bca3e5b88941eab785af8392f4
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,29-441,97); use=GMST.fst(187,4-187,10)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_4d7637bca3e5b88941eab785af8392f4 @x0)
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21)
 

:pattern ((Tm_abs_4d7637bca3e5b88941eab785af8392f4 @x0))
:qid typing_Tm_abs_4d7637bca3e5b88941eab785af8392f4))

:named typing_Tm_abs_4d7637bca3e5b88941eab785af8392f4))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_4d7637bca3e5b88941eab785af8392f4
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(441,29-441,97); use=GMST.fst(187,4-187,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_4d7637bca3e5b88941eab785af8392f4 @x1)
@x0)
(Prims.l_and (Prims.eq2 (FStar.Preorder.relation (GMST.state Dummy_value))
(GMST.op_At (GMST.state Dummy_value)
@x1
@x1)
@x1)
...
:pattern ((ApplyTT (Tm_abs_4d7637bca3e5b88941eab785af8392f4 @x1)
@x0))
:qid interpretation_Tm_abs_4d7637bca3e5b88941eab785af8392f4))

:named interpretation_Tm_abs_4d7637bca3e5b88941eab785af8392f4))


(declare-fun Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9
;;; Fact-ids: 
(assert (! (HasType Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21)
:named typing_Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(445,57-445,61); use=GMST.fst(188,4-188,9)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9
@x0)
Prims.l_True)
 

:pattern ((ApplyTT Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9
@x0))
:qid interpretation_Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9))

:named interpretation_Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9))

(declare-fun Tm_refine_5a77ba0e570a764db7aadc9a874aeff0 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(175,56-175,92); use=GMST.fst(189,4-189,22)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_5a77ba0e570a764db7aadc9a874aeff0 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_5a77ba0e570a764db7aadc9a874aeff0 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_5a77ba0e570a764db7aadc9a874aeff0))

:named refinement_kinding_Tm_refine_5a77ba0e570a764db7aadc9a874aeff0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(175,56-175,92); use=GMST.fst(189,4-189,22)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5a77ba0e570a764db7aadc9a874aeff0 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Preorder.relation (GMST.state Dummy_value)))

;; def=GMST.fst(175,78-175,90); use=GMST.fst(189,4-189,22)
(= (GMST.op_At (GMST.state Dummy_value)
@x2
@x2)
@x1)
...
@x1
(Tm_refine_5a77ba0e570a764db7aadc9a874aeff0 @x2)))
:qid refinement_interpretation_Tm_refine_5a77ba0e570a764db7aadc9a874aeff0))

:named refinement_interpretation_Tm_refine_5a77ba0e570a764db7aadc9a874aeff0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5a77ba0e570a764db7aadc9a874aeff0
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(175,56-175,92); use=GMST.fst(189,4-189,22)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5a77ba0e570a764db7aadc9a874aeff0 @x0)))
(Valid (Prims.hasEq (FStar.Preorder.relation (GMST.state Dummy_value)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5a77ba0e570a764db7aadc9a874aeff0 @x0))))
:qid haseqTm_refine_5a77ba0e570a764db7aadc9a874aeff0))

:named haseqTm_refine_5a77ba0e570a764db7aadc9a874aeff0))
;;;;;;;;;;;;;;;;any_result: FStar.Preorder.preorder state -> Prims.GTot Type0
(declare-fun Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85
Tm_type)
:named kinding_Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(181,23-181,37); use=GMST.fst(187,4-191,72)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85))
:qid GMST_pre_typing_Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85))

:named GMST_pre_typing_Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(181,23-181,37); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid GMST_interpretation_Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85))
:qid GMST_interpretation_Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85))

:named GMST_interpretation_Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85))
(declare-fun Tm_abs_05b06840b0916351df2c23ec59d76d24 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_05b06840b0916351df2c23ec59d76d24
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(451,66-451,102); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_05b06840b0916351df2c23ec59d76d24 @x0)
Tm_arrow_5d8ecebacf4d5af3e5a5cecc9bf7ab85)
 

:pattern ((Tm_abs_05b06840b0916351df2c23ec59d76d24 @x0))
:qid typing_Tm_abs_05b06840b0916351df2c23ec59d76d24))

:named typing_Tm_abs_05b06840b0916351df2c23ec59d76d24))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_05b06840b0916351df2c23ec59d76d24
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(451,66-451,102); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_05b06840b0916351df2c23ec59d76d24 @x1)
@x0)
(ApplyTT @x1
@x0))
 

:pattern ((ApplyTT (Tm_abs_05b06840b0916351df2c23ec59d76d24 @x1)
@x0))
:qid interpretation_Tm_abs_05b06840b0916351df2c23ec59d76d24))

:named interpretation_Tm_abs_05b06840b0916351df2c23ec59d76d24))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(451,66-451,102); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.l_Forall (FStar.Preorder.preorder (GMST.state Dummy_value))
(Tm_abs_05b06840b0916351df2c23ec59d76d24 @x0)))
...
;; def=Prims.fst(451,90-451,102); use=GMST.fst(187,4-191,72)
(Valid 
;; def=Prims.fst(451,90-451,102); use=GMST.fst(187,4-191,72)
(ApplyTT @x0
@x1)
...
;;no pats
:qid l_quant_interp_23105a0e2fe5a6ce1ce4c3ad6d3c1483.1))
)
 

:pattern ((Valid (Prims.l_Forall (FStar.Preorder.preorder (GMST.state Dummy_value))
(Tm_abs_05b06840b0916351df2c23ec59d76d24 @x0))))
:qid l_quant_interp_23105a0e2fe5a6ce1ce4c3ad6d3c1483))

:named l_quant_interp_23105a0e2fe5a6ce1ce4c3ad6d3c1483))
;;;;;;;;;;;;;;;;p: Prims.pure_post (FStar.Preorder.preorder state) -> Prims.pure_pre
(declare-fun Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f
Tm_type)
:named kinding_Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(325,45-368,26); use=GMST.fst(187,4-191,72)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f))
:qid GMST_pre_typing_Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f))

:named GMST_pre_typing_Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(325,45-368,26); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term))
...
(forall ((@x1 Term))
 (! (implies (HasType @x1
(Prims.pure_post (FStar.Preorder.preorder (GMST.state Dummy_value))))
(HasType (ApplyTT @x0
@x1)
Prims.pure_pre))
...
:pattern ((ApplyTT @x0
@x1))
:qid GMST_interpretation_Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f))
:qid GMST_interpretation_Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f))

:named GMST_interpretation_Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f))
(declare-fun Tm_abs_dd2518e956859acbf61225bc8b8aaf91 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_dd2518e956859acbf61225bc8b8aaf91
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,7-369,58); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_dd2518e956859acbf61225bc8b8aaf91 @x0)
Tm_arrow_cda7643f3dcc4dd3bbae7879b93d266f)
 

:pattern ((Tm_abs_dd2518e956859acbf61225bc8b8aaf91 @x0))
:qid typing_Tm_abs_dd2518e956859acbf61225bc8b8aaf91))

:named typing_Tm_abs_dd2518e956859acbf61225bc8b8aaf91))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_dd2518e956859acbf61225bc8b8aaf91
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,7-369,58); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_dd2518e956859acbf61225bc8b8aaf91 @x1)
@x0)
(Prims.l_and (Prims.l_imp (FStar.Preorder.preorder_rel (GMST.state Dummy_value)
@x1)
(Prims.eq2 (FStar.Preorder.relation (GMST.state Dummy_value))
(GMST.op_At (GMST.state Dummy_value)
@x1
@x1)
@x1))
(Prims.l_Forall (FStar.Preorder.preorder (GMST.state Dummy_value))
(Tm_abs_05b06840b0916351df2c23ec59d76d24 @x0))))
 

:pattern ((ApplyTT (Tm_abs_dd2518e956859acbf61225bc8b8aaf91 @x1)
@x0))
:qid interpretation_Tm_abs_dd2518e956859acbf61225bc8b8aaf91))

:named interpretation_Tm_abs_dd2518e956859acbf61225bc8b8aaf91))




(declare-fun Tm_abs_bef10cf5e903f36ef5f275ad6b42e214 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_bef10cf5e903f36ef5f275ad6b42e214
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(464,77-464,90); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_bef10cf5e903f36ef5f275ad6b42e214 @x0
@x1)
Tm_arrow_6d40a3ff25433fc91a0f28572e37ed21)
 

:pattern ((Tm_abs_bef10cf5e903f36ef5f275ad6b42e214 @x0
@x1))
:qid typing_Tm_abs_bef10cf5e903f36ef5f275ad6b42e214))

:named typing_Tm_abs_bef10cf5e903f36ef5f275ad6b42e214))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_bef10cf5e903f36ef5f275ad6b42e214
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(464,77-464,90); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_bef10cf5e903f36ef5f275ad6b42e214 @x1
@x2)
@x0)
(Prims.l_imp (Prims.eq2 (Tm_refine_5a77ba0e570a764db7aadc9a874aeff0 @x1)
@x1
@x2)
(ApplyTT @x0
Tm_unit)))
...
:pattern ((ApplyTT (Tm_abs_bef10cf5e903f36ef5f275ad6b42e214 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_bef10cf5e903f36ef5f275ad6b42e214))

:named interpretation_Tm_abs_bef10cf5e903f36ef5f275ad6b42e214))
...
;;;;;;;;;;;;;;;;s1: state -> Type0
(declare-fun Tm_arrow_3457286d89e5d0eabd956a2597fa2481 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3457286d89e5d0eabd956a2597fa2481
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3457286d89e5d0eabd956a2597fa2481
Tm_type)
:named kinding_Tm_arrow_3457286d89e5d0eabd956a2597fa2481))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(183,35-183,40); use=GMST.fst(190,66-190,67)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3457286d89e5d0eabd956a2597fa2481)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_3457286d89e5d0eabd956a2597fa2481))
:qid GMST_pre_typing_Tm_arrow_3457286d89e5d0eabd956a2597fa2481))

:named GMST_pre_typing_Tm_arrow_3457286d89e5d0eabd956a2597fa2481))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3457286d89e5d0eabd956a2597fa2481
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(183,35-183,40); use=GMST.fst(190,66-190,67)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid GMST_interpretation_Tm_arrow_3457286d89e5d0eabd956a2597fa2481.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_3457286d89e5d0eabd956a2597fa2481))
:qid GMST_interpretation_Tm_arrow_3457286d89e5d0eabd956a2597fa2481))

:named GMST_interpretation_Tm_arrow_3457286d89e5d0eabd956a2597fa2481))
(declare-fun Tm_abs_2a3b737217d828b395f2412d0768dde5 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_2a3b737217d828b395f2412d0768dde5
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,70-101,79); use=GMST.fst(190,66-190,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_2a3b737217d828b395f2412d0768dde5 @x0
@x1
@x2)
Tm_arrow_3457286d89e5d0eabd956a2597fa2481)
 

:pattern ((Tm_abs_2a3b737217d828b395f2412d0768dde5 @x0
@x1
@x2))
:qid typing_Tm_abs_2a3b737217d828b395f2412d0768dde5))

:named typing_Tm_abs_2a3b737217d828b395f2412d0768dde5))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2a3b737217d828b395f2412d0768dde5
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,70-101,79); use=GMST.fst(190,66-190,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_2a3b737217d828b395f2412d0768dde5 @x1
@x2
@x3)
@x0)
(Prims.l_imp (ApplyTT (ApplyTT @x1
@x2)
@x0)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT GMST.op_At@tok
(GMST.state Dummy_value))
...
:pattern ((ApplyTT (Tm_abs_2a3b737217d828b395f2412d0768dde5 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_2a3b737217d828b395f2412d0768dde5))

:named interpretation_Tm_abs_2a3b737217d828b395f2412d0768dde5))

(declare-fun Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=GMST.fst(190,66-190,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d @x0
@x1
@x2
@x3)
...
:pattern ((Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d @x0
@x1
@x2
@x3))
:qid typing_Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d))

:named typing_Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=GMST.fst(190,66-190,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d @x1
@x2
@x3
@x4)
@x0)
(Prims.l_Forall (GMST.state Dummy_value)
(Tm_abs_2a3b737217d828b395f2412d0768dde5 @x1
@x2
@x3)))
 

:pattern ((ApplyTT (Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d @x1
@x2
@x3
@x4)
@x0))
:qid interpretation_Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d))

:named interpretation_Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d))

;;;;;;;;;;;;;;;;s1: state{rel s0 s1} -> Type0
(declare-fun Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(190,37-190,68)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d))

:named kinding_Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(190,37-190,68)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d @x2
@x3)))
:qid GMST_pre_typing_Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d))

:named GMST_pre_typing_Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(190,37-190,68)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d @x1
@x2))
(and 
;; def=GMST.fst(101,65-101,80); use=GMST.fst(190,37-190,68)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid GMST_interpretation_Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d.1))
...
(Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d @x1
@x2)))
:qid GMST_interpretation_Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d))

:named GMST_interpretation_Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d))
(declare-fun Tm_abs_0719e0623d8cd7523fe94616894c4288 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_0719e0623d8cd7523fe94616894c4288
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(190,32-190,33); use=GMST.fst(190,66-190,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_0719e0623d8cd7523fe94616894c4288 @x0
@x1
@x2)
(Tm_arrow_c5a83e63e08a7598e668be3bf4d6ef4d @x1
@x2))
...
:pattern ((Tm_abs_0719e0623d8cd7523fe94616894c4288 @x0
@x1
@x2))
:qid typing_Tm_abs_0719e0623d8cd7523fe94616894c4288))

:named typing_Tm_abs_0719e0623d8cd7523fe94616894c4288))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_0719e0623d8cd7523fe94616894c4288
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(190,32-190,33); use=GMST.fst(190,66-190,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_0719e0623d8cd7523fe94616894c4288 @x1
@x2
@x3)
@x0)
(Prims.l_Forall @x1
(Tm_abs_ffd316ae35f2a03b0258c3f5b2c9225d @x3
@x0
@x2
@x1)))
 

:pattern ((ApplyTT (Tm_abs_0719e0623d8cd7523fe94616894c4288 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_0719e0623d8cd7523fe94616894c4288))

:named interpretation_Tm_abs_0719e0623d8cd7523fe94616894c4288))

(declare-fun Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=GMST.fst(190,37-190,68)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e @x0
@x1
@x2
@x3)
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x3))
...
:pattern ((Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e @x0
@x1
@x2
@x3))
:qid typing_Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e))

:named typing_Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=GMST.fst(190,37-190,68)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e @x1
@x2
@x3
@x4)
@x0)
(Prims.l_Forall (Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x1
@x2)
(Tm_abs_0719e0623d8cd7523fe94616894c4288 @x3
@x2
@x1)))
 

:pattern ((ApplyTT (Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e @x1
@x2
@x3
@x4)
@x0))
:qid interpretation_Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e))

:named interpretation_Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e))



;;;;;;;;;;;;;;;;p: (_: b -> s1: state{(rel @ rel) s0 s1} -> Type0) -> Type0
(declare-fun Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-180,30); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7))

:named kinding_Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-180,30); use=GMST.fst(187,4-191,72)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid GMST_pre_typing_Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7))

:named GMST_pre_typing_Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-180,30); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7 @x1
@x2
@x3))
(and 
;; def=GMST.fst(101,65-180,30); use=GMST.fst(187,4-191,72)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Tm_arrow_75ade134e6af182990b00d93a998b3fd @x3
@x2
@x1))
(HasType (ApplyTT @x0
@x4)
...
:pattern ((ApplyTT @x0
@x4))
:qid GMST_interpretation_Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7.1))
...
@x2
@x3)))
:qid GMST_interpretation_Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7))

:named GMST_interpretation_Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7))
(declare-fun Tm_abs_5c439563fd52e2ae7b27ef541a308ccb (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_5c439563fd52e2ae7b27ef541a308ccb
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=GMST.fst(190,37-190,68)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_5c439563fd52e2ae7b27ef541a308ccb @x0
@x1
@x2
@x3)
(Tm_arrow_5f014eb2345e57a90b5d8cc91fd7bbe7 @x1
...
:pattern ((Tm_abs_5c439563fd52e2ae7b27ef541a308ccb @x0
@x1
@x2
@x3))
:qid typing_Tm_abs_5c439563fd52e2ae7b27ef541a308ccb))

:named typing_Tm_abs_5c439563fd52e2ae7b27ef541a308ccb))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_5c439563fd52e2ae7b27ef541a308ccb
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=GMST.fst(190,37-190,68)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (Tm_abs_5c439563fd52e2ae7b27ef541a308ccb @x1
@x2
@x3
@x4)
@x0)
(Prims.l_Forall @x1
(Tm_abs_d3a2d5065bf3a7ba341184297bf5eb6e @x3
@x4
@x2
@x1)))
 

:pattern ((ApplyTT (Tm_abs_5c439563fd52e2ae7b27ef541a308ccb @x1
@x2
@x3
@x4)
@x0))
:qid interpretation_Tm_abs_5c439563fd52e2ae7b27ef541a308ccb))

:named interpretation_Tm_abs_5c439563fd52e2ae7b27ef541a308ccb))

(declare-fun Tm_abs_af07208e0ecb7112dee96f139621688f (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_af07208e0ecb7112dee96f139621688f
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_af07208e0ecb7112dee96f139621688f @x0
@x1
@x2)
Tm_arrow_3457286d89e5d0eabd956a2597fa2481)
 

:pattern ((Tm_abs_af07208e0ecb7112dee96f139621688f @x0
@x1
@x2))
:qid typing_Tm_abs_af07208e0ecb7112dee96f139621688f))

:named typing_Tm_abs_af07208e0ecb7112dee96f139621688f))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_af07208e0ecb7112dee96f139621688f
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_af07208e0ecb7112dee96f139621688f @x1
@x2
@x3)
@x0)
(Prims.l_Forall (Tm_arrow_75ade134e6af182990b00d93a998b3fd @x0
@x1
@x2)
(Tm_abs_5c439563fd52e2ae7b27ef541a308ccb @x3
@x2
@x1
@x0)))
 

:pattern ((ApplyTT (Tm_abs_af07208e0ecb7112dee96f139621688f @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_af07208e0ecb7112dee96f139621688f))

:named interpretation_Tm_abs_af07208e0ecb7112dee96f139621688f))
...
;; def=dummy(0,0-0,0); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.l_Forall (GMST.state Dummy_value)
(Tm_abs_af07208e0ecb7112dee96f139621688f @x2
@x1
@x0)))
...
;;no pats
:qid l_quant_interp_4a21f32ec6a1a51ee886937578dfc62e.3))


)
 
;;no pats
:qid l_quant_interp_4a21f32ec6a1a51ee886937578dfc62e.2))

)
 
;;no pats
:qid l_quant_interp_4a21f32ec6a1a51ee886937578dfc62e.1))
)
 

:pattern ((Valid (Prims.l_Forall (GMST.state Dummy_value)
(Tm_abs_af07208e0ecb7112dee96f139621688f @x2
@x1
@x0))))
:qid l_quant_interp_4a21f32ec6a1a51ee886937578dfc62e))

:named l_quant_interp_4a21f32ec6a1a51ee886937578dfc62e))
;;;;;;;;;;;;;;;;any_result: mst_wp state b (rel @ rel) -> Prims.GTot Type0
(declare-fun Tm_arrow_c31fb6db20045d44252fb060b665f499 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c31fb6db20045d44252fb060b665f499
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(176,28-176,47); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_c31fb6db20045d44252fb060b665f499 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_c31fb6db20045d44252fb060b665f499 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_c31fb6db20045d44252fb060b665f499))

:named kinding_Tm_arrow_c31fb6db20045d44252fb060b665f499))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(176,28-176,47); use=GMST.fst(187,4-191,72)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_c31fb6db20045d44252fb060b665f499 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_c31fb6db20045d44252fb060b665f499 @x2
@x3)))
:qid GMST_pre_typing_Tm_arrow_c31fb6db20045d44252fb060b665f499))

:named GMST_pre_typing_Tm_arrow_c31fb6db20045d44252fb060b665f499))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c31fb6db20045d44252fb060b665f499
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(176,28-176,47); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_c31fb6db20045d44252fb060b665f499 @x1
@x2))
(and 
;; def=GMST.fst(176,28-176,47); use=GMST.fst(187,4-191,72)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid GMST_interpretation_Tm_arrow_c31fb6db20045d44252fb060b665f499.1))
...
(Tm_arrow_c31fb6db20045d44252fb060b665f499 @x1
@x2)))
:qid GMST_interpretation_Tm_arrow_c31fb6db20045d44252fb060b665f499))

:named GMST_interpretation_Tm_arrow_c31fb6db20045d44252fb060b665f499))
(declare-fun Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(451,66-451,102); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89 @x0
@x1
@x2)
(Tm_arrow_c31fb6db20045d44252fb060b665f499 @x1
@x2))
...
:pattern ((Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89 @x0
@x1
@x2))
:qid typing_Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89))

:named typing_Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(451,66-451,102); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89 @x1
@x2
@x3)
@x0)
(ApplyTT @x1
...
:pattern ((ApplyTT (Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89))

:named interpretation_Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(451,66-451,102); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.l_Forall (GMST.mst_wp (GMST.state Dummy_value)
@x2
(GMST.op_At (GMST.state Dummy_value)
@x1
@x1))
(Tm_abs_a84a4d0ce1e5cb7daf5a4947c45cbd89 @x0
@x1
@x2)))
...
;;no pats
:qid l_quant_interp_c7ca8689f212d1e98018aba7bd38bf47.1))
)
 

:pattern ((Valid (Prims.l_Forall (GMST.mst_wp (GMST.state Dummy_value)
@x2
(GMST.op_At (GMST.state Dummy_value)
@x1
@x1))
...
@x1
@x2))))
:qid l_quant_interp_c7ca8689f212d1e98018aba7bd38bf47))

:named l_quant_interp_c7ca8689f212d1e98018aba7bd38bf47))
;;;;;;;;;;;;;;;;p: Prims.pure_post (mst_wp state b (rel @ rel)) -> Prims.pure_pre
(declare-fun Tm_arrow_13db5a28ac709eeec52a785737a492a6 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_13db5a28ac709eeec52a785737a492a6
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(325,45-368,26); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_13db5a28ac709eeec52a785737a492a6 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_13db5a28ac709eeec52a785737a492a6 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_13db5a28ac709eeec52a785737a492a6))

:named kinding_Tm_arrow_13db5a28ac709eeec52a785737a492a6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(325,45-368,26); use=GMST.fst(187,4-191,72)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_13db5a28ac709eeec52a785737a492a6 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_13db5a28ac709eeec52a785737a492a6 @x2
@x3)))
:qid GMST_pre_typing_Tm_arrow_13db5a28ac709eeec52a785737a492a6))

:named GMST_pre_typing_Tm_arrow_13db5a28ac709eeec52a785737a492a6))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_13db5a28ac709eeec52a785737a492a6
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(325,45-368,26); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_13db5a28ac709eeec52a785737a492a6 @x1
@x2))
(and 
;; def=Prims.fst(325,45-368,26); use=GMST.fst(187,4-191,72)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Prims.pure_post (GMST.mst_wp (GMST.state Dummy_value)
@x2
(GMST.op_At (GMST.state Dummy_value)
@x1
@x1))))
...
:pattern ((ApplyTT @x0
@x3))
:qid GMST_interpretation_Tm_arrow_13db5a28ac709eeec52a785737a492a6.1))
...
(Tm_arrow_13db5a28ac709eeec52a785737a492a6 @x1
@x2)))
:qid GMST_interpretation_Tm_arrow_13db5a28ac709eeec52a785737a492a6))

:named GMST_interpretation_Tm_arrow_13db5a28ac709eeec52a785737a492a6))
(declare-fun Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,7-369,58); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8 @x0
@x1
@x2)
(Tm_arrow_13db5a28ac709eeec52a785737a492a6 @x1
@x2))
...
:pattern ((Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8 @x0
@x1
@x2))
:qid typing_Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8))

:named typing_Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,7-369,58); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8 @x1
@x2
@x3)
@x0)
(Prims.l_and (Prims.l_Forall (GMST.state Dummy_value)
(Tm_abs_af07208e0ecb7112dee96f139621688f @x2
@x3
@x1))
(Prims.l_Forall (GMST.mst_wp (GMST.state Dummy_value)
@x3
(GMST.op_At (GMST.state Dummy_value)
@x2
@x2))
...
:pattern ((ApplyTT (Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8))

:named interpretation_Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8))
...
;;;;;;;;;;;;;;;;x: a -> s1: state{rel s0 s1} -> Type0
(declare-fun Tm_arrow_b33738844e7c277348cc3b13d4410c09 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b33738844e7c277348cc3b13d4410c09
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-180,20); use=GMST.fst(182,36-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_b33738844e7c277348cc3b13d4410c09 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_b33738844e7c277348cc3b13d4410c09 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_b33738844e7c277348cc3b13d4410c09))

:named kinding_Tm_arrow_b33738844e7c277348cc3b13d4410c09))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-180,20); use=GMST.fst(182,36-191,72)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_b33738844e7c277348cc3b13d4410c09 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid GMST_pre_typing_Tm_arrow_b33738844e7c277348cc3b13d4410c09))

:named GMST_pre_typing_Tm_arrow_b33738844e7c277348cc3b13d4410c09))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b33738844e7c277348cc3b13d4410c09
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-180,20); use=GMST.fst(182,36-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_b33738844e7c277348cc3b13d4410c09 @x1
@x2
@x3))
(and 
;; def=GMST.fst(101,65-180,20); use=GMST.fst(182,36-191,72)
...
@x4)
@x5))
:qid GMST_interpretation_Tm_arrow_b33738844e7c277348cc3b13d4410c09.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid GMST_interpretation_Tm_arrow_b33738844e7c277348cc3b13d4410c09.2))
))
...
@x2
@x3)))
:qid GMST_interpretation_Tm_arrow_b33738844e7c277348cc3b13d4410c09))

:named GMST_interpretation_Tm_arrow_b33738844e7c277348cc3b13d4410c09))
(declare-fun Tm_abs_800b72212112430c0c5595d824944bc6 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_800b72212112430c0c5595d824944bc6
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(190,57-190,67); use=GMST.fst(190,57-190,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_800b72212112430c0c5595d824944bc6 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Tm_abs_800b72212112430c0c5595d824944bc6 @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_800b72212112430c0c5595d824944bc6))

:named typing_Tm_abs_800b72212112430c0c5595d824944bc6))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_800b72212112430c0c5595d824944bc6
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(190,57-190,67); use=GMST.fst(190,57-190,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_800b72212112430c0c5595d824944bc6 @x2
@x3
@x4
@x5
@x6)
...
:pattern ((ApplyTT (ApplyTT (Tm_abs_800b72212112430c0c5595d824944bc6 @x2
@x3
@x4
@x5
@x6)
@x0)
@x1))
:qid interpretation_Tm_abs_800b72212112430c0c5595d824944bc6))

:named interpretation_Tm_abs_800b72212112430c0c5595d824944bc6))



;;;;;;;;;;;;;;;;s0: state -> p: (_: b -> s1: state{(rel @ rel) s0 s1} -> Type0) -> Type0
(declare-fun Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-180,30); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c))

:named kinding_Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-180,30); use=GMST.fst(187,4-191,72)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c @x2
@x3)))
:qid GMST_pre_typing_Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c))

:named GMST_pre_typing_Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(101,65-180,30); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c @x1
@x2))
(and 
;; def=GMST.fst(101,65-180,30); use=GMST.fst(187,4-191,72)
(forall ((@x3 Term) (@x4 Term))
...
@x3)
@x4))
:qid GMST_interpretation_Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid GMST_interpretation_Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c.2))
))
...
(Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c @x1
@x2)))
:qid GMST_interpretation_Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c))

:named GMST_interpretation_Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c))
(declare-fun Tm_abs_f9ada65b3419e113d7810dde28e99dfd (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_f9ada65b3419e113d7810dde28e99dfd
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(190,37-190,68); use=GMST.fst(190,37-190,68)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_f9ada65b3419e113d7810dde28e99dfd @x0
@x1
@x2
@x3
@x4)
(Tm_arrow_7468e3a6d0c79ac547b4f992f25d6e6c @x3
@x4))
 

:pattern ((Tm_abs_f9ada65b3419e113d7810dde28e99dfd @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_f9ada65b3419e113d7810dde28e99dfd))

:named typing_Tm_abs_f9ada65b3419e113d7810dde28e99dfd))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_f9ada65b3419e113d7810dde28e99dfd
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(190,37-190,68); use=GMST.fst(190,37-190,68)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_f9ada65b3419e113d7810dde28e99dfd @x2
@x3
@x4
@x5
@x6)
...
(ApplyTT (ApplyTT @x2
@x0)
(Tm_abs_800b72212112430c0c5595d824944bc6 @x3
@x1
@x0
@x6
@x4)))
...
:pattern ((ApplyTT (ApplyTT (Tm_abs_f9ada65b3419e113d7810dde28e99dfd @x2
@x3
@x4
@x5
@x6)
@x0)
@x1))
:qid interpretation_Tm_abs_f9ada65b3419e113d7810dde28e99dfd))

:named interpretation_Tm_abs_f9ada65b3419e113d7810dde28e99dfd))

(declare-fun Tm_abs_caba6c620dbf2a6b63675c8fad136634 (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_caba6c620dbf2a6b63675c8fad136634
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(464,77-464,90); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (HasType (Tm_abs_caba6c620dbf2a6b63675c8fad136634 @x0
@x1
@x2
@x3
@x4
...
:pattern ((Tm_abs_caba6c620dbf2a6b63675c8fad136634 @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_Tm_abs_caba6c620dbf2a6b63675c8fad136634))

:named typing_Tm_abs_caba6c620dbf2a6b63675c8fad136634))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_caba6c620dbf2a6b63675c8fad136634
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(464,77-464,90); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (ApplyTT (Tm_abs_caba6c620dbf2a6b63675c8fad136634 @x1
@x2
@x3
@x4
@x5
@x6)
@x0)
(Prims.l_imp (Prims.eq2 (GMST.mst_wp (GMST.state Dummy_value)
@x1
(GMST.op_At (GMST.state Dummy_value)
@x2
@x2))
(Tm_abs_f9ada65b3419e113d7810dde28e99dfd @x3
@x4
@x5
@x1
@x2)
...
:pattern ((ApplyTT (Tm_abs_caba6c620dbf2a6b63675c8fad136634 @x1
@x2
@x3
@x4
@x5
@x6)
@x0))
:qid interpretation_Tm_abs_caba6c620dbf2a6b63675c8fad136634))

:named interpretation_Tm_abs_caba6c620dbf2a6b63675c8fad136634))




(declare-fun Tm_abs_53a6ddedd8b02099d1d14a2cde793852 (Term Term Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_53a6ddedd8b02099d1d14a2cde793852
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(190,57-190,67); use=GMST.fst(189,4-189,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term))
 (! (HasType (Tm_abs_53a6ddedd8b02099d1d14a2cde793852 @x0
@x1
@x2
@x3
@x4
...
@x9
@x10)
(Tm_arrow_b33738844e7c277348cc3b13d4410c09 @x8
@x9
@x10))
 

:pattern ((Tm_abs_53a6ddedd8b02099d1d14a2cde793852 @x0
@x1
@x2
@x3
@x4
...
@x9
@x10))
:qid typing_Tm_abs_53a6ddedd8b02099d1d14a2cde793852))

:named typing_Tm_abs_53a6ddedd8b02099d1d14a2cde793852))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_53a6ddedd8b02099d1d14a2cde793852
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(190,57-190,67); use=GMST.fst(189,4-189,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term) (@x12 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_53a6ddedd8b02099d1d14a2cde793852 @x2
@x3
@x4
@x5
@x6
...
:pattern ((ApplyTT (ApplyTT (Tm_abs_53a6ddedd8b02099d1d14a2cde793852 @x2
@x3
@x4
@x5
@x6
...
@x0)
@x1))
:qid interpretation_Tm_abs_53a6ddedd8b02099d1d14a2cde793852))

:named interpretation_Tm_abs_53a6ddedd8b02099d1d14a2cde793852))

;;;;;;;;;;;;;;;;rel1: FStar.Preorder.relation state -> x: Prims.unit -> s1: state{rel1 s1 s1} -> Prims.GTot Type0
(declare-fun Tm_arrow_e230eb8b375be9b921e606565b9df533 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e230eb8b375be9b921e606565b9df533
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(29,64-29,79); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_e230eb8b375be9b921e606565b9df533 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_e230eb8b375be9b921e606565b9df533 @x0)
Tm_type))
:qid kinding_Tm_arrow_e230eb8b375be9b921e606565b9df533))

:named kinding_Tm_arrow_e230eb8b375be9b921e606565b9df533))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(29,64-29,79); use=GMST.fst(187,4-191,72)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_e230eb8b375be9b921e606565b9df533 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_e230eb8b375be9b921e606565b9df533 @x2)))
:qid GMST_pre_typing_Tm_arrow_e230eb8b375be9b921e606565b9df533))

:named GMST_pre_typing_Tm_arrow_e230eb8b375be9b921e606565b9df533))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e230eb8b375be9b921e606565b9df533
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(29,64-29,79); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_e230eb8b375be9b921e606565b9df533 @x1))
(and 
;; def=GMST.fst(29,64-29,79); use=GMST.fst(187,4-191,72)
(forall ((@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x2
...
@x3)
@x4))
:qid GMST_interpretation_Tm_arrow_e230eb8b375be9b921e606565b9df533.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid GMST_interpretation_Tm_arrow_e230eb8b375be9b921e606565b9df533.2))
...
@x2)
@x3))
:qid GMST_interpretation_Tm_arrow_e230eb8b375be9b921e606565b9df533.3))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_e230eb8b375be9b921e606565b9df533 @x1)))
:qid GMST_interpretation_Tm_arrow_e230eb8b375be9b921e606565b9df533))

:named GMST_interpretation_Tm_arrow_e230eb8b375be9b921e606565b9df533))
(declare-fun Tm_abs_ea60efde9b600cd4ac44917f8524ac9a (Term Term Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_ea60efde9b600cd4ac44917f8524ac9a
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term))
 (! (HasType (Tm_abs_ea60efde9b600cd4ac44917f8524ac9a @x0
@x1
@x2
@x3
@x4
...
@x9
@x10)
(Tm_arrow_e230eb8b375be9b921e606565b9df533 @x10))
 

:pattern ((Tm_abs_ea60efde9b600cd4ac44917f8524ac9a @x0
@x1
@x2
@x3
@x4
...
@x9
@x10))
:qid typing_Tm_abs_ea60efde9b600cd4ac44917f8524ac9a))

:named typing_Tm_abs_ea60efde9b600cd4ac44917f8524ac9a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_ea60efde9b600cd4ac44917f8524ac9a
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term) (@x12 Term) (@x13 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_ea60efde9b600cd4ac44917f8524ac9a @x3
@x4
@x5
@x6
@x7
...
(ApplyTT (ApplyTT @x3
@x2)
(Tm_abs_53a6ddedd8b02099d1d14a2cde793852 @x4
@x5
@x0
@x6
@x7
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_ea60efde9b600cd4ac44917f8524ac9a @x3
@x4
@x5
@x6
@x7
...
@x1)
@x2))
:qid interpretation_Tm_abs_ea60efde9b600cd4ac44917f8524ac9a))

:named interpretation_Tm_abs_ea60efde9b600cd4ac44917f8524ac9a))

;;;;;;;;;;;;;;;;rel1: FStar.Preorder.relation state -> x: mst_wp state b (rel @ rel) -> s1: state{rel1 s1 s1}   -> Prims.GTot Type0
(declare-fun Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(29,45-176,47); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797))

:named kinding_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(29,45-176,47); use=GMST.fst(187,4-191,72)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid GMST_pre_typing_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797))

:named GMST_pre_typing_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(29,45-176,47); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797 @x1
@x2
@x3))
(and 
;; def=GMST.fst(29,45-176,47); use=GMST.fst(187,4-191,72)
...
@x2)))
(HasType @x6
(Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x4
@x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x4)
@x5)
...
@x5)
@x6))
:qid GMST_interpretation_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797.1))
...
:pattern ((ApplyTT @x0
@x4))
:qid GMST_interpretation_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797.2))
...
@x4)
@x5))
:qid GMST_interpretation_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797.3))
))
...
@x2
@x3)))
:qid GMST_interpretation_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797))

:named GMST_interpretation_Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797))
(declare-fun Tm_abs_e8cbcd19e8fbf25747419103b181d9e8 (Term Term Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_e8cbcd19e8fbf25747419103b181d9e8
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term))
 (! (HasType (Tm_abs_e8cbcd19e8fbf25747419103b181d9e8 @x0
@x1
@x2
@x3
@x4
...
@x9
@x10)
(Tm_arrow_c8a3538bc918f7e43ddfdd0ed22e4797 @x8
@x9
@x10))
 

:pattern ((Tm_abs_e8cbcd19e8fbf25747419103b181d9e8 @x0
@x1
@x2
@x3
@x4
...
@x9
@x10))
:qid typing_Tm_abs_e8cbcd19e8fbf25747419103b181d9e8))

:named typing_Tm_abs_e8cbcd19e8fbf25747419103b181d9e8))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e8cbcd19e8fbf25747419103b181d9e8
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term) (@x12 Term) (@x13 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_e8cbcd19e8fbf25747419103b181d9e8 @x3
@x4
@x5
@x6
@x7
...
@x1)
@x2)
(GMST.lift_div_gmst Prims.unit
(Tm_abs_caba6c620dbf2a6b63675c8fad136634 @x13
@x12
@x3
@x4
@x5
@x1)
@x2
(Tm_abs_ea60efde9b600cd4ac44917f8524ac9a @x3
@x4
@x6
@x0
@x7
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_e8cbcd19e8fbf25747419103b181d9e8 @x3
@x4
@x5
@x6
@x7
...
@x1)
@x2))
:qid interpretation_Tm_abs_e8cbcd19e8fbf25747419103b181d9e8))

:named interpretation_Tm_abs_e8cbcd19e8fbf25747419103b181d9e8))


(declare-fun Tm_abs_f411ed7b35e862c88bd103c0e5cce997 (Term Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_f411ed7b35e862c88bd103c0e5cce997
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term))
 (! (HasType (Tm_abs_f411ed7b35e862c88bd103c0e5cce997 @x0
@x1
@x2
@x3
@x4
...
@x8
@x9)
(Tm_arrow_e230eb8b375be9b921e606565b9df533 @x9))
 

:pattern ((Tm_abs_f411ed7b35e862c88bd103c0e5cce997 @x0
@x1
@x2
@x3
@x4
...
@x8
@x9))
:qid typing_Tm_abs_f411ed7b35e862c88bd103c0e5cce997))

:named typing_Tm_abs_f411ed7b35e862c88bd103c0e5cce997))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_f411ed7b35e862c88bd103c0e5cce997
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term) (@x12 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_f411ed7b35e862c88bd103c0e5cce997 @x3
@x4
@x5
@x6
@x7
...
@x1)
@x2)
(GMST.lift_div_gmst (GMST.mst_wp (GMST.state Dummy_value)
@x3
(GMST.op_At (GMST.state Dummy_value)
@x4
@x4))
(Tm_abs_fa3276fcefdb256f54a9bab92fbc94b8 @x5
@x4
@x3)
@x2
(Tm_abs_e8cbcd19e8fbf25747419103b181d9e8 @x6
@x7
@x5
@x8
@x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_f411ed7b35e862c88bd103c0e5cce997 @x3
@x4
@x5
@x6
@x7
...
@x1)
@x2))
:qid interpretation_Tm_abs_f411ed7b35e862c88bd103c0e5cce997))

:named interpretation_Tm_abs_f411ed7b35e862c88bd103c0e5cce997))


;;;;;;;;;;;;;;;;rel1: FStar.Preorder.relation state ->     x: rel2: FStar.Preorder.relation state {rel @ rel == rel2} ->     s1: state{rel1 s1 s1}   -> Prims.GTot Type0
(declare-fun Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(29,45-175,92); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619))

:named kinding_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(29,45-175,92); use=GMST.fst(187,4-191,72)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619 @x2
@x3)))
:qid GMST_pre_typing_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619))

:named GMST_pre_typing_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(29,45-175,92); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619 @x1
@x2))
(and 
;; def=GMST.fst(29,45-175,92); use=GMST.fst(187,4-191,72)
...
(Tm_refine_5a77ba0e570a764db7aadc9a874aeff0 @x2))
(HasType @x5
(Tm_refine_2dbcc642e30c94354080ed8b90217c10 @x3
@x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x3)
@x4)
...
@x4)
@x5))
:qid GMST_interpretation_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid GMST_interpretation_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619.2))
...
@x3)
@x4))
:qid GMST_interpretation_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619.3))
))
...
(Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619 @x1
@x2)))
:qid GMST_interpretation_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619))

:named GMST_interpretation_Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619))
(declare-fun Tm_abs_62bfc2ce87452f42048da408f827a69b (Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_62bfc2ce87452f42048da408f827a69b
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (HasType (Tm_abs_62bfc2ce87452f42048da408f827a69b @x0
@x1
@x2
@x3
@x4
...
@x7
@x8)
(Tm_arrow_4bbca22c5ffbe6d99071ff07a09f9619 @x7
@x8))
 

:pattern ((Tm_abs_62bfc2ce87452f42048da408f827a69b @x0
@x1
@x2
@x3
@x4
...
@x7
@x8))
:qid typing_Tm_abs_62bfc2ce87452f42048da408f827a69b))

:named typing_Tm_abs_62bfc2ce87452f42048da408f827a69b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_62bfc2ce87452f42048da408f827a69b
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_62bfc2ce87452f42048da408f827a69b @x3
@x4
@x5
@x6
@x7
...
@x2)
(GMST.lift_div_gmst Prims.unit
(Tm_abs_bef10cf5e903f36ef5f275ad6b42e214 @x11
@x1)
@x2
(Tm_abs_f411ed7b35e862c88bd103c0e5cce997 @x3
@x11
@x4
@x5
@x6
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_62bfc2ce87452f42048da408f827a69b @x3
@x4
@x5
@x6
@x7
...
@x1)
@x2))
:qid interpretation_Tm_abs_62bfc2ce87452f42048da408f827a69b))

:named interpretation_Tm_abs_62bfc2ce87452f42048da408f827a69b))


(declare-fun Tm_abs_6edea92646200e0b209fd88879c9a2f6 (Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_6edea92646200e0b209fd88879c9a2f6
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (HasType (Tm_abs_6edea92646200e0b209fd88879c9a2f6 @x0
@x1
@x2
@x3
@x4
...
@x6
@x7)
(Tm_arrow_e230eb8b375be9b921e606565b9df533 @x7))
 

:pattern ((Tm_abs_6edea92646200e0b209fd88879c9a2f6 @x0
@x1
@x2
@x3
@x4
...
@x6
@x7))
:qid typing_Tm_abs_6edea92646200e0b209fd88879c9a2f6))

:named typing_Tm_abs_6edea92646200e0b209fd88879c9a2f6))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_6edea92646200e0b209fd88879c9a2f6
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_6edea92646200e0b209fd88879c9a2f6 @x3
@x4
@x5
@x6
@x7
...
@x1)
@x2)
(GMST.lift_div_gmst (Tm_refine_5a77ba0e570a764db7aadc9a874aeff0 @x3)
(Tm_abs_dd2518e956859acbf61225bc8b8aaf91 @x3)
@x2
(Tm_abs_62bfc2ce87452f42048da408f827a69b @x4
@x5
@x6
@x7
@x8
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_6edea92646200e0b209fd88879c9a2f6 @x3
@x4
@x5
@x6
@x7
...
@x1)
@x2))
:qid interpretation_Tm_abs_6edea92646200e0b209fd88879c9a2f6))

:named interpretation_Tm_abs_6edea92646200e0b209fd88879c9a2f6))


(declare-fun Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904 (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (HasType (Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904 @x0
@x1
@x2
@x3
@x4
@x5
@x6)
(Tm_arrow_e230eb8b375be9b921e606565b9df533 @x6))
 

:pattern ((Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904 @x0
@x1
@x2
@x3
@x4
@x5
@x6))
:qid typing_Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904))

:named typing_Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(43,29-43,67); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904 @x3
@x4
@x5
@x6
@x7
...
@x2)
(GMST.lift_div_gmst Prims.unit
Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9
@x2
(Tm_abs_6edea92646200e0b209fd88879c9a2f6 @x3
@x4
@x5
@x6
@x7
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904 @x3
@x4
@x5
@x6
@x7
...
@x1)
@x2))
:qid interpretation_Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904))

:named interpretation_Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904))



(declare-fun Tm_abs_11cb3759ab1137e1dd015ec1595ca30c (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_11cb3759ab1137e1dd015ec1595ca30c
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(186,58-186,68); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_11cb3759ab1137e1dd015ec1595ca30c @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Tm_abs_11cb3759ab1137e1dd015ec1595ca30c @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_11cb3759ab1137e1dd015ec1595ca30c))

:named typing_Tm_abs_11cb3759ab1137e1dd015ec1595ca30c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_11cb3759ab1137e1dd015ec1595ca30c
;;; Fact-ids: 
(assert (! 
;; def=GMST.fst(186,58-186,68); use=GMST.fst(187,4-191,72)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_11cb3759ab1137e1dd015ec1595ca30c @x2
@x3
@x4
@x5
@x6)
...
:pattern ((ApplyTT (ApplyTT (Tm_abs_11cb3759ab1137e1dd015ec1595ca30c @x2
@x3
@x4
@x5
@x6)
@x0)
@x1))
:qid interpretation_Tm_abs_11cb3759ab1137e1dd015ec1595ca30c))

:named interpretation_Tm_abs_11cb3759ab1137e1dd015ec1595ca30c))
...
;   (f: (_: Prims.unit -> GMST.GMST a))
;   (g: (x: a -> GMST.GMST b)).
;   (forall (s0: GMST.state) (p: (_: b -> s1: GMST.state{(rel @ rel) s0 s1} -> Type0)).
;       (*  - Could not prove post-condition
; *)
;       forall (x: a) (s1: GMST.state{rel s0 s1}).
;         (*  - Could not prove post-condition
; *)
;         forall (_: b) (s1: GMST.state). rel s1 s1 ==> (rel @ rel) s0 s1) /\
;   (forall (s0: GMST.state) (p: GMST.gmst_post GMST.state b s0).
;       wp1 s0 (fun x s1 -> wp2 x s1 (p (rel @ rel))) ==>
;       GMST.lift_div_gmst Prims.unit
;         (fun p ->
;             rel @ rel == rel /\
;             (forall (pure_result: Prims.unit). rel @ rel == rel ==> p pure_result))
;         s0
;         (fun rel1 _ s1 ->
;             GMST.lift_div_gmst Prims.unit
;               (fun _ -> Prims.l_True)
;               s1
;               (fun rel1 _ s1 ->
;                   GMST.lift_div_gmst (rel2: FStar.Preorder.relation GMST.state {rel @ rel == rel2})
;                     (fun p ->
;                         (FStar.Preorder.preorder_rel rel ==> rel @ rel == rel) /\
;                         (forall (any_result: FStar.Preorder.preorder GMST.state). p any_result))
;                     s1
;                     (fun rel1 x s1 ->
;                         GMST.lift_div_gmst Prims.unit
;                           (fun post -> rel == x ==> post ())
;                           s1
;                           (fun rel1 _ s1 ->
;                               GMST.lift_div_gmst (GMST.mst_wp GMST.state b (rel @ rel))
;                                 (fun p ->
;                                     (forall (s0: GMST.state)
;                                         (p: (_: b -> s1: GMST.state{(rel @ rel) s0 s1} -> Type0)).
;                                         (*  - Could not prove post-condition
; *)
;                                         forall (x: a) (s1: GMST.state{rel s0 s1}).
;                                           (*  - Could not prove post-condition
; *)
;                                           forall (_: b) (s1: GMST.state).
;                                             rel s1 s1 ==> (rel @ rel) s0 s1) /\
;                                     (forall (any_result: GMST.mst_wp GMST.state b (rel @ rel)).
;                                         p any_result))
;                                 s1
;                                 (fun rel1 x s1 ->
;                                     GMST.lift_div_gmst Prims.unit
;                                       (fun post ->
;                                           (fun s0 p -> wp1 s0 (fun x s1 -> wp2 x s1 p)) == x ==>
;                                           post ())
;                                       s1
;                                       (fun rel1 _ s1 ->
;                                           wp1 s1
...
;; def=GMST.fst(56,2-56,36); use=GMST.fst(75,22-191,72)
(and 
;; def=dummy(0,0-0,0); use=GMST.fst(187,4-191,72)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
...
;; def=GMST.fst(101,70-101,79); use=GMST.fst(186,67-186,68)
(or label_1
...
;; def=GMST.fst(186,38-186,69); use=GMST.fst(187,4-191,72)
(Valid 
;; def=GMST.fst(186,38-186,69); use=GMST.fst(187,4-191,72)
(ApplyTT (ApplyTT @x3
@x7)
(Tm_abs_11cb3759ab1137e1dd015ec1595ca30c @x4
@x8
@x7
@x2
@x0))
...
;; def=GMST.fst(43,4-43,68); use=GMST.fst(187,4-191,72)
(or label_2
...
;; def=GMST.fst(43,4-43,68); use=GMST.fst(187,4-191,72)
(GMST.lift_div_gmst Prims.unit
(Tm_abs_4d7637bca3e5b88941eab785af8392f4 @x2)
@x7
(Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904 @x2
@x1
@x0
@x3
@x4
...
; QUERY ID: (GMST.preorder_app, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_f8666440faa91836cc5a13998af863fc, eq2-interp, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.transitive, equation_GMST.lift_div_gmst, equation_GMST.state, equation_Prims.eqtype, int_inversion, interpretation_Tm_abs_1bcda93ddf33f42f542cea7bc0e7f904, interpretation_Tm_abs_4d7637bca3e5b88941eab785af8392f4, interpretation_Tm_abs_9b728148fdfbb433bf963274e0ec60de, interpretation_Tm_abs_c2911ad21afae8f2ae1686aaf9ae5ca9, l_and-interp, l_quant_interp_8e7f59dbbf720f12c514120d6e5684ae, lemma_GMST.lemma_preorder_comp_equal, refinement_interpretation_Tm_refine_2dbcc642e30c94354080ed8b90217c10, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, token_correspondence_GMST.op_At, true_interp, typing_Prims.int, unit_typing
