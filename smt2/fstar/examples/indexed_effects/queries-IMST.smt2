...
(declare-fun IMST.st_pre (Term) Term)

(declare-fun IMST.st_pre@tok () Term)
...
(declare-fun IMST.st_post_ (Term Term Term) Term)

(declare-fun IMST.st_post_@tok () Term)
...
(declare-fun IMST.st_post (Term Term) Term)

(declare-fun IMST.st_post@tok () Term)
...
(declare-fun IMST.st_wp (Term) Term)

(declare-fun IMST.st_wp@tok () Term)
;;;;;;;;;;;;;;;;s: Type -> _: FStar.Preorder.preorder s -> _: FStar.Pervasives.st_post_h s a   -> FStar.Pervasives.st_pre_h s
(declare-fun Tm_arrow_a04229effa92137687fd8808058ab61a (Term) Term)

; </end encoding let st_wp>


; encoding sigelt let st_return


; <Start encoding let st_return>

(declare-fun IMST.st_return (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> s: Type -> rel: FStar.Preorder.preorder s -> post: st_post s a -> s0: s   -> Prims.logical
(declare-fun Tm_arrow_22f8a7b5a9b7c2639f7ee8c4d8a83ca7 () Term)
(declare-fun IMST.st_return@tok () Term)

; </end encoding let st_return>


; encoding sigelt let st_bind


; <Start encoding let st_bind>

;;;;;;;;;;;;;;;;_: a -> st_wp b
(declare-fun Tm_arrow_cb831e627fca1714a692268c68778a9a (Term Term) Term)
(declare-fun IMST.st_bind (Term Term Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     wp1: st_wp a ->     wp2: (_: a -> st_wp b) ->     s: Type ->     rel: FStar.Preorder.preorder s ->     post: st_post s b ->     s0: s   -> Type
(declare-fun Tm_arrow_f63b7a5c2e010ff2a12da752fbd0ba18 () Term)
(declare-fun IMST.st_bind@tok () Term)


(declare-fun Tm_abs_aeb0cc076214bd6c42a8c4e39231c212 (Term Term Term Term Term) Term)

; </end encoding let st_bind>


; encoding sigelt let st_if_then_else


; <Start encoding let st_if_then_else>

(declare-fun IMST.st_if_then_else (Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     p: Type ->     wp_then: st_wp a ->     wp_else: st_wp a ->     s: Type ->     rel: FStar.Preorder.preorder s ->     post: st_post s a ->     s0: s   -> Prims.logical
(declare-fun Tm_arrow_8a07ba5313d1901f0012935377213aa3 () Term)
(declare-fun IMST.st_if_then_else@tok () Term)

; </end encoding let st_if_then_else>


; encoding sigelt let st_ite


; <Start encoding let st_ite>

(declare-fun IMST.st_ite (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: st_wp a -> s: Type -> rel: FStar.Preorder.preorder s -> post: st_post s a -> s0: s   -> Prims.logical
(declare-fun Tm_arrow_15143b14454c07d8581812fd47e80d8c () Term)
(declare-fun IMST.st_ite@tok () Term)

; </end encoding let st_ite>


; encoding sigelt let st_stronger


; <Start encoding let st_stronger>

(declare-fun IMST.st_stronger (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp1: st_wp a -> wp2: st_wp a -> Prims.logical
(declare-fun Tm_arrow_40fb65b7b1a5c3c9830a1e3ab110237f () Term)
(declare-fun IMST.st_stronger@tok () Term)

; </end encoding let st_stronger>


; encoding sigelt let st_close


; <Start encoding let st_close>


(declare-fun IMST.st_close (Term Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     wp: (_: b -> Prims.GTot (st_wp a)) ->     s: Type ->     rel: FStar.Preorder.preorder s ->     p: st_post s a ->     s0: s   -> Prims.logical
(declare-fun Tm_arrow_9ab1a3563a0351ccda77e0d7eb754c20 () Term)
(declare-fun IMST.st_close@tok () Term)


; </end encoding let st_close>


; encoding sigelt let st_trivial


; <Start encoding let st_trivial>

(declare-fun IMST.st_trivial (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: st_wp a -> Prims.logical
(declare-fun Tm_arrow_24088675ebb5d725d0018733d0a138e8 () Term)
(declare-fun IMST.st_trivial@tok () Term)
...
; encoding sigelt new_effect { IMST ... }


; <Skipped new_effect { IMST ... }/>


; encoding sigelt let lift_div_imst


; <Start encoding let lift_div_imst>

(declare-fun IMST.lift_div_imst (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     wp: Prims.pure_wp a ->     s: Type ->     rel: FStar.Preorder.preorder s ->     post: st_post s a ->     s0: s   -> Prims.pure_pre
(declare-fun Tm_arrow_4fdfae7741f48f4395a2a6aba0fc2fe8 () Term)
(declare-fun IMST.lift_div_imst@tok () Term)



; </end encoding let lift_div_imst>


; encoding sigelt sub_effect DIV ~> IMST


; <Skipped sub_effect DIV ~> IMST/>
...
(declare-fun IMST.st_wp_ (Term Term) Term)

(declare-fun IMST.st_wp_@tok () Term)
;;;;;;;;;;;;;;;;_: st_post s a -> st_pre s
(declare-fun Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa (Term Term) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMST.st_wp'; Namespace IMST
(assert (! 
;; def=IMST.fst(107,4-107,10); use=IMST.fst(107,4-107,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (IMST.st_wp_ @x0
@x1)
Tm_type))
 

:pattern ((IMST.st_wp_ @x0
@x1))
:qid typing_IMST.st_wp_))

:named typing_IMST.st_wp_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMST.st_pre; Namespace IMST
(assert (! 
;; def=IMST.fst(28,4-28,10); use=IMST.fst(28,4-28,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (IMST.st_pre @x0)
Tm_type))
 

:pattern ((IMST.st_pre @x0))
:qid typing_IMST.st_pre))

:named typing_IMST.st_pre))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMST.st_post; Namespace IMST
(assert (! 
;; def=IMST.fst(30,4-30,11); use=IMST.fst(30,4-30,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (IMST.st_post @x0
@x1)
Tm_type))
 

:pattern ((IMST.st_post @x0
@x1))
:qid typing_IMST.st_post))

:named typing_IMST.st_post))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa
;;; Fact-ids: Name IMST.st_wp'; Namespace IMST
(assert (! 
;; def=IMST.fst(108,4-108,33); use=IMST.fst(108,4-108,33)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa))

:named kinding_Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa))
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (IMST.st_wp_ @x0
@x1)
(Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa @x0
@x1))
 

:pattern ((IMST.st_wp_ @x0
@x1))
:qid equation_IMST.st_wp_))

:named equation_IMST.st_wp_))
;;;;;;;;;;;;;;;;Equation for IMST.st_pre
;;; Fact-ids: Name IMST.st_pre; Namespace IMST
(assert (! 
;; def=IMST.fst(28,4-28,10); use=IMST.fst(28,4-28,10)
(forall ((@x0 Term))
...
:pattern ((IMST.st_pre @x0))
:qid equation_IMST.st_pre))

:named equation_IMST.st_pre))
;;;;;;;;;;;;;;;;Equation for IMST.st_post
;;; Fact-ids: Name IMST.st_post; Namespace IMST
(assert (! 
;; def=IMST.fst(30,4-30,11); use=IMST.fst(30,4-30,11)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((IMST.st_post @x0
@x1))
:qid equation_IMST.st_post))

:named equation_IMST.st_post))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa @x2
@x3)))
:qid IMST_pre_typing_Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa))

:named IMST_pre_typing_Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa
;;; Fact-ids: Name IMST.st_wp'; Namespace IMST
(assert (! 
;; def=IMST.fst(108,4-108,33); use=IMST.fst(108,4-108,33)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa @x1
@x2))
(and 
;; def=IMST.fst(108,4-108,33); use=IMST.fst(108,4-108,33)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid IMST_interpretation_Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa.1))
...
(Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa @x1
@x2)))
:qid IMST_interpretation_Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa))

:named IMST_interpretation_Tm_arrow_fbea90d8714b982b92b5324f3f0d35aa))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
; Starting query at IMST.fst(112,4-112,94)
...
(declare-fun Tm_abs_e8555c9e53483702ba1031562c0a1452 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_e8555c9e53483702ba1031562c0a1452
;;; Fact-ids: 
(assert (! (HasType Tm_abs_e8555c9e53483702ba1031562c0a1452
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
:named typing_Tm_abs_e8555c9e53483702ba1031562c0a1452))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e8555c9e53483702ba1031562c0a1452
;;; Fact-ids: 
(assert (! 
;; def=IMST.fst(111,34-111,44); use=IMST.fst(111,34-111,44)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_e8555c9e53483702ba1031562c0a1452
@x0)
(FStar.Preorder.preorder @x0))
 

:pattern ((ApplyTT Tm_abs_e8555c9e53483702ba1031562c0a1452
@x0))
:qid interpretation_Tm_abs_e8555c9e53483702ba1031562c0a1452))

:named interpretation_Tm_abs_e8555c9e53483702ba1031562c0a1452))
...
FStar.Pervasives.dsnd@tok))
:named @kick_partial_app_06f8a66c038a7e324c19bf1f98f1c309))

; Encoding query formula : forall (a: Type)
;   (sr: s: Type & FStar.Preorder.preorder s)
;   (wp: IMST.st_wp' a (FStar.Pervasives.dfst sr)).
;   (*  - Could not prove post-condition
; *)
;   forall (s: Type0) (rel: FStar.Preorder.preorder s) (post: FStar.Pervasives.st_post_h s a) (s0: s).
;     (*  - Could not prove post-condition
; *)
;     (s == FStar.Pervasives.dfst sr ==>
;       (forall (x: s).
;           (*  - Could not prove post-condition
; *)
;           forall (y: sr._1).
;             Prims.has_type y s /\
;             (forall (any_result: sr._1).
;                 y == any_result ==>
;                 (forall (any_result: Type0). rel x y == any_result ==> Prims.has_type x sr._1)))) /\
;     (s == FStar.Pervasives.dfst sr /\
;       (forall (x: s) (y: sr._1). rel x y <==> FStar.Pervasives.dsnd sr x y) ==>
;       (forall (_: a) (_: FStar.Pervasives.dfst sr). Prims.has_type _ s) /\
;       (forall (any_result: FStar.Pervasives.st_post_h s a).
;           post == any_result ==>
;           (forall (any_result: IMST.st_pre (FStar.Pervasives.dfst sr)).
;               Prims.has_type s0 (FStar.Pervasives.dfst sr))))


; Context: While encoding a query
; While typechecking the top-level declaration `let op_Greater_Less`
...
Tm_abs_e8555c9e53483702ba1031562c0a1452))
(HasType @x2
(IMST.st_wp_ @x0
...
;; def=dummy(0,0-0,0); use=IMST.fst(112,4-112,94)
...
(HasType @x5
(FStar.Pervasives.st_post_h @x3
@x0))
(HasType @x6
@x3))

;; def=Prims.fst(459,77-459,89); use=IMST.fst(112,25-112,94)
(and (implies 
;; def=IMST.fst(112,25-112,37); use=IMST.fst(112,25-112,37)
(= @x3
(FStar.Pervasives.dfst Tm_type
Tm_abs_e8555c9e53483702ba1031562c0a1452
@x1))
...
;; def=dummy(0,0-0,0); use=IMST.fst(112,25-112,80)
(forall ((@x7 Term))
 (! (implies (HasType @x7
@x3)

;; def=dummy(0,0-0,0); use=IMST.fst(112,51-112,79)
(forall ((@x8 Term))
 (! (implies (HasType @x8
...
;; def=Prims.fst(459,77-459,89); use=IMST.fst(112,51-112,79)
(and 
;; def=IMST.fst(112,51-112,52); use=IMST.fst(112,61-112,62)
(or label_1
(HasType @x8
@x3))


;; def=Prims.fst(451,66-451,102); use=IMST.fst(112,51-112,79)
(forall ((@x9 Term))
...
;; def=Prims.fst(210,12-210,13); use=IMST.fst(112,51-112,79)
(= (ApplyTT (ApplyTT @x4
@x7)
@x8)
@x10)
...
;; def=IMST.fst(112,49-112,50); use=IMST.fst(112,76-112,77)
(or label_2
(HasType @x7
(Prims.__proj__Mkdtuple2__item___1 Tm_type
Tm_abs_e8555c9e53483702ba1031562c0a1452
...
(implies 
;; def=IMST.fst(112,25-112,80); use=IMST.fst(112,25-112,80)
(and 
;; def=IMST.fst(112,25-112,37); use=IMST.fst(112,25-112,37)
(= @x3
(FStar.Pervasives.dfst Tm_type
...
;; def=IMST.fst(112,41-112,80); use=IMST.fst(112,41-112,80)
...
;; def=IMST.fst(112,55-112,79); use=IMST.fst(112,55-112,79)
(iff 
;; def=IMST.fst(112,55-112,62); use=IMST.fst(112,55-112,62)
(Valid 
;; def=IMST.fst(112,55-112,62); use=IMST.fst(112,55-112,62)
(ApplyTT (ApplyTT @x4
@x7)
...
;; def=IMST.fst(112,68-112,79); use=IMST.fst(112,68-112,79)
(Valid 
;; def=IMST.fst(112,68-112,79); use=IMST.fst(112,68-112,79)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.dsnd@tok
Tm_type)
Tm_abs_e8555c9e53483702ba1031562c0a1452)
@x1)
@x7)
...
;; def=Prims.fst(459,77-459,89); use=IMST.fst(112,25-112,94)
(and 
;; def=dummy(0,0-0,0); use=IMST.fst(112,87-112,91)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
@x0)
(HasType @x8
...
;; def=IMST.fst(112,14-112,18); use=IMST.fst(112,87-112,91)
(or label_3
(HasType @x8
@x3))
)
...
;; def=Prims.fst(451,66-451,102); use=IMST.fst(112,25-112,94)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.Pervasives.st_post_h @x3
@x0))

;; def=dummy(0,0-0,0); use=IMST.fst(112,25-112,94)
(= @x5
@x7)
)
...
(forall ((@x8 Term))
 (! (implies (HasType @x8
(IMST.st_pre (FStar.Pervasives.dfst Tm_type
Tm_abs_e8555c9e53483702ba1031562c0a1452
@x1)))

;; def=IMST.fst(112,19-112,21); use=IMST.fst(112,92-112,94)
(or label_4
(HasType @x6
(FStar.Pervasives.dfst Tm_type
Tm_abs_e8555c9e53483702ba1031562c0a1452
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IMST.op_Greater_Less, 1)
; STATUS: unsat
...
(declare-fun IMST.op_Greater_Less (Term Term Term) Term)




;;;;;;;;;;;;;;;;sr: s: Type & FStar.Preorder.preorder s -> wp: st_wp' a (FStar.Pervasives.dfst sr) -> st_wp a
(declare-fun Tm_arrow_965920fa186ed2e61a5fb13d2bbc10b0 () Term)
(declare-fun IMST.op_Greater_Less@tok () Term)
...
;;;;;;;;;;;;;;;;y: sr._1 -> Prims.GTot Type
(declare-fun Tm_arrow_a8451a6785cf7abb4b41705e8bc430af (Term) Term)
(declare-fun Tm_abs_f6229f830af2d8347bce66e5261f672d (Term Term Term) Term)

(declare-fun Tm_abs_1819bb3de9b779167b8dd9de8b706c21 (Term Term Term) Term)





;;;;;;;;;;;;;;;;s: Type -> rel: FStar.Preorder.preorder s -> post: FStar.Pervasives.st_post_h s a -> s0: s   -> Prims.GTot Type
(declare-fun Tm_arrow_4fff2e3162ca14fa8efe37c76b649cfb (Term) Term)
(declare-fun Tm_abs_8c6383544a580e39d8db9cc5a0abca91 (Term Term Term) Term)

; </end encoding let op_Greater_Less>


; encoding sigelt val IMST.get


; <Start encoding val IMST.get>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IMST.get (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IMST.get@tok () Term)

; </end encoding val IMST.get>


; encoding sigelt val IMST.put


; <Start encoding val IMST.put>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IMST.put (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IMST.put@tok () Term)

; </end encoding val IMST.put>
...
(declare-fun IMST.witnessed (Term Term Term) Term)
;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate s -> Type
(declare-fun Tm_arrow_43c2a786525533d46c4f0c73f49705dd () Term)
(declare-fun IMST.witnessed@tok () Term)

; </end encoding let witnessed>


; encoding sigelt val IMST.witness


; <Start encoding val IMST.witness>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IMST.witness (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IMST.witness@tok () Term)

; </end encoding val IMST.witness>


; encoding sigelt val IMST.recall


; <Start encoding val IMST.recall>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IMST.recall (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IMST.recall@tok () Term)

; </end encoding val IMST.recall>


; encoding sigelt let nat_rel'


; <Start encoding let nat_rel'>

(declare-fun IMST.nat_rel_ (Dummy_sort) Term)

; </end encoding let nat_rel'>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMST.nat_rel'; Namespace IMST
(assert (! 
;; def=IMST.fst(133,4-133,12); use=IMST.fst(133,4-133,12)
(forall ((@u0 Dummy_sort))
 (! (HasType (IMST.nat_rel_ @u0)
(FStar.Preorder.relation Prims.nat))
 

:pattern ((IMST.nat_rel_ @u0))
:qid typing_IMST.nat_rel_))

:named typing_IMST.nat_rel_))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;Equation for IMST.nat_rel'
;;; Fact-ids: Name IMST.nat_rel'; Namespace IMST
(assert (! 
;; def=IMST.fst(133,4-133,12); use=IMST.fst(133,4-133,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT (IMST.nat_rel_ Dummy_value)
@x0)
@x1)
...
:pattern ((ApplyTT (ApplyTT (IMST.nat_rel_ Dummy_value)
@x0)
@x1))
:qid equation_IMST.nat_rel_))

:named equation_IMST.nat_rel_))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
; Starting query at IMST.fst(136,0-136,37)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (FStar.Preorder.preorder_rel IMST.nat_rel')


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let nat_rel`
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Preorder.fst(33,40-33,56); use=IMST.fst(136,29-136,37)
(or label_1

;; def=FStar.Preorder.fst(33,40-33,56); use=IMST.fst(136,29-136,37)
(Valid 
;; def=FStar.Preorder.fst(33,40-33,56); use=IMST.fst(136,29-136,37)
(FStar.Preorder.preorder_rel Prims.nat
(IMST.nat_rel_ Dummy_value))
)
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IMST.nat_rel, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, b2t_def, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_IMST.nat_rel_, equation_Prims.nat, primitive_Prims.op_LessThanOrEqual, projection_inverse_BoxBool_proj_0
...
(declare-fun IMST.nat_rel (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;typing_Tm_abs_e8555c9e53483702ba1031562c0a1452
;;; Fact-ids: Name IMST.op_Greater_Less; Namespace IMST
(assert (! (HasType Tm_abs_e8555c9e53483702ba1031562c0a1452
Tm_arrow_ef9cb512a25ee351fa5536d617490497)
:named typing_Tm_abs_e8555c9e53483702ba1031562c0a1452))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMST.witnessed; Namespace IMST
(assert (! 
;; def=IMST.fst(121,4-121,13); use=IMST.fst(121,4-121,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType (IMST.witnessed @x0
@x1
@x2)
Tm_type))
 

:pattern ((IMST.witnessed @x0
@x1
@x2))
:qid typing_IMST.witnessed))

:named typing_IMST.witnessed))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMST.nat_rel; Namespace IMST
(assert (! 
;; def=IMST.fst(136,4-136,11); use=IMST.fst(136,4-136,11)
(forall ((@u0 Dummy_sort))
 (! (HasType (IMST.nat_rel @u0)
(FStar.Preorder.preorder Prims.nat))
 

:pattern ((IMST.nat_rel @u0))
:qid typing_IMST.nat_rel))

:named typing_IMST.nat_rel))
;;;;;;;;;;;;;;;;free var typing
...
@x1
@x2)
(FStar.Monotonic.Witnessed.witnessed @x0
@x1
@x2))
...
@x1
@x2))
:qid equation_IMST.witnessed))

:named equation_IMST.witnessed))
;;;;;;;;;;;;;;;;Equation for IMST.nat_rel
;;; Fact-ids: Name IMST.nat_rel; Namespace IMST
(assert (! 
;; def=IMST.fst(136,4-136,11); use=IMST.fst(136,4-136,11)
...
:qid equation_IMST.nat_rel))

:named equation_IMST.nat_rel))
...
; Starting query at IMST.fst(142,3-151,6)
...
;;; Fact-ids: 
(assert (! 
;; def=IMST.fst(146,13-146,16); use=IMST.fst(146,4-146,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid IMST_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named IMST_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
...
:pattern ((ApplyTT @x0
@x1))
:qid IMST_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid IMST_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named IMST_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
(declare-fun Tm_abs_05f6ce5958841550e0655050d1696a3a () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_05f6ce5958841550e0655050d1696a3a
;;; Fact-ids: 
(assert (! (HasType Tm_abs_05f6ce5958841550e0655050d1696a3a
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)
:named typing_Tm_abs_05f6ce5958841550e0655050d1696a3a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_05f6ce5958841550e0655050d1696a3a
;;; Fact-ids: 
(assert (! 
;; def=IMST.fst(146,36-146,41); use=IMST.fst(146,4-146,11)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_05f6ce5958841550e0655050d1696a3a
@x0)
(Prims.b2t (Prims.op_GreaterThan @x0
(BoxInt 0))))
 

:pattern ((ApplyTT Tm_abs_05f6ce5958841550e0655050d1696a3a
@x0))
:qid interpretation_Tm_abs_05f6ce5958841550e0655050d1696a3a))

:named interpretation_Tm_abs_05f6ce5958841550e0655050d1696a3a))
...
;   (*  - Could not prove post-condition
; *)
;   forall (s: Type0) (rel: FStar.Preorder.preorder s) (p: IMST.st_post s Prims.nat) (s0: s).
;     s == FStar.Pervasives.dfst (| Prims.nat, IMST.nat_rel |) /\
;     (forall (x: s) (y: (| Prims.nat, IMST.nat_rel |)._1).
;         rel x y <==> FStar.Pervasives.dsnd (| Prims.nat, IMST.nat_rel |) x y) /\
;     (forall (s1: i: Prims.int{i >= 0}). s1 > s0 ==> p s0 s1) ==>
;     s == FStar.Pervasives.dfst (| Prims.nat, IMST.nat_rel |) /\
;     (forall (x: s) (y: (| Prims.nat, IMST.nat_rel |)._1).
;         rel x y <==> FStar.Pervasives.dsnd (| Prims.nat, IMST.nat_rel |) x y) /\
;     (s0 + 1 >= 0) /\
...
;             (forall (x: s) (y: (| Prims.nat, IMST.nat_rel |)._1).
;                 rel x y <==> FStar.Pervasives.dsnd (| Prims.nat, IMST.nat_rel |) x y) /\
;             FStar.Preorder.stable (fun n -> n > 0) IMST.nat_rel /\ (s0 + 1 > 0) /\
;             (IMST.witnessed (fun n -> n > 0) ==>
;               (s0 + 1) * 42 >= 0 /\
;               (forall (return_val: Prims.nat).
;                   return_val == (s0 + 1) * 42 ==>
;                   s == FStar.Pervasives.dfst (| Prims.nat, IMST.nat_rel |) /\
;                   (forall (x: s) (y: (| Prims.nat, IMST.nat_rel |)._1).
;                       rel x y <==> FStar.Pervasives.dsnd (| Prims.nat, IMST.nat_rel |) x y) /\
;                   IMST.nat_rel (s0 + 1) ((s0 + 1) * 42) /\
;                   ((s == FStar.Pervasives.dfst (| Prims.nat, IMST.nat_rel |)) /\
;                   (forall (x: s) (y: (| Prims.nat, IMST.nat_rel |)._1).
;                       rel x y <==> FStar.Pervasives.dsnd (| Prims.nat, IMST.nat_rel |) x y) /\
;                   (FStar.Preorder.stable (fun n -> n > 0) IMST.nat_rel /\
;                   IMST.witnessed (fun n -> n > 0) /\
;                   ((s0 + 1) * 42 > 0 ==>
;                     s == FStar.Pervasives.dfst (| Prims.nat, IMST.nat_rel |) /\
;                     (forall (x: s) (y: (| Prims.nat, IMST.nat_rel |)._1).
...
;                             any_result == s0 ==>
;                             (forall (v: Prims.nat). v == any_result ==> p v ((s0 + 1) * 42))))))))))))
;     )
...
;; def=IMST.fst(58,4-58,96); use=IMST.fst(81,22-81,33)
...
;; def=IMST.fst(112,25-112,37); use=IMST.fst(141,33-141,34)
(= @x1
(FStar.Pervasives.dfst Tm_type
Tm_abs_e8555c9e53483702ba1031562c0a1452
...
Tm_abs_e8555c9e53483702ba1031562c0a1452
Prims.nat
(IMST.nat_rel Dummy_value))))


;; def=IMST.fst(112,41-112,80); use=IMST.fst(141,33-141,34)
...
;; def=IMST.fst(112,55-112,79); use=IMST.fst(141,33-141,34)
(iff 
;; def=IMST.fst(112,55-112,62); use=IMST.fst(141,33-141,34)
(Valid 
;; def=IMST.fst(112,55-112,62); use=IMST.fst(141,33-141,34)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=IMST.fst(112,68-112,79); use=IMST.fst(141,33-141,34)
(Valid 
;; def=IMST.fst(112,68-112,79); use=IMST.fst(141,33-141,34)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.dsnd@tok
Tm_type)
...
;; def=IMST.fst(141,48-141,80); use=IMST.fst(142,3-151,6)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Tm_refine_542f9d4f129664613f2483a6c88bc7c2)

;; def=IMST.fst(141,60-141,67); use=IMST.fst(142,3-151,6)
(> (BoxInt_proj_0 @x5)
(BoxInt_proj_0 @x4))
)

;; def=IMST.fst(141,73-141,80); use=IMST.fst(142,3-151,6)
(Valid 
;; def=IMST.fst(141,73-141,80); use=IMST.fst(142,3-151,6)
(ApplyTT (ApplyTT @x3
@x4)
...
;; def=IMST.fst(112,25-112,94); use=IMST.fst(142,3-151,6)
(and 
;; def=IMST.fst(112,25-112,37); use=IMST.fst(142,3-151,6)
(or label_1
...
;; def=IMST.fst(112,41-112,80); use=IMST.fst(142,3-151,6)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
@x1)
(HasType @x6
...
;; def=IMST.fst(112,55-112,79); use=IMST.fst(142,3-151,6)
(or label_2

;; def=IMST.fst(112,55-112,79); use=IMST.fst(142,3-151,6)
(iff 
;; def=IMST.fst(112,55-112,62); use=IMST.fst(142,3-151,6)
(Valid 
;; def=IMST.fst(112,55-112,62); use=IMST.fst(142,3-151,6)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=IMST.fst(112,68-112,79); use=IMST.fst(142,3-151,6)
(Valid 
;; def=IMST.fst(112,68-112,79); use=IMST.fst(142,3-151,6)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.Pervasives.dsnd@tok
Tm_type)
...
;; def=Prims.fst(680,18-680,24); use=IMST.fst(143,22-143,30)
(or label_3
...
;; def=Prims.fst(356,2-356,58); use=IMST.fst(142,3-151,6)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=IMST.fst(142,3-151,6)
(= @x5
...
;; def=IMST.fst(119,92-119,101); use=IMST.fst(143,4-143,7)
(or label_6

;; def=IMST.fst(119,92-119,101); use=IMST.fst(143,4-143,7)
(Valid 
;; def=IMST.fst(119,92-119,101); use=IMST.fst(143,4-143,7)
(ApplyTT (ApplyTT (IMST.nat_rel Dummy_value)
@x4)
(Prims.op_Addition @x4
(BoxInt 1)))
)
...
;; def=IMST.fst(145,11-145,19); use=IMST.fst(145,4-145,10)
(or label_9
...
;; def=Prims.fst(441,36-441,97); use=IMST.fst(145,4-145,10)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)
...
;; def=IMST.fst(124,43-124,55); use=IMST.fst(146,4-146,11)
(or label_12

;; def=IMST.fst(124,43-124,55); use=IMST.fst(146,4-146,11)
(Valid 
;; def=IMST.fst(124,43-124,55); use=IMST.fst(146,4-146,11)
(FStar.Preorder.stable Prims.nat
Tm_abs_05f6ce5958841550e0655050d1696a3a
(IMST.nat_rel Dummy_value))
)
)
...
(implies 
;; def=IMST.fst(124,68-124,87); use=IMST.fst(146,4-146,11)
(Valid 
;; def=IMST.fst(124,68-124,87); use=IMST.fst(146,4-146,11)
(IMST.witnessed Prims.nat
(IMST.nat_rel Dummy_value)
Tm_abs_05f6ce5958841550e0655050d1696a3a)
)


;; def=Prims.fst(459,77-459,89); use=IMST.fst(142,3-151,6)
(and 
;; def=Prims.fst(680,18-680,24); use=IMST.fst(147,22-147,31)
(or label_14

;; def=Prims.fst(680,18-680,24); use=IMST.fst(147,22-147,31)
(>= (BoxInt_proj_0 (Prims.op_Multiply (Prims.op_Addition @x4
(BoxInt 1))
(BoxInt 42)))
(BoxInt_proj_0 (BoxInt 0)))
)
...
;; def=Prims.fst(356,26-356,41); use=IMST.fst(142,3-151,6)
(= @x7
(Prims.op_Multiply (Prims.op_Addition @x4
(BoxInt 1))
(BoxInt 42)))
)
...
;; def=IMST.fst(119,92-119,101); use=IMST.fst(147,4-147,7)
(or label_17
...
;; def=IMST.fst(127,43-127,55); use=IMST.fst(148,4-148,10)
(or label_20
...
;; def=IMST.fst(127,59-127,78); use=IMST.fst(148,4-148,10)
(or label_21
...
(implies 
;; def=IMST.fst(148,35-148,40); use=IMST.fst(148,4-148,10)
(> (BoxInt_proj_0 (Prims.op_Multiply (Prims.op_Addition @x4
(BoxInt 1))
(BoxInt 42)))
(BoxInt_proj_0 (BoxInt 0)))
...
;; def=IMST.fst(150,11-150,19); use=IMST.fst(150,4-150,10)
(or label_24
...
;; def=Prims.fst(441,36-441,97); use=IMST.fst(150,4-150,10)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)
...
;; def=Prims.fst(451,66-451,102); use=IMST.fst(142,3-151,6)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.nat)

;; def=IMST.fst(141,9-151,6); use=IMST.fst(142,3-151,6)
(= @x9
@x4)
)

;; def=IMST.fst(36,4-36,34); use=IMST.fst(142,3-151,6)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.nat)

;; def=IMST.fst(36,14-36,20); use=IMST.fst(142,3-151,6)
(= @x10
@x9)
)

;; def=IMST.fst(36,25-36,34); use=IMST.fst(142,3-151,6)
(or label_25
...
; QUERY ID: (IMST.f, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, b2t_def, equation_FStar.Pervasives.dfst, equation_FStar.Pervasives.dsnd, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.stable, equation_IMST.nat_rel, equation_IMST.nat_rel_, equation_Prims.nat, int_inversion, interpretation_Tm_abs_05f6ce5958841550e0655050d1696a3a, primitive_Prims.op_Addition, primitive_Prims.op_GreaterThan, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Multiply, proj_equation_Prims.Mkdtuple2__1, proj_equation_Prims.Mkdtuple2__2, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_Prims.Mkdtuple2__1, projection_inverse_Prims.Mkdtuple2__2, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c, typing_IMST.nat_rel
