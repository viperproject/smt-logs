...
(declare-fun IMSTsub.st_pre (Term) Term)

(declare-fun IMSTsub.st_pre@tok () Term)
...
(declare-fun IMSTsub.st_post_ (Term Term Term) Term)

(declare-fun IMSTsub.st_post_@tok () Term)
...
(declare-fun IMSTsub.st_post (Term Term) Term)

(declare-fun IMSTsub.st_post@tok () Term)
...
(declare-fun IMSTsub.st_wp (Term) Term)

(declare-fun IMSTsub.st_wp@tok () Term)
...
(declare-fun IMSTsub.st_return (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> s: Type -> rel: FStar.Preorder.preorder s -> post: st_post s a -> s0: s   -> Prims.logical
(declare-fun Tm_arrow_5bce34a18aac6065abcc6c04e84784a5 () Term)
(declare-fun IMSTsub.st_return@tok () Term)
...
;;;;;;;;;;;;;;;;_: a -> st_wp b
(declare-fun Tm_arrow_ef73e5e6a476174d331609d1482e2c2b (Term Term) Term)
(declare-fun IMSTsub.st_bind (Term Term Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     wp1: st_wp a ->     wp2: (_: a -> st_wp b) ->     s: Type ->     rel: FStar.Preorder.preorder s ->     post: st_post s b ->     s0: s   -> Type
(declare-fun Tm_arrow_f88cb42387f507f4f0dda75a11d9fa25 () Term)
(declare-fun IMSTsub.st_bind@tok () Term)
...
(declare-fun IMSTsub.st_if_then_else (Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     p: Type ->     wp_then: st_wp a ->     wp_else: st_wp a ->     s: Type ->     rel: FStar.Preorder.preorder s ->     post: st_post s a ->     s0: s   -> Prims.logical
(declare-fun Tm_arrow_dc776a18e30596a28ea60af7c0131b52 () Term)
(declare-fun IMSTsub.st_if_then_else@tok () Term)
...
(declare-fun IMSTsub.st_ite (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: st_wp a -> s: Type -> rel: FStar.Preorder.preorder s -> post: st_post s a -> s0: s   -> Prims.logical
(declare-fun Tm_arrow_56e9ae4b7b35ef7dc69214d043f577bc () Term)
(declare-fun IMSTsub.st_ite@tok () Term)
...
(declare-fun IMSTsub.st_stronger (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp1: st_wp a -> wp2: st_wp a -> Prims.logical
(declare-fun Tm_arrow_2d664da60968bd02b3e6e87f7113d48f () Term)
(declare-fun IMSTsub.st_stronger@tok () Term)
...
(declare-fun IMSTsub.st_close (Term Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     wp: (_: b -> Prims.GTot (st_wp a)) ->     s: Type ->     rel: FStar.Preorder.preorder s ->     p: st_post s a ->     s0: s   -> Prims.logical
(declare-fun Tm_arrow_870922eff878e0c959b4ab16e9863eec () Term)
(declare-fun IMSTsub.st_close@tok () Term)
...
(declare-fun IMSTsub.st_trivial (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: st_wp a -> Prims.logical
(declare-fun Tm_arrow_3788883d01d55b274984c53e7eb2e9de () Term)
(declare-fun IMSTsub.st_trivial@tok () Term)
...
(declare-fun IMSTsub.lift_div_imst (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     wp: Prims.pure_wp a ->     s: Type ->     rel: FStar.Preorder.preorder s ->     post: st_post s a ->     s0: s   -> Prims.pure_pre
(declare-fun Tm_arrow_ce6904f5b1babfdf74f183ecaaf5995b () Term)
(declare-fun IMSTsub.lift_div_imst@tok () Term)
...
(declare-fun IMSTsub.st_wp_ (Term Term) Term)

(declare-fun IMSTsub.st_wp_@tok () Term)
;;;;;;;;;;;;;;;;_: st_post s a -> st_pre s
(declare-fun Tm_arrow_6b133781f276c6a74707c7a6afed05a8 (Term Term) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMSTsub.st_wp'; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(97,4-97,10); use=IMSTsub.fst(97,4-97,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (IMSTsub.st_wp_ @x0
@x1)
Tm_type))
 

:pattern ((IMSTsub.st_wp_ @x0
@x1))
:qid typing_IMSTsub.st_wp_))

:named typing_IMSTsub.st_wp_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMSTsub.st_pre; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(30,4-30,10); use=IMSTsub.fst(30,4-30,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (IMSTsub.st_pre @x0)
Tm_type))
 

:pattern ((IMSTsub.st_pre @x0))
:qid typing_IMSTsub.st_pre))

:named typing_IMSTsub.st_pre))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMSTsub.st_post; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(32,4-32,11); use=IMSTsub.fst(32,4-32,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (IMSTsub.st_post @x0
@x1)
Tm_type))
 

:pattern ((IMSTsub.st_post @x0
@x1))
:qid typing_IMSTsub.st_post))

:named typing_IMSTsub.st_post))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6b133781f276c6a74707c7a6afed05a8
;;; Fact-ids: Name IMSTsub.st_wp'; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(98,4-98,33); use=IMSTsub.fst(98,4-98,33)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_6b133781f276c6a74707c7a6afed05a8 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_6b133781f276c6a74707c7a6afed05a8 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_6b133781f276c6a74707c7a6afed05a8))

:named kinding_Tm_arrow_6b133781f276c6a74707c7a6afed05a8))
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (IMSTsub.st_wp_ @x0
@x1)
(Tm_arrow_6b133781f276c6a74707c7a6afed05a8 @x0
@x1))
 

:pattern ((IMSTsub.st_wp_ @x0
@x1))
:qid equation_IMSTsub.st_wp_))

:named equation_IMSTsub.st_wp_))
;;;;;;;;;;;;;;;;Equation for IMSTsub.st_pre
;;; Fact-ids: Name IMSTsub.st_pre; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(30,4-30,10); use=IMSTsub.fst(30,4-30,10)
(forall ((@x0 Term))
...
:pattern ((IMSTsub.st_pre @x0))
:qid equation_IMSTsub.st_pre))

:named equation_IMSTsub.st_pre))
;;;;;;;;;;;;;;;;Equation for IMSTsub.st_post
;;; Fact-ids: Name IMSTsub.st_post; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(32,4-32,11); use=IMSTsub.fst(32,4-32,11)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((IMSTsub.st_post @x0
@x1))
:qid equation_IMSTsub.st_post))

:named equation_IMSTsub.st_post))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_6b133781f276c6a74707c7a6afed05a8 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_6b133781f276c6a74707c7a6afed05a8 @x2
@x3)))
:qid IMSTsub_pre_typing_Tm_arrow_6b133781f276c6a74707c7a6afed05a8))

:named IMSTsub_pre_typing_Tm_arrow_6b133781f276c6a74707c7a6afed05a8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_6b133781f276c6a74707c7a6afed05a8
;;; Fact-ids: Name IMSTsub.st_wp'; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(98,4-98,33); use=IMSTsub.fst(98,4-98,33)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_6b133781f276c6a74707c7a6afed05a8 @x1
@x2))
(and 
;; def=IMSTsub.fst(98,4-98,33); use=IMSTsub.fst(98,4-98,33)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid IMSTsub_interpretation_Tm_arrow_6b133781f276c6a74707c7a6afed05a8.1))
...
(Tm_arrow_6b133781f276c6a74707c7a6afed05a8 @x1
@x2)))
:qid IMSTsub_interpretation_Tm_arrow_6b133781f276c6a74707c7a6afed05a8))

:named IMSTsub_interpretation_Tm_arrow_6b133781f276c6a74707c7a6afed05a8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
; Starting query at IMSTsub.fst(103,4-103,87)
...
; Encoding query formula : forall (a: Type) (s: Type) (rel: FStar.Preorder.preorder s) (wp: IMSTsub.st_wp' a s).
;   (*  - Could not prove post-condition
; *)
;   forall (s': Type0)
;     (rel': FStar.Preorder.preorder s')
;     (post: FStar.Pervasives.st_post_h s' a)
;     (s0: s').
;     (*  - Could not prove post-condition
; *)
;     (s == s' ==>
...
;           (*  - Could not prove post-condition
; *)
;           forall (y: s'). Prims.has_type y s /\ (rel x y ==> Prims.has_type x s'))) /\
;     (s == s' /\ (forall (x: s) (y: s'). rel x y ==> rel' x y) ==>
;       (forall (_: a) (_: s). Prims.has_type _ s') /\
;       (forall (any_result: FStar.Pervasives.st_post_h s' a).
;           post == any_result ==> (forall (any_result: IMSTsub.st_pre s). Prims.has_type s0 s)))


; Context: While encoding a query
; While typechecking the top-level declaration `let idx`
...
;; def=dummy(0,0-0,0); use=IMSTsub.fst(103,4-103,87)
(forall ((@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x4
Tm_type)
(HasType @x5
(FStar.Preorder.preorder @x4))
(HasType @x6
(FStar.Pervasives.st_post_h @x4
@x0))
(HasType @x7
@x4))

;; def=Prims.fst(459,77-459,89); use=IMSTsub.fst(103,27-103,87)
(and (implies 
;; def=IMSTsub.fst(103,27-103,34); use=IMSTsub.fst(103,27-103,34)
(= @x1
@x4)


;; def=dummy(0,0-0,0); use=IMSTsub.fst(103,27-103,73)
(forall ((@x8 Term))
 (! (implies (HasType @x8
@x1)

;; def=dummy(0,0-0,0); use=IMSTsub.fst(103,48-103,72)
(forall ((@x9 Term))
 (! (implies (HasType @x9
@x4)

;; def=IMSTsub.fst(103,46-103,59); use=IMSTsub.fst(103,52-103,70)
(and 
;; def=IMSTsub.fst(103,48-103,49); use=IMSTsub.fst(103,58-103,59)
(or label_1
(HasType @x9
@x1))

(implies 
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(103,52-103,59)
(Valid 
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(103,52-103,59)
(ApplyTT (ApplyTT @x2
@x8)
...
;; def=IMSTsub.fst(103,46-103,47); use=IMSTsub.fst(103,69-103,70)
(or label_2
(HasType @x8
@x4))
))
...
(implies 
;; def=IMSTsub.fst(103,27-103,73); use=IMSTsub.fst(103,27-103,73)
(and 
;; def=IMSTsub.fst(103,27-103,34); use=IMSTsub.fst(103,27-103,34)
(= @x1
@x4)
...
;; def=IMSTsub.fst(103,38-103,73); use=IMSTsub.fst(103,38-103,73)
...
;; def=IMSTsub.fst(103,64-103,72); use=IMSTsub.fst(103,64-103,72)
(Valid 
;; def=IMSTsub.fst(103,64-103,72); use=IMSTsub.fst(103,64-103,72)
(ApplyTT (ApplyTT @x5
@x8)
...
;; def=Prims.fst(459,77-459,89); use=IMSTsub.fst(103,27-103,87)
(and 
;; def=dummy(0,0-0,0); use=IMSTsub.fst(103,80-103,84)
(forall ((@x8 Term) (@x9 Term))
 (! (implies (and (HasType @x8
@x0)
(HasType @x9
...
;; def=IMSTsub.fst(103,16-103,20); use=IMSTsub.fst(103,80-103,84)
(or label_3
(HasType @x9
@x4))
)
...
;; def=Prims.fst(451,66-451,102); use=IMSTsub.fst(103,27-103,87)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(FStar.Pervasives.st_post_h @x4
@x0))

;; def=dummy(0,0-0,0); use=IMSTsub.fst(103,27-103,87)
(= @x6
@x8)
)
...
;; def=IMSTsub.fst(103,21-103,23); use=IMSTsub.fst(103,85-103,87)
(or label_4
(HasType @x7
@x1))
)
...
; encoding sigelt let idx


; <Start encoding let idx>

(declare-fun IMSTsub.idx (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> rel: FStar.Preorder.preorder s -> wp: st_wp' a s -> st_wp a
(declare-fun Tm_arrow_55c55db2480eedb22e868908e3d5d43f () Term)
(declare-fun IMSTsub.idx@tok () Term)
...
(declare-fun Tm_abs_6105f34386b0e63ce9b81a40656f3377 (Term Term Term Term) Term)

; </end encoding let idx>


; encoding sigelt val IMSTsub.get


; <Start encoding val IMSTsub.get>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IMSTsub.get (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IMSTsub.get@tok () Term)

; </end encoding val IMSTsub.get>


; encoding sigelt val IMSTsub.put


; <Start encoding val IMSTsub.put>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IMSTsub.put (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IMSTsub.put@tok () Term)

; </end encoding val IMSTsub.put>
...
(declare-fun IMSTsub.witnessed (Term Term Term) Term)
;;;;;;;;;;;;;;;;p: FStar.Preorder.predicate s -> Type
(declare-fun Tm_arrow_43c2a786525533d46c4f0c73f49705dd () Term)
(declare-fun IMSTsub.witnessed@tok () Term)

; </end encoding let witnessed>


; encoding sigelt val IMSTsub.witness


; <Start encoding val IMSTsub.witness>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IMSTsub.witness (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IMSTsub.witness@tok () Term)

; </end encoding val IMSTsub.witness>


; encoding sigelt val IMSTsub.recall


; <Start encoding val IMSTsub.recall>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IMSTsub.recall (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IMSTsub.recall@tok () Term)

; </end encoding val IMSTsub.recall>
...
(declare-fun IMSTsub.nat_rel_ (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMSTsub.nat_rel'; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(124,4-124,12); use=IMSTsub.fst(124,4-124,12)
(forall ((@u0 Dummy_sort))
 (! (HasType (IMSTsub.nat_rel_ @u0)
(FStar.Preorder.relation Prims.nat))
 

:pattern ((IMSTsub.nat_rel_ @u0))
:qid typing_IMSTsub.nat_rel_))

:named typing_IMSTsub.nat_rel_))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;Equation for IMSTsub.nat_rel'
;;; Fact-ids: Name IMSTsub.nat_rel'; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(124,4-124,12); use=IMSTsub.fst(124,4-124,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT (IMSTsub.nat_rel_ Dummy_value)
@x0)
@x1)
...
:pattern ((ApplyTT (ApplyTT (IMSTsub.nat_rel_ Dummy_value)
@x0)
@x1))
:qid equation_IMSTsub.nat_rel_))

:named equation_IMSTsub.nat_rel_))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
; Starting query at IMSTsub.fst(127,0-127,37)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (FStar.Preorder.preorder_rel IMSTsub.nat_rel')
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Preorder.fst(33,40-33,56); use=IMSTsub.fst(127,29-127,37)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IMSTsub.nat_rel, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, b2t_def, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_IMSTsub.nat_rel_, equation_Prims.nat, primitive_Prims.op_LessThanOrEqual, projection_inverse_BoxBool_proj_0
...
(declare-fun IMSTsub.nat_rel (Dummy_sort) Term)

; </end encoding let nat_rel>

(push) ;; push{2

; Starting query at IMSTsub.fst(130,15-130,20)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (i: Prims.nat) (j: Prims.nat). (*  - Could not prove post-condition
; *) Prims.hasEq Prims.nat


; Context: While encoding a query
; While typechecking the top-level declaration `let eq_rel'`
...
;; def=Prims.fst(73,23-73,30); use=IMSTsub.fst(130,15-130,16)
(or label_1
...
; encoding sigelt let eq_rel'


; <Start encoding let eq_rel'>

(declare-fun IMSTsub.eq_rel_ (Dummy_sort) Term)

; </end encoding let eq_rel'>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMSTsub.eq_rel'; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(129,4-129,11); use=IMSTsub.fst(129,4-129,11)
(forall ((@u0 Dummy_sort))
 (! (HasType (IMSTsub.eq_rel_ @u0)
(FStar.Preorder.relation Prims.nat))
 

:pattern ((IMSTsub.eq_rel_ @u0))
:qid typing_IMSTsub.eq_rel_))

:named typing_IMSTsub.eq_rel_))
...
;;;;;;;;;;;;;;;;Equation for IMSTsub.eq_rel'
;;; Fact-ids: Name IMSTsub.eq_rel'; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(129,4-129,11); use=IMSTsub.fst(129,4-129,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT (IMSTsub.eq_rel_ Dummy_value)
@x0)
@x1)
...
:pattern ((ApplyTT (ApplyTT (IMSTsub.eq_rel_ Dummy_value)
@x0)
@x1))
:qid equation_IMSTsub.eq_rel_))

:named equation_IMSTsub.eq_rel_))
(push) ;; push{2

; Starting query at IMSTsub.fst(132,0-132,35)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.auto_squash (FStar.Preorder.preorder_rel IMSTsub.eq_rel')
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Preorder.fst(33,40-33,56); use=IMSTsub.fst(132,28-132,35)
(or label_1
...
; QUERY ID: (IMSTsub.eq_rel, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, b2t_def, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_FStar.Preorder.transitive, equation_IMSTsub.eq_rel_, equation_Prims.nat, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0
...
(declare-fun IMSTsub.eq_rel (Dummy_sort) Term)
...
;;; Fact-ids: Name IMSTsub.nat_rel; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(127,4-127,11); use=IMSTsub.fst(127,4-127,11)
(forall ((@u0 Dummy_sort))
 (! (HasType (IMSTsub.nat_rel @u0)
(FStar.Preorder.preorder Prims.nat))
 

:pattern ((IMSTsub.nat_rel @u0))
:qid typing_IMSTsub.nat_rel))

:named typing_IMSTsub.nat_rel))
;;;;;;;;;;;;;;;;Equation for IMSTsub.nat_rel
;;; Fact-ids: Name IMSTsub.nat_rel; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(127,4-127,11); use=IMSTsub.fst(127,4-127,11)
...
:qid equation_IMSTsub.nat_rel))

:named equation_IMSTsub.nat_rel))
(push) ;; push{2

; Starting query at IMSTsub.fst(138,4-138,6)
...
;   (*  - Could not prove post-condition
; *)
;   forall (s: Type0) (rel: FStar.Preorder.preorder s) (p: IMSTsub.st_post s Prims.unit) (s0: s).
;     Prims.nat == s /\ (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\ p () s0 ==>
;     (forall (any_result: Prims.unit). p any_result s0)
...
;; def=IMSTsub.fst(60,4-61,39); use=IMSTsub.fst(80,22-80,33)
...
;; def=IMSTsub.fst(103,27-103,34); use=IMSTsub.fst(137,15-137,18)
(= Prims.nat
@x1)


;; def=IMSTsub.fst(103,38-103,73); use=IMSTsub.fst(137,15-137,18)
...
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(137,15-137,18)
(Valid 
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(137,15-137,18)
(ApplyTT (ApplyTT (IMSTsub.nat_rel Dummy_value)
@x5)
@x6)
)
)

;; def=IMSTsub.fst(103,64-103,72); use=IMSTsub.fst(137,15-137,18)
(Valid 
;; def=IMSTsub.fst(103,64-103,72); use=IMSTsub.fst(137,15-137,18)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=IMSTsub.fst(137,44-137,51); use=IMSTsub.fst(138,4-138,6)
(Valid 
;; def=IMSTsub.fst(137,44-137,51); use=IMSTsub.fst(138,4-138,6)
(ApplyTT (ApplyTT @x3
Tm_unit)
...
;; def=IMSTsub.fst(91,17-91,26); use=IMSTsub.fst(138,4-138,6)
(or label_1

;; def=IMSTsub.fst(91,17-91,26); use=IMSTsub.fst(92,25-92,38)
(Valid 
;; def=IMSTsub.fst(91,17-91,26); use=IMSTsub.fst(92,25-92,38)
(ApplyTT (ApplyTT @x3
@x5)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IMSTsub.f (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IMSTsub.f@tok () Term)

; </end encoding let f>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMSTsub.witnessed; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(112,4-112,13); use=IMSTsub.fst(112,4-112,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType (IMSTsub.witnessed @x0
@x1
@x2)
Tm_type))
 

:pattern ((IMSTsub.witnessed @x0
@x1
@x2))
:qid typing_IMSTsub.witnessed))

:named typing_IMSTsub.witnessed))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IMSTsub.eq_rel; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(132,4-132,10); use=IMSTsub.fst(132,4-132,10)
(forall ((@u0 Dummy_sort))
 (! (HasType (IMSTsub.eq_rel @u0)
(FStar.Preorder.preorder Prims.nat))
 

:pattern ((IMSTsub.eq_rel @u0))
:qid typing_IMSTsub.eq_rel))

:named typing_IMSTsub.eq_rel))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Equation for IMSTsub.witnessed
;;; Fact-ids: Name IMSTsub.witnessed; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(112,4-112,13); use=IMSTsub.fst(112,4-112,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (IMSTsub.witnessed @x0
@x1
@x2)
...
@x1
@x2))
:qid equation_IMSTsub.witnessed))

:named equation_IMSTsub.witnessed))
;;;;;;;;;;;;;;;;Equation for IMSTsub.eq_rel
;;; Fact-ids: Name IMSTsub.eq_rel; Namespace IMSTsub
(assert (! 
;; def=IMSTsub.fst(132,4-132,10); use=IMSTsub.fst(132,4-132,10)
...
:qid equation_IMSTsub.eq_rel))

:named equation_IMSTsub.eq_rel))
...
; Starting query at IMSTsub.fst(142,3-160,6)
...
;;; Fact-ids: 
(assert (! 
;; def=IMSTsub.fst(146,13-146,16); use=IMSTsub.fst(146,4-146,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid IMSTsub_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named IMSTsub_pre_typing_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
...
:pattern ((ApplyTT @x0
@x1))
:qid IMSTsub_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
:qid IMSTsub_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))

:named IMSTsub_interpretation_Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e))
...
;;; Fact-ids: 
(assert (! 
;; def=IMSTsub.fst(146,36-146,41); use=IMSTsub.fst(146,4-146,11)
(forall ((@x0 Term))
...
(declare-fun Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6
;;; Fact-ids: 
(assert (! 
;; def=IMSTsub.fst(151,35-151,41); use=IMSTsub.fst(151,4-151,11)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6 @x0)
Tm_arrow_9974df5c311cfcfa7100bc7bef095e1e)
 

:pattern ((Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6 @x0))
:qid typing_Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6))

:named typing_Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6
;;; Fact-ids: 
(assert (! 
;; def=IMSTsub.fst(151,35-151,41); use=IMSTsub.fst(151,4-151,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6 @x1)
@x0)
(Prims.b2t (Prims.op_Equality Prims.nat
@x0
(Prims.op_Multiply (Prims.op_Addition @x1
(BoxInt 1))
(BoxInt 42)))))
 

:pattern ((ApplyTT (Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6 @x1)
@x0))
:qid interpretation_Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6))

:named interpretation_Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6))
...
;   (*  - Could not prove post-condition
; *)
;   forall (s: Type0) (rel: FStar.Preorder.preorder s) (p: IMSTsub.st_post s Prims.nat) (s0: s).
;     Prims.nat == s /\ (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\
...
;         return_val == s0 + 1 ==>
;         Prims.nat == s /\ (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\
;         IMSTsub.nat_rel s0 (s0 + 1) /\
;         ((Prims.nat == s) /\ (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\
;         ((s0 + 1 > 0) /\
;         (forall (pure_result: Prims.unit).
;             s0 + 1 > 0 ==>
;             Prims.nat == s /\ (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\
;             FStar.Preorder.stable (fun n -> n > 0) IMSTsub.nat_rel /\ (s0 + 1 > 0) /\
;             (IMSTsub.witnessed (fun n -> n > 0) ==>
;               (s0 + 1) * 42 >= 0 /\
;               (forall (return_val: Prims.nat).
;                   return_val == (s0 + 1) * 42 ==>
;                   Prims.nat == s /\ (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\
;                   IMSTsub.nat_rel (s0 + 1) ((s0 + 1) * 42) /\
;                   ((Prims.nat == s) /\
;                   (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\
;                   (FStar.Preorder.stable (fun n -> n > 0) IMSTsub.nat_rel /\
;                   IMSTsub.witnessed (fun n -> n > 0) /\
;                   ((s0 + 1) * 42 > 0 ==>
;                     Prims.nat == s /\
;                     (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\
...
;                             (*  - Could not prove post-condition
; *) Prims.hasEq Prims.nat) /\
;                         (forall (any_result: FStar.Preorder.predicate Prims.nat).
;                             (fun n -> n = (s0 + 1) * 42) == any_result ==>
;                             Prims.nat == s /\
;                             (forall (x: Prims.nat) (y: s). IMSTsub.eq_rel x y ==> rel x y) /\
;                             FStar.Preorder.stable (fun n -> n = (s0 + 1) * 42) IMSTsub.eq_rel /\
;                             (IMSTsub.witnessed (fun n -> n = (s0 + 1) * 42) ==>
;                               (s0 + 1) * 43 >= 0 /\
;                               (forall (return_val: Prims.nat).
;                                   return_val == (s0 + 1) * 43 ==>
;                                   Prims.nat == s /\
;                                   (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\
;                                   IMSTsub.nat_rel ((s0 + 1) * 42) ((s0 + 1) * 43) /\
;                                   ((forall (n: Prims.nat).
;                                       (*  - Could not prove post-condition
; *) Prims.hasEq Prims.nat) /\
;                                   (forall (any_result: FStar.Preorder.predicate Prims.nat).
...
;                                       Prims.nat == s /\
;                                       (forall (x: Prims.nat) (y: s). IMSTsub.eq_rel x y ==> rel x y) /\
;                                       FStar.Preorder.stable (fun n -> n = (s0 + 1) * 42)
;                                         IMSTsub.eq_rel /\
;                                       IMSTsub.witnessed (fun n -> n = (s0 + 1) * 42) /\
;                                       ((s0 + 1) * 43 = (s0 + 1) * 42 ==>
;                                         Prims.nat == s /\
;                                         (forall (x: Prims.nat) (y: s).
;                                             IMSTsub.nat_rel x y ==> rel x y) /\
;                                         (s0 + 1 > 0) /\
;                                         (forall (pure_result: Prims.unit).
;                                             s0 + 1 > 0 ==>
;                                             (forall (pure_result: Prims.unit)
...
;; def=IMSTsub.fst(103,27-103,34); use=IMSTsub.fst(141,14-141,17)
(= Prims.nat
@x1)


;; def=IMSTsub.fst(103,38-103,73); use=IMSTsub.fst(141,14-141,17)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.nat)
(HasType @x6
...
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(141,14-141,17)
(Valid 
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(141,14-141,17)
(ApplyTT (ApplyTT (IMSTsub.nat_rel Dummy_value)
@x5)
...
;; def=IMSTsub.fst(103,64-103,72); use=IMSTsub.fst(141,14-141,17)
(Valid 
;; def=IMSTsub.fst(103,64-103,72); use=IMSTsub.fst(141,14-141,17)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=IMSTsub.fst(141,43-141,75); use=IMSTsub.fst(142,3-160,6)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Tm_refine_542f9d4f129664613f2483a6c88bc7c2)

;; def=IMSTsub.fst(141,55-141,62); use=IMSTsub.fst(142,3-160,6)
(> (BoxInt_proj_0 @x5)
(BoxInt_proj_0 @x4))
)

;; def=IMSTsub.fst(141,68-141,75); use=IMSTsub.fst(142,3-160,6)
(Valid 
;; def=IMSTsub.fst(141,68-141,75); use=IMSTsub.fst(142,3-160,6)
(ApplyTT (ApplyTT @x3
@x4)
...
;; def=IMSTsub.fst(103,27-103,87); use=IMSTsub.fst(142,3-160,6)
(and 
;; def=IMSTsub.fst(103,27-103,34); use=IMSTsub.fst(142,3-160,6)
(or label_1
...
;; def=IMSTsub.fst(103,38-103,73); use=IMSTsub.fst(142,3-160,6)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.nat)
(HasType @x6
...
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(142,3-160,6)
(Valid 
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(142,3-160,6)
(ApplyTT (ApplyTT (IMSTsub.nat_rel Dummy_value)
@x5)
...
;; def=IMSTsub.fst(103,64-103,72); use=IMSTsub.fst(142,3-160,6)
(or label_2
...
;; def=Prims.fst(680,18-680,24); use=IMSTsub.fst(143,22-143,30)
(or label_3
...
;; def=Prims.fst(356,2-356,58); use=IMSTsub.fst(142,3-160,6)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=IMSTsub.fst(142,3-160,6)
(= @x5
...
;; def=IMSTsub.fst(110,87-110,96); use=IMSTsub.fst(143,4-143,7)
(or label_6
...
;; def=IMSTsub.fst(145,11-145,19); use=IMSTsub.fst(145,4-145,10)
(or label_9
...
;; def=Prims.fst(441,36-441,97); use=IMSTsub.fst(145,4-145,10)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)
...
;; def=IMSTsub.fst(115,38-115,50); use=IMSTsub.fst(146,4-146,11)
(or label_12
...
(implies 
;; def=IMSTsub.fst(115,63-115,82); use=IMSTsub.fst(146,4-146,11)
(Valid 
;; def=IMSTsub.fst(115,63-115,82); use=IMSTsub.fst(146,4-146,11)
(IMSTsub.witnessed Prims.nat
(IMSTsub.nat_rel Dummy_value)
Tm_abs_05f6ce5958841550e0655050d1696a3a)
)


;; def=Prims.fst(459,77-459,89); use=IMSTsub.fst(142,3-160,6)
(and 
;; def=Prims.fst(680,18-680,24); use=IMSTsub.fst(147,22-147,31)
(or label_14
...
;; def=IMSTsub.fst(110,87-110,96); use=IMSTsub.fst(147,4-147,7)
(or label_17
...
;; def=IMSTsub.fst(118,38-118,50); use=IMSTsub.fst(148,4-148,10)
(or label_20
...
;; def=IMSTsub.fst(118,54-118,73); use=IMSTsub.fst(148,4-148,10)
(or label_21
...
(implies 
;; def=IMSTsub.fst(148,35-148,40); use=IMSTsub.fst(148,4-148,10)
(> (BoxInt_proj_0 (Prims.op_Multiply (Prims.op_Addition @x4
(BoxInt 1))
(BoxInt 42)))
(BoxInt_proj_0 (BoxInt 0)))
...
;; def=IMSTsub.fst(150,11-150,19); use=IMSTsub.fst(150,4-150,10)
(or label_24
...
;; def=Prims.fst(441,36-441,97); use=IMSTsub.fst(150,4-150,10)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)
...
;; def=Prims.fst(459,77-459,89); use=IMSTsub.fst(142,3-160,6)
(and 
;; def=dummy(0,0-0,0); use=IMSTsub.fst(142,3-160,6)
(forall ((@x9 Term))
 (! (implies (HasType @x9
Prims.nat)

;; def=Prims.fst(73,23-73,30); use=IMSTsub.fst(151,35-151,36)
(or label_25
...
;; def=Prims.fst(451,66-451,102); use=IMSTsub.fst(142,3-160,6)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(FStar.Preorder.predicate Prims.nat))

;; def=IMSTsub.fst(114,48-151,41); use=IMSTsub.fst(142,3-160,6)
(= (Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6 @x4)
@x9)
)
...
(Valid 
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(142,3-160,6)
(ApplyTT (ApplyTT (IMSTsub.eq_rel Dummy_value)
@x10)
@x11)
)
)
...
;; def=IMSTsub.fst(115,38-115,50); use=IMSTsub.fst(151,4-151,11)
(or label_28
...
(FStar.Preorder.stable Prims.nat
(Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6 @x4)
(IMSTsub.eq_rel Dummy_value))
)
)

(implies 
;; def=IMSTsub.fst(115,63-115,82); use=IMSTsub.fst(151,4-151,11)
(Valid 
;; def=IMSTsub.fst(115,63-115,82); use=IMSTsub.fst(151,4-151,11)
(IMSTsub.witnessed Prims.nat
(IMSTsub.eq_rel Dummy_value)
...
;; def=Prims.fst(459,77-459,89); use=IMSTsub.fst(142,3-160,6)
(and 
;; def=Prims.fst(680,18-680,24); use=IMSTsub.fst(152,22-152,31)
(or label_29
...
;; def=IMSTsub.fst(110,87-110,96); use=IMSTsub.fst(152,4-152,7)
(or label_32
...
;; def=Prims.fst(73,23-73,30); use=IMSTsub.fst(153,34-153,35)
(or label_33
...
;; def=IMSTsub.fst(117,47-153,40); use=IMSTsub.fst(142,3-160,6)
(= (Tm_abs_51845e820d2f8cf7519520f3fb3ba4f6 @x4)
@x11)
)
...
;; def=IMSTsub.fst(118,38-118,50); use=IMSTsub.fst(153,4-153,10)
(or label_36
...
;; def=IMSTsub.fst(118,54-118,73); use=IMSTsub.fst(153,4-153,10)
(or label_37
...
(implies 
;; def=IMSTsub.fst(153,34-153,40); use=IMSTsub.fst(153,4-153,10)
(= (Prims.op_Multiply (Prims.op_Addition @x4
(BoxInt 1))
(BoxInt 43))
(Prims.op_Multiply (Prims.op_Addition @x4
...
;; def=IMSTsub.fst(155,11-155,19); use=IMSTsub.fst(155,4-155,10)
(or label_40
...
;; def=Prims.fst(441,36-441,97); use=IMSTsub.fst(155,4-155,10)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
Prims.unit)
...
;; def=Prims.fst(441,36-441,97); use=IMSTsub.fst(156,4-156,10)
(forall ((@x13 Term))
 (! (implies (HasType @x13
Prims.unit)

;; def=Prims.fst(441,36-441,97); use=IMSTsub.fst(157,4-157,10)
(forall ((@x14 Term))
 (! (implies (HasType @x14
Prims.unit)
...
;; def=Prims.fst(459,77-459,89); use=IMSTsub.fst(142,3-160,6)
(and 
;; def=Prims.fst(73,23-73,30); use=IMSTsub.fst(158,17-158,19)
(or label_41
...
;; def=Prims.fst(588,31-588,32); use=IMSTsub.fst(142,3-160,6)
(= Prims.nat
@x15)
)
...
;; def=Prims.fst(180,10-180,11); use=IMSTsub.fst(142,3-160,6)
...
;; def=Prims.fst(672,13-672,14); use=IMSTsub.fst(142,3-160,6)
(= (Prims.b2t (Prims.op_Equality Prims.nat
(Prims.op_Multiply (Prims.op_Addition @x4
(BoxInt 1))
(BoxInt 43))
...
;; def=Prims.fst(441,29-441,97); use=IMSTsub.fst(158,4-158,10)
(and 
;; def=IMSTsub.fst(158,11-158,20); use=IMSTsub.fst(158,4-158,10)
(or label_42
...
;; def=Prims.fst(441,36-441,97); use=IMSTsub.fst(158,4-158,10)
(forall ((@x18 Term))
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IMSTsub.g (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IMSTsub.g@tok () Term)

; </end encoding let g>

(push) ;; push{2

; Starting query at IMSTsub.fst(164,3-168,6)
...
;   forall (s: Type0) (rel: FStar.Preorder.preorder s) (p: IMSTsub.st_post s Prims.nat) (s0: s).
;     Prims.nat == s /\ (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\
;     (forall (s1: i: Prims.int{i >= 0}). s1 > s0 ==> p s1 s1) ==>
;     Prims.nat == s /\ (forall (x: Prims.nat) (y: s). IMSTsub.eq_rel x y ==> rel x y) /\
;     (Prims.nat == s) /\ (forall (x: Prims.nat) (y: s). IMSTsub.eq_rel x y ==> rel x y) /\
;     (IMSTsub.eq_rel s0 s0 /\
;     ((s0 + 1 >= 0) /\
;     (forall (return_val: Prims.nat).
;         return_val == s0 + 1 ==>
;         Prims.nat == s /\ (forall (x: Prims.nat) (y: s). IMSTsub.nat_rel x y ==> rel x y) /\
;         IMSTsub.nat_rel s0 (s0 + 1) /\
;         ((Prims.nat == s) /\ (forall (x: Prims.nat) (y: s). IMSTsub.eq_rel x y ==> rel x y) /\
;         (forall (v: Prims.nat). v == s0 + 1 ==> p v (s0 + 1))))))
...
;; def=IMSTsub.fst(103,27-103,34); use=IMSTsub.fst(163,14-163,17)
(= Prims.nat
@x1)


;; def=IMSTsub.fst(103,38-103,73); use=IMSTsub.fst(163,14-163,17)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.nat)
(HasType @x6
...
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(163,14-163,17)
(Valid 
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(163,14-163,17)
(ApplyTT (ApplyTT (IMSTsub.nat_rel Dummy_value)
@x5)
...
;; def=IMSTsub.fst(103,64-103,72); use=IMSTsub.fst(163,14-163,17)
(Valid 
;; def=IMSTsub.fst(103,64-103,72); use=IMSTsub.fst(163,14-163,17)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=IMSTsub.fst(163,43-163,74); use=IMSTsub.fst(164,3-168,6)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Tm_refine_542f9d4f129664613f2483a6c88bc7c2)

;; def=IMSTsub.fst(163,55-163,62); use=IMSTsub.fst(164,3-168,6)
(> (BoxInt_proj_0 @x5)
(BoxInt_proj_0 @x4))
)

;; def=IMSTsub.fst(163,67-163,74); use=IMSTsub.fst(164,3-168,6)
(Valid 
;; def=IMSTsub.fst(163,67-163,74); use=IMSTsub.fst(164,3-168,6)
(ApplyTT (ApplyTT @x3
@x5)
...
;; def=IMSTsub.fst(103,27-103,87); use=IMSTsub.fst(164,3-168,6)
(and 
;; def=IMSTsub.fst(103,27-103,34); use=IMSTsub.fst(164,3-168,6)
(or label_1
...
;; def=IMSTsub.fst(103,38-103,73); use=IMSTsub.fst(164,3-168,6)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.nat)
(HasType @x6
...
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(164,3-168,6)
(Valid 
;; def=IMSTsub.fst(103,52-103,59); use=IMSTsub.fst(164,3-168,6)
(ApplyTT (ApplyTT (IMSTsub.eq_rel Dummy_value)
@x5)
...
;; def=IMSTsub.fst(103,64-103,72); use=IMSTsub.fst(164,3-168,6)
(or label_2
...
;; def=IMSTsub.fst(110,87-110,96); use=IMSTsub.fst(165,4-165,7)
(or label_5
...
;; def=Prims.fst(680,18-680,24); use=IMSTsub.fst(166,22-166,30)
(or label_6
...
;; def=Prims.fst(356,2-356,58); use=IMSTsub.fst(164,3-168,6)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=IMSTsub.fst(164,3-168,6)
(= @x5
(Prims.op_Addition @x4
(BoxInt 1)))
)
...
;; def=IMSTsub.fst(110,87-110,96); use=IMSTsub.fst(166,4-166,7)
(or label_9
...
;; def=IMSTsub.fst(38,4-38,34); use=IMSTsub.fst(164,3-168,6)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=IMSTsub.fst(38,14-38,20); use=IMSTsub.fst(164,3-168,6)
(= @x6
(Prims.op_Addition @x4
(BoxInt 1)))
)

;; def=IMSTsub.fst(38,25-38,34); use=IMSTsub.fst(164,3-168,6)
(or label_12
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IMSTsub.h, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, b2t_def, equation_FStar.Preorder.preorder, equation_FStar.Preorder.preorder_rel, equation_FStar.Preorder.reflexive, equation_IMSTsub.eq_rel, equation_IMSTsub.eq_rel_, equation_IMSTsub.nat_rel, equation_IMSTsub.nat_rel_, equation_Prims.nat, int_inversion, primitive_Prims.op_Addition, primitive_Prims.op_Equality, primitive_Prims.op_LessThanOrEqual, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_bd10f09297e0e7dc08314f7d9211801c
