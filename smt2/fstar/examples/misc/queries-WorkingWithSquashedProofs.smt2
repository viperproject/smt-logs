...
; Internals for WorkingWithSquashedProofs


; encoding sigelt val WorkingWithSquashedProofs.foo


; <Start encoding val WorkingWithSquashedProofs.foo>

(declare-fun WorkingWithSquashedProofs.foo (Term Term) Term)

(declare-fun WorkingWithSquashedProofs.foo@tok () Term)

; </end encoding val WorkingWithSquashedProofs.foo>


; encoding sigelt val WorkingWithSquashedProofs.bar


; <Start encoding val WorkingWithSquashedProofs.bar>

(declare-fun WorkingWithSquashedProofs.bar (Term Term) Term)

(declare-fun WorkingWithSquashedProofs.bar@tok () Term)

; </end encoding val WorkingWithSquashedProofs.bar>


; encoding sigelt val WorkingWithSquashedProofs.foo_pf_implies_bar


; <Start encoding val WorkingWithSquashedProofs.foo_pf_implies_bar>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun WorkingWithSquashedProofs.foo_pf_implies_bar (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun WorkingWithSquashedProofs.foo_pf_implies_bar@tok () Term)

; </end encoding val WorkingWithSquashedProofs.foo_pf_implies_bar>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name WorkingWithSquashedProofs.foo; Namespace WorkingWithSquashedProofs
(assert (! 
;; def=WorkingWithSquashedProofs.fst(28,4-28,7); use=WorkingWithSquashedProofs.fst(28,4-28,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
@x0))
(HasType (WorkingWithSquashedProofs.foo @x0
@x1)
Tm_type))
 

:pattern ((WorkingWithSquashedProofs.foo @x0
@x1))
:qid typing_WorkingWithSquashedProofs.foo))

:named typing_WorkingWithSquashedProofs.foo))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name WorkingWithSquashedProofs.bar; Namespace WorkingWithSquashedProofs
(assert (! 
;; def=WorkingWithSquashedProofs.fst(30,4-30,7); use=WorkingWithSquashedProofs.fst(30,4-30,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
@x0))
(HasType (WorkingWithSquashedProofs.bar @x0
@x1)
Tm_type))
 

:pattern ((WorkingWithSquashedProofs.bar @x0
@x1))
:qid typing_WorkingWithSquashedProofs.bar))

:named typing_WorkingWithSquashedProofs.bar))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
; Starting query at WorkingWithSquashedProofs.fst(45,3-46,77)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_460b166284656e401cd2507f30d7a622 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(43,29-43,43); use=WorkingWithSquashedProofs.fst(43,29-43,43)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_460b166284656e401cd2507f30d7a622 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_460b166284656e401cd2507f30d7a622 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_460b166284656e401cd2507f30d7a622))

:named refinement_kinding_Tm_refine_460b166284656e401cd2507f30d7a622))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(43,29-43,43); use=WorkingWithSquashedProofs.fst(43,29-43,43)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_460b166284656e401cd2507f30d7a622 @x2))
(and (HasTypeFuel @u0
@x1
@x2)

;; def=WorkingWithSquashedProofs.fst(43,34-43,41); use=WorkingWithSquashedProofs.fst(43,34-43,41)
(Valid 
;; def=WorkingWithSquashedProofs.fst(43,34-43,41); use=WorkingWithSquashedProofs.fst(43,34-43,41)
(WorkingWithSquashedProofs.foo @x2
@x1)
)
))
...
@x1
(Tm_refine_460b166284656e401cd2507f30d7a622 @x2)))
:qid refinement_interpretation_Tm_refine_460b166284656e401cd2507f30d7a622))

:named refinement_interpretation_Tm_refine_460b166284656e401cd2507f30d7a622))
;;;;;;;;;;;;;;;;haseq for Tm_refine_460b166284656e401cd2507f30d7a622
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(43,29-43,43); use=WorkingWithSquashedProofs.fst(43,29-43,43)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_460b166284656e401cd2507f30d7a622 @x0)))
(Valid (Prims.hasEq @x0)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_460b166284656e401cd2507f30d7a622 @x0))))
:qid haseqTm_refine_460b166284656e401cd2507f30d7a622))

:named haseqTm_refine_460b166284656e401cd2507f30d7a622))
;;;;;;;;;;;;;;;;_: foo a x -> Prims.GTot (Prims.squash (bar a x))
(declare-fun Tm_arrow_94a83516fcd4f13f48566bc6b6811707 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_94a83516fcd4f13f48566bc6b6811707
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(46,30-46,39); use=WorkingWithSquashedProofs.fst(46,17-46,28)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_94a83516fcd4f13f48566bc6b6811707 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_94a83516fcd4f13f48566bc6b6811707 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_94a83516fcd4f13f48566bc6b6811707))

:named kinding_Tm_arrow_94a83516fcd4f13f48566bc6b6811707))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(46,30-46,39); use=WorkingWithSquashedProofs.fst(46,17-46,28)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_94a83516fcd4f13f48566bc6b6811707 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_94a83516fcd4f13f48566bc6b6811707 @x2
@x3)))
:qid WorkingWithSquashedProofs_pre_typing_Tm_arrow_94a83516fcd4f13f48566bc6b6811707))

:named WorkingWithSquashedProofs_pre_typing_Tm_arrow_94a83516fcd4f13f48566bc6b6811707))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_94a83516fcd4f13f48566bc6b6811707
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(46,30-46,39); use=WorkingWithSquashedProofs.fst(46,17-46,28)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_94a83516fcd4f13f48566bc6b6811707 @x1
@x2))
(and 
;; def=WorkingWithSquashedProofs.fst(46,30-46,39); use=WorkingWithSquashedProofs.fst(46,17-46,28)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(Prims.squash (WorkingWithSquashedProofs.bar @x2
@x1))))
 

:pattern ((ApplyTT @x0
@x3))
:qid WorkingWithSquashedProofs_interpretation_Tm_arrow_94a83516fcd4f13f48566bc6b6811707.1))
...
(Tm_arrow_94a83516fcd4f13f48566bc6b6811707 @x1
@x2)))
:qid WorkingWithSquashedProofs_interpretation_Tm_arrow_94a83516fcd4f13f48566bc6b6811707))

:named WorkingWithSquashedProofs_interpretation_Tm_arrow_94a83516fcd4f13f48566bc6b6811707))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
WorkingWithSquashedProofs.foo_pf_implies_bar@tok))
:named @kick_partial_app_59a53dc821aedcc6f82e8216f9368a63))

; Encoding query formula : forall (a: Type) (x: a{WorkingWithSquashedProofs.foo a x}).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). WorkingWithSquashedProofs.bar a x ==> p pure_result) ==>
;     Prims.auto_squash (WorkingWithSquashedProofs.foo a x) /\
;     (forall (any_result: Prims.unit) (b: Prims.squash (WorkingWithSquashedProofs.foo a x)).
;         (forall (pf: WorkingWithSquashedProofs.foo a x) (_: Prims.unit).
;             Prims.auto_squash (WorkingWithSquashedProofs.bar a x)) /\
;         (forall (return_val:
;             (_: WorkingWithSquashedProofs.foo a x
;                 -> Prims.GTot (Prims.squash (WorkingWithSquashedProofs.bar a x)))).
;             return_val == WorkingWithSquashedProofs.foo_pf_implies_bar a x ==>
;             (forall (any_result: Prims.squash (WorkingWithSquashedProofs.bar a x))
;                 (any_result: Prims.squash (WorkingWithSquashedProofs.bar a x)).
;                 p any_result)))


; Context: While encoding a query
; While typechecking the top-level declaration `let foo_implies_bar`
; While typechecking the top-level declaration `[@@expect_failure] let foo_implies_bar`
...
Tm_type)
(HasType @x1
(Tm_refine_460b166284656e401cd2507f30d7a622 @x0)))
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=WorkingWithSquashedProofs.fst(44,10-44,19); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(or label_2

;; def=WorkingWithSquashedProofs.fst(44,10-44,19); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(Valid 
;; def=WorkingWithSquashedProofs.fst(44,10-44,19); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(WorkingWithSquashedProofs.bar @x0
@x1)
)
)
)

;; def=Prims.fst(441,83-441,96); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(Valid 
;; def=Prims.fst(441,83-441,96); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(459,77-459,89); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(and 
;; def=WorkingWithSquashedProofs.fst(45,19-45,28); use=WorkingWithSquashedProofs.fst(45,31-45,33)
(or label_3

;; def=WorkingWithSquashedProofs.fst(45,19-45,28); use=WorkingWithSquashedProofs.fst(45,31-45,33)
(Valid 
;; def=WorkingWithSquashedProofs.fst(45,19-45,28); use=WorkingWithSquashedProofs.fst(45,31-45,33)
(WorkingWithSquashedProofs.foo @x0
@x1)
)
)


;; def=Prims.fst(451,66-451,102); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=Prims.fst(413,99-413,120); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Prims.squash (WorkingWithSquashedProofs.foo @x0
@x1)))

;; def=Prims.fst(459,77-459,89); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(and 
;; def=dummy(0,0-0,0); use=WorkingWithSquashedProofs.fst(46,53-46,77)
...
;; def=WorkingWithSquashedProofs.fst(46,41-46,50); use=WorkingWithSquashedProofs.fst(46,53-46,77)
(or label_4
...
;; def=Prims.fst(356,2-356,58); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Tm_arrow_94a83516fcd4f13f48566bc6b6811707 @x1
@x0))

;; def=Prims.fst(356,26-356,41); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(= @x5
(ApplyTT (ApplyTT WorkingWithSquashedProofs.foo_pf_implies_bar@tok
@x0)
@x1))
)
...
(forall ((@x6 Term))
 (! (implies (HasType @x6
(Prims.squash (WorkingWithSquashedProofs.bar @x0
@x1)))
...
;; def=Prims.fst(451,90-451,102); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(Valid 
;; def=Prims.fst(451,90-451,102); use=WorkingWithSquashedProofs.fst(45,3-46,77)
(ApplyTT @x2
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (WorkingWithSquashedProofs.foo_implies_bar, 1)
...
; Starting query at WorkingWithSquashedProofs.fst(51,4-51,9)
...
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(49,39-49,46); use=WorkingWithSquashedProofs.fst(49,39-49,46)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b))

:named refinement_kinding_Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(49,39-49,46); use=WorkingWithSquashedProofs.fst(49,39-49,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b @x2))
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=Prims.fst(635,71-635,97); use=WorkingWithSquashedProofs.fst(49,39-49,46)
(not 
;; def=Prims.fst(441,29-441,97); use=WorkingWithSquashedProofs.fst(49,39-49,44)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=WorkingWithSquashedProofs.fst(49,24-49,25); use=WorkingWithSquashedProofs.fst(49,45-49,46)
(Valid 
;; def=WorkingWithSquashedProofs.fst(49,24-49,25); use=WorkingWithSquashedProofs.fst(49,45-49,46)
@x2
)
...
;; def=Prims.fst(635,86-635,95); use=WorkingWithSquashedProofs.fst(49,39-49,46)
(not 
;; def=Prims.fst(635,86-635,95); use=WorkingWithSquashedProofs.fst(49,39-49,46)
(= @x3
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b.1))
)
))
...
@x1
(Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b @x2)))
:qid refinement_interpretation_Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b))

:named refinement_interpretation_Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(49,39-49,46); use=WorkingWithSquashedProofs.fst(49,39-49,46)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b @x0)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b @x0))))
:qid haseqTm_refine_3b1bc98ed7702245ad88d7f144de6d8b))

:named haseqTm_refine_3b1bc98ed7702245ad88d7f144de6d8b))
;;;;;;;;;;;;;;;;_: a -> FStar.Pervasives.Lemma (ensures b)
(declare-fun Tm_arrow_7080cc49da7e20320b64de4f6f1468ef (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7080cc49da7e20320b64de4f6f1468ef
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(49,21-49,46); use=WorkingWithSquashedProofs.fst(49,34-49,46)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_7080cc49da7e20320b64de4f6f1468ef @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_7080cc49da7e20320b64de4f6f1468ef @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_7080cc49da7e20320b64de4f6f1468ef))

:named kinding_Tm_arrow_7080cc49da7e20320b64de4f6f1468ef))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(49,21-49,46); use=WorkingWithSquashedProofs.fst(49,34-49,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_7080cc49da7e20320b64de4f6f1468ef @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_7080cc49da7e20320b64de4f6f1468ef @x2
@x3)))
:qid WorkingWithSquashedProofs_pre_typing_Tm_arrow_7080cc49da7e20320b64de4f6f1468ef))

:named WorkingWithSquashedProofs_pre_typing_Tm_arrow_7080cc49da7e20320b64de4f6f1468ef))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7080cc49da7e20320b64de4f6f1468ef
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(49,21-49,46); use=WorkingWithSquashedProofs.fst(49,34-49,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_7080cc49da7e20320b64de4f6f1468ef @x1
@x2))
(and 
;; def=WorkingWithSquashedProofs.fst(49,21-49,46); use=WorkingWithSquashedProofs.fst(49,34-49,46)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b @x1)))
 

:pattern ((ApplyTT @x0
@x3))
:qid WorkingWithSquashedProofs_interpretation_Tm_arrow_7080cc49da7e20320b64de4f6f1468ef.1))
...
(Tm_arrow_7080cc49da7e20320b64de4f6f1468ef @x1
@x2)))
:qid WorkingWithSquashedProofs_interpretation_Tm_arrow_7080cc49da7e20320b64de4f6f1468ef))

:named WorkingWithSquashedProofs_interpretation_Tm_arrow_7080cc49da7e20320b64de4f6f1468ef))

; Encoding query formula : forall (a: Type) (b: Type) (lem: (_: a -> FStar.Pervasives.Lemma (ensures b))) (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (pure_result: Prims.unit). b ==> Prims.auto_squash b


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_as_squash`
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(51,4-51,7)
(forall ((@x4 Term))
...
;; def=WorkingWithSquashedProofs.fst(49,24-49,25); use=WorkingWithSquashedProofs.fst(51,4-51,9)
(or label_1

;; def=WorkingWithSquashedProofs.fst(49,24-49,25); use=WorkingWithSquashedProofs.fst(50,17-50,18)
(Valid 
;; def=WorkingWithSquashedProofs.fst(49,24-49,25); use=WorkingWithSquashedProofs.fst(50,17-50,18)
@x1
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (WorkingWithSquashedProofs.lemma_as_squash, 1)
; STATUS: unsat
...
; encoding sigelt let lemma_as_squash


; <Start encoding let lemma_as_squash>

(declare-fun Tm_refine_3b1bc98ed7702245ad88d7f144de6d8b (Term) Term)
;;;;;;;;;;;;;;;;_: a -> FStar.Pervasives.Lemma (ensures b)
(declare-fun Tm_arrow_7080cc49da7e20320b64de4f6f1468ef (Term Term) Term)
(declare-fun WorkingWithSquashedProofs.lemma_as_squash (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;$lem: (_: a -> FStar.Pervasives.Lemma (ensures b)) -> x: a -> Prims.GTot (Prims.squash b)
(declare-fun Tm_arrow_d5bf255a0860dad97fa9be8bbbdee2c8 () Term)
(declare-fun WorkingWithSquashedProofs.lemma_as_squash@tok () Term)



; </end encoding let lemma_as_squash>
...
; Starting query at WorkingWithSquashedProofs.fst(56,4-56,74)
...
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(54,29-54,43); use=WorkingWithSquashedProofs.fst(54,29-54,43)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_460b166284656e401cd2507f30d7a622 @x0)
Tm_type)
...
;; def=WorkingWithSquashedProofs.fst(54,34-54,41); use=WorkingWithSquashedProofs.fst(54,34-54,41)
(Valid 
;; def=WorkingWithSquashedProofs.fst(54,34-54,41); use=WorkingWithSquashedProofs.fst(54,34-54,41)
(WorkingWithSquashedProofs.foo @x2
@x1)
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(56,4-56,74)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=WorkingWithSquashedProofs.fst(55,10-55,19); use=WorkingWithSquashedProofs.fst(56,4-56,74)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=WorkingWithSquashedProofs.fst(56,4-56,74)
(Valid 
;; def=Prims.fst(441,83-441,96); use=WorkingWithSquashedProofs.fst(56,4-56,74)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(459,77-459,89); use=WorkingWithSquashedProofs.fst(56,4-56,74)
(and 
;; def=WorkingWithSquashedProofs.fst(34,42-34,49); use=WorkingWithSquashedProofs.fst(56,29-56,31)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=WorkingWithSquashedProofs.fst(56,4-56,74)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)
...
;; def=Prims.fst(451,90-451,102); use=WorkingWithSquashedProofs.fst(56,4-56,74)
(Valid 
;; def=Prims.fst(451,90-451,102); use=WorkingWithSquashedProofs.fst(56,4-56,74)
(ApplyTT @x2
@x5)
...
; QUERY ID: (WorkingWithSquashedProofs.foo_implies_bar, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.squash, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c, refinement_interpretation_Tm_refine_460b166284656e401cd2507f30d7a622
...
; encoding sigelt let foo_implies_bar


; <Start encoding let foo_implies_bar>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun WorkingWithSquashedProofs.foo_implies_bar (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun WorkingWithSquashedProofs.foo_implies_bar@tok () Term)

; </end encoding let foo_implies_bar>


; encoding sigelt val WorkingWithSquashedProofs.foo_or_bar


; <Start encoding val WorkingWithSquashedProofs.foo_or_bar>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun WorkingWithSquashedProofs.foo_or_bar (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun WorkingWithSquashedProofs.foo_or_bar@tok () Term)

; </end encoding val WorkingWithSquashedProofs.foo_or_bar>


; encoding sigelt val WorkingWithSquashedProofs.baz


; <Start encoding val WorkingWithSquashedProofs.baz>

(declare-fun WorkingWithSquashedProofs.baz (Term Term) Term)

(declare-fun WorkingWithSquashedProofs.baz@tok () Term)

; </end encoding val WorkingWithSquashedProofs.baz>


; encoding sigelt val WorkingWithSquashedProofs.foo_baz


; <Start encoding val WorkingWithSquashedProofs.foo_baz>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun WorkingWithSquashedProofs.foo_baz (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun WorkingWithSquashedProofs.foo_baz@tok () Term)

; </end encoding val WorkingWithSquashedProofs.foo_baz>


; encoding sigelt val WorkingWithSquashedProofs.bar_baz


; <Start encoding val WorkingWithSquashedProofs.bar_baz>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun WorkingWithSquashedProofs.bar_baz (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun WorkingWithSquashedProofs.bar_baz@tok () Term)

; </end encoding val WorkingWithSquashedProofs.bar_baz>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name WorkingWithSquashedProofs.baz; Namespace WorkingWithSquashedProofs
(assert (! 
;; def=WorkingWithSquashedProofs.fst(65,4-65,7); use=WorkingWithSquashedProofs.fst(65,4-65,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
@x0))
(HasType (WorkingWithSquashedProofs.baz @x0
@x1)
Tm_type))
 

:pattern ((WorkingWithSquashedProofs.baz @x0
@x1))
:qid typing_WorkingWithSquashedProofs.baz))

:named typing_WorkingWithSquashedProofs.baz))
;;;;;;;;;;;;;;;;free var typing
...
; Starting query at WorkingWithSquashedProofs.fst(84,3-96,12)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_9d683c026be591732fd7b938a4d2571b (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(84,22-84,42); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_9d683c026be591732fd7b938a4d2571b @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_9d683c026be591732fd7b938a4d2571b @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_9d683c026be591732fd7b938a4d2571b))

:named refinement_kinding_Tm_refine_9d683c026be591732fd7b938a4d2571b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(84,22-84,42); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9d683c026be591732fd7b938a4d2571b @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=WorkingWithSquashedProofs.fst(84,22-84,42); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(or 
;; def=WorkingWithSquashedProofs.fst(84,23-84,30); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(Valid 
;; def=WorkingWithSquashedProofs.fst(84,23-84,30); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(WorkingWithSquashedProofs.foo @x2
@x3)
...
;; def=WorkingWithSquashedProofs.fst(84,34-84,41); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(Valid 
;; def=WorkingWithSquashedProofs.fst(84,34-84,41); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(WorkingWithSquashedProofs.bar @x2
@x3)
)
)
))
...
(Tm_refine_9d683c026be591732fd7b938a4d2571b @x2
@x3)))
:qid refinement_interpretation_Tm_refine_9d683c026be591732fd7b938a4d2571b))

:named refinement_interpretation_Tm_refine_9d683c026be591732fd7b938a4d2571b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9d683c026be591732fd7b938a4d2571b
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(84,22-84,42); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9d683c026be591732fd7b938a4d2571b @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9d683c026be591732fd7b938a4d2571b @x0
@x1))))
:qid haseqTm_refine_9d683c026be591732fd7b938a4d2571b))

:named haseqTm_refine_9d683c026be591732fd7b938a4d2571b))

;;;;;;;;;;;;;;;;_: foo a x \/ bar a x -> Prims.GTot (Prims.squash (baz a x))
(declare-fun Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(84,22-84,42); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b))

:named kinding_Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(84,22-84,42); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b @x2
@x3)))
:qid WorkingWithSquashedProofs_pre_typing_Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b))

:named WorkingWithSquashedProofs_pre_typing_Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(84,22-84,42); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b @x1
@x2))
(and 
;; def=WorkingWithSquashedProofs.fst(84,22-84,42); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Prims.l_or (WorkingWithSquashedProofs.foo @x2
@x1)
(WorkingWithSquashedProofs.bar @x2
@x1)))
(HasType (ApplyTT @x0
@x3)
(Prims.squash (WorkingWithSquashedProofs.baz @x2
@x1))))
 

:pattern ((ApplyTT @x0
@x3))
:qid WorkingWithSquashedProofs_interpretation_Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b.1))
...
(Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b @x1
@x2)))
:qid WorkingWithSquashedProofs_interpretation_Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b))

:named WorkingWithSquashedProofs_interpretation_Tm_arrow_f5b29489ab1eda0f8339ab49eee87c4b))

; Encoding query formula : forall (a: Type) (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). WorkingWithSquashedProofs.baz a x ==> p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         WorkingWithSquashedProofs.foo a x \/ WorkingWithSquashedProofs.bar a x ==>
;         (WorkingWithSquashedProofs.foo a x \/ WorkingWithSquashedProofs.bar a x) /\
;         (forall (any_result:
;             Prims.squash (WorkingWithSquashedProofs.foo a x \/ WorkingWithSquashedProofs.bar a x))
;             (b:
;             Prims.squash (WorkingWithSquashedProofs.foo a x \/ WorkingWithSquashedProofs.bar a x)).
;             (forall (fb: WorkingWithSquashedProofs.foo a x \/ WorkingWithSquashedProofs.bar a x).
;                 (*  - Could not prove post-condition
; *)
;                 forall (b:
;                   Prims.squash (Prims.sum (WorkingWithSquashedProofs.foo a x)
;                         (WorkingWithSquashedProofs.bar a x)))
;                   (c_fb:
;                   Prims.sum (WorkingWithSquashedProofs.foo a x) (WorkingWithSquashedProofs.bar a x))
;                 .
;                   (*  - Could not prove post-condition
; *)
;                   forall (k: Prims.pure_post (Prims.squash (WorkingWithSquashedProofs.baz a x))).
;                     (forall (x: Prims.squash (WorkingWithSquashedProofs.baz a x)).
;                         {:pattern Prims.guard_free (k x)}
;                         Prims.auto_squash (k x)) ==>
;                     (~(Left? c_fb) /\ ~(Right? c_fb) ==> Prims.l_False) /\
;                     (forall (b: WorkingWithSquashedProofs.foo a x).
;                         c_fb == Prims.Left b ==>
;                         WorkingWithSquashedProofs.foo a x /\
;                         (forall (pure_result: Prims.unit).
;                             WorkingWithSquashedProofs.baz a x ==>
;                             Prims.auto_squash (WorkingWithSquashedProofs.baz a x))) /\
;                     (~(Left? c_fb) ==>
;                       (forall (b: WorkingWithSquashedProofs.bar a x).
;                           c_fb == Prims.Right b ==>
;                           WorkingWithSquashedProofs.bar a x /\
;                           (forall (pure_result: Prims.unit).
;                               WorkingWithSquashedProofs.baz a x ==>
;                               Prims.auto_squash (WorkingWithSquashedProofs.baz a x))))) /\
;             (forall (any_result:
;                 (_: WorkingWithSquashedProofs.foo a x \/ WorkingWithSquashedProofs.bar a x
;                     -> Prims.GTot (Prims.squash (WorkingWithSquashedProofs.baz a x))))
;                 (any_result: Prims.squash (WorkingWithSquashedProofs.baz a x))
;                 (any_result: Prims.squash (WorkingWithSquashedProofs.baz a x)).
;                 p any_result)))


; Context: While encoding a query
; While typechecking the top-level declaration `let valid_baz`
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=WorkingWithSquashedProofs.fst(83,10-83,19); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(or label_2

;; def=WorkingWithSquashedProofs.fst(83,10-83,19); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(Valid 
;; def=WorkingWithSquashedProofs.fst(83,10-83,19); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(WorkingWithSquashedProofs.baz @x0
@x1)
)
)
)

;; def=Prims.fst(441,83-441,96); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(Valid 
;; def=Prims.fst(441,83-441,96); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(84,45-84,55)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=WorkingWithSquashedProofs.fst(62,36-62,56); use=WorkingWithSquashedProofs.fst(84,45-84,55)
(or 
;; def=WorkingWithSquashedProofs.fst(62,37-62,44); use=WorkingWithSquashedProofs.fst(84,45-84,55)
(Valid 
;; def=WorkingWithSquashedProofs.fst(62,37-62,44); use=WorkingWithSquashedProofs.fst(84,45-84,55)
(WorkingWithSquashedProofs.foo @x0
@x1)
...
;; def=WorkingWithSquashedProofs.fst(62,48-62,55); use=WorkingWithSquashedProofs.fst(84,45-84,55)
(Valid 
;; def=WorkingWithSquashedProofs.fst(62,48-62,55); use=WorkingWithSquashedProofs.fst(84,45-84,55)
(WorkingWithSquashedProofs.bar @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(and 
;; def=WorkingWithSquashedProofs.fst(84,22-84,42); use=WorkingWithSquashedProofs.fst(84,45-84,57)
(or label_3

;; def=WorkingWithSquashedProofs.fst(84,23-84,30); use=WorkingWithSquashedProofs.fst(84,45-84,57)
(Valid 
;; def=WorkingWithSquashedProofs.fst(84,23-84,30); use=WorkingWithSquashedProofs.fst(84,45-84,57)
(WorkingWithSquashedProofs.foo @x0
@x1)
...
;; def=WorkingWithSquashedProofs.fst(84,34-84,41); use=WorkingWithSquashedProofs.fst(84,45-84,57)
(Valid 
;; def=WorkingWithSquashedProofs.fst(84,34-84,41); use=WorkingWithSquashedProofs.fst(84,45-84,57)
(WorkingWithSquashedProofs.bar @x0
@x1)
...
;; def=Prims.fst(451,66-451,102); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Tm_refine_9d683c026be591732fd7b938a4d2571b @x0
@x1))

;; def=Prims.fst(413,99-413,120); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Tm_refine_9d683c026be591732fd7b938a4d2571b @x0
@x1))
...
;; def=Prims.fst(459,77-459,89); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(and 
;; def=dummy(0,0-0,0); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(Prims.l_or (WorkingWithSquashedProofs.foo @x0
@x1)
(WorkingWithSquashedProofs.bar @x0
@x1)))

;; def=Prims.fst(413,99-413,120); use=WorkingWithSquashedProofs.fst(86,4-96,11)
(forall ((@x7 Term))
 (! (implies (HasType @x7
(Prims.squash (Prims.sum (WorkingWithSquashedProofs.foo @x0
@x1)
(WorkingWithSquashedProofs.bar @x0
@x1))))

;; def=dummy(0,0-0,0); use=WorkingWithSquashedProofs.fst(86,4-96,11)
(forall ((@x8 Term))
 (! (implies (HasType @x8
(Prims.sum (WorkingWithSquashedProofs.foo @x0
@x1)
(WorkingWithSquashedProofs.bar @x0
@x1)))
...
(Prims.pure_post (Prims.squash (WorkingWithSquashedProofs.baz @x0
@x1))))

;; def=Prims.fst(402,27-402,88); use=WorkingWithSquashedProofs.fst(86,77-96,10)
(forall ((@x10 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=WorkingWithSquashedProofs.fst(86,77-96,10)
(Valid 
;; def=Prims.fst(402,84-402,87); use=WorkingWithSquashedProofs.fst(86,77-96,10)
(ApplyTT @x9
@x10)
...
;; def=Prims.fst(459,77-459,89); use=WorkingWithSquashedProofs.fst(86,77-96,10)
(and (implies 
;; def=WorkingWithSquashedProofs.fst(86,39-86,43); use=WorkingWithSquashedProofs.fst(88,13-88,17)
(and 
;; def=WorkingWithSquashedProofs.fst(86,39-86,43); use=WorkingWithSquashedProofs.fst(88,13-88,17)
(not 
;; def=WorkingWithSquashedProofs.fst(86,39-86,43); use=WorkingWithSquashedProofs.fst(88,13-88,17)
(BoxBool_proj_0 (Prims.uu___is_Left (WorkingWithSquashedProofs.foo @x0
@x1)
(WorkingWithSquashedProofs.bar @x0
@x1)
@x8))
...
(not 
;; def=WorkingWithSquashedProofs.fst(86,39-86,43); use=WorkingWithSquashedProofs.fst(88,13-88,17)
(BoxBool_proj_0 (Prims.uu___is_Right (WorkingWithSquashedProofs.foo @x0
@x1)
(WorkingWithSquashedProofs.bar @x0
@x1)
@x8))
...
;; def=Prims.fst(413,99-413,120); use=WorkingWithSquashedProofs.fst(86,77-96,10)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(WorkingWithSquashedProofs.foo @x0
@x1))

;; def=WorkingWithSquashedProofs.fst(86,39-89,21); use=WorkingWithSquashedProofs.fst(88,13-89,21)
(= @x8
(Prims.Left (WorkingWithSquashedProofs.foo @x0
@x1)
(WorkingWithSquashedProofs.bar @x0
@x1)
@x10))
...
;; def=Prims.fst(441,29-441,97); use=WorkingWithSquashedProofs.fst(91,9-91,16)
(and 
;; def=WorkingWithSquashedProofs.fst(73,14-73,21); use=WorkingWithSquashedProofs.fst(91,9-91,16)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(91,9-91,16)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
Prims.unit)

;; def=WorkingWithSquashedProofs.fst(74,13-74,20); use=WorkingWithSquashedProofs.fst(91,9-91,16)
(Valid 
;; def=WorkingWithSquashedProofs.fst(74,13-74,20); use=WorkingWithSquashedProofs.fst(91,9-91,16)
(WorkingWithSquashedProofs.baz @x0
@x1)
...
;; def=WorkingWithSquashedProofs.fst(87,24-87,33); use=WorkingWithSquashedProofs.fst(91,9-91,18)
(or label_6
...
(implies 
;; def=Prims.fst(389,19-389,21); use=WorkingWithSquashedProofs.fst(86,77-96,10)
(not 
;; def=WorkingWithSquashedProofs.fst(86,39-86,43); use=WorkingWithSquashedProofs.fst(88,13-88,17)
(BoxBool_proj_0 (Prims.uu___is_Left (WorkingWithSquashedProofs.foo @x0
@x1)
...
;; def=WorkingWithSquashedProofs.fst(86,39-92,22); use=WorkingWithSquashedProofs.fst(88,13-92,22)
(= @x8
(Prims.Right (WorkingWithSquashedProofs.foo @x0
@x1)
(WorkingWithSquashedProofs.bar @x0
@x1)
@x10))
...
;; def=Prims.fst(441,29-441,97); use=WorkingWithSquashedProofs.fst(94,9-94,16)
(and 
;; def=WorkingWithSquashedProofs.fst(79,14-79,21); use=WorkingWithSquashedProofs.fst(94,9-94,16)
(or label_7
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(94,9-94,16)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
Prims.unit)

;; def=WorkingWithSquashedProofs.fst(80,13-80,20); use=WorkingWithSquashedProofs.fst(94,9-94,16)
(Valid 
;; def=WorkingWithSquashedProofs.fst(80,13-80,20); use=WorkingWithSquashedProofs.fst(94,9-94,16)
(WorkingWithSquashedProofs.baz @x0
@x1)
...
;; def=WorkingWithSquashedProofs.fst(87,24-87,33); use=WorkingWithSquashedProofs.fst(94,9-94,18)
(or label_8
...
(forall ((@x7 Term))
 (! (implies (HasType @x7
(Prims.squash (WorkingWithSquashedProofs.baz @x0
@x1)))
...
;; def=Prims.fst(451,90-451,102); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(Valid 
;; def=Prims.fst(451,90-451,102); use=WorkingWithSquashedProofs.fst(84,3-96,12)
(ApplyTT @x2
@x8)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (WorkingWithSquashedProofs.valid_baz, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Prims.Left, disc_equation_Prims.Right, equation_Prims.squash, fuel_guarded_inversion_Prims.sum, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c
...
; encoding sigelt let valid_baz


; <Start encoding let valid_baz>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun WorkingWithSquashedProofs.valid_baz (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun WorkingWithSquashedProofs.valid_baz@tok () Term)

; </end encoding let valid_baz>


; encoding sigelt val WorkingWithSquashedProofs.c_foo_baz


; <Start encoding val WorkingWithSquashedProofs.c_foo_baz>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun WorkingWithSquashedProofs.c_foo_baz (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun WorkingWithSquashedProofs.c_foo_baz@tok () Term)

; </end encoding val WorkingWithSquashedProofs.c_foo_baz>


; encoding sigelt val WorkingWithSquashedProofs.c_bar_baz


; <Start encoding val WorkingWithSquashedProofs.c_bar_baz>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun WorkingWithSquashedProofs.c_bar_baz (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun WorkingWithSquashedProofs.c_bar_baz@tok () Term)

; </end encoding val WorkingWithSquashedProofs.c_bar_baz>

(push) ;; push{2

; Starting query at WorkingWithSquashedProofs.fst(113,3-123,12)
...
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(113,22-113,42); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_9d683c026be591732fd7b938a4d2571b @x0
@x1)
Tm_type)
...
;; def=WorkingWithSquashedProofs.fst(113,22-113,42); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(or 
;; def=WorkingWithSquashedProofs.fst(113,23-113,30); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(Valid 
;; def=WorkingWithSquashedProofs.fst(113,23-113,30); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(WorkingWithSquashedProofs.foo @x2
@x3)
...
;; def=WorkingWithSquashedProofs.fst(113,34-113,41); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(Valid 
;; def=WorkingWithSquashedProofs.fst(113,34-113,41); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(WorkingWithSquashedProofs.bar @x2
@x3)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let valid_baz_alt`
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=WorkingWithSquashedProofs.fst(112,10-112,19); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(Valid 
;; def=Prims.fst(441,83-441,96); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(113,45-113,55)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=WorkingWithSquashedProofs.fst(62,36-62,56); use=WorkingWithSquashedProofs.fst(113,45-113,55)
(or 
;; def=WorkingWithSquashedProofs.fst(62,37-62,44); use=WorkingWithSquashedProofs.fst(113,45-113,55)
(Valid 
;; def=WorkingWithSquashedProofs.fst(62,37-62,44); use=WorkingWithSquashedProofs.fst(113,45-113,55)
(WorkingWithSquashedProofs.foo @x0
@x1)
...
;; def=WorkingWithSquashedProofs.fst(62,48-62,55); use=WorkingWithSquashedProofs.fst(113,45-113,55)
(Valid 
;; def=WorkingWithSquashedProofs.fst(62,48-62,55); use=WorkingWithSquashedProofs.fst(113,45-113,55)
(WorkingWithSquashedProofs.bar @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(and 
;; def=WorkingWithSquashedProofs.fst(113,22-113,42); use=WorkingWithSquashedProofs.fst(113,45-113,57)
(or label_3

;; def=WorkingWithSquashedProofs.fst(113,23-113,30); use=WorkingWithSquashedProofs.fst(113,45-113,57)
(Valid 
;; def=WorkingWithSquashedProofs.fst(113,23-113,30); use=WorkingWithSquashedProofs.fst(113,45-113,57)
(WorkingWithSquashedProofs.foo @x0
@x1)
...
;; def=WorkingWithSquashedProofs.fst(113,34-113,41); use=WorkingWithSquashedProofs.fst(113,45-113,57)
(Valid 
;; def=WorkingWithSquashedProofs.fst(113,34-113,41); use=WorkingWithSquashedProofs.fst(113,45-113,57)
(WorkingWithSquashedProofs.bar @x0
@x1)
...
;; def=Prims.fst(451,66-451,102); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Tm_refine_9d683c026be591732fd7b938a4d2571b @x0
@x1))

;; def=Prims.fst(413,99-413,120); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Tm_refine_9d683c026be591732fd7b938a4d2571b @x0
@x1))
...
;; def=Prims.fst(459,77-459,89); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(and 
;; def=dummy(0,0-0,0); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(Prims.l_or (WorkingWithSquashedProofs.foo @x0
@x1)
...
;; def=Prims.fst(413,99-413,120); use=WorkingWithSquashedProofs.fst(115,4-123,11)
(forall ((@x7 Term))
 (! (implies (HasType @x7
(Prims.squash (Prims.sum (WorkingWithSquashedProofs.foo @x0
@x1)
...
;; def=dummy(0,0-0,0); use=WorkingWithSquashedProofs.fst(115,4-123,11)
(forall ((@x8 Term))
 (! (implies (HasType @x8
(Prims.sum (WorkingWithSquashedProofs.foo @x0
@x1)
...
;; def=Prims.fst(402,27-402,88); use=WorkingWithSquashedProofs.fst(115,77-123,10)
(forall ((@x10 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=WorkingWithSquashedProofs.fst(115,77-123,10)
(Valid 
;; def=Prims.fst(402,84-402,87); use=WorkingWithSquashedProofs.fst(115,77-123,10)
(ApplyTT @x9
@x10)
...
;; def=Prims.fst(459,77-459,89); use=WorkingWithSquashedProofs.fst(115,77-123,10)
(and (implies 
;; def=WorkingWithSquashedProofs.fst(115,39-115,43); use=WorkingWithSquashedProofs.fst(117,13-117,17)
(and 
;; def=WorkingWithSquashedProofs.fst(115,39-115,43); use=WorkingWithSquashedProofs.fst(117,13-117,17)
(not 
;; def=WorkingWithSquashedProofs.fst(115,39-115,43); use=WorkingWithSquashedProofs.fst(117,13-117,17)
...
;; def=Prims.fst(413,99-413,120); use=WorkingWithSquashedProofs.fst(115,77-123,10)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(WorkingWithSquashedProofs.foo @x0
@x1))

;; def=WorkingWithSquashedProofs.fst(115,39-118,21); use=WorkingWithSquashedProofs.fst(117,13-118,21)
(= @x8
(Prims.Left (WorkingWithSquashedProofs.foo @x0
@x1)
(WorkingWithSquashedProofs.bar @x0
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(119,9-119,18)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
Prims.unit)

;; def=WorkingWithSquashedProofs.fst(104,13-104,20); use=WorkingWithSquashedProofs.fst(119,9-119,18)
(Valid 
;; def=WorkingWithSquashedProofs.fst(104,13-104,20); use=WorkingWithSquashedProofs.fst(119,9-119,18)
(WorkingWithSquashedProofs.baz @x0
@x1)
...
;; def=WorkingWithSquashedProofs.fst(116,24-116,33); use=WorkingWithSquashedProofs.fst(119,9-119,22)
(or label_5
...
(implies 
;; def=Prims.fst(389,19-389,21); use=WorkingWithSquashedProofs.fst(115,77-123,10)
(not 
;; def=WorkingWithSquashedProofs.fst(115,39-115,43); use=WorkingWithSquashedProofs.fst(117,13-117,17)
(BoxBool_proj_0 (Prims.uu___is_Left (WorkingWithSquashedProofs.foo @x0
@x1)
...
;; def=WorkingWithSquashedProofs.fst(115,39-120,22); use=WorkingWithSquashedProofs.fst(117,13-120,22)
(= @x8
(Prims.Right (WorkingWithSquashedProofs.foo @x0
@x1)
(WorkingWithSquashedProofs.bar @x0
...
;; def=Prims.fst(441,36-441,97); use=WorkingWithSquashedProofs.fst(121,9-121,18)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
Prims.unit)

;; def=WorkingWithSquashedProofs.fst(109,13-109,20); use=WorkingWithSquashedProofs.fst(121,9-121,18)
(Valid 
;; def=WorkingWithSquashedProofs.fst(109,13-109,20); use=WorkingWithSquashedProofs.fst(121,9-121,18)
(WorkingWithSquashedProofs.baz @x0
@x1)
...
;; def=WorkingWithSquashedProofs.fst(116,24-116,33); use=WorkingWithSquashedProofs.fst(121,9-121,22)
(or label_6
...
;; def=Prims.fst(451,90-451,102); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(Valid 
;; def=Prims.fst(451,90-451,102); use=WorkingWithSquashedProofs.fst(113,3-123,12)
(ApplyTT @x2
@x8)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (WorkingWithSquashedProofs.valid_baz_alt, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Prims.Left, disc_equation_Prims.Right, equation_Prims.squash, fuel_guarded_inversion_Prims.sum, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_2de20c066034c13bf76e9c0b94f4806c
...
; encoding sigelt let valid_baz_alt


; <Start encoding let valid_baz_alt>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun WorkingWithSquashedProofs.valid_baz_alt (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun WorkingWithSquashedProofs.valid_baz_alt@tok () Term)

; </end encoding let valid_baz_alt>
...
; Starting query at WorkingWithSquashedProofs.fst(129,4-133,61)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(127,46-127,54); use=WorkingWithSquashedProofs.fst(127,46-127,54)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e))

:named refinement_kinding_Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(127,46-127,54); use=WorkingWithSquashedProofs.fst(127,46-127,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.unit)
...
;; def=WorkingWithSquashedProofs.fst(127,46-127,54); use=WorkingWithSquashedProofs.fst(127,46-127,54)
(or 
;; def=WorkingWithSquashedProofs.fst(127,28-127,29); use=WorkingWithSquashedProofs.fst(127,47-127,48)
(Valid 
;; def=WorkingWithSquashedProofs.fst(127,28-127,29); use=WorkingWithSquashedProofs.fst(127,47-127,48)
@x2
)
...
;; def=WorkingWithSquashedProofs.fst(127,31-127,32); use=WorkingWithSquashedProofs.fst(127,52-127,53)
(Valid 
;; def=WorkingWithSquashedProofs.fst(127,31-127,32); use=WorkingWithSquashedProofs.fst(127,52-127,53)
@x3
)
...
(Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e @x2
@x3)))
:qid refinement_interpretation_Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e))

:named refinement_interpretation_Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e
;;; Fact-ids: 
(assert (! 
;; def=WorkingWithSquashedProofs.fst(127,46-127,54); use=WorkingWithSquashedProofs.fst(127,46-127,54)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e @x0
@x1)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e @x0
@x1))))
:qid haseqTm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e))

:named haseqTm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e))




; Encoding query formula : forall (r: Type)
;   (p: Prims.logical)
;   (q: Prims.logical)
;   (f: Prims.squash (p \/ q))
;   (left: (_: p -> Prims.GTot r))
;   (right: (_: q -> Prims.GTot r)).
;   (*  - Could not prove post-condition
; *)
;   forall (b: Prims.squash (p \/ q)) (pq: p \/ q).
;     (*  - Could not prove post-condition
; *)
;     forall (b: Prims.squash (Prims.sum p q)) (c: Prims.sum p q).
;       (*  - Could not prove post-condition
; *)
;       forall (k: Prims.pure_post (Prims.squash r)).
;         (forall (x: Prims.squash r). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;         ~(Left? c) /\ ~(Right? c) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let elim_squash_or`
...
Prims.logical)
(HasType @x3
(Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e @x1
@x2))
(HasType @x4
...
;; def=Prims.fst(413,99-413,120); use=WorkingWithSquashedProofs.fst(129,4-133,61)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(Tm_refine_fe5dc86c0b5ea8bea91e659ca9e2937e @x1
@x2))

;; def=dummy(0,0-0,0); use=WorkingWithSquashedProofs.fst(129,4-133,61)
(forall ((@x7 Term))
 (! (implies (HasType @x7
(Prims.l_or @x1
@x2))

;; def=Prims.fst(413,99-413,120); use=WorkingWithSquashedProofs.fst(130,4-133,60)
(forall ((@x8 Term))
 (! (implies (HasType @x8
(Prims.squash (Prims.sum @x1
@x2)))

;; def=dummy(0,0-0,0); use=WorkingWithSquashedProofs.fst(130,4-133,60)
(forall ((@x9 Term))
 (! (implies (HasType @x9
(Prims.sum @x1
@x2))
...
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(Prims.pure_post (Prims.squash @x0)))

;; def=Prims.fst(402,27-402,88); use=WorkingWithSquashedProofs.fst(131,4-133,59)
(forall ((@x11 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=WorkingWithSquashedProofs.fst(131,4-133,59)
(Valid 
;; def=Prims.fst(402,84-402,87); use=WorkingWithSquashedProofs.fst(131,4-133,59)
(ApplyTT @x10
@x11)
...
;; def=WorkingWithSquashedProofs.fst(130,37-130,38); use=WorkingWithSquashedProofs.fst(131,10-131,11)
(not 
;; def=WorkingWithSquashedProofs.fst(130,37-130,38); use=WorkingWithSquashedProofs.fst(131,10-131,11)
(BoxBool_proj_0 (Prims.uu___is_Left @x1
@x2
@x9))
)
...
(not 
;; def=WorkingWithSquashedProofs.fst(130,37-130,38); use=WorkingWithSquashedProofs.fst(131,10-131,11)
(BoxBool_proj_0 (Prims.uu___is_Right @x1
@x2
@x9))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (WorkingWithSquashedProofs.elim_squash_or, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Prims.Left, disc_equation_Prims.Right, fuel_guarded_inversion_Prims.sum, projection_inverse_BoxBool_proj_0
