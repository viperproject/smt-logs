...
; Internals for MonadicLetBindings
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c
;;; Fact-ids: Name FStar.List.Tot.Base.tryPick; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(343,24-344,17); use=FStar.List.Tot.Base.fst(344,8-344,17)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c))

:named kinding_Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c @x2
@x3)))
:qid FStar.List.Tot.Base_pre_typing_Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c))

:named FStar.List.Tot.Base_pre_typing_Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c
;;; Fact-ids: Name FStar.List.Tot.Base.tryPick; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(343,24-344,17); use=FStar.List.Tot.Base.fst(344,8-344,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c @x1
@x2))
(and 
;; def=FStar.List.Tot.Base.fst(343,24-344,17); use=FStar.List.Tot.Base.fst(344,8-344,17)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c.1))
...
(Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c @x1
@x2)))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c))

:named FStar.List.Tot.Base_interpretation_Tm_arrow_4b0c7cc34485afa5854ebe5c95023d4c))
(push) ;; push{2

; Starting query at MonadicLetBindings.fst(39,4-41,18)
...
;   (f: (_: 'a -> FStar.Pervasives.Native.option 'b)).
...
;     ~(Some? x) /\ ~(None? x) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let op_let_Question`
...
;; def=Prims.fst(402,27-402,88); use=MonadicLetBindings.fst(39,4-41,18)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(39,4-41,18)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(39,4-41,18)
(ApplyTT @x4
@x5)
...
;; def=MonadicLetBindings.fst(38,12-38,13); use=MonadicLetBindings.fst(39,10-39,11)
(not 
;; def=MonadicLetBindings.fst(38,12-38,13); use=MonadicLetBindings.fst(39,10-39,11)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some @x0
@x2))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.op_let_Question, 1)
; STATUS: unsat
...
; encoding sigelt let op_let_Question


; <Start encoding let op_let_Question>


(declare-fun MonadicLetBindings.op_let_Question (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: FStar.Pervasives.Native.option 'a -> f: (_: 'a -> FStar.Pervasives.Native.option 'b)   -> FStar.Pervasives.Native.option 'b
(declare-fun Tm_arrow_a273ef2cc9fc82e9581085ed97b33fbb () Term)
(declare-fun MonadicLetBindings.op_let_Question@tok () Term)


; </end encoding let op_let_Question>


; encoding sigelt let op_and_Question


; <Start encoding let op_and_Question>

(declare-fun MonadicLetBindings.op_and_Question (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: FStar.Pervasives.Native.option 'a -> y: FStar.Pervasives.Native.option 'b   -> FStar.Pervasives.Native.option ('a & 'b)
(declare-fun Tm_arrow_ec53e28761f7162315c702c514065f62 () Term)
(declare-fun MonadicLetBindings.op_and_Question@tok () Term)

; </end encoding let op_and_Question>
...
(declare-fun MonadicLetBindings.head (Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.list _ -> FStar.Pervasives.Native.option _
(declare-fun Tm_arrow_e105036e6d557917958e01cd287fa08a () Term)
(declare-fun MonadicLetBindings.head@tok () Term)
...
; Starting query at MonadicLetBindings.fst(54,2-58,29)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Prims.list (Prims.int & Prims.int))
;   (b: Prims.list (Prims.int & Prims.int))
;   (c: FStar.Pervasives.Native.option Prims.bool).
;   (*  - Could not prove post-condition
; *)
;   forall (_: (Prims.int & Prims.int) & (Prims.int & Prims.int)).
;     (*  - Could not prove post-condition
; *)
;     forall (b: Prims.int) (b: Prims.int) (b: Prims.int) (b: Prims.int).
;       _ == ((b, b), (b, b)) ==>
;       (forall (_: Prims.bool).
;           (*  - Could not prove post-condition
; *)
...
;                 Prims.auto_squash (k x)) ==>
;             ~(_ = true) /\ ~(_ = false) ==> Prims.l_False)


; Context: While encoding a query
; While typechecking the top-level declaration `let option_example`
...
(assert (! (not (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(Prims.list (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))
(HasType @x1
(Prims.list (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))
...
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(54,2-58,29)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))

;; def=Prims.fst(413,99-413,120); use=MonadicLetBindings.fst(56,9-56,10)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.int)
...
;; def=MonadicLetBindings.fst(55,7-55,15); use=MonadicLetBindings.fst(56,9-56,10)
(= @x3
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
...
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(56,9-56,10)
(forall ((@x8 Term))
 (! (implies (HasType @x8
Prims.bool)
...
;; def=Prims.fst(402,27-402,88); use=MonadicLetBindings.fst(56,9-56,10)
(forall ((@x10 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(56,9-56,10)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(56,9-56,10)
(ApplyTT @x9
@x10)
...
;; def=MonadicLetBindings.fst(56,9-57,8); use=MonadicLetBindings.fst(56,9-56,10)
(not 
;; def=MonadicLetBindings.fst(56,9-57,8); use=MonadicLetBindings.fst(56,9-56,10)
(= @x8
(BoxBool true))
...
;; def=MonadicLetBindings.fst(56,9-58,9); use=MonadicLetBindings.fst(56,9-56,10)
(not 
;; def=MonadicLetBindings.fst(56,9-58,9); use=MonadicLetBindings.fst(56,9-56,10)
(= @x8
(BoxBool false))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.option_example, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, bool_inversion
...
; encoding sigelt let option_example


; <Start encoding let option_example>

(declare-fun MonadicLetBindings.option_example (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Prims.list (Prims.int & Prims.int) ->     b: Prims.list (Prims.int & Prims.int) ->     c: FStar.Pervasives.Native.option Prims.bool   -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_9ce88afd6eb6c64c41bf88edd62e3f41 () Term)
(declare-fun MonadicLetBindings.option_example@tok () Term)
;;;;;;;;;;;;;;;;_: Prims.bool -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_a84e63a3d168c96d3ef06bbac4d7f7c7 () Term)
(declare-fun Tm_abs_170725c53e9ae92b52dd1733d873283d (Term) Term)
;;;;;;;;;;;;;;;;_: (Prims.int & Prims.int) & (Prims.int & Prims.int) -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_c748060380839913c9bf243b82001311 () Term)
(declare-fun Tm_abs_a0f714fc67d8cbd2c547145e08cb3901 (Term) Term)

; </end encoding let option_example>


; encoding sigelt let let_punning


; <Start encoding let let_punning>

(declare-fun MonadicLetBindings.let_punning (Term) Term)
;;;;;;;;;;;;;;;;a: FStar.Pervasives.Native.option Prims.int -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_21ae1a474a94df5e114eecf4e8ca5e8b () Term)
(declare-fun MonadicLetBindings.let_punning@tok () Term)
;;;;;;;;;;;;;;;;a: Prims.int -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_d35a343232bbd3568f776882493e21c0 () Term)
(declare-fun Tm_abs_f6046888d92205d67b197dd128dc0ed0 () Term)

; </end encoding let let_punning>
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d35a343232bbd3568f776882493e21c0
;;; Fact-ids: Name MonadicLetBindings.let_punning; Namespace MonadicLetBindings
(assert (! (HasType Tm_arrow_d35a343232bbd3568f776882493e21c0
Tm_type)
:named kinding_Tm_arrow_d35a343232bbd3568f776882493e21c0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name MonadicLetBindings.let_punning; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(38,36-60,30); use=MonadicLetBindings.fst(61,4-61,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d35a343232bbd3568f776882493e21c0)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_d35a343232bbd3568f776882493e21c0))
:qid MonadicLetBindings_pre_typing_Tm_arrow_d35a343232bbd3568f776882493e21c0))

:named MonadicLetBindings_pre_typing_Tm_arrow_d35a343232bbd3568f776882493e21c0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d35a343232bbd3568f776882493e21c0
;;; Fact-ids: Name MonadicLetBindings.let_punning; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(38,36-60,30); use=MonadicLetBindings.fst(61,4-61,8)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid MonadicLetBindings_interpretation_Tm_arrow_d35a343232bbd3568f776882493e21c0.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_d35a343232bbd3568f776882493e21c0))
:qid MonadicLetBindings_interpretation_Tm_arrow_d35a343232bbd3568f776882493e21c0))

:named MonadicLetBindings_interpretation_Tm_arrow_d35a343232bbd3568f776882493e21c0))
(push) ;; push{2

; Starting query at MonadicLetBindings.fst(65,4-67,31)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (validate: (_: Prims.int -> FStar.Pervasives.Native.option Prims.int)) (x: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.int).
;     (*  - Could not prove post-condition
...
;       (forall (x: FStar.Pervasives.Native.option Prims.int). {:pattern Prims.guard_free (k x)}
;           Prims.auto_squash (k x)) ==>
;       ~(x = 0 = true) ==> (forall (b: Prims.bool). x = 0 == b ==> x <> 0)


; Context: While encoding a query
; While typechecking the top-level declaration `let sequence_example`
...
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(65,4-67,31)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)
...
;; def=Prims.fst(402,27-402,88); use=MonadicLetBindings.fst(66,4-67,31)
(forall ((@x4 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(66,4-67,31)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(66,4-67,31)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(389,19-389,21); use=MonadicLetBindings.fst(66,4-67,31)
(not 
;; def=MonadicLetBindings.fst(66,7-66,12); use=MonadicLetBindings.fst(66,7-66,12)
...
;; def=Prims.fst(413,99-413,120); use=MonadicLetBindings.fst(66,4-67,31)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.bool)

;; def=MonadicLetBindings.fst(66,7-67,31); use=MonadicLetBindings.fst(66,7-67,31)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
@x4)
...
;; def=Prims.fst(686,22-686,28); use=MonadicLetBindings.fst(67,29-67,30)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.sequence_example, 1)
; STATUS: unsat
...
; encoding sigelt let sequence_example


; <Start encoding let sequence_example>


(declare-fun MonadicLetBindings.sequence_example (Term Term) Term)

;;;;;;;;;;;;;;;;validate: (_: Prims.int -> FStar.Pervasives.Native.option Prims.int) -> x: Prims.int   -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_0fdbac910beb836353fb2b42f06bda58 () Term)
(declare-fun MonadicLetBindings.sequence_example@tok () Term)


(declare-fun Tm_abs_d3c35a4f92bf29b4f23fdb1de0611ee7 (Term) Term)

; </end encoding let sequence_example>
...
(declare-fun MonadicLetBindings.uu___0 (Dummy_sort) Term)
...
(declare-fun MonadicLetBindings.uu___1 (Dummy_sort) Term)

; </end encoding let uu___1>


; encoding sigelt let sugared1


; <Start encoding let sugared1>

;;;;;;;;;;;;;;;;_: (_ & _) & _ -> _
(declare-fun Tm_arrow_0907c08f896765ed646ec9c6cb485cb9 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: _ -> _: (_: (_ & _) & _ -> _) -> _
(declare-fun Tm_arrow_748cc4758a00d7f81fda1ed43108bea8 (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;_: _ -> _: _ -> _: _ -> _
(declare-fun Tm_arrow_46a2f20e317f00bf7b3689605c5b8536 (Term Term Term Term) Term)
(declare-fun MonadicLetBindings.sugared1 (Term Term Term Term Term Term Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;op_let_Star: (_: _ -> _: (_: (_ & _) & _ -> _) -> _) ->     op_and_Star: (_: _ -> _: _ -> _) ->     ex: _ ->     ey: _ ->     ez: _ ->     f: (_: _ -> _: _ -> _: _ -> _)   -> _
(declare-fun Tm_arrow_139c7316cbb09bb034093ac200b9b1af () Term)
(declare-fun MonadicLetBindings.sugared1@tok () Term)





(declare-fun Tm_abs_b98afa69ea882e4d5f130417533647df (Term Term Term Term Term) Term)

; </end encoding let sugared1>


; encoding sigelt let desugared1


; <Start encoding let desugared1>





(declare-fun MonadicLetBindings.desugared1 (Term Term Term Term Term Term Term Term Term Term Term Term Term) Term)





(declare-fun MonadicLetBindings.desugared1@tok () Term)
...
; </end encoding let desugared1>

(push) ;; push{2

; Starting query at MonadicLetBindings.fst(88,4-90,22)

(declare-fun label_1 () Bool)

;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option Prims.int ->     _: (_: Prims.int -> FStar.Pervasives.Native.option Prims.int)   -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_3b4674e47faf72e89c29807bf51a62b4 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3b4674e47faf72e89c29807bf51a62b4
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3b4674e47faf72e89c29807bf51a62b4
Tm_type)
:named kinding_Tm_arrow_3b4674e47faf72e89c29807bf51a62b4))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(87,14-87,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3b4674e47faf72e89c29807bf51a62b4)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_3b4674e47faf72e89c29807bf51a62b4))
:qid MonadicLetBindings_pre_typing_Tm_arrow_3b4674e47faf72e89c29807bf51a62b4))

:named MonadicLetBindings_pre_typing_Tm_arrow_3b4674e47faf72e89c29807bf51a62b4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3b4674e47faf72e89c29807bf51a62b4
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(87,14-87,18)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid MonadicLetBindings_interpretation_Tm_arrow_3b4674e47faf72e89c29807bf51a62b4.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid MonadicLetBindings_interpretation_Tm_arrow_3b4674e47faf72e89c29807bf51a62b4.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_3b4674e47faf72e89c29807bf51a62b4))
:qid MonadicLetBindings_interpretation_Tm_arrow_3b4674e47faf72e89c29807bf51a62b4))

:named MonadicLetBindings_interpretation_Tm_arrow_3b4674e47faf72e89c29807bf51a62b4))

; Encoding query formula : forall (op_let_Question:
;   (
;         _: FStar.Pervasives.Native.option Prims.int ->
;         _: (_: Prims.int -> FStar.Pervasives.Native.option Prims.int)
;       -> FStar.Pervasives.Native.option Prims.int))
;   (ex: FStar.Pervasives.Native.option Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.int).
;     (*  - Could not prove post-condition
...
;       (forall (x: FStar.Pervasives.Native.option Prims.int). {:pattern Prims.guard_free (k x)}
;           Prims.auto_squash (k x)) ==>
;       ~(_ = 0) ==> (forall (b: Prims.int). _ == b ==> b <> 0)


; Context: While encoding a query
; While typechecking the top-level declaration `let sugared2`
...
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(88,4-90,22)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)
...
;; def=Prims.fst(402,27-402,88); use=MonadicLetBindings.fst(88,4-90,22)
(forall ((@x4 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(88,4-90,22)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(88,4-90,22)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(389,19-389,21); use=MonadicLetBindings.fst(88,4-90,22)
(not 
;; def=MonadicLetBindings.fst(88,11-89,5); use=MonadicLetBindings.fst(88,11-89,5)
(= @x2
(BoxInt 0))
)
)

;; def=Prims.fst(413,99-413,120); use=MonadicLetBindings.fst(88,4-90,22)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.int)

;; def=MonadicLetBindings.fst(88,11-90,5); use=MonadicLetBindings.fst(88,11-90,5)
(= @x2
@x4)
)

;; def=Prims.fst(686,22-686,28); use=MonadicLetBindings.fst(90,20-90,21)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.sugared2, 1)
; STATUS: unsat
...
; encoding sigelt let sugared2


; <Start encoding let sugared2>


;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option Prims.int ->     _: (_: Prims.int -> FStar.Pervasives.Native.option Prims.int)   -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_3b4674e47faf72e89c29807bf51a62b4 () Term)
(declare-fun MonadicLetBindings.sugared2 (Term Term) Term)


;;;;;;;;;;;;;;;;op_let_Question:       (             _: FStar.Pervasives.Native.option Prims.int ->             _: (_: Prims.int -> FStar.Pervasives.Native.option Prims.int)           -> FStar.Pervasives.Native.option Prims.int) ->     ex: FStar.Pervasives.Native.option Prims.int   -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_e1e968049368ab97b5002753053d415a () Term)
(declare-fun MonadicLetBindings.sugared2@tok () Term)



(declare-fun Tm_abs_8d3495ec221e13f65915a69e0b409f48 () Term)

; </end encoding let sugared2>

(push) ;; push{2

; Starting query at MonadicLetBindings.fst(92,4-94,44)

(declare-fun label_1 () Bool)

;;;;;;;;;;;;;;;;_: _ -> _: (_: Prims.int -> FStar.Pervasives.Native.option Prims.int) -> _
(declare-fun Tm_arrow_9c6244bb656031b042c04e18f919131e (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9c6244bb656031b042c04e18f919131e
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(91,0-94,44)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_9c6244bb656031b042c04e18f919131e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_9c6244bb656031b042c04e18f919131e @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_9c6244bb656031b042c04e18f919131e))

:named kinding_Tm_arrow_9c6244bb656031b042c04e18f919131e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(91,0-94,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_9c6244bb656031b042c04e18f919131e @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_9c6244bb656031b042c04e18f919131e @x2
@x3)))
:qid MonadicLetBindings_pre_typing_Tm_arrow_9c6244bb656031b042c04e18f919131e))

:named MonadicLetBindings_pre_typing_Tm_arrow_9c6244bb656031b042c04e18f919131e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9c6244bb656031b042c04e18f919131e
;;; Fact-ids: 
(assert (! 
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(91,0-94,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_9c6244bb656031b042c04e18f919131e @x1
@x2))
(and 
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(91,0-94,44)
...
@x3)
@x4))
:qid MonadicLetBindings_interpretation_Tm_arrow_9c6244bb656031b042c04e18f919131e.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid MonadicLetBindings_interpretation_Tm_arrow_9c6244bb656031b042c04e18f919131e.2))
))
...
(Tm_arrow_9c6244bb656031b042c04e18f919131e @x1
@x2)))
:qid MonadicLetBindings_interpretation_Tm_arrow_9c6244bb656031b042c04e18f919131e))

:named MonadicLetBindings_interpretation_Tm_arrow_9c6244bb656031b042c04e18f919131e))

; Encoding query formula : forall (_: Type)
;   (_: Type)
;   (op_let_Question: (_: _ -> _: (_: Prims.int -> FStar.Pervasives.Native.option Prims.int) -> _))
;   (ex: _).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.int).
...
;       (forall (x: FStar.Pervasives.Native.option Prims.int). {:pattern Prims.guard_free (k x)}
;           Prims.auto_squash (k x)) ==>
;       ~(x = 0) ==> (forall (b: Prims.int). x == b ==> b <> 0)


; Context: While encoding a query
; While typechecking the top-level declaration `let desugared2`
...
;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(92,4-94,44)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.int)
...
;; def=Prims.fst(402,27-402,88); use=MonadicLetBindings.fst(92,33-94,43)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(92,33-94,43)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(92,33-94,43)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(389,19-389,21); use=MonadicLetBindings.fst(92,33-94,43)
(not 
;; def=MonadicLetBindings.fst(92,28-93,26); use=MonadicLetBindings.fst(92,39-93,26)
(= @x4
(BoxInt 0))
)
)

;; def=Prims.fst(413,99-413,120); use=MonadicLetBindings.fst(92,33-94,43)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.int)

;; def=MonadicLetBindings.fst(92,28-94,26); use=MonadicLetBindings.fst(92,39-94,26)
(= @x4
@x6)
)

;; def=Prims.fst(686,22-686,28); use=MonadicLetBindings.fst(94,41-94,42)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.desugared2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt let desugared2


; <Start encoding let desugared2>


;;;;;;;;;;;;;;;;_: _ -> _: (_: Prims.int -> FStar.Pervasives.Native.option Prims.int) -> _
(declare-fun Tm_arrow_9c6244bb656031b042c04e18f919131e (Term Term) Term)
(declare-fun MonadicLetBindings.desugared2 (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;op_let_Question: (_: _ -> _: (_: Prims.int -> FStar.Pervasives.Native.option Prims.int) -> _) ->     ex: _   -> _
(declare-fun Tm_arrow_801818c1e54d89cdf758c77f83e43a29 () Term)
(declare-fun MonadicLetBindings.desugared2@tok () Term)





; </end encoding let desugared2>


; encoding sigelt let sugared3


; <Start encoding let sugared3>

;;;;;;;;;;;;;;;;_: _ -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_2a20f12fd7ac80593f09bd0014a84e03 (Term) Term)
;;;;;;;;;;;;;;;;_: _ -> _: (_: _ -> FStar.Pervasives.Native.option Prims.int) -> _
(declare-fun Tm_arrow_68925c81dd31a169ebfb1d44fa95ce20 (Term Term Term) Term)
(declare-fun MonadicLetBindings.sugared3 (Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;op_let_Question: (_: _ -> _: (_: _ -> FStar.Pervasives.Native.option Prims.int) -> _) -> ex: _ -> _
(declare-fun Tm_arrow_8949ef121f45b6d4e06557bd7cf85e66 () Term)
(declare-fun MonadicLetBindings.sugared3@tok () Term)



(declare-fun Tm_abs_0115d874e62eb167a4fe59fcced96e7e (Term) Term)

; </end encoding let sugared3>


; encoding sigelt let desugared3


; <Start encoding let desugared3>



(declare-fun MonadicLetBindings.desugared3 (Term Term Term Term Term) Term)



(declare-fun MonadicLetBindings.desugared3@tok () Term)





; </end encoding let desugared3>


; encoding sigelt let sugared4


; <Start encoding let sugared4>

;;;;;;;;;;;;;;;;_: Prims.bool -> _
(declare-fun Tm_arrow_0fb34df09b643253d421dc821b3d8a35 (Term) Term)
;;;;;;;;;;;;;;;;_: _ -> _: (_: Prims.bool -> _) -> _
(declare-fun Tm_arrow_51ea3bf65d2548da2f976b3d057a9f04 (Term Term Term) Term)
(declare-fun MonadicLetBindings.sugared4 (Term Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;op_let_Question: (_: _ -> _: (_: Prims.bool -> _) -> _) -> ex: _ -> a: _ -> b: _ -> _
(declare-fun Tm_arrow_745f2da885f4c3a371acf62df485edaf () Term)
(declare-fun MonadicLetBindings.sugared4@tok () Term)



(declare-fun Tm_abs_3fea8c454d2dbedef9f00a0649ecdd90 (Term Term Term) Term)

; </end encoding let sugared4>


; encoding sigelt let desugared4


; <Start encoding let desugared4>

;;;;;;;;;;;;;;;;_: Prims.bool -> Prims.unit
(declare-fun Tm_arrow_67996253d093abd00b8d2c5c5e2fafd3 () Term)
;;;;;;;;;;;;;;;;_: _ -> _: (_: Prims.bool -> Prims.unit) -> _
(declare-fun Tm_arrow_20838172ea1494b8c221e47120fc8643 (Term Term) Term)
;;;;;;;;;;;;;;;;_: _ -> Prims.unit
(declare-fun Tm_arrow_a81c5c38338876965452e63054bff052 (Term) Term)
(declare-fun MonadicLetBindings.desugared4 (Term Term Term Term Term Term Term) Term)



;;;;;;;;;;;;;;;;op_let_Question: (_: _ -> _: (_: Prims.bool -> Prims.unit) -> _) ->     ex: _ ->     a: (_: _ -> Prims.unit) ->     b: _   -> _
(declare-fun Tm_arrow_94bbfdb0ca06febcf05d0deca1ce6c2f () Term)
(declare-fun MonadicLetBindings.desugared4@tok () Term)




(declare-fun Tm_abs_1cad4e2e4ffab7a81a24cdfb7332d2b3 () Term)

; </end encoding let desugared4>


; encoding sigelt let op_let_Colon_Colon


; <Start encoding let op_let_Colon_Colon>


(declare-fun MonadicLetBindings.op_let_Colon_Colon (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;l: Prims.list 'a -> f: (_: 'a -> Prims.list 'b) -> Prims.list 'b
(declare-fun Tm_arrow_fa29259213ac10778e5a0678eeedec50 () Term)
(declare-fun MonadicLetBindings.op_let_Colon_Colon@tok () Term)


; </end encoding let op_let_Colon_Colon>
...
; Starting query at MonadicLetBindings.fst(112,4-114,22)
...
;;;;;;;;;;;;;;;;b : Prims.list 'b (Prims.list 'b)
(declare-fun x_8e2b3e2e2d5822bdb0266bcb517fa74a_5 () Term)
;;;;;;;;;;;;;;;;binder_x_8e2b3e2e2d5822bdb0266bcb517fa74a_5
;;; Fact-ids: 
(assert (! (HasType x_8e2b3e2e2d5822bdb0266bcb517fa74a_5
(Prims.list x_fe28d8bcde588226b4e538b35321de05_3))
:named binder_x_8e2b3e2e2d5822bdb0266bcb517fa74a_5))
(declare-fun Tm_refine_ef3472e20c37088300654c8a7853b730 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(111,13-114,22); use=MonadicLetBindings.fst(111,13-114,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_ef3472e20c37088300654c8a7853b730 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_ef3472e20c37088300654c8a7853b730 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_ef3472e20c37088300654c8a7853b730))

:named refinement_kinding_Tm_refine_ef3472e20c37088300654c8a7853b730))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(111,13-114,22); use=MonadicLetBindings.fst(111,13-114,22)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ef3472e20c37088300654c8a7853b730 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=MonadicLetBindings.fst(111,13-114,22); use=MonadicLetBindings.fst(111,13-114,22)
(or 
;; def=MonadicLetBindings.fst(112,4-114,22); use=MonadicLetBindings.fst(112,4-114,22)
(Valid 
;; def=MonadicLetBindings.fst(112,4-114,22); use=MonadicLetBindings.fst(112,4-114,22)
...
;; def=MonadicLetBindings.fst(111,13-114,22); use=MonadicLetBindings.fst(111,13-114,22)
(and 
;; def=MonadicLetBindings.fst(111,13-111,14); use=MonadicLetBindings.fst(111,13-111,14)
(Valid 
;; def=MonadicLetBindings.fst(111,13-111,14); use=MonadicLetBindings.fst(111,13-111,14)
...
(Prims.list x_fe28d8bcde588226b4e538b35321de05_3)
@x1
x_8e2b3e2e2d5822bdb0266bcb517fa74a_5)
)
)
)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_ef3472e20c37088300654c8a7853b730))

:named refinement_interpretation_Tm_refine_ef3472e20c37088300654c8a7853b730))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ef3472e20c37088300654c8a7853b730
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(111,13-114,22); use=MonadicLetBindings.fst(111,13-114,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ef3472e20c37088300654c8a7853b730 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Prims.list @x2))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ef3472e20c37088300654c8a7853b730 @x0
@x1
@x2))))
:qid haseqTm_refine_ef3472e20c37088300654c8a7853b730))

:named haseqTm_refine_ef3472e20c37088300654c8a7853b730))
(declare-fun MonadicLetBindings.zip (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Prims.list 'a -> b: Prims.list 'b {a << a \/ a === a /\ b << b} -> Prims.list ('a & 'b)
(declare-fun Tm_arrow_8456f74892243f83c17a869075842cfc () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8456f74892243f83c17a869075842cfc
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_8456f74892243f83c17a869075842cfc
Tm_type)
:named kinding_Tm_arrow_8456f74892243f83c17a869075842cfc))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(111,13-114,22); use=MonadicLetBindings.fst(111,13-114,22)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8456f74892243f83c17a869075842cfc)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_8456f74892243f83c17a869075842cfc))
:qid MonadicLetBindings_pre_typing_Tm_arrow_8456f74892243f83c17a869075842cfc))

:named MonadicLetBindings_pre_typing_Tm_arrow_8456f74892243f83c17a869075842cfc))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8456f74892243f83c17a869075842cfc
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(111,13-114,22); use=MonadicLetBindings.fst(111,13-114,22)
(forall ((@x0 Term))
...
(Prims.list @x1))
(HasType @x4
(Tm_refine_ef3472e20c37088300654c8a7853b730 @x1
@x3
@x2)))
...
@x3)
@x4)
(Prims.list (FStar.Pervasives.Native.tuple2 @x1
@x2))))
...
@x3)
@x4))
:qid MonadicLetBindings_interpretation_Tm_arrow_8456f74892243f83c17a869075842cfc.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid MonadicLetBindings_interpretation_Tm_arrow_8456f74892243f83c17a869075842cfc.2))
...
@x1)
@x2))
:qid MonadicLetBindings_interpretation_Tm_arrow_8456f74892243f83c17a869075842cfc.3))
...
@x2)
@x3))
:qid MonadicLetBindings_interpretation_Tm_arrow_8456f74892243f83c17a869075842cfc.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_8456f74892243f83c17a869075842cfc))
:qid MonadicLetBindings_interpretation_Tm_arrow_8456f74892243f83c17a869075842cfc))

:named MonadicLetBindings_interpretation_Tm_arrow_8456f74892243f83c17a869075842cfc))
(declare-fun MonadicLetBindings.zip@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(111,8-111,11); use=MonadicLetBindings.fst(111,8-111,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT MonadicLetBindings.zip@tok
@x0)
@x1)
@x2)
@x3)
(MonadicLetBindings.zip @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT MonadicLetBindings.zip@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_MonadicLetBindings.zip))

:named token_correspondence_MonadicLetBindings.zip))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(111,8-111,11); use=MonadicLetBindings.fst(111,8-111,11)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MonadicLetBindings.zip@tok
Tm_arrow_8456f74892243f83c17a869075842cfc))
...
@x3)
@x4)
(MonadicLetBindings.zip @x1
@x2
@x3
@x4))
 

:pattern ((MonadicLetBindings.zip @x1
@x2
@x3
@x4))
:qid function_token_typing_MonadicLetBindings.zip.1))
)
 

:pattern ((ApplyTT @x0
MonadicLetBindings.zip@tok))
:qid function_token_typing_MonadicLetBindings.zip))

:named function_token_typing_MonadicLetBindings.zip))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(111,8-111,11); use=MonadicLetBindings.fst(111,8-111,11)
...
(Prims.list @x0))
(HasType @x3
(Tm_refine_ef3472e20c37088300654c8a7853b730 @x0
@x2
@x1)))
(HasType (MonadicLetBindings.zip @x0
@x1
@x2
@x3)
(Prims.list (FStar.Pervasives.Native.tuple2 @x0
@x1))))
 

:pattern ((MonadicLetBindings.zip @x0
@x1
@x2
@x3))
:qid typing_MonadicLetBindings.zip))

:named typing_MonadicLetBindings.zip))
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (Prims.list ('a & 'b))).
;   (forall (x: Prims.list ('a & 'b)). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (forall (b: 'a) (b: Prims.list 'a) (b: 'b) (b: Prims.list 'b).
;       (a, b) == (b :: b, b :: b) ==>
;       (forall (return_val: Type). return_val == 'a & 'b ==> b << a \/ b === a /\ b << b))
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Prims.list (FStar.Pervasives.Native.tuple2 x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3))))

;; def=Prims.fst(402,27-402,88); use=MonadicLetBindings.fst(112,4-114,22)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(112,4-114,22)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(112,4-114,22)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(413,99-413,120); use=MonadicLetBindings.fst(112,4-114,22)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=MonadicLetBindings.fst(112,10-113,18); use=MonadicLetBindings.fst(112,10-113,18)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_fe28d8bcde588226b4e538b35321de05_2)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_3)
x_3dddec8ced2db740e4e8aaf70542be7a_4
x_8e2b3e2e2d5822bdb0266bcb517fa74a_5)
(FStar.Pervasives.Native.Mktuple2 (Prims.list x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=Prims.fst(356,2-356,58); use=MonadicLetBindings.fst(112,4-114,22)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Tm_type)

;; def=Prims.fst(356,26-356,41); use=MonadicLetBindings.fst(112,4-114,22)
(= @x5
(FStar.Pervasives.Native.tuple2 x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3))
)

;; def=MonadicLetBindings.fst(111,13-114,22); use=MonadicLetBindings.fst(113,38-113,40)
(or label_1

;; def=MonadicLetBindings.fst(112,4-114,22); use=MonadicLetBindings.fst(113,38-113,40)
(Valid 
;; def=MonadicLetBindings.fst(112,4-114,22); use=MonadicLetBindings.fst(113,38-113,40)
...
;; def=MonadicLetBindings.fst(111,13-114,22); use=MonadicLetBindings.fst(113,38-113,40)
(and 
;; def=MonadicLetBindings.fst(111,13-111,14); use=MonadicLetBindings.fst(113,38-113,40)
(Valid 
;; def=MonadicLetBindings.fst(111,13-111,14); use=MonadicLetBindings.fst(113,38-113,40)
(Prims.op_Equals_Equals_Equals (Prims.list x_fe28d8bcde588226b4e538b35321de05_2)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_2)
@x2
x_3dddec8ced2db740e4e8aaf70542be7a_4)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.zip, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_3dddec8ced2db740e4e8aaf70542be7a_4, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, subterm_ordering_Prims.Cons
...
; encoding sigelt let rec zip


; <Start encoding let rec zip>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun MonadicLetBindings.zip.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun MonadicLetBindings.zip.fuel_instrumented_token () Term)
(declare-fun MonadicLetBindings.zip (Term Term Term Term) Term)
(declare-fun MonadicLetBindings.zip@tok () Term)
;;;;;;;;;;;;;;;;a: Prims.list 'a -> b: Prims.list 'b -> Prims.list ('a & 'b)
(declare-fun Tm_arrow_40431bad5dd3c208e2b9ee83c899b546 () Term)

; </end encoding let rec zip>


; encoding sigelt let op_and_Colon_Colon


; <Start encoding let op_and_Colon_Colon>

(declare-fun MonadicLetBindings.op_and_Colon_Colon (Term Term Term Term) Term)

(declare-fun MonadicLetBindings.op_and_Colon_Colon@tok () Term)

; </end encoding let op_and_Colon_Colon>


; encoding sigelt let list_example1


; <Start encoding let list_example1>

(declare-fun MonadicLetBindings.list_example1 (Dummy_sort) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> Prims.list Prims.int
(declare-fun Tm_arrow_b924c75f55178ed471eb4478d2098569 () Term)
(declare-fun Tm_abs_1e6d6a983784015c0ff56dbf3b95d1d9 () Term)

; </end encoding let list_example1>
...
(declare-fun MonadicLetBindings.uu___2 (Dummy_sort) Term)

; </end encoding let uu___2>


; encoding sigelt let list_example2


; <Start encoding let list_example2>

(declare-fun MonadicLetBindings.list_example2 (Dummy_sort) Term)
;;;;;;;;;;;;;;;;_: Prims.int & Prims.string -> Prims.list (Prims.int & Prims.string)
(declare-fun Tm_arrow_256aca55d6691cddf983f1c867044f58 () Term)
(declare-fun Tm_abs_cb7e2865e9b906f8e1fca33127d0bf35 () Term)

; </end encoding let list_example2>
...
(declare-fun MonadicLetBindings.uu___3 (Dummy_sort) Term)
...
; encoding sigelt type MonadicLetBindings.exp


; <Start encoding type MonadicLetBindings.exp>

;;;;;;;;;;;;;;;;Constructor
(declare-fun MonadicLetBindings.exp () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun MonadicLetBindings.Const (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadicLetBindings.Const__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: MonadicLetBindings.Const
(declare-fun MonadicLetBindings.Const@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun MonadicLetBindings.Addition (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadicLetBindings.Addition__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadicLetBindings.Addition__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: MonadicLetBindings.Addition
(declare-fun MonadicLetBindings.Addition@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun MonadicLetBindings.Division (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadicLetBindings.Division__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun MonadicLetBindings.Division__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: MonadicLetBindings.Division
(declare-fun MonadicLetBindings.Division@tok () Term)
;;;;;;;;;;;;;;;;_0: Prims.int -> exp
(declare-fun Tm_arrow_e7cd9e3d58fd02bd4deac88fccdb193e () Term)
;;;;;;;;;;;;;;;;_0: exp -> _1: exp -> exp
(declare-fun Tm_arrow_4b0af9298987867244f997a4872b6680 () Term)


; <start constructor MonadicLetBindings.exp>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-MonadicLetBindings.exp ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
347)
(= __@x0
MonadicLetBindings.exp)))

; </end constructor MonadicLetBindings.exp>


; <start constructor MonadicLetBindings.Const>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-MonadicLetBindings.Const ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
353)
(= __@x0
(MonadicLetBindings.Const (MonadicLetBindings.Const__0 __@x0)))))

; </end constructor MonadicLetBindings.Const>


; <start constructor MonadicLetBindings.Addition>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-MonadicLetBindings.Addition ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
358)
(= __@x0
(MonadicLetBindings.Addition (MonadicLetBindings.Addition__0 __@x0)
(MonadicLetBindings.Addition__1 __@x0)))))

; </end constructor MonadicLetBindings.Addition>


; <start constructor MonadicLetBindings.Division>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-MonadicLetBindings.Division ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
363)
(= __@x0
(MonadicLetBindings.Division (MonadicLetBindings.Division__0 __@x0)
(MonadicLetBindings.Division__1 __@x0)))))

; </end constructor MonadicLetBindings.Division>


; </end encoding type MonadicLetBindings.exp>

;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(MonadicLetBindings.Division @x1
@x2)
MonadicLetBindings.exp)
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
...
@x2)
MonadicLetBindings.exp))
:qid subterm_ordering_MonadicLetBindings.Division))

:named subterm_ordering_MonadicLetBindings.Division))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(134,4-134,9); use=MonadicLetBindings.fst(134,4-134,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(MonadicLetBindings.Const @x1)
MonadicLetBindings.exp)
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x1
...
(MonadicLetBindings.Const @x1)
MonadicLetBindings.exp))
:qid subterm_ordering_MonadicLetBindings.Const))

:named subterm_ordering_MonadicLetBindings.Const))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(MonadicLetBindings.Addition @x1
@x2)
MonadicLetBindings.exp)
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
...
@x2)
MonadicLetBindings.exp))
:qid subterm_ordering_MonadicLetBindings.Addition))

:named subterm_ordering_MonadicLetBindings.Addition))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (MonadicLetBindings.Division__1 (MonadicLetBindings.Division @x0
@x1))
@x1)
 

:pattern ((MonadicLetBindings.Division @x0
@x1))
:qid projection_inverse_MonadicLetBindings.Division__1))

:named projection_inverse_MonadicLetBindings.Division__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (MonadicLetBindings.Division__0 (MonadicLetBindings.Division @x0
@x1))
@x0)
...
:pattern ((MonadicLetBindings.Division @x0
@x1))
:qid projection_inverse_MonadicLetBindings.Division__0))

:named projection_inverse_MonadicLetBindings.Division__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(134,4-134,9); use=MonadicLetBindings.fst(134,4-134,9)
(forall ((@x0 Term))
 (! (= (MonadicLetBindings.Const__0 (MonadicLetBindings.Const @x0))
@x0)
 

:pattern ((MonadicLetBindings.Const @x0))
:qid projection_inverse_MonadicLetBindings.Const__0))

:named projection_inverse_MonadicLetBindings.Const__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (MonadicLetBindings.Addition__1 (MonadicLetBindings.Addition @x0
@x1))
@x1)
 

:pattern ((MonadicLetBindings.Addition @x0
@x1))
:qid projection_inverse_MonadicLetBindings.Addition__1))

:named projection_inverse_MonadicLetBindings.Addition__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (MonadicLetBindings.Addition__0 (MonadicLetBindings.Addition @x0
@x1))
@x0)
...
:pattern ((MonadicLetBindings.Addition @x0
@x1))
:qid projection_inverse_MonadicLetBindings.Addition__0))

:named projection_inverse_MonadicLetBindings.Addition__0))
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! (HasType MonadicLetBindings.exp
Tm_type)
:named kinding_MonadicLetBindings.exp@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(133,5-133,8); use=MonadicLetBindings.fst(133,5-133,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
MonadicLetBindings.exp)
(or (is-MonadicLetBindings.Const @x1)
(is-MonadicLetBindings.Addition @x1)
(is-MonadicLetBindings.Division @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
MonadicLetBindings.exp))
:qid fuel_guarded_inversion_MonadicLetBindings.exp))

:named fuel_guarded_inversion_MonadicLetBindings.exp))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
...
@x2)
MonadicLetBindings.exp))
:qid data_typing_intro_MonadicLetBindings.Division@tok))

:named data_typing_intro_MonadicLetBindings.Division@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(134,4-134,9); use=MonadicLetBindings.fst(134,4-134,9)
...
(MonadicLetBindings.Const @x1)
MonadicLetBindings.exp))
:qid data_typing_intro_MonadicLetBindings.Const@tok))

:named data_typing_intro_MonadicLetBindings.Const@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
...
@x2)
MonadicLetBindings.exp))
:qid data_typing_intro_MonadicLetBindings.Addition@tok))

:named data_typing_intro_MonadicLetBindings.Addition@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
...
@x2)
MonadicLetBindings.exp))
:qid data_elim_MonadicLetBindings.Division))

:named data_elim_MonadicLetBindings.Division))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(134,4-134,9); use=MonadicLetBindings.fst(134,4-134,9)
...
(MonadicLetBindings.Const @x1)
MonadicLetBindings.exp))
:qid data_elim_MonadicLetBindings.Const))

:named data_elim_MonadicLetBindings.Const))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
...
@x2)
MonadicLetBindings.exp))
:qid data_elim_MonadicLetBindings.Addition))

:named data_elim_MonadicLetBindings.Addition))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! (= 347
(Term_constr_id MonadicLetBindings.exp))
:named constructor_distinct_MonadicLetBindings.exp))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= 363
(Term_constr_id (MonadicLetBindings.Division @x0
@x1)))
 

:pattern ((MonadicLetBindings.Division @x0
@x1))
:qid constructor_distinct_MonadicLetBindings.Division))

:named constructor_distinct_MonadicLetBindings.Division))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(134,4-134,9); use=MonadicLetBindings.fst(134,4-134,9)
(forall ((@x0 Term))
 (! (= 353
(Term_constr_id (MonadicLetBindings.Const @x0)))
 

:pattern ((MonadicLetBindings.Const @x0))
:qid constructor_distinct_MonadicLetBindings.Const))

:named constructor_distinct_MonadicLetBindings.Const))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= 358
(Term_constr_id (MonadicLetBindings.Addition @x0
@x1)))
 

:pattern ((MonadicLetBindings.Addition @x0
@x1))
:qid constructor_distinct_MonadicLetBindings.Addition))

:named constructor_distinct_MonadicLetBindings.Addition))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(133,5-133,8); use=MonadicLetBindings.fst(133,5-133,8)
...
@x0
MonadicLetBindings.exp))
:qid MonadicLetBindings_pretyping_66efaf146f0bdf852352b426871e22cd))

:named MonadicLetBindings_pretyping_66efaf146f0bdf852352b426871e22cd))
(push) ;; push{4

; Starting query at MonadicLetBindings.fst(133,0-136,31)
...
; Encoding query formula : Prims.hasEq MonadicLetBindings.exp ==>
; (forall (_0: MonadicLetBindings.exp) (_1: MonadicLetBindings.exp).
;     Prims.hasEq MonadicLetBindings.exp /\ Prims.hasEq MonadicLetBindings.exp) /\
; (forall (_0: MonadicLetBindings.exp) (_1: MonadicLetBindings.exp).
;     Prims.hasEq MonadicLetBindings.exp /\ Prims.hasEq MonadicLetBindings.exp)


; Context: While encoding a query
; While typechecking the top-level declaration `type MonadicLetBindings.exp`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=MonadicLetBindings.fst(133,0-136,31); use=MonadicLetBindings.fst(133,0-136,31)
(Valid 
;; def=MonadicLetBindings.fst(133,0-136,31); use=MonadicLetBindings.fst(133,0-136,31)
(Prims.hasEq MonadicLetBindings.exp)
)
...
;; def=MonadicLetBindings.fst(133,0-136,31); use=MonadicLetBindings.fst(133,0-136,31)
(and 
;; def=MonadicLetBindings.fst(133,0-136,31); use=MonadicLetBindings.fst(135,14-135,17)
(or label_1
...
;; def=MonadicLetBindings.fst(133,0-136,31); use=MonadicLetBindings.fst(135,21-135,24)
(or label_2
...
;; def=MonadicLetBindings.fst(133,0-136,31); use=MonadicLetBindings.fst(133,0-136,31)
(and 
;; def=MonadicLetBindings.fst(133,0-136,31); use=MonadicLetBindings.fst(136,14-136,17)
(or label_3
...
;; def=MonadicLetBindings.fst(133,0-136,31); use=MonadicLetBindings.fst(136,21-136,24)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.exp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt assume MonadicLetBindings.exp__uu___haseq


; <Start encoding assume MonadicLetBindings.exp__uu___haseq>


; </end encoding assume MonadicLetBindings.exp__uu___haseq>


; encoding sigelt val MonadicLetBindings.uu___is_Const


; <Start encoding val MonadicLetBindings.uu___is_Const>

(declare-fun MonadicLetBindings.uu___is_Const (Term) Term)
;;;;;;;;;;;;;;;;projectee: exp -> Prims.bool
(declare-fun Tm_arrow_e7a1039b1f8fd3edc0a698f545c88934 () Term)
(declare-fun MonadicLetBindings.uu___is_Const@tok () Term)

; </end encoding val MonadicLetBindings.uu___is_Const>
...
; encoding sigelt val MonadicLetBindings.__proj__Const__item___0


; <Start encoding val MonadicLetBindings.__proj__Const__item___0>

(declare-fun Tm_refine_d405158072015f458f791f5ac15aeb94 () Term)
(declare-fun MonadicLetBindings.__proj__Const__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: exp{Const? _} -> Prims.int
(declare-fun Tm_arrow_0c1bf3cf50b3251fdd7e404ad6b4f1fc () Term)
(declare-fun MonadicLetBindings.__proj__Const__item___0@tok () Term)

; </end encoding val MonadicLetBindings.__proj__Const__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadicLetBindings.uu___is_Const; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(134,4-134,9); use=MonadicLetBindings.fst(134,4-134,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
MonadicLetBindings.exp)
(HasType (MonadicLetBindings.uu___is_Const @x0)
Prims.bool))
 

:pattern ((MonadicLetBindings.uu___is_Const @x0))
:qid typing_MonadicLetBindings.uu___is_Const))

:named typing_MonadicLetBindings.uu___is_Const))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
...
:named subterm_ordering_MonadicLetBindings.Addition))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name MonadicLetBindings.__proj__Const__item___0; Namespace MonadicLetBindings
(assert (! (HasType Tm_refine_d405158072015f458f791f5ac15aeb94
Tm_type)
:named refinement_kinding_Tm_refine_d405158072015f458f791f5ac15aeb94))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name MonadicLetBindings.__proj__Const__item___0; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(134,4-134,9); use=MonadicLetBindings.fst(134,4-134,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_d405158072015f458f791f5ac15aeb94)
(and (HasTypeFuel @u0
@x1
MonadicLetBindings.exp)

;; def=MonadicLetBindings.fst(134,4-134,9); use=MonadicLetBindings.fst(134,4-134,9)
(BoxBool_proj_0 (MonadicLetBindings.uu___is_Const @x1))
))
...
@x1
Tm_refine_d405158072015f458f791f5ac15aeb94))
:qid refinement_interpretation_Tm_refine_d405158072015f458f791f5ac15aeb94))

:named refinement_interpretation_Tm_refine_d405158072015f458f791f5ac15aeb94))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
...
Tm_type)
:named kinding_MonadicLetBindings.exp@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d405158072015f458f791f5ac15aeb94
;;; Fact-ids: Name MonadicLetBindings.__proj__Const__item___0; Namespace MonadicLetBindings
(assert (! (iff (Valid (Prims.hasEq Tm_refine_d405158072015f458f791f5ac15aeb94))
(Valid (Prims.hasEq MonadicLetBindings.exp)))
:named haseqTm_refine_d405158072015f458f791f5ac15aeb94))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(133,5-133,8); use=MonadicLetBindings.fst(133,5-133,8)
...
;; def=MonadicLetBindings.fst(134,4-134,9); use=MonadicLetBindings.fst(134,4-134,9)
(forall ((@x0 Term))
 (! (= (MonadicLetBindings.uu___is_Const @x0)
(BoxBool (is-MonadicLetBindings.Const @x0)))
 

:pattern ((MonadicLetBindings.uu___is_Const @x0))
:qid disc_equation_MonadicLetBindings.Const))

:named disc_equation_MonadicLetBindings.Const))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
...
:named constructor_distinct_MonadicLetBindings.Addition))
;;;;;;;;;;;;;;;;Assumption: MonadicLetBindings.exp__uu___haseq
;;; Fact-ids: Name MonadicLetBindings.exp__uu___haseq; Namespace MonadicLetBindings
(assert (! (Valid (Prims.hasEq MonadicLetBindings.exp))
:named assumption_MonadicLetBindings.exp__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name MonadicLetBindings.exp; Namespace MonadicLetBindings; Name MonadicLetBindings.Const; Namespace MonadicLetBindings; Name MonadicLetBindings.Addition; Namespace MonadicLetBindings; Name MonadicLetBindings.Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(133,5-133,8); use=MonadicLetBindings.fst(133,5-133,8)
...
; Encoding query formula : forall (projectee: _: MonadicLetBindings.exp{Const? _}).
;   (*  - Could not prove post-condition
...
(not 
;; def=MonadicLetBindings.fst(134,4-134,9); use=MonadicLetBindings.fst(134,4-134,9)
(BoxBool_proj_0 (MonadicLetBindings.uu___is_Const @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.__proj__Const__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_d405158072015f458f791f5ac15aeb94
...
; encoding sigelt val MonadicLetBindings.uu___is_Addition


; <Start encoding val MonadicLetBindings.uu___is_Addition>

(declare-fun MonadicLetBindings.uu___is_Addition (Term) Term)

(declare-fun MonadicLetBindings.uu___is_Addition@tok () Term)

; </end encoding val MonadicLetBindings.uu___is_Addition>


; encoding sigelt let uu___is_Addition


; <Skipped let uu___is_Addition/>


; encoding sigelt val MonadicLetBindings.__proj__Addition__item___0


; <Start encoding val MonadicLetBindings.__proj__Addition__item___0>

(declare-fun Tm_refine_63574e1869a11ca1d9c7d14d978c92a7 () Term)
(declare-fun MonadicLetBindings.__proj__Addition__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: exp{Addition? _} -> exp
(declare-fun Tm_arrow_d3beabacfe282885e2d16d7450d08051 () Term)
(declare-fun MonadicLetBindings.__proj__Addition__item___0@tok () Term)

; </end encoding val MonadicLetBindings.__proj__Addition__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadicLetBindings.uu___is_Addition; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
MonadicLetBindings.exp)
(HasType (MonadicLetBindings.uu___is_Addition @x0)
Prims.bool))
 

:pattern ((MonadicLetBindings.uu___is_Addition @x0))
:qid typing_MonadicLetBindings.uu___is_Addition))

:named typing_MonadicLetBindings.uu___is_Addition))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name MonadicLetBindings.__proj__Addition__item___0; Namespace MonadicLetBindings
(assert (! (HasType Tm_refine_63574e1869a11ca1d9c7d14d978c92a7
Tm_type)
:named refinement_kinding_Tm_refine_63574e1869a11ca1d9c7d14d978c92a7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name MonadicLetBindings.__proj__Addition__item___0; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_63574e1869a11ca1d9c7d14d978c92a7)
(and (HasTypeFuel @u0
@x1
MonadicLetBindings.exp)

;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
(BoxBool_proj_0 (MonadicLetBindings.uu___is_Addition @x1))
))
...
@x1
Tm_refine_63574e1869a11ca1d9c7d14d978c92a7))
:qid refinement_interpretation_Tm_refine_63574e1869a11ca1d9c7d14d978c92a7))

:named refinement_interpretation_Tm_refine_63574e1869a11ca1d9c7d14d978c92a7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_63574e1869a11ca1d9c7d14d978c92a7
;;; Fact-ids: Name MonadicLetBindings.__proj__Addition__item___0; Namespace MonadicLetBindings
(assert (! (iff (Valid (Prims.hasEq Tm_refine_63574e1869a11ca1d9c7d14d978c92a7))
(Valid (Prims.hasEq MonadicLetBindings.exp)))
:named haseqTm_refine_63574e1869a11ca1d9c7d14d978c92a7))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name MonadicLetBindings.uu___is_Addition; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
(forall ((@x0 Term))
 (! (= (MonadicLetBindings.uu___is_Addition @x0)
(BoxBool (is-MonadicLetBindings.Addition @x0)))
 

:pattern ((MonadicLetBindings.uu___is_Addition @x0))
:qid disc_equation_MonadicLetBindings.Addition))

:named disc_equation_MonadicLetBindings.Addition))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: MonadicLetBindings.exp{Addition? _}).
;   (*  - Could not prove post-condition
; *) ~(Addition? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Addition__item___0`
...
(not 
;; def=MonadicLetBindings.fst(135,4-135,12); use=MonadicLetBindings.fst(135,4-135,12)
(BoxBool_proj_0 (MonadicLetBindings.uu___is_Addition @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.__proj__Addition__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_63574e1869a11ca1d9c7d14d978c92a7
...
; encoding sigelt let __proj__Addition__item___0


; <Skipped let __proj__Addition__item___0/>


; encoding sigelt val MonadicLetBindings.__proj__Addition__item___1


; <Start encoding val MonadicLetBindings.__proj__Addition__item___1>


(declare-fun MonadicLetBindings.__proj__Addition__item___1 (Term) Term)


(declare-fun MonadicLetBindings.__proj__Addition__item___1@tok () Term)

; </end encoding val MonadicLetBindings.__proj__Addition__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Addition__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.__proj__Addition__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_63574e1869a11ca1d9c7d14d978c92a7
...
; encoding sigelt let __proj__Addition__item___1


; <Skipped let __proj__Addition__item___1/>


; encoding sigelt val MonadicLetBindings.uu___is_Division


; <Start encoding val MonadicLetBindings.uu___is_Division>

(declare-fun MonadicLetBindings.uu___is_Division (Term) Term)

(declare-fun MonadicLetBindings.uu___is_Division@tok () Term)

; </end encoding val MonadicLetBindings.uu___is_Division>


; encoding sigelt let uu___is_Division


; <Skipped let uu___is_Division/>


; encoding sigelt val MonadicLetBindings.__proj__Division__item___0


; <Start encoding val MonadicLetBindings.__proj__Division__item___0>

(declare-fun Tm_refine_217c480e43cb68047d7a89fd94e54252 () Term)
(declare-fun MonadicLetBindings.__proj__Division__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: exp{Division? _} -> exp
(declare-fun Tm_arrow_a4dd5557efadeff44b4b1d4d0f8b1405 () Term)
(declare-fun MonadicLetBindings.__proj__Division__item___0@tok () Term)

; </end encoding val MonadicLetBindings.__proj__Division__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MonadicLetBindings.uu___is_Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
MonadicLetBindings.exp)
(HasType (MonadicLetBindings.uu___is_Division @x0)
Prims.bool))
 

:pattern ((MonadicLetBindings.uu___is_Division @x0))
:qid typing_MonadicLetBindings.uu___is_Division))

:named typing_MonadicLetBindings.uu___is_Division))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name MonadicLetBindings.__proj__Division__item___0; Namespace MonadicLetBindings
(assert (! (HasType Tm_refine_217c480e43cb68047d7a89fd94e54252
Tm_type)
:named refinement_kinding_Tm_refine_217c480e43cb68047d7a89fd94e54252))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name MonadicLetBindings.__proj__Division__item___0; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_217c480e43cb68047d7a89fd94e54252)
(and (HasTypeFuel @u0
@x1
MonadicLetBindings.exp)

;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
(BoxBool_proj_0 (MonadicLetBindings.uu___is_Division @x1))
))
...
@x1
Tm_refine_217c480e43cb68047d7a89fd94e54252))
:qid refinement_interpretation_Tm_refine_217c480e43cb68047d7a89fd94e54252))

:named refinement_interpretation_Tm_refine_217c480e43cb68047d7a89fd94e54252))
;;;;;;;;;;;;;;;;haseq for Tm_refine_217c480e43cb68047d7a89fd94e54252
;;; Fact-ids: Name MonadicLetBindings.__proj__Division__item___0; Namespace MonadicLetBindings
(assert (! (iff (Valid (Prims.hasEq Tm_refine_217c480e43cb68047d7a89fd94e54252))
(Valid (Prims.hasEq MonadicLetBindings.exp)))
:named haseqTm_refine_217c480e43cb68047d7a89fd94e54252))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name MonadicLetBindings.uu___is_Division; Namespace MonadicLetBindings
(assert (! 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
(forall ((@x0 Term))
 (! (= (MonadicLetBindings.uu___is_Division @x0)
(BoxBool (is-MonadicLetBindings.Division @x0)))
 

:pattern ((MonadicLetBindings.uu___is_Division @x0))
:qid disc_equation_MonadicLetBindings.Division))

:named disc_equation_MonadicLetBindings.Division))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: MonadicLetBindings.exp{Division? _}).
;   (*  - Could not prove post-condition
; *) ~(Division? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Division__item___0`
...
(not 
;; def=MonadicLetBindings.fst(136,4-136,12); use=MonadicLetBindings.fst(136,4-136,12)
(BoxBool_proj_0 (MonadicLetBindings.uu___is_Division @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.__proj__Division__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_217c480e43cb68047d7a89fd94e54252
...
; encoding sigelt let __proj__Division__item___0


; <Skipped let __proj__Division__item___0/>


; encoding sigelt val MonadicLetBindings.__proj__Division__item___1


; <Start encoding val MonadicLetBindings.__proj__Division__item___1>


(declare-fun MonadicLetBindings.__proj__Division__item___1 (Term) Term)


(declare-fun MonadicLetBindings.__proj__Division__item___1@tok () Term)

; </end encoding val MonadicLetBindings.__proj__Division__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Division__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.__proj__Division__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_217c480e43cb68047d7a89fd94e54252
...
; encoding sigelt let __proj__Division__item___1


; <Skipped let __proj__Division__item___1/>

(push) ;; push{2

; Starting query at MonadicLetBindings.fst(139,4-147,35)

;;;;;;;;;;;;;;;;e : MonadicLetBindings.exp (MonadicLetBindings.exp)
(declare-fun x_66efaf146f0bdf852352b426871e22cd_0 () Term)
;;;;;;;;;;;;;;;;binder_x_66efaf146f0bdf852352b426871e22cd_0
;;; Fact-ids: 
(assert (! (HasType x_66efaf146f0bdf852352b426871e22cd_0
MonadicLetBindings.exp)
:named binder_x_66efaf146f0bdf852352b426871e22cd_0))
(declare-fun Tm_refine_e13cb32fab208868816b6cb3e170493f () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_e13cb32fab208868816b6cb3e170493f
Tm_type)
:named refinement_kinding_Tm_refine_e13cb32fab208868816b6cb3e170493f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(138,14-147,35); use=MonadicLetBindings.fst(138,14-147,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_e13cb32fab208868816b6cb3e170493f)
(and (HasTypeFuel @u0
@x1
MonadicLetBindings.exp)

;; def=MonadicLetBindings.fst(139,4-147,35); use=MonadicLetBindings.fst(139,4-147,35)

;; def=MonadicLetBindings.fst(139,4-147,35); use=MonadicLetBindings.fst(139,4-147,35)
(Valid 
;; def=MonadicLetBindings.fst(139,4-147,35); use=MonadicLetBindings.fst(139,4-147,35)
(Prims.precedes MonadicLetBindings.exp
MonadicLetBindings.exp
@x1
x_66efaf146f0bdf852352b426871e22cd_0)
)
...
@x1
Tm_refine_e13cb32fab208868816b6cb3e170493f))
:qid refinement_interpretation_Tm_refine_e13cb32fab208868816b6cb3e170493f))

:named refinement_interpretation_Tm_refine_e13cb32fab208868816b6cb3e170493f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e13cb32fab208868816b6cb3e170493f
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_e13cb32fab208868816b6cb3e170493f))
(Valid (Prims.hasEq MonadicLetBindings.exp)))
:named haseqTm_refine_e13cb32fab208868816b6cb3e170493f))
(declare-fun MonadicLetBindings.eval (Term) Term)

;;;;;;;;;;;;;;;;e: exp{e << e} -> FStar.Pervasives.Native.option Prims.int
(declare-fun Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b
Tm_type)
:named kinding_Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(138,14-147,35); use=MonadicLetBindings.fst(138,14-147,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b))
:qid MonadicLetBindings_pre_typing_Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b))

:named MonadicLetBindings_pre_typing_Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(138,14-147,35); use=MonadicLetBindings.fst(138,14-147,35)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid MonadicLetBindings_interpretation_Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b))
:qid MonadicLetBindings_interpretation_Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b))

:named MonadicLetBindings_interpretation_Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b))
(declare-fun MonadicLetBindings.eval@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(138,8-138,12); use=MonadicLetBindings.fst(138,8-138,12)
(forall ((@x0 Term))
 (! (= (ApplyTT MonadicLetBindings.eval@tok
@x0)
(MonadicLetBindings.eval @x0))
 

:pattern ((ApplyTT MonadicLetBindings.eval@tok
@x0))
:qid token_correspondence_MonadicLetBindings.eval))

:named token_correspondence_MonadicLetBindings.eval))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(138,8-138,12); use=MonadicLetBindings.fst(138,8-138,12)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MonadicLetBindings.eval@tok
Tm_arrow_8bf2cdacdb97bcc241db617bc7606a9b))
...
(forall ((@x1 Term))
 (! (= (ApplyTT MonadicLetBindings.eval@tok
@x1)
(MonadicLetBindings.eval @x1))
 

:pattern ((MonadicLetBindings.eval @x1))
:qid function_token_typing_MonadicLetBindings.eval.1))
)
 

:pattern ((ApplyTT @x0
MonadicLetBindings.eval@tok))
:qid function_token_typing_MonadicLetBindings.eval))

:named function_token_typing_MonadicLetBindings.eval))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=MonadicLetBindings.fst(138,8-138,12); use=MonadicLetBindings.fst(138,8-138,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_e13cb32fab208868816b6cb3e170493f)
(HasType (MonadicLetBindings.eval @x0)
(FStar.Pervasives.Native.option Prims.int)))
 

:pattern ((MonadicLetBindings.eval @x0))
:qid typing_MonadicLetBindings.eval))

:named typing_MonadicLetBindings.eval))
...
;   (forall (x: FStar.Pervasives.Native.option Prims.int). {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(Const? e) /\ ~(Addition? e) /\ ~(Division? e) ==> Prims.l_False) /\
;   (~(Const? e) ==>
;     (forall (b: MonadicLetBindings.exp) (b: MonadicLetBindings.exp).
;         e == MonadicLetBindings.Addition b b ==>
;         b << e /\
;         (forall (any_result: MonadicLetBindings.exp).
;             b == any_result ==>
;             (forall (any_result: FStar.Pervasives.Native.option Prims.int).
;                 MonadicLetBindings.eval b == any_result ==> b << e))) /\
;     (~(Addition? e) ==>
;       (forall (b: MonadicLetBindings.exp) (b: MonadicLetBindings.exp).
;           e == MonadicLetBindings.Division b b ==>
;           b << e /\
;           (forall (any_result: MonadicLetBindings.exp).
;               b == any_result ==>
;               (forall (any_result: FStar.Pervasives.Native.option Prims.int).
;                   MonadicLetBindings.eval b == any_result ==>
;                   (forall (_: Prims.int).
;                       (*  - Could not prove post-condition
; *)
;                       forall (k: Prims.pure_post (FStar.Pervasives.Native.option Prims.int)).
...
;; def=Prims.fst(402,27-402,88); use=MonadicLetBindings.fst(139,4-147,35)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(139,4-147,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(139,4-147,35)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=MonadicLetBindings.fst(139,4-147,35)
(and (implies 
;; def=MonadicLetBindings.fst(138,14-138,15); use=MonadicLetBindings.fst(139,10-139,11)
(and 
;; def=MonadicLetBindings.fst(138,14-138,15); use=MonadicLetBindings.fst(139,10-139,11)
(not 
;; def=MonadicLetBindings.fst(138,14-138,15); use=MonadicLetBindings.fst(139,10-139,11)
(BoxBool_proj_0 (MonadicLetBindings.uu___is_Const x_66efaf146f0bdf852352b426871e22cd_0))
)
...
(not 
;; def=MonadicLetBindings.fst(138,14-138,15); use=MonadicLetBindings.fst(139,10-139,11)
(BoxBool_proj_0 (MonadicLetBindings.uu___is_Addition x_66efaf146f0bdf852352b426871e22cd_0))
)
...
(not 
;; def=MonadicLetBindings.fst(138,14-138,15); use=MonadicLetBindings.fst(139,10-139,11)
(BoxBool_proj_0 (MonadicLetBindings.uu___is_Division x_66efaf146f0bdf852352b426871e22cd_0))
)
)

label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=MonadicLetBindings.fst(139,4-147,35)
(not 
;; def=MonadicLetBindings.fst(138,14-138,15); use=MonadicLetBindings.fst(139,10-139,11)
(BoxBool_proj_0 (MonadicLetBindings.uu___is_Const x_66efaf146f0bdf852352b426871e22cd_0))
)
...
;; def=Prims.fst(389,2-389,39); use=MonadicLetBindings.fst(139,4-147,35)
(and 
;; def=Prims.fst(413,99-413,120); use=MonadicLetBindings.fst(139,4-147,35)
(forall ((@x1 Term))
 (! (implies (HasType @x1
MonadicLetBindings.exp)
...
;; def=MonadicLetBindings.fst(138,14-141,16); use=MonadicLetBindings.fst(139,10-141,16)
(= x_66efaf146f0bdf852352b426871e22cd_0
(MonadicLetBindings.Addition @x1
@x2))
)
...
;; def=Prims.fst(459,77-459,89); use=MonadicLetBindings.fst(139,4-147,35)
(and 
;; def=MonadicLetBindings.fst(139,4-147,35); use=MonadicLetBindings.fst(141,34-141,35)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=MonadicLetBindings.fst(139,4-147,35)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
MonadicLetBindings.exp)

;; def=MonadicLetBindings.fst(138,14-141,14); use=MonadicLetBindings.fst(139,4-147,35)
(= @x1
@x3)
)
...
;; def=MonadicLetBindings.fst(44,12-141,35); use=MonadicLetBindings.fst(139,4-147,35)
(= (MonadicLetBindings.eval @x1)
@x4)
)

;; def=MonadicLetBindings.fst(139,4-147,35); use=MonadicLetBindings.fst(142,33-142,34)
(or label_3
...
;; def=MonadicLetBindings.fst(138,14-144,16); use=MonadicLetBindings.fst(139,10-144,16)
(= x_66efaf146f0bdf852352b426871e22cd_0
(MonadicLetBindings.Division @x1
@x2))
)
...
;; def=Prims.fst(459,77-459,89); use=MonadicLetBindings.fst(139,4-147,35)
(and 
;; def=MonadicLetBindings.fst(139,4-147,35); use=MonadicLetBindings.fst(144,32-144,33)
(or label_4
...
;; def=MonadicLetBindings.fst(138,14-144,16); use=MonadicLetBindings.fst(139,4-147,35)
(= @x2
@x3)
)
...
;; def=MonadicLetBindings.fst(38,12-144,33); use=MonadicLetBindings.fst(139,4-147,35)
(= (MonadicLetBindings.eval @x2)
@x4)
)

;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(139,4-147,35)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.int)
...
;; def=Prims.fst(402,27-402,88); use=MonadicLetBindings.fst(144,20-147,35)
(forall ((@x7 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(144,20-147,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MonadicLetBindings.fst(144,20-147,35)
(ApplyTT @x6
@x7)
...
;; def=Prims.fst(389,19-389,21); use=MonadicLetBindings.fst(144,20-147,35)
(not 
;; def=MonadicLetBindings.fst(144,27-145,20); use=MonadicLetBindings.fst(144,27-145,20)
(= @x5
(BoxInt 0))
)
)

;; def=Prims.fst(413,99-413,120); use=MonadicLetBindings.fst(144,20-147,35)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.int)

;; def=MonadicLetBindings.fst(144,27-146,20); use=MonadicLetBindings.fst(144,27-146,20)
(= @x5
@x7)
)

;; def=Prims.fst(459,77-459,89); use=MonadicLetBindings.fst(144,20-147,35)
(and 
;; def=MonadicLetBindings.fst(139,4-147,35); use=MonadicLetBindings.fst(146,38-146,39)
(or label_5
...
;; def=Prims.fst(451,66-451,102); use=MonadicLetBindings.fst(144,20-147,35)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
MonadicLetBindings.exp)

;; def=MonadicLetBindings.fst(138,14-144,14); use=MonadicLetBindings.fst(144,20-147,35)
(= @x1
@x8)
)
...
;; def=MonadicLetBindings.fst(38,12-146,39); use=MonadicLetBindings.fst(144,20-147,35)
(= (MonadicLetBindings.eval @x1)
@x9)
)

;; def=dummy(0,0-0,0); use=MonadicLetBindings.fst(144,20-147,35)
(forall ((@x10 Term))
 (! (implies (HasType @x10
Prims.int)

;; def=Prims.fst(686,22-686,28); use=MonadicLetBindings.fst(147,33-147,34)
(or label_6
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MonadicLetBindings.eval, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, MonadicLetBindings_pretyping_66efaf146f0bdf852352b426871e22cd, binder_x_66efaf146f0bdf852352b426871e22cd_0, disc_equation_MonadicLetBindings.Addition, disc_equation_MonadicLetBindings.Const, disc_equation_MonadicLetBindings.Division, fuel_guarded_inversion_MonadicLetBindings.exp, projection_inverse_BoxBool_proj_0, subterm_ordering_MonadicLetBindings.Addition, subterm_ordering_MonadicLetBindings.Division
