...
; Externals for module IntSort


; <Skipped val IntSort.sorted/>


; <Start encoding let rec sorted>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun IntSort.sorted.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun IntSort.sorted.fuel_instrumented_token () Term)
(declare-fun IntSort.sorted (Term) Term)
(declare-fun IntSort.sorted@tok () Term)
;;;;;;;;;;;;;;;;l: Prims.list Prims.int -> Prims.bool
(declare-fun Tm_arrow_cb3c103c2d81239d407e5929a4272a36 () Term)

; </end encoding let rec sorted>


; <Skipped val IntSort.test_sorted/>


; <Start encoding let test_sorted>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IntSort.test_sorted (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IntSort.test_sorted@tok () Term)

; </end encoding let test_sorted>


; <Skipped val IntSort.test_sorted2/>


; <Start encoding let test_sorted2>

(declare-fun IntSort.test_sorted2 (Term) Term)
(declare-fun Tm_refine_8940e385d966068a5e15c2861dbb927f () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> m: Prims.list Prims.int {sorted m}
(declare-fun Tm_arrow_0b00cb4e0ae1cffedac3a0a6748c339b () Term)
(declare-fun IntSort.test_sorted2@tok () Term)


; </end encoding let test_sorted2>


; <Skipped val IntSort.sorted_smaller/>


; <Start encoding let rec sorted_smaller>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun IntSort.sorted_smaller (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun IntSort.sorted_smaller@tok () Term)

; </end encoding let rec sorted_smaller>


; <Start encoding let permutation>

(declare-fun IntSort.permutation (Term Term) Term)
;;;;;;;;;;;;;;;;l1: Prims.list Prims.int -> l2: Prims.list Prims.int -> Prims.logical
(declare-fun Tm_arrow_0145e299ff986e84e8cf7c6fc23af2ed () Term)
(declare-fun IntSort.permutation@tok () Term)

; </end encoding let permutation>


; <Start encoding let permutation_2>

(declare-fun IntSort.permutation_2 (Term Term Term) Term)
;;;;;;;;;;;;;;;;l: Prims.list Prims.int -> l1: Prims.list Prims.int -> l2: Prims.list Prims.int -> Prims.logical
(declare-fun Tm_arrow_003bffcb67e36704e15114ac47a24966 () Term)
(declare-fun IntSort.permutation_2@tok () Term)

; </end encoding let permutation_2>


; End Externals for module IntSort

(push) ;; push{1

; Internals for InsertionSort


; encoding sigelt val InsertionSort.insert


; <Skipped val InsertionSort.insert/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IntSort.sorted; Namespace IntSort
(assert (! 
;; def=IntSort.fst(21,8-21,14); use=IntSort.fst(21,8-21,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(Prims.list Prims.int))
(HasType (IntSort.sorted @x0)
Prims.bool))
 

:pattern ((IntSort.sorted @x0))
:qid typing_IntSort.sorted))

:named typing_IntSort.sorted))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IntSort.permutation; Namespace IntSort
(assert (! 
;; def=IntSort.fst(45,5-45,16); use=IntSort.fst(45,5-45,16)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(Prims.list Prims.int))
(HasType @x1
(Prims.list Prims.int)))
(HasType (IntSort.permutation @x0
@x1)
Prims.logical))
 

:pattern ((IntSort.permutation @x0
@x1))
:qid typing_IntSort.permutation))

:named typing_IntSort.permutation))
;;;;;;;;;;;;;;;;free var typing
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
(Prims.list Prims.int))
(HasType (IntSort.sorted.fuel_instrumented @u0
@x1)
Prims.bool))
 

:pattern ((IntSort.sorted.fuel_instrumented @u0
@x1))
:qid token_correspondence_IntSort.sorted.fuel_instrumented))

:named token_correspondence_IntSort.sorted.fuel_instrumented))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name FStar.List.Tot.Base.mem; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(240,8-240,11); use=FStar.List.Tot.Base.fst(240,8-240,11)
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name IntSort.test_sorted2; Namespace IntSort
(assert (! (HasType Tm_refine_8940e385d966068a5e15c2861dbb927f
Tm_type)
:named refinement_kinding_Tm_refine_8940e385d966068a5e15c2861dbb927f))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name IntSort.test_sorted2; Namespace IntSort
(assert (! 
;; def=IntSort.fst(29,30-29,52); use=IntSort.fst(30,4-30,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_8940e385d966068a5e15c2861dbb927f)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=IntSort.fst(29,42-29,50); use=IntSort.fst(30,4-30,16)
(BoxBool_proj_0 (IntSort.sorted @x1))
))
...
@x1
Tm_refine_8940e385d966068a5e15c2861dbb927f))
:qid refinement_interpretation_Tm_refine_8940e385d966068a5e15c2861dbb927f))

:named refinement_interpretation_Tm_refine_8940e385d966068a5e15c2861dbb927f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;Lemma: IntSort.sorted_smaller
;;; Fact-ids: Name IntSort.sorted_smaller; Namespace IntSort
...
;; def=IntSort.fst(37,37-37,50); use=IntSort.fst(40,8-40,22)
(BoxBool_proj_0 (IntSort.sorted.fuel_instrumented ZFuel
(Prims.Cons Prims.int
@x0
@x2)))


;; def=IntSort.fst(37,54-37,61); use=IntSort.fst(40,8-40,22)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem.fuel_instrumented ZFuel
Prims.int
@x1
@x2))
)

;; def=IntSort.fst(38,35-38,43); use=IntSort.fst(40,8-40,22)
(<= (BoxInt_proj_0 @x0)
(BoxInt_proj_0 @x1))
)
 

:pattern ((IntSort.sorted.fuel_instrumented ZFuel
(Prims.Cons Prims.int
@x0
@x2)) (FStar.List.Tot.Base.mem.fuel_instrumented ZFuel
Prims.int
@x1
@x2))
:qid lemma_IntSort.sorted_smaller))
:named lemma_IntSort.sorted_smaller))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_8940e385d966068a5e15c2861dbb927f
;;; Fact-ids: Name IntSort.test_sorted2; Namespace IntSort
(assert (! (iff (Valid (Prims.hasEq Tm_refine_8940e385d966068a5e15c2861dbb927f))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_8940e385d966068a5e15c2861dbb927f))
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: IntSort.sorted
;;; Fact-ids: Name IntSort.sorted; Namespace IntSort
(assert (! 
;; def=IntSort.fst(21,8-21,14); use=IntSort.fst(21,8-21,14)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
(Prims.list Prims.int))
(= (IntSort.sorted.fuel_instrumented (SFuel @u0)
@x1)
(let ((@lb2 @x1))
...
(BoxBool true)
(ite (and (is-Prims.Cons @lb2)
(is-Prims.Cons (Prims.Cons_tl @lb2)))
(Prims.op_AmpAmp (Prims.op_LessThanOrEqual (Prims.Cons_hd @lb2)
(Prims.Cons_hd (Prims.Cons_tl @lb2)))
(IntSort.sorted.fuel_instrumented @u0
(Prims.Cons Prims.int
(Prims.Cons_hd (Prims.Cons_tl @lb2))
(Prims.Cons_tl (Prims.Cons_tl @lb2)))))
Tm_unit))))))
 :weight 0


:pattern ((IntSort.sorted.fuel_instrumented (SFuel @u0)
@x1))
:qid equation_with_fuel_IntSort.sorted.fuel_instrumented))

:named equation_with_fuel_IntSort.sorted.fuel_instrumented))
...
;;;;;;;;;;;;;;;;Equation for IntSort.permutation
;;; Fact-ids: Name IntSort.permutation; Namespace IntSort
(assert (! 
;; def=IntSort.fst(45,5-45,16); use=IntSort.fst(45,5-45,16)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Valid (IntSort.permutation @x0
@x1))

;; def=IntSort.fst(46,4-46,60); use=IntSort.fst(46,4-46,60)
(and 
;; def=IntSort.fst(46,4-46,25); use=IntSort.fst(46,4-46,25)
...
;; def=IntSort.fst(46,29-46,60); use=IntSort.fst(46,29-46,60)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=IntSort.fst(46,40-46,59); use=IntSort.fst(46,40-46,59)
...
;;no pats
:qid equation_IntSort.permutation.1))
)
)
...
:pattern ((IntSort.permutation @x0
@x1))
:qid equation_IntSort.permutation))

:named equation_IntSort.permutation))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;;;;;;;;;;;;;;;;Prop-typing for IntSort.permutation
;;; Fact-ids: Name IntSort.permutation; Namespace IntSort
(assert (! 
;; def=IntSort.fst(45,5-45,16); use=IntSort.fst(45,5-45,16)
(forall ((@x0 Term) (@x1 Term))
...
(HasType @x1
(Prims.list Prims.int)))
(Valid (Prims.subtype_of (IntSort.permutation @x0
@x1)
Prims.unit)))
 

:pattern ((Prims.subtype_of (IntSort.permutation @x0
@x1)
Prims.unit))
:qid defn_equation_IntSort.permutation))

:named defn_equation_IntSort.permutation))
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (= (IntSort.sorted.fuel_instrumented (SFuel @u0)
@x1)
(IntSort.sorted.fuel_instrumented ZFuel
@x1))
 

:pattern ((IntSort.sorted.fuel_instrumented (SFuel @u0)
@x1))
:qid @fuel_irrelevance_IntSort.sorted.fuel_instrumented))

:named @fuel_irrelevance_IntSort.sorted.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name FStar.List.Tot.Base.mem; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(240,8-240,11); use=FStar.List.Tot.Base.fst(240,8-240,11)
...
(forall ((@x0 Term))
 (! (= (IntSort.sorted @x0)
(IntSort.sorted.fuel_instrumented MaxFuel
@x0))
 

:pattern ((IntSort.sorted @x0))
:qid @fuel_correspondence_IntSort.sorted.fuel_instrumented))

:named @fuel_correspondence_IntSort.sorted.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name FStar.List.Tot.Base.mem; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(240,8-240,11); use=FStar.List.Tot.Base.fst(240,8-240,11)
...
; Starting query at InsertionSort.fst(26,21-33,18)

;;;;;;;;;;;;;;;;i : Prims.int (Prims.int)
...
;;;;;;;;;;;;;;;;l : l: Prims.list Prims.int {IntSort.sorted l} (l: Prims.list Prims.int {IntSort.sorted l})
(declare-fun x_4bb3e7f5f20a26f76ed0f345eab0aa93_1 () Term)

;;;;;;;;;;;;;;;;binder_x_4bb3e7f5f20a26f76ed0f345eab0aa93_1
;;; Fact-ids: 
(assert (! (HasType x_4bb3e7f5f20a26f76ed0f345eab0aa93_1
Tm_refine_8940e385d966068a5e15c2861dbb927f)
:named binder_x_4bb3e7f5f20a26f76ed0f345eab0aa93_1))
(declare-fun Tm_refine_1a2e5e19e69215581d90b3675b0da367 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(24,13-33,18); use=InsertionSort.fst(24,13-33,18)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_1a2e5e19e69215581d90b3675b0da367 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_1a2e5e19e69215581d90b3675b0da367 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_1a2e5e19e69215581d90b3675b0da367))

:named refinement_kinding_Tm_refine_1a2e5e19e69215581d90b3675b0da367))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(24,13-33,18); use=InsertionSort.fst(24,13-33,18)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1a2e5e19e69215581d90b3675b0da367 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=InsertionSort.fst(24,33-24,41); use=InsertionSort.fst(26,8-26,14)
(BoxBool_proj_0 (IntSort.sorted @x1))
...
;; def=InsertionSort.fst(24,13-33,18); use=InsertionSort.fst(24,13-33,18)
(or 
;; def=InsertionSort.fst(26,21-33,18); use=InsertionSort.fst(26,21-33,18)
(Valid 
;; def=InsertionSort.fst(26,21-33,18); use=InsertionSort.fst(26,21-33,18)
...
;; def=InsertionSort.fst(24,13-33,18); use=InsertionSort.fst(24,13-33,18)
(and 
;; def=InsertionSort.fst(24,13-26,16); use=InsertionSort.fst(24,13-26,16)
(Valid 
;; def=InsertionSort.fst(24,13-26,16); use=InsertionSort.fst(24,13-26,16)
...
(Prims.list Prims.int)
@x1
x_4bb3e7f5f20a26f76ed0f345eab0aa93_1)
)
)
)
...
@x1
(Tm_refine_1a2e5e19e69215581d90b3675b0da367 @x2)))
:qid refinement_interpretation_Tm_refine_1a2e5e19e69215581d90b3675b0da367))

:named refinement_interpretation_Tm_refine_1a2e5e19e69215581d90b3675b0da367))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1a2e5e19e69215581d90b3675b0da367
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(24,13-33,18); use=InsertionSort.fst(24,13-33,18)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1a2e5e19e69215581d90b3675b0da367 @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_1a2e5e19e69215581d90b3675b0da367 @x0))))
:qid haseqTm_refine_1a2e5e19e69215581d90b3675b0da367))

:named haseqTm_refine_1a2e5e19e69215581d90b3675b0da367))
(declare-fun InsertionSort.insert (Term Term) Term)

(declare-fun Tm_refine_adfe81fccfdafe0df3fcf496690ab0da (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(26,8-26,14)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_adfe81fccfdafe0df3fcf496690ab0da))

:named refinement_kinding_Tm_refine_adfe81fccfdafe0df3fcf496690ab0da))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(26,8-26,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=InsertionSort.fst(25,22-25,30); use=InsertionSort.fst(26,8-26,14)
(BoxBool_proj_0 (IntSort.sorted @x1))


;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(26,8-26,14)
(Valid 
;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(26,8-26,14)
(IntSort.permutation (Prims.Cons Prims.int
@x2
@x3)
@x1)
)
...
(Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x2
@x3)))
:qid refinement_interpretation_Tm_refine_adfe81fccfdafe0df3fcf496690ab0da))

:named refinement_interpretation_Tm_refine_adfe81fccfdafe0df3fcf496690ab0da))
;;;;;;;;;;;;;;;;haseq for Tm_refine_adfe81fccfdafe0df3fcf496690ab0da
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(26,8-26,14)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x0
@x1)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x0
@x1))))
:qid haseqTm_refine_adfe81fccfdafe0df3fcf496690ab0da))

:named haseqTm_refine_adfe81fccfdafe0df3fcf496690ab0da))
;;;;;;;;;;;;;;;;i: Prims.int -> l: (l: Prims.list Prims.int {IntSort.sorted l}){i << i \/ i === i /\ l << l}   -> m: Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation (i :: l) m}
(declare-fun Tm_arrow_df3088d20de0d5237c5cde5804bdb933 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_df3088d20de0d5237c5cde5804bdb933
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_df3088d20de0d5237c5cde5804bdb933
Tm_type)
:named kinding_Tm_arrow_df3088d20de0d5237c5cde5804bdb933))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(24,13-33,18); use=InsertionSort.fst(24,13-33,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_df3088d20de0d5237c5cde5804bdb933)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_df3088d20de0d5237c5cde5804bdb933))
:qid InsertionSort_pre_typing_Tm_arrow_df3088d20de0d5237c5cde5804bdb933))

:named InsertionSort_pre_typing_Tm_arrow_df3088d20de0d5237c5cde5804bdb933))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_df3088d20de0d5237c5cde5804bdb933
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(24,13-33,18); use=InsertionSort.fst(24,13-33,18)
(forall ((@x0 Term))
...
Prims.int)
(HasType @x2
(Tm_refine_1a2e5e19e69215581d90b3675b0da367 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
(Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x1
@x2)))
...
@x1)
@x2))
:qid InsertionSort_interpretation_Tm_arrow_df3088d20de0d5237c5cde5804bdb933.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid InsertionSort_interpretation_Tm_arrow_df3088d20de0d5237c5cde5804bdb933.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_df3088d20de0d5237c5cde5804bdb933))
:qid InsertionSort_interpretation_Tm_arrow_df3088d20de0d5237c5cde5804bdb933))

:named InsertionSort_interpretation_Tm_arrow_df3088d20de0d5237c5cde5804bdb933))
(declare-fun InsertionSort.insert@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(26,8-26,14); use=InsertionSort.fst(26,8-26,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT InsertionSort.insert@tok
@x0)
@x1)
(InsertionSort.insert @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT InsertionSort.insert@tok
@x0)
@x1))
:qid token_correspondence_InsertionSort.insert))

:named token_correspondence_InsertionSort.insert))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(26,8-26,14); use=InsertionSort.fst(26,8-26,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType InsertionSort.insert@tok
Tm_arrow_df3088d20de0d5237c5cde5804bdb933))
...
@x1)
@x2)
(InsertionSort.insert @x1
@x2))
 

:pattern ((InsertionSort.insert @x1
@x2))
:qid function_token_typing_InsertionSort.insert.1))
)
 

:pattern ((ApplyTT @x0
InsertionSort.insert@tok))
:qid function_token_typing_InsertionSort.insert))

:named function_token_typing_InsertionSort.insert))
...
Prims.int)
(HasType @x1
(Tm_refine_1a2e5e19e69215581d90b3675b0da367 @x0)))
(HasType (InsertionSort.insert @x0
@x1)
(Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x0
@x1)))
 

:pattern ((InsertionSort.insert @x0
@x1))
:qid typing_InsertionSort.insert))

:named typing_InsertionSort.insert))
...
(declare-fun Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c
Tm_type)
:named refinement_kinding_Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(26,21-33,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=InsertionSort.fst(25,22-25,30); use=InsertionSort.fst(26,21-33,18)
(BoxBool_proj_0 (IntSort.sorted @x1))


;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(26,21-33,18)
(Valid 
;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(26,21-33,18)
(IntSort.permutation (Prims.Cons Prims.int
x_ae567c2fb75be05905677af440075565_0
...
@x1
Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c))
:qid refinement_interpretation_Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c))

:named refinement_interpretation_Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_36ec5022ac323da8a4e47c0bc87a6a1c))

(declare-fun Tm_refine_7d27f65491c760eed369810570f38690 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(26,21-33,18)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_7d27f65491c760eed369810570f38690 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_7d27f65491c760eed369810570f38690 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_7d27f65491c760eed369810570f38690))

:named refinement_kinding_Tm_refine_7d27f65491c760eed369810570f38690))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(26,21-33,18)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7d27f65491c760eed369810570f38690 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))
...
@x1
(Tm_refine_7d27f65491c760eed369810570f38690 @x2)))
:qid refinement_interpretation_Tm_refine_7d27f65491c760eed369810570f38690))

:named refinement_interpretation_Tm_refine_7d27f65491c760eed369810570f38690))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7d27f65491c760eed369810570f38690
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(26,21-33,18)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7d27f65491c760eed369810570f38690 @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7d27f65491c760eed369810570f38690 @x0))))
:qid haseqTm_refine_7d27f65491c760eed369810570f38690))

:named haseqTm_refine_7d27f65491c760eed369810570f38690))



; Encoding query formula : forall (k:
;   Prims.pure_post (m: Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation (i :: l) m})).
;   (forall (x: m: Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation (i :: l) m}).
;       {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;   (l == [] ==> IntSort.sorted [i] /\ IntSort.permutation (i :: l) [i]) /\
;   (~(Nil? l) ==>
;     (forall (b: Prims.int) (b: Prims.list Prims.int).
;         l == b :: b ==>
;         (forall (k:
;             Prims.pure_post (m:
;                 Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation (i :: l) m})).
;             (forall (x:
;                 m: Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation (i :: l) m}).
;                 {:pattern Prims.guard_free (k x)}
;                 Prims.auto_squash (k x)) ==>
;             (i <= b == true ==> IntSort.sorted (i :: l) /\ IntSort.permutation (i :: l) (i :: l)) /\
;             (~(i <= b = true) ==>
;               (forall (b: Prims.bool).
;                   i <= b == b ==>
;                   IntSort.sorted b /\ (i << i \/ b << l) /\
;                   (forall (any_result: Prims.list Prims.int).
;                       b == any_result ==>
;                       (forall (any_result:
;                           m:
;                           Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation (i :: b) m})
;                         .
;                           InsertionSort.insert i b == any_result ==>
;                           (~(Cons? (InsertionSort.insert i b)) ==> Prims.l_False) /\
;                           (forall (b: Prims.int) (b: Prims.list Prims.int).
;                               InsertionSort.insert i b == b :: b ==>
;                               (forall (k: Prims.pure_post Prims.unit).
;                                   (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)}
;                                       IntSort.sorted (b :: InsertionSort.insert i b) /\
;                                       IntSort.permutation (i :: l) (b :: InsertionSort.insert i b) ==>
;                                       k x) ==>
;                                   (FStar.List.Tot.Base.mem b b == true ==>
;                                     IntSort.sorted (b :: b) /\ FStar.List.Tot.Base.mem b b /\
;                                     (forall (pure_result: Prims.unit). b <= b ==> k pure_result)) /\
;                                   (~(FStar.List.Tot.Base.mem b b = true) ==>
;                                     (forall (b: Prims.bool).
;                                         FStar.List.Tot.Base.mem b b == b ==>
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c))

;; def=Prims.fst(402,27-402,88); use=InsertionSort.fst(26,21-33,18)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=InsertionSort.fst(26,21-33,18)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort.fst(26,21-33,18)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort.fst(26,21-33,18)
(and (implies 
;; def=InsertionSort.fst(26,17-26,18); use=InsertionSort.fst(26,27-26,28)
(and 
;; def=InsertionSort.fst(26,17-26,18); use=InsertionSort.fst(26,27-26,28)
(not 
;; def=InsertionSort.fst(26,17-26,18); use=InsertionSort.fst(26,27-26,28)
...
label_1)
(implies 
;; def=InsertionSort.fst(26,17-27,6); use=InsertionSort.fst(26,27-27,6)
(= x_4bb3e7f5f20a26f76ed0f345eab0aa93_1
(Prims.Nil Prims.int))


;; def=InsertionSort.fst(25,22-25,54); use=InsertionSort.fst(27,10-27,13)
(and 
;; def=InsertionSort.fst(25,22-25,30); use=InsertionSort.fst(27,10-27,13)
(or label_2

;; def=InsertionSort.fst(25,22-25,30); use=InsertionSort.fst(27,10-27,13)
(BoxBool_proj_0 (IntSort.sorted (Prims.Cons Prims.int
x_ae567c2fb75be05905677af440075565_0
(Prims.Nil Prims.int))))
)


;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(27,10-27,13)
(or label_3
...
(implies 
;; def=Prims.fst(389,19-389,21); use=InsertionSort.fst(26,21-33,18)
(not 
;; def=InsertionSort.fst(26,17-26,18); use=InsertionSort.fst(26,27-26,28)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_4bb3e7f5f20a26f76ed0f345eab0aa93_1))
...
;; def=Prims.fst(413,99-413,120); use=InsertionSort.fst(26,21-33,18)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=InsertionSort.fst(26,17-28,10); use=InsertionSort.fst(26,27-28,10)
(= x_4bb3e7f5f20a26f76ed0f345eab0aa93_1
(Prims.Cons Prims.int
@x1
@x2))
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort.fst(26,21-33,18)
(and (implies 
;; def=InsertionSort.fst(29,8-29,15); use=InsertionSort.fst(29,8-29,15)
(= (Prims.op_LessThanOrEqual x_ae567c2fb75be05905677af440075565_0
@x1)
(BoxBool true))


;; def=InsertionSort.fst(25,22-25,54); use=InsertionSort.fst(29,21-29,25)
(and 
;; def=InsertionSort.fst(25,22-25,30); use=InsertionSort.fst(29,21-29,25)
(or label_4
...
;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(29,21-29,25)
(or label_5
...
;; def=InsertionSort.fst(29,8-33,18); use=InsertionSort.fst(29,8-33,18)
(= (Prims.op_LessThanOrEqual x_ae567c2fb75be05905677af440075565_0
@x1)
@x4)
)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort.fst(26,21-33,18)
(and 
;; def=InsertionSort.fst(24,33-24,41); use=InsertionSort.fst(30,30-30,32)
(or label_6

;; def=InsertionSort.fst(24,33-24,41); use=InsertionSort.fst(30,30-30,32)
(BoxBool_proj_0 (IntSort.sorted @x2))
)


;; def=InsertionSort.fst(24,13-33,18); use=InsertionSort.fst(30,30-30,32)
(or label_7

;; def=InsertionSort.fst(26,21-33,18); use=InsertionSort.fst(30,30-30,32)
(Valid 
;; def=InsertionSort.fst(26,21-33,18); use=InsertionSort.fst(30,30-30,32)
(Prims.precedes Prims.int
Prims.int
...
;; def=Prims.fst(451,66-451,102); use=InsertionSort.fst(26,21-33,18)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.list Prims.int))

;; def=InsertionSort.fst(24,22-28,10); use=InsertionSort.fst(26,21-33,18)
(= @x2
@x5)
)
...
;; def=InsertionSort.fst(30,14-30,32); use=InsertionSort.fst(30,14-30,32)
(= (InsertionSort.insert x_ae567c2fb75be05905677af440075565_0
@x2)
@x6)
)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort.fst(26,21-33,18)
(and (implies 
;; def=InsertionSort.fst(31,15-31,19); use=InsertionSort.fst(31,15-31,19)
(not 
;; def=InsertionSort.fst(31,15-31,19); use=InsertionSort.fst(31,15-31,19)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
(InsertionSort.insert x_ae567c2fb75be05905677af440075565_0
...
;; def=Prims.fst(402,2-402,97); use=InsertionSort.fst(26,21-33,18)
(forall ((@x9 Term))
...
(forall ((@x10 Term))
 (! (implies 
;; def=InsertionSort.fst(25,22-25,54); use=InsertionSort.fst(33,10-33,18)
(and 
;; def=InsertionSort.fst(25,22-25,30); use=InsertionSort.fst(33,10-33,18)
(or label_9
...
;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(33,10-33,18)
(or label_10
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort.fst(26,21-33,18)
(and (implies 
;; def=InsertionSort.fst(32,13-32,21); use=InsertionSort.fst(32,13-32,21)
(= (FStar.List.Tot.Base.mem Prims.int
@x7
@x2)
(BoxBool true))
...
;; def=Prims.fst(441,29-441,97); use=InsertionSort.fst(32,27-32,41)
(and 
;; def=IntSort.fst(37,37-37,50); use=InsertionSort.fst(32,27-32,41)
(or label_11
...
;; def=IntSort.fst(37,54-37,61); use=InsertionSort.fst(32,27-32,41)
(or label_12
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort.fst(32,27-32,41)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=IntSort.fst(38,35-38,43); use=InsertionSort.fst(32,27-32,41)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x7))
)

;; def=Prims.fst(441,83-441,96); use=InsertionSort.fst(32,27-32,41)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort.fst(32,27-32,41)
(ApplyTT @x9
@x10)
...
;; def=InsertionSort.fst(32,10-32,49); use=InsertionSort.fst(32,10-32,49)
(= (FStar.List.Tot.Base.mem Prims.int
@x7
@x2)
@x10)
...
;; def=Prims.fst(451,90-451,102); use=InsertionSort.fst(26,21-33,18)
(Valid 
;; def=Prims.fst(451,90-451,102); use=InsertionSort.fst(26,21-33,18)
(ApplyTT @x9
@x11)
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun InsertionSort.insert.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun InsertionSort.insert.fuel_instrumented_token () Term)
(declare-fun InsertionSort.insert (Term Term) Term)
(declare-fun InsertionSort.insert@tok () Term)
...
;;;;;;;;;;;;;;;;i: Prims.int -> l: Prims.list Prims.int {IntSort.sorted l}   -> m: Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation (i :: l) m}
(declare-fun Tm_arrow_5a5efdf8ab215b3286dc339e511eb69c () Term)


; </end encoding let rec insert>


; encoding sigelt val InsertionSort.insert_implicit


; <Skipped val InsertionSort.insert_implicit/>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name InsertionSort.insert; Namespace InsertionSort
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(26,8-26,14)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x0
...
; Starting query at InsertionSort.fst(38,30-42,36)
...
Tm_refine_8940e385d966068a5e15c2861dbb927f)
:named binder_x_4bb3e7f5f20a26f76ed0f345eab0aa93_1))
(declare-fun Tm_refine_6309e99079d1cf420cacc4470f98f858 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(36,22-42,36); use=InsertionSort.fst(36,22-42,36)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_6309e99079d1cf420cacc4470f98f858 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_6309e99079d1cf420cacc4470f98f858 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_6309e99079d1cf420cacc4470f98f858))

:named refinement_kinding_Tm_refine_6309e99079d1cf420cacc4470f98f858))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(36,22-42,36); use=InsertionSort.fst(36,22-42,36)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6309e99079d1cf420cacc4470f98f858 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=InsertionSort.fst(36,42-36,50); use=InsertionSort.fst(38,8-38,23)
(BoxBool_proj_0 (IntSort.sorted @x1))
...
;; def=InsertionSort.fst(36,22-42,36); use=InsertionSort.fst(36,22-42,36)
(or 
;; def=InsertionSort.fst(38,30-42,36); use=InsertionSort.fst(38,30-42,36)
(Valid 
;; def=InsertionSort.fst(38,30-42,36); use=InsertionSort.fst(38,30-42,36)
(Prims.precedes Prims.int
Prims.int
...
;; def=InsertionSort.fst(36,22-42,36); use=InsertionSort.fst(36,22-42,36)
(and 
;; def=InsertionSort.fst(36,22-38,25); use=InsertionSort.fst(36,22-38,25)
(Valid 
;; def=InsertionSort.fst(36,22-38,25); use=InsertionSort.fst(36,22-38,25)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
@x1
(Tm_refine_6309e99079d1cf420cacc4470f98f858 @x2)))
:qid refinement_interpretation_Tm_refine_6309e99079d1cf420cacc4470f98f858))

:named refinement_interpretation_Tm_refine_6309e99079d1cf420cacc4470f98f858))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6309e99079d1cf420cacc4470f98f858
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(36,22-42,36); use=InsertionSort.fst(36,22-42,36)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6309e99079d1cf420cacc4470f98f858 @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6309e99079d1cf420cacc4470f98f858 @x0))))
:qid haseqTm_refine_6309e99079d1cf420cacc4470f98f858))

:named haseqTm_refine_6309e99079d1cf420cacc4470f98f858))
(declare-fun InsertionSort.insert_implicit (Term Term) Term)


;;;;;;;;;;;;;;;;i: Prims.int -> l: (l: Prims.list Prims.int {IntSort.sorted l}){i << i \/ i === i /\ l << l}   -> m: Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation (i :: l) m}
(declare-fun Tm_arrow_ff51f10d9ff9c3937ea42e20390da657 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ff51f10d9ff9c3937ea42e20390da657
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_ff51f10d9ff9c3937ea42e20390da657
Tm_type)
:named kinding_Tm_arrow_ff51f10d9ff9c3937ea42e20390da657))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(36,22-42,36); use=InsertionSort.fst(36,22-42,36)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ff51f10d9ff9c3937ea42e20390da657)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_ff51f10d9ff9c3937ea42e20390da657))
:qid InsertionSort_pre_typing_Tm_arrow_ff51f10d9ff9c3937ea42e20390da657))

:named InsertionSort_pre_typing_Tm_arrow_ff51f10d9ff9c3937ea42e20390da657))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ff51f10d9ff9c3937ea42e20390da657
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(36,22-42,36); use=InsertionSort.fst(36,22-42,36)
(forall ((@x0 Term))
...
Prims.int)
(HasType @x2
(Tm_refine_6309e99079d1cf420cacc4470f98f858 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
(Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x1
...
@x1)
@x2))
:qid InsertionSort_interpretation_Tm_arrow_ff51f10d9ff9c3937ea42e20390da657.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid InsertionSort_interpretation_Tm_arrow_ff51f10d9ff9c3937ea42e20390da657.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_ff51f10d9ff9c3937ea42e20390da657))
:qid InsertionSort_interpretation_Tm_arrow_ff51f10d9ff9c3937ea42e20390da657))

:named InsertionSort_interpretation_Tm_arrow_ff51f10d9ff9c3937ea42e20390da657))
(declare-fun InsertionSort.insert_implicit@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(38,8-38,23); use=InsertionSort.fst(38,8-38,23)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT InsertionSort.insert_implicit@tok
@x0)
@x1)
(InsertionSort.insert_implicit @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT InsertionSort.insert_implicit@tok
@x0)
@x1))
:qid token_correspondence_InsertionSort.insert_implicit))

:named token_correspondence_InsertionSort.insert_implicit))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(38,8-38,23); use=InsertionSort.fst(38,8-38,23)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType InsertionSort.insert_implicit@tok
Tm_arrow_ff51f10d9ff9c3937ea42e20390da657))
...
@x1)
@x2)
(InsertionSort.insert_implicit @x1
@x2))
 

:pattern ((InsertionSort.insert_implicit @x1
@x2))
:qid function_token_typing_InsertionSort.insert_implicit.1))
)
 

:pattern ((ApplyTT @x0
InsertionSort.insert_implicit@tok))
:qid function_token_typing_InsertionSort.insert_implicit))

:named function_token_typing_InsertionSort.insert_implicit))
...
Prims.int)
(HasType @x1
(Tm_refine_6309e99079d1cf420cacc4470f98f858 @x0)))
(HasType (InsertionSort.insert_implicit @x0
@x1)
(Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x0
@x1)))
 

:pattern ((InsertionSort.insert_implicit @x0
@x1))
:qid typing_InsertionSort.insert_implicit))

:named typing_InsertionSort.insert_implicit))
(declare-fun label_9 () Bool)
(declare-fun label_8 () Bool)
(declare-fun label_7 () Bool)
(declare-fun label_6 () Bool)
...
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(37,10-37,56); use=InsertionSort.fst(38,30-42,36)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_36ec5022ac323da8a4e47c0bc87a6a1c)
...
;; def=InsertionSort.fst(37,22-37,30); use=InsertionSort.fst(38,30-42,36)
(BoxBool_proj_0 (IntSort.sorted @x1))


;; def=InsertionSort.fst(37,34-37,54); use=InsertionSort.fst(38,30-42,36)
(Valid 
;; def=InsertionSort.fst(37,34-37,54); use=InsertionSort.fst(38,30-42,36)
(IntSort.permutation (Prims.Cons Prims.int
x_ae567c2fb75be05905677af440075565_0
...
;                           Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation (i :: b) m})
;                         .
;                           InsertionSort.insert_implicit i b == any_result ==>
;                           (forall (return_val:
;                               m:
;                               Prims.list Prims.int
;                                 {IntSort.sorted m /\ IntSort.permutation (i :: b) m}).
;                               return_val == InsertionSort.insert_implicit i b ==>
;                               InsertionSort.insert_implicit i b == return_val ==>
;                               (forall (any_result: Prims.list Prims.int).
;                                   b :: InsertionSort.insert_implicit i b == any_result ==>
;                                   IntSort.sorted (b :: InsertionSort.insert_implicit i b) /\
;                                   IntSort.permutation (i :: l)
;                                     (b :: InsertionSort.insert_implicit i b))))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec insert_implicit`
...
;; def=Prims.fst(402,27-402,88); use=InsertionSort.fst(38,30-42,36)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=InsertionSort.fst(38,30-42,36)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort.fst(38,30-42,36)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort.fst(38,30-42,36)
(and (implies 
;; def=InsertionSort.fst(38,26-38,27); use=InsertionSort.fst(38,36-38,37)
(and 
;; def=InsertionSort.fst(38,26-38,27); use=InsertionSort.fst(38,36-38,37)
(not 
;; def=InsertionSort.fst(38,26-38,27); use=InsertionSort.fst(38,36-38,37)
...
label_1)
(implies 
;; def=InsertionSort.fst(38,26-39,6); use=InsertionSort.fst(38,36-39,6)
(= x_4bb3e7f5f20a26f76ed0f345eab0aa93_1
(Prims.Nil Prims.int))


;; def=InsertionSort.fst(37,22-37,54); use=InsertionSort.fst(39,10-39,13)
(and 
;; def=InsertionSort.fst(37,22-37,30); use=InsertionSort.fst(39,10-39,13)
(or label_2
...
;; def=InsertionSort.fst(37,34-37,54); use=InsertionSort.fst(39,10-39,13)
(or label_3
...
(implies 
;; def=Prims.fst(389,19-389,21); use=InsertionSort.fst(38,30-42,36)
(not 
;; def=InsertionSort.fst(38,26-38,27); use=InsertionSort.fst(38,36-38,37)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_4bb3e7f5f20a26f76ed0f345eab0aa93_1))
...
;; def=Prims.fst(413,99-413,120); use=InsertionSort.fst(38,30-42,36)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=InsertionSort.fst(38,26-40,10); use=InsertionSort.fst(38,36-40,10)
(= x_4bb3e7f5f20a26f76ed0f345eab0aa93_1
(Prims.Cons Prims.int
@x1
@x2))
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort.fst(38,30-42,36)
(and (implies 
;; def=InsertionSort.fst(41,8-41,15); use=InsertionSort.fst(41,8-41,15)
(= (Prims.op_LessThanOrEqual x_ae567c2fb75be05905677af440075565_0
@x1)
(BoxBool true))


;; def=InsertionSort.fst(37,22-37,54); use=InsertionSort.fst(41,21-41,25)
(and 
;; def=InsertionSort.fst(37,22-37,30); use=InsertionSort.fst(41,21-41,25)
(or label_4
...
;; def=InsertionSort.fst(37,34-37,54); use=InsertionSort.fst(41,21-41,25)
(or label_5
...
;; def=InsertionSort.fst(41,8-42,36); use=InsertionSort.fst(41,8-42,36)
(= (Prims.op_LessThanOrEqual x_ae567c2fb75be05905677af440075565_0
@x1)
@x4)
)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort.fst(38,30-42,36)
(and 
;; def=InsertionSort.fst(36,42-36,50); use=InsertionSort.fst(42,33-42,35)
(or label_6
...
;; def=InsertionSort.fst(36,22-42,36); use=InsertionSort.fst(42,33-42,35)
(or label_7

;; def=InsertionSort.fst(38,30-42,36); use=InsertionSort.fst(42,33-42,35)
(Valid 
;; def=InsertionSort.fst(38,30-42,36); use=InsertionSort.fst(42,33-42,35)
(Prims.precedes Prims.int
Prims.int
...
;; def=Prims.fst(451,66-451,102); use=InsertionSort.fst(38,30-42,36)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.list Prims.int))

;; def=InsertionSort.fst(36,31-40,10); use=InsertionSort.fst(38,30-42,36)
(= @x2
@x5)
)
...
;; def=InsertionSort.fst(37,10-42,36); use=InsertionSort.fst(42,14-42,36)
(= (InsertionSort.insert_implicit x_ae567c2fb75be05905677af440075565_0
@x2)
@x6)
)

;; def=Prims.fst(356,2-356,58); use=InsertionSort.fst(38,30-42,36)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Tm_refine_7d27f65491c760eed369810570f38690 @x2))

;; def=Prims.fst(356,26-356,41); use=InsertionSort.fst(38,30-42,36)
(= @x7
(InsertionSort.insert_implicit x_ae567c2fb75be05905677af440075565_0
@x2))


;; def=Prims.fst(616,20-616,22); use=InsertionSort.fst(38,30-42,36)
(= (InsertionSort.insert_implicit x_ae567c2fb75be05905677af440075565_0
@x2)
@x7)
)
...
;; def=InsertionSort.fst(37,10-42,36); use=InsertionSort.fst(38,30-42,36)
(= (Prims.Cons Prims.int
@x1
(InsertionSort.insert_implicit x_ae567c2fb75be05905677af440075565_0
@x2))
...
;; def=InsertionSort.fst(37,22-37,54); use=InsertionSort.fst(42,10-42,36)
(and 
;; def=InsertionSort.fst(37,22-37,30); use=InsertionSort.fst(42,10-42,36)
(or label_8
...
;; def=InsertionSort.fst(37,34-37,54); use=InsertionSort.fst(42,10-42,36)
(or label_9
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InsertionSort.insert_implicit, 1)
; STATUS: unsat
...
; encoding sigelt let rec insert_implicit


; <Start encoding let rec insert_implicit>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun InsertionSort.insert_implicit.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun InsertionSort.insert_implicit.fuel_instrumented_token () Term)
(declare-fun InsertionSort.insert_implicit (Term Term) Term)
(declare-fun InsertionSort.insert_implicit@tok () Term)
...
; </end encoding let rec insert_implicit>


; encoding sigelt val InsertionSort.sort


; <Skipped val InsertionSort.sort/>
...
(HasType @x2
Tm_refine_8940e385d966068a5e15c2861dbb927f))
(HasType (InsertionSort.insert.fuel_instrumented @u0
@x1
@x2)
(Tm_refine_adfe81fccfdafe0df3fcf496690ab0da @x1
@x2)))
...
:pattern ((InsertionSort.insert.fuel_instrumented @u0
@x1
@x2))
:qid token_correspondence_InsertionSort.insert.fuel_instrumented))

:named token_correspondence_InsertionSort.insert.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: InsertionSort.insert
;;; Fact-ids: Name InsertionSort.insert; Namespace InsertionSort
(assert (! 
;; def=InsertionSort.fst(26,8-26,14); use=InsertionSort.fst(26,8-26,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
...
(HasType @x2
Tm_refine_8940e385d966068a5e15c2861dbb927f))
(= (InsertionSort.insert.fuel_instrumented (SFuel @u0)
@x1
@x2)
(let ((@lb3 @x2))
(ite (is-Prims.Nil @lb3)
...
(Prims.Nil Prims.int))
(ite (is-Prims.Cons @lb3)
(let ((@lb4 (Prims.op_LessThanOrEqual @x1
(Prims.Cons_hd @lb3))))
(ite (= @lb4
(BoxBool true))
(Prims.Cons Prims.int
@x1
@x2)
(let ((@lb5 (InsertionSort.insert.fuel_instrumented @u0
@x1
(Prims.Cons_tl @lb3))))
(ite (is-Prims.Cons @lb5)
(Prims.Cons Prims.int
(Prims.Cons_hd @lb3)
(InsertionSort.insert.fuel_instrumented @u0
@x1
(Prims.Cons_tl @lb3)))
Tm_unit))))
Tm_unit)))))
...
:pattern ((InsertionSort.insert.fuel_instrumented (SFuel @u0)
@x1
@x2))
:qid equation_with_fuel_InsertionSort.insert.fuel_instrumented))

:named equation_with_fuel_InsertionSort.insert.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name InsertionSort.insert; Namespace InsertionSort
(assert (! 
;; def=InsertionSort.fst(26,8-26,14); use=InsertionSort.fst(26,8-26,14)
...
@x1
@x2)
(InsertionSort.insert.fuel_instrumented ZFuel
@x1
@x2))
...
@x1
@x2))
:qid @fuel_irrelevance_InsertionSort.insert.fuel_instrumented))

:named @fuel_irrelevance_InsertionSort.insert.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name InsertionSort.insert; Namespace InsertionSort
(assert (! 
;; def=InsertionSort.fst(26,8-26,14); use=InsertionSort.fst(26,8-26,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (InsertionSort.insert @x0
@x1)
(InsertionSort.insert.fuel_instrumented MaxFuel
@x0
@x1))
...
:pattern ((InsertionSort.insert @x0
@x1))
:qid @fuel_correspondence_InsertionSort.insert.fuel_instrumented))

:named @fuel_correspondence_InsertionSort.insert.fuel_instrumented))
(push) ;; push{2

; Starting query at InsertionSort.fst(46,17-48,33)
...
(declare-fun Tm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0
Tm_type)
:named refinement_kinding_Tm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(45,11-48,33); use=InsertionSort.fst(45,11-48,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=InsertionSort.fst(46,17-48,33); use=InsertionSort.fst(46,17-48,33)
...
@x1
Tm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0))
:qid refinement_interpretation_Tm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0))

:named refinement_interpretation_Tm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0))
(declare-fun InsertionSort.sort (Term) Term)

(declare-fun Tm_refine_e8403f918d280ddafd288213ea995835 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(45,29-45,70); use=InsertionSort.fst(46,8-46,12)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_e8403f918d280ddafd288213ea995835 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_e8403f918d280ddafd288213ea995835 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_e8403f918d280ddafd288213ea995835))

:named refinement_kinding_Tm_refine_e8403f918d280ddafd288213ea995835))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(45,29-45,70); use=InsertionSort.fst(46,8-46,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e8403f918d280ddafd288213ea995835 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=InsertionSort.fst(45,41-45,49); use=InsertionSort.fst(46,8-46,12)
(BoxBool_proj_0 (IntSort.sorted @x1))


;; def=InsertionSort.fst(45,53-45,68); use=InsertionSort.fst(46,8-46,12)
(Valid 
;; def=InsertionSort.fst(45,53-45,68); use=InsertionSort.fst(46,8-46,12)
(IntSort.permutation @x2
@x1)
)
))
...
@x1
(Tm_refine_e8403f918d280ddafd288213ea995835 @x2)))
:qid refinement_interpretation_Tm_refine_e8403f918d280ddafd288213ea995835))

:named refinement_interpretation_Tm_refine_e8403f918d280ddafd288213ea995835))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e8403f918d280ddafd288213ea995835
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(45,29-45,70); use=InsertionSort.fst(46,8-46,12)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e8403f918d280ddafd288213ea995835 @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e8403f918d280ddafd288213ea995835 @x0))))
:qid haseqTm_refine_e8403f918d280ddafd288213ea995835))

:named haseqTm_refine_e8403f918d280ddafd288213ea995835))
;;;;;;;;;;;;;;;;l: Prims.list Prims.int {l << l}   -> m: Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation l m}
(declare-fun Tm_arrow_149806dcfc2563914d28078d25ad75fc () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_149806dcfc2563914d28078d25ad75fc
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_149806dcfc2563914d28078d25ad75fc
Tm_type)
:named kinding_Tm_arrow_149806dcfc2563914d28078d25ad75fc))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(45,11-48,33); use=InsertionSort.fst(45,11-48,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_149806dcfc2563914d28078d25ad75fc)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_149806dcfc2563914d28078d25ad75fc))
:qid InsertionSort_pre_typing_Tm_arrow_149806dcfc2563914d28078d25ad75fc))

:named InsertionSort_pre_typing_Tm_arrow_149806dcfc2563914d28078d25ad75fc))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_149806dcfc2563914d28078d25ad75fc
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(45,11-48,33); use=InsertionSort.fst(45,11-48,33)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_refine_e8403f918d280ddafd288213ea995835 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid InsertionSort_interpretation_Tm_arrow_149806dcfc2563914d28078d25ad75fc.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_149806dcfc2563914d28078d25ad75fc))
:qid InsertionSort_interpretation_Tm_arrow_149806dcfc2563914d28078d25ad75fc))

:named InsertionSort_interpretation_Tm_arrow_149806dcfc2563914d28078d25ad75fc))
(declare-fun InsertionSort.sort@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(46,8-46,12); use=InsertionSort.fst(46,8-46,12)
(forall ((@x0 Term))
 (! (= (ApplyTT InsertionSort.sort@tok
@x0)
(InsertionSort.sort @x0))
 

:pattern ((ApplyTT InsertionSort.sort@tok
@x0))
:qid token_correspondence_InsertionSort.sort))

:named token_correspondence_InsertionSort.sort))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(46,8-46,12); use=InsertionSort.fst(46,8-46,12)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType InsertionSort.sort@tok
Tm_arrow_149806dcfc2563914d28078d25ad75fc))
...
(forall ((@x1 Term))
 (! (= (ApplyTT InsertionSort.sort@tok
@x1)
(InsertionSort.sort @x1))
 

:pattern ((InsertionSort.sort @x1))
:qid function_token_typing_InsertionSort.sort.1))
)
 

:pattern ((ApplyTT @x0
InsertionSort.sort@tok))
:qid function_token_typing_InsertionSort.sort))

:named function_token_typing_InsertionSort.sort))
...
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_e534f45ace9a0aa35c8c63fb34e8e5a0)
(HasType (InsertionSort.sort @x0)
(Tm_refine_e8403f918d280ddafd288213ea995835 @x0)))
 

:pattern ((InsertionSort.sort @x0))
:qid typing_InsertionSort.sort))

:named typing_InsertionSort.sort))
(declare-fun label_7 () Bool)
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_d0920d3f6811df121f7bdfd6feb13f0c () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_d0920d3f6811df121f7bdfd6feb13f0c
Tm_type)
:named refinement_kinding_Tm_refine_d0920d3f6811df121f7bdfd6feb13f0c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(45,29-45,70); use=InsertionSort.fst(46,17-48,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_d0920d3f6811df121f7bdfd6feb13f0c)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=InsertionSort.fst(45,41-45,49); use=InsertionSort.fst(46,17-48,33)
(BoxBool_proj_0 (IntSort.sorted @x1))


;; def=InsertionSort.fst(45,53-45,68); use=InsertionSort.fst(46,17-48,33)
(Valid 
;; def=InsertionSort.fst(45,53-45,68); use=InsertionSort.fst(46,17-48,33)
(IntSort.permutation x_66b03f5c7897b05649fed8196554c587_0
@x1)
)
))
...
@x1
Tm_refine_d0920d3f6811df121f7bdfd6feb13f0c))
:qid refinement_interpretation_Tm_refine_d0920d3f6811df121f7bdfd6feb13f0c))

:named refinement_interpretation_Tm_refine_d0920d3f6811df121f7bdfd6feb13f0c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d0920d3f6811df121f7bdfd6feb13f0c
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_d0920d3f6811df121f7bdfd6feb13f0c))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_d0920d3f6811df121f7bdfd6feb13f0c))


(declare-fun Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(46,17-48,33)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1))

:named refinement_kinding_Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(46,17-48,33)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=InsertionSort.fst(25,22-25,30); use=InsertionSort.fst(46,17-48,33)
(BoxBool_proj_0 (IntSort.sorted @x1))


;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(46,17-48,33)
(Valid 
;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(46,17-48,33)
(IntSort.permutation (Prims.Cons Prims.int
@x2
...
(Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1))

:named refinement_interpretation_Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort.fst(25,10-25,56); use=InsertionSort.fst(46,17-48,33)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1 @x0
@x1)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1 @x0
@x1))))
:qid haseqTm_refine_377fbb2fe77d32fd6e462e68de3c52e1))

:named haseqTm_refine_377fbb2fe77d32fd6e462e68de3c52e1))


; Encoding query formula : forall (k: Prims.pure_post (m: Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation l m})).
;   (forall (x: m: Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation l m}).
;       {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;   (l == [] ==> IntSort.sorted [] /\ IntSort.permutation l []) /\
;   (~(Nil? l) ==>
;     (forall (b: Prims.int) (b: Prims.list Prims.int).
;         l == b :: b ==>
;         b << l /\
...
;             b == any_result ==>
;             (forall (any_result:
;                 m: Prims.list Prims.int {IntSort.sorted m /\ IntSort.permutation b m}).
;                 InsertionSort.sort b == any_result ==>
;                 (IntSort.sorted (InsertionSort.sort b) /\
;                   IntSort.permutation b (InsertionSort.sort b) ==>
;                   IntSort.sorted (InsertionSort.sort b)) /\
;                 (forall (return_val: l: Prims.list Prims.int {IntSort.sorted l}).
;                     return_val == InsertionSort.sort b ==>
;                     InsertionSort.sort b == return_val ==>
;                     (forall (any_result:
;                         m:
;                         Prims.list Prims.int
;                           {IntSort.sorted m /\ IntSort.permutation (b :: InsertionSort.sort b) m}).
;                         InsertionSort.insert b (InsertionSort.sort b) == any_result ==>
;                         IntSort.sorted (InsertionSort.insert b (InsertionSort.sort b)) /\
;                         IntSort.permutation (b :: InsertionSort.sort b)
;                           (InsertionSort.insert b (InsertionSort.sort b)) ==>
;                         IntSort.sorted (InsertionSort.insert b (InsertionSort.sort b)) /\
;                         IntSort.permutation l (InsertionSort.insert b (InsertionSort.sort b))))))))
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Tm_refine_d0920d3f6811df121f7bdfd6feb13f0c))

;; def=Prims.fst(402,27-402,88); use=InsertionSort.fst(46,17-48,33)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=InsertionSort.fst(46,17-48,33)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort.fst(46,17-48,33)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort.fst(46,17-48,33)
(and (implies 
;; def=InsertionSort.fst(46,13-46,14); use=InsertionSort.fst(46,23-46,24)
(and 
;; def=InsertionSort.fst(46,13-46,14); use=InsertionSort.fst(46,23-46,24)
(not 
;; def=InsertionSort.fst(46,13-46,14); use=InsertionSort.fst(46,23-46,24)
...
label_1)
(implies 
;; def=InsertionSort.fst(46,13-47,8); use=InsertionSort.fst(46,23-47,8)
(= x_66b03f5c7897b05649fed8196554c587_0
(Prims.Nil Prims.int))


;; def=InsertionSort.fst(45,41-45,68); use=InsertionSort.fst(47,12-47,14)
(and 
;; def=InsertionSort.fst(45,41-45,49); use=InsertionSort.fst(47,12-47,14)
(or label_2

;; def=InsertionSort.fst(45,41-45,49); use=InsertionSort.fst(47,12-47,14)
(BoxBool_proj_0 (IntSort.sorted (Prims.Nil Prims.int)))
)


;; def=InsertionSort.fst(45,53-45,68); use=InsertionSort.fst(47,12-47,14)
(or label_3
...
(implies 
;; def=Prims.fst(389,19-389,21); use=InsertionSort.fst(46,17-48,33)
(not 
;; def=InsertionSort.fst(46,13-46,14); use=InsertionSort.fst(46,23-46,24)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_66b03f5c7897b05649fed8196554c587_0))
...
;; def=Prims.fst(413,99-413,120); use=InsertionSort.fst(46,17-48,33)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=InsertionSort.fst(46,13-48,11); use=InsertionSort.fst(46,23-48,11)
(= x_66b03f5c7897b05649fed8196554c587_0
(Prims.Cons Prims.int
@x1
@x2))
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort.fst(46,17-48,33)
(and 
;; def=InsertionSort.fst(46,17-48,33); use=InsertionSort.fst(48,30-48,32)
(or label_4
...
;; def=Prims.fst(451,66-451,102); use=InsertionSort.fst(46,17-48,33)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.list Prims.int))

;; def=InsertionSort.fst(45,11-48,11); use=InsertionSort.fst(46,17-48,33)
(= @x2
@x3)
)
...
;; def=InsertionSort.fst(24,22-48,33); use=InsertionSort.fst(48,15-48,33)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort.fst(46,17-48,33)
(and (implies 
;; def=InsertionSort.fst(45,41-45,68); use=InsertionSort.fst(48,24-48,33)
(and 
;; def=InsertionSort.fst(45,41-45,49); use=InsertionSort.fst(48,24-48,33)
(BoxBool_proj_0 (IntSort.sorted (InsertionSort.sort @x2)))


;; def=InsertionSort.fst(45,53-45,68); use=InsertionSort.fst(48,24-48,33)
(Valid 
;; def=InsertionSort.fst(45,53-45,68); use=InsertionSort.fst(48,24-48,33)
(IntSort.permutation @x2
(InsertionSort.sort @x2))
...
;; def=InsertionSort.fst(24,33-24,41); use=InsertionSort.fst(48,24-48,33)
(or label_5
...
;; def=Prims.fst(356,2-356,58); use=InsertionSort.fst(46,17-48,33)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Tm_refine_8940e385d966068a5e15c2861dbb927f)

;; def=Prims.fst(356,26-356,41); use=InsertionSort.fst(46,17-48,33)
(= @x5
(InsertionSort.sort @x2))


;; def=InsertionSort.fst(24,22-48,33); use=InsertionSort.fst(46,17-48,33)
(= (InsertionSort.sort @x2)
@x5)
)
...
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_377fbb2fe77d32fd6e462e68de3c52e1 @x1
@x2))

;; def=InsertionSort.fst(45,29-48,33); use=InsertionSort.fst(46,17-48,33)
(= (InsertionSort.insert @x1
(InsertionSort.sort @x2))
@x6)


;; def=InsertionSort.fst(25,22-25,30); use=InsertionSort.fst(48,15-48,33)
(BoxBool_proj_0 (IntSort.sorted (InsertionSort.insert @x1
(InsertionSort.sort @x2))))


;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(48,15-48,33)
(Valid 
;; def=InsertionSort.fst(25,34-25,54); use=InsertionSort.fst(48,15-48,33)
(IntSort.permutation (Prims.Cons Prims.int
@x1
...
;; def=InsertionSort.fst(45,41-45,68); use=InsertionSort.fst(48,15-48,33)
(and 
;; def=InsertionSort.fst(45,41-45,49); use=InsertionSort.fst(48,15-48,33)
(or label_6
...
;; def=InsertionSort.fst(45,53-45,68); use=InsertionSort.fst(48,15-48,33)
(or label_7
