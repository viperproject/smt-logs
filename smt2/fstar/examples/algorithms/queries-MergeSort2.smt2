...
; Internals for MergeSort2


; encoding sigelt val MergeSort2.merge'


; <Skipped val MergeSort2.merge'/>
...
; Starting query at MergeSort2.fst(34,28-40,30)
...
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(33,67-34,17); use=MergeSort2.fst(34,8-34,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd))
:qid MergeSort2_pre_typing_Tm_arrow_605ada36aef613d3875663fdd1971cfd))

:named MergeSort2_pre_typing_Tm_arrow_605ada36aef613d3875663fdd1971cfd))
...
:pattern ((ApplyTT @x0
@x1))
:qid MergeSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_605ada36aef613d3875663fdd1971cfd))
:qid MergeSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd))

:named MergeSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd))
...
(declare-fun Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(33,13-40,30); use=MergeSort2.fst(33,13-40,30)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09))

:named refinement_kinding_Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(33,13-40,30); use=MergeSort2.fst(33,13-40,30)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=MergeSort2.fst(33,13-40,30); use=MergeSort2.fst(33,13-40,30)
(or 
;; def=MergeSort2.fst(34,28-40,30); use=MergeSort2.fst(34,28-40,30)
(Valid 
;; def=MergeSort2.fst(34,28-40,30); use=MergeSort2.fst(34,28-40,30)
...
;; def=MergeSort2.fst(33,13-40,30); use=MergeSort2.fst(33,13-40,30)
(and 
;; def=MergeSort2.fst(33,13-34,17); use=MergeSort2.fst(33,13-34,17)
(Valid 
;; def=MergeSort2.fst(33,13-34,17); use=MergeSort2.fst(33,13-34,17)
...
;; def=MergeSort2.fst(33,26-40,30); use=MergeSort2.fst(33,26-40,30)
(or 
;; def=MergeSort2.fst(34,28-40,30); use=MergeSort2.fst(34,28-40,30)
(Valid 
;; def=MergeSort2.fst(34,28-40,30); use=MergeSort2.fst(34,28-40,30)
...
;; def=MergeSort2.fst(33,26-40,30); use=MergeSort2.fst(33,26-40,30)
(and 
;; def=MergeSort2.fst(33,26-34,20); use=MergeSort2.fst(33,26-34,20)
(Valid 
;; def=MergeSort2.fst(33,26-34,20); use=MergeSort2.fst(33,26-34,20)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09))

:named refinement_interpretation_Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09))
;;;;;;;;;;;;;;;;haseq for Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(33,13-40,30); use=MergeSort2.fst(33,13-40,30)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09 @x0
@x1
@x2))))
:qid haseqTm_refine_285b2ad777a9989cd1f3f6f132b6fb09))

:named haseqTm_refine_285b2ad777a9989cd1f3f6f132b6fb09))
(declare-fun MergeSort2.merge_ (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;l1: Prims.list a ->     l2: Prims.list a ->     k: (_: a -> Prims.int){a << a \/ a === a /\ (l1 << l1 \/ l1 === l1 /\ l2 << l2)}   -> Prims.list a
(declare-fun Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6
Tm_type)
:named kinding_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(33,13-40,30); use=MergeSort2.fst(33,13-40,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6))
:qid MergeSort2_pre_typing_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6))

:named MergeSort2_pre_typing_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(33,13-40,30); use=MergeSort2.fst(33,13-40,30)
(forall ((@x0 Term))
...
(Prims.list @x1))
(HasType @x4
(Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09 @x1
@x2
@x3)))
...
@x3)
@x4))
:qid MergeSort2_interpretation_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid MergeSort2_interpretation_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6.2))
...
@x1)
@x2))
:qid MergeSort2_interpretation_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6.3))
...
@x2)
@x3))
:qid MergeSort2_interpretation_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6))
:qid MergeSort2_interpretation_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6))

:named MergeSort2_interpretation_Tm_arrow_d9bf7fda168c75b2c0f28432d8f218b6))
(declare-fun MergeSort2.merge_@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(34,8-34,14); use=MergeSort2.fst(34,8-34,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT MergeSort2.merge_@tok
@x0)
@x1)
@x2)
@x3)
(MergeSort2.merge_ @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT MergeSort2.merge_@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_MergeSort2.merge_))

:named token_correspondence_MergeSort2.merge_))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(34,8-34,14); use=MergeSort2.fst(34,8-34,14)
...
@x3)
@x4)
(MergeSort2.merge_ @x1
@x2
@x3
@x4))
 

:pattern ((MergeSort2.merge_ @x1
@x2
@x3
@x4))
:qid function_token_typing_MergeSort2.merge_.1))
)
 

:pattern ((ApplyTT @x0
MergeSort2.merge_@tok))
:qid function_token_typing_MergeSort2.merge_))

:named function_token_typing_MergeSort2.merge_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(34,8-34,14); use=MergeSort2.fst(34,8-34,14)
...
(Prims.list @x0))
(HasType @x3
(Tm_refine_285b2ad777a9989cd1f3f6f132b6fb09 @x0
@x1
@x2)))
(HasType (MergeSort2.merge_ @x0
@x1
@x2
@x3)
(Prims.list @x0)))
...
:pattern ((MergeSort2.merge_ @x0
@x1
@x2
@x3))
:qid typing_MergeSort2.merge_))

:named typing_MergeSort2.merge_))
...
;   (~(Nil? (l1, l2)._1) ==>
;     ~(Nil? (l1, l2)._2) ==>
;     (forall (b: a) (b: Prims.list a) (b: a) (b: Prims.list a).
;         (l1, l2) == (b :: b, b :: b) ==>
;         (forall (k: Prims.pure_post (Prims.list a)).
;             (forall (x: Prims.list a). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;             (k b <= k b == true ==> a << a \/ (b << l1 \/ b === l1 /\ l2 << l2)) /\
;             (~(k b <= k b = true) ==>
;               (forall (b: Prims.bool). k b <= k b == b ==> a << a \/ (l1 << l1 \/ b << l2))))))
...
;; def=Prims.fst(402,27-402,88); use=MergeSort2.fst(34,28-40,30)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(34,28-40,30)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(34,28-40,30)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(34,28-40,30)
(and (implies 
;; def=MergeSort2.fst(35,4-37,20); use=MergeSort2.fst(35,4-37,20)
(and 
;; def=MergeSort2.fst(35,4-35,9); use=MergeSort2.fst(35,4-35,9)
(not 
;; def=MergeSort2.fst(35,4-35,9); use=MergeSort2.fst(35,4-35,9)
...
;; def=MergeSort2.fst(36,4-36,9); use=MergeSort2.fst(36,4-36,9)
(not 
;; def=MergeSort2.fst(36,4-36,9); use=MergeSort2.fst(36,4-36,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=MergeSort2.fst(37,4-37,20); use=MergeSort2.fst(37,4-37,20)
(not 
;; def=MergeSort2.fst(37,4-37,20); use=MergeSort2.fst(37,4-37,20)
...
label_1)
(implies 
;; def=Prims.fst(389,18-389,39); use=MergeSort2.fst(34,28-40,30)
(and 
;; def=Prims.fst(389,19-389,21); use=MergeSort2.fst(34,28-40,30)
(not 
;; def=MergeSort2.fst(35,4-35,9); use=MergeSort2.fst(35,4-35,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(34,28-40,30)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=MergeSort2.fst(34,34-37,20); use=MergeSort2.fst(34,34-37,20)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
x_374b44ccfcb77ed85d505dbc44265913_1
x_374b44ccfcb77ed85d505dbc44265913_2)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort2.fst(34,28-40,30)
(and (implies 
;; def=MergeSort2.fst(38,7-38,19); use=MergeSort2.fst(38,7-38,19)
...
;; def=MergeSort2.fst(33,13-40,30); use=MergeSort2.fst(39,28-39,29)
(or label_2

;; def=MergeSort2.fst(34,28-40,30); use=MergeSort2.fst(39,28-39,29)
(Valid 
;; def=MergeSort2.fst(34,28-40,30); use=MergeSort2.fst(39,28-39,29)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(33,26-40,30); use=MergeSort2.fst(39,28-39,29)
(and 
;; def=MergeSort2.fst(33,26-34,20); use=MergeSort2.fst(39,28-39,29)
(Valid 
;; def=MergeSort2.fst(33,26-34,20); use=MergeSort2.fst(39,28-39,29)
...
;; def=MergeSort2.fst(38,7-40,30); use=MergeSort2.fst(38,7-40,30)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x1)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x3))
...
;; def=MergeSort2.fst(33,13-40,30); use=MergeSort2.fst(40,28-40,29)
(or label_3

;; def=MergeSort2.fst(34,28-40,30); use=MergeSort2.fst(40,28-40,29)
(Valid 
;; def=MergeSort2.fst(34,28-40,30); use=MergeSort2.fst(40,28-40,29)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun MergeSort2.merge_.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun MergeSort2.merge_.fuel_instrumented_token () Term)
(declare-fun MergeSort2.merge_ (Term Term Term Term) Term)
(declare-fun MergeSort2.merge_@tok () Term)



;;;;;;;;;;;;;;;;l1: Prims.list a -> l2: Prims.list a -> k: (_: a -> Prims.int) -> Prims.list a
(declare-fun Tm_arrow_e440497d30593fa341f17f65b2aae7ac () Term)

; </end encoding let rec merge'>


; encoding sigelt val MergeSort2.merge'_permutation


; <Skipped val MergeSort2.merge'_permutation/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MergeSort2.merge'; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(34,8-34,14); use=MergeSort2.fst(34,8-34,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
...
(HasType @x4
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(HasType (MergeSort2.merge_.fuel_instrumented @u0
@x1
@x2
@x3
@x4)
...
:pattern ((MergeSort2.merge_.fuel_instrumented @u0
@x1
@x2
@x3
@x4))
:qid token_correspondence_MergeSort2.merge_.fuel_instrumented))

:named token_correspondence_MergeSort2.merge_.fuel_instrumented))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name FStar.List.Tot.Base.mem; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(240,8-240,11); use=FStar.List.Tot.Base.fst(240,8-240,11)
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: MergeSort2.merge'
;;; Fact-ids: Name MergeSort2.merge'; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(34,8-34,14); use=MergeSort2.fst(34,8-34,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
(HasType @x4
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(= (MergeSort2.merge_.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4)
...
(Prims.Cons @x1
(Prims.Cons_hd (FStar.Pervasives.Native.Mktuple2__1 @lb5))
(MergeSort2.merge_.fuel_instrumented @u0
@x1
...
:pattern ((MergeSort2.merge_.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4))
:qid equation_with_fuel_MergeSort2.merge_.fuel_instrumented))

:named equation_with_fuel_MergeSort2.merge_.fuel_instrumented))
...
@x3
@x4)
(MergeSort2.merge_.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid @fuel_irrelevance_MergeSort2.merge_.fuel_instrumented))

:named @fuel_irrelevance_MergeSort2.merge_.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name FStar.List.Tot.Base.mem; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(240,8-240,11); use=FStar.List.Tot.Base.fst(240,8-240,11)
...
@x2
@x3)
(MergeSort2.merge_.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_correspondence_MergeSort2.merge_.fuel_instrumented))

:named @fuel_correspondence_MergeSort2.merge_.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name FStar.List.Tot.Base.mem; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(240,8-240,11); use=FStar.List.Tot.Base.fst(240,8-240,11)
...
; Starting query at MergeSort2.fst(48,40-54,38)
...
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(46,14-48,29); use=MergeSort2.fst(48,8-48,29)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_3))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MergeSort2.merge__permutation (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MergeSort2.merge__permutation@tok () Term)
...
;       GenericSort.permutation_2 (MergeSort2.merge' l1 l2 k) l1 l2 ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? (l1, l2)._1) /\ ~(Nil? (l1, l2)._2) /\ ~(Cons? (l1, l2)._1 && Cons? (l1, l2)._2) ==>
;         Prims.l_False) /\
;       (forall (b: Prims.list a).
;           (l1, l2) == ([], b) ==> (forall (any_result: Prims.unit). k any_result)) /\
;       (~(Nil? (l1, l2)._1) ==>
;         (forall (b: Prims.list a).
;             (l1, l2) == (b, []) ==> (forall (any_result: Prims.unit). k any_result)) /\
;         (~(Nil? (l1, l2)._2) ==>
...
;                         k == any_result ==>
;                         (forall (pure_result: Prims.unit).
;                             GenericSort.permutation_2 (MergeSort2.merge' b l2 k) b l2 ==>
;                             k pure_result))) /\
;                   (~(k b <= k b = true) ==>
;                     (forall (b: Prims.bool).
;                         k b <= k b == b ==>
...
;                             k == any_result ==>
;                             (forall (pure_result: Prims.unit).
;                                 GenericSort.permutation_2 (MergeSort2.merge' l1 b k) l1 b ==>
;                                 k pure_result)))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec merge'_permutation`
...
;;; Fact-ids: 
(assert (! (not 
;; def=MergeSort2.fst(48,40-54,38); use=MergeSort2.fst(48,40-54,38)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(48,40-54,38)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=MergeSort2.fst(47,16-47,52); use=MergeSort2.fst(48,40-54,38)
(or label_2
...
(MergeSort2.merge_ x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1
x_374b44ccfcb77ed85d505dbc44265913_2
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(48,40-54,38)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(48,40-54,38)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=MergeSort2.fst(48,40-54,38)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(48,40-54,38)
(Valid 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(48,40-54,38)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(48,40-54,38)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(48,40-54,38)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(48,40-54,38)
(and (implies 
;; def=MergeSort2.fst(49,4-51,20); use=MergeSort2.fst(49,4-51,20)
(and 
;; def=MergeSort2.fst(49,4-49,9); use=MergeSort2.fst(49,4-49,9)
(not 
;; def=MergeSort2.fst(49,4-49,9); use=MergeSort2.fst(49,4-49,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=MergeSort2.fst(50,4-50,9); use=MergeSort2.fst(50,4-50,9)
(not 
;; def=MergeSort2.fst(50,4-50,9); use=MergeSort2.fst(50,4-50,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.__proj__Mktuple2__item___2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=MergeSort2.fst(51,4-51,20); use=MergeSort2.fst(51,4-51,20)
(not 
;; def=MergeSort2.fst(51,4-51,20); use=MergeSort2.fst(51,4-51,20)
(and (BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(48,40-54,38)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=MergeSort2.fst(48,46-49,9); use=MergeSort2.fst(48,46-49,9)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
x_374b44ccfcb77ed85d505dbc44265913_1
x_374b44ccfcb77ed85d505dbc44265913_2)
...
;; def=Prims.fst(451,66-451,102); use=MergeSort2.fst(48,40-54,38)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(48,40-54,38)
(Valid 
;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(48,40-54,38)
(ApplyTT @x1
@x3)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MergeSort2.fst(48,40-54,38)
(not 
;; def=MergeSort2.fst(49,4-49,9); use=MergeSort2.fst(49,4-49,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort2.fst(48,40-54,38)
(and 
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(48,40-54,38)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
...
;; def=MergeSort2.fst(48,46-50,9); use=MergeSort2.fst(48,46-50,9)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
x_374b44ccfcb77ed85d505dbc44265913_1
x_374b44ccfcb77ed85d505dbc44265913_2)
...
;; def=MergeSort2.fst(48,46-51,20); use=MergeSort2.fst(48,46-51,20)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
x_374b44ccfcb77ed85d505dbc44265913_1
x_374b44ccfcb77ed85d505dbc44265913_2)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort2.fst(48,40-54,38)
(and (implies 
;; def=MergeSort2.fst(52,7-52,19); use=MergeSort2.fst(52,7-52,19)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x2)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x4))
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(48,40-54,38)
(and 
;; def=MergeSort2.fst(43,25-54,38); use=MergeSort2.fst(53,36-53,37)
(or label_4

;; def=MergeSort2.fst(48,40-54,38); use=MergeSort2.fst(53,36-53,37)
(Valid 
;; def=MergeSort2.fst(48,40-54,38); use=MergeSort2.fst(53,36-53,37)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(44,3-54,38); use=MergeSort2.fst(53,36-53,37)
(and 
;; def=MergeSort2.fst(44,3-48,32); use=MergeSort2.fst(53,36-53,37)
(Valid 
;; def=MergeSort2.fst(44,3-48,32); use=MergeSort2.fst(53,36-53,37)
(Prims.op_Equals_Equals_Equals (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=MergeSort2.fst(46,2-48,37); use=MergeSort2.fst(48,40-54,38)
(= x_582acf81e02a6e4176cba5e2730f867d_3
@x7)
)

;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(53,10-53,28)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=MergeSort2.fst(47,16-47,52); use=MergeSort2.fst(53,10-53,28)
(Valid 
;; def=MergeSort2.fst(47,16-47,52); use=MergeSort2.fst(53,10-53,28)
(GenericSort.permutation_2 x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.merge_ x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(53,10-53,28)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(53,10-53,28)
(ApplyTT @x6
@x8)
...
;; def=MergeSort2.fst(52,7-54,38); use=MergeSort2.fst(52,7-54,38)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x2)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x4))
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(48,40-54,38)
(and 
;; def=MergeSort2.fst(43,25-54,38); use=MergeSort2.fst(54,36-54,37)
(or label_5

;; def=MergeSort2.fst(48,40-54,38); use=MergeSort2.fst(54,36-54,37)
(Valid 
;; def=MergeSort2.fst(48,40-54,38); use=MergeSort2.fst(54,36-54,37)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(54,10-54,28)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.unit)

;; def=MergeSort2.fst(47,16-47,52); use=MergeSort2.fst(54,10-54,28)
(Valid 
;; def=MergeSort2.fst(47,16-47,52); use=MergeSort2.fst(54,10-54,28)
(GenericSort.permutation_2 x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.merge_ x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(54,10-54,28)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(54,10-54,28)
(ApplyTT @x6
@x9)
...
; encoding sigelt let rec merge'_permutation


; <Start encoding let rec merge'_permutation>
...
; </end encoding let rec merge'_permutation>


; encoding sigelt val MergeSort2.merge'_sorted


; <Skipped val MergeSort2.merge'_sorted/>
...
; Starting query at MergeSort2.fst(63,35-69,33)
...
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(60,14-63,24); use=MergeSort2.fst(63,8-63,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_3))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MergeSort2.merge__sorted (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MergeSort2.merge__sorted@tok () Term)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   GenericSort.sorted l1 k /\ GenericSort.sorted l2 k /\
;   (forall (pure_result: Prims.unit).
;       GenericSort.sorted (MergeSort2.merge' l1 l2 k) k ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? (l1, l2)._1) /\ ~(Nil? (l1, l2)._2) /\ ~(Cons? (l1, l2)._1 && Cons? (l1, l2)._2) ==>
;         Prims.l_False) /\
...
;                     (forall (any_result: (_: a -> Prims.int)).
;                         k == any_result ==>
;                         GenericSort.sorted b k /\ GenericSort.sorted l2 k /\
;                         (forall (pure_result: Prims.unit).
;                             GenericSort.sorted (MergeSort2.merge' b l2 k) k ==> k pure_result))) /\
;                   (~(k b <= k b = true) ==>
;                     (forall (b: Prims.bool).
;                         k b <= k b == b ==>
;                         (a << a \/ (l1 << l1 \/ b << l2)) /\
;                         (forall (any_result: (_: a -> Prims.int)).
;                             k == any_result ==>
;                             GenericSort.sorted l1 k /\ GenericSort.sorted b k /\
;                             (forall (pure_result: Prims.unit).
;                                 GenericSort.sorted (MergeSort2.merge' l1 b k) k ==> k pure_result)))
;                   ))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec merge'_sorted`
...
;;; Fact-ids: 
(assert (! (not 
;; def=MergeSort2.fst(63,35-69,33); use=MergeSort2.fst(63,35-69,33)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=MergeSort2.fst(61,19-61,30); use=MergeSort2.fst(63,35-69,33)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1
x_582acf81e02a6e4176cba5e2730f867d_3))


;; def=MergeSort2.fst(61,34-61,45); use=MergeSort2.fst(63,35-69,33)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2
x_582acf81e02a6e4176cba5e2730f867d_3))


;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(63,35-69,33)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=MergeSort2.fst(62,17-62,42); use=MergeSort2.fst(63,35-69,33)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(63,35-69,33)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(63,35-69,33)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=MergeSort2.fst(63,35-69,33)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(63,35-69,33)
(Valid 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(63,35-69,33)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(63,35-69,33)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(63,35-69,33)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(63,35-69,33)
(and (implies 
;; def=MergeSort2.fst(64,4-66,20); use=MergeSort2.fst(64,4-66,20)
(and 
;; def=MergeSort2.fst(64,4-64,9); use=MergeSort2.fst(64,4-64,9)
(not 
;; def=MergeSort2.fst(64,4-64,9); use=MergeSort2.fst(64,4-64,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=MergeSort2.fst(65,4-65,9); use=MergeSort2.fst(65,4-65,9)
(not 
;; def=MergeSort2.fst(65,4-65,9); use=MergeSort2.fst(65,4-65,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.__proj__Mktuple2__item___2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=MergeSort2.fst(66,4-66,20); use=MergeSort2.fst(66,4-66,20)
(not 
;; def=MergeSort2.fst(66,4-66,20); use=MergeSort2.fst(66,4-66,20)
(and (BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(63,35-69,33)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=MergeSort2.fst(63,41-64,9); use=MergeSort2.fst(63,41-64,9)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
x_374b44ccfcb77ed85d505dbc44265913_1
x_374b44ccfcb77ed85d505dbc44265913_2)
...
;; def=Prims.fst(451,66-451,102); use=MergeSort2.fst(63,35-69,33)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(63,35-69,33)
(Valid 
;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(63,35-69,33)
(ApplyTT @x1
@x3)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MergeSort2.fst(63,35-69,33)
(not 
;; def=MergeSort2.fst(64,4-64,9); use=MergeSort2.fst(64,4-64,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort2.fst(63,35-69,33)
(and 
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(63,35-69,33)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
...
;; def=MergeSort2.fst(63,41-65,9); use=MergeSort2.fst(63,41-65,9)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
x_374b44ccfcb77ed85d505dbc44265913_1
x_374b44ccfcb77ed85d505dbc44265913_2)
...
;; def=MergeSort2.fst(63,41-66,20); use=MergeSort2.fst(63,41-66,20)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
x_374b44ccfcb77ed85d505dbc44265913_1
x_374b44ccfcb77ed85d505dbc44265913_2)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort2.fst(63,35-69,33)
(and (implies 
;; def=MergeSort2.fst(67,7-67,19); use=MergeSort2.fst(67,7-67,19)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x2)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x4))
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(63,35-69,33)
(and 
;; def=MergeSort2.fst(57,20-69,33); use=MergeSort2.fst(68,31-68,32)
(or label_4

;; def=MergeSort2.fst(63,35-69,33); use=MergeSort2.fst(68,31-68,32)
(Valid 
;; def=MergeSort2.fst(63,35-69,33); use=MergeSort2.fst(68,31-68,32)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(58,3-69,33); use=MergeSort2.fst(68,31-68,32)
(and 
;; def=MergeSort2.fst(58,3-63,27); use=MergeSort2.fst(68,31-68,32)
(Valid 
;; def=MergeSort2.fst(58,3-63,27); use=MergeSort2.fst(68,31-68,32)
(Prims.op_Equals_Equals_Equals (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=MergeSort2.fst(60,2-63,32); use=MergeSort2.fst(63,35-69,33)
(= x_582acf81e02a6e4176cba5e2730f867d_3
@x7)
)

;; def=Prims.fst(441,29-441,97); use=MergeSort2.fst(68,10-68,23)
(and 
;; def=MergeSort2.fst(61,19-61,30); use=MergeSort2.fst(68,10-68,23)
(or label_5
...
;; def=MergeSort2.fst(61,34-61,45); use=MergeSort2.fst(68,10-68,23)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(68,10-68,23)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=MergeSort2.fst(62,17-62,42); use=MergeSort2.fst(68,10-68,23)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.merge_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
x_374b44ccfcb77ed85d505dbc44265913_2
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(68,10-68,23)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(68,10-68,23)
(ApplyTT @x6
@x8)
...
;; def=MergeSort2.fst(67,7-69,33); use=MergeSort2.fst(67,7-69,33)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x2)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x4))
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(63,35-69,33)
(and 
;; def=MergeSort2.fst(57,20-69,33); use=MergeSort2.fst(69,31-69,32)
(or label_7

;; def=MergeSort2.fst(63,35-69,33); use=MergeSort2.fst(69,31-69,32)
(Valid 
;; def=MergeSort2.fst(63,35-69,33); use=MergeSort2.fst(69,31-69,32)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=Prims.fst(441,29-441,97); use=MergeSort2.fst(69,10-69,23)
(and 
;; def=MergeSort2.fst(61,19-61,30); use=MergeSort2.fst(69,10-69,23)
(or label_8
...
;; def=MergeSort2.fst(61,34-61,45); use=MergeSort2.fst(69,10-69,23)
(or label_9
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(69,10-69,23)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.unit)

;; def=MergeSort2.fst(62,17-62,42); use=MergeSort2.fst(69,10-69,23)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.merge_ x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1
@x5
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(69,10-69,23)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(69,10-69,23)
(ApplyTT @x6
@x9)
...
; encoding sigelt let rec merge'_sorted


; <Start encoding let rec merge'_sorted>
...
; </end encoding let rec merge'_sorted>
...
; Starting query at MergeSort2.fst(72,0-74,104)

(declare-fun label_1 () Bool)



(declare-fun Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(73,18-73,44); use=MergeSort2.fst(73,2-73,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57))

:named refinement_kinding_Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(73,18-73,44); use=MergeSort2.fst(73,2-73,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=MergeSort2.fst(73,19-73,29); use=MergeSort2.fst(73,2-73,7)
(BoxBool_proj_0 (GenericSort.sorted @x2
@x3
@x4))


;; def=MergeSort2.fst(73,33-73,43); use=MergeSort2.fst(73,2-73,7)
(BoxBool_proj_0 (GenericSort.sorted @x2
@x5
@x4))
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57))

:named refinement_interpretation_Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(73,18-73,44); use=MergeSort2.fst(73,2-73,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57))

:named haseqTm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57))

; Encoding query formula : forall (a: Prims.eqtype)
;   (l: Prims.list a {Cons? l})
;   (r: Prims.list a {Cons? r})
;   (k: (_: a -> Prims.int))
;   (_: Prims.squash (GenericSort.sorted l k /\ GenericSort.sorted r k)).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.int). Cons? l /\ Cons? r ==> Prims.hasEq (Prims.list a)


; Context: While encoding a query
; While typechecking the top-level declaration `val MergeSort2.merge'_filter_eq_inv`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MergeSort2.fst(72,0-74,104)
...
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0))
(HasType @x4
(Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57 @x0
@x1
@x3
@x2)))

;; def=dummy(0,0-0,0); use=MergeSort2.fst(74,17-74,103)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.int)

;; def=MergeSort2.fst(74,28-74,35); use=MergeSort2.fst(74,28-74,35)
(BoxBool_proj_0 (Prims.uu___is_Cons @x0
@x1))


;; def=MergeSort2.fst(74,39-74,46); use=MergeSort2.fst(74,39-74,46)
(BoxBool_proj_0 (Prims.uu___is_Cons @x0
@x2))
)

;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(74,73-74,82)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MergeSort2.merge'_filter_eq_inv, 1)
; STATUS: unsat
...
; encoding sigelt val MergeSort2.merge'_filter_eq_inv


; <Skipped val MergeSort2.merge'_filter_eq_inv/>
...
; Starting query at MergeSort2.fst(76,2-88,5)
...
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(72,39-72,59); use=MergeSort2.fst(75,8-75,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=MergeSort2.fst(72,50-72,57); use=MergeSort2.fst(75,8-75,28)
(BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x1))
))
...
;;;;;;;;;;;;;;;;r : r: Prims.list a {Cons? r} (r: Prims.list a {Cons? r})
(declare-fun x_9a99f0ed3c7c19be1f30eec0ab46713a_2 () Term)

;;;;;;;;;;;;;;;;binder_x_9a99f0ed3c7c19be1f30eec0ab46713a_2
;;; Fact-ids: 
(assert (! (HasType x_9a99f0ed3c7c19be1f30eec0ab46713a_2
Tm_refine_68a3139579b4e370456a4a2443f8bb4d)
:named binder_x_9a99f0ed3c7c19be1f30eec0ab46713a_2))
;;;;;;;;;;;;;;;;k : _: a -> Prims.int (_: a -> Prims.int)
(declare-fun x_582acf81e02a6e4176cba5e2730f867d_3 () Term)
;;;;;;;;;;;;;;;;_: a -> Prims.int
(declare-fun Tm_arrow_605ada36aef613d3875663fdd1971cfd () Term)
...
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(72,99-75,31); use=MergeSort2.fst(75,8-75,31)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_3))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MergeSort2.merge__filter_eq_inv (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MergeSort2.merge__filter_eq_inv@tok () Term)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   GenericSort.sorted l k /\ GenericSort.sorted r k /\
;   (forall (pure_result: Prims.unit).
;       (forall (x: Prims.int).
;           Cons? l /\ Cons? r /\
;           GenericStability.filter_eq x (l @ r) k =
;           GenericStability.filter_eq x (MergeSort2.merge' l r k) k) ==>
;       p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (k (FStar.List.Tot.Base.hd r) < k (FStar.List.Tot.Base.hd l) == true ==>
;         GenericSort.sorted l k /\ k (FStar.List.Tot.Base.hd l) > k (FStar.List.Tot.Base.hd r) /\
;         (forall (pure_result: Prims.unit).
;             GenericStability.stable (l @ r)
;               (FStar.List.Tot.Base.hd r :: l @ FStar.List.Tot.Base.tl r)
;               k ==>
...
;                     (forall (k: Prims.pure_post Prims.unit).
;                         (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} k x ==> k x) ==>
;                         (FStar.List.Tot.Base.tl r = [] == true ==>
;                           (forall (any_result: Prims.unit). k any_result)) /\
;                         (~(FStar.List.Tot.Base.tl r = [] = true) ==>
;                           (forall (b: Prims.bool).
;                               FStar.List.Tot.Base.tl r = [] == b ==>
;                               Cons? (FStar.List.Tot.Base.tl r) /\
;                               (forall (return_val: r: Prims.list a {Cons? r}).
;                                   return_val == FStar.List.Tot.Base.tl r ==>
;                                   (a << a \/ (l << l \/ FStar.List.Tot.Base.tl r << r)) /\
;                                   (forall (any_result: (_: a -> Prims.int)).
;                                       k == any_result ==>
;                                       GenericSort.sorted l k /\
;                                       GenericSort.sorted (FStar.List.Tot.Base.tl r) k /\
;                                       (forall (pure_result: Prims.unit).
;                                           (forall (x: Prims.int).
;                                               Cons? l /\ Cons? (FStar.List.Tot.Base.tl r) /\
;                                               GenericStability.filter_eq x
;                                                 (l @ FStar.List.Tot.Base.tl r)
;                                                 k =
;                                               GenericStability.filter_eq x
;                                                 (MergeSort2.merge' l (FStar.List.Tot.Base.tl r) k)
;                                                 k) ==>
;                                           (forall (pure_result: Prims.unit).
;                                               (forall (x: Prims.int).
;                                                   GenericStability.filter_eq x
;                                                     [FStar.List.Tot.Base.hd r]
;                                                     k @
;                                                   GenericStability.filter_eq x
;                                                     (MergeSort2.merge' l
...
;       (~(k (FStar.List.Tot.Base.hd r) < k (FStar.List.Tot.Base.hd l) = true) ==>
;         (forall (b: Prims.bool).
;             k (FStar.List.Tot.Base.hd r) < k (FStar.List.Tot.Base.hd l) == b ==>
;             Prims.hasEq (Prims.list a) /\
;             (forall (return_val: Prims.eqtype).
;                 return_val == Prims.list a ==>
;                 (forall (any_result: Prims.bool).
...
;                     (forall (k: Prims.pure_post Prims.unit).
;                         (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} k x ==> k x) ==>
;                         (FStar.List.Tot.Base.tl l = [] == true ==>
;                           (forall (any_result: Prims.unit). k any_result)) /\
;                         (~(FStar.List.Tot.Base.tl l = [] = true) ==>
;                           (forall (b: Prims.bool).
;                               FStar.List.Tot.Base.tl l = [] == b ==>
;                               Cons? (FStar.List.Tot.Base.tl l) /\
;                               (forall (return_val: l: Prims.list a {Cons? l}).
;                                   return_val == FStar.List.Tot.Base.tl l ==>
;                                   (a << a \/
;                                     (FStar.List.Tot.Base.tl l << l \/
;                                       FStar.List.Tot.Base.tl l === l /\ r << r)) /\
;                                   (forall (any_result: (_: a -> Prims.int)).
;                                       k == any_result ==>
;                                       GenericSort.sorted (FStar.List.Tot.Base.tl l) k /\
;                                       GenericSort.sorted r k /\
;                                       (forall (pure_result: Prims.unit).
;                                           (forall (x: Prims.int).
;                                               Cons? (FStar.List.Tot.Base.tl l) /\ Cons? r /\
;                                               GenericStability.filter_eq x
;                                                 (FStar.List.Tot.Base.tl l @ r)
;                                                 k =
;                                               GenericStability.filter_eq x
;                                                 (MergeSort2.merge' (FStar.List.Tot.Base.tl l) r k)
;                                                 k) ==>
;                                           (forall (pure_result: Prims.unit).
;                                               (forall (x: Prims.int).
;                                                   GenericStability.filter_eq x
;                                                     [FStar.List.Tot.Base.hd l]
;                                                     k @
;                                                   GenericStability.filter_eq x
;                                                     (MergeSort2.merge' (FStar.List.Tot.Base.tl l)
;                                                         r
;                                                         k)
;                                                     k =
;                                                   GenericStability.filter_eq x
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec merge'_filter_eq_inv`
...
;;; Fact-ids: 
(assert (! (not 
;; def=MergeSort2.fst(76,2-88,5); use=MergeSort2.fst(76,2-88,5)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=MergeSort2.fst(73,19-73,29); use=MergeSort2.fst(76,2-88,5)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_1
x_582acf81e02a6e4176cba5e2730f867d_3))


;; def=MergeSort2.fst(73,33-73,43); use=MergeSort2.fst(76,2-88,5)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_2
x_582acf81e02a6e4176cba5e2730f867d_3))


;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(76,2-88,5)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=MergeSort2.fst(74,17-74,103); use=MergeSort2.fst(76,2-88,5)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=MergeSort2.fst(74,28-74,102); use=MergeSort2.fst(76,2-88,5)
(and 
;; def=MergeSort2.fst(74,28-74,35); use=MergeSort2.fst(76,2-88,5)
(or label_2
...
;; def=MergeSort2.fst(74,39-74,46); use=MergeSort2.fst(76,2-88,5)
(or label_3
...
;; def=MergeSort2.fst(74,50-74,102); use=MergeSort2.fst(76,2-88,5)
(or label_4
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(76,2-88,5)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(76,2-88,5)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=MergeSort2.fst(76,2-88,5)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(76,2-88,5)
(Valid 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(76,2-88,5)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(76,2-88,5)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(76,2-88,5)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort2.fst(76,2-88,5)
(and (implies 
;; def=MergeSort2.fst(76,5-76,24); use=MergeSort2.fst(76,5-76,24)
(= (Prims.op_LessThan (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
(FStar.List.Tot.Base.hd x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_2))
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
(FStar.List.Tot.Base.hd x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_1)))
...
;; def=Prims.fst(441,29-441,97); use=MergeSort2.fst(77,4-77,15)
(and 
;; def=GenericStability.fst(97,18-97,31); use=MergeSort2.fst(77,4-77,15)
(or label_5
...
;; def=GenericStability.fst(97,35-97,58); use=MergeSort2.fst(77,4-77,15)
(or label_6

;; def=GenericStability.fst(97,35-97,58); use=MergeSort2.fst(77,4-77,15)
(> (BoxInt_proj_0 (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
(FStar.List.Tot.Base.hd x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_1)))
(BoxInt_proj_0 (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
(FStar.List.Tot.Base.hd x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(77,4-77,15)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=GenericStability.fst(98,17-98,59); use=MergeSort2.fst(77,4-77,15)
(Valid 
;; def=GenericStability.fst(98,17-98,59); use=MergeSort2.fst(77,4-77,15)
...
x_9a99f0ed3c7c19be1f30eec0ab46713a_2)
x_9a99f0ed3c7c19be1f30eec0ab46713a_1)
(FStar.List.Tot.Base.tl x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_2))
x_582acf81e02a6e4176cba5e2730f867d_3)
)
)

;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(76,2-88,5)
(and 
;; def=Prims.fst(73,23-73,30); use=Prims.fst(615,10-615,16)
(or label_7

;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(76,2-88,5)
(Valid 
;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(76,2-88,5)
...
;; def=Prims.fst(356,2-356,58); use=MergeSort2.fst(76,2-88,5)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.eqtype)

;; def=Prims.fst(356,26-356,41); use=MergeSort2.fst(76,2-88,5)
(= @x3
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))
)

;; def=Prims.fst(451,66-451,102); use=MergeSort2.fst(76,2-88,5)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.bool)

;; def=MergeSort2.fst(78,7-78,18); use=MergeSort2.fst(78,7-78,18)
(= (Prims.op_Equality (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(FStar.List.Tot.Base.tl x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_2)
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))
@x4)
...
;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(76,2-88,5)
(Valid 
;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(76,2-88,5)
(ApplyTT @x5
@x6)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MergeSort2.fst(76,2-88,5)
(not 
;; def=MergeSort2.fst(78,7-78,18); use=MergeSort2.fst(78,7-78,18)
(= (Prims.op_Equality (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(FStar.List.Tot.Base.tl x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(76,2-88,5)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.bool)

;; def=MergeSort2.fst(78,7-81,51); use=MergeSort2.fst(78,7-81,51)
(= (Prims.op_Equality (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(FStar.List.Tot.Base.tl x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_2)
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(76,2-88,5)
(and 
;; def=MergeSort2.fst(72,74-72,81); use=MergeSort2.fst(80,29-80,35)
(or label_8
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(76,2-88,5)
(and 
;; def=MergeSort2.fst(72,27-88,5); use=MergeSort2.fst(80,36-80,37)
(or label_9

;; def=MergeSort2.fst(76,2-88,5); use=MergeSort2.fst(80,36-80,37)
(Valid 
;; def=MergeSort2.fst(76,2-88,5); use=MergeSort2.fst(80,36-80,37)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(72,87-75,37); use=MergeSort2.fst(76,2-88,5)
(= x_582acf81e02a6e4176cba5e2730f867d_3
@x8)
)

;; def=Prims.fst(441,29-441,97); use=MergeSort2.fst(80,6-80,26)
(and 
;; def=MergeSort2.fst(73,19-73,29); use=MergeSort2.fst(80,6-80,26)
(or label_10
...
;; def=MergeSort2.fst(73,33-73,43); use=MergeSort2.fst(80,6-80,26)
(or label_11
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(80,6-80,26)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.unit)

;; def=MergeSort2.fst(74,17-74,103); use=MergeSort2.fst(80,6-80,26)
(forall ((@x10 Term))
 (! (implies (HasType @x10
Prims.int)

;; def=MergeSort2.fst(74,28-74,102); use=MergeSort2.fst(80,6-80,26)
(and 
;; def=MergeSort2.fst(74,28-74,35); use=MergeSort2.fst(80,6-80,26)
(BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_1))


;; def=MergeSort2.fst(74,39-74,46); use=MergeSort2.fst(80,6-80,26)
(BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.List.Tot.Base.tl x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_2)))


;; def=MergeSort2.fst(74,50-74,102); use=MergeSort2.fst(80,6-80,26)
(= (GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
@x10
(FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_1
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(81,6-81,22)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=GenericStability.fst(52,17-52,90); use=MergeSort2.fst(81,6-81,22)
(forall ((@x11 Term))
 (! (implies (HasType @x11
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=MergeSort2.fst(81,6-81,22)
(= (FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
(GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
@x11
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(81,6-81,22)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(81,6-81,22)
(ApplyTT @x5
@x10)
...
;; def=MergeSort2.fst(76,5-88,5); use=MergeSort2.fst(76,5-88,5)
(= (Prims.op_LessThan (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
(FStar.List.Tot.Base.hd x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_2))
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
...
;; def=MergeSort2.fst(84,10-84,21); use=MergeSort2.fst(84,10-84,21)
(= (Prims.op_Equality (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(FStar.List.Tot.Base.tl x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_1)
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))
...
;; def=MergeSort2.fst(84,10-87,49); use=MergeSort2.fst(84,10-87,49)
(= (Prims.op_Equality (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(FStar.List.Tot.Base.tl x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_1)
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(76,2-88,5)
(and 
;; def=MergeSort2.fst(72,50-72,57); use=MergeSort2.fst(86,25-86,31)
(or label_13
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(76,2-88,5)
(and 
;; def=MergeSort2.fst(72,27-88,5); use=MergeSort2.fst(86,34-86,35)
(or label_14

;; def=MergeSort2.fst(76,2-88,5); use=MergeSort2.fst(86,34-86,35)
(Valid 
;; def=MergeSort2.fst(76,2-88,5); use=MergeSort2.fst(86,34-86,35)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(72,40-88,5); use=MergeSort2.fst(86,34-86,35)
(and 
;; def=MergeSort2.fst(72,40-75,33); use=MergeSort2.fst(86,34-86,35)
(Valid 
;; def=MergeSort2.fst(72,40-75,33); use=MergeSort2.fst(86,34-86,35)
(Prims.op_Equals_Equals_Equals (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(441,29-441,97); use=MergeSort2.fst(86,4-86,24)
(and 
;; def=MergeSort2.fst(73,19-73,29); use=MergeSort2.fst(86,4-86,24)
(or label_15
...
;; def=MergeSort2.fst(73,33-73,43); use=MergeSort2.fst(86,4-86,24)
(or label_16
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(86,4-86,24)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.unit)

;; def=MergeSort2.fst(74,17-74,103); use=MergeSort2.fst(86,4-86,24)
(forall ((@x10 Term))
 (! (implies (HasType @x10
Prims.int)

;; def=MergeSort2.fst(74,28-74,102); use=MergeSort2.fst(86,4-86,24)
(and 
;; def=MergeSort2.fst(74,28-74,35); use=MergeSort2.fst(86,4-86,24)
(BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.List.Tot.Base.tl x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_1)))


;; def=MergeSort2.fst(74,39-74,46); use=MergeSort2.fst(86,4-86,24)
(BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_2))


;; def=MergeSort2.fst(74,50-74,102); use=MergeSort2.fst(86,4-86,24)
(= (GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
@x10
(FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.List.Tot.Base.tl x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(87,4-87,20)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=GenericStability.fst(52,17-52,90); use=MergeSort2.fst(87,4-87,20)
(forall ((@x11 Term))
 (! (implies (HasType @x11
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=MergeSort2.fst(87,4-87,20)
(= (FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
(GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
@x11
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(87,4-87,20)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(87,4-87,20)
(ApplyTT @x5
@x10)
...
; Starting query at MergeSort2.fst(75,0-88,5)
...
(declare-fun Tm_refine_41baf604c37e925a53bdc7f374d17896 (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(72,27-88,5); use=MergeSort2.fst(75,0-88,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (HasType (Tm_refine_41baf604c37e925a53bdc7f374d17896 @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_41baf604c37e925a53bdc7f374d17896 @x0
@x1
@x2
@x3
@x4
@x5)
Tm_type))
:qid refinement_kinding_Tm_refine_41baf604c37e925a53bdc7f374d17896))

:named refinement_kinding_Tm_refine_41baf604c37e925a53bdc7f374d17896))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(72,27-88,5); use=MergeSort2.fst(75,0-88,5)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_41baf604c37e925a53bdc7f374d17896 @x2
@x3
@x4
@x5
@x6
...
;; def=MergeSort2.fst(72,27-88,5); use=MergeSort2.fst(75,0-88,5)
(and 
;; def=MergeSort2.fst(72,27-75,31); use=MergeSort2.fst(75,0-88,5)
(Valid 
;; def=MergeSort2.fst(72,27-75,31); use=MergeSort2.fst(75,0-88,5)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(72,40-88,5); use=MergeSort2.fst(75,0-88,5)
(or 
;; def=MergeSort2.fst(76,2-88,5); use=MergeSort2.fst(76,2-88,5)
(Valid 
;; def=MergeSort2.fst(76,2-88,5); use=MergeSort2.fst(76,2-88,5)
...
;; def=MergeSort2.fst(72,40-88,5); use=MergeSort2.fst(75,0-88,5)
(and 
;; def=MergeSort2.fst(72,40-75,33); use=MergeSort2.fst(75,0-88,5)
(Valid 
;; def=MergeSort2.fst(72,40-75,33); use=MergeSort2.fst(75,0-88,5)
(Prims.op_Equals_Equals_Equals (Prims.list @x2)
(Prims.list @x3)
...
@x6
@x7)))
:qid refinement_interpretation_Tm_refine_41baf604c37e925a53bdc7f374d17896))

:named refinement_interpretation_Tm_refine_41baf604c37e925a53bdc7f374d17896))
;;;;;;;;;;;;;;;;haseq for Tm_refine_41baf604c37e925a53bdc7f374d17896
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(72,27-88,5); use=MergeSort2.fst(75,0-88,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_41baf604c37e925a53bdc7f374d17896 @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_41baf604c37e925a53bdc7f374d17896 @x0
@x1
@x2
@x3
@x4
@x5))))
:qid haseqTm_refine_41baf604c37e925a53bdc7f374d17896))

:named haseqTm_refine_41baf604c37e925a53bdc7f374d17896))
(declare-fun Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(73,18-73,44); use=MergeSort2.fst(75,8-75,28)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57 @x0
@x1
@x2
...
;; def=MergeSort2.fst(73,19-73,29); use=MergeSort2.fst(75,8-75,28)
(BoxBool_proj_0 (GenericSort.sorted @x2
@x3
@x4))


;; def=MergeSort2.fst(73,33-73,43); use=MergeSort2.fst(75,8-75,28)
(BoxBool_proj_0 (GenericSort.sorted @x2
@x5
@x4))
))
...
;   (l: Prims.list a {Cons? l})
;   (r: Prims.list a {Cons? r})
;   (k: (_: a -> Prims.int){a << a \/ a === a /\ (l << l \/ l === l /\ r << r)})
;   (_: Prims.squash (GenericSort.sorted l k /\ GenericSort.sorted r k)).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.int). Cons? l /\ Cons? r ==> Prims.hasEq (Prims.list a)
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MergeSort2.fst(75,0-88,5)
...
Prims.eqtype)
(HasType @x5
(Tm_refine_7aac12c24449a22c34d98a0ea8ed4a32 @x4))
(HasType @x6
(Tm_refine_7aac12c24449a22c34d98a0ea8ed4a32 @x4))
(HasType @x7
(Tm_refine_41baf604c37e925a53bdc7f374d17896 @x4
@x0
@x5
@x1
@x6
@x2))
(HasType @x8
(Tm_refine_f9c7a148bf7b7ec7c43ad4e1fd880f57 @x4
@x5
@x7
@x6)))

;; def=dummy(0,0-0,0); use=MergeSort2.fst(75,8-75,28)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.int)

;; def=MergeSort2.fst(74,28-74,35); use=MergeSort2.fst(75,8-75,28)
(BoxBool_proj_0 (Prims.uu___is_Cons @x4
@x5))


;; def=MergeSort2.fst(74,39-74,46); use=MergeSort2.fst(75,8-75,28)
(BoxBool_proj_0 (Prims.uu___is_Cons @x4
@x6))
)

;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(75,8-75,28)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MergeSort2.merge'_filter_eq_inv, 3)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Prims.list__uu___haseq, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f
...
; encoding sigelt let rec merge'_filter_eq_inv


; <Start encoding let rec merge'_filter_eq_inv>
...
; </end encoding let rec merge'_filter_eq_inv>


; encoding sigelt val MergeSort2.merge'_stable


; <Skipped val MergeSort2.merge'_stable/>

(push) ;; push{2

; Starting query at MergeSort2.fst(94,29-94,55)
...
;     GenericSort.sorted l k /\ GenericSort.sorted r k /\
;     (forall (pure_result: Prims.unit).
;         GenericStability.stable (l @ r) (MergeSort2.merge' l r k) k ==> p pure_result) ==>
;     GenericSort.sorted l k /\ GenericSort.sorted r k /\
;     (forall (pure_result: Prims.unit).
;         (forall (x: Prims.int).
;             Cons? l /\ Cons? r /\
...
; Context: While encoding a query
; While typechecking the top-level declaration `let merge'_stable`
...
;; def=MergeSort2.fst(92,19-92,29); use=MergeSort2.fst(94,29-94,55)
(BoxBool_proj_0 (GenericSort.sorted @x0
@x1
@x3))


;; def=MergeSort2.fst(92,33-92,43); use=MergeSort2.fst(94,29-94,55)
(BoxBool_proj_0 (GenericSort.sorted @x0
@x2
@x3))


;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(94,29-94,55)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=MergeSort2.fst(93,17-93,46); use=MergeSort2.fst(94,29-94,55)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(94,29-94,55)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(94,29-94,55)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(441,29-441,97); use=MergeSort2.fst(94,29-94,55)
(and 
;; def=MergeSort2.fst(73,19-73,29); use=MergeSort2.fst(94,29-94,49)
(or label_3
...
;; def=MergeSort2.fst(73,33-73,43); use=MergeSort2.fst(94,29-94,49)
(or label_4
...
;; def=MergeSort2.fst(74,17-74,103); use=MergeSort2.fst(94,29-94,49)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)

;; def=MergeSort2.fst(74,28-74,102); use=MergeSort2.fst(94,29-94,49)
(and 
;; def=MergeSort2.fst(74,28-74,35); use=MergeSort2.fst(94,29-94,49)
(BoxBool_proj_0 (Prims.uu___is_Cons @x0
@x1))


;; def=MergeSort2.fst(74,39-74,46); use=MergeSort2.fst(94,29-94,49)
(BoxBool_proj_0 (Prims.uu___is_Cons @x0
@x2))


;; def=MergeSort2.fst(74,50-74,102); use=MergeSort2.fst(94,29-94,49)
(= (GenericStability.filter_eq @x0
@x6
(FStar.List.Tot.Base.op_At @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MergeSort2.merge'_stable, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_GenericStability.stable
...
; encoding sigelt let merge'_stable


; <Start encoding let merge'_stable>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MergeSort2.merge__stable (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MergeSort2.merge__stable@tok () Term)

; </end encoding let merge'_stable>

(push) ;; push{2

; Starting query at MergeSort2.fst(97,0-101,48)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,40-97,68); use=MergeSort2.fst(97,40-97,68)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81))

:named refinement_kinding_Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,40-97,68); use=MergeSort2.fst(97,40-97,68)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=MergeSort2.fst(97,46-97,51); use=MergeSort2.fst(97,46-97,51)
(< (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 @x1))


;; def=MergeSort2.fst(97,55-97,67); use=MergeSort2.fst(97,55-97,67)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.List.Tot.Base.length @x2
@x3)))
))
...
(Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81))

:named refinement_interpretation_Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81))
;;;;;;;;;;;;;;;;haseq for Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,40-97,68); use=MergeSort2.fst(97,40-97,68)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 @x0
@x1)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 @x0
@x1))))
:qid haseqTm_refine_265d5aaae9c4478c5ac720ba42d3ea81))

:named haseqTm_refine_265d5aaae9c4478c5ac720ba42d3ea81))

; Encoding query formula : forall (a: Prims.eqtype)
;   (l: Prims.list a)
;   (n: Prims.nat{0 < n /\ n < FStar.List.Tot.Base.length l}).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (l_tup: Prims.list a & Prims.list a).
;     (*  - Subtyping check failed
...
; Context: While encoding a query
; While typechecking the top-level declaration `val MergeSort2.split_n`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MergeSort2.fst(97,0-101,48)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
(Prims.list @x0))
(HasType @x2
(Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 @x0
@x1)))

;; def=dummy(0,0-0,0); use=MergeSort2.fst(97,16-101,48)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.Pervasives.Native.tuple2 (Prims.list @x0)
(Prims.list @x0)))

;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(98,42-98,43)
(or label_1
...
; encoding sigelt val MergeSort2.split_n


; <Skipped val MergeSort2.split_n/>
...
; Starting query at MergeSort2.fst(103,2-105,69)
...
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))
:named binder_x_374b44ccfcb77ed85d505dbc44265913_1))
;;;;;;;;;;;;;;;;n : n: Prims.nat{0 < n /\ n < FStar.List.Tot.Base.length l} (n: Prims.nat{0 < n /\ n < FStar.List.Tot.Base.length l})
(declare-fun x_12ad13c179a423968cde28ef13b41120_2 () Term)
(declare-fun Tm_refine_ed79d725517da8cb1c3d6b1656dc617d () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_ed79d725517da8cb1c3d6b1656dc617d
Tm_type)
:named refinement_kinding_Tm_refine_ed79d725517da8cb1c3d6b1656dc617d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,40-97,68); use=MergeSort2.fst(102,8-102,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ed79d725517da8cb1c3d6b1656dc617d)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=MergeSort2.fst(97,46-97,51); use=MergeSort2.fst(102,8-102,15)
(< (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 @x1))


;; def=MergeSort2.fst(97,55-97,67); use=MergeSort2.fst(102,8-102,15)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.List.Tot.Base.length x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1)))
))
...
@x1
Tm_refine_ed79d725517da8cb1c3d6b1656dc617d))
:qid refinement_interpretation_Tm_refine_ed79d725517da8cb1c3d6b1656dc617d))

:named refinement_interpretation_Tm_refine_ed79d725517da8cb1c3d6b1656dc617d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ed79d725517da8cb1c3d6b1656dc617d
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ed79d725517da8cb1c3d6b1656dc617d))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_ed79d725517da8cb1c3d6b1656dc617d))
;;;;;;;;;;;;;;;;binder_x_12ad13c179a423968cde28ef13b41120_2
;;; Fact-ids: 
(assert (! (HasType x_12ad13c179a423968cde28ef13b41120_2
Tm_refine_ed79d725517da8cb1c3d6b1656dc617d)
:named binder_x_12ad13c179a423968cde28ef13b41120_2))
(declare-fun Tm_refine_af8ac072ca208ba4122a7471b7af9ace (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(97,14-105,69)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_af8ac072ca208ba4122a7471b7af9ace @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_af8ac072ca208ba4122a7471b7af9ace @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_af8ac072ca208ba4122a7471b7af9ace))

:named refinement_kinding_Tm_refine_af8ac072ca208ba4122a7471b7af9ace))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(97,14-105,69)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_af8ac072ca208ba4122a7471b7af9ace @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(97,14-105,69)
(or 
;; def=MergeSort2.fst(103,2-105,69); use=MergeSort2.fst(103,2-105,69)
(Valid 
;; def=MergeSort2.fst(103,2-105,69); use=MergeSort2.fst(103,2-105,69)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(97,14-105,69)
(and 
;; def=MergeSort2.fst(97,14-102,18); use=MergeSort2.fst(97,14-102,18)
(Valid 
;; def=MergeSort2.fst(97,14-102,18); use=MergeSort2.fst(97,14-102,18)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(97,27-105,69); use=MergeSort2.fst(97,27-105,69)
(or 
;; def=MergeSort2.fst(103,2-105,69); use=MergeSort2.fst(103,2-105,69)
(Valid 
;; def=MergeSort2.fst(103,2-105,69); use=MergeSort2.fst(103,2-105,69)
...
;; def=MergeSort2.fst(97,27-105,69); use=MergeSort2.fst(97,27-105,69)
(and 
;; def=MergeSort2.fst(97,27-102,20); use=MergeSort2.fst(97,27-102,20)
(Valid 
;; def=MergeSort2.fst(97,27-102,20); use=MergeSort2.fst(97,27-102,20)
(Prims.op_Equals_Equals_Equals (Prims.list @x2)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
Prims.nat
@x1
x_12ad13c179a423968cde28ef13b41120_2)
)
)
)
)
...
(Tm_refine_af8ac072ca208ba4122a7471b7af9ace @x2
@x3)))
:qid refinement_interpretation_Tm_refine_af8ac072ca208ba4122a7471b7af9ace))

:named refinement_interpretation_Tm_refine_af8ac072ca208ba4122a7471b7af9ace))
;;;;;;;;;;;;;;;;haseq for Tm_refine_af8ac072ca208ba4122a7471b7af9ace
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(97,14-105,69)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_af8ac072ca208ba4122a7471b7af9ace @x0
@x1)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_af8ac072ca208ba4122a7471b7af9ace @x0
@x1))))
:qid haseqTm_refine_af8ac072ca208ba4122a7471b7af9ace))

:named haseqTm_refine_af8ac072ca208ba4122a7471b7af9ace))
(declare-fun MergeSort2.split_n (Term Term Term) Term)

(declare-fun Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(98,6-101,48); use=MergeSort2.fst(102,8-102,15)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95))

:named refinement_kinding_Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(98,6-101,48); use=MergeSort2.fst(102,8-102,15)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (Prims.list @x2)
(Prims.list @x2)))

;; def=MergeSort2.fst(98,31-98,58); use=MergeSort2.fst(102,8-102,15)
(= (FStar.List.Tot.Base.op_At @x2
(FStar.Pervasives.Native.fst (Prims.list @x2)
(Prims.list @x2)
@x1)
(FStar.Pervasives.Native.snd (Prims.list @x2)
(Prims.list @x2)
@x1))
@x3)


;; def=MergeSort2.fst(99,7-99,36); use=MergeSort2.fst(102,8-102,15)
(< (BoxInt_proj_0 (FStar.List.Tot.Base.length @x2
(FStar.Pervasives.Native.fst (Prims.list @x2)
(Prims.list @x2)
@x1)))
...
;; def=MergeSort2.fst(100,7-100,36); use=MergeSort2.fst(102,8-102,15)
(< (BoxInt_proj_0 (FStar.List.Tot.Base.length @x2
(FStar.Pervasives.Native.snd (Prims.list @x2)
(Prims.list @x2)
@x1)))
...
;; def=MergeSort2.fst(101,7-101,46); use=MergeSort2.fst(102,8-102,15)
(Valid 
;; def=MergeSort2.fst(101,7-101,46); use=MergeSort2.fst(102,8-102,15)
(GenericSort.permutation_2 @x2
@x3
(FStar.Pervasives.Native.fst (Prims.list @x2)
(Prims.list @x2)
@x1)
...
(Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95))

:named refinement_interpretation_Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(98,6-101,48); use=MergeSort2.fst(102,8-102,15)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (Prims.list @x0)
(Prims.list @x0)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 @x0
@x1))))
:qid haseqTm_refine_f28b7a7fea85abb9aeab640e2a54cf95))

:named haseqTm_refine_f28b7a7fea85abb9aeab640e2a54cf95))
;;;;;;;;;;;;;;;;l: Prims.list a ->     n:       (n: Prims.nat{0 < n /\ n < FStar.List.Tot.Base.length l})         {a << a \/ a === a /\ (l << l \/ l === l /\ n << n)}   -> l_tup:     (Prims.list a & Prims.list a)       { FStar.Pervasives.Native.fst l_tup @ FStar.Pervasives.Native.snd l_tup = l /\         FStar.List.Tot.Base.length (FStar.Pervasives.Native.fst l_tup) <         FStar.List.Tot.Base.length l /\         FStar.List.Tot.Base.length (FStar.Pervasives.Native.snd l_tup) <         FStar.List.Tot.Base.length l /\         GenericSort.permutation_2 l           (FStar.Pervasives.Native.fst l_tup)           (FStar.Pervasives.Native.snd l_tup) }
(declare-fun Tm_arrow_860886105cfb23120935b5763007d8e8 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_860886105cfb23120935b5763007d8e8
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_860886105cfb23120935b5763007d8e8
Tm_type)
:named kinding_Tm_arrow_860886105cfb23120935b5763007d8e8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(97,14-105,69)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_860886105cfb23120935b5763007d8e8)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_860886105cfb23120935b5763007d8e8))
:qid MergeSort2_pre_typing_Tm_arrow_860886105cfb23120935b5763007d8e8))

:named MergeSort2_pre_typing_Tm_arrow_860886105cfb23120935b5763007d8e8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_860886105cfb23120935b5763007d8e8
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(97,14-105,69)
(forall ((@x0 Term))
...
(Prims.list @x1))
(HasType @x3
(Tm_refine_af8ac072ca208ba4122a7471b7af9ace @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
@x3)
(Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 @x1
@x2)))
...
@x2)
@x3))
:qid MergeSort2_interpretation_Tm_arrow_860886105cfb23120935b5763007d8e8.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid MergeSort2_interpretation_Tm_arrow_860886105cfb23120935b5763007d8e8.2))
...
@x1)
@x2))
:qid MergeSort2_interpretation_Tm_arrow_860886105cfb23120935b5763007d8e8.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_860886105cfb23120935b5763007d8e8))
:qid MergeSort2_interpretation_Tm_arrow_860886105cfb23120935b5763007d8e8))

:named MergeSort2_interpretation_Tm_arrow_860886105cfb23120935b5763007d8e8))
(declare-fun MergeSort2.split_n@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(102,8-102,15); use=MergeSort2.fst(102,8-102,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT MergeSort2.split_n@tok
@x0)
@x1)
@x2)
(MergeSort2.split_n @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT MergeSort2.split_n@tok
@x0)
@x1)
@x2))
:qid token_correspondence_MergeSort2.split_n))

:named token_correspondence_MergeSort2.split_n))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(102,8-102,15); use=MergeSort2.fst(102,8-102,15)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MergeSort2.split_n@tok
Tm_arrow_860886105cfb23120935b5763007d8e8))
...
@x2)
@x3)
(MergeSort2.split_n @x1
@x2
@x3))
 

:pattern ((MergeSort2.split_n @x1
@x2
@x3))
:qid function_token_typing_MergeSort2.split_n.1))
)
 

:pattern ((ApplyTT @x0
MergeSort2.split_n@tok))
:qid function_token_typing_MergeSort2.split_n))

:named function_token_typing_MergeSort2.split_n))
...
(Prims.list @x0))
(HasType @x2
(Tm_refine_af8ac072ca208ba4122a7471b7af9ace @x0
@x1)))
(HasType (MergeSort2.split_n @x0
@x1
@x2)
(Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 @x0
@x1)))
 

:pattern ((MergeSort2.split_n @x0
@x1
@x2))
:qid typing_MergeSort2.split_n))

:named typing_MergeSort2.split_n))
(declare-fun label_16 () Bool)
(declare-fun label_15 () Bool)
(declare-fun label_14 () Bool)
(declare-fun label_13 () Bool)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_84cdb2e504107028ab9ed2fa31a258de () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_84cdb2e504107028ab9ed2fa31a258de
Tm_type)
:named refinement_kinding_Tm_refine_84cdb2e504107028ab9ed2fa31a258de))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(98,6-101,48); use=MergeSort2.fst(103,2-105,69)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_84cdb2e504107028ab9ed2fa31a258de)
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)))

;; def=MergeSort2.fst(98,31-98,58); use=MergeSort2.fst(103,2-105,69)
(= (FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.fst (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
@x1)
(FStar.Pervasives.Native.snd (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
@x1))
x_374b44ccfcb77ed85d505dbc44265913_1)


;; def=MergeSort2.fst(99,7-99,36); use=MergeSort2.fst(103,2-105,69)
(< (BoxInt_proj_0 (FStar.List.Tot.Base.length x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.fst (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
@x1)))
...
;; def=MergeSort2.fst(100,7-100,36); use=MergeSort2.fst(103,2-105,69)
(< (BoxInt_proj_0 (FStar.List.Tot.Base.length x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.Pervasives.Native.snd (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
@x1)))
...
;; def=MergeSort2.fst(101,7-101,46); use=MergeSort2.fst(103,2-105,69)
(Valid 
;; def=MergeSort2.fst(101,7-101,46); use=MergeSort2.fst(103,2-105,69)
(GenericSort.permutation_2 x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1
...
@x1
Tm_refine_84cdb2e504107028ab9ed2fa31a258de))
:qid refinement_interpretation_Tm_refine_84cdb2e504107028ab9ed2fa31a258de))

:named refinement_interpretation_Tm_refine_84cdb2e504107028ab9ed2fa31a258de))
;;;;;;;;;;;;;;;;haseq for Tm_refine_84cdb2e504107028ab9ed2fa31a258de
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_84cdb2e504107028ab9ed2fa31a258de))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)))))
:named haseqTm_refine_84cdb2e504107028ab9ed2fa31a258de))
(declare-fun Tm_refine_724965cd52f85f36a90294b8ae53465f (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(105,20-105,27)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_724965cd52f85f36a90294b8ae53465f @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_724965cd52f85f36a90294b8ae53465f @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_724965cd52f85f36a90294b8ae53465f))

:named refinement_kinding_Tm_refine_724965cd52f85f36a90294b8ae53465f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(105,20-105,27)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_724965cd52f85f36a90294b8ae53465f @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=MergeSort2.fst(97,46-97,51); use=MergeSort2.fst(105,20-105,27)
(< (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 @x1))


;; def=MergeSort2.fst(97,55-97,67); use=MergeSort2.fst(105,20-105,27)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.List.Tot.Base.length x_9cd1733a5204f989dbb2f01d5984df93_0
@x2)))
...
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(105,20-105,27)
(or 
;; def=MergeSort2.fst(103,2-105,69); use=MergeSort2.fst(105,20-105,27)
(Valid 
;; def=MergeSort2.fst(103,2-105,69); use=MergeSort2.fst(105,20-105,27)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(97,27-105,69); use=MergeSort2.fst(105,20-105,27)
(and 
;; def=MergeSort2.fst(97,27-102,20); use=MergeSort2.fst(105,20-105,27)
(Valid 
;; def=MergeSort2.fst(97,27-102,20); use=MergeSort2.fst(105,20-105,27)
(Prims.op_Equals_Equals_Equals (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
@x1
(Tm_refine_724965cd52f85f36a90294b8ae53465f @x2)))
:qid refinement_interpretation_Tm_refine_724965cd52f85f36a90294b8ae53465f))

:named refinement_interpretation_Tm_refine_724965cd52f85f36a90294b8ae53465f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_724965cd52f85f36a90294b8ae53465f
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(105,20-105,27)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_724965cd52f85f36a90294b8ae53465f @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_724965cd52f85f36a90294b8ae53465f @x0))))
:qid haseqTm_refine_724965cd52f85f36a90294b8ae53465f))

:named haseqTm_refine_724965cd52f85f36a90294b8ae53465f))
(declare-fun Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(98,6-101,48); use=MergeSort2.fst(103,2-105,69)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33))

:named refinement_kinding_Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(98,6-101,48); use=MergeSort2.fst(103,2-105,69)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
@x1
(Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33 @x2)))
:qid refinement_interpretation_Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33))

:named refinement_interpretation_Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(98,6-101,48); use=MergeSort2.fst(103,2-105,69)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33 @x0))))
:qid haseqTm_refine_d881694e2c5ef9e78cbf2eabc793bd33))

:named haseqTm_refine_d881694e2c5ef9e78cbf2eabc793bd33))


; Encoding query formula : (forall (l_tup: Prims.list a & Prims.list a).
;     (*  - Subtyping check failed
;   - Expected type Prims.eqtype got type Type0
; *)
;     Prims.hasEq (Prims.list a)) /\
...
;         Prims.hasEq (Prims.list a)) /\
;     (forall (k:
;         Prims.pure_post (l_tup:
;             (Prims.list a & Prims.list a)
;               { FStar.Pervasives.Native.fst l_tup @ FStar.Pervasives.Native.snd l_tup = l /\
;                 FStar.List.Tot.Base.length (FStar.Pervasives.Native.fst l_tup) <
;                 FStar.List.Tot.Base.length l /\
;                 FStar.List.Tot.Base.length (FStar.Pervasives.Native.snd l_tup) <
;                 FStar.List.Tot.Base.length l /\
;                 GenericSort.permutation_2 l
;                   (FStar.Pervasives.Native.fst l_tup)
;                   (FStar.Pervasives.Native.snd l_tup) })).
;         (forall (x:
;             l_tup:
;             (Prims.list a & Prims.list a)
;               { FStar.Pervasives.Native.fst l_tup @ FStar.Pervasives.Native.snd l_tup = l /\
...
;         (n = 1 == true ==>
;           FStar.Pervasives.Native.fst ([b], b) @ FStar.Pervasives.Native.snd ([b], b) = l /\
;           FStar.List.Tot.Base.length (FStar.Pervasives.Native.fst ([b], b)) <
;           FStar.List.Tot.Base.length l /\
;           FStar.List.Tot.Base.length (FStar.Pervasives.Native.snd ([b], b)) <
;           FStar.List.Tot.Base.length l /\
;           GenericSort.permutation_2 l
;             (FStar.Pervasives.Native.fst ([b], b))
;             (FStar.Pervasives.Native.snd ([b], b))) /\
;         (~(n = 1 = true) ==>
;           (forall (b: Prims.bool).
;               n = 1 == b ==>
;               (forall (l_tup: Prims.list a & Prims.list a).
...
; *)
;                   Prims.hasEq (Prims.list a)) /\
;               (n - 1 >= 0) /\ ((0 < n - 1) /\ (n - 1 < FStar.List.Tot.Base.length b)) /\
;               (a << a \/ (b << l \/ b === l /\ n - 1 << n)) /\
;               (forall (return_val:
;                   n:
;                   (n: Prims.nat{0 < n /\ n < FStar.List.Tot.Base.length b})
;                     {a << a \/ (b << l \/ b === l /\ n << n)}).
;                   return_val == n - 1 ==>
;                   (forall (any_result:
;                       l_tup:
;                       (Prims.list a & Prims.list a)
;                         { FStar.Pervasives.Native.fst l_tup @ FStar.Pervasives.Native.snd l_tup = b /\
;                           FStar.List.Tot.Base.length (FStar.Pervasives.Native.fst l_tup) <
;                           FStar.List.Tot.Base.length b /\
;                           FStar.List.Tot.Base.length (FStar.Pervasives.Native.snd l_tup) <
;                           FStar.List.Tot.Base.length b /\
;                           GenericSort.permutation_2 b
;                             (FStar.Pervasives.Native.fst l_tup)
;                             (FStar.Pervasives.Native.snd l_tup) }).
;                       MergeSort2.split_n b (n - 1) == any_result ==>
;                       FStar.Pervasives.Native.fst (b ::
;                         FStar.Pervasives.Native.fst (MergeSort2.split_n b (n - 1)),
;                         FStar.Pervasives.Native.snd (MergeSort2.split_n b (n - 1))) @
;                       FStar.Pervasives.Native.snd (b ::
;                         FStar.Pervasives.Native.fst (MergeSort2.split_n b (n - 1)),
;                         FStar.Pervasives.Native.snd (MergeSort2.split_n b (n - 1))) =
;                       l /\
;                       FStar.List.Tot.Base.length (FStar.Pervasives.Native.fst (b ::
;                             FStar.Pervasives.Native.fst (MergeSort2.split_n b (n - 1)),
;                             FStar.Pervasives.Native.snd (MergeSort2.split_n b (n - 1)))) <
;                       FStar.List.Tot.Base.length l /\
;                       FStar.List.Tot.Base.length (FStar.Pervasives.Native.snd (b ::
;                             FStar.Pervasives.Native.fst (MergeSort2.split_n b (n - 1)),
;                             FStar.Pervasives.Native.snd (MergeSort2.split_n b (n - 1)))) <
;                       FStar.List.Tot.Base.length l /\
;                       GenericSort.permutation_2 l
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec split_n`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(103,2-105,69)
(and 
;; def=dummy(0,0-0,0); use=MergeSort2.fst(103,2-105,69)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.Pervasives.Native.tuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)))

;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(102,8-102,15)
(or label_1

;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(103,2-105,69)
(Valid 
;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(103,2-105,69)
(Prims.hasEq (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))
)
...
(implies 
;; def=MergeSort2.fst(102,19-102,20); use=MergeSort2.fst(103,8-103,9)
(not 
;; def=MergeSort2.fst(102,19-102,20); use=MergeSort2.fst(103,8-103,9)
(BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(103,2-105,69)
(forall ((@x0 Term))
 (! (implies (HasType @x0
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=MergeSort2.fst(102,19-104,10); use=MergeSort2.fst(103,8-104,10)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x0
@x1))
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(103,2-105,69)
(and 
;; def=dummy(0,0-0,0); use=MergeSort2.fst(104,14-105,69)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.Pervasives.Native.tuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(104,14-105,69)
(Valid 
;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(104,14-105,69)
(Prims.hasEq (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))
)
...
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.pure_post Tm_refine_84cdb2e504107028ab9ed2fa31a258de))

;; def=Prims.fst(402,27-402,88); use=MergeSort2.fst(103,2-105,69)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(103,2-105,69)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(103,2-105,69)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort2.fst(103,2-105,69)
(and (implies 
;; def=MergeSort2.fst(104,17-104,22); use=MergeSort2.fst(104,17-104,22)
...
;; def=MergeSort2.fst(98,31-101,46); use=MergeSort2.fst(104,28-104,37)
(and 
;; def=MergeSort2.fst(98,31-98,58); use=MergeSort2.fst(104,28-104,37)
(or label_4
...
;; def=MergeSort2.fst(99,7-99,36); use=MergeSort2.fst(104,28-104,37)
(or label_5
...
;; def=MergeSort2.fst(100,7-100,36); use=MergeSort2.fst(104,28-104,37)
(or label_6
...
;; def=MergeSort2.fst(101,7-101,46); use=MergeSort2.fst(104,28-104,37)
(or label_7
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MergeSort2.fst(103,2-105,69)
(not 
;; def=MergeSort2.fst(104,17-104,22); use=MergeSort2.fst(104,17-104,22)
(= (Prims.op_Equality Prims.int
x_12ad13c179a423968cde28ef13b41120_2
...
;; def=MergeSort2.fst(104,17-105,69); use=MergeSort2.fst(104,17-105,69)
(= (Prims.op_Equality Prims.int
x_12ad13c179a423968cde28ef13b41120_2
(BoxInt 1))
@x3)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(103,2-105,69)
(and 
;; def=dummy(0,0-0,0); use=MergeSort2.fst(105,8-105,69)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.Pervasives.Native.tuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)))

;; def=Prims.fst(73,23-73,30); use=MergeSort2.fst(105,20-105,27)
(or label_8
...
;; def=Prims.fst(680,18-680,24); use=MergeSort2.fst(105,31-105,36)
(or label_9

;; def=Prims.fst(680,18-680,24); use=MergeSort2.fst(105,31-105,36)
(>= (BoxInt_proj_0 (Prims.op_Subtraction x_12ad13c179a423968cde28ef13b41120_2
(BoxInt 1)))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=MergeSort2.fst(97,46-97,51); use=MergeSort2.fst(105,31-105,36)
(or label_10
...
;; def=MergeSort2.fst(97,55-97,67); use=MergeSort2.fst(105,31-105,36)
(or label_11
...
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(105,31-105,36)
(or label_12

;; def=MergeSort2.fst(103,2-105,69); use=MergeSort2.fst(105,31-105,36)
(Valid 
;; def=MergeSort2.fst(103,2-105,69); use=MergeSort2.fst(105,31-105,36)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(97,27-105,69); use=MergeSort2.fst(105,31-105,36)
(and 
;; def=MergeSort2.fst(97,27-102,20); use=MergeSort2.fst(105,31-105,36)
(Valid 
;; def=MergeSort2.fst(97,27-102,20); use=MergeSort2.fst(105,31-105,36)
(Prims.op_Equals_Equals_Equals (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
(Prims.precedes Prims.nat
Prims.nat
(Prims.op_Subtraction x_12ad13c179a423968cde28ef13b41120_2
(BoxInt 1))
x_12ad13c179a423968cde28ef13b41120_2)
)
)
...
;; def=Prims.fst(356,2-356,58); use=MergeSort2.fst(103,2-105,69)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Tm_refine_724965cd52f85f36a90294b8ae53465f @x1))

;; def=Prims.fst(356,26-356,41); use=MergeSort2.fst(103,2-105,69)
(= @x4
(Prims.op_Subtraction x_12ad13c179a423968cde28ef13b41120_2
(BoxInt 1)))
)

;; def=Prims.fst(451,66-451,102); use=MergeSort2.fst(103,2-105,69)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Tm_refine_d881694e2c5ef9e78cbf2eabc793bd33 @x1))

;; def=MergeSort2.fst(105,13-105,36); use=MergeSort2.fst(105,13-105,36)
(= (MergeSort2.split_n x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
(Prims.op_Subtraction x_12ad13c179a423968cde28ef13b41120_2
(BoxInt 1)))
@x5)
...
;; def=MergeSort2.fst(98,31-101,46); use=MergeSort2.fst(105,40-105,69)
(and 
;; def=MergeSort2.fst(98,31-98,58); use=MergeSort2.fst(105,40-105,69)
(or label_13
...
;; def=MergeSort2.fst(99,7-99,36); use=MergeSort2.fst(105,40-105,69)
(or label_14
...
;; def=MergeSort2.fst(100,7-100,36); use=MergeSort2.fst(105,40-105,69)
(or label_15
...
;; def=MergeSort2.fst(101,7-101,46); use=MergeSort2.fst(105,40-105,69)
(or label_16
...
; Starting query at MergeSort2.fst(102,0-105,69)
...
:named haseqTm_refine_265d5aaae9c4478c5ac720ba42d3ea81))
(declare-fun Tm_refine_5532da505baa863503e69de86916d21d (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(102,0-105,69)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_refine_5532da505baa863503e69de86916d21d @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_refine_5532da505baa863503e69de86916d21d @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid refinement_kinding_Tm_refine_5532da505baa863503e69de86916d21d))

:named refinement_kinding_Tm_refine_5532da505baa863503e69de86916d21d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(102,0-105,69)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5532da505baa863503e69de86916d21d @x2
@x3
@x4
@x5
@x6))
...
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(102,0-105,69)
(and 
;; def=MergeSort2.fst(97,14-102,18); use=MergeSort2.fst(102,0-105,69)
(Valid 
;; def=MergeSort2.fst(97,14-102,18); use=MergeSort2.fst(102,0-105,69)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
;; def=MergeSort2.fst(97,27-105,69); use=MergeSort2.fst(102,0-105,69)
(or 
;; def=MergeSort2.fst(103,2-105,69); use=MergeSort2.fst(103,2-105,69)
(Valid 
;; def=MergeSort2.fst(103,2-105,69); use=MergeSort2.fst(103,2-105,69)
...
;; def=MergeSort2.fst(97,27-105,69); use=MergeSort2.fst(102,0-105,69)
(and 
;; def=MergeSort2.fst(97,27-102,20); use=MergeSort2.fst(102,0-105,69)
(Valid 
;; def=MergeSort2.fst(97,27-102,20); use=MergeSort2.fst(102,0-105,69)
(Prims.op_Equals_Equals_Equals (Prims.list @x2)
(Prims.list @x4)
...
@x5
@x6)))
:qid refinement_interpretation_Tm_refine_5532da505baa863503e69de86916d21d))

:named refinement_interpretation_Tm_refine_5532da505baa863503e69de86916d21d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5532da505baa863503e69de86916d21d
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(97,14-105,69); use=MergeSort2.fst(102,0-105,69)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5532da505baa863503e69de86916d21d @x0
@x1
@x2
@x3
@x4)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_5532da505baa863503e69de86916d21d @x0
@x1
@x2
@x3
@x4))))
:qid haseqTm_refine_5532da505baa863503e69de86916d21d))

:named haseqTm_refine_5532da505baa863503e69de86916d21d))
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MergeSort2.fst(102,0-105,69)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
(Prims.list @x3))
(HasType @x5
(Tm_refine_5532da505baa863503e69de86916d21d @x3
@x4
@x0
@x1
@x2)))
...
(forall ((@x6 Term))
 (! (implies (HasType @x6
(FStar.Pervasives.Native.tuple2 (Prims.list @x3)
(Prims.list @x3)))
...
; encoding sigelt let rec split_n


; <Start encoding let rec split_n>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun MergeSort2.split_n.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun MergeSort2.split_n.fuel_instrumented_token () Term)
(declare-fun MergeSort2.split_n (Term Term Term) Term)
(declare-fun MergeSort2.split_n@tok () Term)
(declare-fun Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 (Term Term) Term)
(declare-fun Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 (Term Term) Term)
...
;;;;;;;;;;;;;;;;l: Prims.list a -> n: Prims.nat{0 < n /\ n < FStar.List.Tot.Base.length l}   -> l_tup:     (Prims.list a & Prims.list a)       { FStar.Pervasives.Native.fst l_tup @ FStar.Pervasives.Native.snd l_tup = l /\         FStar.List.Tot.Base.length (FStar.Pervasives.Native.fst l_tup) <         FStar.List.Tot.Base.length l /\         FStar.List.Tot.Base.length (FStar.Pervasives.Native.snd l_tup) <         FStar.List.Tot.Base.length l /\         GenericSort.permutation_2 l           (FStar.Pervasives.Native.fst l_tup)           (FStar.Pervasives.Native.snd l_tup) }
(declare-fun Tm_arrow_920d7f9c13793dadd08b0c1764f6c61d () Term)


; </end encoding let rec split_n>


; encoding sigelt val MergeSort2.split_half


; <Skipped val MergeSort2.split_half/>
...
; Starting query at MergeSort2.fst(110,22-110,48)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(108,29-108,54); use=MergeSort2.fst(110,4-110,14)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba))

:named refinement_kinding_Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(108,29-108,54); use=MergeSort2.fst(110,4-110,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))

;; def=MergeSort2.fst(108,39-108,52); use=MergeSort2.fst(110,4-110,14)
(>= (BoxInt_proj_0 (FStar.List.Tot.Base.length @x2
@x1))
...
@x1
(Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba @x2)))
:qid refinement_interpretation_Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba))

:named refinement_interpretation_Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(108,29-108,54); use=MergeSort2.fst(110,4-110,14)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba @x0)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba @x0))))
:qid haseqTm_refine_ce2d1b3837e674d387c3a28a9a7243ba))

:named haseqTm_refine_ce2d1b3837e674d387c3a28a9a7243ba))

; Encoding query formula : forall (a: Prims.eqtype) (l: Prims.list a {FStar.List.Tot.Base.length l >= 2}).
;   (*  - Could not prove post-condition
; *)
;   FStar.List.Tot.Base.length l / 2 >= 0 /\
;   (0 < FStar.List.Tot.Base.length l / 2) /\
;   (FStar.List.Tot.Base.length l / 2 < FStar.List.Tot.Base.length l)


; Context: While encoding a query
; While typechecking the top-level declaration `let split_half`
...
Prims.eqtype)
(HasType @x1
(Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba @x0)))

;; def=MergeSort2.fst(97,46-97,67); use=MergeSort2.fst(110,32-110,48)
(and 
;; def=Prims.fst(680,18-680,24); use=MergeSort2.fst(110,32-110,48)
(or label_1

;; def=Prims.fst(680,18-680,24); use=MergeSort2.fst(110,32-110,48)
(>= (BoxInt_proj_0 (Prims.op_Division (FStar.List.Tot.Base.length @x0
@x1)
(BoxInt 2)))
(BoxInt_proj_0 (BoxInt 0)))
)
...
;; def=MergeSort2.fst(97,46-97,51); use=MergeSort2.fst(110,32-110,48)
(or label_2
...
;; def=MergeSort2.fst(97,55-97,67); use=MergeSort2.fst(110,32-110,48)
(or label_3
...
@x1)
(BoxInt 2)))
(BoxInt_proj_0 (FStar.List.Tot.Base.length @x0
@x1)))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MergeSort2.split_half, 1)
; STATUS: unsat
...
; encoding sigelt let split_half


; <Start encoding let split_half>

(declare-fun Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba (Term) Term)
(declare-fun MergeSort2.split_half (Term Term) Term)

;;;;;;;;;;;;;;;;l: Prims.list a {FStar.List.Tot.Base.length l >= 2} -> Prims.list a & Prims.list a
(declare-fun Tm_arrow_f08670105130c325854210e503d29f2b () Term)
(declare-fun MergeSort2.split_half@tok () Term)


; </end encoding let split_half>


; encoding sigelt val MergeSort2.mergesort'


; <Skipped val MergeSort2.mergesort'/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MergeSort2.split_n; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(102,8-102,15); use=MergeSort2.fst(102,8-102,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
:named typing_MergeSort2.split_n))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MergeSort2.split_half; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(110,4-110,14); use=MergeSort2.fst(110,4-110,14)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
(Tm_refine_ce2d1b3837e674d387c3a28a9a7243ba @x0)))
(HasType (MergeSort2.split_half @x0
@x1)
(FStar.Pervasives.Native.tuple2 (Prims.list @x0)
(Prims.list @x0))))
 

:pattern ((MergeSort2.split_half @x0
@x1))
:qid typing_MergeSort2.split_half))

:named typing_MergeSort2.split_half))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name MergeSort2.split_n; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(102,8-102,15); use=MergeSort2.fst(102,8-102,15)
...
(Prims.list @x1))
(HasType @x3
(Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 @x1
@x2)))
(HasType (MergeSort2.split_n.fuel_instrumented @u0
@x1
@x2
@x3)
(Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95 @x1
...
:pattern ((MergeSort2.split_n.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_MergeSort2.split_n.fuel_instrumented))

:named token_correspondence_MergeSort2.split_n.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name MergeSort2.split_n; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(98,6-101,48); use=MergeSort2.fst(102,8-102,15)
...
:named haseqTm_refine_265d5aaae9c4478c5ac720ba42d3ea81))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: MergeSort2.split_n
;;; Fact-ids: Name MergeSort2.split_n; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(102,8-102,15); use=MergeSort2.fst(102,8-102,15)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81 @x1
@x2)))
(= (MergeSort2.split_n.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x2))
...
(Prims.Cons @x1
(Prims.Cons_hd @lb4)
(FStar.Pervasives.Native.fst (Prims.list @x1)
(Prims.list @x1)
(MergeSort2.split_n.fuel_instrumented @u0
@x1
(Prims.Cons_tl @lb4)
(Prims.op_Subtraction @x3
(BoxInt 1)))))
(FStar.Pervasives.Native.snd (Prims.list @x1)
(Prims.list @x1)
(MergeSort2.split_n.fuel_instrumented @u0
@x1
(Prims.Cons_tl @lb4)
...
:pattern ((MergeSort2.split_n.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_MergeSort2.split_n.fuel_instrumented))

:named equation_with_fuel_MergeSort2.split_n.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for MergeSort2.split_half
;;; Fact-ids: Name MergeSort2.split_half; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(110,4-110,14); use=MergeSort2.fst(110,4-110,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (MergeSort2.split_half @x0
@x1)
(MergeSort2.split_n @x0
@x1
(Prims.op_Division (FStar.List.Tot.Base.length @x0
@x1)
(BoxInt 2))))
...
:pattern ((MergeSort2.split_half @x0
@x1))
:qid equation_MergeSort2.split_half))

:named equation_MergeSort2.split_half))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name MergeSort2.split_n; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(102,8-102,15); use=MergeSort2.fst(102,8-102,15)
...
@x2
@x3)
(MergeSort2.split_n.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_MergeSort2.split_n.fuel_instrumented))

:named @fuel_irrelevance_MergeSort2.split_n.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name MergeSort2.split_n; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(102,8-102,15); use=MergeSort2.fst(102,8-102,15)
...
@x1
@x2)
(MergeSort2.split_n.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_MergeSort2.split_n.fuel_instrumented))

:named @fuel_correspondence_MergeSort2.split_n.fuel_instrumented))
(push) ;; push{2

; Starting query at MergeSort2.fst(115,2-120,54)
...
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(113,53-114,21); use=MergeSort2.fst(114,8-114,21)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
(declare-fun Tm_refine_b0115f9edd37694a429bd38db30efb79 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(113,41-120,54); use=MergeSort2.fst(113,41-120,54)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_b0115f9edd37694a429bd38db30efb79 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_b0115f9edd37694a429bd38db30efb79 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_b0115f9edd37694a429bd38db30efb79))

:named refinement_kinding_Tm_refine_b0115f9edd37694a429bd38db30efb79))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(113,41-120,54); use=MergeSort2.fst(113,41-120,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b0115f9edd37694a429bd38db30efb79 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x2))

;; def=MergeSort2.fst(115,2-120,54); use=MergeSort2.fst(115,2-120,54)
...
@x3)
(FStar.List.Tot.Base.length x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
)
...
(Tm_refine_b0115f9edd37694a429bd38db30efb79 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_b0115f9edd37694a429bd38db30efb79))

:named refinement_interpretation_Tm_refine_b0115f9edd37694a429bd38db30efb79))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b0115f9edd37694a429bd38db30efb79
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(113,41-120,54); use=MergeSort2.fst(113,41-120,54)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b0115f9edd37694a429bd38db30efb79 @x0
@x1)))
(Valid (Prims.hasEq (Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b0115f9edd37694a429bd38db30efb79 @x0
@x1))))
:qid haseqTm_refine_b0115f9edd37694a429bd38db30efb79))

:named haseqTm_refine_b0115f9edd37694a429bd38db30efb79))
(declare-fun MergeSort2.mergesort_ (Term Term Term) Term)


;;;;;;;;;;;;;;;;l: Prims.list a ->     k: (_: a -> Prims.int){FStar.List.Tot.Base.length l << FStar.List.Tot.Base.length l}   -> Prims.Tot (Prims.list a)
(declare-fun Tm_arrow_84ad74d78f30a4595b4636c7b51cff64 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_84ad74d78f30a4595b4636c7b51cff64
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_84ad74d78f30a4595b4636c7b51cff64
Tm_type)
:named kinding_Tm_arrow_84ad74d78f30a4595b4636c7b51cff64))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(113,19-120,54); use=MergeSort2.fst(113,41-120,54)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_84ad74d78f30a4595b4636c7b51cff64)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_84ad74d78f30a4595b4636c7b51cff64))
:qid MergeSort2_pre_typing_Tm_arrow_84ad74d78f30a4595b4636c7b51cff64))

:named MergeSort2_pre_typing_Tm_arrow_84ad74d78f30a4595b4636c7b51cff64))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_84ad74d78f30a4595b4636c7b51cff64
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(113,19-120,54); use=MergeSort2.fst(113,41-120,54)
(forall ((@x0 Term))
...
(Prims.list @x1))
(HasType @x3
(Tm_refine_b0115f9edd37694a429bd38db30efb79 @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x2)
@x3))
:qid MergeSort2_interpretation_Tm_arrow_84ad74d78f30a4595b4636c7b51cff64.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid MergeSort2_interpretation_Tm_arrow_84ad74d78f30a4595b4636c7b51cff64.2))
...
@x1)
@x2))
:qid MergeSort2_interpretation_Tm_arrow_84ad74d78f30a4595b4636c7b51cff64.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_84ad74d78f30a4595b4636c7b51cff64))
:qid MergeSort2_interpretation_Tm_arrow_84ad74d78f30a4595b4636c7b51cff64))

:named MergeSort2_interpretation_Tm_arrow_84ad74d78f30a4595b4636c7b51cff64))
(declare-fun MergeSort2.mergesort_@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(114,8-114,18); use=MergeSort2.fst(114,8-114,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT MergeSort2.mergesort_@tok
@x0)
@x1)
@x2)
(MergeSort2.mergesort_ @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT MergeSort2.mergesort_@tok
@x0)
@x1)
@x2))
:qid token_correspondence_MergeSort2.mergesort_))

:named token_correspondence_MergeSort2.mergesort_))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(114,8-114,18); use=MergeSort2.fst(114,8-114,18)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MergeSort2.mergesort_@tok
Tm_arrow_84ad74d78f30a4595b4636c7b51cff64))
...
@x2)
@x3)
(MergeSort2.mergesort_ @x1
@x2
@x3))
 

:pattern ((MergeSort2.mergesort_ @x1
@x2
@x3))
:qid function_token_typing_MergeSort2.mergesort_.1))
)
 

:pattern ((ApplyTT @x0
MergeSort2.mergesort_@tok))
:qid function_token_typing_MergeSort2.mergesort_))

:named function_token_typing_MergeSort2.mergesort_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(114,8-114,18); use=MergeSort2.fst(114,8-114,18)
...
(Prims.list @x0))
(HasType @x2
(Tm_refine_b0115f9edd37694a429bd38db30efb79 @x0
@x1)))
(HasType (MergeSort2.mergesort_ @x0
@x1
@x2)
(Prims.list @x0)))
 

:pattern ((MergeSort2.mergesort_ @x0
@x1
@x2))
:qid typing_MergeSort2.mergesort_))

:named typing_MergeSort2.mergesort_))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;         l == b :: b :: b ==>
;         FStar.List.Tot.Base.length l >= 2 /\
;         (forall (any_result: Prims.list a).
;             l == any_result ==>
;             (forall (any_result: Prims.list a & Prims.list a).
;                 MergeSort2.split_half l == any_result ==>
;                 (forall (b: Prims.list a) (b: Prims.list a).
;                     MergeSort2.split_half l == (b, b) ==>
;                     FStar.List.Tot.Base.length b << FStar.List.Tot.Base.length l /\
;                     (forall (any_result: (_: a -> Prims.int)).
;                         k == any_result ==>
;                         (forall (any_result: Prims.list a).
;                             MergeSort2.mergesort' b k == any_result ==>
;                             FStar.List.Tot.Base.length b << FStar.List.Tot.Base.length l)))))))
...
;; def=Prims.fst(402,27-402,88); use=MergeSort2.fst(115,2-120,54)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(115,2-120,54)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(115,2-120,54)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(115,2-120,54)
(and (implies 
;; def=MergeSort2.fst(114,22-120,54); use=MergeSort2.fst(115,2-120,54)
(and 
;; def=MergeSort2.fst(114,22-114,23); use=MergeSort2.fst(115,8-115,9)
(not 
;; def=MergeSort2.fst(114,22-114,23); use=MergeSort2.fst(115,8-115,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
label_1)
(implies 
;; def=Prims.fst(389,18-389,39); use=MergeSort2.fst(115,2-120,54)
(and 
;; def=Prims.fst(389,19-389,21); use=MergeSort2.fst(115,2-120,54)
(not 
;; def=MergeSort2.fst(114,22-114,23); use=MergeSort2.fst(115,8-115,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(115,2-120,54)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=MergeSort2.fst(114,22-118,11); use=MergeSort2.fst(115,8-118,11)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(115,2-120,54)
(and 
;; def=MergeSort2.fst(108,39-108,52); use=MergeSort2.fst(119,34-119,35)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=MergeSort2.fst(115,2-120,54)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=MergeSort2.fst(108,30-114,23); use=MergeSort2.fst(115,2-120,54)
(= x_374b44ccfcb77ed85d505dbc44265913_1
@x4)
)
...
;; def=MergeSort2.fst(119,8-119,35); use=MergeSort2.fst(119,8-119,35)
(= (MergeSort2.split_half x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1)
@x5)
)
...
;; def=MergeSort2.fst(119,8-119,20); use=MergeSort2.fst(119,8-119,20)
(= (MergeSort2.split_half x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1)
(FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(115,2-120,54)
(and 
;; def=MergeSort2.fst(115,2-120,54); use=MergeSort2.fst(120,29-120,30)
(or label_3
...
;; def=MergeSort2.fst(113,41-114,25); use=MergeSort2.fst(115,2-120,54)
...
;; def=MergeSort2.fst(33,26-120,31); use=MergeSort2.fst(115,2-120,54)
(= (MergeSort2.mergesort_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x6
x_582acf81e02a6e4176cba5e2730f867d_2)
@x9)
)

;; def=MergeSort2.fst(115,2-120,54); use=MergeSort2.fst(120,50-120,51)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MergeSort2.mergesort', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, @query, binder_x_374b44ccfcb77ed85d505dbc44265913_1, binder_x_9cd1733a5204f989dbb2f01d5984df93_0, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, equation_GenericSort.permutation_2, equation_MergeSort2.split_half, equation_Prims.eqtype, equation_Prims.nat, equation_with_fuel_FStar.List.Tot.Base.length.fuel_instrumented, fuel_guarded_inversion_Prims.list, int_typing, kinding_Prims.list@tok, primitive_Prims.op_Addition, primitive_Prims.op_Division, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, proj_equation_Prims.Cons_tl, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_Prims.Cons_tl, refinement_interpretation_Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_7aac12c24449a22c34d98a0ea8ed4a32, refinement_interpretation_Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95, token_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, typing_FStar.List.Tot.Base.length, typing_FStar.Pervasives.Native.fst, typing_FStar.Pervasives.Native.snd, typing_MergeSort2.split_n, typing_Prims.__proj__Cons__item__tl, well-founded-ordering-on-nat
...
; encoding sigelt let rec mergesort'


; <Start encoding let rec mergesort'>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun MergeSort2.mergesort_.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun MergeSort2.mergesort_.fuel_instrumented_token () Term)
(declare-fun MergeSort2.mergesort_ (Term Term Term) Term)
(declare-fun MergeSort2.mergesort_@tok () Term)



;;;;;;;;;;;;;;;;l: Prims.list a -> k: (_: a -> Prims.int) -> Prims.Tot (Prims.list a)
(declare-fun Tm_arrow_93b4e975982fc9b3d2cdacb45754b800 () Term)

; </end encoding let rec mergesort'>


; encoding sigelt val MergeSort2.mergesort'_sorted


; <Skipped val MergeSort2.mergesort'_sorted/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MergeSort2.mergesort'; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(114,8-114,18); use=MergeSort2.fst(114,8-114,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(HasType @x3
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(HasType (MergeSort2.mergesort_.fuel_instrumented @u0
@x1
@x2
@x3)
(Prims.list @x1)))
...
:pattern ((MergeSort2.mergesort_.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_MergeSort2.mergesort_.fuel_instrumented))

:named token_correspondence_MergeSort2.mergesort_.fuel_instrumented))
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: MergeSort2.mergesort'
;;; Fact-ids: Name MergeSort2.mergesort'; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(114,8-114,18); use=MergeSort2.fst(114,8-114,18)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(= (MergeSort2.mergesort_.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x2))
...
(ite (and (is-Prims.Cons @lb4)
(is-Prims.Cons (Prims.Cons_tl @lb4)))
(let ((@lb5 (MergeSort2.split_half @x1
@x2)))
(MergeSort2.merge_ @x1
(MergeSort2.mergesort_.fuel_instrumented @u0
@x1
...
:pattern ((MergeSort2.mergesort_.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_MergeSort2.mergesort_.fuel_instrumented))

:named equation_with_fuel_MergeSort2.mergesort_.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name MergeSort2.mergesort'; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(114,8-114,18); use=MergeSort2.fst(114,8-114,18)
...
@x2
@x3)
(MergeSort2.mergesort_.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_MergeSort2.mergesort_.fuel_instrumented))

:named @fuel_irrelevance_MergeSort2.mergesort_.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name MergeSort2.mergesort'; Namespace MergeSort2
(assert (! 
;; def=MergeSort2.fst(114,8-114,18); use=MergeSort2.fst(114,8-114,18)
...
@x1
@x2)
(MergeSort2.mergesort_.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_MergeSort2.mergesort_.fuel_instrumented))

:named @fuel_correspondence_MergeSort2.mergesort_.fuel_instrumented))
(push) ;; push{2

; Starting query at MergeSort2.fst(127,2-134,61)
...
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(123,60-126,28); use=MergeSort2.fst(126,8-126,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_2))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MergeSort2.mergesort__sorted (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MergeSort2.mergesort__sorted@tok () Term)
(declare-fun label_8 () Bool)
(declare-fun label_7 () Bool)
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit).
;       GenericSort.sorted (MergeSort2.mergesort' l k) k ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l && Nil? l.tl) /\ ~(Cons? l && Cons? l.tl) ==> Prims.l_False) /\
...
;                               k == any_result ==>
;                               (forall (pure_result: Prims.unit).
;                                   GenericSort.sorted (MergeSort2.mergesort' b k) k ==>
;                                   FStar.List.Tot.Base.length b << FStar.List.Tot.Base.length l /\
;                                   (forall (any_result: (_: a -> Prims.int)).
;                                       k == any_result ==>
;                                       (forall (pure_result: Prims.unit).
...
;                                           GenericSort.sorted (MergeSort2.mergesort' b k) k /\
;                                           (forall (pure_result: Prims.unit).
;                                               GenericSort.sorted (MergeSort2.merge' (MergeSort2.mergesort'
;                                                         b
;                                                         k)
;                                                     (MergeSort2.mergesort' b k)
;                                                     k)
;                                                 k ==>
;                                               k pure_result))))))))))))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec mergesort'_sorted`
...
;;; Fact-ids: 
(assert (! (not 
;; def=MergeSort2.fst(127,2-134,61); use=MergeSort2.fst(127,2-134,61)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(127,2-134,61)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=MergeSort2.fst(124,15-124,42); use=MergeSort2.fst(127,2-134,61)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(127,2-134,61)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(127,2-134,61)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=MergeSort2.fst(127,2-134,61)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(127,2-134,61)
(Valid 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(127,2-134,61)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(127,2-134,61)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(127,2-134,61)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(127,2-134,61)
(and (implies 
;; def=MergeSort2.fst(126,29-134,61); use=MergeSort2.fst(127,2-134,61)
(and 
;; def=MergeSort2.fst(126,29-126,30); use=MergeSort2.fst(127,8-127,9)
(not 
;; def=MergeSort2.fst(126,29-126,30); use=MergeSort2.fst(127,8-127,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
label_3)
(implies 
;; def=MergeSort2.fst(126,29-128,6); use=MergeSort2.fst(127,8-128,6)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=MergeSort2.fst(127,2-134,61)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(127,2-134,61)
(Valid 
;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(127,2-134,61)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MergeSort2.fst(127,2-134,61)
(not 
;; def=MergeSort2.fst(126,29-126,30); use=MergeSort2.fst(127,8-127,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(389,2-389,39); use=MergeSort2.fst(127,2-134,61)
(and 
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(127,2-134,61)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=MergeSort2.fst(126,29-129,7); use=MergeSort2.fst(127,8-129,7)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
;; def=MergeSort2.fst(126,29-130,11); use=MergeSort2.fst(127,8-130,11)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(127,2-134,61)
(and 
;; def=MergeSort2.fst(108,39-108,52); use=MergeSort2.fst(131,34-131,35)
(or label_4
...
;; def=MergeSort2.fst(108,30-126,30); use=MergeSort2.fst(127,2-134,61)
(= x_374b44ccfcb77ed85d505dbc44265913_1
@x5)
)
...
;; def=MergeSort2.fst(131,8-131,35); use=MergeSort2.fst(131,8-131,35)
(= (MergeSort2.split_half x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1)
@x6)
)
...
;; def=MergeSort2.fst(131,8-131,20); use=MergeSort2.fst(131,8-131,20)
(= (MergeSort2.split_half x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1)
(FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(127,2-134,61)
(and 
;; def=MergeSort2.fst(127,2-134,61); use=MergeSort2.fst(132,28-132,29)
(or label_5
...
;; def=MergeSort2.fst(123,48-126,32); use=MergeSort2.fst(127,2-134,61)
(= x_582acf81e02a6e4176cba5e2730f867d_2
@x9)
)

;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(132,4-132,21)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=MergeSort2.fst(124,15-124,42); use=MergeSort2.fst(132,4-132,21)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.mergesort_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x7
x_582acf81e02a6e4176cba5e2730f867d_2)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(127,2-134,61)
(and 
;; def=MergeSort2.fst(127,2-134,61); use=MergeSort2.fst(133,28-133,29)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(133,4-133,21)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
Prims.unit)

;; def=MergeSort2.fst(124,15-124,42); use=MergeSort2.fst(133,4-133,21)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.mergesort_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x8
x_582acf81e02a6e4176cba5e2730f867d_2)
...
;; def=Prims.fst(441,29-441,97); use=MergeSort2.fst(134,4-134,17)
(and 
;; def=MergeSort2.fst(61,19-61,30); use=MergeSort2.fst(134,4-134,17)
(or label_7
...
;; def=MergeSort2.fst(61,34-61,45); use=MergeSort2.fst(134,4-134,17)
(or label_8
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(134,4-134,17)
(forall ((@x13 Term))
 (! (implies (and (HasType @x13
Prims.unit)

;; def=MergeSort2.fst(62,17-62,42); use=MergeSort2.fst(134,4-134,17)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.merge_ x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.mergesort_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x7
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(134,4-134,17)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(134,4-134,17)
(ApplyTT @x1
@x13)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MergeSort2.mergesort'_sorted, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_FStar.List.Tot.Base.append.fuel_instrumented, @fuel_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, @fuel_correspondence_FStar.List.Tot.Base.mem.fuel_instrumented, @fuel_correspondence_GenericSort.sorted.fuel_instrumented, @fuel_correspondence_MergeSort2.mergesort_.fuel_instrumented, @fuel_irrelevance_MergeSort2.mergesort_.fuel_instrumented, @query, GenericSort_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949, MergeSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd, binder_x_374b44ccfcb77ed85d505dbc44265913_1, binder_x_582acf81e02a6e4176cba5e2730f867d_2, binder_x_9cd1733a5204f989dbb2f01d5984df93_0, bool_inversion, constructor_distinct_Prims.Cons, constructor_distinct_Prims.Nil, data_elim_Prims.Cons, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_FStar.List.Tot.Base.op_At, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, equation_GenericSort.permutation_2, equation_MergeSort2.split_half, equation_Prims.eqtype, equation_Prims.nat, equation_with_fuel_FStar.List.Tot.Base.append.fuel_instrumented, equation_with_fuel_FStar.List.Tot.Base.length.fuel_instrumented, equation_with_fuel_FStar.List.Tot.Base.mem.fuel_instrumented, equation_with_fuel_GenericSort.sorted.fuel_instrumented, equation_with_fuel_MergeSort2.mergesort_.fuel_instrumented, fuel_guarded_inversion_Prims.list, int_typing, kinding_Prims.list@tok, primitive_Prims.op_Addition, primitive_Prims.op_Division, primitive_Prims.op_Equality, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, proj_equation_Prims.Cons_tl, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, projection_inverse_Prims.Nil_a, refinement_interpretation_Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_7aac12c24449a22c34d98a0ea8ed4a32, refinement_interpretation_Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95, token_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, typing_FStar.List.Tot.Base.length, typing_FStar.Pervasives.Native.__proj__Mktuple2__item___1, typing_FStar.Pervasives.Native.__proj__Mktuple2__item___2, typing_GenericSort.sorted, typing_MergeSort2.merge_, typing_MergeSort2.mergesort_, typing_MergeSort2.split_n, typing_Prims.__proj__Cons__item__tl, well-founded-ordering-on-nat
...
; encoding sigelt let rec mergesort'_sorted


; <Start encoding let rec mergesort'_sorted>
...
; </end encoding let rec mergesort'_sorted>


; encoding sigelt val MergeSort2.mergesort'_permutation


; <Skipped val MergeSort2.mergesort'_permutation/>
...
; Starting query at MergeSort2.fst(141,2-147,66)
...
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(137,65-140,33); use=MergeSort2.fst(140,8-140,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_2))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MergeSort2.mergesort__permutation (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MergeSort2.mergesort__permutation@tok () Term)
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit).
;       GenericSort.permutation l (MergeSort2.mergesort' l k) ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l && Nil? l.tl) /\ ~(Cons? l && Cons? l.tl) ==> Prims.l_False) /\
;       (l == [] ==> (forall (any_result: Prims.unit). k any_result)) /\
...
;                               k == any_result ==>
;                               (forall (pure_result: Prims.unit).
;                                   GenericSort.permutation b (MergeSort2.mergesort' b k) ==>
;                                   FStar.List.Tot.Base.length b << FStar.List.Tot.Base.length l /\
;                                   (forall (any_result: (_: a -> Prims.int)).
;                                       k == any_result ==>
;                                       (forall (pure_result: Prims.unit).
;                                           GenericSort.permutation b (MergeSort2.mergesort' b k) ==>
;                                           (forall (pure_result: Prims.unit).
;                                               GenericSort.permutation_2 (MergeSort2.merge' (MergeSort2.mergesort'
;                                                         b
;                                                         k)
;                                                     (MergeSort2.mergesort' b k)
;                                                     k)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec mergesort'_permutation`
...
;;; Fact-ids: 
(assert (! (not 
;; def=MergeSort2.fst(141,2-147,66); use=MergeSort2.fst(141,2-147,66)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(141,2-147,66)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=MergeSort2.fst(138,16-138,48); use=MergeSort2.fst(141,2-147,66)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(141,2-147,66)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(141,2-147,66)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=MergeSort2.fst(141,2-147,66)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(141,2-147,66)
(Valid 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(141,2-147,66)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(141,2-147,66)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(141,2-147,66)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(141,2-147,66)
(and (implies 
;; def=MergeSort2.fst(140,34-147,66); use=MergeSort2.fst(141,2-147,66)
(and 
;; def=MergeSort2.fst(140,34-140,35); use=MergeSort2.fst(141,8-141,9)
(not 
;; def=MergeSort2.fst(140,34-140,35); use=MergeSort2.fst(141,8-141,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
label_3)
(implies 
;; def=MergeSort2.fst(140,34-142,6); use=MergeSort2.fst(141,8-142,6)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=MergeSort2.fst(141,2-147,66)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(141,2-147,66)
(Valid 
;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(141,2-147,66)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MergeSort2.fst(141,2-147,66)
(not 
;; def=MergeSort2.fst(140,34-140,35); use=MergeSort2.fst(141,8-141,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(389,2-389,39); use=MergeSort2.fst(141,2-147,66)
(and 
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(141,2-147,66)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=MergeSort2.fst(140,34-142,12); use=MergeSort2.fst(141,8-142,12)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
;; def=MergeSort2.fst(140,34-143,11); use=MergeSort2.fst(141,8-143,11)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(141,2-147,66)
(and 
;; def=MergeSort2.fst(108,39-108,52); use=MergeSort2.fst(144,34-144,35)
(or label_4
...
;; def=MergeSort2.fst(108,30-140,35); use=MergeSort2.fst(141,2-147,66)
(= x_374b44ccfcb77ed85d505dbc44265913_1
@x5)
)
...
;; def=MergeSort2.fst(144,8-144,35); use=MergeSort2.fst(144,8-144,35)
(= (MergeSort2.split_half x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1)
@x6)
)
...
;; def=MergeSort2.fst(144,8-144,20); use=MergeSort2.fst(144,8-144,20)
(= (MergeSort2.split_half x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1)
(FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(141,2-147,66)
(and 
;; def=MergeSort2.fst(141,2-147,66); use=MergeSort2.fst(145,33-145,34)
(or label_5
...
;; def=MergeSort2.fst(137,53-140,37); use=MergeSort2.fst(141,2-147,66)
(= x_582acf81e02a6e4176cba5e2730f867d_2
@x9)
)

;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(145,4-145,26)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=MergeSort2.fst(138,16-138,48); use=MergeSort2.fst(145,4-145,26)
(Valid 
;; def=MergeSort2.fst(138,16-138,48); use=MergeSort2.fst(145,4-145,26)
(GenericSort.permutation x_9cd1733a5204f989dbb2f01d5984df93_0
@x7
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(141,2-147,66)
(and 
;; def=MergeSort2.fst(141,2-147,66); use=MergeSort2.fst(146,33-146,34)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(146,4-146,26)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
Prims.unit)

;; def=MergeSort2.fst(138,16-138,48); use=MergeSort2.fst(146,4-146,26)
(Valid 
;; def=MergeSort2.fst(138,16-138,48); use=MergeSort2.fst(146,4-146,26)
(GenericSort.permutation x_9cd1733a5204f989dbb2f01d5984df93_0
@x8
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(147,4-147,22)
(forall ((@x13 Term))
 (! (implies (and (HasType @x13
Prims.unit)

;; def=MergeSort2.fst(47,16-47,52); use=MergeSort2.fst(147,4-147,22)
(Valid 
;; def=MergeSort2.fst(47,16-47,52); use=MergeSort2.fst(147,4-147,22)
(GenericSort.permutation_2 x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.merge_ x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(147,4-147,22)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(147,4-147,22)
(ApplyTT @x1
@x13)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MergeSort2.mergesort'_permutation, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_FStar.List.Tot.Base.append.fuel_instrumented, @fuel_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, @fuel_correspondence_MergeSort2.mergesort_.fuel_instrumented, @fuel_irrelevance_MergeSort2.mergesort_.fuel_instrumented, @query, GenericSort_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949, MergeSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd, binder_x_374b44ccfcb77ed85d505dbc44265913_1, binder_x_582acf81e02a6e4176cba5e2730f867d_2, binder_x_9cd1733a5204f989dbb2f01d5984df93_0, constructor_distinct_Prims.Cons, constructor_distinct_Prims.Nil, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_FStar.List.Tot.Base.op_At, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, equation_GenericSort.permutation, equation_GenericSort.permutation_2, equation_MergeSort2.split_half, equation_Prims.eqtype, equation_Prims.nat, equation_with_fuel_FStar.List.Tot.Base.append.fuel_instrumented, equation_with_fuel_FStar.List.Tot.Base.length.fuel_instrumented, equation_with_fuel_MergeSort2.mergesort_.fuel_instrumented, fuel_guarded_inversion_Prims.list, int_typing, kinding_Prims.list@tok, primitive_Prims.op_Addition, primitive_Prims.op_Division, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, proj_equation_Prims.Cons_tl, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, projection_inverse_Prims.Nil_a, refinement_interpretation_Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_7aac12c24449a22c34d98a0ea8ed4a32, refinement_interpretation_Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95, token_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, typing_FStar.List.Tot.Base.length, typing_FStar.Pervasives.Native.__proj__Mktuple2__item___1, typing_FStar.Pervasives.Native.__proj__Mktuple2__item___2, typing_MergeSort2.split_n, typing_Prims.__proj__Cons__item__tl, well-founded-ordering-on-nat
...
; encoding sigelt let rec mergesort'_permutation


; <Start encoding let rec mergesort'_permutation>
...
; </end encoding let rec mergesort'_permutation>


; encoding sigelt val MergeSort2.mergesort'_stable


; <Skipped val MergeSort2.mergesort'_stable/>

(push) ;; push{2

; Starting query at MergeSort2.fst(154,2-163,61)
...
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(150,60-153,28); use=MergeSort2.fst(153,8-153,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_2))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun MergeSort2.mergesort__stable (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun MergeSort2.mergesort__stable@tok () Term)
(declare-fun label_12 () Bool)
(declare-fun label_11 () Bool)
(declare-fun label_10 () Bool)
(declare-fun label_9 () Bool)
...
;;; Fact-ids: 
(assert (! 
;; def=MergeSort2.fst(91,32-91,52); use=MergeSort2.fst(163,4-163,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_68a3139579b4e370456a4a2443f8bb4d)
...
;; def=MergeSort2.fst(91,43-91,50); use=MergeSort2.fst(163,4-163,17)
(BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x1))
))
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit).
;       GenericStability.stable l (MergeSort2.mergesort' l k) k ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l && Nil? l.tl) /\ ~(Cons? l && Cons? l.tl) ==> Prims.l_False) /\
;       (l == [] ==> (forall (any_result: Prims.unit). k any_result)) /\
...
;                               k == any_result ==>
;                               (forall (pure_result: Prims.unit).
;                                   GenericStability.stable b (MergeSort2.mergesort' b k) k ==>
;                                   FStar.List.Tot.Base.length b << FStar.List.Tot.Base.length l /\
;                                   (forall (any_result: (_: a -> Prims.int)).
;                                       k == any_result ==>
;                                       (forall (pure_result: Prims.unit).
...
;                                                   GenericSort.sorted (MergeSort2.mergesort' b k) k ==>
;                                                   (forall (pure_result: Prims.unit).
;                                                       GenericSort.sorted (MergeSort2.mergesort' b k)
;                                                         k ==>
;                                                       Cons? (MergeSort2.mergesort' b k) /\
;                                                       (forall (return_val:
;                                                           l: Prims.list a {Cons? l}).
;                                                           return_val == MergeSort2.mergesort' b k ==>
;                                                           Cons? (MergeSort2.mergesort' b k) /\
;                                                           (forall (return_val:
;                                                               r: Prims.list a {Cons? r}).
;                                                               return_val ==
;                                                               MergeSort2.mergesort' b k ==>
;                                                               GenericSort.sorted (MergeSort2.mergesort'
;                                                                     b
;                                                                     k)
;                                                                 k /\
;                                                               GenericSort.sorted (MergeSort2.mergesort'
...
;                                                                 k /\
;                                                               (forall (pure_result: Prims.unit).
;                                                                   GenericStability.stable (MergeSort2.mergesort'
;                                                                         b
;                                                                         k @
;                                                                       MergeSort2.mergesort' b k)
;                                                                     (MergeSort2.merge' (MergeSort2.mergesort'
;                                                                             b
;                                                                             k)
;                                                                         (MergeSort2.mergesort' b k)
;                                                                         k)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec mergesort'_stable`
...
;;; Fact-ids: 
(assert (! (not 
;; def=MergeSort2.fst(154,2-163,61); use=MergeSort2.fst(154,2-163,61)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(154,2-163,61)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=MergeSort2.fst(151,16-151,45); use=MergeSort2.fst(154,2-163,61)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(154,2-163,61)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(154,2-163,61)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=MergeSort2.fst(154,2-163,61)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(154,2-163,61)
(Valid 
;; def=Prims.fst(402,73-402,79); use=MergeSort2.fst(154,2-163,61)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(154,2-163,61)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort2.fst(154,2-163,61)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(154,2-163,61)
(and (implies 
;; def=MergeSort2.fst(153,29-163,61); use=MergeSort2.fst(154,2-163,61)
(and 
;; def=MergeSort2.fst(153,29-153,30); use=MergeSort2.fst(154,8-154,9)
(not 
;; def=MergeSort2.fst(153,29-153,30); use=MergeSort2.fst(154,8-154,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
label_3)
(implies 
;; def=MergeSort2.fst(153,29-155,6); use=MergeSort2.fst(154,8-155,6)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=MergeSort2.fst(154,2-163,61)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(154,2-163,61)
(Valid 
;; def=Prims.fst(451,90-451,102); use=MergeSort2.fst(154,2-163,61)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MergeSort2.fst(154,2-163,61)
(not 
;; def=MergeSort2.fst(153,29-153,30); use=MergeSort2.fst(154,8-154,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(389,2-389,39); use=MergeSort2.fst(154,2-163,61)
(and 
;; def=Prims.fst(413,99-413,120); use=MergeSort2.fst(154,2-163,61)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=MergeSort2.fst(153,29-155,12); use=MergeSort2.fst(154,8-155,12)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
;; def=MergeSort2.fst(153,29-156,11); use=MergeSort2.fst(154,8-156,11)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(154,2-163,61)
(and 
;; def=MergeSort2.fst(108,39-108,52); use=MergeSort2.fst(157,34-157,35)
(or label_4
...
;; def=MergeSort2.fst(108,30-153,30); use=MergeSort2.fst(154,2-163,61)
(= x_374b44ccfcb77ed85d505dbc44265913_1
@x5)
)
...
;; def=MergeSort2.fst(157,8-157,35); use=MergeSort2.fst(157,8-157,35)
(= (MergeSort2.split_half x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1)
@x6)
)
...
;; def=MergeSort2.fst(157,8-157,20); use=MergeSort2.fst(157,8-157,20)
(= (MergeSort2.split_half x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1)
(FStar.Pervasives.Native.Mktuple2 (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(154,2-163,61)
(and 
;; def=MergeSort2.fst(154,2-163,61); use=MergeSort2.fst(158,28-158,29)
(or label_5
...
;; def=MergeSort2.fst(150,48-153,32); use=MergeSort2.fst(154,2-163,61)
(= x_582acf81e02a6e4176cba5e2730f867d_2
@x9)
)

;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(158,4-158,21)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=MergeSort2.fst(151,16-151,45); use=MergeSort2.fst(158,4-158,21)
(Valid 
;; def=MergeSort2.fst(151,16-151,45); use=MergeSort2.fst(158,4-158,21)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
@x7
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(154,2-163,61)
(and 
;; def=MergeSort2.fst(154,2-163,61); use=MergeSort2.fst(159,28-159,29)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(159,4-159,21)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
Prims.unit)

;; def=MergeSort2.fst(151,16-151,45); use=MergeSort2.fst(159,4-159,21)
(Valid 
;; def=MergeSort2.fst(151,16-151,45); use=MergeSort2.fst(159,4-159,21)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
@x8
...
;; def=Prims.fst(441,29-441,97); use=MergeSort2.fst(160,4-160,17)
(and 
;; def=GenericStability.fst(142,22-142,36); use=MergeSort2.fst(160,4-160,17)
(or label_7
...
;; def=GenericStability.fst(142,40-142,54); use=MergeSort2.fst(160,4-160,17)
(or label_8
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(160,4-160,17)
(forall ((@x13 Term))
 (! (implies (and (HasType @x13
Prims.unit)

;; def=GenericStability.fst(143,19-143,45); use=MergeSort2.fst(160,4-160,17)
(Valid 
;; def=GenericStability.fst(143,19-143,45); use=MergeSort2.fst(160,4-160,17)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(161,4-161,21)
(forall ((@x14 Term))
 (! (implies (and (HasType @x14
Prims.unit)

;; def=MergeSort2.fst(124,15-124,42); use=MergeSort2.fst(161,4-161,21)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.mergesort_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x7
x_582acf81e02a6e4176cba5e2730f867d_2)
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(162,4-162,21)
(forall ((@x15 Term))
 (! (implies (and (HasType @x15
Prims.unit)

;; def=MergeSort2.fst(124,15-124,42); use=MergeSort2.fst(162,4-162,21)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(MergeSort2.mergesort_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x8
x_582acf81e02a6e4176cba5e2730f867d_2)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(154,2-163,61)
(and 
;; def=MergeSort2.fst(91,43-91,50); use=MergeSort2.fst(163,18-163,38)
(or label_9
...
;; def=Prims.fst(356,2-356,58); use=MergeSort2.fst(154,2-163,61)
(forall ((@x16 Term))
 (! (implies (and (HasType @x16
Tm_refine_68a3139579b4e370456a4a2443f8bb4d)

;; def=Prims.fst(356,26-356,41); use=MergeSort2.fst(154,2-163,61)
(= @x16
(MergeSort2.mergesort_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x7
x_582acf81e02a6e4176cba5e2730f867d_2))
...
;; def=Prims.fst(459,77-459,89); use=MergeSort2.fst(154,2-163,61)
(and 
;; def=MergeSort2.fst(91,67-91,74); use=MergeSort2.fst(163,39-163,59)
(or label_10
...
;; def=Prims.fst(441,29-441,97); use=MergeSort2.fst(163,4-163,17)
(and 
;; def=MergeSort2.fst(92,19-92,29); use=MergeSort2.fst(163,4-163,17)
(or label_11
...
;; def=MergeSort2.fst(92,33-92,43); use=MergeSort2.fst(163,4-163,17)
(or label_12
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(163,4-163,17)
(forall ((@x18 Term))
 (! (implies (and (HasType @x18
Prims.unit)

;; def=MergeSort2.fst(93,17-93,46); use=MergeSort2.fst(163,4-163,17)
(Valid 
;; def=MergeSort2.fst(93,17-93,46); use=MergeSort2.fst(163,4-163,17)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(163,4-163,17)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort2.fst(163,4-163,17)
(ApplyTT @x1
@x18)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MergeSort2.mergesort'_stable, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_FStar.List.Tot.Base.append.fuel_instrumented, @fuel_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, @fuel_correspondence_FStar.List.Tot.Base.mem.fuel_instrumented, @fuel_correspondence_GenericStability.filter_eq.fuel_instrumented, @fuel_correspondence_MergeSort2.mergesort_.fuel_instrumented, @fuel_irrelevance_MergeSort2.mergesort_.fuel_instrumented, @query, GenericSort_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949, MergeSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_374b44ccfcb77ed85d505dbc44265913_1, binder_x_582acf81e02a6e4176cba5e2730f867d_2, binder_x_9cd1733a5204f989dbb2f01d5984df93_0, constructor_distinct_Prims.Cons, constructor_distinct_Prims.Nil, data_elim_Prims.Cons, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_FStar.List.Tot.Base.op_At, equation_FStar.Pervasives.Native.fst, equation_FStar.Pervasives.Native.snd, equation_GenericSort.permutation_2, equation_GenericStability.stable, equation_MergeSort2.split_half, equation_Prims.eqtype, equation_Prims.nat, equation_with_fuel_FStar.List.Tot.Base.append.fuel_instrumented, equation_with_fuel_FStar.List.Tot.Base.length.fuel_instrumented, equation_with_fuel_FStar.List.Tot.Base.mem.fuel_instrumented, equation_with_fuel_GenericStability.filter_eq.fuel_instrumented, equation_with_fuel_MergeSort2.mergesort_.fuel_instrumented, fuel_guarded_inversion_Prims.list, function_token_typing_Prims.__cache_version_number__, int_typing, kinding_Prims.list@tok, lemma_FStar.List.Tot.Properties.append_l_nil, primitive_Prims.op_Addition, primitive_Prims.op_Division, primitive_Prims.op_Equality, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, proj_equation_Prims.Cons_tl, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, projection_inverse_Prims.Nil_a, refinement_interpretation_Tm_refine_265d5aaae9c4478c5ac720ba42d3ea81, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_7aac12c24449a22c34d98a0ea8ed4a32, refinement_interpretation_Tm_refine_f28b7a7fea85abb9aeab640e2a54cf95, token_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, typing_FStar.List.Tot.Base.length, typing_FStar.Pervasives.Native.fst, typing_FStar.Pervasives.Native.snd, typing_GenericStability.filter_eq, typing_MergeSort2.mergesort_, typing_MergeSort2.split_n, typing_Prims.__proj__Cons__item__tl, well-founded-ordering-on-nat
...
; encoding sigelt let rec mergesort'_stable


; <Start encoding let rec mergesort'_stable>
...
; </end encoding let rec mergesort'_stable>
...
; Starting query at MergeSort2.fst(169,2-172,16)
...
; *)
;   forall (pure_result: Prims.unit).
;     GenericSort.sorted (MergeSort2.mergesort' l k) k ==>
;     (forall (pure_result: Prims.unit).
;         GenericSort.permutation l (MergeSort2.mergesort' l k) ==>
;         (forall (pure_result: Prims.unit).
;             GenericStability.stable l (MergeSort2.mergesort' l k) k ==>
;             GenericSort.sorted (MergeSort2.mergesort' l k) k /\
;             GenericSort.permutation l (MergeSort2.mergesort' l k) /\
;             GenericStability.stable (MergeSort2.mergesort' l k) l k))


; Context: While encoding a query
; While typechecking the top-level declaration `let mergesort`
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(169,2-169,19)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=MergeSort2.fst(124,15-124,42); use=MergeSort2.fst(169,2-169,19)
(BoxBool_proj_0 (GenericSort.sorted @x0
(MergeSort2.mergesort_ @x0
@x1
@x2)
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(170,2-170,24)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=MergeSort2.fst(138,16-138,48); use=MergeSort2.fst(170,2-170,24)
(Valid 
;; def=MergeSort2.fst(138,16-138,48); use=MergeSort2.fst(170,2-170,24)
...
;; def=Prims.fst(441,36-441,97); use=MergeSort2.fst(171,2-171,19)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=MergeSort2.fst(151,16-151,45); use=MergeSort2.fst(171,2-171,19)
(Valid 
;; def=MergeSort2.fst(151,16-151,45); use=MergeSort2.fst(171,2-171,19)
(GenericStability.stable @x0
@x1
...
;; def=MergeSort2.fst(167,17-167,67); use=MergeSort2.fst(172,2-172,16)
(and 
;; def=MergeSort2.fst(167,17-167,28); use=MergeSort2.fst(172,2-172,16)
(or label_1
...
;; def=MergeSort2.fst(167,32-167,48); use=MergeSort2.fst(172,2-172,16)
(or label_2
...
;; def=MergeSort2.fst(167,52-167,67); use=MergeSort2.fst(172,2-172,16)
(or label_3
