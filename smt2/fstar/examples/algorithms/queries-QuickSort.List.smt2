...
; Internals for QuickSort.List


; encoding sigelt #set-options "--initial_ifuel 1 --initial_fuel 1 --max_ifuel 1 --max_fuel 1"


; <Skipped #set-options "--initial_ifuel 1 --initial_fuel 1 --max_ifuel 1 --max_fuel 1"/>


; encoding sigelt val QuickSort.List.sorted


; <Skipped val QuickSort.List.sorted/>
...
; Starting query at QuickSort.List.fst(24,19-26,13)
...
;;;;;;;;;;;;;;;;f : _: 'a -> _: 'a -> Prims.bool (_: 'a -> _: 'a -> Prims.bool)
(declare-fun x_efcefbc9baa34bb860680c61a11922cb_2 () Term)
;;;;;;;;;;;;;;;;_: 'a -> _: 'a -> Prims.bool
(declare-fun Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0
Tm_type)
:named kinding_Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(23,29-24,16); use=QuickSort.List.fst(24,8-24,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0))
:qid QuickSort.List_pre_typing_Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0))

:named QuickSort.List_pre_typing_Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(23,29-24,16); use=QuickSort.List.fst(24,8-24,16)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid QuickSort.List_interpretation_Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickSort.List_interpretation_Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0))
:qid QuickSort.List_interpretation_Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0))

:named QuickSort.List_interpretation_Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0))
;;;;;;;;;;;;;;;;binder_x_efcefbc9baa34bb860680c61a11922cb_2
;;; Fact-ids: 
(assert (! (HasType x_efcefbc9baa34bb860680c61a11922cb_2
Tm_arrow_dbca5ce6005b0ac91f57abd165fa98a0)
:named binder_x_efcefbc9baa34bb860680c61a11922cb_2))
;;;;;;;;;;;;;;;;uu___1 : Prims.list 'a (Prims.list 'a)
...
(declare-fun Tm_refine_b9a69a57b4e390c13398fc81b71cac78 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(24,19-26,13); use=QuickSort.List.fst(24,19-26,13)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_b9a69a57b4e390c13398fc81b71cac78 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_b9a69a57b4e390c13398fc81b71cac78 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_b9a69a57b4e390c13398fc81b71cac78))

:named refinement_kinding_Tm_refine_b9a69a57b4e390c13398fc81b71cac78))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(24,19-26,13); use=QuickSort.List.fst(24,19-26,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b9a69a57b4e390c13398fc81b71cac78 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
@x1
(Tm_refine_b9a69a57b4e390c13398fc81b71cac78 @x2)))
:qid refinement_interpretation_Tm_refine_b9a69a57b4e390c13398fc81b71cac78))

:named refinement_interpretation_Tm_refine_b9a69a57b4e390c13398fc81b71cac78))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b9a69a57b4e390c13398fc81b71cac78
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(24,19-26,13); use=QuickSort.List.fst(24,19-26,13)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b9a69a57b4e390c13398fc81b71cac78 @x0)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b9a69a57b4e390c13398fc81b71cac78 @x0))))
:qid haseqTm_refine_b9a69a57b4e390c13398fc81b71cac78))

:named haseqTm_refine_b9a69a57b4e390c13398fc81b71cac78))
(declare-fun QuickSort.List.sorted (Term Term Term) Term)


;;;;;;;;;;;;;;;;_: (_: 'a -> _: 'a -> Prims.bool) -> _: _: Prims.list 'a {_ << _} -> Prims.bool
(declare-fun Tm_arrow_044bbfd464e58eebb28eedacc24813e4 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_044bbfd464e58eebb28eedacc24813e4
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_044bbfd464e58eebb28eedacc24813e4
Tm_type)
:named kinding_Tm_arrow_044bbfd464e58eebb28eedacc24813e4))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(23,13-26,13); use=QuickSort.List.fst(23,13-26,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_044bbfd464e58eebb28eedacc24813e4)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_044bbfd464e58eebb28eedacc24813e4))
:qid QuickSort.List_pre_typing_Tm_arrow_044bbfd464e58eebb28eedacc24813e4))

:named QuickSort.List_pre_typing_Tm_arrow_044bbfd464e58eebb28eedacc24813e4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_044bbfd464e58eebb28eedacc24813e4
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(23,13-26,13); use=QuickSort.List.fst(23,13-26,13)
(forall ((@x0 Term))
...
(Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e @x1))
(HasType @x3
(Tm_refine_b9a69a57b4e390c13398fc81b71cac78 @x1)))
...
@x2)
@x3))
:qid QuickSort.List_interpretation_Tm_arrow_044bbfd464e58eebb28eedacc24813e4.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickSort.List_interpretation_Tm_arrow_044bbfd464e58eebb28eedacc24813e4.2))
...
@x1)
@x2))
:qid QuickSort.List_interpretation_Tm_arrow_044bbfd464e58eebb28eedacc24813e4.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_044bbfd464e58eebb28eedacc24813e4))
:qid QuickSort.List_interpretation_Tm_arrow_044bbfd464e58eebb28eedacc24813e4))

:named QuickSort.List_interpretation_Tm_arrow_044bbfd464e58eebb28eedacc24813e4))
(declare-fun QuickSort.List.sorted@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(24,8-24,14); use=QuickSort.List.fst(24,8-24,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT QuickSort.List.sorted@tok
@x0)
@x1)
@x2)
(QuickSort.List.sorted @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT QuickSort.List.sorted@tok
@x0)
@x1)
@x2))
:qid token_correspondence_QuickSort.List.sorted))

:named token_correspondence_QuickSort.List.sorted))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(24,8-24,14); use=QuickSort.List.fst(24,8-24,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType QuickSort.List.sorted@tok
Tm_arrow_044bbfd464e58eebb28eedacc24813e4))
...
@x2)
@x3)
(QuickSort.List.sorted @x1
@x2
@x3))
 

:pattern ((QuickSort.List.sorted @x1
@x2
@x3))
:qid function_token_typing_QuickSort.List.sorted.1))
)
 

:pattern ((ApplyTT @x0
QuickSort.List.sorted@tok))
:qid function_token_typing_QuickSort.List.sorted))

:named function_token_typing_QuickSort.List.sorted))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(24,8-24,14); use=QuickSort.List.fst(24,8-24,14)
...
(HasType @x2
(Tm_refine_b9a69a57b4e390c13398fc81b71cac78 @x0)))
(HasType (QuickSort.List.sorted @x0
@x1
@x2)
Prims.bool))
 

:pattern ((QuickSort.List.sorted @x0
@x1
@x2))
:qid typing_QuickSort.List.sorted))

:named typing_QuickSort.List.sorted))
...
;   (forall (b: 'a) (b: 'a) (b: Prims.list 'a). _ == b :: b :: b ==> f b b ==> b :: b << _)
...
;; def=Prims.fst(402,27-402,88); use=QuickSort.List.fst(24,19-26,13)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(24,19-26,13)
(Valid 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(24,19-26,13)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(413,99-413,120); use=QuickSort.List.fst(24,19-26,13)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=QuickSort.List.fst(25,16-25,21); use=QuickSort.List.fst(25,16-25,21)
(BoxBool_proj_0 (ApplyTT (ApplyTT x_efcefbc9baa34bb860680c61a11922cb_2
@x1)
@x2))
)

;; def=QuickSort.List.fst(24,19-26,13); use=QuickSort.List.fst(25,34-25,41)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickSort.List.sorted, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_0a56e3de562c08d8ab59f4ac6f626a98_3, subterm_ordering_Prims.Cons
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun QuickSort.List.sorted.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun QuickSort.List.sorted.fuel_instrumented_token () Term)
(declare-fun QuickSort.List.sorted (Term Term Term) Term)
(declare-fun QuickSort.List.sorted@tok () Term)
...
(declare-fun QuickSort.List.total_order (Term) Term)

(declare-fun QuickSort.List.total_order@tok () Term)

(declare-fun Tm_refine_17abf6cc62b543ab8e21c4b019598546 (Term) Term)

; </end encoding let total_order>


; encoding sigelt val QuickSort.List.count


; <Skipped val QuickSort.List.count/>
...
; Starting query at QuickSort.List.fst(37,21-39,11)
...
;;;;;;;;;;;;;;;;uu___2 : Prims.list a (Prims.list a)
...
(declare-fun Tm_refine_9babacf0048570ce1bc5cba8572df0c6 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(36,12-39,11); use=QuickSort.List.fst(36,12-39,11)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_9babacf0048570ce1bc5cba8572df0c6 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_9babacf0048570ce1bc5cba8572df0c6 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_9babacf0048570ce1bc5cba8572df0c6))

:named refinement_kinding_Tm_refine_9babacf0048570ce1bc5cba8572df0c6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(36,12-39,11); use=QuickSort.List.fst(36,12-39,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9babacf0048570ce1bc5cba8572df0c6 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
;; def=QuickSort.List.fst(36,12-39,11); use=QuickSort.List.fst(36,12-39,11)
(or 
;; def=QuickSort.List.fst(37,21-39,11); use=QuickSort.List.fst(37,21-39,11)
(Valid 
;; def=QuickSort.List.fst(37,21-39,11); use=QuickSort.List.fst(37,21-39,11)
...
;; def=QuickSort.List.fst(36,12-39,11); use=QuickSort.List.fst(36,12-39,11)
(and 
;; def=QuickSort.List.fst(36,12-37,16); use=QuickSort.List.fst(36,12-37,16)
(Valid 
;; def=QuickSort.List.fst(36,12-37,16); use=QuickSort.List.fst(36,12-37,16)
...
;; def=QuickSort.List.fst(37,17-39,11); use=QuickSort.List.fst(37,17-39,11)
(or 
;; def=QuickSort.List.fst(37,21-39,11); use=QuickSort.List.fst(37,21-39,11)
(Valid 
;; def=QuickSort.List.fst(37,21-39,11); use=QuickSort.List.fst(37,21-39,11)
...
;; def=QuickSort.List.fst(37,17-39,11); use=QuickSort.List.fst(37,17-39,11)
(and 
;; def=QuickSort.List.fst(37,17-37,18); use=QuickSort.List.fst(37,17-37,18)
(Valid 
;; def=QuickSort.List.fst(37,17-37,18); use=QuickSort.List.fst(37,17-37,18)
...
(Tm_refine_9babacf0048570ce1bc5cba8572df0c6 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_9babacf0048570ce1bc5cba8572df0c6))

:named refinement_interpretation_Tm_refine_9babacf0048570ce1bc5cba8572df0c6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9babacf0048570ce1bc5cba8572df0c6
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(36,12-39,11); use=QuickSort.List.fst(36,12-39,11)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9babacf0048570ce1bc5cba8572df0c6 @x0
@x1)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9babacf0048570ce1bc5cba8572df0c6 @x0
@x1))))
:qid haseqTm_refine_9babacf0048570ce1bc5cba8572df0c6))

:named haseqTm_refine_9babacf0048570ce1bc5cba8572df0c6))
(declare-fun QuickSort.List.count (Term Term Term) Term)

;;;;;;;;;;;;;;;;_: a -> _: _: Prims.list a {a << a \/ a === a /\ (_ << x \/ _ === x /\ _ << _)} -> Prims.nat
(declare-fun Tm_arrow_60ed7296a024ab6aede3c4c72756c51d () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_60ed7296a024ab6aede3c4c72756c51d
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_60ed7296a024ab6aede3c4c72756c51d
Tm_type)
:named kinding_Tm_arrow_60ed7296a024ab6aede3c4c72756c51d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(36,12-39,11); use=QuickSort.List.fst(36,12-39,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_60ed7296a024ab6aede3c4c72756c51d)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_60ed7296a024ab6aede3c4c72756c51d))
:qid QuickSort.List_pre_typing_Tm_arrow_60ed7296a024ab6aede3c4c72756c51d))

:named QuickSort.List_pre_typing_Tm_arrow_60ed7296a024ab6aede3c4c72756c51d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_60ed7296a024ab6aede3c4c72756c51d
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(36,12-39,11); use=QuickSort.List.fst(36,12-39,11)
(forall ((@x0 Term))
...
@x1)
(HasType @x3
(Tm_refine_9babacf0048570ce1bc5cba8572df0c6 @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x2)
@x3))
:qid QuickSort.List_interpretation_Tm_arrow_60ed7296a024ab6aede3c4c72756c51d.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickSort.List_interpretation_Tm_arrow_60ed7296a024ab6aede3c4c72756c51d.2))
...
@x1)
@x2))
:qid QuickSort.List_interpretation_Tm_arrow_60ed7296a024ab6aede3c4c72756c51d.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_60ed7296a024ab6aede3c4c72756c51d))
:qid QuickSort.List_interpretation_Tm_arrow_60ed7296a024ab6aede3c4c72756c51d))

:named QuickSort.List_interpretation_Tm_arrow_60ed7296a024ab6aede3c4c72756c51d))
(declare-fun QuickSort.List.count@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(37,8-37,13); use=QuickSort.List.fst(37,8-37,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT QuickSort.List.count@tok
@x0)
@x1)
@x2)
(QuickSort.List.count @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT QuickSort.List.count@tok
@x0)
@x1)
@x2))
:qid token_correspondence_QuickSort.List.count))

:named token_correspondence_QuickSort.List.count))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(37,8-37,13); use=QuickSort.List.fst(37,8-37,13)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType QuickSort.List.count@tok
Tm_arrow_60ed7296a024ab6aede3c4c72756c51d))
...
@x2)
@x3)
(QuickSort.List.count @x1
@x2
@x3))
 

:pattern ((QuickSort.List.count @x1
@x2
@x3))
:qid function_token_typing_QuickSort.List.count.1))
)
 

:pattern ((ApplyTT @x0
QuickSort.List.count@tok))
:qid function_token_typing_QuickSort.List.count))

:named function_token_typing_QuickSort.List.count))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(37,8-37,13); use=QuickSort.List.fst(37,8-37,13)
...
@x0)
(HasType @x2
(Tm_refine_9babacf0048570ce1bc5cba8572df0c6 @x0
@x1)))
(HasType (QuickSort.List.count @x0
@x1
@x2)
Prims.nat))
 

:pattern ((QuickSort.List.count @x0
@x1
@x2))
:qid typing_QuickSort.List.count))

:named typing_QuickSort.List.count))
...
;                         QuickSort.List.count x b == any_result ==>
;                         (forall (return_val: Prims.nat).
;                             return_val == QuickSort.List.count x b ==>
;                             QuickSort.List.count x b == return_val ==>
;                             (forall (any_result: Prims.int).
;                                 (match b = x with
;                                   | true -> 1
;                                   | _ -> 0) +
;                                 QuickSort.List.count x b ==
;                                 any_result ==>
;                                 (match b = x with
;                                   | true -> 1
;                                   | _ -> 0) +
...
;; def=Prims.fst(402,27-402,88); use=QuickSort.List.fst(37,21-39,11)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(37,21-39,11)
(Valid 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(37,21-39,11)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(37,21-39,11)
(and (implies 
;; def=QuickSort.List.fst(37,21-39,11); use=QuickSort.List.fst(37,21-39,11)
(and 
;; def=QuickSort.List.fst(37,21-39,11); use=QuickSort.List.fst(37,21-39,11)
...
;; def=Prims.fst(413,99-413,120); use=QuickSort.List.fst(37,21-39,11)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(402,2-402,97); use=QuickSort.List.fst(37,21-39,11)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
...
(forall ((@x4 Term))
 (! (implies (implies 
;; def=dummy(0,0-0,0); use=QuickSort.List.fst(37,21-39,11)
(= (let ((@lb5 (Prims.op_Equality x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
x_157b99e815dc43d99415725267e9c452_1)))
(ite (= @lb5
(BoxBool true))
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(37,21-39,11)
(and 
;; def=QuickSort.List.fst(36,12-39,11); use=QuickSort.List.fst(38,50-38,52)
(or label_2

;; def=QuickSort.List.fst(37,21-39,11); use=QuickSort.List.fst(38,50-38,52)
(Valid 
;; def=QuickSort.List.fst(37,21-39,11); use=QuickSort.List.fst(38,50-38,52)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=Prims.fst(451,66-451,102); use=QuickSort.List.fst(37,21-39,11)
(forall ((@x5 Term))
...
;; def=QuickSort.List.fst(36,43-38,52); use=QuickSort.List.fst(38,42-38,52)
(= (QuickSort.List.count x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_1
@x2)
@x6)
)

;; def=Prims.fst(356,2-356,58); use=QuickSort.List.fst(37,21-39,11)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=QuickSort.List.fst(37,21-39,11)
(= @x7
(QuickSort.List.count x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_1
@x2))
...
;; def=QuickSort.List.fst(36,43-38,52); use=QuickSort.List.fst(37,21-39,11)
(= (Prims.op_Addition (let ((@lb9 (Prims.op_Equality x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
x_157b99e815dc43d99415725267e9c452_1)))
(ite (= @lb9
(BoxBool true))
...
;; def=Prims.fst(680,18-680,24); use=QuickSort.List.fst(38,14-38,52)
(or label_3

;; def=Prims.fst(680,18-680,24); use=QuickSort.List.fst(38,14-38,52)
(>= (BoxInt_proj_0 (Prims.op_Addition (let ((@lb9 (Prims.op_Equality x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
x_157b99e815dc43d99415725267e9c452_1)))
(ite (= @lb9
(BoxBool true))
...
;; def=Prims.fst(389,2-389,39); use=QuickSort.List.fst(37,21-39,11)
(and (implies 
;; def=QuickSort.List.fst(38,18-38,24); use=QuickSort.List.fst(38,18-38,24)
...
;; def=Prims.fst(451,90-451,102); use=QuickSort.List.fst(37,21-39,11)
(Valid 
;; def=Prims.fst(451,90-451,102); use=QuickSort.List.fst(37,21-39,11)
(ApplyTT @x3
@x4)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=QuickSort.List.fst(37,21-39,11)
(not 
;; def=QuickSort.List.fst(38,18-38,24); use=QuickSort.List.fst(38,18-38,24)
(= (Prims.op_Equality x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
...
;; def=QuickSort.List.fst(38,18-38,38); use=QuickSort.List.fst(38,18-38,38)
(= (Prims.op_Equality x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
x_157b99e815dc43d99415725267e9c452_1)
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickSort.List.count, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_374b44ccfcb77ed85d505dbc44265913_2, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_Prims.nat, fuel_guarded_inversion_Prims.list, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, subterm_ordering_Prims.Cons
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun QuickSort.List.count.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun QuickSort.List.count.fuel_instrumented_token () Term)
(declare-fun QuickSort.List.count (Term Term Term) Term)
(declare-fun QuickSort.List.count@tok () Term)
...
; encoding sigelt val QuickSort.List.mem_count


; <Skipped val QuickSort.List.mem_count/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickSort.List.count; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(37,8-37,13); use=QuickSort.List.fst(37,8-37,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(HasType @x3
(Prims.list @x1)))
(HasType (QuickSort.List.count.fuel_instrumented @u0
@x1
@x2
@x3)
Prims.nat))
...
:pattern ((QuickSort.List.count.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_QuickSort.List.count.fuel_instrumented))

:named token_correspondence_QuickSort.List.count.fuel_instrumented))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name FStar.List.Tot.Base.mem; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(240,8-240,11); use=FStar.List.Tot.Base.fst(240,8-240,11)
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: QuickSort.List.count
;;; Fact-ids: Name QuickSort.List.count; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(37,8-37,13); use=QuickSort.List.fst(37,8-37,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Prims.list @x1)))
(= (QuickSort.List.count.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x3))
(ite (is-Prims.Cons @lb4)
(Prims.op_Addition (let ((@lb5 (Prims.op_Equality @x1
(Prims.Cons_hd @lb4)
@x2)))
(ite (= @lb5
(BoxBool true))
(BoxInt 1)
(BoxInt 0)))
(QuickSort.List.count.fuel_instrumented @u0
@x1
@x2
(Prims.Cons_tl @lb4)))
...
:pattern ((QuickSort.List.count.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_QuickSort.List.count.fuel_instrumented))

:named equation_with_fuel_QuickSort.List.count.fuel_instrumented))
...
@x2
@x3)
(QuickSort.List.count.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_QuickSort.List.count.fuel_instrumented))

:named @fuel_irrelevance_QuickSort.List.count.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name FStar.List.Tot.Base.mem; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(240,8-240,11); use=FStar.List.Tot.Base.fst(240,8-240,11)
...
@x1
@x2)
(QuickSort.List.count.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_QuickSort.List.count.fuel_instrumented))

:named @fuel_correspondence_QuickSort.List.count.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name FStar.List.Tot.Base.mem; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(240,8-240,11); use=FStar.List.Tot.Base.fst(240,8-240,11)
...
; Starting query at QuickSort.List.fst(47,25-49,27)
...
:named binder_x_374b44ccfcb77ed85d505dbc44265913_2))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun QuickSort.List.mem_count (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun QuickSort.List.mem_count@tok () Term)
...
;       FStar.List.Tot.Base.mem x _ = (QuickSort.List.count x _ > 0) ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? _) /\ ~(Cons? _) ==> Prims.l_False) /\
;       (_ == [] ==> (forall (any_result: Prims.unit). k any_result)) /\
;       (~(Nil? _) ==>
;         (forall (b: a) (b: Prims.list a).
;             _ == b :: b ==>
;             b << _ /\
...
;                 b == any_result ==>
;                 (forall (pure_result: Prims.unit).
;                     FStar.List.Tot.Base.mem x b = (QuickSort.List.count x b > 0) ==> k pure_result))
;         )))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec mem_count`
...
;;; Fact-ids: 
(assert (! (not 
;; def=QuickSort.List.fst(47,25-49,27); use=QuickSort.List.fst(47,25-49,27)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=QuickSort.List.fst(47,25-49,27)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=QuickSort.List.fst(44,10-44,37); use=QuickSort.List.fst(47,25-49,27)
(or label_2

;; def=QuickSort.List.fst(44,10-44,37); use=QuickSort.List.fst(47,25-49,27)
(= (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_1
x_374b44ccfcb77ed85d505dbc44265913_2)
(Prims.op_GreaterThan (QuickSort.List.count x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_1
x_374b44ccfcb77ed85d505dbc44265913_2)
(BoxInt 0)))
)
...
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(47,25-49,27)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(47,25-49,27)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=QuickSort.List.fst(47,25-49,27)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=QuickSort.List.fst(47,25-49,27)
(Valid 
;; def=Prims.fst(402,73-402,79); use=QuickSort.List.fst(47,25-49,27)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(47,25-49,27)
(Valid 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(47,25-49,27)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(47,25-49,27)
(and (implies 
;; def=QuickSort.List.fst(47,25-49,27); use=QuickSort.List.fst(47,25-49,27)
(and 
;; def=QuickSort.List.fst(47,25-49,27); use=QuickSort.List.fst(47,25-49,27)
...
;; def=Prims.fst(451,66-451,102); use=QuickSort.List.fst(47,25-49,27)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=QuickSort.List.fst(47,25-49,27)
(Valid 
;; def=Prims.fst(451,90-451,102); use=QuickSort.List.fst(47,25-49,27)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=QuickSort.List.fst(47,25-49,27)
(not 
;; def=QuickSort.List.fst(47,25-49,27); use=QuickSort.List.fst(47,25-49,27)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
;; def=Prims.fst(413,99-413,120); use=QuickSort.List.fst(47,25-49,27)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(47,25-49,27)
(and 
;; def=QuickSort.List.fst(47,25-49,27); use=QuickSort.List.fst(49,25-49,27)
(or label_4
...
;; def=QuickSort.List.fst(42,35-49,9); use=QuickSort.List.fst(47,25-49,27)
(= @x3
@x4)
)

;; def=Prims.fst(441,36-441,97); use=QuickSort.List.fst(49,13-49,22)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=QuickSort.List.fst(44,10-44,37); use=QuickSort.List.fst(49,13-49,22)
(= (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_1
@x3)
(Prims.op_GreaterThan (QuickSort.List.count x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(49,13-49,22)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(49,13-49,22)
(ApplyTT @x1
@x5)
...
; encoding sigelt let rec mem_count


; <Start encoding let rec mem_count>
...
; </end encoding let rec mem_count>


; encoding sigelt val QuickSort.List.partition


; <Skipped val QuickSort.List.partition/>
...
; Starting query at QuickSort.List.fst(52,22-56,47)
...
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(51,26-52,19); use=QuickSort.List.fst(52,8-52,19)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))
:qid QuickSort.List_pre_typing_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))

:named QuickSort.List_pre_typing_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickSort.List_interpretation_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))
:qid QuickSort.List_interpretation_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))

:named QuickSort.List_interpretation_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))
...
(declare-fun Tm_refine_8105dda5119214fa15b40aef9acd3d00 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(52,22-56,47); use=QuickSort.List.fst(52,22-56,47)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_8105dda5119214fa15b40aef9acd3d00 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_8105dda5119214fa15b40aef9acd3d00 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_8105dda5119214fa15b40aef9acd3d00))

:named refinement_kinding_Tm_refine_8105dda5119214fa15b40aef9acd3d00))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(52,22-56,47); use=QuickSort.List.fst(52,22-56,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8105dda5119214fa15b40aef9acd3d00 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
@x1
(Tm_refine_8105dda5119214fa15b40aef9acd3d00 @x2)))
:qid refinement_interpretation_Tm_refine_8105dda5119214fa15b40aef9acd3d00))

:named refinement_interpretation_Tm_refine_8105dda5119214fa15b40aef9acd3d00))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8105dda5119214fa15b40aef9acd3d00
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(52,22-56,47); use=QuickSort.List.fst(52,22-56,47)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8105dda5119214fa15b40aef9acd3d00 @x0)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8105dda5119214fa15b40aef9acd3d00 @x0))))
:qid haseqTm_refine_8105dda5119214fa15b40aef9acd3d00))

:named haseqTm_refine_8105dda5119214fa15b40aef9acd3d00))
(declare-fun QuickSort.List.partition (Term Term Term) Term)


;;;;;;;;;;;;;;;;_: (_: 'a -> Prims.bool) -> _: _: Prims.list 'a {_ << _} -> Prims.list 'a & Prims.list 'a
(declare-fun Tm_arrow_68c025a0090f0c5b691ce03542260029 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_68c025a0090f0c5b691ce03542260029
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_68c025a0090f0c5b691ce03542260029
Tm_type)
:named kinding_Tm_arrow_68c025a0090f0c5b691ce03542260029))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(51,16-56,47); use=QuickSort.List.fst(51,16-56,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_68c025a0090f0c5b691ce03542260029)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_68c025a0090f0c5b691ce03542260029))
:qid QuickSort.List_pre_typing_Tm_arrow_68c025a0090f0c5b691ce03542260029))

:named QuickSort.List_pre_typing_Tm_arrow_68c025a0090f0c5b691ce03542260029))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_68c025a0090f0c5b691ce03542260029
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(51,16-56,47); use=QuickSort.List.fst(51,16-56,47)
(forall ((@x0 Term))
...
(Tm_arrow_84543425b818e2d10a976186b8e8c250 @x1))
(HasType @x3
(Tm_refine_8105dda5119214fa15b40aef9acd3d00 @x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
@x3)
...
@x2)
@x3))
:qid QuickSort.List_interpretation_Tm_arrow_68c025a0090f0c5b691ce03542260029.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickSort.List_interpretation_Tm_arrow_68c025a0090f0c5b691ce03542260029.2))
...
@x1)
@x2))
:qid QuickSort.List_interpretation_Tm_arrow_68c025a0090f0c5b691ce03542260029.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_68c025a0090f0c5b691ce03542260029))
:qid QuickSort.List_interpretation_Tm_arrow_68c025a0090f0c5b691ce03542260029))

:named QuickSort.List_interpretation_Tm_arrow_68c025a0090f0c5b691ce03542260029))
(declare-fun QuickSort.List.partition@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(52,8-52,17); use=QuickSort.List.fst(52,8-52,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT QuickSort.List.partition@tok
@x0)
@x1)
@x2)
(QuickSort.List.partition @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT QuickSort.List.partition@tok
@x0)
@x1)
@x2))
:qid token_correspondence_QuickSort.List.partition))

:named token_correspondence_QuickSort.List.partition))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(52,8-52,17); use=QuickSort.List.fst(52,8-52,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType QuickSort.List.partition@tok
Tm_arrow_68c025a0090f0c5b691ce03542260029))
...
@x2)
@x3)
(QuickSort.List.partition @x1
@x2
@x3))
 

:pattern ((QuickSort.List.partition @x1
@x2
@x3))
:qid function_token_typing_QuickSort.List.partition.1))
)
 

:pattern ((ApplyTT @x0
QuickSort.List.partition@tok))
:qid function_token_typing_QuickSort.List.partition))

:named function_token_typing_QuickSort.List.partition))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(52,8-52,17); use=QuickSort.List.fst(52,8-52,17)
...
(HasType @x2
(Tm_refine_8105dda5119214fa15b40aef9acd3d00 @x0)))
(HasType (QuickSort.List.partition @x0
@x1
@x2)
...
:pattern ((QuickSort.List.partition @x0
@x1
@x2))
:qid typing_QuickSort.List.partition))

:named typing_QuickSort.List.partition))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (Prims.list 'a & Prims.list 'a)).
;   (forall (x: Prims.list 'a & Prims.list 'a). {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(Nil? _) /\ ~(Cons? _) ==> Prims.l_False) /\
;   (~(Nil? _) ==> (forall (b: 'a) (b: Prims.list 'a). _ == b :: b ==> b << _))
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (Prims.list x_fe28d8bcde588226b4e538b35321de05_1)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1))))

;; def=Prims.fst(402,27-402,88); use=QuickSort.List.fst(52,22-56,47)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(52,22-56,47)
(Valid 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(52,22-56,47)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(52,22-56,47)
(and (implies 
;; def=QuickSort.List.fst(52,22-56,47); use=QuickSort.List.fst(52,22-56,47)
(and 
;; def=QuickSort.List.fst(52,22-56,47); use=QuickSort.List.fst(52,22-56,47)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=QuickSort.List.fst(52,22-56,47)
(not 
;; def=QuickSort.List.fst(52,22-56,47); use=QuickSort.List.fst(52,22-56,47)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_0a56e3de562c08d8ab59f4ac6f626a98_3))
...
;; def=Prims.fst(413,99-413,120); use=QuickSort.List.fst(52,22-56,47)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=QuickSort.List.fst(52,22-56,47); use=QuickSort.List.fst(55,29-55,31)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickSort.List.partition, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_0a56e3de562c08d8ab59f4ac6f626a98_3, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun QuickSort.List.partition.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun QuickSort.List.partition.fuel_instrumented_token () Term)
(declare-fun QuickSort.List.partition (Term Term Term) Term)
(declare-fun QuickSort.List.partition@tok () Term)
...
; encoding sigelt val QuickSort.List.partition_lemma


; <Skipped val QuickSort.List.partition_lemma/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickSort.List.partition; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(52,8-52,17); use=QuickSort.List.fst(52,8-52,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(HasType @x3
(Prims.list @x1)))
(HasType (QuickSort.List.partition.fuel_instrumented @u0
@x1
@x2
@x3)
(FStar.Pervasives.Native.tuple2 (Prims.list @x1)
...
:pattern ((QuickSort.List.partition.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_QuickSort.List.partition.fuel_instrumented))

:named token_correspondence_QuickSort.List.partition.fuel_instrumented))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name FStar.List.Tot.Base.length; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(74,8-74,14); use=FStar.List.Tot.Base.fst(74,8-74,14)
...
;;;;;;;;;;;;;;;;Lemma: QuickSort.List.mem_count
;;; Fact-ids: Name QuickSort.List.mem_count; Namespace QuickSort.List
...
;; def=QuickSort.List.fst(44,10-44,37); use=QuickSort.List.fst(47,8-47,17)
(= (FStar.List.Tot.Base.mem.fuel_instrumented ZFuel
@x0
@x1
@x2)
(Prims.op_GreaterThan (QuickSort.List.count.fuel_instrumented ZFuel
@x0
@x1
@x2)
(BoxInt 0)))
...
:pattern ((FStar.List.Tot.Base.mem.fuel_instrumented ZFuel
@x0
@x1
@x2))
:qid lemma_QuickSort.List.mem_count))
:named lemma_QuickSort.List.mem_count))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: QuickSort.List.partition
;;; Fact-ids: Name QuickSort.List.partition; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(52,8-52,17); use=QuickSort.List.fst(52,8-52,17)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Prims.list @x1)))
(= (QuickSort.List.partition.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x3))
...
(Prims.Nil @x1))
(ite (is-Prims.Cons @lb4)
(let ((@lb5 (QuickSort.List.partition.fuel_instrumented @u0
@x1
@x2
(Prims.Cons_tl @lb4))))
(let ((@lb6 (ApplyTT @x2
...
:pattern ((QuickSort.List.partition.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_QuickSort.List.partition.fuel_instrumented))

:named equation_with_fuel_QuickSort.List.partition.fuel_instrumented))
...
@x2
@x3)
(QuickSort.List.partition.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_QuickSort.List.partition.fuel_instrumented))

:named @fuel_irrelevance_QuickSort.List.partition.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name FStar.List.Tot.Base.length; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(74,8-74,14); use=FStar.List.Tot.Base.fst(74,8-74,14)
...
@x1
@x2)
(QuickSort.List.partition.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_QuickSort.List.partition.fuel_instrumented))

:named @fuel_correspondence_QuickSort.List.partition.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name FStar.List.Tot.Base.length; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(74,8-74,14); use=FStar.List.Tot.Base.fst(74,8-74,14)
...
; Starting query at QuickSort.List.fst(68,33-70,35)
...
:named binder_x_9cd1733a5204f989dbb2f01d5984df93_0))
;;;;;;;;;;;;;;;;f : _: a -> Prims.bool (_: a -> Prims.bool)
(declare-fun x_b30313af1883fa3dac9793c844f68f3f_1 () Term)
;;;;;;;;;;;;;;;;_: a -> Prims.bool
(declare-fun Tm_arrow_7326250d08c73a7388961066f97746aa () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7326250d08c73a7388961066f97746aa
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_7326250d08c73a7388961066f97746aa
Tm_type)
:named kinding_Tm_arrow_7326250d08c73a7388961066f97746aa))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(59,46-68,26); use=QuickSort.List.fst(68,8-68,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7326250d08c73a7388961066f97746aa)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_7326250d08c73a7388961066f97746aa))
:qid QuickSort.List_pre_typing_Tm_arrow_7326250d08c73a7388961066f97746aa))

:named QuickSort.List_pre_typing_Tm_arrow_7326250d08c73a7388961066f97746aa))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7326250d08c73a7388961066f97746aa
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(59,46-68,26); use=QuickSort.List.fst(68,8-68,26)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickSort.List_interpretation_Tm_arrow_7326250d08c73a7388961066f97746aa.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_7326250d08c73a7388961066f97746aa))
:qid QuickSort.List_interpretation_Tm_arrow_7326250d08c73a7388961066f97746aa))

:named QuickSort.List_interpretation_Tm_arrow_7326250d08c73a7388961066f97746aa))
;;;;;;;;;;;;;;;;binder_x_b30313af1883fa3dac9793c844f68f3f_1
;;; Fact-ids: 
(assert (! (HasType x_b30313af1883fa3dac9793c844f68f3f_1
Tm_arrow_7326250d08c73a7388961066f97746aa)
:named binder_x_b30313af1883fa3dac9793c844f68f3f_1))
...
:named binder_x_374b44ccfcb77ed85d505dbc44265913_2))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun QuickSort.List.partition_lemma (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun QuickSort.List.partition_lemma@tok () Term)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit).
;       (let hi, lo = QuickSort.List.partition f l in
;         FStar.List.Tot.Base.length l = FStar.List.Tot.Base.length hi + FStar.List.Tot.Base.length lo /\
;         (forall (x: a). {:pattern f x}
;             (FStar.List.Tot.Base.mem x hi ==> f x) /\ (FStar.List.Tot.Base.mem x lo ==> ~(f x))) /\
;         (forall (x: a). {:pattern QuickSort.List.count x hi\/QuickSort.List.count x lo}
;             QuickSort.List.count x l = QuickSort.List.count x hi + QuickSort.List.count x lo)) ==>
;       p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
...
;                 b == any_result ==>
;                 (forall (pure_result: Prims.unit).
;                     (let hi, lo = QuickSort.List.partition f b in
;                       FStar.List.Tot.Base.length b =
;                       FStar.List.Tot.Base.length hi + FStar.List.Tot.Base.length lo /\
;                       (forall (x: a). {:pattern f x}
;                           (FStar.List.Tot.Base.mem x hi ==> f x) /\
;                           (FStar.List.Tot.Base.mem x lo ==> ~(f x))) /\
;                       (forall (x: a).
;                           {:pattern QuickSort.List.count x hi\/QuickSort.List.count x lo}
;                           QuickSort.List.count x b =
;                           QuickSort.List.count x hi + QuickSort.List.count x lo)) ==>
;                     k pure_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec partition_lemma`
...
;;; Fact-ids: 
(assert (! (not 
;; def=QuickSort.List.fst(68,33-70,35); use=QuickSort.List.fst(68,33-70,35)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=QuickSort.List.fst(68,33-70,35)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))
(let ((@lb2 (QuickSort.List.partition x_9cd1733a5204f989dbb2f01d5984df93_0
x_b30313af1883fa3dac9793c844f68f3f_1
x_374b44ccfcb77ed85d505dbc44265913_2)))

;; def=QuickSort.List.fst(62,18-66,73); use=QuickSort.List.fst(68,33-70,35)
(and 
;; def=QuickSort.List.fst(62,18-62,50); use=QuickSort.List.fst(68,33-70,35)
(or label_2

;; def=QuickSort.List.fst(62,18-62,50); use=QuickSort.List.fst(68,33-70,35)
(= (FStar.List.Tot.Base.length x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2)
(Prims.op_Addition (FStar.List.Tot.Base.length x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=QuickSort.List.fst(63,21-64,63); use=QuickSort.List.fst(68,33-70,35)
(forall ((@x3 Term))
 (! (implies (HasType @x3
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=QuickSort.List.fst(63,46-64,62); use=QuickSort.List.fst(68,33-70,35)
(and (implies 
;; def=QuickSort.List.fst(63,47-63,55); use=QuickSort.List.fst(68,33-70,35)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
(FStar.Pervasives.Native.Mktuple2__1 @lb2)))


;; def=QuickSort.List.fst(63,62-63,65); use=QuickSort.List.fst(68,33-70,35)
(or label_3

;; def=QuickSort.List.fst(63,62-63,65); use=QuickSort.List.fst(68,33-70,35)
(BoxBool_proj_0 (ApplyTT x_b30313af1883fa3dac9793c844f68f3f_1
@x3))
)
)
(implies 
;; def=QuickSort.List.fst(64,42-64,50); use=QuickSort.List.fst(68,33-70,35)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
(FStar.Pervasives.Native.Mktuple2__2 @lb2)))


;; def=QuickSort.List.fst(64,55-64,61); use=QuickSort.List.fst(68,33-70,35)
(or label_4

;; def=QuickSort.List.fst(64,55-64,61); use=QuickSort.List.fst(68,33-70,35)
(not 
;; def=QuickSort.List.fst(64,56-64,61); use=QuickSort.List.fst(68,33-70,35)
(BoxBool_proj_0 (ApplyTT x_b30313af1883fa3dac9793c844f68f3f_1
@x3))
)
)
...
:pattern ((ApplyTT x_b30313af1883fa3dac9793c844f68f3f_1
@x3))
:qid @query.2))


;; def=QuickSort.List.fst(65,21-66,73); use=QuickSort.List.fst(68,33-70,35)
(forall ((@x3 Term))
 (! (implies (HasType @x3
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=QuickSort.List.fst(66,35-66,72); use=QuickSort.List.fst(68,33-70,35)
(or label_5
...
@x3
x_374b44ccfcb77ed85d505dbc44265913_2)
(Prims.op_Addition (QuickSort.List.count x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
(FStar.Pervasives.Native.Mktuple2__1 @lb2))
(QuickSort.List.count x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
...
:pattern ((QuickSort.List.count.fuel_instrumented ZFuel
x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
(FStar.Pervasives.Native.Mktuple2__1 @lb2)))
...
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(68,33-70,35)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(68,33-70,35)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=QuickSort.List.fst(68,33-70,35)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=QuickSort.List.fst(68,33-70,35)
(Valid 
;; def=Prims.fst(402,73-402,79); use=QuickSort.List.fst(68,33-70,35)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(68,33-70,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(68,33-70,35)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(68,33-70,35)
(and (implies 
;; def=QuickSort.List.fst(68,29-68,30); use=QuickSort.List.fst(68,39-68,40)
(and 
;; def=QuickSort.List.fst(68,29-68,30); use=QuickSort.List.fst(68,39-68,40)
(not 
;; def=QuickSort.List.fst(68,29-68,30); use=QuickSort.List.fst(68,39-68,40)
...
label_6)
(implies 
;; def=QuickSort.List.fst(68,29-69,6); use=QuickSort.List.fst(68,39-69,6)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=QuickSort.List.fst(68,33-70,35)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=QuickSort.List.fst(68,33-70,35)
(Valid 
;; def=Prims.fst(451,90-451,102); use=QuickSort.List.fst(68,33-70,35)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=QuickSort.List.fst(68,33-70,35)
(not 
;; def=QuickSort.List.fst(68,29-68,30); use=QuickSort.List.fst(68,39-68,40)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
;; def=Prims.fst(413,99-413,120); use=QuickSort.List.fst(68,33-70,35)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=QuickSort.List.fst(68,29-70,10); use=QuickSort.List.fst(68,39-70,10)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(68,33-70,35)
(and 
;; def=QuickSort.List.fst(59,22-70,35); use=QuickSort.List.fst(70,33-70,35)
(or label_7

;; def=QuickSort.List.fst(68,33-70,35); use=QuickSort.List.fst(70,33-70,35)
(Valid 
;; def=QuickSort.List.fst(68,33-70,35); use=QuickSort.List.fst(70,33-70,35)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=QuickSort.List.fst(59,55-70,10); use=QuickSort.List.fst(68,33-70,35)
(= @x3
@x4)
)

;; def=Prims.fst(441,36-441,97); use=QuickSort.List.fst(70,15-70,30)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)
(let ((@lb6 (QuickSort.List.partition x_9cd1733a5204f989dbb2f01d5984df93_0
x_b30313af1883fa3dac9793c844f68f3f_1
@x3)))

;; def=QuickSort.List.fst(62,18-66,73); use=QuickSort.List.fst(70,15-70,30)
(and 
;; def=QuickSort.List.fst(62,18-62,50); use=QuickSort.List.fst(70,15-70,30)
(= (FStar.List.Tot.Base.length x_9cd1733a5204f989dbb2f01d5984df93_0
@x3)
(Prims.op_Addition (FStar.List.Tot.Base.length x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=QuickSort.List.fst(63,21-64,63); use=QuickSort.List.fst(70,15-70,30)
(forall ((@x7 Term))
 (! (implies (HasType @x7
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=QuickSort.List.fst(63,46-64,62); use=QuickSort.List.fst(70,15-70,30)
(and 
;; def=QuickSort.List.fst(63,46-63,66); use=QuickSort.List.fst(70,15-70,30)
(implies 
;; def=QuickSort.List.fst(63,47-63,55); use=QuickSort.List.fst(70,15-70,30)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x7
(FStar.Pervasives.Native.Mktuple2__1 @lb6)))


;; def=QuickSort.List.fst(63,62-63,65); use=QuickSort.List.fst(70,15-70,30)
(BoxBool_proj_0 (ApplyTT x_b30313af1883fa3dac9793c844f68f3f_1
@x7))
)


;; def=QuickSort.List.fst(64,41-64,62); use=QuickSort.List.fst(70,15-70,30)
(implies 
;; def=QuickSort.List.fst(64,42-64,50); use=QuickSort.List.fst(70,15-70,30)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x7
(FStar.Pervasives.Native.Mktuple2__2 @lb6)))


;; def=QuickSort.List.fst(64,55-64,61); use=QuickSort.List.fst(70,15-70,30)
(not 
;; def=QuickSort.List.fst(64,56-64,61); use=QuickSort.List.fst(70,15-70,30)
(BoxBool_proj_0 (ApplyTT x_b30313af1883fa3dac9793c844f68f3f_1
@x7))
)
)
...
;; def=QuickSort.List.fst(65,21-66,73); use=QuickSort.List.fst(70,15-70,30)
(forall ((@x7 Term))
 (! (implies (HasType @x7
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=QuickSort.List.fst(66,35-66,72); use=QuickSort.List.fst(70,15-70,30)
(= (QuickSort.List.count x_9cd1733a5204f989dbb2f01d5984df93_0
@x7
@x3)
(Prims.op_Addition (QuickSort.List.count x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(70,15-70,30)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(70,15-70,30)
(ApplyTT @x1
@x5)
...
; encoding sigelt let rec partition_lemma


; <Start encoding let rec partition_lemma>
...
; </end encoding let rec partition_lemma>


; encoding sigelt val QuickSort.List.sorted_app_lemma


; <Skipped val QuickSort.List.sorted_app_lemma/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickSort.List.total_order; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(28,5-28,16); use=QuickSort.List.fst(28,5-28,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.eqtype)
(HasType (QuickSort.List.total_order @x0)
Tm_type))
 

:pattern ((QuickSort.List.total_order @x0))
:qid typing_QuickSort.List.total_order))

:named typing_QuickSort.List.total_order))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickSort.List.sorted; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(24,8-24,14); use=QuickSort.List.fst(24,8-24,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(HasType @x3
(Prims.list @x1)))
(HasType (QuickSort.List.sorted.fuel_instrumented @u0
@x1
@x2
@x3)
Prims.bool))
...
:pattern ((QuickSort.List.sorted.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_QuickSort.List.sorted.fuel_instrumented))

:named token_correspondence_QuickSort.List.sorted.fuel_instrumented))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name FStar.List.Tot.Base.append; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(119,8-119,14); use=FStar.List.Tot.Base.fst(119,8-119,14)
...
;;; Fact-ids: Name QuickSort.List.total_order; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(29,2-34,3); use=QuickSort.List.fst(29,2-34,3)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_17abf6cc62b543ab8e21c4b019598546 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_17abf6cc62b543ab8e21c4b019598546 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_17abf6cc62b543ab8e21c4b019598546))

:named refinement_kinding_Tm_refine_17abf6cc62b543ab8e21c4b019598546))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name QuickSort.List.total_order; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(29,2-34,3); use=QuickSort.List.fst(29,2-34,3)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_17abf6cc62b543ab8e21c4b019598546 @x2))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e @x2))

;; def=QuickSort.List.fst(30,6-30,23); use=QuickSort.List.fst(30,6-30,23)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x2)

;; def=QuickSort.List.fst(30,17-30,22); use=QuickSort.List.fst(30,17-30,22)
...
;;no pats
:qid refinement_interpretation_Tm_refine_17abf6cc62b543ab8e21c4b019598546.1))


;; def=QuickSort.List.fst(31,7-31,53); use=QuickSort.List.fst(31,7-31,53)
...
;; def=QuickSort.List.fst(31,22-31,29); use=QuickSort.List.fst(31,22-31,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x1
@x3)
@x4))


;; def=QuickSort.List.fst(31,33-31,40); use=QuickSort.List.fst(31,33-31,40)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x1
@x4)
@x3))
)

;; def=QuickSort.List.fst(31,45-31,52); use=QuickSort.List.fst(31,45-31,52)
(= @x3
@x4)
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_17abf6cc62b543ab8e21c4b019598546.2))


;; def=QuickSort.List.fst(32,7-32,56); use=QuickSort.List.fst(32,7-32,56)
...
;; def=QuickSort.List.fst(32,25-32,32); use=QuickSort.List.fst(32,25-32,32)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x1
@x3)
@x4))


;; def=QuickSort.List.fst(32,36-32,43); use=QuickSort.List.fst(32,36-32,43)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x1
@x4)
@x5))
)

;; def=QuickSort.List.fst(32,48-32,55); use=QuickSort.List.fst(32,48-32,55)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x1
@x3)
@x5))
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_17abf6cc62b543ab8e21c4b019598546.3))


;; def=QuickSort.List.fst(33,7-33,41); use=QuickSort.List.fst(33,7-33,41)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
@x2)
(HasType @x4
...
;; def=QuickSort.List.fst(33,22-33,40); use=QuickSort.List.fst(33,22-33,40)
(or 
;; def=QuickSort.List.fst(33,22-33,29); use=QuickSort.List.fst(33,22-33,29)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x1
@x3)
@x4))


;; def=QuickSort.List.fst(33,33-33,40); use=QuickSort.List.fst(33,33-33,40)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x1
@x4)
@x3))
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_17abf6cc62b543ab8e21c4b019598546.4))
))
...
@x1
(Tm_refine_17abf6cc62b543ab8e21c4b019598546 @x2)))
:qid refinement_interpretation_Tm_refine_17abf6cc62b543ab8e21c4b019598546))

:named refinement_interpretation_Tm_refine_17abf6cc62b543ab8e21c4b019598546))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_17abf6cc62b543ab8e21c4b019598546
;;; Fact-ids: Name QuickSort.List.total_order; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(29,2-34,3); use=QuickSort.List.fst(29,2-34,3)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_17abf6cc62b543ab8e21c4b019598546 @x0)))
(Valid (Prims.hasEq (Tm_arrow_c8126b87a2c25bb477df4a7a6b0eea9e @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_17abf6cc62b543ab8e21c4b019598546 @x0))))
:qid haseqTm_refine_17abf6cc62b543ab8e21c4b019598546))

:named haseqTm_refine_17abf6cc62b543ab8e21c4b019598546))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: QuickSort.List.sorted
;;; Fact-ids: Name QuickSort.List.sorted; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(24,8-24,14); use=QuickSort.List.fst(24,8-24,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Prims.list @x1)))
(= (QuickSort.List.sorted.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x3))
...
(QuickSort.List.sorted.fuel_instrumented @u0
@x1
@x2
(Prims.Cons @x1
(Prims.Cons_hd (Prims.Cons_tl @lb4))
...
:pattern ((QuickSort.List.sorted.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_QuickSort.List.sorted.fuel_instrumented))

:named equation_with_fuel_QuickSort.List.sorted.fuel_instrumented))
...
;;;;;;;;;;;;;;;;Equation for QuickSort.List.total_order
;;; Fact-ids: Name QuickSort.List.total_order; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(28,5-28,16); use=QuickSort.List.fst(28,5-28,16)
(forall ((@x0 Term))
 (! (= (QuickSort.List.total_order @x0)
(Tm_refine_17abf6cc62b543ab8e21c4b019598546 @x0))
 

:pattern ((QuickSort.List.total_order @x0))
:qid equation_QuickSort.List.total_order))

:named equation_QuickSort.List.total_order))
...
@x2
@x3)
(QuickSort.List.sorted.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_QuickSort.List.sorted.fuel_instrumented))

:named @fuel_irrelevance_QuickSort.List.sorted.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name FStar.List.Tot.Base.append; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(119,8-119,14); use=FStar.List.Tot.Base.fst(119,8-119,14)
...
@x1
@x2)
(QuickSort.List.sorted.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_QuickSort.List.sorted.fuel_instrumented))

:named @fuel_correspondence_QuickSort.List.sorted.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name FStar.List.Tot.Base.append; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(119,8-119,14); use=FStar.List.Tot.Base.fst(119,8-119,14)
...
; Starting query at QuickSort.List.fst(79,2-81,11)
...
Prims.eqtype)
:named binder_x_9cd1733a5204f989dbb2f01d5984df93_0))
;;;;;;;;;;;;;;;;f : QuickSort.List.total_order a (QuickSort.List.total_order a)
(declare-fun x_fa73c18594d08bb0081d6900c10a3e22_1 () Term)
;;;;;;;;;;;;;;;;binder_x_fa73c18594d08bb0081d6900c10a3e22_1
;;; Fact-ids: 
(assert (! (HasType x_fa73c18594d08bb0081d6900c10a3e22_1
(QuickSort.List.total_order x_9cd1733a5204f989dbb2f01d5984df93_0))
:named binder_x_fa73c18594d08bb0081d6900c10a3e22_1))
;;;;;;;;;;;;;;;;l1 : l1: Prims.list a {QuickSort.List.sorted f l1} (l1: Prims.list a {QuickSort.List.sorted f l1})
(declare-fun x_1764a6116741c7a0333841a23d29b244_2 () Term)
(declare-fun Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c
Tm_type)
:named refinement_kinding_Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(73,5-73,27); use=QuickSort.List.fst(78,8-78,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c)
(and (HasTypeFuel @u0
@x1
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=QuickSort.List.fst(73,15-73,26); use=QuickSort.List.fst(78,8-78,24)
(BoxBool_proj_0 (QuickSort.List.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x1))
))
...
@x1
Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c))
:qid refinement_interpretation_Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c))

:named refinement_interpretation_Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c))
(Valid (Prims.hasEq (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))))
:named haseqTm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c))
;;;;;;;;;;;;;;;;binder_x_1764a6116741c7a0333841a23d29b244_2
;;; Fact-ids: 
(assert (! (HasType x_1764a6116741c7a0333841a23d29b244_2
Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c)
:named binder_x_1764a6116741c7a0333841a23d29b244_2))
;;;;;;;;;;;;;;;;l2 : l2: Prims.list a {QuickSort.List.sorted f l2} (l2: Prims.list a {QuickSort.List.sorted f l2})
(declare-fun x_1764a6116741c7a0333841a23d29b244_3 () Term)

;;;;;;;;;;;;;;;;binder_x_1764a6116741c7a0333841a23d29b244_3
;;; Fact-ids: 
(assert (! (HasType x_1764a6116741c7a0333841a23d29b244_3
Tm_refine_0b2f95dfd86ca50bd4c9605f1f8a4a8c)
:named binder_x_1764a6116741c7a0333841a23d29b244_3))
;;;;;;;;;;;;;;;;pivot : a (a)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun QuickSort.List.sorted_app_lemma (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun QuickSort.List.sorted_app_lemma@tok () Term)
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (y: a).
;       (FStar.List.Tot.Base.mem y l1 ==> ~(f pivot y)) /\
;       (FStar.List.Tot.Base.mem y l2 ==> f pivot y)) /\
;   (forall (pure_result: Prims.unit). QuickSort.List.sorted f (l1 @ pivot :: l2) ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (forall (b: a) (b: Prims.list a).
;           l1 == b :: b ==>
;           QuickSort.List.sorted f b /\
;           (forall (any_result: Prims.list a).
;               b == any_result ==>
;               (a << a \/ (f << f \/ (b << l1 \/ b === l1 /\ (l2 << l2 \/ pivot << pivot)))) /\
;               (forall (any_result: a).
;                   pivot == any_result ==>
;                   (forall (y: a).
;                       (FStar.List.Tot.Base.mem y b ==> ~(f pivot y)) /\
;                       (FStar.List.Tot.Base.mem y l2 ==> f pivot y)) /\
;                   (forall (pure_result: Prims.unit).
;                       QuickSort.List.sorted f (b @ pivot :: l2) ==> k pure_result)))) /\
;       (~(Cons? l1) ==>
;         (forall (b: Prims.list a). l1 == b ==> (forall (any_result: Prims.unit). k any_result))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec sorted_app_lemma`
...
;;; Fact-ids: 
(assert (! (not 
;; def=QuickSort.List.fst(79,2-81,11); use=QuickSort.List.fst(79,2-81,11)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=QuickSort.List.fst(74,21-75,40); use=QuickSort.List.fst(79,2-81,11)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=QuickSort.List.fst(74,32-75,39); use=QuickSort.List.fst(79,2-81,11)
(and 
;; def=QuickSort.List.fst(74,32-74,59); use=QuickSort.List.fst(79,2-81,11)
(implies 
;; def=QuickSort.List.fst(74,33-74,41); use=QuickSort.List.fst(79,2-81,11)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
x_1764a6116741c7a0333841a23d29b244_2))


;; def=QuickSort.List.fst(74,46-74,58); use=QuickSort.List.fst(79,2-81,11)
(not 
;; def=QuickSort.List.fst(74,47-74,58); use=QuickSort.List.fst(79,2-81,11)
(BoxBool_proj_0 (ApplyTT (ApplyTT x_fa73c18594d08bb0081d6900c10a3e22_1
...
;; def=QuickSort.List.fst(75,13-75,39); use=QuickSort.List.fst(79,2-81,11)
(implies 
;; def=QuickSort.List.fst(75,14-75,22); use=QuickSort.List.fst(79,2-81,11)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
x_1764a6116741c7a0333841a23d29b244_3))


;; def=QuickSort.List.fst(75,29-75,38); use=QuickSort.List.fst(79,2-81,11)
(BoxBool_proj_0 (ApplyTT (ApplyTT x_fa73c18594d08bb0081d6900c10a3e22_1
x_157b99e815dc43d99415725267e9c452_4)
@x1))
)
...
;; def=Prims.fst(441,36-441,97); use=QuickSort.List.fst(79,2-81,11)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=QuickSort.List.fst(76,19-76,48); use=QuickSort.List.fst(79,2-81,11)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(79,2-81,11)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(79,2-81,11)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=QuickSort.List.fst(79,2-81,11)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=QuickSort.List.fst(79,2-81,11)
(Valid 
;; def=Prims.fst(402,73-402,79); use=QuickSort.List.fst(79,2-81,11)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(79,2-81,11)
(Valid 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(79,2-81,11)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(389,2-389,39); use=QuickSort.List.fst(79,2-81,11)
(and 
;; def=Prims.fst(413,99-413,120); use=QuickSort.List.fst(79,2-81,11)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=QuickSort.List.fst(78,30-80,10); use=QuickSort.List.fst(79,8-80,10)
(= x_1764a6116741c7a0333841a23d29b244_2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(79,2-81,11)
(and 
;; def=QuickSort.List.fst(73,15-73,26); use=QuickSort.List.fst(80,33-80,35)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=QuickSort.List.fst(79,2-81,11)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=QuickSort.List.fst(73,5-80,10); use=QuickSort.List.fst(79,2-81,11)
(= @x3
@x4)
)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(79,2-81,11)
(and 
;; def=QuickSort.List.fst(72,23-81,11); use=QuickSort.List.fst(80,39-80,44)
(or label_4

;; def=QuickSort.List.fst(79,2-81,11); use=QuickSort.List.fst(80,39-80,44)
(Valid 
;; def=QuickSort.List.fst(79,2-81,11); use=QuickSort.List.fst(80,39-80,44)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
(Valid 
;; def=QuickSort.List.fst(79,2-81,11); use=QuickSort.List.fst(80,39-80,44)
(Prims.precedes (QuickSort.List.total_order x_9cd1733a5204f989dbb2f01d5984df93_0)
(QuickSort.List.total_order x_9cd1733a5204f989dbb2f01d5984df93_0)
x_fa73c18594d08bb0081d6900c10a3e22_1
x_fa73c18594d08bb0081d6900c10a3e22_1)
)
...
;; def=QuickSort.List.fst(73,5-81,11); use=QuickSort.List.fst(80,39-80,44)
(and 
;; def=QuickSort.List.fst(73,5-78,32); use=QuickSort.List.fst(80,39-80,44)
(Valid 
;; def=QuickSort.List.fst(73,5-78,32); use=QuickSort.List.fst(80,39-80,44)
...
;; def=QuickSort.List.fst(73,31-81,11); use=QuickSort.List.fst(80,39-80,44)
(or 
;; def=QuickSort.List.fst(79,2-81,11); use=QuickSort.List.fst(80,39-80,44)
(Valid 
;; def=QuickSort.List.fst(79,2-81,11); use=QuickSort.List.fst(80,39-80,44)
...
;; def=QuickSort.List.fst(73,57-78,41); use=QuickSort.List.fst(79,2-81,11)
(= x_157b99e815dc43d99415725267e9c452_4
@x5)
)

;; def=Prims.fst(441,29-441,97); use=QuickSort.List.fst(80,14-80,30)
(and 
;; def=QuickSort.List.fst(74,21-75,40); use=QuickSort.List.fst(80,14-80,30)
(forall ((@x6 Term))
 (! (implies (HasType @x6
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=QuickSort.List.fst(74,32-75,39); use=QuickSort.List.fst(80,14-80,30)
(and (implies 
;; def=QuickSort.List.fst(74,33-74,41); use=QuickSort.List.fst(80,14-80,30)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x6
@x3))


;; def=QuickSort.List.fst(74,46-74,58); use=QuickSort.List.fst(80,14-80,30)
(or label_5

;; def=QuickSort.List.fst(74,46-74,58); use=QuickSort.List.fst(80,14-80,30)
(not 
;; def=QuickSort.List.fst(74,47-74,58); use=QuickSort.List.fst(80,14-80,30)
(BoxBool_proj_0 (ApplyTT (ApplyTT x_fa73c18594d08bb0081d6900c10a3e22_1
x_157b99e815dc43d99415725267e9c452_4)
@x6))
)
...
(implies 
;; def=QuickSort.List.fst(75,14-75,22); use=QuickSort.List.fst(80,14-80,30)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x6
x_1764a6116741c7a0333841a23d29b244_3))


;; def=QuickSort.List.fst(75,29-75,38); use=QuickSort.List.fst(80,14-80,30)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=QuickSort.List.fst(80,14-80,30)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=QuickSort.List.fst(76,19-76,48); use=QuickSort.List.fst(80,14-80,30)
(BoxBool_proj_0 (QuickSort.List.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
(FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
...
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(80,14-80,30)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(80,14-80,30)
(ApplyTT @x1
@x6)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=QuickSort.List.fst(79,2-81,11)
(not 
;; def=QuickSort.List.fst(78,30-78,32); use=QuickSort.List.fst(79,8-79,10)
(BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
x_1764a6116741c7a0333841a23d29b244_2))
)
...
;; def=QuickSort.List.fst(78,30-81,5); use=QuickSort.List.fst(79,8-81,5)
(= x_1764a6116741c7a0333841a23d29b244_2
@x2)
)
...
;; def=Prims.fst(451,90-451,102); use=QuickSort.List.fst(79,2-81,11)
(Valid 
;; def=Prims.fst(451,90-451,102); use=QuickSort.List.fst(79,2-81,11)
(ApplyTT @x1
@x3)
...
; encoding sigelt let rec sorted_app_lemma


; <Start encoding let rec sorted_app_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun QuickSort.List.sorted_app_lemma (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun QuickSort.List.sorted_app_lemma@tok () Term)
(declare-fun Tm_refine_99f7df2863fee377fc834e4ed93b99b6 (Term Term) Term)


; </end encoding let rec sorted_app_lemma>

(push) ;; push{2

; Starting query at QuickSort.List.fst(84,2-84,33)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Prims.eqtype) (l: Prims.list a) (m: Prims.list a).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let is_permutation`
...
;; def=dummy(0,0-0,0); use=QuickSort.List.fst(84,2-84,33)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x0)

;; def=Prims.fst(73,23-73,30); use=QuickSort.List.fst(84,24-84,29)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickSort.List.is_permutation, 1)
; STATUS: unsat
...
; encoding sigelt let is_permutation


; <Start encoding let is_permutation>

(declare-fun QuickSort.List.is_permutation (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Prims.eqtype -> l: Prims.list a -> m: Prims.list a -> Prims.logical
(declare-fun Tm_arrow_c889543c7ad1d1005ca87f02dbc30b89 () Term)
(declare-fun QuickSort.List.is_permutation@tok () Term)

; </end encoding let is_permutation>


; encoding sigelt val QuickSort.List.append_count


; <Skipped val QuickSort.List.append_count/>

(push) ;; push{2

; Starting query at QuickSort.List.fst(91,2-93,33)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun QuickSort.List.append_count (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun QuickSort.List.append_count@tok () Term)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit).
;       QuickSort.List.count x (l @ m) = QuickSort.List.count x l + QuickSort.List.count x m ==>
;       p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
...
;                 x == any_result ==>
;                 (forall (pure_result: Prims.unit).
;                     QuickSort.List.count x (b @ m) =
;                     QuickSort.List.count x b + QuickSort.List.count x m ==>
;                     k pure_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec append_count`
...
;;; Fact-ids: 
(assert (! (not 
;; def=QuickSort.List.fst(91,2-93,33); use=QuickSort.List.fst(91,2-93,33)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=QuickSort.List.fst(91,2-93,33)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=QuickSort.List.fst(88,17-88,60); use=QuickSort.List.fst(91,2-93,33)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(91,2-93,33)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(91,2-93,33)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=QuickSort.List.fst(91,2-93,33)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=QuickSort.List.fst(91,2-93,33)
(Valid 
;; def=Prims.fst(402,73-402,79); use=QuickSort.List.fst(91,2-93,33)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(91,2-93,33)
(Valid 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(91,2-93,33)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(91,2-93,33)
(and (implies 
;; def=QuickSort.List.fst(90,24-90,25); use=QuickSort.List.fst(91,8-91,9)
(and 
;; def=QuickSort.List.fst(90,24-90,25); use=QuickSort.List.fst(91,8-91,9)
(not 
;; def=QuickSort.List.fst(90,24-90,25); use=QuickSort.List.fst(91,8-91,9)
...
label_3)
(implies 
;; def=QuickSort.List.fst(90,24-92,6); use=QuickSort.List.fst(91,8-92,6)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=QuickSort.List.fst(91,2-93,33)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=QuickSort.List.fst(91,2-93,33)
(Valid 
;; def=Prims.fst(451,90-451,102); use=QuickSort.List.fst(91,2-93,33)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=QuickSort.List.fst(91,2-93,33)
(not 
;; def=QuickSort.List.fst(90,24-90,25); use=QuickSort.List.fst(91,8-91,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(413,99-413,120); use=QuickSort.List.fst(91,2-93,33)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=QuickSort.List.fst(90,24-93,10); use=QuickSort.List.fst(91,8-93,10)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(91,2-93,33)
(and 
;; def=QuickSort.List.fst(86,19-93,33); use=QuickSort.List.fst(93,32-93,33)
(or label_4

;; def=QuickSort.List.fst(91,2-93,33); use=QuickSort.List.fst(93,32-93,33)
(Valid 
;; def=QuickSort.List.fst(91,2-93,33); use=QuickSort.List.fst(93,32-93,33)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=QuickSort.List.fst(86,31-93,33); use=QuickSort.List.fst(93,32-93,33)
(and 
;; def=QuickSort.List.fst(86,31-90,25); use=QuickSort.List.fst(93,32-93,33)
(Valid 
;; def=QuickSort.List.fst(86,31-90,25); use=QuickSort.List.fst(93,32-93,33)
(Prims.op_Equals_Equals_Equals (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=QuickSort.List.fst(86,43-93,33); use=QuickSort.List.fst(93,32-93,33)
(or 
;; def=QuickSort.List.fst(91,2-93,33); use=QuickSort.List.fst(93,32-93,33)
(Valid 
;; def=QuickSort.List.fst(91,2-93,33); use=QuickSort.List.fst(93,32-93,33)
...
;; def=QuickSort.List.fst(86,55-90,29); use=QuickSort.List.fst(91,2-93,33)
(= x_157b99e815dc43d99415725267e9c452_3
@x4)
)

;; def=Prims.fst(441,36-441,97); use=QuickSort.List.fst(93,14-93,26)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=QuickSort.List.fst(88,17-88,60); use=QuickSort.List.fst(93,14-93,26)
(= (QuickSort.List.count x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_3
(FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
...
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(93,14-93,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(93,14-93,26)
(ApplyTT @x1
@x5)
...
; encoding sigelt let rec append_count


; <Start encoding let rec append_count>
...
; </end encoding let rec append_count>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name QuickSort.List.is_permutation; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(83,5-83,19); use=QuickSort.List.fst(83,5-83,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
(HasType @x2
(Prims.list @x0)))
(HasType (QuickSort.List.is_permutation @x0
@x1
@x2)
Prims.logical))
 

:pattern ((QuickSort.List.is_permutation @x0
@x1
@x2))
:qid typing_QuickSort.List.is_permutation))

:named typing_QuickSort.List.is_permutation))
;;;;;;;;;;;;;;;;Lemma: QuickSort.List.append_count
;;; Fact-ids: Name QuickSort.List.append_count; Namespace QuickSort.List
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
;; def=QuickSort.List.fst(88,17-88,60); use=QuickSort.List.fst(90,8-90,20)
(= (QuickSort.List.count.fuel_instrumented ZFuel
@x0
@x3
(FStar.List.Tot.Base.op_At @x0
@x1
@x2))
(Prims.op_Addition (QuickSort.List.count.fuel_instrumented ZFuel
@x0
@x3
@x1)
(QuickSort.List.count.fuel_instrumented ZFuel
...
@x1
@x2)))
:qid lemma_QuickSort.List.append_count))
:named lemma_QuickSort.List.append_count))
;;;;;;;;;;;;;;;;Equation for QuickSort.List.is_permutation
;;; Fact-ids: Name QuickSort.List.is_permutation; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(83,5-83,19); use=QuickSort.List.fst(83,5-83,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (QuickSort.List.is_permutation @x0
@x1
@x2))

;; def=QuickSort.List.fst(84,2-84,33); use=QuickSort.List.fst(84,2-84,33)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x0)

;; def=QuickSort.List.fst(84,12-84,33); use=QuickSort.List.fst(84,12-84,33)
(= (QuickSort.List.count @x0
@x3
@x1)
(QuickSort.List.count @x0
...
;;no pats
:qid equation_QuickSort.List.is_permutation.1))
)
...
@x1
@x2))
:qid equation_QuickSort.List.is_permutation))

:named equation_QuickSort.List.is_permutation))
;;;;;;;;;;;;;;;;Prop-typing for QuickSort.List.is_permutation
;;; Fact-ids: Name QuickSort.List.is_permutation; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(83,5-83,19); use=QuickSort.List.fst(83,5-83,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Prims.list @x0)))
(Valid (Prims.subtype_of (QuickSort.List.is_permutation @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (QuickSort.List.is_permutation @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_QuickSort.List.is_permutation))

:named defn_equation_QuickSort.List.is_permutation))
(push) ;; push{2

; Starting query at QuickSort.List.fst(109,4-109,82)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Prims.eqtype) (hd: a) (tl: Prims.list a) (l1: Prims.list a) (l2: Prims.list a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     QuickSort.List.is_permutation a tl (l1 @ l2) /\
;     (forall (pure_result: Prims.unit).
;         QuickSort.List.is_permutation a (hd :: tl) (l1 @ hd :: l2) ==> p pure_result) ==>
;     (forall (x: a).
;         QuickSort.List.count x (l1 @ hd :: l2) =
;         QuickSort.List.count x l1 + QuickSort.List.count x (hd :: l2)) /\
;     (forall (pure_result: Prims.unit).
;         (forall (x: a).
;             QuickSort.List.count x (l1 @ hd :: l2) =
;             QuickSort.List.count x l1 + QuickSort.List.count x (hd :: l2)) ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let permutation_app_lemma`
...
;; def=QuickSort.List.fst(97,21-97,52); use=QuickSort.List.fst(109,4-109,82)
(Valid 
;; def=QuickSort.List.fst(97,21-97,52); use=QuickSort.List.fst(109,4-109,82)
(QuickSort.List.is_permutation @x0
@x2
(FStar.List.Tot.Base.op_At @x0
@x3
@x4))
...
;; def=Prims.fst(441,36-441,97); use=QuickSort.List.fst(109,4-109,82)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=QuickSort.List.fst(98,20-98,63); use=QuickSort.List.fst(109,4-109,82)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(109,4-109,82)
(Valid 
;; def=Prims.fst(441,83-441,96); use=QuickSort.List.fst(109,4-109,82)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(441,29-441,97); use=QuickSort.List.fst(109,4-109,82)
(and 
;; def=QuickSort.List.fst(109,11-109,82); use=QuickSort.List.fst(109,11-109,82)
(forall ((@x6 Term))
 (! (implies (HasType @x6
@x0)

;; def=QuickSort.List.fst(109,22-109,81); use=QuickSort.List.fst(109,22-109,81)
(or label_3
...
@x1
@x4)))
(Prims.op_Addition (QuickSort.List.count @x0
@x6
@x3)
(QuickSort.List.count @x0
@x6
...
;; def=QuickSort.List.fst(109,11-109,82); use=QuickSort.List.fst(109,4-109,10)
(forall ((@x7 Term))
 (! (implies (HasType @x7
@x0)

;; def=QuickSort.List.fst(109,22-109,81); use=QuickSort.List.fst(109,4-109,10)
(= (QuickSort.List.count @x0
@x7
(FStar.List.Tot.Base.op_At @x0
@x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (QuickSort.List.permutation_app_lemma, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_QuickSort.List.count.fuel_instrumented, @fuel_irrelevance_QuickSort.List.count.fuel_instrumented, @query, constructor_distinct_Prims.Cons, data_typing_intro_Prims.Cons@tok, equation_FStar.List.Tot.Base.op_At, equation_Prims.eqtype, equation_Prims.nat, equation_QuickSort.List.is_permutation, equation_with_fuel_QuickSort.List.count.fuel_instrumented, int_inversion, int_typing, lemma_QuickSort.List.append_count, primitive_Prims.op_Addition, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_QuickSort.List.count
...
; encoding sigelt let permutation_app_lemma


; <Start encoding let permutation_app_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun QuickSort.List.permutation_app_lemma (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun QuickSort.List.permutation_app_lemma@tok () Term)

; </end encoding let permutation_app_lemma>


; encoding sigelt val QuickSort.List.quicksort


; <Skipped val QuickSort.List.quicksort/>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name QuickSort.List.sorted_app_lemma; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(73,5-73,27); use=QuickSort.List.fst(78,8-78,24)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_99f7df2863fee377fc834e4ed93b99b6 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_99f7df2863fee377fc834e4ed93b99b6 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_99f7df2863fee377fc834e4ed93b99b6))

:named refinement_kinding_Tm_refine_99f7df2863fee377fc834e4ed93b99b6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name QuickSort.List.sorted_app_lemma; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(73,5-73,27); use=QuickSort.List.fst(78,8-78,24)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_99f7df2863fee377fc834e4ed93b99b6 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
;; def=QuickSort.List.fst(73,15-73,26); use=QuickSort.List.fst(78,8-78,24)
(BoxBool_proj_0 (QuickSort.List.sorted.fuel_instrumented ZFuel
@x2
@x3
@x1))
))
...
(Tm_refine_99f7df2863fee377fc834e4ed93b99b6 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_99f7df2863fee377fc834e4ed93b99b6))

:named refinement_interpretation_Tm_refine_99f7df2863fee377fc834e4ed93b99b6))
;;;;;;;;;;;;;;;;Lemma: QuickSort.List.sorted_app_lemma
;;; Fact-ids: Name QuickSort.List.sorted_app_lemma; Namespace QuickSort.List
...
(QuickSort.List.total_order @x0))
(HasType @x2
(Tm_refine_99f7df2863fee377fc834e4ed93b99b6 @x0
@x1))
(HasType @x3
(Tm_refine_99f7df2863fee377fc834e4ed93b99b6 @x0
@x1))
...
;; def=QuickSort.List.fst(74,21-75,40); use=QuickSort.List.fst(78,8-78,24)
(forall ((@x5 Term))
 (! (implies (HasType @x5
@x0)

;; def=QuickSort.List.fst(74,32-75,39); use=QuickSort.List.fst(78,8-78,24)
(and 
;; def=QuickSort.List.fst(74,32-74,59); use=QuickSort.List.fst(78,8-78,24)
(implies 
;; def=QuickSort.List.fst(74,33-74,41); use=QuickSort.List.fst(78,8-78,24)
...
;; def=QuickSort.List.fst(74,46-74,58); use=QuickSort.List.fst(78,8-78,24)
(not 
;; def=QuickSort.List.fst(74,47-74,58); use=QuickSort.List.fst(78,8-78,24)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x1
@x4)
@x5))
)
...
;; def=QuickSort.List.fst(75,13-75,39); use=QuickSort.List.fst(78,8-78,24)
(implies 
;; def=QuickSort.List.fst(75,14-75,22); use=QuickSort.List.fst(78,8-78,24)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem.fuel_instrumented ZFuel
@x0
@x5
@x3))
...
;; def=QuickSort.List.fst(75,29-75,38); use=QuickSort.List.fst(78,8-78,24)
(BoxBool_proj_0 (ApplyTT (ApplyTT @x1
@x4)
@x5))
)
...
;;no pats
:qid lemma_QuickSort.List.sorted_app_lemma.1))
)

;; def=QuickSort.List.fst(76,19-76,48); use=QuickSort.List.fst(78,8-78,24)
(BoxBool_proj_0 (QuickSort.List.sorted.fuel_instrumented ZFuel
@x0
@x1
(FStar.List.Tot.Base.op_At @x0
...
:pattern ((QuickSort.List.sorted.fuel_instrumented ZFuel
@x0
@x1
(FStar.List.Tot.Base.op_At @x0
@x2
...
@x4
@x3))))
:qid lemma_QuickSort.List.sorted_app_lemma))
:named lemma_QuickSort.List.sorted_app_lemma))
;;;;;;;;;;;;;;;;Lemma: QuickSort.List.partition_lemma
;;; Fact-ids: Name QuickSort.List.partition_lemma; Namespace QuickSort.List
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
(HasType @x2
(Prims.list @x0)))
(let ((@lb3 (QuickSort.List.partition.fuel_instrumented ZFuel
@x0
@x1
@x2)))

;; def=QuickSort.List.fst(62,18-66,73); use=QuickSort.List.fst(68,8-68,23)
(and 
;; def=QuickSort.List.fst(62,18-62,50); use=QuickSort.List.fst(68,8-68,23)
(= (FStar.List.Tot.Base.length.fuel_instrumented ZFuel
@x0
@x2)
...
;; def=QuickSort.List.fst(63,21-64,63); use=QuickSort.List.fst(68,8-68,23)
(forall ((@x4 Term))
 (! (implies (HasType @x4
@x0)

;; def=QuickSort.List.fst(63,46-64,62); use=QuickSort.List.fst(68,8-68,23)
(and 
;; def=QuickSort.List.fst(63,46-63,66); use=QuickSort.List.fst(68,8-68,23)
(implies 
;; def=QuickSort.List.fst(63,47-63,55); use=QuickSort.List.fst(68,8-68,23)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem.fuel_instrumented ZFuel
@x0
@x4
(FStar.Pervasives.Native.Mktuple2__1 @lb3)))
...
;; def=QuickSort.List.fst(63,62-63,65); use=QuickSort.List.fst(68,8-68,23)
(BoxBool_proj_0 (ApplyTT @x1
@x4))
)


;; def=QuickSort.List.fst(64,41-64,62); use=QuickSort.List.fst(68,8-68,23)
(implies 
;; def=QuickSort.List.fst(64,42-64,50); use=QuickSort.List.fst(68,8-68,23)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem.fuel_instrumented ZFuel
@x0
@x4
(FStar.Pervasives.Native.Mktuple2__2 @lb3)))
...
;; def=QuickSort.List.fst(64,55-64,61); use=QuickSort.List.fst(68,8-68,23)
(not 
;; def=QuickSort.List.fst(64,56-64,61); use=QuickSort.List.fst(68,8-68,23)
(BoxBool_proj_0 (ApplyTT @x1
@x4))
)
)
...
:pattern ((ApplyTT @x1
@x4))
:qid lemma_QuickSort.List.partition_lemma.1))


;; def=QuickSort.List.fst(65,21-66,73); use=QuickSort.List.fst(68,8-68,23)
(forall ((@x4 Term))
 (! (implies (HasType @x4
@x0)

;; def=QuickSort.List.fst(66,35-66,72); use=QuickSort.List.fst(68,8-68,23)
(= (QuickSort.List.count.fuel_instrumented ZFuel
@x0
@x4
@x2)
...
@x4
(FStar.Pervasives.Native.Mktuple2__2 @lb3)))
:qid lemma_QuickSort.List.partition_lemma.2))
)
))
 

:pattern ((QuickSort.List.partition.fuel_instrumented ZFuel
@x0
@x1
@x2))
:qid lemma_QuickSort.List.partition_lemma))
:named lemma_QuickSort.List.partition_lemma))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_99f7df2863fee377fc834e4ed93b99b6
;;; Fact-ids: Name QuickSort.List.sorted_app_lemma; Namespace QuickSort.List
(assert (! 
;; def=QuickSort.List.fst(73,5-73,27); use=QuickSort.List.fst(78,8-78,24)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_99f7df2863fee377fc834e4ed93b99b6 @x0
@x1)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_99f7df2863fee377fc834e4ed93b99b6 @x0
@x1))))
:qid haseqTm_refine_99f7df2863fee377fc834e4ed93b99b6))

:named haseqTm_refine_99f7df2863fee377fc834e4ed93b99b6))
(push) ;; push{2

; Starting query at QuickSort.List.fst(115,2-121,5)
...
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))
:named binder_x_374b44ccfcb77ed85d505dbc44265913_2))
(declare-fun Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(111,47-121,5); use=QuickSort.List.fst(111,47-121,5)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27))

:named refinement_kinding_Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(111,47-121,5); use=QuickSort.List.fst(111,47-121,5)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))

;; def=QuickSort.List.fst(115,2-121,5); use=QuickSort.List.fst(115,2-121,5)
...
@x1
(Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27 @x2)))
:qid refinement_interpretation_Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27))

:named refinement_interpretation_Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27))
;;;;;;;;;;;;;;;;haseq for Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(111,47-121,5); use=QuickSort.List.fst(111,47-121,5)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27 @x0)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27 @x0))))
:qid haseqTm_refine_67b21c82f0aa54911a67aaa8a0ff4a27))

:named haseqTm_refine_67b21c82f0aa54911a67aaa8a0ff4a27))
(declare-fun QuickSort.List.quicksort (Term Term Term) Term)

(declare-fun Tm_refine_f2197a43567323f09dd309ac411766df (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(112,6-112,52); use=QuickSort.List.fst(114,8-114,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_f2197a43567323f09dd309ac411766df @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_f2197a43567323f09dd309ac411766df @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_f2197a43567323f09dd309ac411766df))

:named refinement_kinding_Tm_refine_f2197a43567323f09dd309ac411766df))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(112,6-112,52); use=QuickSort.List.fst(114,8-114,17)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f2197a43567323f09dd309ac411766df @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=QuickSort.List.fst(112,16-112,26); use=QuickSort.List.fst(114,8-114,17)
(BoxBool_proj_0 (QuickSort.List.sorted @x2
@x3
@x1))


;; def=QuickSort.List.fst(112,30-112,50); use=QuickSort.List.fst(114,8-114,17)
(Valid 
;; def=QuickSort.List.fst(112,30-112,50); use=QuickSort.List.fst(114,8-114,17)
(QuickSort.List.is_permutation @x2
@x4
@x1)
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_f2197a43567323f09dd309ac411766df))

:named refinement_interpretation_Tm_refine_f2197a43567323f09dd309ac411766df))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f2197a43567323f09dd309ac411766df
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(112,6-112,52); use=QuickSort.List.fst(114,8-114,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f2197a43567323f09dd309ac411766df @x0
@x1
@x2)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f2197a43567323f09dd309ac411766df @x0
@x1
@x2))))
:qid haseqTm_refine_f2197a43567323f09dd309ac411766df))

:named haseqTm_refine_f2197a43567323f09dd309ac411766df))
;;;;;;;;;;;;;;;;f: total_order a -> l: Prims.list a {FStar.List.Tot.Base.length l << FStar.List.Tot.Base.length l}   -> Prims.Tot (m: Prims.list a {sorted f m /\ is_permutation a l m})
(declare-fun Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5
Tm_type)
:named kinding_Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(111,18-121,5); use=QuickSort.List.fst(111,47-121,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5))
:qid QuickSort.List_pre_typing_Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5))

:named QuickSort.List_pre_typing_Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(111,18-121,5); use=QuickSort.List.fst(111,47-121,5)
(forall ((@x0 Term))
...
Prims.eqtype)
(HasType @x2
(QuickSort.List.total_order @x1))
(HasType @x3
(Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27 @x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
@x3)
(Tm_refine_f2197a43567323f09dd309ac411766df @x1
@x2
@x3)))
...
@x2)
@x3))
:qid QuickSort.List_interpretation_Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid QuickSort.List_interpretation_Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5.2))
...
@x1)
@x2))
:qid QuickSort.List_interpretation_Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5))
:qid QuickSort.List_interpretation_Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5))

:named QuickSort.List_interpretation_Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5))
(declare-fun QuickSort.List.quicksort@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(114,8-114,17); use=QuickSort.List.fst(114,8-114,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT QuickSort.List.quicksort@tok
@x0)
@x1)
@x2)
(QuickSort.List.quicksort @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT QuickSort.List.quicksort@tok
@x0)
@x1)
@x2))
:qid token_correspondence_QuickSort.List.quicksort))

:named token_correspondence_QuickSort.List.quicksort))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(114,8-114,17); use=QuickSort.List.fst(114,8-114,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType QuickSort.List.quicksort@tok
Tm_arrow_4ebb8dd6e4cdf3eff1082a03972f26f5))
...
@x2)
@x3)
(QuickSort.List.quicksort @x1
@x2
@x3))
 

:pattern ((QuickSort.List.quicksort @x1
@x2
@x3))
:qid function_token_typing_QuickSort.List.quicksort.1))
)
 

:pattern ((ApplyTT @x0
QuickSort.List.quicksort@tok))
:qid function_token_typing_QuickSort.List.quicksort))

:named function_token_typing_QuickSort.List.quicksort))
...
(QuickSort.List.total_order @x0))
(HasType @x2
(Tm_refine_67b21c82f0aa54911a67aaa8a0ff4a27 @x0)))
(HasType (QuickSort.List.quicksort @x0
@x1
@x2)
(Tm_refine_f2197a43567323f09dd309ac411766df @x0
@x1
@x2)))
 

:pattern ((QuickSort.List.quicksort @x0
@x1
@x2))
:qid typing_QuickSort.List.quicksort))

:named typing_QuickSort.List.quicksort))
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_df7f4cd8c4863ff5493e4cc74e10e016 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_df7f4cd8c4863ff5493e4cc74e10e016
Tm_type)
:named refinement_kinding_Tm_refine_df7f4cd8c4863ff5493e4cc74e10e016))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(112,6-112,52); use=QuickSort.List.fst(115,2-121,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_df7f4cd8c4863ff5493e4cc74e10e016)
(and (HasTypeFuel @u0
@x1
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=QuickSort.List.fst(112,16-112,26); use=QuickSort.List.fst(115,2-121,5)
(BoxBool_proj_0 (QuickSort.List.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x1))


;; def=QuickSort.List.fst(112,30-112,50); use=QuickSort.List.fst(115,2-121,5)
(Valid 
;; def=QuickSort.List.fst(112,30-112,50); use=QuickSort.List.fst(115,2-121,5)
(QuickSort.List.is_permutation x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2
@x1)
)
))
...
@x1
Tm_refine_df7f4cd8c4863ff5493e4cc74e10e016))
:qid refinement_interpretation_Tm_refine_df7f4cd8c4863ff5493e4cc74e10e016))

:named refinement_interpretation_Tm_refine_df7f4cd8c4863ff5493e4cc74e10e016))
;;;;;;;;;;;;;;;;haseq for Tm_refine_df7f4cd8c4863ff5493e4cc74e10e016
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_df7f4cd8c4863ff5493e4cc74e10e016))
(Valid (Prims.hasEq (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))))
:named haseqTm_refine_df7f4cd8c4863ff5493e4cc74e10e016))
(declare-fun Tm_refine_2bec8da86b03ffbb793b976c53fc6163 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(112,6-112,52); use=QuickSort.List.fst(119,12-119,21)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_2bec8da86b03ffbb793b976c53fc6163 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_2bec8da86b03ffbb793b976c53fc6163 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_2bec8da86b03ffbb793b976c53fc6163))

:named refinement_kinding_Tm_refine_2bec8da86b03ffbb793b976c53fc6163))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(112,6-112,52); use=QuickSort.List.fst(119,12-119,21)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_2bec8da86b03ffbb793b976c53fc6163 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=QuickSort.List.fst(112,16-112,26); use=QuickSort.List.fst(119,12-119,21)
(BoxBool_proj_0 (QuickSort.List.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x1))


;; def=QuickSort.List.fst(112,30-112,50); use=QuickSort.List.fst(119,12-119,21)
(Valid 
;; def=QuickSort.List.fst(112,30-112,50); use=QuickSort.List.fst(119,12-119,21)
(QuickSort.List.is_permutation x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
...
@x1
(Tm_refine_2bec8da86b03ffbb793b976c53fc6163 @x2)))
:qid refinement_interpretation_Tm_refine_2bec8da86b03ffbb793b976c53fc6163))

:named refinement_interpretation_Tm_refine_2bec8da86b03ffbb793b976c53fc6163))
;;;;;;;;;;;;;;;;haseq for Tm_refine_2bec8da86b03ffbb793b976c53fc6163
;;; Fact-ids: 
(assert (! 
;; def=QuickSort.List.fst(112,6-112,52); use=QuickSort.List.fst(119,12-119,21)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_2bec8da86b03ffbb793b976c53fc6163 @x0)))
(Valid (Prims.hasEq (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_2bec8da86b03ffbb793b976c53fc6163 @x0))))
:qid haseqTm_refine_2bec8da86b03ffbb793b976c53fc6163))

:named haseqTm_refine_2bec8da86b03ffbb793b976c53fc6163))
...
;   Prims.pure_post (m:
;       Prims.list a {QuickSort.List.sorted f m /\ QuickSort.List.is_permutation a l m})).
;   (forall (x: m: Prims.list a {QuickSort.List.sorted f m /\ QuickSort.List.is_permutation a l m}).
;       {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;   (l == [] ==> QuickSort.List.sorted f [] /\ QuickSort.List.is_permutation a l []) /\
;   (~(Nil? l) ==>
;     (forall (b: a) (b: Prims.list a).
;         l == b :: b ==>
;         (forall (b: Prims.list a) (b: Prims.list a).
;             QuickSort.List.partition (f b) b == (b, b) ==>
;             FStar.List.Tot.Base.length b << FStar.List.Tot.Base.length l /\
;             (forall (any_result: Prims.list a).
;                 b == any_result ==>
;                 (forall (any_result:
;                     m:
;                     Prims.list a {QuickSort.List.sorted f m /\ QuickSort.List.is_permutation a b m})
;                   .
;                     QuickSort.List.quicksort f b == any_result ==>
;                     (forall (return_val:
;                         m:
;                         Prims.list a
;                           {QuickSort.List.sorted f m /\ QuickSort.List.is_permutation a b m}).
;                         return_val == QuickSort.List.quicksort f b ==>
;                         QuickSort.List.quicksort f b == return_val ==>
;                         FStar.List.Tot.Base.length b << FStar.List.Tot.Base.length l /\
;                         (forall (any_result: Prims.list a).
;                             b == any_result ==>
;                             (forall (any_result:
...
;                                     m:
;                                     Prims.list a
;                                       { QuickSort.List.sorted f m /\
;                                         QuickSort.List.is_permutation a b m }).
;                                     return_val == QuickSort.List.quicksort f b ==>
;                                     QuickSort.List.quicksort f b == return_val ==>
;                                     (forall (any_result: Prims.list a).
;                                         b :: QuickSort.List.quicksort f b == any_result ==>
;                                         (forall (any_result: Prims.list a).
;                                             QuickSort.List.quicksort f b @
;                                             b :: QuickSort.List.quicksort f b ==
;                                             any_result ==>
;                                             FStar.List.Tot.Base.length b <<
...
;                                                                 Prims.list a
;                                                                   { QuickSort.List.sorted f m /\
;                                                                     QuickSort.List.is_permutation a
;                                                                       b
;                                                                       m }).
;                                                                 QuickSort.List.quicksort f b ==
;                                                                 any_result ==>
...
;                                                                           a
;                                                                           (b :: b)
;                                                                           (QuickSort.List.quicksort f
;                                                                               b @
;                                                                             b ::
;                                                                             QuickSort.List.quicksort
;                                                                               f
;                                                                               b) ==>
;                                                                         QuickSort.List.sorted f
;                                                                           (QuickSort.List.quicksort f
;                                                                               b @
;                                                                             b ::
;                                                                             QuickSort.List.quicksort
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec quicksort`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Tm_refine_df7f4cd8c4863ff5493e4cc74e10e016))

;; def=Prims.fst(402,27-402,88); use=QuickSort.List.fst(115,2-121,5)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(115,2-121,5)
(Valid 
;; def=Prims.fst(402,84-402,87); use=QuickSort.List.fst(115,2-121,5)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(115,2-121,5)
(and (implies 
;; def=QuickSort.List.fst(114,23-114,24); use=QuickSort.List.fst(115,8-115,9)
(and 
;; def=QuickSort.List.fst(114,23-114,24); use=QuickSort.List.fst(115,8-115,9)
(not 
;; def=QuickSort.List.fst(114,23-114,24); use=QuickSort.List.fst(115,8-115,9)
...
label_1)
(implies 
;; def=QuickSort.List.fst(114,23-116,6); use=QuickSort.List.fst(115,8-116,6)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=QuickSort.List.fst(112,16-112,50); use=QuickSort.List.fst(116,10-116,12)
(and 
;; def=QuickSort.List.fst(112,16-112,26); use=QuickSort.List.fst(116,10-116,12)
(or label_2
...
;; def=QuickSort.List.fst(112,30-112,50); use=QuickSort.List.fst(116,10-116,12)
(or label_3
...
(implies 
;; def=Prims.fst(389,19-389,21); use=QuickSort.List.fst(115,2-121,5)
(not 
;; def=QuickSort.List.fst(114,23-114,24); use=QuickSort.List.fst(115,8-115,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
;; def=Prims.fst(413,99-413,120); use=QuickSort.List.fst(115,2-121,5)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=QuickSort.List.fst(114,23-117,13); use=QuickSort.List.fst(115,8-117,13)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
@x2))
...
;; def=QuickSort.List.fst(118,8-118,14); use=QuickSort.List.fst(118,8-118,14)
(= (QuickSort.List.partition x_9cd1733a5204f989dbb2f01d5984df93_0
(ApplyTT x_fa73c18594d08bb0081d6900c10a3e22_1
@x1)
@x2)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(115,2-121,5)
(and 
;; def=QuickSort.List.fst(115,2-121,5); use=QuickSort.List.fst(119,24-119,26)
(or label_4
...
;; def=Prims.fst(451,66-451,102); use=QuickSort.List.fst(115,2-121,5)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=QuickSort.List.fst(111,47-118,14); use=QuickSort.List.fst(115,2-121,5)
(= @x4
@x5)
)
...
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_2bec8da86b03ffbb793b976c53fc6163 @x4))

;; def=QuickSort.List.fst(112,6-119,26); use=QuickSort.List.fst(115,2-121,5)
(= (QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x4)
@x6)
)

;; def=Prims.fst(356,2-356,58); use=QuickSort.List.fst(115,2-121,5)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Tm_refine_2bec8da86b03ffbb793b976c53fc6163 @x4))

;; def=Prims.fst(356,26-356,41); use=QuickSort.List.fst(115,2-121,5)
(= @x7
(QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x4))
...
;; def=FStar.List.Tot.Base.fst(124,10-124,11); use=QuickSort.List.fst(115,2-121,5)
(= (QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x4)
@x7)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(115,2-121,5)
(and 
;; def=QuickSort.List.fst(115,2-121,5); use=QuickSort.List.fst(119,50-119,52)
(or label_5
...
;; def=QuickSort.List.fst(111,47-118,10); use=QuickSort.List.fst(115,2-121,5)
(= @x3
@x8)
)
...
(Tm_refine_2bec8da86b03ffbb793b976c53fc6163 @x3))

;; def=QuickSort.List.fst(112,6-119,52); use=QuickSort.List.fst(115,2-121,5)
(= (QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x3)
@x9)
...
;; def=Prims.fst(616,20-616,22); use=QuickSort.List.fst(115,2-121,5)
(= (QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x3)
@x10)
...
;; def=FStar.List.Tot.Base.fst(124,12-124,13); use=QuickSort.List.fst(115,2-121,5)
(= (Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
(QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
...
;; def=QuickSort.List.fst(119,8-119,52); use=QuickSort.List.fst(119,8-119,52)
(= (FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
(QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x4)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(115,2-121,5)
(and 
;; def=QuickSort.List.fst(115,2-121,5); use=QuickSort.List.fst(120,48-120,50)
(or label_6
...
;; def=QuickSort.List.fst(112,6-120,51); use=QuickSort.List.fst(115,2-121,5)
(= (QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x4)
@x14)
...
;; def=QuickSort.List.fst(96,27-120,51); use=QuickSort.List.fst(115,2-121,5)
(= (QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x4)
@x15)
...
;; def=Prims.fst(459,77-459,89); use=QuickSort.List.fst(115,2-121,5)
(and 
;; def=QuickSort.List.fst(115,2-121,5); use=QuickSort.List.fst(120,65-120,67)
(or label_7
...
;; def=QuickSort.List.fst(112,6-120,68); use=QuickSort.List.fst(115,2-121,5)
(= (QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x3)
@x17)
...
;; def=QuickSort.List.fst(96,39-120,68); use=QuickSort.List.fst(115,2-121,5)
(= (QuickSort.List.quicksort x_9cd1733a5204f989dbb2f01d5984df93_0
x_fa73c18594d08bb0081d6900c10a3e22_1
@x3)
@x18)
...
;; def=Prims.fst(441,29-441,97); use=QuickSort.List.fst(120,4-120,25)
(and 
;; def=QuickSort.List.fst(97,21-97,52); use=QuickSort.List.fst(120,4-120,25)
(or label_8
...
;; def=Prims.fst(441,36-441,97); use=QuickSort.List.fst(120,4-120,25)
(forall ((@x19 Term))
 (! (implies (and (HasType @x19
Prims.unit)

;; def=QuickSort.List.fst(98,20-98,63); use=QuickSort.List.fst(120,4-120,25)
(Valid 
;; def=QuickSort.List.fst(98,20-98,63); use=QuickSort.List.fst(120,4-120,25)
(QuickSort.List.is_permutation x_9cd1733a5204f989dbb2f01d5984df93_0
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=QuickSort.List.fst(112,16-112,50); use=QuickSort.List.fst(121,4-121,5)
(and 
;; def=QuickSort.List.fst(112,16-112,26); use=QuickSort.List.fst(121,4-121,5)
(or label_9
...
;; def=QuickSort.List.fst(112,30-112,50); use=QuickSort.List.fst(121,4-121,5)
(or label_10
