...
; Internals for MergeSort


; encoding sigelt let split_inv


; <Start encoding let split_inv>

(declare-fun MergeSort.split_inv (Term Term Term) Term)

(declare-fun MergeSort.split_inv@tok () Term)

; </end encoding let split_inv>


; encoding sigelt val MergeSort.split


; <Skipped val MergeSort.split/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MergeSort.split_inv; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(20,5-20,14); use=MergeSort.fst(20,5-20,14)
...
(HasType @x2
(Prims.list Prims.int)))
(HasType (MergeSort.split_inv @x0
@x1
@x2)
Prims.logical))
 

:pattern ((MergeSort.split_inv @x0
@x1
@x2))
:qid typing_MergeSort.split_inv))

:named typing_MergeSort.split_inv))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name IntSort.permutation_2; Namespace IntSort
(assert (! 
;; def=IntSort.fst(48,5-48,18); use=IntSort.fst(48,5-48,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(Prims.list Prims.int))
(HasType @x1
...
(HasType @x2
(Prims.list Prims.int)))
(HasType (IntSort.permutation_2 @x0
@x1
@x2)
Prims.logical))
 

:pattern ((IntSort.permutation_2 @x0
@x1
@x2))
:qid typing_IntSort.permutation_2))

:named typing_IntSort.permutation_2))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Equation for MergeSort.split_inv
;;; Fact-ids: Name MergeSort.split_inv; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(20,5-20,14); use=MergeSort.fst(20,5-20,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (MergeSort.split_inv @x0
@x1
@x2))

;; def=MergeSort.fst(21,4-23,48); use=MergeSort.fst(21,4-23,48)
(and 
;; def=MergeSort.fst(21,4-21,25); use=MergeSort.fst(21,4-21,25)
(Valid 
;; def=MergeSort.fst(21,4-21,25); use=MergeSort.fst(21,4-21,25)
(IntSort.permutation_2 @x0
@x1
@x2)
)


;; def=MergeSort.fst(23,4-23,24); use=MergeSort.fst(23,4-23,24)
(> (BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.int
@x0))
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.int
@x1)))


;; def=MergeSort.fst(23,28-23,48); use=MergeSort.fst(23,28-23,48)
(> (BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.int
@x0))
(BoxInt_proj_0 (FStar.List.Tot.Base.length Prims.int
@x2)))
...
@x1
@x2))
:qid equation_MergeSort.split_inv))

:named equation_MergeSort.split_inv))
;;;;;;;;;;;;;;;;Equation for IntSort.permutation_2
;;; Fact-ids: Name IntSort.permutation_2; Namespace IntSort
(assert (! 
;; def=IntSort.fst(48,5-48,18); use=IntSort.fst(48,5-48,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (IntSort.permutation_2 @x0
@x1
@x2))

;; def=IntSort.fst(49,4-50,36); use=IntSort.fst(49,4-50,36)
(and 
;; def=IntSort.fst(49,4-49,48); use=IntSort.fst(49,4-49,48)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.int)

;; def=IntSort.fst(49,15-49,47); use=IntSort.fst(49,15-49,47)
(= (FStar.List.Tot.Base.mem Prims.int
@x3
@x0)
(Prims.op_BarBar (FStar.List.Tot.Base.mem Prims.int
@x3
@x1)
(FStar.List.Tot.Base.mem Prims.int
@x3
...
;;no pats
:qid equation_IntSort.permutation_2.1))


;; def=IntSort.fst(50,4-50,36); use=IntSort.fst(50,4-50,36)
(= (FStar.List.Tot.Base.length Prims.int
@x0)
(Prims.op_Addition (FStar.List.Tot.Base.length Prims.int
@x1)
(FStar.List.Tot.Base.length Prims.int
@x2)))
)
...
@x1
@x2))
:qid equation_IntSort.permutation_2))

:named equation_IntSort.permutation_2))
...
;;;;;;;;;;;;;;;;Prop-typing for MergeSort.split_inv
;;; Fact-ids: Name MergeSort.split_inv; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(20,5-20,14); use=MergeSort.fst(20,5-20,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Prims.list Prims.int)))
(Valid (Prims.subtype_of (MergeSort.split_inv @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (MergeSort.split_inv @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_MergeSort.split_inv))

:named defn_equation_MergeSort.split_inv))
;;;;;;;;;;;;;;;;Prop-typing for IntSort.permutation_2
;;; Fact-ids: Name IntSort.permutation_2; Namespace IntSort
(assert (! 
;; def=IntSort.fst(48,5-48,18); use=IntSort.fst(48,5-48,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Prims.list Prims.int)))
(Valid (Prims.subtype_of (IntSort.permutation_2 @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (IntSort.permutation_2 @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_IntSort.permutation_2))

:named defn_equation_IntSort.permutation_2))
...
; Starting query at MergeSort.fst(29,2-33,23)
...
(declare-fun Tm_refine_35d57aac03ce60db5b24ab0579f77cc1 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_35d57aac03ce60db5b24ab0579f77cc1
Tm_type)
:named refinement_kinding_Tm_refine_35d57aac03ce60db5b24ab0579f77cc1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(25,11-33,23); use=MergeSort.fst(25,11-33,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_35d57aac03ce60db5b24ab0579f77cc1)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=MergeSort.fst(29,2-33,23); use=MergeSort.fst(29,2-33,23)
...
@x1
Tm_refine_35d57aac03ce60db5b24ab0579f77cc1))
:qid refinement_interpretation_Tm_refine_35d57aac03ce60db5b24ab0579f77cc1))

:named refinement_interpretation_Tm_refine_35d57aac03ce60db5b24ab0579f77cc1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_35d57aac03ce60db5b24ab0579f77cc1
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_35d57aac03ce60db5b24ab0579f77cc1))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_35d57aac03ce60db5b24ab0579f77cc1))
(declare-fun MergeSort.split (Term) Term)

(declare-fun Tm_refine_48bc63e029480d3d2e316caa63dd5bbb (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(25,30-25,51); use=MergeSort.fst(28,8-28,13)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_48bc63e029480d3d2e316caa63dd5bbb @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_48bc63e029480d3d2e316caa63dd5bbb @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_48bc63e029480d3d2e316caa63dd5bbb))

:named refinement_kinding_Tm_refine_48bc63e029480d3d2e316caa63dd5bbb))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(25,30-25,51); use=MergeSort.fst(28,8-28,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_48bc63e029480d3d2e316caa63dd5bbb @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (Prims.list Prims.int)
(Prims.list Prims.int)))

;; def=MergeSort.fst(27,25-27,52); use=MergeSort.fst(28,8-28,13)
(Valid 
;; def=MergeSort.fst(27,25-27,52); use=MergeSort.fst(28,8-28,13)
(MergeSort.split_inv @x2
(FStar.Pervasives.Native.fst (Prims.list Prims.int)
(Prims.list Prims.int)
@x1)
(FStar.Pervasives.Native.snd (Prims.list Prims.int)
(Prims.list Prims.int)
@x1))
)
))
...
@x1
(Tm_refine_48bc63e029480d3d2e316caa63dd5bbb @x2)))
:qid refinement_interpretation_Tm_refine_48bc63e029480d3d2e316caa63dd5bbb))

:named refinement_interpretation_Tm_refine_48bc63e029480d3d2e316caa63dd5bbb))
;;;;;;;;;;;;;;;;haseq for Tm_refine_48bc63e029480d3d2e316caa63dd5bbb
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(25,30-25,51); use=MergeSort.fst(28,8-28,13)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_48bc63e029480d3d2e316caa63dd5bbb @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (Prims.list Prims.int)
(Prims.list Prims.int)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_48bc63e029480d3d2e316caa63dd5bbb @x0))))
:qid haseqTm_refine_48bc63e029480d3d2e316caa63dd5bbb))

:named haseqTm_refine_48bc63e029480d3d2e316caa63dd5bbb))
;;;;;;;;;;;;;;;;l: Prims.list Prims.int {l << _} -> Prims.Pure (Prims.list Prims.int & Prims.list Prims.int)
(declare-fun Tm_arrow_664098a8ae3aa71ee3e75d118eadc362 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_664098a8ae3aa71ee3e75d118eadc362
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_664098a8ae3aa71ee3e75d118eadc362
Tm_type)
:named kinding_Tm_arrow_664098a8ae3aa71ee3e75d118eadc362))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(25,11-33,23); use=MergeSort.fst(25,11-33,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_664098a8ae3aa71ee3e75d118eadc362)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_664098a8ae3aa71ee3e75d118eadc362))
:qid MergeSort_pre_typing_Tm_arrow_664098a8ae3aa71ee3e75d118eadc362))

:named MergeSort_pre_typing_Tm_arrow_664098a8ae3aa71ee3e75d118eadc362))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_664098a8ae3aa71ee3e75d118eadc362
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(25,11-33,23); use=MergeSort.fst(25,11-33,23)
(forall ((@x0 Term))
...
(forall ((@x1 Term))
 (! (implies (and 
;; def=MergeSort.fst(26,24-26,31); use=MergeSort.fst(28,8-28,13)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x1))


;; def=MergeSort.fst(26,35-26,53); use=MergeSort.fst(28,8-28,13)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
(Prims.__proj__Cons__item__tl Prims.int
@x1)))
...
(HasType (ApplyTT @x0
@x1)
(Tm_refine_48bc63e029480d3d2e316caa63dd5bbb @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid MergeSort_interpretation_Tm_arrow_664098a8ae3aa71ee3e75d118eadc362.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_664098a8ae3aa71ee3e75d118eadc362))
:qid MergeSort_interpretation_Tm_arrow_664098a8ae3aa71ee3e75d118eadc362))

:named MergeSort_interpretation_Tm_arrow_664098a8ae3aa71ee3e75d118eadc362))
(declare-fun MergeSort.split@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(28,8-28,13); use=MergeSort.fst(28,8-28,13)
(forall ((@x0 Term))
 (! (= (ApplyTT MergeSort.split@tok
@x0)
(MergeSort.split @x0))
 

:pattern ((ApplyTT MergeSort.split@tok
@x0))
:qid token_correspondence_MergeSort.split))

:named token_correspondence_MergeSort.split))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(28,8-28,13); use=MergeSort.fst(28,8-28,13)
...
:pattern ((MergeSort.split @x1))
:qid function_token_typing_MergeSort.split.1))
)
 

:pattern ((ApplyTT @x0
MergeSort.split@tok))
:qid function_token_typing_MergeSort.split))

:named function_token_typing_MergeSort.split))
...
(HasType @x0
Tm_refine_35d57aac03ce60db5b24ab0579f77cc1))
(HasType (MergeSort.split @x0)
(Tm_refine_48bc63e029480d3d2e316caa63dd5bbb @x0)))
 

:pattern ((MergeSort.split @x0))
:qid typing_MergeSort.split))

:named typing_MergeSort.split))
...
; Encoding query formula : forall (p: Prims.pure_post (Prims.list Prims.int & Prims.list Prims.int)).
;   Cons? _ /\ Cons? _.tl /\
;   (forall (pure_result: Prims.list Prims.int & Prims.list Prims.int).
;       MergeSort.split_inv _
;         (FStar.Pervasives.Native.fst pure_result)
;         (FStar.Pervasives.Native.snd pure_result) ==>
;       p pure_result) ==>
;   (~(Cons? _ && Cons? _.tl) ==> Prims.l_False) /\
;   (forall (b: Prims.int) (b: Prims.int) (b: Prims.list Prims.int).
;       _ == b :: b :: b ==>
;       (forall (k: Prims.pure_post (Prims.list Prims.int & Prims.list Prims.int)).
;           (forall (x: Prims.list Prims.int & Prims.list Prims.int).
...
;                     | [x'] -> [x; x'], [y]
;                     | _ ->
;                       (let l1, l2 = MergeSort.split l in
;                         x :: l1, y :: l2)
;                       <:
;                       Prims.list Prims.int & Prims.list Prims.int)
;                   <:
;                   Prims.list Prims.int & Prims.list Prims.int) ==>
;                 (forall (return_val: Prims.list Prims.int & Prims.list Prims.int).
;                     return_val == x ==> p return_val)) ==>
;               k x) ==>
;           (b == [] ==>
;             (forall (any_result: Prims.list Prims.int & Prims.list Prims.int). k any_result)) /\
;           (~(Nil? b) ==>
;             (forall (b: Prims.int).
;                 b == [b] ==>
;                 (forall (any_result: Prims.list Prims.int & Prims.list Prims.int). k any_result)) /\
;             (~(Cons? b && Nil? b.tl) ==>
;               (forall (b: Prims.list Prims.int).
;                   b == b ==>
;                   b << _ /\
...
;                       Cons? b /\ Cons? b.tl /\
;                       (forall (pure_result: Prims.list Prims.int & Prims.list Prims.int).
;                           MergeSort.split_inv b
;                             (FStar.Pervasives.Native.fst pure_result)
;                             (FStar.Pervasives.Native.snd pure_result) ==>
;                           MergeSort.split b == pure_result ==>
;                           (forall (b: Prims.list Prims.int) (b: Prims.list Prims.int).
;                               MergeSort.split b == (b, b) ==>
;                               (forall (any_result: Prims.list Prims.int & Prims.list Prims.int).
;                                   k any_result)))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec split`
...
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (Prims.list Prims.int)
(Prims.list Prims.int))))

;; def=MergeSort.fst(26,24-26,31); use=MergeSort.fst(29,2-33,23)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
x_66b03f5c7897b05649fed8196554c587_0))


;; def=MergeSort.fst(26,35-26,53); use=MergeSort.fst(29,2-33,23)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
(Prims.__proj__Cons__item__tl Prims.int
x_66b03f5c7897b05649fed8196554c587_0)))


;; def=Prims.fst(441,36-441,97); use=MergeSort.fst(29,2-33,23)
(forall ((@x1 Term))
...
;; def=MergeSort.fst(27,25-27,52); use=MergeSort.fst(29,2-33,23)
(or label_2

;; def=MergeSort.fst(27,25-27,52); use=MergeSort.fst(29,2-33,23)
(Valid 
;; def=MergeSort.fst(27,25-27,52); use=MergeSort.fst(29,2-33,23)
(MergeSort.split_inv x_66b03f5c7897b05649fed8196554c587_0
(FStar.Pervasives.Native.fst (Prims.list Prims.int)
(Prims.list Prims.int)
@x1)
(FStar.Pervasives.Native.snd (Prims.list Prims.int)
...
;; def=Prims.fst(441,83-441,96); use=MergeSort.fst(29,2-33,23)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort.fst(29,2-33,23)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(29,2-33,23)
(and (implies 
;; def=MergeSort.fst(29,2-33,23); use=MergeSort.fst(29,2-33,23)
(not 
;; def=MergeSort.fst(29,2-33,23); use=MergeSort.fst(29,2-33,23)
...
;; def=Prims.fst(413,99-413,120); use=MergeSort.fst(29,2-33,23)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=MergeSort.fst(28,15-28,22); use=MergeSort.fst(29,2-33,23)
(= x_66b03f5c7897b05649fed8196554c587_0
(Prims.Cons Prims.int
@x1
(Prims.Cons Prims.int
...
;; def=Prims.fst(402,2-402,97); use=MergeSort.fst(29,2-33,23)
(forall ((@x4 Term))
...
(forall ((@x5 Term))
 (! (implies (implies 
;; def=MergeSort.fst(25,30-33,23); use=MergeSort.fst(29,2-33,23)
(= @x5
(let ((@lb6 x_66b03f5c7897b05649fed8196554c587_0))
(ite (and (is-Prims.Cons @lb6)
(is-Prims.Cons (Prims.Cons_tl @lb6)))
(let ((@lb7 (Prims.Cons_tl (Prims.Cons_tl @lb6))))
...
(Prims.Nil Prims.int))
(Prims.Cons Prims.int
(Prims.Cons_hd (Prims.Cons_tl @lb6))
(Prims.Nil Prims.int)))
(ite (and (is-Prims.Cons @lb7)
(is-Prims.Nil (Prims.Cons_tl @lb7)))
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
(Prims.Cons Prims.int
(Prims.Cons_hd @lb6)
...
(Prims.Cons_hd (Prims.Cons_tl @lb6))
(Prims.Nil Prims.int)))
(let ((@lb8 (MergeSort.split (Prims.Cons_tl (Prims.Cons_tl @lb6)))))
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
(Prims.Cons Prims.int
(Prims.Cons_hd @lb6)
...
;; def=Prims.fst(402,84-402,87); use=MergeSort.fst(29,2-33,23)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort.fst(29,2-33,23)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort.fst(29,2-33,23)
(and (implies 
;; def=MergeSort.fst(28,21-30,8); use=MergeSort.fst(29,8-30,8)
(= @x3
(Prims.Nil Prims.int))


;; def=Prims.fst(451,66-451,102); use=MergeSort.fst(29,2-33,23)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(FStar.Pervasives.Native.tuple2 (Prims.list Prims.int)
(Prims.list Prims.int)))

;; def=Prims.fst(451,90-451,102); use=MergeSort.fst(29,2-33,23)
(Valid 
;; def=Prims.fst(451,90-451,102); use=MergeSort.fst(29,2-33,23)
(ApplyTT @x4
@x5)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MergeSort.fst(29,2-33,23)
(not 
;; def=MergeSort.fst(28,21-28,22); use=MergeSort.fst(29,8-29,9)
...
;; def=MergeSort.fst(28,21-31,10); use=MergeSort.fst(29,8-31,10)
(= @x3
(Prims.Cons Prims.int
@x5
(Prims.Nil Prims.int)))
...
;; def=MergeSort.fst(28,21-32,7); use=MergeSort.fst(29,8-32,7)
(= @x3
@x5)
)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(29,2-33,23)
(and 
;; def=MergeSort.fst(29,2-33,23); use=MergeSort.fst(32,30-32,31)
(or label_4
...
;; def=MergeSort.fst(25,11-28,22); use=MergeSort.fst(29,2-33,23)
(= @x3
@x6)
)

;; def=Prims.fst(441,29-441,97); use=MergeSort.fst(32,24-32,29)
(and 
;; def=MergeSort.fst(26,24-26,31); use=MergeSort.fst(32,24-32,29)
(or label_5
...
;; def=MergeSort.fst(26,35-26,53); use=MergeSort.fst(32,24-32,29)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=MergeSort.fst(32,24-32,29)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.Pervasives.Native.tuple2 (Prims.list Prims.int)
(Prims.list Prims.int)))

;; def=MergeSort.fst(27,25-27,52); use=MergeSort.fst(32,24-32,29)
(Valid 
;; def=MergeSort.fst(27,25-27,52); use=MergeSort.fst(32,24-32,29)
(MergeSort.split_inv @x3
(FStar.Pervasives.Native.fst (Prims.list Prims.int)
(Prims.list Prims.int)
@x7)
(FStar.Pervasives.Native.snd (Prims.list Prims.int)
...
;; def=MergeSort.fst(32,15-32,31); use=MergeSort.fst(32,15-32,31)
(= (MergeSort.split @x3)
@x7)
)
...
;; def=MergeSort.fst(32,15-32,21); use=MergeSort.fst(32,15-32,21)
(= (MergeSort.split @x3)
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
@x8
...
; Starting query at MergeSort.fst(28,0-33,23)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_612501cc5bc612f1ff316ed4fa496902 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(25,11-33,23); use=MergeSort.fst(28,0-33,23)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_612501cc5bc612f1ff316ed4fa496902 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_612501cc5bc612f1ff316ed4fa496902 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_612501cc5bc612f1ff316ed4fa496902))

:named refinement_kinding_Tm_refine_612501cc5bc612f1ff316ed4fa496902))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(25,11-33,23); use=MergeSort.fst(28,0-33,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_612501cc5bc612f1ff316ed4fa496902 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))
...
@x1
(Tm_refine_612501cc5bc612f1ff316ed4fa496902 @x2)))
:qid refinement_interpretation_Tm_refine_612501cc5bc612f1ff316ed4fa496902))

:named refinement_interpretation_Tm_refine_612501cc5bc612f1ff316ed4fa496902))
;;;;;;;;;;;;;;;;haseq for Tm_refine_612501cc5bc612f1ff316ed4fa496902
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(25,11-33,23); use=MergeSort.fst(28,0-33,23)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_612501cc5bc612f1ff316ed4fa496902 @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_612501cc5bc612f1ff316ed4fa496902 @x0))))
:qid haseqTm_refine_612501cc5bc612f1ff316ed4fa496902))

:named haseqTm_refine_612501cc5bc612f1ff316ed4fa496902))

; Encoding query formula : forall (_: Prims.list Prims.int) (l: Prims.list Prims.int {l << _}).
;   (Cons? l ==> l << _ ==> Cons? l) /\
;   (forall (any_result: Prims.logical).
;       Cons? l /\ Cons? l.tl == any_result ==>
;       (forall (_: Prims.list Prims.int & Prims.list Prims.int). Cons? l ==> l << _ ==> Cons? l))
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=MergeSort.fst(28,0-33,23)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(Prims.list Prims.int))
(HasType @x1
(Tm_refine_612501cc5bc612f1ff316ed4fa496902 @x0)))

;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(28,0-33,23)
(and (implies (and 
;; def=MergeSort.fst(26,24-26,31); use=MergeSort.fst(28,8-28,13)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x1))
...
;; def=MergeSort.fst(29,2-33,23); use=MergeSort.fst(28,8-28,13)
...
;; def=Prims.fst(616,4-616,8); use=MergeSort.fst(26,51-26,52)
(or label_1

;; def=Prims.fst(616,4-616,8); use=MergeSort.fst(28,8-28,13)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x1))
)
)

;; def=Prims.fst(451,66-451,102); use=MergeSort.fst(28,0-33,23)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.logical)

;; def=Prims.fst(439,23-439,26); use=MergeSort.fst(28,0-33,23)
(= (Prims.l_and (Prims.b2t (Prims.uu___is_Cons Prims.int
@x1))
(Prims.b2t (Prims.uu___is_Cons Prims.int
(Prims.__proj__Cons__item__tl Prims.int
@x1))))
@x2)
)
...
; encoding sigelt let rec split


; <Start encoding let rec split>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun MergeSort.split.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun MergeSort.split.fuel_instrumented_token () Term)
(declare-fun MergeSort.split (Term) Term)
(declare-fun MergeSort.split@tok () Term)
(declare-fun Tm_refine_48bc63e029480d3d2e316caa63dd5bbb (Term) Term)

;;;;;;;;;;;;;;;;l: Prims.list Prims.int -> Prims.Pure (Prims.list Prims.int & Prims.list Prims.int)
(declare-fun Tm_arrow_41ba938ffa1e07f06f25c23dfdd1a79a () Term)
...
; Starting query at MergeSort.fst(38,4-40,34)
...
; Encoding query formula : forall (l1: Prims.list Prims.int) (l2: Prims.list Prims.int) (l: Prims.list Prims.int).
;   (*  - Could not prove post-condition
; *)
;   (Cons? l1 /\ Cons? l ==>
;     Cons? l1 /\
;     (forall (any_result: Prims.list Prims.int).
;         l1 == any_result ==> (forall (any_result: Prims.int). l1.hd == any_result ==> Cons? l))) /\
;   (~(Cons? l1 /\ Cons? l /\ l1.hd = l.hd) ==>
;     Cons? l2 /\ Cons? l ==>
;     Cons? l2 /\
;     (forall (any_result: Prims.list Prims.int).
;         l2 == any_result ==> (forall (any_result: Prims.int). l2.hd == any_result ==> Cons? l)))


; Context: While encoding a query
; While typechecking the top-level declaration `let merge_inv`
...
;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(38,4-39,53)
(and (implies 
;; def=MergeSort.fst(38,5-38,24); use=MergeSort.fst(38,5-38,24)
(and 
;; def=MergeSort.fst(38,5-38,13); use=MergeSort.fst(38,5-38,13)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x0))


;; def=MergeSort.fst(38,17-38,24); use=MergeSort.fst(38,17-38,24)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x2))
)


;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(38,4-38,53)
(and 
;; def=Prims.fst(616,4-616,8); use=MergeSort.fst(38,37-38,39)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=MergeSort.fst(38,4-38,53)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.list Prims.int))

;; def=Prims.fst(616,4-616,8); use=MergeSort.fst(38,4-38,53)
(= @x0
@x3)
)
...
;; def=dummy(0,0-0,0); use=MergeSort.fst(38,4-38,53)
(= (Prims.__proj__Cons__item__hd Prims.int
@x0)
@x4)
)

;; def=Prims.fst(616,4-616,8); use=MergeSort.fst(38,51-38,52)
(or label_2
...
;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(38,4-39,53)
(and 
;; def=MergeSort.fst(38,4-38,53); use=MergeSort.fst(38,4-38,53)
(not 
;; def=MergeSort.fst(38,4-38,53); use=MergeSort.fst(38,4-38,53)
(and 
;; def=MergeSort.fst(38,5-38,13); use=MergeSort.fst(38,5-38,13)
...
;; def=MergeSort.fst(38,28-38,52); use=MergeSort.fst(38,28-38,52)
(= (Prims.__proj__Cons__item__hd Prims.int
@x0)
(Prims.__proj__Cons__item__hd Prims.int
@x2))
...
;; def=MergeSort.fst(39,5-39,13); use=MergeSort.fst(39,5-39,13)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x1))


;; def=MergeSort.fst(39,17-39,24); use=MergeSort.fst(39,17-39,24)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x2))
)


;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(39,4-39,53)
(and 
;; def=Prims.fst(616,4-616,8); use=MergeSort.fst(39,37-39,39)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=MergeSort.fst(39,4-39,53)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.list Prims.int))

;; def=Prims.fst(616,4-616,8); use=MergeSort.fst(39,4-39,53)
(= @x1
@x3)
)
...
;; def=dummy(0,0-0,0); use=MergeSort.fst(39,4-39,53)
(= (Prims.__proj__Cons__item__hd Prims.int
@x1)
@x4)
)

;; def=Prims.fst(616,4-616,8); use=MergeSort.fst(39,51-39,52)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MergeSort.merge_inv, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt let merge_inv


; <Start encoding let merge_inv>

(declare-fun MergeSort.merge_inv (Term Term Term) Term)

(declare-fun MergeSort.merge_inv@tok () Term)

; </end encoding let merge_inv>


; encoding sigelt val MergeSort.merge


; <Skipped val MergeSort.merge/>


; encoding sigelt #set-options "--z3rlimit 10"


; <Skipped #set-options "--z3rlimit 10"/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MergeSort.merge_inv; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(37,5-37,14); use=MergeSort.fst(37,5-37,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(Prims.list Prims.int))
(HasType @x1
...
(HasType @x2
(Prims.list Prims.int)))
(HasType (MergeSort.merge_inv @x0
@x1
@x2)
Prims.logical))
 

:pattern ((MergeSort.merge_inv @x0
@x1
@x2))
:qid typing_MergeSort.merge_inv))

:named typing_MergeSort.merge_inv))
...
;;;;;;;;;;;;;;;;Equation for MergeSort.merge_inv
;;; Fact-ids: Name MergeSort.merge_inv; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(37,5-37,14); use=MergeSort.fst(37,5-37,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (MergeSort.merge_inv @x0
@x1
@x2))

;; def=MergeSort.fst(38,4-40,34); use=MergeSort.fst(38,4-40,34)
(or 
;; def=MergeSort.fst(38,4-38,53); use=MergeSort.fst(38,4-38,53)
(and 
;; def=MergeSort.fst(38,5-38,13); use=MergeSort.fst(38,5-38,13)
...
;; def=MergeSort.fst(39,4-39,53); use=MergeSort.fst(39,4-39,53)
(and 
;; def=MergeSort.fst(39,5-39,13); use=MergeSort.fst(39,5-39,13)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x1))
...
;; def=MergeSort.fst(39,28-39,52); use=MergeSort.fst(39,28-39,52)
(= (Prims.__proj__Cons__item__hd Prims.int
@x1)
(Prims.__proj__Cons__item__hd Prims.int
@x2))
...
;; def=MergeSort.fst(40,4-40,34); use=MergeSort.fst(40,4-40,34)
(and 
;; def=MergeSort.fst(40,5-40,12); use=MergeSort.fst(40,5-40,12)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
@x0))


;; def=MergeSort.fst(40,16-40,23); use=MergeSort.fst(40,16-40,23)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
@x1))


;; def=MergeSort.fst(40,27-40,33); use=MergeSort.fst(40,27-40,33)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
@x2))
)
)
...
@x1
@x2))
:qid equation_MergeSort.merge_inv))

:named equation_MergeSort.merge_inv))
...
;;;;;;;;;;;;;;;;Prop-typing for MergeSort.merge_inv
;;; Fact-ids: Name MergeSort.merge_inv; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(37,5-37,14); use=MergeSort.fst(37,5-37,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Prims.list Prims.int)))
(Valid (Prims.subtype_of (MergeSort.merge_inv @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (MergeSort.merge_inv @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_MergeSort.merge_inv))

:named defn_equation_MergeSort.merge_inv))
(push) ;; push{2

; Starting query at MergeSort.fst(47,22-52,47)

;;;;;;;;;;;;;;;;l1 : Prims.list Prims.int (Prims.list Prims.int)
(declare-fun x_66b03f5c7897b05649fed8196554c587_0 () Term)
;;;;;;;;;;;;;;;;binder_x_66b03f5c7897b05649fed8196554c587_0
;;; Fact-ids: 
(assert (! (HasType x_66b03f5c7897b05649fed8196554c587_0
(Prims.list Prims.int))
:named binder_x_66b03f5c7897b05649fed8196554c587_0))
;;;;;;;;;;;;;;;;l2 : Prims.list Prims.int (Prims.list Prims.int)
...
(declare-fun Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(42,11-52,47); use=MergeSort.fst(42,11-52,47)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6))

:named refinement_kinding_Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(42,11-52,47); use=MergeSort.fst(42,11-52,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))
...
;; def=MergeSort.fst(42,11-52,47); use=MergeSort.fst(42,11-52,47)
(or 
;; def=MergeSort.fst(47,22-52,47); use=MergeSort.fst(47,22-52,47)
(Valid 
;; def=MergeSort.fst(47,22-52,47); use=MergeSort.fst(47,22-52,47)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=MergeSort.fst(42,11-52,47); use=MergeSort.fst(42,11-52,47)
(and 
;; def=MergeSort.fst(42,11-47,16); use=MergeSort.fst(42,11-47,16)
(Valid 
;; def=MergeSort.fst(42,11-47,16); use=MergeSort.fst(42,11-47,16)
...
@x1
(Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6 @x2)))
:qid refinement_interpretation_Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6))

:named refinement_interpretation_Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(42,11-52,47); use=MergeSort.fst(42,11-52,47)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6 @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6 @x0))))
:qid haseqTm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6))

:named haseqTm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6))
(declare-fun MergeSort.merge (Term Term) Term)

(declare-fun Tm_refine_e2547a65943c734e2839d0ebba2b81f2 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(42,46-42,56); use=MergeSort.fst(47,8-47,13)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_e2547a65943c734e2839d0ebba2b81f2 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_e2547a65943c734e2839d0ebba2b81f2 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_e2547a65943c734e2839d0ebba2b81f2))

:named refinement_kinding_Tm_refine_e2547a65943c734e2839d0ebba2b81f2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(42,46-42,56); use=MergeSort.fst(47,8-47,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e2547a65943c734e2839d0ebba2b81f2 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=MergeSort.fst(44,32-44,40); use=MergeSort.fst(47,8-47,13)
(BoxBool_proj_0 (IntSort.sorted @x1))


;; def=MergeSort.fst(44,44-44,65); use=MergeSort.fst(47,8-47,13)
(Valid 
;; def=MergeSort.fst(44,44-44,65); use=MergeSort.fst(47,8-47,13)
(IntSort.permutation_2 @x1
@x2
@x3)
)


;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(47,8-47,13)
(Valid 
;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(47,8-47,13)
(MergeSort.merge_inv @x2
@x3
@x1)
)
))
...
(Tm_refine_e2547a65943c734e2839d0ebba2b81f2 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_e2547a65943c734e2839d0ebba2b81f2))

:named refinement_interpretation_Tm_refine_e2547a65943c734e2839d0ebba2b81f2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e2547a65943c734e2839d0ebba2b81f2
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(42,46-42,56); use=MergeSort.fst(47,8-47,13)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e2547a65943c734e2839d0ebba2b81f2 @x0
@x1)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e2547a65943c734e2839d0ebba2b81f2 @x0
@x1))))
:qid haseqTm_refine_e2547a65943c734e2839d0ebba2b81f2))

:named haseqTm_refine_e2547a65943c734e2839d0ebba2b81f2))
;;;;;;;;;;;;;;;;l1: Prims.list Prims.int -> l2: Prims.list Prims.int {l1 << l1 \/ l1 === l1 /\ l2 << l2}   -> Prims.Pure (Prims.list Prims.int)
(declare-fun Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b
Tm_type)
:named kinding_Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(42,11-52,47); use=MergeSort.fst(42,11-52,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b))
:qid MergeSort_pre_typing_Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b))

:named MergeSort_pre_typing_Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(42,11-52,47); use=MergeSort.fst(42,11-52,47)
(forall ((@x0 Term))
...
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and 
;; def=MergeSort.fst(43,24-43,33); use=MergeSort.fst(47,8-47,13)
(BoxBool_proj_0 (IntSort.sorted @x1))


;; def=MergeSort.fst(43,37-43,46); use=MergeSort.fst(47,8-47,13)
(BoxBool_proj_0 (IntSort.sorted @x2))

(HasType @x1
(Prims.list Prims.int))
(HasType @x2
(Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
(Tm_refine_e2547a65943c734e2839d0ebba2b81f2 @x1
@x2)))
...
@x1)
@x2))
:qid MergeSort_interpretation_Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid MergeSort_interpretation_Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b))
:qid MergeSort_interpretation_Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b))

:named MergeSort_interpretation_Tm_arrow_e847ad2f6ded0248b66ff14a8ffe9d5b))
(declare-fun MergeSort.merge@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(47,8-47,13); use=MergeSort.fst(47,8-47,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT MergeSort.merge@tok
@x0)
@x1)
(MergeSort.merge @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT MergeSort.merge@tok
@x0)
@x1))
:qid token_correspondence_MergeSort.merge))

:named token_correspondence_MergeSort.merge))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(47,8-47,13); use=MergeSort.fst(47,8-47,13)
...
:pattern ((MergeSort.merge @x1
@x2))
:qid function_token_typing_MergeSort.merge.1))
)
 

:pattern ((ApplyTT @x0
MergeSort.merge@tok))
:qid function_token_typing_MergeSort.merge))

:named function_token_typing_MergeSort.merge))
...
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and 
;; def=MergeSort.fst(43,24-43,33); use=MergeSort.fst(47,8-47,13)
(BoxBool_proj_0 (IntSort.sorted @x0))
...
(Prims.list Prims.int))
(HasType @x1
(Tm_refine_2ec4c9e6dfdf5cf709b6e54d5d88d6f6 @x0)))
(HasType (MergeSort.merge @x0
@x1)
(Tm_refine_e2547a65943c734e2839d0ebba2b81f2 @x0
@x1)))
 

:pattern ((MergeSort.merge @x0
@x1))
:qid typing_MergeSort.merge))

:named typing_MergeSort.merge))
...
; Encoding query formula : forall (p: Prims.pure_post (Prims.list Prims.int)).
;   IntSort.sorted l1 /\ IntSort.sorted l2 /\
;   (forall (pure_result: Prims.list Prims.int).
;       IntSort.sorted pure_result /\ IntSort.permutation_2 pure_result l1 l2 /\
;       MergeSort.merge_inv l1 l2 pure_result ==>
;       p pure_result) ==>
;   (forall (k: Prims.pure_post (Prims.list Prims.int)).
;       (forall (x: Prims.list Prims.int). {:pattern Prims.guard_free (k x)}
;           (x ==
;             (match l1, l2 with
;               | [], _ -> l2
;               | _, [] -> l1
;               | h1 :: tl1, h2 :: tl2 ->
;                 (match h1 <= h2 with
;                   | true -> h1 :: MergeSort.merge tl1 l2
;                   | _ -> h2 :: MergeSort.merge l1 tl2)
;                 <:
;                 Prims.list Prims.int) ==>
;             (forall (return_val: Prims.list Prims.int). return_val == x ==> p return_val)) ==>
;           k x) ==>
;       (~(Nil? (l1, l2)._1) /\ ~(Nil? (l1, l2)._2) /\ ~(Cons? (l1, l2)._1 && Cons? (l1, l2)._2) ==>
;         Prims.l_False) /\
;       (forall (b: Prims.list Prims.int).
;           (l1, l2) == ([], b) ==> (forall (any_result: Prims.list Prims.int). k any_result)) /\
;       (~(Nil? (l1, l2)._1) ==>
;         (forall (b: Prims.list Prims.int).
;             (l1, l2) == (b, []) ==> (forall (any_result: Prims.list Prims.int). k any_result)) /\
;         (~(Nil? (l1, l2)._2) ==>
...
;               (l1, l2) == (b :: b, b :: b) ==>
;               (forall (k: Prims.pure_post (Prims.list Prims.int)).
;                   (forall (x: Prims.list Prims.int). {:pattern Prims.guard_free (k x)} k x ==> k x) ==>
;                   (b <= b == true ==>
;                     (b << l1 \/ b === l1 /\ l2 << l2) /\
;                     (forall (any_result: Prims.list Prims.int).
;                         l2 == any_result ==>
;                         IntSort.sorted b /\ IntSort.sorted l2 /\
;                         (forall (pure_result: Prims.list Prims.int).
;                             IntSort.sorted pure_result /\ IntSort.permutation_2 pure_result b l2 /\
;                             MergeSort.merge_inv b l2 pure_result ==>
;                             MergeSort.merge b l2 == pure_result ==>
;                             (forall (any_result: Prims.list Prims.int). k any_result)))) /\
;                   (~(b <= b = true) ==>
;                     (forall (b: Prims.bool).
;                         b <= b == b ==>
;                         (l1 << l1 \/ b << l2) /\
;                         (forall (any_result: Prims.list Prims.int).
;                             b == any_result ==>
;                             IntSort.sorted l1 /\ IntSort.sorted b /\
;                             (forall (pure_result: Prims.list Prims.int).
;                                 IntSort.sorted pure_result /\ IntSort.permutation_2 pure_result l1 b /\
;                                 MergeSort.merge_inv l1 b pure_result ==>
;                                 MergeSort.merge l1 b == pure_result ==>
;                                 (forall (any_result: Prims.list Prims.int). k any_result))))))))))
...
;; def=MergeSort.fst(43,24-43,33); use=MergeSort.fst(47,22-52,47)
(BoxBool_proj_0 (IntSort.sorted x_66b03f5c7897b05649fed8196554c587_0))


;; def=MergeSort.fst(43,37-43,46); use=MergeSort.fst(47,22-52,47)
(BoxBool_proj_0 (IntSort.sorted x_66b03f5c7897b05649fed8196554c587_1))


;; def=Prims.fst(441,36-441,97); use=MergeSort.fst(47,22-52,47)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
(Prims.list Prims.int)))

;; def=MergeSort.fst(44,32-44,40); use=MergeSort.fst(47,22-52,47)
(or label_2
...
;; def=MergeSort.fst(44,44-44,65); use=MergeSort.fst(47,22-52,47)
(or label_3
...
;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(47,22-52,47)
(or label_4

;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(47,22-52,47)
(Valid 
;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(47,22-52,47)
(MergeSort.merge_inv x_66b03f5c7897b05649fed8196554c587_0
x_66b03f5c7897b05649fed8196554c587_1
@x1)
)
)
...
;; def=Prims.fst(441,83-441,96); use=MergeSort.fst(47,22-52,47)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort.fst(47,22-52,47)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=MergeSort.fst(47,22-52,47)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post (Prims.list Prims.int)))
...
(forall ((@x2 Term))
 (! (implies (implies 
;; def=MergeSort.fst(42,46-52,47); use=MergeSort.fst(47,22-52,47)
(= @x2
(let ((@lb3 (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
x_66b03f5c7897b05649fed8196554c587_0
x_66b03f5c7897b05649fed8196554c587_1)))
(ite (is-Prims.Nil (FStar.Pervasives.Native.Mktuple2__1 @lb3))
x_66b03f5c7897b05649fed8196554c587_1
(ite (is-Prims.Nil (FStar.Pervasives.Native.Mktuple2__2 @lb3))
x_66b03f5c7897b05649fed8196554c587_0
(ite (and (is-Prims.Cons (FStar.Pervasives.Native.Mktuple2__1 @lb3))
(is-Prims.Cons (FStar.Pervasives.Native.Mktuple2__2 @lb3)))
(let ((@lb4 (Prims.op_LessThanOrEqual (Prims.Cons_hd (FStar.Pervasives.Native.Mktuple2__1 @lb3))
(Prims.Cons_hd (FStar.Pervasives.Native.Mktuple2__2 @lb3)))))
(ite (= @lb4
(BoxBool true))
(Prims.Cons Prims.int
(Prims.Cons_hd (FStar.Pervasives.Native.Mktuple2__1 @lb3))
(MergeSort.merge (Prims.Cons_tl (FStar.Pervasives.Native.Mktuple2__1 @lb3))
x_66b03f5c7897b05649fed8196554c587_1))
(Prims.Cons Prims.int
(Prims.Cons_hd (FStar.Pervasives.Native.Mktuple2__2 @lb3))
(MergeSort.merge x_66b03f5c7897b05649fed8196554c587_0
(Prims.Cons_tl (FStar.Pervasives.Native.Mktuple2__2 @lb3))))))
Tm_unit)))))
...
;; def=Prims.fst(402,84-402,87); use=MergeSort.fst(47,22-52,47)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort.fst(47,22-52,47)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(47,22-52,47)
(and (implies 
;; def=MergeSort.fst(48,4-50,20); use=MergeSort.fst(48,4-50,20)
(and 
;; def=MergeSort.fst(48,4-48,9); use=MergeSort.fst(48,4-48,9)
(not 
;; def=MergeSort.fst(48,4-48,9); use=MergeSort.fst(48,4-48,9)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
...
;; def=MergeSort.fst(49,4-49,9); use=MergeSort.fst(49,4-49,9)
(not 
;; def=MergeSort.fst(49,4-49,9); use=MergeSort.fst(49,4-49,9)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
...
;; def=MergeSort.fst(50,4-50,20); use=MergeSort.fst(50,4-50,20)
(not 
;; def=MergeSort.fst(50,4-50,20); use=MergeSort.fst(50,4-50,20)
(and (BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list Prims.int)
...
;; def=Prims.fst(413,99-413,120); use=MergeSort.fst(47,22-52,47)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.list Prims.int))

;; def=MergeSort.fst(47,28-48,9); use=MergeSort.fst(47,28-48,9)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
x_66b03f5c7897b05649fed8196554c587_0
x_66b03f5c7897b05649fed8196554c587_1)
...
;; def=Prims.fst(451,66-451,102); use=MergeSort.fst(47,22-52,47)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Prims.list Prims.int))

;; def=Prims.fst(451,90-451,102); use=MergeSort.fst(47,22-52,47)
(Valid 
;; def=Prims.fst(451,90-451,102); use=MergeSort.fst(47,22-52,47)
(ApplyTT @x1
@x3)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MergeSort.fst(47,22-52,47)
(not 
;; def=MergeSort.fst(48,4-48,9); use=MergeSort.fst(48,4-48,9)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list Prims.int)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort.fst(47,22-52,47)
(and 
;; def=Prims.fst(413,99-413,120); use=MergeSort.fst(47,22-52,47)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
...
;; def=MergeSort.fst(47,28-49,9); use=MergeSort.fst(47,28-49,9)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
x_66b03f5c7897b05649fed8196554c587_0
x_66b03f5c7897b05649fed8196554c587_1)
...
;; def=MergeSort.fst(47,28-50,20); use=MergeSort.fst(47,28-50,20)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
x_66b03f5c7897b05649fed8196554c587_0
x_66b03f5c7897b05649fed8196554c587_1)
...
(forall ((@x7 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=MergeSort.fst(47,22-52,47)
(Valid 
;; def=Prims.fst(402,73-402,79); use=MergeSort.fst(47,22-52,47)
(ApplyTT @x1
@x7)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort.fst(47,22-52,47)
(and (implies 
;; def=MergeSort.fst(50,27-50,35); use=MergeSort.fst(50,27-50,35)
(= (Prims.op_LessThanOrEqual @x2
@x4)
(BoxBool true))
...
;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(47,22-52,47)
(and 
;; def=MergeSort.fst(42,11-52,47); use=MergeSort.fst(51,44-51,46)
(or label_6

;; def=MergeSort.fst(47,22-52,47); use=MergeSort.fst(51,44-51,46)
(Valid 
;; def=MergeSort.fst(47,22-52,47); use=MergeSort.fst(51,44-51,46)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=MergeSort.fst(42,11-52,47); use=MergeSort.fst(51,44-51,46)
(and 
;; def=MergeSort.fst(42,11-47,16); use=MergeSort.fst(51,44-51,46)
(Valid 
;; def=MergeSort.fst(42,11-47,16); use=MergeSort.fst(51,44-51,46)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=MergeSort.fst(42,26-47,19); use=MergeSort.fst(47,22-52,47)
(= x_66b03f5c7897b05649fed8196554c587_1
@x7)
)

;; def=Prims.fst(441,29-441,97); use=MergeSort.fst(51,34-51,39)
(and 
;; def=MergeSort.fst(43,24-43,33); use=MergeSort.fst(51,34-51,39)
(or label_7

;; def=MergeSort.fst(43,24-43,33); use=MergeSort.fst(51,34-51,39)
(BoxBool_proj_0 (IntSort.sorted @x3))
)


;; def=MergeSort.fst(43,37-43,46); use=MergeSort.fst(51,34-51,39)
(or label_8
...
;; def=Prims.fst(441,36-441,97); use=MergeSort.fst(51,34-51,39)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Prims.list Prims.int))

;; def=MergeSort.fst(44,32-44,40); use=MergeSort.fst(51,34-51,39)
(BoxBool_proj_0 (IntSort.sorted @x8))


;; def=MergeSort.fst(44,44-44,65); use=MergeSort.fst(51,34-51,39)
(Valid 
;; def=MergeSort.fst(44,44-44,65); use=MergeSort.fst(51,34-51,39)
(IntSort.permutation_2 @x8
@x3
x_66b03f5c7897b05649fed8196554c587_1)
)


;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(51,34-51,39)
(Valid 
;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(51,34-51,39)
(MergeSort.merge_inv @x3
x_66b03f5c7897b05649fed8196554c587_1
@x8)
)


;; def=Prims.fst(616,20-616,22); use=MergeSort.fst(47,22-52,47)
(= (MergeSort.merge @x3
x_66b03f5c7897b05649fed8196554c587_1)
@x8)
)
...
;; def=MergeSort.fst(50,27-52,47); use=MergeSort.fst(50,27-52,47)
(= (Prims.op_LessThanOrEqual @x2
@x4)
@x7)
)
...
;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(47,22-52,47)
(and 
;; def=MergeSort.fst(42,11-52,47); use=MergeSort.fst(52,43-52,46)
(or label_9

;; def=MergeSort.fst(47,22-52,47); use=MergeSort.fst(52,43-52,46)
(Valid 
;; def=MergeSort.fst(47,22-52,47); use=MergeSort.fst(52,43-52,46)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=MergeSort.fst(42,26-50,20); use=MergeSort.fst(47,22-52,47)
(= @x5
@x8)
)

;; def=Prims.fst(441,29-441,97); use=MergeSort.fst(52,34-52,39)
(and 
;; def=MergeSort.fst(43,24-43,33); use=MergeSort.fst(52,34-52,39)
(or label_10
...
;; def=MergeSort.fst(43,37-43,46); use=MergeSort.fst(52,34-52,39)
(or label_11

;; def=MergeSort.fst(43,37-43,46); use=MergeSort.fst(52,34-52,39)
(BoxBool_proj_0 (IntSort.sorted @x5))
)


;; def=Prims.fst(441,36-441,97); use=MergeSort.fst(52,34-52,39)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(Prims.list Prims.int))

;; def=MergeSort.fst(44,32-44,40); use=MergeSort.fst(52,34-52,39)
(BoxBool_proj_0 (IntSort.sorted @x9))


;; def=MergeSort.fst(44,44-44,65); use=MergeSort.fst(52,34-52,39)
(Valid 
;; def=MergeSort.fst(44,44-44,65); use=MergeSort.fst(52,34-52,39)
(IntSort.permutation_2 @x9
x_66b03f5c7897b05649fed8196554c587_0
@x5)
)


;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(52,34-52,39)
(Valid 
;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(52,34-52,39)
(MergeSort.merge_inv x_66b03f5c7897b05649fed8196554c587_0
@x5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MergeSort.merge, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, @fuel_correspondence_FStar.List.Tot.Base.mem.fuel_instrumented, @fuel_correspondence_IntSort.sorted.fuel_instrumented, @fuel_irrelevance_FStar.List.Tot.Base.length.fuel_instrumented, @fuel_irrelevance_FStar.List.Tot.Base.mem.fuel_instrumented, @fuel_irrelevance_IntSort.sorted.fuel_instrumented, @query, Prims_pretyping_3862c4e8ff39bfc3871b6a47e7ff5b2e, Prims_pretyping_ae567c2fb75be05905677af440075565, Prims_pretyping_f8666440faa91836cc5a13998af863fc, binder_x_66b03f5c7897b05649fed8196554c587_0, binder_x_66b03f5c7897b05649fed8196554c587_1, bool_inversion, bool_typing, constructor_distinct_Prims.Cons, constructor_distinct_Prims.Nil, constructor_distinct_Prims.list, constructor_distinct_Prims.unit, constructor_distinct_Tm_unit, data_elim_Prims.Cons, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_IntSort.permutation_2, equation_MergeSort.merge_inv, equation_Prims.eqtype, equation_Prims.nat, equation_with_fuel_FStar.List.Tot.Base.length.fuel_instrumented, equation_with_fuel_FStar.List.Tot.Base.mem.fuel_instrumented, equation_with_fuel_IntSort.sorted.fuel_instrumented, fuel_guarded_inversion_Prims.list, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_AmpAmp, primitive_Prims.op_BarBar, primitive_Prims.op_Equality, primitive_Prims.op_LessThanOrEqual, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, proj_equation_Prims.Cons_hd, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, projection_inverse_Prims.Nil_a, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, subterm_ordering_Prims.Cons, token_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, token_correspondence_FStar.List.Tot.Base.mem.fuel_instrumented, typing_FStar.List.Tot.Base.length, typing_FStar.List.Tot.Base.mem, typing_IntSort.sorted, typing_Prims.int, unit_typing
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun MergeSort.merge.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun MergeSort.merge.fuel_instrumented_token () Term)
(declare-fun MergeSort.merge (Term Term) Term)
(declare-fun MergeSort.merge@tok () Term)
(declare-fun Tm_refine_e2547a65943c734e2839d0ebba2b81f2 (Term Term) Term)

;;;;;;;;;;;;;;;;l1: Prims.list Prims.int -> l2: Prims.list Prims.int -> Prims.Pure (Prims.list Prims.int)
(declare-fun Tm_arrow_5f63e343bcec70701e03c5c7eb438346 () Term)


; </end encoding let rec merge>


; encoding sigelt val MergeSort.mergesort


; <Skipped val MergeSort.mergesort/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MergeSort.split; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(28,8-28,13); use=MergeSort.fst(28,8-28,13)
(forall ((@x0 Term))
 (! (implies (and 
...
:named typing_MergeSort.split))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MergeSort.merge; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(47,8-47,13); use=MergeSort.fst(47,8-47,13)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and 
...
(HasType (MergeSort.split.fuel_instrumented @u0
@x1)
(Tm_refine_48bc63e029480d3d2e316caa63dd5bbb @x1)))
 

:pattern ((MergeSort.split.fuel_instrumented @u0
@x1))
:qid token_correspondence_MergeSort.split.fuel_instrumented))

:named token_correspondence_MergeSort.split.fuel_instrumented))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name MergeSort.merge; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(47,8-47,13); use=MergeSort.fst(47,8-47,13)
...
(HasType (MergeSort.merge.fuel_instrumented @u0
@x1
@x2)
(Tm_refine_e2547a65943c734e2839d0ebba2b81f2 @x1
@x2)))
...
:pattern ((MergeSort.merge.fuel_instrumented @u0
@x1
@x2))
:qid token_correspondence_MergeSort.merge.fuel_instrumented))

:named token_correspondence_MergeSort.merge.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name MergeSort.merge; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(42,46-42,56); use=MergeSort.fst(47,8-47,13)
...
:named haseqTm_refine_48bc63e029480d3d2e316caa63dd5bbb))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: MergeSort.split
;;; Fact-ids: Name MergeSort.split; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(28,8-28,13); use=MergeSort.fst(28,8-28,13)
(forall ((@u0 Fuel) (@x1 Term))
...
(= (MergeSort.split.fuel_instrumented (SFuel @u0)
@x1)
(let ((@lb2 @x1))
(ite (and (is-Prims.Cons @lb2)
(is-Prims.Cons (Prims.Cons_tl @lb2)))
(let ((@lb3 (Prims.Cons_tl (Prims.Cons_tl @lb2))))
(ite (is-Prims.Nil @lb3)
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
(Prims.Cons Prims.int
...
(Prims.Cons_hd (Prims.Cons_tl @lb2))
(Prims.Nil Prims.int)))
(let ((@lb4 (MergeSort.split.fuel_instrumented @u0
(Prims.Cons_tl (Prims.Cons_tl @lb2)))))
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
(Prims.Cons Prims.int
...
:pattern ((MergeSort.split.fuel_instrumented (SFuel @u0)
@x1))
:qid equation_with_fuel_MergeSort.split.fuel_instrumented))

:named equation_with_fuel_MergeSort.split.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: MergeSort.merge
;;; Fact-ids: Name MergeSort.merge; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(47,8-47,13); use=MergeSort.fst(47,8-47,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
...
(= (MergeSort.merge.fuel_instrumented (SFuel @u0)
@x1
@x2)
(let ((@lb3 (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
...
(Prims.Cons Prims.int
(Prims.Cons_hd (FStar.Pervasives.Native.Mktuple2__1 @lb3))
(MergeSort.merge.fuel_instrumented @u0
(Prims.Cons_tl (FStar.Pervasives.Native.Mktuple2__1 @lb3))
@x2))
(Prims.Cons Prims.int
(Prims.Cons_hd (FStar.Pervasives.Native.Mktuple2__2 @lb3))
(MergeSort.merge.fuel_instrumented @u0
...
:pattern ((MergeSort.merge.fuel_instrumented (SFuel @u0)
@x1
@x2))
:qid equation_with_fuel_MergeSort.merge.fuel_instrumented))

:named equation_with_fuel_MergeSort.merge.fuel_instrumented))
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (= (MergeSort.split.fuel_instrumented (SFuel @u0)
@x1)
(MergeSort.split.fuel_instrumented ZFuel
@x1))
 

:pattern ((MergeSort.split.fuel_instrumented (SFuel @u0)
@x1))
:qid @fuel_irrelevance_MergeSort.split.fuel_instrumented))

:named @fuel_irrelevance_MergeSort.split.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name MergeSort.merge; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(47,8-47,13); use=MergeSort.fst(47,8-47,13)
...
@x1
@x2)
(MergeSort.merge.fuel_instrumented ZFuel
@x1
@x2))
...
@x1
@x2))
:qid @fuel_irrelevance_MergeSort.merge.fuel_instrumented))

:named @fuel_irrelevance_MergeSort.merge.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name MergeSort.split; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(28,8-28,13); use=MergeSort.fst(28,8-28,13)
(forall ((@x0 Term))
 (! (= (MergeSort.split @x0)
(MergeSort.split.fuel_instrumented MaxFuel
@x0))
 

:pattern ((MergeSort.split @x0))
:qid @fuel_correspondence_MergeSort.split.fuel_instrumented))

:named @fuel_correspondence_MergeSort.split.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name MergeSort.merge; Namespace MergeSort
(assert (! 
;; def=MergeSort.fst(47,8-47,13); use=MergeSort.fst(47,8-47,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (MergeSort.merge @x0
@x1)
(MergeSort.merge.fuel_instrumented MaxFuel
@x0
@x1))
...
:pattern ((MergeSort.merge @x0
@x1))
:qid @fuel_correspondence_MergeSort.merge.fuel_instrumented))

:named @fuel_correspondence_MergeSort.merge.fuel_instrumented))
(push) ;; push{2

; Starting query at MergeSort.fst(56,22-63,17)
...
(Prims.list Prims.int))
:named binder_x_66b03f5c7897b05649fed8196554c587_0))
(declare-fun Tm_refine_6a9da0482c7bd0a436c98784e49df1a4 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_6a9da0482c7bd0a436c98784e49df1a4
Tm_type)
:named refinement_kinding_Tm_refine_6a9da0482c7bd0a436c98784e49df1a4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(54,15-63,17); use=MergeSort.fst(54,15-63,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_6a9da0482c7bd0a436c98784e49df1a4)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=MergeSort.fst(56,22-63,17); use=MergeSort.fst(56,22-63,17)
...
@x1
Tm_refine_6a9da0482c7bd0a436c98784e49df1a4))
:qid refinement_interpretation_Tm_refine_6a9da0482c7bd0a436c98784e49df1a4))

:named refinement_interpretation_Tm_refine_6a9da0482c7bd0a436c98784e49df1a4))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6a9da0482c7bd0a436c98784e49df1a4
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_6a9da0482c7bd0a436c98784e49df1a4))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_6a9da0482c7bd0a436c98784e49df1a4))
(declare-fun MergeSort.mergesort (Term) Term)

(declare-fun Tm_refine_e8403f918d280ddafd288213ea995835 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(54,34-54,44); use=MergeSort.fst(56,8-56,17)
(forall ((@x0 Term))
...
;; def=MergeSort.fst(55,25-55,33); use=MergeSort.fst(56,8-56,17)
(BoxBool_proj_0 (IntSort.sorted @x1))


;; def=MergeSort.fst(55,37-55,52); use=MergeSort.fst(56,8-56,17)
(Valid 
;; def=MergeSort.fst(55,37-55,52); use=MergeSort.fst(56,8-56,17)
...
;;;;;;;;;;;;;;;;l: Prims.list Prims.int {FStar.List.Tot.Base.length l << FStar.List.Tot.Base.length l}   -> Prims.Pure (Prims.list Prims.int)
(declare-fun Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81
Tm_type)
:named kinding_Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(54,15-63,17); use=MergeSort.fst(54,15-63,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81))
:qid MergeSort_pre_typing_Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81))

:named MergeSort_pre_typing_Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(54,15-63,17); use=MergeSort.fst(54,15-63,17)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid MergeSort_interpretation_Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81))
:qid MergeSort_interpretation_Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81))

:named MergeSort_interpretation_Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81))
(declare-fun MergeSort.mergesort@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(56,8-56,17); use=MergeSort.fst(56,8-56,17)
(forall ((@x0 Term))
 (! (= (ApplyTT MergeSort.mergesort@tok
@x0)
(MergeSort.mergesort @x0))
 

:pattern ((ApplyTT MergeSort.mergesort@tok
@x0))
:qid token_correspondence_MergeSort.mergesort))

:named token_correspondence_MergeSort.mergesort))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=MergeSort.fst(56,8-56,17); use=MergeSort.fst(56,8-56,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType MergeSort.mergesort@tok
Tm_arrow_7eb9ef89d7ad68c74a7be8c49e87da81))
...
(forall ((@x1 Term))
 (! (= (ApplyTT MergeSort.mergesort@tok
@x1)
(MergeSort.mergesort @x1))
 

:pattern ((MergeSort.mergesort @x1))
:qid function_token_typing_MergeSort.mergesort.1))
)
 

:pattern ((ApplyTT @x0
MergeSort.mergesort@tok))
:qid function_token_typing_MergeSort.mergesort))

:named function_token_typing_MergeSort.mergesort))
...
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_6a9da0482c7bd0a436c98784e49df1a4)
(HasType (MergeSort.mergesort @x0)
(Tm_refine_e8403f918d280ddafd288213ea995835 @x0)))
 

:pattern ((MergeSort.mergesort @x0))
:qid typing_MergeSort.mergesort))

:named typing_MergeSort.mergesort))
(declare-fun label_9 () Bool)
(declare-fun label_8 () Bool)
(declare-fun label_7 () Bool)
(declare-fun label_6 () Bool)
...
; Encoding query formula : forall (p: Prims.pure_post (Prims.list Prims.int)).
;   (forall (pure_result: Prims.list Prims.int).
;       IntSort.sorted pure_result /\ IntSort.permutation l pure_result ==> p pure_result) ==>
;   (forall (k: Prims.pure_post (Prims.list Prims.int)).
;       (forall (x: Prims.list Prims.int). {:pattern Prims.guard_free (k x)}
;           (x ==
;             (match l with
...
;               | _ ->
;                 (let l1, l2 = MergeSort.split l in
;                   MergeSort.merge (MergeSort.mergesort l1) (MergeSort.mergesort l2))
;                 <:
;                 Prims.list Prims.int) ==>
;             (forall (return_val: Prims.list Prims.int). return_val == x ==> p return_val)) ==>
;           k x) ==>
;       (l == [] ==> (forall (any_result: Prims.list Prims.int). k any_result)) /\
;       (~(Nil? l) ==>
;         (forall (b: Prims.int).
;             l == [b] ==> (forall (any_result: Prims.list Prims.int). k any_result)) /\
;         (~(Cons? l && Nil? l.tl) ==>
;           (forall (b: Prims.list Prims.int).
;               l == b ==>
;               Cons? l /\ Cons? l.tl /\
;               (forall (pure_result: Prims.list Prims.int & Prims.list Prims.int).
;                   MergeSort.split_inv l
;                     (FStar.Pervasives.Native.fst pure_result)
;                     (FStar.Pervasives.Native.snd pure_result) ==>
;                   MergeSort.split l == pure_result ==>
;                   (forall (b: Prims.list Prims.int) (b: Prims.list Prims.int).
;                       MergeSort.split l == (b, b) ==>
;                       FStar.List.Tot.Base.length b << FStar.List.Tot.Base.length l /\
;                       (forall (any_result: Prims.list Prims.int).
;                           b == any_result ==>
;                           (forall (pure_result: Prims.list Prims.int).
;                               IntSort.sorted pure_result /\ IntSort.permutation b pure_result ==>
;                               MergeSort.mergesort b == pure_result ==>
;                               FStar.List.Tot.Base.length b << FStar.List.Tot.Base.length l /\
;                               (forall (any_result: Prims.list Prims.int).
;                                   b == any_result ==>
;                                   (forall (pure_result: Prims.list Prims.int).
;                                       IntSort.sorted pure_result /\
;                                       IntSort.permutation b pure_result ==>
;                                       MergeSort.mergesort b == pure_result ==>
;                                       IntSort.sorted (MergeSort.mergesort b) /\
;                                       IntSort.sorted (MergeSort.mergesort b) /\
;                                       (forall (pure_result: Prims.list Prims.int).
;                                           IntSort.sorted pure_result /\
;                                           IntSort.permutation_2 pure_result
;                                             (MergeSort.mergesort b)
;                                             (MergeSort.mergesort b) /\
;                                           MergeSort.merge_inv (MergeSort.mergesort b)
;                                             (MergeSort.mergesort b)
;                                             pure_result ==>
;                                           k pure_result)))))))))))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec mergesort`
...
;; def=Prims.fst(441,36-441,97); use=MergeSort.fst(56,22-63,17)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
(Prims.list Prims.int)))

;; def=MergeSort.fst(55,25-55,33); use=MergeSort.fst(56,22-63,17)
(or label_2
...
;; def=MergeSort.fst(55,37-55,52); use=MergeSort.fst(56,22-63,17)
(or label_3
...
;; def=Prims.fst(441,83-441,96); use=MergeSort.fst(56,22-63,17)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort.fst(56,22-63,17)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=MergeSort.fst(56,22-63,17)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post (Prims.list Prims.int)))
...
(forall ((@x2 Term))
 (! (implies (implies 
;; def=MergeSort.fst(54,34-63,17); use=MergeSort.fst(56,22-63,17)
(= @x2
(let ((@lb3 x_66b03f5c7897b05649fed8196554c587_0))
(ite (is-Prims.Nil @lb3)
(Prims.Nil Prims.int)
(ite (and (is-Prims.Cons @lb3)
(is-Prims.Nil (Prims.Cons_tl @lb3)))
...
(Prims.Cons_hd @lb3)
(Prims.Nil Prims.int))
(let ((@lb4 (MergeSort.split x_66b03f5c7897b05649fed8196554c587_0)))
(MergeSort.merge (MergeSort.mergesort (FStar.Pervasives.Native.Mktuple2__1 @lb4))
(MergeSort.mergesort (FStar.Pervasives.Native.Mktuple2__2 @lb4))))))))
...
;; def=Prims.fst(402,84-402,87); use=MergeSort.fst(56,22-63,17)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MergeSort.fst(56,22-63,17)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort.fst(56,22-63,17)
(and (implies 
;; def=MergeSort.fst(56,18-57,6); use=MergeSort.fst(56,28-57,6)
(= x_66b03f5c7897b05649fed8196554c587_0
(Prims.Nil Prims.int))


;; def=Prims.fst(451,66-451,102); use=MergeSort.fst(56,22-63,17)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Prims.list Prims.int))

;; def=Prims.fst(451,90-451,102); use=MergeSort.fst(56,22-63,17)
(Valid 
;; def=Prims.fst(451,90-451,102); use=MergeSort.fst(56,22-63,17)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MergeSort.fst(56,22-63,17)
(not 
;; def=MergeSort.fst(56,18-56,19); use=MergeSort.fst(56,28-56,29)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_66b03f5c7897b05649fed8196554c587_0))
)
...
;; def=Prims.fst(389,2-389,39); use=MergeSort.fst(56,22-63,17)
(and 
;; def=Prims.fst(413,99-413,120); use=MergeSort.fst(56,22-63,17)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.int)

;; def=MergeSort.fst(56,18-58,7); use=MergeSort.fst(56,28-58,7)
(= x_66b03f5c7897b05649fed8196554c587_0
(Prims.Cons Prims.int
@x2
(Prims.Nil Prims.int)))
...
;; def=MergeSort.fst(56,18-59,5); use=MergeSort.fst(56,28-59,5)
(= x_66b03f5c7897b05649fed8196554c587_0
@x2)
)

;; def=Prims.fst(441,29-441,97); use=MergeSort.fst(60,19-60,24)
(and 
;; def=MergeSort.fst(26,24-26,31); use=MergeSort.fst(60,19-60,24)
(or label_4
...
;; def=MergeSort.fst(26,35-26,53); use=MergeSort.fst(60,19-60,24)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=MergeSort.fst(60,19-60,24)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(FStar.Pervasives.Native.tuple2 (Prims.list Prims.int)
(Prims.list Prims.int)))

;; def=MergeSort.fst(27,25-27,52); use=MergeSort.fst(60,19-60,24)
(Valid 
;; def=MergeSort.fst(27,25-27,52); use=MergeSort.fst(60,19-60,24)
(MergeSort.split_inv x_66b03f5c7897b05649fed8196554c587_0
(FStar.Pervasives.Native.fst (Prims.list Prims.int)
...
;; def=MergeSort.fst(60,9-60,26); use=MergeSort.fst(60,9-60,26)
(= (MergeSort.split x_66b03f5c7897b05649fed8196554c587_0)
@x3)
)
...
;; def=MergeSort.fst(60,9-60,15); use=MergeSort.fst(60,9-60,15)
(= (MergeSort.split x_66b03f5c7897b05649fed8196554c587_0)
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
@x4
...
;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(56,22-63,17)
(and 
;; def=MergeSort.fst(56,22-63,17); use=MergeSort.fst(61,24-61,26)
(or label_6
...
;; def=MergeSort.fst(54,15-60,11); use=MergeSort.fst(56,22-63,17)
(= @x4
@x6)
)

;; def=Prims.fst(441,36-441,97); use=MergeSort.fst(61,14-61,23)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Prims.list Prims.int))

;; def=MergeSort.fst(55,25-55,33); use=MergeSort.fst(61,14-61,23)
(BoxBool_proj_0 (IntSort.sorted @x7))


;; def=MergeSort.fst(55,37-55,52); use=MergeSort.fst(61,14-61,23)
(Valid 
;; def=MergeSort.fst(55,37-55,52); use=MergeSort.fst(61,14-61,23)
(IntSort.permutation @x4
@x7)
)


;; def=MergeSort.fst(61,8-61,26); use=MergeSort.fst(61,8-61,26)
(= (MergeSort.mergesort @x4)
@x7)
)

;; def=Prims.fst(459,77-459,89); use=MergeSort.fst(56,22-63,17)
(and 
;; def=MergeSort.fst(56,22-63,17); use=MergeSort.fst(62,24-62,26)
(or label_7
...
;; def=MergeSort.fst(54,15-60,15); use=MergeSort.fst(56,22-63,17)
(= @x5
@x8)
)

;; def=Prims.fst(441,36-441,97); use=MergeSort.fst(62,14-62,23)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(Prims.list Prims.int))

;; def=MergeSort.fst(55,25-55,33); use=MergeSort.fst(62,14-62,23)
(BoxBool_proj_0 (IntSort.sorted @x9))


;; def=MergeSort.fst(55,37-55,52); use=MergeSort.fst(62,14-62,23)
(Valid 
;; def=MergeSort.fst(55,37-55,52); use=MergeSort.fst(62,14-62,23)
(IntSort.permutation @x5
@x9)
)


;; def=MergeSort.fst(62,8-62,26); use=MergeSort.fst(62,8-62,26)
(= (MergeSort.mergesort @x5)
@x9)
)

;; def=Prims.fst(441,29-441,97); use=MergeSort.fst(63,4-63,9)
(and 
;; def=MergeSort.fst(43,24-43,33); use=MergeSort.fst(63,4-63,9)
(or label_8

;; def=MergeSort.fst(43,24-43,33); use=MergeSort.fst(63,4-63,9)
(BoxBool_proj_0 (IntSort.sorted (MergeSort.mergesort @x4)))
)


;; def=MergeSort.fst(43,37-43,46); use=MergeSort.fst(63,4-63,9)
(or label_9

;; def=MergeSort.fst(43,37-43,46); use=MergeSort.fst(63,4-63,9)
(BoxBool_proj_0 (IntSort.sorted (MergeSort.mergesort @x5)))
)


;; def=Prims.fst(441,36-441,97); use=MergeSort.fst(63,4-63,9)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(Prims.list Prims.int))

;; def=MergeSort.fst(44,32-44,40); use=MergeSort.fst(63,4-63,9)
(BoxBool_proj_0 (IntSort.sorted @x10))


;; def=MergeSort.fst(44,44-44,65); use=MergeSort.fst(63,4-63,9)
(Valid 
;; def=MergeSort.fst(44,44-44,65); use=MergeSort.fst(63,4-63,9)
(IntSort.permutation_2 @x10
(MergeSort.mergesort @x4)
(MergeSort.mergesort @x5))
)


;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(63,4-63,9)
(Valid 
;; def=MergeSort.fst(45,44-45,61); use=MergeSort.fst(63,4-63,9)
(MergeSort.merge_inv (MergeSort.mergesort @x4)
(MergeSort.mergesort @x5)
@x10)
)
)

;; def=Prims.fst(441,83-441,96); use=MergeSort.fst(63,4-63,9)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MergeSort.fst(63,4-63,9)
(ApplyTT @x1
@x10)
