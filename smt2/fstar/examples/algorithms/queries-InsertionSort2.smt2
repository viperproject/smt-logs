...
; Externals for module GenericSort


; <Skipped val GenericSort.sorted/>


; <Start encoding let rec sorted>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun GenericSort.sorted.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun GenericSort.sorted.fuel_instrumented_token () Term)
(declare-fun GenericSort.sorted (Term Term Term) Term)
(declare-fun GenericSort.sorted@tok () Term)
;;;;;;;;;;;;;;;;_: 'a -> Prims.int
(declare-fun Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 (Term) Term)


;;;;;;;;;;;;;;;;l: Prims.list 'a -> key: (_: 'a -> Prims.int) -> Prims.bool
(declare-fun Tm_arrow_c28fc75308c5f8885e69a8191c74725a () Term)

; </end encoding let rec sorted>


; <Skipped val GenericSort.test_sorted/>


; <Start encoding let test_sorted>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericSort.test_sorted (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericSort.test_sorted@tok () Term)

; </end encoding let test_sorted>


; <Skipped val GenericSort.test_sorted2/>


; <Start encoding let test_sorted2>


(declare-fun GenericSort.test_sorted2 (Term Term Term) Term)

(declare-fun Tm_refine_40df688876565697b8cc8ea85a461183 (Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> key: (_: 'a -> Prims.int) -> m: Prims.list 'a {sorted m key}
(declare-fun Tm_arrow_dffa9975a3dd7cc933bfc22c1185cffc () Term)
(declare-fun GenericSort.test_sorted2@tok () Term)
...
; <Skipped val GenericSort.sorted_smaller/>


; <Start encoding let rec sorted_smaller>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericSort.sorted_smaller (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericSort.sorted_smaller@tok () Term)


; </end encoding let rec sorted_smaller>


; <Skipped val GenericSort.sorted_tl/>


; <Start encoding let rec sorted_tl>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericSort.sorted_tl (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericSort.sorted_tl@tok () Term)

; </end encoding let rec sorted_tl>


; <Skipped val GenericSort.sorted_lt/>


; <Start encoding let sorted_lt>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericSort.sorted_lt (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericSort.sorted_lt@tok () Term)

; </end encoding let sorted_lt>


; <Start encoding let permutation>


(declare-fun GenericSort.permutation (Term Term Term) Term)

;;;;;;;;;;;;;;;;l1: Prims.list a -> l2: Prims.list a -> Prims.logical
(declare-fun Tm_arrow_99770ad51acec235ff920c7568f06c81 () Term)
(declare-fun GenericSort.permutation@tok () Term)
...
(declare-fun GenericSort.permutation_2 (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;l: Prims.list a -> l1: Prims.list a -> l2: Prims.list a -> Prims.logical
(declare-fun Tm_arrow_60568efd872d84dcd1b3cd2aecf82069 () Term)
(declare-fun GenericSort.permutation_2@tok () Term)


; </end encoding let permutation_2>


; End Externals for module GenericSort


; Externals for module GenericStability


; <Skipped val GenericStability.filter_eq/>


; <Start encoding let rec filter_eq>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun GenericStability.filter_eq.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun GenericStability.filter_eq.fuel_instrumented_token () Term)
(declare-fun GenericStability.filter_eq (Term Term Term Term) Term)
(declare-fun GenericStability.filter_eq@tok () Term)



;;;;;;;;;;;;;;;;x: Prims.int -> xs: Prims.list a -> k: (_: a -> Prims.int) -> Prims.list a
(declare-fun Tm_arrow_9b19c7576807253b8e405a8a5e3297e9 () Term)

; </end encoding let rec filter_eq>


; <Skipped val GenericStability.filter_eq_contains/>


; <Start encoding let rec filter_eq_contains>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.filter_eq_contains (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.filter_eq_contains@tok () Term)

; </end encoding let rec filter_eq_contains>


; <Skipped val GenericStability.filter_eq_append/>


; <Start encoding let rec filter_eq_append>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.filter_eq_append (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.filter_eq_append@tok () Term)

; </end encoding let rec filter_eq_append>


; <Skipped val GenericStability.filter_eq_not_contains/>


; <Start encoding let rec filter_eq_not_contains>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.filter_eq_not_contains (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.filter_eq_not_contains@tok () Term)

; </end encoding let rec filter_eq_not_contains>


; <Skipped val GenericStability.filter_eq_single/>


; <Start encoding let filter_eq_single>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.filter_eq_single (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.filter_eq_single@tok () Term)

; </end encoding let filter_eq_single>


; <Skipped val GenericStability.filter_eq_sorted_lt/>


; <Start encoding let filter_eq_sorted_lt>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.filter_eq_sorted_lt (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.filter_eq_sorted_lt@tok () Term)

; </end encoding let filter_eq_sorted_lt>


; <Skipped val GenericStability.filter_eq_first/>


; <Start encoding let filter_eq_first>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.filter_eq_first (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.filter_eq_first@tok () Term)

; </end encoding let filter_eq_first>


; <Start encoding let stable>


(declare-fun GenericStability.stable (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;l1: Prims.list a -> l2: Prims.list a -> k: (_: a -> Prims.int) -> Prims.logical
(declare-fun Tm_arrow_1ab09ee8433fe7b7a51f335c25813d03 () Term)
(declare-fun GenericStability.stable@tok () Term)


; </end encoding let stable>


; <Skipped val GenericStability.stable_lift/>


; <Start encoding let stable_lift>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.stable_lift (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.stable_lift@tok () Term)

; </end encoding let stable_lift>


; <Skipped val GenericStability.stable_append_l/>


; <Start encoding let rec stable_append_l>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.stable_append_l (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.stable_append_l@tok () Term)

; </end encoding let rec stable_append_l>


; <Skipped val GenericStability.stable_append_r/>


; <Start encoding let rec stable_append_r>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.stable_append_r (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.stable_append_r@tok () Term)

; </end encoding let rec stable_append_r>


; <Skipped val GenericStability.stable_transitive/>


; <Start encoding let stable_transitive>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.stable_transitive (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.stable_transitive@tok () Term)

; </end encoding let stable_transitive>


; <Skipped val GenericStability.stable_append/>


; <Start encoding let stable_append>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun GenericStability.stable_append (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun GenericStability.stable_append@tok () Term)

; </end encoding let stable_append>


; End Externals for module GenericStability

(push) ;; push{1

; Internals for InsertionSort2


; encoding sigelt val InsertionSort2.insert'


; <Skipped val InsertionSort2.insert'/>
...
;;; Fact-ids: Name GenericSort.sorted; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(28,38-29,16); use=GenericSort.fst(29,8-29,16)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x2)))
:qid GenericSort_pre_typing_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949))

:named GenericSort_pre_typing_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949))
...
:pattern ((ApplyTT @x0
@x2))
:qid GenericSort_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
:qid GenericSort_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949))

:named GenericSort_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949))
(push) ;; push{2

; Starting query at InsertionSort2.fst(25,2-29,29)
...
;;;;;;;;;;;;;;;;k : _: a -> Prims.int (_: a -> Prims.int)
(declare-fun x_582acf81e02a6e4176cba5e2730f867d_3 () Term)
;;;;;;;;;;;;;;;;_: a -> Prims.int
(declare-fun Tm_arrow_605ada36aef613d3875663fdd1971cfd () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_605ada36aef613d3875663fdd1971cfd
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_605ada36aef613d3875663fdd1971cfd
Tm_type)
:named kinding_Tm_arrow_605ada36aef613d3875663fdd1971cfd))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(23,59-24,18); use=InsertionSort2.fst(24,8-24,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd))
:qid InsertionSort2_pre_typing_Tm_arrow_605ada36aef613d3875663fdd1971cfd))

:named InsertionSort2_pre_typing_Tm_arrow_605ada36aef613d3875663fdd1971cfd))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(23,59-24,18); use=InsertionSort2.fst(24,8-24,18)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid InsertionSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_605ada36aef613d3875663fdd1971cfd))
:qid InsertionSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd))

:named InsertionSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd))
;;;;;;;;;;;;;;;;binder_x_582acf81e02a6e4176cba5e2730f867d_3
;;; Fact-ids: 
(assert (! (HasType x_582acf81e02a6e4176cba5e2730f867d_3
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
:named binder_x_582acf81e02a6e4176cba5e2730f867d_3))

(declare-fun Tm_refine_e848c13c1439d56ab11a603efcdce3ff (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(23,14-29,29); use=InsertionSort2.fst(23,14-29,29)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_e848c13c1439d56ab11a603efcdce3ff @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_e848c13c1439d56ab11a603efcdce3ff @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_e848c13c1439d56ab11a603efcdce3ff))

:named refinement_kinding_Tm_refine_e848c13c1439d56ab11a603efcdce3ff))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(23,14-29,29); use=InsertionSort2.fst(23,14-29,29)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e848c13c1439d56ab11a603efcdce3ff @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=InsertionSort2.fst(23,14-29,29); use=InsertionSort2.fst(23,14-29,29)
(or 
;; def=InsertionSort2.fst(25,2-29,29); use=InsertionSort2.fst(25,2-29,29)
(Valid 
;; def=InsertionSort2.fst(25,2-29,29); use=InsertionSort2.fst(25,2-29,29)
...
;; def=InsertionSort2.fst(23,14-29,29); use=InsertionSort2.fst(23,14-29,29)
(and 
;; def=InsertionSort2.fst(23,14-24,18); use=InsertionSort2.fst(23,14-24,18)
(Valid 
;; def=InsertionSort2.fst(23,14-24,18); use=InsertionSort2.fst(23,14-24,18)
...
;; def=InsertionSort2.fst(23,26-29,29); use=InsertionSort2.fst(23,26-29,29)
(or 
;; def=InsertionSort2.fst(25,2-29,29); use=InsertionSort2.fst(25,2-29,29)
(Valid 
;; def=InsertionSort2.fst(25,2-29,29); use=InsertionSort2.fst(25,2-29,29)
...
;; def=InsertionSort2.fst(23,26-29,29); use=InsertionSort2.fst(23,26-29,29)
(and 
;; def=InsertionSort2.fst(23,26-24,20); use=InsertionSort2.fst(23,26-24,20)
(Valid 
;; def=InsertionSort2.fst(23,26-24,20); use=InsertionSort2.fst(23,26-24,20)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_e848c13c1439d56ab11a603efcdce3ff))

:named refinement_interpretation_Tm_refine_e848c13c1439d56ab11a603efcdce3ff))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e848c13c1439d56ab11a603efcdce3ff
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(23,14-29,29); use=InsertionSort2.fst(23,14-29,29)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e848c13c1439d56ab11a603efcdce3ff @x0
@x1
@x2)))
(Valid (Prims.hasEq (Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e848c13c1439d56ab11a603efcdce3ff @x0
@x1
@x2))))
:qid haseqTm_refine_e848c13c1439d56ab11a603efcdce3ff))

:named haseqTm_refine_e848c13c1439d56ab11a603efcdce3ff))
(declare-fun InsertionSort2.insert_ (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;x: a ->     l: Prims.list a ->     k: (_: a -> Prims.int){a << a \/ a === a /\ (x << x \/ x === x /\ l << l)}   -> Prims.list a
(declare-fun Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a
Tm_type)
:named kinding_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(23,14-29,29); use=InsertionSort2.fst(23,14-29,29)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a))
:qid InsertionSort2_pre_typing_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a))

:named InsertionSort2_pre_typing_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(23,14-29,29); use=InsertionSort2.fst(23,14-29,29)
(forall ((@x0 Term))
...
(Prims.list @x1))
(HasType @x4
(Tm_refine_e848c13c1439d56ab11a603efcdce3ff @x1
@x2
@x3)))
...
@x3)
@x4))
:qid InsertionSort2_interpretation_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid InsertionSort2_interpretation_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a.2))
...
@x1)
@x2))
:qid InsertionSort2_interpretation_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a.3))
...
@x2)
@x3))
:qid InsertionSort2_interpretation_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a))
:qid InsertionSort2_interpretation_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a))

:named InsertionSort2_interpretation_Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a))
(declare-fun InsertionSort2.insert_@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(24,8-24,15); use=InsertionSort2.fst(24,8-24,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT InsertionSort2.insert_@tok
@x0)
@x1)
@x2)
@x3)
(InsertionSort2.insert_ @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT InsertionSort2.insert_@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_InsertionSort2.insert_))

:named token_correspondence_InsertionSort2.insert_))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(24,8-24,15); use=InsertionSort2.fst(24,8-24,15)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType InsertionSort2.insert_@tok
Tm_arrow_96c376633e7c74f3db41dd7cd6e2e71a))
...
@x3)
@x4)
(InsertionSort2.insert_ @x1
@x2
@x3
@x4))
 

:pattern ((InsertionSort2.insert_ @x1
@x2
@x3
@x4))
:qid function_token_typing_InsertionSort2.insert_.1))
)
 

:pattern ((ApplyTT @x0
InsertionSort2.insert_@tok))
:qid function_token_typing_InsertionSort2.insert_))

:named function_token_typing_InsertionSort2.insert_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(24,8-24,15); use=InsertionSort2.fst(24,8-24,15)
...
(Prims.list @x0))
(HasType @x3
(Tm_refine_e848c13c1439d56ab11a603efcdce3ff @x0
@x1
@x2)))
(HasType (InsertionSort2.insert_ @x0
@x1
@x2
@x3)
(Prims.list @x0)))
...
:pattern ((InsertionSort2.insert_ @x0
@x1
@x2
@x3))
:qid typing_InsertionSort2.insert_))

:named typing_InsertionSort2.insert_))
...
;         l == b :: b ==>
;         (forall (k: Prims.pure_post (Prims.list a)).
;             (forall (x: Prims.list a). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;             ~(k x <= k b = true) ==>
;             (forall (b: Prims.bool). k x <= k b == b ==> a << a \/ (x << x \/ b << l)))))
...
;; def=Prims.fst(402,27-402,88); use=InsertionSort2.fst(25,2-29,29)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(25,2-29,29)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(25,2-29,29)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(25,2-29,29)
(and (implies 
;; def=InsertionSort2.fst(24,21-24,22); use=InsertionSort2.fst(25,8-25,9)
(and 
;; def=InsertionSort2.fst(24,21-24,22); use=InsertionSort2.fst(25,8-25,9)
(not 
;; def=InsertionSort2.fst(24,21-24,22); use=InsertionSort2.fst(25,8-25,9)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=InsertionSort2.fst(25,2-29,29)
(not 
;; def=InsertionSort2.fst(24,21-24,22); use=InsertionSort2.fst(25,8-25,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
;; def=Prims.fst(413,99-413,120); use=InsertionSort2.fst(25,2-29,29)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=InsertionSort2.fst(24,21-27,10); use=InsertionSort2.fst(25,8-27,10)
(= x_374b44ccfcb77ed85d505dbc44265913_2
...
;; def=Prims.fst(389,19-389,21); use=InsertionSort2.fst(25,2-29,29)
(not 
;; def=InsertionSort2.fst(28,7-28,18); use=InsertionSort2.fst(28,7-28,18)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
x_157b99e815dc43d99415725267e9c452_1)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x1))
(BoxBool true))
)
)
...
;; def=InsertionSort2.fst(28,7-29,29); use=InsertionSort2.fst(28,7-29,29)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
x_157b99e815dc43d99415725267e9c452_1)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x1))
...
;; def=InsertionSort2.fst(23,14-29,29); use=InsertionSort2.fst(29,27-29,28)
(or label_2

;; def=InsertionSort2.fst(25,2-29,29); use=InsertionSort2.fst(29,27-29,28)
(Valid 
;; def=InsertionSort2.fst(25,2-29,29); use=InsertionSort2.fst(29,27-29,28)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InsertionSort2.insert', 1)
; STATUS: unsat
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun InsertionSort2.insert_.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun InsertionSort2.insert_.fuel_instrumented_token () Term)
(declare-fun InsertionSort2.insert_ (Term Term Term Term) Term)
(declare-fun InsertionSort2.insert_@tok () Term)



;;;;;;;;;;;;;;;;x: a -> l: Prims.list a -> k: (_: a -> Prims.int) -> Prims.list a
(declare-fun Tm_arrow_cf79e372fae1e06d10adcd13ca6afa2e () Term)

; </end encoding let rec insert'>


; encoding sigelt val InsertionSort2.insert'_sorted


; <Skipped val InsertionSort2.insert'_sorted/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InsertionSort2.insert'; Namespace InsertionSort2
(assert (! 
;; def=InsertionSort2.fst(24,8-24,15); use=InsertionSort2.fst(24,8-24,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
...
(Prims.list @x0))
(HasType @x3
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0)))
(HasType (InsertionSort2.insert_ @x0
@x1
@x2
@x3)
...
;;; Fact-ids: Name GenericSort.sorted; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(29,8-29,14); use=GenericSort.fst(29,8-29,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0)))
(HasType (GenericSort.sorted @x0
@x1
@x2)
Prims.bool))
 

:pattern ((GenericSort.sorted @x0
@x1
@x2))
:qid typing_GenericSort.sorted))

:named typing_GenericSort.sorted))
...
(HasType @x4
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(HasType (InsertionSort2.insert_.fuel_instrumented @u0
@x1
@x2
@x3
@x4)
...
:pattern ((InsertionSort2.insert_.fuel_instrumented @u0
@x1
@x2
@x3
@x4))
:qid token_correspondence_InsertionSort2.insert_.fuel_instrumented))

:named token_correspondence_InsertionSort2.insert_.fuel_instrumented))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name GenericSort.sorted; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(29,8-29,14); use=GenericSort.fst(29,8-29,14)
...
(HasType @x3
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(HasType (GenericSort.sorted.fuel_instrumented @u0
@x1
@x2
@x3)
Prims.bool))
...
:pattern ((GenericSort.sorted.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_GenericSort.sorted.fuel_instrumented))

:named token_correspondence_GenericSort.sorted.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: InsertionSort2.insert'
;;; Fact-ids: Name InsertionSort2.insert'; Namespace InsertionSort2
(assert (! 
;; def=InsertionSort2.fst(24,8-24,15); use=InsertionSort2.fst(24,8-24,15)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
(HasType @x4
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(= (InsertionSort2.insert_.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4)
...
(let ((@lb6 (Prims.op_LessThanOrEqual (ApplyTT @x4
@x2)
(ApplyTT @x4
(Prims.Cons_hd @lb5)))))
(ite (= @lb6
...
(Prims.Cons @x1
(Prims.Cons_hd @lb5)
(InsertionSort2.insert_.fuel_instrumented @u0
@x1
@x2
(Prims.Cons_tl @lb5)
@x4))))
...
:pattern ((InsertionSort2.insert_.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4))
:qid equation_with_fuel_InsertionSort2.insert_.fuel_instrumented))

:named equation_with_fuel_InsertionSort2.insert_.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: GenericSort.sorted
;;; Fact-ids: Name GenericSort.sorted; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(29,8-29,14); use=GenericSort.fst(29,8-29,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(= (GenericSort.sorted.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x2))
...
(Prims.op_AmpAmp (Prims.op_LessThanOrEqual (ApplyTT @x3
(Prims.Cons_hd @lb4))
(ApplyTT @x3
(Prims.Cons_hd (Prims.Cons_tl @lb4))))
(GenericSort.sorted.fuel_instrumented @u0
@x1
(Prims.Cons @x1
(Prims.Cons_hd (Prims.Cons_tl @lb4))
...
:pattern ((GenericSort.sorted.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_GenericSort.sorted.fuel_instrumented))

:named equation_with_fuel_GenericSort.sorted.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name InsertionSort2.insert'; Namespace InsertionSort2
(assert (! 
;; def=InsertionSort2.fst(24,8-24,15); use=InsertionSort2.fst(24,8-24,15)
...
@x3
@x4)
(InsertionSort2.insert_.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid @fuel_irrelevance_InsertionSort2.insert_.fuel_instrumented))

:named @fuel_irrelevance_InsertionSort2.insert_.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name GenericSort.sorted; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(29,8-29,14); use=GenericSort.fst(29,8-29,14)
...
@x2
@x3)
(GenericSort.sorted.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_GenericSort.sorted.fuel_instrumented))

:named @fuel_irrelevance_GenericSort.sorted.fuel_instrumented))
...
@x2
@x3)
(InsertionSort2.insert_.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_correspondence_InsertionSort2.insert_.fuel_instrumented))

:named @fuel_correspondence_InsertionSort2.insert_.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name GenericSort.sorted; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(29,8-29,14); use=GenericSort.fst(29,8-29,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (GenericSort.sorted @x0
@x1
@x2)
(GenericSort.sorted.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_GenericSort.sorted.fuel_instrumented))

:named @fuel_correspondence_GenericSort.sorted.fuel_instrumented))
(push) ;; push{2

; Starting query at InsertionSort2.fst(35,2-39,30)
...
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(31,66-34,25); use=InsertionSort2.fst(34,8-34,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_3))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InsertionSort2.insert__sorted (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InsertionSort2.insert__sorted@tok () Term)
...
;   GenericSort.sorted l k /\
;   (forall (pure_result: Prims.unit).
;       GenericSort.sorted (InsertionSort2.insert' x l k) k ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l && Nil? l.tl) /\ ~(Cons? l) ==> Prims.l_False) /\
...
;                   (k x <= k b == true ==> (forall (any_result: Prims.unit). k any_result)) /\
;                   (~(k x <= k b = true) ==>
;                     (forall (b: Prims.bool).
;                         k x <= k b == b ==>
;                         (a << a \/ (x << x \/ b << l)) /\
;                         (forall (any_result: (_: a -> Prims.int)).
;                             k == any_result ==>
;                             GenericSort.sorted b k /\
;                             (forall (pure_result: Prims.unit).
;                                 GenericSort.sorted (InsertionSort2.insert' x b k) k ==>
;                                 k pure_result)))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec insert'_sorted`
...
;;; Fact-ids: 
(assert (! (not 
;; def=InsertionSort2.fst(35,2-39,30); use=InsertionSort2.fst(35,2-39,30)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=InsertionSort2.fst(32,18-32,30); use=InsertionSort2.fst(35,2-39,30)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2
x_582acf81e02a6e4176cba5e2730f867d_3))


;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(35,2-39,30)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=InsertionSort2.fst(33,17-33,43); use=InsertionSort2.fst(35,2-39,30)
(or label_2

;; def=InsertionSort2.fst(33,17-33,43); use=InsertionSort2.fst(35,2-39,30)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insert_ x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_1
x_374b44ccfcb77ed85d505dbc44265913_2
x_582acf81e02a6e4176cba5e2730f867d_3)
x_582acf81e02a6e4176cba5e2730f867d_3))
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(35,2-39,30)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(35,2-39,30)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=InsertionSort2.fst(35,2-39,30)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(35,2-39,30)
(Valid 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(35,2-39,30)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(35,2-39,30)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(35,2-39,30)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(35,2-39,30)
(and (implies 
;; def=InsertionSort2.fst(34,28-39,30); use=InsertionSort2.fst(35,2-39,30)
(and 
;; def=InsertionSort2.fst(34,28-34,29); use=InsertionSort2.fst(35,8-35,9)
(not 
;; def=InsertionSort2.fst(34,28-34,29); use=InsertionSort2.fst(35,8-35,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
x_374b44ccfcb77ed85d505dbc44265913_2))
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
(Prims.__proj__Cons__item__tl x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))))
)
...
label_3)
(implies 
;; def=InsertionSort2.fst(34,28-36,6); use=InsertionSort2.fst(35,8-36,6)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=InsertionSort2.fst(35,2-39,30)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(35,2-39,30)
(Valid 
;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(35,2-39,30)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=InsertionSort2.fst(35,2-39,30)
(not 
;; def=InsertionSort2.fst(34,28-34,29); use=InsertionSort2.fst(35,8-35,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort2.fst(35,2-39,30)
(and 
;; def=Prims.fst(413,99-413,120); use=InsertionSort2.fst(35,2-39,30)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=InsertionSort2.fst(34,28-36,12); use=InsertionSort2.fst(35,8-36,12)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
;; def=InsertionSort2.fst(34,28-37,10); use=InsertionSort2.fst(35,8-37,10)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort2.fst(35,2-39,30)
(and (implies 
;; def=InsertionSort2.fst(38,7-38,18); use=InsertionSort2.fst(38,7-38,18)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
x_157b99e815dc43d99415725267e9c452_1)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x2))
...
;; def=InsertionSort2.fst(38,7-39,30); use=InsertionSort2.fst(38,7-39,30)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
x_157b99e815dc43d99415725267e9c452_1)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x2))
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(35,2-39,30)
(and 
;; def=InsertionSort2.fst(31,21-39,30); use=InsertionSort2.fst(39,29-39,30)
(or label_4

;; def=InsertionSort2.fst(35,2-39,30); use=InsertionSort2.fst(39,29-39,30)
(Valid 
;; def=InsertionSort2.fst(35,2-39,30); use=InsertionSort2.fst(39,29-39,30)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=InsertionSort2.fst(31,54-34,31); use=InsertionSort2.fst(35,2-39,30)
(= x_582acf81e02a6e4176cba5e2730f867d_3
@x6)
)

;; def=Prims.fst(441,29-441,97); use=InsertionSort2.fst(39,9-39,23)
(and 
;; def=InsertionSort2.fst(32,18-32,30); use=InsertionSort2.fst(39,9-39,23)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(39,9-39,23)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=InsertionSort2.fst(33,17-33,43); use=InsertionSort2.fst(39,9-39,23)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insert_ x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_1
@x3
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(39,9-39,23)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(39,9-39,23)
(ApplyTT @x4
@x7)
...
; encoding sigelt let rec insert'_sorted


; <Start encoding let rec insert'_sorted>
...
; </end encoding let rec insert'_sorted>


; encoding sigelt val InsertionSort2.insert'_stable


; <Skipped val InsertionSort2.insert'_stable/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GenericStability.stable; Namespace GenericStability
(assert (! 
;; def=GenericStability.fst(91,5-91,11); use=GenericStability.fst(91,5-91,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
(HasType @x3
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0)))
(HasType (GenericStability.stable @x0
@x1
@x2
@x3)
Prims.logical))
...
:pattern ((GenericStability.stable @x0
@x1
@x2
@x3))
:qid typing_GenericStability.stable))

:named typing_GenericStability.stable))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GenericStability.filter_eq; Namespace GenericStability
(assert (! 
;; def=GenericStability.fst(35,8-35,17); use=GenericStability.fst(35,8-35,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x3
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0)))
(HasType (GenericStability.filter_eq @x0
@x1
@x2
@x3)
(Prims.list @x0)))
...
:pattern ((GenericStability.filter_eq @x0
@x1
@x2
@x3))
:qid typing_GenericStability.filter_eq))

:named typing_GenericStability.filter_eq))
;;;;;;;;;;;;;;;;free var typing
...
(HasType @x4
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(HasType (GenericStability.filter_eq.fuel_instrumented @u0
@x1
@x2
@x3
@x4)
...
:pattern ((GenericStability.filter_eq.fuel_instrumented @u0
@x1
@x2
@x3
@x4))
:qid token_correspondence_GenericStability.filter_eq.fuel_instrumented))

:named token_correspondence_GenericStability.filter_eq.fuel_instrumented))
;;;;;;;;;;;;;;;;Typing correspondence of token to term
;;; Fact-ids: Name FStar.List.Tot.Base.append; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(119,8-119,14); use=FStar.List.Tot.Base.fst(119,8-119,14)
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: GenericStability.filter_eq
;;; Fact-ids: Name GenericStability.filter_eq; Namespace GenericStability
(assert (! 
;; def=GenericStability.fst(35,8-35,17); use=GenericStability.fst(35,8-35,17)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
(HasType @x4
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(= (GenericStability.filter_eq.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4)
...
(Prims.Cons @x1
(Prims.Cons_hd @lb5)
(GenericStability.filter_eq.fuel_instrumented @u0
@x1
@x2
(Prims.Cons_tl @lb5)
@x4))
...
:pattern ((GenericStability.filter_eq.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4))
:qid equation_with_fuel_GenericStability.filter_eq.fuel_instrumented))

:named equation_with_fuel_GenericStability.filter_eq.fuel_instrumented))
...
;;;;;;;;;;;;;;;;Equation for GenericStability.stable
;;; Fact-ids: Name GenericStability.stable; Namespace GenericStability
(assert (! 
;; def=GenericStability.fst(91,5-91,11); use=GenericStability.fst(91,5-91,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Valid (GenericStability.stable @x0
@x1
@x2
@x3))

;; def=GenericStability.fst(91,69-91,116); use=GenericStability.fst(91,69-91,116)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.int)

;; def=GenericStability.fst(91,79-91,116); use=GenericStability.fst(91,79-91,116)
(= (GenericStability.filter_eq @x0
@x4
@x1
@x3)
(GenericStability.filter_eq @x0
...
;;no pats
:qid equation_GenericStability.stable.1))
)
...
@x2
@x3))
:qid equation_GenericStability.stable))

:named equation_GenericStability.stable))
...
;;;;;;;;;;;;;;;;Prop-typing for GenericStability.stable
;;; Fact-ids: Name GenericStability.stable; Namespace GenericStability
(assert (! 
;; def=GenericStability.fst(91,5-91,11); use=GenericStability.fst(91,5-91,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0)))
(Valid (Prims.subtype_of (GenericStability.stable @x0
@x1
@x2
@x3)
Prims.unit)))
...
:pattern ((Prims.subtype_of (GenericStability.stable @x0
@x1
@x2
@x3)
Prims.unit))
:qid defn_equation_GenericStability.stable))

:named defn_equation_GenericStability.stable))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name GenericStability.filter_eq; Namespace GenericStability
(assert (! 
;; def=GenericStability.fst(35,8-35,17); use=GenericStability.fst(35,8-35,17)
...
@x3
@x4)
(GenericStability.filter_eq.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid @fuel_irrelevance_GenericStability.filter_eq.fuel_instrumented))

:named @fuel_irrelevance_GenericStability.filter_eq.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name FStar.List.Tot.Base.append; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(119,8-119,14); use=FStar.List.Tot.Base.fst(119,8-119,14)
...
@x2
@x3)
(GenericStability.filter_eq.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_correspondence_GenericStability.filter_eq.fuel_instrumented))

:named @fuel_correspondence_GenericStability.filter_eq.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name FStar.List.Tot.Base.append; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(119,8-119,14); use=FStar.List.Tot.Base.fst(119,8-119,14)
...
; Starting query at InsertionSort2.fst(45,2-49,30)
...
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(41,66-44,25); use=InsertionSort2.fst(44,8-44,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_3))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InsertionSort2.insert__stable (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InsertionSort2.insert__stable@tok () Term)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
...
;   GenericSort.sorted l k /\
;   (forall (pure_result: Prims.unit).
;       GenericStability.stable (InsertionSort2.insert' x l k) (x :: l) k ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;       (l == [] ==> (forall (any_result: Prims.unit). k any_result)) /\
...
;                   (forall (pure_result: Prims.unit).
;                       (forall (x: Prims.int).
;                           GenericStability.filter_eq x [x] k @
;                           GenericStability.filter_eq x (InsertionSort2.insert' x b k) k =
;                           GenericStability.filter_eq x ([x] @ InsertionSort2.insert' x b k) k) ==>
;                       k pure_result)) /\
;                 (~(k x <= k b = true) ==>
;                   (forall (b: Prims.bool).
;                       k x <= k b == b ==>
...
;                           GenericSort.sorted b k /\
;                           (forall (pure_result: Prims.unit).
;                               GenericStability.stable (InsertionSort2.insert' x b k) (x :: b) k ==>
;                               k pure_result))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec insert'_stable`
...
;;; Fact-ids: 
(assert (! (not 
;; def=InsertionSort2.fst(45,2-49,30); use=InsertionSort2.fst(45,2-49,30)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=InsertionSort2.fst(42,18-42,30); use=InsertionSort2.fst(45,2-49,30)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2
x_582acf81e02a6e4176cba5e2730f867d_3))


;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(45,2-49,30)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=InsertionSort2.fst(43,17-43,50); use=InsertionSort2.fst(45,2-49,30)
(or label_2

;; def=InsertionSort2.fst(43,17-43,50); use=InsertionSort2.fst(45,2-49,30)
(Valid 
;; def=InsertionSort2.fst(43,17-43,50); use=InsertionSort2.fst(45,2-49,30)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insert_ x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_1
x_374b44ccfcb77ed85d505dbc44265913_2
x_582acf81e02a6e4176cba5e2730f867d_3)
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(45,2-49,30)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(45,2-49,30)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=InsertionSort2.fst(45,2-49,30)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(45,2-49,30)
(Valid 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(45,2-49,30)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(45,2-49,30)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(45,2-49,30)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(45,2-49,30)
(and (implies 
;; def=InsertionSort2.fst(44,28-44,29); use=InsertionSort2.fst(45,8-45,9)
(and 
;; def=InsertionSort2.fst(44,28-44,29); use=InsertionSort2.fst(45,8-45,9)
(not 
;; def=InsertionSort2.fst(44,28-44,29); use=InsertionSort2.fst(45,8-45,9)
...
label_3)
(implies 
;; def=InsertionSort2.fst(44,28-46,6); use=InsertionSort2.fst(45,8-46,6)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=InsertionSort2.fst(45,2-49,30)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(45,2-49,30)
(Valid 
;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(45,2-49,30)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=InsertionSort2.fst(45,2-49,30)
(not 
;; def=InsertionSort2.fst(44,28-44,29); use=InsertionSort2.fst(45,8-45,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
;; def=Prims.fst(413,99-413,120); use=InsertionSort2.fst(45,2-49,30)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=InsertionSort2.fst(44,28-47,10); use=InsertionSort2.fst(45,8-47,10)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort2.fst(45,2-49,30)
(and (implies 
;; def=InsertionSort2.fst(48,7-48,18); use=InsertionSort2.fst(48,7-48,18)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
x_157b99e815dc43d99415725267e9c452_1)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x2))
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(48,24-48,40)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=GenericStability.fst(52,17-52,90); use=InsertionSort2.fst(48,24-48,40)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=InsertionSort2.fst(48,24-48,40)
(= (FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
(GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
@x6
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(48,24-48,40)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(48,24-48,40)
(ApplyTT @x4
@x5)
...
;; def=InsertionSort2.fst(48,7-49,30); use=InsertionSort2.fst(48,7-49,30)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
x_157b99e815dc43d99415725267e9c452_1)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x2))
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(45,2-49,30)
(and 
;; def=InsertionSort2.fst(41,21-49,30); use=InsertionSort2.fst(49,29-49,30)
(or label_4

;; def=InsertionSort2.fst(45,2-49,30); use=InsertionSort2.fst(49,29-49,30)
(Valid 
;; def=InsertionSort2.fst(45,2-49,30); use=InsertionSort2.fst(49,29-49,30)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=InsertionSort2.fst(41,54-44,31); use=InsertionSort2.fst(45,2-49,30)
(= x_582acf81e02a6e4176cba5e2730f867d_3
@x6)
)

;; def=Prims.fst(441,29-441,97); use=InsertionSort2.fst(49,9-49,23)
(and 
;; def=InsertionSort2.fst(42,18-42,30); use=InsertionSort2.fst(49,9-49,23)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(49,9-49,23)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=InsertionSort2.fst(43,17-43,50); use=InsertionSort2.fst(49,9-49,23)
(Valid 
;; def=InsertionSort2.fst(43,17-43,50); use=InsertionSort2.fst(49,9-49,23)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insert_ x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(49,9-49,23)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(49,9-49,23)
(ApplyTT @x4
@x7)
...
; encoding sigelt let rec insert'_stable


; <Start encoding let rec insert'_stable>
...
; </end encoding let rec insert'_stable>


; encoding sigelt val InsertionSort2.insert'_permutation


; <Skipped val InsertionSort2.insert'_permutation/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GenericSort.permutation_2; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(71,5-71,18); use=GenericSort.fst(71,5-71,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_refine_414d0a9f578ab0048252f8c8f552b99f)
(HasType @x1
...
(HasType @x3
(Prims.list @x0)))
(HasType (GenericSort.permutation_2 @x0
@x1
@x2
@x3)
Prims.logical))
...
:pattern ((GenericSort.permutation_2 @x0
@x1
@x2
@x3))
:qid typing_GenericSort.permutation_2))

:named typing_GenericSort.permutation_2))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Equation for GenericSort.permutation_2
;;; Fact-ids: Name GenericSort.permutation_2; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(71,5-71,18); use=GenericSort.fst(71,5-71,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Valid (GenericSort.permutation_2 @x0
@x1
@x2
@x3))

;; def=GenericSort.fst(72,4-73,36); use=GenericSort.fst(72,4-73,36)
(and 
;; def=GenericSort.fst(72,4-72,48); use=GenericSort.fst(72,4-72,48)
(forall ((@x4 Term))
 (! (implies (HasType @x4
@x0)

;; def=GenericSort.fst(72,15-72,47); use=GenericSort.fst(72,15-72,47)
(= (FStar.List.Tot.Base.mem @x0
@x4
@x1)
(Prims.op_BarBar (FStar.List.Tot.Base.mem @x0
@x4
@x2)
(FStar.List.Tot.Base.mem @x0
@x4
...
;;no pats
:qid equation_GenericSort.permutation_2.1))


;; def=GenericSort.fst(73,4-73,36); use=GenericSort.fst(73,4-73,36)
(= (FStar.List.Tot.Base.length @x0
@x1)
(Prims.op_Addition (FStar.List.Tot.Base.length @x0
@x2)
(FStar.List.Tot.Base.length @x0
@x3)))
)
...
@x2
@x3))
:qid equation_GenericSort.permutation_2))

:named equation_GenericSort.permutation_2))
;;;;;;;;;;;;;;;;Prop-typing for GenericSort.permutation_2
;;; Fact-ids: Name GenericSort.permutation_2; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(71,5-71,18); use=GenericSort.fst(71,5-71,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Prims.list @x0)))
(Valid (Prims.subtype_of (GenericSort.permutation_2 @x0
@x1
@x2
@x3)
Prims.unit)))
...
:pattern ((Prims.subtype_of (GenericSort.permutation_2 @x0
@x1
@x2
@x3)
Prims.unit))
:qid defn_equation_GenericSort.permutation_2))

:named defn_equation_GenericSort.permutation_2))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name FStar.List.Tot.Base.mem; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(240,8-240,11); use=FStar.List.Tot.Base.fst(240,8-240,11)
...
; Starting query at InsertionSort2.fst(54,2-59,35)
...
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(51,71-53,30); use=InsertionSort2.fst(53,8-53,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_3))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InsertionSort2.insert__permutation (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InsertionSort2.insert__permutation@tok () Term)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit).
;       GenericSort.permutation_2 (InsertionSort2.insert' x l k) l [x] ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l && Nil? l.tl) /\ ~(Cons? l) ==> Prims.l_False) /\
;       (l == [] ==> (forall (any_result: Prims.unit). k any_result)) /\
...
;                             k == any_result ==>
;                             (forall (pure_result: Prims.unit).
;                                 GenericSort.permutation_2 (InsertionSort2.insert' x b k) b [x] ==>
;                                 k pure_result)))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec insert'_permutation`
...
;;; Fact-ids: 
(assert (! (not 
;; def=InsertionSort2.fst(54,2-59,35); use=InsertionSort2.fst(54,2-59,35)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(54,2-59,35)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=InsertionSort2.fst(52,16-52,53); use=InsertionSort2.fst(54,2-59,35)
(or label_2

;; def=InsertionSort2.fst(52,16-52,53); use=InsertionSort2.fst(54,2-59,35)
(Valid 
;; def=InsertionSort2.fst(52,16-52,53); use=InsertionSort2.fst(54,2-59,35)
(GenericSort.permutation_2 x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insert_ x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_1
x_374b44ccfcb77ed85d505dbc44265913_2
x_582acf81e02a6e4176cba5e2730f867d_3)
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(54,2-59,35)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(54,2-59,35)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=InsertionSort2.fst(54,2-59,35)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(54,2-59,35)
(Valid 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(54,2-59,35)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(54,2-59,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(54,2-59,35)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(54,2-59,35)
(and (implies 
;; def=InsertionSort2.fst(53,33-59,35); use=InsertionSort2.fst(54,2-59,35)
(and 
;; def=InsertionSort2.fst(53,33-53,34); use=InsertionSort2.fst(54,8-54,9)
(not 
;; def=InsertionSort2.fst(53,33-53,34); use=InsertionSort2.fst(54,8-54,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
label_3)
(implies 
;; def=InsertionSort2.fst(53,33-55,6); use=InsertionSort2.fst(54,8-55,6)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=InsertionSort2.fst(54,2-59,35)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(54,2-59,35)
(Valid 
;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(54,2-59,35)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=InsertionSort2.fst(54,2-59,35)
(not 
;; def=InsertionSort2.fst(53,33-53,34); use=InsertionSort2.fst(54,8-54,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort2.fst(54,2-59,35)
(and 
;; def=Prims.fst(413,99-413,120); use=InsertionSort2.fst(54,2-59,35)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=InsertionSort2.fst(53,33-56,7); use=InsertionSort2.fst(54,8-56,7)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
;; def=InsertionSort2.fst(53,33-57,10); use=InsertionSort2.fst(54,8-57,10)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort2.fst(54,2-59,35)
(and (implies 
;; def=InsertionSort2.fst(58,7-58,18); use=InsertionSort2.fst(58,7-58,18)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
x_157b99e815dc43d99415725267e9c452_1)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x2))
...
;; def=InsertionSort2.fst(58,7-59,35); use=InsertionSort2.fst(58,7-59,35)
(= (Prims.op_LessThanOrEqual (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
x_157b99e815dc43d99415725267e9c452_1)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x2))
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(54,2-59,35)
(and 
;; def=InsertionSort2.fst(51,26-59,35); use=InsertionSort2.fst(59,34-59,35)
(or label_4

;; def=InsertionSort2.fst(54,2-59,35); use=InsertionSort2.fst(59,34-59,35)
(Valid 
;; def=InsertionSort2.fst(54,2-59,35); use=InsertionSort2.fst(59,34-59,35)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=InsertionSort2.fst(51,59-53,36); use=InsertionSort2.fst(54,2-59,35)
(= x_582acf81e02a6e4176cba5e2730f867d_3
@x6)
)

;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(59,9-59,28)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=InsertionSort2.fst(52,16-52,53); use=InsertionSort2.fst(59,9-59,28)
(Valid 
;; def=InsertionSort2.fst(52,16-52,53); use=InsertionSort2.fst(59,9-59,28)
(GenericSort.permutation_2 x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insert_ x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(59,9-59,28)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(59,9-59,28)
(ApplyTT @x4
@x7)
...
; encoding sigelt let rec insert'_permutation


; <Start encoding let rec insert'_permutation>
...
; </end encoding let rec insert'_permutation>


; encoding sigelt val InsertionSort2.insertionsort'


; <Skipped val InsertionSort2.insertionsort'/>

(push) ;; push{2

; Starting query at InsertionSort2.fst(63,2-66,48)
...
;;;;;;;;;;;;;;;;k : _: a -> Prims.int (_: a -> Prims.int)
(declare-fun x_582acf81e02a6e4176cba5e2730f867d_2 () Term)
;;;;;;;;;;;;;;;;_: a -> Prims.int
(declare-fun Tm_arrow_605ada36aef613d3875663fdd1971cfd () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_605ada36aef613d3875663fdd1971cfd
;;; Fact-ids: 
...
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(61,59-62,25); use=InsertionSort2.fst(62,8-62,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
;;; Fact-ids: 
(assert (! (HasType x_582acf81e02a6e4176cba5e2730f867d_2
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
:named binder_x_582acf81e02a6e4176cba5e2730f867d_2))

(declare-fun Tm_refine_476671edc7b72c4cf92589018cec7759 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(61,21-66,48); use=InsertionSort2.fst(61,21-66,48)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_476671edc7b72c4cf92589018cec7759 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_476671edc7b72c4cf92589018cec7759 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_476671edc7b72c4cf92589018cec7759))

:named refinement_kinding_Tm_refine_476671edc7b72c4cf92589018cec7759))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(61,21-66,48); use=InsertionSort2.fst(61,21-66,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_476671edc7b72c4cf92589018cec7759 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x2))
...
;; def=InsertionSort2.fst(61,21-66,48); use=InsertionSort2.fst(61,21-66,48)
(or 
;; def=InsertionSort2.fst(63,2-66,48); use=InsertionSort2.fst(63,2-66,48)
(Valid 
;; def=InsertionSort2.fst(63,2-66,48); use=InsertionSort2.fst(63,2-66,48)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=InsertionSort2.fst(61,21-66,48); use=InsertionSort2.fst(61,21-66,48)
(and 
;; def=InsertionSort2.fst(61,21-62,25); use=InsertionSort2.fst(61,21-62,25)
(Valid 
;; def=InsertionSort2.fst(61,21-62,25); use=InsertionSort2.fst(61,21-62,25)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
(Tm_refine_476671edc7b72c4cf92589018cec7759 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_476671edc7b72c4cf92589018cec7759))

:named refinement_interpretation_Tm_refine_476671edc7b72c4cf92589018cec7759))
;;;;;;;;;;;;;;;;haseq for Tm_refine_476671edc7b72c4cf92589018cec7759
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(61,21-66,48); use=InsertionSort2.fst(61,21-66,48)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_476671edc7b72c4cf92589018cec7759 @x0
@x1)))
(Valid (Prims.hasEq (Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_476671edc7b72c4cf92589018cec7759 @x0
@x1))))
:qid haseqTm_refine_476671edc7b72c4cf92589018cec7759))

:named haseqTm_refine_476671edc7b72c4cf92589018cec7759))
(declare-fun InsertionSort2.insertionsort_ (Term Term Term) Term)


;;;;;;;;;;;;;;;;l: Prims.list a -> k: (_: a -> Prims.int){a << a \/ a === a /\ l << l} -> Prims.list a
(declare-fun Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6
Tm_type)
:named kinding_Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(61,21-66,48); use=InsertionSort2.fst(61,21-66,48)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6))
:qid InsertionSort2_pre_typing_Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6))

:named InsertionSort2_pre_typing_Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(61,21-66,48); use=InsertionSort2.fst(61,21-66,48)
(forall ((@x0 Term))
...
(Prims.list @x1))
(HasType @x3
(Tm_refine_476671edc7b72c4cf92589018cec7759 @x1
@x2)))
...
@x2)
@x3))
:qid InsertionSort2_interpretation_Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid InsertionSort2_interpretation_Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6.2))
...
@x1)
@x2))
:qid InsertionSort2_interpretation_Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6))
:qid InsertionSort2_interpretation_Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6))

:named InsertionSort2_interpretation_Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6))
(declare-fun InsertionSort2.insertionsort_@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(62,8-62,22); use=InsertionSort2.fst(62,8-62,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT InsertionSort2.insertionsort_@tok
@x0)
@x1)
@x2)
(InsertionSort2.insertionsort_ @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT InsertionSort2.insertionsort_@tok
@x0)
@x1)
@x2))
:qid token_correspondence_InsertionSort2.insertionsort_))

:named token_correspondence_InsertionSort2.insertionsort_))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(62,8-62,22); use=InsertionSort2.fst(62,8-62,22)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType InsertionSort2.insertionsort_@tok
Tm_arrow_4d8fdd08e900b7186b6f5cdd457aa2c6))
...
@x2)
@x3)
(InsertionSort2.insertionsort_ @x1
@x2
@x3))
 

:pattern ((InsertionSort2.insertionsort_ @x1
@x2
@x3))
:qid function_token_typing_InsertionSort2.insertionsort_.1))
)
 

:pattern ((ApplyTT @x0
InsertionSort2.insertionsort_@tok))
:qid function_token_typing_InsertionSort2.insertionsort_))

:named function_token_typing_InsertionSort2.insertionsort_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(62,8-62,22); use=InsertionSort2.fst(62,8-62,22)
...
(Prims.list @x0))
(HasType @x2
(Tm_refine_476671edc7b72c4cf92589018cec7759 @x0
@x1)))
(HasType (InsertionSort2.insertionsort_ @x0
@x1
@x2)
(Prims.list @x0)))
 

:pattern ((InsertionSort2.insertionsort_ @x0
@x1
@x2))
:qid typing_InsertionSort2.insertionsort_))

:named typing_InsertionSort2.insertionsort_))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(Nil? l) /\ ~(Cons? l && Nil? l.tl) /\ ~(Cons? l) ==> Prims.l_False) /\
;   (~(Nil? l) ==>
;     ~(Cons? l && Nil? l.tl) ==> (forall (b: a) (b: Prims.list a). l == b :: b ==> a << a \/ b << l))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec insertionsort'`
...
;; def=Prims.fst(402,27-402,88); use=InsertionSort2.fst(63,2-66,48)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(63,2-66,48)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(63,2-66,48)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(63,2-66,48)
(and (implies 
;; def=InsertionSort2.fst(62,26-66,48); use=InsertionSort2.fst(63,2-66,48)
(and 
;; def=InsertionSort2.fst(62,26-62,27); use=InsertionSort2.fst(63,8-63,9)
(not 
;; def=InsertionSort2.fst(62,26-62,27); use=InsertionSort2.fst(63,8-63,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
label_1)
(implies 
;; def=Prims.fst(389,18-389,39); use=InsertionSort2.fst(63,2-66,48)
(and 
;; def=Prims.fst(389,19-389,21); use=InsertionSort2.fst(63,2-66,48)
(not 
;; def=InsertionSort2.fst(62,26-62,27); use=InsertionSort2.fst(63,8-63,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(413,99-413,120); use=InsertionSort2.fst(63,2-66,48)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=InsertionSort2.fst(62,26-66,10); use=InsertionSort2.fst(63,8-66,10)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
@x2))
...
;; def=InsertionSort2.fst(61,21-66,48); use=InsertionSort2.fst(66,44-66,45)
(or label_2

;; def=InsertionSort2.fst(63,2-66,48); use=InsertionSort2.fst(66,44-66,45)
(Valid 
;; def=InsertionSort2.fst(63,2-66,48); use=InsertionSort2.fst(66,44-66,45)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InsertionSort2.insertionsort', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_374b44ccfcb77ed85d505dbc44265913_1, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
; encoding sigelt let rec insertionsort'


; <Start encoding let rec insertionsort'>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun InsertionSort2.insertionsort_.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun InsertionSort2.insertionsort_.fuel_instrumented_token () Term)
(declare-fun InsertionSort2.insertionsort_ (Term Term Term) Term)
(declare-fun InsertionSort2.insertionsort_@tok () Term)



;;;;;;;;;;;;;;;;l: Prims.list a -> k: (_: a -> Prims.int) -> Prims.list a
(declare-fun Tm_arrow_93b4e975982fc9b3d2cdacb45754b800 () Term)

; </end encoding let rec insertionsort'>


; encoding sigelt val InsertionSort2.insertionsort'_sorted


; <Skipped val InsertionSort2.insertionsort'_sorted/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name InsertionSort2.insertionsort'; Namespace InsertionSort2
(assert (! 
;; def=InsertionSort2.fst(62,8-62,22); use=InsertionSort2.fst(62,8-62,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(HasType @x3
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(HasType (InsertionSort2.insertionsort_.fuel_instrumented @u0
@x1
@x2
@x3)
(Prims.list @x1)))
...
:pattern ((InsertionSort2.insertionsort_.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_InsertionSort2.insertionsort_.fuel_instrumented))

:named token_correspondence_InsertionSort2.insertionsort_.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: InsertionSort2.insertionsort'
;;; Fact-ids: Name InsertionSort2.insertionsort'; Namespace InsertionSort2
(assert (! 
;; def=InsertionSort2.fst(62,8-62,22); use=InsertionSort2.fst(62,8-62,22)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1)))
(= (InsertionSort2.insertionsort_.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x2))
...
(InsertionSort2.insert_ @x1
(Prims.Cons_hd @lb4)
(InsertionSort2.insertionsort_.fuel_instrumented @u0
@x1
(Prims.Cons_tl @lb4)
@x3)
@x3)
...
:pattern ((InsertionSort2.insertionsort_.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_InsertionSort2.insertionsort_.fuel_instrumented))

:named equation_with_fuel_InsertionSort2.insertionsort_.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name InsertionSort2.insertionsort'; Namespace InsertionSort2
(assert (! 
;; def=InsertionSort2.fst(62,8-62,22); use=InsertionSort2.fst(62,8-62,22)
...
@x2
@x3)
(InsertionSort2.insertionsort_.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_InsertionSort2.insertionsort_.fuel_instrumented))

:named @fuel_irrelevance_InsertionSort2.insertionsort_.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name InsertionSort2.insertionsort'; Namespace InsertionSort2
(assert (! 
;; def=InsertionSort2.fst(62,8-62,22); use=InsertionSort2.fst(62,8-62,22)
...
@x1
@x2)
(InsertionSort2.insertionsort_.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_InsertionSort2.insertionsort_.fuel_instrumented))

:named @fuel_correspondence_InsertionSort2.insertionsort_.fuel_instrumented))
(push) ;; push{2

; Starting query at InsertionSort2.fst(71,2-76,45)
...
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(68,66-70,32); use=InsertionSort2.fst(70,8-70,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_2))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InsertionSort2.insertionsort__sorted (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InsertionSort2.insertionsort__sorted@tok () Term)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit).
;       GenericSort.sorted (InsertionSort2.insertionsort' l k) k ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l && Nil? l.tl) /\ ~(Cons? l) ==> Prims.l_False) /\
;       (l == [] ==> (forall (any_result: Prims.unit). k any_result)) /\
...
;                   k == any_result ==>
;                   (forall (pure_result: Prims.unit).
;                       GenericSort.sorted (InsertionSort2.insertionsort' b k) k ==>
;                       GenericSort.sorted (InsertionSort2.insertionsort' b k) k /\
;                       (forall (pure_result: Prims.unit).
;                           GenericSort.sorted (InsertionSort2.insert' b
;                                 (InsertionSort2.insertionsort' b k)
;                                 k)
;                             k ==>
;                           k pure_result)))))))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec insertionsort'_sorted`
...
;;; Fact-ids: 
(assert (! (not 
;; def=InsertionSort2.fst(71,2-76,45); use=InsertionSort2.fst(71,2-76,45)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(71,2-76,45)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=InsertionSort2.fst(69,15-69,46); use=InsertionSort2.fst(71,2-76,45)
(or label_2

;; def=InsertionSort2.fst(69,15-69,46); use=InsertionSort2.fst(71,2-76,45)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insertionsort_ x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1
x_582acf81e02a6e4176cba5e2730f867d_2)
x_582acf81e02a6e4176cba5e2730f867d_2))
)
)

;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(71,2-76,45)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(71,2-76,45)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=InsertionSort2.fst(71,2-76,45)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(71,2-76,45)
(Valid 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(71,2-76,45)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(71,2-76,45)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(71,2-76,45)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(71,2-76,45)
(and (implies 
;; def=InsertionSort2.fst(70,33-76,45); use=InsertionSort2.fst(71,2-76,45)
(and 
;; def=InsertionSort2.fst(70,33-70,34); use=InsertionSort2.fst(71,8-71,9)
(not 
;; def=InsertionSort2.fst(70,33-70,34); use=InsertionSort2.fst(71,8-71,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
label_3)
(implies 
;; def=InsertionSort2.fst(70,33-72,6); use=InsertionSort2.fst(71,8-72,6)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=InsertionSort2.fst(71,2-76,45)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(71,2-76,45)
(Valid 
;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(71,2-76,45)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=InsertionSort2.fst(71,2-76,45)
(not 
;; def=InsertionSort2.fst(70,33-70,34); use=InsertionSort2.fst(71,8-71,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort2.fst(71,2-76,45)
(and 
;; def=Prims.fst(413,99-413,120); use=InsertionSort2.fst(71,2-76,45)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=InsertionSort2.fst(70,33-73,7); use=InsertionSort2.fst(71,8-73,7)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
;; def=InsertionSort2.fst(70,33-74,10); use=InsertionSort2.fst(71,8-74,10)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(71,2-76,45)
(and 
;; def=InsertionSort2.fst(68,28-76,45); use=InsertionSort2.fst(75,29-75,30)
(or label_4

;; def=InsertionSort2.fst(71,2-76,45); use=InsertionSort2.fst(75,29-75,30)
(Valid 
;; def=InsertionSort2.fst(71,2-76,45); use=InsertionSort2.fst(75,29-75,30)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=InsertionSort2.fst(68,54-70,36); use=InsertionSort2.fst(71,2-76,45)
(= x_582acf81e02a6e4176cba5e2730f867d_2
@x4)
)

;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(75,4-75,25)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=InsertionSort2.fst(69,15-69,46); use=InsertionSort2.fst(75,4-75,25)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insertionsort_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
x_582acf81e02a6e4176cba5e2730f867d_2)
...
;; def=Prims.fst(441,29-441,97); use=InsertionSort2.fst(76,4-76,18)
(and 
;; def=InsertionSort2.fst(32,18-32,30); use=InsertionSort2.fst(76,4-76,18)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(76,4-76,18)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=InsertionSort2.fst(33,17-33,43); use=InsertionSort2.fst(76,4-76,18)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insert_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(InsertionSort2.insertionsort_ x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(76,4-76,18)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(76,4-76,18)
(ApplyTT @x1
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InsertionSort2.insertionsort'_sorted, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_GenericSort.sorted.fuel_instrumented, @fuel_correspondence_InsertionSort2.insertionsort_.fuel_instrumented, @fuel_irrelevance_InsertionSort2.insertionsort_.fuel_instrumented, @query, GenericSort_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949, InsertionSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd, binder_x_374b44ccfcb77ed85d505dbc44265913_1, binder_x_582acf81e02a6e4176cba5e2730f867d_2, binder_x_9cd1733a5204f989dbb2f01d5984df93_0, bool_inversion, constructor_distinct_Prims.Nil, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_Prims.eqtype, equation_with_fuel_GenericSort.sorted.fuel_instrumented, equation_with_fuel_InsertionSort2.insertionsort_.fuel_instrumented, fuel_guarded_inversion_Prims.list, proj_equation_Prims.Cons_tl, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, projection_inverse_Prims.Nil_a, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, subterm_ordering_Prims.Cons, typing_GenericSort.sorted, typing_InsertionSort2.insert_, typing_InsertionSort2.insertionsort_, typing_Prims.uu___is_Cons, typing_Prims.uu___is_Nil
...
; encoding sigelt let rec insertionsort'_sorted


; <Start encoding let rec insertionsort'_sorted>
...
; </end encoding let rec insertionsort'_sorted>


; encoding sigelt val InsertionSort2.insertionsort'_stable


; <Skipped val InsertionSort2.insertionsort'_stable/>

(push) ;; push{2

; Starting query at InsertionSort2.fst(81,2-87,45)
...
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(78,66-80,32); use=InsertionSort2.fst(80,8-80,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_2))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InsertionSort2.insertionsort__stable (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InsertionSort2.insertionsort__stable@tok () Term)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit).
;       GenericStability.stable (InsertionSort2.insertionsort' l k) l k ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l && Nil? l.tl) /\ ~(Cons? l) ==> Prims.l_False) /\
;       (l == [] ==> (forall (any_result: Prims.unit). k any_result)) /\
...
;                   k == any_result ==>
;                   (forall (pure_result: Prims.unit).
;                       GenericStability.stable (InsertionSort2.insertionsort' b k) b k ==>
;                       (forall (pure_result: Prims.unit).
;                           GenericSort.sorted (InsertionSort2.insertionsort' b k) k ==>
;                           GenericSort.sorted (InsertionSort2.insertionsort' b k) k /\
;                           (forall (pure_result: Prims.unit).
;                               GenericStability.stable (InsertionSort2.insert' b
;                                     (InsertionSort2.insertionsort' b k)
;                                     k)
;                                 (b :: InsertionSort2.insertionsort' b k)
;                                 k ==>
;                               k pure_result))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec insertionsort'_stable`
...
;;; Fact-ids: 
(assert (! (not 
;; def=InsertionSort2.fst(81,2-87,45); use=InsertionSort2.fst(81,2-87,45)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(81,2-87,45)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=InsertionSort2.fst(79,16-79,47); use=InsertionSort2.fst(81,2-87,45)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(81,2-87,45)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(81,2-87,45)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=InsertionSort2.fst(81,2-87,45)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(81,2-87,45)
(Valid 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(81,2-87,45)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(81,2-87,45)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(81,2-87,45)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(81,2-87,45)
(and (implies 
;; def=InsertionSort2.fst(80,33-87,45); use=InsertionSort2.fst(81,2-87,45)
(and 
;; def=InsertionSort2.fst(80,33-80,34); use=InsertionSort2.fst(81,8-81,9)
(not 
;; def=InsertionSort2.fst(80,33-80,34); use=InsertionSort2.fst(81,8-81,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
label_3)
(implies 
;; def=InsertionSort2.fst(80,33-82,6); use=InsertionSort2.fst(81,8-82,6)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=InsertionSort2.fst(81,2-87,45)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(81,2-87,45)
(Valid 
;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(81,2-87,45)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=InsertionSort2.fst(81,2-87,45)
(not 
;; def=InsertionSort2.fst(80,33-80,34); use=InsertionSort2.fst(81,8-81,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort2.fst(81,2-87,45)
(and 
;; def=Prims.fst(413,99-413,120); use=InsertionSort2.fst(81,2-87,45)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=InsertionSort2.fst(80,33-83,7); use=InsertionSort2.fst(81,8-83,7)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
;; def=InsertionSort2.fst(80,33-84,10); use=InsertionSort2.fst(81,8-84,10)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(81,2-87,45)
(and 
;; def=InsertionSort2.fst(78,28-87,45); use=InsertionSort2.fst(85,29-85,30)
(or label_4

;; def=InsertionSort2.fst(81,2-87,45); use=InsertionSort2.fst(85,29-85,30)
(Valid 
;; def=InsertionSort2.fst(81,2-87,45); use=InsertionSort2.fst(85,29-85,30)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=InsertionSort2.fst(78,54-80,36); use=InsertionSort2.fst(81,2-87,45)
(= x_582acf81e02a6e4176cba5e2730f867d_2
@x4)
)

;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(85,4-85,25)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=InsertionSort2.fst(79,16-79,47); use=InsertionSort2.fst(85,4-85,25)
(Valid 
;; def=InsertionSort2.fst(79,16-79,47); use=InsertionSort2.fst(85,4-85,25)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insertionsort_ x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(86,4-86,25)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=InsertionSort2.fst(69,15-69,46); use=InsertionSort2.fst(86,4-86,25)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insertionsort_ x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
x_582acf81e02a6e4176cba5e2730f867d_2)
...
;; def=Prims.fst(441,29-441,97); use=InsertionSort2.fst(87,4-87,18)
(and 
;; def=InsertionSort2.fst(42,18-42,30); use=InsertionSort2.fst(87,4-87,18)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(87,4-87,18)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=InsertionSort2.fst(43,17-43,50); use=InsertionSort2.fst(87,4-87,18)
(Valid 
;; def=InsertionSort2.fst(43,17-43,50); use=InsertionSort2.fst(87,4-87,18)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insert_ x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(87,4-87,18)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(87,4-87,18)
(ApplyTT @x1
@x7)
...
; encoding sigelt let rec insertionsort'_stable


; <Start encoding let rec insertionsort'_stable>
...
; </end encoding let rec insertionsort'_stable>


; encoding sigelt val InsertionSort2.insertionsort'_permutation


; <Skipped val InsertionSort2.insertionsort'_permutation/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name GenericSort.permutation; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(68,5-68,16); use=GenericSort.fst(68,5-68,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_refine_414d0a9f578ab0048252f8c8f552b99f)
(HasType @x1
...
(HasType @x2
(Prims.list @x0)))
(HasType (GenericSort.permutation @x0
@x1
@x2)
Prims.logical))
 

:pattern ((GenericSort.permutation @x0
@x1
@x2))
:qid typing_GenericSort.permutation))

:named typing_GenericSort.permutation))
;;;;;;;;;;;;;;;;Equation for GenericSort.permutation
;;; Fact-ids: Name GenericSort.permutation; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(68,5-68,16); use=GenericSort.fst(68,5-68,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (GenericSort.permutation @x0
@x1
@x2))

;; def=GenericSort.fst(69,4-69,60); use=GenericSort.fst(69,4-69,60)
(and 
;; def=GenericSort.fst(69,4-69,25); use=GenericSort.fst(69,4-69,25)
(= (FStar.List.Tot.Base.length @x0
@x1)
(FStar.List.Tot.Base.length @x0
@x2))
...
;; def=GenericSort.fst(69,29-69,60); use=GenericSort.fst(69,29-69,60)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x0)

;; def=GenericSort.fst(69,40-69,59); use=GenericSort.fst(69,40-69,59)
(= (FStar.List.Tot.Base.mem @x0
@x3
@x1)
(FStar.List.Tot.Base.mem @x0
...
;;no pats
:qid equation_GenericSort.permutation.1))
)
)
...
@x1
@x2))
:qid equation_GenericSort.permutation))

:named equation_GenericSort.permutation))
;;;;;;;;;;;;;;;;Prop-typing for GenericSort.permutation
;;; Fact-ids: Name GenericSort.permutation; Namespace GenericSort
(assert (! 
;; def=GenericSort.fst(68,5-68,16); use=GenericSort.fst(68,5-68,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Prims.list @x0)))
(Valid (Prims.subtype_of (GenericSort.permutation @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (GenericSort.permutation @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_GenericSort.permutation))

:named defn_equation_GenericSort.permutation))
(push) ;; push{2

; Starting query at InsertionSort2.fst(92,2-97,50)
...
;;; Fact-ids: 
(assert (! 
;; def=InsertionSort2.fst(89,71-91,37); use=InsertionSort2.fst(91,8-91,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
:named binder_x_582acf81e02a6e4176cba5e2730f867d_2))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun InsertionSort2.insertionsort__permutation (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun InsertionSort2.insertionsort__permutation@tok () Term)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit).
;       GenericSort.permutation (InsertionSort2.insertionsort' l k) l ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l && Nil? l.tl) /\ ~(Cons? l) ==> Prims.l_False) /\
;       (l == [] ==> (forall (any_result: Prims.unit). k any_result)) /\
...
;                   k == any_result ==>
;                   (forall (pure_result: Prims.unit).
;                       GenericSort.permutation (InsertionSort2.insertionsort' b k) b ==>
;                       (forall (pure_result: Prims.unit).
;                           GenericSort.permutation_2 (InsertionSort2.insert' b
;                                 (InsertionSort2.insertionsort' b k)
;                                 k)
;                             (InsertionSort2.insertionsort' b k)
;                             [b] ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec insertionsort'_permutation`
...
;;; Fact-ids: 
(assert (! (not 
;; def=InsertionSort2.fst(92,2-97,50); use=InsertionSort2.fst(92,2-97,50)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(92,2-97,50)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=InsertionSort2.fst(90,15-90,51); use=InsertionSort2.fst(92,2-97,50)
(or label_2

;; def=InsertionSort2.fst(90,15-90,51); use=InsertionSort2.fst(92,2-97,50)
(Valid 
;; def=InsertionSort2.fst(90,15-90,51); use=InsertionSort2.fst(92,2-97,50)
(GenericSort.permutation x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insertionsort_ x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1
x_582acf81e02a6e4176cba5e2730f867d_2)
x_374b44ccfcb77ed85d505dbc44265913_1)
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(92,2-97,50)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(92,2-97,50)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=InsertionSort2.fst(92,2-97,50)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(92,2-97,50)
(Valid 
;; def=Prims.fst(402,73-402,79); use=InsertionSort2.fst(92,2-97,50)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(92,2-97,50)
(Valid 
;; def=Prims.fst(402,84-402,87); use=InsertionSort2.fst(92,2-97,50)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(92,2-97,50)
(and (implies 
;; def=InsertionSort2.fst(91,38-97,50); use=InsertionSort2.fst(92,2-97,50)
(and 
;; def=InsertionSort2.fst(91,38-91,39); use=InsertionSort2.fst(92,8-92,9)
(not 
;; def=InsertionSort2.fst(91,38-91,39); use=InsertionSort2.fst(92,8-92,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
label_3)
(implies 
;; def=InsertionSort2.fst(91,38-93,6); use=InsertionSort2.fst(92,8-93,6)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=InsertionSort2.fst(92,2-97,50)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(92,2-97,50)
(Valid 
;; def=Prims.fst(451,90-451,102); use=InsertionSort2.fst(92,2-97,50)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=InsertionSort2.fst(92,2-97,50)
(not 
;; def=InsertionSort2.fst(91,38-91,39); use=InsertionSort2.fst(92,8-92,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(389,2-389,39); use=InsertionSort2.fst(92,2-97,50)
(and 
;; def=Prims.fst(413,99-413,120); use=InsertionSort2.fst(92,2-97,50)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=InsertionSort2.fst(91,38-94,7); use=InsertionSort2.fst(92,8-94,7)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
;; def=InsertionSort2.fst(91,38-95,10); use=InsertionSort2.fst(92,8-95,10)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=InsertionSort2.fst(92,2-97,50)
(and 
;; def=InsertionSort2.fst(89,33-97,50); use=InsertionSort2.fst(96,34-96,35)
(or label_4

;; def=InsertionSort2.fst(92,2-97,50); use=InsertionSort2.fst(96,34-96,35)
(Valid 
;; def=InsertionSort2.fst(92,2-97,50); use=InsertionSort2.fst(96,34-96,35)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=InsertionSort2.fst(89,59-91,41); use=InsertionSort2.fst(92,2-97,50)
(= x_582acf81e02a6e4176cba5e2730f867d_2
@x4)
)

;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(96,4-96,30)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=InsertionSort2.fst(90,15-90,51); use=InsertionSort2.fst(96,4-96,30)
(Valid 
;; def=InsertionSort2.fst(90,15-90,51); use=InsertionSort2.fst(96,4-96,30)
(GenericSort.permutation x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insertionsort_ x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(97,4-97,23)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=InsertionSort2.fst(52,16-52,53); use=InsertionSort2.fst(97,4-97,23)
(Valid 
;; def=InsertionSort2.fst(52,16-52,53); use=InsertionSort2.fst(97,4-97,23)
(GenericSort.permutation_2 x_9cd1733a5204f989dbb2f01d5984df93_0
(InsertionSort2.insert_ x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(97,4-97,23)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(97,4-97,23)
(ApplyTT @x1
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (InsertionSort2.insertionsort'_permutation, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_FStar.List.Tot.Base.length.fuel_instrumented, @fuel_correspondence_FStar.List.Tot.Base.mem.fuel_instrumented, @fuel_correspondence_InsertionSort2.insertionsort_.fuel_instrumented, @fuel_irrelevance_FStar.List.Tot.Base.length.fuel_instrumented, @fuel_irrelevance_FStar.List.Tot.Base.mem.fuel_instrumented, @fuel_irrelevance_InsertionSort2.insertionsort_.fuel_instrumented, @query, GenericSort_interpretation_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949, InsertionSort2_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd, binder_x_374b44ccfcb77ed85d505dbc44265913_1, binder_x_582acf81e02a6e4176cba5e2730f867d_2, binder_x_9cd1733a5204f989dbb2f01d5984df93_0, bool_inversion, constructor_distinct_Prims.Cons, constructor_distinct_Prims.Nil, data_typing_intro_Prims.Cons@tok, data_typing_intro_Prims.Nil@tok, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_GenericSort.permutation, equation_GenericSort.permutation_2, equation_Prims.eqtype, equation_Prims.nat, equation_with_fuel_FStar.List.Tot.Base.length.fuel_instrumented, equation_with_fuel_FStar.List.Tot.Base.mem.fuel_instrumented, equation_with_fuel_InsertionSort2.insertionsort_.fuel_instrumented, fuel_guarded_inversion_Prims.list, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_BarBar, primitive_Prims.op_Equality, proj_equation_Prims.Cons_tl, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, projection_inverse_Prims.Nil_a, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, subterm_ordering_Prims.Cons, typing_FStar.List.Tot.Base.length, typing_FStar.List.Tot.Base.mem, typing_Prims.uu___is_Cons, typing_Prims.uu___is_Nil
...
; encoding sigelt let rec insertionsort'_permutation


; <Start encoding let rec insertionsort'_permutation>
...
; </end encoding let rec insertionsort'_permutation>
...
;;;;;;;;;;;;;;;;Lemma: GenericSort.sorted_smaller
;;; Fact-ids: Name GenericSort.sorted_smaller; Namespace GenericSort
...
;; def=GenericSort.fst(48,37-48,54); use=GenericSort.fst(51,8-51,22)
(BoxBool_proj_0 (GenericSort.sorted.fuel_instrumented ZFuel
@x0
(Prims.Cons @x0
@x1
@x3)
...
;; def=GenericSort.fst(48,58-48,65); use=GenericSort.fst(51,8-51,22)
...
;; def=GenericSort.fst(49,34-49,50); use=GenericSort.fst(51,8-51,22)
...
:pattern ((GenericSort.sorted.fuel_instrumented ZFuel
@x0
(Prims.Cons @x0
@x1
@x3)
@x4) (FStar.List.Tot.Base.mem.fuel_instrumented ZFuel
@x0
@x2
@x3))
:qid lemma_GenericSort.sorted_smaller))
:named lemma_GenericSort.sorted_smaller))
(push) ;; push{2

; Starting query at InsertionSort2.fst(104,2-107,20)
...
; Encoding query formula : forall (a: Prims.eqtype) (l: Prims.list a) (k: (_: a -> Prims.int)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (Prims.list a)).
;     (forall (pure_result: Prims.list a).
;         GenericSort.sorted pure_result k /\ GenericStability.stable l pure_result k /\
;         GenericSort.permutation l pure_result ==>
;         p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         GenericSort.permutation (InsertionSort2.insertionsort' l k) l ==>
;         (forall (pure_result: Prims.unit).
;             GenericStability.stable (InsertionSort2.insertionsort' l k) l k ==>
;             (forall (pure_result: Prims.unit).
;                 GenericSort.sorted (InsertionSort2.insertionsort' l k) k ==>
;                 (forall (any_result: Prims.list a).
;                     any_result == InsertionSort2.insertionsort' l k ==>
;                     (forall (return_val: Prims.list a). return_val == any_result ==> p return_val)))
;         ))


; Context: While encoding a query
; While typechecking the top-level declaration `let insertionsort`
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post (Prims.list @x0)))

;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(104,2-107,20)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
(Prims.list @x0)))

;; def=InsertionSort2.fst(102,27-102,38); use=InsertionSort2.fst(104,2-107,20)
(or label_2

;; def=InsertionSort2.fst(102,27-102,38); use=InsertionSort2.fst(104,2-107,20)
(BoxBool_proj_0 (GenericSort.sorted @x0
@x4
@x2))
)


;; def=InsertionSort2.fst(102,42-102,55); use=InsertionSort2.fst(104,2-107,20)
(or label_3

;; def=InsertionSort2.fst(102,42-102,55); use=InsertionSort2.fst(104,2-107,20)
(Valid 
;; def=InsertionSort2.fst(102,42-102,55); use=InsertionSort2.fst(104,2-107,20)
(GenericStability.stable @x0
@x1
@x4
@x2)
)
...
;; def=InsertionSort2.fst(102,59-102,75); use=InsertionSort2.fst(104,2-107,20)
(or label_4

;; def=InsertionSort2.fst(102,59-102,75); use=InsertionSort2.fst(104,2-107,20)
(Valid 
;; def=InsertionSort2.fst(102,59-102,75); use=InsertionSort2.fst(104,2-107,20)
(GenericSort.permutation @x0
@x1
@x4)
)
)
...
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(104,2-107,20)
(Valid 
;; def=Prims.fst(441,83-441,96); use=InsertionSort2.fst(104,2-107,20)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(104,2-104,28)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=InsertionSort2.fst(90,15-90,51); use=InsertionSort2.fst(104,2-104,28)
(Valid 
;; def=InsertionSort2.fst(90,15-90,51); use=InsertionSort2.fst(104,2-104,28)
(GenericSort.permutation @x0
(InsertionSort2.insertionsort_ @x0
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(105,2-105,23)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=InsertionSort2.fst(79,16-79,47); use=InsertionSort2.fst(105,2-105,23)
(Valid 
;; def=InsertionSort2.fst(79,16-79,47); use=InsertionSort2.fst(105,2-105,23)
(GenericStability.stable @x0
(InsertionSort2.insertionsort_ @x0
...
;; def=Prims.fst(441,36-441,97); use=InsertionSort2.fst(106,2-106,23)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=InsertionSort2.fst(69,15-69,46); use=InsertionSort2.fst(106,2-106,23)
(BoxBool_proj_0 (GenericSort.sorted @x0
(InsertionSort2.insertionsort_ @x0
@x1
@x2)
...
;; def=Prims.fst(451,66-451,102); use=InsertionSort2.fst(104,2-107,20)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Prims.list @x0))

;; def=InsertionSort2.fst(100,7-107,20); use=InsertionSort2.fst(104,2-107,20)
(= @x7
(InsertionSort2.insertionsort_ @x0
@x1
@x2))
...
; QUERY ID: (InsertionSort2.insertionsort, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_GenericStability.filter_eq.fuel_instrumented, @fuel_correspondence_InsertionSort2.insertionsort_.fuel_instrumented, @query, equation_GenericSort.permutation, equation_GenericStability.stable, equation_Prims.eqtype, equation_Prims.nat, equation_with_fuel_GenericStability.filter_eq.fuel_instrumented, equation_with_fuel_InsertionSort2.insertionsort_.fuel_instrumented, fuel_guarded_inversion_Prims.list, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_FStar.List.Tot.Base.length
