...
; Internals for IntSort


; encoding sigelt val IntSort.sorted
...
; Starting query at IntSort.fst(21,19-23,46)
...
(declare-fun Tm_refine_2bb07c2eee201bc6d1c2f744454beec6 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_2bb07c2eee201bc6d1c2f744454beec6
Tm_type)
:named refinement_kinding_Tm_refine_2bb07c2eee201bc6d1c2f744454beec6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=IntSort.fst(21,19-23,46); use=IntSort.fst(21,19-23,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_2bb07c2eee201bc6d1c2f744454beec6)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))
...
@x1
Tm_refine_2bb07c2eee201bc6d1c2f744454beec6))
:qid refinement_interpretation_Tm_refine_2bb07c2eee201bc6d1c2f744454beec6))

:named refinement_interpretation_Tm_refine_2bb07c2eee201bc6d1c2f744454beec6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_2bb07c2eee201bc6d1c2f744454beec6
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_2bb07c2eee201bc6d1c2f744454beec6))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_2bb07c2eee201bc6d1c2f744454beec6))
(declare-fun IntSort.sorted (Term) Term)

;;;;;;;;;;;;;;;;_: _: Prims.list Prims.int {_ << l} -> Prims.bool
(declare-fun Tm_arrow_43a91b1af2e99df2cdd414117d3374e7 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_43a91b1af2e99df2cdd414117d3374e7
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_43a91b1af2e99df2cdd414117d3374e7
Tm_type)
:named kinding_Tm_arrow_43a91b1af2e99df2cdd414117d3374e7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=IntSort.fst(20,28-23,46); use=IntSort.fst(21,8-23,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_43a91b1af2e99df2cdd414117d3374e7)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_43a91b1af2e99df2cdd414117d3374e7))
:qid IntSort_pre_typing_Tm_arrow_43a91b1af2e99df2cdd414117d3374e7))

:named IntSort_pre_typing_Tm_arrow_43a91b1af2e99df2cdd414117d3374e7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_43a91b1af2e99df2cdd414117d3374e7
;;; Fact-ids: 
(assert (! 
;; def=IntSort.fst(20,28-23,46); use=IntSort.fst(21,8-23,46)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid IntSort_interpretation_Tm_arrow_43a91b1af2e99df2cdd414117d3374e7.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_43a91b1af2e99df2cdd414117d3374e7))
:qid IntSort_interpretation_Tm_arrow_43a91b1af2e99df2cdd414117d3374e7))

:named IntSort_interpretation_Tm_arrow_43a91b1af2e99df2cdd414117d3374e7))
...
(forall ((@x0 Term))
 (! (= (ApplyTT IntSort.sorted@tok
@x0)
(IntSort.sorted @x0))
 

:pattern ((ApplyTT IntSort.sorted@tok
@x0))
:qid token_correspondence_IntSort.sorted))

:named token_correspondence_IntSort.sorted))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=IntSort.fst(21,8-21,14); use=IntSort.fst(21,8-21,14)
...
:pattern ((IntSort.sorted @x1))
:qid function_token_typing_IntSort.sorted.1))
)
 

:pattern ((ApplyTT @x0
IntSort.sorted@tok))
:qid function_token_typing_IntSort.sorted))

:named function_token_typing_IntSort.sorted))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=IntSort.fst(21,8-21,14); use=IntSort.fst(21,8-21,14)
...
;; def=Prims.fst(402,27-402,88); use=IntSort.fst(21,19-23,46)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=IntSort.fst(21,19-23,46)
(Valid 
;; def=Prims.fst(402,84-402,87); use=IntSort.fst(21,19-23,46)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=IntSort.fst(21,19-23,46)
(and (implies 
;; def=IntSort.fst(21,15-23,46); use=IntSort.fst(21,19-23,46)
(and 
;; def=IntSort.fst(21,15-21,16); use=IntSort.fst(21,25-21,26)
(not 
;; def=IntSort.fst(21,15-21,16); use=IntSort.fst(21,25-21,26)
...
label_1)
(implies 
;; def=Prims.fst(389,18-389,39); use=IntSort.fst(21,19-23,46)
(and 
;; def=Prims.fst(389,19-389,21); use=IntSort.fst(21,19-23,46)
(not 
;; def=IntSort.fst(21,15-21,16); use=IntSort.fst(21,25-21,26)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_66b03f5c7897b05649fed8196554c587_0))
...
;; def=Prims.fst(413,99-413,120); use=IntSort.fst(21,19-23,46)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=IntSort.fst(21,15-23,14); use=IntSort.fst(21,25-23,14)
(= x_66b03f5c7897b05649fed8196554c587_0
...
;; def=IntSort.fst(23,18-23,26); use=IntSort.fst(23,18-23,26)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x2))
)

;; def=IntSort.fst(21,19-23,46); use=IntSort.fst(23,38-23,45)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IntSort.sorted, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_66b03f5c7897b05649fed8196554c587_0, data_elim_Prims.Cons, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, function_token_typing_Prims.__cache_version_number__, proj_equation_Prims.Cons_tl, projection_inverse_BoxBool_proj_0, subterm_ordering_Prims.Cons
...
; Starting query at IntSort.fst(25,0-26,60)
...
;;; Fact-ids: 
(assert (! 
;; def=IntSort.fst(26,6-26,60); use=IntSort.fst(26,6-26,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
; Encoding query formula : forall (x: Prims.int) (l: Prims.list Prims.int) (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *) IntSort.sorted (x :: l) /\ Cons? l ==> Cons? l


; Context: While encoding a query
; While typechecking the top-level declaration `val IntSort.test_sorted`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=IntSort.fst(25,0-26,60)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
...
;; def=IntSort.fst(26,14-26,27); use=IntSort.fst(26,14-26,27)
(BoxBool_proj_0 (IntSort.sorted (Prims.Cons Prims.int
@x0
@x1)))


;; def=IntSort.fst(26,31-26,38); use=IntSort.fst(26,31-26,38)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x1))
)

;; def=Prims.fst(616,4-616,8); use=IntSort.fst(26,58-26,59)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IntSort.test_sorted, 1)
; STATUS: unsat
...
; encoding sigelt val IntSort.test_sorted
...
; Starting query at IntSort.fst(27,22-27,24)
...
;         (IntSort.sorted (x :: l) /\ Cons? l ==> x <= l.hd) ==> p pure_result) ==>
...
;; def=Prims.fst(441,36-441,97); use=IntSort.fst(27,22-27,24)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))
(implies 
;; def=IntSort.fst(26,13-26,39); use=IntSort.fst(27,22-27,24)
(and 
;; def=IntSort.fst(26,14-26,27); use=IntSort.fst(27,22-27,24)
(BoxBool_proj_0 (IntSort.sorted (Prims.Cons Prims.int
@x0
@x1)))


;; def=IntSort.fst(26,31-26,38); use=IntSort.fst(27,22-27,24)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x1))
)


;; def=IntSort.fst(26,44-26,59); use=IntSort.fst(27,22-27,24)
(or label_2

;; def=IntSort.fst(26,44-26,59); use=IntSort.fst(27,22-27,24)
(<= (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (Prims.__proj__Cons__item__hd Prims.int
@x1)))
)
))

;; def=Prims.fst(441,83-441,96); use=IntSort.fst(27,22-27,24)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IntSort.fst(27,22-27,24)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IntSort.test_sorted, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_IntSort.sorted.fuel_instrumented, @query, constructor_distinct_Prims.Cons, data_typing_intro_Prims.Cons@tok, disc_equation_Prims.Cons, equation_Prims.eqtype, equation_with_fuel_IntSort.sorted.fuel_instrumented, primitive_Prims.op_AmpAmp, primitive_Prims.op_LessThanOrEqual, proj_equation_Prims.Cons_hd, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
; encoding sigelt val IntSort.test_sorted2
...
; Starting query at IntSort.fst(30,22-30,25)
...
;; def=IntSort.fst(29,42-29,50); use=IntSort.fst(30,22-30,25)
(or label_1
...
; encoding sigelt val IntSort.sorted_smaller
...
; Starting query at IntSort.fst(40,31-42,56)
...
;   IntSort.sorted (x :: l) /\ FStar.List.Tot.Base.mem y l /\
...
;                 (b = y == true ==> (forall (any_result: Prims.unit). k any_result)) /\
;                 (~(b = y = true) ==>
;                   (forall (b: Prims.bool).
;                       b = y == b ==>
;                       (x << x \/ (y << y \/ b << l)) /\
...
;                           b == any_result ==>
;                           IntSort.sorted (x :: b) /\ FStar.List.Tot.Base.mem y b /\
;                           (forall (pure_result: Prims.unit). x <= y ==> k pure_result))))))))
...
;;; Fact-ids: 
(assert (! (not 
;; def=IntSort.fst(40,31-42,56); use=IntSort.fst(40,31-42,56)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=IntSort.fst(37,37-37,50); use=IntSort.fst(40,31-42,56)
(BoxBool_proj_0 (IntSort.sorted (Prims.Cons Prims.int
x_ae567c2fb75be05905677af440075565_0
x_66b03f5c7897b05649fed8196554c587_2)))


;; def=IntSort.fst(37,54-37,61); use=IntSort.fst(40,31-42,56)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem Prims.int
x_ae567c2fb75be05905677af440075565_1
x_66b03f5c7897b05649fed8196554c587_2))


;; def=Prims.fst(441,36-441,97); use=IntSort.fst(40,31-42,56)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=IntSort.fst(38,35-38,43); use=IntSort.fst(40,31-42,56)
(or label_2

;; def=IntSort.fst(38,35-38,43); use=IntSort.fst(40,31-42,56)
(<= (BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_0)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_1))
)
)

;; def=Prims.fst(441,83-441,96); use=IntSort.fst(40,31-42,56)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IntSort.fst(40,31-42,56)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=IntSort.fst(40,31-42,56)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=IntSort.fst(40,31-42,56)
(Valid 
;; def=Prims.fst(402,73-402,79); use=IntSort.fst(40,31-42,56)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=IntSort.fst(40,31-42,56)
(Valid 
;; def=Prims.fst(402,84-402,87); use=IntSort.fst(40,31-42,56)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=IntSort.fst(40,31-42,56)
(and (implies 
;; def=IntSort.fst(40,27-40,28); use=IntSort.fst(40,37-40,38)
(and 
;; def=IntSort.fst(40,27-40,28); use=IntSort.fst(40,37-40,38)
(not 
;; def=IntSort.fst(40,27-40,28); use=IntSort.fst(40,37-40,38)
...
label_3)
(implies 
;; def=IntSort.fst(40,27-41,8); use=IntSort.fst(40,37-41,8)
(= x_66b03f5c7897b05649fed8196554c587_2
(Prims.Nil Prims.int))


;; def=Prims.fst(451,66-451,102); use=IntSort.fst(40,31-42,56)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=IntSort.fst(40,31-42,56)
(Valid 
;; def=Prims.fst(451,90-451,102); use=IntSort.fst(40,31-42,56)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=IntSort.fst(40,31-42,56)
(not 
;; def=IntSort.fst(40,27-40,28); use=IntSort.fst(40,37-40,38)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_66b03f5c7897b05649fed8196554c587_2))
...
;; def=Prims.fst(413,99-413,120); use=IntSort.fst(40,31-42,56)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)
...
;; def=IntSort.fst(40,27-42,11); use=IntSort.fst(40,37-42,11)
(= x_66b03f5c7897b05649fed8196554c587_2
(Prims.Cons Prims.int
@x2
@x3))
...
;; def=Prims.fst(389,2-389,39); use=IntSort.fst(40,31-42,56)
(and (implies 
;; def=IntSort.fst(42,18-42,21); use=IntSort.fst(42,18-42,21)
...
;; def=IntSort.fst(42,18-42,56); use=IntSort.fst(42,18-42,56)
(= (Prims.op_Equality Prims.int
@x2
x_ae567c2fb75be05905677af440075565_1)
@x5)
...
;; def=Prims.fst(459,77-459,89); use=IntSort.fst(40,31-42,56)
(and 
;; def=IntSort.fst(34,20-42,56); use=IntSort.fst(42,54-42,56)
(or label_4

;; def=IntSort.fst(40,31-42,56); use=IntSort.fst(42,54-42,56)
(Valid 
;; def=IntSort.fst(40,31-42,56); use=IntSort.fst(42,54-42,56)
...
;; def=IntSort.fst(36,20-42,11); use=IntSort.fst(40,31-42,56)
(= @x3
@x6)
)

;; def=Prims.fst(441,29-441,97); use=IntSort.fst(42,35-42,49)
(and 
;; def=IntSort.fst(37,37-37,50); use=IntSort.fst(42,35-42,49)
(or label_5
...
;; def=IntSort.fst(37,54-37,61); use=IntSort.fst(42,35-42,49)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=IntSort.fst(42,35-42,49)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=IntSort.fst(38,35-38,43); use=IntSort.fst(42,35-42,49)
(<= (BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_0)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_1))
)

;; def=Prims.fst(441,83-441,96); use=IntSort.fst(42,35-42,49)
(Valid 
;; def=Prims.fst(441,83-441,96); use=IntSort.fst(42,35-42,49)
(ApplyTT @x4
@x7)
...
; Starting query at IntSort.fst(46,4-46,60)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (l1: Prims.list Prims.int) (l2: Prims.list Prims.int).
;   (*  - Could not prove post-condition
...
;; def=Prims.fst(73,23-73,30); use=IntSort.fst(46,4-46,10)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (IntSort.permutation, 1)
; STATUS: unsat
