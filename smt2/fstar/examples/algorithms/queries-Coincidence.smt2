...
; Internals for Coincidence


; encoding sigelt val Coincidence.mem


; <Skipped val Coincidence.mem/>
...
; Starting query at Coincidence.fst(27,2-29,30)
...
(declare-fun Tm_refine_9e5f99209b478038b006f989e528b33b (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(26,12-29,30); use=Coincidence.fst(26,12-29,30)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_9e5f99209b478038b006f989e528b33b @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_9e5f99209b478038b006f989e528b33b @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_9e5f99209b478038b006f989e528b33b))

:named refinement_kinding_Tm_refine_9e5f99209b478038b006f989e528b33b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(26,12-29,30); use=Coincidence.fst(26,12-29,30)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9e5f99209b478038b006f989e528b33b @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))
...
;; def=Coincidence.fst(26,12-29,30); use=Coincidence.fst(26,12-29,30)
(or 
;; def=Coincidence.fst(27,2-29,30); use=Coincidence.fst(27,2-29,30)
(Valid 
;; def=Coincidence.fst(27,2-29,30); use=Coincidence.fst(27,2-29,30)
...
;; def=Coincidence.fst(26,12-29,30); use=Coincidence.fst(26,12-29,30)
(and 
;; def=Coincidence.fst(26,12-26,13); use=Coincidence.fst(26,12-26,13)
(Valid 
;; def=Coincidence.fst(26,12-26,13); use=Coincidence.fst(26,12-26,13)
...
@x1
(Tm_refine_9e5f99209b478038b006f989e528b33b @x2)))
:qid refinement_interpretation_Tm_refine_9e5f99209b478038b006f989e528b33b))

:named refinement_interpretation_Tm_refine_9e5f99209b478038b006f989e528b33b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9e5f99209b478038b006f989e528b33b
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(26,12-29,30); use=Coincidence.fst(26,12-29,30)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9e5f99209b478038b006f989e528b33b @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9e5f99209b478038b006f989e528b33b @x0))))
:qid haseqTm_refine_9e5f99209b478038b006f989e528b33b))

:named haseqTm_refine_9e5f99209b478038b006f989e528b33b))
(declare-fun Coincidence.mem (Term Term) Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: _: Prims.list Prims.int {_ << a \/ _ === a /\ _ << l} -> Prims.bool
(declare-fun Tm_arrow_3b099dde541b09ac816c3f5b22f3081f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3b099dde541b09ac816c3f5b22f3081f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3b099dde541b09ac816c3f5b22f3081f
Tm_type)
:named kinding_Tm_arrow_3b099dde541b09ac816c3f5b22f3081f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(25,9-29,30); use=Coincidence.fst(26,8-29,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3b099dde541b09ac816c3f5b22f3081f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_3b099dde541b09ac816c3f5b22f3081f))
:qid Coincidence_pre_typing_Tm_arrow_3b099dde541b09ac816c3f5b22f3081f))

:named Coincidence_pre_typing_Tm_arrow_3b099dde541b09ac816c3f5b22f3081f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3b099dde541b09ac816c3f5b22f3081f
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(25,9-29,30); use=Coincidence.fst(26,8-29,30)
(forall ((@x0 Term))
...
Prims.int)
(HasType @x2
(Tm_refine_9e5f99209b478038b006f989e528b33b @x1)))
...
@x1)
@x2))
:qid Coincidence_interpretation_Tm_arrow_3b099dde541b09ac816c3f5b22f3081f.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Coincidence_interpretation_Tm_arrow_3b099dde541b09ac816c3f5b22f3081f.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_3b099dde541b09ac816c3f5b22f3081f))
:qid Coincidence_interpretation_Tm_arrow_3b099dde541b09ac816c3f5b22f3081f))

:named Coincidence_interpretation_Tm_arrow_3b099dde541b09ac816c3f5b22f3081f))
(declare-fun Coincidence.mem@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(26,8-26,11); use=Coincidence.fst(26,8-26,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Coincidence.mem@tok
@x0)
@x1)
(Coincidence.mem @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Coincidence.mem@tok
@x0)
@x1))
:qid token_correspondence_Coincidence.mem))

:named token_correspondence_Coincidence.mem))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(26,8-26,11); use=Coincidence.fst(26,8-26,11)
...
:pattern ((Coincidence.mem @x1
@x2))
:qid function_token_typing_Coincidence.mem.1))
)
 

:pattern ((ApplyTT @x0
Coincidence.mem@tok))
:qid function_token_typing_Coincidence.mem))

:named function_token_typing_Coincidence.mem))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(26,8-26,11); use=Coincidence.fst(26,8-26,11)
...
Prims.int)
(HasType @x1
(Tm_refine_9e5f99209b478038b006f989e528b33b @x0)))
(HasType (Coincidence.mem @x0
@x1)
Prims.bool))
 

:pattern ((Coincidence.mem @x0
@x1))
:qid typing_Coincidence.mem))

:named typing_Coincidence.mem))
...
;   (~(Nil? l) ==>
;     (forall (b: Prims.int) (b: Prims.list Prims.int). l == b :: b ==> ~(b = a) ==> a << a \/ b << l)
;   )
...
;; def=Prims.fst(402,27-402,88); use=Coincidence.fst(27,2-29,30)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Coincidence.fst(27,2-29,30)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Coincidence.fst(27,2-29,30)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Coincidence.fst(27,2-29,30)
(and (implies 
;; def=Coincidence.fst(26,14-26,15); use=Coincidence.fst(27,8-27,9)
(and 
;; def=Coincidence.fst(26,14-26,15); use=Coincidence.fst(27,8-27,9)
(not 
;; def=Coincidence.fst(26,14-26,15); use=Coincidence.fst(27,8-27,9)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Coincidence.fst(27,2-29,30)
(not 
;; def=Coincidence.fst(26,14-26,15); use=Coincidence.fst(27,8-27,9)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_66b03f5c7897b05649fed8196554c587_1))
...
;; def=Prims.fst(413,99-413,120); use=Coincidence.fst(27,2-29,30)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=Coincidence.fst(26,14-29,10); use=Coincidence.fst(27,8-29,10)
(= x_66b03f5c7897b05649fed8196554c587_1
...
;; def=Coincidence.fst(29,14-29,18); use=Coincidence.fst(29,14-29,18)
(not 
;; def=Coincidence.fst(29,14-29,18); use=Coincidence.fst(29,14-29,18)
(= @x1
x_ae567c2fb75be05905677af440075565_0)
...
;; def=Coincidence.fst(26,12-29,30); use=Coincidence.fst(29,28-29,30)
(or label_2

;; def=Coincidence.fst(27,2-29,30); use=Coincidence.fst(29,28-29,30)
(Valid 
;; def=Coincidence.fst(27,2-29,30); use=Coincidence.fst(29,28-29,30)
(Prims.precedes Prims.int
Prims.int
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Coincidence.mem, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_66b03f5c7897b05649fed8196554c587_1, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, function_token_typing_Prims.__cache_version_number__, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Coincidence.mem.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Coincidence.mem.fuel_instrumented_token () Term)
(declare-fun Coincidence.mem (Term Term) Term)
(declare-fun Coincidence.mem@tok () Term)
;;;;;;;;;;;;;;;;a: Prims.int -> l: Prims.list Prims.int -> Prims.bool
(declare-fun Tm_arrow_ee937eaeb6b9b3349b89dc19cdae69d3 () Term)

; </end encoding let rec mem>


; encoding sigelt val Coincidence.sorted


; <Skipped val Coincidence.sorted/>

(push) ;; push{2

; Starting query at Coincidence.fst(34,2-36,13)
...
(declare-fun Tm_refine_717ff17cae4e2bd443528cee4117bc46 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_717ff17cae4e2bd443528cee4117bc46
Tm_type)
:named refinement_kinding_Tm_refine_717ff17cae4e2bd443528cee4117bc46))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(34,2-36,13); use=Coincidence.fst(34,2-36,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_717ff17cae4e2bd443528cee4117bc46)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))
...
@x1
Tm_refine_717ff17cae4e2bd443528cee4117bc46))
:qid refinement_interpretation_Tm_refine_717ff17cae4e2bd443528cee4117bc46))

:named refinement_interpretation_Tm_refine_717ff17cae4e2bd443528cee4117bc46))
;;;;;;;;;;;;;;;;haseq for Tm_refine_717ff17cae4e2bd443528cee4117bc46
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_717ff17cae4e2bd443528cee4117bc46))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_717ff17cae4e2bd443528cee4117bc46))
(declare-fun Coincidence.sorted (Term) Term)

;;;;;;;;;;;;;;;;_: _: Prims.list Prims.int {_ << l} -> Prims.bool
(declare-fun Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0
Tm_type)
:named kinding_Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(32,28-36,13); use=Coincidence.fst(33,8-36,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0))
:qid Coincidence_pre_typing_Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0))

:named Coincidence_pre_typing_Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(32,28-36,13); use=Coincidence.fst(33,8-36,13)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Coincidence_interpretation_Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0))
:qid Coincidence_interpretation_Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0))

:named Coincidence_interpretation_Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0))
(declare-fun Coincidence.sorted@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(33,8-33,14); use=Coincidence.fst(33,8-33,14)
(forall ((@x0 Term))
 (! (= (ApplyTT Coincidence.sorted@tok
@x0)
(Coincidence.sorted @x0))
 

:pattern ((ApplyTT Coincidence.sorted@tok
@x0))
:qid token_correspondence_Coincidence.sorted))

:named token_correspondence_Coincidence.sorted))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(33,8-33,14); use=Coincidence.fst(33,8-33,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Coincidence.sorted@tok
Tm_arrow_78d4495e1c90533cd6c67a0a33a5d1f0))
...
(forall ((@x1 Term))
 (! (= (ApplyTT Coincidence.sorted@tok
@x1)
(Coincidence.sorted @x1))
 

:pattern ((Coincidence.sorted @x1))
:qid function_token_typing_Coincidence.sorted.1))
)
 

:pattern ((ApplyTT @x0
Coincidence.sorted@tok))
:qid function_token_typing_Coincidence.sorted))

:named function_token_typing_Coincidence.sorted))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(33,8-33,14); use=Coincidence.fst(33,8-33,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_717ff17cae4e2bd443528cee4117bc46)
(HasType (Coincidence.sorted @x0)
Prims.bool))
 

:pattern ((Coincidence.sorted @x0))
:qid typing_Coincidence.sorted))

:named typing_Coincidence.sorted))
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post Prims.bool).
;   (forall (x: Prims.bool). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (forall (b: Prims.int) (b: Prims.int) (b: Prims.list Prims.int).
;       l == b :: b :: b ==> b < b ==> b :: b << l)
...
;; def=Prims.fst(402,27-402,88); use=Coincidence.fst(34,2-36,13)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Coincidence.fst(34,2-36,13)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Coincidence.fst(34,2-36,13)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(413,99-413,120); use=Coincidence.fst(34,2-36,13)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=Coincidence.fst(33,15-35,12); use=Coincidence.fst(34,8-35,12)
(= x_66b03f5c7897b05649fed8196554c587_0
(Prims.Cons Prims.int
@x1
(Prims.Cons Prims.int
...
;; def=Coincidence.fst(35,16-35,21); use=Coincidence.fst(35,16-35,21)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x2))
)

;; def=Coincidence.fst(34,2-36,13); use=Coincidence.fst(35,32-35,39)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Coincidence.sorted, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_66b03f5c7897b05649fed8196554c587_0, subterm_ordering_Prims.Cons
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Coincidence.sorted.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Coincidence.sorted.fuel_instrumented_token () Term)
(declare-fun Coincidence.sorted (Term) Term)
(declare-fun Coincidence.sorted@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Coincidence.sorted; Namespace Coincidence
(assert (! 
;; def=Coincidence.fst(33,8-33,14); use=Coincidence.fst(33,8-33,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
(Prims.list Prims.int))
(HasType (Coincidence.sorted.fuel_instrumented @u0
@x1)
Prims.bool))
 

:pattern ((Coincidence.sorted.fuel_instrumented @u0
@x1))
:qid token_correspondence_Coincidence.sorted.fuel_instrumented))

:named token_correspondence_Coincidence.sorted.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.__proj__Cons__item__hd; Namespace Prims
(assert (! 
;; def=Prims.fst(616,4-616,8); use=Prims.fst(616,4-616,8)
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Coincidence.sorted
;;; Fact-ids: Name Coincidence.sorted; Namespace Coincidence
(assert (! 
;; def=Coincidence.fst(33,8-33,14); use=Coincidence.fst(33,8-33,14)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
(Prims.list Prims.int))
(= (Coincidence.sorted.fuel_instrumented (SFuel @u0)
@x1)
(let ((@lb2 @x1))
(ite (and (is-Prims.Cons @lb2)
(is-Prims.Cons (Prims.Cons_tl @lb2)))
(Prims.op_AmpAmp (Prims.op_LessThan (Prims.Cons_hd @lb2)
(Prims.Cons_hd (Prims.Cons_tl @lb2)))
(Coincidence.sorted.fuel_instrumented @u0
(Prims.Cons Prims.int
(Prims.Cons_hd (Prims.Cons_tl @lb2))
...
:pattern ((Coincidence.sorted.fuel_instrumented (SFuel @u0)
@x1))
:qid equation_with_fuel_Coincidence.sorted.fuel_instrumented))

:named equation_with_fuel_Coincidence.sorted.fuel_instrumented))
;;;;;;;;;;;;;;;;b2t typing
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (= (Coincidence.sorted.fuel_instrumented (SFuel @u0)
@x1)
(Coincidence.sorted.fuel_instrumented ZFuel
@x1))
 

:pattern ((Coincidence.sorted.fuel_instrumented (SFuel @u0)
@x1))
:qid @fuel_irrelevance_Coincidence.sorted.fuel_instrumented))

:named @fuel_irrelevance_Coincidence.sorted.fuel_instrumented))
...
(forall ((@x0 Term))
 (! (= (Coincidence.sorted @x0)
(Coincidence.sorted.fuel_instrumented MaxFuel
@x0))
 

:pattern ((Coincidence.sorted @x0))
:qid @fuel_correspondence_Coincidence.sorted.fuel_instrumented))

:named @fuel_correspondence_Coincidence.sorted.fuel_instrumented))
(push) ;; push{2

; Starting query at Coincidence.fst(39,0-41,34)
...
; Encoding query formula : forall (y: Prims.int) (xs: Prims.list Prims.int).
;   (Coincidence.sorted xs ==> Prims.hasEq (Prims.list Prims.int) /\ (~(xs = []) ==> Cons? xs)) /\
;   (forall (any_result: Prims.bool).
;       (Coincidence.sorted xs && (xs = [] || y < xs.hd)) == any_result ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `val Coincidence.lemma1`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Coincidence.fst(39,0-41,34)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=Coincidence.fst(39,15-41,34)
(and (implies 
;; def=Coincidence.fst(40,19-40,28); use=Coincidence.fst(40,19-40,28)
(BoxBool_proj_0 (Coincidence.sorted @x1))


;; def=Coincidence.fst(39,22-40,40); use=Coincidence.fst(40,33-40,59)
(and 
;; def=Prims.fst(73,23-73,30); use=Coincidence.fst(40,33-40,35)
(or label_1

;; def=Prims.fst(73,23-73,30); use=Coincidence.fst(40,33-40,35)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Coincidence.fst(40,33-40,35)
(Prims.hasEq (Prims.list Prims.int))
)
)

(implies 
;; def=Coincidence.fst(40,33-40,40); use=Coincidence.fst(40,33-40,40)
(not 
;; def=Coincidence.fst(40,33-40,40); use=Coincidence.fst(40,33-40,40)
(= @x1
(Prims.Nil Prims.int))
...
;; def=Prims.fst(616,4-616,8); use=Coincidence.fst(40,57-40,59)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Coincidence.fst(39,15-41,34)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.bool)

;; def=Prims.fst(180,10-180,11); use=Coincidence.fst(39,15-41,34)
(= (Prims.op_AmpAmp (Coincidence.sorted @x1)
(Prims.op_BarBar (Prims.op_Equality (Prims.list Prims.int)
@x1
(Prims.Nil Prims.int))
(Prims.op_LessThan @x0
(Prims.__proj__Cons__item__hd Prims.int
@x1))))
@x2)
)
...
;; def=FStar.Pervasives.fsti(112,28-112,31); use=Coincidence.fst(39,15-41,34)
(= (Prims.b2t (Prims.op_AmpAmp (Coincidence.sorted @x1)
(Prims.op_BarBar (Prims.op_Equality (Prims.list Prims.int)
@x1
(Prims.Nil Prims.int))
(Prims.op_LessThan @x0
...
;; def=Coincidence.fst(40,19-40,28); use=Coincidence.fst(41,17-41,33)
(BoxBool_proj_0 (Coincidence.sorted @x1))
)

;; def=Coincidence.fst(39,22-40,40); use=Coincidence.fst(41,17-41,33)
(and 
;; def=Prims.fst(73,23-73,30); use=Coincidence.fst(40,2-40,7)
(or label_3

;; def=Prims.fst(73,23-73,30); use=Coincidence.fst(41,17-41,33)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Coincidence.fst(41,17-41,33)
(Prims.hasEq (Prims.list Prims.int))
)
...
(implies 
;; def=Coincidence.fst(40,33-40,40); use=Coincidence.fst(41,17-41,33)
(not 
;; def=Coincidence.fst(40,33-40,40); use=Coincidence.fst(41,17-41,33)
(= @x1
(Prims.Nil Prims.int))
...
;; def=Prims.fst(616,4-616,8); use=Coincidence.fst(41,17-41,33)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x1))
)
))
...
; encoding sigelt val Coincidence.lemma1


; <Skipped val Coincidence.lemma1/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Coincidence.mem; Namespace Coincidence
(assert (! 
;; def=Coincidence.fst(26,8-26,11); use=Coincidence.fst(26,8-26,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x2
(Prims.list Prims.int)))
(HasType (Coincidence.mem.fuel_instrumented @u0
@x1
@x2)
Prims.bool))
 

:pattern ((Coincidence.mem.fuel_instrumented @u0
@x1
@x2))
:qid token_correspondence_Coincidence.mem.fuel_instrumented))

:named token_correspondence_Coincidence.mem.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Coincidence.mem
;;; Fact-ids: Name Coincidence.mem; Namespace Coincidence
(assert (! 
;; def=Coincidence.fst(26,8-26,11); use=Coincidence.fst(26,8-26,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
...
(HasType @x2
(Prims.list Prims.int)))
(= (Coincidence.mem.fuel_instrumented (SFuel @u0)
@x1
@x2)
(let ((@lb3 @x2))
...
(Prims.Cons_hd @lb3)
@x1)
(Coincidence.mem.fuel_instrumented @u0
@x1
(Prims.Cons_tl @lb3)))
Tm_unit)))))
 :weight 0
...
:pattern ((Coincidence.mem.fuel_instrumented (SFuel @u0)
@x1
@x2))
:qid equation_with_fuel_Coincidence.mem.fuel_instrumented))

:named equation_with_fuel_Coincidence.mem.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Coincidence.mem; Namespace Coincidence
(assert (! 
;; def=Coincidence.fst(26,8-26,11); use=Coincidence.fst(26,8-26,11)
...
@x1
@x2)
(Coincidence.mem.fuel_instrumented ZFuel
@x1
@x2))
...
@x1
@x2))
:qid @fuel_irrelevance_Coincidence.mem.fuel_instrumented))

:named @fuel_irrelevance_Coincidence.mem.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name Coincidence.mem; Namespace Coincidence
(assert (! 
;; def=Coincidence.fst(26,8-26,11); use=Coincidence.fst(26,8-26,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Coincidence.mem @x0
@x1)
(Coincidence.mem.fuel_instrumented MaxFuel
@x0
@x1))
...
:pattern ((Coincidence.mem @x0
@x1))
:qid @fuel_correspondence_Coincidence.mem.fuel_instrumented))

:named @fuel_correspondence_Coincidence.mem.fuel_instrumented))
(push) ;; push{2

; Starting query at Coincidence.fst(43,2-45,26)

;;;;;;;;;;;;;;;;y : Prims.int (Prims.int)
(declare-fun x_ae567c2fb75be05905677af440075565_0 () Term)
;;;;;;;;;;;;;;;;binder_x_ae567c2fb75be05905677af440075565_0
;;; Fact-ids: 
(assert (! (HasType x_ae567c2fb75be05905677af440075565_0
Prims.int)
:named binder_x_ae567c2fb75be05905677af440075565_0))
;;;;;;;;;;;;;;;;xs : Prims.list Prims.int (Prims.list Prims.int)
(declare-fun x_66b03f5c7897b05649fed8196554c587_1 () Term)
;;;;;;;;;;;;;;;;binder_x_66b03f5c7897b05649fed8196554c587_1
;;; Fact-ids: 
(assert (! (HasType x_66b03f5c7897b05649fed8196554c587_1
...
:named binder_x_66b03f5c7897b05649fed8196554c587_1))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Coincidence.lemma1 (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Coincidence.lemma1@tok () Term)
...
;   Coincidence.sorted xs && (xs = [] || y < xs.hd) /\
;   (forall (pure_result: Prims.unit). Prims.op_Negation (Coincidence.mem y xs) ==> p pure_result) ==>
...
;                 b == any_result ==>
;                 Coincidence.sorted b && (b = [] || y < b.hd) /\
;                 (forall (pure_result: Prims.unit).
;                     Prims.op_Negation (Coincidence.mem y b) ==> k pure_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec lemma1`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Coincidence.fst(43,2-45,26); use=Coincidence.fst(43,2-45,26)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))
(BoxBool_proj_0 (Coincidence.sorted x_66b03f5c7897b05649fed8196554c587_1))
(BoxBool_proj_0 (Prims.op_BarBar (Prims.op_Equality (Prims.list Prims.int)
x_66b03f5c7897b05649fed8196554c587_1
(Prims.Nil Prims.int))
...
;; def=Prims.fst(441,36-441,97); use=Coincidence.fst(43,2-45,26)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))
(or label_2
(not (BoxBool_proj_0 (Coincidence.mem x_ae567c2fb75be05905677af440075565_0
x_66b03f5c7897b05649fed8196554c587_1)))))

;; def=Prims.fst(441,83-441,96); use=Coincidence.fst(43,2-45,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Coincidence.fst(43,2-45,26)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=Coincidence.fst(43,2-45,26)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=Coincidence.fst(43,2-45,26)
(Valid 
;; def=Prims.fst(402,73-402,79); use=Coincidence.fst(43,2-45,26)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=Coincidence.fst(43,2-45,26)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Coincidence.fst(43,2-45,26)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=Coincidence.fst(43,2-45,26)
(and (implies 
;; def=Coincidence.fst(42,17-42,19); use=Coincidence.fst(43,8-43,10)
(and 
;; def=Coincidence.fst(42,17-42,19); use=Coincidence.fst(43,8-43,10)
(not 
;; def=Coincidence.fst(42,17-42,19); use=Coincidence.fst(43,8-43,10)
...
label_3)
(implies 
;; def=Coincidence.fst(42,17-44,6); use=Coincidence.fst(43,8-44,6)
(= x_66b03f5c7897b05649fed8196554c587_1
(Prims.Nil Prims.int))


;; def=Prims.fst(451,66-451,102); use=Coincidence.fst(43,2-45,26)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=Coincidence.fst(43,2-45,26)
(Valid 
;; def=Prims.fst(451,90-451,102); use=Coincidence.fst(43,2-45,26)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Coincidence.fst(43,2-45,26)
(not 
;; def=Coincidence.fst(42,17-42,19); use=Coincidence.fst(43,8-43,10)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_66b03f5c7897b05649fed8196554c587_1))
...
;; def=Prims.fst(413,99-413,120); use=Coincidence.fst(43,2-45,26)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)
...
;; def=Coincidence.fst(42,17-45,10); use=Coincidence.fst(43,8-45,10)
(= x_66b03f5c7897b05649fed8196554c587_1
(Prims.Cons Prims.int
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=Coincidence.fst(43,2-45,26)
(and 
;; def=Coincidence.fst(39,13-45,26); use=Coincidence.fst(45,23-45,26)
(or label_4

;; def=Coincidence.fst(43,2-45,26); use=Coincidence.fst(45,23-45,26)
(Valid 
;; def=Coincidence.fst(43,2-45,26); use=Coincidence.fst(45,23-45,26)
(Prims.precedes Prims.int
Prims.int
...
;; def=Coincidence.fst(39,22-45,10); use=Coincidence.fst(43,2-45,26)
(= @x3
@x4)
)

;; def=Prims.fst(441,29-441,97); use=Coincidence.fst(45,14-45,20)
(and (or label_5
(BoxBool_proj_0 (Coincidence.sorted @x3)))
(or label_6
(BoxBool_proj_0 (Prims.op_BarBar (Prims.op_Equality (Prims.list Prims.int)
@x3
(Prims.Nil Prims.int))
...
;; def=Prims.fst(441,36-441,97); use=Coincidence.fst(45,14-45,20)
(forall ((@x5 Term))
...
;; def=Prims.fst(441,83-441,96); use=Coincidence.fst(45,14-45,20)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Coincidence.fst(45,14-45,20)
(ApplyTT @x1
@x5)
...
; Starting query at Coincidence.fst(42,0-45,26)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_5a85b56fd8f9cf98d38df0db54be5673 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(39,13-45,26); use=Coincidence.fst(42,0-45,26)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_5a85b56fd8f9cf98d38df0db54be5673 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_5a85b56fd8f9cf98d38df0db54be5673 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_5a85b56fd8f9cf98d38df0db54be5673))

:named refinement_kinding_Tm_refine_5a85b56fd8f9cf98d38df0db54be5673))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(39,13-45,26); use=Coincidence.fst(42,0-45,26)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5a85b56fd8f9cf98d38df0db54be5673 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Coincidence.fst(39,13-45,26); use=Coincidence.fst(42,0-45,26)
(and 
;; def=Coincidence.fst(39,13-42,16); use=Coincidence.fst(42,0-45,26)
(Valid 
;; def=Coincidence.fst(39,13-42,16); use=Coincidence.fst(42,0-45,26)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_5a85b56fd8f9cf98d38df0db54be5673))

:named refinement_interpretation_Tm_refine_5a85b56fd8f9cf98d38df0db54be5673))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5a85b56fd8f9cf98d38df0db54be5673
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(39,13-45,26); use=Coincidence.fst(42,0-45,26)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5a85b56fd8f9cf98d38df0db54be5673 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5a85b56fd8f9cf98d38df0db54be5673 @x0
@x1
@x2))))
:qid haseqTm_refine_5a85b56fd8f9cf98d38df0db54be5673))

:named haseqTm_refine_5a85b56fd8f9cf98d38df0db54be5673))

; Encoding query formula : forall (y: Prims.int)
;   (xs: Prims.list Prims.int)
;   (y: Prims.int)
;   (xs: Prims.list Prims.int {y << y \/ y === y /\ xs << xs}).
;   (Coincidence.sorted xs ==>
;     Prims.hasEq (Prims.list Prims.int) /\
;     (~(xs = []) ==> y << y \/ y === y /\ xs << xs ==> Cons? xs)) /\
;   (forall (any_result: Prims.bool).
;       (Coincidence.sorted xs && (xs = [] || y < xs.hd)) == any_result ==>
;       (forall (any_result: Prims.logical).
;           (Coincidence.sorted xs && (xs = [] || y < xs.hd)) == any_result ==>
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Coincidence.fst(42,0-45,26)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=Coincidence.fst(42,0-45,26)
(and (implies 
;; def=Coincidence.fst(40,19-40,28); use=Coincidence.fst(42,8-42,14)
(BoxBool_proj_0 (Coincidence.sorted @x3))


;; def=Coincidence.fst(39,22-40,40); use=Coincidence.fst(42,8-42,14)
(and 
;; def=Prims.fst(73,23-73,30); use=Coincidence.fst(42,8-42,14)
(or label_1
...
(implies (and 
;; def=Coincidence.fst(40,33-40,40); use=Coincidence.fst(42,8-42,14)
(not 
;; def=Coincidence.fst(40,33-40,40); use=Coincidence.fst(42,8-42,14)
(= @x3
(Prims.Nil Prims.int))
...
;; def=Coincidence.fst(39,13-45,26); use=Coincidence.fst(42,8-42,14)

;; def=Coincidence.fst(39,13-45,26); use=Coincidence.fst(42,8-42,14)
(or 
;; def=Coincidence.fst(43,2-45,26); use=Coincidence.fst(42,8-42,14)
(Valid 
;; def=Coincidence.fst(43,2-45,26); use=Coincidence.fst(42,8-42,14)
(Prims.precedes Prims.int
Prims.int
...
;; def=Coincidence.fst(39,13-45,26); use=Coincidence.fst(42,8-42,14)
(and 
;; def=Coincidence.fst(39,13-42,16); use=Coincidence.fst(42,8-42,14)
(Valid 
;; def=Coincidence.fst(39,13-42,16); use=Coincidence.fst(42,8-42,14)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
;; def=Prims.fst(616,4-616,8); use=Coincidence.fst(42,8-42,14)
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
@x3))
)
))
...
;; def=Prims.fst(451,66-451,102); use=Coincidence.fst(42,0-45,26)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.bool)

;; def=Prims.fst(180,10-180,11); use=Coincidence.fst(42,0-45,26)
(= (Prims.op_AmpAmp (Coincidence.sorted @x3)
(Prims.op_BarBar (Prims.op_Equality (Prims.list Prims.int)
@x3
(Prims.Nil Prims.int))
...
;; def=FStar.Pervasives.fsti(112,28-112,31); use=Coincidence.fst(42,0-45,26)
(= (Prims.b2t (Prims.op_AmpAmp (Coincidence.sorted @x3)
(Prims.op_BarBar (Prims.op_Equality (Prims.list Prims.int)
@x3
(Prims.Nil Prims.int))
(Prims.op_LessThan @x2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Coincidence.lemma1, 3)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, assumption_Prims.list__uu___haseq, disc_equation_Prims.Cons, equation_Prims.eqtype, fuel_guarded_inversion_Prims.list, function_token_typing_Prims.__cache_version_number__, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_5a85b56fd8f9cf98d38df0db54be5673, typing_Prims.int
...
; encoding sigelt let rec lemma1


; <Start encoding let rec lemma1>
...
; </end encoding let rec lemma1>


; encoding sigelt val Coincidence.coincidence


; <Skipped val Coincidence.coincidence/>
...
; Starting query at Coincidence.fst(51,2-56,11)

;;;;;;;;;;;;;;;;xs : xs: Prims.list Prims.int {Coincidence.sorted xs} (xs: Prims.list Prims.int {Coincidence.sorted xs})
(declare-fun x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0 () Term)
(declare-fun Tm_refine_71e8d8b44dbf25589942ba53ea8a610b () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_71e8d8b44dbf25589942ba53ea8a610b
Tm_type)
:named refinement_kinding_Tm_refine_71e8d8b44dbf25589942ba53ea8a610b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(48,18-48,42); use=Coincidence.fst(50,8-50,19)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_71e8d8b44dbf25589942ba53ea8a610b)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=Coincidence.fst(48,32-48,41); use=Coincidence.fst(50,8-50,19)
(BoxBool_proj_0 (Coincidence.sorted @x1))
))
...
@x1
Tm_refine_71e8d8b44dbf25589942ba53ea8a610b))
:qid refinement_interpretation_Tm_refine_71e8d8b44dbf25589942ba53ea8a610b))

:named refinement_interpretation_Tm_refine_71e8d8b44dbf25589942ba53ea8a610b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_71e8d8b44dbf25589942ba53ea8a610b
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_71e8d8b44dbf25589942ba53ea8a610b))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_71e8d8b44dbf25589942ba53ea8a610b))
;;;;;;;;;;;;;;;;binder_x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0
;;; Fact-ids: 
(assert (! (HasType x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0
Tm_refine_71e8d8b44dbf25589942ba53ea8a610b)
:named binder_x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0))
;;;;;;;;;;;;;;;;ys : ys: Prims.list Prims.int {Coincidence.sorted ys} (ys: Prims.list Prims.int {Coincidence.sorted ys})
(declare-fun x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1 () Term)

;;;;;;;;;;;;;;;;binder_x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1
;;; Fact-ids: 
(assert (! (HasType x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1
Tm_refine_71e8d8b44dbf25589942ba53ea8a610b)
:named binder_x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1))

(declare-fun Tm_refine_d3b2d0563dca5e0180c5749c820faf58 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(48,18-56,11)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_d3b2d0563dca5e0180c5749c820faf58 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_d3b2d0563dca5e0180c5749c820faf58 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_d3b2d0563dca5e0180c5749c820faf58))

:named refinement_kinding_Tm_refine_d3b2d0563dca5e0180c5749c820faf58))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(48,18-56,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d3b2d0563dca5e0180c5749c820faf58 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=Coincidence.fst(48,62-48,71); use=Coincidence.fst(50,8-50,19)
(BoxBool_proj_0 (Coincidence.sorted @x1))
...
;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(48,18-56,11)
(or 
;; def=Coincidence.fst(51,2-56,11); use=Coincidence.fst(51,2-56,11)
(Valid 
;; def=Coincidence.fst(51,2-56,11); use=Coincidence.fst(51,2-56,11)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
@x2
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0)
)


;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(48,18-56,11)
(and 
;; def=Coincidence.fst(48,18-50,22); use=Coincidence.fst(48,18-50,22)
(Valid 
;; def=Coincidence.fst(48,18-50,22); use=Coincidence.fst(48,18-50,22)
...
(Prims.list Prims.int)
@x1
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)
)
)
)
...
@x1
(Tm_refine_d3b2d0563dca5e0180c5749c820faf58 @x2)))
:qid refinement_interpretation_Tm_refine_d3b2d0563dca5e0180c5749c820faf58))

:named refinement_interpretation_Tm_refine_d3b2d0563dca5e0180c5749c820faf58))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d3b2d0563dca5e0180c5749c820faf58
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(48,18-56,11)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d3b2d0563dca5e0180c5749c820faf58 @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d3b2d0563dca5e0180c5749c820faf58 @x0))))
:qid haseqTm_refine_d3b2d0563dca5e0180c5749c820faf58))

:named haseqTm_refine_d3b2d0563dca5e0180c5749c820faf58))
(declare-fun Coincidence.coincidence (Term Term) Term)


(declare-fun Tm_refine_13f4b79e3d32f722463ee62ae304d544 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(49,12-49,75); use=Coincidence.fst(50,8-50,19)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_13f4b79e3d32f722463ee62ae304d544 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_13f4b79e3d32f722463ee62ae304d544 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_13f4b79e3d32f722463ee62ae304d544))

:named refinement_kinding_Tm_refine_13f4b79e3d32f722463ee62ae304d544))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(49,12-49,75); use=Coincidence.fst(50,8-50,19)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_13f4b79e3d32f722463ee62ae304d544 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=Coincidence.fst(49,27-49,73); use=Coincidence.fst(50,8-50,19)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.int)

;; def=Coincidence.fst(49,37-49,73); use=Coincidence.fst(50,8-50,19)
(iff 
;; def=Coincidence.fst(49,37-49,45); use=Coincidence.fst(50,8-50,19)
(BoxBool_proj_0 (Coincidence.mem @x4
@x1))


;; def=Coincidence.fst(49,51-49,73); use=Coincidence.fst(50,8-50,19)
(and (BoxBool_proj_0 (Coincidence.mem @x4
@x2))
(BoxBool_proj_0 (Coincidence.mem @x4
@x3)))
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_13f4b79e3d32f722463ee62ae304d544.1))
))
...
(Tm_refine_13f4b79e3d32f722463ee62ae304d544 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_13f4b79e3d32f722463ee62ae304d544))

:named refinement_interpretation_Tm_refine_13f4b79e3d32f722463ee62ae304d544))
;;;;;;;;;;;;;;;;haseq for Tm_refine_13f4b79e3d32f722463ee62ae304d544
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(49,12-49,75); use=Coincidence.fst(50,8-50,19)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_13f4b79e3d32f722463ee62ae304d544 @x0
@x1)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_13f4b79e3d32f722463ee62ae304d544 @x0
@x1))))
:qid haseqTm_refine_13f4b79e3d32f722463ee62ae304d544))

:named haseqTm_refine_13f4b79e3d32f722463ee62ae304d544))
;;;;;;;;;;;;;;;;xs: Prims.list Prims.int {sorted xs} ->     ys: (ys: Prims.list Prims.int {sorted ys}){xs << xs \/ xs === xs /\ ys << ys}   -> zs: Prims.list Prims.int {forall (z: Prims.int). mem z zs <==> mem z xs && mem z ys}
(declare-fun Tm_arrow_5ed9ec68903c26adea28924f9a65973d () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5ed9ec68903c26adea28924f9a65973d
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_5ed9ec68903c26adea28924f9a65973d
Tm_type)
:named kinding_Tm_arrow_5ed9ec68903c26adea28924f9a65973d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(48,18-56,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_5ed9ec68903c26adea28924f9a65973d)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_5ed9ec68903c26adea28924f9a65973d))
:qid Coincidence_pre_typing_Tm_arrow_5ed9ec68903c26adea28924f9a65973d))

:named Coincidence_pre_typing_Tm_arrow_5ed9ec68903c26adea28924f9a65973d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5ed9ec68903c26adea28924f9a65973d
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(48,18-56,11)
(forall ((@x0 Term))
...
Tm_refine_71e8d8b44dbf25589942ba53ea8a610b)
(HasType @x2
(Tm_refine_d3b2d0563dca5e0180c5749c820faf58 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
(Tm_refine_13f4b79e3d32f722463ee62ae304d544 @x1
@x2)))
...
@x1)
@x2))
:qid Coincidence_interpretation_Tm_arrow_5ed9ec68903c26adea28924f9a65973d.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Coincidence_interpretation_Tm_arrow_5ed9ec68903c26adea28924f9a65973d.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_5ed9ec68903c26adea28924f9a65973d))
:qid Coincidence_interpretation_Tm_arrow_5ed9ec68903c26adea28924f9a65973d))

:named Coincidence_interpretation_Tm_arrow_5ed9ec68903c26adea28924f9a65973d))
(declare-fun Coincidence.coincidence@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(50,8-50,19); use=Coincidence.fst(50,8-50,19)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Coincidence.coincidence@tok
@x0)
@x1)
(Coincidence.coincidence @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Coincidence.coincidence@tok
@x0)
@x1))
:qid token_correspondence_Coincidence.coincidence))

:named token_correspondence_Coincidence.coincidence))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(50,8-50,19); use=Coincidence.fst(50,8-50,19)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Coincidence.coincidence@tok
Tm_arrow_5ed9ec68903c26adea28924f9a65973d))
...
@x1)
@x2)
(Coincidence.coincidence @x1
@x2))
 

:pattern ((Coincidence.coincidence @x1
@x2))
:qid function_token_typing_Coincidence.coincidence.1))
)
 

:pattern ((ApplyTT @x0
Coincidence.coincidence@tok))
:qid function_token_typing_Coincidence.coincidence))

:named function_token_typing_Coincidence.coincidence))
...
Tm_refine_71e8d8b44dbf25589942ba53ea8a610b)
(HasType @x1
(Tm_refine_d3b2d0563dca5e0180c5749c820faf58 @x0)))
(HasType (Coincidence.coincidence @x0
@x1)
(Tm_refine_13f4b79e3d32f722463ee62ae304d544 @x0
@x1)))
 

:pattern ((Coincidence.coincidence @x0
@x1))
:qid typing_Coincidence.coincidence))

:named typing_Coincidence.coincidence))
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_83b0d7e331121c283f4e67c01921c9b5 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_83b0d7e331121c283f4e67c01921c9b5
Tm_type)
:named refinement_kinding_Tm_refine_83b0d7e331121c283f4e67c01921c9b5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(49,12-49,75); use=Coincidence.fst(51,2-56,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_83b0d7e331121c283f4e67c01921c9b5)
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))

;; def=Coincidence.fst(49,27-49,73); use=Coincidence.fst(51,2-56,11)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=Coincidence.fst(49,37-49,73); use=Coincidence.fst(51,2-56,11)
(iff 
;; def=Coincidence.fst(49,37-49,45); use=Coincidence.fst(51,2-56,11)
(BoxBool_proj_0 (Coincidence.mem @x2
@x1))


;; def=Coincidence.fst(49,51-49,73); use=Coincidence.fst(51,2-56,11)
(and (BoxBool_proj_0 (Coincidence.mem @x2
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0))
(BoxBool_proj_0 (Coincidence.mem @x2
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)))
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_83b0d7e331121c283f4e67c01921c9b5.1))
))
...
@x1
Tm_refine_83b0d7e331121c283f4e67c01921c9b5))
:qid refinement_interpretation_Tm_refine_83b0d7e331121c283f4e67c01921c9b5))

:named refinement_interpretation_Tm_refine_83b0d7e331121c283f4e67c01921c9b5))
;;;;;;;;;;;;;;;;haseq for Tm_refine_83b0d7e331121c283f4e67c01921c9b5
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_83b0d7e331121c283f4e67c01921c9b5))
(Valid (Prims.hasEq (Prims.list Prims.int))))
:named haseqTm_refine_83b0d7e331121c283f4e67c01921c9b5))





(declare-fun Tm_refine_7c69cf6763f69aec3c78eff142b302fd (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(49,12-49,75); use=Coincidence.fst(51,2-56,11)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_7c69cf6763f69aec3c78eff142b302fd @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_7c69cf6763f69aec3c78eff142b302fd @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_7c69cf6763f69aec3c78eff142b302fd))

:named refinement_kinding_Tm_refine_7c69cf6763f69aec3c78eff142b302fd))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(49,12-49,75); use=Coincidence.fst(51,2-56,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7c69cf6763f69aec3c78eff142b302fd @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))
...
(iff 
;; def=Coincidence.fst(49,37-49,45); use=Coincidence.fst(51,2-56,11)
(BoxBool_proj_0 (Coincidence.mem @x3
@x1))


;; def=Coincidence.fst(49,51-49,73); use=Coincidence.fst(51,2-56,11)
(and (BoxBool_proj_0 (Coincidence.mem @x3
@x2))
(BoxBool_proj_0 (Coincidence.mem @x3
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)))
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_7c69cf6763f69aec3c78eff142b302fd.1))
))
...
@x1
(Tm_refine_7c69cf6763f69aec3c78eff142b302fd @x2)))
:qid refinement_interpretation_Tm_refine_7c69cf6763f69aec3c78eff142b302fd))

:named refinement_interpretation_Tm_refine_7c69cf6763f69aec3c78eff142b302fd))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7c69cf6763f69aec3c78eff142b302fd
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(49,12-49,75); use=Coincidence.fst(51,2-56,11)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7c69cf6763f69aec3c78eff142b302fd @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7c69cf6763f69aec3c78eff142b302fd @x0))))
:qid haseqTm_refine_7c69cf6763f69aec3c78eff142b302fd))

:named haseqTm_refine_7c69cf6763f69aec3c78eff142b302fd))
(declare-fun Tm_refine_648e990f04b5ab5536406e0d718e9a3a (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(49,12-49,75); use=Coincidence.fst(51,2-56,11)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_648e990f04b5ab5536406e0d718e9a3a @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_648e990f04b5ab5536406e0d718e9a3a @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_648e990f04b5ab5536406e0d718e9a3a))

:named refinement_kinding_Tm_refine_648e990f04b5ab5536406e0d718e9a3a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(49,12-49,75); use=Coincidence.fst(51,2-56,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_648e990f04b5ab5536406e0d718e9a3a @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list Prims.int))
...
;;no pats
:qid refinement_interpretation_Tm_refine_648e990f04b5ab5536406e0d718e9a3a.1))
))
...
@x1
(Tm_refine_648e990f04b5ab5536406e0d718e9a3a @x2)))
:qid refinement_interpretation_Tm_refine_648e990f04b5ab5536406e0d718e9a3a))

:named refinement_interpretation_Tm_refine_648e990f04b5ab5536406e0d718e9a3a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_648e990f04b5ab5536406e0d718e9a3a
;;; Fact-ids: 
(assert (! 
;; def=Coincidence.fst(49,12-49,75); use=Coincidence.fst(51,2-56,11)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_648e990f04b5ab5536406e0d718e9a3a @x0)))
(Valid (Prims.hasEq (Prims.list Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_648e990f04b5ab5536406e0d718e9a3a @x0))))
:qid haseqTm_refine_648e990f04b5ab5536406e0d718e9a3a))

:named haseqTm_refine_648e990f04b5ab5536406e0d718e9a3a))
...
;       Prims.list Prims.int
;         { forall (z: Prims.int).
;             Coincidence.mem z zs <==> Coincidence.mem z xs && Coincidence.mem z ys })).
;   (forall (x:
;       zs:
;       Prims.list Prims.int
;         { forall (z: Prims.int).
...
;   (forall (b: Prims.int) (b: Prims.list Prims.int) (b: Prims.int) (b: Prims.list Prims.int).
;       (xs, ys) == (b :: b, b :: b) ==>
;       (forall (k:
;           Prims.pure_post (zs:
;               Prims.list Prims.int
...
;               Prims.auto_squash (k x)) ==>
;           (b = b == true ==>
;             Coincidence.sorted b /\
;             (forall (any_result: Prims.list Prims.int).
;                 b == any_result ==>
;                 Coincidence.sorted b /\ (b << xs \/ b === xs /\ b << ys) /\
;                 (forall (any_result: Prims.list Prims.int).
;                     b == any_result ==>
;                     (forall (any_result:
;                         zs:
;                         Prims.list Prims.int
;                           { forall (z: Prims.int).
;                               Coincidence.mem z zs <==> Coincidence.mem z b && Coincidence.mem z b })
;                       .
;                         Coincidence.coincidence b b == any_result ==>
;                         (forall (return_val:
;                             zs:
;                             Prims.list Prims.int
;                               { forall (z: Prims.int).
;                                   Coincidence.mem z zs <==>
;                                   Coincidence.mem z b && Coincidence.mem z b }).
;                             return_val == Coincidence.coincidence b b ==>
;                             Coincidence.coincidence b b == return_val ==>
;                             (forall (any_result: Prims.list Prims.int).
;                                 b :: Coincidence.coincidence b b == any_result ==>
;                                 (forall (z: Prims.int).
;                                     Coincidence.mem z (b :: Coincidence.coincidence b b) <==>
;                                     Coincidence.mem z xs && Coincidence.mem z ys))))))) /\
;           (~(b = b = true) ==>
;             (forall (b: Prims.bool).
;                 b = b == b ==>
;                 (forall (k:
...
;                         Prims.auto_squash (k x)) ==>
;                     (b < b == true ==>
;                       Coincidence.sorted ys && (ys = [] || b < ys.hd) /\
;                       (forall (pure_result: Prims.unit).
;                           Prims.op_Negation (Coincidence.mem b ys) ==>
;                           Coincidence.sorted b /\
;                           (forall (any_result: Prims.list Prims.int).
;                               b == any_result ==>
;                               (Coincidence.sorted ys ==>
;                                 Coincidence.sorted ys /\ (b << xs \/ b === xs /\ ys << ys)) /\
;                               (forall (any_result: ys: Prims.list Prims.int {Coincidence.sorted ys})
;                                 .
;                                   ys == any_result ==>
;                                   (forall (any_result:
;                                       zs:
...
;                                         { forall (z: Prims.int).
;                                             Coincidence.mem z zs <==>
;                                             Coincidence.mem z b && Coincidence.mem z ys }).
;                                       Coincidence.coincidence b ys == any_result ==>
;                                       (forall (z: Prims.int).
;                                           Coincidence.mem z (Coincidence.coincidence b ys) <==>
;                                           Coincidence.mem z b && Coincidence.mem z ys) ==>
;                                       (forall (z: Prims.int).
;                                           Coincidence.mem z (Coincidence.coincidence b ys) <==>
;                                           Coincidence.mem z xs && Coincidence.mem z ys)))))) /\
...
;                       (forall (b: Prims.bool).
;                           b < b == b ==>
;                           Coincidence.sorted xs && (xs = [] || b < xs.hd) /\
;                           (forall (pure_result: Prims.unit).
;                               Prims.op_Negation (Coincidence.mem b xs) ==>
;                               Coincidence.sorted b /\ (xs << xs \/ b << ys) /\
;                               (forall (any_result: Prims.list Prims.int).
;                                   b == any_result ==>
;                                   (forall (any_result:
;                                       zs:
...
;                                         { forall (z: Prims.int).
;                                             Coincidence.mem z zs <==>
;                                             Coincidence.mem z xs && Coincidence.mem z b }).
;                                       Coincidence.coincidence xs b == any_result ==>
;                                       (forall (z: Prims.int).
;                                           Coincidence.mem z (Coincidence.coincidence xs b) <==>
;                                           Coincidence.mem z xs && Coincidence.mem z b) ==>
;                                       (forall (z: Prims.int).
;                                           Coincidence.mem z (Coincidence.coincidence xs b) <==>
;                                           Coincidence.mem z xs && Coincidence.mem z ys))))))))))) /\
;   (~(Cons? (xs, ys)._1 && Cons? (xs, ys)._2) ==>
;     (forall (b: Prims.list Prims.int & Prims.list Prims.int).
;         (xs, ys) == b ==>
;         (forall (z: Prims.int).
;             Coincidence.mem z [] <==> Coincidence.mem z xs && Coincidence.mem z ys)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec coincidence`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Tm_refine_83b0d7e331121c283f4e67c01921c9b5))

;; def=Prims.fst(402,27-402,88); use=Coincidence.fst(51,2-56,11)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Coincidence.fst(51,2-56,11)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Coincidence.fst(51,2-56,11)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,2-389,39); use=Coincidence.fst(51,2-56,11)
(and 
;; def=Prims.fst(413,99-413,120); use=Coincidence.fst(51,2-56,11)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=Coincidence.fst(51,8-52,18); use=Coincidence.fst(51,8-52,18)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
...
;; def=Prims.fst(389,2-389,39); use=Coincidence.fst(51,2-56,11)
(and (implies 
;; def=Coincidence.fst(53,7-53,12); use=Coincidence.fst(53,7-53,12)
...
;; def=Prims.fst(459,77-459,89); use=Coincidence.fst(51,2-56,11)
(and 
;; def=Coincidence.fst(48,32-48,41); use=Coincidence.fst(53,48-53,51)
(or label_1

;; def=Coincidence.fst(48,32-48,41); use=Coincidence.fst(53,48-53,51)
(BoxBool_proj_0 (Coincidence.sorted @x2))
)


;; def=Prims.fst(451,66-451,102); use=Coincidence.fst(51,2-56,11)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Prims.list Prims.int))

;; def=Coincidence.fst(48,18-52,10); use=Coincidence.fst(51,2-56,11)
(= @x2
@x6)
)
...
;; def=Prims.fst(459,77-459,89); use=Coincidence.fst(51,2-56,11)
(and 
;; def=Coincidence.fst(48,62-48,71); use=Coincidence.fst(53,52-53,55)
(or label_2

;; def=Coincidence.fst(48,62-48,71); use=Coincidence.fst(53,52-53,55)
(BoxBool_proj_0 (Coincidence.sorted @x4))
)


;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(53,52-53,55)
(or label_3

;; def=Coincidence.fst(51,2-56,11); use=Coincidence.fst(53,52-53,55)
(Valid 
;; def=Coincidence.fst(51,2-56,11); use=Coincidence.fst(53,52-53,55)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(53,52-53,55)
(and 
;; def=Coincidence.fst(48,18-50,22); use=Coincidence.fst(53,52-53,55)
(Valid 
;; def=Coincidence.fst(48,18-50,22); use=Coincidence.fst(53,52-53,55)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=Coincidence.fst(48,46-52,18); use=Coincidence.fst(51,2-56,11)
(= @x4
@x7)
)
...
;; def=Coincidence.fst(49,12-53,55); use=Coincidence.fst(53,36-53,55)
(= (Coincidence.coincidence @x2
@x4)
@x8)
)

;; def=Prims.fst(356,2-356,58); use=Coincidence.fst(51,2-56,11)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(Tm_refine_13f4b79e3d32f722463ee62ae304d544 @x2
@x4))

;; def=Prims.fst(356,26-356,41); use=Coincidence.fst(51,2-56,11)
(= @x9
(Coincidence.coincidence @x2
@x4))


;; def=Prims.fst(616,20-616,22); use=Coincidence.fst(51,2-56,11)
(= (Coincidence.coincidence @x2
@x4)
@x9)
)
...
;; def=Coincidence.fst(49,12-53,55); use=Coincidence.fst(51,2-56,11)
(= (Prims.Cons Prims.int
@x1
(Coincidence.coincidence @x2
@x4))
...
;; def=Coincidence.fst(49,27-49,73); use=Coincidence.fst(53,31-53,55)
(forall ((@x11 Term))
 (! (implies (HasType @x11
Prims.int)

;; def=Coincidence.fst(49,37-49,73); use=Coincidence.fst(53,31-53,55)
(or label_4

;; def=Coincidence.fst(49,37-49,73); use=Coincidence.fst(53,31-53,55)
(iff 
;; def=Coincidence.fst(49,37-49,45); use=Coincidence.fst(53,31-53,55)
(BoxBool_proj_0 (Coincidence.mem @x11
(Prims.Cons Prims.int
@x1
(Coincidence.coincidence @x2
@x4))))
...
;; def=Coincidence.fst(49,51-49,73); use=Coincidence.fst(53,31-53,55)
(and (BoxBool_proj_0 (Coincidence.mem @x11
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0))
(BoxBool_proj_0 (Coincidence.mem @x11
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)))
)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Coincidence.fst(51,2-56,11)
(not 
;; def=Coincidence.fst(53,7-53,12); use=Coincidence.fst(53,7-53,12)
(= (Prims.op_Equality Prims.int
@x1
...
;; def=Coincidence.fst(53,7-55,57); use=Coincidence.fst(53,7-55,57)
(= (Prims.op_Equality Prims.int
@x1
@x3)
@x6)
...
;; def=Prims.fst(389,2-389,39); use=Coincidence.fst(51,2-56,11)
(and (implies 
;; def=Coincidence.fst(54,12-54,17); use=Coincidence.fst(54,12-54,17)
(= (Prims.op_LessThan @x1
@x3)
(BoxBool true))


;; def=Prims.fst(441,29-441,97); use=Coincidence.fst(54,24-54,30)
(and 
;; def=Coincidence.fst(51,2-56,11); use=Coincidence.fst(51,2-56,11)
(or label_5
(BoxBool_proj_0 (Coincidence.sorted x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)))
...
;; def=Prims.fst(441,36-441,97); use=Coincidence.fst(54,24-54,30)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)
(not (BoxBool_proj_0 (Coincidence.mem @x1
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1))))

;; def=Prims.fst(459,77-459,89); use=Coincidence.fst(51,2-56,11)
(and 
;; def=Coincidence.fst(48,32-48,41); use=Coincidence.fst(54,49-54,52)
(or label_7
...
;; def=Prims.fst(459,77-459,89); use=Coincidence.fst(51,2-56,11)
(and (implies 
;; def=Coincidence.fst(48,62-48,71); use=Coincidence.fst(54,53-54,55)
(BoxBool_proj_0 (Coincidence.sorted x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1))


;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(54,53-54,55)
(and 
;; def=Coincidence.fst(48,62-48,71); use=Coincidence.fst(54,53-54,55)
(or label_8
...
;; def=Coincidence.fst(51,2-56,11); use=Coincidence.fst(54,53-54,55)
(Valid 
;; def=Coincidence.fst(51,2-56,11); use=Coincidence.fst(54,53-54,55)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(54,53-54,55)
(and 
;; def=Coincidence.fst(48,18-50,22); use=Coincidence.fst(54,53-54,55)
(Valid 
;; def=Coincidence.fst(48,18-50,22); use=Coincidence.fst(54,53-54,55)
(Prims.op_Equals_Equals_Equals (Prims.list Prims.int)
(Prims.list Prims.int)
...
;; def=Coincidence.fst(48,46-50,25); use=Coincidence.fst(51,2-56,11)
(= x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1
@x10)
)
...
;; def=Coincidence.fst(49,12-54,55); use=Coincidence.fst(51,2-56,11)
(= (Coincidence.coincidence @x2
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)
@x11)


;; def=Coincidence.fst(49,27-49,73); use=Coincidence.fst(54,37-54,55)
(forall ((@x12 Term))
 (! (implies (HasType @x12
Prims.int)

;; def=Coincidence.fst(49,37-49,73); use=Coincidence.fst(54,37-54,55)
(iff 
;; def=Coincidence.fst(49,37-49,45); use=Coincidence.fst(54,37-54,55)
(BoxBool_proj_0 (Coincidence.mem @x12
(Coincidence.coincidence @x2
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)))


;; def=Coincidence.fst(49,51-49,73); use=Coincidence.fst(54,37-54,55)
(and (BoxBool_proj_0 (Coincidence.mem @x12
@x2))
(BoxBool_proj_0 (Coincidence.mem @x12
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)))
)
...
;; def=Coincidence.fst(54,12-55,57); use=Coincidence.fst(54,12-55,57)
(= (Prims.op_LessThan @x1
@x3)
@x8)
)

;; def=Prims.fst(441,29-441,97); use=Coincidence.fst(55,24-55,30)
(and 
;; def=Coincidence.fst(51,2-56,11); use=Coincidence.fst(51,2-56,11)
(or label_11
(BoxBool_proj_0 (Coincidence.sorted x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0)))
...
;; def=Prims.fst(441,36-441,97); use=Coincidence.fst(55,24-55,30)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.unit)
(not (BoxBool_proj_0 (Coincidence.mem @x3
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0))))

;; def=Prims.fst(459,77-459,89); use=Coincidence.fst(51,2-56,11)
(and 
;; def=Coincidence.fst(48,62-48,71); use=Coincidence.fst(55,53-55,56)
(or label_13
...
;; def=Coincidence.fst(48,18-56,11); use=Coincidence.fst(55,53-55,56)
(or label_14

;; def=Coincidence.fst(51,2-56,11); use=Coincidence.fst(55,53-55,56)
(Valid 
;; def=Coincidence.fst(51,2-56,11); use=Coincidence.fst(55,53-55,56)
(Prims.precedes (Prims.list Prims.int)
(Prims.list Prims.int)
...
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
(Tm_refine_648e990f04b5ab5536406e0d718e9a3a @x4))

;; def=Coincidence.fst(49,12-55,56); use=Coincidence.fst(51,2-56,11)
(= (Coincidence.coincidence x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0
@x4)
@x11)


;; def=Coincidence.fst(49,27-49,73); use=Coincidence.fst(55,37-55,56)
(forall ((@x12 Term))
 (! (implies (HasType @x12
Prims.int)

;; def=Coincidence.fst(49,37-49,73); use=Coincidence.fst(55,37-55,56)
(iff 
;; def=Coincidence.fst(49,37-49,45); use=Coincidence.fst(55,37-55,56)
(BoxBool_proj_0 (Coincidence.mem @x12
(Coincidence.coincidence x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0
@x4)))


;; def=Coincidence.fst(49,51-49,73); use=Coincidence.fst(55,37-55,56)
(and (BoxBool_proj_0 (Coincidence.mem @x12
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0))
(BoxBool_proj_0 (Coincidence.mem @x12
@x4)))
...
;; def=Prims.fst(389,19-389,21); use=Coincidence.fst(51,2-56,11)
(not 
;; def=Coincidence.fst(52,4-52,18); use=Coincidence.fst(52,4-52,18)
(and (BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (Prims.list Prims.int)
(Prims.list Prims.int)
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1))))
(BoxBool_proj_0 (Prims.uu___is_Cons Prims.int
(FStar.Pervasives.Native.__proj__Mktuple2__item___2 (Prims.list Prims.int)
(Prims.list Prims.int)
(FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0
...
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(FStar.Pervasives.Native.tuple2 (Prims.list Prims.int)
(Prims.list Prims.int)))

;; def=Coincidence.fst(51,8-56,5); use=Coincidence.fst(51,8-56,5)
(= (FStar.Pervasives.Native.Mktuple2 (Prims.list Prims.int)
(Prims.list Prims.int)
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)
...
;; def=Coincidence.fst(49,27-49,73); use=Coincidence.fst(56,9-56,11)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=Coincidence.fst(49,37-49,73); use=Coincidence.fst(56,9-56,11)
(or label_16

;; def=Coincidence.fst(49,37-49,73); use=Coincidence.fst(56,9-56,11)
(iff 
;; def=Coincidence.fst(49,37-49,45); use=Coincidence.fst(56,9-56,11)
(BoxBool_proj_0 (Coincidence.mem @x2
(Prims.Nil Prims.int)))


;; def=Coincidence.fst(49,51-49,73); use=Coincidence.fst(56,9-56,11)
(and (BoxBool_proj_0 (Coincidence.mem @x2
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_0))
(BoxBool_proj_0 (Coincidence.mem @x2
x_9196bb3ba9d8f2ebbf8fc41c3ae89bb6_1)))
