...
; Internals for GenericStability


; encoding sigelt val GenericStability.filter_eq
...
; Starting query at GenericStability.fst(36,2-41,27)
...
(declare-fun x_2bfcfa6422f0665f886671d4c4b4d62b_4 () Term)
;;;;;;;;;;;;;;;;_: a -> Prims.int
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(34,65-35,20); use=GenericStability.fst(35,8-35,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_79886a0e4c92f3492092fb04d00db416))
:qid GenericStability_pre_typing_Tm_arrow_79886a0e4c92f3492092fb04d00db416))

:named GenericStability_pre_typing_Tm_arrow_79886a0e4c92f3492092fb04d00db416))
...
:pattern ((ApplyTT @x0
@x1))
:qid GenericStability_interpretation_Tm_arrow_79886a0e4c92f3492092fb04d00db416.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_79886a0e4c92f3492092fb04d00db416))
:qid GenericStability_interpretation_Tm_arrow_79886a0e4c92f3492092fb04d00db416))

:named GenericStability_interpretation_Tm_arrow_79886a0e4c92f3492092fb04d00db416))
;;;;;;;;;;;;;;;;binder_x_2bfcfa6422f0665f886671d4c4b4d62b_4
;;; Fact-ids: 
(assert (! (HasType x_2bfcfa6422f0665f886671d4c4b4d62b_4
Tm_arrow_79886a0e4c92f3492092fb04d00db416)
:named binder_x_2bfcfa6422f0665f886671d4c4b4d62b_4))

(declare-fun Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(34,27-41,27); use=GenericStability.fst(34,27-41,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8))

:named refinement_kinding_Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(34,27-41,27); use=GenericStability.fst(34,27-41,27)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=GenericStability.fst(34,27-41,27); use=GenericStability.fst(34,27-41,27)
(or 
;; def=GenericStability.fst(36,2-41,27); use=GenericStability.fst(36,2-41,27)
(Valid 
;; def=GenericStability.fst(36,2-41,27); use=GenericStability.fst(36,2-41,27)
...
;; def=GenericStability.fst(34,27-41,27); use=GenericStability.fst(34,27-41,27)
(and 
;; def=GenericStability.fst(34,27-35,22); use=GenericStability.fst(34,27-35,22)
(Valid 
;; def=GenericStability.fst(34,27-35,22); use=GenericStability.fst(34,27-35,22)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8))

:named refinement_interpretation_Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(34,27-41,27); use=GenericStability.fst(34,27-41,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8 @x0
@x1
@x2))))
:qid haseqTm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8))

:named haseqTm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8))
(declare-fun GenericStability.filter_eq (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;x: Prims.int -> xs: Prims.list a -> k: (_: a -> Prims.int){x << x \/ x === x /\ xs << xs}   -> Prims.list a
(declare-fun Tm_arrow_db9085b1f03cef8429d8787e176065ce () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_db9085b1f03cef8429d8787e176065ce
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_db9085b1f03cef8429d8787e176065ce
Tm_type)
:named kinding_Tm_arrow_db9085b1f03cef8429d8787e176065ce))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(34,18-41,27); use=GenericStability.fst(34,27-41,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_db9085b1f03cef8429d8787e176065ce)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_db9085b1f03cef8429d8787e176065ce))
:qid GenericStability_pre_typing_Tm_arrow_db9085b1f03cef8429d8787e176065ce))

:named GenericStability_pre_typing_Tm_arrow_db9085b1f03cef8429d8787e176065ce))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_db9085b1f03cef8429d8787e176065ce
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(34,18-41,27); use=GenericStability.fst(34,27-41,27)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid GenericStability_interpretation_Tm_arrow_db9085b1f03cef8429d8787e176065ce.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid GenericStability_interpretation_Tm_arrow_db9085b1f03cef8429d8787e176065ce.2))
...
@x1)
@x2))
:qid GenericStability_interpretation_Tm_arrow_db9085b1f03cef8429d8787e176065ce.3))
...
@x2)
@x3))
:qid GenericStability_interpretation_Tm_arrow_db9085b1f03cef8429d8787e176065ce.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_db9085b1f03cef8429d8787e176065ce))
:qid GenericStability_interpretation_Tm_arrow_db9085b1f03cef8429d8787e176065ce))

:named GenericStability_interpretation_Tm_arrow_db9085b1f03cef8429d8787e176065ce))
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT GenericStability.filter_eq@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT GenericStability.filter_eq@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_GenericStability.filter_eq))

:named token_correspondence_GenericStability.filter_eq))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(35,8-35,17); use=GenericStability.fst(35,8-35,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType GenericStability.filter_eq@tok
Tm_arrow_db9085b1f03cef8429d8787e176065ce))
...
@x3)
@x4)
(GenericStability.filter_eq @x1
@x2
@x3
@x4))
 

:pattern ((GenericStability.filter_eq @x1
@x2
@x3
@x4))
:qid function_token_typing_GenericStability.filter_eq.1))
)
 

:pattern ((ApplyTT @x0
GenericStability.filter_eq@tok))
:qid function_token_typing_GenericStability.filter_eq))

:named function_token_typing_GenericStability.filter_eq))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(35,8-35,17); use=GenericStability.fst(35,8-35,17)
...
(Prims.list @x0))
(HasType @x3
(Tm_refine_9e5c3d929d93a7c9ea32e2d44e1431c8 @x1
@x0
@x2)))
...
;             (forall (x: Prims.list a). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;             (k b = x == true ==> x << x \/ b << xs) /\
;             (~(k b = x = true) ==> (forall (b: Prims.bool). k b = x == b ==> x << x \/ b << xs)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec filter_eq`
...
;; def=Prims.fst(402,27-402,88); use=GenericStability.fst(36,2-41,27)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=GenericStability.fst(36,2-41,27)
(Valid 
;; def=Prims.fst(402,84-402,87); use=GenericStability.fst(36,2-41,27)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(36,2-41,27)
(and (implies 
;; def=GenericStability.fst(35,23-35,25); use=GenericStability.fst(36,8-36,10)
(and 
;; def=GenericStability.fst(35,23-35,25); use=GenericStability.fst(36,8-36,10)
(not 
;; def=GenericStability.fst(35,23-35,25); use=GenericStability.fst(36,8-36,10)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=GenericStability.fst(36,2-41,27)
(not 
;; def=GenericStability.fst(35,23-35,25); use=GenericStability.fst(36,8-36,10)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_0a56e3de562c08d8ab59f4ac6f626a98_3))
...
;; def=Prims.fst(413,99-413,120); use=GenericStability.fst(36,2-41,27)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=GenericStability.fst(35,23-38,10); use=GenericStability.fst(36,8-38,10)
(= x_0a56e3de562c08d8ab59f4ac6f626a98_3
...
;; def=Prims.fst(389,2-389,39); use=GenericStability.fst(36,2-41,27)
(and (implies 
;; def=GenericStability.fst(39,10-39,18); use=GenericStability.fst(39,10-39,18)
(= (Prims.op_Equality Prims.int
(ApplyTT x_2bfcfa6422f0665f886671d4c4b4d62b_4
@x1)
x_ae567c2fb75be05905677af440075565_2)
(BoxBool true))


;; def=GenericStability.fst(34,27-41,27); use=GenericStability.fst(40,28-40,29)
(or label_2

;; def=GenericStability.fst(36,2-41,27); use=GenericStability.fst(40,28-40,29)
(Valid 
;; def=GenericStability.fst(36,2-41,27); use=GenericStability.fst(40,28-40,29)
(Prims.precedes Prims.int
Prims.int
...
;; def=GenericStability.fst(39,10-41,27); use=GenericStability.fst(39,10-41,27)
(= (Prims.op_Equality Prims.int
(ApplyTT x_2bfcfa6422f0665f886671d4c4b4d62b_4
@x1)
x_ae567c2fb75be05905677af440075565_2)
...
;; def=GenericStability.fst(34,27-41,27); use=GenericStability.fst(41,26-41,27)
(or label_3

;; def=GenericStability.fst(36,2-41,27); use=GenericStability.fst(41,26-41,27)
(Valid 
;; def=GenericStability.fst(36,2-41,27); use=GenericStability.fst(41,26-41,27)
(Prims.precedes Prims.int
Prims.int
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.filter_eq, 1)
; STATUS: unsat
...
; encoding sigelt let rec filter_eq
...
; encoding sigelt val GenericStability.filter_eq_contains
...
; Starting query at GenericStability.fst(46,2-49,31)
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(43,78-45,29); use=GenericStability.fst(45,8-45,29)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd))
:qid GenericStability_pre_typing_Tm_arrow_605ada36aef613d3875663fdd1971cfd))

:named GenericStability_pre_typing_Tm_arrow_605ada36aef613d3875663fdd1971cfd))
...
:pattern ((ApplyTT @x0
@x1))
:qid GenericStability_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_605ada36aef613d3875663fdd1971cfd))
:qid GenericStability_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd))

:named GenericStability_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd))
...
;       (forall (x: a).
;           FStar.List.Tot.Base.mem x xs /\ key x = k <==>
;           FStar.List.Tot.Base.mem x (GenericStability.filter_eq k xs key)) ==>
;       p pure_result) ==>
...
;                 (forall (pure_result: Prims.unit).
;                     (forall (x: a).
;                         FStar.List.Tot.Base.mem x b /\ key x = k <==>
;                         FStar.List.Tot.Base.mem x (GenericStability.filter_eq k b key)) ==>
;                     k pure_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec filter_eq_contains`
...
;;; Fact-ids: 
(assert (! (not 
;; def=GenericStability.fst(46,2-49,31); use=GenericStability.fst(46,2-49,31)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(46,2-49,31)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=GenericStability.fst(44,17-44,84); use=GenericStability.fst(46,2-49,31)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=GenericStability.fst(44,28-44,83); use=GenericStability.fst(46,2-49,31)
(or label_2

;; def=GenericStability.fst(44,28-44,83); use=GenericStability.fst(46,2-49,31)
(iff 
;; def=GenericStability.fst(44,28-44,51); use=GenericStability.fst(46,2-49,31)
(and 
;; def=GenericStability.fst(44,29-44,37); use=GenericStability.fst(46,2-49,31)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
x_374b44ccfcb77ed85d505dbc44265913_2))


;; def=GenericStability.fst(44,41-44,50); use=GenericStability.fst(46,2-49,31)
...
;; def=GenericStability.fst(44,57-44,83); use=GenericStability.fst(46,2-49,31)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(46,2-49,31)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(46,2-49,31)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=GenericStability.fst(46,2-49,31)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=GenericStability.fst(46,2-49,31)
(Valid 
;; def=Prims.fst(402,73-402,79); use=GenericStability.fst(46,2-49,31)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=GenericStability.fst(46,2-49,31)
(Valid 
;; def=Prims.fst(402,84-402,87); use=GenericStability.fst(46,2-49,31)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(46,2-49,31)
(and (implies 
;; def=GenericStability.fst(45,32-45,34); use=GenericStability.fst(46,8-46,10)
(and 
;; def=GenericStability.fst(45,32-45,34); use=GenericStability.fst(46,8-46,10)
(not 
;; def=GenericStability.fst(45,32-45,34); use=GenericStability.fst(46,8-46,10)
...
label_3)
(implies 
;; def=GenericStability.fst(45,32-47,6); use=GenericStability.fst(46,8-47,6)
(= x_374b44ccfcb77ed85d505dbc44265913_2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=GenericStability.fst(46,2-49,31)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=GenericStability.fst(46,2-49,31)
(Valid 
;; def=Prims.fst(451,90-451,102); use=GenericStability.fst(46,2-49,31)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=GenericStability.fst(46,2-49,31)
(not 
;; def=GenericStability.fst(45,32-45,34); use=GenericStability.fst(46,8-46,10)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
;; def=Prims.fst(413,99-413,120); use=GenericStability.fst(46,2-49,31)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=GenericStability.fst(45,32-48,10); use=GenericStability.fst(46,8-48,10)
(= x_374b44ccfcb77ed85d505dbc44265913_2
...
;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(46,2-49,31)
(and 
;; def=GenericStability.fst(43,25-49,31); use=GenericStability.fst(49,28-49,31)
(or label_4

;; def=GenericStability.fst(46,2-49,31); use=GenericStability.fst(49,28-49,31)
(Valid 
;; def=GenericStability.fst(46,2-49,31); use=GenericStability.fst(49,28-49,31)
...
;; def=GenericStability.fst(43,64-45,38); use=GenericStability.fst(46,2-49,31)
(= x_582acf81e02a6e4176cba5e2730f867d_3
@x4)
)

;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(49,4-49,22)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=GenericStability.fst(44,17-44,84); use=GenericStability.fst(49,4-49,22)
(forall ((@x6 Term))
 (! (implies (HasType @x6
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=GenericStability.fst(44,28-44,83); use=GenericStability.fst(49,4-49,22)
(iff 
;; def=GenericStability.fst(44,28-44,51); use=GenericStability.fst(49,4-49,22)
(and 
;; def=GenericStability.fst(44,29-44,37); use=GenericStability.fst(49,4-49,22)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x6
@x3))


;; def=GenericStability.fst(44,41-44,50); use=GenericStability.fst(49,4-49,22)
(= (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_3
@x6)
x_ae567c2fb75be05905677af440075565_1)
)
...
;; def=GenericStability.fst(44,57-44,83); use=GenericStability.fst(49,4-49,22)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x6
(GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
x_ae567c2fb75be05905677af440075565_1
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(49,4-49,22)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(49,4-49,22)
(ApplyTT @x1
@x5)
...
; encoding sigelt let rec filter_eq_contains
...
; Starting query at GenericStability.fst(51,0-52,91)
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(52,2-52,91); use=GenericStability.fst(52,2-52,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
; Context: While encoding a query
; While typechecking the top-level declaration `val GenericStability.filter_eq_append`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GenericStability.fst(51,0-52,91)
...
;; def=dummy(0,0-0,0); use=GenericStability.fst(52,17-52,90)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.int)

;; def=Prims.fst(73,23-73,30); use=GenericStability.fst(52,68-52,77)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.filter_eq_append, 1)
; STATUS: unsat
...
; encoding sigelt val GenericStability.filter_eq_append
...
; Starting query at GenericStability.fst(54,2-57,28)
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(51,79-53,27); use=GenericStability.fst(53,8-53,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
;   (forall (pure_result: Prims.unit).
;       (forall (x: Prims.int).
;           GenericStability.filter_eq x l1 k @ GenericStability.filter_eq x l2 k =
;           GenericStability.filter_eq x (l1 @ l2) k) ==>
;       p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
...
;                 (forall (pure_result: Prims.unit).
;                     (forall (x: Prims.int).
;                         GenericStability.filter_eq x b k @ GenericStability.filter_eq x l2 k =
;                         GenericStability.filter_eq x (b @ l2) k) ==>
;                     k pure_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec filter_eq_append`
...
;;; Fact-ids: 
(assert (! (not 
;; def=GenericStability.fst(54,2-57,28); use=GenericStability.fst(54,2-57,28)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(54,2-57,28)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=GenericStability.fst(52,17-52,90); use=GenericStability.fst(54,2-57,28)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=GenericStability.fst(54,2-57,28)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(54,2-57,28)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(54,2-57,28)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=GenericStability.fst(54,2-57,28)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=GenericStability.fst(54,2-57,28)
(Valid 
;; def=Prims.fst(402,73-402,79); use=GenericStability.fst(54,2-57,28)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=GenericStability.fst(54,2-57,28)
(Valid 
;; def=Prims.fst(402,84-402,87); use=GenericStability.fst(54,2-57,28)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(54,2-57,28)
(and (implies 
;; def=GenericStability.fst(53,28-53,30); use=GenericStability.fst(54,8-54,10)
(and 
;; def=GenericStability.fst(53,28-53,30); use=GenericStability.fst(54,8-54,10)
(not 
;; def=GenericStability.fst(53,28-53,30); use=GenericStability.fst(54,8-54,10)
...
label_3)
(implies 
;; def=GenericStability.fst(53,28-55,6); use=GenericStability.fst(54,8-55,6)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=GenericStability.fst(54,2-57,28)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=GenericStability.fst(54,2-57,28)
(Valid 
;; def=Prims.fst(451,90-451,102); use=GenericStability.fst(54,2-57,28)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=GenericStability.fst(54,2-57,28)
(not 
;; def=GenericStability.fst(53,28-53,30); use=GenericStability.fst(54,8-54,10)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(413,99-413,120); use=GenericStability.fst(54,2-57,28)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=GenericStability.fst(53,28-56,10); use=GenericStability.fst(54,8-56,10)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(54,2-57,28)
(and 
;; def=GenericStability.fst(51,23-57,28); use=GenericStability.fst(57,27-57,28)
(or label_4

;; def=GenericStability.fst(54,2-57,28); use=GenericStability.fst(57,27-57,28)
(Valid 
;; def=GenericStability.fst(54,2-57,28); use=GenericStability.fst(57,27-57,28)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=GenericStability.fst(51,36-57,28); use=GenericStability.fst(57,27-57,28)
(and 
;; def=GenericStability.fst(51,36-53,30); use=GenericStability.fst(57,27-57,28)
(Valid 
;; def=GenericStability.fst(51,36-53,30); use=GenericStability.fst(57,27-57,28)
...
;; def=GenericStability.fst(51,67-53,35); use=GenericStability.fst(54,2-57,28)
(= x_582acf81e02a6e4176cba5e2730f867d_3
@x4)
)

;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(57,4-57,20)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=GenericStability.fst(52,17-52,90); use=GenericStability.fst(57,4-57,20)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=GenericStability.fst(57,4-57,20)
(= (FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
(GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
@x6
@x3
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(57,4-57,20)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(57,4-57,20)
(ApplyTT @x1
@x5)
...
; Starting query at GenericStability.fst(53,0-57,28)

(declare-fun label_1 () Bool)


(declare-fun Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(51,23-57,28); use=GenericStability.fst(53,0-57,28)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (HasType (Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e @x0
@x1
@x2
@x3
@x4
@x5)
Tm_type))
:qid refinement_kinding_Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e))

:named refinement_kinding_Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(51,23-57,28); use=GenericStability.fst(53,0-57,28)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e @x2
@x3
@x4
@x5
@x6
...
;; def=GenericStability.fst(51,23-57,28); use=GenericStability.fst(53,0-57,28)
(and 
;; def=GenericStability.fst(51,23-53,27); use=GenericStability.fst(53,0-57,28)
(Valid 
;; def=GenericStability.fst(51,23-53,27); use=GenericStability.fst(53,0-57,28)
...
;; def=GenericStability.fst(51,36-57,28); use=GenericStability.fst(53,0-57,28)
(or 
;; def=GenericStability.fst(54,2-57,28); use=GenericStability.fst(54,2-57,28)
(Valid 
;; def=GenericStability.fst(54,2-57,28); use=GenericStability.fst(54,2-57,28)
...
;; def=GenericStability.fst(51,36-57,28); use=GenericStability.fst(53,0-57,28)
(and 
;; def=GenericStability.fst(51,36-53,30); use=GenericStability.fst(53,0-57,28)
(Valid 
;; def=GenericStability.fst(51,36-53,30); use=GenericStability.fst(53,0-57,28)
...
@x6
@x7)))
:qid refinement_interpretation_Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e))

:named refinement_interpretation_Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(51,23-57,28); use=GenericStability.fst(53,0-57,28)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e @x0
@x1
@x2
@x3
@x4
@x5))))
:qid haseqTm_refine_ac308ec5d1e5cb17d0757b9694b12e6e))

:named haseqTm_refine_ac308ec5d1e5cb17d0757b9694b12e6e))
(declare-fun Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(52,2-52,91); use=GenericStability.fst(53,8-53,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
;   (l1: Prims.list a)
;   (l2: Prims.list a)
;   (k: (_: a -> Prims.int){a << a \/ a === a /\ (l1 << l1 \/ l1 === l1 /\ l2 << l2)})
;   (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.int).
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GenericStability.fst(53,0-57,28)
...
(Prims.list @x4))
(HasType @x7
(Tm_refine_ac308ec5d1e5cb17d0757b9694b12e6e @x4
@x0
@x5
@x1
@x6
...
;; def=dummy(0,0-0,0); use=GenericStability.fst(53,8-53,24)
(forall ((@x9 Term))
 (! (implies (HasType @x9
Prims.int)

;; def=Prims.fst(73,23-73,30); use=GenericStability.fst(53,8-53,24)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.filter_eq_append, 3)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Prims.list__uu___haseq, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f
...
; encoding sigelt let rec filter_eq_append
...
; Starting query at GenericStability.fst(59,0-60,91)
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(60,2-60,91); use=GenericStability.fst(60,2-60,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
; Encoding query formula : forall (a: Prims.eqtype) (l: Prims.list a) (k: (_: a -> Prims.int)) (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.int).
;     (*  - Subtyping check failed
...
; Context: While encoding a query
; While typechecking the top-level declaration `val GenericStability.filter_eq_not_contains`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GenericStability.fst(59,0-60,91)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
;; def=dummy(0,0-0,0); use=GenericStability.fst(60,17-60,90)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.int)

;; def=Prims.fst(73,23-73,30); use=GenericStability.fst(60,29-60,38)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.filter_eq_not_contains, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Prims.list__uu___haseq, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f
...
; encoding sigelt val GenericStability.filter_eq_not_contains
...
; Starting query at GenericStability.fst(62,2-65,31)
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(59,68-61,33); use=GenericStability.fst(61,8-61,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
;   (forall (pure_result: Prims.unit).
;       (forall (x: Prims.int).
;           GenericStability.filter_eq x l k = [] <==>
;           ~(exists (e: a). FStar.List.Tot.Base.mem e l /\ k e = x)) ==>
;       p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
...
;                 (forall (pure_result: Prims.unit).
;                     (forall (x: Prims.int).
;                         GenericStability.filter_eq x b k = [] <==>
;                         ~(exists (e: a). FStar.List.Tot.Base.mem e b /\ k e = x)) ==>
;                     k pure_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec filter_eq_not_contains`
...
;;; Fact-ids: 
(assert (! (not 
;; def=GenericStability.fst(62,2-65,31); use=GenericStability.fst(62,2-65,31)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(62,2-65,31)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=GenericStability.fst(60,17-60,90); use=GenericStability.fst(62,2-65,31)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=GenericStability.fst(60,28-60,89); use=GenericStability.fst(62,2-65,31)
(or label_2

;; def=GenericStability.fst(60,28-60,89); use=GenericStability.fst(62,2-65,31)
(iff 
;; def=GenericStability.fst(60,28-60,50); use=GenericStability.fst(62,2-65,31)
(= (GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
x_374b44ccfcb77ed85d505dbc44265913_1
...
;; def=GenericStability.fst(60,56-60,89); use=GenericStability.fst(62,2-65,31)
(not 
;; def=GenericStability.fst(60,57-60,89); use=GenericStability.fst(62,2-65,31)
(exists ((@x3 Term))
 (! (and (HasType @x3
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=GenericStability.fst(60,69-60,76); use=GenericStability.fst(62,2-65,31)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
x_374b44ccfcb77ed85d505dbc44265913_1))


;; def=GenericStability.fst(60,80-60,87); use=GenericStability.fst(62,2-65,31)
(= (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_2
@x3)
@x2)
)
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(62,2-65,31)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(62,2-65,31)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=GenericStability.fst(62,2-65,31)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=GenericStability.fst(62,2-65,31)
(Valid 
;; def=Prims.fst(402,73-402,79); use=GenericStability.fst(62,2-65,31)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=GenericStability.fst(62,2-65,31)
(Valid 
;; def=Prims.fst(402,84-402,87); use=GenericStability.fst(62,2-65,31)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(62,2-65,31)
(and (implies 
;; def=GenericStability.fst(61,34-61,35); use=GenericStability.fst(62,8-62,9)
(and 
;; def=GenericStability.fst(61,34-61,35); use=GenericStability.fst(62,8-62,9)
(not 
;; def=GenericStability.fst(61,34-61,35); use=GenericStability.fst(62,8-62,9)
...
label_3)
(implies 
;; def=GenericStability.fst(61,34-63,6); use=GenericStability.fst(62,8-63,6)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=GenericStability.fst(62,2-65,31)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=GenericStability.fst(62,2-65,31)
(Valid 
;; def=Prims.fst(451,90-451,102); use=GenericStability.fst(62,2-65,31)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=GenericStability.fst(62,2-65,31)
(not 
;; def=GenericStability.fst(61,34-61,35); use=GenericStability.fst(62,8-62,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(413,99-413,120); use=GenericStability.fst(62,2-65,31)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=GenericStability.fst(61,34-64,10); use=GenericStability.fst(62,8-64,10)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(62,2-65,31)
(and 
;; def=GenericStability.fst(59,29-65,31); use=GenericStability.fst(65,30-65,31)
(or label_4

;; def=GenericStability.fst(62,2-65,31); use=GenericStability.fst(65,30-65,31)
(Valid 
;; def=GenericStability.fst(62,2-65,31); use=GenericStability.fst(65,30-65,31)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=GenericStability.fst(59,56-61,37); use=GenericStability.fst(62,2-65,31)
(= x_582acf81e02a6e4176cba5e2730f867d_2
@x4)
)

;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(65,4-65,26)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=GenericStability.fst(60,17-60,90); use=GenericStability.fst(65,4-65,26)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)

;; def=GenericStability.fst(60,28-60,89); use=GenericStability.fst(65,4-65,26)
(iff 
;; def=GenericStability.fst(60,28-60,50); use=GenericStability.fst(65,4-65,26)
(= (GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
@x6
@x3
x_582acf81e02a6e4176cba5e2730f867d_2)
...
;; def=GenericStability.fst(60,56-60,89); use=GenericStability.fst(65,4-65,26)
(not 
;; def=GenericStability.fst(60,57-60,89); use=GenericStability.fst(65,4-65,26)
(exists ((@x7 Term))
 (! (and (HasType @x7
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=GenericStability.fst(60,69-60,76); use=GenericStability.fst(65,4-65,26)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x7
@x3))


;; def=GenericStability.fst(60,80-60,87); use=GenericStability.fst(65,4-65,26)
(= (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_2
@x7)
@x6)
)
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(65,4-65,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(65,4-65,26)
(ApplyTT @x1
@x5)
...
; Starting query at GenericStability.fst(61,0-65,31)

(declare-fun label_1 () Bool)


(declare-fun Tm_refine_85cbe50821a9266d015e76a911072e9e (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(59,29-65,31); use=GenericStability.fst(61,0-65,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_85cbe50821a9266d015e76a911072e9e @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_85cbe50821a9266d015e76a911072e9e @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_85cbe50821a9266d015e76a911072e9e))

:named refinement_kinding_Tm_refine_85cbe50821a9266d015e76a911072e9e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(59,29-65,31); use=GenericStability.fst(61,0-65,31)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_85cbe50821a9266d015e76a911072e9e @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=GenericStability.fst(59,29-65,31); use=GenericStability.fst(61,0-65,31)
(and 
;; def=GenericStability.fst(59,29-61,33); use=GenericStability.fst(61,0-65,31)
(Valid 
;; def=GenericStability.fst(59,29-61,33); use=GenericStability.fst(61,0-65,31)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_85cbe50821a9266d015e76a911072e9e))

:named refinement_interpretation_Tm_refine_85cbe50821a9266d015e76a911072e9e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_85cbe50821a9266d015e76a911072e9e
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(59,29-65,31); use=GenericStability.fst(61,0-65,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_85cbe50821a9266d015e76a911072e9e @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0))))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_85cbe50821a9266d015e76a911072e9e @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_85cbe50821a9266d015e76a911072e9e))

:named haseqTm_refine_85cbe50821a9266d015e76a911072e9e))
(declare-fun Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(60,2-60,91); use=GenericStability.fst(61,8-61,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GenericStability.fst(61,0-65,31)
...
(Prims.list @x3))
(HasType @x5
(Tm_refine_85cbe50821a9266d015e76a911072e9e @x3
@x0
@x4
@x1))
(HasType @x6
...
;; def=dummy(0,0-0,0); use=GenericStability.fst(61,8-61,30)
(forall ((@x7 Term))
 (! (implies (HasType @x7
Prims.int)

;; def=Prims.fst(73,23-73,30); use=GenericStability.fst(61,8-61,30)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.filter_eq_not_contains, 3)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Prims.list__uu___haseq, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f
...
; encoding sigelt let rec filter_eq_not_contains
...
; Starting query at GenericStability.fst(67,0-70,74)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_51deb5145edaf9e32b597aa333ac0c64 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(68,2-68,38); use=GenericStability.fst(68,2-68,38)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_51deb5145edaf9e32b597aa333ac0c64 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_51deb5145edaf9e32b597aa333ac0c64 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_51deb5145edaf9e32b597aa333ac0c64))

:named refinement_kinding_Tm_refine_51deb5145edaf9e32b597aa333ac0c64))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(68,2-68,38); use=GenericStability.fst(68,2-68,38)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_51deb5145edaf9e32b597aa333ac0c64 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))

;; def=GenericStability.fst(68,13-68,20); use=GenericStability.fst(68,13-68,20)
(BoxBool_proj_0 (Prims.uu___is_Cons @x2
@x1))


;; def=GenericStability.fst(68,24-68,36); use=GenericStability.fst(68,24-68,36)
...
@x1
(Tm_refine_51deb5145edaf9e32b597aa333ac0c64 @x2)))
:qid refinement_interpretation_Tm_refine_51deb5145edaf9e32b597aa333ac0c64))

:named refinement_interpretation_Tm_refine_51deb5145edaf9e32b597aa333ac0c64))
;;;;;;;;;;;;;;;;haseq for Tm_refine_51deb5145edaf9e32b597aa333ac0c64
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(68,2-68,38); use=GenericStability.fst(68,2-68,38)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_51deb5145edaf9e32b597aa333ac0c64 @x0)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_51deb5145edaf9e32b597aa333ac0c64 @x0))))
:qid haseqTm_refine_51deb5145edaf9e32b597aa333ac0c64))

:named haseqTm_refine_51deb5145edaf9e32b597aa333ac0c64))
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(70,2-70,74); use=GenericStability.fst(70,2-70,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)
...
; Encoding query formula : forall (a: Prims.eqtype)
;   (l: Prims.list a {Cons? l /\ FStar.List.Tot.Base.length l = 1})
;   (k: (_: a -> Prims.int))
;   (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.int).
;     (Cons? l /\ FStar.List.Tot.Base.length l = 1 ==> Cons? l) /\
;     (k (FStar.List.Tot.Base.hd l) = x ==>
;       Prims.hasEq (Prims.list a) /\
;       (forall (return_val: Prims.eqtype).
;           return_val == Prims.list a ==> Cons? l /\ FStar.List.Tot.Base.length l = 1 ==> Cons? l))


; Context: While encoding a query
; While typechecking the top-level declaration `val GenericStability.filter_eq_single`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GenericStability.fst(67,0-70,74)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
(Tm_refine_51deb5145edaf9e32b597aa333ac0c64 @x0))
(HasType @x2
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0))
(HasType @x3
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9))

;; def=dummy(0,0-0,0); use=GenericStability.fst(70,17-70,73)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.int)

;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(70,28-70,72)
(and (implies 
;; def=GenericStability.fst(68,13-68,36); use=GenericStability.fst(70,35-70,36)
(and 
;; def=GenericStability.fst(68,13-68,20); use=GenericStability.fst(70,35-70,36)
(BoxBool_proj_0 (Prims.uu___is_Cons @x0
@x1))


;; def=GenericStability.fst(68,24-68,36); use=GenericStability.fst(70,35-70,36)
(= (FStar.List.Tot.Base.length @x0
@x1)
(BoxInt 1))
)
...
;; def=FStar.List.Tot.Base.fst(38,18-38,25); use=GenericStability.fst(70,35-70,36)
(or label_1
...
(implies 
;; def=GenericStability.fst(70,28-70,43); use=GenericStability.fst(70,28-70,43)
(= (ApplyTT @x2
(FStar.List.Tot.Base.hd @x0
@x1))
@x4)
...
;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(70,28-70,72)
(and 
;; def=Prims.fst(73,23-73,30); use=Prims.fst(616,34-616,40)
(or label_2

;; def=Prims.fst(73,23-73,30); use=GenericStability.fst(70,28-70,72)
(Valid 
;; def=Prims.fst(73,23-73,30); use=GenericStability.fst(70,28-70,72)
(Prims.hasEq (Prims.list @x0))
)
...
;; def=Prims.fst(356,2-356,58); use=GenericStability.fst(70,28-70,72)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.eqtype)

;; def=Prims.fst(356,26-356,41); use=GenericStability.fst(70,28-70,72)
(= @x5
(Prims.list @x0))


;; def=GenericStability.fst(68,13-68,20); use=GenericStability.fst(70,70-70,71)
(BoxBool_proj_0 (Prims.uu___is_Cons @x0
@x1))


;; def=GenericStability.fst(68,24-68,36); use=GenericStability.fst(70,70-70,71)
(= (FStar.List.Tot.Base.length @x0
@x1)
(BoxInt 1))
)

;; def=FStar.List.Tot.Base.fst(38,18-38,25); use=GenericStability.fst(70,70-70,71)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.filter_eq_single, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Prims.list__uu___haseq, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f
...
; encoding sigelt val GenericStability.filter_eq_single
...
; Starting query at GenericStability.fst(71,30-71,32)
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(68,2-68,38); use=GenericStability.fst(71,4-71,20)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_51deb5145edaf9e32b597aa333ac0c64 @x0)
Tm_type)
...
;; def=GenericStability.fst(68,13-68,20); use=GenericStability.fst(71,4-71,20)
(BoxBool_proj_0 (Prims.uu___is_Cons @x2
@x1))


;; def=GenericStability.fst(68,24-68,36); use=GenericStability.fst(71,4-71,20)
(= (FStar.List.Tot.Base.length @x2
@x1)
(BoxInt 1))
))
...
;         (forall (x: Prims.int).
;             k (FStar.List.Tot.Base.hd l) = x ==>
;             GenericStability.filter_eq x l k = [FStar.List.Tot.Base.hd l]) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let filter_eq_single`
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(71,30-71,32)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=GenericStability.fst(70,17-70,73); use=GenericStability.fst(71,30-71,32)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.int)

;; def=GenericStability.fst(70,28-70,43); use=GenericStability.fst(71,30-71,32)
(= (ApplyTT @x2
(FStar.List.Tot.Base.hd @x0
@x1))
@x5)
...
;; def=GenericStability.fst(70,48-70,72); use=GenericStability.fst(71,30-71,32)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(71,30-71,32)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(71,30-71,32)
(ApplyTT @x3
@x4)
...
; encoding sigelt let filter_eq_single
...
; Starting query at GenericStability.fst(73,0-75,71)
...
;   (k: (_: a -> Prims.int))
;   (_: Prims.squash (GenericSort.sorted l k)).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.int). x < k (FStar.List.Tot.Base.hd l) ==> Prims.hasEq (Prims.list a)


; Context: While encoding a query
; While typechecking the top-level declaration `val GenericStability.filter_eq_sorted_lt`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GenericStability.fst(73,0-75,71)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0))
(HasType @x3
(Prims.squash (Prims.b2t (GenericSort.sorted @x0
@x1
@x2)))))

;; def=dummy(0,0-0,0); use=GenericStability.fst(75,17-75,70)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.int)

;; def=GenericStability.fst(75,28-75,42); use=GenericStability.fst(75,28-75,42)
(< (BoxInt_proj_0 @x4)
...
;; def=Prims.fst(73,23-73,30); use=GenericStability.fst(75,28-75,69)
(Valid 
;; def=Prims.fst(73,23-73,30); use=GenericStability.fst(75,28-75,69)
(Prims.hasEq (Prims.list @x0))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.filter_eq_sorted_lt, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Prims.list__uu___haseq, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f
...
; encoding sigelt val GenericStability.filter_eq_sorted_lt
...
; Starting query at GenericStability.fst(77,2-78,28)
...
;     (forall (pure_result: Prims.unit).
;         (forall (x: Prims.int).
;             x < k (FStar.List.Tot.Base.hd l) ==> GenericStability.filter_eq x l k = []) ==>
;         p pure_result) ==>
;     GenericSort.sorted l k /\
;     (forall (pure_result: Prims.unit).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let filter_eq_sorted_lt`
...
;; def=GenericStability.fst(74,18-74,30); use=GenericStability.fst(77,2-78,28)
(BoxBool_proj_0 (GenericSort.sorted @x0
@x1
@x2))


;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(77,2-78,28)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=GenericStability.fst(75,17-75,70); use=GenericStability.fst(77,2-78,28)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.int)

;; def=GenericStability.fst(75,28-75,42); use=GenericStability.fst(77,2-78,28)
(< (BoxInt_proj_0 @x5)
(BoxInt_proj_0 (ApplyTT @x2
(FStar.List.Tot.Base.hd @x0
@x1))))
...
;; def=GenericStability.fst(75,47-75,69); use=GenericStability.fst(77,2-78,28)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(77,2-78,28)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(77,2-78,28)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,29-441,97); use=GenericStability.fst(77,2-77,11)
(and 
;; def=GenericSort.fst(64,18-64,30); use=GenericStability.fst(77,2-77,11)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(77,2-77,11)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=GenericSort.fst(65,27-65,88); use=GenericStability.fst(77,2-77,11)
...
;; def=GenericSort.fst(65,41-65,53); use=GenericStability.fst(77,2-77,11)
(< (BoxInt_proj_0 @x5)
(BoxInt_proj_0 (ApplyTT @x2
(FStar.List.Tot.Base.hd @x0
@x1))))
...
;; def=GenericSort.fst(65,57-65,64); use=GenericStability.fst(77,2-77,11)
(= (ApplyTT @x2
@x6)
@x5)
)

;; def=GenericSort.fst(65,70-65,87); use=GenericStability.fst(77,2-77,11)
(= (FStar.List.Tot.Base.mem @x0
@x6
@x1)
(BoxBool false))
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(78,2-78,24)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=GenericStability.fst(60,17-60,90); use=GenericStability.fst(78,2-78,24)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)

;; def=GenericStability.fst(60,28-60,89); use=GenericStability.fst(78,2-78,24)
(iff 
;; def=GenericStability.fst(60,28-60,50); use=GenericStability.fst(78,2-78,24)
(= (GenericStability.filter_eq @x0
@x6
@x1
@x2)
...
;; def=GenericStability.fst(60,56-60,89); use=GenericStability.fst(78,2-78,24)
(not 
;; def=GenericStability.fst(60,57-60,89); use=GenericStability.fst(78,2-78,24)
(exists ((@x7 Term))
 (! (and (HasType @x7
@x0)

;; def=GenericStability.fst(60,69-60,76); use=GenericStability.fst(78,2-78,24)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem @x0
@x7
@x1))


;; def=GenericStability.fst(60,80-60,87); use=GenericStability.fst(78,2-78,24)
(= (ApplyTT @x2
@x7)
@x6)
)
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(78,2-78,24)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(78,2-78,24)
(ApplyTT @x3
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.filter_eq_sorted_lt, 2)
; STATUS: unsat
...
; encoding sigelt let filter_eq_sorted_lt
...
; Starting query at GenericStability.fst(80,0-86,86)

(declare-fun label_1 () Bool)



(declare-fun Tm_refine_5276ec40afe12a0b1477e6333ebd75db (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(84,18-84,59); use=GenericStability.fst(84,2-84,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_5276ec40afe12a0b1477e6333ebd75db @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_5276ec40afe12a0b1477e6333ebd75db @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_5276ec40afe12a0b1477e6333ebd75db))

:named refinement_kinding_Tm_refine_5276ec40afe12a0b1477e6333ebd75db))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(84,18-84,59); use=GenericStability.fst(84,2-84,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5276ec40afe12a0b1477e6333ebd75db @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=GenericStability.fst(84,18-84,31); use=GenericStability.fst(84,2-84,7)
(BoxBool_proj_0 (GenericSort.sorted @x2
@x3
@x4))


;; def=GenericStability.fst(84,36-84,59); use=GenericStability.fst(84,2-84,7)
(> (BoxInt_proj_0 (ApplyTT @x4
(FStar.List.Tot.Base.hd @x2
@x3)))
(BoxInt_proj_0 (ApplyTT @x4
(FStar.List.Tot.Base.hd @x2
@x5))))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_5276ec40afe12a0b1477e6333ebd75db))

:named refinement_interpretation_Tm_refine_5276ec40afe12a0b1477e6333ebd75db))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5276ec40afe12a0b1477e6333ebd75db
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(84,18-84,59); use=GenericStability.fst(84,2-84,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5276ec40afe12a0b1477e6333ebd75db @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_5276ec40afe12a0b1477e6333ebd75db @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_5276ec40afe12a0b1477e6333ebd75db))

:named haseqTm_refine_5276ec40afe12a0b1477e6333ebd75db))

; Encoding query formula : forall (a: Prims.eqtype)
;   (l1: Prims.list a {Cons? l1})
;   (l2: Prims.list a {Cons? l2})
;   (k: (_: a -> Prims.int))
;   (_:
;   Prims.squash (GenericSort.sorted l1 k /\
;       k (FStar.List.Tot.Base.hd l1) > k (FStar.List.Tot.Base.hd l2))).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.int). k (FStar.List.Tot.Base.hd l2) = x ==> Prims.hasEq (Prims.list a)


; Context: While encoding a query
; While typechecking the top-level declaration `val GenericStability.filter_eq_first`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GenericStability.fst(80,0-86,86)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0))
(HasType @x4
(Tm_refine_5276ec40afe12a0b1477e6333ebd75db @x0
@x1
@x3
@x2)))

;; def=dummy(0,0-0,0); use=GenericStability.fst(85,17-86,85)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.int)

;; def=GenericStability.fst(85,28-85,44); use=GenericStability.fst(85,28-85,44)
(= (ApplyTT @x3
(FStar.List.Tot.Base.hd @x0
@x2))
@x5)
...
;; def=Prims.fst(73,23-73,30); use=GenericStability.fst(86,59-86,60)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.filter_eq_first, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Prims.list__uu___haseq, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f
...
; encoding sigelt val GenericStability.filter_eq_first
...
; Starting query at GenericStability.fst(88,2-89,26)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     GenericSort.sorted l1 k /\ k (FStar.List.Tot.Base.hd l1) > k (FStar.List.Tot.Base.hd l2) /\
;     (forall (pure_result: Prims.unit).
;         (forall (x: Prims.int).
;             k (FStar.List.Tot.Base.hd l2) = x ==>
;             GenericStability.filter_eq x (l1 @ l2) k =
;             GenericStability.filter_eq x (FStar.List.Tot.Base.hd l2 :: l1) k @
;             GenericStability.filter_eq x (FStar.List.Tot.Base.tl l2) k) ==>
;         p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         (forall (x: Prims.int).
;             GenericStability.filter_eq x l1 k @ GenericStability.filter_eq x l2 k =
;             GenericStability.filter_eq x (l1 @ l2) k) ==>
;         GenericSort.sorted l1 k /\
;         (forall (pure_result: Prims.unit).
;             (forall (x: Prims.int).
;                 x < k (FStar.List.Tot.Base.hd l1) ==> GenericStability.filter_eq x l1 k = []) ==>
;             p pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let filter_eq_first`
...
;; def=GenericStability.fst(84,18-84,31); use=GenericStability.fst(88,2-89,26)
(BoxBool_proj_0 (GenericSort.sorted @x0
@x1
@x3))


;; def=GenericStability.fst(84,36-84,59); use=GenericStability.fst(88,2-89,26)
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(88,2-89,26)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=GenericStability.fst(85,17-86,85); use=GenericStability.fst(88,2-89,26)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.int)

;; def=GenericStability.fst(85,28-85,44); use=GenericStability.fst(88,2-89,26)
(= (ApplyTT @x3
(FStar.List.Tot.Base.hd @x0
@x2))
@x6)
...
;; def=GenericStability.fst(86,4-86,84); use=GenericStability.fst(88,2-89,26)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(88,2-89,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(88,2-89,26)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(88,2-88,18)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=GenericStability.fst(52,17-52,90); use=GenericStability.fst(88,2-88,18)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=GenericStability.fst(88,2-88,18)
(= (FStar.List.Tot.Base.op_At @x0
(GenericStability.filter_eq @x0
@x6
@x1
...
;; def=Prims.fst(441,29-441,97); use=GenericStability.fst(89,2-89,21)
(and 
;; def=GenericStability.fst(74,18-74,30); use=GenericStability.fst(89,2-89,21)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(89,2-89,21)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=GenericStability.fst(75,17-75,70); use=GenericStability.fst(89,2-89,21)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.int)

;; def=GenericStability.fst(75,28-75,42); use=GenericStability.fst(89,2-89,21)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (ApplyTT @x3
(FStar.List.Tot.Base.hd @x0
@x1))))
...
;; def=GenericStability.fst(75,47-75,69); use=GenericStability.fst(89,2-89,21)
(= (GenericStability.filter_eq @x0
@x7
@x1
@x3)
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(89,2-89,21)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(89,2-89,21)
(ApplyTT @x4
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.filter_eq_first, 2)
; STATUS: unsat
...
; encoding sigelt let filter_eq_first
...
; Starting query at GenericStability.fst(91,69-91,116)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Prims.eqtype) (l1: Prims.list a) (l2: Prims.list a) (k: (_: a -> Prims.int)).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.int).
;     (*  - Subtyping check failed
...
; Context: While encoding a query
; While typechecking the top-level declaration `let stable`
...
;; def=dummy(0,0-0,0); use=GenericStability.fst(91,69-91,116)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.int)

;; def=Prims.fst(73,23-73,30); use=GenericStability.fst(91,99-91,108)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.stable, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Prims.list__uu___haseq, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f
...
; encoding sigelt val GenericStability.stable_lift
...
; Starting query at GenericStability.fst(100,2-103,42)
...
;     GenericSort.sorted l1 k /\ k (FStar.List.Tot.Base.hd l1) > k (FStar.List.Tot.Base.hd l2) /\
;     (forall (pure_result: Prims.unit).
;         GenericStability.stable (l1 @ l2)
;           (FStar.List.Tot.Base.hd l2 :: l1 @ FStar.List.Tot.Base.tl l2)
;           k ==>
;         p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         (forall (x: Prims.int).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let stable_lift`
...
;; def=GenericStability.fst(97,18-97,31); use=GenericStability.fst(100,2-103,42)
(BoxBool_proj_0 (GenericSort.sorted @x0
@x1
@x3))


;; def=GenericStability.fst(97,35-97,58); use=GenericStability.fst(100,2-103,42)
(> (BoxInt_proj_0 (ApplyTT @x3
(FStar.List.Tot.Base.hd @x0
@x1)))
(BoxInt_proj_0 (ApplyTT @x3
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(100,2-103,42)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=GenericStability.fst(98,17-98,59); use=GenericStability.fst(100,2-103,42)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(100,2-103,42)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(100,2-103,42)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(100,2-100,18)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=GenericStability.fst(52,17-52,90); use=GenericStability.fst(100,2-100,18)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=GenericStability.fst(100,2-100,18)
(= (FStar.List.Tot.Base.op_At @x0
(GenericStability.filter_eq @x0
@x6
@x1
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(101,2-101,18)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=GenericStability.fst(52,17-52,90); use=GenericStability.fst(101,2-101,18)
(forall ((@x7 Term))
 (! (implies (HasType @x7
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=GenericStability.fst(101,2-101,18)
(= (FStar.List.Tot.Base.op_At @x0
(GenericStability.filter_eq @x0
@x7
(Prims.Cons @x0
...
;; def=Prims.fst(441,29-441,97); use=GenericStability.fst(102,2-102,17)
(and 
;; def=GenericStability.fst(84,18-84,31); use=GenericStability.fst(102,2-102,17)
(or label_3
...
;; def=GenericStability.fst(84,36-84,59); use=GenericStability.fst(102,2-102,17)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(102,2-102,17)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=GenericStability.fst(85,17-86,85); use=GenericStability.fst(102,2-102,17)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.int)

;; def=GenericStability.fst(85,28-85,44); use=GenericStability.fst(102,2-102,17)
(= (ApplyTT @x3
(FStar.List.Tot.Base.hd @x0
@x2))
@x8)
...
;; def=GenericStability.fst(86,4-86,84); use=GenericStability.fst(102,2-102,17)
(= (GenericStability.filter_eq @x0
@x8
(FStar.List.Tot.Base.op_At @x0
@x1
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(103,2-103,18)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=GenericStability.fst(52,17-52,90); use=GenericStability.fst(103,2-103,18)
(forall ((@x9 Term))
 (! (implies (HasType @x9
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=GenericStability.fst(103,2-103,18)
(= (FStar.List.Tot.Base.op_At @x0
(GenericStability.filter_eq @x0
@x9
(Prims.Cons @x0
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(103,2-103,18)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(103,2-103,18)
(ApplyTT @x4
@x8)
...
; encoding sigelt let stable_lift
...
; encoding sigelt val GenericStability.stable_append_l
...
; Starting query at GenericStability.fst(112,2-114,39)
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(109,14-111,26); use=GenericStability.fst(111,8-111,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   (forall (pure_result: Prims.unit).
;       (GenericStability.stable r r' k ==> GenericStability.stable (l @ r) (l @ r') k) ==>
;       p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
...
;                 k == any_result ==>
;                 (forall (pure_result: Prims.unit).
;                     (GenericStability.stable r r' k ==> GenericStability.stable (b @ r) (b @ r') k) ==>
;                     k pure_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec stable_append_l`
...
;;; Fact-ids: 
(assert (! (not 
;; def=GenericStability.fst(112,2-114,39); use=GenericStability.fst(112,2-114,39)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(112,2-114,39)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))
(implies 
;; def=GenericStability.fst(110,18-110,31); use=GenericStability.fst(112,2-114,39)
(Valid 
;; def=GenericStability.fst(110,18-110,31); use=GenericStability.fst(112,2-114,39)
...
;; def=GenericStability.fst(110,36-110,57); use=GenericStability.fst(112,2-114,39)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(112,2-114,39)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(112,2-114,39)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=GenericStability.fst(112,2-114,39)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=GenericStability.fst(112,2-114,39)
(Valid 
;; def=Prims.fst(402,73-402,79); use=GenericStability.fst(112,2-114,39)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=GenericStability.fst(112,2-114,39)
(Valid 
;; def=Prims.fst(402,84-402,87); use=GenericStability.fst(112,2-114,39)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(112,2-114,39)
(and (implies 
;; def=GenericStability.fst(111,27-111,28); use=GenericStability.fst(112,8-112,9)
(and 
;; def=GenericStability.fst(111,27-111,28); use=GenericStability.fst(112,8-112,9)
(not 
;; def=GenericStability.fst(111,27-111,28); use=GenericStability.fst(112,8-112,9)
...
label_3)
(implies 
;; def=GenericStability.fst(111,27-113,6); use=GenericStability.fst(112,8-113,6)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=GenericStability.fst(112,2-114,39)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=GenericStability.fst(112,2-114,39)
(Valid 
;; def=Prims.fst(451,90-451,102); use=GenericStability.fst(112,2-114,39)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=GenericStability.fst(112,2-114,39)
(not 
;; def=GenericStability.fst(111,27-111,28); use=GenericStability.fst(112,8-112,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1))
...
;; def=Prims.fst(413,99-413,120); use=GenericStability.fst(112,2-114,39)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=GenericStability.fst(111,27-114,10); use=GenericStability.fst(112,8-114,10)
(= x_374b44ccfcb77ed85d505dbc44265913_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=GenericStability.fst(112,2-114,39)
(and 
;; def=GenericStability.fst(105,22-114,39); use=GenericStability.fst(114,38-114,39)
(or label_4

;; def=GenericStability.fst(112,2-114,39); use=GenericStability.fst(114,38-114,39)
(Valid 
;; def=GenericStability.fst(112,2-114,39); use=GenericStability.fst(114,38-114,39)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=GenericStability.fst(106,3-114,39); use=GenericStability.fst(114,38-114,39)
(and 
;; def=GenericStability.fst(106,3-111,28); use=GenericStability.fst(114,38-114,39)
(Valid 
;; def=GenericStability.fst(106,3-111,28); use=GenericStability.fst(114,38-114,39)
(Prims.op_Equals_Equals_Equals (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=GenericStability.fst(107,3-114,39); use=GenericStability.fst(114,38-114,39)
(or 
;; def=GenericStability.fst(112,2-114,39); use=GenericStability.fst(114,38-114,39)
(Valid 
;; def=GenericStability.fst(112,2-114,39); use=GenericStability.fst(114,38-114,39)
...
;; def=GenericStability.fst(109,2-111,35); use=GenericStability.fst(112,2-114,39)
(= x_582acf81e02a6e4176cba5e2730f867d_4
@x4)
)

;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(114,14-114,29)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=GenericStability.fst(110,17-110,58); use=GenericStability.fst(114,14-114,29)
(implies 
;; def=GenericStability.fst(110,18-110,31); use=GenericStability.fst(114,14-114,29)
(Valid 
;; def=GenericStability.fst(110,18-110,31); use=GenericStability.fst(114,14-114,29)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2
...
;; def=GenericStability.fst(110,36-110,57); use=GenericStability.fst(114,14-114,29)
(Valid 
;; def=GenericStability.fst(110,36-110,57); use=GenericStability.fst(114,14-114,29)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
(FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(114,14-114,29)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(114,14-114,29)
(ApplyTT @x1
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.stable_append_l, 1)
; STATUS: unsat
...
; encoding sigelt let rec stable_append_l
...
; encoding sigelt val GenericStability.stable_append_r
...
; Starting query at GenericStability.fst(124,2-125,25)
...
;;; Fact-ids: 
(assert (! 
;; def=GenericStability.fst(120,14-123,26); use=GenericStability.fst(123,8-123,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
; Encoding query formula : forall (p: Prims.pure_post Prims.unit).
;   GenericStability.stable l l' k /\
;   (forall (pure_result: Prims.unit). GenericStability.stable (l @ r) (l' @ r) k ==> p pure_result) ==>
;   (forall (pure_result: Prims.unit).
;       (forall (x: Prims.int).
;           GenericStability.filter_eq x l k @ GenericStability.filter_eq x r k =
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec stable_append_r`
...
;;; Fact-ids: 
(assert (! (not 
;; def=GenericStability.fst(124,2-125,25); use=GenericStability.fst(124,2-125,25)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=GenericStability.fst(121,18-121,33); use=GenericStability.fst(124,2-125,25)
(Valid 
;; def=GenericStability.fst(121,18-121,33); use=GenericStability.fst(124,2-125,25)
(GenericStability.stable x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_1
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(124,2-125,25)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=GenericStability.fst(122,16-122,39); use=GenericStability.fst(124,2-125,25)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(124,2-125,25)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(124,2-125,25)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(124,2-124,18)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.unit)

;; def=GenericStability.fst(52,17-52,90); use=GenericStability.fst(124,2-124,18)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=GenericStability.fst(124,2-124,18)
(= (FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
(GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
x_374b44ccfcb77ed85d505dbc44265913_1
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(125,2-125,18)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=GenericStability.fst(52,17-52,90); use=GenericStability.fst(125,2-125,18)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.int)

;; def=GenericStability.fst(52,28-52,89); use=GenericStability.fst(125,2-125,18)
(= (FStar.List.Tot.Base.op_At x_9cd1733a5204f989dbb2f01d5984df93_0
(GenericStability.filter_eq x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
x_374b44ccfcb77ed85d505dbc44265913_2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(125,2-125,18)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(125,2-125,18)
(ApplyTT @x0
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.stable_append_r, 1)
; STATUS: unsat
...
; encoding sigelt let rec stable_append_r
...
; encoding sigelt val GenericStability.stable_transitive
...
; Starting query at GenericStability.fst(134,38-134,40)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     GenericStability.stable l1 l2 k /\ GenericStability.stable l2 l3 k /\
;     (forall (pure_result: Prims.unit). GenericStability.stable l1 l3 k ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let stable_transitive`
...
;; def=GenericStability.fst(132,22-132,36); use=GenericStability.fst(134,38-134,40)
(Valid 
;; def=GenericStability.fst(132,22-132,36); use=GenericStability.fst(134,38-134,40)
(GenericStability.stable @x0
@x1
...
;; def=GenericStability.fst(132,40-132,54); use=GenericStability.fst(134,38-134,40)
(Valid 
;; def=GenericStability.fst(132,40-132,54); use=GenericStability.fst(134,38-134,40)
(GenericStability.stable @x0
@x2
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(134,38-134,40)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=GenericStability.fst(133,19-133,35); use=GenericStability.fst(134,38-134,40)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(134,38-134,40)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(134,38-134,40)
(ApplyTT @x5
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.stable_transitive, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_GenericStability.stable
...
; encoding sigelt let stable_transitive
...
; encoding sigelt val GenericStability.stable_append
...
; Starting query at GenericStability.fst(145,2-146,28)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     GenericStability.stable l1 l2 k /\ GenericStability.stable r1 r2 k /\
;     (forall (pure_result: Prims.unit).
;         GenericStability.stable (l1 @ r1) (l2 @ r2) k ==> p pure_result) ==>
;     GenericStability.stable l1 l2 k /\
;     (forall (pure_result: Prims.unit).
;         GenericStability.stable (l1 @ r1) (l2 @ r1) k ==>
;         (forall (pure_result: Prims.unit).
;             (GenericStability.stable r1 r2 k ==> GenericStability.stable (l2 @ r1) (l2 @ r2) k) ==>
;             p pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let stable_append`
...
;; def=GenericStability.fst(142,22-142,36); use=GenericStability.fst(145,2-146,28)
(Valid 
;; def=GenericStability.fst(142,22-142,36); use=GenericStability.fst(145,2-146,28)
(GenericStability.stable @x0
@x1
...
;; def=GenericStability.fst(142,40-142,54); use=GenericStability.fst(145,2-146,28)
(Valid 
;; def=GenericStability.fst(142,40-142,54); use=GenericStability.fst(145,2-146,28)
(GenericStability.stable @x0
@x3
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(145,2-146,28)
(forall ((@x7 Term))
 (! (implies (and (or label_1
(HasType @x7
Prims.unit))

;; def=GenericStability.fst(143,19-143,45); use=GenericStability.fst(145,2-146,28)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(145,2-146,28)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(145,2-146,28)
(ApplyTT @x6
@x7)
...
;; def=Prims.fst(441,29-441,97); use=GenericStability.fst(145,2-145,17)
(and 
;; def=GenericStability.fst(121,18-121,33); use=GenericStability.fst(145,2-145,17)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(145,2-145,17)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=GenericStability.fst(122,16-122,39); use=GenericStability.fst(145,2-145,17)
(Valid 
;; def=GenericStability.fst(122,16-122,39); use=GenericStability.fst(145,2-145,17)
(GenericStability.stable @x0
(FStar.List.Tot.Base.op_At @x0
...
;; def=Prims.fst(441,36-441,97); use=GenericStability.fst(146,2-146,17)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=GenericStability.fst(110,17-110,58); use=GenericStability.fst(146,2-146,17)
(implies 
;; def=GenericStability.fst(110,18-110,31); use=GenericStability.fst(146,2-146,17)
(Valid 
;; def=GenericStability.fst(110,18-110,31); use=GenericStability.fst(146,2-146,17)
(GenericStability.stable @x0
@x3
...
;; def=GenericStability.fst(110,36-110,57); use=GenericStability.fst(146,2-146,17)
(Valid 
;; def=GenericStability.fst(110,36-110,57); use=GenericStability.fst(146,2-146,17)
(GenericStability.stable @x0
(FStar.List.Tot.Base.op_At @x0
...
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(146,2-146,17)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericStability.fst(146,2-146,17)
(ApplyTT @x6
@x8)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericStability.stable_append, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.List.Tot.Base.op_At, equation_GenericStability.stable
