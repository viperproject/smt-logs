...
; Internals for GenericSort


; encoding sigelt val GenericSort.sorted
...
; Starting query at GenericSort.fst(29,23-31,58)
...
;;;;;;;;;;;;;;;;key : _: 'a -> Prims.int (_: 'a -> Prims.int)
(declare-fun x_2bfcfa6422f0665f886671d4c4b4d62b_3 () Term)
;;;;;;;;;;;;;;;;_: 'a -> Prims.int
(declare-fun Tm_arrow_79886a0e4c92f3492092fb04d00db416 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_79886a0e4c92f3492092fb04d00db416
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_79886a0e4c92f3492092fb04d00db416
Tm_type)
:named kinding_Tm_arrow_79886a0e4c92f3492092fb04d00db416))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_79886a0e4c92f3492092fb04d00db416)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_79886a0e4c92f3492092fb04d00db416))
:qid GenericSort_pre_typing_Tm_arrow_79886a0e4c92f3492092fb04d00db416))

:named GenericSort_pre_typing_Tm_arrow_79886a0e4c92f3492092fb04d00db416))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_79886a0e4c92f3492092fb04d00db416
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(28,38-29,16); use=GenericSort.fst(29,8-29,16)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid GenericSort_interpretation_Tm_arrow_79886a0e4c92f3492092fb04d00db416.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_79886a0e4c92f3492092fb04d00db416))
:qid GenericSort_interpretation_Tm_arrow_79886a0e4c92f3492092fb04d00db416))

:named GenericSort_interpretation_Tm_arrow_79886a0e4c92f3492092fb04d00db416))
;;;;;;;;;;;;;;;;binder_x_2bfcfa6422f0665f886671d4c4b4d62b_3
;;; Fact-ids: 
(assert (! (HasType x_2bfcfa6422f0665f886671d4c4b4d62b_3
Tm_arrow_79886a0e4c92f3492092fb04d00db416)
:named binder_x_2bfcfa6422f0665f886671d4c4b4d62b_3))
;;;;;;;;;;;;;;;;_: 'a -> Prims.int
(declare-fun Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(28,17-28,41); use=GenericSort.fst(28,28-29,14)
(forall ((@x0 Term))
...
(declare-fun Tm_refine_e92931eafb5f87a1550c85a7c0897437 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(28,23-31,58); use=GenericSort.fst(28,23-31,58)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_e92931eafb5f87a1550c85a7c0897437 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_e92931eafb5f87a1550c85a7c0897437 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_e92931eafb5f87a1550c85a7c0897437))

:named refinement_kinding_Tm_refine_e92931eafb5f87a1550c85a7c0897437))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(28,23-31,58); use=GenericSort.fst(28,23-31,58)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e92931eafb5f87a1550c85a7c0897437 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x2))

;; def=GenericSort.fst(29,23-31,58); use=GenericSort.fst(29,23-31,58)
...
(Tm_refine_e92931eafb5f87a1550c85a7c0897437 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_e92931eafb5f87a1550c85a7c0897437))

:named refinement_interpretation_Tm_refine_e92931eafb5f87a1550c85a7c0897437))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e92931eafb5f87a1550c85a7c0897437
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(28,23-31,58); use=GenericSort.fst(28,23-31,58)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e92931eafb5f87a1550c85a7c0897437 @x0
@x1)))
(Valid (Prims.hasEq (Tm_arrow_2b1c71e61beb0ccdfcd22e3f2064d949 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e92931eafb5f87a1550c85a7c0897437 @x0
@x1))))
:qid haseqTm_refine_e92931eafb5f87a1550c85a7c0897437))

:named haseqTm_refine_e92931eafb5f87a1550c85a7c0897437))
(declare-fun GenericSort.sorted (Term Term Term) Term)


;;;;;;;;;;;;;;;;_: Prims.list 'a -> key: (_: 'a -> Prims.int){_ << l} -> Prims.bool
(declare-fun Tm_arrow_9a88d9f8d15f5246476d13458cf0a667 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9a88d9f8d15f5246476d13458cf0a667
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_9a88d9f8d15f5246476d13458cf0a667
Tm_type)
:named kinding_Tm_arrow_9a88d9f8d15f5246476d13458cf0a667))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(28,12-31,58); use=GenericSort.fst(28,23-31,58)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9a88d9f8d15f5246476d13458cf0a667)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_9a88d9f8d15f5246476d13458cf0a667))
:qid GenericSort_pre_typing_Tm_arrow_9a88d9f8d15f5246476d13458cf0a667))

:named GenericSort_pre_typing_Tm_arrow_9a88d9f8d15f5246476d13458cf0a667))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9a88d9f8d15f5246476d13458cf0a667
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(28,12-31,58); use=GenericSort.fst(28,23-31,58)
(forall ((@x0 Term))
...
(Prims.list @x1))
(HasType @x3
(Tm_refine_e92931eafb5f87a1550c85a7c0897437 @x1
@x2)))
...
@x2)
@x3))
:qid GenericSort_interpretation_Tm_arrow_9a88d9f8d15f5246476d13458cf0a667.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid GenericSort_interpretation_Tm_arrow_9a88d9f8d15f5246476d13458cf0a667.2))
...
@x1)
@x2))
:qid GenericSort_interpretation_Tm_arrow_9a88d9f8d15f5246476d13458cf0a667.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_9a88d9f8d15f5246476d13458cf0a667))
:qid GenericSort_interpretation_Tm_arrow_9a88d9f8d15f5246476d13458cf0a667))

:named GenericSort_interpretation_Tm_arrow_9a88d9f8d15f5246476d13458cf0a667))
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT GenericSort.sorted@tok
@x0)
@x1)
@x2)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT GenericSort.sorted@tok
@x0)
@x1)
@x2))
:qid token_correspondence_GenericSort.sorted))

:named token_correspondence_GenericSort.sorted))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(29,8-29,14); use=GenericSort.fst(29,8-29,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType GenericSort.sorted@tok
Tm_arrow_9a88d9f8d15f5246476d13458cf0a667))
...
@x2)
@x3)
(GenericSort.sorted @x1
@x2
@x3))
 

:pattern ((GenericSort.sorted @x1
@x2
@x3))
:qid function_token_typing_GenericSort.sorted.1))
)
 

:pattern ((ApplyTT @x0
GenericSort.sorted@tok))
:qid function_token_typing_GenericSort.sorted))

:named function_token_typing_GenericSort.sorted))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(29,8-29,14); use=GenericSort.fst(29,8-29,14)
...
(Prims.list @x0))
(HasType @x2
(Tm_refine_e92931eafb5f87a1550c85a7c0897437 @x0
@x1)))
...
;   (~(Nil? l) ==>
;     ~(Cons? l && Nil? l.tl) ==>
;     (forall (b: 'a) (b: 'a) (b: Prims.list 'a). l == b :: b :: b ==> key b <= key b ==> b :: b << l)
;   )
...
;; def=Prims.fst(402,27-402,88); use=GenericSort.fst(29,23-31,58)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=GenericSort.fst(29,23-31,58)
(Valid 
;; def=Prims.fst(402,84-402,87); use=GenericSort.fst(29,23-31,58)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=GenericSort.fst(29,23-31,58)
(and (implies 
;; def=GenericSort.fst(29,15-31,58); use=GenericSort.fst(29,23-31,58)
(and 
;; def=GenericSort.fst(29,15-29,16); use=GenericSort.fst(29,29-29,30)
(not 
;; def=GenericSort.fst(29,15-29,16); use=GenericSort.fst(29,29-29,30)
...
label_1)
(implies 
;; def=Prims.fst(389,18-389,39); use=GenericSort.fst(29,23-31,58)
(and 
;; def=Prims.fst(389,19-389,21); use=GenericSort.fst(29,23-31,58)
(not 
;; def=GenericSort.fst(29,15-29,16); use=GenericSort.fst(29,29-29,30)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_0a56e3de562c08d8ab59f4ac6f626a98_2))
...
;; def=Prims.fst(413,99-413,120); use=GenericSort.fst(29,23-31,58)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=GenericSort.fst(29,15-31,14); use=GenericSort.fst(29,29-31,14)
(= x_0a56e3de562c08d8ab59f4ac6f626a98_2
...
;; def=GenericSort.fst(31,18-31,34); use=GenericSort.fst(31,18-31,34)
(<= (BoxInt_proj_0 (ApplyTT x_2bfcfa6422f0665f886671d4c4b4d62b_3
@x1))
(BoxInt_proj_0 (ApplyTT x_2bfcfa6422f0665f886671d4c4b4d62b_3
@x2)))
)

;; def=GenericSort.fst(29,23-31,58); use=GenericSort.fst(31,54-31,57)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericSort.sorted, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_0a56e3de562c08d8ab59f4ac6f626a98_2, data_elim_Prims.Cons, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, proj_equation_Prims.Cons_tl, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
; Starting query at GenericSort.fst(33,0-34,74)
...
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(34,6-34,74); use=GenericSort.fst(34,6-34,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
; *) GenericSort.sorted (x :: l) key /\ Cons? l ==> Cons? l


; Context: While encoding a query
; While typechecking the top-level declaration `val GenericSort.test_sorted`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=GenericSort.fst(33,0-34,74)
...
;; def=GenericSort.fst(34,14-34,31); use=GenericSort.fst(34,14-34,31)
...
;; def=GenericSort.fst(34,35-34,42); use=GenericSort.fst(34,35-34,42)
(BoxBool_proj_0 (Prims.uu___is_Cons @x0
@x2))
)

;; def=Prims.fst(616,4-616,8); use=GenericSort.fst(34,71-34,72)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericSort.test_sorted, 1)
; STATUS: unsat
...
; encoding sigelt val GenericSort.test_sorted
...
; Starting query at GenericSort.fst(35,26-35,28)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


; Encoding query formula : forall ('a: Type) (x: 'a) (l: Prims.list 'a) (key: (_: 'a -> Prims.int)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         (GenericSort.sorted (x :: l) key /\ Cons? l ==> key x <= key l.hd) ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let test_sorted`
...
;; def=Prims.fst(441,36-441,97); use=GenericSort.fst(35,26-35,28)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))
(implies 
;; def=GenericSort.fst(34,13-34,43); use=GenericSort.fst(35,26-35,28)
(and 
;; def=GenericSort.fst(34,14-34,31); use=GenericSort.fst(35,26-35,28)
(BoxBool_proj_0 (GenericSort.sorted @x0
(Prims.Cons @x0
@x1
@x2)
...
;; def=GenericSort.fst(34,35-34,42); use=GenericSort.fst(35,26-35,28)
(BoxBool_proj_0 (Prims.uu___is_Cons @x0
@x2))
)


;; def=GenericSort.fst(34,48-34,73); use=GenericSort.fst(35,26-35,28)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(35,26-35,28)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(35,26-35,28)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericSort.test_sorted, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_GenericSort.sorted.fuel_instrumented, @query, bool_inversion, constructor_distinct_Prims.Cons, data_typing_intro_Prims.Cons@tok, disc_equation_Prims.Cons, equation_with_fuel_GenericSort.sorted.fuel_instrumented, fuel_guarded_inversion_Prims.list, primitive_Prims.op_AmpAmp, primitive_Prims.op_LessThanOrEqual, proj_equation_Prims.Cons_hd, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, typing_GenericSort.sorted, typing_Prims.uu___is_Cons
...
; encoding sigelt let test_sorted
...
; encoding sigelt val GenericSort.test_sorted2
...
; Starting query at GenericSort.fst(38,26-38,29)

(declare-fun label_1 () Bool)


; Encoding query formula : forall ('a: Type) (_: Prims.unit) (key: (_: 'a -> Prims.int)).
;   (*  - Could not prove post-condition
; *) GenericSort.sorted [] key


; Context: While encoding a query
; While typechecking the top-level declaration `let test_sorted2`
...
;; def=GenericSort.fst(37,64-37,76); use=GenericSort.fst(38,26-38,29)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericSort.test_sorted2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_GenericSort.sorted.fuel_instrumented, @query, constructor_distinct_Prims.Nil, data_typing_intro_Prims.Nil@tok, equation_with_fuel_GenericSort.sorted.fuel_instrumented, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Nil_a
...
; encoding sigelt let test_sorted2
...
; encoding sigelt val GenericSort.sorted_smaller
...
; Starting query at GenericSort.fst(51,38-53,70)
...
;;;;;;;;;;;;;;;;key : _: a -> Prims.int (_: a -> Prims.int)
(declare-fun x_582acf81e02a6e4176cba5e2730f867d_4 () Term)
;;;;;;;;;;;;;;;;_: a -> Prims.int
...
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(47,34-51,25); use=GenericSort.fst(51,8-51,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd))
:qid GenericSort_pre_typing_Tm_arrow_605ada36aef613d3875663fdd1971cfd))

:named GenericSort_pre_typing_Tm_arrow_605ada36aef613d3875663fdd1971cfd))
...
:pattern ((ApplyTT @x0
@x1))
:qid GenericSort_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_605ada36aef613d3875663fdd1971cfd))
:qid GenericSort_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd))

:named GenericSort_interpretation_Tm_arrow_605ada36aef613d3875663fdd1971cfd))
;;;;;;;;;;;;;;;;binder_x_582acf81e02a6e4176cba5e2730f867d_4
;;; Fact-ids: 
(assert (! (HasType x_582acf81e02a6e4176cba5e2730f867d_4
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
:named binder_x_582acf81e02a6e4176cba5e2730f867d_4))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
...
;   GenericSort.sorted (x :: l) key /\ FStar.List.Tot.Base.mem y l /\
;   (forall (pure_result: Prims.unit). key x <= key y ==> p pure_result) ==>
...
;                 (key b = key y == true ==> (forall (any_result: Prims.unit). k any_result)) /\
;                 (~(key b = key y = true) ==>
;                   (forall (b: Prims.bool).
;                       key b = key y == b ==>
;                       (a << a \/ (x << x \/ (y << y \/ b << l))) /\
...
;                           key == any_result ==>
;                           GenericSort.sorted (x :: b) key /\ FStar.List.Tot.Base.mem y b /\
;                           (forall (pure_result: Prims.unit). key x <= key y ==> k pure_result)))))))
;   )


; Context: While encoding a query
; While typechecking the top-level declaration `let rec sorted_smaller`
...
;;; Fact-ids: 
(assert (! (not 
;; def=GenericSort.fst(51,38-53,70); use=GenericSort.fst(51,38-53,70)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=GenericSort.fst(48,37-48,54); use=GenericSort.fst(51,38-53,70)
...
x_582acf81e02a6e4176cba5e2730f867d_4))


;; def=GenericSort.fst(48,58-48,65); use=GenericSort.fst(51,38-53,70)
(BoxBool_proj_0 (FStar.List.Tot.Base.mem x_9cd1733a5204f989dbb2f01d5984df93_0
x_157b99e815dc43d99415725267e9c452_2
x_374b44ccfcb77ed85d505dbc44265913_3))


;; def=Prims.fst(441,36-441,97); use=GenericSort.fst(51,38-53,70)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=GenericSort.fst(49,34-49,50); use=GenericSort.fst(51,38-53,70)
(or label_2

;; def=GenericSort.fst(49,34-49,50); use=GenericSort.fst(51,38-53,70)
(<= (BoxInt_proj_0 (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_4
x_157b99e815dc43d99415725267e9c452_1))
(BoxInt_proj_0 (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_4
x_157b99e815dc43d99415725267e9c452_2)))
)
...
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(51,38-53,70)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(51,38-53,70)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=GenericSort.fst(51,38-53,70)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=GenericSort.fst(51,38-53,70)
(Valid 
;; def=Prims.fst(402,73-402,79); use=GenericSort.fst(51,38-53,70)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=GenericSort.fst(51,38-53,70)
(Valid 
;; def=Prims.fst(402,84-402,87); use=GenericSort.fst(51,38-53,70)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=GenericSort.fst(51,38-53,70)
(and (implies 
;; def=GenericSort.fst(51,30-51,31); use=GenericSort.fst(51,44-51,45)
(and 
;; def=GenericSort.fst(51,30-51,31); use=GenericSort.fst(51,44-51,45)
(not 
;; def=GenericSort.fst(51,30-51,31); use=GenericSort.fst(51,44-51,45)
...
label_3)
(implies 
;; def=GenericSort.fst(51,30-52,8); use=GenericSort.fst(51,44-52,8)
(= x_374b44ccfcb77ed85d505dbc44265913_3
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0))


;; def=Prims.fst(451,66-451,102); use=GenericSort.fst(51,38-53,70)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=GenericSort.fst(51,38-53,70)
(Valid 
;; def=Prims.fst(451,90-451,102); use=GenericSort.fst(51,38-53,70)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=GenericSort.fst(51,38-53,70)
(not 
;; def=GenericSort.fst(51,30-51,31); use=GenericSort.fst(51,44-51,45)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_3))
...
;; def=Prims.fst(413,99-413,120); use=GenericSort.fst(51,38-53,70)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=GenericSort.fst(51,30-53,11); use=GenericSort.fst(51,44-53,11)
(= x_374b44ccfcb77ed85d505dbc44265913_3
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x3))
...
;; def=Prims.fst(389,2-389,39); use=GenericSort.fst(51,38-53,70)
(and (implies 
;; def=GenericSort.fst(53,18-53,31); use=GenericSort.fst(53,18-53,31)
(= (Prims.op_Equality Prims.int
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_4
@x2)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_4
x_157b99e815dc43d99415725267e9c452_2))
(BoxBool true))
...
;; def=GenericSort.fst(53,18-53,70); use=GenericSort.fst(53,18-53,70)
(= (Prims.op_Equality Prims.int
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_4
@x2)
(ApplyTT x_582acf81e02a6e4176cba5e2730f867d_4
...
;; def=Prims.fst(459,77-459,89); use=GenericSort.fst(51,38-53,70)
(and 
;; def=GenericSort.fst(43,21-53,70); use=GenericSort.fst(53,67-53,70)
(or label_4

;; def=GenericSort.fst(51,38-53,70); use=GenericSort.fst(53,67-53,70)
(Valid 
;; def=GenericSort.fst(51,38-53,70); use=GenericSort.fst(53,67-53,70)
...
;; def=GenericSort.fst(47,20-51,35); use=GenericSort.fst(51,38-53,70)
(= x_582acf81e02a6e4176cba5e2730f867d_4
@x6)
)

;; def=Prims.fst(441,29-441,97); use=GenericSort.fst(53,45-53,59)
(and 
;; def=GenericSort.fst(48,37-48,54); use=GenericSort.fst(53,45-53,59)
(or label_5
...
;; def=GenericSort.fst(48,58-48,65); use=GenericSort.fst(53,45-53,59)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=GenericSort.fst(53,45-53,59)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=GenericSort.fst(49,34-49,50); use=GenericSort.fst(53,45-53,59)
(<= (BoxInt_proj_0 (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_4
x_157b99e815dc43d99415725267e9c452_1))
(BoxInt_proj_0 (ApplyTT x_582acf81e02a6e4176cba5e2730f867d_4
x_157b99e815dc43d99415725267e9c452_2)))
...
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(53,45-53,59)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(53,45-53,59)
(ApplyTT @x4
@x7)
...
; encoding sigelt let rec sorted_smaller
...
; encoding sigelt val GenericSort.sorted_tl
...
; Starting query at GenericSort.fst(59,2-61,35)
...
(declare-fun x_9a99f0ed3c7c19be1f30eec0ab46713a_1 () Term)
(declare-fun Tm_refine_68a3139579b4e370456a4a2443f8bb4d () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_68a3139579b4e370456a4a2443f8bb4d
Tm_type)
:named refinement_kinding_Tm_refine_68a3139579b4e370456a4a2443f8bb4d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(55,28-55,45); use=GenericSort.fst(58,8-58,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_68a3139579b4e370456a4a2443f8bb4d)
(and (HasTypeFuel @u0
@x1
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=GenericSort.fst(55,37-55,44); use=GenericSort.fst(58,8-58,17)
(BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x1))
))
...
@x1
Tm_refine_68a3139579b4e370456a4a2443f8bb4d))
:qid refinement_interpretation_Tm_refine_68a3139579b4e370456a4a2443f8bb4d))

:named refinement_interpretation_Tm_refine_68a3139579b4e370456a4a2443f8bb4d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_68a3139579b4e370456a4a2443f8bb4d
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_68a3139579b4e370456a4a2443f8bb4d))
(Valid (Prims.hasEq (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))))
:named haseqTm_refine_68a3139579b4e370456a4a2443f8bb4d))
;;;;;;;;;;;;;;;;binder_x_9a99f0ed3c7c19be1f30eec0ab46713a_1
;;; Fact-ids: 
(assert (! (HasType x_9a99f0ed3c7c19be1f30eec0ab46713a_1
Tm_refine_68a3139579b4e370456a4a2443f8bb4d)
:named binder_x_9a99f0ed3c7c19be1f30eec0ab46713a_1))
...
;;; Fact-ids: 
(assert (! 
;; def=GenericSort.fst(55,61-58,20); use=GenericSort.fst(58,8-58,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_605ada36aef613d3875663fdd1971cfd)
...
;   (forall (pure_result: Prims.unit). GenericSort.sorted l.tl k ==> p pure_result) ==>
;   (forall (k: Prims.pure_post Prims.unit).
;       (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;       (~(Cons? l && Nil? l.tl) /\ ~(Cons? l && Cons? l.tl) ==> Prims.l_False) /\
...
;                 (forall (any_result: (_: a -> Prims.int)).
;                     k == any_result ==>
;                     GenericSort.sorted (b :: b) k /\
;                     (forall (pure_result: Prims.unit).
;                         GenericSort.sorted (b :: b).tl k ==> k pure_result))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec sorted_tl`
...
;;; Fact-ids: 
(assert (! (not 
;; def=GenericSort.fst(59,2-61,35); use=GenericSort.fst(59,2-61,35)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=GenericSort.fst(56,18-56,30); use=GenericSort.fst(59,2-61,35)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_1
x_582acf81e02a6e4176cba5e2730f867d_2))


;; def=Prims.fst(441,36-441,97); use=GenericSort.fst(59,2-61,35)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=GenericSort.fst(57,17-57,40); use=GenericSort.fst(59,2-61,35)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(59,2-61,35)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(59,2-61,35)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=GenericSort.fst(59,2-61,35)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=GenericSort.fst(59,2-61,35)
(Valid 
;; def=Prims.fst(402,73-402,79); use=GenericSort.fst(59,2-61,35)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=GenericSort.fst(59,2-61,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=GenericSort.fst(59,2-61,35)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=GenericSort.fst(59,2-61,35)
(and (implies 
;; def=GenericSort.fst(59,2-61,35); use=GenericSort.fst(59,2-61,35)
(and 
;; def=GenericSort.fst(59,2-61,35); use=GenericSort.fst(59,2-61,35)
...
;; def=Prims.fst(413,99-413,120); use=GenericSort.fst(59,2-61,35)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=GenericSort.fst(58,21-60,7); use=GenericSort.fst(59,8-60,7)
(= x_9a99f0ed3c7c19be1f30eec0ab46713a_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_0)))
...
;; def=Prims.fst(451,66-451,102); use=GenericSort.fst(59,2-61,35)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=GenericSort.fst(59,2-61,35)
(Valid 
;; def=Prims.fst(451,90-451,102); use=GenericSort.fst(59,2-61,35)
(ApplyTT @x1
@x3)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=GenericSort.fst(59,2-61,35)
(not 
;; def=GenericSort.fst(59,2-61,35); use=GenericSort.fst(59,2-61,35)
(and (BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_0
x_9a99f0ed3c7c19be1f30eec0ab46713a_1))
...
;; def=GenericSort.fst(58,21-61,12); use=GenericSort.fst(59,8-61,12)
(= x_9a99f0ed3c7c19be1f30eec0ab46713a_1
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
...
;; def=Prims.fst(459,77-459,89); use=GenericSort.fst(59,2-61,35)
(and 
;; def=GenericSort.fst(55,37-55,44); use=GenericSort.fst(61,26-61,33)
(or label_4
...
;; def=Prims.fst(356,2-356,58); use=GenericSort.fst(59,2-61,35)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Tm_refine_68a3139579b4e370456a4a2443f8bb4d)

;; def=Prims.fst(356,26-356,41); use=GenericSort.fst(59,2-61,35)
(= @x5
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
@x4))
...
;; def=Prims.fst(459,77-459,89); use=GenericSort.fst(59,2-61,35)
(and 
;; def=GenericSort.fst(55,16-61,35); use=GenericSort.fst(61,34-61,35)
(or label_5

;; def=GenericSort.fst(59,2-61,35); use=GenericSort.fst(61,34-61,35)
(Valid 
;; def=GenericSort.fst(59,2-61,35); use=GenericSort.fst(61,34-61,35)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=GenericSort.fst(55,49-58,24); use=GenericSort.fst(59,2-61,35)
(= x_582acf81e02a6e4176cba5e2730f867d_2
@x6)
)

;; def=Prims.fst(441,29-441,97); use=GenericSort.fst(61,16-61,25)
(and 
;; def=GenericSort.fst(56,18-56,30); use=GenericSort.fst(61,16-61,25)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=GenericSort.fst(61,16-61,25)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=GenericSort.fst(57,17-57,40); use=GenericSort.fst(61,16-61,25)
(BoxBool_proj_0 (GenericSort.sorted x_9cd1733a5204f989dbb2f01d5984df93_0
(Prims.__proj__Cons__item__tl x_9cd1733a5204f989dbb2f01d5984df93_0
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
...
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(61,16-61,25)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(61,16-61,25)
(ApplyTT @x1
@x7)
...
; encoding sigelt let rec sorted_tl
...
; encoding sigelt val GenericSort.sorted_lt
...
(HasType @x1
(Tm_refine_7aac12c24449a22c34d98a0ea8ed4a32 @x0)))
(HasType (FStar.List.Tot.Base.hd @x0
@x1)
@x0))
 

:pattern ((FStar.List.Tot.Base.hd @x0
@x1))
...
; Starting query at GenericSort.fst(66,23-66,25)
...
; Encoding query formula : forall (a: Prims.eqtype) (l: Prims.list a {Cons? l}) (k: (_: a -> Prims.int)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     GenericSort.sorted l k /\
;     (forall (pure_result: Prims.unit).
;         (forall (x: Prims.int) (y: a).
;             x < k (FStar.List.Tot.Base.hd l) /\ k y = x ==> FStar.List.Tot.Base.mem y l = false) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let sorted_lt`
...
;; def=GenericSort.fst(64,18-64,30); use=GenericSort.fst(66,23-66,25)
(BoxBool_proj_0 (GenericSort.sorted @x0
@x1
@x2))


;; def=Prims.fst(441,36-441,97); use=GenericSort.fst(66,23-66,25)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=GenericSort.fst(65,27-65,88); use=GenericSort.fst(66,23-66,25)
...
;; def=GenericSort.fst(65,41-65,53); use=GenericSort.fst(66,23-66,25)
(< (BoxInt_proj_0 @x5)
...
;; def=GenericSort.fst(65,57-65,64); use=GenericSort.fst(66,23-66,25)
(= (ApplyTT @x2
@x6)
@x5)
)

;; def=GenericSort.fst(65,70-65,87); use=GenericSort.fst(66,23-66,25)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(66,23-66,25)
(Valid 
;; def=Prims.fst(441,83-441,96); use=GenericSort.fst(66,23-66,25)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericSort.sorted_lt, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_FStar.List.Tot.Base.mem.fuel_instrumented, @fuel_correspondence_GenericSort.sorted.fuel_instrumented, @fuel_irrelevance_FStar.List.Tot.Base.mem.fuel_instrumented, @fuel_irrelevance_GenericSort.sorted.fuel_instrumented, @query, Prims_pretyping_3862c4e8ff39bfc3871b6a47e7ff5b2e, bool_inversion, data_elim_Prims.Cons, disc_equation_Prims.Cons, equation_FStar.List.Tot.Base.hd, equation_Prims.eqtype, equation_with_fuel_FStar.List.Tot.Base.mem.fuel_instrumented, fuel_guarded_inversion_Prims.list, lemma_GenericSort.sorted_smaller, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_7aac12c24449a22c34d98a0ea8ed4a32, token_correspondence_FStar.List.Tot.Base.mem.fuel_instrumented, typing_FStar.List.Tot.Base.hd, typing_GenericSort.sorted
...
; Starting query at GenericSort.fst(69,4-69,60)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type{Prims.hasEq a}) (l1: Prims.list a) (l2: Prims.list a).
;   (*  - Could not prove post-condition
...
;; def=Prims.fst(73,23-73,30); use=GenericSort.fst(69,4-69,10)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (GenericSort.permutation, 1)
; STATUS: unsat
