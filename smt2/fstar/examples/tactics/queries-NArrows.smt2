...
; Internals for NArrows


; encoding sigelt type NArrows.n_arrows_t


; <Start encoding type NArrows.n_arrows_t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun NArrows.n_arrows_t (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun NArrows.n_arrows_t@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun NArrows.Mkn_arrows_t (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun NArrows.Mkn_arrows_t_ff (Term) Term)
;;;;;;;;;;;;;;;;Constructor base
(declare-fun NArrows.Mkn_arrows_t@base (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: NArrows.Mkn_arrows_t
(declare-fun NArrows.Mkn_arrows_t@tok () Term)
;;;;;;;;;;;;;;;;ff: Prims.int -> n_arrows_t t
(declare-fun Tm_arrow_3c7772da81787891299c69ca3363ebdb () Term)

; <start constructor NArrows.n_arrows_t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NArrows.n_arrows_t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
(NArrows.n_arrows_t @x0))
 
;;no pats
:qid is-NArrows.n_arrows_t))))

; </end constructor NArrows.n_arrows_t>


; <start constructor NArrows.Mkn_arrows_t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-NArrows.Mkn_arrows_t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
111)
(exists ((@x0 Term))
 (! (= __@x0
(NArrows.Mkn_arrows_t @x0
(NArrows.Mkn_arrows_t_ff __@x0)))
 
;;no pats
:qid is-NArrows.Mkn_arrows_t))))

; </end constructor NArrows.Mkn_arrows_t>


; </end encoding type NArrows.n_arrows_t>


; encoding sigelt val NArrows.__proj__Mkn_arrows_t__item__ff


; <Start encoding val NArrows.__proj__Mkn_arrows_t__item__ff>

(declare-fun NArrows.__proj__Mkn_arrows_t__item__ff (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: n_arrows_t t -> Prims.int
(declare-fun Tm_arrow_b0403eb7fc60be77738f33261d7250c9 () Term)
(declare-fun NArrows.__proj__Mkn_arrows_t__item__ff@tok () Term)

; </end encoding val NArrows.__proj__Mkn_arrows_t__item__ff>


; encoding sigelt let __proj__Mkn_arrows_t__item__ff


; <Skipped let __proj__Mkn_arrows_t__item__ff/>
...
(declare-fun NArrows.ff (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: n_arrows_t t |} -> Prims.int
(declare-fun Tm_arrow_f37a0b44fe82138a45250bf23f7e6872 (Term) Term)
;;;;;;;;;;;;;;;;{| projectee: n_arrows_t t |} -> Prims.int
(declare-fun Tm_arrow_1f55e8a852550ccb58edc1fbe691f257 () Term)
(declare-fun NArrows.ff@tok () Term)


(declare-fun Tm_abs_df99b3f29d8b7f3c1e723d74288d6db6 (Term) Term)

; </end encoding let ff>


; encoding sigelt let n_arrows


; <Start encoding let n_arrows>

(declare-fun NArrows.n_arrows (Term Term) Term)

(declare-fun NArrows.n_arrows@tok () Term)

; </end encoding let n_arrows>


; encoding sigelt let n_arrow_int


; <Start encoding let n_arrow_int>

(declare-fun NArrows.n_arrow_int (Dummy_sort) Term)

; </end encoding let n_arrow_int>


; encoding sigelt let n_arrow_arr


; <Start encoding let n_arrow_arr>

(declare-fun NArrows.n_arrow_arr (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> {| _: n_arrows_t b |} -> n_arrows_t (_: a -> b)
(declare-fun Tm_arrow_3603765ef2474313412f9e55f770eff4 () Term)
(declare-fun NArrows.n_arrow_arr@tok () Term)



; </end encoding let n_arrow_arr>
...
(declare-fun NArrows.xxx (Dummy_sort) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> _: Prims.nat -> Prims.int
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NArrows.xxx; Namespace NArrows
(assert (! 
;; def=NArrows.fst(11,4-11,7); use=NArrows.fst(11,4-11,7)
(forall ((@u0 Dummy_sort))
 (! (HasType (NArrows.xxx @u0)
Prims.int)
 

:pattern ((NArrows.xxx @u0))
:qid typing_NArrows.xxx))

:named typing_NArrows.xxx))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NArrows.n_arrows; Namespace NArrows
(assert (! 
;; def=NArrows.fst(5,4-5,12); use=NArrows.fst(5,4-5,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(NArrows.n_arrows_t @x0)))
(HasType (NArrows.n_arrows @x0
@x1)
Prims.int))
 

:pattern ((NArrows.n_arrows @x0
@x1))
:qid typing_NArrows.n_arrows))

:named typing_NArrows.n_arrows))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NArrows.n_arrow_int; Namespace NArrows
(assert (! 
;; def=NArrows.fst(7,9-7,20); use=NArrows.fst(7,9-7,20)
(forall ((@u0 Dummy_sort))
 (! (HasType (NArrows.n_arrow_int @u0)
(NArrows.n_arrows_t Prims.int))
 

:pattern ((NArrows.n_arrow_int @u0))
:qid typing_NArrows.n_arrow_int))

:named typing_NArrows.n_arrow_int))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NArrows.n_arrow_arr; Namespace NArrows
(assert (! 
;; def=NArrows.fst(9,9-9,20); use=NArrows.fst(9,9-9,20)
...
Tm_type)
(HasType @x2
(NArrows.n_arrows_t @x1)))
(HasType (NArrows.n_arrow_arr @x0
@x1
@x2)
(NArrows.n_arrows_t (Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x0))))
 

:pattern ((NArrows.n_arrow_arr @x0
@x1
@x2))
:qid typing_NArrows.n_arrow_arr))

:named typing_NArrows.n_arrow_arr))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name NArrows.__proj__Mkn_arrows_t__item__ff; Namespace NArrows
(assert (! 
;; def=NArrows.fst(3,30-3,32); use=NArrows.fst(3,30-3,32)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(NArrows.n_arrows_t @x0)))
(HasType (NArrows.__proj__Mkn_arrows_t__item__ff @x0
@x1)
Prims.int))
 

:pattern ((NArrows.__proj__Mkn_arrows_t__item__ff @x0
@x1))
:qid typing_NArrows.__proj__Mkn_arrows_t__item__ff))

:named typing_NArrows.__proj__Mkn_arrows_t__item__ff))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name NArrows.n_arrows_t; Namespace NArrows; Name NArrows.Mkn_arrows_t; Namespace NArrows
(assert (! 
;; def=NArrows.fst(3,6-3,16); use=NArrows.fst(3,6-3,16)
(forall ((@x0 Term))
 (! (= (ApplyTT NArrows.n_arrows_t@tok
@x0)
(NArrows.n_arrows_t @x0))
 

:pattern ((ApplyTT NArrows.n_arrows_t@tok
@x0))

:pattern ((NArrows.n_arrows_t @x0))
:qid token_correspondence_NArrows.n_arrows_t@tok))

:named token_correspondence_NArrows.n_arrows_t@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name NArrows.n_arrows_t; Namespace NArrows; Name NArrows.Mkn_arrows_t; Namespace NArrows
(assert (! 
;; def=NArrows.fst(3,6-3,16); use=NArrows.fst(3,6-3,16)
...
(NArrows.Mkn_arrows_t @x1
@x2)
(NArrows.n_arrows_t @x3))
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(NArrows.Mkn_arrows_t @x1
...
@x2)
(NArrows.n_arrows_t @x3)))
:qid subterm_ordering_NArrows.Mkn_arrows_t))

:named subterm_ordering_NArrows.Mkn_arrows_t))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=NArrows.fst(3,6-3,16); use=NArrows.fst(3,6-3,16)
(forall ((@x0 Term) (@x1 Term))
 (! (= (NArrows.Mkn_arrows_t_ff (NArrows.Mkn_arrows_t @x0
@x1))
@x1)
 

:pattern ((NArrows.Mkn_arrows_t @x0
@x1))
:qid projection_inverse_NArrows.Mkn_arrows_t_ff))

:named projection_inverse_NArrows.Mkn_arrows_t_ff))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name NArrows.__proj__Mkn_arrows_t__item__ff; Namespace NArrows
(assert (! 
;; def=NArrows.fst(3,30-3,32); use=NArrows.fst(3,30-3,32)
(forall ((@x0 Term) (@x1 Term))
 (! (= (NArrows.__proj__Mkn_arrows_t__item__ff @x0
@x1)
(NArrows.Mkn_arrows_t_ff @x1))
 

:pattern ((NArrows.__proj__Mkn_arrows_t__item__ff @x0
@x1))
:qid proj_equation_NArrows.Mkn_arrows_t_ff))

:named proj_equation_NArrows.Mkn_arrows_t_ff))
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name NArrows.n_arrows_t; Namespace NArrows; Name NArrows.Mkn_arrows_t; Namespace NArrows
(assert (! (is-Tm_arrow (PreType NArrows.n_arrows_t@tok))
:named pre_kinding_NArrows.n_arrows_t@tok))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_97e79e8898be25d1baac7492eb8157a8
;;; Fact-ids: Name NArrows.xxx; Namespace NArrows
(assert (! (HasType Tm_arrow_97e79e8898be25d1baac7492eb8157a8
Tm_type)
:named kinding_Tm_arrow_97e79e8898be25d1baac7492eb8157a8))
...
;;; Fact-ids: Name NArrows.n_arrows_t; Namespace NArrows; Name NArrows.Mkn_arrows_t; Namespace NArrows
(assert (! (and (IsTotFun NArrows.n_arrows_t@tok)

;; def=NArrows.fst(3,6-3,16); use=NArrows.fst(3,6-3,16)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (NArrows.n_arrows_t @x0)
Tm_type))
 

:pattern ((NArrows.n_arrows_t @x0))
:qid kinding_NArrows.n_arrows_t@tok))
)
:named kinding_NArrows.n_arrows_t@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(NArrows.n_arrows_t @x2))
(is-NArrows.Mkn_arrows_t @x1))
 

:pattern ((HasTypeFuel @u0
@x1
(NArrows.n_arrows_t @x2)))
:qid fuel_guarded_inversion_NArrows.n_arrows_t))

:named fuel_guarded_inversion_NArrows.n_arrows_t))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name NArrows.n_arrows_t; Namespace NArrows; Name NArrows.Mkn_arrows_t; Namespace NArrows
(assert (! (= 105
(Term_constr_id NArrows.n_arrows_t@tok))
:named fresh_token_NArrows.n_arrows_t@tok))
...
(NArrows.n_arrows Tm_arrow_97e79e8898be25d1baac7492eb8157a8
(NArrows.n_arrow_arr Prims.int
Tm_arrow_fc34ca66de2f262c06145b17fb7ed6cb
(NArrows.n_arrow_arr Prims.nat
Prims.int
(NArrows.n_arrow_int Dummy_value)))))
...
:qid equation_NArrows.xxx))

:named equation_NArrows.xxx))
;;;;;;;;;;;;;;;;Equation for NArrows.n_arrows
;;; Fact-ids: Name NArrows.n_arrows; Namespace NArrows
(assert (! 
;; def=NArrows.fst(5,4-5,12); use=NArrows.fst(5,4-5,12)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((NArrows.n_arrows @x0
@x1))
:qid equation_NArrows.n_arrows))

:named equation_NArrows.n_arrows))
;;;;;;;;;;;;;;;;Equation for NArrows.n_arrow_int
;;; Fact-ids: Name NArrows.n_arrow_int; Namespace NArrows
(assert (! 
;; def=NArrows.fst(7,9-7,20); use=NArrows.fst(7,9-7,20)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=NArrows.fst(7,9-7,20); use=NArrows.fst(7,9-7,20)
(NArrows.n_arrow_int @u0)

(NArrows.Mkn_arrows_t Prims.int
(BoxInt 0)))
...
:qid equation_NArrows.n_arrow_int))

:named equation_NArrows.n_arrow_int))
;;;;;;;;;;;;;;;;Equation for NArrows.n_arrow_arr
;;; Fact-ids: Name NArrows.n_arrow_arr; Namespace NArrows
(assert (! 
;; def=NArrows.fst(9,9-9,20); use=NArrows.fst(9,9-9,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (NArrows.n_arrow_arr @x0
@x1
@x2)
(NArrows.Mkn_arrows_t (Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x0)
...
@x1
@x2))
:qid equation_NArrows.n_arrow_arr))

:named equation_NArrows.n_arrow_arr))
...
@x2)
(NArrows.n_arrows_t @x1)))
:qid data_typing_intro_NArrows.Mkn_arrows_t@tok))

:named data_typing_intro_NArrows.Mkn_arrows_t@tok))
...
@x2)
(NArrows.n_arrows_t @x3)))
:qid data_elim_NArrows.Mkn_arrows_t))

:named data_elim_NArrows.Mkn_arrows_t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 104
(Term_constr_id (NArrows.n_arrows_t @x0)))
 

:pattern ((NArrows.n_arrows_t @x0))
:qid constructor_distinct_NArrows.n_arrows_t))

:named constructor_distinct_NArrows.n_arrows_t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name NArrows.n_arrows_t; Namespace NArrows; Name NArrows.Mkn_arrows_t; Namespace NArrows
(assert (! 
;; def=NArrows.fst(3,6-3,16); use=NArrows.fst(3,6-3,16)
(forall ((@x0 Term) (@x1 Term))
 (! (= 111
(Term_constr_id (NArrows.Mkn_arrows_t @x0
@x1)))
 

:pattern ((NArrows.Mkn_arrows_t @x0
@x1))
:qid constructor_distinct_NArrows.Mkn_arrows_t))

:named constructor_distinct_NArrows.Mkn_arrows_t))
;;;;;;;;;;;;;;;;Constructor base
;;; Fact-ids: Name NArrows.n_arrows_t; Namespace NArrows; Name NArrows.Mkn_arrows_t; Namespace NArrows
(assert (! 
;; def=NArrows.fst(3,6-3,16); use=NArrows.fst(3,6-3,16)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (is-NArrows.Mkn_arrows_t (NArrows.Mkn_arrows_t @x0
@x1))
(= (NArrows.Mkn_arrows_t @x0
@x1)
(NArrows.Mkn_arrows_t@base @x1)))
 

:pattern ((NArrows.Mkn_arrows_t @x0
@x1))
:qid constructor_base_NArrows.Mkn_arrows_t))

:named constructor_base_NArrows.Mkn_arrows_t))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
(NArrows.n_arrows_t @x2))
(= (Term_constr_id (NArrows.n_arrows_t @x2))
...
@x0
(NArrows.n_arrows_t @x2)))
:qid NArrows_pretyping_d4384b188b22057be646995e85fa6070))

:named NArrows_pretyping_d4384b188b22057be646995e85fa6070))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name NArrows.xxx; Namespace NArrows
(assert (! 
;; def=NArrows.fst(11,20-11,37); use=NArrows.fst(11,20-11,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_97e79e8898be25d1baac7492eb8157a8)
...
@x1
Tm_arrow_97e79e8898be25d1baac7492eb8157a8))
:qid NArrows_pre_typing_Tm_arrow_97e79e8898be25d1baac7492eb8157a8))

:named NArrows_pre_typing_Tm_arrow_97e79e8898be25d1baac7492eb8157a8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_97e79e8898be25d1baac7492eb8157a8
;;; Fact-ids: Name NArrows.xxx; Namespace NArrows
(assert (! 
;; def=NArrows.fst(11,20-11,37); use=NArrows.fst(11,20-11,37)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid NArrows_interpretation_Tm_arrow_97e79e8898be25d1baac7492eb8157a8.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid NArrows_interpretation_Tm_arrow_97e79e8898be25d1baac7492eb8157a8.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_97e79e8898be25d1baac7492eb8157a8))
:qid NArrows_interpretation_Tm_arrow_97e79e8898be25d1baac7492eb8157a8))

:named NArrows_interpretation_Tm_arrow_97e79e8898be25d1baac7492eb8157a8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.UInt.max_int; Namespace FStar.UInt
(assert (! 
...
; Starting query at NArrows.fst(13,0-13,25)

(declare-fun label_1 () Bool)

; Encoding query formula : NArrows.xxx == 2
...
;;; Fact-ids: 
(assert (! (not 
;; def=NArrows.fst(13,15-13,25); use=NArrows.fst(13,8-13,14)
(or label_1

;; def=NArrows.fst(13,15-13,25); use=NArrows.fst(13,8-13,14)
(= (NArrows.xxx Dummy_value)
(BoxInt 2))
)
)
:named @query))
