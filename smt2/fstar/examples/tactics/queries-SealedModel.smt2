...
; Internals for SealedModel


; encoding sigelt val SealedModel.sealed


; <Skipped val SealedModel.sealed/>


; encoding sigelt type SealedModel.sealed


; <Start encoding type SealedModel.sealed>

;;;;;;;;;;;;;;;;Constructor
(declare-fun SealedModel.sealed (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun SealedModel.sealed@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SealedModel.Seal (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun SealedModel.Seal__0 (Term) Term)
;;;;;;;;;;;;;;;;Constructor base
(declare-fun SealedModel.Seal@base (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: SealedModel.Seal
(declare-fun SealedModel.Seal@tok () Term)
(declare-fun Non_total_Tm_arrow_458669198803b86e531731a2e81cc575 (Term) Term)

;;;;;;;;;;;;;;;;_0: (_: Prims.unit -> FStar.Tactics.Effect.TacS a) -> sealed a
(declare-fun Tm_arrow_66ce0a721ebfdf6c6770b52bb83da416 () Term)

; <start constructor SealedModel.sealed>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SealedModel.sealed ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
(SealedModel.sealed @x0))
 
;;no pats
:qid is-SealedModel.sealed))))

; </end constructor SealedModel.sealed>


; <start constructor SealedModel.Seal>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SealedModel.Seal ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
119)
(exists ((@x0 Term))
 (! (= __@x0
(SealedModel.Seal @x0
(SealedModel.Seal__0 __@x0)))
 
;;no pats
:qid is-SealedModel.Seal))))

; </end constructor SealedModel.Seal>


; </end encoding type SealedModel.sealed>


; encoding sigelt val SealedModel.uu___is_Seal


; <Start encoding val SealedModel.uu___is_Seal>

(declare-fun SealedModel.uu___is_Seal (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: sealed a -> Prims.bool
(declare-fun Tm_arrow_287539f4a2b59ae7e674bbe67cdf3a4a () Term)
(declare-fun SealedModel.uu___is_Seal@tok () Term)

; </end encoding val SealedModel.uu___is_Seal>


; encoding sigelt let uu___is_Seal


; <Skipped let uu___is_Seal/>


; encoding sigelt val SealedModel.__proj__Seal__item___0


; <Start encoding val SealedModel.__proj__Seal__item___0>

(declare-fun SealedModel.__proj__Seal__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: sealed a -> _: Prims.unit -> FStar.Tactics.Effect.TacS a
(declare-fun Tm_arrow_258b681c61d7b27f2bd02d9983e9b946 () Term)
(declare-fun SealedModel.__proj__Seal__item___0@tok () Term)


; </end encoding val SealedModel.__proj__Seal__item___0>


; encoding sigelt let __proj__Seal__item___0


; <Skipped let __proj__Seal__item___0/>


; encoding sigelt val SealedModel.unobs_axiom


; <Start encoding val SealedModel.unobs_axiom>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SealedModel.unobs_axiom (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SealedModel.unobs_axiom@tok () Term)

; </end encoding val SealedModel.unobs_axiom>


; encoding sigelt val SealedModel.sealed_singl


; <Skipped val SealedModel.sealed_singl/>
...
;;; Fact-ids: Name SealedModel.sealed; Namespace SealedModel; Name SealedModel.Seal; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(24,5-24,11); use=SealedModel.fst(24,5-24,11)
(forall ((@x0 Term))
 (! (= (ApplyTT SealedModel.sealed@tok
@x0)
(SealedModel.sealed @x0))
 

:pattern ((ApplyTT SealedModel.sealed@tok
@x0))

:pattern ((SealedModel.sealed @x0))
:qid token_correspondence_SealedModel.sealed@tok))

:named token_correspondence_SealedModel.sealed@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name SealedModel.sealed; Namespace SealedModel; Name SealedModel.Seal; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(25,4-25,8); use=SealedModel.fst(25,4-25,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(SealedModel.Seal @x1
@x2)
(SealedModel.sealed @x3))
...
@x2)
(SealedModel.sealed @x3)))
:qid subterm_ordering_SealedModel.Seal))

:named subterm_ordering_SealedModel.Seal))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=SealedModel.fst(25,4-25,8); use=SealedModel.fst(25,4-25,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (SealedModel.Seal__0 (SealedModel.Seal @x0
@x1))
@x1)
 

:pattern ((SealedModel.Seal @x0
@x1))
:qid projection_inverse_SealedModel.Seal__0))

:named projection_inverse_SealedModel.Seal__0))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name SealedModel.sealed; Namespace SealedModel; Name SealedModel.Seal; Namespace SealedModel
(assert (! (is-Tm_arrow (PreType SealedModel.sealed@tok))
:named pre_kinding_SealedModel.sealed@tok))
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: Name SealedModel.sealed; Namespace SealedModel; Name SealedModel.Seal; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(24,13-25,17); use=SealedModel.fst(25,13-25,27)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Non_total_Tm_arrow_458669198803b86e531731a2e81cc575 @x0)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_458669198803b86e531731a2e81cc575 @x0)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_458669198803b86e531731a2e81cc575))

:named non_total_function_typing_Non_total_Tm_arrow_458669198803b86e531731a2e81cc575))
...
;;; Fact-ids: Name SealedModel.sealed; Namespace SealedModel; Name SealedModel.Seal; Namespace SealedModel
(assert (! (and (IsTotFun SealedModel.sealed@tok)

;; def=SealedModel.fst(24,5-24,11); use=SealedModel.fst(24,5-24,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (SealedModel.sealed @x0)
Tm_type))
 

:pattern ((SealedModel.sealed @x0))
:qid kinding_SealedModel.sealed@tok))
)
:named kinding_SealedModel.sealed@tok))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(SealedModel.sealed @x2))
(is-SealedModel.Seal @x1))
 

:pattern ((HasTypeFuel @u0
@x1
(SealedModel.sealed @x2)))
:qid fuel_guarded_inversion_SealedModel.sealed))

:named fuel_guarded_inversion_SealedModel.sealed))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name SealedModel.sealed; Namespace SealedModel; Name SealedModel.Seal; Namespace SealedModel
(assert (! (= 105
(Term_constr_id SealedModel.sealed@tok))
:named fresh_token_SealedModel.sealed@tok))
...
(HasTypeFuel @u0
@x2
(Non_total_Tm_arrow_458669198803b86e531731a2e81cc575 @x1)))
(HasTypeFuel @u0
(SealedModel.Seal @x1
@x2)
(SealedModel.sealed @x1)))
...
@x2)
(SealedModel.sealed @x1)))
:qid data_typing_intro_SealedModel.Seal@tok))

:named data_typing_intro_SealedModel.Seal@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
(HasTypeFuel @u0
@x2
(Non_total_Tm_arrow_458669198803b86e531731a2e81cc575 @x3))))
...
@x2)
(SealedModel.sealed @x3)))
:qid data_elim_SealedModel.Seal))

:named data_elim_SealedModel.Seal))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SealedModel.sealed; Namespace SealedModel; Name SealedModel.Seal; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(24,5-24,11); use=SealedModel.fst(24,5-24,11)
(forall ((@x0 Term))
 (! (= 104
(Term_constr_id (SealedModel.sealed @x0)))
 

:pattern ((SealedModel.sealed @x0))
:qid constructor_distinct_SealedModel.sealed))

:named constructor_distinct_SealedModel.sealed))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SealedModel.sealed; Namespace SealedModel; Name SealedModel.Seal; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(25,4-25,8); use=SealedModel.fst(25,4-25,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 119
(Term_constr_id (SealedModel.Seal @x0
@x1)))
 

:pattern ((SealedModel.Seal @x0
@x1))
:qid constructor_distinct_SealedModel.Seal))

:named constructor_distinct_SealedModel.Seal))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;; def=SealedModel.fst(25,4-25,8); use=SealedModel.fst(25,4-25,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (is-SealedModel.Seal (SealedModel.Seal @x0
@x1))
(= (SealedModel.Seal @x0
@x1)
(SealedModel.Seal@base @x1)))
 

:pattern ((SealedModel.Seal @x0
@x1))
:qid constructor_base_SealedModel.Seal))

:named constructor_base_SealedModel.Seal))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name SealedModel.sealed; Namespace SealedModel; Name SealedModel.Seal; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(24,5-24,11); use=SealedModel.fst(24,5-24,11)
...
@x0
(SealedModel.sealed @x2))
(= (Term_constr_id (SealedModel.sealed @x2))
...
@x0
(SealedModel.sealed @x2)))
:qid SealedModel_pretyping_da27fdcab046fe0ec4e2c340fa284e6b))

:named SealedModel_pretyping_da27fdcab046fe0ec4e2c340fa284e6b))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
; Starting query at SealedModel.fst(37,62-40,17)
...
; Encoding query formula : forall (a: Type) (x: SealedModel.sealed a) (y: SealedModel.sealed a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). x == y ==> p pure_result) ==>
;     (forall (b: (_: Prims.unit -> FStar.Tactics.Effect.TacS a)).
;         x == SealedModel.Seal b ==>
;         (forall (b: (_: Prims.unit -> FStar.Tactics.Effect.TacS a)).
;             y == SealedModel.Seal b ==> (forall (pure_result: Prims.unit). b == b ==> p pure_result)
;         ))


; Context: While encoding a query
; While typechecking the top-level declaration `let sealed_singl`
...
;; def=Prims.fst(441,36-441,97); use=SealedModel.fst(37,62-40,17)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=SealedModel.fst(37,52-37,60); use=SealedModel.fst(37,62-40,17)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=SealedModel.fst(37,62-40,17)
(Valid 
;; def=Prims.fst(441,83-441,96); use=SealedModel.fst(37,62-40,17)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(413,99-413,120); use=SealedModel.fst(37,62-40,17)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Non_total_Tm_arrow_458669198803b86e531731a2e81cc575 @x0))

;; def=SealedModel.fst(38,6-38,12); use=SealedModel.fst(38,6-38,12)
(= @x1
(SealedModel.Seal @x0
@x4))
)
...
;; def=SealedModel.fst(39,6-39,12); use=SealedModel.fst(39,6-39,12)
(= @x2
(SealedModel.Seal @x0
@x5))
)

;; def=Prims.fst(441,36-441,97); use=SealedModel.fst(40,2-40,13)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=SealedModel.fst(35,61-35,69); use=SealedModel.fst(40,2-40,13)
(= @x4
@x5)
)

;; def=Prims.fst(441,83-441,96); use=SealedModel.fst(40,2-40,13)
(Valid 
;; def=Prims.fst(441,83-441,96); use=SealedModel.fst(40,2-40,13)
(ApplyTT @x3
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SealedModel.sealed_singl, 1)
; STATUS: unsat
...
; encoding sigelt let sealed_singl


; <Start encoding let sealed_singl>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SealedModel.sealed_singl (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SealedModel.sealed_singl@tok () Term)

; </end encoding let sealed_singl>


; encoding sigelt val SealedModel.seal


; <Skipped val SealedModel.seal/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Stubs.Tactics.Result.uu___is_Success; Namespace FStar.Stubs.Tactics.Result
(assert (! 
...
(HasType @x1
(FStar.Stubs.Tactics.Result.__result @x0)))
(HasType (FStar.Stubs.Tactics.Result.uu___is_Success @x0
@x1)
Prims.bool))
 

:pattern ((FStar.Stubs.Tactics.Result.uu___is_Success @x0
@x1))
:qid typing_FStar.Stubs.Tactics.Result.uu___is_Success))

:named typing_FStar.Stubs.Tactics.Result.uu___is_Success))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_79c32bf125dc2af78993da96357547a4
;;; Fact-ids: Name FStar.Tactics.Effect.tac_wp_t0; Namespace FStar.Tactics.Effect
(assert (! 
;; def=FStar.Tactics.Effect.fsti(28,17-28,36); use=FStar.Tactics.Effect.fsti(28,17-28,36)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_79c32bf125dc2af78993da96357547a4 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_79c32bf125dc2af78993da96357547a4 @x0)
Tm_type))
:qid kinding_Tm_arrow_79c32bf125dc2af78993da96357547a4))

:named kinding_Tm_arrow_79c32bf125dc2af78993da96357547a4))
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
...
;; def=FStar.Stubs.Tactics.Result.fsti(25,6-25,13); use=FStar.Stubs.Tactics.Result.fsti(25,6-25,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.Stubs.Tactics.Result.uu___is_Success @x0
@x1)
(BoxBool (is-FStar.Stubs.Tactics.Result.Success @x1)))
 

:pattern ((FStar.Stubs.Tactics.Result.uu___is_Success @x0
@x1))
:qid disc_equation_FStar.Stubs.Tactics.Result.Success))

:named disc_equation_FStar.Stubs.Tactics.Result.Success))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name FStar.Stubs.Tactics.Common.uu___is_TacticFailure; Namespace FStar.Stubs.Tactics.Common
(assert (! 
;; def=FStar.Stubs.Tactics.Common.fsti(12,10-12,23); use=FStar.Stubs.Tactics.Common.fsti(12,10-12,23)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_79c32bf125dc2af78993da96357547a4 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_79c32bf125dc2af78993da96357547a4 @x2)))
:qid FStar.Tactics.Effect_pre_typing_Tm_arrow_79c32bf125dc2af78993da96357547a4))

:named FStar.Tactics.Effect_pre_typing_Tm_arrow_79c32bf125dc2af78993da96357547a4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_79c32bf125dc2af78993da96357547a4
;;; Fact-ids: Name FStar.Tactics.Effect.tac_wp_t0; Namespace FStar.Tactics.Effect
(assert (! 
;; def=FStar.Tactics.Effect.fsti(28,17-28,36); use=FStar.Tactics.Effect.fsti(28,17-28,36)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_79c32bf125dc2af78993da96357547a4 @x1))
(and 
;; def=FStar.Tactics.Effect.fsti(28,17-28,36); use=FStar.Tactics.Effect.fsti(28,17-28,36)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.Tactics.Effect_interpretation_Tm_arrow_79c32bf125dc2af78993da96357547a4.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_79c32bf125dc2af78993da96357547a4 @x1)))
:qid FStar.Tactics.Effect_interpretation_Tm_arrow_79c32bf125dc2af78993da96357547a4))

:named FStar.Tactics.Effect_interpretation_Tm_arrow_79c32bf125dc2af78993da96357547a4))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name FStar.Stubs.Tactics.Types.proofstate; Namespace FStar.Stubs.Tactics.Types
(assert (! 
...
; Starting query at SealedModel.fst(43,2-43,20)
...
;       (p: (_: FStar.Stubs.Tactics.Result.__result a -> Type0)).
;       (forall (r: FStar.Stubs.Tactics.Result.__result a). Success? r ==> p r) ==>
;       (forall (return_val: a).
;           return_val == x ==> p (FStar.Stubs.Tactics.Result.Success return_val ps))


; Context: While encoding a query
; While typechecking the top-level declaration `let seal`
...
;; def=dummy(0,0-0,0); use=SealedModel.fst(43,2-43,20)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=FStar.Tactics.Effect.fsti(129,19-129,55); use=SealedModel.fst(43,18-43,19)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
FStar.Stubs.Tactics.Types.proofstate)
(HasType @x4
(Tm_arrow_79c32bf125dc2af78993da96357547a4 @x0))

;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(43,18-43,19)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Stubs.Tactics.Result.__result @x0))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(43,18-43,19)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success @x0
@x5))
)

;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(43,18-43,19)
(Valid 
;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(43,18-43,19)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(356,2-356,58); use=SealedModel.fst(43,2-43,20)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
@x0)

;; def=Prims.fst(356,26-356,41); use=SealedModel.fst(43,2-43,20)
(= @x5
@x1)
)

;; def=FStar.Tactics.Effect.fsti(173,27-173,43); use=SealedModel.fst(43,18-43,19)
(or label_1

;; def=FStar.Tactics.Effect.fsti(173,27-173,43); use=SealedModel.fst(43,2-43,20)
(Valid 
;; def=FStar.Tactics.Effect.fsti(173,27-173,43); use=SealedModel.fst(43,2-43,20)
(ApplyTT @x4
(FStar.Stubs.Tactics.Result.Success @x0
@x5
@x3))
)
)
...
(declare-fun SealedModel.seal (Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> sealed a
(declare-fun Tm_arrow_6c0f868019cd28e0636b2749464e339c () Term)
(declare-fun SealedModel.seal@tok () Term)
;;;;;;;;;;;;;;;;Imprecise function encoding
(declare-fun Tm_abs_SealedModel_171 (Term Term) Term)

; </end encoding let seal>


; encoding sigelt val SealedModel.unseal


; <Skipped val SealedModel.unseal/>

(push) ;; push{2

; Starting query at SealedModel.fst(45,53-47,6)
...
; Encoding query formula : forall (a: Type) (s: SealedModel.sealed a).
;   (*  - Could not prove post-condition
; *)
;   forall (ps: FStar.Stubs.Tactics.Types.proofstate)
;     (p: (_: FStar.Stubs.Tactics.Result.__result a -> Type0)).
;     (forall (r: FStar.Stubs.Tactics.Result.__result a). Success? r ==> p r) ==>
;     (forall (k: (_: FStar.Stubs.Tactics.Result.__result a -> Type0)).
;         (forall (r: FStar.Stubs.Tactics.Result.__result a). {:pattern Prims.guard_free (k r)}
;             p r ==> k r) ==>
;         (forall (x: (_: Prims.unit -> FStar.Tactics.Effect.TacS a))
;             (k: (_: FStar.Stubs.Tactics.Result.__result a -> Type0)).
;             (forall (r: FStar.Stubs.Tactics.Result.__result a). {:pattern Prims.guard_free (k r)}
;                 k r ==> k r) ==>
;             s == SealedModel.Seal x ==>
;             (forall (r: FStar.Stubs.Tactics.Result.__result a). Success? r ==> k r)))


; Context: While encoding a query
; While typechecking the top-level declaration `let unseal`
...
;; def=FStar.Tactics.Effect.fsti(129,19-129,55); use=SealedModel.fst(45,53-47,6)
...
;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(45,53-47,6)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Stubs.Tactics.Result.__result @x0))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(45,53-47,6)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success @x0
@x4))
)

;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(45,53-47,6)
(Valid 
;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(45,53-47,6)
(ApplyTT @x3
@x4)
...
;; def=FStar.Tactics.Effect.fsti(61,2-61,114); use=SealedModel.fst(45,53-47,6)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Tm_arrow_79c32bf125dc2af78993da96357547a4 @x0))
...
(forall ((@x5 Term))
 (! (implies 
;; def=FStar.Tactics.Effect.fsti(61,87-61,93); use=SealedModel.fst(45,53-47,6)
(or label_1
...
;; def=FStar.Tactics.Effect.fsti(61,98-61,101); use=SealedModel.fst(45,53-47,6)
(Valid 
;; def=FStar.Tactics.Effect.fsti(61,98-61,101); use=SealedModel.fst(45,53-47,6)
(ApplyTT @x4
@x5)
...
;; def=FStar.Tactics.Effect.fsti(137,29-137,57); use=SealedModel.fst(45,53-47,6)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Non_total_Tm_arrow_458669198803b86e531731a2e81cc575 @x0))
...
;; def=SealedModel.fst(46,6-46,12); use=SealedModel.fst(46,6-46,12)
(= @x1
(SealedModel.Seal @x0
@x5))
)

;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(47,2-47,3)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.Stubs.Tactics.Result.__result @x0))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(47,2-47,3)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success @x0
@x7))
)

;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(47,2-47,3)
(Valid 
;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(47,2-47,3)
(ApplyTT @x6
@x7)
...
; encoding sigelt let unseal


; <Start encoding let unseal>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SealedModel.unseal (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SealedModel.unseal@tok () Term)

; </end encoding let unseal>


; encoding sigelt val SealedModel.map_seal


; <Skipped val SealedModel.map_seal/>

(push) ;; push{2

; Starting query at SealedModel.fst(58,2-58,31)

(declare-fun label_1 () Bool)
(declare-fun Non_total_Tm_arrow_0deea676dba88a79700a3a66fdf77e16 (Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=SealedModel.fst(53,4-53,21); use=SealedModel.fst(55,7-55,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (Non_total_Tm_arrow_0deea676dba88a79700a3a66fdf77e16 @x0
@x1)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_0deea676dba88a79700a3a66fdf77e16 @x0
@x1)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_0deea676dba88a79700a3a66fdf77e16))

:named non_total_function_typing_Non_total_Tm_arrow_0deea676dba88a79700a3a66fdf77e16))



; Encoding query formula : forall (a: Type) (b: Type) (s: SealedModel.sealed a) (f: (_: a -> FStar.Tactics.Effect.TacS b)).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.unit).
;     (*  - Could not prove post-condition
; *)
;     forall (ps: FStar.Stubs.Tactics.Types.proofstate)
;       (p: (_: FStar.Stubs.Tactics.Result.__result b -> Type0)).
;       (forall (r: FStar.Stubs.Tactics.Result.__result b). Success? r ==> p r) ==>
;       (forall (k: (_: FStar.Stubs.Tactics.Result.__result b -> Type0)).
;           (forall (r: FStar.Stubs.Tactics.Result.__result b). {:pattern Prims.guard_free (k r)}
;               p r ==> k r) ==>
;           (forall (r: FStar.Stubs.Tactics.Result.__result a).
;               Success? r ==>
;               (match r with
;                 | FStar.Stubs.Tactics.Result.Success _ _ ->
;                   forall (r: FStar.Stubs.Tactics.Result.__result b). Success? r ==> k r
;                 | FStar.Stubs.Tactics.Result.Failed ex ps ->
;                   k (FStar.Stubs.Tactics.Result.Failed ex ps))))


; Context: While encoding a query
; While typechecking the top-level declaration `let map_seal`
...
(SealedModel.sealed @x0))
(HasType @x3
(Non_total_Tm_arrow_0deea676dba88a79700a3a66fdf77e16 @x0
@x1)))

;; def=dummy(0,0-0,0); use=SealedModel.fst(58,2-58,31)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.unit)

;; def=FStar.Tactics.Effect.fsti(129,19-129,55); use=SealedModel.fst(58,18-58,30)
...
;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(58,18-58,30)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.Stubs.Tactics.Result.__result @x1))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(58,18-58,30)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success @x1
@x7))
)

;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(58,18-58,30)
(Valid 
;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(58,18-58,30)
(ApplyTT @x6
@x7)
...
;; def=FStar.Tactics.Effect.fsti(61,2-61,114); use=SealedModel.fst(58,18-58,30)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Tm_arrow_79c32bf125dc2af78993da96357547a4 @x1))
...
(forall ((@x8 Term))
 (! (implies 
;; def=FStar.Tactics.Effect.fsti(61,87-61,93); use=SealedModel.fst(58,18-58,30)
(or label_1
...
;; def=FStar.Tactics.Effect.fsti(61,98-61,101); use=SealedModel.fst(58,18-58,30)
(Valid 
;; def=FStar.Tactics.Effect.fsti(61,98-61,101); use=SealedModel.fst(58,18-58,30)
(ApplyTT @x7
@x8)
...
;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(58,21-58,27)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(FStar.Stubs.Tactics.Result.__result @x0))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(58,21-58,27)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success @x0
@x8))
)
(let ((@lb9 @x8))
(ite (is-FStar.Stubs.Tactics.Result.Success @lb9)

;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(58,18-58,19)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(FStar.Stubs.Tactics.Result.__result @x1))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(58,18-58,19)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success @x1
@x10))
)

;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(58,18-58,19)
(Valid 
;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(58,18-58,19)
(ApplyTT @x7
@x10)
...
(ite (is-FStar.Stubs.Tactics.Result.Failed @lb9)

;; def=FStar.Tactics.Effect.fsti(54,29-54,48); use=SealedModel.fst(58,18-58,30)
(Valid 
;; def=FStar.Tactics.Effect.fsti(54,29-54,48); use=SealedModel.fst(58,18-58,30)
(ApplyTT @x7
(FStar.Stubs.Tactics.Result.Failed @x1
(FStar.Stubs.Tactics.Result.Failed_exn @lb9)
(FStar.Stubs.Tactics.Result.Failed_ps @lb9)))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SealedModel.map_seal, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, disc_equation_FStar.Stubs.Tactics.Result.Success, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let map_seal


; <Start encoding let map_seal>

(declare-fun Non_total_Tm_arrow_0deea676dba88a79700a3a66fdf77e16 (Term Term) Term)
(declare-fun SealedModel.map_seal (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;b: Type -> s: sealed a -> f: (_: a -> FStar.Tactics.Effect.TacS b) -> sealed b
(declare-fun Tm_arrow_027f55a946a2a4206fdd5b37e2c8c133 () Term)
(declare-fun SealedModel.map_seal@tok () Term)

;;;;;;;;;;;;;;;;Imprecise function encoding
(declare-fun Tm_abs_SealedModel_224 (Term Term Term Term) Term)

; </end encoding let map_seal>


; encoding sigelt val SealedModel.bind_seal


; <Skipped val SealedModel.bind_seal/>

(push) ;; push{2

; Starting query at SealedModel.fst(66,2-66,40)

(declare-fun label_1 () Bool)
(declare-fun Non_total_Tm_arrow_2d2f598e8b31b85ebe9e4406d6b48062 (Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=SealedModel.fst(61,4-63,27); use=SealedModel.fst(63,7-63,27)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (Non_total_Tm_arrow_2d2f598e8b31b85ebe9e4406d6b48062 @x0
@x1)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_2d2f598e8b31b85ebe9e4406d6b48062 @x0
@x1)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_2d2f598e8b31b85ebe9e4406d6b48062))

:named non_total_function_typing_Non_total_Tm_arrow_2d2f598e8b31b85ebe9e4406d6b48062))


;;;;;;;;;;;;;;;;_: FStar.Stubs.Tactics.Result.__result (sealed b) -> Type
(declare-fun Tm_arrow_222a6416287de325e6c6d1521078e24c (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_222a6416287de325e6c6d1521078e24c
;;; Fact-ids: 
(assert (! 
;; def=FStar.Tactics.Effect.fsti(61,12-61,31); use=SealedModel.fst(66,18-66,39)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_222a6416287de325e6c6d1521078e24c @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_222a6416287de325e6c6d1521078e24c @x0)
Tm_type))
:qid kinding_Tm_arrow_222a6416287de325e6c6d1521078e24c))

:named kinding_Tm_arrow_222a6416287de325e6c6d1521078e24c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Tactics.Effect.fsti(61,12-61,31); use=SealedModel.fst(66,18-66,39)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_222a6416287de325e6c6d1521078e24c @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_222a6416287de325e6c6d1521078e24c @x2)))
:qid SealedModel_pre_typing_Tm_arrow_222a6416287de325e6c6d1521078e24c))

:named SealedModel_pre_typing_Tm_arrow_222a6416287de325e6c6d1521078e24c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_222a6416287de325e6c6d1521078e24c
;;; Fact-ids: 
(assert (! 
;; def=FStar.Tactics.Effect.fsti(61,12-61,31); use=SealedModel.fst(66,18-66,39)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_222a6416287de325e6c6d1521078e24c @x1))
(and 
;; def=FStar.Tactics.Effect.fsti(61,12-61,31); use=SealedModel.fst(66,18-66,39)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.Stubs.Tactics.Result.__result (SealedModel.sealed @x1)))
(HasType (ApplyTT @x0
@x2)
Tm_type))
...
:pattern ((ApplyTT @x0
@x2))
:qid SealedModel_interpretation_Tm_arrow_222a6416287de325e6c6d1521078e24c.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_222a6416287de325e6c6d1521078e24c @x1)))
:qid SealedModel_interpretation_Tm_arrow_222a6416287de325e6c6d1521078e24c))

:named SealedModel_interpretation_Tm_arrow_222a6416287de325e6c6d1521078e24c))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (s: SealedModel.sealed a)
;   (f: (_: a -> FStar.Tactics.Effect.TacS (SealedModel.sealed b))).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.unit).
;     (*  - Could not prove post-condition
...
;           (forall (r: FStar.Stubs.Tactics.Result.__result b). {:pattern Prims.guard_free (k r)}
;               p r ==> k r) ==>
;           (forall (k: (_: FStar.Stubs.Tactics.Result.__result (SealedModel.sealed b) -> Type0)).
;               (forall (r: FStar.Stubs.Tactics.Result.__result (SealedModel.sealed b)).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let bind_seal`
...
(SealedModel.sealed @x0))
(HasType @x3
(Non_total_Tm_arrow_2d2f598e8b31b85ebe9e4406d6b48062 @x0
@x1)))

;; def=dummy(0,0-0,0); use=SealedModel.fst(66,2-66,40)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.unit)

;; def=FStar.Tactics.Effect.fsti(129,19-129,55); use=SealedModel.fst(66,18-66,39)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
FStar.Stubs.Tactics.Types.proofstate)
(HasType @x6
...
;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(66,18-66,39)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.Stubs.Tactics.Result.__result @x1))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(66,18-66,39)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success @x1
@x7))
)

;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(66,18-66,39)
(Valid 
;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(66,18-66,39)
(ApplyTT @x6
@x7)
...
;; def=FStar.Tactics.Effect.fsti(61,2-61,114); use=SealedModel.fst(66,18-66,39)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Tm_arrow_79c32bf125dc2af78993da96357547a4 @x1))
...
(forall ((@x8 Term))
 (! (implies 
;; def=FStar.Tactics.Effect.fsti(61,87-61,93); use=SealedModel.fst(66,18-66,39)
(or label_1
...
;; def=FStar.Tactics.Effect.fsti(61,98-61,101); use=SealedModel.fst(66,18-66,39)
(Valid 
;; def=FStar.Tactics.Effect.fsti(61,98-61,101); use=SealedModel.fst(66,18-66,39)
(ApplyTT @x7
@x8)
...
(forall ((@x9 Term))
 (! (implies (let ((@lb10 @x9))
(ite (is-FStar.Stubs.Tactics.Result.Success @lb10)

;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(66,18-66,24)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
(FStar.Stubs.Tactics.Result.__result @x1))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(66,18-66,24)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success @x1
@x11))
)

;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(66,18-66,24)
(Valid 
;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(66,18-66,24)
(ApplyTT @x7
@x11)
...
(ite (is-FStar.Stubs.Tactics.Result.Failed @lb10)

;; def=FStar.Tactics.Effect.fsti(54,29-54,48); use=SealedModel.fst(66,18-66,39)
(Valid 
;; def=FStar.Tactics.Effect.fsti(54,29-54,48); use=SealedModel.fst(66,18-66,39)
(ApplyTT @x7
(FStar.Stubs.Tactics.Result.Failed @x1
(FStar.Stubs.Tactics.Result.Failed_exn @lb10)
(FStar.Stubs.Tactics.Result.Failed_ps @lb10)))
)
...
;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(66,29-66,35)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(FStar.Stubs.Tactics.Result.__result @x0))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(66,29-66,35)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success @x0
@x9))
)
(let ((@lb10 @x9))
...
;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(66,26-66,27)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
(FStar.Stubs.Tactics.Result.__result (SealedModel.sealed @x1)))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(66,26-66,27)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success (SealedModel.sealed @x1)
@x11))
)

;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(66,26-66,27)
(Valid 
;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(66,26-66,27)
(ApplyTT @x8
@x11)
...
;; def=FStar.Tactics.Effect.fsti(54,29-54,48); use=SealedModel.fst(66,18-66,39)
(ApplyTT @x8
(FStar.Stubs.Tactics.Result.Failed (SealedModel.sealed @x1)
(FStar.Stubs.Tactics.Result.Failed_exn @lb10)
(FStar.Stubs.Tactics.Result.Failed_ps @lb10)))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SealedModel.bind_seal, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, disc_equation_FStar.Stubs.Tactics.Result.Success, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let bind_seal


; <Start encoding let bind_seal>

(declare-fun Non_total_Tm_arrow_2d2f598e8b31b85ebe9e4406d6b48062 (Term Term) Term)
(declare-fun SealedModel.bind_seal (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;b: Type -> s: sealed a -> f: (_: a -> FStar.Tactics.Effect.TacS (sealed b)) -> sealed b
(declare-fun Tm_arrow_b4bcd55a941f410978da2ca212167f76 () Term)
(declare-fun SealedModel.bind_seal@tok () Term)

;;;;;;;;;;;;;;;;Imprecise function encoding
(declare-fun Tm_abs_SealedModel_265 (Term Term Term Term) Term)

; </end encoding let bind_seal>


; encoding sigelt type SealedModel.t


; <Start encoding type SealedModel.t>

;;;;;;;;;;;;;;;;Constructor
(declare-fun SealedModel.t () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SealedModel.X (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun SealedModel.X__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: SealedModel.X
(declare-fun SealedModel.X@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun SealedModel.Y () Term)
;;;;;;;;;;;;;;;;data constructor proxy: SealedModel.Y
(declare-fun SealedModel.Y@tok () Term)
;;;;;;;;;;;;;;;;_0: sealed t -> t
(declare-fun Tm_arrow_5bbdee5e147e87c92190c3a5284ca00b () Term)

; <start constructor SealedModel.t>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SealedModel.t ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
266)
(= __@x0
SealedModel.t)))

; </end constructor SealedModel.t>


; <start constructor SealedModel.X>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SealedModel.X ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
272)
(= __@x0
(SealedModel.X (SealedModel.X__0 __@x0)))))

; </end constructor SealedModel.X>


; <start constructor SealedModel.Y>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-SealedModel.Y ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
277)
(= __@x0
SealedModel.Y)))

; </end constructor SealedModel.Y>


; </end encoding type SealedModel.t>


; encoding sigelt val SealedModel.uu___is_X


; <Start encoding val SealedModel.uu___is_X>

(declare-fun SealedModel.uu___is_X (Term) Term)
;;;;;;;;;;;;;;;;projectee: t -> Prims.bool
(declare-fun Tm_arrow_f4a5831fa83de90bea24d0bdff233bb8 () Term)
(declare-fun SealedModel.uu___is_X@tok () Term)

; </end encoding val SealedModel.uu___is_X>
...
; encoding sigelt val SealedModel.__proj__X__item___0


; <Start encoding val SealedModel.__proj__X__item___0>

(declare-fun Tm_refine_783aa278341fef507c697eec496b82d6 () Term)
(declare-fun SealedModel.__proj__X__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: t{X? _} -> sealed t
(declare-fun Tm_arrow_944c4759e83eb1f3b84ea6e47c1e09a9 () Term)
(declare-fun SealedModel.__proj__X__item___0@tok () Term)

; </end encoding val SealedModel.__proj__X__item___0>

;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! (HasType SealedModel.Y@tok
SealedModel.t)
:named typing_tok_SealedModel.Y@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SealedModel.uu___is_X; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(76,4-76,5); use=SealedModel.fst(76,4-76,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SealedModel.t)
(HasType (SealedModel.uu___is_X @x0)
Prims.bool))
 

:pattern ((SealedModel.uu___is_X @x0))
:qid typing_SealedModel.uu___is_X))

:named typing_SealedModel.uu___is_X))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(76,4-76,5); use=SealedModel.fst(76,4-76,5)
...
(SealedModel.X @x1)
SealedModel.t))
:qid subterm_ordering_SealedModel.X))

:named subterm_ordering_SealedModel.X))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name SealedModel.__proj__X__item___0; Namespace SealedModel
(assert (! (HasType Tm_refine_783aa278341fef507c697eec496b82d6
Tm_type)
:named refinement_kinding_Tm_refine_783aa278341fef507c697eec496b82d6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name SealedModel.__proj__X__item___0; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(76,4-76,5); use=SealedModel.fst(76,4-76,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_783aa278341fef507c697eec496b82d6)
(and (HasTypeFuel @u0
@x1
SealedModel.t)

;; def=SealedModel.fst(76,4-76,5); use=SealedModel.fst(76,4-76,5)
(BoxBool_proj_0 (SealedModel.uu___is_X @x1))
))
...
@x1
Tm_refine_783aa278341fef507c697eec496b82d6))
:qid refinement_interpretation_Tm_refine_783aa278341fef507c697eec496b82d6))

:named refinement_interpretation_Tm_refine_783aa278341fef507c697eec496b82d6))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(76,4-76,5); use=SealedModel.fst(76,4-76,5)
(forall ((@x0 Term))
 (! (= (SealedModel.X__0 (SealedModel.X @x0))
@x0)
 

:pattern ((SealedModel.X @x0))
:qid projection_inverse_SealedModel.X__0))

:named projection_inverse_SealedModel.X__0))
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! (HasType SealedModel.t
Tm_type)
:named kinding_SealedModel.t@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_783aa278341fef507c697eec496b82d6
;;; Fact-ids: Name SealedModel.__proj__X__item___0; Namespace SealedModel
(assert (! (iff (Valid (Prims.hasEq Tm_refine_783aa278341fef507c697eec496b82d6))
(Valid (Prims.hasEq SealedModel.t)))
:named haseqTm_refine_783aa278341fef507c697eec496b82d6))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(75,5-75,6); use=SealedModel.fst(75,5-75,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
SealedModel.t)
(or (is-SealedModel.X @x1)
(is-SealedModel.Y @x1)))
...
@x1
SealedModel.t))
:qid fuel_guarded_inversion_SealedModel.t))

:named fuel_guarded_inversion_SealedModel.t))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! (= SealedModel.Y@tok
SealedModel.Y)
:named equality_tok_SealedModel.Y@tok))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name SealedModel.uu___is_X; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(76,4-76,5); use=SealedModel.fst(76,4-76,5)
(forall ((@x0 Term))
 (! (= (SealedModel.uu___is_X @x0)
(BoxBool (is-SealedModel.X @x0)))
 

:pattern ((SealedModel.uu___is_X @x0))
:qid disc_equation_SealedModel.X))

:named disc_equation_SealedModel.X))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(77,4-77,5); use=SealedModel.fst(77,4-77,5)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
SealedModel.Y
SealedModel.t)
...
SealedModel.Y
SealedModel.t))
:qid data_typing_intro_SealedModel.Y@tok))

:named data_typing_intro_SealedModel.Y@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(76,4-76,5); use=SealedModel.fst(76,4-76,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
(SealedModel.sealed SealedModel.t))
(HasTypeFuel @u0
(SealedModel.X @x1)
SealedModel.t))
...
(SealedModel.X @x1)
SealedModel.t))
:qid data_typing_intro_SealedModel.X@tok))

:named data_typing_intro_SealedModel.X@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(76,4-76,5); use=SealedModel.fst(76,4-76,5)
...
(SealedModel.X @x1)
SealedModel.t))
:qid data_elim_SealedModel.X))

:named data_elim_SealedModel.X))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! (= 266
(Term_constr_id SealedModel.t))
:named constructor_distinct_SealedModel.t))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! (= 277
(Term_constr_id SealedModel.Y))
:named constructor_distinct_SealedModel.Y))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(76,4-76,5); use=SealedModel.fst(76,4-76,5)
(forall ((@x0 Term))
 (! (= 272
(Term_constr_id (SealedModel.X @x0)))
 

:pattern ((SealedModel.X @x0))
:qid constructor_distinct_SealedModel.X))

:named constructor_distinct_SealedModel.X))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name SealedModel.t; Namespace SealedModel; Name SealedModel.X; Namespace SealedModel; Name SealedModel.Y; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(75,5-75,6); use=SealedModel.fst(75,5-75,6)
...
@x0
SealedModel.t))
:qid SealedModel_pretyping_62f760e00c09d3170a3281451bb320e6))

:named SealedModel_pretyping_62f760e00c09d3170a3281451bb320e6))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: SealedModel.t{X? _}).
;   (*  - Could not prove post-condition
; *) ~(X? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__X__item___0`
...
(not 
;; def=SealedModel.fst(76,4-76,5); use=SealedModel.fst(76,4-76,5)
(BoxBool_proj_0 (SealedModel.uu___is_X @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SealedModel.__proj__X__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_783aa278341fef507c697eec496b82d6
...
; encoding sigelt let __proj__X__item___0


; <Skipped let __proj__X__item___0/>


; encoding sigelt val SealedModel.uu___is_Y


; <Start encoding val SealedModel.uu___is_Y>

(declare-fun SealedModel.uu___is_Y (Term) Term)

(declare-fun SealedModel.uu___is_Y@tok () Term)

; </end encoding val SealedModel.uu___is_Y>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SealedModel.seal; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(42,4-42,8); use=SealedModel.fst(42,4-42,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
@x0))
(HasType (SealedModel.seal @x0
@x1)
(SealedModel.sealed @x0)))
...
:pattern ((SealedModel.seal @x0
@x1))
:qid typing_SealedModel.seal))

:named typing_SealedModel.seal))
;;;;;;;;;;;;;;;;Equation for SealedModel.seal
;;; Fact-ids: Name SealedModel.seal; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(42,4-42,8); use=SealedModel.fst(42,4-42,8)
(forall ((@x0 Term) (@x1 Term))
...
@x1)
(SealedModel.Seal @x0
(Tm_abs_SealedModel_171 @x1
@x0)))
 

:pattern ((SealedModel.seal @x0
@x1))
:qid equation_SealedModel.seal))

:named equation_SealedModel.seal))
(push) ;; push{2

; Starting query at SealedModel.fst(83,2-89,3)
...
; Encoding query formula : forall (x: SealedModel.t) (_: Prims.squash (x << SealedModel.seal x)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). x == SealedModel.Y ==> p pure_result) ==>
;     (forall (k: Prims.pure_post Prims.unit).
;         (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;         (X? x == true ==>
;           (~(X? x) ==> Prims.l_False) /\
;           (forall (b: SealedModel.sealed SealedModel.t).
;               x == SealedModel.X b ==>
;               b << x /\
;               (forall (pure_result: Prims.unit).
;                   b << x ==>
;                   (forall (pure_result: Prims.unit). b == SealedModel.seal x ==> Prims.l_False)))) /\
;         (~(X? x = true) ==>
;           (forall (b: Prims.bool). X? x == b ==> (forall (any_result: Prims.unit). k any_result))))


; Context: While encoding a query
; While typechecking the top-level declaration `let prec_no_x`
...
SealedModel.t)
(HasType @x1
(Prims.squash (Prims.precedes SealedModel.t
(SealedModel.sealed SealedModel.t)
@x0
(SealedModel.seal SealedModel.t
@x0)))))
...
;; def=Prims.fst(441,36-441,97); use=SealedModel.fst(83,2-89,3)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=SealedModel.fst(82,57-82,65); use=SealedModel.fst(83,2-89,3)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=SealedModel.fst(83,2-89,3)
(Valid 
;; def=Prims.fst(441,83-441,96); use=SealedModel.fst(83,2-89,3)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(402,2-402,97); use=SealedModel.fst(83,2-89,3)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post Prims.unit))
...
(forall ((@x4 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=SealedModel.fst(83,2-89,3)
(Valid 
;; def=Prims.fst(402,73-402,79); use=SealedModel.fst(83,2-89,3)
(ApplyTT @x2
@x4)
...
;; def=Prims.fst(402,84-402,87); use=SealedModel.fst(83,2-89,3)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SealedModel.fst(83,2-89,3)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(389,2-389,39); use=SealedModel.fst(83,2-89,3)
(and (implies 
;; def=SealedModel.fst(83,5-83,9); use=SealedModel.fst(83,5-83,9)
(= (SealedModel.uu___is_X @x0)
(BoxBool true))


;; def=Prims.fst(459,77-459,89); use=SealedModel.fst(83,2-89,3)
(and (implies 
;; def=SealedModel.fst(84,8-84,11); use=SealedModel.fst(84,8-84,11)
(not 
;; def=SealedModel.fst(84,8-84,11); use=SealedModel.fst(84,8-84,11)
(BoxBool_proj_0 (SealedModel.uu___is_X @x0))
)
...
;; def=Prims.fst(413,99-413,120); use=SealedModel.fst(83,2-89,3)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(SealedModel.sealed SealedModel.t))
...
;; def=Prims.fst(441,29-441,97); use=SealedModel.fst(85,4-85,10)
(and 
;; def=SealedModel.fst(85,11-85,19); use=SealedModel.fst(85,4-85,10)
(or label_4

;; def=SealedModel.fst(85,11-85,19); use=SealedModel.fst(85,4-85,10)
(Valid 
;; def=SealedModel.fst(85,11-85,19); use=SealedModel.fst(85,4-85,10)
(Prims.precedes (SealedModel.sealed SealedModel.t)
SealedModel.t
@x4
@x0)
)
...
;; def=Prims.fst(441,36-441,97); use=SealedModel.fst(85,4-85,10)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)
...
;; def=Prims.fst(441,36-441,97); use=SealedModel.fst(86,4-86,16)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=SealedModel.fsti(44,10-44,18); use=SealedModel.fst(86,4-86,16)
(= @x4
(SealedModel.seal SealedModel.t
@x0))
)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=SealedModel.fst(83,2-89,3)
(not 
;; def=SealedModel.fst(83,5-83,9); use=SealedModel.fst(83,5-83,9)
(= (SealedModel.uu___is_X @x0)
(BoxBool true))
...
;; def=SealedModel.fst(83,2-89,3); use=SealedModel.fst(83,2-89,3)
(= (SealedModel.uu___is_X @x0)
@x4)
)

;; def=Prims.fst(451,66-451,102); use=SealedModel.fst(83,2-89,3)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=SealedModel.fst(83,2-89,3)
(Valid 
;; def=Prims.fst(451,90-451,102); use=SealedModel.fst(83,2-89,3)
(ApplyTT @x3
@x5)
...
; encoding sigelt let prec_no_x


; <Start encoding let prec_no_x>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SealedModel.prec_no_x (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SealedModel.prec_no_x@tok () Term)

; </end encoding let prec_no_x>


; encoding sigelt let tx


; <Start encoding let tx>

(declare-fun SealedModel.tx () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SealedModel.uu___is_Y; Namespace SealedModel
(assert (! 
;; def=SealedModel.fst(77,4-77,5); use=SealedModel.fst(77,4-77,5)
(forall ((@x0 Term))
 (! (implies (HasType @x0
SealedModel.t)
(HasType (SealedModel.uu___is_Y @x0)
Prims.bool))
 

:pattern ((SealedModel.uu___is_Y @x0))
:qid typing_SealedModel.uu___is_Y))

:named typing_SealedModel.uu___is_Y))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.int; Namespace Prims
...
;; def=SealedModel.fst(77,4-77,5); use=SealedModel.fst(77,4-77,5)
(forall ((@x0 Term))
 (! (= (SealedModel.uu___is_Y @x0)
(BoxBool (is-SealedModel.Y @x0)))
 

:pattern ((SealedModel.uu___is_Y @x0))
:qid disc_equation_SealedModel.Y))

:named disc_equation_SealedModel.Y))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
; Starting query at SealedModel.fst(112,20-124,14)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Non_total_Tm_arrow_499d5658cd394d4f303c7d7e5857f148 (Term Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=SealedModel.fst(108,28-110,28); use=SealedModel.fst(110,15-110,38)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
Tm_type))
(HasType (Non_total_Tm_arrow_499d5658cd394d4f303c7d7e5857f148 @x0
@x1
@x2)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_499d5658cd394d4f303c7d7e5857f148 @x0
@x1
@x2)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_499d5658cd394d4f303c7d7e5857f148))

:named non_total_function_typing_Non_total_Tm_arrow_499d5658cd394d4f303c7d7e5857f148))
;;;;;;;;;;;;;;;;s: sealed a -> _: (f: x: a{x << s} -> FStar.Tactics.Effect.TacS b) -> sealed b
(declare-fun Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de
Tm_type)
:named kinding_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=SealedModel.fst(108,16-111,24); use=SealedModel.fst(108,16-111,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de))
:qid SealedModel_pre_typing_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de))

:named SealedModel_pre_typing_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de
;;; Fact-ids: 
(assert (! 
;; def=SealedModel.fst(108,16-111,24); use=SealedModel.fst(108,16-111,24)
(forall ((@x0 Term))
...
(SealedModel.sealed @x1))
(HasType @x4
(Non_total_Tm_arrow_499d5658cd394d4f303c7d7e5857f148 @x1
@x3
@x2)))
...
@x3)
@x4))
:qid SealedModel_interpretation_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid SealedModel_interpretation_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de.2))
...
@x1)
@x2))
:qid SealedModel_interpretation_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de.3))
...
@x2)
@x3))
:qid SealedModel_interpretation_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de))
:qid SealedModel_interpretation_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de))

:named SealedModel_interpretation_Tm_arrow_3a23ba986af8fd6099fd81cdfe1661de))
(declare-fun Tm_refine_ddb39e4ca8967888ba670c6fdec9bf69 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_ddb39e4ca8967888ba670c6fdec9bf69
Tm_type)
:named refinement_kinding_Tm_refine_ddb39e4ca8967888ba670c6fdec9bf69))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=SealedModel.fst(114,8-114,21); use=SealedModel.fst(114,8-114,21)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ddb39e4ca8967888ba670c6fdec9bf69)
(and (HasTypeFuel @u0
@x1
SealedModel.t)

;; def=SealedModel.fst(114,13-114,19); use=SealedModel.fst(114,13-114,19)
(Valid 
;; def=SealedModel.fst(114,13-114,19); use=SealedModel.fst(114,13-114,19)
(Prims.precedes SealedModel.t
(SealedModel.sealed SealedModel.t)
@x1
(SealedModel.seal SealedModel.t
(SealedModel.X (SealedModel.seal SealedModel.t
SealedModel.Y@tok))))
)
))
...
@x1
Tm_refine_ddb39e4ca8967888ba670c6fdec9bf69))
:qid refinement_interpretation_Tm_refine_ddb39e4ca8967888ba670c6fdec9bf69))

:named refinement_interpretation_Tm_refine_ddb39e4ca8967888ba670c6fdec9bf69))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ddb39e4ca8967888ba670c6fdec9bf69
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ddb39e4ca8967888ba670c6fdec9bf69))
(Valid (Prims.hasEq SealedModel.t)))
:named haseqTm_refine_ddb39e4ca8967888ba670c6fdec9bf69))
;;;;;;;;;;;;;;;;_: FStar.Stubs.Tactics.Result.__result Prims.int -> Type
(declare-fun Tm_arrow_86517847498bd63e99ebc143c8ccc90f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_86517847498bd63e99ebc143c8ccc90f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_86517847498bd63e99ebc143c8ccc90f
Tm_type)
:named kinding_Tm_arrow_86517847498bd63e99ebc143c8ccc90f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Tactics.Effect.fsti(28,17-28,36); use=SealedModel.fst(115,4-121,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_86517847498bd63e99ebc143c8ccc90f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_86517847498bd63e99ebc143c8ccc90f))
:qid SealedModel_pre_typing_Tm_arrow_86517847498bd63e99ebc143c8ccc90f))

:named SealedModel_pre_typing_Tm_arrow_86517847498bd63e99ebc143c8ccc90f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_86517847498bd63e99ebc143c8ccc90f
;;; Fact-ids: 
(assert (! 
;; def=FStar.Tactics.Effect.fsti(28,17-28,36); use=SealedModel.fst(115,4-121,9)
(forall ((@x0 Term))
...
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.Stubs.Tactics.Result.__result Prims.int))
(HasType (ApplyTT @x0
@x1)
Tm_type))
...
:pattern ((ApplyTT @x0
@x1))
:qid SealedModel_interpretation_Tm_arrow_86517847498bd63e99ebc143c8ccc90f.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_86517847498bd63e99ebc143c8ccc90f))
:qid SealedModel_interpretation_Tm_arrow_86517847498bd63e99ebc143c8ccc90f))

:named SealedModel_interpretation_Tm_arrow_86517847498bd63e99ebc143c8ccc90f))

; Encoding query formula : forall (map_seal:
;   (s: SealedModel.sealed a -> _: (f: x: a{x << s} -> FStar.Tactics.Effect.TacS b)
;       -> SealedModel.sealed b)).
;   (*  - Could not prove post-condition
; *)
;   forall (x: SealedModel.t{x << SealedModel.seal (SealedModel.X (SealedModel.seal SealedModel.Y))}).
;     (*  - Could not prove post-condition
; *)
;     forall (ps: FStar.Stubs.Tactics.Types.proofstate)
;       (p: (_: FStar.Stubs.Tactics.Result.__result Prims.int -> Type0)).
;       (forall (r: FStar.Stubs.Tactics.Result.__result Prims.int). Success? r ==> p r) ==>
;       (forall (k: Prims.pure_post Prims.int).
;           (forall (x: Prims.int). {:pattern Prims.guard_free (k x)}
;               (x ==
;                 (match x with
;                   | SealedModel.X _ -> FStar.Pervasives.false_elim ()
;                   | SealedModel.Y -> 123) ==>
;                 (forall (return_val: Prims.int).
;                     return_val == x ==> p (FStar.Stubs.Tactics.Result.Success return_val ps))) ==>
;               k x) ==>
;           (~(X? x) /\ ~(Y? x) ==> Prims.l_False) /\
;           (forall (b: SealedModel.sealed SealedModel.t).
;               x == SealedModel.X b ==>
;               (forall (pure_result: Prims.unit).
;                   SealedModel.seal (SealedModel.X (SealedModel.seal SealedModel.Y)) ==
;                   SealedModel.seal x ==>
;                   x << SealedModel.seal x /\
;                   (forall (any_result: Prims.unit) (pure_result: Prims.unit).
;                       x == SealedModel.Y ==> Prims.l_False))) /\
;           (~(X? x) ==> x == SealedModel.Y ==> (forall (any_result: Prims.int). k any_result)))


; Context: While encoding a query
; While typechecking the top-level declaration `let contra_map_seal_precedes`
...
;; def=dummy(0,0-0,0); use=SealedModel.fst(112,20-124,14)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Tm_refine_ddb39e4ca8967888ba670c6fdec9bf69)

;; def=FStar.Tactics.Effect.fsti(129,19-129,55); use=SealedModel.fst(115,4-121,9)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
FStar.Stubs.Tactics.Types.proofstate)
(HasType @x3
...
;; def=FStar.Tactics.Effect.fsti(159,37-159,70); use=SealedModel.fst(115,4-121,9)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Stubs.Tactics.Result.__result Prims.int))

;; def=FStar.Tactics.Effect.fsti(165,80-165,90); use=SealedModel.fst(115,4-121,9)
(BoxBool_proj_0 (FStar.Stubs.Tactics.Result.uu___is_Success Prims.int
@x4))
)

;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(115,4-121,9)
(Valid 
;; def=FStar.Tactics.Effect.fsti(159,62-159,69); use=SealedModel.fst(115,4-121,9)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(402,2-402,97); use=SealedModel.fst(115,4-121,9)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
...
(forall ((@x5 Term))
 (! (implies (implies 
;; def=SealedModel.fst(114,29-121,9); use=SealedModel.fst(115,4-121,9)
(= @x5
(let ((@lb6 @x1))
(ite (is-SealedModel.X @lb6)
(FStar.Pervasives.false_elim Prims.int
Tm_unit)
(ite (is-SealedModel.Y @lb6)
(BoxInt 123)
Tm_unit))))


;; def=Prims.fst(356,2-356,58); use=SealedModel.fst(112,20-124,14)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.int)

;; def=Prims.fst(356,26-356,41); use=SealedModel.fst(112,20-124,14)
(= @x6
@x5)
)

;; def=FStar.Tactics.Effect.fsti(173,27-173,43); use=SealedModel.fst(112,20-124,14)
(or label_1
...
;; def=FStar.Tactics.Effect.fsti(173,27-173,43); use=SealedModel.fst(112,20-124,14)
(ApplyTT @x3
(FStar.Stubs.Tactics.Result.Success Prims.int
@x6
@x2))
)
)
...
;; def=Prims.fst(402,84-402,87); use=SealedModel.fst(115,4-121,9)
(Valid 
;; def=Prims.fst(402,84-402,87); use=SealedModel.fst(115,4-121,9)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=SealedModel.fst(115,4-121,9)
(and (implies 
;; def=SealedModel.fst(114,9-114,10); use=SealedModel.fst(115,10-115,11)
(and 
;; def=SealedModel.fst(114,9-114,10); use=SealedModel.fst(115,10-115,11)
(not 
;; def=SealedModel.fst(114,9-114,10); use=SealedModel.fst(115,10-115,11)
...
(not 
;; def=SealedModel.fst(114,9-114,10); use=SealedModel.fst(115,10-115,11)
(BoxBool_proj_0 (SealedModel.uu___is_Y @x1))
)
)

label_2)

;; def=Prims.fst(413,99-413,120); use=SealedModel.fst(115,4-121,9)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(SealedModel.sealed SealedModel.t))

;; def=SealedModel.fst(114,9-116,10); use=SealedModel.fst(115,10-116,10)
(= @x1
(SealedModel.X @x5))
)

;; def=Prims.fst(441,36-441,97); use=SealedModel.fst(117,6-117,18)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=SealedModel.fsti(44,10-44,18); use=SealedModel.fst(117,6-117,18)
(= (SealedModel.seal SealedModel.t
(SealedModel.X (SealedModel.seal SealedModel.t
SealedModel.Y@tok)))
(SealedModel.seal SealedModel.t
...
;; def=Prims.fst(459,77-459,89); use=SealedModel.fst(115,4-121,9)
(and 
;; def=SealedModel.fst(82,34-82,47); use=SealedModel.fst(118,18-118,20)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=SealedModel.fst(115,4-121,9)
(forall ((@x7 Term))
 (! (implies (HasType @x7
Prims.unit)

;; def=Prims.fst(441,36-441,97); use=SealedModel.fst(118,6-118,15)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=SealedModel.fst(82,57-82,65); use=SealedModel.fst(118,6-118,15)
(= @x1
SealedModel.Y@tok)
)
label_4)
...
(implies 
;; def=Prims.fst(389,18-389,39); use=SealedModel.fst(115,4-121,9)
(and 
;; def=Prims.fst(389,19-389,21); use=SealedModel.fst(115,4-121,9)
(not 
;; def=SealedModel.fst(114,9-114,10); use=SealedModel.fst(115,10-115,11)
(BoxBool_proj_0 (SealedModel.uu___is_X @x1))
)
...
;; def=SealedModel.fst(114,9-120,7); use=SealedModel.fst(115,10-120,7)
(= @x1
SealedModel.Y@tok)
)
...
;; def=Prims.fst(451,90-451,102); use=SealedModel.fst(115,4-121,9)
(Valid 
;; def=Prims.fst(451,90-451,102); use=SealedModel.fst(115,4-121,9)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SealedModel.contra_map_seal_precedes, 1)
; STATUS: unsat
