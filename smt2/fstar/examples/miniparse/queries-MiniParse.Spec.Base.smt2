...
; Internals for MiniParse.Spec.Base
...
; encoding sigelt let consumed_length
...
; encoding sigelt let bare_parser
...
; Starting query at MiniParse.Spec.Base.fst(57,2-65,5)
...
; *)
;   Some? (MiniParse.Spec.Base.bparse f x) ==>
;   (forall (any_result: FStar.Pervasives.Native.option (t & MiniParse.Spec.Base.consumed_length x)).
;       MiniParse.Spec.Base.bparse f x == any_result ==>
;       (~(Some? (MiniParse.Spec.Base.bparse f x)) ==> Prims.l_False) /\
;       (forall (b: t & MiniParse.Spec.Base.consumed_length x).
;           MiniParse.Spec.Base.bparse f x == FStar.Pervasives.Native.Some b ==>
;           (forall (b: t) (b: MiniParse.Spec.Base.consumed_length x).
;               b == (b, b) ==>
;               (b <= FStar.Seq.Base.length x' /\ FStar.Seq.Base.length x' <= FStar.Seq.Base.length x ==>
;                 (b <= FStar.Seq.Base.length x ==> 0 <= b && b <= FStar.Seq.Base.length x') /\
...
; While typechecking the top-level declaration `let no_lookahead_weak_on`
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(57,2-65,5)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2))))

;; def=MiniParse.Spec.Base.fst(58,7-58,27); use=MiniParse.Spec.Base.fst(58,7-58,27)
(= (MiniParse.Spec.Base.bparse @x0
@x1
@x2)
@x4)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(57,2-65,5)
(and (implies 
;; def=MiniParse.Spec.Base.fst(58,7-58,13); use=MiniParse.Spec.Base.fst(58,7-58,13)
(not 
;; def=MiniParse.Spec.Base.fst(58,7-58,13); use=MiniParse.Spec.Base.fst(58,7-58,13)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2))
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(57,2-65,5)
(forall ((@x5 Term))
...
;; def=MiniParse.Spec.Base.fst(59,7-59,13); use=MiniParse.Spec.Base.fst(59,7-59,13)
(= @x5
...
;; def=Prims.fst(451,66-459,89); use=MiniParse.Spec.Base.fst(60,2-65,3)
(and (implies 
;; def=MiniParse.Spec.Base.fst(60,3-60,56); use=MiniParse.Spec.Base.fst(60,3-60,56)
(and 
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(60,2-60,100)
(and (implies 
;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(60,75-60,78)
(<= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x2)))


;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(60,75-60,78)
(and 
;; def=MiniParse.Spec.Base.fst(59,10-59,13); use=MiniParse.Spec.Base.fst(60,75-60,78)
(or label_2
...
;; def=MiniParse.Spec.Base.fst(59,10-59,13); use=MiniParse.Spec.Base.fst(60,75-60,78)
(or label_3
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x7
(FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x3))))
)
)

;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(60,2-60,100)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(MiniParse.Spec.Base.consumed_length @x2))

;; def=FStar.Seq.Base.fsti(64,43-64,44); use=MiniParse.Spec.Base.fst(60,2-60,100)
(= @x7
@x8)
)
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(60,2-60,100)
...
;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(60,96-60,99)
(<= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x2)))
)

;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(60,96-60,99)
(and 
;; def=MiniParse.Spec.Base.fst(59,10-59,13); use=MiniParse.Spec.Base.fst(60,96-60,99)
(or label_4
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
@x7)))
...
(implies 
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(60,2-65,3)
(and 
;; def=MiniParse.Spec.Base.fst(60,3-60,23); use=MiniParse.Spec.Base.fst(60,3-60,23)
(<= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(61,2-65,3)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x3))))

;; def=MiniParse.Spec.Base.fst(62,7-62,29); use=MiniParse.Spec.Base.fst(62,7-62,29)
(= (MiniParse.Spec.Base.bparse @x0
@x1
@x3)
@x8)
...
;; def=MiniParse.Spec.Base.fst(62,7-62,14); use=MiniParse.Spec.Base.fst(62,7-62,14)
(not 
;; def=MiniParse.Spec.Base.fst(62,7-62,14); use=MiniParse.Spec.Base.fst(62,7-62,14)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x3))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.no_lookahead_weak_on, 1)
; STATUS: unsat
...
; encoding sigelt let no_lookahead_weak_on
...
; Starting query at MiniParse.Spec.Base.fst(79,2-79,4)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (t: Type)
;   (f1: MiniParse.Spec.Base.bare_parser t)
;   (f2: MiniParse.Spec.Base.bare_parser t)
;   (x: MiniParse.Spec.Base.bytes)
;   (x': MiniParse.Spec.Base.bytes).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     MiniParse.Spec.Base.bparse f2 x == MiniParse.Spec.Base.bparse f1 x /\
;     MiniParse.Spec.Base.bparse f2 x' == MiniParse.Spec.Base.bparse f1 x' /\
;     (forall (pure_result: Prims.unit).
;         (MiniParse.Spec.Base.no_lookahead_weak_on f2 x x' <==>
;           MiniParse.Spec.Base.no_lookahead_weak_on f1 x x') ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let no_lookahead_weak_on_ext`
...
;; def=MiniParse.Spec.Base.fst(73,4-73,30); use=MiniParse.Spec.Base.fst(79,2-79,4)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x3)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(74,4-74,32); use=MiniParse.Spec.Base.fst(79,2-79,4)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x4)
(MiniParse.Spec.Base.bparse @x0
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(79,2-79,4)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=MiniParse.Spec.Base.fst(76,11-78,3); use=MiniParse.Spec.Base.fst(79,2-79,4)
(or label_2

;; def=MiniParse.Spec.Base.fst(76,11-78,3); use=MiniParse.Spec.Base.fst(79,2-79,4)
(iff 
;; def=MiniParse.Spec.Base.fst(77,4-77,32); use=MiniParse.Spec.Base.fst(79,2-79,4)
(Valid 
;; def=MiniParse.Spec.Base.fst(77,4-77,32); use=MiniParse.Spec.Base.fst(79,2-79,4)
...
;; def=MiniParse.Spec.Base.fst(77,38-77,66); use=MiniParse.Spec.Base.fst(79,2-79,4)
(Valid 
;; def=MiniParse.Spec.Base.fst(77,38-77,66); use=MiniParse.Spec.Base.fst(79,2-79,4)
(MiniParse.Spec.Base.no_lookahead_weak_on @x0
@x1
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(79,2-79,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(79,2-79,4)
(ApplyTT @x5
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.no_lookahead_weak_on_ext, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_MiniParse.Spec.Base.no_lookahead_weak_on
...
; encoding sigelt let no_lookahead_weak_on_ext
...
; encoding sigelt let no_lookahead_weak
...
; Starting query at MiniParse.Spec.Base.fst(97,2-97,98)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (t: Type) (f1: MiniParse.Spec.Base.bare_parser t) (f2: MiniParse.Spec.Base.bare_parser t).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
...
;     (forall (pure_result: Prims.unit).
;         (MiniParse.Spec.Base.no_lookahead_weak f2 <==> MiniParse.Spec.Base.no_lookahead_weak f1) ==>
;         p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         (forall (x: MiniParse.Spec.Base.bytes) (y: MiniParse.Spec.Base.bytes).
;             MiniParse.Spec.Base.bparse f2 x == MiniParse.Spec.Base.bparse f1 x /\
;             MiniParse.Spec.Base.bparse f2 y == MiniParse.Spec.Base.bparse f1 y ==>
;             (MiniParse.Spec.Base.no_lookahead_weak_on f2 x y <==>
;               MiniParse.Spec.Base.no_lookahead_weak_on f1 x y)) ==>
;         p pure_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let no_lookahead_weak_ext`
...
;; def=MiniParse.Spec.Base.fst(91,12-93,3); use=MiniParse.Spec.Base.fst(97,2-97,98)
(forall ((@x4 Term))
 (! (implies (HasType @x4
MiniParse.Spec.Base.bytes)

;; def=MiniParse.Spec.Base.fst(92,25-92,51); use=MiniParse.Spec.Base.fst(97,2-97,98)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x4)
(MiniParse.Spec.Base.bparse @x0
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(97,2-97,98)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=MiniParse.Spec.Base.fst(94,11-96,3); use=MiniParse.Spec.Base.fst(97,2-97,98)
(or label_2

;; def=MiniParse.Spec.Base.fst(94,11-96,3); use=MiniParse.Spec.Base.fst(97,2-97,98)
(iff 
;; def=MiniParse.Spec.Base.fst(95,4-95,24); use=MiniParse.Spec.Base.fst(97,2-97,98)
(Valid 
;; def=MiniParse.Spec.Base.fst(95,4-95,24); use=MiniParse.Spec.Base.fst(97,2-97,98)
...
;; def=MiniParse.Spec.Base.fst(95,30-95,50); use=MiniParse.Spec.Base.fst(97,2-97,98)
(Valid 
;; def=MiniParse.Spec.Base.fst(95,30-95,50); use=MiniParse.Spec.Base.fst(97,2-97,98)
(MiniParse.Spec.Base.no_lookahead_weak @x0
@x1)
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(97,2-97,98)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(97,2-97,98)
(ApplyTT @x3
@x4)
...
;; def=FStar.Classical.fsti(277,12-277,43); use=MiniParse.Spec.Base.fst(97,12-97,26)
...
;; def=MiniParse.Spec.Base.fst(73,4-73,30); use=MiniParse.Spec.Base.fst(97,12-97,26)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x5)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(74,4-74,32); use=MiniParse.Spec.Base.fst(97,12-97,26)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x6)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(76,11-78,3); use=MiniParse.Spec.Base.fst(97,12-97,26)
(iff 
;; def=MiniParse.Spec.Base.fst(77,4-77,32); use=MiniParse.Spec.Base.fst(97,12-97,26)
(Valid 
;; def=MiniParse.Spec.Base.fst(77,4-77,32); use=MiniParse.Spec.Base.fst(97,12-97,26)
(MiniParse.Spec.Base.no_lookahead_weak_on @x0
@x2
...
;; def=MiniParse.Spec.Base.fst(77,38-77,66); use=MiniParse.Spec.Base.fst(97,12-97,26)
(Valid 
;; def=MiniParse.Spec.Base.fst(77,38-77,66); use=MiniParse.Spec.Base.fst(97,12-97,26)
(MiniParse.Spec.Base.no_lookahead_weak_on @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.no_lookahead_weak_ext, 1)
; STATUS: unsat
...
; encoding sigelt let no_lookahead_weak_ext
...
; Starting query at MiniParse.Spec.Base.fst(106,2-111,3)
...
;   (*  - Could not prove post-condition
; *)
;   Some? (MiniParse.Spec.Base.bparse p b1) /\ Some? (MiniParse.Spec.Base.bparse p b2) ==>
;   (forall (any_result: FStar.Pervasives.Native.option (t & MiniParse.Spec.Base.consumed_length b1)).
;       MiniParse.Spec.Base.bparse p b1 == any_result ==>
;       (~(Some? (MiniParse.Spec.Base.bparse p b1)) ==> Prims.l_False) /\
;       (forall (b: t) (b: MiniParse.Spec.Base.consumed_length b1).
;           MiniParse.Spec.Base.bparse p b1 == FStar.Pervasives.Native.Some (b, b) ==>
;           (forall (any_result:
;               FStar.Pervasives.Native.option (t & MiniParse.Spec.Base.consumed_length b2)).
;               MiniParse.Spec.Base.bparse p b2 == any_result ==>
;               ~(Some? (MiniParse.Spec.Base.bparse p b2)) ==> Prims.l_False)))


; Context: While encoding a query
; While typechecking the top-level declaration `let injective_precond`
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(106,2-111,3)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2))))

;; def=MiniParse.Spec.Base.fst(108,9-108,39); use=MiniParse.Spec.Base.fst(108,9-108,39)
(= (MiniParse.Spec.Base.bparse @x0
@x1
@x2)
@x4)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(106,2-111,3)
(and (implies 
;; def=MiniParse.Spec.Base.fst(108,9-108,24); use=MiniParse.Spec.Base.fst(108,9-108,24)
(not 
;; def=MiniParse.Spec.Base.fst(108,9-108,24); use=MiniParse.Spec.Base.fst(108,9-108,24)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2))
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(106,2-111,3)
(forall ((@x5 Term))
 (! (implies (HasType @x5
@x0)
...
;; def=MiniParse.Spec.Base.fst(109,9-109,39); use=MiniParse.Spec.Base.fst(109,9-109,39)
(= (MiniParse.Spec.Base.bparse @x0
@x1
@x3)
@x7)
...
;; def=MiniParse.Spec.Base.fst(109,9-109,24); use=MiniParse.Spec.Base.fst(109,9-109,24)
(not 
;; def=MiniParse.Spec.Base.fst(109,9-109,24); use=MiniParse.Spec.Base.fst(109,9-109,24)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x3))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.injective_precond, 1)
; STATUS: unsat
...
; encoding sigelt let injective_precond
...
; Starting query at MiniParse.Spec.Base.fst(125,2-125,4)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (t: Type)
;   (p1: MiniParse.Spec.Base.bare_parser t)
;   (p2: MiniParse.Spec.Base.bare_parser t)
;   (b1: MiniParse.Spec.Base.bytes)
;   (b2: MiniParse.Spec.Base.bytes).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     MiniParse.Spec.Base.bparse p2 b1 == MiniParse.Spec.Base.bparse p1 b1 /\
;     MiniParse.Spec.Base.bparse p2 b2 == MiniParse.Spec.Base.bparse p1 b2 /\
;     (forall (pure_result: Prims.unit).
;         (MiniParse.Spec.Base.injective_precond p2 b1 b2 <==>
;           MiniParse.Spec.Base.injective_precond p1 b1 b2) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let injective_precond_ext`
...
;; def=MiniParse.Spec.Base.fst(119,4-119,32); use=MiniParse.Spec.Base.fst(125,2-125,4)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x3)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(120,4-120,32); use=MiniParse.Spec.Base.fst(125,2-125,4)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x4)
(MiniParse.Spec.Base.bparse @x0
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(125,2-125,4)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=MiniParse.Spec.Base.fst(122,11-124,3); use=MiniParse.Spec.Base.fst(125,2-125,4)
(or label_2

;; def=MiniParse.Spec.Base.fst(122,11-124,3); use=MiniParse.Spec.Base.fst(125,2-125,4)
(iff 
;; def=MiniParse.Spec.Base.fst(123,4-123,30); use=MiniParse.Spec.Base.fst(125,2-125,4)
(Valid 
;; def=MiniParse.Spec.Base.fst(123,4-123,30); use=MiniParse.Spec.Base.fst(125,2-125,4)
...
;; def=MiniParse.Spec.Base.fst(123,36-123,62); use=MiniParse.Spec.Base.fst(125,2-125,4)
(Valid 
;; def=MiniParse.Spec.Base.fst(123,36-123,62); use=MiniParse.Spec.Base.fst(125,2-125,4)
(MiniParse.Spec.Base.injective_precond @x0
@x1
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(125,2-125,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(125,2-125,4)
(ApplyTT @x5
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.injective_precond_ext, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_MiniParse.Spec.Base.injective_precond
...
; encoding sigelt let injective_precond_ext
...
; Starting query at MiniParse.Spec.Base.fst(132,2-138,3)
...
;                   MiniParse.Spec.Base.bparse p b2 == FStar.Pervasives.Native.Some (b, b) ==>
;                   b == b ==>
;                   (b <= FStar.Seq.Base.length b1 ==> 0 <= b && b <= FStar.Seq.Base.length b1) /\
;                   (forall (any_result: MiniParse.Spec.Base.consumed_length b1).
;                       b == any_result ==>
;                       (forall (any_result: FStar.Seq.Base.seq MiniParse.Spec.Base.byte).
;                           FStar.Seq.Base.slice b1 0 b == any_result ==>
;                           b <= FStar.Seq.Base.length b2 ==> 0 <= b && b <= FStar.Seq.Base.length b2)
;                   )))))


; Context: While encoding a query
; While typechecking the top-level declaration `let injective_postcond`
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(132,2-138,3)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2))))

;; def=MiniParse.Spec.Base.fst(134,9-134,39); use=MiniParse.Spec.Base.fst(134,9-134,39)
(= (MiniParse.Spec.Base.bparse @x0
@x1
@x2)
@x4)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(132,2-138,3)
(and (implies 
;; def=MiniParse.Spec.Base.fst(134,9-134,24); use=MiniParse.Spec.Base.fst(134,9-134,24)
(not 
;; def=MiniParse.Spec.Base.fst(134,9-134,24); use=MiniParse.Spec.Base.fst(134,9-134,24)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2))
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(132,2-138,3)
(forall ((@x5 Term))
 (! (implies (HasType @x5
@x0)
...
;; def=MiniParse.Spec.Base.fst(135,9-135,39); use=MiniParse.Spec.Base.fst(135,9-135,39)
(= (MiniParse.Spec.Base.bparse @x0
@x1
@x3)
@x7)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(132,2-138,3)
(and (implies 
;; def=MiniParse.Spec.Base.fst(135,9-135,24); use=MiniParse.Spec.Base.fst(135,9-135,24)
(not 
;; def=MiniParse.Spec.Base.fst(135,9-135,24); use=MiniParse.Spec.Base.fst(135,9-135,24)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x3))
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(136,4-137,46)
(and (implies 
;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(137,19-137,23)
(<= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x2)))


;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(137,19-137,23)
(and 
;; def=MiniParse.Spec.Base.fst(134,19-134,23); use=MiniParse.Spec.Base.fst(137,19-137,23)
(or label_3
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
@x6)))
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(136,4-137,46)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(MiniParse.Spec.Base.consumed_length @x2))

;; def=FStar.Seq.Base.fsti(64,43-64,44); use=MiniParse.Spec.Base.fst(136,4-137,46)
(= @x6
@x10)
)
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(136,4-137,46)
(= (FStar.Seq.Base.slice (MiniParse.Spec.Base.byte Dummy_value)
@x2
(BoxInt 0)
@x6)
...
;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(137,42-137,46)
(<= (BoxInt_proj_0 @x9)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x3)))
)

;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(137,42-137,46)
(and 
;; def=MiniParse.Spec.Base.fst(135,19-135,23); use=MiniParse.Spec.Base.fst(137,42-137,46)
(or label_5
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
@x9)))
...
;; def=MiniParse.Spec.Base.fst(135,19-135,23); use=MiniParse.Spec.Base.fst(137,42-137,46)
(or label_6
(BoxBool_proj_0 (Prims.op_LessThanOrEqual @x9
(FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x3))))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.injective_postcond, 1)
; STATUS: unsat
...
; encoding sigelt let injective_postcond
...
; Starting query at MiniParse.Spec.Base.fst(152,2-152,4)
...
;     MiniParse.Spec.Base.bparse p2 b2 == MiniParse.Spec.Base.bparse p1 b2 /\
;     (forall (pure_result: Prims.unit).
;         (MiniParse.Spec.Base.injective_postcond p2 b1 b2 <==>
;           MiniParse.Spec.Base.injective_postcond p1 b1 b2) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let injective_postcond_ext`
...
;; def=MiniParse.Spec.Base.fst(146,4-146,32); use=MiniParse.Spec.Base.fst(152,2-152,4)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x3)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(147,4-147,32); use=MiniParse.Spec.Base.fst(152,2-152,4)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x4)
(MiniParse.Spec.Base.bparse @x0
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(152,2-152,4)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=MiniParse.Spec.Base.fst(149,11-151,3); use=MiniParse.Spec.Base.fst(152,2-152,4)
(or label_2

;; def=MiniParse.Spec.Base.fst(149,11-151,3); use=MiniParse.Spec.Base.fst(152,2-152,4)
(iff 
;; def=MiniParse.Spec.Base.fst(150,4-150,31); use=MiniParse.Spec.Base.fst(152,2-152,4)
(Valid 
;; def=MiniParse.Spec.Base.fst(150,4-150,31); use=MiniParse.Spec.Base.fst(152,2-152,4)
...
;; def=MiniParse.Spec.Base.fst(150,37-150,64); use=MiniParse.Spec.Base.fst(152,2-152,4)
(Valid 
;; def=MiniParse.Spec.Base.fst(150,37-150,64); use=MiniParse.Spec.Base.fst(152,2-152,4)
(MiniParse.Spec.Base.injective_postcond @x0
@x1
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(152,2-152,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(152,2-152,4)
(ApplyTT @x5
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.injective_postcond_ext, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_MiniParse.Spec.Base.injective_postcond
...
; encoding sigelt let injective_postcond_ext
...
; Starting query at MiniParse.Spec.Base.fst(169,2-170,96)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (t: Type) (p1: MiniParse.Spec.Base.bare_parser t) (p2: MiniParse.Spec.Base.bare_parser t).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (b: MiniParse.Spec.Base.bytes).
...
;     (forall (pure_result: Prims.unit).
;         (MiniParse.Spec.Base.injective p2 <==> MiniParse.Spec.Base.injective p1) ==> p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         (forall (x: MiniParse.Spec.Base.bytes) (y: MiniParse.Spec.Base.bytes).
;             MiniParse.Spec.Base.bparse p2 x == MiniParse.Spec.Base.bparse p1 x /\
;             MiniParse.Spec.Base.bparse p2 y == MiniParse.Spec.Base.bparse p1 y ==>
;             (MiniParse.Spec.Base.injective_precond p2 x y <==>
;               MiniParse.Spec.Base.injective_precond p1 x y)) ==>
;         (forall (pure_result: Prims.unit).
;             (forall (x: MiniParse.Spec.Base.bytes) (y: MiniParse.Spec.Base.bytes).
;                 MiniParse.Spec.Base.bparse p2 x == MiniParse.Spec.Base.bparse p1 x /\
;                 MiniParse.Spec.Base.bparse p2 y == MiniParse.Spec.Base.bparse p1 y ==>
;                 (MiniParse.Spec.Base.injective_postcond p2 x y <==>
;                   MiniParse.Spec.Base.injective_postcond p1 x y)) ==>
;             p pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let injective_ext`
...
;; def=MiniParse.Spec.Base.fst(163,12-165,3); use=MiniParse.Spec.Base.fst(169,2-170,96)
(forall ((@x4 Term))
 (! (implies (HasType @x4
MiniParse.Spec.Base.bytes)

;; def=MiniParse.Spec.Base.fst(164,24-164,50); use=MiniParse.Spec.Base.fst(169,2-170,96)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x4)
(MiniParse.Spec.Base.bparse @x0
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(169,2-170,96)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=MiniParse.Spec.Base.fst(166,11-168,3); use=MiniParse.Spec.Base.fst(169,2-170,96)
(or label_2

;; def=MiniParse.Spec.Base.fst(166,11-168,3); use=MiniParse.Spec.Base.fst(169,2-170,96)
(iff 
;; def=MiniParse.Spec.Base.fst(167,4-167,16); use=MiniParse.Spec.Base.fst(169,2-170,96)
(Valid 
;; def=MiniParse.Spec.Base.fst(167,4-167,16); use=MiniParse.Spec.Base.fst(169,2-170,96)
...
;; def=MiniParse.Spec.Base.fst(167,22-167,34); use=MiniParse.Spec.Base.fst(169,2-170,96)
(Valid 
;; def=MiniParse.Spec.Base.fst(167,22-167,34); use=MiniParse.Spec.Base.fst(169,2-170,96)
(MiniParse.Spec.Base.injective @x0
@x1)
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(169,2-170,96)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(169,2-170,96)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(169,12-169,26)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=FStar.Classical.fsti(277,12-277,43); use=MiniParse.Spec.Base.fst(169,12-169,26)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
MiniParse.Spec.Base.bytes)
(HasType @x6
...
;; def=MiniParse.Spec.Base.fst(119,4-119,32); use=MiniParse.Spec.Base.fst(169,12-169,26)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x5)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(120,4-120,32); use=MiniParse.Spec.Base.fst(169,12-169,26)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x6)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(122,11-124,3); use=MiniParse.Spec.Base.fst(169,12-169,26)
(iff 
;; def=MiniParse.Spec.Base.fst(123,4-123,30); use=MiniParse.Spec.Base.fst(169,12-169,26)
(Valid 
;; def=MiniParse.Spec.Base.fst(123,4-123,30); use=MiniParse.Spec.Base.fst(169,12-169,26)
(MiniParse.Spec.Base.injective_precond @x0
@x2
...
;; def=MiniParse.Spec.Base.fst(123,36-123,62); use=MiniParse.Spec.Base.fst(169,12-169,26)
(Valid 
;; def=MiniParse.Spec.Base.fst(123,36-123,62); use=MiniParse.Spec.Base.fst(169,12-169,26)
(MiniParse.Spec.Base.injective_precond @x0
@x1
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(170,12-170,26)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=FStar.Classical.fsti(277,12-277,43); use=MiniParse.Spec.Base.fst(170,12-170,26)
...
;; def=MiniParse.Spec.Base.fst(146,4-146,32); use=MiniParse.Spec.Base.fst(170,12-170,26)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x6)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(147,4-147,32); use=MiniParse.Spec.Base.fst(170,12-170,26)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x7)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(149,11-151,3); use=MiniParse.Spec.Base.fst(170,12-170,26)
(iff 
;; def=MiniParse.Spec.Base.fst(150,4-150,31); use=MiniParse.Spec.Base.fst(170,12-170,26)
(Valid 
;; def=MiniParse.Spec.Base.fst(150,4-150,31); use=MiniParse.Spec.Base.fst(170,12-170,26)
(MiniParse.Spec.Base.injective_postcond @x0
@x2
...
;; def=MiniParse.Spec.Base.fst(150,37-150,64); use=MiniParse.Spec.Base.fst(170,12-170,26)
(Valid 
;; def=MiniParse.Spec.Base.fst(150,37-150,64); use=MiniParse.Spec.Base.fst(170,12-170,26)
(MiniParse.Spec.Base.injective_postcond @x0
@x1
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(170,12-170,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(170,12-170,26)
(ApplyTT @x3
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.injective_ext, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_MiniParse.Spec.Base.injective
...
; encoding sigelt let injective_ext
...
; Starting query at MiniParse.Spec.Base.fst(177,2-182,3)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let no_lookahead_on_precond`
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(177,2-182,3)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2))))

;; def=MiniParse.Spec.Base.fst(178,9-178,29); use=MiniParse.Spec.Base.fst(178,9-178,29)
(= (MiniParse.Spec.Base.bparse @x0
@x1
@x2)
@x4)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(177,2-182,3)
(and (implies 
;; def=MiniParse.Spec.Base.fst(178,9-178,15); use=MiniParse.Spec.Base.fst(178,9-178,15)
(not 
;; def=MiniParse.Spec.Base.fst(178,9-178,15); use=MiniParse.Spec.Base.fst(178,9-178,15)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2))
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(177,2-182,3)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2)))
...
;; def=MiniParse.Spec.Base.fst(179,9-179,15); use=MiniParse.Spec.Base.fst(179,9-179,15)
(= @x5
(FStar.Pervasives.Native.Mktuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2)
@x6
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(180,4-181,43)
(and (implies 
;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(181,19-181,22)
(<= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x2)))


;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(181,19-181,22)
(and 
;; def=MiniParse.Spec.Base.fst(179,12-179,15); use=MiniParse.Spec.Base.fst(181,19-181,22)
(or label_2
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
@x7)))
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(180,4-181,43)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(MiniParse.Spec.Base.consumed_length @x2))

;; def=FStar.Seq.Base.fsti(64,43-64,44); use=MiniParse.Spec.Base.fst(180,4-181,43)
(= @x7
@x8)
)
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(180,4-181,43)
(= (FStar.Seq.Base.slice (MiniParse.Spec.Base.byte Dummy_value)
@x3
(BoxInt 0)
@x7)
...
;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(181,40-181,43)
(<= (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x2)))
)

;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(181,40-181,43)
(and 
;; def=MiniParse.Spec.Base.fst(179,12-179,15); use=MiniParse.Spec.Base.fst(181,40-181,43)
(or label_4
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
@x7)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.no_lookahead_on_precond, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.Some, equation_MiniParse.Spec.Base.byte, equation_MiniParse.Spec.Base.bytes, equation_MiniParse.Spec.Base.consumed_length, equation_Prims.eqtype, equation_Prims.nat, int_inversion, primitive_Prims.op_LessThanOrEqual, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_f1ef48729dd48b5741a77671cc117cd5, typing_FStar.Seq.Base.length, typing_FStar.UInt8.t
...
; encoding sigelt let no_lookahead_on_precond
...
; Starting query at MiniParse.Spec.Base.fst(189,2-196,4)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let no_lookahead_on_postcond`
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(189,2-196,4)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2))))

;; def=MiniParse.Spec.Base.fst(190,7-190,27); use=MiniParse.Spec.Base.fst(190,7-190,27)
(= (MiniParse.Spec.Base.bparse @x0
@x1
@x2)
@x4)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(189,2-196,4)
(and (implies 
;; def=MiniParse.Spec.Base.fst(190,7-190,13); use=MiniParse.Spec.Base.fst(190,7-190,13)
(not 
;; def=MiniParse.Spec.Base.fst(190,7-190,13); use=MiniParse.Spec.Base.fst(190,7-190,13)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2))
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(189,2-196,4)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2)))
...
;; def=MiniParse.Spec.Base.fst(191,7-191,11); use=MiniParse.Spec.Base.fst(191,7-191,11)
(= @x5
(FStar.Pervasives.Native.Mktuple2 @x0
(MiniParse.Spec.Base.consumed_length @x2)
@x6
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(192,2-196,3)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x3))))

;; def=MiniParse.Spec.Base.fst(193,7-193,29); use=MiniParse.Spec.Base.fst(193,7-193,29)
(= (MiniParse.Spec.Base.bparse @x0
@x1
@x3)
@x8)
...
;; def=MiniParse.Spec.Base.fst(193,7-193,14); use=MiniParse.Spec.Base.fst(193,7-193,14)
(not 
;; def=MiniParse.Spec.Base.fst(193,7-193,14); use=MiniParse.Spec.Base.fst(193,7-193,14)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x3))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.no_lookahead_on_postcond, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt let no_lookahead_on_postcond
...
; encoding sigelt let no_lookahead_on
...
; Starting query at MiniParse.Spec.Base.fst(217,2-217,4)
...
;     MiniParse.Spec.Base.bparse p2 b2 == MiniParse.Spec.Base.bparse p1 b2 /\
;     (forall (pure_result: Prims.unit).
;         (MiniParse.Spec.Base.no_lookahead_on p2 b1 b2 <==>
;           MiniParse.Spec.Base.no_lookahead_on p1 b1 b2) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let no_lookahead_on_ext`
...
;; def=MiniParse.Spec.Base.fst(211,4-211,32); use=MiniParse.Spec.Base.fst(217,2-217,4)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x3)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(212,4-212,32); use=MiniParse.Spec.Base.fst(217,2-217,4)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x4)
(MiniParse.Spec.Base.bparse @x0
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(217,2-217,4)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=MiniParse.Spec.Base.fst(214,11-216,3); use=MiniParse.Spec.Base.fst(217,2-217,4)
(or label_2

;; def=MiniParse.Spec.Base.fst(214,11-216,3); use=MiniParse.Spec.Base.fst(217,2-217,4)
(iff 
;; def=MiniParse.Spec.Base.fst(215,4-215,28); use=MiniParse.Spec.Base.fst(217,2-217,4)
(Valid 
;; def=MiniParse.Spec.Base.fst(215,4-215,28); use=MiniParse.Spec.Base.fst(217,2-217,4)
...
;; def=MiniParse.Spec.Base.fst(215,34-215,58); use=MiniParse.Spec.Base.fst(217,2-217,4)
(Valid 
;; def=MiniParse.Spec.Base.fst(215,34-215,58); use=MiniParse.Spec.Base.fst(217,2-217,4)
(MiniParse.Spec.Base.no_lookahead_on @x0
@x1
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(217,2-217,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(217,2-217,4)
(ApplyTT @x5
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.no_lookahead_on_ext, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.Some, equation_MiniParse.Spec.Base.consumed_length, equation_MiniParse.Spec.Base.no_lookahead_on, equation_MiniParse.Spec.Base.no_lookahead_on_postcond, equation_MiniParse.Spec.Base.no_lookahead_on_precond, fuel_guarded_inversion_FStar.Pervasives.Native.option, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, typing_MiniParse.Spec.Base.bparse
...
; encoding sigelt let no_lookahead_on_ext
...
; encoding sigelt let no_lookahead
...
; Starting query at MiniParse.Spec.Base.fst(235,2-235,93)
...
;         MiniParse.Spec.Base.bparse p2 b == MiniParse.Spec.Base.bparse p1 b) /\
;     (forall (pure_result: Prims.unit).
;         (MiniParse.Spec.Base.no_lookahead p2 <==> MiniParse.Spec.Base.no_lookahead p1) ==>
;         p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         (forall (x: MiniParse.Spec.Base.bytes) (y: MiniParse.Spec.Base.bytes).
;             MiniParse.Spec.Base.bparse p2 x == MiniParse.Spec.Base.bparse p1 x /\
;             MiniParse.Spec.Base.bparse p2 y == MiniParse.Spec.Base.bparse p1 y ==>
;             (MiniParse.Spec.Base.no_lookahead_on p2 x y <==>
;               MiniParse.Spec.Base.no_lookahead_on p1 x y)) ==>
;         p pure_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let no_lookahead_ext`
...
;; def=MiniParse.Spec.Base.fst(229,12-231,3); use=MiniParse.Spec.Base.fst(235,2-235,93)
(forall ((@x4 Term))
 (! (implies (HasType @x4
MiniParse.Spec.Base.bytes)

;; def=MiniParse.Spec.Base.fst(230,24-230,50); use=MiniParse.Spec.Base.fst(235,2-235,93)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x4)
(MiniParse.Spec.Base.bparse @x0
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(235,2-235,93)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=MiniParse.Spec.Base.fst(232,11-234,3); use=MiniParse.Spec.Base.fst(235,2-235,93)
(or label_2

;; def=MiniParse.Spec.Base.fst(232,11-234,3); use=MiniParse.Spec.Base.fst(235,2-235,93)
(iff 
;; def=MiniParse.Spec.Base.fst(233,4-233,19); use=MiniParse.Spec.Base.fst(235,2-235,93)
(Valid 
;; def=MiniParse.Spec.Base.fst(233,4-233,19); use=MiniParse.Spec.Base.fst(235,2-235,93)
...
;; def=MiniParse.Spec.Base.fst(233,25-233,40); use=MiniParse.Spec.Base.fst(235,2-235,93)
(Valid 
;; def=MiniParse.Spec.Base.fst(233,25-233,40); use=MiniParse.Spec.Base.fst(235,2-235,93)
(MiniParse.Spec.Base.no_lookahead @x0
@x1)
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(235,2-235,93)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(235,2-235,93)
(ApplyTT @x3
@x4)
...
;; def=FStar.Classical.fsti(277,12-277,43); use=MiniParse.Spec.Base.fst(235,12-235,26)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
MiniParse.Spec.Base.bytes)
(HasType @x6
...
;; def=MiniParse.Spec.Base.fst(211,4-211,32); use=MiniParse.Spec.Base.fst(235,12-235,26)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x5)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(212,4-212,32); use=MiniParse.Spec.Base.fst(235,12-235,26)
(= (MiniParse.Spec.Base.bparse @x0
@x2
@x6)
(MiniParse.Spec.Base.bparse @x0
...
;; def=MiniParse.Spec.Base.fst(214,11-216,3); use=MiniParse.Spec.Base.fst(235,12-235,26)
(iff 
;; def=MiniParse.Spec.Base.fst(215,4-215,28); use=MiniParse.Spec.Base.fst(235,12-235,26)
(Valid 
;; def=MiniParse.Spec.Base.fst(215,4-215,28); use=MiniParse.Spec.Base.fst(235,12-235,26)
(MiniParse.Spec.Base.no_lookahead_on @x0
@x2
...
;; def=MiniParse.Spec.Base.fst(215,34-215,58); use=MiniParse.Spec.Base.fst(235,12-235,26)
(Valid 
;; def=MiniParse.Spec.Base.fst(215,34-215,58); use=MiniParse.Spec.Base.fst(235,12-235,26)
(MiniParse.Spec.Base.no_lookahead_on @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.no_lookahead_ext, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_MiniParse.Spec.Base.no_lookahead
...
; encoding sigelt let no_lookahead_ext
...
; encoding sigelt type MiniParse.Spec.Base.parser_spec
...
; encoding sigelt val MiniParse.Spec.Base.uu___is_Parser
...
; encoding sigelt let uu___is_Parser


; <Skipped let uu___is_Parser/>


; encoding sigelt val MiniParse.Spec.Base.__proj__Parser__item__f
...
; encoding sigelt let __proj__Parser__item__f


; <Skipped let __proj__Parser__item__f/>


; encoding sigelt let coerce_to_bare_parser
...
; Starting query at MiniParse.Spec.Base.fst(267,2-267,11)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (t2: Type) (t1: Type) (x: t1).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post t2).
;     t1 == t2 /\ (forall (pure_result: t2). Prims.auto_squash (p pure_result)) ==>
;     Prims.has_type x t2 /\
;     (forall (any_result: t1).
;         any_result == x ==> (forall (return_val: t2). return_val == any_result ==> p return_val))
...
;; def=MiniParse.Spec.Base.fst(265,12-265,22); use=MiniParse.Spec.Base.fst(267,2-267,11)
(= @x1
@x0)


;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(267,2-267,11)
(forall ((@x4 Term))
 (! (implies (or label_1
(HasType @x4
@x0))

;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(267,2-267,11)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(267,2-267,11)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(267,2-267,11)
(and 
;; def=MiniParse.Spec.Base.fst(263,3-263,4); use=MiniParse.Spec.Base.fst(267,3-267,4)
(or label_2
(HasType @x2
@x0))


;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(267,2-267,11)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
@x1)

;; def=MiniParse.Spec.Base.fst(261,3-263,4); use=MiniParse.Spec.Base.fst(267,2-267,11)
(= @x4
@x2)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.coerce, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; Starting query at MiniParse.Spec.Base.fst(277,2-277,3)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (t2: Type) (t1: Type) (p: MiniParse.Spec.Base.parser_spec t1).
;   (*  - Could not prove post-condition
; *)
...
;     t1 == t2 /\
;     (forall (any_result: MiniParse.Spec.Base.parser_spec t1).
;         any_result == p ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let coerce_parser`
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post (MiniParse.Spec.Base.parser_spec @x0)))

;; def=MiniParse.Spec.Base.fst(275,12-275,22); use=MiniParse.Spec.Base.fst(277,2-277,3)
(= @x0
@x1)


;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(277,2-277,3)
(forall ((@x4 Term))
 (! (implies (or label_1
(HasType @x4
(MiniParse.Spec.Base.parser_spec @x0)))

;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(277,2-277,3)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(277,2-277,3)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(277,2-277,3)
(and 
;; def=MiniParse.Spec.Base.fst(271,3-272,6); use=MiniParse.Spec.Base.fst(277,2-277,3)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(277,2-277,3)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(MiniParse.Spec.Base.parser_spec @x1))

;; def=MiniParse.Spec.Base.fst(273,3-274,23); use=MiniParse.Spec.Base.fst(277,2-277,3)
(= @x4
@x2)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.coerce_parser, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt let coerce_parser
...
; encoding sigelt let bare_serializer
...
; Starting query at MiniParse.Spec.Base.fst(292,2-292,61)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (t: Type) (p: MiniParse.Spec.Base.parser_spec t) (f: MiniParse.Spec.Base.bare_serializer t).
;   (*  - Could not prove post-condition
; *)
;   forall (x: t)
;     (any_result: FStar.Pervasives.Native.option (t & MiniParse.Spec.Base.consumed_length (f x))).
;     MiniParse.Spec.Base.parse p (f x) == any_result ==>
;     (forall (any_result: Prims.nat).
;         FStar.Seq.Base.length (f x) == any_result ==>
;         FStar.Seq.Base.length (f x) <= FStar.Seq.Base.length (f x))


; Context: While encoding a query
; While typechecking the top-level declaration `let serializer_correct`
...
;; def=dummy(0,0-0,0); use=MiniParse.Spec.Base.fst(292,2-292,61)
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(292,2-292,61)
(= (MiniParse.Spec.Base.parse @x0
@x1
(ApplyTT @x2
@x3))
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(292,2-292,61)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=MiniParse.Spec.Base.fst(254,20-292,60); use=MiniParse.Spec.Base.fst(292,35-292,61)
(= (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
(ApplyTT @x2
@x3))
@x5)
...
;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(292,44-292,60)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.serializer_correct, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt let serializer_correct
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e
;;; Fact-ids: Name MiniParse.Spec.Base.consumed_length; Namespace MiniParse.Spec.Base
(assert (! (HasType Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e
Tm_type)
:named kinding_Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e))
...
;;; Fact-ids: Name MiniParse.Spec.Base.consumed_length; Namespace MiniParse.Spec.Base
(assert (! 
;; def=MiniParse.Spec.Base.fst(40,24-40,42); use=MiniParse.Spec.Base.fst(40,24-40,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e))
:qid MiniParse.Spec.Base_pre_typing_Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e))

:named MiniParse.Spec.Base_pre_typing_Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e
;;; Fact-ids: Name MiniParse.Spec.Base.consumed_length; Namespace MiniParse.Spec.Base
(assert (! 
;; def=MiniParse.Spec.Base.fst(40,24-40,42); use=MiniParse.Spec.Base.fst(40,24-40,42)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid MiniParse.Spec.Base_interpretation_Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e))
:qid MiniParse.Spec.Base_interpretation_Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e))

:named MiniParse.Spec.Base_interpretation_Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e))
(push) ;; push{2

; Starting query at MiniParse.Spec.Base.fst(303,2-303,4)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_f0990daca12e681f3d756bd918556ac1 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(301,12-301,84); use=MiniParse.Spec.Base.fst(303,2-303,4)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_f0990daca12e681f3d756bd918556ac1 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_f0990daca12e681f3d756bd918556ac1 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_f0990daca12e681f3d756bd918556ac1))

:named refinement_kinding_Tm_refine_f0990daca12e681f3d756bd918556ac1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(301,12-301,84); use=MiniParse.Spec.Base.fst(303,2-303,4)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f0990daca12e681f3d756bd918556ac1 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=MiniParse.Spec.Base.fst(301,13-301,21); use=MiniParse.Spec.Base.fst(303,2-303,4)
(= @x2
@x3)


;; def=MiniParse.Spec.Base.fst(301,25-301,83); use=MiniParse.Spec.Base.fst(303,2-303,4)
(forall ((@x6 Term))
 (! (implies (HasType @x6
MiniParse.Spec.Base.bytes)

;; def=MiniParse.Spec.Base.fst(301,50-301,82); use=MiniParse.Spec.Base.fst(303,2-303,4)
(= (MiniParse.Spec.Base.parse @x2
@x4
@x6)
(MiniParse.Spec.Base.parse @x3
@x5
@x6))
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_f0990daca12e681f3d756bd918556ac1.1))
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_f0990daca12e681f3d756bd918556ac1))

:named refinement_interpretation_Tm_refine_f0990daca12e681f3d756bd918556ac1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f0990daca12e681f3d756bd918556ac1
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(301,12-301,84); use=MiniParse.Spec.Base.fst(303,2-303,4)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f0990daca12e681f3d756bd918556ac1 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_f0990daca12e681f3d756bd918556ac1 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_f0990daca12e681f3d756bd918556ac1))

:named haseqTm_refine_f0990daca12e681f3d756bd918556ac1))

(declare-fun Tm_abs_20b3d72baf4e53935cb2d67c13936e9a (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_20b3d72baf4e53935cb2d67c13936e9a
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(301,25-301,83); use=MiniParse.Spec.Base.fst(303,2-303,4)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_20b3d72baf4e53935cb2d67c13936e9a @x0
@x1
@x2
@x3)
Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e)
...
:pattern ((Tm_abs_20b3d72baf4e53935cb2d67c13936e9a @x0
@x1
@x2
@x3))
:qid typing_Tm_abs_20b3d72baf4e53935cb2d67c13936e9a))

:named typing_Tm_abs_20b3d72baf4e53935cb2d67c13936e9a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_20b3d72baf4e53935cb2d67c13936e9a
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(301,25-301,83); use=MiniParse.Spec.Base.fst(303,2-303,4)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (Tm_abs_20b3d72baf4e53935cb2d67c13936e9a @x1
@x2
@x3
@x4)
@x0)
(Prims.eq2 (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x1
(MiniParse.Spec.Base.consumed_length @x0)))
...
:pattern ((ApplyTT (Tm_abs_20b3d72baf4e53935cb2d67c13936e9a @x1
@x2
@x3
@x4)
@x0))
:qid interpretation_Tm_abs_20b3d72baf4e53935cb2d67c13936e9a))

:named interpretation_Tm_abs_20b3d72baf4e53935cb2d67c13936e9a))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(301,25-301,83); use=MiniParse.Spec.Base.fst(303,2-303,4)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.l_Forall MiniParse.Spec.Base.bytes
(Tm_abs_20b3d72baf4e53935cb2d67c13936e9a @x3
@x2
@x1
@x0)))
...
;;no pats
:qid l_quant_interp_517bafb0b3c92fdc3d4722a35a74afa8.1))
)
 

:pattern ((Valid (Prims.l_Forall MiniParse.Spec.Base.bytes
(Tm_abs_20b3d72baf4e53935cb2d67c13936e9a @x3
@x2
@x1
@x0))))
:qid l_quant_interp_517bafb0b3c92fdc3d4722a35a74afa8))

:named l_quant_interp_517bafb0b3c92fdc3d4722a35a74afa8))

; Encoding query formula : forall (t1: Type)
;   (p1: MiniParse.Spec.Base.parser_spec t1)
;   (f: MiniParse.Spec.Base.bare_serializer t1)
;   (t2: Type)
;   (p2: MiniParse.Spec.Base.parser_spec t2).
;   (t1 == t2 ==>
;     (forall (input: MiniParse.Spec.Base.bytes)
;         (any_result:
;         FStar.Pervasives.Native.option (t1 & MiniParse.Spec.Base.consumed_length input)).
;         MiniParse.Spec.Base.parse p1 input == any_result ==>
;         (forall (any_result:
;             FStar.Pervasives.Native.option (t2 & MiniParse.Spec.Base.consumed_length input)).
;             MiniParse.Spec.Base.parse p2 input == any_result ==> t2 == t1))) /\
;   (forall (any_result: Prims.logical).
;       (t1 == t2) /\
;       (forall (input: MiniParse.Spec.Base.bytes).
;           MiniParse.Spec.Base.parse p1 input == MiniParse.Spec.Base.parse p2 input) ==
;       any_result ==>
;       (t1 == t2 ==>
;         (forall (input: MiniParse.Spec.Base.bytes)
;             (any_result:
...
;                   MiniParse.Spec.Base.parse p1 input == MiniParse.Spec.Base.parse p2 input))).
;           (*  - Could not prove post-condition
; *) forall (_: t2). Prims.has_type _ t1)) /\
;   (forall (p: Prims.pure_post Prims.unit).
;       t1 == t2 /\
;       (forall (input: MiniParse.Spec.Base.bytes).
;           MiniParse.Spec.Base.parse p1 input == MiniParse.Spec.Base.parse p2 input) /\
;       (forall (pure_result: Prims.unit).
;           (MiniParse.Spec.Base.serializer_correct p1 f <==>
;             MiniParse.Spec.Base.serializer_correct p2 f) ==>
;           p pure_result) ==>
;       (forall (any_result: Prims.unit). p any_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let serializer_correct_ext`
...
;; def=dummy(0,0-0,0); use=MiniParse.Spec.Base.fst(303,2-303,4)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
MiniParse.Spec.Base.bytes)
(HasType @x6
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(303,2-303,4)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x5)
@x6)
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(303,2-303,4)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x3
(MiniParse.Spec.Base.consumed_length @x5))))

;; def=MiniParse.Spec.Base.fst(254,7-301,82); use=MiniParse.Spec.Base.fst(303,2-303,4)
(= (MiniParse.Spec.Base.parse @x3
@x4
@x5)
@x7)
...
;; def=MiniParse.Spec.Base.fst(295,4-298,6); use=MiniParse.Spec.Base.fst(301,68-301,82)
(or label_1

;; def=MiniParse.Spec.Base.fst(295,4-298,6); use=MiniParse.Spec.Base.fst(303,2-303,4)
(= @x3
@x0)
)
)
...
;; def=FStar.Pervasives.fsti(112,28-112,31); use=MiniParse.Spec.Base.fst(303,2-303,4)
(= (Prims.l_and (Prims.eq2 Tm_type
@x0
@x3)
(Prims.l_Forall MiniParse.Spec.Base.bytes
(Tm_abs_20b3d72baf4e53935cb2d67c13936e9a @x0
@x1
@x3
@x4)))
@x5)
...
;; def=MiniParse.Spec.Base.fst(295,4-298,6); use=MiniParse.Spec.Base.fst(300,2-300,7)
(or label_2
...
(forall ((@x6 Term))
 (! (implies (HasType @x6
(Tm_refine_f0990daca12e681f3d756bd918556ac1 @x0
@x3
@x1
@x4))
...
;; def=MiniParse.Spec.Base.fst(297,3-297,4); use=MiniParse.Spec.Base.fst(302,63-302,64)
(or label_3
(HasType @x7
@x0))
)
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(303,2-303,4)
(forall ((@x6 Term))
 (! (implies (and (or label_4
(HasType @x6
Prims.unit))

;; def=MiniParse.Spec.Base.fst(302,11-302,65); use=MiniParse.Spec.Base.fst(303,2-303,4)
(or label_5

;; def=MiniParse.Spec.Base.fst(302,11-302,65); use=MiniParse.Spec.Base.fst(303,2-303,4)
(iff 
;; def=MiniParse.Spec.Base.fst(302,12-302,35); use=MiniParse.Spec.Base.fst(303,2-303,4)
(Valid 
;; def=MiniParse.Spec.Base.fst(302,12-302,35); use=MiniParse.Spec.Base.fst(303,2-303,4)
(MiniParse.Spec.Base.serializer_correct @x0
@x1
@x2)
)


;; def=MiniParse.Spec.Base.fst(302,41-302,64); use=MiniParse.Spec.Base.fst(303,2-303,4)
(Valid 
;; def=MiniParse.Spec.Base.fst(302,41-302,64); use=MiniParse.Spec.Base.fst(303,2-303,4)
(MiniParse.Spec.Base.serializer_correct @x3
@x4
@x2)
)
)
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(303,2-303,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(303,2-303,4)
(ApplyTT @x5
@x6)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.serializer_correct_ext, 1)
; STATUS: unsat
...
; encoding sigelt let serializer_correct_ext
...
; Starting query at MiniParse.Spec.Base.fst(310,2-314,3)
...
;     Some? (MiniParse.Spec.Base.parse p s) ==>
;     (forall (any_result: FStar.Pervasives.Native.option (t & MiniParse.Spec.Base.consumed_length s))
;       .
;         MiniParse.Spec.Base.parse p s == any_result ==>
;         (~(Some? (MiniParse.Spec.Base.parse p s)) ==> Prims.l_False) /\
;         (forall (b: t) (b: MiniParse.Spec.Base.consumed_length s).
;             MiniParse.Spec.Base.parse p s == FStar.Pervasives.Native.Some (b, b) ==>
;             (forall (any_result: FStar.Seq.Base.seq MiniParse.Spec.Base.byte).
;                 f b == any_result ==>
;                 b <= FStar.Seq.Base.length s ==> 0 <= b && b <= FStar.Seq.Base.length s)))


; Context: While encoding a query
; While typechecking the top-level declaration `let serializer_complete`
...
;; def=dummy(0,0-0,0); use=MiniParse.Spec.Base.fst(310,2-314,3)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
MiniParse.Spec.Base.bytes)

;; def=MiniParse.Spec.Base.fst(311,2-311,19); use=MiniParse.Spec.Base.fst(311,2-311,19)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x3))
(MiniParse.Spec.Base.parse @x0
@x1
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(311,2-314,3)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x3))))

;; def=MiniParse.Spec.Base.fst(312,9-312,35); use=MiniParse.Spec.Base.fst(312,9-312,35)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x3)
@x4)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(311,2-314,3)
(and (implies 
;; def=MiniParse.Spec.Base.fst(312,9-312,22); use=MiniParse.Spec.Base.fst(312,9-312,22)
(not 
;; def=MiniParse.Spec.Base.fst(312,9-312,22); use=MiniParse.Spec.Base.fst(312,9-312,22)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x3))
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(311,2-314,3)
(forall ((@x5 Term))
 (! (implies (HasType @x5
@x0)
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(311,2-314,3)
(= (ApplyTT @x2
@x5)
@x7)


;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(313,25-313,28)
(<= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x3)))
)

;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(313,25-313,28)
(and 
;; def=MiniParse.Spec.Base.fst(312,18-312,21); use=MiniParse.Spec.Base.fst(313,25-313,28)
(or label_2
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
@x6)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.serializer_complete, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.Some, equation_MiniParse.Spec.Base.byte, equation_MiniParse.Spec.Base.bytes, equation_MiniParse.Spec.Base.consumed_length, equation_Prims.eqtype, equation_Prims.nat, int_inversion, primitive_Prims.op_LessThanOrEqual, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_f1ef48729dd48b5741a77671cc117cd5, typing_FStar.Seq.Base.length, typing_FStar.UInt8.t
...
; encoding sigelt let serializer_complete
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MiniParse.Spec.Base.serializer_complete; Namespace MiniParse.Spec.Base
(assert (! 
;; def=MiniParse.Spec.Base.fst(305,4-305,23); use=MiniParse.Spec.Base.fst(305,4-305,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(MiniParse.Spec.Base.bare_serializer @x0)))
(HasType (MiniParse.Spec.Base.serializer_complete @x0
@x1
@x2)
Tm_type))
 

:pattern ((MiniParse.Spec.Base.serializer_complete @x0
@x1
@x2))
:qid typing_MiniParse.Spec.Base.serializer_complete))

:named typing_MiniParse.Spec.Base.serializer_complete))
;;;;;;;;;;;;;;;;==> interpretation
;;; Fact-ids: Name Prims.l_imp; Namespace Prims
(assert (! (forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;Equation for MiniParse.Spec.Base.serializer_complete
;;; Fact-ids: Name MiniParse.Spec.Base.serializer_complete; Namespace MiniParse.Spec.Base
(assert (! 
;; def=MiniParse.Spec.Base.fst(305,4-305,23); use=MiniParse.Spec.Base.fst(305,4-305,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (MiniParse.Spec.Base.serializer_complete @x0
@x1
@x2))

;; def=MiniParse.Spec.Base.fst(310,2-314,3); use=MiniParse.Spec.Base.fst(310,2-314,3)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
MiniParse.Spec.Base.bytes)
...
(let ((@lb4 (MiniParse.Spec.Base.parse @x0
@x1
@x3)))
(ite (is-FStar.Pervasives.Native.Some @lb4)

;; def=MiniParse.Spec.Base.fst(313,4-313,28); use=MiniParse.Spec.Base.fst(313,4-313,28)
(= (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2__1 (FStar.Pervasives.Native.Some_v @lb4)))
(FStar.Seq.Base.slice (MiniParse.Spec.Base.byte Dummy_value)
@x3
...
;;no pats
:qid equation_MiniParse.Spec.Base.serializer_complete.1))
)
...
@x1
@x2))
:qid equation_MiniParse.Spec.Base.serializer_complete))

:named equation_MiniParse.Spec.Base.serializer_complete))
;;;;;;;;;;;;;;;;Prop-typing for MiniParse.Spec.Base.serializer_complete
;;; Fact-ids: Name MiniParse.Spec.Base.serializer_complete; Namespace MiniParse.Spec.Base
(assert (! 
;; def=MiniParse.Spec.Base.fst(305,4-305,23); use=MiniParse.Spec.Base.fst(305,4-305,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
(MiniParse.Spec.Base.bare_serializer @x0)))
(Valid (Prims.subtype_of (MiniParse.Spec.Base.serializer_complete @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (MiniParse.Spec.Base.serializer_complete @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_MiniParse.Spec.Base.serializer_complete))

:named defn_equation_MiniParse.Spec.Base.serializer_complete))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Prims.l_imp; Namespace Prims
(assert (! 
;; def=Prims.fst(204,12-204,26); use=Prims.fst(204,57-204,68)
...
; Starting query at MiniParse.Spec.Base.fst(323,1-337,54)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_a35b41c05b41680ad74f589aaa7434fc (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(325,4-331,7); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_a35b41c05b41680ad74f589aaa7434fc @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_a35b41c05b41680ad74f589aaa7434fc @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_a35b41c05b41680ad74f589aaa7434fc))

:named refinement_kinding_Tm_refine_a35b41c05b41680ad74f589aaa7434fc))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(325,4-331,7); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a35b41c05b41680ad74f589aaa7434fc @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Prims.fst(635,71-635,97); use=MiniParse.Spec.Base.fst(323,1-337,54)
(not 
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(323,1-337,54)
(and 
;; def=MiniParse.Spec.Base.fst(326,14-326,33); use=MiniParse.Spec.Base.fst(323,1-337,54)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x2
(MiniParse.Spec.Base.consumed_length @x3))
(MiniParse.Spec.Base.parse @x2
@x4
@x3)))
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=MiniParse.Spec.Base.fst(328,6-328,23); use=MiniParse.Spec.Base.fst(323,1-337,54)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x2
(MiniParse.Spec.Base.consumed_length @x3))
(MiniParse.Spec.Base.parse @x2
@x4
...
(let ((@lb7 (MiniParse.Spec.Base.parse @x2
@x4
@x3)))
(ite (is-FStar.Pervasives.Native.Some @lb7)

;; def=MiniParse.Spec.Base.fst(330,6-330,30); use=MiniParse.Spec.Base.fst(323,1-337,54)
(= (ApplyTT @x5
...
;; def=Prims.fst(635,86-635,95); use=MiniParse.Spec.Base.fst(323,1-337,54)
(not 
;; def=Prims.fst(635,86-635,95); use=MiniParse.Spec.Base.fst(323,1-337,54)
(= @x6
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_a35b41c05b41680ad74f589aaa7434fc.1))
)
)
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_a35b41c05b41680ad74f589aaa7434fc))

:named refinement_interpretation_Tm_refine_a35b41c05b41680ad74f589aaa7434fc))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a35b41c05b41680ad74f589aaa7434fc
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(325,4-331,7); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a35b41c05b41680ad74f589aaa7434fc @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_a35b41c05b41680ad74f589aaa7434fc @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_a35b41c05b41680ad74f589aaa7434fc))

:named haseqTm_refine_a35b41c05b41680ad74f589aaa7434fc))
;;;;;;;;;;;;;;;;s: bytes   -> FStar.Pervasives.Lemma (requires Some? (parse p s))       (ensures         Some? (parse p s) /\         (let FStar.Pervasives.Native.Some (x, len) = parse p s in           f x == FStar.Seq.Base.slice s 0 len))
(declare-fun Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(324,8-331,7); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f))

:named kinding_Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(324,8-331,7); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid MiniParse.Spec.Base_pre_typing_Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f))

:named MiniParse.Spec.Base_pre_typing_Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(324,8-331,7); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f @x1
@x2
@x3))
(and 
;; def=MiniParse.Spec.Base.fst(324,8-331,7); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x4 Term))
 (! (implies (and 
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(323,1-337,54)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x3
...
(HasType (ApplyTT @x0
@x4)
(Tm_refine_a35b41c05b41680ad74f589aaa7434fc @x3
@x4
@x2
@x1)))
...
:pattern ((ApplyTT @x0
@x4))
:qid MiniParse.Spec.Base_interpretation_Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f.1))
...
@x2
@x3)))
:qid MiniParse.Spec.Base_interpretation_Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f))

:named MiniParse.Spec.Base_interpretation_Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f))


(declare-fun Tm_refine_645ec1b8fd4525b988ac624aee47f68f (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(83,6-83,25); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_645ec1b8fd4525b988ac624aee47f68f @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_645ec1b8fd4525b988ac624aee47f68f @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_645ec1b8fd4525b988ac624aee47f68f))

:named refinement_kinding_Tm_refine_645ec1b8fd4525b988ac624aee47f68f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(83,6-83,25); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_645ec1b8fd4525b988ac624aee47f68f @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=FStar.Classical.fsti(83,12-83,25); use=MiniParse.Spec.Base.fst(323,1-337,54)
(implies 
;; def=MiniParse.Spec.Base.fst(326,14-326,33); use=MiniParse.Spec.Base.fst(323,1-337,54)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x2
(MiniParse.Spec.Base.consumed_length @x3))
...
;; def=MiniParse.Spec.Base.fst(327,13-331,6); use=MiniParse.Spec.Base.fst(323,1-337,54)
(and 
;; def=MiniParse.Spec.Base.fst(328,6-328,23); use=MiniParse.Spec.Base.fst(323,1-337,54)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x2
(MiniParse.Spec.Base.consumed_length @x3))
...
;;no pats
:qid refinement_interpretation_Tm_refine_645ec1b8fd4525b988ac624aee47f68f.1))
)
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_645ec1b8fd4525b988ac624aee47f68f))

:named refinement_interpretation_Tm_refine_645ec1b8fd4525b988ac624aee47f68f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_645ec1b8fd4525b988ac624aee47f68f
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(83,6-83,25); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_645ec1b8fd4525b988ac624aee47f68f @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_645ec1b8fd4525b988ac624aee47f68f @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_645ec1b8fd4525b988ac624aee47f68f))

:named haseqTm_refine_645ec1b8fd4525b988ac624aee47f68f))
;;;;;;;;;;;;;;;;x: bytes   -> FStar.Pervasives.Lemma     (ensures       Some? (parse p x) ==>       Some? (parse p x) /\       (let FStar.Pervasives.Native.Some (x, len) = parse p x in         f x == FStar.Seq.Base.slice x 0 len))
(declare-fun Tm_arrow_fc4da87cb313beea20a62dc0d0f65091 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fc4da87cb313beea20a62dc0d0f65091
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(324,8-324,13); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_fc4da87cb313beea20a62dc0d0f65091 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_fc4da87cb313beea20a62dc0d0f65091 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_fc4da87cb313beea20a62dc0d0f65091))

:named kinding_Tm_arrow_fc4da87cb313beea20a62dc0d0f65091))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(324,8-324,13); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_fc4da87cb313beea20a62dc0d0f65091 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid MiniParse.Spec.Base_pre_typing_Tm_arrow_fc4da87cb313beea20a62dc0d0f65091))

:named MiniParse.Spec.Base_pre_typing_Tm_arrow_fc4da87cb313beea20a62dc0d0f65091))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_fc4da87cb313beea20a62dc0d0f65091
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(324,8-324,13); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_fc4da87cb313beea20a62dc0d0f65091 @x1
@x2
@x3))
(and 
;; def=MiniParse.Spec.Base.fst(324,8-324,13); use=MiniParse.Spec.Base.fst(323,1-337,54)
...
(HasType (ApplyTT @x0
@x4)
(Tm_refine_645ec1b8fd4525b988ac624aee47f68f @x3
@x4
@x2
@x1)))
...
:pattern ((ApplyTT @x0
@x4))
:qid MiniParse.Spec.Base_interpretation_Tm_arrow_fc4da87cb313beea20a62dc0d0f65091.1))
...
@x2
@x3)))
:qid MiniParse.Spec.Base_interpretation_Tm_arrow_fc4da87cb313beea20a62dc0d0f65091))

:named MiniParse.Spec.Base_interpretation_Tm_arrow_fc4da87cb313beea20a62dc0d0f65091))

(declare-fun Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(327,13-331,6); use=MiniParse.Spec.Base.fst(337,50-337,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8 @x0
@x1
@x2)
Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e)
 

:pattern ((Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8 @x0
@x1
@x2))
:qid typing_Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8))

:named typing_Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(327,13-331,6); use=MiniParse.Spec.Base.fst(337,50-337,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8 @x1
@x2
@x3)
@x0)
...
@x2
@x0)))
(let ((@lb4 (MiniParse.Spec.Base.parse @x1
@x2
@x0)))
(ite (is-FStar.Pervasives.Native.Some @lb4)
...
:pattern ((ApplyTT (Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8))

:named interpretation_Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8))

(declare-fun Tm_abs_018ccdca44a3970221b5587bbd553846 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_018ccdca44a3970221b5587bbd553846
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(83,12-83,25); use=MiniParse.Spec.Base.fst(337,36-337,49)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_018ccdca44a3970221b5587bbd553846 @x0
@x1
@x2)
Tm_arrow_6ad57bb949e0d6345a8ea332ec1a107e)
 

:pattern ((Tm_abs_018ccdca44a3970221b5587bbd553846 @x0
@x1
@x2))
:qid typing_Tm_abs_018ccdca44a3970221b5587bbd553846))

:named typing_Tm_abs_018ccdca44a3970221b5587bbd553846))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_018ccdca44a3970221b5587bbd553846
;;; Fact-ids: 
(assert (! 
;; def=FStar.Classical.fsti(83,12-83,25); use=MiniParse.Spec.Base.fst(337,36-337,49)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_018ccdca44a3970221b5587bbd553846 @x1
@x2
@x3)
@x0)
(Prims.l_imp (Prims.b2t (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x1
(MiniParse.Spec.Base.consumed_length @x0))
(MiniParse.Spec.Base.parse @x1
@x2
@x0)))
...
:pattern ((ApplyTT (Tm_abs_018ccdca44a3970221b5587bbd553846 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_018ccdca44a3970221b5587bbd553846))

:named interpretation_Tm_abs_018ccdca44a3970221b5587bbd553846))

; Encoding query formula : forall (t: Type) (p: MiniParse.Spec.Base.parser_spec t) (f: MiniParse.Spec.Base.bare_serializer t).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     MiniParse.Spec.Base.serializer_correct p f /\
;     (forall (pure_result: Prims.unit). MiniParse.Spec.Base.serializer_complete p f ==> p pure_result
;     ) ==>
;     (forall (s: MiniParse.Spec.Base.bytes)
;         (_: Prims.squash (Some? (MiniParse.Spec.Base.parse p s))).
;         (*  - Could not prove post-condition
; *)
;         Some? (MiniParse.Spec.Base.parse p s) ==>
;         (forall (any_result:
;             FStar.Pervasives.Native.option (t & MiniParse.Spec.Base.consumed_length s)).
;             MiniParse.Spec.Base.parse p s == any_result ==>
;             (~(Some? (MiniParse.Spec.Base.parse p s)) ==> Prims.l_False) /\
;             (forall (b: t) (b: MiniParse.Spec.Base.consumed_length s).
;                 MiniParse.Spec.Base.parse p s == FStar.Pervasives.Native.Some (b, b) ==>
...
;                     b <= FStar.Seq.Base.length s ==> 0 <= b && b <= FStar.Seq.Base.length s)))) /\
;     (forall (s: MiniParse.Spec.Base.bytes).
;         (forall (_: Prims.squash (Some? (MiniParse.Spec.Base.parse p s))).
;             (*  - Could not prove post-condition
; *)
;             Some? (MiniParse.Spec.Base.parse p s) ==>
;             (forall (any_result:
...
;             (forall (pure_result: Prims.unit).
;                 Some? (MiniParse.Spec.Base.parse p s) /\
;                 (let FStar.Pervasives.Native.Some (x, len) = MiniParse.Spec.Base.parse p s in
;                   f x == FStar.Seq.Base.slice s 0 len) ==>
;                 p pure_result) ==>
;             (forall (any_result:
;                 FStar.Pervasives.Native.option (t & MiniParse.Spec.Base.consumed_length s)).
;                 MiniParse.Spec.Base.parse p s == any_result ==>
...
;                 (forall (b: t) (b: MiniParse.Spec.Base.consumed_length s).
;                     MiniParse.Spec.Base.parse p s == FStar.Pervasives.Native.Some (b, b) ==>
;                     MiniParse.Spec.Base.no_lookahead_weak_on p.f (f b) s /\
;                     (forall (pure_result: Prims.unit).
;                         MiniParse.Spec.Base.no_lookahead_weak_on p.f (f b) s ==>
;                         MiniParse.Spec.Base.injective_precond p.f (f b) s /\
;                         (forall (pure_result: Prims.unit).
;                             MiniParse.Spec.Base.injective_precond p.f (f b) s ==>
;                             MiniParse.Spec.Base.injective_postcond p.f (f b) s /\
;                             (forall (pure_result: Prims.unit).
;                                 MiniParse.Spec.Base.injective_postcond p.f (f b) s ==> p pure_result
;                             ))))))) /\
;     (forall (any_result:
;         (s: MiniParse.Spec.Base.bytes
;             -> FStar.Pervasives.Lemma (requires Some? (MiniParse.Spec.Base.parse p s))
;                 (ensures
;                   Some? (MiniParse.Spec.Base.parse p s) /\
;                   (let FStar.Pervasives.Native.Some (x, len) = MiniParse.Spec.Base.parse p s in
;                     f x == FStar.Seq.Base.slice s 0 len)))).
;         (forall (x: MiniParse.Spec.Base.bytes).
;             (*  - Could not prove post-condition
; *)
;             Some? (MiniParse.Spec.Base.parse p x) ==>
;             Some? (MiniParse.Spec.Base.parse p x) ==>
;             (forall (any_result:
;                 FStar.Pervasives.Native.option (t & MiniParse.Spec.Base.consumed_length x)).
;                 MiniParse.Spec.Base.parse p x == any_result ==>
;                 (~(Some? (MiniParse.Spec.Base.parse p x)) ==> Prims.l_False) /\
;                 (forall (b: t) (b: MiniParse.Spec.Base.consumed_length x).
;                     MiniParse.Spec.Base.parse p x == FStar.Pervasives.Native.Some (b, b) ==>
;                     (forall (any_result: FStar.Seq.Base.seq MiniParse.Spec.Base.byte).
;                         f b == any_result ==>
;                         b <= FStar.Seq.Base.length x ==> 0 <= b && b <= FStar.Seq.Base.length x)))) /\
;         (forall (any_result: (_: MiniParse.Spec.Base.bytes -> Prims.GTot Type0)).
;             (fun x ->
;                 Some? (MiniParse.Spec.Base.parse p x) ==>
;                 Some? (MiniParse.Spec.Base.parse p x) /\
;                 (let FStar.Pervasives.Native.Some (x, len) = MiniParse.Spec.Base.parse p x in
;                   f x == FStar.Seq.Base.slice x 0 len)) ==
;             any_result ==>
;             (forall (s: MiniParse.Spec.Base.bytes).
;                 (*  - Could not prove post-condition
; *)
...
;                             b <= FStar.Seq.Base.length s ==> 0 <= b && b <= FStar.Seq.Base.length s)
;                     ))) /\
;             (forall (any_result: (_: MiniParse.Spec.Base.bytes -> Type0)).
;                 (fun s ->
;                     Some? (MiniParse.Spec.Base.parse p s) /\
;                     (let FStar.Pervasives.Native.Some (x, len) = MiniParse.Spec.Base.parse p s in
;                       f x == FStar.Seq.Base.slice s 0 len)) ==
...
;                             Some? (MiniParse.Spec.Base.parse p x) ==>
;                             Some? (MiniParse.Spec.Base.parse p x) /\
;                             (let FStar.Pervasives.Native.Some (x, len) =
;                                 MiniParse.Spec.Base.parse p x
;                               in
;                               f x == FStar.Seq.Base.slice x 0 len))))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let serializer_correct_implies_complete`
...
;; def=MiniParse.Spec.Base.fst(321,12-321,36); use=MiniParse.Spec.Base.fst(323,1-337,54)
(Valid 
;; def=MiniParse.Spec.Base.fst(321,12-321,36); use=MiniParse.Spec.Base.fst(323,1-337,54)
(MiniParse.Spec.Base.serializer_correct @x0
@x1
...
;; def=MiniParse.Spec.Base.fst(322,11-322,36); use=MiniParse.Spec.Base.fst(323,1-337,54)
(or label_2

;; def=MiniParse.Spec.Base.fst(322,11-322,36); use=MiniParse.Spec.Base.fst(323,1-337,54)
(Valid 
;; def=MiniParse.Spec.Base.fst(322,11-322,36); use=MiniParse.Spec.Base.fst(323,1-337,54)
(MiniParse.Spec.Base.serializer_complete @x0
@x1
@x2)
)
)
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(323,1-337,54)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(323,1-337,54)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(323,1-337,54)
(and 
;; def=dummy(0,0-0,0); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
MiniParse.Spec.Base.bytes)
(HasType @x5
(Prims.squash (Prims.b2t (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
(MiniParse.Spec.Base.parse @x0
@x1
@x4)))))

;; def=MiniParse.Spec.Base.fst(328,6-328,23); use=MiniParse.Spec.Base.fst(328,6-328,23)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
(MiniParse.Spec.Base.parse @x0
@x1
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(327,13-331,6)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))))

;; def=MiniParse.Spec.Base.fst(329,11-329,37); use=MiniParse.Spec.Base.fst(329,11-329,37)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x4)
@x6)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(327,13-331,6)
(and (implies 
;; def=MiniParse.Spec.Base.fst(329,11-329,24); use=MiniParse.Spec.Base.fst(329,11-329,24)
(not 
;; def=MiniParse.Spec.Base.fst(329,11-329,24); use=MiniParse.Spec.Base.fst(329,11-329,24)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(327,13-331,6)
(forall ((@x7 Term))
 (! (implies (HasType @x7
@x0)
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(327,13-331,6)
(= (ApplyTT @x2
@x7)
@x9)


;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(330,27-330,30)
(<= (BoxInt_proj_0 @x8)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x4)))
)

;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(330,27-330,30)
(and 
;; def=MiniParse.Spec.Base.fst(329,20-329,23); use=MiniParse.Spec.Base.fst(330,27-330,30)
(or label_4
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
@x8)))
...
;; def=Prims.fst(406,51-406,91); use=MiniParse.Spec.Base.fst(323,1-337,54)
(and 
;; def=dummy(0,0-0,0); use=MiniParse.Spec.Base.fst(332,3-335,67)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.squash (Prims.b2t (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
...
;; def=MiniParse.Spec.Base.fst(328,6-328,23); use=MiniParse.Spec.Base.fst(332,3-335,67)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
(MiniParse.Spec.Base.parse @x0
@x1
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(332,3-335,67)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))))

;; def=MiniParse.Spec.Base.fst(329,11-329,37); use=MiniParse.Spec.Base.fst(332,3-335,67)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x4)
@x6)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(332,3-335,67)
(and (implies 
;; def=MiniParse.Spec.Base.fst(329,11-329,24); use=MiniParse.Spec.Base.fst(332,3-335,67)
(not 
;; def=MiniParse.Spec.Base.fst(329,11-329,24); use=MiniParse.Spec.Base.fst(332,3-335,67)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(332,3-335,67)
(forall ((@x7 Term))
 (! (implies (HasType @x7
@x0)
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(332,3-335,67)
(= (ApplyTT @x2
@x7)
@x9)


;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(332,3-335,67)
(<= (BoxInt_proj_0 @x8)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x4)))
)

;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(332,3-335,67)
(and 
;; def=MiniParse.Spec.Base.fst(329,20-329,23); use=MiniParse.Spec.Base.fst(330,27-330,30)
(or label_7
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
...
;; def=MiniParse.Spec.Base.fst(326,14-326,33); use=MiniParse.Spec.Base.fst(332,3-335,67)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
(MiniParse.Spec.Base.parse @x0
@x1
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(332,3-335,67)
(forall ((@x6 Term))
...
;; def=MiniParse.Spec.Base.fst(330,6-330,30); use=MiniParse.Spec.Base.fst(332,3-335,67)
(or label_11
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(332,3-335,67)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(332,3-335,67)
(ApplyTT @x5
@x6)
...
;; def=MiniParse.Spec.Base.fst(332,9-332,35); use=MiniParse.Spec.Base.fst(332,9-332,35)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x4)
@x6)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(332,3-335,67)
(and (implies 
;; def=MiniParse.Spec.Base.fst(332,9-332,22); use=MiniParse.Spec.Base.fst(332,9-332,22)
(not 
;; def=MiniParse.Spec.Base.fst(332,9-332,22); use=MiniParse.Spec.Base.fst(332,9-332,22)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(333,4-333,10)
(and 
;; def=MiniParse.Spec.Base.fst(333,11-333,69); use=MiniParse.Spec.Base.fst(333,4-333,10)
(or label_13
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(333,4-333,10)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.unit)
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(334,4-334,10)
(and 
;; def=MiniParse.Spec.Base.fst(334,11-334,66); use=MiniParse.Spec.Base.fst(334,4-334,10)
(or label_14
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(334,4-334,10)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(335,4-335,10)
(and 
;; def=MiniParse.Spec.Base.fst(335,11-335,67); use=MiniParse.Spec.Base.fst(335,4-335,10)
(or label_15
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(335,4-335,10)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
Prims.unit)
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(335,4-335,10)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(335,4-335,10)
(ApplyTT @x5
@x11)
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(323,1-337,54)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Tm_arrow_6dc6a9a161afc7c6dd91d3e79c59550f @x2
@x1
...
;; def=MiniParse.Spec.Base.fst(326,14-326,33); use=MiniParse.Spec.Base.fst(337,36-337,49)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x5))
(MiniParse.Spec.Base.parse @x0
@x1
...
;; def=MiniParse.Spec.Base.fst(328,6-328,23); use=MiniParse.Spec.Base.fst(337,36-337,49)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x5))
(MiniParse.Spec.Base.parse @x0
@x1
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(337,36-337,49)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x5))))

;; def=MiniParse.Spec.Base.fst(329,28-329,37); use=MiniParse.Spec.Base.fst(337,36-337,49)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x5)
@x6)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(337,36-337,49)
(and (implies 
;; def=MiniParse.Spec.Base.fst(329,28-329,37); use=MiniParse.Spec.Base.fst(337,36-337,49)
(not 
;; def=MiniParse.Spec.Base.fst(329,28-329,37); use=MiniParse.Spec.Base.fst(337,36-337,49)
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(337,36-337,49)
(forall ((@x7 Term))
 (! (implies (HasType @x7
@x0)
...
;; def=MiniParse.Spec.Base.fst(329,11-329,37); use=MiniParse.Spec.Base.fst(337,36-337,49)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x5)
(FStar.Pervasives.Native.Some (FStar.Pervasives.Native.tuple2 @x0
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(337,36-337,49)
(= (ApplyTT @x2
@x7)
@x9)


;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(337,36-337,49)
(<= (BoxInt_proj_0 @x8)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x5)))
)

;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(337,36-337,49)
(and 
;; def=MiniParse.Spec.Base.fst(329,20-329,23); use=MiniParse.Spec.Base.fst(330,27-330,30)
(or label_17
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
...
;; def=FStar.Classical.fsti(83,12-240,31); use=MiniParse.Spec.Base.fst(323,1-337,54)
(= (Tm_abs_018ccdca44a3970221b5587bbd553846 @x0
@x1
@x2)
@x5)
)
...
;; def=MiniParse.Spec.Base.fst(328,6-328,23); use=MiniParse.Spec.Base.fst(337,50-337,53)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x6))
(MiniParse.Spec.Base.parse @x0
@x1
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(337,50-337,53)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x6))))

;; def=MiniParse.Spec.Base.fst(329,28-329,37); use=MiniParse.Spec.Base.fst(337,50-337,53)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x6)
@x7)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(337,50-337,53)
(and (implies 
;; def=MiniParse.Spec.Base.fst(329,28-329,37); use=MiniParse.Spec.Base.fst(337,50-337,53)
(not 
;; def=MiniParse.Spec.Base.fst(329,28-329,37); use=MiniParse.Spec.Base.fst(337,50-337,53)
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(337,50-337,53)
(forall ((@x8 Term))
 (! (implies (HasType @x8
@x0)
...
;; def=MiniParse.Spec.Base.fst(329,11-329,37); use=MiniParse.Spec.Base.fst(337,50-337,53)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x6)
(FStar.Pervasives.Native.Some (FStar.Pervasives.Native.tuple2 @x0
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(337,50-337,53)
(= (ApplyTT @x2
@x8)
@x10)


;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(337,50-337,53)
(<= (BoxInt_proj_0 @x9)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x6)))
)

;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(337,50-337,53)
(and 
;; def=MiniParse.Spec.Base.fst(329,20-329,23); use=MiniParse.Spec.Base.fst(330,27-330,30)
(or label_20
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
...
;; def=FStar.Classical.fsti(80,11-80,12); use=MiniParse.Spec.Base.fst(323,1-337,54)
(= (Tm_abs_3bbaa60af1e8b5a0bf3005eb599becd8 @x0
@x1
@x2)
@x6)
)
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(337,12-337,24)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=FStar.Classical.fsti(241,12-241,32); use=MiniParse.Spec.Base.fst(337,12-337,24)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
MiniParse.Spec.Base.bytes)

;; def=MiniParse.Spec.Base.fst(326,14-326,33); use=MiniParse.Spec.Base.fst(337,12-337,24)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x9))
(MiniParse.Spec.Base.parse @x0
@x1
@x9)))
)

;; def=MiniParse.Spec.Base.fst(327,13-331,6); use=MiniParse.Spec.Base.fst(337,12-337,24)
(and 
;; def=MiniParse.Spec.Base.fst(328,6-328,23); use=MiniParse.Spec.Base.fst(337,12-337,24)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x9))
(MiniParse.Spec.Base.parse @x0
@x1
...
(let ((@lb10 (MiniParse.Spec.Base.parse @x0
@x1
@x9)))
(ite (is-FStar.Pervasives.Native.Some @lb10)

;; def=MiniParse.Spec.Base.fst(330,6-330,30); use=MiniParse.Spec.Base.fst(337,12-337,24)
(= (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2__1 (FStar.Pervasives.Native.Some_v @lb10)))
(FStar.Seq.Base.slice (MiniParse.Spec.Base.byte Dummy_value)
@x9
(BoxInt 0)
(FStar.Pervasives.Native.Mktuple2__2 (FStar.Pervasives.Native.Some_v @lb10))))
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(337,12-337,24)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(337,12-337,24)
(ApplyTT @x3
@x8)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.serializer_correct_implies_complete, 1)
; STATUS: unsat
...
; encoding sigelt let serializer_correct_implies_complete
...
; encoding sigelt type MiniParse.Spec.Base.serializer_spec
...
; encoding sigelt val MiniParse.Spec.Base.uu___is_Serializer
...
; encoding sigelt let uu___is_Serializer


; <Skipped let uu___is_Serializer/>


; encoding sigelt val MiniParse.Spec.Base.__proj__Serializer__item__f
...
; encoding sigelt let __proj__Serializer__item__f
...
; Starting query at MiniParse.Spec.Base.fst(353,2-353,3)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


; Encoding query formula : forall (t2: Type)
;   (t1: Type)
;   (p: MiniParse.Spec.Base.parser_spec t1)
;   (s: MiniParse.Spec.Base.serializer_spec p)
;   (u186: Prims.squash (t2 == t1)).
;   t2 == t1 /\ t1 == t2


; Context: While encoding a query
; While typechecking the top-level declaration `let coerce_serializer`
...
;; def=MiniParse.Spec.Base.fst(275,12-350,4); use=MiniParse.Spec.Base.fst(353,2-353,3)
(and 
;; def=MiniParse.Spec.Base.fst(275,12-275,22); use=MiniParse.Spec.Base.fst(353,2-353,3)
(or label_1
...
;; def=MiniParse.Spec.Base.fst(347,3-348,6); use=MiniParse.Spec.Base.fst(353,2-353,3)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.coerce_serializer, 1)
; STATUS: unsat
...
; encoding sigelt let coerce_serializer
...
;;;;;;;;;;;;;;;;t2: Type -> s: serializer_spec p -> u248: Prims.squash (t2 == t1) -> serializer_spec p
...
; Starting query at MiniParse.Spec.Base.fst(364,2-365,53)
...
;;; Fact-ids: 
(assert (! 
;; def=MiniParse.Spec.Base.fst(362,25-362,83); use=MiniParse.Spec.Base.fst(364,2-365,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_20b3d72baf4e53935cb2d67c13936e9a @x0
@x1
@x2
...
;; def=MiniParse.Spec.Base.fst(362,50-362,82); use=MiniParse.Spec.Base.fst(364,2-365,53)
(= (MiniParse.Spec.Base.parse @x3
@x2
@x4)
(MiniParse.Spec.Base.parse @x1
...
;           MiniParse.Spec.Base.parse p1 input == MiniParse.Spec.Base.parse p2 input) ==
;       any_result ==>
;       (forall (_: MiniParse.Spec.Base.serializer_spec p2).
;           t1 == t2 ==>
;           (forall (input: MiniParse.Spec.Base.bytes)
;               (any_result:
;               FStar.Pervasives.Native.option (t1 & MiniParse.Spec.Base.consumed_length input)).
...
;                   FStar.Pervasives.Native.option (t2 & MiniParse.Spec.Base.consumed_length input)).
;                   MiniParse.Spec.Base.parse p2 input == any_result ==> t2 == t1)))) /\
;   (forall (p: Prims.pure_post (MiniParse.Spec.Base.serializer_spec p2)).
;       t1 == t2 /\
;       (forall (input: MiniParse.Spec.Base.bytes).
;           MiniParse.Spec.Base.parse p1 input == MiniParse.Spec.Base.parse p2 input) /\
;       (forall (pure_result: MiniParse.Spec.Base.serializer_spec p2).
;           Prims.auto_squash (p pure_result)) ==>
;       t1 == t2 /\
;       (forall (input: MiniParse.Spec.Base.bytes).
;           MiniParse.Spec.Base.parse p1 input == MiniParse.Spec.Base.parse p2 input) /\
;       (forall (pure_result: Prims.unit).
;           (MiniParse.Spec.Base.serializer_correct p1 s1.f <==>
;             MiniParse.Spec.Base.serializer_correct p2 s1.f) ==>
;           (forall (_: t2). Prims.has_type _ t1) /\
;           (forall (return_val: MiniParse.Spec.Base.bare_serializer t2).
;               return_val == s1.f ==>
;               Prims.auto_squash (MiniParse.Spec.Base.serializer_correct p2 s1.f) /\
;               (forall (return_val:
;                   f:
;                   MiniParse.Spec.Base.bare_serializer t2
;                     {MiniParse.Spec.Base.serializer_correct p2 f}).
;                   return_val == s1.f ==>
;                   s1.f == return_val ==>
;                   (forall (any_result: MiniParse.Spec.Base.serializer_spec p2).
;                       any_result == MiniParse.Spec.Base.Serializer s1.f ==>
;                       (forall (return_val: MiniParse.Spec.Base.serializer_spec p2).
;                           return_val == any_result ==> p return_val))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let serialize_ext`
...
;; def=Prims.fst(406,51-459,89); use=Prims.fst(430,19-430,32)
(and (implies 
;; def=MiniParse.Spec.Base.fst(362,13-362,21); use=MiniParse.Spec.Base.fst(364,2-365,53)
(= @x0
@x3)


;; def=dummy(0,0-0,0); use=MiniParse.Spec.Base.fst(364,2-365,53)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
MiniParse.Spec.Base.bytes)
(HasType @x6
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(364,2-365,53)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x5)
@x6)
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(364,2-365,53)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x3
(MiniParse.Spec.Base.consumed_length @x5))))

;; def=MiniParse.Spec.Base.fst(254,7-362,82); use=MiniParse.Spec.Base.fst(364,2-365,53)
(= (MiniParse.Spec.Base.parse @x3
@x4
@x5)
@x7)
...
;; def=MiniParse.Spec.Base.fst(356,4-359,6); use=MiniParse.Spec.Base.fst(362,68-362,82)
(or label_1

;; def=MiniParse.Spec.Base.fst(356,4-359,6); use=MiniParse.Spec.Base.fst(364,2-365,53)
(= @x3
@x0)
)
)
...
;; def=Prims.fst(439,23-439,26); use=MiniParse.Spec.Base.fst(364,2-365,53)
(= (Prims.l_and (Prims.eq2 Tm_type
@x0
@x3)
(Prims.l_Forall MiniParse.Spec.Base.bytes
...
(HasType @x8
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x7))))
...
;; def=MiniParse.Spec.Base.fst(356,4-359,6); use=MiniParse.Spec.Base.fst(361,2-361,6)
(or label_2
...
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.pure_post (MiniParse.Spec.Base.serializer_spec @x3
@x4)))
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(364,2-365,53)
(forall ((@x6 Term))
 (! (implies (or label_3
(HasType @x6
(MiniParse.Spec.Base.serializer_spec @x3
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(364,2-365,53)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(364,2-365,53)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(364,2-364,24)
(and 
;; def=MiniParse.Spec.Base.fst(301,13-301,21); use=MiniParse.Spec.Base.fst(364,2-364,24)
(or label_4
...
;; def=MiniParse.Spec.Base.fst(301,25-301,83); use=MiniParse.Spec.Base.fst(364,2-364,24)
(forall ((@x6 Term))
 (! (implies (HasType @x6
MiniParse.Spec.Base.bytes)

;; def=MiniParse.Spec.Base.fst(301,50-301,82); use=MiniParse.Spec.Base.fst(364,2-364,24)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(364,2-364,24)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=MiniParse.Spec.Base.fst(302,11-302,65); use=MiniParse.Spec.Base.fst(364,2-364,24)
(iff 
;; def=MiniParse.Spec.Base.fst(302,12-302,35); use=MiniParse.Spec.Base.fst(364,2-364,24)
(Valid 
;; def=MiniParse.Spec.Base.fst(302,12-302,35); use=MiniParse.Spec.Base.fst(364,2-364,24)
(MiniParse.Spec.Base.serializer_correct @x0
@x1
...
;; def=MiniParse.Spec.Base.fst(302,41-302,64); use=MiniParse.Spec.Base.fst(364,2-364,24)
(Valid 
;; def=MiniParse.Spec.Base.fst(302,41-302,64); use=MiniParse.Spec.Base.fst(364,2-364,24)
(MiniParse.Spec.Base.serializer_correct @x3
@x4
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(364,2-365,53)
(and 
;; def=dummy(0,0-0,0); use=MiniParse.Spec.Base.fst(365,14-365,30)
(forall ((@x7 Term))
 (! (implies (HasType @x7
@x3)

;; def=MiniParse.Spec.Base.fst(365,14-365,30); use=MiniParse.Spec.Base.fst(365,14-365,30)
(or label_6
(HasType @x7
@x0))
)
...
;; def=Prims.fst(356,2-356,58); use=MiniParse.Spec.Base.fst(364,2-365,53)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(MiniParse.Spec.Base.bare_serializer @x3))

;; def=Prims.fst(356,26-356,41); use=MiniParse.Spec.Base.fst(364,2-365,53)
(= @x7
(MiniParse.Spec.Base.__proj__Serializer__item__f @x0
@x1
@x2))
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(364,2-365,53)
(and 
;; def=MiniParse.Spec.Base.fst(343,41-343,63); use=MiniParse.Spec.Base.fst(365,13-365,53)
(or label_7
...
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Tm_refine_8da27fc70f74cdb01995c74e5b0aab3a @x3
@x4))
...
;; def=MiniParse.Spec.Base.fst(343,18-365,53); use=MiniParse.Spec.Base.fst(364,2-365,53)
(= (MiniParse.Spec.Base.__proj__Serializer__item__f @x0
@x1
@x2)
@x8)
...
;; def=MiniParse.Spec.Base.fst(361,7-365,53); use=MiniParse.Spec.Base.fst(364,2-365,53)
(= @x9
(MiniParse.Spec.Base.Serializer @x3
@x4
(MiniParse.Spec.Base.__proj__Serializer__item__f @x0
@x1
@x2)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (MiniParse.Spec.Base.serialize_ext, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_MiniParse.Spec.Base.Serializer, fuel_guarded_inversion_MiniParse.Spec.Base.serializer_spec, proj_equation_MiniParse.Spec.Base.Serializer_f, refinement_interpretation_Tm_refine_8da27fc70f74cdb01995c74e5b0aab3a
...
; encoding sigelt let serialize_ext
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name MiniParse.Spec.Base.serialize_ext; Namespace MiniParse.Spec.Base
(assert (! 
;; def=MiniParse.Spec.Base.fst(355,4-355,17); use=MiniParse.Spec.Base.fst(355,4-355,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and 
;; def=MiniParse.Spec.Base.fst(362,13-362,21); use=MiniParse.Spec.Base.fst(362,13-362,21)
(= @x0
@x3)


;; def=MiniParse.Spec.Base.fst(362,25-362,83); use=MiniParse.Spec.Base.fst(362,25-362,83)
(forall ((@x5 Term))
 (! (implies (HasType @x5
MiniParse.Spec.Base.bytes)

;; def=MiniParse.Spec.Base.fst(362,50-362,82); use=MiniParse.Spec.Base.fst(362,50-362,82)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x5)
(MiniParse.Spec.Base.parse @x3
...
;;no pats
:qid typing_MiniParse.Spec.Base.serialize_ext.1))
...
(HasType @x4
(MiniParse.Spec.Base.parser_spec @x3)))
(HasType (MiniParse.Spec.Base.serialize_ext @x0
@x1
@x2
@x3
@x4)
(Tm_refine_d9c4b4f5350e06d893302895e7b320c0 @x3
@x4)))
 

:pattern ((MiniParse.Spec.Base.serialize_ext @x0
@x1
@x2
@x3
@x4))
:qid typing_MiniParse.Spec.Base.serialize_ext))

:named typing_MiniParse.Spec.Base.serialize_ext))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name MiniParse.Spec.Base.serialize_ext; Namespace MiniParse.Spec.Base
(assert (! 
;; def=MiniParse.Spec.Base.fst(361,7-361,27); use=MiniParse.Spec.Base.fst(361,7-361,27)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_d9c4b4f5350e06d893302895e7b320c0 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_d9c4b4f5350e06d893302895e7b320c0 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_d9c4b4f5350e06d893302895e7b320c0))

:named refinement_kinding_Tm_refine_d9c4b4f5350e06d893302895e7b320c0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name MiniParse.Spec.Base.serialize_ext; Namespace MiniParse.Spec.Base
(assert (! 
;; def=MiniParse.Spec.Base.fst(361,7-361,27); use=MiniParse.Spec.Base.fst(361,7-361,27)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d9c4b4f5350e06d893302895e7b320c0 @x2
@x3))
(HasTypeFuel @u0
@x1
(MiniParse.Spec.Base.serializer_spec @x2
...
(Tm_refine_d9c4b4f5350e06d893302895e7b320c0 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_d9c4b4f5350e06d893302895e7b320c0))

:named refinement_interpretation_Tm_refine_d9c4b4f5350e06d893302895e7b320c0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d9c4b4f5350e06d893302895e7b320c0
;;; Fact-ids: Name MiniParse.Spec.Base.serialize_ext; Namespace MiniParse.Spec.Base
(assert (! 
;; def=MiniParse.Spec.Base.fst(361,7-361,27); use=MiniParse.Spec.Base.fst(361,7-361,27)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d9c4b4f5350e06d893302895e7b320c0 @x0
@x1)))
(Valid (Prims.hasEq (MiniParse.Spec.Base.serializer_spec @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d9c4b4f5350e06d893302895e7b320c0 @x0
@x1))))
:qid haseqTm_refine_d9c4b4f5350e06d893302895e7b320c0))

:named haseqTm_refine_d9c4b4f5350e06d893302895e7b320c0))
;;;;;;;;;;;;;;;;Equation for MiniParse.Spec.Base.serialize_ext
;;; Fact-ids: Name MiniParse.Spec.Base.serialize_ext; Namespace MiniParse.Spec.Base
(assert (! 
;; def=MiniParse.Spec.Base.fst(355,4-355,17); use=MiniParse.Spec.Base.fst(355,4-355,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (MiniParse.Spec.Base.serialize_ext @x0
@x1
@x2
@x3
@x4)
...
@x3
@x4))
:qid equation_MiniParse.Spec.Base.serialize_ext))

:named equation_MiniParse.Spec.Base.serialize_ext))
(push) ;; push{2

; Starting query at MiniParse.Spec.Base.fst(376,2-376,24)
...
;   (t1 == t2 ==> t2 == t1) /\
;   (forall (any_result: Prims.logical).
;       (t1 == t2) /\ (p1 == p2) == any_result ==>
;       (forall (_: MiniParse.Spec.Base.serializer_spec p2). t1 == t2 ==> t2 == t1)) /\
;   (forall (p: Prims.pure_post (MiniParse.Spec.Base.serializer_spec p2)).
;       t1 == t2 /\ p1 == p2 /\
;       (forall (pure_result: MiniParse.Spec.Base.serializer_spec p2).
;           Prims.auto_squash (p pure_result)) ==>
...
;           MiniParse.Spec.Base.parse p1 input == MiniParse.Spec.Base.parse p2 input) /\
;       (forall (pure_result: MiniParse.Spec.Base.serializer_spec p2).
;           pure_result == MiniParse.Spec.Base.serialize_ext p1 s1 p2 ==>
;           (forall (return_val: MiniParse.Spec.Base.serializer_spec p2).
...
;; def=Prims.fst(406,51-459,89); use=Prims.fst(430,19-430,32)
(and (implies 
;; def=MiniParse.Spec.Base.fst(374,13-374,21); use=MiniParse.Spec.Base.fst(376,2-376,24)
(= @x0
@x3)


;; def=MiniParse.Spec.Base.fst(368,4-371,6); use=MiniParse.Spec.Base.fst(374,31-374,33)
(or label_1

;; def=MiniParse.Spec.Base.fst(368,4-371,6); use=MiniParse.Spec.Base.fst(376,2-376,24)
(= @x3
@x0)
)
)

;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(376,2-376,24)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.logical)

;; def=Prims.fst(439,23-439,26); use=MiniParse.Spec.Base.fst(376,2-376,24)
(= (Prims.l_and (Prims.eq2 Tm_type
@x0
@x3)
(Prims.eq2 (MiniParse.Spec.Base.parser_spec @x0)
@x1
@x4))
@x5)
)

;; def=dummy(0,0-0,0); use=MiniParse.Spec.Base.fst(376,2-376,24)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(MiniParse.Spec.Base.serializer_spec @x3
@x4))
...
;; def=MiniParse.Spec.Base.fst(374,25-374,33); use=MiniParse.Spec.Base.fst(376,2-376,24)
(= @x1
@x4)


;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(376,2-376,24)
(forall ((@x6 Term))
 (! (implies (or label_3
(HasType @x6
(MiniParse.Spec.Base.serializer_spec @x3
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(376,2-376,24)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(376,2-376,24)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(376,2-376,24)
(and 
;; def=MiniParse.Spec.Base.fst(362,13-362,21); use=MiniParse.Spec.Base.fst(376,2-376,15)
(or label_4
...
;; def=MiniParse.Spec.Base.fst(362,25-362,83); use=MiniParse.Spec.Base.fst(376,2-376,15)
(forall ((@x6 Term))
 (! (implies (HasType @x6
MiniParse.Spec.Base.bytes)

;; def=MiniParse.Spec.Base.fst(362,50-362,82); use=MiniParse.Spec.Base.fst(376,2-376,15)
(or label_5
...
;; def=MiniParse.Spec.Base.fst(373,7-376,24); use=MiniParse.Spec.Base.fst(376,2-376,24)
(= @x6
(MiniParse.Spec.Base.serialize_ext @x0
@x1
@x2
...
; Starting query at MiniParse.Spec.Base.fst(393,2-393,58)
...
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         MiniParse.Spec.Base.serialize s1 x == MiniParse.Spec.Base.serialize s2 x ==> p pure_result) ==>
;     MiniParse.Spec.Base.serializer_correct p s2.f /\
;     (forall (pure_result: Prims.unit).
;         MiniParse.Spec.Base.serializer_complete p s2.f ==> p pure_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let serializer_unique`
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(393,2-393,58)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=MiniParse.Spec.Base.fst(392,2-392,36); use=MiniParse.Spec.Base.fst(393,2-393,58)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(393,2-393,58)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(393,2-393,58)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(393,2-393,58)
(and 
;; def=MiniParse.Spec.Base.fst(321,12-321,36); use=MiniParse.Spec.Base.fst(393,2-393,37)
(or label_3
...
;; def=MiniParse.Spec.Base.fst(322,11-322,36); use=MiniParse.Spec.Base.fst(393,2-393,37)
(Valid 
;; def=MiniParse.Spec.Base.fst(322,11-322,36); use=MiniParse.Spec.Base.fst(393,2-393,37)
(MiniParse.Spec.Base.serializer_complete @x0
@x1
...
; encoding sigelt let serializer_unique
...
; Starting query at MiniParse.Spec.Base.fst(403,2-403,4)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     MiniParse.Spec.Base.serialize s x1 == MiniParse.Spec.Base.serialize s x2 /\
;     (forall (pure_result: Prims.unit). x1 == x2 ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let serializer_injective`
...
;; def=MiniParse.Spec.Base.fst(401,12-401,46); use=MiniParse.Spec.Base.fst(403,2-403,4)
(= (MiniParse.Spec.Base.serialize @x0
@x1
@x2
@x3)
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(403,2-403,4)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=MiniParse.Spec.Base.fst(402,11-402,21); use=MiniParse.Spec.Base.fst(403,2-403,4)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(403,2-403,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(403,2-403,4)
(ApplyTT @x5
@x6)
...
; encoding sigelt let serializer_injective
...
; Starting query at MiniParse.Spec.Base.fst(420,2-430,63)
...
;     (forall (pure_result: Prims.unit).
;         MiniParse.Spec.Base.parse p1 x == MiniParse.Spec.Base.parse p2 x ==> p pure_result) ==>
;     MiniParse.Spec.Base.serializer_correct p1 s /\
;     (forall (pure_result: Prims.unit).
;         MiniParse.Spec.Base.serializer_complete p1 s ==>
;         (forall (any_result:
;             FStar.Pervasives.Native.option (t & MiniParse.Spec.Base.consumed_length x)).
;             MiniParse.Spec.Base.parse p1 x == any_result ==>
;             (~(Some? (MiniParse.Spec.Base.parse p1 x)) ==> Prims.l_False) /\
;             (forall (b: t) (b: MiniParse.Spec.Base.consumed_length x).
;                 MiniParse.Spec.Base.parse p1 x == FStar.Pervasives.Native.Some (b, b) ==>
;                 (b <= FStar.Seq.Base.length x ==> 0 <= b && b <= FStar.Seq.Base.length x) /\
;                 (forall (any_result: MiniParse.Spec.Base.consumed_length x).
;                     b == any_result ==>
;                     (forall (any_result: FStar.Seq.Base.seq MiniParse.Spec.Base.byte).
;                         FStar.Seq.Base.slice x 0 b == any_result ==>
;                         s b == FStar.Seq.Base.slice x 0 b /\
;                         (forall (pure_result: Prims.unit).
;                             s b == FStar.Seq.Base.slice x 0 b ==>
;                             b == FStar.Seq.Base.length (FStar.Seq.Base.slice x 0 b) /\
;                             (forall (pure_result: Prims.unit).
;                                 b == FStar.Seq.Base.length (FStar.Seq.Base.slice x 0 b) ==>
;                                 (forall (any_result:
;                                     FStar.Pervasives.Native.option (t &
;                                         MiniParse.Spec.Base.consumed_length (FStar.Seq.Base.slice x
;                                               0
;                                               b))).
;                                     MiniParse.Spec.Base.parse p1 (FStar.Seq.Base.slice x 0 b) ==
;                                     any_result ==>
;                                     FStar.Seq.Base.length (FStar.Seq.Base.slice x 0 b) <=
;                                     FStar.Seq.Base.length (FStar.Seq.Base.slice x 0 b) /\
;                                     (forall (any_result: Prims.nat).
;                                         FStar.Seq.Base.length (FStar.Seq.Base.slice x 0 b) ==
;                                         any_result ==>
;                                         (forall (any_result:
;                                             t &
;                                             MiniParse.Spec.Base.consumed_length (FStar.Seq.Base.slice
;                                                   x
;                                                   0
;                                                   b)).
;                                             (b,
...
;                                                     FStar.Pervasives.Native.Some
;                                                     (b,
;                                                     FStar.Seq.Base.length (FStar.Seq.Base.slice x
;                                                           0
;                                                           b)) ==
;                                                     any_result ==>
;                                                     MiniParse.Spec.Base.parse p1
...
; Context: While encoding a query
; While typechecking the top-level declaration `let serializer_parser_unique'`
...
;; def=MiniParse.Spec.Base.fst(413,4-413,27); use=MiniParse.Spec.Base.fst(420,2-430,63)
(Valid 
;; def=MiniParse.Spec.Base.fst(413,4-413,27); use=MiniParse.Spec.Base.fst(420,2-430,63)
(MiniParse.Spec.Base.serializer_correct @x0
@x1
...
;; def=MiniParse.Spec.Base.fst(414,4-414,27); use=MiniParse.Spec.Base.fst(420,2-430,63)
(Valid 
;; def=MiniParse.Spec.Base.fst(414,4-414,27); use=MiniParse.Spec.Base.fst(420,2-430,63)
(MiniParse.Spec.Base.serializer_correct @x0
@x2
...
;; def=MiniParse.Spec.Base.fst(415,4-415,22); use=MiniParse.Spec.Base.fst(420,2-430,63)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
(MiniParse.Spec.Base.parse @x0
@x1
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(420,2-430,63)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=MiniParse.Spec.Base.fst(417,11-419,3); use=MiniParse.Spec.Base.fst(420,2-430,63)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(420,2-430,63)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(420,2-430,63)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(420,2-420,37)
(and 
;; def=MiniParse.Spec.Base.fst(321,12-321,36); use=MiniParse.Spec.Base.fst(420,2-420,37)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(420,2-420,37)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=MiniParse.Spec.Base.fst(322,11-322,36); use=MiniParse.Spec.Base.fst(420,2-420,37)
(Valid 
;; def=MiniParse.Spec.Base.fst(322,11-322,36); use=MiniParse.Spec.Base.fst(420,2-420,37)
(MiniParse.Spec.Base.serializer_complete @x0
@x1
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(420,2-430,63)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))))

;; def=MiniParse.Spec.Base.fst(421,7-421,34); use=MiniParse.Spec.Base.fst(421,7-421,34)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x4)
@x7)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(420,2-430,63)
(and (implies 
;; def=MiniParse.Spec.Base.fst(421,7-421,20); use=MiniParse.Spec.Base.fst(421,7-421,20)
(not 
;; def=MiniParse.Spec.Base.fst(421,7-421,20); use=MiniParse.Spec.Base.fst(421,7-421,20)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(420,2-430,63)
(forall ((@x8 Term))
 (! (implies (HasType @x8
@x0)
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(420,2-430,63)
(and (implies 
;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(422,25-422,28)
(<= (BoxInt_proj_0 @x9)
(BoxInt_proj_0 (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
@x4)))


;; def=FStar.Seq.Base.fsti(64,49-64,72); use=MiniParse.Spec.Base.fst(422,25-422,28)
(and 
;; def=MiniParse.Spec.Base.fst(421,16-421,19); use=MiniParse.Spec.Base.fst(422,25-422,28)
(or label_5
(BoxBool_proj_0 (Prims.op_LessThanOrEqual (BoxInt 0)
@x9)))
...
;; def=FStar.Seq.Base.fsti(64,43-64,44); use=MiniParse.Spec.Base.fst(420,2-430,63)
(= @x9
@x10)
)
...
;; def=MiniParse.Spec.Base.fst(422,6-422,28); use=MiniParse.Spec.Base.fst(422,6-422,28)
(= (FStar.Seq.Base.slice (MiniParse.Spec.Base.byte Dummy_value)
@x4
(BoxInt 0)
@x9)
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(423,2-423,8)
(and 
;; def=MiniParse.Spec.Base.fst(423,9-423,20); use=MiniParse.Spec.Base.fst(423,2-423,8)
(or label_7
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(423,2-423,8)
(forall ((@x12 Term))
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(425,2-425,8)
(and 
;; def=MiniParse.Spec.Base.fst(425,9-425,22); use=MiniParse.Spec.Base.fst(425,2-425,8)
(or label_8
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(425,2-425,8)
(forall ((@x13 Term))
...
;; def=Prims.fst(175,35-175,36); use=MiniParse.Spec.Base.fst(420,2-430,63)
(= (MiniParse.Spec.Base.parse @x0
@x1
(FStar.Seq.Base.slice (MiniParse.Spec.Base.byte Dummy_value)
@x4
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(420,2-430,63)
(and 
;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(426,34-426,38)
(or label_9
...
;; def=FStar.Pervasives.Native.fst(59,43-59,45); use=MiniParse.Spec.Base.fst(420,2-430,63)
(= (FStar.Seq.Base.length (MiniParse.Spec.Base.byte Dummy_value)
(FStar.Seq.Base.slice (MiniParse.Spec.Base.byte Dummy_value)
@x4
(BoxInt 0)
...
;; def=FStar.Pervasives.Native.fst(33,11-33,12); use=MiniParse.Spec.Base.fst(420,2-430,63)
(= (FStar.Pervasives.Native.Mktuple2 @x0
(MiniParse.Spec.Base.consumed_length (FStar.Seq.Base.slice (MiniParse.Spec.Base.byte Dummy_value)
@x4
(BoxInt 0)
...
;; def=Prims.fst(175,42-175,43); use=MiniParse.Spec.Base.fst(420,2-430,63)
(= (FStar.Pervasives.Native.Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length (FStar.Seq.Base.slice (MiniParse.Spec.Base.byte Dummy_value)
@x4
(BoxInt 0)
...
;; def=Prims.fst(672,13-672,14); use=MiniParse.Spec.Base.fst(420,2-430,63)
(= (Prims.eq2 (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length (FStar.Seq.Base.slice (MiniParse.Spec.Base.byte Dummy_value)
@x4
(BoxInt 0)
@x9))))
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(426,2-426,8)
(and 
;; def=MiniParse.Spec.Base.fst(426,9-426,40); use=MiniParse.Spec.Base.fst(426,2-426,8)
(or label_10
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(426,2-426,8)
(forall ((@x19 Term))
...
;; def=Prims.fst(459,77-459,89); use=MiniParse.Spec.Base.fst(420,2-430,63)
(and 
;; def=MiniParse.Spec.Base.fst(40,55-40,72); use=MiniParse.Spec.Base.fst(427,34-427,38)
(or label_11
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(427,2-427,8)
(and 
;; def=MiniParse.Spec.Base.fst(427,9-427,40); use=MiniParse.Spec.Base.fst(427,2-427,8)
(or label_12
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(427,2-427,8)
(forall ((@x25 Term))
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(428,2-428,8)
(and 
;; def=MiniParse.Spec.Base.fst(428,9-428,60); use=MiniParse.Spec.Base.fst(428,2-428,8)
(or label_13
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(428,2-428,8)
(forall ((@x26 Term))
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(429,2-429,8)
(and 
;; def=MiniParse.Spec.Base.fst(429,9-429,69); use=MiniParse.Spec.Base.fst(429,2-429,8)
(or label_14
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(429,2-429,8)
(forall ((@x27 Term))
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(430,2-430,8)
(and 
;; def=MiniParse.Spec.Base.fst(430,9-430,63); use=MiniParse.Spec.Base.fst(430,2-430,8)
(or label_15
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(430,2-430,8)
(forall ((@x28 Term))
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(430,2-430,8)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(430,2-430,8)
(ApplyTT @x5
@x28)
...
; encoding sigelt let serializer_parser_unique'
...
; Starting query at MiniParse.Spec.Base.fst(446,2-450,9)
...
;         Some? (MiniParse.Spec.Base.parse p1 x) == any_result ==>
;         (forall (k: Prims.pure_post Prims.unit).
;             (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} p x ==> k x) ==>
;             (Some? (MiniParse.Spec.Base.parse p1 x) == true ==>
;               MiniParse.Spec.Base.serializer_correct p1 s /\
;               MiniParse.Spec.Base.serializer_correct p2 s /\ Some? (MiniParse.Spec.Base.parse p1 x) /\
;               (forall (pure_result: Prims.unit).
;                   MiniParse.Spec.Base.parse p1 x == MiniParse.Spec.Base.parse p2 x ==> k pure_result
;               )) /\
;             (~(Some? (MiniParse.Spec.Base.parse p1 x) = true) ==>
;               (forall (b: Prims.bool).
;                   Some? (MiniParse.Spec.Base.parse p1 x) == b ==>
;                   (forall (any_result: Prims.bool).
;                       Some? (MiniParse.Spec.Base.parse p2 x) == any_result ==>
;                       (forall (k: Prims.pure_post Prims.unit).
;                           (forall (x: Prims.unit). {:pattern Prims.guard_free (k x)} k x ==> k x) ==>
;                           (Some? (MiniParse.Spec.Base.parse p2 x) == true ==>
;                             MiniParse.Spec.Base.serializer_correct p2 s /\
;                             MiniParse.Spec.Base.serializer_correct p1 s /\
;                             Some? (MiniParse.Spec.Base.parse p2 x) /\
;                             (forall (pure_result: Prims.unit).
;                                 MiniParse.Spec.Base.parse p2 x == MiniParse.Spec.Base.parse p1 x ==>
;                                 k pure_result)) /\
;                           (~(Some? (MiniParse.Spec.Base.parse p2 x) = true) ==>
;                             (forall (b: Prims.bool).
;                                 Some? (MiniParse.Spec.Base.parse p2 x) == b ==>
...
;; def=MiniParse.Spec.Base.fst(440,4-440,27); use=MiniParse.Spec.Base.fst(446,2-450,9)
(Valid 
;; def=MiniParse.Spec.Base.fst(440,4-440,27); use=MiniParse.Spec.Base.fst(446,2-450,9)
(MiniParse.Spec.Base.serializer_correct @x0
@x1
...
;; def=MiniParse.Spec.Base.fst(441,4-441,27); use=MiniParse.Spec.Base.fst(446,2-450,9)
(Valid 
;; def=MiniParse.Spec.Base.fst(441,4-441,27); use=MiniParse.Spec.Base.fst(446,2-450,9)
(MiniParse.Spec.Base.serializer_correct @x0
@x2
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(446,2-450,9)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=MiniParse.Spec.Base.fst(443,11-445,3); use=MiniParse.Spec.Base.fst(446,2-450,9)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(446,2-450,9)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(446,2-450,9)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(451,66-451,102); use=MiniParse.Spec.Base.fst(446,2-450,9)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.bool)

;; def=MiniParse.Spec.Base.fst(446,5-446,23); use=MiniParse.Spec.Base.fst(446,5-446,23)
(= (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
(MiniParse.Spec.Base.parse @x0
@x1
@x4))
...
;; def=Prims.fst(402,2-402,97); use=MiniParse.Spec.Base.fst(446,2-450,9)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Prims.pure_post Prims.unit))
...
(forall ((@x8 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=MiniParse.Spec.Base.fst(446,2-450,9)
(Valid 
;; def=Prims.fst(402,73-402,79); use=MiniParse.Spec.Base.fst(446,2-450,9)
(ApplyTT @x5
@x8)
...
;; def=Prims.fst(402,84-402,87); use=MiniParse.Spec.Base.fst(446,2-450,9)
(Valid 
;; def=Prims.fst(402,84-402,87); use=MiniParse.Spec.Base.fst(446,2-450,9)
(ApplyTT @x7
@x8)
...
;; def=Prims.fst(389,2-389,39); use=MiniParse.Spec.Base.fst(446,2-450,9)
(and (implies 
;; def=MiniParse.Spec.Base.fst(446,5-446,23); use=MiniParse.Spec.Base.fst(446,5-446,23)
(= (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(447,7-447,32)
(and 
;; def=MiniParse.Spec.Base.fst(413,4-413,27); use=MiniParse.Spec.Base.fst(447,7-447,32)
(or label_3
...
;; def=MiniParse.Spec.Base.fst(414,4-414,27); use=MiniParse.Spec.Base.fst(447,7-447,32)
(or label_4
...
;; def=MiniParse.Spec.Base.fst(415,4-415,22); use=MiniParse.Spec.Base.fst(447,7-447,32)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(447,7-447,32)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=MiniParse.Spec.Base.fst(417,11-419,3); use=MiniParse.Spec.Base.fst(447,7-447,32)
(= (MiniParse.Spec.Base.parse @x0
@x1
@x4)
(MiniParse.Spec.Base.parse @x0
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(447,7-447,32)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(447,7-447,32)
(ApplyTT @x7
@x8)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=MiniParse.Spec.Base.fst(446,2-450,9)
(not 
;; def=MiniParse.Spec.Base.fst(446,5-446,23); use=MiniParse.Spec.Base.fst(446,5-446,23)
(= (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
...
;; def=Prims.fst(413,99-413,120); use=MiniParse.Spec.Base.fst(446,2-450,9)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.bool)

;; def=MiniParse.Spec.Base.fst(446,5-450,9); use=MiniParse.Spec.Base.fst(446,5-450,9)
(= (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
(MiniParse.Spec.Base.parse @x0
@x1
...
;; def=MiniParse.Spec.Base.fst(448,10-448,28); use=MiniParse.Spec.Base.fst(448,10-448,28)
(= (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
(MiniParse.Spec.Base.parse @x0
@x2
...
;; def=Prims.fst(441,29-441,97); use=MiniParse.Spec.Base.fst(449,7-449,32)
(and 
;; def=MiniParse.Spec.Base.fst(413,4-413,27); use=MiniParse.Spec.Base.fst(449,7-449,32)
(or label_6
...
;; def=MiniParse.Spec.Base.fst(414,4-414,27); use=MiniParse.Spec.Base.fst(449,7-449,32)
(or label_7
...
;; def=MiniParse.Spec.Base.fst(415,4-415,22); use=MiniParse.Spec.Base.fst(449,7-449,32)
(or label_8
...
;; def=Prims.fst(441,36-441,97); use=MiniParse.Spec.Base.fst(449,7-449,32)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
Prims.unit)

;; def=MiniParse.Spec.Base.fst(417,11-419,3); use=MiniParse.Spec.Base.fst(449,7-449,32)
(= (MiniParse.Spec.Base.parse @x0
@x2
@x4)
(MiniParse.Spec.Base.parse @x0
...
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(449,7-449,32)
(Valid 
;; def=Prims.fst(441,83-441,96); use=MiniParse.Spec.Base.fst(449,7-449,32)
(ApplyTT @x10
@x11)
...
;; def=MiniParse.Spec.Base.fst(448,10-450,9); use=MiniParse.Spec.Base.fst(448,10-450,9)
(= (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 @x0
(MiniParse.Spec.Base.consumed_length @x4))
(MiniParse.Spec.Base.parse @x0
@x2
...
;; def=Prims.fst(451,90-451,102); use=MiniParse.Spec.Base.fst(446,2-450,9)
(Valid 
;; def=Prims.fst(451,90-451,102); use=MiniParse.Spec.Base.fst(446,2-450,9)
(ApplyTT @x10
@x12)
