...
; Internals for BinarySearchTreeFirst
...
; encoding sigelt type BinarySearchTreeFirst.tree


; <Start encoding type BinarySearchTreeFirst.tree>

;;;;;;;;;;;;;;;;Constructor
(declare-fun BinarySearchTreeFirst.tree (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun BinarySearchTreeFirst.tree@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun BinarySearchTreeFirst.Node (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BinarySearchTreeFirst.Node_r (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BinarySearchTreeFirst.Node_l (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BinarySearchTreeFirst.Node_left (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BinarySearchTreeFirst.Node_n (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BinarySearchTreeFirst.Node_right (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: BinarySearchTreeFirst.Node
(declare-fun BinarySearchTreeFirst.Node@tok () Term)
(declare-fun Tm_refine_7bd45d8dd562d256ba02499dea4c4dea (Term Term Term Term) Term)
...
(declare-fun Tm_arrow_c0c05a9e0e8ea458afc4b2948877a868 () Term)

; <start constructor BinarySearchTreeFirst.tree>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-BinarySearchTreeFirst.tree ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
117)
(exists ((@x0 Term))
 (! (= __@x0
(BinarySearchTreeFirst.tree @x0))
 
;;no pats
:qid is-BinarySearchTreeFirst.tree))))

; </end constructor BinarySearchTreeFirst.tree>


; <start constructor BinarySearchTreeFirst.Node>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-BinarySearchTreeFirst.Node ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
125)
(= __@x0
(BinarySearchTreeFirst.Node (BinarySearchTreeFirst.Node_r __@x0)
(BinarySearchTreeFirst.Node_l __@x0)
(BinarySearchTreeFirst.Node_left __@x0)
(BinarySearchTreeFirst.Node_n __@x0)
(BinarySearchTreeFirst.Node_right __@x0)))))

; </end constructor BinarySearchTreeFirst.Node>


; </end encoding type BinarySearchTreeFirst.tree>
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(30,5-30,9); use=BinarySearchTreeFirst.fst(30,5-30,9)
(forall ((@x0 Term))
 (! (= (ApplyTT BinarySearchTreeFirst.tree@tok
@x0)
(BinarySearchTreeFirst.tree @x0))
 

:pattern ((ApplyTT BinarySearchTreeFirst.tree@tok
@x0))

:pattern ((BinarySearchTreeFirst.tree @x0))
:qid token_correspondence_BinarySearchTreeFirst.tree@tok))

:named token_correspondence_BinarySearchTreeFirst.tree@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FStar.Pervasives.Native.option; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.None; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Some; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=FStar.Pervasives.Native.fst(33,4-33,8)
...
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(31,4-31,8); use=BinarySearchTreeFirst.fst(31,4-31,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(BinarySearchTreeFirst.Node @x1
@x2
@x3
@x4
@x5)
(BinarySearchTreeFirst.tree @x6))
...
@x5)
(BinarySearchTreeFirst.tree @x6)))
:qid subterm_ordering_BinarySearchTreeFirst.Node))

:named subterm_ordering_BinarySearchTreeFirst.Node))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(34,11-37,58); use=BinarySearchTreeFirst.fst(34,11-37,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_7bd45d8dd562d256ba02499dea4c4dea @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_7bd45d8dd562d256ba02499dea4c4dea @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_7bd45d8dd562d256ba02499dea4c4dea))

:named refinement_kinding_Tm_refine_7bd45d8dd562d256ba02499dea4c4dea))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7bd45d8dd562d256ba02499dea4c4dea @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x4)))

;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(34,33-34,39)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 @x3))


;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(35,36-35,42)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x4))


;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(36,36-36,58)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x4)
@x1)
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(37,36-37,57)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x2)
@x5)
(Prims.op_Equality Prims.int
@x3
@x2))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_7bd45d8dd562d256ba02499dea4c4dea))

:named refinement_interpretation_Tm_refine_7bd45d8dd562d256ba02499dea4c4dea))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (BinarySearchTreeFirst.Node_right (BinarySearchTreeFirst.Node @x0
@x1
@x2
@x3
@x4))
...
:pattern ((BinarySearchTreeFirst.Node @x0
@x1
@x2
@x3
@x4))
:qid projection_inverse_BinarySearchTreeFirst.Node_right))

:named projection_inverse_BinarySearchTreeFirst.Node_right))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(31,4-31,8); use=BinarySearchTreeFirst.fst(31,4-31,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (BinarySearchTreeFirst.Node_r (BinarySearchTreeFirst.Node @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_BinarySearchTreeFirst.Node_r))

:named projection_inverse_BinarySearchTreeFirst.Node_r))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(31,4-31,8); use=BinarySearchTreeFirst.fst(31,4-31,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (BinarySearchTreeFirst.Node_n (BinarySearchTreeFirst.Node @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_BinarySearchTreeFirst.Node_n))

:named projection_inverse_BinarySearchTreeFirst.Node_n))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(31,4-31,8); use=BinarySearchTreeFirst.fst(31,4-31,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (BinarySearchTreeFirst.Node_left (BinarySearchTreeFirst.Node @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_BinarySearchTreeFirst.Node_left))

:named projection_inverse_BinarySearchTreeFirst.Node_left))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(31,4-31,8); use=BinarySearchTreeFirst.fst(31,4-31,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (BinarySearchTreeFirst.Node_l (BinarySearchTreeFirst.Node @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_BinarySearchTreeFirst.Node_l))

:named projection_inverse_BinarySearchTreeFirst.Node_l))
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! (is-Tm_arrow (PreType BinarySearchTreeFirst.tree@tok))
:named pre_kinding_BinarySearchTreeFirst.tree@tok))
...
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! (and (IsTotFun BinarySearchTreeFirst.tree@tok)

;; def=BinarySearchTreeFirst.fst(30,5-30,9); use=BinarySearchTreeFirst.fst(30,5-30,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (BinarySearchTreeFirst.tree @x0)
Tm_type))
 

:pattern ((BinarySearchTreeFirst.tree @x0))
:qid kinding_BinarySearchTreeFirst.tree@tok))
)
:named kinding_BinarySearchTreeFirst.tree@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_7bd45d8dd562d256ba02499dea4c4dea
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(34,11-37,58); use=BinarySearchTreeFirst.fst(34,11-37,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7bd45d8dd562d256ba02499dea4c4dea @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x2)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7bd45d8dd562d256ba02499dea4c4dea @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_7bd45d8dd562d256ba02499dea4c4dea))

:named haseqTm_refine_7bd45d8dd562d256ba02499dea4c4dea))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(BinarySearchTreeFirst.tree @x2))
(and (is-BinarySearchTreeFirst.Node @x1)
(= @x2
(BinarySearchTreeFirst.Node_r @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(BinarySearchTreeFirst.tree @x2)))
:qid fuel_guarded_inversion_BinarySearchTreeFirst.tree))

:named fuel_guarded_inversion_BinarySearchTreeFirst.tree))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name FStar.Pervasives.Native.option; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.None; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Some; Namespace FStar.Pervasives.Native
(assert (! (= 102
...
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! (= 118
(Term_constr_id BinarySearchTreeFirst.tree@tok))
:named fresh_token_BinarySearchTreeFirst.tree@tok))
...
(HasTypeFuel @u0
@x3
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x2)))
(HasTypeFuel @u0
@x4
Prims.int)
(HasTypeFuel @u0
...
@x5)
(BinarySearchTreeFirst.tree @x1)))
:qid data_typing_intro_BinarySearchTreeFirst.Node@tok))

:named data_typing_intro_BinarySearchTreeFirst.Node@tok))
...
@x5)
(BinarySearchTreeFirst.tree @x6)))
:qid data_elim_BinarySearchTreeFirst.Node))

:named data_elim_BinarySearchTreeFirst.Node))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 117
(Term_constr_id (BinarySearchTreeFirst.tree @x0)))
 

:pattern ((BinarySearchTreeFirst.tree @x0))
:qid constructor_distinct_BinarySearchTreeFirst.tree))

:named constructor_distinct_BinarySearchTreeFirst.tree))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name BinarySearchTreeFirst.tree; Namespace BinarySearchTreeFirst; Name BinarySearchTreeFirst.Node; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(31,4-31,8); use=BinarySearchTreeFirst.fst(31,4-31,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= 125
(Term_constr_id (BinarySearchTreeFirst.Node @x0
@x1
@x2
@x3
@x4)))
...
@x3
@x4))
:qid constructor_distinct_BinarySearchTreeFirst.Node))

:named constructor_distinct_BinarySearchTreeFirst.Node))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x0
(BinarySearchTreeFirst.tree @x2)))
:qid BinarySearchTreeFirst_pretyping_32c99cb150ee6f474d09a93f2f2fb96e))

:named BinarySearchTreeFirst_pretyping_32c99cb150ee6f474d09a93f2f2fb96e))
(push) ;; push{4

; Starting query at BinarySearchTreeFirst.fst(30,0-38,17)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


; Encoding query formula : forall (r: Prims.int).
;   (forall (r: Prims.int). {:pattern Prims.hasEq (BinarySearchTreeFirst.tree r)}
;       Prims.hasEq (BinarySearchTreeFirst.tree r)) ==>
;   (forall (l: Prims.int)
;       (left: FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree l))
;       (n: Prims.int)
;       (right:
;       FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree r)
;         {l <= n /\ n <= r /\ None? right == (n = r) /\ None? left == (n = l)}).
;       Prims.hasEq (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree l)) /\
;       Prims.hasEq (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree r)))


; Context: While encoding a query
; While typechecking the top-level declaration `type BinarySearchTreeFirst.tree`
...
;; def=BinarySearchTreeFirst.fst(30,0-38,17); use=BinarySearchTreeFirst.fst(30,0-38,17)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
(Valid 
;; def=BinarySearchTreeFirst.fst(30,0-38,17); use=BinarySearchTreeFirst.fst(30,0-38,17)
(Prims.hasEq (BinarySearchTreeFirst.tree @x1))
)
)
 

:pattern ((Prims.hasEq (BinarySearchTreeFirst.tree @x1)))
:qid @query.1))
)
...
Prims.int)
(HasType @x2
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x1)))
(HasType @x3
Prims.int)
(HasType @x4
(Tm_refine_7bd45d8dd562d256ba02499dea4c4dea @x1
@x3
@x0
@x2)))
...
;; def=BinarySearchTreeFirst.fst(30,0-38,17); use=BinarySearchTreeFirst.fst(30,0-38,17)
(and 
;; def=BinarySearchTreeFirst.fst(30,0-38,17); use=BinarySearchTreeFirst.fst(32,17-32,32)
(or label_1

;; def=BinarySearchTreeFirst.fst(30,0-38,17); use=BinarySearchTreeFirst.fst(30,0-38,17)
(Valid 
;; def=BinarySearchTreeFirst.fst(30,0-38,17); use=BinarySearchTreeFirst.fst(30,0-38,17)
(Prims.hasEq (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x1)))
)
)


;; def=BinarySearchTreeFirst.fst(34,17-34,32); use=BinarySearchTreeFirst.fst(34,17-34,32)
(or label_2

;; def=BinarySearchTreeFirst.fst(34,17-34,32); use=BinarySearchTreeFirst.fst(34,17-34,32)
(Valid 
;; def=BinarySearchTreeFirst.fst(34,17-34,32); use=BinarySearchTreeFirst.fst(34,17-34,32)
(Prims.hasEq (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x0)))
)
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BinarySearchTreeFirst.tree, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_FStar.Pervasives.Native.option__uu___haseq, int_inversion, kinding_BinarySearchTreeFirst.tree@tok
...
; encoding sigelt assume BinarySearchTreeFirst.tree__uu___haseq


; <Start encoding assume BinarySearchTreeFirst.tree__uu___haseq>


; </end encoding assume BinarySearchTreeFirst.tree__uu___haseq>


; encoding sigelt val BinarySearchTreeFirst.uu___is_Node


; <Start encoding val BinarySearchTreeFirst.uu___is_Node>

(declare-fun BinarySearchTreeFirst.uu___is_Node (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: tree r -> Prims.bool
(declare-fun Tm_arrow_e651043a03120888e1addb4f893d87eb () Term)
(declare-fun BinarySearchTreeFirst.uu___is_Node@tok () Term)

; </end encoding val BinarySearchTreeFirst.uu___is_Node>
...
; encoding sigelt val BinarySearchTreeFirst.__proj__Node__item__l


; <Start encoding val BinarySearchTreeFirst.__proj__Node__item__l>

(declare-fun BinarySearchTreeFirst.__proj__Node__item__l (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: tree r -> Prims.int
(declare-fun Tm_arrow_11c00d68a6f1b948371f86585389078d () Term)
(declare-fun BinarySearchTreeFirst.__proj__Node__item__l@tok () Term)

; </end encoding val BinarySearchTreeFirst.__proj__Node__item__l>
...
; encoding sigelt val BinarySearchTreeFirst.__proj__Node__item__left


; <Start encoding val BinarySearchTreeFirst.__proj__Node__item__left>

(declare-fun BinarySearchTreeFirst.__proj__Node__item__left (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: tree r -> FStar.Pervasives.Native.option (tree projectee.l)
(declare-fun Tm_arrow_f9431dc1c0fa23496e813378cd9155c2 () Term)
(declare-fun BinarySearchTreeFirst.__proj__Node__item__left@tok () Term)

; </end encoding val BinarySearchTreeFirst.__proj__Node__item__left>
...
; encoding sigelt val BinarySearchTreeFirst.__proj__Node__item__n


; <Start encoding val BinarySearchTreeFirst.__proj__Node__item__n>

(declare-fun BinarySearchTreeFirst.__proj__Node__item__n (Term Term) Term)

(declare-fun BinarySearchTreeFirst.__proj__Node__item__n@tok () Term)

; </end encoding val BinarySearchTreeFirst.__proj__Node__item__n>
...
; encoding sigelt val BinarySearchTreeFirst.__proj__Node__item__right


; <Start encoding val BinarySearchTreeFirst.__proj__Node__item__right>

(declare-fun BinarySearchTreeFirst.__proj__Node__item__right (Term Term) Term)
(declare-fun Tm_refine_c8378dc59b55fb22a0f615ed00f0d305 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: tree r   -> right:     FStar.Pervasives.Native.option (tree r)       { projectee.l <= projectee.n /\ projectee.n <= r /\ None? right == (projectee.n = r) /\         None? projectee.left == (projectee.n = projectee.l) }
(declare-fun Tm_arrow_48f174fdb0078f4b597fef37784f7616 () Term)
(declare-fun BinarySearchTreeFirst.__proj__Node__item__right@tok () Term)


; </end encoding val BinarySearchTreeFirst.__proj__Node__item__right>
...
:qid assumption_FStar.Pervasives.Native.option__uu___haseq))
:named assumption_FStar.Pervasives.Native.option__uu___haseq))
;;;;;;;;;;;;;;;;Assumption: BinarySearchTreeFirst.tree__uu___haseq
;;; Fact-ids: Name BinarySearchTreeFirst.tree__uu___haseq; Namespace BinarySearchTreeFirst
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(Valid (Prims.hasEq (BinarySearchTreeFirst.tree @x0))))
 

:pattern ((Prims.hasEq (BinarySearchTreeFirst.tree @x0)))
:qid assumption_BinarySearchTreeFirst.tree__uu___haseq))
:named assumption_BinarySearchTreeFirst.tree__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Starting query at BinarySearchTreeFirst.fst(41,22-41,44)
...
; Encoding query formula : forall (i: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   i <= i /\ i <= i /\ None? FStar.Pervasives.Native.None == true /\
;   None? FStar.Pervasives.Native.None == true


; Context: While encoding a query
; While typechecking the top-level declaration `let leaf`
...
;; def=BinarySearchTreeFirst.fst(34,33-37,57); use=BinarySearchTreeFirst.fst(41,40-41,44)
(and 
;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(41,40-41,44)
(or label_1
...
;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(41,40-41,44)
(or label_2
...
;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(41,40-41,44)
(or label_3

;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(41,40-41,44)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x0)
(FStar.Pervasives.Native.None (BinarySearchTreeFirst.tree @x0)))
(BoxBool true))
)


;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(41,40-41,44)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BinarySearchTreeFirst.leaf, 1)
; STATUS: unsat
...
; encoding sigelt let leaf


; <Start encoding let leaf>

(declare-fun BinarySearchTreeFirst.leaf (Term) Term)
;;;;;;;;;;;;;;;;i: Prims.int -> tree i
(declare-fun Tm_arrow_5138513c753bb27941a241582f5339e9 () Term)
(declare-fun BinarySearchTreeFirst.leaf@tok () Term)

; </end encoding let leaf>
...
(declare-fun BinarySearchTreeFirst.max (Term Term) Term)

(declare-fun BinarySearchTreeFirst.max@tok () Term)

; </end encoding let max>


; encoding sigelt val BinarySearchTreeFirst.insert


; <Skipped val BinarySearchTreeFirst.insert/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BinarySearchTreeFirst.max; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(43,4-43,7); use=BinarySearchTreeFirst.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.int)
(HasType @x1
Prims.int))
(HasType (BinarySearchTreeFirst.max @x0
@x1)
Prims.int))
 

:pattern ((BinarySearchTreeFirst.max @x0
@x1))
:qid typing_BinarySearchTreeFirst.max))

:named typing_BinarySearchTreeFirst.max))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BinarySearchTreeFirst.leaf; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(41,4-41,8); use=BinarySearchTreeFirst.fst(41,4-41,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (BinarySearchTreeFirst.leaf @x0)
(BinarySearchTreeFirst.tree @x0)))
 

:pattern ((BinarySearchTreeFirst.leaf @x0))
:qid typing_BinarySearchTreeFirst.leaf))

:named typing_BinarySearchTreeFirst.leaf))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for BinarySearchTreeFirst.max
;;; Fact-ids: Name BinarySearchTreeFirst.max; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(43,4-43,7); use=BinarySearchTreeFirst.fst(43,4-43,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (BinarySearchTreeFirst.max @x0
@x1)
(let ((@lb2 (Prims.op_LessThan @x0
@x1)))
(ite (= @lb2
(BoxBool true))
@x1
...
:pattern ((BinarySearchTreeFirst.max @x0
@x1))
:qid equation_BinarySearchTreeFirst.max))

:named equation_BinarySearchTreeFirst.max))
;;;;;;;;;;;;;;;;Equation for BinarySearchTreeFirst.leaf
;;; Fact-ids: Name BinarySearchTreeFirst.leaf; Namespace BinarySearchTreeFirst
(assert (! 
;; def=BinarySearchTreeFirst.fst(41,4-41,8); use=BinarySearchTreeFirst.fst(41,4-41,8)
(forall ((@x0 Term))
 (! (= (BinarySearchTreeFirst.leaf @x0)
(BinarySearchTreeFirst.Node @x0
@x0
(FStar.Pervasives.Native.None (BinarySearchTreeFirst.tree @x0))
@x0
(FStar.Pervasives.Native.None (BinarySearchTreeFirst.tree @x0))))
...
:pattern ((BinarySearchTreeFirst.leaf @x0))
:qid equation_BinarySearchTreeFirst.leaf))

:named equation_BinarySearchTreeFirst.leaf))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at BinarySearchTreeFirst.fst(47,2-59,45)

;;;;;;;;;;;;;;;;k : Prims.int (Prims.int)
...
;;;;;;;;;;;;;;;;uu___ : BinarySearchTreeFirst.tree k (BinarySearchTreeFirst.tree k)
(declare-fun x_81ab4b0d876eecb400f71902650e8bce_1 () Term)
;;;;;;;;;;;;;;;;binder_x_81ab4b0d876eecb400f71902650e8bce_1
;;; Fact-ids: 
(assert (! (HasType x_81ab4b0d876eecb400f71902650e8bce_1
(BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0))
:named binder_x_81ab4b0d876eecb400f71902650e8bce_1))
...
(declare-fun Tm_refine_c9577fc578e3682568c91639209bfe34 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(45,34-59,45); use=BinarySearchTreeFirst.fst(45,34-59,45)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c9577fc578e3682568c91639209bfe34 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_c9577fc578e3682568c91639209bfe34 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_c9577fc578e3682568c91639209bfe34))

:named refinement_kinding_Tm_refine_c9577fc578e3682568c91639209bfe34))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(45,34-59,45); use=BinarySearchTreeFirst.fst(45,34-59,45)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c9577fc578e3682568c91639209bfe34 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=BinarySearchTreeFirst.fst(47,2-59,45); use=BinarySearchTreeFirst.fst(47,2-59,45)

;; def=BinarySearchTreeFirst.fst(47,2-59,45); use=BinarySearchTreeFirst.fst(47,2-59,45)
(Valid 
;; def=BinarySearchTreeFirst.fst(47,2-59,45); use=BinarySearchTreeFirst.fst(47,2-59,45)
(Prims.precedes (BinarySearchTreeFirst.tree @x2)
(BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x3
x_81ab4b0d876eecb400f71902650e8bce_1)
)
...
(Tm_refine_c9577fc578e3682568c91639209bfe34 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_c9577fc578e3682568c91639209bfe34))

:named refinement_interpretation_Tm_refine_c9577fc578e3682568c91639209bfe34))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c9577fc578e3682568c91639209bfe34
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(45,34-59,45); use=BinarySearchTreeFirst.fst(45,34-59,45)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c9577fc578e3682568c91639209bfe34 @x0
@x1)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c9577fc578e3682568c91639209bfe34 @x0
@x1))))
:qid haseqTm_refine_c9577fc578e3682568c91639209bfe34))

:named haseqTm_refine_c9577fc578e3682568c91639209bfe34))
(declare-fun BinarySearchTreeFirst.insert (Term Term Term) Term)

;;;;;;;;;;;;;;;;t: tree k -> i: Prims.int{t << _} -> Prims.Tot (tree (max k i))
(declare-fun Tm_arrow_65f5340db21b67795a087309164b2802 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_65f5340db21b67795a087309164b2802
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_65f5340db21b67795a087309164b2802
Tm_type)
:named kinding_Tm_arrow_65f5340db21b67795a087309164b2802))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(45,15-59,45); use=BinarySearchTreeFirst.fst(45,34-59,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_65f5340db21b67795a087309164b2802)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_65f5340db21b67795a087309164b2802))
:qid BinarySearchTreeFirst_pre_typing_Tm_arrow_65f5340db21b67795a087309164b2802))

:named BinarySearchTreeFirst_pre_typing_Tm_arrow_65f5340db21b67795a087309164b2802))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_65f5340db21b67795a087309164b2802
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(45,15-59,45); use=BinarySearchTreeFirst.fst(45,34-59,45)
(forall ((@x0 Term))
...
(BinarySearchTreeFirst.tree @x1))
(HasType @x3
(Tm_refine_c9577fc578e3682568c91639209bfe34 @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
@x3)
(BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max @x1
@x3))))
...
@x2)
@x3))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_65f5340db21b67795a087309164b2802.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_65f5340db21b67795a087309164b2802.2))
...
@x1)
@x2))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_65f5340db21b67795a087309164b2802.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_65f5340db21b67795a087309164b2802))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_65f5340db21b67795a087309164b2802))

:named BinarySearchTreeFirst_interpretation_Tm_arrow_65f5340db21b67795a087309164b2802))
(declare-fun BinarySearchTreeFirst.insert@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(46,8-46,14); use=BinarySearchTreeFirst.fst(46,8-46,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT BinarySearchTreeFirst.insert@tok
@x0)
@x1)
@x2)
(BinarySearchTreeFirst.insert @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT BinarySearchTreeFirst.insert@tok
@x0)
@x1)
@x2))
:qid token_correspondence_BinarySearchTreeFirst.insert))

:named token_correspondence_BinarySearchTreeFirst.insert))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(46,8-46,14); use=BinarySearchTreeFirst.fst(46,8-46,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType BinarySearchTreeFirst.insert@tok
Tm_arrow_65f5340db21b67795a087309164b2802))
...
@x2)
@x3)
(BinarySearchTreeFirst.insert @x1
@x2
@x3))
 

:pattern ((BinarySearchTreeFirst.insert @x1
@x2
@x3))
:qid function_token_typing_BinarySearchTreeFirst.insert.1))
)
 

:pattern ((ApplyTT @x0
BinarySearchTreeFirst.insert@tok))
:qid function_token_typing_BinarySearchTreeFirst.insert))

:named function_token_typing_BinarySearchTreeFirst.insert))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(46,8-46,14); use=BinarySearchTreeFirst.fst(46,8-46,14)
...
(BinarySearchTreeFirst.tree @x0))
(HasType @x2
(Tm_refine_c9577fc578e3682568c91639209bfe34 @x0
@x1)))
(HasType (BinarySearchTreeFirst.insert @x0
@x1
@x2)
(BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max @x0
@x2))))
 

:pattern ((BinarySearchTreeFirst.insert @x0
@x1
@x2))
:qid typing_BinarySearchTreeFirst.insert))

:named typing_BinarySearchTreeFirst.insert))
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_7a476e5b2b868d61b32adab1246770c5 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(34,11-37,58); use=BinarySearchTreeFirst.fst(47,2-59,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_7a476e5b2b868d61b32adab1246770c5 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_7a476e5b2b868d61b32adab1246770c5 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_7a476e5b2b868d61b32adab1246770c5))

:named refinement_kinding_Tm_refine_7a476e5b2b868d61b32adab1246770c5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(34,11-37,58); use=BinarySearchTreeFirst.fst(47,2-59,45)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7a476e5b2b868d61b32adab1246770c5 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)))

;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(47,2-59,45)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 @x3))


;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(47,2-59,45)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_0))


;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x1)
(Prims.op_Equality Prims.int
@x3
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x2)
@x4)
(Prims.op_Equality Prims.int
@x3
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_7a476e5b2b868d61b32adab1246770c5))

:named refinement_interpretation_Tm_refine_7a476e5b2b868d61b32adab1246770c5))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7a476e5b2b868d61b32adab1246770c5
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(34,11-37,58); use=BinarySearchTreeFirst.fst(47,2-59,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7a476e5b2b868d61b32adab1246770c5 @x0
@x1
@x2)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7a476e5b2b868d61b32adab1246770c5 @x0
@x1
@x2))))
:qid haseqTm_refine_7a476e5b2b868d61b32adab1246770c5))

:named haseqTm_refine_7a476e5b2b868d61b32adab1246770c5))



; Encoding query formula : forall (b: Prims.int)
;   (b: FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree b))
;   (b: Prims.int)
;   (b:
;   right:
;   FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree k)
;     {b <= b /\ b <= k /\ None? right == (b = k) /\ None? b == (b = b)}).
;   _ == BinarySearchTreeFirst.Node b b b ==>
;   (forall (k: Prims.pure_post (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max k i))).
;       (forall (x: BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max k i)).
;           {:pattern Prims.guard_free (k x)}
;           Prims.auto_squash (k x)) ==>
;       (i = b == true ==> k == BinarySearchTreeFirst.max k i) /\
;       (~(i = b = true) ==>
;         (forall (b: Prims.bool).
;             i = b == b ==>
;             (forall (k:
;                 Prims.pure_post (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max k i))).
;                 (forall (x: BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max k i)).
;                     {:pattern Prims.guard_free (k x)}
;                     Prims.auto_squash (k x)) ==>
;                 (i < b == true ==>
...
;                       (b == FStar.Pervasives.Native.None ==>
;                         (b <= b /\ b <= k /\ None? b == (b = k) /\ None? b == (b = b) ==>
;                           i <= b /\ b <= k /\ None? b == (b = k) /\
;                           None? (FStar.Pervasives.Native.Some (BinarySearchTreeFirst.leaf i)) ==
;                           (b = i)) /\
;                         (forall (any_result:
;                             right:
;                             FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree k)
;                               {b <= b /\ b <= k /\ None? right == (b = k) /\ None? b == (b = b)}).
;                             b == any_result ==>
;                             (forall (any_result: BinarySearchTreeFirst.tree k).
;                                 BinarySearchTreeFirst.Node
;                                   (FStar.Pervasives.Native.Some (BinarySearchTreeFirst.leaf i)) b b ==
;                                 any_result ==>
;                                 k == BinarySearchTreeFirst.max k i))) /\
;                       (~(None? b) ==>
;                         (forall (b: BinarySearchTreeFirst.tree b).
;                             b == FStar.Pervasives.Native.Some b ==>
;                             b << _ /\
;                             (forall (any_result: Prims.int).
;                                 i == any_result ==>
;                                 (forall (any_result:
;                                     BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max b i)).
;                                     BinarySearchTreeFirst.insert b i == any_result ==>
;                                     (forall (any_result:
;                                         FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max
;                                                   b
;                                                   i))).
;                                         FStar.Pervasives.Native.Some
;                                         (BinarySearchTreeFirst.insert b i) ==
;                                         any_result ==>
;                                         (b <= b /\ b <= k /\ None? b == (b = k) /\
;                                           None? b == (b = b) ==>
;                                           BinarySearchTreeFirst.max b i <= b /\ b <= k /\
;                                           None? b == (b = k) /\
;                                           None? (FStar.Pervasives.Native.Some
;                                               (BinarySearchTreeFirst.insert b i)) ==
;                                           (b = BinarySearchTreeFirst.max b i)) /\
;                                         (forall (any_result:
;                                             right:
;                                             FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree
;                                                   k)
;                                               { b <= b /\ b <= k /\ None? right == (b = k) /\
;                                                 None? b == (b = b) }).
;                                             b == any_result ==>
;                                             (forall (any_result: BinarySearchTreeFirst.tree k).
;                                                 BinarySearchTreeFirst.Node
;                                                   (FStar.Pervasives.Native.Some
;                                                     (BinarySearchTreeFirst.insert b i)) b b ==
;                                                 any_result ==>
;                                                 k == BinarySearchTreeFirst.max k i))))))))) /\
;                 (~(i < b = true) ==>
;                   (forall (b: Prims.bool).
...
;                           (~(None? b) /\ ~(Some? b) ==> Prims.l_False) /\
;                           (b == FStar.Pervasives.Native.None ==>
;                             i == BinarySearchTreeFirst.max k i /\
;                             (forall (return_val:
;                                 BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max k i)).
;                                 return_val == BinarySearchTreeFirst.leaf i ==>
;                                 (forall (any_result:
;                                     FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max
;                                               k
;                                               i))).
;                                     FStar.Pervasives.Native.Some (BinarySearchTreeFirst.leaf i) ==
;                                     any_result ==>
;                                     b <= b /\ b <= BinarySearchTreeFirst.max k i /\
;                                     None? (FStar.Pervasives.Native.Some
;                                         (BinarySearchTreeFirst.leaf i)) ==
;                                     (b = BinarySearchTreeFirst.max k i) /\ None? b == (b = b)))) /\
;                           (~(None? b) ==>
;                             (forall (b: BinarySearchTreeFirst.tree k).
;                                 b == FStar.Pervasives.Native.Some b ==>
;                                 b << _ /\
;                                 (forall (any_result: Prims.int).
;                                     i == any_result ==>
...
;                                             None? (FStar.Pervasives.Native.Some
;                                                 (BinarySearchTreeFirst.insert b i)) ==
;                                             (b = BinarySearchTreeFirst.max k i) /\
;                                             None? b == (b = b)))))))))))))
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(413,99-413,120); use=BinarySearchTreeFirst.fst(47,2-59,45)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
...
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x0)))
...
(Tm_refine_7a476e5b2b868d61b32adab1246770c5 @x0
@x2
@x1))

;; def=BinarySearchTreeFirst.fst(46,25-46,42); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= x_81ab4b0d876eecb400f71902650e8bce_1
(BinarySearchTreeFirst.Node x_ae567c2fb75be05905677af440075565_0
@x0
@x1
@x2
@x3))
...
(Prims.pure_post (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max x_ae567c2fb75be05905677af440075565_0
x_ae567c2fb75be05905677af440075565_2))))

;; def=Prims.fst(402,27-402,88); use=BinarySearchTreeFirst.fst(47,2-59,45)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=BinarySearchTreeFirst.fst(47,2-59,45)
(Valid 
;; def=Prims.fst(402,84-402,87); use=BinarySearchTreeFirst.fst(47,2-59,45)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(389,2-389,39); use=BinarySearchTreeFirst.fst(47,2-59,45)
(and (implies 
;; def=BinarySearchTreeFirst.fst(47,5-47,10); use=BinarySearchTreeFirst.fst(47,5-47,10)
(= (Prims.op_Equality Prims.int
x_ae567c2fb75be05905677af440075565_2
@x2)
(BoxBool true))
...
;; def=BinarySearchTreeFirst.fst(45,53-46,18); use=BinarySearchTreeFirst.fst(48,7-48,24)
(or label_1

;; def=BinarySearchTreeFirst.fst(45,53-46,18); use=BinarySearchTreeFirst.fst(48,7-48,24)
(= x_ae567c2fb75be05905677af440075565_0
(BinarySearchTreeFirst.max x_ae567c2fb75be05905677af440075565_0
x_ae567c2fb75be05905677af440075565_2))
)
)
(implies 
;; def=Prims.fst(389,19-389,21); use=BinarySearchTreeFirst.fst(47,2-59,45)
(not 
;; def=BinarySearchTreeFirst.fst(47,5-47,10); use=BinarySearchTreeFirst.fst(47,5-47,10)
(= (Prims.op_Equality Prims.int
x_ae567c2fb75be05905677af440075565_2
...
;; def=BinarySearchTreeFirst.fst(47,5-59,45); use=BinarySearchTreeFirst.fst(47,5-59,45)
(= (Prims.op_Equality Prims.int
x_ae567c2fb75be05905677af440075565_2
@x2)
@x5)
...
;; def=Prims.fst(389,2-389,39); use=BinarySearchTreeFirst.fst(47,2-59,45)
(and (implies 
;; def=BinarySearchTreeFirst.fst(49,10-49,15); use=BinarySearchTreeFirst.fst(49,10-49,15)
(= (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_2
@x2)
(BoxBool true))
...
;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(47,2-59,45)
(and (implies 
;; def=BinarySearchTreeFirst.fst(46,30-46,34); use=BinarySearchTreeFirst.fst(50,13-50,17)
(and 
;; def=BinarySearchTreeFirst.fst(46,30-46,34); use=BinarySearchTreeFirst.fst(50,13-50,17)
(not 
;; def=BinarySearchTreeFirst.fst(46,30-46,34); use=BinarySearchTreeFirst.fst(50,13-50,17)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x0)
@x1))
)
...
(not 
;; def=BinarySearchTreeFirst.fst(46,30-46,34); use=BinarySearchTreeFirst.fst(50,13-50,17)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (BinarySearchTreeFirst.tree @x0)
@x1))
)
)
...
label_2)
(implies 
;; def=BinarySearchTreeFirst.fst(46,30-51,13); use=BinarySearchTreeFirst.fst(50,13-51,13)
(= @x1
(FStar.Pervasives.Native.None (BinarySearchTreeFirst.tree @x0)))
...
;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(47,2-59,45)
(and (implies 
;; def=BinarySearchTreeFirst.fst(34,33-37,57); use=BinarySearchTreeFirst.fst(52,33-52,38)
(and 
;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(52,33-52,38)
(<= (BoxInt_proj_0 @x0)
(BoxInt_proj_0 @x2))


;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(52,33-52,38)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_0))


;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(52,33-52,38)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x3)
(Prims.op_Equality Prims.int
@x2
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(52,33-52,38)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x0)
@x1)
(Prims.op_Equality Prims.int
@x2
...
;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(52,33-52,38)
(<= (BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_2)
(BoxInt_proj_0 @x2))
)
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(52,33-52,38)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_2)
(FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_2)
(BinarySearchTreeFirst.leaf x_ae567c2fb75be05905677af440075565_2)))
(Prims.op_Equality Prims.int
@x2
x_ae567c2fb75be05905677af440075565_2))
)
...
;; def=Prims.fst(451,66-451,102); use=BinarySearchTreeFirst.fst(47,2-59,45)
(forall ((@x8 Term))
...
;; def=BinarySearchTreeFirst.fst(34,11-46,42); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= @x3
@x8)
)
...
;; def=BinarySearchTreeFirst.fst(45,47-52,38); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= (BinarySearchTreeFirst.Node x_ae567c2fb75be05905677af440075565_0
x_ae567c2fb75be05905677af440075565_2
(FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_2)
(BinarySearchTreeFirst.leaf x_ae567c2fb75be05905677af440075565_2))
...
;; def=BinarySearchTreeFirst.fst(45,53-46,18); use=BinarySearchTreeFirst.fst(52,10-52,38)
(or label_7
...
;; def=BinarySearchTreeFirst.fst(46,30-53,18); use=BinarySearchTreeFirst.fst(50,13-53,18)
(= @x1
(FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree @x0)
@x8))
)

;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(47,2-59,45)
(and 
;; def=BinarySearchTreeFirst.fst(47,2-59,45); use=BinarySearchTreeFirst.fst(54,34-54,35)
(or label_8

;; def=BinarySearchTreeFirst.fst(47,2-59,45); use=BinarySearchTreeFirst.fst(54,34-54,35)
(Valid 
;; def=BinarySearchTreeFirst.fst(47,2-59,45); use=BinarySearchTreeFirst.fst(54,34-54,35)
(Prims.precedes (BinarySearchTreeFirst.tree @x0)
(BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x8
x_81ab4b0d876eecb400f71902650e8bce_1)
)
...
;; def=BinarySearchTreeFirst.fst(45,34-46,45); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= x_ae567c2fb75be05905677af440075565_2
@x9)
)
...
;; def=FStar.Pervasives.Native.fst(33,11-33,12); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= (BinarySearchTreeFirst.insert @x0
@x8
x_ae567c2fb75be05905677af440075565_2)
@x10)
...
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max @x0
x_ae567c2fb75be05905677af440075565_2))))

;; def=BinarySearchTreeFirst.fst(32,11-54,37); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= (FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max @x0
x_ae567c2fb75be05905677af440075565_2))
(BinarySearchTreeFirst.insert @x0
@x8
x_ae567c2fb75be05905677af440075565_2))
...
;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(47,2-59,45)
(and (implies 
;; def=BinarySearchTreeFirst.fst(34,33-37,57); use=BinarySearchTreeFirst.fst(54,40-54,45)
(and 
;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(54,40-54,45)
(<= (BoxInt_proj_0 @x0)
(BoxInt_proj_0 @x2))


;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(54,40-54,45)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_0))


;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(54,40-54,45)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x3)
(Prims.op_Equality Prims.int
@x2
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(54,40-54,45)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x0)
@x1)
(Prims.op_Equality Prims.int
@x2
...
;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(54,40-54,45)
(<= (BoxInt_proj_0 (BinarySearchTreeFirst.max @x0
x_ae567c2fb75be05905677af440075565_2))
(BoxInt_proj_0 @x2))
)
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(54,40-54,45)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max @x0
x_ae567c2fb75be05905677af440075565_2))
(FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max @x0
x_ae567c2fb75be05905677af440075565_2))
(BinarySearchTreeFirst.insert @x0
...
;; def=BinarySearchTreeFirst.fst(45,47-54,45); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= (BinarySearchTreeFirst.Node x_ae567c2fb75be05905677af440075565_0
(BinarySearchTreeFirst.max @x0
x_ae567c2fb75be05905677af440075565_2)
(FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max @x0
...
;; def=BinarySearchTreeFirst.fst(45,53-46,18); use=BinarySearchTreeFirst.fst(54,10-54,45)
(or label_13
...
;; def=BinarySearchTreeFirst.fst(49,10-59,45); use=BinarySearchTreeFirst.fst(49,10-59,45)
(= (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_2
@x2)
@x7)
)
...
;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(47,2-59,45)
(and (implies 
;; def=BinarySearchTreeFirst.fst(46,37-46,42); use=BinarySearchTreeFirst.fst(55,13-55,18)
(and 
;; def=BinarySearchTreeFirst.fst(46,37-46,42); use=BinarySearchTreeFirst.fst(55,13-55,18)
(not 
;; def=BinarySearchTreeFirst.fst(46,37-46,42); use=BinarySearchTreeFirst.fst(55,13-55,18)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x3))
)
...
(not 
;; def=BinarySearchTreeFirst.fst(46,37-46,42); use=BinarySearchTreeFirst.fst(55,13-55,18)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x3))
)
)
...
label_14)
(implies 
;; def=BinarySearchTreeFirst.fst(46,37-56,13); use=BinarySearchTreeFirst.fst(55,13-56,13)
(= @x3
(FStar.Pervasives.Native.None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)))


;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(47,2-59,45)
(and 
;; def=BinarySearchTreeFirst.fst(45,53-46,45); use=BinarySearchTreeFirst.fst(57,28-57,36)
(or label_15
...
;; def=Prims.fst(356,2-356,58); use=BinarySearchTreeFirst.fst(47,2-59,45)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max x_ae567c2fb75be05905677af440075565_0
x_ae567c2fb75be05905677af440075565_2)))

;; def=Prims.fst(356,26-356,41); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= @x9
(BinarySearchTreeFirst.leaf x_ae567c2fb75be05905677af440075565_2))
)
...
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max x_ae567c2fb75be05905677af440075565_0
x_ae567c2fb75be05905677af440075565_2))))

;; def=BinarySearchTreeFirst.fst(34,11-57,37); use=BinarySearchTreeFirst.fst(57,10-57,37)
(= (FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max x_ae567c2fb75be05905677af440075565_0
x_ae567c2fb75be05905677af440075565_2))
(BinarySearchTreeFirst.leaf x_ae567c2fb75be05905677af440075565_2))
@x10)
)

;; def=BinarySearchTreeFirst.fst(34,33-37,57); use=BinarySearchTreeFirst.fst(57,22-57,37)
(and 
;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(57,22-57,37)
(or label_16
...
;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(57,22-57,37)
(or label_17

;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(57,22-57,37)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BinarySearchTreeFirst.max x_ae567c2fb75be05905677af440075565_0
x_ae567c2fb75be05905677af440075565_2)))
)


;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(57,22-57,37)
(or label_18

;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(57,22-57,37)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max x_ae567c2fb75be05905677af440075565_0
x_ae567c2fb75be05905677af440075565_2))
(FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max x_ae567c2fb75be05905677af440075565_0
x_ae567c2fb75be05905677af440075565_2))
(BinarySearchTreeFirst.leaf x_ae567c2fb75be05905677af440075565_2)))
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(57,22-57,37)
(or label_19
...
;; def=BinarySearchTreeFirst.fst(46,37-58,19); use=BinarySearchTreeFirst.fst(55,13-58,19)
(= @x3
(FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x9))
)

;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(47,2-59,45)
(and 
;; def=BinarySearchTreeFirst.fst(47,2-59,45); use=BinarySearchTreeFirst.fst(59,42-59,43)
(or label_20

;; def=BinarySearchTreeFirst.fst(47,2-59,45); use=BinarySearchTreeFirst.fst(59,42-59,43)
(Valid 
;; def=BinarySearchTreeFirst.fst(47,2-59,45); use=BinarySearchTreeFirst.fst(59,42-59,43)
(Prims.precedes (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
(BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x9
x_81ab4b0d876eecb400f71902650e8bce_1)
)
...
;; def=FStar.Pervasives.Native.fst(33,11-33,12); use=BinarySearchTreeFirst.fst(47,2-59,45)
(= (BinarySearchTreeFirst.insert x_ae567c2fb75be05905677af440075565_0
@x9
x_ae567c2fb75be05905677af440075565_2)
@x11)
)
...
;; def=BinarySearchTreeFirst.fst(34,11-59,45); use=BinarySearchTreeFirst.fst(59,10-59,45)
(= (FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree (BinarySearchTreeFirst.max x_ae567c2fb75be05905677af440075565_0
x_ae567c2fb75be05905677af440075565_2))
(BinarySearchTreeFirst.insert x_ae567c2fb75be05905677af440075565_0
@x9
...
;; def=BinarySearchTreeFirst.fst(34,33-37,57); use=BinarySearchTreeFirst.fst(59,22-59,45)
(and 
;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(59,22-59,45)
(or label_21
...
;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(59,22-59,45)
(or label_22
...
;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(59,22-59,45)
(or label_23
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(59,22-59,45)
(or label_24
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BinarySearchTreeFirst.insert, 1)
; STATUS: unsat
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun BinarySearchTreeFirst.insert.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun BinarySearchTreeFirst.insert.fuel_instrumented_token () Term)
(declare-fun BinarySearchTreeFirst.insert (Term Term Term) Term)
(declare-fun BinarySearchTreeFirst.insert@tok () Term)
;;;;;;;;;;;;;;;;t: tree k -> i: Prims.int -> Prims.Tot (tree (max k i))
(declare-fun Tm_arrow_e69e1c6f09a9715283fe80e4969bc736 () Term)

; </end encoding let rec insert>


; encoding sigelt val BinarySearchTreeFirst.contains


; <Skipped val BinarySearchTreeFirst.contains/>
...
; Starting query at BinarySearchTreeFirst.fst(63,2-68,55)
...
Prims.int)
:named binder_x_ae567c2fb75be05905677af440075565_0))
;;;;;;;;;;;;;;;;t : BinarySearchTreeFirst.tree k (BinarySearchTreeFirst.tree k)
(declare-fun x_81ab4b0d876eecb400f71902650e8bce_1 () Term)
;;;;;;;;;;;;;;;;binder_x_81ab4b0d876eecb400f71902650e8bce_1
;;; Fact-ids: 
(assert (! (HasType x_81ab4b0d876eecb400f71902650e8bce_1
...
Prims.int)
:named binder_x_ae567c2fb75be05905677af440075565_2))
(declare-fun Tm_refine_012f31007dca1709e8a6312370d36c1f (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(61,36-68,55); use=BinarySearchTreeFirst.fst(61,36-68,55)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_012f31007dca1709e8a6312370d36c1f @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_012f31007dca1709e8a6312370d36c1f @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_012f31007dca1709e8a6312370d36c1f))

:named refinement_kinding_Tm_refine_012f31007dca1709e8a6312370d36c1f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(61,36-68,55); use=BinarySearchTreeFirst.fst(61,36-68,55)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_012f31007dca1709e8a6312370d36c1f @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=BinarySearchTreeFirst.fst(63,2-68,55); use=BinarySearchTreeFirst.fst(63,2-68,55)
...
(Tm_refine_012f31007dca1709e8a6312370d36c1f @x2
@x3)))
:qid refinement_interpretation_Tm_refine_012f31007dca1709e8a6312370d36c1f))

:named refinement_interpretation_Tm_refine_012f31007dca1709e8a6312370d36c1f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_012f31007dca1709e8a6312370d36c1f
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(61,36-68,55); use=BinarySearchTreeFirst.fst(61,36-68,55)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_012f31007dca1709e8a6312370d36c1f @x0
@x1)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_012f31007dca1709e8a6312370d36c1f @x0
@x1))))
:qid haseqTm_refine_012f31007dca1709e8a6312370d36c1f))

:named haseqTm_refine_012f31007dca1709e8a6312370d36c1f))
(declare-fun BinarySearchTreeFirst.contains (Term Term Term) Term)

;;;;;;;;;;;;;;;;t: tree k -> key: Prims.int{t << t} -> Prims.Tot Prims.bool
(declare-fun Tm_arrow_e53fe139d07accb05f8716074d3af323 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e53fe139d07accb05f8716074d3af323
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_e53fe139d07accb05f8716074d3af323
Tm_type)
:named kinding_Tm_arrow_e53fe139d07accb05f8716074d3af323))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(61,17-68,55); use=BinarySearchTreeFirst.fst(61,36-68,55)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_e53fe139d07accb05f8716074d3af323)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_e53fe139d07accb05f8716074d3af323))
:qid BinarySearchTreeFirst_pre_typing_Tm_arrow_e53fe139d07accb05f8716074d3af323))

:named BinarySearchTreeFirst_pre_typing_Tm_arrow_e53fe139d07accb05f8716074d3af323))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e53fe139d07accb05f8716074d3af323
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(61,17-68,55); use=BinarySearchTreeFirst.fst(61,36-68,55)
(forall ((@x0 Term))
...
(BinarySearchTreeFirst.tree @x1))
(HasType @x3
(Tm_refine_012f31007dca1709e8a6312370d36c1f @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x2)
@x3))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_e53fe139d07accb05f8716074d3af323.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_e53fe139d07accb05f8716074d3af323.2))
...
@x1)
@x2))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_e53fe139d07accb05f8716074d3af323.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_e53fe139d07accb05f8716074d3af323))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_e53fe139d07accb05f8716074d3af323))

:named BinarySearchTreeFirst_interpretation_Tm_arrow_e53fe139d07accb05f8716074d3af323))
(declare-fun BinarySearchTreeFirst.contains@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(62,8-62,16); use=BinarySearchTreeFirst.fst(62,8-62,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT BinarySearchTreeFirst.contains@tok
@x0)
@x1)
@x2)
(BinarySearchTreeFirst.contains @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT BinarySearchTreeFirst.contains@tok
@x0)
@x1)
@x2))
:qid token_correspondence_BinarySearchTreeFirst.contains))

:named token_correspondence_BinarySearchTreeFirst.contains))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(62,8-62,16); use=BinarySearchTreeFirst.fst(62,8-62,16)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType BinarySearchTreeFirst.contains@tok
Tm_arrow_e53fe139d07accb05f8716074d3af323))
...
@x2)
@x3)
(BinarySearchTreeFirst.contains @x1
@x2
@x3))
 

:pattern ((BinarySearchTreeFirst.contains @x1
@x2
@x3))
:qid function_token_typing_BinarySearchTreeFirst.contains.1))
)
 

:pattern ((ApplyTT @x0
BinarySearchTreeFirst.contains@tok))
:qid function_token_typing_BinarySearchTreeFirst.contains))

:named function_token_typing_BinarySearchTreeFirst.contains))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(62,8-62,16); use=BinarySearchTreeFirst.fst(62,8-62,16)
...
(BinarySearchTreeFirst.tree @x0))
(HasType @x2
(Tm_refine_012f31007dca1709e8a6312370d36c1f @x0
@x1)))
(HasType (BinarySearchTreeFirst.contains @x0
@x1
@x2)
Prims.bool))
 

:pattern ((BinarySearchTreeFirst.contains @x0
@x1
@x2))
:qid typing_BinarySearchTreeFirst.contains))

:named typing_BinarySearchTreeFirst.contains))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(34,11-37,58); use=BinarySearchTreeFirst.fst(65,11-65,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_7a476e5b2b868d61b32adab1246770c5 @x0
@x1
@x2)
...
;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(65,11-65,15)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 @x3))


;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(65,11-65,15)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_0))


;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(65,11-65,15)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x1)
(Prims.op_Equality Prims.int
@x3
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(65,11-65,15)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x2)
@x4)
(Prims.op_Equality Prims.int
@x3
...
;           FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree k)
;             {b <= b /\ b <= k /\ None? right == (b = k) /\ None? b == (b = b)}).
;           t == BinarySearchTreeFirst.Node b b b ==>
;           (~(b = k) ==>
;             key < b && Some? b ==>
;             Some? b /\
;             (forall (any_result: FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree b)).
;                 b == any_result ==>
;                 (forall (any_result: BinarySearchTreeFirst.tree b). b.v == any_result ==> b.v << t))
;           ) /\
;           (~(b = k || key < b && Some? b && BinarySearchTreeFirst.contains b.v key) ==>
;             Some? b ==>
;             (b <= b /\ b <= k /\ None? b == (b = k) /\ None? b == (b = b) ==> Some? b) /\
;             (forall (any_result:
;                 right:
;                 FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree k)
;                   {b <= b /\ b <= k /\ None? right == (b = k) /\ None? b == (b = b)}).
;                 b == any_result ==>
;                 (forall (any_result: BinarySearchTreeFirst.tree k). b.v == any_result ==> b.v << t))
;           )))
...
;; def=Prims.fst(402,27-402,88); use=BinarySearchTreeFirst.fst(63,2-68,55)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=BinarySearchTreeFirst.fst(63,2-68,55)
(Valid 
;; def=Prims.fst(402,84-402,87); use=BinarySearchTreeFirst.fst(63,2-68,55)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=BinarySearchTreeFirst.fst(63,2-68,55)
(not 
;; def=BinarySearchTreeFirst.fst(63,5-63,12); use=BinarySearchTreeFirst.fst(63,5-63,12)
(= (Prims.op_GreaterThan x_ae567c2fb75be05905677af440075565_2
x_ae567c2fb75be05905677af440075565_0)
(BoxBool true))
)
)

;; def=Prims.fst(413,99-413,120); use=BinarySearchTreeFirst.fst(63,2-68,55)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=BinarySearchTreeFirst.fst(63,5-68,55); use=BinarySearchTreeFirst.fst(63,5-68,55)
(= (Prims.op_GreaterThan x_ae567c2fb75be05905677af440075565_2
x_ae567c2fb75be05905677af440075565_0)
@x1)
)
...
;; def=BinarySearchTreeFirst.fst(65,11-65,28); use=BinarySearchTreeFirst.fst(65,11-65,28)
(= x_81ab4b0d876eecb400f71902650e8bce_1
(BinarySearchTreeFirst.Node x_ae567c2fb75be05905677af440075565_0
@x2
@x3
...
;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(66,7-68,55)
(and (implies 
;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(66,7-67,64)
(and 
;; def=BinarySearchTreeFirst.fst(66,7-66,10); use=BinarySearchTreeFirst.fst(66,7-66,10)
(not 
;; def=BinarySearchTreeFirst.fst(66,7-66,10); use=BinarySearchTreeFirst.fst(66,7-66,10)
(= @x4
x_ae567c2fb75be05905677af440075565_0)
...
(BoxBool_proj_0 (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_2
@x4))
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (BinarySearchTreeFirst.tree @x2)
@x3)))


;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(67,10-67,64)
(and 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=BinarySearchTreeFirst.fst(67,54-67,58)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=BinarySearchTreeFirst.fst(67,10-67,64)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x2)))

;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=BinarySearchTreeFirst.fst(67,10-67,64)
(= @x3
@x6)
)
...
;; def=BinarySearchTreeFirst.fst(61,24-67,59); use=BinarySearchTreeFirst.fst(67,10-67,64)
(= (FStar.Pervasives.Native.__proj__Some__item__v (BinarySearchTreeFirst.tree @x2)
@x3)
@x7)
)

;; def=BinarySearchTreeFirst.fst(63,2-68,55); use=BinarySearchTreeFirst.fst(67,60-67,63)
(or label_2
...
;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(66,7-68,55)
(and 
;; def=BinarySearchTreeFirst.fst(66,7-67,64); use=BinarySearchTreeFirst.fst(66,7-67,64)
(not 
;; def=BinarySearchTreeFirst.fst(66,7-67,64); use=BinarySearchTreeFirst.fst(66,7-67,64)
(or (BoxBool_proj_0 (Prims.op_Equality Prims.int
@x4
x_ae567c2fb75be05905677af440075565_0))
(BoxBool_proj_0 (Prims.op_AmpAmp (Prims.op_AmpAmp (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_2
@x4)
(FStar.Pervasives.Native.uu___is_Some (BinarySearchTreeFirst.tree @x2)
@x3))
(BinarySearchTreeFirst.contains @x2
(FStar.Pervasives.Native.__proj__Some__item__v (BinarySearchTreeFirst.tree @x2)
@x3)
x_ae567c2fb75be05905677af440075565_2))))
)
...
;; def=BinarySearchTreeFirst.fst(68,11-68,22); use=BinarySearchTreeFirst.fst(68,11-68,22)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x5))
)


;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(68,10-68,55)
(and (implies 
;; def=BinarySearchTreeFirst.fst(34,33-37,57); use=BinarySearchTreeFirst.fst(68,44-68,49)
(and 
;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(68,44-68,49)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 @x4))


;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(68,44-68,49)
(<= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_0))


;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(68,44-68,49)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x5)
(Prims.op_Equality Prims.int
@x4
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(68,44-68,49)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x2)
@x3)
(Prims.op_Equality Prims.int
@x4
...
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=BinarySearchTreeFirst.fst(68,44-68,49)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=BinarySearchTreeFirst.fst(68,10-68,55)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_7a476e5b2b868d61b32adab1246770c5 @x2
@x4
...
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=BinarySearchTreeFirst.fst(68,10-68,55)
(= @x5
@x6)
)
...
;; def=BinarySearchTreeFirst.fst(61,24-68,50); use=BinarySearchTreeFirst.fst(68,10-68,55)
(= (FStar.Pervasives.Native.__proj__Some__item__v (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x5)
@x7)
)

;; def=BinarySearchTreeFirst.fst(63,2-68,55); use=BinarySearchTreeFirst.fst(68,51-68,54)
(or label_4
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun BinarySearchTreeFirst.contains.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun BinarySearchTreeFirst.contains.fuel_instrumented_token () Term)
(declare-fun BinarySearchTreeFirst.contains (Term Term Term) Term)
(declare-fun BinarySearchTreeFirst.contains@tok () Term)
;;;;;;;;;;;;;;;;t: tree k -> key: Prims.int -> Prims.Tot Prims.bool
(declare-fun Tm_arrow_584c72ae87b0f223ee0d9a7fd01aa4b4 () Term)

; </end encoding let rec contains>


; encoding sigelt val BinarySearchTreeFirst.in_order_opt


; <Skipped val BinarySearchTreeFirst.in_order_opt/>
...
; Starting query at BinarySearchTreeFirst.fst(71,34-74,45)
...
Prims.int)
:named binder_x_ae567c2fb75be05905677af440075565_0))
;;;;;;;;;;;;;;;;t : FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree k) (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree k))
(declare-fun x_b98020eae7589a36221779c3f67bf83b_1 () Term)
;;;;;;;;;;;;;;;;binder_x_b98020eae7589a36221779c3f67bf83b_1
;;; Fact-ids: 
(assert (! (HasType x_b98020eae7589a36221779c3f67bf83b_1
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)))
:named binder_x_b98020eae7589a36221779c3f67bf83b_1))
(declare-fun Tm_refine_57ccb3cce459d170ced923d6c0bef2a8 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(70,28-74,45); use=BinarySearchTreeFirst.fst(70,28-74,45)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_57ccb3cce459d170ced923d6c0bef2a8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_57ccb3cce459d170ced923d6c0bef2a8 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_57ccb3cce459d170ced923d6c0bef2a8))

:named refinement_kinding_Tm_refine_57ccb3cce459d170ced923d6c0bef2a8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(70,28-74,45); use=BinarySearchTreeFirst.fst(70,28-74,45)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_57ccb3cce459d170ced923d6c0bef2a8 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x2)))

;; def=BinarySearchTreeFirst.fst(71,34-74,45); use=BinarySearchTreeFirst.fst(71,34-74,45)

;; def=BinarySearchTreeFirst.fst(71,34-74,45); use=BinarySearchTreeFirst.fst(71,34-74,45)
(Valid 
;; def=BinarySearchTreeFirst.fst(71,34-74,45); use=BinarySearchTreeFirst.fst(71,34-74,45)
(Prims.precedes (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x2))
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0))
@x1
x_b98020eae7589a36221779c3f67bf83b_1)
)
...
@x1
(Tm_refine_57ccb3cce459d170ced923d6c0bef2a8 @x2)))
:qid refinement_interpretation_Tm_refine_57ccb3cce459d170ced923d6c0bef2a8))

:named refinement_interpretation_Tm_refine_57ccb3cce459d170ced923d6c0bef2a8))
;;;;;;;;;;;;;;;;haseq for Tm_refine_57ccb3cce459d170ced923d6c0bef2a8
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(70,28-74,45); use=BinarySearchTreeFirst.fst(70,28-74,45)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_57ccb3cce459d170ced923d6c0bef2a8 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x0)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_57ccb3cce459d170ced923d6c0bef2a8 @x0))))
:qid haseqTm_refine_57ccb3cce459d170ced923d6c0bef2a8))

:named haseqTm_refine_57ccb3cce459d170ced923d6c0bef2a8))
(declare-fun BinarySearchTreeFirst.in_order_opt (Term Term) Term)

;;;;;;;;;;;;;;;;t: FStar.Pervasives.Native.option (tree k) {t << t} -> Prims.Tot (Prims.list Prims.int)
(declare-fun Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716
Tm_type)
:named kinding_Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(70,21-74,45); use=BinarySearchTreeFirst.fst(70,28-74,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716))
:qid BinarySearchTreeFirst_pre_typing_Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716))

:named BinarySearchTreeFirst_pre_typing_Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(70,21-74,45); use=BinarySearchTreeFirst.fst(70,28-74,45)
(forall ((@x0 Term))
...
Prims.int)
(HasType @x2
(Tm_refine_57ccb3cce459d170ced923d6c0bef2a8 @x1)))
...
@x1)
@x2))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716))
:qid BinarySearchTreeFirst_interpretation_Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716))

:named BinarySearchTreeFirst_interpretation_Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716))
(declare-fun BinarySearchTreeFirst.in_order_opt@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(71,8-71,20); use=BinarySearchTreeFirst.fst(71,8-71,20)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT BinarySearchTreeFirst.in_order_opt@tok
@x0)
@x1)
(BinarySearchTreeFirst.in_order_opt @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT BinarySearchTreeFirst.in_order_opt@tok
@x0)
@x1))
:qid token_correspondence_BinarySearchTreeFirst.in_order_opt))

:named token_correspondence_BinarySearchTreeFirst.in_order_opt))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(71,8-71,20); use=BinarySearchTreeFirst.fst(71,8-71,20)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType BinarySearchTreeFirst.in_order_opt@tok
Tm_arrow_0e4d83b9b4d2ee1354c1a6d3d7436716))
...
@x1)
@x2)
(BinarySearchTreeFirst.in_order_opt @x1
@x2))
 

:pattern ((BinarySearchTreeFirst.in_order_opt @x1
@x2))
:qid function_token_typing_BinarySearchTreeFirst.in_order_opt.1))
)
 

:pattern ((ApplyTT @x0
BinarySearchTreeFirst.in_order_opt@tok))
:qid function_token_typing_BinarySearchTreeFirst.in_order_opt))

:named function_token_typing_BinarySearchTreeFirst.in_order_opt))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(71,8-71,20); use=BinarySearchTreeFirst.fst(71,8-71,20)
...
Prims.int)
(HasType @x1
(Tm_refine_57ccb3cce459d170ced923d6c0bef2a8 @x0)))
(HasType (BinarySearchTreeFirst.in_order_opt @x0
@x1)
(Prims.list Prims.int)))
 

:pattern ((BinarySearchTreeFirst.in_order_opt @x0
@x1))
:qid typing_BinarySearchTreeFirst.in_order_opt))

:named typing_BinarySearchTreeFirst.in_order_opt))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_7a476e5b2b868d61b32adab1246770c5 (Term Term Term) Term)
...
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTreeFirst.fst(34,11-37,58); use=BinarySearchTreeFirst.fst(73,10-73,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_7a476e5b2b868d61b32adab1246770c5 @x0
@x1
@x2)
...
;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(73,10-73,14)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 @x3))


;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(73,10-73,14)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_0))


;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(73,10-73,14)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x1)
(Prims.op_Equality Prims.int
@x3
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(73,10-73,14)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x2)
@x4)
(Prims.op_Equality Prims.int
@x3
...
; Encoding query formula : forall (k: Prims.pure_post (Prims.list Prims.int)).
;   (forall (x: Prims.list Prims.int). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(None? t) /\ ~(Some? t) ==> Prims.l_False) /\
;   (~(None? t) ==>
;     (forall (b: Prims.int)
;         (b: FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree b))
;         (b: Prims.int)
...
;         FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree k)
;           {b <= b /\ b <= k /\ None? right == (b = k) /\ None? b == (b = b)}).
;         t == FStar.Pervasives.Native.Some (BinarySearchTreeFirst.Node b b b) ==>
;         b << t /\
;         (forall (any_result: FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree b)).
;             b == any_result ==>
;             (forall (any_result: Prims.list Prims.int).
;                 BinarySearchTreeFirst.in_order_opt b == any_result ==>
;                 b <= b /\ b <= k /\ None? b == (b = k) /\ None? b == (b = b) ==> b << t))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec in_order_opt`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Prims.list Prims.int)))

;; def=Prims.fst(402,27-402,88); use=BinarySearchTreeFirst.fst(71,34-74,45)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=BinarySearchTreeFirst.fst(71,34-74,45)
(Valid 
;; def=Prims.fst(402,84-402,87); use=BinarySearchTreeFirst.fst(71,34-74,45)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(71,34-74,45)
(and (implies 
;; def=BinarySearchTreeFirst.fst(71,30-71,31); use=BinarySearchTreeFirst.fst(71,40-71,41)
(and 
;; def=BinarySearchTreeFirst.fst(71,30-71,31); use=BinarySearchTreeFirst.fst(71,40-71,41)
(not 
;; def=BinarySearchTreeFirst.fst(71,30-71,31); use=BinarySearchTreeFirst.fst(71,40-71,41)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=BinarySearchTreeFirst.fst(71,34-74,45)
(not 
;; def=BinarySearchTreeFirst.fst(71,30-71,31); use=BinarySearchTreeFirst.fst(71,40-71,41)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
x_b98020eae7589a36221779c3f67bf83b_1))
...
;; def=Prims.fst(413,99-413,120); use=BinarySearchTreeFirst.fst(71,34-74,45)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Tm_refine_7a476e5b2b868d61b32adab1246770c5 @x1
@x3
@x2))

;; def=BinarySearchTreeFirst.fst(71,30-73,28); use=BinarySearchTreeFirst.fst(71,40-73,28)
(= x_b98020eae7589a36221779c3f67bf83b_1
(FStar.Pervasives.Native.Some (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
(BinarySearchTreeFirst.Node x_ae567c2fb75be05905677af440075565_0
@x1
...
;; def=Prims.fst(459,77-459,89); use=BinarySearchTreeFirst.fst(71,34-74,45)
(and 
;; def=BinarySearchTreeFirst.fst(71,34-74,45); use=BinarySearchTreeFirst.fst(74,18-74,22)
(or label_2

;; def=BinarySearchTreeFirst.fst(71,34-74,45); use=BinarySearchTreeFirst.fst(74,18-74,22)
(Valid 
;; def=BinarySearchTreeFirst.fst(71,34-74,45); use=BinarySearchTreeFirst.fst(74,18-74,22)
(Prims.precedes (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x1))
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0))
@x2
x_b98020eae7589a36221779c3f67bf83b_1)
)
...
;; def=Prims.fst(451,66-451,102); use=BinarySearchTreeFirst.fst(71,34-74,45)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree @x1)))

;; def=BinarySearchTreeFirst.fst(70,28-73,19); use=BinarySearchTreeFirst.fst(71,34-74,45)
(= @x2
@x5)
)
...
;; def=FStar.List.Tot.Base.fst(124,10-124,11); use=BinarySearchTreeFirst.fst(71,34-74,45)
(= (BinarySearchTreeFirst.in_order_opt @x1
@x2)
@x6)


;; def=BinarySearchTreeFirst.fst(34,33-34,39); use=BinarySearchTreeFirst.fst(74,40-74,45)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x3))


;; def=BinarySearchTreeFirst.fst(35,36-35,42); use=BinarySearchTreeFirst.fst(74,40-74,45)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 x_ae567c2fb75be05905677af440075565_0))


;; def=BinarySearchTreeFirst.fst(36,36-36,58); use=BinarySearchTreeFirst.fst(74,40-74,45)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0)
@x4)
(Prims.op_Equality Prims.int
@x3
...
;; def=BinarySearchTreeFirst.fst(37,36-37,57); use=BinarySearchTreeFirst.fst(74,40-74,45)
(= (FStar.Pervasives.Native.uu___is_None (BinarySearchTreeFirst.tree @x1)
@x2)
(Prims.op_Equality Prims.int
@x3
@x1))
...
;; def=BinarySearchTreeFirst.fst(71,34-74,45); use=BinarySearchTreeFirst.fst(74,40-74,45)
(or label_3

;; def=BinarySearchTreeFirst.fst(71,34-74,45); use=BinarySearchTreeFirst.fst(74,40-74,45)
(Valid 
;; def=BinarySearchTreeFirst.fst(71,34-74,45); use=BinarySearchTreeFirst.fst(74,40-74,45)
(Prims.precedes (FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0))
(FStar.Pervasives.Native.option (BinarySearchTreeFirst.tree x_ae567c2fb75be05905677af440075565_0))
@x4
x_b98020eae7589a36221779c3f67bf83b_1)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BinarySearchTreeFirst.in_order_opt, 1)
