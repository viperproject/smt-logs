...
; Externals for module FStar.Ref


; <Start encoding let sel>

(declare-fun FStar.Ref.sel (Term Term Term) Term)
(declare-fun Tm_ghost_arrow_6f46792a84717d84602fcdac46ffcb61 () Term)
(declare-fun FStar.Ref.sel@tok () Term)
...
(declare-fun FStar.Ref.upd (Term Term Term Term) Term)
(declare-fun Tm_ghost_arrow_af769ef87c3f9e3491cc07263413fcd2 () Term)
(declare-fun FStar.Ref.upd@tok () Term)
...
(declare-fun FStar.Ref.addr_of (Term Term) Term)
(declare-fun Tm_ghost_arrow_89025b87dacbcbd56486dc39bf398c0e () Term)
(declare-fun FStar.Ref.addr_of@tok () Term)
...
(declare-fun FStar.Ref.contains (Term Term Term) Term)
(declare-fun Tm_arrow_76e9f656162596fc9d054b804b7aec19 () Term)
(declare-fun FStar.Ref.contains@tok () Term)
...
(declare-fun FStar.Ref.unused_in (Term Term Term) Term)
(declare-fun Tm_arrow_089dcd19bb5f4a5de1ac1ec9dc5b3f7c () Term)
(declare-fun FStar.Ref.unused_in@tok () Term)
...
(declare-fun FStar.Ref.fresh (Term Term Term Term) Term)
(declare-fun Tm_arrow_ad529bb7c690a8c821512e18101cef9b () Term)
(declare-fun FStar.Ref.fresh@tok () Term)
...
(declare-fun FStar.Ref.only (Term Term) Term)
(declare-fun Tm_ghost_arrow_67c670833ecfc6811c862de721487223 () Term)
(declare-fun FStar.Ref.only@tok () Term)

; </end encoding let only>


; <Skipped val FStar.Ref.recall/>


; <Start encoding let recall>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Ref.recall (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Ref.recall@tok () Term)

; </end encoding let recall>


; <Skipped val FStar.Ref.alloc/>


; <Start encoding let alloc>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Ref.alloc (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Ref.alloc@tok () Term)

; </end encoding let alloc>


; <Skipped val FStar.Ref.read/>


; <Start encoding let read>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Ref.read (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Ref.read@tok () Term)

; </end encoding let read>


; <Skipped val FStar.Ref.write/>


; <Start encoding let write>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Ref.write (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Ref.write@tok () Term)

; </end encoding let write>


; <Skipped val FStar.Ref.op_Bang/>


; <Start encoding let op_Bang>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Ref.op_Bang (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Ref.op_Bang@tok () Term)

; </end encoding let op_Bang>


; <Skipped val FStar.Ref.op_Colon_Equals/>


; <Start encoding let op_Colon_Equals>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Ref.op_Colon_Equals (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Ref.op_Colon_Equals@tok () Term)

; </end encoding let op_Colon_Equals>


; End Externals for module FStar.Ref
...
; encoding sigelt let ignore


; <Start encoding let ignore>

(declare-fun Lens.ignore (Term Term) Term)

(declare-fun Lens.ignore@tok () Term)

; </end encoding let ignore>


; encoding sigelt type Lens.lens


; <Start encoding type Lens.lens>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.lens (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Lens.lens@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.Mklens (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mklens_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mklens_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mklens_get (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mklens_put (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Lens.Mklens
(declare-fun Lens.Mklens@tok () Term)

;;;;;;;;;;;;;;;;_: b -> _: a -> a
(declare-fun Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 (Term Term) Term)


;;;;;;;;;;;;;;;;get: (_: a -> b) -> put: (_: b -> _: a -> a) -> lens a b
(declare-fun Tm_arrow_0fe6b6eccce75220a914cfd818d5d70f () Term)

; <start constructor Lens.lens>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.lens ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
106)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
; </end constructor Lens.lens>


; <start constructor Lens.Mklens>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.Mklens ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
117)
(= __@x0
(Lens.Mklens (Lens.Mklens_a __@x0)
(Lens.Mklens_b __@x0)
(Lens.Mklens_get __@x0)
(Lens.Mklens_put __@x0)))))

; </end constructor Lens.Mklens>


; </end encoding type Lens.lens>


; encoding sigelt val Lens.__proj__Mklens__item__get


; <Start encoding val Lens.__proj__Mklens__item__get>

(declare-fun Lens.__proj__Mklens__item__get (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: lens a b -> _: a -> b
(declare-fun Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92 () Term)
(declare-fun Lens.__proj__Mklens__item__get@tok () Term)


; </end encoding val Lens.__proj__Mklens__item__get>


; encoding sigelt let __proj__Mklens__item__get


; <Skipped let __proj__Mklens__item__get/>


; encoding sigelt val Lens.__proj__Mklens__item__put


; <Start encoding val Lens.__proj__Mklens__item__put>

(declare-fun Lens.__proj__Mklens__item__put (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: lens a b -> _: b -> _: a -> a
(declare-fun Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac () Term)
(declare-fun Lens.__proj__Mklens__item__put@tok () Term)


; </end encoding val Lens.__proj__Mklens__item__put>


; encoding sigelt let __proj__Mklens__item__put


; <Skipped let __proj__Mklens__item__put/>


; encoding sigelt let op_Bar_Dot


; <Start encoding let op_Bar_Dot>

(declare-fun Lens.op_Bar_Dot (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: 'a -> l: lens 'a 'b -> 'b
(declare-fun Tm_arrow_dbc054e1d8df7840c7be64e99fd2973a () Term)
(declare-fun Lens.op_Bar_Dot@tok () Term)

; </end encoding let op_Bar_Dot>


; encoding sigelt let op_Bar_Colon_Equals


; <Start encoding let op_Bar_Colon_Equals>

(declare-fun Lens.op_Bar_Colon_Equals (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: 'a -> l: lens 'a 'b -> _: 'b -> 'a
(declare-fun Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070 () Term)
(declare-fun Lens.op_Bar_Colon_Equals@tok () Term)


(declare-fun Tm_abs_2a3edf4b01e4f2bd197952ce921068e0 (Term Term Term Term) Term)

; </end encoding let op_Bar_Colon_Equals>


; encoding sigelt let op_Bar_Dot_Dot


; <Start encoding let op_Bar_Dot_Dot>

(declare-fun Lens.op_Bar_Dot_Dot (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;m: lens 'a 'b -> l: lens 'b 'c -> lens 'a 'c
(declare-fun Tm_arrow_d4bb24b21949198540e5b12706e05e2b () Term)
(declare-fun Lens.op_Bar_Dot_Dot@tok () Term)



(declare-fun Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2 (Term Term Term Term Term) Term)




(declare-fun Tm_abs_519017a02c008e8d770d2bb88e107760 (Term Term Term Term Term) Term)

; </end encoding let op_Bar_Dot_Dot>
...
(declare-fun Lens.op_String_Assignment (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: 'a -> l: lens 'a 'b -> v: 'b -> 'a
(declare-fun Tm_arrow_4023da8f9120f361b1c91edb0295a058 () Term)
(declare-fun Lens.op_String_Assignment@tok () Term)
...
(declare-fun Lens.op_String_Access (Term Term Term Term) Term)

(declare-fun Lens.op_String_Access@tok () Term)

; </end encoding let op_String_Access>


; encoding sigelt type Lens.point


; <Start encoding type Lens.point>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.point () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.Mkpoint (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkpoint_x (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkpoint_y (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkpoint_z (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Lens.Mkpoint
(declare-fun Lens.Mkpoint@tok () Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int -> z: Prims.int -> point
(declare-fun Tm_arrow_ee5be747e0db648f097de6cfe2b2feed () Term)

; <start constructor Lens.point>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.point ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
177)
(= __@x0
Lens.point)))

; </end constructor Lens.point>


; <start constructor Lens.Mkpoint>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.Mkpoint ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
183)
(= __@x0
(Lens.Mkpoint (Lens.Mkpoint_x __@x0)
(Lens.Mkpoint_y __@x0)
(Lens.Mkpoint_z __@x0)))))

; </end constructor Lens.Mkpoint>


; </end encoding type Lens.point>


; encoding sigelt assume Lens.point__uu___haseq


; <Start encoding assume Lens.point__uu___haseq>


; </end encoding assume Lens.point__uu___haseq>


; encoding sigelt val Lens.__proj__Mkpoint__item__x


; <Start encoding val Lens.__proj__Mkpoint__item__x>

(declare-fun Lens.__proj__Mkpoint__item__x (Term) Term)
;;;;;;;;;;;;;;;;projectee: point -> Prims.int
(declare-fun Tm_arrow_312381d8813cf71a3e835505b06ccd99 () Term)
(declare-fun Lens.__proj__Mkpoint__item__x@tok () Term)

; </end encoding val Lens.__proj__Mkpoint__item__x>


; encoding sigelt let __proj__Mkpoint__item__x


; <Skipped let __proj__Mkpoint__item__x/>


; encoding sigelt val Lens.__proj__Mkpoint__item__y


; <Start encoding val Lens.__proj__Mkpoint__item__y>

(declare-fun Lens.__proj__Mkpoint__item__y (Term) Term)

(declare-fun Lens.__proj__Mkpoint__item__y@tok () Term)

; </end encoding val Lens.__proj__Mkpoint__item__y>


; encoding sigelt let __proj__Mkpoint__item__y


; <Skipped let __proj__Mkpoint__item__y/>


; encoding sigelt val Lens.__proj__Mkpoint__item__z


; <Start encoding val Lens.__proj__Mkpoint__item__z>

(declare-fun Lens.__proj__Mkpoint__item__z (Term) Term)

(declare-fun Lens.__proj__Mkpoint__item__z@tok () Term)

; </end encoding val Lens.__proj__Mkpoint__item__z>


; encoding sigelt let __proj__Mkpoint__item__z


; <Skipped let __proj__Mkpoint__item__z/>
...
(declare-fun Lens.x (Dummy_sort) Term)

(declare-fun Tm_abs_30aa2c44da896ed171a336780c884642 () Term)
;;;;;;;;;;;;;;;;x': Prims.int -> p: point -> point
(declare-fun Tm_arrow_c2a0c88e46965bac75ae0f7043d31a91 () Term)
(declare-fun Tm_abs_6295135fceac43a3b3829c81acba698c () Term)
...
(declare-fun Lens.y (Dummy_sort) Term)

(declare-fun Tm_abs_d49e5a7927656b15afcf03f85647fb12 () Term)

(declare-fun Tm_abs_7e8decff09d17d4753389bd389487823 () Term)

; </end encoding let y>


; encoding sigelt let z


; <Start encoding let z>

(declare-fun Lens.z (Dummy_sort) Term)

(declare-fun Tm_abs_8715976ea10d21fc497e4079ef5e561f () Term)

(declare-fun Tm_abs_d5124c0ea8927583ac7f1eb1ac7fe546 () Term)
...
; encoding sigelt type Lens.circle


; <Start encoding type Lens.circle>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.circle () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.Mkcircle (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkcircle_center (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkcircle_radius (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Lens.Mkcircle
(declare-fun Lens.Mkcircle@tok () Term)
;;;;;;;;;;;;;;;;center: point -> radius: Prims.nat -> circle
(declare-fun Tm_arrow_e70088a65d29dd9bf9f1dc715943c7be () Term)

; <start constructor Lens.circle>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.circle ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
215)
(= __@x0
Lens.circle)))

; </end constructor Lens.circle>


; <start constructor Lens.Mkcircle>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.Mkcircle ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
221)
(= __@x0
(Lens.Mkcircle (Lens.Mkcircle_center __@x0)
(Lens.Mkcircle_radius __@x0)))))

; </end constructor Lens.Mkcircle>


; </end encoding type Lens.circle>
...
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Lens.point; Namespace Lens; Name Lens.Mkpoint; Namespace Lens
(assert (! 
;; def=Lens.fst(58,5-58,10); use=Lens.fst(58,5-58,10)
...
@x3)
Lens.point))
:qid subterm_ordering_Lens.Mkpoint))

:named subterm_ordering_Lens.Mkpoint))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Lens.circle; Namespace Lens; Name Lens.Mkcircle; Namespace Lens
(assert (! 
;; def=Lens.fst(81,5-81,11); use=Lens.fst(81,5-81,11)
...
@x2)
Lens.circle))
:qid subterm_ordering_Lens.Mkcircle))

:named subterm_ordering_Lens.Mkcircle))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Lens.Mkpoint_z (Lens.Mkpoint @x0
@x1
@x2))
@x2)
 

:pattern ((Lens.Mkpoint @x0
@x1
@x2))
:qid projection_inverse_Lens.Mkpoint_z))

:named projection_inverse_Lens.Mkpoint_z))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.point; Namespace Lens; Name Lens.Mkpoint; Namespace Lens
(assert (! 
;; def=Lens.fst(58,5-58,10); use=Lens.fst(58,5-58,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Lens.Mkpoint_y (Lens.Mkpoint @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_Lens.Mkpoint_y))

:named projection_inverse_Lens.Mkpoint_y))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.point; Namespace Lens; Name Lens.Mkpoint; Namespace Lens
(assert (! 
;; def=Lens.fst(58,5-58,10); use=Lens.fst(58,5-58,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Lens.Mkpoint_x (Lens.Mkpoint @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_Lens.Mkpoint_x))

:named projection_inverse_Lens.Mkpoint_x))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.circle; Namespace Lens; Name Lens.Mkcircle; Namespace Lens
(assert (! 
;; def=Lens.fst(81,5-81,11); use=Lens.fst(81,5-81,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Lens.Mkcircle_radius (Lens.Mkcircle @x0
@x1))
@x1)
 

:pattern ((Lens.Mkcircle @x0
@x1))
:qid projection_inverse_Lens.Mkcircle_radius))

:named projection_inverse_Lens.Mkcircle_radius))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.circle; Namespace Lens; Name Lens.Mkcircle; Namespace Lens
(assert (! 
;; def=Lens.fst(81,5-81,11); use=Lens.fst(81,5-81,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Lens.Mkcircle_center (Lens.Mkcircle @x0
@x1))
@x0)
...
:pattern ((Lens.Mkcircle @x0
@x1))
:qid projection_inverse_Lens.Mkcircle_center))

:named projection_inverse_Lens.Mkcircle_center))
...
;;; Fact-ids: Name Lens.point; Namespace Lens; Name Lens.Mkpoint; Namespace Lens
(assert (! (HasType Lens.point
Tm_type)
:named kinding_Lens.point@tok))
;;; Fact-ids: Name Lens.circle; Namespace Lens; Name Lens.Mkcircle; Namespace Lens
(assert (! (HasType Lens.circle
Tm_type)
:named kinding_Lens.circle@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
@x1
Lens.point))
:qid fuel_guarded_inversion_Lens.point))

:named fuel_guarded_inversion_Lens.point))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Lens.circle; Namespace Lens; Name Lens.Mkcircle; Namespace Lens
(assert (! 
;; def=Lens.fst(81,5-81,11); use=Lens.fst(81,5-81,11)
...
@x1
Lens.circle))
:qid fuel_guarded_inversion_Lens.circle))

:named fuel_guarded_inversion_Lens.circle))
...
@x3)
Lens.point))
:qid data_typing_intro_Lens.Mkpoint@tok))

:named data_typing_intro_Lens.Mkpoint@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Lens.circle; Namespace Lens; Name Lens.Mkcircle; Namespace Lens
(assert (! 
;; def=Lens.fst(81,5-81,11); use=Lens.fst(81,5-81,11)
...
@x2)
Lens.circle))
:qid data_typing_intro_Lens.Mkcircle@tok))

:named data_typing_intro_Lens.Mkcircle@tok))
...
@x3)
Lens.point))
:qid data_elim_Lens.Mkpoint))

:named data_elim_Lens.Mkpoint))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Lens.circle; Namespace Lens; Name Lens.Mkcircle; Namespace Lens
(assert (! 
;; def=Lens.fst(81,5-81,11); use=Lens.fst(81,5-81,11)
...
@x2)
Lens.circle))
:qid data_elim_Lens.Mkcircle))

:named data_elim_Lens.Mkcircle))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name Lens.point; Namespace Lens; Name Lens.Mkpoint; Namespace Lens
(assert (! (= 177
(Term_constr_id Lens.point))
:named constructor_distinct_Lens.point))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lens.circle; Namespace Lens; Name Lens.Mkcircle; Namespace Lens
(assert (! (= 215
(Term_constr_id Lens.circle))
:named constructor_distinct_Lens.circle))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lens.point; Namespace Lens; Name Lens.Mkpoint; Namespace Lens
(assert (! 
;; def=Lens.fst(58,5-58,10); use=Lens.fst(58,5-58,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 183
(Term_constr_id (Lens.Mkpoint @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_Lens.Mkpoint))

:named constructor_distinct_Lens.Mkpoint))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lens.circle; Namespace Lens; Name Lens.Mkcircle; Namespace Lens
(assert (! 
;; def=Lens.fst(81,5-81,11); use=Lens.fst(81,5-81,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= 221
(Term_constr_id (Lens.Mkcircle @x0
@x1)))
 

:pattern ((Lens.Mkcircle @x0
@x1))
:qid constructor_distinct_Lens.Mkcircle))

:named constructor_distinct_Lens.Mkcircle))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Monotonic.Heap.core_mref; Namespace FStar.Monotonic.Heap
(assert (! 
;; def=FStar.Monotonic.Heap.fsti(39,4-39,13); use=FStar.Monotonic.Heap.fsti(39,4-39,13)
...
;;;;;;;;;;;;;;;;Assumption: Lens.point__uu___haseq
;;; Fact-ids: Name Lens.point__uu___haseq; Namespace Lens
(assert (! (Valid (Prims.hasEq Lens.point))
:named assumption_Lens.point__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
Lens.circle))
:qid Lens_pretyping_73f64c0922cb511e616695000043f83b))

:named Lens_pretyping_73f64c0922cb511e616695000043f83b))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Lens.point; Namespace Lens; Name Lens.Mkpoint; Namespace Lens
(assert (! 
;; def=Lens.fst(58,5-58,10); use=Lens.fst(58,5-58,10)
...
@x0
Lens.point))
:qid Lens_pretyping_60107029805c7066ee040590f41f940e))

:named Lens_pretyping_60107029805c7066ee040590f41f940e))
...
; Starting query at Lens.fst(81,0-84,1)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq Lens.circle ==>
; (forall (center: Lens.point) (radius: Prims.nat). Prims.hasEq Lens.point /\ Prims.hasEq Prims.nat)


; Context: While encoding a query
; While typechecking the top-level declaration `type Lens.circle`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=Lens.fst(81,0-84,1); use=Lens.fst(81,0-84,1)
(Valid 
;; def=Lens.fst(81,0-84,1); use=Lens.fst(81,0-84,1)
(Prims.hasEq Lens.circle)
)
...
;; def=Lens.fst(81,0-84,1); use=Lens.fst(81,0-84,1)
(and 
;; def=Lens.fst(81,0-84,1); use=Lens.fst(82,10-82,15)
(or label_1

;; def=Lens.fst(81,0-84,1); use=Lens.fst(81,0-84,1)
(Valid 
;; def=Lens.fst(81,0-84,1); use=Lens.fst(81,0-84,1)
(Prims.hasEq Lens.point)
)
)


;; def=Lens.fst(81,0-84,1); use=Lens.fst(83,10-83,13)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lens.circle, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Lens.point__uu___haseq, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
; encoding sigelt assume Lens.circle__uu___haseq


; <Start encoding assume Lens.circle__uu___haseq>


; </end encoding assume Lens.circle__uu___haseq>


; encoding sigelt val Lens.__proj__Mkcircle__item__center


; <Start encoding val Lens.__proj__Mkcircle__item__center>

(declare-fun Lens.__proj__Mkcircle__item__center (Term) Term)
;;;;;;;;;;;;;;;;projectee: circle -> point
(declare-fun Tm_arrow_56215c642ba4f786413f5155436c6e14 () Term)
(declare-fun Lens.__proj__Mkcircle__item__center@tok () Term)

; </end encoding val Lens.__proj__Mkcircle__item__center>


; encoding sigelt let __proj__Mkcircle__item__center


; <Skipped let __proj__Mkcircle__item__center/>


; encoding sigelt val Lens.__proj__Mkcircle__item__radius


; <Start encoding val Lens.__proj__Mkcircle__item__radius>

(declare-fun Lens.__proj__Mkcircle__item__radius (Term) Term)
;;;;;;;;;;;;;;;;projectee: circle -> Prims.nat
(declare-fun Tm_arrow_a1f16fcfb96ed1b0651b3cfec42d194c () Term)
(declare-fun Lens.__proj__Mkcircle__item__radius@tok () Term)

; </end encoding val Lens.__proj__Mkcircle__item__radius>


; encoding sigelt let __proj__Mkcircle__item__radius


; <Skipped let __proj__Mkcircle__item__radius/>


; encoding sigelt let center


; <Start encoding let center>

(declare-fun Lens.center (Dummy_sort) Term)

(declare-fun Tm_abs_c618576bd4380f277052ff4bc41b4b90 () Term)
;;;;;;;;;;;;;;;;n: point -> c: circle -> circle
(declare-fun Tm_arrow_2a939e86e978759e45cfb0c8bdb957b2 () Term)
(declare-fun Tm_abs_96e87fbaefce25a779d4dc8298d052ca () Term)

; </end encoding let center>


; encoding sigelt let radius


; <Start encoding let radius>

(declare-fun Lens.radius (Dummy_sort) Term)

(declare-fun Tm_abs_c5e07c1b9af37f10ff445a6ec217fed4 () Term)
;;;;;;;;;;;;;;;;n: Prims.nat -> c: circle -> circle
(declare-fun Tm_arrow_519a99e78512f76562d082f6f2fd8fcb () Term)
(declare-fun Tm_abs_5a147bad5d5b08fa3e380010f7678ff0 () Term)

; </end encoding let radius>


; encoding sigelt let getY


; <Start encoding let getY>

(declare-fun Lens.getY (Term) Term)
;;;;;;;;;;;;;;;;c: circle -> Prims.int
(declare-fun Tm_arrow_d780d435c7711dd266d61d9e50a58f62 () Term)
(declare-fun Lens.getY@tok () Term)

; </end encoding let getY>
...
(declare-fun Lens.getY_ (Term) Term)

(declare-fun Lens.getY_@tok () Term)
...
(declare-fun Lens.getY__ (Term) Term)

(declare-fun Lens.getY__@tok () Term)

; </end encoding let getY''>


; encoding sigelt let setY


; <Start encoding let setY>

(declare-fun Lens.setY (Term Term) Term)
;;;;;;;;;;;;;;;;c: circle -> new_y: Prims.int -> circle
(declare-fun Tm_arrow_d86a5c655074d944fc7a65e2f5f6b631 () Term)
(declare-fun Lens.setY@tok () Term)

; </end encoding let setY>


; encoding sigelt let tedious_setY


; <Start encoding let tedious_setY>

(declare-fun Lens.tedious_setY (Term Term) Term)

(declare-fun Lens.tedious_setY@tok () Term)

; </end encoding let tedious_setY>


; encoding sigelt let moveUp


; <Start encoding let moveUp>

(declare-fun Lens.moveUp (Term Term) Term)

(declare-fun Lens.moveUp@tok () Term)

; </end encoding let moveUp>
...
; encoding sigelt type Lens.rgb


; <Start encoding type Lens.rgb>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.rgb () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.Mkrgb (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkrgb_red (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkrgb_green (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkrgb_blue (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Lens.Mkrgb
(declare-fun Lens.Mkrgb@tok () Term)
;;;;;;;;;;;;;;;;red: Prims.nat -> green: Prims.nat -> blue: Prims.nat -> rgb
(declare-fun Tm_arrow_7dda29c7509e1b9ec44366930a7f4bd4 () Term)

; <start constructor Lens.rgb>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.rgb ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
269)
(= __@x0
Lens.rgb)))

; </end constructor Lens.rgb>


; <start constructor Lens.Mkrgb>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.Mkrgb ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
275)
(= __@x0
(Lens.Mkrgb (Lens.Mkrgb_red __@x0)
(Lens.Mkrgb_green __@x0)
(Lens.Mkrgb_blue __@x0)))))

; </end constructor Lens.Mkrgb>


; </end encoding type Lens.rgb>
...
:named typing_FStar.Monotonic.Heap.core_mref))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Lens.rgb; Namespace Lens; Name Lens.Mkrgb; Namespace Lens
(assert (! 
;; def=Lens.fst(121,5-121,8); use=Lens.fst(121,5-121,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Lens.Mkrgb @x1
@x2
...
@x3)
Lens.rgb))
:qid subterm_ordering_Lens.Mkrgb))

:named subterm_ordering_Lens.Mkrgb))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! (HasType Tm_refine_f1ecc6ab6882a651504f328937700647
Tm_type)
...
;; def=Lens.fst(121,5-121,8); use=Lens.fst(121,5-121,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Lens.Mkrgb_red (Lens.Mkrgb @x0
@x1
@x2))
@x0)
 

:pattern ((Lens.Mkrgb @x0
@x1
@x2))
:qid projection_inverse_Lens.Mkrgb_red))

:named projection_inverse_Lens.Mkrgb_red))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.rgb; Namespace Lens; Name Lens.Mkrgb; Namespace Lens
(assert (! 
;; def=Lens.fst(121,5-121,8); use=Lens.fst(121,5-121,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Lens.Mkrgb_green (Lens.Mkrgb @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_Lens.Mkrgb_green))

:named projection_inverse_Lens.Mkrgb_green))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.rgb; Namespace Lens; Name Lens.Mkrgb; Namespace Lens
(assert (! 
;; def=Lens.fst(121,5-121,8); use=Lens.fst(121,5-121,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Lens.Mkrgb_blue (Lens.Mkrgb @x0
@x1
@x2))
@x2)
...
@x1
@x2))
:qid projection_inverse_Lens.Mkrgb_blue))

:named projection_inverse_Lens.Mkrgb_blue))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
:named kinding_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))
;;; Fact-ids: Name Lens.rgb; Namespace Lens; Name Lens.Mkrgb; Namespace Lens
(assert (! (HasType Lens.rgb
Tm_type)
:named kinding_Lens.rgb@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
@x1
Lens.rgb))
:qid fuel_guarded_inversion_Lens.rgb))

:named fuel_guarded_inversion_Lens.rgb))
;;;;;;;;;;;;;;;;Equation for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
@x3)
Lens.rgb))
:qid data_typing_intro_Lens.Mkrgb@tok))

:named data_typing_intro_Lens.Mkrgb@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Lens.rgb; Namespace Lens; Name Lens.Mkrgb; Namespace Lens
(assert (! 
;; def=Lens.fst(121,5-121,8); use=Lens.fst(121,5-121,8)
...
@x3)
Lens.rgb))
:qid data_elim_Lens.Mkrgb))

:named data_elim_Lens.Mkrgb))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
(Term_constr_id Prims.unit))
...
;;; Fact-ids: Name Lens.rgb; Namespace Lens; Name Lens.Mkrgb; Namespace Lens
(assert (! (= 269
(Term_constr_id Lens.rgb))
:named constructor_distinct_Lens.rgb))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lens.rgb; Namespace Lens; Name Lens.Mkrgb; Namespace Lens
(assert (! 
;; def=Lens.fst(121,5-121,8); use=Lens.fst(121,5-121,8)
...
@x1
@x2))
:qid constructor_distinct_Lens.Mkrgb))

:named constructor_distinct_Lens.Mkrgb))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Monotonic.Heap.core_mref; Namespace FStar.Monotonic.Heap
(assert (! 
;; def=FStar.Monotonic.Heap.fsti(39,4-39,13); use=FStar.Monotonic.Heap.fsti(39,4-39,13)
...
@x0
Lens.rgb))
:qid Lens_pretyping_aeaac797fd209dd57ed2c86fb5c1cfc4))

:named Lens_pretyping_aeaac797fd209dd57ed2c86fb5c1cfc4))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
; Starting query at Lens.fst(121,0-125,1)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq Lens.rgb ==>
; (forall (red: Prims.nat) (green: Prims.nat) (blue: Prims.nat).
;     Prims.hasEq Prims.nat /\ Prims.hasEq Prims.nat /\ Prims.hasEq Prims.nat)


; Context: While encoding a query
; While typechecking the top-level declaration `type Lens.rgb`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=Lens.fst(121,0-125,1); use=Lens.fst(121,0-125,1)
(Valid 
;; def=Lens.fst(121,0-125,1); use=Lens.fst(121,0-125,1)
(Prims.hasEq Lens.rgb)
)
...
;; def=Lens.fst(121,0-125,1); use=Lens.fst(121,0-125,1)
(and 
;; def=Lens.fst(121,0-125,1); use=Lens.fst(122,6-122,9)
(or label_1
...
;; def=Lens.fst(121,0-125,1); use=Lens.fst(123,8-123,11)
(or label_2
...
;; def=Lens.fst(121,0-125,1); use=Lens.fst(124,7-124,10)
(or label_3
...
; encoding sigelt assume Lens.rgb__uu___haseq


; <Start encoding assume Lens.rgb__uu___haseq>


; </end encoding assume Lens.rgb__uu___haseq>


; encoding sigelt val Lens.__proj__Mkrgb__item__red


; <Start encoding val Lens.__proj__Mkrgb__item__red>

(declare-fun Lens.__proj__Mkrgb__item__red (Term) Term)
;;;;;;;;;;;;;;;;projectee: rgb -> Prims.nat
(declare-fun Tm_arrow_d27cedea9031ed2059ebe072a1fd6727 () Term)
(declare-fun Lens.__proj__Mkrgb__item__red@tok () Term)

; </end encoding val Lens.__proj__Mkrgb__item__red>


; encoding sigelt let __proj__Mkrgb__item__red


; <Skipped let __proj__Mkrgb__item__red/>


; encoding sigelt val Lens.__proj__Mkrgb__item__green


; <Start encoding val Lens.__proj__Mkrgb__item__green>

(declare-fun Lens.__proj__Mkrgb__item__green (Term) Term)

(declare-fun Lens.__proj__Mkrgb__item__green@tok () Term)

; </end encoding val Lens.__proj__Mkrgb__item__green>


; encoding sigelt let __proj__Mkrgb__item__green


; <Skipped let __proj__Mkrgb__item__green/>


; encoding sigelt val Lens.__proj__Mkrgb__item__blue


; <Start encoding val Lens.__proj__Mkrgb__item__blue>

(declare-fun Lens.__proj__Mkrgb__item__blue (Term) Term)

(declare-fun Lens.__proj__Mkrgb__item__blue@tok () Term)

; </end encoding val Lens.__proj__Mkrgb__item__blue>


; encoding sigelt let __proj__Mkrgb__item__blue


; <Skipped let __proj__Mkrgb__item__blue/>


; encoding sigelt let red


; <Start encoding let red>

(declare-fun Lens.red (Dummy_sort) Term)

(declare-fun Tm_abs_e62b8ae02f0211879edf17759337dece () Term)
;;;;;;;;;;;;;;;;z: Prims.nat -> p: rgb -> rgb
(declare-fun Tm_arrow_ccd56f7cb8c5273c9009295eb85225c8 () Term)
(declare-fun Tm_abs_d381b3714593bf26c531ba4e353815a1 () Term)

; </end encoding let red>


; encoding sigelt let green


; <Start encoding let green>

(declare-fun Lens.green (Dummy_sort) Term)

(declare-fun Tm_abs_535fbbec11a7b7c1e39c280cb0cf8b87 () Term)

(declare-fun Tm_abs_333b4209beaa25a6af3fe8b856ca8526 () Term)

; </end encoding let green>


; encoding sigelt let blue


; <Start encoding let blue>

(declare-fun Lens.blue (Dummy_sort) Term)

(declare-fun Tm_abs_03fafe12d8e5c84492d2e7e05f5cbe72 () Term)

(declare-fun Tm_abs_268aa11c85ff1ef7893c6df895f824b7 () Term)

; </end encoding let blue>
...
; encoding sigelt type Lens.colored


; <Start encoding type Lens.colored>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.colored (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Lens.colored@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.Mkcolored (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkcolored_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkcolored_color (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkcolored_payload (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Lens.Mkcolored
(declare-fun Lens.Mkcolored@tok () Term)
;;;;;;;;;;;;;;;;color: rgb -> payload: a -> colored a
(declare-fun Tm_arrow_38f1b2637236997428d2ac55f6dbde84 () Term)

; <start constructor Lens.colored>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.colored ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
318)
(exists ((@x0 Term))
 (! (= __@x0
...
; </end constructor Lens.colored>


; <start constructor Lens.Mkcolored>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.Mkcolored ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
325)
(= __@x0
(Lens.Mkcolored (Lens.Mkcolored_a __@x0)
(Lens.Mkcolored_color __@x0)
(Lens.Mkcolored_payload __@x0)))))

; </end constructor Lens.Mkcolored>


; </end encoding type Lens.colored>
...
;;; Fact-ids: Name Lens.colored; Namespace Lens; Name Lens.Mkcolored; Namespace Lens
(assert (! 
;; def=Lens.fst(141,5-141,12); use=Lens.fst(141,5-141,12)
(forall ((@x0 Term))
 (! (= (ApplyTT Lens.colored@tok
@x0)
(Lens.colored @x0))
 

:pattern ((ApplyTT Lens.colored@tok
@x0))

:pattern ((Lens.colored @x0))
:qid token_correspondence_Lens.colored@tok))

:named token_correspondence_Lens.colored@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Lens.rgb; Namespace Lens; Name Lens.Mkrgb; Namespace Lens
(assert (! 
;; def=Lens.fst(121,5-121,8); use=Lens.fst(121,5-121,8)
...
@x3)
(Lens.colored @x4)))
:qid subterm_ordering_Lens.Mkcolored))

:named subterm_ordering_Lens.Mkcolored))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! (HasType Tm_refine_f1ecc6ab6882a651504f328937700647
Tm_type)
...
;; def=Lens.fst(141,5-141,12); use=Lens.fst(141,5-141,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Lens.Mkcolored_payload (Lens.Mkcolored @x0
@x1
@x2))
@x2)
 

:pattern ((Lens.Mkcolored @x0
@x1
@x2))
:qid projection_inverse_Lens.Mkcolored_payload))

:named projection_inverse_Lens.Mkcolored_payload))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.colored; Namespace Lens; Name Lens.Mkcolored; Namespace Lens
(assert (! 
;; def=Lens.fst(141,5-141,12); use=Lens.fst(141,5-141,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Lens.Mkcolored_color (Lens.Mkcolored @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_Lens.Mkcolored_color))

:named projection_inverse_Lens.Mkcolored_color))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.colored; Namespace Lens; Name Lens.Mkcolored; Namespace Lens
(assert (! 
;; def=Lens.fst(141,5-141,12); use=Lens.fst(141,5-141,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Lens.Mkcolored_a (Lens.Mkcolored @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_Lens.Mkcolored_a))

:named projection_inverse_Lens.Mkcolored_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Lens.colored; Namespace Lens; Name Lens.Mkcolored; Namespace Lens
(assert (! (is-Tm_arrow (PreType Lens.colored@tok))
:named pre_kinding_Lens.colored@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
:named kinding_Lens.rgb@tok))
;;; Fact-ids: Name Lens.colored; Namespace Lens; Name Lens.Mkcolored; Namespace Lens
(assert (! (and (IsTotFun Lens.colored@tok)

;; def=Lens.fst(141,5-141,12); use=Lens.fst(141,5-141,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Lens.colored @x0)
Tm_type))
 

:pattern ((Lens.colored @x0))
:qid kinding_Lens.colored@tok))
)
:named kinding_Lens.colored@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
@x1
(Lens.colored @x2)))
:qid fuel_guarded_inversion_Lens.colored))

:named fuel_guarded_inversion_Lens.colored))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Lens.colored; Namespace Lens; Name Lens.Mkcolored; Namespace Lens
(assert (! (= 319
(Term_constr_id Lens.colored@tok))
:named fresh_token_Lens.colored@tok))
;;;;;;;;;;;;;;;;Equation for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
@x3)
(Lens.colored @x1)))
:qid data_typing_intro_Lens.Mkcolored@tok))

:named data_typing_intro_Lens.Mkcolored@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Lens.rgb; Namespace Lens; Name Lens.Mkrgb; Namespace Lens
(assert (! 
;; def=Lens.fst(121,5-121,8); use=Lens.fst(121,5-121,8)
...
@x3)
(Lens.colored @x4)))
:qid data_elim_Lens.Mkcolored))

:named data_elim_Lens.Mkcolored))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
(Term_constr_id Prims.unit))
...
(forall ((@x0 Term))
 (! (= 318
(Term_constr_id (Lens.colored @x0)))
 

:pattern ((Lens.colored @x0))
:qid constructor_distinct_Lens.colored))

:named constructor_distinct_Lens.colored))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lens.rgb; Namespace Lens; Name Lens.Mkrgb; Namespace Lens
(assert (! 
;; def=Lens.fst(121,5-121,8); use=Lens.fst(121,5-121,8)
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 325
(Term_constr_id (Lens.Mkcolored @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_Lens.Mkcolored))

:named constructor_distinct_Lens.Mkcolored))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Monotonic.Heap.core_mref; Namespace FStar.Monotonic.Heap
(assert (! 
;; def=FStar.Monotonic.Heap.fsti(39,4-39,13); use=FStar.Monotonic.Heap.fsti(39,4-39,13)
...
:named constructor_distinct_FStar.Monotonic.Heap.core_mref))
;;;;;;;;;;;;;;;;Assumption: Lens.rgb__uu___haseq
;;; Fact-ids: Name Lens.rgb__uu___haseq; Namespace Lens
(assert (! (Valid (Prims.hasEq Lens.rgb))
:named assumption_Lens.rgb__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
@x0
(Lens.colored @x2)))
:qid Lens_pretyping_466778cecf85f4d121f6ff037a360f7d))

:named Lens_pretyping_466778cecf85f4d121f6ff037a360f7d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Preorder.relation; Namespace FStar.Preorder
(assert (! 
;; def=FStar.Preorder.fst(20,15-20,40); use=FStar.Preorder.fst(20,25-20,40)
...
; Starting query at Lens.fst(141,0-144,1)
...
;   Prims.hasEq a /\
;   (forall (a: Type). {:pattern Prims.hasEq (Lens.colored a)}
;       Prims.hasEq a ==> Prims.hasEq (Lens.colored a)) ==>
;   (forall (color: Lens.rgb) (payload: a). Prims.hasEq Lens.rgb /\ Prims.hasEq a)


; Context: While encoding a query
; While typechecking the top-level declaration `type Lens.colored`
...
;; def=Lens.fst(141,0-144,1); use=Lens.fst(141,0-144,1)
(Valid 
;; def=Lens.fst(141,0-144,1); use=Lens.fst(141,0-144,1)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=Lens.fst(141,0-144,1); use=Lens.fst(141,0-144,1)
(Prims.hasEq (Lens.colored @x1))
)
)
 

:pattern ((Prims.hasEq (Lens.colored @x1)))
:qid @query.1))
)
...
;; def=Lens.fst(141,0-144,1); use=Lens.fst(141,0-144,1)
(and 
;; def=Lens.fst(141,0-144,1); use=Lens.fst(142,8-142,11)
(or label_1
...
;; def=Lens.fst(141,0-144,1); use=Lens.fst(143,10-143,11)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lens.colored, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_Lens.rgb__uu___haseq
...
; encoding sigelt assume Lens.colored__uu___haseq


; <Start encoding assume Lens.colored__uu___haseq>


; </end encoding assume Lens.colored__uu___haseq>


; encoding sigelt val Lens.__proj__Mkcolored__item__color


; <Start encoding val Lens.__proj__Mkcolored__item__color>

(declare-fun Lens.__proj__Mkcolored__item__color (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: colored a -> rgb
(declare-fun Tm_arrow_8fd227894246d68d32470c80f30e787e () Term)
(declare-fun Lens.__proj__Mkcolored__item__color@tok () Term)

; </end encoding val Lens.__proj__Mkcolored__item__color>


; encoding sigelt let __proj__Mkcolored__item__color


; <Skipped let __proj__Mkcolored__item__color/>


; encoding sigelt val Lens.__proj__Mkcolored__item__payload


; <Start encoding val Lens.__proj__Mkcolored__item__payload>

(declare-fun Lens.__proj__Mkcolored__item__payload (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: colored a -> a
(declare-fun Tm_arrow_3cee57860f2c8eafcb0d9ba7552d4af8 () Term)
(declare-fun Lens.__proj__Mkcolored__item__payload@tok () Term)

; </end encoding val Lens.__proj__Mkcolored__item__payload>


; encoding sigelt let __proj__Mkcolored__item__payload


; <Skipped let __proj__Mkcolored__item__payload/>


; encoding sigelt let color


; <Start encoding let color>

(declare-fun Lens.color (Term) Term)
;;;;;;;;;;;;;;;;lens (colored a) rgb
(declare-fun Tm_arrow_f9ad852c5fe4349a72b12e82212302df () Term)
(declare-fun Lens.color@tok () Term)
;;;;;;;;;;;;;;;;p: colored a -> rgb
(declare-fun Tm_arrow_70718708c434ed70fbdaa88227865dc5 (Term) Term)
(declare-fun Tm_abs_90d7d2e98068ab1dfe578907234f6218 (Term) Term)
;;;;;;;;;;;;;;;;z: rgb -> p: colored a -> colored a
(declare-fun Tm_arrow_7270683854a921d35f2cc0546447ec81 (Term) Term)
(declare-fun Tm_abs_9e1fb80221b6aec60048d25c2cfc6884 (Term) Term)

; </end encoding let color>


; encoding sigelt let payload


; <Start encoding let payload>

(declare-fun Lens.payload (Term) Term)
;;;;;;;;;;;;;;;;lens (colored a) a
(declare-fun Tm_arrow_e062da2bb6c7e9a12d7b347f42fa6691 () Term)
(declare-fun Lens.payload@tok () Term)
;;;;;;;;;;;;;;;;p: colored a -> a
(declare-fun Tm_arrow_4097e55f753a20224cc5778a5f5166ff (Term) Term)
(declare-fun Tm_abs_54c4667321635a0149d8f94f1724c432 (Term) Term)
;;;;;;;;;;;;;;;;z: a -> p: colored a -> colored a
(declare-fun Tm_arrow_01f0f1692a4ed0bd61a88ea73fe38807 (Term) Term)
(declare-fun Tm_abs_fdb9e818f8c5a3a3209cb08282bb0699 (Term) Term)

; </end encoding let payload>
...
(declare-fun Lens.moveUp_ (Term Term) Term)
;;;;;;;;;;;;;;;;c: colored circle -> offset_y: Prims.int -> colored circle
(declare-fun Tm_arrow_dc57c14a6f094402f5239e8ccfc6af04 () Term)
(declare-fun Lens.moveUp_@tok () Term)

; </end encoding let moveUp'>


; encoding sigelt let op_Bar_Bar


; <Start encoding let op_Bar_Bar>

(declare-fun Lens.op_Bar_Bar (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;l1: lens 'a 'b -> l2: lens 'a 'c -> lens 'a ('b & 'c)
(declare-fun Tm_arrow_af80ee792164590fce249ec2b03178b5 () Term)
(declare-fun Lens.op_Bar_Bar@tok () Term)


;;;;;;;;;;;;;;;;a: 'a -> 'b & 'c
(declare-fun Tm_arrow_3f4f9f2257e8795905fff41379c18362 (Term Term Term) Term)
(declare-fun Tm_abs_70f8dae70c331631e6732e1e326b36d1 (Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;_: 'b & 'c -> a: 'a -> 'a
(declare-fun Tm_arrow_b0c81149e3b5a7f096e712a03c1f0a77 (Term Term Term) Term)
(declare-fun Tm_abs_c2cfb195a6eb0653d05e1c6ebe22fe67 (Term Term Term Term Term) Term)

; </end encoding let op_Bar_Bar>


; encoding sigelt let makeGreen


; <Start encoding let makeGreen>

(declare-fun Lens.makeGreen (Term) Term)
;;;;;;;;;;;;;;;;c: colored circle -> colored circle
(declare-fun Tm_arrow_8d1d133f6a859d9d1ef34bf8e66617e9 () Term)
(declare-fun Lens.makeGreen@tok () Term)

; </end encoding let makeGreen>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.ST.ref; Namespace FStar.ST
(assert (! 
;; def=FStar.ST.fst(130,5-130,8); use=FStar.ST.fst(130,5-130,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.ST.ref @x0)
Tm_type))
 

:pattern ((FStar.ST.ref @x0))
:qid typing_FStar.ST.ref))

:named typing_FStar.ST.ref))
;;;;;;;;;;;;;;;;free var typing
...
:named true_interp))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Lens.lens@tok
@x0)
@x1)
(Lens.lens @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Lens.lens@tok
@x0)
@x1))

:pattern ((Lens.lens @x0
@x1))
:qid token_correspondence_Lens.lens@tok))

:named token_correspondence_Lens.lens@tok))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name FStar.ST.contains_pred; Namespace FStar.ST
(assert (! 
;; def=FStar.ST.fst(79,4-79,17); use=FStar.ST.fst(79,4-79,17)
...
(Lens.lens @x5
@x6)))
:qid subterm_ordering_Lens.Mklens))

:named subterm_ordering_Lens.Mklens))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! (HasType Tm_refine_f1ecc6ab6882a651504f328937700647
Tm_type)
...
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Lens.Mklens_put (Lens.Mklens @x0
@x1
@x2
@x3))
@x3)
...
:pattern ((Lens.Mklens @x0
@x1
@x2
@x3))
:qid projection_inverse_Lens.Mklens_put))

:named projection_inverse_Lens.Mklens_put))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Lens.Mklens_get (Lens.Mklens @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Lens.Mklens_get))

:named projection_inverse_Lens.Mklens_get))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Lens.Mklens_b (Lens.Mklens @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Lens.Mklens_b))

:named projection_inverse_Lens.Mklens_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Lens.Mklens_a (Lens.Mklens @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_Lens.Mklens_a))

:named projection_inverse_Lens.Mklens_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! (is-Tm_arrow (PreType Lens.lens@tok))
:named pre_kinding_Lens.lens@tok))
...
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,11-29,21); use=Lens.fst(31,7-31,18)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! (and (IsTotFun Lens.lens@tok)

;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Lens.lens@tok
@x0))
 

:pattern ((ApplyTT Lens.lens@tok
@x0))
:qid kinding_Lens.lens@tok))
...
:pattern ((Lens.lens @x0
@x1))
:qid kinding_Lens.lens@tok.1))
)
:named kinding_Lens.lens@tok))
...
(Lens.lens @x2
@x3)))
:qid fuel_guarded_inversion_Lens.lens))

:named fuel_guarded_inversion_Lens.lens))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! (= 107
(Term_constr_id Lens.lens@tok))
:named fresh_token_Lens.lens@tok))
;;;;;;;;;;;;;;;;Equation for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
:pattern ((FStar.ST.ref @x0))
:qid equation_FStar.ST.ref))

:named equation_FStar.ST.ref))
...
(Lens.lens @x1
@x2)))
:qid data_typing_intro_Lens.Mklens@tok))

:named data_typing_intro_Lens.Mklens@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
(HasTypeFuel @u0
@x4
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x5
@x6))))
...
(Lens.lens @x5
@x6)))
:qid data_elim_Lens.Mklens))

:named data_elim_Lens.Mklens))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
(Term_constr_id Prims.unit))
...
(forall ((@x0 Term) (@x1 Term))
 (! (= 106
(Term_constr_id (Lens.lens @x0
@x1)))
 

:pattern ((Lens.lens @x0
@x1))
:qid constructor_distinct_Lens.lens))

:named constructor_distinct_Lens.lens))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
@x2
@x3))
:qid constructor_distinct_Lens.Mklens))

:named constructor_distinct_Lens.Mklens))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.Monotonic.Heap.core_mref; Namespace FStar.Monotonic.Heap
(assert (! 
;; def=FStar.Monotonic.Heap.fsti(39,4-39,13); use=FStar.Monotonic.Heap.fsti(39,4-39,13)
...
(Lens.lens @x2
@x3)))
:qid Lens_pretyping_04422c6f65860c797261d647ba704993))

:named Lens_pretyping_04422c6f65860c797261d647ba704993))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,11-29,21); use=Lens.fst(31,7-31,18)
...
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x2
@x3)))
:qid Lens_pre_typing_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))

:named Lens_pre_typing_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))
...
@x3)
@x4))
:qid Lens_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Lens_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81.2))
))
...
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x1
@x2)))
:qid Lens_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))

:named Lens_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.TSet.map; Namespace FStar.TSet
(assert (! 
;; def=FStar.TSet.fsti(117,10-117,21); use=FStar.TSet.fsti(117,31-117,41)
...
; Starting query at Lens.fst(183,0-200,1)

(declare-fun Lens.stlens (Term Term Term) Term)
;;;;;;;;;;;;;;;;l: lens a b -> Type
(declare-fun Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde
Tm_type)
:named kinding_Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Lens.fst(183,16-183,43); use=Lens.fst(183,16-183,43)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde))
:qid Lens_pre_typing_Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde))

:named Lens_pre_typing_Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde
;;; Fact-ids: 
(assert (! 
;; def=Lens.fst(183,16-183,43); use=Lens.fst(183,16-183,43)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid Lens_interpretation_Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Lens_interpretation_Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde.2))
...
@x1)
@x2))
:qid Lens_interpretation_Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde))
:qid Lens_interpretation_Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde))

:named Lens_interpretation_Tm_arrow_8d17d7b20fce0edf67627ffdbdf59cde))
(declare-fun Lens.stlens@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Lens.fst(183,5-183,11); use=Lens.fst(183,5-183,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Lens.stlens@tok
@x0)
@x1)
@x2)
(Lens.stlens @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Lens.stlens@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Lens.stlens))

:named token_correspondence_Lens.stlens))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Lens.fst(183,5-183,11); use=Lens.fst(183,5-183,11)
...
:pattern ((Lens.stlens @x1
@x2
@x3))
:qid function_token_typing_Lens.stlens.1))
)
 

:pattern ((ApplyTT @x0
Lens.stlens@tok))
:qid function_token_typing_Lens.stlens))

:named function_token_typing_Lens.stlens))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Lens.fst(183,5-183,11); use=Lens.fst(183,5-183,11)
...
(Lens.lens @x0
@x1)))
(HasType (Lens.stlens @x0
@x1
@x2)
Tm_type))
 

:pattern ((Lens.stlens @x0
@x1
@x2))
:qid typing_Lens.stlens))

:named typing_Lens.stlens))
(declare-fun label_1 () Bool)
(declare-fun Non_total_Tm_arrow_1ea65d87e61dbd447c2d986db556b53e (Term Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=Lens.fst(183,24-186,20); use=Lens.fst(186,15-187,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Lens.lens @x0
@x1)))
(HasType (Non_total_Tm_arrow_1ea65d87e61dbd447c2d986db556b53e @x0
@x1
@x2)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_1ea65d87e61dbd447c2d986db556b53e @x0
@x1
@x2)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_1ea65d87e61dbd447c2d986db556b53e))

:named non_total_function_typing_Non_total_Tm_arrow_1ea65d87e61dbd447c2d986db556b53e))

; Encoding query formula : forall (a: Type) (b: Type) (l: Lens.lens a b) (st_get: (r: FStar.ST.ref a -> FStar.ST.ST b)).
...
; *) r == s ==> Prims.hasEq Prims.nat


; Context: While encoding a query
; While typechecking the top-level declaration `type Lens.stlens`
...
@x1))
(HasType @x3
(Non_total_Tm_arrow_1ea65d87e61dbd447c2d986db556b53e @x0
@x1
@x2)))

;; def=dummy(0,0-0,0); use=Lens.fst(183,0-200,1)
...
;; def=Lens.fst(197,25-197,31); use=Lens.fst(192,15-194,24)
(= @x5
@x7)
)

;; def=Prims.fst(73,23-73,30); use=Lens.fst(198,25-198,33)
(or label_1

;; def=Prims.fst(73,23-73,30); use=Lens.fst(192,15-194,24)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Lens.fst(192,15-194,24)
(Prims.hasEq Prims.nat)
)
...
; encoding sigelt type Lens.stlens


; <Start encoding type Lens.stlens>
...
(declare-fun Lens.stlens@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Lens.Mkstlens (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkstlens_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkstlens_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkstlens_l (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkstlens_st_get (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Lens.Mkstlens_st_put (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Lens.Mkstlens
(declare-fun Lens.Mkstlens@tok () Term)
(declare-fun Non_total_Tm_arrow_1ea65d87e61dbd447c2d986db556b53e (Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_3f46d2b72e68dc4ea2808b51782667d5 (Term Term Term) Term)


;;;;;;;;;;;;;;;;st_get: (r: FStar.ST.ref a -> FStar.ST.ST b) ->     st_put: (y: b -> r: FStar.ST.ref a -> FStar.ST.ST (FStar.ST.ref a))   -> stlens l
(declare-fun Tm_arrow_7aa9ad7a2a8c07bfd46100e3b3cfff22 () Term)

; <start constructor Lens.stlens>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.stlens ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
378)
(exists ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= __@x0
...
; </end constructor Lens.stlens>


; <start constructor Lens.Mkstlens>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Lens.Mkstlens ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
405)
(= __@x0
(Lens.Mkstlens (Lens.Mkstlens_a __@x0)
(Lens.Mkstlens_b __@x0)
(Lens.Mkstlens_l __@x0)
(Lens.Mkstlens_st_get __@x0)
(Lens.Mkstlens_st_put __@x0)))))

; </end constructor Lens.Mkstlens>


; </end encoding type Lens.stlens>


; encoding sigelt val Lens.__proj__Mkstlens__item__st_get


; <Start encoding val Lens.__proj__Mkstlens__item__st_get>

(declare-fun Lens.__proj__Mkstlens__item__st_get (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: stlens l -> r: FStar.ST.ref a -> FStar.ST.ST b
(declare-fun Tm_arrow_c9181dd8b2627dc2a7c987de3bf38d1a () Term)
(declare-fun Lens.__proj__Mkstlens__item__st_get@tok () Term)


; </end encoding val Lens.__proj__Mkstlens__item__st_get>


; encoding sigelt let __proj__Mkstlens__item__st_get


; <Skipped let __proj__Mkstlens__item__st_get/>
...
:named true_interp))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Lens.stlens; Namespace Lens; Name Lens.Mkstlens; Namespace Lens
(assert (! 
;; def=Lens.fst(183,5-183,11); use=Lens.fst(183,5-183,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Lens.stlens@tok
...
@x1
@x2))
:qid token_correspondence_Lens.stlens@tok))

:named token_correspondence_Lens.stlens@tok))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
@x7
@x8)))
:qid subterm_ordering_Lens.Mkstlens))

:named subterm_ordering_Lens.Mkstlens))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Lens.Mkstlens_st_put (Lens.Mkstlens @x0
@x1
@x2
@x3
@x4))
...
:pattern ((Lens.Mkstlens @x0
@x1
@x2
@x3
@x4))
:qid projection_inverse_Lens.Mkstlens_st_put))

:named projection_inverse_Lens.Mkstlens_st_put))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.stlens; Namespace Lens; Name Lens.Mkstlens; Namespace Lens
(assert (! 
;; def=Lens.fst(183,5-183,11); use=Lens.fst(183,5-183,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Lens.Mkstlens_st_get (Lens.Mkstlens @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Lens.Mkstlens_st_get))

:named projection_inverse_Lens.Mkstlens_st_get))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.stlens; Namespace Lens; Name Lens.Mkstlens; Namespace Lens
(assert (! 
;; def=Lens.fst(183,5-183,11); use=Lens.fst(183,5-183,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Lens.Mkstlens_l (Lens.Mkstlens @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Lens.Mkstlens_l))

:named projection_inverse_Lens.Mkstlens_l))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.stlens; Namespace Lens; Name Lens.Mkstlens; Namespace Lens
(assert (! 
;; def=Lens.fst(183,5-183,11); use=Lens.fst(183,5-183,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Lens.Mkstlens_b (Lens.Mkstlens @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Lens.Mkstlens_b))

:named projection_inverse_Lens.Mkstlens_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.stlens; Namespace Lens; Name Lens.Mkstlens; Namespace Lens
(assert (! 
;; def=Lens.fst(183,5-183,11); use=Lens.fst(183,5-183,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Lens.Mkstlens_a (Lens.Mkstlens @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Lens.Mkstlens_a))

:named projection_inverse_Lens.Mkstlens_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Lens.stlens; Namespace Lens; Name Lens.Mkstlens; Namespace Lens
(assert (! (is-Tm_arrow (PreType Lens.stlens@tok))
:named pre_kinding_Lens.stlens@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! (is-Tm_arrow (PreType Lens.lens@tok))
:named pre_kinding_Lens.lens@tok))
...
;;; Fact-ids: Name Lens.stlens; Namespace Lens; Name Lens.Mkstlens; Namespace Lens
(assert (! 
;; def=Lens.fst(183,24-194,24); use=Lens.fst(192,15-194,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Lens.lens @x1
@x0)))
(HasType (Non_total_Tm_arrow_3f46d2b72e68dc4ea2808b51782667d5 @x0
@x1
@x2)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_3f46d2b72e68dc4ea2808b51782667d5 @x0
@x1
@x2)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_3f46d2b72e68dc4ea2808b51782667d5))

:named non_total_function_typing_Non_total_Tm_arrow_3f46d2b72e68dc4ea2808b51782667d5))
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: Name Lens.stlens; Namespace Lens; Name Lens.Mkstlens; Namespace Lens
(assert (! 
;; def=Lens.fst(183,24-186,20); use=Lens.fst(186,15-187,18)
...
:named kinding_Prims.trivial@tok))
;;; Fact-ids: Name Lens.stlens; Namespace Lens; Name Lens.Mkstlens; Namespace Lens
(assert (! (and (IsTotFun Lens.stlens@tok)

;; def=Lens.fst(183,5-183,11); use=Lens.fst(183,5-183,11)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Lens.stlens@tok
@x0))
 

:pattern ((ApplyTT Lens.stlens@tok
@x0))
:qid kinding_Lens.stlens@tok))


;; def=Lens.fst(183,5-183,11); use=Lens.fst(183,5-183,11)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (ApplyTT (ApplyTT Lens.stlens@tok
@x0)
@x1))
 

:pattern ((ApplyTT (ApplyTT Lens.stlens@tok
@x0)
@x1))
:qid kinding_Lens.stlens@tok.1))
...
@x1
@x2))
:qid kinding_Lens.stlens@tok.2))
)
:named kinding_Lens.stlens@tok))
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! (and (IsTotFun Lens.lens@tok)
...
@x3
@x4)))
:qid fuel_guarded_inversion_Lens.stlens))

:named fuel_guarded_inversion_Lens.stlens))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
;;; Fact-ids: Name Lens.stlens; Namespace Lens; Name Lens.Mkstlens; Namespace Lens
(assert (! (= 379
(Term_constr_id Lens.stlens@tok))
:named fresh_token_Lens.stlens@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! (= 107
(Term_constr_id Lens.lens@tok))
...
(HasTypeFuel @u0
@x4
(Non_total_Tm_arrow_1ea65d87e61dbd447c2d986db556b53e @x1
@x2
@x3))
(HasTypeFuel @u0
@x5
(Non_total_Tm_arrow_3f46d2b72e68dc4ea2808b51782667d5 @x2
@x1
@x3)))
(HasTypeFuel @u0
(Lens.Mkstlens @x1
...
@x2
@x3)))
:qid data_typing_intro_Lens.Mkstlens@tok))

:named data_typing_intro_Lens.Mkstlens@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
(HasTypeFuel @u0
@x4
(Non_total_Tm_arrow_1ea65d87e61dbd447c2d986db556b53e @x6
@x7
@x8))
(HasTypeFuel @u0
@x5
(Non_total_Tm_arrow_3f46d2b72e68dc4ea2808b51782667d5 @x7
@x6
@x8))))
...
@x7
@x8)))
:qid data_elim_Lens.Mkstlens))

:named data_elim_Lens.Mkstlens))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
@x1
@x2))
:qid constructor_distinct_Lens.stlens))

:named constructor_distinct_Lens.stlens))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= 405
(Term_constr_id (Lens.Mkstlens @x0
@x1
@x2
@x3
@x4)))
...
@x3
@x4))
:qid constructor_distinct_Lens.Mkstlens))

:named constructor_distinct_Lens.Mkstlens))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
@x3
@x4)))
:qid Lens_pretyping_70e375d643c4167c993b8424af280646))

:named Lens_pretyping_70e375d643c4167c993b8424af280646))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Lens.lens; Namespace Lens; Name Lens.Mklens; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,9); use=Lens.fst(29,5-29,9)
...
; Starting query at Lens.fst(192,5-192,11)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type0) (b: Type) (l: Lens.lens a b) (projectee: Lens.stlens l).
;   (*  - Subtyping check failed
;   - Expected type Type got type Type
; *)
;   forall (y: b)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val Lens.__proj__Mkstlens__item__st_put`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Lens.fst(192,5-192,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=Lens.fst(197,25-197,31); use=Lens.fst(192,5-192,11)
(= @x5
@x7)
)
...
;; def=Prims.fst(73,23-73,30); use=Lens.fst(192,5-192,11)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Lens.fst(192,5-192,11)
(Prims.hasEq Prims.nat)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lens.__proj__Mkstlens__item__st_put, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
; encoding sigelt val Lens.__proj__Mkstlens__item__st_put


; <Start encoding val Lens.__proj__Mkstlens__item__st_put>

(declare-fun Lens.__proj__Mkstlens__item__st_put (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: stlens l -> y: b -> r: FStar.ST.ref a -> FStar.ST.ST (FStar.ST.ref a)
(declare-fun Tm_arrow_b902c63b32248ad86758a90c46ce0289 () Term)
(declare-fun Lens.__proj__Mkstlens__item__st_put@tok () Term)


; </end encoding val Lens.__proj__Mkstlens__item__st_put>
...
; Encoding query formula : forall (a: Type) (b: Type) (l: Lens.lens a b) (projectee: Lens.stlens l).
;   (forall (proj_ret: Lens.stlens l).
;       (*  - Subtyping check failed
;   - Expected type Type got type Type
; *)
;       forall (y: b)
...
;         (*  - Could not prove post-condition
; *) r == s ==> Prims.hasEq Prims.nat) /\
;   (forall (b: (r: FStar.ST.ref a -> FStar.ST.ST b))
;       (b: (y: b -> r: FStar.ST.ref a -> FStar.ST.ST (FStar.ST.ref a))).
;       projectee == Lens.Mkstlens b b ==>
;       (forall (y: b)
;           (r: FStar.ST.ref a)
;           (h0: FStar.Monotonic.Heap.heap)
;           (s: FStar.ST.ref a)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Mkstlens__item__st_put`
...
;; def=Prims.fst(413,99-413,120); use=Lens.fst(192,5-192,11)
(and (forall ((@x4 Term))
 (! (implies (HasType @x4
(Lens.stlens @x0
@x1
...
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Non_total_Tm_arrow_3f46d2b72e68dc4ea2808b51782667d5 @x1
@x0
@x2))

;; def=Lens.fst(183,5-183,11); use=Lens.fst(192,5-192,11)
(= @x3
(Lens.Mkstlens @x0
@x1
@x2
...
;; def=dummy(0,0-0,0); use=Lens.fst(192,5-192,11)
(forall ((@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lens.__proj__Mkstlens__item__st_put, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
; encoding sigelt let __proj__Mkstlens__item__st_put


; <Skipped let __proj__Mkstlens__item__st_put/>

;;;;;;;;;;;;;;;;typing_Tm_abs_2a3edf4b01e4f2bd197952ce921068e0
;;; Fact-ids: Name Lens.op_Bar_Colon_Equals; Namespace Lens
(assert (! 
;; def=Lens.fst(39,56-39,65); use=Lens.fst(39,56-39,65)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_2a3edf4b01e4f2bd197952ce921068e0 @x0
@x1
@x2
@x3)
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x2
...
:pattern ((Tm_abs_2a3edf4b01e4f2bd197952ce921068e0 @x0
@x1
@x2
@x3))
:qid typing_Tm_abs_2a3edf4b01e4f2bd197952ce921068e0))

:named typing_Tm_abs_2a3edf4b01e4f2bd197952ce921068e0))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.prop; Namespace Prims
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lens.op_String_Assignment; Namespace Lens
(assert (! 
;; def=Lens.fst(50,4-50,24); use=Lens.fst(50,4-50,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x4
@x1))
(HasType (Lens.op_String_Assignment @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Lens.op_String_Assignment @x0
@x1
@x2
@x3
@x4))
:qid typing_Lens.op_String_Assignment))

:named typing_Lens.op_String_Assignment))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lens.op_String_Access; Namespace Lens
(assert (! 
;; def=Lens.fst(53,4-53,20); use=Lens.fst(53,4-53,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Lens.lens @x0
@x1)))
(HasType (Lens.op_String_Access @x0
@x1
@x2
@x3)
@x1))
...
:pattern ((Lens.op_String_Access @x0
@x1
@x2
@x3))
:qid typing_Lens.op_String_Access))

:named typing_Lens.op_String_Access))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lens.op_Bar_Dot; Namespace Lens
(assert (! 
;; def=Lens.fst(35,6-35,8); use=Lens.fst(35,6-35,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((Lens.op_Bar_Dot @x0
@x1
@x2
@x3))
:qid typing_Lens.op_Bar_Dot))

:named typing_Lens.op_Bar_Dot))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lens.op_Bar_Colon_Equals; Namespace Lens
(assert (! 
;; def=Lens.fst(39,6-39,9); use=Lens.fst(39,6-39,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Lens.lens @x0
@x1)))
(HasType (Lens.op_Bar_Colon_Equals @x0
@x1
@x2
@x3)
...
:pattern ((Lens.op_Bar_Colon_Equals @x0
@x1
@x2
@x3))
:qid typing_Lens.op_Bar_Colon_Equals))

:named typing_Lens.op_Bar_Colon_Equals))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lens.__proj__Mklens__item__put; Namespace Lens
(assert (! 
;; def=Lens.fst(31,2-31,5); use=Lens.fst(31,2-31,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Lens.lens @x0
@x1)))
(HasType (Lens.__proj__Mklens__item__put @x0
@x1
@x2)
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x0
@x1)))
 

:pattern ((Lens.__proj__Mklens__item__put @x0
@x1
@x2))
:qid typing_Lens.__proj__Mklens__item__put))

:named typing_Lens.__proj__Mklens__item__put))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lens.__proj__Mklens__item__get; Namespace Lens
(assert (! 
;; def=Lens.fst(30,2-30,5); use=Lens.fst(30,2-30,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Lens.lens @x0
@x1)))
(HasType (Lens.__proj__Mklens__item__get @x0
@x1
@x2)
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x0)))
...
:pattern ((Lens.__proj__Mklens__item__get @x0
@x1
@x2))
:qid typing_Lens.__proj__Mklens__item__get))

:named typing_Lens.__proj__Mklens__item__get))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Monotonic.Heap.only; Namespace FStar.Monotonic.Heap
(assert (! 
;; def=FStar.Monotonic.Heap.fsti(63,4-63,8); use=FStar.Monotonic.Heap.fsti(63,4-63,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(FStar.Monotonic.Heap.mref @x0
@x1)))
(HasType (FStar.Monotonic.Heap.only @x0
@x1
@x2)
(FStar.Monotonic.Heap.set Prims.nat)))
 

:pattern ((FStar.Monotonic.Heap.only @x0
@x1
@x2))
:qid typing_FStar.Monotonic.Heap.only))

:named typing_FStar.Monotonic.Heap.only))
;;;;;;;;;;;;;;;;free var typing
...
;; def=Lens.fst(39,6-39,9); use=Lens.fst(39,6-39,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Lens.op_Bar_Colon_Equals@tok
@x0)
@x1)
@x2)
@x3)
(Lens.op_Bar_Colon_Equals @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Lens.op_Bar_Colon_Equals@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Lens.op_Bar_Colon_Equals))

:named token_correspondence_Lens.op_Bar_Colon_Equals))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Lens.__proj__Mklens__item__put; Namespace Lens
(assert (! 
;; def=Lens.fst(31,2-31,5); use=Lens.fst(31,2-31,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Lens.__proj__Mklens__item__put@tok
@x0)
@x1)
@x2)
(Lens.__proj__Mklens__item__put @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT Lens.__proj__Mklens__item__put@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Lens.__proj__Mklens__item__put))

:named token_correspondence_Lens.__proj__Mklens__item__put))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name Lens.__proj__Mklens__item__get; Namespace Lens
(assert (! 
;; def=Lens.fst(30,2-30,5); use=Lens.fst(30,2-30,5)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Lens.__proj__Mklens__item__get@tok
@x0)
@x1)
@x2)
(Lens.__proj__Mklens__item__get @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT Lens.__proj__Mklens__item__get@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Lens.__proj__Mklens__item__get))

:named token_correspondence_Lens.__proj__Mklens__item__get))
;;;;;;;;;;;;;;;;refinement kinding
...
@x1
@x2))
:qid proj_equation_Lens.Mklens_put))

:named proj_equation_Lens.Mklens_put))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Lens.__proj__Mklens__item__get; Namespace Lens
(assert (! 
;; def=Lens.fst(30,2-30,5); use=Lens.fst(30,2-30,5)
...
@x1
@x2))
:qid proj_equation_Lens.Mklens_get))

:named proj_equation_Lens.Mklens_get))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92
;;; Fact-ids: Name Lens.__proj__Mklens__item__get; Namespace Lens
(assert (! (HasType Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92
Tm_type)
:named kinding_Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac
;;; Fact-ids: Name Lens.__proj__Mklens__item__put; Namespace Lens
(assert (! (HasType Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac
Tm_type)
:named kinding_Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070
;;; Fact-ids: Name Lens.op_Bar_Colon_Equals; Namespace Lens
(assert (! (HasType Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070
Tm_type)
:named kinding_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2a3edf4b01e4f2bd197952ce921068e0
;;; Fact-ids: Name Lens.op_Bar_Colon_Equals; Namespace Lens
(assert (! 
;; def=Lens.fst(39,56-39,65); use=Lens.fst(39,56-39,65)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (Tm_abs_2a3edf4b01e4f2bd197952ce921068e0 @x1
@x2
@x3
@x4)
@x0)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Lens.__proj__Mklens__item__put@tok
@x3)
@x4)
@x1)
@x0)
...
:pattern ((ApplyTT (Tm_abs_2a3edf4b01e4f2bd197952ce921068e0 @x1
@x2
@x3
@x4)
@x0))
:qid interpretation_Tm_abs_2a3edf4b01e4f2bd197952ce921068e0))

:named interpretation_Tm_abs_2a3edf4b01e4f2bd197952ce921068e0))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Lens.op_Bar_Colon_Equals@tok
Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070))
...
@x3)
@x4)
(Lens.op_Bar_Colon_Equals @x1
@x2
@x3
@x4))
 

:pattern ((Lens.op_Bar_Colon_Equals @x1
@x2
@x3
@x4))
:qid function_token_typing_Lens.op_Bar_Colon_Equals.1))
)
 

:pattern ((ApplyTT @x0
Lens.op_Bar_Colon_Equals@tok))
:qid function_token_typing_Lens.op_Bar_Colon_Equals))

:named function_token_typing_Lens.op_Bar_Colon_Equals))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Lens.__proj__Mklens__item__put; Namespace Lens
(assert (! 
;; def=Lens.fst(31,2-31,5); use=Lens.fst(31,2-31,5)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Lens.__proj__Mklens__item__put@tok
Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac))
...
@x2)
@x3)
(Lens.__proj__Mklens__item__put @x1
@x2
@x3))
 

:pattern ((Lens.__proj__Mklens__item__put @x1
@x2
@x3))
:qid function_token_typing_Lens.__proj__Mklens__item__put.1))
)
 

:pattern ((ApplyTT @x0
Lens.__proj__Mklens__item__put@tok))
:qid function_token_typing_Lens.__proj__Mklens__item__put))

:named function_token_typing_Lens.__proj__Mklens__item__put))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Lens.__proj__Mklens__item__get; Namespace Lens
(assert (! 
;; def=Lens.fst(30,2-30,5); use=Lens.fst(30,2-30,5)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Lens.__proj__Mklens__item__get@tok
Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92))
...
@x2)
@x3)
(Lens.__proj__Mklens__item__get @x1
@x2
@x3))
 

:pattern ((Lens.__proj__Mklens__item__get @x1
@x2
@x3))
:qid function_token_typing_Lens.__proj__Mklens__item__get.1))
)
 

:pattern ((ApplyTT @x0
Lens.__proj__Mklens__item__get@tok))
:qid function_token_typing_Lens.__proj__Mklens__item__get))

:named function_token_typing_Lens.__proj__Mklens__item__get))
;;;;;;;;;;;;;;;;Equation for Prims.prop
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (= Prims.prop
Tm_refine_73f210ca6e0061ed4a3150f69b8f33bf)
:named equation_Prims.prop))
;;;;;;;;;;;;;;;;Equation for Lens.op_String_Assignment
;;; Fact-ids: Name Lens.op_String_Assignment; Namespace Lens
(assert (! 
;; def=Lens.fst(50,4-50,24); use=Lens.fst(50,4-50,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Lens.op_String_Assignment @x0
@x1
@x2
@x3
@x4)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Lens.op_Bar_Colon_Equals@tok
@x0)
@x1)
@x2)
@x3)
...
@x3
@x4))
:qid equation_Lens.op_String_Assignment))

:named equation_Lens.op_String_Assignment))
;;;;;;;;;;;;;;;;Equation for Lens.op_String_Access
;;; Fact-ids: Name Lens.op_String_Access; Namespace Lens
(assert (! 
;; def=Lens.fst(53,4-53,20); use=Lens.fst(53,4-53,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Lens.op_String_Access @x0
@x1
@x2
@x3)
(Lens.op_Bar_Dot @x0
...
@x2
@x3))
:qid equation_Lens.op_String_Access))

:named equation_Lens.op_String_Access))
;;;;;;;;;;;;;;;;Equation for Lens.op_Bar_Dot
;;; Fact-ids: Name Lens.op_Bar_Dot; Namespace Lens
(assert (! 
;; def=Lens.fst(35,6-35,8); use=Lens.fst(35,6-35,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT Lens.__proj__Mklens__item__get@tok
@x0)
@x1)
@x3)
@x2))
...
@x2
@x3))
:qid equation_Lens.op_Bar_Dot))

:named equation_Lens.op_Bar_Dot))
;;;;;;;;;;;;;;;;Equation for Lens.op_Bar_Colon_Equals
;;; Fact-ids: Name Lens.op_Bar_Colon_Equals; Namespace Lens
(assert (! 
;; def=Lens.fst(39,6-39,9); use=Lens.fst(39,6-39,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3)
(Tm_abs_2a3edf4b01e4f2bd197952ce921068e0 @x3
@x2
@x0
@x1))
...
@x2
@x3))
:qid equation_Lens.op_Bar_Colon_Equals))

:named equation_Lens.op_Bar_Colon_Equals))
...
;;;;;;;;;;;;;;;;Equation for FStar.Monotonic.Heap.only
;;; Fact-ids: Name FStar.Monotonic.Heap.only; Namespace FStar.Monotonic.Heap
(assert (! 
;; def=FStar.Monotonic.Heap.fsti(63,4-63,8); use=FStar.Monotonic.Heap.fsti(63,4-63,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.Monotonic.Heap.only @x0
@x1
@x2)
...
@x1
@x2))
:qid equation_FStar.Monotonic.Heap.only))

:named equation_FStar.Monotonic.Heap.only))
...
;;; Fact-ids: Name Lens.__proj__Mklens__item__get; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,26); use=Lens.fst(29,5-29,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92)
...
@x1
Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92))
:qid Lens_pre_typing_Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92))

:named Lens_pre_typing_Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lens.__proj__Mklens__item__put; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,26); use=Lens.fst(29,5-29,26)
...
@x1
Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac))
:qid Lens_pre_typing_Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac))

:named Lens_pre_typing_Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Lens.op_Bar_Colon_Equals; Namespace Lens
(assert (! 
;; def=Lens.fst(29,22-39,32); use=Lens.fst(39,15-39,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070)
...
@x1
Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070))
:qid Lens_pre_typing_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070))

:named Lens_pre_typing_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92
;;; Fact-ids: Name Lens.__proj__Mklens__item__get; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,26); use=Lens.fst(29,5-29,26)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid Lens_interpretation_Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Lens_interpretation_Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92.2))
...
@x1)
@x2))
:qid Lens_interpretation_Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92))
:qid Lens_interpretation_Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92))

:named Lens_interpretation_Tm_arrow_ba4a7b0fbb1fa398d2bce81f0aa18e92))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac
;;; Fact-ids: Name Lens.__proj__Mklens__item__put; Namespace Lens
(assert (! 
;; def=Lens.fst(29,5-29,26); use=Lens.fst(29,5-29,26)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid Lens_interpretation_Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Lens_interpretation_Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac.2))
...
@x1)
@x2))
:qid Lens_interpretation_Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac))
:qid Lens_interpretation_Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac))

:named Lens_interpretation_Tm_arrow_2ce151c9288e49e44ce225ab99a4d2ac))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070
;;; Fact-ids: Name Lens.op_Bar_Colon_Equals; Namespace Lens
(assert (! 
;; def=Lens.fst(29,22-39,32); use=Lens.fst(39,15-39,44)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid Lens_interpretation_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Lens_interpretation_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070.2))
...
@x1)
@x2))
:qid Lens_interpretation_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070.3))
...
@x2)
@x3))
:qid Lens_interpretation_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070))
:qid Lens_interpretation_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070))

:named Lens_interpretation_Tm_arrow_0e9aebbd722f2a2a08db21b1bf510070))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.Pervasives.st_post_h'; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(442,21-442,67); use=FStar.Pervasives.fsti(442,36-442,67)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
Lens.op_Bar_Colon_Equals@tok))
:named @kick_partial_app_d9741ca8655613e9b8d4bf3cfb84996e))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Lens.op_Bar_Dot; Namespace Lens
(assert (! (Valid (ApplyTT __uu__PartialApp
Lens.__proj__Mklens__item__get@tok))
:named @kick_partial_app_cd1cf8150e36f91d5e2b5a0da59cd110))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name Lens.op_Bar_Colon_Equals; Namespace Lens
(assert (! (Valid (ApplyTT __uu__PartialApp
Lens.__proj__Mklens__item__put@tok))
:named @kick_partial_app_2f714bfc674d87d16f2a9d49809db91e))
(push) ;; push{2

; Starting query at Lens.fst(204,2-205,57)
...
; Encoding query formula : forall (a: Type) (b: Type) (l: Lens.lens a b).
;   (*  - Could not prove post-condition
; *)
;   (forall (r: FStar.ST.ref a).
;       (*  - Could not prove post-condition
; *)
;       forall (p: FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap b)
;         (h: FStar.Monotonic.Heap.heap).
;         (forall (a: b) (h1: FStar.Monotonic.Heap.heap).
;             h == h1 /\ a == (FStar.Monotonic.Heap.sel h1 r |. l) ==> p a h1) ==>
;         p (FStar.Monotonic.Heap.sel h r).[ l ] h) /\
;   (forall (any_result: (r: FStar.ST.ref a -> FStar.ST.ST b)) (x: b) (r: FStar.ST.ref a).
;       (*  - Could not prove post-condition
; *)
;       forall (p: FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap (FStar.ST.ref a))
;         (h: FStar.Monotonic.Heap.heap).
;         (forall (a: FStar.ST.ref a) (h1: FStar.Monotonic.Heap.heap).
;             r == a /\
;             FStar.Monotonic.Heap.modifies (FStar.Set.singleton (FStar.Monotonic.Heap.addr_of r))
;               h
;               h1 /\ FStar.Monotonic.Heap.sel h1 r == ((FStar.Monotonic.Heap.sel h r).[ l ] <- x) ==>
;             p a h1) ==>
;         (forall (a: Prims.unit) (h1: FStar.Monotonic.Heap.heap).
;             FStar.Monotonic.Heap.contains h r /\
;             FStar.Monotonic.Heap.modifies (FStar.Monotonic.Heap.only r) h h1 /\
;             FStar.Monotonic.Heap.equal_dom h h1 /\
;             FStar.Monotonic.Heap.sel h1 r == ((FStar.Monotonic.Heap.sel h r).[ l ] <- x) ==>
;             p r h1))


; Context: While encoding a query
; While typechecking the top-level declaration `let st`
...
;; def=Prims.fst(459,77-459,89); use=Lens.fst(204,2-205,57)
(and 
;; def=dummy(0,0-0,0); use=Lens.fst(204,2-205,57)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.ST.ref @x0))

;; def=FStar.Pervasives.fsti(484,2-484,63); use=Lens.fst(204,2-205,57)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
...
;; def=FStar.ST.fst(76,50-76,87); use=Lens.fst(204,29-204,37)
...
;; def=Lens.fst(189,38-189,44); use=Lens.fst(204,29-204,37)
(or label_3
...
;; def=Lens.fst(189,48-189,69); use=Lens.fst(204,29-204,37)
(or label_4
...
;; def=FStar.ST.fst(76,80-76,86); use=Lens.fst(204,29-204,37)
(Valid 
;; def=FStar.ST.fst(76,80-76,86); use=Lens.fst(204,29-204,37)
(ApplyTT (ApplyTT @x4
@x6)
...
;; def=FStar.Pervasives.fsti(463,24-463,34); use=Lens.fst(204,29-204,37)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=Lens.fst(204,29-204,37)
(ApplyTT (ApplyTT @x4
(Lens.op_String_Access @x0
...
;; def=Prims.fst(451,66-451,102); use=Lens.fst(204,2-205,57)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Non_total_Tm_arrow_1ea65d87e61dbd447c2d986db556b53e @x0
@x1
...
;; def=FStar.ST.fst(76,50-76,87); use=Lens.fst(205,35-205,56)
...
;; def=Lens.fst(197,25-197,31); use=Lens.fst(205,35-205,56)
(or label_7
...
;; def=Lens.fst(198,25-198,67); use=Lens.fst(205,35-205,56)
(or label_8
...
;; def=Lens.fst(199,25-199,60); use=Lens.fst(205,35-205,56)
(or label_9
...
;; def=FStar.ST.fst(76,80-76,86); use=Lens.fst(205,35-205,56)
(Valid 
;; def=FStar.ST.fst(76,80-76,86); use=Lens.fst(205,35-205,56)
(ApplyTT (ApplyTT @x6
@x8)
...
;; def=FStar.ST.fst(76,50-76,87); use=Lens.fst(205,37-205,39)
(forall ((@x8 Term) (@x9 Term))
...
;; def=FStar.Ref.fst(39,4-39,21); use=Lens.fst(205,37-205,39)
(Valid 
;; def=FStar.Ref.fst(39,4-39,21); use=Lens.fst(205,37-205,39)
(FStar.Monotonic.Heap.contains @x0
(FStar.Heap.trivial_preorder @x0)
...
;; def=FStar.Ref.fst(73,62-73,85); use=Lens.fst(205,37-205,39)
(Valid 
;; def=FStar.Ref.fst(73,62-73,85); use=Lens.fst(205,37-205,39)
(FStar.Monotonic.Heap.modifies (FStar.Monotonic.Heap.only @x0
(FStar.Heap.trivial_preorder @x0)
@x5)
@x7
@x9)
...
;; def=FStar.Ref.fst(73,89-73,104); use=Lens.fst(205,37-205,39)
(Valid 
;; def=FStar.Ref.fst(73,89-73,104); use=Lens.fst(205,37-205,39)
(FStar.Monotonic.Heap.equal_dom @x7
@x9)
)


;; def=FStar.Ref.fst(73,108-73,121); use=Lens.fst(205,37-205,39)
(= (FStar.Monotonic.Heap.sel @x0
(FStar.Heap.trivial_preorder @x0)
@x9
@x5)
...
;; def=FStar.Pervasives.fsti(463,24-463,34); use=Lens.fst(205,35-205,56)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=Lens.fst(205,35-205,56)
(ApplyTT (ApplyTT @x6
@x5)
...
(declare-fun Lens.st (Term Term Term) Term)
;;;;;;;;;;;;;;;;l: lens a b -> stlens l
(declare-fun Tm_arrow_984c86de3dd230585b7461ac67b55322 () Term)
(declare-fun Lens.st@tok () Term)
;;;;;;;;;;;;;;;;Imprecise function encoding
(declare-fun Tm_abs_Lens_505 (Term Term Term) Term)
;;;;;;;;;;;;;;;;Imprecise function encoding
(declare-fun Tm_abs_Lens_506 (Term Term Term) Term)

; </end encoding let st>

;;;;;;;;;;;;;;;;typing_Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2
;;; Fact-ids: Name Lens.op_Bar_Dot_Dot; Namespace Lens
(assert (! 
;; def=Lens.fst(44,18-44,33); use=Lens.fst(44,18-44,33)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2 @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2))

:named typing_Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2))
;;;;;;;;;;;;;;;;typing_Tm_abs_519017a02c008e8d770d2bb88e107760
;;; Fact-ids: Name Lens.op_Bar_Dot_Dot; Namespace Lens
(assert (! 
;; def=Lens.fst(45,30-45,57); use=Lens.fst(45,30-45,57)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_519017a02c008e8d770d2bb88e107760 @x0
@x1
@x2
@x3
@x4)
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x3
@x4))
 

:pattern ((Tm_abs_519017a02c008e8d770d2bb88e107760 @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_519017a02c008e8d770d2bb88e107760))

:named typing_Tm_abs_519017a02c008e8d770d2bb88e107760))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Lens.op_Bar_Dot_Dot; Namespace Lens
(assert (! 
;; def=Lens.fst(43,6-43,9); use=Lens.fst(43,6-43,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Lens.lens @x1
@x2)))
(HasType (Lens.op_Bar_Dot_Dot @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Lens.op_Bar_Dot_Dot @x0
@x1
@x2
@x3
@x4))
:qid typing_Lens.op_Bar_Dot_Dot))

:named typing_Lens.op_Bar_Dot_Dot))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2
;;; Fact-ids: Name Lens.op_Bar_Dot_Dot; Namespace Lens
(assert (! 
;; def=Lens.fst(44,18-44,33); use=Lens.fst(44,18-44,33)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2 @x1
@x2
@x3
@x4
@x5)
...
:pattern ((ApplyTT (Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2 @x1
@x2
@x3
@x4
@x5)
@x0))
:qid interpretation_Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2))

:named interpretation_Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_519017a02c008e8d770d2bb88e107760
;;; Fact-ids: Name Lens.op_Bar_Dot_Dot; Namespace Lens
(assert (! 
;; def=Lens.fst(45,30-45,57); use=Lens.fst(45,30-45,57)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_519017a02c008e8d770d2bb88e107760 @x2
@x3
@x4
@x5
@x6)
...
:pattern ((ApplyTT (ApplyTT (Tm_abs_519017a02c008e8d770d2bb88e107760 @x2
@x3
@x4
@x5
@x6)
@x0)
@x1))
:qid interpretation_Tm_abs_519017a02c008e8d770d2bb88e107760))

:named interpretation_Tm_abs_519017a02c008e8d770d2bb88e107760))
;;;;;;;;;;;;;;;;Equation for Lens.op_Bar_Dot_Dot
;;; Fact-ids: Name Lens.op_Bar_Dot_Dot; Namespace Lens
(assert (! 
;; def=Lens.fst(43,6-43,9); use=Lens.fst(43,6-43,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Lens.op_Bar_Dot_Dot @x0
@x1
@x2
@x3
@x4)
(Lens.Mklens @x0
@x2
(Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2 @x1
@x4
@x3
@x2
@x0)
(Tm_abs_519017a02c008e8d770d2bb88e107760 @x1
@x3
@x4
@x0
@x2)))
...
@x3
@x4))
:qid equation_Lens.op_Bar_Dot_Dot))

:named equation_Lens.op_Bar_Dot_Dot))
(push) ;; push{2

; Starting query at Lens.fst(210,5-211,75)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Non_total_Tm_arrow_2fbd9b05753b5d546991174107fc41d9 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=Lens.fst(186,15-209,21); use=Lens.fst(209,60-211,75)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Lens.lens @x2
@x1)))
(HasType (Non_total_Tm_arrow_2fbd9b05753b5d546991174107fc41d9 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Non_total_Tm_arrow_2fbd9b05753b5d546991174107fc41d9 @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_2fbd9b05753b5d546991174107fc41d9))

:named non_total_function_typing_Non_total_Tm_arrow_2fbd9b05753b5d546991174107fc41d9))

; Encoding query formula : forall (a: Type) (b: Type) (c: Type) (l: Lens.lens a b) (sl: Lens.stlens l) (m: Lens.lens b c).
;   (*  - Could not prove post-condition
; *)
;   (forall (r: FStar.ST.ref a).
;       (*  - Could not prove post-condition
; *)
;       forall (p: FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap c)
;         (h: FStar.Monotonic.Heap.heap).
;         (forall (a: c) (h1: FStar.Monotonic.Heap.heap).
;             h == h1 /\ a == (FStar.Monotonic.Heap.sel h1 r |. (l |.. m)) ==> p a h1) ==>
;         (forall (a: b) (h1: FStar.Monotonic.Heap.heap).
;             h == h1 /\ a == (FStar.Monotonic.Heap.sel h1 r |. l) ==> p a.[ m ] h1)) /\
;   (forall (any_result: (r: FStar.ST.ref a -> FStar.ST.ST c)) (x: c) (r: FStar.ST.ref a).
;       (*  - Could not prove post-condition
; *)
;       forall (p: FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap (FStar.ST.ref a))
;         (h: FStar.Monotonic.Heap.heap).
...
;               h
;               h1 /\
;             FStar.Monotonic.Heap.sel h1 r == ((FStar.Monotonic.Heap.sel h r).[ l |.. m ] <- x) ==>
;             p a h1) ==>
;         (forall (a: b) (h1: FStar.Monotonic.Heap.heap).
;             h == h1 /\ a == (FStar.Monotonic.Heap.sel h1 r |. l) ==>
;             (forall (a: FStar.ST.ref a) (h1: FStar.Monotonic.Heap.heap).
;                 r == a /\
;                 FStar.Monotonic.Heap.modifies (FStar.Set.singleton (FStar.Monotonic.Heap.addr_of r))
;                   h1
;                   h1 /\
;                 FStar.Monotonic.Heap.sel h1 r ==
;                 ((FStar.Monotonic.Heap.sel h1 r).[ l ] <- a.[ m ] <- x) ==>
;                 p a h1)))


; Context: While encoding a query
; While typechecking the top-level declaration `let op_Bar_Colon_Dot_Dot`
...
;; def=Prims.fst(459,77-459,89); use=Lens.fst(210,5-211,75)
(and 
;; def=dummy(0,0-0,0); use=Lens.fst(210,5-211,75)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(FStar.ST.ref @x0))

;; def=FStar.Pervasives.fsti(484,2-484,63); use=Lens.fst(210,5-211,75)
...
;; def=FStar.ST.fst(76,50-76,87); use=Lens.fst(210,32-210,49)
...
;; def=Lens.fst(189,38-189,44); use=Lens.fst(210,32-210,49)
(or label_3
...
;; def=Lens.fst(189,48-189,69); use=Lens.fst(210,32-210,49)
(or label_4
...
;; def=FStar.ST.fst(76,80-76,86); use=Lens.fst(210,32-210,49)
(Valid 
;; def=FStar.ST.fst(76,80-76,86); use=Lens.fst(210,32-210,49)
(ApplyTT (ApplyTT @x7
@x9)
...
;; def=FStar.ST.fst(76,50-76,87); use=Lens.fst(210,36-210,42)
(forall ((@x9 Term) (@x10 Term))
...
;; def=Lens.fst(189,38-189,44); use=Lens.fst(210,36-210,42)
(= @x8
@x10)


;; def=Lens.fst(189,48-189,69); use=Lens.fst(210,36-210,42)
(= @x9
(Lens.op_Bar_Dot @x0
@x1
(FStar.Monotonic.Heap.sel @x0
...
;; def=FStar.Pervasives.fsti(463,24-463,34); use=Lens.fst(210,32-210,49)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=Lens.fst(210,32-210,49)
(ApplyTT (ApplyTT @x7
(Lens.op_String_Access @x1
@x2
@x9
@x5))
@x10)
...
;; def=Prims.fst(451,66-451,102); use=Lens.fst(210,5-211,75)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(Non_total_Tm_arrow_2fbd9b05753b5d546991174107fc41d9 @x0
@x2
@x1
@x3
@x5))
...
;; def=FStar.ST.fst(76,50-76,87); use=Lens.fst(211,38-211,74)
...
;; def=Lens.fst(197,25-197,31); use=Lens.fst(211,38-211,74)
(or label_7
...
;; def=Lens.fst(198,25-198,67); use=Lens.fst(211,38-211,74)
(or label_8
...
;; def=Lens.fst(199,25-199,60); use=Lens.fst(211,38-211,74)
(or label_9
...
;; def=FStar.ST.fst(76,80-76,86); use=Lens.fst(211,38-211,74)
(Valid 
;; def=FStar.ST.fst(76,80-76,86); use=Lens.fst(211,38-211,74)
(ApplyTT (ApplyTT @x9
@x11)
...
;; def=FStar.ST.fst(76,50-76,87); use=Lens.fst(211,53-211,59)
(forall ((@x11 Term) (@x12 Term))
...
;; def=Lens.fst(189,38-189,44); use=Lens.fst(211,53-211,59)
(= @x10
@x12)


;; def=Lens.fst(189,48-189,69); use=Lens.fst(211,53-211,59)
(= @x11
(Lens.op_Bar_Dot @x0
@x1
(FStar.Monotonic.Heap.sel @x0
...
;; def=FStar.ST.fst(76,50-76,87); use=Lens.fst(211,41-211,47)
...
;; def=Lens.fst(197,25-197,31); use=Lens.fst(211,41-211,47)
(= @x8
@x13)


;; def=Lens.fst(198,25-198,67); use=Lens.fst(211,41-211,47)
(Valid 
;; def=Lens.fst(198,25-198,67); use=Lens.fst(211,41-211,47)
(FStar.Monotonic.Heap.modifies (FStar.Set.singleton Prims.nat
(FStar.Monotonic.Heap.addr_of @x0
...
;; def=Lens.fst(199,25-199,60); use=Lens.fst(211,41-211,47)
(= (FStar.Monotonic.Heap.sel @x0
(FStar.Heap.trivial_preorder @x0)
@x14
@x8)
...
;; def=FStar.ST.fst(76,80-76,86); use=Lens.fst(211,41-211,47)
(Valid 
;; def=FStar.ST.fst(76,80-76,86); use=Lens.fst(211,41-211,47)
(ApplyTT (ApplyTT @x9
@x13)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Lens.op_Bar_Colon_Dot_Dot, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Lens.op_Bar_Colon_Equals, equation_Lens.op_Bar_Dot, equation_Lens.op_Bar_Dot_Dot, equation_Lens.op_String_Access, equation_Lens.op_String_Assignment, fuel_guarded_inversion_Lens.lens, fuel_guarded_inversion_Lens.stlens, interpretation_Tm_abs_2a3edf4b01e4f2bd197952ce921068e0, interpretation_Tm_abs_519017a02c008e8d770d2bb88e107760, interpretation_Tm_abs_623dbc4739871293a8e5a3c0e6f66cc2, proj_equation_Lens.Mklens_get, proj_equation_Lens.Mklens_put, projection_inverse_Lens.Mklens_get, projection_inverse_Lens.Mklens_put, token_correspondence_Lens.__proj__Mklens__item__get, token_correspondence_Lens.__proj__Mklens__item__put, token_correspondence_Lens.op_Bar_Colon_Equals, typing_Lens.op_String_Access
