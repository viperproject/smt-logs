...
; Internals for ArrayRealized


; encoding sigelt type ArrayRealized.contents


; <Start encoding type ArrayRealized.contents>

;;;;;;;;;;;;;;;;Constructor
(declare-fun ArrayRealized.contents (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun ArrayRealized.contents@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ArrayRealized.seq (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun ArrayRealized.seq@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ArrayRealized.Const (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Const_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Const_v (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ArrayRealized.Const
(declare-fun ArrayRealized.Const@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ArrayRealized.Upd (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Upd_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Upd_ix (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Upd_v (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Upd_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ArrayRealized.Upd
(declare-fun ArrayRealized.Upd@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ArrayRealized.Append (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Append_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Append_s1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Append_s2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ArrayRealized.Append
(declare-fun ArrayRealized.Append@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun ArrayRealized.Seq (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Seq_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Seq_c (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Seq_start_i (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun ArrayRealized.Seq_end_i (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: ArrayRealized.Seq
(declare-fun ArrayRealized.Seq@tok () Term)
;;;;;;;;;;;;;;;;v: a -> contents a
(declare-fun Tm_arrow_c60177bec216fde96d5607712d71d084 () Term)
;;;;;;;;;;;;;;;;ix: Prims.int -> v: a -> tl: contents a -> contents a
(declare-fun Tm_arrow_c84f25f08c67f609eab0c30d6a676dba () Term)
;;;;;;;;;;;;;;;;s1: seq a -> s2: seq a -> contents a
(declare-fun Tm_arrow_1e99d164628b8088ba4000bf728462b4 () Term)
(declare-fun Tm_refine_ad53f3413fd15db5258446e997071714 (Term) Term)

;;;;;;;;;;;;;;;;c: contents a -> start_i: Prims.nat -> end_i: Prims.nat{end_i >= start_i} -> seq a
(declare-fun Tm_arrow_5300612476d0ead4e56dc32a49b7aed4 () Term)

; <start constructor ArrayRealized.contents>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ArrayRealized.contents ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
(ArrayRealized.contents @x0))
 
;;no pats
:qid is-ArrayRealized.contents))))

; </end constructor ArrayRealized.contents>


; <start constructor ArrayRealized.seq>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ArrayRealized.seq ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
110)
(exists ((@x0 Term))
 (! (= __@x0
(ArrayRealized.seq @x0))
 
;;no pats
:qid is-ArrayRealized.seq))))

; </end constructor ArrayRealized.seq>


; <start constructor ArrayRealized.Const>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ArrayRealized.Const ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
117)
(= __@x0
(ArrayRealized.Const (ArrayRealized.Const_a __@x0)
(ArrayRealized.Const_v __@x0)))))

; </end constructor ArrayRealized.Const>


; <start constructor ArrayRealized.Upd>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ArrayRealized.Upd ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
(ArrayRealized.Upd (ArrayRealized.Upd_a __@x0)
(ArrayRealized.Upd_ix __@x0)
(ArrayRealized.Upd_v __@x0)
(ArrayRealized.Upd_tl __@x0)))))

; </end constructor ArrayRealized.Upd>


; <start constructor ArrayRealized.Append>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-ArrayRealized.Append ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
127)
(= __@x0
(ArrayRealized.Append (ArrayRealized.Append_a __@x0)
(ArrayRealized.Append_s1 __@x0)
(ArrayRealized.Append_s2 __@x0)))))

; </end constructor ArrayRealized.Append>
...
133)
(= __@x0
(ArrayRealized.Seq (ArrayRealized.Seq_a __@x0)
(ArrayRealized.Seq_c __@x0)
(ArrayRealized.Seq_start_i __@x0)
(ArrayRealized.Seq_end_i __@x0)))))

; </end constructor ArrayRealized.Seq>


; </end encoding type ArrayRealized.contents>


; encoding sigelt val ArrayRealized.uu___is_Const


; <Start encoding val ArrayRealized.uu___is_Const>

(declare-fun ArrayRealized.uu___is_Const (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: contents a -> Prims.bool
(declare-fun Tm_arrow_979008b6846446fbd620a31a73abf8dd () Term)
(declare-fun ArrayRealized.uu___is_Const@tok () Term)

; </end encoding val ArrayRealized.uu___is_Const>
...
; encoding sigelt val ArrayRealized.__proj__Const__item__v


; <Start encoding val ArrayRealized.__proj__Const__item__v>

(declare-fun Tm_refine_f518e333d098938912ef26bb10f80716 (Term) Term)
(declare-fun ArrayRealized.__proj__Const__item__v (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: contents a {Const? _} -> a
(declare-fun Tm_arrow_bbf849acd18dff044cb8f10623266d08 () Term)
(declare-fun ArrayRealized.__proj__Const__item__v@tok () Term)

; </end encoding val ArrayRealized.__proj__Const__item__v>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ArrayRealized.uu___is_Const; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(ArrayRealized.contents @x0)))
(HasType (ArrayRealized.uu___is_Const @x0
@x1)
Prims.bool))
 

:pattern ((ArrayRealized.uu___is_Const @x0
@x1))
:qid typing_ArrayRealized.uu___is_Const))

:named typing_ArrayRealized.uu___is_Const))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(25,4-25,7); use=ArrayRealized.fst(25,4-25,7)
(forall ((@x0 Term))
 (! (= (ApplyTT ArrayRealized.seq@tok
@x0)
(ArrayRealized.seq @x0))
 

:pattern ((ApplyTT ArrayRealized.seq@tok
@x0))

:pattern ((ArrayRealized.seq @x0))
:qid token_correspondence_ArrayRealized.seq@tok))

:named token_correspondence_ArrayRealized.seq@tok))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(20,10-20,18); use=ArrayRealized.fst(20,10-20,18)
(forall ((@x0 Term))
 (! (= (ApplyTT ArrayRealized.contents@tok
@x0)
(ArrayRealized.contents @x0))
 

:pattern ((ApplyTT ArrayRealized.contents@tok
@x0))

:pattern ((ArrayRealized.contents @x0))
:qid token_correspondence_ArrayRealized.contents@tok))

:named token_correspondence_ArrayRealized.contents@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(ArrayRealized.Upd @x1
@x2
@x3
@x4)
(ArrayRealized.contents @x5))
...
@x4)
(ArrayRealized.contents @x5)))
:qid subterm_ordering_ArrayRealized.Upd))

:named subterm_ordering_ArrayRealized.Upd))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(26,4-26,7); use=ArrayRealized.fst(26,4-26,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(ArrayRealized.Seq @x1
@x2
@x3
@x4)
(ArrayRealized.seq @x5))
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(ArrayRealized.Seq @x1
...
@x4)
(ArrayRealized.seq @x5)))
:qid subterm_ordering_ArrayRealized.Seq))

:named subterm_ordering_ArrayRealized.Seq))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,4-21,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(ArrayRealized.Const @x1
@x2)
(ArrayRealized.contents @x3))
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(ArrayRealized.Const @x1
...
@x2)
(ArrayRealized.contents @x3)))
:qid subterm_ordering_ArrayRealized.Const))

:named subterm_ordering_ArrayRealized.Const))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(ArrayRealized.Append @x1
@x2
@x3)
(ArrayRealized.contents @x4))
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(ArrayRealized.Append @x1
...
@x3)
(ArrayRealized.contents @x4)))
:qid subterm_ordering_ArrayRealized.Append))

:named subterm_ordering_ArrayRealized.Append))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ArrayRealized.__proj__Const__item__v; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,4-21,9)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_f518e333d098938912ef26bb10f80716 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_f518e333d098938912ef26bb10f80716 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_f518e333d098938912ef26bb10f80716))

:named refinement_kinding_Tm_refine_f518e333d098938912ef26bb10f80716))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(28,13-28,40); use=ArrayRealized.fst(28,13-28,40)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_ad53f3413fd15db5258446e997071714 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_ad53f3413fd15db5258446e997071714 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_ad53f3413fd15db5258446e997071714))

:named refinement_kinding_Tm_refine_ad53f3413fd15db5258446e997071714))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f518e333d098938912ef26bb10f80716 @x2))
(and (HasTypeFuel @u0
@x1
(ArrayRealized.contents @x2))

;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,4-21,9)
(BoxBool_proj_0 (ArrayRealized.uu___is_Const @x2
@x1))
))
...
@x1
(Tm_refine_f518e333d098938912ef26bb10f80716 @x2)))
:qid refinement_interpretation_Tm_refine_f518e333d098938912ef26bb10f80716))

:named refinement_interpretation_Tm_refine_f518e333d098938912ef26bb10f80716))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ad53f3413fd15db5258446e997071714 @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=ArrayRealized.fst(28,23-28,39); use=ArrayRealized.fst(28,23-28,39)
(>= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x2))
))
...
@x1
(Tm_refine_ad53f3413fd15db5258446e997071714 @x2)))
:qid refinement_interpretation_Tm_refine_ad53f3413fd15db5258446e997071714))

:named refinement_interpretation_Tm_refine_ad53f3413fd15db5258446e997071714))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
...
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrayRealized.Upd_v (ArrayRealized.Upd @x0
@x1
@x2
@x3))
@x2)
...
:pattern ((ArrayRealized.Upd @x0
@x1
@x2
@x3))
:qid projection_inverse_ArrayRealized.Upd_v))

:named projection_inverse_ArrayRealized.Upd_v))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrayRealized.Upd_tl (ArrayRealized.Upd @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_ArrayRealized.Upd_tl))

:named projection_inverse_ArrayRealized.Upd_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrayRealized.Upd_ix (ArrayRealized.Upd @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_ArrayRealized.Upd_ix))

:named projection_inverse_ArrayRealized.Upd_ix))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrayRealized.Upd_a (ArrayRealized.Upd @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_ArrayRealized.Upd_a))

:named projection_inverse_ArrayRealized.Upd_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(26,4-26,7); use=ArrayRealized.fst(26,4-26,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrayRealized.Seq_start_i (ArrayRealized.Seq @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_ArrayRealized.Seq_start_i))

:named projection_inverse_ArrayRealized.Seq_start_i))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(26,4-26,7); use=ArrayRealized.fst(26,4-26,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrayRealized.Seq_end_i (ArrayRealized.Seq @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_ArrayRealized.Seq_end_i))

:named projection_inverse_ArrayRealized.Seq_end_i))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(26,4-26,7); use=ArrayRealized.fst(26,4-26,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrayRealized.Seq_c (ArrayRealized.Seq @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_ArrayRealized.Seq_c))

:named projection_inverse_ArrayRealized.Seq_c))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(26,4-26,7); use=ArrayRealized.fst(26,4-26,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrayRealized.Seq_a (ArrayRealized.Seq @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_ArrayRealized.Seq_a))

:named projection_inverse_ArrayRealized.Seq_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ArrayRealized.Const_v (ArrayRealized.Const @x0
@x1))
@x1)
 

:pattern ((ArrayRealized.Const @x0
@x1))
:qid projection_inverse_ArrayRealized.Const_v))

:named projection_inverse_ArrayRealized.Const_v))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ArrayRealized.Const_a (ArrayRealized.Const @x0
@x1))
@x0)
...
:pattern ((ArrayRealized.Const @x0
@x1))
:qid projection_inverse_ArrayRealized.Const_a))

:named projection_inverse_ArrayRealized.Const_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ArrayRealized.Append_s2 (ArrayRealized.Append @x0
@x1
@x2))
@x2)
 

:pattern ((ArrayRealized.Append @x0
@x1
@x2))
:qid projection_inverse_ArrayRealized.Append_s2))

:named projection_inverse_ArrayRealized.Append_s2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ArrayRealized.Append_s1 (ArrayRealized.Append @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_ArrayRealized.Append_s1))

:named projection_inverse_ArrayRealized.Append_s1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ArrayRealized.Append_a (ArrayRealized.Append @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_ArrayRealized.Append_a))

:named projection_inverse_ArrayRealized.Append_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! (is-Tm_arrow (PreType ArrayRealized.seq@tok))
:named pre_kinding_ArrayRealized.seq@tok))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! (is-Tm_arrow (PreType ArrayRealized.contents@tok))
:named pre_kinding_ArrayRealized.contents@tok))
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! (and (IsTotFun ArrayRealized.seq@tok)

;; def=ArrayRealized.fst(25,4-25,7); use=ArrayRealized.fst(25,4-25,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (ArrayRealized.seq @x0)
Tm_type))
 

:pattern ((ArrayRealized.seq @x0))
:qid kinding_ArrayRealized.seq@tok))
)
:named kinding_ArrayRealized.seq@tok))
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! (and (IsTotFun ArrayRealized.contents@tok)

;; def=ArrayRealized.fst(20,10-20,18); use=ArrayRealized.fst(20,10-20,18)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (ArrayRealized.contents @x0)
Tm_type))
 

:pattern ((ArrayRealized.contents @x0))
:qid kinding_ArrayRealized.contents@tok))
)
:named kinding_ArrayRealized.contents@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
:qid int_inversion))
:named int_inversion))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f518e333d098938912ef26bb10f80716
;;; Fact-ids: Name ArrayRealized.__proj__Const__item__v; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,4-21,9)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f518e333d098938912ef26bb10f80716 @x0)))
(Valid (Prims.hasEq (ArrayRealized.contents @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f518e333d098938912ef26bb10f80716 @x0))))
:qid haseqTm_refine_f518e333d098938912ef26bb10f80716))

:named haseqTm_refine_f518e333d098938912ef26bb10f80716))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_ad53f3413fd15db5258446e997071714
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(28,13-28,40); use=ArrayRealized.fst(28,13-28,40)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ad53f3413fd15db5258446e997071714 @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ad53f3413fd15db5258446e997071714 @x0))))
:qid haseqTm_refine_ad53f3413fd15db5258446e997071714))

:named haseqTm_refine_ad53f3413fd15db5258446e997071714))
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(ArrayRealized.seq @x2))
(and (is-ArrayRealized.Seq @x1)
(= @x2
(ArrayRealized.Seq_a @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(ArrayRealized.seq @x2)))
:qid fuel_guarded_inversion_ArrayRealized.seq))

:named fuel_guarded_inversion_ArrayRealized.seq))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(20,10-20,18); use=ArrayRealized.fst(20,10-20,18)
...
@x1
(ArrayRealized.contents @x2))
(or (and (is-ArrayRealized.Const @x1)
(= @x2
(ArrayRealized.Const_a @x1)))
(and (is-ArrayRealized.Upd @x1)
(= @x2
(ArrayRealized.Upd_a @x1)))
(and (is-ArrayRealized.Append @x1)
(= @x2
(ArrayRealized.Append_a @x1)))))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
(ArrayRealized.contents @x2)))
:qid fuel_guarded_inversion_ArrayRealized.contents))

:named fuel_guarded_inversion_ArrayRealized.contents))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! (= 111
(Term_constr_id ArrayRealized.seq@tok))
:named fresh_token_ArrayRealized.seq@tok))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! (= 105
(Term_constr_id ArrayRealized.contents@tok))
:named fresh_token_ArrayRealized.contents@tok))
...
;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ArrayRealized.uu___is_Const @x0
@x1)
(BoxBool (is-ArrayRealized.Const @x1)))
 

:pattern ((ArrayRealized.uu___is_Const @x0
@x1))
:qid disc_equation_ArrayRealized.Const))

:named disc_equation_ArrayRealized.Const))
...
@x4)
(ArrayRealized.contents @x1)))
:qid data_typing_intro_ArrayRealized.Upd@tok))

:named data_typing_intro_ArrayRealized.Upd@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(26,4-26,7); use=ArrayRealized.fst(26,4-26,7)
...
(HasTypeFuel @u0
@x4
(Tm_refine_ad53f3413fd15db5258446e997071714 @x3)))
(HasTypeFuel @u0
(ArrayRealized.Seq @x1
@x2
@x3
...
@x4)
(ArrayRealized.seq @x1)))
:qid data_typing_intro_ArrayRealized.Seq@tok))

:named data_typing_intro_ArrayRealized.Seq@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,4-21,9)
...
@x2)
(ArrayRealized.contents @x1)))
:qid data_typing_intro_ArrayRealized.Const@tok))

:named data_typing_intro_ArrayRealized.Const@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
...
@x3)
(ArrayRealized.contents @x1)))
:qid data_typing_intro_ArrayRealized.Append@tok))

:named data_typing_intro_ArrayRealized.Append@tok))
...
@x4)
(ArrayRealized.contents @x5)))
:qid data_elim_ArrayRealized.Upd))

:named data_elim_ArrayRealized.Upd))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(26,4-26,7); use=ArrayRealized.fst(26,4-26,7)
...
@x4)
(ArrayRealized.seq @x5)))
:qid data_elim_ArrayRealized.Seq))

:named data_elim_ArrayRealized.Seq))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,4-21,9)
...
@x2)
(ArrayRealized.contents @x3)))
:qid data_elim_ArrayRealized.Const))

:named data_elim_ArrayRealized.Const))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
...
@x3)
(ArrayRealized.contents @x4)))
:qid data_elim_ArrayRealized.Append))

:named data_elim_ArrayRealized.Append))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 110
(Term_constr_id (ArrayRealized.seq @x0)))
 

:pattern ((ArrayRealized.seq @x0))
:qid constructor_distinct_ArrayRealized.seq))

:named constructor_distinct_ArrayRealized.seq))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(20,10-20,18); use=ArrayRealized.fst(20,10-20,18)
(forall ((@x0 Term))
 (! (= 104
(Term_constr_id (ArrayRealized.contents @x0)))
 

:pattern ((ArrayRealized.contents @x0))
:qid constructor_distinct_ArrayRealized.contents))

:named constructor_distinct_ArrayRealized.contents))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 122
(Term_constr_id (ArrayRealized.Upd @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_ArrayRealized.Upd))

:named constructor_distinct_ArrayRealized.Upd))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(26,4-26,7); use=ArrayRealized.fst(26,4-26,7)
...
(forall ((@x0 Term) (@x1 Term))
 (! (= 117
(Term_constr_id (ArrayRealized.Const @x0
@x1)))
 

:pattern ((ArrayRealized.Const @x0
@x1))
:qid constructor_distinct_ArrayRealized.Const))

:named constructor_distinct_ArrayRealized.Const))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 127
(Term_constr_id (ArrayRealized.Append @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_ArrayRealized.Append))

:named constructor_distinct_ArrayRealized.Append))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x0
(ArrayRealized.seq @x2)))
:qid ArrayRealized_pretyping_cc10ab84ecf2dac7d76ca7742e5d117c))

:named ArrayRealized_pretyping_cc10ab84ecf2dac7d76ca7742e5d117c))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name ArrayRealized.contents; Namespace ArrayRealized; Name ArrayRealized.Const; Namespace ArrayRealized; Name ArrayRealized.Upd; Namespace ArrayRealized; Name ArrayRealized.Append; Namespace ArrayRealized; Name ArrayRealized.seq; Namespace ArrayRealized; Name ArrayRealized.Seq; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(20,10-20,18); use=ArrayRealized.fst(20,10-20,18)
...
@x0
(ArrayRealized.contents @x2)))
:qid ArrayRealized_pretyping_62f3ebcb9ba4897438d73e396cf79277))

:named ArrayRealized_pretyping_62f3ebcb9ba4897438d73e396cf79277))
(push) ;; push{2

; Starting query at ArrayRealized.fst(21,12-21,13)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (projectee: _: ArrayRealized.contents a {Const? _}).
;   (*  - Could not prove post-condition
; *) ~(Const? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Const__item__v`
...
Tm_type)
(HasType @x1
(Tm_refine_f518e333d098938912ef26bb10f80716 @x0))

;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,12-21,13)
(not 
;; def=ArrayRealized.fst(21,4-21,9); use=ArrayRealized.fst(21,12-21,13)
(BoxBool_proj_0 (ArrayRealized.uu___is_Const @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.__proj__Const__item__v, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_f518e333d098938912ef26bb10f80716
...
; encoding sigelt let __proj__Const__item__v


; <Skipped let __proj__Const__item__v/>


; encoding sigelt val ArrayRealized.uu___is_Upd


; <Start encoding val ArrayRealized.uu___is_Upd>

(declare-fun ArrayRealized.uu___is_Upd (Term Term) Term)

(declare-fun ArrayRealized.uu___is_Upd@tok () Term)

; </end encoding val ArrayRealized.uu___is_Upd>


; encoding sigelt let uu___is_Upd


; <Skipped let uu___is_Upd/>


; encoding sigelt val ArrayRealized.__proj__Upd__item__ix


; <Start encoding val ArrayRealized.__proj__Upd__item__ix>

(declare-fun Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8 (Term) Term)
(declare-fun ArrayRealized.__proj__Upd__item__ix (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: contents a {Upd? _} -> Prims.int
(declare-fun Tm_arrow_8fb92eb6b496fd20c8f2715f57181171 () Term)
(declare-fun ArrayRealized.__proj__Upd__item__ix@tok () Term)

; </end encoding val ArrayRealized.__proj__Upd__item__ix>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ArrayRealized.uu___is_Upd; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(ArrayRealized.contents @x0)))
(HasType (ArrayRealized.uu___is_Upd @x0
@x1)
Prims.bool))
 

:pattern ((ArrayRealized.uu___is_Upd @x0
@x1))
:qid typing_ArrayRealized.uu___is_Upd))

:named typing_ArrayRealized.uu___is_Upd))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ArrayRealized.__proj__Upd__item__ix; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8))

:named refinement_kinding_Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name ArrayRealized.__proj__Upd__item__ix; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8 @x2))
(and (HasTypeFuel @u0
@x1
(ArrayRealized.contents @x2))

;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(BoxBool_proj_0 (ArrayRealized.uu___is_Upd @x2
@x1))
))
...
@x1
(Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8 @x2)))
:qid refinement_interpretation_Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8))

:named refinement_interpretation_Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8))
;;;;;;;;;;;;;;;;haseq for Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8
;;; Fact-ids: Name ArrayRealized.__proj__Upd__item__ix; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8 @x0)))
(Valid (Prims.hasEq (ArrayRealized.contents @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8 @x0))))
:qid haseqTm_refine_451b818f0c9cf2c0d099c0942c0aeaf8))

:named haseqTm_refine_451b818f0c9cf2c0d099c0942c0aeaf8))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name ArrayRealized.uu___is_Upd; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,4-22,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ArrayRealized.uu___is_Upd @x0
@x1)
(BoxBool (is-ArrayRealized.Upd @x1)))
 

:pattern ((ArrayRealized.uu___is_Upd @x0
@x1))
:qid disc_equation_ArrayRealized.Upd))

:named disc_equation_ArrayRealized.Upd))
(push) ;; push{2

; Starting query at ArrayRealized.fst(22,12-22,14)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (projectee: _: ArrayRealized.contents a {Upd? _}).
;   (*  - Could not prove post-condition
; *) ~(Upd? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Upd__item__ix`
...
Tm_type)
(HasType @x1
(Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8 @x0))

;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,12-22,14)
(not 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,12-22,14)
(BoxBool_proj_0 (ArrayRealized.uu___is_Upd @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.__proj__Upd__item__ix, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8
...
; encoding sigelt let __proj__Upd__item__ix


; <Skipped let __proj__Upd__item__ix/>


; encoding sigelt val ArrayRealized.__proj__Upd__item__v


; <Start encoding val ArrayRealized.__proj__Upd__item__v>


(declare-fun ArrayRealized.__proj__Upd__item__v (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: contents a {Upd? _} -> a
(declare-fun Tm_arrow_91cb74f651ea1f00ced6d85b8f5d1752 () Term)
(declare-fun ArrayRealized.__proj__Upd__item__v@tok () Term)

; </end encoding val ArrayRealized.__proj__Upd__item__v>

(push) ;; push{2

; Starting query at ArrayRealized.fst(22,22-22,23)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Upd__item__v`
...
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,22-22,23)
(not 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,22-22,23)
(BoxBool_proj_0 (ArrayRealized.uu___is_Upd @x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.__proj__Upd__item__v, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8
...
; encoding sigelt let __proj__Upd__item__v


; <Skipped let __proj__Upd__item__v/>


; encoding sigelt val ArrayRealized.__proj__Upd__item__tl


; <Start encoding val ArrayRealized.__proj__Upd__item__tl>


(declare-fun ArrayRealized.__proj__Upd__item__tl (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: contents a {Upd? _} -> contents a
(declare-fun Tm_arrow_0f44f921443dca3eff5050b2435b95c5 () Term)
(declare-fun ArrayRealized.__proj__Upd__item__tl@tok () Term)

; </end encoding val ArrayRealized.__proj__Upd__item__tl>

(push) ;; push{2

; Starting query at ArrayRealized.fst(22,29-22,31)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Upd__item__tl`
...
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,29-22,31)
(not 
;; def=ArrayRealized.fst(22,4-22,7); use=ArrayRealized.fst(22,29-22,31)
(BoxBool_proj_0 (ArrayRealized.uu___is_Upd @x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.__proj__Upd__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_451b818f0c9cf2c0d099c0942c0aeaf8
...
; encoding sigelt let __proj__Upd__item__tl


; <Skipped let __proj__Upd__item__tl/>


; encoding sigelt val ArrayRealized.uu___is_Append


; <Start encoding val ArrayRealized.uu___is_Append>

(declare-fun ArrayRealized.uu___is_Append (Term Term) Term)

(declare-fun ArrayRealized.uu___is_Append@tok () Term)

; </end encoding val ArrayRealized.uu___is_Append>


; encoding sigelt let uu___is_Append


; <Skipped let uu___is_Append/>


; encoding sigelt val ArrayRealized.__proj__Append__item__s1


; <Start encoding val ArrayRealized.__proj__Append__item__s1>

(declare-fun Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be (Term) Term)
(declare-fun ArrayRealized.__proj__Append__item__s1 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: contents a {Append? _} -> seq a
(declare-fun Tm_arrow_ad0affbd8e6b5a27c85ffcaeb83a9aaa () Term)
(declare-fun ArrayRealized.__proj__Append__item__s1@tok () Term)

; </end encoding val ArrayRealized.__proj__Append__item__s1>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ArrayRealized.uu___is_Append; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(ArrayRealized.contents @x0)))
(HasType (ArrayRealized.uu___is_Append @x0
@x1)
Prims.bool))
 

:pattern ((ArrayRealized.uu___is_Append @x0
@x1))
:qid typing_ArrayRealized.uu___is_Append))

:named typing_ArrayRealized.uu___is_Append))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ArrayRealized.__proj__Append__item__s1; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be))

:named refinement_kinding_Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name ArrayRealized.__proj__Append__item__s1; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be @x2))
(and (HasTypeFuel @u0
@x1
(ArrayRealized.contents @x2))

;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(BoxBool_proj_0 (ArrayRealized.uu___is_Append @x2
@x1))
))
...
@x1
(Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be @x2)))
:qid refinement_interpretation_Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be))

:named refinement_interpretation_Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be
;;; Fact-ids: Name ArrayRealized.__proj__Append__item__s1; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be @x0)))
(Valid (Prims.hasEq (ArrayRealized.contents @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be @x0))))
:qid haseqTm_refine_f6b3b0b73fcc8263a6e67a711e0143be))

:named haseqTm_refine_f6b3b0b73fcc8263a6e67a711e0143be))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name ArrayRealized.uu___is_Append; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,4-23,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ArrayRealized.uu___is_Append @x0
@x1)
(BoxBool (is-ArrayRealized.Append @x1)))
 

:pattern ((ArrayRealized.uu___is_Append @x0
@x1))
:qid disc_equation_ArrayRealized.Append))

:named disc_equation_ArrayRealized.Append))
(push) ;; push{2

; Starting query at ArrayRealized.fst(23,13-23,15)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (projectee: _: ArrayRealized.contents a {Append? _}).
;   (*  - Could not prove post-condition
; *) ~(Append? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Append__item__s1`
...
Tm_type)
(HasType @x1
(Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be @x0))

;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,13-23,15)
(not 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,13-23,15)
(BoxBool_proj_0 (ArrayRealized.uu___is_Append @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.__proj__Append__item__s1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be
...
; encoding sigelt let __proj__Append__item__s1


; <Skipped let __proj__Append__item__s1/>


; encoding sigelt val ArrayRealized.__proj__Append__item__s2


; <Start encoding val ArrayRealized.__proj__Append__item__s2>


(declare-fun ArrayRealized.__proj__Append__item__s2 (Term Term) Term)


(declare-fun ArrayRealized.__proj__Append__item__s2@tok () Term)

; </end encoding val ArrayRealized.__proj__Append__item__s2>

(push) ;; push{2

; Starting query at ArrayRealized.fst(23,25-23,27)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Append__item__s2`
...
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,25-23,27)
(not 
;; def=ArrayRealized.fst(23,4-23,10); use=ArrayRealized.fst(23,25-23,27)
(BoxBool_proj_0 (ArrayRealized.uu___is_Append @x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.__proj__Append__item__s2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_f6b3b0b73fcc8263a6e67a711e0143be
...
; encoding sigelt let __proj__Append__item__s2


; <Skipped let __proj__Append__item__s2/>


; encoding sigelt val ArrayRealized.uu___is_Seq


; <Start encoding val ArrayRealized.uu___is_Seq>

(declare-fun ArrayRealized.uu___is_Seq (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: seq a -> Prims.bool
(declare-fun Tm_arrow_690d9d67d4f25ec2fbce55cd50e0d0ae () Term)
(declare-fun ArrayRealized.uu___is_Seq@tok () Term)

; </end encoding val ArrayRealized.uu___is_Seq>


; encoding sigelt let uu___is_Seq


; <Skipped let uu___is_Seq/>


; encoding sigelt val ArrayRealized.__proj__Seq__item__c


; <Start encoding val ArrayRealized.__proj__Seq__item__c>

(declare-fun ArrayRealized.__proj__Seq__item__c (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: seq a -> contents a
(declare-fun Tm_arrow_69cfcbf9f08878eae9236d6e721e352d () Term)
(declare-fun ArrayRealized.__proj__Seq__item__c@tok () Term)

; </end encoding val ArrayRealized.__proj__Seq__item__c>


; encoding sigelt let __proj__Seq__item__c


; <Skipped let __proj__Seq__item__c/>


; encoding sigelt val ArrayRealized.__proj__Seq__item__start_i


; <Start encoding val ArrayRealized.__proj__Seq__item__start_i>

(declare-fun ArrayRealized.__proj__Seq__item__start_i (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: seq a -> Prims.nat
(declare-fun Tm_arrow_54636076844b857d9e8bd48c269dbea6 () Term)
(declare-fun ArrayRealized.__proj__Seq__item__start_i@tok () Term)

; </end encoding val ArrayRealized.__proj__Seq__item__start_i>


; encoding sigelt let __proj__Seq__item__start_i


; <Skipped let __proj__Seq__item__start_i/>


; encoding sigelt val ArrayRealized.__proj__Seq__item__end_i


; <Start encoding val ArrayRealized.__proj__Seq__item__end_i>

(declare-fun ArrayRealized.__proj__Seq__item__end_i (Term Term) Term)
(declare-fun Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: seq a -> end_i: Prims.nat{end_i >= projectee.start_i}
(declare-fun Tm_arrow_20b3b3cc215c722a76ae7422afc9ac62 () Term)
(declare-fun ArrayRealized.__proj__Seq__item__end_i@tok () Term)


; </end encoding val ArrayRealized.__proj__Seq__item__end_i>


; encoding sigelt let __proj__Seq__item__end_i


; <Skipped let __proj__Seq__item__end_i/>


; encoding sigelt val ArrayRealized.create


; <Skipped val ArrayRealized.create/>

(push) ;; push{2

; Starting query at ArrayRealized.fst(32,20-32,40)

(declare-fun label_1 () Bool)

; Encoding query formula : forall ('a: Type) (n: Prims.nat) (init: 'a). (*  - Could not prove post-condition
; *) n >= 0
...
;; def=ArrayRealized.fst(28,23-28,39); use=ArrayRealized.fst(32,39-32,40)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.create, 1)
; STATUS: unsat
...
(declare-fun ArrayRealized.create (Term Term Term) Term)
;;;;;;;;;;;;;;;;n: Prims.nat -> init: 'a -> seq 'a
(declare-fun Tm_arrow_375e4e211bd8ee955fb725208400f4ae () Term)
(declare-fun ArrayRealized.create@tok () Term)

; </end encoding let create>


; encoding sigelt val ArrayRealized.length


; <Skipped val ArrayRealized.length/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ArrayRealized.__proj__Seq__item__start_i; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(27,13-27,20); use=ArrayRealized.fst(27,13-27,20)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(ArrayRealized.seq @x0)))
(HasType (ArrayRealized.__proj__Seq__item__start_i @x0
@x1)
Prims.nat))
 

:pattern ((ArrayRealized.__proj__Seq__item__start_i @x0
@x1))
:qid typing_ArrayRealized.__proj__Seq__item__start_i))

:named typing_ArrayRealized.__proj__Seq__item__start_i))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ArrayRealized.__proj__Seq__item__end_i; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(28,13-28,18); use=ArrayRealized.fst(28,13-28,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(ArrayRealized.seq @x0)))
(HasType (ArrayRealized.__proj__Seq__item__end_i @x0
@x1)
(Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5 @x0
@x1)))
 

:pattern ((ArrayRealized.__proj__Seq__item__end_i @x0
@x1))
:qid typing_ArrayRealized.__proj__Seq__item__end_i))

:named typing_ArrayRealized.__proj__Seq__item__end_i))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ArrayRealized.__proj__Seq__item__end_i; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(28,13-28,40); use=ArrayRealized.fst(28,13-28,40)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5))

:named refinement_kinding_Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name ArrayRealized.__proj__Seq__item__end_i; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(28,13-28,40); use=ArrayRealized.fst(28,13-28,40)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
;; def=ArrayRealized.fst(28,23-28,39); use=ArrayRealized.fst(28,23-28,39)
(>= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (ArrayRealized.__proj__Seq__item__start_i @x2
@x3)))
))
...
(Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5))

:named refinement_interpretation_Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name ArrayRealized.__proj__Seq__item__start_i; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(27,13-27,20); use=ArrayRealized.fst(27,13-27,20)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ArrayRealized.__proj__Seq__item__start_i @x0
@x1)
(ArrayRealized.Seq_start_i @x1))
 

:pattern ((ArrayRealized.__proj__Seq__item__start_i @x0
@x1))
:qid proj_equation_ArrayRealized.Seq_start_i))

:named proj_equation_ArrayRealized.Seq_start_i))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name ArrayRealized.__proj__Seq__item__end_i; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(28,13-28,18); use=ArrayRealized.fst(28,13-28,18)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ArrayRealized.__proj__Seq__item__end_i @x0
@x1)
(ArrayRealized.Seq_end_i @x1))
 

:pattern ((ArrayRealized.__proj__Seq__item__end_i @x0
@x1))
:qid proj_equation_ArrayRealized.Seq_end_i))

:named proj_equation_ArrayRealized.Seq_end_i))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5
;;; Fact-ids: Name ArrayRealized.__proj__Seq__item__end_i; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(28,13-28,40); use=ArrayRealized.fst(28,13-28,40)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5 @x0
@x1)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5 @x0
@x1))))
:qid haseqTm_refine_6afa65d9c74af2fe6d9a37a4161c64a5))

:named haseqTm_refine_6afa65d9c74af2fe6d9a37a4161c64a5))
(push) ;; push{2

; Starting query at ArrayRealized.fst(35,15-35,44)

(declare-fun label_1 () Bool)

; Encoding query formula : forall ('a: Type) (s: ArrayRealized.seq 'a).
;   (*  - Could not prove post-condition
; *) s.end_i - s.start_i >= 0
...
;; def=Prims.fst(680,18-680,24); use=ArrayRealized.fst(35,15-35,44)
(or label_1

;; def=Prims.fst(680,18-680,24); use=ArrayRealized.fst(35,15-35,44)
(>= (BoxInt_proj_0 (Prims.op_Subtraction (ArrayRealized.__proj__Seq__item__end_i @x0
@x1)
(ArrayRealized.__proj__Seq__item__start_i @x0
@x1)))
(BoxInt_proj_0 (BoxInt 0)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.length, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, primitive_Prims.op_Subtraction, proj_equation_ArrayRealized.Seq_end_i, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_6afa65d9c74af2fe6d9a37a4161c64a5, typing_ArrayRealized.__proj__Seq__item__end_i
...
(declare-fun ArrayRealized.length (Term Term) Term)

(declare-fun ArrayRealized.length@tok () Term)

; </end encoding let length>


; encoding sigelt val ArrayRealized.__index__


; <Skipped val ArrayRealized.__index__/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ArrayRealized.length; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(35,4-35,10); use=ArrayRealized.fst(35,4-35,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(ArrayRealized.seq @x0)))
(HasType (ArrayRealized.length @x0
@x1)
Prims.nat))
 

:pattern ((ArrayRealized.length @x0
@x1))
:qid typing_ArrayRealized.length))

:named typing_ArrayRealized.length))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ArrayRealized.__proj__Seq__item__c; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(26,10-26,11); use=ArrayRealized.fst(26,10-26,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(ArrayRealized.seq @x0)))
(HasType (ArrayRealized.__proj__Seq__item__c @x0
@x1)
(ArrayRealized.contents @x0)))
 

:pattern ((ArrayRealized.__proj__Seq__item__c @x0
@x1))
:qid typing_ArrayRealized.__proj__Seq__item__c))

:named typing_ArrayRealized.__proj__Seq__item__c))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;; def=ArrayRealized.fst(26,10-26,11); use=ArrayRealized.fst(26,10-26,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ArrayRealized.__proj__Seq__item__c @x0
@x1)
(ArrayRealized.Seq_c @x1))
 

:pattern ((ArrayRealized.__proj__Seq__item__c @x0
@x1))
:qid proj_equation_ArrayRealized.Seq_c))

:named proj_equation_ArrayRealized.Seq_c))
...
;;;;;;;;;;;;;;;;Equation for ArrayRealized.length
;;; Fact-ids: Name ArrayRealized.length; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(35,4-35,10); use=ArrayRealized.fst(35,4-35,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ArrayRealized.length @x0
@x1)
(Prims.op_Subtraction (ArrayRealized.__proj__Seq__item__end_i @x0
@x1)
(ArrayRealized.__proj__Seq__item__start_i @x0
@x1)))
...
:pattern ((ArrayRealized.length @x0
@x1))
:qid equation_ArrayRealized.length))

:named equation_ArrayRealized.length))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at ArrayRealized.fst(38,24-41,108)
...
;;;;;;;;;;;;;;;;c : ArrayRealized.contents 'a (ArrayRealized.contents 'a)
(declare-fun x_fa1e1283a3ea777d1921821431f572c6_2 () Term)
;;;;;;;;;;;;;;;;binder_x_fa1e1283a3ea777d1921821431f572c6_2
;;; Fact-ids: 
(assert (! (HasType x_fa1e1283a3ea777d1921821431f572c6_2
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1))
:named binder_x_fa1e1283a3ea777d1921821431f572c6_2))
...
(declare-fun Tm_refine_ad28ced42d8227b4d2229606186f758e (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(38,18-41,108)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_ad28ced42d8227b4d2229606186f758e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_ad28ced42d8227b4d2229606186f758e @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_ad28ced42d8227b4d2229606186f758e))

:named refinement_kinding_Tm_refine_ad28ced42d8227b4d2229606186f758e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(38,18-41,108)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ad28ced42d8227b4d2229606186f758e @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.int)
...
;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(38,18-41,108)
(or 
;; def=ArrayRealized.fst(38,24-41,108); use=ArrayRealized.fst(38,24-41,108)
(Valid 
;; def=ArrayRealized.fst(38,24-41,108); use=ArrayRealized.fst(38,24-41,108)
(Prims.precedes (ArrayRealized.contents @x2)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
@x3
x_fa1e1283a3ea777d1921821431f572c6_2)
)


;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(38,18-41,108)
(and 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(38,18-38,19)
(Valid 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(38,18-38,19)
(Prims.op_Equals_Equals_Equals (ArrayRealized.contents @x2)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
@x3
x_fa1e1283a3ea777d1921821431f572c6_2)
)
...
(Tm_refine_ad28ced42d8227b4d2229606186f758e @x2
@x3)))
:qid refinement_interpretation_Tm_refine_ad28ced42d8227b4d2229606186f758e))

:named refinement_interpretation_Tm_refine_ad28ced42d8227b4d2229606186f758e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ad28ced42d8227b4d2229606186f758e
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(38,18-41,108)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ad28ced42d8227b4d2229606186f758e @x0
@x1)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ad28ced42d8227b4d2229606186f758e @x0
@x1))))
:qid haseqTm_refine_ad28ced42d8227b4d2229606186f758e))

:named haseqTm_refine_ad28ced42d8227b4d2229606186f758e))
(declare-fun ArrayRealized.__index__ (Term Term Term) Term)

;;;;;;;;;;;;;;;;_: contents 'a -> _: _: Prims.int{_ << c \/ _ === c /\ _ << i} -> 'a
(declare-fun Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6
Tm_type)
:named kinding_Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(37,15-41,108); use=ArrayRealized.fst(37,41-41,108)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6))
:qid ArrayRealized_pre_typing_Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6))

:named ArrayRealized_pre_typing_Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(37,15-41,108); use=ArrayRealized.fst(37,41-41,108)
(forall ((@x0 Term))
...
(ArrayRealized.contents @x1))
(HasType @x3
(Tm_refine_ad28ced42d8227b4d2229606186f758e @x1
@x2)))
...
@x2)
@x3))
:qid ArrayRealized_interpretation_Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ArrayRealized_interpretation_Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6.2))
...
@x1)
@x2))
:qid ArrayRealized_interpretation_Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6))
:qid ArrayRealized_interpretation_Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6))

:named ArrayRealized_interpretation_Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6))
(declare-fun ArrayRealized.__index__@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(38,8-38,17); use=ArrayRealized.fst(38,8-38,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT ArrayRealized.__index__@tok
@x0)
@x1)
@x2)
(ArrayRealized.__index__ @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT ArrayRealized.__index__@tok
@x0)
@x1)
@x2))
:qid token_correspondence_ArrayRealized.__index__))

:named token_correspondence_ArrayRealized.__index__))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(38,8-38,17); use=ArrayRealized.fst(38,8-38,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType ArrayRealized.__index__@tok
Tm_arrow_8d744f0d95a37b5f0c8423727dc699c6))
...
@x2)
@x3)
(ArrayRealized.__index__ @x1
@x2
@x3))
 

:pattern ((ArrayRealized.__index__ @x1
@x2
@x3))
:qid function_token_typing_ArrayRealized.__index__.1))
)
 

:pattern ((ApplyTT @x0
ArrayRealized.__index__@tok))
:qid function_token_typing_ArrayRealized.__index__))

:named function_token_typing_ArrayRealized.__index__))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(38,8-38,17); use=ArrayRealized.fst(38,8-38,17)
...
(ArrayRealized.contents @x0))
(HasType @x2
(Tm_refine_ad28ced42d8227b4d2229606186f758e @x0
@x1)))
(HasType (ArrayRealized.__index__ @x0
@x1
@x2)
@x0))
 

:pattern ((ArrayRealized.__index__ @x0
@x1
@x2))
:qid typing_ArrayRealized.__index__))

:named typing_ArrayRealized.__index__))
...
;   (~(Const? c) /\ ~(Upd? c) /\ ~(Append? c) ==> Prims.l_False) /\
;   (~(Const? c) ==>
;     (forall (b: Prims.int) (b: 'a) (b: ArrayRealized.contents 'a).
;         c == ArrayRealized.Upd b b b ==>
;         (forall (k: Prims.pure_post 'a).
;             (forall (x: 'a). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;             ~(i = b = true) ==> (forall (b: Prims.bool). i = b == b ==> b << c \/ b === c /\ i << i)
;         )) /\
;     (~(Upd? c) ==>
;       (forall (b: ArrayRealized.seq 'a) (b: ArrayRealized.seq 'a).
;           c == ArrayRealized.Append b b ==>
;           (forall (k: Prims.pure_post 'a).
;               (forall (x: 'a). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;               (i < ArrayRealized.length b == true ==> b.c << c \/ b.c === c /\ i << i) /\
;               (~(i < ArrayRealized.length b = true) ==>
;                 (forall (b: Prims.bool).
;                     i < ArrayRealized.length b == b ==>
;                     b.c << c \/ b.c === c /\ i - ArrayRealized.length b << i))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec __index__`
...
;; def=Prims.fst(402,27-402,88); use=ArrayRealized.fst(38,24-41,108)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=ArrayRealized.fst(38,24-41,108)
(Valid 
;; def=Prims.fst(402,84-402,87); use=ArrayRealized.fst(38,24-41,108)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=ArrayRealized.fst(38,24-41,108)
(and (implies 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(38,30-38,31)
(and 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(38,30-38,31)
(not 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(38,30-38,31)
(BoxBool_proj_0 (ArrayRealized.uu___is_Const x_fe28d8bcde588226b4e538b35321de05_1
x_fa1e1283a3ea777d1921821431f572c6_2))
)
...
(not 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(38,30-38,31)
(BoxBool_proj_0 (ArrayRealized.uu___is_Upd x_fe28d8bcde588226b4e538b35321de05_1
x_fa1e1283a3ea777d1921821431f572c6_2))
)
...
(not 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(38,30-38,31)
(BoxBool_proj_0 (ArrayRealized.uu___is_Append x_fe28d8bcde588226b4e538b35321de05_1
x_fa1e1283a3ea777d1921821431f572c6_2))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=ArrayRealized.fst(38,24-41,108)
(not 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(38,30-38,31)
(BoxBool_proj_0 (ArrayRealized.uu___is_Const x_fe28d8bcde588226b4e538b35321de05_1
x_fa1e1283a3ea777d1921821431f572c6_2))
...
;; def=Prims.fst(389,2-389,39); use=ArrayRealized.fst(38,24-41,108)
(and 
;; def=Prims.fst(413,99-413,120); use=ArrayRealized.fst(38,24-41,108)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=ArrayRealized.fst(38,18-40,14); use=ArrayRealized.fst(38,30-40,14)
(= x_fa1e1283a3ea777d1921821431f572c6_2
(ArrayRealized.Upd x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
@x3))
)
...
;; def=Prims.fst(389,19-389,21); use=ArrayRealized.fst(38,24-41,108)
(not 
;; def=ArrayRealized.fst(40,21-40,24); use=ArrayRealized.fst(40,21-40,24)
...
;; def=ArrayRealized.fst(40,21-40,51); use=ArrayRealized.fst(40,21-40,51)
(= (Prims.op_Equality Prims.int
x_ae567c2fb75be05905677af440075565_3
@x1)
@x5)
...
;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(40,50-40,51)
(or label_2

;; def=ArrayRealized.fst(38,24-41,108); use=ArrayRealized.fst(40,50-40,51)
(Valid 
;; def=ArrayRealized.fst(38,24-41,108); use=ArrayRealized.fst(40,50-40,51)
(Prims.precedes (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
@x3
x_fa1e1283a3ea777d1921821431f572c6_2)
)
...
;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(40,50-40,51)
(and 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(40,50-40,51)
(Valid 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(40,50-40,51)
(Prims.op_Equals_Equals_Equals (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
@x3
x_fa1e1283a3ea777d1921821431f572c6_2)
)
...
(forall ((@x1 Term))
 (! (implies (HasType @x1
(ArrayRealized.seq x_fe28d8bcde588226b4e538b35321de05_1))
...
;; def=ArrayRealized.fst(38,18-41,16); use=ArrayRealized.fst(38,30-41,16)
(= x_fa1e1283a3ea777d1921821431f572c6_2
(ArrayRealized.Append x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2))
)
(forall ((@x3 Term))
...
;; def=Prims.fst(389,2-389,39); use=ArrayRealized.fst(38,24-41,108)
(and (implies 
;; def=ArrayRealized.fst(41,23-41,36); use=ArrayRealized.fst(41,23-41,36)
(= (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_3
(ArrayRealized.length x_fe28d8bcde588226b4e538b35321de05_1
@x1))
(BoxBool true))


;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(41,64-41,65)
(or label_3

;; def=ArrayRealized.fst(38,24-41,108); use=ArrayRealized.fst(41,64-41,65)
(Valid 
;; def=ArrayRealized.fst(38,24-41,108); use=ArrayRealized.fst(41,64-41,65)
(Prims.precedes (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.__proj__Seq__item__c x_fe28d8bcde588226b4e538b35321de05_1
@x1)
x_fa1e1283a3ea777d1921821431f572c6_2)
)
...
;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(41,64-41,65)
(and 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(41,64-41,65)
(Valid 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(41,64-41,65)
(Prims.op_Equals_Equals_Equals (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=ArrayRealized.fst(41,23-41,108); use=ArrayRealized.fst(41,23-41,108)
(= (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_3
(ArrayRealized.length x_fe28d8bcde588226b4e538b35321de05_1
@x1))
@x4)
...
;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(41,93-41,108)
(or label_4

;; def=ArrayRealized.fst(38,24-41,108); use=ArrayRealized.fst(41,93-41,108)
(Valid 
;; def=ArrayRealized.fst(38,24-41,108); use=ArrayRealized.fst(41,93-41,108)
(Prims.precedes (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=ArrayRealized.fst(38,18-41,108); use=ArrayRealized.fst(41,93-41,108)
(and 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(41,93-41,108)
(Valid 
;; def=ArrayRealized.fst(38,18-38,19); use=ArrayRealized.fst(41,93-41,108)
(Prims.op_Equals_Equals_Equals (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
...
(Prims.precedes Prims.int
Prims.int
(Prims.op_Subtraction x_ae567c2fb75be05905677af440075565_3
(ArrayRealized.length x_fe28d8bcde588226b4e538b35321de05_1
@x1))
x_ae567c2fb75be05905677af440075565_3)
)
...
; encoding sigelt let rec __index__


; <Start encoding let rec __index__>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun ArrayRealized.__index__.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun ArrayRealized.__index__.fuel_instrumented_token () Term)
(declare-fun ArrayRealized.__index__ (Term Term Term) Term)
(declare-fun ArrayRealized.__index__@tok () Term)
;;;;;;;;;;;;;;;;c: contents 'a -> i: Prims.int -> 'a
(declare-fun Tm_arrow_d6434ef66b6957480e66527d44eab80f () Term)

; </end encoding let rec __index__>


; encoding sigelt val ArrayRealized.index


; <Skipped val ArrayRealized.index/>
...
(declare-fun Tm_refine_de7864dba64f5cff270ffba50b1146ea (Term Term) Term)
(declare-fun ArrayRealized.index (Term Term Term) Term)

;;;;;;;;;;;;;;;;s: seq 'a -> i: Prims.nat{length s > i} -> 'a
(declare-fun Tm_arrow_db33ccb1e44a91570c305250e36044a9 () Term)
(declare-fun ArrayRealized.index@tok () Term)


; </end encoding let index>


; encoding sigelt val ArrayRealized.__update__


; <Skipped val ArrayRealized.__update__/>

(push) ;; push{2

; Starting query at ArrayRealized.fst(47,27-53,102)
...
(declare-fun Tm_refine_a0e28827a49f96b988850fedf64e304f (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(47,19-53,102); use=ArrayRealized.fst(47,19-53,102)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_a0e28827a49f96b988850fedf64e304f @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_a0e28827a49f96b988850fedf64e304f @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_a0e28827a49f96b988850fedf64e304f))

:named refinement_kinding_Tm_refine_a0e28827a49f96b988850fedf64e304f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(47,19-53,102); use=ArrayRealized.fst(47,19-53,102)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a0e28827a49f96b988850fedf64e304f @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=ArrayRealized.fst(47,19-53,102); use=ArrayRealized.fst(47,19-53,102)
(or 
;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(47,27-53,102)
(Valid 
;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(47,27-53,102)
(Prims.precedes (ArrayRealized.contents @x2)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=ArrayRealized.fst(47,19-53,102); use=ArrayRealized.fst(47,19-53,102)
(and 
;; def=ArrayRealized.fst(47,19-47,20); use=ArrayRealized.fst(47,19-47,20)
(Valid 
;; def=ArrayRealized.fst(47,19-47,20); use=ArrayRealized.fst(47,19-47,20)
(Prims.op_Equals_Equals_Equals (ArrayRealized.contents @x2)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=ArrayRealized.fst(47,21-53,102); use=ArrayRealized.fst(47,21-53,102)
(or 
;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(47,27-53,102)
(Valid 
;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(47,27-53,102)
...
;; def=ArrayRealized.fst(47,21-53,102); use=ArrayRealized.fst(47,21-53,102)
(and 
;; def=ArrayRealized.fst(47,21-47,22); use=ArrayRealized.fst(47,21-47,22)
(Valid 
;; def=ArrayRealized.fst(47,21-47,22); use=ArrayRealized.fst(47,21-47,22)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_a0e28827a49f96b988850fedf64e304f))

:named refinement_interpretation_Tm_refine_a0e28827a49f96b988850fedf64e304f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a0e28827a49f96b988850fedf64e304f
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(47,19-53,102); use=ArrayRealized.fst(47,19-53,102)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a0e28827a49f96b988850fedf64e304f @x0
@x1
@x2)))
(Valid (Prims.hasEq @x0)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a0e28827a49f96b988850fedf64e304f @x0
@x1
@x2))))
:qid haseqTm_refine_a0e28827a49f96b988850fedf64e304f))

:named haseqTm_refine_a0e28827a49f96b988850fedf64e304f))
(declare-fun ArrayRealized.__update__ (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;_: contents 'a -> _: Prims.int -> _: _: 'a{_ << c \/ _ === c /\ (_ << i \/ _ === i /\ _ << v)}   -> contents 'a
(declare-fun Tm_arrow_40f9bbab7574fd4706335327957bee17 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_40f9bbab7574fd4706335327957bee17
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_40f9bbab7574fd4706335327957bee17
Tm_type)
:named kinding_Tm_arrow_40f9bbab7574fd4706335327957bee17))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(46,16-53,102); use=ArrayRealized.fst(47,8-53,102)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_40f9bbab7574fd4706335327957bee17)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_40f9bbab7574fd4706335327957bee17))
:qid ArrayRealized_pre_typing_Tm_arrow_40f9bbab7574fd4706335327957bee17))

:named ArrayRealized_pre_typing_Tm_arrow_40f9bbab7574fd4706335327957bee17))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_40f9bbab7574fd4706335327957bee17
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(46,16-53,102); use=ArrayRealized.fst(47,8-53,102)
(forall ((@x0 Term))
...
Prims.int)
(HasType @x4
(Tm_refine_a0e28827a49f96b988850fedf64e304f @x1
@x2
@x3)))
...
@x3)
@x4))
:qid ArrayRealized_interpretation_Tm_arrow_40f9bbab7574fd4706335327957bee17.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid ArrayRealized_interpretation_Tm_arrow_40f9bbab7574fd4706335327957bee17.2))
...
@x1)
@x2))
:qid ArrayRealized_interpretation_Tm_arrow_40f9bbab7574fd4706335327957bee17.3))
...
@x2)
@x3))
:qid ArrayRealized_interpretation_Tm_arrow_40f9bbab7574fd4706335327957bee17.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_40f9bbab7574fd4706335327957bee17))
:qid ArrayRealized_interpretation_Tm_arrow_40f9bbab7574fd4706335327957bee17))

:named ArrayRealized_interpretation_Tm_arrow_40f9bbab7574fd4706335327957bee17))
(declare-fun ArrayRealized.__update__@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(47,8-47,18); use=ArrayRealized.fst(47,8-47,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT ArrayRealized.__update__@tok
@x0)
@x1)
@x2)
@x3)
(ArrayRealized.__update__ @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT ArrayRealized.__update__@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_ArrayRealized.__update__))

:named token_correspondence_ArrayRealized.__update__))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(47,8-47,18); use=ArrayRealized.fst(47,8-47,18)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType ArrayRealized.__update__@tok
Tm_arrow_40f9bbab7574fd4706335327957bee17))
...
@x3)
@x4)
(ArrayRealized.__update__ @x1
@x2
@x3
@x4))
 

:pattern ((ArrayRealized.__update__ @x1
@x2
@x3
@x4))
:qid function_token_typing_ArrayRealized.__update__.1))
)
 

:pattern ((ApplyTT @x0
ArrayRealized.__update__@tok))
:qid function_token_typing_ArrayRealized.__update__))

:named function_token_typing_ArrayRealized.__update__))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(47,8-47,18); use=ArrayRealized.fst(47,8-47,18)
...
Prims.int)
(HasType @x3
(Tm_refine_a0e28827a49f96b988850fedf64e304f @x0
@x1
@x2)))
(HasType (ArrayRealized.__update__ @x0
@x1
@x2
@x3)
(ArrayRealized.contents @x0)))
...
:pattern ((ArrayRealized.__update__ @x0
@x1
@x2
@x3))
:qid typing_ArrayRealized.__update__))

:named typing_ArrayRealized.__update__))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (ArrayRealized.contents 'a)).
;   (forall (x: ArrayRealized.contents 'a). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Const? c) /\ ~(Upd? c) /\ ~(Append? c) ==> Prims.l_False) /\
;   (~(Const? c) ==>
;     ~(Upd? c) ==>
;     (forall (b: ArrayRealized.seq 'a) (b: ArrayRealized.seq 'a).
;         c == ArrayRealized.Append b b ==>
;         (forall (k: Prims.pure_post (ArrayRealized.contents 'a)).
;             (forall (x: ArrayRealized.contents 'a). {:pattern Prims.guard_free (k x)}
;                 Prims.auto_squash (k x)) ==>
;             (i < ArrayRealized.length b == true ==> b.c << c \/ b.c === c /\ (i << i \/ v << v)) /\
;             (~(i < ArrayRealized.length b = true) ==>
;               (forall (b: Prims.bool).
;                   i < ArrayRealized.length b == b ==>
;                   b.c << c \/
;                   b.c === c /\
;                   (i - ArrayRealized.length b << i \/ i - ArrayRealized.length b === i /\ v << v))))
;     ))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec __update__`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)))

;; def=Prims.fst(402,27-402,88); use=ArrayRealized.fst(47,27-53,102)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=ArrayRealized.fst(47,27-53,102)
(Valid 
;; def=Prims.fst(402,84-402,87); use=ArrayRealized.fst(47,27-53,102)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=ArrayRealized.fst(47,27-53,102)
(and (implies 
;; def=ArrayRealized.fst(47,19-47,20); use=ArrayRealized.fst(47,33-47,34)
(and 
;; def=ArrayRealized.fst(47,19-47,20); use=ArrayRealized.fst(47,33-47,34)
(not 
;; def=ArrayRealized.fst(47,19-47,20); use=ArrayRealized.fst(47,33-47,34)
...
label_1)
(implies 
;; def=Prims.fst(389,18-389,39); use=ArrayRealized.fst(47,27-53,102)
(and 
;; def=Prims.fst(389,19-389,21); use=ArrayRealized.fst(47,27-53,102)
(not 
;; def=ArrayRealized.fst(47,19-47,20); use=ArrayRealized.fst(47,33-47,34)
(BoxBool_proj_0 (ArrayRealized.uu___is_Const x_fe28d8bcde588226b4e538b35321de05_1
x_fa1e1283a3ea777d1921821431f572c6_2))
...
;; def=Prims.fst(413,99-413,120); use=ArrayRealized.fst(47,27-53,102)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(ArrayRealized.seq x_fe28d8bcde588226b4e538b35321de05_1))
...
;; def=ArrayRealized.fst(47,19-50,16); use=ArrayRealized.fst(47,33-50,16)
(= x_fa1e1283a3ea777d1921821431f572c6_2
(ArrayRealized.Append x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2))
...
;; def=Prims.fst(389,2-389,39); use=ArrayRealized.fst(47,27-53,102)
(and (implies 
;; def=ArrayRealized.fst(51,8-51,21); use=ArrayRealized.fst(51,8-51,21)
(= (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_3
(ArrayRealized.length x_fe28d8bcde588226b4e538b35321de05_1
@x1))
(BoxBool true))
...
;; def=ArrayRealized.fst(47,19-53,102); use=ArrayRealized.fst(52,48-52,49)
(or label_2

;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(52,48-52,49)
(Valid 
;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(52,48-52,49)
(Prims.precedes (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=ArrayRealized.fst(47,19-53,102); use=ArrayRealized.fst(52,48-52,49)
(and 
;; def=ArrayRealized.fst(47,19-47,20); use=ArrayRealized.fst(52,48-52,49)
(Valid 
;; def=ArrayRealized.fst(47,19-47,20); use=ArrayRealized.fst(52,48-52,49)
(Prims.op_Equals_Equals_Equals (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=ArrayRealized.fst(47,21-53,102); use=ArrayRealized.fst(52,48-52,49)
(or 
;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(52,48-52,49)
(Valid 
;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(52,48-52,49)
...
;; def=ArrayRealized.fst(51,8-53,102); use=ArrayRealized.fst(51,8-53,102)
(= (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_3
(ArrayRealized.length x_fe28d8bcde588226b4e538b35321de05_1
@x1))
@x4)
...
;; def=ArrayRealized.fst(47,19-53,102); use=ArrayRealized.fst(53,65-53,66)
(or label_3

;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(53,65-53,66)
(Valid 
;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(53,65-53,66)
(Prims.precedes (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=ArrayRealized.fst(47,19-53,102); use=ArrayRealized.fst(53,65-53,66)
(and 
;; def=ArrayRealized.fst(47,19-47,20); use=ArrayRealized.fst(53,65-53,66)
(Valid 
;; def=ArrayRealized.fst(47,19-47,20); use=ArrayRealized.fst(53,65-53,66)
(Prims.op_Equals_Equals_Equals (ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
(ArrayRealized.contents x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=ArrayRealized.fst(47,21-53,102); use=ArrayRealized.fst(53,65-53,66)
(or 
;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(53,65-53,66)
(Valid 
;; def=ArrayRealized.fst(47,27-53,102); use=ArrayRealized.fst(53,65-53,66)
...
;; def=ArrayRealized.fst(47,21-53,102); use=ArrayRealized.fst(53,65-53,66)
(and 
;; def=ArrayRealized.fst(47,21-47,22); use=ArrayRealized.fst(53,65-53,66)
(Valid 
;; def=ArrayRealized.fst(47,21-47,22); use=ArrayRealized.fst(53,65-53,66)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.__update__, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_fa1e1283a3ea777d1921821431f572c6_2, data_elim_ArrayRealized.Append, disc_equation_ArrayRealized.Append, disc_equation_ArrayRealized.Const, disc_equation_ArrayRealized.Upd, fuel_guarded_inversion_ArrayRealized.contents, fuel_guarded_inversion_ArrayRealized.seq, proj_equation_ArrayRealized.Seq_c, projection_inverse_ArrayRealized.Append_s1, projection_inverse_ArrayRealized.Append_s2, projection_inverse_BoxBool_proj_0, subterm_ordering_ArrayRealized.Append, subterm_ordering_ArrayRealized.Seq
...
; encoding sigelt let rec __update__


; <Start encoding let rec __update__>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun ArrayRealized.__update__.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun ArrayRealized.__update__.fuel_instrumented_token () Term)
(declare-fun ArrayRealized.__update__ (Term Term Term Term) Term)
(declare-fun ArrayRealized.__update__@tok () Term)
;;;;;;;;;;;;;;;;c: contents 'a -> i: Prims.int -> v: 'a -> contents 'a
(declare-fun Tm_arrow_752db85f3b837f1eee1bb03e94a6c21a () Term)

; </end encoding let rec __update__>


; encoding sigelt val ArrayRealized.update


; <Skipped val ArrayRealized.update/>


; encoding sigelt let update


; <Start encoding let update>


(declare-fun ArrayRealized.update (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;s: seq 'a -> i: Prims.nat{length s > i} -> v: 'a -> seq 'a
(declare-fun Tm_arrow_0fb7e60f2c003eb6e3e017a5ccca7502 () Term)
(declare-fun ArrayRealized.update@tok () Term)


; </end encoding let update>


; encoding sigelt val ArrayRealized.slice


; <Skipped val ArrayRealized.slice/>
...
; Starting query at ArrayRealized.fst(59,38-59,71)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_4a6642d08239c82e3ded92ca12e02f84 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(58,32-58,64); use=ArrayRealized.fst(59,4-59,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_4a6642d08239c82e3ded92ca12e02f84 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_4a6642d08239c82e3ded92ca12e02f84 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_4a6642d08239c82e3ded92ca12e02f84))

:named refinement_kinding_Tm_refine_4a6642d08239c82e3ded92ca12e02f84))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(58,32-58,64); use=ArrayRealized.fst(59,4-59,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4a6642d08239c82e3ded92ca12e02f84 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=ArrayRealized.fst(58,39-58,45); use=ArrayRealized.fst(59,4-59,9)
(<= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 @x1))


;; def=ArrayRealized.fst(58,49-58,62); use=ArrayRealized.fst(59,4-59,9)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (ArrayRealized.length @x3
@x4)))
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_4a6642d08239c82e3ded92ca12e02f84))

:named refinement_interpretation_Tm_refine_4a6642d08239c82e3ded92ca12e02f84))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4a6642d08239c82e3ded92ca12e02f84
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(58,32-58,64); use=ArrayRealized.fst(59,4-59,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4a6642d08239c82e3ded92ca12e02f84 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4a6642d08239c82e3ded92ca12e02f84 @x0
@x1
@x2))))
:qid haseqTm_refine_4a6642d08239c82e3ded92ca12e02f84))

:named haseqTm_refine_4a6642d08239c82e3ded92ca12e02f84))


; Encoding query formula : forall ('a: Type)
;   (_: ArrayRealized.seq 'a)
;   (i: Prims.nat)
;   (j: Prims.nat{i <= j /\ j <= ArrayRealized.length _}).
;   (*  - Could not prove post-condition
; *)
;   forall (b: ArrayRealized.contents 'a) (b: Prims.nat) (b: end_i: Prims.nat{end_i >= b}).
;     _ == ArrayRealized.Seq b b b ==>
;     b + i >= 0 /\
;     (forall (return_val: Prims.nat). return_val == b + i ==> b + j >= 0 /\ b + j >= b + i)


; Context: While encoding a query
; While typechecking the top-level declaration `let slice`
...
;; def=Prims.fst(413,99-413,120); use=ArrayRealized.fst(59,38-59,71)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(ArrayRealized.contents @x0))
...
(Tm_refine_ad53f3413fd15db5258446e997071714 @x5))

;; def=ArrayRealized.fst(59,11-59,30); use=ArrayRealized.fst(59,38-59,71)
(= @x1
(ArrayRealized.Seq @x0
@x4
@x5
...
;; def=Prims.fst(459,77-459,89); use=ArrayRealized.fst(59,38-59,71)
(and 
;; def=Prims.fst(680,18-680,24); use=ArrayRealized.fst(59,44-59,57)
(or label_1
...
;; def=Prims.fst(356,2-356,58); use=ArrayRealized.fst(59,38-59,71)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=ArrayRealized.fst(59,38-59,71)
(= @x7
(Prims.op_Addition @x5
@x2))
)

;; def=ArrayRealized.fst(28,23-28,39); use=ArrayRealized.fst(59,58-59,71)
(and 
;; def=Prims.fst(680,18-680,24); use=ArrayRealized.fst(59,58-59,71)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.slice, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, int_inversion, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_4a6642d08239c82e3ded92ca12e02f84, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
...
(declare-fun Tm_refine_4a6642d08239c82e3ded92ca12e02f84 (Term Term Term) Term)
(declare-fun ArrayRealized.slice (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;s: seq 'a -> i: Prims.nat -> j: Prims.nat{i <= j /\ j <= length s} -> seq 'a
(declare-fun Tm_arrow_eeaed18d725cde12c527ab5ef8a8edbe () Term)
(declare-fun ArrayRealized.slice@tok () Term)


; </end encoding let slice>


; encoding sigelt val ArrayRealized.split


; <Skipped val ArrayRealized.split/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name ArrayRealized.slice; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(59,4-59,9); use=ArrayRealized.fst(59,4-59,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
@x0
@x1)))
(HasType (ArrayRealized.slice @x0
@x1
@x2
@x3)
(ArrayRealized.seq @x0)))
...
:pattern ((ArrayRealized.slice @x0
@x1
@x2
@x3))
:qid typing_ArrayRealized.slice))

:named typing_ArrayRealized.slice))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name ArrayRealized.slice; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(58,32-58,64); use=ArrayRealized.fst(59,4-59,9)
...
:named haseqTm_refine_4a6642d08239c82e3ded92ca12e02f84))
;;;;;;;;;;;;;;;;Equation for ArrayRealized.slice
;;; Fact-ids: Name ArrayRealized.slice; Namespace ArrayRealized
(assert (! 
;; def=ArrayRealized.fst(59,4-59,9); use=ArrayRealized.fst(59,4-59,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ArrayRealized.slice @x0
@x1
@x2
@x3)
(let ((@lb4 @x1))
(ArrayRealized.Seq @x0
(ArrayRealized.Seq_c @lb4)
(Prims.op_Addition (ArrayRealized.Seq_start_i @lb4)
@x2)
(Prims.op_Addition (ArrayRealized.Seq_start_i @lb4)
@x3))))
...
@x2
@x3))
:qid equation_ArrayRealized.slice))

:named equation_ArrayRealized.slice))
(push) ;; push{2

; Starting query at ArrayRealized.fst(62,16-62,49)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_b8cada5c916f910ecd78984b727cc657 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(61,23-61,54); use=ArrayRealized.fst(62,4-62,9)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_b8cada5c916f910ecd78984b727cc657 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_b8cada5c916f910ecd78984b727cc657 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_b8cada5c916f910ecd78984b727cc657))

:named refinement_kinding_Tm_refine_b8cada5c916f910ecd78984b727cc657))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(61,23-61,54); use=ArrayRealized.fst(62,4-62,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b8cada5c916f910ecd78984b727cc657 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=ArrayRealized.fst(61,30-61,36); use=ArrayRealized.fst(62,4-62,9)
(<= (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 @x1))


;; def=ArrayRealized.fst(61,40-61,52); use=ArrayRealized.fst(62,4-62,9)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (ArrayRealized.length @x2
@x3)))
))
...
(Tm_refine_b8cada5c916f910ecd78984b727cc657 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_b8cada5c916f910ecd78984b727cc657))

:named refinement_interpretation_Tm_refine_b8cada5c916f910ecd78984b727cc657))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b8cada5c916f910ecd78984b727cc657
;;; Fact-ids: 
(assert (! 
;; def=ArrayRealized.fst(61,23-61,54); use=ArrayRealized.fst(62,4-62,9)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b8cada5c916f910ecd78984b727cc657 @x0
@x1)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b8cada5c916f910ecd78984b727cc657 @x0
@x1))))
:qid haseqTm_refine_b8cada5c916f910ecd78984b727cc657))

:named haseqTm_refine_b8cada5c916f910ecd78984b727cc657))


; Encoding query formula : forall ('a: Type) (s: ArrayRealized.seq 'a) (i: Prims.nat{0 <= i /\ i < ArrayRealized.length s}).
;   (*  - Could not prove post-condition
; *)
;   (0 <= i /\ i < ArrayRealized.length s ==> 0 <= i /\ i <= ArrayRealized.length s) /\
;   (forall (any_result: i: Prims.nat{0 <= i /\ i < ArrayRealized.length s}).
;       i == any_result ==>
;       (forall (any_result: ArrayRealized.seq 'a).
;           ArrayRealized.slice s 0 i == any_result ==>
;           i <= ArrayRealized.length s /\ ArrayRealized.length s <= ArrayRealized.length s))
...
(ArrayRealized.seq @x0))
(HasType @x2
(Tm_refine_b8cada5c916f910ecd78984b727cc657 @x0
@x1)))

;; def=Prims.fst(459,77-459,89); use=ArrayRealized.fst(62,16-62,49)
(and (implies 
;; def=ArrayRealized.fst(61,29-61,53); use=ArrayRealized.fst(62,26-62,27)
(and 
;; def=ArrayRealized.fst(61,30-61,36); use=ArrayRealized.fst(62,26-62,27)
(<= (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 @x2))


;; def=ArrayRealized.fst(61,40-61,52); use=ArrayRealized.fst(62,26-62,27)
(< (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (ArrayRealized.length @x0
@x1)))
)


;; def=ArrayRealized.fst(58,38-58,63); use=ArrayRealized.fst(62,26-62,27)
(and 
;; def=ArrayRealized.fst(58,39-58,45); use=ArrayRealized.fst(62,26-62,27)
(or label_1
...
;; def=ArrayRealized.fst(58,49-58,62); use=ArrayRealized.fst(62,26-62,27)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=ArrayRealized.fst(62,16-62,49)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Tm_refine_b8cada5c916f910ecd78984b727cc657 @x0
@x1))

;; def=ArrayRealized.fst(58,32-62,13); use=ArrayRealized.fst(62,16-62,49)
(= @x2
@x3)
)
...
;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=ArrayRealized.fst(62,16-62,49)
(= (ArrayRealized.slice @x0
@x1
(BoxInt 0)
@x2)
...
;; def=ArrayRealized.fst(58,38-58,63); use=ArrayRealized.fst(62,39-62,49)
(and 
;; def=ArrayRealized.fst(58,39-58,45); use=ArrayRealized.fst(62,39-62,49)
(or label_3
...
;; def=ArrayRealized.fst(58,49-58,62); use=ArrayRealized.fst(62,39-62,49)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.split, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_b8cada5c916f910ecd78984b727cc657
...
(declare-fun Tm_refine_b8cada5c916f910ecd78984b727cc657 (Term Term) Term)
(declare-fun ArrayRealized.split (Term Term Term) Term)

;;;;;;;;;;;;;;;;s: seq 'a -> i: Prims.nat{0 <= i /\ i < length s} -> seq 'a & seq 'a
(declare-fun Tm_arrow_687a3c11730b48aa97311e903ead3af7 () Term)
(declare-fun ArrayRealized.split@tok () Term)


; </end encoding let split>


; encoding sigelt val ArrayRealized.append


; <Skipped val ArrayRealized.append/>

(push) ;; push{2

; Starting query at ArrayRealized.fst(65,19-65,63)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall ('a: Type) (s1: ArrayRealized.seq 'a) (s2: ArrayRealized.seq 'a).
;   (*  - Could not prove post-condition
; *)
;   ArrayRealized.length s1 + ArrayRealized.length s2 >= 0 /\
;   ArrayRealized.length s1 + ArrayRealized.length s2 >= 0


; Context: While encoding a query
; While typechecking the top-level declaration `let append`
...
;; def=ArrayRealized.fst(28,23-28,39); use=ArrayRealized.fst(65,40-65,63)
(and 
;; def=Prims.fst(680,18-680,24); use=ArrayRealized.fst(65,40-65,63)
(or label_1

;; def=Prims.fst(680,18-680,24); use=ArrayRealized.fst(65,40-65,63)
(>= (BoxInt_proj_0 (Prims.op_Addition (ArrayRealized.length @x0
@x1)
(ArrayRealized.length @x0
@x2)))
(BoxInt_proj_0 (BoxInt 0)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ArrayRealized.append, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_ArrayRealized.length, equation_Prims.nat, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_ArrayRealized.length
