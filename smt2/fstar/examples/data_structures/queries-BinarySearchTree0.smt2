...
; Internals for BinarySearchTree0
...
; encoding sigelt type BinarySearchTree0.tree


; <Start encoding type BinarySearchTree0.tree>

;;;;;;;;;;;;;;;;Constructor
(declare-fun BinarySearchTree0.tree () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun BinarySearchTree0.Leaf () Term)
;;;;;;;;;;;;;;;;data constructor proxy: BinarySearchTree0.Leaf
(declare-fun BinarySearchTree0.Leaf@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun BinarySearchTree0.Node (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BinarySearchTree0.Node__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BinarySearchTree0.Node__1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BinarySearchTree0.Node__2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: BinarySearchTree0.Node
(declare-fun BinarySearchTree0.Node@tok () Term)
;;;;;;;;;;;;;;;;_0: Prims.int -> _1: tree -> _2: tree -> tree
(declare-fun Tm_arrow_4ca440e0045e1afcfef04766aeaabde3 () Term)

; <start constructor BinarySearchTree0.tree>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-BinarySearchTree0.tree ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
BinarySearchTree0.tree)))

; </end constructor BinarySearchTree0.tree>


; <start constructor BinarySearchTree0.Leaf>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-BinarySearchTree0.Leaf ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
BinarySearchTree0.Leaf)))

; </end constructor BinarySearchTree0.Leaf>


; <start constructor BinarySearchTree0.Node>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-BinarySearchTree0.Node ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(= __@x0
(BinarySearchTree0.Node (BinarySearchTree0.Node__0 __@x0)
(BinarySearchTree0.Node__1 __@x0)
(BinarySearchTree0.Node__2 __@x0)))))

; </end constructor BinarySearchTree0.Node>


; </end encoding type BinarySearchTree0.tree>
...
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! (HasType BinarySearchTree0.Leaf@tok
BinarySearchTree0.tree)
:named typing_tok_BinarySearchTree0.Leaf@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! 
;; def=BinarySearchTree0.fst(20,4-20,8); use=BinarySearchTree0.fst(20,4-20,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(BinarySearchTree0.Node @x1
@x2
@x3)
BinarySearchTree0.tree)
...
@x3)
BinarySearchTree0.tree))
:qid subterm_ordering_BinarySearchTree0.Node))

:named subterm_ordering_BinarySearchTree0.Node))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (BinarySearchTree0.Node__2 (BinarySearchTree0.Node @x0
@x1
@x2))
@x2)
 

:pattern ((BinarySearchTree0.Node @x0
@x1
@x2))
:qid projection_inverse_BinarySearchTree0.Node__2))

:named projection_inverse_BinarySearchTree0.Node__2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! 
;; def=BinarySearchTree0.fst(20,4-20,8); use=BinarySearchTree0.fst(20,4-20,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (BinarySearchTree0.Node__1 (BinarySearchTree0.Node @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_BinarySearchTree0.Node__1))

:named projection_inverse_BinarySearchTree0.Node__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! 
;; def=BinarySearchTree0.fst(20,4-20,8); use=BinarySearchTree0.fst(20,4-20,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (BinarySearchTree0.Node__0 (BinarySearchTree0.Node @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_BinarySearchTree0.Node__0))

:named projection_inverse_BinarySearchTree0.Node__0))
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! (HasType BinarySearchTree0.tree
Tm_type)
:named kinding_BinarySearchTree0.tree@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! 
;; def=BinarySearchTree0.fst(18,5-18,9); use=BinarySearchTree0.fst(18,5-18,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
BinarySearchTree0.tree)
(or (is-BinarySearchTree0.Leaf @x1)
(is-BinarySearchTree0.Node @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
BinarySearchTree0.tree))
:qid fuel_guarded_inversion_BinarySearchTree0.tree))

:named fuel_guarded_inversion_BinarySearchTree0.tree))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! (= BinarySearchTree0.Leaf@tok
BinarySearchTree0.Leaf)
:named equality_tok_BinarySearchTree0.Leaf@tok))
...
@x3)
BinarySearchTree0.tree))
:qid data_typing_intro_BinarySearchTree0.Node@tok))

:named data_typing_intro_BinarySearchTree0.Node@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! 
;; def=BinarySearchTree0.fst(19,4-19,8); use=BinarySearchTree0.fst(19,4-19,8)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
BinarySearchTree0.Leaf
BinarySearchTree0.tree)
...
BinarySearchTree0.Leaf
BinarySearchTree0.tree))
:qid data_typing_intro_BinarySearchTree0.Leaf@tok))

:named data_typing_intro_BinarySearchTree0.Leaf@tok))
...
@x3)
BinarySearchTree0.tree))
:qid data_elim_BinarySearchTree0.Node))

:named data_elim_BinarySearchTree0.Node))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! (= 116
(Term_constr_id BinarySearchTree0.tree))
:named constructor_distinct_BinarySearchTree0.tree))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! 
;; def=BinarySearchTree0.fst(20,4-20,8); use=BinarySearchTree0.fst(20,4-20,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 124
(Term_constr_id (BinarySearchTree0.Node @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_BinarySearchTree0.Node))

:named constructor_distinct_BinarySearchTree0.Node))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! (= 122
(Term_constr_id BinarySearchTree0.Leaf))
:named constructor_distinct_BinarySearchTree0.Leaf))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
BinarySearchTree0.tree))
:qid BinarySearchTree0_pretyping_ce9e987e2a674adb4dce3a63ac377c81))

:named BinarySearchTree0_pretyping_ce9e987e2a674adb4dce3a63ac377c81))
(push) ;; push{4

; Starting query at BinarySearchTree0.fst(18,0-20,38)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq BinarySearchTree0.tree ==>
; (forall (_0: Prims.int) (_1: BinarySearchTree0.tree) (_2: BinarySearchTree0.tree).
;     Prims.hasEq BinarySearchTree0.tree /\ Prims.hasEq BinarySearchTree0.tree)


; Context: While encoding a query
; While typechecking the top-level declaration `type BinarySearchTree0.tree`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=BinarySearchTree0.fst(18,0-20,38); use=BinarySearchTree0.fst(18,0-20,38)
(Valid 
;; def=BinarySearchTree0.fst(18,0-20,38); use=BinarySearchTree0.fst(18,0-20,38)
(Prims.hasEq BinarySearchTree0.tree)
)
...
;; def=BinarySearchTree0.fst(18,0-20,38); use=BinarySearchTree0.fst(18,0-20,38)
(and 
;; def=BinarySearchTree0.fst(18,0-20,38); use=BinarySearchTree0.fst(20,18-20,22)
(or label_1
...
;; def=BinarySearchTree0.fst(18,0-20,38); use=BinarySearchTree0.fst(20,26-20,30)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BinarySearchTree0.tree, 1)
; STATUS: unsat
...
; encoding sigelt assume BinarySearchTree0.tree__uu___haseq


; <Start encoding assume BinarySearchTree0.tree__uu___haseq>


; </end encoding assume BinarySearchTree0.tree__uu___haseq>


; encoding sigelt val BinarySearchTree0.uu___is_Leaf


; <Start encoding val BinarySearchTree0.uu___is_Leaf>

(declare-fun BinarySearchTree0.uu___is_Leaf (Term) Term)
;;;;;;;;;;;;;;;;projectee: tree -> Prims.bool
(declare-fun Tm_arrow_5c48474b21e7741c925cff5808d1a435 () Term)
(declare-fun BinarySearchTree0.uu___is_Leaf@tok () Term)

; </end encoding val BinarySearchTree0.uu___is_Leaf>
...
; encoding sigelt val BinarySearchTree0.uu___is_Node


; <Start encoding val BinarySearchTree0.uu___is_Node>

(declare-fun BinarySearchTree0.uu___is_Node (Term) Term)

(declare-fun BinarySearchTree0.uu___is_Node@tok () Term)

; </end encoding val BinarySearchTree0.uu___is_Node>
...
; encoding sigelt val BinarySearchTree0.__proj__Node__item___0


; <Start encoding val BinarySearchTree0.__proj__Node__item___0>

(declare-fun Tm_refine_0f47b300bc7833c94b530c9724981898 () Term)
(declare-fun BinarySearchTree0.__proj__Node__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: tree{Node? _} -> Prims.int
(declare-fun Tm_arrow_7ca8a56291d3fdc96b1eb4fcb300ab6e () Term)
(declare-fun BinarySearchTree0.__proj__Node__item___0@tok () Term)

; </end encoding val BinarySearchTree0.__proj__Node__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BinarySearchTree0.uu___is_Node; Namespace BinarySearchTree0
(assert (! 
;; def=BinarySearchTree0.fst(20,4-20,8); use=BinarySearchTree0.fst(20,4-20,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
BinarySearchTree0.tree)
(HasType (BinarySearchTree0.uu___is_Node @x0)
Prims.bool))
 

:pattern ((BinarySearchTree0.uu___is_Node @x0))
:qid typing_BinarySearchTree0.uu___is_Node))

:named typing_BinarySearchTree0.uu___is_Node))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name BinarySearchTree0.tree; Namespace BinarySearchTree0; Name BinarySearchTree0.Leaf; Namespace BinarySearchTree0; Name BinarySearchTree0.Node; Namespace BinarySearchTree0
(assert (! 
;; def=BinarySearchTree0.fst(20,4-20,8); use=BinarySearchTree0.fst(20,4-20,8)
...
:named refinement_kinding_Tm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name BinarySearchTree0.__proj__Node__item___0; Namespace BinarySearchTree0
(assert (! (HasType Tm_refine_0f47b300bc7833c94b530c9724981898
Tm_type)
:named refinement_kinding_Tm_refine_0f47b300bc7833c94b530c9724981898))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! (HasType Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_0f47b300bc7833c94b530c9724981898)
(and (HasTypeFuel @u0
@x1
BinarySearchTree0.tree)

;; def=BinarySearchTree0.fst(20,4-20,8); use=BinarySearchTree0.fst(20,4-20,8)
(BoxBool_proj_0 (BinarySearchTree0.uu___is_Node @x1))
))
...
@x1
Tm_refine_0f47b300bc7833c94b530c9724981898))
:qid refinement_interpretation_Tm_refine_0f47b300bc7833c94b530c9724981898))

:named refinement_interpretation_Tm_refine_0f47b300bc7833c94b530c9724981898))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
;; def=Prims.fst(686,15-686,29); use=Prims.fst(686,15-686,29)
...
(Valid (Prims.hasEq Tm_type)))
:named haseqTm_refine_414d0a9f578ab0048252f8c8f552b99f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0f47b300bc7833c94b530c9724981898
;;; Fact-ids: Name BinarySearchTree0.__proj__Node__item___0; Namespace BinarySearchTree0
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0f47b300bc7833c94b530c9724981898))
(Valid (Prims.hasEq BinarySearchTree0.tree)))
:named haseqTm_refine_0f47b300bc7833c94b530c9724981898))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f))
(Valid (Prims.hasEq Prims.int)))
...
;; def=BinarySearchTree0.fst(20,4-20,8); use=BinarySearchTree0.fst(20,4-20,8)
(forall ((@x0 Term))
 (! (= (BinarySearchTree0.uu___is_Node @x0)
(BoxBool (is-BinarySearchTree0.Node @x0)))
 

:pattern ((BinarySearchTree0.uu___is_Node @x0))
:qid disc_equation_BinarySearchTree0.Node))

:named disc_equation_BinarySearchTree0.Node))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: BinarySearchTree0.tree__uu___haseq
;;; Fact-ids: Name BinarySearchTree0.tree__uu___haseq; Namespace BinarySearchTree0
(assert (! (Valid (Prims.hasEq BinarySearchTree0.tree))
:named assumption_BinarySearchTree0.tree__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Encoding query formula : forall (projectee: _: BinarySearchTree0.tree{Node? _}).
...
(not 
;; def=BinarySearchTree0.fst(20,4-20,8); use=BinarySearchTree0.fst(20,4-20,8)
(BoxBool_proj_0 (BinarySearchTree0.uu___is_Node @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BinarySearchTree0.__proj__Node__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0f47b300bc7833c94b530c9724981898
...
; encoding sigelt val BinarySearchTree0.__proj__Node__item___1


; <Start encoding val BinarySearchTree0.__proj__Node__item___1>


(declare-fun BinarySearchTree0.__proj__Node__item___1 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: tree{Node? _} -> tree
(declare-fun Tm_arrow_45f24fddbab7397a778619958f029185 () Term)
(declare-fun BinarySearchTree0.__proj__Node__item___1@tok () Term)

; </end encoding val BinarySearchTree0.__proj__Node__item___1>
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BinarySearchTree0.__proj__Node__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0f47b300bc7833c94b530c9724981898
...
; encoding sigelt val BinarySearchTree0.__proj__Node__item___2


; <Start encoding val BinarySearchTree0.__proj__Node__item___2>


(declare-fun BinarySearchTree0.__proj__Node__item___2 (Term) Term)


(declare-fun BinarySearchTree0.__proj__Node__item___2@tok () Term)

; </end encoding val BinarySearchTree0.__proj__Node__item___2>
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BinarySearchTree0.__proj__Node__item___2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_0f47b300bc7833c94b530c9724981898
...
; encoding sigelt val BinarySearchTree0.search


; <Skipped val BinarySearchTree0.search/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BinarySearchTree0.uu___is_Leaf; Namespace BinarySearchTree0
(assert (! 
;; def=BinarySearchTree0.fst(19,4-19,8); use=BinarySearchTree0.fst(19,4-19,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
BinarySearchTree0.tree)
(HasType (BinarySearchTree0.uu___is_Leaf @x0)
Prims.bool))
 

:pattern ((BinarySearchTree0.uu___is_Leaf @x0))
:qid typing_BinarySearchTree0.uu___is_Leaf))

:named typing_BinarySearchTree0.uu___is_Leaf))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;; def=BinarySearchTree0.fst(19,4-19,8); use=BinarySearchTree0.fst(19,4-19,8)
(forall ((@x0 Term))
 (! (= (BinarySearchTree0.uu___is_Leaf @x0)
(BoxBool (is-BinarySearchTree0.Leaf @x0)))
 

:pattern ((BinarySearchTree0.uu___is_Leaf @x0))
:qid disc_equation_BinarySearchTree0.Leaf))

:named disc_equation_BinarySearchTree0.Leaf))
...
; Starting query at BinarySearchTree0.fst(24,2-28,50)
...
;;;;;;;;;;;;;;;;t : BinarySearchTree0.tree (BinarySearchTree0.tree)
(declare-fun x_ce9e987e2a674adb4dce3a63ac377c81_1 () Term)
;;;;;;;;;;;;;;;;binder_x_ce9e987e2a674adb4dce3a63ac377c81_1
;;; Fact-ids: 
(assert (! (HasType x_ce9e987e2a674adb4dce3a63ac377c81_1
BinarySearchTree0.tree)
:named binder_x_ce9e987e2a674adb4dce3a63ac377c81_1))
(declare-fun Tm_refine_24ec18055b7e634950bab9e7397b05ec (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(23,15-28,50); use=BinarySearchTree0.fst(23,15-28,50)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_24ec18055b7e634950bab9e7397b05ec @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_24ec18055b7e634950bab9e7397b05ec @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_24ec18055b7e634950bab9e7397b05ec))

:named refinement_kinding_Tm_refine_24ec18055b7e634950bab9e7397b05ec))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(23,15-28,50); use=BinarySearchTree0.fst(23,15-28,50)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_24ec18055b7e634950bab9e7397b05ec @x2))
(and (HasTypeFuel @u0
@x1
BinarySearchTree0.tree)
...
;; def=BinarySearchTree0.fst(23,15-28,50); use=BinarySearchTree0.fst(23,15-28,50)
(or 
;; def=BinarySearchTree0.fst(24,2-28,50); use=BinarySearchTree0.fst(24,2-28,50)
(Valid 
;; def=BinarySearchTree0.fst(24,2-28,50); use=BinarySearchTree0.fst(24,2-28,50)
...
;; def=BinarySearchTree0.fst(23,15-28,50); use=BinarySearchTree0.fst(23,15-28,50)
(and 
;; def=BinarySearchTree0.fst(23,15-23,16); use=BinarySearchTree0.fst(23,15-23,16)
(Valid 
;; def=BinarySearchTree0.fst(23,15-23,16); use=BinarySearchTree0.fst(23,15-23,16)
...
(Valid 
;; def=BinarySearchTree0.fst(24,2-28,50); use=BinarySearchTree0.fst(24,2-28,50)
(Prims.precedes BinarySearchTree0.tree
BinarySearchTree0.tree
@x1
x_ce9e987e2a674adb4dce3a63ac377c81_1)
)
)
)
...
@x1
(Tm_refine_24ec18055b7e634950bab9e7397b05ec @x2)))
:qid refinement_interpretation_Tm_refine_24ec18055b7e634950bab9e7397b05ec))

:named refinement_interpretation_Tm_refine_24ec18055b7e634950bab9e7397b05ec))
;;;;;;;;;;;;;;;;haseq for Tm_refine_24ec18055b7e634950bab9e7397b05ec
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(23,15-28,50); use=BinarySearchTree0.fst(23,15-28,50)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_24ec18055b7e634950bab9e7397b05ec @x0)))
(Valid (Prims.hasEq BinarySearchTree0.tree)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_24ec18055b7e634950bab9e7397b05ec @x0))))
:qid haseqTm_refine_24ec18055b7e634950bab9e7397b05ec))

:named haseqTm_refine_24ec18055b7e634950bab9e7397b05ec))
(declare-fun BinarySearchTree0.search (Term Term) Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: _: tree{_ << x \/ _ === x /\ _ << t} -> Prims.bool
(declare-fun Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185
Tm_type)
:named kinding_Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(22,13-28,50); use=BinarySearchTree0.fst(23,8-28,50)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185))
:qid BinarySearchTree0_pre_typing_Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185))

:named BinarySearchTree0_pre_typing_Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(22,13-28,50); use=BinarySearchTree0.fst(23,8-28,50)
(forall ((@x0 Term))
...
Prims.int)
(HasType @x2
(Tm_refine_24ec18055b7e634950bab9e7397b05ec @x1)))
...
@x1)
@x2))
:qid BinarySearchTree0_interpretation_Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid BinarySearchTree0_interpretation_Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185))
:qid BinarySearchTree0_interpretation_Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185))

:named BinarySearchTree0_interpretation_Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185))
(declare-fun BinarySearchTree0.search@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(23,8-23,14); use=BinarySearchTree0.fst(23,8-23,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT BinarySearchTree0.search@tok
@x0)
@x1)
(BinarySearchTree0.search @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT BinarySearchTree0.search@tok
@x0)
@x1))
:qid token_correspondence_BinarySearchTree0.search))

:named token_correspondence_BinarySearchTree0.search))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(23,8-23,14); use=BinarySearchTree0.fst(23,8-23,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType BinarySearchTree0.search@tok
Tm_arrow_d6665f2e2a1f0e20ef0b2b38e8d24185))
...
@x1)
@x2)
(BinarySearchTree0.search @x1
@x2))
 

:pattern ((BinarySearchTree0.search @x1
@x2))
:qid function_token_typing_BinarySearchTree0.search.1))
)
 

:pattern ((ApplyTT @x0
BinarySearchTree0.search@tok))
:qid function_token_typing_BinarySearchTree0.search))

:named function_token_typing_BinarySearchTree0.search))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(23,8-23,14); use=BinarySearchTree0.fst(23,8-23,14)
...
Prims.int)
(HasType @x1
(Tm_refine_24ec18055b7e634950bab9e7397b05ec @x0)))
(HasType (BinarySearchTree0.search @x0
@x1)
Prims.bool))
 

:pattern ((BinarySearchTree0.search @x0
@x1))
:qid typing_BinarySearchTree0.search))

:named typing_BinarySearchTree0.search))
...
;   (~(Leaf? t) ==>
;     (forall (b: Prims.int) (b: BinarySearchTree0.tree) (b: BinarySearchTree0.tree).
;         t == BinarySearchTree0.Node b b b ==>
...
;; def=Prims.fst(402,27-402,88); use=BinarySearchTree0.fst(24,2-28,50)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=BinarySearchTree0.fst(24,2-28,50)
(Valid 
;; def=Prims.fst(402,84-402,87); use=BinarySearchTree0.fst(24,2-28,50)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=BinarySearchTree0.fst(24,2-28,50)
(and (implies 
;; def=BinarySearchTree0.fst(23,17-23,18); use=BinarySearchTree0.fst(24,8-24,9)
(and 
;; def=BinarySearchTree0.fst(23,17-23,18); use=BinarySearchTree0.fst(24,8-24,9)
(not 
;; def=BinarySearchTree0.fst(23,17-23,18); use=BinarySearchTree0.fst(24,8-24,9)
(BoxBool_proj_0 (BinarySearchTree0.uu___is_Leaf x_ce9e987e2a674adb4dce3a63ac377c81_1))
)
...
(not 
;; def=BinarySearchTree0.fst(23,17-23,18); use=BinarySearchTree0.fst(24,8-24,9)
(BoxBool_proj_0 (BinarySearchTree0.uu___is_Node x_ce9e987e2a674adb4dce3a63ac377c81_1))
)
)

label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=BinarySearchTree0.fst(24,2-28,50)
(not 
;; def=BinarySearchTree0.fst(23,17-23,18); use=BinarySearchTree0.fst(24,8-24,9)
(BoxBool_proj_0 (BinarySearchTree0.uu___is_Leaf x_ce9e987e2a674adb4dce3a63ac377c81_1))
)
...
;; def=Prims.fst(413,99-413,120); use=BinarySearchTree0.fst(24,2-28,50)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=BinarySearchTree0.fst(23,17-26,16); use=BinarySearchTree0.fst(24,8-26,16)
(= x_ce9e987e2a674adb4dce3a63ac377c81_1
(BinarySearchTree0.Node @x1
@x2
@x3))
...
;; def=Prims.fst(389,19-389,21); use=BinarySearchTree0.fst(24,2-28,50)
(not 
;; def=BinarySearchTree0.fst(26,23-26,28); use=BinarySearchTree0.fst(26,23-26,28)
...
;; def=BinarySearchTree0.fst(26,23-28,50); use=BinarySearchTree0.fst(26,23-28,50)
(= (Prims.op_Equality Prims.int
x_ae567c2fb75be05905677af440075565_0
@x1)
@x5)
...
;; def=Prims.fst(389,2-389,39); use=BinarySearchTree0.fst(24,2-28,50)
(and (implies 
;; def=BinarySearchTree0.fst(27,28-27,33); use=BinarySearchTree0.fst(27,28-27,33)
(= (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_0
@x1)
(BoxBool true))


;; def=BinarySearchTree0.fst(23,15-28,50); use=BinarySearchTree0.fst(27,48-27,50)
(or label_2

;; def=BinarySearchTree0.fst(24,2-28,50); use=BinarySearchTree0.fst(27,48-27,50)
(Valid 
;; def=BinarySearchTree0.fst(24,2-28,50); use=BinarySearchTree0.fst(27,48-27,50)
(Prims.precedes Prims.int
Prims.int
...
;; def=BinarySearchTree0.fst(27,28-28,50); use=BinarySearchTree0.fst(27,28-28,50)
(= (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_0
@x1)
@x7)
)

;; def=BinarySearchTree0.fst(23,15-28,50); use=BinarySearchTree0.fst(28,48-28,50)
(or label_3

;; def=BinarySearchTree0.fst(24,2-28,50); use=BinarySearchTree0.fst(28,48-28,50)
(Valid 
;; def=BinarySearchTree0.fst(24,2-28,50); use=BinarySearchTree0.fst(28,48-28,50)
(Prims.precedes Prims.int
Prims.int
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BinarySearchTree0.search, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, BinarySearchTree0_pretyping_ce9e987e2a674adb4dce3a63ac377c81, binder_x_ce9e987e2a674adb4dce3a63ac377c81_1, disc_equation_BinarySearchTree0.Leaf, disc_equation_BinarySearchTree0.Node, equality_tok_BinarySearchTree0.Leaf@tok, fuel_guarded_inversion_BinarySearchTree0.tree, projection_inverse_BinarySearchTree0.Node__1, projection_inverse_BinarySearchTree0.Node__2, projection_inverse_BoxBool_proj_0, subterm_ordering_BinarySearchTree0.Node, typing_tok_BinarySearchTree0.Leaf@tok
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun BinarySearchTree0.search.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun BinarySearchTree0.search.fuel_instrumented_token () Term)
(declare-fun BinarySearchTree0.search (Term Term) Term)
(declare-fun BinarySearchTree0.search@tok () Term)
;;;;;;;;;;;;;;;;x: Prims.int -> t: tree -> Prims.bool
(declare-fun Tm_arrow_5f62bea078c505a7f3006d48831fadcb () Term)

; </end encoding let rec search>


; encoding sigelt val BinarySearchTree0.insert


; <Skipped val BinarySearchTree0.insert/>

(push) ;; push{2

; Starting query at BinarySearchTree0.fst(32,2-36,62)
...
BinarySearchTree0.tree)
:named binder_x_ce9e987e2a674adb4dce3a63ac377c81_1))
(declare-fun Tm_refine_66d43254bdb96178a002555035760c9d (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(31,15-36,62); use=BinarySearchTree0.fst(31,15-36,62)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_66d43254bdb96178a002555035760c9d @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_66d43254bdb96178a002555035760c9d @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_66d43254bdb96178a002555035760c9d))

:named refinement_kinding_Tm_refine_66d43254bdb96178a002555035760c9d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(31,15-36,62); use=BinarySearchTree0.fst(31,15-36,62)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_66d43254bdb96178a002555035760c9d @x2))
(and (HasTypeFuel @u0
@x1
BinarySearchTree0.tree)
...
;; def=BinarySearchTree0.fst(31,15-36,62); use=BinarySearchTree0.fst(31,15-36,62)
(or 
;; def=BinarySearchTree0.fst(32,2-36,62); use=BinarySearchTree0.fst(32,2-36,62)
(Valid 
;; def=BinarySearchTree0.fst(32,2-36,62); use=BinarySearchTree0.fst(32,2-36,62)
(Prims.precedes Prims.int
Prims.int
...
;; def=BinarySearchTree0.fst(31,15-36,62); use=BinarySearchTree0.fst(31,15-36,62)
(and 
;; def=BinarySearchTree0.fst(31,15-31,16); use=BinarySearchTree0.fst(31,15-31,16)
(Valid 
;; def=BinarySearchTree0.fst(31,15-31,16); use=BinarySearchTree0.fst(31,15-31,16)
(Prims.op_Equals_Equals_Equals Prims.int
Prims.int
...
@x1
(Tm_refine_66d43254bdb96178a002555035760c9d @x2)))
:qid refinement_interpretation_Tm_refine_66d43254bdb96178a002555035760c9d))

:named refinement_interpretation_Tm_refine_66d43254bdb96178a002555035760c9d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_66d43254bdb96178a002555035760c9d
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(31,15-36,62); use=BinarySearchTree0.fst(31,15-36,62)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_66d43254bdb96178a002555035760c9d @x0)))
(Valid (Prims.hasEq BinarySearchTree0.tree)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_66d43254bdb96178a002555035760c9d @x0))))
:qid haseqTm_refine_66d43254bdb96178a002555035760c9d))

:named haseqTm_refine_66d43254bdb96178a002555035760c9d))
(declare-fun BinarySearchTree0.insert (Term Term) Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: _: tree{_ << x \/ _ === x /\ _ << t} -> tree
(declare-fun Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094
Tm_type)
:named kinding_Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(30,13-36,62); use=BinarySearchTree0.fst(31,8-36,62)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094))
:qid BinarySearchTree0_pre_typing_Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094))

:named BinarySearchTree0_pre_typing_Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(30,13-36,62); use=BinarySearchTree0.fst(31,8-36,62)
(forall ((@x0 Term))
...
Prims.int)
(HasType @x2
(Tm_refine_66d43254bdb96178a002555035760c9d @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
BinarySearchTree0.tree))
...
@x1)
@x2))
:qid BinarySearchTree0_interpretation_Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid BinarySearchTree0_interpretation_Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094))
:qid BinarySearchTree0_interpretation_Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094))

:named BinarySearchTree0_interpretation_Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094))
(declare-fun BinarySearchTree0.insert@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(31,8-31,14); use=BinarySearchTree0.fst(31,8-31,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT BinarySearchTree0.insert@tok
@x0)
@x1)
(BinarySearchTree0.insert @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT BinarySearchTree0.insert@tok
@x0)
@x1))
:qid token_correspondence_BinarySearchTree0.insert))

:named token_correspondence_BinarySearchTree0.insert))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(31,8-31,14); use=BinarySearchTree0.fst(31,8-31,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType BinarySearchTree0.insert@tok
Tm_arrow_86b61d2e9e2c792f8071116a1c1bb094))
...
@x1)
@x2)
(BinarySearchTree0.insert @x1
@x2))
 

:pattern ((BinarySearchTree0.insert @x1
@x2))
:qid function_token_typing_BinarySearchTree0.insert.1))
)
 

:pattern ((ApplyTT @x0
BinarySearchTree0.insert@tok))
:qid function_token_typing_BinarySearchTree0.insert))

:named function_token_typing_BinarySearchTree0.insert))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=BinarySearchTree0.fst(31,8-31,14); use=BinarySearchTree0.fst(31,8-31,14)
...
Prims.int)
(HasType @x1
(Tm_refine_66d43254bdb96178a002555035760c9d @x0)))
(HasType (BinarySearchTree0.insert @x0
@x1)
BinarySearchTree0.tree))
 

:pattern ((BinarySearchTree0.insert @x0
@x1))
:qid typing_BinarySearchTree0.insert))

:named typing_BinarySearchTree0.insert))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post BinarySearchTree0.tree).
;   (forall (x: BinarySearchTree0.tree). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Leaf? t) /\ ~(Node? t) ==> Prims.l_False) /\
;   (~(Leaf? t) ==>
;     (forall (b: Prims.int) (b: BinarySearchTree0.tree) (b: BinarySearchTree0.tree).
;         t == BinarySearchTree0.Node b b b ==>
;         (forall (k: Prims.pure_post BinarySearchTree0.tree).
;             (forall (x: BinarySearchTree0.tree). {:pattern Prims.guard_free (k x)}
;                 Prims.auto_squash (k x)) ==>
;             ~(x = b = true) ==>
;             (forall (b: Prims.bool).
;                 x = b == b ==>
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post BinarySearchTree0.tree))

;; def=Prims.fst(402,27-402,88); use=BinarySearchTree0.fst(32,2-36,62)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=BinarySearchTree0.fst(32,2-36,62)
(Valid 
;; def=Prims.fst(402,84-402,87); use=BinarySearchTree0.fst(32,2-36,62)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=BinarySearchTree0.fst(32,2-36,62)
(and (implies 
;; def=BinarySearchTree0.fst(31,17-31,18); use=BinarySearchTree0.fst(32,8-32,9)
(and 
;; def=BinarySearchTree0.fst(31,17-31,18); use=BinarySearchTree0.fst(32,8-32,9)
(not 
;; def=BinarySearchTree0.fst(31,17-31,18); use=BinarySearchTree0.fst(32,8-32,9)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=BinarySearchTree0.fst(32,2-36,62)
(not 
;; def=BinarySearchTree0.fst(31,17-31,18); use=BinarySearchTree0.fst(32,8-32,9)
(BoxBool_proj_0 (BinarySearchTree0.uu___is_Leaf x_ce9e987e2a674adb4dce3a63ac377c81_1))
)
...
;; def=Prims.fst(413,99-413,120); use=BinarySearchTree0.fst(32,2-36,62)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=BinarySearchTree0.fst(31,17-34,16); use=BinarySearchTree0.fst(32,8-34,16)
(= x_ce9e987e2a674adb4dce3a63ac377c81_1
(BinarySearchTree0.Node @x1
@x2
@x3))
...
;; def=Prims.fst(389,19-389,21); use=BinarySearchTree0.fst(32,2-36,62)
(not 
;; def=BinarySearchTree0.fst(34,23-34,28); use=BinarySearchTree0.fst(34,23-34,28)
(= (Prims.op_Equality Prims.int
x_ae567c2fb75be05905677af440075565_0
@x1)
(BoxBool true))
...
;; def=BinarySearchTree0.fst(34,23-36,62); use=BinarySearchTree0.fst(34,23-36,62)
(= (Prims.op_Equality Prims.int
x_ae567c2fb75be05905677af440075565_0
@x1)
@x5)
...
;; def=Prims.fst(389,2-389,39); use=BinarySearchTree0.fst(32,2-36,62)
(and (implies 
;; def=BinarySearchTree0.fst(35,28-35,33); use=BinarySearchTree0.fst(35,28-35,33)
(= (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_0
@x1)
(BoxBool true))


;; def=BinarySearchTree0.fst(31,15-36,62); use=BinarySearchTree0.fst(35,56-35,58)
(or label_2

;; def=BinarySearchTree0.fst(32,2-36,62); use=BinarySearchTree0.fst(35,56-35,58)
(Valid 
;; def=BinarySearchTree0.fst(32,2-36,62); use=BinarySearchTree0.fst(35,56-35,58)
(Prims.precedes Prims.int
Prims.int
...
;; def=BinarySearchTree0.fst(35,28-36,62); use=BinarySearchTree0.fst(35,28-36,62)
(= (Prims.op_LessThan x_ae567c2fb75be05905677af440075565_0
@x1)
@x7)
)

;; def=BinarySearchTree0.fst(31,15-36,62); use=BinarySearchTree0.fst(36,59-36,61)
(or label_3

;; def=BinarySearchTree0.fst(32,2-36,62); use=BinarySearchTree0.fst(36,59-36,61)
(Valid 
;; def=BinarySearchTree0.fst(32,2-36,62); use=BinarySearchTree0.fst(36,59-36,61)
(Prims.precedes Prims.int
Prims.int
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BinarySearchTree0.insert, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, BinarySearchTree0_pretyping_ce9e987e2a674adb4dce3a63ac377c81, binder_x_ce9e987e2a674adb4dce3a63ac377c81_1, disc_equation_BinarySearchTree0.Leaf, disc_equation_BinarySearchTree0.Node, equality_tok_BinarySearchTree0.Leaf@tok, fuel_guarded_inversion_BinarySearchTree0.tree, projection_inverse_BinarySearchTree0.Node__1, projection_inverse_BinarySearchTree0.Node__2, projection_inverse_BoxBool_proj_0, subterm_ordering_BinarySearchTree0.Node, typing_tok_BinarySearchTree0.Leaf@tok
