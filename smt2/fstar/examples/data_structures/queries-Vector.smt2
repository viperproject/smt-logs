...
; Starting query at Vector.fst(19,0-24,29)

(declare-fun Vector.vector (Term Term) Term)
;;;;;;;;;;;;;;;;'a: Type -> _: Prims.nat -> Type
(declare-fun Tm_arrow_67c7b2626869cb316f118144000415b9 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_67c7b2626869cb316f118144000415b9
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_67c7b2626869cb316f118144000415b9
Tm_type)
:named kinding_Tm_arrow_67c7b2626869cb316f118144000415b9))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(19,12-19,28); use=Vector.fst(19,12-19,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_67c7b2626869cb316f118144000415b9)
...
@x1
Tm_arrow_67c7b2626869cb316f118144000415b9))
:qid Vector_pre_typing_Tm_arrow_67c7b2626869cb316f118144000415b9))

:named Vector_pre_typing_Tm_arrow_67c7b2626869cb316f118144000415b9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(19,12-19,28); use=Vector.fst(19,12-19,28)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_67c7b2626869cb316f118144000415b9))
:qid Vector_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9))

:named Vector_interpretation_Tm_arrow_67c7b2626869cb316f118144000415b9))
(declare-fun Vector.vector@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(19,5-19,11); use=Vector.fst(19,5-19,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Vector.vector@tok
@x0)
@x1)
(Vector.vector @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Vector.vector@tok
@x0)
@x1))
:qid token_correspondence_Vector.vector))

:named token_correspondence_Vector.vector))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(19,5-19,11); use=Vector.fst(19,5-19,11)
...
:pattern ((Vector.vector @x1
@x2))
:qid function_token_typing_Vector.vector.1))
)
 

:pattern ((ApplyTT @x0
Vector.vector@tok))
:qid function_token_typing_Vector.vector))

:named function_token_typing_Vector.vector))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(19,5-19,11); use=Vector.fst(19,5-19,11)
...
(HasType @x1
Prims.nat))
(HasType (Vector.vector @x0
@x1)
Tm_type))
 

:pattern ((Vector.vector @x0
@x1))
:qid typing_Vector.vector))

:named typing_Vector.vector))
(declare-fun label_1 () Bool)

; Encoding query formula : forall ('a: Type) (hd: 'a) (n: Prims.nat) (tl: Vector.vector 'a n).
...
; While typechecking the top-level declaration `type Vector.vector`
...
;; def=Prims.fst(680,18-680,24); use=Vector.fst(24,22-24,29)
(or label_1
...
; encoding sigelt type Vector.vector


; <Start encoding type Vector.vector>
...
(declare-fun Vector.vector@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Vector.VNil (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Vector.VNil__a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Vector.VNil
(declare-fun Vector.VNil@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Vector.VCons (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Vector.VCons__a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Vector.VCons_hd (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Vector.VCons_n (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Vector.VCons_tl (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Vector.VCons
(declare-fun Vector.VCons@tok () Term)
;;;;;;;;;;;;;;;;vector 'a 0
(declare-fun Tm_arrow_fdd048e14a7dfa73a5658915c426403b () Term)
;;;;;;;;;;;;;;;;hd: 'a -> tl: vector 'a n -> vector 'a (n + 1)
(declare-fun Tm_arrow_d14312b83b23decc89eda8e32d243e70 () Term)

; <start constructor Vector.vector>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Vector.vector ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
124)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
;;no pats
:qid is-Vector.vector))))

; </end constructor Vector.vector>


; <start constructor Vector.VNil>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Vector.VNil ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
131)
(= __@x0
(Vector.VNil (Vector.VNil__a __@x0)))))

; </end constructor Vector.VNil>


; <start constructor Vector.VCons>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Vector.VCons ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
137)
(= __@x0
(Vector.VCons (Vector.VCons__a __@x0)
(Vector.VCons_hd __@x0)
(Vector.VCons_n __@x0)
(Vector.VCons_tl __@x0)))))

; </end constructor Vector.VCons>


; </end encoding type Vector.vector>
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(19,5-19,11); use=Vector.fst(19,5-19,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Vector.vector@tok
...
:pattern ((Vector.vector @x0
@x1))
:qid token_correspondence_Vector.vector@tok))

:named token_correspondence_Vector.vector@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
...
(Vector.vector @x5
@x6)))
:qid subterm_ordering_Vector.VCons))

:named subterm_ordering_Vector.VCons))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(20,4-20,8); use=Vector.fst(20,4-20,8)
(forall ((@x0 Term))
 (! (= (Vector.VNil__a (Vector.VNil @x0))
@x0)
 

:pattern ((Vector.VNil @x0))
:qid projection_inverse_Vector.VNil__a))

:named projection_inverse_Vector.VNil__a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Vector.VCons_tl (Vector.VCons @x0
@x1
@x2
@x3))
@x3)
...
:pattern ((Vector.VCons @x0
@x1
@x2
@x3))
:qid projection_inverse_Vector.VCons_tl))

:named projection_inverse_Vector.VCons_tl))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Vector.VCons_n (Vector.VCons @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Vector.VCons_n))

:named projection_inverse_Vector.VCons_n))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Vector.VCons_hd (Vector.VCons @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Vector.VCons_hd))

:named projection_inverse_Vector.VCons_hd))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Vector.VCons__a (Vector.VCons @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_Vector.VCons__a))

:named projection_inverse_Vector.VCons__a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! (is-Tm_arrow (PreType Vector.vector@tok))
:named pre_kinding_Vector.vector@tok))
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! (and (IsTotFun Vector.vector@tok)

;; def=Vector.fst(19,5-19,11); use=Vector.fst(19,5-19,11)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Vector.vector@tok
@x0))
 

:pattern ((ApplyTT Vector.vector@tok
@x0))
:qid kinding_Vector.vector@tok))
...
:pattern ((Vector.vector @x0
@x1))
:qid kinding_Vector.vector@tok.1))
)
:named kinding_Vector.vector@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(19,5-19,11); use=Vector.fst(19,5-19,11)
...
(Vector.vector @x2
@x3))
(or (and (is-Vector.VNil @x1)
(= @x2
(Vector.VNil__a @x1))
(= @x3
(BoxInt 0)))
(and (is-Vector.VCons @x1)
(= @x2
(Vector.VCons__a @x1))
(= @x3
(Prims.op_Addition (Vector.VCons_n @x1)
(BoxInt 1))))))
...
(Vector.vector @x2
@x3)))
:qid fuel_guarded_inversion_Vector.vector))

:named fuel_guarded_inversion_Vector.vector))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! (= 125
(Term_constr_id Vector.vector@tok))
:named fresh_token_Vector.vector@tok))
...
(Vector.vector @x1
@x2)))
:qid data_typing_intro_Vector.VNil@tok))

:named data_typing_intro_Vector.VNil@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
...
(Vector.vector @x1
@x5)))
:qid data_typing_intro_Vector.VCons@tok))

:named data_typing_intro_Vector.VCons@tok))
...
(Vector.vector @x2
@x3)))
:qid data_elim_Vector.VNil))

:named data_elim_Vector.VNil))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
...
(Vector.vector @x5
@x6)))
:qid data_elim_Vector.VCons))

:named data_elim_Vector.VCons))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(19,5-19,11); use=Vector.fst(19,5-19,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= 124
(Term_constr_id (Vector.vector @x0
@x1)))
 

:pattern ((Vector.vector @x0
@x1))
:qid constructor_distinct_Vector.vector))

:named constructor_distinct_Vector.vector))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(20,4-20,8); use=Vector.fst(20,4-20,8)
(forall ((@x0 Term))
 (! (= 131
(Term_constr_id (Vector.VNil @x0)))
 

:pattern ((Vector.VNil @x0))
:qid constructor_distinct_Vector.VNil))

:named constructor_distinct_Vector.VNil))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= 137
(Term_constr_id (Vector.VCons @x0
@x1
@x2
@x3)))
...
@x2
@x3))
:qid constructor_distinct_Vector.VCons))

:named constructor_distinct_Vector.VCons))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(19,5-19,11); use=Vector.fst(19,5-19,11)
...
(Vector.vector @x2
@x3)))
:qid Vector_pretyping_8b879a9491eabf445d3262614a8a2223))

:named Vector_pretyping_8b879a9491eabf445d3262614a8a2223))
(push) ;; push{4
...
; Encoding query formula : forall ('a: Type) (_: Prims.nat).
;   Prims.hasEq 'a /\
;   (forall ('a: Type) (_: Prims.nat). {:pattern Prims.hasEq (Vector.vector 'a _)}
;       Prims.hasEq 'a ==> Prims.hasEq (Vector.vector 'a _)) ==>
;   (forall (hd: 'a) (n: Prims.nat) (tl: Vector.vector 'a n).
;       Prims.hasEq 'a /\ Prims.hasEq Prims.nat /\ Prims.hasEq (Vector.vector 'a n))
...
;; def=Vector.fst(19,0-24,29); use=Vector.fst(19,0-24,29)
(Valid 
;; def=Vector.fst(19,0-24,29); use=Vector.fst(19,0-24,29)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=Vector.fst(19,0-24,29); use=Vector.fst(19,0-24,29)
(Prims.hasEq (Vector.vector @x2
@x3))
)
)
 

:pattern ((Prims.hasEq (Vector.vector @x2
@x3)))
:qid @query.1))
)
...
;; def=Vector.fst(19,0-24,29); use=Vector.fst(19,0-24,29)
(and 
;; def=Vector.fst(19,0-24,29); use=Vector.fst(21,15-21,17)
(or label_1
...
;; def=Vector.fst(19,0-24,29); use=Vector.fst(22,15-22,18)
(or label_2
...
;; def=Vector.fst(19,0-24,29); use=Vector.fst(23,15-23,26)
(or label_3

;; def=Vector.fst(19,0-24,29); use=Vector.fst(19,0-24,29)
(Valid 
;; def=Vector.fst(19,0-24,29); use=Vector.fst(19,0-24,29)
(Prims.hasEq (Vector.vector @x0
@x3))
)
)
)
...
; encoding sigelt assume Vector.vector__uu___haseq


; <Start encoding assume Vector.vector__uu___haseq>


; </end encoding assume Vector.vector__uu___haseq>


; encoding sigelt val Vector.uu___is_VNil


; <Start encoding val Vector.uu___is_VNil>

(declare-fun Vector.uu___is_VNil (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: vector 'a _ -> Prims.bool
(declare-fun Tm_arrow_24e9ae7a0e1a3511cb5e40092d5f32c9 () Term)
(declare-fun Vector.uu___is_VNil@tok () Term)

; </end encoding val Vector.uu___is_VNil>


; encoding sigelt let uu___is_VNil


; <Skipped let uu___is_VNil/>


; encoding sigelt val Vector.uu___is_VCons


; <Start encoding val Vector.uu___is_VCons>

(declare-fun Vector.uu___is_VCons (Term Term Term) Term)

(declare-fun Vector.uu___is_VCons@tok () Term)

; </end encoding val Vector.uu___is_VCons>


; encoding sigelt let uu___is_VCons


; <Skipped let uu___is_VCons/>


; encoding sigelt val Vector.__proj__VCons__item__hd


; <Start encoding val Vector.__proj__VCons__item__hd>

(declare-fun Tm_refine_a4e93483662b42a2216eccfd8e27a9c0 (Term Term) Term)
(declare-fun Vector.__proj__VCons__item__hd (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vector 'a _ {VCons? _} -> 'a
(declare-fun Tm_arrow_7d63beb6f0895ada9d3f6cbd68c1f8e6 () Term)
(declare-fun Vector.__proj__VCons__item__hd@tok () Term)

; </end encoding val Vector.__proj__VCons__item__hd>
...
:named unit_inversion))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Vector.uu___is_VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
...
(Vector.vector @x0
@x1)))
(HasType (Vector.uu___is_VCons @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Vector.uu___is_VCons @x0
@x1
@x2))
:qid typing_Vector.uu___is_VCons))

:named typing_Vector.uu___is_VCons))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (HasType Prims.unit
Prims.eqtype)
...
:named refinement_kinding_Tm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Vector.__proj__VCons__item__hd; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_a4e93483662b42a2216eccfd8e27a9c0 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_a4e93483662b42a2216eccfd8e27a9c0 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_a4e93483662b42a2216eccfd8e27a9c0))

:named refinement_kinding_Tm_refine_a4e93483662b42a2216eccfd8e27a9c0))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! (HasType Tm_refine_774ba3f728d91ead8ef40be66c9802e5
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a4e93483662b42a2216eccfd8e27a9c0 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Vector.vector @x2
...
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
(BoxBool_proj_0 (Vector.uu___is_VCons @x2
@x3
@x1))
))
...
(Tm_refine_a4e93483662b42a2216eccfd8e27a9c0 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_a4e93483662b42a2216eccfd8e27a9c0))

:named refinement_interpretation_Tm_refine_a4e93483662b42a2216eccfd8e27a9c0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
;; def=Prims.fst(683,11-683,24); use=Prims.fst(683,11-683,24)
...
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a4e93483662b42a2216eccfd8e27a9c0
;;; Fact-ids: Name Vector.__proj__VCons__item__hd; Namespace Vector
(assert (! 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a4e93483662b42a2216eccfd8e27a9c0 @x0
@x1)))
(Valid (Prims.hasEq (Vector.vector @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a4e93483662b42a2216eccfd8e27a9c0 @x0
@x1))))
:qid haseqTm_refine_a4e93483662b42a2216eccfd8e27a9c0))

:named haseqTm_refine_a4e93483662b42a2216eccfd8e27a9c0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_774ba3f728d91ead8ef40be66c9802e5
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_774ba3f728d91ead8ef40be66c9802e5))
(Valid (Prims.hasEq Prims.int)))
...
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,4-21,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Vector.uu___is_VCons @x0
@x1
@x2)
(BoxBool (is-Vector.VCons @x2)))
 

:pattern ((Vector.uu___is_VCons @x0
@x1
@x2))
:qid disc_equation_Vector.VCons))

:named disc_equation_Vector.VCons))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
;;;;;;;;;;;;;;;;Assumption: Vector.vector__uu___haseq
;;; Fact-ids: Name Vector.vector__uu___haseq; Namespace Vector
...
:pattern ((Prims.hasEq (Vector.vector @x0
@x1)))
:qid assumption_Vector.vector__uu___haseq))
:named assumption_Vector.vector__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Vector.vector; Namespace Vector; Name Vector.VNil; Namespace Vector; Name Vector.VCons; Namespace Vector
(assert (! 
;; def=Vector.fst(19,5-19,11); use=Vector.fst(19,5-19,11)
...
; Starting query at Vector.fst(21,12-21,14)

(declare-fun label_1 () Bool)


; Encoding query formula : forall ('a: Type) (_: Prims.nat) (projectee: _: Vector.vector 'a _ {VCons? _}).
;   (*  - Could not prove post-condition
; *) ~(VCons? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__VCons__item__hd`
...
Prims.nat)
(HasType @x2
(Tm_refine_a4e93483662b42a2216eccfd8e27a9c0 @x0
@x1))

;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,12-21,14)
(not 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(21,12-21,14)
(BoxBool_proj_0 (Vector.uu___is_VCons @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Vector.__proj__VCons__item__hd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_a4e93483662b42a2216eccfd8e27a9c0
...
; encoding sigelt let __proj__VCons__item__hd


; <Skipped let __proj__VCons__item__hd/>


; encoding sigelt val Vector.__proj__VCons__item__n


; <Start encoding val Vector.__proj__VCons__item__n>


(declare-fun Vector.__proj__VCons__item__n (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vector 'a _ {VCons? _} -> Prims.nat
(declare-fun Tm_arrow_2730117b028cdfcf69182b12ecf17181 () Term)
(declare-fun Vector.__proj__VCons__item__n@tok () Term)

; </end encoding val Vector.__proj__VCons__item__n>

(push) ;; push{2

; Starting query at Vector.fst(22,13-22,14)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__VCons__item__n`
...
;; def=Vector.fst(21,4-21,9); use=Vector.fst(22,13-22,14)
(not 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(22,13-22,14)
(BoxBool_proj_0 (Vector.uu___is_VCons @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Vector.__proj__VCons__item__n, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_a4e93483662b42a2216eccfd8e27a9c0
...
; encoding sigelt let __proj__VCons__item__n


; <Skipped let __proj__VCons__item__n/>


; encoding sigelt val Vector.__proj__VCons__item__tl


; <Start encoding val Vector.__proj__VCons__item__tl>


(declare-fun Vector.__proj__VCons__item__tl (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: vector 'a _ {VCons? _} -> vector 'a projectee.n
(declare-fun Tm_arrow_71a97d82e0aec251af7a44616f99503d () Term)
(declare-fun Vector.__proj__VCons__item__tl@tok () Term)

; </end encoding val Vector.__proj__VCons__item__tl>

(push) ;; push{2

; Starting query at Vector.fst(23,12-23,14)
...
; *)
;   (~(VCons? projectee) ==> Prims.l_False) /\
;   (forall (b: 'a) (b: Prims.nat) (b: Vector.vector 'a b).
;       projectee == Vector.VCons b b ==> b + 1 == _ /\ VCons? (Vector.VCons b b))


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__VCons__item__tl`
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(23,12-23,14)
(and (implies 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(23,12-23,14)
(not 
;; def=Vector.fst(21,4-21,9); use=Vector.fst(23,12-23,14)
(BoxBool_proj_0 (Vector.uu___is_VCons @x0
@x1
...
;; def=Prims.fst(413,99-413,120); use=Vector.fst(23,12-23,14)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x0)
...
;; def=dummy(0,0-0,0); use=Vector.fst(23,12-23,14)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Vector.__proj__VCons__item__tl, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Vector.VCons, refinement_interpretation_Tm_refine_a4e93483662b42a2216eccfd8e27a9c0
...
; encoding sigelt let __proj__VCons__item__tl


; <Skipped let __proj__VCons__item__tl/>
...
; Starting query at Vector.fst(26,0-26,50)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (n: Prims.pos).
;   (*  - Subtyping check failed
...
; Context: While encoding a query
; While typechecking the top-level declaration `val Vector.head`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Vector.fst(26,0-26,50)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=Prims.fst(683,18-683,23); use=Vector.fst(26,40-26,41)
(> (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (BoxInt 0)))
)

;; def=Prims.fst(680,18-680,24); use=Vector.fst(26,40-26,41)
(or label_1
...
; encoding sigelt val Vector.head


; <Skipped val Vector.head/>

(push) ;; push{2

; Starting query at Vector.fst(27,19-28,19)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (n: Prims.pos) (v: Vector.vector a n).
;   (*  - Could not prove post-condition
; *) ~(VCons? v) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let head`
...
;; def=Vector.fst(27,15-27,16); use=Vector.fst(27,25-27,26)
(not 
;; def=Vector.fst(27,15-27,16); use=Vector.fst(27,25-27,26)
(BoxBool_proj_0 (Vector.uu___is_VCons @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Vector.head, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Vector.VCons, equation_Prims.pos, fuel_guarded_inversion_Vector.vector, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5
...
; Starting query at Vector.fst(27,0-28,19)
...
;; def=Prims.fst(683,18-683,23); use=Vector.fst(27,19-28,19)
(> (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (BoxInt 0)))
)

;; def=Prims.fst(680,18-680,24); use=Vector.fst(27,13-27,14)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Vector.fst(27,19-28,19)
(>= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
; encoding sigelt let head


; <Start encoding let head>

(declare-fun Vector.head (Term Term Term) Term)
;;;;;;;;;;;;;;;;v: vector a n -> a
(declare-fun Tm_arrow_dad70d650456b08bc3f4b8929f17a9c2 () Term)
(declare-fun Vector.head@tok () Term)

; </end encoding let head>


; encoding sigelt val Vector.nth


; <Skipped val Vector.nth/>
...
; Starting query at Vector.fst(32,2-34,23)
...
;;;;;;;;;;;;;;;;m : m: Prims.nat{m > n} (m: Prims.nat{m > n})
(declare-fun x_dea256e7a41198c89ed07f42894c7b2b_3 () Term)
(declare-fun Tm_refine_cd73fa2255f8011c45dec35de340a3ae () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_cd73fa2255f8011c45dec35de340a3ae
Tm_type)
:named refinement_kinding_Tm_refine_cd73fa2255f8011c45dec35de340a3ae))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(30,19-30,32); use=Vector.fst(31,8-31,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_cd73fa2255f8011c45dec35de340a3ae)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=Vector.fst(30,26-30,31); use=Vector.fst(31,8-31,11)
(> (BoxInt_proj_0 @x1)
(BoxInt_proj_0 x_bb4e1c9af0265270f8e7a5f250f730e2_2))
))
...
@x1
Tm_refine_cd73fa2255f8011c45dec35de340a3ae))
:qid refinement_interpretation_Tm_refine_cd73fa2255f8011c45dec35de340a3ae))

:named refinement_interpretation_Tm_refine_cd73fa2255f8011c45dec35de340a3ae))
;;;;;;;;;;;;;;;;haseq for Tm_refine_cd73fa2255f8011c45dec35de340a3ae
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_cd73fa2255f8011c45dec35de340a3ae))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_cd73fa2255f8011c45dec35de340a3ae))
;;;;;;;;;;;;;;;;binder_x_dea256e7a41198c89ed07f42894c7b2b_3
;;; Fact-ids: 
(assert (! (HasType x_dea256e7a41198c89ed07f42894c7b2b_3
Tm_refine_cd73fa2255f8011c45dec35de340a3ae)
:named binder_x_dea256e7a41198c89ed07f42894c7b2b_3))
;;;;;;;;;;;;;;;;uu___ : Vector.vector 'a m (Vector.vector 'a m)
(declare-fun x_21c13f6456e3f350b125d9f794dd3770_4 () Term)
;;;;;;;;;;;;;;;;binder_x_21c13f6456e3f350b125d9f794dd3770_4
;;; Fact-ids: 
(assert (! (HasType x_21c13f6456e3f350b125d9f794dd3770_4
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3))
:named binder_x_21c13f6456e3f350b125d9f794dd3770_4))
...
;; def=Vector.fst(30,19-30,32); use=Vector.fst(31,8-31,11)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d))

:named refinement_kinding_Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(30,19-30,32); use=Vector.fst(31,8-31,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
@x1
(Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d @x2)))
:qid refinement_interpretation_Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d))

:named refinement_interpretation_Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(30,19-30,32); use=Vector.fst(31,8-31,11)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d @x0))))
:qid haseqTm_refine_2b9cd3e1fbccf82e9ebe34941f00564d))

:named haseqTm_refine_2b9cd3e1fbccf82e9ebe34941f00564d))
(declare-fun Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(30,10-34,23); use=Vector.fst(30,10-34,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e))

:named refinement_kinding_Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(30,10-34,23); use=Vector.fst(30,10-34,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Vector.fst(30,10-34,23); use=Vector.fst(30,10-34,23)
(or 
;; def=Vector.fst(32,2-34,23); use=Vector.fst(32,2-34,23)
(Valid 
;; def=Vector.fst(32,2-34,23); use=Vector.fst(32,2-34,23)
...
;; def=Vector.fst(30,10-34,23); use=Vector.fst(30,10-34,23)
(and 
;; def=Vector.fst(30,10-31,13); use=Vector.fst(30,10-31,13)
(Valid 
;; def=Vector.fst(30,10-31,13); use=Vector.fst(30,10-31,13)
...
;; def=Vector.fst(30,20-34,23); use=Vector.fst(30,20-34,23)
(or 
;; def=Vector.fst(32,2-34,23); use=Vector.fst(32,2-34,23)
(Valid 
;; def=Vector.fst(32,2-34,23); use=Vector.fst(32,2-34,23)
...
;; def=Vector.fst(30,20-34,23); use=Vector.fst(30,20-34,23)
(and 
;; def=Vector.fst(30,20-31,16); use=Vector.fst(30,20-31,16)
(Valid 
;; def=Vector.fst(30,20-31,16); use=Vector.fst(30,20-31,16)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=Vector.fst(32,2-34,23); use=Vector.fst(32,2-34,23)
(Prims.precedes (Vector.vector @x4
@x3)
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3)
@x1
x_21c13f6456e3f350b125d9f794dd3770_4)
)
)
)
)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e))

:named refinement_interpretation_Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(30,10-34,23); use=Vector.fst(30,10-34,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e @x0
@x1
@x2)))
(Valid (Prims.hasEq (Vector.vector @x2
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e @x0
@x1
@x2))))
:qid haseqTm_refine_3a2c2d54c384f80841908c46ce3a2b2e))

:named haseqTm_refine_3a2c2d54c384f80841908c46ce3a2b2e))
(declare-fun Vector.nth (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;n: Prims.nat -> _: _: vector 'a m {n << n \/ n === n /\ (m << m \/ m === m /\ _ << _)} -> 'a
(declare-fun Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a
Tm_type)
:named kinding_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(30,10-34,23); use=Vector.fst(30,10-34,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a))
:qid Vector_pre_typing_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a))

:named Vector_pre_typing_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(30,10-34,23); use=Vector.fst(30,10-34,23)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid Vector_interpretation_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a.2))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a.3))
...
@x2)
@x3))
:qid Vector_interpretation_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a))
:qid Vector_interpretation_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a))

:named Vector_interpretation_Tm_arrow_4aa31fcaad67be4fc8b6ed7a4fa8150a))
(declare-fun Vector.nth@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(31,8-31,11); use=Vector.fst(31,8-31,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.nth@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.nth@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Vector.nth))

:named token_correspondence_Vector.nth))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(31,8-31,11); use=Vector.fst(31,8-31,11)
...
:pattern ((Vector.nth @x1
@x2
@x3
@x4))
:qid function_token_typing_Vector.nth.1))
)
 

:pattern ((ApplyTT @x0
Vector.nth@tok))
:qid function_token_typing_Vector.nth))

:named function_token_typing_Vector.nth))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(31,8-31,11); use=Vector.fst(31,8-31,11)
...
Prims.nat)
(HasType @x2
(Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d @x1))
(HasType @x3
(Tm_refine_3a2c2d54c384f80841908c46ce3a2b2e @x1
@x2
@x0)))
(HasType (Vector.nth @x0
@x1
@x2
@x3)
@x0))
...
:pattern ((Vector.nth @x0
@x1
@x2
@x3))
:qid typing_Vector.nth))

:named typing_Vector.nth))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : (~(VCons? _) ==> Prims.l_False) /\
; (forall (b: 'a) (b: Prims.nat) (b: Vector.vector 'a b).
;     _ == Vector.VCons b b ==>
...
;                     b == any_result ==> n - 1 << n \/ n - 1 === n /\ (b << m \/ b === m /\ b << _)))
;         )))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec nth`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(459,77-459,89); use=Vector.fst(32,2-34,23)
(and (implies 
;; def=Vector.fst(31,18-31,32); use=Vector.fst(32,2-34,23)
(not 
;; def=Vector.fst(31,18-31,32); use=Vector.fst(32,2-34,23)
(BoxBool_proj_0 (Vector.uu___is_VCons x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3
x_21c13f6456e3f350b125d9f794dd3770_4))
)
...
;; def=Prims.fst(413,99-413,120); use=Vector.fst(32,2-34,23)
(forall ((@x0 Term))
 (! (implies (HasType @x0
...
;; def=Vector.fst(31,18-31,32); use=Vector.fst(32,2-34,23)
(= x_21c13f6456e3f350b125d9f794dd3770_4
(Vector.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x0
@x1
@x2))
)
...
;; def=Prims.fst(402,27-402,88); use=Vector.fst(32,2-34,23)
(forall ((@x4 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(32,2-34,23)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(32,2-34,23)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(389,19-389,21); use=Vector.fst(32,2-34,23)
(not 
;; def=Vector.fst(32,5-32,10); use=Vector.fst(32,5-32,10)
...
;; def=Vector.fst(32,5-34,23); use=Vector.fst(32,5-34,23)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_2
(BoxInt 0))
@x4)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(32,2-34,23)
(and 
;; def=Prims.fst(680,18-680,24); use=Vector.fst(34,11-34,16)
(or label_2

;; def=Prims.fst(680,18-680,24); use=Vector.fst(34,11-34,16)
(>= (BoxInt_proj_0 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_2
(BoxInt 1)))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=Prims.fst(356,2-356,58); use=Vector.fst(32,2-34,23)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Vector.fst(32,2-34,23)
(= @x5
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_2
(BoxInt 1)))
)

;; def=Prims.fst(459,77-459,89); use=Vector.fst(32,2-34,23)
(and 
;; def=Vector.fst(30,26-30,31); use=Vector.fst(34,18-34,20)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=Vector.fst(32,2-34,23)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=Vector.fst(30,20-31,29); use=Vector.fst(32,2-34,23)
(= @x1
@x6)
)

;; def=Vector.fst(30,10-34,23); use=Vector.fst(34,21-34,23)
(or label_4

;; def=Vector.fst(32,2-34,23); use=Vector.fst(34,21-34,23)
(Valid 
;; def=Vector.fst(32,2-34,23); use=Vector.fst(34,21-34,23)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(30,10-34,23); use=Vector.fst(34,21-34,23)
(and 
;; def=Vector.fst(30,10-31,13); use=Vector.fst(34,21-34,23)
(Valid 
;; def=Vector.fst(30,10-31,13); use=Vector.fst(34,21-34,23)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Vector.fst(30,20-34,23); use=Vector.fst(34,21-34,23)
(or 
;; def=Vector.fst(32,2-34,23); use=Vector.fst(34,21-34,23)
(Valid 
;; def=Vector.fst(32,2-34,23); use=Vector.fst(34,21-34,23)
...
;; def=Vector.fst(30,20-34,23); use=Vector.fst(34,21-34,23)
(and 
;; def=Vector.fst(30,20-31,16); use=Vector.fst(34,21-34,23)
(Valid 
;; def=Vector.fst(30,20-31,16); use=Vector.fst(34,21-34,23)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=Vector.fst(32,2-34,23); use=Vector.fst(34,21-34,23)
(Prims.precedes (Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
@x1)
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_dea256e7a41198c89ed07f42894c7b2b_3)
@x2
...
; encoding sigelt let rec nth


; <Start encoding let rec nth>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Vector.nth.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Vector.nth.fuel_instrumented_token () Term)
(declare-fun Vector.nth (Term Term Term Term) Term)
(declare-fun Vector.nth@tok () Term)
(declare-fun Tm_refine_2b9cd3e1fbccf82e9ebe34941f00564d (Term) Term)


;;;;;;;;;;;;;;;;n: Prims.nat -> _: vector 'a m -> 'a
(declare-fun Tm_arrow_b4625f143d37a5a61c9831eea7d29c85 () Term)

; </end encoding let rec nth>

(push) ;; push{2

; Starting query at Vector.fst(36,0-36,102)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (n1: Prims.nat) (n2: Prims.nat) (l: Vector.vector a n1) (_: Vector.vector a n2).
;   (*  - Subtyping check failed
;   - Expected type Prims.nat got type Prims.int
; *) n1 + n2 >= 0
...
; Context: While encoding a query
; While typechecking the top-level declaration `val Vector.append`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Vector.fst(36,0-36,102)
...
;; def=Prims.fst(680,18-680,24); use=Vector.fst(36,92-36,101)
(or label_1
...
; encoding sigelt val Vector.append


; <Skipped val Vector.append/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Vector.uu___is_VNil; Namespace Vector
(assert (! 
;; def=Vector.fst(20,4-20,8); use=Vector.fst(20,4-20,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(Vector.vector @x0
@x1)))
(HasType (Vector.uu___is_VNil @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Vector.uu___is_VNil @x0
@x1
@x2))
:qid typing_Vector.uu___is_VNil))

:named typing_Vector.uu___is_VNil))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Vector.uu___is_VNil; Namespace Vector
(assert (! 
;; def=Vector.fst(20,4-20,8); use=Vector.fst(20,4-20,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Vector.uu___is_VNil @x0
@x1
@x2)
(BoxBool (is-Vector.VNil @x2)))
 

:pattern ((Vector.uu___is_VNil @x0
@x1
@x2))
:qid disc_equation_Vector.VNil))

:named disc_equation_Vector.VNil))
(push) ;; push{2

; Starting query at Vector.fst(38,2-40,44)
...
;;;;;;;;;;;;;;;;v1 : Vector.vector a n1 (Vector.vector a n1)
(declare-fun x_2ca789102088f52029182cc0ebc25e49_4 () Term)
;;;;;;;;;;;;;;;;binder_x_2ca789102088f52029182cc0ebc25e49_4
;;; Fact-ids: 
(assert (! (HasType x_2ca789102088f52029182cc0ebc25e49_4
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2))
:named binder_x_2ca789102088f52029182cc0ebc25e49_4))
;;;;;;;;;;;;;;;;v2 : Vector.vector a n2 (Vector.vector a n2)
(declare-fun x_1fd74c304e163c0d8adcb88881fe80b8_5 () Term)
;;;;;;;;;;;;;;;;binder_x_1fd74c304e163c0d8adcb88881fe80b8_5
;;; Fact-ids: 
(assert (! (HasType x_1fd74c304e163c0d8adcb88881fe80b8_5
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_3))
:named binder_x_1fd74c304e163c0d8adcb88881fe80b8_5))
(declare-fun Tm_refine_0742df68e9d0f118a0770643bfad7fba (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(36,24-40,44); use=Vector.fst(36,24-40,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_0742df68e9d0f118a0770643bfad7fba @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_0742df68e9d0f118a0770643bfad7fba @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_0742df68e9d0f118a0770643bfad7fba))

:named refinement_kinding_Tm_refine_0742df68e9d0f118a0770643bfad7fba))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(36,24-40,44); use=Vector.fst(36,24-40,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_0742df68e9d0f118a0770643bfad7fba @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Vector.fst(36,24-40,44); use=Vector.fst(36,24-40,44)
(or 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(38,2-40,44)
(Valid 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(38,2-40,44)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(36,24-40,44); use=Vector.fst(36,24-40,44)
(and 
;; def=Vector.fst(36,24-37,21); use=Vector.fst(36,24-37,21)
(Valid 
;; def=Vector.fst(36,24-37,21); use=Vector.fst(36,24-37,21)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Vector.fst(36,35-40,44); use=Vector.fst(36,35-40,44)
(or 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(38,2-40,44)
(Valid 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(38,2-40,44)
...
;; def=Vector.fst(36,35-40,44); use=Vector.fst(36,35-40,44)
(and 
;; def=Vector.fst(36,35-37,25); use=Vector.fst(36,35-37,25)
(Valid 
;; def=Vector.fst(36,35-37,25); use=Vector.fst(36,35-37,25)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Vector.fst(36,45-40,44); use=Vector.fst(36,45-40,44)
(or 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(38,2-40,44)
(Valid 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(38,2-40,44)
...
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x5
x_2ca789102088f52029182cc0ebc25e49_4)
)


;; def=Vector.fst(36,45-40,44); use=Vector.fst(36,45-40,44)
(and 
;; def=Vector.fst(36,45-37,28); use=Vector.fst(36,45-37,28)
(Valid 
;; def=Vector.fst(36,45-37,28); use=Vector.fst(36,45-37,28)
(Prims.op_Equals_Equals_Equals (Vector.vector @x4
@x2)
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x5
...
x_bb4e1c9af0265270f8e7a5f250f730e2_3)
@x1
x_1fd74c304e163c0d8adcb88881fe80b8_5)
)
)
)
)
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_0742df68e9d0f118a0770643bfad7fba))

:named refinement_interpretation_Tm_refine_0742df68e9d0f118a0770643bfad7fba))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0742df68e9d0f118a0770643bfad7fba
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(36,24-40,44); use=Vector.fst(36,24-40,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_0742df68e9d0f118a0770643bfad7fba @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (Vector.vector @x2
...
:pattern ((Valid (Prims.hasEq (Tm_refine_0742df68e9d0f118a0770643bfad7fba @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_0742df68e9d0f118a0770643bfad7fba))

:named haseqTm_refine_0742df68e9d0f118a0770643bfad7fba))
(declare-fun Vector.append (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;l: vector a n1 ->     _:       _:       vector a n2         {n1 << n1 \/ n1 === n1 /\ (n2 << n2 \/ n2 === n2 /\ (l << v1 \/ l === v1 /\ _ << v2))}   -> vector a (n1 + n2)
(declare-fun Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50
Tm_type)
:named kinding_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(36,15-40,44); use=Vector.fst(36,24-40,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50))
:qid Vector_pre_typing_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50))

:named Vector_pre_typing_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(36,15-40,44); use=Vector.fst(36,24-40,44)
(forall ((@x0 Term))
...
@x4)
@x5))
:qid Vector_interpretation_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50.2))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50.3))
...
@x2)
@x3))
:qid Vector_interpretation_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50.4))
...
@x3)
@x4))
:qid Vector_interpretation_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50.5))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50))
:qid Vector_interpretation_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50))

:named Vector_interpretation_Tm_arrow_4ca7209cd63dea154ea77e00bc7e6b50))
(declare-fun Vector.append@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(37,8-37,14); use=Vector.fst(37,8-37,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.append@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.append@tok
@x0)
@x1)
@x2)
@x3)
@x4))
:qid token_correspondence_Vector.append))

:named token_correspondence_Vector.append))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(37,8-37,14); use=Vector.fst(37,8-37,14)
...
:pattern ((Vector.append @x1
@x2
@x3
@x4
@x5))
:qid function_token_typing_Vector.append.1))
)
 

:pattern ((ApplyTT @x0
Vector.append@tok))
:qid function_token_typing_Vector.append))

:named function_token_typing_Vector.append))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(37,8-37,14); use=Vector.fst(37,8-37,14)
...
@x1))
(HasType @x4
(Tm_refine_0742df68e9d0f118a0770643bfad7fba @x1
@x2
@x0
@x3)))
(HasType (Vector.append @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Vector.append @x0
@x1
@x2
@x3
@x4))
:qid typing_Vector.append))

:named typing_Vector.append))
...
; Encoding query formula : n1 + n2 >= 0 /\
; (forall (k: Prims.pure_post (Vector.vector a (n1 + n2))).
;     (forall (x: Vector.vector a (n1 + n2)). {:pattern Prims.guard_free (k x)}
;         Prims.auto_squash (k x)) ==>
;     (~(VNil? v1) /\ ~(VCons? v1) ==> Prims.l_False) /\
;     (v1 == Vector.VNil ==> n2 == n1 + n2) /\
;     (~(VNil? v1) ==>
;       (forall (b: a) (b: Prims.nat) (b: Vector.vector a b).
;           v1 == Vector.VCons b b ==>
;           b + n2 >= 0 /\
;           (forall (return_val: Prims.nat).
;               return_val == b + n2 ==>
;               (b << n1 \/ b === n1 /\ (n2 << n2 \/ (b << v1 \/ b === v1 /\ v2 << v2))) /\
;               (forall (any_result: Vector.vector a n2).
;                   v2 == any_result ==>
;                   (forall (any_result: Vector.vector a (b + n2)).
;                       Vector.append b v2 == any_result ==>
;                       (forall (any_result: Vector.vector a (b + n2 + 1)).
;                           Vector.VCons b (Vector.append b v2) == any_result ==>
;                           b + n2 + 1 == n1 + n2)))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec append`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(459,77-459,89); use=Vector.fst(38,2-40,44)
(and 
;; def=Prims.fst(680,18-680,24); use=Vector.fst(37,8-37,14)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Vector.fst(38,2-40,44)
(>= (BoxInt_proj_0 (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_2
x_bb4e1c9af0265270f8e7a5f250f730e2_3))
(BoxInt_proj_0 (BoxInt 0)))
)
...
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
(Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_2
x_bb4e1c9af0265270f8e7a5f250f730e2_3))))

;; def=Prims.fst(402,27-402,88); use=Vector.fst(38,2-40,44)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(38,2-40,44)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(38,2-40,44)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(38,2-40,44)
(and (implies 
;; def=Vector.fst(37,26-37,28); use=Vector.fst(38,8-38,10)
(and 
;; def=Vector.fst(37,26-37,28); use=Vector.fst(38,8-38,10)
(not 
;; def=Vector.fst(37,26-37,28); use=Vector.fst(38,8-38,10)
(BoxBool_proj_0 (Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2
x_2ca789102088f52029182cc0ebc25e49_4))
)
...
label_2)
(implies 
;; def=Vector.fst(37,26-39,10); use=Vector.fst(38,8-39,10)
(= x_2ca789102088f52029182cc0ebc25e49_4
(Vector.VNil x_fe28d8bcde588226b4e538b35321de05_1))


;; def=Vector.fst(36,92-37,25); use=Vector.fst(39,14-39,16)
(or label_3
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Vector.fst(38,2-40,44)
(not 
;; def=Vector.fst(37,26-37,28); use=Vector.fst(38,8-38,10)
(BoxBool_proj_0 (Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2
...
;; def=Prims.fst(413,99-413,120); use=Vector.fst(38,2-40,44)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=Vector.fst(37,26-40,17); use=Vector.fst(38,8-40,17)
(= x_2ca789102088f52029182cc0ebc25e49_4
(Vector.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(38,2-40,44)
(and 
;; def=Prims.fst(680,18-680,24); use=Vector.fst(40,31-40,37)
(or label_4
...
;; def=Prims.fst(356,2-356,58); use=Vector.fst(38,2-40,44)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Vector.fst(38,2-40,44)
(= @x4
(Prims.op_Addition @x2
x_bb4e1c9af0265270f8e7a5f250f730e2_3))
)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(38,2-40,44)
(and 
;; def=Vector.fst(36,24-40,44); use=Vector.fst(40,41-40,43)
(or label_5

;; def=Vector.fst(38,2-40,44); use=Vector.fst(40,41-40,43)
(Valid 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(40,41-40,43)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(36,24-40,44); use=Vector.fst(40,41-40,43)
(and 
;; def=Vector.fst(36,24-37,21); use=Vector.fst(40,41-40,43)
(Valid 
;; def=Vector.fst(36,24-37,21); use=Vector.fst(40,41-40,43)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Vector.fst(36,35-40,44); use=Vector.fst(40,41-40,43)
(or 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(40,41-40,43)
(Valid 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(40,41-40,43)
...
;; def=Vector.fst(36,45-40,44); use=Vector.fst(40,41-40,43)
(and 
;; def=Vector.fst(36,45-37,28); use=Vector.fst(40,41-40,43)
(Valid 
;; def=Vector.fst(36,45-37,28); use=Vector.fst(40,41-40,43)
(Prims.op_Equals_Equals_Equals (Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
@x2)
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x3
...
;; def=Prims.fst(451,66-451,102); use=Vector.fst(38,2-40,44)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_3))

;; def=dummy(0,0-0,0); use=Vector.fst(38,2-40,44)
(= x_1fd74c304e163c0d8adcb88881fe80b8_5
@x5)
)
...
;; def=Vector.fst(23,12-40,44); use=Vector.fst(38,2-40,44)
(= (Vector.append x_fe28d8bcde588226b4e538b35321de05_1
@x2
x_bb4e1c9af0265270f8e7a5f250f730e2_3
@x3
x_1fd74c304e163c0d8adcb88881fe80b8_5)
...
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
(Prims.op_Addition (Prims.op_Addition @x2
x_bb4e1c9af0265270f8e7a5f250f730e2_3)
(BoxInt 1))))

;; def=Vector.fst(36,82-40,44); use=Vector.fst(38,2-40,44)
(= (Vector.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x1
(Prims.op_Addition @x2
x_bb4e1c9af0265270f8e7a5f250f730e2_3)
...
;; def=Vector.fst(24,22-36,101); use=Vector.fst(40,21-40,44)
(or label_6
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Vector.append, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_2ca789102088f52029182cc0ebc25e49_4, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_2, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_3, data_elim_Vector.VCons, data_elim_Vector.VNil, disc_equation_Vector.VCons, disc_equation_Vector.VNil, equation_Prims.nat, fuel_guarded_inversion_Vector.vector, int_inversion, int_typing, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; Starting query at Vector.fst(37,0-40,44)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_8a05f321c253bdfe4e1807727f7f78a0 (Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(36,24-40,44); use=Vector.fst(37,0-40,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (HasType (Tm_refine_8a05f321c253bdfe4e1807727f7f78a0 @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_8a05f321c253bdfe4e1807727f7f78a0 @x0
@x1
@x2
@x3
@x4
...
@x8)
Tm_type))
:qid refinement_kinding_Tm_refine_8a05f321c253bdfe4e1807727f7f78a0))

:named refinement_kinding_Tm_refine_8a05f321c253bdfe4e1807727f7f78a0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(36,24-40,44); use=Vector.fst(37,0-40,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8a05f321c253bdfe4e1807727f7f78a0 @x2
@x3
@x4
@x5
@x6
...
;; def=Vector.fst(36,24-40,44); use=Vector.fst(37,0-40,44)
(and 
;; def=Vector.fst(36,24-37,21); use=Vector.fst(37,0-40,44)
(Valid 
;; def=Vector.fst(36,24-37,21); use=Vector.fst(37,0-40,44)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Vector.fst(36,35-40,44); use=Vector.fst(37,0-40,44)
(or 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(38,2-40,44)
(Valid 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(38,2-40,44)
...
;; def=Vector.fst(36,35-40,44); use=Vector.fst(37,0-40,44)
(and 
;; def=Vector.fst(36,35-37,25); use=Vector.fst(37,0-40,44)
(Valid 
;; def=Vector.fst(36,35-37,25); use=Vector.fst(37,0-40,44)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Vector.fst(36,45-40,44); use=Vector.fst(37,0-40,44)
(or 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(38,2-40,44)
(Valid 
;; def=Vector.fst(38,2-40,44); use=Vector.fst(38,2-40,44)
(Prims.precedes (Vector.vector @x6
@x2)
(Vector.vector @x7
@x3)
@x8
...
;; def=Vector.fst(36,45-40,44); use=Vector.fst(37,0-40,44)
(and 
;; def=Vector.fst(36,45-37,28); use=Vector.fst(37,0-40,44)
(Valid 
;; def=Vector.fst(36,45-37,28); use=Vector.fst(37,0-40,44)
(Prims.op_Equals_Equals_Equals (Vector.vector @x6
@x2)
(Vector.vector @x7
@x3)
@x8
...
@x9
@x10)))
:qid refinement_interpretation_Tm_refine_8a05f321c253bdfe4e1807727f7f78a0))

:named refinement_interpretation_Tm_refine_8a05f321c253bdfe4e1807727f7f78a0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8a05f321c253bdfe4e1807727f7f78a0
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(36,24-40,44); use=Vector.fst(37,0-40,44)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8a05f321c253bdfe4e1807727f7f78a0 @x0
@x1
@x2
@x3
@x4
...
@x7
@x8)))
(Valid (Prims.hasEq (Vector.vector @x4
@x2))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8a05f321c253bdfe4e1807727f7f78a0 @x0
@x1
@x2
@x3
@x4
...
@x7
@x8))))
:qid haseqTm_refine_8a05f321c253bdfe4e1807727f7f78a0))

:named haseqTm_refine_8a05f321c253bdfe4e1807727f7f78a0))

; Encoding query formula : forall (a: Type) (n1: Prims.nat) (n2: Prims.nat) (v1: Vector.vector a n1) (v2: Vector.vector a n2)
;   (a: Type) (n1: Prims.nat) (n2: Prims.nat) (l: Vector.vector a n1)
;   (_:
;   _:
;   Vector.vector a n2
;     {n1 << n1 \/ n1 === n1 /\ (n2 << n2 \/ n2 === n2 /\ (l << v1 \/ l === v1 /\ _ << v2))}).
;   (*  - Subtyping check failed
;   - Expected type Prims.nat got type Prims.int
; *) n1 + n2 >= 0
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Vector.fst(37,0-40,44)
...
@x6))
(HasType @x9
(Tm_refine_8a05f321c253bdfe4e1807727f7f78a0 @x6
@x1
@x7
@x2
@x5
...
; encoding sigelt let rec append


; <Start encoding let rec append>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Vector.append.fuel_instrumented (Fuel Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Vector.append.fuel_instrumented_token () Term)
(declare-fun Vector.append (Term Term Term Term Term) Term)
(declare-fun Vector.append@tok () Term)
;;;;;;;;;;;;;;;;l: vector a n1 -> v2: vector a n2 -> vector a (n1 + n2)
(declare-fun Tm_arrow_3c4caa4aa8b5529c0be0beb60aa2949c () Term)

; </end encoding let rec append>


; encoding sigelt val Vector.reverse


; <Skipped val Vector.reverse/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Vector.append; Namespace Vector
(assert (! 
;; def=Vector.fst(37,8-37,14); use=Vector.fst(37,8-37,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
...
(Vector.vector @x1
@x3)))
(HasType (Vector.append.fuel_instrumented @u0
@x1
@x2
@x3
@x4
...
:pattern ((Vector.append.fuel_instrumented @u0
@x1
@x2
@x3
@x4
@x5))
:qid token_correspondence_Vector.append.fuel_instrumented))

:named token_correspondence_Vector.append.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Vector.append
;;; Fact-ids: Name Vector.append; Namespace Vector
(assert (! 
;; def=Vector.fst(37,8-37,14); use=Vector.fst(37,8-37,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
...
(Vector.vector @x1
@x3)))
(= (Vector.append.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4
@x5)
(let ((@lb6 @x4))
(ite (is-Vector.VNil @lb6)
@x5
(ite (is-Vector.VCons @lb6)
(Vector.VCons @x1
(Vector.VCons_hd @lb6)
(Prims.op_Addition (Vector.VCons_n @lb6)
@x3)
(Vector.append.fuel_instrumented @u0
@x1
(Vector.VCons_n @lb6)
@x3
(Vector.VCons_tl @lb6)
...
:pattern ((Vector.append.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3
@x4
@x5))
:qid equation_with_fuel_Vector.append.fuel_instrumented))

:named equation_with_fuel_Vector.append.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Vector.append; Namespace Vector
(assert (! 
;; def=Vector.fst(37,8-37,14); use=Vector.fst(37,8-37,14)
...
@x4
@x5)
(Vector.append.fuel_instrumented ZFuel
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid @fuel_irrelevance_Vector.append.fuel_instrumented))

:named @fuel_irrelevance_Vector.append.fuel_instrumented))
...
@x3
@x4)
(Vector.append.fuel_instrumented MaxFuel
@x0
@x1
@x2
@x3
...
@x3
@x4))
:qid @fuel_correspondence_Vector.append.fuel_instrumented))

:named @fuel_correspondence_Vector.append.fuel_instrumented))
(push) ;; push{2

; Starting query at Vector.fst(43,26-45,54)
...
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_2))
;;;;;;;;;;;;;;;;v : Vector.vector a n (Vector.vector a n)
(declare-fun x_2ca789102088f52029182cc0ebc25e49_3 () Term)
;;;;;;;;;;;;;;;;binder_x_2ca789102088f52029182cc0ebc25e49_3
;;; Fact-ids: 
(assert (! (HasType x_2ca789102088f52029182cc0ebc25e49_3
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2))
:named binder_x_2ca789102088f52029182cc0ebc25e49_3))
(declare-fun Tm_refine_ca21583d8e05bdf6362794e3bdca178d (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(42,25-45,54); use=Vector.fst(42,25-45,54)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_ca21583d8e05bdf6362794e3bdca178d @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_ca21583d8e05bdf6362794e3bdca178d @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_ca21583d8e05bdf6362794e3bdca178d))

:named refinement_kinding_Tm_refine_ca21583d8e05bdf6362794e3bdca178d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(42,25-45,54); use=Vector.fst(42,25-45,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ca21583d8e05bdf6362794e3bdca178d @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Vector.vector @x3
...
;; def=Vector.fst(42,25-45,54); use=Vector.fst(42,25-45,54)
(or 
;; def=Vector.fst(43,26-45,54); use=Vector.fst(43,26-45,54)
(Valid 
;; def=Vector.fst(43,26-45,54); use=Vector.fst(43,26-45,54)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(42,25-45,54); use=Vector.fst(42,25-45,54)
(and 
;; def=Vector.fst(42,25-43,21); use=Vector.fst(42,25-43,21)
(Valid 
;; def=Vector.fst(42,25-43,21); use=Vector.fst(42,25-43,21)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=Vector.fst(43,26-45,54); use=Vector.fst(43,26-45,54)
(Prims.precedes (Vector.vector @x3
@x2)
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2)
@x1
x_2ca789102088f52029182cc0ebc25e49_3)
)
)
)
...
(Tm_refine_ca21583d8e05bdf6362794e3bdca178d @x2
@x3)))
:qid refinement_interpretation_Tm_refine_ca21583d8e05bdf6362794e3bdca178d))

:named refinement_interpretation_Tm_refine_ca21583d8e05bdf6362794e3bdca178d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ca21583d8e05bdf6362794e3bdca178d
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(42,25-45,54); use=Vector.fst(42,25-45,54)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ca21583d8e05bdf6362794e3bdca178d @x0
@x1)))
(Valid (Prims.hasEq (Vector.vector @x1
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ca21583d8e05bdf6362794e3bdca178d @x0
@x1))))
:qid haseqTm_refine_ca21583d8e05bdf6362794e3bdca178d))

:named haseqTm_refine_ca21583d8e05bdf6362794e3bdca178d))
(declare-fun Vector.reverse (Term Term Term) Term)

;;;;;;;;;;;;;;;;_: _: vector a n {n << n \/ n === n /\ _ << v} -> vector a n
(declare-fun Tm_arrow_14e85b7f262233a9ca84f7daa5705581 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_14e85b7f262233a9ca84f7daa5705581
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_14e85b7f262233a9ca84f7daa5705581
Tm_type)
:named kinding_Tm_arrow_14e85b7f262233a9ca84f7daa5705581))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(42,16-45,54); use=Vector.fst(42,25-45,54)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_14e85b7f262233a9ca84f7daa5705581)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_14e85b7f262233a9ca84f7daa5705581))
:qid Vector_pre_typing_Tm_arrow_14e85b7f262233a9ca84f7daa5705581))

:named Vector_pre_typing_Tm_arrow_14e85b7f262233a9ca84f7daa5705581))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_14e85b7f262233a9ca84f7daa5705581
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(42,16-45,54); use=Vector.fst(42,25-45,54)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid Vector_interpretation_Tm_arrow_14e85b7f262233a9ca84f7daa5705581.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_14e85b7f262233a9ca84f7daa5705581.2))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_14e85b7f262233a9ca84f7daa5705581.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_14e85b7f262233a9ca84f7daa5705581))
:qid Vector_interpretation_Tm_arrow_14e85b7f262233a9ca84f7daa5705581))

:named Vector_interpretation_Tm_arrow_14e85b7f262233a9ca84f7daa5705581))
(declare-fun Vector.reverse@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(43,8-43,15); use=Vector.fst(43,8-43,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Vector.reverse@tok
@x0)
@x1)
@x2)
(Vector.reverse @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Vector.reverse@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Vector.reverse))

:named token_correspondence_Vector.reverse))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(43,8-43,15); use=Vector.fst(43,8-43,15)
...
:pattern ((Vector.reverse @x1
@x2
@x3))
:qid function_token_typing_Vector.reverse.1))
)
 

:pattern ((ApplyTT @x0
Vector.reverse@tok))
:qid function_token_typing_Vector.reverse))

:named function_token_typing_Vector.reverse))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(43,8-43,15); use=Vector.fst(43,8-43,15)
...
Prims.nat)
(HasType @x2
(Tm_refine_ca21583d8e05bdf6362794e3bdca178d @x1
@x0)))
(HasType (Vector.reverse @x0
@x1
@x2)
(Vector.vector @x0
@x1)))
...
:pattern ((Vector.reverse @x0
@x1
@x2))
:qid typing_Vector.reverse))

:named typing_Vector.reverse))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (Vector.vector a n)).
;   (forall (x: Vector.vector a n). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(VNil? v) /\ ~(VCons? v) ==> Prims.l_False) /\
;   (v == Vector.VNil ==> 0 == n) /\
;   (~(VNil? v) ==>
;     (forall (b: a) (b: Prims.nat) (b: Vector.vector a b).
;         v == Vector.VCons b b ==>
;         (b << n \/ b === n /\ b << v) /\
;         (forall (any_result: Vector.vector a b).
;             b == any_result ==>
;             (forall (any_result: Vector.vector a b).
;                 Vector.reverse b == any_result ==>
;                 (forall (any_result: Vector.vector a (b + 1)).
;                     Vector.append (Vector.reverse b) (Vector.VCons b Vector.VNil) == any_result ==>
;                     b + 1 == n)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec reverse`
...
;; def=Prims.fst(402,27-402,88); use=Vector.fst(43,26-45,54)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(43,26-45,54)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(43,26-45,54)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(43,26-45,54)
(and (implies 
;; def=Vector.fst(43,22-43,23); use=Vector.fst(43,32-43,33)
(and 
;; def=Vector.fst(43,22-43,23); use=Vector.fst(43,32-43,33)
(not 
;; def=Vector.fst(43,22-43,23); use=Vector.fst(43,32-43,33)
...
label_1)
(implies 
;; def=Vector.fst(43,22-44,8); use=Vector.fst(43,32-44,8)
(= x_2ca789102088f52029182cc0ebc25e49_3
(Vector.VNil x_fe28d8bcde588226b4e538b35321de05_1))


;; def=Vector.fst(20,21-43,21); use=Vector.fst(44,12-44,16)
(or label_2
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Vector.fst(43,26-45,54)
(not 
;; def=Vector.fst(43,22-43,23); use=Vector.fst(43,32-43,33)
(BoxBool_proj_0 (Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2
...
;; def=Prims.fst(413,99-413,120); use=Vector.fst(43,26-45,54)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=Vector.fst(43,22-45,15); use=Vector.fst(43,32-45,15)
(= x_2ca789102088f52029182cc0ebc25e49_3
(Vector.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(43,26-45,54)
(and 
;; def=Vector.fst(42,25-45,54); use=Vector.fst(45,35-45,37)
(or label_3

;; def=Vector.fst(43,26-45,54); use=Vector.fst(45,35-45,37)
(Valid 
;; def=Vector.fst(43,26-45,54); use=Vector.fst(45,35-45,37)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(42,25-45,54); use=Vector.fst(45,35-45,37)
(and 
;; def=Vector.fst(42,25-43,21); use=Vector.fst(45,35-45,37)
(Valid 
;; def=Vector.fst(42,25-43,21); use=Vector.fst(45,35-45,37)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Prims.fst(451,66-451,102); use=Vector.fst(43,26-45,54)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
@x2))

;; def=dummy(0,0-0,0); use=Vector.fst(43,26-45,54)
(= @x3
@x4)
)
...
;; def=Vector.fst(36,45-45,38); use=Vector.fst(43,26-45,54)
(= (Vector.reverse x_fe28d8bcde588226b4e538b35321de05_1
@x2
@x3)
@x5)
)
...
;; def=Vector.fst(42,52-45,54); use=Vector.fst(43,26-45,54)
(= (Vector.append x_fe28d8bcde588226b4e538b35321de05_1
@x2
(BoxInt 1)
(Vector.reverse x_fe28d8bcde588226b4e538b35321de05_1
...
;; def=Vector.fst(36,92-43,21); use=Vector.fst(45,19-45,54)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Vector.reverse, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_2ca789102088f52029182cc0ebc25e49_3, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_2, constructor_distinct_Vector.VNil, data_elim_Vector.VCons, disc_equation_Vector.VCons, disc_equation_Vector.VNil, equation_Prims.nat, fuel_guarded_inversion_Vector.vector, int_inversion, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec reverse


; <Start encoding let rec reverse>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Vector.reverse.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Vector.reverse.fuel_instrumented_token () Term)
(declare-fun Vector.reverse (Term Term Term) Term)
(declare-fun Vector.reverse@tok () Term)
;;;;;;;;;;;;;;;;v: vector a n -> vector a n
(declare-fun Tm_arrow_37bbc56fe1bbbd091f87f34b5c83b6f1 () Term)

; </end encoding let rec reverse>


; encoding sigelt val Vector.mapT


; <Skipped val Vector.mapT/>

(push) ;; push{2

; Starting query at Vector.fst(48,22-50,43)
...
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(48,13-48,14); use=Vector.fst(48,13-48,14)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
:qid Vector_pre_typing_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))

:named Vector_pre_typing_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
:qid Vector_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))

:named Vector_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
...
;;;;;;;;;;;;;;;;n : Prims.nat (Prims.nat)
(declare-fun x_bb4e1c9af0265270f8e7a5f250f730e2_5 () Term)
;;;;;;;;;;;;;;;;binder_x_bb4e1c9af0265270f8e7a5f250f730e2_5
;;; Fact-ids: 
(assert (! (HasType x_bb4e1c9af0265270f8e7a5f250f730e2_5
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_5))
;;;;;;;;;;;;;;;;v : Vector.vector 'a n (Vector.vector 'a n)
(declare-fun x_f2a82419b48cea016cad98171080844c_6 () Term)
;;;;;;;;;;;;;;;;binder_x_f2a82419b48cea016cad98171080844c_6
;;; Fact-ids: 
(assert (! (HasType x_f2a82419b48cea016cad98171080844c_6
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5))
:named binder_x_f2a82419b48cea016cad98171080844c_6))
;;;;;;;;;;;;;;;;_: 'a -> 'b
(declare-fun Tm_arrow_6980332764c4493a7b0df5c02f7aefbe (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(47,11-47,23); use=Vector.fst(47,11-47,23)
(forall ((@x0 Term) (@x1 Term))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x2
@x3)))
:qid Vector_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named Vector_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
...
:pattern ((ApplyTT @x0
@x3))
:qid Vector_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe.1))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x2)))
:qid Vector_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named Vector_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
(declare-fun Tm_refine_a0f962dfde01b79772ebf740b21b5052 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(47,29-50,43); use=Vector.fst(47,29-50,43)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_a0f962dfde01b79772ebf740b21b5052 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_a0f962dfde01b79772ebf740b21b5052 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_a0f962dfde01b79772ebf740b21b5052))

:named refinement_kinding_Tm_refine_a0f962dfde01b79772ebf740b21b5052))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(47,29-50,43); use=Vector.fst(47,29-50,43)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a0f962dfde01b79772ebf740b21b5052 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Vector.vector @x3
...
;; def=Vector.fst(47,29-50,43); use=Vector.fst(47,29-50,43)
(or 
;; def=Vector.fst(48,22-50,43); use=Vector.fst(48,22-50,43)
(Valid 
;; def=Vector.fst(48,22-50,43); use=Vector.fst(48,22-50,43)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(47,29-50,43); use=Vector.fst(47,29-50,43)
(and 
;; def=Vector.fst(47,29-48,17); use=Vector.fst(47,29-48,17)
(Valid 
;; def=Vector.fst(47,29-48,17); use=Vector.fst(47,29-48,17)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x1
x_f2a82419b48cea016cad98171080844c_6)
)
)
)
...
(Tm_refine_a0f962dfde01b79772ebf740b21b5052 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_a0f962dfde01b79772ebf740b21b5052))

:named refinement_interpretation_Tm_refine_a0f962dfde01b79772ebf740b21b5052))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a0f962dfde01b79772ebf740b21b5052
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(47,29-50,43); use=Vector.fst(47,29-50,43)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a0f962dfde01b79772ebf740b21b5052 @x0
@x1)))
(Valid (Prims.hasEq (Vector.vector @x1
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a0f962dfde01b79772ebf740b21b5052 @x0
@x1))))
:qid haseqTm_refine_a0f962dfde01b79772ebf740b21b5052))

:named haseqTm_refine_a0f962dfde01b79772ebf740b21b5052))
(declare-fun Vector.mapT (Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;_: (_: 'a -> 'b) -> _: _: vector 'a n {n << n \/ n === n /\ _ << v} -> vector 'b n
(declare-fun Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd
Tm_type)
:named kinding_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(47,11-50,43); use=Vector.fst(47,11-50,43)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd))
:qid Vector_pre_typing_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd))

:named Vector_pre_typing_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(47,11-50,43); use=Vector.fst(47,11-50,43)
(forall ((@x0 Term))
...
Prims.nat)
(HasType @x5
(Tm_refine_a0f962dfde01b79772ebf740b21b5052 @x4
@x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x4)
@x5))
:qid Vector_interpretation_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd.2))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd.3))
...
@x2)
@x3))
:qid Vector_interpretation_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd.4))
...
@x3)
@x4))
:qid Vector_interpretation_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd.5))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd))
:qid Vector_interpretation_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd))

:named Vector_interpretation_Tm_arrow_7fe2e747a156a1ff87e1d830f32f66cd))
(declare-fun Vector.mapT@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(48,8-48,12); use=Vector.fst(48,8-48,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.mapT@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.mapT@tok
@x0)
@x1)
@x2)
@x3)
@x4))
:qid token_correspondence_Vector.mapT))

:named token_correspondence_Vector.mapT))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(48,8-48,12); use=Vector.fst(48,8-48,12)
...
:pattern ((Vector.mapT @x1
@x2
@x3
@x4
@x5))
:qid function_token_typing_Vector.mapT.1))
)
 

:pattern ((ApplyTT @x0
Vector.mapT@tok))
:qid function_token_typing_Vector.mapT))

:named function_token_typing_Vector.mapT))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(48,8-48,12); use=Vector.fst(48,8-48,12)
...
Prims.nat)
(HasType @x4
(Tm_refine_a0f962dfde01b79772ebf740b21b5052 @x3
@x0)))
(HasType (Vector.mapT @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Vector.mapT @x0
@x1
@x2
@x3
@x4))
:qid typing_Vector.mapT))

:named typing_Vector.mapT))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (Vector.vector 'b n)).
;   (forall (x: Vector.vector 'b n). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(VNil? v) /\ ~(VCons? v) ==> Prims.l_False) /\
;   (v == Vector.VNil ==> 0 == n) /\
;   (~(VNil? v) ==>
;     (forall (b: 'a) (b: Prims.nat) (b: Vector.vector 'a b).
...
;         (forall (any_result: Vector.vector 'a b).
;             b == any_result ==>
;             (forall (any_result: Vector.vector 'b b).
;                 Vector.mapT f b == any_result ==>
;                 (forall (any_result: Vector.vector 'b (b + 1)).
;                     Vector.VCons (f b) (Vector.mapT f b) == any_result ==> b + 1 == n)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec mapT`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Vector.vector x_fe28d8bcde588226b4e538b35321de05_3
x_bb4e1c9af0265270f8e7a5f250f730e2_5)))

;; def=Prims.fst(402,27-402,88); use=Vector.fst(48,22-50,43)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(48,22-50,43)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(48,22-50,43)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(48,22-50,43)
(and (implies 
;; def=Vector.fst(48,18-48,19); use=Vector.fst(48,28-48,29)
(and 
;; def=Vector.fst(48,18-48,19); use=Vector.fst(48,28-48,29)
(not 
;; def=Vector.fst(48,18-48,19); use=Vector.fst(48,28-48,29)
(BoxBool_proj_0 (Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
x_f2a82419b48cea016cad98171080844c_6))
)
...
(not 
;; def=Vector.fst(48,18-48,19); use=Vector.fst(48,28-48,29)
(BoxBool_proj_0 (Vector.uu___is_VCons x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
x_f2a82419b48cea016cad98171080844c_6))
)
)
...
label_1)
(implies 
;; def=Vector.fst(48,18-49,8); use=Vector.fst(48,28-49,8)
(= x_f2a82419b48cea016cad98171080844c_6
(Vector.VNil x_fe28d8bcde588226b4e538b35321de05_2))


;; def=Vector.fst(20,21-48,17); use=Vector.fst(49,12-49,16)
(or label_2
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Vector.fst(48,22-50,43)
(not 
;; def=Vector.fst(48,18-48,19); use=Vector.fst(48,28-48,29)
(BoxBool_proj_0 (Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
...
;; def=Prims.fst(413,99-413,120); use=Vector.fst(48,22-50,43)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=Vector.fst(48,18-50,15); use=Vector.fst(48,28-50,15)
(= x_f2a82419b48cea016cad98171080844c_6
(Vector.VCons x_fe28d8bcde588226b4e538b35321de05_2
@x1
@x2
@x3))
)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(48,22-50,43)
(and 
;; def=Vector.fst(47,29-50,43); use=Vector.fst(50,40-50,42)
(or label_3

;; def=Vector.fst(48,22-50,43); use=Vector.fst(50,40-50,42)
(Valid 
;; def=Vector.fst(48,22-50,43); use=Vector.fst(50,40-50,42)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(47,29-50,43); use=Vector.fst(50,40-50,42)
(and 
;; def=Vector.fst(47,29-48,17); use=Vector.fst(50,40-50,42)
(Valid 
;; def=Vector.fst(47,29-48,17); use=Vector.fst(50,40-50,42)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(Valid 
;; def=Vector.fst(48,22-50,43); use=Vector.fst(50,40-50,42)
(Prims.precedes (Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
@x2)
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x3
...
;; def=Prims.fst(451,66-451,102); use=Vector.fst(48,22-50,43)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
@x2))

;; def=dummy(0,0-0,0); use=Vector.fst(48,22-50,43)
(= @x3
@x4)
)
...
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_3
@x2))

;; def=Vector.fst(23,12-50,43); use=Vector.fst(48,22-50,43)
(= (Vector.mapT x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3
x_57af2c0907f883669f14a9b761d251ac_4
@x2
@x3)
@x5)
)
...
;; def=Vector.fst(47,57-50,43); use=Vector.fst(48,22-50,43)
(= (Vector.VCons x_fe28d8bcde588226b4e538b35321de05_3
(ApplyTT x_57af2c0907f883669f14a9b761d251ac_4
@x1)
@x2
(Vector.mapT x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3
...
;; def=Vector.fst(24,22-48,17); use=Vector.fst(50,19-50,43)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Vector.mapT, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_5, binder_x_f2a82419b48cea016cad98171080844c_6, constructor_distinct_Vector.VNil, data_elim_Vector.VCons, disc_equation_Vector.VCons, disc_equation_Vector.VNil, equation_Prims.nat, fuel_guarded_inversion_Vector.vector, int_inversion, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec mapT


; <Start encoding let rec mapT>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Vector.mapT.fuel_instrumented (Fuel Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Vector.mapT.fuel_instrumented_token () Term)
(declare-fun Vector.mapT (Term Term Term Term Term) Term)
(declare-fun Vector.mapT@tok () Term)
;;;;;;;;;;;;;;;;_: 'a -> 'b
(declare-fun Tm_arrow_6980332764c4493a7b0df5c02f7aefbe (Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: 'a -> 'b) -> v: vector 'a n -> vector 'b n
(declare-fun Tm_arrow_46f109ce094d43f8c4bd4045dd41bd1f () Term)

; </end encoding let rec mapT>


; encoding sigelt val Vector.fold_left


; <Skipped val Vector.fold_left/>

(push) ;; push{2

; Starting query at Vector.fst(53,31-55,44)
...
Tm_type)
:named binder_x_fe28d8bcde588226b4e538b35321de05_3))
;;;;;;;;;;;;;;;;f : _: 'b -> _: 'a -> 'b (_: 'b -> _: 'a -> 'b)
(declare-fun x_2d8b4c119c44e45a2d66ec6284d7cfe7_4 () Term)
;;;;;;;;;;;;;;;;_: 'b -> _: 'a -> 'b
(declare-fun Tm_arrow_0a897859812468b4876bf0d5eb4e68fa () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0a897859812468b4876bf0d5eb4e68fa
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_0a897859812468b4876bf0d5eb4e68fa
Tm_type)
:named kinding_Tm_arrow_0a897859812468b4876bf0d5eb4e68fa))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(53,18-53,19); use=Vector.fst(53,18-53,19)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_0a897859812468b4876bf0d5eb4e68fa)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_0a897859812468b4876bf0d5eb4e68fa))
:qid Vector_pre_typing_Tm_arrow_0a897859812468b4876bf0d5eb4e68fa))

:named Vector_pre_typing_Tm_arrow_0a897859812468b4876bf0d5eb4e68fa))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0a897859812468b4876bf0d5eb4e68fa
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(53,18-53,19); use=Vector.fst(53,18-53,19)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_0a897859812468b4876bf0d5eb4e68fa.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_0a897859812468b4876bf0d5eb4e68fa.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_0a897859812468b4876bf0d5eb4e68fa))
:qid Vector_interpretation_Tm_arrow_0a897859812468b4876bf0d5eb4e68fa))

:named Vector_interpretation_Tm_arrow_0a897859812468b4876bf0d5eb4e68fa))
;;;;;;;;;;;;;;;;binder_x_2d8b4c119c44e45a2d66ec6284d7cfe7_4
;;; Fact-ids: 
(assert (! (HasType x_2d8b4c119c44e45a2d66ec6284d7cfe7_4
Tm_arrow_0a897859812468b4876bf0d5eb4e68fa)
:named binder_x_2d8b4c119c44e45a2d66ec6284d7cfe7_4))
;;;;;;;;;;;;;;;;acc : 'b ('b)
(declare-fun x_23111b199e312dabc7d863b983ebf5c5_5 () Term)
;;;;;;;;;;;;;;;;binder_x_23111b199e312dabc7d863b983ebf5c5_5
;;; Fact-ids: 
(assert (! (HasType x_23111b199e312dabc7d863b983ebf5c5_5
x_fe28d8bcde588226b4e538b35321de05_3)
:named binder_x_23111b199e312dabc7d863b983ebf5c5_5))
;;;;;;;;;;;;;;;;n : Prims.nat (Prims.nat)
(declare-fun x_bb4e1c9af0265270f8e7a5f250f730e2_6 () Term)
;;;;;;;;;;;;;;;;binder_x_bb4e1c9af0265270f8e7a5f250f730e2_6
;;; Fact-ids: 
(assert (! (HasType x_bb4e1c9af0265270f8e7a5f250f730e2_6
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_6))
;;;;;;;;;;;;;;;;v : Vector.vector 'a n (Vector.vector 'a n)
(declare-fun x_048405c135c47e66b2f031213c846802_7 () Term)
;;;;;;;;;;;;;;;;binder_x_048405c135c47e66b2f031213c846802_7
;;; Fact-ids: 
(assert (! (HasType x_048405c135c47e66b2f031213c846802_7
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_6))
:named binder_x_048405c135c47e66b2f031213c846802_7))
;;;;;;;;;;;;;;;;_: 'b -> _: 'a -> 'b
(declare-fun Tm_arrow_f0225aaf6b987d44876e7f498390aa39 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f0225aaf6b987d44876e7f498390aa39
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(52,16-52,24); use=Vector.fst(52,16-52,34)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_f0225aaf6b987d44876e7f498390aa39))

:named kinding_Tm_arrow_f0225aaf6b987d44876e7f498390aa39))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(52,16-52,24); use=Vector.fst(52,16-52,34)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x2
@x3)))
:qid Vector_pre_typing_Tm_arrow_f0225aaf6b987d44876e7f498390aa39))

:named Vector_pre_typing_Tm_arrow_f0225aaf6b987d44876e7f498390aa39))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f0225aaf6b987d44876e7f498390aa39
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(52,16-52,24); use=Vector.fst(52,16-52,34)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x1
@x2))
(and 
;; def=Vector.fst(52,16-52,24); use=Vector.fst(52,16-52,34)
...
@x3)
@x4))
:qid Vector_interpretation_Tm_arrow_f0225aaf6b987d44876e7f498390aa39.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Vector_interpretation_Tm_arrow_f0225aaf6b987d44876e7f498390aa39.2))
))
...
(Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x1
@x2)))
:qid Vector_interpretation_Tm_arrow_f0225aaf6b987d44876e7f498390aa39))

:named Vector_interpretation_Tm_arrow_f0225aaf6b987d44876e7f498390aa39))
(declare-fun Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(53,31-55,44); use=Vector.fst(53,31-55,44)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7))

:named refinement_kinding_Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(53,31-55,44); use=Vector.fst(53,31-55,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Vector.vector @x2
...
(Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7))

:named refinement_interpretation_Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(53,31-55,44); use=Vector.fst(53,31-55,44)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7 @x0
@x1)))
(Valid (Prims.hasEq (Vector.vector @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7 @x0
@x1))))
:qid haseqTm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7))

:named haseqTm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7))
(declare-fun Vector.fold_left (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;_: (_: 'b -> _: 'a -> 'b) -> _: 'b -> _: _: vector 'a n {n << n} -> Prims.Tot 'b
(declare-fun Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852
Tm_type)
:named kinding_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(52,16-55,44); use=Vector.fst(52,16-55,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852))
:qid Vector_pre_typing_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852))

:named Vector_pre_typing_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(52,16-55,44); use=Vector.fst(52,16-55,44)
(forall ((@x0 Term))
...
Prims.nat)
(HasType @x6
(Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7 @x1
@x5)))
...
@x5)
@x6))
:qid Vector_interpretation_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852.2))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852.3))
...
@x2)
@x3))
:qid Vector_interpretation_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852.4))
...
@x3)
@x4))
:qid Vector_interpretation_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852.5))
...
@x4)
@x5))
:qid Vector_interpretation_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852.6))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852))
:qid Vector_interpretation_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852))

:named Vector_interpretation_Tm_arrow_2bbe3e6bef756a746fc2c0e35d47d852))
(declare-fun Vector.fold_left@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(53,8-53,17); use=Vector.fst(53,8-53,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.fold_left@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.fold_left@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5))
:qid token_correspondence_Vector.fold_left))

:named token_correspondence_Vector.fold_left))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(53,8-53,17); use=Vector.fst(53,8-53,17)
...
:pattern ((Vector.fold_left @x1
@x2
@x3
@x4
@x5
@x6))
:qid function_token_typing_Vector.fold_left.1))
)
 

:pattern ((ApplyTT @x0
Vector.fold_left@tok))
:qid function_token_typing_Vector.fold_left))

:named function_token_typing_Vector.fold_left))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(53,8-53,17); use=Vector.fst(53,8-53,17)
...
Tm_type)
(HasType @x2
(Tm_arrow_f0225aaf6b987d44876e7f498390aa39 @x0
@x1))
(HasType @x3
@x1)
(HasType @x4
Prims.nat)
(HasType @x5
(Tm_refine_5c74fdcc5c0af1c3ba1eaa9911141cd7 @x0
@x4)))
(HasType (Vector.fold_left @x0
@x1
@x2
@x3
@x4
...
:pattern ((Vector.fold_left @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_Vector.fold_left))

:named typing_Vector.fold_left))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post 'b).
;   (forall (x: 'b). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(VNil? v) /\ ~(VCons? v) ==> Prims.l_False) /\
;   (~(VNil? v) ==>
;     (forall (b: 'a) (b: Prims.nat) (b: Vector.vector 'a b). v == Vector.VCons b b ==> b << n))
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post x_fe28d8bcde588226b4e538b35321de05_3))

;; def=Prims.fst(402,27-402,88); use=Vector.fst(53,31-55,44)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(53,31-55,44)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(53,31-55,44)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(53,31-55,44)
(and (implies 
;; def=Vector.fst(53,27-53,28); use=Vector.fst(53,37-53,38)
(and 
;; def=Vector.fst(53,27-53,28); use=Vector.fst(53,37-53,38)
(not 
;; def=Vector.fst(53,27-53,28); use=Vector.fst(53,37-53,38)
(BoxBool_proj_0 (Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_6
x_048405c135c47e66b2f031213c846802_7))
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Vector.fst(53,31-55,44)
(not 
;; def=Vector.fst(53,27-53,28); use=Vector.fst(53,37-53,38)
(BoxBool_proj_0 (Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_6
...
;; def=Prims.fst(413,99-413,120); use=Vector.fst(53,31-55,44)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=Vector.fst(53,27-55,15); use=Vector.fst(53,37-55,15)
(= x_048405c135c47e66b2f031213c846802_7
(Vector.VCons x_fe28d8bcde588226b4e538b35321de05_2
@x1
@x2
...
;; def=Vector.fst(53,31-55,44); use=Vector.fst(55,42-55,44)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Vector.fold_left, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_048405c135c47e66b2f031213c846802_7, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_6, data_elim_Vector.VCons, disc_equation_Vector.VCons, disc_equation_Vector.VNil, equation_Prims.nat, fuel_guarded_inversion_Vector.vector, int_inversion, int_typing, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_Vector.VCons_n, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Vector.fold_left.fuel_instrumented (Fuel Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Vector.fold_left.fuel_instrumented_token () Term)
(declare-fun Vector.fold_left (Term Term Term Term Term Term) Term)
(declare-fun Vector.fold_left@tok () Term)
;;;;;;;;;;;;;;;;_: 'b -> _: 'a -> 'b
(declare-fun Tm_arrow_f0225aaf6b987d44876e7f498390aa39 (Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: 'b -> _: 'a -> 'b) -> acc: 'b -> v: vector 'a n -> Prims.Tot 'b
(declare-fun Tm_arrow_abb95d7d1b82cfe910de4dc14decf688 () Term)

; </end encoding let rec fold_left>


; encoding sigelt val Vector.fold_right


; <Skipped val Vector.fold_right/>

(push) ;; push{2

; Starting query at Vector.fst(58,32-60,45)
...
Tm_type)
:named binder_x_fe28d8bcde588226b4e538b35321de05_3))
;;;;;;;;;;;;;;;;f : _: 'a -> _: 'b -> 'b (_: 'a -> _: 'b -> 'b)
(declare-fun x_a9f8f96d0366f364dc51afa3ee2791bc_4 () Term)
;;;;;;;;;;;;;;;;_: 'a -> _: 'b -> 'b
(declare-fun Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8
Tm_type)
:named kinding_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(58,19-58,20); use=Vector.fst(58,19-58,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
:qid Vector_pre_typing_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))

:named Vector_pre_typing_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(58,19-58,20); use=Vector.fst(58,19-58,20)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
:qid Vector_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))

:named Vector_interpretation_Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8))
;;;;;;;;;;;;;;;;binder_x_a9f8f96d0366f364dc51afa3ee2791bc_4
;;; Fact-ids: 
(assert (! (HasType x_a9f8f96d0366f364dc51afa3ee2791bc_4
Tm_arrow_ef5c2ac2662748fbaa4f84969079b8b8)
:named binder_x_a9f8f96d0366f364dc51afa3ee2791bc_4))
;;;;;;;;;;;;;;;;n : Prims.nat (Prims.nat)
(declare-fun x_bb4e1c9af0265270f8e7a5f250f730e2_5 () Term)
;;;;;;;;;;;;;;;;binder_x_bb4e1c9af0265270f8e7a5f250f730e2_5
;;; Fact-ids: 
...
:named binder_x_f2a82419b48cea016cad98171080844c_6))
;;;;;;;;;;;;;;;;acc : 'b ('b)
(declare-fun x_23111b199e312dabc7d863b983ebf5c5_7 () Term)
;;;;;;;;;;;;;;;;binder_x_23111b199e312dabc7d863b983ebf5c5_7
;;; Fact-ids: 
(assert (! (HasType x_23111b199e312dabc7d863b983ebf5c5_7
x_fe28d8bcde588226b4e538b35321de05_3)
:named binder_x_23111b199e312dabc7d863b983ebf5c5_7))
;;;;;;;;;;;;;;;;_: 'a -> _: 'b -> 'b
(declare-fun Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(57,17-57,25); use=Vector.fst(57,17-57,35)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))

:named kinding_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(57,17-57,25); use=Vector.fst(57,17-57,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x2
@x3)))
:qid Vector_pre_typing_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))

:named Vector_pre_typing_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(57,17-57,25); use=Vector.fst(57,17-57,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x1
@x2))
(and 
;; def=Vector.fst(57,17-57,25); use=Vector.fst(57,17-57,35)
(forall ((@x3 Term) (@x4 Term))
...
@x3)
@x4))
:qid Vector_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid Vector_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81.2))
))
...
(Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 @x1
@x2)))
:qid Vector_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))

:named Vector_interpretation_Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81))
(declare-fun Tm_refine_c18b861ca78f966d627c9433dc843699 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(57,41-60,45); use=Vector.fst(57,41-60,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_c18b861ca78f966d627c9433dc843699 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_c18b861ca78f966d627c9433dc843699 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_c18b861ca78f966d627c9433dc843699))

:named refinement_kinding_Tm_refine_c18b861ca78f966d627c9433dc843699))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(57,41-60,45); use=Vector.fst(57,41-60,45)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c18b861ca78f966d627c9433dc843699 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Vector.fst(57,41-60,45); use=Vector.fst(57,41-60,45)
(or 
;; def=Vector.fst(58,32-60,45); use=Vector.fst(58,32-60,45)
(Valid 
;; def=Vector.fst(58,32-60,45); use=Vector.fst(58,32-60,45)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(57,41-60,45); use=Vector.fst(57,41-60,45)
(and 
;; def=Vector.fst(57,41-58,23); use=Vector.fst(57,41-58,23)
(Valid 
;; def=Vector.fst(57,41-58,23); use=Vector.fst(57,41-58,23)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Vector.fst(58,24-60,45); use=Vector.fst(58,24-60,45)
(or 
;; def=Vector.fst(58,32-60,45); use=Vector.fst(58,32-60,45)
(Valid 
;; def=Vector.fst(58,32-60,45); use=Vector.fst(58,32-60,45)
...
;; def=Vector.fst(58,24-60,45); use=Vector.fst(58,24-60,45)
(and 
;; def=Vector.fst(58,24-58,25); use=Vector.fst(58,24-58,25)
(Valid 
;; def=Vector.fst(58,24-58,25); use=Vector.fst(58,24-58,25)
(Prims.op_Equals_Equals_Equals (Vector.vector @x3
@x2)
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x4
...
x_fe28d8bcde588226b4e538b35321de05_3
@x1
x_23111b199e312dabc7d863b983ebf5c5_7)
)
)
)
)
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_c18b861ca78f966d627c9433dc843699))

:named refinement_interpretation_Tm_refine_c18b861ca78f966d627c9433dc843699))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c18b861ca78f966d627c9433dc843699
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(57,41-60,45); use=Vector.fst(57,41-60,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c18b861ca78f966d627c9433dc843699 @x0
@x1
@x2
@x3)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_c18b861ca78f966d627c9433dc843699 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_c18b861ca78f966d627c9433dc843699))

:named haseqTm_refine_c18b861ca78f966d627c9433dc843699))
(declare-fun Vector.fold_right (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;_: (_: 'a -> _: 'b -> 'b) ->     _: vector 'a n ->     _: _: 'b{n << n \/ n === n /\ (_ << v \/ _ === v /\ _ << acc)}   -> 'b
(declare-fun Tm_arrow_a521a0ea2fbead496e3e91639a8202b1 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a521a0ea2fbead496e3e91639a8202b1
Tm_type)
:named kinding_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(57,17-60,45); use=Vector.fst(57,17-60,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a521a0ea2fbead496e3e91639a8202b1)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a521a0ea2fbead496e3e91639a8202b1))
:qid Vector_pre_typing_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1))

:named Vector_pre_typing_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(57,17-60,45); use=Vector.fst(57,17-60,45)
(forall ((@x0 Term))
...
@x4))
(HasType @x6
(Tm_refine_c18b861ca78f966d627c9433dc843699 @x4
@x1
@x5
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
...
@x5)
@x6))
:qid Vector_interpretation_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1.2))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1.3))
...
@x2)
@x3))
:qid Vector_interpretation_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1.4))
...
@x3)
@x4))
:qid Vector_interpretation_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1.5))
...
@x4)
@x5))
:qid Vector_interpretation_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1.6))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_a521a0ea2fbead496e3e91639a8202b1))
:qid Vector_interpretation_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1))

:named Vector_interpretation_Tm_arrow_a521a0ea2fbead496e3e91639a8202b1))
(declare-fun Vector.fold_right@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(58,8-58,18); use=Vector.fst(58,8-58,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.fold_right@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.fold_right@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5))
:qid token_correspondence_Vector.fold_right))

:named token_correspondence_Vector.fold_right))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(58,8-58,18); use=Vector.fst(58,8-58,18)
...
:pattern ((Vector.fold_right @x1
@x2
@x3
@x4
@x5
@x6))
:qid function_token_typing_Vector.fold_right.1))
)
 

:pattern ((ApplyTT @x0
Vector.fold_right@tok))
:qid function_token_typing_Vector.fold_right))

:named function_token_typing_Vector.fold_right))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(58,8-58,18); use=Vector.fst(58,8-58,18)
...
@x3))
(HasType @x5
(Tm_refine_c18b861ca78f966d627c9433dc843699 @x3
@x0
@x4
@x1)))
(HasType (Vector.fold_right @x0
@x1
@x2
@x3
@x4
...
:pattern ((Vector.fold_right @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_Vector.fold_right))

:named typing_Vector.fold_right))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(VNil? v) ==>
;     (forall (b: 'a) (b: Prims.nat) (b: Vector.vector 'a b).
;         v == Vector.VCons b b ==> b << n \/ b === n /\ (b << v \/ b === v /\ acc << acc)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec fold_right`
...
;; def=Prims.fst(402,27-402,88); use=Vector.fst(58,32-60,45)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(58,32-60,45)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(58,32-60,45)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(58,32-60,45)
(and (implies 
;; def=Vector.fst(58,24-58,25); use=Vector.fst(58,38-58,39)
(and 
;; def=Vector.fst(58,24-58,25); use=Vector.fst(58,38-58,39)
(not 
;; def=Vector.fst(58,24-58,25); use=Vector.fst(58,38-58,39)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Vector.fst(58,32-60,45)
(not 
;; def=Vector.fst(58,24-58,25); use=Vector.fst(58,38-58,39)
(BoxBool_proj_0 (Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5
...
;; def=Prims.fst(413,99-413,120); use=Vector.fst(58,32-60,45)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=Vector.fst(58,24-60,15); use=Vector.fst(58,38-60,15)
(= x_f2a82419b48cea016cad98171080844c_6
(Vector.VCons x_fe28d8bcde588226b4e538b35321de05_2
@x1
@x2
...
;; def=Vector.fst(57,41-60,45); use=Vector.fst(60,41-60,44)
(or label_2

;; def=Vector.fst(58,32-60,45); use=Vector.fst(60,41-60,44)
(Valid 
;; def=Vector.fst(58,32-60,45); use=Vector.fst(60,41-60,44)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(57,41-60,45); use=Vector.fst(60,41-60,44)
(and 
;; def=Vector.fst(57,41-58,23); use=Vector.fst(60,41-60,44)
(Valid 
;; def=Vector.fst(57,41-58,23); use=Vector.fst(60,41-60,44)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Vector.fst(58,24-60,45); use=Vector.fst(60,41-60,44)
(or 
;; def=Vector.fst(58,32-60,45); use=Vector.fst(60,41-60,44)
(Valid 
;; def=Vector.fst(58,32-60,45); use=Vector.fst(60,41-60,44)
...
;; def=Vector.fst(58,24-60,45); use=Vector.fst(60,41-60,44)
(and 
;; def=Vector.fst(58,24-58,25); use=Vector.fst(60,41-60,44)
(Valid 
;; def=Vector.fst(58,24-58,25); use=Vector.fst(60,41-60,44)
(Prims.op_Equals_Equals_Equals (Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
@x2)
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_5)
@x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Vector.fold_right, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_5, binder_x_f2a82419b48cea016cad98171080844c_6, data_elim_Vector.VCons, disc_equation_Vector.VCons, disc_equation_Vector.VNil, equation_Prims.nat, fuel_guarded_inversion_Vector.vector, int_inversion, int_typing, primitive_Prims.op_Addition, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_Vector.VCons_n, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec fold_right


; <Start encoding let rec fold_right>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Vector.fold_right.fuel_instrumented (Fuel Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Vector.fold_right.fuel_instrumented_token () Term)
(declare-fun Vector.fold_right (Term Term Term Term Term Term) Term)
(declare-fun Vector.fold_right@tok () Term)
;;;;;;;;;;;;;;;;_: 'a -> _: 'b -> 'b
(declare-fun Tm_arrow_3c1d21b8f6dcc5e202b4ff1cafbaba81 (Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: 'a -> _: 'b -> 'b) -> v: vector 'a n -> acc: 'b -> 'b
(declare-fun Tm_arrow_198577550a395ce68b7ddd50115b2fd3 () Term)

; </end encoding let rec fold_right>


; encoding sigelt val Vector.find


; <Skipped val Vector.find/>
...
; Starting query at Vector.fst(63,22-68,18)
...
Tm_type)
:named binder_x_fe28d8bcde588226b4e538b35321de05_1))
;;;;;;;;;;;;;;;;f : _: 'a -> Prims.bool (_: 'a -> Prims.bool)
(declare-fun x_ad4fa64b8bde7a35b571dab333de24e9_2 () Term)
;;;;;;;;;;;;;;;;_: 'a -> Prims.bool
(declare-fun Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22
Tm_type)
:named kinding_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,23-63,14); use=Vector.fst(63,8-63,14)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))
:qid Vector_pre_typing_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))

:named Vector_pre_typing_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,23-63,14); use=Vector.fst(63,8-63,14)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))
:qid Vector_interpretation_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))

:named Vector_interpretation_Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22))
;;;;;;;;;;;;;;;;binder_x_ad4fa64b8bde7a35b571dab333de24e9_2
;;; Fact-ids: 
(assert (! (HasType x_ad4fa64b8bde7a35b571dab333de24e9_2
Tm_arrow_e4eab69ee26f37309e9615f5a07e5b22)
:named binder_x_ad4fa64b8bde7a35b571dab333de24e9_2))
;;;;;;;;;;;;;;;;n : Prims.nat (Prims.nat)
(declare-fun x_bb4e1c9af0265270f8e7a5f250f730e2_3 () Term)
;;;;;;;;;;;;;;;;binder_x_bb4e1c9af0265270f8e7a5f250f730e2_3
;;; Fact-ids: 
...
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_3))
;;;;;;;;;;;;;;;;v : Vector.vector 'a n (Vector.vector 'a n)
(declare-fun x_1fd74c304e163c0d8adcb88881fe80b8_4 () Term)
;;;;;;;;;;;;;;;;binder_x_1fd74c304e163c0d8adcb88881fe80b8_4
;;; Fact-ids: 
(assert (! (HasType x_1fd74c304e163c0d8adcb88881fe80b8_4
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_3))
:named binder_x_1fd74c304e163c0d8adcb88881fe80b8_4))
;;;;;;;;;;;;;;;;_: 'a -> Prims.bool
(declare-fun Tm_arrow_84543425b818e2d10a976186b8e8c250 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_84543425b818e2d10a976186b8e8c250
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,13-62,27); use=Vector.fst(62,13-63,12)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_84543425b818e2d10a976186b8e8c250 @x2)))
:qid Vector_pre_typing_Tm_arrow_84543425b818e2d10a976186b8e8c250))

:named Vector_pre_typing_Tm_arrow_84543425b818e2d10a976186b8e8c250))
...
:pattern ((ApplyTT @x0
@x2))
:qid Vector_interpretation_Tm_arrow_84543425b818e2d10a976186b8e8c250.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_84543425b818e2d10a976186b8e8c250 @x1)))
:qid Vector_interpretation_Tm_arrow_84543425b818e2d10a976186b8e8c250))

:named Vector_interpretation_Tm_arrow_84543425b818e2d10a976186b8e8c250))
(declare-fun Tm_refine_ee5ef463a9431543d7cec94bbaae5501 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,33-68,18); use=Vector.fst(62,33-68,18)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_ee5ef463a9431543d7cec94bbaae5501 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_ee5ef463a9431543d7cec94bbaae5501 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_ee5ef463a9431543d7cec94bbaae5501))

:named refinement_kinding_Tm_refine_ee5ef463a9431543d7cec94bbaae5501))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,33-68,18); use=Vector.fst(62,33-68,18)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ee5ef463a9431543d7cec94bbaae5501 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Vector.vector @x3
...
;; def=Vector.fst(62,33-68,18); use=Vector.fst(62,33-68,18)
(or 
;; def=Vector.fst(63,22-68,18); use=Vector.fst(63,22-68,18)
(Valid 
;; def=Vector.fst(63,22-68,18); use=Vector.fst(63,22-68,18)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(62,33-68,18); use=Vector.fst(62,33-68,18)
(and 
;; def=Vector.fst(62,33-63,17); use=Vector.fst(62,33-63,17)
(Valid 
;; def=Vector.fst(62,33-63,17); use=Vector.fst(62,33-63,17)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
x_bb4e1c9af0265270f8e7a5f250f730e2_3)
@x1
x_1fd74c304e163c0d8adcb88881fe80b8_4)
)
)
)
...
(Tm_refine_ee5ef463a9431543d7cec94bbaae5501 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_ee5ef463a9431543d7cec94bbaae5501))

:named refinement_interpretation_Tm_refine_ee5ef463a9431543d7cec94bbaae5501))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ee5ef463a9431543d7cec94bbaae5501
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,33-68,18); use=Vector.fst(62,33-68,18)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ee5ef463a9431543d7cec94bbaae5501 @x0
@x1)))
(Valid (Prims.hasEq (Vector.vector @x1
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ee5ef463a9431543d7cec94bbaae5501 @x0
@x1))))
:qid haseqTm_refine_ee5ef463a9431543d7cec94bbaae5501))

:named haseqTm_refine_ee5ef463a9431543d7cec94bbaae5501))
(declare-fun Vector.find (Term Term Term Term) Term)
...
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,69-62,80); use=Vector.fst(63,8-63,12)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_3b1cb9ec3355fed185c658f53954b3fa @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_3b1cb9ec3355fed185c658f53954b3fa @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_3b1cb9ec3355fed185c658f53954b3fa))

:named refinement_kinding_Tm_refine_3b1cb9ec3355fed185c658f53954b3fa))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,69-62,80); use=Vector.fst(63,8-63,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3b1cb9ec3355fed185c658f53954b3fa @x2
@x3))
(and (HasTypeFuel @u0
@x1
@x2)

;; def=Vector.fst(62,75-62,78); use=Vector.fst(63,8-63,12)
...
(Tm_refine_3b1cb9ec3355fed185c658f53954b3fa @x2
@x3)))
:qid refinement_interpretation_Tm_refine_3b1cb9ec3355fed185c658f53954b3fa))

:named refinement_interpretation_Tm_refine_3b1cb9ec3355fed185c658f53954b3fa))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3b1cb9ec3355fed185c658f53954b3fa
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,69-62,80); use=Vector.fst(63,8-63,12)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3b1cb9ec3355fed185c658f53954b3fa @x0
@x1)))
(Valid (Prims.hasEq @x0)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3b1cb9ec3355fed185c658f53954b3fa @x0
@x1))))
:qid haseqTm_refine_3b1cb9ec3355fed185c658f53954b3fa))

:named haseqTm_refine_3b1cb9ec3355fed185c658f53954b3fa))
;;;;;;;;;;;;;;;;f: (_: 'a -> Prims.bool) -> _: _: vector 'a n {n << n \/ n === n /\ _ << v}   -> FStar.Pervasives.Native.option (x: 'a{f x})
(declare-fun Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416
Tm_type)
:named kinding_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,13-68,18); use=Vector.fst(62,13-68,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416))
:qid Vector_pre_typing_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416))

:named Vector_pre_typing_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,13-68,18); use=Vector.fst(62,13-68,18)
(forall ((@x0 Term))
...
Prims.nat)
(HasType @x4
(Tm_refine_ee5ef463a9431543d7cec94bbaae5501 @x3
@x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
@x3)
@x4)
(FStar.Pervasives.Native.option (Tm_refine_3b1cb9ec3355fed185c658f53954b3fa @x1
@x2))))
...
@x3)
@x4))
:qid Vector_interpretation_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416.2))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416.3))
...
@x2)
@x3))
:qid Vector_interpretation_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416))
:qid Vector_interpretation_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416))

:named Vector_interpretation_Tm_arrow_02ea99b7c89f2755a93c70b6a71ae416))
(declare-fun Vector.find@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(63,8-63,12); use=Vector.fst(63,8-63,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.find@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.find@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Vector.find))

:named token_correspondence_Vector.find))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(63,8-63,12); use=Vector.fst(63,8-63,12)
...
:pattern ((Vector.find @x1
@x2
@x3
@x4))
:qid function_token_typing_Vector.find.1))
)
 

:pattern ((ApplyTT @x0
Vector.find@tok))
:qid function_token_typing_Vector.find))

:named function_token_typing_Vector.find))
...
Tm_type)
(HasType @x1
(Tm_arrow_84543425b818e2d10a976186b8e8c250 @x0))
(HasType @x2
Prims.nat)
(HasType @x3
(Tm_refine_ee5ef463a9431543d7cec94bbaae5501 @x2
@x0)))
(HasType (Vector.find @x0
@x1
@x2
@x3)
(FStar.Pervasives.Native.option (Tm_refine_3b1cb9ec3355fed185c658f53954b3fa @x0
@x1))))
 

:pattern ((Vector.find @x0
@x1
@x2
@x3))
:qid typing_Vector.find))

:named typing_Vector.find))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_d460cd707c042701331d577a5aa2f5ef () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_d460cd707c042701331d577a5aa2f5ef
Tm_type)
:named refinement_kinding_Tm_refine_d460cd707c042701331d577a5aa2f5ef))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(62,69-62,80); use=Vector.fst(63,22-68,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_d460cd707c042701331d577a5aa2f5ef)
(and (HasTypeFuel @u0
@x1
x_fe28d8bcde588226b4e538b35321de05_1)

;; def=Vector.fst(62,75-62,78); use=Vector.fst(63,22-68,18)
(BoxBool_proj_0 (ApplyTT x_ad4fa64b8bde7a35b571dab333de24e9_2
@x1))
))
...
@x1
Tm_refine_d460cd707c042701331d577a5aa2f5ef))
:qid refinement_interpretation_Tm_refine_d460cd707c042701331d577a5aa2f5ef))

:named refinement_interpretation_Tm_refine_d460cd707c042701331d577a5aa2f5ef))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d460cd707c042701331d577a5aa2f5ef
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_d460cd707c042701331d577a5aa2f5ef))
(Valid (Prims.hasEq x_fe28d8bcde588226b4e538b35321de05_1)))
:named haseqTm_refine_d460cd707c042701331d577a5aa2f5ef))




; Encoding query formula : forall (k: Prims.pure_post (FStar.Pervasives.Native.option (x: 'a{f x}))).
;   (forall (x: FStar.Pervasives.Native.option (x: 'a{f x})). {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(VNil? v) /\ ~(VCons? v) ==> Prims.l_False) /\
;   (~(VNil? v) ==>
;     (forall (b: 'a) (b: Prims.nat) (b: Vector.vector 'a b).
;         v == Vector.VCons b b ==>
;         (forall (k: Prims.pure_post (FStar.Pervasives.Native.option (x: 'a{f x}))).
;             (forall (x: FStar.Pervasives.Native.option (x: 'a{f x})).
;                 {:pattern Prims.guard_free (k x)}
;                 Prims.auto_squash (k x)) ==>
;             (f b == true ==> f b) /\
;             (~(f b = true) ==> (forall (b: Prims.bool). f b == b ==> b << n \/ b === n /\ b << v))))
;   )
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (FStar.Pervasives.Native.option Tm_refine_d460cd707c042701331d577a5aa2f5ef)))

;; def=Prims.fst(402,27-402,88); use=Vector.fst(63,22-68,18)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(63,22-68,18)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(63,22-68,18)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(63,22-68,18)
(and (implies 
;; def=Vector.fst(63,18-63,19); use=Vector.fst(63,28-63,29)
(and 
;; def=Vector.fst(63,18-63,19); use=Vector.fst(63,28-63,29)
(not 
;; def=Vector.fst(63,18-63,19); use=Vector.fst(63,28-63,29)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Vector.fst(63,22-68,18)
(not 
;; def=Vector.fst(63,18-63,19); use=Vector.fst(63,28-63,29)
(BoxBool_proj_0 (Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_1
x_bb4e1c9af0265270f8e7a5f250f730e2_3
...
;; def=Prims.fst(413,99-413,120); use=Vector.fst(63,22-68,18)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=Vector.fst(63,18-65,15); use=Vector.fst(63,28-65,15)
(= x_1fd74c304e163c0d8adcb88881fe80b8_4
(Vector.VCons x_fe28d8bcde588226b4e538b35321de05_1
@x1
@x2
...
;; def=Prims.fst(389,2-389,39); use=Vector.fst(63,22-68,18)
(and (implies 
;; def=Vector.fst(66,7-66,11); use=Vector.fst(66,7-66,11)
(= (ApplyTT x_ad4fa64b8bde7a35b571dab333de24e9_2
@x1)
(BoxBool true))


;; def=Vector.fst(62,75-62,78); use=Vector.fst(67,14-67,16)
(or label_2
...
;; def=Vector.fst(66,7-68,18); use=Vector.fst(66,7-68,18)
(= (ApplyTT x_ad4fa64b8bde7a35b571dab333de24e9_2
@x1)
@x5)
)

;; def=Vector.fst(62,33-68,18); use=Vector.fst(68,16-68,18)
(or label_3

;; def=Vector.fst(63,22-68,18); use=Vector.fst(68,16-68,18)
(Valid 
;; def=Vector.fst(63,22-68,18); use=Vector.fst(68,16-68,18)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(62,33-68,18); use=Vector.fst(68,16-68,18)
(and 
;; def=Vector.fst(62,33-63,17); use=Vector.fst(68,16-68,18)
(Valid 
;; def=Vector.fst(62,33-63,17); use=Vector.fst(68,16-68,18)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Vector.find.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Vector.find.fuel_instrumented_token () Term)
(declare-fun Vector.find (Term Term Term Term) Term)
(declare-fun Vector.find@tok () Term)
;;;;;;;;;;;;;;;;_: 'a -> Prims.bool
(declare-fun Tm_arrow_84543425b818e2d10a976186b8e8c250 (Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: 'a -> Prims.bool) -> v: vector 'a n -> FStar.Pervasives.Native.option (x: 'a{f x})
(declare-fun Tm_arrow_5070665e3a1424ad1e1a514de2ac5c83 () Term)


; </end encoding let rec find>


; encoding sigelt val Vector.zip'


; <Skipped val Vector.zip'/>
...
; Starting query at Vector.fst(71,30-75,31)
...
:named binder_x_fe28d8bcde588226b4e538b35321de05_3))
;;;;;;;;;;;;;;;;n : Prims.nat (Prims.nat)
(declare-fun x_bb4e1c9af0265270f8e7a5f250f730e2_4 () Term)
;;;;;;;;;;;;;;;;binder_x_bb4e1c9af0265270f8e7a5f250f730e2_4
;;; Fact-ids: 
(assert (! (HasType x_bb4e1c9af0265270f8e7a5f250f730e2_4
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_4))
;;;;;;;;;;;;;;;;v1 : Vector.vector a n (Vector.vector a n)
(declare-fun x_49f7eb260f7789f18adb7dbb2ba714df_5 () Term)
;;;;;;;;;;;;;;;;binder_x_49f7eb260f7789f18adb7dbb2ba714df_5
;;; Fact-ids: 
(assert (! (HasType x_49f7eb260f7789f18adb7dbb2ba714df_5
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_4))
:named binder_x_49f7eb260f7789f18adb7dbb2ba714df_5))
;;;;;;;;;;;;;;;;v2 : Vector.vector b n (Vector.vector b n)
(declare-fun x_b22ffd3ae8bcda01839665f8319f8020_6 () Term)
;;;;;;;;;;;;;;;;binder_x_b22ffd3ae8bcda01839665f8319f8020_6
;;; Fact-ids: 
(assert (! (HasType x_b22ffd3ae8bcda01839665f8319f8020_6
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_3
x_bb4e1c9af0265270f8e7a5f250f730e2_4))
:named binder_x_b22ffd3ae8bcda01839665f8319f8020_6))
(declare-fun Tm_refine_41d8d3c62b271fe62c7b4a2e53742257 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(70,33-75,31); use=Vector.fst(70,33-75,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_41d8d3c62b271fe62c7b4a2e53742257 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_41d8d3c62b271fe62c7b4a2e53742257 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_41d8d3c62b271fe62c7b4a2e53742257))

:named refinement_kinding_Tm_refine_41d8d3c62b271fe62c7b4a2e53742257))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(70,33-75,31); use=Vector.fst(70,33-75,31)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_41d8d3c62b271fe62c7b4a2e53742257 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Vector.fst(70,33-75,31); use=Vector.fst(70,33-75,31)
(or 
;; def=Vector.fst(71,30-75,31); use=Vector.fst(71,30-75,31)
(Valid 
;; def=Vector.fst(71,30-75,31); use=Vector.fst(71,30-75,31)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(70,33-75,31); use=Vector.fst(70,33-75,31)
(and 
;; def=Vector.fst(70,33-71,21); use=Vector.fst(70,33-71,21)
(Valid 
;; def=Vector.fst(70,33-71,21); use=Vector.fst(70,33-71,21)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Vector.fst(71,22-75,31); use=Vector.fst(71,22-75,31)
(or 
;; def=Vector.fst(71,30-75,31); use=Vector.fst(71,30-75,31)
(Valid 
;; def=Vector.fst(71,30-75,31); use=Vector.fst(71,30-75,31)
...
x_bb4e1c9af0265270f8e7a5f250f730e2_4)
@x4
x_49f7eb260f7789f18adb7dbb2ba714df_5)
)


;; def=Vector.fst(71,22-75,31); use=Vector.fst(71,22-75,31)
(and 
;; def=Vector.fst(71,22-71,24); use=Vector.fst(71,22-71,24)
(Valid 
;; def=Vector.fst(71,22-71,24); use=Vector.fst(71,22-71,24)
(Prims.op_Equals_Equals_Equals (Vector.vector @x3
@x2)
...
(Valid 
;; def=Vector.fst(71,30-75,31); use=Vector.fst(71,30-75,31)
(Prims.precedes (Vector.vector @x5
@x2)
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_3
x_bb4e1c9af0265270f8e7a5f250f730e2_4)
@x1
x_b22ffd3ae8bcda01839665f8319f8020_6)
)
)
)
)
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_41d8d3c62b271fe62c7b4a2e53742257))

:named refinement_interpretation_Tm_refine_41d8d3c62b271fe62c7b4a2e53742257))
;;;;;;;;;;;;;;;;haseq for Tm_refine_41d8d3c62b271fe62c7b4a2e53742257
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(70,33-75,31); use=Vector.fst(70,33-75,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_41d8d3c62b271fe62c7b4a2e53742257 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (Vector.vector @x3
@x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_41d8d3c62b271fe62c7b4a2e53742257 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_41d8d3c62b271fe62c7b4a2e53742257))

:named haseqTm_refine_41d8d3c62b271fe62c7b4a2e53742257))
(declare-fun Vector.zip_ (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;_: vector a n -> _: _: vector b n {n << n \/ n === n /\ (_ << v1 \/ _ === v1 /\ _ << v2)}   -> vector (a & b) n
(declare-fun Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf
Tm_type)
:named kinding_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(70,13-75,31); use=Vector.fst(70,33-75,31)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf))
:qid Vector_pre_typing_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf))

:named Vector_pre_typing_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(70,13-75,31); use=Vector.fst(70,33-75,31)
(forall ((@x0 Term))
...
@x3))
(HasType @x5
(Tm_refine_41d8d3c62b271fe62c7b4a2e53742257 @x3
@x1
@x4
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
...
@x4)
@x5)
(Vector.vector (FStar.Pervasives.Native.tuple2 @x1
@x2)
@x3)))
...
@x4)
@x5))
:qid Vector_interpretation_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Vector_interpretation_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf.2))
...
@x1)
@x2))
:qid Vector_interpretation_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf.3))
...
@x2)
@x3))
:qid Vector_interpretation_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf.4))
...
@x3)
@x4))
:qid Vector_interpretation_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf.5))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf))
:qid Vector_interpretation_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf))

:named Vector_interpretation_Tm_arrow_d6c7b0f795abd0d4047ab44cfee78baf))
(declare-fun Vector.zip_@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(71,8-71,12); use=Vector.fst(71,8-71,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.zip_@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Vector.zip_@tok
@x0)
@x1)
@x2)
@x3)
@x4))
:qid token_correspondence_Vector.zip_))

:named token_correspondence_Vector.zip_))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(71,8-71,12); use=Vector.fst(71,8-71,12)
...
:pattern ((Vector.zip_ @x1
@x2
@x3
@x4
@x5))
:qid function_token_typing_Vector.zip_.1))
)
 

:pattern ((ApplyTT @x0
Vector.zip_@tok))
:qid function_token_typing_Vector.zip_))

:named function_token_typing_Vector.zip_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Vector.fst(71,8-71,12); use=Vector.fst(71,8-71,12)
...
@x3
@x1)))
(HasType (Vector.zip_ @x0
@x1
@x2
@x3
@x4)
(Vector.vector (FStar.Pervasives.Native.tuple2 @x0
@x1)
@x2)))
 

:pattern ((Vector.zip_ @x0
@x1
@x2
@x3
@x4))
:qid typing_Vector.zip_))

:named typing_Vector.zip_))
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
...
; Encoding query formula : forall (k: Prims.pure_post (Vector.vector (a & b) n)).
;   (forall (x: Vector.vector (a & b) n). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(VNil? v1) /\ ~(VCons? v1) ==> Prims.l_False) /\
;   (v1 == Vector.VNil ==> 0 == n) /\
;   (~(VNil? v1) ==>
;     (forall (b: a) (b: Prims.nat) (b: Vector.vector a b).
;         v1 == Vector.VCons b b ==>
;         (~(VCons? v2) ==> Prims.l_False) /\
;         (forall (b: b) (b: Prims.nat) (b: Vector.vector b b).
;             v2 == Vector.VCons b b ==>
;             b == b /\ (b << n \/ b === n /\ (b << v1 \/ b === v1 /\ b << v2)) /\
;             (forall (any_result: Vector.vector b b).
;                 b == any_result ==>
;                 (forall (any_result: Vector.vector (a & b) b).
;                     Vector.zip' b b == any_result ==>
;                     (forall (any_result: Vector.vector (a & b) (b + 1)).
;                         Vector.VCons (b, b) (Vector.zip' b b) == any_result ==> b + 1 == n))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec zip'`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Vector.vector (FStar.Pervasives.Native.tuple2 x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3)
x_bb4e1c9af0265270f8e7a5f250f730e2_4)))

;; def=Prims.fst(402,27-402,88); use=Vector.fst(71,30-75,31)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(71,30-75,31)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Vector.fst(71,30-75,31)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(71,30-75,31)
(and (implies 
;; def=Vector.fst(71,22-71,24); use=Vector.fst(71,36-71,38)
(and 
;; def=Vector.fst(71,22-71,24); use=Vector.fst(71,36-71,38)
(not 
;; def=Vector.fst(71,22-71,24); use=Vector.fst(71,36-71,38)
...
label_1)
(implies 
;; def=Vector.fst(71,22-72,8); use=Vector.fst(71,36-72,8)
(= x_49f7eb260f7789f18adb7dbb2ba714df_5
(Vector.VNil x_fe28d8bcde588226b4e538b35321de05_2))


;; def=Vector.fst(20,21-71,21); use=Vector.fst(72,12-72,16)
(or label_2
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Vector.fst(71,30-75,31)
(not 
;; def=Vector.fst(71,22-71,24); use=Vector.fst(71,36-71,38)
(BoxBool_proj_0 (Vector.uu___is_VNil x_fe28d8bcde588226b4e538b35321de05_2
x_bb4e1c9af0265270f8e7a5f250f730e2_4
...
;; def=Prims.fst(413,99-413,120); use=Vector.fst(71,30-75,31)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=Vector.fst(71,22-73,15); use=Vector.fst(71,36-73,15)
(= x_49f7eb260f7789f18adb7dbb2ba714df_5
(Vector.VCons x_fe28d8bcde588226b4e538b35321de05_2
@x1
@x2
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(71,30-75,31)
(and (implies 
;; def=Vector.fst(74,8-74,19); use=Vector.fst(74,8-74,19)
(not 
;; def=Vector.fst(74,8-74,19); use=Vector.fst(74,8-74,19)
(BoxBool_proj_0 (Vector.uu___is_VCons x_fe28d8bcde588226b4e538b35321de05_3
x_bb4e1c9af0265270f8e7a5f250f730e2_4
x_b22ffd3ae8bcda01839665f8319f8020_6))
)
...
;; def=Prims.fst(459,77-459,89); use=Vector.fst(71,30-75,31)
(and 
;; def=Vector.fst(73,12-74,19); use=Vector.fst(75,27-75,30)
(or label_4
...
;; def=Vector.fst(70,33-75,31); use=Vector.fst(75,27-75,30)
(or label_5

;; def=Vector.fst(71,30-75,31); use=Vector.fst(75,27-75,30)
(Valid 
;; def=Vector.fst(71,30-75,31); use=Vector.fst(75,27-75,30)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Vector.fst(70,33-75,31); use=Vector.fst(75,27-75,30)
(and 
;; def=Vector.fst(70,33-71,21); use=Vector.fst(75,27-75,30)
(Valid 
;; def=Vector.fst(70,33-71,21); use=Vector.fst(75,27-75,30)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Vector.fst(71,22-75,31); use=Vector.fst(75,27-75,30)
(or 
;; def=Vector.fst(71,30-75,31); use=Vector.fst(75,27-75,30)
(Valid 
;; def=Vector.fst(71,30-75,31); use=Vector.fst(75,27-75,30)
...
;; def=Vector.fst(71,22-75,31); use=Vector.fst(75,27-75,30)
(and 
;; def=Vector.fst(71,22-71,24); use=Vector.fst(75,27-75,30)
(Valid 
;; def=Vector.fst(71,22-71,24); use=Vector.fst(75,27-75,30)
(Prims.op_Equals_Equals_Equals (Vector.vector x_fe28d8bcde588226b4e538b35321de05_2
@x2)
...
(Valid 
;; def=Vector.fst(71,30-75,31); use=Vector.fst(75,27-75,30)
(Prims.precedes (Vector.vector x_fe28d8bcde588226b4e538b35321de05_3
@x2)
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_3
x_bb4e1c9af0265270f8e7a5f250f730e2_4)
@x6
...
;; def=Prims.fst(451,66-451,102); use=Vector.fst(71,30-75,31)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Vector.vector x_fe28d8bcde588226b4e538b35321de05_3
@x5))

;; def=dummy(0,0-0,0); use=Vector.fst(71,30-75,31)
(= @x6
@x7)
)
...
(Vector.vector (FStar.Pervasives.Native.tuple2 x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3)
@x2))

;; def=Vector.fst(23,12-75,31); use=Vector.fst(71,30-75,31)
(= (Vector.zip_ x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3
@x2
@x3
@x6)
...
;; def=Vector.fst(70,74-75,31); use=Vector.fst(71,30-75,31)
(= (Vector.VCons (FStar.Pervasives.Native.tuple2 x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3)
(FStar.Pervasives.Native.Mktuple2 x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3
@x1
@x4)
@x2
...
;; def=Vector.fst(24,22-71,21); use=Vector.fst(75,4-75,31)
(or label_6
