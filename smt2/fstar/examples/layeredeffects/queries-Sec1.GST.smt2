...
(declare-fun Sec1.GST.state (Dummy_sort) Term)

; </end encoding let state>


; encoding sigelt type Sec1.GST.tag


; <Start encoding type Sec1.GST.tag>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Sec1.GST.tag () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Sec1.GST.R () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Sec1.GST.R
(declare-fun Sec1.GST.R@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Sec1.GST.RW () Term)
;;;;;;;;;;;;;;;;data constructor proxy: Sec1.GST.RW
(declare-fun Sec1.GST.RW@tok () Term)

; <start constructor Sec1.GST.tag>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Sec1.GST.tag ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
Sec1.GST.tag)))

; </end constructor Sec1.GST.tag>


; <start constructor Sec1.GST.R>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Sec1.GST.R ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
128)
(= __@x0
Sec1.GST.R)))

; </end constructor Sec1.GST.R>


; <start constructor Sec1.GST.RW>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Sec1.GST.RW ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
130)
(= __@x0
Sec1.GST.RW)))

; </end constructor Sec1.GST.RW>


; </end encoding type Sec1.GST.tag>


; encoding sigelt assume Sec1.GST.tag__uu___haseq


; <Start encoding assume Sec1.GST.tag__uu___haseq>


; </end encoding assume Sec1.GST.tag__uu___haseq>


; encoding sigelt val Sec1.GST.uu___is_R


; <Start encoding val Sec1.GST.uu___is_R>

(declare-fun Sec1.GST.uu___is_R (Term) Term)
;;;;;;;;;;;;;;;;projectee: tag -> Prims.bool
(declare-fun Tm_arrow_427b92e49346b3241f4f71381f5e086d () Term)
(declare-fun Sec1.GST.uu___is_R@tok () Term)

; </end encoding val Sec1.GST.uu___is_R>
...
; encoding sigelt val Sec1.GST.uu___is_RW


; <Start encoding val Sec1.GST.uu___is_RW>

(declare-fun Sec1.GST.uu___is_RW (Term) Term)

(declare-fun Sec1.GST.uu___is_RW@tok () Term)

; </end encoding val Sec1.GST.uu___is_RW>


; encoding sigelt let uu___is_RW


; <Skipped let uu___is_RW/>
...
(declare-fun Sec1.GST.op (Term Term) Term)
;;;;;;;;;;;;;;;;t0: tag -> t1: tag -> tag
(declare-fun Tm_arrow_2b6b70c942d79a05488c6045dd1d21e2 () Term)
(declare-fun Sec1.GST.op@tok () Term)
...
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! (HasType Sec1.GST.RW@tok
Sec1.GST.tag)
:named typing_tok_Sec1.GST.RW@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! (HasType Sec1.GST.R@tok
Sec1.GST.tag)
:named typing_tok_Sec1.GST.R@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Sec1.GST.uu___is_RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(3,17-3,19); use=Sec1.GST.fst(3,17-3,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Sec1.GST.tag)
(HasType (Sec1.GST.uu___is_RW @x0)
Prims.bool))
 

:pattern ((Sec1.GST.uu___is_RW @x0))
:qid typing_Sec1.GST.uu___is_RW))

:named typing_Sec1.GST.uu___is_RW))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Sec1.GST.uu___is_R; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(3,13-3,14); use=Sec1.GST.fst(3,13-3,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Sec1.GST.tag)
(HasType (Sec1.GST.uu___is_R @x0)
Prims.bool))
 

:pattern ((Sec1.GST.uu___is_R @x0))
:qid typing_Sec1.GST.uu___is_R))

:named typing_Sec1.GST.uu___is_R))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! (HasType Sec1.GST.tag
Tm_type)
:named kinding_Sec1.GST.tag@tok))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(3,5-3,8); use=Sec1.GST.fst(3,5-3,8)
(forall ((@u0 Fuel) (@x1 Term))
...
@x1
Sec1.GST.tag))
:qid fuel_guarded_inversion_Sec1.GST.tag))

:named fuel_guarded_inversion_Sec1.GST.tag))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! (= Sec1.GST.RW@tok
Sec1.GST.RW)
:named equality_tok_Sec1.GST.RW@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! (= Sec1.GST.R@tok
Sec1.GST.R)
:named equality_tok_Sec1.GST.R@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;; def=Sec1.GST.fst(3,17-3,19); use=Sec1.GST.fst(3,17-3,19)
(forall ((@x0 Term))
 (! (= (Sec1.GST.uu___is_RW @x0)
(BoxBool (is-Sec1.GST.RW @x0)))
 

:pattern ((Sec1.GST.uu___is_RW @x0))
:qid disc_equation_Sec1.GST.RW))

:named disc_equation_Sec1.GST.RW))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Sec1.GST.uu___is_R; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(3,13-3,14); use=Sec1.GST.fst(3,13-3,14)
(forall ((@x0 Term))
 (! (= (Sec1.GST.uu___is_R @x0)
(BoxBool (is-Sec1.GST.R @x0)))
 

:pattern ((Sec1.GST.uu___is_R @x0))
:qid disc_equation_Sec1.GST.R))

:named disc_equation_Sec1.GST.R))
...
Sec1.GST.RW
Sec1.GST.tag))
:qid data_typing_intro_Sec1.GST.RW@tok))

:named data_typing_intro_Sec1.GST.RW@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(3,13-3,14); use=Sec1.GST.fst(3,13-3,14)
...
Sec1.GST.R
Sec1.GST.tag))
:qid data_typing_intro_Sec1.GST.R@tok))

:named data_typing_intro_Sec1.GST.R@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! (= 122
(Term_constr_id Sec1.GST.tag))
:named constructor_distinct_Sec1.GST.tag))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! (= 130
(Term_constr_id Sec1.GST.RW))
:named constructor_distinct_Sec1.GST.RW))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! (= 128
(Term_constr_id Sec1.GST.R))
:named constructor_distinct_Sec1.GST.R))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;;;;;;;;;;;;;;;Assumption: Sec1.GST.tag__uu___haseq
;;; Fact-ids: Name Sec1.GST.tag__uu___haseq; Namespace Sec1.GST
(assert (! (Valid (Prims.hasEq Sec1.GST.tag))
:named assumption_Sec1.GST.tag__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Sec1.GST.tag; Namespace Sec1.GST; Name Sec1.GST.R; Namespace Sec1.GST; Name Sec1.GST.RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(3,5-3,8); use=Sec1.GST.fst(3,5-3,8)
...
@x0
Sec1.GST.tag))
:qid Sec1.GST_pretyping_785f4d4493de3ef62683946a78d77527))

:named Sec1.GST_pretyping_785f4d4493de3ef62683946a78d77527))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
; Starting query at Sec1.GST.fst(6,2-8,30)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (t: Sec1.GST.tag).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Type).
;     (forall (x: Type). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     ~(R? t) /\ ~(RW? t) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let gst`
...
;; def=Prims.fst(402,27-402,88); use=Sec1.GST.fst(6,2-8,30)
(forall ((@x3 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Sec1.GST.fst(6,2-8,30)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Sec1.GST.fst(6,2-8,30)
(ApplyTT @x2
@x3)
...
;; def=Sec1.GST.fst(5,18-5,19); use=Sec1.GST.fst(6,8-6,9)
(not 
;; def=Sec1.GST.fst(5,18-5,19); use=Sec1.GST.fst(6,8-6,9)
(BoxBool_proj_0 (Sec1.GST.uu___is_R @x1))
)
...
(not 
;; def=Sec1.GST.fst(5,18-5,19); use=Sec1.GST.fst(6,8-6,9)
(BoxBool_proj_0 (Sec1.GST.uu___is_RW @x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Sec1.GST.gst, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_Sec1.GST.R, disc_equation_Sec1.GST.RW, fuel_guarded_inversion_Sec1.GST.tag, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let gst


; <Start encoding let gst>

(declare-fun Sec1.GST.gst (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> t: tag -> Type
(declare-fun Tm_arrow_340fb0b1752486a006fd960d430c6018 () Term)
(declare-fun Sec1.GST.gst@tok () Term)
;;;;;;;;;;;;;;;;_: state -> a & state
(declare-fun Tm_arrow_1f5007a854b30e0c869da30d41c00846 (Term) Term)
;;;;;;;;;;;;;;;;_: state -> a
(declare-fun Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 (Term) Term)

; </end encoding let gst>
...
(declare-fun Sec1.GST.return (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> gst a R
(declare-fun Tm_arrow_8fda4fa45002e9ceca2c128e1929d58d () Term)
(declare-fun Sec1.GST.return@tok () Term)

(declare-fun Tm_abs_c353b81e514f3b406f2eeeb6c8aa43ec (Term Term) Term)

; </end encoding let return>


; encoding sigelt let lift_r_rw


; <Start encoding let lift_r_rw>

(declare-fun Sec1.GST.lift_r_rw (Term Term) Term)
;;;;;;;;;;;;;;;;g: gst a R -> gst a RW
(declare-fun Tm_arrow_44127854095cc70b3c05d2f432cc5b31 () Term)
(declare-fun Sec1.GST.lift_r_rw@tok () Term)

(declare-fun Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1 (Term Term) Term)

; </end encoding let lift_r_rw>
...
;;;;;;;;;;;;;;;;typing_Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1
;;; Fact-ids: Name Sec1.GST.lift_r_rw; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(14,21-14,27); use=Sec1.GST.fst(14,21-14,27)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1 @x0
@x1)
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x1))
 

:pattern ((Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1 @x0
@x1))
:qid typing_Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1))

:named typing_Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Sec1.GST.state; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(2,4-2,9); use=Sec1.GST.fst(2,4-2,9)
(forall ((@u0 Dummy_sort))
 (! (HasType (Sec1.GST.state @u0)
Prims.eqtype)
 

:pattern ((Sec1.GST.state @u0))
:qid typing_Sec1.GST.state))

:named typing_Sec1.GST.state))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Sec1.GST.op; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(4,4-4,6); use=Sec1.GST.fst(4,4-4,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Sec1.GST.tag)
(HasType @x1
Sec1.GST.tag))
(HasType (Sec1.GST.op @x0
@x1)
Sec1.GST.tag))
 

:pattern ((Sec1.GST.op @x0
@x1))
:qid typing_Sec1.GST.op))

:named typing_Sec1.GST.op))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Sec1.GST.lift_r_rw; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(12,4-12,13); use=Sec1.GST.fst(12,4-12,13)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Sec1.GST.gst @x0
Sec1.GST.R@tok)))
(HasType (Sec1.GST.lift_r_rw @x0
@x1)
(Sec1.GST.gst @x0
Sec1.GST.RW@tok)))
 

:pattern ((Sec1.GST.lift_r_rw @x0
@x1))
:qid typing_Sec1.GST.lift_r_rw))

:named typing_Sec1.GST.lift_r_rw))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Sec1.GST.gst; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(5,4-5,7); use=Sec1.GST.fst(5,4-5,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Sec1.GST.tag))
(HasType (Sec1.GST.gst @x0
@x1)
Tm_type))
 

:pattern ((Sec1.GST.gst @x0
@x1))
:qid typing_Sec1.GST.gst))

:named typing_Sec1.GST.gst))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.int; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14
;;; Fact-ids: Name Sec1.GST.gst; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(5,9-7,15); use=Sec1.GST.fst(7,10-7,20)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x0)
Tm_type))
:qid kinding_Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14))

:named kinding_Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1f5007a854b30e0c869da30d41c00846
;;; Fact-ids: Name Sec1.GST.gst; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(8,11-8,29); use=Sec1.GST.fst(8,11-8,29)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x0)
Tm_type))
:qid kinding_Tm_arrow_1f5007a854b30e0c869da30d41c00846))

:named kinding_Tm_arrow_1f5007a854b30e0c869da30d41c00846))
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1
;;; Fact-ids: Name Sec1.GST.lift_r_rw; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(14,21-14,27); use=Sec1.GST.fst(14,21-14,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1 @x1
@x2)
@x0)
(FStar.Pervasives.Native.Mktuple2 @x2
(Sec1.GST.state Dummy_value)
(ApplyTT @x1
@x0)
@x0))
 

:pattern ((ApplyTT (Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1))

:named interpretation_Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
:qid equation_Sec1.GST.state))

:named equation_Sec1.GST.state))
;;;;;;;;;;;;;;;;Equation for Sec1.GST.op
;;; Fact-ids: Name Sec1.GST.op; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(4,4-4,6); use=Sec1.GST.fst(4,4-4,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Sec1.GST.op @x0
@x1)
(let ((@lb2 (FStar.Pervasives.Native.Mktuple2 Sec1.GST.tag
Sec1.GST.tag
@x0
@x1)))
(ite (is-Sec1.GST.RW (FStar.Pervasives.Native.Mktuple2__2 @lb2))
Sec1.GST.RW@tok
(ite (is-Sec1.GST.RW (FStar.Pervasives.Native.Mktuple2__1 @lb2))
Sec1.GST.RW@tok
Sec1.GST.R@tok))))
...
:pattern ((Sec1.GST.op @x0
@x1))
:qid equation_Sec1.GST.op))

:named equation_Sec1.GST.op))
;;;;;;;;;;;;;;;;Equation for Sec1.GST.lift_r_rw
;;; Fact-ids: Name Sec1.GST.lift_r_rw; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(12,4-12,13); use=Sec1.GST.fst(12,4-12,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Sec1.GST.lift_r_rw @x0
@x1)
(Tm_abs_2d5879fa2d03ea229bbae67ba018b9e1 @x1
@x0))
 

:pattern ((Sec1.GST.lift_r_rw @x0
@x1))
:qid equation_Sec1.GST.lift_r_rw))

:named equation_Sec1.GST.lift_r_rw))
;;;;;;;;;;;;;;;;Equation for Sec1.GST.gst
;;; Fact-ids: Name Sec1.GST.gst; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(5,4-5,7); use=Sec1.GST.fst(5,4-5,7)
(forall ((@x0 Term) (@x1 Term))
...
@x1)
(let ((@lb2 @x1))
(ite (is-Sec1.GST.R @lb2)
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x0)
(ite (is-Sec1.GST.RW @lb2)
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x0)
Tm_unit))))
 

:pattern ((Sec1.GST.gst @x0
@x1))
:qid equation_Sec1.GST.gst))

:named equation_Sec1.GST.gst))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,22-59,30); use=FStar.Pervasives.Native.fst(59,22-59,30)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x2)))
:qid Sec1.GST_pre_typing_Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14))

:named Sec1.GST_pre_typing_Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Sec1.GST.gst; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(8,11-8,29); use=Sec1.GST.fst(8,11-8,29)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x2)))
:qid Sec1.GST_pre_typing_Tm_arrow_1f5007a854b30e0c869da30d41c00846))

:named Sec1.GST_pre_typing_Tm_arrow_1f5007a854b30e0c869da30d41c00846))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14
;;; Fact-ids: Name Sec1.GST.gst; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(5,9-7,15); use=Sec1.GST.fst(7,10-7,20)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x1))
(and 
;; def=Sec1.GST.fst(5,9-7,15); use=Sec1.GST.fst(7,10-7,20)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid Sec1.GST_interpretation_Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x1)))
:qid Sec1.GST_interpretation_Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14))

:named Sec1.GST_interpretation_Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1f5007a854b30e0c869da30d41c00846
;;; Fact-ids: Name Sec1.GST.gst; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(8,11-8,29); use=Sec1.GST.fst(8,11-8,29)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid Sec1.GST_interpretation_Tm_arrow_1f5007a854b30e0c869da30d41c00846.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x1)))
:qid Sec1.GST_interpretation_Tm_arrow_1f5007a854b30e0c869da30d41c00846))

:named Sec1.GST_interpretation_Tm_arrow_1f5007a854b30e0c869da30d41c00846))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! 
...
; Starting query at Sec1.GST.fst(17,4-19,12)
...
; Encoding query formula : forall (a: Type) (t0: Sec1.GST.tag) (t1: Sec1.GST.tag) (g: Sec1.GST.gst a t0).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post (Sec1.GST.gst a (Sec1.GST.op t0 t1))).
;     (forall (x: Sec1.GST.gst a (Sec1.GST.op t0 t1)). {:pattern Prims.guard_free (k x)}
;         Prims.auto_squash (k x)) ==>
;     ((t0, t1) == (Sec1.GST.R, Sec1.GST.RW) ==>
;       Prims.has_type g (_: Sec1.GST.state -> a) /\
;       (forall (any_result: Sec1.GST.gst a t0).
;           g == any_result ==>
;           (forall (any_result: Sec1.GST.gst a Sec1.GST.RW).
;               Sec1.GST.lift_r_rw g == any_result ==>
;               Prims.has_type (Sec1.GST.lift_r_rw g)
;                 (match Sec1.GST.op t0 t1 with
;                   | Sec1.GST.R -> _: Sec1.GST.state -> a
;                   | Sec1.GST.RW -> _: Sec1.GST.state -> a & Sec1.GST.state)))) /\
;     (~(R? (t0, t1)._1 && RW? (t0, t1)._2) ==>
;       (forall (b: Sec1.GST.tag & Sec1.GST.tag).
;           (t0, t1) == b ==>
;           Prims.has_type g
;             (match Sec1.GST.op t0 t1 with
;               | Sec1.GST.R -> _: Sec1.GST.state -> a
...
; Context: While encoding a query
; While typechecking the top-level declaration `let lift`
...
(Prims.pure_post (Sec1.GST.gst @x0
(Sec1.GST.op @x1
@x2))))

;; def=Prims.fst(402,27-402,88); use=Sec1.GST.fst(17,4-19,12)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Sec1.GST.fst(17,4-19,12)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Sec1.GST.fst(17,4-19,12)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(389,2-389,39); use=Sec1.GST.fst(17,4-19,12)
(and (implies 
;; def=Sec1.GST.fst(17,10-18,11); use=Sec1.GST.fst(17,10-18,11)
(= (FStar.Pervasives.Native.Mktuple2 Sec1.GST.tag
Sec1.GST.tag
@x1
@x2)
(FStar.Pervasives.Native.Mktuple2 Sec1.GST.tag
...
;; def=Prims.fst(459,77-459,89); use=Sec1.GST.fst(17,4-19,12)
(and 
;; def=Sec1.GST.fst(15,21-15,22); use=Sec1.GST.fst(18,28-18,29)
(or label_1
(HasType @x3
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x0)))


;; def=Prims.fst(451,66-451,102); use=Sec1.GST.fst(17,4-19,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Sec1.GST.gst @x0
@x1))

;; def=Sec1.GST.fst(12,18-15,22); use=Sec1.GST.fst(17,4-19,12)
(= @x3
@x5)
)
...
;; def=Sec1.GST.fst(16,4-18,29); use=Sec1.GST.fst(17,4-19,12)
(= (Sec1.GST.lift_r_rw @x0
@x3)
@x6)
)

;; def=Sec1.GST.fst(18,15-18,29); use=Sec1.GST.fst(18,15-18,29)
(or label_2
(HasType (Sec1.GST.lift_r_rw @x0
@x3)
(let ((@lb7 (Sec1.GST.op @x1
@x2)))
(ite (is-Sec1.GST.R @lb7)
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x0)
(ite (is-Sec1.GST.RW @lb7)
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x0)
Tm_unit)))))
)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Sec1.GST.fst(17,4-19,12)
(not 
;; def=Sec1.GST.fst(18,6-18,11); use=Sec1.GST.fst(18,6-18,11)
(and (BoxBool_proj_0 (Sec1.GST.uu___is_R (FStar.Pervasives.Native.__proj__Mktuple2__item___1 Sec1.GST.tag
Sec1.GST.tag
(FStar.Pervasives.Native.Mktuple2 Sec1.GST.tag
Sec1.GST.tag
@x1
@x2))))
(BoxBool_proj_0 (Sec1.GST.uu___is_RW (FStar.Pervasives.Native.__proj__Mktuple2__item___2 Sec1.GST.tag
Sec1.GST.tag
(FStar.Pervasives.Native.Mktuple2 Sec1.GST.tag
Sec1.GST.tag
@x1
...
;; def=Prims.fst(413,99-413,120); use=Sec1.GST.fst(17,4-19,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Pervasives.Native.tuple2 Sec1.GST.tag
Sec1.GST.tag))

;; def=Sec1.GST.fst(17,10-19,7); use=Sec1.GST.fst(17,10-19,7)
(= (FStar.Pervasives.Native.Mktuple2 Sec1.GST.tag
Sec1.GST.tag
@x1
@x2)
...
;; def=Sec1.GST.fst(15,21-15,22); use=Sec1.GST.fst(19,11-19,12)
(or label_3
(HasType @x3
(let ((@lb6 (Sec1.GST.op @x1
@x2)))
(ite (is-Sec1.GST.R @lb6)
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x0)
(ite (is-Sec1.GST.RW @lb6)
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x0)
Tm_unit)))))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Sec1.GST.lift, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Sec1.GST_pretyping_785f4d4493de3ef62683946a78d77527, constructor_distinct_Sec1.GST.R, constructor_distinct_Sec1.GST.RW, disc_equation_Sec1.GST.R, disc_equation_Sec1.GST.RW, equality_tok_Sec1.GST.R@tok, equality_tok_Sec1.GST.RW@tok, equation_Sec1.GST.gst, equation_Sec1.GST.op, fuel_guarded_inversion_Sec1.GST.tag, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, typing_Sec1.GST.op, typing_tok_Sec1.GST.RW@tok
...
; encoding sigelt let lift


; <Start encoding let lift>

(declare-fun Sec1.GST.lift (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;g: gst a t0 -> gst a (op t0 t1)
(declare-fun Tm_arrow_c39982d9ead60d1174180302a0dc85be () Term)
(declare-fun Sec1.GST.lift@tok () Term)

; </end encoding let lift>


; encoding sigelt let bind_R


; <Start encoding let bind_R>

;;;;;;;;;;;;;;;;_: a -> gst b R
(declare-fun Tm_arrow_b2f097b73d3eaaea9797168949ddc623 (Term Term) Term)
(declare-fun Sec1.GST.bind_R (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;f: gst a R -> g: (_: a -> gst b R) -> gst b R
(declare-fun Tm_arrow_2c8ba27814582e10895125305925eb26 () Term)
(declare-fun Sec1.GST.bind_R@tok () Term)


(declare-fun Tm_abs_0d9e87d30155b0ba08df4b517a772dfa (Term Term Term) Term)

; </end encoding let bind_R>


; encoding sigelt let bind_RW


; <Start encoding let bind_RW>

;;;;;;;;;;;;;;;;_: a -> gst b RW
(declare-fun Tm_arrow_a527520640c5d08aeb1b80f645280f50 (Term Term) Term)
(declare-fun Sec1.GST.bind_RW (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;f: gst a RW -> g: (_: a -> gst b RW) -> gst b RW
(declare-fun Tm_arrow_373a9a9dd7d3f8f06f076b0fcaa5cde9 () Term)
(declare-fun Sec1.GST.bind_RW@tok () Term)


(declare-fun Tm_abs_cdec80e174c0fe8dc6a8b518db567b29 (Term Term Term) Term)

; </end encoding let bind_RW>

;;;;;;;;;;;;;;;;typing_Tm_abs_cdec80e174c0fe8dc6a8b518db567b29
;;; Fact-ids: Name Sec1.GST.bind_RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(27,20-29,12); use=Sec1.GST.fst(27,20-29,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_cdec80e174c0fe8dc6a8b518db567b29 @x0
@x1
@x2)
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x2))
 

:pattern ((Tm_abs_cdec80e174c0fe8dc6a8b518db567b29 @x0
@x1
@x2))
:qid typing_Tm_abs_cdec80e174c0fe8dc6a8b518db567b29))

:named typing_Tm_abs_cdec80e174c0fe8dc6a8b518db567b29))
;;;;;;;;;;;;;;;;typing_Tm_abs_0d9e87d30155b0ba08df4b517a772dfa
;;; Fact-ids: Name Sec1.GST.bind_R; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(24,6-24,11); use=Sec1.GST.fst(24,6-24,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_0d9e87d30155b0ba08df4b517a772dfa @x0
@x1
@x2)
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x2))
 

:pattern ((Tm_abs_0d9e87d30155b0ba08df4b517a772dfa @x0
@x1
@x2))
:qid typing_Tm_abs_0d9e87d30155b0ba08df4b517a772dfa))

:named typing_Tm_abs_0d9e87d30155b0ba08df4b517a772dfa))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Sec1.GST.bind_RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(25,4-25,11); use=Sec1.GST.fst(25,4-25,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
Sec1.GST.RW@tok))
(HasType @x3
(Tm_arrow_a527520640c5d08aeb1b80f645280f50 @x1
@x0)))
(HasType (Sec1.GST.bind_RW @x0
@x1
@x2
@x3)
(Sec1.GST.gst @x1
...
:pattern ((Sec1.GST.bind_RW @x0
@x1
@x2
@x3))
:qid typing_Sec1.GST.bind_RW))

:named typing_Sec1.GST.bind_RW))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Sec1.GST.bind_R; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(20,4-20,10); use=Sec1.GST.fst(20,4-20,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
Sec1.GST.R@tok))
(HasType @x3
(Tm_arrow_b2f097b73d3eaaea9797168949ddc623 @x1
@x0)))
(HasType (Sec1.GST.bind_R @x0
@x1
@x2
@x3)
(Sec1.GST.gst @x1
...
:pattern ((Sec1.GST.bind_R @x0
@x1
@x2
@x3))
:qid typing_Sec1.GST.bind_R))

:named typing_Sec1.GST.bind_R))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b2f097b73d3eaaea9797168949ddc623
;;; Fact-ids: Name Sec1.GST.bind_R; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(20,12-20,45); use=Sec1.GST.fst(20,33-20,45)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_b2f097b73d3eaaea9797168949ddc623 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_b2f097b73d3eaaea9797168949ddc623 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_b2f097b73d3eaaea9797168949ddc623))

:named kinding_Tm_arrow_b2f097b73d3eaaea9797168949ddc623))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a527520640c5d08aeb1b80f645280f50
;;; Fact-ids: Name Sec1.GST.bind_RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(25,13-25,48); use=Sec1.GST.fst(25,35-25,48)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_a527520640c5d08aeb1b80f645280f50 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_a527520640c5d08aeb1b80f645280f50 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_a527520640c5d08aeb1b80f645280f50))

:named kinding_Tm_arrow_a527520640c5d08aeb1b80f645280f50))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_cdec80e174c0fe8dc6a8b518db567b29
;;; Fact-ids: Name Sec1.GST.bind_RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(27,20-29,12); use=Sec1.GST.fst(27,20-29,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_cdec80e174c0fe8dc6a8b518db567b29 @x1
@x2
@x3)
@x0)
(let ((@lb4 (ApplyTT @x2
...
:pattern ((ApplyTT (Tm_abs_cdec80e174c0fe8dc6a8b518db567b29 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_cdec80e174c0fe8dc6a8b518db567b29))

:named interpretation_Tm_abs_cdec80e174c0fe8dc6a8b518db567b29))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_0d9e87d30155b0ba08df4b517a772dfa
;;; Fact-ids: Name Sec1.GST.bind_R; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(24,6-24,11); use=Sec1.GST.fst(24,6-24,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_0d9e87d30155b0ba08df4b517a772dfa @x1
@x2
@x3)
@x0)
(ApplyTT (ApplyTT @x1
...
:pattern ((ApplyTT (Tm_abs_0d9e87d30155b0ba08df4b517a772dfa @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_0d9e87d30155b0ba08df4b517a772dfa))

:named interpretation_Tm_abs_0d9e87d30155b0ba08df4b517a772dfa))
;;;;;;;;;;;;;;;;Equation for Sec1.GST.bind_RW
;;; Fact-ids: Name Sec1.GST.bind_RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(25,4-25,11); use=Sec1.GST.fst(25,4-25,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3)
(Tm_abs_cdec80e174c0fe8dc6a8b518db567b29 @x3
@x2
@x1))
...
@x2
@x3))
:qid equation_Sec1.GST.bind_RW))

:named equation_Sec1.GST.bind_RW))
;;;;;;;;;;;;;;;;Equation for Sec1.GST.bind_R
;;; Fact-ids: Name Sec1.GST.bind_R; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(20,4-20,10); use=Sec1.GST.fst(20,4-20,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3)
(Tm_abs_0d9e87d30155b0ba08df4b517a772dfa @x3
@x2
@x1))
...
@x2
@x3))
:qid equation_Sec1.GST.bind_R))

:named equation_Sec1.GST.bind_R))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Sec1.GST.bind_R; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(20,12-20,45); use=Sec1.GST.fst(20,33-20,45)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_b2f097b73d3eaaea9797168949ddc623 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_b2f097b73d3eaaea9797168949ddc623 @x2
@x3)))
:qid Sec1.GST_pre_typing_Tm_arrow_b2f097b73d3eaaea9797168949ddc623))

:named Sec1.GST_pre_typing_Tm_arrow_b2f097b73d3eaaea9797168949ddc623))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Sec1.GST.bind_RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(25,13-25,48); use=Sec1.GST.fst(25,35-25,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_a527520640c5d08aeb1b80f645280f50 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_a527520640c5d08aeb1b80f645280f50 @x2
@x3)))
:qid Sec1.GST_pre_typing_Tm_arrow_a527520640c5d08aeb1b80f645280f50))

:named Sec1.GST_pre_typing_Tm_arrow_a527520640c5d08aeb1b80f645280f50))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b2f097b73d3eaaea9797168949ddc623
;;; Fact-ids: Name Sec1.GST.bind_R; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(20,12-20,45); use=Sec1.GST.fst(20,33-20,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid Sec1.GST_interpretation_Tm_arrow_b2f097b73d3eaaea9797168949ddc623.1))
...
(Tm_arrow_b2f097b73d3eaaea9797168949ddc623 @x1
@x2)))
:qid Sec1.GST_interpretation_Tm_arrow_b2f097b73d3eaaea9797168949ddc623))

:named Sec1.GST_interpretation_Tm_arrow_b2f097b73d3eaaea9797168949ddc623))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a527520640c5d08aeb1b80f645280f50
;;; Fact-ids: Name Sec1.GST.bind_RW; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(25,13-25,48); use=Sec1.GST.fst(25,35-25,48)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid Sec1.GST_interpretation_Tm_arrow_a527520640c5d08aeb1b80f645280f50.1))
...
(Tm_arrow_a527520640c5d08aeb1b80f645280f50 @x1
@x2)))
:qid Sec1.GST_interpretation_Tm_arrow_a527520640c5d08aeb1b80f645280f50))

:named Sec1.GST_interpretation_Tm_arrow_a527520640c5d08aeb1b80f645280f50))
(push) ;; push{2

; Starting query at Sec1.GST.fst(32,4-34,29)
...
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> gst b t
(declare-fun Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce
;;; Fact-ids: 
(assert (! 
;; def=Sec1.GST.fst(30,22-30,58); use=Sec1.GST.fst(30,46-30,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce))

:named kinding_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Sec1.GST.fst(30,22-30,58); use=Sec1.GST.fst(30,46-30,58)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid Sec1.GST_pre_typing_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce))

:named Sec1.GST_pre_typing_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce
;;; Fact-ids: 
(assert (! 
;; def=Sec1.GST.fst(30,22-30,58); use=Sec1.GST.fst(30,46-30,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce @x1
@x2
@x3))
(and 
;; def=Sec1.GST.fst(30,22-30,58); use=Sec1.GST.fst(30,46-30,58)
...
:pattern ((ApplyTT @x0
@x4))
:qid Sec1.GST_interpretation_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce.1))
...
@x2
@x3)))
:qid Sec1.GST_interpretation_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce))

:named Sec1.GST_interpretation_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce))
...
; Encoding query formula : forall (a: Type) (b: Type) (t: Sec1.GST.tag) (f: Sec1.GST.gst a t) (g: (_: a -> Sec1.GST.gst b t)).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post (Sec1.GST.gst b t)).
;     (forall (x: Sec1.GST.gst b t). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     (~(R? t) /\ ~(RW? t) ==> Prims.l_False) /\
;     (t == Sec1.GST.R ==>
;       Prims.has_type f (_: Sec1.GST.state -> a) /\
;       (forall (any_result: Sec1.GST.gst a t).
;           f == any_result ==>
;           (forall (_: a)
;               (_:
;               (match t with
;                 | Sec1.GST.R -> _: Sec1.GST.state -> b
;                 | Sec1.GST.RW -> _: Sec1.GST.state -> b & Sec1.GST.state)).
;               Prims.has_type _ (_: Sec1.GST.state -> b)) /\
;           (forall (any_result: (_: a -> Sec1.GST.gst b t)).
;               g == any_result ==>
;               (forall (any_result: Sec1.GST.gst b Sec1.GST.R).
;                   Sec1.GST.bind_R f g == any_result ==>
;                   Prims.has_type (Sec1.GST.bind_R f g)
;                     (match t with
;                       | Sec1.GST.R -> _: Sec1.GST.state -> b
;                       | Sec1.GST.RW -> _: Sec1.GST.state -> b & Sec1.GST.state))))) /\
;     (~(R? t) ==>
;       t == Sec1.GST.RW ==>
;       Prims.has_type f (_: Sec1.GST.state -> a & Sec1.GST.state) /\
;       (forall (any_result: Sec1.GST.gst a t).
;           f == any_result ==>
;           (forall (_: a)
;               (_:
...
;                 | Sec1.GST.R -> _: Sec1.GST.state -> b
;                 | Sec1.GST.RW -> _: Sec1.GST.state -> b & Sec1.GST.state)).
;               Prims.has_type _ (_: Sec1.GST.state -> b & Sec1.GST.state)) /\
;           (forall (any_result: (_: a -> Sec1.GST.gst b t)).
;               g == any_result ==>
;               (forall (any_result: Sec1.GST.gst b Sec1.GST.RW).
;                   Sec1.GST.bind_RW f g == any_result ==>
;                   Prims.has_type (Sec1.GST.bind_RW f g)
;                     (match t with
;                       | Sec1.GST.R -> _: Sec1.GST.state -> b
;                       | Sec1.GST.RW -> _: Sec1.GST.state -> b & Sec1.GST.state)))))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let bind_homogeneous`
...
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.pure_post (Sec1.GST.gst @x1
@x2)))

;; def=Prims.fst(402,27-402,88); use=Sec1.GST.fst(32,4-34,29)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Sec1.GST.fst(32,4-34,29)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Sec1.GST.fst(32,4-34,29)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=Sec1.GST.fst(32,4-34,29)
(and (implies 
;; def=Sec1.GST.fst(30,28-30,29); use=Sec1.GST.fst(32,10-32,11)
(and 
;; def=Sec1.GST.fst(30,28-30,29); use=Sec1.GST.fst(32,10-32,11)
(not 
;; def=Sec1.GST.fst(30,28-30,29); use=Sec1.GST.fst(32,10-32,11)
(BoxBool_proj_0 (Sec1.GST.uu___is_R @x2))
)
...
(not 
;; def=Sec1.GST.fst(30,28-30,29); use=Sec1.GST.fst(32,10-32,11)
(BoxBool_proj_0 (Sec1.GST.uu___is_RW @x2))
)
)

label_1)
(implies 
;; def=Sec1.GST.fst(30,28-33,7); use=Sec1.GST.fst(32,10-33,7)
(= @x2
Sec1.GST.R@tok)
...
;; def=Prims.fst(459,77-459,89); use=Sec1.GST.fst(32,4-34,29)
(and 
;; def=Sec1.GST.fst(30,31-30,32); use=Sec1.GST.fst(33,24-33,25)
(or label_2
(HasType @x3
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x0)))


;; def=Prims.fst(451,66-451,102); use=Sec1.GST.fst(32,4-34,29)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Sec1.GST.gst @x0
@x2))

;; def=Sec1.GST.fst(20,18-30,32); use=Sec1.GST.fst(32,4-34,29)
(= @x3
@x6)
)
...
;; def=Prims.fst(459,77-459,89); use=Sec1.GST.fst(32,4-34,29)
(and 
;; def=dummy(0,0-0,0); use=Sec1.GST.fst(33,26-33,27)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
@x0)
(HasType @x8
(let ((@lb9 @x2))
(ite (is-Sec1.GST.R @lb9)
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x1)
(ite (is-Sec1.GST.RW @lb9)
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x1)
Tm_unit)))))

;; def=Sec1.GST.fst(30,43-30,44); use=Sec1.GST.fst(33,26-33,27)
(or label_3
(HasType @x8
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x1)))
)
...
;; def=Sec1.GST.fst(20,30-30,44); use=Sec1.GST.fst(32,4-34,29)
(= @x4
@x7)
)
...
;; def=Sec1.GST.fst(31,4-33,27); use=Sec1.GST.fst(32,4-34,29)
(= (Sec1.GST.bind_R @x0
@x1
@x3
@x4)
...
;; def=Sec1.GST.fst(33,11-33,27); use=Sec1.GST.fst(33,11-33,27)
(or label_4
(HasType (Sec1.GST.bind_R @x0
@x1
@x3
...
(implies 
;; def=Prims.fst(389,18-389,39); use=Sec1.GST.fst(32,4-34,29)
(and 
;; def=Prims.fst(389,19-389,21); use=Sec1.GST.fst(32,4-34,29)
(not 
;; def=Sec1.GST.fst(30,28-30,29); use=Sec1.GST.fst(32,10-32,11)
(BoxBool_proj_0 (Sec1.GST.uu___is_R @x2))
)
...
;; def=Sec1.GST.fst(30,28-34,8); use=Sec1.GST.fst(32,10-34,8)
(= @x2
Sec1.GST.RW@tok)
)
...
;; def=Prims.fst(459,77-459,89); use=Sec1.GST.fst(32,4-34,29)
(and 
;; def=Sec1.GST.fst(30,31-30,32); use=Sec1.GST.fst(34,26-34,27)
(or label_5
(HasType @x3
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x0)))
...
;; def=Sec1.GST.fst(25,19-30,32); use=Sec1.GST.fst(32,4-34,29)
(= @x3
@x6)
)
...
;; def=Prims.fst(459,77-459,89); use=Sec1.GST.fst(32,4-34,29)
(and 
;; def=dummy(0,0-0,0); use=Sec1.GST.fst(34,28-34,29)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
@x0)
(HasType @x8
...
;; def=Sec1.GST.fst(30,43-30,44); use=Sec1.GST.fst(34,28-34,29)
(or label_6
(HasType @x8
(Tm_arrow_1f5007a854b30e0c869da30d41c00846 @x1)))
)
...
;; def=Sec1.GST.fst(25,32-30,44); use=Sec1.GST.fst(32,4-34,29)
(= @x4
@x7)
)
...
;; def=Sec1.GST.fst(31,4-34,29); use=Sec1.GST.fst(32,4-34,29)
(= (Sec1.GST.bind_RW @x0
@x1
@x3
@x4)
...
;; def=Sec1.GST.fst(34,12-34,29); use=Sec1.GST.fst(34,12-34,29)
(or label_7
(HasType (Sec1.GST.bind_RW @x0
@x1
@x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Sec1.GST.bind_homogeneous, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_Sec1.GST.R, constructor_distinct_Sec1.GST.RW, disc_equation_Sec1.GST.R, disc_equation_Sec1.GST.RW, equality_tok_Sec1.GST.R@tok, equality_tok_Sec1.GST.RW@tok, equation_Sec1.GST.gst, fuel_guarded_inversion_Sec1.GST.tag, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let bind_homogeneous


; <Start encoding let bind_homogeneous>

;;;;;;;;;;;;;;;;_: a -> gst b t
(declare-fun Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce (Term Term Term) Term)
(declare-fun Sec1.GST.bind_homogeneous (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;f: gst a t -> g: (_: a -> gst b t) -> gst b t
(declare-fun Tm_arrow_75a34d80b400c8b8c3c755e4d9d47c19 () Term)
(declare-fun Sec1.GST.bind_homogeneous@tok () Term)


; </end encoding let bind_homogeneous>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Sec1.GST.lift; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(15,4-15,8); use=Sec1.GST.fst(15,4-15,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:pattern ((Sec1.GST.lift @x0
@x1
@x2
@x3))
:qid typing_Sec1.GST.lift))

:named typing_Sec1.GST.lift))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce
;;; Fact-ids: Name Sec1.GST.bind_homogeneous; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(30,22-30,58); use=Sec1.GST.fst(30,46-30,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce @x0
...
@x2
@x3)
(let ((@lb4 (FStar.Pervasives.Native.Mktuple2 Sec1.GST.tag
Sec1.GST.tag
@x1
@x2)))
(ite (and (is-Sec1.GST.R (FStar.Pervasives.Native.Mktuple2__1 @lb4))
(is-Sec1.GST.RW (FStar.Pervasives.Native.Mktuple2__2 @lb4)))
(Sec1.GST.lift_r_rw @x0
@x3)
@x3)))
...
@x2
@x3))
:qid equation_Sec1.GST.lift))

:named equation_Sec1.GST.lift))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Sec1.GST.bind_homogeneous; Namespace Sec1.GST
(assert (! 
;; def=Sec1.GST.fst(30,22-30,58); use=Sec1.GST.fst(30,46-30,58)
...
; Starting query at Sec1.GST.fst(37,4-38,56)
...
;   (t1: Sec1.GST.tag)
;   (f: Sec1.GST.gst a t0)
;   (g: (_: a -> Sec1.GST.gst b t1)).
;   (*  - Could not prove post-condition
; *)
;   forall (x: a).
;     (*  - Could not prove post-condition
; *)
;     Prims.has_type (Sec1.GST.lift (g x))
;       (match Sec1.GST.op t0 t1 with
;         | Sec1.GST.R -> _: Sec1.GST.state -> b
;         | Sec1.GST.RW -> _: Sec1.GST.state -> b & Sec1.GST.state)
...
@x2))
(HasType @x5
(Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce @x3
@x1
@x0)))

;; def=dummy(0,0-0,0); use=Sec1.GST.fst(37,4-38,56)
(forall ((@x6 Term))
 (! (implies (HasType @x6
@x0)

;; def=Sec1.GST.fst(38,35-38,55); use=Sec1.GST.fst(38,35-38,55)
(or label_1
(HasType (Sec1.GST.lift @x1
@x3
@x2
(ApplyTT @x5
@x6))
(let ((@lb7 (Sec1.GST.op @x2
@x3)))
(ite (is-Sec1.GST.R @lb7)
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x1)
(ite (is-Sec1.GST.RW @lb7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Sec1.GST.bind, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Sec1.GST_interpretation_Tm_arrow_93ccfb2cb417c6bb293ac790694d34ce, Sec1.GST_pretyping_785f4d4493de3ef62683946a78d77527, constructor_distinct_Sec1.GST.R, constructor_distinct_Sec1.GST.RW, equality_tok_Sec1.GST.R@tok, equality_tok_Sec1.GST.RW@tok, equation_Sec1.GST.gst, equation_Sec1.GST.lift, equation_Sec1.GST.op, fuel_guarded_inversion_Sec1.GST.tag, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, typing_Sec1.GST.lift, typing_Sec1.GST.op, typing_tok_Sec1.GST.RW@tok
...
(declare-fun Sec1.GST.bind (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> t0: tag -> t1: tag -> f: gst a t0 -> g: (_: a -> gst b t1) -> gst b (op t0 t1)
(declare-fun Tm_arrow_e25cc616ae8d284a38841ebec489f452 () Term)
(declare-fun Sec1.GST.bind@tok () Term)

;;;;;;;;;;;;;;;;x: a -> gst b (op t0 t1)
(declare-fun Tm_arrow_58970cff9a69c0f87adbc4b1b193f1b6 (Term Term Term Term) Term)
(declare-fun Tm_abs_11b39c462faec7d7874142a2acee43e5 (Term Term Term Term Term) Term)

; </end encoding let bind>


; encoding sigelt let gst_read


; <Start encoding let gst_read>

(declare-fun Sec1.GST.gst_read (Dummy_sort) Term)

; </end encoding let gst_read>


; encoding sigelt let gst_write


; <Start encoding let gst_write>

(declare-fun Sec1.GST.gst_write (Term) Term)
;;;;;;;;;;;;;;;;s: state -> gst Prims.unit RW
(declare-fun Tm_arrow_e4516a8aee5cf4381554f9e5119a1c83 () Term)
(declare-fun Sec1.GST.gst_write@tok () Term)
;;;;;;;;;;;;;;;;_: state -> Prims.unit & state
(declare-fun Tm_arrow_f233bc7a7e82f0f632b94ec234abdcb4 () Term)
(declare-fun Tm_abs_ed08f446bb01aa0b66c87bc6923cb8d6 (Term) Term)

; </end encoding let gst_write>


; encoding sigelt layered_effect { GST ... }


; <Skipped layered_effect { GST ... }/>
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Sec1.GST.read (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Sec1.GST.read@tok () Term)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Sec1.GST.write (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Sec1.GST.write@tok () Term)
...
; Starting query at Sec1.GST.fst(56,4-56,17)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=Sec1.GST.fst(52,47-52,48)
(forall ((@x0 Term))
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,54); use=Sec1.GST.fst(52,47-52,48)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_61bb9550f39772f18eaab129c43c3788 @x2)))
:qid Sec1.GST_pre_typing_Tm_arrow_61bb9550f39772f18eaab129c43c3788))

:named Sec1.GST_pre_typing_Tm_arrow_61bb9550f39772f18eaab129c43c3788))
...
:pattern ((ApplyTT @x0
@x2))
:qid Sec1.GST_interpretation_Tm_arrow_61bb9550f39772f18eaab129c43c3788.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_61bb9550f39772f18eaab129c43c3788 @x1)))
:qid Sec1.GST_interpretation_Tm_arrow_61bb9550f39772f18eaab129c43c3788))

:named Sec1.GST_interpretation_Tm_arrow_61bb9550f39772f18eaab129c43c3788))
(declare-fun Tm_abs_6ffc06f5d789cf42c73d4f163a977cc0 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_6ffc06f5d789cf42c73d4f163a977cc0
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(635,86-635,95); use=Sec1.GST.fst(52,47-52,48)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: 
(assert (! 
;; def=Sec1.GST.fst(52,14-52,15); use=Sec1.GST.fst(52,47-52,48)
(forall ((@x0 Term) (@x1 Term))
...
;; def=Prims.fst(635,71-635,97); use=Sec1.GST.fst(52,47-52,48)
(not 
;; def=Prims.fst(635,72-635,97); use=Sec1.GST.fst(52,47-52,48)
(Valid 
;; def=Prims.fst(635,72-635,97); use=Sec1.GST.fst(52,47-52,48)
(ApplyTT @x2
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(630,69-630,73); use=Sec1.GST.fst(52,47-52,48)
(forall ((@x0 Term))
...
;;; Fact-ids: 
(assert (! 
;; def=Sec1.GST.fst(52,14-52,38); use=Sec1.GST.fst(52,34-52,48)
(forall ((@x0 Term) (@x1 Term))
...
(Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd @x2
@x3)))
:qid Sec1.GST_pre_typing_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))

:named Sec1.GST_pre_typing_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))
...
(forall ((@x3 Term))
 (! (implies (and 
;; def=Prims.fst(630,56-630,74); use=Sec1.GST.fst(52,47-52,48)
(Valid 
;; def=Prims.fst(630,56-630,74); use=Sec1.GST.fst(52,47-52,48)
(ApplyTT @x2
...
:pattern ((ApplyTT @x0
@x3))
:qid Sec1.GST_interpretation_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd.1))
...
(Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd @x1
@x2)))
:qid Sec1.GST_interpretation_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))

:named Sec1.GST_interpretation_Tm_arrow_c4804ca26ade2f3859400eebcb37ddbd))



(declare-fun Tm_abs_2abc29b9f5eda55ba947030beb38a985 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_2abc29b9f5eda55ba947030beb38a985
;;; Fact-ids: 
(assert (! 
;; def=Sec1.GST.fst(56,13-56,17); use=Sec1.GST.fst(56,13-56,17)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_2abc29b9f5eda55ba947030beb38a985 @x0
@x1)
(Tm_arrow_9adf3a70f2b3caa8cd0c779dc4792e14 @x1))
 

:pattern ((Tm_abs_2abc29b9f5eda55ba947030beb38a985 @x0
@x1))
:qid typing_Tm_abs_2abc29b9f5eda55ba947030beb38a985))

:named typing_Tm_abs_2abc29b9f5eda55ba947030beb38a985))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2abc29b9f5eda55ba947030beb38a985
;;; Fact-ids: 
(assert (! 
;; def=Sec1.GST.fst(56,13-56,17); use=Sec1.GST.fst(56,13-56,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_2abc29b9f5eda55ba947030beb38a985 @x1
@x2)
@x0)
(ApplyTT @x1
Tm_unit))
...
:pattern ((ApplyTT (Tm_abs_2abc29b9f5eda55ba947030beb38a985 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_2abc29b9f5eda55ba947030beb38a985))

:named interpretation_Tm_abs_2abc29b9f5eda55ba947030beb38a985))
...
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (Sec1.GST.gst a Sec1.GST.R)).
;     wp (fun _ -> Prims.l_True) /\
;     (forall (pure_result: Sec1.GST.gst a Sec1.GST.R). Prims.auto_squash (p pure_result)) ==>
;     (forall (s: Sec1.GST.state).
;         (*  - Could not prove post-condition
; *) Prims.auto_squash (wp (fun _ -> Prims.l_True))) /\
;     (forall (any_result: Sec1.GST.gst a Sec1.GST.R).
;         any_result == (fun _ -> f ()) ==>
;         (forall (return_val: Sec1.GST.gst a Sec1.GST.R). return_val == any_result ==> p return_val))


; Context: While encoding a query
; While typechecking the top-level declaration `let lift_pure`
...
;; def=Sec1.GST.fst(54,19-54,37); use=Sec1.GST.fst(56,4-56,17)
(Valid 
;; def=Sec1.GST.fst(54,19-54,37); use=Sec1.GST.fst(56,4-56,17)
(ApplyTT @x1
...
;; def=Prims.fst(441,36-441,97); use=Sec1.GST.fst(56,4-56,17)
(forall ((@x4 Term))
 (! (implies (or label_1
(HasType @x4
(Sec1.GST.gst @x0
...
;; def=Prims.fst(441,83-441,96); use=Sec1.GST.fst(56,4-56,17)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Sec1.GST.fst(56,4-56,17)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=Sec1.GST.fst(56,4-56,17)
(and 
;; def=dummy(0,0-0,0); use=Sec1.GST.fst(56,4-56,17)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Sec1.GST.state Dummy_value))

;; def=Prims.fst(369,7-369,58); use=Sec1.GST.fst(56,13-56,17)
(or label_2

;; def=Prims.fst(369,7-369,58); use=Sec1.GST.fst(56,4-56,17)
(Valid 
;; def=Prims.fst(369,7-369,58); use=Sec1.GST.fst(56,4-56,17)
(ApplyTT @x1
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x0))
...
;; def=Prims.fst(451,66-451,102); use=Sec1.GST.fst(56,4-56,17)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Sec1.GST.gst @x0
Sec1.GST.R@tok))

;; def=Sec1.GST.fst(53,9-56,17); use=Sec1.GST.fst(56,4-56,17)
(= @x4
(Tm_abs_2abc29b9f5eda55ba947030beb38a985 @x2
@x0))
)
...
; encoding sigelt let lift_pure


; <Start encoding let lift_pure>
...
(declare-fun Sec1.GST.lift_pure (Term Term Term) Term)
...
(declare-fun Tm_refine_9a03c64a85c42ac6e4687b6f75de34d5 (Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> f: (_: Prims.unit -> Prims.PURE a) -> Prims.Pure (gst a R)
(declare-fun Tm_arrow_5e315645d20961fc7eed98f0eec86cb6 () Term)
(declare-fun Sec1.GST.lift_pure@tok () Term)
...
; </end encoding let lift_pure>

(push) ;; push{2

; Starting query at Sec1.GST.fst(58,0-58,34)
...
; Encoding query formula : forall (a: Type)
;   (wp: Prims.pure_wp a)
;   (p: Prims.pure_post (Sec1.GST.gst a Sec1.GST.R))
;   (q: Prims.pure_post (Sec1.GST.gst a Sec1.GST.R)).
;   (forall (x: Sec1.GST.gst a Sec1.GST.R). p x ==> q x) ==>
;   wp (fun _ -> Prims.l_True) /\
;   (forall (pure_result: Sec1.GST.gst a Sec1.GST.R). Prims.auto_squash (p pure_result)) ==>
;   wp (fun _ -> Prims.l_True) /\
;   (forall (pure_result: Sec1.GST.gst a Sec1.GST.R). Prims.auto_squash (q pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `sub_effect PURE ~> GST`
...
;; def=Sec1.GST.fst(54,19-54,37); use=Sec1.GST.fst(58,25-58,34)
(Valid 
;; def=Sec1.GST.fst(54,19-54,37); use=Sec1.GST.fst(58,25-58,34)
(ApplyTT @x1
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x0))
...
;; def=Prims.fst(441,36-441,97); use=Sec1.GST.fst(58,25-58,34)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Sec1.GST.gst @x0
Sec1.GST.R@tok))

;; def=Prims.fst(441,83-441,96); use=Sec1.GST.fst(58,25-58,34)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Sec1.GST.fst(58,25-58,34)
(ApplyTT @x2
@x4)
...
;; def=Prims.fst(441,29-441,97); use=Sec1.GST.fst(58,25-58,34)
(and 
;; def=Sec1.GST.fst(54,19-54,37); use=Sec1.GST.fst(58,25-58,34)
(or label_1
