...
; encoding sigelt #set-options "--print_universes"


; <Skipped #set-options "--print_universes"/>
...
(declare-fun DM4F.wp0 (Term Term) Term)

(declare-fun DM4F.wp0@tok () Term)
;;;;;;;;;;;;;;;;_: a & st -> Type
...
(declare-fun DM4F.st_monotonic (Term Term Term) Term)
;;;;;;;;;;;;;;;;w: wp0 st a -> Type
(declare-fun Tm_arrow_41baeba7ab4055a420e6546ed5704d67 () Term)
(declare-fun DM4F.st_monotonic@tok () Term)
...
(declare-fun DM4F.wp (Term Term) Term)

(declare-fun DM4F.wp@tok () Term)
(declare-fun Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce (Term Term) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name DM4F.wp0; Namespace DM4F
(assert (! 
;; def=DM4F.fst(9,5-9,8); use=DM4F.fst(9,5-9,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:named typing_DM4F.wp0))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name DM4F.wp; Namespace DM4F
(assert (! 
;; def=DM4F.fst(17,5-17,7); use=DM4F.fst(17,5-17,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
:named typing_DM4F.wp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name DM4F.st_monotonic; Namespace DM4F
(assert (! 
;; def=DM4F.fst(12,4-12,16); use=DM4F.fst(12,4-12,16)
...
(DM4F.wp0 @x0
@x1)))
(HasType (DM4F.st_monotonic @x0
@x1
@x2)
Tm_type))
 

:pattern ((DM4F.st_monotonic @x0
@x1
@x2))
:qid typing_DM4F.st_monotonic))

:named typing_DM4F.st_monotonic))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;; Fact-ids: Name DM4F.wp; Namespace DM4F
(assert (! 
;; def=DM4F.fst(17,15-17,43); use=DM4F.fst(17,15-17,43)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce))

:named refinement_kinding_Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce @x2
@x3))
(and (HasTypeFuel @u0
@x1
(DM4F.wp0 @x2
...
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(17,28-17,42)
(Valid 
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(17,28-17,42)
(DM4F.st_monotonic @x2
@x3
@x1)
)
))
...
(Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce @x2
@x3)))
:qid refinement_interpretation_Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce))

:named refinement_interpretation_Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name DM4F.st_monotonic; Namespace DM4F
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=DM4F.fst(15,12-15,14)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name DM4F.wp0; Namespace DM4F
(assert (! 
;; def=DM4F.fst(10,9-10,24); use=DM4F.fst(10,9-10,24)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name DM4F.wp0; Namespace DM4F
(assert (! 
;; def=DM4F.fst(9,10-10,34); use=DM4F.fst(10,2-10,34)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce
;;; Fact-ids: Name DM4F.wp; Namespace DM4F
(assert (! 
;; def=DM4F.fst(17,15-17,43); use=DM4F.fst(17,15-17,43)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce @x0
@x1)))
(Valid (Prims.hasEq (DM4F.wp0 @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce @x0
@x1))))
:qid haseqTm_refine_7d65da4998d4da77eee5d5ab706ad1ce))

:named haseqTm_refine_7d65da4998d4da77eee5d5ab706ad1ce))
...
:pattern ((DM4F.wp0 @x0
@x1))
:qid equation_DM4F.wp0))

:named equation_DM4F.wp0))
;;;;;;;;;;;;;;;;Equation for DM4F.wp
;;; Fact-ids: Name DM4F.wp; Namespace DM4F
(assert (! 
;; def=DM4F.fst(17,5-17,7); use=DM4F.fst(17,5-17,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (DM4F.wp @x0
@x1)
(Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce @x0
@x1))
 

:pattern ((DM4F.wp @x0
@x1))
:qid equation_DM4F.wp))

:named equation_DM4F.wp))
;;;;;;;;;;;;;;;;Equation for DM4F.st_monotonic
;;; Fact-ids: Name DM4F.st_monotonic; Namespace DM4F
(assert (! 
;; def=DM4F.fst(12,4-12,16); use=DM4F.fst(12,4-12,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (DM4F.st_monotonic @x0
@x1
@x2))

;; def=DM4F.fst(15,2-15,83); use=DM4F.fst(15,2-15,83)
(forall ((@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x3
@x0)
(HasType @x4
(Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1 @x0
@x1))
(HasType @x5
(Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1 @x0
@x1))

;; def=DM4F.fst(15,19-15,59); use=DM4F.fst(15,19-15,59)
...
;; def=DM4F.fst(15,33-15,43); use=DM4F.fst(15,33-15,43)
(Valid 
;; def=DM4F.fst(15,33-15,43); use=DM4F.fst(15,33-15,43)
(ApplyTT @x4
(FStar.Pervasives.Native.Mktuple2 @x1
...
;; def=DM4F.fst(15,48-15,58); use=DM4F.fst(15,48-15,58)
(Valid 
;; def=DM4F.fst(15,48-15,58); use=DM4F.fst(15,48-15,58)
(ApplyTT @x5
(FStar.Pervasives.Native.Mktuple2 @x1
...
;;no pats
:qid equation_DM4F.st_monotonic.2))


;; def=DM4F.fst(15,64-15,71); use=DM4F.fst(15,64-15,71)
(Valid 
;; def=DM4F.fst(15,64-15,71); use=DM4F.fst(15,64-15,71)
(ApplyTT (ApplyTT @x2
@x3)
...
;; def=DM4F.fst(15,76-15,83); use=DM4F.fst(15,76-15,83)
(Valid 
;; def=DM4F.fst(15,76-15,83); use=DM4F.fst(15,76-15,83)
(ApplyTT (ApplyTT @x2
@x3)
...
;;no pats
:qid equation_DM4F.st_monotonic.1))
)
...
@x1
@x2))
:qid equation_DM4F.st_monotonic))

:named equation_DM4F.st_monotonic))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;;;;;;;;;;;;;;;;Prop-typing for DM4F.st_monotonic
;;; Fact-ids: Name DM4F.st_monotonic; Namespace DM4F
(assert (! 
;; def=DM4F.fst(12,4-12,16); use=DM4F.fst(12,4-12,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(DM4F.wp0 @x0
@x1)))
(Valid (Prims.subtype_of (DM4F.st_monotonic @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (DM4F.st_monotonic @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_DM4F.st_monotonic))

:named defn_equation_DM4F.st_monotonic))
...
(Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1 @x2
@x3)))
:qid DM4F_pre_typing_Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1))

:named DM4F_pre_typing_Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name DM4F.wp0; Namespace DM4F
(assert (! 
;; def=DM4F.fst(10,9-10,24); use=DM4F.fst(10,9-10,24)
...
(Tm_arrow_e582d335e47d6840e0aed28d317c4bc1 @x2
@x3)))
:qid DM4F_pre_typing_Tm_arrow_e582d335e47d6840e0aed28d317c4bc1))

:named DM4F_pre_typing_Tm_arrow_e582d335e47d6840e0aed28d317c4bc1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name DM4F.wp0; Namespace DM4F
(assert (! 
;; def=DM4F.fst(9,10-10,34); use=DM4F.fst(10,2-10,34)
...
(Tm_arrow_b095d1214768e735059543db46dbca1c @x2
@x3)))
:qid DM4F_pre_typing_Tm_arrow_b095d1214768e735059543db46dbca1c))

:named DM4F_pre_typing_Tm_arrow_b095d1214768e735059543db46dbca1c))
...
:pattern ((ApplyTT @x0
@x3))
:qid DM4F_interpretation_Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1.1))
...
(Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1 @x1
@x2)))
:qid DM4F_interpretation_Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1))

:named DM4F_interpretation_Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1))
...
:pattern ((ApplyTT @x0
@x3))
:qid DM4F_interpretation_Tm_arrow_e582d335e47d6840e0aed28d317c4bc1.1))
...
(Tm_arrow_e582d335e47d6840e0aed28d317c4bc1 @x1
@x2)))
:qid DM4F_interpretation_Tm_arrow_e582d335e47d6840e0aed28d317c4bc1))

:named DM4F_interpretation_Tm_arrow_e582d335e47d6840e0aed28d317c4bc1))
...
@x3)
@x4))
:qid DM4F_interpretation_Tm_arrow_b095d1214768e735059543db46dbca1c.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid DM4F_interpretation_Tm_arrow_b095d1214768e735059543db46dbca1c.2))
))
...
(Tm_arrow_b095d1214768e735059543db46dbca1c @x1
@x2)))
:qid DM4F_interpretation_Tm_arrow_b095d1214768e735059543db46dbca1c))

:named DM4F_interpretation_Tm_arrow_b095d1214768e735059543db46dbca1c))
(push) ;; push{2

; Starting query at DM4F.fst(19,25-20,24)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (st: Type) (wp: DM4F.wp st a).
;   (*  - Could not prove post-condition
; *)
;   forall (s0: st) (p: Prims.pure_post u#ua (a & st)) (q: Prims.pure_post u#ua (a & st)).
...
;; def=dummy(0,0-0,0); use=DM4F.fst(20,5-20,24)
(forall ((@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x3
@x1)
(HasType @x4
...
;; def=FStar.Monotonic.Pure.fst(34,28-34,55); use=DM4F.fst(20,5-20,24)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(FStar.Pervasives.Native.tuple2 @x0
@x1))

;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=DM4F.fst(20,5-20,24)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=DM4F.fst(20,5-20,24)
(ApplyTT @x4
@x6)
...
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=DM4F.fst(20,5-20,24)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=DM4F.fst(20,5-20,24)
(ApplyTT @x5
@x6)
...
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=DM4F.fst(20,5-20,24)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=DM4F.fst(20,5-20,24)
(ApplyTT (ApplyTT @x2
@x3)
...
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=DM4F.fst(20,5-20,24)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (DM4F.repr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, DM4F_interpretation_Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1, Prims_interpretation_Tm_arrow_92458cff82f9ffee1f6e26a1c0c579f3, data_typing_intro_FStar.Pervasives.Native.Mktuple2@tok, equation_DM4F.st_monotonic, equation_DM4F.wp, equation_Prims.l_True, equation_Prims.logical, equation_Prims.pure_post, equation_Prims.pure_post_, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, refinement_interpretation_Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce, refinement_interpretation_Tm_refine_8d65e998a07dd53ec478e27017d9dba5, true_interp
...
(declare-fun DM4F.repr (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> st: Type -> wp: wp st a -> Type
(declare-fun Tm_arrow_b6393a9317d187752bd8ced2b9da9325 () Term)
(declare-fun DM4F.repr@tok () Term)
...
; Starting query at DM4F.fst(23,54-23,75)
...
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(23,66-23,75); use=DM4F.fst(23,66-23,75)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash u#0
;     (DM4F.st_monotonic u#uu___73
;         (fun s0 p -> p (FStar.Pervasives.Native.Mktuple2 u#uu___73 u#0 x s0)))
...
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(23,66-23,75)
(or label_1

;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(23,66-23,75)
(Valid 
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(23,66-23,75)
(DM4F.st_monotonic @x1
@x0
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (DM4F.return_wp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_DM4F.st_monotonic, interpretation_Tm_abs_a53e7fdfe19e2acb9ae53a9cdca91170
...
(declare-fun DM4F.return_wp (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> wp st a
(declare-fun Tm_arrow_ad9f2188e50db2c89559255af25a7c60 () Term)
(declare-fun DM4F.return_wp@tok () Term)
...
; Starting query at DM4F.fst(26,2-26,19)
...
;     (*  - Could not prove post-condition
; *)
;     forall (p: Prims.pure_post u#uu___70 (a & st)).
;       p (FStar.Pervasives.Native.Mktuple2 u#uu___70 u#0 x s0) ==>
;       (forall (return_val: a & st).
;           return_val == FStar.Pervasives.Native.Mktuple2 u#uu___70 u#0 x s0 ==> p return_val)
...
;; def=dummy(0,0-0,0); use=DM4F.fst(26,2-26,19)
(forall ((@x3 Term))
 (! (implies (HasType @x3
@x2)

;; def=Prims.fst(406,51-406,91); use=DM4F.fst(26,2-26,19)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.pure_post (FStar.Pervasives.Native.tuple2 @x0
@x2)))

;; def=DM4F.fst(23,66-23,75); use=DM4F.fst(26,2-26,19)
(Valid 
;; def=DM4F.fst(23,66-23,75); use=DM4F.fst(26,2-26,19)
(ApplyTT @x4
...
;; def=Prims.fst(356,2-356,58); use=DM4F.fst(26,2-26,19)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Pervasives.Native.tuple2 @x0
@x2))

;; def=Prims.fst(356,26-356,41); use=DM4F.fst(26,2-26,19)
(= @x5
(FStar.Pervasives.Native.Mktuple2 @x0
@x2
@x1
...
;; def=Prims.fst(356,46-356,58); use=DM4F.fst(26,12-26,19)
(or label_1

;; def=Prims.fst(356,46-356,58); use=DM4F.fst(26,2-26,19)
(Valid 
;; def=Prims.fst(356,46-356,58); use=DM4F.fst(26,2-26,19)
(ApplyTT @x4
@x5)
...
(declare-fun DM4F.return (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type -> x: a -> st: Type -> repr a st (fun s0 p -> p (x, s0))
(declare-fun Tm_arrow_e4b21541701b49aa55fd15cd20d4fde1 () Term)
(declare-fun DM4F.return@tok () Term)
...
; Starting query at DM4F.fst(30,2-30,50)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> wp st b
(declare-fun Tm_arrow_d7f52f607027396987dcb79f3361bd2f (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d7f52f607027396987dcb79f3361bd2f
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(29,14-29,70); use=DM4F.fst(29,58-29,70)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_d7f52f607027396987dcb79f3361bd2f @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_d7f52f607027396987dcb79f3361bd2f @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_d7f52f607027396987dcb79f3361bd2f))

:named kinding_Tm_arrow_d7f52f607027396987dcb79f3361bd2f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(29,14-29,70); use=DM4F.fst(29,58-29,70)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_d7f52f607027396987dcb79f3361bd2f @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid DM4F_pre_typing_Tm_arrow_d7f52f607027396987dcb79f3361bd2f))

:named DM4F_pre_typing_Tm_arrow_d7f52f607027396987dcb79f3361bd2f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d7f52f607027396987dcb79f3361bd2f
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(29,14-29,70); use=DM4F.fst(29,58-29,70)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_d7f52f607027396987dcb79f3361bd2f @x1
@x2
@x3))
(and 
;; def=DM4F.fst(29,14-29,70); use=DM4F.fst(29,58-29,70)
...
:pattern ((ApplyTT @x0
@x4))
:qid DM4F_interpretation_Tm_arrow_d7f52f607027396987dcb79f3361bd2f.1))
...
@x2
@x3)))
:qid DM4F_interpretation_Tm_arrow_d7f52f607027396987dcb79f3361bd2f))

:named DM4F_interpretation_Tm_arrow_d7f52f607027396987dcb79f3361bd2f))
...
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(30,38-30,49); use=DM4F.fst(30,38-30,49)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(30,14-30,50); use=DM4F.fst(30,14-30,50)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
; Encoding query formula : forall (a: Type) (b: Type) (st: Type) (wp_c: DM4F.wp st a) (wp_f: (_: a -> DM4F.wp st b)).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash u#0
;     (DM4F.st_monotonic u#uu___124
;         (fun s0 p ->
;             wp_c s0
;               (fun _ ->
;                   (let y, s1 = _ in
...
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(30,14-30,50)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (DM4F.bind_wp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, DM4F_interpretation_Tm_arrow_d7f52f607027396987dcb79f3361bd2f, DM4F_interpretation_Tm_arrow_e582d335e47d6840e0aed28d317c4bc1, DM4F_interpretation_Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1, equation_DM4F.st_monotonic, equation_DM4F.wp, equation_Prims.logical, interpretation_Tm_abs_811e8b5e3738987d804ef8609b0e9eff, interpretation_Tm_abs_c9e46470d33b7e79486e6e894a637d1b, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce, typing_Tm_abs_811e8b5e3738987d804ef8609b0e9eff
...
;;;;;;;;;;;;;;;;_: a -> wp st b
(declare-fun Tm_arrow_d7f52f607027396987dcb79f3361bd2f (Term Term Term) Term)
(declare-fun DM4F.bind_wp (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;wp_c: wp st a -> wp_f: (_: a -> wp st b) -> wp st b
(declare-fun Tm_arrow_6979dc6dbf2525c26545ee491b83304d () Term)
(declare-fun DM4F.bind_wp@tok () Term)
...
;;; Fact-ids: Name DM4F.repr; Namespace DM4F
(assert (! 
;; def=Prims.fst(630,69-630,73); use=DM4F.fst(20,16-20,24)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name DM4F.repr; Namespace DM4F
(assert (! 
;; def=Prims.fst(635,86-635,95); use=DM4F.fst(20,16-20,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;;;;;;;;;;;;;;;;typing_Tm_abs_811e8b5e3738987d804ef8609b0e9eff
;;; Fact-ids: Name DM4F.bind_wp; Namespace DM4F
(assert (! 
;; def=DM4F.fst(30,38-30,49); use=DM4F.fst(30,38-30,49)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_811e8b5e3738987d804ef8609b0e9eff @x0
...
;;; Fact-ids: Name DM4F.repr; Namespace DM4F
(assert (! 
;; def=DM4F.fst(19,5-19,9); use=DM4F.fst(19,5-19,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(DM4F.wp @x1
@x0)))
(HasType (DM4F.repr @x0
@x1
@x2)
Tm_type))
 

:pattern ((DM4F.repr @x0
@x1
@x2))
:qid typing_DM4F.repr))

:named typing_DM4F.repr))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;; Fact-ids: Name DM4F.repr; Namespace DM4F
(assert (! 
;; def=DM4F.fst(20,16-20,24); use=DM4F.fst(20,16-20,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;;; Fact-ids: Name DM4F.repr; Namespace DM4F
(assert (! 
;; def=Prims.fst(315,31-315,40); use=DM4F.fst(20,16-20,24)
(forall ((@x0 Term) (@x1 Term))
...
;; def=Prims.fst(635,71-635,97); use=DM4F.fst(20,16-20,24)
(not 
;; def=Prims.fst(635,72-635,97); use=DM4F.fst(20,16-20,24)
(Valid 
;; def=Prims.fst(635,72-635,97); use=DM4F.fst(20,16-20,24)
(ApplyTT (ApplyTT @x2
@x3)
...
;;; Fact-ids: Name DM4F.repr; Namespace DM4F
(assert (! 
;; def=Prims.fst(315,31-315,54); use=DM4F.fst(20,16-20,24)
(forall ((@x0 Term) (@x1 Term))
...
;;; Fact-ids: Name DM4F.repr; Namespace DM4F
(assert (! 
;; def=DM4F.fst(19,25-20,24); use=DM4F.fst(20,5-20,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x1
@x2))
:qid equation_DM4F.repr))

:named equation_DM4F.repr))
;;;;;;;;;;;;;;;;Eq2 interpretation
;;; Fact-ids: Name Prims.eq2; Namespace Prims
...
(Tm_arrow_28390b616d684ad32add7d90db8f7b75 @x2
@x3)))
:qid DM4F_pre_typing_Tm_arrow_28390b616d684ad32add7d90db8f7b75))

:named DM4F_pre_typing_Tm_arrow_28390b616d684ad32add7d90db8f7b75))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name DM4F.repr; Namespace DM4F
(assert (! 
;; def=DM4F.fst(19,25-20,24); use=DM4F.fst(20,5-20,24)
...
@x3
@x4)))
:qid DM4F_pre_typing_Tm_arrow_1b3e9294d089e4dc98ae0412dc8f2b45))

:named DM4F_pre_typing_Tm_arrow_1b3e9294d089e4dc98ae0412dc8f2b45))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d7f52f607027396987dcb79f3361bd2f
;;; Fact-ids: Name DM4F.bind_wp; Namespace DM4F
(assert (! 
;; def=DM4F.fst(29,14-29,70); use=DM4F.fst(29,58-29,70)
...
:pattern ((ApplyTT @x0
@x3))
:qid DM4F_interpretation_Tm_arrow_28390b616d684ad32add7d90db8f7b75.1))
...
(Tm_arrow_28390b616d684ad32add7d90db8f7b75 @x1
@x2)))
:qid DM4F_interpretation_Tm_arrow_28390b616d684ad32add7d90db8f7b75))

:named DM4F_interpretation_Tm_arrow_28390b616d684ad32add7d90db8f7b75))
...
(forall ((@x4 Term))
 (! (implies (and 
;; def=Prims.fst(630,56-630,74); use=DM4F.fst(20,16-20,24)
(Valid 
;; def=Prims.fst(630,56-630,74); use=DM4F.fst(20,16-20,24)
(ApplyTT (ApplyTT @x3
@x4)
...
:pattern ((ApplyTT @x0
@x4))
:qid DM4F_interpretation_Tm_arrow_1b3e9294d089e4dc98ae0412dc8f2b45.1))
...
@x2
@x3)))
:qid DM4F_interpretation_Tm_arrow_1b3e9294d089e4dc98ae0412dc8f2b45))

:named DM4F_interpretation_Tm_arrow_1b3e9294d089e4dc98ae0412dc8f2b45))
(push) ;; push{2

; Starting query at DM4F.fst(38,2-39,15)

(declare-fun label_1 () Bool)

;;;;;;;;;;;;;;;;x: a -> repr b st (wp_f x)
(declare-fun Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(32,10-36,33); use=DM4F.fst(36,10-36,33)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0 @x0
@x1
@x2
@x3)
Tm_type))
:qid kinding_Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0))

:named kinding_Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(32,10-36,33); use=DM4F.fst(36,10-36,33)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0 @x2
@x3
@x4
@x5))
(is-Tm_arrow (PreType @x1)))
...
@x4
@x5)))
:qid DM4F_pre_typing_Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0))

:named DM4F_pre_typing_Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(32,10-36,33); use=DM4F.fst(36,10-36,33)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0 @x1
@x2
@x3
@x4))
(and 
...
:pattern ((ApplyTT @x0
@x5))
:qid DM4F_interpretation_Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0.1))
...
@x3
@x4)))
:qid DM4F_interpretation_Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0))

:named DM4F_interpretation_Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0))
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=DM4F.fst(38,2-39,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;; def=Prims.fst(356,26-356,41); use=DM4F.fst(38,2-39,15)
(= @x4
@x1)
)

;; def=Prims.fst(356,46-356,58); use=DM4F.fst(38,2-39,15)
(Valid 
;; def=Prims.fst(356,46-356,58); use=DM4F.fst(38,2-39,15)
(ApplyTT @x0
@x4)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,38-369,57); use=DM4F.fst(38,2-39,15)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(413,99-413,120); use=DM4F.fst(38,11-39,15)
...
;; def=DM4F.fst(38,17-38,22); use=DM4F.fst(38,17-38,22)
(= (ApplyTT @x6
@x5)
...
;; def=Prims.fst(369,38-369,57); use=DM4F.fst(38,11-39,15)
(Valid 
;; def=Prims.fst(369,38-369,57); use=DM4F.fst(38,11-39,15)
...
;     (*  - Could not prove post-condition
; *)
;     forall (p: Prims.pure_post u#uu___175 (b & st)).
;       wp_c s0
;         (fun _ ->
;             (let y, s1 = _ in
;               wp_f y s1 p)
...
;             c s0 == bind_result_1 ==>
;             (forall (b: a) (b: st).
;                 c s0 == FStar.Pervasives.Native.Mktuple2 u#uu___174 u#0 b b ==>
;                 wp_f b
;                   b
;                   (fun bind_result_1 ->
;                       bind_result_1 ==
...
@x3))
(HasType @x6
(Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0 @x4
@x2
@x1
@x0)))

;; def=dummy(0,0-0,0); use=DM4F.fst(38,2-39,15)
(forall ((@x7 Term))
 (! (implies (HasType @x7
@x2)

;; def=Prims.fst(406,51-406,91); use=DM4F.fst(38,2-39,15)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Prims.pure_post (FStar.Pervasives.Native.tuple2 @x1
@x2)))

;; def=DM4F.fst(30,14-30,50); use=DM4F.fst(38,2-39,15)
(Valid 
;; def=DM4F.fst(30,14-30,50); use=DM4F.fst(38,2-39,15)
(ApplyTT (ApplyTT @x3
@x7)
...
;; def=Prims.fst(369,7-369,58); use=DM4F.fst(38,11-39,15)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (DM4F.bind, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, DM4F_interpretation_Tm_arrow_d7f52f607027396987dcb79f3361bd2f, DM4F_interpretation_Tm_arrow_e582d335e47d6840e0aed28d317c4bc1, DM4F_interpretation_Tm_arrow_ee603e5be846a1542f5c1ba61ab8e8a1, Prims_interpretation_Tm_arrow_92458cff82f9ffee1f6e26a1c0c579f3, eq2-interp, equation_DM4F.st_monotonic, equation_DM4F.wp, equation_Prims.l_True, equation_Prims.logical, equation_Prims.pure_post, equation_Prims.pure_post_, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, interpretation_Tm_abs_2160bde7f60b176103b955fc59281315, interpretation_Tm_abs_811e8b5e3738987d804ef8609b0e9eff, interpretation_Tm_abs_ade907d0cf068369deec49e03ec454f6, l_imp-interp, l_quant_interp_b0051d59d5e27d8f13752350dd9a2a74, l_quant_interp_e03c39cc34182dd604407aded4bc3292, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce, refinement_interpretation_Tm_refine_8d65e998a07dd53ec478e27017d9dba5, true_interp, typing_Tm_abs_2160bde7f60b176103b955fc59281315, typing_Tm_abs_811e8b5e3738987d804ef8609b0e9eff, typing_Tm_abs_ade907d0cf068369deec49e03ec454f6
...
;;;;;;;;;;;;;;;;x: a -> repr b st (wp_f x)
(declare-fun Tm_arrow_15b5a6fb2f7404fbd4f106fa2a8293a0 (Term Term Term Term) Term)
(declare-fun DM4F.bind (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_arrow_2e84a6127041a97b8cfcd54f3f54c46a () Term)
(declare-fun DM4F.bind@tok () Term)
...
; Starting query at DM4F.fst(43,2-43,53)

(declare-fun label_1 () Bool)


;;;;;;;;;;;;;;;;s0: st -> p: (_: a & st -> Type0) -> Prims.logical
(declare-fun Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(10,9-42,25); use=DM4F.fst(42,45-43,53)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6))

:named kinding_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(10,9-42,25); use=DM4F.fst(42,45-43,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 @x2
@x3)))
:qid DM4F_pre_typing_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6))

:named DM4F_pre_typing_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(10,9-42,25); use=DM4F.fst(42,45-43,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 @x1
@x2))
(and 
;; def=DM4F.fst(10,9-42,25); use=DM4F.fst(42,45-43,53)
(forall ((@x3 Term) (@x4 Term))
...
@x3)
@x4))
:qid DM4F_interpretation_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid DM4F_interpretation_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6.2))
))
...
(Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 @x1
@x2)))
:qid DM4F_interpretation_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6))

:named DM4F_interpretation_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6))
(declare-fun Tm_abs_e1564b9158d7aff8304adb8fdac9f95c (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_e1564b9158d7aff8304adb8fdac9f95c
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(43,14-43,53); use=DM4F.fst(43,14-43,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_e1564b9158d7aff8304adb8fdac9f95c @x0
@x1
@x2
@x3
@x4)
(Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 @x3
@x4))
 

:pattern ((Tm_abs_e1564b9158d7aff8304adb8fdac9f95c @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_e1564b9158d7aff8304adb8fdac9f95c))

:named typing_Tm_abs_e1564b9158d7aff8304adb8fdac9f95c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e1564b9158d7aff8304adb8fdac9f95c
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(43,14-43,53); use=DM4F.fst(43,14-43,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_e1564b9158d7aff8304adb8fdac9f95c @x2
@x3
@x4
@x5
@x6)
@x0)
@x1)
(Prims.l_and (Prims.l_imp (Prims.b2t @x2)
(ApplyTT (ApplyTT @x3
@x0)
@x1))
(Prims.l_imp (Prims.l_not (Prims.b2t @x2))
(ApplyTT (ApplyTT @x4
@x0)
@x1))))
 

:pattern ((ApplyTT (ApplyTT (Tm_abs_e1564b9158d7aff8304adb8fdac9f95c @x2
@x3
@x4
@x5
@x6)
@x0)
@x1))
:qid interpretation_Tm_abs_e1564b9158d7aff8304adb8fdac9f95c))

:named interpretation_Tm_abs_e1564b9158d7aff8304adb8fdac9f95c))

; Encoding query formula : forall (a: Type) (st: Type) (wpf: DM4F.wp st a) (wpg: DM4F.wp st a) (b: Prims.bool).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash u#0
;     (DM4F.st_monotonic u#uu___95 (fun s0 p -> (b ==> wpf s0 p) /\ (~b ==> wpg s0 p)))


; Context: While encoding a query
; While typechecking the top-level declaration `let ite_wp`
...
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(43,14-43,53)
(or label_1
...
(DM4F.st_monotonic @x1
@x0
(Tm_abs_e1564b9158d7aff8304adb8fdac9f95c @x4
@x2
@x3
@x0
@x1))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (DM4F.ite_wp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_DM4F.st_monotonic, equation_DM4F.wp, interpretation_Tm_abs_e1564b9158d7aff8304adb8fdac9f95c, l_and-interp, l_imp-interp, l_not-interp, refinement_interpretation_Tm_refine_7d65da4998d4da77eee5d5ab706ad1ce
...
; encoding sigelt let ite_wp


; <Start encoding let ite_wp>

(declare-fun DM4F.ite_wp (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;wpf: wp st a -> wpg: wp st a -> b: Prims.bool -> wp st a
(declare-fun Tm_arrow_42aae5c0c2826fe7f95ec8cbedc1475b () Term)
(declare-fun DM4F.ite_wp@tok () Term)


;;;;;;;;;;;;;;;;s0: st -> p: (_: a & st -> Type) -> Prims.logical
(declare-fun Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 (Term Term) Term)
(declare-fun Tm_abs_e1564b9158d7aff8304adb8fdac9f95c (Term Term Term Term Term) Term)

; </end encoding let ite_wp>
...
(declare-fun DM4F.if_then_else (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     st: Type ->     wpf: wp st a ->     wpg: wp st a ->     f: repr a st wpf ->     g: repr a st wpg ->     b: Prims.bool   -> Type
(declare-fun Tm_arrow_1aae8150e174e6e083497e4de5e308fc () Term)
(declare-fun DM4F.if_then_else@tok () Term)
...
(declare-fun DM4F.stronger (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;w1: wp st a -> w2: wp st a -> Type
(declare-fun Tm_arrow_c6a1ed8cf6a0d20fdf124ac87300b1d4 () Term)
(declare-fun DM4F.stronger@tok () Term)
...
; Starting query at DM4F.fst(70,4-70,5)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


; Encoding query formula : forall (a: Type) (st: Type) (wpf: DM4F.wp st a) (wpg: DM4F.wp st a) (f: DM4F.repr a st wpf).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post u#uu___107 (DM4F.repr u#uu___107 a st wpg)).
;     (forall (s0: st) (p: (_: a & st -> Type0)). wpg s0 p ==> wpf s0 p) /\
;     (forall (pure_result: DM4F.repr u#uu___107 a st wpg). Prims.auto_squash u#0 (p pure_result)) ==>
;     (forall (s0: st) (p: Prims.pure_post u#uu___107 (a & st)). wpg s0 p ==> wpf s0 p) /\
;     (forall (any_result: DM4F.repr u#uu___107 a st wpf).
;         any_result == f ==>
;         (forall (return_val: DM4F.repr u#uu___107 a st wpg).
...
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.pure_post (DM4F.repr @x0
@x1
@x3)))

;; def=DM4F.fst(60,4-60,36); use=DM4F.fst(68,20-68,28)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
@x1)
(HasType @x7
...
;; def=DM4F.fst(60,17-60,24); use=DM4F.fst(68,20-68,28)
(Valid 
;; def=DM4F.fst(60,17-60,24); use=DM4F.fst(68,20-68,28)
(ApplyTT (ApplyTT @x3
@x6)
...
;; def=DM4F.fst(60,29-60,36); use=DM4F.fst(68,20-68,28)
(Valid 
;; def=DM4F.fst(60,29-60,36); use=DM4F.fst(68,20-68,28)
(ApplyTT (ApplyTT @x2
@x6)
...
;; def=Prims.fst(441,36-441,97); use=DM4F.fst(70,4-70,5)
(forall ((@x6 Term))
 (! (implies (or label_1
(HasType @x6
(DM4F.repr @x0
...
;; def=Prims.fst(441,83-441,96); use=DM4F.fst(70,4-70,5)
(Valid 
;; def=Prims.fst(441,83-441,96); use=DM4F.fst(70,4-70,5)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=DM4F.fst(70,4-70,5)
(and 
;; def=dummy(0,0-0,0); use=DM4F.fst(70,4-70,5)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
@x1)
(HasType @x7
...
;; def=Prims.fst(406,76-406,81); use=DM4F.fst(70,4-70,5)
(Valid 
;; def=Prims.fst(406,76-406,81); use=DM4F.fst(70,4-70,5)
(ApplyTT (ApplyTT @x3
@x6)
...
;; def=Prims.fst(406,86-406,91); use=DM4F.fst(70,4-70,5)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=DM4F.fst(70,4-70,5)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(DM4F.repr @x0
@x1
...
;; def=DM4F.fst(66,3-67,24); use=DM4F.fst(70,4-70,5)
(= @x6
@x4)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (DM4F.subcomp, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, DM4F_interpretation_Tm_arrow_e582d335e47d6840e0aed28d317c4bc1, Prims_interpretation_Tm_arrow_92458cff82f9ffee1f6e26a1c0c579f3, equation_Prims.l_True, equation_Prims.pure_post, equation_Prims.pure_post_, refinement_interpretation_Tm_refine_8d65e998a07dd53ec478e27017d9dba5, true_interp
...
(declare-fun DM4F.subcomp (Term Term Term Term Term) Term)
(declare-fun Tm_refine_5d025410a8fd09181780a52dfcde3543 (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> st: Type -> wpf: wp st a -> wpg: wp st a -> f: repr a st wpf   -> Prims.Pure (repr a st wpg)
(declare-fun Tm_arrow_f1af32088696fb4ab7dc34b93863825d () Term)
(declare-fun DM4F.subcomp@tok () Term)
...
; Encoding query formula : forall (a: Type u#uu___627)
;   (st: Type0)
;   (wpf: DM4F.wp u#uu___627 st a)
;   (wpg: DM4F.wp u#uu___627 st a)
;   (p: Prims.pure_post u#uu___627 (DM4F.repr u#uu___627 a st wpg))
;   (q: Prims.pure_post u#uu___627 (DM4F.repr u#uu___627 a st wpg)).
;   (forall (x: DM4F.repr u#uu___627 a st wpg). p x ==> q x) ==>
;   (forall (s0: st) (p: (_: a & st -> Type0)). wpg s0 p ==> wpf s0 p) /\
;   (forall (pure_result: DM4F.repr u#uu___627 a st wpg). Prims.auto_squash u#0 (p pure_result)) ==>
;   (forall (s0: st) (p: (_: a & st -> Type0)). wpg s0 p ==> wpf s0 p) /\
;   (forall (pure_result: DM4F.repr u#uu___627 a st wpg). Prims.auto_squash u#0 (q pure_result))


; Context: While encoding a query
; While checking the subcomp combinator
; While checking layered effect definition `DM4F.ST`
...
;; def=DM4F.fst(60,4-60,36); use=DM4F.fst(60,4-60,36)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
@x1)
(HasType @x7
...
;; def=DM4F.fst(60,17-60,24); use=DM4F.fst(60,17-60,24)
(Valid 
;; def=DM4F.fst(60,17-60,24); use=DM4F.fst(60,17-60,24)
(ApplyTT (ApplyTT @x3
@x6)
...
;; def=DM4F.fst(60,29-60,36); use=DM4F.fst(60,29-60,36)
(Valid 
;; def=DM4F.fst(60,29-60,36); use=DM4F.fst(60,29-60,36)
(ApplyTT (ApplyTT @x2
@x6)
...
;; def=Prims.fst(441,36-441,97); use=DM4F.fst(77,42-77,49)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(DM4F.repr @x0
@x1
...
;; def=Prims.fst(441,83-441,96); use=DM4F.fst(77,42-77,49)
(Valid 
;; def=Prims.fst(441,83-441,96); use=DM4F.fst(77,42-77,49)
(ApplyTT @x4
@x6)
...
;; def=Prims.fst(441,29-441,97); use=DM4F.fst(77,42-77,49)
(and 
;; def=DM4F.fst(60,4-60,36); use=DM4F.fst(60,4-60,36)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
...
; Encoding query formula : forall (a: Type) (st: Type) (wpf: DM4F.wp st a) (wpg: DM4F.wp st a) (f: DM4F.repr a st wpf)
;   (g: DM4F.repr a st wpg) (p: Prims.bool) (_: Prims.squash p) (s0: st) (p: (_: a & st -> Type0)).
;   (p ==> wpf s0 p) /\ (~p ==> wpg s0 p) ==> wpf s0 p
...
;; def=DM4F.fst(43,14-43,30); use=DM4F.fst(53,15-53,21)
(implies 
;; def=DM4F.fst(42,52-42,53); use=DM4F.fst(53,15-53,21)
(BoxBool_proj_0 @x6)


;; def=DM4F.fst(43,21-43,29); use=DM4F.fst(53,15-53,21)
(Valid 
;; def=DM4F.fst(43,21-43,29); use=DM4F.fst(53,15-53,21)
(ApplyTT (ApplyTT @x2
@x8)
...
;; def=DM4F.fst(43,34-43,53); use=DM4F.fst(53,15-53,21)
(implies 
;; def=DM4F.fst(43,35-43,39); use=DM4F.fst(53,15-53,21)
(not 
;; def=DM4F.fst(42,52-42,53); use=DM4F.fst(53,15-53,21)
(BoxBool_proj_0 @x6)
)
...
;; def=DM4F.fst(43,44-43,52); use=DM4F.fst(53,15-53,21)
(Valid 
;; def=DM4F.fst(43,44-43,52); use=DM4F.fst(53,15-53,21)
(ApplyTT (ApplyTT @x3
@x8)
...
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(77,28-77,40); use=DM4F.fst(77,28-77,40)
(forall ((@x0 Term))
...
; Encoding query formula : forall (a: Type) (st: Type) (wpf: DM4F.wp st a) (wpg: DM4F.wp st a) (f: DM4F.repr a st wpf)
;   (g: DM4F.repr a st wpg) (p: Prims.bool) (_: _: Prims.unit{~p}) (s0: st) (p: (_: a & st -> Type0)).
;   (p ==> wpf s0 p) /\ (~p ==> wpg s0 p) ==> wpg s0 p
...
Prims.bool)
(HasType @x7
(Tm_refine_de09779676242898794a0b057d5f5bb4 @x6))
(HasType @x8
@x1)
(HasType @x9
(Tm_arrow_e582d335e47d6840e0aed28d317c4bc1 @x1
...
; Starting query at DM4F.fst(82,2-83,36)
...
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(83,26-83,35); use=DM4F.fst(83,26-83,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=DM4F.fst(81,53-83,36)
(forall ((@x0 Term) (@x1 Term))
...
(Tm_arrow_7bf032b416e9eba50fbdda1b1814a8d2 @x2
@x3)))
:qid DM4F_pre_typing_Tm_arrow_7bf032b416e9eba50fbdda1b1814a8d2))

:named DM4F_pre_typing_Tm_arrow_7bf032b416e9eba50fbdda1b1814a8d2))
...
@x3)
@x4))
:qid DM4F_interpretation_Tm_arrow_7bf032b416e9eba50fbdda1b1814a8d2.1))
...
:pattern ((ApplyTT @x0
@x3))
:qid DM4F_interpretation_Tm_arrow_7bf032b416e9eba50fbdda1b1814a8d2.2))
))
...
(Tm_arrow_7bf032b416e9eba50fbdda1b1814a8d2 @x1
@x2)))
:qid DM4F_interpretation_Tm_arrow_7bf032b416e9eba50fbdda1b1814a8d2))

:named DM4F_interpretation_Tm_arrow_7bf032b416e9eba50fbdda1b1814a8d2))
(declare-fun Tm_abs_577992fc994ed74f2ceebcf0b832bbd2 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_577992fc994ed74f2ceebcf0b832bbd2
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(83,14-83,36); use=DM4F.fst(83,14-83,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;     (forall (a: Type0)
;         (wp: Prims.pure_wp u#0 a)
;         (p: Prims.pure_post u#0 a)
;         (q: Prims.pure_post u#0 a).
;         (forall (x: a). p x ==> q x) ==> wp p ==> wp q) ==>
;     Prims.auto_squash u#0
;       (DM4F.st_monotonic u#uu___152
;           (fun s0 p -> w (fun x -> p (FStar.Pervasives.Native.Mktuple2 u#uu___152 u#0 x s0))))
...
;; def=Prims.fst(441,36-441,97); use=DM4F.fst(82,2-82,34)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=FStar.Monotonic.Pure.fst(42,4-42,53); use=DM4F.fst(82,2-82,34)
...
;; def=FStar.Monotonic.Pure.fst(34,2-34,75); use=DM4F.fst(82,2-83,36)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
(Prims.pure_post @x4))
(HasType @x7
...
;; def=FStar.Monotonic.Pure.fst(34,28-34,55); use=DM4F.fst(82,2-83,36)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
@x4)

;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=DM4F.fst(82,2-83,36)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=DM4F.fst(82,2-83,36)
(ApplyTT @x6
@x8)
...
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=DM4F.fst(82,2-83,36)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=DM4F.fst(82,2-83,36)
(ApplyTT @x7
@x8)
...
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=DM4F.fst(82,2-83,36)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=DM4F.fst(82,2-83,36)
(ApplyTT @x5
@x6)
...
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=DM4F.fst(82,2-83,36)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=DM4F.fst(82,2-83,36)
(ApplyTT @x5
@x7)
...
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(83,14-83,36)
(or label_1
...
(declare-fun DM4F.lift_wp (Term Term Term) Term)
;;;;;;;;;;;;;;;;w: Prims.pure_wp a -> wp st a
(declare-fun Tm_arrow_470d4d0d53680cbc57fe6895ee93da5a () Term)
(declare-fun DM4F.lift_wp@tok () Term)
...
;;;;;;;;;;;;;;;;typing_Tm_abs_963d181e5476598451a0d753ab150aec
;;; Fact-ids: Name DM4F.lift_wp; Namespace DM4F
(assert (! 
;; def=DM4F.fst(83,26-83,35); use=DM4F.fst(83,26-83,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_963d181e5476598451a0d753ab150aec @x0
...
; Starting query at DM4F.fst(87,4-88,24)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=DM4F.fst(87,4-88,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_abs_6514a1ac6977f12532d392b53a42aa86 @x0
@x1
@x2
...
;; def=Prims.fst(356,26-356,41); use=DM4F.fst(87,4-88,24)
(= @x4
@x1)
)

;; def=Prims.fst(356,46-356,58); use=DM4F.fst(87,4-88,24)
(Valid 
;; def=Prims.fst(356,46-356,58); use=DM4F.fst(87,4-88,24)
(ApplyTT @x0
@x4)
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(451,66-451,102); use=DM4F.fst(88,14-88,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
;; def=DM4F.fst(20,16-88,24); use=DM4F.fst(88,14-88,24)
(= @x5
(FStar.Pervasives.Native.Mktuple2 @x4
@x3
(ApplyTT @x2
...
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,38-369,57); use=DM4F.fst(88,14-88,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
...
; Encoding query formula : forall (a: Type) (wp: Prims.pure_wp a) (st: Type) (f: (_: Prims.unit -> Prims.PURE a)).
;   (*  - Could not prove post-condition
; *)
;   forall (pure_result: Prims.unit).
;     (forall (a: Type0)
...
;         (*  - Could not prove post-condition
; *)
;         forall (p: Prims.pure_post u#uu___221 (a & st)).
;           wp (fun x -> p (FStar.Pervasives.Native.Mktuple2 u#uu___221 u#0 x s0)) ==>
;           wp (fun bind_result_1 ->
;                 f () == bind_result_1 ==>
;                 (forall (any_result: a & st).
;                     any_result == FStar.Pervasives.Native.Mktuple2 u#uu___221 u#0 (f ()) s0 ==>
...
;; def=Prims.fst(441,36-441,97); use=DM4F.fst(87,4-87,36)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=FStar.Monotonic.Pure.fst(42,4-42,53); use=DM4F.fst(87,4-87,36)
...
;; def=FStar.Monotonic.Pure.fst(34,2-34,75); use=DM4F.fst(87,4-88,24)
...
;; def=FStar.Monotonic.Pure.fst(34,28-34,55); use=DM4F.fst(87,4-88,24)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
@x5)

;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=DM4F.fst(87,4-88,24)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=DM4F.fst(87,4-88,24)
(ApplyTT @x7
@x9)
...
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=DM4F.fst(87,4-88,24)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=DM4F.fst(87,4-88,24)
(ApplyTT @x8
@x9)
...
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=DM4F.fst(87,4-88,24)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=DM4F.fst(87,4-88,24)
(ApplyTT @x6
@x7)
...
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=DM4F.fst(87,4-88,24)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=DM4F.fst(87,4-88,24)
(ApplyTT @x6
@x8)
...
;; def=dummy(0,0-0,0); use=DM4F.fst(87,4-88,24)
(forall ((@x5 Term))
 (! (implies (HasType @x5
@x2)

;; def=Prims.fst(406,51-406,91); use=DM4F.fst(87,4-88,24)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Prims.pure_post (FStar.Pervasives.Native.tuple2 @x0
@x2)))

;; def=DM4F.fst(83,14-83,36); use=DM4F.fst(87,4-88,24)
(Valid 
;; def=DM4F.fst(83,14-83,36); use=DM4F.fst(87,4-88,24)
(ApplyTT @x1
...
;; def=Prims.fst(369,7-369,58); use=DM4F.fst(88,14-88,24)
(or label_1
...
(declare-fun DM4F.lift_pure_st (Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> st: Type -> f: (_: Prims.unit -> Prims.PURE a)   -> repr a st (fun s0 p -> wp (fun x -> p (x, s0)))
(declare-fun Tm_arrow_c677ba6bd2781be8fe30594dba926f35 () Term)
(declare-fun DM4F.lift_pure_st@tok () Term)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6
;;; Fact-ids: Name DM4F.ite_wp; Namespace DM4F
(assert (! 
;; def=DM4F.fst(10,9-42,25); use=DM4F.fst(10,9-43,33)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 @x0
@x1)
Tm_type)
...
; Starting query at DM4F.fst(93,2-93,27)

(declare-fun label_1 () Bool)


(declare-fun Tm_abs_3570f468d369062a6a595beede09a227 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_3570f468d369062a6a595beede09a227
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(93,14-93,27); use=DM4F.fst(93,14-93,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_3570f468d369062a6a595beede09a227 @x0
@x1
@x2)
(Tm_arrow_e582d335e47d6840e0aed28d317c4bc1 @x1
@x2))
...
:pattern ((Tm_abs_3570f468d369062a6a595beede09a227 @x0
@x1
@x2))
:qid typing_Tm_abs_3570f468d369062a6a595beede09a227))

:named typing_Tm_abs_3570f468d369062a6a595beede09a227))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3570f468d369062a6a595beede09a227
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(93,14-93,27); use=DM4F.fst(93,14-93,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_3570f468d369062a6a595beede09a227 @x1
@x2
@x3)
@x0)
(ApplyTT @x1
...
:pattern ((ApplyTT (Tm_abs_3570f468d369062a6a595beede09a227 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_3570f468d369062a6a595beede09a227))

:named interpretation_Tm_abs_3570f468d369062a6a595beede09a227))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(93,14-93,27); use=DM4F.fst(93,14-93,27)
...
@x1)
(Tm_abs_3570f468d369062a6a595beede09a227 @x0
@x1
@x2)))
...
;; def=DM4F.fst(93,24-93,27); use=DM4F.fst(93,24-93,27)
(Valid 
;; def=DM4F.fst(93,24-93,27); use=DM4F.fst(93,24-93,27)
(ApplyTT @x0
@x3)
...
;;no pats
:qid l_quant_interp_7476593ebb206e7a8235a58ae2f6298e.1))
)
...
@x1
@x2))))
:qid l_quant_interp_7476593ebb206e7a8235a58ae2f6298e))

:named l_quant_interp_7476593ebb206e7a8235a58ae2f6298e))


(declare-fun Tm_abs_ac22a594b282e3624667bed6f5093659 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_ac22a594b282e3624667bed6f5093659
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(93,14-93,27); use=DM4F.fst(93,14-93,27)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_ac22a594b282e3624667bed6f5093659 @x0
@x1)
(Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 @x0
@x1))
 

:pattern ((Tm_abs_ac22a594b282e3624667bed6f5093659 @x0
@x1))
:qid typing_Tm_abs_ac22a594b282e3624667bed6f5093659))

:named typing_Tm_abs_ac22a594b282e3624667bed6f5093659))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_ac22a594b282e3624667bed6f5093659
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(93,14-93,27); use=DM4F.fst(93,14-93,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (Tm_abs_ac22a594b282e3624667bed6f5093659 @x2
@x3)
@x0)
@x1)
(Prims.l_Forall (FStar.Pervasives.Native.tuple2 @x2
@x3)
(Tm_abs_3570f468d369062a6a595beede09a227 @x1
@x3
@x2)))
 

:pattern ((ApplyTT (ApplyTT (Tm_abs_ac22a594b282e3624667bed6f5093659 @x2
@x3)
@x0)
@x1))
:qid interpretation_Tm_abs_ac22a594b282e3624667bed6f5093659))

:named interpretation_Tm_abs_ac22a594b282e3624667bed6f5093659))

; Encoding query formula : forall (st: Type) (a: Type).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash u#0 (DM4F.st_monotonic u#uu___75 (fun _ p -> forall (r: a & st). p r))


; Context: While encoding a query
; While typechecking the top-level declaration `let null`
...
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(93,14-93,27)
(or label_1

;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(93,14-93,27)
(Valid 
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(93,14-93,27)
(DM4F.st_monotonic @x0
@x1
(Tm_abs_ac22a594b282e3624667bed6f5093659 @x1
@x0))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (DM4F.null, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_FStar.Pervasives.Native.Mktuple2, equation_DM4F.st_monotonic, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, interpretation_Tm_abs_ac22a594b282e3624667bed6f5093659, l_quant_interp_7476593ebb206e7a8235a58ae2f6298e
...
; encoding sigelt let null


; <Start encoding let null>

(declare-fun DM4F.null (Term Term) Term)
;;;;;;;;;;;;;;;;wp st a
(declare-fun Tm_arrow_41e9134c4496349f63944273f801aba9 () Term)
(declare-fun DM4F.null@tok () Term)
...
; </end encoding let null>

(push) ;; push{2

; Starting query at DM4F.fst(96,2-96,34)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=DM4F.fst(96,2-96,34)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_b16528360b61445749199368a84703a6 @x2)))
:qid DM4F_pre_typing_Tm_arrow_b16528360b61445749199368a84703a6))

:named DM4F_pre_typing_Tm_arrow_b16528360b61445749199368a84703a6))
...
:pattern ((ApplyTT @x0
@x2))
:qid DM4F_interpretation_Tm_arrow_b16528360b61445749199368a84703a6.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_b16528360b61445749199368a84703a6 @x1)))
:qid DM4F_interpretation_Tm_arrow_b16528360b61445749199368a84703a6))

:named DM4F_interpretation_Tm_arrow_b16528360b61445749199368a84703a6))
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=DM4F.fst(95,20-96,34)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_ce3dd9e6f3110cd000c70bef091f8956 @x2)))
:qid DM4F_pre_typing_Tm_arrow_ce3dd9e6f3110cd000c70bef091f8956))

:named DM4F_pre_typing_Tm_arrow_ce3dd9e6f3110cd000c70bef091f8956))
...
@x2)
@x3))
:qid DM4F_interpretation_Tm_arrow_ce3dd9e6f3110cd000c70bef091f8956.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid DM4F_interpretation_Tm_arrow_ce3dd9e6f3110cd000c70bef091f8956.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_ce3dd9e6f3110cd000c70bef091f8956 @x1)))
:qid DM4F_interpretation_Tm_arrow_ce3dd9e6f3110cd000c70bef091f8956))

:named DM4F_interpretation_Tm_arrow_ce3dd9e6f3110cd000c70bef091f8956))
(declare-fun Tm_abs_20a7238fd07f9d31c2887ac37e91b7a4 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_20a7238fd07f9d31c2887ac37e91b7a4
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(95,39-95,49); use=DM4F.fst(96,2-96,34)
(forall ((@x0 Term))
...
;   Prims.auto_squash u#0
;     (DM4F.st_monotonic u#0 (fun s0 p -> p (FStar.Pervasives.Native.Mktuple2 u#0 u#0 s0 s0))) /\
;   Prims.auto_squash u#0
;     (DM4F.st_monotonic u#0 (fun s0 p -> p (FStar.Pervasives.Native.Mktuple2 u#0 u#0 s0 s0))) /\
;   (forall (s0: st).
;       (*  - Could not prove post-condition
; *)
;       forall (p: Prims.pure_post u#0 (st & st)).
;         p (FStar.Pervasives.Native.Mktuple2 u#0 u#0 s0 s0) ==>
;         (forall (return_val: st & st).
;             return_val == FStar.Pervasives.Native.Mktuple2 u#0 u#0 s0 s0 ==> p return_val))
...
;; def=dummy(0,0-0,0); use=DM4F.fst(95,39-96,33)
(and 
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(95,39-95,49)
(or label_1

;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(96,2-96,34)
(Valid 
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(96,2-96,34)
(DM4F.st_monotonic @x0
@x0
...
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(96,25-96,33)
(Valid 
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(96,25-96,33)
(DM4F.st_monotonic @x0
@x0
...
;; def=dummy(0,0-0,0); use=DM4F.fst(96,25-96,33)
(forall ((@x2 Term))
 (! (implies (HasType @x2
@x0)

;; def=Prims.fst(406,51-406,91); use=DM4F.fst(96,25-96,33)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post (FStar.Pervasives.Native.tuple2 @x0
@x0)))

;; def=DM4F.fst(95,39-95,49); use=DM4F.fst(96,25-96,33)
(Valid 
;; def=DM4F.fst(95,39-95,49); use=DM4F.fst(96,25-96,33)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 @x0
...
;; def=Prims.fst(356,2-356,58); use=DM4F.fst(96,25-96,33)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.tuple2 @x0
@x0))

;; def=Prims.fst(356,26-356,41); use=DM4F.fst(96,25-96,33)
(= @x4
(FStar.Pervasives.Native.Mktuple2 @x0
@x0
@x2
...
;; def=Prims.fst(356,46-356,58); use=DM4F.fst(96,25-96,33)
(or label_3
...
; QUERY ID: (DM4F.get, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_DM4F.st_monotonic, interpretation_Tm_abs_20a7238fd07f9d31c2887ac37e91b7a4
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun DM4F.get (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun DM4F.get@tok () Term)

; </end encoding let get>

(push) ;; push{2

; Starting query at DM4F.fst(99,2-99,32)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=DM4F.fst(99,2-99,32)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_3b93d3a2efc03fbb1aeb57eebff54310 @x2)))
:qid DM4F_pre_typing_Tm_arrow_3b93d3a2efc03fbb1aeb57eebff54310))

:named DM4F_pre_typing_Tm_arrow_3b93d3a2efc03fbb1aeb57eebff54310))
...
:pattern ((ApplyTT @x0
@x2))
:qid DM4F_interpretation_Tm_arrow_3b93d3a2efc03fbb1aeb57eebff54310.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_3b93d3a2efc03fbb1aeb57eebff54310 @x1)))
:qid DM4F_interpretation_Tm_arrow_3b93d3a2efc03fbb1aeb57eebff54310))

:named DM4F_interpretation_Tm_arrow_3b93d3a2efc03fbb1aeb57eebff54310))
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=DM4F.fst(98,29-99,32)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_e53ad9635a6fdac618d4c3368df4e34c @x2)))
:qid DM4F_pre_typing_Tm_arrow_e53ad9635a6fdac618d4c3368df4e34c))

:named DM4F_pre_typing_Tm_arrow_e53ad9635a6fdac618d4c3368df4e34c))
...
@x2)
@x3))
:qid DM4F_interpretation_Tm_arrow_e53ad9635a6fdac618d4c3368df4e34c.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid DM4F_interpretation_Tm_arrow_e53ad9635a6fdac618d4c3368df4e34c.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_e53ad9635a6fdac618d4c3368df4e34c @x1)))
:qid DM4F_interpretation_Tm_arrow_e53ad9635a6fdac618d4c3368df4e34c))

:named DM4F_interpretation_Tm_arrow_e53ad9635a6fdac618d4c3368df4e34c))
(declare-fun Tm_abs_bddbf1da97343ce49be9bf357977f029 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_bddbf1da97343ce49be9bf357977f029
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(98,44-98,53); use=DM4F.fst(99,2-99,32)
(forall ((@x0 Term) (@x1 Term))
...
;   Prims.auto_squash u#0
;     (DM4F.st_monotonic u#0 (fun _ p -> p (FStar.Pervasives.Native.Mktuple2 u#0 u#0 () s))) /\
;   Prims.auto_squash u#0
;     (DM4F.st_monotonic u#0 (fun _ p -> p (FStar.Pervasives.Native.Mktuple2 u#0 u#0 () s))) /\
;   (forall (_: st).
;       (*  - Could not prove post-condition
; *)
;       forall (p: Prims.pure_post u#0 (Prims.unit & st)).
;         p (FStar.Pervasives.Native.Mktuple2 u#0 u#0 () s) ==>
;         (forall (return_val: Prims.unit & st).
;             return_val == FStar.Pervasives.Native.Mktuple2 u#0 u#0 () s ==> p return_val))
...
;; def=dummy(0,0-0,0); use=DM4F.fst(98,44-99,31)
(and 
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(98,44-98,53)
(or label_1

;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(99,2-99,32)
(Valid 
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(99,2-99,32)
(DM4F.st_monotonic @x0
Prims.unit
...
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(99,24-99,31)
(Valid 
;; def=DM4F.fst(17,28-17,42); use=DM4F.fst(99,24-99,31)
(DM4F.st_monotonic @x0
Prims.unit
...
;; def=dummy(0,0-0,0); use=DM4F.fst(99,24-99,31)
(forall ((@x2 Term))
 (! (implies (HasType @x2
@x0)

;; def=Prims.fst(406,51-406,91); use=DM4F.fst(99,24-99,31)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post (FStar.Pervasives.Native.tuple2 Prims.unit
@x0)))

;; def=DM4F.fst(98,44-98,53); use=DM4F.fst(99,24-99,31)
(Valid 
;; def=DM4F.fst(98,44-98,53); use=DM4F.fst(99,24-99,31)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=Prims.fst(356,2-356,58); use=DM4F.fst(99,24-99,31)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.tuple2 Prims.unit
@x0))

;; def=Prims.fst(356,26-356,41); use=DM4F.fst(99,24-99,31)
(= @x4
(FStar.Pervasives.Native.Mktuple2 Prims.unit
@x0
Tm_unit
...
;; def=Prims.fst(356,46-356,58); use=DM4F.fst(99,24-99,31)
(or label_3
...
; QUERY ID: (DM4F.put, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_f8666440faa91836cc5a13998af863fc, equation_DM4F.st_monotonic, interpretation_Tm_abs_bddbf1da97343ce49be9bf357977f029, unit_typing
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun DM4F.put (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun DM4F.put@tok () Term)
...
;;;;;;;;;;;;;;;;typing_Tm_abs_ac22a594b282e3624667bed6f5093659
;;; Fact-ids: Name DM4F.null; Namespace DM4F
(assert (! 
;; def=DM4F.fst(93,14-93,27); use=DM4F.fst(93,14-93,27)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_ac22a594b282e3624667bed6f5093659 @x0
...
;;; Fact-ids: Name DM4F.null; Namespace DM4F
(assert (! 
;; def=DM4F.fst(92,4-92,8); use=DM4F.fst(92,4-92,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (DM4F.null @x0
@x1)
(DM4F.wp @x0
@x1)))
 

:pattern ((DM4F.null @x0
@x1))
:qid typing_DM4F.null))

:named typing_DM4F.null))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name DM4F.null; Namespace DM4F
(assert (! 
;; def=DM4F.fst(92,4-92,8); use=DM4F.fst(92,4-92,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT DM4F.null@tok
@x0)
@x1)
(DM4F.null @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT DM4F.null@tok
@x0)
@x1))
:qid token_correspondence_DM4F.null))

:named token_correspondence_DM4F.null))
;;;;;;;;;;;;;;;;refinement kinding
...
:named l_quant_interp_7476593ebb206e7a8235a58ae2f6298e))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_41e9134c4496349f63944273f801aba9
;;; Fact-ids: Name DM4F.null; Namespace DM4F
(assert (! (HasType Tm_arrow_41e9134c4496349f63944273f801aba9
Tm_type)
:named kinding_Tm_arrow_41e9134c4496349f63944273f801aba9))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_ac22a594b282e3624667bed6f5093659
;;; Fact-ids: Name DM4F.null; Namespace DM4F
(assert (! 
;; def=DM4F.fst(93,14-93,27); use=DM4F.fst(93,14-93,27)
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType DM4F.null@tok
Tm_arrow_41e9134c4496349f63944273f801aba9))
...
:pattern ((DM4F.null @x1
@x2))
:qid function_token_typing_DM4F.null.1))
)
 

:pattern ((ApplyTT @x0
DM4F.null@tok))
:qid function_token_typing_DM4F.null))

:named function_token_typing_DM4F.null))
;;;;;;;;;;;;;;;;Equation for DM4F.null
;;; Fact-ids: Name DM4F.null; Namespace DM4F
(assert (! 
;; def=DM4F.fst(92,4-92,8); use=DM4F.fst(92,4-92,8)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((DM4F.null @x0
@x1))
:qid equation_DM4F.null))

:named equation_DM4F.null))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
;;; Fact-ids: Name DM4F.null; Namespace DM4F
(assert (! 
;; def=DM4F.fst(9,13-92,25); use=DM4F.fst(92,10-92,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_41e9134c4496349f63944273f801aba9)
...
@x1
Tm_arrow_41e9134c4496349f63944273f801aba9))
:qid DM4F_pre_typing_Tm_arrow_41e9134c4496349f63944273f801aba9))

:named DM4F_pre_typing_Tm_arrow_41e9134c4496349f63944273f801aba9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_41e9134c4496349f63944273f801aba9
;;; Fact-ids: Name DM4F.null; Namespace DM4F
(assert (! 
;; def=DM4F.fst(9,13-92,25); use=DM4F.fst(92,10-92,25)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid DM4F_interpretation_Tm_arrow_41e9134c4496349f63944273f801aba9.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid DM4F_interpretation_Tm_arrow_41e9134c4496349f63944273f801aba9.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_41e9134c4496349f63944273f801aba9))
:qid DM4F_interpretation_Tm_arrow_41e9134c4496349f63944273f801aba9))

:named DM4F_interpretation_Tm_arrow_41e9134c4496349f63944273f801aba9))
(push) ;; push{2

; Starting query at DM4F.fst(101,31-104,17)
...
;;; Fact-ids: 
(assert (! 
;; def=DM4F.fst(10,9-10,24); use=DM4F.fst(68,20-68,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_3e8b49f14488374d63bce57fd67fc3b4))
:qid DM4F_pre_typing_Tm_arrow_3e8b49f14488374d63bce57fd67fc3b4))

:named DM4F_pre_typing_Tm_arrow_3e8b49f14488374d63bce57fd67fc3b4))
...
:pattern ((ApplyTT @x0
@x1))
:qid DM4F_interpretation_Tm_arrow_3e8b49f14488374d63bce57fd67fc3b4.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_3e8b49f14488374d63bce57fd67fc3b4))
:qid DM4F_interpretation_Tm_arrow_3e8b49f14488374d63bce57fd67fc3b4))

:named DM4F_interpretation_Tm_arrow_3e8b49f14488374d63bce57fd67fc3b4))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
DM4F.null@tok))
:named @kick_partial_app_a51a78e7d1af1bde9661b1590ed149a8))

; Encoding query formula : forall (_: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (s0: Prims.int) (p: (_: Prims.int & Prims.int -> Type0)).
;     DM4F.null u#0 s0 p ==>
;     p (FStar.Pervasives.Native.Mktuple2 u#0 u#0 (s0 + s0 + (s0 + s0)) (s0 + s0))
...
(Valid 
;; def=DM4F.fst(60,17-60,24); use=DM4F.fst(68,20-68,28)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT DM4F.null@tok
Prims.int)
Prims.int)
@x1)
@x2)
...
;; def=DM4F.fst(23,66-23,75); use=DM4F.fst(101,31-104,17)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (DM4F.test, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_typing_intro_FStar.Pervasives.Native.Mktuple2@tok, equation_DM4F.null, equation_Prims.eqtype, int_inversion, int_typing, interpretation_Tm_abs_ac22a594b282e3624667bed6f5093659, l_quant_interp_7476593ebb206e7a8235a58ae2f6298e, primitive_Prims.op_Addition, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, token_correspondence_DM4F.null, typing_Prims.int
