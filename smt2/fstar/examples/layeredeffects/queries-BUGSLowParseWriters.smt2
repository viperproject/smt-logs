...
; Internals for BUGSLowParseWriters


; encoding sigelt #set-options "--warn_error -352"


; <Skipped #set-options "--warn_error -352"/>


; encoding sigelt let memory_invariant


; <Start encoding let memory_invariant>

(declare-fun BUGSLowParseWriters.memory_invariant () Term)

; </end encoding let memory_invariant>


; encoding sigelt type BUGSLowParseWriters.result


; <Start encoding type BUGSLowParseWriters.result>

;;;;;;;;;;;;;;;;Constructor
(declare-fun BUGSLowParseWriters.result (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun BUGSLowParseWriters.result@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun BUGSLowParseWriters.Correct (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BUGSLowParseWriters.Correct_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BUGSLowParseWriters.Correct__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: BUGSLowParseWriters.Correct
(declare-fun BUGSLowParseWriters.Correct@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun BUGSLowParseWriters.Error (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BUGSLowParseWriters.Error_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BUGSLowParseWriters.Error__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: BUGSLowParseWriters.Error
(declare-fun BUGSLowParseWriters.Error@tok () Term)
;;;;;;;;;;;;;;;;_0: a -> result a
(declare-fun Tm_arrow_6828c97bd64b5e40494265ff9af15f5f () Term)
;;;;;;;;;;;;;;;;_0: Prims.string -> result a
(declare-fun Tm_arrow_b3f8568ef7357692977f581c586786d0 () Term)

; <start constructor BUGSLowParseWriters.result>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-BUGSLowParseWriters.result ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
(BUGSLowParseWriters.result @x0))
 
;;no pats
:qid is-BUGSLowParseWriters.result))))

; </end constructor BUGSLowParseWriters.result>


; <start constructor BUGSLowParseWriters.Correct>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-BUGSLowParseWriters.Correct ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
111)
(= __@x0
(BUGSLowParseWriters.Correct (BUGSLowParseWriters.Correct_a __@x0)
(BUGSLowParseWriters.Correct__0 __@x0)))))

; </end constructor BUGSLowParseWriters.Correct>


; <start constructor BUGSLowParseWriters.Error>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-BUGSLowParseWriters.Error ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
116)
(= __@x0
(BUGSLowParseWriters.Error (BUGSLowParseWriters.Error_a __@x0)
(BUGSLowParseWriters.Error__0 __@x0)))))

; </end constructor BUGSLowParseWriters.Error>


; </end encoding type BUGSLowParseWriters.result>


; encoding sigelt val BUGSLowParseWriters.uu___is_Correct


; <Start encoding val BUGSLowParseWriters.uu___is_Correct>

(declare-fun BUGSLowParseWriters.uu___is_Correct (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: result a -> Prims.bool
(declare-fun Tm_arrow_64ecb9b5e03a7f16b739e17f4e3ab888 () Term)
(declare-fun BUGSLowParseWriters.uu___is_Correct@tok () Term)

; </end encoding val BUGSLowParseWriters.uu___is_Correct>


; encoding sigelt let uu___is_Correct


; <Skipped let uu___is_Correct/>


; encoding sigelt val BUGSLowParseWriters.__proj__Correct__item___0


; <Start encoding val BUGSLowParseWriters.__proj__Correct__item___0>

(declare-fun Tm_refine_663361c39544907ac5067c9c50873bd4 (Term) Term)
(declare-fun BUGSLowParseWriters.__proj__Correct__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: result a {Correct? _} -> a
(declare-fun Tm_arrow_c2abf806d292620153e000c5dfcf2d7a () Term)
(declare-fun BUGSLowParseWriters.__proj__Correct__item___0@tok () Term)

; </end encoding val BUGSLowParseWriters.__proj__Correct__item___0>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BUGSLowParseWriters.uu___is_Correct; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(BUGSLowParseWriters.result @x0)))
(HasType (BUGSLowParseWriters.uu___is_Correct @x0
@x1)
Prims.bool))
 

:pattern ((BUGSLowParseWriters.uu___is_Correct @x0
@x1))
:qid typing_BUGSLowParseWriters.uu___is_Correct))

:named typing_BUGSLowParseWriters.uu___is_Correct))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(40,5-40,11); use=BUGSLowParseWriters.fst(40,5-40,11)
(forall ((@x0 Term))
 (! (= (ApplyTT BUGSLowParseWriters.result@tok
@x0)
(BUGSLowParseWriters.result @x0))
 

:pattern ((ApplyTT BUGSLowParseWriters.result@tok
@x0))

:pattern ((BUGSLowParseWriters.result @x0))
:qid token_correspondence_BUGSLowParseWriters.result@tok))

:named token_correspondence_BUGSLowParseWriters.result@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(BUGSLowParseWriters.Error @x1
@x2)
(BUGSLowParseWriters.result @x3))
...
@x2)
(BUGSLowParseWriters.result @x3)))
:qid subterm_ordering_BUGSLowParseWriters.Error))

:named subterm_ordering_BUGSLowParseWriters.Error))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(BUGSLowParseWriters.Correct @x1
@x2)
(BUGSLowParseWriters.result @x3))
(Valid (Prims.precedes Prims.lex_t
Prims.lex_t
...
@x2)
(BUGSLowParseWriters.result @x3)))
:qid subterm_ordering_BUGSLowParseWriters.Correct))

:named subterm_ordering_BUGSLowParseWriters.Correct))
;;;;;;;;;;;;;;;;string inversion
;;; Fact-ids: Name Prims.string; Namespace Prims
(assert (! (forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name BUGSLowParseWriters.__proj__Correct__item___0; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_663361c39544907ac5067c9c50873bd4 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_663361c39544907ac5067c9c50873bd4 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_663361c39544907ac5067c9c50873bd4))

:named refinement_kinding_Tm_refine_663361c39544907ac5067c9c50873bd4))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_663361c39544907ac5067c9c50873bd4 @x2))
(and (HasTypeFuel @u0
@x1
(BUGSLowParseWriters.result @x2))

;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(BoxBool_proj_0 (BUGSLowParseWriters.uu___is_Correct @x2
@x1))
))
...
@x1
(Tm_refine_663361c39544907ac5067c9c50873bd4 @x2)))
:qid refinement_interpretation_Tm_refine_663361c39544907ac5067c9c50873bd4))

:named refinement_interpretation_Tm_refine_663361c39544907ac5067c9c50873bd4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (BUGSLowParseWriters.Error_a (BUGSLowParseWriters.Error @x0
@x1))
@x0)
 

:pattern ((BUGSLowParseWriters.Error @x0
@x1))
:qid projection_inverse_BUGSLowParseWriters.Error_a))

:named projection_inverse_BUGSLowParseWriters.Error_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (BUGSLowParseWriters.Error__0 (BUGSLowParseWriters.Error @x0
@x1))
@x1)
...
:pattern ((BUGSLowParseWriters.Error @x0
@x1))
:qid projection_inverse_BUGSLowParseWriters.Error__0))

:named projection_inverse_BUGSLowParseWriters.Error__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (BUGSLowParseWriters.Correct_a (BUGSLowParseWriters.Correct @x0
@x1))
@x0)
 

:pattern ((BUGSLowParseWriters.Correct @x0
@x1))
:qid projection_inverse_BUGSLowParseWriters.Correct_a))

:named projection_inverse_BUGSLowParseWriters.Correct_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (BUGSLowParseWriters.Correct__0 (BUGSLowParseWriters.Correct @x0
@x1))
@x1)
...
:pattern ((BUGSLowParseWriters.Correct @x0
@x1))
:qid projection_inverse_BUGSLowParseWriters.Correct__0))

:named projection_inverse_BUGSLowParseWriters.Correct__0))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! (is-Tm_arrow (PreType BUGSLowParseWriters.result@tok))
:named pre_kinding_BUGSLowParseWriters.result@tok))
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! (and (IsTotFun BUGSLowParseWriters.result@tok)

;; def=BUGSLowParseWriters.fst(40,5-40,11); use=BUGSLowParseWriters.fst(40,5-40,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (BUGSLowParseWriters.result @x0)
Tm_type))
 

:pattern ((BUGSLowParseWriters.result @x0))
:qid kinding_BUGSLowParseWriters.result@tok))
)
:named kinding_BUGSLowParseWriters.result@tok))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_663361c39544907ac5067c9c50873bd4
;;; Fact-ids: Name BUGSLowParseWriters.__proj__Correct__item___0; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_663361c39544907ac5067c9c50873bd4 @x0)))
(Valid (Prims.hasEq (BUGSLowParseWriters.result @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_663361c39544907ac5067c9c50873bd4 @x0))))
:qid haseqTm_refine_663361c39544907ac5067c9c50873bd4))

:named haseqTm_refine_663361c39544907ac5067c9c50873bd4))
...
@x1
(BUGSLowParseWriters.result @x2))
(or (and (is-BUGSLowParseWriters.Correct @x1)
(= @x2
(BUGSLowParseWriters.Correct_a @x1)))
(and (is-BUGSLowParseWriters.Error @x1)
(= @x2
(BUGSLowParseWriters.Error_a @x1)))))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
(BUGSLowParseWriters.result @x2)))
:qid fuel_guarded_inversion_BUGSLowParseWriters.result))

:named fuel_guarded_inversion_BUGSLowParseWriters.result))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! (= 105
(Term_constr_id BUGSLowParseWriters.result@tok))
:named fresh_token_BUGSLowParseWriters.result@tok))
...
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (BUGSLowParseWriters.uu___is_Correct @x0
@x1)
(BoxBool (is-BUGSLowParseWriters.Correct @x1)))
 

:pattern ((BUGSLowParseWriters.uu___is_Correct @x0
@x1))
:qid disc_equation_BUGSLowParseWriters.Correct))

:named disc_equation_BUGSLowParseWriters.Correct))
...
@x2)
(BUGSLowParseWriters.result @x1)))
:qid data_typing_intro_BUGSLowParseWriters.Error@tok))

:named data_typing_intro_BUGSLowParseWriters.Error@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
...
@x2)
(BUGSLowParseWriters.result @x1)))
:qid data_typing_intro_BUGSLowParseWriters.Correct@tok))

:named data_typing_intro_BUGSLowParseWriters.Correct@tok))
...
@x2)
(BUGSLowParseWriters.result @x3)))
:qid data_elim_BUGSLowParseWriters.Error))

:named data_elim_BUGSLowParseWriters.Error))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
...
@x2)
(BUGSLowParseWriters.result @x3)))
:qid data_elim_BUGSLowParseWriters.Correct))

:named data_elim_BUGSLowParseWriters.Correct))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term))
 (! (= 104
(Term_constr_id (BUGSLowParseWriters.result @x0)))
 

:pattern ((BUGSLowParseWriters.result @x0))
:qid constructor_distinct_BUGSLowParseWriters.result))

:named constructor_distinct_BUGSLowParseWriters.result))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= 116
(Term_constr_id (BUGSLowParseWriters.Error @x0
@x1)))
 

:pattern ((BUGSLowParseWriters.Error @x0
@x1))
:qid constructor_distinct_BUGSLowParseWriters.Error))

:named constructor_distinct_BUGSLowParseWriters.Error))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name BUGSLowParseWriters.result; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Correct; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= 111
(Term_constr_id (BUGSLowParseWriters.Correct @x0
@x1)))
 

:pattern ((BUGSLowParseWriters.Correct @x0
@x1))
:qid constructor_distinct_BUGSLowParseWriters.Correct))

:named constructor_distinct_BUGSLowParseWriters.Correct))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x0
(BUGSLowParseWriters.result @x2)))
:qid BUGSLowParseWriters_pretyping_924ea0eaaccb632095f0d4df4062a398))

:named BUGSLowParseWriters_pretyping_924ea0eaaccb632095f0d4df4062a398))
(push) ;; push{2
...
; Encoding query formula : forall (a: Type) (projectee: _: BUGSLowParseWriters.result a {Correct? _}).
;   (*  - Could not prove post-condition
; *) ~(Correct? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Correct__item___0`
...
Tm_type)
(HasType @x1
(Tm_refine_663361c39544907ac5067c9c50873bd4 @x0))

;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(not 
;; def=BUGSLowParseWriters.fst(41,2-41,9); use=BUGSLowParseWriters.fst(41,2-41,9)
(BoxBool_proj_0 (BUGSLowParseWriters.uu___is_Correct @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.__proj__Correct__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_663361c39544907ac5067c9c50873bd4
...
; encoding sigelt let __proj__Correct__item___0


; <Skipped let __proj__Correct__item___0/>


; encoding sigelt val BUGSLowParseWriters.uu___is_Error


; <Start encoding val BUGSLowParseWriters.uu___is_Error>

(declare-fun BUGSLowParseWriters.uu___is_Error (Term Term) Term)

(declare-fun BUGSLowParseWriters.uu___is_Error@tok () Term)

; </end encoding val BUGSLowParseWriters.uu___is_Error>


; encoding sigelt let uu___is_Error


; <Skipped let uu___is_Error/>


; encoding sigelt val BUGSLowParseWriters.__proj__Error__item___0


; <Start encoding val BUGSLowParseWriters.__proj__Error__item___0>

(declare-fun Tm_refine_3b282434ccd43fdb008018983e216134 (Term) Term)
(declare-fun BUGSLowParseWriters.__proj__Error__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: result a {Error? _} -> Prims.string
(declare-fun Tm_arrow_99b13a14fd5dad725430aee8ce940aec () Term)
(declare-fun BUGSLowParseWriters.__proj__Error__item___0@tok () Term)

; </end encoding val BUGSLowParseWriters.__proj__Error__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BUGSLowParseWriters.uu___is_Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(BUGSLowParseWriters.result @x0)))
(HasType (BUGSLowParseWriters.uu___is_Error @x0
@x1)
Prims.bool))
 

:pattern ((BUGSLowParseWriters.uu___is_Error @x0
@x1))
:qid typing_BUGSLowParseWriters.uu___is_Error))

:named typing_BUGSLowParseWriters.uu___is_Error))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name BUGSLowParseWriters.__proj__Error__item___0; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_3b282434ccd43fdb008018983e216134 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_3b282434ccd43fdb008018983e216134 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_3b282434ccd43fdb008018983e216134))

:named refinement_kinding_Tm_refine_3b282434ccd43fdb008018983e216134))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name BUGSLowParseWriters.__proj__Error__item___0; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3b282434ccd43fdb008018983e216134 @x2))
(and (HasTypeFuel @u0
@x1
(BUGSLowParseWriters.result @x2))

;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(BoxBool_proj_0 (BUGSLowParseWriters.uu___is_Error @x2
@x1))
))
...
@x1
(Tm_refine_3b282434ccd43fdb008018983e216134 @x2)))
:qid refinement_interpretation_Tm_refine_3b282434ccd43fdb008018983e216134))

:named refinement_interpretation_Tm_refine_3b282434ccd43fdb008018983e216134))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3b282434ccd43fdb008018983e216134
;;; Fact-ids: Name BUGSLowParseWriters.__proj__Error__item___0; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3b282434ccd43fdb008018983e216134 @x0)))
(Valid (Prims.hasEq (BUGSLowParseWriters.result @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3b282434ccd43fdb008018983e216134 @x0))))
:qid haseqTm_refine_3b282434ccd43fdb008018983e216134))

:named haseqTm_refine_3b282434ccd43fdb008018983e216134))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name BUGSLowParseWriters.uu___is_Error; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (BUGSLowParseWriters.uu___is_Error @x0
@x1)
(BoxBool (is-BUGSLowParseWriters.Error @x1)))
 

:pattern ((BUGSLowParseWriters.uu___is_Error @x0
@x1))
:qid disc_equation_BUGSLowParseWriters.Error))

:named disc_equation_BUGSLowParseWriters.Error))
(push) ;; push{2
...
; Encoding query formula : forall (a: Type) (projectee: _: BUGSLowParseWriters.result a {Error? _}).
;   (*  - Could not prove post-condition
; *) ~(Error? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Error__item___0`
...
Tm_type)
(HasType @x1
(Tm_refine_3b282434ccd43fdb008018983e216134 @x0))

;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(not 
;; def=BUGSLowParseWriters.fst(42,2-42,7); use=BUGSLowParseWriters.fst(42,2-42,7)
(BoxBool_proj_0 (BUGSLowParseWriters.uu___is_Error @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.__proj__Error__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_3b282434ccd43fdb008018983e216134
...
; encoding sigelt let __proj__Error__item___0


; <Skipped let __proj__Error__item___0/>


; encoding sigelt let pure_post_err


; <Start encoding let pure_post_err>

(declare-fun BUGSLowParseWriters.pure_post_err (Term) Term)
;;;;;;;;;;;;;;;;pre: Prims.pure_pre -> Type
(declare-fun Tm_arrow_5da07cbe3084f1be91cd25f6217f8315 () Term)
(declare-fun BUGSLowParseWriters.pure_post_err@tok () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.GTot Type
(declare-fun Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe () Term)

; </end encoding let pure_post_err>


; encoding sigelt let pure_post'


; <Start encoding let pure_post'>

(declare-fun BUGSLowParseWriters.pure_post_ (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> pre: Prims.pure_pre -> Type
(declare-fun Tm_arrow_66c8fd70a204b4b4a8d6e740ac0b8fb1 () Term)
(declare-fun BUGSLowParseWriters.pure_post_@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BUGSLowParseWriters.pure_post_err; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(44,4-44,17); use=BUGSLowParseWriters.fst(44,4-44,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.pure_pre)
(HasType (BUGSLowParseWriters.pure_post_err @x0)
Tm_type))
 

:pattern ((BUGSLowParseWriters.pure_post_err @x0))
:qid typing_BUGSLowParseWriters.pure_post_err))

:named typing_BUGSLowParseWriters.pure_post_err))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BUGSLowParseWriters.pure_post'; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(49,4-49,14); use=BUGSLowParseWriters.fst(49,4-49,14)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Prims.pure_pre))
(HasType (BUGSLowParseWriters.pure_post_ @x0
@x1)
Tm_type))
 

:pattern ((BUGSLowParseWriters.pure_post_ @x0
@x1))
:qid typing_BUGSLowParseWriters.pure_post_))

:named typing_BUGSLowParseWriters.pure_post_))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for BUGSLowParseWriters.pure_post_err
;;; Fact-ids: Name BUGSLowParseWriters.pure_post_err; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(44,4-44,17); use=BUGSLowParseWriters.fst(44,4-44,17)
(forall ((@x0 Term))
 (! (= (BUGSLowParseWriters.pure_post_err @x0)
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe)
 

:pattern ((BUGSLowParseWriters.pure_post_err @x0))
:qid equation_BUGSLowParseWriters.pure_post_err))

:named equation_BUGSLowParseWriters.pure_post_err))
;;;;;;;;;;;;;;;;Equation for BUGSLowParseWriters.pure_post'
;;; Fact-ids: Name BUGSLowParseWriters.pure_post'; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(49,4-49,14); use=BUGSLowParseWriters.fst(49,4-49,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (BUGSLowParseWriters.pure_post_ @x0
@x1)
...
:pattern ((BUGSLowParseWriters.pure_post_ @x0
@x1))
:qid equation_BUGSLowParseWriters.pure_post_))

:named equation_BUGSLowParseWriters.pure_post_))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;;; Fact-ids: Name BUGSLowParseWriters.pure_post_err; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(47,2-47,37); use=BUGSLowParseWriters.fst(47,2-47,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe)
...
@x1
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
:qid BUGSLowParseWriters_pre_typing_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))

:named BUGSLowParseWriters_pre_typing_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
...
:pattern ((ApplyTT @x0
@x1))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))

:named BUGSLowParseWriters_interpretation_Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe))
(push) ;; push{2

; Starting query at BUGSLowParseWriters.fst(57,2-64,4)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_a21d04f2177efa608733964b5aa08d52 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=BUGSLowParseWriters.fst(57,2-58,18)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_a21d04f2177efa608733964b5aa08d52 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_a21d04f2177efa608733964b5aa08d52 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_a21d04f2177efa608733964b5aa08d52))

:named refinement_kinding_Tm_refine_a21d04f2177efa608733964b5aa08d52))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=BUGSLowParseWriters.fst(57,2-58,18)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a21d04f2177efa608733964b5aa08d52 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(BUGSLowParseWriters.result @x2))

;; def=BUGSLowParseWriters.fst(56,33-56,36); use=BUGSLowParseWriters.fst(59,12-59,15)
(Valid 
;; def=BUGSLowParseWriters.fst(56,33-56,36); use=BUGSLowParseWriters.fst(59,12-59,15)
@x3
)
...
(Tm_refine_a21d04f2177efa608733964b5aa08d52 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_a21d04f2177efa608733964b5aa08d52))

:named refinement_interpretation_Tm_refine_a21d04f2177efa608733964b5aa08d52))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a21d04f2177efa608733964b5aa08d52
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(315,31-315,40); use=BUGSLowParseWriters.fst(57,2-58,18)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a21d04f2177efa608733964b5aa08d52 @x0
@x1)))
(Valid (Prims.hasEq (BUGSLowParseWriters.result @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a21d04f2177efa608733964b5aa08d52 @x0
@x1))))
:qid haseqTm_refine_a21d04f2177efa608733964b5aa08d52))

:named haseqTm_refine_a21d04f2177efa608733964b5aa08d52))
...
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.unit) (res: _: BUGSLowParseWriters.result a {pre}).
;     (*  - Could not prove post-condition
; *)
;     forall (k: Prims.pure_post Type0).
;       (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;       ~(Correct? res) /\ ~(Error? res) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let read_repr_spec`
...
@x1))
(HasType @x3
(BUGSLowParseWriters.pure_post_err @x1)))

;; def=dummy(0,0-0,0); use=BUGSLowParseWriters.fst(57,2-64,4)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
Prims.unit)
(HasType @x5
(Tm_refine_a21d04f2177efa608733964b5aa08d52 @x0
@x1)))

;; def=dummy(0,0-0,0); use=BUGSLowParseWriters.fst(57,2-58,18)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Prims.pure_post Tm_type))

;; def=Prims.fst(402,27-402,88); use=BUGSLowParseWriters.fst(57,2-58,18)
(forall ((@x7 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=BUGSLowParseWriters.fst(57,2-58,18)
(Valid 
;; def=Prims.fst(402,84-402,87); use=BUGSLowParseWriters.fst(57,2-58,18)
(ApplyTT @x6
@x7)
...
;; def=BUGSLowParseWriters.fst(60,16-60,19); use=BUGSLowParseWriters.fst(57,2-58,18)
(not 
;; def=BUGSLowParseWriters.fst(60,16-60,19); use=BUGSLowParseWriters.fst(57,2-58,18)
(BoxBool_proj_0 (BUGSLowParseWriters.uu___is_Correct @x0
@x5))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.read_repr_spec, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, disc_equation_BUGSLowParseWriters.Correct, disc_equation_BUGSLowParseWriters.Error, fuel_guarded_inversion_BUGSLowParseWriters.result, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_a21d04f2177efa608733964b5aa08d52
...
; encoding sigelt let read_repr_spec


; <Start encoding let read_repr_spec>

(declare-fun BUGSLowParseWriters.read_repr_spec (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> pre: Prims.pure_pre -> post: pure_post' a pre -> post_err: pure_post_err pre -> Type
(declare-fun Tm_arrow_1907b807146deb6e0f7b57756c7ef21f () Term)
(declare-fun BUGSLowParseWriters.read_repr_spec@tok () Term)
(declare-fun Tm_refine_d73b7e5ec1a4e0557de140da3de1db58 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.Ghost (result a)
(declare-fun Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3 (Term Term Term Term) Term)

; </end encoding let read_repr_spec>


; encoding sigelt type BUGSLowParseWriters.read_repr


; <Start encoding type BUGSLowParseWriters.read_repr>

;;;;;;;;;;;;;;;;Constructor
(declare-fun BUGSLowParseWriters.read_repr (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun BUGSLowParseWriters.read_repr@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun BUGSLowParseWriters.ReadRepr (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BUGSLowParseWriters.ReadRepr_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BUGSLowParseWriters.ReadRepr_pre (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BUGSLowParseWriters.ReadRepr_post (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BUGSLowParseWriters.ReadRepr_post_err (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BUGSLowParseWriters.ReadRepr_l (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun BUGSLowParseWriters.ReadRepr_spec (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: BUGSLowParseWriters.ReadRepr
(declare-fun BUGSLowParseWriters.ReadRepr@tok () Term)
;;;;;;;;;;;;;;;;spec: read_repr_spec a pre post post_err -> read_repr a pre post post_err l
(declare-fun Tm_arrow_6ab28ee371a42b6a0c258ad056193202 () Term)

; <start constructor BUGSLowParseWriters.read_repr>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-BUGSLowParseWriters.read_repr ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
148)
(exists ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= __@x0
(BUGSLowParseWriters.read_repr @x0
@x1
@x2
@x3
@x4))
...
;;no pats
:qid is-BUGSLowParseWriters.read_repr))))

; </end constructor BUGSLowParseWriters.read_repr>


; <start constructor BUGSLowParseWriters.ReadRepr>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-BUGSLowParseWriters.ReadRepr ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
155)
(= __@x0
(BUGSLowParseWriters.ReadRepr (BUGSLowParseWriters.ReadRepr_a __@x0)
(BUGSLowParseWriters.ReadRepr_pre __@x0)
(BUGSLowParseWriters.ReadRepr_post __@x0)
(BUGSLowParseWriters.ReadRepr_post_err __@x0)
(BUGSLowParseWriters.ReadRepr_l __@x0)
(BUGSLowParseWriters.ReadRepr_spec __@x0)))))

; </end constructor BUGSLowParseWriters.ReadRepr>


; </end encoding type BUGSLowParseWriters.read_repr>


; encoding sigelt val BUGSLowParseWriters.uu___is_ReadRepr


; <Start encoding val BUGSLowParseWriters.uu___is_ReadRepr>

(declare-fun BUGSLowParseWriters.uu___is_ReadRepr (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: read_repr a pre post post_err l -> Prims.bool
(declare-fun Tm_arrow_1bc5c9d781e64eecb508acfa842cfb40 () Term)
(declare-fun BUGSLowParseWriters.uu___is_ReadRepr@tok () Term)

; </end encoding val BUGSLowParseWriters.uu___is_ReadRepr>


; encoding sigelt let uu___is_ReadRepr


; <Skipped let uu___is_ReadRepr/>


; encoding sigelt val BUGSLowParseWriters.__proj__ReadRepr__item__spec


; <Start encoding val BUGSLowParseWriters.__proj__ReadRepr__item__spec>

(declare-fun BUGSLowParseWriters.__proj__ReadRepr__item__spec (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: read_repr a pre post post_err l -> read_repr_spec a pre post post_err
(declare-fun Tm_arrow_f6298b057c4595fb92228179d95b9172 () Term)
(declare-fun BUGSLowParseWriters.__proj__ReadRepr__item__spec@tok () Term)

; </end encoding val BUGSLowParseWriters.__proj__ReadRepr__item__spec>


; encoding sigelt let __proj__ReadRepr__item__spec


; <Skipped let __proj__ReadRepr__item__spec/>

(push) ;; push{2

; Starting query at BUGSLowParseWriters.fst(80,2-80,20)
...
;     (*  - Could not prove post-condition
; *)
;     forall (p: Prims.pure_post (BUGSLowParseWriters.result a)).
;       (forall (ghost_result: BUGSLowParseWriters.result a).
;           (match ghost_result with
;             | BUGSLowParseWriters.Correct v -> v == x
;             | BUGSLowParseWriters.Error _ -> Prims.l_False) ==>
;           p ghost_result) ==>
;       (forall (return_val: BUGSLowParseWriters.result a).
;           return_val == BUGSLowParseWriters.Correct x ==> p return_val)


; Context: While encoding a query
; While typechecking the top-level declaration `let read_return_spec`
...
;; def=dummy(0,0-0,0); use=BUGSLowParseWriters.fst(80,2-80,20)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(406,51-406,91); use=BUGSLowParseWriters.fst(80,2-80,20)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post (BUGSLowParseWriters.result @x0)))

;; def=Prims.fst(485,36-485,100); use=BUGSLowParseWriters.fst(80,11-80,20)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
(BUGSLowParseWriters.result @x0)))
(let ((@lb5 @x4))
(ite (is-BUGSLowParseWriters.Correct @lb5)

;; def=BUGSLowParseWriters.fst(79,41-79,49); use=BUGSLowParseWriters.fst(80,11-80,20)
(or label_2

;; def=BUGSLowParseWriters.fst(79,41-79,49); use=BUGSLowParseWriters.fst(80,11-80,20)
(= (BUGSLowParseWriters.Correct__0 @lb5)
@x1)
)

(ite (is-BUGSLowParseWriters.Error @lb5)
label_3
Unreachable))))

;; def=Prims.fst(485,85-485,99); use=BUGSLowParseWriters.fst(80,11-80,20)
(Valid 
;; def=Prims.fst(485,85-485,99); use=BUGSLowParseWriters.fst(80,11-80,20)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(356,2-356,58); use=BUGSLowParseWriters.fst(80,2-80,20)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(BUGSLowParseWriters.result @x0))

;; def=Prims.fst(356,26-356,41); use=BUGSLowParseWriters.fst(80,2-80,20)
(= @x4
(BUGSLowParseWriters.Correct @x0
@x1))
)

;; def=Prims.fst(356,46-356,58); use=BUGSLowParseWriters.fst(80,2-80,20)
(Valid 
;; def=Prims.fst(356,46-356,58); use=BUGSLowParseWriters.fst(80,2-80,20)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.read_return_spec, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, constructor_distinct_BUGSLowParseWriters.Correct, projection_inverse_BUGSLowParseWriters.Correct__0, projection_inverse_BUGSLowParseWriters.Correct_a
...
; encoding sigelt let read_return_spec


; <Start encoding let read_return_spec>

(declare-fun BUGSLowParseWriters.read_return_spec (Term Term) Term)

(declare-fun Tm_abs_bbcaf2c7177276dfe13060488d87cfe1 (Term Term) Term)

(declare-fun Tm_abs_077c0f895008f5d74804c404b01870e8 () Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> read_repr_spec a Prims.l_True (fun res -> res == x) (fun _ -> Prims.l_False)
(declare-fun Tm_arrow_ee670d91ff8d3bff2897cc480c721294 () Term)
(declare-fun BUGSLowParseWriters.read_return_spec@tok () Term)




(declare-fun Tm_abs_9fd0b052fb930cc6efce41d2a00c22ac (Term Term) Term)

; </end encoding let read_return_spec>


; encoding sigelt let read_return


; <Start encoding let read_return>

(declare-fun BUGSLowParseWriters.read_return (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type -> x: a -> inv: memory_invariant   -> read_repr a Prims.l_True (fun res -> res == x) (fun _ -> Prims.l_False) inv
(declare-fun Tm_arrow_21091e6097a7463e87b747d6b9031bdc () Term)
(declare-fun BUGSLowParseWriters.read_return@tok () Term)
...
; </end encoding let read_return>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BUGSLowParseWriters.read_repr_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(56,4-56,18); use=BUGSLowParseWriters.fst(56,4-56,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x3
(BUGSLowParseWriters.pure_post_err @x1)))
(HasType (BUGSLowParseWriters.read_repr_spec @x0
@x1
@x2
@x3)
Tm_type))
...
:pattern ((BUGSLowParseWriters.read_repr_spec @x0
@x1
@x2
@x3))
:qid typing_BUGSLowParseWriters.read_repr_spec))

:named typing_BUGSLowParseWriters.read_repr_spec))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name BUGSLowParseWriters.read_repr_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(58,8-58,18); use=BUGSLowParseWriters.fst(58,8-58,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_d73b7e5ec1a4e0557de140da3de1db58 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_d73b7e5ec1a4e0557de140da3de1db58 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_d73b7e5ec1a4e0557de140da3de1db58))

:named refinement_kinding_Tm_refine_d73b7e5ec1a4e0557de140da3de1db58))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name BUGSLowParseWriters.read_repr_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(58,8-58,18); use=BUGSLowParseWriters.fst(58,8-58,18)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d73b7e5ec1a4e0557de140da3de1db58 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=BUGSLowParseWriters.fst(62,19-62,25); use=BUGSLowParseWriters.fst(62,19-62,25)
(Valid 
;; def=BUGSLowParseWriters.fst(62,19-62,25); use=BUGSLowParseWriters.fst(62,19-62,25)
(ApplyTT @x3
(BUGSLowParseWriters.Correct__0 @lb5))
...
;; def=BUGSLowParseWriters.fst(63,17-63,28); use=BUGSLowParseWriters.fst(63,17-63,28)
(Valid 
;; def=BUGSLowParseWriters.fst(63,17-63,28); use=BUGSLowParseWriters.fst(63,17-63,28)
(ApplyTT @x4
Tm_unit)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_d73b7e5ec1a4e0557de140da3de1db58))

:named refinement_interpretation_Tm_refine_d73b7e5ec1a4e0557de140da3de1db58))
;;;;;;;;;;;;;;;;kinding_Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3
;;; Fact-ids: Name BUGSLowParseWriters.read_repr_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(57,2-58,18); use=BUGSLowParseWriters.fst(57,2-58,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3 @x0
@x1
@x2
@x3)
Tm_type))
:qid kinding_Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3))

:named kinding_Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d73b7e5ec1a4e0557de140da3de1db58
;;; Fact-ids: Name BUGSLowParseWriters.read_repr_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(58,8-58,18); use=BUGSLowParseWriters.fst(58,8-58,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d73b7e5ec1a4e0557de140da3de1db58 @x0
@x1
@x2)))
(Valid (Prims.hasEq (BUGSLowParseWriters.result @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d73b7e5ec1a4e0557de140da3de1db58 @x0
@x1
@x2))))
:qid haseqTm_refine_d73b7e5ec1a4e0557de140da3de1db58))

:named haseqTm_refine_d73b7e5ec1a4e0557de140da3de1db58))
;;;;;;;;;;;;;;;;Equation for BUGSLowParseWriters.read_repr_spec
;;; Fact-ids: Name BUGSLowParseWriters.read_repr_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(56,4-56,18); use=BUGSLowParseWriters.fst(56,4-56,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (BUGSLowParseWriters.read_repr_spec @x0
@x1
@x2
@x3)
(Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3 @x3
@x2
@x0
@x1))
...
@x2
@x3))
:qid equation_BUGSLowParseWriters.read_repr_spec))

:named equation_BUGSLowParseWriters.read_repr_spec))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name BUGSLowParseWriters.read_repr_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(57,2-58,18); use=BUGSLowParseWriters.fst(57,2-58,18)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3 @x2
@x3
@x4
@x5))
(is-Tm_arrow (PreType @x1)))
...
@x4
@x5)))
:qid BUGSLowParseWriters_pre_typing_Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3))

:named BUGSLowParseWriters_pre_typing_Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3))
;;;;;;;;;;;;;;;;interpretation_Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3
;;; Fact-ids: Name BUGSLowParseWriters.read_repr_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(57,2-58,18); use=BUGSLowParseWriters.fst(57,2-58,18)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeZ @x0
(Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3 @x1
@x2
@x3
@x4))
...
(HasType (ApplyTT @x0
@x5)
(Tm_refine_d73b7e5ec1a4e0557de140da3de1db58 @x3
@x2
@x1)))
...
:pattern ((ApplyTT @x0
@x5))
:qid BUGSLowParseWriters_interpretation_Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3.1))
)
...
@x3
@x4)))
:qid BUGSLowParseWriters_interpretation_Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3))

:named BUGSLowParseWriters_interpretation_Tm_ghost_arrow_d18f56ea14d6fc353e978cc4905dbfc3))
(push) ;; push{2

; Starting query at BUGSLowParseWriters.fst(100,2-103,22)
...
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;x: a -> Prims.pure_pre
(declare-fun Tm_arrow_9b47201bed4c47de39b455e43a541085 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9b47201bed4c47de39b455e43a541085
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-91,27); use=BUGSLowParseWriters.fst(91,13-91,27)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_9b47201bed4c47de39b455e43a541085 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_9b47201bed4c47de39b455e43a541085 @x0)
Tm_type))
:qid kinding_Tm_arrow_9b47201bed4c47de39b455e43a541085))

:named kinding_Tm_arrow_9b47201bed4c47de39b455e43a541085))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-91,27); use=BUGSLowParseWriters.fst(91,13-91,27)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_9b47201bed4c47de39b455e43a541085 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_9b47201bed4c47de39b455e43a541085 @x2)))
:qid BUGSLowParseWriters_pre_typing_Tm_arrow_9b47201bed4c47de39b455e43a541085))

:named BUGSLowParseWriters_pre_typing_Tm_arrow_9b47201bed4c47de39b455e43a541085))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9b47201bed4c47de39b455e43a541085
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-91,27); use=BUGSLowParseWriters.fst(91,13-91,27)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_9b47201bed4c47de39b455e43a541085 @x1))
(and 
;; def=BUGSLowParseWriters.fst(88,3-91,27); use=BUGSLowParseWriters.fst(91,13-91,27)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_9b47201bed4c47de39b455e43a541085.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_9b47201bed4c47de39b455e43a541085 @x1)))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_9b47201bed4c47de39b455e43a541085))

:named BUGSLowParseWriters_interpretation_Tm_arrow_9b47201bed4c47de39b455e43a541085))
;;;;;;;;;;;;;;;;x: a -> pure_post' b (pre_g x)
(declare-fun Tm_arrow_45dbec0132a130ad61fdfc4203262480 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_45dbec0132a130ad61fdfc4203262480
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-91,69); use=BUGSLowParseWriters.fst(91,41-91,69)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_45dbec0132a130ad61fdfc4203262480 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_45dbec0132a130ad61fdfc4203262480 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_45dbec0132a130ad61fdfc4203262480))

:named kinding_Tm_arrow_45dbec0132a130ad61fdfc4203262480))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-91,69); use=BUGSLowParseWriters.fst(91,41-91,69)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_45dbec0132a130ad61fdfc4203262480 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid BUGSLowParseWriters_pre_typing_Tm_arrow_45dbec0132a130ad61fdfc4203262480))

:named BUGSLowParseWriters_pre_typing_Tm_arrow_45dbec0132a130ad61fdfc4203262480))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_45dbec0132a130ad61fdfc4203262480
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-91,69); use=BUGSLowParseWriters.fst(91,41-91,69)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_45dbec0132a130ad61fdfc4203262480 @x1
@x2
@x3))
(and 
;; def=BUGSLowParseWriters.fst(88,3-91,69); use=BUGSLowParseWriters.fst(91,41-91,69)
...
(HasType (ApplyTT @x0
@x4)
(BUGSLowParseWriters.pure_post_ @x2
(ApplyTT @x1
@x4))))
...
:pattern ((ApplyTT @x0
@x4))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_45dbec0132a130ad61fdfc4203262480.1))
...
@x2
@x3)))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_45dbec0132a130ad61fdfc4203262480))

:named BUGSLowParseWriters_interpretation_Tm_arrow_45dbec0132a130ad61fdfc4203262480))
;;;;;;;;;;;;;;;;x: a -> pure_post_err (pre_g x)
(declare-fun Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-92,48); use=BUGSLowParseWriters.fst(92,19-92,48)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1))

:named kinding_Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-92,48); use=BUGSLowParseWriters.fst(92,19-92,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1 @x2
@x3)))
:qid BUGSLowParseWriters_pre_typing_Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1))

:named BUGSLowParseWriters_pre_typing_Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-92,48); use=BUGSLowParseWriters.fst(92,19-92,48)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1 @x1
@x2))
(and 
;; def=BUGSLowParseWriters.fst(88,3-92,48); use=BUGSLowParseWriters.fst(92,19-92,48)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(BUGSLowParseWriters.pure_post_err (ApplyTT @x1
@x3))))
 

:pattern ((ApplyTT @x0
@x3))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1.1))
...
(Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1 @x1
@x2)))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1))

:named BUGSLowParseWriters_interpretation_Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1))
;;;;;;;;;;;;;;;;x: a -> read_repr_spec b (pre_g x) (post_g x) (post_err_g x)
(declare-fun Tm_arrow_f78c2f71898502070dc71d33c01bde58 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f78c2f71898502070dc71d33c01bde58
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-94,65); use=BUGSLowParseWriters.fst(94,8-94,65)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_arrow_f78c2f71898502070dc71d33c01bde58 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_arrow_f78c2f71898502070dc71d33c01bde58 @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid kinding_Tm_arrow_f78c2f71898502070dc71d33c01bde58))

:named kinding_Tm_arrow_f78c2f71898502070dc71d33c01bde58))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-94,65); use=BUGSLowParseWriters.fst(94,8-94,65)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_f78c2f71898502070dc71d33c01bde58 @x2
@x3
@x4
@x5
@x6))
...
@x5
@x6)))
:qid BUGSLowParseWriters_pre_typing_Tm_arrow_f78c2f71898502070dc71d33c01bde58))

:named BUGSLowParseWriters_pre_typing_Tm_arrow_f78c2f71898502070dc71d33c01bde58))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f78c2f71898502070dc71d33c01bde58
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(88,3-94,65); use=BUGSLowParseWriters.fst(94,8-94,65)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f78c2f71898502070dc71d33c01bde58 @x1
@x2
@x3
@x4
@x5))
...
(HasType (ApplyTT @x0
@x6)
(BUGSLowParseWriters.read_repr_spec @x4
(ApplyTT @x3
@x6)
(ApplyTT @x2
@x6)
...
:pattern ((ApplyTT @x0
@x6))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_f78c2f71898502070dc71d33c01bde58.1))
...
@x4
@x5)))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_f78c2f71898502070dc71d33c01bde58))

:named BUGSLowParseWriters_interpretation_Tm_arrow_f78c2f71898502070dc71d33c01bde58))

; Encoding query formula : forall (a: Type) (b: Type) (pre_f: Prims.pure_pre) (post_f: BUGSLowParseWriters.pure_post' a pre_f)
;   (post_err_f: BUGSLowParseWriters.pure_post_err pre_f) (pre_g: (x: a -> Prims.pure_pre))
;   (post_g: (x: a -> BUGSLowParseWriters.pure_post' b (pre_g x)))
;   (post_err_g: (x: a -> BUGSLowParseWriters.pure_post_err (pre_g x)))
;   (f_bind_spec: BUGSLowParseWriters.read_repr_spec a pre_f post_f post_err_f)
;   (g: (x: a -> BUGSLowParseWriters.read_repr_spec b (pre_g x) (post_g x) (post_err_g x))).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.unit).
;     (*  - Could not prove post-condition
; *)
;     forall (p: Prims.pure_post (BUGSLowParseWriters.result b)).
;       pre_f /\ (forall (x: a). post_f x ==> pre_g x) /\
;       (forall (ghost_result: BUGSLowParseWriters.result b).
;           (match ghost_result with
;             | BUGSLowParseWriters.Correct v -> exists (x: a). pre_f /\ post_f x /\ post_g x v
;             | BUGSLowParseWriters.Error _ ->
;               pre_f /\ (post_err_f () \/ (exists (x: a). post_f x /\ post_err_g x ()))) ==>
;           p ghost_result) ==>
;       pre_f /\
;       (forall (ghost_result: BUGSLowParseWriters.result a).
;           (match ghost_result with
;             | BUGSLowParseWriters.Correct v -> post_f v
;             | BUGSLowParseWriters.Error _ -> post_err_f ()) ==>
;           f_bind_spec () == ghost_result ==>
;           (forall (k: Prims.pure_post (BUGSLowParseWriters.result b)).
;               (forall (x: BUGSLowParseWriters.result b). {:pattern Prims.guard_free (k x)}
;                   (x ==
;                     (match f_bind_spec () with
;                       | BUGSLowParseWriters.Correct a -> g a ()
;                       | BUGSLowParseWriters.Error e -> BUGSLowParseWriters.Error e) ==>
;                     (forall (return_val: BUGSLowParseWriters.result b).
;                         return_val == x ==> p return_val)) ==>
;                   k x) ==>
;               (~(Correct? (f_bind_spec ())) /\ ~(Error? (f_bind_spec ())) ==> Prims.l_False) /\
;               (forall (b: a).
;                   f_bind_spec () == BUGSLowParseWriters.Correct b ==>
;                   pre_g b /\
;                   (forall (ghost_result: BUGSLowParseWriters.result b).
;                       (match ghost_result with
;                         | BUGSLowParseWriters.Correct v -> post_g b v
;                         | BUGSLowParseWriters.Error _ -> post_err_g b ()) ==>
;                       k ghost_result)) /\
;               (~(Correct? (f_bind_spec ())) ==>
;                 (forall (b: Prims.string).
;                     f_bind_spec () == BUGSLowParseWriters.Error b ==>
;                     (forall (any_result: BUGSLowParseWriters.result b). k any_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let read_bind_spec`
...
@x2))
(HasType @x4
(BUGSLowParseWriters.pure_post_err @x2))
(HasType @x5
(Tm_arrow_9b47201bed4c47de39b455e43a541085 @x0))
(HasType @x6
(Tm_arrow_45dbec0132a130ad61fdfc4203262480 @x5
@x1
@x0))
(HasType @x7
(Tm_arrow_6a231e0fe9036d2636201f0d5d8746d1 @x5
@x0))
(HasType @x8
(BUGSLowParseWriters.read_repr_spec @x0
@x2
...
@x4))
(HasType @x9
(Tm_arrow_f78c2f71898502070dc71d33c01bde58 @x7
@x6
@x5
@x1
@x0)))

;; def=dummy(0,0-0,0); use=BUGSLowParseWriters.fst(100,2-103,22)
(forall ((@x10 Term))
 (! (implies (HasType @x10
Prims.unit)

;; def=Prims.fst(406,51-406,91); use=BUGSLowParseWriters.fst(100,2-103,22)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
(Prims.pure_post (BUGSLowParseWriters.result @x1)))

;; def=BUGSLowParseWriters.fst(89,3-89,8); use=BUGSLowParseWriters.fst(96,5-96,10)
(Valid 
;; def=BUGSLowParseWriters.fst(89,3-89,8); use=BUGSLowParseWriters.fst(96,5-96,10)
@x2
)
...
;; def=BUGSLowParseWriters.fst(96,14-96,52); use=BUGSLowParseWriters.fst(101,2-103,22)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
@x0)

;; def=BUGSLowParseWriters.fst(96,31-96,39); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=BUGSLowParseWriters.fst(96,31-96,39); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT @x3
@x12)
...
;; def=BUGSLowParseWriters.fst(96,44-96,51); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=BUGSLowParseWriters.fst(96,44-96,51); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT @x5
@x12)
...
;; def=Prims.fst(485,36-485,100); use=BUGSLowParseWriters.fst(101,2-103,22)
(forall ((@x12 Term))
 (! (implies (and (or label_1
(HasType @x12
(BUGSLowParseWriters.result @x1)))
(let ((@lb13 @x12))
(ite (is-BUGSLowParseWriters.Correct @lb13)

;; def=BUGSLowParseWriters.fst(97,14-97,61); use=BUGSLowParseWriters.fst(101,2-103,22)
(or label_2
...
;; def=BUGSLowParseWriters.fst(89,3-89,8); use=BUGSLowParseWriters.fst(97,30-97,35)
(Valid 
;; def=BUGSLowParseWriters.fst(89,3-89,8); use=BUGSLowParseWriters.fst(97,30-97,35)
@x2
)
...
;; def=BUGSLowParseWriters.fst(97,39-97,47); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=BUGSLowParseWriters.fst(97,39-97,47); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT @x3
@x14)
...
;; def=BUGSLowParseWriters.fst(97,51-97,61); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=BUGSLowParseWriters.fst(97,51-97,61); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT (ApplyTT @x6
@x14)
(BUGSLowParseWriters.Correct__0 @lb13))
)
)
...
(ite (is-BUGSLowParseWriters.Error @lb13)

;; def=BUGSLowParseWriters.fst(98,14-98,87); use=BUGSLowParseWriters.fst(101,2-103,22)
(and 
;; def=BUGSLowParseWriters.fst(89,3-89,8); use=BUGSLowParseWriters.fst(98,14-98,19)
(or label_3
...
;; def=BUGSLowParseWriters.fst(98,23-98,87); use=BUGSLowParseWriters.fst(101,2-103,22)
(or label_4

;; def=BUGSLowParseWriters.fst(98,24-98,37); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=BUGSLowParseWriters.fst(98,24-98,37); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT @x4
Tm_unit)
...
;; def=BUGSLowParseWriters.fst(98,41-98,86); use=BUGSLowParseWriters.fst(101,2-103,22)
(exists ((@x14 Term))
 (! (and (HasType @x14
@x0)

;; def=BUGSLowParseWriters.fst(98,58-98,66); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=BUGSLowParseWriters.fst(98,58-98,66); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT @x3
@x14)
...
;; def=BUGSLowParseWriters.fst(98,70-98,85); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=BUGSLowParseWriters.fst(98,70-98,85); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT (ApplyTT @x7
@x14)
...
;; def=Prims.fst(485,85-485,99); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=Prims.fst(485,85-485,99); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT @x11
@x12)
...
;; def=Prims.fst(485,29-485,100); use=BUGSLowParseWriters.fst(101,2-103,22)
(and 
;; def=BUGSLowParseWriters.fst(89,3-89,8); use=BUGSLowParseWriters.fst(93,33-93,38)
(or label_5
...
;; def=BUGSLowParseWriters.fst(62,19-62,25); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=BUGSLowParseWriters.fst(62,19-62,25); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT @x3
(BUGSLowParseWriters.Correct__0 @lb13))
...
;; def=BUGSLowParseWriters.fst(63,17-63,28); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=BUGSLowParseWriters.fst(63,17-63,28); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT @x4
Tm_unit)
...
;; def=BUGSLowParseWriters.fst(101,8-101,22); use=BUGSLowParseWriters.fst(101,8-101,22)
(= (ApplyTT @x8
Tm_unit)
@x12)
)

;; def=Prims.fst(402,2-402,97); use=BUGSLowParseWriters.fst(101,2-103,22)
(forall ((@x13 Term))
...
(forall ((@x14 Term))
 (! (implies (implies 
;; def=BUGSLowParseWriters.fst(58,8-103,22); use=BUGSLowParseWriters.fst(101,2-103,22)
(= @x14
(let ((@lb15 (ApplyTT @x8
Tm_unit)))
(ite (is-BUGSLowParseWriters.Correct @lb15)
(ApplyTT (ApplyTT @x9
(BUGSLowParseWriters.Correct__0 @lb15))
Tm_unit)
(ite (is-BUGSLowParseWriters.Error @lb15)
(BUGSLowParseWriters.Error @x1
(BUGSLowParseWriters.Error__0 @lb15))
Tm_unit))))


;; def=Prims.fst(356,2-356,58); use=BUGSLowParseWriters.fst(100,2-103,22)
(forall ((@x15 Term))
 (! (implies (and (HasType @x15
(BUGSLowParseWriters.result @x1))

;; def=Prims.fst(356,26-356,41); use=BUGSLowParseWriters.fst(100,2-103,22)
(= @x15
@x14)
)

;; def=Prims.fst(356,46-356,58); use=BUGSLowParseWriters.fst(100,2-103,22)
(Valid 
;; def=Prims.fst(356,46-356,58); use=BUGSLowParseWriters.fst(100,2-103,22)
(ApplyTT @x11
@x15)
...
;; def=Prims.fst(402,84-402,87); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=Prims.fst(402,84-402,87); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT @x13
@x14)
...
;; def=Prims.fst(459,77-459,89); use=BUGSLowParseWriters.fst(101,2-103,22)
(and (implies 
;; def=BUGSLowParseWriters.fst(101,8-101,22); use=BUGSLowParseWriters.fst(101,8-101,22)
(and 
;; def=BUGSLowParseWriters.fst(101,8-101,22); use=BUGSLowParseWriters.fst(101,8-101,22)
...
;; def=Prims.fst(413,99-413,120); use=BUGSLowParseWriters.fst(101,2-103,22)
(forall ((@x14 Term))
 (! (implies (and (HasType @x14
@x0)

;; def=BUGSLowParseWriters.fst(101,8-102,13); use=BUGSLowParseWriters.fst(101,8-102,13)
(= (ApplyTT @x8
Tm_unit)
(BUGSLowParseWriters.Correct @x0
@x14))
...
;; def=Prims.fst(485,29-485,100); use=BUGSLowParseWriters.fst(101,2-103,22)
(and 
;; def=BUGSLowParseWriters.fst(94,30-94,39); use=BUGSLowParseWriters.fst(101,2-103,22)
(or label_7
...
(BUGSLowParseWriters.result @x1))
(let ((@lb16 @x15))
(ite (is-BUGSLowParseWriters.Correct @lb16)
...
(ApplyTT (ApplyTT @x6
@x14)
(BUGSLowParseWriters.Correct__0 @lb16))
)

(ite (is-BUGSLowParseWriters.Error @lb16)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=BUGSLowParseWriters.fst(101,2-103,22)
(not 
;; def=BUGSLowParseWriters.fst(101,8-101,22); use=BUGSLowParseWriters.fst(101,8-101,22)
(BoxBool_proj_0 (BUGSLowParseWriters.uu___is_Correct @x0
(ApplyTT @x8
...
;; def=BUGSLowParseWriters.fst(101,8-103,11); use=BUGSLowParseWriters.fst(101,8-103,11)
(= (ApplyTT @x8
Tm_unit)
(BUGSLowParseWriters.Error @x0
@x14))
)

;; def=Prims.fst(451,66-451,102); use=BUGSLowParseWriters.fst(101,2-103,22)
(forall ((@x15 Term))
 (! (implies (HasType @x15
(BUGSLowParseWriters.result @x1))

;; def=Prims.fst(451,90-451,102); use=BUGSLowParseWriters.fst(101,2-103,22)
(Valid 
;; def=Prims.fst(451,90-451,102); use=BUGSLowParseWriters.fst(101,2-103,22)
(ApplyTT @x13
@x15)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.read_bind_spec, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, constructor_distinct_BUGSLowParseWriters.Correct, constructor_distinct_BUGSLowParseWriters.Error, disc_equation_BUGSLowParseWriters.Correct, disc_equation_BUGSLowParseWriters.Error, projection_inverse_BUGSLowParseWriters.Correct__0, projection_inverse_BUGSLowParseWriters.Correct_a, projection_inverse_BUGSLowParseWriters.Error__0, projection_inverse_BUGSLowParseWriters.Error_a, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let read_bind_spec


; <Start encoding let read_bind_spec>
...
;;;;;;;;;;;;;;;;x: a -> read_repr_spec b (pre_g x) (post_g x) (post_err_g x)
(declare-fun Tm_arrow_f78c2f71898502070dc71d33c01bde58 (Term Term Term Term Term) Term)
(declare-fun BUGSLowParseWriters.read_bind_spec (Term Term Term Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_bf0cf58ed3f4414e8f5e3f1b1f1d274e (Term Term Term Term Term) Term)

(declare-fun Tm_abs_4e30c3219d357849cb32766f2f45b45d (Term Term Term Term Term) Term)

(declare-fun Tm_abs_39c29de4f4a618f2a8bb84e796f28d8e (Term Term Term) Term)

(declare-fun Tm_abs_3579507e4a78cceb0b18d13a13a22ab3 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     pre_f: Prims.pure_pre ->     post_f: pure_post' a pre_f ->     post_err_f: pure_post_err pre_f ->     pre_g: (x: a -> Prims.pure_pre) ->     post_g: (x: a -> pure_post' b (pre_g x)) ->     post_err_g: (x: a -> pure_post_err (pre_g x)) ->     f_bind_spec: read_repr_spec a pre_f post_f post_err_f ->     g: (x: a -> read_repr_spec b (pre_g x) (post_g x) (post_err_g x))   -> read_repr_spec b       (pre_f /\ (forall (x: a). post_f x ==> pre_g x))       (fun y -> exists (x: a). pre_f /\ post_f x /\ post_g x y)       (fun _ -> pre_f /\ (post_err_f () \/ (exists (x: a). post_f x /\ post_err_g x ())))
(declare-fun Tm_arrow_61040b1a0ca486d456d6c3486f992497 () Term)
(declare-fun BUGSLowParseWriters.read_bind_spec@tok () Term)
...
(declare-fun Tm_abs_cbdaa2375b11fe33af51b822f773a465 (Term Term Term) Term)

; </end encoding let read_bind_spec>


; encoding sigelt let read_bind


; <Start encoding let read_bind>




;;;;;;;;;;;;;;;;x: a -> read_repr b (pre_g x) (post_g x) (post_err_g x) l
(declare-fun Tm_arrow_7a8e42ce2ef483613f0bd07684b6831c (Term Term Term Term Term Term) Term)
(declare-fun BUGSLowParseWriters.read_bind (Term Term Term Term Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     pre_f: Prims.pure_pre ->     post_f: pure_post' a pre_f ->     post_err_f: pure_post_err pre_f ->     pre_g: (x: a -> Prims.pure_pre) ->     post_g: (x: a -> pure_post' b (pre_g x)) ->     post_err_g: (x: a -> pure_post_err (pre_g x)) ->     l: memory_invariant ->     f_bind: read_repr a pre_f post_f post_err_f l ->     g: (x: a -> read_repr b (pre_g x) (post_g x) (post_err_g x) l)   -> read_repr b       (pre_f /\ (forall (x: a). post_f x ==> pre_g x))       (fun y -> exists (x: a). pre_f /\ post_f x /\ post_g x y)       (fun _ -> pre_f /\ (post_err_f () \/ (exists (x: a). post_f x /\ post_err_g x ())))       l
(declare-fun Tm_arrow_f67bd56cfa12d12a3d6c4b194d90b601 () Term)
(declare-fun BUGSLowParseWriters.read_bind@tok () Term)
...
(declare-fun Tm_abs_c7ebd81813cb6b9174ce6535a899069a (Term Term Term Term Term Term Term) Term)

; </end encoding let read_bind>


; encoding sigelt let read_subcomp_spec_cond


; <Start encoding let read_subcomp_spec_cond>

(declare-fun BUGSLowParseWriters.read_subcomp_spec_cond (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     pre: Prims.pure_pre ->     post: pure_post' a pre ->     post_err: pure_post_err pre ->     pre': Prims.pure_pre ->     post': pure_post' a pre' ->     post_err': pure_post_err pre'   -> Prims.GTot Type
(declare-fun Tm_arrow_5918438cff7d67a28f171860b9eb235b () Term)
(declare-fun BUGSLowParseWriters.read_subcomp_spec_cond@tok () Term)

; </end encoding let read_subcomp_spec_cond>


; encoding sigelt let read_subcomp_cond


; <Start encoding let read_subcomp_cond>

(declare-fun BUGSLowParseWriters.read_subcomp_cond (Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     pre: Prims.pure_pre ->     post: pure_post' a pre ->     post_err: pure_post_err pre ->     pre': Prims.pure_pre ->     post': pure_post' a pre' ->     post_err': pure_post_err pre' ->     l: memory_invariant ->     l': memory_invariant   -> Prims.GTot Type
(declare-fun Tm_arrow_3fcca4c48a436d900977d3c8b55fc884 () Term)
(declare-fun BUGSLowParseWriters.read_subcomp_cond@tok () Term)

(declare-fun Tm_abs_39bc442a4d364fd801db305108455e73 (Term Term Term Term) Term)

; </end encoding let read_subcomp_cond>

(push) ;; push{2

; Starting query at BUGSLowParseWriters.fst(150,2-150,24)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_abs_887db497cb9109bbbb4230584155dad1 (Term) Term)
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_887db497cb9109bbbb4230584155dad1
;;; Fact-ids: 
(assert (! true
:named tot_fun_Tm_abs_887db497cb9109bbbb4230584155dad1))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_887db497cb9109bbbb4230584155dad1
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(150,12-150,23); use=BUGSLowParseWriters.fst(150,12-150,23)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_887db497cb9109bbbb4230584155dad1 @x1)
@x0)
(ApplyTT @x1
@x0))
 

:pattern ((ApplyTT (Tm_abs_887db497cb9109bbbb4230584155dad1 @x1)
@x0))
:qid interpretation_Tm_abs_887db497cb9109bbbb4230584155dad1))

:named interpretation_Tm_abs_887db497cb9109bbbb4230584155dad1))
...
;   (post': BUGSLowParseWriters.pure_post' a pre')
;   (post_err': BUGSLowParseWriters.pure_post_err pre')
;   (f_subcomp: BUGSLowParseWriters.read_repr_spec a pre post post_err).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (BUGSLowParseWriters.read_repr_spec a pre' post' post_err')).
;     (pre' ==> pre) /\ (forall (x: a). pre' /\ post x ==> post' x) /\
;     (pre' /\ post_err () ==> post_err' ()) /\
;     (forall (pure_result: BUGSLowParseWriters.read_repr_spec a pre' post' post_err').
...
;           (forall (ghost_result: BUGSLowParseWriters.result a).
;               (match ghost_result with
;                 | BUGSLowParseWriters.Correct v -> post' v
;                 | BUGSLowParseWriters.Error _ -> post_err' ()) ==>
;               p ghost_result) ==>
;           pre /\
;           (forall (ghost_result: BUGSLowParseWriters.result a).
;               (match ghost_result with
;                 | BUGSLowParseWriters.Correct v -> post v
;                 | BUGSLowParseWriters.Error _ -> post_err ()) ==>
;               ghost_result == f_subcomp x ==>
;               (forall (return_val: BUGSLowParseWriters.result a).
;                   return_val == ghost_result ==> p return_val))) /\
;     (forall (any_result: BUGSLowParseWriters.read_repr_spec a pre' post' post_err').
;         any_result == (fun x -> f_subcomp x) ==>
;         (forall (return_val: BUGSLowParseWriters.read_repr_spec a pre' post' post_err').
;             return_val == any_result ==> p return_val))


; Context: While encoding a query
; While typechecking the top-level declaration `let read_subcomp_spec`
...
@x4))
(HasType @x6
(BUGSLowParseWriters.pure_post_err @x4))
(HasType @x7
(BUGSLowParseWriters.read_repr_spec @x0
@x1
@x2
...
(Prims.pure_post (BUGSLowParseWriters.read_repr_spec @x0
@x4
@x5
@x6)))

;; def=BUGSLowParseWriters.fst(129,2-129,16); use=BUGSLowParseWriters.fst(148,13-148,35)
(implies 
;; def=BUGSLowParseWriters.fst(145,3-145,7); use=BUGSLowParseWriters.fst(148,56-148,60)
(Valid 
;; def=BUGSLowParseWriters.fst(145,3-145,7); use=BUGSLowParseWriters.fst(148,56-148,60)
@x4
)
...
;; def=BUGSLowParseWriters.fst(144,3-144,6); use=BUGSLowParseWriters.fst(148,38-148,41)
(Valid 
;; def=BUGSLowParseWriters.fst(144,3-144,6); use=BUGSLowParseWriters.fst(148,38-148,41)
@x1
)
...
;; def=BUGSLowParseWriters.fst(130,2-130,43); use=BUGSLowParseWriters.fst(148,13-148,35)
(forall ((@x9 Term))
...
;; def=BUGSLowParseWriters.fst(130,23-130,29); use=BUGSLowParseWriters.fst(148,13-148,35)
(Valid 
;; def=BUGSLowParseWriters.fst(130,23-130,29); use=BUGSLowParseWriters.fst(148,13-148,35)
(ApplyTT @x2
@x9)
...
;; def=BUGSLowParseWriters.fst(130,35-130,42); use=BUGSLowParseWriters.fst(148,13-148,35)
(Valid 
;; def=BUGSLowParseWriters.fst(130,35-130,42); use=BUGSLowParseWriters.fst(148,13-148,35)
(ApplyTT @x5
@x9)
...
;; def=BUGSLowParseWriters.fst(131,2-131,42); use=BUGSLowParseWriters.fst(148,13-148,35)
(implies 
;; def=BUGSLowParseWriters.fst(131,3-131,24); use=BUGSLowParseWriters.fst(148,13-148,35)
(and 
;; def=BUGSLowParseWriters.fst(145,3-145,7); use=BUGSLowParseWriters.fst(148,56-148,60)
(Valid 
;; def=BUGSLowParseWriters.fst(145,3-145,7); use=BUGSLowParseWriters.fst(148,56-148,60)
...
;; def=BUGSLowParseWriters.fst(131,12-131,23); use=BUGSLowParseWriters.fst(148,13-148,35)
(Valid 
;; def=BUGSLowParseWriters.fst(131,12-131,23); use=BUGSLowParseWriters.fst(148,13-148,35)
(ApplyTT @x3
Tm_unit)
...
;; def=BUGSLowParseWriters.fst(131,29-131,41); use=BUGSLowParseWriters.fst(148,13-148,35)
(Valid 
;; def=BUGSLowParseWriters.fst(131,29-131,41); use=BUGSLowParseWriters.fst(148,13-148,35)
(ApplyTT @x6
Tm_unit)
...
;; def=Prims.fst(441,36-441,97); use=BUGSLowParseWriters.fst(150,2-150,24)
(forall ((@x9 Term))
 (! (implies (or label_1
(HasType @x9
(BUGSLowParseWriters.read_repr_spec @x0
...
;; def=Prims.fst(441,83-441,96); use=BUGSLowParseWriters.fst(150,2-150,24)
(Valid 
;; def=Prims.fst(441,83-441,96); use=BUGSLowParseWriters.fst(150,2-150,24)
(ApplyTT @x8
@x9)
...
;; def=Prims.fst(459,77-459,89); use=BUGSLowParseWriters.fst(150,2-150,24)
(and 
;; def=dummy(0,0-0,0); use=BUGSLowParseWriters.fst(150,2-150,24)
(forall ((@x9 Term))
 (! (implies (HasType @x9
Prims.unit)

;; def=Prims.fst(406,51-406,91); use=BUGSLowParseWriters.fst(150,2-150,24)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(Prims.pure_post (BUGSLowParseWriters.result @x0)))

;; def=BUGSLowParseWriters.fst(145,3-145,7); use=BUGSLowParseWriters.fst(147,25-147,29)
(Valid 
;; def=BUGSLowParseWriters.fst(145,3-145,7); use=BUGSLowParseWriters.fst(147,25-147,29)
@x4
)
...
;; def=Prims.fst(485,36-485,100); use=BUGSLowParseWriters.fst(150,12-150,23)
(forall ((@x11 Term))
 (! (implies (and (or label_2
(HasType @x11
(BUGSLowParseWriters.result @x0)))
(let ((@lb12 @x11))
(ite (is-BUGSLowParseWriters.Correct @lb12)

;; def=BUGSLowParseWriters.fst(62,19-62,25); use=BUGSLowParseWriters.fst(150,12-150,23)
(or label_3
...
;; def=BUGSLowParseWriters.fst(62,19-62,25); use=BUGSLowParseWriters.fst(150,12-150,23)
(ApplyTT @x5
(BUGSLowParseWriters.Correct__0 @lb12))
)
)

(ite (is-BUGSLowParseWriters.Error @lb12)

;; def=BUGSLowParseWriters.fst(63,17-63,28); use=BUGSLowParseWriters.fst(150,12-150,23)
(or label_4
...
;; def=Prims.fst(485,85-485,99); use=BUGSLowParseWriters.fst(150,12-150,23)
(Valid 
;; def=Prims.fst(485,85-485,99); use=BUGSLowParseWriters.fst(150,12-150,23)
(ApplyTT @x10
@x11)
...
;; def=Prims.fst(485,29-485,100); use=BUGSLowParseWriters.fst(150,12-150,23)
(and 
;; def=BUGSLowParseWriters.fst(144,3-144,6); use=BUGSLowParseWriters.fst(146,30-146,33)
(or label_5
...
;; def=BUGSLowParseWriters.fst(58,8-150,23); use=BUGSLowParseWriters.fst(150,12-150,23)
(= @x11
(ApplyTT @x7
@x9))
)

;; def=Prims.fst(356,2-356,58); use=BUGSLowParseWriters.fst(150,2-150,24)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
(BUGSLowParseWriters.result @x0))

;; def=Prims.fst(356,26-356,41); use=BUGSLowParseWriters.fst(150,2-150,24)
(= @x12
@x11)
)

;; def=Prims.fst(356,46-356,58); use=BUGSLowParseWriters.fst(150,2-150,24)
(Valid 
;; def=Prims.fst(356,46-356,58); use=BUGSLowParseWriters.fst(150,2-150,24)
(ApplyTT @x10
@x12)
...
;; def=Prims.fst(451,66-451,102); use=BUGSLowParseWriters.fst(150,2-150,24)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(BUGSLowParseWriters.read_repr_spec @x0
@x4
...
;; def=BUGSLowParseWriters.fst(147,7-150,23); use=BUGSLowParseWriters.fst(150,2-150,24)
(= @x9
(Tm_abs_887db497cb9109bbbb4230584155dad1 @x7))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.read_subcomp_spec, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_BUGSLowParseWriters.Correct
...
; encoding sigelt let read_subcomp_spec


; <Start encoding let read_subcomp_spec>

(declare-fun BUGSLowParseWriters.read_subcomp_spec (Term Term Term Term Term Term Term Term) Term)
(declare-fun Tm_refine_9f84fde25c9371c70f6024f4e723e92d (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     pre: Prims.pure_pre ->     post: pure_post' a pre ->     post_err: pure_post_err pre ->     pre': Prims.pure_pre ->     post': pure_post' a pre' ->     post_err': pure_post_err pre' ->     f_subcomp: read_repr_spec a pre post post_err   -> Prims.Pure (read_repr_spec a pre' post' post_err')
(declare-fun Tm_arrow_622386f303374143e4047664fdb20bf1 () Term)
(declare-fun BUGSLowParseWriters.read_subcomp_spec@tok () Term)

(declare-fun Tm_abs_887db497cb9109bbbb4230584155dad1 (Term) Term)

; </end encoding let read_subcomp_spec>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BUGSLowParseWriters.read_subcomp_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(143,4-143,21); use=BUGSLowParseWriters.fst(143,4-143,21)
...
;;no pats
:qid typing_BUGSLowParseWriters.read_subcomp_spec.1))
...
@x2
@x3)))
(HasType (BUGSLowParseWriters.read_subcomp_spec @x0
@x1
@x2
@x3
@x4
...
@x6
@x7)
(Tm_refine_9f84fde25c9371c70f6024f4e723e92d @x0
@x4
@x5
@x6)))
 

:pattern ((BUGSLowParseWriters.read_subcomp_spec @x0
@x1
@x2
@x3
@x4
...
@x6
@x7))
:qid typing_BUGSLowParseWriters.read_subcomp_spec))

:named typing_BUGSLowParseWriters.read_subcomp_spec))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BUGSLowParseWriters.memory_invariant; Namespace BUGSLowParseWriters
(assert (! (HasType BUGSLowParseWriters.memory_invariant
Tm_type)
:named typing_BUGSLowParseWriters.memory_invariant))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BUGSLowParseWriters.__proj__ReadRepr__item__spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(74,5-74,9); use=BUGSLowParseWriters.fst(74,5-74,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(BUGSLowParseWriters.pure_post_err @x1))
(HasType @x4
BUGSLowParseWriters.memory_invariant)
(HasType @x5
(BUGSLowParseWriters.read_repr @x0
@x1
@x2
@x3
@x4)))
(HasType (BUGSLowParseWriters.__proj__ReadRepr__item__spec @x0
@x1
@x2
@x3
@x4
...
:pattern ((BUGSLowParseWriters.__proj__ReadRepr__item__spec @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_BUGSLowParseWriters.__proj__ReadRepr__item__spec))

:named typing_BUGSLowParseWriters.__proj__ReadRepr__item__spec))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(67,5-67,14); use=BUGSLowParseWriters.fst(67,5-67,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.read_repr@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.read_repr@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((BUGSLowParseWriters.read_repr @x0
@x1
@x2
@x3
@x4))
:qid token_correspondence_BUGSLowParseWriters.read_repr@tok))

:named token_correspondence_BUGSLowParseWriters.read_repr@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(73,4-73,12); use=BUGSLowParseWriters.fst(73,4-73,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term) (@x10 Term) (@x11 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(BUGSLowParseWriters.ReadRepr @x1
@x2
@x3
@x4
@x5
@x6)
(BUGSLowParseWriters.read_repr @x7
@x8
@x9
@x10
@x11))
...
@x10
@x11)))
:qid subterm_ordering_BUGSLowParseWriters.ReadRepr))

:named subterm_ordering_BUGSLowParseWriters.ReadRepr))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name BUGSLowParseWriters.read_subcomp_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(147,7-147,46); use=BUGSLowParseWriters.fst(147,7-147,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_9f84fde25c9371c70f6024f4e723e92d @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_9f84fde25c9371c70f6024f4e723e92d @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_9f84fde25c9371c70f6024f4e723e92d))

:named refinement_kinding_Tm_refine_9f84fde25c9371c70f6024f4e723e92d))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9f84fde25c9371c70f6024f4e723e92d @x2
@x3
@x4
@x5))
(HasTypeFuel @u0
@x1
(BUGSLowParseWriters.read_repr_spec @x2
@x3
@x4
@x5)))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_9f84fde25c9371c70f6024f4e723e92d))

:named refinement_interpretation_Tm_refine_9f84fde25c9371c70f6024f4e723e92d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
...
;; def=BUGSLowParseWriters.fst(73,4-73,12); use=BUGSLowParseWriters.fst(73,4-73,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (BUGSLowParseWriters.ReadRepr_spec (BUGSLowParseWriters.ReadRepr @x0
@x1
@x2
@x3
@x4
...
:pattern ((BUGSLowParseWriters.ReadRepr @x0
@x1
@x2
@x3
@x4
@x5))
:qid projection_inverse_BUGSLowParseWriters.ReadRepr_spec))

:named projection_inverse_BUGSLowParseWriters.ReadRepr_spec))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(73,4-73,12); use=BUGSLowParseWriters.fst(73,4-73,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (BUGSLowParseWriters.ReadRepr_pre (BUGSLowParseWriters.ReadRepr @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_BUGSLowParseWriters.ReadRepr_pre))

:named projection_inverse_BUGSLowParseWriters.ReadRepr_pre))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(73,4-73,12); use=BUGSLowParseWriters.fst(73,4-73,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (BUGSLowParseWriters.ReadRepr_post_err (BUGSLowParseWriters.ReadRepr @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_BUGSLowParseWriters.ReadRepr_post_err))

:named projection_inverse_BUGSLowParseWriters.ReadRepr_post_err))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(73,4-73,12); use=BUGSLowParseWriters.fst(73,4-73,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (BUGSLowParseWriters.ReadRepr_post (BUGSLowParseWriters.ReadRepr @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_BUGSLowParseWriters.ReadRepr_post))

:named projection_inverse_BUGSLowParseWriters.ReadRepr_post))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(73,4-73,12); use=BUGSLowParseWriters.fst(73,4-73,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (BUGSLowParseWriters.ReadRepr_l (BUGSLowParseWriters.ReadRepr @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_BUGSLowParseWriters.ReadRepr_l))

:named projection_inverse_BUGSLowParseWriters.ReadRepr_l))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(73,4-73,12); use=BUGSLowParseWriters.fst(73,4-73,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (BUGSLowParseWriters.ReadRepr_a (BUGSLowParseWriters.ReadRepr @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_BUGSLowParseWriters.ReadRepr_a))

:named projection_inverse_BUGSLowParseWriters.ReadRepr_a))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name BUGSLowParseWriters.__proj__ReadRepr__item__spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(74,5-74,9); use=BUGSLowParseWriters.fst(74,5-74,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (BUGSLowParseWriters.__proj__ReadRepr__item__spec @x0
@x1
@x2
@x3
@x4
@x5)
(BUGSLowParseWriters.ReadRepr_spec @x5))
...
@x4
@x5))
:qid proj_equation_BUGSLowParseWriters.ReadRepr_spec))

:named proj_equation_BUGSLowParseWriters.ReadRepr_spec))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! (is-Tm_arrow (PreType BUGSLowParseWriters.read_repr@tok))
:named pre_kinding_BUGSLowParseWriters.read_repr@tok))
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! (and (IsTotFun BUGSLowParseWriters.read_repr@tok)

;; def=BUGSLowParseWriters.fst(67,5-67,14); use=BUGSLowParseWriters.fst(67,5-67,14)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT BUGSLowParseWriters.read_repr@tok
@x0))
 

:pattern ((ApplyTT BUGSLowParseWriters.read_repr@tok
@x0))
:qid kinding_BUGSLowParseWriters.read_repr@tok))


;; def=BUGSLowParseWriters.fst(67,5-67,14); use=BUGSLowParseWriters.fst(67,5-67,14)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (ApplyTT (ApplyTT BUGSLowParseWriters.read_repr@tok
@x0)
@x1))
 

:pattern ((ApplyTT (ApplyTT BUGSLowParseWriters.read_repr@tok
@x0)
@x1))
:qid kinding_BUGSLowParseWriters.read_repr@tok.1))


;; def=BUGSLowParseWriters.fst(67,5-67,14); use=BUGSLowParseWriters.fst(67,5-67,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (IsTotFun (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.read_repr@tok
@x0)
@x1)
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.read_repr@tok
@x0)
@x1)
@x2))
:qid kinding_BUGSLowParseWriters.read_repr@tok.2))


;; def=BUGSLowParseWriters.fst(67,5-67,14); use=BUGSLowParseWriters.fst(67,5-67,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (IsTotFun (ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.read_repr@tok
@x0)
@x1)
@x2)
@x3))
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.read_repr@tok
@x0)
@x1)
@x2)
@x3))
:qid kinding_BUGSLowParseWriters.read_repr@tok.3))
...
(HasType @x4
BUGSLowParseWriters.memory_invariant))
(HasType (BUGSLowParseWriters.read_repr @x0
@x1
@x2
@x3
@x4)
...
@x3
@x4))
:qid kinding_BUGSLowParseWriters.read_repr@tok.4))
)
:named kinding_BUGSLowParseWriters.read_repr@tok))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_887db497cb9109bbbb4230584155dad1
;;; Fact-ids: Name BUGSLowParseWriters.read_subcomp_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(150,12-150,23); use=BUGSLowParseWriters.fst(150,12-150,23)
...
:qid int_inversion))
:named int_inversion))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9f84fde25c9371c70f6024f4e723e92d
;;; Fact-ids: Name BUGSLowParseWriters.read_subcomp_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(147,7-147,46); use=BUGSLowParseWriters.fst(147,7-147,46)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9f84fde25c9371c70f6024f4e723e92d @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (BUGSLowParseWriters.read_repr_spec @x0
@x1
@x2
@x3))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9f84fde25c9371c70f6024f4e723e92d @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_9f84fde25c9371c70f6024f4e723e92d))

:named haseqTm_refine_9f84fde25c9371c70f6024f4e723e92d))
...
(assert (! (HasType BUGSLowParseWriters.memory_invariant
Tm_type)
:named function_token_typing_BUGSLowParseWriters.memory_invariant))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(67,5-67,14); use=BUGSLowParseWriters.fst(67,5-67,14)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel @u0
@x1
(BUGSLowParseWriters.read_repr @x2
@x3
@x4
@x5
@x6))
(and (is-BUGSLowParseWriters.ReadRepr @x1)
(= @x2
(BUGSLowParseWriters.ReadRepr_a @x1))
(= @x3
(BUGSLowParseWriters.ReadRepr_pre @x1))
(= @x4
(BUGSLowParseWriters.ReadRepr_post @x1))
(= @x5
(BUGSLowParseWriters.ReadRepr_post_err @x1))
(= @x6
(BUGSLowParseWriters.ReadRepr_l @x1))))
...
@x5
@x6)))
:qid fuel_guarded_inversion_BUGSLowParseWriters.read_repr))

:named fuel_guarded_inversion_BUGSLowParseWriters.read_repr))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! (= 149
(Term_constr_id BUGSLowParseWriters.read_repr@tok))
:named fresh_token_BUGSLowParseWriters.read_repr@tok))
;;;;;;;;;;;;;;;;Equation for Prims.nat
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! (= Prims.nat
Tm_refine_542f9d4f129664613f2483a6c88bc7c2)
:named equation_Prims.nat))
;;;;;;;;;;;;;;;;Equation for BUGSLowParseWriters.read_subcomp_spec
;;; Fact-ids: Name BUGSLowParseWriters.read_subcomp_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(143,4-143,21); use=BUGSLowParseWriters.fst(143,4-143,21)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (= (BUGSLowParseWriters.read_subcomp_spec @x0
@x1
@x2
@x3
@x4
...
@x6
@x7))
:qid equation_BUGSLowParseWriters.read_subcomp_spec))

:named equation_BUGSLowParseWriters.read_subcomp_spec))
;;;;;;;;;;;;;;;;Equation for BUGSLowParseWriters.memory_invariant
;;; Fact-ids: Name BUGSLowParseWriters.memory_invariant; Namespace BUGSLowParseWriters
(assert (! (= BUGSLowParseWriters.memory_invariant
Prims.nat)
:named equation_BUGSLowParseWriters.memory_invariant))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(73,4-73,12); use=BUGSLowParseWriters.fst(73,4-73,12)
...
(HasTypeFuel @u0
@x3
(BUGSLowParseWriters.pure_post_ @x1
@x2))
(HasTypeFuel @u0
@x4
(BUGSLowParseWriters.pure_post_err @x2))
...
(HasTypeFuel @u0
@x6
(BUGSLowParseWriters.read_repr_spec @x1
@x2
@x3
@x4)))
(HasTypeFuel @u0
...
@x5
@x6)
(BUGSLowParseWriters.read_repr @x1
@x2
@x3
@x4
@x5)))
...
@x4
@x5)))
:qid data_typing_intro_BUGSLowParseWriters.ReadRepr@tok))

:named data_typing_intro_BUGSLowParseWriters.ReadRepr@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(73,4-73,12); use=BUGSLowParseWriters.fst(73,4-73,12)
...
(HasTypeFuel @u0
@x9
(BUGSLowParseWriters.pure_post_ @x7
@x8))
(HasTypeFuel @u0
@x10
(BUGSLowParseWriters.pure_post_err @x8))
(HasTypeFuel @u0
@x11
BUGSLowParseWriters.memory_invariant)
(HasTypeFuel @u0
@x6
(BUGSLowParseWriters.read_repr_spec @x7
@x8
@x9
@x10))))
...
@x10
@x11)))
:qid data_elim_BUGSLowParseWriters.ReadRepr))

:named data_elim_BUGSLowParseWriters.ReadRepr))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= 148
(Term_constr_id (BUGSLowParseWriters.read_repr @x0
@x1
@x2
@x3
@x4)))
...
@x3
@x4))
:qid constructor_distinct_BUGSLowParseWriters.read_repr))

:named constructor_distinct_BUGSLowParseWriters.read_repr))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name BUGSLowParseWriters.read_repr; Namespace BUGSLowParseWriters; Name BUGSLowParseWriters.ReadRepr; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(73,4-73,12); use=BUGSLowParseWriters.fst(73,4-73,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= 155
(Term_constr_id (BUGSLowParseWriters.ReadRepr @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid constructor_distinct_BUGSLowParseWriters.ReadRepr))

:named constructor_distinct_BUGSLowParseWriters.ReadRepr))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! 
...
@x5
@x6)))
:qid BUGSLowParseWriters_pretyping_d5f4af823ffacbb2bc4ce5ba5f1c6a72))

:named BUGSLowParseWriters_pretyping_d5f4af823ffacbb2bc4ce5ba5f1c6a72))
(push) ;; push{2

; Starting query at BUGSLowParseWriters.fst(161,2-161,98)
...
; Encoding query formula : forall (a: Type) (pre: Prims.pure_pre) (post: BUGSLowParseWriters.pure_post' a pre)
;   (post_err: BUGSLowParseWriters.pure_post_err pre) (pre': Prims.pure_pre)
;   (post': BUGSLowParseWriters.pure_post' a pre') (post_err': BUGSLowParseWriters.pure_post_err pre')
;   (l: BUGSLowParseWriters.memory_invariant) (l': BUGSLowParseWriters.memory_invariant)
;   (f_subcomp: BUGSLowParseWriters.read_repr a pre post post_err l).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (BUGSLowParseWriters.read_repr a pre' post' post_err' l')).
;     (pre' ==> pre) /\ (forall (x: a). pre' /\ post x ==> post' x) /\
;     (pre' /\ post_err () ==> post_err' ()) /\
;     (forall (pure_result: BUGSLowParseWriters.read_repr a pre' post' post_err' l').
;         Prims.auto_squash (p pure_result)) ==>
;     (pre' ==> pre) /\ (forall (x: a). pre' /\ post x ==> post' x) /\
;     (pre' /\ post_err () ==> post_err' ()) /\
;     (forall (pure_result: BUGSLowParseWriters.read_repr_spec a pre' post' post_err').
;         BUGSLowParseWriters.read_subcomp_spec a
;           pre
;           post
;           post_err
;           pre'
...
;           f_subcomp.spec ==
;         pure_result ==>
;         (forall (any_result: BUGSLowParseWriters.read_repr a pre' post' post_err' l').
;             any_result ==
;             BUGSLowParseWriters.ReadRepr
;             (BUGSLowParseWriters.read_subcomp_spec a
;                 pre
;                 post
;                 post_err
...
;                 post_err'
;                 f_subcomp.spec) ==>
;             (forall (return_val: BUGSLowParseWriters.read_repr a pre' post' post_err' l').
;                 return_val == any_result ==> p return_val)))


; Context: While encoding a query
; While typechecking the top-level declaration `let read_subcomp`
...
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
(Prims.pure_post (BUGSLowParseWriters.read_repr @x0
@x4
@x5
@x6
@x8)))

;; def=BUGSLowParseWriters.fst(129,2-129,16); use=BUGSLowParseWriters.fst(141,2-141,24)
(implies 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(159,51-159,55)
(Valid 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(159,51-159,55)
@x4
)
...
;; def=BUGSLowParseWriters.fst(153,3-153,6); use=BUGSLowParseWriters.fst(159,33-159,36)
(Valid 
;; def=BUGSLowParseWriters.fst(153,3-153,6); use=BUGSLowParseWriters.fst(159,33-159,36)
@x1
)
...
;; def=BUGSLowParseWriters.fst(130,2-130,43); use=BUGSLowParseWriters.fst(141,2-141,24)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
@x0)
...
;; def=BUGSLowParseWriters.fst(130,23-130,29); use=BUGSLowParseWriters.fst(141,2-141,24)
(Valid 
;; def=BUGSLowParseWriters.fst(130,23-130,29); use=BUGSLowParseWriters.fst(141,2-141,24)
(ApplyTT @x2
@x11)
...
;; def=BUGSLowParseWriters.fst(130,35-130,42); use=BUGSLowParseWriters.fst(141,2-141,24)
(Valid 
;; def=BUGSLowParseWriters.fst(130,35-130,42); use=BUGSLowParseWriters.fst(141,2-141,24)
(ApplyTT @x5
@x11)
...
;; def=BUGSLowParseWriters.fst(131,2-131,42); use=BUGSLowParseWriters.fst(141,2-141,24)
(implies 
;; def=BUGSLowParseWriters.fst(131,3-131,24); use=BUGSLowParseWriters.fst(141,2-141,24)
(and 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(159,51-159,55)
(Valid 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(159,51-159,55)
...
;; def=BUGSLowParseWriters.fst(131,12-131,23); use=BUGSLowParseWriters.fst(141,2-141,24)
(Valid 
;; def=BUGSLowParseWriters.fst(131,12-131,23); use=BUGSLowParseWriters.fst(141,2-141,24)
(ApplyTT @x3
Tm_unit)
...
;; def=BUGSLowParseWriters.fst(131,29-131,41); use=BUGSLowParseWriters.fst(141,2-141,24)
(Valid 
;; def=BUGSLowParseWriters.fst(131,29-131,41); use=BUGSLowParseWriters.fst(141,2-141,24)
(ApplyTT @x6
Tm_unit)
...
;; def=Prims.fst(441,36-441,97); use=BUGSLowParseWriters.fst(161,2-161,98)
(forall ((@x11 Term))
 (! (implies (or label_1
(HasType @x11
(BUGSLowParseWriters.read_repr @x0
...
;; def=Prims.fst(441,83-441,96); use=BUGSLowParseWriters.fst(161,2-161,98)
(Valid 
;; def=Prims.fst(441,83-441,96); use=BUGSLowParseWriters.fst(161,2-161,98)
(ApplyTT @x10
@x11)
...
;; def=Prims.fst(441,29-441,97); use=BUGSLowParseWriters.fst(161,12-161,29)
(and (implies 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(161,50-161,54)
(Valid 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(161,50-161,54)
@x4
)
...
;; def=BUGSLowParseWriters.fst(153,3-153,6); use=BUGSLowParseWriters.fst(161,32-161,35)
(or label_2
...
;; def=BUGSLowParseWriters.fst(130,2-130,43); use=BUGSLowParseWriters.fst(161,2-161,98)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
@x0)
...
;; def=BUGSLowParseWriters.fst(130,23-130,29); use=BUGSLowParseWriters.fst(161,2-161,98)
(Valid 
;; def=BUGSLowParseWriters.fst(130,23-130,29); use=BUGSLowParseWriters.fst(161,2-161,98)
(ApplyTT @x2
@x11)
...
;; def=BUGSLowParseWriters.fst(130,35-130,42); use=BUGSLowParseWriters.fst(161,2-161,98)
(or label_3
...
(implies 
;; def=BUGSLowParseWriters.fst(131,3-131,24); use=BUGSLowParseWriters.fst(161,2-161,98)
(and 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(161,50-161,54)
(Valid 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(161,50-161,54)
...
;; def=BUGSLowParseWriters.fst(131,12-131,23); use=BUGSLowParseWriters.fst(161,2-161,98)
(Valid 
;; def=BUGSLowParseWriters.fst(131,12-131,23); use=BUGSLowParseWriters.fst(161,2-161,98)
(ApplyTT @x3
Tm_unit)
...
;; def=BUGSLowParseWriters.fst(131,29-131,41); use=BUGSLowParseWriters.fst(161,2-161,98)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=BUGSLowParseWriters.fst(161,12-161,29)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
(BUGSLowParseWriters.read_repr_spec @x0
@x4
...
;; def=BUGSLowParseWriters.fst(74,5-161,98); use=BUGSLowParseWriters.fst(161,2-161,98)
(= (BUGSLowParseWriters.read_subcomp_spec @x0
@x1
@x2
@x3
...
;; def=Prims.fst(451,66-451,102); use=BUGSLowParseWriters.fst(161,2-161,98)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
(BUGSLowParseWriters.read_repr @x0
@x4
...
;; def=BUGSLowParseWriters.fst(158,7-161,98); use=BUGSLowParseWriters.fst(161,2-161,98)
(= @x12
(BUGSLowParseWriters.ReadRepr @x0
@x4
@x5
@x6
@x8
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.read_subcomp, 1)
; STATUS: unsat
...
; encoding sigelt let read_subcomp


; <Start encoding let read_subcomp>

(declare-fun BUGSLowParseWriters.read_subcomp (Term Term Term Term Term Term Term Term Term Term) Term)
(declare-fun Tm_refine_25d9e00e841b41d6c953efe65ae2ffdd (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     pre: Prims.pure_pre ->     post: pure_post' a pre ->     post_err: pure_post_err pre ->     pre': Prims.pure_pre ->     post': pure_post' a pre' ->     post_err': pure_post_err pre' ->     l: memory_invariant ->     l': memory_invariant ->     f_subcomp: read_repr a pre post post_err l   -> Prims.Pure (read_repr a pre' post' post_err' l')
(declare-fun Tm_arrow_4d4d49f34c44dda87c61176f58360a9c () Term)
(declare-fun BUGSLowParseWriters.read_subcomp@tok () Term)


; </end encoding let read_subcomp>


; encoding sigelt let read_if_then_else


; <Start encoding let read_if_then_else>

(declare-fun BUGSLowParseWriters.read_if_then_else (Term Term Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     pre_f: Prims.pure_pre ->     pre_g: Prims.pure_pre ->     post_f: pure_post' a pre_f ->     post_g: pure_post' a pre_g ->     post_err_f: pure_post_err pre_f ->     post_err_g: pure_post_err pre_g ->     l: memory_invariant ->     f_ifthenelse: read_repr a pre_f post_f post_err_f l ->     g: read_repr a pre_g post_g post_err_g l ->     p: Prims.bool   -> Type
(declare-fun Tm_arrow_6de004ac8418a4bddb8412a27a899b5b () Term)
(declare-fun BUGSLowParseWriters.read_if_then_else@tok () Term)

(declare-fun Tm_abs_89a61bf40d40a7ccce79d1927944e4a8 (Term Term Term Term) Term)

(declare-fun Tm_abs_7ea87e4ae3c04a81a5053c5865ea113d (Term Term Term) Term)

; </end encoding let read_if_then_else>
...
;   (post': BUGSLowParseWriters.pure_post' a pre') (post_err': BUGSLowParseWriters.pure_post_err pre')
;   (l: BUGSLowParseWriters.memory_invariant) (l': BUGSLowParseWriters.memory_invariant)
;   (p: Prims.pure_post (BUGSLowParseWriters.read_repr a pre' post' post_err' l'))
;   (q: Prims.pure_post (BUGSLowParseWriters.read_repr a pre' post' post_err' l')).
;   (forall (x: BUGSLowParseWriters.read_repr a pre' post' post_err' l'). p x ==> q x) ==>
;   (pre' ==> pre) /\ (forall (x: a). pre' /\ post x ==> post' x) /\
;   (pre' /\ post_err () ==> post_err' ()) /\
;   (forall (pure_result: BUGSLowParseWriters.read_repr a pre' post' post_err' l').
;       Prims.auto_squash (p pure_result)) ==>
...
; While checking layered effect definition `BUGSLowParseWriters.ERead`
; While typechecking the top-level declaration `layered_effect { ERead ... }`
...
;; def=BUGSLowParseWriters.fst(129,2-129,16); use=BUGSLowParseWriters.fst(129,2-129,16)
(implies 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(154,3-154,7)
(Valid 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(154,3-154,7)
@x4
)
...
;; def=BUGSLowParseWriters.fst(153,3-153,6); use=BUGSLowParseWriters.fst(153,3-153,6)
(Valid 
;; def=BUGSLowParseWriters.fst(153,3-153,6); use=BUGSLowParseWriters.fst(153,3-153,6)
@x1
)
...
;; def=BUGSLowParseWriters.fst(130,2-130,43); use=BUGSLowParseWriters.fst(130,2-130,43)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
@x0)
...
;; def=BUGSLowParseWriters.fst(130,23-130,29); use=BUGSLowParseWriters.fst(130,23-130,29)
(Valid 
;; def=BUGSLowParseWriters.fst(130,23-130,29); use=BUGSLowParseWriters.fst(130,23-130,29)
(ApplyTT @x2
@x11)
...
;; def=BUGSLowParseWriters.fst(130,35-130,42); use=BUGSLowParseWriters.fst(130,35-130,42)
(Valid 
;; def=BUGSLowParseWriters.fst(130,35-130,42); use=BUGSLowParseWriters.fst(130,35-130,42)
(ApplyTT @x5
@x11)
...
;; def=BUGSLowParseWriters.fst(131,2-131,42); use=BUGSLowParseWriters.fst(131,2-131,42)
(implies 
;; def=BUGSLowParseWriters.fst(131,3-131,24); use=BUGSLowParseWriters.fst(131,3-131,24)
(and 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(154,3-154,7)
(Valid 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(154,3-154,7)
...
;; def=BUGSLowParseWriters.fst(131,12-131,23); use=BUGSLowParseWriters.fst(131,12-131,23)
(Valid 
;; def=BUGSLowParseWriters.fst(131,12-131,23); use=BUGSLowParseWriters.fst(131,12-131,23)
(ApplyTT @x3
Tm_unit)
...
;; def=BUGSLowParseWriters.fst(131,29-131,41); use=BUGSLowParseWriters.fst(131,29-131,41)
(Valid 
;; def=BUGSLowParseWriters.fst(131,29-131,41); use=BUGSLowParseWriters.fst(131,29-131,41)
(ApplyTT @x6
Tm_unit)
...
;; def=Prims.fst(441,36-441,97); use=BUGSLowParseWriters.fst(187,14-187,26)
(forall ((@x11 Term))
 (! (implies (HasType @x11
(BUGSLowParseWriters.read_repr @x0
@x4
...
;; def=Prims.fst(441,83-441,96); use=BUGSLowParseWriters.fst(187,14-187,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=BUGSLowParseWriters.fst(187,14-187,26)
(ApplyTT @x9
@x11)
...
;; def=Prims.fst(441,29-441,97); use=BUGSLowParseWriters.fst(187,14-187,26)
(and (implies 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(154,3-154,7)
(Valid 
;; def=BUGSLowParseWriters.fst(154,3-154,7); use=BUGSLowParseWriters.fst(154,3-154,7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.ERead, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; Encoding query formula : forall (a: Type) (pre_f: Prims.pure_pre) (pre_g: Prims.pure_pre)
;   (post_f: BUGSLowParseWriters.pure_post' a pre_f) (post_g: BUGSLowParseWriters.pure_post' a pre_g)
;   (post_err_f: BUGSLowParseWriters.pure_post_err pre_f)
;   (post_err_g: BUGSLowParseWriters.pure_post_err pre_g) (l: BUGSLowParseWriters.memory_invariant)
;   (f: BUGSLowParseWriters.read_repr a pre_f post_f post_err_f l)
;   (g: BUGSLowParseWriters.read_repr a pre_g post_g post_err_g l) (p: Prims.bool) (_: Prims.squash p)
; .
;   ((p ==> pre_f) /\ (~p ==> pre_g) ==> pre_f) /\
;   (forall (x: a).
;       (p ==> pre_f) /\ (~p ==> pre_g) /\ post_f x ==> (p ==> post_f x) /\ (~p ==> post_g x)) /\
;   ((p ==> pre_f) /\ (~p ==> pre_g) /\ post_err_f () ==>
;     (p ==> post_err_f ()) /\ (~p ==> post_err_g ()))
...
Prims.bool)
(HasType @x11
(Prims.squash (Prims.b2t @x10))))

;; def=BUGSLowParseWriters.fst(129,2-131,42); use=BUGSLowParseWriters.fst(141,2-141,24)
(and (implies 
;; def=BUGSLowParseWriters.fst(175,4-175,40); use=BUGSLowParseWriters.fst(188,19-188,36)
(and 
;; def=BUGSLowParseWriters.fst(175,5-175,18); use=BUGSLowParseWriters.fst(188,19-188,36)
(implies 
;; def=BUGSLowParseWriters.fst(172,3-172,4); use=BUGSLowParseWriters.fst(188,19-188,36)
(BoxBool_proj_0 @x10)


;; def=BUGSLowParseWriters.fst(164,3-164,8); use=BUGSLowParseWriters.fst(164,3-164,8)
(Valid 
;; def=BUGSLowParseWriters.fst(164,3-164,8); use=BUGSLowParseWriters.fst(164,3-164,8)
@x1
)
...
;; def=BUGSLowParseWriters.fst(175,22-175,39); use=BUGSLowParseWriters.fst(188,19-188,36)
(implies 
;; def=BUGSLowParseWriters.fst(175,23-175,28); use=BUGSLowParseWriters.fst(188,19-188,36)
(not 
;; def=BUGSLowParseWriters.fst(172,3-172,4); use=BUGSLowParseWriters.fst(188,19-188,36)
(BoxBool_proj_0 @x10)
)
...
;; def=BUGSLowParseWriters.fst(164,9-164,14); use=BUGSLowParseWriters.fst(164,9-164,14)
(Valid 
;; def=BUGSLowParseWriters.fst(164,9-164,14); use=BUGSLowParseWriters.fst(164,9-164,14)
@x2
)
...
;; def=BUGSLowParseWriters.fst(176,14-176,54); use=BUGSLowParseWriters.fst(188,19-188,36)
(and (implies 
;; def=BUGSLowParseWriters.fst(172,3-172,4); use=BUGSLowParseWriters.fst(188,19-188,36)
(BoxBool_proj_0 @x10)


;; def=BUGSLowParseWriters.fst(176,21-176,29); use=BUGSLowParseWriters.fst(188,19-188,36)
(or label_2
...
(implies 
;; def=BUGSLowParseWriters.fst(176,35-176,40); use=BUGSLowParseWriters.fst(188,19-188,36)
(not 
;; def=BUGSLowParseWriters.fst(172,3-172,4); use=BUGSLowParseWriters.fst(188,19-188,36)
(BoxBool_proj_0 @x10)
)
...
;; def=BUGSLowParseWriters.fst(176,45-176,53); use=BUGSLowParseWriters.fst(188,19-188,36)
(or label_3
...
;; def=BUGSLowParseWriters.fst(177,14-177,64); use=BUGSLowParseWriters.fst(188,19-188,36)
(and (implies 
;; def=BUGSLowParseWriters.fst(172,3-172,4); use=BUGSLowParseWriters.fst(188,19-188,36)
(BoxBool_proj_0 @x10)


;; def=BUGSLowParseWriters.fst(177,21-177,34); use=BUGSLowParseWriters.fst(188,19-188,36)
(or label_4
...
(implies 
;; def=BUGSLowParseWriters.fst(177,40-177,45); use=BUGSLowParseWriters.fst(188,19-188,36)
(not 
;; def=BUGSLowParseWriters.fst(172,3-172,4); use=BUGSLowParseWriters.fst(188,19-188,36)
(BoxBool_proj_0 @x10)
)
...
;; def=BUGSLowParseWriters.fst(177,50-177,63); use=BUGSLowParseWriters.fst(188,19-188,36)
(or label_5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.ERead, 2)
; STATUS: unsat
...
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(188,19-188,36); use=BUGSLowParseWriters.fst(188,19-188,36)
(forall ((@x0 Term))
...
;   (post_err_g: BUGSLowParseWriters.pure_post_err pre_g) (l: BUGSLowParseWriters.memory_invariant)
;   (f: BUGSLowParseWriters.read_repr a pre_f post_f post_err_f l)
;   (g: BUGSLowParseWriters.read_repr a pre_g post_g post_err_g l) (p: Prims.bool)
;   (_: _: Prims.unit{~p}).
;   ((p ==> pre_f) /\ (~p ==> pre_g) ==> pre_g) /\
;   (forall (x: a).
;       (p ==> pre_f) /\ (~p ==> pre_g) /\ post_g x ==> (p ==> post_f x) /\ (~p ==> post_g x)) /\
;   ((p ==> pre_f) /\ (~p ==> pre_g) /\ post_err_g () ==>
;     (p ==> post_err_f ()) /\ (~p ==> post_err_g ()))
...
Prims.bool)
(HasType @x11
(Tm_refine_de09779676242898794a0b057d5f5bb4 @x10)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.ERead, 3)
; STATUS: unsat
...
; encoding sigelt layered_effect { ERead ... }


; <Skipped layered_effect { ERead ... }/>


; encoding sigelt effect Read a pre post inv = BUGSLowParseWriters.ERead a


; <Skipped effect Read a pre post inv = BUGSLowParseWriters.ERead a/>
...
; Starting query at BUGSLowParseWriters.fst(205,2-206,36)
...
;;;;;;;;;;;;;;;;return_val: result a -> Prims.GTot Type0
(declare-fun Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(58,8-58,18); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4 @x0)
Tm_type))
:qid kinding_Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4))

:named kinding_Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(58,8-58,18); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4 @x2)))
:qid BUGSLowParseWriters_pre_typing_Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4))

:named BUGSLowParseWriters_pre_typing_Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(58,8-58,18); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4 @x1))
(and 
;; def=BUGSLowParseWriters.fst(58,8-58,18); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4 @x1)))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4))

:named BUGSLowParseWriters_interpretation_Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4))
(declare-fun Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72 @x0
@x1
@x2)
(Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4 @x2))
 

:pattern ((Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72 @x0
@x1
@x2))
:qid typing_Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72))

:named typing_Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72 @x1
@x2
@x3)
@x0)
(Prims.l_imp (Prims.eq2 (BUGSLowParseWriters.result @x3)
@x0
@x1)
(ApplyTT @x2
@x0)))
...
:pattern ((ApplyTT (Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72))

:named interpretation_Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(356,2-356,58); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.l_Forall (BUGSLowParseWriters.result @x2)
(Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72 @x1
@x0
@x2)))
...
;; def=Prims.fst(356,26-356,41); use=BUGSLowParseWriters.fst(205,2-206,36)
(= @x3
@x1)
)

;; def=Prims.fst(356,46-356,58); use=BUGSLowParseWriters.fst(205,2-206,36)
(Valid 
;; def=Prims.fst(356,46-356,58); use=BUGSLowParseWriters.fst(205,2-206,36)
(ApplyTT @x0
@x3)
...
;;no pats
:qid l_quant_interp_caf3f0581e33ee0214565c25768a72bb.1))
)
 

:pattern ((Valid (Prims.l_Forall (BUGSLowParseWriters.result @x2)
(Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72 @x1
@x0
@x2))))
:qid l_quant_interp_caf3f0581e33ee0214565c25768a72bb))

:named l_quant_interp_caf3f0581e33ee0214565c25768a72bb))

(declare-fun Tm_abs_04f583462b441912c4b615e1cbab0517 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_04f583462b441912c4b615e1cbab0517
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(451,66-451,102); use=BUGSLowParseWriters.fst(206,12-206,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_04f583462b441912c4b615e1cbab0517 @x0
@x1
@x2)
(Tm_arrow_d18a0ee863656ec2c7483c8a9ad5e4b4 @x2))
 

:pattern ((Tm_abs_04f583462b441912c4b615e1cbab0517 @x0
@x1
@x2))
:qid typing_Tm_abs_04f583462b441912c4b615e1cbab0517))

:named typing_Tm_abs_04f583462b441912c4b615e1cbab0517))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_04f583462b441912c4b615e1cbab0517
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(451,66-451,102); use=BUGSLowParseWriters.fst(206,12-206,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_04f583462b441912c4b615e1cbab0517 @x1
@x2
@x3)
@x0)
(Prims.l_imp (Prims.eq2 (BUGSLowParseWriters.result @x3)
@x0
(BUGSLowParseWriters.Correct @x3
(ApplyTT @x1
Tm_unit)))
(Prims.l_Forall (BUGSLowParseWriters.result @x3)
(Tm_abs_6a4256e70c6ba1c054c1c2bb774d5e72 @x0
@x2
@x3))))
 

:pattern ((ApplyTT (Tm_abs_04f583462b441912c4b615e1cbab0517 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_04f583462b441912c4b615e1cbab0517))

:named interpretation_Tm_abs_04f583462b441912c4b615e1cbab0517))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(451,66-451,102); use=BUGSLowParseWriters.fst(206,12-206,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.l_Forall (BUGSLowParseWriters.result @x2)
(Tm_abs_04f583462b441912c4b615e1cbab0517 @x1
@x0
@x2)))
...
;; def=BUGSLowParseWriters.fst(58,8-206,36); use=BUGSLowParseWriters.fst(206,12-206,36)
(= @x3
(BUGSLowParseWriters.Correct @x2
(ApplyTT @x1
Tm_unit)))
)
...
;;no pats
:qid l_quant_interp_d7d3a048ecab29ba5b8115834b43165b.2))
)
 
;;no pats
:qid l_quant_interp_d7d3a048ecab29ba5b8115834b43165b.1))
)
...
@x0
@x2))))
:qid l_quant_interp_d7d3a048ecab29ba5b8115834b43165b))

:named l_quant_interp_d7d3a048ecab29ba5b8115834b43165b))

(declare-fun Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,38-369,57); use=BUGSLowParseWriters.fst(206,12-206,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431 @x0
@x1
@x2)
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x2))
 

:pattern ((Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431 @x0
@x1
@x2))
:qid typing_Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431))

:named typing_Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431
;;; Fact-ids: 
(assert (! 
;; def=Prims.fst(369,38-369,57); use=BUGSLowParseWriters.fst(206,12-206,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431 @x1
@x2
@x3)
@x0)
...
:pattern ((ApplyTT (Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431))

:named interpretation_Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431))



(declare-fun Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(202,31-202,42); use=BUGSLowParseWriters.fst(206,12-206,36)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d @x0
@x1)
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x1))
 

:pattern ((Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d @x0
@x1))
:qid typing_Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d))

:named typing_Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(202,31-202,42); use=BUGSLowParseWriters.fst(206,12-206,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d @x1
@x2)
@x0)
(Prims.l_not (Prims.eq2 @x2
(BUGSLowParseWriters.Correct__0 @x1)
@x0)))
 

:pattern ((ApplyTT (Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d @x1
@x2)
@x0))
:qid interpretation_Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d))

:named interpretation_Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d))

; Encoding query formula : forall (a: Type) (wp: Prims.pure_wp a) (f_pure_spec: (_: Prims.unit -> Prims.PURE a)).
;   (*  - Could not prove post-condition
; *)
...
;           (forall (ghost_result: BUGSLowParseWriters.result a).
;               (match ghost_result with
;                 | BUGSLowParseWriters.Correct v -> ~(wp (fun x' -> ~(v == x')))
;                 | BUGSLowParseWriters.Error _ -> Prims.l_False) ==>
;               p ghost_result) ==>
;           wp (fun bind_result_1 ->
;                 f_pure_spec () == bind_result_1 ==>
;                 (forall (any_result: BUGSLowParseWriters.result a).
;                     any_result == BUGSLowParseWriters.Correct (f_pure_spec ()) ==>
;                     (forall (return_val: BUGSLowParseWriters.result a).
;                         return_val == any_result ==> p return_val))))


; Context: While encoding a query
; While typechecking the top-level declaration `let lift_pure_read_spec`
...
;; def=Prims.fst(441,36-441,97); use=BUGSLowParseWriters.fst(205,23-205,48)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=FStar.Monotonic.Pure.fst(34,2-34,75); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
(Prims.pure_post @x0))
(HasType @x5
...
;; def=FStar.Monotonic.Pure.fst(34,28-34,55); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
@x0)

;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=BUGSLowParseWriters.fst(205,2-206,36)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,43-34,46); use=BUGSLowParseWriters.fst(205,2-206,36)
(ApplyTT @x4
@x6)
...
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=BUGSLowParseWriters.fst(205,2-206,36)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,51-34,54); use=BUGSLowParseWriters.fst(205,2-206,36)
(ApplyTT @x5
@x6)
...
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=BUGSLowParseWriters.fst(205,2-206,36)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,61-34,65); use=BUGSLowParseWriters.fst(205,2-206,36)
(ApplyTT @x1
@x4)
...
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=BUGSLowParseWriters.fst(205,2-206,36)
(Valid 
;; def=FStar.Monotonic.Pure.fst(34,70-34,74); use=BUGSLowParseWriters.fst(205,2-206,36)
(ApplyTT @x1
@x5)
...
;; def=dummy(0,0-0,0); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.unit)

;; def=Prims.fst(406,51-406,91); use=BUGSLowParseWriters.fst(205,2-206,36)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.pure_post (BUGSLowParseWriters.result @x0)))

;; def=BUGSLowParseWriters.fst(201,4-201,24); use=BUGSLowParseWriters.fst(206,12-206,36)
(Valid 
;; def=BUGSLowParseWriters.fst(201,4-201,24); use=BUGSLowParseWriters.fst(206,12-206,36)
(ApplyTT @x1
...
;; def=Prims.fst(485,36-485,100); use=BUGSLowParseWriters.fst(206,12-206,36)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
(BUGSLowParseWriters.result @x0)))
(let ((@lb7 @x6))
(ite (is-BUGSLowParseWriters.Correct @lb7)

;; def=BUGSLowParseWriters.fst(202,14-202,44); use=BUGSLowParseWriters.fst(206,12-206,36)
(or label_2

;; def=BUGSLowParseWriters.fst(202,14-202,44); use=BUGSLowParseWriters.fst(206,12-206,36)
(not 
;; def=BUGSLowParseWriters.fst(202,16-202,44); use=BUGSLowParseWriters.fst(206,12-206,36)
(Valid 
;; def=BUGSLowParseWriters.fst(202,16-202,44); use=BUGSLowParseWriters.fst(206,12-206,36)
(ApplyTT @x1
(Tm_abs_1a3b3b2e3463fa5b017852858d0bc89d @lb7
@x0))
)
)
)

(ite (is-BUGSLowParseWriters.Error @lb7)
label_3
Unreachable))))

;; def=Prims.fst(485,85-485,99); use=BUGSLowParseWriters.fst(206,12-206,36)
(Valid 
;; def=Prims.fst(485,85-485,99); use=BUGSLowParseWriters.fst(206,12-206,36)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(369,7-369,58); use=BUGSLowParseWriters.fst(206,12-206,36)
(or label_4
...
;; def=Prims.fst(369,7-369,58); use=BUGSLowParseWriters.fst(206,12-206,36)
(ApplyTT @x1
(Tm_abs_3ed2a9d5cf9afbd60993b8aec125d431 @x2
@x5
@x0))
)
)
...
; encoding sigelt let lift_pure_read_spec


; <Start encoding let lift_pure_read_spec>
...
(declare-fun BUGSLowParseWriters.lift_pure_read_spec (Term Term Term) Term)
...
(declare-fun Tm_abs_b6611a6fee45331cc641a406f75c8837 (Term Term) Term)

(declare-fun Tm_abs_43a6eb0bfcda1f20b52d3f409f847b5c (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> f_pure_spec: (_: Prims.unit -> Prims.PURE a)   -> read_repr_spec a       (wp (fun _ -> Prims.l_True))       (fun x -> ~(wp (fun x' -> ~(x == x'))))       (fun _ -> Prims.l_False)
(declare-fun Tm_arrow_aac4ecbbd80bff7f05f2f5b1772cf261 () Term)
(declare-fun BUGSLowParseWriters.lift_pure_read_spec@tok () Term)
...
(declare-fun Tm_abs_323d42cb31e575fb15edc5529acd9bdf (Term Term) Term)

; </end encoding let lift_pure_read_spec>


; encoding sigelt let lift_pure_read


; <Start encoding let lift_pure_read>
...
(declare-fun BUGSLowParseWriters.lift_pure_read (Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> l: memory_invariant -> f_pure: (_: Prims.unit -> Prims.PURE a)   -> read_repr a       (wp (fun _ -> Prims.l_True))       (fun x -> ~(wp (fun x' -> ~(x == x'))))       (fun _ -> Prims.l_False)       l
(declare-fun Tm_arrow_6b4b39ec348f4979015f69351ea2f358 () Term)
(declare-fun BUGSLowParseWriters.lift_pure_read@tok () Term)
...
; </end encoding let lift_pure_read>


; encoding sigelt sub_effect PURE ~> ERead


; <Skipped sub_effect PURE ~> ERead/>


; encoding sigelt let reify_read_spec


; <Start encoding let reify_read_spec>

(declare-fun Non_total_Tm_arrow_0c9f72bb29fbb03fda5c701e05991f4d (Term Term Term Term Term) Term)
(declare-fun BUGSLowParseWriters.reify_read_spec (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     pre: Prims.pure_pre ->     post: pure_post' a pre ->     post_err: pure_post_err pre ->     l: memory_invariant ->     $r: (_: Prims.unit -> ERead a)   -> Prims.GTot (read_repr_spec a pre post post_err)
(declare-fun Tm_arrow_2b82477733f76b567a325db94d8da125 () Term)
(declare-fun BUGSLowParseWriters.reify_read_spec@tok () Term)

;;;;;;;;;;;;;;;;Imprecise reify
(declare-fun Tm_reify_BUGSLowParseWriters_453 () Term)

; </end encoding let reify_read_spec>

;;;;;;;;;;;;;;;;typing_Tm_abs_077c0f895008f5d74804c404b01870e8
;;; Fact-ids: Name BUGSLowParseWriters.read_return_spec; Namespace BUGSLowParseWriters
(assert (! (HasType Tm_abs_077c0f895008f5d74804c404b01870e8
Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe)
:named typing_Tm_abs_077c0f895008f5d74804c404b01870e8))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BUGSLowParseWriters.reify_read_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(220,4-220,19); use=BUGSLowParseWriters.fst(220,4-220,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
BUGSLowParseWriters.memory_invariant)
(HasType @x5
(Non_total_Tm_arrow_0c9f72bb29fbb03fda5c701e05991f4d @x0
@x1
@x2
@x3
@x4)))
(HasType (BUGSLowParseWriters.reify_read_spec @x0
@x1
@x2
@x3
@x4
...
:pattern ((BUGSLowParseWriters.reify_read_spec @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_BUGSLowParseWriters.reify_read_spec))

:named typing_BUGSLowParseWriters.reify_read_spec))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name BUGSLowParseWriters.reify_read_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(220,4-220,19); use=BUGSLowParseWriters.fst(220,4-220,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.reify_read_spec@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5)
(BUGSLowParseWriters.reify_read_spec @x0
@x1
@x2
@x3
@x4
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.reify_read_spec@tok
@x0)
@x1)
@x2)
@x3)
@x4)
@x5))
:qid token_correspondence_BUGSLowParseWriters.reify_read_spec))

:named token_correspondence_BUGSLowParseWriters.reify_read_spec))
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: Name BUGSLowParseWriters.reify_read_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(221,3-226,11); use=BUGSLowParseWriters.fst(226,7-226,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x4
BUGSLowParseWriters.memory_invariant))
(HasType (Non_total_Tm_arrow_0c9f72bb29fbb03fda5c701e05991f4d @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Non_total_Tm_arrow_0c9f72bb29fbb03fda5c701e05991f4d @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_0c9f72bb29fbb03fda5c701e05991f4d))

:named non_total_function_typing_Non_total_Tm_arrow_0c9f72bb29fbb03fda5c701e05991f4d))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2b82477733f76b567a325db94d8da125
;;; Fact-ids: Name BUGSLowParseWriters.reify_read_spec; Namespace BUGSLowParseWriters
(assert (! (HasType Tm_arrow_2b82477733f76b567a325db94d8da125
Tm_type)
:named kinding_Tm_arrow_2b82477733f76b567a325db94d8da125))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_077c0f895008f5d74804c404b01870e8
;;; Fact-ids: Name BUGSLowParseWriters.read_return_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(79,61-79,66); use=BUGSLowParseWriters.fst(79,61-79,66)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_077c0f895008f5d74804c404b01870e8
@x0)
Prims.l_False)
 

:pattern ((ApplyTT Tm_abs_077c0f895008f5d74804c404b01870e8
@x0))
:qid interpretation_Tm_abs_077c0f895008f5d74804c404b01870e8))

:named interpretation_Tm_abs_077c0f895008f5d74804c404b01870e8))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name BUGSLowParseWriters.reify_read_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(220,4-220,19); use=BUGSLowParseWriters.fst(220,4-220,19)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType BUGSLowParseWriters.reify_read_spec@tok
Tm_arrow_2b82477733f76b567a325db94d8da125))
...
@x5)
@x6)
(BUGSLowParseWriters.reify_read_spec @x1
@x2
@x3
@x4
@x5
...
:pattern ((BUGSLowParseWriters.reify_read_spec @x1
@x2
@x3
@x4
@x5
@x6))
:qid function_token_typing_BUGSLowParseWriters.reify_read_spec.1))
)
 

:pattern ((ApplyTT @x0
BUGSLowParseWriters.reify_read_spec@tok))
:qid function_token_typing_BUGSLowParseWriters.reify_read_spec))

:named function_token_typing_BUGSLowParseWriters.reify_read_spec))
;;;;;;;;;;;;;;;;Equation for BUGSLowParseWriters.reify_read_spec
;;; Fact-ids: Name BUGSLowParseWriters.reify_read_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(220,4-220,19); use=BUGSLowParseWriters.fst(220,4-220,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
...
@x3
@x4
Tm_reify_BUGSLowParseWriters_453))
...
@x4
@x5))
:qid equation_BUGSLowParseWriters.reify_read_spec))

:named equation_BUGSLowParseWriters.reify_read_spec))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name BUGSLowParseWriters.reify_read_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(221,3-227,43); use=BUGSLowParseWriters.fst(221,5-227,43)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2b82477733f76b567a325db94d8da125)
...
@x1
Tm_arrow_2b82477733f76b567a325db94d8da125))
:qid BUGSLowParseWriters_pre_typing_Tm_arrow_2b82477733f76b567a325db94d8da125))

:named BUGSLowParseWriters_pre_typing_Tm_arrow_2b82477733f76b567a325db94d8da125))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2b82477733f76b567a325db94d8da125
;;; Fact-ids: Name BUGSLowParseWriters.reify_read_spec; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(221,3-227,43); use=BUGSLowParseWriters.fst(221,5-227,43)
(forall ((@x0 Term))
...
BUGSLowParseWriters.memory_invariant)
(HasType @x6
(Non_total_Tm_arrow_0c9f72bb29fbb03fda5c701e05991f4d @x1
@x2
@x3
@x4
@x5)))
...
@x5)
@x6))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_2b82477733f76b567a325db94d8da125.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_2b82477733f76b567a325db94d8da125.2))
...
@x1)
@x2))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_2b82477733f76b567a325db94d8da125.3))
...
@x2)
@x3))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_2b82477733f76b567a325db94d8da125.4))
...
@x3)
@x4))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_2b82477733f76b567a325db94d8da125.5))
...
@x4)
@x5))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_2b82477733f76b567a325db94d8da125.6))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_2b82477733f76b567a325db94d8da125))
:qid BUGSLowParseWriters_interpretation_Tm_arrow_2b82477733f76b567a325db94d8da125))

:named BUGSLowParseWriters_interpretation_Tm_arrow_2b82477733f76b567a325db94d8da125))
(push) ;; push{2

; Starting query at BUGSLowParseWriters.fst(237,3-238,53)

(declare-fun label_1 () Bool)
(declare-fun Non_total_Tm_arrow_3301e8ed3ea7f30000d331d093ae5835 (Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(232,3-233,11); use=BUGSLowParseWriters.fst(233,7-233,21)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
BUGSLowParseWriters.memory_invariant))
(HasType (Non_total_Tm_arrow_3301e8ed3ea7f30000d331d093ae5835 @x0
@x1)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_3301e8ed3ea7f30000d331d093ae5835 @x0
@x1)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_3301e8ed3ea7f30000d331d093ae5835))

:named non_total_function_typing_Non_total_Tm_arrow_3301e8ed3ea7f30000d331d093ae5835))
(declare-fun Non_total_Tm_arrow_281a845dd9a3f1cc8f42b2439dd51c9b (Term Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=BUGSLowParseWriters.fst(232,3-234,16); use=BUGSLowParseWriters.fst(234,7-234,26)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
BUGSLowParseWriters.memory_invariant))
(HasType (Non_total_Tm_arrow_281a845dd9a3f1cc8f42b2439dd51c9b @x0
@x1
@x2)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_281a845dd9a3f1cc8f42b2439dd51c9b @x0
@x1
@x2)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_281a845dd9a3f1cc8f42b2439dd51c9b))

:named non_total_function_typing_Non_total_Tm_arrow_281a845dd9a3f1cc8f42b2439dd51c9b))
...
BUGSLowParseWriters.reify_read_spec@tok))
:named @kick_partial_app_046f30f865b8f963b15cd0319df6e4bc))
...
; Encoding query formula : forall (inv: BUGSLowParseWriters.memory_invariant)
;   (a: Type)
;   (b: Type)
;   (f: (_: Prims.unit -> BUGSLowParseWriters.Read a))
;   (g: (_: a -> _: Prims.unit -> BUGSLowParseWriters.Read b)).
;   (*  - Could not prove post-condition
; *)
;   forall (ghost_result: BUGSLowParseWriters.result a).
;     (match ghost_result with
;       | BUGSLowParseWriters.Correct _ -> Prims.l_True
;       | BUGSLowParseWriters.Error _ -> Prims.l_False) ==>
;     BUGSLowParseWriters.reify_read_spec a
;       Prims.l_True
;       (fun _ -> Prims.l_True)
;       (fun _ -> Prims.l_False)
;       inv
...
;       () ==
;     ghost_result ==>
;     ~(Correct? (BUGSLowParseWriters.reify_read_spec a
;             Prims.l_True
;             (fun _ -> Prims.l_True)
;             (fun _ -> Prims.l_False)
;             inv
...
Tm_type)
(HasType @x3
(Non_total_Tm_arrow_3301e8ed3ea7f30000d331d093ae5835 @x1
@x0))
(HasType @x4
(Non_total_Tm_arrow_281a845dd9a3f1cc8f42b2439dd51c9b @x1
@x2
@x0)))

;; def=Prims.fst(485,36-485,100); use=BUGSLowParseWriters.fst(237,3-238,53)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(BUGSLowParseWriters.result @x1))
(let ((@lb6 @x5))
(implies (not (is-BUGSLowParseWriters.Correct @lb6))
(ite (is-BUGSLowParseWriters.Error @lb6)

;; def=BUGSLowParseWriters.fst(196,29-196,34); use=BUGSLowParseWriters.fst(237,3-238,53)
false

Unreachable)))

;; def=BUGSLowParseWriters.fst(237,9-237,39); use=BUGSLowParseWriters.fst(237,9-237,39)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.reify_read_spec@tok
@x1)
Prims.l_True)
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x1))
Tm_abs_077c0f895008f5d74804c404b01870e8)
@x0)
@x3)
Tm_unit)
@x5)
...
(not 
;; def=BUGSLowParseWriters.fst(237,9-237,39); use=BUGSLowParseWriters.fst(237,9-237,39)
(BoxBool_proj_0 (BUGSLowParseWriters.uu___is_Correct @x1
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.reify_read_spec@tok
@x1)
Prims.l_True)
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x1))
...
; QUERY ID: (BUGSLowParseWriters.read_bind_spec', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, disc_equation_BUGSLowParseWriters.Correct, projection_inverse_BoxBool_proj_0
...
(declare-fun Non_total_Tm_arrow_3301e8ed3ea7f30000d331d093ae5835 (Term Term) Term)
(declare-fun Non_total_Tm_arrow_281a845dd9a3f1cc8f42b2439dd51c9b (Term Term Term) Term)
(declare-fun BUGSLowParseWriters.read_bind_spec_ (Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;inv: memory_invariant ->     a: Type ->     b: Type ->     f: (_: Prims.unit -> Read a) ->     g: (_: a -> _: Prims.unit -> Read b)   -> Prims.GTot (result b)
(declare-fun Tm_ghost_arrow_82e1627c2cf77899b8dbd1b076c0b061 () Term)
(declare-fun BUGSLowParseWriters.read_bind_spec_@tok () Term)
...
; encoding sigelt let read_bind_impl'


; <Start encoding let read_bind_impl'>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun BUGSLowParseWriters.read_bind_impl_ (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun BUGSLowParseWriters.read_bind_impl_@tok () Term)

; </end encoding let read_bind_impl'>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name BUGSLowParseWriters.read_bind_spec'; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(230,4-230,19); use=BUGSLowParseWriters.fst(230,4-230,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x0
BUGSLowParseWriters.memory_invariant)
(HasType @x1
...
@x2
@x0)))
(HasType (BUGSLowParseWriters.read_bind_spec_ @x0
@x1
@x2
@x3
@x4)
...
:pattern ((BUGSLowParseWriters.read_bind_spec_ @x0
@x1
@x2
@x3
@x4))
:qid typing_BUGSLowParseWriters.read_bind_spec_))

:named typing_BUGSLowParseWriters.read_bind_spec_))
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: Name BUGSLowParseWriters.read_bind_spec'; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(232,3-233,11); use=BUGSLowParseWriters.fst(233,7-233,21)
...
:named non_total_function_typing_Non_total_Tm_arrow_281a845dd9a3f1cc8f42b2439dd51c9b))
;;;;;;;;;;;;;;;;Equation for BUGSLowParseWriters.read_bind_spec'
;;; Fact-ids: Name BUGSLowParseWriters.read_bind_spec'; Namespace BUGSLowParseWriters
(assert (! 
;; def=BUGSLowParseWriters.fst(230,4-230,19); use=BUGSLowParseWriters.fst(230,4-230,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (BUGSLowParseWriters.read_bind_spec_ @x0
@x1
@x2
@x3
@x4)
(let ((@lb5 (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.reify_read_spec@tok
@x1)
Prims.l_True)
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x1))
Tm_abs_077c0f895008f5d74804c404b01870e8)
...
@x3
@x4))
:qid equation_BUGSLowParseWriters.read_bind_spec_))

:named equation_BUGSLowParseWriters.read_bind_spec_))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name BUGSLowParseWriters.read_bind_spec'; Namespace BUGSLowParseWriters
(assert (! (Valid (ApplyTT __uu__PartialApp
BUGSLowParseWriters.reify_read_spec@tok))
...
; Starting query at BUGSLowParseWriters.fst(258,1-259,14)
...
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
BUGSLowParseWriters.read_bind_impl_@tok))
:named @kick_partial_app_0a9cbd73fcae2bc70e485b0fce6c90a7))
...
;     (forall (pure_result: Prims.unit).
;         BUGSLowParseWriters.reify_read_spec b
;           Prims.l_True
;           (fun _ -> Prims.l_True)
;           (fun _ -> Prims.l_False)
;           inv
;           (BUGSLowParseWriters.read_bind_impl' inv a b f g)
;           () ==
;         BUGSLowParseWriters.read_bind_spec' inv a b f g ==>
;         p pure_result) ==>
;     (forall (ghost_result: BUGSLowParseWriters.result b).
;         (match ghost_result with
;           | BUGSLowParseWriters.Correct _ -> Prims.l_True
...
; Context: While encoding a query
; While typechecking the top-level declaration `let read_bind_correct`
; While typechecking the top-level declaration `[@@expect_failure] let read_bind_correct`
...
;; def=Prims.fst(441,36-441,97); use=BUGSLowParseWriters.fst(258,1-259,14)
(forall ((@x6 Term))
 (! (implies (and (or label_1
(HasType @x6
Prims.unit))

;; def=BUGSLowParseWriters.fst(256,6-257,36); use=BUGSLowParseWriters.fst(258,1-259,14)
(or label_2
...
Tm_abs_077c0f895008f5d74804c404b01870e8)
@x0)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.read_bind_impl_@tok
@x0)
@x1)
@x2)
@x3)
...
;; def=Prims.fst(441,83-441,96); use=BUGSLowParseWriters.fst(258,1-259,14)
(Valid 
;; def=Prims.fst(441,83-441,96); use=BUGSLowParseWriters.fst(258,1-259,14)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(485,36-485,100); use=BUGSLowParseWriters.fst(258,1-259,14)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(BUGSLowParseWriters.result @x2))
(let ((@lb7 @x6))
(implies (not (is-BUGSLowParseWriters.Correct @lb7))
(ite (is-BUGSLowParseWriters.Error @lb7)

;; def=BUGSLowParseWriters.fst(196,29-196,34); use=BUGSLowParseWriters.fst(258,1-259,14)
false

Unreachable)))

;; def=BUGSLowParseWriters.fst(258,6-258,68); use=BUGSLowParseWriters.fst(258,6-258,68)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT BUGSLowParseWriters.reify_read_spec@tok
@x2)
Prims.l_True)
(Tm_abs_5e34897418ce4950a4effcc8c159cf53 @x2))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (BUGSLowParseWriters.read_bind_correct, 1)
