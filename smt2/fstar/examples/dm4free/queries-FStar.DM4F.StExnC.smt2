...
; Internals for FStar.DM4F.StExnC


; encoding sigelt let stexnc


; <Start encoding let stexnc>

(declare-fun FStar.DM4F.StExnC.stexnc (Term) Term)

(declare-fun FStar.DM4F.StExnC.stexnc@tok () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.M (FStar.Pervasives.Native.option a & (Prims.int & Prims.int))
(declare-fun Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931 (Term) Term)

; </end encoding let stexnc>


; encoding sigelt val FStar.DM4F.StExnC.return


; <Skipped val FStar.DM4F.StExnC.return/>
...
(declare-fun FStar.DM4F.StExnC.return (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> stexnc a
(declare-fun Tm_arrow_1fab9babf3a55fad07553f5cfc917796 () Term)
(declare-fun FStar.DM4F.StExnC.return@tok () Term)
(declare-fun Tm_abs_49bee813604500a8e22278df90bb77aa (Term Term) Term)

; </end encoding let return>


; encoding sigelt val FStar.DM4F.StExnC.bind


; <Skipped val FStar.DM4F.StExnC.bind/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.StExnC.stexnc; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(30,4-30,10); use=FStar.DM4F.StExnC.fst(30,4-30,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.StExnC.stexnc @x0)
Tm_type))
 

:pattern ((FStar.DM4F.StExnC.stexnc @x0))
:qid typing_FStar.DM4F.StExnC.stexnc))

:named typing_FStar.DM4F.StExnC.stexnc))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931
;;; Fact-ids: Name FStar.DM4F.StExnC.stexnc; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,2-31,35); use=FStar.DM4F.StExnC.fst(31,2-31,35)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931 @x0)
Tm_type))
:qid kinding_Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931))

:named kinding_Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.StExnC.stexnc
;;; Fact-ids: Name FStar.DM4F.StExnC.stexnc; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(30,4-30,10); use=FStar.DM4F.StExnC.fst(30,4-30,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.StExnC.stexnc @x0)
(Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931 @x0))
 

:pattern ((FStar.DM4F.StExnC.stexnc @x0))
:qid equation_FStar.DM4F.StExnC.stexnc))

:named equation_FStar.DM4F.StExnC.stexnc))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931 @x2)))
:qid FStar.DM4F.StExnC_pre_typing_Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931))

:named FStar.DM4F.StExnC_pre_typing_Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931
;;; Fact-ids: Name FStar.DM4F.StExnC.stexnc; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,2-31,35); use=FStar.DM4F.StExnC.fst(31,2-31,35)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931 @x1))
(and 
;; def=FStar.DM4F.StExnC.fst(31,2-31,35); use=FStar.DM4F.StExnC.fst(31,2-31,35)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931 @x1)))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931))

:named FStar.DM4F.StExnC_interpretation_Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931))
(push) ;; push{2

; Starting query at FStar.DM4F.StExnC.fst(40,11-45,47)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;f: a -> stexnc b
(declare-fun Tm_arrow_a717c8043a5ddce49235262372b3169a (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a717c8043a5ddce49235262372b3169a
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExnC.fst(38,35-39,10); use=FStar.DM4F.StExnC.fst(39,4-39,10)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_a717c8043a5ddce49235262372b3169a @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_a717c8043a5ddce49235262372b3169a @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_a717c8043a5ddce49235262372b3169a))

:named kinding_Tm_arrow_a717c8043a5ddce49235262372b3169a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExnC.fst(38,35-39,10); use=FStar.DM4F.StExnC.fst(39,4-39,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_a717c8043a5ddce49235262372b3169a @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_a717c8043a5ddce49235262372b3169a @x2
@x3)))
:qid FStar.DM4F.StExnC_pre_typing_Tm_arrow_a717c8043a5ddce49235262372b3169a))

:named FStar.DM4F.StExnC_pre_typing_Tm_arrow_a717c8043a5ddce49235262372b3169a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a717c8043a5ddce49235262372b3169a
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExnC.fst(38,35-39,10); use=FStar.DM4F.StExnC.fst(39,4-39,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_a717c8043a5ddce49235262372b3169a @x1
@x2))
(and 
;; def=FStar.DM4F.StExnC.fst(38,35-39,10); use=FStar.DM4F.StExnC.fst(39,4-39,10)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(FStar.DM4F.StExnC.stexnc @x1)))
 

:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_a717c8043a5ddce49235262372b3169a.1))
...
(Tm_arrow_a717c8043a5ddce49235262372b3169a @x1
@x2)))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_a717c8043a5ddce49235262372b3169a))

:named FStar.DM4F.StExnC_interpretation_Tm_arrow_a717c8043a5ddce49235262372b3169a))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (m: FStar.DM4F.StExnC.stexnc a)
;   (f: (f: a -> FStar.DM4F.StExnC.stexnc b))
;   (s0: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post (FStar.Pervasives.Native.option b & (Prims.int & Prims.int))).
;     (forall (x: FStar.Pervasives.Native.option b & (Prims.int & Prims.int)).
;         {:pattern Prims.guard_free (k x)}
;         Prims.auto_squash (k x)) ==>
;     ~(None? (m s0)._1) /\ ~(Some? (m s0)._1) ==> Prims.l_False
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.StExnC.fst(40,11-45,47)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExnC.fst(40,11-45,47)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExnC.fst(40,11-45,47)
(ApplyTT @x5
@x6)
...
;; def=FStar.DM4F.StExnC.fst(43,6-43,20); use=FStar.DM4F.StExnC.fst(43,6-43,20)
(not 
;; def=FStar.DM4F.StExnC.fst(43,6-43,20); use=FStar.DM4F.StExnC.fst(43,6-43,20)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x0
...
;; def=FStar.DM4F.StExnC.fst(44,6-44,22); use=FStar.DM4F.StExnC.fst(44,6-44,22)
(not 
;; def=FStar.DM4F.StExnC.fst(44,6-44,22); use=FStar.DM4F.StExnC.fst(44,6-44,22)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some @x0
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (FStar.Pervasives.Native.option @x0)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.StExnC.bind, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.StExnC_interpretation_Tm_arrow_8c94faa02b24d9a28aeef5eeea96d931, equation_FStar.DM4F.StExnC.stexnc, equation_Prims.eqtype, int_inversion, kinding_FStar.Pervasives.Native.option@tok, kinding_FStar.Pervasives.Native.tuple2@tok, lemma_FStar.Pervasives.invertOption, proj_equation_FStar.Pervasives.Native.Mktuple2__1, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.Pervasives.Native.__proj__Mktuple2__item___1, typing_Prims.int
...
;;;;;;;;;;;;;;;;f: a -> stexnc b
(declare-fun Tm_arrow_a717c8043a5ddce49235262372b3169a (Term Term) Term)
(declare-fun FStar.DM4F.StExnC.bind (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> m: stexnc a -> f: (f: a -> stexnc b) -> stexnc b
(declare-fun Tm_arrow_632fa22ddaf359ceacef4366e0faf11b () Term)
(declare-fun FStar.DM4F.StExnC.bind@tok () Term)

(declare-fun Tm_abs_6ff0aa3cc7c2fc4c4a4b26b7cecfdc00 (Term Term Term) Term)
...
(declare-fun FStar.DM4F.StExnC.raise (Term) Term)
;;;;;;;;;;;;;;;;a: Type -> stexnc a
(declare-fun Tm_arrow_e3b6c4687848f9f19e40c7fccde4aef3 () Term)
(declare-fun FStar.DM4F.StExnC.raise@tok () Term)
(declare-fun Tm_abs_b930d8614722094e625ea772ff902211 (Term) Term)

; </end encoding let raise>


; encoding sigelt let _dm4f_STEXNC_lift_from_pure


; <Start encoding let _dm4f_STEXNC_lift_from_pure>


;;;;;;;;;;;;;;;;_: (_: a -> Type) -> Type
(declare-fun Tm_arrow_11b93b1a25b26195b88e72dd87199600 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type
(declare-fun Tm_arrow_e63a87ac364d3cf4fc7f7941c7419f91 (Term) Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     s: Prims.int ->     p': (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_df03e94bde1d167170d85cc9305002ca () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_lift_from_pure@tok () Term)




(declare-fun Tm_abs_0c6550c65a4ece2095646e6badd50714 (Term Term Term) Term)

; </end encoding let _dm4f_STEXNC_lift_from_pure>


; encoding sigelt let _dm4f_STEXNC_return_wp


; <Start encoding let _dm4f_STEXNC_return_wp>


(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     x: a ->     s: Prims.int ->     p': (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_75a2b17059266c41f2adadd953db6e88 () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_return_wp@tok () Term)


; </end encoding let _dm4f_STEXNC_return_wp>


; encoding sigelt let _dm4f_STEXNC_return_elab


; <Start encoding let _dm4f_STEXNC_return_elab>

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_return_elab (Term Term Term) Term)
(declare-fun Tm_refine_47fa8235e81bd11c2478cf4a5d98e52f (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> s: Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option a & (Prims.int & Prims.int))
(declare-fun Tm_arrow_948220d63b08886e03a3b9aaa727f2e4 () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_return_elab@tok () Term)


; </end encoding let _dm4f_STEXNC_return_elab>


; encoding sigelt let _dm4f_STEXNC_bind_wp


; <Start encoding let _dm4f_STEXNC_bind_wp>


;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type) -> Type
(declare-fun Tm_arrow_2a917dabd7dea9b944a0e5b48f9ae791 (Term) Term)


;;;;;;;;;;;;;;;;f: a -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option b & (Prims.int & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_2330a170af96d2b8a743157e2043282b (Term Term) Term)

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     m:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type) ->     f:       (             f: a ->             _: Prims.int ->             _: (_: FStar.Pervasives.Native.option b & (Prims.int & Prims.int) -> Type)           -> Type) ->     s0: Prims.int ->     p'': (_: FStar.Pervasives.Native.option b & (Prims.int & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_832b75074b25b8a5e091540d325a4f06 () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_bind_wp@tok () Term)
...
(declare-fun Tm_abs_070b219f128964d72df6fc9baf14102b (Term Term Term) Term)

(declare-fun Tm_abs_def9ef520565188777b24e34d267bc3d (Term Term Term Term) Term)

; </end encoding let _dm4f_STEXNC_bind_wp>


; encoding sigelt let _dm4f_STEXNC_bind_elab


; <Start encoding let _dm4f_STEXNC_bind_elab>



(declare-fun Tm_refine_01ce842b776866406784cdbe59c3f398 (Term) Term)

;;;;;;;;;;;;;;;;y: _: (FStar.Pervasives.Native.option a & (Prims.int & Prims.int)){Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_351df79640465565381f9ec34a42db68 (Term) Term)
(declare-fun Tm_abs_53408fb36b9db1462d52f6b465432226 (Term Term) Term)
(declare-fun Tm_refine_3fa3512923b137c85eb820dc05593163 (Term Term Term) Term)



(declare-fun Tm_abs_5d1697062a6d8a28c8e6a7166554e907 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option a & (Prims.int & Prims.int))
(declare-fun Tm_arrow_9e7d6d2c1254ffaf282f7f0305a11760 (Term Term) Term)
...
(declare-fun Tm_refine_369f7445709870817ee06b0b49b458ae (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option b & (Prims.int & Prims.int))
(declare-fun Tm_arrow_aaa438e379f577dbec02d387ca65b300 (Term Term Term) Term)
;;;;;;;;;;;;;;;;f__x: a -> _: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option b & (Prims.int & Prims.int))
(declare-fun Tm_arrow_3ec6d9fa3e58465b5b93a5d6df72dd86 (Term Term Term) Term)

(declare-fun Tm_abs_44a6865d7351d8e7ab7eab4c88a56787 (Term) Term)

(declare-fun Tm_abs_e83ab7c6d20f734f7aa8cd628921e2e4 (Term Term Term) Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_bind_elab (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_8d1bd92ffef744915ea56360de1df804 (Term Term Term) Term)

(declare-fun Tm_abs_d869754a2c7b5c9b15172dad94a71ef1 (Term Term Term Term) Term)
(declare-fun Tm_refine_5384e5e135ce70e63c8af94effaa7578 (Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     m__w:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type) ->     m: (_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option a & (Prims.int & Prims.int))) ->     f__w:       (             f: a ->             _: Prims.int ->             _: (_: FStar.Pervasives.Native.option b & (Prims.int & Prims.int) -> Type)           -> Type) ->     f:       (f__x: a -> _: Prims.int           -> Prims.PURE (FStar.Pervasives.Native.option b & (Prims.int & Prims.int))) ->     s0: Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option b & (Prims.int & Prims.int))
(declare-fun Tm_arrow_6f4c275ba9b0fa2d15ae5ee4774445db () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_bind_elab@tok () Term)
...
; </end encoding let _dm4f_STEXNC_bind_elab>


; encoding sigelt let _dm4f_STEXNC___proj__STEXNC__item__raise_elab


; <Start encoding let _dm4f_STEXNC___proj__STEXNC__item__raise_elab>

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab (Term) Term)
(declare-fun Tm_refine_ac04978f639ccfe81a204101926a8ce3 (Term Term) Term)
;;;;;;;;;;;;;;;;s0__x: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option a & (Prims.int & Prims.int))
(declare-fun Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7 (Term) Term)
;;;;;;;;;;;;;;;;a: Type -> s0__x: Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option a & (Prims.int & Prims.int))
(declare-fun Tm_arrow_f47e58d8bbe545761659b63829ab7a82 () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab@tok () Term)




; </end encoding let _dm4f_STEXNC___proj__STEXNC__item__raise_elab>


; encoding sigelt let _dm4f_STEXNC___proj__STEXNC__item__raise_complete_type


; <Start encoding let _dm4f_STEXNC___proj__STEXNC__item__raise_complete_type>

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_complete_type () Term)




; </end encoding let _dm4f_STEXNC___proj__STEXNC__item__raise_complete_type>


; encoding sigelt let _dm4f_STEXNC_repr


; <Start encoding let _dm4f_STEXNC_repr>



(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp_a:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type)   -> Type
(declare-fun Tm_arrow_6bdc507786b8b56b3fc2bf1948c376c5 () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_repr@tok () Term)
...
; </end encoding let _dm4f_STEXNC_repr>


; encoding sigelt let _dm4f_STEXNC_pre


; <Start encoding let _dm4f_STEXNC_pre>

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_pre () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Type
(declare-fun Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2 () Term)

; </end encoding let _dm4f_STEXNC_pre>


; encoding sigelt let _dm4f_STEXNC_post


; <Start encoding let _dm4f_STEXNC_post>

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_post (Term) Term)

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_post@tok () Term)


; </end encoding let _dm4f_STEXNC_post>


; encoding sigelt let _dm4f_STEXNC_wp


; <Start encoding let _dm4f_STEXNC_wp>

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_wp (Term) Term)

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_wp@tok () Term)



; </end encoding let _dm4f_STEXNC_wp>


; encoding sigelt let _dm4f_STEXNC_ctx


; <Start encoding let _dm4f_STEXNC_ctx>

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_ctx (Term Term) Term)

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type) -> t
(declare-fun Tm_arrow_907ba7232475e450bfbdae57bbb4b408 (Term Term) Term)

; </end encoding let _dm4f_STEXNC_ctx>


; encoding sigelt let _dm4f_STEXNC_gctx


; <Start encoding let _dm4f_STEXNC_gctx>

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_gctx (Term Term) Term)

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.GTot t
(declare-fun Tm_ghost_arrow_43d8ca6970cc520c7c424b915476c47b (Term Term) Term)

; </end encoding let _dm4f_STEXNC_gctx>


; encoding sigelt let _dm4f_STEXNC_pure


; <Start encoding let _dm4f_STEXNC_pure>


(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> t
(declare-fun Tm_arrow_9eda3d004f9e46c293bd874f7149fd5a () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_pure@tok () Term)


; </end encoding let _dm4f_STEXNC_pure>


; encoding sigelt let _dm4f_STEXNC_app


; <Start encoding let _dm4f_STEXNC_app>



;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_a772e0a814365598ee924ca92394956f (Term Term Term) Term)



(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Prims.GTot t1) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_b61dfa53af04a494ae381ffa3c6d914d () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_app@tok () Term)
...
; </end encoding let _dm4f_STEXNC_app>


; encoding sigelt let _dm4f_STEXNC_lift1


; <Start encoding let _dm4f_STEXNC_lift1>




(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Prims.GTot t1) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_5cd679499768c0615f275efab94c22b4 () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_lift1@tok () Term)
...
(declare-fun Tm_abs_a6580fae9d1465c8ccaa40a683360fe1 (Term Term Term Term) Term)

; </end encoding let _dm4f_STEXNC_lift1>


; encoding sigelt let _dm4f_STEXNC_lift2


; <Start encoding let _dm4f_STEXNC_lift2>
...
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Prims.GTot t1) ->     a2:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Prims.GTot t2) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_fd28785bb84a4b5ca580614f9432614e () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_lift2@tok () Term)
...
(declare-fun Tm_abs_5e96ce509421a45703ccd1a5921b0d9e (Term Term Term Term Term) Term)

; </end encoding let _dm4f_STEXNC_lift2>


; encoding sigelt let _dm4f_STEXNC_push


; <Start encoding let _dm4f_STEXNC_push>



;;;;;;;;;;;;;;;;_: t1 -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_645b01be66bc7a3bfee5af195e2d83e9 (Term Term Term) Term)

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f:       (             _: t1 ->             _: Prims.int ->             _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Prims.GTot t2) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_ec61effed9bfb4914537aaae50f0ba41 () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_push@tok () Term)





; </end encoding let _dm4f_STEXNC_push>


; encoding sigelt let _dm4f_STEXNC_wp_if_then_else


; <Start encoding let _dm4f_STEXNC_wp_if_then_else>

(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type) ->     _:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_5cb89b0b4fb85cf352abd39010fa3b28 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type) ->     _:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_2af9f74d09099338663e2c21855ef5a4 () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_85b2a0e634244d5b8586444df000f3f0 (Term) Term)
...
;;;;;;;;;;;;;;;;a1:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Prims.GTot Prims.logical) ->     a2:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Prims.GTot Prims.logical) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_13f5c2ea4f4c2dd89d01bca30f01f022 (Term) Term)
(declare-fun Tm_abs_ed79bb165cbc56216e3305e6fe1b94d7 (Term Term) Term)

; </end encoding let _dm4f_STEXNC_wp_if_then_else>


; encoding sigelt let _dm4f_STEXNC_wp_close


; <Start encoding let _dm4f_STEXNC_wp_close>




(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f:       (             _: b ->             _: Prims.int ->             _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_7d8247f7c60c186564634a8e7ca3f85f () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_wp_close@tok () Term)
...
(declare-fun Tm_abs_afeb670d41d84c38560ff5b8aadbcf31 (Term Term Term) Term)

; </end encoding let _dm4f_STEXNC_wp_close>


; encoding sigelt let _dm4f_STEXNC_stronger


; <Start encoding let _dm4f_STEXNC_stronger>





(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type) ->     wp2:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_b3a6887520fb1f94af0907e424111a47 () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_stronger@tok () Term)
...
; </end encoding let _dm4f_STEXNC_stronger>


; encoding sigelt let _dm4f_STEXNC_ite_wp


; <Start encoding let _dm4f_STEXNC_ite_wp>




(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_1374f316518734f7703cc9401d808b02 () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_ite_wp@tok () Term)





; </end encoding let _dm4f_STEXNC_ite_wp>


; encoding sigelt let _dm4f_STEXNC_null_wp


; <Start encoding let _dm4f_STEXNC_null_wp>


(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_2d3d986e11cdd7bd7f359e9d1354d67e () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_null_wp@tok () Term)


; </end encoding let _dm4f_STEXNC_null_wp>


; encoding sigelt let _dm4f_STEXNC_wp_trivial


; <Start encoding let _dm4f_STEXNC_wp_trivial>



(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_0ec8e2435e05216dd172b5eb44a58f2d () Term)
(declare-fun FStar.DM4F.StExnC._dm4f_STEXNC_wp_trivial@tok () Term)




; </end encoding let _dm4f_STEXNC_wp_trivial>


; encoding sigelt new_effect_for_free { STEXNC ... }


; <Start encoding new_effect_for_free { STEXNC ... }>





(declare-fun Tm_abs_75e397dfef2feec85571dea964ccc7a1 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.StExnC.__proj__STEXNC__item__raise (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.StExnC.__proj__STEXNC__item__raise@tok () Term)

; </end encoding new_effect_for_free { STEXNC ... }>


; encoding sigelt sub_effect PURE ~> STEXNC


; <Skipped sub_effect PURE ~> STEXNC/>


; encoding sigelt let lift_pure_stexnc


; <Start encoding let lift_pure_stexnc>


(declare-fun FStar.DM4F.StExnC.lift_pure_stexnc (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     wp: Prims.pure_wp a ->     h0: Prims.int ->     p: (_: FStar.Pervasives.Native.option a & (Prims.int & Prims.int) -> Type)   -> Prims.pure_pre
(declare-fun Tm_arrow_94d68468e8a1b727a551f161dcf87de5 () Term)
(declare-fun FStar.DM4F.StExnC.lift_pure_stexnc@tok () Term)




; </end encoding let lift_pure_stexnc>
...
; encoding sigelt effect StExnC a req ens = FStar.DM4F.StExnC.STEXNC a


; <Skipped effect StExnC a req ens = FStar.DM4F.StExnC.STEXNC a/>


; encoding sigelt effect SC a = FStar.DM4F.StExnC.STEXNC a


; <Skipped effect SC a = FStar.DM4F.StExnC.STEXNC a/>
...
; Starting query at FStar.DM4F.StExnC.fst(89,0-93,77)
...
;   (j: Prims.int)
;   (h0: Prims.int)
;   (x: FStar.Pervasives.Native.option Prims.int)
;   (h1: Prims.int)
;   (c: Prims.int).
;   (*  - Could not prove post-condition
; *)
...
;     (~(None? x) ==>
;       (forall (b: Prims.int).
;           x == FStar.Pervasives.Native.Some b ==> h0 = h1 /\ c = 0 /\ j <> 0 ==> j <> 0))


; Context: While encoding a query
; While typechecking the top-level declaration `val FStar.DM4F.StExnC.div_intrinsic`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=FStar.DM4F.StExnC.fst(89,0-93,77)
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Prims.pure_post Tm_type))

;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(forall ((@x7 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(ApplyTT @x6
@x7)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(and (implies 
;; def=FStar.DM4F.StExnC.fst(91,19-91,20); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(and 
;; def=FStar.DM4F.StExnC.fst(91,19-91,20); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(not 
;; def=FStar.DM4F.StExnC.fst(91,19-91,20); use=FStar.DM4F.StExnC.fst(89,22-89,48)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(not 
;; def=FStar.DM4F.StExnC.fst(91,19-91,20); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None Prims.int
@x3))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.int)

;; def=FStar.DM4F.StExnC.fst(91,19-93,32); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(= @x3
(FStar.Pervasives.Native.Some Prims.int
@x7))


;; def=FStar.DM4F.StExnC.fst(93,36-93,43); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(= @x2
@x4)


;; def=FStar.DM4F.StExnC.fst(93,47-93,52); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(= @x5
(BoxInt 0))


;; def=FStar.DM4F.StExnC.fst(93,56-93,62); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(not (= @x1
(BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExnC.fst(93,74-93,75)
(or label_2

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExnC.fst(89,22-89,48)
(not (= @x1
(BoxInt 0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.StExnC.div_intrinsic, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, lemma_FStar.Pervasives.invertOption, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
; encoding sigelt val FStar.DM4F.StExnC.div_intrinsic


; <Skipped val FStar.DM4F.StExnC.div_intrinsic/>
...
; Starting query at FStar.DM4F.StExnC.fst(95,2-96,12)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int) -> Type
(declare-fun Tm_arrow_3631bce3f35111ff646835e8d859caa3 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3631bce3f35111ff646835e8d859caa3
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3631bce3f35111ff646835e8d859caa3
Tm_type)
:named kinding_Tm_arrow_3631bce3f35111ff646835e8d859caa3))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,11-31,35); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3631bce3f35111ff646835e8d859caa3)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_3631bce3f35111ff646835e8d859caa3))
:qid FStar.DM4F.StExnC_pre_typing_Tm_arrow_3631bce3f35111ff646835e8d859caa3))

:named FStar.DM4F.StExnC_pre_typing_Tm_arrow_3631bce3f35111ff646835e8d859caa3))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3631bce3f35111ff646835e8d859caa3
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,11-31,35); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_3631bce3f35111ff646835e8d859caa3.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_3631bce3f35111ff646835e8d859caa3))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_3631bce3f35111ff646835e8d859caa3))

:named FStar.DM4F.StExnC_interpretation_Tm_arrow_3631bce3f35111ff646835e8d859caa3))

; Encoding query formula : forall (i: Prims.nat) (j: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.int)
;     (p: Prims.pure_post (FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int))).
;     (forall (r: FStar.Pervasives.Native.option Prims.int) (h1: Prims.int) (c: Prims.int).
;         (match r with
;           | FStar.Pervasives.Native.None  -> _ = h1 /\ c = 1 /\ j = 0
;           | FStar.Pervasives.Native.Some z -> _ = h1 /\ c = 0 /\ j <> 0 /\ z = i / j) ==>
;         p (r, (h1, c))) ==>
;     (forall (k: (_: FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int) -> Type0)).
;         (forall (a1: FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int)).
;             {:pattern Prims.guard_free (k a1)}
;             k a1 <==> p a1) ==>
;         (j = 0 = true ==> j = 0 == true ==> k (FStar.Pervasives.Native.None, (_, 1))) /\
;         (~(j = 0 = true) ==>
;           (forall (b: Prims.bool).
;               j = 0 == b ==>
;               j <> 0 /\
...
;                           k (FStar.Pervasives.Native.Some return_val, (_, 0))))))))
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.StExnC.fst(95,2-96,12)
...
;; def=FStar.DM4F.StExnC.fst(74,13-75,62); use=FStar.DM4F.StExnC.fst(95,2-96,12)
...
;; def=FStar.DM4F.StExnC.fst(92,34-92,59); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(and 
;; def=FStar.DM4F.StExnC.fst(92,34-92,41); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(= @x2
@x5)


;; def=FStar.DM4F.StExnC.fst(92,45-92,50); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(= @x6
(BoxInt 1))


;; def=FStar.DM4F.StExnC.fst(92,54-92,59); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(= @x1
(BoxInt 0))
)
...
;; def=FStar.DM4F.StExnC.fst(93,36-93,75); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(and 
;; def=FStar.DM4F.StExnC.fst(93,36-93,43); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(= @x2
@x5)


;; def=FStar.DM4F.StExnC.fst(93,47-93,52); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(= @x6
(BoxInt 0))


;; def=FStar.DM4F.StExnC.fst(93,56-93,62); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(not (= @x1
(BoxInt 0)))


;; def=FStar.DM4F.StExnC.fst(93,66-93,75); use=FStar.DM4F.StExnC.fst(95,2-96,12)
...
;; def=FStar.DM4F.StExnC.fst(75,47-75,61); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(Valid 
;; def=FStar.DM4F.StExnC.fst(75,47-75,61); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(ApplyTT @x3
...
;; def=Prims.fst(221,62-221,85); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(and (implies 
;; def=Prims.fst(221,62-221,71); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(and 
;; def=FStar.DM4F.StExnC.fst(95,5-95,10); use=FStar.DM4F.StExnC.fst(95,5-95,10)
...
;; def=FStar.DM4F.StExnC.fst(45,30-45,47); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(or label_1
...
(implies 
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(not 
;; def=FStar.DM4F.StExnC.fst(95,5-95,10); use=FStar.DM4F.StExnC.fst(95,5-95,10)
(= (Prims.op_Equality Prims.int
@x1
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=FStar.DM4F.StExnC.fst(95,5-96,12); use=FStar.DM4F.StExnC.fst(95,5-96,12)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
@x5)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(and 
;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExnC.fst(96,11-96,12)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.int)
...
;; def=FStar.DM4F.StExnC.fst(89,45-96,12); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(= @x7
(Prims.op_Division @x0
@x1))
)

;; def=Prims.fst(356,2-356,58); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.int)

;; def=Prims.fst(356,26-356,41); use=FStar.DM4F.StExnC.fst(95,2-96,12)
(= @x8
@x7)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.StExnC.div_intrinsic, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, data_typing_intro_FStar.Pervasives.Native.None@tok, data_typing_intro_FStar.Pervasives.Native.Some@tok, equation_Prims.eqtype, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.None_a, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
(declare-fun FStar.DM4F.StExnC.div_intrinsic (Term Term) Term)
(declare-fun Non_total_Tm_arrow_d166981c5ad437abc294205f10e17746 () Term)
(declare-fun FStar.DM4F.StExnC.div_intrinsic@tok () Term)
(declare-fun Tm_refine_a4c8b97a2eab719862b9f88d4ac3973c (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int))
(declare-fun Tm_arrow_9a80de8bdfb114fe86ea07304d374dd3 (Term Term) Term)
(declare-fun Tm_abs_2da6c5d88c680daaa46407a57543835d (Term Term) Term)

; </end encoding let div_intrinsic>

(push) ;; push{2

; Starting query at FStar.DM4F.StExnC.fst(99,2-100,12)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,11-31,35); use=FStar.DM4F.StExnC.fst(99,2-100,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3631bce3f35111ff646835e8d859caa3)
...
;   forall (_: Prims.int)
;     (p: Prims.pure_post (FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int))).
;     (forall (x: FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int)). p x) ==>
;     (forall (k: (_: FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int) -> Type0)).
;         (forall (a1: FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int)).
;             {:pattern Prims.guard_free (k a1)}
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.StExnC.fst(99,2-100,12)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.int)
(HasType @x3
...
;; def=FStar.DM4F.StExnC.fst(79,29-79,42); use=FStar.DM4F.StExnC.fst(99,2-100,12)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
...
;; def=FStar.DM4F.StExnC.fst(79,39-79,42); use=FStar.DM4F.StExnC.fst(99,2-100,12)
(Valid 
;; def=FStar.DM4F.StExnC.fst(79,39-79,42); use=FStar.DM4F.StExnC.fst(99,2-100,12)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.StExnC.fst(99,2-100,12)
(not 
;; def=FStar.DM4F.StExnC.fst(99,5-99,10); use=FStar.DM4F.StExnC.fst(99,5-99,10)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
(BoxBool true))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.StExnC.fst(99,2-100,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=FStar.DM4F.StExnC.fst(99,5-100,12); use=FStar.DM4F.StExnC.fst(99,5-100,12)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
@x5)
...
;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExnC.fst(100,11-100,12)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.StExnC.div_extrinsic, 1)
; STATUS: unsat
...
(declare-fun FStar.DM4F.StExnC.div_extrinsic (Term Term) Term)
(declare-fun Non_total_Tm_arrow_a1203eeae4370ed83521693b2f582f8f () Term)
(declare-fun FStar.DM4F.StExnC.div_extrinsic@tok () Term)
(declare-fun Tm_refine_74afcf3b86e718852d1bbc84a44bf929 () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int))
(declare-fun Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9 () Term)


; </end encoding let div_extrinsic>

;;;;;;;;;;;;;;;;typing_Tm_abs_75e397dfef2feec85571dea964ccc7a1
;;; Fact-ids: Name FStar.DM4F.StExnC.STEXNC; Namespace FStar.DM4F.StExnC
(assert (! (HasType Tm_abs_75e397dfef2feec85571dea964ccc7a1
Tm_arrow_f47e58d8bbe545761659b63829ab7a82)
:named typing_Tm_abs_75e397dfef2feec85571dea964ccc7a1))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.StExnC.div_extrinsic; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(98,5-98,18); use=FStar.DM4F.StExnC.fst(98,5-98,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
Prims.int))
(HasType (FStar.DM4F.StExnC.div_extrinsic @x0
@x1)
Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9))
 

:pattern ((FStar.DM4F.StExnC.div_extrinsic @x0
@x1))
:qid typing_FStar.DM4F.StExnC.div_extrinsic))

:named typing_FStar.DM4F.StExnC.div_extrinsic))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_2da6c5d88c680daaa46407a57543835d
;;; Fact-ids: Name FStar.DM4F.StExnC.div_intrinsic; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(35,26-35,40); use=FStar.DM4F.StExnC.fst(35,26-35,40)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (Tm_abs_2da6c5d88c680daaa46407a57543835d @x0
@x1))
 

:pattern ((Tm_abs_2da6c5d88c680daaa46407a57543835d @x0
@x1))
:qid tot_fun_Tm_abs_2da6c5d88c680daaa46407a57543835d))

:named tot_fun_Tm_abs_2da6c5d88c680daaa46407a57543835d))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.StExnC.fst(47,43-47,56)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_ac04978f639ccfe81a204101926a8ce3 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_ac04978f639ccfe81a204101926a8ce3 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_ac04978f639ccfe81a204101926a8ce3))

:named refinement_kinding_Tm_refine_ac04978f639ccfe81a204101926a8ce3))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.StExnC.div_extrinsic; Namespace FStar.DM4F.StExnC
(assert (! (HasType Tm_refine_74afcf3b86e718852d1bbc84a44bf929
Tm_type)
:named refinement_kinding_Tm_refine_74afcf3b86e718852d1bbc84a44bf929))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.StExnC.fst(47,43-47,56)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ac04978f639ccfe81a204101926a8ce3 @x2
@x3))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.StExnC.fst(47,43-47,56)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.StExnC.fst(47,43-47,56)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.StExnC.fst(47,43-47,56)
...
(Tm_refine_ac04978f639ccfe81a204101926a8ce3 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_ac04978f639ccfe81a204101926a8ce3))

:named refinement_interpretation_Tm_refine_ac04978f639ccfe81a204101926a8ce3))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.StExnC.div_extrinsic; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,11-31,35); use=FStar.DM4F.StExnC.fst(31,11-31,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_74afcf3b86e718852d1bbc84a44bf929)
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.StExnC.fst(31,11-31,35)
(not 
;; def=FStar.DM4F.StExnC.fst(79,29-79,42); use=FStar.DM4F.StExnC.fst(98,37-98,39)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
...
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.StExnC.fst(31,11-31,35)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.StExnC.fst(31,11-31,35)
(= @x2
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_74afcf3b86e718852d1bbc84a44bf929.1))
)
))
...
@x1
Tm_refine_74afcf3b86e718852d1bbc84a44bf929))
:qid refinement_interpretation_Tm_refine_74afcf3b86e718852d1bbc84a44bf929))

:named refinement_interpretation_Tm_refine_74afcf3b86e718852d1bbc84a44bf929))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name FStar.Pervasives.Native.__proj__Mktuple2__item___2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,43-59,45); use=FStar.Pervasives.Native.fst(59,43-59,45)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f47e58d8bbe545761659b63829ab7a82
;;; Fact-ids: Name FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab; Namespace FStar.DM4F.StExnC
(assert (! (HasType Tm_arrow_f47e58d8bbe545761659b63829ab7a82
Tm_type)
:named kinding_Tm_arrow_f47e58d8bbe545761659b63829ab7a82))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9
;;; Fact-ids: Name FStar.DM4F.StExnC.div_extrinsic; Namespace FStar.DM4F.StExnC
(assert (! (HasType Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9
Tm_type)
:named kinding_Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7
;;; Fact-ids: Name FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,2-31,5); use=FStar.DM4F.StExnC.fst(31,2-47,56)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7 @x0)
Tm_type))
:qid kinding_Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7))

:named kinding_Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_b930d8614722094e625ea772ff902211
;;; Fact-ids: Name FStar.DM4F.StExnC.raise; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(47,42-47,57); use=FStar.DM4F.StExnC.fst(47,42-47,57)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_b930d8614722094e625ea772ff902211 @x1)
@x0)
...
:pattern ((ApplyTT (Tm_abs_b930d8614722094e625ea772ff902211 @x1)
@x0))
:qid interpretation_Tm_abs_b930d8614722094e625ea772ff902211))

:named interpretation_Tm_abs_b930d8614722094e625ea772ff902211))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_75e397dfef2feec85571dea964ccc7a1
;;; Fact-ids: Name FStar.DM4F.StExnC.STEXNC; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(47,42-47,57); use=FStar.DM4F.StExnC.fst(47,42-47,57)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_75e397dfef2feec85571dea964ccc7a1
@x0)
(Tm_abs_b930d8614722094e625ea772ff902211 @x0))
 

:pattern ((ApplyTT Tm_abs_75e397dfef2feec85571dea964ccc7a1
@x0))
:qid interpretation_Tm_abs_75e397dfef2feec85571dea964ccc7a1))

:named interpretation_Tm_abs_75e397dfef2feec85571dea964ccc7a1))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2da6c5d88c680daaa46407a57543835d
;;; Fact-ids: Name FStar.DM4F.StExnC.div_intrinsic; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(35,26-35,40); use=FStar.DM4F.StExnC.fst(35,26-35,40)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_2da6c5d88c680daaa46407a57543835d @x1
@x2)
@x0)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
...
:pattern ((ApplyTT (Tm_abs_2da6c5d88c680daaa46407a57543835d @x1
@x2)
@x0))
:qid interpretation_Tm_abs_2da6c5d88c680daaa46407a57543835d))

:named interpretation_Tm_abs_2da6c5d88c680daaa46407a57543835d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ac04978f639ccfe81a204101926a8ce3
;;; Fact-ids: Name FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.StExnC.fst(47,43-47,56)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ac04978f639ccfe81a204101926a8ce3 @x0
@x1)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_ac04978f639ccfe81a204101926a8ce3 @x0
@x1))))
:qid haseqTm_refine_ac04978f639ccfe81a204101926a8ce3))

:named haseqTm_refine_ac04978f639ccfe81a204101926a8ce3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_74afcf3b86e718852d1bbc84a44bf929
;;; Fact-ids: Name FStar.DM4F.StExnC.div_extrinsic; Namespace FStar.DM4F.StExnC
(assert (! (iff (Valid (Prims.hasEq Tm_refine_74afcf3b86e718852d1bbc84a44bf929))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))))
:named haseqTm_refine_74afcf3b86e718852d1bbc84a44bf929))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.StExnC.div_extrinsic
;;; Fact-ids: Name FStar.DM4F.StExnC.div_extrinsic; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(98,5-98,18); use=FStar.DM4F.StExnC.fst(98,5-98,18)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.StExnC.div_extrinsic @x0
@x1)
...
(ite (= @lb2
(BoxBool true))
(FStar.DM4F.StExnC.__proj__STEXNC__item__raise Prims.int)
(Tm_abs_2da6c5d88c680daaa46407a57543835d @x1
@x0))))
 

:pattern ((FStar.DM4F.StExnC.div_extrinsic @x0
@x1))
:qid equation_FStar.DM4F.StExnC.div_extrinsic))

:named equation_FStar.DM4F.StExnC.div_extrinsic))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,2-47,17); use=FStar.DM4F.StExnC.fst(31,2-47,56)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f47e58d8bbe545761659b63829ab7a82)
...
@x1
Tm_arrow_f47e58d8bbe545761659b63829ab7a82))
:qid FStar.DM4F.StExnC_pre_typing_Tm_arrow_f47e58d8bbe545761659b63829ab7a82))

:named FStar.DM4F.StExnC_pre_typing_Tm_arrow_f47e58d8bbe545761659b63829ab7a82))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.StExnC.div_extrinsic; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,2-31,35); use=FStar.DM4F.StExnC.fst(31,2-31,35)
...
@x1
Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9))
:qid FStar.DM4F.StExnC_pre_typing_Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9))

:named FStar.DM4F.StExnC_pre_typing_Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,2-31,5); use=FStar.DM4F.StExnC.fst(31,2-47,56)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7 @x2)))
:qid FStar.DM4F.StExnC_pre_typing_Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7))

:named FStar.DM4F.StExnC_pre_typing_Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f47e58d8bbe545761659b63829ab7a82
;;; Fact-ids: Name FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,2-47,17); use=FStar.DM4F.StExnC.fst(31,2-47,56)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_f47e58d8bbe545761659b63829ab7a82.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_f47e58d8bbe545761659b63829ab7a82))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_f47e58d8bbe545761659b63829ab7a82))

:named FStar.DM4F.StExnC_interpretation_Tm_arrow_f47e58d8bbe545761659b63829ab7a82))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9
;;; Fact-ids: Name FStar.DM4F.StExnC.div_extrinsic; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,2-31,35); use=FStar.DM4F.StExnC.fst(31,2-31,35)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9))

:named FStar.DM4F.StExnC_interpretation_Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7
;;; Fact-ids: Name FStar.DM4F.StExnC._dm4f_STEXNC___proj__STEXNC__item__raise_elab; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(31,2-31,5); use=FStar.DM4F.StExnC.fst(31,2-47,56)
(forall ((@x0 Term) (@x1 Term))
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_ac04978f639ccfe81a204101926a8ce3 @x1
@x2)))
 

:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7 @x1)))
:qid FStar.DM4F.StExnC_interpretation_Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7))

:named FStar.DM4F.StExnC_interpretation_Tm_arrow_9cc33ce85ef52fb17af1100724fe8ac7))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.StExnC.STEXNC; Namespace FStar.DM4F.StExnC
(assert (! 
;; def=FStar.DM4F.StExnC.fst(58,7-58,12); use=FStar.DM4F.StExnC.fst(58,7-58,12)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.StExnC.__proj__STEXNC__item__raise @x0)
(ApplyTT Tm_abs_75e397dfef2feec85571dea964ccc7a1
@x0))
 

:pattern ((FStar.DM4F.StExnC.__proj__STEXNC__item__raise @x0))
:qid FStar.DM4F.StExnC.__proj__STEXNC__item__raise_equality))

:named FStar.DM4F.StExnC.__proj__STEXNC__item__raise_equality))
(push) ;; push{2

; Starting query at FStar.DM4F.StExnC.fst(105,64-105,66)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExnC.fst(103,2-105,61); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;       (*  - Could not prove post-condition
; *)
;       forall (x: FStar.Pervasives.Native.option Prims.int & (Prims.int & Prims.int)).
;         reify (FStar.DM4F.StExnC.div_extrinsic i j) h0 == x ==>
;         (forall (k: Prims.pure_post Type0).
;             (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;             (~(None? (reify (FStar.DM4F.StExnC.div_extrinsic i j) h0)._1 &&
;                 (reify (FStar.DM4F.StExnC.div_extrinsic i j) h0)._2._2 = 1) /\
;               ~(Some? (reify (FStar.DM4F.StExnC.div_extrinsic i j) h0)._1 &&
;                 (reify (FStar.DM4F.StExnC.div_extrinsic i j) h0)._2._2 = 0) ==>
;               Prims.l_False) /\
;             (~(None? (reify (FStar.DM4F.StExnC.div_extrinsic i j) h0)._1 &&
;                 (reify (FStar.DM4F.StExnC.div_extrinsic i j) h0)._2._2 = 1) ==>
;               (forall (b: Prims.int) (b: Prims.int).
;                   reify (FStar.DM4F.StExnC.div_extrinsic i j) h0 ==
...
;           (match reify (FStar.DM4F.StExnC.div_extrinsic i j) h0 with
;             | FStar.Pervasives.Native.None , (h1, 1) -> h1 = h0 /\ j = 0
;             | FStar.Pervasives.Native.Some z, (h1, 0) -> h1 = h0 /\ j <> 0 /\ z = i / j) ==>
;           p pure_result) ==>
...
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)

;; def=FStar.DM4F.StExnC.fst(79,29-79,42); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
...
;; def=FStar.DM4F.StExnC.fst(103,15-103,43); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(= (ApplyTT (FStar.DM4F.StExnC.div_extrinsic @x0
@x1)
@x2)
@x4)
)
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(and (implies 
;; def=FStar.DM4F.StExnC.fst(104,11-105,26); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(and 
;; def=FStar.DM4F.StExnC.fst(104,11-104,24); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(not 
;; def=FStar.DM4F.StExnC.fst(104,11-104,24); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(and (BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None Prims.int
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (FStar.Pervasives.Native.option Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(ApplyTT (FStar.DM4F.StExnC.div_extrinsic @x0
@x1)
...
Prims.int
(FStar.Pervasives.Native.__proj__Mktuple2__item___2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(ApplyTT (FStar.DM4F.StExnC.div_extrinsic @x0
@x1)
...
;; def=FStar.DM4F.StExnC.fst(105,11-105,26); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(not 
;; def=FStar.DM4F.StExnC.fst(105,11-105,26); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(and (BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some Prims.int
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (FStar.Pervasives.Native.option Prims.int)
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(ApplyTT (FStar.DM4F.StExnC.div_extrinsic @x0
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(not 
;; def=FStar.DM4F.StExnC.fst(104,11-104,24); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(and (BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None Prims.int
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (FStar.Pervasives.Native.option Prims.int)
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)
...
;; def=FStar.DM4F.StExnC.fst(103,15-105,26); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(= (ApplyTT (FStar.DM4F.StExnC.div_extrinsic @x0
@x1)
@x2)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.int)
...
;; def=FStar.DM4F.StExnC.fst(105,30-105,37); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(= @x7
@x2)


;; def=FStar.DM4F.StExnC.fst(105,41-105,47); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(not (= @x1
(BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExnC.fst(105,59-105,60)
(or label_2

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(not (= @x1
(BoxInt 0)))
)
)
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(forall ((@x4 Term))
 (! (implies (and (or label_3
(HasType @x4
Prims.unit))
(let ((@lb5 (ApplyTT (FStar.DM4F.StExnC.div_extrinsic @x0
@x1)
@x2)))
(ite (and (is-FStar.Pervasives.Native.None (FStar.Pervasives.Native.Mktuple2__1 @lb5))
(= (FStar.Pervasives.Native.Mktuple2__2 (FStar.Pervasives.Native.Mktuple2__2 @lb5))
(BoxInt 1)))

;; def=FStar.DM4F.StExnC.fst(104,28-104,44); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(and 
;; def=FStar.DM4F.StExnC.fst(104,28-104,35); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(or label_4

;; def=FStar.DM4F.StExnC.fst(104,28-104,35); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(= (FStar.Pervasives.Native.Mktuple2__1 (FStar.Pervasives.Native.Mktuple2__2 @lb5))
@x2)
)


;; def=FStar.DM4F.StExnC.fst(104,39-104,44); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(or label_5
...
(ite (and (is-FStar.Pervasives.Native.Some (FStar.Pervasives.Native.Mktuple2__1 @lb5))
(= (FStar.Pervasives.Native.Mktuple2__2 (FStar.Pervasives.Native.Mktuple2__2 @lb5))
(BoxInt 0)))

;; def=FStar.DM4F.StExnC.fst(105,30-105,60); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(and 
;; def=FStar.DM4F.StExnC.fst(105,30-105,37); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(or label_6
...
;; def=FStar.DM4F.StExnC.fst(105,51-105,60); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(or label_8

;; def=FStar.DM4F.StExnC.fst(105,51-105,60); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(= (FStar.Pervasives.Native.Some_v (FStar.Pervasives.Native.Mktuple2__1 @lb5))
(Prims.op_Division @x0
@x1))
)
)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.StExnC.fst(105,64-105,66)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.StExnC.lemma_div_extrinsic, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.StExnC.__proj__STEXNC__item__raise_equality, FStar.DM4F.StExnC_interpretation_Tm_arrow_ddb41050dee43710c77444e5ab9bb1b9, Prims_pretyping_ae567c2fb75be05905677af440075565, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.None, disc_equation_FStar.Pervasives.Native.Some, equation_FStar.DM4F.StExnC.div_extrinsic, equation_Prims.eqtype, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, int_inversion, interpretation_Tm_abs_2da6c5d88c680daaa46407a57543835d, interpretation_Tm_abs_75e397dfef2feec85571dea964ccc7a1, interpretation_Tm_abs_b930d8614722094e625ea772ff902211, kinding_FStar.Pervasives.Native.option@tok, kinding_FStar.Pervasives.Native.tuple2@tok, lemma_FStar.Pervasives.invertOption, primitive_Prims.op_Equality, proj_equation_FStar.Pervasives.Native.Mktuple2__1, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_74afcf3b86e718852d1bbc84a44bf929, typing_FStar.DM4F.StExnC.div_extrinsic, typing_FStar.Pervasives.Native.__proj__Mktuple2__item___1, typing_Prims.int
