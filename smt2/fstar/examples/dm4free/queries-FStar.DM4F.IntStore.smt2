...
; Internals for FStar.DM4F.IntStore
...
(declare-fun FStar.DM4F.IntStore.id () Term)
...
(declare-fun FStar.DM4F.IntStore.heap () Term)

; </end encoding let heap>


; encoding sigelt let in_


; <Start encoding let in_>

(declare-fun FStar.DM4F.IntStore.in_ (Term Term) Term)
;;;;;;;;;;;;;;;;x: id -> store: heap -> Prims.bool
(declare-fun Tm_arrow_88c23109c57090c0aaeef76178904819 () Term)
(declare-fun FStar.DM4F.IntStore.in_@tok () Term)

; </end encoding let in_>


; encoding sigelt let int_store


; <Start encoding let int_store>

(declare-fun FStar.DM4F.IntStore.int_store (Term) Term)

(declare-fun FStar.DM4F.IntStore.int_store@tok () Term)
;;;;;;;;;;;;;;;;_: heap -> Prims.M (FStar.Pervasives.Native.option a & heap)
(declare-fun Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591 (Term) Term)
...
(declare-fun FStar.DM4F.IntStore.return_is (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> int_store a
(declare-fun Tm_arrow_6b811bd52673976b81d9965a16ecf6c9 () Term)
(declare-fun FStar.DM4F.IntStore.return_is@tok () Term)
(declare-fun Tm_abs_1eebc973a408848ff309d9c0dbd72493 (Term Term) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IntStore.int_store; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,5-27,14); use=FStar.DM4F.IntStore.fst(27,5-27,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.IntStore.int_store @x0)
Tm_type))
 

:pattern ((FStar.DM4F.IntStore.int_store @x0))
:qid typing_FStar.DM4F.IntStore.int_store))

:named typing_FStar.DM4F.IntStore.int_store))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IntStore.heap; Namespace FStar.DM4F.IntStore
(assert (! (HasType FStar.DM4F.IntStore.heap
Tm_type)
:named typing_FStar.DM4F.IntStore.heap))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591
;;; Fact-ids: Name FStar.DM4F.IntStore.int_store; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,26-27,53); use=FStar.DM4F.IntStore.fst(27,26-27,53)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591 @x0)
Tm_type))
:qid kinding_Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591))

:named kinding_Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591))
...
(assert (! (HasType FStar.DM4F.IntStore.heap
Tm_type)
:named function_token_typing_FStar.DM4F.IntStore.heap))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntStore.int_store
;;; Fact-ids: Name FStar.DM4F.IntStore.int_store; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,5-27,14); use=FStar.DM4F.IntStore.fst(27,5-27,14)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.IntStore.int_store @x0)
(Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591 @x0))
 

:pattern ((FStar.DM4F.IntStore.int_store @x0))
:qid equation_FStar.DM4F.IntStore.int_store))

:named equation_FStar.DM4F.IntStore.int_store))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntStore.heap
;;; Fact-ids: Name FStar.DM4F.IntStore.heap; Namespace FStar.DM4F.IntStore
(assert (! (= FStar.DM4F.IntStore.heap
(FStar.Seq.Base.seq Prims.int))
:named equation_FStar.DM4F.IntStore.heap))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591 @x2)))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591
;;; Fact-ids: Name FStar.DM4F.IntStore.int_store; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,26-27,53); use=FStar.DM4F.IntStore.fst(27,26-27,53)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591 @x1))
(and 
;; def=FStar.DM4F.IntStore.fst(27,26-27,53); use=FStar.DM4F.IntStore.fst(27,26-27,53)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591 @x1)))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_9bc44a0c7fd53f4bbd45580baba3e591))
(push) ;; push{2

; Starting query at FStar.DM4F.IntStore.fst(30,2-34,28)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> int_store b
(declare-fun Tm_arrow_cf3389761bb3731f423bb0764bd6b769 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_cf3389761bb3731f423bb0764bd6b769
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStore.fst(29,13-29,61); use=FStar.DM4F.IntStore.fst(29,45-29,61)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_cf3389761bb3731f423bb0764bd6b769 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_cf3389761bb3731f423bb0764bd6b769 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_cf3389761bb3731f423bb0764bd6b769))

:named kinding_Tm_arrow_cf3389761bb3731f423bb0764bd6b769))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStore.fst(29,13-29,61); use=FStar.DM4F.IntStore.fst(29,45-29,61)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_cf3389761bb3731f423bb0764bd6b769 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_cf3389761bb3731f423bb0764bd6b769 @x2
@x3)))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_cf3389761bb3731f423bb0764bd6b769))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_cf3389761bb3731f423bb0764bd6b769))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_cf3389761bb3731f423bb0764bd6b769
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStore.fst(29,13-29,61); use=FStar.DM4F.IntStore.fst(29,45-29,61)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_cf3389761bb3731f423bb0764bd6b769 @x1
@x2))
(and 
;; def=FStar.DM4F.IntStore.fst(29,13-29,61); use=FStar.DM4F.IntStore.fst(29,45-29,61)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(FStar.DM4F.IntStore.int_store @x1)))
 

:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_cf3389761bb3731f423bb0764bd6b769.1))
...
(Tm_arrow_cf3389761bb3731f423bb0764bd6b769 @x1
@x2)))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_cf3389761bb3731f423bb0764bd6b769))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_cf3389761bb3731f423bb0764bd6b769))
...
; *)
;   forall (store: FStar.DM4F.IntStore.heap).
;     (*  - Could not prove post-condition
; *)
;     forall (b: FStar.Pervasives.Native.option a) (b: FStar.DM4F.IntStore.heap).
;       x store == (b, b) ==>
;       (forall (k: Prims.pure_post (FStar.Pervasives.Native.option b & FStar.DM4F.IntStore.heap)).
;           (forall (x: FStar.Pervasives.Native.option b & FStar.DM4F.IntStore.heap).
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(30,2-34,28)
(forall ((@x4 Term))
 (! (implies (HasType @x4
FStar.DM4F.IntStore.heap)

;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.IntStore.fst(30,14-34,28)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(FStar.Pervasives.Native.option @x0))
...
;; def=FStar.DM4F.IntStore.fst(31,7-31,16); use=FStar.DM4F.IntStore.fst(31,7-31,16)
(= (ApplyTT @x2
@x4)
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.IntStore.fst(30,14-34,28)
(forall ((@x8 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.IntStore.fst(30,14-34,28)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.IntStore.fst(30,14-34,28)
(ApplyTT @x7
@x8)
...
;; def=FStar.DM4F.IntStore.fst(31,7-31,8); use=FStar.DM4F.IntStore.fst(32,10-32,11)
(not 
;; def=FStar.DM4F.IntStore.fst(31,7-31,8); use=FStar.DM4F.IntStore.fst(32,10-32,11)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x0
@x5))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStore.bind_is, 1)
; STATUS: unsat
...
;;;;;;;;;;;;;;;;_: a -> int_store b
(declare-fun Tm_arrow_cf3389761bb3731f423bb0764bd6b769 (Term Term) Term)
(declare-fun FStar.DM4F.IntStore.bind_is (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> x: int_store a -> f: (_: a -> int_store b) -> int_store b
(declare-fun Tm_arrow_44ff71fe3d7dc0c7d86e5a50f558cbbd () Term)
(declare-fun FStar.DM4F.IntStore.bind_is@tok () Term)

(declare-fun Tm_abs_3ef44cd4a684aea06e253cca909669e1 (Term Term Term) Term)
...
(declare-fun FStar.DM4F.IntStore.get (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> int_store heap
(declare-fun Tm_arrow_2439d2655df3ca6da46836e920b6e0f6 () Term)
(declare-fun FStar.DM4F.IntStore.get@tok () Term)
(declare-fun Tm_abs_cde4de9909fefdf0d7c6082b82123522 () Term)
...
(declare-fun FStar.DM4F.IntStore.put (Term) Term)
;;;;;;;;;;;;;;;;s: heap -> int_store Prims.unit
(declare-fun Tm_arrow_149fe192d406e3f058aef567d276a6fd () Term)
(declare-fun FStar.DM4F.IntStore.put@tok () Term)
(declare-fun Tm_abs_9f9779cfa65a646a9dc440fc8d441829 (Term) Term)
...
(declare-fun FStar.DM4F.IntStore.raise_impl (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> int_store Prims.l_False
(declare-fun Tm_arrow_c35adfb245a2be72315e184da83c6fa8 () Term)
(declare-fun FStar.DM4F.IntStore.raise_impl@tok () Term)
(declare-fun Tm_abs_0d62a2fc0d511256bd677c990e74861f () Term)

; </end encoding let raise_impl>


; encoding sigelt let _dm4f_INT_STORE_lift_from_pure
...
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type
(declare-fun Tm_arrow_66632374962b397192bcb0ef0c17b257 (Term) Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     store: FStar.Seq.Base.seq Prims.int ->     p': (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_4f697c164b64a6637d260841e64095ca () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_lift_from_pure@tok () Term)




(declare-fun Tm_abs_1da1cb2c75068a255d1ded51ead6e977 (Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_lift_from_pure>


; encoding sigelt let _dm4f_INT_STORE_return_wp


; <Start encoding let _dm4f_INT_STORE_return_wp>


(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     x: a ->     store: FStar.Seq.Base.seq Prims.int ->     p': (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_35184300277f2fb6a83d6b1ce22e1987 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_return_wp@tok () Term)


; </end encoding let _dm4f_INT_STORE_return_wp>


; encoding sigelt let _dm4f_INT_STORE_return_elab


; <Start encoding let _dm4f_INT_STORE_return_elab>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_return_elab (Term Term) Term)
(declare-fun Tm_refine_e6a63db1553a4796885816ad17741f9f (Term Term Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_de8a3b3ac61a5c89752616c7317a65b4 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> store__x: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_fc110c024a334350aa16c838dbb70b07 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_return_elab@tok () Term)


(declare-fun Tm_abs_d0edd4b6f3c56dccaf23e81d88d8647f (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_return_elab>


; encoding sigelt let _dm4f_INT_STORE_bind_wp


; <Start encoding let _dm4f_INT_STORE_bind_wp>


;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_ba660ac937a098cbc502268a1d036756 (Term) Term)


;;;;;;;;;;;;;;;;_: a ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option b & FStar.Seq.Base.seq Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_c1a1fe47c126a0e29661c7867e361269 (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option b & heap -> Type
(declare-fun Tm_arrow_04742f171aff802bfcf52df0dceacbb6 (Term) Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     x:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     f:       (             _: a ->             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option b & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     store: FStar.Seq.Base.seq Prims.int ->     p'': (_: FStar.Pervasives.Native.option b & heap -> Type)   -> Type
(declare-fun Tm_arrow_3d0278255753cb6de35d56fd5566fd2b () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_bind_wp@tok () Term)
...
(declare-fun Tm_abs_866444e6d560fce2b3f6bc594c1a9974 (Term Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_bind_wp>


; encoding sigelt let _dm4f_INT_STORE_bind_elab
...
(declare-fun Tm_refine_adfbca1500fe0e5b2fbb2847ee67072a (Term) Term)

;;;;;;;;;;;;;;;;y: _: (FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int){Prims.l_True}   -> Prims.GTot Type
(declare-fun Tm_arrow_0e9e92593f1dfc6ede0f9332a9bf81d3 (Term) Term)
(declare-fun Tm_abs_02a282a84edfbfe690e9f1664557dcac (Term Term) Term)
(declare-fun Tm_refine_3e5b748fa30f5c31251065468657ba42 (Term Term Term) Term)



(declare-fun Tm_abs_642959a05d810946aaf42380be8987fd (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_23a86a35708067015125a83de77b416f (Term Term) Term)
...
(declare-fun Tm_refine_22978cea7e8ce5360c3fb5af343a7b53 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_934f07d4cd7df7e68d087e8371d04ed6 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_784596498dc537d12a59df90a83c8d6c (Term Term Term) Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_bind_elab (Term Term Term Term Term Term) Term)
...
(declare-fun Tm_refine_09cab60a64281f90a2420770515e869e (Term) Term)

;;;;;;;;;;;;;;;;y: _: (FStar.Pervasives.Native.option b & heap){Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_867692d589b9529d87075ea0907b7470 (Term) Term)
(declare-fun Tm_abs_39c39e21a49d9c32e2fdc803103427b0 (Term Term) Term)

(declare-fun Tm_abs_a4f902dd2137f83d8fd990ac39289dc7 (Term Term Term Term) Term)
(declare-fun Tm_refine_42efe516762a5a0798170c73a00c0b09 (Term Term Term Term Term) Term)



(declare-fun Tm_abs_3a285aaa17a9bdc1e4727079588acf37 (Term) Term)

(declare-fun Tm_abs_a2dddf0693b1f46f075b0c58bbc019c4 (Term Term Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.Seq.Base.seq Prims.int -> Prims.PURE (FStar.Pervasives.Native.option b & heap)
(declare-fun Tm_arrow_71f73fe61f068da347ea0476c89ae729 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     x__w:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     x:       (_: FStar.Seq.Base.seq Prims.int           -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int)) ->     f__w:       (             _: a ->             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option b & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     f:       (_: a -> _: FStar.Seq.Base.seq Prims.int           -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.Seq.Base.seq Prims.int)) ->     store__x: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option b & heap)
(declare-fun Tm_arrow_99a6262217a9011e84b976bc71579bb8 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_bind_elab@tok () Term)
...
(declare-fun Tm_abs_f1d62c174da03479326789714bd94b62 (Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_bind_elab>


; encoding sigelt let _dm4f_INT_STORE___proj__INT_STORE__item__get_elab


; <Start encoding let _dm4f_INT_STORE___proj__INT_STORE__item__get_elab>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab (Term) Term)
(declare-fun Tm_refine_ca466071266e2aadf6d8eb9897e98c71 (Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.Seq.Base.seq Prims.int   -> Prims.PURE     (FStar.Pervasives.Native.option (FStar.Seq.Base.seq Prims.int) & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_c3307adc258f4aba231d1b68d86b37f8 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> store__x: FStar.Seq.Base.seq Prims.int   -> Prims.PURE     (FStar.Pervasives.Native.option (FStar.Seq.Base.seq Prims.int) & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_6631ab9b65954887db06c7b94c61a3a8 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab@tok () Term)


(declare-fun Tm_abs_c180a1a093bf4028a15844b815442d7b () Term)

; </end encoding let _dm4f_INT_STORE___proj__INT_STORE__item__get_elab>


; encoding sigelt let _dm4f_INT_STORE___proj__INT_STORE__item__get_complete_type


; <Start encoding let _dm4f_INT_STORE___proj__INT_STORE__item__get_complete_type>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_complete_type () Term)
...
; encoding sigelt let _dm4f_INT_STORE___proj__INT_STORE__item__put_elab


; <Start encoding let _dm4f_INT_STORE___proj__INT_STORE__item__put_elab>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab (Term) Term)
(declare-fun Tm_refine_6a15a366328605071729f52393506055 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option Prims.unit & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_784383d546d77cb9f0247221b8010213 (Term) Term)
;;;;;;;;;;;;;;;;s: FStar.Seq.Base.seq Prims.int -> _: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option Prims.unit & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_77616552377b2c06579f52084c6e869b () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab@tok () Term)


(declare-fun Tm_abs_05a67f9fe771d5ede528047b14da96c1 (Term) Term)

; </end encoding let _dm4f_INT_STORE___proj__INT_STORE__item__put_elab>


; encoding sigelt let _dm4f_INT_STORE___proj__INT_STORE__item__put_complete_type


; <Start encoding let _dm4f_INT_STORE___proj__INT_STORE__item__put_complete_type>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_complete_type () Term)
...
; encoding sigelt let _dm4f_INT_STORE___proj__INT_STORE__item__raise__elab


; <Start encoding let _dm4f_INT_STORE___proj__INT_STORE__item__raise__elab>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__raise__elab (Term) Term)
(declare-fun Tm_refine_07f3a2d0605e39cca21db161065eb958 (Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option Prims.l_False & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_4b16031df08cf9d6527f6ca968ec581e () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> store__x: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option Prims.l_False & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_e7dc5e82a3839daa6078444b86f3c98d () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__raise__elab@tok () Term)


(declare-fun Tm_abs_e862696349b09559610bf40e797f80c1 () Term)

; </end encoding let _dm4f_INT_STORE___proj__INT_STORE__item__raise__elab>


; encoding sigelt let _dm4f_INT_STORE___proj__INT_STORE__item__raise__complete_type


; <Start encoding let _dm4f_INT_STORE___proj__INT_STORE__item__raise__complete_type>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__raise__complete_type () Term)




; </end encoding let _dm4f_INT_STORE___proj__INT_STORE__item__raise__complete_type>


; encoding sigelt let _dm4f_INT_STORE_repr
...
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp_a:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type)   -> Type
(declare-fun Tm_arrow_901f168620e7d4780926cdf902279102 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_repr@tok () Term)
...
; encoding sigelt let _dm4f_INT_STORE_pre


; <Start encoding let _dm4f_INT_STORE_pre>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_pre () Term)
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int -> Type
(declare-fun Tm_arrow_22cd0a0d3f288b7e58b207c9c47bc04c () Term)

; </end encoding let _dm4f_INT_STORE_pre>


; encoding sigelt let _dm4f_INT_STORE_post


; <Start encoding let _dm4f_INT_STORE_post>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_post (Term) Term)

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_post@tok () Term)


; </end encoding let _dm4f_INT_STORE_post>


; encoding sigelt let _dm4f_INT_STORE_wp


; <Start encoding let _dm4f_INT_STORE_wp>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_wp (Term) Term)

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_wp@tok () Term)
...
; encoding sigelt let _dm4f_INT_STORE_ctx


; <Start encoding let _dm4f_INT_STORE_ctx>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_ctx (Term Term) Term)

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> t
(declare-fun Tm_arrow_efc352b9d00e7b73e9e19a923cd5114e (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_ctx>


; encoding sigelt let _dm4f_INT_STORE_gctx


; <Start encoding let _dm4f_INT_STORE_gctx>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_gctx (Term Term) Term)

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.GTot t
(declare-fun Tm_ghost_arrow_56378a213468a1332cd9ff9ace0c518a (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_gctx>


; encoding sigelt let _dm4f_INT_STORE_pure


; <Start encoding let _dm4f_INT_STORE_pure>


(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> t
(declare-fun Tm_arrow_bf372eda8c1bd16b603c1ec63bc8c543 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_pure@tok () Term)


; </end encoding let _dm4f_INT_STORE_pure>


; encoding sigelt let _dm4f_INT_STORE_app
...
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_66c08b30a843e358736afb2a9c9accec (Term Term Term) Term)



(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Prims.GTot t1) ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_ef57a18947149cecde77764493242b12 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_app@tok () Term)
...
; encoding sigelt let _dm4f_INT_STORE_lift1
...
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Prims.GTot t1) ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_7fcbb0ee42f9f6d5488d871ae79f4012 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_lift1@tok () Term)
...
(declare-fun Tm_abs_8efa0812d4fad809e7ed0df8fb14f4a2 (Term Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_lift1>


; encoding sigelt let _dm4f_INT_STORE_lift2
...
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Prims.GTot t1) ->     a2:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Prims.GTot t2) ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_47321235356c9a0890e22586000998fa () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_lift2@tok () Term)
...
(declare-fun Tm_abs_69d2fcf1364cee55e448655ca4cf2b83 (Term Term Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_lift2>


; encoding sigelt let _dm4f_INT_STORE_push
...
;;;;;;;;;;;;;;;;_: t1 ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_2d0dbaf018d5e76dccbdc7da6f457d8a (Term Term Term) Term)

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f:       (             _: t1 ->             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Prims.GTot t2) ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_a1975dc1b24895db7ec73306c9e19a9e () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_push@tok () Term)
...
; encoding sigelt let _dm4f_INT_STORE_wp_if_then_else


; <Start encoding let _dm4f_INT_STORE_wp_if_then_else>

(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     _:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_327857cf2cc47af2a9f9fec0d407ddd4 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     _:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_62cc13fa5e7e9bb087c9adfc41f9db5a () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_4af36bbb509be1bbef637d4d6cec0e06 (Term) Term)
...
;;;;;;;;;;;;;;;;a1:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Prims.GTot Prims.logical) ->     a2:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Prims.GTot Prims.logical) ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_e0644e40a7450db231a14abe5b44c3f1 (Term) Term)
(declare-fun Tm_abs_f58e801ea1642123f36c15df3159b6a3 (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_wp_if_then_else>


; encoding sigelt let _dm4f_INT_STORE_wp_close
...
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f:       (             _: b ->             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_3e15ae10fcce05d7121bd21695d6df20 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_wp_close@tok () Term)
...
(declare-fun Tm_abs_b4677d1c3d09b2b44ca6b14575708c80 (Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_wp_close>


; encoding sigelt let _dm4f_INT_STORE_stronger
...
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     wp2:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_420e8486a001bd05ee62786cd3b046d0 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_stronger@tok () Term)
...
; encoding sigelt let _dm4f_INT_STORE_ite_wp
...
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type) ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.logical
(declare-fun Tm_arrow_b3d422f4b89fe8f41df977a9fbe0db64 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_ite_wp@tok () Term)
...
; encoding sigelt let _dm4f_INT_STORE_null_wp


; <Start encoding let _dm4f_INT_STORE_null_wp>


(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     _: FStar.Seq.Base.seq Prims.int ->     _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)   -> Prims.logical
(declare-fun Tm_arrow_5748b7aa4652fb6aa1cc991a6dca094b () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_null_wp@tok () Term)


; </end encoding let _dm4f_INT_STORE_null_wp>


; encoding sigelt let _dm4f_INT_STORE_wp_trivial
...
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp:       (             _: FStar.Seq.Base.seq Prims.int ->             _: (_: FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_0fecb663dd23869b08da0d67558c8853 () Term)
(declare-fun FStar.DM4F.IntStore._dm4f_INT_STORE_wp_trivial@tok () Term)
...
; encoding sigelt new_effect_for_free { INT_STORE ... }
...
(declare-fun Tm_abs_e663c8e63232c34d4af141ab8f8e901c () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntStore.__proj__INT_STORE__item__get (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntStore.__proj__INT_STORE__item__get@tok () Term)




(declare-fun Tm_abs_2e660715db1749600edbac843098eb9a () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntStore.__proj__INT_STORE__item__put (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntStore.__proj__INT_STORE__item__put@tok () Term)
(declare-fun Tm_refine_72b607c315ccd653b2c38d69f398c7cb () Term)

(declare-fun Tm_abs_0915464e74e833c74cced327d3f5d2e3 () Term)



(declare-fun Tm_refine_3fa55d8c2198a573078badd6c832e738 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int   -> Prims.PURE     (FStar.Pervasives.Native.option (x: Prims.unit{Prims.empty}) & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_bdb21571abec49dcb10bc11e45eff190 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.DM4F.IntStore._dm4f_INT_STORE_repr (x: Prims.unit{Prims.empty})       (fun store__x p' -> p' (FStar.Pervasives.Native.None, store__x))
(declare-fun Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37 () Term)
(declare-fun Tm_abs_928b19931d487bf450765aab83c9a4be () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntStore.__proj__INT_STORE__item__raise_ (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntStore.__proj__INT_STORE__item__raise_@tok () Term)

; </end encoding new_effect_for_free { INT_STORE ... }>


; encoding sigelt sub_effect PURE ~> INT_STORE


; <Skipped sub_effect PURE ~> INT_STORE/>


; encoding sigelt effect IntStore a pre post = FStar.DM4F.IntStore.INT_STORE a


; <Skipped effect IntStore a pre post = FStar.DM4F.IntStore.INT_STORE a/>


; encoding sigelt effect IS a = FStar.DM4F.IntStore.INT_STORE a


; <Skipped effect IS a = FStar.DM4F.IntStore.INT_STORE a/>
...
; Starting query at FStar.DM4F.IntStore.fst(64,1-64,56)
...
;   (*  - Could not prove post-condition
; *)
;   forall (_: FStar.Seq.Base.seq Prims.int)
;     (p: Prims.pure_post (FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int)).
;     (forall (x: FStar.Pervasives.Native.option a) (l1: FStar.Seq.Base.seq Prims.int).
;         _ == l1 /\ None? x ==> p (x, l1)) ==>
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(64,1-64,56)
...
;; def=FStar.DM4F.IntStore.fst(54,37-54,88); use=FStar.DM4F.IntStore.fst(64,1-64,56)
...
;; def=FStar.DM4F.IntStore.fst(63,47-63,55); use=FStar.DM4F.IntStore.fst(64,1-64,56)
(= @x2
@x5)


;; def=FStar.DM4F.IntStore.fst(63,59-63,66); use=FStar.DM4F.IntStore.fst(64,1-64,56)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x0
@x4))
)

;; def=FStar.DM4F.IntStore.fst(54,78-54,87); use=FStar.DM4F.IntStore.fst(64,1-64,56)
(Valid 
;; def=FStar.DM4F.IntStore.fst(54,78-54,87); use=FStar.DM4F.IntStore.fst(64,1-64,56)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option @x0)
...
;; def=FStar.DM4F.IntStore.fst(33,14-33,26); use=FStar.DM4F.IntStore.fst(64,1-64,56)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStore.raise_, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_FStar.Pervasives.Native.None, data_typing_intro_FStar.Pervasives.Native.None@tok, disc_equation_FStar.Pervasives.Native.None, equation_FStar.DM4F.IntStore.heap, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.None_a
...
(declare-fun FStar.DM4F.IntStore.raise_ (Term Term) Term)
(declare-fun Non_total_Tm_arrow_bc037d37425fad0ac77e52d2afad3976 () Term)
(declare-fun FStar.DM4F.IntStore.raise_@tok () Term)
(declare-fun Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74 (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_3f89d153145cfe940ec3181ebb675fdd (Term) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IntStore.in_; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(24,4-24,7); use=FStar.DM4F.IntStore.fst(24,4-24,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
FStar.DM4F.IntStore.id)
(HasType @x1
FStar.DM4F.IntStore.heap))
(HasType (FStar.DM4F.IntStore.in_ @x0
@x1)
Prims.bool))
 

:pattern ((FStar.DM4F.IntStore.in_ @x0
@x1))
:qid typing_FStar.DM4F.IntStore.in_))

:named typing_FStar.DM4F.IntStore.in_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IntStore.id; Namespace FStar.DM4F.IntStore
(assert (! (HasType FStar.DM4F.IntStore.id
Tm_type)
:named typing_FStar.DM4F.IntStore.id))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Seq.Base.index; Namespace FStar.Seq.Base
(assert (! 
...
(assert (! (HasType FStar.DM4F.IntStore.id
Tm_type)
:named function_token_typing_FStar.DM4F.IntStore.id))
;;;;;;;;;;;;;;;;Equation for Prims.nat
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! (= Prims.nat
Tm_refine_542f9d4f129664613f2483a6c88bc7c2)
:named equation_Prims.nat))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntStore.in_
;;; Fact-ids: Name FStar.DM4F.IntStore.in_; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(24,4-24,7); use=FStar.DM4F.IntStore.fst(24,4-24,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.IntStore.in_ @x0
@x1)
(Prims.op_LessThan @x0
...
:pattern ((FStar.DM4F.IntStore.in_ @x0
@x1))
:qid equation_FStar.DM4F.IntStore.in_))

:named equation_FStar.DM4F.IntStore.in_))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntStore.id
;;; Fact-ids: Name FStar.DM4F.IntStore.id; Namespace FStar.DM4F.IntStore
(assert (! (= FStar.DM4F.IntStore.id
Prims.nat)
:named equation_FStar.DM4F.IntStore.id))
(push) ;; push{2

; Starting query at FStar.DM4F.IntStore.fst(76,1-80,16)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option Prims.int & FStar.Seq.Base.seq Prims.int -> Type
(declare-fun Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f
Tm_type)
:named kinding_Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(forall ((@x0 Term))
...
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Seq.Base.seq Prims.int)))
(HasType (ApplyTT @x0
@x1)
Tm_type))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f))


; Encoding query formula : forall (i: FStar.DM4F.IntStore.id).
;   (forall (s: FStar.Seq.Base.seq Prims.int)
;       (p: (_: FStar.Pervasives.Native.option Prims.int & FStar.Seq.Base.seq Prims.int -> Type0)).
;       (*  - Could not prove post-condition
; *)
;       forall (k: Prims.pure_post Type0).
;         (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;         FStar.DM4F.IntStore.in_ i s == true ==> i < FStar.Seq.Base.length s) /\
;   (forall (_: FStar.Seq.Base.seq Prims.int)
;       (p: Prims.pure_post (FStar.Pervasives.Native.option Prims.int & FStar.Seq.Base.seq Prims.int))
;     .
;       (match FStar.DM4F.IntStore.in_ i _ with
;         | true -> p (FStar.Pervasives.Native.Some (FStar.Seq.Base.index _ i), _)
;         | _ -> p (FStar.Pervasives.Native.None, _)) ==>
;       (forall (k:
;           (_: FStar.Pervasives.Native.option Prims.int & FStar.Seq.Base.seq Prims.int -> Type0)).
;           (forall (a1: FStar.Pervasives.Native.option Prims.int & FStar.Seq.Base.seq Prims.int).
;               {:pattern Prims.guard_free (k a1)}
;               k a1 <==> p a1) ==>
;           (FStar.DM4F.IntStore.in_ i _ = true ==>
;             FStar.DM4F.IntStore.in_ i _ == true ==>
;             i < FStar.Seq.Base.length _ /\
;             (forall (any_result: FStar.DM4F.IntStore.id).
;                 i == any_result ==>
;                 (forall (any_result: Prims.int).
;                     any_result == FStar.Seq.Base.index _ i ==>
;                     (forall (return_val: Prims.int).
;                         return_val == any_result ==> k (FStar.Pervasives.Native.Some return_val, _))
;                 ))) /\
;           (~(FStar.DM4F.IntStore.in_ i _ = true) ==>
;             (forall (e1: Prims.bool).
;                 FStar.DM4F.IntStore.in_ i _ == e1 ==>
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(76,1-80,16)
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(forall ((@x4 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(ApplyTT @x3
@x4)
...
;; def=FStar.DM4F.IntStore.fst(73,9-73,18); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(= (FStar.DM4F.IntStore.in_ @x0
@x1)
(BoxBool true))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.IntStore.fst(74,28-74,29)
(or label_1

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(< (BoxInt_proj_0 @x0)
...
(FStar.Seq.Base.seq Prims.int))
(HasType @x2
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Seq.Base.seq Prims.int))))
(let ((@lb3 (FStar.DM4F.IntStore.in_ @x0
@x1)))
(ite (= @lb3
(BoxBool true))

;; def=FStar.DM4F.IntStore.fst(74,11-74,34); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(Valid 
;; def=FStar.DM4F.IntStore.fst(74,11-74,34); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Seq.Base.seq Prims.int)
...
;; def=FStar.DM4F.IntStore.fst(75,11-75,22); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(Valid 
;; def=FStar.DM4F.IntStore.fst(75,11-75,22); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.int)
...
;; def=Prims.fst(221,62-221,85); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(and (implies 
;; def=Prims.fst(221,62-221,71); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(and 
;; def=FStar.DM4F.IntStore.fst(78,5-78,18); use=FStar.DM4F.IntStore.fst(78,5-78,18)
(= (FStar.DM4F.IntStore.in_ @x0
@x1)
(BoxBool true))
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.IntStore.fst(79,19-79,20)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
FStar.DM4F.IntStore.id)

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(= @x0
@x4)
)
...
;; def=FStar.DM4F.IntStore.fst(71,14-79,20); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(= @x5
(FStar.Seq.Base.index Prims.int
@x1
@x0))
...
;; def=Prims.fst(356,2-356,58); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.int)

;; def=Prims.fst(356,26-356,41); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(= @x6
@x5)
)

;; def=FStar.DM4F.IntStore.fst(28,58-28,71); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(or label_3
...
(implies 
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.IntStore.fst(76,1-80,16)
(not 
;; def=FStar.DM4F.IntStore.fst(78,5-78,18); use=FStar.DM4F.IntStore.fst(78,5-78,18)
(= (FStar.DM4F.IntStore.in_ @x0
@x1)
...
;; def=FStar.DM4F.IntStore.fst(78,5-80,16); use=FStar.DM4F.IntStore.fst(78,5-80,16)
(= (FStar.DM4F.IntStore.in_ @x0
@x1)
@x4)
)

;; def=FStar.DM4F.IntStore.fst(54,37-54,88); use=FStar.DM4F.IntStore.fst(80,7-80,13)
...
;; def=FStar.DM4F.IntStore.fst(63,47-63,55); use=FStar.DM4F.IntStore.fst(80,7-80,13)
(= @x1
@x6)


;; def=FStar.DM4F.IntStore.fst(63,59-63,66); use=FStar.DM4F.IntStore.fst(80,7-80,13)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None Prims.int
@x5))
)

;; def=FStar.DM4F.IntStore.fst(54,78-54,87); use=FStar.DM4F.IntStore.fst(80,7-80,13)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStore.read, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, disc_equation_FStar.Pervasives.Native.None, equation_FStar.DM4F.IntStore.id, equation_FStar.DM4F.IntStore.in_, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.option, function_token_typing_Prims.__cache_version_number__, int_inversion, primitive_Prims.op_LessThan, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
...
(declare-fun FStar.DM4F.IntStore.read (Term) Term)
(declare-fun Non_total_Tm_arrow_348f73bd2c971dd797878d9f52550ac9 () Term)
(declare-fun FStar.DM4F.IntStore.read@tok () Term)
(declare-fun Tm_refine_23a9f4081dd9caf90ad448b496b3081f (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option Prims.int & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45 (Term) Term)
(declare-fun Tm_abs_e31b9cc181ef985fb9d787b42b923e08 (Term Term) Term)
...
; Starting query at FStar.DM4F.IntStore.fst(89,1-93,16)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option Prims.unit & FStar.Seq.Base.seq Prims.int -> Type
(declare-fun Tm_arrow_57698f0e840a52dbee04a90c760277c4 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_57698f0e840a52dbee04a90c760277c4
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_57698f0e840a52dbee04a90c760277c4
Tm_type)
:named kinding_Tm_arrow_57698f0e840a52dbee04a90c760277c4))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_57698f0e840a52dbee04a90c760277c4)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_57698f0e840a52dbee04a90c760277c4))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_57698f0e840a52dbee04a90c760277c4))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_57698f0e840a52dbee04a90c760277c4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_57698f0e840a52dbee04a90c760277c4
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(forall ((@x0 Term))
...
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.Seq.Base.seq Prims.int)))
(HasType (ApplyTT @x0
@x1)
Tm_type))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_57698f0e840a52dbee04a90c760277c4.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_57698f0e840a52dbee04a90c760277c4))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_57698f0e840a52dbee04a90c760277c4))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_57698f0e840a52dbee04a90c760277c4))


; Encoding query formula : forall (i: FStar.DM4F.IntStore.id) (x: Prims.int).
;   (forall (s: FStar.Seq.Base.seq Prims.int)
;       (p: (_: FStar.Pervasives.Native.option Prims.unit & FStar.Seq.Base.seq Prims.int -> Type0)).
;       (*  - Could not prove post-condition
; *)
;       forall (k: Prims.pure_post Type0).
;         (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
...
;   (forall (_: FStar.Seq.Base.seq Prims.int)
;       (p:
;       Prims.pure_post (FStar.Pervasives.Native.option Prims.unit & FStar.Seq.Base.seq Prims.int)).
;       (match FStar.DM4F.IntStore.in_ i _ with
;         | true -> p (FStar.Pervasives.Native.Some (), FStar.Seq.Base.upd _ i x)
;         | _ -> p (FStar.Pervasives.Native.None, _)) ==>
;       (forall (k:
;           (_: FStar.Pervasives.Native.option Prims.unit & FStar.Seq.Base.seq Prims.int -> Type0)).
;           (forall (a1: FStar.Pervasives.Native.option Prims.unit & FStar.Seq.Base.seq Prims.int).
;               {:pattern Prims.guard_free (k a1)}
;               k a1 <==> p a1) ==>
;           (FStar.DM4F.IntStore.in_ i _ = true ==>
;             FStar.DM4F.IntStore.in_ i _ == true ==>
...
;                     FStar.Seq.Base.upd _ i x == any_result ==>
;                     k (FStar.Pervasives.Native.Some (), FStar.Seq.Base.upd _ i x)
;                     <:
;                     Type0))) /\
;           (~(FStar.DM4F.IntStore.in_ i _ = true) ==>
;             (forall (e1: Prims.bool).
;                 FStar.DM4F.IntStore.in_ i _ == e1 ==>
;                 (forall (x: FStar.Pervasives.Native.option Prims.unit)
;                     (l1: FStar.Seq.Base.seq Prims.int).
;                     _ == l1 /\ None? x ==> k (x, l1))))))
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(ApplyTT @x4
@x5)
...
;; def=FStar.DM4F.IntStore.fst(86,9-86,18); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(= (FStar.DM4F.IntStore.in_ @x0
@x2)
(BoxBool true))
)

;; def=FStar.Seq.Base.fsti(56,37-56,49); use=FStar.DM4F.IntStore.fst(87,28-87,29)
(or label_1

;; def=FStar.Seq.Base.fsti(56,37-56,49); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(< (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (FStar.Seq.Base.length Prims.int
@x2)))
)
...
(FStar.Seq.Base.seq Prims.int))
(HasType @x3
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.Seq.Base.seq Prims.int))))
(let ((@lb4 (FStar.DM4F.IntStore.in_ @x0
@x2)))
(ite (= @lb4
(BoxBool true))

;; def=FStar.DM4F.IntStore.fst(87,11-87,32); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(Valid 
;; def=FStar.DM4F.IntStore.fst(87,11-87,32); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.Seq.Base.seq Prims.int)
...
;; def=FStar.DM4F.IntStore.fst(88,11-88,22); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(Valid 
;; def=FStar.DM4F.IntStore.fst(88,11-88,22); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.Seq.Base.seq Prims.int)
(FStar.Pervasives.Native.None Prims.unit)
@x2))
)
)))
...
;; def=Prims.fst(221,62-221,85); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(and (implies 
;; def=Prims.fst(221,62-221,71); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(and 
;; def=FStar.DM4F.IntStore.fst(91,5-91,18); use=FStar.DM4F.IntStore.fst(91,5-91,18)
(= (FStar.DM4F.IntStore.in_ @x0
@x2)
(BoxBool true))
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(and 
;; def=FStar.Seq.Base.fsti(56,37-56,49); use=FStar.DM4F.IntStore.fst(92,26-92,27)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
FStar.DM4F.IntStore.id)

;; def=FStar.Seq.Base.fsti(56,31-56,32); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(= @x0
@x5)
)
...
;; def=FStar.DM4F.IntStore.fst(37,38-37,48); use=FStar.DM4F.IntStore.fst(92,11-92,14)
(or label_3
...
(implies 
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.IntStore.fst(89,1-93,16)
(not 
;; def=FStar.DM4F.IntStore.fst(91,5-91,18); use=FStar.DM4F.IntStore.fst(91,5-91,18)
(= (FStar.DM4F.IntStore.in_ @x0
@x2)
...
;; def=FStar.DM4F.IntStore.fst(91,5-93,16); use=FStar.DM4F.IntStore.fst(91,5-93,16)
(= (FStar.DM4F.IntStore.in_ @x0
@x2)
@x5)
)

;; def=FStar.DM4F.IntStore.fst(54,37-54,88); use=FStar.DM4F.IntStore.fst(93,7-93,13)
...
;; def=FStar.DM4F.IntStore.fst(63,47-63,55); use=FStar.DM4F.IntStore.fst(93,7-93,13)
(= @x2
@x7)


;; def=FStar.DM4F.IntStore.fst(63,59-63,66); use=FStar.DM4F.IntStore.fst(93,7-93,13)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None Prims.unit
@x6))
)

;; def=FStar.DM4F.IntStore.fst(54,78-54,87); use=FStar.DM4F.IntStore.fst(93,7-93,13)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStore.write, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_f8666440faa91836cc5a13998af863fc, disc_equation_FStar.Pervasives.Native.None, equation_FStar.DM4F.IntStore.id, equation_FStar.DM4F.IntStore.in_, equation_Prims.nat, fuel_guarded_inversion_FStar.Pervasives.Native.option, int_inversion, primitive_Prims.op_LessThan, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, unit_typing
...
(declare-fun FStar.DM4F.IntStore.write (Term Term) Term)
(declare-fun Non_total_Tm_arrow_64c985102eadc74598463c6a586b0f9f () Term)
(declare-fun FStar.DM4F.IntStore.write@tok () Term)
(declare-fun Tm_refine_9d979f8d89d517e11b280d817a875789 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option Prims.unit & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_356bac7577fce9fd8b176002f95cd8e8 (Term Term) Term)

; </end encoding let write>

(push) ;; push{2

; Starting query at FStar.DM4F.IntStore.fst(103,1-105,15)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_cfbec73c9e491d0ca4921e6dda987d7f)
...
; Encoding query formula : forall (i: FStar.DM4F.IntStore.id).
;   (forall (s0: FStar.Seq.Base.seq Prims.int)
;       (p: (_: FStar.Pervasives.Native.option Prims.int & FStar.Seq.Base.seq Prims.int -> Type0)).
;       (*  - Could not prove post-condition
; *)
;       FStar.DM4F.IntStore.in_ i s0 ==> i < FStar.Seq.Base.length s0) /\
;   (forall (_: FStar.Seq.Base.seq Prims.int)
;       (p: Prims.pure_post (FStar.Pervasives.Native.option Prims.int & FStar.Seq.Base.seq Prims.int))
;     .
;       FStar.DM4F.IntStore.in_ i _ /\ p (FStar.Pervasives.Native.Some (FStar.Seq.Base.index _ i), _) ==>
;       i < FStar.Seq.Base.length _ /\
;       (forall (any_result: FStar.DM4F.IntStore.id).
;           i == any_result ==>
;           (forall (any_result: Prims.int).
;               any_result == FStar.Seq.Base.index _ i ==>
;               p (FStar.Pervasives.Native.Some any_result, _)
;               <:
;               Type0)))


; Context: While encoding a query
; While typechecking the top-level declaration `let read_tot`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
...
;; def=FStar.DM4F.IntStore.fst(97,31-97,41); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(BoxBool_proj_0 (FStar.DM4F.IntStore.in_ @x0
@x1))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.IntStore.fst(97,63-97,64)
(or label_1

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(< (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (FStar.Seq.Base.length Prims.int
@x1)))
)
...
;; def=FStar.DM4F.IntStore.fst(97,45-97,70); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(Valid 
;; def=FStar.DM4F.IntStore.fst(97,45-97,70); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.int)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.IntStore.fst(105,14-105,15)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
FStar.DM4F.IntStore.id)

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(= @x0
@x3)
)
...
;; def=FStar.DM4F.IntStore.fst(97,14-105,15); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(= @x4
(FStar.Seq.Base.index Prims.int
@x1
@x0))
...
;; def=FStar.DM4F.IntStore.fst(28,58-28,71); use=FStar.DM4F.IntStore.fst(103,1-105,15)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStore.read_tot, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.IntStore.id, equation_FStar.DM4F.IntStore.in_, equation_Prims.nat, int_inversion, primitive_Prims.op_LessThan, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
...
; encoding sigelt let read_tot


; <Start encoding let read_tot>

(declare-fun FStar.DM4F.IntStore.read_tot (Term) Term)
(declare-fun Non_total_Tm_arrow_9b5d2644ce7305ed09a9c71d577162ce () Term)
(declare-fun FStar.DM4F.IntStore.read_tot@tok () Term)
(declare-fun Tm_refine_d90fe0d31fc6f0340eaed3c8d3fad99f (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option Prims.int & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_820e64a91449d82302613ed71aeb030a (Term) Term)

; </end encoding let read_tot>

(push) ;; push{2

; Starting query at FStar.DM4F.IntStore.fst(110,1-112,25)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(110,1-112,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_57698f0e840a52dbee04a90c760277c4)
...
;       (p:
;       Prims.pure_post (FStar.Pervasives.Native.option Prims.unit & FStar.Seq.Base.seq Prims.int)).
;       FStar.DM4F.IntStore.in_ i _ /\ p (FStar.Pervasives.Native.Some (), FStar.Seq.Base.upd _ i x) ==>
;       i < FStar.Seq.Base.length _ /\
;       (forall (any_result: FStar.DM4F.IntStore.id).
;           i == any_result ==>
;           (forall (any_result: FStar.Seq.Base.seq Prims.int).
;               FStar.Seq.Base.upd _ i x == any_result ==>
;               p (FStar.Pervasives.Native.Some (), FStar.Seq.Base.upd _ i x)
;               <:
;               Type0)))


; Context: While encoding a query
; While typechecking the top-level declaration `let write_tot`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(110,1-112,25)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(110,1-112,25)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
...
;; def=FStar.DM4F.IntStore.fst(109,32-109,42); use=FStar.DM4F.IntStore.fst(110,1-112,25)
(BoxBool_proj_0 (FStar.DM4F.IntStore.in_ @x0
@x2))
)

;; def=FStar.Seq.Base.fsti(56,37-56,49); use=FStar.DM4F.IntStore.fst(109,65-109,66)
(or label_1

;; def=FStar.Seq.Base.fsti(56,37-56,49); use=FStar.DM4F.IntStore.fst(110,1-112,25)
(< (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (FStar.Seq.Base.length Prims.int
@x2)))
)
...
;; def=FStar.DM4F.IntStore.fst(109,46-109,69); use=FStar.DM4F.IntStore.fst(110,1-112,25)
(Valid 
;; def=FStar.DM4F.IntStore.fst(109,46-109,69); use=FStar.DM4F.IntStore.fst(110,1-112,25)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.unit)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.IntStore.fst(110,1-112,25)
(and 
;; def=FStar.Seq.Base.fsti(56,37-56,49); use=FStar.DM4F.IntStore.fst(112,21-112,22)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.IntStore.fst(110,1-112,25)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
FStar.DM4F.IntStore.id)

;; def=FStar.Seq.Base.fsti(56,31-56,32); use=FStar.DM4F.IntStore.fst(110,1-112,25)
(= @x0
@x4)
)
...
;; def=FStar.DM4F.IntStore.fst(37,38-37,48); use=FStar.DM4F.IntStore.fst(112,6-112,9)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStore.write_tot, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.IntStore.id, equation_FStar.DM4F.IntStore.in_, equation_Prims.nat, int_inversion, primitive_Prims.op_LessThan, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2
...
; encoding sigelt let write_tot


; <Start encoding let write_tot>

(declare-fun FStar.DM4F.IntStore.write_tot (Term Term) Term)
(declare-fun Non_total_Tm_arrow_db510f055da26e3c5c413536bc832054 () Term)
(declare-fun FStar.DM4F.IntStore.write_tot@tok () Term)
(declare-fun Tm_refine_30dbd0ff58a0d309986d918b12f5b5b0 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Seq.Base.seq Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option Prims.unit & FStar.Seq.Base.seq Prims.int)
(declare-fun Tm_arrow_32956666400d7bda7487256b787b0ead (Term Term) Term)

; </end encoding let write_tot>

;;;;;;;;;;;;;;;;typing_Tm_abs_e663c8e63232c34d4af141ab8f8e901c
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! (HasType Tm_abs_e663c8e63232c34d4af141ab8f8e901c
Tm_arrow_6631ab9b65954887db06c7b94c61a3a8)
:named typing_Tm_abs_e663c8e63232c34d4af141ab8f8e901c))
;;;;;;;;;;;;;;;;typing_Tm_abs_928b19931d487bf450765aab83c9a4be
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! (HasType Tm_abs_928b19931d487bf450765aab83c9a4be
Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37)
:named typing_Tm_abs_928b19931d487bf450765aab83c9a4be))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IntStore.read; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(70,4-70,8); use=FStar.DM4F.IntStore.fst(70,4-70,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FStar.DM4F.IntStore.id)
(HasType (FStar.DM4F.IntStore.read @x0)
(Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45 @x0)))
 

:pattern ((FStar.DM4F.IntStore.read @x0))
:qid typing_FStar.DM4F.IntStore.read))

:named typing_FStar.DM4F.IntStore.read))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IntStore.raise_; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(62,4-62,10); use=FStar.DM4F.IntStore.fst(62,4-62,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Prims.unit))
(HasType (FStar.DM4F.IntStore.raise_ @x0
@x1)
(Tm_arrow_3f89d153145cfe940ec3181ebb675fdd @x0)))
 

:pattern ((FStar.DM4F.IntStore.raise_ @x0
@x1))
:qid typing_FStar.DM4F.IntStore.raise_))

:named typing_FStar.DM4F.IntStore.raise_))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_e31b9cc181ef985fb9d787b42b923e08
;;; Fact-ids: Name FStar.DM4F.IntStore.read; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(28,58-28,71); use=FStar.DM4F.IntStore.fst(28,58-28,71)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (Tm_abs_e31b9cc181ef985fb9d787b42b923e08 @x0
@x1))
 

:pattern ((Tm_abs_e31b9cc181ef985fb9d787b42b923e08 @x0
@x1))
:qid tot_fun_Tm_abs_e31b9cc181ef985fb9d787b42b923e08))

:named tot_fun_Tm_abs_e31b9cc181ef985fb9d787b42b923e08))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_c180a1a093bf4028a15844b815442d7b
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! (IsTotFun Tm_abs_c180a1a093bf4028a15844b815442d7b)
:named tot_fun_Tm_abs_c180a1a093bf4028a15844b815442d7b))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_0915464e74e833c74cced327d3f5d2e3
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! (IsTotFun Tm_abs_0915464e74e833c74cced327d3f5d2e3)
:named tot_fun_Tm_abs_0915464e74e833c74cced327d3f5d2e3))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.IntStore.fst(36,45-36,62)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_ca466071266e2aadf6d8eb9897e98c71 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_ca466071266e2aadf6d8eb9897e98c71 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_ca466071266e2aadf6d8eb9897e98c71))

:named refinement_kinding_Tm_refine_ca466071266e2aadf6d8eb9897e98c71))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntStore.raise_; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74))

:named refinement_kinding_Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_3fa55d8c2198a573078badd6c832e738 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_3fa55d8c2198a573078badd6c832e738 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_3fa55d8c2198a573078badd6c832e738))

:named refinement_kinding_Tm_refine_3fa55d8c2198a573078badd6c832e738))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntStore.read; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_23a9f4081dd9caf90ad448b496b3081f @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_23a9f4081dd9caf90ad448b496b3081f @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_23a9f4081dd9caf90ad448b496b3081f))

:named refinement_kinding_Tm_refine_23a9f4081dd9caf90ad448b496b3081f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.IntStore.fst(36,45-36,62)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ca466071266e2aadf6d8eb9897e98c71 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option (FStar.Seq.Base.seq Prims.int))
(FStar.Seq.Base.seq Prims.int)))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.IntStore.fst(36,45-36,62)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.IntStore.fst(36,45-36,62)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.IntStore.fst(36,45-36,62)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option (FStar.Seq.Base.seq Prims.int))
(FStar.Seq.Base.seq Prims.int)
(FStar.Pervasives.Native.Some (FStar.Seq.Base.seq Prims.int)
@x2)
@x2)
@x1)
)
...
@x1
(Tm_refine_ca466071266e2aadf6d8eb9897e98c71 @x2)))
:qid refinement_interpretation_Tm_refine_ca466071266e2aadf6d8eb9897e98c71))

:named refinement_interpretation_Tm_refine_ca466071266e2aadf6d8eb9897e98c71))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.IntStore.raise_; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option @x2)
(FStar.Seq.Base.seq Prims.int)))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(not 
;; def=FStar.DM4F.IntStore.fst(54,27-54,88); use=FStar.DM4F.IntStore.fst(63,4-63,12)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.option @x2))
(HasType @x5
...
;; def=FStar.DM4F.IntStore.fst(63,47-63,55); use=FStar.DM4F.IntStore.fst(63,47-63,55)
(= @x3
@x5)


;; def=FStar.DM4F.IntStore.fst(63,59-63,66); use=FStar.DM4F.IntStore.fst(63,59-63,66)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x2
@x4))
)

;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.IntStore.fst(27,36-27,53)
...
;;no pats
:qid refinement_interpretation_Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74.1))
)
))
...
(Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74))

:named refinement_interpretation_Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3fa55d8c2198a573078badd6c832e738 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Tm_refine_72b607c315ccd653b2c38d69f398c7cb)
(FStar.Seq.Base.seq Prims.int)))
...
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Tm_refine_72b607c315ccd653b2c38d69f398c7cb)
(FStar.Seq.Base.seq Prims.int)
(FStar.Pervasives.Native.None Tm_refine_72b607c315ccd653b2c38d69f398c7cb)
@x2)
@x1)
)
)
...
@x1
(Tm_refine_3fa55d8c2198a573078badd6c832e738 @x2)))
:qid refinement_interpretation_Tm_refine_3fa55d8c2198a573078badd6c832e738))

:named refinement_interpretation_Tm_refine_3fa55d8c2198a573078badd6c832e738))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.IntStore.read; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_23a9f4081dd9caf90ad448b496b3081f @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(not (let ((@lb4 (FStar.DM4F.IntStore.in_ @x3
@x2)))
(ite (= @lb4
(BoxBool true))
...
(Tm_refine_23a9f4081dd9caf90ad448b496b3081f @x2
@x3)))
:qid refinement_interpretation_Tm_refine_23a9f4081dd9caf90ad448b496b3081f))

:named refinement_interpretation_Tm_refine_23a9f4081dd9caf90ad448b496b3081f))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name FStar.Pervasives.Native.__proj__Mktuple2__item___1; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=FStar.Pervasives.Native.fst(59,33-59,35)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45
;;; Fact-ids: Name FStar.DM4F.IntStore.read; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45 @x0)
Tm_type))
:qid kinding_Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45))

:named kinding_Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c3307adc258f4aba231d1b68d86b37f8
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! (HasType Tm_arrow_c3307adc258f4aba231d1b68d86b37f8
Tm_type)
:named kinding_Tm_arrow_c3307adc258f4aba231d1b68d86b37f8))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_bdb21571abec49dcb10bc11e45eff190
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! (HasType Tm_arrow_bdb21571abec49dcb10bc11e45eff190
Tm_type)
:named kinding_Tm_arrow_bdb21571abec49dcb10bc11e45eff190))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! (HasType Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37
Tm_type)
:named kinding_Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6631ab9b65954887db06c7b94c61a3a8
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! (HasType Tm_arrow_6631ab9b65954887db06c7b94c61a3a8
Tm_type)
:named kinding_Tm_arrow_6631ab9b65954887db06c7b94c61a3a8))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3f89d153145cfe940ec3181ebb675fdd
;;; Fact-ids: Name FStar.DM4F.IntStore.raise_; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_3f89d153145cfe940ec3181ebb675fdd @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_3f89d153145cfe940ec3181ebb675fdd @x0)
Tm_type))
:qid kinding_Tm_arrow_3f89d153145cfe940ec3181ebb675fdd))

:named kinding_Tm_arrow_3f89d153145cfe940ec3181ebb675fdd))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e663c8e63232c34d4af141ab8f8e901c
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(36,45-36,62); use=FStar.DM4F.IntStore.fst(36,45-36,62)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_e663c8e63232c34d4af141ab8f8e901c
@x0)
Tm_abs_c180a1a093bf4028a15844b815442d7b)
 

:pattern ((ApplyTT Tm_abs_e663c8e63232c34d4af141ab8f8e901c
@x0))
:qid interpretation_Tm_abs_e663c8e63232c34d4af141ab8f8e901c))

:named interpretation_Tm_abs_e663c8e63232c34d4af141ab8f8e901c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e31b9cc181ef985fb9d787b42b923e08
;;; Fact-ids: Name FStar.DM4F.IntStore.read; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(28,58-28,71); use=FStar.DM4F.IntStore.fst(28,58-28,71)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_e31b9cc181ef985fb9d787b42b923e08 @x1
@x2)
@x0)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Seq.Base.seq Prims.int)
(FStar.Pervasives.Native.Some Prims.int
(FStar.Seq.Base.index Prims.int
(FStar.Pervasives.Native.Some_v @x2)
@x1))
@x0))
 

:pattern ((ApplyTT (Tm_abs_e31b9cc181ef985fb9d787b42b923e08 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_e31b9cc181ef985fb9d787b42b923e08))

:named interpretation_Tm_abs_e31b9cc181ef985fb9d787b42b923e08))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c180a1a093bf4028a15844b815442d7b
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(36,45-36,62); use=FStar.DM4F.IntStore.fst(36,45-36,62)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_c180a1a093bf4028a15844b815442d7b
@x0)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option (FStar.Seq.Base.seq Prims.int))
(FStar.Seq.Base.seq Prims.int)
(FStar.Pervasives.Native.Some (FStar.Seq.Base.seq Prims.int)
...
:pattern ((ApplyTT Tm_abs_c180a1a093bf4028a15844b815442d7b
@x0))
:qid interpretation_Tm_abs_c180a1a093bf4028a15844b815442d7b))

:named interpretation_Tm_abs_c180a1a093bf4028a15844b815442d7b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_928b19931d487bf450765aab83c9a4be
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(41,51-41,62); use=FStar.DM4F.IntStore.fst(41,51-41,62)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_928b19931d487bf450765aab83c9a4be
@x0)
Tm_abs_0915464e74e833c74cced327d3f5d2e3)
 

:pattern ((ApplyTT Tm_abs_928b19931d487bf450765aab83c9a4be
@x0))
:qid interpretation_Tm_abs_928b19931d487bf450765aab83c9a4be))

:named interpretation_Tm_abs_928b19931d487bf450765aab83c9a4be))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_0915464e74e833c74cced327d3f5d2e3
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(41,51-41,62); use=FStar.DM4F.IntStore.fst(41,51-41,62)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_0915464e74e833c74cced327d3f5d2e3
@x0)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Tm_refine_72b607c315ccd653b2c38d69f398c7cb)
(FStar.Seq.Base.seq Prims.int)
(FStar.Pervasives.Native.None Tm_refine_72b607c315ccd653b2c38d69f398c7cb)
...
:pattern ((ApplyTT Tm_abs_0915464e74e833c74cced327d3f5d2e3
@x0))
:qid interpretation_Tm_abs_0915464e74e833c74cced327d3f5d2e3))

:named interpretation_Tm_abs_0915464e74e833c74cced327d3f5d2e3))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ca466071266e2aadf6d8eb9897e98c71
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.IntStore.fst(36,45-36,62)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ca466071266e2aadf6d8eb9897e98c71 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option (FStar.Seq.Base.seq Prims.int))
(FStar.Seq.Base.seq Prims.int)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ca466071266e2aadf6d8eb9897e98c71 @x0))))
:qid haseqTm_refine_ca466071266e2aadf6d8eb9897e98c71))

:named haseqTm_refine_ca466071266e2aadf6d8eb9897e98c71))
;;;;;;;;;;;;;;;;haseq for Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74
;;; Fact-ids: Name FStar.DM4F.IntStore.raise_; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74 @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option @x0)
(FStar.Seq.Base.seq Prims.int)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74 @x0
@x1))))
:qid haseqTm_refine_670665e202a9bfc61fc8cf1fdd1e1e74))

:named haseqTm_refine_670665e202a9bfc61fc8cf1fdd1e1e74))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3fa55d8c2198a573078badd6c832e738
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3fa55d8c2198a573078badd6c832e738 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Tm_refine_72b607c315ccd653b2c38d69f398c7cb)
(FStar.Seq.Base.seq Prims.int)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3fa55d8c2198a573078badd6c832e738 @x0))))
:qid haseqTm_refine_3fa55d8c2198a573078badd6c832e738))

:named haseqTm_refine_3fa55d8c2198a573078badd6c832e738))
;;;;;;;;;;;;;;;;haseq for Tm_refine_23a9f4081dd9caf90ad448b496b3081f
;;; Fact-ids: Name FStar.DM4F.IntStore.read; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_23a9f4081dd9caf90ad448b496b3081f @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
(FStar.Seq.Base.seq Prims.int)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_23a9f4081dd9caf90ad448b496b3081f @x0
@x1))))
:qid haseqTm_refine_23a9f4081dd9caf90ad448b496b3081f))

:named haseqTm_refine_23a9f4081dd9caf90ad448b496b3081f))
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntStore.read
;;; Fact-ids: Name FStar.DM4F.IntStore.read; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(70,4-70,8); use=FStar.DM4F.IntStore.fst(70,4-70,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (FStar.DM4F.IntStore.read @x0)
@x1)
(let ((@lb2 (ApplyTT (FStar.DM4F.IntStore.__proj__INT_STORE__item__get Tm_unit)
@x1)))
(let ((@lb3 (FStar.Pervasives.Native.Mktuple2__1 @lb2)))
...
(ApplyTT (let ((@lb4 (FStar.DM4F.IntStore.in_ @x0
(FStar.Pervasives.Native.Some_v @lb3))))
(ite (= @lb4
(BoxBool true))
(Tm_abs_e31b9cc181ef985fb9d787b42b923e08 @x0
@lb3)
(FStar.DM4F.IntStore.raise_ Prims.int
Tm_unit)))
(FStar.Pervasives.Native.Mktuple2__2 @lb2))
Tm_unit)))))
 

:pattern ((ApplyTT (FStar.DM4F.IntStore.read @x0)
@x1))
:qid equation_FStar.DM4F.IntStore.read))

:named equation_FStar.DM4F.IntStore.read))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntStore.raise_
;;; Fact-ids: Name FStar.DM4F.IntStore.raise_; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(62,4-62,10); use=FStar.DM4F.IntStore.fst(62,4-62,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (FStar.DM4F.IntStore.raise_ @x0
@x1)
@x2)
(let ((@lb3 (ApplyTT (FStar.DM4F.IntStore.__proj__INT_STORE__item__raise_ Tm_unit)
@x2)))
(let ((@lb4 (FStar.Pervasives.Native.Mktuple2__1 @lb3)))
...
:pattern ((ApplyTT (FStar.DM4F.IntStore.raise_ @x0
@x1)
@x2))
:qid equation_FStar.DM4F.IntStore.raise_))

:named equation_FStar.DM4F.IntStore.raise_))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntStore.read; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45 @x2)))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-23,19); use=FStar.DM4F.IntStore.fst(23,12-36,62)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_c3307adc258f4aba231d1b68d86b37f8)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_c3307adc258f4aba231d1b68d86b37f8))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_c3307adc258f4aba231d1b68d86b37f8))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_c3307adc258f4aba231d1b68d86b37f8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_bdb21571abec49dcb10bc11e45eff190)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_bdb21571abec49dcb10bc11e45eff190))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_bdb21571abec49dcb10bc11e45eff190))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_bdb21571abec49dcb10bc11e45eff190))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(41,15-41,17); use=FStar.DM4F.IntStore.fst(41,15-41,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37)
...
@x1
Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-36,10); use=FStar.DM4F.IntStore.fst(23,12-36,62)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_6631ab9b65954887db06c7b94c61a3a8)
...
@x1
Tm_arrow_6631ab9b65954887db06c7b94c61a3a8))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_6631ab9b65954887db06c7b94c61a3a8))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_6631ab9b65954887db06c7b94c61a3a8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntStore.raise_; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_3f89d153145cfe940ec3181ebb675fdd @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_3f89d153145cfe940ec3181ebb675fdd @x2)))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_3f89d153145cfe940ec3181ebb675fdd))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_3f89d153145cfe940ec3181ebb675fdd))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45
;;; Fact-ids: Name FStar.DM4F.IntStore.read; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45 @x1))
(and 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@x2 Term))
 (! (implies (and (let ((@lb3 (FStar.DM4F.IntStore.in_ @x1
@x2)))
true)
(HasType @x2
(FStar.Seq.Base.seq Prims.int)))
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45 @x1)))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c3307adc258f4aba231d1b68d86b37f8
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-23,19); use=FStar.DM4F.IntStore.fst(23,12-36,62)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_refine_ca466071266e2aadf6d8eb9897e98c71 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_c3307adc258f4aba231d1b68d86b37f8.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_c3307adc258f4aba231d1b68d86b37f8))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_c3307adc258f4aba231d1b68d86b37f8))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_c3307adc258f4aba231d1b68d86b37f8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_bdb21571abec49dcb10bc11e45eff190
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_refine_3fa55d8c2198a573078badd6c832e738 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_bdb21571abec49dcb10bc11e45eff190.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_bdb21571abec49dcb10bc11e45eff190))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_bdb21571abec49dcb10bc11e45eff190))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_bdb21571abec49dcb10bc11e45eff190))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(41,15-41,17); use=FStar.DM4F.IntStore.fst(41,15-41,17)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_8a18c98549b32703e7bb5f5aa57f3b37))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_6631ab9b65954887db06c7b94c61a3a8
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__get_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-36,10); use=FStar.DM4F.IntStore.fst(23,12-36,62)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_6631ab9b65954887db06c7b94c61a3a8.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_6631ab9b65954887db06c7b94c61a3a8))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_6631ab9b65954887db06c7b94c61a3a8))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_6631ab9b65954887db06c7b94c61a3a8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3f89d153145cfe940ec3181ebb675fdd
;;; Fact-ids: Name FStar.DM4F.IntStore.raise_; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_3f89d153145cfe940ec3181ebb675fdd @x1))
(and 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_670665e202a9bfc61fc8cf1fdd1e1e74 @x1
@x2)))
 

:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_3f89d153145cfe940ec3181ebb675fdd.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_3f89d153145cfe940ec3181ebb675fdd @x1)))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_3f89d153145cfe940ec3181ebb675fdd))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_3f89d153145cfe940ec3181ebb675fdd))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(50,7-50,13); use=FStar.DM4F.IntStore.fst(50,7-50,13)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.IntStore.__proj__INT_STORE__item__raise_ @x0)
(ApplyTT Tm_abs_928b19931d487bf450765aab83c9a4be
@x0))
 

:pattern ((FStar.DM4F.IntStore.__proj__INT_STORE__item__raise_ @x0))
:qid FStar.DM4F.IntStore.__proj__INT_STORE__item__raise__equality))

:named FStar.DM4F.IntStore.__proj__INT_STORE__item__raise__equality))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(48,7-48,10); use=FStar.DM4F.IntStore.fst(48,7-48,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.IntStore.__proj__INT_STORE__item__get @x0)
(ApplyTT Tm_abs_e663c8e63232c34d4af141ab8f8e901c
@x0))
 

:pattern ((FStar.DM4F.IntStore.__proj__INT_STORE__item__get @x0))
:qid FStar.DM4F.IntStore.__proj__INT_STORE__item__get_equality))

:named FStar.DM4F.IntStore.__proj__INT_STORE__item__get_equality))
(push) ;; push{2

; Starting query at FStar.DM4F.IntStore.fst(122,2-122,4)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (store: FStar.DM4F.IntStore.heap) (r: FStar.DM4F.IntStore.id).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     FStar.DM4F.IntStore.in_ r store /\
;     (forall (pure_result: Prims.unit).
;         Some? (FStar.Pervasives.Native.fst (reify (FStar.DM4F.IntStore.read r) store)) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let total_read_lemma`
...
;; def=FStar.DM4F.IntStore.fst(121,20-121,33); use=FStar.DM4F.IntStore.fst(122,2-122,4)
(BoxBool_proj_0 (FStar.DM4F.IntStore.in_ @x1
@x0))


;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.IntStore.fst(122,2-122,4)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=FStar.DM4F.IntStore.fst(121,44-121,78); use=FStar.DM4F.IntStore.fst(122,2-122,4)
(or label_2

;; def=FStar.DM4F.IntStore.fst(121,44-121,78); use=FStar.DM4F.IntStore.fst(122,2-122,4)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some Prims.int
(FStar.Pervasives.Native.fst (FStar.Pervasives.Native.option Prims.int)
(FStar.Seq.Base.seq Prims.int)
(ApplyTT (FStar.DM4F.IntStore.read @x1)
@x0))))
)
)

;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.IntStore.fst(122,2-122,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.IntStore.fst(122,2-122,4)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStore.total_read_lemma, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.IntStore_interpretation_Tm_arrow_ca46dacfe97f3e00db4f2581b784fa45, Prims_pretyping_ae567c2fb75be05905677af440075565, bool_inversion, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.Some, equation_FStar.DM4F.IntStore.heap, equation_FStar.DM4F.IntStore.id, equation_FStar.DM4F.IntStore.in_, equation_FStar.DM4F.IntStore.read, equation_FStar.Pervasives.Native.fst, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, int_inversion, proj_equation_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_23a9f4081dd9caf90ad448b496b3081f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_FStar.DM4F.IntStore.in_, typing_FStar.DM4F.IntStore.read
...
; encoding sigelt let total_read_lemma


; <Start encoding let total_read_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.IntStore.total_read_lemma (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.IntStore.total_read_lemma@tok () Term)

; </end encoding let total_read_lemma>

;;;;;;;;;;;;;;;;typing_Tm_abs_2e660715db1749600edbac843098eb9a
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! (HasType Tm_abs_2e660715db1749600edbac843098eb9a
Tm_arrow_77616552377b2c06579f52084c6e869b)
:named typing_Tm_abs_2e660715db1749600edbac843098eb9a))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IntStore.write; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(83,6-83,11); use=FStar.DM4F.IntStore.fst(83,6-83,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
FStar.DM4F.IntStore.id)
(HasType @x1
Prims.int))
(HasType (FStar.DM4F.IntStore.write @x0
@x1)
(Tm_arrow_356bac7577fce9fd8b176002f95cd8e8 @x1
@x0)))
 

:pattern ((FStar.DM4F.IntStore.write @x0
@x1))
:qid typing_FStar.DM4F.IntStore.write))

:named typing_FStar.DM4F.IntStore.write))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_05a67f9fe771d5ede528047b14da96c1
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(37,38-37,48); use=FStar.DM4F.IntStore.fst(37,38-37,48)
(forall ((@x0 Term))
 (! (IsTotFun (Tm_abs_05a67f9fe771d5ede528047b14da96c1 @x0))
 

:pattern ((Tm_abs_05a67f9fe771d5ede528047b14da96c1 @x0))
:qid tot_fun_Tm_abs_05a67f9fe771d5ede528047b14da96c1))

:named tot_fun_Tm_abs_05a67f9fe771d5ede528047b14da96c1))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntStore.write; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_9d979f8d89d517e11b280d817a875789 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_9d979f8d89d517e11b280d817a875789 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_9d979f8d89d517e11b280d817a875789))

:named refinement_kinding_Tm_refine_9d979f8d89d517e11b280d817a875789))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.IntStore.fst(37,38-37,48)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_6a15a366328605071729f52393506055 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_6a15a366328605071729f52393506055 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_6a15a366328605071729f52393506055))

:named refinement_kinding_Tm_refine_6a15a366328605071729f52393506055))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.IntStore.write; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9d979f8d89d517e11b280d817a875789 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(not (let ((@lb5 (FStar.DM4F.IntStore.in_ @x3
@x2)))
(ite (= @lb5
(BoxBool true))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_9d979f8d89d517e11b280d817a875789))

:named refinement_interpretation_Tm_refine_9d979f8d89d517e11b280d817a875789))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.IntStore.fst(37,38-37,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6a15a366328605071729f52393506055 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.Seq.Base.seq Prims.int)))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.IntStore.fst(37,38-37,48)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.IntStore.fst(37,38-37,48)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.IntStore.fst(37,38-37,48)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.Seq.Base.seq Prims.int)
...
@x1
(Tm_refine_6a15a366328605071729f52393506055 @x2)))
:qid refinement_interpretation_Tm_refine_6a15a366328605071729f52393506055))

:named refinement_interpretation_Tm_refine_6a15a366328605071729f52393506055))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_784383d546d77cb9f0247221b8010213
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-23,19); use=FStar.DM4F.IntStore.fst(23,12-37,48)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_784383d546d77cb9f0247221b8010213 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_784383d546d77cb9f0247221b8010213 @x0)
Tm_type))
:qid kinding_Tm_arrow_784383d546d77cb9f0247221b8010213))

:named kinding_Tm_arrow_784383d546d77cb9f0247221b8010213))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_77616552377b2c06579f52084c6e869b
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! (HasType Tm_arrow_77616552377b2c06579f52084c6e869b
Tm_type)
:named kinding_Tm_arrow_77616552377b2c06579f52084c6e869b))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_356bac7577fce9fd8b176002f95cd8e8
;;; Fact-ids: Name FStar.DM4F.IntStore.write; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_356bac7577fce9fd8b176002f95cd8e8 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_356bac7577fce9fd8b176002f95cd8e8 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_356bac7577fce9fd8b176002f95cd8e8))

:named kinding_Tm_arrow_356bac7577fce9fd8b176002f95cd8e8))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_2e660715db1749600edbac843098eb9a
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(37,38-37,48); use=FStar.DM4F.IntStore.fst(37,38-37,48)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_2e660715db1749600edbac843098eb9a
@x0)
(Tm_abs_05a67f9fe771d5ede528047b14da96c1 @x0))
 

:pattern ((ApplyTT Tm_abs_2e660715db1749600edbac843098eb9a
@x0))
:qid interpretation_Tm_abs_2e660715db1749600edbac843098eb9a))

:named interpretation_Tm_abs_2e660715db1749600edbac843098eb9a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_05a67f9fe771d5ede528047b14da96c1
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(37,38-37,48); use=FStar.DM4F.IntStore.fst(37,38-37,48)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_05a67f9fe771d5ede528047b14da96c1 @x1)
@x0)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.Seq.Base.seq Prims.int)
(FStar.Pervasives.Native.Some Prims.unit
...
:pattern ((ApplyTT (Tm_abs_05a67f9fe771d5ede528047b14da96c1 @x1)
@x0))
:qid interpretation_Tm_abs_05a67f9fe771d5ede528047b14da96c1))

:named interpretation_Tm_abs_05a67f9fe771d5ede528047b14da96c1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9d979f8d89d517e11b280d817a875789
;;; Fact-ids: Name FStar.DM4F.IntStore.write; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(27,36-27,53); use=FStar.DM4F.IntStore.fst(27,36-27,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9d979f8d89d517e11b280d817a875789 @x0
@x1
@x2)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.Seq.Base.seq Prims.int)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9d979f8d89d517e11b280d817a875789 @x0
@x1
@x2))))
:qid haseqTm_refine_9d979f8d89d517e11b280d817a875789))

:named haseqTm_refine_9d979f8d89d517e11b280d817a875789))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6a15a366328605071729f52393506055
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.IntStore.fst(37,38-37,48)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6a15a366328605071729f52393506055 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.Seq.Base.seq Prims.int)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6a15a366328605071729f52393506055 @x0))))
:qid haseqTm_refine_6a15a366328605071729f52393506055))

:named haseqTm_refine_6a15a366328605071729f52393506055))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntStore.write
;;; Fact-ids: Name FStar.DM4F.IntStore.write; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(83,6-83,11); use=FStar.DM4F.IntStore.fst(83,6-83,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (FStar.DM4F.IntStore.write @x0
@x1)
@x2)
(let ((@lb3 (ApplyTT (FStar.DM4F.IntStore.__proj__INT_STORE__item__get Tm_unit)
@x2)))
(let ((@lb4 (FStar.Pervasives.Native.Mktuple2__1 @lb3)))
(ite (is-FStar.Pervasives.Native.None @lb4)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.unit)
...
(FStar.Pervasives.Native.Mktuple2__2 @lb3))
(ite (is-FStar.Pervasives.Native.Some @lb4)
(ApplyTT (let ((@lb5 (FStar.DM4F.IntStore.in_ @x0
(FStar.Pervasives.Native.Some_v @lb4))))
(ite (= @lb5
(BoxBool true))
(FStar.DM4F.IntStore.__proj__INT_STORE__item__put (FStar.Seq.Base.upd Prims.int
(FStar.Pervasives.Native.Some_v @lb4)
@x0
@x1))
(FStar.DM4F.IntStore.raise_ Prims.unit
Tm_unit)))
(FStar.Pervasives.Native.Mktuple2__2 @lb3))
Tm_unit)))))
 

:pattern ((ApplyTT (FStar.DM4F.IntStore.write @x0
@x1)
@x2))
:qid equation_FStar.DM4F.IntStore.write))

:named equation_FStar.DM4F.IntStore.write))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-23,19); use=FStar.DM4F.IntStore.fst(23,12-37,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_784383d546d77cb9f0247221b8010213 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_784383d546d77cb9f0247221b8010213 @x2)))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_784383d546d77cb9f0247221b8010213))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_784383d546d77cb9f0247221b8010213))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-23,19); use=FStar.DM4F.IntStore.fst(23,12-37,48)
...
@x1
Tm_arrow_77616552377b2c06579f52084c6e869b))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_77616552377b2c06579f52084c6e869b))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_77616552377b2c06579f52084c6e869b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntStore.write; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_356bac7577fce9fd8b176002f95cd8e8 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_356bac7577fce9fd8b176002f95cd8e8 @x2
@x3)))
:qid FStar.DM4F.IntStore_pre_typing_Tm_arrow_356bac7577fce9fd8b176002f95cd8e8))

:named FStar.DM4F.IntStore_pre_typing_Tm_arrow_356bac7577fce9fd8b176002f95cd8e8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_784383d546d77cb9f0247221b8010213
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-23,19); use=FStar.DM4F.IntStore.fst(23,12-37,48)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_784383d546d77cb9f0247221b8010213 @x1))
(and 
;; def=FStar.DM4F.IntStore.fst(23,12-23,19); use=FStar.DM4F.IntStore.fst(23,12-37,48)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_6a15a366328605071729f52393506055 @x1)))
 

:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_784383d546d77cb9f0247221b8010213.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_784383d546d77cb9f0247221b8010213 @x1)))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_784383d546d77cb9f0247221b8010213))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_784383d546d77cb9f0247221b8010213))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_77616552377b2c06579f52084c6e869b
;;; Fact-ids: Name FStar.DM4F.IntStore._dm4f_INT_STORE___proj__INT_STORE__item__put_elab; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-23,19); use=FStar.DM4F.IntStore.fst(23,12-37,48)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_77616552377b2c06579f52084c6e869b.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_77616552377b2c06579f52084c6e869b))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_77616552377b2c06579f52084c6e869b))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_77616552377b2c06579f52084c6e869b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_356bac7577fce9fd8b176002f95cd8e8
;;; Fact-ids: Name FStar.DM4F.IntStore.write; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;; def=FStar.DM4F.IntStore.fst(23,12-27,53); use=FStar.DM4F.IntStore.fst(23,12-27,53)
(forall ((@x3 Term))
 (! (implies (and (let ((@lb4 (FStar.DM4F.IntStore.in_ @x2
@x3)))
true)
(HasType @x3
(FStar.Seq.Base.seq Prims.int)))
(HasType (ApplyTT @x0
@x3)
(Tm_refine_9d979f8d89d517e11b280d817a875789 @x3
@x2
@x1)))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_356bac7577fce9fd8b176002f95cd8e8.1))
...
(Tm_arrow_356bac7577fce9fd8b176002f95cd8e8 @x1
@x2)))
:qid FStar.DM4F.IntStore_interpretation_Tm_arrow_356bac7577fce9fd8b176002f95cd8e8))

:named FStar.DM4F.IntStore_interpretation_Tm_arrow_356bac7577fce9fd8b176002f95cd8e8))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.IntStore.INT_STORE; Namespace FStar.DM4F.IntStore
(assert (! 
;; def=FStar.DM4F.IntStore.fst(49,7-49,10); use=FStar.DM4F.IntStore.fst(49,7-49,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.IntStore.__proj__INT_STORE__item__put @x0)
(ApplyTT Tm_abs_2e660715db1749600edbac843098eb9a
@x0))
 

:pattern ((FStar.DM4F.IntStore.__proj__INT_STORE__item__put @x0))
:qid FStar.DM4F.IntStore.__proj__INT_STORE__item__put_equality))

:named FStar.DM4F.IntStore.__proj__INT_STORE__item__put_equality))
(push) ;; push{2

; Starting query at FStar.DM4F.IntStore.fst(126,2-126,4)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (store: FStar.DM4F.IntStore.heap) (r: FStar.DM4F.IntStore.id) (x: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     FStar.DM4F.IntStore.in_ r store /\
;     (forall (pure_result: Prims.unit).
;         Some? (FStar.Pervasives.Native.fst (reify (FStar.DM4F.IntStore.write r x) store)) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let total_write_lemma`
...
;; def=FStar.DM4F.IntStore.fst(125,20-125,33); use=FStar.DM4F.IntStore.fst(126,2-126,4)
(BoxBool_proj_0 (FStar.DM4F.IntStore.in_ @x1
@x0))


;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.IntStore.fst(126,2-126,4)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=FStar.DM4F.IntStore.fst(125,44-125,81); use=FStar.DM4F.IntStore.fst(126,2-126,4)
(or label_2

;; def=FStar.DM4F.IntStore.fst(125,44-125,81); use=FStar.DM4F.IntStore.fst(126,2-126,4)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some Prims.unit
(FStar.Pervasives.Native.fst (FStar.Pervasives.Native.option Prims.unit)
(FStar.Seq.Base.seq Prims.int)
(ApplyTT (FStar.DM4F.IntStore.write @x1
@x2)
@x0))))
)
)

;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.IntStore.fst(126,2-126,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.IntStore.fst(126,2-126,4)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStore.total_write_lemma, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.IntStore_interpretation_Tm_arrow_356bac7577fce9fd8b176002f95cd8e8, Prims_pretyping_f8666440faa91836cc5a13998af863fc, bool_inversion, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.Some, equation_FStar.DM4F.IntStore.heap, equation_FStar.DM4F.IntStore.id, equation_FStar.DM4F.IntStore.in_, equation_FStar.DM4F.IntStore.write, equation_FStar.Pervasives.Native.fst, equation_Prims.nat, int_inversion, proj_equation_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_9d979f8d89d517e11b280d817a875789, typing_FStar.DM4F.IntStore.in_, typing_FStar.DM4F.IntStore.write, unit_typing
...
; encoding sigelt let total_write_lemma


; <Start encoding let total_write_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.IntStore.total_write_lemma (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.IntStore.total_write_lemma@tok () Term)

; </end encoding let total_write_lemma>
...
; Starting query at FStar.DM4F.IntStore.fst(132,2-132,4)
...
; Encoding query formula : forall (store: FStar.DM4F.IntStore.heap) (r: FStar.DM4F.IntStore.id) (x: Prims.int).
;   (forall (_: Prims.squash (FStar.DM4F.IntStore.in_ r store)).
;       (*  - Could not prove post-condition
; *)
;       FStar.DM4F.IntStore.in_ r store ==>
;       FStar.DM4F.IntStore.in_ r store /\ FStar.DM4F.IntStore.in_ r (FStar.Seq.Base.upd store r x)) /\
;   (forall (p: Prims.pure_post Prims.unit).
;       FStar.DM4F.IntStore.in_ r store /\
;       (forall (pure_result: Prims.unit).
;           FStar.DM4F.IntStore.in_ r store /\
;           FStar.Pervasives.Native.Some (FStar.Seq.Base.index (FStar.Seq.Base.upd store r x) r) ==
...
; Context: While encoding a query
; While typechecking the top-level declaration `let read_write_lemma1`
...
;; def=Prims.fst(406,51-406,91); use=Prims.fst(430,19-430,32)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStore.fst(132,2-132,4)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.squash (Prims.b2t (FStar.DM4F.IntStore.in_ @x1
@x0))))

;; def=FStar.DM4F.IntStore.fst(131,16-131,29); use=FStar.DM4F.IntStore.fst(132,2-132,4)
(BoxBool_proj_0 (FStar.DM4F.IntStore.in_ @x1
@x0))
)

;; def=FStar.DM4F.IntStore.fst(109,32-109,69); use=FStar.DM4F.IntStore.fst(132,2-132,4)
(and 
;; def=FStar.DM4F.IntStore.fst(109,32-109,42); use=FStar.DM4F.IntStore.fst(131,15-131,117)
(or label_1

;; def=FStar.DM4F.IntStore.fst(109,32-109,42); use=FStar.DM4F.IntStore.fst(132,2-132,4)
(BoxBool_proj_0 (FStar.DM4F.IntStore.in_ @x1
@x0))
)


;; def=FStar.DM4F.IntStore.fst(97,31-97,41); use=FStar.DM4F.IntStore.fst(131,15-131,117)
(or label_2

;; def=FStar.DM4F.IntStore.fst(97,31-97,41); use=FStar.DM4F.IntStore.fst(132,2-132,4)
(BoxBool_proj_0 (FStar.DM4F.IntStore.in_ @x1
(FStar.Seq.Base.upd Prims.int
@x0
@x1
...
;; def=FStar.DM4F.IntStore.fst(130,22-130,37); use=FStar.DM4F.IntStore.fst(132,2-132,4)
(BoxBool_proj_0 (FStar.DM4F.IntStore.in_ @x1
@x0))


;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.IntStore.fst(132,2-132,4)
(forall ((@x4 Term))
...
;; def=FStar.DM4F.IntStore.fst(131,33-131,116); use=FStar.DM4F.IntStore.fst(132,2-132,4)
(or label_5
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.IntStore.fst(132,2-132,4)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.IntStore.fst(132,2-132,4)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStore.read_write_lemma1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, equation_FStar.DM4F.IntStore.heap, equation_FStar.DM4F.IntStore.id, equation_FStar.DM4F.IntStore.in_, equation_Prims.eqtype, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, int_inversion, lemma_FStar.Seq.Base.lemma_index_upd1, lemma_FStar.Seq.Base.lemma_len_upd, primitive_Prims.op_LessThan, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_2ca062977a42c36634b89c1c4f193f79, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55, typing_Prims.int
