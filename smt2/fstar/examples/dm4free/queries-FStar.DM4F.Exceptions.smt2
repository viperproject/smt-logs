...
; Internals for FStar.DM4F.Exceptions
...
(declare-fun FStar.DM4F.Exceptions.ex (Term) Term)

(declare-fun FStar.DM4F.Exceptions.ex@tok () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.M (FStar.Pervasives.either a Prims.exn)
(declare-fun Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8 (Term) Term)

; </end encoding let ex>


; encoding sigelt val FStar.DM4F.Exceptions.return_ex


; <Skipped val FStar.DM4F.Exceptions.return_ex/>
...
(declare-fun FStar.DM4F.Exceptions.return_ex (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> ex a
(declare-fun Tm_arrow_bfd34f4ff515964a57ad28a4489e805e () Term)
(declare-fun FStar.DM4F.Exceptions.return_ex@tok () Term)
(declare-fun Tm_abs_3699bd5e0109c03428c7b6d4d2039b10 (Term Term) Term)

; </end encoding let return_ex>


; encoding sigelt val FStar.DM4F.Exceptions.bind_ex


; <Skipped val FStar.DM4F.Exceptions.bind_ex/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Exceptions.ex; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,4-29,6); use=FStar.DM4F.Exceptions.fst(29,4-29,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.Exceptions.ex @x0)
Tm_type))
 

:pattern ((FStar.DM4F.Exceptions.ex @x0))
:qid typing_FStar.DM4F.Exceptions.ex))

:named typing_FStar.DM4F.Exceptions.ex))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8
;;; Fact-ids: Name FStar.DM4F.Exceptions.ex; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,18-29,42); use=FStar.DM4F.Exceptions.fst(29,18-29,42)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8 @x0)
Tm_type))
:qid kinding_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8))

:named kinding_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Exceptions.ex
;;; Fact-ids: Name FStar.DM4F.Exceptions.ex; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,4-29,6); use=FStar.DM4F.Exceptions.fst(29,4-29,6)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.Exceptions.ex @x0)
(Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8 @x0))
 

:pattern ((FStar.DM4F.Exceptions.ex @x0))
:qid equation_FStar.DM4F.Exceptions.ex))

:named equation_FStar.DM4F.Exceptions.ex))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8 @x2)))
:qid FStar.DM4F.Exceptions_pre_typing_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8))

:named FStar.DM4F.Exceptions_pre_typing_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8
;;; Fact-ids: Name FStar.DM4F.Exceptions.ex; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,18-29,42); use=FStar.DM4F.Exceptions.fst(29,18-29,42)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8 @x1))
(and 
;; def=FStar.DM4F.Exceptions.fst(29,18-29,42); use=FStar.DM4F.Exceptions.fst(29,18-29,42)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8 @x1)))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8))

:named FStar.DM4F.Exceptions_interpretation_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8))
(push) ;; push{2

; Starting query at FStar.DM4F.Exceptions.fst(36,30-40,19)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;g: a -> ex b
(declare-fun Tm_arrow_6b1a979213c5a0ede73827923c010b82 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6b1a979213c5a0ede73827923c010b82
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(35,58-36,13); use=FStar.DM4F.Exceptions.fst(36,4-36,13)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_6b1a979213c5a0ede73827923c010b82 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_6b1a979213c5a0ede73827923c010b82 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_6b1a979213c5a0ede73827923c010b82))

:named kinding_Tm_arrow_6b1a979213c5a0ede73827923c010b82))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(35,58-36,13); use=FStar.DM4F.Exceptions.fst(36,4-36,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_6b1a979213c5a0ede73827923c010b82 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_6b1a979213c5a0ede73827923c010b82 @x2
@x3)))
:qid FStar.DM4F.Exceptions_pre_typing_Tm_arrow_6b1a979213c5a0ede73827923c010b82))

:named FStar.DM4F.Exceptions_pre_typing_Tm_arrow_6b1a979213c5a0ede73827923c010b82))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_6b1a979213c5a0ede73827923c010b82
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(35,58-36,13); use=FStar.DM4F.Exceptions.fst(36,4-36,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_6b1a979213c5a0ede73827923c010b82 @x1
@x2))
(and 
;; def=FStar.DM4F.Exceptions.fst(35,58-36,13); use=FStar.DM4F.Exceptions.fst(36,4-36,13)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(FStar.DM4F.Exceptions.ex @x1)))
 

:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_6b1a979213c5a0ede73827923c010b82.1))
...
(Tm_arrow_6b1a979213c5a0ede73827923c010b82 @x1
@x2)))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_6b1a979213c5a0ede73827923c010b82))

:named FStar.DM4F.Exceptions_interpretation_Tm_arrow_6b1a979213c5a0ede73827923c010b82))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (f: FStar.DM4F.Exceptions.ex a)
;   (g: (g: a -> FStar.DM4F.Exceptions.ex b))
;   (_: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post (FStar.Pervasives.either b Prims.exn)).
;     (forall (x: FStar.Pervasives.either b Prims.exn). {:pattern Prims.guard_free (k x)}
;         Prims.auto_squash (k x)) ==>
;     ~(Inr? (f ())) /\ ~(Inl? (f ())) ==> Prims.l_False
...
(Prims.pure_post (FStar.Pervasives.either @x1
Prims.exn)))

;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.Exceptions.fst(36,30-40,19)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.Exceptions.fst(36,30-40,19)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.Exceptions.fst(36,30-40,19)
(ApplyTT @x5
@x6)
...
;; def=FStar.DM4F.Exceptions.fst(37,6-37,7); use=FStar.DM4F.Exceptions.fst(38,8-38,9)
(not 
;; def=FStar.DM4F.Exceptions.fst(37,6-37,7); use=FStar.DM4F.Exceptions.fst(38,8-38,9)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Exceptions.bind_ex, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.Exceptions_interpretation_Tm_arrow_72cdc0c9c0d847eb228998a5a6607da8, disc_equation_FStar.Pervasives.Inl, disc_equation_FStar.Pervasives.Inr, equation_FStar.DM4F.Exceptions.ex, fuel_guarded_inversion_FStar.Pervasives.either, projection_inverse_BoxBool_proj_0, unit_typing
...
;;;;;;;;;;;;;;;;g: a -> ex b
(declare-fun Tm_arrow_6b1a979213c5a0ede73827923c010b82 (Term Term) Term)
(declare-fun FStar.DM4F.Exceptions.bind_ex (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> f: ex a -> g: (g: a -> ex b) -> ex b
(declare-fun Tm_arrow_11e12c0d4a6a89d9274979a77116f7ae () Term)
(declare-fun FStar.DM4F.Exceptions.bind_ex@tok () Term)

(declare-fun Tm_abs_4416c144504520157d3d9e4cbf91a72c (Term Term Term) Term)

; </end encoding let bind_ex>


; encoding sigelt let raise0


; <Start encoding let raise0>

(declare-fun FStar.DM4F.Exceptions.raise0 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> e: Prims.exn -> ex a
(declare-fun Tm_arrow_3f9c911e5e61be22a0517f6fd650ab31 () Term)
(declare-fun FStar.DM4F.Exceptions.raise0@tok () Term)
(declare-fun Tm_abs_64200c495c053c32205dcfababcf728f (Term Term) Term)

; </end encoding let raise0>


; encoding sigelt let _dm4f_EXN_lift_from_pure


; <Start encoding let _dm4f_EXN_lift_from_pure>


;;;;;;;;;;;;;;;;_: (_: a -> Type) -> Type
(declare-fun Tm_arrow_11b93b1a25b26195b88e72dd87199600 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.either a Prims.exn -> Type
(declare-fun Tm_arrow_74e862599ed71165ef4c4d59b4428110 (Term) Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     _: Prims.unit ->     p': (_: FStar.Pervasives.either a Prims.exn -> Type)   -> Type
(declare-fun Tm_arrow_a830cc6b198c5808d86952cddc014ee4 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_lift_from_pure@tok () Term)




(declare-fun Tm_abs_a77d4c52b84c96c62629058dae2b1223 (Term Term) Term)

; </end encoding let _dm4f_EXN_lift_from_pure>


; encoding sigelt let _dm4f_EXN_return_wp


; <Start encoding let _dm4f_EXN_return_wp>


(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> _: Prims.unit -> p': (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type
(declare-fun Tm_arrow_46441f5dab2abed424871ea3d4c0d0f7 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_return_wp@tok () Term)


; </end encoding let _dm4f_EXN_return_wp>


; encoding sigelt let _dm4f_EXN_return_elab


; <Start encoding let _dm4f_EXN_return_elab>

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_return_elab (Term Term Term) Term)
(declare-fun Tm_refine_dfadd5876bf3e158d9733bc4b0837426 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> _: Prims.unit -> Prims.PURE (FStar.Pervasives.either a Prims.exn)
(declare-fun Tm_arrow_b347b995e531b798022dc024dcd0c769 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_return_elab@tok () Term)


; </end encoding let _dm4f_EXN_return_elab>


; encoding sigelt let _dm4f_EXN_bind_wp


; <Start encoding let _dm4f_EXN_bind_wp>


;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type
(declare-fun Tm_arrow_42b4559a8821d37147ff9d6de985f108 (Term) Term)


;;;;;;;;;;;;;;;;g: a -> _: Prims.unit -> _: (_: FStar.Pervasives.either b Prims.exn -> Type) -> Type
(declare-fun Tm_arrow_c16c2a11ee554c93ffe42422143e6ecc (Term Term) Term)

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type) ->     g: (g: a -> _: Prims.unit -> _: (_: FStar.Pervasives.either b Prims.exn -> Type) -> Type) ->     _: Prims.unit ->     p'': (_: FStar.Pervasives.either b Prims.exn -> Type)   -> Type
(declare-fun Tm_arrow_dacf2af61919a2e4c7016cc451c79b7e () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_bind_wp@tok () Term)
...
(declare-fun Tm_abs_10f6a510a67b23e7fa4e932675fccac0 (Term Term Term Term) Term)

; </end encoding let _dm4f_EXN_bind_wp>


; encoding sigelt let _dm4f_EXN_bind_elab


; <Start encoding let _dm4f_EXN_bind_elab>



(declare-fun Tm_refine_e4acc32a0bad14133ab8803ed1c4464a (Term) Term)

;;;;;;;;;;;;;;;;y: _: FStar.Pervasives.either a Prims.exn {Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_1e94a36430dd1a5bd37eb7c214071cc8 (Term) Term)
(declare-fun Tm_abs_7aba4abc55addfa0275f77d7dcc9a358 (Term Term) Term)
(declare-fun Tm_refine_addb76a5aa231a4e4de19f284d0beeba (Term Term Term) Term)



(declare-fun Tm_abs_dbfdce2855c13db8c55bce35acee1690 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Pervasives.either a Prims.exn)
(declare-fun Tm_arrow_fd0b486d8927213ebf6141c3cd322f4c (Term Term) Term)
...
(declare-fun Tm_refine_36e24c88b4dc118e4ff4a9a45d21f529 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Pervasives.either b Prims.exn)
(declare-fun Tm_arrow_0455b5582f5a64f91b77dd16dac13a22 (Term Term Term) Term)
;;;;;;;;;;;;;;;;g__x: a -> _: Prims.unit -> Prims.PURE (FStar.Pervasives.either b Prims.exn)
(declare-fun Tm_arrow_217456f6c7ab4539e2c788ca538db171 (Term Term Term) Term)





(declare-fun Tm_abs_a6c232152dff97b2178443c64b346396 (Term Term Term) Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_bind_elab (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_3ea71dcef38343a8a1867c59f5fd95b6 (Term Term Term Term) Term)
(declare-fun Tm_refine_080a67f72571ddb14dcb21514f0666ad (Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f__w: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type) ->     f: (_: Prims.unit -> Prims.PURE (FStar.Pervasives.either a Prims.exn)) ->     g__w: (g: a -> _: Prims.unit -> _: (_: FStar.Pervasives.either b Prims.exn -> Type) -> Type) ->     g: (g__x: a -> _: Prims.unit -> Prims.PURE (FStar.Pervasives.either b Prims.exn)) ->     _: Prims.unit   -> Prims.PURE (FStar.Pervasives.either b Prims.exn)
(declare-fun Tm_arrow_3649c5ef41e08c64e59a25adfe6bc45d () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_bind_elab@tok () Term)
...
; </end encoding let _dm4f_EXN_bind_elab>


; encoding sigelt let _dm4f_EXN___proj__EXN__item__raise_elab


; <Start encoding let _dm4f_EXN___proj__EXN__item__raise_elab>

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_elab (Term Term) Term)
(declare-fun Tm_refine_62db490e3440ced78f38fae84a8b0240 (Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Pervasives.either a Prims.exn)
(declare-fun Tm_arrow_837d6fb4dd08f1b676881c282fba65dc (Term Term) Term)
;;;;;;;;;;;;;;;;e: Prims.exn -> _: Prims.unit -> Prims.PURE (FStar.Pervasives.either a Prims.exn)
(declare-fun Tm_arrow_9812e2765adf7fe0afbb22bd49833273 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_elab@tok () Term)




; </end encoding let _dm4f_EXN___proj__EXN__item__raise_elab>


; encoding sigelt let _dm4f_EXN___proj__EXN__item__raise_complete_type


; <Start encoding let _dm4f_EXN___proj__EXN__item__raise_complete_type>

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_complete_type () Term)




; </end encoding let _dm4f_EXN___proj__EXN__item__raise_complete_type>


; encoding sigelt let _dm4f_EXN_repr


; <Start encoding let _dm4f_EXN_repr>



(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp_a: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type)   -> Type
(declare-fun Tm_arrow_0d830e5c6cfce39c93888a5b43e66ee6 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_repr@tok () Term)
...
; </end encoding let _dm4f_EXN_repr>


; encoding sigelt let _dm4f_EXN_pre


; <Start encoding let _dm4f_EXN_pre>

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_pre () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Type
(declare-fun Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe () Term)

; </end encoding let _dm4f_EXN_pre>


; encoding sigelt let _dm4f_EXN_post


; <Start encoding let _dm4f_EXN_post>

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_post (Term) Term)

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_post@tok () Term)


; </end encoding let _dm4f_EXN_post>


; encoding sigelt let _dm4f_EXN_wp


; <Start encoding let _dm4f_EXN_wp>

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_wp (Term) Term)

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_wp@tok () Term)



; </end encoding let _dm4f_EXN_wp>


; encoding sigelt let _dm4f_EXN_ctx


; <Start encoding let _dm4f_EXN_ctx>

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_ctx (Term Term) Term)

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> t
(declare-fun Tm_arrow_9d18e8ae57adbd23ace2b7370d93b9f0 (Term Term) Term)

; </end encoding let _dm4f_EXN_ctx>


; encoding sigelt let _dm4f_EXN_gctx


; <Start encoding let _dm4f_EXN_gctx>

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_gctx (Term Term) Term)

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Prims.GTot t
(declare-fun Tm_ghost_arrow_ce143c75d3a5c7501747e29e8bb00348 (Term Term) Term)

; </end encoding let _dm4f_EXN_gctx>


; encoding sigelt let _dm4f_EXN_pure


; <Start encoding let _dm4f_EXN_pure>


(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> t
(declare-fun Tm_arrow_56279a95bbb919314672377e75ed6197 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_pure@tok () Term)


; </end encoding let _dm4f_EXN_pure>


; encoding sigelt let _dm4f_EXN_app


; <Start encoding let _dm4f_EXN_app>



;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_1c70b20b23f9a484328fc4f5a4ca9f42 (Term Term Term) Term)



(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Prims.GTot t1) ->     _: Prims.unit ->     _: (_: FStar.Pervasives.either a Prims.exn -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_91da76a1be724c06683b4e796a123882 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_app@tok () Term)
...
; </end encoding let _dm4f_EXN_app>


; encoding sigelt let _dm4f_EXN_lift1


; <Start encoding let _dm4f_EXN_lift1>




(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Prims.GTot t1) ->     _: Prims.unit ->     _: (_: FStar.Pervasives.either a Prims.exn -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_eedb5d19bacd9fe28071c55cfba50959 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_lift1@tok () Term)
...
(declare-fun Tm_abs_5a3e377a7c5a59bd41a66cc68ed3db14 (Term Term Term Term) Term)

; </end encoding let _dm4f_EXN_lift1>


; encoding sigelt let _dm4f_EXN_lift2


; <Start encoding let _dm4f_EXN_lift2>
...
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Prims.GTot t1) ->     a2: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Prims.GTot t2) ->     _: Prims.unit ->     _: (_: FStar.Pervasives.either a Prims.exn -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_339989547477f5f81cc929c82be9f396 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_lift2@tok () Term)
...
(declare-fun Tm_abs_c997d9805305982555334abc1ec98b6a (Term Term Term Term Term) Term)

; </end encoding let _dm4f_EXN_lift2>


; encoding sigelt let _dm4f_EXN_push


; <Start encoding let _dm4f_EXN_push>



;;;;;;;;;;;;;;;;_: t1 -> _: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Prims.GTot t2
(declare-fun Tm_arrow_81def73975344de40674be3779db542e (Term Term Term) Term)

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f:       (_: t1 -> _: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type)           -> Prims.GTot t2) ->     _: Prims.unit ->     _: (_: FStar.Pervasives.either a Prims.exn -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_359b6b5262419296293f6a92900303bd () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_push@tok () Term)





; </end encoding let _dm4f_EXN_push>


; encoding sigelt let _dm4f_EXN_wp_if_then_else


; <Start encoding let _dm4f_EXN_wp_if_then_else>

(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type) ->     _: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type) ->     _: Prims.unit ->     _: (_: FStar.Pervasives.either a Prims.exn -> Type)   -> Type
(declare-fun Tm_arrow_d92e408b5b75d691aef0abf34f202ea5 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type) ->     _: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type) ->     _: Prims.unit ->     _: (_: FStar.Pervasives.either a Prims.exn -> Type)   -> Type
(declare-fun Tm_arrow_07d675b071eb6e85de05948f43d7e2b4 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_2fbd9fc889fd577c7d74e825236f4724 (Term) Term)
...
;;;;;;;;;;;;;;;;a1:       (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type)           -> Prims.GTot Prims.logical) ->     a2:       (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type)           -> Prims.GTot Prims.logical) ->     _: Prims.unit ->     _: (_: FStar.Pervasives.either a Prims.exn -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_74fb5b9f2132ee272d894305124f0a08 (Term) Term)
(declare-fun Tm_abs_0325b7041ac3baae9833774f55d41317 (Term Term) Term)

; </end encoding let _dm4f_EXN_wp_if_then_else>


; encoding sigelt let _dm4f_EXN_wp_close


; <Start encoding let _dm4f_EXN_wp_close>




(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: b -> _: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type) ->     _: Prims.unit ->     _: (_: FStar.Pervasives.either a Prims.exn -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_9837f8abd97054ab006a70853cd25c57 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_wp_close@tok () Term)
...
(declare-fun Tm_abs_c852c187ffea8b249fdbaa334dfd0d40 (Term Term Term) Term)

; </end encoding let _dm4f_EXN_wp_close>


; encoding sigelt let _dm4f_EXN_stronger


; <Start encoding let _dm4f_EXN_stronger>





(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type) ->     wp2: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_5b3475f76c65718f820027b074c32846 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_stronger@tok () Term)
...
; </end encoding let _dm4f_EXN_stronger>


; encoding sigelt let _dm4f_EXN_ite_wp


; <Start encoding let _dm4f_EXN_ite_wp>




(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type) ->     _: Prims.unit ->     _: (_: FStar.Pervasives.either a Prims.exn -> Type)   -> Prims.logical
(declare-fun Tm_arrow_7cb1b48b2663d32107dbb228b84d7cfa () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_ite_wp@tok () Term)





; </end encoding let _dm4f_EXN_ite_wp>


; encoding sigelt let _dm4f_EXN_null_wp


; <Start encoding let _dm4f_EXN_null_wp>


(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> _: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Prims.logical
(declare-fun Tm_arrow_381c2350c7b59db466ebcad5c0ecbf6f () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_null_wp@tok () Term)


; </end encoding let _dm4f_EXN_null_wp>


; encoding sigelt let _dm4f_EXN_wp_trivial


; <Start encoding let _dm4f_EXN_wp_trivial>



(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: (_: Prims.unit -> _: (_: FStar.Pervasives.either a Prims.exn -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_d3517c249b64dc810cae0f7a7c2374d8 () Term)
(declare-fun FStar.DM4F.Exceptions._dm4f_EXN_wp_trivial@tok () Term)




; </end encoding let _dm4f_EXN_wp_trivial>


; encoding sigelt new_effect_for_free { EXN ... }


; <Start encoding new_effect_for_free { EXN ... }>





(declare-fun Tm_abs_5c6cfbc6e316b08c7e62522257bdc1a5 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.Exceptions.__proj__EXN__item__raise (Term Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.Exceptions.__proj__EXN__item__raise@tok () Term)

; </end encoding new_effect_for_free { EXN ... }>


; encoding sigelt sub_effect PURE ~> EXN


; <Skipped sub_effect PURE ~> EXN/>
...
(declare-fun FStar.DM4F.Exceptions.raise (Term) Term)
(declare-fun Non_total_Tm_arrow_0a94a90560d409b7ff0b72c375936c0b (Term) Term)
;;;;;;;;;;;;;;;;e__x: Prims.exn -> EXN _
(declare-fun Tm_arrow_d0b01ad27773e685b2fc23a65bc35027 () Term)
(declare-fun FStar.DM4F.Exceptions.raise@tok () Term)


; </end encoding let raise>


; encoding sigelt effect Exn a pre post = FStar.DM4F.Exceptions.EXN a


; <Skipped effect Exn a pre post = FStar.DM4F.Exceptions.EXN a/>


; encoding sigelt effect Ex a = FStar.DM4F.Exceptions.EXN a


; <Skipped effect Ex a = FStar.DM4F.Exceptions.EXN a/>


; encoding sigelt datacon FStar.DM4F.Exceptions.Division_by_zero for type Prims.exn


; <Start encoding datacon FStar.DM4F.Exceptions.Division_by_zero for type Prims.exn>

;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.Exceptions.Division_by_zero () Term)
;;;;;;;;;;;;;;;;Constructor base
(declare-fun FStar.DM4F.Exceptions.Division_by_zero@base () Term)
;;;;;;;;;;;;;;;;data constructor proxy: FStar.DM4F.Exceptions.Division_by_zero
(declare-fun FStar.DM4F.Exceptions.Division_by_zero@tok () Term)

; <start constructor FStar.DM4F.Exceptions.Division_by_zero>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.Exceptions.Division_by_zero ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
722)
(= __@x0
FStar.DM4F.Exceptions.Division_by_zero)))

; </end constructor FStar.DM4F.Exceptions.Division_by_zero>


; </end encoding datacon FStar.DM4F.Exceptions.Division_by_zero for type Prims.exn>


; encoding sigelt val FStar.DM4F.Exceptions.uu___is_Division_by_zero


; <Start encoding val FStar.DM4F.Exceptions.uu___is_Division_by_zero>

(declare-fun FStar.DM4F.Exceptions.uu___is_Division_by_zero (Term) Term)
;;;;;;;;;;;;;;;;projectee: Prims.exn -> Prims.bool
(declare-fun Tm_arrow_81ab3356926b82578fcb92e97b412345 () Term)
(declare-fun FStar.DM4F.Exceptions.uu___is_Division_by_zero@tok () Term)

; </end encoding val FStar.DM4F.Exceptions.uu___is_Division_by_zero>


; encoding sigelt let uu___is_Division_by_zero


; <Skipped let uu___is_Division_by_zero/>


; encoding sigelt val FStar.DM4F.Exceptions.div_intrinsic


; <Skipped val FStar.DM4F.Exceptions.div_intrinsic/>

;;;;;;;;;;;;;;;;Constructor base
;;; Fact-ids: Name FStar.DM4F.Exceptions.Division_by_zero; Namespace FStar.DM4F.Exceptions
(assert (! (implies (is-FStar.DM4F.Exceptions.Division_by_zero FStar.DM4F.Exceptions.Division_by_zero)
(= FStar.DM4F.Exceptions.Division_by_zero
FStar.DM4F.Exceptions.Division_by_zero@base))
:named constructor_base_FStar.DM4F.Exceptions.Division_by_zero))
...
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name FStar.DM4F.Exceptions.Division_by_zero; Namespace FStar.DM4F.Exceptions
(assert (! (HasType FStar.DM4F.Exceptions.Division_by_zero@tok
Prims.exn)
:named typing_tok_FStar.DM4F.Exceptions.Division_by_zero@tok))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name FStar.DM4F.Exceptions.Division_by_zero; Namespace FStar.DM4F.Exceptions
(assert (! (= FStar.DM4F.Exceptions.Division_by_zero@tok
FStar.DM4F.Exceptions.Division_by_zero)
:named equality_tok_FStar.DM4F.Exceptions.Division_by_zero@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FStar.DM4F.Exceptions.Division_by_zero; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(92,10-92,26); use=FStar.DM4F.Exceptions.fst(92,10-92,26)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
FStar.DM4F.Exceptions.Division_by_zero
Prims.exn)
...
FStar.DM4F.Exceptions.Division_by_zero
Prims.exn))
:qid data_typing_intro_FStar.DM4F.Exceptions.Division_by_zero@tok))

:named data_typing_intro_FStar.DM4F.Exceptions.Division_by_zero@tok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (= 303
...
;;; Fact-ids: Name FStar.DM4F.Exceptions.Division_by_zero; Namespace FStar.DM4F.Exceptions
(assert (! (= 722
(Term_constr_id FStar.DM4F.Exceptions.Division_by_zero))
:named constructor_distinct_FStar.DM4F.Exceptions.Division_by_zero))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! 
...
; Starting query at FStar.DM4F.Exceptions.fst(99,2-100,12)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.either Prims.int Prims.exn -> Type
(declare-fun Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35
Tm_type)
:named kinding_Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,28-29,42); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35))
:qid FStar.DM4F.Exceptions_pre_typing_Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35))

:named FStar.DM4F.Exceptions_pre_typing_Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,28-29,42); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(forall ((@x0 Term))
...
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.Pervasives.either Prims.int
Prims.exn))
(HasType (ApplyTT @x0
@x1)
Tm_type))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35))

:named FStar.DM4F.Exceptions_interpretation_Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35))

; Encoding query formula : forall (i: Prims.nat) (j: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.unit) (p: Prims.pure_post (FStar.Pervasives.either Prims.int Prims.exn)).
;     (forall (r: FStar.Pervasives.either Prims.int Prims.exn).
;         (match r with
;           | FStar.Pervasives.Inr FStar.DM4F.Exceptions.Division_by_zero -> j = 0
;           | FStar.Pervasives.Inl z -> j <> 0 /\ z = i / j
;           | _ -> Prims.l_True) ==>
;         p r) ==>
;     (forall (k: (_: FStar.Pervasives.either Prims.int Prims.exn -> Type0)).
;         (forall (a1: FStar.Pervasives.either Prims.int Prims.exn).
;             {:pattern Prims.guard_free (k a1)}
;             k a1 <==> p a1) ==>
;         (j = 0 = true ==>
;           j = 0 == true ==> k (FStar.Pervasives.Inr FStar.DM4F.Exceptions.Division_by_zero)) /\
;         (~(j = 0 = true) ==>
;           (forall (b: Prims.bool).
;               j = 0 == b ==>
;               j <> 0 /\
...
;                           return_val == any_result ==> k (FStar.Pervasives.Inl return_val)))))))
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.unit)
(HasType @x3
(Prims.pure_post (FStar.Pervasives.either Prims.int
Prims.exn)))

;; def=FStar.DM4F.Exceptions.fst(60,10-60,60); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.either Prims.int
Prims.exn))
(let ((@lb5 @x4))
(ite (and (is-FStar.Pervasives.Inr @lb5)
(is-FStar.DM4F.Exceptions.Division_by_zero (FStar.Pervasives.Inr_v @lb5)))

;; def=FStar.DM4F.Exceptions.fst(96,47-96,50); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(= @x1
(BoxInt 0))

(implies (is-FStar.Pervasives.Inl @lb5)

;; def=FStar.DM4F.Exceptions.fst(96,62-96,79); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(and 
;; def=FStar.DM4F.Exceptions.fst(96,62-96,66); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(not (= @x1
(BoxInt 0)))


;; def=FStar.DM4F.Exceptions.fst(96,70-96,79); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(= (FStar.Pervasives.Inl_v @lb5)
(Prims.op_Division @x0
@x1))
)
))))

;; def=FStar.DM4F.Exceptions.fst(60,56-60,59); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(Valid 
;; def=FStar.DM4F.Exceptions.fst(60,56-60,59); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(221,62-221,85); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(and (implies 
;; def=Prims.fst(221,62-221,71); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(and 
;; def=FStar.DM4F.Exceptions.fst(99,5-99,8); use=FStar.DM4F.Exceptions.fst(99,5-99,8)
...
;; def=FStar.DM4F.Exceptions.fst(42,46-42,51); use=FStar.DM4F.Exceptions.fst(99,14-99,19)
(or label_1
...
;; def=FStar.DM4F.Exceptions.fst(42,46-42,51); use=FStar.DM4F.Exceptions.fst(99,14-99,19)
(ApplyTT @x4
(FStar.Pervasives.Inr Prims.int
Prims.exn
FStar.DM4F.Exceptions.Division_by_zero@tok))
)
)
)
(implies 
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(not 
;; def=FStar.DM4F.Exceptions.fst(99,5-99,8); use=FStar.DM4F.Exceptions.fst(99,5-99,8)
(= (Prims.op_Equality Prims.int
@x1
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=FStar.DM4F.Exceptions.fst(99,5-100,12); use=FStar.DM4F.Exceptions.fst(99,5-100,12)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
@x5)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(and 
;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.Exceptions.fst(100,11-100,12)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(forall ((@x6 Term))
...
;; def=FStar.DM4F.Exceptions.fst(94,42-100,12); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(= @x7
(Prims.op_Division @x0
@x1))
)

;; def=Prims.fst(356,2-356,58); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.int)

;; def=Prims.fst(356,26-356,41); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(= @x8
@x7)
)

;; def=FStar.DM4F.Exceptions.fst(33,29-33,34); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(or label_3
...
;; def=FStar.DM4F.Exceptions.fst(33,29-33,34); use=FStar.DM4F.Exceptions.fst(99,2-100,12)
(ApplyTT @x4
(FStar.Pervasives.Inl Prims.int
Prims.exn
@x8))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Exceptions.div_intrinsic, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_2feddfe489e78a01f5d2e9b55172b46a, Prims_pretyping_ae567c2fb75be05905677af440075565, constructor_distinct_FStar.DM4F.Exceptions.Division_by_zero, constructor_distinct_FStar.Pervasives.Inl, constructor_distinct_FStar.Pervasives.Inr, data_typing_intro_FStar.Pervasives.Inl@tok, data_typing_intro_FStar.Pervasives.Inr@tok, equality_tok_FStar.DM4F.Exceptions.Division_by_zero@tok, equation_Prims.eqtype, function_token_typing_Prims.__cache_version_number__, int_inversion, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Inl_v, projection_inverse_FStar.Pervasives.Inr_a, projection_inverse_FStar.Pervasives.Inr_b, projection_inverse_FStar.Pervasives.Inr_v, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.exn, typing_Prims.int, typing_tok_FStar.DM4F.Exceptions.Division_by_zero@tok
...
(declare-fun FStar.DM4F.Exceptions.div_intrinsic (Term Term) Term)
(declare-fun Non_total_Tm_arrow_e245423fa8b02c631e8e33bf9f1c3ec9 () Term)
(declare-fun FStar.DM4F.Exceptions.div_intrinsic@tok () Term)
(declare-fun Tm_refine_c6b34a9ee0f5d41effabfeacad852fce (Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Pervasives.either Prims.int Prims.exn)
(declare-fun Tm_arrow_9c6c4f91e0ae82acbceb1f2c312da420 (Term Term) Term)
(declare-fun Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f (Term Term) Term)

; </end encoding let div_intrinsic>

(push) ;; push{2

; Starting query at FStar.DM4F.Exceptions.fst(103,2-104,12)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,28-29,42); use=FStar.DM4F.Exceptions.fst(103,2-104,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_52b4ca9f56c56bd1c37c6c0117880a35)
...
; *)
;   forall (_: Prims.unit) (p: Prims.pure_post (FStar.Pervasives.either Prims.int Prims.exn)).
;     (forall (x: FStar.Pervasives.either Prims.int Prims.exn). p x) ==>
;     (forall (k: (_: FStar.Pervasives.either Prims.int Prims.exn -> Type0)).
;         (forall (a1: FStar.Pervasives.either Prims.int Prims.exn).
;             {:pattern Prims.guard_free (k a1)}
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Exceptions.fst(103,2-104,12)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.unit)
(HasType @x3
...
;; def=FStar.DM4F.Exceptions.fst(65,39-65,52); use=FStar.DM4F.Exceptions.fst(103,2-104,12)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.Pervasives.either Prims.int
Prims.exn))

;; def=FStar.DM4F.Exceptions.fst(65,49-65,52); use=FStar.DM4F.Exceptions.fst(103,2-104,12)
(Valid 
;; def=FStar.DM4F.Exceptions.fst(65,49-65,52); use=FStar.DM4F.Exceptions.fst(103,2-104,12)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.Exceptions.fst(103,2-104,12)
(not 
;; def=FStar.DM4F.Exceptions.fst(103,5-103,8); use=FStar.DM4F.Exceptions.fst(103,5-103,8)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
(BoxBool true))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.Exceptions.fst(103,2-104,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=FStar.DM4F.Exceptions.fst(103,5-104,12); use=FStar.DM4F.Exceptions.fst(103,5-104,12)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
@x5)
...
;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.Exceptions.fst(104,11-104,12)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Exceptions.div_extrinsic, 1)
; STATUS: unsat
...
(declare-fun FStar.DM4F.Exceptions.div_extrinsic (Term Term) Term)
(declare-fun Non_total_Tm_arrow_53e7ea9cd152725e54ceb46e51725e2f () Term)
(declare-fun FStar.DM4F.Exceptions.div_extrinsic@tok () Term)
(declare-fun Tm_refine_45169deb6dbf5ae881e96d5c771b782f () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE (FStar.Pervasives.either Prims.int Prims.exn)
(declare-fun Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97 () Term)



; </end encoding let div_extrinsic>

;;;;;;;;;;;;;;;;typing_Tm_abs_5c6cfbc6e316b08c7e62522257bdc1a5
;;; Fact-ids: Name FStar.DM4F.Exceptions.EXN; Namespace FStar.DM4F.Exceptions
(assert (! (HasType Tm_abs_5c6cfbc6e316b08c7e62522257bdc1a5
Tm_arrow_9812e2765adf7fe0afbb22bd49833273)
:named typing_Tm_abs_5c6cfbc6e316b08c7e62522257bdc1a5))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Exceptions.uu___is_Division_by_zero; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(92,10-92,26); use=FStar.DM4F.Exceptions.fst(92,10-92,26)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.exn)
(HasType (FStar.DM4F.Exceptions.uu___is_Division_by_zero @x0)
Prims.bool))
 

:pattern ((FStar.DM4F.Exceptions.uu___is_Division_by_zero @x0))
:qid typing_FStar.DM4F.Exceptions.uu___is_Division_by_zero))

:named typing_FStar.DM4F.Exceptions.uu___is_Division_by_zero))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Exceptions.raise; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(54,4-54,9); use=FStar.DM4F.Exceptions.fst(54,4-54,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.Exceptions.raise @x0)
(Non_total_Tm_arrow_0a94a90560d409b7ff0b72c375936c0b @x0)))
 

:pattern ((FStar.DM4F.Exceptions.raise @x0))
:qid typing_FStar.DM4F.Exceptions.raise))

:named typing_FStar.DM4F.Exceptions.raise))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_extrinsic; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(102,5-102,18); use=FStar.DM4F.Exceptions.fst(102,5-102,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
Prims.int))
(HasType (FStar.DM4F.Exceptions.div_extrinsic @x0
@x1)
Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97))
 

:pattern ((FStar.DM4F.Exceptions.div_extrinsic @x0
@x1))
:qid typing_FStar.DM4F.Exceptions.div_extrinsic))

:named typing_FStar.DM4F.Exceptions.div_extrinsic))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_intrinsic; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(33,29-33,34); use=FStar.DM4F.Exceptions.fst(33,29-33,34)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f @x0
@x1))
 

:pattern ((Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f @x0
@x1))
:qid tot_fun_Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f))

:named tot_fun_Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name FStar.DM4F.Exceptions.raise; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(54,4-54,9); use=FStar.DM4F.Exceptions.fst(54,4-54,9)
(forall ((@x0 Term))
 (! (= (ApplyTT FStar.DM4F.Exceptions.raise@tok
@x0)
(FStar.DM4F.Exceptions.raise @x0))
 

:pattern ((ApplyTT FStar.DM4F.Exceptions.raise@tok
@x0))
:qid token_correspondence_FStar.DM4F.Exceptions.raise))

:named token_correspondence_FStar.DM4F.Exceptions.raise))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Pervasives.__proj__Inr__item__v; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(732,4-732,7); use=FStar.Pervasives.fsti(732,4-732,7)
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_elab; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.Pervasives.fsti(732,18-732,28); use=FStar.DM4F.Exceptions.fst(42,46-42,49)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_62db490e3440ced78f38fae84a8b0240 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_62db490e3440ced78f38fae84a8b0240 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_62db490e3440ced78f38fae84a8b0240))

:named refinement_kinding_Tm_refine_62db490e3440ced78f38fae84a8b0240))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_extrinsic; Namespace FStar.DM4F.Exceptions
(assert (! (HasType Tm_refine_45169deb6dbf5ae881e96d5c771b782f
Tm_type)
:named refinement_kinding_Tm_refine_45169deb6dbf5ae881e96d5c771b782f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.__proj__Inr__item__v; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(732,4-732,7); use=FStar.Pervasives.fsti(732,4-732,7)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_62db490e3440ced78f38fae84a8b0240 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.either @x2
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.Exceptions.fst(42,46-42,49)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.Exceptions.fst(42,46-42,49)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.Exceptions.fst(42,46-42,49)
(= (FStar.Pervasives.Inr @x2
Prims.exn
@x3)
@x1)
)
...
(Tm_refine_62db490e3440ced78f38fae84a8b0240 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_62db490e3440ced78f38fae84a8b0240))

:named refinement_interpretation_Tm_refine_62db490e3440ced78f38fae84a8b0240))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_extrinsic; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,28-29,42); use=FStar.DM4F.Exceptions.fst(29,28-29,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_45169deb6dbf5ae881e96d5c771b782f)
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.either Prims.int
Prims.exn))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.Exceptions.fst(29,28-29,42)
(not 
;; def=FStar.DM4F.Exceptions.fst(65,39-65,52); use=FStar.DM4F.Exceptions.fst(102,37-102,39)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.Pervasives.either Prims.int
Prims.exn))

;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.Exceptions.fst(29,28-29,42)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.Exceptions.fst(29,28-29,42)
(= @x2
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_45169deb6dbf5ae881e96d5c771b782f.1))
)
))
...
@x1
Tm_refine_45169deb6dbf5ae881e96d5c771b782f))
:qid refinement_interpretation_Tm_refine_45169deb6dbf5ae881e96d5c771b782f))

:named refinement_interpretation_Tm_refine_45169deb6dbf5ae881e96d5c771b782f))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name FStar.Pervasives.__proj__Inr__item__v; Namespace FStar.Pervasives
(assert (! 
;; def=FStar.Pervasives.fsti(732,10-732,11); use=FStar.Pervasives.fsti(732,10-732,11)
...
;;; Fact-ids: Name FStar.DM4F.Exceptions.raise; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(42,23-54,22); use=FStar.DM4F.Exceptions.fst(54,0-54,22)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Non_total_Tm_arrow_0a94a90560d409b7ff0b72c375936c0b @x0)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_0a94a90560d409b7ff0b72c375936c0b @x0)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_0a94a90560d409b7ff0b72c375936c0b))

:named non_total_function_typing_Non_total_Tm_arrow_0a94a90560d409b7ff0b72c375936c0b))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d0b01ad27773e685b2fc23a65bc35027
;;; Fact-ids: Name FStar.DM4F.Exceptions.raise; Namespace FStar.DM4F.Exceptions
(assert (! (HasType Tm_arrow_d0b01ad27773e685b2fc23a65bc35027
Tm_type)
:named kinding_Tm_arrow_d0b01ad27773e685b2fc23a65bc35027))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9812e2765adf7fe0afbb22bd49833273
;;; Fact-ids: Name FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_elab; Namespace FStar.DM4F.Exceptions
(assert (! (HasType Tm_arrow_9812e2765adf7fe0afbb22bd49833273
Tm_type)
:named kinding_Tm_arrow_9812e2765adf7fe0afbb22bd49833273))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_837d6fb4dd08f1b676881c282fba65dc
;;; Fact-ids: Name FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_elab; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,18-29,22); use=FStar.DM4F.Exceptions.fst(29,18-42,49)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_837d6fb4dd08f1b676881c282fba65dc @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_837d6fb4dd08f1b676881c282fba65dc @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_837d6fb4dd08f1b676881c282fba65dc))

:named kinding_Tm_arrow_837d6fb4dd08f1b676881c282fba65dc))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_extrinsic; Namespace FStar.DM4F.Exceptions
(assert (! (HasType Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97
Tm_type)
:named kinding_Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_intrinsic; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(33,29-33,34); use=FStar.DM4F.Exceptions.fst(33,29-33,34)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f @x1
@x2)
@x0)
(FStar.Pervasives.Inl Prims.int
Prims.exn
...
:pattern ((ApplyTT (Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f @x1
@x2)
@x0))
:qid interpretation_Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f))

:named interpretation_Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_64200c495c053c32205dcfababcf728f
;;; Fact-ids: Name FStar.DM4F.Exceptions.raise0; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(42,46-42,51); use=FStar.DM4F.Exceptions.fst(42,46-42,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_64200c495c053c32205dcfababcf728f @x1
@x2)
@x0)
(FStar.Pervasives.Inr @x2
Prims.exn
...
:pattern ((ApplyTT (Tm_abs_64200c495c053c32205dcfababcf728f @x1
@x2)
@x0))
:qid interpretation_Tm_abs_64200c495c053c32205dcfababcf728f))

:named interpretation_Tm_abs_64200c495c053c32205dcfababcf728f))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_5c6cfbc6e316b08c7e62522257bdc1a5
;;; Fact-ids: Name FStar.DM4F.Exceptions.EXN; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(42,46-42,51); use=FStar.DM4F.Exceptions.fst(42,46-42,51)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_5c6cfbc6e316b08c7e62522257bdc1a5
@x0)
@x1)
(Tm_abs_64200c495c053c32205dcfababcf728f @x1
@x0))
 

:pattern ((ApplyTT (ApplyTT Tm_abs_5c6cfbc6e316b08c7e62522257bdc1a5
@x0)
@x1))
:qid interpretation_Tm_abs_5c6cfbc6e316b08c7e62522257bdc1a5))

:named interpretation_Tm_abs_5c6cfbc6e316b08c7e62522257bdc1a5))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_62db490e3440ced78f38fae84a8b0240
;;; Fact-ids: Name FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_elab; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.Pervasives.fsti(732,18-732,28); use=FStar.DM4F.Exceptions.fst(42,46-42,49)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_62db490e3440ced78f38fae84a8b0240 @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.either @x0
Prims.exn))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_62db490e3440ced78f38fae84a8b0240 @x0
@x1))))
:qid haseqTm_refine_62db490e3440ced78f38fae84a8b0240))

:named haseqTm_refine_62db490e3440ced78f38fae84a8b0240))
;;;;;;;;;;;;;;;;haseq for Tm_refine_45169deb6dbf5ae881e96d5c771b782f
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_extrinsic; Namespace FStar.DM4F.Exceptions
(assert (! (iff (Valid (Prims.hasEq Tm_refine_45169deb6dbf5ae881e96d5c771b782f))
(Valid (Prims.hasEq (FStar.Pervasives.either Prims.int
Prims.exn))))
:named haseqTm_refine_45169deb6dbf5ae881e96d5c771b782f))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name FStar.DM4F.Exceptions.raise; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(54,4-54,9); use=FStar.DM4F.Exceptions.fst(54,4-54,9)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.Exceptions.raise@tok
Tm_arrow_d0b01ad27773e685b2fc23a65bc35027))

;; def=FStar.DM4F.Exceptions.fst(54,4-54,9); use=FStar.DM4F.Exceptions.fst(54,4-54,9)
(forall ((@x1 Term))
 (! (= (ApplyTT FStar.DM4F.Exceptions.raise@tok
@x1)
(FStar.DM4F.Exceptions.raise @x1))
 

:pattern ((FStar.DM4F.Exceptions.raise @x1))
:qid function_token_typing_FStar.DM4F.Exceptions.raise.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.Exceptions.raise@tok))
:qid function_token_typing_FStar.DM4F.Exceptions.raise))

:named function_token_typing_FStar.DM4F.Exceptions.raise))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Exceptions.raise
;;; Fact-ids: Name FStar.DM4F.Exceptions.raise; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(54,4-54,9); use=FStar.DM4F.Exceptions.fst(54,4-54,9)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.Exceptions.raise @x0)
(ApplyTT FStar.DM4F.Exceptions.__proj__EXN__item__raise@tok
@x0))
 

:pattern ((FStar.DM4F.Exceptions.raise @x0))
:qid equation_FStar.DM4F.Exceptions.raise))

:named equation_FStar.DM4F.Exceptions.raise))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Exceptions.div_extrinsic
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_extrinsic; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(102,5-102,18); use=FStar.DM4F.Exceptions.fst(102,5-102,18)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.Exceptions.div_extrinsic @x0
@x1)
...
(ite (= @lb2
(BoxBool true))
(ApplyTT (ApplyTT FStar.DM4F.Exceptions.raise@tok
Prims.int)
FStar.DM4F.Exceptions.Division_by_zero@tok)
(Tm_abs_c7d6e1ed5cccce6d4089922183ea8d4f @x1
@x0))))
 

:pattern ((FStar.DM4F.Exceptions.div_extrinsic @x0
@x1))
:qid equation_FStar.DM4F.Exceptions.div_extrinsic))

:named equation_FStar.DM4F.Exceptions.div_extrinsic))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name FStar.DM4F.Exceptions.uu___is_Division_by_zero; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(92,10-92,26); use=FStar.DM4F.Exceptions.fst(92,10-92,26)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.Exceptions.uu___is_Division_by_zero @x0)
(BoxBool (is-FStar.DM4F.Exceptions.Division_by_zero @x0)))
 

:pattern ((FStar.DM4F.Exceptions.uu___is_Division_by_zero @x0))
:qid disc_equation_FStar.DM4F.Exceptions.Division_by_zero))

:named disc_equation_FStar.DM4F.Exceptions.Division_by_zero))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Exceptions.raise; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(42,23-54,22); use=FStar.DM4F.Exceptions.fst(54,0-54,22)
...
@x1
Tm_arrow_d0b01ad27773e685b2fc23a65bc35027))
:qid FStar.DM4F.Exceptions_pre_typing_Tm_arrow_d0b01ad27773e685b2fc23a65bc35027))

:named FStar.DM4F.Exceptions_pre_typing_Tm_arrow_d0b01ad27773e685b2fc23a65bc35027))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_elab; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,18-50,21); use=FStar.DM4F.Exceptions.fst(29,18-50,21)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9812e2765adf7fe0afbb22bd49833273)
...
@x1
Tm_arrow_9812e2765adf7fe0afbb22bd49833273))
:qid FStar.DM4F.Exceptions_pre_typing_Tm_arrow_9812e2765adf7fe0afbb22bd49833273))

:named FStar.DM4F.Exceptions_pre_typing_Tm_arrow_9812e2765adf7fe0afbb22bd49833273))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_elab; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,18-29,22); use=FStar.DM4F.Exceptions.fst(29,18-42,49)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_837d6fb4dd08f1b676881c282fba65dc @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_837d6fb4dd08f1b676881c282fba65dc @x2
@x3)))
:qid FStar.DM4F.Exceptions_pre_typing_Tm_arrow_837d6fb4dd08f1b676881c282fba65dc))

:named FStar.DM4F.Exceptions_pre_typing_Tm_arrow_837d6fb4dd08f1b676881c282fba65dc))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_extrinsic; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,18-29,42); use=FStar.DM4F.Exceptions.fst(29,18-29,42)
...
@x1
Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97))
:qid FStar.DM4F.Exceptions_pre_typing_Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97))

:named FStar.DM4F.Exceptions_pre_typing_Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d0b01ad27773e685b2fc23a65bc35027
;;; Fact-ids: Name FStar.DM4F.Exceptions.raise; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(42,23-54,22); use=FStar.DM4F.Exceptions.fst(54,0-54,22)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Non_total_Tm_arrow_0a94a90560d409b7ff0b72c375936c0b @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_d0b01ad27773e685b2fc23a65bc35027.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_d0b01ad27773e685b2fc23a65bc35027))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_d0b01ad27773e685b2fc23a65bc35027))

:named FStar.DM4F.Exceptions_interpretation_Tm_arrow_d0b01ad27773e685b2fc23a65bc35027))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9812e2765adf7fe0afbb22bd49833273
;;; Fact-ids: Name FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_elab; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,18-50,21); use=FStar.DM4F.Exceptions.fst(29,18-50,21)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_9812e2765adf7fe0afbb22bd49833273.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_9812e2765adf7fe0afbb22bd49833273.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_9812e2765adf7fe0afbb22bd49833273))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_9812e2765adf7fe0afbb22bd49833273))

:named FStar.DM4F.Exceptions_interpretation_Tm_arrow_9812e2765adf7fe0afbb22bd49833273))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_837d6fb4dd08f1b676881c282fba65dc
;;; Fact-ids: Name FStar.DM4F.Exceptions._dm4f_EXN___proj__EXN__item__raise_elab; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,18-29,22); use=FStar.DM4F.Exceptions.fst(29,18-42,49)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_837d6fb4dd08f1b676881c282fba65dc @x1
@x2))
(and 
;; def=FStar.DM4F.Exceptions.fst(29,18-29,22); use=FStar.DM4F.Exceptions.fst(29,18-42,49)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_837d6fb4dd08f1b676881c282fba65dc.1))
...
(Tm_arrow_837d6fb4dd08f1b676881c282fba65dc @x1
@x2)))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_837d6fb4dd08f1b676881c282fba65dc))

:named FStar.DM4F.Exceptions_interpretation_Tm_arrow_837d6fb4dd08f1b676881c282fba65dc))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_extrinsic; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(29,18-29,42); use=FStar.DM4F.Exceptions.fst(29,18-29,42)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97))
:qid FStar.DM4F.Exceptions_interpretation_Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97))

:named FStar.DM4F.Exceptions_interpretation_Tm_arrow_1dfe2a01ee473137a9b5390d3c36eb97))
;;;;;;;;;;;;;;;;Action token correspondence
;;; Fact-ids: Name FStar.DM4F.Exceptions.EXN; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(50,7-50,12); use=FStar.DM4F.Exceptions.fst(50,7-50,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT FStar.DM4F.Exceptions.__proj__EXN__item__raise@tok
@x0)
@x1)
(FStar.DM4F.Exceptions.__proj__EXN__item__raise @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT FStar.DM4F.Exceptions.__proj__EXN__item__raise@tok
@x0)
@x1))
:qid FStar.DM4F.Exceptions.__proj__EXN__item__raise_token_correspondence))

:named FStar.DM4F.Exceptions.__proj__EXN__item__raise_token_correspondence))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.Exceptions.EXN; Namespace FStar.DM4F.Exceptions
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(50,7-50,12); use=FStar.DM4F.Exceptions.fst(50,7-50,12)
...
:pattern ((FStar.DM4F.Exceptions.__proj__EXN__item__raise @x0
@x1))
:qid FStar.DM4F.Exceptions.__proj__EXN__item__raise_equality))

:named FStar.DM4F.Exceptions.__proj__EXN__item__raise_equality))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.DM4F.Exceptions.raise; Namespace FStar.DM4F.Exceptions
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.DM4F.Exceptions.__proj__EXN__item__raise@tok))
:named @kick_partial_app_8c0f7806db6c15d8c11d037fd7859304))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.DM4F.Exceptions.div_intrinsic; Namespace FStar.DM4F.Exceptions
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.DM4F.Exceptions.raise@tok))
:named @kick_partial_app_5d5640b7d2527409aaac183c1bf68394))
(push) ;; push{2

; Starting query at FStar.DM4F.Exceptions.fst(109,43-109,45)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Exceptions.fst(107,2-109,40); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;       (*  - Could not prove post-condition
; *)
;       forall (x: FStar.Pervasives.either Prims.int Prims.exn).
;         reify (FStar.DM4F.Exceptions.div_extrinsic i j) () == x ==>
;         (forall (k: Prims.pure_post Type0).
;             (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;             ~(Inr? (reify (FStar.DM4F.Exceptions.div_extrinsic i j) ()) &&
;               Division_by_zero? (reify (FStar.DM4F.Exceptions.div_extrinsic i j) ()).v) /\
;             ~(Inl? (reify (FStar.DM4F.Exceptions.div_extrinsic i j) ())) ==>
;             Prims.l_False)) /\
;   (forall (p: Prims.pure_post Prims.unit).
;       (forall (pure_result: Prims.unit).
;           (match reify (FStar.DM4F.Exceptions.div_extrinsic i j) () with
;             | FStar.Pervasives.Inr FStar.DM4F.Exceptions.Division_by_zero -> j = 0
;             | FStar.Pervasives.Inl z -> j <> 0 /\ z = i / j) ==>
;           p pure_result) ==>
...
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)

;; def=FStar.DM4F.Exceptions.fst(65,39-65,52); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(FStar.Pervasives.either Prims.int
Prims.exn))

;; def=FStar.DM4F.Exceptions.fst(107,15-107,43); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(= (ApplyTT (FStar.DM4F.Exceptions.div_extrinsic @x0
@x1)
Tm_unit)
@x3)
)
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(ApplyTT @x4
@x5)
...
;; def=FStar.DM4F.Exceptions.fst(107,15-108,14); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(not 
;; def=FStar.DM4F.Exceptions.fst(107,15-108,14); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(and (BoxBool_proj_0 (FStar.Pervasives.uu___is_Inr Prims.int
Prims.exn
(ApplyTT (FStar.DM4F.Exceptions.div_extrinsic @x0
@x1)
Tm_unit)))
(BoxBool_proj_0 (FStar.DM4F.Exceptions.uu___is_Division_by_zero (FStar.Pervasives.__proj__Inr__item__v Prims.int
Prims.exn
(ApplyTT (FStar.DM4F.Exceptions.div_extrinsic @x0
@x1)
Tm_unit)))))
...
(not 
;; def=FStar.DM4F.Exceptions.fst(107,15-107,43); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(BoxBool_proj_0 (FStar.Pervasives.uu___is_Inl Prims.int
Prims.exn
(ApplyTT (FStar.DM4F.Exceptions.div_extrinsic @x0
@x1)
Tm_unit)))
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(forall ((@x3 Term))
 (! (implies (and (or label_2
(HasType @x3
Prims.unit))
(let ((@lb4 (ApplyTT (FStar.DM4F.Exceptions.div_extrinsic @x0
@x1)
Tm_unit)))
(ite (and (is-FStar.Pervasives.Inr @lb4)
(is-FStar.DM4F.Exceptions.Division_by_zero (FStar.Pervasives.Inr_v @lb4)))

;; def=FStar.DM4F.Exceptions.fst(108,35-108,40); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(or label_3
...
(ite (is-FStar.Pervasives.Inl @lb4)

;; def=FStar.DM4F.Exceptions.fst(109,20-109,39); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(and 
;; def=FStar.DM4F.Exceptions.fst(109,20-109,26); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(or label_4
...
;; def=FStar.DM4F.Exceptions.fst(109,30-109,39); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(or label_5

;; def=FStar.DM4F.Exceptions.fst(109,30-109,39); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(= (FStar.Pervasives.Inl_v @lb4)
(Prims.op_Division @x0
@x1))
)
)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Exceptions.fst(109,43-109,45)
(ApplyTT @x2
@x3)
...
; encoding sigelt let lemma_div_extrinsic


; <Start encoding let lemma_div_extrinsic>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.Exceptions.lemma_div_extrinsic (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.Exceptions.lemma_div_extrinsic@tok () Term)

; </end encoding let lemma_div_extrinsic>


; encoding sigelt val FStar.DM4F.Exceptions.raise_


; <Skipped val FStar.DM4F.Exceptions.raise_/>

(push) ;; push{2

; Starting query at FStar.DM4F.Exceptions.fst(117,32-117,37)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (e: Prims.exn) (_: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (FStar.Pervasives.either a Prims.exn)).
;     p (FStar.Pervasives.Inr e) ==>
;     (forall (return_val: FStar.Pervasives.either a Prims.exn).
;         return_val == FStar.Pervasives.Inr e ==> p return_val)


; Context: While encoding a query
; While typechecking the top-level declaration `let raise_`
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.pure_post (FStar.Pervasives.either @x0
Prims.exn)))

;; def=FStar.DM4F.Exceptions.fst(116,82-116,91); use=FStar.DM4F.Exceptions.fst(117,32-117,37)
(Valid 
;; def=FStar.DM4F.Exceptions.fst(116,82-116,91); use=FStar.DM4F.Exceptions.fst(117,32-117,37)
(ApplyTT @x3
...
;; def=Prims.fst(356,46-356,58); use=FStar.DM4F.Exceptions.fst(117,32-117,37)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Exceptions.raise_, 1)
; STATUS: unsat
...
(declare-fun FStar.DM4F.Exceptions.raise_ (Term Term) Term)



(declare-fun FStar.DM4F.Exceptions.raise_@tok () Term)
...
; Starting query at FStar.DM4F.Exceptions.fst(121,4-121,29)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (e: Prims.exn).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.unit) (p: Prims.pure_post (FStar.Pervasives.either a Prims.exn)).
;     (forall (r: FStar.Pervasives.either a Prims.exn). r == FStar.Pervasives.Inr e ==> p r) ==>
;     p (FStar.Pervasives.Inr e)


; Context: While encoding a query
; While typechecking the top-level declaration `let raise__`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Exceptions.fst(121,17-121,29)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.unit)
(HasType @x3
...
;; def=FStar.DM4F.Exceptions.fst(60,10-60,60); use=FStar.DM4F.Exceptions.fst(121,17-121,29)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.either @x0
Prims.exn))

;; def=FStar.DM4F.Exceptions.fst(120,53-120,63); use=FStar.DM4F.Exceptions.fst(121,17-121,29)
(= @x4
(FStar.Pervasives.Inr @x0
Prims.exn
@x1))
...
;; def=FStar.DM4F.Exceptions.fst(60,56-60,59); use=FStar.DM4F.Exceptions.fst(121,17-121,29)
(Valid 
;; def=FStar.DM4F.Exceptions.fst(60,56-60,59); use=FStar.DM4F.Exceptions.fst(121,17-121,29)
(ApplyTT @x3
@x4)
...
;; def=FStar.DM4F.Exceptions.fst(116,82-116,91); use=FStar.DM4F.Exceptions.fst(121,18-121,24)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Exceptions.raise__, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_typing_intro_FStar.Pervasives.Inr@tok, typing_Prims.exn
