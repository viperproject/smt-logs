...
; Internals for FStar.DM4F.Continuations
...
(declare-fun FStar.DM4F.Continuations.cont (Term Term) Term)

(declare-fun FStar.DM4F.Continuations.cont@tok () Term)

;;;;;;;;;;;;;;;;_: (_: a -> Prims.M ans) -> Prims.M ans
...
(declare-fun FStar.DM4F.Continuations.return (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;ans: Type -> a: Type -> x: a -> p: (_: a -> Prims.M ans) -> Prims.M ans
(declare-fun Tm_arrow_2694b24b1ea386f1a4573562a91c5d17 () Term)
(declare-fun FStar.DM4F.Continuations.return@tok () Term)
...
;;;;;;;;;;;;;;;;_: a -> cont ans b
(declare-fun Tm_arrow_a2f49374ef35ac25e0655f0934fb363a (Term Term Term) Term)

(declare-fun FStar.DM4F.Continuations.bind (Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;ans: Type ->     a: Type ->     b: Type ->     m: cont ans a ->     f: (_: a -> cont ans b) ->     k: (_: b -> Prims.M ans)   -> Prims.M ans
(declare-fun Tm_arrow_d3c52bff418b15fdaac741dc3083e7df () Term)
(declare-fun FStar.DM4F.Continuations.bind@tok () Term)


(declare-fun Tm_abs_bbab2524e0b098b5ae18f1bb2a44f6ea (Term Term Term) Term)

; </end encoding let bind>


; encoding sigelt type FStar.DM4F.Continuations.either


; <Start encoding type FStar.DM4F.Continuations.either>

;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.Continuations.either (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun FStar.DM4F.Continuations.either@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.Continuations.L (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.DM4F.Continuations.L_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.DM4F.Continuations.L_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.DM4F.Continuations.L__2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: FStar.DM4F.Continuations.L
(declare-fun FStar.DM4F.Continuations.L@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.Continuations.R (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.DM4F.Continuations.R_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.DM4F.Continuations.R_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.DM4F.Continuations.R__2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: FStar.DM4F.Continuations.R
(declare-fun FStar.DM4F.Continuations.R@tok () Term)
;;;;;;;;;;;;;;;;a: Type -> b: Type -> _2: a -> either a b
(declare-fun Tm_arrow_410096c484ca90050f865199e0c941e7 () Term)
;;;;;;;;;;;;;;;;a: Type -> b: Type -> _2: b -> either a b
(declare-fun Tm_arrow_d55711f058269794475c62ae089783ab () Term)

; <start constructor FStar.DM4F.Continuations.either>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.Continuations.either ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
132)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
(FStar.DM4F.Continuations.either @x0
@x1))
 
;;no pats
:qid is-FStar.DM4F.Continuations.either))))

; </end constructor FStar.DM4F.Continuations.either>


; <start constructor FStar.DM4F.Continuations.L>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.Continuations.L ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
139)
(= __@x0
(FStar.DM4F.Continuations.L (FStar.DM4F.Continuations.L_a __@x0)
(FStar.DM4F.Continuations.L_b __@x0)
(FStar.DM4F.Continuations.L__2 __@x0)))))

; </end constructor FStar.DM4F.Continuations.L>


; <start constructor FStar.DM4F.Continuations.R>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.Continuations.R ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
146)
(= __@x0
(FStar.DM4F.Continuations.R (FStar.DM4F.Continuations.R_a __@x0)
(FStar.DM4F.Continuations.R_b __@x0)
(FStar.DM4F.Continuations.R__2 __@x0)))))

; </end constructor FStar.DM4F.Continuations.R>


; </end encoding type FStar.DM4F.Continuations.either>


; encoding sigelt val FStar.DM4F.Continuations.uu___is_L


; <Start encoding val FStar.DM4F.Continuations.uu___is_L>

(declare-fun FStar.DM4F.Continuations.uu___is_L (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: either _ _ -> Prims.bool
(declare-fun Tm_arrow_dd84bc92baf411af5ee609ca008de0d6 () Term)
(declare-fun FStar.DM4F.Continuations.uu___is_L@tok () Term)

; </end encoding val FStar.DM4F.Continuations.uu___is_L>
...
; encoding sigelt val FStar.DM4F.Continuations.__proj__L__item__a


; <Start encoding val FStar.DM4F.Continuations.__proj__L__item__a>

(declare-fun Tm_refine_8445d79c1f764e59f2958fa0cdffa351 (Term Term) Term)
(declare-fun FStar.DM4F.Continuations.__proj__L__item__a (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: either _ _ {L? _} -> Type
(declare-fun Tm_arrow_72c7c057d7b650972a66168b8988d128 () Term)
(declare-fun FStar.DM4F.Continuations.__proj__L__item__a@tok () Term)

; </end encoding val FStar.DM4F.Continuations.__proj__L__item__a>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Continuations.uu___is_L; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
...
(FStar.DM4F.Continuations.either @x0
@x1)))
(HasType (FStar.DM4F.Continuations.uu___is_L @x0
@x1
@x2)
Prims.bool))
 

:pattern ((FStar.DM4F.Continuations.uu___is_L @x0
@x1
@x2))
:qid typing_FStar.DM4F.Continuations.uu___is_L))

:named typing_FStar.DM4F.Continuations.uu___is_L))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(30,10-30,16); use=FStar.DM4F.Continuations.fst(30,10-30,16)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT FStar.DM4F.Continuations.either@tok
@x0)
@x1)
(FStar.DM4F.Continuations.either @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT FStar.DM4F.Continuations.either@tok
@x0)
@x1))

:pattern ((FStar.DM4F.Continuations.either @x0
@x1))
:qid token_correspondence_FStar.DM4F.Continuations.either@tok))

:named token_correspondence_FStar.DM4F.Continuations.either@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(FStar.DM4F.Continuations.R @x1
@x2
@x3)
(FStar.DM4F.Continuations.either @x4
@x5))
...
(FStar.DM4F.Continuations.either @x4
@x5)))
:qid subterm_ordering_FStar.DM4F.Continuations.R))

:named subterm_ordering_FStar.DM4F.Continuations.R))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
...
(FStar.DM4F.Continuations.either @x4
@x5)))
:qid subterm_ordering_FStar.DM4F.Continuations.L))

:named subterm_ordering_FStar.DM4F.Continuations.L))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Continuations.__proj__L__item__a; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_8445d79c1f764e59f2958fa0cdffa351 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_8445d79c1f764e59f2958fa0cdffa351 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_8445d79c1f764e59f2958fa0cdffa351))

:named refinement_kinding_Tm_refine_8445d79c1f764e59f2958fa0cdffa351))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8445d79c1f764e59f2958fa0cdffa351 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.DM4F.Continuations.either @x2
@x3))

;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
(BoxBool_proj_0 (FStar.DM4F.Continuations.uu___is_L @x2
@x3
@x1))
))
...
(Tm_refine_8445d79c1f764e59f2958fa0cdffa351 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_8445d79c1f764e59f2958fa0cdffa351))

:named refinement_interpretation_Tm_refine_8445d79c1f764e59f2958fa0cdffa351))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
...
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.Continuations.R_b (FStar.DM4F.Continuations.R @x0
@x1
@x2))
@x1)
 

:pattern ((FStar.DM4F.Continuations.R @x0
@x1
@x2))
:qid projection_inverse_FStar.DM4F.Continuations.R_b))

:named projection_inverse_FStar.DM4F.Continuations.R_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.Continuations.R_a (FStar.DM4F.Continuations.R @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_FStar.DM4F.Continuations.R_a))

:named projection_inverse_FStar.DM4F.Continuations.R_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.Continuations.R__2 (FStar.DM4F.Continuations.R @x0
@x1
@x2))
@x2)
...
@x1
@x2))
:qid projection_inverse_FStar.DM4F.Continuations.R__2))

:named projection_inverse_FStar.DM4F.Continuations.R__2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.Continuations.L_b (FStar.DM4F.Continuations.L @x0
@x1
@x2))
@x1)
 

:pattern ((FStar.DM4F.Continuations.L @x0
@x1
@x2))
:qid projection_inverse_FStar.DM4F.Continuations.L_b))

:named projection_inverse_FStar.DM4F.Continuations.L_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.Continuations.L_a (FStar.DM4F.Continuations.L @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_FStar.DM4F.Continuations.L_a))

:named projection_inverse_FStar.DM4F.Continuations.L_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.Continuations.L__2 (FStar.DM4F.Continuations.L @x0
@x1
@x2))
@x2)
...
@x1
@x2))
:qid projection_inverse_FStar.DM4F.Continuations.L__2))

:named projection_inverse_FStar.DM4F.Continuations.L__2))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! (is-Tm_arrow (PreType FStar.DM4F.Continuations.either@tok))
:named pre_kinding_FStar.DM4F.Continuations.either@tok))
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! (and (IsTotFun FStar.DM4F.Continuations.either@tok)

;; def=FStar.DM4F.Continuations.fst(30,10-30,16); use=FStar.DM4F.Continuations.fst(30,10-30,16)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT FStar.DM4F.Continuations.either@tok
@x0))
 

:pattern ((ApplyTT FStar.DM4F.Continuations.either@tok
@x0))
:qid kinding_FStar.DM4F.Continuations.either@tok))
...
(HasType @x1
Tm_type))
(HasType (FStar.DM4F.Continuations.either @x0
@x1)
Tm_type))
...
:pattern ((FStar.DM4F.Continuations.either @x0
@x1))
:qid kinding_FStar.DM4F.Continuations.either@tok.1))
)
:named kinding_FStar.DM4F.Continuations.either@tok))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_8445d79c1f764e59f2958fa0cdffa351
;;; Fact-ids: Name FStar.DM4F.Continuations.__proj__L__item__a; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8445d79c1f764e59f2958fa0cdffa351 @x0
@x1)))
(Valid (Prims.hasEq (FStar.DM4F.Continuations.either @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8445d79c1f764e59f2958fa0cdffa351 @x0
@x1))))
:qid haseqTm_refine_8445d79c1f764e59f2958fa0cdffa351))

:named haseqTm_refine_8445d79c1f764e59f2958fa0cdffa351))
...
(FStar.DM4F.Continuations.either @x2
@x3))
(or (and (is-FStar.DM4F.Continuations.L @x1)
(= @x2
(FStar.DM4F.Continuations.L_a @x1))
(= @x3
(FStar.DM4F.Continuations.L_b @x1)))
(and (is-FStar.DM4F.Continuations.R @x1)
(= @x2
(FStar.DM4F.Continuations.R_a @x1))
(= @x3
(FStar.DM4F.Continuations.R_b @x1)))))
...
(FStar.DM4F.Continuations.either @x2
@x3)))
:qid fuel_guarded_inversion_FStar.DM4F.Continuations.either))

:named fuel_guarded_inversion_FStar.DM4F.Continuations.either))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! (= 133
(Term_constr_id FStar.DM4F.Continuations.either@tok))
:named fresh_token_FStar.DM4F.Continuations.either@tok))
...
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.Continuations.uu___is_L @x0
@x1
@x2)
(BoxBool (is-FStar.DM4F.Continuations.L @x2)))
 

:pattern ((FStar.DM4F.Continuations.uu___is_L @x0
@x1
@x2))
:qid disc_equation_FStar.DM4F.Continuations.L))

:named disc_equation_FStar.DM4F.Continuations.L))
...
(FStar.DM4F.Continuations.either @x4
@x5)))
:qid data_typing_intro_FStar.DM4F.Continuations.R@tok))

:named data_typing_intro_FStar.DM4F.Continuations.R@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
...
(FStar.DM4F.Continuations.either @x4
@x5)))
:qid data_typing_intro_FStar.DM4F.Continuations.L@tok))

:named data_typing_intro_FStar.DM4F.Continuations.L@tok))
...
(FStar.DM4F.Continuations.either @x4
@x5)))
:qid data_elim_FStar.DM4F.Continuations.R))

:named data_elim_FStar.DM4F.Continuations.R))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
...
(FStar.DM4F.Continuations.either @x4
@x5)))
:qid data_elim_FStar.DM4F.Continuations.L))

:named data_elim_FStar.DM4F.Continuations.L))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term) (@x1 Term))
 (! (= 132
(Term_constr_id (FStar.DM4F.Continuations.either @x0
@x1)))
 

:pattern ((FStar.DM4F.Continuations.either @x0
@x1))
:qid constructor_distinct_FStar.DM4F.Continuations.either))

:named constructor_distinct_FStar.DM4F.Continuations.either))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 146
(Term_constr_id (FStar.DM4F.Continuations.R @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_FStar.DM4F.Continuations.R))

:named constructor_distinct_FStar.DM4F.Continuations.R))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.DM4F.Continuations.either; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.L; Namespace FStar.DM4F.Continuations; Name FStar.DM4F.Continuations.R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= 139
(Term_constr_id (FStar.DM4F.Continuations.L @x0
@x1
@x2)))
...
@x1
@x2))
:qid constructor_distinct_FStar.DM4F.Continuations.L))

:named constructor_distinct_FStar.DM4F.Continuations.L))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
(FStar.DM4F.Continuations.either @x2
@x3)))
:qid FStar.DM4F.Continuations_pretyping_bea60dd42815a47e75e120a4e7ee9a40))

:named FStar.DM4F.Continuations_pretyping_bea60dd42815a47e75e120a4e7ee9a40))
(push) ;; push{2

; Starting query at FStar.DM4F.Continuations.fst(31,7-31,8)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Type) (_: Type) (projectee: _: FStar.DM4F.Continuations.either _ _ {L? _}).
;   (*  - Could not prove post-condition
; *) ~(L? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__L__item__a`
...
Tm_type)
(HasType @x2
(Tm_refine_8445d79c1f764e59f2958fa0cdffa351 @x0
@x1))

;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,7-31,8)
(not 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,7-31,8)
(BoxBool_proj_0 (FStar.DM4F.Continuations.uu___is_L @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Continuations.__proj__L__item__a, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_8445d79c1f764e59f2958fa0cdffa351
...
; encoding sigelt let __proj__L__item__a


; <Skipped let __proj__L__item__a/>


; encoding sigelt val FStar.DM4F.Continuations.__proj__L__item__b


; <Start encoding val FStar.DM4F.Continuations.__proj__L__item__b>


(declare-fun FStar.DM4F.Continuations.__proj__L__item__b (Term Term Term) Term)


(declare-fun FStar.DM4F.Continuations.__proj__L__item__b@tok () Term)

; </end encoding val FStar.DM4F.Continuations.__proj__L__item__b>

(push) ;; push{2

; Starting query at FStar.DM4F.Continuations.fst(31,23-31,24)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__L__item__b`
...
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,23-31,24)
(not 
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,23-31,24)
(BoxBool_proj_0 (FStar.DM4F.Continuations.uu___is_L @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Continuations.__proj__L__item__b, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_8445d79c1f764e59f2958fa0cdffa351
...
; encoding sigelt let __proj__L__item__b


; <Skipped let __proj__L__item__b/>


; encoding sigelt val FStar.DM4F.Continuations.__proj__L__item___2


; <Start encoding val FStar.DM4F.Continuations.__proj__L__item___2>


(declare-fun FStar.DM4F.Continuations.__proj__L__item___2 (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: either _ _ {L? _} -> projectee.a
(declare-fun Tm_arrow_76a48d75217ca7d226dbae24475d59c8 () Term)
(declare-fun FStar.DM4F.Continuations.__proj__L__item___2@tok () Term)

; </end encoding val FStar.DM4F.Continuations.__proj__L__item___2>
...
; *)
;   (~(L? projectee) ==> Prims.l_False) /\
;   (forall (b: Type) (b: Type) (b: b).
;       projectee == FStar.DM4F.Continuations.L b b b ==>
;       b == _ /\ b == _ /\ L? (FStar.DM4F.Continuations.L b b b))


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__L__item___2`
...
;; def=FStar.DM4F.Continuations.fst(31,2-31,3); use=FStar.DM4F.Continuations.fst(31,2-31,3)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Continuations.fst(31,2-31,3)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Continuations.__proj__L__item___2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_FStar.DM4F.Continuations.L, refinement_interpretation_Tm_refine_8445d79c1f764e59f2958fa0cdffa351
...
; encoding sigelt let __proj__L__item___2


; <Skipped let __proj__L__item___2/>


; encoding sigelt val FStar.DM4F.Continuations.uu___is_R


; <Start encoding val FStar.DM4F.Continuations.uu___is_R>

(declare-fun FStar.DM4F.Continuations.uu___is_R (Term Term Term) Term)

(declare-fun FStar.DM4F.Continuations.uu___is_R@tok () Term)

; </end encoding val FStar.DM4F.Continuations.uu___is_R>
...
; encoding sigelt val FStar.DM4F.Continuations.__proj__R__item__a


; <Start encoding val FStar.DM4F.Continuations.__proj__R__item__a>

(declare-fun Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0 (Term Term) Term)
(declare-fun FStar.DM4F.Continuations.__proj__R__item__a (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: either _ _ {R? _} -> Type
(declare-fun Tm_arrow_3bf58de0062b17e4302b2cdbdf080714 () Term)
(declare-fun FStar.DM4F.Continuations.__proj__R__item__a@tok () Term)

; </end encoding val FStar.DM4F.Continuations.__proj__R__item__a>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Continuations.uu___is_R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(FStar.DM4F.Continuations.either @x0
@x1)))
(HasType (FStar.DM4F.Continuations.uu___is_R @x0
@x1
@x2)
Prims.bool))
 

:pattern ((FStar.DM4F.Continuations.uu___is_R @x0
@x1
@x2))
:qid typing_FStar.DM4F.Continuations.uu___is_R))

:named typing_FStar.DM4F.Continuations.uu___is_R))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Continuations.__proj__R__item__a; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0))

:named refinement_kinding_Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Continuations.__proj__R__item__a; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.DM4F.Continuations.either @x2
...
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(BoxBool_proj_0 (FStar.DM4F.Continuations.uu___is_R @x2
@x3
@x1))
))
...
(Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0))

:named refinement_interpretation_Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0
;;; Fact-ids: Name FStar.DM4F.Continuations.__proj__R__item__a; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0 @x0
@x1)))
(Valid (Prims.hasEq (FStar.DM4F.Continuations.either @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0 @x0
@x1))))
:qid haseqTm_refine_a6a39bffc11b264d9749ffb3bf1e08d0))

:named haseqTm_refine_a6a39bffc11b264d9749ffb3bf1e08d0))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name FStar.DM4F.Continuations.uu___is_R; Namespace FStar.DM4F.Continuations
(assert (! 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.Continuations.uu___is_R @x0
@x1
@x2)
(BoxBool (is-FStar.DM4F.Continuations.R @x2)))
 

:pattern ((FStar.DM4F.Continuations.uu___is_R @x0
@x1
@x2))
:qid disc_equation_FStar.DM4F.Continuations.R))

:named disc_equation_FStar.DM4F.Continuations.R))
(push) ;; push{2

; Starting query at FStar.DM4F.Continuations.fst(32,7-32,8)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Type) (_: Type) (projectee: _: FStar.DM4F.Continuations.either _ _ {R? _}).
;   (*  - Could not prove post-condition
; *) ~(R? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__R__item__a`
...
Tm_type)
(HasType @x2
(Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0 @x0
@x1))

;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,7-32,8)
(not 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,7-32,8)
(BoxBool_proj_0 (FStar.DM4F.Continuations.uu___is_R @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Continuations.__proj__R__item__a, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0
...
; encoding sigelt let __proj__R__item__a


; <Skipped let __proj__R__item__a/>


; encoding sigelt val FStar.DM4F.Continuations.__proj__R__item__b


; <Start encoding val FStar.DM4F.Continuations.__proj__R__item__b>


(declare-fun FStar.DM4F.Continuations.__proj__R__item__b (Term Term Term) Term)


(declare-fun FStar.DM4F.Continuations.__proj__R__item__b@tok () Term)

; </end encoding val FStar.DM4F.Continuations.__proj__R__item__b>

(push) ;; push{2

; Starting query at FStar.DM4F.Continuations.fst(32,23-32,24)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__R__item__b`
...
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,23-32,24)
(not 
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,23-32,24)
(BoxBool_proj_0 (FStar.DM4F.Continuations.uu___is_R @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Continuations.__proj__R__item__b, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0
...
; encoding sigelt let __proj__R__item__b


; <Skipped let __proj__R__item__b/>


; encoding sigelt val FStar.DM4F.Continuations.__proj__R__item___2


; <Start encoding val FStar.DM4F.Continuations.__proj__R__item___2>


(declare-fun FStar.DM4F.Continuations.__proj__R__item___2 (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: either _ _ {R? _} -> projectee.b
(declare-fun Tm_arrow_3feddb912d0a1895fcd3dc966558fe0e () Term)
(declare-fun FStar.DM4F.Continuations.__proj__R__item___2@tok () Term)

; </end encoding val FStar.DM4F.Continuations.__proj__R__item___2>
...
;   (~(R? projectee) ==> Prims.l_False) /\
;   (forall (b: Type) (b: Type) (b: b).
;       projectee == FStar.DM4F.Continuations.R b b b ==>
;       b == _ /\ b == _ /\ R? (FStar.DM4F.Continuations.R b b b))


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__R__item___2`
...
;; def=FStar.DM4F.Continuations.fst(32,2-32,3); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Continuations.fst(32,2-32,3)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Continuations.__proj__R__item___2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_FStar.DM4F.Continuations.R, refinement_interpretation_Tm_refine_a6a39bffc11b264d9749ffb3bf1e08d0
