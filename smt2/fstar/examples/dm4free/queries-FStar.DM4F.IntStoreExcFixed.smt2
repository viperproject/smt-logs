...
; Externals for interface FStar.DM4F.Heap.IntStoreFixed
...
; <Start encoding val FStar.DM4F.Heap.IntStoreFixed.id>

(declare-fun FStar.DM4F.Heap.IntStoreFixed.id (Dummy_sort) Term)

; </end encoding val FStar.DM4F.Heap.IntStoreFixed.id>


; <Start encoding val FStar.DM4F.Heap.IntStoreFixed.heap>

(declare-fun FStar.DM4F.Heap.IntStoreFixed.heap (Dummy_sort) Term)

; </end encoding val FStar.DM4F.Heap.IntStoreFixed.heap>


; <Start encoding val FStar.DM4F.Heap.IntStoreFixed.to_id>
...
; </end encoding val FStar.DM4F.Heap.IntStoreFixed.to_id>


; <Start encoding val FStar.DM4F.Heap.IntStoreFixed.index>
...
; </end encoding val FStar.DM4F.Heap.IntStoreFixed.index>
...
; <Start encoding val FStar.DM4F.Heap.IntStoreFixed.upd>
...
; </end encoding val FStar.DM4F.Heap.IntStoreFixed.upd>


; <Start encoding val FStar.DM4F.Heap.IntStoreFixed.create>
...
; </end encoding val FStar.DM4F.Heap.IntStoreFixed.create>


; <Start encoding val FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1>
...
; </end encoding val FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1>


; <Start encoding val FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd2>
...
; </end encoding val FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd2>


; <Start encoding val FStar.DM4F.Heap.IntStoreFixed.lemma_index_create>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.Heap.IntStoreFixed.lemma_index_create (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.Heap.IntStoreFixed.lemma_index_create@tok () Term)

; </end encoding val FStar.DM4F.Heap.IntStoreFixed.lemma_index_create>


; End Externals for interface FStar.DM4F.Heap.IntStoreFixed


; Externals for module FStar.DM4F.IntStoreFixedReader


; <Start encoding let int_store_reader>

(declare-fun FStar.DM4F.IntStoreFixedReader.int_store_reader (Term) Term)

(declare-fun FStar.DM4F.IntStoreFixedReader.int_store_reader@tok () Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.M a
(declare-fun Tm_arrow_05d20d40bad13b48028b0f3c3264a55a (Term) Term)

; </end encoding let int_store_reader>


; <Start encoding let return_isr>

(declare-fun FStar.DM4F.IntStoreFixedReader.return_isr (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> int_store_reader a
(declare-fun Tm_arrow_5daa22fda3f75ba90b52e22f1715718f () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader.return_isr@tok () Term)
(declare-fun Tm_abs_0ee5f9cec4a4560a186a65611e0c4932 (Term) Term)

; </end encoding let return_isr>


; <Start encoding let bind_isr>

;;;;;;;;;;;;;;;;_: a -> int_store_reader b
(declare-fun Tm_arrow_70705a7b347c9fb06d2b6ed8a0f8d92e (Term Term) Term)
(declare-fun FStar.DM4F.IntStoreFixedReader.bind_isr (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> x: int_store_reader a -> f: (_: a -> int_store_reader b) -> int_store_reader b
(declare-fun Tm_arrow_fd45c7a9c2d396912c8623618449b0c6 () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader.bind_isr@tok () Term)

(declare-fun Tm_abs_a40310401411b24a443184118de06ec4 (Term Term) Term)

; </end encoding let bind_isr>


; <Start encoding let get>

(declare-fun FStar.DM4F.IntStoreFixedReader.get (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> int_store_reader FStar.DM4F.Heap.IntStoreFixed.heap
(declare-fun Tm_arrow_f82880ada6bec576665a97884dad2cc9 () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader.get@tok () Term)
(declare-fun Tm_abs_6ddd41efc4b5662e5cf5849d70095a69 () Term)

; </end encoding let get>


; <Start encoding let _dm4f_INT_STORE_READER_lift_from_pure>


;;;;;;;;;;;;;;;;_: (_: a -> Type) -> Type
(declare-fun Tm_arrow_11b93b1a25b26195b88e72dd87199600 (Term) Term)

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     store: FStar.DM4F.Heap.IntStoreFixed.heap ->     p': (_: a -> Type)   -> Type
(declare-fun Tm_arrow_b41138fa1858e535ab83b664ca1fa976 () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_lift_from_pure@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_READER_lift_from_pure>


; <Start encoding let _dm4f_INT_STORE_READER_return_wp>


(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> store: FStar.DM4F.Heap.IntStoreFixed.heap -> p': (_: a -> Type) -> Type
(declare-fun Tm_arrow_10e9fb42412f79904df950edb2bcce45 () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_return_wp@tok () Term)


; </end encoding let _dm4f_INT_STORE_READER_return_wp>


; <Start encoding let _dm4f_INT_STORE_READER_return_elab>

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_return_elab (Term Term) Term)
(declare-fun Tm_refine_596c1d30a548c3757eed791d6da6a1f4 (Term Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE a
(declare-fun Tm_arrow_e440c2f9709f3ce1179828ab08520352 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> store__x: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE a
(declare-fun Tm_arrow_46793bd63db47c364bf45a368b8656ff () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_return_elab@tok () Term)




; </end encoding let _dm4f_INT_STORE_READER_return_elab>


; <Start encoding let _dm4f_INT_STORE_READER_bind_wp>


;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type
(declare-fun Tm_arrow_d2d6b33e8b63861d0cf41820a0a71452 (Term) Term)


;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: b -> Type) -> Type
(declare-fun Tm_arrow_217757c5a2c5958056e3de72d348eb13 (Term Term) Term)

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     x: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     f: (_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: b -> Type) -> Type) ->     store: FStar.DM4F.Heap.IntStoreFixed.heap ->     p'': (_: b -> Type)   -> Type
(declare-fun Tm_arrow_0ebf3bc215ebcbbe456e124ab373c96c () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_bind_wp@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_READER_bind_wp>


; <Start encoding let _dm4f_INT_STORE_READER_bind_elab>
...
(declare-fun Tm_refine_6bf25fb771b96d4a127f06dfca4aa26a (Term Term Term) Term)



(declare-fun Tm_abs_735bfa0400a12573ed48312f042e45e7 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE a
(declare-fun Tm_arrow_dbc7b9ee8effb605162f092be57cedd4 (Term Term) Term)
...
(declare-fun Tm_refine_ba46f4dba235d16885ca7aac093b8bd2 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE b
(declare-fun Tm_arrow_0da1f45cfa6d6425b4af524e23d964c6 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE b
(declare-fun Tm_arrow_db6591e301e18795576b1fe2fd582929 (Term Term Term) Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_bind_elab (Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_b7e8bb87622332c16e9288315d585dbf (Term Term Term Term Term) Term)
(declare-fun Tm_refine_4e4c41a5dd03356733fe8ac77d36a78b (Term Term Term Term Term) Term)





(declare-fun Tm_abs_8a37611a33b6c1ae8ffe84f33e52722e (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE b
(declare-fun Tm_arrow_9f08e9e7585e9a529bf2dd36c522bc48 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     x__w: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     x: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE a) ->     f__w: (_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: b -> Type) -> Type) ->     f: (_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE b) ->     store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE b
(declare-fun Tm_arrow_39ff68958f49b1ba8235794280ea7b79 () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_bind_elab@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_READER_bind_elab>


; <Start encoding let _dm4f_INT_STORE_READER___proj__INT_STORE_READER__item__get_elab>

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER___proj__INT_STORE_READER__item__get_elab (Term) Term)
(declare-fun Tm_refine_9ea91a5740bf2b94773ad62271671d0a (Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE FStar.DM4F.Heap.IntStoreFixed.heap
(declare-fun Tm_arrow_f4b9abca5bf648a2cdde52524c8b1644 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE FStar.DM4F.Heap.IntStoreFixed.heap
(declare-fun Tm_arrow_1eb67462e3c6f9f11878794d25357350 () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER___proj__INT_STORE_READER__item__get_elab@tok () Term)




; </end encoding let _dm4f_INT_STORE_READER___proj__INT_STORE_READER__item__get_elab>


; <Start encoding let _dm4f_INT_STORE_READER___proj__INT_STORE_READER__item__get_complete_type>

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER___proj__INT_STORE_READER__item__get_complete_type () Term)




; </end encoding let _dm4f_INT_STORE_READER___proj__INT_STORE_READER__item__get_complete_type>


; <Start encoding let _dm4f_INT_STORE_READER_repr>



(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp_a: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) -> Type
(declare-fun Tm_arrow_124d3d4cd36edcb668cd4a133da4d10f () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_repr@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_READER_repr>


; <Start encoding let _dm4f_INT_STORE_READER_pre>

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_pre () Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Type
(declare-fun Tm_arrow_f56ab51f6e3f91c41b04dd3761aa020f () Term)

; </end encoding let _dm4f_INT_STORE_READER_pre>


; <Start encoding let _dm4f_INT_STORE_READER_post>

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_post (Term) Term)

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_post@tok () Term)


; </end encoding let _dm4f_INT_STORE_READER_post>


; <Start encoding let _dm4f_INT_STORE_READER_wp>

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_wp (Term) Term)

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_wp@tok () Term)



; </end encoding let _dm4f_INT_STORE_READER_wp>


; <Start encoding let _dm4f_INT_STORE_READER_ctx>

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_ctx (Term Term) Term)

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> t
(declare-fun Tm_arrow_51955bea433fae864a1b4914a0a32a7f (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_READER_ctx>


; <Start encoding let _dm4f_INT_STORE_READER_gctx>

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_gctx (Term Term) Term)

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot t
(declare-fun Tm_ghost_arrow_c2d5bcc829394583ac3e49cd34ff6d70 (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_READER_gctx>


; <Start encoding let _dm4f_INT_STORE_READER_pure>


(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> t
(declare-fun Tm_arrow_e1f7135e740831e77208ac87ff486e70 () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_pure@tok () Term)


; </end encoding let _dm4f_INT_STORE_READER_pure>


; <Start encoding let _dm4f_INT_STORE_READER_app>



;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_a77721cd0abeef2761be2c83676d5931 (Term Term Term) Term)



(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot t1) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_2eee551f7f9643684d4e4b736b6f2b25 () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_app@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_READER_app>


; <Start encoding let _dm4f_INT_STORE_READER_lift1>




(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot t1) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_2336dfb557aa6786d4d12ffb1a834d0e () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_lift1@tok () Term)
...
(declare-fun Tm_abs_8f4e991831aaf7f0b08ffc45a984bc4d (Term Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_READER_lift1>


; <Start encoding let _dm4f_INT_STORE_READER_lift2>
...
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot t1) ->     a2: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot t2) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_3323abd5a4c0491f7d52187bdaca53eb () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_lift2@tok () Term)
...
(declare-fun Tm_abs_52f2f8f35094802b64ee1fad4b3c3090 (Term Term Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_READER_lift2>


; <Start encoding let _dm4f_INT_STORE_READER_push>



;;;;;;;;;;;;;;;;_: t1 -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot t2
(declare-fun Tm_arrow_b55f75622eaf4374ace14ff8827e728b (Term Term Term) Term)

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f: (_: t1 -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot t2) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_53afab8c71ec7fa0c0b426cf41bbb8cf () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_push@tok () Term)





; </end encoding let _dm4f_INT_STORE_READER_push>


; <Start encoding let _dm4f_INT_STORE_READER_wp_if_then_else>

(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     _: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a -> Type)   -> Type
(declare-fun Tm_arrow_bcf347ab15a030106e32d9cd9b63ab2a (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     _: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a -> Type)   -> Type
(declare-fun Tm_arrow_bcf2a1693c01118fa2b236765fc5109d () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_daec3789af99fcea8987a6d27279de39 (Term) Term)
...
;;;;;;;;;;;;;;;;a1: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot Prims.logical) ->     a2: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.GTot Prims.logical) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_de2c2a957dfeba846aa7f5d2910754e4 (Term) Term)
(declare-fun Tm_abs_dfe9ecd9f4c9ae8b27d664fb4daf77ab (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_READER_wp_if_then_else>


; <Start encoding let _dm4f_INT_STORE_READER_wp_close>




(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: b -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_22d62f3dbfb771dafdce07dc17d4d1e1 () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_wp_close@tok () Term)
...
(declare-fun Tm_abs_99728745508433c2f565dab6f2568ecc (Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_READER_wp_close>


; <Start encoding let _dm4f_INT_STORE_READER_stronger>





(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     wp2: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_f68d8a2605448abae67ba0ddedd9e90e () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_stronger@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_READER_stronger>


; <Start encoding let _dm4f_INT_STORE_READER_ite_wp>




(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a -> Type)   -> Prims.logical
(declare-fun Tm_arrow_0f5f9cf17980a0ae66e2abeb3645afae () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_ite_wp@tok () Term)





; </end encoding let _dm4f_INT_STORE_READER_ite_wp>


; <Start encoding let _dm4f_INT_STORE_READER_null_wp>


(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Prims.logical
(declare-fun Tm_arrow_c84c89f926c7fe9c51c23b8462423355 () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_null_wp@tok () Term)


; </end encoding let _dm4f_INT_STORE_READER_null_wp>


; <Start encoding let _dm4f_INT_STORE_READER_wp_trivial>



(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) -> Prims.logical
(declare-fun Tm_arrow_33f4e5bcfbe14138b247d22df868dc9f () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader._dm4f_INT_STORE_READER_wp_trivial@tok () Term)




; </end encoding let _dm4f_INT_STORE_READER_wp_trivial>


; <Start encoding new_effect_for_free { INT_STORE_READER ... }>





(declare-fun Tm_abs_554ae364705a657216a37832b8a4f339 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntStoreFixedReader.__proj__INT_STORE_READER__item__get (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntStoreFixedReader.__proj__INT_STORE_READER__item__get@tok () Term)

; </end encoding new_effect_for_free { INT_STORE_READER ... }>


; <Skipped sub_effect PURE ~> INT_STORE_READER/>


; <Skipped effect IntStoreReader a pre post = FStar.DM4F.IntStoreFixedReader.INT_STORE_READER a/>


; <Skipped effect ISR a = FStar.DM4F.IntStoreFixedReader.INT_STORE_READER a/>


; <Skipped effect ISRNull a = FStar.DM4F.IntStoreFixedReader.INT_STORE_READER a/>


; <Start encoding let read>

(declare-fun FStar.DM4F.IntStoreFixedReader.read (Term) Term)
(declare-fun Non_total_Tm_arrow_890a053bb7b7e9c65d7814ee407844ae () Term)
(declare-fun FStar.DM4F.IntStoreFixedReader.read@tok () Term)
(declare-fun Tm_refine_eac41041c4b7d6d516d3e9a4edbbfa63 (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE Prims.int
(declare-fun Tm_arrow_848bda92a9d2543be5b861171be475bb (Term) Term)

; </end encoding let read>


; End Externals for module FStar.DM4F.IntStoreFixedReader


; Externals for module FStar.DM4F.IntStoreFixed


; <Start encoding let int_store>

(declare-fun FStar.DM4F.IntStoreFixed.int_store (Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed.int_store@tok () Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.M (a & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_a17848d26b4ad0c8eaff7838085c87d7 (Term) Term)

; </end encoding let int_store>


; <Start encoding let return_is>

(declare-fun FStar.DM4F.IntStoreFixed.return_is (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> int_store a
(declare-fun Tm_arrow_d034cb554453befc1f2c3ac3a736ff38 () Term)
(declare-fun FStar.DM4F.IntStoreFixed.return_is@tok () Term)
(declare-fun Tm_abs_add11b2cfe5041f2aeacbd5ad2faf9f7 (Term Term) Term)

; </end encoding let return_is>


; <Start encoding let bind_is>

;;;;;;;;;;;;;;;;_: a -> int_store b
(declare-fun Tm_arrow_f0bbaffae1dbe35ed4f8f2d2b9a163ba (Term Term) Term)
(declare-fun FStar.DM4F.IntStoreFixed.bind_is (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> x: int_store a -> f: (_: a -> int_store b) -> int_store b
(declare-fun Tm_arrow_9cf206dcac4a9e17cf42f9b1a4476a1c () Term)
(declare-fun FStar.DM4F.IntStoreFixed.bind_is@tok () Term)

(declare-fun Tm_abs_2cf5bf4c9c3687249b987f870883f752 (Term Term) Term)

; </end encoding let bind_is>


; <Start encoding let iget>

(declare-fun FStar.DM4F.IntStoreFixed.iget (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> int_store FStar.DM4F.Heap.IntStoreFixed.heap
(declare-fun Tm_arrow_90c665b37224b7fb25ff4eb682d139a0 () Term)
(declare-fun FStar.DM4F.IntStoreFixed.iget@tok () Term)
(declare-fun Tm_abs_3e22f54edd0083a6425bc1e3d28fbc05 () Term)

; </end encoding let iget>


; <Start encoding let iput>

(declare-fun FStar.DM4F.IntStoreFixed.iput (Term) Term)
;;;;;;;;;;;;;;;;s: FStar.DM4F.Heap.IntStoreFixed.heap -> int_store Prims.unit
(declare-fun Tm_arrow_455d95f210aa751ce3e48e6350a370c8 () Term)
(declare-fun FStar.DM4F.IntStoreFixed.iput@tok () Term)
(declare-fun Tm_abs_b39c8c630087b05df5c03dcc1ddf75bf (Term) Term)

; </end encoding let iput>


; <Start encoding let _dm4f_INT_STORE_lift_from_pure>



;;;;;;;;;;;;;;;;_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type
(declare-fun Tm_arrow_4a122dbaa4205e5ff9f905668f3af22a (Term) Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     store: FStar.DM4F.Heap.IntStoreFixed.heap ->     p': (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_36d9f026452ff777c534ecab1cd8e511 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_lift_from_pure@tok () Term)




(declare-fun Tm_abs_737307ff0969ec4d60a4a1acaecd8fcb (Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_lift_from_pure>


; <Start encoding let _dm4f_INT_STORE_return_wp>


(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     x: a ->     store: FStar.DM4F.Heap.IntStoreFixed.heap ->     p': (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_b5e66f64459393dd313af55e8acd59ee () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_return_wp@tok () Term)


; </end encoding let _dm4f_INT_STORE_return_wp>


; <Start encoding let _dm4f_INT_STORE_return_elab>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_return_elab (Term Term) Term)
(declare-fun Tm_refine_68b5da29acf7e36093a4fbab3e18eca5 (Term Term Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE (a & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_61a32202f6d20947ce1bc3bb173e0a17 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (a & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_90f884e453c9c7445e1570c71b781279 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_return_elab@tok () Term)




; </end encoding let _dm4f_INT_STORE_return_elab>


; <Start encoding let _dm4f_INT_STORE_bind_wp>


;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_357068e4fc287c1162b66769695c05f1 (Term) Term)


;;;;;;;;;;;;;;;;_: a ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: b & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_d60b69b95b9d1e23608829f949fe03d4 (Term Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     x:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     f:       (             _: a ->             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: b & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     store: FStar.DM4F.Heap.IntStoreFixed.heap ->     p'': (_: b & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_da86099bf2c9ba90942b3fe6b034ceff () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_bind_wp@tok () Term)
...
(declare-fun Tm_abs_da3cf85747c548a704f8ef805670e54b (Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_bind_wp>


; <Start encoding let _dm4f_INT_STORE_bind_elab>



(declare-fun Tm_refine_faf94212971ab0af3131886562de1cd0 (Term) Term)

;;;;;;;;;;;;;;;;y: _: (a & FStar.DM4F.Heap.IntStoreFixed.heap){Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_8fcceec9e2d1f75a680731d42e2d5799 (Term) Term)
(declare-fun Tm_abs_e68b0ee6a13ea74763c74e23f0c2d4e5 (Term Term) Term)
(declare-fun Tm_refine_2c02ccfc1d0fed9d43011ccd4638cb8a (Term Term Term) Term)



(declare-fun Tm_abs_a58a0067a950327e05f06d693a01270b (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE (a & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_aee29dd0f9c8d113d80d40b0b3e6d4d7 (Term Term) Term)
...
(declare-fun Tm_refine_553de2b5966aa6584a1e86a6ebeb76b6 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE (b & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_944fd14c1b13b855dc3047f5ee2289c5 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE (b & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_0143c18a41cd88f75f02b3243677984d (Term Term Term) Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_bind_elab (Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_a40600650419f2154f37d675a9992ff7 (Term Term Term Term) Term)
(declare-fun Tm_refine_b801916dcf990907639f527b47288421 (Term Term Term Term Term) Term)





(declare-fun Tm_abs_2ede36f197f1ffee247e1206cfaee4d3 (Term Term Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE (b & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_5d27142ffc87fc87d8c3de795a10199d (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     x__w:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     x:       (_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE (a & FStar.DM4F.Heap.IntStoreFixed.heap)) ->     f__w:       (             _: a ->             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: b & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     f:       (_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap           -> Prims.PURE (b & FStar.DM4F.Heap.IntStoreFixed.heap)) ->     store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (b & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_05850f65ec3ab6b0882db7f28bdbee5b () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_bind_elab@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_bind_elab>


; <Start encoding let _dm4f_INT_STORE___proj__INT_STORE__item__get_elab>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE___proj__INT_STORE__item__get_elab (Term) Term)
(declare-fun Tm_refine_666faf3ae22f3405e3b218b2f649d2fe (Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.DM4F.Heap.IntStoreFixed.heap & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_0ebf6797d8c570c4b60a6b385043cc19 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.DM4F.Heap.IntStoreFixed.heap & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_b22bd37309a4fb5e90f54c53fa751e38 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE___proj__INT_STORE__item__get_elab@tok () Term)




; </end encoding let _dm4f_INT_STORE___proj__INT_STORE__item__get_elab>


; <Start encoding let _dm4f_INT_STORE___proj__INT_STORE__item__get_complete_type>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE___proj__INT_STORE__item__get_complete_type () Term)




; </end encoding let _dm4f_INT_STORE___proj__INT_STORE__item__get_complete_type>


; <Start encoding let _dm4f_INT_STORE___proj__INT_STORE__item__put_elab>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE___proj__INT_STORE__item__put_elab (Term) Term)
(declare-fun Tm_refine_423714d01f26e857cc9942d33f5f3022 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_55d2bd815ed9c2d56dff96bb9790a821 (Term) Term)
;;;;;;;;;;;;;;;;s: FStar.DM4F.Heap.IntStoreFixed.heap -> _: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_27344548d5505510fcd6457cd12f97f7 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE___proj__INT_STORE__item__put_elab@tok () Term)




; </end encoding let _dm4f_INT_STORE___proj__INT_STORE__item__put_elab>


; <Start encoding let _dm4f_INT_STORE___proj__INT_STORE__item__put_complete_type>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE___proj__INT_STORE__item__put_complete_type () Term)




; </end encoding let _dm4f_INT_STORE___proj__INT_STORE__item__put_complete_type>


; <Start encoding let _dm4f_INT_STORE_repr>



(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp_a:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type)   -> Type
(declare-fun Tm_arrow_2b454591c85074e98ae0a63bf0f97546 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_repr@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_repr>


; <Start encoding let _dm4f_INT_STORE_pre>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_pre () Term)


; </end encoding let _dm4f_INT_STORE_pre>


; <Start encoding let _dm4f_INT_STORE_post>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_post (Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_post@tok () Term)


; </end encoding let _dm4f_INT_STORE_post>


; <Start encoding let _dm4f_INT_STORE_wp>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_wp (Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_wp@tok () Term)



; </end encoding let _dm4f_INT_STORE_wp>


; <Start encoding let _dm4f_INT_STORE_ctx>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_ctx (Term Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type) -> t
(declare-fun Tm_arrow_57ba49952425aaf03a495d53f8cc5191 (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_ctx>


; <Start encoding let _dm4f_INT_STORE_gctx>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_gctx (Term Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot t
(declare-fun Tm_ghost_arrow_6fa45b03fce308df19c573b637cfab9b (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_gctx>


; <Start encoding let _dm4f_INT_STORE_pure>


(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> t
(declare-fun Tm_arrow_dbf6d82a2f925a10edf179af05d7fedc () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_pure@tok () Term)


; </end encoding let _dm4f_INT_STORE_pure>


; <Start encoding let _dm4f_INT_STORE_app>



;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_47e56ac0884264d05922b46184c3e58e (Term Term Term) Term)



(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot t1) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_7e5ecd1832c2a1a4fd63a543d01f1980 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_app@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_app>


; <Start encoding let _dm4f_INT_STORE_lift1>




(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot t1) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_ae179169c9fc3e835146a7aea8b5dc61 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_lift1@tok () Term)
...
(declare-fun Tm_abs_97c4eadd56e05c1a23387d28a9926dae (Term Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_lift1>


; <Start encoding let _dm4f_INT_STORE_lift2>
...
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot t1) ->     a2:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot t2) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_0aabc12a7bc646ede4df62f4c9be253a () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_lift2@tok () Term)
...
(declare-fun Tm_abs_2151a0a26ee2849387261b7b5ba15fa2 (Term Term Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_lift2>


; <Start encoding let _dm4f_INT_STORE_push>



;;;;;;;;;;;;;;;;_: t1 ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_e3ad7456c733c3d5bd62574aec31a843 (Term Term Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f:       (             _: t1 ->             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot t2) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_026bb58e706fbdd07b9b8de61b70d26e () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_push@tok () Term)





; </end encoding let _dm4f_INT_STORE_push>


; <Start encoding let _dm4f_INT_STORE_wp_if_then_else>

(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_f99de1f3a26b8a8909bc75f44d248834 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_1696c4e5bddb579f24828d3cfae850e9 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_642d63bb149dbfbd78930a7b6ab8b539 (Term) Term)
...
;;;;;;;;;;;;;;;;a1:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot Prims.logical) ->     a2:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot Prims.logical) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_1b7f3ff77754f3239ce274e98ffc9a4d (Term) Term)
(declare-fun Tm_abs_57a4144c89a37aba7a7448215dba2ddf (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_wp_if_then_else>


; <Start encoding let _dm4f_INT_STORE_wp_close>




(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f:       (             _: b ->             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_cc1cfe5cbbc09fa4b6d433dac3b26852 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_wp_close@tok () Term)
...
(declare-fun Tm_abs_6471f978489afb423a19d886a8ae8f50 (Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_wp_close>


; <Start encoding let _dm4f_INT_STORE_stronger>





(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     wp2:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_822d07908a025cb0a42348337957d4f9 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_stronger@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_stronger>


; <Start encoding let _dm4f_INT_STORE_ite_wp>




(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.logical
(declare-fun Tm_arrow_c7b5b5173dd62f13e64561e2527b5013 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_ite_wp@tok () Term)





; </end encoding let _dm4f_INT_STORE_ite_wp>


; <Start encoding let _dm4f_INT_STORE_null_wp>


(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.logical
(declare-fun Tm_arrow_1a822ab2e6eb4f7c1fabe88937b6d63b () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_null_wp@tok () Term)


; </end encoding let _dm4f_INT_STORE_null_wp>


; <Start encoding let _dm4f_INT_STORE_wp_trivial>



(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_73b6f7122f12e03da26fa3b27240b039 () Term)
(declare-fun FStar.DM4F.IntStoreFixed._dm4f_INT_STORE_wp_trivial@tok () Term)




; </end encoding let _dm4f_INT_STORE_wp_trivial>


; <Start encoding new_effect_for_free { INT_STORE ... }>





(declare-fun Tm_abs_eb1f1c4d6539c6993da3da6bf2d24d2e () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntStoreFixed.__proj__INT_STORE__item__get (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntStoreFixed.__proj__INT_STORE__item__get@tok () Term)




(declare-fun Tm_abs_f5eb1bdda21a9c56f1f99baa07af86ee () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntStoreFixed.__proj__INT_STORE__item__put (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntStoreFixed.__proj__INT_STORE__item__put@tok () Term)

; </end encoding new_effect_for_free { INT_STORE ... }>


; <Skipped sub_effect PURE ~> INT_STORE/>


; <Start encoding let get>

(declare-fun FStar.DM4F.IntStoreFixed.get (Term) Term)
(declare-fun Non_total_Tm_arrow_394ce4e1a619a600a62c01e8ed1666fa () Term)
(declare-fun FStar.DM4F.IntStoreFixed.get@tok () Term)
...
(declare-fun FStar.DM4F.IntStoreFixed.put (Term) Term)
(declare-fun Non_total_Tm_arrow_c11168a232bde4dbfb0f200e0bd5a811 () Term)
(declare-fun FStar.DM4F.IntStoreFixed.put@tok () Term)
...
; <Skipped effect IntStore a pre post = FStar.DM4F.IntStoreFixed.INT_STORE a/>


; <Skipped effect IS a = FStar.DM4F.IntStoreFixed.INT_STORE a/>


; <Skipped effect ISNull a = FStar.DM4F.IntStoreFixed.INT_STORE a/>


; <Start encoding let wp>

(declare-fun FStar.DM4F.IntStoreFixed.wp (Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed.wp@tok () Term)
...
(declare-fun FStar.DM4F.IntStoreFixed.pre () Term)
...
(declare-fun FStar.DM4F.IntStoreFixed.post (Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed.post@tok () Term)
...
(declare-fun FStar.DM4F.IntStoreFixed.repr (Term Term) Term)



(declare-fun FStar.DM4F.IntStoreFixed.repr@tok () Term)
...
(declare-fun FStar.DM4F.IntStoreFixed.read (Term) Term)
(declare-fun Non_total_Tm_arrow_bde0ce5945ba32e4bb71d830730bb6c4 () Term)
(declare-fun FStar.DM4F.IntStoreFixed.read@tok () Term)
(declare-fun Tm_refine_c1f7194f7fe3678091017ff02d273dba (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE (Prims.int & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_f7ae0744f1714541e83313281f8e2798 (Term) Term)
...
(declare-fun FStar.DM4F.IntStoreFixed.write (Term Term) Term)
(declare-fun Non_total_Tm_arrow_df6f4765b1fc2a3e6aca581ce2c52489 () Term)
(declare-fun FStar.DM4F.IntStoreFixed.write@tok () Term)
(declare-fun Tm_refine_03a927a17b13c20652477177d78fbc88 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_b2d6b30e9174a09501e8a5719e7357a0 (Term Term) Term)
...
(declare-fun FStar.DM4F.IntStoreFixed.op_Bang (Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed.op_Bang@tok () Term)
...
(declare-fun FStar.DM4F.IntStoreFixed.op_Colon_equals (Term Term) Term)

(declare-fun FStar.DM4F.IntStoreFixed.op_Colon_equals@tok () Term)
...
; <Start encoding val FStar.DM4F.IntStoreFixed.refine_st>


;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> Type
(declare-fun Tm_arrow_975dc2498af7ff9faf2ab2680edc577d (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: b -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> Type
(declare-fun Tm_arrow_33daefae1026867622eacf317c62e6be (Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap -> _: b -> _: FStar.DM4F.Heap.IntStoreFixed.heap   -> Type
(declare-fun Tm_arrow_901ae8d9b89ba1e335f1ea0e6e3979bf (Term Term) Term)




(declare-fun Non_total_Tm_arrow_49bae728a6e1016156f1b971c86a0e78 (Term Term Term Term) Term)
(declare-fun FStar.DM4F.IntStoreFixed.refine_st (Term Term Term Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_d949818cc1585be5f050b05477b39dab () Term)
(declare-fun FStar.DM4F.IntStoreFixed.refine_st@tok () Term)
(declare-fun Tm_refine_a385ed4739aa4d22ee6d7e1c93a07630 (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE (b & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_dc7c3c1fc74ceef7fde6ac9b05d1e074 (Term Term Term Term Term) Term)

; </end encoding val FStar.DM4F.IntStoreFixed.refine_st>


; <Start encoding let lift_int_store_reader_int_store_wp>



(declare-fun FStar.DM4F.IntStoreFixed.lift_int_store_reader_int_store_wp (Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_0d5c7bdc4aba5d8ef8730dc3c82072ce () Term)
(declare-fun FStar.DM4F.IntStoreFixed.lift_int_store_reader_int_store_wp@tok () Term)
...
(declare-fun Tm_abs_4307894404e59341e398b7a551242e9b (Term Term) Term)

; </end encoding let lift_int_store_reader_int_store_wp>


; <Skipped #set-options "--admit_smt_queries true"/>


; <Start encoding let lift_int_store_reader_int_store>
...
(declare-fun FStar.DM4F.IntStoreFixed.lift_int_store_reader_int_store (Term Term Term) Term)
...
(declare-fun Tm_abs_ac08315eac303840d1a40c7c0a8b60dc (Term Term Term) Term)
(declare-fun Tm_refine_58802d7a8fa637fc7b1cceb3d2d471ae (Term Term Term) Term)


;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE (a & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_b3c65856fd7f3a14fc0e70d12ca478ca (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     wp: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> _: (_: a -> Type) -> Type) ->     e: (_: FStar.DM4F.Heap.IntStoreFixed.heap -> Prims.PURE a) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (a & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_19d61b96885da52451445e10b818620c () Term)
(declare-fun FStar.DM4F.IntStoreFixed.lift_int_store_reader_int_store@tok () Term)
...
(declare-fun Tm_abs_36f84d9190732192df7586e208139c8e (Term Term) Term)

; </end encoding let lift_int_store_reader_int_store>


; <Skipped #set-options "--admit_smt_queries false"/>


; <Skipped sub_effect INT_STORE_READER ~> INT_STORE/>


; End Externals for module FStar.DM4F.IntStoreFixed

(push) ;; push{1

; Internals for FStar.DM4F.IntStoreExcFixed


; encoding sigelt let int_store_exc


; <Start encoding let int_store_exc>

(declare-fun FStar.DM4F.IntStoreExcFixed.int_store_exc (Term) Term)

(declare-fun FStar.DM4F.IntStoreExcFixed.int_store_exc@tok () Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.M (FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_e2523ff976a28664f498bf835af2d9e0 (Term) Term)

; </end encoding let int_store_exc>


; encoding sigelt let return_is


; <Start encoding let return_is>

(declare-fun FStar.DM4F.IntStoreExcFixed.return_is (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> int_store_exc a
(declare-fun Tm_arrow_0be973eef4f3557245c9a64821c8ce45 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed.return_is@tok () Term)
(declare-fun Tm_abs_ca68c58d1dc744a423f47aa65c0a1349 (Term Term) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IntStoreExcFixed.int_store_exc; Namespace FStar.DM4F.IntStoreExcFixed
(assert (! 
;; def=FStar.DM4F.IntStoreExcFixed.fst(21,5-21,18); use=FStar.DM4F.IntStoreExcFixed.fst(21,5-21,18)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.IntStoreExcFixed.int_store_exc @x0)
Tm_type))
 

:pattern ((FStar.DM4F.IntStoreExcFixed.int_store_exc @x0))
:qid typing_FStar.DM4F.IntStoreExcFixed.int_store_exc))

:named typing_FStar.DM4F.IntStoreExcFixed.int_store_exc))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.heap; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(23,4-23,8); use=FStar.DM4F.Heap.IntStoreFixed.fsti(23,4-23,8)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e2523ff976a28664f498bf835af2d9e0
;;; Fact-ids: Name FStar.DM4F.IntStoreExcFixed.int_store_exc; Namespace FStar.DM4F.IntStoreExcFixed
(assert (! 
;; def=FStar.DM4F.IntStoreExcFixed.fst(21,30-21,57); use=FStar.DM4F.IntStoreExcFixed.fst(21,30-21,57)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_e2523ff976a28664f498bf835af2d9e0 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_e2523ff976a28664f498bf835af2d9e0 @x0)
Tm_type))
:qid kinding_Tm_arrow_e2523ff976a28664f498bf835af2d9e0))

:named kinding_Tm_arrow_e2523ff976a28664f498bf835af2d9e0))
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntStoreExcFixed.int_store_exc
;;; Fact-ids: Name FStar.DM4F.IntStoreExcFixed.int_store_exc; Namespace FStar.DM4F.IntStoreExcFixed
(assert (! 
;; def=FStar.DM4F.IntStoreExcFixed.fst(21,5-21,18); use=FStar.DM4F.IntStoreExcFixed.fst(21,5-21,18)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.IntStoreExcFixed.int_store_exc @x0)
(Tm_arrow_e2523ff976a28664f498bf835af2d9e0 @x0))
 

:pattern ((FStar.DM4F.IntStoreExcFixed.int_store_exc @x0))
:qid equation_FStar.DM4F.IntStoreExcFixed.int_store_exc))

:named equation_FStar.DM4F.IntStoreExcFixed.int_store_exc))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_e2523ff976a28664f498bf835af2d9e0 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_e2523ff976a28664f498bf835af2d9e0 @x2)))
:qid FStar.DM4F.IntStoreExcFixed_pre_typing_Tm_arrow_e2523ff976a28664f498bf835af2d9e0))

:named FStar.DM4F.IntStoreExcFixed_pre_typing_Tm_arrow_e2523ff976a28664f498bf835af2d9e0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e2523ff976a28664f498bf835af2d9e0
;;; Fact-ids: Name FStar.DM4F.IntStoreExcFixed.int_store_exc; Namespace FStar.DM4F.IntStoreExcFixed
(assert (! 
;; def=FStar.DM4F.IntStoreExcFixed.fst(21,30-21,57); use=FStar.DM4F.IntStoreExcFixed.fst(21,30-21,57)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_e2523ff976a28664f498bf835af2d9e0 @x1))
(and 
;; def=FStar.DM4F.IntStoreExcFixed.fst(21,30-21,57); use=FStar.DM4F.IntStoreExcFixed.fst(21,30-21,57)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.IntStoreExcFixed_interpretation_Tm_arrow_e2523ff976a28664f498bf835af2d9e0.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_e2523ff976a28664f498bf835af2d9e0 @x1)))
:qid FStar.DM4F.IntStoreExcFixed_interpretation_Tm_arrow_e2523ff976a28664f498bf835af2d9e0))

:named FStar.DM4F.IntStoreExcFixed_interpretation_Tm_arrow_e2523ff976a28664f498bf835af2d9e0))
(push) ;; push{2

; Starting query at FStar.DM4F.IntStoreExcFixed.fst(24,2-28,28)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> int_store_exc b
(declare-fun Tm_arrow_951ae606ef80a14d64cd92690078d820 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_951ae606ef80a14d64cd92690078d820
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStoreExcFixed.fst(23,13-23,69); use=FStar.DM4F.IntStoreExcFixed.fst(23,49-23,69)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_951ae606ef80a14d64cd92690078d820 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_951ae606ef80a14d64cd92690078d820 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_951ae606ef80a14d64cd92690078d820))

:named kinding_Tm_arrow_951ae606ef80a14d64cd92690078d820))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStoreExcFixed.fst(23,13-23,69); use=FStar.DM4F.IntStoreExcFixed.fst(23,49-23,69)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_951ae606ef80a14d64cd92690078d820 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_951ae606ef80a14d64cd92690078d820 @x2
@x3)))
:qid FStar.DM4F.IntStoreExcFixed_pre_typing_Tm_arrow_951ae606ef80a14d64cd92690078d820))

:named FStar.DM4F.IntStoreExcFixed_pre_typing_Tm_arrow_951ae606ef80a14d64cd92690078d820))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_951ae606ef80a14d64cd92690078d820
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntStoreExcFixed.fst(23,13-23,69); use=FStar.DM4F.IntStoreExcFixed.fst(23,49-23,69)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_951ae606ef80a14d64cd92690078d820 @x1
@x2))
(and 
;; def=FStar.DM4F.IntStoreExcFixed.fst(23,13-23,69); use=FStar.DM4F.IntStoreExcFixed.fst(23,49-23,69)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(FStar.DM4F.IntStoreExcFixed.int_store_exc @x1)))
 

:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.IntStoreExcFixed_interpretation_Tm_arrow_951ae606ef80a14d64cd92690078d820.1))
...
(Tm_arrow_951ae606ef80a14d64cd92690078d820 @x1
@x2)))
:qid FStar.DM4F.IntStoreExcFixed_interpretation_Tm_arrow_951ae606ef80a14d64cd92690078d820))

:named FStar.DM4F.IntStoreExcFixed_interpretation_Tm_arrow_951ae606ef80a14d64cd92690078d820))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (x: FStar.DM4F.IntStoreExcFixed.int_store_exc a)
;   (f: (_: a -> FStar.DM4F.IntStoreExcFixed.int_store_exc b)).
;   (*  - Could not prove post-condition
; *)
;   forall (store: FStar.DM4F.Heap.IntStoreFixed.heap).
;     (*  - Could not prove post-condition
; *)
;     forall (b: FStar.Pervasives.Native.option a) (b: FStar.DM4F.Heap.IntStoreFixed.heap).
;       x store == (b, b) ==>
;       (forall (k:
;           Prims.pure_post (FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap)).
;           (forall (x: FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap).
...
; While typechecking the top-level declaration `let bind_is`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStoreExcFixed.fst(24,2-28,28)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.DM4F.Heap.IntStoreFixed.heap Dummy_value))

;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.IntStoreExcFixed.fst(24,14-28,28)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(FStar.Pervasives.Native.option @x0))
...
;; def=FStar.DM4F.IntStoreExcFixed.fst(25,7-25,16); use=FStar.DM4F.IntStoreExcFixed.fst(25,7-25,16)
(= (ApplyTT @x2
@x4)
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.IntStoreExcFixed.fst(24,14-28,28)
(forall ((@x8 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.IntStoreExcFixed.fst(24,14-28,28)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.IntStoreExcFixed.fst(24,14-28,28)
(ApplyTT @x7
@x8)
...
;; def=FStar.DM4F.IntStoreExcFixed.fst(25,7-25,8); use=FStar.DM4F.IntStoreExcFixed.fst(26,10-26,11)
(not 
;; def=FStar.DM4F.IntStoreExcFixed.fst(25,7-25,8); use=FStar.DM4F.IntStoreExcFixed.fst(26,10-26,11)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x0
@x5))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStoreExcFixed.bind_is, 1)
; STATUS: unsat
...
;;;;;;;;;;;;;;;;_: a -> int_store_exc b
(declare-fun Tm_arrow_951ae606ef80a14d64cd92690078d820 (Term Term) Term)
(declare-fun FStar.DM4F.IntStoreExcFixed.bind_is (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> x: int_store_exc a -> f: (_: a -> int_store_exc b) -> int_store_exc b
(declare-fun Tm_arrow_c38d4e763340eb2afe0c34d00b64a3ee () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed.bind_is@tok () Term)

(declare-fun Tm_abs_b2952fc163544d180c62c64580a80dd3 (Term Term Term) Term)

; </end encoding let bind_is>


; encoding sigelt let iget


; <Start encoding let iget>

(declare-fun FStar.DM4F.IntStoreExcFixed.iget (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> int_store_exc FStar.DM4F.Heap.IntStoreFixed.heap
(declare-fun Tm_arrow_b51bbb7433d9b174e407f43b51f6d64e () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed.iget@tok () Term)
(declare-fun Tm_abs_6169b3ea32ca1b53d4c1becbc6732636 () Term)

; </end encoding let iget>


; encoding sigelt let iput


; <Start encoding let iput>

(declare-fun FStar.DM4F.IntStoreExcFixed.iput (Term) Term)
;;;;;;;;;;;;;;;;s: FStar.DM4F.Heap.IntStoreFixed.heap -> int_store_exc Prims.unit
(declare-fun Tm_arrow_c5c1398bd02c9b39ae15f68d70b1ebbb () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed.iput@tok () Term)
(declare-fun Tm_abs_8e0458ea656a29089d238795e8d3dab6 (Term) Term)

; </end encoding let iput>


; encoding sigelt let raise_impl


; <Start encoding let raise_impl>

(declare-fun FStar.DM4F.IntStoreExcFixed.raise_impl (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> int_store_exc Prims.l_False
(declare-fun Tm_arrow_43f2671dcf125dbe9ffba1a948c6f315 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed.raise_impl@tok () Term)
(declare-fun Tm_abs_a58fc4a40c7e82e8f9b1f0bae2dee567 () Term)

; </end encoding let raise_impl>


; encoding sigelt let _dm4f_INT_STORE_EXC_lift_from_pure


; <Start encoding let _dm4f_INT_STORE_EXC_lift_from_pure>



;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type
(declare-fun Tm_arrow_f0297d2ee5b7ca9baafb27e5077261bd (Term) Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     store: FStar.DM4F.Heap.IntStoreFixed.heap ->     p': (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_67b0df440dad153d3f9ed750e6a3aac7 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_lift_from_pure@tok () Term)




(declare-fun Tm_abs_7176a8d34214f83e159983b579b3b20b (Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_EXC_lift_from_pure>


; encoding sigelt let _dm4f_INT_STORE_EXC_return_wp


; <Start encoding let _dm4f_INT_STORE_EXC_return_wp>


(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     x: a ->     store: FStar.DM4F.Heap.IntStoreFixed.heap ->     p': (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_6665276414a3b0fee1f5f270545c7b21 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_return_wp@tok () Term)


; </end encoding let _dm4f_INT_STORE_EXC_return_wp>


; encoding sigelt let _dm4f_INT_STORE_EXC_return_elab


; <Start encoding let _dm4f_INT_STORE_EXC_return_elab>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_return_elab (Term Term) Term)
(declare-fun Tm_refine_7cdf8eb420109f6bb9ae6881333a45b6 (Term Term Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_8bfaab1434525463349d763e06575f62 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_3e3083ac9f3b64367ff34647c18680de () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_return_elab@tok () Term)




; </end encoding let _dm4f_INT_STORE_EXC_return_elab>


; encoding sigelt let _dm4f_INT_STORE_EXC_bind_wp


; <Start encoding let _dm4f_INT_STORE_EXC_bind_wp>


;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_4591661f09ab188489567205986d67e3 (Term) Term)


;;;;;;;;;;;;;;;;_: a ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_322b8eb6ba0e084f67fba95a9a3b4b6a (Term Term) Term)

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     x:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     f:       (             _: a ->             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     store: FStar.DM4F.Heap.IntStoreFixed.heap ->     p'': (_: FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_058acdf0635c7b7093b04300487abb91 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_bind_wp@tok () Term)
...
(declare-fun Tm_abs_60040f51bd19fd54a2fa310643f6766f (Term Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_EXC_bind_wp>


; encoding sigelt let _dm4f_INT_STORE_EXC_bind_elab


; <Start encoding let _dm4f_INT_STORE_EXC_bind_elab>



(declare-fun Tm_refine_e5cffd39d25b7acf9db604c21112110f (Term) Term)

;;;;;;;;;;;;;;;;y: _: (FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap){Prims.l_True}   -> Prims.GTot Type
(declare-fun Tm_arrow_ed5303b8595beeecf00ca8a10300f10a (Term) Term)
(declare-fun Tm_abs_eda3664990d24e9e6b326755676c1317 (Term Term) Term)
(declare-fun Tm_refine_fed12ac40f455309703edf8ea81c52d2 (Term Term Term) Term)



(declare-fun Tm_abs_7b67cfcdc77e4576501d51422ae17e88 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_ee8466190b345f48fd316635cbd02790 (Term Term) Term)
...
(declare-fun Tm_refine_9cf8076051263b9b1b2585fbfd1f14f0 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_0c9265b06a0373693d733d84e8b4feee (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_3ba64b18b5b5cbafd51e4e0df6305115 (Term Term Term) Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_bind_elab (Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_cae0e4279625638da447788782f06a3d (Term Term Term Term) Term)
(declare-fun Tm_refine_b6b7e92dbf865869aba4ee35de51f708 (Term Term Term Term Term) Term)





(declare-fun Tm_abs_1f8475c47f9257905ba7b5a421b023c8 (Term Term Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_56ffe9a44cfc26799886e36dd36095fb (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     x__w:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     x:       (_: FStar.DM4F.Heap.IntStoreFixed.heap           -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap)) ->     f__w:       (             _: a ->             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     f:       (_: a -> _: FStar.DM4F.Heap.IntStoreFixed.heap           -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap)) ->     store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_7a49f672cee0526bb30d8a7b90c5b475 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_bind_elab@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_EXC_bind_elab>


; encoding sigelt let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__get_elab


; <Start encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__get_elab>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__get_elab (Term) Term)
(declare-fun Tm_refine_a8f59cda3d8e751249067ef3c2dda766 (Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE     (FStar.Pervasives.Native.option FStar.DM4F.Heap.IntStoreFixed.heap &       FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_70659e7c4b756b31ac8e383e937a91f5 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE     (FStar.Pervasives.Native.option FStar.DM4F.Heap.IntStoreFixed.heap &       FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_1e496d58e2a3078cd1031cea825b8417 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__get_elab@tok () Term)




; </end encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__get_elab>


; encoding sigelt let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__get_complete_type


; <Start encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__get_complete_type>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__get_complete_type () Term)




; </end encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__get_complete_type>


; encoding sigelt let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__put_elab


; <Start encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__put_elab>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__put_elab (Term) Term)
(declare-fun Tm_refine_892f0ff0180544414bf9c6df0feb167a (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option Prims.unit & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_fde952d448615d4ced632e00d336781c (Term) Term)
;;;;;;;;;;;;;;;;s: FStar.DM4F.Heap.IntStoreFixed.heap -> _: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option Prims.unit & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_4a76f352a50479be572769a975e4f8c8 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__put_elab@tok () Term)




; </end encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__put_elab>


; encoding sigelt let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__put_complete_type


; <Start encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__put_complete_type>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__put_complete_type () Term)




; </end encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__put_complete_type>


; encoding sigelt let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__raise__elab


; <Start encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__raise__elab>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__raise__elab (Term) Term)
(declare-fun Tm_refine_ae8f2de04922a6da3944e874fb95b60d (Term) Term)
;;;;;;;;;;;;;;;;store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option Prims.l_False & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_7c64778dc374557727d55a486a7d12b5 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> store__x: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE (FStar.Pervasives.Native.option Prims.l_False & FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_462a158f82308c066fa49d808c3c2474 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__raise__elab@tok () Term)




; </end encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__raise__elab>


; encoding sigelt let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__raise__complete_type


; <Start encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__raise__complete_type>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__raise__complete_type () Term)




; </end encoding let _dm4f_INT_STORE_EXC___proj__INT_STORE_EXC__item__raise__complete_type>


; encoding sigelt let _dm4f_INT_STORE_EXC_repr


; <Start encoding let _dm4f_INT_STORE_EXC_repr>



(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp_a:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type)   -> Type
(declare-fun Tm_arrow_e2202c3ff230998b4df3969b699e05a1 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_repr@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_EXC_repr>


; encoding sigelt let _dm4f_INT_STORE_EXC_pre


; <Start encoding let _dm4f_INT_STORE_EXC_pre>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_pre () Term)


; </end encoding let _dm4f_INT_STORE_EXC_pre>


; encoding sigelt let _dm4f_INT_STORE_EXC_post


; <Start encoding let _dm4f_INT_STORE_EXC_post>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_post (Term) Term)

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_post@tok () Term)


; </end encoding let _dm4f_INT_STORE_EXC_post>


; encoding sigelt let _dm4f_INT_STORE_EXC_wp


; <Start encoding let _dm4f_INT_STORE_EXC_wp>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_wp (Term) Term)

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_wp@tok () Term)



; </end encoding let _dm4f_INT_STORE_EXC_wp>


; encoding sigelt let _dm4f_INT_STORE_EXC_ctx


; <Start encoding let _dm4f_INT_STORE_EXC_ctx>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_ctx (Term Term) Term)

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> t
(declare-fun Tm_arrow_0954335ea3c51e4ddc7f02dbc36c62e7 (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_EXC_ctx>


; encoding sigelt let _dm4f_INT_STORE_EXC_gctx


; <Start encoding let _dm4f_INT_STORE_EXC_gctx>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_gctx (Term Term) Term)

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot t
(declare-fun Tm_ghost_arrow_0b7b9b850e33938c4f66f621aaddcce6 (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_EXC_gctx>


; encoding sigelt let _dm4f_INT_STORE_EXC_pure


; <Start encoding let _dm4f_INT_STORE_EXC_pure>


(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> t
(declare-fun Tm_arrow_07191345c3e7ac2758ddb48b555834fb () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_pure@tok () Term)


; </end encoding let _dm4f_INT_STORE_EXC_pure>


; encoding sigelt let _dm4f_INT_STORE_EXC_app


; <Start encoding let _dm4f_INT_STORE_EXC_app>



;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_24babbc56c641f6a5b438f0e32e5efba (Term Term Term) Term)



(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot t1) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_c480b84a5c1b581f02dbd69815bec2f9 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_app@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_EXC_app>


; encoding sigelt let _dm4f_INT_STORE_EXC_lift1


; <Start encoding let _dm4f_INT_STORE_EXC_lift1>




(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot t1) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_bbfe360d91a6d1b1c0f525c40555c462 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_lift1@tok () Term)
...
(declare-fun Tm_abs_7a1bb21f81bc168be5f2273449681f30 (Term Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_EXC_lift1>


; encoding sigelt let _dm4f_INT_STORE_EXC_lift2


; <Start encoding let _dm4f_INT_STORE_EXC_lift2>
...
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot t1) ->     a2:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot t2) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_b237b81bd5d6a1fd255452e6801fe291 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_lift2@tok () Term)
...
(declare-fun Tm_abs_4e743b8ba8edd707af183d491719df42 (Term Term Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_EXC_lift2>


; encoding sigelt let _dm4f_INT_STORE_EXC_push


; <Start encoding let _dm4f_INT_STORE_EXC_push>



;;;;;;;;;;;;;;;;_: t1 ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_02818c24f974f6885313a44839d4ac04 (Term Term Term) Term)

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f:       (             _: t1 ->             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot t2) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_ceedb996a254da5e846b54d78c4009a2 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_push@tok () Term)





; </end encoding let _dm4f_INT_STORE_EXC_push>


; encoding sigelt let _dm4f_INT_STORE_EXC_wp_if_then_else


; <Start encoding let _dm4f_INT_STORE_EXC_wp_if_then_else>

(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_38ae3470135384926a7a81d7c83195d8 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Type
(declare-fun Tm_arrow_138a39f68e30ca803cdaca67ce516fcc () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_462356d1b3c39a04b8498ecafee2a43f (Term) Term)
...
;;;;;;;;;;;;;;;;a1:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot Prims.logical) ->     a2:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Prims.GTot Prims.logical) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_97e775be26e4bd9ea68c3e5b133a64e0 (Term) Term)
(declare-fun Tm_abs_c080cdd68a8349a456cd828b93250659 (Term Term) Term)

; </end encoding let _dm4f_INT_STORE_EXC_wp_if_then_else>


; encoding sigelt let _dm4f_INT_STORE_EXC_wp_close


; <Start encoding let _dm4f_INT_STORE_EXC_wp_close>




(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f:       (             _: b ->             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_17ee19c762e4cd51f80b9f5d4ad778ba () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_wp_close@tok () Term)
...
(declare-fun Tm_abs_c7c37b91b0703d310650c23c3a61729f (Term Term Term) Term)

; </end encoding let _dm4f_INT_STORE_EXC_wp_close>


; encoding sigelt let _dm4f_INT_STORE_EXC_stronger


; <Start encoding let _dm4f_INT_STORE_EXC_stronger>





(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     wp2:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_cfd5238baa26cd3dde655968fbbcf01d () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_stronger@tok () Term)
...
; </end encoding let _dm4f_INT_STORE_EXC_stronger>


; encoding sigelt let _dm4f_INT_STORE_EXC_ite_wp


; <Start encoding let _dm4f_INT_STORE_EXC_ite_wp>




(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type) ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.logical
(declare-fun Tm_arrow_03902fa3a0a8a3f52715636beecb38eb () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_ite_wp@tok () Term)





; </end encoding let _dm4f_INT_STORE_EXC_ite_wp>


; encoding sigelt let _dm4f_INT_STORE_EXC_null_wp


; <Start encoding let _dm4f_INT_STORE_EXC_null_wp>


(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     _: FStar.DM4F.Heap.IntStoreFixed.heap ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)   -> Prims.logical
(declare-fun Tm_arrow_13350cc1bfeddcb120a067f298dce98f () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_null_wp@tok () Term)


; </end encoding let _dm4f_INT_STORE_EXC_null_wp>


; encoding sigelt let _dm4f_INT_STORE_EXC_wp_trivial


; <Start encoding let _dm4f_INT_STORE_EXC_wp_trivial>



(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp:       (             _: FStar.DM4F.Heap.IntStoreFixed.heap ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_e364ec2a5b301ed80df6a10391f2bf29 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_wp_trivial@tok () Term)




; </end encoding let _dm4f_INT_STORE_EXC_wp_trivial>


; encoding sigelt new_effect_for_free { INT_STORE_EXC ... }


; <Start encoding new_effect_for_free { INT_STORE_EXC ... }>





(declare-fun Tm_abs_936023dc6b4c426772a2f02a9a4c3dc5 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntStoreExcFixed.__proj__INT_STORE_EXC__item__get (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntStoreExcFixed.__proj__INT_STORE_EXC__item__get@tok () Term)




(declare-fun Tm_abs_18b56141e981518d5158ae8287c1437d () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntStoreExcFixed.__proj__INT_STORE_EXC__item__put (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntStoreExcFixed.__proj__INT_STORE_EXC__item__put@tok () Term)
(declare-fun Tm_refine_72b607c315ccd653b2c38d69f398c7cb () Term)

(declare-fun Tm_abs_fca28f4cbb6f4b2fa944ab91a89409d7 () Term)



(declare-fun Tm_refine_9877ba275a37c5d9ddc8b819d73203c0 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.IntStoreFixed.heap   -> Prims.PURE     (FStar.Pervasives.Native.option (x: Prims.unit{Prims.empty}) &       FStar.DM4F.Heap.IntStoreFixed.heap)
(declare-fun Tm_arrow_891d5645dfae6d62d7966f6613193934 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit   -> FStar.DM4F.IntStoreExcFixed._dm4f_INT_STORE_EXC_repr (x: Prims.unit{Prims.empty})       (fun store__x p' -> p' (FStar.Pervasives.Native.None, store__x))
(declare-fun Tm_arrow_aad3131134c1b63d26cf25b6b44ec87b () Term)
(declare-fun Tm_abs_cb8acd2409c1119a23c17c81d2f08cc9 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntStoreExcFixed.__proj__INT_STORE_EXC__item__raise_ (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntStoreExcFixed.__proj__INT_STORE_EXC__item__raise_@tok () Term)

; </end encoding new_effect_for_free { INT_STORE_EXC ... }>


; encoding sigelt sub_effect PURE ~> INT_STORE_EXC


; <Skipped sub_effect PURE ~> INT_STORE_EXC/>
...
(declare-fun FStar.DM4F.IntStoreExcFixed.get (Term) Term)
(declare-fun Non_total_Tm_arrow_3c86dee201586e64fa4be94646dd1098 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed.get@tok () Term)
...
(declare-fun FStar.DM4F.IntStoreExcFixed.put (Term) Term)
(declare-fun Non_total_Tm_arrow_fef1beefcfcd074810c8af33af1d1cb1 () Term)
(declare-fun FStar.DM4F.IntStoreExcFixed.put@tok () Term)
...
; encoding sigelt effect IntStoreExc a pre post = FStar.DM4F.IntStoreExcFixed.INT_STORE_EXC a


; <Skipped effect IntStoreExc a pre post = FStar.DM4F.IntStoreExcFixed.INT_STORE_EXC a/>


; encoding sigelt effect ISE a = FStar.DM4F.IntStoreExcFixed.INT_STORE_EXC a


; <Skipped effect ISE a = FStar.DM4F.IntStoreExcFixed.INT_STORE_EXC a/>


; encoding sigelt effect ISENull a = FStar.DM4F.IntStoreExcFixed.INT_STORE_EXC a


; <Skipped effect ISENull a = FStar.DM4F.IntStoreExcFixed.INT_STORE_EXC a/>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntStoreExcFixed.INT_STORE_EXC; Namespace FStar.DM4F.IntStoreExcFixed
(assert (! (HasType Tm_refine_72b607c315ccd653b2c38d69f398c7cb
Tm_type)
:named refinement_kinding_Tm_refine_72b607c315ccd653b2c38d69f398c7cb))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.IntStoreExcFixed.INT_STORE_EXC; Namespace FStar.DM4F.IntStoreExcFixed
(assert (! 
;; def=Prims.fst(117,32-117,42); use=Prims.fst(117,32-117,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_72b607c315ccd653b2c38d69f398c7cb)
(and (HasTypeFuel @u0
@x1
Prims.unit)

;; def=Prims.fst(159,29-159,34); use=Prims.fst(159,29-159,34)
(Valid 
;; def=Prims.fst(159,29-159,34); use=Prims.fst(159,29-159,34)
Prims.empty
)
...
@x1
Tm_refine_72b607c315ccd653b2c38d69f398c7cb))
:qid refinement_interpretation_Tm_refine_72b607c315ccd653b2c38d69f398c7cb))

:named refinement_interpretation_Tm_refine_72b607c315ccd653b2c38d69f398c7cb))
;;; Fact-ids: Name Prims.empty; Namespace Prims
(assert (! (HasType Prims.empty
Tm_type)
:named kinding_Prims.empty@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_72b607c315ccd653b2c38d69f398c7cb
;;; Fact-ids: Name FStar.DM4F.IntStoreExcFixed.INT_STORE_EXC; Namespace FStar.DM4F.IntStoreExcFixed
(assert (! (iff (Valid (Prims.hasEq Tm_refine_72b607c315ccd653b2c38d69f398c7cb))
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_72b607c315ccd653b2c38d69f398c7cb))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.empty; Namespace Prims
(assert (! 
...
; Starting query at FStar.DM4F.IntStoreExcFixed.fst(62,1-62,60)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (_: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (_: FStar.DM4F.Heap.IntStoreFixed.heap)
;     (p: Prims.pure_post (FStar.Pervasives.Native.option a & FStar.DM4F.Heap.IntStoreFixed.heap)).
;     (forall (x: FStar.Pervasives.Native.option a) (l1: FStar.DM4F.Heap.IntStoreFixed.heap).
;         _ == l1 /\ None? x ==> p (x, l1)) ==>
;     p (FStar.Pervasives.Native.None, _)
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntStoreExcFixed.fst(62,1-62,60)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
(FStar.DM4F.Heap.IntStoreFixed.heap Dummy_value))
(HasType @x3
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option @x0)
(FStar.DM4F.Heap.IntStoreFixed.heap Dummy_value))))

;; def=FStar.DM4F.IntStoreExcFixed.fst(51,41-51,92); use=FStar.DM4F.IntStoreExcFixed.fst(62,1-62,60)
...
;; def=FStar.DM4F.IntStoreExcFixed.fst(61,50-61,58); use=FStar.DM4F.IntStoreExcFixed.fst(62,1-62,60)
(= @x2
@x5)


;; def=FStar.DM4F.IntStoreExcFixed.fst(61,62-61,69); use=FStar.DM4F.IntStoreExcFixed.fst(62,1-62,60)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x0
@x4))
)

;; def=FStar.DM4F.IntStoreExcFixed.fst(51,82-51,91); use=FStar.DM4F.IntStoreExcFixed.fst(62,1-62,60)
(Valid 
;; def=FStar.DM4F.IntStoreExcFixed.fst(51,82-51,91); use=FStar.DM4F.IntStoreExcFixed.fst(62,1-62,60)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option @x0)
...
;; def=FStar.DM4F.IntStoreExcFixed.fst(27,14-27,26); use=FStar.DM4F.IntStoreExcFixed.fst(62,1-62,60)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntStoreExcFixed.raise_, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, constructor_distinct_FStar.Pervasives.Native.None, data_typing_intro_FStar.Pervasives.Native.None@tok, disc_equation_FStar.Pervasives.Native.None, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.None_a
