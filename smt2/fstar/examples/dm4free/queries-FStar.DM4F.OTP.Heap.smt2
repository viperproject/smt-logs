...
; Internals for FStar.DM4F.OTP.Heap
...
(declare-fun FStar.DM4F.OTP.Heap.size (Dummy_sort) Term)

; </end encoding let size>


; encoding sigelt val FStar.DM4F.OTP.Heap.q


; <Skipped val FStar.DM4F.OTP.Heap.q/>
...
(declare-fun FStar.DM4F.OTP.Heap.q (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.q; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(23,4-23,5); use=FStar.DM4F.OTP.Heap.fst(23,4-23,5)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.DM4F.OTP.Heap.q @u0)
Prims.pos)
 

:pattern ((FStar.DM4F.OTP.Heap.q @u0))
:qid typing_FStar.DM4F.OTP.Heap.q))

:named typing_FStar.DM4F.OTP.Heap.q))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.q
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.q; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(23,4-23,5); use=FStar.DM4F.OTP.Heap.fst(23,4-23,5)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=FStar.DM4F.OTP.Heap.fst(23,4-23,5); use=FStar.DM4F.OTP.Heap.fst(23,4-23,5)
(FStar.DM4F.OTP.Heap.q @u0)

(Prims.admit Prims.pos
Tm_unit))
...
:qid equation_FStar.DM4F.OTP.Heap.q))

:named equation_FStar.DM4F.OTP.Heap.q))
...
; Starting query at FStar.DM4F.OTP.Heap.fsti(27,0-27,17)

(declare-fun label_1 () Bool)

; Encoding query formula : FStar.DM4F.OTP.Heap.q > 0 ==> FStar.DM4F.OTP.Heap.q >= 0


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let elem`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=Prims.fst(683,18-683,23); use=FStar.DM4F.OTP.Heap.fsti(27,16-27,17)
(> (BoxInt_proj_0 (FStar.DM4F.OTP.Heap.q Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))


;; def=Prims.fst(680,18-680,24); use=FStar.DM4F.OTP.Heap.fsti(27,16-27,17)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.elem, 1)
; STATUS: unsat
...
; encoding sigelt let elem


; <Start encoding let elem>

(declare-fun FStar.DM4F.OTP.Heap.elem () Term)

; </end encoding let elem>


; encoding sigelt val FStar.DM4F.OTP.Heap.id


; <Skipped val FStar.DM4F.OTP.Heap.id/>
...
; Starting query at FStar.DM4F.OTP.Heap.fst(25,5-25,7)
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.DM4F.OTP.Heap.fst(25,21-25,24); use=FStar.DM4F.OTP.Heap.fst(25,21-25,24)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.id, 1)
; STATUS: unsat
...
(declare-fun FStar.DM4F.OTP.Heap.id (Dummy_sort) Term)
(declare-fun Tm_refine_ab1935d06c5b83d762f98a79720546e5 () Term)

; </end encoding let id>


; encoding sigelt val FStar.DM4F.OTP.Heap.tape


; <Skipped val FStar.DM4F.OTP.Heap.tape/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.size; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(23,4-23,8); use=FStar.DM4F.OTP.Heap.fsti(23,4-23,8)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.DM4F.OTP.Heap.size @u0)
Prims.int)
 

:pattern ((FStar.DM4F.OTP.Heap.size @u0))
:qid typing_FStar.DM4F.OTP.Heap.size))

:named typing_FStar.DM4F.OTP.Heap.size))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.elem; Namespace FStar.DM4F.OTP.Heap
(assert (! (HasType FStar.DM4F.OTP.Heap.elem
Tm_type)
:named typing_FStar.DM4F.OTP.Heap.elem))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.id; Namespace FStar.DM4F.OTP.Heap
(assert (! (HasType Tm_refine_ab1935d06c5b83d762f98a79720546e5
Tm_type)
:named refinement_kinding_Tm_refine_ab1935d06c5b83d762f98a79720546e5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.BitVector.bv_t; Namespace FStar.BitVector
(assert (! 
;; def=FStar.BitVector.fsti(32,21-32,51); use=FStar.BitVector.fsti(32,21-32,51)
...
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.id; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(25,19-25,34); use=FStar.DM4F.OTP.Heap.fst(25,19-25,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ab1935d06c5b83d762f98a79720546e5)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=FStar.DM4F.OTP.Heap.fst(25,25-25,33); use=FStar.DM4F.OTP.Heap.fst(25,25-25,33)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
))
...
@x1
Tm_refine_ab1935d06c5b83d762f98a79720546e5))
:qid refinement_interpretation_Tm_refine_ab1935d06c5b83d762f98a79720546e5))

:named refinement_interpretation_Tm_refine_ab1935d06c5b83d762f98a79720546e5))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_ab1935d06c5b83d762f98a79720546e5
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.id; Namespace FStar.DM4F.OTP.Heap
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ab1935d06c5b83d762f98a79720546e5))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_ab1935d06c5b83d762f98a79720546e5))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.elem; Namespace FStar.DM4F.OTP.Heap
(assert (! (HasType FStar.DM4F.OTP.Heap.elem
Tm_type)
:named function_token_typing_FStar.DM4F.OTP.Heap.elem))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.size
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.size; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(23,4-23,8); use=FStar.DM4F.OTP.Heap.fsti(23,4-23,8)
(forall ((@u0 Dummy_sort))
...
:qid equation_FStar.DM4F.OTP.Heap.size))

:named equation_FStar.DM4F.OTP.Heap.size))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.elem
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.elem; Namespace FStar.DM4F.OTP.Heap
(assert (! (= FStar.DM4F.OTP.Heap.elem
(FStar.BitVector.bv_t (FStar.DM4F.OTP.Heap.q Dummy_value)))
:named equation_FStar.DM4F.OTP.Heap.elem))
...
; Starting query at FStar.DM4F.OTP.Heap.fst(27,5-27,9)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq (FStar.Seq.Base.seq FStar.DM4F.OTP.Heap.elem)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let tape`
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.DM4F.OTP.Heap.fst(27,23-27,31); use=FStar.DM4F.OTP.Heap.fst(27,23-27,31)
(or label_1

;; def=FStar.DM4F.OTP.Heap.fst(27,23-27,31); use=FStar.DM4F.OTP.Heap.fst(27,23-27,31)
(Valid 
;; def=FStar.DM4F.OTP.Heap.fst(27,23-27,31); use=FStar.DM4F.OTP.Heap.fst(27,23-27,31)
(Prims.hasEq (FStar.Seq.Base.seq FStar.DM4F.OTP.Heap.elem))
)
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.tape, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.BitVector.bv_t, equation_FStar.DM4F.OTP.Heap.elem, equation_FStar.DM4F.OTP.Heap.q, equation_Prims.eqtype, haseqTm_refine_e2d5d62a90ceed8a6faf9d20615f4e1e, lemma_FStar.Seq.Base.hasEq_lemma, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.DM4F.OTP.Heap.elem, typing_Prims.bool
...
; encoding sigelt let tape


; <Start encoding let tape>

(declare-fun FStar.DM4F.OTP.Heap.tape (Dummy_sort) Term)
(declare-fun Tm_refine_a839637410d9c2e1da47cdb933b51925 () Term)

; </end encoding let tape>


; encoding sigelt val FStar.DM4F.OTP.Heap.to_id


; <Skipped val FStar.DM4F.OTP.Heap.to_id/>
...
(declare-fun FStar.DM4F.OTP.Heap.to_id (Term) Term)

;;;;;;;;;;;;;;;;n: Prims.nat{n < size} -> id
(declare-fun Tm_arrow_fa0eff3dd174200166421e5e085bee4f () Term)
(declare-fun FStar.DM4F.OTP.Heap.to_id@tok () Term)


; </end encoding let to_id>


; encoding sigelt val FStar.DM4F.OTP.Heap.incrementable


; <Skipped val FStar.DM4F.OTP.Heap.incrementable/>


; encoding sigelt let incrementable


; <Start encoding let incrementable>

(declare-fun FStar.DM4F.OTP.Heap.incrementable (Term) Term)
;;;;;;;;;;;;;;;;i: id -> Prims.bool
(declare-fun Tm_arrow_9b8cddde8a1357592ece51bd650e5bb5 () Term)
(declare-fun FStar.DM4F.OTP.Heap.incrementable@tok () Term)

; </end encoding let incrementable>


; encoding sigelt val FStar.DM4F.OTP.Heap.incr


; <Skipped val FStar.DM4F.OTP.Heap.incr/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.incrementable; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(31,4-31,17); use=FStar.DM4F.OTP.Heap.fst(31,4-31,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.DM4F.OTP.Heap.id Dummy_value))
(HasType (FStar.DM4F.OTP.Heap.incrementable @x0)
Prims.bool))
 

:pattern ((FStar.DM4F.OTP.Heap.incrementable @x0))
:qid typing_FStar.DM4F.OTP.Heap.incrementable))

:named typing_FStar.DM4F.OTP.Heap.incrementable))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.id; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(25,5-25,7); use=FStar.DM4F.OTP.Heap.fst(25,5-25,7)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.DM4F.OTP.Heap.id @u0)
Prims.eqtype)
 

:pattern ((FStar.DM4F.OTP.Heap.id @u0))
:qid typing_FStar.DM4F.OTP.Heap.id))

:named typing_FStar.DM4F.OTP.Heap.id))
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.incrementable
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.incrementable; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(31,4-31,17); use=FStar.DM4F.OTP.Heap.fst(31,4-31,17)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.OTP.Heap.incrementable @x0)
(Prims.op_LessThan (Prims.op_Addition @x0
(BoxInt 1))
(FStar.DM4F.OTP.Heap.size Dummy_value)))
 

:pattern ((FStar.DM4F.OTP.Heap.incrementable @x0))
:qid equation_FStar.DM4F.OTP.Heap.incrementable))

:named equation_FStar.DM4F.OTP.Heap.incrementable))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.id
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.id; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(25,5-25,7); use=FStar.DM4F.OTP.Heap.fst(25,5-25,7)
(forall ((@u0 Dummy_sort))
...
:qid equation_FStar.DM4F.OTP.Heap.id))

:named equation_FStar.DM4F.OTP.Heap.id))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Heap.fst(33,40-33,53)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_aff078fed7f4c0267d7d97ac63cc368c () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_aff078fed7f4c0267d7d97ac63cc368c
Tm_type)
:named refinement_kinding_Tm_refine_aff078fed7f4c0267d7d97ac63cc368c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(33,9-33,32); use=FStar.DM4F.OTP.Heap.fst(33,9-33,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_aff078fed7f4c0267d7d97ac63cc368c)
(and (HasTypeFuel @u0
@x1
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fst(33,15-33,30); use=FStar.DM4F.OTP.Heap.fst(33,15-33,30)
(BoxBool_proj_0 (FStar.DM4F.OTP.Heap.incrementable @x1))
))
...
@x1
Tm_refine_aff078fed7f4c0267d7d97ac63cc368c))
:qid refinement_interpretation_Tm_refine_aff078fed7f4c0267d7d97ac63cc368c))

:named refinement_interpretation_Tm_refine_aff078fed7f4c0267d7d97ac63cc368c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_aff078fed7f4c0267d7d97ac63cc368c
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_aff078fed7f4c0267d7d97ac63cc368c))
(Valid (Prims.hasEq (FStar.DM4F.OTP.Heap.id Dummy_value))))
:named haseqTm_refine_aff078fed7f4c0267d7d97ac63cc368c))

; Encoding query formula : forall (i: FStar.DM4F.OTP.Heap.id{FStar.DM4F.OTP.Heap.incrementable i}).
;   (*  - Could not prove post-condition
; *) i + 1 >= 0 /\ i + 1 < FStar.DM4F.OTP.Heap.size
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Heap.fst(33,46-33,53)
(and 
;; def=Prims.fst(680,18-680,24); use=FStar.DM4F.OTP.Heap.fst(33,46-33,53)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.incr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.OTP.Heap.id, equation_FStar.DM4F.OTP.Heap.incrementable, equation_Prims.nat, primitive_Prims.op_Addition, primitive_Prims.op_LessThan, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_ab1935d06c5b83d762f98a79720546e5, refinement_interpretation_Tm_refine_aff078fed7f4c0267d7d97ac63cc368c
...
(declare-fun Tm_refine_aff078fed7f4c0267d7d97ac63cc368c () Term)
(declare-fun FStar.DM4F.OTP.Heap.incr (Term) Term)

;;;;;;;;;;;;;;;;i: id{incrementable i} -> id
(declare-fun Tm_arrow_33b1c983ed25d5039179a1eee6ba111e () Term)
(declare-fun FStar.DM4F.OTP.Heap.incr@tok () Term)


; </end encoding let incr>


; encoding sigelt val FStar.DM4F.OTP.Heap.index


; <Skipped val FStar.DM4F.OTP.Heap.index/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.tape; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(27,5-27,9); use=FStar.DM4F.OTP.Heap.fst(27,5-27,9)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.DM4F.OTP.Heap.tape @u0)
Prims.eqtype)
 

:pattern ((FStar.DM4F.OTP.Heap.tape @u0))
:qid typing_FStar.DM4F.OTP.Heap.tape))

:named typing_FStar.DM4F.OTP.Heap.tape))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.incr; Namespace FStar.DM4F.OTP.Heap
(assert (! (HasType Tm_refine_aff078fed7f4c0267d7d97ac63cc368c
Tm_type)
:named refinement_kinding_Tm_refine_aff078fed7f4c0267d7d97ac63cc368c))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.tape; Namespace FStar.DM4F.OTP.Heap
(assert (! (HasType Tm_refine_a839637410d9c2e1da47cdb933b51925
Tm_type)
:named refinement_kinding_Tm_refine_a839637410d9c2e1da47cdb933b51925))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.incr; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(37,9-37,32); use=FStar.DM4F.OTP.Heap.fst(33,4-33,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_aff078fed7f4c0267d7d97ac63cc368c)
...
;; def=FStar.DM4F.OTP.Heap.fsti(37,15-37,30); use=FStar.DM4F.OTP.Heap.fst(33,4-33,8)
(BoxBool_proj_0 (FStar.DM4F.OTP.Heap.incrementable @x1))
))
...
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.tape; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(27,21-27,49); use=FStar.DM4F.OTP.Heap.fst(27,21-27,49)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_a839637410d9c2e1da47cdb933b51925)
(and (HasTypeFuel @u0
@x1
(FStar.Seq.Base.seq FStar.DM4F.OTP.Heap.elem))

;; def=FStar.DM4F.OTP.Heap.fst(27,32-27,48); use=FStar.DM4F.OTP.Heap.fst(27,32-27,48)
(= (FStar.Seq.Base.length FStar.DM4F.OTP.Heap.elem
@x1)
(FStar.DM4F.OTP.Heap.size Dummy_value))
))
...
@x1
Tm_refine_a839637410d9c2e1da47cdb933b51925))
:qid refinement_interpretation_Tm_refine_a839637410d9c2e1da47cdb933b51925))

:named refinement_interpretation_Tm_refine_a839637410d9c2e1da47cdb933b51925))
;;;;;;;;;;;;;;;;haseq for Tm_refine_aff078fed7f4c0267d7d97ac63cc368c
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.incr; Namespace FStar.DM4F.OTP.Heap
(assert (! (iff (Valid (Prims.hasEq Tm_refine_aff078fed7f4c0267d7d97ac63cc368c))
(Valid (Prims.hasEq (FStar.DM4F.OTP.Heap.id Dummy_value))))
:named haseqTm_refine_aff078fed7f4c0267d7d97ac63cc368c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a839637410d9c2e1da47cdb933b51925
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.tape; Namespace FStar.DM4F.OTP.Heap
(assert (! (iff (Valid (Prims.hasEq Tm_refine_a839637410d9c2e1da47cdb933b51925))
(Valid (Prims.hasEq (FStar.Seq.Base.seq FStar.DM4F.OTP.Heap.elem))))
:named haseqTm_refine_a839637410d9c2e1da47cdb933b51925))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.tape
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.tape; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(27,5-27,9); use=FStar.DM4F.OTP.Heap.fst(27,5-27,9)
(forall ((@u0 Dummy_sort))
...
:qid equation_FStar.DM4F.OTP.Heap.tape))

:named equation_FStar.DM4F.OTP.Heap.tape))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Heap.fst(35,39-35,48)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (h: FStar.DM4F.OTP.Heap.tape) (i: FStar.DM4F.OTP.Heap.id).
;   (*  - Could not prove post-condition
; *)
;   i < FStar.DM4F.OTP.Heap.size ==> i < FStar.Seq.Base.length h
...
(assert (! (not (forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(HasType @x1
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fst(25,25-25,33); use=FStar.DM4F.OTP.Heap.fst(35,47-35,48)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.OTP.Heap.fst(35,47-35,48)
(or label_1

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.OTP.Heap.fst(35,47-35,48)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.Seq.Base.length FStar.DM4F.OTP.Heap.elem
@x0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.index, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.OTP.Heap.tape, refinement_interpretation_Tm_refine_a839637410d9c2e1da47cdb933b51925
...
(declare-fun FStar.DM4F.OTP.Heap.index (Term Term) Term)
;;;;;;;;;;;;;;;;h: tape -> i: id -> elem
(declare-fun Tm_arrow_db2e6477811c336ec3dc0a324a214131 () Term)
(declare-fun FStar.DM4F.OTP.Heap.index@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Heap.sel (Term Term) Term)

(declare-fun FStar.DM4F.OTP.Heap.sel@tok () Term)

; </end encoding let sel>


; encoding sigelt val FStar.DM4F.OTP.Heap.upd


; <Skipped val FStar.DM4F.OTP.Heap.upd/>
...
; Starting query at FStar.DM4F.OTP.Heap.fst(37,46-37,55)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (h: FStar.DM4F.OTP.Heap.tape) (i: FStar.DM4F.OTP.Heap.id) (x: FStar.DM4F.OTP.Heap.elem).
;   (*  - Could not prove post-condition
; *)
;   (i < FStar.DM4F.OTP.Heap.size ==> i < FStar.Seq.Base.length h) /\
;   (forall (any_result: FStar.DM4F.OTP.Heap.id).
;       i == any_result ==>
;       (forall (any_result: FStar.Seq.Base.seq FStar.DM4F.OTP.Heap.elem).
;           FStar.Seq.Base.upd h i x == any_result ==>
;           FStar.Seq.Base.length (FStar.Seq.Base.upd h i x) == FStar.DM4F.OTP.Heap.size))
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Heap.fst(37,46-37,55)
(and (implies 
;; def=FStar.DM4F.OTP.Heap.fst(25,25-25,33); use=FStar.DM4F.OTP.Heap.fst(37,52-37,53)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))


;; def=FStar.Seq.Base.fsti(56,37-56,49); use=FStar.DM4F.OTP.Heap.fst(37,52-37,53)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Heap.fst(37,46-37,55)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.Seq.Base.fsti(56,31-56,32); use=FStar.DM4F.OTP.Heap.fst(37,46-37,55)
(= @x1
@x3)
)
...
;; def=FStar.DM4F.OTP.Heap.fst(37,39-37,55); use=FStar.DM4F.OTP.Heap.fst(37,46-37,55)
(= (FStar.Seq.Base.upd FStar.DM4F.OTP.Heap.elem
@x0
@x1
@x2)
@x4)
...
;; def=FStar.DM4F.OTP.Heap.fst(27,32-27,48); use=FStar.DM4F.OTP.Heap.fst(37,46-37,55)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.upd, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.OTP.Heap.elem, equation_FStar.DM4F.OTP.Heap.id, equation_FStar.DM4F.OTP.Heap.tape, lemma_FStar.Seq.Base.lemma_len_upd, refinement_interpretation_Tm_refine_2ca062977a42c36634b89c1c4f193f79, refinement_interpretation_Tm_refine_a839637410d9c2e1da47cdb933b51925, refinement_interpretation_Tm_refine_ab1935d06c5b83d762f98a79720546e5, typing_FStar.DM4F.OTP.Heap.elem
...
(declare-fun FStar.DM4F.OTP.Heap.upd (Term Term Term) Term)
;;;;;;;;;;;;;;;;h: tape -> i: id -> x: elem -> tape
(declare-fun Tm_arrow_44338d2cbe2fc163d93ae0b768905938 () Term)
(declare-fun FStar.DM4F.OTP.Heap.upd@tok () Term)

; </end encoding let upd>


; encoding sigelt val FStar.DM4F.OTP.Heap.create


; <Skipped val FStar.DM4F.OTP.Heap.create/>
...
; Starting query at FStar.DM4F.OTP.Heap.fst(39,33-39,52)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: FStar.DM4F.OTP.Heap.elem).
;   (*  - Could not prove post-condition
; *)
;   FStar.DM4F.OTP.Heap.size >= 0 /\
;   (forall (any_result: Prims.int).
;       FStar.DM4F.OTP.Heap.size == any_result ==>
;       (forall (any_result: FStar.Seq.Base.seq FStar.DM4F.OTP.Heap.elem).
;           FStar.Seq.Base.create FStar.DM4F.OTP.Heap.size x == any_result ==>
;           FStar.Seq.Base.length (FStar.Seq.Base.create FStar.DM4F.OTP.Heap.size x) ==
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Heap.fst(39,33-39,52)
(and 
;; def=Prims.fst(680,18-680,24); use=FStar.DM4F.OTP.Heap.fst(39,46-39,50)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Heap.fst(39,33-39,52)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Heap.fst(39,33-39,52)
(= (FStar.DM4F.OTP.Heap.size Dummy_value)
@x1)
)
...
;; def=FStar.DM4F.OTP.Heap.fst(39,26-39,52); use=FStar.DM4F.OTP.Heap.fst(39,33-39,52)
(= (FStar.Seq.Base.create FStar.DM4F.OTP.Heap.elem
(FStar.DM4F.OTP.Heap.size Dummy_value)
@x0)
@x2)
)

;; def=FStar.DM4F.OTP.Heap.fst(27,32-27,48); use=FStar.DM4F.OTP.Heap.fst(39,33-39,52)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.create, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.OTP.Heap.elem, equation_FStar.DM4F.OTP.Heap.size, equation_Prims.nat, lemma_FStar.Seq.Base.lemma_create_len, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_FStar.DM4F.OTP.Heap.elem
...
(declare-fun FStar.DM4F.OTP.Heap.create (Term) Term)
;;;;;;;;;;;;;;;;x: elem -> tape
(declare-fun Tm_arrow_2ec5692e7e94e19b83e69a6f69188269 () Term)
(declare-fun FStar.DM4F.OTP.Heap.create@tok () Term)

; </end encoding let create>


; encoding sigelt val FStar.DM4F.OTP.Heap.equal


; <Skipped val FStar.DM4F.OTP.Heap.equal/>
...
(declare-fun FStar.DM4F.OTP.Heap.equal (Term Term) Term)
;;;;;;;;;;;;;;;;t1: tape -> t2: tape -> Prims.GTot Type
(declare-fun Tm_arrow_8cfe39c97a82ac077a32e85c1b9dfc70 () Term)
(declare-fun FStar.DM4F.OTP.Heap.equal@tok () Term)

; </end encoding let equal>


; encoding sigelt val FStar.DM4F.OTP.Heap.lemma_eq_intro


; <Skipped val FStar.DM4F.OTP.Heap.lemma_eq_intro/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.index; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(35,4-35,9); use=FStar.DM4F.OTP.Heap.fst(35,4-35,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(HasType @x1
(FStar.DM4F.OTP.Heap.id Dummy_value)))
(HasType (FStar.DM4F.OTP.Heap.index @x0
@x1)
FStar.DM4F.OTP.Heap.elem))
 

:pattern ((FStar.DM4F.OTP.Heap.index @x0
@x1))
:qid typing_FStar.DM4F.OTP.Heap.index))

:named typing_FStar.DM4F.OTP.Heap.index))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.equal; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(41,4-41,9); use=FStar.DM4F.OTP.Heap.fst(41,4-41,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(HasType @x1
(FStar.DM4F.OTP.Heap.tape Dummy_value)))
(HasType (FStar.DM4F.OTP.Heap.equal @x0
@x1)
Tm_type))
 

:pattern ((FStar.DM4F.OTP.Heap.equal @x0
@x1))
:qid typing_FStar.DM4F.OTP.Heap.equal))

:named typing_FStar.DM4F.OTP.Heap.equal))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.index
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.index; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(35,4-35,9); use=FStar.DM4F.OTP.Heap.fst(35,4-35,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.OTP.Heap.index @x0
@x1)
(FStar.Seq.Base.index FStar.DM4F.OTP.Heap.elem
@x0
@x1))
...
:pattern ((FStar.DM4F.OTP.Heap.index @x0
@x1))
:qid equation_FStar.DM4F.OTP.Heap.index))

:named equation_FStar.DM4F.OTP.Heap.index))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.equal
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.equal; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(41,4-41,9); use=FStar.DM4F.OTP.Heap.fst(41,4-41,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.OTP.Heap.equal @x0
@x1)
(FStar.Seq.Base.equal FStar.DM4F.OTP.Heap.elem
@x0
@x1))
...
:pattern ((FStar.DM4F.OTP.Heap.equal @x0
@x1))
:qid equation_FStar.DM4F.OTP.Heap.equal))

:named equation_FStar.DM4F.OTP.Heap.equal))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at FStar.DM4F.OTP.Heap.fst(44,2-46,32)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: id -> Prims.GTot Type
(declare-fun Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50
Tm_type)
:named kinding_Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(44,20-44,22); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50))
:qid FStar.DM4F.OTP.Heap_pre_typing_Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50))

:named FStar.DM4F.OTP.Heap_pre_typing_Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(44,20-44,22); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Heap_interpretation_Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50))
:qid FStar.DM4F.OTP.Heap_interpretation_Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50))

:named FStar.DM4F.OTP.Heap_interpretation_Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50))

(declare-fun Tm_refine_3f0a1ce233393e5867a6d207ada7e43f (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(178,26-178,48); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_3f0a1ce233393e5867a6d207ada7e43f @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_3f0a1ce233393e5867a6d207ada7e43f @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_3f0a1ce233393e5867a6d207ada7e43f))

:named refinement_kinding_Tm_refine_3f0a1ce233393e5867a6d207ada7e43f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(178,26-178,48); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3f0a1ce233393e5867a6d207ada7e43f @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=FStar.Seq.Base.fsti(178,33-178,46); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.Seq.Base.length FStar.DM4F.OTP.Heap.elem
@x2)))
))
...
@x1
(Tm_refine_3f0a1ce233393e5867a6d207ada7e43f @x2)))
:qid refinement_interpretation_Tm_refine_3f0a1ce233393e5867a6d207ada7e43f))

:named refinement_interpretation_Tm_refine_3f0a1ce233393e5867a6d207ada7e43f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3f0a1ce233393e5867a6d207ada7e43f
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(178,26-178,48); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3f0a1ce233393e5867a6d207ada7e43f @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3f0a1ce233393e5867a6d207ada7e43f @x0))))
:qid haseqTm_refine_3f0a1ce233393e5867a6d207ada7e43f))

:named haseqTm_refine_3f0a1ce233393e5867a6d207ada7e43f))

(declare-fun Tm_abs_49e15e18f930c26f359035e74865c3c6 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_49e15e18f930c26f359035e74865c3c6
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(45,9-45,54); use=FStar.DM4F.OTP.Heap.fst(45,9-45,54)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_49e15e18f930c26f359035e74865c3c6 @x0)
Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50)
 

:pattern ((Tm_abs_49e15e18f930c26f359035e74865c3c6 @x0))
:qid typing_Tm_abs_49e15e18f930c26f359035e74865c3c6))

:named typing_Tm_abs_49e15e18f930c26f359035e74865c3c6))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_49e15e18f930c26f359035e74865c3c6
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(45,9-45,54); use=FStar.DM4F.OTP.Heap.fst(45,9-45,54)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_49e15e18f930c26f359035e74865c3c6 @x1)
@x0)
(Prims.eq2 FStar.DM4F.OTP.Heap.elem
(FStar.DM4F.OTP.Heap.index @x1
@x0)
(FStar.Seq.Base.index FStar.DM4F.OTP.Heap.elem
@x1
@x0)))
...
:pattern ((ApplyTT (Tm_abs_49e15e18f930c26f359035e74865c3c6 @x1)
@x0))
:qid interpretation_Tm_abs_49e15e18f930c26f359035e74865c3c6))

:named interpretation_Tm_abs_49e15e18f930c26f359035e74865c3c6))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(45,9-45,54); use=FStar.DM4F.OTP.Heap.fst(45,9-45,54)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.l_Forall (FStar.DM4F.OTP.Heap.id Dummy_value)
(Tm_abs_49e15e18f930c26f359035e74865c3c6 @x0)))
...
;; def=FStar.DM4F.OTP.Heap.fst(45,25-45,53); use=FStar.DM4F.OTP.Heap.fst(45,25-45,53)
(= (FStar.DM4F.OTP.Heap.index @x0
@x1)
(FStar.Seq.Base.index FStar.DM4F.OTP.Heap.elem
@x0
...
;;no pats
:qid l_quant_interp_811b587b22e0f97a14a7344e57a22db9.1))
)
 

:pattern ((Valid (Prims.l_Forall (FStar.DM4F.OTP.Heap.id Dummy_value)
(Tm_abs_49e15e18f930c26f359035e74865c3c6 @x0))))
:qid l_quant_interp_811b587b22e0f97a14a7344e57a22db9))

:named l_quant_interp_811b587b22e0f97a14a7344e57a22db9))
...
; Encoding query formula : forall (s1: FStar.DM4F.OTP.Heap.tape) (s2: FStar.DM4F.OTP.Heap.tape).
;   (*  - Could not prove post-condition
; *)
...
;     (forall (pure_result: Prims.unit). FStar.DM4F.OTP.Heap.equal s1 s2 ==> p pure_result) ==>
;     (forall (i: FStar.DM4F.OTP.Heap.id).
;         (*  - Subtyping check failed
;   - Expected type i: Prims.nat{i < FStar.Seq.Base.length s1} got type id
; *)
;         i < FStar.DM4F.OTP.Heap.size ==> i < FStar.Seq.Base.length s1) /\
;     (forall (any_result: (_: FStar.DM4F.OTP.Heap.id -> Prims.GTot Type0)).
;         (fun i -> FStar.DM4F.OTP.Heap.index s1 i == FStar.Seq.Base.index s1 i) == any_result ==>
;         (forall (any_result: Prims.logical).
;             (forall (i: FStar.DM4F.OTP.Heap.id).
;                 FStar.DM4F.OTP.Heap.index s1 i == FStar.Seq.Base.index s1 i) ==
;             any_result ==>
;             (forall (i: FStar.DM4F.OTP.Heap.id).
;                 FStar.DM4F.OTP.Heap.index s1 i == FStar.Seq.Base.index s1 i) /\
...
;                 (forall (i: FStar.DM4F.OTP.Heap.id).
;                     (*  - Subtyping check failed
;   - Expected type i: Prims.nat{i < FStar.Seq.Base.length s2} got type id
; *)
;                     i < FStar.DM4F.OTP.Heap.size ==> i < FStar.Seq.Base.length s2) /\
;                 (forall (any_result: (_: FStar.DM4F.OTP.Heap.id -> Prims.GTot Type0)).
;                     (fun i -> FStar.DM4F.OTP.Heap.index s2 i == FStar.Seq.Base.index s2 i) ==
;                     any_result ==>
;                     (forall (any_result: Prims.logical).
;                         (forall (i: FStar.DM4F.OTP.Heap.id).
;                             FStar.DM4F.OTP.Heap.index s2 i == FStar.Seq.Base.index s2 i) ==
;                         any_result ==>
;                         (forall (i: FStar.DM4F.OTP.Heap.id).
;                             FStar.DM4F.OTP.Heap.index s2 i == FStar.Seq.Base.index s2 i) /\
;                         (forall (pure_result: Prims.unit).
...
;                             (forall (pure_result: Prims.unit).
;                                 FStar.Seq.Base.equal s1 s2 ==> p pure_result)))))))
...
;; def=FStar.DM4F.OTP.Heap.fsti(49,12-49,92); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fsti(49,66-49,90); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(= (FStar.DM4F.OTP.Heap.index @x0
@x3)
(FStar.DM4F.OTP.Heap.index @x1
@x3))
...
:pattern ((FStar.DM4F.OTP.Heap.index @x0
@x3) (FStar.DM4F.OTP.Heap.index @x1
@x3))
:qid @query.2))


;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=FStar.DM4F.OTP.Heap.fsti(50,11-50,24); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fst(25,25-25,33); use=FStar.DM4F.OTP.Heap.fst(44,52-44,53)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.OTP.Heap.fst(44,52-44,53)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_arrow_00c6cd7a10c7595b55246431ab8cbe50)

;; def=Prims.fst(286,26-286,27); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(= (Tm_abs_49e15e18f930c26f359035e74865c3c6 @x0)
@x3)
)
...
;; def=Prims.fst(672,13-672,14); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(= (Prims.l_Forall (FStar.DM4F.OTP.Heap.id Dummy_value)
(Tm_abs_49e15e18f930c26f359035e74865c3c6 @x0))
@x4)
)

;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.OTP.Heap.fst(44,2-44,8)
(and 
;; def=FStar.DM4F.OTP.Heap.fst(44,9-44,54); use=FStar.DM4F.OTP.Heap.fst(44,2-44,8)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fst(44,25-44,53); use=FStar.DM4F.OTP.Heap.fst(44,2-44,8)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(44,2-44,8)
(forall ((@x5 Term))
...
;; def=FStar.DM4F.OTP.Heap.fst(25,25-25,33); use=FStar.DM4F.OTP.Heap.fst(45,52-45,53)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.OTP.Heap.fst(45,52-45,53)
(or label_5
...
;; def=Prims.fst(286,26-286,27); use=FStar.DM4F.OTP.Heap.fst(44,2-46,32)
(= (Tm_abs_49e15e18f930c26f359035e74865c3c6 @x1)
@x6)
)
...
;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.OTP.Heap.fst(45,2-45,8)
(and 
;; def=FStar.DM4F.OTP.Heap.fst(45,9-45,54); use=FStar.DM4F.OTP.Heap.fst(45,2-45,8)
(forall ((@x8 Term))
 (! (implies (HasType @x8
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fst(45,25-45,53); use=FStar.DM4F.OTP.Heap.fst(45,2-45,8)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(45,2-45,8)
(forall ((@x8 Term))
...
;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(and 
;; def=FStar.Seq.Base.fsti(177,16-177,37); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(or label_7
...
;; def=FStar.Seq.Base.fsti(178,18-178,114); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(forall ((@x9 Term))
 (! (implies (HasType @x9
(Tm_refine_3f0a1ce233393e5867a6d207ada7e43f @x0))

;; def=FStar.Seq.Base.fsti(178,87-178,113); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(or label_8
...
:pattern ((FStar.Seq.Base.index FStar.DM4F.OTP.Heap.elem
@x0
@x9) (FStar.Seq.Base.index FStar.DM4F.OTP.Heap.elem
@x1
@x9))
:qid @query.16))


;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.unit)

;; def=FStar.Seq.Base.fsti(179,14-179,27); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(Valid 
;; def=FStar.Seq.Base.fsti(179,14-179,27); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(FStar.Seq.Base.equal FStar.DM4F.OTP.Heap.elem
@x0
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(46,6-46,20)
(ApplyTT @x2
@x9)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.lemma_eq_intro, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.OTP.Heap.equal, equation_FStar.DM4F.OTP.Heap.id, equation_FStar.DM4F.OTP.Heap.index, equation_FStar.DM4F.OTP.Heap.tape, equation_Prims.nat, int_inversion, refinement_interpretation_Tm_refine_3f0a1ce233393e5867a6d207ada7e43f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_a839637410d9c2e1da47cdb933b51925, refinement_interpretation_Tm_refine_ab1935d06c5b83d762f98a79720546e5
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.OTP.Heap.lemma_eq_intro (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.OTP.Heap.lemma_eq_intro@tok () Term)

; </end encoding let lemma_eq_intro>


; encoding sigelt val FStar.DM4F.OTP.Heap.lemma_eq_elim


; <Skipped val FStar.DM4F.OTP.Heap.lemma_eq_elim/>

;;;;;;;;;;;;;;;;Lemma: FStar.DM4F.OTP.Heap.lemma_eq_intro
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.lemma_eq_intro; Namespace FStar.DM4F.OTP.Heap
...
;; def=FStar.DM4F.OTP.Heap.fsti(49,12-49,92); use=FStar.DM4F.OTP.Heap.fst(43,4-43,18)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fsti(49,66-49,90); use=FStar.DM4F.OTP.Heap.fst(43,4-43,18)
(= (FStar.DM4F.OTP.Heap.index @x0
@x2)
(FStar.DM4F.OTP.Heap.index @x1
@x2))
...
:pattern ((FStar.DM4F.OTP.Heap.index @x0
@x2) (FStar.DM4F.OTP.Heap.index @x1
@x2))
:qid lemma_FStar.DM4F.OTP.Heap.lemma_eq_intro.1))
)

;; def=FStar.DM4F.OTP.Heap.fsti(50,11-50,24); use=FStar.DM4F.OTP.Heap.fst(43,4-43,18)
(Valid 
;; def=FStar.DM4F.OTP.Heap.fsti(50,11-50,24); use=FStar.DM4F.OTP.Heap.fst(43,4-43,18)
(FStar.DM4F.OTP.Heap.equal @x0
@x1)
...
:pattern ((FStar.DM4F.OTP.Heap.equal @x0
@x1))
:qid lemma_FStar.DM4F.OTP.Heap.lemma_eq_intro))
:named lemma_FStar.DM4F.OTP.Heap.lemma_eq_intro))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Heap.fst(48,26-48,28)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     FStar.DM4F.OTP.Heap.equal s1 s2 /\
;     (forall (pure_result: Prims.unit). s1 == s2 ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_eq_elim`
...
;; def=FStar.DM4F.OTP.Heap.fsti(54,12-54,25); use=FStar.DM4F.OTP.Heap.fst(48,26-48,28)
(Valid 
;; def=FStar.DM4F.OTP.Heap.fsti(54,12-54,25); use=FStar.DM4F.OTP.Heap.fst(48,26-48,28)
(FStar.DM4F.OTP.Heap.equal @x0
@x1)
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(48,26-48,28)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=FStar.DM4F.OTP.Heap.fsti(55,11-55,19); use=FStar.DM4F.OTP.Heap.fst(48,26-48,28)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(48,26-48,28)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(48,26-48,28)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.lemma_eq_elim, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.OTP.Heap.elem, equation_FStar.DM4F.OTP.Heap.equal, equation_FStar.DM4F.OTP.Heap.tape, lemma_FStar.Seq.Base.lemma_eq_elim, refinement_interpretation_Tm_refine_a839637410d9c2e1da47cdb933b51925, typing_FStar.DM4F.OTP.Heap.elem
...
; encoding sigelt let lemma_eq_elim


; <Start encoding let lemma_eq_elim>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.OTP.Heap.lemma_eq_elim (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.OTP.Heap.lemma_eq_elim@tok () Term)

; </end encoding let lemma_eq_elim>


; encoding sigelt val FStar.DM4F.OTP.Heap.lemma_index_upd1


; <Skipped val FStar.DM4F.OTP.Heap.lemma_index_upd1/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.upd; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(37,4-37,7); use=FStar.DM4F.OTP.Heap.fst(37,4-37,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(HasType @x1
...
(HasType @x2
FStar.DM4F.OTP.Heap.elem))
(HasType (FStar.DM4F.OTP.Heap.upd @x0
@x1
@x2)
(FStar.DM4F.OTP.Heap.tape Dummy_value)))
 

:pattern ((FStar.DM4F.OTP.Heap.upd @x0
@x1
@x2))
:qid typing_FStar.DM4F.OTP.Heap.upd))

:named typing_FStar.DM4F.OTP.Heap.upd))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.upd
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.upd; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(37,4-37,7); use=FStar.DM4F.OTP.Heap.fst(37,4-37,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.OTP.Heap.upd @x0
@x1
@x2)
(FStar.Seq.Base.upd FStar.DM4F.OTP.Heap.elem
@x0
...
@x1
@x2))
:qid equation_FStar.DM4F.OTP.Heap.upd))

:named equation_FStar.DM4F.OTP.Heap.upd))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Heap.fst(50,29-50,57)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (s: FStar.DM4F.OTP.Heap.tape) (n: FStar.DM4F.OTP.Heap.id) (v: FStar.DM4F.OTP.Heap.elem).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.DM4F.OTP.Heap.index (FStar.DM4F.OTP.Heap.upd s n v) n == v ==> p pure_result) ==>
;     (n < FStar.DM4F.OTP.Heap.size ==> n < FStar.Seq.Base.length s) /\
;     (forall (any_result: FStar.DM4F.OTP.Heap.id).
;         n == any_result ==>
;         (forall (pure_result: Prims.unit).
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(50,29-50,57)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=FStar.DM4F.OTP.Heap.fsti(60,11-60,37); use=FStar.DM4F.OTP.Heap.fst(50,29-50,57)
(or label_2

;; def=FStar.DM4F.OTP.Heap.fsti(60,11-60,37); use=FStar.DM4F.OTP.Heap.fst(50,29-50,57)
(= (FStar.DM4F.OTP.Heap.index (FStar.DM4F.OTP.Heap.upd @x0
@x1
@x2)
@x1)
@x2)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(50,29-50,57)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(50,29-50,57)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Heap.fst(50,29-50,57)
(and (implies 
;; def=FStar.DM4F.OTP.Heap.fst(25,25-25,33); use=FStar.DM4F.OTP.Heap.fst(50,54-50,55)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))


;; def=FStar.Seq.Base.fsti(138,50-138,62); use=FStar.DM4F.OTP.Heap.fst(50,54-50,55)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Heap.fst(50,29-50,57)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.Seq.Base.fsti(138,44-138,45); use=FStar.DM4F.OTP.Heap.fst(50,29-50,57)
(= @x1
@x4)
)

;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(50,29-50,45)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=FStar.Seq.Base.fsti(140,11-140,37); use=FStar.DM4F.OTP.Heap.fst(50,29-50,45)
(= (FStar.Seq.Base.index FStar.DM4F.OTP.Heap.elem
(FStar.Seq.Base.upd FStar.DM4F.OTP.Heap.elem
@x0
@x1
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(50,29-50,45)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(50,29-50,45)
(ApplyTT @x3
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.lemma_index_upd1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.OTP.Heap.id, equation_FStar.DM4F.OTP.Heap.index, equation_FStar.DM4F.OTP.Heap.tape, equation_FStar.DM4F.OTP.Heap.upd, refinement_interpretation_Tm_refine_a839637410d9c2e1da47cdb933b51925, refinement_interpretation_Tm_refine_ab1935d06c5b83d762f98a79720546e5
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.OTP.Heap.lemma_index_upd1 (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.OTP.Heap.lemma_index_upd1@tok () Term)

; </end encoding let lemma_index_upd1>


; encoding sigelt val FStar.DM4F.OTP.Heap.lemma_index_upd2


; <Skipped val FStar.DM4F.OTP.Heap.lemma_index_upd2/>

;;;;;;;;;;;;;;;;Lemma: FStar.DM4F.OTP.Heap.lemma_index_upd1
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.lemma_index_upd1; Namespace FStar.DM4F.OTP.Heap
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(HasType @x1
...
;; def=FStar.DM4F.OTP.Heap.fsti(60,11-60,37); use=FStar.DM4F.OTP.Heap.fst(50,4-50,20)
(= (FStar.DM4F.OTP.Heap.index (FStar.DM4F.OTP.Heap.upd @x0
@x1
@x2)
@x1)
...
:pattern ((FStar.DM4F.OTP.Heap.index (FStar.DM4F.OTP.Heap.upd @x0
@x1
@x2)
@x1))
:qid lemma_FStar.DM4F.OTP.Heap.lemma_index_upd1))
:named lemma_FStar.DM4F.OTP.Heap.lemma_index_upd1))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Heap.fst(52,31-52,61)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(63,50-63,60); use=FStar.DM4F.OTP.Heap.fst(52,4-52,20)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621))

:named refinement_kinding_Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(63,50-63,60); use=FStar.DM4F.OTP.Heap.fst(52,4-52,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fsti(63,55-63,59); use=FStar.DM4F.OTP.Heap.fst(52,4-52,20)
(not (= @x1
@x2))
))
...
@x1
(Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621 @x2)))
:qid refinement_interpretation_Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621))

:named refinement_interpretation_Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(63,50-63,60); use=FStar.DM4F.OTP.Heap.fst(52,4-52,20)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621 @x0)))
(Valid (Prims.hasEq (FStar.DM4F.OTP.Heap.id Dummy_value))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621 @x0))))
:qid haseqTm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621))

:named haseqTm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621))


; Encoding query formula : forall (s: FStar.DM4F.OTP.Heap.tape)
...
;     (forall (any_result: FStar.DM4F.OTP.Heap.id).
;         n == any_result ==>
;         (i < FStar.DM4F.OTP.Heap.size /\ i <> n ==> i <> n /\ i < FStar.Seq.Base.length s) /\
;         (forall (any_result: i: FStar.DM4F.OTP.Heap.id{i <> n}).
;             i == any_result ==>
;             (forall (pure_result: Prims.unit).
...
FStar.DM4F.OTP.Heap.elem)
(HasType @x3
(Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621 @x1)))
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(52,31-52,61)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=FStar.DM4F.OTP.Heap.fsti(65,11-65,45); use=FStar.DM4F.OTP.Heap.fst(52,31-52,61)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(52,31-52,61)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(52,31-52,61)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Heap.fst(52,31-52,61)
(and (implies 
;; def=FStar.DM4F.OTP.Heap.fst(25,25-25,33); use=FStar.DM4F.OTP.Heap.fst(52,56-52,57)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))


;; def=FStar.Seq.Base.fsti(143,50-143,62); use=FStar.DM4F.OTP.Heap.fst(52,56-52,57)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Heap.fst(52,31-52,61)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.Seq.Base.fsti(143,44-143,45); use=FStar.DM4F.OTP.Heap.fst(52,31-52,61)
(= @x1
@x5)
)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Heap.fst(52,31-52,61)
(and (implies 
;; def=FStar.DM4F.OTP.Heap.fsti(63,55-63,59); use=FStar.DM4F.OTP.Heap.fst(52,60-52,61)
(and 
;; def=FStar.DM4F.OTP.Heap.fst(25,25-25,33); use=FStar.DM4F.OTP.Heap.fst(52,60-52,61)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
...
;; def=FStar.Seq.Base.fsti(143,80-143,100); use=FStar.DM4F.OTP.Heap.fst(52,60-52,61)
(and 
;; def=FStar.Seq.Base.fsti(143,80-143,84); use=FStar.DM4F.OTP.Heap.fst(52,60-52,61)
(or label_4
...
;; def=FStar.Seq.Base.fsti(143,88-143,100); use=FStar.DM4F.OTP.Heap.fst(52,60-52,61)
(or label_5
...
;; def=FStar.Seq.Base.fsti(143,74-143,75); use=FStar.DM4F.OTP.Heap.fst(52,31-52,61)
(= @x3
@x6)
)

;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(52,31-52,47)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=FStar.Seq.Base.fsti(145,11-145,45); use=FStar.DM4F.OTP.Heap.fst(52,31-52,47)
(= (FStar.Seq.Base.index FStar.DM4F.OTP.Heap.elem
(FStar.Seq.Base.upd FStar.DM4F.OTP.Heap.elem
@x0
@x1
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(52,31-52,47)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(52,31-52,47)
(ApplyTT @x4
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.lemma_index_upd2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.OTP.Heap.id, equation_FStar.DM4F.OTP.Heap.index, equation_FStar.DM4F.OTP.Heap.tape, equation_FStar.DM4F.OTP.Heap.upd, equation_Prims.nat, int_inversion, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621, refinement_interpretation_Tm_refine_a839637410d9c2e1da47cdb933b51925, refinement_interpretation_Tm_refine_ab1935d06c5b83d762f98a79720546e5
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.OTP.Heap.lemma_index_upd2 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.OTP.Heap.lemma_index_upd2@tok () Term)
(declare-fun Tm_refine_a7b6a6d2bd5866f2aebb991bbb9a8621 (Term) Term)

; </end encoding let lemma_index_upd2>


; encoding sigelt val FStar.DM4F.OTP.Heap.lemma_index_create


; <Skipped val FStar.DM4F.OTP.Heap.lemma_index_create/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.create; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(39,4-39,10); use=FStar.DM4F.OTP.Heap.fst(39,4-39,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FStar.DM4F.OTP.Heap.elem)
(HasType (FStar.DM4F.OTP.Heap.create @x0)
(FStar.DM4F.OTP.Heap.tape Dummy_value)))
 

:pattern ((FStar.DM4F.OTP.Heap.create @x0))
:qid typing_FStar.DM4F.OTP.Heap.create))

:named typing_FStar.DM4F.OTP.Heap.create))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.create
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.create; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fst(39,4-39,10); use=FStar.DM4F.OTP.Heap.fst(39,4-39,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.OTP.Heap.create @x0)
(FStar.Seq.Base.create FStar.DM4F.OTP.Heap.elem
(FStar.DM4F.OTP.Heap.size Dummy_value)
@x0))
...
:pattern ((FStar.DM4F.OTP.Heap.create @x0))
:qid equation_FStar.DM4F.OTP.Heap.create))

:named equation_FStar.DM4F.OTP.Heap.create))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Heap.fst(54,29-54,62)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (v: FStar.DM4F.OTP.Heap.elem) (i: FStar.DM4F.OTP.Heap.id).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.DM4F.OTP.Heap.index (FStar.DM4F.OTP.Heap.create v) i == v ==> p pure_result) ==>
;     FStar.DM4F.OTP.Heap.size >= 0 /\
;     (forall (any_result: Prims.int).
;         FStar.DM4F.OTP.Heap.size == any_result ==>
;         (forall (pure_result: Prims.unit).
;             FStar.Seq.Base.index (FStar.Seq.Base.create FStar.DM4F.OTP.Heap.size v) i == v ==>
;             p pure_result))
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(54,29-54,62)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=FStar.DM4F.OTP.Heap.fsti(70,11-70,36); use=FStar.DM4F.OTP.Heap.fst(54,29-54,62)
(or label_2

;; def=FStar.DM4F.OTP.Heap.fsti(70,11-70,36); use=FStar.DM4F.OTP.Heap.fst(54,29-54,62)
(= (FStar.DM4F.OTP.Heap.index (FStar.DM4F.OTP.Heap.create @x0)
@x1)
@x0)
)
)

;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(54,29-54,62)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(54,29-54,62)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Heap.fst(54,29-54,62)
(and 
;; def=Prims.fst(680,18-680,24); use=FStar.DM4F.OTP.Heap.fst(54,54-54,58)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Heap.fst(54,29-54,62)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.int)

;; def=FStar.Seq.Base.fsti(133,35-133,36); use=FStar.DM4F.OTP.Heap.fst(54,29-54,62)
(= (FStar.DM4F.OTP.Heap.size Dummy_value)
@x3)
)

;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Heap.fst(54,29-54,47)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=FStar.Seq.Base.fsti(135,11-135,38); use=FStar.DM4F.OTP.Heap.fst(54,29-54,47)
(= (FStar.Seq.Base.index FStar.DM4F.OTP.Heap.elem
(FStar.Seq.Base.create FStar.DM4F.OTP.Heap.elem
(FStar.DM4F.OTP.Heap.size Dummy_value)
@x0)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(54,29-54,47)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Heap.fst(54,29-54,47)
(ApplyTT @x2
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Heap.lemma_index_create, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.OTP.Heap.create, equation_FStar.DM4F.OTP.Heap.id, equation_FStar.DM4F.OTP.Heap.index, equation_Prims.nat, int_inversion, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_ab1935d06c5b83d762f98a79720546e5
