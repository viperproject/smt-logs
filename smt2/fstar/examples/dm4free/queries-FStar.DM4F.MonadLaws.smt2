...
; Internals for FStar.DM4F.MonadLaws
...
(declare-fun FStar.DM4F.MonadLaws.st (Term Term) Term)

(declare-fun FStar.DM4F.MonadLaws.st@tok () Term)
;;;;;;;;;;;;;;;;_: s -> a & s
...
(declare-fun FStar.DM4F.MonadLaws.return_st (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> st s a
(declare-fun Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8 () Term)
(declare-fun FStar.DM4F.MonadLaws.return_st@tok () Term)
...
;;;;;;;;;;;;;;;;_: a -> st s b
(declare-fun Tm_arrow_981fbcabe796faab6bb5653cc9728141 (Term Term Term) Term)
(declare-fun FStar.DM4F.MonadLaws.bind_st (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;f: st s a -> g: (_: a -> st s b) -> st s b
(declare-fun Tm_arrow_953261e67140a1bf5009fcd0217f1736 () Term)
(declare-fun FStar.DM4F.MonadLaws.bind_st@tok () Term)
...
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(24,61-24,66); use=FStar.DM4F.MonadLaws.fst(24,61-24,66)
...
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(27,13-27,40); use=FStar.DM4F.MonadLaws.fst(27,13-27,40)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.MonadLaws.st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(22,4-22,6); use=FStar.DM4F.MonadLaws.fst(22,4-22,6)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type))
(HasType (FStar.DM4F.MonadLaws.st @x0
@x1)
Tm_type))
 

:pattern ((FStar.DM4F.MonadLaws.st @x0
@x1))
:qid typing_FStar.DM4F.MonadLaws.st))

:named typing_FStar.DM4F.MonadLaws.st))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(24,4-24,13); use=FStar.DM4F.MonadLaws.fst(24,4-24,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
@x1))
(HasType (FStar.DM4F.MonadLaws.return_st @x0
@x1
@x2)
(FStar.DM4F.MonadLaws.st @x0
@x1)))
 

:pattern ((FStar.DM4F.MonadLaws.return_st @x0
@x1
@x2))
:qid typing_FStar.DM4F.MonadLaws.return_st))

:named typing_FStar.DM4F.MonadLaws.return_st))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(26,4-26,11); use=FStar.DM4F.MonadLaws.fst(26,4-26,11)
...
@x1))
(HasType @x4
(Tm_arrow_981fbcabe796faab6bb5653cc9728141 @x2
@x0
@x1)))
(HasType (FStar.DM4F.MonadLaws.bind_st @x0
@x1
@x2
@x3
@x4)
...
:pattern ((FStar.DM4F.MonadLaws.bind_st @x0
@x1
@x2
@x3
@x4))
:qid typing_FStar.DM4F.MonadLaws.bind_st))

:named typing_FStar.DM4F.MonadLaws.bind_st))
...
;; def=FStar.DM4F.MonadLaws.fst(24,4-24,13); use=FStar.DM4F.MonadLaws.fst(24,4-24,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT FStar.DM4F.MonadLaws.return_st@tok
@x0)
@x1)
@x2)
(FStar.DM4F.MonadLaws.return_st @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT FStar.DM4F.MonadLaws.return_st@tok
@x0)
@x1)
@x2))
:qid token_correspondence_FStar.DM4F.MonadLaws.return_st))

:named token_correspondence_FStar.DM4F.MonadLaws.return_st))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
...
;;; Fact-ids: Name FStar.DM4F.MonadLaws.st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(22,8-22,43); use=FStar.DM4F.MonadLaws.fst(22,27-22,43)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_981fbcabe796faab6bb5653cc9728141
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(26,24-26,67); use=FStar.DM4F.MonadLaws.fst(26,56-26,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_981fbcabe796faab6bb5653cc9728141 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_981fbcabe796faab6bb5653cc9728141 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_981fbcabe796faab6bb5653cc9728141))

:named kinding_Tm_arrow_981fbcabe796faab6bb5653cc9728141))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_st; Namespace FStar.DM4F.MonadLaws
(assert (! (HasType Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8
Tm_type)
:named kinding_Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.MonadLaws.return_st@tok
Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8))
...
@x2)
@x3)
(FStar.DM4F.MonadLaws.return_st @x1
@x2
@x3))
 

:pattern ((FStar.DM4F.MonadLaws.return_st @x1
@x2
@x3))
:qid function_token_typing_FStar.DM4F.MonadLaws.return_st.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.MonadLaws.return_st@tok))
:qid function_token_typing_FStar.DM4F.MonadLaws.return_st))

:named function_token_typing_FStar.DM4F.MonadLaws.return_st))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,5-59,11); use=FStar.Pervasives.Native.fst(59,5-59,11)
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.MonadLaws.st
;;; Fact-ids: Name FStar.DM4F.MonadLaws.st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(22,4-22,6); use=FStar.DM4F.MonadLaws.fst(22,4-22,6)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((FStar.DM4F.MonadLaws.st @x0
@x1))
:qid equation_FStar.DM4F.MonadLaws.st))

:named equation_FStar.DM4F.MonadLaws.st))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.MonadLaws.return_st
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(24,4-24,13); use=FStar.DM4F.MonadLaws.fst(24,4-24,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
@x1
@x2))
:qid equation_FStar.DM4F.MonadLaws.return_st))

:named equation_FStar.DM4F.MonadLaws.return_st))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.MonadLaws.bind_st
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(26,4-26,11); use=FStar.DM4F.MonadLaws.fst(26,4-26,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (FStar.DM4F.MonadLaws.bind_st @x0
@x1
@x2
@x3
@x4)
...
@x3
@x4))
:qid equation_FStar.DM4F.MonadLaws.bind_st))

:named equation_FStar.DM4F.MonadLaws.bind_st))
...
(Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe @x2
@x3)))
:qid FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))

:named FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(26,24-26,67); use=FStar.DM4F.MonadLaws.fst(26,56-26,67)
...
@x3
@x4)))
:qid FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_981fbcabe796faab6bb5653cc9728141))

:named FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_981fbcabe796faab6bb5653cc9728141))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(24,18-24,48); use=FStar.DM4F.MonadLaws.fst(24,18-24,48)
...
@x1
Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8))
:qid FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8))

:named FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe.1))
...
(Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe @x1
@x2)))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))

:named FStar.DM4F.MonadLaws_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_981fbcabe796faab6bb5653cc9728141
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(26,24-26,67); use=FStar.DM4F.MonadLaws.fst(26,56-26,67)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_981fbcabe796faab6bb5653cc9728141 @x1
@x2
@x3))
(and 
;; def=FStar.DM4F.MonadLaws.fst(26,24-26,67); use=FStar.DM4F.MonadLaws.fst(26,56-26,67)
...
(HasType (ApplyTT @x0
@x4)
(FStar.DM4F.MonadLaws.st @x2
@x1)))
 

:pattern ((ApplyTT @x0
@x4))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_981fbcabe796faab6bb5653cc9728141.1))
...
@x2
@x3)))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_981fbcabe796faab6bb5653cc9728141))

:named FStar.DM4F.MonadLaws_interpretation_Tm_arrow_981fbcabe796faab6bb5653cc9728141))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_st; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(24,18-24,48); use=FStar.DM4F.MonadLaws.fst(24,18-24,48)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8.2))
...
@x1)
@x2))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8))

:named FStar.DM4F.MonadLaws_interpretation_Tm_arrow_5d04d39bf82f6a8aabbc7eac0fe407f8))
(push) ;; push{2

; Starting query at FStar.DM4F.MonadLaws.fst(30,2-30,40)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(22,36-22,43); use=FStar.DM4F.MonadLaws.fst(30,2-30,40)
(forall ((@x0 Term) (@x1 Term))
...
FStar.DM4F.MonadLaws.return_st@tok))
:named @kick_partial_app_f911d4474c7ad1be5079f6a9c2c89c35))

; Encoding query formula : forall (s: Type) (a: Type) (f: FStar.DM4F.MonadLaws.st s a).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash (FStar.FunctionalExtensionality.feq (FStar.DM4F.MonadLaws.bind_st f
;             FStar.DM4F.MonadLaws.return_st)
;         f)


; Context: While encoding a query
; While typechecking the top-level declaration `let right_unit_st`
...
;; def=FStar.DM4F.MonadLaws.fst(30,9-30,40); use=FStar.DM4F.MonadLaws.fst(30,9-30,40)
(or label_1
...
@x1
@x2
(ApplyTT (ApplyTT FStar.DM4F.MonadLaws.return_st@tok
@x0)
@x1))
@x2)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.MonadLaws.right_unit_st, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.MonadLaws_interpretation_Tm_arrow_a0084ca3a951f68c3110bd0ebd7c60fe, equation_FStar.DM4F.MonadLaws.bind_st, equation_FStar.DM4F.MonadLaws.return_st, equation_FStar.DM4F.MonadLaws.st, equation_FStar.FunctionalExtensionality.feq, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, interpretation_Tm_abs_7706f980135a89a687c904d968136d5b, interpretation_Tm_abs_a02c4ab615d86c1fd4d6707b08902221, token_correspondence_FStar.DM4F.MonadLaws.return_st
...
; encoding sigelt let right_unit_st


; <Start encoding let right_unit_st>

(declare-fun FStar.DM4F.MonadLaws.right_unit_st (Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> a: Type -> f: st s a -> Prims.unit
(declare-fun Tm_arrow_43fad9b5b567d41f5f49e5aa47e2e5c2 () Term)
(declare-fun FStar.DM4F.MonadLaws.right_unit_st@tok () Term)

; </end encoding let right_unit_st>

(push) ;; push{2

; Starting query at FStar.DM4F.MonadLaws.fst(33,2-33,46)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(22,36-22,43); use=FStar.DM4F.MonadLaws.fst(33,2-33,46)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x0
@x1)
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x1))
...
; Encoding query formula : forall (s: Type) (a: Type) (b: Type) (x: a) (f: (_: a -> FStar.DM4F.MonadLaws.st s b)).
;   (*  - Could not prove post-condition
; *)
;   Prims.auto_squash (FStar.FunctionalExtensionality.feq (FStar.DM4F.MonadLaws.bind_st (FStar.DM4F.MonadLaws.return_st
;                 x)
;             f)
;         (f x))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let left_unit_st`
...
;; def=FStar.DM4F.MonadLaws.fst(33,9-33,46); use=FStar.DM4F.MonadLaws.fst(33,9-33,46)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.MonadLaws.left_unit_st, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.DM4F.MonadLaws.bind_st, equation_FStar.DM4F.MonadLaws.return_st, equation_FStar.FunctionalExtensionality.feq, interpretation_Tm_abs_7706f980135a89a687c904d968136d5b, interpretation_Tm_abs_a02c4ab615d86c1fd4d6707b08902221, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
; encoding sigelt let left_unit_st


; <Start encoding let left_unit_st>


(declare-fun FStar.DM4F.MonadLaws.left_unit_st (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;s: Type -> a: Type -> b: Type -> x: a -> f: (_: a -> st s b) -> Prims.unit
(declare-fun Tm_arrow_360ad7f89e0b4f0db69546c1a03935b8 () Term)
(declare-fun FStar.DM4F.MonadLaws.left_unit_st@tok () Term)


; </end encoding let left_unit_st>

(push) ;; push{2

; Starting query at FStar.DM4F.MonadLaws.fst(37,5-38,43)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(22,36-22,43); use=FStar.DM4F.MonadLaws.fst(37,5-38,43)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x0
@x1)
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x1))
...
(declare-fun Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60 (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(37,38-37,53); use=FStar.DM4F.MonadLaws.fst(37,38-37,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (HasType (Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60 @x0
@x1
@x2
@x3
@x4
@x5)
(Tm_arrow_981fbcabe796faab6bb5653cc9728141 @x3
@x4
@x5))
 

:pattern ((Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60 @x0
@x1
@x2
@x3
@x4
@x5))
:qid typing_Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60))

:named typing_Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(37,38-37,53); use=FStar.DM4F.MonadLaws.fst(37,38-37,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (= (ApplyTT (Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60 @x1
@x2
@x3
@x4
@x5
@x6)
@x0)
(FStar.DM4F.MonadLaws.bind_st @x5
@x1
@x4
(ApplyTT @x2
@x0)
...
:pattern ((ApplyTT (Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60 @x1
@x2
@x3
@x4
@x5
@x6)
@x0))
:qid interpretation_Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60))

:named interpretation_Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60))
...
; *)
;   Prims.auto_squash (FStar.FunctionalExtensionality.feq (FStar.DM4F.MonadLaws.bind_st f
;             (fun x -> FStar.DM4F.MonadLaws.bind_st (g x) h))
;         (FStar.DM4F.MonadLaws.bind_st (FStar.DM4F.MonadLaws.bind_st f g) h))


; Context: While encoding a query
; While typechecking the top-level declaration `let assoc_st`
...
;; def=FStar.DM4F.MonadLaws.fst(37,12-38,43); use=FStar.DM4F.MonadLaws.fst(37,12-38,43)
(or label_1
...
;; def=FStar.DM4F.MonadLaws.fst(37,12-38,43); use=FStar.DM4F.MonadLaws.fst(37,12-38,43)
(FStar.FunctionalExtensionality.feq @x0
(Tm_abs_59b2fd075c540cd5f8e34bf1901fa92a @x3
@x0)
(FStar.DM4F.MonadLaws.bind_st @x0
@x1
@x3
@x4
(Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60 @x2
@x5
@x6
@x3
@x0
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.MonadLaws.assoc_st, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.DM4F.MonadLaws.bind_st, equation_FStar.FunctionalExtensionality.feq, interpretation_Tm_abs_684e5ffc9fdc1cae7fa344c11aac6e60, interpretation_Tm_abs_7706f980135a89a687c904d968136d5b
...
; encoding sigelt let assoc_st


; <Start encoding let assoc_st>



(declare-fun FStar.DM4F.MonadLaws.assoc_st (Term Term Term Term Term Term Term) Term)


;;;;;;;;;;;;;;;;s: Type -> a: Type -> b: Type -> c: Type -> f: st s a -> g: (_: a -> st s b) -> h: (_: b -> st s c)   -> Prims.unit
(declare-fun Tm_arrow_e29c66723eedca700e2b8ed3163cfae2 () Term)
(declare-fun FStar.DM4F.MonadLaws.assoc_st@tok () Term)



; </end encoding let assoc_st>


; encoding sigelt type FStar.DM4F.MonadLaws.label


; <Start encoding type FStar.DM4F.MonadLaws.label>

;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.MonadLaws.label () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.MonadLaws.Low () Term)
;;;;;;;;;;;;;;;;data constructor proxy: FStar.DM4F.MonadLaws.Low
(declare-fun FStar.DM4F.MonadLaws.Low@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.MonadLaws.High () Term)
;;;;;;;;;;;;;;;;data constructor proxy: FStar.DM4F.MonadLaws.High
(declare-fun FStar.DM4F.MonadLaws.High@tok () Term)

; <start constructor FStar.DM4F.MonadLaws.label>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.MonadLaws.label ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
178)
(= __@x0
FStar.DM4F.MonadLaws.label)))

; </end constructor FStar.DM4F.MonadLaws.label>


; <start constructor FStar.DM4F.MonadLaws.Low>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.MonadLaws.Low ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
184)
(= __@x0
FStar.DM4F.MonadLaws.Low)))

; </end constructor FStar.DM4F.MonadLaws.Low>


; <start constructor FStar.DM4F.MonadLaws.High>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.MonadLaws.High ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
186)
(= __@x0
FStar.DM4F.MonadLaws.High)))

; </end constructor FStar.DM4F.MonadLaws.High>


; </end encoding type FStar.DM4F.MonadLaws.label>


; encoding sigelt assume FStar.DM4F.MonadLaws.label__uu___haseq


; <Start encoding assume FStar.DM4F.MonadLaws.label__uu___haseq>


; </end encoding assume FStar.DM4F.MonadLaws.label__uu___haseq>


; encoding sigelt val FStar.DM4F.MonadLaws.uu___is_Low


; <Start encoding val FStar.DM4F.MonadLaws.uu___is_Low>

(declare-fun FStar.DM4F.MonadLaws.uu___is_Low (Term) Term)
;;;;;;;;;;;;;;;;projectee: label -> Prims.bool
(declare-fun Tm_arrow_635e0007f3d521bb8ecbbba91e76fccd () Term)
(declare-fun FStar.DM4F.MonadLaws.uu___is_Low@tok () Term)

; </end encoding val FStar.DM4F.MonadLaws.uu___is_Low>


; encoding sigelt let uu___is_Low


; <Skipped let uu___is_Low/>


; encoding sigelt val FStar.DM4F.MonadLaws.uu___is_High


; <Start encoding val FStar.DM4F.MonadLaws.uu___is_High>

(declare-fun FStar.DM4F.MonadLaws.uu___is_High (Term) Term)

(declare-fun FStar.DM4F.MonadLaws.uu___is_High@tok () Term)

; </end encoding val FStar.DM4F.MonadLaws.uu___is_High>


; encoding sigelt let uu___is_High


; <Skipped let uu___is_High/>
...
(declare-fun FStar.DM4F.MonadLaws.ifc (Term) Term)

(declare-fun FStar.DM4F.MonadLaws.ifc@tok () Term)
;;;;;;;;;;;;;;;;_: label -> FStar.Pervasives.Native.option (a & label)
(declare-fun Tm_arrow_05275a1cf51d299be9159781d6b8228d (Term) Term)

; </end encoding let ifc>


; encoding sigelt let return_ifc


; <Start encoding let return_ifc>

(declare-fun FStar.DM4F.MonadLaws.return_ifc (Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> ifc a
(declare-fun Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1 () Term)
(declare-fun FStar.DM4F.MonadLaws.return_ifc@tok () Term)

(declare-fun Tm_abs_6d60449855e44f314114039708e0f80a (Term Term) Term)

; </end encoding let return_ifc>
...
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! (HasType FStar.DM4F.MonadLaws.Low@tok
FStar.DM4F.MonadLaws.label)
:named typing_tok_FStar.DM4F.MonadLaws.Low@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! (HasType FStar.DM4F.MonadLaws.High@tok
FStar.DM4F.MonadLaws.label)
:named typing_tok_FStar.DM4F.MonadLaws.High@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.MonadLaws.ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,4-46,7); use=FStar.DM4F.MonadLaws.fst(46,4-46,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.MonadLaws.ifc @x0)
Tm_type))
 

:pattern ((FStar.DM4F.MonadLaws.ifc @x0))
:qid typing_FStar.DM4F.MonadLaws.ifc))

:named typing_FStar.DM4F.MonadLaws.ifc))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_05275a1cf51d299be9159781d6b8228d
;;; Fact-ids: Name FStar.DM4F.MonadLaws.ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,19-46,52); use=FStar.DM4F.MonadLaws.fst(46,19-46,52)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_05275a1cf51d299be9159781d6b8228d @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_05275a1cf51d299be9159781d6b8228d @x0)
Tm_type))
:qid kinding_Tm_arrow_05275a1cf51d299be9159781d6b8228d))

:named kinding_Tm_arrow_05275a1cf51d299be9159781d6b8228d))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! (HasType FStar.DM4F.MonadLaws.label
Tm_type)
:named kinding_FStar.DM4F.MonadLaws.label@tok))
...
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(42,5-42,10); use=FStar.DM4F.MonadLaws.fst(42,5-42,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
FStar.DM4F.MonadLaws.label)
(or (is-FStar.DM4F.MonadLaws.Low @x1)
(is-FStar.DM4F.MonadLaws.High @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
FStar.DM4F.MonadLaws.label))
:qid fuel_guarded_inversion_FStar.DM4F.MonadLaws.label))

:named fuel_guarded_inversion_FStar.DM4F.MonadLaws.label))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name FStar.Pervasives.Native.option; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.None; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Some; Namespace FStar.Pervasives.Native
(assert (! (= 102
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.MonadLaws.ifc
;;; Fact-ids: Name FStar.DM4F.MonadLaws.ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,4-46,7); use=FStar.DM4F.MonadLaws.fst(46,4-46,7)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.MonadLaws.ifc @x0)
(Tm_arrow_05275a1cf51d299be9159781d6b8228d @x0))
 

:pattern ((FStar.DM4F.MonadLaws.ifc @x0))
:qid equation_FStar.DM4F.MonadLaws.ifc))

:named equation_FStar.DM4F.MonadLaws.ifc))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! (= FStar.DM4F.MonadLaws.Low@tok
FStar.DM4F.MonadLaws.Low)
:named equality_tok_FStar.DM4F.MonadLaws.Low@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! (= FStar.DM4F.MonadLaws.High@tok
FStar.DM4F.MonadLaws.High)
:named equality_tok_FStar.DM4F.MonadLaws.High@tok))
...
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(43,4-43,7); use=FStar.DM4F.MonadLaws.fst(43,4-43,7)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
FStar.DM4F.MonadLaws.Low
FStar.DM4F.MonadLaws.label)
...
FStar.DM4F.MonadLaws.Low
FStar.DM4F.MonadLaws.label))
:qid data_typing_intro_FStar.DM4F.MonadLaws.Low@tok))

:named data_typing_intro_FStar.DM4F.MonadLaws.Low@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(44,4-44,8); use=FStar.DM4F.MonadLaws.fst(44,4-44,8)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
FStar.DM4F.MonadLaws.High
FStar.DM4F.MonadLaws.label)
...
FStar.DM4F.MonadLaws.High
FStar.DM4F.MonadLaws.label))
:qid data_typing_intro_FStar.DM4F.MonadLaws.High@tok))

:named data_typing_intro_FStar.DM4F.MonadLaws.High@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name FStar.Pervasives.Native.option; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.None; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Some; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(33,4-33,8); use=FStar.Pervasives.Native.fst(33,4-33,8)
...
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! (= 178
(Term_constr_id FStar.DM4F.MonadLaws.label))
:named constructor_distinct_FStar.DM4F.MonadLaws.label))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! (= 184
(Term_constr_id FStar.DM4F.MonadLaws.Low))
:named constructor_distinct_FStar.DM4F.MonadLaws.Low))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.Low; Namespace FStar.DM4F.MonadLaws; Name FStar.DM4F.MonadLaws.High; Namespace FStar.DM4F.MonadLaws
(assert (! (= 186
(Term_constr_id FStar.DM4F.MonadLaws.High))
:named constructor_distinct_FStar.DM4F.MonadLaws.High))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
;;;;;;;;;;;;;;;;Assumption: FStar.DM4F.MonadLaws.label__uu___haseq
;;; Fact-ids: Name FStar.DM4F.MonadLaws.label__uu___haseq; Namespace FStar.DM4F.MonadLaws
(assert (! (Valid (Prims.hasEq FStar.DM4F.MonadLaws.label))
:named assumption_FStar.DM4F.MonadLaws.label__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
FStar.DM4F.MonadLaws.label))
:qid FStar.DM4F.MonadLaws_pretyping_eb5d41e13bf746cc49f141ba21a8c7a8))

:named FStar.DM4F.MonadLaws_pretyping_eb5d41e13bf746cc49f141ba21a8c7a8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.MonadLaws.ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,19-46,52); use=FStar.DM4F.MonadLaws.fst(46,19-46,52)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_05275a1cf51d299be9159781d6b8228d @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_05275a1cf51d299be9159781d6b8228d @x2)))
:qid FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_05275a1cf51d299be9159781d6b8228d))

:named FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_05275a1cf51d299be9159781d6b8228d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_05275a1cf51d299be9159781d6b8228d
;;; Fact-ids: Name FStar.DM4F.MonadLaws.ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,19-46,52); use=FStar.DM4F.MonadLaws.fst(46,19-46,52)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_05275a1cf51d299be9159781d6b8228d @x1))
(and 
;; def=FStar.DM4F.MonadLaws.fst(46,19-46,52); use=FStar.DM4F.MonadLaws.fst(46,19-46,52)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_05275a1cf51d299be9159781d6b8228d.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_05275a1cf51d299be9159781d6b8228d @x1)))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_05275a1cf51d299be9159781d6b8228d))

:named FStar.DM4F.MonadLaws_interpretation_Tm_arrow_05275a1cf51d299be9159781d6b8228d))
(push) ;; push{2

; Starting query at FStar.DM4F.MonadLaws.fst(50,4-55,42)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> ifc b
(declare-fun Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(49,15-49,63); use=FStar.DM4F.MonadLaws.fst(49,47-49,63)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e))

:named kinding_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(49,15-49,63); use=FStar.DM4F.MonadLaws.fst(49,47-49,63)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e @x2
@x3)))
:qid FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e))

:named FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(49,15-49,63); use=FStar.DM4F.MonadLaws.fst(49,47-49,63)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e @x1
@x2))
(and 
;; def=FStar.DM4F.MonadLaws.fst(49,15-49,63); use=FStar.DM4F.MonadLaws.fst(49,47-49,63)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(FStar.DM4F.MonadLaws.ifc @x1)))
 

:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e.1))
...
(Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e @x1
@x2)))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e))

:named FStar.DM4F.MonadLaws_interpretation_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (f: FStar.DM4F.MonadLaws.ifc a)
;   (g: (_: a -> FStar.DM4F.MonadLaws.ifc b)).
;   (*  - Could not prove post-condition
; *)
;   forall (l0: FStar.DM4F.MonadLaws.label).
;     (*  - Could not prove post-condition
; *)
;     forall (k: Prims.pure_post (FStar.Pervasives.Native.option (b & FStar.DM4F.MonadLaws.label))).
;       (forall (x: FStar.Pervasives.Native.option (b & FStar.DM4F.MonadLaws.label)).
;           {:pattern Prims.guard_free (k x)}
;           Prims.auto_squash (k x)) ==>
;       (~(None? (f l0)) /\ ~(Some? (f l0)) ==> Prims.l_False) /\
;       (~(None? (f l0)) ==>
;         (forall (b: a) (b: FStar.DM4F.MonadLaws.label).
;             f l0 == FStar.Pervasives.Native.Some (b, b) ==>
;             (forall (k:
;                 Prims.pure_post (FStar.Pervasives.Native.option (b & FStar.DM4F.MonadLaws.label))).
;                 (forall (x: FStar.Pervasives.Native.option (b & FStar.DM4F.MonadLaws.label)).
;                     {:pattern Prims.guard_free (k x)}
;                     Prims.auto_squash (k x)) ==>
;                 ~(None? (g b b)) /\ ~(Some? (g b b)) ==> Prims.l_False)))


; Context: While encoding a query
; While typechecking the top-level declaration `let bind_ifc`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.MonadLaws.fst(50,4-55,42)
(forall ((@x4 Term))
 (! (implies (HasType @x4
FStar.DM4F.MonadLaws.label)
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.MonadLaws.fst(50,13-55,42)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.MonadLaws.fst(50,13-55,42)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.MonadLaws.fst(50,13-55,42)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.MonadLaws.fst(50,13-55,42)
(and (implies 
;; def=FStar.DM4F.MonadLaws.fst(50,18-50,21); use=FStar.DM4F.MonadLaws.fst(50,38-50,41)
(and 
;; def=FStar.DM4F.MonadLaws.fst(50,18-50,21); use=FStar.DM4F.MonadLaws.fst(50,38-50,41)
(not 
;; def=FStar.DM4F.MonadLaws.fst(50,18-50,21); use=FStar.DM4F.MonadLaws.fst(50,38-50,41)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=FStar.DM4F.MonadLaws.fst(50,13-55,42)
(not 
;; def=FStar.DM4F.MonadLaws.fst(50,18-50,21); use=FStar.DM4F.MonadLaws.fst(50,38-50,41)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (FStar.Pervasives.Native.tuple2 @x0
FStar.DM4F.MonadLaws.label)
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.MonadLaws.fst(50,13-55,42)
(forall ((@x6 Term))
 (! (implies (HasType @x6
@x0)
...
;; def=FStar.DM4F.MonadLaws.fst(50,18-52,25); use=FStar.DM4F.MonadLaws.fst(50,38-52,25)
(= (ApplyTT @x2
@x4)
...
;; def=FStar.DM4F.MonadLaws.fst(53,17-53,21); use=FStar.DM4F.MonadLaws.fst(53,40-53,44)
(not 
;; def=FStar.DM4F.MonadLaws.fst(53,17-53,21); use=FStar.DM4F.MonadLaws.fst(53,40-53,44)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.MonadLaws.bind_ifc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.MonadLaws_interpretation_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e, FStar.DM4F.MonadLaws_interpretation_Tm_arrow_05275a1cf51d299be9159781d6b8228d, equation_FStar.DM4F.MonadLaws.ifc, kinding_FStar.DM4F.MonadLaws.label@tok, kinding_FStar.Pervasives.Native.tuple2@tok, lemma_FStar.Pervasives.invertOption
...
;;;;;;;;;;;;;;;;_: a -> ifc b
(declare-fun Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e (Term Term) Term)
(declare-fun FStar.DM4F.MonadLaws.bind_ifc (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;f: ifc a -> g: (_: a -> ifc b) -> ifc b
(declare-fun Tm_arrow_ea2c67298b5964c779d90aea57a862bc () Term)
(declare-fun FStar.DM4F.MonadLaws.bind_ifc@tok () Term)


(declare-fun Tm_abs_1654580b2318271d7b329211408eb334 (Term Term Term) Term)

; </end encoding let bind_ifc>


; encoding sigelt val FStar.DM4F.MonadLaws.left_unit


; <Skipped val FStar.DM4F.MonadLaws.left_unit/>

;;;;;;;;;;;;;;;;typing_Tm_abs_6d60449855e44f314114039708e0f80a
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(48,50-48,61); use=FStar.DM4F.MonadLaws.fst(48,50-48,61)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_6d60449855e44f314114039708e0f80a @x0
@x1)
(Tm_arrow_05275a1cf51d299be9159781d6b8228d @x1))
 

:pattern ((Tm_abs_6d60449855e44f314114039708e0f80a @x0
@x1))
:qid typing_Tm_abs_6d60449855e44f314114039708e0f80a))

:named typing_Tm_abs_6d60449855e44f314114039708e0f80a))
;;;;;;;;;;;;;;;;typing_Tm_abs_1654580b2318271d7b329211408eb334
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(50,32-55,42); use=FStar.DM4F.MonadLaws.fst(50,32-55,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_1654580b2318271d7b329211408eb334 @x0
@x1
@x2)
(Tm_arrow_05275a1cf51d299be9159781d6b8228d @x2))
 

:pattern ((Tm_abs_1654580b2318271d7b329211408eb334 @x0
@x1
@x2))
:qid typing_Tm_abs_1654580b2318271d7b329211408eb334))

:named typing_Tm_abs_1654580b2318271d7b329211408eb334))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(48,4-48,14); use=FStar.DM4F.MonadLaws.fst(48,4-48,14)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
@x0))
(HasType (FStar.DM4F.MonadLaws.return_ifc @x0
@x1)
(FStar.DM4F.MonadLaws.ifc @x0)))
 

:pattern ((FStar.DM4F.MonadLaws.return_ifc @x0
@x1))
:qid typing_FStar.DM4F.MonadLaws.return_ifc))

:named typing_FStar.DM4F.MonadLaws.return_ifc))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(49,4-49,12); use=FStar.DM4F.MonadLaws.fst(49,4-49,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e @x1
@x0)))
(HasType (FStar.DM4F.MonadLaws.bind_ifc @x0
@x1
@x2
@x3)
(FStar.DM4F.MonadLaws.ifc @x1)))
...
:pattern ((FStar.DM4F.MonadLaws.bind_ifc @x0
@x1
@x2
@x3))
:qid typing_FStar.DM4F.MonadLaws.bind_ifc))

:named typing_FStar.DM4F.MonadLaws.bind_ifc))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(49,15-49,63); use=FStar.DM4F.MonadLaws.fst(49,47-49,63)
...
:named kinding_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_6d60449855e44f314114039708e0f80a
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(48,50-48,61); use=FStar.DM4F.MonadLaws.fst(48,50-48,61)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_6d60449855e44f314114039708e0f80a @x1
@x2)
@x0)
...
:pattern ((ApplyTT (Tm_abs_6d60449855e44f314114039708e0f80a @x1
@x2)
@x0))
:qid interpretation_Tm_abs_6d60449855e44f314114039708e0f80a))

:named interpretation_Tm_abs_6d60449855e44f314114039708e0f80a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_1654580b2318271d7b329211408eb334
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(50,32-55,42); use=FStar.DM4F.MonadLaws.fst(50,32-55,42)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_1654580b2318271d7b329211408eb334 @x1
@x2
@x3)
@x0)
(let ((@lb4 (ApplyTT @x2
...
:pattern ((ApplyTT (Tm_abs_1654580b2318271d7b329211408eb334 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_1654580b2318271d7b329211408eb334))

:named interpretation_Tm_abs_1654580b2318271d7b329211408eb334))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.MonadLaws.return_ifc
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(48,4-48,14); use=FStar.DM4F.MonadLaws.fst(48,4-48,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.MonadLaws.return_ifc @x0
@x1)
(Tm_abs_6d60449855e44f314114039708e0f80a @x1
@x0))
 

:pattern ((FStar.DM4F.MonadLaws.return_ifc @x0
@x1))
:qid equation_FStar.DM4F.MonadLaws.return_ifc))

:named equation_FStar.DM4F.MonadLaws.return_ifc))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.MonadLaws.bind_ifc
;;; Fact-ids: Name FStar.DM4F.MonadLaws.bind_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(49,4-49,12); use=FStar.DM4F.MonadLaws.fst(49,4-49,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (FStar.DM4F.MonadLaws.bind_ifc @x0
@x1
@x2
@x3)
(Tm_abs_1654580b2318271d7b329211408eb334 @x3
@x2
@x1))
...
@x2
@x3))
:qid equation_FStar.DM4F.MonadLaws.bind_ifc))

:named equation_FStar.DM4F.MonadLaws.bind_ifc))
...
; Starting query at FStar.DM4F.MonadLaws.fst(59,24-59,26)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

;;;;;;;;;;;;;;;;_: label -> Type
(declare-fun Tm_arrow_8eb33e556996416c1e9af28b734e2fbb () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8eb33e556996416c1e9af28b734e2fbb
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_8eb33e556996416c1e9af28b734e2fbb
Tm_type)
:named kinding_Tm_arrow_8eb33e556996416c1e9af28b734e2fbb))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,19-46,24); use=FStar.DM4F.MonadLaws.fst(59,24-59,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8eb33e556996416c1e9af28b734e2fbb)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_8eb33e556996416c1e9af28b734e2fbb))
:qid FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_8eb33e556996416c1e9af28b734e2fbb))

:named FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_8eb33e556996416c1e9af28b734e2fbb))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8eb33e556996416c1e9af28b734e2fbb
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,19-46,24); use=FStar.DM4F.MonadLaws.fst(59,24-59,26)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_8eb33e556996416c1e9af28b734e2fbb.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_8eb33e556996416c1e9af28b734e2fbb))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_8eb33e556996416c1e9af28b734e2fbb))

:named FStar.DM4F.MonadLaws_interpretation_Tm_arrow_8eb33e556996416c1e9af28b734e2fbb))
(declare-fun Tm_abs_143ffd806070927862b2b0f8ac8c0b90 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_143ffd806070927862b2b0f8ac8c0b90
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,32-46,52); use=FStar.DM4F.MonadLaws.fst(59,24-59,26)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_143ffd806070927862b2b0f8ac8c0b90 @x0)
Tm_arrow_8eb33e556996416c1e9af28b734e2fbb)
 

:pattern ((Tm_abs_143ffd806070927862b2b0f8ac8c0b90 @x0))
:qid typing_Tm_abs_143ffd806070927862b2b0f8ac8c0b90))

:named typing_Tm_abs_143ffd806070927862b2b0f8ac8c0b90))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_143ffd806070927862b2b0f8ac8c0b90
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,32-46,52); use=FStar.DM4F.MonadLaws.fst(59,24-59,26)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_143ffd806070927862b2b0f8ac8c0b90 @x1)
@x0)
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x1
FStar.DM4F.MonadLaws.label)))
 

:pattern ((ApplyTT (Tm_abs_143ffd806070927862b2b0f8ac8c0b90 @x1)
@x0))
:qid interpretation_Tm_abs_143ffd806070927862b2b0f8ac8c0b90))

:named interpretation_Tm_abs_143ffd806070927862b2b0f8ac8c0b90))

; Encoding query formula : forall (a: Type) (b: Type) (x: a) (f: (_: a -> FStar.DM4F.MonadLaws.ifc b)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.FunctionalExtensionality.feq (FStar.DM4F.MonadLaws.bind_ifc (FStar.DM4F.MonadLaws.return_ifc
;                   x)
;               f)
;           (f x) ==>
;         p pure_result) ==>
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.MonadLaws.fst(59,24-59,26)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=FStar.DM4F.MonadLaws.fst(58,21-58,60); use=FStar.DM4F.MonadLaws.fst(59,24-59,26)
(or label_2

;; def=FStar.DM4F.MonadLaws.fst(58,21-58,60); use=FStar.DM4F.MonadLaws.fst(59,24-59,26)
(Valid 
;; def=FStar.DM4F.MonadLaws.fst(58,21-58,60); use=FStar.DM4F.MonadLaws.fst(59,24-59,26)
(FStar.FunctionalExtensionality.feq FStar.DM4F.MonadLaws.label
(Tm_abs_143ffd806070927862b2b0f8ac8c0b90 @x1)
(FStar.DM4F.MonadLaws.bind_ifc @x0
@x1
(FStar.DM4F.MonadLaws.return_ifc @x0
@x2)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.MonadLaws.fst(59,24-59,26)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.MonadLaws.fst(59,24-59,26)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.MonadLaws.left_unit, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.MonadLaws_interpretation_Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e, FStar.DM4F.MonadLaws_interpretation_Tm_arrow_05275a1cf51d299be9159781d6b8228d, FStar.DM4F.MonadLaws_pretyping_eb5d41e13bf746cc49f141ba21a8c7a8, constructor_distinct_FStar.Pervasives.Native.Some, data_elim_FStar.Pervasives.Native.Some, equality_tok_FStar.DM4F.MonadLaws.Low@tok, equation_FStar.DM4F.MonadLaws.bind_ifc, equation_FStar.DM4F.MonadLaws.ifc, equation_FStar.DM4F.MonadLaws.return_ifc, equation_FStar.FunctionalExtensionality.feq, fuel_guarded_inversion_FStar.DM4F.MonadLaws.label, fuel_guarded_inversion_FStar.Pervasives.Native.option, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, interpretation_Tm_abs_1654580b2318271d7b329211408eb334, interpretation_Tm_abs_6d60449855e44f314114039708e0f80a, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Mktuple2__a, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, typing_tok_FStar.DM4F.MonadLaws.Low@tok
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.MonadLaws.left_unit (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.MonadLaws.left_unit@tok () Term)

; </end encoding let left_unit>


; encoding sigelt val FStar.DM4F.MonadLaws.right_unit


; <Skipped val FStar.DM4F.MonadLaws.right_unit/>
...
;; def=FStar.DM4F.MonadLaws.fst(48,4-48,14); use=FStar.DM4F.MonadLaws.fst(48,4-48,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT FStar.DM4F.MonadLaws.return_ifc@tok
@x0)
@x1)
(FStar.DM4F.MonadLaws.return_ifc @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT FStar.DM4F.MonadLaws.return_ifc@tok
@x0)
@x1))
:qid token_correspondence_FStar.DM4F.MonadLaws.return_ifc))

:named token_correspondence_FStar.DM4F.MonadLaws.return_ifc))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! (HasType Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1
Tm_type)
:named kinding_Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(48,4-48,14); use=FStar.DM4F.MonadLaws.fst(48,4-48,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.MonadLaws.return_ifc@tok
Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1))
...
@x1)
@x2)
(FStar.DM4F.MonadLaws.return_ifc @x1
@x2))
 

:pattern ((FStar.DM4F.MonadLaws.return_ifc @x1
@x2))
:qid function_token_typing_FStar.DM4F.MonadLaws.return_ifc.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.MonadLaws.return_ifc@tok))
:qid function_token_typing_FStar.DM4F.MonadLaws.return_ifc))

:named function_token_typing_FStar.DM4F.MonadLaws.return_ifc))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(48,17-48,38); use=FStar.DM4F.MonadLaws.fst(48,19-48,38)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1)
...
@x1
Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1))
:qid FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1))

:named FStar.DM4F.MonadLaws_pre_typing_Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1
;;; Fact-ids: Name FStar.DM4F.MonadLaws.return_ifc; Namespace FStar.DM4F.MonadLaws
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(48,17-48,38); use=FStar.DM4F.MonadLaws.fst(48,19-48,38)
(forall ((@x0 Term))
...
@x1)
@x2))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1))
:qid FStar.DM4F.MonadLaws_interpretation_Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1))

:named FStar.DM4F.MonadLaws_interpretation_Tm_arrow_dace4b97eac0538b6ea4ca32cb6a66d1))
(push) ;; push{2

; Starting query at FStar.DM4F.MonadLaws.fst(62,21-62,23)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,19-46,24); use=FStar.DM4F.MonadLaws.fst(62,21-62,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8eb33e556996416c1e9af28b734e2fbb)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,32-46,52); use=FStar.DM4F.MonadLaws.fst(62,21-62,23)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_143ffd806070927862b2b0f8ac8c0b90 @x0)
Tm_arrow_8eb33e556996416c1e9af28b734e2fbb)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.DM4F.MonadLaws.return_ifc@tok))
:named @kick_partial_app_1d932b579ca36d32c4df639564cd25ee))

; Encoding query formula : forall (a: Type) (f: FStar.DM4F.MonadLaws.ifc a).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.FunctionalExtensionality.feq (FStar.DM4F.MonadLaws.bind_ifc f
;               FStar.DM4F.MonadLaws.return_ifc)
;           f ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.MonadLaws.fst(62,21-62,23)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=FStar.DM4F.MonadLaws.fst(61,43-61,76); use=FStar.DM4F.MonadLaws.fst(62,21-62,23)
(or label_2
...
;; def=FStar.DM4F.MonadLaws.fst(61,43-61,76); use=FStar.DM4F.MonadLaws.fst(62,21-62,23)
(FStar.FunctionalExtensionality.feq FStar.DM4F.MonadLaws.label
(Tm_abs_143ffd806070927862b2b0f8ac8c0b90 @x0)
(FStar.DM4F.MonadLaws.bind_ifc @x0
@x0
@x1
(ApplyTT FStar.DM4F.MonadLaws.return_ifc@tok
@x0))
@x1)
)
)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.MonadLaws.fst(62,21-62,23)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.MonadLaws.fst(62,21-62,23)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.MonadLaws.right_unit, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.MonadLaws_interpretation_Tm_arrow_05275a1cf51d299be9159781d6b8228d, FStar.DM4F.MonadLaws_pretyping_eb5d41e13bf746cc49f141ba21a8c7a8, data_elim_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.None, disc_equation_FStar.Pervasives.Native.Some, equality_tok_FStar.DM4F.MonadLaws.Low@tok, equation_FStar.DM4F.MonadLaws.bind_ifc, equation_FStar.DM4F.MonadLaws.ifc, equation_FStar.DM4F.MonadLaws.return_ifc, equation_FStar.FunctionalExtensionality.feq, fuel_guarded_inversion_FStar.Pervasives.Native.option, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, function_token_typing_FStar.DM4F.MonadLaws.return_ifc, interpretation_Tm_abs_1654580b2318271d7b329211408eb334, interpretation_Tm_abs_6d60449855e44f314114039708e0f80a, kinding_FStar.DM4F.MonadLaws.label@tok, kinding_FStar.Pervasives.Native.tuple2@tok, lemma_FStar.Pervasives.invertOption, projection_inverse_BoxBool_proj_0, typing_tok_FStar.DM4F.MonadLaws.Low@tok
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.MonadLaws.right_unit (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.MonadLaws.right_unit@tok () Term)

; </end encoding let right_unit>


; encoding sigelt val FStar.DM4F.MonadLaws.associativity


; <Skipped val FStar.DM4F.MonadLaws.associativity/>

(push) ;; push{2

; Starting query at FStar.DM4F.MonadLaws.fst(68,32-68,34)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,19-46,24); use=FStar.DM4F.MonadLaws.fst(68,32-68,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8eb33e556996416c1e9af28b734e2fbb)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(46,32-46,52); use=FStar.DM4F.MonadLaws.fst(68,32-68,34)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_143ffd806070927862b2b0f8ac8c0b90 @x0)
Tm_arrow_8eb33e556996416c1e9af28b734e2fbb)
...
(declare-fun Tm_abs_fea701705593963d20006d2dcd055322 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_fea701705593963d20006d2dcd055322
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(66,53-66,69); use=FStar.DM4F.MonadLaws.fst(68,32-68,34)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_fea701705593963d20006d2dcd055322 @x0
@x1
@x2
@x3
@x4)
(Tm_arrow_03d7c8f404a3f17a41fbd38d1795a79e @x3
@x4))
 

:pattern ((Tm_abs_fea701705593963d20006d2dcd055322 @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_fea701705593963d20006d2dcd055322))

:named typing_Tm_abs_fea701705593963d20006d2dcd055322))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_fea701705593963d20006d2dcd055322
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.MonadLaws.fst(66,53-66,69); use=FStar.DM4F.MonadLaws.fst(68,32-68,34)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (Tm_abs_fea701705593963d20006d2dcd055322 @x1
@x2
@x3
@x4
@x5)
@x0)
(FStar.DM4F.MonadLaws.bind_ifc @x1
@x4
(ApplyTT @x2
@x0)
@x3))
...
:pattern ((ApplyTT (Tm_abs_fea701705593963d20006d2dcd055322 @x1
@x2
@x3
@x4
@x5)
@x0))
:qid interpretation_Tm_abs_fea701705593963d20006d2dcd055322))

:named interpretation_Tm_abs_fea701705593963d20006d2dcd055322))
...
;   (f: FStar.DM4F.MonadLaws.ifc a)
;   (g: (_: a -> FStar.DM4F.MonadLaws.ifc b))
;   (h: (_: b -> FStar.DM4F.MonadLaws.ifc c)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.FunctionalExtensionality.feq (FStar.DM4F.MonadLaws.bind_ifc f
;               (fun x -> FStar.DM4F.MonadLaws.bind_ifc (g x) h))
;           (FStar.DM4F.MonadLaws.bind_ifc (FStar.DM4F.MonadLaws.bind_ifc f g) h) ==>
;         p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.MonadLaws.fst(68,32-68,34)
(forall ((@x7 Term))
 (! (implies (and (or label_1
(HasType @x7
Prims.unit))

;; def=FStar.DM4F.MonadLaws.fst(66,26-67,64); use=FStar.DM4F.MonadLaws.fst(68,32-68,34)
(or label_2
...
;; def=FStar.DM4F.MonadLaws.fst(66,26-67,64); use=FStar.DM4F.MonadLaws.fst(68,32-68,34)
(FStar.FunctionalExtensionality.feq FStar.DM4F.MonadLaws.label
(Tm_abs_143ffd806070927862b2b0f8ac8c0b90 @x2)
(FStar.DM4F.MonadLaws.bind_ifc @x0
@x2
@x3
(Tm_abs_fea701705593963d20006d2dcd055322 @x1
@x4
@x5
@x2
@x0))
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.MonadLaws.fst(68,32-68,34)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.MonadLaws.fst(68,32-68,34)
(ApplyTT @x6
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.MonadLaws.associativity, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.MonadLaws_interpretation_Tm_arrow_05275a1cf51d299be9159781d6b8228d, FStar.DM4F.MonadLaws_pretyping_eb5d41e13bf746cc49f141ba21a8c7a8, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, constructor_distinct_Tm_unit, data_elim_FStar.Pervasives.Native.Some, equality_tok_FStar.DM4F.MonadLaws.High@tok, equality_tok_FStar.DM4F.MonadLaws.Low@tok, equation_FStar.DM4F.MonadLaws.bind_ifc, equation_FStar.DM4F.MonadLaws.ifc, equation_FStar.FunctionalExtensionality.feq, fuel_guarded_inversion_FStar.DM4F.MonadLaws.label, fuel_guarded_inversion_FStar.Pervasives.Native.option, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, interpretation_Tm_abs_1654580b2318271d7b329211408eb334, interpretation_Tm_abs_fea701705593963d20006d2dcd055322, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Mktuple2__a, projection_inverse_FStar.Pervasives.Native.Some_v, typing_FStar.DM4F.MonadLaws.bind_ifc, typing_Tm_abs_fea701705593963d20006d2dcd055322, typing_tok_FStar.DM4F.MonadLaws.High@tok, typing_tok_FStar.DM4F.MonadLaws.Low@tok
