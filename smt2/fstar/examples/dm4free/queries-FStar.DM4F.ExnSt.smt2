...
; Externals for module FStar.DM4F.ST


; <Start encoding let st>

(declare-fun FStar.DM4F.ST.st (Term Term) Term)

(declare-fun FStar.DM4F.ST.st@tok () Term)
;;;;;;;;;;;;;;;;_: s -> Prims.M (a & s)
...
(declare-fun FStar.DM4F.ST.return_st (Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> a: Type -> x: a -> st s a
(declare-fun Tm_arrow_0792ad8a6da5906863f7fd4ae805211f () Term)
(declare-fun FStar.DM4F.ST.return_st@tok () Term)
...
;;;;;;;;;;;;;;;;_: a -> st s b
(declare-fun Tm_arrow_23277d88e6219007de40f12b9efc53bd (Term Term Term) Term)
(declare-fun FStar.DM4F.ST.bind_st (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;s: Type -> a: Type -> b: Type -> f: st s a -> g: (_: a -> st s b) -> st s b
(declare-fun Tm_arrow_ac86da2d00b737ff03c51447ff8324c2 () Term)
(declare-fun FStar.DM4F.ST.bind_st@tok () Term)
...
(declare-fun FStar.DM4F.ST.get (Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> _: Prims.unit -> st s s
(declare-fun Tm_arrow_88e49a876f76efcfecce500248a12396 () Term)
(declare-fun FStar.DM4F.ST.get@tok () Term)
(declare-fun Tm_abs_be1f098a73b727536eabaf253dd83852 (Term) Term)
...
(declare-fun FStar.DM4F.ST.put (Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> x: s -> st s Prims.unit
(declare-fun Tm_arrow_3639947565d17f7463d3a8c0da6e9785 () Term)
(declare-fun FStar.DM4F.ST.put@tok () Term)
(declare-fun Tm_abs_a2449e6ff52c8081ac060741b7cff354 (Term Term) Term)

; </end encoding let put>


; <Start encoding let _dm4f_STATE_h_lift_from_pure>
...
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_lift_from_pure (Term Term Term Term Term) Term)



;;;;;;;;;;;;;;;;s: Type -> a: Type -> wp: (_: (_: a -> Type) -> Type) -> s0: s -> p': (_: a & s -> Type) -> Type
(declare-fun Tm_arrow_fe87751d7b1ccc45a415f28ff2d80a5e () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_lift_from_pure@tok () Term)
...
; </end encoding let _dm4f_STATE_h_lift_from_pure>


; <Start encoding let _dm4f_STATE_h_return_wp>


(declare-fun FStar.DM4F.ST._dm4f_STATE_h_return_wp (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;s: Type -> a: Type -> x: a -> s0: s -> p': (_: a & s -> Type) -> Type
(declare-fun Tm_arrow_d4e8770e6412c7143e5021e5dedbfb7b () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_return_wp@tok () Term)


; </end encoding let _dm4f_STATE_h_return_wp>


; <Start encoding let _dm4f_STATE_h_return_elab>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_return_elab (Term Term Term) Term)
(declare-fun Tm_refine_a29639c8725df82a6659e82627bb977e (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s0__x: s -> Prims.PURE (a & s)
(declare-fun Tm_arrow_60638e12385a249c11c0e3df28ec72df (Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> a: Type -> x: a -> s0__x: s -> Prims.PURE (a & s)
(declare-fun Tm_arrow_d51e3e480efc0cd6bd91f920557adf23 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_return_elab@tok () Term)




; </end encoding let _dm4f_STATE_h_return_elab>


; <Start encoding let _dm4f_STATE_h_bind_wp>


;;;;;;;;;;;;;;;;_: s -> _: (_: a & s -> Type) -> Type
(declare-fun Tm_arrow_b095d1214768e735059543db46dbca1c (Term Term) Term)


;;;;;;;;;;;;;;;;_: a -> _: s -> _: (_: b & s -> Type) -> Type
(declare-fun Tm_arrow_da46eb0ea2ae1c75d10c4cc5379b88fd (Term Term Term) Term)

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_bind_wp (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;s: Type ->     a: Type ->     b: Type ->     f: (_: s -> _: (_: a & s -> Type) -> Type) ->     g: (_: a -> _: s -> _: (_: b & s -> Type) -> Type) ->     s0: s ->     p'': (_: b & s -> Type)   -> Type
(declare-fun Tm_arrow_eaf659705275ecc93d18250283ee20a3 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_bind_wp@tok () Term)
...
; </end encoding let _dm4f_STATE_h_bind_wp>


; <Start encoding let _dm4f_STATE_h_bind_elab>



(declare-fun Tm_refine_6a9ddcd18392ac5aab5ee22fe53237c6 (Term Term) Term)

;;;;;;;;;;;;;;;;y: _: (a & s){Prims.l_True} -> Prims.GTot Type
...
(declare-fun Tm_refine_42fe39f8138ca947c7f10fe9089b7cb2 (Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: s -> Prims.PURE (b & s)
(declare-fun Tm_arrow_6ffced0c6a885d920329504bfbd86b05 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: s -> Prims.PURE (b & s)
(declare-fun Tm_arrow_74c8a4ab9b2065b12bcb2a91567ee681 (Term Term Term Term) Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_bind_elab (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_bd78f01afdbd934b381a22dc10401854 (Term Term Term Term Term) Term)
(declare-fun Tm_refine_35fda262c9c836230bd2c3c27a396b7e (Term Term Term Term Term Term) Term)





(declare-fun Tm_abs_4aadfac28103c5ea109a52c562aa844f (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s0__x: s -> Prims.PURE (b & s)
(declare-fun Tm_arrow_b2468963a0315f89de746e28ec5f966a (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s: Type ->     a: Type ->     b: Type ->     f__w: (_: s -> _: (_: a & s -> Type) -> Type) ->     f: (_: s -> Prims.PURE (a & s)) ->     g__w: (_: a -> _: s -> _: (_: b & s -> Type) -> Type) ->     g: (_: a -> _: s -> Prims.PURE (b & s)) ->     s0__x: s   -> Prims.PURE (b & s)
(declare-fun Tm_arrow_a5385c81255daded2e1d6d425f7f9d5a () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_bind_elab@tok () Term)
...
; </end encoding let _dm4f_STATE_h_bind_elab>


; <Start encoding let _dm4f_STATE_h___proj__STATE_h__item__get_elab>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h___proj__STATE_h__item__get_elab (Term Term) Term)
(declare-fun Tm_refine_d5194732ff27d0e13116a944e4da3b76 (Term Term) Term)
;;;;;;;;;;;;;;;;s0__x: s -> Prims.PURE (s & s)
(declare-fun Tm_arrow_8d87e29fbe3019ee51640fd23fd45fa3 (Term) Term)
;;;;;;;;;;;;;;;;s: Type -> _: Prims.unit -> s0__x: s -> Prims.PURE (s & s)
(declare-fun Tm_arrow_da47b2a9ee4125926ca815db448bdcfe () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h___proj__STATE_h__item__get_elab@tok () Term)




; </end encoding let _dm4f_STATE_h___proj__STATE_h__item__get_elab>


; <Start encoding let _dm4f_STATE_h___proj__STATE_h__item__get_complete_type>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h___proj__STATE_h__item__get_complete_type (Term) Term)

(declare-fun FStar.DM4F.ST._dm4f_STATE_h___proj__STATE_h__item__get_complete_type@tok () Term)


;;;;;;;;;;;;;;;;_: Prims.unit -> s0__x: s -> Prims.PURE (s & s)
(declare-fun Tm_arrow_2f154e39691cfa8a02d15972400d1c9f (Term) Term)

; </end encoding let _dm4f_STATE_h___proj__STATE_h__item__get_complete_type>


; <Start encoding let _dm4f_STATE_h___proj__STATE_h__item__put_elab>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h___proj__STATE_h__item__put_elab (Term Term) Term)
(declare-fun Tm_refine_48c85674db7f9ecfba1946e2d1064a46 (Term Term) Term)
;;;;;;;;;;;;;;;;_: s -> Prims.PURE (Prims.unit & s)
(declare-fun Tm_arrow_ca7020194db9e668b67e9da46b9198bb (Term Term) Term)
;;;;;;;;;;;;;;;;s: Type -> x: s -> _: s -> Prims.PURE (Prims.unit & s)
(declare-fun Tm_arrow_e6cfde14004a657cbb96167222b4f0b3 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h___proj__STATE_h__item__put_elab@tok () Term)




; </end encoding let _dm4f_STATE_h___proj__STATE_h__item__put_elab>


; <Start encoding let _dm4f_STATE_h___proj__STATE_h__item__put_complete_type>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h___proj__STATE_h__item__put_complete_type (Term) Term)

(declare-fun FStar.DM4F.ST._dm4f_STATE_h___proj__STATE_h__item__put_complete_type@tok () Term)


;;;;;;;;;;;;;;;;x__x: s -> _: s -> Prims.PURE (Prims.unit & s)
(declare-fun Tm_arrow_8835bc07bce344bef992140067fcf101 (Term) Term)

; </end encoding let _dm4f_STATE_h___proj__STATE_h__item__put_complete_type>


; <Start encoding let _dm4f_STATE_h_repr>



(declare-fun FStar.DM4F.ST._dm4f_STATE_h_repr (Term Term Term) Term)


;;;;;;;;;;;;;;;;s: Type -> a: Type -> wp_a: (_: s -> _: (_: a & s -> Type) -> Type) -> Type
(declare-fun Tm_arrow_b55f42f89219af947835d6cc0be80e55 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_repr@tok () Term)
...
; </end encoding let _dm4f_STATE_h_repr>


; <Start encoding let _dm4f_STATE_h_pre>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_pre (Term) Term)

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_pre@tok () Term)


; </end encoding let _dm4f_STATE_h_pre>


; <Start encoding let _dm4f_STATE_h_post>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_post (Term Term) Term)

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_post@tok () Term)


; </end encoding let _dm4f_STATE_h_post>


; <Start encoding let _dm4f_STATE_h_wp>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_wp (Term Term) Term)

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_wp@tok () Term)



; </end encoding let _dm4f_STATE_h_wp>


; <Start encoding let _dm4f_STATE_h_ctx>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_ctx (Term Term Term) Term)

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: s -> _: (_: a & s -> Type) -> t
(declare-fun Tm_arrow_936d3e9fc91af25de121c09c08090e03 (Term Term Term) Term)

; </end encoding let _dm4f_STATE_h_ctx>


; <Start encoding let _dm4f_STATE_h_gctx>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_gctx (Term Term Term) Term)

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: s -> _: (_: a & s -> Type) -> Prims.GTot t
(declare-fun Tm_ghost_arrow_f46bf66accee259a5a70e19dc4d3d417 (Term Term Term) Term)

; </end encoding let _dm4f_STATE_h_gctx>


; <Start encoding let _dm4f_STATE_h_pure>


(declare-fun FStar.DM4F.ST._dm4f_STATE_h_pure (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: s -> _: (_: a & s -> Type) -> t
(declare-fun Tm_arrow_8f3d8450a53635c778179286c1941b2a () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_pure@tok () Term)


; </end encoding let _dm4f_STATE_h_pure>


; <Start encoding let _dm4f_STATE_h_app>



;;;;;;;;;;;;;;;;_: s -> _: (_: a & s -> Type) -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_dc2d6e9f6d27ca6711b030e2b9c10463 (Term Term Term Term) Term)



(declare-fun FStar.DM4F.ST._dm4f_STATE_h_app (Term Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l: (_: s -> _: (_: a & s -> Type) -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r: (_: s -> _: (_: a & s -> Type) -> Prims.GTot t1) ->     _: s ->     _: (_: a & s -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_cd9a7b3900afa8551619a429de323553 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_app@tok () Term)
...
; </end encoding let _dm4f_STATE_h_app>


; <Start encoding let _dm4f_STATE_h_lift1>




(declare-fun FStar.DM4F.ST._dm4f_STATE_h_lift1 (Term Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1: (_: s -> _: (_: a & s -> Type) -> Prims.GTot t1) ->     _: s ->     _: (_: a & s -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_2710469536edcfbfdd2b007070983551 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_lift1@tok () Term)
...
(declare-fun Tm_abs_189a073afedb94170cc3657c5e3d3052 (Term Term Term Term Term) Term)

; </end encoding let _dm4f_STATE_h_lift1>


; <Start encoding let _dm4f_STATE_h_lift2>

;;;;;;;;;;;;;;;;_: t1 -> _: t2 -> Prims.GTot t3
(declare-fun Tm_ghost_arrow_44164f5e759c8937bc211b53dca29861 (Term Term Term) Term)




(declare-fun FStar.DM4F.ST._dm4f_STATE_h_lift2 (Term Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1: (_: s -> _: (_: a & s -> Type) -> Prims.GTot t1) ->     a2: (_: s -> _: (_: a & s -> Type) -> Prims.GTot t2) ->     _: s ->     _: (_: a & s -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_7b09b60c2887d64edfea6db5fe36e00f () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_lift2@tok () Term)
...
(declare-fun Tm_abs_130ae0e5794bfdfbd671a30433479f0a (Term Term Term Term Term Term) Term)

; </end encoding let _dm4f_STATE_h_lift2>


; <Start encoding let _dm4f_STATE_h_push>



;;;;;;;;;;;;;;;;_: t1 -> _: s -> _: (_: a & s -> Type) -> Prims.GTot t2
(declare-fun Tm_arrow_1a962865c68e5613e91ceeb34da0ba35 (Term Term Term Term) Term)

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_push (Term Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f: (_: t1 -> _: s -> _: (_: a & s -> Type) -> Prims.GTot t2) ->     _: s ->     _: (_: a & s -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_b49511d7db9bdb21a4be4a628132cf87 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_push@tok () Term)





; </end encoding let _dm4f_STATE_h_push>


; <Start encoding let _dm4f_STATE_h_wp_if_then_else>

(declare-fun FStar.DM4F.ST._dm4f_STATE_h_wp_if_then_else (Term Term Term) Term)
...
;;;;;;;;;;;;;;;;_: (_: s -> _: (_: a & s -> Type) -> Type) ->     _: (_: s -> _: (_: a & s -> Type) -> Type) ->     _: s ->     _: (_: a & s -> Type)   -> Type
(declare-fun Tm_arrow_bcdb3703b8a9fb8c0cb1c96e55a390a0 (Term Term) Term)
;;;;;;;;;;;;;;;;s: Type ->     a: Type ->     c: Type ->     _: (_: s -> _: (_: a & s -> Type) -> Type) ->     _: (_: s -> _: (_: a & s -> Type) -> Type) ->     _: s ->     _: (_: a & s -> Type)   -> Type
(declare-fun Tm_arrow_d634d4af9573feb7a28a4c954e9cc917 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: s -> _: (_: a & s -> Type) -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_59287d495006e5c8ff8fc3fd62e681d6 (Term Term) Term)
...
;;;;;;;;;;;;;;;;a1: (_: s -> _: (_: a & s -> Type) -> Prims.GTot Prims.logical) ->     a2: (_: s -> _: (_: a & s -> Type) -> Prims.GTot Prims.logical) ->     _: s ->     _: (_: a & s -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_5bdd7b243e5fb64ccf715f6bc614102a (Term Term) Term)
(declare-fun Tm_abs_59e6bbf204d0ce9ede0c975008625c96 (Term Term Term) Term)

; </end encoding let _dm4f_STATE_h_wp_if_then_else>


; <Start encoding let _dm4f_STATE_h_wp_close>




(declare-fun FStar.DM4F.ST._dm4f_STATE_h_wp_close (Term Term Term Term) Term)





;;;;;;;;;;;;;;;;s: Type ->     a: Type ->     b: Type ->     f: (_: b -> _: s -> _: (_: a & s -> Type) -> Type) ->     _: s ->     _: (_: a & s -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_3f3c2ce7368762a5c90cf510631b7d23 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_wp_close@tok () Term)
...
(declare-fun Tm_abs_170462c0134078dffa670dd348658203 (Term Term Term Term) Term)

; </end encoding let _dm4f_STATE_h_wp_close>


; <Start encoding let _dm4f_STATE_h_stronger>





(declare-fun FStar.DM4F.ST._dm4f_STATE_h_stronger (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;s: Type ->     a: Type ->     wp1: (_: s -> _: (_: a & s -> Type) -> Type) ->     wp2: (_: s -> _: (_: a & s -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_1bad8869f5f9929b389668e37e177a66 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_stronger@tok () Term)
...
; </end encoding let _dm4f_STATE_h_stronger>


; <Start encoding let _dm4f_STATE_h_ite_wp>




(declare-fun FStar.DM4F.ST._dm4f_STATE_h_ite_wp (Term Term Term Term Term) Term)



;;;;;;;;;;;;;;;;s: Type -> a: Type -> wp: (_: s -> _: (_: a & s -> Type) -> Type) -> _: s -> _: (_: a & s -> Type)   -> Prims.logical
(declare-fun Tm_arrow_fb6a1bf18b438b8086efc948b04e6cd3 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_ite_wp@tok () Term)





; </end encoding let _dm4f_STATE_h_ite_wp>


; <Start encoding let _dm4f_STATE_h_null_wp>


(declare-fun FStar.DM4F.ST._dm4f_STATE_h_null_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;s: Type -> a: Type -> _: s -> _: (_: a & s -> Type) -> Prims.logical
(declare-fun Tm_arrow_bb5c23d38fc3c00fb5b1ca00fe5fb347 () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_null_wp@tok () Term)


; </end encoding let _dm4f_STATE_h_null_wp>


; <Start encoding let _dm4f_STATE_h_wp_trivial>



(declare-fun FStar.DM4F.ST._dm4f_STATE_h_wp_trivial (Term Term Term) Term)


;;;;;;;;;;;;;;;;s: Type -> a: Type -> wp: (_: s -> _: (_: a & s -> Type) -> Type) -> Prims.logical
(declare-fun Tm_arrow_b9ca51b54c87f0bad8bfdd872480ae7e () Term)
(declare-fun FStar.DM4F.ST._dm4f_STATE_h_wp_trivial@tok () Term)




; </end encoding let _dm4f_STATE_h_wp_trivial>


; <Start encoding new_effect_for_free { STATE_h ... }>


;;;;;;;;;;;;;;;;_: s & s -> Type
(declare-fun Tm_arrow_b16528360b61445749199368a84703a6 (Term) Term)

;;;;;;;;;;;;;;;;s0__x: s -> p': (_: s & s -> Type) -> Type
...
;;;;;;;;;;;;;;;;s: Type -> _: Prims.unit -> FStar.DM4F.ST._dm4f_STATE_h_repr s s (fun s0__x p' -> p' (s0__x, s0__x))
(declare-fun Tm_arrow_5c91832692eae2bde3801591689dd62c () Term)
(declare-fun Tm_abs_4c8cd1b063df8845edd2843302f61d10 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.ST.__proj__STATE_h__item__get (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.ST.__proj__STATE_h__item__get@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.unit & s -> Type
(declare-fun Tm_arrow_3b93d3a2efc03fbb1aeb57eebff54310 (Term) Term)

;;;;;;;;;;;;;;;;_: s -> p': (_: Prims.unit & s -> Type) -> Type
...
;;;;;;;;;;;;;;;;s: Type -> x: s -> FStar.DM4F.ST._dm4f_STATE_h_repr s Prims.unit (fun _ p' -> p' ((), x))
(declare-fun Tm_arrow_873ffd22d90f88fc0c1ff534b9d024e0 () Term)
(declare-fun Tm_abs_7a49fb6863a90bd2562cba0da9602c5f () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.ST.__proj__STATE_h__item__put (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.ST.__proj__STATE_h__item__put@tok () Term)

; </end encoding new_effect_for_free { STATE_h ... }>


; End Externals for module FStar.DM4F.ST


; Externals for module FStar.DM4F.IntST


; <Start encoding let state>

(declare-fun FStar.DM4F.IntST.state (Dummy_sort) Term)

; </end encoding let state>


; <Start encoding let _dm4f_STINT_lift_from_pure>



;;;;;;;;;;;;;;;;_: a & Prims.int -> Type
(declare-fun Tm_arrow_f292402a0ffac3d4a8718d68be967e06 (Term) Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type -> wp: (_: (_: a -> Type) -> Type) -> s0: Prims.int -> p': (_: a & Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_99cc16d28f6a730ffd7a0dd0ac38daa1 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_lift_from_pure@tok () Term)




(declare-fun Tm_abs_68b669d1ea097667facfc7d92bff75c8 (Term Term Term) Term)

; </end encoding let _dm4f_STINT_lift_from_pure>


; <Start encoding let _dm4f_STINT_return_wp>


(declare-fun FStar.DM4F.IntST._dm4f_STINT_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> s0: Prims.int -> p': (_: a & Prims.int -> Type) -> Type
(declare-fun Tm_arrow_f1661db73d60df5e8e83a7dc558d2330 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_return_wp@tok () Term)


; </end encoding let _dm4f_STINT_return_wp>


; <Start encoding let _dm4f_STINT_return_elab>

(declare-fun FStar.DM4F.IntST._dm4f_STINT_return_elab (Term Term) Term)
(declare-fun Tm_refine_c32d66ca9d371937f1f9342cd6ff111a (Term Term Term) Term)
;;;;;;;;;;;;;;;;s0__x: Prims.int -> Prims.PURE (a & Prims.int)
(declare-fun Tm_arrow_7a6d05a822a118aa590e829dc124452d (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> s0__x: Prims.int -> Prims.PURE (a & Prims.int)
(declare-fun Tm_arrow_fda292a92c7f1f4361c5b517ce8c38ce () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_return_elab@tok () Term)


(declare-fun Tm_abs_6776a8bc12d8ad7020652326f816a749 (Term Term) Term)

; </end encoding let _dm4f_STINT_return_elab>


; <Start encoding let _dm4f_STINT_bind_wp>


;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type
(declare-fun Tm_arrow_7853a2edc32b257911d17159b1a77431 (Term) Term)


;;;;;;;;;;;;;;;;_: a -> _: Prims.int -> _: (_: b & Prims.int -> Type) -> Type
(declare-fun Tm_arrow_a698e5ca6b83af02e23d2cbc2515c16d (Term Term) Term)

(declare-fun FStar.DM4F.IntST._dm4f_STINT_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) ->     g: (_: a -> _: Prims.int -> _: (_: b & Prims.int -> Type) -> Type) ->     s0: Prims.int ->     p'': (_: b & Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_2095b2dcd6bad09458fac1a46130c5e0 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_bind_wp@tok () Term)
...
(declare-fun Tm_abs_80d56cc94151becbf9344bd3117a3bb5 (Term Term Term) Term)

; </end encoding let _dm4f_STINT_bind_wp>


; <Start encoding let _dm4f_STINT_bind_elab>



(declare-fun Tm_refine_64fe85f0f96d3f9d81437e2379fd0ec2 (Term) Term)

;;;;;;;;;;;;;;;;y: _: (a & Prims.int){Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_68ab07589640cf1f12548ac67de718b3 (Term) Term)
(declare-fun Tm_abs_35d637e6b8a8ab6e372fa966ba9de42b (Term Term) Term)
(declare-fun Tm_refine_111e54b956f3b6404934c58eb3e4fc2a (Term Term Term) Term)



(declare-fun Tm_abs_36b29e33cd5251a4fc38fce1443704ec (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (a & Prims.int)
(declare-fun Tm_arrow_fa36b93540849c7953adc8fe8accc179 (Term Term) Term)
...
(declare-fun Tm_refine_ea8ef14c852dd6f9ba1bb67e3d9e53e2 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (b & Prims.int)
(declare-fun Tm_arrow_682d383ffe7b35ffd4c022de3ec2fdc5 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: Prims.int -> Prims.PURE (b & Prims.int)
(declare-fun Tm_arrow_5aa5e71d993442e3c194176f586d41de (Term Term Term) Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_bind_elab (Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_244519f791604519409cb5f83f96f22f (Term Term Term Term) Term)
(declare-fun Tm_refine_1cf3b8fffc10d7f44ba7f1487eb5a38a (Term Term Term Term Term) Term)





(declare-fun Tm_abs_f31eb6c1bb00450bca7a6309aaa3fb10 (Term Term Term) Term)
;;;;;;;;;;;;;;;;s0__x: Prims.int -> Prims.PURE (b & Prims.int)
(declare-fun Tm_arrow_00948f4888ff0d96e01e175a44a7d790 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f__w: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) ->     f: (_: Prims.int -> Prims.PURE (a & Prims.int)) ->     g__w: (_: a -> _: Prims.int -> _: (_: b & Prims.int -> Type) -> Type) ->     g: (_: a -> _: Prims.int -> Prims.PURE (b & Prims.int)) ->     s0__x: Prims.int   -> Prims.PURE (b & Prims.int)
(declare-fun Tm_arrow_f740398799d916d09d39b5ebe77731cd () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_bind_elab@tok () Term)
...
(declare-fun Tm_abs_82bf8ff247b65f581bcfd1d5bcb7be4f (Term Term) Term)

; </end encoding let _dm4f_STINT_bind_elab>


; <Start encoding let _dm4f_STINT___proj__STINT__item__get_elab>

(declare-fun FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab (Term) Term)
(declare-fun Tm_refine_0c58db28f9b346702a52f92cd7941fff (Term) Term)
;;;;;;;;;;;;;;;;s0__x: Prims.int -> Prims.PURE (Prims.int & Prims.int)
(declare-fun Tm_arrow_ce687f3723a179ebd24369355f1010cf () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> s0__x: Prims.int -> Prims.PURE (Prims.int & Prims.int)
(declare-fun Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab@tok () Term)


(declare-fun Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61 () Term)

; </end encoding let _dm4f_STINT___proj__STINT__item__get_elab>


; <Start encoding let _dm4f_STINT___proj__STINT__item__get_complete_type>

(declare-fun FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_complete_type () Term)




; </end encoding let _dm4f_STINT___proj__STINT__item__get_complete_type>


; <Start encoding let _dm4f_STINT___proj__STINT__item__put_elab>

(declare-fun FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab (Term) Term)
(declare-fun Tm_refine_a7635122d129405918ff6301b4fd477f (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (Prims.unit & Prims.int)
(declare-fun Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7 (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> _: Prims.int -> Prims.PURE (Prims.unit & Prims.int)
(declare-fun Tm_arrow_29d32c61cfd0bab4e81eb50a22004243 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab@tok () Term)


(declare-fun Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c (Term) Term)

; </end encoding let _dm4f_STINT___proj__STINT__item__put_elab>


; <Start encoding let _dm4f_STINT___proj__STINT__item__put_complete_type>

(declare-fun FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_complete_type () Term)




; </end encoding let _dm4f_STINT___proj__STINT__item__put_complete_type>


; <Start encoding let _dm4f_STINT_repr>



(declare-fun FStar.DM4F.IntST._dm4f_STINT_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp_a: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) -> Type
(declare-fun Tm_arrow_18da0f66d702e97d211faa2a34dfc393 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_repr@tok () Term)
...
; </end encoding let _dm4f_STINT_repr>


; <Start encoding let _dm4f_STINT_pre>

(declare-fun FStar.DM4F.IntST._dm4f_STINT_pre () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Type
(declare-fun Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2 () Term)

; </end encoding let _dm4f_STINT_pre>


; <Start encoding let _dm4f_STINT_post>

(declare-fun FStar.DM4F.IntST._dm4f_STINT_post (Term) Term)

(declare-fun FStar.DM4F.IntST._dm4f_STINT_post@tok () Term)


; </end encoding let _dm4f_STINT_post>


; <Start encoding let _dm4f_STINT_wp>

(declare-fun FStar.DM4F.IntST._dm4f_STINT_wp (Term) Term)

(declare-fun FStar.DM4F.IntST._dm4f_STINT_wp@tok () Term)



; </end encoding let _dm4f_STINT_wp>


; <Start encoding let _dm4f_STINT_ctx>

(declare-fun FStar.DM4F.IntST._dm4f_STINT_ctx (Term Term) Term)

(declare-fun FStar.DM4F.IntST._dm4f_STINT_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: a & Prims.int -> Type) -> t
(declare-fun Tm_arrow_b1f24f05cf2f2d075bed67bff7ce091d (Term Term) Term)

; </end encoding let _dm4f_STINT_ctx>


; <Start encoding let _dm4f_STINT_gctx>

(declare-fun FStar.DM4F.IntST._dm4f_STINT_gctx (Term Term) Term)

(declare-fun FStar.DM4F.IntST._dm4f_STINT_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot t
(declare-fun Tm_ghost_arrow_abd73df8628a8d3da3540846485370ec (Term Term) Term)

; </end encoding let _dm4f_STINT_gctx>


; <Start encoding let _dm4f_STINT_pure>


(declare-fun FStar.DM4F.IntST._dm4f_STINT_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: Prims.int -> _: (_: a & Prims.int -> Type) -> t
(declare-fun Tm_arrow_c01d9ef401764834e93ca0c8bda76e05 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_pure@tok () Term)


; </end encoding let _dm4f_STINT_pure>


; <Start encoding let _dm4f_STINT_app>



;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_5f7840f852984faba2535d0b9ad6635c (Term Term Term) Term)



(declare-fun FStar.DM4F.IntST._dm4f_STINT_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot t1) ->     _: Prims.int ->     _: (_: a & Prims.int -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_a379ed9eb1692e8e25a29669bafac000 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_app@tok () Term)
...
; </end encoding let _dm4f_STINT_app>


; <Start encoding let _dm4f_STINT_lift1>




(declare-fun FStar.DM4F.IntST._dm4f_STINT_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot t1) ->     _: Prims.int ->     _: (_: a & Prims.int -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_07fb4d1f3e97dbf369ba378fdead3455 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_lift1@tok () Term)
...
(declare-fun Tm_abs_be54b962dda3c58c29366dee794bcfc3 (Term Term Term Term) Term)

; </end encoding let _dm4f_STINT_lift1>


; <Start encoding let _dm4f_STINT_lift2>
...
(declare-fun FStar.DM4F.IntST._dm4f_STINT_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot t1) ->     a2: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot t2) ->     _: Prims.int ->     _: (_: a & Prims.int -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_705e8a728382522e2305ff2cc88b9d1f () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_lift2@tok () Term)
...
(declare-fun Tm_abs_c9b35439b8d49482e712b0c13e6d583d (Term Term Term Term Term) Term)

; </end encoding let _dm4f_STINT_lift2>


; <Start encoding let _dm4f_STINT_push>



;;;;;;;;;;;;;;;;_: t1 -> _: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot t2
(declare-fun Tm_arrow_0195ea58d73416f25c6041915d87d273 (Term Term Term) Term)

(declare-fun FStar.DM4F.IntST._dm4f_STINT_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f: (_: t1 -> _: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot t2) ->     _: Prims.int ->     _: (_: a & Prims.int -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_d6d734c7ad54a1ad2a799a31b15a3b51 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_push@tok () Term)





; </end encoding let _dm4f_STINT_push>


; <Start encoding let _dm4f_STINT_wp_if_then_else>

(declare-fun FStar.DM4F.IntST._dm4f_STINT_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) ->     _: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) ->     _: Prims.int ->     _: (_: a & Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_c8894c9e98fa17118ed8b388a0edd77f (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) ->     _: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) ->     _: Prims.int ->     _: (_: a & Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_39eb991fcf66eb1fc628a46efef2f88e () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_ea99e1943f3f982a6a66765948635037 (Term) Term)
...
;;;;;;;;;;;;;;;;a1: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot Prims.logical) ->     a2: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.GTot Prims.logical) ->     _: Prims.int ->     _: (_: a & Prims.int -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_c5d9275d7bbf41678ec43a4bdb487fa9 (Term) Term)
(declare-fun Tm_abs_f5e1f7ab7ef1731ad18a0f486d354efa (Term Term) Term)

; </end encoding let _dm4f_STINT_wp_if_then_else>


; <Start encoding let _dm4f_STINT_wp_close>




(declare-fun FStar.DM4F.IntST._dm4f_STINT_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: b -> _: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) ->     _: Prims.int ->     _: (_: a & Prims.int -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_73d51e7a440174e6c6fe53f5e8f0538c () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_wp_close@tok () Term)
...
(declare-fun Tm_abs_8a5b7c18de91e97848256af1abbb0278 (Term Term Term) Term)

; </end encoding let _dm4f_STINT_wp_close>


; <Start encoding let _dm4f_STINT_stronger>





(declare-fun FStar.DM4F.IntST._dm4f_STINT_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) ->     wp2: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_1691aabc1798136030f9a87fb3635e38 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_stronger@tok () Term)
...
; </end encoding let _dm4f_STINT_stronger>


; <Start encoding let _dm4f_STINT_ite_wp>




(declare-fun FStar.DM4F.IntST._dm4f_STINT_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) ->     _: Prims.int ->     _: (_: a & Prims.int -> Type)   -> Prims.logical
(declare-fun Tm_arrow_6c8774f3c6bae5796558c14d8bd944b3 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_ite_wp@tok () Term)





; </end encoding let _dm4f_STINT_ite_wp>


; <Start encoding let _dm4f_STINT_null_wp>


(declare-fun FStar.DM4F.IntST._dm4f_STINT_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> _: Prims.int -> _: (_: a & Prims.int -> Type) -> Prims.logical
(declare-fun Tm_arrow_6172c25210a65a9e57e35b3f8acd37e5 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_null_wp@tok () Term)


; </end encoding let _dm4f_STINT_null_wp>


; <Start encoding let _dm4f_STINT_wp_trivial>



(declare-fun FStar.DM4F.IntST._dm4f_STINT_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: (_: Prims.int -> _: (_: a & Prims.int -> Type) -> Type) -> Prims.logical
(declare-fun Tm_arrow_6706accb548a4ba51066165cd9d39b62 () Term)
(declare-fun FStar.DM4F.IntST._dm4f_STINT_wp_trivial@tok () Term)




; </end encoding let _dm4f_STINT_wp_trivial>


; <Start encoding new_effect_for_free { STINT ... }>





(declare-fun Tm_abs_cc18103f7e8a41ead5051007b34f3b4b () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntST.__proj__STINT__item__get (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntST.__proj__STINT__item__get@tok () Term)




(declare-fun Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IntST.__proj__STINT__item__put (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IntST.__proj__STINT__item__put@tok () Term)

; </end encoding new_effect_for_free { STINT ... }>


; <Skipped sub_effect PURE ~> STINT/>
...
(declare-fun FStar.DM4F.IntST.repr (Term Term) Term)



(declare-fun FStar.DM4F.IntST.repr@tok () Term)
...
(declare-fun FStar.DM4F.IntST.post (Term) Term)

(declare-fun FStar.DM4F.IntST.post@tok () Term)
...
(declare-fun FStar.DM4F.IntST.pre () Term)
...
(declare-fun FStar.DM4F.IntST.wp (Term) Term)

(declare-fun FStar.DM4F.IntST.wp@tok () Term)
...
(declare-fun FStar.DM4F.IntST.get (Term) Term)
(declare-fun Non_total_Tm_arrow_4c9836e1931ff6d36e007fd5b26c1b20 () Term)
(declare-fun FStar.DM4F.IntST.get@tok () Term)
...
(declare-fun FStar.DM4F.IntST.put (Term) Term)
(declare-fun Non_total_Tm_arrow_f545c818f88f03704e39c101b26df1e4 () Term)
(declare-fun FStar.DM4F.IntST.put@tok () Term)
...
; <Start encoding let lift_pure_stint>

(declare-fun FStar.DM4F.IntST.lift_pure_stint (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> wp: Prims.pure_wp a -> n: Prims.int -> p: post a -> Prims.pure_pre
(declare-fun Tm_arrow_bed296587e6e1889de6dd47f66df8f13 () Term)
(declare-fun FStar.DM4F.IntST.lift_pure_stint@tok () Term)



; </end encoding let lift_pure_stint>


; <Skipped sub_effect PURE ~> STINT/>


; <Skipped effect StInt a pre post = FStar.DM4F.IntST.STINT a/>


; <Skipped effect StNull a = FStar.DM4F.IntST.STINT a/>


; <Skipped val FStar.DM4F.IntST.incr_intrinsic/>


; <Start encoding let incr_intrinsic>

(declare-fun FStar.DM4F.IntST.incr_intrinsic (Term) Term)
(declare-fun Non_total_Tm_arrow_2e70870eea8ae0718014651851f68bc9 () Term)
(declare-fun FStar.DM4F.IntST.incr_intrinsic@tok () Term)
(declare-fun Tm_refine_9703cdf5be9a3734b4883d43d7171a27 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (Prims.unit & Prims.int)
(declare-fun Tm_arrow_1d83556974358bd676762706160c7dcc () Term)

; </end encoding let incr_intrinsic>
...
(declare-fun FStar.DM4F.IntST.incr_intrinsic_ (Term) Term)
(declare-fun Non_total_Tm_arrow_df45b40a4cef86e8d9cdbd5d90f7b209 () Term)
(declare-fun FStar.DM4F.IntST.incr_intrinsic_@tok () Term)
(declare-fun Tm_refine_a19a1b56165513e485d067d8190bf904 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (Prims.unit & Prims.int)
(declare-fun Tm_arrow_ed553eec04b9b30ffc3e20a2d0aa350e () Term)

; </end encoding let incr_intrinsic'>


; <Skipped val FStar.DM4F.IntST.incr/>


; <Start encoding let incr>

(declare-fun FStar.DM4F.IntST.incr (Term) Term)
(declare-fun Non_total_Tm_arrow_7a5a810a792c07fe3ae71785807dd4c4 () Term)
(declare-fun FStar.DM4F.IntST.incr@tok () Term)
(declare-fun Tm_refine_24d1edd7919b87d4b2510e0fdfa32d2d () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (Prims.unit & Prims.int)
(declare-fun Tm_arrow_b996639e5552f46d555b60a2e4f57108 () Term)

; </end encoding let incr>


; <Start encoding let incr_increases>

(declare-fun FStar.DM4F.IntST.incr_increases (Term) Term)

(declare-fun FStar.DM4F.IntST.incr_increases@tok () Term)

; </end encoding let incr_increases>


; <Start encoding let decr>

(declare-fun FStar.DM4F.IntST.decr (Term) Term)

(declare-fun FStar.DM4F.IntST.decr@tok () Term)
...
; <Start encoding let ifc>

(declare-fun FStar.DM4F.IntST.ifc (Term) Term)
(declare-fun Non_total_Tm_arrow_c6d64180e4a1859ba43341c6950e7296 () Term)
(declare-fun FStar.DM4F.IntST.ifc@tok () Term)
(declare-fun Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563 () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (Prims.int & Prims.int)
(declare-fun Tm_arrow_2f0ea550a9a01b08d152bef225faf73e () Term)
(declare-fun Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e () Term)
(declare-fun Tm_abs_cd4af824bd65da4276f069890c42565c () Term)

; </end encoding let ifc>


; <Start encoding let ni_ifc>

(declare-fun FStar.DM4F.IntST.ni_ifc (Dummy_sort) Term)

; </end encoding let ni_ifc>


; <Skipped val FStar.DM4F.IntST.action_get/>


; <Start encoding let action_get>

(declare-fun FStar.DM4F.IntST.action_get (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int & Prims.int -> Type
(declare-fun Tm_arrow_3e8b49f14488374d63bce57fd67fc3b4 () Term)

;;;;;;;;;;;;;;;;n: Prims.int -> post: (_: Prims.int & Prims.int -> Type) -> Type
(declare-fun Tm_arrow_ddb7f95458a4116148f38278d50b3b8f () Term)
(declare-fun Tm_abs_5a9b2eb4aa1a06829eeb53225933a1e3 () Term)
;;;;;;;;;;;;;;;;u4423: Prims.unit -> repr Prims.int (fun n post -> post (n, n))
(declare-fun Tm_arrow_4e30629545985f33af0377b7e6d4968b () Term)
(declare-fun FStar.DM4F.IntST.action_get@tok () Term)
...
; </end encoding let action_get>


; <Skipped val FStar.DM4F.IntST.action_put/>


; <Start encoding let action_put>

(declare-fun FStar.DM4F.IntST.action_put (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit & Prims.int -> Type
(declare-fun Tm_arrow_28dd1f036957bc0521c95a6bb2bc313e () Term)

;;;;;;;;;;;;;;;;n: Prims.int -> post: (_: Prims.unit & Prims.int -> Type) -> Type
(declare-fun Tm_arrow_1f1238a213790f3f0afba4d635b3376c () Term)
(declare-fun Tm_abs_363e28fa927c2b9574c7ad7581d13f33 (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> repr Prims.unit (fun _ post -> post ((), x))
(declare-fun Tm_arrow_dff2e6e1f2dcf6d81a3c144c43e7da92 () Term)
(declare-fun FStar.DM4F.IntST.action_put@tok () Term)
...
; </end encoding let action_put>


; <Skipped val FStar.DM4F.IntST.get'/>


; <Start encoding let get'>

(declare-fun FStar.DM4F.IntST.get_ (Term) Term)

(declare-fun FStar.DM4F.IntST.get_@tok () Term)
...
; <Skipped val FStar.DM4F.IntST.put'/>


; <Start encoding let put'>

(declare-fun FStar.DM4F.IntST.put_ (Term) Term)

(declare-fun FStar.DM4F.IntST.put_@tok () Term)
...
; <Start encoding let assert_after_reify>

(declare-fun FStar.DM4F.IntST.assert_after_reify (Term) Term)

(declare-fun FStar.DM4F.IntST.assert_after_reify@tok () Term)


(declare-fun Tm_abs_06da55c274aa7f4b1e9afda72fa49813 (Term) Term)

; </end encoding let assert_after_reify>


; <Skipped val FStar.DM4F.IntST.assert_after_reflect/>


; <Start encoding let assert_after_reflect>

(declare-fun FStar.DM4F.IntST.assert_after_reflect (Term) Term)
(declare-fun Non_total_Tm_arrow_c5850256e15726da05f2e5a16d70c9bc () Term)
(declare-fun FStar.DM4F.IntST.assert_after_reflect@tok () Term)



; </end encoding let assert_after_reflect>


; <Skipped val FStar.DM4F.IntST.reflect_on_the_fly/>


; <Start encoding let reflect_on_the_fly>

(declare-fun FStar.DM4F.IntST.reflect_on_the_fly (Term) Term)

(declare-fun FStar.DM4F.IntST.reflect_on_the_fly@tok () Term)



; </end encoding let reflect_on_the_fly>


; <Start encoding val FStar.DM4F.IntST.refine_st>


;;;;;;;;;;;;;;;;_: a -> _: Prims.int -> Type
(declare-fun Tm_arrow_28cb490ddce9081249876a97abea3031 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> _: b -> _: Prims.int -> Type
(declare-fun Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13 (Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: Prims.int -> _: b -> _: Prims.int -> Type
(declare-fun Tm_arrow_b8742cb779dae441c1980f30dc033e62 (Term Term) Term)




(declare-fun Non_total_Tm_arrow_fc5a94b9b334bfa13cd4789208877f69 (Term Term Term Term) Term)
(declare-fun FStar.DM4F.IntST.refine_st (Term Term Term Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_c60c544b5c8719162f47d32da5e2cca8 () Term)
(declare-fun FStar.DM4F.IntST.refine_st@tok () Term)
(declare-fun Tm_refine_0183c3a25d8feca88dc327cadcb01d57 (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (b & Prims.int)
(declare-fun Tm_arrow_74e6b22e391c8bcad9f4225c59ac12d8 (Term Term Term Term Term) Term)

; </end encoding val FStar.DM4F.IntST.refine_st>


; <Skipped val FStar.DM4F.IntST.incr_pre_post/>


; <Start encoding let incr_pre_post>

(declare-fun FStar.DM4F.IntST.incr_pre_post (Term) Term)
(declare-fun Non_total_Tm_arrow_1ab1a45aa6823088e0400b3204cdc095 () Term)
(declare-fun FStar.DM4F.IntST.incr_pre_post@tok () Term)
(declare-fun Tm_refine_0a4f80f177fa4d46c010180a0a037f8f () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (Prims.unit & Prims.int)
(declare-fun Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53 () Term)

; </end encoding let incr_pre_post>


; <Start encoding let refine_st_incr_test>

(declare-fun FStar.DM4F.IntST.refine_st_incr_test (Term) Term)

(declare-fun FStar.DM4F.IntST.refine_st_incr_test@tok () Term)


;;;;;;;;;;;;;;;;u5813: Prims.unit -> _: Prims.int -> Type
(declare-fun Tm_arrow_4e506f1292c04c2736703495147ca70a () Term)
(declare-fun Tm_abs_3e65fe516ff4329c112377c019383211 () Term)
;;;;;;;;;;;;;;;;u5823: Prims.unit -> _: Prims.int -> _: Prims.unit -> _: Prims.int -> Type
(declare-fun Tm_arrow_783cb7c204744ea014540f0cab502371 () Term)
(declare-fun Tm_abs_4e02216365c3d4d153cb0c5ab890790c () Term)

; </end encoding let refine_st_incr_test>


; End Externals for module FStar.DM4F.IntST

(push) ;; push{1

; Internals for FStar.DM4F.ExnSt
...
(declare-fun FStar.DM4F.ExnSt.exnst (Term) Term)

(declare-fun FStar.DM4F.ExnSt.exnst@tok () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.M (FStar.Pervasives.Native.option (a & Prims.int))
(declare-fun Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494 (Term) Term)

; </end encoding let exnst>


; encoding sigelt val FStar.DM4F.ExnSt.return


; <Skipped val FStar.DM4F.ExnSt.return/>
...
(declare-fun FStar.DM4F.ExnSt.return (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> exnst a
(declare-fun Tm_arrow_27df58a246f6a105b20f5e26e7e14b1d () Term)
(declare-fun FStar.DM4F.ExnSt.return@tok () Term)
(declare-fun Tm_abs_803417f303216df6eef6c72a07f79e19 (Term Term) Term)

; </end encoding let return>


; encoding sigelt val FStar.DM4F.ExnSt.bind


; <Skipped val FStar.DM4F.ExnSt.bind/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.ExnSt.exnst; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,4-28,9); use=FStar.DM4F.ExnSt.fst(28,4-28,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.ExnSt.exnst @x0)
Tm_type))
 

:pattern ((FStar.DM4F.ExnSt.exnst @x0))
:qid typing_FStar.DM4F.ExnSt.exnst))

:named typing_FStar.DM4F.ExnSt.exnst))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563
Tm_type)
:named refinement_kinding_Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntST.incr; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_refine_24d1edd7919b87d4b2510e0fdfa32d2d
Tm_type)
:named refinement_kinding_Tm_refine_24d1edd7919b87d4b2510e0fdfa32d2d))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntST.incr_pre_post; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_refine_0a4f80f177fa4d46c010180a0a037f8f
Tm_type)
:named refinement_kinding_Tm_refine_0a4f80f177fa4d46c010180a0a037f8f))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563)
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ST.fst(27,34-27,41)
(not 
;; def=FStar.DM4F.IntST.fst(54,50-54,75); use=FStar.DM4F.IntST.fst(89,20-89,26)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))

;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ST.fst(27,34-27,41)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ST.fst(27,34-27,41)
(= @x2
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563.1))
)
))
...
@x1
Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563))
:qid refinement_interpretation_Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563))

:named refinement_interpretation_Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_24d1edd7919b87d4b2510e0fdfa32d2d)
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ST.fst(27,34-27,41)
(not 
;; def=FStar.DM4F.IntST.fst(54,50-54,75); use=FStar.DM4F.IntST.fst(76,4-76,8)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))
...
;;no pats
:qid refinement_interpretation_Tm_refine_24d1edd7919b87d4b2510e0fdfa32d2d.1))
)
))
...
@x1
Tm_refine_24d1edd7919b87d4b2510e0fdfa32d2d))
:qid refinement_interpretation_Tm_refine_24d1edd7919b87d4b2510e0fdfa32d2d))

:named refinement_interpretation_Tm_refine_24d1edd7919b87d4b2510e0fdfa32d2d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.IntST.incr_pre_post; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_0a4f80f177fa4d46c010180a0a037f8f)
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ST.fst(27,34-27,41)
(not 
;; def=FStar.DM4F.IntST.fst(49,23-50,63); use=FStar.DM4F.IntST.fst(176,4-176,17)
...
;;no pats
:qid refinement_interpretation_Tm_refine_0a4f80f177fa4d46c010180a0a037f8f.1))
)
))
...
@x1
Tm_refine_0a4f80f177fa4d46c010180a0a037f8f))
:qid refinement_interpretation_Tm_refine_0a4f80f177fa4d46c010180a0a037f8f))

:named refinement_interpretation_Tm_refine_0a4f80f177fa4d46c010180a0a037f8f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494
;;; Fact-ids: Name FStar.DM4F.ExnSt.exnst; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,14-28,41); use=FStar.DM4F.ExnSt.fst(28,14-28,41)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494 @x0)
Tm_type))
:qid kinding_Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494))

:named kinding_Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! (iff (Valid (Prims.hasEq Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))))
:named haseqTm_refine_5cb9baf456c638b9dd0f9af1eaa1a563))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_24d1edd7919b87d4b2510e0fdfa32d2d
;;; Fact-ids: Name FStar.DM4F.IntST.incr; Namespace FStar.DM4F.IntST
(assert (! (iff (Valid (Prims.hasEq Tm_refine_24d1edd7919b87d4b2510e0fdfa32d2d))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))))
:named haseqTm_refine_24d1edd7919b87d4b2510e0fdfa32d2d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0a4f80f177fa4d46c010180a0a037f8f
;;; Fact-ids: Name FStar.DM4F.IntST.incr_pre_post; Namespace FStar.DM4F.IntST
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0a4f80f177fa4d46c010180a0a037f8f))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))))
:named haseqTm_refine_0a4f80f177fa4d46c010180a0a037f8f))
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.ExnSt.exnst
;;; Fact-ids: Name FStar.DM4F.ExnSt.exnst; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,4-28,9); use=FStar.DM4F.ExnSt.fst(28,4-28,9)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.ExnSt.exnst @x0)
(Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494 @x0))
 

:pattern ((FStar.DM4F.ExnSt.exnst @x0))
:qid equation_FStar.DM4F.ExnSt.exnst))

:named equation_FStar.DM4F.ExnSt.exnst))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494 @x2)))
:qid FStar.DM4F.ExnSt_pre_typing_Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494))

:named FStar.DM4F.ExnSt_pre_typing_Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494
;;; Fact-ids: Name FStar.DM4F.ExnSt.exnst; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,14-28,41); use=FStar.DM4F.ExnSt.fst(28,14-28,41)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494 @x1))
(and 
;; def=FStar.DM4F.ExnSt.fst(28,14-28,41); use=FStar.DM4F.ExnSt.fst(28,14-28,41)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494 @x1)))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494))

:named FStar.DM4F.ExnSt_interpretation_Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494))
(push) ;; push{2

; Starting query at FStar.DM4F.ExnSt.fst(37,11-41,32)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;g: a -> exnst b
(declare-fun Tm_arrow_694a7bfd307055c0dc5a39ea35144d10 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_694a7bfd307055c0dc5a39ea35144d10
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(35,34-36,10); use=FStar.DM4F.ExnSt.fst(36,4-36,10)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_694a7bfd307055c0dc5a39ea35144d10 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_694a7bfd307055c0dc5a39ea35144d10 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_694a7bfd307055c0dc5a39ea35144d10))

:named kinding_Tm_arrow_694a7bfd307055c0dc5a39ea35144d10))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(35,34-36,10); use=FStar.DM4F.ExnSt.fst(36,4-36,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_694a7bfd307055c0dc5a39ea35144d10 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_694a7bfd307055c0dc5a39ea35144d10 @x2
@x3)))
:qid FStar.DM4F.ExnSt_pre_typing_Tm_arrow_694a7bfd307055c0dc5a39ea35144d10))

:named FStar.DM4F.ExnSt_pre_typing_Tm_arrow_694a7bfd307055c0dc5a39ea35144d10))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_694a7bfd307055c0dc5a39ea35144d10
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(35,34-36,10); use=FStar.DM4F.ExnSt.fst(36,4-36,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_694a7bfd307055c0dc5a39ea35144d10 @x1
@x2))
(and 
;; def=FStar.DM4F.ExnSt.fst(35,34-36,10); use=FStar.DM4F.ExnSt.fst(36,4-36,10)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(FStar.DM4F.ExnSt.exnst @x1)))
 

:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_694a7bfd307055c0dc5a39ea35144d10.1))
...
(Tm_arrow_694a7bfd307055c0dc5a39ea35144d10 @x1
@x2)))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_694a7bfd307055c0dc5a39ea35144d10))

:named FStar.DM4F.ExnSt_interpretation_Tm_arrow_694a7bfd307055c0dc5a39ea35144d10))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (f: FStar.DM4F.ExnSt.exnst a)
;   (g: (g: a -> FStar.DM4F.ExnSt.exnst b))
;   (s0: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post (FStar.Pervasives.Native.option (b & Prims.int))).
;     (forall (x: FStar.Pervasives.Native.option (b & Prims.int)). {:pattern Prims.guard_free (k x)}
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.ExnSt.fst(37,11-41,32)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.ExnSt.fst(37,11-41,32)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.ExnSt.fst(37,11-41,32)
(ApplyTT @x5
@x6)
...
;; def=FStar.DM4F.ExnSt.fst(38,8-38,11); use=FStar.DM4F.ExnSt.fst(39,10-39,13)
(not 
;; def=FStar.DM4F.ExnSt.fst(38,8-38,11); use=FStar.DM4F.ExnSt.fst(39,10-39,13)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.ExnSt.bind, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.ExnSt_interpretation_Tm_arrow_9a0e9e3b0543e9a5bbf1ca7aaaab2494, equation_FStar.DM4F.ExnSt.exnst, equation_Prims.eqtype, int_inversion, kinding_FStar.Pervasives.Native.tuple2@tok, lemma_FStar.Pervasives.invertOption, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
;;;;;;;;;;;;;;;;g: a -> exnst b
(declare-fun Tm_arrow_694a7bfd307055c0dc5a39ea35144d10 (Term Term) Term)
(declare-fun FStar.DM4F.ExnSt.bind (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> f: exnst a -> g: (g: a -> exnst b) -> exnst b
(declare-fun Tm_arrow_9aef8e5af7a589bde9d270d8dcffde5b () Term)
(declare-fun FStar.DM4F.ExnSt.bind@tok () Term)

(declare-fun Tm_abs_0defff67c1434cc98f382ce434b34aea (Term Term Term) Term)
...
(declare-fun FStar.DM4F.ExnSt.raise (Term) Term)
;;;;;;;;;;;;;;;;a: Type -> exnst a
(declare-fun Tm_arrow_091c8f2ee50aeb537e4c06dc64837cd8 () Term)
(declare-fun FStar.DM4F.ExnSt.raise@tok () Term)
(declare-fun Tm_abs_15d1a1024d0dd12a02ff74be4fbf3dc0 (Term) Term)

; </end encoding let raise>


; encoding sigelt let _dm4f_EXNST_lift_from_pure


; <Start encoding let _dm4f_EXNST_lift_from_pure>



;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option (a & Prims.int) -> Type
(declare-fun Tm_arrow_bfd05765df95b56171bbe616030d5b1a (Term) Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     s: Prims.int ->     p': (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_bf5d35d9e9c782ca787993322f352e0e () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_lift_from_pure@tok () Term)




(declare-fun Tm_abs_0e9d3e198b4136ccafdcabadcd2214f1 (Term Term Term) Term)

; </end encoding let _dm4f_EXNST_lift_from_pure>


; encoding sigelt let _dm4f_EXNST_return_wp


; <Start encoding let _dm4f_EXNST_return_wp>


(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> s: Prims.int -> p': (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_39160e948f0437ab0f4d9f7ea474a2b5 () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_return_wp@tok () Term)


; </end encoding let _dm4f_EXNST_return_wp>


; encoding sigelt let _dm4f_EXNST_return_elab


; <Start encoding let _dm4f_EXNST_return_elab>

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_return_elab (Term Term Term) Term)
(declare-fun Tm_refine_bdc9bee04c38c3337a06704c23e89b2e (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> s: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option (a & Prims.int))
(declare-fun Tm_arrow_45ffe9dd58213c254a331f8da6d63dfc () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_return_elab@tok () Term)


; </end encoding let _dm4f_EXNST_return_elab>


; encoding sigelt let _dm4f_EXNST_bind_wp


; <Start encoding let _dm4f_EXNST_bind_wp>


;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type
(declare-fun Tm_arrow_977d3954183195b32a8bf92c5d8450db (Term) Term)


;;;;;;;;;;;;;;;;g: a -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option (b & Prims.int) -> Type) -> Type
(declare-fun Tm_arrow_082635c4d5140df86553538d086f38ba (Term Term) Term)

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type) ->     g:       (g: a -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option (b & Prims.int) -> Type)           -> Type) ->     s0: Prims.int ->     p'': (_: FStar.Pervasives.Native.option (b & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_a4f0e4a824b50d946fc3364437fb3f4d () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_bind_wp@tok () Term)
...
(declare-fun Tm_abs_e0a3b9cc3e3b75b7a372e104710f403d (Term Term Term Term) Term)

; </end encoding let _dm4f_EXNST_bind_wp>


; encoding sigelt let _dm4f_EXNST_bind_elab


; <Start encoding let _dm4f_EXNST_bind_elab>



(declare-fun Tm_refine_04e8763990d12863a29e399dc5f5a073 (Term) Term)

;;;;;;;;;;;;;;;;y: _: FStar.Pervasives.Native.option (a & Prims.int) {Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_0ebe2983ad833320950a6c800becec57 (Term) Term)
(declare-fun Tm_abs_5ca5ee7346242d8f8fbb6a8083c85039 (Term Term) Term)
(declare-fun Tm_refine_f6e1dfe58aedec7dea841e2d992373a3 (Term Term Term) Term)



(declare-fun Tm_abs_eb6055b3901560ff950e7bf2ba3ae6e4 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option (a & Prims.int))
(declare-fun Tm_arrow_4a93b7c13e1ec01a9d0f9a71f36bd92b (Term Term) Term)
...
(declare-fun Tm_refine_9319fb97444582a8c0578fb7b4a8354f (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option (b & Prims.int))
(declare-fun Tm_arrow_c1c551100dc80ba3841e00092d8f6d24 (Term Term Term) Term)
;;;;;;;;;;;;;;;;g__x: a -> _: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option (b & Prims.int))
(declare-fun Tm_arrow_5c76682647e71641379f0522f58cb58e (Term Term Term) Term)





(declare-fun Tm_abs_11d061159ceca266d4981bb413155b7d (Term Term Term) Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_bind_elab (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_dec2392088ce4dc806e9ddf47b544621 (Term Term Term Term) Term)
(declare-fun Tm_refine_2baaf20f17c25c46117f54c9431931a8 (Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f__w: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type) ->     f: (_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option (a & Prims.int))) ->     g__w:       (g: a -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option (b & Prims.int) -> Type)           -> Type) ->     g: (g__x: a -> _: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option (b & Prims.int))) ->     s0: Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option (b & Prims.int))
(declare-fun Tm_arrow_96c47aaf113cffe775694ec10f20f30c () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_bind_elab@tok () Term)
...
; </end encoding let _dm4f_EXNST_bind_elab>


; encoding sigelt let _dm4f_EXNST___proj__EXNST__item__raise_elab


; <Start encoding let _dm4f_EXNST___proj__EXNST__item__raise_elab>

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab (Term) Term)
(declare-fun Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option (a & Prims.int))
(declare-fun Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1 (Term) Term)
;;;;;;;;;;;;;;;;a: Type -> _: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option (a & Prims.int))
(declare-fun Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5 () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab@tok () Term)




; </end encoding let _dm4f_EXNST___proj__EXNST__item__raise_elab>


; encoding sigelt let _dm4f_EXNST___proj__EXNST__item__raise_complete_type


; <Start encoding let _dm4f_EXNST___proj__EXNST__item__raise_complete_type>

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_complete_type () Term)




; </end encoding let _dm4f_EXNST___proj__EXNST__item__raise_complete_type>


; encoding sigelt let _dm4f_EXNST_repr


; <Start encoding let _dm4f_EXNST_repr>



(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp_a: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type)   -> Type
(declare-fun Tm_arrow_4dd67d6f111829a9e62854a49c2fc074 () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_repr@tok () Term)
...
; </end encoding let _dm4f_EXNST_repr>


; encoding sigelt let _dm4f_EXNST_pre


; <Start encoding let _dm4f_EXNST_pre>

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_pre () Term)


; </end encoding let _dm4f_EXNST_pre>


; encoding sigelt let _dm4f_EXNST_post


; <Start encoding let _dm4f_EXNST_post>

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_post (Term) Term)

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_post@tok () Term)


; </end encoding let _dm4f_EXNST_post>


; encoding sigelt let _dm4f_EXNST_wp


; <Start encoding let _dm4f_EXNST_wp>

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_wp (Term) Term)

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_wp@tok () Term)



; </end encoding let _dm4f_EXNST_wp>


; encoding sigelt let _dm4f_EXNST_ctx


; <Start encoding let _dm4f_EXNST_ctx>

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_ctx (Term Term) Term)

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> t
(declare-fun Tm_arrow_2297512360fc2ee6f87f756f6d64494e (Term Term) Term)

; </end encoding let _dm4f_EXNST_ctx>


; encoding sigelt let _dm4f_EXNST_gctx


; <Start encoding let _dm4f_EXNST_gctx>

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_gctx (Term Term) Term)

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Prims.GTot t
(declare-fun Tm_ghost_arrow_1d44bc739354f91ef41e0f214a351420 (Term Term) Term)

; </end encoding let _dm4f_EXNST_gctx>


; encoding sigelt let _dm4f_EXNST_pure


; <Start encoding let _dm4f_EXNST_pure>


(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> t
(declare-fun Tm_arrow_cb954b0f64ba216e23f4a85bb991c54d () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_pure@tok () Term)


; </end encoding let _dm4f_EXNST_pure>


; encoding sigelt let _dm4f_EXNST_app


; <Start encoding let _dm4f_EXNST_app>



;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_1230d3244cbb093d93f97070b9b0d14d (Term Term Term) Term)



(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)           -> Prims.GTot t1) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_20f5309df7f0c5dab0e966a40adc2272 () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_app@tok () Term)
...
; </end encoding let _dm4f_EXNST_app>


; encoding sigelt let _dm4f_EXNST_lift1


; <Start encoding let _dm4f_EXNST_lift1>




(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)           -> Prims.GTot t1) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_5877eb88e96610161f3599e707795225 () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_lift1@tok () Term)
...
(declare-fun Tm_abs_4faf893e7b0bac585216410b359404a9 (Term Term Term Term) Term)

; </end encoding let _dm4f_EXNST_lift1>


; encoding sigelt let _dm4f_EXNST_lift2


; <Start encoding let _dm4f_EXNST_lift2>
...
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)           -> Prims.GTot t1) ->     a2:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)           -> Prims.GTot t2) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_7b3a5b72be26d9c6b1283a6ed651a2bb () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_lift2@tok () Term)
...
(declare-fun Tm_abs_a7d456dd87f6ee53947ad12a0f9329df (Term Term Term Term Term) Term)

; </end encoding let _dm4f_EXNST_lift2>


; encoding sigelt let _dm4f_EXNST_push


; <Start encoding let _dm4f_EXNST_push>



;;;;;;;;;;;;;;;;_: t1 -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_5eddc85b91cd0f7a79e403e520559b15 (Term Term Term) Term)

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f:       (_: t1 -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)           -> Prims.GTot t2) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_11e15666c1813f1424b70f23639fa774 () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_push@tok () Term)





; </end encoding let _dm4f_EXNST_push>


; encoding sigelt let _dm4f_EXNST_wp_if_then_else


; <Start encoding let _dm4f_EXNST_wp_if_then_else>

(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type) ->     _: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_3625febcde2379c1ab78e8efd4196ad8 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type) ->     _: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Type
(declare-fun Tm_arrow_8eb42afadfe1b168798f36e1f1c85a75 () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_d86546b85d4f2952790deafddec60174 (Term) Term)
...
;;;;;;;;;;;;;;;;a1:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)           -> Prims.GTot Prims.logical) ->     a2:       (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)           -> Prims.GTot Prims.logical) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_e687d1a1211617f0007f0d8f9c8e2360 (Term) Term)
(declare-fun Tm_abs_bec31ed08836240de5825844fddad123 (Term Term) Term)

; </end encoding let _dm4f_EXNST_wp_if_then_else>


; encoding sigelt let _dm4f_EXNST_wp_close


; <Start encoding let _dm4f_EXNST_wp_close>




(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f:       (_: b -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)           -> Type) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_8b487930ccc6f25f0b9c38fcabaf4ace () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_wp_close@tok () Term)
...
(declare-fun Tm_abs_64c54d3e1f957e32abed603f0b3b28af (Term Term Term) Term)

; </end encoding let _dm4f_EXNST_wp_close>


; encoding sigelt let _dm4f_EXNST_stronger


; <Start encoding let _dm4f_EXNST_stronger>





(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type) ->     wp2: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_3f93a8b137cacf2f7a4cb82f2f82d92e () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_stronger@tok () Term)
...
; </end encoding let _dm4f_EXNST_stronger>


; encoding sigelt let _dm4f_EXNST_ite_wp


; <Start encoding let _dm4f_EXNST_ite_wp>




(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type) ->     _: Prims.int ->     _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_4884455f19d48f607ab20d70c2180f3f () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_ite_wp@tok () Term)





; </end encoding let _dm4f_EXNST_ite_wp>


; encoding sigelt let _dm4f_EXNST_null_wp


; <Start encoding let _dm4f_EXNST_null_wp>


(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_258502c2c32c1f34c2bf5572efb08ed2 () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_null_wp@tok () Term)


; </end encoding let _dm4f_EXNST_null_wp>


; encoding sigelt let _dm4f_EXNST_wp_trivial


; <Start encoding let _dm4f_EXNST_wp_trivial>



(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option (a & Prims.int) -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_67b4698f0dc32458d87e75b9addd6b3e () Term)
(declare-fun FStar.DM4F.ExnSt._dm4f_EXNST_wp_trivial@tok () Term)




; </end encoding let _dm4f_EXNST_wp_trivial>


; encoding sigelt new_effect_for_free { EXNST ... }


; <Start encoding new_effect_for_free { EXNST ... }>





(declare-fun Tm_abs_00709a744a48249290e9052cc7253072 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.ExnSt.__proj__EXNST__item__raise (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.ExnSt.__proj__EXNST__item__raise@tok () Term)

; </end encoding new_effect_for_free { EXNST ... }>


; encoding sigelt sub_effect PURE ~> EXNST


; <Skipped sub_effect PURE ~> EXNST/>


; encoding sigelt let stint


; <Start encoding let stint>

(declare-fun FStar.DM4F.ExnSt.stint (Term) Term)

(declare-fun FStar.DM4F.ExnSt.stint@tok () Term)

; </end encoding let stint>


; encoding sigelt sub_effect STINT ~> EXNST


; <Skipped sub_effect STINT ~> EXNST/>


; encoding sigelt effect ExnSt a req ens = FStar.DM4F.ExnSt.EXNST a


; <Skipped effect ExnSt a req ens = FStar.DM4F.ExnSt.EXNST a/>


; encoding sigelt effect S a = FStar.DM4F.ExnSt.EXNST a


; <Skipped effect S a = FStar.DM4F.ExnSt.EXNST a/>
...
; Starting query at FStar.DM4F.ExnSt.fst(77,2-79,48)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (i: Prims.nat)
;   (j: Prims.int)
;   (h0: Prims.int)
;   (x: FStar.Pervasives.Native.option (Prims.int & Prims.int)).
;   (*  - Could not prove post-condition
; *)
;   forall (k: Prims.pure_post Type0).
;     (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;     (~(None? x) /\ ~(Some? x) ==> Prims.l_False) /\
;     (~(None? x) ==>
;       (forall (b: Prims.int) (b: Prims.int).
;           x == FStar.Pervasives.Native.Some (b, b) ==> h0 = b /\ j <> 0 ==> j <> 0))


; Context: While encoding a query
; While typechecking the top-level declaration `let div_intrisic_spec`
...
Prims.int)
(HasType @x3
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))))
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.pure_post Tm_type))

;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.ExnSt.fst(77,2-79,48)
(forall ((@x5 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.ExnSt.fst(77,2-79,48)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.ExnSt.fst(77,2-79,48)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.ExnSt.fst(77,2-79,48)
(and (implies 
;; def=FStar.DM4F.ExnSt.fst(76,49-76,50); use=FStar.DM4F.ExnSt.fst(77,8-77,9)
(and 
;; def=FStar.DM4F.ExnSt.fst(76,49-76,50); use=FStar.DM4F.ExnSt.fst(77,8-77,9)
(not 
;; def=FStar.DM4F.ExnSt.fst(76,49-76,50); use=FStar.DM4F.ExnSt.fst(77,8-77,9)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
@x3))
)
...
(not 
;; def=FStar.DM4F.ExnSt.fst(76,49-76,50); use=FStar.DM4F.ExnSt.fst(77,8-77,9)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
@x3))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=FStar.DM4F.ExnSt.fst(77,2-79,48)
(not 
;; def=FStar.DM4F.ExnSt.fst(76,49-76,50); use=FStar.DM4F.ExnSt.fst(77,8-77,9)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.ExnSt.fst(77,2-79,48)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.int)
...
;; def=FStar.DM4F.ExnSt.fst(76,49-79,16); use=FStar.DM4F.ExnSt.fst(77,8-79,16)
(= @x3
(FStar.Pervasives.Native.Some (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
...
;; def=FStar.DM4F.ExnSt.fst(79,20-79,27); use=FStar.DM4F.ExnSt.fst(79,20-79,27)
(= @x2
@x6)


;; def=FStar.DM4F.ExnSt.fst(79,31-79,35); use=FStar.DM4F.ExnSt.fst(79,31-79,35)
(not (= @x1
(BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.ExnSt.fst(79,47-79,48)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.ExnSt.div_intrisic_spec, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, kinding_FStar.Pervasives.Native.tuple2@tok, lemma_FStar.Pervasives.invertOption, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
; encoding sigelt let div_intrisic_spec


; <Start encoding let div_intrisic_spec>

(declare-fun FStar.DM4F.ExnSt.div_intrisic_spec (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;i: Prims.nat ->     j: Prims.int ->     h0: Prims.int ->     x: FStar.Pervasives.Native.option (Prims.int & Prims.int)   -> Type
(declare-fun Tm_arrow_5dc4b46041d01ba4855c65aa80946328 () Term)
(declare-fun FStar.DM4F.ExnSt.div_intrisic_spec@tok () Term)

; </end encoding let div_intrisic_spec>


; encoding sigelt val FStar.DM4F.ExnSt.div_intrinsic


; <Skipped val FStar.DM4F.ExnSt.div_intrinsic/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_intrisic_spec; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(76,4-76,21); use=FStar.DM4F.ExnSt.fst(76,4-76,21)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
...
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))))
(HasType (FStar.DM4F.ExnSt.div_intrisic_spec @x0
@x1
@x2
@x3)
Tm_type))
...
:pattern ((FStar.DM4F.ExnSt.div_intrisic_spec @x0
@x1
@x2
@x3))
:qid typing_FStar.DM4F.ExnSt.div_intrisic_spec))

:named typing_FStar.DM4F.ExnSt.div_intrisic_spec))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.ExnSt.div_intrisic_spec
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_intrisic_spec; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(76,4-76,21); use=FStar.DM4F.ExnSt.fst(76,4-76,21)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (FStar.DM4F.ExnSt.div_intrisic_spec @x0
@x1
@x2
@x3)
(let ((@lb4 @x3))
...
(Prims.l_and (Prims.l_and (Prims.b2t (Prims.op_Equality Prims.int
@x2
...
@x2
@x3))
:qid equation_FStar.DM4F.ExnSt.div_intrisic_spec))

:named equation_FStar.DM4F.ExnSt.div_intrisic_spec))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
;; def=Prims.fst(183,34-183,38); use=Prims.fst(183,34-183,38)
...
; Starting query at FStar.DM4F.ExnSt.fst(86,4-91,13)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option (Prims.int & Prims.int) -> Type
(declare-fun Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59
Tm_type)
:named kinding_Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,23-28,41); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59))
:qid FStar.DM4F.ExnSt_pre_typing_Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59))

:named FStar.DM4F.ExnSt_pre_typing_Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,23-28,41); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59))

:named FStar.DM4F.ExnSt_interpretation_Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59))

; Encoding query formula : forall (i: Prims.nat) (j: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.int)
;     (p: Prims.pure_post (FStar.Pervasives.Native.option (Prims.int & Prims.int))).
;     (forall (r: FStar.Pervasives.Native.option (Prims.int & Prims.int)).
;         FStar.DM4F.ExnSt.div_intrisic_spec i j _ r ==> p r) ==>
;     (forall (k: (_: FStar.Pervasives.Native.option (Prims.int & Prims.int) -> Type0)).
;         (forall (a1: FStar.Pervasives.Native.option (Prims.int & Prims.int)).
;             {:pattern Prims.guard_free (k a1)}
;             k a1 <==> p a1) ==>
;         (j = 0 = true ==>
;           j = 0 == true ==>
;           (forall (x: Prims.unit & Prims.int).
;               (match FStar.Pervasives.Native.Some x with
;                 | FStar.Pervasives.Native.None  -> k FStar.Pervasives.Native.None
;                 | FStar.Pervasives.Native.Some (_, _) -> k FStar.Pervasives.Native.None)
;               <:
;               Type0)) /\
;         (~(j = 0 = true) ==>
;           (forall (b: Prims.bool).
...
;                           k (FStar.Pervasives.Native.Some (return_val, _))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let div_intrinsic`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.int)
(HasType @x3
(Prims.pure_post (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))))

;; def=FStar.DM4F.ExnSt.fst(64,54-64,94); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))

;; def=FStar.DM4F.ExnSt.fst(83,24-83,50); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(Valid 
;; def=FStar.DM4F.ExnSt.fst(83,24-83,50); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(FStar.DM4F.ExnSt.div_intrisic_spec @x0
@x1
...
;; def=FStar.DM4F.ExnSt.fst(64,90-64,93); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(Valid 
;; def=FStar.DM4F.ExnSt.fst(64,90-64,93); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(221,62-221,85); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(and (implies 
;; def=Prims.fst(221,62-221,71); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(and 
;; def=FStar.DM4F.ExnSt.fst(86,7-86,12); use=FStar.DM4F.ExnSt.fst(86,7-86,12)
...
;; def=FStar.DM4F.IntST.fst(54,50-54,75); use=FStar.DM4F.ExnSt.fst(88,14-88,18)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))
(let ((@lb6 (FStar.Pervasives.Native.Some (FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int)
@x5)))
(ite (is-FStar.Pervasives.Native.None @lb6)

;; def=FStar.DM4F.ExnSt.fst(40,14-40,18); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(or label_1
...
;; def=FStar.DM4F.ExnSt.fst(40,14-40,18); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(ApplyTT @x4
(FStar.Pervasives.Native.None (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))
)
)
...
;; def=FStar.DM4F.ExnSt.fst(43,40-43,44); use=FStar.DM4F.ExnSt.fst(89,15-89,20)
(or label_2
...
(implies 
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(not 
;; def=FStar.DM4F.ExnSt.fst(86,7-86,12); use=FStar.DM4F.ExnSt.fst(86,7-86,12)
(= (Prims.op_Equality Prims.int
@x1
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=FStar.DM4F.ExnSt.fst(86,7-91,13); use=FStar.DM4F.ExnSt.fst(86,7-91,13)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
@x5)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(and 
;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.ExnSt.fst(91,12-91,13)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.int)
...
;; def=FStar.DM4F.ExnSt.fst(81,44-91,13); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(= @x7
(Prims.op_Division @x0
@x1))
)

;; def=Prims.fst(356,2-356,58); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.int)

;; def=Prims.fst(356,26-356,41); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(= @x8
@x7)
)

;; def=FStar.DM4F.ExnSt.fst(58,62-58,68); use=FStar.DM4F.ExnSt.fst(86,4-91,13)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.ExnSt.div_intrinsic, 1)
; STATUS: unsat
...
; encoding sigelt let div_intrinsic


; <Start encoding let div_intrinsic>

(declare-fun FStar.DM4F.ExnSt.div_intrinsic (Term Term) Term)
(declare-fun Non_total_Tm_arrow_7cfa834f6ae25fae49086a317bccae34 () Term)
(declare-fun FStar.DM4F.ExnSt.div_intrinsic@tok () Term)
(declare-fun Tm_refine_ac77eab35d59b079d14cb586bf14c693 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option (Prims.int & Prims.int))
(declare-fun Tm_arrow_8503891f16b63abb1aa8dda3e865ee6b (Term Term) Term)
(declare-fun Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8 (Term Term) Term)
(declare-fun Tm_abs_a301c3bd252685f2edfa896c9ccd9d70 () Term)

; </end encoding let div_intrinsic>

(push) ;; push{2

; Starting query at FStar.DM4F.ExnSt.fst(94,4-100,11)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,23-28,41); use=FStar.DM4F.ExnSt.fst(94,4-100,11)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7551e67ce46d28ed1eb19f19b8a54c59)
...
;   forall (_: Prims.int)
;     (p: Prims.pure_post (FStar.Pervasives.Native.option (Prims.int & Prims.int))).
;     (forall (x: FStar.Pervasives.Native.option (Prims.int & Prims.int)). p x) ==>
;     (forall (k: (_: FStar.Pervasives.Native.option (Prims.int & Prims.int) -> Type0)).
;         (forall (a1: FStar.Pervasives.Native.option (Prims.int & Prims.int)).
;             {:pattern Prims.guard_free (k a1)}
;             Prims.auto_squash (k a1)) ==>
;         ~(j = 0 = true) ==> (forall (b: Prims.bool). j = 0 == b ==> j <> 0))


; Context: While encoding a query
; While typechecking the top-level declaration `let div_extrinsic`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.ExnSt.fst(94,4-100,11)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.int)
(HasType @x3
...
;; def=FStar.DM4F.ExnSt.fst(68,28-68,41); use=FStar.DM4F.ExnSt.fst(94,4-100,11)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))

;; def=FStar.DM4F.ExnSt.fst(68,38-68,41); use=FStar.DM4F.ExnSt.fst(94,4-100,11)
(Valid 
;; def=FStar.DM4F.ExnSt.fst(68,38-68,41); use=FStar.DM4F.ExnSt.fst(94,4-100,11)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.ExnSt.fst(94,4-100,11)
(not 
;; def=FStar.DM4F.ExnSt.fst(94,7-94,12); use=FStar.DM4F.ExnSt.fst(94,7-94,12)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
(BoxBool true))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.ExnSt.fst(94,4-100,11)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=FStar.DM4F.ExnSt.fst(94,7-100,11); use=FStar.DM4F.ExnSt.fst(94,7-100,11)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
@x5)
...
;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.ExnSt.fst(100,10-100,11)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.ExnSt.div_extrinsic, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_Prims.op_Equality
...
; encoding sigelt let div_extrinsic


; <Start encoding let div_extrinsic>

(declare-fun FStar.DM4F.ExnSt.div_extrinsic (Term Term) Term)
(declare-fun Non_total_Tm_arrow_13e6fa38ce20bac6413e1905fa0592b5 () Term)
(declare-fun FStar.DM4F.ExnSt.div_extrinsic@tok () Term)
(declare-fun Tm_refine_15621903c90a91435aa88dd65f2b1df5 () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option (Prims.int & Prims.int))
(declare-fun Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0 () Term)



; </end encoding let div_extrinsic>

;;;;;;;;;;;;;;;;typing_Tm_abs_cc18103f7e8a41ead5051007b34f3b4b
;;; Fact-ids: Name FStar.DM4F.IntST.STINT; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_abs_cc18103f7e8a41ead5051007b34f3b4b
Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af)
:named typing_Tm_abs_cc18103f7e8a41ead5051007b34f3b4b))
;;;;;;;;;;;;;;;;typing_Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c
;;; Fact-ids: Name FStar.DM4F.IntST.STINT; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c
Tm_arrow_29d32c61cfd0bab4e81eb50a22004243)
:named typing_Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c))
;;;;;;;;;;;;;;;;typing_Tm_abs_00709a744a48249290e9052cc7253072
;;; Fact-ids: Name FStar.DM4F.ExnSt.EXNST; Namespace FStar.DM4F.ExnSt
(assert (! (HasType Tm_abs_00709a744a48249290e9052cc7253072
Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5)
:named typing_Tm_abs_00709a744a48249290e9052cc7253072))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IntST.incr; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(76,4-76,8); use=FStar.DM4F.IntST.fst(76,4-76,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.unit)
(HasType (FStar.DM4F.IntST.incr @x0)
Tm_arrow_b996639e5552f46d555b60a2e4f57108))
 

:pattern ((FStar.DM4F.IntST.incr @x0))
:qid typing_FStar.DM4F.IntST.incr))

:named typing_FStar.DM4F.IntST.incr))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_extrinsic; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(93,5-93,18); use=FStar.DM4F.ExnSt.fst(93,5-93,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
Prims.int))
(HasType (FStar.DM4F.ExnSt.div_extrinsic @x0
@x1)
Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0))
 

:pattern ((FStar.DM4F.ExnSt.div_extrinsic @x0
@x1))
:qid typing_FStar.DM4F.ExnSt.div_extrinsic))

:named typing_FStar.DM4F.ExnSt.div_extrinsic))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_intrinsic; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(32,26-32,37); use=FStar.DM4F.ExnSt.fst(32,26-32,37)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8 @x0
@x1))
 

:pattern ((Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8 @x0
@x1))
:qid tot_fun_Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8))

:named tot_fun_Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_a301c3bd252685f2edfa896c9ccd9d70
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_intrinsic; Namespace FStar.DM4F.ExnSt
(assert (! (IsTotFun Tm_abs_a301c3bd252685f2edfa896c9ccd9d70)
:named tot_fun_Tm_abs_a301c3bd252685f2edfa896c9ccd9d70))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@x0 Term))
 (! (IsTotFun (Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c @x0))
 

:pattern ((Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c @x0))
:qid tot_fun_Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c))

:named tot_fun_Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! (IsTotFun Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61)
:named tot_fun_Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_a7635122d129405918ff6301b4fd477f @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_a7635122d129405918ff6301b4fd477f @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_a7635122d129405918ff6301b4fd477f))

:named refinement_kinding_Tm_refine_a7635122d129405918ff6301b4fd477f))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.Pervasives.Native.fst(32,11-32,19); use=FStar.DM4F.ExnSt.fst(43,40-43,44)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306))

:named refinement_kinding_Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_extrinsic; Namespace FStar.DM4F.ExnSt
(assert (! (HasType Tm_refine_15621903c90a91435aa88dd65f2b1df5
Tm_type)
:named refinement_kinding_Tm_refine_15621903c90a91435aa88dd65f2b1df5))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(38,41-38,47)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_0c58db28f9b346702a52f92cd7941fff @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_0c58db28f9b346702a52f92cd7941fff @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_0c58db28f9b346702a52f92cd7941fff))

:named refinement_kinding_Tm_refine_0c58db28f9b346702a52f92cd7941fff))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_a7635122d129405918ff6301b4fd477f @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ST.fst(40,46-40,51)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ST.fst(40,46-40,51)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ST.fst(40,46-40,51)
(= (FStar.Pervasives.Native.Mktuple2 Prims.unit
Prims.int
...
@x1
(Tm_refine_a7635122d129405918ff6301b4fd477f @x2)))
:qid refinement_interpretation_Tm_refine_a7635122d129405918ff6301b4fd477f))

:named refinement_interpretation_Tm_refine_a7635122d129405918ff6301b4fd477f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.Pervasives.Native.fst(32,11-32,19); use=FStar.DM4F.ExnSt.fst(43,40-43,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x2
Prims.int)))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ExnSt.fst(43,40-43,44)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ExnSt.fst(43,40-43,44)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ExnSt.fst(43,40-43,44)
...
@x1
(Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306 @x2)))
:qid refinement_interpretation_Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306))

:named refinement_interpretation_Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_extrinsic; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,23-28,41); use=FStar.DM4F.ExnSt.fst(28,23-28,41)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_15621903c90a91435aa88dd65f2b1df5)
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ExnSt.fst(28,23-28,41)
(not 
;; def=FStar.DM4F.ExnSt.fst(68,28-68,41); use=FStar.DM4F.ExnSt.fst(93,37-93,38)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))

;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ExnSt.fst(28,23-28,41)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ExnSt.fst(28,23-28,41)
(= @x2
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_15621903c90a91435aa88dd65f2b1df5.1))
)
))
...
@x1
Tm_refine_15621903c90a91435aa88dd65f2b1df5))
:qid refinement_interpretation_Tm_refine_15621903c90a91435aa88dd65f2b1df5))

:named refinement_interpretation_Tm_refine_15621903c90a91435aa88dd65f2b1df5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(38,41-38,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_0c58db28f9b346702a52f92cd7941fff @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ST.fst(38,41-38,47)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ST.fst(38,41-38,47)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ST.fst(38,41-38,47)
(= (FStar.Pervasives.Native.Mktuple2 Prims.int
Prims.int
...
@x1
(Tm_refine_0c58db28f9b346702a52f92cd7941fff @x2)))
:qid refinement_interpretation_Tm_refine_0c58db28f9b346702a52f92cd7941fff))

:named refinement_interpretation_Tm_refine_0c58db28f9b346702a52f92cd7941fff))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7 @x0)
Tm_type))
:qid kinding_Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7))

:named kinding_Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ce687f3723a179ebd24369355f1010cf
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_arrow_ce687f3723a179ebd24369355f1010cf
Tm_type)
:named kinding_Tm_arrow_ce687f3723a179ebd24369355f1010cf))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af
Tm_type)
:named kinding_Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b996639e5552f46d555b60a2e4f57108
;;; Fact-ids: Name FStar.DM4F.IntST.incr; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_arrow_b996639e5552f46d555b60a2e4f57108
Tm_type)
:named kinding_Tm_arrow_b996639e5552f46d555b60a2e4f57108))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_extrinsic; Namespace FStar.DM4F.ExnSt
(assert (! (HasType Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0
Tm_type)
:named kinding_Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5
;;; Fact-ids: Name FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab; Namespace FStar.DM4F.ExnSt
(assert (! (HasType Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5
Tm_type)
:named kinding_Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_29d32c61cfd0bab4e81eb50a22004243
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_arrow_29d32c61cfd0bab4e81eb50a22004243
Tm_type)
:named kinding_Tm_arrow_29d32c61cfd0bab4e81eb50a22004243))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1
;;; Fact-ids: Name FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,14-28,17); use=FStar.DM4F.ExnSt.fst(28,14-43,44)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1 @x0)
Tm_type))
:qid kinding_Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1))

:named kinding_Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_intrinsic; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(32,26-32,37); use=FStar.DM4F.ExnSt.fst(32,26-32,37)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8 @x1
@x2)
@x0)
(FStar.Pervasives.Native.Some (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
...
:pattern ((ApplyTT (Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8))

:named interpretation_Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_cc18103f7e8a41ead5051007b34f3b4b
;;; Fact-ids: Name FStar.DM4F.IntST.STINT; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(38,41-38,47); use=FStar.DM4F.ST.fst(38,41-38,47)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_cc18103f7e8a41ead5051007b34f3b4b
@x0)
Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61)
 

:pattern ((ApplyTT Tm_abs_cc18103f7e8a41ead5051007b34f3b4b
@x0))
:qid interpretation_Tm_abs_cc18103f7e8a41ead5051007b34f3b4b))

:named interpretation_Tm_abs_cc18103f7e8a41ead5051007b34f3b4b))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_a301c3bd252685f2edfa896c9ccd9d70
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_intrinsic; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(39,4-41,32); use=FStar.DM4F.ExnSt.fst(39,4-41,32)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_a301c3bd252685f2edfa896c9ccd9d70
@x0)
(let ((@lb1 (FStar.Pervasives.Native.Some (FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int)
(ApplyTT (FStar.DM4F.IntST.incr Tm_unit)
@x0))))
(ite (is-FStar.Pervasives.Native.None @lb1)
(FStar.Pervasives.Native.None (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))
(ite (is-FStar.Pervasives.Native.Some @lb1)
(ApplyTT (FStar.DM4F.ExnSt.__proj__EXNST__item__raise Prims.int)
(FStar.Pervasives.Native.Mktuple2__2 (FStar.Pervasives.Native.Some_v @lb1)))
Tm_unit))))
 

:pattern ((ApplyTT Tm_abs_a301c3bd252685f2edfa896c9ccd9d70
@x0))
:qid interpretation_Tm_abs_a301c3bd252685f2edfa896c9ccd9d70))

:named interpretation_Tm_abs_a301c3bd252685f2edfa896c9ccd9d70))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c @x1)
@x0)
(FStar.Pervasives.Native.Mktuple2 Prims.unit
Prims.int
Tm_unit
...
:pattern ((ApplyTT (Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c @x1)
@x0))
:qid interpretation_Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c))

:named interpretation_Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(38,41-38,47); use=FStar.DM4F.ST.fst(38,41-38,47)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61
@x0)
(FStar.Pervasives.Native.Mktuple2 Prims.int
Prims.int
@x0
...
:pattern ((ApplyTT Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61
@x0))
:qid interpretation_Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61))

:named interpretation_Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c
;;; Fact-ids: Name FStar.DM4F.IntST.STINT; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c
@x0)
(Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c @x0))
 

:pattern ((ApplyTT Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c
@x0))
:qid interpretation_Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c))

:named interpretation_Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_15d1a1024d0dd12a02ff74be4fbf3dc0
;;; Fact-ids: Name FStar.DM4F.ExnSt.raise; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(43,40-43,44); use=FStar.DM4F.ExnSt.fst(43,40-43,44)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_15d1a1024d0dd12a02ff74be4fbf3dc0 @x1)
@x0)
(FStar.Pervasives.Native.None (FStar.Pervasives.Native.tuple2 @x1
Prims.int)))
 

:pattern ((ApplyTT (Tm_abs_15d1a1024d0dd12a02ff74be4fbf3dc0 @x1)
@x0))
:qid interpretation_Tm_abs_15d1a1024d0dd12a02ff74be4fbf3dc0))

:named interpretation_Tm_abs_15d1a1024d0dd12a02ff74be4fbf3dc0))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_00709a744a48249290e9052cc7253072
;;; Fact-ids: Name FStar.DM4F.ExnSt.EXNST; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(43,40-43,44); use=FStar.DM4F.ExnSt.fst(43,40-43,44)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_00709a744a48249290e9052cc7253072
@x0)
(Tm_abs_15d1a1024d0dd12a02ff74be4fbf3dc0 @x0))
 

:pattern ((ApplyTT Tm_abs_00709a744a48249290e9052cc7253072
@x0))
:qid interpretation_Tm_abs_00709a744a48249290e9052cc7253072))

:named interpretation_Tm_abs_00709a744a48249290e9052cc7253072))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a7635122d129405918ff6301b4fd477f
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_a7635122d129405918ff6301b4fd477f @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_a7635122d129405918ff6301b4fd477f @x0))))
:qid haseqTm_refine_a7635122d129405918ff6301b4fd477f))

:named haseqTm_refine_a7635122d129405918ff6301b4fd477f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306
;;; Fact-ids: Name FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.Pervasives.Native.fst(32,11-32,19); use=FStar.DM4F.ExnSt.fst(43,40-43,44)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 @x0
Prims.int)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306 @x0))))
:qid haseqTm_refine_5107ef437a2f2c3cb1a6550c2bd0a306))

:named haseqTm_refine_5107ef437a2f2c3cb1a6550c2bd0a306))
;;;;;;;;;;;;;;;;haseq for Tm_refine_15621903c90a91435aa88dd65f2b1df5
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_extrinsic; Namespace FStar.DM4F.ExnSt
(assert (! (iff (Valid (Prims.hasEq Tm_refine_15621903c90a91435aa88dd65f2b1df5))
(Valid (Prims.hasEq (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))))
:named haseqTm_refine_15621903c90a91435aa88dd65f2b1df5))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0c58db28f9b346702a52f92cd7941fff
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(38,41-38,47)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_0c58db28f9b346702a52f92cd7941fff @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_0c58db28f9b346702a52f92cd7941fff @x0))))
:qid haseqTm_refine_0c58db28f9b346702a52f92cd7941fff))

:named haseqTm_refine_0c58db28f9b346702a52f92cd7941fff))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntST.incr
;;; Fact-ids: Name FStar.DM4F.IntST.incr; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(76,4-76,8); use=FStar.DM4F.IntST.fst(76,4-76,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (FStar.DM4F.IntST.incr @x0)
@x1)
(let ((@lb2 (ApplyTT (FStar.DM4F.IntST.__proj__STINT__item__get Tm_unit)
@x1)))
(ApplyTT (FStar.DM4F.IntST.__proj__STINT__item__put (Prims.op_Addition (FStar.Pervasives.Native.Mktuple2__1 @lb2)
(BoxInt 1)))
(FStar.Pervasives.Native.Mktuple2__2 @lb2))))
 

:pattern ((ApplyTT (FStar.DM4F.IntST.incr @x0)
@x1))
:qid equation_FStar.DM4F.IntST.incr))

:named equation_FStar.DM4F.IntST.incr))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.ExnSt.div_extrinsic
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_extrinsic; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(93,5-93,18); use=FStar.DM4F.ExnSt.fst(93,5-93,18)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.ExnSt.div_extrinsic @x0
@x1)
...
(ite (= @lb2
(BoxBool true))
Tm_abs_a301c3bd252685f2edfa896c9ccd9d70
(Tm_abs_e8320454ea3931af1e1c7ab2b376e5a8 @x1
@x0))))
 

:pattern ((FStar.DM4F.ExnSt.div_extrinsic @x0
@x1))
:qid equation_FStar.DM4F.ExnSt.div_extrinsic))

:named equation_FStar.DM4F.ExnSt.div_extrinsic))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7 @x2)))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ce687f3723a179ebd24369355f1010cf)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_ce687f3723a179ebd24369355f1010cf))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_ce687f3723a179ebd24369355f1010cf))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_ce687f3723a179ebd24369355f1010cf))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(38,17-38,19); use=FStar.DM4F.ST.fst(38,17-38,19)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af)
...
@x1
Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntST.incr; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
...
@x1
Tm_arrow_b996639e5552f46d555b60a2e4f57108))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_b996639e5552f46d555b60a2e4f57108))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_b996639e5552f46d555b60a2e4f57108))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
...
@x1
Tm_arrow_29d32c61cfd0bab4e81eb50a22004243))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_29d32c61cfd0bab4e81eb50a22004243))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_29d32c61cfd0bab4e81eb50a22004243))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7 @x1))
(and 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_a7635122d129405918ff6301b4fd477f @x1)))
 

:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7 @x1)))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_ea7d0c86cbd176c5a6ccf7a7037823c7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ce687f3723a179ebd24369355f1010cf
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_refine_0c58db28f9b346702a52f92cd7941fff @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_ce687f3723a179ebd24369355f1010cf.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_ce687f3723a179ebd24369355f1010cf))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_ce687f3723a179ebd24369355f1010cf))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_ce687f3723a179ebd24369355f1010cf))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__get_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(38,17-38,19); use=FStar.DM4F.ST.fst(38,17-38,19)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_cad41ca3eeb8f55fa00ce3c0353b91af))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b996639e5552f46d555b60a2e4f57108
;;; Fact-ids: Name FStar.DM4F.IntST.incr; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_b996639e5552f46d555b60a2e4f57108.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_b996639e5552f46d555b60a2e4f57108))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_b996639e5552f46d555b60a2e4f57108))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_b996639e5552f46d555b60a2e4f57108))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_29d32c61cfd0bab4e81eb50a22004243
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT___proj__STINT__item__put_elab; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_29d32c61cfd0bab4e81eb50a22004243.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_29d32c61cfd0bab4e81eb50a22004243))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_29d32c61cfd0bab4e81eb50a22004243))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_29d32c61cfd0bab4e81eb50a22004243))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.IntST.STINT; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(29,7-29,10); use=FStar.DM4F.IntST.fst(29,7-29,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.IntST.__proj__STINT__item__put @x0)
(ApplyTT Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c
@x0))
 

:pattern ((FStar.DM4F.IntST.__proj__STINT__item__put @x0))
:qid FStar.DM4F.IntST.__proj__STINT__item__put_equality))

:named FStar.DM4F.IntST.__proj__STINT__item__put_equality))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.IntST.STINT; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(28,7-28,10); use=FStar.DM4F.IntST.fst(28,7-28,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.IntST.__proj__STINT__item__get @x0)
(ApplyTT Tm_abs_cc18103f7e8a41ead5051007b34f3b4b
@x0))
 

:pattern ((FStar.DM4F.IntST.__proj__STINT__item__get @x0))
:qid FStar.DM4F.IntST.__proj__STINT__item__get_equality))

:named FStar.DM4F.IntST.__proj__STINT__item__get_equality))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_extrinsic; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,14-28,41); use=FStar.DM4F.ExnSt.fst(28,14-28,41)
...
@x1
Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0))
:qid FStar.DM4F.ExnSt_pre_typing_Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0))

:named FStar.DM4F.ExnSt_pre_typing_Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,14-43,17); use=FStar.DM4F.ExnSt.fst(28,14-43,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5)
...
@x1
Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5))
:qid FStar.DM4F.ExnSt_pre_typing_Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5))

:named FStar.DM4F.ExnSt_pre_typing_Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,14-28,17); use=FStar.DM4F.ExnSt.fst(28,14-43,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1 @x2)))
:qid FStar.DM4F.ExnSt_pre_typing_Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1))

:named FStar.DM4F.ExnSt_pre_typing_Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0
;;; Fact-ids: Name FStar.DM4F.ExnSt.div_extrinsic; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,14-28,41); use=FStar.DM4F.ExnSt.fst(28,14-28,41)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0))

:named FStar.DM4F.ExnSt_interpretation_Tm_arrow_9de91ba7f308f17284a8f37ea1dc59e0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5
;;; Fact-ids: Name FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,14-43,17); use=FStar.DM4F.ExnSt.fst(28,14-43,44)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5))

:named FStar.DM4F.ExnSt_interpretation_Tm_arrow_813ade1e88b0f152f9c59b84a6c4cdc5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1
;;; Fact-ids: Name FStar.DM4F.ExnSt._dm4f_EXNST___proj__EXNST__item__raise_elab; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(28,14-28,17); use=FStar.DM4F.ExnSt.fst(28,14-43,44)
(forall ((@x0 Term) (@x1 Term))
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_5107ef437a2f2c3cb1a6550c2bd0a306 @x1)))
 

:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1 @x1)))
:qid FStar.DM4F.ExnSt_interpretation_Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1))

:named FStar.DM4F.ExnSt_interpretation_Tm_arrow_18e54b918e5aa51474283c6aea8fd4c1))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.ExnSt.EXNST; Namespace FStar.DM4F.ExnSt
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(51,4-51,9); use=FStar.DM4F.ExnSt.fst(51,4-51,9)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.ExnSt.__proj__EXNST__item__raise @x0)
(ApplyTT Tm_abs_00709a744a48249290e9052cc7253072
@x0))
 

:pattern ((FStar.DM4F.ExnSt.__proj__EXNST__item__raise @x0))
:qid FStar.DM4F.ExnSt.__proj__EXNST__item__raise_equality))

:named FStar.DM4F.ExnSt.__proj__EXNST__item__raise_equality))
(push) ;; push{2

; Starting query at FStar.DM4F.ExnSt.fst(105,61-105,63)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ExnSt.fst(103,2-105,58); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
; Encoding query formula : forall (i: Prims.nat) (j: Prims.int) (h0: Prims.int).
;   (forall (_: Prims.squash Prims.l_True).
;       (*  - Could not prove post-condition
; *)
;       forall (x: FStar.Pervasives.Native.option (Prims.int & Prims.int)).
;         reify (FStar.DM4F.ExnSt.div_extrinsic i j) h0 == x ==>
;         (forall (k: Prims.pure_post Type0).
;             (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;             (~(None? (reify (FStar.DM4F.ExnSt.div_extrinsic i j) h0)) /\
;               ~(Some? (reify (FStar.DM4F.ExnSt.div_extrinsic i j) h0)) ==>
;               Prims.l_False) /\
;             (~(None? (reify (FStar.DM4F.ExnSt.div_extrinsic i j) h0)) ==>
;               (forall (b: Prims.int) (b: Prims.int).
;                   reify (FStar.DM4F.ExnSt.div_extrinsic i j) h0 ==
;                   FStar.Pervasives.Native.Some (b, b) ==>
;                   h0 = b /\ j <> 0 ==> j <> 0)))) /\
;   (forall (p: Prims.pure_post Prims.unit).
;       (forall (pure_result: Prims.unit).
;           (match reify (FStar.DM4F.ExnSt.div_extrinsic i j) h0 with
;             | FStar.Pervasives.Native.None  -> j = 0
;             | FStar.Pervasives.Native.Some (z, h1) -> h0 = h1 /\ j <> 0 /\ z = i / j) ==>
;           p pure_result) ==>
;       (forall (any_result: Prims.unit). p any_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_div_extrinsic`
...
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)

;; def=FStar.DM4F.ExnSt.fst(68,28-68,41); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))

;; def=FStar.DM4F.ExnSt.fst(103,15-103,43); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(= (ApplyTT (FStar.DM4F.ExnSt.div_extrinsic @x0
@x1)
@x2)
@x4)
)
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(and (implies 
;; def=FStar.DM4F.ExnSt.fst(103,15-103,43); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(and 
;; def=FStar.DM4F.ExnSt.fst(103,15-103,43); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(not 
;; def=FStar.DM4F.ExnSt.fst(103,15-103,43); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)
...
;; def=FStar.DM4F.ExnSt.fst(103,15-105,23); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(= (ApplyTT (FStar.DM4F.ExnSt.div_extrinsic @x0
@x1)
@x2)
(FStar.Pervasives.Native.Some (FStar.Pervasives.Native.tuple2 Prims.int
...
;; def=FStar.DM4F.ExnSt.fst(105,27-105,34); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(= @x2
@x7)


;; def=FStar.DM4F.ExnSt.fst(105,38-105,44); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(not (= @x1
(BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.ExnSt.fst(105,56-105,57)
(or label_2

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(not (= @x1
(BoxInt 0)))
)
)
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(forall ((@x4 Term))
 (! (implies (and (or label_3
(HasType @x4
Prims.unit))
(let ((@lb5 (ApplyTT (FStar.DM4F.ExnSt.div_extrinsic @x0
@x1)
@x2)))
(ite (is-FStar.Pervasives.Native.None @lb5)

;; def=FStar.DM4F.ExnSt.fst(104,19-104,24); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(or label_4
...
;; def=FStar.DM4F.ExnSt.fst(105,27-105,57); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(and 
;; def=FStar.DM4F.ExnSt.fst(105,27-105,34); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(or label_5
...
;; def=FStar.DM4F.ExnSt.fst(105,48-105,57); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(or label_7
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.ExnSt.fst(105,61-105,63)
(ApplyTT @x3
@x4)
