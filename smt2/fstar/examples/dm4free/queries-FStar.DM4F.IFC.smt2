...
; Internals for FStar.DM4F.IFC


; encoding sigelt type FStar.DM4F.IFC.label


; <Start encoding type FStar.DM4F.IFC.label>

;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.IFC.label () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.IFC.Low () Term)
;;;;;;;;;;;;;;;;data constructor proxy: FStar.DM4F.IFC.Low
(declare-fun FStar.DM4F.IFC.Low@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.IFC.High () Term)
;;;;;;;;;;;;;;;;data constructor proxy: FStar.DM4F.IFC.High
(declare-fun FStar.DM4F.IFC.High@tok () Term)

; <start constructor FStar.DM4F.IFC.label>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.IFC.label ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
122)
(= __@x0
FStar.DM4F.IFC.label)))

; </end constructor FStar.DM4F.IFC.label>


; <start constructor FStar.DM4F.IFC.Low>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.IFC.Low ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
128)
(= __@x0
FStar.DM4F.IFC.Low)))

; </end constructor FStar.DM4F.IFC.Low>


; <start constructor FStar.DM4F.IFC.High>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.IFC.High ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
130)
(= __@x0
FStar.DM4F.IFC.High)))

; </end constructor FStar.DM4F.IFC.High>


; </end encoding type FStar.DM4F.IFC.label>


; encoding sigelt assume FStar.DM4F.IFC.label__uu___haseq


; <Start encoding assume FStar.DM4F.IFC.label__uu___haseq>


; </end encoding assume FStar.DM4F.IFC.label__uu___haseq>


; encoding sigelt val FStar.DM4F.IFC.uu___is_Low


; <Start encoding val FStar.DM4F.IFC.uu___is_Low>

(declare-fun FStar.DM4F.IFC.uu___is_Low (Term) Term)
;;;;;;;;;;;;;;;;projectee: label -> Prims.bool
(declare-fun Tm_arrow_db91c5bd6b74cf9b3843d63b412d6f31 () Term)
(declare-fun FStar.DM4F.IFC.uu___is_Low@tok () Term)

; </end encoding val FStar.DM4F.IFC.uu___is_Low>
...
; encoding sigelt val FStar.DM4F.IFC.uu___is_High


; <Start encoding val FStar.DM4F.IFC.uu___is_High>

(declare-fun FStar.DM4F.IFC.uu___is_High (Term) Term)

(declare-fun FStar.DM4F.IFC.uu___is_High@tok () Term)

; </end encoding val FStar.DM4F.IFC.uu___is_High>
...
(declare-fun FStar.DM4F.IFC.ifc (Term) Term)

(declare-fun FStar.DM4F.IFC.ifc@tok () Term)
;;;;;;;;;;;;;;;;_: label -> Prims.M (FStar.Pervasives.Native.option (a & label))
(declare-fun Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd (Term) Term)
...
(declare-fun FStar.DM4F.IFC.return_ifc (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> ifc a
(declare-fun Tm_arrow_edc6375c7c889e596f1df608db684a27 () Term)
(declare-fun FStar.DM4F.IFC.return_ifc@tok () Term)
(declare-fun Tm_abs_d674667f8b701459fce6f376ce568bfd (Term Term) Term)
...
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! (HasType FStar.DM4F.IFC.Low@tok
FStar.DM4F.IFC.label)
:named typing_tok_FStar.DM4F.IFC.Low@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! (HasType FStar.DM4F.IFC.High@tok
FStar.DM4F.IFC.label)
:named typing_tok_FStar.DM4F.IFC.High@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IFC.ifc; Namespace FStar.DM4F.IFC
(assert (! 
;; def=FStar.DM4F.IFC.fst(26,4-26,7); use=FStar.DM4F.IFC.fst(26,4-26,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.IFC.ifc @x0)
Tm_type))
 

:pattern ((FStar.DM4F.IFC.ifc @x0))
:qid typing_FStar.DM4F.IFC.ifc))

:named typing_FStar.DM4F.IFC.ifc))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd
;;; Fact-ids: Name FStar.DM4F.IFC.ifc; Namespace FStar.DM4F.IFC
(assert (! 
;; def=FStar.DM4F.IFC.fst(26,19-26,50); use=FStar.DM4F.IFC.fst(26,19-26,50)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd @x0)
Tm_type))
:qid kinding_Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd))

:named kinding_Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! (HasType FStar.DM4F.IFC.label
Tm_type)
:named kinding_FStar.DM4F.IFC.label@tok))
...
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! 
;; def=FStar.DM4F.IFC.fst(22,5-22,10); use=FStar.DM4F.IFC.fst(22,5-22,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
FStar.DM4F.IFC.label)
(or (is-FStar.DM4F.IFC.Low @x1)
(is-FStar.DM4F.IFC.High @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
FStar.DM4F.IFC.label))
:qid fuel_guarded_inversion_FStar.DM4F.IFC.label))

:named fuel_guarded_inversion_FStar.DM4F.IFC.label))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! (= 126
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IFC.ifc
;;; Fact-ids: Name FStar.DM4F.IFC.ifc; Namespace FStar.DM4F.IFC
(assert (! 
;; def=FStar.DM4F.IFC.fst(26,4-26,7); use=FStar.DM4F.IFC.fst(26,4-26,7)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.IFC.ifc @x0)
(Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd @x0))
 

:pattern ((FStar.DM4F.IFC.ifc @x0))
:qid equation_FStar.DM4F.IFC.ifc))

:named equation_FStar.DM4F.IFC.ifc))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! (= FStar.DM4F.IFC.Low@tok
FStar.DM4F.IFC.Low)
:named equality_tok_FStar.DM4F.IFC.Low@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! (= FStar.DM4F.IFC.High@tok
FStar.DM4F.IFC.High)
:named equality_tok_FStar.DM4F.IFC.High@tok))
...
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! 
;; def=FStar.DM4F.IFC.fst(23,4-23,7); use=FStar.DM4F.IFC.fst(23,4-23,7)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
FStar.DM4F.IFC.Low
FStar.DM4F.IFC.label)
...
FStar.DM4F.IFC.Low
FStar.DM4F.IFC.label))
:qid data_typing_intro_FStar.DM4F.IFC.Low@tok))

:named data_typing_intro_FStar.DM4F.IFC.Low@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! 
;; def=FStar.DM4F.IFC.fst(24,4-24,8); use=FStar.DM4F.IFC.fst(24,4-24,8)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
FStar.DM4F.IFC.High
FStar.DM4F.IFC.label)
...
FStar.DM4F.IFC.High
FStar.DM4F.IFC.label))
:qid data_typing_intro_FStar.DM4F.IFC.High@tok))

:named data_typing_intro_FStar.DM4F.IFC.High@tok))
...
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! (= 122
(Term_constr_id FStar.DM4F.IFC.label))
:named constructor_distinct_FStar.DM4F.IFC.label))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! (= 128
(Term_constr_id FStar.DM4F.IFC.Low))
:named constructor_distinct_FStar.DM4F.IFC.Low))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.DM4F.IFC.label; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.Low; Namespace FStar.DM4F.IFC; Name FStar.DM4F.IFC.High; Namespace FStar.DM4F.IFC
(assert (! (= 130
(Term_constr_id FStar.DM4F.IFC.High))
:named constructor_distinct_FStar.DM4F.IFC.High))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
;;;;;;;;;;;;;;;;Assumption: FStar.DM4F.IFC.label__uu___haseq
;;; Fact-ids: Name FStar.DM4F.IFC.label__uu___haseq; Namespace FStar.DM4F.IFC
(assert (! (Valid (Prims.hasEq FStar.DM4F.IFC.label))
:named assumption_FStar.DM4F.IFC.label__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
FStar.DM4F.IFC.label))
:qid FStar.DM4F.IFC_pretyping_ec0bb0f1bf3d1d6b39e57751a23ec047))

:named FStar.DM4F.IFC_pretyping_ec0bb0f1bf3d1d6b39e57751a23ec047))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IFC.ifc; Namespace FStar.DM4F.IFC
(assert (! 
;; def=FStar.DM4F.IFC.fst(26,19-26,50); use=FStar.DM4F.IFC.fst(26,19-26,50)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd @x2)))
:qid FStar.DM4F.IFC_pre_typing_Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd))

:named FStar.DM4F.IFC_pre_typing_Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd
;;; Fact-ids: Name FStar.DM4F.IFC.ifc; Namespace FStar.DM4F.IFC
(assert (! 
;; def=FStar.DM4F.IFC.fst(26,19-26,50); use=FStar.DM4F.IFC.fst(26,19-26,50)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd @x1))
(and 
;; def=FStar.DM4F.IFC.fst(26,19-26,50); use=FStar.DM4F.IFC.fst(26,19-26,50)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.IFC_interpretation_Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd @x1)))
:qid FStar.DM4F.IFC_interpretation_Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd))

:named FStar.DM4F.IFC_interpretation_Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd))
(push) ;; push{2

; Starting query at FStar.DM4F.IFC.fst(30,4-37,45)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> ifc b
(declare-fun Tm_arrow_8149d865425f388a584b6c9b45ca899c (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8149d865425f388a584b6c9b45ca899c
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IFC.fst(29,14-29,61); use=FStar.DM4F.IFC.fst(29,45-29,61)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_8149d865425f388a584b6c9b45ca899c @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_8149d865425f388a584b6c9b45ca899c @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_8149d865425f388a584b6c9b45ca899c))

:named kinding_Tm_arrow_8149d865425f388a584b6c9b45ca899c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IFC.fst(29,14-29,61); use=FStar.DM4F.IFC.fst(29,45-29,61)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_8149d865425f388a584b6c9b45ca899c @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_8149d865425f388a584b6c9b45ca899c @x2
@x3)))
:qid FStar.DM4F.IFC_pre_typing_Tm_arrow_8149d865425f388a584b6c9b45ca899c))

:named FStar.DM4F.IFC_pre_typing_Tm_arrow_8149d865425f388a584b6c9b45ca899c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8149d865425f388a584b6c9b45ca899c
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IFC.fst(29,14-29,61); use=FStar.DM4F.IFC.fst(29,45-29,61)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_8149d865425f388a584b6c9b45ca899c @x1
@x2))
(and 
;; def=FStar.DM4F.IFC.fst(29,14-29,61); use=FStar.DM4F.IFC.fst(29,45-29,61)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(FStar.DM4F.IFC.ifc @x1)))
 

:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.IFC_interpretation_Tm_arrow_8149d865425f388a584b6c9b45ca899c.1))
...
(Tm_arrow_8149d865425f388a584b6c9b45ca899c @x1
@x2)))
:qid FStar.DM4F.IFC_interpretation_Tm_arrow_8149d865425f388a584b6c9b45ca899c))

:named FStar.DM4F.IFC_interpretation_Tm_arrow_8149d865425f388a584b6c9b45ca899c))

; Encoding query formula : forall (a: Type) (b: Type) (f: FStar.DM4F.IFC.ifc a) (g: (_: a -> FStar.DM4F.IFC.ifc b)).
;   (*  - Could not prove post-condition
; *)
;   forall (l0: FStar.DM4F.IFC.label).
;     (*  - Could not prove post-condition
; *)
;     forall (k: Prims.pure_post (FStar.Pervasives.Native.option (b & FStar.DM4F.IFC.label))).
;       (forall (x: FStar.Pervasives.Native.option (b & FStar.DM4F.IFC.label)).
;           {:pattern Prims.guard_free (k x)}
;           Prims.auto_squash (k x)) ==>
;       (~(None? (f l0)) /\ ~(Some? (f l0)) ==> Prims.l_False) /\
;       (~(None? (f l0)) ==>
;         (forall (b: a) (b: FStar.DM4F.IFC.label).
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IFC.fst(30,4-37,45)
(forall ((@x4 Term))
 (! (implies (HasType @x4
FStar.DM4F.IFC.label)
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.IFC.fst(30,13-37,45)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.IFC.fst(30,13-37,45)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.IFC.fst(30,13-37,45)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.IFC.fst(30,13-37,45)
(and (implies 
;; def=FStar.DM4F.IFC.fst(30,18-30,21); use=FStar.DM4F.IFC.fst(31,20-31,23)
(and 
;; def=FStar.DM4F.IFC.fst(30,18-30,21); use=FStar.DM4F.IFC.fst(31,20-31,23)
(not 
;; def=FStar.DM4F.IFC.fst(30,18-30,21); use=FStar.DM4F.IFC.fst(31,20-31,23)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=FStar.DM4F.IFC.fst(30,13-37,45)
(not 
;; def=FStar.DM4F.IFC.fst(30,18-30,21); use=FStar.DM4F.IFC.fst(31,20-31,23)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None (FStar.Pervasives.Native.tuple2 @x0
FStar.DM4F.IFC.label)
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.IFC.fst(30,13-37,45)
(forall ((@x6 Term))
 (! (implies (HasType @x6
@x0)
...
;; def=FStar.DM4F.IFC.fst(30,18-33,28); use=FStar.DM4F.IFC.fst(31,20-33,28)
(= (ApplyTT @x2
@x4)
...
;; def=FStar.DM4F.IFC.fst(34,20-34,24); use=FStar.DM4F.IFC.fst(35,22-35,26)
(not 
;; def=FStar.DM4F.IFC.fst(34,20-34,24); use=FStar.DM4F.IFC.fst(35,22-35,26)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IFC.bind_ifc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.IFC_interpretation_Tm_arrow_5e74331ece5915e55d8f952a33f0c3fd, FStar.DM4F.IFC_interpretation_Tm_arrow_8149d865425f388a584b6c9b45ca899c, equation_FStar.DM4F.IFC.ifc, kinding_FStar.DM4F.IFC.label@tok, kinding_FStar.Pervasives.Native.tuple2@tok, lemma_FStar.Pervasives.invertOption
...
;;;;;;;;;;;;;;;;_: a -> ifc b
(declare-fun Tm_arrow_8149d865425f388a584b6c9b45ca899c (Term Term) Term)
(declare-fun FStar.DM4F.IFC.bind_ifc (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> f: ifc a -> g: (_: a -> ifc b) -> ifc b
(declare-fun Tm_arrow_862c1635286c5f43cbf1e23270177571 () Term)
(declare-fun FStar.DM4F.IFC.bind_ifc@tok () Term)

(declare-fun Tm_abs_e533e016a394588e9fa818f392b7486f (Term Term Term) Term)

; </end encoding let bind_ifc>

(push) ;; push{2

; Starting query at FStar.DM4F.IFC.fst(39,17-39,61)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (l1: FStar.DM4F.IFC.label) (l2: FStar.DM4F.IFC.label).
;   (*  - Could not prove post-condition
; *)
;   Prims.hasEq FStar.DM4F.IFC.label /\
;   (~(l1 = FStar.DM4F.IFC.High) ==> Prims.hasEq FStar.DM4F.IFC.label)


; Context: While encoding a query
; While typechecking the top-level declaration `let join`
...
;; def=FStar.DM4F.IFC.fst(39,20-39,42); use=FStar.DM4F.IFC.fst(39,20-39,42)
(and 
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.IFC.fst(39,25-39,29)
(or label_1
...
(implies 
;; def=FStar.DM4F.IFC.fst(39,20-39,29); use=FStar.DM4F.IFC.fst(39,20-39,29)
(not 
;; def=FStar.DM4F.IFC.fst(39,20-39,29); use=FStar.DM4F.IFC.fst(39,20-39,29)
(= @x0
FStar.DM4F.IFC.High@tok)
)


;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.IFC.fst(39,38-39,42)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IFC.join, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_FStar.DM4F.IFC.label__uu___haseq
...
; encoding sigelt let join


; <Start encoding let join>

(declare-fun FStar.DM4F.IFC.join (Term Term) Term)
;;;;;;;;;;;;;;;;l1: label -> l2: label -> label
(declare-fun Tm_arrow_099172388afdba333a7e320e168c8380 () Term)
(declare-fun FStar.DM4F.IFC.join@tok () Term)

; </end encoding let join>

(push) ;; push{2

; Starting query at FStar.DM4F.IFC.fst(41,18-41,40)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let flows`
...
;; def=FStar.DM4F.IFC.fst(41,22-41,39); use=FStar.DM4F.IFC.fst(41,22-41,39)
(and 
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.IFC.fst(41,25-41,29)
(or label_1
...
(implies 
;; def=FStar.DM4F.IFC.fst(41,22-41,29); use=FStar.DM4F.IFC.fst(41,22-41,29)
(= @x0
FStar.DM4F.IFC.High@tok)


;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.IFC.fst(41,36-41,39)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IFC.flows, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_FStar.DM4F.IFC.label__uu___haseq
...
(declare-fun FStar.DM4F.IFC.flows (Term Term) Term)
;;;;;;;;;;;;;;;;l1: label -> l2: label -> Prims.bool
(declare-fun Tm_arrow_0b521d755cf140a5f50acbdaa8bf4a15 () Term)
(declare-fun FStar.DM4F.IFC.flows@tok () Term)
...
(declare-fun FStar.DM4F.IFC.read (Term) Term)
;;;;;;;;;;;;;;;;l: label -> ifc Prims.bool
(declare-fun Tm_arrow_b417fdf79d9b4ebe4536afa806cdd756 () Term)
(declare-fun FStar.DM4F.IFC.read@tok () Term)
(declare-fun Tm_abs_b5bce49ef08bd5234e619cfe68f5c932 (Term) Term)
...
(declare-fun FStar.DM4F.IFC.write (Term Term) Term)
;;;;;;;;;;;;;;;;l: label -> b: Prims.bool -> ifc Prims.unit
(declare-fun Tm_arrow_f02ff6edd8d69bc889e561c2f24cc7d6 () Term)
(declare-fun FStar.DM4F.IFC.write@tok () Term)
(declare-fun Tm_abs_6f0f67dd59761ea38058874916c98bf0 (Term) Term)

; </end encoding let write>


; encoding sigelt let _dm4f_IFC_lift_from_pure


; <Start encoding let _dm4f_IFC_lift_from_pure>


;;;;;;;;;;;;;;;;_: (_: a -> Type) -> Type
(declare-fun Tm_arrow_11b93b1a25b26195b88e72dd87199600 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option (a & label) -> Type
(declare-fun Tm_arrow_070dfe24454960b8c034284a09982e2f (Term) Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     l: label ->     p': (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Type
(declare-fun Tm_arrow_8d77a1ea48b7b4bb641b599324f074b3 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_lift_from_pure@tok () Term)




(declare-fun Tm_abs_b22d5046d1588bd7113d3618bdd0e60a (Term Term Term) Term)

; </end encoding let _dm4f_IFC_lift_from_pure>


; encoding sigelt let _dm4f_IFC_return_wp


; <Start encoding let _dm4f_IFC_return_wp>


(declare-fun FStar.DM4F.IFC._dm4f_IFC_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> l: label -> p': (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type
(declare-fun Tm_arrow_c09c0f8454fd3f63b574c852c39c016e () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_return_wp@tok () Term)


; </end encoding let _dm4f_IFC_return_wp>


; encoding sigelt let _dm4f_IFC_return_elab


; <Start encoding let _dm4f_IFC_return_elab>

(declare-fun FStar.DM4F.IFC._dm4f_IFC_return_elab (Term Term) Term)
(declare-fun Tm_refine_71087909ae63027fdaac807b9e4c3a14 (Term Term Term) Term)
;;;;;;;;;;;;;;;;l__x: label -> Prims.PURE (FStar.Pervasives.Native.option (a & label))
(declare-fun Tm_arrow_da75c1a7cfb5f5149046bd7c6e5a4a3a (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> l__x: label -> Prims.PURE (FStar.Pervasives.Native.option (a & label))
(declare-fun Tm_arrow_1007a4f0e438c929b43ff06dd3870f06 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_return_elab@tok () Term)




; </end encoding let _dm4f_IFC_return_elab>


; encoding sigelt let _dm4f_IFC_bind_wp


; <Start encoding let _dm4f_IFC_bind_wp>


;;;;;;;;;;;;;;;;_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type
(declare-fun Tm_arrow_65bbf330d03ffc0d3dedcad4dc6bd602 (Term) Term)


;;;;;;;;;;;;;;;;_: a -> _: label -> _: (_: FStar.Pervasives.Native.option (b & label) -> Type) -> Type
(declare-fun Tm_arrow_563d030f82c4133c005ad3ffa88b3ae8 (Term Term) Term)

(declare-fun FStar.DM4F.IFC._dm4f_IFC_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type) ->     g: (_: a -> _: label -> _: (_: FStar.Pervasives.Native.option (b & label) -> Type) -> Type) ->     l0: label ->     p'': (_: FStar.Pervasives.Native.option (b & label) -> Type)   -> Type
(declare-fun Tm_arrow_eec129d2649693b99758cf4615d1dc3b () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_bind_wp@tok () Term)
...
(declare-fun Tm_abs_9ea9512157b0edf8cd4fa8747234851b (Term Term) Term)

(declare-fun Tm_abs_a98a9b86a7ac2b905809d7343f31b35f (Term Term Term Term) Term)

; </end encoding let _dm4f_IFC_bind_wp>


; encoding sigelt let _dm4f_IFC_bind_elab


; <Start encoding let _dm4f_IFC_bind_elab>



(declare-fun Tm_refine_17fe6142909bd4d7a33c5994413fd926 (Term) Term)

;;;;;;;;;;;;;;;;y: _: FStar.Pervasives.Native.option (a & label) {Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_0ebe4d13d381497c9db18e7f9180154f (Term) Term)
(declare-fun Tm_abs_c0caab6285e1469e23d3d72da813d78f (Term Term) Term)
(declare-fun Tm_refine_6b3b6a7d5f8c760dc36fde74e277b26b (Term Term Term) Term)



(declare-fun Tm_abs_9f130084da6782b0084b036aa9c62f5d (Term) Term)
;;;;;;;;;;;;;;;;_: label -> Prims.PURE (FStar.Pervasives.Native.option (a & label))
(declare-fun Tm_arrow_9e9c0ae79e6922721fcf656b8e2d89e5 (Term Term) Term)
...
(declare-fun Tm_refine_5c9901a59be048f97e777cabee62ece3 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: label -> Prims.PURE (FStar.Pervasives.Native.option (b & label))
(declare-fun Tm_arrow_5ec82302fd3b08dfa3af5883c1c2e7b2 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: label -> Prims.PURE (FStar.Pervasives.Native.option (b & label))
(declare-fun Tm_arrow_5a4950e14ce062104c87243467e5da0c (Term Term Term) Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_bind_elab (Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_1de8e0067ddc99b5733809c9f029577d (Term Term) Term)

(declare-fun Tm_abs_925291133cb983c535e582da6e3f417b (Term Term Term Term) Term)
(declare-fun Tm_refine_8987b5eaa301b19a5f391020646b9f0d (Term Term Term Term Term) Term)

(declare-fun Tm_abs_48d7c0110f34e121c8f3a1fd2f271d52 (Term) Term)

(declare-fun Tm_abs_7df89594dfd738771afff801f7dc94c7 (Term Term Term) Term)
;;;;;;;;;;;;;;;;l0__x: label -> Prims.PURE (FStar.Pervasives.Native.option (b & label))
(declare-fun Tm_arrow_405a00a8d3f0408b462f149e78eb892d (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f__w: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type) ->     f: (_: label -> Prims.PURE (FStar.Pervasives.Native.option (a & label))) ->     g__w: (_: a -> _: label -> _: (_: FStar.Pervasives.Native.option (b & label) -> Type) -> Type) ->     g: (_: a -> _: label -> Prims.PURE (FStar.Pervasives.Native.option (b & label))) ->     l0__x: label   -> Prims.PURE (FStar.Pervasives.Native.option (b & label))
(declare-fun Tm_arrow_a60af9a614c300e3473ae0597206f4e9 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_bind_elab@tok () Term)
...
; </end encoding let _dm4f_IFC_bind_elab>


; encoding sigelt let _dm4f_IFC___proj__IFC__item__read_elab


; <Start encoding let _dm4f_IFC___proj__IFC__item__read_elab>

(declare-fun FStar.DM4F.IFC._dm4f_IFC___proj__IFC__item__read_elab (Term) Term)
(declare-fun Tm_refine_e6db35e188a7a74877a32cac868f2ec2 (Term Term) Term)
;;;;;;;;;;;;;;;;l0__x: label -> Prims.PURE (FStar.Pervasives.Native.option (Prims.bool & label))
(declare-fun Tm_arrow_71434f1c9190127d9b11f02bb7858e82 (Term) Term)
;;;;;;;;;;;;;;;;l: label -> l0__x: label -> Prims.PURE (FStar.Pervasives.Native.option (Prims.bool & label))
(declare-fun Tm_arrow_6894c9e2e50726a4ca24a40f405ab7a0 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC___proj__IFC__item__read_elab@tok () Term)


(declare-fun Tm_abs_4effcea99e7f171069277e8d6698debb (Term) Term)

; </end encoding let _dm4f_IFC___proj__IFC__item__read_elab>


; encoding sigelt let _dm4f_IFC___proj__IFC__item__read_complete_type


; <Start encoding let _dm4f_IFC___proj__IFC__item__read_complete_type>

(declare-fun FStar.DM4F.IFC._dm4f_IFC___proj__IFC__item__read_complete_type () Term)




; </end encoding let _dm4f_IFC___proj__IFC__item__read_complete_type>


; encoding sigelt let _dm4f_IFC___proj__IFC__item__write_elab


; <Start encoding let _dm4f_IFC___proj__IFC__item__write_elab>

(declare-fun FStar.DM4F.IFC._dm4f_IFC___proj__IFC__item__write_elab (Term Term) Term)
(declare-fun Tm_refine_2d03b2896560d0dfd0b0cf14fbd7498b (Term Term) Term)
;;;;;;;;;;;;;;;;l0__x: label -> Prims.PURE (FStar.Pervasives.Native.option (Prims.unit & label))
(declare-fun Tm_arrow_a05d6b2ce1aa97ae55e3088079b34e4b (Term) Term)
;;;;;;;;;;;;;;;;l: label -> b: Prims.bool -> l0__x: label   -> Prims.PURE (FStar.Pervasives.Native.option (Prims.unit & label))
(declare-fun Tm_arrow_0fc04a47062915c76ec63853490c1b0e () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC___proj__IFC__item__write_elab@tok () Term)


(declare-fun Tm_abs_f3b3138c25e160f17ba83d5c92ec63ea (Term) Term)

; </end encoding let _dm4f_IFC___proj__IFC__item__write_elab>


; encoding sigelt let _dm4f_IFC___proj__IFC__item__write_complete_type


; <Start encoding let _dm4f_IFC___proj__IFC__item__write_complete_type>

(declare-fun FStar.DM4F.IFC._dm4f_IFC___proj__IFC__item__write_complete_type () Term)




; </end encoding let _dm4f_IFC___proj__IFC__item__write_complete_type>


; encoding sigelt let _dm4f_IFC_repr


; <Start encoding let _dm4f_IFC_repr>



(declare-fun FStar.DM4F.IFC._dm4f_IFC_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp_a: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type)   -> Type
(declare-fun Tm_arrow_2fecde874a0b72187f87ee10e2a05948 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_repr@tok () Term)
...
; </end encoding let _dm4f_IFC_repr>


; encoding sigelt let _dm4f_IFC_pre


; <Start encoding let _dm4f_IFC_pre>

(declare-fun FStar.DM4F.IFC._dm4f_IFC_pre () Term)
;;;;;;;;;;;;;;;;_: label -> Type
(declare-fun Tm_arrow_587b21f168bac5c87063462eaa1a7b56 () Term)

; </end encoding let _dm4f_IFC_pre>


; encoding sigelt let _dm4f_IFC_post


; <Start encoding let _dm4f_IFC_post>

(declare-fun FStar.DM4F.IFC._dm4f_IFC_post (Term) Term)

(declare-fun FStar.DM4F.IFC._dm4f_IFC_post@tok () Term)


; </end encoding let _dm4f_IFC_post>


; encoding sigelt let _dm4f_IFC_wp


; <Start encoding let _dm4f_IFC_wp>

(declare-fun FStar.DM4F.IFC._dm4f_IFC_wp (Term) Term)

(declare-fun FStar.DM4F.IFC._dm4f_IFC_wp@tok () Term)



; </end encoding let _dm4f_IFC_wp>


; encoding sigelt let _dm4f_IFC_ctx


; <Start encoding let _dm4f_IFC_ctx>

(declare-fun FStar.DM4F.IFC._dm4f_IFC_ctx (Term Term) Term)

(declare-fun FStar.DM4F.IFC._dm4f_IFC_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> t
(declare-fun Tm_arrow_11c5a66c4dec3b7ce11ec7fac749334c (Term Term) Term)

; </end encoding let _dm4f_IFC_ctx>


; encoding sigelt let _dm4f_IFC_gctx


; <Start encoding let _dm4f_IFC_gctx>

(declare-fun FStar.DM4F.IFC._dm4f_IFC_gctx (Term Term) Term)

(declare-fun FStar.DM4F.IFC._dm4f_IFC_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Prims.GTot t
(declare-fun Tm_ghost_arrow_a366d920b997c92000b01dfe18b70c86 (Term Term) Term)

; </end encoding let _dm4f_IFC_gctx>


; encoding sigelt let _dm4f_IFC_pure


; <Start encoding let _dm4f_IFC_pure>


(declare-fun FStar.DM4F.IFC._dm4f_IFC_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> t
(declare-fun Tm_arrow_c5a55e37b6d67806070d368436d72c95 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_pure@tok () Term)


; </end encoding let _dm4f_IFC_pure>


; encoding sigelt let _dm4f_IFC_app


; <Start encoding let _dm4f_IFC_app>



;;;;;;;;;;;;;;;;_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_e3abd9c9ac226913e5fcdb8307e7a666 (Term Term Term) Term)



(declare-fun FStar.DM4F.IFC._dm4f_IFC_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Prims.GTot t1) ->     _: label ->     _: (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_2e41837858e63c45f43de2f721627fdb () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_app@tok () Term)
...
; </end encoding let _dm4f_IFC_app>


; encoding sigelt let _dm4f_IFC_lift1


; <Start encoding let _dm4f_IFC_lift1>




(declare-fun FStar.DM4F.IFC._dm4f_IFC_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Prims.GTot t1) ->     _: label ->     _: (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_e3235a4626a1eba909cd7ef335e38e03 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_lift1@tok () Term)
...
(declare-fun Tm_abs_0670af2aa60f59c510d2bb57449cc8a3 (Term Term Term Term) Term)

; </end encoding let _dm4f_IFC_lift1>


; encoding sigelt let _dm4f_IFC_lift2


; <Start encoding let _dm4f_IFC_lift2>
...
(declare-fun FStar.DM4F.IFC._dm4f_IFC_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Prims.GTot t1) ->     a2: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Prims.GTot t2) ->     _: label ->     _: (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_9913d2e06aa94c4d862006c21d0f7e53 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_lift2@tok () Term)
...
(declare-fun Tm_abs_6e0ab8e9db8a9259334665b47ae73504 (Term Term Term Term Term) Term)

; </end encoding let _dm4f_IFC_lift2>


; encoding sigelt let _dm4f_IFC_push


; <Start encoding let _dm4f_IFC_push>



;;;;;;;;;;;;;;;;_: t1 -> _: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Prims.GTot t2
(declare-fun Tm_arrow_98a259d8a6b134b39249c809e536bdc4 (Term Term Term) Term)

(declare-fun FStar.DM4F.IFC._dm4f_IFC_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f:       (_: t1 -> _: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type)           -> Prims.GTot t2) ->     _: label ->     _: (_: FStar.Pervasives.Native.option (a & label) -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_79e5ba268622ba1444d650566c4f0c02 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_push@tok () Term)





; </end encoding let _dm4f_IFC_push>


; encoding sigelt let _dm4f_IFC_wp_if_then_else


; <Start encoding let _dm4f_IFC_wp_if_then_else>

(declare-fun FStar.DM4F.IFC._dm4f_IFC_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type) ->     _: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type) ->     _: label ->     _: (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Type
(declare-fun Tm_arrow_fa742aa5282803d754d925724e88b558 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type) ->     _: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type) ->     _: label ->     _: (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Type
(declare-fun Tm_arrow_3c62c0b1e766e219222eee430b8e66e2 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_1011eb92523d8f32d5d30709f0ad6caf (Term) Term)
...
;;;;;;;;;;;;;;;;a1:       (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type)           -> Prims.GTot Prims.logical) ->     a2:       (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type)           -> Prims.GTot Prims.logical) ->     _: label ->     _: (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_bab21e105976e6fc539cda743512295d (Term) Term)
(declare-fun Tm_abs_c8be269c3a2e424eb91404c06665ba7d (Term Term) Term)

; </end encoding let _dm4f_IFC_wp_if_then_else>


; encoding sigelt let _dm4f_IFC_wp_close


; <Start encoding let _dm4f_IFC_wp_close>




(declare-fun FStar.DM4F.IFC._dm4f_IFC_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: b -> _: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type) ->     _: label ->     _: (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_ee896e077f28e83a698e540c76aa4ff9 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_wp_close@tok () Term)
...
(declare-fun Tm_abs_c2743c08d5511a7cccf1ee7344f5e92c (Term Term Term) Term)

; </end encoding let _dm4f_IFC_wp_close>


; encoding sigelt let _dm4f_IFC_stronger


; <Start encoding let _dm4f_IFC_stronger>





(declare-fun FStar.DM4F.IFC._dm4f_IFC_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type) ->     wp2: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_6223744238937a6c13cb7cd41f56f97b () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_stronger@tok () Term)
...
; </end encoding let _dm4f_IFC_stronger>


; encoding sigelt let _dm4f_IFC_ite_wp


; <Start encoding let _dm4f_IFC_ite_wp>




(declare-fun FStar.DM4F.IFC._dm4f_IFC_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type) ->     _: label ->     _: (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_af63c94c97c935957b0e5dc744802050 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_ite_wp@tok () Term)





; </end encoding let _dm4f_IFC_ite_wp>


; encoding sigelt let _dm4f_IFC_null_wp


; <Start encoding let _dm4f_IFC_null_wp>


(declare-fun FStar.DM4F.IFC._dm4f_IFC_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> _: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Prims.logical
(declare-fun Tm_arrow_c29cc657ae3bc6c1aa53d3fab92b2821 () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_null_wp@tok () Term)


; </end encoding let _dm4f_IFC_null_wp>


; encoding sigelt let _dm4f_IFC_wp_trivial


; <Start encoding let _dm4f_IFC_wp_trivial>



(declare-fun FStar.DM4F.IFC._dm4f_IFC_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: (_: label -> _: (_: FStar.Pervasives.Native.option (a & label) -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_4c202d0c137b7a699aba49c0d82f402a () Term)
(declare-fun FStar.DM4F.IFC._dm4f_IFC_wp_trivial@tok () Term)




; </end encoding let _dm4f_IFC_wp_trivial>


; encoding sigelt new_effect_for_free { IFC ... }


; <Start encoding new_effect_for_free { IFC ... }>





(declare-fun Tm_abs_98f01bb40611fa168b255f84dff40059 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IFC.__proj__IFC__item__read (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IFC.__proj__IFC__item__read@tok () Term)




(declare-fun Tm_abs_e52a42bc882fdff6318f07cfed50a991 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.IFC.__proj__IFC__item__write (Term Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.IFC.__proj__IFC__item__write@tok () Term)

; </end encoding new_effect_for_free { IFC ... }>


; encoding sigelt sub_effect PURE ~> IFC


; <Skipped sub_effect PURE ~> IFC/>


; encoding sigelt effect Ifc a req ens = FStar.DM4F.IFC.IFC a


; <Skipped effect Ifc a req ens = FStar.DM4F.IFC.IFC a/>


; encoding sigelt let lift_pure_exnst


; <Start encoding let lift_pure_exnst>


(declare-fun FStar.DM4F.IFC.lift_pure_exnst (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     wp: Prims.pure_wp a ->     h0: label ->     p: (_: FStar.Pervasives.Native.option (a & label) -> Type)   -> Prims.pure_pre
(declare-fun Tm_arrow_9fbdc7605889bde7acba134a299b6303 () Term)
(declare-fun FStar.DM4F.IFC.lift_pure_exnst@tok () Term)




; </end encoding let lift_pure_exnst>
...
; encoding sigelt let xor


; <Start encoding let xor>

(declare-fun FStar.DM4F.IFC.xor (Term Term) Term)
;;;;;;;;;;;;;;;;b1: Prims.bool -> b2: Prims.bool -> Prims.bool
(declare-fun Tm_arrow_a41b9b98d4288401e09e5c3b51ccc4f5 () Term)
(declare-fun FStar.DM4F.IFC.xor@tok () Term)

; </end encoding let xor>

(push) ;; push{2

; Starting query at FStar.DM4F.IFC.fst(71,0-72,58)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Prims.unit)
;   (l: FStar.DM4F.IFC.label)
;   (r: FStar.Pervasives.Native.option (Prims.unit & FStar.DM4F.IFC.label)).
;   (*  - Could not prove post-condition
; *)
;   Prims.hasEq (FStar.Pervasives.Native.option (Prims.unit & FStar.DM4F.IFC.label))


; Context: While encoding a query
; While typechecking the top-level declaration `val FStar.DM4F.IFC.p`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=FStar.DM4F.IFC.fst(71,0-72,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.unit)
(HasType @x1
FStar.DM4F.IFC.label)
(HasType @x2
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.unit
FStar.DM4F.IFC.label))))

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.IFC.fst(72,48-72,49)
(or label_1

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.IFC.fst(71,8-71,25)
(Valid 
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.IFC.fst(71,8-71,25)
(Prims.hasEq (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.unit
FStar.DM4F.IFC.label)))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IFC.p, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.IFC_pretyping_ec0bb0f1bf3d1d6b39e57751a23ec047, Prims_pretyping_f8666440faa91836cc5a13998af863fc, assumption_FStar.DM4F.IFC.label__uu___haseq, assumption_FStar.Pervasives.Native.option__uu___haseq, assumption_FStar.Pervasives.Native.tuple2__uu___haseq, equality_tok_FStar.DM4F.IFC.Low@tok, equation_Prims.eqtype, kinding_FStar.DM4F.IFC.label@tok, kinding_FStar.Pervasives.Native.tuple2@tok, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.unit, typing_tok_FStar.DM4F.IFC.Low@tok, unit_typing
...
; encoding sigelt val FStar.DM4F.IFC.p


; <Skipped val FStar.DM4F.IFC.p/>
...
; Starting query at FStar.DM4F.IFC.fst(73,10-79,28)
...
;   (*  - Could not prove post-condition
; *)
;   forall (_: FStar.DM4F.IFC.label)
;     (p: Prims.pure_post (FStar.Pervasives.Native.option (Prims.unit & FStar.DM4F.IFC.label))).
;     (forall (r: FStar.Pervasives.Native.option (Prims.unit & FStar.DM4F.IFC.label)).
;         r = FStar.Pervasives.Native.None ==> p r) ==>
;     (match
;         Prims.op_Negation ((match
;                 (match _ = FStar.DM4F.IFC.High with
;                   | true -> FStar.DM4F.IFC.High
;                   | _ -> FStar.DM4F.IFC.Low) =
;                 FStar.DM4F.IFC.High
;               with
;               | true -> FStar.DM4F.IFC.High
;               | _ -> FStar.DM4F.IFC.Low) =
...
;             true)
;       with
;       | true -> p FStar.Pervasives.Native.None <: Type0
;       | _ -> p FStar.Pervasives.Native.None <: Type0)


; Context: While encoding a query
; While typechecking the top-level declaration `let p`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IFC.fst(73,10-79,28)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
FStar.DM4F.IFC.label)
(HasType @x2
(Prims.pure_post (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.unit
FStar.DM4F.IFC.label))))

;; def=FStar.DM4F.IFC.fst(61,13-61,53); use=FStar.DM4F.IFC.fst(73,10-79,28)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 Prims.unit
FStar.DM4F.IFC.label)))

;; def=FStar.DM4F.IFC.fst(72,48-72,56); use=FStar.DM4F.IFC.fst(73,10-79,28)
(= @x3
(FStar.Pervasives.Native.None (FStar.Pervasives.Native.tuple2 Prims.unit
FStar.DM4F.IFC.label)))
)

;; def=FStar.DM4F.IFC.fst(61,49-61,52); use=FStar.DM4F.IFC.fst(73,10-79,28)
(Valid 
;; def=FStar.DM4F.IFC.fst(61,49-61,52); use=FStar.DM4F.IFC.fst(73,10-79,28)
(ApplyTT @x2
@x3)
...
(let ((@lb3 (Prims.op_Negation (Prims.op_AmpAmp (Prims.op_Equality FStar.DM4F.IFC.label
(let ((@lb3 (Prims.op_Equality FStar.DM4F.IFC.label
(let ((@lb3 (Prims.op_Equality FStar.DM4F.IFC.label
@x1
FStar.DM4F.IFC.High@tok)))
(ite (= @lb3
...
;; def=FStar.DM4F.IFC.fst(36,26-36,30); use=FStar.DM4F.IFC.fst(73,10-79,28)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IFC.p, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_typing_intro_FStar.Pervasives.Native.None@tok, equation_Prims.eqtype, kinding_FStar.DM4F.IFC.label@tok, kinding_FStar.Pervasives.Native.tuple2@tok, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.unit
