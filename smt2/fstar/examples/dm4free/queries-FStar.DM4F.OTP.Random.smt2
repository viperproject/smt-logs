...
; Externals for interface FStar.DM4F.OTP.Heap
...
; <Start encoding val FStar.DM4F.OTP.Heap.q>

(declare-fun FStar.DM4F.OTP.Heap.q (Dummy_sort) Term)

; </end encoding val FStar.DM4F.OTP.Heap.q>
...
; <Start encoding val FStar.DM4F.OTP.Heap.id>

(declare-fun FStar.DM4F.OTP.Heap.id (Dummy_sort) Term)

; </end encoding val FStar.DM4F.OTP.Heap.id>


; <Start encoding val FStar.DM4F.OTP.Heap.tape>

(declare-fun FStar.DM4F.OTP.Heap.tape (Dummy_sort) Term)

; </end encoding val FStar.DM4F.OTP.Heap.tape>


; <Start encoding val FStar.DM4F.OTP.Heap.to_id>
...
; </end encoding val FStar.DM4F.OTP.Heap.to_id>


; <Start encoding val FStar.DM4F.OTP.Heap.incrementable>
...
; </end encoding val FStar.DM4F.OTP.Heap.incrementable>


; <Start encoding val FStar.DM4F.OTP.Heap.incr>
...
; </end encoding val FStar.DM4F.OTP.Heap.incr>


; <Start encoding val FStar.DM4F.OTP.Heap.index>
...
; </end encoding val FStar.DM4F.OTP.Heap.index>
...
; <Start encoding val FStar.DM4F.OTP.Heap.upd>
...
; </end encoding val FStar.DM4F.OTP.Heap.upd>


; <Start encoding val FStar.DM4F.OTP.Heap.create>
...
; </end encoding val FStar.DM4F.OTP.Heap.create>


; <Start encoding val FStar.DM4F.OTP.Heap.equal>
...
; </end encoding val FStar.DM4F.OTP.Heap.equal>


; <Start encoding val FStar.DM4F.OTP.Heap.lemma_eq_intro>
...
; </end encoding val FStar.DM4F.OTP.Heap.lemma_eq_intro>


; <Start encoding val FStar.DM4F.OTP.Heap.lemma_eq_elim>
...
; </end encoding val FStar.DM4F.OTP.Heap.lemma_eq_elim>


; <Start encoding val FStar.DM4F.OTP.Heap.lemma_index_upd1>
...
; </end encoding val FStar.DM4F.OTP.Heap.lemma_index_upd1>


; <Start encoding val FStar.DM4F.OTP.Heap.lemma_index_upd2>
...
; </end encoding val FStar.DM4F.OTP.Heap.lemma_index_upd2>


; <Start encoding val FStar.DM4F.OTP.Heap.lemma_index_create>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.OTP.Heap.lemma_index_create (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.OTP.Heap.lemma_index_create@tok () Term)

; </end encoding val FStar.DM4F.OTP.Heap.lemma_index_create>


; End Externals for interface FStar.DM4F.OTP.Heap

(push) ;; push{1

; Internals for FStar.DM4F.OTP.Random
...
(declare-fun FStar.DM4F.OTP.Random.store () Term)
...
(declare-fun FStar.DM4F.OTP.Random.rand (Term) Term)

(declare-fun FStar.DM4F.OTP.Random.rand@tok () Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.M (FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_0544c8c34b509552650e81e269cbb91b (Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random.return (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> rand a
(declare-fun Tm_arrow_dc11d2d4784418042ed88ddab6c51d13 () Term)
(declare-fun FStar.DM4F.OTP.Random.return@tok () Term)
(declare-fun Tm_abs_a31e20bd6fb093afada42f14ce1dad44 (Term Term) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Random.rand; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,5-24,9); use=FStar.DM4F.OTP.Random.fst(24,5-24,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.OTP.Random.rand @x0)
Tm_type))
 

:pattern ((FStar.DM4F.OTP.Random.rand @x0))
:qid typing_FStar.DM4F.OTP.Random.rand))

:named typing_FStar.DM4F.OTP.Random.rand))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.tape; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(31,4-31,8); use=FStar.DM4F.OTP.Heap.fsti(31,4-31,8)
...
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(35,4-35,17); use=FStar.DM4F.OTP.Heap.fsti(35,4-35,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
...
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(29,4-29,6); use=FStar.DM4F.OTP.Heap.fsti(29,4-29,6)
(forall ((@u0 Dummy_sort))
...
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.incr; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(37,9-37,32); use=FStar.DM4F.OTP.Heap.fsti(37,9-37,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=FStar.DM4F.OTP.Heap.fsti(37,15-37,30); use=FStar.DM4F.OTP.Heap.fsti(37,15-37,30)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0544c8c34b509552650e81e269cbb91b
;;; Fact-ids: Name FStar.DM4F.OTP.Random.rand; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,53); use=FStar.DM4F.OTP.Random.fst(24,21-24,53)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_0544c8c34b509552650e81e269cbb91b @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_0544c8c34b509552650e81e269cbb91b @x0)
Tm_type))
:qid kinding_Tm_arrow_0544c8c34b509552650e81e269cbb91b))

:named kinding_Tm_arrow_0544c8c34b509552650e81e269cbb91b))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Random.rand
;;; Fact-ids: Name FStar.DM4F.OTP.Random.rand; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,5-24,9); use=FStar.DM4F.OTP.Random.fst(24,5-24,9)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.OTP.Random.rand @x0)
(Tm_arrow_0544c8c34b509552650e81e269cbb91b @x0))
 

:pattern ((FStar.DM4F.OTP.Random.rand @x0))
:qid equation_FStar.DM4F.OTP.Random.rand))

:named equation_FStar.DM4F.OTP.Random.rand))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_0544c8c34b509552650e81e269cbb91b @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_0544c8c34b509552650e81e269cbb91b @x2)))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_0544c8c34b509552650e81e269cbb91b))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_0544c8c34b509552650e81e269cbb91b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0544c8c34b509552650e81e269cbb91b
;;; Fact-ids: Name FStar.DM4F.OTP.Random.rand; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,53); use=FStar.DM4F.OTP.Random.fst(24,21-24,53)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_0544c8c34b509552650e81e269cbb91b @x1))
(and 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,53); use=FStar.DM4F.OTP.Random.fst(24,21-24,53)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.Pervasives.Native.tuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_0544c8c34b509552650e81e269cbb91b.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_0544c8c34b509552650e81e269cbb91b @x1)))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_0544c8c34b509552650e81e269cbb91b))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_0544c8c34b509552650e81e269cbb91b))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(29,2-33,33)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: a -> rand b
(declare-fun Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(28,10-28,45); use=FStar.DM4F.OTP.Random.fst(28,34-28,45)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6))

:named kinding_Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(28,10-28,45); use=FStar.DM4F.OTP.Random.fst(28,34-28,45)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6 @x2
@x3)))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(28,10-28,45); use=FStar.DM4F.OTP.Random.fst(28,34-28,45)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6 @x1
@x2))
(and 
;; def=FStar.DM4F.OTP.Random.fst(28,10-28,45); use=FStar.DM4F.OTP.Random.fst(28,34-28,45)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(FStar.DM4F.OTP.Random.rand @x1)))
 

:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6.1))
...
(Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6 @x1
@x2)))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (c: FStar.DM4F.OTP.Random.rand a)
;   (f: (_: a -> FStar.DM4F.OTP.Random.rand b)).
;   (*  - Could not prove post-condition
; *)
;   forall (s: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape).
;     (*  - Could not prove post-condition
; *)
;     forall (b: FStar.Pervasives.Native.option a) (b: FStar.DM4F.OTP.Heap.id).
;       c s == (b, b) ==>
;       (forall (k: Prims.pure_post (FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id)).
;           (forall (x: FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id).
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(29,2-33,33)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.Pervasives.Native.tuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)))

;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.OTP.Random.fst(29,10-33,33)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(FStar.Pervasives.Native.option @x0))
...
;; def=FStar.DM4F.OTP.Random.fst(30,8-30,15); use=FStar.DM4F.OTP.Random.fst(30,8-30,15)
(= (ApplyTT @x2
@x4)
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.OTP.Random.fst(29,10-33,33)
(forall ((@x8 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.OTP.Random.fst(29,10-33,33)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.OTP.Random.fst(29,10-33,33)
(ApplyTT @x7
@x8)
...
;; def=FStar.DM4F.OTP.Random.fst(30,8-30,9); use=FStar.DM4F.OTP.Random.fst(31,10-31,11)
(not 
;; def=FStar.DM4F.OTP.Random.fst(30,8-30,9); use=FStar.DM4F.OTP.Random.fst(31,10-31,11)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x0
@x5))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.bind, 1)
; STATUS: unsat
...
;;;;;;;;;;;;;;;;_: a -> rand b
(declare-fun Tm_arrow_72fbb58f30fb87a164b8e65ca981b9b6 (Term Term) Term)
(declare-fun FStar.DM4F.OTP.Random.bind (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> c: rand a -> f: (_: a -> rand b) -> rand b
(declare-fun Tm_arrow_ea0046100632666b04c8e320f0914cae () Term)
(declare-fun FStar.DM4F.OTP.Random.bind@tok () Term)

(declare-fun Tm_abs_b82f1e6d64ff9860e8db0f872587b61f (Term Term Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random.get (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> rand (FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape)
(declare-fun Tm_arrow_e576bbbcb9280a7eff87fca429485cd3 () Term)
(declare-fun FStar.DM4F.OTP.Random.get@tok () Term)
(declare-fun Tm_abs_1e5a95f2c5c572be9bda4d0400687648 () Term)
...
(declare-fun FStar.DM4F.OTP.Random.put (Term) Term)
;;;;;;;;;;;;;;;;i: FStar.DM4F.OTP.Heap.id -> rand Prims.unit
(declare-fun Tm_arrow_db115fd640cc77fb54bd8838cda1566a () Term)
(declare-fun FStar.DM4F.OTP.Random.put@tok () Term)
(declare-fun Tm_abs_e085da0642af1c0170978413b0cb2072 (Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random.raise (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> _: Prims.unit -> rand a
(declare-fun Tm_arrow_983967f23d115eb22678b876b4922e8a () Term)
(declare-fun FStar.DM4F.OTP.Random.raise@tok () Term)
(declare-fun Tm_abs_c69dc97a950b2d69e0ce19e15e783d0b (Term) Term)
...
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type
(declare-fun Tm_arrow_0e3760dc0b0ab5120e7d72e266807448 (Term) Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     p'': (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Type
(declare-fun Tm_arrow_f74f581fd07cf9a286005a97fd982dc6 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_lift_from_pure@tok () Term)




(declare-fun Tm_abs_c6831a47c779f5389650faa943c8d574 (Term Term Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_return_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;_: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type) -> Type
(declare-fun Tm_arrow_a7b798979494219cd26018d905356370 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     x: a ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Type
(declare-fun Tm_arrow_478d72a0ece66fcdd3043c389f769f16 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_return_wp@tok () Term)





(declare-fun Tm_abs_ba6288c205586743de4883eb0c200b7c (Term Term Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_return_elab (Term Term) Term)
(declare-fun Tm_refine_0a6a5b5e2c12d46c5b848ce33c373ec9 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_9f22be201fe1a7a61f75f93a3624b38f (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_79be8a8ac89c9044c920744977ed992a () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_return_elab@tok () Term)
...
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Type
(declare-fun Tm_arrow_b4c1df240ce566fa2ed72c11efed6f70 (Term) Term)


;;;;;;;;;;;;;;;;_: a ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id -> Type)   -> Type
(declare-fun Tm_arrow_8e7c1da86bff76e37b80e741c0a0855a (Term Term) Term)

(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     c:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     f:       (             _: a ->             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     s: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     p'': (_: FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id -> Type)   -> Type
(declare-fun Tm_arrow_ffd607693f17b99e0bd89e8616f9d751 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_bind_wp@tok () Term)
...
(declare-fun Tm_abs_263219dbf23e16c7761b87929f8d3976 (Term Term Term Term Term) Term)
...
(declare-fun Tm_refine_d0bce8f1f70335b7edd1307bd39771a2 (Term) Term)

;;;;;;;;;;;;;;;;y: _: (FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id){Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_d127275704e4779e9eb993e5c1b91efb (Term) Term)
(declare-fun Tm_abs_0feef353f5af3acf1a6238f64e3383dc (Term Term) Term)
(declare-fun Tm_refine_60405dac0b8c4682099c2e9d3e047840 (Term Term Term) Term)



(declare-fun Tm_abs_eb38a952433365d802933040cd64ee2a (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_3fb9efd4d5b429ae52c8b254881a150d (Term Term) Term)
...
(declare-fun Tm_refine_266cf20a0986e62e93be56bcc260ac17 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_35826255e74e0805d6f3e710bb1a8c22 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_5081efff24f2a7e5c79764e960236dfd (Term Term Term) Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_bind_elab (Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_b86fb3f7c296a611eb3654258b46ba88 (Term Term Term Term Term) Term)
(declare-fun Tm_refine_0a834d52de4921411ba04235908b59be (Term Term Term Term Term) Term)





(declare-fun Tm_abs_15ec35760a96a08bca29cc09fb142a2d (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s__x: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_b64b0b2cf8ff9075814cdcc5bd275f48 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     c__w:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     c:       (_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape           -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id)) ->     f__w:       (             _: a ->             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     f:       (_: a -> _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape           -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id)) ->     s__x: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option b & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_4c6587b2fb010c58307bf6d887da25b3 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_bind_elab@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab (Term) Term)
(declare-fun Tm_refine_832ed264c4fd10a49c73dd82c26bd333 (Term) Term)
;;;;;;;;;;;;;;;;s__x: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE     (FStar.Pervasives.Native.option (FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape) &       FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_caf863278b60918447a365337bcab26f () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> s__x: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE     (FStar.Pervasives.Native.option (FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape) &       FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab@tok () Term)


(declare-fun Tm_abs_905568eda7f67f1801eaeecdb9c0177c () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_complete_type () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab (Term) Term)
(declare-fun Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option Prims.unit & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_04ee35e5c29784972ce320095d61de29 (Term) Term)
;;;;;;;;;;;;;;;;i: FStar.DM4F.OTP.Heap.id -> _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option Prims.unit & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_complete_type () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab (Term Term) Term)
(declare-fun Tm_refine_e983a4e582e3ac4ad088f2b259df1574 (Term Term) Term)
;;;;;;;;;;;;;;;;s__x: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_150ac79b4e386f38de800c6ee30721f3 (Term) Term)
;;;;;;;;;;;;;;;;a: Type -> _: Prims.unit -> s__x: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_70d5271e919fdfbaf5141dce18620207 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab@tok () Term)


(declare-fun Tm_abs_dd8724145141a3bcee421f2185d31b03 (Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_complete_type () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp_a:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type)   -> Type
(declare-fun Tm_arrow_33563b9f0cb2cc8dd968dfa05e29078a () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_repr@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_pre () Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape -> Type
(declare-fun Tm_arrow_13f82a6975884b4c70415c34b8dd54fe () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_post (Term) Term)

(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_post@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_wp (Term) Term)

(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_wp@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_ctx (Term Term) Term)

(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> t
(declare-fun Tm_arrow_f4d115e9f78d3245310646f47ba055e0 (Term Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_gctx (Term Term) Term)

(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.GTot t
(declare-fun Tm_ghost_arrow_3e3e20e935d3edb0cb2a69d492eead09 (Term Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> t
(declare-fun Tm_arrow_23b715f3ab27be841866e58283a4634e () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_pure@tok () Term)
...
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_9e789ff56d0c43fbf27f65ad9e02e959 (Term Term Term) Term)



(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Prims.GTot t1) ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_d74cc4197333f321ccbdd2a6fa38b89a () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_app@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Prims.GTot t1) ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_0ba3e0a0dd10478272f96efc1279f156 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_lift1@tok () Term)
...
(declare-fun Tm_abs_05cd380bd90b6cdcf66aedca518db1ff (Term Term Term Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Prims.GTot t1) ->     a2:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Prims.GTot t2) ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_6df705da374da4d318ff218215f126ef () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_lift2@tok () Term)
...
(declare-fun Tm_abs_110d4838e88621462435c6accfc47717 (Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;_: t1 ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_8389076d4db9b31c4523c2822eff021d (Term Term Term) Term)

(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f:       (             _: t1 ->             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Prims.GTot t2) ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_2d55f8e404b6dc49d04fc6f728fc63b5 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_push@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     _:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Type
(declare-fun Tm_arrow_833bc3927344c22e1185678a71d53b54 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     _:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Type
(declare-fun Tm_arrow_bfd20425abfddbba7ef3065a0432173d () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_cf3187c8cd0c0a88c91e2831f58afa50 (Term) Term)
...
;;;;;;;;;;;;;;;;a1:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Prims.GTot Prims.logical) ->     a2:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Prims.GTot Prims.logical) ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_90a2ffb74f69ab76ac0698ba7666fbc8 (Term) Term)
(declare-fun Tm_abs_80c7d3c58f2dde1d40440690017b7d77 (Term Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f:       (             _: b ->             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_a08930f707c3fa0feaa2c3dc07398d91 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_wp_close@tok () Term)
...
(declare-fun Tm_abs_a0c58d58802869dac2a02d2407048a40 (Term Term Term) Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     wp2:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_8060ceb478e65071e90345baee64d97d () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_stronger@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type) ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.logical
(declare-fun Tm_arrow_e3047e0c1df1c9a55d4816eaf5c648b7 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_ite_wp@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->     _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)   -> Prims.logical
(declare-fun Tm_arrow_572fc9c8cc75b6fe1f4fdcbbdfea6939 () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_null_wp@tok () Term)
...
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp:       (             _: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape ->             _: (_: FStar.Pervasives.Native.option a & FStar.DM4F.OTP.Heap.id -> Type)           -> Type)   -> Prims.logical
(declare-fun Tm_arrow_f00cc81bf7c28bbed5f065f218a6b5cc () Term)
(declare-fun FStar.DM4F.OTP.Random._dm4f_RAND_wp_trivial@tok () Term)
...
(declare-fun Tm_abs_1b12fa825dfc555f2845b85867dd0ae0 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.OTP.Random.__proj__RAND__item__get (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.OTP.Random.__proj__RAND__item__get@tok () Term)




(declare-fun Tm_abs_e174caa253d9f4561255ed46be7f1316 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.OTP.Random.__proj__RAND__item__put (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.OTP.Random.__proj__RAND__item__put@tok () Term)




(declare-fun Tm_abs_60c8c6d8c9e1a5d4bb194217e06b2ef7 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.OTP.Random.__proj__RAND__item__raise (Term Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.OTP.Random.__proj__RAND__item__raise@tok () Term)
...
; encoding sigelt effect Rand a = FStar.DM4F.OTP.Random.RAND a


; <Skipped effect Rand a = FStar.DM4F.OTP.Random.RAND a/>
...
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(25,4-25,5); use=FStar.DM4F.OTP.Heap.fsti(25,4-25,5)
(forall ((@u0 Dummy_sort))
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.to_id; Namespace FStar.DM4F.OTP.Heap
...
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.to_id; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(33,10-33,27); use=FStar.DM4F.OTP.Heap.fsti(33,10-33,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Heap.fsti(33,17-33,25)
(< (BoxInt_proj_0 @x1)
...
; Starting query at FStar.DM4F.OTP.Random.fst(59,10-61,22)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem & FStar.DM4F.OTP.Heap.id -> Type
(declare-fun Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a
Tm_type)
:named kinding_Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,38-24,53); use=FStar.DM4F.OTP.Random.fst(59,30-59,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,38-24,53); use=FStar.DM4F.OTP.Random.fst(59,30-59,34)
(forall ((@x0 Term))
...
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value)))
(HasType (ApplyTT @x0
@x1)
Tm_type))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a))

; Encoding query formula : forall (_: Prims.unit)
;   (_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape)
;   (p:
;   (_: FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem & FStar.DM4F.OTP.Heap.id -> Type0)).
;   (*  - Could not prove post-condition
; *)
;   forall (b: FStar.DM4F.OTP.Heap.id) (b: FStar.DM4F.OTP.Heap.tape).
;     _ == (b, b) ==>
;     (forall (k: Prims.pure_post Type0).
;         (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;         FStar.DM4F.OTP.Heap.incrementable b == true ==> FStar.DM4F.OTP.Heap.incrementable b)


; Context: While encoding a query
; While typechecking the top-level declaration `val FStar.DM4F.OTP.Random.sample`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(59,10-61,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.unit)
(HasType @x1
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.OTP.Random.fst(59,22-59,39)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.DM4F.OTP.Heap.id Dummy_value))
...
;; def=FStar.DM4F.OTP.Random.fst(59,46-59,52); use=FStar.DM4F.OTP.Random.fst(59,22-59,39)
(= @x1
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
@x3
@x4))
)

;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(59,22-59,39)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.pure_post Tm_type))

;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.OTP.Random.fst(59,22-59,39)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.OTP.Random.fst(59,22-59,39)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.OTP.Random.fst(59,22-59,39)
(ApplyTT @x5
@x6)
...
;; def=FStar.DM4F.OTP.Random.fst(60,5-60,23); use=FStar.DM4F.OTP.Random.fst(59,22-59,39)
(= (FStar.DM4F.OTP.Heap.incrementable @x3)
(BoxBool true))
)

;; def=FStar.DM4F.OTP.Heap.fsti(37,15-37,30); use=FStar.DM4F.OTP.Random.fst(60,58-60,62)
(or label_1

;; def=FStar.DM4F.OTP.Heap.fsti(37,15-37,30); use=FStar.DM4F.OTP.Random.fst(59,22-59,39)
(BoxBool_proj_0 (FStar.DM4F.OTP.Heap.incrementable @x3))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.sample, 1)
; STATUS: unsat
...
; encoding sigelt val FStar.DM4F.OTP.Random.sample


; <Skipped val FStar.DM4F.OTP.Random.sample/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.index; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(39,4-39,9); use=FStar.DM4F.OTP.Heap.fsti(39,4-39,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(HasType @x1
...
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.incr; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(37,4-37,8); use=FStar.DM4F.OTP.Heap.fsti(37,4-37,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_aff078fed7f4c0267d7d97ac63cc368c)
(HasType (FStar.DM4F.OTP.Heap.incr @x0)
(FStar.DM4F.OTP.Heap.id Dummy_value)))
 

:pattern ((FStar.DM4F.OTP.Heap.incr @x0))
:qid typing_FStar.DM4F.OTP.Heap.incr))

:named typing_FStar.DM4F.OTP.Heap.incr))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(62,15-70,23)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,38-24,53); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a)
...
;   (*  - Could not prove post-condition
; *)
;   forall (_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape)
;     (p:
;     Prims.pure_post (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem &
;         FStar.DM4F.OTP.Heap.id)).
;     (let next, t = _ in
;       (match FStar.DM4F.OTP.Heap.incrementable next with
;         | true ->
;           p (FStar.Pervasives.Native.Some (FStar.DM4F.OTP.Heap.index t next),
;             FStar.DM4F.OTP.Heap.incr next)
;         | _ -> p (FStar.Pervasives.Native.None, next))
;       <:
;       Type0) ==>
;     (forall (e1: FStar.DM4F.OTP.Heap.id) (e1: FStar.DM4F.OTP.Heap.tape).
;         _ == (e1, e1) ==>
;         (forall (k:
;             (_: FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem & FStar.DM4F.OTP.Heap.id
;                 -> Type0)).
;             (forall (a1:
;                 FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem & FStar.DM4F.OTP.Heap.id).
;                 {:pattern Prims.guard_free (k a1)}
;                 k a1 <==> p a1) ==>
;             (FStar.DM4F.OTP.Heap.incrementable e1 = true ==>
;               FStar.DM4F.OTP.Heap.incrementable e1 == true ==>
;               FStar.DM4F.OTP.Heap.incrementable e1 /\
;               (forall (any_result: FStar.DM4F.OTP.Heap.id).
;                   e1 == any_result ==>
;                   (forall (any_result: FStar.DM4F.OTP.Heap.id).
;                       FStar.DM4F.OTP.Heap.incr e1 == any_result ==>
;                       k (FStar.Pervasives.Native.Some (FStar.DM4F.OTP.Heap.index e1 e1),
;                         FStar.DM4F.OTP.Heap.incr e1)
;                       <:
;                       Type0))) /\
;             (~(FStar.DM4F.OTP.Heap.incrementable e1 = true) ==>
;               (forall (e1: Prims.bool).
;                   FStar.DM4F.OTP.Heap.incrementable e1 == e1 ==>
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
(FStar.Pervasives.Native.tuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)))
(HasType @x2
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value))))
(let ((@lb3 @x1))
(let ((@lb4 (FStar.DM4F.OTP.Heap.incrementable (FStar.Pervasives.Native.Mktuple2__1 @lb3))))
(ite (= @lb4
(BoxBool true))

;; def=FStar.DM4F.OTP.Random.fst(60,29-60,63); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(60,29-60,63); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.Pervasives.Native.Some FStar.DM4F.OTP.Heap.elem
(FStar.DM4F.OTP.Heap.index (FStar.Pervasives.Native.Mktuple2__2 @lb3)
(FStar.Pervasives.Native.Mktuple2__1 @lb3)))
(FStar.DM4F.OTP.Heap.incr (FStar.Pervasives.Native.Mktuple2__1 @lb3))))
)


;; def=FStar.DM4F.OTP.Random.fst(61,7-61,21); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(61,7-61,21); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.Pervasives.Native.None FStar.DM4F.OTP.Heap.elem)
(FStar.Pervasives.Native.Mktuple2__1 @lb3)))
)
))))
...
;; def=FStar.DM4F.OTP.Random.fst(63,6-63,13); use=FStar.DM4F.OTP.Random.fst(63,6-63,13)
(= @x1
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
@x3
...
;; def=Prims.fst(221,62-221,85); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(and (implies 
;; def=Prims.fst(221,62-221,71); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(and 
;; def=FStar.DM4F.OTP.Random.fst(64,5-64,23); use=FStar.DM4F.OTP.Random.fst(64,5-64,23)
(= (FStar.DM4F.OTP.Heap.incrementable @x3)
(BoxBool true))
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(37,15-37,30); use=FStar.DM4F.OTP.Random.fst(66,20-66,24)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fsti(37,10-37,11); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(= @x3
@x6)
)
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(= (FStar.DM4F.OTP.Heap.incr @x3)
@x7)
)

;; def=FStar.DM4F.OTP.Random.fst(26,53-26,65); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(or label_2
...
(implies 
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.OTP.Random.fst(62,15-70,23)
(not 
;; def=FStar.DM4F.OTP.Random.fst(64,5-64,23); use=FStar.DM4F.OTP.Random.fst(64,5-64,23)
(= (FStar.DM4F.OTP.Heap.incrementable @x3)
(BoxBool true))
...
;; def=FStar.DM4F.OTP.Random.fst(64,5-70,23); use=FStar.DM4F.OTP.Random.fst(64,5-70,23)
(= (FStar.DM4F.OTP.Heap.incrementable @x3)
@x6)
)

;; def=FStar.DM4F.OTP.Random.fst(42,42-42,53); use=FStar.DM4F.OTP.Random.fst(70,10-70,15)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.sample, 2)
; STATUS: unsat
...
(declare-fun FStar.DM4F.OTP.Random.sample (Term) Term)
(declare-fun Non_total_Tm_arrow_4fab1587dbc2ecb5cc847b6e68a4c2a7 () Term)
(declare-fun FStar.DM4F.OTP.Random.sample@tok () Term)
(declare-fun Tm_refine_03a578a32186c85a6294c5dde709df60 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape   -> Prims.PURE (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3 () Term)
(declare-fun Tm_abs_4b51d4348f512b7d30438281c51aea6a (Term) Term)

; </end encoding let sample>

;;;;;;;;;;;;;;;;typing_Tm_abs_e174caa253d9f4561255ed46be7f1316
;;; Fact-ids: Name FStar.DM4F.OTP.Random.RAND; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_abs_e174caa253d9f4561255ed46be7f1316
Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6)
:named typing_Tm_abs_e174caa253d9f4561255ed46be7f1316))
;;;;;;;;;;;;;;;;typing_Tm_abs_60c8c6d8c9e1a5d4bb194217e06b2ef7
;;; Fact-ids: Name FStar.DM4F.OTP.Random.RAND; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_abs_60c8c6d8c9e1a5d4bb194217e06b2ef7
Tm_arrow_70d5271e919fdfbaf5141dce18620207)
:named typing_Tm_abs_60c8c6d8c9e1a5d4bb194217e06b2ef7))
;;;;;;;;;;;;;;;;typing_Tm_abs_1b12fa825dfc555f2845b85867dd0ae0
;;; Fact-ids: Name FStar.DM4F.OTP.Random.RAND; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_abs_1b12fa825dfc555f2845b85867dd0ae0
Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9)
:named typing_Tm_abs_1b12fa825dfc555f2845b85867dd0ae0))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sample; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(62,4-62,10); use=FStar.DM4F.OTP.Random.fst(62,4-62,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.unit)
(HasType (FStar.DM4F.OTP.Random.sample @x0)
Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3))
 

:pattern ((FStar.DM4F.OTP.Random.sample @x0))
:qid typing_FStar.DM4F.OTP.Random.sample))

:named typing_FStar.DM4F.OTP.Random.sample))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.to_id; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(33,4-33,9); use=FStar.DM4F.OTP.Heap.fsti(33,4-33,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_ab1935d06c5b83d762f98a79720546e5)
(HasType (FStar.DM4F.OTP.Heap.to_id @x0)
(FStar.DM4F.OTP.Heap.id Dummy_value)))
 

:pattern ((FStar.DM4F.OTP.Heap.to_id @x0))
:qid typing_FStar.DM4F.OTP.Heap.to_id))

:named typing_FStar.DM4F.OTP.Heap.to_id))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.sel; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(40,4-40,7); use=FStar.DM4F.OTP.Heap.fsti(40,4-40,7)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(HasType @x1
(FStar.DM4F.OTP.Heap.id Dummy_value)))
(HasType (FStar.DM4F.OTP.Heap.sel @x0
@x1)
FStar.DM4F.OTP.Heap.elem))
 

:pattern ((FStar.DM4F.OTP.Heap.sel @x0
@x1))
:qid typing_FStar.DM4F.OTP.Heap.sel))

:named typing_FStar.DM4F.OTP.Heap.sel))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_dd8724145141a3bcee421f2185d31b03
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(42,42-42,53); use=FStar.DM4F.OTP.Random.fst(42,42-42,53)
(forall ((@x0 Term))
 (! (IsTotFun (Tm_abs_dd8724145141a3bcee421f2185d31b03 @x0))
 

:pattern ((Tm_abs_dd8724145141a3bcee421f2185d31b03 @x0))
:qid tot_fun_Tm_abs_dd8724145141a3bcee421f2185d31b03))

:named tot_fun_Tm_abs_dd8724145141a3bcee421f2185d31b03))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_905568eda7f67f1801eaeecdb9c0177c
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! (IsTotFun Tm_abs_905568eda7f67f1801eaeecdb9c0177c)
:named tot_fun_Tm_abs_905568eda7f67f1801eaeecdb9c0177c))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_4b51d4348f512b7d30438281c51aea6a
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sample; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(29,10-33,33); use=FStar.DM4F.OTP.Random.fst(29,10-33,33)
(forall ((@x0 Term))
 (! (IsTotFun (Tm_abs_4b51d4348f512b7d30438281c51aea6a @x0))
 

:pattern ((Tm_abs_4b51d4348f512b7d30438281c51aea6a @x0))
:qid tot_fun_Tm_abs_4b51d4348f512b7d30438281c51aea6a))

:named tot_fun_Tm_abs_4b51d4348f512b7d30438281c51aea6a))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.OTP.Random.fst(42,42-42,53)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_e983a4e582e3ac4ad088f2b259df1574 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_e983a4e582e3ac4ad088f2b259df1574 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_e983a4e582e3ac4ad088f2b259df1574))

:named refinement_kinding_Tm_refine_e983a4e582e3ac4ad088f2b259df1574))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.OTP.Random.fst(36,35-36,48)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_832ed264c4fd10a49c73dd82c26bd333 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_832ed264c4fd10a49c73dd82c26bd333 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_832ed264c4fd10a49c73dd82c26bd333))

:named refinement_kinding_Tm_refine_832ed264c4fd10a49c73dd82c26bd333))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.OTP.Random.fst(39,33-39,43)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75))

:named refinement_kinding_Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sample; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,38-24,53); use=FStar.DM4F.OTP.Random.fst(24,38-24,53)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_03a578a32186c85a6294c5dde709df60 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_03a578a32186c85a6294c5dde709df60 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_03a578a32186c85a6294c5dde709df60))

:named refinement_kinding_Tm_refine_03a578a32186c85a6294c5dde709df60))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.OTP.Random.fst(42,42-42,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e983a4e582e3ac4ad088f2b259df1574 @x2
@x3))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.OTP.Random.fst(42,42-42,53)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.OTP.Random.fst(42,42-42,53)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.OTP.Random.fst(42,42-42,53)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option @x2)
(FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.Pervasives.Native.None @x2)
(let ((@lb4 @x3))
...
(Tm_refine_e983a4e582e3ac4ad088f2b259df1574 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_e983a4e582e3ac4ad088f2b259df1574))

:named refinement_interpretation_Tm_refine_e983a4e582e3ac4ad088f2b259df1574))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.OTP.Random.fst(36,35-36,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_832ed264c4fd10a49c73dd82c26bd333 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)))
(FStar.DM4F.OTP.Heap.id Dummy_value)))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.OTP.Random.fst(36,35-36,48)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.OTP.Random.fst(36,35-36,48)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.OTP.Random.fst(36,35-36,48)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)))
(FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.Pervasives.Native.Some (FStar.Pervasives.Native.tuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value))
@x2)
(let ((@lb3 @x2))
(FStar.Pervasives.Native.Mktuple2__1 @lb3)))
...
@x1
(Tm_refine_832ed264c4fd10a49c73dd82c26bd333 @x2)))
:qid refinement_interpretation_Tm_refine_832ed264c4fd10a49c73dd82c26bd333))

:named refinement_interpretation_Tm_refine_832ed264c4fd10a49c73dd82c26bd333))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.OTP.Random.fst(39,33-39,43)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.DM4F.OTP.Heap.id Dummy_value)))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.OTP.Random.fst(39,33-39,43)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.OTP.Random.fst(39,33-39,43)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.OTP.Random.fst(39,33-39,43)
...
@x1
(Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75 @x2)))
:qid refinement_interpretation_Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75))

:named refinement_interpretation_Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sample; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,38-24,53); use=FStar.DM4F.OTP.Random.fst(24,38-24,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_03a578a32186c85a6294c5dde709df60 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value)))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.OTP.Random.fst(24,38-24,53)
(not (let ((@lb3 @x2))
(let ((@lb4 (FStar.DM4F.OTP.Heap.incrementable (FStar.Pervasives.Native.Mktuple2__1 @lb3))))
(ite (= @lb4
(BoxBool true))

;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.OTP.Random.fst(24,38-24,53)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.OTP.Random.fst(24,38-24,53)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value)
...
@x1
(Tm_refine_03a578a32186c85a6294c5dde709df60 @x2)))
:qid refinement_interpretation_Tm_refine_03a578a32186c85a6294c5dde709df60))

:named refinement_interpretation_Tm_refine_03a578a32186c85a6294c5dde709df60))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name FStar.Pervasives.Native.__proj__Mktuple2__item___2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,43-59,45); use=FStar.Pervasives.Native.fst(59,43-59,45)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_caf863278b60918447a365337bcab26f
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_arrow_caf863278b60918447a365337bcab26f
Tm_type)
:named kinding_Tm_arrow_caf863278b60918447a365337bcab26f))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_70d5271e919fdfbaf5141dce18620207
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_arrow_70d5271e919fdfbaf5141dce18620207
Tm_type)
:named kinding_Tm_arrow_70d5271e919fdfbaf5141dce18620207))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9
Tm_type)
:named kinding_Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sample; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3
Tm_type)
:named kinding_Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6
Tm_type)
:named kinding_Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_150ac79b4e386f38de800c6ee30721f3
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,32); use=FStar.DM4F.OTP.Random.fst(24,21-42,53)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_150ac79b4e386f38de800c6ee30721f3 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_150ac79b4e386f38de800c6ee30721f3 @x0)
Tm_type))
:qid kinding_Tm_arrow_150ac79b4e386f38de800c6ee30721f3))

:named kinding_Tm_arrow_150ac79b4e386f38de800c6ee30721f3))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_04ee35e5c29784972ce320095d61de29
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,32); use=FStar.DM4F.OTP.Random.fst(24,21-39,43)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_04ee35e5c29784972ce320095d61de29 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_04ee35e5c29784972ce320095d61de29 @x0)
Tm_type))
:qid kinding_Tm_arrow_04ee35e5c29784972ce320095d61de29))

:named kinding_Tm_arrow_04ee35e5c29784972ce320095d61de29))
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
...
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e174caa253d9f4561255ed46be7f1316
;;; Fact-ids: Name FStar.DM4F.OTP.Random.RAND; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(39,33-39,43); use=FStar.DM4F.OTP.Random.fst(39,33-39,43)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_e174caa253d9f4561255ed46be7f1316
@x0)
(Tm_abs_e085da0642af1c0170978413b0cb2072 @x0))
 

:pattern ((ApplyTT Tm_abs_e174caa253d9f4561255ed46be7f1316
@x0))
:qid interpretation_Tm_abs_e174caa253d9f4561255ed46be7f1316))

:named interpretation_Tm_abs_e174caa253d9f4561255ed46be7f1316))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_e085da0642af1c0170978413b0cb2072
;;; Fact-ids: Name FStar.DM4F.OTP.Random.put; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(39,33-39,43); use=FStar.DM4F.OTP.Random.fst(39,33-39,43)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_e085da0642af1c0170978413b0cb2072 @x1)
@x0)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.Pervasives.Native.Some Prims.unit
...
:pattern ((ApplyTT (Tm_abs_e085da0642af1c0170978413b0cb2072 @x1)
@x0))
:qid interpretation_Tm_abs_e085da0642af1c0170978413b0cb2072))

:named interpretation_Tm_abs_e085da0642af1c0170978413b0cb2072))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_dd8724145141a3bcee421f2185d31b03
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(42,42-42,53); use=FStar.DM4F.OTP.Random.fst(42,42-42,53)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_dd8724145141a3bcee421f2185d31b03 @x1)
@x0)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option @x1)
(FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.Pervasives.Native.None @x1)
(let ((@lb2 @x0))
...
:pattern ((ApplyTT (Tm_abs_dd8724145141a3bcee421f2185d31b03 @x1)
@x0))
:qid interpretation_Tm_abs_dd8724145141a3bcee421f2185d31b03))

:named interpretation_Tm_abs_dd8724145141a3bcee421f2185d31b03))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_905568eda7f67f1801eaeecdb9c0177c
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(36,35-36,48); use=FStar.DM4F.OTP.Random.fst(36,35-36,48)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_905568eda7f67f1801eaeecdb9c0177c
@x0)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)))
(FStar.DM4F.OTP.Heap.id Dummy_value)
...
:pattern ((ApplyTT Tm_abs_905568eda7f67f1801eaeecdb9c0177c
@x0))
:qid interpretation_Tm_abs_905568eda7f67f1801eaeecdb9c0177c))

:named interpretation_Tm_abs_905568eda7f67f1801eaeecdb9c0177c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_60c8c6d8c9e1a5d4bb194217e06b2ef7
;;; Fact-ids: Name FStar.DM4F.OTP.Random.RAND; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(42,42-42,53); use=FStar.DM4F.OTP.Random.fst(42,42-42,53)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Tm_abs_60c8c6d8c9e1a5d4bb194217e06b2ef7
@x0)
@x1)
(Tm_abs_dd8724145141a3bcee421f2185d31b03 @x0))
 

:pattern ((ApplyTT (ApplyTT Tm_abs_60c8c6d8c9e1a5d4bb194217e06b2ef7
@x0)
@x1))
:qid interpretation_Tm_abs_60c8c6d8c9e1a5d4bb194217e06b2ef7))

:named interpretation_Tm_abs_60c8c6d8c9e1a5d4bb194217e06b2ef7))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_4b51d4348f512b7d30438281c51aea6a
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sample; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(29,10-33,33); use=FStar.DM4F.OTP.Random.fst(29,10-33,33)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_4b51d4348f512b7d30438281c51aea6a @x1)
@x0)
(let ((@lb2 (ApplyTT (FStar.DM4F.OTP.Random.__proj__RAND__item__put (FStar.DM4F.OTP.Heap.incr (FStar.Pervasives.Native.Mktuple2__1 @x1)))
@x0)))
...
(FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.Pervasives.Native.Some FStar.DM4F.OTP.Heap.elem
(FStar.DM4F.OTP.Heap.index (FStar.Pervasives.Native.Mktuple2__2 @x1)
(FStar.Pervasives.Native.Mktuple2__1 @x1)))
(FStar.Pervasives.Native.Mktuple2__2 @lb2))
Tm_unit)))))
 

:pattern ((ApplyTT (Tm_abs_4b51d4348f512b7d30438281c51aea6a @x1)
@x0))
:qid interpretation_Tm_abs_4b51d4348f512b7d30438281c51aea6a))

:named interpretation_Tm_abs_4b51d4348f512b7d30438281c51aea6a))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_1b12fa825dfc555f2845b85867dd0ae0
;;; Fact-ids: Name FStar.DM4F.OTP.Random.RAND; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(36,35-36,48); use=FStar.DM4F.OTP.Random.fst(36,35-36,48)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_1b12fa825dfc555f2845b85867dd0ae0
@x0)
Tm_abs_905568eda7f67f1801eaeecdb9c0177c)
 

:pattern ((ApplyTT Tm_abs_1b12fa825dfc555f2845b85867dd0ae0
@x0))
:qid interpretation_Tm_abs_1b12fa825dfc555f2845b85867dd0ae0))

:named interpretation_Tm_abs_1b12fa825dfc555f2845b85867dd0ae0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e983a4e582e3ac4ad088f2b259df1574
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.OTP.Random.fst(42,42-42,53)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e983a4e582e3ac4ad088f2b259df1574 @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option @x0)
(FStar.DM4F.OTP.Heap.id Dummy_value)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e983a4e582e3ac4ad088f2b259df1574 @x0
@x1))))
:qid haseqTm_refine_e983a4e582e3ac4ad088f2b259df1574))

:named haseqTm_refine_e983a4e582e3ac4ad088f2b259df1574))
;;;;;;;;;;;;;;;;haseq for Tm_refine_832ed264c4fd10a49c73dd82c26bd333
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.OTP.Random.fst(36,35-36,48)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_832ed264c4fd10a49c73dd82c26bd333 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option (FStar.Pervasives.Native.tuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)))
(FStar.DM4F.OTP.Heap.id Dummy_value)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_832ed264c4fd10a49c73dd82c26bd333 @x0))))
:qid haseqTm_refine_832ed264c4fd10a49c73dd82c26bd333))

:named haseqTm_refine_832ed264c4fd10a49c73dd82c26bd333))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.OTP.Random.fst(39,33-39,43)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.unit)
(FStar.DM4F.OTP.Heap.id Dummy_value)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75 @x0))))
:qid haseqTm_refine_0aa825fd3ba7e4770ab6823ce07a8b75))

:named haseqTm_refine_0aa825fd3ba7e4770ab6823ce07a8b75))
;;;;;;;;;;;;;;;;haseq for Tm_refine_03a578a32186c85a6294c5dde709df60
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sample; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,38-24,53); use=FStar.DM4F.OTP.Random.fst(24,38-24,53)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_03a578a32186c85a6294c5dde709df60 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value)))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_03a578a32186c85a6294c5dde709df60 @x0))))
:qid haseqTm_refine_03a578a32186c85a6294c5dde709df60))

:named haseqTm_refine_03a578a32186c85a6294c5dde709df60))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.equals; Namespace Prims; Name Prims.Refl; Namespace Prims
(assert (! 
;; def=Prims.fst(165,5-165,11); use=Prims.fst(165,5-165,11)
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Random.sample
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sample; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(62,4-62,10); use=FStar.DM4F.OTP.Random.fst(62,4-62,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (FStar.DM4F.OTP.Random.sample @x0)
@x1)
(let ((@lb2 (ApplyTT (FStar.DM4F.OTP.Random.__proj__RAND__item__get Tm_unit)
@x1)))
(let ((@lb3 (FStar.Pervasives.Native.Mktuple2__1 @lb2)))
(ite (is-FStar.Pervasives.Native.None @lb3)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
...
(FStar.Pervasives.Native.Mktuple2__2 @lb2))
(ite (is-FStar.Pervasives.Native.Some @lb3)
(ApplyTT (let ((@lb4 (FStar.Pervasives.Native.Some_v @lb3)))
(let ((@lb5 (FStar.DM4F.OTP.Heap.incrementable (FStar.Pervasives.Native.Mktuple2__1 @lb4))))
(ite (= @lb5
(BoxBool true))
(Tm_abs_4b51d4348f512b7d30438281c51aea6a @lb4)
(FStar.DM4F.OTP.Random.__proj__RAND__item__raise FStar.DM4F.OTP.Heap.elem
Tm_unit))))
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.Pervasives.Native.Mktuple2__2 @lb2)
(FStar.Pervasives.Native.snd (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
@x1)))
Tm_unit)))))
 

:pattern ((ApplyTT (FStar.DM4F.OTP.Random.sample @x0)
@x1))
:qid equation_FStar.DM4F.OTP.Random.sample))

:named equation_FStar.DM4F.OTP.Random.sample))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Heap.sel
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.sel; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(40,4-40,7); use=FStar.DM4F.OTP.Heap.fsti(40,4-40,7)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.OTP.Heap.sel @x0
@x1)
...
:pattern ((FStar.DM4F.OTP.Heap.sel @x0
@x1))
:qid equation_FStar.DM4F.OTP.Heap.sel))

:named equation_FStar.DM4F.OTP.Heap.sel))
;;;;;;;;;;;;;;;;Eq2 interpretation
;;; Fact-ids: Name Prims.eq2; Namespace Prims
...
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,32); use=FStar.DM4F.OTP.Random.fst(24,21-36,48)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_caf863278b60918447a365337bcab26f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_caf863278b60918447a365337bcab26f))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_caf863278b60918447a365337bcab26f))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_caf863278b60918447a365337bcab26f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-42,21); use=FStar.DM4F.OTP.Random.fst(24,21-42,53)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_70d5271e919fdfbaf5141dce18620207)
...
@x1
Tm_arrow_70d5271e919fdfbaf5141dce18620207))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_70d5271e919fdfbaf5141dce18620207))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_70d5271e919fdfbaf5141dce18620207))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-36,10); use=FStar.DM4F.OTP.Random.fst(24,21-36,48)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9)
...
@x1
Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sample; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,53); use=FStar.DM4F.OTP.Random.fst(24,21-24,53)
...
@x1
Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,52); use=FStar.DM4F.OTP.Random.fst(24,21-39,43)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6)
...
@x1
Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,32); use=FStar.DM4F.OTP.Random.fst(24,21-42,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_150ac79b4e386f38de800c6ee30721f3 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_150ac79b4e386f38de800c6ee30721f3 @x2)))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_150ac79b4e386f38de800c6ee30721f3))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_150ac79b4e386f38de800c6ee30721f3))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,32); use=FStar.DM4F.OTP.Random.fst(24,21-39,43)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_04ee35e5c29784972ce320095d61de29 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_04ee35e5c29784972ce320095d61de29 @x2)))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_04ee35e5c29784972ce320095d61de29))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_04ee35e5c29784972ce320095d61de29))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_caf863278b60918447a365337bcab26f
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,32); use=FStar.DM4F.OTP.Random.fst(24,21-36,48)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_refine_832ed264c4fd10a49c73dd82c26bd333 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_caf863278b60918447a365337bcab26f.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_caf863278b60918447a365337bcab26f))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_caf863278b60918447a365337bcab26f))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_caf863278b60918447a365337bcab26f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_70d5271e919fdfbaf5141dce18620207
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-42,21); use=FStar.DM4F.OTP.Random.fst(24,21-42,53)
(forall ((@x0 Term))
...
@x1)
@x2)
(Tm_arrow_150ac79b4e386f38de800c6ee30721f3 @x1)))
 

:pattern ((ApplyTT (ApplyTT @x0
@x1)
@x2))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_70d5271e919fdfbaf5141dce18620207.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_70d5271e919fdfbaf5141dce18620207.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_70d5271e919fdfbaf5141dce18620207))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_70d5271e919fdfbaf5141dce18620207))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_70d5271e919fdfbaf5141dce18620207))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__get_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-36,10); use=FStar.DM4F.OTP.Random.fst(24,21-36,48)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_2e605c670f77ba3ce34788ee3ba9d6d9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sample; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,53); use=FStar.DM4F.OTP.Random.fst(24,21-24,53)
(forall ((@x0 Term))
...
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,53); use=FStar.DM4F.OTP.Random.fst(24,21-24,53)
(forall ((@x1 Term))
 (! (implies (and (let ((@lb2 @x1))
(let ((@lb3 (FStar.DM4F.OTP.Heap.incrementable (FStar.Pervasives.Native.Mktuple2__1 @lb2))))
true))
(HasType @x1
(FStar.Pervasives.Native.tuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value))))
(HasType (ApplyTT @x0
@x1)
(Tm_refine_03a578a32186c85a6294c5dde709df60 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,52); use=FStar.DM4F.OTP.Random.fst(24,21-39,43)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_04ee35e5c29784972ce320095d61de29 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_1824942f4bd77f162bcb49a4fbc984b6))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_150ac79b4e386f38de800c6ee30721f3
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__raise_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,32); use=FStar.DM4F.OTP.Random.fst(24,21-42,53)
(forall ((@x0 Term) (@x1 Term))
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_e983a4e582e3ac4ad088f2b259df1574 @x1
@x2)))
 

:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_150ac79b4e386f38de800c6ee30721f3.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_150ac79b4e386f38de800c6ee30721f3 @x1)))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_150ac79b4e386f38de800c6ee30721f3))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_150ac79b4e386f38de800c6ee30721f3))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_04ee35e5c29784972ce320095d61de29
;;; Fact-ids: Name FStar.DM4F.OTP.Random._dm4f_RAND___proj__RAND__item__put_elab; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,21-24,32); use=FStar.DM4F.OTP.Random.fst(24,21-39,43)
(forall ((@x0 Term) (@x1 Term))
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_0aa825fd3ba7e4770ab6823ce07a8b75 @x1)))
 

:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_04ee35e5c29784972ce320095d61de29.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_04ee35e5c29784972ce320095d61de29 @x1)))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_04ee35e5c29784972ce320095d61de29))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_04ee35e5c29784972ce320095d61de29))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.OTP.Random.RAND; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(51,7-51,12); use=FStar.DM4F.OTP.Random.fst(51,7-51,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.OTP.Random.__proj__RAND__item__raise @x0
@x1)
(ApplyTT (ApplyTT Tm_abs_60c8c6d8c9e1a5d4bb194217e06b2ef7
@x0)
@x1))
...
:pattern ((FStar.DM4F.OTP.Random.__proj__RAND__item__raise @x0
@x1))
:qid FStar.DM4F.OTP.Random.__proj__RAND__item__raise_equality))

:named FStar.DM4F.OTP.Random.__proj__RAND__item__raise_equality))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.OTP.Random.RAND; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(50,7-50,10); use=FStar.DM4F.OTP.Random.fst(50,7-50,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.OTP.Random.__proj__RAND__item__put @x0)
(ApplyTT Tm_abs_e174caa253d9f4561255ed46be7f1316
@x0))
 

:pattern ((FStar.DM4F.OTP.Random.__proj__RAND__item__put @x0))
:qid FStar.DM4F.OTP.Random.__proj__RAND__item__put_equality))

:named FStar.DM4F.OTP.Random.__proj__RAND__item__put_equality))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.OTP.Random.RAND; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(49,7-49,10); use=FStar.DM4F.OTP.Random.fst(49,7-49,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.OTP.Random.__proj__RAND__item__get @x0)
(ApplyTT Tm_abs_1b12fa825dfc555f2845b85867dd0ae0
@x0))
 

:pattern ((FStar.DM4F.OTP.Random.__proj__RAND__item__get @x0))
:qid FStar.DM4F.OTP.Random.__proj__RAND__item__get_equality))

:named FStar.DM4F.OTP.Random.__proj__RAND__item__get_equality))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(77,4-79,45)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_529f0938ee325e340663f57c504a39b5 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(73,30-77,2); use=FStar.DM4F.OTP.Random.fst(73,30-77,2)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_529f0938ee325e340663f57c504a39b5 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_529f0938ee325e340663f57c504a39b5 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_529f0938ee325e340663f57c504a39b5))

:named refinement_kinding_Tm_refine_529f0938ee325e340663f57c504a39b5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(73,30-77,2); use=FStar.DM4F.OTP.Random.fst(73,30-77,2)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_529f0938ee325e340663f57c504a39b5 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=FStar.DM4F.OTP.Random.fst(74,2-74,22); use=FStar.DM4F.OTP.Random.fst(74,2-74,22)
(= (FStar.DM4F.OTP.Heap.sel @x1
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0)))
@x2)


;; def=FStar.DM4F.OTP.Random.fst(75,2-75,25); use=FStar.DM4F.OTP.Random.fst(75,2-75,25)
(BoxBool_proj_0 (FStar.DM4F.OTP.Heap.incrementable (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))))


;; def=FStar.DM4F.OTP.Random.fst(76,2-76,27); use=FStar.DM4F.OTP.Random.fst(76,2-76,27)
(= (FStar.DM4F.OTP.Heap.incr (FStar.DM4F.OTP.Heap.to_id (BoxInt 0)))
(FStar.DM4F.OTP.Heap.to_id (BoxInt 1)))
))
...
@x1
(Tm_refine_529f0938ee325e340663f57c504a39b5 @x2)))
:qid refinement_interpretation_Tm_refine_529f0938ee325e340663f57c504a39b5))

:named refinement_interpretation_Tm_refine_529f0938ee325e340663f57c504a39b5))
;;;;;;;;;;;;;;;;haseq for Tm_refine_529f0938ee325e340663f57c504a39b5
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(73,30-77,2); use=FStar.DM4F.OTP.Random.fst(73,30-77,2)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_529f0938ee325e340663f57c504a39b5 @x0)))
(Valid (Prims.hasEq (FStar.DM4F.OTP.Heap.tape Dummy_value))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_529f0938ee325e340663f57c504a39b5 @x0))))
:qid haseqTm_refine_529f0938ee325e340663f57c504a39b5))

:named haseqTm_refine_529f0938ee325e340663f57c504a39b5))
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem & FStar.DM4F.OTP.Heap.id -> Type
(declare-fun Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a
;;; Fact-ids: 
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,38-24,53); use=FStar.DM4F.OTP.Random.fst(78,17-78,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a)
...
; Encoding query formula : forall (v: FStar.DM4F.OTP.Heap.elem)
;   (t:
...
;       FStar.DM4F.OTP.Heap.incr (FStar.DM4F.OTP.Heap.to_id 0) == FStar.DM4F.OTP.Heap.to_id 1 }).
;   (*  - Could not prove post-condition
; *)
;   (forall (_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape)
;       (p:
...
;           -> Prims.PURE
;             (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem & FStar.DM4F.OTP.Heap.id))).
;       reify (FStar.DM4F.OTP.Random.sample ()) == any_result ==>
;       0 < FStar.DM4F.OTP.Heap.size /\
;       (forall (any_result: Prims.int).
;           0 == any_result ==>
;           (forall (any_result: FStar.DM4F.OTP.Heap.id).
;               FStar.DM4F.OTP.Heap.to_id 0 == any_result ==>
;               (forall (any_result: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape).
;                   (FStar.DM4F.OTP.Heap.to_id 0, t) == any_result ==>
;                   (match FStar.DM4F.OTP.Heap.incrementable (FStar.DM4F.OTP.Heap.to_id 0) with
;                     | true ->
;                       reify (FStar.DM4F.OTP.Random.sample ()) (FStar.DM4F.OTP.Heap.to_id 0, t) ==
;                       (FStar.Pervasives.Native.Some
;                       (FStar.DM4F.OTP.Heap.index t (FStar.DM4F.OTP.Heap.to_id 0)),
;                       FStar.DM4F.OTP.Heap.incr (FStar.DM4F.OTP.Heap.to_id 0)) ==>
;                       1 < FStar.DM4F.OTP.Heap.size /\
;                       (forall (any_result: Prims.int).
;                           1 == any_result ==>
;                           (forall (any_result: FStar.DM4F.OTP.Heap.id).
;                               FStar.DM4F.OTP.Heap.to_id 1 == any_result ==>
;                               (forall (any_result:
;                                   FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem &
;                                   FStar.DM4F.OTP.Heap.id).
;                                   (FStar.Pervasives.Native.Some v,
;                                   FStar.DM4F.OTP.Heap.to_id 1) ==
;                                   any_result ==>
;                                   (forall (any_result: Prims.logical).
;                                       reify (FStar.DM4F.OTP.Random.sample ())
;                                         (FStar.DM4F.OTP.Heap.to_id 0,
;                                         t) ==
;                                       (FStar.Pervasives.Native.Some v,
;                                       FStar.DM4F.OTP.Heap.to_id 1) ==
;                                       any_result ==>
...
FStar.DM4F.OTP.Heap.elem)
(HasType @x1
(Tm_refine_529f0938ee325e340663f57c504a39b5 @x0)))

;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.OTP.Random.fst(78,17-78,23)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.DM4F.OTP.Heap.id Dummy_value))
...
;; def=FStar.DM4F.OTP.Random.fst(59,46-59,52); use=FStar.DM4F.OTP.Random.fst(78,17-78,23)
(= @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
@x4
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.OTP.Random.fst(78,17-78,23)
(forall ((@x7 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.OTP.Random.fst(78,17-78,23)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.OTP.Random.fst(78,17-78,23)
(ApplyTT @x6
@x7)
...
;; def=FStar.DM4F.OTP.Random.fst(60,5-60,23); use=FStar.DM4F.OTP.Random.fst(78,17-78,23)
(= (FStar.DM4F.OTP.Heap.incrementable @x4)
(BoxBool true))
)
...
;; def=FStar.DM4F.OTP.Heap.fsti(37,15-37,30); use=FStar.DM4F.OTP.Random.fst(78,17-78,23)
(BoxBool_proj_0 (FStar.DM4F.OTP.Heap.incrementable @x4))
)
)
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3)

;; def=FStar.DM4F.OTP.Random.fst(78,6-78,26); use=FStar.DM4F.OTP.Random.fst(78,6-78,26)
(= (FStar.DM4F.OTP.Random.sample Tm_unit)
@x2)
)

;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(79,19-79,20)
(or label_2
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,11-33,12); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= (BoxInt 0)
@x3)
)
...
;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x4)
)
...
(let ((@lb6 (FStar.DM4F.OTP.Heap.incrementable (FStar.DM4F.OTP.Heap.to_id (BoxInt 0)))))
(ite (= @lb6
(BoxBool true))
(implies 
;; def=Prims.fst(175,35-175,36); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= (ApplyTT (FStar.DM4F.OTP.Random.sample Tm_unit)
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x1))
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(79,42-79,43)
(or label_3
...
;; def=FStar.Pervasives.Native.fst(59,43-59,45); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 1))
@x8)
)
...
;; def=Prims.fst(175,42-175,43); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.Pervasives.Native.Some FStar.DM4F.OTP.Heap.elem
@x0)
...
;; def=Prims.fst(672,13-672,14); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= (Prims.eq2 (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value))
(ApplyTT (FStar.DM4F.OTP.Random.sample Tm_unit)
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
...
;; def=FStar.DM4F.OTP.Random.fst(79,9-79,45); use=FStar.DM4F.OTP.Random.fst(79,2-79,8)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.test_sample_some, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, bool_inversion, equation_FStar.DM4F.OTP.Heap.sel, equation_FStar.DM4F.OTP.Heap.size, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_529f0938ee325e340663f57c504a39b5, typing_FStar.DM4F.OTP.Heap.incrementable
...
; Starting query at FStar.DM4F.OTP.Random.fst(73,0-79,45)
...
; *)
;   forall (t: FStar.DM4F.OTP.Heap.tape).
;     0 < FStar.DM4F.OTP.Heap.size /\
;     (FStar.DM4F.OTP.Heap.sel t (FStar.DM4F.OTP.Heap.to_id 0) == v ==> 0 < FStar.DM4F.OTP.Heap.size) /\
;     (FStar.DM4F.OTP.Heap.sel t (FStar.DM4F.OTP.Heap.to_id 0) == v /\
;       FStar.DM4F.OTP.Heap.incrementable (FStar.DM4F.OTP.Heap.to_id 0) ==>
;       0 < FStar.DM4F.OTP.Heap.size /\
;       (forall (any_result: Prims.int).
...
;               FStar.DM4F.OTP.Heap.to_id 0 == any_result ==>
;               FStar.DM4F.OTP.Heap.incrementable (FStar.DM4F.OTP.Heap.to_id 0) /\
;               (forall (return_val: i: FStar.DM4F.OTP.Heap.id{FStar.DM4F.OTP.Heap.incrementable i}).
;                   return_val == FStar.DM4F.OTP.Heap.to_id 0 ==>
;                   FStar.DM4F.OTP.Heap.to_id 0 == return_val ==>
;                   (forall (any_result: FStar.DM4F.OTP.Heap.id).
;                       FStar.DM4F.OTP.Heap.incr (FStar.DM4F.OTP.Heap.to_id 0) == any_result ==>
;                       1 < FStar.DM4F.OTP.Heap.size)))))
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(74,15-74,16)
(or label_1

;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(< (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
)

(implies 
;; def=FStar.DM4F.OTP.Random.fst(74,2-74,22); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= (FStar.DM4F.OTP.Heap.sel @x1
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0)))
@x0)


;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(75,23-75,24)
(or label_2
...
(implies 
;; def=FStar.DM4F.OTP.Random.fst(74,2-75,25); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(and 
;; def=FStar.DM4F.OTP.Random.fst(74,2-74,22); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= (FStar.DM4F.OTP.Heap.sel @x1
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0)))
...
;; def=FStar.DM4F.OTP.Random.fst(75,2-75,25); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(BoxBool_proj_0 (FStar.DM4F.OTP.Heap.incrementable (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))))
)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(76,14-76,15)
(or label_3
...
;; def=FStar.DM4F.OTP.Heap.fsti(37,9-37,32); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x3)
)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(37,15-37,30); use=FStar.DM4F.OTP.Random.fst(76,7-76,16)
(or label_4

;; def=FStar.DM4F.OTP.Heap.fsti(37,15-37,30); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(BoxBool_proj_0 (FStar.DM4F.OTP.Heap.incrementable (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))))
)


;; def=Prims.fst(356,2-356,58); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_refine_aff078fed7f4c0267d7d97ac63cc368c)

;; def=Prims.fst(356,26-356,41); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= @x4
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0)))


;; def=FStar.DM4F.OTP.Heap.fsti(37,10-37,11); use=FStar.DM4F.OTP.Random.fst(77,4-79,45)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x4)
)
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(76,26-76,27)
(or label_5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.test_sample_some, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.DM4F.OTP.Heap.size, projection_inverse_BoxInt_proj_0
...
(declare-fun Tm_refine_529f0938ee325e340663f57c504a39b5 (Term) Term)
(declare-fun FStar.DM4F.OTP.Random.test_sample_some (Term Term) Term)
...
(declare-fun Tm_arrow_d977549a851228ff140a7e0dafb05030 () Term)
(declare-fun FStar.DM4F.OTP.Random.test_sample_some@tok () Term)
...
; Starting query at FStar.DM4F.OTP.Random.fst(82,75-84,43)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_25b90748bb5adddca3db9d1f72c972aa () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_25b90748bb5adddca3db9d1f72c972aa
Tm_type)
:named refinement_kinding_Tm_refine_25b90748bb5adddca3db9d1f72c972aa))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(82,30-82,73); use=FStar.DM4F.OTP.Random.fst(82,30-82,73)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_25b90748bb5adddca3db9d1f72c972aa)
(and (HasTypeFuel @u0
@x1
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(not (BoxBool_proj_0 (FStar.DM4F.OTP.Heap.incrementable (FStar.DM4F.OTP.Heap.to_id (BoxInt 9)))))))
 

:pattern ((HasTypeFuel @u0
@x1
Tm_refine_25b90748bb5adddca3db9d1f72c972aa))
:qid refinement_interpretation_Tm_refine_25b90748bb5adddca3db9d1f72c972aa))

:named refinement_interpretation_Tm_refine_25b90748bb5adddca3db9d1f72c972aa))
;;;;;;;;;;;;;;;;haseq for Tm_refine_25b90748bb5adddca3db9d1f72c972aa
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_25b90748bb5adddca3db9d1f72c972aa))
(Valid (Prims.hasEq (FStar.DM4F.OTP.Heap.tape Dummy_value))))
:named haseqTm_refine_25b90748bb5adddca3db9d1f72c972aa))
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem & FStar.DM4F.OTP.Heap.id -> Type
(declare-fun Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a
;;; Fact-ids: 
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(24,38-24,53); use=FStar.DM4F.OTP.Random.fst(83,17-83,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_dcf636f9169cd4cd599d89387c15ff8a)
...
;             (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem & FStar.DM4F.OTP.Heap.id))).
;       reify (FStar.DM4F.OTP.Random.sample ()) == any_result ==>
;       9 < FStar.DM4F.OTP.Heap.size /\
;       (forall (any_result: Prims.int).
;           9 == any_result ==>
;           (forall (any_result: FStar.DM4F.OTP.Heap.id).
;               FStar.DM4F.OTP.Heap.to_id 9 == any_result ==>
;               (forall (any_result: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape).
;                   (FStar.DM4F.OTP.Heap.to_id 9, t) == any_result ==>
;                   (match FStar.DM4F.OTP.Heap.incrementable (FStar.DM4F.OTP.Heap.to_id 9) with
;                     | true ->
;                       reify (FStar.DM4F.OTP.Random.sample ()) (FStar.DM4F.OTP.Heap.to_id 9, t) ==
;                       (FStar.Pervasives.Native.Some
;                       (FStar.DM4F.OTP.Heap.index t (FStar.DM4F.OTP.Heap.to_id 9)),
;                       FStar.DM4F.OTP.Heap.incr (FStar.DM4F.OTP.Heap.to_id 9)) ==>
;                       9 < FStar.DM4F.OTP.Heap.size /\
;                       (forall (any_result: Prims.int).
;                           9 == any_result ==>
;                           (forall (any_result: FStar.DM4F.OTP.Heap.id).
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
(FStar.Pervasives.Native.tuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.OTP.Random.fst(83,17-83,23)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.DM4F.OTP.Heap.id Dummy_value))
...
;; def=FStar.DM4F.OTP.Random.fst(59,46-59,52); use=FStar.DM4F.OTP.Random.fst(83,17-83,23)
(= @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
@x4
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.OTP.Random.fst(83,17-83,23)
(forall ((@x7 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.OTP.Random.fst(83,17-83,23)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.OTP.Random.fst(83,17-83,23)
(ApplyTT @x6
@x7)
...
;; def=FStar.DM4F.OTP.Random.fst(60,5-60,23); use=FStar.DM4F.OTP.Random.fst(83,17-83,23)
(= (FStar.DM4F.OTP.Heap.incrementable @x4)
(BoxBool true))
)
...
;; def=FStar.DM4F.OTP.Heap.fsti(37,15-37,30); use=FStar.DM4F.OTP.Random.fst(83,17-83,23)
(BoxBool_proj_0 (FStar.DM4F.OTP.Heap.incrementable @x4))
)
)
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_arrow_19b50565b2f27cf009cfcafec0e5d5e3)

;; def=FStar.DM4F.OTP.Random.fst(83,6-83,27); use=FStar.DM4F.OTP.Random.fst(83,6-83,27)
(= (FStar.DM4F.OTP.Random.sample Tm_unit)
@x2)
)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(84,19-84,20)
(or label_2

;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(84,19-84,20)
(< (BoxInt_proj_0 (BoxInt 9))
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
)
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,11-33,12); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(= (BoxInt 9)
@x3)
)
...
;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 9))
@x4)
)
...
(let ((@lb6 (FStar.DM4F.OTP.Heap.incrementable (FStar.DM4F.OTP.Heap.to_id (BoxInt 9)))))
(ite (= @lb6
(BoxBool true))
(implies 
;; def=Prims.fst(175,35-175,36); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(= (ApplyTT (FStar.DM4F.OTP.Random.sample Tm_unit)
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 9))
...
(FStar.DM4F.OTP.Heap.index @x1
(FStar.DM4F.OTP.Heap.to_id (BoxInt 9))))
(FStar.DM4F.OTP.Heap.incr (FStar.DM4F.OTP.Heap.to_id (BoxInt 9)))))


;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(84,40-84,41)
(or label_3
...
;; def=FStar.Pervasives.Native.fst(59,43-59,45); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 9))
@x8)
)
...
;; def=Prims.fst(175,42-175,43); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.Pervasives.Native.None FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 9)))
...
;; def=Prims.fst(672,13-672,14); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(= (Prims.eq2 (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option FStar.DM4F.OTP.Heap.elem)
(FStar.DM4F.OTP.Heap.id Dummy_value))
(ApplyTT (FStar.DM4F.OTP.Random.sample Tm_unit)
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
...
;; def=FStar.DM4F.OTP.Random.fst(84,9-84,43); use=FStar.DM4F.OTP.Random.fst(84,2-84,8)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.test_sample_none, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.OTP.Heap.size, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_25b90748bb5adddca3db9d1f72c972aa
...
; Starting query at FStar.DM4F.OTP.Random.fst(82,0-84,43)
...
;   forall (t: FStar.DM4F.OTP.Heap.tape).
;     (*  - Subtyping check failed
;   - Expected type n: Prims.nat{n < FStar.DM4F.OTP.Heap.size} got type Prims.int
; *)
;     9 < FStar.DM4F.OTP.Heap.size
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(82,66-82,67)
(or label_1

;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(82,75-84,43)
(< (BoxInt_proj_0 (BoxInt 9))
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.test_sample_none, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.DM4F.OTP.Heap.size, projection_inverse_BoxInt_proj_0
...
(declare-fun Tm_refine_25b90748bb5adddca3db9d1f72c972aa () Term)
(declare-fun FStar.DM4F.OTP.Random.test_sample_none (Term Term) Term)
...
(declare-fun Tm_arrow_43526bcaf6d62af6816f5725c4170d84 () Term)
(declare-fun FStar.DM4F.OTP.Random.test_sample_none@tok () Term)


; </end encoding let test_sample_none>


; encoding sigelt type FStar.DM4F.OTP.Random.bijection


; <Start encoding type FStar.DM4F.OTP.Random.bijection>

;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.OTP.Random.bijection () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.DM4F.OTP.Random.Bijection (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.DM4F.OTP.Random.Bijection_f (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.DM4F.OTP.Random.Bijection_finv (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: FStar.DM4F.OTP.Random.Bijection
(declare-fun FStar.DM4F.OTP.Random.Bijection@tok () Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.tape -> FStar.DM4F.OTP.Heap.tape
(declare-fun Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a () Term)

(declare-fun Tm_refine_6e1cd8b072e751339d1179e813fda863 (Term) Term)



;;;;;;;;;;;;;;;;f: (_: FStar.DM4F.OTP.Heap.tape -> FStar.DM4F.OTP.Heap.tape) ->     finv:       (_: FStar.DM4F.OTP.Heap.tape -> FStar.DM4F.OTP.Heap.tape)         { forall (h: FStar.DM4F.OTP.Heap.tape).             FStar.DM4F.OTP.Heap.equal (f (finv h)) h /\ FStar.DM4F.OTP.Heap.equal (finv (f h)) h }   -> bijection
(declare-fun Tm_arrow_18ff85fcb78dc8a4d8096747c7f47c9a () Term)

; <start constructor FStar.DM4F.OTP.Random.bijection>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.DM4F.OTP.Random.bijection ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
799)
(= __@x0
FStar.DM4F.OTP.Random.bijection)))

; </end constructor FStar.DM4F.OTP.Random.bijection>
...
810)
(= __@x0
(FStar.DM4F.OTP.Random.Bijection (FStar.DM4F.OTP.Random.Bijection_f __@x0)
(FStar.DM4F.OTP.Random.Bijection_finv __@x0)))))

; </end constructor FStar.DM4F.OTP.Random.Bijection>


; </end encoding type FStar.DM4F.OTP.Random.bijection>


; encoding sigelt val FStar.DM4F.OTP.Random.uu___is_Bijection


; <Start encoding val FStar.DM4F.OTP.Random.uu___is_Bijection>

(declare-fun FStar.DM4F.OTP.Random.uu___is_Bijection (Term) Term)
;;;;;;;;;;;;;;;;projectee: bijection -> Prims.bool
(declare-fun Tm_arrow_3bdbe9e51d4a959655269525db472158 () Term)
(declare-fun FStar.DM4F.OTP.Random.uu___is_Bijection@tok () Term)

; </end encoding val FStar.DM4F.OTP.Random.uu___is_Bijection>
...
; encoding sigelt val FStar.DM4F.OTP.Random.__proj__Bijection__item__f


; <Start encoding val FStar.DM4F.OTP.Random.__proj__Bijection__item__f>

(declare-fun FStar.DM4F.OTP.Random.__proj__Bijection__item__f (Term) Term)

;;;;;;;;;;;;;;;;projectee: bijection -> _: FStar.DM4F.OTP.Heap.tape -> FStar.DM4F.OTP.Heap.tape
(declare-fun Tm_arrow_0f59050e554c927a077f6dfc0cc3c751 () Term)
(declare-fun FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok () Term)


; </end encoding val FStar.DM4F.OTP.Random.__proj__Bijection__item__f>
...
; encoding sigelt val FStar.DM4F.OTP.Random.__proj__Bijection__item__finv


; <Start encoding val FStar.DM4F.OTP.Random.__proj__Bijection__item__finv>

(declare-fun FStar.DM4F.OTP.Random.__proj__Bijection__item__finv (Term) Term)


(declare-fun Tm_refine_87095c1bc0678f440c68c2adbbc8c31e (Term) Term)
;;;;;;;;;;;;;;;;projectee: bijection   -> finv:     (_: FStar.DM4F.OTP.Heap.tape -> FStar.DM4F.OTP.Heap.tape)       { forall (h: FStar.DM4F.OTP.Heap.tape).           FStar.DM4F.OTP.Heap.equal (projectee.f (finv h)) h /\           FStar.DM4F.OTP.Heap.equal (finv (projectee.f h)) h }
(declare-fun Tm_arrow_392a2de039cc1e000ab2f19079dab964 () Term)
(declare-fun FStar.DM4F.OTP.Random.__proj__Bijection__item__finv@tok () Term)





; </end encoding val FStar.DM4F.OTP.Random.__proj__Bijection__item__finv>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__finv; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(90,6-90,10); use=FStar.DM4F.OTP.Random.fst(90,6-90,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FStar.DM4F.OTP.Random.bijection)
(HasType (FStar.DM4F.OTP.Random.__proj__Bijection__item__finv @x0)
(Tm_refine_87095c1bc0678f440c68c2adbbc8c31e @x0)))
 

:pattern ((FStar.DM4F.OTP.Random.__proj__Bijection__item__finv @x0))
:qid typing_FStar.DM4F.OTP.Random.__proj__Bijection__item__finv))

:named typing_FStar.DM4F.OTP.Random.__proj__Bijection__item__finv))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__f; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(89,6-89,7); use=FStar.DM4F.OTP.Random.fst(89,6-89,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FStar.DM4F.OTP.Random.bijection)
(HasType (FStar.DM4F.OTP.Random.__proj__Bijection__item__f @x0)
Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a))
 

:pattern ((FStar.DM4F.OTP.Random.__proj__Bijection__item__f @x0))
:qid typing_FStar.DM4F.OTP.Random.__proj__Bijection__item__f))

:named typing_FStar.DM4F.OTP.Random.__proj__Bijection__item__f))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.equal; Namespace FStar.DM4F.OTP.Heap
(assert (! 
;; def=FStar.DM4F.OTP.Heap.fsti(46,4-46,9); use=FStar.DM4F.OTP.Heap.fsti(46,4-46,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(HasType @x1
...
;; def=FStar.DM4F.OTP.Random.fst(90,6-90,10); use=FStar.DM4F.OTP.Random.fst(90,6-90,10)
(forall ((@x0 Term))
 (! (= (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__finv@tok
@x0)
(FStar.DM4F.OTP.Random.__proj__Bijection__item__finv @x0))
 

:pattern ((ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__finv@tok
@x0))
:qid token_correspondence_FStar.DM4F.OTP.Random.__proj__Bijection__item__finv))

:named token_correspondence_FStar.DM4F.OTP.Random.__proj__Bijection__item__finv))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__f; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(89,6-89,7); use=FStar.DM4F.OTP.Random.fst(89,6-89,7)
(forall ((@x0 Term))
 (! (= (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok
@x0)
(FStar.DM4F.OTP.Random.__proj__Bijection__item__f @x0))
 

:pattern ((ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok
@x0))
:qid token_correspondence_FStar.DM4F.OTP.Random.__proj__Bijection__item__f))

:named token_correspondence_FStar.DM4F.OTP.Random.__proj__Bijection__item__f))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(88,4-88,13); use=FStar.DM4F.OTP.Random.fst(88,4-88,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(FStar.DM4F.OTP.Random.Bijection @x1
@x2)
FStar.DM4F.OTP.Random.bijection)
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
...
@x2)
FStar.DM4F.OTP.Random.bijection))
:qid subterm_ordering_FStar.DM4F.OTP.Random.Bijection))

:named subterm_ordering_FStar.DM4F.OTP.Random.Bijection))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__finv; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(90,6-90,88); use=FStar.DM4F.OTP.Random.fst(90,6-90,88)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_87095c1bc0678f440c68c2adbbc8c31e @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_87095c1bc0678f440c68c2adbbc8c31e @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_87095c1bc0678f440c68c2adbbc8c31e))

:named refinement_kinding_Tm_refine_87095c1bc0678f440c68c2adbbc8c31e))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(90,6-90,88); use=FStar.DM4F.OTP.Random.fst(90,6-90,88)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_6e1cd8b072e751339d1179e813fda863 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_6e1cd8b072e751339d1179e813fda863 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_6e1cd8b072e751339d1179e813fda863))

:named refinement_kinding_Tm_refine_6e1cd8b072e751339d1179e813fda863))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.OTP.Random.test_sample_none; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_refine_25b90748bb5adddca3db9d1f72c972aa
Tm_type)
:named refinement_kinding_Tm_refine_25b90748bb5adddca3db9d1f72c972aa))
;;;;;;;;;;;;;;;;refinement_interpretation
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_87095c1bc0678f440c68c2adbbc8c31e @x2))
(and (HasTypeFuel @u0
@x1
Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a)

;; def=FStar.DM4F.OTP.Random.fst(90,26-90,87); use=FStar.DM4F.OTP.Random.fst(90,26-90,87)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=FStar.DM4F.OTP.Random.fst(90,43-90,87); use=FStar.DM4F.OTP.Random.fst(90,43-90,87)
(and 
;; def=FStar.DM4F.OTP.Random.fst(90,43-90,63); use=FStar.DM4F.OTP.Random.fst(90,43-90,63)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(90,43-90,63); use=FStar.DM4F.OTP.Random.fst(90,43-90,63)
(FStar.DM4F.OTP.Heap.equal (ApplyTT (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok
@x2)
(ApplyTT @x1
@x3))
@x3)
...
;; def=FStar.DM4F.OTP.Random.fst(90,67-90,87); use=FStar.DM4F.OTP.Random.fst(90,67-90,87)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(90,67-90,87); use=FStar.DM4F.OTP.Random.fst(90,67-90,87)
(FStar.DM4F.OTP.Heap.equal (ApplyTT @x1
(ApplyTT (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok
@x2)
@x3))
@x3)
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_87095c1bc0678f440c68c2adbbc8c31e.1))
))
...
@x1
(Tm_refine_87095c1bc0678f440c68c2adbbc8c31e @x2)))
:qid refinement_interpretation_Tm_refine_87095c1bc0678f440c68c2adbbc8c31e))

:named refinement_interpretation_Tm_refine_87095c1bc0678f440c68c2adbbc8c31e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(90,6-90,88); use=FStar.DM4F.OTP.Random.fst(90,6-90,88)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6e1cd8b072e751339d1179e813fda863 @x2))
(and (HasTypeFuel @u0
@x1
Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a)
...
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(90,43-90,63); use=FStar.DM4F.OTP.Random.fst(90,43-90,63)
(FStar.DM4F.OTP.Heap.equal (ApplyTT @x2
(ApplyTT @x1
@x3))
@x3)
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_6e1cd8b072e751339d1179e813fda863.1))
))
...
@x1
(Tm_refine_6e1cd8b072e751339d1179e813fda863 @x2)))
:qid refinement_interpretation_Tm_refine_6e1cd8b072e751339d1179e813fda863))

:named refinement_interpretation_Tm_refine_6e1cd8b072e751339d1179e813fda863))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.OTP.Random.test_sample_none; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(82,30-82,73); use=FStar.DM4F.OTP.Random.fst(82,30-82,73)
...
;; def=FStar.DM4F.OTP.Random.fst(88,4-88,13); use=FStar.DM4F.OTP.Random.fst(88,4-88,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.OTP.Random.Bijection_finv (FStar.DM4F.OTP.Random.Bijection @x0
@x1))
@x1)
 

:pattern ((FStar.DM4F.OTP.Random.Bijection @x0
@x1))
:qid projection_inverse_FStar.DM4F.OTP.Random.Bijection_finv))

:named projection_inverse_FStar.DM4F.OTP.Random.Bijection_finv))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(88,4-88,13); use=FStar.DM4F.OTP.Random.fst(88,4-88,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.OTP.Random.Bijection_f (FStar.DM4F.OTP.Random.Bijection @x0
@x1))
@x0)
...
:pattern ((FStar.DM4F.OTP.Random.Bijection @x0
@x1))
:qid projection_inverse_FStar.DM4F.OTP.Random.Bijection_f))

:named projection_inverse_FStar.DM4F.OTP.Random.Bijection_f))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__finv; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(90,6-90,10); use=FStar.DM4F.OTP.Random.fst(90,6-90,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.OTP.Random.__proj__Bijection__item__finv @x0)
(FStar.DM4F.OTP.Random.Bijection_finv @x0))
 

:pattern ((FStar.DM4F.OTP.Random.__proj__Bijection__item__finv @x0))
:qid proj_equation_FStar.DM4F.OTP.Random.Bijection_finv))

:named proj_equation_FStar.DM4F.OTP.Random.Bijection_finv))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__f; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(89,6-89,7); use=FStar.DM4F.OTP.Random.fst(89,6-89,7)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.OTP.Random.__proj__Bijection__item__f @x0)
(FStar.DM4F.OTP.Random.Bijection_f @x0))
 

:pattern ((FStar.DM4F.OTP.Random.__proj__Bijection__item__f @x0))
:qid proj_equation_FStar.DM4F.OTP.Random.Bijection_f))

:named proj_equation_FStar.DM4F.OTP.Random.Bijection_f))
...
;; def=FStar.DM4F.OTP.Heap.fsti(49,12-49,92); use=FStar.DM4F.OTP.Heap.fsti(49,12-49,92)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.DM4F.OTP.Heap.id Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fsti(49,66-49,90); use=FStar.DM4F.OTP.Heap.fsti(49,66-49,90)
(= (FStar.DM4F.OTP.Heap.index @x0
@x2)
(FStar.DM4F.OTP.Heap.index @x1
@x2))
...
;; def=FStar.DM4F.OTP.Heap.fsti(50,11-50,24); use=FStar.DM4F.OTP.Heap.fsti(50,11-50,24)
(Valid 
;; def=FStar.DM4F.OTP.Heap.fsti(50,11-50,24); use=FStar.DM4F.OTP.Heap.fsti(50,11-50,24)
...
;;;;;;;;;;;;;;;;Lemma: FStar.DM4F.OTP.Heap.lemma_eq_elim
;;; Fact-ids: Name FStar.DM4F.OTP.Heap.lemma_eq_elim; Namespace FStar.DM4F.OTP.Heap
(assert (! (forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(HasType @x1
...
;; def=FStar.DM4F.OTP.Heap.fsti(54,12-54,25); use=FStar.DM4F.OTP.Heap.fsti(54,12-54,25)
(Valid 
;; def=FStar.DM4F.OTP.Heap.fsti(54,12-54,25); use=FStar.DM4F.OTP.Heap.fsti(54,12-54,25)
(FStar.DM4F.OTP.Heap.equal @x0
@x1)
...
;; def=FStar.DM4F.OTP.Heap.fsti(55,11-55,19); use=FStar.DM4F.OTP.Heap.fsti(55,11-55,19)
(= @x0
@x1)
)
...
:pattern ((FStar.DM4F.OTP.Heap.equal @x0
@x1))
:qid lemma_FStar.DM4F.OTP.Heap.lemma_eq_elim))
:named lemma_FStar.DM4F.OTP.Heap.lemma_eq_elim))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a
Tm_type)
:named kinding_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_392a2de039cc1e000ab2f19079dab964
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__finv; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_arrow_392a2de039cc1e000ab2f19079dab964
Tm_type)
:named kinding_Tm_arrow_392a2de039cc1e000ab2f19079dab964))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0f59050e554c927a077f6dfc0cc3c751
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__f; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_arrow_0f59050e554c927a077f6dfc0cc3c751
Tm_type)
:named kinding_Tm_arrow_0f59050e554c927a077f6dfc0cc3c751))
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType FStar.DM4F.OTP.Random.bijection
Tm_type)
:named kinding_FStar.DM4F.OTP.Random.bijection@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_87095c1bc0678f440c68c2adbbc8c31e
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__finv; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(90,6-90,88); use=FStar.DM4F.OTP.Random.fst(90,6-90,88)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_87095c1bc0678f440c68c2adbbc8c31e @x0)))
(Valid (Prims.hasEq Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_87095c1bc0678f440c68c2adbbc8c31e @x0))))
:qid haseqTm_refine_87095c1bc0678f440c68c2adbbc8c31e))

:named haseqTm_refine_87095c1bc0678f440c68c2adbbc8c31e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6e1cd8b072e751339d1179e813fda863
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(90,6-90,88); use=FStar.DM4F.OTP.Random.fst(90,6-90,88)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6e1cd8b072e751339d1179e813fda863 @x0)))
(Valid (Prims.hasEq Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6e1cd8b072e751339d1179e813fda863 @x0))))
:qid haseqTm_refine_6e1cd8b072e751339d1179e813fda863))

:named haseqTm_refine_6e1cd8b072e751339d1179e813fda863))
;;;;;;;;;;;;;;;;haseq for Tm_refine_25b90748bb5adddca3db9d1f72c972aa
;;; Fact-ids: Name FStar.DM4F.OTP.Random.test_sample_none; Namespace FStar.DM4F.OTP.Random
(assert (! (iff (Valid (Prims.hasEq Tm_refine_25b90748bb5adddca3db9d1f72c972aa))
(Valid (Prims.hasEq (FStar.DM4F.OTP.Heap.tape Dummy_value))))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.OTP.Random.__proj__Bijection__item__finv@tok
Tm_arrow_392a2de039cc1e000ab2f19079dab964))

;; def=FStar.DM4F.OTP.Random.fst(90,6-90,10); use=FStar.DM4F.OTP.Random.fst(90,6-90,10)
(forall ((@x1 Term))
 (! (= (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__finv@tok
@x1)
(FStar.DM4F.OTP.Random.__proj__Bijection__item__finv @x1))
 

:pattern ((FStar.DM4F.OTP.Random.__proj__Bijection__item__finv @x1))
:qid function_token_typing_FStar.DM4F.OTP.Random.__proj__Bijection__item__finv.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.OTP.Random.__proj__Bijection__item__finv@tok))
:qid function_token_typing_FStar.DM4F.OTP.Random.__proj__Bijection__item__finv))

:named function_token_typing_FStar.DM4F.OTP.Random.__proj__Bijection__item__finv))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__f; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(89,6-89,7); use=FStar.DM4F.OTP.Random.fst(89,6-89,7)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok
Tm_arrow_0f59050e554c927a077f6dfc0cc3c751))

;; def=FStar.DM4F.OTP.Random.fst(89,6-89,7); use=FStar.DM4F.OTP.Random.fst(89,6-89,7)
(forall ((@x1 Term))
 (! (= (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok
@x1)
(FStar.DM4F.OTP.Random.__proj__Bijection__item__f @x1))
 

:pattern ((FStar.DM4F.OTP.Random.__proj__Bijection__item__f @x1))
:qid function_token_typing_FStar.DM4F.OTP.Random.__proj__Bijection__item__f.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok))
:qid function_token_typing_FStar.DM4F.OTP.Random.__proj__Bijection__item__f))

:named function_token_typing_FStar.DM4F.OTP.Random.__proj__Bijection__item__f))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(87,10-87,19); use=FStar.DM4F.OTP.Random.fst(87,10-87,19)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
FStar.DM4F.OTP.Random.bijection)
(is-FStar.DM4F.OTP.Random.Bijection @x1))
 

:pattern ((HasTypeFuel @u0
@x1
FStar.DM4F.OTP.Random.bijection))
:qid fuel_guarded_inversion_FStar.DM4F.OTP.Random.bijection))

:named fuel_guarded_inversion_FStar.DM4F.OTP.Random.bijection))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(88,4-88,13); use=FStar.DM4F.OTP.Random.fst(88,4-88,13)
...
(HasTypeFuel @u0
@x2
(Tm_refine_6e1cd8b072e751339d1179e813fda863 @x1)))
(HasTypeFuel @u0
(FStar.DM4F.OTP.Random.Bijection @x1
@x2)
FStar.DM4F.OTP.Random.bijection))
...
@x2)
FStar.DM4F.OTP.Random.bijection))
:qid data_typing_intro_FStar.DM4F.OTP.Random.Bijection@tok))

:named data_typing_intro_FStar.DM4F.OTP.Random.Bijection@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(88,4-88,13); use=FStar.DM4F.OTP.Random.fst(88,4-88,13)
...
@x2)
FStar.DM4F.OTP.Random.bijection))
:qid data_elim_FStar.DM4F.OTP.Random.Bijection))

:named data_elim_FStar.DM4F.OTP.Random.Bijection))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! (= 799
(Term_constr_id FStar.DM4F.OTP.Random.bijection))
:named constructor_distinct_FStar.DM4F.OTP.Random.bijection))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(88,4-88,13); use=FStar.DM4F.OTP.Random.fst(88,4-88,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= 810
(Term_constr_id (FStar.DM4F.OTP.Random.Bijection @x0
@x1)))
 

:pattern ((FStar.DM4F.OTP.Random.Bijection @x0
@x1))
:qid constructor_distinct_FStar.DM4F.OTP.Random.Bijection))
...
@x0
FStar.DM4F.OTP.Random.bijection))
:qid FStar.DM4F.OTP.Random_pretyping_65cd675befef0d716100cb302b96028e))

:named FStar.DM4F.OTP.Random_pretyping_65cd675befef0d716100cb302b96028e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(89,9-89,21); use=FStar.DM4F.OTP.Random.fst(89,9-89,21)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a)
...
@x1
Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__finv; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(87,10-90,88); use=FStar.DM4F.OTP.Random.fst(87,10-90,88)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_392a2de039cc1e000ab2f19079dab964)
...
@x1
Tm_arrow_392a2de039cc1e000ab2f19079dab964))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_392a2de039cc1e000ab2f19079dab964))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_392a2de039cc1e000ab2f19079dab964))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__f; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(87,10-89,21); use=FStar.DM4F.OTP.Random.fst(87,10-89,21)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_0f59050e554c927a077f6dfc0cc3c751)
...
@x1
Tm_arrow_0f59050e554c927a077f6dfc0cc3c751))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_0f59050e554c927a077f6dfc0cc3c751))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_0f59050e554c927a077f6dfc0cc3c751))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a
;;; Fact-ids: Name FStar.DM4F.OTP.Random.bijection; Namespace FStar.DM4F.OTP.Random; Name FStar.DM4F.OTP.Random.Bijection; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(89,9-89,21); use=FStar.DM4F.OTP.Random.fst(89,9-89,21)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_392a2de039cc1e000ab2f19079dab964
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__finv; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(87,10-90,88); use=FStar.DM4F.OTP.Random.fst(87,10-90,88)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_refine_87095c1bc0678f440c68c2adbbc8c31e @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_392a2de039cc1e000ab2f19079dab964.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_392a2de039cc1e000ab2f19079dab964))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_392a2de039cc1e000ab2f19079dab964))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_392a2de039cc1e000ab2f19079dab964))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0f59050e554c927a077f6dfc0cc3c751
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__f; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(87,10-89,21); use=FStar.DM4F.OTP.Random.fst(87,10-89,21)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_0f59050e554c927a077f6dfc0cc3c751.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_0f59050e554c927a077f6dfc0cc3c751))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_0f59050e554c927a077f6dfc0cc3c751))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_0f59050e554c927a077f6dfc0cc3c751))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.DM4F.OTP.Random.__proj__Bijection__item__finv; Namespace FStar.DM4F.OTP.Random
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok))
:named @kick_partial_app_b1d013fdaea950466b339a6d81693206))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(95,2-95,26)
...
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.DM4F.OTP.Random.__proj__Bijection__item__finv@tok))
:named @kick_partial_app_e8d1e52b7ee363f98a0dfb74bf51a9cd))



; Encoding query formula : forall (bij: FStar.DM4F.OTP.Random.bijection).
;   (*  - Could not prove post-condition
; *)
;   forall (h: FStar.DM4F.OTP.Heap.tape).
;     FStar.DM4F.OTP.Heap.equal (bij.finv (bij.f h)) h /\
;     FStar.DM4F.OTP.Heap.equal (bij.f (bij.finv h)) h
...
;; def=FStar.DM4F.OTP.Random.fst(90,26-90,87); use=FStar.DM4F.OTP.Random.fst(95,21-95,26)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=FStar.DM4F.OTP.Random.fst(90,43-90,87); use=FStar.DM4F.OTP.Random.fst(95,21-95,26)
(and 
;; def=FStar.DM4F.OTP.Random.fst(90,43-90,63); use=FStar.DM4F.OTP.Random.fst(95,21-95,26)
(or label_1

;; def=FStar.DM4F.OTP.Random.fst(90,43-90,63); use=FStar.DM4F.OTP.Random.fst(95,21-95,26)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(90,43-90,63); use=FStar.DM4F.OTP.Random.fst(95,21-95,26)
(FStar.DM4F.OTP.Heap.equal (ApplyTT (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__finv@tok
@x0)
(ApplyTT (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok
@x0)
@x1))
...
;; def=FStar.DM4F.OTP.Random.fst(90,67-90,87); use=FStar.DM4F.OTP.Random.fst(95,21-95,26)
(or label_2
...
(FStar.DM4F.OTP.Heap.equal (ApplyTT (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok
@x0)
(ApplyTT (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__finv@tok
@x0)
@x1))
@x1)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.inverse, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.OTP.Random_interpretation_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a, data_elim_FStar.DM4F.OTP.Random.Bijection, fuel_guarded_inversion_FStar.DM4F.OTP.Random.bijection, lemma_FStar.DM4F.OTP.Heap.lemma_eq_elim, proj_equation_FStar.DM4F.OTP.Random.Bijection_f, proj_equation_FStar.DM4F.OTP.Random.Bijection_finv, refinement_interpretation_Tm_refine_6e1cd8b072e751339d1179e813fda863, token_correspondence_FStar.DM4F.OTP.Random.__proj__Bijection__item__f, token_correspondence_FStar.DM4F.OTP.Random.__proj__Bijection__item__finv
...
(declare-fun FStar.DM4F.OTP.Random.inverse (Term) Term)
;;;;;;;;;;;;;;;;bij: bijection -> bijection
(declare-fun Tm_arrow_453c7bcf1fd54a29d2b751747565d700 () Term)
(declare-fun FStar.DM4F.OTP.Random.inverse@tok () Term)

; </end encoding let inverse>


; encoding sigelt val FStar.DM4F.OTP.Random.sum


; <Start encoding val FStar.DM4F.OTP.Random.sum>

;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.tape -> Prims.nat
(declare-fun Tm_arrow_2406da4c5642b08528044a87c1da76cf () Term)
(declare-fun FStar.DM4F.OTP.Random.sum (Term) Term)

;;;;;;;;;;;;;;;;f: (_: FStar.DM4F.OTP.Heap.tape -> Prims.nat) -> Prims.nat
(declare-fun Tm_arrow_0f80f3d957b6238c402015a388ac07fc () Term)
(declare-fun FStar.DM4F.OTP.Random.sum@tok () Term)

; </end encoding val FStar.DM4F.OTP.Random.sum>


; encoding sigelt val FStar.DM4F.OTP.Random.sum_bijection


; <Start encoding val FStar.DM4F.OTP.Random.sum_bijection>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.OTP.Random.sum_bijection (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.OTP.Random.sum_bijection@tok () Term)

; </end encoding val FStar.DM4F.OTP.Random.sum_bijection>


; encoding sigelt val FStar.DM4F.OTP.Random.sum_monotonic


; <Start encoding val FStar.DM4F.OTP.Random.sum_monotonic>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.OTP.Random.sum_monotonic (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.OTP.Random.sum_monotonic@tok () Term)

; </end encoding val FStar.DM4F.OTP.Random.sum_monotonic>


; encoding sigelt val FStar.DM4F.OTP.Random.sum_extensional


; <Skipped val FStar.DM4F.OTP.Random.sum_extensional/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sum; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(99,11-99,14); use=FStar.DM4F.OTP.Random.fst(99,11-99,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_2406da4c5642b08528044a87c1da76cf)
(HasType (FStar.DM4F.OTP.Random.sum @x0)
Prims.nat))
 

:pattern ((FStar.DM4F.OTP.Random.sum @x0))
:qid typing_FStar.DM4F.OTP.Random.sum))

:named typing_FStar.DM4F.OTP.Random.sum))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2406da4c5642b08528044a87c1da76cf
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sum; Namespace FStar.DM4F.OTP.Random
(assert (! (HasType Tm_arrow_2406da4c5642b08528044a87c1da76cf
Tm_type)
:named kinding_Tm_arrow_2406da4c5642b08528044a87c1da76cf))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sum; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(99,19-99,30); use=FStar.DM4F.OTP.Random.fst(99,19-99,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_2406da4c5642b08528044a87c1da76cf)
...
@x1
Tm_arrow_2406da4c5642b08528044a87c1da76cf))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_2406da4c5642b08528044a87c1da76cf))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_2406da4c5642b08528044a87c1da76cf))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2406da4c5642b08528044a87c1da76cf
;;; Fact-ids: Name FStar.DM4F.OTP.Random.sum; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(99,19-99,30); use=FStar.DM4F.OTP.Random.fst(99,19-99,30)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_2406da4c5642b08528044a87c1da76cf.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_2406da4c5642b08528044a87c1da76cf))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_2406da4c5642b08528044a87c1da76cf))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_2406da4c5642b08528044a87c1da76cf))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(115,2-116,19)
...
; Encoding query formula : forall (f: (_: FStar.DM4F.OTP.Heap.tape -> Prims.nat))
;   (g: (_: FStar.DM4F.OTP.Heap.tape -> Prims.nat)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (h: FStar.DM4F.OTP.Heap.tape). f h == g h) /\
;     (forall (pure_result: Prims.unit).
;         FStar.DM4F.OTP.Random.sum f == FStar.DM4F.OTP.Random.sum g ==> p pure_result) ==>
;     (forall (h: FStar.DM4F.OTP.Heap.tape). f h <= g h) /\
;     (forall (pure_result: Prims.unit).
;         FStar.DM4F.OTP.Random.sum f <= FStar.DM4F.OTP.Random.sum g ==>
;         (forall (h: FStar.DM4F.OTP.Heap.tape). g h <= f h) /\
;         (forall (pure_result: Prims.unit).
;             FStar.DM4F.OTP.Random.sum g <= FStar.DM4F.OTP.Random.sum f ==> p pure_result))
...
;; def=FStar.DM4F.OTP.Random.fst(112,12-112,34); use=FStar.DM4F.OTP.Random.fst(115,2-116,19)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=FStar.DM4F.OTP.Random.fst(112,23-112,33); use=FStar.DM4F.OTP.Random.fst(115,2-116,19)
(= (ApplyTT @x0
@x3)
(ApplyTT @x1
@x3))
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(115,2-116,19)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=FStar.DM4F.OTP.Random.fst(113,11-113,27); use=FStar.DM4F.OTP.Random.fst(115,2-116,19)
(or label_2

;; def=FStar.DM4F.OTP.Random.fst(113,11-113,27); use=FStar.DM4F.OTP.Random.fst(115,2-116,19)
(= (FStar.DM4F.OTP.Random.sum @x0)
(FStar.DM4F.OTP.Random.sum @x1))
)
)

;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(115,2-116,19)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(115,2-116,19)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.OTP.Random.fst(115,2-115,15)
(and 
;; def=FStar.DM4F.OTP.Random.fst(107,12-107,34); use=FStar.DM4F.OTP.Random.fst(115,2-115,15)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=FStar.DM4F.OTP.Random.fst(107,23-107,33); use=FStar.DM4F.OTP.Random.fst(115,2-115,15)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(115,2-115,15)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.unit)

;; def=FStar.DM4F.OTP.Random.fst(108,11-108,27); use=FStar.DM4F.OTP.Random.fst(115,2-115,15)
(<= (BoxInt_proj_0 (FStar.DM4F.OTP.Random.sum @x0))
(BoxInt_proj_0 (FStar.DM4F.OTP.Random.sum @x1)))
)

;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.OTP.Random.fst(116,2-116,15)
(and 
;; def=FStar.DM4F.OTP.Random.fst(107,12-107,34); use=FStar.DM4F.OTP.Random.fst(116,2-116,15)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=FStar.DM4F.OTP.Random.fst(107,23-107,33); use=FStar.DM4F.OTP.Random.fst(116,2-116,15)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(116,2-116,15)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=FStar.DM4F.OTP.Random.fst(108,11-108,27); use=FStar.DM4F.OTP.Random.fst(116,2-116,15)
(<= (BoxInt_proj_0 (FStar.DM4F.OTP.Random.sum @x1))
(BoxInt_proj_0 (FStar.DM4F.OTP.Random.sum @x0)))
)

;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(116,2-116,15)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(116,2-116,15)
(ApplyTT @x2
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.sum_extensional, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, int_inversion, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_FStar.DM4F.OTP.Random.sum
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.OTP.Random.sum_extensional (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.OTP.Random.sum_extensional@tok () Term)

; </end encoding let sum_extensional>


; encoding sigelt val FStar.DM4F.OTP.Random.mass


; <Skipped val FStar.DM4F.OTP.Random.mass/>

(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(125,18-125,63)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape -> Prims.M (a & FStar.DM4F.OTP.Heap.id)
(declare-fun Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(21,20-124,43); use=FStar.DM4F.OTP.Random.fst(125,4-125,8)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3 @x0)
Tm_type))
:qid kinding_Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3))

:named kinding_Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(21,20-124,43); use=FStar.DM4F.OTP.Random.fst(125,4-125,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3 @x2)))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(21,20-124,43); use=FStar.DM4F.OTP.Random.fst(125,4-125,8)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3 @x1))
(and 
;; def=FStar.DM4F.OTP.Random.fst(21,20-124,43); use=FStar.DM4F.OTP.Random.fst(125,4-125,8)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3 @x1)))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3))
;;;;;;;;;;;;;;;;_: a -> Prims.nat
(declare-fun Tm_arrow_1eea001dc988a6a52767d18e2341e80f (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1eea001dc988a6a52767d18e2341e80f
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(124,56-125,11); use=FStar.DM4F.OTP.Random.fst(125,4-125,11)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_1eea001dc988a6a52767d18e2341e80f @x2)))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_1eea001dc988a6a52767d18e2341e80f))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_1eea001dc988a6a52767d18e2341e80f))
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_1eea001dc988a6a52767d18e2341e80f.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_1eea001dc988a6a52767d18e2341e80f @x1)))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_1eea001dc988a6a52767d18e2341e80f))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_1eea001dc988a6a52767d18e2341e80f))
...
Tm_type)
(HasType @x1
(Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3 @x0))
(HasType @x2
(Tm_arrow_1eea001dc988a6a52767d18e2341e80f @x0)))

;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(125,18-125,63)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(125,51-125,52)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.mass, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.DM4F.OTP.Heap.size, projection_inverse_BoxInt_proj_0
...
;;;;;;;;;;;;;;;;_: a -> Prims.nat
(declare-fun Tm_arrow_1eea001dc988a6a52767d18e2341e80f (Term) Term)
(declare-fun FStar.DM4F.OTP.Random.mass (Term Term Term) Term)


;;;;;;;;;;;;;;;;f:       (_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape -> Prims.M (a & FStar.DM4F.OTP.Heap.id)) ->     p: (_: a -> Prims.nat)   -> Prims.nat
(declare-fun Tm_arrow_51a598663aacbcb564f556da833deef8 () Term)
(declare-fun FStar.DM4F.OTP.Random.mass@tok () Term)



(declare-fun Tm_abs_c82d308c1977f29914f2f3d3a95ee08f (Term Term) Term)

; </end encoding let mass>


; encoding sigelt val FStar.DM4F.OTP.Random.point


; <Skipped val FStar.DM4F.OTP.Random.point/>

(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(128,26-128,53)
...
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.OTP.Random.fst(128,29-128,30)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.point, 1)
; STATUS: unsat
...
(declare-fun FStar.DM4F.OTP.Random.point (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: FStar.Pervasives.Native.option a -> Prims.nat
(declare-fun Tm_arrow_b33b055f9025afd093160a747bf7ed64 () Term)
(declare-fun FStar.DM4F.OTP.Random.point@tok () Term)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3
;;; Fact-ids: Name FStar.DM4F.OTP.Random.mass; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(21,20-124,43); use=FStar.DM4F.OTP.Random.fst(125,4-125,8)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3 @x0)
...
;;; Fact-ids: Name FStar.DM4F.OTP.Random.mass; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(124,11-124,59); use=FStar.DM4F.OTP.Random.fst(124,51-125,8)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_1eea001dc988a6a52767d18e2341e80f @x0)
Tm_type)
...
; Starting query at FStar.DM4F.OTP.Random.fst(135,0-146,38)
...
;;;;;;;;;;;;;;;;_: FStar.DM4F.OTP.Heap.tape -> Prims.GTot Type
(declare-fun Tm_arrow_24335d74380922f290a2b99aff3a0b1c () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_24335d74380922f290a2b99aff3a0b1c
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_24335d74380922f290a2b99aff3a0b1c
Tm_type)
:named kinding_Tm_arrow_24335d74380922f290a2b99aff3a0b1c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(89,9-89,13); use=FStar.DM4F.OTP.Random.fst(135,15-146,38)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_24335d74380922f290a2b99aff3a0b1c)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_24335d74380922f290a2b99aff3a0b1c))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_24335d74380922f290a2b99aff3a0b1c))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_24335d74380922f290a2b99aff3a0b1c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_24335d74380922f290a2b99aff3a0b1c
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(89,9-89,13); use=FStar.DM4F.OTP.Random.fst(135,15-146,38)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_24335d74380922f290a2b99aff3a0b1c.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_24335d74380922f290a2b99aff3a0b1c))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_24335d74380922f290a2b99aff3a0b1c))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_24335d74380922f290a2b99aff3a0b1c))


(declare-fun Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(142,4-145,21); use=FStar.DM4F.OTP.Random.fst(142,4-145,21)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e))

:named typing_Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(142,4-145,21); use=FStar.DM4F.OTP.Random.fst(142,4-145,21)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e @x1
@x2
@x3
@x4
@x5)
...
:pattern ((ApplyTT (Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e @x1
@x2
@x3
@x4
@x5)
@x0))
:qid interpretation_Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e))

:named interpretation_Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e))
...
;; def=FStar.DM4F.OTP.Random.fst(142,4-145,21); use=FStar.DM4F.OTP.Random.fst(142,4-145,21)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.l_Forall (FStar.DM4F.OTP.Heap.tape Dummy_value)
(Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e @x4
@x3
@x2
@x1
@x0)))
...
;; def=FStar.DM4F.OTP.Random.fst(145,6-145,20); use=FStar.DM4F.OTP.Random.fst(145,6-145,20)
...
;;no pats
:qid l_quant_interp_2c44e3256805289693e7d1a6515a848c.1))
)
 

:pattern ((Valid (Prims.l_Forall (FStar.DM4F.OTP.Heap.tape Dummy_value)
(Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e @x4
@x3
@x2
@x1
@x0))))
:qid l_quant_interp_2c44e3256805289693e7d1a6515a848c))

:named l_quant_interp_2c44e3256805289693e7d1a6515a848c))
...
;   (_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape -> Prims.M (a & FStar.DM4F.OTP.Heap.id)))
;   (c2:
;   (_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape -> Prims.M (b & FStar.DM4F.OTP.Heap.id)))
;   (p1: (_: a -> Prims.nat))
;   (p2: (_: b -> Prims.nat))
...
;               (forall (any_result: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape).
;                   (FStar.DM4F.OTP.Heap.to_id 0, t) == any_result ==>
;                   (forall (any_result: a & FStar.DM4F.OTP.Heap.id).
;                       c1 (FStar.DM4F.OTP.Heap.to_id 0, t) == any_result ==>
;                       (forall (b: a) (b: FStar.DM4F.OTP.Heap.id).
;                           c1 (FStar.DM4F.OTP.Heap.to_id 0, t) == (b, b) ==>
;                           0 < FStar.DM4F.OTP.Heap.size)))))) /\
;   (forall (any_result: (_: FStar.DM4F.OTP.Heap.tape -> Prims.GTot Type0)).
;       (fun t ->
;           (let r1, _ = c1 (FStar.DM4F.OTP.Heap.to_id 0, t) in
;             (let r2, _ = c2 (FStar.DM4F.OTP.Heap.to_id 0, bij.f t) in
;               p1 r1 <= p2 r2)
;             <:
;             Type0)
;           <:
...
; Context: While encoding a query
; While typechecking the top-level declaration `val FStar.DM4F.OTP.Random.pr_leq`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(135,0-146,38)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(135,15-146,38)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(135,15-146,38)
(forall ((@x7 Term))
 (! (implies (HasType @x7
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(142,4-145,21)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(143,27-143,28)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(142,4-145,21)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.int)

;; def=FStar.DM4F.OTP.Heap.fsti(33,11-33,12); use=FStar.DM4F.OTP.Random.fst(142,4-145,21)
(= (BoxInt 0)
@x8)
)
...
;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=FStar.DM4F.OTP.Random.fst(142,4-145,21)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x9)
)
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(142,4-145,21)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x7)
...
;; def=FStar.DM4F.OTP.Random.fst(143,10-143,31); use=FStar.DM4F.OTP.Random.fst(143,10-143,31)
(= (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.OTP.Random.fst(142,4-145,21)
(forall ((@x12 Term))
 (! (implies (HasType @x12
@x0)
...
;; def=FStar.DM4F.OTP.Random.fst(143,10-143,14); use=FStar.DM4F.OTP.Random.fst(143,10-143,14)
(= (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(144,27-144,28)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(135,15-146,38)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Tm_arrow_24335d74380922f290a2b99aff3a0b1c)

;; def=Prims.fst(286,26-286,27); use=FStar.DM4F.OTP.Random.fst(135,15-146,38)
(= (Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e @x4
@x5
@x3
@x6
...
;; def=FStar.Pervasives.fsti(112,28-112,31); use=FStar.DM4F.OTP.Random.fst(135,15-146,38)
(= (Prims.l_Forall (FStar.DM4F.OTP.Heap.tape Dummy_value)
(Tm_abs_4ec6f47ff6df779cda1acd8a4a1a036e @x4
@x5
@x3
@x6
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(146,11-146,37)
(forall ((@x9 Term))
 (! (implies (HasType @x9
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(146,11-146,37)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(140,19-140,24)
(or label_3

;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(146,11-146,37)
(< (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
)


;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(146,11-146,37)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.int)

;; def=FStar.DM4F.OTP.Heap.fsti(33,11-33,12); use=FStar.DM4F.OTP.Random.fst(146,11-146,37)
(= (BoxInt 0)
@x10)
)
...
;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=FStar.DM4F.OTP.Random.fst(146,11-146,37)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x11)
)
...
;; def=FStar.DM4F.OTP.Random.fst(143,10-143,31); use=FStar.DM4F.OTP.Random.fst(146,11-146,37)
(= (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.OTP.Random.fst(146,11-146,37)
(forall ((@x14 Term))
 (! (implies (HasType @x14
@x0)
...
;; def=FStar.DM4F.OTP.Random.fst(143,10-143,14); use=FStar.DM4F.OTP.Random.fst(146,11-146,37)
(= (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.pr_leq, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.DM4F.OTP.Heap.size, projection_inverse_BoxInt_proj_0
...
; encoding sigelt val FStar.DM4F.OTP.Random.pr_leq


; <Skipped val FStar.DM4F.OTP.Random.pr_leq/>

;;;;;;;;;;;;;;;;typing_Tm_abs_c82d308c1977f29914f2f3d3a95ee08f
;;; Fact-ids: Name FStar.DM4F.OTP.Random.mass; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(125,31-125,62); use=FStar.DM4F.OTP.Random.fst(125,31-125,62)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_c82d308c1977f29914f2f3d3a95ee08f @x0
@x1)
Tm_arrow_2406da4c5642b08528044a87c1da76cf)
 

:pattern ((Tm_abs_c82d308c1977f29914f2f3d3a95ee08f @x0
@x1))
:qid typing_Tm_abs_c82d308c1977f29914f2f3d3a95ee08f))

:named typing_Tm_abs_c82d308c1977f29914f2f3d3a95ee08f))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Random.mass; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(125,4-125,8); use=FStar.DM4F.OTP.Random.fst(125,4-125,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
(Tm_arrow_1eea001dc988a6a52767d18e2341e80f @x0)))
(HasType (FStar.DM4F.OTP.Random.mass @x0
@x1
@x2)
Prims.nat))
 

:pattern ((FStar.DM4F.OTP.Random.mass @x0
@x1
@x2))
:qid typing_FStar.DM4F.OTP.Random.mass))

:named typing_FStar.DM4F.OTP.Random.mass))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.OTP.Random.inverse; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(94,4-94,11); use=FStar.DM4F.OTP.Random.fst(94,4-94,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
FStar.DM4F.OTP.Random.bijection)
(HasType (FStar.DM4F.OTP.Random.inverse @x0)
FStar.DM4F.OTP.Random.bijection))
 

:pattern ((FStar.DM4F.OTP.Random.inverse @x0))
:qid typing_FStar.DM4F.OTP.Random.inverse))

:named typing_FStar.DM4F.OTP.Random.inverse))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c82d308c1977f29914f2f3d3a95ee08f
;;; Fact-ids: Name FStar.DM4F.OTP.Random.mass; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(125,31-125,62); use=FStar.DM4F.OTP.Random.fst(125,31-125,62)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_c82d308c1977f29914f2f3d3a95ee08f @x1
@x2)
@x0)
(let ((@lb3 (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
...
:pattern ((ApplyTT (Tm_abs_c82d308c1977f29914f2f3d3a95ee08f @x1
@x2)
@x0))
:qid interpretation_Tm_abs_c82d308c1977f29914f2f3d3a95ee08f))

:named interpretation_Tm_abs_c82d308c1977f29914f2f3d3a95ee08f))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Random.mass
;;; Fact-ids: Name FStar.DM4F.OTP.Random.mass; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(125,4-125,8); use=FStar.DM4F.OTP.Random.fst(125,4-125,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.OTP.Random.mass @x0
@x1
@x2)
(FStar.DM4F.OTP.Random.sum (Tm_abs_c82d308c1977f29914f2f3d3a95ee08f @x2
@x1)))
...
@x1
@x2))
:qid equation_FStar.DM4F.OTP.Random.mass))

:named equation_FStar.DM4F.OTP.Random.mass))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.OTP.Random.inverse
;;; Fact-ids: Name FStar.DM4F.OTP.Random.inverse; Namespace FStar.DM4F.OTP.Random
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(94,4-94,11); use=FStar.DM4F.OTP.Random.fst(94,4-94,11)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.OTP.Random.inverse @x0)
(FStar.DM4F.OTP.Random.Bijection (FStar.DM4F.OTP.Random.__proj__Bijection__item__finv @x0)
(FStar.DM4F.OTP.Random.__proj__Bijection__item__f @x0)))
 

:pattern ((FStar.DM4F.OTP.Random.inverse @x0))
:qid equation_FStar.DM4F.OTP.Random.inverse))

:named equation_FStar.DM4F.OTP.Random.inverse))
(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(147,34-153,81)
...
(declare-fun Tm_abs_3ad51fe09b367ce8e00ba62322dde271 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_3ad51fe09b367ce8e00ba62322dde271
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(153,27-153,77); use=FStar.DM4F.OTP.Random.fst(153,2-153,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_3ad51fe09b367ce8e00ba62322dde271 @x0
@x1
@x2)
Tm_arrow_2406da4c5642b08528044a87c1da76cf)
 

:pattern ((Tm_abs_3ad51fe09b367ce8e00ba62322dde271 @x0
@x1
@x2))
:qid typing_Tm_abs_3ad51fe09b367ce8e00ba62322dde271))

:named typing_Tm_abs_3ad51fe09b367ce8e00ba62322dde271))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3ad51fe09b367ce8e00ba62322dde271
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(153,27-153,77); use=FStar.DM4F.OTP.Random.fst(153,2-153,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_3ad51fe09b367ce8e00ba62322dde271 @x1
@x2
@x3)
@x0)
(let ((@lb4 (ApplyTT @x2
...
@x3)
(ApplyTT (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok
(FStar.DM4F.OTP.Random.inverse @x3))
@x0))))))
(ApplyTT @x1
(FStar.Pervasives.Native.Mktuple2__1 @lb4))))
 

:pattern ((ApplyTT (Tm_abs_3ad51fe09b367ce8e00ba62322dde271 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_3ad51fe09b367ce8e00ba62322dde271))

:named interpretation_Tm_abs_3ad51fe09b367ce8e00ba62322dde271))
...
(declare-fun Tm_abs_f0051361eca86bd9f12f424627a60030 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_f0051361eca86bd9f12f424627a60030
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(152,25-152,66); use=FStar.DM4F.OTP.Random.fst(152,2-152,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_f0051361eca86bd9f12f424627a60030 @x0
@x1
@x2)
Tm_arrow_2406da4c5642b08528044a87c1da76cf)
 

:pattern ((Tm_abs_f0051361eca86bd9f12f424627a60030 @x0
@x1
@x2))
:qid typing_Tm_abs_f0051361eca86bd9f12f424627a60030))

:named typing_Tm_abs_f0051361eca86bd9f12f424627a60030))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_f0051361eca86bd9f12f424627a60030
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(152,25-152,66); use=FStar.DM4F.OTP.Random.fst(152,2-152,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_f0051361eca86bd9f12f424627a60030 @x1
@x2
@x3)
@x0)
(let ((@lb4 (ApplyTT @x2
...
:pattern ((ApplyTT (Tm_abs_f0051361eca86bd9f12f424627a60030 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_f0051361eca86bd9f12f424627a60030))

:named interpretation_Tm_abs_f0051361eca86bd9f12f424627a60030))
...
;         Type0) /\
;     (forall (pure_result: Prims.unit).
;         FStar.DM4F.OTP.Random.mass c1 p1 <= FStar.DM4F.OTP.Random.mass c2 p2 ==> p pure_result) ==>
;     (forall (h: FStar.DM4F.OTP.Heap.tape).
;         (*  - Could not prove post-condition
; *) 0 < FStar.DM4F.OTP.Heap.size) /\
;     (forall (any_result: (h: FStar.DM4F.OTP.Heap.tape -> Prims.nat)).
;         (fun h ->
;             (let r1, _ = c1 (FStar.DM4F.OTP.Heap.to_id 0, h) in
;               p1 r1)
;             <:
;             Prims.nat) ==
;         any_result ==>
...
;         (forall (any_result: (h: FStar.DM4F.OTP.Heap.tape -> Prims.nat)).
;             (fun h ->
;                 (let r2, _ = c2 (FStar.DM4F.OTP.Heap.to_id 0, h) in
;                   p2 r2)
;                 <:
;                 Prims.nat) ==
;             any_result ==>
...
;                 (*  - Could not prove post-condition
; *) 0 < FStar.DM4F.OTP.Heap.size) /\
;             (forall (any_result: (_: FStar.DM4F.OTP.Heap.tape -> Prims.nat)).
;                 (fun h ->
;                     (let r2, _ = c2 (FStar.DM4F.OTP.Heap.to_id 0, bij.f h) in
;                       p2 r2)
;                     <:
;                     Prims.nat) ==
;                 any_result ==>
...
;                       p2 r2)) /\
;                 (forall (pure_result: Prims.unit).
;                     FStar.DM4F.OTP.Random.sum (fun h ->
;                           (let r1, _ = c1 (FStar.DM4F.OTP.Heap.to_id 0, h) in
;                             p1 r1)
;                           <:
;                           Prims.nat) <=
...
;                             FStar.DM4F.OTP.Random.sum (fun h ->
;                                   (let r2, _ =
;                                       c2 (FStar.DM4F.OTP.Heap.to_id 0,
;                                         bij.f ((FStar.DM4F.OTP.Random.inverse bij).f h))
;                                     in
;                                     p2 r2)
;                                   <:
;                                   Prims.nat) ==>
...
;; def=FStar.DM4F.OTP.Random.fst(142,4-145,21); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(forall ((@x8 Term))
 (! (implies (HasType @x8
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(let ((@lb9 (ApplyTT @x2
...
;; def=FStar.DM4F.OTP.Random.fst(145,6-145,20); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(<= (BoxInt_proj_0 (ApplyTT @x4
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(forall ((@x8 Term))
 (! (implies (and (or label_1
(HasType @x8
Prims.unit))

;; def=FStar.DM4F.OTP.Random.fst(146,11-146,37); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(or label_2

;; def=FStar.DM4F.OTP.Random.fst(146,11-146,37); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(<= (BoxInt_proj_0 (FStar.DM4F.OTP.Random.mass @x0
@x2
@x4))
(BoxInt_proj_0 (FStar.DM4F.OTP.Random.mass @x1
@x3
@x5)))
)
)

;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(ApplyTT @x7
@x8)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(forall ((@x8 Term))
 (! (implies (HasType @x8
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(149,42-149,43)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Tm_arrow_2406da4c5642b08528044a87c1da76cf)

;; def=FStar.DM4F.OTP.Random.fst(149,6-149,55); use=FStar.DM4F.OTP.Random.fst(149,6-149,55)
(= (Tm_abs_c82d308c1977f29914f2f3d3a95ee08f @x4
@x2)
@x8)
)
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(150,42-150,43)
(or label_4
...
;; def=FStar.DM4F.OTP.Random.fst(150,6-150,55); use=FStar.DM4F.OTP.Random.fst(150,6-150,55)
(= (Tm_abs_c82d308c1977f29914f2f3d3a95ee08f @x5
@x3)
@x9)
)
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(151,50-151,51)
(or label_5
...
;; def=FStar.DM4F.OTP.Random.fst(106,45-151,69); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(= (Tm_abs_f0051361eca86bd9f12f424627a60030 @x5
@x3
@x6)
@x10)
)

;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.OTP.Random.fst(151,2-151,15)
(and 
;; def=FStar.DM4F.OTP.Random.fst(107,12-107,34); use=FStar.DM4F.OTP.Random.fst(151,2-151,15)
(forall ((@x11 Term))
 (! (implies (HasType @x11
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=FStar.DM4F.OTP.Random.fst(107,23-107,33); use=FStar.DM4F.OTP.Random.fst(151,2-151,15)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(151,2-151,15)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
Prims.unit)

;; def=FStar.DM4F.OTP.Random.fst(108,11-108,27); use=FStar.DM4F.OTP.Random.fst(151,2-151,15)
(<= (BoxInt_proj_0 (FStar.DM4F.OTP.Random.sum (Tm_abs_c82d308c1977f29914f2f3d3a95ee08f @x4
@x2)))
(BoxInt_proj_0 (FStar.DM4F.OTP.Random.sum (Tm_abs_f0051361eca86bd9f12f424627a60030 @x5
@x3
@x6))))
)
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(152,47-152,48)
(or label_7
...
;; def=FStar.DM4F.OTP.Random.fst(102,26-152,66); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(= (Tm_abs_f0051361eca86bd9f12f424627a60030 @x5
@x3
@x6)
@x12)
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(152,2-152,15)
(forall ((@x13 Term))
 (! (implies (and (HasType @x13
Prims.unit)

;; def=FStar.DM4F.OTP.Random.fst(103,2-103,39); use=FStar.DM4F.OTP.Random.fst(152,2-152,15)
(= (FStar.DM4F.OTP.Random.sum (Tm_abs_f0051361eca86bd9f12f424627a60030 @x5
@x3
@x6))
(FStar.DM4F.OTP.Random.sum (Tm_abs_3ad51fe09b367ce8e00ba62322dde271 @x5
@x3
@x6)))
)
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(153,49-153,50)
(or label_8
...
;; def=FStar.DM4F.OTP.Random.fst(111,21-153,77); use=FStar.DM4F.OTP.Random.fst(147,34-153,81)
(= (Tm_abs_3ad51fe09b367ce8e00ba62322dde271 @x5
@x3
@x6)
@x14)
)

;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.OTP.Random.fst(153,2-153,17)
(and 
;; def=FStar.DM4F.OTP.Random.fst(112,12-112,34); use=FStar.DM4F.OTP.Random.fst(153,2-153,17)
(forall ((@x15 Term))
 (! (implies (HasType @x15
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=FStar.DM4F.OTP.Random.fst(112,23-112,33); use=FStar.DM4F.OTP.Random.fst(153,2-153,17)
(or label_9
...
@x6)
(ApplyTT (ApplyTT FStar.DM4F.OTP.Random.__proj__Bijection__item__f@tok
(FStar.DM4F.OTP.Random.inverse @x6))
@x15))))))
(ApplyTT @x5
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(153,2-153,17)
(forall ((@x15 Term))
 (! (implies (and (HasType @x15
Prims.unit)

;; def=FStar.DM4F.OTP.Random.fst(113,11-113,27); use=FStar.DM4F.OTP.Random.fst(153,2-153,17)
(= (FStar.DM4F.OTP.Random.sum (Tm_abs_3ad51fe09b367ce8e00ba62322dde271 @x5
@x3
@x6))
(FStar.DM4F.OTP.Random.sum (Tm_abs_c82d308c1977f29914f2f3d3a95ee08f @x5
@x3)))
)

;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(153,2-153,17)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(153,2-153,17)
(ApplyTT @x7
@x15)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.pr_leq, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.OTP.Random_interpretation_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a, data_elim_FStar.DM4F.OTP.Random.Bijection, equation_FStar.DM4F.OTP.Heap.size, equation_FStar.DM4F.OTP.Random.inverse, equation_FStar.DM4F.OTP.Random.mass, fuel_guarded_inversion_FStar.DM4F.OTP.Random.bijection, lemma_FStar.DM4F.OTP.Heap.lemma_eq_elim, proj_equation_FStar.DM4F.OTP.Random.Bijection_f, proj_equation_FStar.DM4F.OTP.Random.Bijection_finv, projection_inverse_BoxInt_proj_0, projection_inverse_FStar.DM4F.OTP.Random.Bijection_f, refinement_interpretation_Tm_refine_6e1cd8b072e751339d1179e813fda863, token_correspondence_FStar.DM4F.OTP.Random.__proj__Bijection__item__f
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.OTP.Random.pr_leq (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.OTP.Random.pr_leq@tok () Term)

; </end encoding let pr_leq>

(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(157,0-167,38)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(89,9-89,13); use=FStar.DM4F.OTP.Random.fst(157,14-167,38)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_24335d74380922f290a2b99aff3a0b1c)
...
(declare-fun Tm_abs_15e9f23bcae7b7abc9117958f0117fc2 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_15e9f23bcae7b7abc9117958f0117fc2
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(164,4-166,25); use=FStar.DM4F.OTP.Random.fst(164,4-166,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_abs_15e9f23bcae7b7abc9117958f0117fc2 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((Tm_abs_15e9f23bcae7b7abc9117958f0117fc2 @x0
@x1
@x2
@x3
@x4))
:qid typing_Tm_abs_15e9f23bcae7b7abc9117958f0117fc2))

:named typing_Tm_abs_15e9f23bcae7b7abc9117958f0117fc2))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_15e9f23bcae7b7abc9117958f0117fc2
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(164,4-166,25); use=FStar.DM4F.OTP.Random.fst(164,4-166,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (ApplyTT (Tm_abs_15e9f23bcae7b7abc9117958f0117fc2 @x1
@x2
@x3
@x4
@x5)
...
:pattern ((ApplyTT (Tm_abs_15e9f23bcae7b7abc9117958f0117fc2 @x1
@x2
@x3
@x4
@x5)
@x0))
:qid interpretation_Tm_abs_15e9f23bcae7b7abc9117958f0117fc2))

:named interpretation_Tm_abs_15e9f23bcae7b7abc9117958f0117fc2))
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.l_Forall (FStar.DM4F.OTP.Heap.tape Dummy_value)
(Tm_abs_15e9f23bcae7b7abc9117958f0117fc2 @x4
@x3
@x2
@x1
@x0)))
...
;; def=FStar.DM4F.OTP.Random.fst(166,10-166,24); use=FStar.DM4F.OTP.Random.fst(166,10-166,24)
(= (ApplyTT @x4
(FStar.Pervasives.Native.Mktuple2__1 @lb6))
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2__1 @lb7)))
...
;;no pats
:qid l_quant_interp_cf57b25ff9af9d963789959ee379048e.1))
)
...
@x1
@x0))))
:qid l_quant_interp_cf57b25ff9af9d963789959ee379048e))

:named l_quant_interp_cf57b25ff9af9d963789959ee379048e))
...
;               FStar.DM4F.OTP.Heap.to_id 0 == any_result ==>
;               (forall (any_result: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape).
;                   (FStar.DM4F.OTP.Heap.to_id 0, h) == any_result ==>
;                   (forall (any_result: a & FStar.DM4F.OTP.Heap.id).
;                       c1 (FStar.DM4F.OTP.Heap.to_id 0, h) == any_result ==>
;                       (forall (b: a) (b: FStar.DM4F.OTP.Heap.id).
;                           c1 (FStar.DM4F.OTP.Heap.to_id 0, h) == (b, b) ==>
;                           0 < FStar.DM4F.OTP.Heap.size)))))) /\
;   (forall (any_result: (_: FStar.DM4F.OTP.Heap.tape -> Prims.GTot Type0)).
;       (fun h ->
;           (let r1, _ = c1 (FStar.DM4F.OTP.Heap.to_id 0, h) in
...
; Context: While encoding a query
; While typechecking the top-level declaration `val FStar.DM4F.OTP.Random.pr_eq`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(157,0-167,38)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(157,14-167,38)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(157,14-167,38)
(forall ((@x7 Term))
 (! (implies (HasType @x7
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(164,4-166,25)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(164,36-164,37)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(164,4-166,25)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.int)

;; def=FStar.DM4F.OTP.Heap.fsti(33,11-33,12); use=FStar.DM4F.OTP.Random.fst(164,4-166,25)
(= (BoxInt 0)
@x8)
)
...
;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=FStar.DM4F.OTP.Random.fst(164,4-166,25)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x9)
)
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(164,4-166,25)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x7)
...
;; def=FStar.DM4F.OTP.Random.fst(164,19-164,41); use=FStar.DM4F.OTP.Random.fst(164,19-164,41)
(= (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.OTP.Random.fst(164,4-166,25)
(forall ((@x12 Term))
 (! (implies (HasType @x12
@x0)
...
;; def=FStar.DM4F.OTP.Random.fst(164,19-164,23); use=FStar.DM4F.OTP.Random.fst(164,19-164,23)
(= (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(165,31-165,32)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(157,14-167,38)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Tm_arrow_24335d74380922f290a2b99aff3a0b1c)

;; def=Prims.fst(286,26-286,27); use=FStar.DM4F.OTP.Random.fst(157,14-167,38)
(= (Tm_abs_15e9f23bcae7b7abc9117958f0117fc2 @x4
@x5
@x3
@x6
...
;; def=FStar.Pervasives.fsti(112,28-112,31); use=FStar.DM4F.OTP.Random.fst(157,14-167,38)
(= (Prims.l_Forall (FStar.DM4F.OTP.Heap.tape Dummy_value)
(Tm_abs_15e9f23bcae7b7abc9117958f0117fc2 @x4
@x5
@x3
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(167,11-167,37)
(forall ((@x9 Term))
 (! (implies (HasType @x9
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(167,11-167,37)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(162,19-162,24)
(or label_3

;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(167,11-167,37)
(< (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
)


;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(167,11-167,37)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.int)

;; def=FStar.DM4F.OTP.Heap.fsti(33,11-33,12); use=FStar.DM4F.OTP.Random.fst(167,11-167,37)
(= (BoxInt 0)
@x10)
)
...
;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=FStar.DM4F.OTP.Random.fst(167,11-167,37)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x11)
)
...
;; def=FStar.DM4F.OTP.Random.fst(164,19-164,41); use=FStar.DM4F.OTP.Random.fst(167,11-167,37)
(= (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.OTP.Random.fst(167,11-167,37)
(forall ((@x14 Term))
 (! (implies (HasType @x14
@x0)
...
;; def=FStar.DM4F.OTP.Random.fst(164,19-164,23); use=FStar.DM4F.OTP.Random.fst(167,11-167,37)
(= (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.pr_eq, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.DM4F.OTP.Heap.size, projection_inverse_BoxInt_proj_0
...
; encoding sigelt val FStar.DM4F.OTP.Random.pr_eq


; <Skipped val FStar.DM4F.OTP.Random.pr_eq/>

(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(169,2-170,34)
...
;         Type0) /\
;     (forall (pure_result: Prims.unit).
;         FStar.DM4F.OTP.Random.mass c1 p1 <= FStar.DM4F.OTP.Random.mass c2 p2 ==>
;         (forall (t: FStar.DM4F.OTP.Heap.tape).
;             (let r1, _ = c2 (FStar.DM4F.OTP.Heap.to_id 0, t) in
;               (let r2, _ =
;                   c1 (FStar.DM4F.OTP.Heap.to_id 0, (FStar.DM4F.OTP.Random.inverse bij).f t)
;                 in
;                 p2 r1 <= p1 r2)
;               <:
;               Type0)
...
;             Type0) /\
;         (forall (pure_result: Prims.unit).
;             FStar.DM4F.OTP.Random.mass c2 p2 <= FStar.DM4F.OTP.Random.mass c1 p1 ==> p pure_result))
...
;; def=FStar.DM4F.OTP.Random.fst(164,4-166,25); use=FStar.DM4F.OTP.Random.fst(169,2-170,34)
(forall ((@x8 Term))
 (! (implies (HasType @x8
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(let ((@lb9 (ApplyTT @x2
...
;; def=FStar.DM4F.OTP.Random.fst(166,10-166,24); use=FStar.DM4F.OTP.Random.fst(169,2-170,34)
(= (ApplyTT @x4
(FStar.Pervasives.Native.Mktuple2__1 @lb9))
(ApplyTT @x5
(FStar.Pervasives.Native.Mktuple2__1 @lb10)))
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(169,2-170,34)
(forall ((@x8 Term))
 (! (implies (and (or label_1
(HasType @x8
Prims.unit))

;; def=FStar.DM4F.OTP.Random.fst(167,11-167,37); use=FStar.DM4F.OTP.Random.fst(169,2-170,34)
(or label_2
...
@x2
@x4)
(FStar.DM4F.OTP.Random.mass @x1
@x3
@x5))
)
)

;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(169,2-170,34)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(169,2-170,34)
(ApplyTT @x7
@x8)
...
;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.OTP.Random.fst(169,2-169,8)
(and 
;; def=FStar.DM4F.OTP.Random.fst(142,4-145,21); use=FStar.DM4F.OTP.Random.fst(169,2-169,8)
(forall ((@x8 Term))
 (! (implies (HasType @x8
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(let ((@lb9 (ApplyTT @x2
...
;; def=FStar.DM4F.OTP.Random.fst(145,6-145,20); use=FStar.DM4F.OTP.Random.fst(169,2-169,8)
(or label_3
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(169,2-169,8)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=FStar.DM4F.OTP.Random.fst(146,11-146,37); use=FStar.DM4F.OTP.Random.fst(169,2-169,8)
(<= (BoxInt_proj_0 (FStar.DM4F.OTP.Random.mass @x0
@x2
@x4))
(BoxInt_proj_0 (FStar.DM4F.OTP.Random.mass @x1
...
;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.OTP.Random.fst(170,2-170,8)
(and 
;; def=FStar.DM4F.OTP.Random.fst(142,4-145,21); use=FStar.DM4F.OTP.Random.fst(170,2-170,8)
(forall ((@x9 Term))
 (! (implies (HasType @x9
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(let ((@lb10 (ApplyTT @x3
...
;; def=FStar.DM4F.OTP.Random.fst(145,6-145,20); use=FStar.DM4F.OTP.Random.fst(170,2-170,8)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(170,2-170,8)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.unit)

;; def=FStar.DM4F.OTP.Random.fst(146,11-146,37); use=FStar.DM4F.OTP.Random.fst(170,2-170,8)
(<= (BoxInt_proj_0 (FStar.DM4F.OTP.Random.mass @x1
@x3
@x5))
(BoxInt_proj_0 (FStar.DM4F.OTP.Random.mass @x0
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(170,2-170,8)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(170,2-170,8)
(ApplyTT @x7
@x9)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.pr_eq, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.OTP.Random_interpretation_Tm_arrow_6cffc838e221e9db79a8e9b298c3ba2a, data_elim_FStar.DM4F.OTP.Random.Bijection, equation_FStar.DM4F.OTP.Random.inverse, equation_FStar.DM4F.OTP.Random.mass, equation_Prims.nat, fuel_guarded_inversion_FStar.DM4F.OTP.Random.bijection, int_inversion, lemma_FStar.DM4F.OTP.Heap.lemma_eq_elim, proj_equation_FStar.DM4F.OTP.Random.Bijection_f, proj_equation_FStar.DM4F.OTP.Random.Bijection_finv, projection_inverse_FStar.DM4F.OTP.Random.Bijection_f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_6e1cd8b072e751339d1179e813fda863, token_correspondence_FStar.DM4F.OTP.Random.__proj__Bijection__item__f, typing_FStar.DM4F.OTP.Random.mass
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.OTP.Random.pr_eq (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.OTP.Random.pr_eq@tok () Term)
...
; Starting query at FStar.DM4F.OTP.Random.fst(172,0-195,24)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(172,11-174,22); use=FStar.DM4F.OTP.Random.fst(174,8-174,22)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_a19f9d49348d4e0038f0ded87d87802f @x2)))
:qid FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))

:named FStar.DM4F.OTP.Random_pre_typing_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))
...
@x2)
@x3))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f.2))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_a19f9d49348d4e0038f0ded87d87802f @x1)))
:qid FStar.DM4F.OTP.Random_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))

:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_a19f9d49348d4e0038f0ded87d87802f))
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(21,26-21,30); use=FStar.DM4F.OTP.Random.fst(172,13-195,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_24335d74380922f290a2b99aff3a0b1c)
...
:named FStar.DM4F.OTP.Random_interpretation_Tm_arrow_24335d74380922f290a2b99aff3a0b1c))
(declare-fun Tm_refine_344dac369a489b12a58784aa362b15a6 (Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(183,12-191,36); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (HasType (Tm_refine_344dac369a489b12a58784aa362b15a6 @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_344dac369a489b12a58784aa362b15a6 @x0
@x1
@x2
@x3
@x4
...
@x7)
Tm_type))
:qid refinement_kinding_Tm_refine_344dac369a489b12a58784aa362b15a6))

:named refinement_kinding_Tm_refine_344dac369a489b12a58784aa362b15a6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(183,12-191,36); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term) (@x9 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_344dac369a489b12a58784aa362b15a6 @x2
@x3
@x4
@x5
@x6
...
;; def=FStar.DM4F.OTP.Random.fst(189,6-191,35); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(and 
;; def=FStar.DM4F.OTP.Random.fst(189,6-189,24); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(implies 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(189,7-189,10)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(189,7-189,10)
@x2
)
...
;; def=FStar.DM4F.OTP.Random.fst(189,15-189,23); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(= @x3
@x4)
)


;; def=FStar.DM4F.OTP.Random.fst(190,6-190,33); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(implies 
;; def=FStar.DM4F.OTP.Random.fst(190,7-190,16); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(and 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(190,7-190,10)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(190,7-190,10)
@x2
)
...
;; def=FStar.DM4F.OTP.Random.fst(175,2-175,4); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(BoxBool_proj_0 @x3)
)


;; def=FStar.DM4F.OTP.Random.fst(190,22-190,32); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(190,22-190,32); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(ApplyTT (ApplyTT @x5
(FStar.Pervasives.Native.Mktuple2__1 @lb11))
...
;; def=FStar.DM4F.OTP.Random.fst(191,6-191,35); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(implies 
;; def=FStar.DM4F.OTP.Random.fst(191,7-191,17); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(and 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(191,7-191,10)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(191,7-191,10)
@x2
)
...
;; def=FStar.DM4F.OTP.Random.fst(191,14-191,17); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(not 
;; def=FStar.DM4F.OTP.Random.fst(175,2-175,4); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(BoxBool_proj_0 @x3)
)
...
;; def=FStar.DM4F.OTP.Random.fst(191,22-191,34); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(191,22-191,34); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(ApplyTT (ApplyTT @x5
...
;;no pats
:qid refinement_interpretation_Tm_refine_344dac369a489b12a58784aa362b15a6.1))
))
...
@x8
@x9)))
:qid refinement_interpretation_Tm_refine_344dac369a489b12a58784aa362b15a6))

:named refinement_interpretation_Tm_refine_344dac369a489b12a58784aa362b15a6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_344dac369a489b12a58784aa362b15a6
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(183,12-191,36); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_344dac369a489b12a58784aa362b15a6 @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_344dac369a489b12a58784aa362b15a6 @x0
@x1
@x2
@x3
@x4
...
@x6
@x7))))
:qid haseqTm_refine_344dac369a489b12a58784aa362b15a6))

:named haseqTm_refine_344dac369a489b12a58784aa362b15a6))
...
(declare-fun Tm_abs_063ed8b177634eeb06ed86ed044e1a1d (Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_063ed8b177634eeb06ed86ed044e1a1d
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(183,12-191,36); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (HasType (Tm_abs_063ed8b177634eeb06ed86ed044e1a1d @x0
@x1
@x2
@x3
@x4
...
:pattern ((Tm_abs_063ed8b177634eeb06ed86ed044e1a1d @x0
@x1
@x2
@x3
@x4
...
@x6
@x7))
:qid typing_Tm_abs_063ed8b177634eeb06ed86ed044e1a1d))

:named typing_Tm_abs_063ed8b177634eeb06ed86ed044e1a1d))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_063ed8b177634eeb06ed86ed044e1a1d
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(183,12-191,36); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (= (ApplyTT (Tm_abs_063ed8b177634eeb06ed86ed044e1a1d @x1
@x2
@x3
@x4
@x5
...
:pattern ((ApplyTT (Tm_abs_063ed8b177634eeb06ed86ed044e1a1d @x1
@x2
@x3
@x4
@x5
...
@x8)
@x0))
:qid interpretation_Tm_abs_063ed8b177634eeb06ed86ed044e1a1d))

:named interpretation_Tm_abs_063ed8b177634eeb06ed86ed044e1a1d))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(183,12-191,36); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (iff (Valid (Prims.l_Forall (FStar.DM4F.OTP.Heap.tape Dummy_value)
(Tm_abs_063ed8b177634eeb06ed86ed044e1a1d @x7
@x6
@x5
@x4
@x3
...
;; def=FStar.DM4F.OTP.Random.fst(189,6-191,35); use=FStar.DM4F.OTP.Random.fst(189,6-191,35)
(and 
;; def=FStar.DM4F.OTP.Random.fst(189,6-189,24); use=FStar.DM4F.OTP.Random.fst(189,6-189,24)
(implies 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(189,7-189,10)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(189,7-189,10)
...
;; def=FStar.DM4F.OTP.Random.fst(189,15-189,23); use=FStar.DM4F.OTP.Random.fst(189,15-189,23)
(= @x6
@x5)
)


;; def=FStar.DM4F.OTP.Random.fst(190,6-190,33); use=FStar.DM4F.OTP.Random.fst(190,6-190,33)
(implies 
;; def=FStar.DM4F.OTP.Random.fst(190,7-190,16); use=FStar.DM4F.OTP.Random.fst(190,7-190,16)
(and 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(190,7-190,10)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(190,7-190,10)
...
;; def=FStar.DM4F.OTP.Random.fst(175,2-175,4); use=FStar.DM4F.OTP.Random.fst(190,14-190,16)
(BoxBool_proj_0 @x6)
)


;; def=FStar.DM4F.OTP.Random.fst(190,22-190,32); use=FStar.DM4F.OTP.Random.fst(190,22-190,32)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(190,22-190,32); use=FStar.DM4F.OTP.Random.fst(190,22-190,32)
(ApplyTT (ApplyTT @x4
(FStar.Pervasives.Native.Mktuple2__1 @lb9))
...
;; def=FStar.DM4F.OTP.Random.fst(191,6-191,35); use=FStar.DM4F.OTP.Random.fst(191,6-191,35)
(implies 
;; def=FStar.DM4F.OTP.Random.fst(191,7-191,17); use=FStar.DM4F.OTP.Random.fst(191,7-191,17)
(and 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(191,7-191,10)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(173,2-173,5); use=FStar.DM4F.OTP.Random.fst(191,7-191,10)
...
;; def=FStar.DM4F.OTP.Random.fst(191,14-191,17); use=FStar.DM4F.OTP.Random.fst(191,14-191,17)
(not 
;; def=FStar.DM4F.OTP.Random.fst(175,2-175,4); use=FStar.DM4F.OTP.Random.fst(191,15-191,17)
(BoxBool_proj_0 @x6)
)
)


;; def=FStar.DM4F.OTP.Random.fst(191,22-191,34); use=FStar.DM4F.OTP.Random.fst(191,22-191,34)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(191,22-191,34); use=FStar.DM4F.OTP.Random.fst(191,22-191,34)
(ApplyTT (ApplyTT @x4
(FStar.Pervasives.Native.Mktuple2__1 @lb11))
...
;;no pats
:qid l_quant_interp_6d79fe54270672dc92a3faec8531c603.1))
)
...
@x1
@x0))))
:qid l_quant_interp_6d79fe54270672dc92a3faec8531c603))

:named l_quant_interp_6d79fe54270672dc92a3faec8531c603))
...
;                                   FStar.DM4F.OTP.Heap.to_id 0 == any_result ==>
;                                   (forall (any_result:
;                                       FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape).
;                                       (FStar.DM4F.OTP.Heap.to_id 0, h) == any_result ==>
;                                       (forall (any_result: a & FStar.DM4F.OTP.Heap.id).
;                                           c2 (FStar.DM4F.OTP.Heap.to_id 0, h) == any_result ==>
;                                           (forall (b: a) (b: FStar.DM4F.OTP.Heap.id).
;                                               c2 (FStar.DM4F.OTP.Heap.to_id 0, h) == (b, b) ==>
;                                               0 < FStar.DM4F.OTP.Heap.size /\
;                                               (forall (any_result: Prims.int).
;                                                   0 == any_result ==>
;                                                   (forall (any_result: FStar.DM4F.OTP.Heap.id).
...
;                                                           any_result ==>
;                                                           (forall (any_result:
;                                                               a & FStar.DM4F.OTP.Heap.id).
;                                                               c1' (FStar.DM4F.OTP.Heap.to_id 0, h) ==
;                                                               any_result ==>
;                                                               (forall (b: a)
;                                                                   (b: FStar.DM4F.OTP.Heap.id).
;                                                                   c1' (FStar.DM4F.OTP.Heap.to_id 0,
;                                                                     h) ==
;                                                                   (b,
;                                                                   b) ==>
;                                                                   0 < FStar.DM4F.OTP.Heap.size))))))
...
;                                                               )))))))))))))) /\
;           (forall (_:
;               Prims.squash (forall (h: FStar.DM4F.OTP.Heap.tape).
;                     (let r1, _ = c1 (FStar.DM4F.OTP.Heap.to_id 0, h) in
;                       (let r2, _ = c2 (FStar.DM4F.OTP.Heap.to_id 0, h) in
;                         (let r1', _ = c1' (FStar.DM4F.OTP.Heap.to_id 0, h) in
;                           (let r2', _ = c2' (FStar.DM4F.OTP.Heap.to_id 0, h) in
...
; *)
;               forall (k:
;                 Prims.pure_post (_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape
;                       -> a & FStar.DM4F.OTP.Heap.id)).
;                 (forall (x:
;                     (_: FStar.DM4F.OTP.Heap.id & FStar.DM4F.OTP.Heap.tape
;                         -> a & FStar.DM4F.OTP.Heap.id)).
...
;                                     (match b1 with
;                                       | true -> c1
;                                       | _ -> c1') (FStar.DM4F.OTP.Heap.to_id 0,
;                                       h) ==
;                                     any_result ==>
;                                     (forall (b: a) (b: FStar.DM4F.OTP.Heap.id).
;                                         (match b1 with
...
;                                                     -> a & FStar.DM4F.OTP.Heap.id)).
;                                                 {:pattern Prims.guard_free (k x)}
;                                                 0 < FStar.DM4F.OTP.Heap.size ==> k x) ==>
;                                             (b2 == true ==>
;                                               (forall (any_result:
;                                                   (
;                                                         _:
;                                                           FStar.DM4F.OTP.Heap.id &
;                                                           FStar.DM4F.OTP.Heap.tape
;                                                       -> Prims.M (a & FStar.DM4F.OTP.Heap.id))).
;                                                   k any_result)) /\
;                                             (~(b2 = true) ==>
;                                               (forall (b: Prims.bool).
;                                                   b2 == b ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `val FStar.DM4F.OTP.Random.cond`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(172,0-195,24)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(172,13-195,24)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(172,13-195,24)
(forall ((@x10 Term))
 (! (implies (HasType @x10
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(185,29-185,30)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(forall ((@x11 Term))
 (! (implies (and (HasType @x11
Prims.int)

;; def=FStar.DM4F.OTP.Heap.fsti(33,11-33,12); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(= (BoxInt 0)
@x11)
)
...
;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x12)
)
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(= (FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x10)
...
;; def=FStar.DM4F.OTP.Random.fst(185,10-185,34); use=FStar.DM4F.OTP.Random.fst(185,10-185,34)
(= (ApplyTT @x5
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(forall ((@x15 Term))
 (! (implies (HasType @x15
@x0)
...
;; def=FStar.DM4F.OTP.Random.fst(185,10-185,14); use=FStar.DM4F.OTP.Random.fst(185,10-185,14)
(= (ApplyTT @x5
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(186,29-186,30)
(or label_2
...
;; def=FStar.DM4F.OTP.Random.fst(186,10-186,34); use=FStar.DM4F.OTP.Random.fst(186,10-186,34)
(= (ApplyTT @x7
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=FStar.DM4F.OTP.Random.fst(186,10-186,14); use=FStar.DM4F.OTP.Random.fst(186,10-186,14)
(= (ApplyTT @x7
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(183,12-191,36)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(187,29-187,30)
(or label_3
...
;; def=FStar.DM4F.OTP.Random.fst(187,10-187,34); use=FStar.DM4F.OTP.Random.fst(187,10-187,34)
(= (ApplyTT @x6
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=FStar.DM4F.OTP.Random.fst(187,10-187,15); use=FStar.DM4F.OTP.Random.fst(187,10-187,15)
(= (ApplyTT @x6
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(188,29-188,30)
(or label_4
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(172,13-195,24)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Tm_arrow_24335d74380922f290a2b99aff3a0b1c)

;; def=Prims.fst(286,26-286,27); use=FStar.DM4F.OTP.Random.fst(172,13-195,24)
(= (Tm_abs_063ed8b177634eeb06ed86ed044e1a1d @x1
@x3
@x4
@x2
@x8
...
;; def=FStar.Pervasives.fsti(112,28-112,31); use=FStar.DM4F.OTP.Random.fst(172,13-195,24)
(= (Prims.l_Forall (FStar.DM4F.OTP.Heap.tape Dummy_value)
(Tm_abs_063ed8b177634eeb06ed86ed044e1a1d @x1
@x3
@x4
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(172,13-195,24)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(forall ((@x12 Term))
 (! (implies (HasType @x12
(FStar.DM4F.OTP.Heap.tape Dummy_value))

;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(182,2-182,7)
(or label_5

;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(< (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 (FStar.DM4F.OTP.Heap.size Dummy_value)))
)


;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(forall ((@x13 Term))
 (! (implies (and (HasType @x13
Prims.int)

;; def=FStar.DM4F.OTP.Heap.fsti(33,11-33,12); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(= (BoxInt 0)
@x13)
)
...
;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(= (FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
@x14)
)
...
;; def=FStar.DM4F.OTP.Random.fst(185,10-185,34); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(= (ApplyTT @x5
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(forall ((@x17 Term))
 (! (implies (HasType @x17
@x0)
...
;; def=FStar.DM4F.OTP.Random.fst(185,10-185,14); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(= (ApplyTT @x5
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=FStar.DM4F.OTP.Random.fst(186,10-186,34); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(= (ApplyTT @x7
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=FStar.DM4F.OTP.Random.fst(186,10-186,14); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(= (ApplyTT @x7
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=FStar.DM4F.OTP.Random.fst(187,10-187,34); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(= (ApplyTT @x6
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
;; def=FStar.DM4F.OTP.Random.fst(187,10-187,15); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(= (ApplyTT @x6
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.OTP.Heap.id Dummy_value)
(FStar.DM4F.OTP.Heap.tape Dummy_value)
(FStar.DM4F.OTP.Heap.to_id (BoxInt 0))
...
(forall ((@x12 Term))
 (! (implies (HasType @x12
(Tm_refine_344dac369a489b12a58784aa362b15a6 @x1
@x3
@x4
@x2
@x8
...
;; def=Prims.fst(402,2-402,97); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(forall ((@x13 Term))
 (! (implies (and (HasType @x13
(Prims.pure_post (Tm_arrow_953bc1c8c8b8ca933c5c0a552ff468d3 @x0)))

;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(forall ((@x14 Term))
 (! 
;; def=Prims.fst(402,73-402,87); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(implies 
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(and 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(193,47-193,48)
(or label_9
...
;; def=FStar.DM4F.OTP.Random.fst(193,8-193,52); use=FStar.DM4F.OTP.Random.fst(193,8-193,52)
(= (ApplyTT (let ((@lb19 @x3))
(ite (= @lb19
(BoxBool true))
@x5
...
;; def=FStar.DM4F.OTP.Random.fst(193,8-193,12); use=FStar.DM4F.OTP.Random.fst(193,8-193,12)
(= (ApplyTT (let ((@lb21 @x3))
(ite (= @lb21
(BoxBool true))
@x5
...
(forall ((@x22 Term))
 (! (implies 
;; def=FStar.DM4F.OTP.Heap.fsti(33,17-33,25); use=FStar.DM4F.OTP.Random.fst(194,47-194,48)
(or label_10
...
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(ApplyTT @x21
@x22)
...
;; def=Prims.fst(389,2-389,39); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(and (implies 
;; def=FStar.DM4F.OTP.Random.fst(176,2-194,21); use=FStar.DM4F.OTP.Random.fst(194,19-194,21)
(= @x4
(BoxBool true))
...
;; def=Prims.fst(451,90-451,102); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(Valid 
;; def=Prims.fst(451,90-451,102); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(ApplyTT @x21
@x22)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(not 
;; def=FStar.DM4F.OTP.Random.fst(176,2-194,21); use=FStar.DM4F.OTP.Random.fst(194,19-194,21)
(= @x4
(BoxBool true))
...
;; def=FStar.DM4F.OTP.Random.fst(176,2-194,38); use=FStar.DM4F.OTP.Random.fst(194,19-194,38)
(= @x4
@x22)
)
...
;; def=Prims.fst(389,2-389,39); use=FStar.DM4F.OTP.Random.fst(192,11-195,23)
(and (implies 
;; def=FStar.DM4F.OTP.Random.fst(175,2-193,21); use=FStar.DM4F.OTP.Random.fst(193,19-193,21)
(= @x3
(BoxBool true))
...
;; def=FStar.DM4F.OTP.Random.fst(175,2-193,38); use=FStar.DM4F.OTP.Random.fst(193,19-193,38)
(= @x3
@x14)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.cond, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.DM4F.OTP.Heap.size, projection_inverse_BoxInt_proj_0
...
; encoding sigelt val FStar.DM4F.OTP.Random.cond


; <Skipped val FStar.DM4F.OTP.Random.cond/>

(push) ;; push{2

; Starting query at FStar.DM4F.OTP.Random.fst(196,45-196,47)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.OTP.Random.fst(174,18-196,11); use=FStar.DM4F.OTP.Random.fst(196,4-196,11)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_a19f9d49348d4e0038f0ded87d87802f @x0)
Tm_type)
...
;               (match b2 with
;                 | true -> c2
;                 | _ -> c2') (FStar.DM4F.OTP.Heap.to_id 0,
;                 h)
;             in
;             pre ==> post r1 r2)
;           <:
...
;; def=FStar.DM4F.OTP.Random.fst(183,12-191,36); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(forall ((@x11 Term))
 (! (implies (HasType @x11
(FStar.DM4F.OTP.Heap.tape Dummy_value))
(let ((@lb12 (ApplyTT @x5
...
;; def=FStar.DM4F.OTP.Random.fst(189,6-191,35); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(and 
;; def=FStar.DM4F.OTP.Random.fst(189,6-189,24); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(implies 
;; def=FStar.DM4F.OTP.Random.fst(196,12-196,15); use=FStar.DM4F.OTP.Random.fst(196,12-196,15)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(196,12-196,15); use=FStar.DM4F.OTP.Random.fst(196,12-196,15)
@x1
)
...
;; def=FStar.DM4F.OTP.Random.fst(189,15-189,23); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(= @x3
@x4)
)


;; def=FStar.DM4F.OTP.Random.fst(190,6-190,33); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(implies 
;; def=FStar.DM4F.OTP.Random.fst(190,7-190,16); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(and 
;; def=FStar.DM4F.OTP.Random.fst(196,12-196,15); use=FStar.DM4F.OTP.Random.fst(196,12-196,15)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(196,12-196,15); use=FStar.DM4F.OTP.Random.fst(196,12-196,15)
...
;; def=FStar.DM4F.OTP.Random.fst(175,2-175,4); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(BoxBool_proj_0 @x3)
)


;; def=FStar.DM4F.OTP.Random.fst(190,22-190,32); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(190,22-190,32); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(ApplyTT (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2__1 @lb12))
...
;; def=FStar.DM4F.OTP.Random.fst(191,6-191,35); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(implies 
;; def=FStar.DM4F.OTP.Random.fst(191,7-191,17); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(and 
;; def=FStar.DM4F.OTP.Random.fst(196,12-196,15); use=FStar.DM4F.OTP.Random.fst(196,12-196,15)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(196,12-196,15); use=FStar.DM4F.OTP.Random.fst(196,12-196,15)
...
;; def=FStar.DM4F.OTP.Random.fst(191,14-191,17); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(not 
;; def=FStar.DM4F.OTP.Random.fst(175,2-175,4); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(BoxBool_proj_0 @x3)
)
...
;; def=FStar.DM4F.OTP.Random.fst(191,22-191,34); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(Valid 
;; def=FStar.DM4F.OTP.Random.fst(191,22-191,34); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(ApplyTT (ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2__1 @lb14))
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(forall ((@x11 Term))
 (! (implies (and (or label_1
(HasType @x11
Prims.unit))
...
;; def=FStar.DM4F.OTP.Random.fst(195,12-195,22); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.OTP.Random.fst(196,45-196,47)
(ApplyTT @x10
@x11)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.OTP.Random.cond, 2)
; STATUS: unsat
