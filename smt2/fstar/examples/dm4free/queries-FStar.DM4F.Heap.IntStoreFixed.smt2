...
; Internals for FStar.DM4F.Heap.IntStoreFixed


; encoding sigelt let store_size


; <Start encoding let store_size>

(declare-fun FStar.DM4F.Heap.IntStoreFixed.store_size (Dummy_sort) Term)

; </end encoding let store_size>


; encoding sigelt val FStar.DM4F.Heap.IntStoreFixed.id


; <Skipped val FStar.DM4F.Heap.IntStoreFixed.id/>
...
; Starting query at FStar.DM4F.Heap.IntStoreFixed.fst(20,0-20,30)
...
; While typechecking the top-level declaration `let id`
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,11-20,14); use=FStar.DM4F.Heap.IntStoreFixed.fst(20,11-20,14)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.IntStoreFixed.id, 1)
; STATUS: unsat
...
(declare-fun FStar.DM4F.Heap.IntStoreFixed.id (Dummy_sort) Term)
(declare-fun Tm_refine_6970eb1cc2a7cbece1f97684ca23fd46 () Term)

; </end encoding let id>


; encoding sigelt val FStar.DM4F.Heap.IntStoreFixed.heap


; <Skipped val FStar.DM4F.Heap.IntStoreFixed.heap/>
...
; Starting query at FStar.DM4F.Heap.IntStoreFixed.fst(21,0-21,44)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq (FStar.Seq.Base.seq Prims.int)


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let heap`
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(21,13-21,20); use=FStar.DM4F.Heap.IntStoreFixed.fst(21,13-21,20)
(or label_1

;; def=FStar.DM4F.Heap.IntStoreFixed.fst(21,13-21,20); use=FStar.DM4F.Heap.IntStoreFixed.fst(21,13-21,20)
(Valid 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(21,13-21,20); use=FStar.DM4F.Heap.IntStoreFixed.fst(21,13-21,20)
(Prims.hasEq (FStar.Seq.Base.seq Prims.int))
)
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.IntStoreFixed.heap, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, lemma_FStar.Seq.Base.hasEq_lemma, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
(declare-fun FStar.DM4F.Heap.IntStoreFixed.heap (Dummy_sort) Term)
(declare-fun Tm_refine_6df2ffe10bff6bf2a3fe27af74739e18 () Term)

; </end encoding let heap>


; encoding sigelt val FStar.DM4F.Heap.IntStoreFixed.to_id


; <Skipped val FStar.DM4F.Heap.IntStoreFixed.to_id/>


; encoding sigelt let to_id


; <Start encoding let to_id>


(declare-fun FStar.DM4F.Heap.IntStoreFixed.to_id (Term) Term)

;;;;;;;;;;;;;;;;n: Prims.nat{n < store_size} -> id
(declare-fun Tm_arrow_bb5123e62ee26bf481c947e2a29e3b8e () Term)
(declare-fun FStar.DM4F.Heap.IntStoreFixed.to_id@tok () Term)


; </end encoding let to_id>


; encoding sigelt val FStar.DM4F.Heap.IntStoreFixed.index


; <Skipped val FStar.DM4F.Heap.IntStoreFixed.index/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.store_size; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(20,4-20,14); use=FStar.DM4F.Heap.IntStoreFixed.fsti(20,4-20,14)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.DM4F.Heap.IntStoreFixed.store_size @u0)
Prims.int)
 

:pattern ((FStar.DM4F.Heap.IntStoreFixed.store_size @u0))
:qid typing_FStar.DM4F.Heap.IntStoreFixed.store_size))

:named typing_FStar.DM4F.Heap.IntStoreFixed.store_size))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.id; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,4-20,6); use=FStar.DM4F.Heap.IntStoreFixed.fst(20,4-20,6)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.DM4F.Heap.IntStoreFixed.id @u0)
Prims.eqtype)
 

:pattern ((FStar.DM4F.Heap.IntStoreFixed.id @u0))
:qid typing_FStar.DM4F.Heap.IntStoreFixed.id))

:named typing_FStar.DM4F.Heap.IntStoreFixed.id))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.heap; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(21,4-21,8); use=FStar.DM4F.Heap.IntStoreFixed.fst(21,4-21,8)
(forall ((@u0 Dummy_sort))
 (! (HasType (FStar.DM4F.Heap.IntStoreFixed.heap @u0)
Prims.eqtype)
 

:pattern ((FStar.DM4F.Heap.IntStoreFixed.heap @u0))
:qid typing_FStar.DM4F.Heap.IntStoreFixed.heap))

:named typing_FStar.DM4F.Heap.IntStoreFixed.heap))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.heap; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! (HasType Tm_refine_6df2ffe10bff6bf2a3fe27af74739e18
Tm_type)
:named refinement_kinding_Tm_refine_6df2ffe10bff6bf2a3fe27af74739e18))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.id; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! (HasType Tm_refine_6970eb1cc2a7cbece1f97684ca23fd46
Tm_type)
:named refinement_kinding_Tm_refine_6970eb1cc2a7cbece1f97684ca23fd46))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.heap; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(21,11-21,44); use=FStar.DM4F.Heap.IntStoreFixed.fst(21,11-21,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_6df2ffe10bff6bf2a3fe27af74739e18)
(and (HasTypeFuel @u0
@x1
(FStar.Seq.Base.seq Prims.int))

;; def=FStar.DM4F.Heap.IntStoreFixed.fst(21,21-21,43); use=FStar.DM4F.Heap.IntStoreFixed.fst(21,21-21,43)
(= (FStar.Seq.Base.length Prims.int
@x1)
(FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value))
))
...
@x1
Tm_refine_6df2ffe10bff6bf2a3fe27af74739e18))
:qid refinement_interpretation_Tm_refine_6df2ffe10bff6bf2a3fe27af74739e18))

:named refinement_interpretation_Tm_refine_6df2ffe10bff6bf2a3fe27af74739e18))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.id; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,9-20,30); use=FStar.DM4F.Heap.IntStoreFixed.fst(20,9-20,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_6970eb1cc2a7cbece1f97684ca23fd46)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,15-20,29); use=FStar.DM4F.Heap.IntStoreFixed.fst(20,15-20,29)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)))
))
...
@x1
Tm_refine_6970eb1cc2a7cbece1f97684ca23fd46))
:qid refinement_interpretation_Tm_refine_6970eb1cc2a7cbece1f97684ca23fd46))

:named refinement_interpretation_Tm_refine_6970eb1cc2a7cbece1f97684ca23fd46))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6df2ffe10bff6bf2a3fe27af74739e18
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.heap; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! (iff (Valid (Prims.hasEq Tm_refine_6df2ffe10bff6bf2a3fe27af74739e18))
(Valid (Prims.hasEq (FStar.Seq.Base.seq Prims.int))))
:named haseqTm_refine_6df2ffe10bff6bf2a3fe27af74739e18))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6970eb1cc2a7cbece1f97684ca23fd46
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.id; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! (iff (Valid (Prims.hasEq Tm_refine_6970eb1cc2a7cbece1f97684ca23fd46))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_6970eb1cc2a7cbece1f97684ca23fd46))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.IntStoreFixed.store_size
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.store_size; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(20,4-20,14); use=FStar.DM4F.Heap.IntStoreFixed.fsti(20,4-20,14)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(20,4-20,14); use=FStar.DM4F.Heap.IntStoreFixed.fsti(20,4-20,14)
(FStar.DM4F.Heap.IntStoreFixed.store_size @u0)
...
:qid equation_FStar.DM4F.Heap.IntStoreFixed.store_size))

:named equation_FStar.DM4F.Heap.IntStoreFixed.store_size))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.IntStoreFixed.id
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.id; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,4-20,6); use=FStar.DM4F.Heap.IntStoreFixed.fst(20,4-20,6)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,4-20,6); use=FStar.DM4F.Heap.IntStoreFixed.fst(20,4-20,6)
(FStar.DM4F.Heap.IntStoreFixed.id @u0)
...
:qid equation_FStar.DM4F.Heap.IntStoreFixed.id))

:named equation_FStar.DM4F.Heap.IntStoreFixed.id))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.IntStoreFixed.heap
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.heap; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(21,4-21,8); use=FStar.DM4F.Heap.IntStoreFixed.fst(21,4-21,8)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(21,4-21,8); use=FStar.DM4F.Heap.IntStoreFixed.fst(21,4-21,8)
(FStar.DM4F.Heap.IntStoreFixed.heap @u0)
...
:qid equation_FStar.DM4F.Heap.IntStoreFixed.heap))

:named equation_FStar.DM4F.Heap.IntStoreFixed.heap))
(push) ;; push{2

; Starting query at FStar.DM4F.Heap.IntStoreFixed.fst(25,16-25,29)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (h: FStar.DM4F.Heap.IntStoreFixed.heap) (i: FStar.DM4F.Heap.IntStoreFixed.id).
;   (*  - Could not prove post-condition
; *)
;   i < FStar.DM4F.Heap.IntStoreFixed.store_size ==> i < FStar.Seq.Base.length h
...
(assert (! (not (forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.Heap.IntStoreFixed.heap Dummy_value))
(HasType @x1
(FStar.DM4F.Heap.IntStoreFixed.id Dummy_value))

;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,15-20,29); use=FStar.DM4F.Heap.IntStoreFixed.fst(25,28-25,29)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.Heap.IntStoreFixed.fst(25,28-25,29)
(or label_1

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=FStar.DM4F.Heap.IntStoreFixed.fst(25,28-25,29)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.Seq.Base.length Prims.int
@x0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.IntStoreFixed.index, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.Heap.IntStoreFixed.heap, refinement_interpretation_Tm_refine_6df2ffe10bff6bf2a3fe27af74739e18
...
(declare-fun FStar.DM4F.Heap.IntStoreFixed.index (Term Term) Term)
;;;;;;;;;;;;;;;;h: heap -> i: id -> Prims.int
(declare-fun Tm_arrow_1e01d4f821626df6b6750b0e8fb901df () Term)
(declare-fun FStar.DM4F.Heap.IntStoreFixed.index@tok () Term)
...
(declare-fun FStar.DM4F.Heap.IntStoreFixed.sel (Term Term) Term)

(declare-fun FStar.DM4F.Heap.IntStoreFixed.sel@tok () Term)

; </end encoding let sel>


; encoding sigelt val FStar.DM4F.Heap.IntStoreFixed.upd


; <Skipped val FStar.DM4F.Heap.IntStoreFixed.upd/>
...
; Starting query at FStar.DM4F.Heap.IntStoreFixed.fst(27,15-27,74)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (h: FStar.DM4F.Heap.IntStoreFixed.heap) (i: FStar.DM4F.Heap.IntStoreFixed.id) (x: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   (i < FStar.DM4F.Heap.IntStoreFixed.store_size ==> i < FStar.Seq.Base.length h) /\
;   (forall (any_result: FStar.DM4F.Heap.IntStoreFixed.id).
;       i == any_result ==>
;       (forall (any_result: FStar.Seq.Base.seq Prims.int).
;           FStar.Seq.Base.upd h i x == any_result ==>
;           FStar.Seq.Base.length (FStar.Seq.Base.upd h i x) =
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,15-27,74)
(and (implies 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,15-20,29); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,31-27,32)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)))


;; def=FStar.Seq.Base.fsti(56,37-56,49); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,31-27,32)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,15-27,74)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(FStar.DM4F.Heap.IntStoreFixed.id Dummy_value))

;; def=FStar.Seq.Base.fsti(56,31-56,32); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,15-27,74)
(= @x1
@x3)
)
...
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(27,20-27,34); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,20-27,34)
(= (FStar.Seq.Base.upd Prims.int
@x0
@x1
@x2)
@x4)
...
;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,38-27,44)
(and 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(27,45-27,69); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,38-27,44)
(or label_2
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,38-27,44)
(forall ((@x5 Term))
...
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(21,21-21,43); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,72-27,74)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.IntStoreFixed.upd, 1)
; STATUS: unsat
...
(declare-fun FStar.DM4F.Heap.IntStoreFixed.upd (Term Term Term) Term)
;;;;;;;;;;;;;;;;h: heap -> i: id -> x: Prims.int -> heap
(declare-fun Tm_arrow_3e9a7d61ba2bff6b0bb3e1ab5ad751f3 () Term)
(declare-fun FStar.DM4F.Heap.IntStoreFixed.upd@tok () Term)

; </end encoding let upd>


; encoding sigelt val FStar.DM4F.Heap.IntStoreFixed.create


; <Skipped val FStar.DM4F.Heap.IntStoreFixed.create/>
...
; Starting query at FStar.DM4F.Heap.IntStoreFixed.fst(29,15-29,39)
...
;   (*  - Could not prove post-condition
; *)
;   FStar.DM4F.Heap.IntStoreFixed.store_size >= 0 /\
;   (forall (any_result: Prims.int).
;       FStar.DM4F.Heap.IntStoreFixed.store_size == any_result ==>
;       (forall (any_result: FStar.Seq.Base.seq Prims.int).
;           FStar.Seq.Base.create FStar.DM4F.Heap.IntStoreFixed.store_size x == any_result ==>
;           FStar.Seq.Base.length (FStar.Seq.Base.create FStar.DM4F.Heap.IntStoreFixed.store_size x) ==
;           FStar.DM4F.Heap.IntStoreFixed.store_size))
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.IntStoreFixed.fst(29,15-29,39)
(and 
;; def=Prims.fst(680,18-680,24); use=FStar.DM4F.Heap.IntStoreFixed.fst(29,27-29,37)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.IntStoreFixed.fst(29,15-29,39)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.IntStoreFixed.fst(29,15-29,39)
(= (FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)
@x1)
)
...
;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(32,21-32,25); use=FStar.DM4F.Heap.IntStoreFixed.fst(29,15-29,39)
(= (FStar.Seq.Base.create Prims.int
(FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)
@x0)
@x2)
)

;; def=FStar.DM4F.Heap.IntStoreFixed.fst(21,21-21,43); use=FStar.DM4F.Heap.IntStoreFixed.fst(29,15-29,39)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.IntStoreFixed.create, 1)
; STATUS: unsat
...
(declare-fun FStar.DM4F.Heap.IntStoreFixed.create (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> heap
(declare-fun Tm_arrow_10da668237149f930a18a89a945f71da () Term)
(declare-fun FStar.DM4F.Heap.IntStoreFixed.create@tok () Term)

; </end encoding let create>


; encoding sigelt val FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1


; <Skipped val FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.upd; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(27,4-27,7); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,4-27,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.Heap.IntStoreFixed.heap Dummy_value))
(HasType @x1
...
(HasType @x2
Prims.int))
(HasType (FStar.DM4F.Heap.IntStoreFixed.upd @x0
@x1
@x2)
(FStar.DM4F.Heap.IntStoreFixed.heap Dummy_value)))
 

:pattern ((FStar.DM4F.Heap.IntStoreFixed.upd @x0
@x1
@x2))
:qid typing_FStar.DM4F.Heap.IntStoreFixed.upd))

:named typing_FStar.DM4F.Heap.IntStoreFixed.upd))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.index; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(25,4-25,9); use=FStar.DM4F.Heap.IntStoreFixed.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.Heap.IntStoreFixed.heap Dummy_value))
(HasType @x1
(FStar.DM4F.Heap.IntStoreFixed.id Dummy_value)))
(HasType (FStar.DM4F.Heap.IntStoreFixed.index @x0
@x1)
Prims.int))
 

:pattern ((FStar.DM4F.Heap.IntStoreFixed.index @x0
@x1))
:qid typing_FStar.DM4F.Heap.IntStoreFixed.index))

:named typing_FStar.DM4F.Heap.IntStoreFixed.index))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.IntStoreFixed.upd
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.upd; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(27,4-27,7); use=FStar.DM4F.Heap.IntStoreFixed.fst(27,4-27,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.DM4F.Heap.IntStoreFixed.upd @x0
@x1
@x2)
(FStar.Seq.Base.upd Prims.int
@x0
...
@x1
@x2))
:qid equation_FStar.DM4F.Heap.IntStoreFixed.upd))

:named equation_FStar.DM4F.Heap.IntStoreFixed.upd))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.IntStoreFixed.index
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.index; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(25,4-25,9); use=FStar.DM4F.Heap.IntStoreFixed.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.Heap.IntStoreFixed.index @x0
@x1)
(FStar.Seq.Base.index Prims.int
@x0
@x1))
...
:pattern ((FStar.DM4F.Heap.IntStoreFixed.index @x0
@x1))
:qid equation_FStar.DM4F.Heap.IntStoreFixed.index))

:named equation_FStar.DM4F.Heap.IntStoreFixed.index))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,56)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (s: FStar.DM4F.Heap.IntStoreFixed.heap) (n: FStar.DM4F.Heap.IntStoreFixed.id) (v: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.DM4F.Heap.IntStoreFixed.index (FStar.DM4F.Heap.IntStoreFixed.upd s n v) n == v ==>
;         p pure_result) ==>
;     (n < FStar.DM4F.Heap.IntStoreFixed.store_size ==> n < FStar.Seq.Base.length s) /\
;     (forall (any_result: FStar.DM4F.Heap.IntStoreFixed.id).
;         n == any_result ==>
;         (forall (pure_result: Prims.unit).
;             FStar.Seq.Base.index (FStar.Seq.Base.upd s n v) n == v ==> p pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_index_upd1`
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,56)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(36,11-36,37); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,56)
(or label_2

;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(36,11-36,37); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,56)
(= (FStar.DM4F.Heap.IntStoreFixed.index (FStar.DM4F.Heap.IntStoreFixed.upd @x0
@x1
@x2)
@x1)
@x2)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,56)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,56)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,56)
(and (implies 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,15-20,29); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,53-31,54)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)))


;; def=FStar.Seq.Base.fsti(138,50-138,62); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,53-31,54)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,56)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.DM4F.Heap.IntStoreFixed.id Dummy_value))

;; def=FStar.Seq.Base.fsti(138,44-138,45); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,56)
(= @x1
@x4)
)

;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,45)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=FStar.Seq.Base.fsti(140,11-140,37); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,45)
(= (FStar.Seq.Base.index Prims.int
(FStar.Seq.Base.upd Prims.int
@x0
@x1
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,45)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,29-31,45)
(ApplyTT @x3
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1, 1)
; STATUS: unsat
...
; encoding sigelt let lemma_index_upd1


; <Start encoding let lemma_index_upd1>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1 (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1@tok () Term)

; </end encoding let lemma_index_upd1>


; encoding sigelt val FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd2


; <Skipped val FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd2/>

;;;;;;;;;;;;;;;;Lemma: FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.Heap.IntStoreFixed.heap Dummy_value))
(HasType @x1
...
;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(36,11-36,37); use=FStar.DM4F.Heap.IntStoreFixed.fst(31,4-31,20)
(= (FStar.DM4F.Heap.IntStoreFixed.index (FStar.DM4F.Heap.IntStoreFixed.upd @x0
@x1
@x2)
@x1)
...
:pattern ((FStar.DM4F.Heap.IntStoreFixed.index (FStar.DM4F.Heap.IntStoreFixed.upd @x0
@x1
@x2)
@x1))
:qid lemma_FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1))
:named lemma_FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd1))
(push) ;; push{2

; Starting query at FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,60)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(39,49-39,59); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,4-33,20)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be))

:named refinement_kinding_Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(39,49-39,59); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,4-33,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be @x2))
(and (HasTypeFuel @u0
@x1
(FStar.DM4F.Heap.IntStoreFixed.id Dummy_value))

;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(39,54-39,58); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,4-33,20)
(not (= @x1
@x2))
))
...
@x1
(Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be @x2)))
:qid refinement_interpretation_Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be))

:named refinement_interpretation_Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be))
;;;;;;;;;;;;;;;;haseq for Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(39,49-39,59); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,4-33,20)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be @x0)))
(Valid (Prims.hasEq (FStar.DM4F.Heap.IntStoreFixed.id Dummy_value))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be @x0))))
:qid haseqTm_refine_682c9ab92a8eed1ab5b3c14d312fe8be))

:named haseqTm_refine_682c9ab92a8eed1ab5b3c14d312fe8be))


; Encoding query formula : forall (s: FStar.DM4F.Heap.IntStoreFixed.heap)
...
;     (forall (any_result: FStar.DM4F.Heap.IntStoreFixed.id).
;         n == any_result ==>
;         (i < FStar.DM4F.Heap.IntStoreFixed.store_size /\ i <> n ==>
;           i <> n /\ i < FStar.Seq.Base.length s) /\
;         (forall (any_result: i: FStar.DM4F.Heap.IntStoreFixed.id{i <> n}).
;             i == any_result ==>
;             (forall (pure_result: Prims.unit).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_index_upd2`
...
Prims.int)
(HasType @x3
(Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be @x1)))
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,60)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(41,11-41,45); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,60)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,60)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,60)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,60)
(and (implies 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,15-20,29); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,55-33,56)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)))


;; def=FStar.Seq.Base.fsti(143,50-143,62); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,55-33,56)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,60)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.DM4F.Heap.IntStoreFixed.id Dummy_value))

;; def=FStar.Seq.Base.fsti(143,44-143,45); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,60)
(= @x1
@x5)
)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,60)
(and (implies 
;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(39,54-39,58); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,59-33,60)
(and 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(20,15-20,29); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,59-33,60)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)))
...
;; def=FStar.Seq.Base.fsti(143,80-143,100); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,59-33,60)
(and 
;; def=FStar.Seq.Base.fsti(143,80-143,84); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,59-33,60)
(or label_4
...
;; def=FStar.Seq.Base.fsti(143,88-143,100); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,59-33,60)
(or label_5
...
;; def=FStar.Seq.Base.fsti(143,74-143,75); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,60)
(= @x3
@x6)
)

;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,47)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
Prims.unit)

;; def=FStar.Seq.Base.fsti(145,11-145,45); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,47)
(= (FStar.Seq.Base.index Prims.int
(FStar.Seq.Base.upd Prims.int
@x0
@x1
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,47)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(33,31-33,47)
(ApplyTT @x4
@x7)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd2, 1)
; STATUS: unsat
...
; encoding sigelt let lemma_index_upd2


; <Start encoding let lemma_index_upd2>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd2 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.DM4F.Heap.IntStoreFixed.lemma_index_upd2@tok () Term)
(declare-fun Tm_refine_682c9ab92a8eed1ab5b3c14d312fe8be (Term) Term)

; </end encoding let lemma_index_upd2>


; encoding sigelt val FStar.DM4F.Heap.IntStoreFixed.lemma_index_create


; <Skipped val FStar.DM4F.Heap.IntStoreFixed.lemma_index_create/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.create; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(29,4-29,10); use=FStar.DM4F.Heap.IntStoreFixed.fst(29,4-29,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (FStar.DM4F.Heap.IntStoreFixed.create @x0)
(FStar.DM4F.Heap.IntStoreFixed.heap Dummy_value)))
 

:pattern ((FStar.DM4F.Heap.IntStoreFixed.create @x0))
:qid typing_FStar.DM4F.Heap.IntStoreFixed.create))

:named typing_FStar.DM4F.Heap.IntStoreFixed.create))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.IntStoreFixed.create
;;; Fact-ids: Name FStar.DM4F.Heap.IntStoreFixed.create; Namespace FStar.DM4F.Heap.IntStoreFixed
(assert (! 
;; def=FStar.DM4F.Heap.IntStoreFixed.fst(29,4-29,10); use=FStar.DM4F.Heap.IntStoreFixed.fst(29,4-29,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.Heap.IntStoreFixed.create @x0)
(FStar.Seq.Base.create Prims.int
(FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)
@x0))
...
:pattern ((FStar.DM4F.Heap.IntStoreFixed.create @x0))
:qid equation_FStar.DM4F.Heap.IntStoreFixed.create))

:named equation_FStar.DM4F.Heap.IntStoreFixed.create))
(push) ;; push{2

; Starting query at FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,67)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (v: Prims.int) (i: FStar.DM4F.Heap.IntStoreFixed.id).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.DM4F.Heap.IntStoreFixed.index (FStar.DM4F.Heap.IntStoreFixed.create v) i == v ==>
;         p pure_result) ==>
;     FStar.DM4F.Heap.IntStoreFixed.store_size >= 0 /\
;     (forall (any_result: Prims.int).
;         FStar.DM4F.Heap.IntStoreFixed.store_size == any_result ==>
;         (forall (pure_result: Prims.unit).
;             FStar.Seq.Base.index (FStar.Seq.Base.create FStar.DM4F.Heap.IntStoreFixed.store_size v)
;               i ==
;             v ==>
;             p pure_result))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_index_create`
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,67)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(46,11-46,36); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,67)
(or label_2

;; def=FStar.DM4F.Heap.IntStoreFixed.fsti(46,11-46,36); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,67)
(= (FStar.DM4F.Heap.IntStoreFixed.index (FStar.DM4F.Heap.IntStoreFixed.create @x0)
@x1)
@x0)
)
)

;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,67)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,67)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,67)
(and 
;; def=Prims.fst(680,18-680,24); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,53-35,63)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,67)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.int)

;; def=FStar.Seq.Base.fsti(133,35-133,36); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,67)
(= (FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)
@x3)
)

;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,47)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=FStar.Seq.Base.fsti(135,11-135,38); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,47)
(= (FStar.Seq.Base.index Prims.int
(FStar.Seq.Base.create Prims.int
(FStar.DM4F.Heap.IntStoreFixed.store_size Dummy_value)
@x0)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,47)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.IntStoreFixed.fst(35,29-35,47)
(ApplyTT @x2
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.IntStoreFixed.lemma_index_create, 1)
; STATUS: unsat
