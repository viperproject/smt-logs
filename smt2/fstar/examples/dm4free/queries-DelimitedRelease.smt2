...
; Externals for interface FStar.DM4F.Heap.ST
...
; <Start encoding val FStar.DM4F.Heap.ST.refine_st>
...
; </end encoding val FStar.DM4F.Heap.ST.refine_st>


; <Start encoding val FStar.DM4F.Heap.ST.runST>



(declare-fun Non_total_Tm_arrow_df1699a2dbbc33d1a6b124bc5f21fd07 (Term Term) Term)
(declare-fun FStar.DM4F.Heap.ST.runST (Term Term Term) Term)



(declare-fun Tm_refine_b3031af99c86155e3eb082fa7d598016 (Term Term) Term)
;;;;;;;;;;;;;;;;_: (_: Prims.unit -> ST a) -> Prims.Pure a
(declare-fun Tm_arrow_6fdaa24f33fd4afb8c7cb05e0eb22d2a () Term)
(declare-fun FStar.DM4F.Heap.ST.runST@tok () Term)


; </end encoding val FStar.DM4F.Heap.ST.runST>


; End Externals for interface FStar.DM4F.Heap.ST
...
; Internals for DelimitedRelease
...
; Starting query at DelimitedRelease.fst(28,2-31,5)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=DelimitedRelease.fst(28,2-31,5)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_a02cf030b79811342f5c0dc23280485a))
:qid DelimitedRelease_pre_typing_Tm_arrow_a02cf030b79811342f5c0dc23280485a))

:named DelimitedRelease_pre_typing_Tm_arrow_a02cf030b79811342f5c0dc23280485a))
...
:pattern ((ApplyTT @x0
@x1))
:qid DelimitedRelease_interpretation_Tm_arrow_a02cf030b79811342f5c0dc23280485a.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_a02cf030b79811342f5c0dc23280485a))
:qid DelimitedRelease_interpretation_Tm_arrow_a02cf030b79811342f5c0dc23280485a))

:named DelimitedRelease_interpretation_Tm_arrow_a02cf030b79811342f5c0dc23280485a))

; Encoding query formula : forall (hi: FStar.DM4F.Heap.ref Prims.int) (lo: FStar.DM4F.Heap.ref Prims.int) (k: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (_: FStar.DM4F.Heap.heap) (p: Prims.pure_post (Prims.unit & FStar.DM4F.Heap.heap)).
;     FStar.DM4F.Heap.contains_a_well_typed _ hi /\ FStar.DM4F.Heap.contains_a_well_typed _ lo /\
;     (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;         FStar.DM4F.Heap.contains_a_well_typed _ hi /\ FStar.DM4F.Heap.contains_a_well_typed _ lo ==>
;         p (a, n1)) ==>
;     FStar.DM4F.Heap.contains_a_well_typed _ hi /\
;     (forall (a: Prims.int) (n1: FStar.DM4F.Heap.heap).
;         FStar.DM4F.Heap.contains_a_well_typed _ hi /\
;         (_ == n1) /\ FStar.DM4F.Heap.contains_a_well_typed n1 hi /\ (FStar.DM4F.Heap.sel n1 hi == a) ==>
;         (forall (k: (_: Prims.unit & FStar.DM4F.Heap.heap -> Type0)).
;             (forall (a1: Prims.unit & FStar.DM4F.Heap.heap). {:pattern Prims.guard_free (k a1)}
;                 k a1 <==> p a1) ==>
;             (k < a = true ==>
;               k < a == true ==>
;               FStar.DM4F.Heap.contains_a_well_typed n1 hi /\
;               (forall (a: Prims.int) (n1: FStar.DM4F.Heap.heap).
;                   FStar.DM4F.Heap.contains_a_well_typed n1 hi /\
;                   (n1 == n1) /\ FStar.DM4F.Heap.contains_a_well_typed n1 hi /\
;                   (FStar.DM4F.Heap.sel n1 hi == a) ==>
;                   FStar.DM4F.Heap.contains_a_well_typed n1 hi /\
;                   (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;                       FStar.DM4F.Heap.contains_a_well_typed n1 hi /\
;                       FStar.DM4F.Heap.contains_a_well_typed n1 hi /\
;                       FStar.DM4F.Heap.contains_a_well_typed n1 hi /\
;                       (n1 == FStar.DM4F.Heap.upd n1 hi (a - k)) ==>
;                       FStar.DM4F.Heap.contains_a_well_typed n1 lo /\
;                       (forall (a: Prims.int) (n1: FStar.DM4F.Heap.heap).
;                           FStar.DM4F.Heap.contains_a_well_typed n1 lo /\
;                           (n1 == n1) /\ FStar.DM4F.Heap.contains_a_well_typed n1 lo /\
;                           (FStar.DM4F.Heap.sel n1 lo == a) ==>
;                           FStar.DM4F.Heap.contains_a_well_typed n1 lo /\
;                           (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;                               FStar.DM4F.Heap.contains_a_well_typed n1 lo /\
;                               FStar.DM4F.Heap.contains_a_well_typed n1 lo /\
;                               FStar.DM4F.Heap.contains_a_well_typed n1 lo /\
;                               (n1 == FStar.DM4F.Heap.upd n1 lo (a + k)) ==>
;                               k (a, n1)))))) /\
;             (~(k < a = true) ==>
;               (forall (b: Prims.bool).
;                   k < a == b ==> (forall (any_result: Prims.unit). k (any_result, n1))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let wallet`
...
;; def=dummy(0,0-0,0); use=DelimitedRelease.fst(28,2-31,5)
...
;; def=DelimitedRelease.fst(25,27-25,55); use=DelimitedRelease.fst(28,2-31,5)
(Valid 
;; def=DelimitedRelease.fst(25,27-25,55); use=DelimitedRelease.fst(28,2-31,5)
...
;; def=DelimitedRelease.fst(26,24-26,52); use=DelimitedRelease.fst(28,2-31,5)
(Valid 
;; def=DelimitedRelease.fst(26,24-26,52); use=DelimitedRelease.fst(28,2-31,5)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=DelimitedRelease.fst(28,2-31,5)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=DelimitedRelease.fst(28,2-31,5)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=DelimitedRelease.fst(28,2-31,5)
(ApplyTT @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=DelimitedRelease.fst(28,9-28,10)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=DelimitedRelease.fst(28,9-28,10)
(or label_1
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=DelimitedRelease.fst(28,9-28,10)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.int)
(HasType @x6
...
;; def=FStar.DM4F.Heap.ST.fsti(89,3-89,11); use=DelimitedRelease.fst(28,9-28,10)
(= @x3
@x6)


;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=DelimitedRelease.fst(28,9-28,10)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=DelimitedRelease.fst(28,9-28,10)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x6
...
;; def=FStar.DM4F.Heap.ST.fsti(91,3-91,16); use=DelimitedRelease.fst(28,9-28,10)
...
;; def=Prims.fst(221,62-221,85); use=DelimitedRelease.fst(28,2-31,5)
(and (implies 
;; def=Prims.fst(221,62-221,71); use=DelimitedRelease.fst(28,2-31,5)
(and 
;; def=DelimitedRelease.fst(28,5-28,12); use=DelimitedRelease.fst(28,5-28,12)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=DelimitedRelease.fst(29,10-29,11)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=DelimitedRelease.fst(29,10-29,11)
(or label_2
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=DelimitedRelease.fst(29,10-29,11)
...
;; def=FStar.DM4F.Heap.ST.fsti(89,3-89,11); use=DelimitedRelease.fst(29,10-29,11)
(= @x6
@x9)


;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=DelimitedRelease.fst(29,10-29,11)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=DelimitedRelease.fst(29,10-29,11)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x9
...
;; def=FStar.DM4F.Heap.ST.fsti(91,3-91,16); use=DelimitedRelease.fst(29,10-29,11)
(= (FStar.DM4F.Heap.sel Prims.int
@x9
@x0)
@x8)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=DelimitedRelease.fst(29,7-29,9)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(106,24-106,51); use=DelimitedRelease.fst(29,7-29,9)
(or label_3
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=DelimitedRelease.fst(29,7-29,9)
...
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=DelimitedRelease.fst(29,7-29,9)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=DelimitedRelease.fst(29,7-29,9)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x9
...
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=DelimitedRelease.fst(29,7-29,9)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=DelimitedRelease.fst(29,7-29,9)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x11
...
;; def=FStar.DM4F.Heap.ST.fsti(109,17-109,33); use=DelimitedRelease.fst(29,7-29,9)
(= @x11
(FStar.DM4F.Heap.upd Prims.int
@x9
@x0
(Prims.op_Subtraction @x8
@x2)))
)

;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=DelimitedRelease.fst(30,10-30,11)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=DelimitedRelease.fst(30,10-30,11)
(or label_4
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=DelimitedRelease.fst(30,10-30,11)
...
;; def=FStar.DM4F.Heap.ST.fsti(89,3-89,11); use=DelimitedRelease.fst(30,10-30,11)
(= @x11
@x13)


;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=DelimitedRelease.fst(30,10-30,11)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=DelimitedRelease.fst(30,10-30,11)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x13
...
;; def=FStar.DM4F.Heap.ST.fsti(91,3-91,16); use=DelimitedRelease.fst(30,10-30,11)
(= (FStar.DM4F.Heap.sel Prims.int
@x13
@x1)
@x12)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=DelimitedRelease.fst(30,7-30,9)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(106,24-106,51); use=DelimitedRelease.fst(30,7-30,9)
(or label_5
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=DelimitedRelease.fst(30,7-30,9)
...
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=DelimitedRelease.fst(30,7-30,9)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=DelimitedRelease.fst(30,7-30,9)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x13
...
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=DelimitedRelease.fst(30,7-30,9)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=DelimitedRelease.fst(30,7-30,9)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x15
...
;; def=FStar.DM4F.Heap.ST.fsti(109,17-109,33); use=DelimitedRelease.fst(30,7-30,9)
(= @x15
(FStar.DM4F.Heap.upd Prims.int
@x13
@x1
(Prims.op_Addition @x12
@x2)))
)

;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=DelimitedRelease.fst(30,7-30,9)
(or label_6
...
(implies 
;; def=Prims.fst(221,76-221,78); use=DelimitedRelease.fst(28,2-31,5)
(not 
;; def=DelimitedRelease.fst(28,5-28,12); use=DelimitedRelease.fst(28,5-28,12)
(= (Prims.op_LessThan @x2
@x5)
...
;; def=Prims.fst(413,99-413,120); use=DelimitedRelease.fst(28,2-31,5)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.bool)

;; def=DelimitedRelease.fst(28,2-31,5); use=DelimitedRelease.fst(28,2-31,5)
(= (Prims.op_LessThan @x2
@x5)
@x8)
)

;; def=Prims.fst(451,66-451,102); use=DelimitedRelease.fst(28,2-31,5)
(forall ((@x9 Term))
 (! (implies (HasType @x9
Prims.unit)

;; def=FStar.DM4F.Heap.ST.fsti(45,93-45,101); use=DelimitedRelease.fst(28,2-31,5)
(or label_7
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (DelimitedRelease.wallet, 1)
; STATUS: unsat
...
; encoding sigelt let wallet


; <Start encoding let wallet>

(declare-fun DelimitedRelease.wallet (Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_1b46d25c2293cb83ea6f2dff4b725265 () Term)
(declare-fun DelimitedRelease.wallet@tok () Term)
(declare-fun Tm_refine_7cd218292925b043d2eb072e03408ed1 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_d570ad90629fada2806f3c45692274c8 (Term Term) Term)
...
(declare-fun Tm_abs_54607be58fc6e3b208e1951a532640c5 (Term Term Term) Term)

; </end encoding let wallet>

(push) ;; push{2

; Starting query at DelimitedRelease.fst(35,5-35,13)
...
; While typechecking the top-level declaration `let addr_set`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(73,23-73,30); use=DelimitedRelease.fst(35,22-35,25)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (DelimitedRelease.addr_set, 1)
; STATUS: unsat
...
; encoding sigelt let addr_set


; <Start encoding let addr_set>

(declare-fun DelimitedRelease.addr_set () Term)

; </end encoding let addr_set>


; encoding sigelt let heap_equiv_on


; <Start encoding let heap_equiv_on>

(declare-fun DelimitedRelease.heap_equiv_on (Term Term Term) Term)
;;;;;;;;;;;;;;;;r: FStar.DM4F.Heap.ref Prims.int -> h_0: FStar.DM4F.Heap.heap -> h_1: FStar.DM4F.Heap.heap   -> Prims.logical
(declare-fun Tm_arrow_229cbfeaee308315fb75e9f9987421f2 () Term)
(declare-fun DelimitedRelease.heap_equiv_on@tok () Term)

; </end encoding let heap_equiv_on>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(104,5-104,10); use=FStar.DM4F.Heap.ST.fsti(104,5-104,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
@x0))
(HasType (FStar.DM4F.Heap.ST.write @x0
@x1
@x2)
(Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797 @x2
@x1
@x0)))
 

:pattern ((FStar.DM4F.Heap.ST.write @x0
@x1
@x2))
:qid typing_FStar.DM4F.Heap.ST.write))

:named typing_FStar.DM4F.Heap.ST.write))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(85,5-85,9); use=FStar.DM4F.Heap.ST.fsti(85,5-85,9)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(FStar.DM4F.Heap.ref @x0)))
(HasType (FStar.DM4F.Heap.ST.read @x0
@x1)
(Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec @x1
@x0)))
 

:pattern ((FStar.DM4F.Heap.ST.read @x0
@x1))
:qid typing_FStar.DM4F.Heap.ST.read))

:named typing_FStar.DM4F.Heap.ST.read))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Colon_Equals; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(112,5-112,20); use=FStar.DM4F.Heap.ST.fsti(112,5-112,20)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.Heap.ST.op_Colon_Equals @x0)
(Non_total_Tm_arrow_661015f3663eb5ed49ce6a9b3117aa88 @x0)))
 

:pattern ((FStar.DM4F.Heap.ST.op_Colon_Equals @x0))
:qid typing_FStar.DM4F.Heap.ST.op_Colon_Equals))

:named typing_FStar.DM4F.Heap.ST.op_Colon_Equals))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Bang; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(95,6-95,7); use=FStar.DM4F.Heap.ST.fsti(95,6-95,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.Heap.ST.op_Bang @x0)
(Non_total_Tm_arrow_55a202b06bf8f2197f2b24d2244b305e @x0)))
 

:pattern ((FStar.DM4F.Heap.ST.op_Bang @x0))
:qid typing_FStar.DM4F.Heap.ST.op_Bang))

:named typing_FStar.DM4F.Heap.ST.op_Bang))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name DelimitedRelease.wallet; Namespace DelimitedRelease
(assert (! 
;; def=DelimitedRelease.fst(23,4-23,10); use=DelimitedRelease.fst(23,4-23,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.Heap.ref Prims.int))
(HasType @x1
...
(HasType @x2
Prims.int))
(HasType (DelimitedRelease.wallet @x0
@x1
@x2)
(Tm_arrow_d570ad90629fada2806f3c45692274c8 @x1
@x0)))
 

:pattern ((DelimitedRelease.wallet @x0
@x1
@x2))
:qid typing_DelimitedRelease.wallet))

:named typing_DelimitedRelease.wallet))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name DelimitedRelease.heap_equiv_on; Namespace DelimitedRelease
(assert (! 
;; def=DelimitedRelease.fst(37,4-37,17); use=DelimitedRelease.fst(37,4-37,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.Heap.ref Prims.int))
(HasType @x1
...
(HasType @x2
FStar.DM4F.Heap.heap))
(HasType (DelimitedRelease.heap_equiv_on @x0
@x1
@x2)
Prims.logical))
 

:pattern ((DelimitedRelease.heap_equiv_on @x0
@x1
@x2))
:qid typing_DelimitedRelease.heap_equiv_on))

:named typing_DelimitedRelease.heap_equiv_on))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_54607be58fc6e3b208e1951a532640c5
;;; Fact-ids: Name DelimitedRelease.wallet; Namespace DelimitedRelease
(assert (! 
;; def=FStar.DM4F.ST.fst(33,17-33,43); use=FStar.DM4F.ST.fst(33,17-33,43)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (IsTotFun (Tm_abs_54607be58fc6e3b208e1951a532640c5 @x0
@x1
@x2))
 

:pattern ((Tm_abs_54607be58fc6e3b208e1951a532640c5 @x0
@x1
@x2))
:qid tot_fun_Tm_abs_54607be58fc6e3b208e1951a532640c5))

:named tot_fun_Tm_abs_54607be58fc6e3b208e1951a532640c5))
...
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_33ca3e15ccdbf81acba6953928f085d6
;;; Fact-ids: Name FStar.DM4F.Heap.ST.zero; Namespace FStar.DM4F.Heap.ST
(assert (! (IsTotFun Tm_abs_33ca3e15ccdbf81acba6953928f085d6)
:named tot_fun_Tm_abs_33ca3e15ccdbf81acba6953928f085d6))
;;;;;;;;;;;;;;;;name-token correspondence
...
;; def=FStar.DM4F.Heap.ST.fsti(104,5-104,10); use=FStar.DM4F.Heap.ST.fsti(104,5-104,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT FStar.DM4F.Heap.ST.write@tok
@x0)
@x1)
@x2)
(FStar.DM4F.Heap.ST.write @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT FStar.DM4F.Heap.ST.write@tok
@x0)
@x1)
@x2))
:qid token_correspondence_FStar.DM4F.Heap.ST.write))

:named token_correspondence_FStar.DM4F.Heap.ST.write))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(85,5-85,9); use=FStar.DM4F.Heap.ST.fsti(85,5-85,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT FStar.DM4F.Heap.ST.read@tok
@x0)
@x1)
(FStar.DM4F.Heap.ST.read @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT FStar.DM4F.Heap.ST.read@tok
@x0)
@x1))
:qid token_correspondence_FStar.DM4F.Heap.ST.read))

:named token_correspondence_FStar.DM4F.Heap.ST.read))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Colon_Equals; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(112,5-112,20); use=FStar.DM4F.Heap.ST.fsti(112,5-112,20)
(forall ((@x0 Term))
 (! (= (ApplyTT FStar.DM4F.Heap.ST.op_Colon_Equals@tok
@x0)
(FStar.DM4F.Heap.ST.op_Colon_Equals @x0))
 

:pattern ((ApplyTT FStar.DM4F.Heap.ST.op_Colon_Equals@tok
@x0))
:qid token_correspondence_FStar.DM4F.Heap.ST.op_Colon_Equals))

:named token_correspondence_FStar.DM4F.Heap.ST.op_Colon_Equals))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Bang; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(95,6-95,7); use=FStar.DM4F.Heap.ST.fsti(95,6-95,7)
(forall ((@x0 Term))
 (! (= (ApplyTT FStar.DM4F.Heap.ST.op_Bang@tok
@x0)
(FStar.DM4F.Heap.ST.op_Bang @x0))
 

:pattern ((ApplyTT FStar.DM4F.Heap.ST.op_Bang@tok
@x0))
:qid token_correspondence_FStar.DM4F.Heap.ST.op_Bang))

:named token_correspondence_FStar.DM4F.Heap.ST.op_Bang))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_7cd218292925b043d2eb072e03408ed1 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_7cd218292925b043d2eb072e03408ed1 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_7cd218292925b043d2eb072e03408ed1))

:named refinement_kinding_Tm_refine_7cd218292925b043d2eb072e03408ed1))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Heap.sel_tot; Namespace FStar.DM4F.Heap
(assert (! 
...
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_289855aa746535562d5330d01c24b5ff @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_289855aa746535562d5330d01c24b5ff @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_289855aa746535562d5330d01c24b5ff))

:named refinement_kinding_Tm_refine_289855aa746535562d5330d01c24b5ff))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_218a7f8b7200b90979b7e60049d43060 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_218a7f8b7200b90979b7e60049d43060 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_218a7f8b7200b90979b7e60049d43060))

:named refinement_kinding_Tm_refine_218a7f8b7200b90979b7e60049d43060))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7cd218292925b043d2eb072e03408ed1 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
(not 
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=DelimitedRelease.fst(24,4-24,6)
(and 
;; def=DelimitedRelease.fst(25,27-25,55); use=DelimitedRelease.fst(25,27-25,55)
(Valid 
;; def=DelimitedRelease.fst(25,27-25,55); use=DelimitedRelease.fst(25,27-25,55)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x2
...
;; def=DelimitedRelease.fst(26,24-26,52); use=DelimitedRelease.fst(26,24-26,52)
(Valid 
;; def=DelimitedRelease.fst(26,24-26,52); use=DelimitedRelease.fst(26,24-26,52)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x2
...
;;no pats
:qid refinement_interpretation_Tm_refine_7cd218292925b043d2eb072e03408ed1.1))
)
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_7cd218292925b043d2eb072e03408ed1))

:named refinement_interpretation_Tm_refine_7cd218292925b043d2eb072e03408ed1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Heap.sel_tot; Namespace FStar.DM4F.Heap
(assert (! 
;; def=FStar.DM4F.Heap.fsti(42,35-42,71); use=FStar.DM4F.Heap.fsti(42,35-42,71)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_289855aa746535562d5330d01c24b5ff @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ST.fst(27,34-27,41)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(86,4-86,6)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=FStar.DM4F.Heap.ST.fsti(87,27-87,54)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=FStar.DM4F.Heap.ST.fsti(87,27-87,54)
(FStar.DM4F.Heap.contains_a_well_typed @x2
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(89,3-89,11); use=FStar.DM4F.Heap.ST.fsti(89,3-89,11)
(= @x3
@x6)


;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(90,17-90,45)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(90,17-90,45)
(FStar.DM4F.Heap.contains_a_well_typed @x2
@x6
...
;; def=FStar.DM4F.Heap.ST.fsti(91,3-91,16); use=FStar.DM4F.Heap.ST.fsti(91,3-91,16)
(= (FStar.DM4F.Heap.sel @x2
@x6
@x4)
@x5)
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_289855aa746535562d5330d01c24b5ff.1))
)
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_289855aa746535562d5330d01c24b5ff))

:named refinement_interpretation_Tm_refine_289855aa746535562d5330d01c24b5ff))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_218a7f8b7200b90979b7e60049d43060 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ST.fst(27,34-27,41)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(105,6-105,8)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(106,24-106,51); use=FStar.DM4F.Heap.ST.fsti(106,24-106,51)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(106,24-106,51); use=FStar.DM4F.Heap.ST.fsti(106,24-106,51)
(FStar.DM4F.Heap.contains_a_well_typed @x2
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=FStar.DM4F.Heap.ST.fsti(107,27-107,55)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=FStar.DM4F.Heap.ST.fsti(107,27-107,55)
(FStar.DM4F.Heap.contains_a_well_typed @x2
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=FStar.DM4F.Heap.ST.fsti(108,18-108,46)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=FStar.DM4F.Heap.ST.fsti(108,18-108,46)
(FStar.DM4F.Heap.contains_a_well_typed @x2
@x7
...
;; def=FStar.DM4F.Heap.ST.fsti(109,17-109,33); use=FStar.DM4F.Heap.ST.fsti(109,17-109,33)
(= @x7
...
;;no pats
:qid refinement_interpretation_Tm_refine_218a7f8b7200b90979b7e60049d43060.1))
)
)
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_218a7f8b7200b90979b7e60049d43060))

:named refinement_interpretation_Tm_refine_218a7f8b7200b90979b7e60049d43060))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(38,41-38,47)
...
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write; Namespace FStar.DM4F.Heap.ST
(assert (! (HasType Non_total_Tm_arrow_fe41029fa99de9fdefa3124fa9385d77
Tm_type)
:named non_total_function_typing_Non_total_Tm_arrow_fe41029fa99de9fdefa3124fa9385d77))
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Colon_Equals; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(104,24-112,28); use=FStar.DM4F.Heap.ST.fsti(112,1-112,28)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Non_total_Tm_arrow_661015f3663eb5ed49ce6a9b3117aa88 @x0)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_661015f3663eb5ed49ce6a9b3117aa88 @x0)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_661015f3663eb5ed49ce6a9b3117aa88))

:named non_total_function_typing_Non_total_Tm_arrow_661015f3663eb5ed49ce6a9b3117aa88))
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Bang; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(85,23-95,15); use=FStar.DM4F.Heap.ST.fsti(95,1-95,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Non_total_Tm_arrow_55a202b06bf8f2197f2b24d2244b305e @x0)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_55a202b06bf8f2197f2b24d2244b305e @x0)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_55a202b06bf8f2197f2b24d2244b305e))

:named non_total_function_typing_Non_total_Tm_arrow_55a202b06bf8f2197f2b24d2244b305e))
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read; Namespace FStar.DM4F.Heap.ST
(assert (! (HasType Non_total_Tm_arrow_0ca95da8a2e011740b0e854a2393003d
Tm_type)
:named non_total_function_typing_Non_total_Tm_arrow_0ca95da8a2e011740b0e854a2393003d))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797))

:named kinding_Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_de36dbf88dcda5986806b4f786af50c1
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Bang; Namespace FStar.DM4F.Heap.ST
(assert (! (HasType Tm_arrow_de36dbf88dcda5986806b4f786af50c1
Tm_type)
:named kinding_Tm_arrow_de36dbf88dcda5986806b4f786af50c1))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d570ad90629fada2806f3c45692274c8
;;; Fact-ids: Name DelimitedRelease.wallet; Namespace DelimitedRelease
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_d570ad90629fada2806f3c45692274c8 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_d570ad90629fada2806f3c45692274c8 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_d570ad90629fada2806f3c45692274c8))

:named kinding_Tm_arrow_d570ad90629fada2806f3c45692274c8))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec))

:named kinding_Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_172b3cef8768b0786256323012b7a89a
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Colon_Equals; Namespace FStar.DM4F.Heap.ST
(assert (! (HasType Tm_arrow_172b3cef8768b0786256323012b7a89a
Tm_type)
:named kinding_Tm_arrow_172b3cef8768b0786256323012b7a89a))
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
...
;; def=FStar.DM4F.ST.fst(33,17-33,43); use=FStar.DM4F.ST.fst(33,17-33,43)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_54607be58fc6e3b208e1951a532640c5 @x1
@x2
@x3)
@x0)
(let ((@lb4 (let ((@lb4 (let ((@lb4 (ApplyTT (ApplyTT (ApplyTT FStar.DM4F.Heap.ST.op_Bang@tok
Prims.int)
@x1)
@x0)))
(FStar.Pervasives.Native.Mktuple2 Prims.int
FStar.DM4F.Heap.heap
(Prims.op_Subtraction (FStar.Pervasives.Native.Mktuple2__1 @lb4)
@x2)
(FStar.Pervasives.Native.Mktuple2__2 @lb4)))))
(ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.DM4F.Heap.ST.op_Colon_Equals@tok
Prims.int)
@x1)
(FStar.Pervasives.Native.Mktuple2__1 @lb4))
(FStar.Pervasives.Native.Mktuple2__2 @lb4)))))
(let ((@lb5 (let ((@lb5 (ApplyTT (ApplyTT (ApplyTT FStar.DM4F.Heap.ST.op_Bang@tok
Prims.int)
@x3)
(FStar.Pervasives.Native.Mktuple2__2 @lb4))))
(FStar.Pervasives.Native.Mktuple2 Prims.int
FStar.DM4F.Heap.heap
(Prims.op_Addition (FStar.Pervasives.Native.Mktuple2__1 @lb5)
@x2)
...
:pattern ((ApplyTT (Tm_abs_54607be58fc6e3b208e1951a532640c5 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_54607be58fc6e3b208e1951a532640c5))

:named interpretation_Tm_abs_54607be58fc6e3b208e1951a532640c5))
...
;;; Fact-ids: Name FStar.DM4F.Heap.ST.zero; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(30,59-30,64); use=FStar.DM4F.ST.fst(30,59-30,64)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_33ca3e15ccdbf81acba6953928f085d6
@x0)
(FStar.Pervasives.Native.Mktuple2 Prims.unit
FStar.DM4F.Heap.heap
Tm_unit
...
:pattern ((ApplyTT Tm_abs_33ca3e15ccdbf81acba6953928f085d6
@x0))
:qid interpretation_Tm_abs_33ca3e15ccdbf81acba6953928f085d6))

:named interpretation_Tm_abs_33ca3e15ccdbf81acba6953928f085d6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7cd218292925b043d2eb072e03408ed1
;;; Fact-ids: Name DelimitedRelease.wallet; Namespace DelimitedRelease
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7cd218292925b043d2eb072e03408ed1 @x0
@x1
@x2)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_7cd218292925b043d2eb072e03408ed1 @x0
@x1
@x2))))
:qid haseqTm_refine_7cd218292925b043d2eb072e03408ed1))

:named haseqTm_refine_7cd218292925b043d2eb072e03408ed1))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_289855aa746535562d5330d01c24b5ff
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_289855aa746535562d5330d01c24b5ff @x0
@x1
@x2)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 @x0
FStar.DM4F.Heap.heap))))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_289855aa746535562d5330d01c24b5ff @x0
@x1
@x2))))
:qid haseqTm_refine_289855aa746535562d5330d01c24b5ff))

:named haseqTm_refine_289855aa746535562d5330d01c24b5ff))
;;;;;;;;;;;;;;;;haseq for Tm_refine_218a7f8b7200b90979b7e60049d43060
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_218a7f8b7200b90979b7e60049d43060 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
...
:pattern ((Valid (Prims.hasEq (Tm_refine_218a7f8b7200b90979b7e60049d43060 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_218a7f8b7200b90979b7e60049d43060))

:named haseqTm_refine_218a7f8b7200b90979b7e60049d43060))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.Heap.ST.write@tok
Non_total_Tm_arrow_fe41029fa99de9fdefa3124fa9385d77))
...
@x2)
@x3)
(FStar.DM4F.Heap.ST.write @x1
@x2
@x3))
 

:pattern ((FStar.DM4F.Heap.ST.write @x1
@x2
@x3))
:qid function_token_typing_FStar.DM4F.Heap.ST.write.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.Heap.ST.write@tok))
:qid function_token_typing_FStar.DM4F.Heap.ST.write))

:named function_token_typing_FStar.DM4F.Heap.ST.write))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(85,5-85,9); use=FStar.DM4F.Heap.ST.fsti(85,5-85,9)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.Heap.ST.read@tok
Non_total_Tm_arrow_0ca95da8a2e011740b0e854a2393003d))
...
@x1)
@x2)
(FStar.DM4F.Heap.ST.read @x1
@x2))
 

:pattern ((FStar.DM4F.Heap.ST.read @x1
@x2))
:qid function_token_typing_FStar.DM4F.Heap.ST.read.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.Heap.ST.read@tok))
:qid function_token_typing_FStar.DM4F.Heap.ST.read))

:named function_token_typing_FStar.DM4F.Heap.ST.read))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Colon_Equals; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(112,5-112,20); use=FStar.DM4F.Heap.ST.fsti(112,5-112,20)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.Heap.ST.op_Colon_Equals@tok
Tm_arrow_172b3cef8768b0786256323012b7a89a))

;; def=FStar.DM4F.Heap.ST.fsti(112,5-112,20); use=FStar.DM4F.Heap.ST.fsti(112,5-112,20)
(forall ((@x1 Term))
 (! (= (ApplyTT FStar.DM4F.Heap.ST.op_Colon_Equals@tok
@x1)
(FStar.DM4F.Heap.ST.op_Colon_Equals @x1))
 

:pattern ((FStar.DM4F.Heap.ST.op_Colon_Equals @x1))
:qid function_token_typing_FStar.DM4F.Heap.ST.op_Colon_Equals.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.Heap.ST.op_Colon_Equals@tok))
:qid function_token_typing_FStar.DM4F.Heap.ST.op_Colon_Equals))

:named function_token_typing_FStar.DM4F.Heap.ST.op_Colon_Equals))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Bang; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(95,6-95,7); use=FStar.DM4F.Heap.ST.fsti(95,6-95,7)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.Heap.ST.op_Bang@tok
Tm_arrow_de36dbf88dcda5986806b4f786af50c1))

;; def=FStar.DM4F.Heap.ST.fsti(95,6-95,7); use=FStar.DM4F.Heap.ST.fsti(95,6-95,7)
(forall ((@x1 Term))
 (! (= (ApplyTT FStar.DM4F.Heap.ST.op_Bang@tok
@x1)
(FStar.DM4F.Heap.ST.op_Bang @x1))
 

:pattern ((FStar.DM4F.Heap.ST.op_Bang @x1))
:qid function_token_typing_FStar.DM4F.Heap.ST.op_Bang.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.Heap.ST.op_Bang@tok))
:qid function_token_typing_FStar.DM4F.Heap.ST.op_Bang))

:named function_token_typing_FStar.DM4F.Heap.ST.op_Bang))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
;; def=Prims.fst(183,5-183,9); use=Prims.fst(183,5-183,9)
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.ST.write
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(104,5-104,10); use=FStar.DM4F.Heap.ST.fsti(104,5-104,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (FStar.DM4F.Heap.ST.write @x0
@x1
@x2)
@x3)
...
:pattern ((ApplyTT (FStar.DM4F.Heap.ST.write @x0
@x1
@x2)
@x3))
:qid equation_FStar.DM4F.Heap.ST.write))

:named equation_FStar.DM4F.Heap.ST.write))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.ST.read
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(85,5-85,9); use=FStar.DM4F.Heap.ST.fsti(85,5-85,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (FStar.DM4F.Heap.ST.read @x0
@x1)
@x2)
...
:pattern ((ApplyTT (FStar.DM4F.Heap.ST.read @x0
@x1)
@x2))
:qid equation_FStar.DM4F.Heap.ST.read))

:named equation_FStar.DM4F.Heap.ST.read))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.ST.op_Colon_Equals
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Colon_Equals; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(112,5-112,20); use=FStar.DM4F.Heap.ST.fsti(112,5-112,20)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.Heap.ST.op_Colon_Equals @x0)
(ApplyTT FStar.DM4F.Heap.ST.write@tok
@x0))
 

:pattern ((FStar.DM4F.Heap.ST.op_Colon_Equals @x0))
:qid equation_FStar.DM4F.Heap.ST.op_Colon_Equals))

:named equation_FStar.DM4F.Heap.ST.op_Colon_Equals))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.ST.op_Bang
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Bang; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(95,6-95,7); use=FStar.DM4F.Heap.ST.fsti(95,6-95,7)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.Heap.ST.op_Bang @x0)
(ApplyTT FStar.DM4F.Heap.ST.read@tok
@x0))
 

:pattern ((FStar.DM4F.Heap.ST.op_Bang @x0))
:qid equation_FStar.DM4F.Heap.ST.op_Bang))

:named equation_FStar.DM4F.Heap.ST.op_Bang))
;;;;;;;;;;;;;;;;Equation for DelimitedRelease.wallet
;;; Fact-ids: Name DelimitedRelease.wallet; Namespace DelimitedRelease
(assert (! 
;; def=DelimitedRelease.fst(23,4-23,10); use=DelimitedRelease.fst(23,4-23,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (DelimitedRelease.wallet @x0
@x1
@x2)
@x3)
(let ((@lb4 (let ((@lb4 (ApplyTT (ApplyTT (ApplyTT FStar.DM4F.Heap.ST.op_Bang@tok
Prims.int)
@x0)
@x3)))
...
(FStar.Pervasives.Native.Mktuple2__1 @lb4))
(FStar.Pervasives.Native.Mktuple2__2 @lb4)))))
(ApplyTT (let ((@lb5 (FStar.Pervasives.Native.Mktuple2__1 @lb4)))
(ite (= @lb5
(BoxBool true))
(Tm_abs_54607be58fc6e3b208e1951a532640c5 @x0
@x2
@x1)
Tm_abs_33ca3e15ccdbf81acba6953928f085d6))
(FStar.Pervasives.Native.Mktuple2__2 @lb4))))
 

:pattern ((ApplyTT (DelimitedRelease.wallet @x0
@x1
@x2)
@x3))
:qid equation_DelimitedRelease.wallet))

:named equation_DelimitedRelease.wallet))
;;;;;;;;;;;;;;;;Equation for DelimitedRelease.heap_equiv_on
;;; Fact-ids: Name DelimitedRelease.heap_equiv_on; Namespace DelimitedRelease
(assert (! 
;; def=DelimitedRelease.fst(37,4-37,17); use=DelimitedRelease.fst(37,4-37,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Valid (DelimitedRelease.heap_equiv_on @x0
@x1
@x2))

;; def=DelimitedRelease.fst(38,4-40,26); use=DelimitedRelease.fst(38,4-40,26)
(implies 
;; def=DelimitedRelease.fst(38,4-39,20); use=DelimitedRelease.fst(38,4-39,20)
(and 
;; def=DelimitedRelease.fst(38,4-38,20); use=DelimitedRelease.fst(38,4-38,20)
(Valid 
;; def=DelimitedRelease.fst(38,4-38,20); use=DelimitedRelease.fst(38,4-38,20)
...
;; def=DelimitedRelease.fst(39,4-39,20); use=DelimitedRelease.fst(39,4-39,20)
(Valid 
;; def=DelimitedRelease.fst(39,4-39,20); use=DelimitedRelease.fst(39,4-39,20)
(FStar.DM4F.Heap.contains Prims.int
@x2
...
;; def=DelimitedRelease.fst(40,4-40,26); use=DelimitedRelease.fst(40,4-40,26)
(= (FStar.DM4F.Heap.sel Prims.int
@x1
@x0)
(FStar.DM4F.Heap.sel Prims.int
...
@x1
@x2))
:qid equation_DelimitedRelease.heap_equiv_on))

:named equation_DelimitedRelease.heap_equiv_on))
;;;;;;;;;;;;;;;;Prop-typing for DelimitedRelease.heap_equiv_on
;;; Fact-ids: Name DelimitedRelease.heap_equiv_on; Namespace DelimitedRelease
(assert (! 
;; def=DelimitedRelease.fst(37,4-37,17); use=DelimitedRelease.fst(37,4-37,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType @x2
FStar.DM4F.Heap.heap))
(Valid (Prims.subtype_of (DelimitedRelease.heap_equiv_on @x0
@x1
@x2)
Prims.unit)))
 

:pattern ((Prims.subtype_of (DelimitedRelease.heap_equiv_on @x0
@x1
@x2)
Prims.unit))
:qid defn_equation_DelimitedRelease.heap_equiv_on))

:named defn_equation_DelimitedRelease.heap_equiv_on))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
;; def=Prims.fst(183,34-183,38); use=Prims.fst(183,34-183,38)
...
@x3
@x4)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Bang; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(85,14-95,15); use=FStar.DM4F.Heap.ST.fsti(95,1-95,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_de36dbf88dcda5986806b4f786af50c1)
...
@x1
Tm_arrow_de36dbf88dcda5986806b4f786af50c1))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_de36dbf88dcda5986806b4f786af50c1))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_de36dbf88dcda5986806b4f786af50c1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec @x2
@x3)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(39,22-39,26); use=FStar.DM4F.Heap.ST.fsti(39,22-39,26)
...
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Colon_Equals; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(104,15-112,28); use=FStar.DM4F.Heap.ST.fsti(112,1-112,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_172b3cef8768b0786256323012b7a89a)
...
@x1
Tm_arrow_172b3cef8768b0786256323012b7a89a))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_172b3cef8768b0786256323012b7a89a))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_172b3cef8768b0786256323012b7a89a))
...
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797 @x1
@x2
@x3))
(and 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
...
(HasType (ApplyTT @x0
@x4)
(Tm_refine_218a7f8b7200b90979b7e60049d43060 @x3
@x4
@x2
@x1)))
...
:pattern ((ApplyTT @x0
@x4))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797.1))
...
@x2
@x3)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_de36dbf88dcda5986806b4f786af50c1
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Bang; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(85,14-95,15); use=FStar.DM4F.Heap.ST.fsti(95,1-95,15)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Non_total_Tm_arrow_55a202b06bf8f2197f2b24d2244b305e @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_de36dbf88dcda5986806b4f786af50c1.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_de36dbf88dcda5986806b4f786af50c1))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_de36dbf88dcda5986806b4f786af50c1))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_de36dbf88dcda5986806b4f786af50c1))
...
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec.1))
...
(Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec @x1
@x2)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec))
...
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_172b3cef8768b0786256323012b7a89a
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Colon_Equals; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(104,15-112,28); use=FStar.DM4F.Heap.ST.fsti(112,1-112,28)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Non_total_Tm_arrow_661015f3663eb5ed49ce6a9b3117aa88 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_172b3cef8768b0786256323012b7a89a.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_172b3cef8768b0786256323012b7a89a))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_172b3cef8768b0786256323012b7a89a))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_172b3cef8768b0786256323012b7a89a))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.Heap.ST.STATE; Namespace FStar.DM4F.Heap.ST
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_d570ad90629fada2806f3c45692274c8 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_d570ad90629fada2806f3c45692274c8 @x2
@x3)))
:qid DelimitedRelease_pre_typing_Tm_arrow_d570ad90629fada2806f3c45692274c8))

:named DelimitedRelease_pre_typing_Tm_arrow_d570ad90629fada2806f3c45692274c8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d570ad90629fada2806f3c45692274c8
;;; Fact-ids: Name DelimitedRelease.wallet; Namespace DelimitedRelease
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
(HasType (ApplyTT @x0
@x3)
(Tm_refine_7cd218292925b043d2eb072e03408ed1 @x3
@x2
@x1)))
...
:pattern ((ApplyTT @x0
@x3))
:qid DelimitedRelease_interpretation_Tm_arrow_d570ad90629fada2806f3c45692274c8.1))
...
(Tm_arrow_d570ad90629fada2806f3c45692274c8 @x1
@x2)))
:qid DelimitedRelease_interpretation_Tm_arrow_d570ad90629fada2806f3c45692274c8))

:named DelimitedRelease_interpretation_Tm_arrow_d570ad90629fada2806f3c45692274c8))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Bang; Namespace FStar.DM4F.Heap.ST
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.DM4F.Heap.ST.read@tok))
:named @kick_partial_app_e356e4a4609bd0c1e80e9c3adb255916))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.DM4F.Heap.ST.incr; Namespace FStar.DM4F.Heap.ST
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.DM4F.Heap.ST.op_Colon_Equals@tok))
:named @kick_partial_app_ae0cea7f442aee5b1d1c657a94276bfc))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.DM4F.Heap.ST.incr; Namespace FStar.DM4F.Heap.ST
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.DM4F.Heap.ST.op_Bang@tok))
:named @kick_partial_app_40758369033bb5eb87ec935dda563113))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.DM4F.Heap.ST.op_Colon_Equals; Namespace FStar.DM4F.Heap.ST
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.DM4F.Heap.ST.write@tok))
:named @kick_partial_app_04e6ddec723400f89e462dc06d57ee46))
(push) ;; push{2

; Starting query at DelimitedRelease.fst(53,4-53,6)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_e825907ec337375c0fd1ce7edf286d4e (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=DelimitedRelease.fst(43,29-44,69); use=DelimitedRelease.fst(43,29-44,69)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_e825907ec337375c0fd1ce7edf286d4e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_e825907ec337375c0fd1ce7edf286d4e @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_e825907ec337375c0fd1ce7edf286d4e))

:named refinement_kinding_Tm_refine_e825907ec337375c0fd1ce7edf286d4e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=DelimitedRelease.fst(43,29-44,69); use=DelimitedRelease.fst(43,29-44,69)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e825907ec337375c0fd1ce7edf286d4e @x2
@x3))
(and (HasTypeFuel @u0
@x1
FStar.DM4F.Heap.heap)

;; def=DelimitedRelease.fst(43,38-43,67); use=DelimitedRelease.fst(43,38-43,67)
(Valid 
;; def=DelimitedRelease.fst(43,38-43,67); use=DelimitedRelease.fst(43,38-43,67)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x1
...
;; def=DelimitedRelease.fst(44,38-44,67); use=DelimitedRelease.fst(44,38-44,67)
(Valid 
;; def=DelimitedRelease.fst(44,38-44,67); use=DelimitedRelease.fst(44,38-44,67)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x1
...
(Tm_refine_e825907ec337375c0fd1ce7edf286d4e @x2
@x3)))
:qid refinement_interpretation_Tm_refine_e825907ec337375c0fd1ce7edf286d4e))

:named refinement_interpretation_Tm_refine_e825907ec337375c0fd1ce7edf286d4e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e825907ec337375c0fd1ce7edf286d4e
;;; Fact-ids: 
(assert (! 
;; def=DelimitedRelease.fst(43,29-44,69); use=DelimitedRelease.fst(43,29-44,69)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e825907ec337375c0fd1ce7edf286d4e @x0
@x1)))
(Valid (Prims.hasEq FStar.DM4F.Heap.heap)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e825907ec337375c0fd1ce7edf286d4e @x0
@x1))))
:qid haseqTm_refine_e825907ec337375c0fd1ce7edf286d4e))

:named haseqTm_refine_e825907ec337375c0fd1ce7edf286d4e))

(declare-fun Tm_refine_b9597015a397cbf6de6958a3a4cf3045 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=DelimitedRelease.fst(47,20-49,56); use=DelimitedRelease.fst(53,4-53,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_refine_b9597015a397cbf6de6958a3a4cf3045 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_refine_b9597015a397cbf6de6958a3a4cf3045 @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid refinement_kinding_Tm_refine_b9597015a397cbf6de6958a3a4cf3045))

:named refinement_kinding_Tm_refine_b9597015a397cbf6de6958a3a4cf3045))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=DelimitedRelease.fst(47,20-49,56); use=DelimitedRelease.fst(53,4-53,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b9597015a397cbf6de6958a3a4cf3045 @x2
@x3
@x4
@x5
@x6))
...
;; def=DelimitedRelease.fst(47,21-47,43); use=DelimitedRelease.fst(53,4-53,6)
(Valid 
;; def=DelimitedRelease.fst(47,21-47,43); use=DelimitedRelease.fst(53,4-53,6)
(DelimitedRelease.heap_equiv_on @x2
@x3
@x4)
)


;; def=DelimitedRelease.fst(48,21-48,45); use=DelimitedRelease.fst(53,4-53,6)
(not (= (FStar.DM4F.Heap.addr_of Prims.int
@x5)
(FStar.DM4F.Heap.addr_of Prims.int
@x2)))


;; def=DelimitedRelease.fst(49,21-49,55); use=DelimitedRelease.fst(53,4-53,6)
(iff 
;; def=DelimitedRelease.fst(49,22-49,35); use=DelimitedRelease.fst(53,4-53,6)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (FStar.DM4F.Heap.sel Prims.int
@x3
@x5)))


;; def=DelimitedRelease.fst(49,41-49,54); use=DelimitedRelease.fst(53,4-53,6)
(< (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (FStar.DM4F.Heap.sel Prims.int
@x4
@x5)))
...
@x5
@x6)))
:qid refinement_interpretation_Tm_refine_b9597015a397cbf6de6958a3a4cf3045))

:named refinement_interpretation_Tm_refine_b9597015a397cbf6de6958a3a4cf3045))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b9597015a397cbf6de6958a3a4cf3045
;;; Fact-ids: 
(assert (! 
;; def=DelimitedRelease.fst(47,20-49,56); use=DelimitedRelease.fst(53,4-53,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b9597015a397cbf6de6958a3a4cf3045 @x0
@x1
@x2
@x3
@x4)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_b9597015a397cbf6de6958a3a4cf3045 @x0
@x1
@x2
@x3
@x4))))
:qid haseqTm_refine_b9597015a397cbf6de6958a3a4cf3045))

:named haseqTm_refine_b9597015a397cbf6de6958a3a4cf3045))

; Encoding query formula : forall (hi: FStar.DM4F.Heap.ref Prims.int)
;   (lo: FStar.DM4F.Heap.ref Prims.int)
;   (k: Prims.int)
;   (h0:
;   FStar.DM4F.Heap.heap
;     {FStar.DM4F.Heap.contains_a_well_typed h0 hi /\ FStar.DM4F.Heap.contains_a_well_typed h0 lo})
;   (h1:
;   FStar.DM4F.Heap.heap
;     {FStar.DM4F.Heap.contains_a_well_typed h1 hi /\ FStar.DM4F.Heap.contains_a_well_typed h1 lo}).
;   (DelimitedRelease.heap_equiv_on lo h0 h1 ==> Prims.hasEq Prims.nat) /\
;   (forall (any_result: Prims.logical).
;       DelimitedRelease.heap_equiv_on lo h0 h1 /\
;       (FStar.DM4F.Heap.addr_of hi <> FStar.DM4F.Heap.addr_of lo) /\
;       (k < FStar.DM4F.Heap.sel h0 hi <==> k < FStar.DM4F.Heap.sel h1 hi) ==
;       any_result ==>
;       (DelimitedRelease.heap_equiv_on lo h0 h1 ==> Prims.hasEq Prims.nat) /\
;       (forall (_:
;           Prims.squash (DelimitedRelease.heap_equiv_on lo h0 h1 /\
;               FStar.DM4F.Heap.addr_of hi <> FStar.DM4F.Heap.addr_of lo /\
;               (k < FStar.DM4F.Heap.sel h0 hi <==> k < FStar.DM4F.Heap.sel h1 hi))).
;           (*  - Could not prove post-condition
; *)
;           FStar.DM4F.Heap.contains_a_well_typed h0 hi /\ FStar.DM4F.Heap.contains_a_well_typed h0 lo /\
;           (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;               FStar.DM4F.Heap.contains_a_well_typed h0 hi /\
;               FStar.DM4F.Heap.contains_a_well_typed h0 lo ==>
;               reify (DelimitedRelease.wallet hi lo k) h0 == (a, n1) ==>
;               (forall (b: Prims.unit) (b: FStar.DM4F.Heap.heap).
;                   reify (DelimitedRelease.wallet hi lo k) h0 == (b, b) ==>
;                   FStar.DM4F.Heap.contains_a_well_typed h1 hi /\
;                   FStar.DM4F.Heap.contains_a_well_typed h1 lo)))) /\
;   (forall (p: Prims.pure_post Prims.unit).
;       DelimitedRelease.heap_equiv_on lo h0 h1 /\
;       FStar.DM4F.Heap.addr_of hi <> FStar.DM4F.Heap.addr_of lo /\
;       (k < FStar.DM4F.Heap.sel h0 hi <==> k < FStar.DM4F.Heap.sel h1 hi) /\
;       (forall (pure_result: Prims.unit).
;           (let _, h0' = reify (DelimitedRelease.wallet hi lo k) h0 in
;             (let _, h1' = reify (DelimitedRelease.wallet hi lo k) h1 in
;               DelimitedRelease.heap_equiv_on lo h0' h1')
;             <:
;             Type0) ==>
;           p pure_result) ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let delimited_release_wallet`
...
Prims.int)
(HasType @x3
(Tm_refine_e825907ec337375c0fd1ce7edf286d4e @x0
@x1))
(HasType @x4
(Tm_refine_e825907ec337375c0fd1ce7edf286d4e @x0
@x1)))
...
(Valid 
;; def=DelimitedRelease.fst(47,21-47,43); use=DelimitedRelease.fst(53,4-53,6)
(DelimitedRelease.heap_equiv_on @x1
@x3
@x4)
)


;; def=Prims.fst(73,23-73,30); use=DelimitedRelease.fst(48,21-48,28)
(or label_1

;; def=Prims.fst(73,23-73,30); use=DelimitedRelease.fst(53,4-53,6)
(Valid 
;; def=Prims.fst(73,23-73,30); use=DelimitedRelease.fst(53,4-53,6)
(Prims.hasEq Prims.nat)
)
...
;; def=Prims.fst(451,66-451,102); use=DelimitedRelease.fst(53,4-53,6)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.logical)

;; def=FStar.Pervasives.fsti(112,28-112,31); use=DelimitedRelease.fst(53,4-53,6)
(= (Prims.l_and (Prims.l_and (DelimitedRelease.heap_equiv_on @x1
@x3
@x4)
...
(FStar.DM4F.Heap.addr_of Prims.int
@x1))))
(Prims.l_iff (Prims.b2t (Prims.op_LessThan @x2
(FStar.DM4F.Heap.sel Prims.int
@x3
@x0)))
...
;; def=dummy(0,0-0,0); use=DelimitedRelease.fst(53,4-53,6)
(and (implies 
;; def=DelimitedRelease.fst(47,21-47,43); use=DelimitedRelease.fst(53,4-53,6)
(Valid 
;; def=DelimitedRelease.fst(47,21-47,43); use=DelimitedRelease.fst(53,4-53,6)
...
;; def=Prims.fst(73,23-73,30); use=DelimitedRelease.fst(47,4-47,9)
(or label_2
...
(forall ((@x6 Term))
 (! (implies (HasType @x6
(Tm_refine_b9597015a397cbf6de6958a3a4cf3045 @x1
@x3
@x4
@x0
@x2))

;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=DelimitedRelease.fst(53,4-53,6)
(and 
;; def=DelimitedRelease.fst(25,27-25,55); use=DelimitedRelease.fst(50,19-52,45)
(or label_3

;; def=DelimitedRelease.fst(25,27-25,55); use=DelimitedRelease.fst(53,4-53,6)
(Valid 
;; def=DelimitedRelease.fst(25,27-25,55); use=DelimitedRelease.fst(53,4-53,6)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x3
...
;; def=DelimitedRelease.fst(26,24-26,52); use=DelimitedRelease.fst(50,19-52,45)
(or label_4

;; def=DelimitedRelease.fst(26,24-26,52); use=DelimitedRelease.fst(53,4-53,6)
(Valid 
;; def=DelimitedRelease.fst(26,24-26,52); use=DelimitedRelease.fst(53,4-53,6)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=DelimitedRelease.fst(53,4-53,6)
...
;; def=DelimitedRelease.fst(50,24-50,58); use=DelimitedRelease.fst(53,4-53,6)
(= (ApplyTT (DelimitedRelease.wallet @x0
@x1
@x2)
@x3)
...
;; def=Prims.fst(413,99-413,120); use=DelimitedRelease.fst(53,4-53,6)
(forall ((@x9 Term))
 (! (implies (HasType @x9
Prims.unit)
...
;; def=DelimitedRelease.fst(50,24-50,30); use=DelimitedRelease.fst(53,4-53,6)
(= (ApplyTT (DelimitedRelease.wallet @x0
@x1
@x2)
@x3)
...
;; def=DelimitedRelease.fst(25,27-26,52); use=DelimitedRelease.fst(53,4-53,6)
(and 
;; def=DelimitedRelease.fst(25,27-25,55); use=DelimitedRelease.fst(50,19-52,45)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=DelimitedRelease.fst(53,4-53,6)
(forall ((@x6 Term))
 (! (implies (and (or label_7
(HasType @x6
Prims.unit))
(let ((@lb7 (ApplyTT (DelimitedRelease.wallet @x0
@x1
@x2)
@x3)))
(let ((@lb8 (ApplyTT (DelimitedRelease.wallet @x0
@x1
@x2)
@x4)))

;; def=DelimitedRelease.fst(52,20-52,44); use=DelimitedRelease.fst(53,4-53,6)
(or label_8
...
;; def=Prims.fst(441,83-441,96); use=DelimitedRelease.fst(53,4-53,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=DelimitedRelease.fst(53,4-53,6)
(ApplyTT @x5
@x6)
