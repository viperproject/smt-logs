...
; Externals for interface FStar.DM4F.Heap


; <Start encoding val FStar.DM4F.Heap.heap>

(declare-fun FStar.DM4F.Heap.heap () Term)

; </end encoding val FStar.DM4F.Heap.heap>


; <Start encoding val FStar.DM4F.Heap.ref>

(declare-fun FStar.DM4F.Heap.ref (Term) Term)

(declare-fun FStar.DM4F.Heap.ref@tok () Term)

; </end encoding val FStar.DM4F.Heap.ref>


; <Start encoding val FStar.DM4F.Heap.addr_of>
...
; </end encoding val FStar.DM4F.Heap.addr_of>


; <Start encoding val FStar.DM4F.Heap.compare_addrs>
...
; </end encoding val FStar.DM4F.Heap.compare_addrs>


; <Start encoding val FStar.DM4F.Heap.contains_a_well_typed>
...
; </end encoding val FStar.DM4F.Heap.contains_a_well_typed>


; <Start encoding val FStar.DM4F.Heap.sel_tot>
...
; </end encoding val FStar.DM4F.Heap.sel_tot>


; <Start encoding val FStar.DM4F.Heap.sel>
...
; </end encoding val FStar.DM4F.Heap.sel>


; <Start encoding val FStar.DM4F.Heap.upd_tot>
...
; </end encoding val FStar.DM4F.Heap.upd_tot>


; <Start encoding val FStar.DM4F.Heap.upd>
...
; </end encoding val FStar.DM4F.Heap.upd>


; <Start encoding val FStar.DM4F.Heap.alloc>
...
; </end encoding val FStar.DM4F.Heap.alloc>


; <Start encoding val FStar.DM4F.Heap.contains>

(declare-fun FStar.DM4F.Heap.contains (Term Term Term) Term)

(declare-fun FStar.DM4F.Heap.contains@tok () Term)

; </end encoding val FStar.DM4F.Heap.contains>


; <Start encoding val FStar.DM4F.Heap.contains_a_well_typed_implies_contains>
...
; </end encoding val FStar.DM4F.Heap.contains_a_well_typed_implies_contains>


; <Start encoding val FStar.DM4F.Heap.contains_addr_of>
...
; </end encoding val FStar.DM4F.Heap.contains_addr_of>
...
; <Start encoding val FStar.DM4F.Heap.alloc_lemma>
...
; </end encoding val FStar.DM4F.Heap.alloc_lemma>


; <Start encoding val FStar.DM4F.Heap.sel_same_addr_of>
...
; </end encoding val FStar.DM4F.Heap.sel_same_addr_of>


; <Start encoding val FStar.DM4F.Heap.sel_upd1>
...
; </end encoding val FStar.DM4F.Heap.sel_upd1>


; <Start encoding val FStar.DM4F.Heap.sel_upd2>
...
; </end encoding val FStar.DM4F.Heap.sel_upd2>


; <Start encoding val FStar.DM4F.Heap.upd_sel>
...
; </end encoding val FStar.DM4F.Heap.upd_sel>
...
; <Start encoding val FStar.DM4F.Heap.emp>

(declare-fun FStar.DM4F.Heap.emp (Dummy_sort) Term)

; </end encoding val FStar.DM4F.Heap.emp>


; <Start encoding val FStar.DM4F.Heap.in_dom_emp>
...
; </end encoding val FStar.DM4F.Heap.in_dom_emp>


; <Start encoding val FStar.DM4F.Heap.upd_contains>
...
; </end encoding val FStar.DM4F.Heap.upd_contains>


; <Start encoding val FStar.DM4F.Heap.upd_contains_a_well_typed>
...
; </end encoding val FStar.DM4F.Heap.upd_contains_a_well_typed>
...
; <Start encoding val FStar.DM4F.Heap.lemma_modifies_trans>
...
; </end encoding val FStar.DM4F.Heap.lemma_modifies_trans>


; <Start encoding val FStar.DM4F.Heap.lemma_sel_tot_is_sel_if_contains_a_well_typed>
...
; </end encoding val FStar.DM4F.Heap.lemma_sel_tot_is_sel_if_contains_a_well_typed>


; <Start encoding val FStar.DM4F.Heap.lemma_upd_tot_is_upd_if_contains_a_well_typed>
...
; </end encoding val FStar.DM4F.Heap.lemma_upd_tot_is_upd_if_contains_a_well_typed>
...
(declare-fun FStar.DM4F.Heap.op_Hat_Plus_Hat (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;r1: ref a -> r2: ref b -> FStar.Set.set Prims.nat
(declare-fun Tm_arrow_b984690ae6eb6ae1decd14dd6959449a () Term)
(declare-fun FStar.DM4F.Heap.op_Hat_Plus_Hat@tok () Term)

; </end encoding let op_Hat_Plus_Hat>


; End Externals for interface FStar.DM4F.Heap

(push) ;; push{1

; Internals for FStar.DM4F.Heap.ST


; encoding sigelt let _dm4f_STATE_lift_from_pure


; <Start encoding let _dm4f_STATE_lift_from_pure>



;;;;;;;;;;;;;;;;_: a & FStar.DM4F.Heap.heap -> Type
(declare-fun Tm_arrow_52f1537e02d27a68a52de16c5e870077 (Term) Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     s0: FStar.DM4F.Heap.heap ->     p': (_: a & FStar.DM4F.Heap.heap -> Type)   -> Type
(declare-fun Tm_arrow_5bd8a28bd91c5ca2f32de3a8cb2f29d8 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_lift_from_pure@tok () Term)




(declare-fun Tm_abs_d792e9b9f12920cc07d3a0b2412953c2 (Term Term Term) Term)

; </end encoding let _dm4f_STATE_lift_from_pure>


; encoding sigelt let _dm4f_STATE_return_wp


; <Start encoding let _dm4f_STATE_return_wp>


(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> s0: FStar.DM4F.Heap.heap -> p': (_: a & FStar.DM4F.Heap.heap -> Type) -> Type
(declare-fun Tm_arrow_38b37605d6fc7bea4a69d2f34d7fa10b () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_return_wp@tok () Term)


; </end encoding let _dm4f_STATE_return_wp>


; encoding sigelt let _dm4f_STATE_return_elab


; <Start encoding let _dm4f_STATE_return_elab>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_return_elab (Term Term) Term)
(declare-fun Tm_refine_1cb8f8975dedad81bdf6985da86b6956 (Term Term Term) Term)
;;;;;;;;;;;;;;;;s0__x: FStar.DM4F.Heap.heap -> Prims.PURE (a & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_74f050a0275378e1b4381dea230d7f0d (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> s0__x: FStar.DM4F.Heap.heap -> Prims.PURE (a & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_b692f9a54937d5ec504669df0a2f58c9 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_return_elab@tok () Term)


(declare-fun Tm_abs_27402dba0dc0638a7c625983daa7fc26 (Term Term) Term)

; </end encoding let _dm4f_STATE_return_elab>


; encoding sigelt let _dm4f_STATE_bind_wp


; <Start encoding let _dm4f_STATE_bind_wp>


;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type
(declare-fun Tm_arrow_574b56f31dace125e35f58bdb86d9156 (Term) Term)


;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.Heap.heap -> _: (_: b & FStar.DM4F.Heap.heap -> Type) -> Type
(declare-fun Tm_arrow_1bc73ec23829678d0af00f84c887a3f2 (Term Term) Term)

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type) ->     g: (_: a -> _: FStar.DM4F.Heap.heap -> _: (_: b & FStar.DM4F.Heap.heap -> Type) -> Type) ->     s0: FStar.DM4F.Heap.heap ->     p'': (_: b & FStar.DM4F.Heap.heap -> Type)   -> Type
(declare-fun Tm_arrow_fadf41e0ef8fd6ab83671211ad9f1911 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_bind_wp@tok () Term)
...
(declare-fun Tm_abs_4c6193b3a0c9a935d76fa99649777a5f (Term Term Term) Term)

; </end encoding let _dm4f_STATE_bind_wp>


; encoding sigelt let _dm4f_STATE_bind_elab


; <Start encoding let _dm4f_STATE_bind_elab>



(declare-fun Tm_refine_80508d5f9333d267f1bdadaba6ccceb6 (Term) Term)

;;;;;;;;;;;;;;;;y: _: (a & FStar.DM4F.Heap.heap){Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_5fc490df8ca7d69b3325f040113870b7 (Term) Term)
(declare-fun Tm_abs_1ff39fb601f13b8706c10bb03b53cb5d (Term Term) Term)
(declare-fun Tm_refine_035810fff1eae5b29412fcb4a0754110 (Term Term Term) Term)



(declare-fun Tm_abs_1ac3596f5d31ba4877fed2412c01b499 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (a & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_4b99ce1a269491d7070898253f93128d (Term Term) Term)
...
(declare-fun Tm_refine_bf6898161f7a31c2bb84711b8e0b2594 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (b & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_62eb522e62672b892345bcc43a9ecd19 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.Heap.heap -> Prims.PURE (b & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_ebc15bf189d30837dddbc95e79d83d17 (Term Term Term) Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_bind_elab (Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_ad7b72bb958f8f43856881caf0104020 (Term Term Term Term) Term)
(declare-fun Tm_refine_16cf14310d121041b24d7e0d7eabaabb (Term Term Term Term Term) Term)





(declare-fun Tm_abs_2fbe63e964224df73d64877a532b8435 (Term Term Term) Term)
;;;;;;;;;;;;;;;;s0__x: FStar.DM4F.Heap.heap -> Prims.PURE (b & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_9f4e9daa0d03b02492f2dfad6626fb5f (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f__w: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type) ->     f: (_: FStar.DM4F.Heap.heap -> Prims.PURE (a & FStar.DM4F.Heap.heap)) ->     g__w: (_: a -> _: FStar.DM4F.Heap.heap -> _: (_: b & FStar.DM4F.Heap.heap -> Type) -> Type) ->     g: (_: a -> _: FStar.DM4F.Heap.heap -> Prims.PURE (b & FStar.DM4F.Heap.heap)) ->     s0__x: FStar.DM4F.Heap.heap   -> Prims.PURE (b & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_c2f10b042958601992041162b41e6557 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_bind_elab@tok () Term)
...
(declare-fun Tm_abs_26a05cc41a2617acd9735ca41c1f2639 (Term Term) Term)

; </end encoding let _dm4f_STATE_bind_elab>


; encoding sigelt let _dm4f_STATE___proj__STATE__item__get_elab


; <Start encoding let _dm4f_STATE___proj__STATE__item__get_elab>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab (Term) Term)
(declare-fun Tm_refine_137cac80114c0d42bfb8d7f27f7dee83 (Term) Term)
;;;;;;;;;;;;;;;;s0__x: FStar.DM4F.Heap.heap -> Prims.PURE (FStar.DM4F.Heap.heap & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_f9b82d10525fd1f52a423689d7528e36 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> s0__x: FStar.DM4F.Heap.heap   -> Prims.PURE (FStar.DM4F.Heap.heap & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_d32eef8f9576f45538e2e9322565f5d1 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab@tok () Term)


(declare-fun Tm_abs_50147fa5577cdf7a53ba8185222c6f23 () Term)

; </end encoding let _dm4f_STATE___proj__STATE__item__get_elab>


; encoding sigelt let _dm4f_STATE___proj__STATE__item__get_complete_type


; <Start encoding let _dm4f_STATE___proj__STATE__item__get_complete_type>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_complete_type () Term)




; </end encoding let _dm4f_STATE___proj__STATE__item__get_complete_type>


; encoding sigelt let _dm4f_STATE___proj__STATE__item__put_elab


; <Start encoding let _dm4f_STATE___proj__STATE__item__put_elab>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab (Term) Term)
(declare-fun Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_1a2a4a3fd9df71617ac951165f517845 (Term) Term)
;;;;;;;;;;;;;;;;x: FStar.DM4F.Heap.heap -> _: FStar.DM4F.Heap.heap -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab@tok () Term)


(declare-fun Tm_abs_3956dcb22289b54ec1d7aa53012106c7 (Term) Term)

; </end encoding let _dm4f_STATE___proj__STATE__item__put_elab>


; encoding sigelt let _dm4f_STATE___proj__STATE__item__put_complete_type


; <Start encoding let _dm4f_STATE___proj__STATE__item__put_complete_type>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_complete_type () Term)




; </end encoding let _dm4f_STATE___proj__STATE__item__put_complete_type>


; encoding sigelt let _dm4f_STATE_repr


; <Start encoding let _dm4f_STATE_repr>



(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp_a: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type)   -> Type
(declare-fun Tm_arrow_9005e8f5db104ea97a2f5d3014617314 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_repr@tok () Term)
...
; </end encoding let _dm4f_STATE_repr>


; encoding sigelt let _dm4f_STATE_pre


; <Start encoding let _dm4f_STATE_pre>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_pre () Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Type
(declare-fun Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e () Term)

; </end encoding let _dm4f_STATE_pre>


; encoding sigelt let _dm4f_STATE_post


; <Start encoding let _dm4f_STATE_post>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_post (Term) Term)

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_post@tok () Term)


; </end encoding let _dm4f_STATE_post>


; encoding sigelt let _dm4f_STATE_wp


; <Start encoding let _dm4f_STATE_wp>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_wp (Term) Term)

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_wp@tok () Term)



; </end encoding let _dm4f_STATE_wp>


; encoding sigelt let _dm4f_STATE_ctx


; <Start encoding let _dm4f_STATE_ctx>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_ctx (Term Term) Term)

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> t
(declare-fun Tm_arrow_e1d4e3e36a465b5e4106eeafe1ecbeea (Term Term) Term)

; </end encoding let _dm4f_STATE_ctx>


; encoding sigelt let _dm4f_STATE_gctx


; <Start encoding let _dm4f_STATE_gctx>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_gctx (Term Term) Term)

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Prims.GTot t
(declare-fun Tm_ghost_arrow_e7ccf45ef8ea4a8ca0ebb9bd913e6e90 (Term Term) Term)

; </end encoding let _dm4f_STATE_gctx>


; encoding sigelt let _dm4f_STATE_pure


; <Start encoding let _dm4f_STATE_pure>


(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> t
(declare-fun Tm_arrow_35646d880af0d6819ef6b5d87fd240e5 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_pure@tok () Term)


; </end encoding let _dm4f_STATE_pure>


; encoding sigelt let _dm4f_STATE_app


; <Start encoding let _dm4f_STATE_app>



;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_35fe14b459e9fe18625600399ff24eb1 (Term Term Term) Term)



(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l:       (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type)           -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Prims.GTot t1) ->     _: FStar.DM4F.Heap.heap ->     _: (_: a & FStar.DM4F.Heap.heap -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_e63e72b3e226a730976123f93db8b8f6 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_app@tok () Term)
...
; </end encoding let _dm4f_STATE_app>


; encoding sigelt let _dm4f_STATE_lift1


; <Start encoding let _dm4f_STATE_lift1>




(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Prims.GTot t1) ->     _: FStar.DM4F.Heap.heap ->     _: (_: a & FStar.DM4F.Heap.heap -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_45595298cab24fdd67fa93aca5de6af8 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_lift1@tok () Term)
...
(declare-fun Tm_abs_21389c1a34f306b96cec4339ad616695 (Term Term Term Term) Term)

; </end encoding let _dm4f_STATE_lift1>


; encoding sigelt let _dm4f_STATE_lift2


; <Start encoding let _dm4f_STATE_lift2>
...
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Prims.GTot t1) ->     a2: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Prims.GTot t2) ->     _: FStar.DM4F.Heap.heap ->     _: (_: a & FStar.DM4F.Heap.heap -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_77917995f2f1b3b0e83ac50fc76f4784 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_lift2@tok () Term)
...
(declare-fun Tm_abs_482e36980f898e27dee3e2b65f854f7d (Term Term Term Term Term) Term)

; </end encoding let _dm4f_STATE_lift2>


; encoding sigelt let _dm4f_STATE_push


; <Start encoding let _dm4f_STATE_push>



;;;;;;;;;;;;;;;;_: t1 -> _: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Prims.GTot t2
(declare-fun Tm_arrow_1a79c601a935debda14086e201d9526b (Term Term Term) Term)

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f:       (_: t1 -> _: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Prims.GTot t2       ) ->     _: FStar.DM4F.Heap.heap ->     _: (_: a & FStar.DM4F.Heap.heap -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_8d5263bb5bf4d89d9c8ea6d69f8c894d () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_push@tok () Term)





; </end encoding let _dm4f_STATE_push>


; encoding sigelt let _dm4f_STATE_wp_if_then_else


; <Start encoding let _dm4f_STATE_wp_if_then_else>

(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type) ->     _: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type) ->     _: FStar.DM4F.Heap.heap ->     _: (_: a & FStar.DM4F.Heap.heap -> Type)   -> Type
(declare-fun Tm_arrow_9de41640438756a17c61344aeb8fda11 (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type) ->     _: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type) ->     _: FStar.DM4F.Heap.heap ->     _: (_: a & FStar.DM4F.Heap.heap -> Type)   -> Type
(declare-fun Tm_arrow_2a5de98498690630805cdb63eb08a32d () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_b26dbe92c8883c5859c4abf4e763bf75 (Term) Term)
...
;;;;;;;;;;;;;;;;a1:       (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type)           -> Prims.GTot Prims.logical) ->     a2:       (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type)           -> Prims.GTot Prims.logical) ->     _: FStar.DM4F.Heap.heap ->     _: (_: a & FStar.DM4F.Heap.heap -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_b42aab1654ab42e4a9504ab686dbca00 (Term) Term)
(declare-fun Tm_abs_99ee578e46a9d6cbd87188336a2dbb68 (Term Term) Term)

; </end encoding let _dm4f_STATE_wp_if_then_else>


; encoding sigelt let _dm4f_STATE_wp_close


; <Start encoding let _dm4f_STATE_wp_close>




(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: b -> _: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type) ->     _: FStar.DM4F.Heap.heap ->     _: (_: a & FStar.DM4F.Heap.heap -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_b76038620e527bbf5a20549c7efa4ef5 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_wp_close@tok () Term)
...
(declare-fun Tm_abs_227b7c9ead33d8c6855209062c8ce76f (Term Term Term) Term)

; </end encoding let _dm4f_STATE_wp_close>


; encoding sigelt let _dm4f_STATE_stronger


; <Start encoding let _dm4f_STATE_stronger>





(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type) ->     wp2: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_dada7f7b0a5d16cdef125dda52f17ec9 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_stronger@tok () Term)
...
; </end encoding let _dm4f_STATE_stronger>


; encoding sigelt let _dm4f_STATE_ite_wp


; <Start encoding let _dm4f_STATE_ite_wp>




(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type) ->     _: FStar.DM4F.Heap.heap ->     _: (_: a & FStar.DM4F.Heap.heap -> Type)   -> Prims.logical
(declare-fun Tm_arrow_dbb083a25d478e5190e8211e00006141 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_ite_wp@tok () Term)





; </end encoding let _dm4f_STATE_ite_wp>


; encoding sigelt let _dm4f_STATE_null_wp


; <Start encoding let _dm4f_STATE_null_wp>


(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> _: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Prims.logical
(declare-fun Tm_arrow_2e3d7f12487d40b58f5221be654f5315 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_null_wp@tok () Term)


; </end encoding let _dm4f_STATE_null_wp>


; encoding sigelt let _dm4f_STATE_wp_trivial


; <Start encoding let _dm4f_STATE_wp_trivial>



(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: (_: FStar.DM4F.Heap.heap -> _: (_: a & FStar.DM4F.Heap.heap -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_42f5b3ecd5f5ff851bbbfcb1e444b395 () Term)
(declare-fun FStar.DM4F.Heap.ST._dm4f_STATE_wp_trivial@tok () Term)




; </end encoding let _dm4f_STATE_wp_trivial>


; encoding sigelt new_effect_for_free { STATE ... }


; <Start encoding new_effect_for_free { STATE ... }>





(declare-fun Tm_abs_7c40d280a6f27d658cb5f54b6f9415cc () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.Heap.ST.__proj__STATE__item__get (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.Heap.ST.__proj__STATE__item__get@tok () Term)




(declare-fun Tm_abs_487b9a6200a4bf314d2acf58de7b1956 () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.Heap.ST.__proj__STATE__item__put (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.Heap.ST.__proj__STATE__item__put@tok () Term)

; </end encoding new_effect_for_free { STATE ... }>


; encoding sigelt sub_effect PURE ~> STATE


; <Skipped sub_effect PURE ~> STATE/>
...
(declare-fun FStar.DM4F.Heap.ST.get (Term) Term)
(declare-fun Non_total_Tm_arrow_c24f6111dfe9616c9748e13efb272695 () Term)
(declare-fun FStar.DM4F.Heap.ST.get@tok () Term)
...
(declare-fun FStar.DM4F.Heap.ST.put (Term) Term)
(declare-fun Non_total_Tm_arrow_3a4a9a9bb727fea2ea5424038aac7d4c () Term)
(declare-fun FStar.DM4F.Heap.ST.put@tok () Term)
...
; encoding sigelt let lift_pure_state


; <Start encoding let lift_pure_state>


(declare-fun FStar.DM4F.Heap.ST.lift_pure_state (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     wp: Prims.pure_wp a ->     h: FStar.DM4F.Heap.heap ->     p: (_: a & FStar.DM4F.Heap.heap -> Type)   -> Prims.pure_pre
(declare-fun Tm_arrow_acbef8cf057c02447abd2f3a41ec2f52 () Term)
(declare-fun FStar.DM4F.Heap.ST.lift_pure_state@tok () Term)




; </end encoding let lift_pure_state>
...
; encoding sigelt effect ST a pre post = FStar.DM4F.Heap.ST.STATE a


; <Skipped effect ST a pre post = FStar.DM4F.Heap.ST.STATE a/>


; encoding sigelt effect STNull a = FStar.DM4F.Heap.ST.ST a


; <Skipped effect STNull a = FStar.DM4F.Heap.ST.ST a/>
...
(assert (! 
;; def=FStar.DM4F.Heap.fsti(49,4-49,7); use=FStar.DM4F.Heap.fsti(49,4-49,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(assert (! 
;; def=FStar.DM4F.Heap.fsti(44,4-44,7); use=FStar.DM4F.Heap.fsti(44,4-44,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.ref; Namespace FStar.DM4F.Heap
(assert (! 
;; def=FStar.DM4F.Heap.fsti(33,4-33,7); use=FStar.DM4F.Heap.fsti(33,4-33,7)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
...
:qid typing_FStar.DM4F.Heap.ref))

:named typing_FStar.DM4F.Heap.ref))
;;;;;;;;;;;;;;;;free var typing
...
(assert (! 
;; def=FStar.DM4F.Heap.fsti(39,4-39,25); use=FStar.DM4F.Heap.fsti(39,4-39,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(assert (! 
;; def=FStar.DM4F.Heap.fsti(55,4-55,12); use=FStar.DM4F.Heap.fsti(55,4-55,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(assert (! 
;; def=FStar.DM4F.Heap.fsti(53,4-53,9); use=FStar.DM4F.Heap.fsti(53,4-53,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(assert (! 
;; def=FStar.DM4F.Heap.fsti(35,4-35,11); use=FStar.DM4F.Heap.fsti(35,4-35,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;;; Fact-ids: Name FStar.DM4F.Heap.alloc; Namespace FStar.DM4F.Heap
(assert (! 
;; def=FStar.DM4F.Heap.fsti(53,44-53,89); use=FStar.DM4F.Heap.fsti(53,44-53,89)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;; def=FStar.DM4F.Heap.fsti(53,62-53,87); use=FStar.DM4F.Heap.fsti(53,62-53,87)
...
;;;;;;;;;;;;;;;;Lemma: FStar.DM4F.Heap.upd_sel
;;; Fact-ids: Name FStar.DM4F.Heap.upd_sel; Namespace FStar.DM4F.Heap
...
;; def=FStar.DM4F.Heap.fsti(94,23-94,52); use=FStar.DM4F.Heap.fsti(94,23-94,52)
(Valid 
;; def=FStar.DM4F.Heap.fsti(94,23-94,52); use=FStar.DM4F.Heap.fsti(94,23-94,52)
...
;; def=FStar.DM4F.Heap.fsti(95,23-95,47); use=FStar.DM4F.Heap.fsti(95,23-95,47)
...
@x1
@x2)))
:qid lemma_FStar.DM4F.Heap.upd_sel))
:named lemma_FStar.DM4F.Heap.upd_sel))
...
;; def=FStar.DM4F.Heap.fsti(118,21-120,53); use=FStar.DM4F.Heap.fsti(118,21-120,53)
(and 
;; def=FStar.DM4F.Heap.fsti(118,22-118,59); use=FStar.DM4F.Heap.fsti(118,22-118,59)
(Valid 
;; def=FStar.DM4F.Heap.fsti(118,22-118,59); use=FStar.DM4F.Heap.fsti(118,22-118,59)
(FStar.DM4F.Heap.contains_a_well_typed @x0
(FStar.DM4F.Heap.upd @x0
...
;; def=FStar.DM4F.Heap.fsti(119,15-120,52); use=FStar.DM4F.Heap.fsti(119,15-120,52)
(implies 
;; def=FStar.DM4F.Heap.fsti(119,16-119,101); use=FStar.DM4F.Heap.fsti(119,16-119,101)
(and 
;; def=FStar.DM4F.Heap.fsti(119,17-119,68); use=FStar.DM4F.Heap.fsti(119,17-119,68)
(or 
;; def=FStar.DM4F.Heap.fsti(119,18-119,45); use=FStar.DM4F.Heap.fsti(119,18-119,45)
(Valid 
;; def=FStar.DM4F.Heap.fsti(119,18-119,45); use=FStar.DM4F.Heap.fsti(119,18-119,45)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x2
...
;; def=FStar.DM4F.Heap.fsti(119,49-119,67); use=FStar.DM4F.Heap.fsti(119,49-119,67)
(not 
;; def=FStar.DM4F.Heap.fsti(119,51-119,67); use=FStar.DM4F.Heap.fsti(119,51-119,67)
(Valid 
;; def=FStar.DM4F.Heap.fsti(119,51-119,67); use=FStar.DM4F.Heap.fsti(119,51-119,67)
...
;; def=FStar.DM4F.Heap.fsti(119,72-119,100); use=FStar.DM4F.Heap.fsti(119,72-119,100)
(Valid 
;; def=FStar.DM4F.Heap.fsti(119,72-119,100); use=FStar.DM4F.Heap.fsti(119,72-119,100)
...
;; def=FStar.DM4F.Heap.fsti(120,13-120,51); use=FStar.DM4F.Heap.fsti(120,13-120,51)
(Valid 
;; def=FStar.DM4F.Heap.fsti(120,13-120,51); use=FStar.DM4F.Heap.fsti(120,13-120,51)
(FStar.DM4F.Heap.contains_a_well_typed @x1
(FStar.DM4F.Heap.upd @x0
...
;; def=FStar.DM4F.Heap.fsti(112,21-113,63); use=FStar.DM4F.Heap.fsti(112,21-113,63)
(and 
;; def=FStar.DM4F.Heap.fsti(112,22-112,60); use=FStar.DM4F.Heap.fsti(112,22-112,60)
(Valid 
;; def=FStar.DM4F.Heap.fsti(112,22-112,60); use=FStar.DM4F.Heap.fsti(112,22-112,60)
(FStar.DM4F.Heap.contains_a_well_typed @x0
(FStar.DM4F.Heap.upd @x0
...
;; def=FStar.DM4F.Heap.fsti(113,15-113,62); use=FStar.DM4F.Heap.fsti(113,15-113,62)
(implies 
;; def=FStar.DM4F.Heap.fsti(113,16-113,31); use=FStar.DM4F.Heap.fsti(113,16-113,31)
(Valid 
;; def=FStar.DM4F.Heap.fsti(113,16-113,31); use=FStar.DM4F.Heap.fsti(113,16-113,31)
...
;; def=FStar.DM4F.Heap.fsti(113,36-113,61); use=FStar.DM4F.Heap.fsti(113,36-113,61)
(Valid 
;; def=FStar.DM4F.Heap.fsti(113,36-113,61); use=FStar.DM4F.Heap.fsti(113,36-113,61)
(FStar.DM4F.Heap.contains @x1
(FStar.DM4F.Heap.upd @x0
...
;; def=FStar.DM4F.Heap.fsti(90,49-90,73); use=FStar.DM4F.Heap.fsti(90,49-90,73)
...
;; def=FStar.DM4F.Heap.fsti(90,78-90,109); use=FStar.DM4F.Heap.fsti(90,78-90,109)
(= (FStar.DM4F.Heap.sel @x0
...
;; def=FStar.DM4F.Heap.fsti(86,26-86,50); use=FStar.DM4F.Heap.fsti(86,26-86,50)
...
;; def=FStar.DM4F.Heap.fsti(86,61-86,86); use=FStar.DM4F.Heap.fsti(86,61-86,86)
(= (FStar.DM4F.Heap.sel @x0
(FStar.DM4F.Heap.upd @x0
@x1
@x2
...
;; def=FStar.DM4F.Heap.fsti(81,20-81,41); use=FStar.DM4F.Heap.fsti(81,20-81,41)
(= (FStar.DM4F.Heap.addr_of @x0
@x1)
(FStar.DM4F.Heap.addr_of @x0
@x2))
...
;; def=FStar.DM4F.Heap.fsti(81,45-81,72); use=FStar.DM4F.Heap.fsti(81,45-81,72)
(Valid 
;; def=FStar.DM4F.Heap.fsti(81,45-81,72); use=FStar.DM4F.Heap.fsti(81,45-81,72)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x3
...
;; def=FStar.DM4F.Heap.fsti(81,76-81,103); use=FStar.DM4F.Heap.fsti(81,76-81,103)
(Valid 
;; def=FStar.DM4F.Heap.fsti(81,76-81,103); use=FStar.DM4F.Heap.fsti(81,76-81,103)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x3
...
;; def=FStar.DM4F.Heap.fsti(82,19-82,39); use=FStar.DM4F.Heap.fsti(82,19-82,39)
(= (FStar.DM4F.Heap.sel @x0
@x3
@x1)
(FStar.DM4F.Heap.sel @x0
...
;; def=FStar.DM4F.Heap.fsti(63,41-63,56); use=FStar.DM4F.Heap.fsti(63,41-63,56)
(Valid 
;; def=FStar.DM4F.Heap.fsti(63,41-63,56); use=FStar.DM4F.Heap.fsti(63,41-63,56)
(FStar.DM4F.Heap.contains @x0
@x2
...
;; def=FStar.DM4F.Heap.fsti(63,60-63,79); use=FStar.DM4F.Heap.fsti(63,60-63,79)
(not 
;; def=FStar.DM4F.Heap.fsti(63,62-63,79); use=FStar.DM4F.Heap.fsti(63,62-63,79)
(Valid 
;; def=FStar.DM4F.Heap.fsti(63,62-63,79); use=FStar.DM4F.Heap.fsti(63,62-63,79)
(FStar.DM4F.Heap.contains @x1
@x2
...
;; def=FStar.DM4F.Heap.fsti(64,25-64,51); use=FStar.DM4F.Heap.fsti(64,25-64,51)
(not (= (FStar.DM4F.Heap.addr_of @x0
@x3)
(FStar.DM4F.Heap.addr_of @x1
@x4)))
...
;; def=FStar.DM4F.Heap.fsti(58,49-58,78); use=FStar.DM4F.Heap.fsti(58,49-58,78)
(Valid 
;; def=FStar.DM4F.Heap.fsti(58,49-58,78); use=FStar.DM4F.Heap.fsti(58,49-58,78)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x1
...
;; def=FStar.DM4F.Heap.fsti(59,27-59,43); use=FStar.DM4F.Heap.fsti(59,27-59,43)
(Valid 
;; def=FStar.DM4F.Heap.fsti(59,27-59,43); use=FStar.DM4F.Heap.fsti(59,27-59,43)
(FStar.DM4F.Heap.contains @x0
@x1
...
;;;;;;;;;;;;;;;;Lemma: FStar.DM4F.Heap.alloc_lemma
;;; Fact-ids: Name FStar.DM4F.Heap.alloc_lemma; Namespace FStar.DM4F.Heap
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
@x0))
(let ((@lb3 (FStar.DM4F.Heap.alloc @x0
@x1
@x2)))

;; def=FStar.DM4F.Heap.fsti(77,14-77,85); use=FStar.DM4F.Heap.fsti(77,14-77,85)
(and 
;; def=FStar.DM4F.Heap.fsti(77,14-77,30); use=FStar.DM4F.Heap.fsti(77,14-77,30)
...
;; def=FStar.DM4F.Heap.fsti(77,34-77,53); use=FStar.DM4F.Heap.fsti(77,34-77,53)
(not 
;; def=FStar.DM4F.Heap.fsti(77,36-77,53); use=FStar.DM4F.Heap.fsti(77,36-77,53)
(Valid 
;; def=FStar.DM4F.Heap.fsti(77,36-77,53); use=FStar.DM4F.Heap.fsti(77,36-77,53)
(FStar.DM4F.Heap.contains @x0
@x1
...
;; def=FStar.DM4F.Heap.fsti(77,57-77,85); use=FStar.DM4F.Heap.fsti(77,57-77,85)
(Valid 
;; def=FStar.DM4F.Heap.fsti(77,57-77,85); use=FStar.DM4F.Heap.fsti(77,57-77,85)
(FStar.DM4F.Heap.contains_a_well_typed @x0
(FStar.Pervasives.Native.Mktuple2__2 @lb3)
...
@x1
@x2))
:qid lemma_FStar.DM4F.Heap.alloc_lemma))
:named lemma_FStar.DM4F.Heap.alloc_lemma))
...
; Starting query at FStar.DM4F.Heap.ST.fsti(70,5-73,7)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (init: a).
;   (forall (h0: FStar.DM4F.Heap.heap) (r: FStar.DM4F.Heap.ref a) (h1: FStar.DM4F.Heap.heap).
;       (*  - Could not prove post-condition
; *)
;       ~(FStar.DM4F.Heap.contains h0 r) /\ FStar.DM4F.Heap.contains_a_well_typed h1 r /\
;       FStar.DM4F.Heap.sel h1 r == init ==>
;       Prims.hasEq Prims.nat) /\
;   (forall (_: FStar.DM4F.Heap.heap)
;       (p: Prims.pure_post (FStar.DM4F.Heap.ref a & FStar.DM4F.Heap.heap)).
;       (forall (a: FStar.DM4F.Heap.ref a) (n1: FStar.DM4F.Heap.heap).
;           ~(FStar.DM4F.Heap.contains _ a) /\ FStar.DM4F.Heap.contains_a_well_typed n1 a /\
;           FStar.DM4F.Heap.sel n1 a == init /\ FStar.DM4F.Heap.modifies FStar.Set.empty _ n1 ==>
;           p (a, n1)) ==>
;       (forall (e1: FStar.DM4F.Heap.ref a) (e1: FStar.DM4F.Heap.heap).
;           FStar.DM4F.Heap.alloc _ init == (e1, e1) ==> p (e1, e1)))
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
...
;; def=FStar.DM4F.Heap.ST.fsti(66,4-66,23); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(66,6-66,23); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(66,6-66,23); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(FStar.DM4F.Heap.contains @x0
@x2
...
;; def=FStar.DM4F.Heap.ST.fsti(67,3-67,31); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(67,3-67,31); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(68,3-68,19); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(= (FStar.DM4F.Heap.sel @x0
@x4
@x3)
@x1)
...
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(69,3-69,11)
(or label_1

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(Valid 
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(Prims.hasEq Prims.nat)
)
...
FStar.DM4F.Heap.heap)
(HasType @x3
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (FStar.DM4F.Heap.ref @x0)
FStar.DM4F.Heap.heap)))

;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
...
;; def=FStar.DM4F.Heap.ST.fsti(69,3-69,27); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(69,3-69,27); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(FStar.DM4F.Heap.modifies (FStar.Set.empty Prims.nat)
@x2
@x5)
)
)

;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(ApplyTT @x3
...
;; def=FStar.DM4F.Heap.ST.fsti(71,10-71,15); use=FStar.DM4F.Heap.ST.fsti(71,10-71,15)
...
;; def=FStar.DM4F.ST.fst(30,59-30,64); use=FStar.DM4F.Heap.ST.fsti(70,5-73,7)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.alloc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.Heap.modifies, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, lemma_FStar.DM4F.Heap.alloc_lemma, lemma_FStar.DM4F.Heap.contains_addr_of, lemma_FStar.DM4F.Heap.sel_upd1, lemma_FStar.DM4F.Heap.sel_upd2, lemma_FStar.DM4F.Heap.upd_contains, lemma_FStar.DM4F.Heap.upd_contains_a_well_typed, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
(declare-fun FStar.DM4F.Heap.ST.alloc (Term Term) Term)
(declare-fun Non_total_Tm_arrow_f7145efff25a291ca3d64d394c3c4c10 () Term)
(declare-fun FStar.DM4F.Heap.ST.alloc@tok () Term)
(declare-fun Tm_refine_962ba9b0d48975fc1520d2dfe3a7b8e7 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (FStar.DM4F.Heap.ref a & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_f44d8f2ed0f1ef578d9e8f34c3d20822 (Term Term) Term)
(declare-fun Tm_abs_992a7fcd52d4ea409c7cc27018142f11 (Term Term) Term)

; </end encoding let alloc>

(push) ;; push{2

; Starting query at FStar.DM4F.Heap.ST.fsti(79,3-82,5)
...
;     (p: Prims.pure_post (FStar.DM4F.Heap.ref a & FStar.DM4F.Heap.heap)).
;     (forall (a: FStar.DM4F.Heap.ref a) (n1: FStar.DM4F.Heap.heap).
;         FStar.DM4F.Heap.contains_a_well_typed n1 a /\
;         (forall (a: Type0) (r': FStar.DM4F.Heap.ref a).
;             FStar.DM4F.Heap.contains_a_well_typed _ r' ==>
;             FStar.DM4F.Heap.contains_a_well_typed n1 r') ==>
;         p (a, n1)) ==>
;     (forall (e1: FStar.DM4F.Heap.ref a) (e1: FStar.DM4F.Heap.heap).
;         FStar.DM4F.Heap.alloc _ init == (e1, e1) ==> p (e1, e1))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let alloc_weak`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
FStar.DM4F.Heap.heap)
(HasType @x3
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
(FStar.DM4F.Heap.ref @x0))
(HasType @x5
...
;; def=FStar.DM4F.Heap.ST.fsti(77,40-77,68); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(77,40-77,68); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x5
...
;; def=FStar.DM4F.Heap.ST.fsti(78,30-78,123); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
Tm_type)
(HasType @x7
(FStar.DM4F.Heap.ref @x6))

;; def=FStar.DM4F.Heap.ST.fsti(78,59-78,88); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(78,59-78,88); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(FStar.DM4F.Heap.contains_a_well_typed @x6
@x2
@x7)
)
)

;; def=FStar.DM4F.Heap.ST.fsti(78,93-78,122); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(78,93-78,122); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(FStar.DM4F.Heap.contains_a_well_typed @x6
@x5
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.Heap.ref @x0)
...
;; def=FStar.DM4F.Heap.ST.fsti(80,8-80,13); use=FStar.DM4F.Heap.ST.fsti(80,8-80,13)
(= (FStar.DM4F.Heap.alloc @x0
@x2
@x1)
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.Heap.ref @x0)
...
;; def=FStar.DM4F.ST.fst(30,59-30,64); use=FStar.DM4F.Heap.ST.fsti(79,3-82,5)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.alloc_weak, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, lemma_FStar.DM4F.Heap.alloc_lemma, lemma_FStar.DM4F.Heap.upd_contains_a_well_typed, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
; encoding sigelt let alloc_weak


; <Start encoding let alloc_weak>

(declare-fun FStar.DM4F.Heap.ST.alloc_weak (Term Term) Term)
(declare-fun Non_total_Tm_arrow_1ea6e3f55150d0c23c7622e3bc5e32cc () Term)
(declare-fun FStar.DM4F.Heap.ST.alloc_weak@tok () Term)
(declare-fun Tm_refine_b371cdfc8273fd792a521f3781bc5f51 (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (FStar.DM4F.Heap.ref a & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_d806aadbce6f8db47219d0431f7babd2 (Term) Term)


; </end encoding let alloc_weak>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.sel_tot; Namespace FStar.DM4F.Heap
(assert (! 
;; def=FStar.DM4F.Heap.fsti(42,4-42,11); use=FStar.DM4F.Heap.fsti(42,4-42,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;;; Fact-ids: Name FStar.DM4F.Heap.sel_tot; Namespace FStar.DM4F.Heap
(assert (! 
;; def=FStar.DM4F.Heap.fsti(42,35-42,71); use=FStar.DM4F.Heap.fsti(42,35-42,71)
(forall ((@x0 Term) (@x1 Term))
...
;; def=FStar.DM4F.Heap.fsti(42,43-42,70); use=FStar.DM4F.Heap.fsti(42,43-42,70)
(Valid 
;; def=FStar.DM4F.Heap.fsti(42,43-42,70); use=FStar.DM4F.Heap.fsti(42,43-42,70)
...
;;;;;;;;;;;;;;;;Lemma: FStar.DM4F.Heap.lemma_sel_tot_is_sel_if_contains_a_well_typed
;;; Fact-ids: Name FStar.DM4F.Heap.lemma_sel_tot_is_sel_if_contains_a_well_typed; Namespace FStar.DM4F.Heap
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=FStar.DM4F.Heap.fsti(158,20-158,44); use=FStar.DM4F.Heap.fsti(158,20-158,44)
...
@x1
@x2))
:qid lemma_FStar.DM4F.Heap.lemma_sel_tot_is_sel_if_contains_a_well_typed))
:named lemma_FStar.DM4F.Heap.lemma_sel_tot_is_sel_if_contains_a_well_typed))
...
; Starting query at FStar.DM4F.Heap.ST.fsti(92,4-93,17)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (r: FStar.DM4F.Heap.ref a).
;   (*  - Could not prove post-condition
; *)
;   forall (_: FStar.DM4F.Heap.heap) (p: Prims.pure_post (a & FStar.DM4F.Heap.heap)).
;     FStar.DM4F.Heap.contains_a_well_typed _ r /\
;     (forall (a: a) (n1: FStar.DM4F.Heap.heap).
;         FStar.DM4F.Heap.contains_a_well_typed _ r /\
;         (_ == n1) /\ FStar.DM4F.Heap.contains_a_well_typed n1 r /\ (FStar.DM4F.Heap.sel n1 r == a) ==>
;         p (a, n1)) ==>
;     Prims.auto_squash (FStar.DM4F.Heap.contains_a_well_typed _ r) /\
;     (forall (any_result: FStar.DM4F.Heap.ref a).
;         r == any_result ==>
;         (forall (any_result: a).
;             any_result == FStar.DM4F.Heap.sel_tot _ r ==> p (any_result, _) <: Type0))
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
FStar.DM4F.Heap.heap)
(HasType @x3
...
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x2
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
@x0)
(HasType @x5
...
;; def=FStar.DM4F.Heap.ST.fsti(89,3-89,11); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(= @x2
@x5)


;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x5
...
;; def=FStar.DM4F.Heap.ST.fsti(91,3-91,16); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(= (FStar.DM4F.Heap.sel @x0
@x5
@x1)
@x4)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(ApplyTT @x3
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(and 
;; def=FStar.DM4F.Heap.fsti(42,43-42,70); use=FStar.DM4F.Heap.ST.fsti(93,16-93,17)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.DM4F.Heap.ref @x0))

;; def=FStar.DM4F.Heap.fsti(42,35-42,36); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(= @x1
@x4)
)
...
;; def=FStar.DM4F.Heap.ST.fsti(85,12-93,17); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(= @x5
(FStar.DM4F.Heap.sel_tot @x0
@x2
@x1))
...
;; def=FStar.DM4F.ST.fst(30,59-30,64); use=FStar.DM4F.Heap.ST.fsti(92,4-93,17)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.read, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, lemma_FStar.DM4F.Heap.lemma_sel_tot_is_sel_if_contains_a_well_typed, refinement_interpretation_Tm_refine_33c56d04cd2b4870da0423961c379a8a
...
(declare-fun FStar.DM4F.Heap.ST.read (Term Term) Term)
(declare-fun Non_total_Tm_arrow_0ca95da8a2e011740b0e854a2393003d () Term)
(declare-fun FStar.DM4F.Heap.ST.read@tok () Term)
(declare-fun Tm_refine_289855aa746535562d5330d01c24b5ff (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (a & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_3b04e6e179fe4fabe28fe13ac21d6cec (Term Term) Term)
...
(declare-fun FStar.DM4F.Heap.ST.op_Bang (Term) Term)
(declare-fun Non_total_Tm_arrow_55a202b06bf8f2197f2b24d2244b305e (Term) Term)
;;;;;;;;;;;;;;;;r: FStar.DM4F.Heap.ref _ -> ST _
(declare-fun Tm_arrow_de36dbf88dcda5986806b4f786af50c1 () Term)
(declare-fun FStar.DM4F.Heap.ST.op_Bang@tok () Term)
...
; Starting query at FStar.DM4F.Heap.ST.fsti(100,4-101,17)
...
;         FStar.DM4F.Heap.contains_a_well_typed _ r /\
;         (forall (a: Type0) (r: FStar.DM4F.Heap.ref a).
;             FStar.DM4F.Heap.contains_a_well_typed _ r ==> FStar.DM4F.Heap.contains_a_well_typed n1 r
;         ) ==>
;         p (a, n1)) ==>
;     Prims.auto_squash (FStar.DM4F.Heap.contains_a_well_typed _ r) /\
;     (forall (any_result: FStar.DM4F.Heap.ref a).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let read_weak`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
FStar.DM4F.Heap.heap)
(HasType @x3
...
;; def=FStar.DM4F.Heap.ST.fsti(98,35-98,63); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(98,35-98,63); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x2
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
@x0)
(HasType @x5
...
;; def=FStar.DM4F.Heap.ST.fsti(99,35-99,123); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
Tm_type)
(HasType @x7
...
;; def=FStar.DM4F.Heap.ST.fsti(99,62-99,90); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(99,62-99,90); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(FStar.DM4F.Heap.contains_a_well_typed @x6
@x2
...
;; def=FStar.DM4F.Heap.ST.fsti(99,95-99,123); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(99,95-99,123); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(FStar.DM4F.Heap.contains_a_well_typed @x6
@x5
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(ApplyTT @x3
(FStar.Pervasives.Native.Mktuple2 @x0
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(and 
;; def=FStar.DM4F.Heap.fsti(42,43-42,70); use=FStar.DM4F.Heap.ST.fsti(101,16-101,17)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.DM4F.Heap.ref @x0))

;; def=FStar.DM4F.Heap.fsti(42,35-42,36); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(= @x1
@x4)
)
...
;; def=FStar.DM4F.Heap.ST.fsti(97,17-101,17); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(= @x5
(FStar.DM4F.Heap.sel_tot @x0
@x2
@x1))
...
;; def=FStar.DM4F.ST.fst(30,59-30,64); use=FStar.DM4F.Heap.ST.fsti(100,4-101,17)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.read_weak, 1)
; STATUS: unsat
...
; encoding sigelt let read_weak


; <Start encoding let read_weak>

(declare-fun FStar.DM4F.Heap.ST.read_weak (Term Term) Term)
(declare-fun Non_total_Tm_arrow_b93dbcdae0636e39b628c0055d5907d0 () Term)
(declare-fun FStar.DM4F.Heap.ST.read_weak@tok () Term)
(declare-fun Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (a & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_ac5361e199150771809c566299892b49 (Term Term) Term)

; </end encoding let read_weak>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.upd_tot; Namespace FStar.DM4F.Heap
(assert (! 
;; def=FStar.DM4F.Heap.fsti(47,4-47,11); use=FStar.DM4F.Heap.fsti(47,4-47,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;;;;;;;;;;;;;;;;Lemma: FStar.DM4F.Heap.lemma_upd_tot_is_upd_if_contains_a_well_typed
;;; Fact-ids: Name FStar.DM4F.Heap.lemma_upd_tot_is_upd_if_contains_a_well_typed; Namespace FStar.DM4F.Heap
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=FStar.DM4F.Heap.fsti(164,20-164,48); use=FStar.DM4F.Heap.fsti(164,20-164,48)
(= (FStar.DM4F.Heap.upd @x0
@x1
@x2
@x3)
...
@x2
@x3))
:qid lemma_FStar.DM4F.Heap.lemma_upd_tot_is_upd_if_contains_a_well_typed))
:named lemma_FStar.DM4F.Heap.lemma_upd_tot_is_upd_if_contains_a_well_typed))
(push) ;; push{2

; Starting query at FStar.DM4F.Heap.ST.fsti(110,5-111,33)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Type) (r: FStar.DM4F.Heap.ref a) (v: a).
;   (*  - Could not prove post-condition
; *)
;   forall (_: FStar.DM4F.Heap.heap) (p: Prims.pure_post (Prims.unit & FStar.DM4F.Heap.heap)).
;     FStar.DM4F.Heap.contains_a_well_typed _ r /\
;     (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;         FStar.DM4F.Heap.contains_a_well_typed _ r /\
;         FStar.DM4F.Heap.contains_a_well_typed _ r /\ FStar.DM4F.Heap.contains_a_well_typed n1 r /\
;         (n1 == FStar.DM4F.Heap.upd _ r v) ==>
;         p (a, n1)) ==>
;     Prims.auto_squash (FStar.DM4F.Heap.contains_a_well_typed _ r) /\
;     (forall (any_result: FStar.DM4F.Heap.ref a).
;         r == any_result ==>
;         (forall (any_result: FStar.DM4F.Heap.heap).
;             FStar.DM4F.Heap.upd_tot _ r v == any_result ==> p ((), FStar.DM4F.Heap.upd_tot _ r v)
;             <:
;             Type0))
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
FStar.DM4F.Heap.heap)
(HasType @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(106,24-106,51); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(106,24-106,51); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
...
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x6
...
;; def=FStar.DM4F.Heap.ST.fsti(109,17-109,33); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(= @x6
(FStar.DM4F.Heap.upd @x0
@x3
@x1
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(ApplyTT @x4
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(and 
;; def=FStar.DM4F.Heap.fsti(47,44-47,72); use=FStar.DM4F.Heap.ST.fsti(111,29-111,30)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.DM4F.Heap.ref @x0))

;; def=FStar.DM4F.Heap.fsti(47,36-47,37); use=FStar.DM4F.Heap.ST.fsti(110,5-111,33)
(= @x1
@x5)
)
...
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.Heap.ST.fsti(111,13-111,16)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.write, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, lemma_FStar.DM4F.Heap.lemma_upd_tot_is_upd_if_contains_a_well_typed, lemma_FStar.DM4F.Heap.upd_contains_a_well_typed, refinement_interpretation_Tm_refine_33c56d04cd2b4870da0423961c379a8a, unit_typing
...
(declare-fun FStar.DM4F.Heap.ST.write (Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_fe41029fa99de9fdefa3124fa9385d77 () Term)
(declare-fun FStar.DM4F.Heap.ST.write@tok () Term)
(declare-fun Tm_refine_218a7f8b7200b90979b7e60049d43060 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_f020b2cd0cdcb1081fafa42ebe1ca797 (Term Term Term) Term)

; </end encoding let write>


; encoding sigelt let op_Colon_Equals


; <Start encoding let op_Colon_Equals>

(declare-fun FStar.DM4F.Heap.ST.op_Colon_Equals (Term) Term)
(declare-fun Non_total_Tm_arrow_661015f3663eb5ed49ce6a9b3117aa88 (Term) Term)
;;;;;;;;;;;;;;;;r: FStar.DM4F.Heap.ref _ -> v: _ -> ST Prims.unit
(declare-fun Tm_arrow_172b3cef8768b0786256323012b7a89a () Term)
(declare-fun FStar.DM4F.Heap.ST.op_Colon_Equals@tok () Term)
...
; Starting query at FStar.DM4F.Heap.ST.fsti(117,3-118,31)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let write_weak`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
FStar.DM4F.Heap.heap)
(HasType @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(115,40-115,68); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(115,40-115,68); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(FStar.DM4F.Heap.contains_a_well_typed @x0
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.unit)
(HasType @x6
...
;; def=FStar.DM4F.Heap.ST.fsti(116,40-116,128); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Tm_type)
(HasType @x8
(FStar.DM4F.Heap.ref @x7))

;; def=FStar.DM4F.Heap.ST.fsti(116,67-116,95); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(116,67-116,95); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(FStar.DM4F.Heap.contains_a_well_typed @x7
@x3
@x8)
)
)

;; def=FStar.DM4F.Heap.ST.fsti(116,100-116,128); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(116,100-116,128); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(FStar.DM4F.Heap.contains_a_well_typed @x7
@x6
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(ApplyTT @x4
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(and 
;; def=FStar.DM4F.Heap.fsti(47,44-47,72); use=FStar.DM4F.Heap.ST.fsti(118,27-118,28)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.DM4F.Heap.ref @x0))

;; def=FStar.DM4F.Heap.fsti(47,36-47,37); use=FStar.DM4F.Heap.ST.fsti(117,3-118,31)
(= @x1
@x5)
)
...
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.Heap.ST.fsti(118,11-118,14)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.write_weak, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, lemma_FStar.DM4F.Heap.lemma_upd_tot_is_upd_if_contains_a_well_typed, lemma_FStar.DM4F.Heap.upd_contains_a_well_typed, refinement_interpretation_Tm_refine_33c56d04cd2b4870da0423961c379a8a, unit_typing
...
; encoding sigelt let write_weak


; <Start encoding let write_weak>

(declare-fun FStar.DM4F.Heap.ST.write_weak (Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_bacc2098eed8177c4b86d6ebeeb8c310 () Term)
(declare-fun FStar.DM4F.Heap.ST.write_weak@tok () Term)
(declare-fun Tm_refine_04837a31074cf44afebea027271a1960 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_070cadfa5a458dd5497b7794d2007481 (Term Term) Term)

; </end encoding let write_weak>
...
; Starting query at FStar.DM4F.Heap.ST.fsti(129,6-129,17)
...
; Encoding query formula : forall (r: FStar.DM4F.Heap.ref Prims.int).
;   (forall (h0: FStar.DM4F.Heap.heap) (s: Prims.unit) (h1: FStar.DM4F.Heap.heap).
;       (*  - Could not prove post-condition
; *)
;       FStar.DM4F.Heap.contains_a_well_typed h0 r ==> Prims.hasEq Prims.nat) /\
;   (forall (_: FStar.DM4F.Heap.heap) (p: Prims.pure_post (Prims.unit & FStar.DM4F.Heap.heap)).
;       FStar.DM4F.Heap.contains_a_well_typed _ r /\
;       (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;           FStar.DM4F.Heap.contains_a_well_typed _ r /\
;           FStar.DM4F.Heap.contains_a_well_typed _ r /\
;           FStar.DM4F.Heap.modifies (FStar.Set.singleton (FStar.DM4F.Heap.addr_of r)) _ n1 /\
;           (FStar.DM4F.Heap.sel n1 r = FStar.DM4F.Heap.sel _ r + 1) ==>
;           p (a, n1)) ==>
;       FStar.DM4F.Heap.contains_a_well_typed _ r /\
;       (forall (a: Prims.int) (n1: FStar.DM4F.Heap.heap).
;           FStar.DM4F.Heap.contains_a_well_typed _ r /\
;           (_ == n1) /\ FStar.DM4F.Heap.contains_a_well_typed n1 r /\ (FStar.DM4F.Heap.sel n1 r == a) ==>
;           FStar.DM4F.Heap.contains_a_well_typed n1 r /\
;           (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
...
;               FStar.DM4F.Heap.contains_a_well_typed n1 r /\
;               FStar.DM4F.Heap.contains_a_well_typed n1 r /\
;               (n1 == FStar.DM4F.Heap.upd n1 r (a + 1)) ==>
;               p (a, n1))))
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.DM4F.Heap.ref Prims.int))

;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
...
;; def=FStar.DM4F.Heap.ST.fsti(126,28-126,56); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(126,28-126,56); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x1
@x0)
)
)

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(127,11-127,19)
(or label_1

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(Valid 
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(Prims.hasEq Prims.nat)
)
...
;; def=FStar.DM4F.Heap.ST.fsti(125,23-125,50); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(125,23-125,50); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x1
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
Prims.unit)
(HasType @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(127,11-127,53); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(127,11-127,53); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(FStar.DM4F.Heap.modifies (FStar.Set.singleton Prims.nat
(FStar.DM4F.Heap.addr_of Prims.int
@x0))
@x1
@x4)
)
...
;; def=FStar.DM4F.Heap.ST.fsti(128,11-128,34); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(= (FStar.DM4F.Heap.sel Prims.int
@x4
@x0)
(Prims.op_Addition (FStar.DM4F.Heap.sel Prims.int
@x1
@x0)
(BoxInt 1)))
)

;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(129,6-129,17)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(129,11-129,12)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=FStar.DM4F.Heap.ST.fsti(129,11-129,12)
(or label_2
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(129,11-129,12)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
Prims.int)
(HasType @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(89,3-89,11); use=FStar.DM4F.Heap.ST.fsti(129,11-129,12)
(= @x1
@x4)


;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(129,11-129,12)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(129,11-129,12)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(91,3-91,16); use=FStar.DM4F.Heap.ST.fsti(129,11-129,12)
(= (FStar.DM4F.Heap.sel Prims.int
@x4
@x0)
@x3)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(129,8-129,10)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(106,24-106,51); use=FStar.DM4F.Heap.ST.fsti(129,8-129,10)
(or label_3
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(129,8-129,10)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.unit)
(HasType @x6
...
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=FStar.DM4F.Heap.ST.fsti(129,8-129,10)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=FStar.DM4F.Heap.ST.fsti(129,8-129,10)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=FStar.DM4F.Heap.ST.fsti(129,8-129,10)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=FStar.DM4F.Heap.ST.fsti(129,8-129,10)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x6
...
;; def=FStar.DM4F.Heap.ST.fsti(109,17-109,33); use=FStar.DM4F.Heap.ST.fsti(129,8-129,10)
(= @x6
(FStar.DM4F.Heap.upd Prims.int
@x4
@x0
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(129,8-129,10)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.incr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, equation_FStar.DM4F.Heap.modifies, equation_Prims.eqtype, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, int_typing, lemma_FStar.DM4F.Heap.sel_upd1, lemma_FStar.DM4F.Heap.sel_upd2, lemma_FStar.DM4F.Heap.upd_contains, lemma_FStar.DM4F.Heap.upd_contains_a_well_typed, lemma_FStar.Set.mem_singleton, primitive_Prims.op_Addition, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_FStar.DM4F.Heap.addr_of, typing_Prims.int
...
(declare-fun FStar.DM4F.Heap.ST.incr (Term) Term)
(declare-fun Non_total_Tm_arrow_07e5f63d2d1c0e56eb38c4b1e3b56c62 () Term)
(declare-fun FStar.DM4F.Heap.ST.incr@tok () Term)
(declare-fun Tm_refine_6400531a3742800e32193da4796d208e (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_d811ce8fe1f2d8aec01d361bb49c6959 (Term) Term)

; </end encoding let incr>

(push) ;; push{2

; Starting query at FStar.DM4F.Heap.ST.fsti(133,4-133,34)
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(133,4-133,34)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
FStar.DM4F.Heap.heap)
(HasType @x2
...
;; def=FStar.DM4F.Heap.ST.fsti(131,48-131,76); use=FStar.DM4F.Heap.ST.fsti(133,4-133,34)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(131,48-131,76); use=FStar.DM4F.Heap.ST.fsti(133,4-133,34)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x1
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(133,4-133,34)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
Prims.unit)
(HasType @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(132,55-132,83); use=FStar.DM4F.Heap.ST.fsti(133,4-133,34)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(132,55-132,83); use=FStar.DM4F.Heap.ST.fsti(133,4-133,34)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(133,4-133,34)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(133,4-133,34)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(133,18-133,27)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(98,35-98,63); use=FStar.DM4F.Heap.ST.fsti(133,18-133,27)
(or label_1
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(133,18-133,27)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
Prims.int)
(HasType @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(99,35-99,123); use=FStar.DM4F.Heap.ST.fsti(133,18-133,27)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Tm_type)
(HasType @x6
(FStar.DM4F.Heap.ref @x5))

;; def=FStar.DM4F.Heap.ST.fsti(99,62-99,90); use=FStar.DM4F.Heap.ST.fsti(133,18-133,27)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(99,62-99,90); use=FStar.DM4F.Heap.ST.fsti(133,18-133,27)
(FStar.DM4F.Heap.contains_a_well_typed @x5
@x1
@x6)
)
)

;; def=FStar.DM4F.Heap.ST.fsti(99,95-99,123); use=FStar.DM4F.Heap.ST.fsti(133,18-133,27)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(99,95-99,123); use=FStar.DM4F.Heap.ST.fsti(133,18-133,27)
(FStar.DM4F.Heap.contains_a_well_typed @x5
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(133,4-133,14)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(115,40-115,68); use=FStar.DM4F.Heap.ST.fsti(133,4-133,14)
(or label_2
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(133,4-133,14)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
Prims.unit)
(HasType @x6
...
;; def=FStar.DM4F.Heap.ST.fsti(116,40-116,128); use=FStar.DM4F.Heap.ST.fsti(133,4-133,14)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Tm_type)
(HasType @x8
...
;; def=FStar.DM4F.Heap.ST.fsti(116,67-116,95); use=FStar.DM4F.Heap.ST.fsti(133,4-133,14)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(116,67-116,95); use=FStar.DM4F.Heap.ST.fsti(133,4-133,14)
(FStar.DM4F.Heap.contains_a_well_typed @x7
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(116,100-116,128); use=FStar.DM4F.Heap.ST.fsti(133,4-133,14)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(116,100-116,128); use=FStar.DM4F.Heap.ST.fsti(133,4-133,14)
(FStar.DM4F.Heap.contains_a_well_typed @x7
@x6
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(133,4-133,14)
(or label_3
...
; QUERY ID: (FStar.DM4F.Heap.ST.incr', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, equation_Prims.eqtype, function_token_typing_Prims.__cache_version_number__, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
(declare-fun FStar.DM4F.Heap.ST.incr_ (Term) Term)
(declare-fun Non_total_Tm_arrow_627b5e83049ca67a6f2ed3f82e963cb5 () Term)
(declare-fun FStar.DM4F.Heap.ST.incr_@tok () Term)
(declare-fun Tm_refine_41ecba646f02f1b0dd449ea5cb2576de (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_459eebfe514ede00b4e707ad8461278c (Term) Term)

; </end encoding let incr'>

;;;;;;;;;;;;;;;;typing_Tm_abs_7c40d280a6f27d658cb5f54b6f9415cc
;;; Fact-ids: Name FStar.DM4F.Heap.ST.STATE; Namespace FStar.DM4F.Heap.ST
(assert (! (HasType Tm_abs_7c40d280a6f27d658cb5f54b6f9415cc
Tm_arrow_d32eef8f9576f45538e2e9322565f5d1)
:named typing_Tm_abs_7c40d280a6f27d658cb5f54b6f9415cc))
;;;;;;;;;;;;;;;;typing_Tm_abs_487b9a6200a4bf314d2acf58de7b1956
;;; Fact-ids: Name FStar.DM4F.Heap.ST.STATE; Namespace FStar.DM4F.Heap.ST
(assert (! (HasType Tm_abs_487b9a6200a4bf314d2acf58de7b1956
Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c)
:named typing_Tm_abs_487b9a6200a4bf314d2acf58de7b1956))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(114,5-114,15); use=FStar.DM4F.Heap.ST.fsti(114,5-114,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x2
@x0))
(HasType (FStar.DM4F.Heap.ST.write_weak @x0
@x1
@x2)
(Tm_arrow_070cadfa5a458dd5497b7794d2007481 @x1
@x0)))
 

:pattern ((FStar.DM4F.Heap.ST.write_weak @x0
@x1
@x2))
:qid typing_FStar.DM4F.Heap.ST.write_weak))

:named typing_FStar.DM4F.Heap.ST.write_weak))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(97,5-97,14); use=FStar.DM4F.Heap.ST.fsti(97,5-97,14)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(FStar.DM4F.Heap.ref @x0)))
(HasType (FStar.DM4F.Heap.ST.read_weak @x0
@x1)
(Tm_arrow_ac5361e199150771809c566299892b49 @x1
@x0)))
 

:pattern ((FStar.DM4F.Heap.ST.read_weak @x0
@x1))
:qid typing_FStar.DM4F.Heap.ST.read_weak))

:named typing_FStar.DM4F.Heap.ST.read_weak))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.ST.incr'; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(131,5-131,10); use=FStar.DM4F.Heap.ST.fsti(131,5-131,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(FStar.DM4F.Heap.ref Prims.int))
(HasType (FStar.DM4F.Heap.ST.incr_ @x0)
(Tm_arrow_459eebfe514ede00b4e707ad8461278c @x0)))
 

:pattern ((FStar.DM4F.Heap.ST.incr_ @x0))
:qid typing_FStar.DM4F.Heap.ST.incr_))

:named typing_FStar.DM4F.Heap.ST.incr_))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_50147fa5577cdf7a53ba8185222c6f23
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! (IsTotFun Tm_abs_50147fa5577cdf7a53ba8185222c6f23)
:named tot_fun_Tm_abs_50147fa5577cdf7a53ba8185222c6f23))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_3956dcb22289b54ec1d7aa53012106c7
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@x0 Term))
 (! (IsTotFun (Tm_abs_3956dcb22289b54ec1d7aa53012106c7 @x0))
 

:pattern ((Tm_abs_3956dcb22289b54ec1d7aa53012106c7 @x0))
:qid tot_fun_Tm_abs_3956dcb22289b54ec1d7aa53012106c7))

:named tot_fun_Tm_abs_3956dcb22289b54ec1d7aa53012106c7))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Heap.ST.incr'; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_41ecba646f02f1b0dd449ea5cb2576de @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_41ecba646f02f1b0dd449ea5cb2576de @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_41ecba646f02f1b0dd449ea5cb2576de))

:named refinement_kinding_Tm_refine_41ecba646f02f1b0dd449ea5cb2576de))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7))

:named refinement_kinding_Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(38,41-38,47)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_137cac80114c0d42bfb8d7f27f7dee83 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_137cac80114c0d42bfb8d7f27f7dee83 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_137cac80114c0d42bfb8d7f27f7dee83))

:named refinement_kinding_Tm_refine_137cac80114c0d42bfb8d7f27f7dee83))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c))

:named refinement_kinding_Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_04837a31074cf44afebea027271a1960 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_04837a31074cf44afebea027271a1960 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_04837a31074cf44afebea027271a1960))

:named refinement_kinding_Tm_refine_04837a31074cf44afebea027271a1960))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Heap.ST.incr'; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_41ecba646f02f1b0dd449ea5cb2576de @x2
@x3))
(and (HasTypeFuel @u0
@x1
...
(not 
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(131,24-131,26)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(131,48-131,76); use=FStar.DM4F.Heap.ST.fsti(131,48-131,76)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(131,48-131,76); use=FStar.DM4F.Heap.ST.fsti(131,48-131,76)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x2
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(51,38-51,89)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
Prims.unit)
(HasType @x5
...
;; def=FStar.DM4F.Heap.ST.fsti(132,55-132,83); use=FStar.DM4F.Heap.ST.fsti(132,55-132,83)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(132,55-132,83); use=FStar.DM4F.Heap.ST.fsti(132,55-132,83)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x5
...
;;no pats
:qid refinement_interpretation_Tm_refine_41ecba646f02f1b0dd449ea5cb2576de.1))
)
)
))
...
(Tm_refine_41ecba646f02f1b0dd449ea5cb2576de @x2
@x3)))
:qid refinement_interpretation_Tm_refine_41ecba646f02f1b0dd449ea5cb2576de))

:named refinement_interpretation_Tm_refine_41ecba646f02f1b0dd449ea5cb2576de))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Prims.unit
FStar.DM4F.Heap.heap))
...
@x1
(Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7 @x2)))
:qid refinement_interpretation_Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7))

:named refinement_interpretation_Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(38,41-38,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_137cac80114c0d42bfb8d7f27f7dee83 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 FStar.DM4F.Heap.heap
FStar.DM4F.Heap.heap))
...
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.ST.fst(38,41-38,47)
(= (FStar.Pervasives.Native.Mktuple2 FStar.DM4F.Heap.heap
FStar.DM4F.Heap.heap
@x2
@x2)
@x1)
...
@x1
(Tm_refine_137cac80114c0d42bfb8d7f27f7dee83 @x2)))
:qid refinement_interpretation_Tm_refine_137cac80114c0d42bfb8d7f27f7dee83))

:named refinement_interpretation_Tm_refine_137cac80114c0d42bfb8d7f27f7dee83))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ST.fst(27,34-27,41)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(98,4-98,6)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(98,35-98,63); use=FStar.DM4F.Heap.ST.fsti(98,35-98,63)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(98,35-98,63); use=FStar.DM4F.Heap.ST.fsti(98,35-98,63)
(FStar.DM4F.Heap.contains_a_well_typed @x2
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(99,35-99,123); use=FStar.DM4F.Heap.ST.fsti(99,35-99,123)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Tm_type)
(HasType @x8
...
;; def=FStar.DM4F.Heap.ST.fsti(99,62-99,90); use=FStar.DM4F.Heap.ST.fsti(99,62-99,90)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(99,62-99,90); use=FStar.DM4F.Heap.ST.fsti(99,62-99,90)
(FStar.DM4F.Heap.contains_a_well_typed @x7
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(99,95-99,123); use=FStar.DM4F.Heap.ST.fsti(99,95-99,123)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(99,95-99,123); use=FStar.DM4F.Heap.ST.fsti(99,95-99,123)
(FStar.DM4F.Heap.contains_a_well_typed @x7
@x6
...
;;no pats
:qid refinement_interpretation_Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c.2))
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c.1))
)
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c))

:named refinement_interpretation_Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_04837a31074cf44afebea027271a1960 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ST.fst(27,34-27,41)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(115,6-115,8)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(115,40-115,68); use=FStar.DM4F.Heap.ST.fsti(115,40-115,68)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(115,40-115,68); use=FStar.DM4F.Heap.ST.fsti(115,40-115,68)
(FStar.DM4F.Heap.contains_a_well_typed @x2
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(116,40-116,128); use=FStar.DM4F.Heap.ST.fsti(116,40-116,128)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Tm_type)
(HasType @x8
...
;; def=FStar.DM4F.Heap.ST.fsti(116,67-116,95); use=FStar.DM4F.Heap.ST.fsti(116,67-116,95)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(116,67-116,95); use=FStar.DM4F.Heap.ST.fsti(116,67-116,95)
(FStar.DM4F.Heap.contains_a_well_typed @x7
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(116,100-116,128); use=FStar.DM4F.Heap.ST.fsti(116,100-116,128)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(116,100-116,128); use=FStar.DM4F.Heap.ST.fsti(116,100-116,128)
(FStar.DM4F.Heap.contains_a_well_typed @x7
@x6
...
;;no pats
:qid refinement_interpretation_Tm_refine_04837a31074cf44afebea027271a1960.2))
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_04837a31074cf44afebea027271a1960.1))
)
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_04837a31074cf44afebea027271a1960))

:named refinement_interpretation_Tm_refine_04837a31074cf44afebea027271a1960))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f9b82d10525fd1f52a423689d7528e36
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! (HasType Tm_arrow_f9b82d10525fd1f52a423689d7528e36
Tm_type)
:named kinding_Tm_arrow_f9b82d10525fd1f52a423689d7528e36))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d32eef8f9576f45538e2e9322565f5d1
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! (HasType Tm_arrow_d32eef8f9576f45538e2e9322565f5d1
Tm_type)
:named kinding_Tm_arrow_d32eef8f9576f45538e2e9322565f5d1))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ac5361e199150771809c566299892b49
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_ac5361e199150771809c566299892b49 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_ac5361e199150771809c566299892b49 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_ac5361e199150771809c566299892b49))

:named kinding_Tm_arrow_ac5361e199150771809c566299892b49))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! (HasType Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c
Tm_type)
:named kinding_Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_459eebfe514ede00b4e707ad8461278c
;;; Fact-ids: Name FStar.DM4F.Heap.ST.incr'; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_459eebfe514ede00b4e707ad8461278c @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_459eebfe514ede00b4e707ad8461278c @x0)
Tm_type))
:qid kinding_Tm_arrow_459eebfe514ede00b4e707ad8461278c))

:named kinding_Tm_arrow_459eebfe514ede00b4e707ad8461278c))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1a2a4a3fd9df71617ac951165f517845
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(39,22-39,26); use=FStar.DM4F.Heap.ST.fsti(39,22-39,26)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_1a2a4a3fd9df71617ac951165f517845 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_1a2a4a3fd9df71617ac951165f517845 @x0)
Tm_type))
:qid kinding_Tm_arrow_1a2a4a3fd9df71617ac951165f517845))

:named kinding_Tm_arrow_1a2a4a3fd9df71617ac951165f517845))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_070cadfa5a458dd5497b7794d2007481
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_070cadfa5a458dd5497b7794d2007481 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_070cadfa5a458dd5497b7794d2007481 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_070cadfa5a458dd5497b7794d2007481))

:named kinding_Tm_arrow_070cadfa5a458dd5497b7794d2007481))
...
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_7c40d280a6f27d658cb5f54b6f9415cc
@x0)
Tm_abs_50147fa5577cdf7a53ba8185222c6f23)
 

:pattern ((ApplyTT Tm_abs_7c40d280a6f27d658cb5f54b6f9415cc
@x0))
:qid interpretation_Tm_abs_7c40d280a6f27d658cb5f54b6f9415cc))

:named interpretation_Tm_abs_7c40d280a6f27d658cb5f54b6f9415cc))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_50147fa5577cdf7a53ba8185222c6f23
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(38,41-38,47); use=FStar.DM4F.ST.fst(38,41-38,47)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_50147fa5577cdf7a53ba8185222c6f23
@x0)
(FStar.Pervasives.Native.Mktuple2 FStar.DM4F.Heap.heap
FStar.DM4F.Heap.heap
@x0
...
:pattern ((ApplyTT Tm_abs_50147fa5577cdf7a53ba8185222c6f23
@x0))
:qid interpretation_Tm_abs_50147fa5577cdf7a53ba8185222c6f23))

:named interpretation_Tm_abs_50147fa5577cdf7a53ba8185222c6f23))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_487b9a6200a4bf314d2acf58de7b1956
;;; Fact-ids: Name FStar.DM4F.Heap.ST.STATE; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_487b9a6200a4bf314d2acf58de7b1956
@x0)
(Tm_abs_3956dcb22289b54ec1d7aa53012106c7 @x0))
 

:pattern ((ApplyTT Tm_abs_487b9a6200a4bf314d2acf58de7b1956
@x0))
:qid interpretation_Tm_abs_487b9a6200a4bf314d2acf58de7b1956))

:named interpretation_Tm_abs_487b9a6200a4bf314d2acf58de7b1956))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_3956dcb22289b54ec1d7aa53012106c7
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_3956dcb22289b54ec1d7aa53012106c7 @x1)
@x0)
(FStar.Pervasives.Native.Mktuple2 Prims.unit
FStar.DM4F.Heap.heap
Tm_unit
...
:pattern ((ApplyTT (Tm_abs_3956dcb22289b54ec1d7aa53012106c7 @x1)
@x0))
:qid interpretation_Tm_abs_3956dcb22289b54ec1d7aa53012106c7))

:named interpretation_Tm_abs_3956dcb22289b54ec1d7aa53012106c7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_41ecba646f02f1b0dd449ea5cb2576de
;;; Fact-ids: Name FStar.DM4F.Heap.ST.incr'; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_41ecba646f02f1b0dd449ea5cb2576de @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
FStar.DM4F.Heap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_41ecba646f02f1b0dd449ea5cb2576de @x0
@x1))))
:qid haseqTm_refine_41ecba646f02f1b0dd449ea5cb2576de))

:named haseqTm_refine_41ecba646f02f1b0dd449ea5cb2576de))
;;;;;;;;;;;;;;;;haseq for Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(40,46-40,51)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
FStar.DM4F.Heap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7 @x0))))
:qid haseqTm_refine_30f8e58e5b3f1eee97f41d6aea37cba7))

:named haseqTm_refine_30f8e58e5b3f1eee97f41d6aea37cba7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_137cac80114c0d42bfb8d7f27f7dee83
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.ST.fst(38,41-38,47)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_137cac80114c0d42bfb8d7f27f7dee83 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 FStar.DM4F.Heap.heap
FStar.DM4F.Heap.heap))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_137cac80114c0d42bfb8d7f27f7dee83 @x0))))
:qid haseqTm_refine_137cac80114c0d42bfb8d7f27f7dee83))

:named haseqTm_refine_137cac80114c0d42bfb8d7f27f7dee83))
;;;;;;;;;;;;;;;;haseq for Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c @x0
@x1
@x2)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 @x0
FStar.DM4F.Heap.heap))))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_082ea62efeb9d86394ed9e317e2f1b1c @x0
@x1
@x2))))
:qid haseqTm_refine_082ea62efeb9d86394ed9e317e2f1b1c))

:named haseqTm_refine_082ea62efeb9d86394ed9e317e2f1b1c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_04837a31074cf44afebea027271a1960
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_04837a31074cf44afebea027271a1960 @x0
@x1
@x2)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
FStar.DM4F.Heap.heap))))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_04837a31074cf44afebea027271a1960 @x0
@x1
@x2))))
:qid haseqTm_refine_04837a31074cf44afebea027271a1960))

:named haseqTm_refine_04837a31074cf44afebea027271a1960))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.ST.write_weak
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(114,5-114,15); use=FStar.DM4F.Heap.ST.fsti(114,5-114,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (FStar.DM4F.Heap.ST.write_weak @x0
@x1
@x2)
@x3)
(let ((@lb4 (ApplyTT (FStar.DM4F.Heap.ST.__proj__STATE__item__get Tm_unit)
@x3)))
(ApplyTT (FStar.DM4F.Heap.ST.__proj__STATE__item__put (FStar.DM4F.Heap.upd_tot @x0
...
:pattern ((ApplyTT (FStar.DM4F.Heap.ST.write_weak @x0
@x1
@x2)
@x3))
:qid equation_FStar.DM4F.Heap.ST.write_weak))

:named equation_FStar.DM4F.Heap.ST.write_weak))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.ST.read_weak
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(97,5-97,14); use=FStar.DM4F.Heap.ST.fsti(97,5-97,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (FStar.DM4F.Heap.ST.read_weak @x0
@x1)
@x2)
(let ((@lb3 (ApplyTT (FStar.DM4F.Heap.ST.__proj__STATE__item__get Tm_unit)
@x2)))
(FStar.Pervasives.Native.Mktuple2 @x0
FStar.DM4F.Heap.heap
(FStar.DM4F.Heap.sel_tot @x0
...
:pattern ((ApplyTT (FStar.DM4F.Heap.ST.read_weak @x0
@x1)
@x2))
:qid equation_FStar.DM4F.Heap.ST.read_weak))

:named equation_FStar.DM4F.Heap.ST.read_weak))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.Heap.ST.incr'
;;; Fact-ids: Name FStar.DM4F.Heap.ST.incr'; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(131,5-131,10); use=FStar.DM4F.Heap.ST.fsti(131,5-131,10)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (FStar.DM4F.Heap.ST.incr_ @x0)
@x1)
(let ((@lb2 (let ((@lb2 (ApplyTT (FStar.DM4F.Heap.ST.read_weak Prims.int
@x0)
@x1)))
(FStar.Pervasives.Native.Mktuple2 Prims.int
FStar.DM4F.Heap.heap
(Prims.op_Addition (FStar.Pervasives.Native.Mktuple2__1 @lb2)
(BoxInt 1))
(FStar.Pervasives.Native.Mktuple2__2 @lb2)))))
(ApplyTT (FStar.DM4F.Heap.ST.write_weak Prims.int
@x0
(FStar.Pervasives.Native.Mktuple2__1 @lb2))
(FStar.Pervasives.Native.Mktuple2__2 @lb2))))
 

:pattern ((ApplyTT (FStar.DM4F.Heap.ST.incr_ @x0)
@x1))
:qid equation_FStar.DM4F.Heap.ST.incr_))

:named equation_FStar.DM4F.Heap.ST.incr_))
;;;;;;;;;;;;;;;;b2t typing
...
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(38,22-38,26); use=FStar.DM4F.Heap.ST.fsti(38,22-38,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f9b82d10525fd1f52a423689d7528e36)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_f9b82d10525fd1f52a423689d7528e36))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_f9b82d10525fd1f52a423689d7528e36))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_f9b82d10525fd1f52a423689d7528e36))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
...
@x1
Tm_arrow_d32eef8f9576f45538e2e9322565f5d1))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_d32eef8f9576f45538e2e9322565f5d1))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_d32eef8f9576f45538e2e9322565f5d1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_ac5361e199150771809c566299892b49 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_ac5361e199150771809c566299892b49 @x2
@x3)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_ac5361e199150771809c566299892b49))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_ac5361e199150771809c566299892b49))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(39,22-39,26); use=FStar.DM4F.Heap.ST.fsti(39,22-39,26)
...
@x1
Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Heap.ST.incr'; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_459eebfe514ede00b4e707ad8461278c @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_459eebfe514ede00b4e707ad8461278c @x2)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_459eebfe514ede00b4e707ad8461278c))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_459eebfe514ede00b4e707ad8461278c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(39,22-39,26); use=FStar.DM4F.Heap.ST.fsti(39,22-39,26)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_1a2a4a3fd9df71617ac951165f517845 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_1a2a4a3fd9df71617ac951165f517845 @x2)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_1a2a4a3fd9df71617ac951165f517845))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_1a2a4a3fd9df71617ac951165f517845))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_070cadfa5a458dd5497b7794d2007481 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_070cadfa5a458dd5497b7794d2007481 @x2
@x3)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_070cadfa5a458dd5497b7794d2007481))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_070cadfa5a458dd5497b7794d2007481))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f9b82d10525fd1f52a423689d7528e36
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(38,22-38,26); use=FStar.DM4F.Heap.ST.fsti(38,22-38,26)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_refine_137cac80114c0d42bfb8d7f27f7dee83 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_f9b82d10525fd1f52a423689d7528e36.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_f9b82d10525fd1f52a423689d7528e36))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_f9b82d10525fd1f52a423689d7528e36))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_f9b82d10525fd1f52a423689d7528e36))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d32eef8f9576f45538e2e9322565f5d1
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__get_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.ST.fst(38,17-38,19); use=FStar.DM4F.ST.fst(38,17-38,19)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_d32eef8f9576f45538e2e9322565f5d1.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_d32eef8f9576f45538e2e9322565f5d1))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_d32eef8f9576f45538e2e9322565f5d1))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_d32eef8f9576f45538e2e9322565f5d1))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ac5361e199150771809c566299892b49
;;; Fact-ids: Name FStar.DM4F.Heap.ST.read_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_ac5361e199150771809c566299892b49.1))
...
(Tm_arrow_ac5361e199150771809c566299892b49 @x1
@x2)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_ac5361e199150771809c566299892b49))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_ac5361e199150771809c566299892b49))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(39,22-39,26); use=FStar.DM4F.Heap.ST.fsti(39,22-39,26)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_1a2a4a3fd9df71617ac951165f517845 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_930e37fa86dd5bdb89a4d77b0bdee25c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_459eebfe514ede00b4e707ad8461278c
;;; Fact-ids: Name FStar.DM4F.Heap.ST.incr'; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_459eebfe514ede00b4e707ad8461278c @x1))
(and 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x2 Term))
 (! (implies (and 
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_459eebfe514ede00b4e707ad8461278c.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_459eebfe514ede00b4e707ad8461278c @x1)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_459eebfe514ede00b4e707ad8461278c))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_459eebfe514ede00b4e707ad8461278c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1a2a4a3fd9df71617ac951165f517845
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE___proj__STATE__item__put_elab; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(39,22-39,26); use=FStar.DM4F.Heap.ST.fsti(39,22-39,26)
(forall ((@x0 Term) (@x1 Term))
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_30f8e58e5b3f1eee97f41d6aea37cba7 @x1)))
 

:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_1a2a4a3fd9df71617ac951165f517845.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_1a2a4a3fd9df71617ac951165f517845 @x1)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_1a2a4a3fd9df71617ac951165f517845))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_1a2a4a3fd9df71617ac951165f517845))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_070cadfa5a458dd5497b7794d2007481
;;; Fact-ids: Name FStar.DM4F.Heap.ST.write_weak; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_070cadfa5a458dd5497b7794d2007481.1))
...
(Tm_arrow_070cadfa5a458dd5497b7794d2007481 @x1
@x2)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_070cadfa5a458dd5497b7794d2007481))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_070cadfa5a458dd5497b7794d2007481))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.Heap.ST.STATE; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(39,7-39,10); use=FStar.DM4F.Heap.ST.fsti(39,7-39,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.Heap.ST.__proj__STATE__item__put @x0)
(ApplyTT Tm_abs_487b9a6200a4bf314d2acf58de7b1956
@x0))
 

:pattern ((FStar.DM4F.Heap.ST.__proj__STATE__item__put @x0))
:qid FStar.DM4F.Heap.ST.__proj__STATE__item__put_equality))

:named FStar.DM4F.Heap.ST.__proj__STATE__item__put_equality))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.Heap.ST.STATE; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(38,7-38,10); use=FStar.DM4F.Heap.ST.fsti(38,7-38,10)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.Heap.ST.__proj__STATE__item__get @x0)
(ApplyTT Tm_abs_7c40d280a6f27d658cb5f54b6f9415cc
@x0))
 

:pattern ((FStar.DM4F.Heap.ST.__proj__STATE__item__get @x0))
:qid FStar.DM4F.Heap.ST.__proj__STATE__item__get_equality))

:named FStar.DM4F.Heap.ST.__proj__STATE__item__get_equality))
(push) ;; push{2

; Starting query at FStar.DM4F.Heap.ST.fsti(136,4-137,36)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_9073a13f8a9480d1df752d719746198d (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(135,31-135,70); use=FStar.DM4F.Heap.ST.fsti(135,31-135,70)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_9073a13f8a9480d1df752d719746198d @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_9073a13f8a9480d1df752d719746198d @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_9073a13f8a9480d1df752d719746198d))

:named refinement_kinding_Tm_refine_9073a13f8a9480d1df752d719746198d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(135,31-135,70); use=FStar.DM4F.Heap.ST.fsti(135,31-135,70)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9073a13f8a9480d1df752d719746198d @x2))
(and (HasTypeFuel @u0
@x1
FStar.DM4F.Heap.heap)

;; def=FStar.DM4F.Heap.ST.fsti(135,40-135,68); use=FStar.DM4F.Heap.ST.fsti(135,40-135,68)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(135,40-135,68); use=FStar.DM4F.Heap.ST.fsti(135,40-135,68)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x1
...
@x1
(Tm_refine_9073a13f8a9480d1df752d719746198d @x2)))
:qid refinement_interpretation_Tm_refine_9073a13f8a9480d1df752d719746198d))

:named refinement_interpretation_Tm_refine_9073a13f8a9480d1df752d719746198d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9073a13f8a9480d1df752d719746198d
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(135,31-135,70); use=FStar.DM4F.Heap.ST.fsti(135,31-135,70)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9073a13f8a9480d1df752d719746198d @x0)))
(Valid (Prims.hasEq FStar.DM4F.Heap.heap)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9073a13f8a9480d1df752d719746198d @x0))))
:qid haseqTm_refine_9073a13f8a9480d1df752d719746198d))

:named haseqTm_refine_9073a13f8a9480d1df752d719746198d))

; Encoding query formula : forall (r: FStar.DM4F.Heap.ref Prims.int)
;   (h0: FStar.DM4F.Heap.heap{FStar.DM4F.Heap.contains_a_well_typed h0 r}).
;   (*  - Could not prove post-condition
; *)
;   FStar.DM4F.Heap.contains_a_well_typed h0 r /\
;   (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;       FStar.DM4F.Heap.contains_a_well_typed h0 r /\ FStar.DM4F.Heap.contains_a_well_typed n1 r ==>
;       reify (FStar.DM4F.Heap.ST.incr' r) h0 == (a, n1) ==>
;       (forall (b: Prims.unit) (b: FStar.DM4F.Heap.heap).
;           reify (FStar.DM4F.Heap.ST.incr' r) h0 == (b, b) ==>
;           (forall (any_result: Type0).
;               (let _, h1 = reify (FStar.DM4F.Heap.ST.incr' r) h0 in
;                 FStar.DM4F.Heap.sel h1 r = FStar.DM4F.Heap.sel h0 r + 1) ==
;               any_result ==>
;               (let _, h1 = reify (FStar.DM4F.Heap.ST.incr' r) h0 in
;                 FStar.DM4F.Heap.sel h1 r = FStar.DM4F.Heap.sel h0 r + 1))))
...
(FStar.DM4F.Heap.ref Prims.int))
(HasType @x1
(Tm_refine_9073a13f8a9480d1df752d719746198d @x0)))

;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(136,32-136,37)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(131,48-131,76); use=FStar.DM4F.Heap.ST.fsti(136,32-136,37)
(or label_1
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(136,32-136,37)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.unit)
(HasType @x3
...
;; def=FStar.DM4F.Heap.ST.fsti(132,55-132,83); use=FStar.DM4F.Heap.ST.fsti(136,32-136,37)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(132,55-132,83); use=FStar.DM4F.Heap.ST.fsti(136,32-136,37)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(136,16-136,44); use=FStar.DM4F.Heap.ST.fsti(136,16-136,44)
(= (ApplyTT (FStar.DM4F.Heap.ST.incr_ @x0)
@x1)
(FStar.Pervasives.Native.Mktuple2 Prims.unit
FStar.DM4F.Heap.heap
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.Heap.ST.fsti(136,4-137,36)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Prims.unit)
...
;; def=FStar.DM4F.Heap.ST.fsti(136,16-136,21); use=FStar.DM4F.Heap.ST.fsti(136,16-136,21)
(= (ApplyTT (FStar.DM4F.Heap.ST.incr_ @x0)
@x1)
(FStar.Pervasives.Native.Mktuple2 Prims.unit
FStar.DM4F.Heap.heap
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.ST.fsti(136,4-137,36)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Tm_type)

;; def=Prims.fst(672,13-672,14); use=FStar.DM4F.Heap.ST.fsti(136,4-137,36)
(= (let ((@lb7 (ApplyTT (FStar.DM4F.Heap.ST.incr_ @x0)
@x1)))
...
;; def=FStar.DM4F.Heap.ST.fsti(137,12-137,35); use=FStar.DM4F.Heap.ST.fsti(136,4-136,10)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.incr_increases, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.Heap.ST.__proj__STATE__item__get_equality, FStar.DM4F.Heap.ST.__proj__STATE__item__put_equality, Prims_pretyping_ae567c2fb75be05905677af440075565, Prims_pretyping_f8666440faa91836cc5a13998af863fc, equation_FStar.DM4F.Heap.ST.incr_, equation_FStar.DM4F.Heap.ST.read_weak, equation_FStar.DM4F.Heap.ST.write_weak, equation_Prims.eqtype, function_token_typing_Prims.__cache_version_number__, int_typing, interpretation_Tm_abs_3956dcb22289b54ec1d7aa53012106c7, interpretation_Tm_abs_487b9a6200a4bf314d2acf58de7b1956, interpretation_Tm_abs_50147fa5577cdf7a53ba8185222c6f23, interpretation_Tm_abs_7c40d280a6f27d658cb5f54b6f9415cc, lemma_FStar.DM4F.Heap.lemma_sel_tot_is_sel_if_contains_a_well_typed, lemma_FStar.DM4F.Heap.lemma_upd_tot_is_upd_if_contains_a_well_typed, lemma_FStar.DM4F.Heap.sel_upd1, primitive_Prims.op_Addition, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_33c56d04cd2b4870da0423961c379a8a, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_9073a13f8a9480d1df752d719746198d, typing_Prims.int, unit_inversion, unit_typing
...
(declare-fun Tm_refine_9073a13f8a9480d1df752d719746198d (Term) Term)
(declare-fun FStar.DM4F.Heap.ST.incr_increases (Term Term) Term)

;;;;;;;;;;;;;;;;r: FStar.DM4F.Heap.ref Prims.int ->     h0: FStar.DM4F.Heap.heap{FStar.DM4F.Heap.contains_a_well_typed h0 r}   -> Prims.unit
(declare-fun Tm_arrow_fea5a41ef4e43c4205b1d045c2704e7b () Term)
(declare-fun FStar.DM4F.Heap.ST.incr_increases@tok () Term)
...
; Starting query at FStar.DM4F.Heap.ST.fsti(148,5-150,7)
...
; Encoding query formula : forall (r: FStar.DM4F.Heap.ref Prims.int).
;   (forall (h0: FStar.DM4F.Heap.heap) (s: FStar.DM4F.Heap.ref Prims.int) (h1: FStar.DM4F.Heap.heap).
;       (*  - Could not prove post-condition
; *)
;       FStar.DM4F.Heap.contains_a_well_typed h0 r /\ ~(FStar.DM4F.Heap.contains h0 s) /\
;       FStar.DM4F.Heap.contains_a_well_typed h1 s ==>
;       Prims.hasEq Prims.nat) /\
;   (forall (_: FStar.DM4F.Heap.heap)
;       (p: Prims.pure_post (FStar.DM4F.Heap.ref Prims.int & FStar.DM4F.Heap.heap)).
;       FStar.DM4F.Heap.contains_a_well_typed _ r /\
;       (forall (a: FStar.DM4F.Heap.ref Prims.int) (n1: FStar.DM4F.Heap.heap).
;           FStar.DM4F.Heap.contains_a_well_typed _ r /\
;           FStar.DM4F.Heap.contains_a_well_typed _ r /\ ~(FStar.DM4F.Heap.contains _ a) /\
;           FStar.DM4F.Heap.contains_a_well_typed n1 a /\
;           FStar.DM4F.Heap.modifies (FStar.Set.singleton (FStar.DM4F.Heap.addr_of r)) _ n1 /\
;           (FStar.DM4F.Heap.sel n1 r = FStar.DM4F.Heap.sel _ r + 1) /\
;           (FStar.DM4F.Heap.sel n1 a = FStar.DM4F.Heap.sel _ r) ==>
;           p (a, n1)) ==>
;       FStar.DM4F.Heap.contains_a_well_typed _ r /\
;       (forall (a: Prims.int) (n1: FStar.DM4F.Heap.heap).
;           FStar.DM4F.Heap.contains_a_well_typed _ r /\
;           (_ == n1) /\ FStar.DM4F.Heap.contains_a_well_typed n1 r /\ (FStar.DM4F.Heap.sel n1 r == a) ==>
;           (forall (a: FStar.DM4F.Heap.ref Prims.int) (n1: FStar.DM4F.Heap.heap).
;               ~(FStar.DM4F.Heap.contains n1 a) /\ FStar.DM4F.Heap.contains_a_well_typed n1 a /\
;               FStar.DM4F.Heap.sel n1 a == a /\ FStar.DM4F.Heap.modifies FStar.Set.empty n1 n1 ==>
;               FStar.DM4F.Heap.contains_a_well_typed n1 r /\
;               (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;                   FStar.DM4F.Heap.contains_a_well_typed n1 r /\
;                   FStar.DM4F.Heap.contains_a_well_typed n1 r /\
;                   FStar.DM4F.Heap.modifies (FStar.Set.singleton (FStar.DM4F.Heap.addr_of r)) n1 n1 /\
;                   (FStar.DM4F.Heap.sel n1 r = FStar.DM4F.Heap.sel n1 r + 1) ==>
;                   p (a, n1)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let copy_and_incr`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(forall ((@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x1
...
;; def=FStar.DM4F.Heap.ST.fsti(142,28-142,56); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(142,28-142,56); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x1
...
;; def=FStar.DM4F.Heap.ST.fsti(143,11-143,30); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(143,13-143,30); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(143,13-143,30); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(FStar.DM4F.Heap.contains Prims.int
@x1
@x2)
)
)
...
;; def=FStar.DM4F.Heap.ST.fsti(144,11-144,39); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(144,11-144,39); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x3
...
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(145,11-145,19)
(or label_1

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(Valid 
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(Prims.hasEq Prims.nat)
)
...
FStar.DM4F.Heap.heap)
(HasType @x2
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (FStar.DM4F.Heap.ref Prims.int)
FStar.DM4F.Heap.heap)))

;; def=FStar.DM4F.Heap.ST.fsti(141,23-141,50); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(141,23-141,50); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x1
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
(FStar.DM4F.Heap.ref Prims.int))
(HasType @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(145,11-145,53); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(145,11-145,53); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(FStar.DM4F.Heap.modifies (FStar.Set.singleton Prims.nat
(FStar.DM4F.Heap.addr_of Prims.int
...
;; def=FStar.DM4F.Heap.ST.fsti(146,11-146,34); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(= (FStar.DM4F.Heap.sel Prims.int
@x4
@x0)
(Prims.op_Addition (FStar.DM4F.Heap.sel Prims.int
...
;; def=FStar.DM4F.Heap.ST.fsti(147,11-147,30); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(= (FStar.DM4F.Heap.sel Prims.int
@x4
@x3)
(FStar.DM4F.Heap.sel Prims.int
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.Heap.ref Prims.int)
FStar.DM4F.Heap.heap
@x3
@x4))
)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(148,20-148,21)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=FStar.DM4F.Heap.ST.fsti(148,20-148,21)
(or label_2
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(148,20-148,21)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
Prims.int)
(HasType @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(89,3-89,11); use=FStar.DM4F.Heap.ST.fsti(148,20-148,21)
(= @x1
@x4)


;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(148,20-148,21)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(148,20-148,21)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(91,3-91,16); use=FStar.DM4F.Heap.ST.fsti(148,20-148,21)
(= (FStar.DM4F.Heap.sel Prims.int
@x4
@x0)
@x3)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(148,14-148,19)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
(FStar.DM4F.Heap.ref Prims.int))
(HasType @x6
...
;; def=FStar.DM4F.Heap.ST.fsti(66,4-66,23); use=FStar.DM4F.Heap.ST.fsti(148,14-148,19)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(66,6-66,23); use=FStar.DM4F.Heap.ST.fsti(148,14-148,19)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(66,6-66,23); use=FStar.DM4F.Heap.ST.fsti(148,14-148,19)
(FStar.DM4F.Heap.contains Prims.int
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(67,3-67,31); use=FStar.DM4F.Heap.ST.fsti(148,14-148,19)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(67,3-67,31); use=FStar.DM4F.Heap.ST.fsti(148,14-148,19)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x6
...
;; def=FStar.DM4F.Heap.ST.fsti(68,3-68,19); use=FStar.DM4F.Heap.ST.fsti(148,14-148,19)
(= (FStar.DM4F.Heap.sel Prims.int
@x6
@x5)
@x3)
...
;; def=FStar.DM4F.Heap.ST.fsti(69,3-69,27); use=FStar.DM4F.Heap.ST.fsti(148,14-148,19)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(69,3-69,27); use=FStar.DM4F.Heap.ST.fsti(148,14-148,19)
(FStar.DM4F.Heap.modifies (FStar.Set.empty Prims.nat)
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(149,6-149,10)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(125,23-125,50); use=FStar.DM4F.Heap.ST.fsti(149,6-149,10)
(or label_3
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(149,6-149,10)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Prims.unit)
(HasType @x8
...
;; def=FStar.DM4F.Heap.ST.fsti(126,28-126,56); use=FStar.DM4F.Heap.ST.fsti(149,6-149,10)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(126,28-126,56); use=FStar.DM4F.Heap.ST.fsti(149,6-149,10)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x6
...
;; def=FStar.DM4F.Heap.ST.fsti(127,11-127,53); use=FStar.DM4F.Heap.ST.fsti(149,6-149,10)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(127,11-127,53); use=FStar.DM4F.Heap.ST.fsti(149,6-149,10)
(FStar.DM4F.Heap.modifies (FStar.Set.singleton Prims.nat
(FStar.DM4F.Heap.addr_of Prims.int
...
;; def=FStar.DM4F.Heap.ST.fsti(128,11-128,34); use=FStar.DM4F.Heap.ST.fsti(149,6-149,10)
(= (FStar.DM4F.Heap.sel Prims.int
@x8
@x0)
(Prims.op_Addition (FStar.DM4F.Heap.sel Prims.int
...
;; def=FStar.DM4F.ST.fst(30,59-30,64); use=FStar.DM4F.Heap.ST.fsti(148,5-150,7)
(or label_4
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.copy_and_incr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, bool_inversion, equation_FStar.DM4F.Heap.modifies, equation_Prims.eqtype, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, int_inversion, lemma_FStar.DM4F.Heap.contains_a_well_typed_implies_contains, lemma_FStar.DM4F.Heap.contains_addr_of, lemma_FStar.Set.mem_empty, lemma_FStar.Set.mem_singleton, primitive_Prims.op_Addition, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_FStar.DM4F.Heap.addr_of, typing_FStar.Set.mem, typing_FStar.Set.singleton, typing_Prims.int
...
; encoding sigelt let copy_and_incr


; <Start encoding let copy_and_incr>

(declare-fun FStar.DM4F.Heap.ST.copy_and_incr (Term) Term)
(declare-fun Non_total_Tm_arrow_03a05b23c43f9c40a311c7ad5f81ef1f () Term)
(declare-fun FStar.DM4F.Heap.ST.copy_and_incr@tok () Term)
(declare-fun Tm_refine_9905a40857282a197eba106c416cc65d (Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (FStar.DM4F.Heap.ref Prims.int & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_d901f3a73314b86fa27834694f48ae67 (Term) Term)


; </end encoding let copy_and_incr>
...
;; def=FStar.DM4F.Heap.fsti(44,4-44,7); use=FStar.DM4F.Heap.fsti(44,4-44,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT FStar.DM4F.Heap.sel@tok
@x0)
@x1)
@x2)
(FStar.DM4F.Heap.sel @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT FStar.DM4F.Heap.sel@tok
@x0)
@x1)
@x2))
:qid token_correspondence_FStar.DM4F.Heap.sel))

:named token_correspondence_FStar.DM4F.Heap.sel))
;;;;;;;;;;;;;;;;kinding_Tm_ghost_arrow_535b38975b72732540270e219fc3b993
;;; Fact-ids: Name FStar.DM4F.Heap.sel; Namespace FStar.DM4F.Heap
(assert (! (HasType Tm_ghost_arrow_535b38975b72732540270e219fc3b993
Tm_type)
:named kinding_Tm_ghost_arrow_535b38975b72732540270e219fc3b993))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.Heap.sel@tok
Tm_ghost_arrow_535b38975b72732540270e219fc3b993))
...
@x2)
@x3)
(FStar.DM4F.Heap.sel @x1
@x2
@x3))
 

:pattern ((FStar.DM4F.Heap.sel @x1
@x2
@x3))
:qid function_token_typing_FStar.DM4F.Heap.sel.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.Heap.sel@tok))
:qid function_token_typing_FStar.DM4F.Heap.sel))

:named function_token_typing_FStar.DM4F.Heap.sel))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Prims.abs; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name FStar.DM4F.Heap.sel; Namespace FStar.DM4F.Heap
(assert (! 
;; def=FStar.DM4F.Heap.fsti(44,10-44,37); use=FStar.DM4F.Heap.fsti(44,12-44,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_ghost_arrow_535b38975b72732540270e219fc3b993)
...
@x1
Tm_ghost_arrow_535b38975b72732540270e219fc3b993))
:qid FStar.DM4F.Heap_pre_typing_Tm_ghost_arrow_535b38975b72732540270e219fc3b993))

:named FStar.DM4F.Heap_pre_typing_Tm_ghost_arrow_535b38975b72732540270e219fc3b993))
;;;;;;;;;;;;;;;;interpretation_Tm_ghost_arrow_535b38975b72732540270e219fc3b993
;;; Fact-ids: Name FStar.DM4F.Heap.sel; Namespace FStar.DM4F.Heap
(assert (! 
;; def=FStar.DM4F.Heap.fsti(44,10-44,37); use=FStar.DM4F.Heap.fsti(44,12-44,47)
(forall ((@x0 Term))
...
@x2)
@x3))
:qid FStar.DM4F.Heap_interpretation_Tm_ghost_arrow_535b38975b72732540270e219fc3b993.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Heap_interpretation_Tm_ghost_arrow_535b38975b72732540270e219fc3b993.2))
))
 

:pattern ((HasTypeZ @x0
Tm_ghost_arrow_535b38975b72732540270e219fc3b993))
:qid FStar.DM4F.Heap_interpretation_Tm_ghost_arrow_535b38975b72732540270e219fc3b993))

:named FStar.DM4F.Heap_interpretation_Tm_ghost_arrow_535b38975b72732540270e219fc3b993))
(push) ;; push{2

; Starting query at FStar.DM4F.Heap.ST.fsti(164,5-166,7)
...
(declare-fun Tm_abs_80b9880b34580852d5d3c1900664c2a8 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_80b9880b34580852d5d3c1900664c2a8
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(165,30-165,35); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_80b9880b34580852d5d3c1900664c2a8 @x0)
Tm_arrow_35447810753695c4fe25c93af1251992)
 

:pattern ((Tm_abs_80b9880b34580852d5d3c1900664c2a8 @x0))
:qid typing_Tm_abs_80b9880b34580852d5d3c1900664c2a8))

:named typing_Tm_abs_80b9880b34580852d5d3c1900664c2a8))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_80b9880b34580852d5d3c1900664c2a8
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(165,30-165,35); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_80b9880b34580852d5d3c1900664c2a8 @x1)
@x0)
(Prims.op_Addition @x1
@x0))
 

:pattern ((ApplyTT (Tm_abs_80b9880b34580852d5d3c1900664c2a8 @x1)
@x0))
:qid interpretation_Tm_abs_80b9880b34580852d5d3c1900664c2a8))

:named interpretation_Tm_abs_80b9880b34580852d5d3c1900664c2a8))
...
FStar.DM4F.Heap.sel@tok))
:named @kick_partial_app_d834b872a040dce5727e5d43fb50b07c))

; Encoding query formula : forall (r: FStar.DM4F.Heap.ref Prims.int).
;   (forall (h0: FStar.DM4F.Heap.heap)
;       (s: FStar.DM4F.Heap.ref (_: Prims.int -> Prims.int))
;       (h1: FStar.DM4F.Heap.heap).
;       (*  - Could not prove post-condition
; *)
;       FStar.DM4F.Heap.contains_a_well_typed h0 r /\ ~(FStar.DM4F.Heap.contains h0 s) /\
;       FStar.DM4F.Heap.contains_a_well_typed h1 s ==>
;       Prims.hasEq Prims.nat) /\
;   (forall (_: FStar.DM4F.Heap.heap)
;       (p: Prims.pure_post (FStar.DM4F.Heap.ref (_: Prims.int -> Prims.int) & FStar.DM4F.Heap.heap)).
;       FStar.DM4F.Heap.contains_a_well_typed _ r /\
;       (forall (a: FStar.DM4F.Heap.ref (_: Prims.int -> Prims.int)) (n1: FStar.DM4F.Heap.heap).
;           FStar.DM4F.Heap.contains_a_well_typed _ r /\
;           FStar.DM4F.Heap.contains_a_well_typed _ r /\ ~(FStar.DM4F.Heap.contains _ a) /\
;           FStar.DM4F.Heap.contains_a_well_typed n1 a /\
;           FStar.DM4F.Heap.modifies (FStar.Set.singleton (FStar.DM4F.Heap.addr_of r)) _ n1 /\
;           (forall (y: Prims.int). FStar.DM4F.Heap.sel n1 a y = FStar.DM4F.Heap.sel _ r + y) ==>
;           p (a, n1)) ==>
;       FStar.DM4F.Heap.contains_a_well_typed _ r /\
;       (forall (a: Prims.int) (n1: FStar.DM4F.Heap.heap).
;           FStar.DM4F.Heap.contains_a_well_typed _ r /\
...
;           (forall (a: FStar.DM4F.Heap.ref (_: Prims.int -> Prims.int)) (n1: FStar.DM4F.Heap.heap).
;               ~(FStar.DM4F.Heap.contains n1 a) /\ FStar.DM4F.Heap.contains_a_well_typed n1 a /\
;               FStar.DM4F.Heap.sel n1 a == (fun y -> a + y) /\
;               FStar.DM4F.Heap.modifies FStar.Set.empty n1 n1 ==>
;               p (a, n1))))


; Context: While encoding a query
; While typechecking the top-level declaration `let alloc_addition_and_incr`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(forall ((@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x1
FStar.DM4F.Heap.heap)
(HasType @x2
(FStar.DM4F.Heap.ref Tm_arrow_35447810753695c4fe25c93af1251992))
(HasType @x3
FStar.DM4F.Heap.heap)

;; def=FStar.DM4F.Heap.ST.fsti(159,27-159,55); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(159,27-159,55); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x1
...
;; def=FStar.DM4F.Heap.ST.fsti(160,10-160,29); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(160,12-160,29); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(160,12-160,29); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(FStar.DM4F.Heap.contains Tm_arrow_35447810753695c4fe25c93af1251992
@x1
@x2)
)
)
...
;; def=FStar.DM4F.Heap.ST.fsti(161,10-161,38); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(161,10-161,38); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(FStar.DM4F.Heap.contains_a_well_typed Tm_arrow_35447810753695c4fe25c93af1251992
@x3
@x2)
)
)

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(162,10-162,18)
(or label_1

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(Valid 
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(Prims.hasEq Prims.nat)
)
...
FStar.DM4F.Heap.heap)
(HasType @x2
(Prims.pure_post (FStar.Pervasives.Native.tuple2 (FStar.DM4F.Heap.ref Tm_arrow_35447810753695c4fe25c93af1251992)
FStar.DM4F.Heap.heap)))

;; def=FStar.DM4F.Heap.ST.fsti(158,29-158,56); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(158,29-158,56); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x1
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
(FStar.DM4F.Heap.ref Tm_arrow_35447810753695c4fe25c93af1251992))
(HasType @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(162,10-162,52); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(162,10-162,52); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(FStar.DM4F.Heap.modifies (FStar.Set.singleton Prims.nat
(FStar.DM4F.Heap.addr_of Prims.int
...
;; def=FStar.DM4F.Heap.ST.fsti(163,10-163,47); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.int)

;; def=FStar.DM4F.Heap.ST.fsti(163,21-163,46); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT FStar.DM4F.Heap.sel@tok
Tm_arrow_35447810753695c4fe25c93af1251992)
@x4)
@x3)
@x5)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 (FStar.DM4F.Heap.ref Tm_arrow_35447810753695c4fe25c93af1251992)
FStar.DM4F.Heap.heap
@x3
@x4))
)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(164,14-164,15)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=FStar.DM4F.Heap.ST.fsti(164,14-164,15)
(or label_2
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(164,14-164,15)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
Prims.int)
(HasType @x4
...
;; def=FStar.DM4F.Heap.ST.fsti(89,3-89,11); use=FStar.DM4F.Heap.ST.fsti(164,14-164,15)
(= @x1
@x4)


;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(164,14-164,15)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(164,14-164,15)
(FStar.DM4F.Heap.contains_a_well_typed Prims.int
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(91,3-91,16); use=FStar.DM4F.Heap.ST.fsti(164,14-164,15)
(= (FStar.DM4F.Heap.sel Prims.int
@x4
@x0)
@x3)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(forall ((@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x5
(FStar.DM4F.Heap.ref Tm_arrow_35447810753695c4fe25c93af1251992))
(HasType @x6
...
;; def=FStar.DM4F.Heap.ST.fsti(66,4-66,23); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(66,6-66,23); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(66,6-66,23); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(FStar.DM4F.Heap.contains Tm_arrow_35447810753695c4fe25c93af1251992
@x4
...
;; def=FStar.DM4F.Heap.ST.fsti(67,3-67,31); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(67,3-67,31); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(FStar.DM4F.Heap.contains_a_well_typed Tm_arrow_35447810753695c4fe25c93af1251992
@x6
...
;; def=FStar.DM4F.Heap.ST.fsti(68,3-68,19); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(= (FStar.DM4F.Heap.sel Tm_arrow_35447810753695c4fe25c93af1251992
@x6
@x5)
(Tm_abs_80b9880b34580852d5d3c1900664c2a8 @x3))


;; def=FStar.DM4F.Heap.ST.fsti(69,3-69,27); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(69,3-69,27); use=FStar.DM4F.Heap.ST.fsti(165,14-165,19)
(FStar.DM4F.Heap.modifies (FStar.Set.empty Prims.nat)
@x4
...
;; def=FStar.DM4F.ST.fst(30,59-30,64); use=FStar.DM4F.Heap.ST.fsti(164,5-166,7)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.alloc_addition_and_incr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.DM4F.Heap.modifies, equation_Prims.eqtype, equation_Prims.nat, function_token_typing_FStar.DM4F.Heap.sel, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, interpretation_Tm_abs_80b9880b34580852d5d3c1900664c2a8, lemma_FStar.Set.mem_empty, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_FStar.DM4F.Heap.addr_of, typing_Prims.int
...
; encoding sigelt let alloc_addition_and_incr


; <Start encoding let alloc_addition_and_incr>

(declare-fun FStar.DM4F.Heap.ST.alloc_addition_and_incr (Term) Term)
(declare-fun Non_total_Tm_arrow_4767a9ee8c22f87eaacd115e2df3c8fd () Term)
(declare-fun FStar.DM4F.Heap.ST.alloc_addition_and_incr@tok () Term)
...
(declare-fun Tm_refine_7aaef3655a074f3b3c41c57270fca1dd (Term Term) Term)

;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap   -> Prims.PURE (FStar.DM4F.Heap.ref (_: Prims.int -> Prims.int) & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_bbe4acc70a9f32d2bb91d67a7b0bd9d6 (Term) Term)



(declare-fun Tm_abs_a54ee22de03ddfefb97e52d8c9d58d7b (Term) Term)


; </end encoding let alloc_addition_and_incr>
...
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.DM4F.Heap.ST.alloc_addition_and_incr; Namespace FStar.DM4F.Heap.ST
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.DM4F.Heap.sel@tok))
:named @kick_partial_app_d834b872a040dce5727e5d43fb50b07c))
(push) ;; push{2

; Starting query at FStar.DM4F.Heap.ST.fsti(178,1-184,17)

;;;;;;;;;;;;;;;;x : FStar.DM4F.Heap.ref Prims.nat (FStar.DM4F.Heap.ref Prims.nat)
(declare-fun x_663557961ece1f0c8a9fcd351089ff1a_0 () Term)
;;;;;;;;;;;;;;;;binder_x_663557961ece1f0c8a9fcd351089ff1a_0
;;; Fact-ids: 
(assert (! (HasType x_663557961ece1f0c8a9fcd351089ff1a_0
(FStar.DM4F.Heap.ref Prims.nat))
:named binder_x_663557961ece1f0c8a9fcd351089ff1a_0))
;;;;;;;;;;;;;;;;ghost_heap : ghost_heap: FStar.DM4F.Heap.heap{FStar.DM4F.Heap.contains_a_well_typed ghost_heap x} (ghost_heap: FStar.DM4F.Heap.heap{FStar.DM4F.Heap.contains_a_well_typed ghost_heap x})
(declare-fun x_10e2ff9b3a18131b534c510cf9f0afee_1 () Term)
(declare-fun Tm_refine_2780bedf233a79a98d593ce0ac8536fa () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_2780bedf233a79a98d593ce0ac8536fa
Tm_type)
:named refinement_kinding_Tm_refine_2780bedf233a79a98d593ce0ac8536fa))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,25-171,80); use=FStar.DM4F.Heap.ST.fsti(171,25-171,80)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_2780bedf233a79a98d593ce0ac8536fa)
(and (HasTypeFuel @u0
@x1
FStar.DM4F.Heap.heap)

;; def=FStar.DM4F.Heap.ST.fsti(171,42-171,78); use=FStar.DM4F.Heap.ST.fsti(171,42-171,78)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(171,42-171,78); use=FStar.DM4F.Heap.ST.fsti(171,42-171,78)
(FStar.DM4F.Heap.contains_a_well_typed Prims.nat
@x1
x_663557961ece1f0c8a9fcd351089ff1a_0)
)
))
...
@x1
Tm_refine_2780bedf233a79a98d593ce0ac8536fa))
:qid refinement_interpretation_Tm_refine_2780bedf233a79a98d593ce0ac8536fa))

:named refinement_interpretation_Tm_refine_2780bedf233a79a98d593ce0ac8536fa))
;;;;;;;;;;;;;;;;haseq for Tm_refine_2780bedf233a79a98d593ce0ac8536fa
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_2780bedf233a79a98d593ce0ac8536fa))
(Valid (Prims.hasEq FStar.DM4F.Heap.heap)))
:named haseqTm_refine_2780bedf233a79a98d593ce0ac8536fa))
;;;;;;;;;;;;;;;;binder_x_10e2ff9b3a18131b534c510cf9f0afee_1
;;; Fact-ids: 
(assert (! (HasType x_10e2ff9b3a18131b534c510cf9f0afee_1
Tm_refine_2780bedf233a79a98d593ce0ac8536fa)
:named binder_x_10e2ff9b3a18131b534c510cf9f0afee_1))
(declare-fun Tm_refine_e58d862e9f140433f8e7df2861d2003e (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,26-184,17); use=FStar.DM4F.Heap.ST.fsti(171,26-184,17)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_e58d862e9f140433f8e7df2861d2003e @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_e58d862e9f140433f8e7df2861d2003e @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_e58d862e9f140433f8e7df2861d2003e))

:named refinement_kinding_Tm_refine_e58d862e9f140433f8e7df2861d2003e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,26-184,17); use=FStar.DM4F.Heap.ST.fsti(171,26-184,17)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e58d862e9f140433f8e7df2861d2003e @x2))
(and (HasTypeFuel @u0
@x1
FStar.DM4F.Heap.heap)
...
;; def=FStar.DM4F.Heap.ST.fsti(178,1-184,17); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
...
Prims.nat
(FStar.DM4F.Heap.sel Prims.nat
@x1
@x2)
(FStar.DM4F.Heap.sel Prims.nat
x_10e2ff9b3a18131b534c510cf9f0afee_1
x_663557961ece1f0c8a9fcd351089ff1a_0))
)
...
@x1
(Tm_refine_e58d862e9f140433f8e7df2861d2003e @x2)))
:qid refinement_interpretation_Tm_refine_e58d862e9f140433f8e7df2861d2003e))

:named refinement_interpretation_Tm_refine_e58d862e9f140433f8e7df2861d2003e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e58d862e9f140433f8e7df2861d2003e
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,26-184,17); use=FStar.DM4F.Heap.ST.fsti(171,26-184,17)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e58d862e9f140433f8e7df2861d2003e @x0)))
(Valid (Prims.hasEq FStar.DM4F.Heap.heap)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e58d862e9f140433f8e7df2861d2003e @x0))))
:qid haseqTm_refine_e58d862e9f140433f8e7df2861d2003e))

:named haseqTm_refine_e58d862e9f140433f8e7df2861d2003e))
(declare-fun FStar.DM4F.Heap.ST.zero (Term Term) Term)

(declare-fun Non_total_Tm_arrow_6b0850a971882e909d0971aa66606650 (Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,16-184,17); use=FStar.DM4F.Heap.ST.fsti(171,16-184,17)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_refine_2780bedf233a79a98d593ce0ac8536fa)
(HasType @x1
(FStar.DM4F.Heap.ref Prims.nat)))
(HasType (Non_total_Tm_arrow_6b0850a971882e909d0971aa66606650 @x0
@x1)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_6b0850a971882e909d0971aa66606650 @x0
@x1)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_6b0850a971882e909d0971aa66606650))

:named non_total_function_typing_Non_total_Tm_arrow_6b0850a971882e909d0971aa66606650))
(declare-fun FStar.DM4F.Heap.ST.zero@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,8-171,12); use=FStar.DM4F.Heap.ST.fsti(171,8-171,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT FStar.DM4F.Heap.ST.zero@tok
@x0)
@x1)
(FStar.DM4F.Heap.ST.zero @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT FStar.DM4F.Heap.ST.zero@tok
@x0)
@x1))
:qid token_correspondence_FStar.DM4F.Heap.ST.zero))

:named token_correspondence_FStar.DM4F.Heap.ST.zero))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,8-171,12); use=FStar.DM4F.Heap.ST.fsti(171,8-171,12)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType FStar.DM4F.Heap.ST.zero@tok
(Non_total_Tm_arrow_6b0850a971882e909d0971aa66606650 x_10e2ff9b3a18131b534c510cf9f0afee_1
x_663557961ece1f0c8a9fcd351089ff1a_0)))
...
@x1)
@x2)
(FStar.DM4F.Heap.ST.zero @x1
@x2))
 

:pattern ((FStar.DM4F.Heap.ST.zero @x1
@x2))
:qid function_token_typing_FStar.DM4F.Heap.ST.zero.1))
)
 

:pattern ((ApplyTT @x0
FStar.DM4F.Heap.ST.zero@tok))
:qid function_token_typing_FStar.DM4F.Heap.ST.zero))

:named function_token_typing_FStar.DM4F.Heap.ST.zero))
(declare-fun Tm_refine_1b33fb9b38d193e84bcab3cd8340af10 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_1b33fb9b38d193e84bcab3cd8340af10 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_1b33fb9b38d193e84bcab3cd8340af10 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_1b33fb9b38d193e84bcab3cd8340af10))

:named refinement_kinding_Tm_refine_1b33fb9b38d193e84bcab3cd8340af10))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1b33fb9b38d193e84bcab3cd8340af10 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.ST.fst(27,34-27,41)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(172,2-172,4)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(173,22-173,37); use=FStar.DM4F.Heap.ST.fsti(173,22-173,37)
(= @x2
@x3)
...
;; def=FStar.DM4F.Heap.ST.fsti(174,27-174,55); use=FStar.DM4F.Heap.ST.fsti(174,27-174,55)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(174,27-174,55); use=FStar.DM4F.Heap.ST.fsti(174,27-174,55)
(FStar.DM4F.Heap.contains_a_well_typed Prims.nat
@x2
...
;; def=FStar.DM4F.Heap.ST.fsti(175,11-175,53); use=FStar.DM4F.Heap.ST.fsti(175,11-175,53)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(175,11-175,53); use=FStar.DM4F.Heap.ST.fsti(175,11-175,53)
(FStar.DM4F.Heap.modifies (FStar.Set.singleton Prims.nat
(FStar.DM4F.Heap.addr_of Prims.nat
@x4))
@x2
@x6)
)
...
;; def=FStar.DM4F.Heap.ST.fsti(176,10-176,22); use=FStar.DM4F.Heap.ST.fsti(176,10-176,22)
(= (FStar.DM4F.Heap.sel Prims.nat
@x6
@x4)
(BoxInt 0))
...
;;no pats
:qid refinement_interpretation_Tm_refine_1b33fb9b38d193e84bcab3cd8340af10.1))
)
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_1b33fb9b38d193e84bcab3cd8340af10))

:named refinement_interpretation_Tm_refine_1b33fb9b38d193e84bcab3cd8340af10))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1b33fb9b38d193e84bcab3cd8340af10
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.ST.fst(27,34-27,41)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1b33fb9b38d193e84bcab3cd8340af10 @x0
@x1
@x2)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Prims.unit
FStar.DM4F.Heap.heap))))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_1b33fb9b38d193e84bcab3cd8340af10 @x0
@x1
@x2))))
:qid haseqTm_refine_1b33fb9b38d193e84bcab3cd8340af10))

:named haseqTm_refine_1b33fb9b38d193e84bcab3cd8340af10))
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (Prims.unit & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_0dac90880e63e6afa31e701fdc405f91 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0dac90880e63e6afa31e701fdc405f91
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_0dac90880e63e6afa31e701fdc405f91 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_0dac90880e63e6afa31e701fdc405f91 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_0dac90880e63e6afa31e701fdc405f91))

:named kinding_Tm_arrow_0dac90880e63e6afa31e701fdc405f91))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_0dac90880e63e6afa31e701fdc405f91 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_0dac90880e63e6afa31e701fdc405f91 @x2
@x3)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_0dac90880e63e6afa31e701fdc405f91))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_0dac90880e63e6afa31e701fdc405f91))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0dac90880e63e6afa31e701fdc405f91
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_0dac90880e63e6afa31e701fdc405f91 @x1
@x2))
(and 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(Tm_refine_1b33fb9b38d193e84bcab3cd8340af10 @x3
@x2
@x1)))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_0dac90880e63e6afa31e701fdc405f91.1))
...
(Tm_arrow_0dac90880e63e6afa31e701fdc405f91 @x1
@x2)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_0dac90880e63e6afa31e701fdc405f91))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_0dac90880e63e6afa31e701fdc405f91))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,8-171,12); use=FStar.DM4F.Heap.ST.fsti(171,8-171,12)
...
(FStar.DM4F.Heap.ref Prims.nat))
(HasType @x1
(Tm_refine_e58d862e9f140433f8e7df2861d2003e @x0)))
(HasType (FStar.DM4F.Heap.ST.zero @x0
@x1)
(Tm_arrow_0dac90880e63e6afa31e701fdc405f91 @x0
@x1)))
 

:pattern ((FStar.DM4F.Heap.ST.zero @x0
@x1))
:qid typing_FStar.DM4F.Heap.ST.zero))

:named typing_FStar.DM4F.Heap.ST.zero))
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: Prims.unit & FStar.DM4F.Heap.heap -> Type
(declare-fun Tm_arrow_a02cf030b79811342f5c0dc23280485a () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a02cf030b79811342f5c0dc23280485a
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a02cf030b79811342f5c0dc23280485a
Tm_type)
:named kinding_Tm_arrow_a02cf030b79811342f5c0dc23280485a))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a02cf030b79811342f5c0dc23280485a)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a02cf030b79811342f5c0dc23280485a))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_a02cf030b79811342f5c0dc23280485a))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_a02cf030b79811342f5c0dc23280485a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a02cf030b79811342f5c0dc23280485a
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.ST.fst(27,34-27,41); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_a02cf030b79811342f5c0dc23280485a.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_a02cf030b79811342f5c0dc23280485a))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_a02cf030b79811342f5c0dc23280485a))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_a02cf030b79811342f5c0dc23280485a))

; Encoding query formula : (forall (h0: FStar.DM4F.Heap.heap) (_: Prims.unit) (h1: FStar.DM4F.Heap.heap).
;     (*  - Could not prove post-condition
; *)
;     FStar.DM4F.Heap.contains_a_well_typed h0 x ==> Prims.hasEq Prims.nat) /\
; (forall (_: FStar.DM4F.Heap.heap) (p: Prims.pure_post (Prims.unit & FStar.DM4F.Heap.heap)).
;     _ == ghost_heap /\
;     (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;         _ == ghost_heap /\
;         FStar.DM4F.Heap.contains_a_well_typed _ x /\
;         FStar.DM4F.Heap.modifies (FStar.Set.singleton (FStar.DM4F.Heap.addr_of x)) _ n1 /\
;         (FStar.DM4F.Heap.sel n1 x = 0) ==>
;         p (a, n1)) ==>
;     FStar.DM4F.Heap.contains_a_well_typed _ x /\
;     (forall (a: Prims.nat) (n1: FStar.DM4F.Heap.heap).
;         FStar.DM4F.Heap.contains_a_well_typed _ x /\
;         (_ == n1) /\ FStar.DM4F.Heap.contains_a_well_typed n1 x /\ (FStar.DM4F.Heap.sel n1 x == a) ==>
;         (forall (k: (_: Prims.unit & FStar.DM4F.Heap.heap -> Type0)).
;             (forall (a1: Prims.unit & FStar.DM4F.Heap.heap). {:pattern Prims.guard_free (k a1)}
;                 k a1 <==> p a1) ==>
;             (a = 0 = true ==>
;               a = 0 == true ==> (forall (any_result: Prims.unit). k (any_result, n1))) /\
;             (~(a = 0 = true) ==>
...
;                       return_val == a - 1 ==>
;                       FStar.DM4F.Heap.contains_a_well_typed n1 x /\
;                       (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;                           FStar.DM4F.Heap.contains_a_well_typed n1 x /\
;                           FStar.DM4F.Heap.contains_a_well_typed n1 x /\
;                           FStar.DM4F.Heap.contains_a_well_typed n1 x /\
;                           (n1 == FStar.DM4F.Heap.upd n1 x (a - 1)) ==>
;                           FStar.DM4F.Heap.contains_a_well_typed n1 x /\
;                           FStar.DM4F.Heap.sel n1 x << FStar.DM4F.Heap.sel ghost_heap x /\
;                           (forall (any_result: FStar.DM4F.Heap.heap).
;                               n1 == any_result ==>
;                               (forall (a: Prims.unit) (n1: FStar.DM4F.Heap.heap).
;                                   FStar.DM4F.Heap.contains_a_well_typed n1 x /\
;                                   FStar.DM4F.Heap.modifies (FStar.Set.singleton (FStar.DM4F.Heap.addr_of
;                                             x))
;                                     n1
;                                     n1 /\ FStar.DM4F.Heap.sel n1 x = 0 ==>
;                                   k (a, n1))
;                               <:
;                               Type0))))))))
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec zero`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
;; def=FStar.DM4F.Heap.ST.fsti(174,27-174,55); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(174,27-174,55); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(FStar.DM4F.Heap.contains_a_well_typed Prims.nat
@x0
...
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(175,11-175,19)
(or label_1

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(Valid 
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(Prims.hasEq Prims.nat)
)
...
;; def=FStar.DM4F.Heap.ST.fsti(173,22-173,37); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(= @x0
x_10e2ff9b3a18131b534c510cf9f0afee_1)


;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.unit)
(HasType @x3
...
;; def=FStar.DM4F.Heap.ST.fsti(175,11-175,53); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(175,11-175,53); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(FStar.DM4F.Heap.modifies (FStar.Set.singleton Prims.nat
(FStar.DM4F.Heap.addr_of Prims.nat
...
;; def=FStar.DM4F.Heap.ST.fsti(176,10-176,22); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(= (FStar.DM4F.Heap.sel Prims.nat
@x3
x_663557961ece1f0c8a9fcd351089ff1a_0)
(BoxInt 0))
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(ApplyTT @x1
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(179,12-179,13)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(87,27-87,54); use=FStar.DM4F.Heap.ST.fsti(179,12-179,13)
(or label_2
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(179,12-179,13)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.nat)
(HasType @x3
...
;; def=FStar.DM4F.Heap.ST.fsti(89,3-89,11); use=FStar.DM4F.Heap.ST.fsti(179,12-179,13)
(= @x0
@x3)


;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(179,12-179,13)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(90,17-90,45); use=FStar.DM4F.Heap.ST.fsti(179,12-179,13)
(FStar.DM4F.Heap.contains_a_well_typed Prims.nat
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(91,3-91,16); use=FStar.DM4F.Heap.ST.fsti(179,12-179,13)
(= (FStar.DM4F.Heap.sel Prims.nat
@x3
x_663557961ece1f0c8a9fcd351089ff1a_0)
@x2)
...
;; def=Prims.fst(221,62-221,85); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(and (implies 
;; def=Prims.fst(221,62-221,71); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(180,5-180,12); use=FStar.DM4F.Heap.ST.fsti(180,5-180,12)
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.unit)

;; def=FStar.DM4F.Heap.ST.fsti(45,93-45,101); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(or label_3
...
(implies 
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(not 
;; def=FStar.DM4F.Heap.ST.fsti(180,5-180,12); use=FStar.DM4F.Heap.ST.fsti(180,5-180,12)
(= (Prims.op_Equality Prims.int
@x2
...
;; def=FStar.DM4F.Heap.ST.fsti(180,5-184,17); use=FStar.DM4F.Heap.ST.fsti(180,5-184,17)
(= (Prims.op_Equality Prims.int
@x2
(BoxInt 0))
@x5)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(and 
;; def=Prims.fst(680,18-680,24); use=FStar.DM4F.Heap.ST.fsti(182,13-182,20)
(or label_4
...
;; def=Prims.fst(356,2-356,58); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(= @x6
(Prims.op_Subtraction @x2
(BoxInt 1)))
)

;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(182,10-182,12)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(106,24-106,51); use=FStar.DM4F.Heap.ST.fsti(182,10-182,12)
(or label_5
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(182,10-182,12)
(forall ((@x7 Term) (@x8 Term))
 (! (implies (and (HasType @x7
Prims.unit)
(HasType @x8
...
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=FStar.DM4F.Heap.ST.fsti(182,10-182,12)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(107,27-107,55); use=FStar.DM4F.Heap.ST.fsti(182,10-182,12)
(FStar.DM4F.Heap.contains_a_well_typed Prims.nat
@x3
...
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=FStar.DM4F.Heap.ST.fsti(182,10-182,12)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(108,18-108,46); use=FStar.DM4F.Heap.ST.fsti(182,10-182,12)
(FStar.DM4F.Heap.contains_a_well_typed Prims.nat
@x8
...
;; def=FStar.DM4F.Heap.ST.fsti(109,17-109,33); use=FStar.DM4F.Heap.ST.fsti(182,10-182,12)
(= @x8
(FStar.DM4F.Heap.upd Prims.nat
@x3
x_663557961ece1f0c8a9fcd351089ff1a_0
(Prims.op_Subtraction @x2
(BoxInt 1))))
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(171,42-171,78); use=FStar.DM4F.Heap.ST.fsti(184,15-184,16)
(or label_6
...
;; def=FStar.DM4F.Heap.ST.fsti(178,1-184,17); use=FStar.DM4F.Heap.ST.fsti(184,15-184,16)
(or label_7
...
;; def=FStar.DM4F.Heap.ST.fsti(171,26-183,13); use=FStar.DM4F.Heap.ST.fsti(178,1-184,17)
(= @x8
@x9)
)

;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(184,8-184,12)
...
;; def=FStar.DM4F.Heap.ST.fsti(174,27-174,55); use=FStar.DM4F.Heap.ST.fsti(184,8-184,12)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(174,27-174,55); use=FStar.DM4F.Heap.ST.fsti(184,8-184,12)
(FStar.DM4F.Heap.contains_a_well_typed Prims.nat
@x8
...
;; def=FStar.DM4F.Heap.ST.fsti(175,11-175,53); use=FStar.DM4F.Heap.ST.fsti(184,8-184,12)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(175,11-175,53); use=FStar.DM4F.Heap.ST.fsti(184,8-184,12)
(FStar.DM4F.Heap.modifies (FStar.Set.singleton Prims.nat
(FStar.DM4F.Heap.addr_of Prims.nat
...
;; def=FStar.DM4F.Heap.ST.fsti(176,10-176,22); use=FStar.DM4F.Heap.ST.fsti(184,8-184,12)
(= (FStar.DM4F.Heap.sel Prims.nat
@x11
x_663557961ece1f0c8a9fcd351089ff1a_0)
(BoxInt 0))
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(184,8-184,12)
(or label_8
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.zero, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_10e2ff9b3a18131b534c510cf9f0afee_1, binder_x_663557961ece1f0c8a9fcd351089ff1a_0, equation_FStar.DM4F.Heap.modifies, equation_Prims.eqtype, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, int_inversion, lemma_FStar.DM4F.Heap.sel_upd1, lemma_FStar.DM4F.Heap.sel_upd2, lemma_FStar.DM4F.Heap.upd_contains, lemma_FStar.DM4F.Heap.upd_contains_a_well_typed, lemma_FStar.Set.mem_singleton, primitive_Prims.op_Equality, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_2780bedf233a79a98d593ce0ac8536fa, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_FStar.DM4F.Heap.addr_of, typing_Prims.int, well-founded-ordering-on-nat
...
; Starting query at FStar.DM4F.Heap.ST.fsti(171,0-184,17)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,25-171,80); use=FStar.DM4F.Heap.ST.fsti(171,25-171,80)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2))

:named refinement_kinding_Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,25-171,80); use=FStar.DM4F.Heap.ST.fsti(171,25-171,80)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2 @x2))
(and (HasTypeFuel @u0
@x1
FStar.DM4F.Heap.heap)
...
@x1
(Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2 @x2)))
:qid refinement_interpretation_Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2))

:named refinement_interpretation_Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,25-171,80); use=FStar.DM4F.Heap.ST.fsti(171,25-171,80)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2 @x0)))
(Valid (Prims.hasEq FStar.DM4F.Heap.heap)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2 @x0))))
:qid haseqTm_refine_587ccbe34b291bb3a7b73dfef8612cc2))

:named haseqTm_refine_587ccbe34b291bb3a7b73dfef8612cc2))
(declare-fun Tm_refine_0860070befc535875a01775f62f56d9a (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,26-184,17); use=FStar.DM4F.Heap.ST.fsti(171,26-184,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_0860070befc535875a01775f62f56d9a @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_0860070befc535875a01775f62f56d9a @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_0860070befc535875a01775f62f56d9a))

:named refinement_kinding_Tm_refine_0860070befc535875a01775f62f56d9a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,26-184,17); use=FStar.DM4F.Heap.ST.fsti(171,26-184,17)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_0860070befc535875a01775f62f56d9a @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_0860070befc535875a01775f62f56d9a))

:named refinement_interpretation_Tm_refine_0860070befc535875a01775f62f56d9a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0860070befc535875a01775f62f56d9a
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(171,26-184,17); use=FStar.DM4F.Heap.ST.fsti(171,26-184,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_0860070befc535875a01775f62f56d9a @x0
@x1
@x2)))
(Valid (Prims.hasEq FStar.DM4F.Heap.heap)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_0860070befc535875a01775f62f56d9a @x0
@x1
@x2))))
:qid haseqTm_refine_0860070befc535875a01775f62f56d9a))

:named haseqTm_refine_0860070befc535875a01775f62f56d9a))

; Encoding query formula : forall (x: FStar.DM4F.Heap.ref Prims.nat)
;   (ghost_heap: FStar.DM4F.Heap.heap{FStar.DM4F.Heap.contains_a_well_typed ghost_heap x})
;   (x: FStar.DM4F.Heap.ref Prims.nat)
;   (ghost_heap:
;   (ghost_heap: FStar.DM4F.Heap.heap{FStar.DM4F.Heap.contains_a_well_typed ghost_heap x})
;     {FStar.DM4F.Heap.sel ghost_heap x << FStar.DM4F.Heap.sel ghost_heap x})
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(171,0-184,17)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (and (HasType @x0
(FStar.DM4F.Heap.ref Prims.nat))
(HasType @x1
(Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2 @x0))
(HasType @x2
(FStar.DM4F.Heap.ref Prims.nat))
(HasType @x3
(Tm_refine_0860070befc535875a01775f62f56d9a @x2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.zero, 2)
; STATUS: unsat
...
; encoding sigelt let rec zero


; <Start encoding let rec zero>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun FStar.DM4F.Heap.ST.zero.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun FStar.DM4F.Heap.ST.zero.fuel_instrumented_token () Term)
(declare-fun FStar.DM4F.Heap.ST.zero (Term Term) Term)
(declare-fun FStar.DM4F.Heap.ST.zero@tok () Term)
(declare-fun Tm_refine_587ccbe34b291bb3a7b73dfef8612cc2 (Term) Term)
(declare-fun Tm_abs_acae1532f63c257039675e9b5194364d (Term Term Fuel) Term)
(declare-fun Tm_abs_33ca3e15ccdbf81acba6953928f085d6 () Term)
(declare-fun Tm_refine_1b33fb9b38d193e84bcab3cd8340af10 (Term Term Term) Term)

(declare-fun Non_total_Tm_arrow_b7e02fc0f3f411e4005c27ea2088e3c9 () Term)
...
; </end encoding let rec zero>

(push) ;; push{2

; expect_failure

;;;;;;;;;;;;;;;;kinding_Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE_pre; Namespace FStar.DM4F.Heap.ST
(assert (! (HasType Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e
Tm_type)
:named kinding_Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE_pre; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e
;;; Fact-ids: Name FStar.DM4F.Heap.ST._dm4f_STATE_pre; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-35,25); use=FStar.DM4F.Heap.ST.fsti(35,21-35,25)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_8811cba5e653c8a7c9ccba4204c3433e))
(push) ;; push{3

; Starting query at FStar.DM4F.Heap.ST.fsti(197,3-205,20)
...
;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.Heap.heap -> Type
(declare-fun Tm_arrow_28f1c554156e6107f90c65675013e8c6 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_28f1c554156e6107f90c65675013e8c6
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-188,17); use=FStar.DM4F.Heap.ST.fsti(35,21-190,23)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_28f1c554156e6107f90c65675013e8c6 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_28f1c554156e6107f90c65675013e8c6 @x0)
Tm_type))
:qid kinding_Tm_arrow_28f1c554156e6107f90c65675013e8c6))

:named kinding_Tm_arrow_28f1c554156e6107f90c65675013e8c6))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-188,17); use=FStar.DM4F.Heap.ST.fsti(35,21-190,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_28f1c554156e6107f90c65675013e8c6 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_28f1c554156e6107f90c65675013e8c6 @x2)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_28f1c554156e6107f90c65675013e8c6))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_28f1c554156e6107f90c65675013e8c6))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_28f1c554156e6107f90c65675013e8c6
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-188,17); use=FStar.DM4F.Heap.ST.fsti(35,21-190,23)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_28f1c554156e6107f90c65675013e8c6 @x1))
(and 
;; def=FStar.DM4F.Heap.ST.fsti(35,21-188,17); use=FStar.DM4F.Heap.ST.fsti(35,21-190,23)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_28f1c554156e6107f90c65675013e8c6.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_28f1c554156e6107f90c65675013e8c6 @x1)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_28f1c554156e6107f90c65675013e8c6))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_28f1c554156e6107f90c65675013e8c6))
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> _: b -> _: FStar.DM4F.Heap.heap -> Type
(declare-fun Tm_arrow_0cf5234cb20e6503adce592d07ce6670 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0cf5234cb20e6503adce592d07ce6670
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(189,16-191,63); use=FStar.DM4F.Heap.ST.fsti(191,33-191,63)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_0cf5234cb20e6503adce592d07ce6670 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_0cf5234cb20e6503adce592d07ce6670 @x0)
Tm_type))
:qid kinding_Tm_arrow_0cf5234cb20e6503adce592d07ce6670))

:named kinding_Tm_arrow_0cf5234cb20e6503adce592d07ce6670))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(189,16-191,63); use=FStar.DM4F.Heap.ST.fsti(191,33-191,63)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_0cf5234cb20e6503adce592d07ce6670 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_0cf5234cb20e6503adce592d07ce6670 @x2)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_0cf5234cb20e6503adce592d07ce6670))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_0cf5234cb20e6503adce592d07ce6670))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0cf5234cb20e6503adce592d07ce6670
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(189,16-191,63); use=FStar.DM4F.Heap.ST.fsti(191,33-191,63)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_0cf5234cb20e6503adce592d07ce6670 @x1))
(and 
;; def=FStar.DM4F.Heap.ST.fsti(189,16-191,63); use=FStar.DM4F.Heap.ST.fsti(191,33-191,63)
(forall ((@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x2
...
@x3)
@x4))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_0cf5234cb20e6503adce592d07ce6670.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_0cf5234cb20e6503adce592d07ce6670.2))
...
@x2)
@x3))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_0cf5234cb20e6503adce592d07ce6670.3))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_0cf5234cb20e6503adce592d07ce6670 @x1)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_0cf5234cb20e6503adce592d07ce6670))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_0cf5234cb20e6503adce592d07ce6670))
;;;;;;;;;;;;;;;;_: a -> _: FStar.DM4F.Heap.heap -> _: b -> _: FStar.DM4F.Heap.heap -> Type
(declare-fun Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(188,16-191,63); use=FStar.DM4F.Heap.ST.fsti(191,23-191,63)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b))

:named kinding_Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(188,16-191,63); use=FStar.DM4F.Heap.ST.fsti(191,23-191,63)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b @x2
@x3)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(188,16-191,63); use=FStar.DM4F.Heap.ST.fsti(191,23-191,63)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b @x1
@x2))
(and 
;; def=FStar.DM4F.Heap.ST.fsti(188,16-191,63); use=FStar.DM4F.Heap.ST.fsti(191,23-191,63)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b.1))
...
(Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b @x1
@x2)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b))




(declare-fun Non_total_Tm_arrow_80f88f7ad08dea94fbc5de9602bb06c7 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(188,16-189,17); use=FStar.DM4F.Heap.ST.fsti(192,22-192,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type)
(HasType @x2
(Tm_arrow_28f1c554156e6107f90c65675013e8c6 @x0))
(HasType @x3
(Tm_arrow_108b4e4b71efd8651fd2b5bfd68c1d8b @x1
@x0)))
(HasType (Non_total_Tm_arrow_80f88f7ad08dea94fbc5de9602bb06c7 @x0
@x1
@x2
@x3)
Tm_type))
...
:pattern ((HasType (Non_total_Tm_arrow_80f88f7ad08dea94fbc5de9602bb06c7 @x0
@x1
@x2
@x3)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_80f88f7ad08dea94fbc5de9602bb06c7))

:named non_total_function_typing_Non_total_Tm_arrow_80f88f7ad08dea94fbc5de9602bb06c7))
(declare-fun Tm_refine_f86275f6447212ee4fea33ead133ca82 (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(198,13-198,23); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (HasType (Tm_refine_f86275f6447212ee4fea33ead133ca82 @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_f86275f6447212ee4fea33ead133ca82 @x0
@x1
@x2
@x3
@x4
@x5)
Tm_type))
:qid refinement_kinding_Tm_refine_f86275f6447212ee4fea33ead133ca82))

:named refinement_kinding_Tm_refine_f86275f6447212ee4fea33ead133ca82))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(198,13-198,23); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f86275f6447212ee4fea33ead133ca82 @x2
@x3
@x4
@x5
@x6
...
;; def=FStar.DM4F.Heap.ST.fsti(200,28-202,37); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(200,28-200,36); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(200,28-200,36); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(ApplyTT (ApplyTT @x2
@x3)
...
;; def=FStar.DM4F.Heap.ST.fsti(201,23-201,48); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(= (ApplyTT (ApplyTT @x5
@x3)
@x4)
...
;; def=FStar.DM4F.Heap.ST.fsti(202,23-202,37); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(202,23-202,37); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
...
@x6
@x7)))
:qid refinement_interpretation_Tm_refine_f86275f6447212ee4fea33ead133ca82))

:named refinement_interpretation_Tm_refine_f86275f6447212ee4fea33ead133ca82))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f86275f6447212ee4fea33ead133ca82
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(198,13-198,23); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f86275f6447212ee4fea33ead133ca82 @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_f86275f6447212ee4fea33ead133ca82 @x0
@x1
@x2
@x3
@x4
@x5))))
:qid haseqTm_refine_f86275f6447212ee4fea33ead133ca82))

:named haseqTm_refine_f86275f6447212ee4fea33ead133ca82))
;;;;;;;;;;;;;;;;h0: FStar.DM4F.Heap.heap -> Prims.Pure (b & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934 (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(197,14-198,23); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934 @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934 @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid kinding_Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934))

:named kinding_Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(197,14-198,23); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934 @x2
@x3
@x4
@x5
@x6))
...
@x5
@x6)))
:qid FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934))

:named FStar.DM4F.Heap.ST_pre_typing_Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(197,14-198,23); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934 @x1
@x2
@x3
@x4
@x5))
...
(forall ((@x6 Term))
 (! (implies (and 
;; def=FStar.DM4F.Heap.ST.fsti(199,13-199,23); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(199,13-199,23); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(ApplyTT (ApplyTT @x5
@x4)
...
(HasType (ApplyTT @x0
@x6)
(Tm_refine_f86275f6447212ee4fea33ead133ca82 @x5
@x4
@x6
@x3
@x2
...
:pattern ((ApplyTT @x0
@x6))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934.1))
...
@x4
@x5)))
:qid FStar.DM4F.Heap.ST_interpretation_Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934))

:named FStar.DM4F.Heap.ST_interpretation_Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934))
(declare-fun Tm_abs_41f04820feae0b7c93ac89ca5e093d9f (Term Term) Term)
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_41f04820feae0b7c93ac89ca5e093d9f
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(203,8-203,22); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (Tm_abs_41f04820feae0b7c93ac89ca5e093d9f @x0
@x1))
 

:pattern ((Tm_abs_41f04820feae0b7c93ac89ca5e093d9f @x0
@x1))
:qid tot_fun_Tm_abs_41f04820feae0b7c93ac89ca5e093d9f))

:named tot_fun_Tm_abs_41f04820feae0b7c93ac89ca5e093d9f))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_41f04820feae0b7c93ac89ca5e093d9f
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(203,8-203,22); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_41f04820feae0b7c93ac89ca5e093d9f @x1
@x2)
@x0)
(ApplyTT (ApplyTT @x2
@x1)
...
:pattern ((ApplyTT (Tm_abs_41f04820feae0b7c93ac89ca5e093d9f @x1
@x2)
@x0))
:qid interpretation_Tm_abs_41f04820feae0b7c93ac89ca5e093d9f))

:named interpretation_Tm_abs_41f04820feae0b7c93ac89ca5e093d9f))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (pre: (_: a -> _: FStar.DM4F.Heap.heap -> Type))
;   (post: (_: a -> _: FStar.DM4F.Heap.heap -> _: b -> _: FStar.DM4F.Heap.heap -> Type))
;   (f: (x: a -> FStar.DM4F.Heap.ST.ST b))
;   (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (_: FStar.DM4F.Heap.heap) (p: Prims.pure_post (b & FStar.DM4F.Heap.heap)).
;     pre x _ /\
;     (forall (a: b) (n1: FStar.DM4F.Heap.heap).
;         pre x _ /\ pre x _ /\ (reify (f x) _ == (a, n1)) /\ post x _ a n1 ==> p (a, n1)) ==>
;     (forall (h0: FStar.DM4F.Heap.heap).
;         (forall (p: Prims.pure_post (b & FStar.DM4F.Heap.heap)).
;             pre x h0 /\
;             (forall (pure_result: b & FStar.DM4F.Heap.heap).
...
;                 (a, n1) == reify (f x) h0 ==>
;                 (forall (return_val: b & FStar.DM4F.Heap.heap).
;                     return_val == (a, n1) ==> p return_val))) /\
;         (forall (p: Prims.pure_post (b & FStar.DM4F.Heap.heap)).
;             pre x h0 /\
;             (forall (pure_result: b & FStar.DM4F.Heap.heap).
;                 (let z, h1 = pure_result in
...
;     (forall (any_result: (h0: FStar.DM4F.Heap.heap -> Prims.Pure (b & FStar.DM4F.Heap.heap))).
;         (fun h0 -> reify (f x) h0 <: Prims.Pure (b & FStar.DM4F.Heap.heap)) == any_result ==>
;         pre x _ /\
;         (forall (pure_result: b & FStar.DM4F.Heap.heap).
;             (let z, h1 = pure_result in
...
@x0))
(HasType @x4
(Non_total_Tm_arrow_80f88f7ad08dea94fbc5de9602bb06c7 @x0
@x1
@x2
@x3))
(HasType @x5
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
FStar.DM4F.Heap.heap)
(HasType @x7
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,34); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,34); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,52-51,58); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,52-51,58); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=FStar.DM4F.Heap.ST.fsti(194,33-194,41); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(194,33-194,41); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=FStar.DM4F.Heap.ST.fsti(195,30-195,55); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(= (ApplyTT (ApplyTT @x4
@x5)
@x6)
(FStar.Pervasives.Native.Mktuple2 @x1
...
;; def=FStar.DM4F.Heap.ST.fsti(196,30-196,44); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(196,30-196,44); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,79-51,88); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(ApplyTT @x7
(FStar.Pervasives.Native.Mktuple2 @x1
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@x8 Term))
 (! (implies (HasType @x8
...
;; def=Prims.fst(406,51-406,91); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(and 
;; def=Prims.fst(406,51-406,91); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
...
;; def=FStar.DM4F.Heap.ST.fsti(199,13-199,23); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(199,13-199,23); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(forall ((@x10 Term))
...
;; def=FStar.DM4F.Heap.ST.fsti(200,28-202,37); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(200,28-200,36); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(or label_2
...
;; def=FStar.DM4F.Heap.ST.fsti(201,23-201,48); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(or label_3
...
;; def=FStar.DM4F.Heap.ST.fsti(202,23-202,37); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(or label_4
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(ApplyTT @x9
@x10)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,89); use=FStar.DM4F.Heap.ST.fsti(203,15-203,16)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(51,28-51,34); use=FStar.DM4F.Heap.ST.fsti(203,15-203,16)
(or label_5
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fsti(203,15-203,16)
(forall ((@x10 Term) (@x11 Term))
 (! (implies (and (HasType @x10
@x1)
(HasType @x11
...
;; def=FStar.DM4F.Heap.ST.fsti(51,52-51,58); use=FStar.DM4F.Heap.ST.fsti(203,15-203,16)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,52-51,58); use=FStar.DM4F.Heap.ST.fsti(203,15-203,16)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,62-51,74); use=FStar.DM4F.Heap.ST.fsti(203,15-203,16)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,62-51,74); use=FStar.DM4F.Heap.ST.fsti(203,15-203,16)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT @x3
@x5)
...
;; def=FStar.DM4F.Heap.ST.fsti(198,13-203,22); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(= (FStar.Pervasives.Native.Mktuple2 @x1
FStar.DM4F.Heap.heap
@x10
@x11)
...
;; def=Prims.fst(356,2-356,58); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
(FStar.Pervasives.Native.tuple2 @x1
FStar.DM4F.Heap.heap))

;; def=Prims.fst(356,26-356,41); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(= @x12
(FStar.Pervasives.Native.Mktuple2 @x1
FStar.DM4F.Heap.heap
@x10
...
;; def=Prims.fst(356,46-356,58); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(Valid 
;; def=Prims.fst(356,46-356,58); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(ApplyTT @x9
@x12)
...
;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(199,13-199,23); use=FStar.DM4F.Heap.ST.fsti(203,8-203,22)
(or label_10
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.ST.fsti(197,3-205,20)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Tm_arrow_5f1c6e8b248af4aa3e8dc9eedaac5934 @x3
@x1
@x4
@x5
@x2))

;; def=FStar.DM4F.Heap.ST.fsti(197,8-203,22); use=FStar.DM4F.Heap.ST.fsti(197,8-203,22)
(= (Tm_abs_41f04820feae0b7c93ac89ca5e093d9f @x5
@x4)
@x8)
)

;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.Heap.ST.fsti(205,19-205,20)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(199,13-199,23); use=FStar.DM4F.Heap.ST.fsti(205,19-205,20)
(or label_11
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Heap.ST.fsti(205,19-205,20)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(FStar.Pervasives.Native.tuple2 @x1
FStar.DM4F.Heap.heap))
...
;; def=FStar.DM4F.Heap.ST.fsti(200,28-202,37); use=FStar.DM4F.Heap.ST.fsti(205,19-205,20)
(and 
;; def=FStar.DM4F.Heap.ST.fsti(200,28-200,36); use=FStar.DM4F.Heap.ST.fsti(205,19-205,20)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(200,28-200,36); use=FStar.DM4F.Heap.ST.fsti(205,19-205,20)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=FStar.DM4F.Heap.ST.fsti(201,23-201,48); use=FStar.DM4F.Heap.ST.fsti(205,19-205,20)
(= (ApplyTT (ApplyTT @x4
@x5)
@x6)
(FStar.Pervasives.Native.Mktuple2 @x1
...
;; def=FStar.DM4F.Heap.ST.fsti(202,23-202,37); use=FStar.DM4F.Heap.ST.fsti(205,19-205,20)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(202,23-202,37); use=FStar.DM4F.Heap.ST.fsti(205,19-205,20)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT @x3
@x5)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.ST.fsti(205,19-205,20)
(or label_12
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.refine_st, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_FStar.Pervasives.Native.Mktuple2, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
; encoding sigelt val FStar.DM4F.Heap.ST.refine_st


; <Skipped val FStar.DM4F.Heap.ST.refine_st/>


; encoding sigelt let refine_st


; <Start encoding let refine_st>
...
(declare-fun Non_total_Tm_arrow_80f88f7ad08dea94fbc5de9602bb06c7 (Term Term Term Term) Term)
(declare-fun FStar.DM4F.Heap.ST.refine_st (Term Term Term Term Term Term) Term)
(declare-fun Non_total_Tm_arrow_71508d50b448063d8e1ffe4121d05b7f () Term)
(declare-fun FStar.DM4F.Heap.ST.refine_st@tok () Term)
(declare-fun Tm_refine_7b263249828693ef986f0e5ce086d4bb (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.DM4F.Heap.heap -> Prims.PURE (b & FStar.DM4F.Heap.heap)
(declare-fun Tm_arrow_26ad65047e5c3539cc78b66891280991 (Term Term Term Term Term) Term)
...
(declare-fun Non_total_Tm_arrow_21326acaa56eaba383872601b256c061 (Term) Term)

; </end encoding let refine_st>


; encoding sigelt val FStar.DM4F.Heap.ST.runST


; <Skipped val FStar.DM4F.Heap.ST.runST/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.Heap.emp; Namespace FStar.DM4F.Heap
(assert (! 
;; def=FStar.DM4F.Heap.fsti(104,4-104,7); use=FStar.DM4F.Heap.fsti(104,4-104,7)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0cf5234cb20e6503adce592d07ce6670
;;; Fact-ids: Name FStar.DM4F.Heap.ST.refine_st; Namespace FStar.DM4F.Heap.ST
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(209,16-211,63); use=FStar.DM4F.Heap.ST.fst(29,4-29,13)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_0cf5234cb20e6503adce592d07ce6670 @x0)
Tm_type)
...
; Starting query at FStar.DM4F.Heap.ST.fst(30,23-30,61)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)


(declare-fun Non_total_Tm_arrow_df1699a2dbbc33d1a6b124bc5f21fd07 (Term Term) Term)
;;;;;;;;;;;;;;;;Typing for non-total arrows
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.Heap.ST.fsti(241,3-241,7); use=FStar.DM4F.Heap.ST.fst(30,4-30,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Tm_arrow_0cf5234cb20e6503adce592d07ce6670 @x0)))
(HasType (Non_total_Tm_arrow_df1699a2dbbc33d1a6b124bc5f21fd07 @x0
@x1)
Tm_type))
 

:pattern ((HasType (Non_total_Tm_arrow_df1699a2dbbc33d1a6b124bc5f21fd07 @x0
@x1)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_df1699a2dbbc33d1a6b124bc5f21fd07))

:named non_total_function_typing_Non_total_Tm_arrow_df1699a2dbbc33d1a6b124bc5f21fd07))

; Encoding query formula : forall (a: Type)
;   (post: (_: FStar.DM4F.Heap.heap -> _: a -> _: FStar.DM4F.Heap.heap -> Type))
;   (s: (_: Prims.unit -> FStar.DM4F.Heap.ST.ST a)).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post a).
;     (forall (pure_result: a).
;         (exists (h0: FStar.DM4F.Heap.heap) (h1: FStar.DM4F.Heap.heap). post h0 pure_result h1) ==>
;         p pure_result) ==>
;     (forall (a: a) (n1: FStar.DM4F.Heap.heap).
;         post FStar.DM4F.Heap.emp a n1 ==>
;         reify (s ()) FStar.DM4F.Heap.emp == (a, n1) ==>
;         (forall (any_result: a).
;             any_result == FStar.Pervasives.Native.fst (reify (s ()) FStar.DM4F.Heap.emp) ==>
;             (forall (return_val: a). return_val == any_result ==> p return_val)))


; Context: While encoding a query
; While typechecking the top-level declaration `let runST`
...
(Tm_arrow_0cf5234cb20e6503adce592d07ce6670 @x0))
(HasType @x2
(Non_total_Tm_arrow_df1699a2dbbc33d1a6b124bc5f21fd07 @x0
@x1)))
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.Heap.ST.fst(30,23-30,61)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
@x0))

;; def=FStar.DM4F.Heap.ST.fsti(244,23-244,49); use=FStar.DM4F.Heap.ST.fst(30,23-30,61)
(or label_2
...
;; def=FStar.DM4F.Heap.ST.fsti(244,37-244,49); use=FStar.DM4F.Heap.ST.fst(30,23-30,61)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(244,37-244,49); use=FStar.DM4F.Heap.ST.fst(30,23-30,61)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.ST.fst(30,23-30,61)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.Heap.ST.fst(30,23-30,61)
(ApplyTT @x3
@x4)
...
;; def=FStar.DM4F.Heap.ST.fsti(51,38-51,89); use=FStar.DM4F.Heap.ST.fst(30,35-30,36)
(forall ((@x4 Term) (@x5 Term))
 (! (implies (and (HasType @x4
@x0)
(HasType @x5
...
;; def=FStar.DM4F.Heap.ST.fsti(51,62-51,74); use=FStar.DM4F.Heap.ST.fst(30,35-30,36)
(Valid 
;; def=FStar.DM4F.Heap.ST.fsti(51,62-51,74); use=FStar.DM4F.Heap.ST.fst(30,35-30,36)
(ApplyTT (ApplyTT (ApplyTT @x1
...
;; def=FStar.Pervasives.Native.fst(62,9-62,10); use=FStar.DM4F.Heap.ST.fst(30,23-30,61)
(= (ApplyTT (ApplyTT @x2
Tm_unit)
(FStar.DM4F.Heap.emp Dummy_value))
(FStar.Pervasives.Native.Mktuple2 @x0
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.Heap.ST.fst(30,23-30,61)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
@x0)

;; def=FStar.DM4F.Heap.ST.fst(30,11-30,61); use=FStar.DM4F.Heap.ST.fst(30,23-30,61)
(= @x6
(FStar.Pervasives.Native.fst @x0
FStar.DM4F.Heap.heap
(ApplyTT (ApplyTT @x2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Heap.ST.runST, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.Pervasives.Native.fst, proj_equation_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, typing_FStar.DM4F.Heap.emp
