...
; Internals for FStar.DM4F.StExn
...
(declare-fun FStar.DM4F.StExn.stexn (Term) Term)

(declare-fun FStar.DM4F.StExn.stexn@tok () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.M (FStar.Pervasives.Native.option a & Prims.int)
(declare-fun Tm_arrow_0e9d2ce21210024c64d270958ff1fc12 (Term) Term)

; </end encoding let stexn>


; encoding sigelt val FStar.DM4F.StExn.return


; <Skipped val FStar.DM4F.StExn.return/>
...
(declare-fun FStar.DM4F.StExn.return (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> stexn a
(declare-fun Tm_arrow_3ed5e07cd5cb807d083217fa409d0adc () Term)
(declare-fun FStar.DM4F.StExn.return@tok () Term)
(declare-fun Tm_abs_aa5749614eba92324bb2e16e3f99d1ea (Term Term) Term)

; </end encoding let return>


; encoding sigelt val FStar.DM4F.StExn.bind


; <Skipped val FStar.DM4F.StExn.bind/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.StExn.stexn; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(26,4-26,9); use=FStar.DM4F.StExn.fst(26,4-26,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (FStar.DM4F.StExn.stexn @x0)
Tm_type))
 

:pattern ((FStar.DM4F.StExn.stexn @x0))
:qid typing_FStar.DM4F.StExn.stexn))

:named typing_FStar.DM4F.StExn.stexn))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0e9d2ce21210024c64d270958ff1fc12
;;; Fact-ids: Name FStar.DM4F.StExn.stexn; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,2-27,27); use=FStar.DM4F.StExn.fst(27,2-27,27)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_0e9d2ce21210024c64d270958ff1fc12 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_0e9d2ce21210024c64d270958ff1fc12 @x0)
Tm_type))
:qid kinding_Tm_arrow_0e9d2ce21210024c64d270958ff1fc12))

:named kinding_Tm_arrow_0e9d2ce21210024c64d270958ff1fc12))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.StExn.stexn
;;; Fact-ids: Name FStar.DM4F.StExn.stexn; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(26,4-26,9); use=FStar.DM4F.StExn.fst(26,4-26,9)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.StExn.stexn @x0)
(Tm_arrow_0e9d2ce21210024c64d270958ff1fc12 @x0))
 

:pattern ((FStar.DM4F.StExn.stexn @x0))
:qid equation_FStar.DM4F.StExn.stexn))

:named equation_FStar.DM4F.StExn.stexn))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_0e9d2ce21210024c64d270958ff1fc12 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_0e9d2ce21210024c64d270958ff1fc12 @x2)))
:qid FStar.DM4F.StExn_pre_typing_Tm_arrow_0e9d2ce21210024c64d270958ff1fc12))

:named FStar.DM4F.StExn_pre_typing_Tm_arrow_0e9d2ce21210024c64d270958ff1fc12))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0e9d2ce21210024c64d270958ff1fc12
;;; Fact-ids: Name FStar.DM4F.StExn.stexn; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,2-27,27); use=FStar.DM4F.StExn.fst(27,2-27,27)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_0e9d2ce21210024c64d270958ff1fc12 @x1))
(and 
;; def=FStar.DM4F.StExn.fst(27,2-27,27); use=FStar.DM4F.StExn.fst(27,2-27,27)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_0e9d2ce21210024c64d270958ff1fc12.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_0e9d2ce21210024c64d270958ff1fc12 @x1)))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_0e9d2ce21210024c64d270958ff1fc12))

:named FStar.DM4F.StExn_interpretation_Tm_arrow_0e9d2ce21210024c64d270958ff1fc12))
(push) ;; push{2

; Starting query at FStar.DM4F.StExn.fst(36,11-40,42)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;g: a -> stexn b
(declare-fun Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExn.fst(34,34-35,10); use=FStar.DM4F.StExn.fst(35,4-35,10)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3))

:named kinding_Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExn.fst(34,34-35,10); use=FStar.DM4F.StExn.fst(35,4-35,10)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3 @x2
@x3)))
:qid FStar.DM4F.StExn_pre_typing_Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3))

:named FStar.DM4F.StExn_pre_typing_Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExn.fst(34,34-35,10); use=FStar.DM4F.StExn.fst(35,4-35,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3 @x1
@x2))
(and 
;; def=FStar.DM4F.StExn.fst(34,34-35,10); use=FStar.DM4F.StExn.fst(35,4-35,10)
(forall ((@x3 Term))
...
(HasType (ApplyTT @x0
@x3)
(FStar.DM4F.StExn.stexn @x1)))
 

:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3.1))
...
(Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3 @x1
@x2)))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3))

:named FStar.DM4F.StExn_interpretation_Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (f: FStar.DM4F.StExn.stexn a)
;   (g: (g: a -> FStar.DM4F.StExn.stexn b))
;   (s0: Prims.int).
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.StExn.fst(36,11-40,42)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExn.fst(36,11-40,42)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExn.fst(36,11-40,42)
(ApplyTT @x5
@x6)
...
;; def=FStar.DM4F.StExn.fst(39,6-39,19); use=FStar.DM4F.StExn.fst(39,6-39,19)
(not 
;; def=FStar.DM4F.StExn.fst(39,6-39,19); use=FStar.DM4F.StExn.fst(39,6-39,19)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None @x0
...
;; def=FStar.DM4F.StExn.fst(40,6-40,24); use=FStar.DM4F.StExn.fst(40,6-40,24)
(not 
;; def=FStar.DM4F.StExn.fst(40,6-40,24); use=FStar.DM4F.StExn.fst(40,6-40,24)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some @x0
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (FStar.Pervasives.Native.option @x0)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.StExn.bind, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.StExn_interpretation_Tm_arrow_0e9d2ce21210024c64d270958ff1fc12, equation_FStar.DM4F.StExn.stexn, equation_Prims.eqtype, int_inversion, kinding_FStar.Pervasives.Native.option@tok, lemma_FStar.Pervasives.invertOption, proj_equation_FStar.Pervasives.Native.Mktuple2__1, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.Pervasives.Native.__proj__Mktuple2__item___1, typing_Prims.int
...
;;;;;;;;;;;;;;;;g: a -> stexn b
(declare-fun Tm_arrow_4efb2624e1b6df0240c5c5d133754bb3 (Term Term) Term)
(declare-fun FStar.DM4F.StExn.bind (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> f: stexn a -> g: (g: a -> stexn b) -> stexn b
(declare-fun Tm_arrow_14f79ec6faff9ef91a28617f1efcb67f () Term)
(declare-fun FStar.DM4F.StExn.bind@tok () Term)

(declare-fun Tm_abs_a0887db6fa4c6af0dcd5a962e7be0767 (Term Term Term) Term)
...
(declare-fun FStar.DM4F.StExn.get (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> stexn Prims.int
(declare-fun Tm_arrow_8a1e1f99ee8039032f3c39571da41294 () Term)
(declare-fun FStar.DM4F.StExn.get@tok () Term)
(declare-fun Tm_abs_4c4759074d905ee2b73c62b4adb79872 () Term)
...
(declare-fun FStar.DM4F.StExn.put (Term) Term)
;;;;;;;;;;;;;;;;s: Prims.int -> stexn Prims.unit
(declare-fun Tm_arrow_a38caafb21c2a8435ab231098d9699a6 () Term)
(declare-fun FStar.DM4F.StExn.put@tok () Term)
(declare-fun Tm_abs_811ac8ac931b14e2af6de7761ad6189f (Term) Term)
...
(declare-fun FStar.DM4F.StExn.raise (Term) Term)
;;;;;;;;;;;;;;;;a: Type -> stexn a
(declare-fun Tm_arrow_96e2df567c3f0df3b10adfd0eb7edbcc () Term)
(declare-fun FStar.DM4F.StExn.raise@tok () Term)
(declare-fun Tm_abs_ebc7050a89f55643c1693d4ce5ac7848 (Term) Term)

; </end encoding let raise>


; encoding sigelt let _dm4f_STEXN_lift_from_pure


; <Start encoding let _dm4f_STEXN_lift_from_pure>


;;;;;;;;;;;;;;;;_: (_: a -> Type) -> Type
(declare-fun Tm_arrow_11b93b1a25b26195b88e72dd87199600 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option a & Prims.int -> Type
(declare-fun Tm_arrow_510ff22d71f1d013d3b8f37f868d3df1 (Term) Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type ->     wp: (_: (_: a -> Type) -> Type) ->     s: Prims.int ->     p': (_: FStar.Pervasives.Native.option a & Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_b80b9fa2d70d245eabc85cbac8bd240f () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_lift_from_pure@tok () Term)




(declare-fun Tm_abs_d13b711bbde8206f4cbc136c8f1c3ce5 (Term Term Term) Term)

; </end encoding let _dm4f_STEXN_lift_from_pure>


; encoding sigelt let _dm4f_STEXN_return_wp


; <Start encoding let _dm4f_STEXN_return_wp>


(declare-fun FStar.DM4F.StExn._dm4f_STEXN_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> s: Prims.int -> p': (_: FStar.Pervasives.Native.option a & Prims.int -> Type)   -> Type
(declare-fun Tm_arrow_03d197b37e4d66ededd3f2c9cbcb5964 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_return_wp@tok () Term)


; </end encoding let _dm4f_STEXN_return_wp>


; encoding sigelt let _dm4f_STEXN_return_elab


; <Start encoding let _dm4f_STEXN_return_elab>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_return_elab (Term Term Term) Term)
(declare-fun Tm_refine_1cdc777767b7969ce25e65a1655d63c5 (Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> s: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option a & Prims.int)
(declare-fun Tm_arrow_7e5e0605e08dd816062e0c98fcca034e () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_return_elab@tok () Term)


; </end encoding let _dm4f_STEXN_return_elab>


; encoding sigelt let _dm4f_STEXN_bind_wp


; <Start encoding let _dm4f_STEXN_bind_wp>


;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & Prims.int -> Type) -> Type
(declare-fun Tm_arrow_358c2e76809ab93b0b067d6f261b15b1 (Term) Term)


;;;;;;;;;;;;;;;;g: a -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option b & Prims.int -> Type) -> Type
(declare-fun Tm_arrow_094feb510b91ece7a90e81fd723390d1 (Term Term) Term)

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_bind_wp (Term Term Term Term Term Term) Term)
...
(declare-fun Tm_arrow_703f71ba70190f6111f32ce4f6293272 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_bind_wp@tok () Term)
...
(declare-fun Tm_abs_b56f67ffbe67c10f87d9ec5a581d2f2f (Term Term Term Term) Term)

; </end encoding let _dm4f_STEXN_bind_wp>


; encoding sigelt let _dm4f_STEXN_bind_elab


; <Start encoding let _dm4f_STEXN_bind_elab>



(declare-fun Tm_refine_c0677d78255cd573cb803afaac433136 (Term) Term)

;;;;;;;;;;;;;;;;y: _: (FStar.Pervasives.Native.option a & Prims.int){Prims.l_True} -> Prims.GTot Type
(declare-fun Tm_arrow_1953bedfed79669e4de57615c2d259bf (Term) Term)
(declare-fun Tm_abs_26568f6a798448ae3d0e529d5dcad710 (Term Term) Term)
(declare-fun Tm_refine_2527ea687b621c4fe8d0fba47c2d0492 (Term Term Term) Term)



(declare-fun Tm_abs_3953b5bbbda7e87ff1bbb6dc39f02622 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option a & Prims.int)
(declare-fun Tm_arrow_e7a06ceb5ddc809133bb4e2ce5166f6e (Term Term) Term)
...
(declare-fun Tm_refine_230a3cdc0907a5509d7204ae574c0199 (Term Term Term Term) Term)




;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option b & Prims.int)
(declare-fun Tm_arrow_8c9e95f0e83674efb1a5ff54036fb57b (Term Term Term) Term)
;;;;;;;;;;;;;;;;g__x: a -> _: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option b & Prims.int)
(declare-fun Tm_arrow_6245db9085cb2fb5133cf468fc231347 (Term Term Term) Term)





(declare-fun Tm_abs_c8e4fb37c7d927b5a52e840bb992b43d (Term Term Term) Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_bind_elab (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_9c0a980e424b5c1b75a8583867f794aa (Term Term Term Term) Term)
(declare-fun Tm_refine_485bf11eeafe372fcfbe98063aafdc87 (Term Term Term Term Term) Term)
...
(declare-fun Tm_arrow_f99a67066fddf87dcf5036be2ca84809 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_bind_elab@tok () Term)
...
; </end encoding let _dm4f_STEXN_bind_elab>


; encoding sigelt let _dm4f_STEXN___proj__STEXN__item__get_elab


; <Start encoding let _dm4f_STEXN___proj__STEXN__item__get_elab>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__get_elab (Term) Term)
(declare-fun Tm_refine_9ad8ebfa3c48724a867b653ead7e8fb9 (Term) Term)
;;;;;;;;;;;;;;;;s0__x: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option Prims.int & Prims.int)
(declare-fun Tm_arrow_f02e72cc89eebc648aaca06d1a809741 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> s0__x: Prims.int   -> Prims.PURE (FStar.Pervasives.Native.option Prims.int & Prims.int)
(declare-fun Tm_arrow_7a2e42a85af26296ff75f819b92e3477 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__get_elab@tok () Term)




; </end encoding let _dm4f_STEXN___proj__STEXN__item__get_elab>


; encoding sigelt let _dm4f_STEXN___proj__STEXN__item__get_complete_type


; <Start encoding let _dm4f_STEXN___proj__STEXN__item__get_complete_type>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__get_complete_type () Term)




; </end encoding let _dm4f_STEXN___proj__STEXN__item__get_complete_type>


; encoding sigelt let _dm4f_STEXN___proj__STEXN__item__put_elab


; <Start encoding let _dm4f_STEXN___proj__STEXN__item__put_elab>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__put_elab (Term) Term)
(declare-fun Tm_refine_66472af37425c105dbcaaf37c041a705 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option Prims.unit & Prims.int)
(declare-fun Tm_arrow_1a0e0e8cf3a800ff16f47d63dd036a17 (Term) Term)
;;;;;;;;;;;;;;;;s: Prims.int -> _: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option Prims.unit & Prims.int)
(declare-fun Tm_arrow_c96ffbf3a64c9335d5c08c6c98b94b21 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__put_elab@tok () Term)




; </end encoding let _dm4f_STEXN___proj__STEXN__item__put_elab>


; encoding sigelt let _dm4f_STEXN___proj__STEXN__item__put_complete_type


; <Start encoding let _dm4f_STEXN___proj__STEXN__item__put_complete_type>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__put_complete_type () Term)




; </end encoding let _dm4f_STEXN___proj__STEXN__item__put_complete_type>


; encoding sigelt let _dm4f_STEXN___proj__STEXN__item__raise_elab


; <Start encoding let _dm4f_STEXN___proj__STEXN__item__raise_elab>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab (Term) Term)
(declare-fun Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf (Term Term) Term)
;;;;;;;;;;;;;;;;s__x: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option a & Prims.int)
(declare-fun Tm_arrow_c9b521c7e012991af483982c25e0abc2 (Term) Term)
;;;;;;;;;;;;;;;;a: Type -> s__x: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option a & Prims.int)
(declare-fun Tm_arrow_d1272576a4c8cda446191f1d54d16a78 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab@tok () Term)




; </end encoding let _dm4f_STEXN___proj__STEXN__item__raise_elab>


; encoding sigelt let _dm4f_STEXN___proj__STEXN__item__raise_complete_type


; <Start encoding let _dm4f_STEXN___proj__STEXN__item__raise_complete_type>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_complete_type () Term)




; </end encoding let _dm4f_STEXN___proj__STEXN__item__raise_complete_type>


; encoding sigelt let _dm4f_STEXN_repr


; <Start encoding let _dm4f_STEXN_repr>



(declare-fun FStar.DM4F.StExn._dm4f_STEXN_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp_a: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & Prims.int -> Type) -> Type)   -> Type
(declare-fun Tm_arrow_5b03ae9b915e33ab6fc14fca91b865fb () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_repr@tok () Term)
...
; </end encoding let _dm4f_STEXN_repr>


; encoding sigelt let _dm4f_STEXN_pre


; <Start encoding let _dm4f_STEXN_pre>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_pre () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Type
(declare-fun Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2 () Term)

; </end encoding let _dm4f_STEXN_pre>


; encoding sigelt let _dm4f_STEXN_post


; <Start encoding let _dm4f_STEXN_post>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_post (Term) Term)

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_post@tok () Term)


; </end encoding let _dm4f_STEXN_post>


; encoding sigelt let _dm4f_STEXN_wp


; <Start encoding let _dm4f_STEXN_wp>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_wp (Term) Term)

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_wp@tok () Term)



; </end encoding let _dm4f_STEXN_wp>


; encoding sigelt let _dm4f_STEXN_ctx


; <Start encoding let _dm4f_STEXN_ctx>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_ctx (Term Term) Term)

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & Prims.int -> Type) -> t
(declare-fun Tm_arrow_6d2bc4bcd4373546ab78407ad7cc02f9 (Term Term) Term)

; </end encoding let _dm4f_STEXN_ctx>


; encoding sigelt let _dm4f_STEXN_gctx


; <Start encoding let _dm4f_STEXN_gctx>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_gctx (Term Term) Term)

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & Prims.int -> Type) -> Prims.GTot t
(declare-fun Tm_ghost_arrow_5038b8db489c21f18e296237a45e25b0 (Term Term) Term)

; </end encoding let _dm4f_STEXN_gctx>


; encoding sigelt let _dm4f_STEXN_pure


; <Start encoding let _dm4f_STEXN_pure>


(declare-fun FStar.DM4F.StExn._dm4f_STEXN_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option a & Prims.int -> Type) -> t
(declare-fun Tm_arrow_1828224b003fe8fd53c53cec185c888c () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_pure@tok () Term)


; </end encoding let _dm4f_STEXN_pure>


; encoding sigelt let _dm4f_STEXN_app


; <Start encoding let _dm4f_STEXN_app>



;;;;;;;;;;;;;;;;_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & Prims.int -> Type)   -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_0605ebe9f1e65634f9c858d615c6b7bf (Term Term Term) Term)



(declare-fun FStar.DM4F.StExn._dm4f_STEXN_app (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_ghost_arrow_e0ac9e5a14954f92b2e825a35701ab1c () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_app@tok () Term)
...
; </end encoding let _dm4f_STEXN_app>


; encoding sigelt let _dm4f_STEXN_lift1


; <Start encoding let _dm4f_STEXN_lift1>




(declare-fun FStar.DM4F.StExn._dm4f_STEXN_lift1 (Term Term Term Term Term) Term)
...
(declare-fun Tm_arrow_d2d9479820d4194f20c53f05e61eb4b6 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_lift1@tok () Term)
...
(declare-fun Tm_abs_6dc242f41ec0f8fa4d88a618ed0b1634 (Term Term Term Term) Term)

; </end encoding let _dm4f_STEXN_lift1>


; encoding sigelt let _dm4f_STEXN_lift2


; <Start encoding let _dm4f_STEXN_lift2>
...
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_lift2 (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_arrow_9d82f33a277abe839eb8365e65c86481 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_lift2@tok () Term)
...
(declare-fun Tm_abs_2dc11e9fb7dc0ec0fbb83d58a12bb499 (Term Term Term Term Term) Term)

; </end encoding let _dm4f_STEXN_lift2>


; encoding sigelt let _dm4f_STEXN_push


; <Start encoding let _dm4f_STEXN_push>



;;;;;;;;;;;;;;;;_: t1 -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option a & Prims.int -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_8261a0a2b5c1bab8a77e5cce4987a95f (Term Term Term) Term)

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_push (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_ghost_arrow_bfd848b442f70f7fea98cd2e7782d228 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_push@tok () Term)





; </end encoding let _dm4f_STEXN_push>


; encoding sigelt let _dm4f_STEXN_wp_if_then_else


; <Start encoding let _dm4f_STEXN_wp_if_then_else>

(declare-fun FStar.DM4F.StExn._dm4f_STEXN_wp_if_then_else (Term Term) Term)
...
(declare-fun Tm_arrow_570390a6d58a786b56df461d5ba46098 (Term) Term)
...
(declare-fun Tm_arrow_9c667e475c620febd36c5c3c17ca654b () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_wp_if_then_else@tok () Term)
...
(declare-fun Tm_arrow_d84ee93d9bea21e145335ce6d5bcfdd1 (Term) Term)
...
(declare-fun Tm_arrow_8db4607051eda24e18b07fd963503d1d (Term) Term)
(declare-fun Tm_abs_6bb09e574c14be498970e6d649ef8306 (Term Term) Term)

; </end encoding let _dm4f_STEXN_wp_if_then_else>


; encoding sigelt let _dm4f_STEXN_wp_close


; <Start encoding let _dm4f_STEXN_wp_close>




(declare-fun FStar.DM4F.StExn._dm4f_STEXN_wp_close (Term Term Term) Term)
...
(declare-fun Tm_arrow_082bb5c032ff205c8294548116aa4664 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_wp_close@tok () Term)
...
(declare-fun Tm_abs_ed8bbdf2f12d9670bea9c922ecbde15f (Term Term Term) Term)

; </end encoding let _dm4f_STEXN_wp_close>


; encoding sigelt let _dm4f_STEXN_stronger


; <Start encoding let _dm4f_STEXN_stronger>





(declare-fun FStar.DM4F.StExn._dm4f_STEXN_stronger (Term Term Term) Term)
...
(declare-fun Tm_arrow_16509d6884aea55f599f6795a74ee631 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_stronger@tok () Term)
...
; </end encoding let _dm4f_STEXN_stronger>


; encoding sigelt let _dm4f_STEXN_ite_wp


; <Start encoding let _dm4f_STEXN_ite_wp>




(declare-fun FStar.DM4F.StExn._dm4f_STEXN_ite_wp (Term Term Term Term) Term)
...
(declare-fun Tm_arrow_690a38b58f5db244ab90c18255da1d40 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_ite_wp@tok () Term)





; </end encoding let _dm4f_STEXN_ite_wp>


; encoding sigelt let _dm4f_STEXN_null_wp


; <Start encoding let _dm4f_STEXN_null_wp>


(declare-fun FStar.DM4F.StExn._dm4f_STEXN_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> _: Prims.int -> _: (_: FStar.Pervasives.Native.option a & Prims.int -> Type)   -> Prims.logical
(declare-fun Tm_arrow_48a35935d34afc0667593fdbfe95c04a () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_null_wp@tok () Term)


; </end encoding let _dm4f_STEXN_null_wp>


; encoding sigelt let _dm4f_STEXN_wp_trivial


; <Start encoding let _dm4f_STEXN_wp_trivial>



(declare-fun FStar.DM4F.StExn._dm4f_STEXN_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type ->     wp: (_: Prims.int -> _: (_: FStar.Pervasives.Native.option a & Prims.int -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_fd9106832dbebe26a11e31c1f4cdaa37 () Term)
(declare-fun FStar.DM4F.StExn._dm4f_STEXN_wp_trivial@tok () Term)




; </end encoding let _dm4f_STEXN_wp_trivial>


; encoding sigelt new_effect_for_free { STEXN ... }


; <Start encoding new_effect_for_free { STEXN ... }>





(declare-fun Tm_abs_28a8f69e57aa6c6d15ed9eeb85a82c5c () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.StExn.__proj__STEXN__item__get (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.StExn.__proj__STEXN__item__get@tok () Term)




(declare-fun Tm_abs_b3152257958f300778ddfeafcc6a65eb () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.StExn.__proj__STEXN__item__put (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.StExn.__proj__STEXN__item__put@tok () Term)




(declare-fun Tm_abs_48cafc9f08d413b982140a55f2480edf () Term)
;;;;;;;;;;;;;;;;Action
(declare-fun FStar.DM4F.StExn.__proj__STEXN__item__raise (Term) Term)
;;;;;;;;;;;;;;;;Action token
(declare-fun FStar.DM4F.StExn.__proj__STEXN__item__raise@tok () Term)

; </end encoding new_effect_for_free { STEXN ... }>


; encoding sigelt sub_effect PURE ~> STEXN


; <Skipped sub_effect PURE ~> STEXN/>


; encoding sigelt let lift_pure_stexn


; <Start encoding let lift_pure_stexn>


(declare-fun FStar.DM4F.StExn.lift_pure_stexn (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type ->     wp: Prims.pure_wp a ->     h0: Prims.int ->     p: (_: FStar.Pervasives.Native.option a & Prims.int -> Type)   -> Prims.pure_pre
(declare-fun Tm_arrow_e7cd9afa790a842ae3988628f04edd68 () Term)
(declare-fun FStar.DM4F.StExn.lift_pure_stexn@tok () Term)




; </end encoding let lift_pure_stexn>
...
; encoding sigelt effect StExn a req ens = FStar.DM4F.StExn.STEXN a


; <Skipped effect StExn a req ens = FStar.DM4F.StExn.STEXN a/>


; encoding sigelt effect S a = FStar.DM4F.StExn.STEXN a


; <Skipped effect S a = FStar.DM4F.StExn.STEXN a/>
...
; Starting query at FStar.DM4F.StExn.fst(72,0-76,68)
...
;     (~(None? x) ==>
;       (forall (b: Prims.int). x == FStar.Pervasives.Native.Some b ==> h0 = h1 /\ j <> 0 ==> j <> 0))


; Context: While encoding a query
; While typechecking the top-level declaration `val FStar.DM4F.StExn.div_intrinsic`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=FStar.DM4F.StExn.fst(72,0-76,68)
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.StExn.fst(72,22-72,47)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Prims.pure_post Tm_type))

;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.StExn.fst(72,22-72,47)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExn.fst(72,22-72,47)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExn.fst(72,22-72,47)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.StExn.fst(72,22-72,47)
(and (implies 
;; def=FStar.DM4F.StExn.fst(74,19-74,20); use=FStar.DM4F.StExn.fst(72,22-72,47)
(and 
;; def=FStar.DM4F.StExn.fst(74,19-74,20); use=FStar.DM4F.StExn.fst(72,22-72,47)
(not 
;; def=FStar.DM4F.StExn.fst(74,19-74,20); use=FStar.DM4F.StExn.fst(72,22-72,47)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=FStar.DM4F.StExn.fst(72,22-72,47)
(not 
;; def=FStar.DM4F.StExn.fst(74,19-74,20); use=FStar.DM4F.StExn.fst(72,22-72,47)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None Prims.int
@x3))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.StExn.fst(72,22-72,47)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.int)

;; def=FStar.DM4F.StExn.fst(74,19-76,32); use=FStar.DM4F.StExn.fst(72,22-72,47)
(= @x3
(FStar.Pervasives.Native.Some Prims.int
@x6))


;; def=FStar.DM4F.StExn.fst(76,36-76,43); use=FStar.DM4F.StExn.fst(72,22-72,47)
(= @x2
@x4)


;; def=FStar.DM4F.StExn.fst(76,47-76,53); use=FStar.DM4F.StExn.fst(72,22-72,47)
(not (= @x1
(BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExn.fst(76,65-76,66)
(or label_2

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExn.fst(72,22-72,47)
(not (= @x1
(BoxInt 0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.StExn.div_intrinsic, 1)
; STATUS: unsat
...
; encoding sigelt val FStar.DM4F.StExn.div_intrinsic


; <Skipped val FStar.DM4F.StExn.div_intrinsic/>
...
; Starting query at FStar.DM4F.StExn.fst(78,2-79,12)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option Prims.int & Prims.int -> Type
(declare-fun Tm_arrow_5efe71156ec9d657a144ba62eaae95b7 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5efe71156ec9d657a144ba62eaae95b7
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_5efe71156ec9d657a144ba62eaae95b7
Tm_type)
:named kinding_Tm_arrow_5efe71156ec9d657a144ba62eaae95b7))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,11-27,27); use=FStar.DM4F.StExn.fst(78,2-79,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_5efe71156ec9d657a144ba62eaae95b7)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_5efe71156ec9d657a144ba62eaae95b7))
:qid FStar.DM4F.StExn_pre_typing_Tm_arrow_5efe71156ec9d657a144ba62eaae95b7))

:named FStar.DM4F.StExn_pre_typing_Tm_arrow_5efe71156ec9d657a144ba62eaae95b7))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5efe71156ec9d657a144ba62eaae95b7
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,11-27,27); use=FStar.DM4F.StExn.fst(78,2-79,12)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_5efe71156ec9d657a144ba62eaae95b7.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_5efe71156ec9d657a144ba62eaae95b7))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_5efe71156ec9d657a144ba62eaae95b7))

:named FStar.DM4F.StExn_interpretation_Tm_arrow_5efe71156ec9d657a144ba62eaae95b7))

; Encoding query formula : forall (i: Prims.nat) (j: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.int) (p: Prims.pure_post (FStar.Pervasives.Native.option Prims.int & Prims.int)).
;     (forall (r: FStar.Pervasives.Native.option Prims.int) (h1: Prims.int).
;         (match r with
;           | FStar.Pervasives.Native.None  -> _ = h1 /\ j = 0
;           | FStar.Pervasives.Native.Some z -> _ = h1 /\ j <> 0 /\ z = i / j) ==>
;         p (r, h1)) ==>
...
;             k a1 <==> p a1) ==>
;         (j = 0 = true ==> j = 0 == true ==> k (FStar.Pervasives.Native.None, _)) /\
;         (~(j = 0 = true) ==>
;           (forall (b: Prims.bool).
;               j = 0 == b ==>
;               j <> 0 /\
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.StExn.fst(78,2-79,12)
...
;; def=FStar.DM4F.StExn.fst(67,4-67,73); use=FStar.DM4F.StExn.fst(78,2-79,12)
...
;; def=FStar.DM4F.StExn.fst(75,34-75,50); use=FStar.DM4F.StExn.fst(78,2-79,12)
(and 
;; def=FStar.DM4F.StExn.fst(75,34-75,41); use=FStar.DM4F.StExn.fst(78,2-79,12)
(= @x2
@x5)


;; def=FStar.DM4F.StExn.fst(75,45-75,50); use=FStar.DM4F.StExn.fst(78,2-79,12)
(= @x1
(BoxInt 0))
)
...
;; def=FStar.DM4F.StExn.fst(76,36-76,66); use=FStar.DM4F.StExn.fst(78,2-79,12)
(and 
;; def=FStar.DM4F.StExn.fst(76,36-76,43); use=FStar.DM4F.StExn.fst(78,2-79,12)
(= @x2
@x5)


;; def=FStar.DM4F.StExn.fst(76,47-76,53); use=FStar.DM4F.StExn.fst(78,2-79,12)
(not (= @x1
(BoxInt 0)))


;; def=FStar.DM4F.StExn.fst(76,57-76,66); use=FStar.DM4F.StExn.fst(78,2-79,12)
...
;; def=FStar.DM4F.StExn.fst(67,63-67,72); use=FStar.DM4F.StExn.fst(78,2-79,12)
(Valid 
;; def=FStar.DM4F.StExn.fst(67,63-67,72); use=FStar.DM4F.StExn.fst(78,2-79,12)
(ApplyTT @x3
...
;; def=Prims.fst(221,62-221,85); use=FStar.DM4F.StExn.fst(78,2-79,12)
(and (implies 
;; def=Prims.fst(221,62-221,71); use=FStar.DM4F.StExn.fst(78,2-79,12)
(and 
;; def=FStar.DM4F.StExn.fst(78,5-78,10); use=FStar.DM4F.StExn.fst(78,5-78,10)
...
;; def=FStar.DM4F.StExn.fst(46,40-46,49); use=FStar.DM4F.StExn.fst(78,23-78,28)
(or label_1
...
(implies 
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.StExn.fst(78,2-79,12)
(not 
;; def=FStar.DM4F.StExn.fst(78,5-78,10); use=FStar.DM4F.StExn.fst(78,5-78,10)
(= (Prims.op_Equality Prims.int
@x1
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.StExn.fst(78,2-79,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=FStar.DM4F.StExn.fst(78,5-79,12); use=FStar.DM4F.StExn.fst(78,5-79,12)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
@x5)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.StExn.fst(78,2-79,12)
(and 
;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExn.fst(79,11-79,12)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.StExn.fst(78,2-79,12)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.int)
...
;; def=FStar.DM4F.StExn.fst(72,44-79,12); use=FStar.DM4F.StExn.fst(78,2-79,12)
(= @x7
(Prims.op_Division @x0
@x1))
)

;; def=Prims.fst(356,2-356,58); use=FStar.DM4F.StExn.fst(78,2-79,12)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.int)

;; def=Prims.fst(356,26-356,41); use=FStar.DM4F.StExn.fst(78,2-79,12)
(= @x8
@x7)
)

;; def=FStar.DM4F.StExn.fst(61,21-61,35); use=FStar.DM4F.StExn.fst(78,2-79,12)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.StExn.div_intrinsic, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, data_elim_FStar.Pervasives.Native.Mktuple2, data_typing_intro_FStar.Pervasives.Native.Mktuple2@tok, data_typing_intro_FStar.Pervasives.Native.None@tok, data_typing_intro_FStar.Pervasives.Native.Some@tok, equation_Prims.eqtype, function_token_typing_Prims.__cache_version_number__, int_inversion, kinding_FStar.Pervasives.Native.option@tok, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.None_a, projection_inverse_FStar.Pervasives.Native.Some_a, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
...
(declare-fun FStar.DM4F.StExn.div_intrinsic (Term Term) Term)
(declare-fun Non_total_Tm_arrow_8dfe4b06868afffca61a354c09f63e26 () Term)
(declare-fun FStar.DM4F.StExn.div_intrinsic@tok () Term)
(declare-fun Tm_refine_2948d505ba562d6d39205db0d7d76860 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option Prims.int & Prims.int)
(declare-fun Tm_arrow_e56191bb2476eeda98946160c851442f (Term Term) Term)
(declare-fun Tm_abs_663fa2def9a31c0aaf9fdd394df3438d (Term Term) Term)

; </end encoding let div_intrinsic>

(push) ;; push{2

; Starting query at FStar.DM4F.StExn.fst(82,2-83,12)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,11-27,27); use=FStar.DM4F.StExn.fst(82,2-83,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_5efe71156ec9d657a144ba62eaae95b7)
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.StExn.fst(82,2-83,12)
(forall ((@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x2
Prims.int)
(HasType @x3
...
;; def=FStar.DM4F.StExn.fst(70,41-70,54); use=FStar.DM4F.StExn.fst(82,2-83,12)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
Prims.int))

;; def=FStar.DM4F.StExn.fst(70,51-70,54); use=FStar.DM4F.StExn.fst(82,2-83,12)
(Valid 
;; def=FStar.DM4F.StExn.fst(70,51-70,54); use=FStar.DM4F.StExn.fst(82,2-83,12)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(221,76-221,78); use=FStar.DM4F.StExn.fst(82,2-83,12)
(not 
;; def=FStar.DM4F.StExn.fst(82,5-82,10); use=FStar.DM4F.StExn.fst(82,5-82,10)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
(BoxBool true))
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.StExn.fst(82,2-83,12)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.bool)

;; def=FStar.DM4F.StExn.fst(82,5-83,12); use=FStar.DM4F.StExn.fst(82,5-83,12)
(= (Prims.op_Equality Prims.int
@x1
(BoxInt 0))
@x5)
...
;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExn.fst(83,11-83,12)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.StExn.div_extrinsic, 1)
; STATUS: unsat
...
(declare-fun FStar.DM4F.StExn.div_extrinsic (Term Term) Term)
(declare-fun Non_total_Tm_arrow_cc9db5ed3b35c198f40ab6d3b2875ea9 () Term)
(declare-fun FStar.DM4F.StExn.div_extrinsic@tok () Term)
(declare-fun Tm_refine_c116bdd19e9e85f9b28d04dc61e36012 () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> Prims.PURE (FStar.Pervasives.Native.option Prims.int & Prims.int)
(declare-fun Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926 () Term)


; </end encoding let div_extrinsic>

;;;;;;;;;;;;;;;;typing_Tm_abs_48cafc9f08d413b982140a55f2480edf
;;; Fact-ids: Name FStar.DM4F.StExn.STEXN; Namespace FStar.DM4F.StExn
(assert (! (HasType Tm_abs_48cafc9f08d413b982140a55f2480edf
Tm_arrow_d1272576a4c8cda446191f1d54d16a78)
:named typing_Tm_abs_48cafc9f08d413b982140a55f2480edf))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.StExn.div_extrinsic; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(81,5-81,18); use=FStar.DM4F.StExn.fst(81,5-81,18)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
Prims.int))
(HasType (FStar.DM4F.StExn.div_extrinsic @x0
@x1)
Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926))
 

:pattern ((FStar.DM4F.StExn.div_extrinsic @x0
@x1))
:qid typing_FStar.DM4F.StExn.div_extrinsic))

:named typing_FStar.DM4F.StExn.div_extrinsic))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_663fa2def9a31c0aaf9fdd394df3438d
;;; Fact-ids: Name FStar.DM4F.StExn.div_intrinsic; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(31,26-31,35); use=FStar.DM4F.StExn.fst(31,26-31,35)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (Tm_abs_663fa2def9a31c0aaf9fdd394df3438d @x0
@x1))
 

:pattern ((Tm_abs_663fa2def9a31c0aaf9fdd394df3438d @x0
@x1))
:qid tot_fun_Tm_abs_663fa2def9a31c0aaf9fdd394df3438d))

:named tot_fun_Tm_abs_663fa2def9a31c0aaf9fdd394df3438d))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.StExn.fst(46,41-46,48)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf))

:named refinement_kinding_Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.StExn.div_extrinsic; Namespace FStar.DM4F.StExn
(assert (! (HasType Tm_refine_c116bdd19e9e85f9b28d04dc61e36012
Tm_type)
:named refinement_kinding_Tm_refine_c116bdd19e9e85f9b28d04dc61e36012))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.StExn.fst(46,41-46,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf @x2
@x3))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.StExn.fst(46,41-46,48)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.StExn.fst(46,41-46,48)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.StExn.fst(46,41-46,48)
...
(Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf @x2
@x3)))
:qid refinement_interpretation_Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf))

:named refinement_interpretation_Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.DM4F.StExn.div_extrinsic; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,11-27,27); use=FStar.DM4F.StExn.fst(27,11-27,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_c116bdd19e9e85f9b28d04dc61e36012)
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
Prims.int))

;; def=Prims.fst(635,71-635,97); use=FStar.DM4F.StExn.fst(27,11-27,27)
(not 
;; def=FStar.DM4F.StExn.fst(70,41-70,54); use=FStar.DM4F.StExn.fst(81,37-81,38)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
Prims.int))

;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.StExn.fst(27,11-27,27)
(not 
;; def=Prims.fst(635,86-635,95); use=FStar.DM4F.StExn.fst(27,11-27,27)
(= @x2
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_c116bdd19e9e85f9b28d04dc61e36012.1))
)
))
...
@x1
Tm_refine_c116bdd19e9e85f9b28d04dc61e36012))
:qid refinement_interpretation_Tm_refine_c116bdd19e9e85f9b28d04dc61e36012))

:named refinement_interpretation_Tm_refine_c116bdd19e9e85f9b28d04dc61e36012))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926
;;; Fact-ids: Name FStar.DM4F.StExn.div_extrinsic; Namespace FStar.DM4F.StExn
(assert (! (HasType Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926
Tm_type)
:named kinding_Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d1272576a4c8cda446191f1d54d16a78
;;; Fact-ids: Name FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab; Namespace FStar.DM4F.StExn
(assert (! (HasType Tm_arrow_d1272576a4c8cda446191f1d54d16a78
Tm_type)
:named kinding_Tm_arrow_d1272576a4c8cda446191f1d54d16a78))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c9b521c7e012991af483982c25e0abc2
;;; Fact-ids: Name FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,2-27,5); use=FStar.DM4F.StExn.fst(27,2-46,48)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_c9b521c7e012991af483982c25e0abc2 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_c9b521c7e012991af483982c25e0abc2 @x0)
Tm_type))
:qid kinding_Tm_arrow_c9b521c7e012991af483982c25e0abc2))

:named kinding_Tm_arrow_c9b521c7e012991af483982c25e0abc2))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_ebc7050a89f55643c1693d4ce5ac7848
;;; Fact-ids: Name FStar.DM4F.StExn.raise; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(46,40-46,49); use=FStar.DM4F.StExn.fst(46,40-46,49)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_ebc7050a89f55643c1693d4ce5ac7848 @x1)
@x0)
...
:pattern ((ApplyTT (Tm_abs_ebc7050a89f55643c1693d4ce5ac7848 @x1)
@x0))
:qid interpretation_Tm_abs_ebc7050a89f55643c1693d4ce5ac7848))

:named interpretation_Tm_abs_ebc7050a89f55643c1693d4ce5ac7848))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_663fa2def9a31c0aaf9fdd394df3438d
;;; Fact-ids: Name FStar.DM4F.StExn.div_intrinsic; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(31,26-31,35); use=FStar.DM4F.StExn.fst(31,26-31,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_663fa2def9a31c0aaf9fdd394df3438d @x1
@x2)
@x0)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.int)
Prims.int
...
:pattern ((ApplyTT (Tm_abs_663fa2def9a31c0aaf9fdd394df3438d @x1
@x2)
@x0))
:qid interpretation_Tm_abs_663fa2def9a31c0aaf9fdd394df3438d))

:named interpretation_Tm_abs_663fa2def9a31c0aaf9fdd394df3438d))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_48cafc9f08d413b982140a55f2480edf
;;; Fact-ids: Name FStar.DM4F.StExn.STEXN; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(46,40-46,49); use=FStar.DM4F.StExn.fst(46,40-46,49)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_48cafc9f08d413b982140a55f2480edf
@x0)
(Tm_abs_ebc7050a89f55643c1693d4ce5ac7848 @x0))
 

:pattern ((ApplyTT Tm_abs_48cafc9f08d413b982140a55f2480edf
@x0))
:qid interpretation_Tm_abs_48cafc9f08d413b982140a55f2480edf))

:named interpretation_Tm_abs_48cafc9f08d413b982140a55f2480edf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf
;;; Fact-ids: Name FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,53-59,65); use=FStar.DM4F.StExn.fst(46,41-46,48)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option @x0)
Prims.int))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf @x0
@x1))))
:qid haseqTm_refine_d6ee3fb815d352dc9b5232338f93b4bf))

:named haseqTm_refine_d6ee3fb815d352dc9b5232338f93b4bf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c116bdd19e9e85f9b28d04dc61e36012
;;; Fact-ids: Name FStar.DM4F.StExn.div_extrinsic; Namespace FStar.DM4F.StExn
(assert (! (iff (Valid (Prims.hasEq Tm_refine_c116bdd19e9e85f9b28d04dc61e36012))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
Prims.int))))
:named haseqTm_refine_c116bdd19e9e85f9b28d04dc61e36012))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.StExn.div_extrinsic
;;; Fact-ids: Name FStar.DM4F.StExn.div_extrinsic; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(81,5-81,18); use=FStar.DM4F.StExn.fst(81,5-81,18)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.DM4F.StExn.div_extrinsic @x0
@x1)
...
(ite (= @lb2
(BoxBool true))
(FStar.DM4F.StExn.__proj__STEXN__item__raise Prims.int)
(Tm_abs_663fa2def9a31c0aaf9fdd394df3438d @x1
@x0))))
 

:pattern ((FStar.DM4F.StExn.div_extrinsic @x0
@x1))
:qid equation_FStar.DM4F.StExn.div_extrinsic))

:named equation_FStar.DM4F.StExn.div_extrinsic))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.StExn.div_extrinsic; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,2-27,27); use=FStar.DM4F.StExn.fst(27,2-27,27)
...
@x1
Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926))
:qid FStar.DM4F.StExn_pre_typing_Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926))

:named FStar.DM4F.StExn_pre_typing_Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,2-46,17); use=FStar.DM4F.StExn.fst(27,2-46,48)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d1272576a4c8cda446191f1d54d16a78)
...
@x1
Tm_arrow_d1272576a4c8cda446191f1d54d16a78))
:qid FStar.DM4F.StExn_pre_typing_Tm_arrow_d1272576a4c8cda446191f1d54d16a78))

:named FStar.DM4F.StExn_pre_typing_Tm_arrow_d1272576a4c8cda446191f1d54d16a78))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,2-27,5); use=FStar.DM4F.StExn.fst(27,2-46,48)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_c9b521c7e012991af483982c25e0abc2 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_c9b521c7e012991af483982c25e0abc2 @x2)))
:qid FStar.DM4F.StExn_pre_typing_Tm_arrow_c9b521c7e012991af483982c25e0abc2))

:named FStar.DM4F.StExn_pre_typing_Tm_arrow_c9b521c7e012991af483982c25e0abc2))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926
;;; Fact-ids: Name FStar.DM4F.StExn.div_extrinsic; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,2-27,27); use=FStar.DM4F.StExn.fst(27,2-27,27)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926))

:named FStar.DM4F.StExn_interpretation_Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d1272576a4c8cda446191f1d54d16a78
;;; Fact-ids: Name FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,2-46,17); use=FStar.DM4F.StExn.fst(27,2-46,48)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_arrow_c9b521c7e012991af483982c25e0abc2 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_d1272576a4c8cda446191f1d54d16a78.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_d1272576a4c8cda446191f1d54d16a78))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_d1272576a4c8cda446191f1d54d16a78))

:named FStar.DM4F.StExn_interpretation_Tm_arrow_d1272576a4c8cda446191f1d54d16a78))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c9b521c7e012991af483982c25e0abc2
;;; Fact-ids: Name FStar.DM4F.StExn._dm4f_STEXN___proj__STEXN__item__raise_elab; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(27,2-27,5); use=FStar.DM4F.StExn.fst(27,2-46,48)
(forall ((@x0 Term) (@x1 Term))
...
(HasType (ApplyTT @x0
@x2)
(Tm_refine_d6ee3fb815d352dc9b5232338f93b4bf @x1
@x2)))
 

:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_c9b521c7e012991af483982c25e0abc2.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_c9b521c7e012991af483982c25e0abc2 @x1)))
:qid FStar.DM4F.StExn_interpretation_Tm_arrow_c9b521c7e012991af483982c25e0abc2))

:named FStar.DM4F.StExn_interpretation_Tm_arrow_c9b521c7e012991af483982c25e0abc2))
;;;;;;;;;;;;;;;;Action equality
;;; Fact-ids: Name FStar.DM4F.StExn.STEXN; Namespace FStar.DM4F.StExn
(assert (! 
;; def=FStar.DM4F.StExn.fst(56,7-56,12); use=FStar.DM4F.StExn.fst(56,7-56,12)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.StExn.__proj__STEXN__item__raise @x0)
(ApplyTT Tm_abs_48cafc9f08d413b982140a55f2480edf
@x0))
 

:pattern ((FStar.DM4F.StExn.__proj__STEXN__item__raise @x0))
:qid FStar.DM4F.StExn.__proj__STEXN__item__raise_equality))

:named FStar.DM4F.StExn.__proj__STEXN__item__raise_equality))
(push) ;; push{2

; Starting query at FStar.DM4F.StExn.fst(88,59-88,61)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.StExn.fst(86,2-88,56); use=FStar.DM4F.StExn.fst(88,59-88,61)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;         reify (FStar.DM4F.StExn.div_extrinsic i j) h0 == x ==>
;         (forall (k: Prims.pure_post Type0).
;             (forall (x: Type0). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;             (~(None? (reify (FStar.DM4F.StExn.div_extrinsic i j) h0)._1) /\
;               ~(Some? (reify (FStar.DM4F.StExn.div_extrinsic i j) h0)._1) ==>
;               Prims.l_False) /\
;             (~(None? (reify (FStar.DM4F.StExn.div_extrinsic i j) h0)._1) ==>
;               (forall (b: Prims.int) (b: Prims.int).
;                   reify (FStar.DM4F.StExn.div_extrinsic i j) h0 ==
;                   (FStar.Pervasives.Native.Some b,
;                   b) ==>
;                   h0 = b /\ j <> 0 ==> j <> 0)))) /\
;   (forall (p: Prims.pure_post Prims.unit).
;       (forall (pure_result: Prims.unit).
;           (match reify (FStar.DM4F.StExn.div_extrinsic i j) h0 with
;             | FStar.Pervasives.Native.None , h1 -> h0 = h1 /\ j = 0
...
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.StExn.fst(88,59-88,61)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_refine_4fe5a88d1a1dcab567f82d246dbcb5b9)

;; def=FStar.DM4F.StExn.fst(70,41-70,54); use=FStar.DM4F.StExn.fst(88,59-88,61)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.Native.tuple2 (FStar.Pervasives.Native.option Prims.int)
Prims.int))

;; def=FStar.DM4F.StExn.fst(86,15-86,43); use=FStar.DM4F.StExn.fst(88,59-88,61)
(= (ApplyTT (FStar.DM4F.StExn.div_extrinsic @x0
@x1)
@x2)
@x4)
)
...
;; def=Prims.fst(402,27-402,88); use=FStar.DM4F.StExn.fst(88,59-88,61)
(forall ((@x6 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExn.fst(88,59-88,61)
(Valid 
;; def=Prims.fst(402,84-402,87); use=FStar.DM4F.StExn.fst(88,59-88,61)
(ApplyTT @x5
@x6)
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.StExn.fst(88,59-88,61)
(and (implies 
;; def=FStar.DM4F.StExn.fst(87,11-88,21); use=FStar.DM4F.StExn.fst(88,59-88,61)
(and 
;; def=FStar.DM4F.StExn.fst(87,11-87,19); use=FStar.DM4F.StExn.fst(88,59-88,61)
(not 
;; def=FStar.DM4F.StExn.fst(87,11-87,19); use=FStar.DM4F.StExn.fst(88,59-88,61)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None Prims.int
...
;; def=FStar.DM4F.StExn.fst(88,11-88,21); use=FStar.DM4F.StExn.fst(88,59-88,61)
(not 
;; def=FStar.DM4F.StExn.fst(88,11-88,21); use=FStar.DM4F.StExn.fst(88,59-88,61)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_Some Prims.int
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (FStar.Pervasives.Native.option Prims.int)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=FStar.DM4F.StExn.fst(88,59-88,61)
(not 
;; def=FStar.DM4F.StExn.fst(87,11-87,19); use=FStar.DM4F.StExn.fst(88,59-88,61)
(BoxBool_proj_0 (FStar.Pervasives.Native.uu___is_None Prims.int
(FStar.Pervasives.Native.__proj__Mktuple2__item___1 (FStar.Pervasives.Native.option Prims.int)
...
;; def=Prims.fst(413,99-413,120); use=FStar.DM4F.StExn.fst(88,59-88,61)
(forall ((@x6 Term))
 (! (implies (HasType @x6
Prims.int)
...
;; def=FStar.DM4F.StExn.fst(86,15-88,21); use=FStar.DM4F.StExn.fst(88,59-88,61)
(= (ApplyTT (FStar.DM4F.StExn.div_extrinsic @x0
@x1)
@x2)
(FStar.Pervasives.Native.Mktuple2 (FStar.Pervasives.Native.option Prims.int)
...
;; def=FStar.DM4F.StExn.fst(88,25-88,32); use=FStar.DM4F.StExn.fst(88,59-88,61)
(= @x2
@x7)


;; def=FStar.DM4F.StExn.fst(88,36-88,42); use=FStar.DM4F.StExn.fst(88,59-88,61)
(not (= @x1
(BoxInt 0)))
)

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExn.fst(88,54-88,55)
(or label_2

;; def=Prims.fst(686,22-686,28); use=FStar.DM4F.StExn.fst(88,59-88,61)
(not (= @x1
(BoxInt 0)))
)
)
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.StExn.fst(88,59-88,61)
(forall ((@x4 Term))
 (! (implies (and (or label_3
(HasType @x4
Prims.unit))
(let ((@lb5 (ApplyTT (FStar.DM4F.StExn.div_extrinsic @x0
@x1)
@x2)))
(ite (is-FStar.Pervasives.Native.None (FStar.Pervasives.Native.Mktuple2__1 @lb5))

;; def=FStar.DM4F.StExn.fst(87,23-87,39); use=FStar.DM4F.StExn.fst(88,59-88,61)
(and 
;; def=FStar.DM4F.StExn.fst(87,23-87,30); use=FStar.DM4F.StExn.fst(88,59-88,61)
(or label_4
...
;; def=FStar.DM4F.StExn.fst(87,34-87,39); use=FStar.DM4F.StExn.fst(88,59-88,61)
(or label_5
...
(ite (is-FStar.Pervasives.Native.Some (FStar.Pervasives.Native.Mktuple2__1 @lb5))

;; def=FStar.DM4F.StExn.fst(88,25-88,55); use=FStar.DM4F.StExn.fst(88,59-88,61)
(and 
;; def=FStar.DM4F.StExn.fst(88,25-88,32); use=FStar.DM4F.StExn.fst(88,59-88,61)
(or label_6
...
;; def=FStar.DM4F.StExn.fst(88,46-88,55); use=FStar.DM4F.StExn.fst(88,59-88,61)
(or label_8
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.StExn.fst(88,59-88,61)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.StExn.fst(88,59-88,61)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.StExn.lemma_div_extrinsic, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.StExn.__proj__STEXN__item__raise_equality, FStar.DM4F.StExn_interpretation_Tm_arrow_ed7d5ef17aca87967a2b5b7ec9442926, Prims_pretyping_ae567c2fb75be05905677af440075565, constructor_distinct_FStar.Pervasives.Native.None, constructor_distinct_FStar.Pervasives.Native.Some, disc_equation_FStar.Pervasives.Native.None, disc_equation_FStar.Pervasives.Native.Some, equation_FStar.DM4F.StExn.div_extrinsic, equation_Prims.eqtype, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, int_inversion, interpretation_Tm_abs_48cafc9f08d413b982140a55f2480edf, interpretation_Tm_abs_663fa2def9a31c0aaf9fdd394df3438d, interpretation_Tm_abs_ebc7050a89f55643c1693d4ce5ac7848, kinding_FStar.Pervasives.Native.option@tok, lemma_FStar.Pervasives.invertOption, primitive_Prims.op_Equality, proj_equation_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_BoxBool_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Some_v, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_c116bdd19e9e85f9b28d04dc61e36012, typing_FStar.DM4F.StExn.div_extrinsic, typing_FStar.Pervasives.Native.__proj__Mktuple2__item___1, typing_Prims.int
