...
; Internals for FStar.DM4F.IntST
...
; encoding sigelt let _dm4f_STINT_lift_from_pure
...
; encoding sigelt let _dm4f_STINT_return_wp
...
; encoding sigelt let _dm4f_STINT_return_elab
...
; encoding sigelt let _dm4f_STINT_bind_wp
...
; encoding sigelt let _dm4f_STINT_bind_elab
...
; encoding sigelt let _dm4f_STINT___proj__STINT__item__get_elab
...
; encoding sigelt let _dm4f_STINT___proj__STINT__item__get_complete_type
...
; encoding sigelt let _dm4f_STINT___proj__STINT__item__put_elab
...
; encoding sigelt let _dm4f_STINT___proj__STINT__item__put_complete_type
...
; encoding sigelt let _dm4f_STINT_repr
...
; encoding sigelt let _dm4f_STINT_pre
...
; encoding sigelt let _dm4f_STINT_post
...
; encoding sigelt let _dm4f_STINT_wp
...
; encoding sigelt let _dm4f_STINT_ctx
...
; encoding sigelt let _dm4f_STINT_gctx
...
; encoding sigelt let _dm4f_STINT_pure
...
; encoding sigelt let _dm4f_STINT_app
...
; encoding sigelt let _dm4f_STINT_lift1
...
; encoding sigelt let _dm4f_STINT_lift2
...
; encoding sigelt let _dm4f_STINT_push
...
; encoding sigelt let _dm4f_STINT_wp_if_then_else
...
; encoding sigelt let _dm4f_STINT_wp_close
...
; encoding sigelt let _dm4f_STINT_stronger
...
; encoding sigelt let _dm4f_STINT_ite_wp
...
; encoding sigelt let _dm4f_STINT_null_wp
...
; encoding sigelt let _dm4f_STINT_wp_trivial
...
; encoding sigelt new_effect_for_free { STINT ... }
...
; encoding sigelt sub_effect PURE ~> STINT
...
; encoding sigelt let lift_pure_stint
...
; encoding sigelt effect StInt a pre post = FStar.DM4F.IntST.STINT a


; <Skipped effect StInt a pre post = FStar.DM4F.IntST.STINT a/>


; encoding sigelt effect StNull a = FStar.DM4F.IntST.STINT a


; <Skipped effect StNull a = FStar.DM4F.IntST.STINT a/>


; encoding sigelt val FStar.DM4F.IntST.incr_intrinsic
...
; Starting query at FStar.DM4F.IntST.fst(60,22-62,20)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u166: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.int) (p: Prims.pure_post (Prims.unit & Prims.int)).
;     (forall (a: Prims.unit) (n1: Prims.int). n1 = _ + 1 ==> p (a, n1)) ==> p ((), _ + 1)


; Context: While encoding a query
; While typechecking the top-level declaration `let incr_intrinsic`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(60,22-62,20)
...
;; def=FStar.DM4F.IntST.fst(50,12-50,63); use=FStar.DM4F.IntST.fst(60,22-62,20)
...
;; def=FStar.DM4F.IntST.fst(59,54-59,65); use=FStar.DM4F.IntST.fst(60,22-62,20)
(= @x4
(Prims.op_Addition @x1
(BoxInt 1)))
)

;; def=FStar.DM4F.IntST.fst(50,53-50,62); use=FStar.DM4F.IntST.fst(60,22-62,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(50,53-50,62); use=FStar.DM4F.IntST.fst(60,22-62,20)
(ApplyTT @x2
...
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.IntST.fst(62,9-62,12)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntST.incr_intrinsic, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, int_typing, primitive_Prims.op_Addition, unit_typing
...
; encoding sigelt let incr_intrinsic
...
; Starting query at FStar.DM4F.IntST.fst(68,23-70,20)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u131: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.int) (p: Prims.pure_post (Prims.unit & Prims.int)).
;     (forall (s1: Prims.int). s1 > _ ==> p ((), s1)) ==> p ((), _ + 1)
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(68,23-70,20)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
Prims.int)
(HasType @x2
...
;; def=FStar.DM4F.IntST.fst(67,18-67,62); use=FStar.DM4F.IntST.fst(68,23-70,20)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.int)

;; def=FStar.DM4F.IntST.fst(67,35-67,44); use=FStar.DM4F.IntST.fst(68,23-70,20)
(> (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x1))
)

;; def=FStar.DM4F.IntST.fst(67,49-67,62); use=FStar.DM4F.IntST.fst(68,23-70,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(67,49-67,62); use=FStar.DM4F.IntST.fst(68,23-70,20)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.IntST.fst(70,9-70,12)
(or label_1
...
; QUERY ID: (FStar.DM4F.IntST.incr_intrinsic', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, int_typing, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0
...
; encoding sigelt val FStar.DM4F.IntST.incr
...
; Starting query at FStar.DM4F.IntST.fst(80,30-80,72)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (s0: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (x: Prims.unit & Prims.int).
;     reify (FStar.DM4F.IntST.incr ()) s0 == x ==>
;     (forall (any_result: Prims.int).
;         FStar.Pervasives.Native.snd (reify (FStar.DM4F.IntST.incr ()) s0) == any_result ==>
;         (forall (any_result: Prims.bool).
;             FStar.Pervasives.Native.snd (reify (FStar.DM4F.IntST.incr ()) s0) = s0 + 1 == any_result ==>
;             (forall (any_result: Prims.logical).
;                 FStar.Pervasives.Native.snd (reify (FStar.DM4F.IntST.incr ()) s0) = s0 + 1 ==
;                 any_result ==>
;                 FStar.Pervasives.Native.snd (reify (FStar.DM4F.IntST.incr ()) s0) = s0 + 1)))


; Context: While encoding a query
; While typechecking the top-level declaration `let incr_increases`
...
;; def=FStar.DM4F.IntST.fst(54,50-54,75); use=FStar.DM4F.IntST.fst(80,50-80,54)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))

;; def=FStar.Pervasives.Native.fst(63,9-63,10); use=FStar.DM4F.IntST.fst(80,30-80,72)
(= (ApplyTT (FStar.DM4F.IntST.incr Tm_unit)
@x0)
@x1)
)

;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.IntST.fst(80,30-80,72)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.int)

;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(80,30-80,72)
...
;; def=Prims.fst(180,10-180,11); use=FStar.DM4F.IntST.fst(80,30-80,72)
...
;; def=Prims.fst(672,13-672,14); use=FStar.DM4F.IntST.fst(80,30-80,72)
...
;; def=FStar.DM4F.IntST.fst(80,37-80,72); use=FStar.DM4F.IntST.fst(80,30-80,36)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntST.incr_increases, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.IntST.__proj__STINT__item__get_equality, FStar.DM4F.IntST.__proj__STINT__item__put_equality, Prims_pretyping_ae567c2fb75be05905677af440075565, Prims_pretyping_f8666440faa91836cc5a13998af863fc, equation_FStar.DM4F.IntST.incr, equation_FStar.Pervasives.Native.snd, function_token_typing_Prims.__cache_version_number__, int_inversion, interpretation_Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c, interpretation_Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61, interpretation_Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c, interpretation_Tm_abs_cc18103f7e8a41ead5051007b34f3b4b, primitive_Prims.op_Addition, proj_equation_FStar.Pervasives.Native.Mktuple2__2, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, unit_typing
...
; encoding sigelt let incr_increases
...
(assert (! 
;; def=FStar.DM4F.IntST.fst(89,5-89,8); use=FStar.DM4F.IntST.fst(89,5-89,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.bool)
(HasType (FStar.DM4F.IntST.ifc @x0)
Tm_arrow_2f0ea550a9a01b08d152bef225faf73e))
 

:pattern ((FStar.DM4F.IntST.ifc @x0))
:qid typing_FStar.DM4F.IntST.ifc))

:named typing_FStar.DM4F.IntST.ifc))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.DM4F.IntST.decr; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(85,5-85,9); use=FStar.DM4F.IntST.fst(85,5-85,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.unit)
(HasType (FStar.DM4F.IntST.decr @x0)
Tm_arrow_b996639e5552f46d555b60a2e4f57108))
 

:pattern ((FStar.DM4F.IntST.decr @x0))
:qid typing_FStar.DM4F.IntST.decr))

:named typing_FStar.DM4F.IntST.decr))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_cd4af824bd65da4276f069890c42565c
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! (IsTotFun Tm_abs_cd4af824bd65da4276f069890c42565c)
:named tot_fun_Tm_abs_cd4af824bd65da4276f069890c42565c))
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! (IsTotFun Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e)
:named tot_fun_Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
...
;;; Fact-ids: Name FStar.DM4F.IntST._dm4f_STINT_pre; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2
Tm_type)
:named kinding_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_2f0ea550a9a01b08d152bef225faf73e
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_arrow_2f0ea550a9a01b08d152bef225faf73e
Tm_type)
:named kinding_Tm_arrow_2f0ea550a9a01b08d152bef225faf73e))
...
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(33,17-33,43); use=FStar.DM4F.ST.fst(33,17-33,43)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_cd4af824bd65da4276f069890c42565c
@x0)
(let ((@lb1 (ApplyTT (FStar.DM4F.IntST.incr Tm_unit)
@x0)))
(let ((@lb2 (ApplyTT (FStar.DM4F.IntST.__proj__STINT__item__get Tm_unit)
(FStar.Pervasives.Native.Mktuple2__2 @lb1))))
(let ((@lb3 (ApplyTT (FStar.DM4F.IntST.decr Tm_unit)
(FStar.Pervasives.Native.Mktuple2__2 @lb2))))
(FStar.Pervasives.Native.Mktuple2 Prims.int
Prims.int
...
:pattern ((ApplyTT Tm_abs_cd4af824bd65da4276f069890c42565c
@x0))
:qid interpretation_Tm_abs_cd4af824bd65da4276f069890c42565c))

:named interpretation_Tm_abs_cd4af824bd65da4276f069890c42565c))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.ST.fst(33,17-33,43); use=FStar.DM4F.ST.fst(33,17-33,43)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e
@x0)
(let ((@lb1 (ApplyTT (FStar.DM4F.IntST.__proj__STINT__item__get Tm_unit)
@x0)))
(FStar.Pervasives.Native.Mktuple2 Prims.int
Prims.int
(Prims.op_Addition (FStar.Pervasives.Native.Mktuple2__1 @lb1)
(BoxInt 1))
(FStar.Pervasives.Native.Mktuple2__2 @lb1))))
 

:pattern ((ApplyTT Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e
@x0))
:qid interpretation_Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e))

:named interpretation_Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e))
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntST.ifc
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(89,5-89,8); use=FStar.DM4F.IntST.fst(89,5-89,8)
(forall ((@x0 Term))
 (! (= (FStar.DM4F.IntST.ifc @x0)
(let ((@lb1 @x0))
(ite (= @lb1
(BoxBool true))
Tm_abs_cd4af824bd65da4276f069890c42565c
Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e)))
 

:pattern ((FStar.DM4F.IntST.ifc @x0))
:qid equation_FStar.DM4F.IntST.ifc))

:named equation_FStar.DM4F.IntST.ifc))
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntST.decr
;;; Fact-ids: Name FStar.DM4F.IntST.decr; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(85,5-85,9); use=FStar.DM4F.IntST.fst(85,5-85,9)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (FStar.DM4F.IntST.decr @x0)
@x1)
(let ((@lb2 (ApplyTT (FStar.DM4F.IntST.__proj__STINT__item__get Tm_unit)
@x1)))
(ApplyTT (FStar.DM4F.IntST.__proj__STINT__item__put (Prims.op_Subtraction (FStar.Pervasives.Native.Mktuple2__1 @lb2)
(BoxInt 1)))
(FStar.Pervasives.Native.Mktuple2__2 @lb2))))
 

:pattern ((ApplyTT (FStar.DM4F.IntST.decr @x0)
@x1))
:qid equation_FStar.DM4F.IntST.decr))

:named equation_FStar.DM4F.IntST.decr))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Prims.l_Forall; Namespace Prims
(assert (! 
;; def=Prims.fst(286,16-286,86); use=Prims.fst(286,71-286,86)
...
@x1
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
...
@x1
Tm_arrow_2f0ea550a9a01b08d152bef225faf73e))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_2f0ea550a9a01b08d152bef225faf73e))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_2f0ea550a9a01b08d152bef225faf73e))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_2f0ea550a9a01b08d152bef225faf73e
;;; Fact-ids: Name FStar.DM4F.IntST.ifc; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_2f0ea550a9a01b08d152bef225faf73e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_2f0ea550a9a01b08d152bef225faf73e))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_2f0ea550a9a01b08d152bef225faf73e))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_2f0ea550a9a01b08d152bef225faf73e))
(push) ;; push{2

; Starting query at FStar.DM4F.IntST.fst(93,0-93,76)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: Prims.bool -> Prims.GTot Type
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(89,12-89,16); use=Prims.fst(454,7-454,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_500279c757ae94c6b581e1748c9c53d5))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_500279c757ae94c6b581e1748c9c53d5))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_500279c757ae94c6b581e1748c9c53d5))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_500279c757ae94c6b581e1748c9c53d5.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_500279c757ae94c6b581e1748c9c53d5))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_500279c757ae94c6b581e1748c9c53d5))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_500279c757ae94c6b581e1748c9c53d5))

(declare-fun Tm_abs_370a1d8bcc0fc83741dd74487829c498 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_370a1d8bcc0fc83741dd74487829c498
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(93,34-93,75); use=FStar.DM4F.IntST.fst(93,34-93,75)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_370a1d8bcc0fc83741dd74487829c498 @x0
@x1)
Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2)
 

:pattern ((Tm_abs_370a1d8bcc0fc83741dd74487829c498 @x0
@x1))
:qid typing_Tm_abs_370a1d8bcc0fc83741dd74487829c498))

:named typing_Tm_abs_370a1d8bcc0fc83741dd74487829c498))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_370a1d8bcc0fc83741dd74487829c498
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(93,34-93,75); use=FStar.DM4F.IntST.fst(93,34-93,75)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_370a1d8bcc0fc83741dd74487829c498 @x1
@x2)
@x0)
(Prims.b2t (Prims.op_Equality (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)
(ApplyTT (FStar.DM4F.IntST.ifc @x1)
@x0)
(ApplyTT (FStar.DM4F.IntST.ifc @x2)
@x0))))
 

:pattern ((ApplyTT (Tm_abs_370a1d8bcc0fc83741dd74487829c498 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_370a1d8bcc0fc83741dd74487829c498))

:named interpretation_Tm_abs_370a1d8bcc0fc83741dd74487829c498))

(declare-fun Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1 (Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(93,34-93,75); use=FStar.DM4F.IntST.fst(93,34-93,75)
(forall ((@x0 Term))
 (! (HasType (Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1 @x0)
Tm_arrow_500279c757ae94c6b581e1748c9c53d5)
 

:pattern ((Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1 @x0))
:qid typing_Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1))

:named typing_Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(93,34-93,75); use=FStar.DM4F.IntST.fst(93,34-93,75)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1 @x1)
@x0)
(Prims.l_Forall Prims.int
(Tm_abs_370a1d8bcc0fc83741dd74487829c498 @x1
@x0)))
 

:pattern ((ApplyTT (Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1 @x1)
@x0))
:qid interpretation_Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1))

:named interpretation_Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1))

(declare-fun Tm_abs_dfdcec8b0d0170253a14cb1936f9a601 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_dfdcec8b0d0170253a14cb1936f9a601
;;; Fact-ids: 
(assert (! (HasType Tm_abs_dfdcec8b0d0170253a14cb1936f9a601
Tm_arrow_500279c757ae94c6b581e1748c9c53d5)
:named typing_Tm_abs_dfdcec8b0d0170253a14cb1936f9a601))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_dfdcec8b0d0170253a14cb1936f9a601
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(93,31-93,75); use=FStar.DM4F.IntST.fst(93,31-93,75)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_dfdcec8b0d0170253a14cb1936f9a601
@x0)
(Prims.l_Forall Prims.bool
(Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1 @x0)))
 

:pattern ((ApplyTT Tm_abs_dfdcec8b0d0170253a14cb1936f9a601
@x0))
:qid interpretation_Tm_abs_dfdcec8b0d0170253a14cb1936f9a601))

:named interpretation_Tm_abs_dfdcec8b0d0170253a14cb1936f9a601))
;;;;;;;;;;;;;;;;Interpretation of deeply embedded quantifier
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.l_Forall Prims.bool
Tm_abs_dfdcec8b0d0170253a14cb1936f9a601))

;; def=FStar.DM4F.IntST.fst(93,20-93,76); use=FStar.DM4F.IntST.fst(93,20-93,76)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.bool)
(HasType @x1
...
;; def=FStar.DM4F.IntST.fst(93,38-93,75); use=FStar.DM4F.IntST.fst(93,38-93,75)
(= (ApplyTT (FStar.DM4F.IntST.ifc @x0)
@x2)
(ApplyTT (FStar.DM4F.IntST.ifc @x1)
@x2))
)
...
;;no pats
:qid l_quant_interp_103d4c03b48581cc96647957e1c566f5))
)
:named l_quant_interp_103d4c03b48581cc96647957e1c566f5))
...
;;no pats
:qid l_quant_interp_1a8fa71a78a73ebdba1f6cda7cc3570a.1))
)
 

:pattern ((Valid (Prims.l_Forall Prims.bool
(Tm_abs_9bbce87d7d4f9a42fa3cd6cf4be366c1 @x0))))
:qid l_quant_interp_1a8fa71a78a73ebdba1f6cda7cc3570a))

:named l_quant_interp_1a8fa71a78a73ebdba1f6cda7cc3570a))



; Encoding query formula : (forall (h0: Prims.bool).
;     (*  - Could not prove post-condition
; *)
;     forall (h1: Prims.bool).
;       (*  - Could not prove post-condition
; *)
;       forall (s0: Prims.int).
...
; *)
;         Prims.hasEq (Prims.int & Prims.int)) /\
; (forall (any_result: (_: Prims.bool -> Prims.GTot Type0)).
;     (fun h0 ->
;         forall (h1: Prims.bool) (s0: Prims.int).
;           reify (FStar.DM4F.IntST.ifc h0) s0 = reify (FStar.DM4F.IntST.ifc h1) s0) ==
;     any_result ==>
;     (forall (any_result: Prims.logical).
;         (forall (h0: Prims.bool) (h1: Prims.bool) (s0: Prims.int).
;             reify (FStar.DM4F.IntST.ifc h0) s0 = reify (FStar.DM4F.IntST.ifc h1) s0) ==
;         any_result ==>
;         (forall (h0: Prims.bool) (h1: Prims.bool) (s0: Prims.int).
;             reify (FStar.DM4F.IntST.ifc h0) s0 = reify (FStar.DM4F.IntST.ifc h1) s0)))
...
; While typechecking the top-level declaration `let ni_ifc`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(93,31-93,75)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.bool)

;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(93,34-93,75)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.int)

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.ST.fst(27,34-27,41)
(or label_1

;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.IntST.fst(93,34-93,75)
(Valid 
;; def=Prims.fst(73,23-73,30); use=FStar.DM4F.IntST.fst(93,34-93,75)
...
;; def=Prims.fst(286,26-286,27); use=Prims.fst(286,26-286,27)
(= Tm_abs_dfdcec8b0d0170253a14cb1936f9a601
@x0)
)
...
;; def=Prims.fst(672,13-672,14); use=Prims.fst(672,13-672,14)
(= (Prims.l_Forall Prims.bool
Tm_abs_dfdcec8b0d0170253a14cb1936f9a601)
@x1)
)

;; def=FStar.DM4F.IntST.fst(93,20-93,76); use=FStar.DM4F.IntST.fst(93,13-93,19)
...
;; def=FStar.DM4F.IntST.fst(93,38-93,75); use=FStar.DM4F.IntST.fst(93,13-93,19)
(or label_2

;; def=FStar.DM4F.IntST.fst(93,38-93,75); use=FStar.DM4F.IntST.fst(93,13-93,19)
(= (ApplyTT (FStar.DM4F.IntST.ifc @x2)
@x4)
(ApplyTT (FStar.DM4F.IntST.ifc @x3)
@x4))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntST.ni_ifc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.IntST.__proj__STINT__item__get_equality, FStar.DM4F.IntST.__proj__STINT__item__put_equality, FStar.DM4F.IntST_interpretation_Tm_arrow_2f0ea550a9a01b08d152bef225faf73e, Prims_pretyping_ae567c2fb75be05905677af440075565, Prims_pretyping_f8666440faa91836cc5a13998af863fc, assumption_FStar.Pervasives.Native.tuple2__uu___haseq, data_elim_FStar.Pervasives.Native.Mktuple2, equation_FStar.DM4F.IntST.decr, equation_FStar.DM4F.IntST.ifc, equation_FStar.DM4F.IntST.incr, equation_Prims.eqtype, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, function_token_typing_Prims.__cache_version_number__, int_inversion, interpretation_Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c, interpretation_Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61, interpretation_Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c, interpretation_Tm_abs_7ca25d477a3e0e2f7c64f9fcd444202e, interpretation_Tm_abs_cc18103f7e8a41ead5051007b34f3b4b, interpretation_Tm_abs_cd4af824bd65da4276f069890c42565c, primitive_Prims.op_Addition, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_5cb9baf456c638b9dd0f9af1eaa1a563, typing_FStar.DM4F.IntST.ifc, typing_Prims.int, unit_typing
...
; encoding sigelt val FStar.DM4F.IntST.action_get
...
; Starting query at FStar.DM4F.IntST.fst(99,22-99,28)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: Prims.unit) (i: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (Prims.int & Prims.int)).
;     p (i, i) ==> (forall (return_val: Prims.int & Prims.int). return_val == (i, i) ==> p return_val)


; Context: While encoding a query
; While typechecking the top-level declaration `let action_get`
...
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Prims.pure_post (FStar.Pervasives.Native.tuple2 Prims.int
Prims.int)))

;; def=FStar.DM4F.IntST.fst(98,52-98,63); use=FStar.DM4F.IntST.fst(99,22-99,28)
(Valid 
;; def=FStar.DM4F.IntST.fst(98,52-98,63); use=FStar.DM4F.IntST.fst(99,22-99,28)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 Prims.int
...
;; def=Prims.fst(356,46-356,58); use=FStar.DM4F.IntST.fst(99,22-99,28)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntST.action_get, 1)
; STATUS: unsat
...
; encoding sigelt let action_get
...
;;;;;;;;;;;;;;;;u144: Prims.unit -> repr Prims.int (fun n post -> post (n, n))
...
; encoding sigelt val FStar.DM4F.IntST.action_put
...
; Starting query at FStar.DM4F.IntST.fst(102,21-102,28)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (x: Prims.int) (i: Prims.int).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post (Prims.unit & Prims.int)).
;     p ((), x) ==>
;     (forall (return_val: Prims.unit & Prims.int). return_val == ((), x) ==> p return_val)


; Context: While encoding a query
; While typechecking the top-level declaration `let action_put`
...
;; def=FStar.DM4F.IntST.fst(101,50-101,62); use=FStar.DM4F.IntST.fst(102,21-102,28)
(Valid 
;; def=FStar.DM4F.IntST.fst(101,50-101,62); use=FStar.DM4F.IntST.fst(102,21-102,28)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=Prims.fst(356,46-356,58); use=FStar.DM4F.IntST.fst(102,21-102,28)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntST.action_put, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt let action_put
...
; encoding sigelt val FStar.DM4F.IntST.get'
...
; encoding sigelt val FStar.DM4F.IntST.put'
...
; Starting query at FStar.DM4F.IntST.fst(110,47-114,15)
...
; *)
;   forall (_: Prims.int) (p: Prims.pure_post (Prims.unit & Prims.int)).
;     (forall (x: Prims.unit & Prims.int). p x) ==>
;     (forall (x: Prims.unit & Prims.int).
;         reify (FStar.DM4F.IntST.incr ()) _ == x ==>
;         (forall (e1: Prims.unit) (e1: Prims.int).
;             reify (FStar.DM4F.IntST.incr ()) _ == (e1, e1) ==> e1 = _ + 1)
;         <:
;         Type0)


; Context: While encoding a query
; While typechecking the top-level declaration `let assert_after_reify`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(110,47-114,15)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
Prims.int)
(HasType @x2
...
;; def=FStar.DM4F.IntST.fst(54,50-54,75); use=FStar.DM4F.IntST.fst(110,47-114,15)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))

;; def=FStar.DM4F.IntST.fst(54,72-54,75); use=FStar.DM4F.IntST.fst(110,47-114,15)
(Valid 
;; def=FStar.DM4F.IntST.fst(54,72-54,75); use=FStar.DM4F.IntST.fst(110,47-114,15)
(ApplyTT @x2
@x3)
...
;; def=FStar.DM4F.IntST.fst(54,50-54,75); use=FStar.DM4F.IntST.fst(112,21-112,25)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))

;; def=FStar.DM4F.IntST.fst(112,6-112,32); use=FStar.DM4F.IntST.fst(112,6-112,32)
(= (ApplyTT (FStar.DM4F.IntST.incr Tm_unit)
@x1)
@x3)
)
...
;; def=FStar.DM4F.IntST.fst(112,6-112,11); use=FStar.DM4F.IntST.fst(112,6-112,11)
(= (ApplyTT (FStar.DM4F.IntST.incr Tm_unit)
@x1)
(FStar.Pervasives.Native.Mktuple2 Prims.unit
Prims.int
...
;; def=FStar.DM4F.IntST.fst(113,9-113,22); use=FStar.DM4F.IntST.fst(113,2-113,8)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntST.assert_after_reify, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.IntST.__proj__STINT__item__get_equality, FStar.DM4F.IntST.__proj__STINT__item__put_equality, equation_FStar.DM4F.IntST.incr, int_inversion, interpretation_Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c, interpretation_Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61, interpretation_Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c, interpretation_Tm_abs_cc18103f7e8a41ead5051007b34f3b4b, primitive_Prims.op_Addition, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2, unit_inversion
...
; encoding sigelt let assert_after_reify
...
; encoding sigelt val FStar.DM4F.IntST.assert_after_reflect


; <Skipped val FStar.DM4F.IntST.assert_after_reflect/>


; encoding sigelt let assert_after_reflect
...
; encoding sigelt val FStar.DM4F.IntST.reflect_on_the_fly
...
; Starting query at FStar.DM4F.IntST.fst(125,26-133,4)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u567: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.int) (p: Prims.pure_post (Prims.int & Prims.int)).
;     (forall (x: Prims.int & Prims.int). p x) ==>
;     (forall (n0: Prims.int).
;         (*  - Could not prove post-condition
; *)
;         forall (p: Prims.pure_post (Prims.unit & Prims.int)).
;           p ((), n0 + 2) ==>
;           (forall (return_val: Prims.unit & Prims.int). return_val == ((), n0 + 2) ==> p return_val)
;     )


; Context: While encoding a query
; While typechecking the top-level declaration `let reflect_on_the_fly`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(125,26-133,4)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
Prims.int)
(HasType @x2
...
;; def=FStar.DM4F.IntST.fst(54,50-54,75); use=FStar.DM4F.IntST.fst(125,26-133,4)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.Pervasives.Native.tuple2 Prims.int
Prims.int))

;; def=FStar.DM4F.IntST.fst(54,72-54,75); use=FStar.DM4F.IntST.fst(125,26-133,4)
(Valid 
;; def=FStar.DM4F.IntST.fst(54,72-54,75); use=FStar.DM4F.IntST.fst(125,26-133,4)
(ApplyTT @x2
@x3)
...
;; def=Prims.fst(406,51-406,91); use=FStar.DM4F.IntST.fst(125,26-133,4)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.pure_post (FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int)))

;; def=FStar.DM4F.IntST.fst(127,41-127,57); use=FStar.DM4F.IntST.fst(129,14-129,22)
(Valid 
;; def=FStar.DM4F.IntST.fst(127,41-127,57); use=FStar.DM4F.IntST.fst(129,14-129,22)
(ApplyTT @x4
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=Prims.fst(356,2-356,58); use=FStar.DM4F.IntST.fst(125,26-133,4)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))

;; def=Prims.fst(356,26-356,41); use=FStar.DM4F.IntST.fst(125,26-133,4)
(= @x5
(FStar.Pervasives.Native.Mktuple2 Prims.unit
Prims.int
Tm_unit
...
;; def=Prims.fst(356,46-356,58); use=FStar.DM4F.IntST.fst(129,14-129,22)
(or label_1

;; def=Prims.fst(356,46-356,58); use=FStar.DM4F.IntST.fst(125,26-133,4)
(Valid 
;; def=Prims.fst(356,46-356,58); use=FStar.DM4F.IntST.fst(125,26-133,4)
(ApplyTT @x4
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntST.reflect_on_the_fly, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query
...
; encoding sigelt let reflect_on_the_fly
...
; Starting query at FStar.DM4F.IntST.fst(151,3-159,20)
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_28cb490ddce9081249876a97abea3031
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-142,17); use=FStar.DM4F.IntST.fst(22,12-144,23)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_28cb490ddce9081249876a97abea3031 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_28cb490ddce9081249876a97abea3031 @x0)
Tm_type))
:qid kinding_Tm_arrow_28cb490ddce9081249876a97abea3031))

:named kinding_Tm_arrow_28cb490ddce9081249876a97abea3031))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-142,17); use=FStar.DM4F.IntST.fst(22,12-144,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_28cb490ddce9081249876a97abea3031 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_28cb490ddce9081249876a97abea3031 @x2)))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_28cb490ddce9081249876a97abea3031))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_28cb490ddce9081249876a97abea3031))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_28cb490ddce9081249876a97abea3031
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-142,17); use=FStar.DM4F.IntST.fst(22,12-144,23)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_28cb490ddce9081249876a97abea3031 @x1))
(and 
;; def=FStar.DM4F.IntST.fst(22,12-142,17); use=FStar.DM4F.IntST.fst(22,12-144,23)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_28cb490ddce9081249876a97abea3031.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_28cb490ddce9081249876a97abea3031 @x1)))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_28cb490ddce9081249876a97abea3031))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_28cb490ddce9081249876a97abea3031))
;;;;;;;;;;;;;;;;_: Prims.int -> _: b -> _: Prims.int -> Type
(declare-fun Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(143,16-145,61); use=FStar.DM4F.IntST.fst(145,33-145,61)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13 @x0)
Tm_type))
:qid kinding_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13))

:named kinding_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(143,16-145,61); use=FStar.DM4F.IntST.fst(145,33-145,61)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13 @x2)))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(143,16-145,61); use=FStar.DM4F.IntST.fst(145,33-145,61)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13 @x1))
(and 
;; def=FStar.DM4F.IntST.fst(143,16-145,61); use=FStar.DM4F.IntST.fst(145,33-145,61)
(forall ((@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x2
...
@x3)
@x4))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13.1))
...
:pattern ((ApplyTT @x0
@x2))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13.2))
...
@x2)
@x3))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13.3))
))
 

:pattern ((HasTypeZ @x0
(Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13 @x1)))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_60cde7f9b7b067b3b5ad214f4d4e2c13))
;;;;;;;;;;;;;;;;_: a -> _: Prims.int -> _: b -> _: Prims.int -> Type
(declare-fun Tm_arrow_b8742cb779dae441c1980f30dc033e62 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b8742cb779dae441c1980f30dc033e62
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(142,16-145,61); use=FStar.DM4F.IntST.fst(145,23-145,61)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_b8742cb779dae441c1980f30dc033e62 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_b8742cb779dae441c1980f30dc033e62 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_b8742cb779dae441c1980f30dc033e62))

:named kinding_Tm_arrow_b8742cb779dae441c1980f30dc033e62))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(142,16-145,61); use=FStar.DM4F.IntST.fst(145,23-145,61)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_b8742cb779dae441c1980f30dc033e62 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_b8742cb779dae441c1980f30dc033e62 @x2
@x3)))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_b8742cb779dae441c1980f30dc033e62))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_b8742cb779dae441c1980f30dc033e62))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b8742cb779dae441c1980f30dc033e62
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(142,16-145,61); use=FStar.DM4F.IntST.fst(145,23-145,61)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_b8742cb779dae441c1980f30dc033e62 @x1
@x2))
(and 
;; def=FStar.DM4F.IntST.fst(142,16-145,61); use=FStar.DM4F.IntST.fst(145,23-145,61)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_b8742cb779dae441c1980f30dc033e62.1))
...
(Tm_arrow_b8742cb779dae441c1980f30dc033e62 @x1
@x2)))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_b8742cb779dae441c1980f30dc033e62))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_b8742cb779dae441c1980f30dc033e62))
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(142,16-143,17); use=FStar.DM4F.IntST.fst(146,22-146,34)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
Tm_type)
(HasType @x2
(Tm_arrow_28cb490ddce9081249876a97abea3031 @x0))
(HasType @x3
(Tm_arrow_b8742cb779dae441c1980f30dc033e62 @x1
@x0)))
(HasType (Non_total_Tm_arrow_fc5a94b9b334bfa13cd4789208877f69 @x0
@x1
@x2
@x3)
Tm_type))
...
:pattern ((HasType (Non_total_Tm_arrow_fc5a94b9b334bfa13cd4789208877f69 @x0
@x1
@x2
@x3)
Tm_type))
:qid non_total_function_typing_Non_total_Tm_arrow_fc5a94b9b334bfa13cd4789208877f69))

:named non_total_function_typing_Non_total_Tm_arrow_fc5a94b9b334bfa13cd4789208877f69))
(declare-fun Tm_refine_98ba9da66053ac9c893fb1b5685c2c11 (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(152,13-152,22); use=FStar.DM4F.IntST.fst(151,3-159,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (HasType (Tm_refine_98ba9da66053ac9c893fb1b5685c2c11 @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_98ba9da66053ac9c893fb1b5685c2c11 @x0
@x1
@x2
@x3
@x4
@x5)
Tm_type))
:qid refinement_kinding_Tm_refine_98ba9da66053ac9c893fb1b5685c2c11))

:named refinement_kinding_Tm_refine_98ba9da66053ac9c893fb1b5685c2c11))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(152,13-152,22); use=FStar.DM4F.IntST.fst(151,3-159,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_98ba9da66053ac9c893fb1b5685c2c11 @x2
@x3
@x4
@x5
@x6
...
;; def=FStar.DM4F.IntST.fst(154,28-156,37); use=FStar.DM4F.IntST.fst(151,3-159,20)
(and 
;; def=FStar.DM4F.IntST.fst(154,28-154,36); use=FStar.DM4F.IntST.fst(151,3-159,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(154,28-154,36); use=FStar.DM4F.IntST.fst(151,3-159,20)
(ApplyTT (ApplyTT @x2
@x3)
...
;; def=FStar.DM4F.IntST.fst(155,23-155,48); use=FStar.DM4F.IntST.fst(151,3-159,20)
(= (ApplyTT (ApplyTT @x5
@x3)
@x4)
...
;; def=FStar.DM4F.IntST.fst(156,23-156,37); use=FStar.DM4F.IntST.fst(151,3-159,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(156,23-156,37); use=FStar.DM4F.IntST.fst(151,3-159,20)
...
@x6
@x7)))
:qid refinement_interpretation_Tm_refine_98ba9da66053ac9c893fb1b5685c2c11))

:named refinement_interpretation_Tm_refine_98ba9da66053ac9c893fb1b5685c2c11))
;;;;;;;;;;;;;;;;haseq for Tm_refine_98ba9da66053ac9c893fb1b5685c2c11
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(152,13-152,22); use=FStar.DM4F.IntST.fst(151,3-159,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_98ba9da66053ac9c893fb1b5685c2c11 @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_98ba9da66053ac9c893fb1b5685c2c11 @x0
@x1
@x2
@x3
@x4
@x5))))
:qid haseqTm_refine_98ba9da66053ac9c893fb1b5685c2c11))

:named haseqTm_refine_98ba9da66053ac9c893fb1b5685c2c11))
;;;;;;;;;;;;;;;;h0: Prims.int -> Prims.Pure (b & Prims.int)
(declare-fun Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(151,14-152,22); use=FStar.DM4F.IntST.fst(151,3-159,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (HasType (Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e @x0
@x1
@x2
@x3
@x4)
...
:pattern ((HasType (Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e @x0
@x1
@x2
@x3
@x4)
Tm_type))
:qid kinding_Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e))

:named kinding_Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(151,14-152,22); use=FStar.DM4F.IntST.fst(151,3-159,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e @x2
@x3
@x4
@x5
@x6))
...
@x5
@x6)))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(151,14-152,22); use=FStar.DM4F.IntST.fst(151,3-159,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e @x1
@x2
@x3
@x4
@x5))
...
(forall ((@x6 Term))
 (! (implies (and 
;; def=FStar.DM4F.IntST.fst(153,13-153,23); use=FStar.DM4F.IntST.fst(151,3-159,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(153,13-153,23); use=FStar.DM4F.IntST.fst(151,3-159,20)
(ApplyTT (ApplyTT @x5
@x4)
...
(HasType (ApplyTT @x0
@x6)
(Tm_refine_98ba9da66053ac9c893fb1b5685c2c11 @x5
@x4
@x6
@x3
@x2
...
:pattern ((ApplyTT @x0
@x6))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e.1))
...
@x4
@x5)))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e))
(declare-fun Tm_abs_56ee54867b14345d14636776f2732f63 (Term Term) Term)
;;;;;;;;;;;;;;;;tot_fun_Tm_abs_56ee54867b14345d14636776f2732f63
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(157,8-157,22); use=FStar.DM4F.IntST.fst(157,8-157,22)
(forall ((@x0 Term) (@x1 Term))
 (! (IsTotFun (Tm_abs_56ee54867b14345d14636776f2732f63 @x0
@x1))
 

:pattern ((Tm_abs_56ee54867b14345d14636776f2732f63 @x0
@x1))
:qid tot_fun_Tm_abs_56ee54867b14345d14636776f2732f63))

:named tot_fun_Tm_abs_56ee54867b14345d14636776f2732f63))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_56ee54867b14345d14636776f2732f63
;;; Fact-ids: 
(assert (! 
;; def=FStar.DM4F.IntST.fst(157,8-157,22); use=FStar.DM4F.IntST.fst(157,8-157,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_56ee54867b14345d14636776f2732f63 @x1
@x2)
@x0)
(ApplyTT (ApplyTT @x2
@x1)
...
:pattern ((ApplyTT (Tm_abs_56ee54867b14345d14636776f2732f63 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_56ee54867b14345d14636776f2732f63))

:named interpretation_Tm_abs_56ee54867b14345d14636776f2732f63))

; Encoding query formula : forall (a: Type)
;   (b: Type)
;   (pre: (_: a -> _: Prims.int -> Type))
;   (post: (_: a -> _: Prims.int -> _: b -> _: Prims.int -> Type))
;   (f: (x: a -> FStar.DM4F.IntST.StInt b))
;   (x: a).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.int) (p: Prims.pure_post (b & Prims.int)).
;     pre x _ /\
;     (forall (a: b) (n1: Prims.int).
;         pre x _ /\ pre x _ /\ (reify (f x) _ == (a, n1)) /\ post x _ a n1 ==> p (a, n1)) ==>
;     (forall (h0: Prims.int).
;         (forall (p: Prims.pure_post (b & Prims.int)).
;             pre x h0 /\
;             (forall (pure_result: b & Prims.int).
;                 (let z, h1 = pure_result in
;                   pre x h0 /\ reify (f x) h0 == (z, h1) /\ post x h0 z h1) ==>
;                 p pure_result) ==>
;             pre x h0 /\
;             (forall (a: b) (n1: Prims.int).
;                 pre x h0 /\ post x h0 a n1 ==>
;                 (a, n1) == reify (f x) h0 ==>
;                 (forall (return_val: b & Prims.int). return_val == (a, n1) ==> p return_val))) /\
;         (forall (p: Prims.pure_post (b & Prims.int)).
;             pre x h0 /\
;             (forall (pure_result: b & Prims.int).
;                 (let z, h1 = pure_result in
...
;                 (let z, h1 = pure_result in
;                   pre x h0 /\ reify (f x) h0 == (z, h1) /\ post x h0 z h1) ==>
;                 pure_result == reify (f x) h0 ==>
;                 (forall (return_val: b & Prims.int). return_val == pure_result ==> p return_val)))) /\
;     (forall (any_result: (h0: Prims.int -> Prims.Pure (b & Prims.int))).
;         (fun h0 -> reify (f x) h0 <: Prims.Pure (b & Prims.int)) == any_result ==>
;         pre x _ /\
;         (forall (pure_result: b & Prims.int).
;             (let z, h1 = pure_result in
;               pre x _ /\ reify (f x) _ == (z, h1) /\ post x _ z h1) ==>
;             p pure_result)
;         <:
;         Type0)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let refine_st`
; While typechecking the top-level declaration `[@@expect_failure] let refine_st`
...
@x0))
(HasType @x4
(Non_total_Tm_arrow_fc5a94b9b334bfa13cd4789208877f69 @x0
@x1
@x2
@x3))
(HasType @x5
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(151,3-159,20)
...
;; def=FStar.DM4F.IntST.fst(49,23-49,29); use=FStar.DM4F.IntST.fst(151,3-159,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(49,23-49,29); use=FStar.DM4F.IntST.fst(151,3-159,20)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=FStar.DM4F.IntST.fst(50,12-50,63); use=FStar.DM4F.IntST.fst(151,3-159,20)
...
;; def=FStar.DM4F.IntST.fst(50,26-50,32); use=FStar.DM4F.IntST.fst(151,3-159,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(50,26-50,32); use=FStar.DM4F.IntST.fst(151,3-159,20)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=FStar.DM4F.IntST.fst(148,36-148,44); use=FStar.DM4F.IntST.fst(151,3-159,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(148,36-148,44); use=FStar.DM4F.IntST.fst(151,3-159,20)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=FStar.DM4F.IntST.fst(149,33-149,58); use=FStar.DM4F.IntST.fst(151,3-159,20)
(= (ApplyTT (ApplyTT @x4
@x5)
@x6)
(FStar.Pervasives.Native.Mktuple2 @x1
...
;; def=FStar.DM4F.IntST.fst(150,33-150,47); use=FStar.DM4F.IntST.fst(151,3-159,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(150,33-150,47); use=FStar.DM4F.IntST.fst(151,3-159,20)
...
;; def=FStar.DM4F.IntST.fst(50,53-50,62); use=FStar.DM4F.IntST.fst(151,3-159,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(50,53-50,62); use=FStar.DM4F.IntST.fst(151,3-159,20)
(ApplyTT @x7
(FStar.Pervasives.Native.Mktuple2 @x1
...
;; def=Prims.fst(459,77-459,89); use=FStar.DM4F.IntST.fst(151,3-159,20)
(and 
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(151,3-159,20)
(forall ((@x8 Term))
 (! (implies (HasType @x8
...
;; def=Prims.fst(406,51-406,91); use=FStar.DM4F.IntST.fst(151,3-159,20)
(and 
;; def=Prims.fst(406,51-406,91); use=FStar.DM4F.IntST.fst(151,3-159,20)
(forall ((@x9 Term))
...
;; def=FStar.DM4F.IntST.fst(153,13-153,23); use=FStar.DM4F.IntST.fst(157,8-157,22)
(Valid 
;; def=FStar.DM4F.IntST.fst(153,13-153,23); use=FStar.DM4F.IntST.fst(157,8-157,22)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.IntST.fst(157,8-157,22)
(forall ((@x10 Term))
...
;; def=FStar.DM4F.IntST.fst(154,28-156,37); use=FStar.DM4F.IntST.fst(157,8-157,22)
(and 
;; def=FStar.DM4F.IntST.fst(154,28-154,36); use=FStar.DM4F.IntST.fst(157,8-157,22)
(or label_2
...
;; def=FStar.DM4F.IntST.fst(155,23-155,48); use=FStar.DM4F.IntST.fst(157,8-157,22)
(or label_3
...
;; def=FStar.DM4F.IntST.fst(156,23-156,37); use=FStar.DM4F.IntST.fst(157,8-157,22)
(or label_4
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.IntST.fst(157,8-157,22)
(Valid 
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.IntST.fst(157,8-157,22)
(ApplyTT @x9
@x10)
...
;; def=FStar.DM4F.IntST.fst(49,23-50,63); use=FStar.DM4F.IntST.fst(157,15-157,16)
(and 
;; def=FStar.DM4F.IntST.fst(49,23-49,29); use=FStar.DM4F.IntST.fst(157,15-157,16)
(or label_5
...
;; def=FStar.DM4F.IntST.fst(50,12-50,63); use=FStar.DM4F.IntST.fst(157,15-157,16)
...
;; def=FStar.DM4F.IntST.fst(50,26-50,32); use=FStar.DM4F.IntST.fst(157,15-157,16)
(Valid 
;; def=FStar.DM4F.IntST.fst(50,26-50,32); use=FStar.DM4F.IntST.fst(157,15-157,16)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=FStar.DM4F.IntST.fst(50,36-50,48); use=FStar.DM4F.IntST.fst(157,15-157,16)
(Valid 
;; def=FStar.DM4F.IntST.fst(50,36-50,48); use=FStar.DM4F.IntST.fst(157,15-157,16)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT @x3
@x5)
...
;; def=FStar.DM4F.IntST.fst(152,13-157,22); use=FStar.DM4F.IntST.fst(157,8-157,22)
(= (FStar.Pervasives.Native.Mktuple2 @x1
Prims.int
@x10
@x11)
...
;; def=Prims.fst(356,2-356,58); use=FStar.DM4F.IntST.fst(151,3-159,20)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
(FStar.Pervasives.Native.tuple2 @x1
Prims.int))

;; def=Prims.fst(356,26-356,41); use=FStar.DM4F.IntST.fst(151,3-159,20)
(= @x12
(FStar.Pervasives.Native.Mktuple2 @x1
Prims.int
@x10
...
;; def=Prims.fst(356,46-356,58); use=FStar.DM4F.IntST.fst(151,3-159,20)
(Valid 
;; def=Prims.fst(356,46-356,58); use=FStar.DM4F.IntST.fst(151,3-159,20)
(ApplyTT @x9
@x12)
...
;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.IntST.fst(157,8-157,22)
(and 
;; def=FStar.DM4F.IntST.fst(153,13-153,23); use=FStar.DM4F.IntST.fst(157,8-157,22)
(or label_10
...
;; def=Prims.fst(451,66-451,102); use=FStar.DM4F.IntST.fst(151,3-159,20)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Tm_arrow_9bd4ef2a1d3df1e383ea950e4ad16c3e @x3
@x1
@x4
@x5
@x2))

;; def=FStar.DM4F.IntST.fst(151,8-157,22); use=FStar.DM4F.IntST.fst(151,8-157,22)
(= (Tm_abs_56ee54867b14345d14636776f2732f63 @x5
@x4)
@x8)
)

;; def=Prims.fst(441,29-441,97); use=FStar.DM4F.IntST.fst(159,19-159,20)
(and 
;; def=FStar.DM4F.IntST.fst(153,13-153,23); use=FStar.DM4F.IntST.fst(159,19-159,20)
(or label_11
...
;; def=Prims.fst(441,36-441,97); use=FStar.DM4F.IntST.fst(159,19-159,20)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(FStar.Pervasives.Native.tuple2 @x1
Prims.int))
...
;; def=FStar.DM4F.IntST.fst(154,28-156,37); use=FStar.DM4F.IntST.fst(159,19-159,20)
(and 
;; def=FStar.DM4F.IntST.fst(154,28-154,36); use=FStar.DM4F.IntST.fst(159,19-159,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(154,28-154,36); use=FStar.DM4F.IntST.fst(159,19-159,20)
(ApplyTT (ApplyTT @x2
@x5)
...
;; def=FStar.DM4F.IntST.fst(155,23-155,48); use=FStar.DM4F.IntST.fst(159,19-159,20)
(= (ApplyTT (ApplyTT @x4
@x5)
@x6)
(FStar.Pervasives.Native.Mktuple2 @x1
...
;; def=FStar.DM4F.IntST.fst(156,23-156,37); use=FStar.DM4F.IntST.fst(159,19-159,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(156,23-156,37); use=FStar.DM4F.IntST.fst(159,19-159,20)
(ApplyTT (ApplyTT (ApplyTT (ApplyTT @x3
@x5)
...
;; def=Prims.fst(441,83-441,96); use=FStar.DM4F.IntST.fst(159,19-159,20)
(or label_12
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntST.refine_st, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, data_elim_FStar.Pervasives.Native.Mktuple2, fuel_guarded_inversion_FStar.Pervasives.Native.tuple2, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
...
; encoding sigelt val FStar.DM4F.IntST.refine_st
...
; encoding sigelt val FStar.DM4F.IntST.incr_pre_post
...
; Starting query at FStar.DM4F.IntST.fst(176,21-178,20)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u161: Prims.unit).
;   (*  - Could not prove post-condition
; *)
;   forall (_: Prims.int) (p: Prims.pure_post (Prims.unit & Prims.int)).
;     (forall (a: Prims.unit) (n1: Prims.int). Prims.auto_squash (p (a, n1))) ==> p ((), _ + 1)


; Context: While encoding a query
; While typechecking the top-level declaration `let incr_pre_post`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(176,21-178,20)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
Prims.int)
(HasType @x2
...
;; def=FStar.DM4F.IntST.fst(50,12-50,63); use=FStar.DM4F.IntST.fst(176,21-178,20)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
Prims.unit)
(HasType @x4
...
;; def=FStar.DM4F.IntST.fst(50,53-50,62); use=FStar.DM4F.IntST.fst(176,21-178,20)
(Valid 
;; def=FStar.DM4F.IntST.fst(50,53-50,62); use=FStar.DM4F.IntST.fst(176,21-178,20)
(ApplyTT @x2
(FStar.Pervasives.Native.Mktuple2 Prims.unit
...
;; def=FStar.DM4F.ST.fst(40,46-40,51); use=FStar.DM4F.IntST.fst(178,9-178,12)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntST.incr_pre_post, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, int_typing, primitive_Prims.op_Addition, unit_typing
...
; encoding sigelt let incr_pre_post
...
(assert (! 
;; def=FStar.DM4F.IntST.fst(176,4-176,17); use=FStar.DM4F.IntST.fst(176,4-176,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.unit)
(HasType (FStar.DM4F.IntST.incr_pre_post @x0)
Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53))
 

:pattern ((FStar.DM4F.IntST.incr_pre_post @x0))
:qid typing_FStar.DM4F.IntST.incr_pre_post))

:named typing_FStar.DM4F.IntST.incr_pre_post))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.DM4F.IntST.incr_pre_post; Namespace FStar.DM4F.IntST
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53
;;; Fact-ids: Name FStar.DM4F.IntST.incr_pre_post; Namespace FStar.DM4F.IntST
(assert (! (HasType Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53
Tm_type)
:named kinding_Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53))
...
;;;;;;;;;;;;;;;;Equation for FStar.DM4F.IntST.incr_pre_post
;;; Fact-ids: Name FStar.DM4F.IntST.incr_pre_post; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(176,4-176,17); use=FStar.DM4F.IntST.fst(176,4-176,17)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (FStar.DM4F.IntST.incr_pre_post @x0)
@x1)
(let ((@lb2 (ApplyTT (FStar.DM4F.IntST.__proj__STINT__item__get Tm_unit)
@x1)))
(ApplyTT (FStar.DM4F.IntST.__proj__STINT__item__put (Prims.op_Addition (FStar.Pervasives.Native.Mktuple2__1 @lb2)
...
:pattern ((ApplyTT (FStar.DM4F.IntST.incr_pre_post @x0)
@x1))
:qid equation_FStar.DM4F.IntST.incr_pre_post))

:named equation_FStar.DM4F.IntST.incr_pre_post))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.DM4F.IntST.incr_pre_post; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
...
@x1
Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53))
:qid FStar.DM4F.IntST_pre_typing_Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53))

:named FStar.DM4F.IntST_pre_typing_Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53
;;; Fact-ids: Name FStar.DM4F.IntST.incr_pre_post; Namespace FStar.DM4F.IntST
(assert (! 
;; def=FStar.DM4F.IntST.fst(22,12-22,15); use=FStar.DM4F.IntST.fst(22,12-22,15)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53))
:qid FStar.DM4F.IntST_interpretation_Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53))

:named FStar.DM4F.IntST_interpretation_Tm_arrow_5c7e4dbc4a313063db097fbf8f4b6e53))
(push) ;; push{2

; Starting query at FStar.DM4F.IntST.fst(180,48-184,22)
...
;   forall (_: Prims.int) (p: Prims.pure_post (Prims.unit & Prims.int)).
;     (forall (x: Prims.unit & Prims.int). p x) ==>
;     (forall (a: Prims.unit) (n1: Prims.int).
;         reify (FStar.DM4F.IntST.incr_pre_post ()) _ == (a, n1) ==> n1 == _ + 1)


; Context: While encoding a query
; While typechecking the top-level declaration `let refine_st_incr_test`
...
;; def=dummy(0,0-0,0); use=FStar.DM4F.IntST.fst(180,48-184,22)
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
Prims.int)
(HasType @x2
...
;; def=FStar.DM4F.IntST.fst(54,50-54,75); use=FStar.DM4F.IntST.fst(180,48-184,22)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(FStar.Pervasives.Native.tuple2 Prims.unit
Prims.int))

;; def=FStar.DM4F.IntST.fst(54,72-54,75); use=FStar.DM4F.IntST.fst(180,48-184,22)
(Valid 
;; def=FStar.DM4F.IntST.fst(54,72-54,75); use=FStar.DM4F.IntST.fst(180,48-184,22)
(ApplyTT @x2
@x3)
...
;; def=FStar.DM4F.IntST.fst(50,12-50,63); use=FStar.DM4F.IntST.fst(182,2-182,11)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
Prims.unit)
(HasType @x4
...
;; def=FStar.DM4F.IntST.fst(169,33-169,58); use=FStar.DM4F.IntST.fst(182,2-182,11)
(= (ApplyTT (FStar.DM4F.IntST.incr_pre_post Tm_unit)
@x1)
(FStar.Pervasives.Native.Mktuple2 Prims.unit
Prims.int
@x3
...
;; def=FStar.DM4F.IntST.fst(184,8-184,22); use=FStar.DM4F.IntST.fst(184,2-184,8)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.IntST.refine_st_incr_test, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.DM4F.IntST.__proj__STINT__item__get_equality, FStar.DM4F.IntST.__proj__STINT__item__put_equality, equation_FStar.DM4F.IntST.incr_pre_post, int_inversion, interpretation_Tm_abs_3aba40c279a473a1fd8e3aa30e0da69c, interpretation_Tm_abs_3b12ca74b1b9de681bdba7dc5e067b61, interpretation_Tm_abs_3f340b2bb143d587cd9ff9d17b0c4a7c, interpretation_Tm_abs_cc18103f7e8a41ead5051007b34f3b4b, primitive_Prims.op_Addition, projection_inverse_FStar.Pervasives.Native.Mktuple2__1, projection_inverse_FStar.Pervasives.Native.Mktuple2__2
