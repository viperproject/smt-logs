...
(declare-fun FStar.DM4F.Id.id (Term) Term)

(declare-fun FStar.DM4F.Id.id@tok () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.M a
(declare-fun Tm_arrow_f733943e720921049fb5d7431c9f04d2 (Term) Term)

; </end encoding let id>


; encoding sigelt let return_id


; <Start encoding let return_id>

(declare-fun FStar.DM4F.Id.return_id (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> id a
(declare-fun Tm_arrow_a9a5178afbb785ee556ebab59c2c76a2 () Term)
(declare-fun FStar.DM4F.Id.return_id@tok () Term)
(declare-fun Tm_abs_4f3e95b98e4b31b4a7b4b15900a308b9 (Term) Term)

; </end encoding let return_id>


; encoding sigelt let bind_id


; <Start encoding let bind_id>

;;;;;;;;;;;;;;;;_: a -> id b
(declare-fun Tm_arrow_f70a34cab86d4dd36849d2c101eebfcf (Term Term) Term)
(declare-fun FStar.DM4F.Id.bind_id (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> b: Type -> x: id a -> f: (_: a -> id b) -> id b
(declare-fun Tm_arrow_26f85be9a5d49c845738b0b47815f7cb () Term)
(declare-fun FStar.DM4F.Id.bind_id@tok () Term)

(declare-fun Tm_abs_c3f06c01fce722b1350d68681402483b (Term Term) Term)

; </end encoding let bind_id>


; encoding sigelt let _dm4f_ID_lift_from_pure


; <Start encoding let _dm4f_ID_lift_from_pure>


;;;;;;;;;;;;;;;;_: (_: a -> Type) -> Type
(declare-fun Tm_arrow_11b93b1a25b26195b88e72dd87199600 (Term) Term)

(declare-fun FStar.DM4F.Id._dm4f_ID_lift_from_pure (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type -> wp: (_: (_: a -> Type) -> Type) -> _: Prims.unit -> p': (_: a -> Type) -> Type
(declare-fun Tm_arrow_6c3bbad008322af28814ec779aa4aaa3 () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_lift_from_pure@tok () Term)
...
; </end encoding let _dm4f_ID_lift_from_pure>


; encoding sigelt let _dm4f_ID_return_wp


; <Start encoding let _dm4f_ID_return_wp>


(declare-fun FStar.DM4F.Id._dm4f_ID_return_wp (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> x: a -> _: Prims.unit -> p': (_: a -> Type) -> Type
(declare-fun Tm_arrow_4d6b13755272dcc8bb6af36bb9cd8573 () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_return_wp@tok () Term)


; </end encoding let _dm4f_ID_return_wp>


; encoding sigelt let _dm4f_ID_return_elab


; <Start encoding let _dm4f_ID_return_elab>

(declare-fun FStar.DM4F.Id._dm4f_ID_return_elab (Term Term) Term)
(declare-fun Tm_refine_596c1d30a548c3757eed791d6da6a1f4 (Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE a
(declare-fun Tm_arrow_fb79464870f43c36bf274e5f02843359 (Term Term) Term)
;;;;;;;;;;;;;;;;a: Type -> x: a -> _: Prims.unit -> Prims.PURE a
(declare-fun Tm_arrow_6a4eefc9ade0333521b486b648c9f54e () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_return_elab@tok () Term)




; </end encoding let _dm4f_ID_return_elab>


; encoding sigelt let _dm4f_ID_bind_wp


; <Start encoding let _dm4f_ID_bind_wp>


;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: a -> Type) -> Type
(declare-fun Tm_arrow_51f4b1e8da0f0c9f0fb701a00c3fdf29 (Term) Term)


;;;;;;;;;;;;;;;;_: a -> _: Prims.unit -> _: (_: b -> Type) -> Type
(declare-fun Tm_arrow_c6868e7e4fa200f6c2c46681aa9ce7e9 (Term Term) Term)

(declare-fun FStar.DM4F.Id._dm4f_ID_bind_wp (Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     x: (_: Prims.unit -> _: (_: a -> Type) -> Type) ->     f: (_: a -> _: Prims.unit -> _: (_: b -> Type) -> Type) ->     _: Prims.unit ->     p'': (_: b -> Type)   -> Type
(declare-fun Tm_arrow_b4c7b3d53306e38584ce96c15af88901 () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_bind_wp@tok () Term)
...
(declare-fun Tm_abs_86bf3358f5883c01a69a9e1afdeea1e5 (Term Term Term) Term)

; </end encoding let _dm4f_ID_bind_wp>


; encoding sigelt let _dm4f_ID_bind_elab


; <Start encoding let _dm4f_ID_bind_elab>
...
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE a
(declare-fun Tm_arrow_6ca018b74eed8e3dd9f1f3a930f6f6a5 (Term Term) Term)
...
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE b
(declare-fun Tm_arrow_02b16ca906b521b75ba39cc93fd8abf9 (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: a -> _: Prims.unit -> Prims.PURE b
(declare-fun Tm_arrow_0121d466aff060fdf13159805b2efc11 (Term Term Term) Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_bind_elab (Term Term Term Term Term Term) Term)
...
(declare-fun Tm_abs_b4ac1d7be5848e911359917421a02233 (Term Term Term Term) Term)
(declare-fun Tm_refine_7a49404f3c0e5b7623057d6cadb13c74 (Term Term Term Term) Term)





(declare-fun Tm_abs_f0f73530ccb9915a63dab549b06651bd (Term Term Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.PURE b
(declare-fun Tm_arrow_85617144f01633264daf0a40811a76ef (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     x__w: (_: Prims.unit -> _: (_: a -> Type) -> Type) ->     x: (_: Prims.unit -> Prims.PURE a) ->     f__w: (_: a -> _: Prims.unit -> _: (_: b -> Type) -> Type) ->     f: (_: a -> _: Prims.unit -> Prims.PURE b) ->     _: Prims.unit   -> Prims.PURE b
(declare-fun Tm_arrow_8975fa63e22f4592928ba9da633ed707 () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_bind_elab@tok () Term)
...
; </end encoding let _dm4f_ID_bind_elab>


; encoding sigelt let _dm4f_ID_repr


; <Start encoding let _dm4f_ID_repr>



(declare-fun FStar.DM4F.Id._dm4f_ID_repr (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp_a: (_: Prims.unit -> _: (_: a -> Type) -> Type) -> Type
(declare-fun Tm_arrow_fb1b25b4d3ad3c5e22fe75d1946291b1 () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_repr@tok () Term)
...
; </end encoding let _dm4f_ID_repr>


; encoding sigelt let _dm4f_ID_pre


; <Start encoding let _dm4f_ID_pre>

(declare-fun FStar.DM4F.Id._dm4f_ID_pre () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> Type
(declare-fun Tm_arrow_b9ff16838ca14be79c4714dd5f2c76fe () Term)

; </end encoding let _dm4f_ID_pre>


; encoding sigelt let _dm4f_ID_post


; <Start encoding let _dm4f_ID_post>

(declare-fun FStar.DM4F.Id._dm4f_ID_post (Term) Term)

(declare-fun FStar.DM4F.Id._dm4f_ID_post@tok () Term)


; </end encoding let _dm4f_ID_post>


; encoding sigelt let _dm4f_ID_wp


; <Start encoding let _dm4f_ID_wp>

(declare-fun FStar.DM4F.Id._dm4f_ID_wp (Term) Term)

(declare-fun FStar.DM4F.Id._dm4f_ID_wp@tok () Term)



; </end encoding let _dm4f_ID_wp>


; encoding sigelt let _dm4f_ID_ctx


; <Start encoding let _dm4f_ID_ctx>

(declare-fun FStar.DM4F.Id._dm4f_ID_ctx (Term Term) Term)

(declare-fun FStar.DM4F.Id._dm4f_ID_ctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: a -> Type) -> t
(declare-fun Tm_arrow_a6573b39912f2db15ba23c1de1e109c6 (Term Term) Term)

; </end encoding let _dm4f_ID_ctx>


; encoding sigelt let _dm4f_ID_gctx


; <Start encoding let _dm4f_ID_gctx>

(declare-fun FStar.DM4F.Id._dm4f_ID_gctx (Term Term) Term)

(declare-fun FStar.DM4F.Id._dm4f_ID_gctx@tok () Term)

;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: a -> Type) -> Prims.GTot t
(declare-fun Tm_ghost_arrow_8155a8020d10290f0dd768f189889280 (Term Term) Term)

; </end encoding let _dm4f_ID_gctx>


; encoding sigelt let _dm4f_ID_pure


; <Start encoding let _dm4f_ID_pure>


(declare-fun FStar.DM4F.Id._dm4f_ID_pure (Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;x: t -> _: Prims.unit -> _: (_: a -> Type) -> t
(declare-fun Tm_arrow_dc0b418f8ca9ff160fda775e2937adf1 () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_pure@tok () Term)


; </end encoding let _dm4f_ID_pure>


; encoding sigelt let _dm4f_ID_app


; <Start encoding let _dm4f_ID_app>



;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: a -> Type) -> Prims.GTot (_: t1 -> Prims.GTot t2)
(declare-fun Tm_arrow_e68eb48e8700ea4efd0ba0c557eabba7 (Term Term Term) Term)



(declare-fun FStar.DM4F.Id._dm4f_ID_app (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l: (_: Prims.unit -> _: (_: a -> Type) -> Prims.GTot (_: t1 -> Prims.GTot t2)) ->     r: (_: Prims.unit -> _: (_: a -> Type) -> Prims.GTot t1) ->     _: Prims.unit ->     _: (_: a -> Type)   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_d906c47a2802be9e987bad93dabe1fea () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_app@tok () Term)
...
; </end encoding let _dm4f_ID_app>


; encoding sigelt let _dm4f_ID_lift1


; <Start encoding let _dm4f_ID_lift1>




(declare-fun FStar.DM4F.Id._dm4f_ID_lift1 (Term Term Term Term Term) Term)





;;;;;;;;;;;;;;;;f: (_: t1 -> Prims.GTot t2) ->     a1: (_: Prims.unit -> _: (_: a -> Type) -> Prims.GTot t1) ->     _: Prims.unit ->     _: (_: a -> Type)   -> Prims.GTot t2
(declare-fun Tm_arrow_432e664c52d7d308e9e145286b6ddd7e () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_lift1@tok () Term)
...
(declare-fun Tm_abs_476231483b8b4c43042bd771b256904b (Term Term Term Term) Term)

; </end encoding let _dm4f_ID_lift1>


; encoding sigelt let _dm4f_ID_lift2


; <Start encoding let _dm4f_ID_lift2>
...
(declare-fun FStar.DM4F.Id._dm4f_ID_lift2 (Term Term Term Term Term Term Term) Term)
...
;;;;;;;;;;;;;;;;f: (_: t1 -> _: t2 -> Prims.GTot t3) ->     a1: (_: Prims.unit -> _: (_: a -> Type) -> Prims.GTot t1) ->     a2: (_: Prims.unit -> _: (_: a -> Type) -> Prims.GTot t2) ->     _: Prims.unit ->     _: (_: a -> Type)   -> Prims.GTot t3
(declare-fun Tm_arrow_c0b3f63988c138a9f785ce2fb81b67d4 () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_lift2@tok () Term)
...
(declare-fun Tm_abs_ca35a5f804f264c483178add53d8ec9a (Term Term Term Term Term) Term)

; </end encoding let _dm4f_ID_lift2>


; encoding sigelt let _dm4f_ID_push


; <Start encoding let _dm4f_ID_push>



;;;;;;;;;;;;;;;;_: t1 -> _: Prims.unit -> _: (_: a -> Type) -> Prims.GTot t2
(declare-fun Tm_arrow_278cc7a1c8d2d44f4ebf9e788fe2ba41 (Term Term Term) Term)

(declare-fun FStar.DM4F.Id._dm4f_ID_push (Term Term Term Term Term Term Term) Term)




;;;;;;;;;;;;;;;;f: (_: t1 -> _: Prims.unit -> _: (_: a -> Type) -> Prims.GTot t2) ->     _: Prims.unit ->     _: (_: a -> Type) ->     e1: t1   -> Prims.GTot t2
(declare-fun Tm_ghost_arrow_a9734e9b146eda7a15179f8c00d84442 () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_push@tok () Term)





; </end encoding let _dm4f_ID_push>


; encoding sigelt let _dm4f_ID_wp_if_then_else


; <Start encoding let _dm4f_ID_wp_if_then_else>

(declare-fun FStar.DM4F.Id._dm4f_ID_wp_if_then_else (Term Term) Term)
...
;;;;;;;;;;;;;;;;_: (_: Prims.unit -> _: (_: a -> Type) -> Type) ->     _: (_: Prims.unit -> _: (_: a -> Type) -> Type) ->     _: Prims.unit ->     _: (_: a -> Type)   -> Type
(declare-fun Tm_arrow_c75533d933f3b538a20d6e7a545fc44c (Term) Term)
;;;;;;;;;;;;;;;;a: Type ->     c: Type ->     _: (_: Prims.unit -> _: (_: a -> Type) -> Type) ->     _: (_: Prims.unit -> _: (_: a -> Type) -> Type) ->     _: Prims.unit ->     _: (_: a -> Type)   -> Type
(declare-fun Tm_arrow_9e62825b6a05fe7b2b67bdeef8fd81da () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_wp_if_then_else@tok () Term)
...
;;;;;;;;;;;;;;;;_: Prims.unit -> _: (_: a -> Type) -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_a6736aa6929260881d6385825bc3ebfe (Term) Term)
...
;;;;;;;;;;;;;;;;a1: (_: Prims.unit -> _: (_: a -> Type) -> Prims.GTot Prims.logical) ->     a2: (_: Prims.unit -> _: (_: a -> Type) -> Prims.GTot Prims.logical) ->     _: Prims.unit ->     _: (_: a -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_5bfac82a4d70b80675e36e35044b68a6 (Term) Term)
(declare-fun Tm_abs_23843b119decbb90832dae668c4620ab (Term Term) Term)

; </end encoding let _dm4f_ID_wp_if_then_else>


; encoding sigelt let _dm4f_ID_wp_close


; <Start encoding let _dm4f_ID_wp_close>




(declare-fun FStar.DM4F.Id._dm4f_ID_wp_close (Term Term Term) Term)





;;;;;;;;;;;;;;;;a: Type ->     b: Type ->     f: (_: b -> _: Prims.unit -> _: (_: a -> Type) -> Type) ->     _: Prims.unit ->     _: (_: a -> Type)   -> Prims.GTot Prims.logical
(declare-fun Tm_arrow_e6dd3a4ab423146b5021852b92df17a9 () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_wp_close@tok () Term)
...
(declare-fun Tm_abs_7211c1016bdba89f8dac1720ae189741 (Term Term Term) Term)

; </end encoding let _dm4f_ID_wp_close>


; encoding sigelt let _dm4f_ID_stronger


; <Start encoding let _dm4f_ID_stronger>





(declare-fun FStar.DM4F.Id._dm4f_ID_stronger (Term Term Term) Term)




;;;;;;;;;;;;;;;;a: Type ->     wp1: (_: Prims.unit -> _: (_: a -> Type) -> Type) ->     wp2: (_: Prims.unit -> _: (_: a -> Type) -> Type)   -> Prims.logical
(declare-fun Tm_arrow_adb4b049c944cda4c9233706f145f311 () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_stronger@tok () Term)
...
; </end encoding let _dm4f_ID_stronger>


; encoding sigelt let _dm4f_ID_ite_wp


; <Start encoding let _dm4f_ID_ite_wp>




(declare-fun FStar.DM4F.Id._dm4f_ID_ite_wp (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;a: Type -> wp: (_: Prims.unit -> _: (_: a -> Type) -> Type) -> _: Prims.unit -> _: (_: a -> Type)   -> Prims.logical
(declare-fun Tm_arrow_4c2c9f813983ba6dc39ca154a57a81eb () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_ite_wp@tok () Term)





; </end encoding let _dm4f_ID_ite_wp>


; encoding sigelt let _dm4f_ID_null_wp


; <Start encoding let _dm4f_ID_null_wp>


(declare-fun FStar.DM4F.Id._dm4f_ID_null_wp (Term Term Term) Term)

;;;;;;;;;;;;;;;;a: Type -> _: Prims.unit -> _: (_: a -> Type) -> Prims.logical
(declare-fun Tm_arrow_7287fa74058ac06017699a2de209f13e () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_null_wp@tok () Term)


; </end encoding let _dm4f_ID_null_wp>


; encoding sigelt let _dm4f_ID_wp_trivial


; <Start encoding let _dm4f_ID_wp_trivial>



(declare-fun FStar.DM4F.Id._dm4f_ID_wp_trivial (Term Term) Term)


;;;;;;;;;;;;;;;;a: Type -> wp: (_: Prims.unit -> _: (_: a -> Type) -> Type) -> Prims.logical
(declare-fun Tm_arrow_67add5cd137a87907d79f359179aacfb () Term)
(declare-fun FStar.DM4F.Id._dm4f_ID_wp_trivial@tok () Term)




; </end encoding let _dm4f_ID_wp_trivial>


; encoding sigelt new_effect_for_free { ID ... }


; <Skipped new_effect_for_free { ID ... }/>


; encoding sigelt sub_effect PURE ~> ID


; <Skipped sub_effect PURE ~> ID/>
...
; Starting query at FStar.DM4F.Id.fst(41,0-41,20)
...
; While typechecking the top-level declaration `[@@expect_failure] let uu___0`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (FStar.DM4F.Id.uu___0, 1)
