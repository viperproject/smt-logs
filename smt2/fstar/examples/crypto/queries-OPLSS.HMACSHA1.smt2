...
(declare-fun OPLSS.HMACSHA1.keysize (Dummy_sort) Term)
...
(declare-fun OPLSS.HMACSHA1.blocksize (Dummy_sort) Term)
...
(declare-fun OPLSS.HMACSHA1.macsize (Dummy_sort) Term)

; </end encoding let macsize>


; encoding sigelt val OPLSS.HMACSHA1.sha1


; <Start encoding val OPLSS.HMACSHA1.sha1>

(declare-fun OPLSS.HMACSHA1.sha1 (Term) Term)
(declare-fun Tm_refine_9c18317a12299d1d8fd2fdd952ec7f7d () Term)
;;;;;;;;;;;;;;;;_: OPLSS.bytes -> h: OPLSS.bytes{FStar.Seq.Base.length h = macsize}
(declare-fun Tm_arrow_210a70c053fca2cca03042267e33b0d6 () Term)
(declare-fun OPLSS.HMACSHA1.sha1@tok () Term)


; </end encoding val OPLSS.HMACSHA1.sha1>
...
(declare-fun OPLSS.HMACSHA1.msg () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.HMACSHA1.keysize; Namespace OPLSS.HMACSHA1
(assert (! 
;; def=OPLSS.HMACSHA1.fst(19,4-19,11); use=OPLSS.HMACSHA1.fst(19,4-19,11)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.HMACSHA1.keysize @u0)
Prims.int)
 

:pattern ((OPLSS.HMACSHA1.keysize @u0))
:qid typing_OPLSS.HMACSHA1.keysize))

:named typing_OPLSS.HMACSHA1.keysize))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Equation for OPLSS.HMACSHA1.keysize
;;; Fact-ids: Name OPLSS.HMACSHA1.keysize; Namespace OPLSS.HMACSHA1
(assert (! 
;; def=OPLSS.HMACSHA1.fst(19,4-19,11); use=OPLSS.HMACSHA1.fst(19,4-19,11)
(forall ((@u0 Dummy_sort))
...
:qid equation_OPLSS.HMACSHA1.keysize))

:named equation_OPLSS.HMACSHA1.keysize))
...
; Starting query at OPLSS.HMACSHA1.fst(27,5-27,13)

(declare-fun label_1 () Bool)

; Encoding query formula : OPLSS.HMACSHA1.keysize >= 0


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let sha1_key`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(680,18-680,24); use=OPLSS.HMACSHA1.fst(27,23-27,30)
(or label_1

;; def=Prims.fst(680,18-680,24); use=OPLSS.HMACSHA1.fst(27,23-27,30)
(>= (BoxInt_proj_0 (OPLSS.HMACSHA1.keysize Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.HMACSHA1.sha1_key, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_OPLSS.HMACSHA1.keysize, projection_inverse_BoxInt_proj_0
...
; encoding sigelt let sha1_key


; <Start encoding let sha1_key>

(declare-fun OPLSS.HMACSHA1.sha1_key () Term)

; </end encoding let sha1_key>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.HMACSHA1.macsize; Namespace OPLSS.HMACSHA1
(assert (! 
;; def=OPLSS.HMACSHA1.fst(21,4-21,11); use=OPLSS.HMACSHA1.fst(21,4-21,11)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.HMACSHA1.macsize @u0)
Prims.int)
 

:pattern ((OPLSS.HMACSHA1.macsize @u0))
:qid typing_OPLSS.HMACSHA1.macsize))

:named typing_OPLSS.HMACSHA1.macsize))
;;;;;;;;;;;;;;;;Equation for OPLSS.HMACSHA1.macsize
;;; Fact-ids: Name OPLSS.HMACSHA1.macsize; Namespace OPLSS.HMACSHA1
(assert (! 
;; def=OPLSS.HMACSHA1.fst(21,4-21,11); use=OPLSS.HMACSHA1.fst(21,4-21,11)
(forall ((@u0 Dummy_sort))
...
:qid equation_OPLSS.HMACSHA1.macsize))

:named equation_OPLSS.HMACSHA1.macsize))
(push) ;; push{2

; Starting query at OPLSS.HMACSHA1.fst(28,5-28,8)

(declare-fun label_1 () Bool)

; Encoding query formula : OPLSS.HMACSHA1.macsize >= 0


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let tag`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(680,18-680,24); use=OPLSS.HMACSHA1.fst(28,18-28,25)
(or label_1

;; def=Prims.fst(680,18-680,24); use=OPLSS.HMACSHA1.fst(28,18-28,25)
(>= (BoxInt_proj_0 (OPLSS.HMACSHA1.macsize Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.HMACSHA1.tag, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_OPLSS.HMACSHA1.macsize, projection_inverse_BoxInt_proj_0
...
(declare-fun OPLSS.HMACSHA1.tag () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.xor; Namespace OPLSS
(assert (! 
;; def=OPLSS.fst(16,4-16,7); use=OPLSS.fst(16,4-16,7)
...
(HasType @x2
(OPLSS.lbytes @x0)))
(HasType (OPLSS.xor @x0
@x1
@x2)
(OPLSS.lbytes @x0)))
 

:pattern ((OPLSS.xor @x0
@x1
@x2))
:qid typing_OPLSS.xor))

:named typing_OPLSS.xor))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.lbytes; Namespace OPLSS
(assert (! 
;; def=OPLSS.fst(7,4-7,10); use=OPLSS.fst(7,4-7,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (OPLSS.lbytes @x0)
Tm_type))
 

:pattern ((OPLSS.lbytes @x0))
:qid typing_OPLSS.lbytes))

:named typing_OPLSS.lbytes))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.bytes; Namespace OPLSS
(assert (! (HasType OPLSS.bytes
Tm_type)
:named typing_OPLSS.bytes))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.byte_of_int; Namespace OPLSS
(assert (! 
;; def=OPLSS.fst(13,4-13,15); use=OPLSS.fst(13,4-13,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_31c7d3d85d92cb942c95a78642e657c7)
(HasType (OPLSS.byte_of_int @x0)
(FStar.UInt8.t Dummy_value)))
 

:pattern ((OPLSS.byte_of_int @x0))
:qid typing_OPLSS.byte_of_int))

:named typing_OPLSS.byte_of_int))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.HMACSHA1.sha1_key; Namespace OPLSS.HMACSHA1
(assert (! (HasType OPLSS.HMACSHA1.sha1_key
Tm_type)
:named typing_OPLSS.HMACSHA1.sha1_key))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.HMACSHA1.sha1; Namespace OPLSS.HMACSHA1
(assert (! 
;; def=OPLSS.HMACSHA1.fst(24,4-24,8); use=OPLSS.HMACSHA1.fst(24,4-24,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
OPLSS.bytes)
(HasType (OPLSS.HMACSHA1.sha1 @x0)
Tm_refine_9c18317a12299d1d8fd2fdd952ec7f7d))
 

:pattern ((OPLSS.HMACSHA1.sha1 @x0))
:qid typing_OPLSS.HMACSHA1.sha1))

:named typing_OPLSS.HMACSHA1.sha1))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.HMACSHA1.msg; Namespace OPLSS.HMACSHA1
(assert (! (HasType OPLSS.HMACSHA1.msg
Tm_type)
:named typing_OPLSS.HMACSHA1.msg))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.HMACSHA1.blocksize; Namespace OPLSS.HMACSHA1
(assert (! 
;; def=OPLSS.HMACSHA1.fst(20,4-20,13); use=OPLSS.HMACSHA1.fst(20,4-20,13)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.HMACSHA1.blocksize @u0)
Prims.int)
 

:pattern ((OPLSS.HMACSHA1.blocksize @u0))
:qid typing_OPLSS.HMACSHA1.blocksize))

:named typing_OPLSS.HMACSHA1.blocksize))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name OPLSS.HMACSHA1.sha1; Namespace OPLSS.HMACSHA1
(assert (! (HasType Tm_refine_9c18317a12299d1d8fd2fdd952ec7f7d
Tm_type)
:named refinement_kinding_Tm_refine_9c18317a12299d1d8fd2fdd952ec7f7d))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name OPLSS.lbytes; Namespace OPLSS
(assert (! 
;; def=OPLSS.fst(7,15-7,40); use=OPLSS.fst(7,15-7,40)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_1770f7f5914d37a8c358e0f35e606914 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_1770f7f5914d37a8c358e0f35e606914 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_1770f7f5914d37a8c358e0f35e606914))

:named refinement_kinding_Tm_refine_1770f7f5914d37a8c358e0f35e606914))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.UInt.uint_t; Namespace FStar.UInt
(assert (! 
;; def=FStar.UInt.fsti(54,22-54,37); use=FStar.UInt.fsti(54,22-54,37)
...
;;; Fact-ids: Name OPLSS.HMACSHA1.sha1; Namespace OPLSS.HMACSHA1
(assert (! 
;; def=OPLSS.HMACSHA1.fst(24,23-24,56); use=OPLSS.HMACSHA1.fst(24,23-24,56)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_9c18317a12299d1d8fd2fdd952ec7f7d)
...
;; def=OPLSS.HMACSHA1.fst(24,32-24,54); use=OPLSS.HMACSHA1.fst(24,32-24,54)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x1)
(OPLSS.HMACSHA1.macsize Dummy_value))
))
...
@x1
Tm_refine_9c18317a12299d1d8fd2fdd952ec7f7d))
:qid refinement_interpretation_Tm_refine_9c18317a12299d1d8fd2fdd952ec7f7d))

:named refinement_interpretation_Tm_refine_9c18317a12299d1d8fd2fdd952ec7f7d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.UInt8.one; Namespace FStar.UInt8
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1770f7f5914d37a8c358e0f35e606914 @x2))
(and (HasTypeFuel @u0
@x1
OPLSS.bytes)

;; def=OPLSS.fst(7,23-7,39); use=OPLSS.fst(7,23-7,39)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x1)
@x2)
))
...
@x1
(Tm_refine_1770f7f5914d37a8c358e0f35e606914 @x2)))
:qid refinement_interpretation_Tm_refine_1770f7f5914d37a8c358e0f35e606914))

:named refinement_interpretation_Tm_refine_1770f7f5914d37a8c358e0f35e606914))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_9c18317a12299d1d8fd2fdd952ec7f7d
;;; Fact-ids: Name OPLSS.HMACSHA1.sha1; Namespace OPLSS.HMACSHA1
(assert (! (iff (Valid (Prims.hasEq Tm_refine_9c18317a12299d1d8fd2fdd952ec7f7d))
(Valid (Prims.hasEq OPLSS.bytes)))
:named haseqTm_refine_9c18317a12299d1d8fd2fdd952ec7f7d))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_1770f7f5914d37a8c358e0f35e606914
;;; Fact-ids: Name OPLSS.lbytes; Namespace OPLSS
(assert (! 
;; def=OPLSS.fst(7,15-7,40); use=OPLSS.fst(7,15-7,40)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1770f7f5914d37a8c358e0f35e606914 @x0)))
(Valid (Prims.hasEq OPLSS.bytes)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_1770f7f5914d37a8c358e0f35e606914 @x0))))
:qid haseqTm_refine_1770f7f5914d37a8c358e0f35e606914))

:named haseqTm_refine_1770f7f5914d37a8c358e0f35e606914))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! (HasType Prims.pos
Tm_type)
...
(assert (! (HasType OPLSS.bytes
Tm_type)
:named function_token_typing_OPLSS.bytes))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name OPLSS.HMACSHA1.sha1_key; Namespace OPLSS.HMACSHA1
(assert (! (HasType OPLSS.HMACSHA1.sha1_key
Tm_type)
:named function_token_typing_OPLSS.HMACSHA1.sha1_key))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name OPLSS.HMACSHA1.msg; Namespace OPLSS.HMACSHA1
(assert (! (HasType OPLSS.HMACSHA1.msg
Tm_type)
:named function_token_typing_OPLSS.HMACSHA1.msg))
...
;;;;;;;;;;;;;;;;Equation for OPLSS.lbytes
;;; Fact-ids: Name OPLSS.lbytes; Namespace OPLSS
(assert (! 
;; def=OPLSS.fst(7,4-7,10); use=OPLSS.fst(7,4-7,10)
(forall ((@x0 Term))
 (! (= (OPLSS.lbytes @x0)
(Tm_refine_1770f7f5914d37a8c358e0f35e606914 @x0))
 

:pattern ((OPLSS.lbytes @x0))
:qid equation_OPLSS.lbytes))

:named equation_OPLSS.lbytes))
;;;;;;;;;;;;;;;;Equation for OPLSS.bytes
;;; Fact-ids: Name OPLSS.bytes; Namespace OPLSS
(assert (! (= OPLSS.bytes
(FStar.Seq.Base.seq (FStar.UInt8.t Dummy_value)))
:named equation_OPLSS.bytes))
;;;;;;;;;;;;;;;;Equation for OPLSS.HMACSHA1.sha1_key
;;; Fact-ids: Name OPLSS.HMACSHA1.sha1_key; Namespace OPLSS.HMACSHA1
(assert (! (= OPLSS.HMACSHA1.sha1_key
(OPLSS.lbytes (OPLSS.HMACSHA1.keysize Dummy_value)))
:named equation_OPLSS.HMACSHA1.sha1_key))
;;;;;;;;;;;;;;;;Equation for OPLSS.HMACSHA1.msg
;;; Fact-ids: Name OPLSS.HMACSHA1.msg; Namespace OPLSS.HMACSHA1
(assert (! (= OPLSS.HMACSHA1.msg
OPLSS.bytes)
:named equation_OPLSS.HMACSHA1.msg))
;;;;;;;;;;;;;;;;Equation for OPLSS.HMACSHA1.blocksize
;;; Fact-ids: Name OPLSS.HMACSHA1.blocksize; Namespace OPLSS.HMACSHA1
(assert (! 
;; def=OPLSS.HMACSHA1.fst(20,4-20,13); use=OPLSS.HMACSHA1.fst(20,4-20,13)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=OPLSS.HMACSHA1.fst(20,4-20,13); use=OPLSS.HMACSHA1.fst(20,4-20,13)
(OPLSS.HMACSHA1.blocksize @u0)

(OPLSS.HMACSHA1.keysize Dummy_value))
...
:qid equation_OPLSS.HMACSHA1.blocksize))

:named equation_OPLSS.HMACSHA1.blocksize))
...
; Starting query at OPLSS.HMACSHA1.fst(31,9-39,44)
...
; Encoding query formula : forall (k: OPLSS.HMACSHA1.sha1_key) (m: OPLSS.HMACSHA1.msg).
;   (*  - Could not prove post-condition
; *)
;   OPLSS.HMACSHA1.blocksize >= 0 /\
;   (forall (any_result: Prims.int).
;       OPLSS.HMACSHA1.blocksize == any_result ==>
;       (forall (any_result: FStar.Seq.Base.seq FStar.UInt8.t).
;           FStar.Seq.Base.create OPLSS.HMACSHA1.blocksize (OPLSS.byte_of_int 92) == any_result ==>
;           OPLSS.HMACSHA1.blocksize >= 0 /\
;           (forall (any_result: Prims.int).
;               OPLSS.HMACSHA1.blocksize == any_result ==>
;               (forall (any_result: FStar.Seq.Base.seq FStar.UInt8.t).
;                   FStar.Seq.Base.create OPLSS.HMACSHA1.blocksize (OPLSS.byte_of_int 54) ==
;                   any_result ==>
;                   OPLSS.HMACSHA1.keysize >= 0 /\
;                   (OPLSS.HMACSHA1.keysize >= 0) /\
;                   (forall (any_result: Prims.int).
;                       OPLSS.HMACSHA1.keysize == any_result ==>
;                       FStar.Seq.Base.length (FStar.Seq.Base.create OPLSS.HMACSHA1.blocksize
;                             (OPLSS.byte_of_int 92)) =
;                       OPLSS.HMACSHA1.keysize /\
;                       (forall (any_result: FStar.Seq.Base.seq FStar.UInt8.t).
;                           FStar.Seq.Base.create OPLSS.HMACSHA1.blocksize (OPLSS.byte_of_int 92) ==
;                           any_result ==>
;                           (forall (any_result: OPLSS.lbytes OPLSS.HMACSHA1.keysize).
;                               OPLSS.xor OPLSS.HMACSHA1.keysize
;                                 k
;                                 (FStar.Seq.Base.create OPLSS.HMACSHA1.blocksize
;                                     (OPLSS.byte_of_int 92)) ==
;                               any_result ==>
;                               OPLSS.HMACSHA1.keysize >= 0 /\
;                               (OPLSS.HMACSHA1.keysize >= 0) /\
...
;                                                 (OPLSS.byte_of_int 54)) ==
;                                           any_result ==>
;                                           FStar.Seq.Base.length (OPLSS.HMACSHA1.sha1 (FStar.Seq.Base.append
;                                                     (OPLSS.xor OPLSS.HMACSHA1.keysize
;                                                         k
;                                                         (FStar.Seq.Base.create OPLSS.HMACSHA1.blocksize
;                                                             (OPLSS.byte_of_int 92)))
;                                                     (OPLSS.HMACSHA1.sha1 (FStar.Seq.Base.append (OPLSS.xor
;                                                                 OPLSS.HMACSHA1.keysize
;                                                                 k
;                                                                 (FStar.Seq.Base.create OPLSS.HMACSHA1.blocksize
;                                                                     (OPLSS.byte_of_int 54)))
;                                                             m)))) =
;                                           OPLSS.HMACSHA1.macsize ==>
;                                           FStar.Seq.Base.length (OPLSS.HMACSHA1.sha1 (FStar.Seq.Base.append
;                                                     (OPLSS.xor OPLSS.HMACSHA1.keysize
;                                                         k
;                                                         (FStar.Seq.Base.create OPLSS.HMACSHA1.blocksize
...
;; def=Prims.fst(459,77-459,89); use=OPLSS.HMACSHA1.fst(31,9-39,44)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS.HMACSHA1.fst(34,24-34,33)
(or label_1

;; def=Prims.fst(680,18-680,24); use=OPLSS.HMACSHA1.fst(34,24-34,33)
(>= (BoxInt_proj_0 (OPLSS.HMACSHA1.blocksize Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=Prims.fst(451,66-451,102); use=OPLSS.HMACSHA1.fst(31,9-39,44)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.int)

;; def=dummy(0,0-0,0); use=OPLSS.HMACSHA1.fst(31,9-39,44)
(= (OPLSS.HMACSHA1.blocksize Dummy_value)
@x2)
)
...
;; def=OPLSS.HMACSHA1.fst(34,6-34,37); use=OPLSS.HMACSHA1.fst(34,6-34,37)
(= (FStar.Seq.Base.create (FStar.UInt8.t Dummy_value)
(OPLSS.HMACSHA1.blocksize Dummy_value)
(OPLSS.byte_of_int (BoxInt 92)))
@x3)
)

;; def=Prims.fst(459,77-459,89); use=OPLSS.HMACSHA1.fst(31,9-39,44)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS.HMACSHA1.fst(35,24-35,33)
(or label_2
...
;; def=OPLSS.HMACSHA1.fst(35,6-35,37); use=OPLSS.HMACSHA1.fst(35,6-35,37)
(= (FStar.Seq.Base.create (FStar.UInt8.t Dummy_value)
(OPLSS.HMACSHA1.blocksize Dummy_value)
(OPLSS.byte_of_int (BoxInt 54)))
@x5)
)

;; def=Prims.fst(459,77-459,89); use=OPLSS.HMACSHA1.fst(31,9-39,44)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS.HMACSHA1.fst(36,25-36,32)
(or label_3
...
;; def=OPLSS.fst(16,9-16,10); use=OPLSS.HMACSHA1.fst(31,9-39,44)
(= (OPLSS.HMACSHA1.keysize Dummy_value)
@x6)
)
...
;; def=Prims.fst(459,77-459,89); use=OPLSS.HMACSHA1.fst(31,9-39,44)
(and 
;; def=OPLSS.fst(7,23-7,39); use=OPLSS.HMACSHA1.fst(36,35-36,39)
(or label_5
...
;; def=OPLSS.HMACSHA1.fst(36,6-36,39); use=OPLSS.HMACSHA1.fst(36,6-36,39)
(= (OPLSS.xor (OPLSS.HMACSHA1.keysize Dummy_value)
@x0
(FStar.Seq.Base.create (FStar.UInt8.t Dummy_value)
(OPLSS.HMACSHA1.blocksize Dummy_value)
(OPLSS.byte_of_int (BoxInt 92))))
...
;; def=Prims.fst(459,77-459,89); use=OPLSS.HMACSHA1.fst(31,9-39,44)
(and 
;; def=Prims.fst(680,18-680,24); use=OPLSS.HMACSHA1.fst(37,25-37,32)
(or label_6
...
;; def=Prims.fst(459,77-459,89); use=OPLSS.HMACSHA1.fst(31,9-39,44)
(and 
;; def=OPLSS.fst(7,23-7,39); use=OPLSS.HMACSHA1.fst(37,35-37,39)
(or label_8
...
;; def=OPLSS.HMACSHA1.fst(37,6-37,39); use=OPLSS.HMACSHA1.fst(37,6-37,39)
(= (OPLSS.xor (OPLSS.HMACSHA1.keysize Dummy_value)
@x0
(FStar.Seq.Base.create (FStar.UInt8.t Dummy_value)
(OPLSS.HMACSHA1.blocksize Dummy_value)
...
;; def=OPLSS.HMACSHA1.fst(24,32-24,54); use=OPLSS.HMACSHA1.fst(38,2-39,44)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
(OPLSS.HMACSHA1.sha1 (FStar.Seq.Base.append (FStar.UInt8.t Dummy_value)
(OPLSS.xor (OPLSS.HMACSHA1.keysize Dummy_value)
@x0
(FStar.Seq.Base.create (FStar.UInt8.t Dummy_value)
(OPLSS.HMACSHA1.blocksize Dummy_value)
...
;; def=OPLSS.fst(7,23-7,39); use=OPLSS.HMACSHA1.fst(38,2-39,44)
(or label_9
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.HMACSHA1.hmac_sha1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, FStar.UInt8_pretyping_512f0e4172b97206a8b0e16196475713, equation_OPLSS.HMACSHA1.blocksize, equation_OPLSS.HMACSHA1.keysize, equation_OPLSS.HMACSHA1.sha1_key, equation_OPLSS.bytes, equation_OPLSS.lbytes, equation_Prims.eqtype, equation_Prims.nat, int_typing, lemma_FStar.Seq.Base.lemma_create_len, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_1770f7f5914d37a8c358e0f35e606914, refinement_interpretation_Tm_refine_31c7d3d85d92cb942c95a78642e657c7, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_FStar.Seq.Base.length, typing_FStar.UInt8.t, typing_OPLSS.byte_of_int
