...
; Starting query at OPLSS.fst(7,15-7,40)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (l: Prims.nat) (b: OPLSS.bytes).
...
;; def=Prims.fst(73,23-73,30); use=OPLSS.fst(7,27-7,33)
(or label_1
...
; encoding sigelt val OPLSS.random
...
; encoding sigelt val OPLSS.byte_of_int
...
; encoding sigelt val OPLSS.auto_lemma_mem_snoc
...
; Starting query at OPLSS.fst(24,35-24,57)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Prims.eqtype) (s: FStar.Seq.Base.seq a) (x: a) (y: a).
...
; Context: While encoding a query
; While typechecking the top-level declaration `let auto_lemma_mem_snoc`
...
;; def=Prims.fst(441,36-441,97); use=OPLSS.fst(24,35-24,57)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=OPLSS.fst(22,14-22,52); use=OPLSS.fst(24,35-24,57)
(or label_2

;; def=OPLSS.fst(22,14-22,52); use=OPLSS.fst(24,35-24,57)
(iff 
;; def=OPLSS.fst(22,15-22,31); use=OPLSS.fst(24,35-24,57)
(BoxBool_proj_0 (FStar.Seq.Properties.mem @x0
@x3
(FStar.Seq.Properties.snoc @x0
@x1
...
;; def=OPLSS.fst(22,37-22,51); use=OPLSS.fst(24,35-24,57)
(or 
;; def=OPLSS.fst(22,37-22,44); use=OPLSS.fst(24,35-24,57)
(BoxBool_proj_0 (FStar.Seq.Properties.mem @x0
@x3
@x1))


;; def=OPLSS.fst(22,48-22,51); use=OPLSS.fst(24,35-24,57)
(= @x2
@x3)
)
)
...
;; def=Prims.fst(441,83-441,96); use=OPLSS.fst(24,35-24,57)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS.fst(24,35-24,57)
(ApplyTT @x4
@x5)
...
;; def=FStar.Seq.Properties.fsti(331,18-331,66); use=OPLSS.fst(24,39-24,53)
(forall ((@x6 Term))
 (! (implies (HasType @x6
@x0)

;; def=FStar.Seq.Properties.fsti(331,29-331,65); use=OPLSS.fst(24,39-24,53)
(iff 
;; def=FStar.Seq.Properties.fsti(331,29-331,45); use=OPLSS.fst(24,39-24,53)
(BoxBool_proj_0 (FStar.Seq.Properties.mem @x0
@x6
(FStar.Seq.Properties.snoc @x0
@x1
...
;; def=FStar.Seq.Properties.fsti(331,51-331,65); use=OPLSS.fst(24,39-24,53)
(or 
;; def=FStar.Seq.Properties.fsti(331,51-331,58); use=OPLSS.fst(24,39-24,53)
(BoxBool_proj_0 (FStar.Seq.Properties.mem @x0
@x6
@x1))


;; def=FStar.Seq.Properties.fsti(331,62-331,65); use=OPLSS.fst(24,39-24,53)
(= @x2
@x6)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.auto_lemma_mem_snoc, 1)
; STATUS: unsat
