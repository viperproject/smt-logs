...
(declare-fun Formatting.op_At_Bar (Term Term) Term)

(declare-fun Formatting.op_At_Bar@tok () Term)
...
(declare-fun Formatting.length (Term) Term)

(declare-fun Formatting.length@tok () Term)
...
(declare-fun Formatting.message () Term)

; </end encoding let message>


; encoding sigelt let msg


; <Start encoding let msg>

(declare-fun Formatting.msg (Term) Term)

(declare-fun Formatting.msg@tok () Term)

; </end encoding let msg>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.op_At_Bar; Namespace Formatting
(assert (! 
;; def=Formatting.fst(26,4-26,13); use=Formatting.fst(26,4-26,13)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Platform.Bytes.bytes)
(HasType @x1
Platform.Bytes.bytes))
(HasType (Formatting.op_At_Bar @x0
@x1)
Platform.Bytes.bytes))
 

:pattern ((Formatting.op_At_Bar @x0
@x1))
:qid typing_Formatting.op_At_Bar))

:named typing_Formatting.op_At_Bar))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.message; Namespace Formatting
(assert (! (HasType Formatting.message
Tm_type)
:named typing_Formatting.message))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.length; Namespace Formatting
(assert (! 
;; def=Formatting.fst(27,4-27,10); use=Formatting.fst(27,4-27,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Platform.Bytes.bytes)
(HasType (Formatting.length @x0)
Prims.nat))
 

:pattern ((Formatting.length @x0))
:qid typing_Formatting.length))

:named typing_Formatting.length))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Seq.Base.eq; Namespace FStar.Seq.Base
(assert (! 
;; def=FStar.Seq.Base.fsti(174,4-174,6); use=FStar.Seq.Base.fsti(174,4-174,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.eqtype)
(HasType @x1
...
(HasType @x2
(FStar.Seq.Base.seq @x0)))
(HasType (FStar.Seq.Base.eq @x0
@x1
@x2)
(Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69 @x0
@x1
@x2)))
 

:pattern ((FStar.Seq.Base.eq @x0
@x1
@x2))
:qid typing_FStar.Seq.Base.eq))

:named typing_FStar.Seq.Base.eq))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name FStar.Seq.Base.eq; Namespace FStar.Seq.Base
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=FStar.Seq.Base.fsti(174,49-174,77)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69))

:named refinement_kinding_Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=FStar.Seq.Base.fsti(174,57-174,75); use=FStar.Seq.Base.fsti(174,57-174,75)
(iff 
;; def=FStar.Seq.Base.fsti(174,50-174,51); use=FStar.Seq.Base.fsti(174,57-174,58)
(BoxBool_proj_0 @x1)


;; def=FStar.Seq.Base.fsti(174,64-174,75); use=FStar.Seq.Base.fsti(174,64-174,75)
(Valid 
;; def=FStar.Seq.Base.fsti(174,64-174,75); use=FStar.Seq.Base.fsti(174,64-174,75)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69))

:named refinement_interpretation_Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Seq.Properties.createL_post; Namespace FStar.Seq.Properties
(assert (! 
;; def=Prims.fst(680,11-680,25); use=Prims.fst(680,11-680,25)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69
;;; Fact-ids: Name FStar.Seq.Base.eq; Namespace FStar.Seq.Base
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=FStar.Seq.Base.fsti(174,49-174,77)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.bool)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_1c0effbdef48f9b00a1efb7b571fbb69 @x0
@x1
@x2))))
:qid haseqTm_refine_1c0effbdef48f9b00a1efb7b571fbb69))

:named haseqTm_refine_1c0effbdef48f9b00a1efb7b571fbb69))
...
(assert (! (HasType Formatting.message
Tm_type)
:named function_token_typing_Formatting.message))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
;; def=Prims.fst(183,5-183,9); use=Prims.fst(183,5-183,9)
...
;;;;;;;;;;;;;;;;Equation for Formatting.op_At_Bar
;;; Fact-ids: Name Formatting.op_At_Bar; Namespace Formatting
(assert (! 
;; def=Formatting.fst(26,4-26,13); use=Formatting.fst(26,4-26,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Formatting.op_At_Bar @x0
@x1)
(Platform.Bytes.op_At_Bar @x0
@x1))
...
:pattern ((Formatting.op_At_Bar @x0
@x1))
:qid equation_Formatting.op_At_Bar))

:named equation_Formatting.op_At_Bar))
;;;;;;;;;;;;;;;;Equation for Formatting.message
;;; Fact-ids: Name Formatting.message; Namespace Formatting
(assert (! (= Formatting.message
Platform.Bytes.bytes)
:named equation_Formatting.message))
;;;;;;;;;;;;;;;;Equation for Formatting.length
;;; Fact-ids: Name Formatting.length; Namespace Formatting
(assert (! 
;; def=Formatting.fst(27,4-27,10); use=Formatting.fst(27,4-27,10)
(forall ((@x0 Term))
 (! (= (Formatting.length @x0)
(Platform.Bytes.length @x0))
 

:pattern ((Formatting.length @x0))
:qid equation_Formatting.length))

:named equation_Formatting.length))
...
; Starting query at Formatting.fst(34,0-38,66)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_43f0235b3df63585f23cf32ce0589ee8 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(36,38-36,98); use=Formatting.fst(36,22-36,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_43f0235b3df63585f23cf32ce0589ee8 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_43f0235b3df63585f23cf32ce0589ee8 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_43f0235b3df63585f23cf32ce0589ee8))

:named refinement_kinding_Tm_refine_43f0235b3df63585f23cf32ce0589ee8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(36,38-36,98); use=Formatting.fst(36,22-36,27)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_43f0235b3df63585f23cf32ce0589ee8 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Formatting.fst(36,39-36,59); use=Formatting.fst(36,22-36,27)
(= (Formatting.length @x2)
(Formatting.length @x3))


;; def=Formatting.fst(36,63-36,97); use=Formatting.fst(36,22-36,27)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.op_At_Bar @x2
@x4)
(Formatting.op_At_Bar @x3
@x5)))
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_43f0235b3df63585f23cf32ce0589ee8))

:named refinement_interpretation_Tm_refine_43f0235b3df63585f23cf32ce0589ee8))
;;;;;;;;;;;;;;;;haseq for Tm_refine_43f0235b3df63585f23cf32ce0589ee8
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(36,38-36,98); use=Formatting.fst(36,22-36,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_43f0235b3df63585f23cf32ce0589ee8 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_43f0235b3df63585f23cf32ce0589ee8 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_43f0235b3df63585f23cf32ce0589ee8))

:named haseqTm_refine_43f0235b3df63585f23cf32ce0589ee8))

; Encoding query formula : forall (b1: Formatting.message)
;   (b2: Formatting.message)
;   (c1: Formatting.message)
;   (c2: Formatting.message).
;   (Formatting.length b1 == Formatting.length c1 ==> Prims.hasEq FStar.UInt8.t) /\
;   (forall (any_result: Prims.logical).
;       (Formatting.length b1 == Formatting.length c1) /\ FStar.Seq.Base.eq (b1 @| b2) (c1 @| c2) ==
;       any_result ==>
;       (Formatting.length b1 == Formatting.length c1 ==> Prims.hasEq FStar.UInt8.t) /\
;       (forall (_:
;           Prims.squash (Formatting.length b1 == Formatting.length c1 /\
;               FStar.Seq.Base.eq (b1 @| b2) (c1 @| c2))).
;           (*  - Could not prove post-condition
; *)
;           Prims.hasEq FStar.UInt8.t /\ (FStar.Seq.Base.eq b1 c1 ==> Prims.hasEq FStar.UInt8.t)))


; Context: While encoding a query
; While typechecking the top-level declaration `val Formatting.append_inj_lemma`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Formatting.fst(34,0-38,66)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Formatting.message)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(34,25-38,66)
(and (implies 
;; def=Formatting.fst(36,39-36,59); use=Formatting.fst(36,39-36,59)
(= (Formatting.length @x0)
(Formatting.length @x2))


;; def=Prims.fst(73,23-73,30); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(56,36-56,40)
(or label_1

;; def=Prims.fst(73,23-73,30); use=Formatting.fst(36,38-36,98)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(36,38-36,98)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
)
)

;; def=Prims.fst(451,66-451,102); use=Formatting.fst(34,25-38,66)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.logical)

;; def=FStar.Pervasives.fsti(112,28-112,31); use=Formatting.fst(34,25-38,66)
(= (Prims.l_and (Prims.eq2 Prims.nat
(Formatting.length @x0)
(Formatting.length @x2))
(Prims.b2t (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.op_At_Bar @x0
@x1)
(Formatting.op_At_Bar @x2
@x3))))
...
;; def=dummy(0,0-0,0); use=Formatting.fst(34,25-38,66)
(and (implies 
;; def=Formatting.fst(36,39-36,59); use=Formatting.fst(37,37-37,79)
(= (Formatting.length @x0)
(Formatting.length @x2))


;; def=Prims.fst(73,23-73,30); use=Formatting.fst(36,22-36,27)
(or label_2

;; def=Prims.fst(73,23-73,30); use=Formatting.fst(37,37-37,79)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(37,37-37,79)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Tm_refine_43f0235b3df63585f23cf32ce0589ee8 @x0
@x2
@x1
@x3))

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(56,36-56,40); use=Formatting.fst(37,37-37,79)
(and 
;; def=Prims.fst(73,23-73,30); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(56,36-56,40)
(or label_3
...
(implies 
;; def=Formatting.fst(37,38-37,56); use=Formatting.fst(37,38-37,56)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
@x0
@x2))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.append_inj_lemma, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.UInt8.t
...
; encoding sigelt val Formatting.append_inj_lemma


; <Skipped val Formatting.append_inj_lemma/>
...
; Starting query at Formatting.fst(40,2-42,122)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_8f4292442d8358aa101190d09fa1e2e1 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(41,37-41,59); use=Formatting.fst(41,37-41,59)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_8f4292442d8358aa101190d09fa1e2e1))

:named refinement_kinding_Tm_refine_8f4292442d8358aa101190d09fa1e2e1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(41,37-41,59); use=Formatting.fst(41,37-41,59)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=Formatting.fst(41,44-41,57); use=Formatting.fst(41,44-41,57)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (Formatting.length @x2)))
))
...
@x1
(Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x2)))
:qid refinement_interpretation_Tm_refine_8f4292442d8358aa101190d09fa1e2e1))

:named refinement_interpretation_Tm_refine_8f4292442d8358aa101190d09fa1e2e1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8f4292442d8358aa101190d09fa1e2e1
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(41,37-41,59); use=Formatting.fst(41,37-41,59)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x0))))
:qid haseqTm_refine_8f4292442d8358aa101190d09fa1e2e1))

:named haseqTm_refine_8f4292442d8358aa101190d09fa1e2e1))


;;;;;;;;;;;;;;;;_: i: Prims.nat{i < length b1} -> Prims.GTot Type
(declare-fun Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(41,37-41,59); use=Formatting.fst(40,2-42,122)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5 @x0)
Tm_type))
:qid kinding_Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5))

:named kinding_Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(41,37-41,59); use=Formatting.fst(40,2-42,122)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5 @x2)))
:qid Formatting_pre_typing_Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5))

:named Formatting_pre_typing_Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(41,37-41,59); use=Formatting.fst(40,2-42,122)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5 @x1))
(and 
;; def=Formatting.fst(41,37-41,59); use=Formatting.fst(40,2-42,122)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x1))
(HasType (ApplyTT @x0
@x2)
Tm_type))
...
:pattern ((ApplyTT @x0
@x2))
:qid Formatting_interpretation_Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5 @x1)))
:qid Formatting_interpretation_Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5))

:named Formatting_interpretation_Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5))
(declare-fun Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(27,145-27,165); use=Formatting.fst(40,2-42,122)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03))

:named refinement_kinding_Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(27,145-27,165); use=Formatting.fst(40,2-42,122)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03 @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=FStar.Seq.Properties.fsti(27,151-27,164); use=Formatting.fst(40,2-42,122)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x2)))
))
...
@x1
(Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03 @x2)))
:qid refinement_interpretation_Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03))

:named refinement_interpretation_Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(27,145-27,165); use=Formatting.fst(40,2-42,122)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03 @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03 @x0))))
:qid haseqTm_refine_4bb7a2db2ce06edcc796ff8082ea5d03))

:named haseqTm_refine_4bb7a2db2ce06edcc796ff8082ea5d03))
(declare-fun Tm_refine_8d91222fd035c5271dcbf26fbaadcb99 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(28,5-28,37); use=Formatting.fst(40,2-42,122)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_8d91222fd035c5271dcbf26fbaadcb99 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_8d91222fd035c5271dcbf26fbaadcb99 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_8d91222fd035c5271dcbf26fbaadcb99))

:named refinement_kinding_Tm_refine_8d91222fd035c5271dcbf26fbaadcb99))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(28,5-28,37); use=Formatting.fst(40,2-42,122)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8d91222fd035c5271dcbf26fbaadcb99 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Prims.fst(635,71-635,97); use=Formatting.fst(40,2-42,122)
(not 
;; def=Prims.fst(441,29-441,97); use=Formatting.fst(40,2-42,122)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=FStar.Seq.Properties.fsti(28,11-28,37); use=Formatting.fst(40,2-42,122)
...
;; def=Prims.fst(635,86-635,95); use=Formatting.fst(40,2-42,122)
(not 
;; def=Prims.fst(635,86-635,95); use=Formatting.fst(40,2-42,122)
(= @x5
@x1)
...
;;no pats
:qid refinement_interpretation_Tm_refine_8d91222fd035c5271dcbf26fbaadcb99.1))
)
))
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_8d91222fd035c5271dcbf26fbaadcb99))

:named refinement_interpretation_Tm_refine_8d91222fd035c5271dcbf26fbaadcb99))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8d91222fd035c5271dcbf26fbaadcb99
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(28,5-28,37); use=Formatting.fst(40,2-42,122)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8d91222fd035c5271dcbf26fbaadcb99 @x0
@x1
@x2)))
(Valid (Prims.hasEq Prims.unit)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8d91222fd035c5271dcbf26fbaadcb99 @x0
@x1
@x2))))
:qid haseqTm_refine_8d91222fd035c5271dcbf26fbaadcb99))

:named haseqTm_refine_8d91222fd035c5271dcbf26fbaadcb99))
;;;;;;;;;;;;;;;;i: Prims.nat{i < FStar.Seq.Base.length b1}   -> FStar.Pervasives.Lemma (ensures FStar.Seq.Base.index b1 i == FStar.Seq.Base.index c1 i)
(declare-fun Tm_arrow_f3409bd47bd8772f2e34e01e5f006008 (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(27,145-28,37); use=Formatting.fst(40,2-42,122)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_f3409bd47bd8772f2e34e01e5f006008 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_f3409bd47bd8772f2e34e01e5f006008 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008))

:named kinding_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(27,145-28,37); use=Formatting.fst(40,2-42,122)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_f3409bd47bd8772f2e34e01e5f006008 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_f3409bd47bd8772f2e34e01e5f006008 @x2
@x3)))
:qid Formatting_pre_typing_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008))

:named Formatting_pre_typing_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(27,145-28,37); use=Formatting.fst(40,2-42,122)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_f3409bd47bd8772f2e34e01e5f006008 @x1
@x2))
(and 
;; def=FStar.Seq.Properties.fsti(27,145-28,37); use=Formatting.fst(40,2-42,122)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid Formatting_interpretation_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008.1))
...
(Tm_arrow_f3409bd47bd8772f2e34e01e5f006008 @x1
@x2)))
:qid Formatting_interpretation_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008))

:named Formatting_interpretation_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008))
...
(declare-fun Tm_abs_10a6fb9326a6b45830f286158a3be8bc (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_10a6fb9326a6b45830f286158a3be8bc
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(42,64-42,88); use=Formatting.fst(42,64-42,88)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_10a6fb9326a6b45830f286158a3be8bc @x0
@x1)
(Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5 @x1))
 

:pattern ((Tm_abs_10a6fb9326a6b45830f286158a3be8bc @x0
@x1))
:qid typing_Tm_abs_10a6fb9326a6b45830f286158a3be8bc))

:named typing_Tm_abs_10a6fb9326a6b45830f286158a3be8bc))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_10a6fb9326a6b45830f286158a3be8bc
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(42,64-42,88); use=Formatting.fst(42,64-42,88)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_10a6fb9326a6b45830f286158a3be8bc @x1
@x2)
@x0)
(Prims.eq2 (FStar.UInt8.t Dummy_value)
(FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
@x2
@x0)
(FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
...
:pattern ((ApplyTT (Tm_abs_10a6fb9326a6b45830f286158a3be8bc @x1
@x2)
@x0))
:qid interpretation_Tm_abs_10a6fb9326a6b45830f286158a3be8bc))

:named interpretation_Tm_abs_10a6fb9326a6b45830f286158a3be8bc))
...
;         FStar.Seq.Base.eq b1 c1 /\ FStar.Seq.Base.eq b2 c2 ==> p pure_result) ==>
;     (FStar.Seq.Base.length b1 = FStar.Seq.Base.length c1 \/
;       FStar.Seq.Base.length b2 = FStar.Seq.Base.length c2) /\
;     FStar.Seq.Base.equal (FStar.Seq.Base.append b1 b2) (FStar.Seq.Base.append c1 c2) /\
;     (forall (any_result: Formatting.message).
;         c2 == any_result ==>
;         (forall (pure_result: Prims.unit).
;             FStar.Seq.Base.length b1 = FStar.Seq.Base.length c1 /\
;             FStar.Seq.Base.length b2 = FStar.Seq.Base.length c2 ==>
;             (forall (x: i: Prims.nat{i < Formatting.length b1}).
;                 (*  - Could not prove post-condition
; *)
;                 (x < Formatting.length b1 ==> x < FStar.Seq.Base.length b1) /\
;                 (forall (any_result: i: Prims.nat{i < Formatting.length b1}).
;                     x == any_result ==>
;                     (forall (any_result: FStar.UInt8.t).
;                         FStar.Seq.Base.index b1 x == any_result ==>
;                         x < Formatting.length b1 ==> x < FStar.Seq.Base.length c1))) /\
;             (forall (any_result: (_: i: Prims.nat{i < Formatting.length b1} -> Prims.GTot Type0)).
;                 (fun x -> FStar.Seq.Base.index b1 x == FStar.Seq.Base.index c1 x) == any_result ==>
;                 FStar.Seq.Base.length b1 = FStar.Seq.Base.length c1 /\
;                 FStar.Seq.Base.equal (FStar.Seq.Base.append b1 b2) (FStar.Seq.Base.append c1 c2) /\
;                 (forall (any_result: Formatting.message).
;                     c2 == any_result ==>
;                     (forall (any_result:
;                         (i: Prims.nat{i < FStar.Seq.Base.length b1}
;                             -> FStar.Pervasives.Lemma
;                               (ensures FStar.Seq.Base.index b1 i == FStar.Seq.Base.index c1 i)))
;                         (pure_result: Prims.unit).
;                         (forall (x: i: Prims.nat{i < Formatting.length b1}).
;                             FStar.Seq.Base.index b1 x == FStar.Seq.Base.index c1 x) ==>
;                         (forall (x: i: Prims.nat{i < Formatting.length b2}).
;                             (*  - Could not prove post-condition
; *)
;                             (x < Formatting.length b2 ==> x < FStar.Seq.Base.length b2) /\
;                             (forall (any_result: i: Prims.nat{i < Formatting.length b2}).
;                                 x == any_result ==>
;                                 (forall (any_result: FStar.UInt8.t).
;                                     FStar.Seq.Base.index b2 x == any_result ==>
;                                     x < Formatting.length b2 ==> x < FStar.Seq.Base.length c2))) /\
;                         (forall (any_result:
;                             (_: i: Prims.nat{i < Formatting.length b2} -> Prims.GTot Type0)).
;                             (fun x -> FStar.Seq.Base.index b2 x == FStar.Seq.Base.index c2 x) ==
;                             any_result ==>
;                             FStar.Seq.Base.length b1 = FStar.Seq.Base.length c1 /\
;                             FStar.Seq.Base.length b2 = FStar.Seq.Base.length c2 /\
;                             FStar.Seq.Base.equal (FStar.Seq.Base.append b1 b2)
;                               (FStar.Seq.Base.append c1 c2) /\
;                             (forall (any_result: Formatting.message).
;                                 c2 == any_result ==>
;                                 (forall (any_result:
;                                     (i: Prims.nat{i < FStar.Seq.Base.length b2}
;                                         -> FStar.Pervasives.Lemma
;                                           (ensures
;                                             FStar.Seq.Base.index b2 i == FStar.Seq.Base.index c2 i)))
;                                     (pure_result: Prims.unit).
;                                     (forall (x: i: Prims.nat{i < Formatting.length b2}).
;                                         FStar.Seq.Base.index b2 x == FStar.Seq.Base.index c2 x) ==>
;                                     p pure_result))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let append_inj_lemma`
...
;; def=Formatting.fst(36,39-36,59); use=Formatting.fst(40,2-42,122)
(= (Formatting.length @x0)
(Formatting.length @x2))


;; def=Formatting.fst(36,63-36,97); use=Formatting.fst(40,2-42,122)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.op_At_Bar @x0
@x1)
(Formatting.op_At_Bar @x2
...
;; def=Prims.fst(441,36-441,97); use=Formatting.fst(40,2-42,122)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Formatting.fst(37,38-37,56); use=Formatting.fst(40,2-42,122)
(or label_2
...
;; def=Formatting.fst(37,60-37,78); use=Formatting.fst(40,2-42,122)
(or label_3
...
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(40,2-42,122)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(40,2-42,122)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(40,2-42,122)
(and 
;; def=FStar.Seq.Properties.fsti(33,84-33,132); use=Formatting.fst(40,33-40,35)
(or label_4

;; def=FStar.Seq.Properties.fsti(33,85-33,106); use=Formatting.fst(40,33-40,35)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x0)
(FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x2))
...
;; def=FStar.Seq.Properties.fsti(33,110-33,131); use=Formatting.fst(40,33-40,35)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x1)
(FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x3))
...
;; def=FStar.Seq.Properties.fsti(33,136-33,173); use=Formatting.fst(40,33-40,35)
(or label_5
...
;; def=Prims.fst(451,66-451,102); use=Formatting.fst(40,2-42,122)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Formatting.message)

;; def=FStar.Seq.Properties.fsti(33,74-33,76); use=Formatting.fst(40,2-42,122)
(= @x3
@x5)
)

;; def=Prims.fst(441,36-441,97); use=Formatting.fst(40,2-40,23)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=FStar.Seq.Properties.fsti(34,21-34,42); use=Formatting.fst(40,2-40,23)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x0)
(FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x2))
...
;; def=FStar.Seq.Properties.fsti(34,46-34,67); use=Formatting.fst(40,2-40,23)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x1)
(FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x3))
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(40,2-42,122)
(and 
;; def=dummy(0,0-0,0); use=Formatting.fst(40,2-42,122)
(forall ((@x7 Term))
 (! (implies (HasType @x7
(Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x0))

;; def=Prims.fst(459,77-459,89); use=Formatting.fst(41,64-41,88)
(and (implies 
;; def=Formatting.fst(41,44-41,57); use=Formatting.fst(41,73-41,74)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (Formatting.length @x0)))


;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Formatting.fst(41,73-41,74)
(or label_6
...
;; def=Prims.fst(451,66-451,102); use=Formatting.fst(41,64-41,88)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x0))

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=Formatting.fst(41,64-41,88)
(= @x7
@x8)
)
...
;; def=Prims.fst(175,35-175,36); use=Formatting.fst(41,64-41,88)
(= (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
@x0
@x7)
@x9)
...
;; def=Formatting.fst(41,44-41,57); use=Formatting.fst(41,87-41,88)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (Formatting.length @x0)))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Formatting.fst(41,87-41,88)
(or label_7
...
(Tm_arrow_eeaeb3d55cd3c6d5b324fed7c6fa3fb5 @x0))

;; def=FStar.Classical.fsti(240,30-240,31); use=Formatting.fst(40,2-42,122)
(= (Tm_abs_10a6fb9326a6b45830f286158a3be8bc @x2
@x0)
@x7)
)
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(40,2-42,122)
(and 
;; def=FStar.Seq.Properties.fsti(27,80-27,101); use=Formatting.fst(41,119-41,121)
(or label_8
...
;; def=FStar.Seq.Properties.fsti(27,105-27,140); use=Formatting.fst(41,119-41,121)
(or label_9
...
;; def=FStar.Seq.Properties.fsti(27,71-27,73); use=Formatting.fst(40,2-42,122)
(= @x3
@x8)
)
...
;; def=Prims.fst(441,36-441,97); use=Formatting.fst(41,12-41,24)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=FStar.Classical.fsti(241,12-241,32); use=Formatting.fst(41,12-41,24)
(forall ((@x11 Term))
 (! (implies (HasType @x11
(Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x0))

;; def=Formatting.fst(41,64-41,88); use=Formatting.fst(41,12-41,24)
(= (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
@x0
@x11)
(FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(42,64-42,88)
(and (implies 
;; def=Formatting.fst(42,44-42,57); use=Formatting.fst(42,73-42,74)
(< (BoxInt_proj_0 @x11)
(BoxInt_proj_0 (Formatting.length @x1)))


;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Formatting.fst(42,73-42,74)
(or label_10
...
;; def=Prims.fst(451,66-451,102); use=Formatting.fst(42,64-42,88)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
(Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x1))

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=Formatting.fst(42,64-42,88)
(= @x11
@x12)
)
...
;; def=Prims.fst(175,35-175,36); use=Formatting.fst(42,64-42,88)
(= (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
@x1
@x11)
@x13)
...
;; def=Formatting.fst(42,44-42,57); use=Formatting.fst(42,87-42,88)
(< (BoxInt_proj_0 @x11)
(BoxInt_proj_0 (Formatting.length @x1)))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Formatting.fst(42,87-42,88)
(or label_11
...
;; def=FStar.Classical.fsti(240,30-240,31); use=Formatting.fst(40,2-42,122)
(= (Tm_abs_10a6fb9326a6b45830f286158a3be8bc @x3
@x1)
@x11)
)
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(40,2-42,122)
(and 
;; def=FStar.Seq.Properties.fsti(30,80-30,101); use=Formatting.fst(42,119-42,121)
(or label_12
...
;; def=FStar.Seq.Properties.fsti(30,105-30,126); use=Formatting.fst(42,119-42,121)
(or label_13
...
;; def=FStar.Seq.Properties.fsti(30,130-30,165); use=Formatting.fst(42,119-42,121)
(or label_14
...
;; def=FStar.Seq.Properties.fsti(30,71-30,73); use=Formatting.fst(40,2-42,122)
(= @x3
@x12)
)
...
(forall ((@x13 Term))
 (! (implies (HasType @x13
(Tm_arrow_f3409bd47bd8772f2e34e01e5f006008 @x3
@x1))

;; def=Prims.fst(441,36-441,97); use=Formatting.fst(42,12-42,24)
(forall ((@x14 Term))
 (! (implies (and (HasType @x14
Prims.unit)

;; def=FStar.Classical.fsti(241,12-241,32); use=Formatting.fst(42,12-42,24)
(forall ((@x15 Term))
 (! (implies (HasType @x15
(Tm_refine_8f4292442d8358aa101190d09fa1e2e1 @x1))

;; def=Formatting.fst(42,64-42,88); use=Formatting.fst(42,12-42,24)
(= (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
@x1
@x15)
(FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
...
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(42,12-42,24)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(42,12-42,24)
(ApplyTT @x4
@x14)
...
; encoding sigelt let append_inj_lemma


; <Start encoding let append_inj_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Formatting.append_inj_lemma (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Formatting.append_inj_lemma@tok () Term)

; </end encoding let append_inj_lemma>
...
; Starting query at Formatting.fst(44,0-48,31)
...
;;;;;;;;;;;;;;;;i: Prims.nat{i < FStar.Seq.Base.length s1} -> Prims.GTot Type0
(declare-fun Tm_arrow_80e61e991a7a94e10c697c68e3424fbf (Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_80e61e991a7a94e10c697c68e3424fbf
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(46,26-46,52); use=Formatting.fst(46,26-46,52)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_80e61e991a7a94e10c697c68e3424fbf @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_80e61e991a7a94e10c697c68e3424fbf @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_80e61e991a7a94e10c697c68e3424fbf))

:named kinding_Tm_arrow_80e61e991a7a94e10c697c68e3424fbf))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(46,26-46,52); use=Formatting.fst(46,26-46,52)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_80e61e991a7a94e10c697c68e3424fbf @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_80e61e991a7a94e10c697c68e3424fbf @x2
@x3)))
:qid Formatting_pre_typing_Tm_arrow_80e61e991a7a94e10c697c68e3424fbf))

:named Formatting_pre_typing_Tm_arrow_80e61e991a7a94e10c697c68e3424fbf))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_80e61e991a7a94e10c697c68e3424fbf
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(46,26-46,52); use=Formatting.fst(46,26-46,52)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_80e61e991a7a94e10c697c68e3424fbf @x1
@x2))
(and 
;; def=Formatting.fst(46,26-46,52); use=Formatting.fst(46,26-46,52)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid Formatting_interpretation_Tm_arrow_80e61e991a7a94e10c697c68e3424fbf.1))
...
(Tm_arrow_80e61e991a7a94e10c697c68e3424fbf @x1
@x2)))
:qid Formatting_interpretation_Tm_arrow_80e61e991a7a94e10c697c68e3424fbf))

:named Formatting_interpretation_Tm_arrow_80e61e991a7a94e10c697c68e3424fbf))
(declare-fun Tm_abs_7278d00ef19c3925b6f64209cb152ddd (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_7278d00ef19c3925b6f64209cb152ddd
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(46,18-46,134); use=Formatting.fst(46,18-46,134)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_7278d00ef19c3925b6f64209cb152ddd @x0
@x1
@x2)
(Tm_arrow_80e61e991a7a94e10c697c68e3424fbf @x1
@x2))
...
:pattern ((Tm_abs_7278d00ef19c3925b6f64209cb152ddd @x0
@x1
@x2))
:qid typing_Tm_abs_7278d00ef19c3925b6f64209cb152ddd))

:named typing_Tm_abs_7278d00ef19c3925b6f64209cb152ddd))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_7278d00ef19c3925b6f64209cb152ddd
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(46,18-46,134); use=Formatting.fst(46,18-46,134)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_7278d00ef19c3925b6f64209cb152ddd @x1
@x2
@x3)
@x0)
(Prims.eq2 @x3
...
:pattern ((ApplyTT (Tm_abs_7278d00ef19c3925b6f64209cb152ddd @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_7278d00ef19c3925b6f64209cb152ddd))

:named interpretation_Tm_abs_7278d00ef19c3925b6f64209cb152ddd))
...
;; def=Formatting.fst(46,18-46,134); use=Formatting.fst(46,18-46,134)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.l_Forall (Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x2
@x1)
(Tm_abs_7278d00ef19c3925b6f64209cb152ddd @x0
@x1
@x2)))
...
;; def=Formatting.fst(46,99-46,133); use=Formatting.fst(46,99-46,133)
...
:pattern ((FStar.Seq.Base.index @x2
@x1
@x3) (FStar.Seq.Base.index @x2
@x0
@x3))
:qid l_quant_interp_7c3e2e74ec0e18a1353b79b16a701fce.1))
)
 

:pattern ((Valid (Prims.l_Forall (Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x2
@x1)
(Tm_abs_7278d00ef19c3925b6f64209cb152ddd @x0
@x1
@x2))))
:qid l_quant_interp_7c3e2e74ec0e18a1353b79b16a701fce))

:named l_quant_interp_7c3e2e74ec0e18a1353b79b16a701fce))
...
;   - Expected type i: Prims.nat{i < FStar.Seq.Base.length s2}
;     got type i: Prims.nat{i < FStar.Seq.Base.length s1}
; *)
;         i < FStar.Seq.Base.length s1 ==> i < FStar.Seq.Base.length s2)) /\
;   (forall (any_result: Prims.logical).
;       (FStar.Seq.Base.length s1 = FStar.Seq.Base.length s2) /\
;       (forall (i: Prims.nat{i < FStar.Seq.Base.length s1}).
...
; Context: While encoding a query
; While typechecking the top-level declaration `val Formatting.lemma_eq_intro`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Formatting.fst(44,0-48,31)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(44,23-48,31)
(and 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(45,20-45,26)
(or label_1
...
(implies 
;; def=Formatting.fst(45,16-45,45); use=Formatting.fst(45,16-45,45)
(= (FStar.Seq.Base.length @x0
@x1)
(FStar.Seq.Base.length @x0
@x2))
...
;; def=dummy(0,0-0,0); use=Formatting.fst(45,15-46,135)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x0
@x1))

;; def=Formatting.fst(46,33-46,50); use=Formatting.fst(46,131-46,132)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (FStar.Seq.Base.length @x0
@x1)))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Formatting.fst(46,131-46,132)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Formatting.fst(44,23-48,31)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.logical)

;; def=FStar.Pervasives.fsti(112,28-112,31); use=Formatting.fst(44,23-48,31)
(= (Prims.l_and (Prims.b2t (Prims.op_Equality Prims.nat
(FStar.Seq.Base.length @x0
@x1)
(FStar.Seq.Base.length @x0
@x2)))
(Prims.l_Forall (Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x0
@x1)
(Tm_abs_7278d00ef19c3925b6f64209cb152ddd @x2
@x1
@x0)))
@x3)
)

;; def=dummy(0,0-0,0); use=Formatting.fst(47,14-47,31)
(and 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(44,55-44,60)
(or label_3

;; def=Prims.fst(73,23-73,30); use=Formatting.fst(47,14-47,31)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(47,14-47,31)
(Prims.hasEq Prims.nat)
)
...
(implies 
;; def=Formatting.fst(45,16-45,45); use=Formatting.fst(47,14-47,31)
(= (FStar.Seq.Base.length @x0
@x1)
(FStar.Seq.Base.length @x0
@x2))
...
;; def=Formatting.fst(46,33-46,50); use=Formatting.fst(47,14-47,31)
(< (BoxInt_proj_0 @x4)
(BoxInt_proj_0 (FStar.Seq.Base.length @x0
@x1)))
)
...
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Formatting.fst(47,14-47,31)
(< (BoxInt_proj_0 @x4)
(BoxInt_proj_0 (FStar.Seq.Base.length @x0
@x2)))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.lemma_eq_intro, 1)
; STATUS: unsat
...
; encoding sigelt val Formatting.lemma_eq_intro


; <Skipped val Formatting.lemma_eq_intro/>

(push) ;; push{2

; Starting query at Formatting.fst(49,30-49,32)
...
;         {:pattern FStar.Seq.Base.index s1 i; FStar.Seq.Base.index s2 i}
;         FStar.Seq.Base.index s1 i == FStar.Seq.Base.index s2 i) /\
;     (forall (pure_result: Prims.unit). FStar.Seq.Base.equal s1 s2 ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let lemma_eq_intro`
...
;; def=Formatting.fst(45,16-45,45); use=Formatting.fst(49,30-49,32)
(= (FStar.Seq.Base.length @x0
@x1)
(FStar.Seq.Base.length @x0
@x2))
...
;; def=Formatting.fst(46,18-46,134); use=Formatting.fst(49,30-49,32)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x0
@x1))

;; def=Formatting.fst(46,99-46,133); use=Formatting.fst(49,30-49,32)
(= (FStar.Seq.Base.index @x0
@x1
@x4)
(FStar.Seq.Base.index @x0
...
:pattern ((FStar.Seq.Base.index @x0
@x1
@x4) (FStar.Seq.Base.index @x0
@x2
@x4))
:qid @query.2))


;; def=Prims.fst(441,36-441,97); use=Formatting.fst(49,30-49,32)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=Formatting.fst(47,14-47,31); use=Formatting.fst(49,30-49,32)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(49,30-49,32)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(49,30-49,32)
(ApplyTT @x3
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.lemma_eq_intro, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, lemma_FStar.Seq.Base.lemma_eq_intro
...
; encoding sigelt let lemma_eq_intro


; <Start encoding let lemma_eq_intro>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Formatting.lemma_eq_intro (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Formatting.lemma_eq_intro@tok () Term)


; </end encoding let lemma_eq_intro>


; encoding sigelt let uInt16


; <Start encoding let uInt16>

(declare-fun Formatting.uInt16 (Term) Term)
;;;;;;;;;;;;;;;;i: Prims.int -> Prims.logical
(declare-fun Tm_arrow_18523044355bf6a573deed3112c71d2b () Term)
(declare-fun Formatting.uInt16@tok () Term)
...
(declare-fun Formatting.uint16 () Term)
(declare-fun Tm_refine_ebb7aa1a8eb38feb68a75d192e1c165d () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.uInt16; Namespace Formatting
(assert (! 
;; def=Formatting.fst(53,5-53,11); use=Formatting.fst(53,5-53,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(HasType (Formatting.uInt16 @x0)
Prims.logical))
 

:pattern ((Formatting.uInt16 @x0))
:qid typing_Formatting.uInt16))

:named typing_Formatting.uInt16))
;;;;;;;;;;;;;;;;string inversion
;;; Fact-ids: Name Prims.string; Namespace Prims
(assert (! (forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Formatting.uint16; Namespace Formatting
(assert (! (HasType Tm_refine_ebb7aa1a8eb38feb68a75d192e1c165d
Tm_type)
:named refinement_kinding_Tm_refine_ebb7aa1a8eb38feb68a75d192e1c165d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Formatting.uint16; Namespace Formatting
(assert (! 
;; def=Formatting.fst(54,14-54,29); use=Formatting.fst(54,14-54,29)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ebb7aa1a8eb38feb68a75d192e1c165d)
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(54,20-54,28)
(Valid 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(54,20-54,28)
(Formatting.uInt16 @x1)
)
))
...
@x1
Tm_refine_ebb7aa1a8eb38feb68a75d192e1c165d))
:qid refinement_interpretation_Tm_refine_ebb7aa1a8eb38feb68a75d192e1c165d))

:named refinement_interpretation_Tm_refine_ebb7aa1a8eb38feb68a75d192e1c165d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ebb7aa1a8eb38feb68a75d192e1c165d
;;; Fact-ids: Name Formatting.uint16; Namespace Formatting
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ebb7aa1a8eb38feb68a75d192e1c165d))
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_ebb7aa1a8eb38feb68a75d192e1c165d))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.string; Namespace Prims
(assert (! (HasType Prims.string
Prims.eqtype)
:named function_token_typing_Prims.string))
;;;;;;;;;;;;;;;;Equation for Formatting.uInt16
;;; Fact-ids: Name Formatting.uInt16; Namespace Formatting
(assert (! 
;; def=Formatting.fst(53,5-53,11); use=Formatting.fst(53,5-53,11)
(forall ((@x0 Term))
 (! (= (Valid (Formatting.uInt16 @x0))

;; def=Formatting.fst(53,22-53,43); use=Formatting.fst(53,22-53,43)
(and 
;; def=Formatting.fst(53,23-53,29); use=Formatting.fst(53,23-53,29)
(<= (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 @x0))


;; def=Formatting.fst(53,33-53,42); use=Formatting.fst(53,33-53,42)
(< (BoxInt_proj_0 @x0)
...
:pattern ((Formatting.uInt16 @x0))
:qid equation_Formatting.uInt16))

:named equation_Formatting.uInt16))
;;;;;;;;;;;;;;;;Prop-typing for Formatting.uInt16
;;; Fact-ids: Name Formatting.uInt16; Namespace Formatting
(assert (! 
;; def=Formatting.fst(53,5-53,11); use=Formatting.fst(53,5-53,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(Valid (Prims.subtype_of (Formatting.uInt16 @x0)
Prims.unit)))
 

:pattern ((Prims.subtype_of (Formatting.uInt16 @x0)
Prims.unit))
:qid defn_equation_Formatting.uInt16))

:named defn_equation_Formatting.uInt16))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.string; Namespace Prims
(assert (! (= 207
...
; Starting query at Formatting.fst(64,0-66,59)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (s0: Prims.string).
;   (*  - Could not prove post-condition
; *)
;   forall (s1: Prims.string).
;     (*  - Subtyping check failed
;   - Expected type Prims.eqtype got type Type0
; *)
;     Prims.hasEq FStar.UInt8.t


; Context: While encoding a query
; While typechecking the top-level declaration `assume Formatting.UTF8_inj`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Formatting.fst(64,0-66,59)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.string)

;; def=dummy(0,0-0,0); use=Formatting.fst(65,12-66,59)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.string)
...
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(66,4-66,59)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(66,4-66,59)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.UTF8_inj, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.UInt8.t
...
; encoding sigelt assume Formatting.UTF8_inj


; <Start encoding assume Formatting.UTF8_inj>


; </end encoding assume Formatting.UTF8_inj>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.uint16; Namespace Formatting
(assert (! (HasType Formatting.uint16
Tm_type)
:named typing_Formatting.uint16))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Formatting.uint16; Namespace Formatting
(assert (! (HasType Formatting.uint16
Tm_type)
:named function_token_typing_Formatting.uint16))
;;;;;;;;;;;;;;;;Equation for Formatting.uint16
;;; Fact-ids: Name Formatting.uint16; Namespace Formatting
(assert (! (= Formatting.uint16
Tm_refine_ebb7aa1a8eb38feb68a75d192e1c165d)
:named equation_Formatting.uint16))
(push) ;; push{2

; Starting query at Formatting.fst(68,0-68,69)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u140: Formatting.uint16).
;   (*  - Subtyping check failed
;   - Expected type Prims.nat got type uint16
; *)
;   Formatting.uInt16 u140 ==> u140 >= 0


; Context: While encoding a query
; While typechecking the top-level declaration `val Formatting.uint16_to_bytes`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Formatting.fst(68,21-68,69)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Formatting.uint16)

;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(68,47-68,48)
(Valid 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(68,47-68,48)
(Formatting.uInt16 @x0)
)
)

;; def=Prims.fst(680,18-680,24); use=Formatting.fst(68,47-68,48)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.uint16_to_bytes, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Formatting.uInt16
...
; encoding sigelt val Formatting.uint16_to_bytes


; <Skipped val Formatting.uint16_to_bytes/>
...
; Starting query at Formatting.fst(70,24-70,46)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a
Tm_type)
:named refinement_kinding_Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(68,21-68,54); use=Formatting.fst(70,4-70,19)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a)
(and (HasTypeFuel @u0
@x1
Formatting.uint16)

;; def=Formatting.fst(68,30-68,53); use=Formatting.fst(70,4-70,19)
...
@x1
Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a))
:qid refinement_interpretation_Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a))

:named refinement_interpretation_Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a))
(Valid (Prims.hasEq Formatting.uint16)))
:named haseqTm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a))

; Encoding query formula : forall (u166: u167: Formatting.uint16{Platform.Bytes.repr_bytes u167 <= 2}).
;   (*  - Could not prove post-condition
; *)
;   Formatting.uInt16 u166 /\ Platform.Bytes.repr_bytes u166 <= 2 ==>
;   u166 >= 0 /\ Platform.Bytes.repr_bytes u166 <= 2


; Context: While encoding a query
; While typechecking the top-level declaration `let uint16_to_bytes`
...
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(70,45-70,46)
(Valid 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(70,45-70,46)
(Formatting.uInt16 @x0)
)
...
;; def=Formatting.fst(68,30-68,53); use=Formatting.fst(70,45-70,46)
(<= (BoxInt_proj_0 (Platform.Bytes.repr_bytes @x0))
(BoxInt_proj_0 (BoxInt 2)))
)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(172,41-172,58); use=Formatting.fst(70,45-70,46)
(and 
;; def=Prims.fst(680,18-680,24); use=Formatting.fst(70,45-70,46)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.uint16_to_bytes, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Formatting.uInt16
...
; Starting query at Formatting.fst(70,0-70,46)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (u205: Formatting.uint16).
;   (*  - Subtyping check failed
;   - Expected type Prims.nat got type uint16
; *)
;   Formatting.uInt16 u205 ==> u205 >= 0
...
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(70,4-70,19)
(Valid 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(70,4-70,19)
(Formatting.uInt16 @x0)
)
...
;; def=Prims.fst(680,18-680,24); use=Formatting.fst(70,4-70,19)
(>= (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.uint16_to_bytes, 3)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Formatting.uInt16
...
; encoding sigelt let uint16_to_bytes


; <Start encoding let uint16_to_bytes>

(declare-fun Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a () Term)
(declare-fun Formatting.uint16_to_bytes (Term) Term)

;;;;;;;;;;;;;;;;u234: u235: uint16{Platform.Bytes.repr_bytes u235 <= 2} -> msg 2
(declare-fun Tm_arrow_4ece96020c3245a3b96e417392012fe1 () Term)
(declare-fun Formatting.uint16_to_bytes@tok () Term)


; </end encoding let uint16_to_bytes>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.uint16_to_bytes; Namespace Formatting
(assert (! 
;; def=Formatting.fst(70,4-70,19); use=Formatting.fst(70,4-70,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a)
(HasType (Formatting.uint16_to_bytes @x0)
(Formatting.msg (BoxInt 2))))
 

:pattern ((Formatting.uint16_to_bytes @x0))
:qid typing_Formatting.uint16_to_bytes))

:named typing_Formatting.uint16_to_bytes))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.msg; Namespace Formatting
(assert (! 
;; def=Formatting.fst(30,5-30,8); use=Formatting.fst(30,5-30,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (Formatting.msg @x0)
Tm_type))
 

:pattern ((Formatting.msg @x0))
:qid typing_Formatting.msg))

:named typing_Formatting.msg))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Platform.Bytes.bytes_of_int; Namespace Platform.Bytes
(assert (! 
...
:named refinement_interpretation_Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a))
;;;;;;;;;;;;;;;;Lemma: Formatting.lemma_eq_intro
;;; Fact-ids: Name Formatting.lemma_eq_intro; Namespace Formatting
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=Formatting.fst(45,16-45,45); use=Formatting.fst(49,4-49,18)
(= (FStar.Seq.Base.length @x0
@x1)
(FStar.Seq.Base.length @x0
@x2))
...
;; def=Formatting.fst(46,18-46,134); use=Formatting.fst(49,4-49,18)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x0
@x1))

;; def=Formatting.fst(46,99-46,133); use=Formatting.fst(49,4-49,18)
(= (FStar.Seq.Base.index @x0
@x1
@x3)
(FStar.Seq.Base.index @x0
...
@x2
@x3))
:qid lemma_Formatting.lemma_eq_intro.1))
)

;; def=Formatting.fst(47,14-47,31); use=Formatting.fst(49,4-49,18)
(Valid 
;; def=Formatting.fst(47,14-47,31); use=Formatting.fst(49,4-49,18)
(FStar.Seq.Base.equal @x0
@x1
...
@x1
@x2))
:qid lemma_Formatting.lemma_eq_intro))
:named lemma_Formatting.lemma_eq_intro))
...
;;;;;;;;;;;;;;;;Equation for Formatting.uint16_to_bytes
;;; Fact-ids: Name Formatting.uint16_to_bytes; Namespace Formatting
(assert (! 
;; def=Formatting.fst(70,4-70,19); use=Formatting.fst(70,4-70,19)
(forall ((@x0 Term))
 (! (= (Formatting.uint16_to_bytes @x0)
(Platform.Bytes.bytes_of_int (BoxInt 2)
@x0))
 

:pattern ((Formatting.uint16_to_bytes @x0))
:qid equation_Formatting.uint16_to_bytes))

:named equation_Formatting.uint16_to_bytes))
;;;;;;;;;;;;;;;;Equation for Formatting.msg
;;; Fact-ids: Name Formatting.msg; Namespace Formatting
(assert (! 
;; def=Formatting.fst(30,5-30,8); use=Formatting.fst(30,5-30,8)
(forall ((@x0 Term))
...
:pattern ((Formatting.msg @x0))
:qid equation_Formatting.msg))

:named equation_Formatting.msg))
(push) ;; push{2

; Starting query at Formatting.fst(72,0-72,98)
...
(declare-fun Tm_refine_e1654124cafabcfd19c68d984b9f6837 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_e1654124cafabcfd19c68d984b9f6837
Tm_type)
:named refinement_kinding_Tm_refine_e1654124cafabcfd19c68d984b9f6837))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(68,21-68,53); use=Formatting.fst(72,33-72,98)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_e1654124cafabcfd19c68d984b9f6837)
(and (HasTypeFuel @u0
@x1
Formatting.uint16)

;; def=Formatting.fst(68,30-68,53); use=Formatting.fst(72,46-72,82)
(or 
;; def=Formatting.fst(68,30-68,53); use=Formatting.fst(72,92-72,94)
(<= (BoxInt_proj_0 (Platform.Bytes.repr_bytes @x1))
(BoxInt_proj_0 (BoxInt 2)))


;; def=Formatting.fst(68,30-68,53); use=Formatting.fst(72,96-72,98)
(<= (BoxInt_proj_0 (Platform.Bytes.repr_bytes @x1))
(BoxInt_proj_0 (BoxInt 2)))
)
))
...
@x1
Tm_refine_e1654124cafabcfd19c68d984b9f6837))
:qid refinement_interpretation_Tm_refine_e1654124cafabcfd19c68d984b9f6837))

:named refinement_interpretation_Tm_refine_e1654124cafabcfd19c68d984b9f6837))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e1654124cafabcfd19c68d984b9f6837
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_e1654124cafabcfd19c68d984b9f6837))
(Valid (Prims.hasEq Formatting.uint16)))
:named haseqTm_refine_e1654124cafabcfd19c68d984b9f6837))



; Encoding query formula : (forall (u1166: Formatting.uint16).
;     (*  - Subtyping check failed
;   - Expected type Prims.nat got type uint16
; *)
;     Formatting.uInt16 u1166 ==> u1166 >= 0) /\
; (forall (any_result: Type0).
;     u1168: Formatting.uint16{Platform.Bytes.repr_bytes u1168 <= 2} == any_result ==>
;     (forall (u1169: Formatting.uint16).
;         (*  - Subtyping check failed
;   - Expected type Prims.nat got type uint16
; *)
;         Formatting.uInt16 u1169 ==> u1169 >= 0) /\
;     (forall (s0: u1171: Formatting.uint16{Platform.Bytes.repr_bytes u1171 <= 2}).
;         (*  - Could not prove post-condition
; *)
;         (forall (u1172: Formatting.uint16).
;             (*  - Subtyping check failed
;   - Expected type Prims.nat got type uint16
; *)
;             Formatting.uInt16 u1172 ==> u1172 >= 0) /\
;         (forall (any_result: Type0).
;             u1174: Formatting.uint16{Platform.Bytes.repr_bytes u1174 <= 2} == any_result ==>
;             (forall (u1175: Formatting.uint16).
;                 (*  - Subtyping check failed
;   - Expected type Prims.nat got type uint16
; *)
;                 Formatting.uInt16 u1175 ==> u1175 >= 0) /\
;             (forall (s1: u1177: Formatting.uint16{Platform.Bytes.repr_bytes u1177 <= 2}).
;                 Prims.hasEq FStar.UInt8.t /\
;                 (FStar.Seq.Base.eq (Formatting.uint16_to_bytes s0) (Formatting.uint16_to_bytes s1) ==>
;                   (forall (u1178: Formatting.uint16).
;                       (Formatting.uInt16 u1178 ==> u1178 >= 0) /\
;                       (~(Platform.Bytes.repr_bytes u1178 <= 2) ==>
;                         Formatting.uInt16 u1178 ==> u1178 >= 0)) /\
;                   (forall (any_result: Type0).
;                       u1180:
;                       Formatting.uint16
;                         { Platform.Bytes.repr_bytes u1180 <= 2 \/
;                           Platform.Bytes.repr_bytes u1180 <= 2 } ==
;                       any_result ==>
;                       (Platform.Bytes.repr_bytes s0 <= 2 ==>
;                         Platform.Bytes.repr_bytes s0 <= 2 \/ Platform.Bytes.repr_bytes s0 <= 2) /\
;                       (forall (any_result:
;                           u1182: Formatting.uint16{Platform.Bytes.repr_bytes u1182 <= 2}).
;                           s0 == any_result ==>
;                           Platform.Bytes.repr_bytes s1 <= 2 ==>
;                           Platform.Bytes.repr_bytes s1 <= 2 \/ Platform.Bytes.repr_bytes s1 <= 2))))
;         )))


; Context: While encoding a query
; While typechecking the top-level declaration `assume Formatting.UINT16_inj`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(72,0-72,98)
(and 
;; def=dummy(0,0-0,0); use=Formatting.fst(72,0-72,98)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Formatting.uint16)

;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(72,26-72,28)
(Valid 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(72,26-72,28)
(Formatting.uInt16 @x0)
)
...
;; def=Prims.fst(680,18-680,24); use=Formatting.fst(72,26-72,28)
(>= (BoxInt_proj_0 @x0)
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
;; def=Prims.fst(451,66-451,102); use=Formatting.fst(72,0-72,98)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Tm_type)

;; def=Prims.fst(286,16-286,17); use=Formatting.fst(72,0-72,98)
(= Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a
@x0)
)
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(72,29-72,98)
(and 
;; def=dummy(0,0-0,0); use=Formatting.fst(72,29-72,98)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Formatting.uint16)

;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(72,67-72,82)
(Valid 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(72,67-72,82)
(Formatting.uInt16 @x2)
)
)
...
;; def=Prims.fst(680,18-680,24); use=Formatting.fst(72,67-72,82)
(>= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
;; def=Prims.fst(451,66-451,102); use=Formatting.fst(72,29-72,98)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_type)

;; def=Prims.fst(286,16-286,17); use=Formatting.fst(72,29-72,98)
(= Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a
@x2)
)
...
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(72,29-72,31)
(Valid 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(72,29-72,31)
(Formatting.uInt16 @x3)
)
)
...
;; def=Prims.fst(680,18-680,24); use=Formatting.fst(72,29-72,31)
(>= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(72,33-72,98)
(and 
;; def=Prims.fst(73,23-73,30); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(56,36-56,40)
(or label_5

;; def=Prims.fst(73,23-73,30); use=Formatting.fst(72,33-72,98)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(72,33-72,98)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
(implies 
;; def=Formatting.fst(72,33-72,87); use=Formatting.fst(72,33-72,87)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.uint16_to_bytes @x1)
(Formatting.uint16_to_bytes @x3)))


;; def=Prims.fst(459,77-459,89); use=Formatting.fst(72,33-72,98)
(and 
;; def=dummy(0,0-0,0); use=Formatting.fst(72,33-72,98)
(forall ((@x4 Term))
 (! (implies (HasType @x4
Formatting.uint16)
...
;; def=Formatting.fst(68,21-68,53); use=Formatting.fst(72,33-72,98)
(and (implies 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(72,46-72,82)
(Valid 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(72,46-72,82)
(Formatting.uInt16 @x4)
)
...
;; def=Prims.fst(680,18-680,24); use=Formatting.fst(72,46-72,82)
(>= (BoxInt_proj_0 @x4)
(BoxInt_proj_0 (BoxInt 0)))
)
)
(implies (and 
;; def=Formatting.fst(68,30-68,53); use=Formatting.fst(72,33-72,98)
(not 
;; def=Formatting.fst(68,30-68,53); use=Formatting.fst(72,33-72,98)
(<= (BoxInt_proj_0 (Platform.Bytes.repr_bytes @x4))
(BoxInt_proj_0 (BoxInt 2)))
)
...
;; def=Prims.fst(451,66-451,102); use=Formatting.fst(72,33-72,98)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_type)

;; def=Prims.fst(175,25-175,26); use=Formatting.fst(72,33-72,98)
(= Tm_refine_e1654124cafabcfd19c68d984b9f6837
@x4)
)
...
;; def=Prims.fst(175,35-175,36); use=Formatting.fst(72,33-72,98)
(= @x1
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.UINT16_inj, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Formatting.uInt16, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.UInt8.t
...
; encoding sigelt assume Formatting.UINT16_inj


; <Start encoding assume Formatting.UINT16_inj>




; </end encoding assume Formatting.UINT16_inj>


; encoding sigelt let string16


; <Start encoding let string16>

(declare-fun Formatting.string16 () Term)
(declare-fun Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9 () Term)

; </end encoding let string16>


; encoding sigelt val Formatting.request


; <Skipped val Formatting.request/>


; encoding sigelt val Formatting.response


; <Skipped val Formatting.response/>


; encoding sigelt let tag0


; <Start encoding let tag0>

(declare-fun Formatting.tag0 (Dummy_sort) Term)

; </end encoding let tag0>


; encoding sigelt let tag1


; <Start encoding let tag1>

(declare-fun Formatting.tag1 (Dummy_sort) Term)

; </end encoding let tag1>


; encoding sigelt let request


; <Start encoding let request>

(declare-fun Formatting.request (Term) Term)
;;;;;;;;;;;;;;;;s: Prims.string -> message
(declare-fun Tm_arrow_97f8655915b1b78f6577dd9d6914bfa7 () Term)
(declare-fun Formatting.request@tok () Term)

; </end encoding let request>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Platform.Bytes.utf8; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(190,11-190,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(190,11-190,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.string)
(HasType (Platform.Bytes.utf8 @x0)
Platform.Bytes.bytes))
 

:pattern ((Platform.Bytes.utf8 @x0))
:qid typing_Platform.Bytes.utf8))

:named typing_Platform.Bytes.utf8))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.string16; Namespace Formatting
(assert (! (HasType Formatting.string16
Tm_type)
:named typing_Formatting.string16))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Formatting.string16; Namespace Formatting
(assert (! (HasType Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9
Tm_type)
:named refinement_kinding_Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Formatting.string16; Namespace Formatting
(assert (! 
;; def=Formatting.fst(74,16-74,56); use=Formatting.fst(74,16-74,56)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9)
(and (HasTypeFuel @u0
@x1
Prims.string)

;; def=Formatting.fst(74,25-74,55); use=Formatting.fst(74,25-74,55)
(Valid 
;; def=Formatting.fst(74,25-74,55); use=Formatting.fst(74,25-74,55)
(Formatting.uInt16 (Formatting.length (Platform.Bytes.utf8 @x1)))
)
))
...
@x1
Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9))
:qid refinement_interpretation_Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9))

:named refinement_interpretation_Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9))
;;;;;;;;;;;;;;;;haseq for Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9
;;; Fact-ids: Name Formatting.string16; Namespace Formatting
(assert (! (iff (Valid (Prims.hasEq Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9))
(Valid (Prims.hasEq Prims.string)))
:named haseqTm_refine_51ee4cf0b5fc41ca89f8061de05f28f9))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Formatting.string16; Namespace Formatting
(assert (! (HasType Formatting.string16
Tm_type)
:named function_token_typing_Formatting.string16))
;;;;;;;;;;;;;;;;Equation for Formatting.string16
;;; Fact-ids: Name Formatting.string16; Namespace Formatting
(assert (! (= Formatting.string16
Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9)
:named equation_Formatting.string16))
;;;;;;;;;;;;;;;;Assumption: Formatting.UTF8_inj
;;; Fact-ids: Name Formatting.UTF8_inj; Namespace Formatting
(assert (! 
;; def=Formatting.fst(65,2-66,59); use=Formatting.fst(65,2-66,59)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.string)
(HasType @x1
...
;; def=Formatting.fst(66,4-66,48); use=Formatting.fst(66,4-66,48)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Platform.Bytes.utf8 @x0)
(Platform.Bytes.utf8 @x1)))
)

;; def=Formatting.fst(66,53-66,59); use=Formatting.fst(66,53-66,59)
(= @x0
@x1)
)
 

:pattern ((Platform.Bytes.utf8 @x0) (Platform.Bytes.utf8 @x1))
:qid assumption_Formatting.UTF8_inj))

:named assumption_Formatting.UTF8_inj))
(push) ;; push{2

; Starting query at Formatting.fst(90,2-92,53)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (s: Formatting.string16) (t: Prims.string).
;   (*  - Could not prove post-condition
; *)
;   forall (pure_result: Prims.unit).
;     (Formatting.length (Platform.Bytes.utf8 s) < 256 <==>
;       Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s)) = 1) /\
;     (Formatting.length (Platform.Bytes.utf8 s) >= 256 /\
;       Formatting.length (Platform.Bytes.utf8 s) < 65536 <==>
;       Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s)) = 2) /\
;     (Formatting.length (Platform.Bytes.utf8 s) >= 65536 /\
;       Formatting.length (Platform.Bytes.utf8 s) < 16777216 <==>
;       Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s)) = 3) /\
;     (Formatting.length (Platform.Bytes.utf8 s) >= 16777216 /\
;       Formatting.length (Platform.Bytes.utf8 s) < 4294967296 <==>
;       Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s)) = 4) /\
;     (Formatting.length (Platform.Bytes.utf8 s) >= 4294967296 /\
;       Formatting.length (Platform.Bytes.utf8 s) < 1099511627776 <==>
;       Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s)) = 5) /\
;     (Formatting.length (Platform.Bytes.utf8 s) >= 1099511627776 /\
;       Formatting.length (Platform.Bytes.utf8 s) < 281474976710656 <==>
;       Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s)) = 6) /\
;     (Formatting.length (Platform.Bytes.utf8 s) >= 281474976710656 /\
;       Formatting.length (Platform.Bytes.utf8 s) < 72057594037927936 <==>
;       Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s)) = 7) /\
;     (Formatting.length (Platform.Bytes.utf8 s) >= 72057594037927936 /\
;       Formatting.length (Platform.Bytes.utf8 s) < 18446744073709551616 <==>
;       Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s)) = 8) ==>
;     Formatting.length (Platform.Bytes.utf8 s) >= 0 ==>
;     Formatting.uInt16 (Formatting.length (Platform.Bytes.utf8 s)) /\
;     Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s)) <= 2


; Context: While encoding a query
; While typechecking the top-level declaration `let response`
...
;; def=Prims.fst(441,36-441,97); use=Formatting.fst(90,8-90,31)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.unit)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,12-45,45); use=Formatting.fst(90,8-90,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,14-45,21); use=Formatting.fst(90,8-90,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 256)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,27-45,43); use=Formatting.fst(90,8-90,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 1))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,12-46,61); use=Formatting.fst(90,8-90,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,14-46,37); use=Formatting.fst(90,8-90,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,15-46,23); use=Formatting.fst(90,8-90,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 256)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,27-46,36); use=Formatting.fst(90,8-90,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 65536)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,43-46,59); use=Formatting.fst(90,8-90,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 2))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,12-47,66); use=Formatting.fst(90,8-90,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,14-47,42); use=Formatting.fst(90,8-90,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,15-47,25); use=Formatting.fst(90,8-90,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 65536)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,29-47,41); use=Formatting.fst(90,8-90,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 16777216)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,48-47,64); use=Formatting.fst(90,8-90,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 3))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,12-48,71); use=Formatting.fst(90,8-90,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,14-48,47); use=Formatting.fst(90,8-90,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,15-48,28); use=Formatting.fst(90,8-90,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 16777216)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,32-48,46); use=Formatting.fst(90,8-90,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 4294967296)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,53-48,69); use=Formatting.fst(90,8-90,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 4))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,12-49,76); use=Formatting.fst(90,8-90,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,14-49,52); use=Formatting.fst(90,8-90,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,15-49,30); use=Formatting.fst(90,8-90,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 4294967296)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,34-49,51); use=Formatting.fst(90,8-90,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 1099511627776)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,58-49,74); use=Formatting.fst(90,8-90,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 5))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,12-50,81); use=Formatting.fst(90,8-90,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,14-50,57); use=Formatting.fst(90,8-90,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,15-50,33); use=Formatting.fst(90,8-90,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 1099511627776)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,37-50,56); use=Formatting.fst(90,8-90,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 281474976710656)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,63-50,79); use=Formatting.fst(90,8-90,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 6))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,12-51,85); use=Formatting.fst(90,8-90,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,14-51,61); use=Formatting.fst(90,8-90,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,15-51,35); use=Formatting.fst(90,8-90,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 281474976710656)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,39-51,60); use=Formatting.fst(90,8-90,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 72057594037927936)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,67-51,83); use=Formatting.fst(90,8-90,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 7))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,12-52,90); use=Formatting.fst(90,8-90,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,14-52,66); use=Formatting.fst(90,8-90,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,15-52,37); use=Formatting.fst(90,8-90,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 72057594037927936)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,41-52,65); use=Formatting.fst(90,8-90,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 18446744073709551616)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,72-52,88); use=Formatting.fst(90,8-90,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 8))
)


;; def=Prims.fst(680,18-680,24); use=Formatting.fst(91,27-91,50)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 0)))
)

;; def=Formatting.fst(54,20-68,53); use=Formatting.fst(91,27-91,50)
(and 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(91,27-91,50)
(or label_1

;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(91,27-91,50)
(Valid 
;; def=Formatting.fst(54,20-54,28); use=Formatting.fst(91,27-91,50)
(Formatting.uInt16 (Formatting.length (Platform.Bytes.utf8 @x0)))
)
)


;; def=Formatting.fst(68,30-68,53); use=Formatting.fst(91,27-91,50)
(or label_2

;; def=Formatting.fst(68,30-68,53); use=Formatting.fst(91,27-91,50)
(<= (BoxInt_proj_0 (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0))))
(BoxInt_proj_0 (BoxInt 2)))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.response, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Formatting.length, equation_Formatting.string16, equation_Formatting.uInt16, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_51ee4cf0b5fc41ca89f8061de05f28f9
...
; encoding sigelt let response


; <Start encoding let response>

(declare-fun Formatting.response (Term Term) Term)
;;;;;;;;;;;;;;;;s: string16 -> t: Prims.string -> message
(declare-fun Tm_arrow_c649e48bbbaf71b4aa30450210a84370 () Term)
(declare-fun Formatting.response@tok () Term)

; </end encoding let response>

(push) ;; push{2

; Starting query at Formatting.fst(105,0-109,53)
...
;;; Fact-ids: 
(assert (! 
;; def=Formatting.fst(107,18-107,22); use=Formatting.fst(107,2-107,7)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
; Encoding query formula : forall (s: Prims.string)
;   (s': Formatting.string16)
;   (t': Prims.string)
;   (_: Prims.squash Prims.l_True).
;   (*  - Could not prove post-condition
; *) Prims.hasEq Formatting.message


; Context: While encoding a query
; While typechecking the top-level declaration `val Formatting.req_resp_distinct`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Formatting.fst(105,0-109,53)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.string)
(HasType @x1
...
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(108,18-108,25)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.req_resp_distinct, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_Platform.Bytes.HasEq_bytes, equation_Formatting.message
...
; encoding sigelt val Formatting.req_resp_distinct


; <Skipped val Formatting.req_resp_distinct/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.tag1; Namespace Formatting
(assert (! 
;; def=Formatting.fst(85,4-85,8); use=Formatting.fst(85,4-85,8)
(forall ((@u0 Dummy_sort))
 (! (HasType (Formatting.tag1 @u0)
(Platform.Bytes.lbytes (BoxInt 1)))
 

:pattern ((Formatting.tag1 @u0))
:qid typing_Formatting.tag1))

:named typing_Formatting.tag1))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.tag0; Namespace Formatting
(assert (! 
;; def=Formatting.fst(84,4-84,8); use=Formatting.fst(84,4-84,8)
(forall ((@u0 Dummy_sort))
 (! (HasType (Formatting.tag0 @u0)
(Platform.Bytes.lbytes (BoxInt 1)))
 

:pattern ((Formatting.tag0 @u0))
:qid typing_Formatting.tag0))

:named typing_Formatting.tag0))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.response; Namespace Formatting
(assert (! 
;; def=Formatting.fst(89,4-89,12); use=Formatting.fst(89,4-89,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Formatting.string16)
(HasType @x1
Prims.string))
(HasType (Formatting.response @x0
@x1)
Formatting.message))
 

:pattern ((Formatting.response @x0
@x1))
:qid typing_Formatting.response))

:named typing_Formatting.response))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Formatting.request; Namespace Formatting
(assert (! 
;; def=Formatting.fst(87,4-87,11); use=Formatting.fst(87,4-87,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.string)
(HasType (Formatting.request @x0)
Formatting.message))
 

:pattern ((Formatting.request @x0))
:qid typing_Formatting.request))

:named typing_Formatting.request))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;Lemma: Formatting.append_inj_lemma
;;; Fact-ids: Name Formatting.append_inj_lemma; Namespace Formatting
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Formatting.message)
(HasType @x1
...
;; def=Formatting.fst(36,39-36,59); use=Formatting.fst(39,4-39,20)
(= (Formatting.length @x0)
(Formatting.length @x2))


;; def=Formatting.fst(36,63-36,97); use=Formatting.fst(39,4-39,20)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.op_At_Bar @x0
@x1)
(Formatting.op_At_Bar @x2
...
;; def=Formatting.fst(37,37-37,79); use=Formatting.fst(39,4-39,20)
(and 
;; def=Formatting.fst(37,38-37,56); use=Formatting.fst(39,4-39,20)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
@x0
@x2))


;; def=Formatting.fst(37,60-37,78); use=Formatting.fst(39,4-39,20)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
@x1
@x3))
)
...
:pattern ((Formatting.op_At_Bar @x0
@x1) (Formatting.op_At_Bar @x2
@x3))
:qid lemma_Formatting.append_inj_lemma))
:named lemma_Formatting.append_inj_lemma))
...
(Platform.Bytes.createBytes (BoxInt 1)
(FStar.UInt8.uint_to_t (BoxInt 1))))
...
:qid equation_Formatting.tag1))

:named equation_Formatting.tag1))
;;;;;;;;;;;;;;;;Equation for Formatting.tag0
;;; Fact-ids: Name Formatting.tag0; Namespace Formatting
(assert (! 
;; def=Formatting.fst(84,4-84,8); use=Formatting.fst(84,4-84,8)
(forall ((@u0 Dummy_sort))
...
(Platform.Bytes.createBytes (BoxInt 1)
(FStar.UInt8.uint_to_t (BoxInt 0))))
...
:qid equation_Formatting.tag0))

:named equation_Formatting.tag0))
;;;;;;;;;;;;;;;;Equation for Formatting.response
;;; Fact-ids: Name Formatting.response; Namespace Formatting
(assert (! 
;; def=Formatting.fst(89,4-89,12); use=Formatting.fst(89,4-89,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Formatting.response @x0
@x1)
(Formatting.op_At_Bar (Formatting.tag1 Dummy_value)
(Formatting.op_At_Bar (Formatting.uint16_to_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(Formatting.op_At_Bar (Platform.Bytes.utf8 @x0)
(Platform.Bytes.utf8 @x1)))))
 

:pattern ((Formatting.response @x0
@x1))
:qid equation_Formatting.response))

:named equation_Formatting.response))
;;;;;;;;;;;;;;;;Equation for Formatting.request
;;; Fact-ids: Name Formatting.request; Namespace Formatting
(assert (! 
;; def=Formatting.fst(87,4-87,11); use=Formatting.fst(87,4-87,11)
(forall ((@x0 Term))
 (! (= (Formatting.request @x0)
(Formatting.op_At_Bar (Formatting.tag0 Dummy_value)
(Platform.Bytes.utf8 @x0)))
 

:pattern ((Formatting.request @x0))
:qid equation_Formatting.request))

:named equation_Formatting.request))
;;;;;;;;;;;;;;;;Assumption: Formatting.UINT16_inj
;;; Fact-ids: Name Formatting.UINT16_inj; Namespace Formatting
(assert (! 
;; def=Formatting.fst(72,19-72,98); use=Formatting.fst(72,19-72,98)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Tm_refine_49d0e5ffb1f2f8200b16f11f2ab50b9a)
(HasType @x1
...
;; def=Formatting.fst(72,92-72,98); use=Formatting.fst(72,92-72,98)
(= @x0
@x1)
)
 
;;no pats
:qid assumption_Formatting.UINT16_inj))

:named assumption_Formatting.UINT16_inj))
(push) ;; push{2

; Starting query at Formatting.fst(111,2-114,46)
...
; Encoding query formula : forall (s: Prims.string) (s': Formatting.string16) (t': Prims.string).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         Formatting.request s <> Formatting.response s' t' ==> p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         (Formatting.length (Platform.Bytes.utf8 s) < 256 <==>
;           Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s)) = 1) /\
;         (Formatting.length (Platform.Bytes.utf8 s) >= 256 /\
...
;               Formatting.length (Platform.Bytes.utf8 s') < 18446744073709551616 <==>
;               Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s')) = 8) ==>
;             0 < FStar.Seq.Base.length (Formatting.request s) /\
;             (forall (any_result: Prims.int).
;                 0 == any_result ==>
;                 (forall (any_result: FStar.UInt8.t).
;                     FStar.Seq.Base.index (Formatting.request s) 0 == any_result ==>
;                     (forall (any_result: Prims.logical).
;                         FStar.Seq.Base.index (Formatting.request s) 0 == (0uy <: FStar.UInt8.t) ==
;                         any_result ==>
;                         FStar.Seq.Base.index (Formatting.request s) 0 == (0uy <: FStar.UInt8.t) /\
;                         (forall (pure_result: Prims.unit).
;                             FStar.Seq.Base.index (Formatting.request s) 0 == (0uy <: FStar.UInt8.t) ==>
;                             0 < FStar.Seq.Base.length (Formatting.response s' t') /\
;                             (forall (any_result: Prims.int).
;                                 0 == any_result ==>
;                                 (forall (any_result: FStar.UInt8.t).
;                                     FStar.Seq.Base.index (Formatting.response s' t') 0 == any_result ==>
;                                     (forall (any_result: Prims.logical).
;                                         FStar.Seq.Base.index (Formatting.response s' t') 0 ==
;                                         (1uy <: FStar.UInt8.t) ==
;                                         any_result ==>
;                                         FStar.Seq.Base.index (Formatting.response s' t') 0 ==
;                                         (1uy <: FStar.UInt8.t) /\
...
; Context: While encoding a query
; While typechecking the top-level declaration `let req_resp_distinct`
...
;; def=Prims.fst(441,36-441,97); use=Formatting.fst(111,2-114,46)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=Formatting.fst(108,17-108,46); use=Formatting.fst(111,2-114,46)
(or label_2

;; def=Formatting.fst(108,17-108,46); use=Formatting.fst(111,2-114,46)
(not (= (Formatting.request @x0)
(Formatting.response @x1
@x2)))
)
)

;; def=Prims.fst(441,83-441,96); use=Formatting.fst(111,2-114,46)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(111,2-114,46)
(ApplyTT @x3
@x4)
...
;; def=Prims.fst(441,36-441,97); use=Formatting.fst(111,8-111,31)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.unit)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,12-45,45); use=Formatting.fst(111,8-111,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,14-45,21); use=Formatting.fst(111,8-111,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 256)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,27-45,43); use=Formatting.fst(111,8-111,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 1))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,12-46,61); use=Formatting.fst(111,8-111,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,14-46,37); use=Formatting.fst(111,8-111,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,15-46,23); use=Formatting.fst(111,8-111,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 256)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,27-46,36); use=Formatting.fst(111,8-111,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 65536)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,43-46,59); use=Formatting.fst(111,8-111,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 2))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,12-47,66); use=Formatting.fst(111,8-111,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,14-47,42); use=Formatting.fst(111,8-111,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,15-47,25); use=Formatting.fst(111,8-111,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 65536)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,29-47,41); use=Formatting.fst(111,8-111,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 16777216)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,48-47,64); use=Formatting.fst(111,8-111,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 3))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,12-48,71); use=Formatting.fst(111,8-111,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,14-48,47); use=Formatting.fst(111,8-111,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,15-48,28); use=Formatting.fst(111,8-111,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 16777216)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,32-48,46); use=Formatting.fst(111,8-111,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 4294967296)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,53-48,69); use=Formatting.fst(111,8-111,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 4))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,12-49,76); use=Formatting.fst(111,8-111,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,14-49,52); use=Formatting.fst(111,8-111,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,15-49,30); use=Formatting.fst(111,8-111,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 4294967296)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,34-49,51); use=Formatting.fst(111,8-111,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 1099511627776)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,58-49,74); use=Formatting.fst(111,8-111,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 5))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,12-50,81); use=Formatting.fst(111,8-111,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,14-50,57); use=Formatting.fst(111,8-111,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,15-50,33); use=Formatting.fst(111,8-111,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 1099511627776)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,37-50,56); use=Formatting.fst(111,8-111,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 281474976710656)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,63-50,79); use=Formatting.fst(111,8-111,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 6))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,12-51,85); use=Formatting.fst(111,8-111,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,14-51,61); use=Formatting.fst(111,8-111,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,15-51,35); use=Formatting.fst(111,8-111,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 281474976710656)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,39-51,60); use=Formatting.fst(111,8-111,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 72057594037927936)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,67-51,83); use=Formatting.fst(111,8-111,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 7))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,12-52,90); use=Formatting.fst(111,8-111,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,14-52,66); use=Formatting.fst(111,8-111,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,15-52,37); use=Formatting.fst(111,8-111,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 72057594037927936)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,41-52,65); use=Formatting.fst(111,8-111,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 18446744073709551616)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,72-52,88); use=Formatting.fst(111,8-111,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 8))
)
)

;; def=Prims.fst(441,36-441,97); use=Formatting.fst(112,8-112,31)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,12-45,45); use=Formatting.fst(112,8-112,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,14-45,21); use=Formatting.fst(112,8-112,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 256)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,27-45,43); use=Formatting.fst(112,8-112,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt 1))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,12-46,61); use=Formatting.fst(112,8-112,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,14-46,37); use=Formatting.fst(112,8-112,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,15-46,23); use=Formatting.fst(112,8-112,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 256)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,27-46,36); use=Formatting.fst(112,8-112,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 65536)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,43-46,59); use=Formatting.fst(112,8-112,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt 2))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,12-47,66); use=Formatting.fst(112,8-112,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,14-47,42); use=Formatting.fst(112,8-112,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,15-47,25); use=Formatting.fst(112,8-112,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 65536)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,29-47,41); use=Formatting.fst(112,8-112,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 16777216)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,48-47,64); use=Formatting.fst(112,8-112,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt 3))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,12-48,71); use=Formatting.fst(112,8-112,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,14-48,47); use=Formatting.fst(112,8-112,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,15-48,28); use=Formatting.fst(112,8-112,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 16777216)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,32-48,46); use=Formatting.fst(112,8-112,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 4294967296)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,53-48,69); use=Formatting.fst(112,8-112,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt 4))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,12-49,76); use=Formatting.fst(112,8-112,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,14-49,52); use=Formatting.fst(112,8-112,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,15-49,30); use=Formatting.fst(112,8-112,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 4294967296)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,34-49,51); use=Formatting.fst(112,8-112,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 1099511627776)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,58-49,74); use=Formatting.fst(112,8-112,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt 5))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,12-50,81); use=Formatting.fst(112,8-112,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,14-50,57); use=Formatting.fst(112,8-112,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,15-50,33); use=Formatting.fst(112,8-112,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 1099511627776)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,37-50,56); use=Formatting.fst(112,8-112,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 281474976710656)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,63-50,79); use=Formatting.fst(112,8-112,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt 6))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,12-51,85); use=Formatting.fst(112,8-112,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,14-51,61); use=Formatting.fst(112,8-112,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,15-51,35); use=Formatting.fst(112,8-112,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 281474976710656)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,39-51,60); use=Formatting.fst(112,8-112,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 72057594037927936)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,67-51,83); use=Formatting.fst(112,8-112,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt 7))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,12-52,90); use=Formatting.fst(112,8-112,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,14-52,66); use=Formatting.fst(112,8-112,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,15-52,37); use=Formatting.fst(112,8-112,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 72057594037927936)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,41-52,65); use=Formatting.fst(112,8-112,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt_proj_0 (BoxInt 18446744073709551616)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,72-52,88); use=Formatting.fst(112,8-112,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x1)))
(BoxInt 8))
)
)

;; def=Prims.fst(459,77-459,89); use=Formatting.fst(111,2-114,46)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Formatting.fst(113,32-113,33)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=Formatting.fst(111,2-114,46)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.int)

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=Formatting.fst(111,2-114,46)
(= (BoxInt 0)
@x6)
)
...
;; def=Prims.fst(175,35-175,36); use=Formatting.fst(111,2-114,46)
(= (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
(Formatting.request @x0)
(BoxInt 0))
@x7)
...
;; def=Prims.fst(672,13-672,14); use=Formatting.fst(111,2-114,46)
(= (Prims.eq2 (FStar.UInt8.t Dummy_value)
(FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
(Formatting.request @x0)
(BoxInt 0))
...
;; def=Prims.fst(441,29-441,97); use=Formatting.fst(113,2-113,8)
(and 
;; def=Formatting.fst(113,9-113,41); use=Formatting.fst(113,2-113,8)
(or label_4
...
;; def=Prims.fst(441,36-441,97); use=Formatting.fst(113,2-113,8)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.unit)
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(111,2-114,46)
(and 
;; def=FStar.Seq.Base.fsti(32,40-32,52); use=Formatting.fst(114,37-114,38)
(or label_5
...
;; def=Prims.fst(441,29-441,97); use=Formatting.fst(114,2-114,8)
(and 
;; def=Formatting.fst(114,9-114,46); use=Formatting.fst(114,2-114,8)
(or label_6
...
;; def=Prims.fst(441,36-441,97); use=Formatting.fst(114,2-114,8)
(forall ((@x13 Term))
 (! (implies (and (HasType @x13
Prims.unit)
...
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(114,2-114,8)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(114,2-114,8)
(ApplyTT @x3
@x13)
...
; encoding sigelt let req_resp_distinct


; <Start encoding let req_resp_distinct>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Formatting.req_resp_distinct (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Formatting.req_resp_distinct@tok () Term)

; </end encoding let req_resp_distinct>

(push) ;; push{2

; Starting query at Formatting.fst(116,0-119,27)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_ab9376e34b625440c20f26afd6ba2f63 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=Formatting.fst(117,5-119,27)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_ab9376e34b625440c20f26afd6ba2f63 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_ab9376e34b625440c20f26afd6ba2f63 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_ab9376e34b625440c20f26afd6ba2f63))

:named refinement_kinding_Tm_refine_ab9376e34b625440c20f26afd6ba2f63))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=Formatting.fst(117,5-119,27)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ab9376e34b625440c20f26afd6ba2f63 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.bool)

;; def=FStar.Seq.Base.fsti(174,57-174,75); use=Formatting.fst(117,5-119,27)
(iff 
;; def=FStar.Seq.Base.fsti(174,50-174,51); use=Formatting.fst(117,5-119,27)
(BoxBool_proj_0 @x1)


;; def=FStar.Seq.Base.fsti(174,64-174,75); use=Formatting.fst(117,5-119,27)
(Valid 
;; def=FStar.Seq.Base.fsti(174,64-174,75); use=Formatting.fst(117,5-119,27)
(FStar.Seq.Base.equal (FStar.UInt8.t Dummy_value)
(Formatting.request @x2)
(Formatting.request @x3))
)
)
))
...
(Tm_refine_ab9376e34b625440c20f26afd6ba2f63 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_ab9376e34b625440c20f26afd6ba2f63))

:named refinement_interpretation_Tm_refine_ab9376e34b625440c20f26afd6ba2f63))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ab9376e34b625440c20f26afd6ba2f63
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=Formatting.fst(117,5-119,27)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ab9376e34b625440c20f26afd6ba2f63 @x0
@x1)))
(Valid (Prims.hasEq Prims.bool)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ab9376e34b625440c20f26afd6ba2f63 @x0
@x1))))
:qid haseqTm_refine_ab9376e34b625440c20f26afd6ba2f63))

:named haseqTm_refine_ab9376e34b625440c20f26afd6ba2f63))


; Encoding query formula : forall (s0: Prims.string) (s1: Prims.string).
;   Prims.hasEq FStar.UInt8.t /\
;   (forall (any_result: Type0).
;       FStar.UInt8.t == any_result ==>
;       (forall (any_result:
;           r: Prims.bool{r <==> FStar.Seq.Base.equal (Formatting.request s0) (Formatting.request s1)})
;         .
;           FStar.Seq.Base.eq (Formatting.request s0) (Formatting.request s1) == any_result ==>
;           (forall (return_val:
;               r:
;               Prims.bool
;                 {r <==> FStar.Seq.Base.equal (Formatting.request s0) (Formatting.request s1)}).
;               return_val == FStar.Seq.Base.eq (Formatting.request s0) (Formatting.request s1) ==>
;               FStar.Seq.Base.eq (Formatting.request s0) (Formatting.request s1) == return_val ==>
;               (forall (any_result: Prims.logical).
;                   FStar.Seq.Base.eq (Formatting.request s0) (Formatting.request s1) == any_result ==>
;                   Prims.hasEq FStar.UInt8.t))))
...
; Context: While encoding a query
; While typechecking the top-level declaration `val Formatting.req_components_corr`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Formatting.fst(116,0-119,27)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.string)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(117,5-119,27)
(and 
;; def=Prims.fst(73,23-73,30); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(56,36-56,40)
(or label_1

;; def=Prims.fst(73,23-73,30); use=Formatting.fst(117,5-119,27)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(117,5-119,27)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
;; def=Prims.fst(451,66-451,102); use=Formatting.fst(117,5-119,27)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_type)

;; def=FStar.Seq.Base.fsti(174,9-174,10); use=Formatting.fst(117,5-119,27)
(= (FStar.UInt8.t Dummy_value)
@x2)
)
...
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Tm_refine_ab9376e34b625440c20f26afd6ba2f63 @x0
@x1))

;; def=FStar.Seq.Base.fsti(174,49-174,77); use=Formatting.fst(118,23-118,57)
(= (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.request @x0)
(Formatting.request @x1))
@x3)
)

;; def=Prims.fst(356,2-356,58); use=Formatting.fst(117,5-119,27)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Tm_refine_ab9376e34b625440c20f26afd6ba2f63 @x0
@x1))

;; def=Prims.fst(356,26-356,41); use=Formatting.fst(117,5-119,27)
(= @x4
(FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.request @x0)
(Formatting.request @x1)))
...
;; def=Prims.fst(180,10-180,11); use=Formatting.fst(117,5-119,27)
(= (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.request @x0)
(Formatting.request @x1))
@x4)
...
;; def=FStar.Pervasives.fsti(112,28-112,31); use=Formatting.fst(117,5-119,27)
(= (Prims.b2t (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.request @x0)
(Formatting.request @x1)))
@x5)
...
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(118,2-118,7)
(or label_2

;; def=Prims.fst(73,23-73,30); use=Formatting.fst(119,18-119,26)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(119,18-119,26)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.req_components_corr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.UInt8.t
...
; encoding sigelt val Formatting.req_components_corr


; <Skipped val Formatting.req_components_corr/>

(push) ;; push{2

; Starting query at Formatting.fst(121,32-121,34)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     FStar.Seq.Base.eq (Formatting.request s0) (Formatting.request s1) /\
;     (forall (pure_result: Prims.unit). s0 == s1 ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let req_components_corr`
...
;; def=Formatting.fst(118,18-118,58); use=Formatting.fst(121,32-121,34)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.request @x0)
(Formatting.request @x1)))


;; def=Prims.fst(441,36-441,97); use=Formatting.fst(121,32-121,34)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=Formatting.fst(119,18-119,26); use=Formatting.fst(121,32-121,34)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(121,32-121,34)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(121,32-121,34)
(ApplyTT @x2
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.req_components_corr, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Formatting.UTF8_inj, equation_Formatting.message, equation_Formatting.request, equation_Formatting.tag0, equation_Platform.Bytes.lbytes, lemma_Formatting.append_inj_lemma, refinement_interpretation_Tm_refine_b3982a6d174e1d047431ae85c35dc7d8, typing_Formatting.tag0, typing_Platform.Bytes.utf8
...
; encoding sigelt let req_components_corr


; <Start encoding let req_components_corr>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Formatting.req_components_corr (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Formatting.req_components_corr@tok () Term)

; </end encoding let req_components_corr>

(push) ;; push{2

; Starting query at Formatting.fst(123,0-127,58)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_e01d5a605042f4591840d01e5a4aba28 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=Formatting.fst(124,5-127,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_e01d5a605042f4591840d01e5a4aba28 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_e01d5a605042f4591840d01e5a4aba28 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_e01d5a605042f4591840d01e5a4aba28))

:named refinement_kinding_Tm_refine_e01d5a605042f4591840d01e5a4aba28))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=Formatting.fst(124,5-127,58)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e01d5a605042f4591840d01e5a4aba28 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=FStar.Seq.Base.fsti(174,57-174,75); use=Formatting.fst(124,5-127,58)
(iff 
;; def=FStar.Seq.Base.fsti(174,50-174,51); use=Formatting.fst(124,5-127,58)
(BoxBool_proj_0 @x1)


;; def=FStar.Seq.Base.fsti(174,64-174,75); use=Formatting.fst(124,5-127,58)
(Valid 
;; def=FStar.Seq.Base.fsti(174,64-174,75); use=Formatting.fst(124,5-127,58)
(FStar.Seq.Base.equal (FStar.UInt8.t Dummy_value)
(Formatting.response @x2
@x3)
(Formatting.response @x4
@x5))
)
)
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_e01d5a605042f4591840d01e5a4aba28))

:named refinement_interpretation_Tm_refine_e01d5a605042f4591840d01e5a4aba28))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e01d5a605042f4591840d01e5a4aba28
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=Formatting.fst(124,5-127,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e01d5a605042f4591840d01e5a4aba28 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.bool)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_e01d5a605042f4591840d01e5a4aba28 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_e01d5a605042f4591840d01e5a4aba28))

:named haseqTm_refine_e01d5a605042f4591840d01e5a4aba28))


; Encoding query formula : forall (s0: Formatting.string16) (t0: Prims.string) (s1: Formatting.string16) (t1: Prims.string).
;   Prims.hasEq FStar.UInt8.t /\
;   (forall (any_result: Type0).
;       FStar.UInt8.t == any_result ==>
;       (forall (any_result:
;           r:
;           Prims.bool
;             {r <==> FStar.Seq.Base.equal (Formatting.response s0 t0) (Formatting.response s1 t1)}).
;           FStar.Seq.Base.eq (Formatting.response s0 t0) (Formatting.response s1 t1) == any_result ==>
;           (forall (return_val:
;               r:
;               Prims.bool
;                 { r <==>
;                   FStar.Seq.Base.equal (Formatting.response s0 t0) (Formatting.response s1 t1) }).
;               return_val ==
;               FStar.Seq.Base.eq (Formatting.response s0 t0) (Formatting.response s1 t1) ==>
;               FStar.Seq.Base.eq (Formatting.response s0 t0) (Formatting.response s1 t1) ==
;               return_val ==>
;               (forall (any_result: Prims.logical).
;                   FStar.Seq.Base.eq (Formatting.response s0 t0) (Formatting.response s1 t1) ==
...
; Context: While encoding a query
; While typechecking the top-level declaration `val Formatting.resp_components_corr`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Formatting.fst(123,0-127,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Formatting.string16)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=Formatting.fst(124,5-127,58)
(and 
;; def=Prims.fst(73,23-73,30); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(56,36-56,40)
(or label_1

;; def=Prims.fst(73,23-73,30); use=Formatting.fst(124,5-127,58)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(124,5-127,58)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
;; def=Prims.fst(451,66-451,102); use=Formatting.fst(124,5-127,58)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_type)

;; def=FStar.Seq.Base.fsti(174,9-174,10); use=Formatting.fst(124,5-127,58)
(= (FStar.UInt8.t Dummy_value)
@x4)
)
...
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Tm_refine_e01d5a605042f4591840d01e5a4aba28 @x0
@x1
@x2
@x3))

;; def=FStar.Seq.Base.fsti(174,49-174,77); use=Formatting.fst(125,23-125,65)
(= (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.response @x0
@x1)
(Formatting.response @x2
...
;; def=Prims.fst(356,2-356,58); use=Formatting.fst(124,5-127,58)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_e01d5a605042f4591840d01e5a4aba28 @x0
@x1
...
;; def=Prims.fst(356,26-356,41); use=Formatting.fst(124,5-127,58)
(= @x6
(FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.response @x0
@x1)
...
;; def=Prims.fst(180,10-180,11); use=Formatting.fst(124,5-127,58)
(= (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.response @x0
@x1)
(Formatting.response @x2
...
;; def=FStar.Pervasives.fsti(112,28-112,31); use=Formatting.fst(124,5-127,58)
(= (Prims.b2t (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.response @x0
@x1)
(Formatting.response @x2
...
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(125,2-125,7)
(or label_2

;; def=Prims.fst(73,23-73,30); use=Formatting.fst(126,18-126,36)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Formatting.fst(126,18-126,36)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Formatting.resp_components_corr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.eqtype, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.UInt8.t
...
; encoding sigelt val Formatting.resp_components_corr


; <Skipped val Formatting.resp_components_corr/>

(push) ;; push{2

; Starting query at Formatting.fst(129,2-130,56)
...
;   forall (p: Prims.pure_post Prims.unit).
;     FStar.Seq.Base.eq (Formatting.response s0 t0) (Formatting.response s1 t1) /\
;     (forall (pure_result: Prims.unit). s0 == s1 /\ t0 == t1 ==> p pure_result) ==>
;     (forall (pure_result: Prims.unit).
;         (Formatting.length (Platform.Bytes.utf8 s0) < 256 <==>
;           Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s0)) = 1) /\
;         (Formatting.length (Platform.Bytes.utf8 s0) >= 256 /\
;           Formatting.length (Platform.Bytes.utf8 s0) < 65536 <==>
;           Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s0)) = 2) /\
;         (Formatting.length (Platform.Bytes.utf8 s0) >= 65536 /\
;           Formatting.length (Platform.Bytes.utf8 s0) < 16777216 <==>
;           Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s0)) = 3) /\
;         (Formatting.length (Platform.Bytes.utf8 s0) >= 16777216 /\
;           Formatting.length (Platform.Bytes.utf8 s0) < 4294967296 <==>
;           Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s0)) = 4) /\
;         (Formatting.length (Platform.Bytes.utf8 s0) >= 4294967296 /\
;           Formatting.length (Platform.Bytes.utf8 s0) < 1099511627776 <==>
;           Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s0)) = 5) /\
;         (Formatting.length (Platform.Bytes.utf8 s0) >= 1099511627776 /\
;           Formatting.length (Platform.Bytes.utf8 s0) < 281474976710656 <==>
;           Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s0)) = 6) /\
;         (Formatting.length (Platform.Bytes.utf8 s0) >= 281474976710656 /\
;           Formatting.length (Platform.Bytes.utf8 s0) < 72057594037927936 <==>
;           Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s0)) = 7) /\
;         (Formatting.length (Platform.Bytes.utf8 s0) >= 72057594037927936 /\
;           Formatting.length (Platform.Bytes.utf8 s0) < 18446744073709551616 <==>
;           Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s0)) = 8) ==>
;         (forall (pure_result: Prims.unit).
;             (Formatting.length (Platform.Bytes.utf8 s1) < 256 <==>
;               Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s1)) = 1) /\
;             (Formatting.length (Platform.Bytes.utf8 s1) >= 256 /\
;               Formatting.length (Platform.Bytes.utf8 s1) < 65536 <==>
;               Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s1)) = 2) /\
;             (Formatting.length (Platform.Bytes.utf8 s1) >= 65536 /\
;               Formatting.length (Platform.Bytes.utf8 s1) < 16777216 <==>
;               Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s1)) = 3) /\
;             (Formatting.length (Platform.Bytes.utf8 s1) >= 16777216 /\
;               Formatting.length (Platform.Bytes.utf8 s1) < 4294967296 <==>
;               Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s1)) = 4) /\
;             (Formatting.length (Platform.Bytes.utf8 s1) >= 4294967296 /\
;               Formatting.length (Platform.Bytes.utf8 s1) < 1099511627776 <==>
;               Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s1)) = 5) /\
;             (Formatting.length (Platform.Bytes.utf8 s1) >= 1099511627776 /\
;               Formatting.length (Platform.Bytes.utf8 s1) < 281474976710656 <==>
;               Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s1)) = 6) /\
;             (Formatting.length (Platform.Bytes.utf8 s1) >= 281474976710656 /\
;               Formatting.length (Platform.Bytes.utf8 s1) < 72057594037927936 <==>
;               Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s1)) = 7) /\
;             (Formatting.length (Platform.Bytes.utf8 s1) >= 72057594037927936 /\
;               Formatting.length (Platform.Bytes.utf8 s1) < 18446744073709551616 <==>
;               Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 s1)) = 8) ==>
;             p pure_result))


; Context: While encoding a query
; While typechecking the top-level declaration `let resp_components_corr`
...
;; def=Formatting.fst(125,18-125,66); use=Formatting.fst(129,2-130,56)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Formatting.response @x0
@x1)
(Formatting.response @x2
...
;; def=Prims.fst(441,36-441,97); use=Formatting.fst(129,2-130,56)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=Formatting.fst(126,19-126,25); use=Formatting.fst(129,2-130,56)
(or label_2
...
;; def=Formatting.fst(126,29-126,35); use=Formatting.fst(129,2-130,56)
(or label_3
...
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(129,2-130,56)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(129,2-130,56)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(441,36-441,97); use=Formatting.fst(129,8-129,31)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,12-45,45); use=Formatting.fst(129,8-129,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,14-45,21); use=Formatting.fst(129,8-129,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 256)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,27-45,43); use=Formatting.fst(129,8-129,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 1))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,12-46,61); use=Formatting.fst(129,8-129,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,14-46,37); use=Formatting.fst(129,8-129,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,15-46,23); use=Formatting.fst(129,8-129,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 256)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,27-46,36); use=Formatting.fst(129,8-129,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 65536)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,43-46,59); use=Formatting.fst(129,8-129,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 2))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,12-47,66); use=Formatting.fst(129,8-129,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,14-47,42); use=Formatting.fst(129,8-129,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,15-47,25); use=Formatting.fst(129,8-129,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 65536)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,29-47,41); use=Formatting.fst(129,8-129,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 16777216)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,48-47,64); use=Formatting.fst(129,8-129,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 3))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,12-48,71); use=Formatting.fst(129,8-129,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,14-48,47); use=Formatting.fst(129,8-129,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,15-48,28); use=Formatting.fst(129,8-129,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 16777216)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,32-48,46); use=Formatting.fst(129,8-129,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 4294967296)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,53-48,69); use=Formatting.fst(129,8-129,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 4))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,12-49,76); use=Formatting.fst(129,8-129,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,14-49,52); use=Formatting.fst(129,8-129,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,15-49,30); use=Formatting.fst(129,8-129,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 4294967296)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,34-49,51); use=Formatting.fst(129,8-129,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 1099511627776)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,58-49,74); use=Formatting.fst(129,8-129,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 5))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,12-50,81); use=Formatting.fst(129,8-129,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,14-50,57); use=Formatting.fst(129,8-129,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,15-50,33); use=Formatting.fst(129,8-129,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 1099511627776)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,37-50,56); use=Formatting.fst(129,8-129,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 281474976710656)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,63-50,79); use=Formatting.fst(129,8-129,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 6))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,12-51,85); use=Formatting.fst(129,8-129,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,14-51,61); use=Formatting.fst(129,8-129,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,15-51,35); use=Formatting.fst(129,8-129,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 281474976710656)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,39-51,60); use=Formatting.fst(129,8-129,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 72057594037927936)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,67-51,83); use=Formatting.fst(129,8-129,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 7))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,12-52,90); use=Formatting.fst(129,8-129,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,14-52,66); use=Formatting.fst(129,8-129,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,15-52,37); use=Formatting.fst(129,8-129,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 72057594037927936)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,41-52,65); use=Formatting.fst(129,8-129,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt_proj_0 (BoxInt 18446744073709551616)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,72-52,88); use=Formatting.fst(129,8-129,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x0)))
(BoxInt 8))
)
)

;; def=Prims.fst(441,36-441,97); use=Formatting.fst(130,8-130,31)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,12-45,45); use=Formatting.fst(130,8-130,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,14-45,21); use=Formatting.fst(130,8-130,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 256)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(45,27-45,43); use=Formatting.fst(130,8-130,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt 1))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,12-46,61); use=Formatting.fst(130,8-130,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,14-46,37); use=Formatting.fst(130,8-130,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,15-46,23); use=Formatting.fst(130,8-130,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 256)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,27-46,36); use=Formatting.fst(130,8-130,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 65536)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(46,43-46,59); use=Formatting.fst(130,8-130,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt 2))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,12-47,66); use=Formatting.fst(130,8-130,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,14-47,42); use=Formatting.fst(130,8-130,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,15-47,25); use=Formatting.fst(130,8-130,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 65536)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,29-47,41); use=Formatting.fst(130,8-130,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 16777216)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(47,48-47,64); use=Formatting.fst(130,8-130,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt 3))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,12-48,71); use=Formatting.fst(130,8-130,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,14-48,47); use=Formatting.fst(130,8-130,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,15-48,28); use=Formatting.fst(130,8-130,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 16777216)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,32-48,46); use=Formatting.fst(130,8-130,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 4294967296)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(48,53-48,69); use=Formatting.fst(130,8-130,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt 4))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,12-49,76); use=Formatting.fst(130,8-130,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,14-49,52); use=Formatting.fst(130,8-130,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,15-49,30); use=Formatting.fst(130,8-130,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 4294967296)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,34-49,51); use=Formatting.fst(130,8-130,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 1099511627776)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(49,58-49,74); use=Formatting.fst(130,8-130,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt 5))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,12-50,81); use=Formatting.fst(130,8-130,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,14-50,57); use=Formatting.fst(130,8-130,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,15-50,33); use=Formatting.fst(130,8-130,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 1099511627776)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,37-50,56); use=Formatting.fst(130,8-130,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 281474976710656)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(50,63-50,79); use=Formatting.fst(130,8-130,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt 6))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,12-51,85); use=Formatting.fst(130,8-130,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,14-51,61); use=Formatting.fst(130,8-130,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,15-51,35); use=Formatting.fst(130,8-130,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 281474976710656)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,39-51,60); use=Formatting.fst(130,8-130,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 72057594037927936)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(51,67-51,83); use=Formatting.fst(130,8-130,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt 7))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,12-52,90); use=Formatting.fst(130,8-130,31)
(iff 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,14-52,66); use=Formatting.fst(130,8-130,31)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,15-52,37); use=Formatting.fst(130,8-130,31)
(>= (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 72057594037927936)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,41-52,65); use=Formatting.fst(130,8-130,31)
(< (BoxInt_proj_0 (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt_proj_0 (BoxInt 18446744073709551616)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(52,72-52,88); use=Formatting.fst(130,8-130,31)
(= (Platform.Bytes.repr_bytes (Formatting.length (Platform.Bytes.utf8 @x2)))
(BoxInt 8))
)
)

;; def=Prims.fst(441,83-441,96); use=Formatting.fst(130,8-130,31)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Formatting.fst(130,8-130,31)
(ApplyTT @x4
@x6)
