...
; Internals for Cert.ACLs


; encoding sigelt let file


; <Start encoding let file>

(declare-fun Cert.ACLs.file (Dummy_sort) Term)

; </end encoding let file>
...
(declare-fun Cert.ACLs.canWrite (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.string -> Prims.bool
(declare-fun Tm_arrow_7e92cc1c04700553193b6f7c7895fa62 () Term)
(declare-fun Cert.ACLs.canWrite@tok () Term)

; </end encoding let canWrite>


; encoding sigelt let publicFile


; <Start encoding let publicFile>

(declare-fun Cert.ACLs.publicFile (Term) Term)

(declare-fun Cert.ACLs.publicFile@tok () Term)

; </end encoding let publicFile>
...
(declare-fun Cert.ACLs.canRead (Term) Term)
;;;;;;;;;;;;;;;;f: file -> Prims.bool
(declare-fun Tm_arrow_dbe525a34706fc93e56bebada2e12c88 () Term)
(declare-fun Cert.ACLs.canRead@tok () Term)

; </end encoding let canRead>


; encoding sigelt val Cert.ACLs.read


; <Start encoding val Cert.ACLs.read>

(declare-fun Tm_refine_6969c262cf44150b15fd248146cc9da2 () Term)
(declare-fun Cert.ACLs.read (Term) Term)

;;;;;;;;;;;;;;;;file: Prims.string{canRead file} -> Prims.string
(declare-fun Tm_arrow_d5f8f340d1878404da211448156fe4e9 () Term)
(declare-fun Cert.ACLs.read@tok () Term)

; </end encoding val Cert.ACLs.read>


; encoding sigelt val Cert.ACLs.delete


; <Start encoding val Cert.ACLs.delete>

(declare-fun Tm_refine_81469cf5caba5948479dcf0757c19149 () Term)
(declare-fun Cert.ACLs.delete (Term) Term)

;;;;;;;;;;;;;;;;file: Prims.string{canWrite file} -> Prims.unit
(declare-fun Tm_arrow_b49350e6221ae76015332ececf1f2622 () Term)
(declare-fun Cert.ACLs.delete@tok () Term)

; </end encoding val Cert.ACLs.delete>


; encoding sigelt let pwd


; <Start encoding let pwd>

(declare-fun Cert.ACLs.pwd (Dummy_sort) Term)

; </end encoding let pwd>
...
(declare-fun Cert.ACLs.readme (Dummy_sort) Term)
...
(declare-fun Cert.ACLs.tmp (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Cert.ACLs.tmp; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(43,4-43,7); use=Cert.ACLs.fst(43,4-43,7)
(forall ((@u0 Dummy_sort))
 (! (HasType (Cert.ACLs.tmp @u0)
Prims.string)
 

:pattern ((Cert.ACLs.tmp @u0))
:qid typing_Cert.ACLs.tmp))

:named typing_Cert.ACLs.tmp))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Cert.ACLs.readme; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(42,4-42,10); use=Cert.ACLs.fst(42,4-42,10)
(forall ((@u0 Dummy_sort))
 (! (HasType (Cert.ACLs.readme @u0)
Prims.string)
 

:pattern ((Cert.ACLs.readme @u0))
:qid typing_Cert.ACLs.readme))

:named typing_Cert.ACLs.readme))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Cert.ACLs.read; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(37,11-37,15); use=Cert.ACLs.fst(37,11-37,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_6969c262cf44150b15fd248146cc9da2)
(HasType (Cert.ACLs.read @x0)
Prims.string))
 

:pattern ((Cert.ACLs.read @x0))
:qid typing_Cert.ACLs.read))

:named typing_Cert.ACLs.read))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Cert.ACLs.publicFile; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(27,4-27,14); use=Cert.ACLs.fst(27,4-27,14)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.string)
(HasType (Cert.ACLs.publicFile @x0)
Prims.bool))
 

:pattern ((Cert.ACLs.publicFile @x0))
:qid typing_Cert.ACLs.publicFile))

:named typing_Cert.ACLs.publicFile))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Cert.ACLs.file; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(21,5-21,9); use=Cert.ACLs.fst(21,5-21,9)
(forall ((@u0 Dummy_sort))
 (! (HasType (Cert.ACLs.file @u0)
Prims.eqtype)
 

:pattern ((Cert.ACLs.file @u0))
:qid typing_Cert.ACLs.file))

:named typing_Cert.ACLs.file))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Cert.ACLs.canWrite; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(23,4-23,12); use=Cert.ACLs.fst(23,4-23,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.string)
(HasType (Cert.ACLs.canWrite @x0)
Prims.bool))
 

:pattern ((Cert.ACLs.canWrite @x0))
:qid typing_Cert.ACLs.canWrite))

:named typing_Cert.ACLs.canWrite))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Cert.ACLs.canRead; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(31,4-31,11); use=Cert.ACLs.fst(31,4-31,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(Cert.ACLs.file Dummy_value))
(HasType (Cert.ACLs.canRead @x0)
Prims.bool))
 

:pattern ((Cert.ACLs.canRead @x0))
:qid typing_Cert.ACLs.canRead))

:named typing_Cert.ACLs.canRead))
;;;;;;;;;;;;;;;;string typing
;;; Fact-ids: Name Prims.string; Namespace Prims
(assert (! (forall ((@u0 FString))
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Cert.ACLs.delete; Namespace Cert.ACLs
(assert (! (HasType Tm_refine_81469cf5caba5948479dcf0757c19149
Tm_type)
:named refinement_kinding_Tm_refine_81469cf5caba5948479dcf0757c19149))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Cert.ACLs.read; Namespace Cert.ACLs
(assert (! (HasType Tm_refine_6969c262cf44150b15fd248146cc9da2
Tm_type)
:named refinement_kinding_Tm_refine_6969c262cf44150b15fd248146cc9da2))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
;;; Fact-ids: Name Cert.ACLs.delete; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(38,19-38,45); use=Cert.ACLs.fst(38,19-38,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_81469cf5caba5948479dcf0757c19149)
(and (HasTypeFuel @u0
@x1
Prims.string)

;; def=Cert.ACLs.fst(38,31-38,44); use=Cert.ACLs.fst(38,31-38,44)
(BoxBool_proj_0 (Cert.ACLs.canWrite @x1))
))
...
@x1
Tm_refine_81469cf5caba5948479dcf0757c19149))
:qid refinement_interpretation_Tm_refine_81469cf5caba5948479dcf0757c19149))

:named refinement_interpretation_Tm_refine_81469cf5caba5948479dcf0757c19149))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name Cert.ACLs.read; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(37,19-37,44); use=Cert.ACLs.fst(37,19-37,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_6969c262cf44150b15fd248146cc9da2)
...
;; def=Cert.ACLs.fst(37,31-37,43); use=Cert.ACLs.fst(37,31-37,43)
(BoxBool_proj_0 (Cert.ACLs.canRead @x1))
))
...
@x1
Tm_refine_6969c262cf44150b15fd248146cc9da2))
:qid refinement_interpretation_Tm_refine_6969c262cf44150b15fd248146cc9da2))

:named refinement_interpretation_Tm_refine_6969c262cf44150b15fd248146cc9da2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_81469cf5caba5948479dcf0757c19149
;;; Fact-ids: Name Cert.ACLs.delete; Namespace Cert.ACLs
(assert (! (iff (Valid (Prims.hasEq Tm_refine_81469cf5caba5948479dcf0757c19149))
(Valid (Prims.hasEq Prims.string)))
:named haseqTm_refine_81469cf5caba5948479dcf0757c19149))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_6969c262cf44150b15fd248146cc9da2
;;; Fact-ids: Name Cert.ACLs.read; Namespace Cert.ACLs
(assert (! (iff (Valid (Prims.hasEq Tm_refine_6969c262cf44150b15fd248146cc9da2))
(Valid (Prims.hasEq Prims.string)))
:named haseqTm_refine_6969c262cf44150b15fd248146cc9da2))
...
:qid equation_Cert.ACLs.tmp))

:named equation_Cert.ACLs.tmp))
;;;;;;;;;;;;;;;;Equation for Cert.ACLs.readme
;;; Fact-ids: Name Cert.ACLs.readme; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(42,4-42,10); use=Cert.ACLs.fst(42,4-42,10)
(forall ((@u0 Dummy_sort))
...
:qid equation_Cert.ACLs.readme))

:named equation_Cert.ACLs.readme))
;;;;;;;;;;;;;;;;Equation for Cert.ACLs.publicFile
;;; Fact-ids: Name Cert.ACLs.publicFile; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(27,4-27,14); use=Cert.ACLs.fst(27,4-27,14)
(forall ((@x0 Term))
 (! (= (Cert.ACLs.publicFile @x0)
(let ((@lb1 @x0))
(ite (= @lb1
(BoxString (FString_const 1)))
(BoxBool true)
...
:pattern ((Cert.ACLs.publicFile @x0))
:qid equation_Cert.ACLs.publicFile))

:named equation_Cert.ACLs.publicFile))
;;;;;;;;;;;;;;;;Equation for Cert.ACLs.file
;;; Fact-ids: Name Cert.ACLs.file; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(21,5-21,9); use=Cert.ACLs.fst(21,5-21,9)
(forall ((@u0 Dummy_sort))
...
:qid equation_Cert.ACLs.file))

:named equation_Cert.ACLs.file))
;;;;;;;;;;;;;;;;Equation for Cert.ACLs.canWrite
;;; Fact-ids: Name Cert.ACLs.canWrite; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(23,4-23,12); use=Cert.ACLs.fst(23,4-23,12)
(forall ((@x0 Term))
 (! (= (Cert.ACLs.canWrite @x0)
(let ((@lb1 @x0))
(ite (= @lb1
(BoxString (FString_const 0)))
(BoxBool true)
...
:pattern ((Cert.ACLs.canWrite @x0))
:qid equation_Cert.ACLs.canWrite))

:named equation_Cert.ACLs.canWrite))
;;;;;;;;;;;;;;;;Equation for Cert.ACLs.canRead
;;; Fact-ids: Name Cert.ACLs.canRead; Namespace Cert.ACLs
(assert (! 
;; def=Cert.ACLs.fst(31,4-31,11); use=Cert.ACLs.fst(31,4-31,11)
(forall ((@x0 Term))
 (! (= (Cert.ACLs.canRead @x0)
(Prims.op_BarBar (Prims.op_BarBar (Cert.ACLs.canWrite @x0)
(Cert.ACLs.publicFile @x0))
...
:pattern ((Cert.ACLs.canRead @x0))
:qid equation_Cert.ACLs.canRead))

:named equation_Cert.ACLs.canRead))
...
; Starting query at Cert.ACLs.fst(46,2-50,4)
...
; *)
;   Cert.ACLs.canWrite Cert.ACLs.tmp /\
;   (forall (any_result: Prims.string).
;       Cert.ACLs.tmp == any_result ==>
;       (forall (any_result: Prims.unit).
;           Cert.ACLs.canRead Cert.ACLs.tmp /\
;           (forall (any_result: Prims.string).
;               Cert.ACLs.tmp == any_result ==>
;               (forall (any_result: Prims.string).
;                   Cert.ACLs.read Cert.ACLs.tmp == any_result ==> Cert.ACLs.canRead Cert.ACLs.readme)
;           )))
...
;; def=Prims.fst(459,77-459,89); use=Cert.ACLs.fst(46,2-50,4)
(and 
;; def=Cert.ACLs.fst(38,31-38,44); use=Cert.ACLs.fst(46,9-46,12)
(or label_1

;; def=Cert.ACLs.fst(38,31-38,44); use=Cert.ACLs.fst(46,9-46,12)
(BoxBool_proj_0 (Cert.ACLs.canWrite (Cert.ACLs.tmp Dummy_value)))
)


;; def=Prims.fst(451,66-451,102); use=Cert.ACLs.fst(46,2-50,4)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.string)

;; def=Cert.ACLs.fst(38,19-46,12); use=Cert.ACLs.fst(46,2-50,4)
(= (Cert.ACLs.tmp Dummy_value)
@x1)
)
...
;; def=Prims.fst(459,77-459,89); use=Cert.ACLs.fst(46,2-50,4)
(and 
;; def=Cert.ACLs.fst(37,31-37,43); use=Cert.ACLs.fst(48,16-48,19)
(or label_2

;; def=Cert.ACLs.fst(37,31-37,43); use=Cert.ACLs.fst(48,16-48,19)
(BoxBool_proj_0 (Cert.ACLs.canRead (Cert.ACLs.tmp Dummy_value)))
)
...
;; def=Cert.ACLs.fst(37,19-48,19); use=Cert.ACLs.fst(46,2-50,4)
(= (Cert.ACLs.tmp Dummy_value)
@x3)
)
...
;; def=Cert.ACLs.fst(48,6-48,19); use=Cert.ACLs.fst(48,6-48,19)
(= (Cert.ACLs.read (Cert.ACLs.tmp Dummy_value))
@x4)
)

;; def=Cert.ACLs.fst(37,31-37,43); use=Cert.ACLs.fst(49,16-49,22)
(or label_3

;; def=Cert.ACLs.fst(37,31-37,43); use=Cert.ACLs.fst(49,16-49,22)
(BoxBool_proj_0 (Cert.ACLs.canRead (Cert.ACLs.readme Dummy_value)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Cert.ACLs.test, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_Cert.ACLs.canRead, equation_Cert.ACLs.canWrite, equation_Cert.ACLs.publicFile, equation_Cert.ACLs.readme, equation_Cert.ACLs.tmp, primitive_Prims.op_BarBar, projection_inverse_BoxBool_proj_0
...
(declare-fun Cert.ACLs.test (Term) Term)

(declare-fun Cert.ACLs.test@tok () Term)

; </end encoding let test>


; encoding sigelt val Cert.ACLs.rc


; <Skipped val Cert.ACLs.rc/>
...
; Starting query at Cert.ACLs.fst(55,2-57,28)

(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: Prims.unit -> Prims.string
(declare-fun Tm_arrow_998f8468eda62fbe33076ca009204032 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_998f8468eda62fbe33076ca009204032
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_998f8468eda62fbe33076ca009204032
Tm_type)
:named kinding_Tm_arrow_998f8468eda62fbe33076ca009204032))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Cert.ACLs.fst(53,20-53,34); use=Cert.ACLs.fst(55,2-57,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_998f8468eda62fbe33076ca009204032)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_998f8468eda62fbe33076ca009204032))
:qid Cert.ACLs_pre_typing_Tm_arrow_998f8468eda62fbe33076ca009204032))

:named Cert.ACLs_pre_typing_Tm_arrow_998f8468eda62fbe33076ca009204032))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_998f8468eda62fbe33076ca009204032
;;; Fact-ids: 
(assert (! 
;; def=Cert.ACLs.fst(53,20-53,34); use=Cert.ACLs.fst(55,2-57,28)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Cert.ACLs_interpretation_Tm_arrow_998f8468eda62fbe33076ca009204032.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_998f8468eda62fbe33076ca009204032))
:qid Cert.ACLs_interpretation_Tm_arrow_998f8468eda62fbe33076ca009204032))

:named Cert.ACLs_interpretation_Tm_arrow_998f8468eda62fbe33076ca009204032))


; Encoding query formula : forall (file: Cert.ACLs.file).
;   (*  - Could not prove post-condition
; *)
;   forall (h0: FStar.Monotonic.Heap.heap)
;     (k: FStar.Pervasives.all_post_h FStar.Monotonic.Heap.heap (_: Prims.unit -> Prims.string)).
;     (forall (x: FStar.Pervasives.result (_: Prims.unit -> Prims.string))
;         (h: FStar.Monotonic.Heap.heap).
;         {:pattern Prims.guard_free (k x h)}
;         Prims.auto_squash (k x h)) ==>
;     Cert.ACLs.canRead file == true ==>
;     (forall (_: Prims.unit). (*  - Could not prove post-condition
; *) Cert.ACLs.canRead file)


; Context: While encoding a query
; While typechecking the top-level declaration `let rc`
...
;; def=FStar.Pervasives.fsti(667,4-667,88); use=Cert.ACLs.fst(55,2-57,28)
(forall ((@x3 Term) (@x4 Term))
 (! 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=Cert.ACLs.fst(55,2-57,28)
(Valid 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=Cert.ACLs.fst(55,2-57,28)
(ApplyTT (ApplyTT @x2
@x3)
...
;; def=Cert.ACLs.fst(55,5-55,17); use=Cert.ACLs.fst(55,5-55,17)
(= (Cert.ACLs.canRead @x0)
(BoxBool true))
)

;; def=dummy(0,0-0,0); use=Cert.ACLs.fst(55,2-57,28)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.unit)

;; def=Cert.ACLs.fst(37,31-37,43); use=Cert.ACLs.fst(56,23-56,27)
(or label_1

;; def=Cert.ACLs.fst(37,31-37,43); use=Cert.ACLs.fst(56,23-56,27)
(BoxBool_proj_0 (Cert.ACLs.canRead @x0))
)
)
