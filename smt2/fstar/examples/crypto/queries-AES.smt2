...
; Starting query at AES.fst(30,5-30,10)

(declare-fun label_1 () Bool)

; Encoding query formula : AES.psize >= 0
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(680,18-680,24); use=AES.fst(30,21-30,26)
(or label_1

;; def=Prims.fst(680,18-680,24); use=AES.fst(30,21-30,26)
(>= (BoxInt_proj_0 (AES.psize Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AES.plain, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AES.blocksize, equation_AES.psize, projection_inverse_BoxInt_proj_0
...
; Starting query at AES.fst(31,5-31,11)

(declare-fun label_1 () Bool)

; Encoding query formula : AES.csize >= 0


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let cipher`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(680,18-680,24); use=AES.fst(31,21-31,26)
(or label_1

;; def=Prims.fst(680,18-680,24); use=AES.fst(31,21-31,26)
(>= (BoxInt_proj_0 (AES.csize Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (AES.cipher, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AES.blocksize, equation_AES.csize, primitive_Prims.op_Multiply, projection_inverse_BoxInt_proj_0
...
; Starting query at AES.fst(35,5-35,8)

(declare-fun label_1 () Bool)

; Encoding query formula : AES.keysize >= 0
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(680,18-680,24); use=AES.fst(35,18-35,25)
(or label_1

;; def=Prims.fst(680,18-680,24); use=AES.fst(35,18-35,25)
(>= (BoxInt_proj_0 (AES.keysize Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)
)
:named @query))
...
; QUERY ID: (AES.key, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_AES.keysize, projection_inverse_BoxInt_proj_0
...
; encoding sigelt val AES.generated
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AES.dec; Namespace AES
(assert (! 
;; def=AES.fst(42,11-42,14); use=AES.fst(42,11-42,14)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
AES.key)
(HasType @x1
...
; Starting query at AES.fst(43,7-45,46)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_4c07f2e3bf4cc74b49928324924c9435 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=AES.fst(43,39-43,65); use=AES.fst(43,39-43,65)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_4c07f2e3bf4cc74b49928324924c9435 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_4c07f2e3bf4cc74b49928324924c9435 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_4c07f2e3bf4cc74b49928324924c9435))

:named refinement_kinding_Tm_refine_4c07f2e3bf4cc74b49928324924c9435))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=AES.fst(43,39-43,65); use=AES.fst(43,39-43,65)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4c07f2e3bf4cc74b49928324924c9435 @x2
@x3))
(and (HasTypeFuel @u0
@x1
AES.cipher)

;; def=AES.fst(43,51-43,62); use=AES.fst(43,51-43,62)
(= (AES.dec @x2
@x1)
@x3)
))
...
(Tm_refine_4c07f2e3bf4cc74b49928324924c9435 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_4c07f2e3bf4cc74b49928324924c9435))

:named refinement_interpretation_Tm_refine_4c07f2e3bf4cc74b49928324924c9435))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4c07f2e3bf4cc74b49928324924c9435
;;; Fact-ids: 
(assert (! 
;; def=AES.fst(43,39-43,65); use=AES.fst(43,39-43,65)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4c07f2e3bf4cc74b49928324924c9435 @x0
@x1)))
(Valid (Prims.hasEq AES.cipher)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4c07f2e3bf4cc74b49928324924c9435 @x0
@x1))))
:qid haseqTm_refine_4c07f2e3bf4cc74b49928324924c9435))

:named haseqTm_refine_4c07f2e3bf4cc74b49928324924c9435))

; Encoding query formula : forall (k: AES.key) (p: AES.plain).
;   (forall (c: AES.cipher).
...
;       c: AES.cipher{AES.dec k c = p} == any_result ==>
;       (forall (h0: FStar.Monotonic.Heap.heap) (c: AES.cipher).
;           (*  - Subtyping check failed
;   - Expected type Prims.eqtype got type Type0
; *)
;           Prims.hasEq AES.plain))
...
; Context: While encoding a query
; While typechecking the top-level declaration `val AES.enc`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=AES.fst(43,7-45,46)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
AES.key)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=AES.fst(43,18-43,65)
(and 
;; def=dummy(0,0-0,0); use=AES.fst(43,18-43,65)
(forall ((@x2 Term))
 (! (implies (HasType @x2
AES.cipher)

;; def=Prims.fst(73,23-73,30); use=AES.fst(43,51-43,54)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=AES.fst(43,18-43,65)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_type)

;; def=FStar.ST.fst(75,11-75,12); use=AES.fst(43,18-43,65)
(= (Tm_refine_4c07f2e3bf4cc74b49928324924c9435 @x0
@x1)
@x2)
)
...
;; def=Prims.fst(73,23-73,30); use=AES.fst(43,36-43,38)
(or label_2
...
; QUERY ID: (AES.enc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_Platform.Bytes.HasEq_bytes, equation_AES.bytes, equation_AES.nbytes, equation_AES.plain, equation_AES.psize, haseqTm_refine_8f0006372dc7eef1f8d6507769207c67
