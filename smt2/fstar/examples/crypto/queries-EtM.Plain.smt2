...
; Externals for interface EtM.Ideal


; <Start encoding val EtM.Ideal.ind_cpa>

(declare-fun EtM.Ideal.ind_cpa (Dummy_sort) Term)

; </end encoding val EtM.Ideal.ind_cpa>


; <Start encoding val EtM.Ideal.uf_cma>

(declare-fun EtM.Ideal.uf_cma (Dummy_sort) Term)
(declare-fun Tm_refine_f4b77abb8a71325c47c79229db8fb3ba () Term)


; </end encoding val EtM.Ideal.uf_cma>


; <Start encoding let ind_cpa_rest_adv>

(declare-fun EtM.Ideal.ind_cpa_rest_adv (Dummy_sort) Term)



; </end encoding let ind_cpa_rest_adv>


; <Start encoding let conf>

(declare-fun EtM.Ideal.conf (Dummy_sort) Term)
...
(declare-fun EtM.Ideal.auth (Dummy_sort) Term)
...
; End Externals for interface EtM.Ideal
...
; Internals for EtM.Plain


; encoding sigelt val EtM.Plain.plain


; <Skipped val EtM.Plain.plain/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name EtM.Ideal.ind_cpa; Namespace EtM.Ideal
(assert (! 
;; def=EtM.Ideal.fsti(19,4-19,11); use=EtM.Ideal.fsti(19,4-19,11)
(forall ((@u0 Dummy_sort))
 (! (HasType (EtM.Ideal.ind_cpa @u0)
Prims.bool)
 

:pattern ((EtM.Ideal.ind_cpa @u0))
:qid typing_EtM.Ideal.ind_cpa))

:named typing_EtM.Ideal.ind_cpa))
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name EtM.Ideal.uf_cma; Namespace EtM.Ideal
(assert (! (HasType Tm_refine_f4b77abb8a71325c47c79229db8fb3ba
Tm_type)
:named refinement_kinding_Tm_refine_f4b77abb8a71325c47c79229db8fb3ba))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name EtM.Ideal.uf_cma; Namespace EtM.Ideal
(assert (! 
;; def=EtM.Ideal.fsti(21,13-21,36); use=EtM.Ideal.fsti(21,13-21,36)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f4b77abb8a71325c47c79229db8fb3ba)
(and (HasTypeFuel @u0
@x1
Prims.bool)

;; def=EtM.Ideal.fsti(21,21-21,34); use=EtM.Ideal.fsti(21,21-21,34)
(implies 
;; def=EtM.Ideal.fsti(21,21-21,28); use=EtM.Ideal.fsti(21,21-21,28)
(BoxBool_proj_0 (EtM.Ideal.ind_cpa Dummy_value))


;; def=EtM.Ideal.fsti(21,13-21,14); use=EtM.Ideal.fsti(21,33-21,34)
(BoxBool_proj_0 @x1)
)
))
...
@x1
Tm_refine_f4b77abb8a71325c47c79229db8fb3ba))
:qid refinement_interpretation_Tm_refine_f4b77abb8a71325c47c79229db8fb3ba))

:named refinement_interpretation_Tm_refine_f4b77abb8a71325c47c79229db8fb3ba))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Pervasives.false_elim; Namespace FStar.Pervasives
(assert (! 
...
:qid int_inversion))
:named int_inversion))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f4b77abb8a71325c47c79229db8fb3ba
;;; Fact-ids: Name EtM.Ideal.uf_cma; Namespace EtM.Ideal
(assert (! (iff (Valid (Prims.hasEq Tm_refine_f4b77abb8a71325c47c79229db8fb3ba))
(Valid (Prims.hasEq Prims.bool)))
:named haseqTm_refine_f4b77abb8a71325c47c79229db8fb3ba))
...
; Starting query at EtM.Plain.fst(22,5-22,10)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq Platform.Bytes.bytes
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(73,23-73,30); use=EtM.Plain.fst(22,22-22,27)
(or label_1
...
(declare-fun EtM.Plain.plain (Dummy_sort) Term)

; </end encoding let plain>


; encoding sigelt val EtM.Plain.reveal


; <Skipped val EtM.Plain.reveal/>
...
(declare-fun EtM.Plain.reveal (Term) Term)
;;;;;;;;;;;;;;;;p: plain -> Prims.GTot Platform.Bytes.bytes
(declare-fun Tm_ghost_arrow_dafb01b9398faf31ed86eb249d812daa () Term)
(declare-fun EtM.Plain.reveal@tok () Term)

; </end encoding let reveal>


; encoding sigelt val EtM.Plain.hide


; <Skipped val EtM.Plain.hide/>
...
(declare-fun EtM.Plain.hide (Term) Term)
;;;;;;;;;;;;;;;;b: Platform.Bytes.bytes -> Prims.GTot plain
(declare-fun Tm_ghost_arrow_b62508611184e7ec1b426d8ed7546de9 () Term)
(declare-fun EtM.Plain.hide@tok () Term)

; </end encoding let hide>


; encoding sigelt val EtM.Plain.reveal_hide


; <Skipped val EtM.Plain.reveal_hide/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name EtM.Plain.reveal; Namespace EtM.Plain
(assert (! 
;; def=EtM.Plain.fst(24,4-24,10); use=EtM.Plain.fst(24,4-24,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(EtM.Plain.plain Dummy_value))
(HasType (EtM.Plain.reveal @x0)
Platform.Bytes.bytes))
 

:pattern ((EtM.Plain.reveal @x0))
:qid typing_EtM.Plain.reveal))

:named typing_EtM.Plain.reveal))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name EtM.Plain.plain; Namespace EtM.Plain
(assert (! 
;; def=EtM.Plain.fst(22,5-22,10); use=EtM.Plain.fst(22,5-22,10)
(forall ((@u0 Dummy_sort))
 (! (HasType (EtM.Plain.plain @u0)
Prims.eqtype)
 

:pattern ((EtM.Plain.plain @u0))
:qid typing_EtM.Plain.plain))

:named typing_EtM.Plain.plain))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name EtM.Plain.hide; Namespace EtM.Plain
(assert (! 
;; def=EtM.Plain.fst(26,4-26,8); use=EtM.Plain.fst(26,4-26,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Platform.Bytes.bytes)
(HasType (EtM.Plain.hide @x0)
(EtM.Plain.plain Dummy_value)))
 

:pattern ((EtM.Plain.hide @x0))
:qid typing_EtM.Plain.hide))

:named typing_EtM.Plain.hide))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
:pattern ((EtM.Plain.reveal @x0))
:qid equation_EtM.Plain.reveal))

:named equation_EtM.Plain.reveal))
;;;;;;;;;;;;;;;;Equation for EtM.Plain.plain
;;; Fact-ids: Name EtM.Plain.plain; Namespace EtM.Plain
(assert (! 
;; def=EtM.Plain.fst(22,5-22,10); use=EtM.Plain.fst(22,5-22,10)
(forall ((@u0 Dummy_sort))
...
:qid equation_EtM.Plain.plain))

:named equation_EtM.Plain.plain))
;;;;;;;;;;;;;;;;Equation for EtM.Plain.hide
;;; Fact-ids: Name EtM.Plain.hide; Namespace EtM.Plain
(assert (! 
;; def=EtM.Plain.fst(26,4-26,8); use=EtM.Plain.fst(26,4-26,8)
(forall ((@x0 Term))
...
:pattern ((EtM.Plain.hide @x0))
:qid equation_EtM.Plain.hide))

:named equation_EtM.Plain.hide))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at EtM.Plain.fst(31,4-31,6)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (p: EtM.Plain.plain).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). EtM.Plain.hide (EtM.Plain.reveal p) == p ==> p pure_result) ==>
...
;; def=Prims.fst(441,36-441,97); use=EtM.Plain.fst(31,4-31,6)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=EtM.Plain.fst(29,10-29,32); use=EtM.Plain.fst(31,4-31,6)
(or label_2

;; def=EtM.Plain.fst(29,10-29,32); use=EtM.Plain.fst(31,4-31,6)
(= (EtM.Plain.hide (EtM.Plain.reveal @x0))
@x0)
)
)

;; def=Prims.fst(441,83-441,96); use=EtM.Plain.fst(31,4-31,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=EtM.Plain.fst(31,4-31,6)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (EtM.Plain.reveal_hide, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_EtM.Plain.hide, equation_EtM.Plain.reveal
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun EtM.Plain.reveal_hide (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun EtM.Plain.reveal_hide@tok () Term)

; </end encoding let reveal_hide>


; encoding sigelt val EtM.Plain.hide_reveal


; <Skipped val EtM.Plain.hide_reveal/>

;;;;;;;;;;;;;;;;Lemma: EtM.Plain.reveal_hide
;;; Fact-ids: Name EtM.Plain.reveal_hide; Namespace EtM.Plain
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
(EtM.Plain.plain Dummy_value))

;; def=EtM.Plain.fsti(29,10-29,32); use=EtM.Plain.fst(28,4-28,15)
(= (EtM.Plain.hide (EtM.Plain.reveal @x0))
@x0)
)
...
:pattern ((EtM.Plain.reveal @x0))
:qid lemma_EtM.Plain.reveal_hide))
:named lemma_EtM.Plain.reveal_hide))
(push) ;; push{2

; Starting query at EtM.Plain.fst(36,4-36,6)
...
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). EtM.Plain.reveal (EtM.Plain.hide b) == b ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)
...
;; def=Prims.fst(441,36-441,97); use=EtM.Plain.fst(36,4-36,6)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=EtM.Plain.fst(34,10-34,32); use=EtM.Plain.fst(36,4-36,6)
(or label_2

;; def=EtM.Plain.fst(34,10-34,32); use=EtM.Plain.fst(36,4-36,6)
(= (EtM.Plain.reveal (EtM.Plain.hide @x0))
@x0)
)
)

;; def=Prims.fst(441,83-441,96); use=EtM.Plain.fst(36,4-36,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=EtM.Plain.fst(36,4-36,6)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (EtM.Plain.hide_reveal, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_EtM.Plain.hide, equation_EtM.Plain.reveal
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun EtM.Plain.hide_reveal (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun EtM.Plain.hide_reveal@tok () Term)

; </end encoding let hide_reveal>


; encoding sigelt val EtM.Plain.repr


; <Skipped val EtM.Plain.repr/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name EtM.Ideal.uf_cma; Namespace EtM.Ideal
(assert (! 
;; def=EtM.Ideal.fsti(21,4-21,10); use=EtM.Ideal.fsti(21,4-21,10)
(forall ((@u0 Dummy_sort))
 (! (HasType (EtM.Ideal.uf_cma @u0)
Tm_refine_f4b77abb8a71325c47c79229db8fb3ba)
 

:pattern ((EtM.Ideal.uf_cma @u0))
:qid typing_EtM.Ideal.uf_cma))

:named typing_EtM.Ideal.uf_cma))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name EtM.Ideal.conf; Namespace EtM.Ideal
(assert (! 
;; def=EtM.Ideal.fsti(26,4-26,8); use=EtM.Ideal.fsti(26,4-26,8)
(forall ((@u0 Dummy_sort))
 (! (HasType (EtM.Ideal.conf @u0)
Prims.bool)
 

:pattern ((EtM.Ideal.conf @u0))
:qid typing_EtM.Ideal.conf))

:named typing_EtM.Ideal.conf))
;;;;;;;;;;;;;;;;Lemma: EtM.Plain.hide_reveal
;;; Fact-ids: Name EtM.Plain.hide_reveal; Namespace EtM.Plain
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
Platform.Bytes.bytes)

;; def=EtM.Plain.fsti(33,10-33,32); use=EtM.Plain.fst(33,4-33,15)
(= (EtM.Plain.reveal (EtM.Plain.hide @x0))
@x0)
)
...
:pattern ((EtM.Plain.hide @x0))
:qid lemma_EtM.Plain.hide_reveal))
:named lemma_EtM.Plain.hide_reveal))
;;;;;;;;;;;;;;;;Equation for EtM.Ideal.conf
;;; Fact-ids: Name EtM.Ideal.conf; Namespace EtM.Ideal
(assert (! 
;; def=EtM.Ideal.fsti(26,4-26,8); use=EtM.Ideal.fsti(26,4-26,8)
(forall ((@u0 Dummy_sort))
...
(Prims.op_AmpAmp (EtM.Ideal.ind_cpa Dummy_value)
(EtM.Ideal.uf_cma Dummy_value)))
...
:qid equation_EtM.Ideal.conf))

:named equation_EtM.Ideal.conf))
(push) ;; push{2

; Starting query at EtM.Plain.fst(40,4-40,5)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_b36e682c0f04094e91b0427038ab0d90 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_b36e682c0f04094e91b0427038ab0d90
Tm_type)
:named refinement_kinding_Tm_refine_b36e682c0f04094e91b0427038ab0d90))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=EtM.Plain.fst(38,9-38,28); use=EtM.Plain.fst(38,9-38,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_b36e682c0f04094e91b0427038ab0d90)
(and (HasTypeFuel @u0
@x1
(EtM.Plain.plain Dummy_value))
(not (BoxBool_proj_0 (EtM.Ideal.conf Dummy_value)))))
 

:pattern ((HasTypeFuel @u0
@x1
Tm_refine_b36e682c0f04094e91b0427038ab0d90))
:qid refinement_interpretation_Tm_refine_b36e682c0f04094e91b0427038ab0d90))

:named refinement_interpretation_Tm_refine_b36e682c0f04094e91b0427038ab0d90))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b36e682c0f04094e91b0427038ab0d90
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_b36e682c0f04094e91b0427038ab0d90))
(Valid (Prims.hasEq (EtM.Plain.plain Dummy_value))))
:named haseqTm_refine_b36e682c0f04094e91b0427038ab0d90))

; Encoding query formula : forall (p: EtM.Plain.plain{Prims.op_Negation EtM.Ideal.conf}).
;   (*  - Could not prove post-condition
; *)
;   Prims.op_Negation EtM.Ideal.conf ==> p == EtM.Plain.reveal p
...
;; def=EtM.Plain.fst(39,13-39,26); use=EtM.Plain.fst(40,4-40,5)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (EtM.Plain.repr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_EtM.Plain.reveal
...
(declare-fun Tm_refine_b36e682c0f04094e91b0427038ab0d90 () Term)
(declare-fun EtM.Plain.repr (Term) Term)

(declare-fun Tm_refine_788ea9febe333beda70cb0ff31693d92 (Term) Term)
;;;;;;;;;;;;;;;;p: plain{Prims.op_Negation EtM.Ideal.conf} -> b: Platform.Bytes.bytes{b == reveal p}
(declare-fun Tm_arrow_c9e794acb0d0cf4a53a20812da062ab6 () Term)
(declare-fun EtM.Plain.repr@tok () Term)
...
; encoding sigelt val EtM.Plain.coerce


; <Skipped val EtM.Plain.coerce/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name EtM.Ideal.auth; Namespace EtM.Ideal
(assert (! 
;; def=EtM.Ideal.fsti(28,4-28,8); use=EtM.Ideal.fsti(28,4-28,8)
(forall ((@u0 Dummy_sort))
 (! (HasType (EtM.Ideal.auth @u0)
Tm_refine_f4b77abb8a71325c47c79229db8fb3ba)
 

:pattern ((EtM.Ideal.auth @u0))
:qid typing_EtM.Ideal.auth))

:named typing_EtM.Ideal.auth))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name EtM.Plain.repr; Namespace EtM.Plain
(assert (! (HasType Tm_refine_b36e682c0f04094e91b0427038ab0d90
Tm_type)
:named refinement_kinding_Tm_refine_b36e682c0f04094e91b0427038ab0d90))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name EtM.Plain.repr; Namespace EtM.Plain
(assert (! 
;; def=EtM.Plain.fsti(36,9-36,28); use=EtM.Plain.fst(38,4-38,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_b36e682c0f04094e91b0427038ab0d90)
...
:qid equation_EtM.Ideal.auth))

:named equation_EtM.Ideal.auth))
(push) ;; push{2

; Starting query at EtM.Plain.fst(44,4-44,5)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_c54299f1ddd297911049409c35c20d74 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_c54299f1ddd297911049409c35c20d74
Tm_type)
:named refinement_kinding_Tm_refine_c54299f1ddd297911049409c35c20d74))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=EtM.Plain.fst(42,11-42,30); use=EtM.Plain.fst(42,11-42,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_c54299f1ddd297911049409c35c20d74)
(and (HasTypeFuel @u0
@x1
Platform.Bytes.bytes)
(not (BoxBool_proj_0 (EtM.Ideal.auth Dummy_value)))))
 

:pattern ((HasTypeFuel @u0
@x1
Tm_refine_c54299f1ddd297911049409c35c20d74))
:qid refinement_interpretation_Tm_refine_c54299f1ddd297911049409c35c20d74))

:named refinement_interpretation_Tm_refine_c54299f1ddd297911049409c35c20d74))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c54299f1ddd297911049409c35c20d74
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_c54299f1ddd297911049409c35c20d74))
(Valid (Prims.hasEq Platform.Bytes.bytes)))
:named haseqTm_refine_c54299f1ddd297911049409c35c20d74))

; Encoding query formula : forall (r: Platform.Bytes.bytes{Prims.op_Negation EtM.Ideal.auth}).
;   (*  - Could not prove post-condition
; *) Prims.op_Negation EtM.Ideal.auth ==> r == EtM.Plain.hide r
...
;; def=EtM.Plain.fst(43,13-43,24); use=EtM.Plain.fst(44,4-44,5)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (EtM.Plain.coerce, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_EtM.Plain.hide
...
(declare-fun Tm_refine_c54299f1ddd297911049409c35c20d74 () Term)
(declare-fun EtM.Plain.coerce (Term) Term)

(declare-fun Tm_refine_45f5d28eda07797c45d5854876b75dfd (Term) Term)
;;;;;;;;;;;;;;;;r: Platform.Bytes.bytes{Prims.op_Negation EtM.Ideal.auth} -> p: plain{p == hide r}
(declare-fun Tm_arrow_55a7ba33e03095cde1a5a827a0bc4d0f () Term)
(declare-fun EtM.Plain.coerce@tok () Term)
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name EtM.Plain.coerce; Namespace EtM.Plain
(assert (! (HasType Tm_refine_c54299f1ddd297911049409c35c20d74
Tm_type)
:named refinement_kinding_Tm_refine_c54299f1ddd297911049409c35c20d74))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name EtM.Plain.coerce; Namespace EtM.Plain
(assert (! 
;; def=EtM.Plain.fsti(39,11-39,30); use=EtM.Plain.fst(42,4-42,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_c54299f1ddd297911049409c35c20d74)
...
; Starting query at EtM.Plain.fsti(44,0-45,36)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val EtM.Plain.length`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=EtM.Plain.fsti(44,0-45,36)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(EtM.Plain.plain Dummy_value))

;; def=dummy(0,0-0,0); use=EtM.Plain.fsti(44,14-45,36)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.nat)

;; def=Prims.fst(73,23-73,30); use=EtM.Plain.fsti(45,11-45,12)
(or label_1
...
; encoding sigelt val EtM.Plain.length


; <Skipped val EtM.Plain.length/>
...
; Starting query at EtM.Plain.fst(49,4-49,14)
...
;   - Expected type Prims.eqtype got type Type0
; *)
;       Prims.hasEq Prims.nat) /\ Platform.Bytes.length p = Platform.Bytes.length (EtM.Plain.reveal p)
...
;; def=EtM.Plain.fst(48,4-49,14); use=EtM.Plain.fst(48,4-49,14)
(and 
;; def=dummy(0,0-0,0); use=EtM.Plain.fst(49,4-49,14)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.nat)

;; def=Prims.fst(73,23-73,30); use=EtM.Plain.fst(48,11-48,12)
(or label_1

;; def=Prims.fst(73,23-73,30); use=EtM.Plain.fst(49,4-49,14)
(Valid 
;; def=Prims.fst(73,23-73,30); use=EtM.Plain.fst(49,4-49,14)
(Prims.hasEq Prims.nat)
)
...
;; def=EtM.Plain.fst(48,11-48,34); use=EtM.Plain.fst(49,4-49,14)
(or label_2

;; def=EtM.Plain.fst(48,11-48,34); use=EtM.Plain.fst(49,4-49,14)
(= (Platform.Bytes.length @x0)
(Platform.Bytes.length (EtM.Plain.reveal @x0)))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (EtM.Plain.length, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_EtM.Plain.reveal, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
