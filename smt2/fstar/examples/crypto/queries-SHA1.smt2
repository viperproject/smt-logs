...
; encoding sigelt let text


; <Start encoding let text>

(declare-fun SHA1.text () Term)

; </end encoding let text>


; encoding sigelt let keysize


; <Start encoding let keysize>

(declare-fun SHA1.keysize (Dummy_sort) Term)

; </end encoding let keysize>


; encoding sigelt let blocksize


; <Start encoding let blocksize>

(declare-fun SHA1.blocksize (Dummy_sort) Term)

; </end encoding let blocksize>


; encoding sigelt let macsize


; <Start encoding let macsize>

(declare-fun SHA1.macsize (Dummy_sort) Term)

; </end encoding let macsize>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SHA1.keysize; Namespace SHA1
(assert (! 
;; def=SHA1.fst(27,4-27,11); use=SHA1.fst(27,4-27,11)
(forall ((@u0 Dummy_sort))
 (! (HasType (SHA1.keysize @u0)
Prims.int)
 

:pattern ((SHA1.keysize @u0))
:qid typing_SHA1.keysize))

:named typing_SHA1.keysize))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
:qid equation_SHA1.keysize))

:named equation_SHA1.keysize))
...
; Starting query at SHA1.fst(31,5-31,8)

(declare-fun label_1 () Bool)

; Encoding query formula : SHA1.keysize >= 0


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let key`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(680,18-680,24); use=SHA1.fst(31,18-31,25)
(or label_1

;; def=Prims.fst(680,18-680,24); use=SHA1.fst(31,18-31,25)
(>= (BoxInt_proj_0 (SHA1.keysize Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)
)
:named @query))
...
; QUERY ID: (SHA1.key, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_SHA1.keysize, projection_inverse_BoxInt_proj_0
...
(declare-fun SHA1.key () Term)

; </end encoding let key>


; encoding sigelt let tag


; <Start encoding let tag>

(declare-fun SHA1.tag () Term)

; </end encoding let tag>


; encoding sigelt val SHA1.sample


; <Skipped val SHA1.sample/>
...
; Starting query at SHA1.fst(35,15-35,23)
...
; *)
;   forall (p: FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap (Platform.Bytes.lbytes n))
;     (h: FStar.Monotonic.Heap.heap).
;     (forall (a: Platform.Bytes.lbytes n) (h1: FStar.Monotonic.Heap.heap). Prims.auto_squash (p a h1)
;     ) ==>
;     (forall (any_result: Platform.Bytes.lbytes n). p any_result h)
...
;; def=FStar.ST.fst(76,50-76,87); use=SHA1.fst(35,15-35,23)
...
;; def=FStar.ST.fst(76,80-76,86); use=SHA1.fst(35,15-35,23)
(Valid 
;; def=FStar.ST.fst(76,80-76,86); use=SHA1.fst(35,15-35,23)
(ApplyTT (ApplyTT @x1
@x3)
...
;; def=FStar.ST.fst(33,87-33,92); use=FStar.ST.fst(34,24-34,36)
(Valid 
;; def=FStar.ST.fst(33,87-33,92); use=FStar.ST.fst(34,24-34,36)
(ApplyTT (ApplyTT @x1
@x3)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun SHA1.sample (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun SHA1.sample@tok () Term)

; </end encoding let sample>


; encoding sigelt val SHA1.sha1


; <Skipped val SHA1.sha1/>

;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.SHA512@tok
CoreCrypto.hash_alg)
:named typing_tok_CoreCrypto.SHA512@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.SHA384@tok
CoreCrypto.hash_alg)
:named typing_tok_CoreCrypto.SHA384@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.SHA256@tok
CoreCrypto.hash_alg)
:named typing_tok_CoreCrypto.SHA256@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.SHA224@tok
CoreCrypto.hash_alg)
:named typing_tok_CoreCrypto.SHA224@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.SHA1@tok
CoreCrypto.hash_alg)
:named typing_tok_CoreCrypto.SHA1@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.MD5@tok
CoreCrypto.hash_alg)
:named typing_tok_CoreCrypto.MD5@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CoreCrypto.hashSize; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(29,4-29,12); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(29,4-29,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
CoreCrypto.hash_alg)
(HasType (CoreCrypto.hashSize @x0)
Prims.int))
 

:pattern ((CoreCrypto.hashSize @x0))
:qid typing_CoreCrypto.hashSize))

:named typing_CoreCrypto.hashSize))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CoreCrypto.hash; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,11-38,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,11-38,15)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
CoreCrypto.hash_alg)
(HasType @x1
Platform.Bytes.bytes))
(HasType (CoreCrypto.hash @x0
@x1)
(Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39 @x0)))
 

:pattern ((CoreCrypto.hash @x0
@x1))
:qid typing_CoreCrypto.hash))

:named typing_CoreCrypto.hash))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CoreCrypto.hash; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,47-38,81); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,47-38,81)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39))

:named refinement_kinding_Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name CoreCrypto.hash; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,47-38,81); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,47-38,81)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39 @x2))
(and (HasTypeFuel @u0
@x1
Platform.Bytes.bytes)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,56-38,79); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,56-38,79)
(= (Platform.Bytes.length @x1)
(CoreCrypto.hashSize @x2))
))
...
@x1
(Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39 @x2)))
:qid refinement_interpretation_Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39))

:named refinement_interpretation_Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39))
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.hash_alg
Tm_type)
:named kinding_CoreCrypto.hash_alg@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39
;;; Fact-ids: Name CoreCrypto.hash; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,47-38,81); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,47-38,81)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39 @x0)))
(Valid (Prims.hasEq Platform.Bytes.bytes)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39 @x0))))
:qid haseqTm_refine_ae61e173a3c4cc520beacd1d06b1ca39))

:named haseqTm_refine_ae61e173a3c4cc520beacd1d06b1ca39))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(21,5-21,13); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(21,5-21,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
CoreCrypto.hash_alg)
(or (is-CoreCrypto.MD5 @x1)
(is-CoreCrypto.SHA1 @x1)
(is-CoreCrypto.SHA224 @x1)
(is-CoreCrypto.SHA256 @x1)
(is-CoreCrypto.SHA384 @x1)
(is-CoreCrypto.SHA512 @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
CoreCrypto.hash_alg))
:qid fuel_guarded_inversion_CoreCrypto.hash_alg))

:named fuel_guarded_inversion_CoreCrypto.hash_alg))
;;;;;;;;;;;;;;;;Equation for CoreCrypto.hashSize
;;; Fact-ids: Name CoreCrypto.hashSize; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(29,4-29,12); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(29,4-29,12)
(forall ((@x0 Term))
 (! (= (CoreCrypto.hashSize @x0)
(let ((@lb1 @x0))
(ite (is-CoreCrypto.MD5 @lb1)
(BoxInt 16)
(ite (is-CoreCrypto.SHA1 @lb1)
(BoxInt 20)
(ite (is-CoreCrypto.SHA224 @lb1)
(BoxInt 28)
(ite (is-CoreCrypto.SHA256 @lb1)
(BoxInt 32)
(ite (is-CoreCrypto.SHA384 @lb1)
(BoxInt 48)
(ite (is-CoreCrypto.SHA512 @lb1)
(BoxInt 64)
Tm_unit))))))))
 

:pattern ((CoreCrypto.hashSize @x0))
:qid equation_CoreCrypto.hashSize))

:named equation_CoreCrypto.hashSize))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= CoreCrypto.SHA512@tok
CoreCrypto.SHA512)
:named equality_tok_CoreCrypto.SHA512@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= CoreCrypto.SHA384@tok
CoreCrypto.SHA384)
:named equality_tok_CoreCrypto.SHA384@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= CoreCrypto.SHA256@tok
CoreCrypto.SHA256)
:named equality_tok_CoreCrypto.SHA256@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= CoreCrypto.SHA224@tok
CoreCrypto.SHA224)
:named equality_tok_CoreCrypto.SHA224@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= CoreCrypto.SHA1@tok
CoreCrypto.SHA1)
:named equality_tok_CoreCrypto.SHA1@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= CoreCrypto.MD5@tok
CoreCrypto.MD5)
:named equality_tok_CoreCrypto.MD5@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(27,4-27,10); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(27,4-27,10)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.SHA512
CoreCrypto.hash_alg)
...
CoreCrypto.SHA512
CoreCrypto.hash_alg))
:qid data_typing_intro_CoreCrypto.SHA512@tok))

:named data_typing_intro_CoreCrypto.SHA512@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(26,4-26,10); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(26,4-26,10)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.SHA384
CoreCrypto.hash_alg)
...
CoreCrypto.SHA384
CoreCrypto.hash_alg))
:qid data_typing_intro_CoreCrypto.SHA384@tok))

:named data_typing_intro_CoreCrypto.SHA384@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(25,4-25,10); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(25,4-25,10)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.SHA256
CoreCrypto.hash_alg)
...
CoreCrypto.SHA256
CoreCrypto.hash_alg))
:qid data_typing_intro_CoreCrypto.SHA256@tok))

:named data_typing_intro_CoreCrypto.SHA256@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(24,4-24,10); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(24,4-24,10)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.SHA224
CoreCrypto.hash_alg)
...
CoreCrypto.SHA224
CoreCrypto.hash_alg))
:qid data_typing_intro_CoreCrypto.SHA224@tok))

:named data_typing_intro_CoreCrypto.SHA224@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(23,4-23,8); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(23,4-23,8)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.SHA1
CoreCrypto.hash_alg)
...
CoreCrypto.SHA1
CoreCrypto.hash_alg))
:qid data_typing_intro_CoreCrypto.SHA1@tok))

:named data_typing_intro_CoreCrypto.SHA1@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(22,4-22,7); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(22,4-22,7)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.MD5
CoreCrypto.hash_alg)
...
CoreCrypto.MD5
CoreCrypto.hash_alg))
:qid data_typing_intro_CoreCrypto.MD5@tok))

:named data_typing_intro_CoreCrypto.MD5@tok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= 101
(Term_constr_id CoreCrypto.hash_alg))
:named constructor_distinct_CoreCrypto.hash_alg))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= 117
(Term_constr_id CoreCrypto.SHA512))
:named constructor_distinct_CoreCrypto.SHA512))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= 115
(Term_constr_id CoreCrypto.SHA384))
:named constructor_distinct_CoreCrypto.SHA384))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= 113
(Term_constr_id CoreCrypto.SHA256))
:named constructor_distinct_CoreCrypto.SHA256))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= 111
(Term_constr_id CoreCrypto.SHA224))
:named constructor_distinct_CoreCrypto.SHA224))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= 109
(Term_constr_id CoreCrypto.SHA1))
:named constructor_distinct_CoreCrypto.SHA1))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! (= 107
(Term_constr_id CoreCrypto.MD5))
:named constructor_distinct_CoreCrypto.MD5))
;;;;;;;;;;;;;;;;Assumption: CoreCrypto.hash_alg__uu___haseq
;;; Fact-ids: Name CoreCrypto.hash_alg__uu___haseq; Namespace CoreCrypto
(assert (! (Valid (Prims.hasEq CoreCrypto.hash_alg))
:named assumption_CoreCrypto.hash_alg__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name CoreCrypto.hash_alg; Namespace CoreCrypto; Name CoreCrypto.MD5; Namespace CoreCrypto; Name CoreCrypto.SHA1; Namespace CoreCrypto; Name CoreCrypto.SHA224; Namespace CoreCrypto; Name CoreCrypto.SHA256; Namespace CoreCrypto; Name CoreCrypto.SHA384; Namespace CoreCrypto; Name CoreCrypto.SHA512; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(21,5-21,13); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(21,5-21,13)
...
@x0
CoreCrypto.hash_alg))
:qid CoreCrypto_pretyping_0f1d00019f8e373fb4b91c0d4de1eed6))

:named CoreCrypto_pretyping_0f1d00019f8e373fb4b91c0d4de1eed6))
(push) ;; push{2

; Starting query at SHA1.fst(38,13-38,24)
...
;   (*  - Could not prove post-condition
; *)
;   Platform.Bytes.length (CoreCrypto.hash CoreCrypto.SHA1 b) = CoreCrypto.hashSize CoreCrypto.SHA1 ==>
;   Platform.Bytes.length (CoreCrypto.hash CoreCrypto.SHA1 b) = 20


; Context: While encoding a query
; While typechecking the top-level declaration `let sha1`
...
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(38,56-38,79); use=SHA1.fst(38,13-38,24)
(= (Platform.Bytes.length (CoreCrypto.hash CoreCrypto.SHA1@tok
@x0))
(CoreCrypto.hashSize CoreCrypto.SHA1@tok))
)

;; def=SHA1.fst(37,33-37,46); use=SHA1.fst(38,13-38,24)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SHA1.sha1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, constructor_distinct_CoreCrypto.SHA1, equality_tok_CoreCrypto.SHA1@tok, equation_CoreCrypto.hashSize
...
; encoding sigelt let sha1


; <Start encoding let sha1>

(declare-fun SHA1.sha1 (Term) Term)
(declare-fun Tm_refine_1fdaea5dba31cb118cd950ae744b092d () Term)
;;;;;;;;;;;;;;;;b: Platform.Bytes.bytes -> h: Platform.Bytes.bytes{Platform.Bytes.length h = 20}
(declare-fun Tm_arrow_ecb28ce44825d640aa645e510fc14029 () Term)
(declare-fun SHA1.sha1@tok () Term)


; </end encoding let sha1>


; encoding sigelt val SHA1.hmac_sha1


; <Skipped val SHA1.hmac_sha1/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SHA1.text; Namespace SHA1
(assert (! (HasType SHA1.text
Tm_type)
:named typing_SHA1.text))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SHA1.key; Namespace SHA1
(assert (! (HasType SHA1.key
Tm_type)
:named typing_SHA1.key))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name SHA1.blocksize; Namespace SHA1
(assert (! 
;; def=SHA1.fst(28,4-28,13); use=SHA1.fst(28,4-28,13)
(forall ((@u0 Dummy_sort))
 (! (HasType (SHA1.blocksize @u0)
Prims.int)
 

:pattern ((SHA1.blocksize @u0))
:qid typing_SHA1.blocksize))

:named typing_SHA1.blocksize))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Platform.Bytes.xor; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(123,11-123,14); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(123,11-123,14)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
...
(HasType @x2
(Platform.Bytes.lbytes @x0)))
(HasType (Platform.Bytes.xor @x0
@x1
@x2)
(Platform.Bytes.lbytes @x0)))
 

:pattern ((Platform.Bytes.xor @x0
@x1
@x2))
:qid typing_Platform.Bytes.xor))

:named typing_Platform.Bytes.xor))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Platform.Bytes.repr_bytes; Namespace Platform.Bytes
(assert (! 
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Platform.Bytes.createBytes; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(112,4-112,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(112,4-112,15)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
(FStar.UInt8.t Dummy_value)))
(HasType (Platform.Bytes.createBytes @x0
@x1)
(Platform.Bytes.lbytes @x0)))
 

:pattern ((Platform.Bytes.createBytes @x0
@x1))
:qid typing_Platform.Bytes.createBytes))

:named typing_Platform.Bytes.createBytes))
;;;;;;;;;;;;;;;;free var typing
...
;;; Fact-ids: Name Platform.Bytes.byte_of_int; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(200,4-200,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(200,4-200,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_31c7d3d85d92cb942c95a78642e657c7)
(HasType (Platform.Bytes.byte_of_int @x0)
(FStar.UInt8.t Dummy_value)))
 

:pattern ((Platform.Bytes.byte_of_int @x0))
:qid typing_Platform.Bytes.byte_of_int))

:named typing_Platform.Bytes.byte_of_int))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name SHA1.sha1; Namespace SHA1
(assert (! (HasType Tm_refine_1fdaea5dba31cb118cd950ae744b092d
Tm_type)
:named refinement_kinding_Tm_refine_1fdaea5dba31cb118cd950ae744b092d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Platform.Bytes.bytes_of_int; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(172,35-172,59); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(172,35-172,59)
...
;;; Fact-ids: Name SHA1.sha1; Namespace SHA1
(assert (! 
;; def=SHA1.fst(37,24-37,48); use=SHA1.fst(38,4-38,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_1fdaea5dba31cb118cd950ae744b092d)
(and (HasTypeFuel @u0
@x1
Platform.Bytes.bytes)

;; def=SHA1.fst(37,33-37,46); use=SHA1.fst(38,4-38,8)
(= (Platform.Bytes.length @x1)
(BoxInt 20))
))
...
@x1
Tm_refine_1fdaea5dba31cb118cd950ae744b092d))
:qid refinement_interpretation_Tm_refine_1fdaea5dba31cb118cd950ae744b092d))

:named refinement_interpretation_Tm_refine_1fdaea5dba31cb118cd950ae744b092d))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_1fdaea5dba31cb118cd950ae744b092d
;;; Fact-ids: Name SHA1.sha1; Namespace SHA1
(assert (! (iff (Valid (Prims.hasEq Tm_refine_1fdaea5dba31cb118cd950ae744b092d))
(Valid (Prims.hasEq Platform.Bytes.bytes)))
:named haseqTm_refine_1fdaea5dba31cb118cd950ae744b092d))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name SHA1.text; Namespace SHA1
(assert (! (HasType SHA1.text
Tm_type)
:named function_token_typing_SHA1.text))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name SHA1.key; Namespace SHA1
(assert (! (HasType SHA1.key
Tm_type)
:named function_token_typing_SHA1.key))
;;;;;;;;;;;;;;;;Equation for SHA1.text
;;; Fact-ids: Name SHA1.text; Namespace SHA1
(assert (! (= SHA1.text
Platform.Bytes.bytes)
:named equation_SHA1.text))
;;;;;;;;;;;;;;;;Equation for SHA1.key
;;; Fact-ids: Name SHA1.key; Namespace SHA1
(assert (! (= SHA1.key
(Platform.Bytes.lbytes (SHA1.keysize Dummy_value)))
:named equation_SHA1.key))
;;;;;;;;;;;;;;;;Equation for SHA1.blocksize
;;; Fact-ids: Name SHA1.blocksize; Namespace SHA1
(assert (! 
;; def=SHA1.fst(28,4-28,13); use=SHA1.fst(28,4-28,13)
(forall ((@u0 Dummy_sort))
...
:qid equation_SHA1.blocksize))

:named equation_SHA1.blocksize))
;;;;;;;;;;;;;;;;Equation for Platform.Bytes.createBytes
;;; Fact-ids: Name Platform.Bytes.createBytes; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(112,4-112,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(112,4-112,15)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Platform.Bytes.createBytes @x0
@x1)
(FStar.Seq.Base.create (FStar.UInt8.t Dummy_value)
@x0
@x1))
...
:pattern ((Platform.Bytes.createBytes @x0
@x1))
:qid equation_Platform.Bytes.createBytes))

:named equation_Platform.Bytes.createBytes))
;;;;;;;;;;;;;;;;Equation for Platform.Bytes.byte_of_int
;;; Fact-ids: Name Platform.Bytes.byte_of_int; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(200,4-200,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(200,4-200,15)
(forall ((@x0 Term))
 (! (= (Platform.Bytes.byte_of_int @x0)
...
:pattern ((Platform.Bytes.byte_of_int @x0))
:qid equation_Platform.Bytes.byte_of_int))

:named equation_Platform.Bytes.byte_of_int))
(push) ;; push{2

; Starting query at SHA1.fst(41,19-50,8)
...
; Encoding query formula : forall (k: SHA1.key) (t: SHA1.text).
;   (*  - Could not prove post-condition
; *)
;   SHA1.blocksize >= 0 /\
;   (SHA1.blocksize >= 0) /\
;   (forall (any_result: Prims.int).
;       SHA1.blocksize == any_result ==>
;       (forall (any_result: Platform.Bytes.lbytes SHA1.blocksize).
;           Platform.Bytes.createBytes SHA1.blocksize (Platform.Bytes.byte_of_int 92) == any_result ==>
;           SHA1.blocksize >= 0 /\
;           (SHA1.blocksize >= 0) /\
;           (forall (any_result: Prims.int).
;               SHA1.blocksize == any_result ==>
;               (forall (any_result: Platform.Bytes.lbytes SHA1.blocksize).
;                   Platform.Bytes.createBytes SHA1.blocksize (Platform.Bytes.byte_of_int 54) ==
;                   any_result ==>
;                   SHA1.keysize >= 0 /\
;                   (SHA1.keysize >= 0) /\
;                   (forall (any_result: Prims.int).
;                       SHA1.keysize == any_result ==>
;                       (forall (any_result: Platform.Bytes.lbytes SHA1.keysize).
;                           Platform.Bytes.xor SHA1.keysize
;                             k
;                             (Platform.Bytes.createBytes SHA1.blocksize
;                                 (Platform.Bytes.byte_of_int 92)) ==
;                           any_result ==>
;                           SHA1.keysize >= 0 /\ SHA1.keysize >= 0))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let hmac_sha1`
...
;; def=Prims.fst(459,77-459,89); use=SHA1.fst(41,19-50,8)
(and 
;; def=Prims.fst(680,18-680,24); use=SHA1.fst(44,25-44,34)
(or label_1

;; def=Prims.fst(680,18-680,24); use=SHA1.fst(44,25-44,34)
(>= (BoxInt_proj_0 (SHA1.blocksize Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)
...
;; def=Prims.fst(451,66-451,102); use=SHA1.fst(41,19-50,8)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.int)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(111,18-111,19); use=SHA1.fst(41,19-50,8)
(= (SHA1.blocksize Dummy_value)
@x2)
)
...
(Platform.Bytes.lbytes (SHA1.blocksize Dummy_value)))

;; def=SHA1.fst(44,6-44,38); use=SHA1.fst(44,6-44,38)
(= (Platform.Bytes.createBytes (SHA1.blocksize Dummy_value)
(Platform.Bytes.byte_of_int (BoxInt 92)))
@x3)
)

;; def=Prims.fst(459,77-459,89); use=SHA1.fst(41,19-50,8)
(and 
;; def=Prims.fst(680,18-680,24); use=SHA1.fst(45,25-45,34)
(or label_3
...
;; def=SHA1.fst(45,6-45,38); use=SHA1.fst(45,6-45,38)
(= (Platform.Bytes.createBytes (SHA1.blocksize Dummy_value)
(Platform.Bytes.byte_of_int (BoxInt 54)))
@x5)
)

;; def=Prims.fst(459,77-459,89); use=SHA1.fst(41,19-50,8)
(and 
;; def=Prims.fst(680,18-680,24); use=SHA1.fst(46,25-46,32)
(or label_5
...
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(123,16-123,17); use=SHA1.fst(41,19-50,8)
(= (SHA1.keysize Dummy_value)
@x6)
)
...
;; def=SHA1.fst(46,6-46,39); use=SHA1.fst(46,6-46,39)
(= (Platform.Bytes.xor (SHA1.keysize Dummy_value)
@x0
(Platform.Bytes.createBytes (SHA1.blocksize Dummy_value)
(Platform.Bytes.byte_of_int (BoxInt 92))))
@x7)
...
;; def=Prims.fst(459,77-459,89); use=SHA1.fst(41,19-50,8)
(and 
;; def=Prims.fst(680,18-680,24); use=SHA1.fst(47,25-47,32)
(or label_7
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (SHA1.hmac_sha1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_SHA1.blocksize, equation_SHA1.keysize, projection_inverse_BoxInt_proj_0
