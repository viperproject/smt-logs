...
(declare-fun CntFormat.op_At_Bar (Term Term) Term)

(declare-fun CntFormat.op_At_Bar@tok () Term)
...
(declare-fun CntFormat.length (Term) Term)

(declare-fun CntFormat.length@tok () Term)
...
(declare-fun CntFormat.message () Term)
...
(declare-fun CntFormat.msg (Term) Term)

(declare-fun CntFormat.msg@tok () Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.op_At_Bar; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(25,4-25,13); use=CntFormat.fst(25,4-25,13)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Platform.Bytes.bytes)
(HasType @x1
Platform.Bytes.bytes))
(HasType (CntFormat.op_At_Bar @x0
@x1)
Platform.Bytes.bytes))
 

:pattern ((CntFormat.op_At_Bar @x0
@x1))
:qid typing_CntFormat.op_At_Bar))

:named typing_CntFormat.op_At_Bar))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.message; Namespace CntFormat
(assert (! (HasType CntFormat.message
Tm_type)
:named typing_CntFormat.message))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.length; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(26,4-26,10); use=CntFormat.fst(26,4-26,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Platform.Bytes.bytes)
(HasType (CntFormat.length @x0)
Prims.nat))
 

:pattern ((CntFormat.length @x0))
:qid typing_CntFormat.length))

:named typing_CntFormat.length))
...
(assert (! (HasType CntFormat.message
Tm_type)
:named function_token_typing_CntFormat.message))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.pair; Namespace Prims; Name Prims.Pair; Namespace Prims
(assert (! 
;; def=Prims.fst(183,5-183,9); use=Prims.fst(183,5-183,9)
...
;;;;;;;;;;;;;;;;Equation for CntFormat.op_At_Bar
;;; Fact-ids: Name CntFormat.op_At_Bar; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(25,4-25,13); use=CntFormat.fst(25,4-25,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (CntFormat.op_At_Bar @x0
@x1)
(Platform.Bytes.op_At_Bar @x0
@x1))
...
:pattern ((CntFormat.op_At_Bar @x0
@x1))
:qid equation_CntFormat.op_At_Bar))

:named equation_CntFormat.op_At_Bar))
;;;;;;;;;;;;;;;;Equation for CntFormat.message
;;; Fact-ids: Name CntFormat.message; Namespace CntFormat
(assert (! (= CntFormat.message
Platform.Bytes.bytes)
:named equation_CntFormat.message))
;;;;;;;;;;;;;;;;Equation for CntFormat.length
;;; Fact-ids: Name CntFormat.length; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(26,4-26,10); use=CntFormat.fst(26,4-26,10)
(forall ((@x0 Term))
...
:pattern ((CntFormat.length @x0))
:qid equation_CntFormat.length))

:named equation_CntFormat.length))
;;;;;;;;;;;;;;;;Eq2 interpretation
;;; Fact-ids: Name Prims.eq2; Namespace Prims
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (= @x1
...
; Starting query at CntFormat.fst(33,0-37,66)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_1f49bdb7ab79587517892adf231d17a1 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(35,38-35,98); use=CntFormat.fst(35,22-35,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_1f49bdb7ab79587517892adf231d17a1 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_1f49bdb7ab79587517892adf231d17a1 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_1f49bdb7ab79587517892adf231d17a1))

:named refinement_kinding_Tm_refine_1f49bdb7ab79587517892adf231d17a1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(35,38-35,98); use=CntFormat.fst(35,22-35,27)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_1f49bdb7ab79587517892adf231d17a1 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=CntFormat.fst(35,39-35,59); use=CntFormat.fst(35,22-35,27)
(= (CntFormat.length @x2)
(CntFormat.length @x3))


;; def=CntFormat.fst(35,63-35,97); use=CntFormat.fst(35,22-35,27)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(CntFormat.op_At_Bar @x2
@x4)
(CntFormat.op_At_Bar @x3
@x5)))
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_1f49bdb7ab79587517892adf231d17a1))

:named refinement_interpretation_Tm_refine_1f49bdb7ab79587517892adf231d17a1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1f49bdb7ab79587517892adf231d17a1
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(35,38-35,98); use=CntFormat.fst(35,22-35,27)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_1f49bdb7ab79587517892adf231d17a1 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.unit)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_1f49bdb7ab79587517892adf231d17a1 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_1f49bdb7ab79587517892adf231d17a1))

:named haseqTm_refine_1f49bdb7ab79587517892adf231d17a1))

; Encoding query formula : forall (b1: CntFormat.message)
;   (b2: CntFormat.message)
;   (c1: CntFormat.message)
;   (c2: CntFormat.message).
;   (CntFormat.length b1 == CntFormat.length c1 ==> Prims.hasEq FStar.UInt8.t) /\
;   (forall (any_result: Prims.logical).
;       (CntFormat.length b1 == CntFormat.length c1) /\ FStar.Seq.Base.eq (b1 @| b2) (c1 @| c2) ==
;       any_result ==>
;       (CntFormat.length b1 == CntFormat.length c1 ==> Prims.hasEq FStar.UInt8.t) /\
;       (forall (_:
;           Prims.squash (CntFormat.length b1 == CntFormat.length c1 /\
...
; While typechecking the top-level declaration `val CntFormat.append_inj_lemma`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=CntFormat.fst(33,0-37,66)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
CntFormat.message)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(33,25-37,66)
(and (implies 
;; def=CntFormat.fst(35,39-35,59); use=CntFormat.fst(35,39-35,59)
(= (CntFormat.length @x0)
(CntFormat.length @x2))
...
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(35,38-35,98)
(Valid 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(35,38-35,98)
...
;; def=Prims.fst(451,66-451,102); use=CntFormat.fst(33,25-37,66)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.logical)

;; def=FStar.Pervasives.fsti(112,28-112,31); use=CntFormat.fst(33,25-37,66)
...
;; def=dummy(0,0-0,0); use=CntFormat.fst(33,25-37,66)
(and (implies 
;; def=CntFormat.fst(35,39-35,59); use=CntFormat.fst(36,37-36,79)
(= (CntFormat.length @x0)
(CntFormat.length @x2))


;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(35,22-35,27)
(or label_2

;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(36,37-36,79)
(Valid 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(36,37-36,79)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Tm_refine_1f49bdb7ab79587517892adf231d17a1 @x0
@x2
@x1
@x3))

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(56,36-56,40); use=CntFormat.fst(36,37-36,79)
(and 
;; def=Prims.fst(73,23-73,30); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(56,36-56,40)
(or label_3
...
(implies 
;; def=CntFormat.fst(36,38-36,56); use=CntFormat.fst(36,38-36,56)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
@x0
@x2))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CntFormat.append_inj_lemma, 1)
; STATUS: unsat
...
; encoding sigelt val CntFormat.append_inj_lemma


; <Skipped val CntFormat.append_inj_lemma/>
...
; Starting query at CntFormat.fst(39,2-41,122)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(40,37-40,59); use=CntFormat.fst(40,37-40,59)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_9f88e160caa86d7bfa7040b8f45605e1))

:named refinement_kinding_Tm_refine_9f88e160caa86d7bfa7040b8f45605e1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(40,37-40,59); use=CntFormat.fst(40,37-40,59)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=CntFormat.fst(40,44-40,57); use=CntFormat.fst(40,44-40,57)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (CntFormat.length @x2)))
))
...
@x1
(Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x2)))
:qid refinement_interpretation_Tm_refine_9f88e160caa86d7bfa7040b8f45605e1))

:named refinement_interpretation_Tm_refine_9f88e160caa86d7bfa7040b8f45605e1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9f88e160caa86d7bfa7040b8f45605e1
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(40,37-40,59); use=CntFormat.fst(40,37-40,59)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x0))))
:qid haseqTm_refine_9f88e160caa86d7bfa7040b8f45605e1))

:named haseqTm_refine_9f88e160caa86d7bfa7040b8f45605e1))


;;;;;;;;;;;;;;;;_: i: Prims.nat{i < length b1} -> Prims.GTot Type
(declare-fun Tm_arrow_4b1a57d36eef332793dc4f985a90b77f (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4b1a57d36eef332793dc4f985a90b77f
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(40,37-40,59); use=CntFormat.fst(39,2-41,122)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_4b1a57d36eef332793dc4f985a90b77f @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_4b1a57d36eef332793dc4f985a90b77f @x0)
Tm_type))
:qid kinding_Tm_arrow_4b1a57d36eef332793dc4f985a90b77f))

:named kinding_Tm_arrow_4b1a57d36eef332793dc4f985a90b77f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(40,37-40,59); use=CntFormat.fst(39,2-41,122)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_4b1a57d36eef332793dc4f985a90b77f @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_4b1a57d36eef332793dc4f985a90b77f @x2)))
:qid CntFormat_pre_typing_Tm_arrow_4b1a57d36eef332793dc4f985a90b77f))

:named CntFormat_pre_typing_Tm_arrow_4b1a57d36eef332793dc4f985a90b77f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4b1a57d36eef332793dc4f985a90b77f
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(40,37-40,59); use=CntFormat.fst(39,2-41,122)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_4b1a57d36eef332793dc4f985a90b77f @x1))
(and 
;; def=CntFormat.fst(40,37-40,59); use=CntFormat.fst(39,2-41,122)
(forall ((@x2 Term))
 (! (implies (HasType @x2
(Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x1))
(HasType (ApplyTT @x0
@x2)
Tm_type))
...
:pattern ((ApplyTT @x0
@x2))
:qid CntFormat_interpretation_Tm_arrow_4b1a57d36eef332793dc4f985a90b77f.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_4b1a57d36eef332793dc4f985a90b77f @x1)))
:qid CntFormat_interpretation_Tm_arrow_4b1a57d36eef332793dc4f985a90b77f))

:named CntFormat_interpretation_Tm_arrow_4b1a57d36eef332793dc4f985a90b77f))
(declare-fun Tm_refine_4bb7a2db2ce06edcc796ff8082ea5d03 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(27,145-27,165); use=CntFormat.fst(39,2-41,122)
(forall ((@x0 Term))
...
;; def=FStar.Seq.Properties.fsti(27,151-27,164); use=CntFormat.fst(39,2-41,122)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x2)))
))
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(28,5-28,37); use=CntFormat.fst(39,2-41,122)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
...
;; def=Prims.fst(635,71-635,97); use=CntFormat.fst(39,2-41,122)
(not 
;; def=Prims.fst(441,29-441,97); use=CntFormat.fst(39,2-41,122)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=FStar.Seq.Properties.fsti(28,11-28,37); use=CntFormat.fst(39,2-41,122)
...
;; def=Prims.fst(635,86-635,95); use=CntFormat.fst(39,2-41,122)
(not 
;; def=Prims.fst(635,86-635,95); use=CntFormat.fst(39,2-41,122)
(= @x5
@x1)
...
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Properties.fsti(27,145-28,37); use=CntFormat.fst(39,2-41,122)
(forall ((@x0 Term) (@x1 Term))
...
(Tm_arrow_f3409bd47bd8772f2e34e01e5f006008 @x2
@x3)))
:qid CntFormat_pre_typing_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008))

:named CntFormat_pre_typing_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008))
...
:pattern ((ApplyTT @x0
@x3))
:qid CntFormat_interpretation_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008.1))
...
(Tm_arrow_f3409bd47bd8772f2e34e01e5f006008 @x1
@x2)))
:qid CntFormat_interpretation_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008))

:named CntFormat_interpretation_Tm_arrow_f3409bd47bd8772f2e34e01e5f006008))
...
(declare-fun Tm_abs_154e402690e4087d46def876f47ac786 (Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_154e402690e4087d46def876f47ac786
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(41,64-41,88); use=CntFormat.fst(41,64-41,88)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_abs_154e402690e4087d46def876f47ac786 @x0
@x1)
(Tm_arrow_4b1a57d36eef332793dc4f985a90b77f @x1))
 

:pattern ((Tm_abs_154e402690e4087d46def876f47ac786 @x0
@x1))
:qid typing_Tm_abs_154e402690e4087d46def876f47ac786))

:named typing_Tm_abs_154e402690e4087d46def876f47ac786))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_154e402690e4087d46def876f47ac786
;;; Fact-ids: 
(assert (! 
;; def=CntFormat.fst(41,64-41,88); use=CntFormat.fst(41,64-41,88)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (Tm_abs_154e402690e4087d46def876f47ac786 @x1
@x2)
@x0)
...
:pattern ((ApplyTT (Tm_abs_154e402690e4087d46def876f47ac786 @x1
@x2)
@x0))
:qid interpretation_Tm_abs_154e402690e4087d46def876f47ac786))

:named interpretation_Tm_abs_154e402690e4087d46def876f47ac786))
...
;     (forall (any_result: CntFormat.message).
;         c2 == any_result ==>
;         (forall (pure_result: Prims.unit).
;             FStar.Seq.Base.length b1 = FStar.Seq.Base.length c1 /\
;             FStar.Seq.Base.length b2 = FStar.Seq.Base.length c2 ==>
;             (forall (x: i: Prims.nat{i < CntFormat.length b1}).
;                 (*  - Could not prove post-condition
; *)
;                 (x < CntFormat.length b1 ==> x < FStar.Seq.Base.length b1) /\
;                 (forall (any_result: i: Prims.nat{i < CntFormat.length b1}).
;                     x == any_result ==>
;                     (forall (any_result: FStar.UInt8.t).
;                         FStar.Seq.Base.index b1 x == any_result ==>
;                         x < CntFormat.length b1 ==> x < FStar.Seq.Base.length c1))) /\
;             (forall (any_result: (_: i: Prims.nat{i < CntFormat.length b1} -> Prims.GTot Type0)).
...
;                         (forall (x: i: Prims.nat{i < CntFormat.length b2}).
;                             (*  - Could not prove post-condition
; *)
;                             (x < CntFormat.length b2 ==> x < FStar.Seq.Base.length b2) /\
;                             (forall (any_result: i: Prims.nat{i < CntFormat.length b2}).
;                                 x == any_result ==>
;                                 (forall (any_result: FStar.UInt8.t).
;                                     FStar.Seq.Base.index b2 x == any_result ==>
;                                     x < CntFormat.length b2 ==> x < FStar.Seq.Base.length c2))) /\
;                         (forall (any_result:
;                             (_: i: Prims.nat{i < CntFormat.length b2} -> Prims.GTot Type0)).
...
;; def=CntFormat.fst(35,39-35,59); use=CntFormat.fst(39,2-41,122)
(= (CntFormat.length @x0)
(CntFormat.length @x2))


;; def=CntFormat.fst(35,63-35,97); use=CntFormat.fst(39,2-41,122)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(CntFormat.op_At_Bar @x0
@x1)
(CntFormat.op_At_Bar @x2
...
;; def=Prims.fst(441,36-441,97); use=CntFormat.fst(39,2-41,122)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=CntFormat.fst(36,38-36,56); use=CntFormat.fst(39,2-41,122)
(or label_2
...
;; def=CntFormat.fst(36,60-36,78); use=CntFormat.fst(39,2-41,122)
(or label_3
...
;; def=Prims.fst(441,83-441,96); use=CntFormat.fst(39,2-41,122)
(Valid 
;; def=Prims.fst(441,83-441,96); use=CntFormat.fst(39,2-41,122)
(ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(39,2-41,122)
(and 
;; def=FStar.Seq.Properties.fsti(33,84-33,132); use=CntFormat.fst(39,33-39,35)
(or label_4

;; def=FStar.Seq.Properties.fsti(33,85-33,106); use=CntFormat.fst(39,33-39,35)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x0)
(FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x2))
...
;; def=FStar.Seq.Properties.fsti(33,110-33,131); use=CntFormat.fst(39,33-39,35)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x1)
(FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x3))
...
;; def=FStar.Seq.Properties.fsti(33,136-33,173); use=CntFormat.fst(39,33-39,35)
(or label_5
...
;; def=Prims.fst(451,66-451,102); use=CntFormat.fst(39,2-41,122)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
CntFormat.message)

;; def=FStar.Seq.Properties.fsti(33,74-33,76); use=CntFormat.fst(39,2-41,122)
(= @x3
@x5)
)

;; def=Prims.fst(441,36-441,97); use=CntFormat.fst(39,2-39,23)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=FStar.Seq.Properties.fsti(34,21-34,42); use=CntFormat.fst(39,2-39,23)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x0)
(FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x2))
...
;; def=FStar.Seq.Properties.fsti(34,46-34,67); use=CntFormat.fst(39,2-39,23)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x1)
(FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x3))
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(39,2-41,122)
(and 
;; def=dummy(0,0-0,0); use=CntFormat.fst(39,2-41,122)
(forall ((@x7 Term))
 (! (implies (HasType @x7
(Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x0))

;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(40,64-40,88)
(and (implies 
;; def=CntFormat.fst(40,44-40,57); use=CntFormat.fst(40,73-40,74)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (CntFormat.length @x0)))


;; def=FStar.Seq.Base.fsti(32,40-32,52); use=CntFormat.fst(40,73-40,74)
(or label_6
...
;; def=Prims.fst(451,66-451,102); use=CntFormat.fst(40,64-40,88)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x0))

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=CntFormat.fst(40,64-40,88)
(= @x7
@x8)
)
...
;; def=Prims.fst(175,35-175,36); use=CntFormat.fst(40,64-40,88)
(= (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
@x0
@x7)
@x9)
...
;; def=CntFormat.fst(40,44-40,57); use=CntFormat.fst(40,87-40,88)
(< (BoxInt_proj_0 @x7)
(BoxInt_proj_0 (CntFormat.length @x0)))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=CntFormat.fst(40,87-40,88)
(or label_7
...
(Tm_arrow_4b1a57d36eef332793dc4f985a90b77f @x0))

;; def=FStar.Classical.fsti(240,30-240,31); use=CntFormat.fst(39,2-41,122)
(= (Tm_abs_154e402690e4087d46def876f47ac786 @x2
@x0)
@x7)
)
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(39,2-41,122)
(and 
;; def=FStar.Seq.Properties.fsti(27,80-27,101); use=CntFormat.fst(40,119-40,121)
(or label_8
...
;; def=FStar.Seq.Properties.fsti(27,105-27,140); use=CntFormat.fst(40,119-40,121)
(or label_9
...
;; def=FStar.Seq.Properties.fsti(27,71-27,73); use=CntFormat.fst(39,2-41,122)
(= @x3
@x8)
)
...
;; def=Prims.fst(441,36-441,97); use=CntFormat.fst(40,12-40,24)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=FStar.Classical.fsti(241,12-241,32); use=CntFormat.fst(40,12-40,24)
(forall ((@x11 Term))
 (! (implies (HasType @x11
(Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x0))

;; def=CntFormat.fst(40,64-40,88); use=CntFormat.fst(40,12-40,24)
(= (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
@x0
@x11)
(FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(41,64-41,88)
(and (implies 
;; def=CntFormat.fst(41,44-41,57); use=CntFormat.fst(41,73-41,74)
(< (BoxInt_proj_0 @x11)
(BoxInt_proj_0 (CntFormat.length @x1)))


;; def=FStar.Seq.Base.fsti(32,40-32,52); use=CntFormat.fst(41,73-41,74)
(or label_10
...
;; def=Prims.fst(451,66-451,102); use=CntFormat.fst(41,64-41,88)
(forall ((@x12 Term))
 (! (implies (and (HasType @x12
(Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x1))

;; def=FStar.Seq.Base.fsti(32,34-32,35); use=CntFormat.fst(41,64-41,88)
(= @x11
@x12)
)
...
;; def=Prims.fst(175,35-175,36); use=CntFormat.fst(41,64-41,88)
(= (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
@x1
@x11)
@x13)
...
;; def=CntFormat.fst(41,44-41,57); use=CntFormat.fst(41,87-41,88)
(< (BoxInt_proj_0 @x11)
(BoxInt_proj_0 (CntFormat.length @x1)))
)

;; def=FStar.Seq.Base.fsti(32,40-32,52); use=CntFormat.fst(41,87-41,88)
(or label_11
...
;; def=FStar.Classical.fsti(240,30-240,31); use=CntFormat.fst(39,2-41,122)
(= (Tm_abs_154e402690e4087d46def876f47ac786 @x3
@x1)
@x11)
)
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(39,2-41,122)
(and 
;; def=FStar.Seq.Properties.fsti(30,80-30,101); use=CntFormat.fst(41,119-41,121)
(or label_12
...
;; def=FStar.Seq.Properties.fsti(30,105-30,126); use=CntFormat.fst(41,119-41,121)
(or label_13
...
;; def=FStar.Seq.Properties.fsti(30,130-30,165); use=CntFormat.fst(41,119-41,121)
(or label_14
...
;; def=FStar.Seq.Properties.fsti(30,71-30,73); use=CntFormat.fst(39,2-41,122)
(= @x3
@x12)
)
...
;; def=Prims.fst(441,36-441,97); use=CntFormat.fst(41,12-41,24)
(forall ((@x14 Term))
 (! (implies (and (HasType @x14
Prims.unit)

;; def=FStar.Classical.fsti(241,12-241,32); use=CntFormat.fst(41,12-41,24)
(forall ((@x15 Term))
 (! (implies (HasType @x15
(Tm_refine_9f88e160caa86d7bfa7040b8f45605e1 @x1))

;; def=CntFormat.fst(41,64-41,88); use=CntFormat.fst(41,12-41,24)
(= (FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
@x1
@x15)
(FStar.Seq.Base.index (FStar.UInt8.t Dummy_value)
...
;; def=Prims.fst(441,83-441,96); use=CntFormat.fst(41,12-41,24)
(Valid 
;; def=Prims.fst(441,83-441,96); use=CntFormat.fst(41,12-41,24)
(ApplyTT @x4
@x14)
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CntFormat.append_inj_lemma (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CntFormat.append_inj_lemma@tok () Term)

; </end encoding let append_inj_lemma>


; encoding sigelt let uint


; <Start encoding let uint>

(declare-fun CntFormat.uint () Term)
(declare-fun Tm_refine_85b54e4e87b0b83fa21a3f3d39639d39 () Term)

; </end encoding let uint>


; encoding sigelt let pint


; <Start encoding let pint>

(declare-fun CntFormat.pint () Term)
(declare-fun Tm_refine_aa17075f57b2d0929720203c7019d3bb () Term)

; </end encoding let pint>
...
(declare-fun CntFormat.uint16 () Term)
(declare-fun Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27 () Term)

; </end encoding let uint16>


; encoding sigelt let uint32


; <Start encoding let uint32>

(declare-fun CntFormat.uint32 () Term)
(declare-fun Tm_refine_92ae293f6e4cd7fc83170fef96182afc () Term)
...
(declare-fun CntFormat.uint16_to_bytes (Term) Term)

;;;;;;;;;;;;;;;;n: Prims.nat{Platform.Bytes.repr_bytes n <= 2} -> Platform.Bytes.lbytes 2
(declare-fun Tm_arrow_7cecb2638d4903eb9a3774667b47a84a () Term)
(declare-fun CntFormat.uint16_to_bytes@tok () Term)


; </end encoding let uint16_to_bytes>


; encoding sigelt let uint32_to_bytes


; <Start encoding let uint32_to_bytes>


(declare-fun CntFormat.uint32_to_bytes (Term) Term)

;;;;;;;;;;;;;;;;n: Prims.nat{Platform.Bytes.repr_bytes n <= 4} -> Platform.Bytes.lbytes 4
(declare-fun Tm_arrow_607aaf85c91b24804e28764649776f3b () Term)
(declare-fun CntFormat.uint32_to_bytes@tok () Term)


; </end encoding let uint32_to_bytes>


; encoding sigelt let bytes_to_uint16


; <Start encoding let bytes_to_uint16>

(declare-fun CntFormat.bytes_to_uint16 (Term) Term)

;;;;;;;;;;;;;;;;x: msg 2   -> n:     Prims.nat       { Platform.Bytes.repr_bytes n <= FStar.Seq.Base.length x /\         (FStar.Seq.Base.length x = 1 ==> n < 256) /\         x = Platform.Bytes.bytes_of_int (FStar.Seq.Base.length x) n }
(declare-fun Tm_arrow_92bfac97dd7043576c0ba0a2c20846b2 () Term)
(declare-fun CntFormat.bytes_to_uint16@tok () Term)


; </end encoding let bytes_to_uint16>


; encoding sigelt let bytes_to_uint32


; <Start encoding let bytes_to_uint32>

(declare-fun CntFormat.bytes_to_uint32 (Term) Term)

;;;;;;;;;;;;;;;;x: msg 4   -> n:     Prims.nat       { Platform.Bytes.repr_bytes n <= FStar.Seq.Base.length x /\         (FStar.Seq.Base.length x = 1 ==> n < 256) /\         x = Platform.Bytes.bytes_of_int (FStar.Seq.Base.length x) n }
(declare-fun Tm_arrow_d92315cfcd83e95069eae23b9bc719f1 () Term)
(declare-fun CntFormat.bytes_to_uint32@tok () Term)


; </end encoding let bytes_to_uint32>
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CntFormat.pint; Namespace CntFormat
(assert (! (HasType Tm_refine_aa17075f57b2d0929720203c7019d3bb
Tm_type)
:named refinement_kinding_Tm_refine_aa17075f57b2d0929720203c7019d3bb))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CntFormat.uint32; Namespace CntFormat
(assert (! (HasType Tm_refine_92ae293f6e4cd7fc83170fef96182afc
Tm_type)
:named refinement_kinding_Tm_refine_92ae293f6e4cd7fc83170fef96182afc))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CntFormat.uint; Namespace CntFormat
(assert (! (HasType Tm_refine_85b54e4e87b0b83fa21a3f3d39639d39
Tm_type)
:named refinement_kinding_Tm_refine_85b54e4e87b0b83fa21a3f3d39639d39))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CntFormat.uint16; Namespace CntFormat
(assert (! (HasType Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27
Tm_type)
:named refinement_kinding_Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name CntFormat.pint; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(47,12-47,25); use=CntFormat.fst(47,12-47,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_aa17075f57b2d0929720203c7019d3bb)
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=CntFormat.fst(47,18-47,24); use=CntFormat.fst(47,18-47,24)
...
@x1
Tm_refine_aa17075f57b2d0929720203c7019d3bb))
:qid refinement_interpretation_Tm_refine_aa17075f57b2d0929720203c7019d3bb))

:named refinement_interpretation_Tm_refine_aa17075f57b2d0929720203c7019d3bb))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name CntFormat.uint32; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(50,14-50,44); use=CntFormat.fst(50,14-50,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_92ae293f6e4cd7fc83170fef96182afc)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=CntFormat.fst(50,20-50,43); use=CntFormat.fst(50,20-50,43)
...
@x1
Tm_refine_92ae293f6e4cd7fc83170fef96182afc))
:qid refinement_interpretation_Tm_refine_92ae293f6e4cd7fc83170fef96182afc))

:named refinement_interpretation_Tm_refine_92ae293f6e4cd7fc83170fef96182afc))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name CntFormat.uint; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(46,12-46,25); use=CntFormat.fst(46,12-46,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_85b54e4e87b0b83fa21a3f3d39639d39)
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=CntFormat.fst(46,18-46,24); use=CntFormat.fst(46,18-46,24)
(<= (BoxInt_proj_0 (BoxInt 0))
(BoxInt_proj_0 @x1))
))
...
@x1
Tm_refine_85b54e4e87b0b83fa21a3f3d39639d39))
:qid refinement_interpretation_Tm_refine_85b54e4e87b0b83fa21a3f3d39639d39))

:named refinement_interpretation_Tm_refine_85b54e4e87b0b83fa21a3f3d39639d39))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name CntFormat.uint16; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(49,14-49,44); use=CntFormat.fst(49,14-49,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=CntFormat.fst(49,20-49,43); use=CntFormat.fst(49,20-49,43)
(<= (BoxInt_proj_0 (Platform.Bytes.repr_bytes @x1))
(BoxInt_proj_0 (BoxInt 2)))
))
...
@x1
Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27))
:qid refinement_interpretation_Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27))

:named refinement_interpretation_Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27))
;;;;;;;;;;;;;;;;haseq for Tm_refine_aa17075f57b2d0929720203c7019d3bb
;;; Fact-ids: Name CntFormat.pint; Namespace CntFormat
(assert (! (iff (Valid (Prims.hasEq Tm_refine_aa17075f57b2d0929720203c7019d3bb))
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_aa17075f57b2d0929720203c7019d3bb))
;;;;;;;;;;;;;;;;haseq for Tm_refine_92ae293f6e4cd7fc83170fef96182afc
;;; Fact-ids: Name CntFormat.uint32; Namespace CntFormat
(assert (! (iff (Valid (Prims.hasEq Tm_refine_92ae293f6e4cd7fc83170fef96182afc))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_92ae293f6e4cd7fc83170fef96182afc))
;;;;;;;;;;;;;;;;haseq for Tm_refine_85b54e4e87b0b83fa21a3f3d39639d39
;;; Fact-ids: Name CntFormat.uint; Namespace CntFormat
(assert (! (iff (Valid (Prims.hasEq Tm_refine_85b54e4e87b0b83fa21a3f3d39639d39))
(Valid (Prims.hasEq Prims.int)))
:named haseqTm_refine_85b54e4e87b0b83fa21a3f3d39639d39))
;;;;;;;;;;;;;;;;haseq for Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27
;;; Fact-ids: Name CntFormat.uint16; Namespace CntFormat
(assert (! (iff (Valid (Prims.hasEq Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_75aaae859fab93cdc6b9fa05a2e66b27))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.string; Namespace Prims
(assert (! (HasType Prims.string
Prims.eqtype)
...
; Starting query at CntFormat.fst(72,0-74,62)
...
; Context: While encoding a query
; While typechecking the top-level declaration `assume CntFormat.UTF8_inj`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=CntFormat.fst(72,0-74,62)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.string)

;; def=dummy(0,0-0,0); use=CntFormat.fst(73,12-74,62)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.string)
...
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(74,5-74,62)
(Valid 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(74,5-74,62)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
; encoding sigelt assume CntFormat.UTF8_inj


; <Start encoding assume CntFormat.UTF8_inj>


; </end encoding assume CntFormat.UTF8_inj>
...
(declare-fun CntFormat.string16 () Term)
(declare-fun Tm_refine_1ed200b6affe2db07bfbf96ff8436cc6 () Term)

; </end encoding let string16>


; encoding sigelt val CntFormat.request


; <Skipped val CntFormat.request/>


; encoding sigelt val CntFormat.response


; <Skipped val CntFormat.response/>
...
(declare-fun CntFormat.tag0 (Dummy_sort) Term)
...
(declare-fun CntFormat.tag1 (Dummy_sort) Term)

; </end encoding let tag1>


; encoding sigelt let tag2


; <Start encoding let tag2>

(declare-fun CntFormat.tag2 (Dummy_sort) Term)

; </end encoding let tag2>
...
(declare-fun CntFormat.request (Term) Term)
;;;;;;;;;;;;;;;;s: Prims.string -> message
(declare-fun Tm_arrow_1e7de424760f606e032f513cd22f1c4e () Term)
(declare-fun CntFormat.request@tok () Term)
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CntFormat.string16; Namespace CntFormat
(assert (! (HasType Tm_refine_1ed200b6affe2db07bfbf96ff8436cc6
Tm_type)
:named refinement_kinding_Tm_refine_1ed200b6affe2db07bfbf96ff8436cc6))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name CntFormat.string16; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(76,16-76,71); use=CntFormat.fst(76,16-76,71)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_1ed200b6affe2db07bfbf96ff8436cc6)
(and (HasTypeFuel @u0
@x1
Prims.string)

;; def=CntFormat.fst(76,25-76,70); use=CntFormat.fst(76,25-76,70)
(<= (BoxInt_proj_0 (Platform.Bytes.repr_bytes (CntFormat.length (Platform.Bytes.utf8 @x1))))
(BoxInt_proj_0 (BoxInt 2)))
))
...
@x1
Tm_refine_1ed200b6affe2db07bfbf96ff8436cc6))
:qid refinement_interpretation_Tm_refine_1ed200b6affe2db07bfbf96ff8436cc6))

:named refinement_interpretation_Tm_refine_1ed200b6affe2db07bfbf96ff8436cc6))
;;;;;;;;;;;;;;;;haseq for Tm_refine_1ed200b6affe2db07bfbf96ff8436cc6
;;; Fact-ids: Name CntFormat.string16; Namespace CntFormat
(assert (! (iff (Valid (Prims.hasEq Tm_refine_1ed200b6affe2db07bfbf96ff8436cc6))
(Valid (Prims.hasEq Prims.string)))
:named haseqTm_refine_1ed200b6affe2db07bfbf96ff8436cc6))
;;;;;;;;;;;;;;;;Assumption: CntFormat.UTF8_inj
;;; Fact-ids: Name CntFormat.UTF8_inj; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(73,2-74,62); use=CntFormat.fst(73,2-74,62)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.string)
(HasType @x1
...
;; def=CntFormat.fst(74,5-74,51); use=CntFormat.fst(74,5-74,51)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(Platform.Bytes.utf8 @x0)
(Platform.Bytes.utf8 @x1)))
)

;; def=CntFormat.fst(74,56-74,62); use=CntFormat.fst(74,56-74,62)
(= @x0
@x1)
)
...
:qid assumption_CntFormat.UTF8_inj))

:named assumption_CntFormat.UTF8_inj))
(push) ;; push{2

; Starting query at CntFormat.fst(92,18-94,53)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (s: Prims.string{Platform.Bytes.repr_bytes (CntFormat.length (Platform.Bytes.utf8 s)) <= 2})
;   (t: Prims.string).
;   (*  - Could not prove post-condition
; *)
;   Platform.Bytes.repr_bytes (CntFormat.length (Platform.Bytes.utf8 s)) <= 2
...
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(172,41-172,58); use=CntFormat.fst(93,27-93,50)
(or label_1

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(172,41-172,58); use=CntFormat.fst(93,27-93,50)
(<= (BoxInt_proj_0 (Platform.Bytes.repr_bytes (CntFormat.length (Platform.Bytes.utf8 @x0))))
(BoxInt_proj_0 (BoxInt 2)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CntFormat.response, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_1ed200b6affe2db07bfbf96ff8436cc6
...
(declare-fun CntFormat.response (Term Term) Term)

;;;;;;;;;;;;;;;;s: Prims.string{Platform.Bytes.repr_bytes (length (Platform.Bytes.utf8 s)) <= 2} -> t: Prims.string   -> message
(declare-fun Tm_arrow_7bd6dba441eec323950af87fa99e1ce6 () Term)
(declare-fun CntFormat.response@tok () Term)


; </end encoding let response>


; encoding sigelt val CntFormat.signal_size


; <Skipped val CntFormat.signal_size/>


; encoding sigelt let signal_size


; <Start encoding let signal_size>

(declare-fun CntFormat.signal_size (Dummy_sort) Term)

; </end encoding let signal_size>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.uint32; Namespace CntFormat
(assert (! (HasType CntFormat.uint32
Tm_type)
:named typing_CntFormat.uint32))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.uint16; Namespace CntFormat
(assert (! (HasType CntFormat.uint16
Tm_type)
:named typing_CntFormat.uint16))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.signal_size; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(97,4-97,15); use=CntFormat.fst(97,4-97,15)
(forall ((@u0 Dummy_sort))
 (! (HasType (CntFormat.signal_size @u0)
Prims.int)
 

:pattern ((CntFormat.signal_size @u0))
:qid typing_CntFormat.signal_size))

:named typing_CntFormat.signal_size))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name CntFormat.uint32; Namespace CntFormat
(assert (! (HasType CntFormat.uint32
Tm_type)
:named function_token_typing_CntFormat.uint32))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name CntFormat.uint16; Namespace CntFormat
(assert (! (HasType CntFormat.uint16
Tm_type)
:named function_token_typing_CntFormat.uint16))
;;;;;;;;;;;;;;;;Equation for CntFormat.uint32
;;; Fact-ids: Name CntFormat.uint32; Namespace CntFormat
(assert (! (= CntFormat.uint32
Tm_refine_92ae293f6e4cd7fc83170fef96182afc)
:named equation_CntFormat.uint32))
;;;;;;;;;;;;;;;;Equation for CntFormat.uint16
;;; Fact-ids: Name CntFormat.uint16; Namespace CntFormat
(assert (! (= CntFormat.uint16
Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27)
:named equation_CntFormat.uint16))
;;;;;;;;;;;;;;;;Equation for CntFormat.signal_size
;;; Fact-ids: Name CntFormat.signal_size; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(97,4-97,15); use=CntFormat.fst(97,4-97,15)
(forall ((@u0 Dummy_sort))
...
:qid equation_CntFormat.signal_size))

:named equation_CntFormat.signal_size))
(push) ;; push{2

; Starting query at CntFormat.fst(99,0-99,54)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (_: CntFormat.uint32) (_: CntFormat.uint16).
;   (*  - Subtyping check failed
;   - Expected type Prims.nat got type Prims.int
; *)
;   CntFormat.signal_size >= 0


; Context: While encoding a query
; While typechecking the top-level declaration `val CntFormat.signal`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=CntFormat.fst(99,0-99,54)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
CntFormat.uint32)
(HasType @x1
...
;; def=Prims.fst(680,18-680,24); use=CntFormat.fst(99,42-99,53)
(or label_1

;; def=Prims.fst(680,18-680,24); use=CntFormat.fst(99,42-99,53)
(>= (BoxInt_proj_0 (CntFormat.signal_size Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CntFormat.signal, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_CntFormat.signal_size, projection_inverse_BoxInt_proj_0
...
; encoding sigelt val CntFormat.signal


; <Skipped val CntFormat.signal/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.uint32_to_bytes; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(68,4-68,19); use=CntFormat.fst(68,4-68,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_92ae293f6e4cd7fc83170fef96182afc)
(HasType (CntFormat.uint32_to_bytes @x0)
(Platform.Bytes.lbytes (BoxInt 4))))
 

:pattern ((CntFormat.uint32_to_bytes @x0))
:qid typing_CntFormat.uint32_to_bytes))

:named typing_CntFormat.uint32_to_bytes))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.uint16_to_bytes; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(67,4-67,19); use=CntFormat.fst(67,4-67,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_75aaae859fab93cdc6b9fa05a2e66b27)
(HasType (CntFormat.uint16_to_bytes @x0)
(Platform.Bytes.lbytes (BoxInt 2))))
 

:pattern ((CntFormat.uint16_to_bytes @x0))
:qid typing_CntFormat.uint16_to_bytes))

:named typing_CntFormat.uint16_to_bytes))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Platform.Bytes.bytes_of_int; Namespace Platform.Bytes
(assert (! 
...
;;;;;;;;;;;;;;;;Lemma: CntFormat.append_inj_lemma
;;; Fact-ids: Name CntFormat.append_inj_lemma; Namespace CntFormat
(assert (! (forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
CntFormat.message)
(HasType @x1
...
;; def=CntFormat.fst(35,39-35,59); use=CntFormat.fst(38,4-38,20)
(= (CntFormat.length @x0)
(CntFormat.length @x2))


;; def=CntFormat.fst(35,63-35,97); use=CntFormat.fst(38,4-38,20)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(CntFormat.op_At_Bar @x0
@x1)
(CntFormat.op_At_Bar @x2
...
;; def=CntFormat.fst(36,37-36,79); use=CntFormat.fst(38,4-38,20)
(and 
;; def=CntFormat.fst(36,38-36,56); use=CntFormat.fst(38,4-38,20)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
@x0
@x2))


;; def=CntFormat.fst(36,60-36,78); use=CntFormat.fst(38,4-38,20)
(BoxBool_proj_0 (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
@x1
@x3))
)
...
:pattern ((CntFormat.op_At_Bar @x0
@x1) (CntFormat.op_At_Bar @x2
@x3))
:qid lemma_CntFormat.append_inj_lemma))
:named lemma_CntFormat.append_inj_lemma))
...
;;;;;;;;;;;;;;;;Equation for CntFormat.uint32_to_bytes
;;; Fact-ids: Name CntFormat.uint32_to_bytes; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(68,4-68,19); use=CntFormat.fst(68,4-68,19)
(forall ((@x0 Term))
 (! (= (CntFormat.uint32_to_bytes @x0)
(Platform.Bytes.bytes_of_int (BoxInt 4)
@x0))
 

:pattern ((CntFormat.uint32_to_bytes @x0))
:qid equation_CntFormat.uint32_to_bytes))

:named equation_CntFormat.uint32_to_bytes))
;;;;;;;;;;;;;;;;Equation for CntFormat.uint16_to_bytes
;;; Fact-ids: Name CntFormat.uint16_to_bytes; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(67,4-67,19); use=CntFormat.fst(67,4-67,19)
(forall ((@x0 Term))
 (! (= (CntFormat.uint16_to_bytes @x0)
(Platform.Bytes.bytes_of_int (BoxInt 2)
@x0))
 

:pattern ((CntFormat.uint16_to_bytes @x0))
:qid equation_CntFormat.uint16_to_bytes))

:named equation_CntFormat.uint16_to_bytes))
(push) ;; push{2

; Starting query at CntFormat.fst(100,16-103,14)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (s: CntFormat.uint32) (c: CntFormat.uint16).
;   (*  - Could not prove post-condition
; *)
;   Platform.Bytes.length (CntFormat.uint32_to_bytes s @| CntFormat.uint16_to_bytes c) =
;   CntFormat.signal_size


; Context: While encoding a query
; While typechecking the top-level declaration `let signal`
...
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,30-74,42); use=CntFormat.fst(103,2-103,14)
(or label_1

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,30-74,42); use=CntFormat.fst(103,2-103,14)
(= (Platform.Bytes.length (CntFormat.op_At_Bar (CntFormat.uint32_to_bytes @x0)
(CntFormat.uint16_to_bytes @x1)))
(CntFormat.signal_size Dummy_value))
)
)
...
; encoding sigelt let signal


; <Start encoding let signal>

(declare-fun CntFormat.signal (Term Term) Term)
;;;;;;;;;;;;;;;;s: uint32 -> c: uint16 -> msg signal_size
(declare-fun Tm_arrow_7871db519f021a4911dba2e234e7702a () Term)
(declare-fun CntFormat.signal@tok () Term)

; </end encoding let signal>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.msg; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(29,5-29,8); use=CntFormat.fst(29,5-29,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (CntFormat.msg @x0)
Tm_type))
 

:pattern ((CntFormat.msg @x0))
:qid typing_CntFormat.msg))

:named typing_CntFormat.msg))
;;;;;;;;;;;;;;;;name-token correspondence
...
:pattern ((CntFormat.msg @x0))
:qid equation_CntFormat.msg))

:named equation_CntFormat.msg))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,22-59,30); use=FStar.Pervasives.Native.fst(59,22-59,30)
...
; Starting query at CntFormat.fst(105,0-106,34)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : CntFormat.signal_size >= 0 /\
; (forall (m: CntFormat.msg CntFormat.signal_size).
;     (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;     forall (x: CntFormat.uint32 & CntFormat.uint16).
;       CntFormat.signal_size >= 0 /\
;       (forall (any_result: Prims.int).
;           CntFormat.signal_size == any_result ==>
;           (forall (any_result: Type0).
;               CntFormat.msg CntFormat.signal_size == any_result ==>
;               Prims.hasEq (CntFormat.msg CntFormat.signal_size))))


; Context: While encoding a query
; While typechecking the top-level declaration `val CntFormat.signal_split`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=CntFormat.fst(105,0-106,34)
(and 
;; def=Prims.fst(680,18-680,24); use=CntFormat.fst(105,25-105,36)
(or label_1
...
(forall ((@x0 Term))
 (! (implies (HasType @x0
(CntFormat.msg (CntFormat.signal_size Dummy_value)))

;; def=dummy(0,0-0,0); use=CntFormat.fst(105,21-106,34)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.Pervasives.Native.tuple2 CntFormat.uint32
CntFormat.uint16))

;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(105,44-106,34)
(and 
;; def=Prims.fst(680,18-680,24); use=CntFormat.fst(106,6-106,7)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=CntFormat.fst(105,44-106,34)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.int)

;; def=CntFormat.fst(29,10-105,36); use=CntFormat.fst(105,44-106,34)
(= (CntFormat.signal_size Dummy_value)
@x2)
)
...
;; def=Prims.fst(588,34-588,40); use=CntFormat.fst(106,6-106,9)
(= (CntFormat.msg (CntFormat.signal_size Dummy_value))
@x3)
)

;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(106,6-106,7)
(or label_3

;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(106,6-106,7)
(Valid 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(106,6-106,7)
(Prims.hasEq (CntFormat.msg (CntFormat.signal_size Dummy_value)))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CntFormat.signal_split, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_Platform.Bytes.HasEq_bytes, equation_CntFormat.msg, equation_CntFormat.signal_size, equation_Platform.Bytes.lbytes, haseqTm_refine_b3982a6d174e1d047431ae85c35dc7d8, projection_inverse_BoxInt_proj_0
...
; encoding sigelt val CntFormat.signal_split


; <Skipped val CntFormat.signal_split/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Platform.Bytes.split_eq; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(140,4-140,12); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(140,4-140,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Platform.Bytes.bytes)
(HasType @x1
(Tm_refine_9765e8d5fa76912a9e96f2f886b65533 @x0)))
(HasType (Platform.Bytes.split_eq @x0
@x1)
(Tm_refine_ac93c9c62e39fbf770521004ecbde3ee @x1
@x0)))
 

:pattern ((Platform.Bytes.split_eq @x0
@x1))
:qid typing_Platform.Bytes.split_eq))

:named typing_Platform.Bytes.split_eq))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.signal; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(100,4-100,10); use=CntFormat.fst(100,4-100,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
CntFormat.uint32)
(HasType @x1
CntFormat.uint16))
(HasType (CntFormat.signal @x0
@x1)
(CntFormat.msg (CntFormat.signal_size Dummy_value))))
 

:pattern ((CntFormat.signal @x0
@x1))
:qid typing_CntFormat.signal))

:named typing_CntFormat.signal))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.bytes_to_uint32; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(70,4-70,19); use=CntFormat.fst(70,4-70,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(CntFormat.msg (BoxInt 4)))
(HasType (CntFormat.bytes_to_uint32 @x0)
(Tm_refine_0643f30616668b6c2208c12d5e73aa3a @x0)))
 

:pattern ((CntFormat.bytes_to_uint32 @x0))
:qid typing_CntFormat.bytes_to_uint32))

:named typing_CntFormat.bytes_to_uint32))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CntFormat.bytes_to_uint16; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(69,4-69,19); use=CntFormat.fst(69,4-69,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(CntFormat.msg (BoxInt 2)))
(HasType (CntFormat.bytes_to_uint16 @x0)
(Tm_refine_0643f30616668b6c2208c12d5e73aa3a @x0)))
 

:pattern ((CntFormat.bytes_to_uint16 @x0))
:qid typing_CntFormat.bytes_to_uint16))

:named typing_CntFormat.bytes_to_uint16))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Platform.Bytes.split_eq; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(137,2-137,74); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(140,4-140,12)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_ac93c9c62e39fbf770521004ecbde3ee @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_ac93c9c62e39fbf770521004ecbde3ee @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_ac93c9c62e39fbf770521004ecbde3ee))

:named refinement_kinding_Tm_refine_ac93c9c62e39fbf770521004ecbde3ee))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Platform.Bytes.split_eq; Namespace Platform.Bytes
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ac93c9c62e39fbf770521004ecbde3ee @x2
@x3))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Platform.Bytes.bytes
...
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(139,21-139,45); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(140,4-140,12)
...
(Tm_refine_ac93c9c62e39fbf770521004ecbde3ee @x2
@x3)))
:qid refinement_interpretation_Tm_refine_ac93c9c62e39fbf770521004ecbde3ee))

:named refinement_interpretation_Tm_refine_ac93c9c62e39fbf770521004ecbde3ee))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Platform.Bytes.split_eq; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(136,25-136,57); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(140,4-140,12)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_ac93c9c62e39fbf770521004ecbde3ee
;;; Fact-ids: Name Platform.Bytes.split_eq; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(137,2-137,74); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(140,4-140,12)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ac93c9c62e39fbf770521004ecbde3ee @x0
@x1)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Platform.Bytes.bytes
Platform.Bytes.bytes))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ac93c9c62e39fbf770521004ecbde3ee @x0
@x1))))
:qid haseqTm_refine_ac93c9c62e39fbf770521004ecbde3ee))

:named haseqTm_refine_ac93c9c62e39fbf770521004ecbde3ee))
...
;;;;;;;;;;;;;;;;Equation for Platform.Bytes.split_eq
;;; Fact-ids: Name Platform.Bytes.split_eq; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(140,4-140,12); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(140,4-140,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Platform.Bytes.split_eq @x0
@x1)
...
:pattern ((Platform.Bytes.split_eq @x0
@x1))
:qid equation_Platform.Bytes.split_eq))

:named equation_Platform.Bytes.split_eq))
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (CntFormat.signal @x0
@x1)
(CntFormat.op_At_Bar (CntFormat.uint32_to_bytes @x0)
(CntFormat.uint16_to_bytes @x1)))
 

:pattern ((CntFormat.signal @x0
@x1))
:qid equation_CntFormat.signal))

:named equation_CntFormat.signal))
;;;;;;;;;;;;;;;;Equation for CntFormat.bytes_to_uint32
;;; Fact-ids: Name CntFormat.bytes_to_uint32; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(70,4-70,19); use=CntFormat.fst(70,4-70,19)
(forall ((@x0 Term))
 (! (= (CntFormat.bytes_to_uint32 @x0)
(Platform.Bytes.int_of_bytes @x0))
 

:pattern ((CntFormat.bytes_to_uint32 @x0))
:qid equation_CntFormat.bytes_to_uint32))

:named equation_CntFormat.bytes_to_uint32))
;;;;;;;;;;;;;;;;Equation for CntFormat.bytes_to_uint16
;;; Fact-ids: Name CntFormat.bytes_to_uint16; Namespace CntFormat
(assert (! 
;; def=CntFormat.fst(69,4-69,19); use=CntFormat.fst(69,4-69,19)
(forall ((@x0 Term))
 (! (= (CntFormat.bytes_to_uint16 @x0)
(Platform.Bytes.int_of_bytes @x0))
 

:pattern ((CntFormat.bytes_to_uint16 @x0))
:qid equation_CntFormat.bytes_to_uint16))

:named equation_CntFormat.bytes_to_uint16))
(push) ;; push{2

; Starting query at CntFormat.fst(107,21-109,46)
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_f5be185f1eef489aa4edd78977965649 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(137,2-137,74); use=CntFormat.fst(108,36-108,44)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_f5be185f1eef489aa4edd78977965649 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_f5be185f1eef489aa4edd78977965649 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_f5be185f1eef489aa4edd78977965649))

:named refinement_kinding_Tm_refine_f5be185f1eef489aa4edd78977965649))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(137,2-137,74); use=CntFormat.fst(108,36-108,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_f5be185f1eef489aa4edd78977965649 @x2))
(and (HasTypeFuel @u0
@x1
(FStar.Pervasives.Native.tuple2 Platform.Bytes.bytes
Platform.Bytes.bytes))
...
Platform.Bytes.bytes
@x1))
(Prims.op_Subtraction (Platform.Bytes.length @x2)
(BoxInt 4))))))
...
@x1
(Tm_refine_f5be185f1eef489aa4edd78977965649 @x2)))
:qid refinement_interpretation_Tm_refine_f5be185f1eef489aa4edd78977965649))

:named refinement_interpretation_Tm_refine_f5be185f1eef489aa4edd78977965649))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f5be185f1eef489aa4edd78977965649
;;; Fact-ids: 
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(137,2-137,74); use=CntFormat.fst(108,36-108,44)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_f5be185f1eef489aa4edd78977965649 @x0)))
(Valid (Prims.hasEq (FStar.Pervasives.Native.tuple2 Platform.Bytes.bytes
Platform.Bytes.bytes))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_f5be185f1eef489aa4edd78977965649 @x0))))
:qid haseqTm_refine_f5be185f1eef489aa4edd78977965649))

:named haseqTm_refine_f5be185f1eef489aa4edd78977965649))



; Encoding query formula : forall (sc: CntFormat.msg CntFormat.signal_size).
;   (*  - Could not prove post-condition
; *)
...
;   (4 <= Platform.Bytes.length sc) /\
;   (forall (any_result: Prims.int).
;       4 == any_result ==>
;       (forall (pure_result:
;           x:
;           (Platform.Bytes.bytes & Platform.Bytes.bytes)
;             { Platform.Bytes.length (FStar.Pervasives.Native.fst x) = 4 &&
;               Platform.Bytes.length (FStar.Pervasives.Native.snd x) = Platform.Bytes.length sc - 4 })
;         .
;           FStar.Pervasives.Native.fst pure_result @| FStar.Pervasives.Native.snd pure_result = sc ==>
;           Platform.Bytes.split_eq sc 4 == pure_result ==>
;           (forall (x: CntFormat.uint32 & CntFormat.uint16).
;               CntFormat.signal_size >= 0 /\
;               (forall (any_result: Prims.int).
;                   CntFormat.signal_size == any_result ==>
...
;                       CntFormat.msg CntFormat.signal_size == any_result ==>
;                       Prims.hasEq (CntFormat.msg CntFormat.signal_size)))) /\
;           (forall (b: Platform.Bytes.bytes) (b: Platform.Bytes.bytes).
;               Platform.Bytes.split_eq sc 4 == (b, b) ==>
;               Platform.Bytes.length b = 4 /\
...
;                           b = Platform.Bytes.bytes_of_int (FStar.Seq.Base.length b) n }).
;                       CntFormat.bytes_to_uint32 b == any_result ==>
;                       (Platform.Bytes.repr_bytes (CntFormat.bytes_to_uint32 b) <=
;                         FStar.Seq.Base.length b /\
;                         (FStar.Seq.Base.length b = 1 ==> CntFormat.bytes_to_uint32 b < 256) /\
;                         b =
;                         Platform.Bytes.bytes_of_int (FStar.Seq.Base.length b)
;                           (CntFormat.bytes_to_uint32 b) ==>
;                         Platform.Bytes.repr_bytes (CntFormat.bytes_to_uint32 b) <= 4) /\
;                       (forall (return_val: CntFormat.uint32).
;                           return_val == CntFormat.bytes_to_uint32 b ==>
;                           CntFormat.bytes_to_uint32 b == return_val ==>
;                           Platform.Bytes.length b = 2 /\
;                           (forall (any_result: Platform.Bytes.bytes).
;                               b == any_result ==>
;                               (forall (any_result:
;                                   n:
...
;                                       b = Platform.Bytes.bytes_of_int (FStar.Seq.Base.length b) n })
;                                 .
;                                   CntFormat.bytes_to_uint16 b == any_result ==>
;                                   (Platform.Bytes.repr_bytes (CntFormat.bytes_to_uint16 b) <=
;                                     FStar.Seq.Base.length b /\
;                                     (FStar.Seq.Base.length b = 1 ==>
;                                       CntFormat.bytes_to_uint16 b < 256) /\
;                                     b =
;                                     Platform.Bytes.bytes_of_int (FStar.Seq.Base.length b)
;                                       (CntFormat.bytes_to_uint16 b) ==>
;                                     Platform.Bytes.repr_bytes (CntFormat.bytes_to_uint16 b) <= 2) /\
;                                   (forall (return_val: CntFormat.uint16).
;                                       return_val == CntFormat.bytes_to_uint16 b ==>
;                                       CntFormat.bytes_to_uint16 b == return_val ==>
;                                       (forall (any_result: CntFormat.uint32 & CntFormat.uint16).
;                                           (CntFormat.bytes_to_uint32 b,
;                                           CntFormat.bytes_to_uint16 b) ==
;                                           any_result ==>
;                                           sc =
;                                           CntFormat.signal (FStar.Pervasives.Native.fst (CntFormat.bytes_to_uint32
;                                                   b,
;                                                 CntFormat.bytes_to_uint16 b))
;                                             (FStar.Pervasives.Native.snd (CntFormat.bytes_to_uint32 b
;                                                 ,
;                                                 CntFormat.bytes_to_uint16 b))))))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let signal_split`
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(107,21-109,46)
(and 
;; def=dummy(0,0-0,0); use=CntFormat.fst(107,21-109,46)
(forall ((@x1 Term))
 (! (implies (HasType @x1
(FStar.Pervasives.Native.tuple2 Platform.Bytes.bytes
Platform.Bytes.bytes))

;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(108,36-108,44)
(or label_1
...
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(136,42-136,55); use=CntFormat.fst(108,48-108,49)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=CntFormat.fst(107,21-109,46)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(136,25-136,26); use=CntFormat.fst(107,21-109,46)
(= (BoxInt 4)
@x1)
)

;; def=Prims.fst(441,36-441,97); use=CntFormat.fst(108,36-108,44)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Tm_refine_f5be185f1eef489aa4edd78977965649 @x0))

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(139,21-139,45); use=CntFormat.fst(108,36-108,44)
(= (Platform.Bytes.op_At_Bar (FStar.Pervasives.Native.fst Platform.Bytes.bytes
Platform.Bytes.bytes
@x2)
(FStar.Pervasives.Native.snd Platform.Bytes.bytes
...
;; def=CntFormat.fst(108,9-108,49); use=CntFormat.fst(108,9-108,49)
(= (Platform.Bytes.split_eq @x0
(BoxInt 4))
@x2)
)
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(107,21-109,46)
(and 
;; def=Prims.fst(680,18-680,24); use=CntFormat.fst(107,4-107,16)
(or label_3

;; def=Prims.fst(680,18-680,24); use=CntFormat.fst(107,21-109,46)
(>= (BoxInt_proj_0 (CntFormat.signal_size Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)
...
;; def=CntFormat.fst(29,10-105,36); use=CntFormat.fst(107,21-109,46)
(= (CntFormat.signal_size Dummy_value)
@x4)
)
...
;; def=Prims.fst(588,34-588,40); use=CntFormat.fst(107,21-109,46)
(= (CntFormat.msg (CntFormat.signal_size Dummy_value))
@x5)
)

;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(107,4-107,16)
(or label_4

;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(107,21-109,46)
(Valid 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(107,21-109,46)
(Prims.hasEq (CntFormat.msg (CntFormat.signal_size Dummy_value)))
)
...
;; def=Prims.fst(413,99-413,120); use=CntFormat.fst(107,21-109,46)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Platform.Bytes.bytes)
...
;; def=CntFormat.fst(108,9-108,17); use=CntFormat.fst(108,9-108,17)
(= (Platform.Bytes.split_eq @x0
(BoxInt 4))
(FStar.Pervasives.Native.Mktuple2 Platform.Bytes.bytes
Platform.Bytes.bytes
@x3
@x4))
)
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(107,21-109,46)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,30-74,42); use=CntFormat.fst(109,21-109,24)
(or label_5

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,30-74,42); use=CntFormat.fst(109,21-109,24)
(= (Platform.Bytes.length @x3)
(BoxInt 4))
)
...
;; def=CntFormat.fst(70,21-108,12); use=CntFormat.fst(107,21-109,46)
(= @x3
@x5)
)
...
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_0643f30616668b6c2208c12d5e73aa3a @x3))

;; def=CntFormat.fst(105,48-109,24); use=CntFormat.fst(107,21-109,46)
(= (CntFormat.bytes_to_uint32 @x3)
@x6)
)

;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(107,21-109,46)
(and (implies 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(174,15-176,44); use=CntFormat.fst(109,5-109,24)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(174,15-174,43); use=CntFormat.fst(109,5-109,24)
(<= (BoxInt_proj_0 (Platform.Bytes.repr_bytes (CntFormat.bytes_to_uint32 @x3)))
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x3)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(175,13-175,43); use=CntFormat.fst(109,5-109,24)
(implies 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(175,14-175,30); use=CntFormat.fst(109,5-109,24)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x3)
(BoxInt 1))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(175,35-175,42); use=CntFormat.fst(109,5-109,24)
(< (BoxInt_proj_0 (CntFormat.bytes_to_uint32 @x3))
(BoxInt_proj_0 (BoxInt 256)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(176,13-176,44); use=CntFormat.fst(109,5-109,24)
(= @x3
(Platform.Bytes.bytes_of_int (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x3)
(CntFormat.bytes_to_uint32 @x3)))
...
;; def=CntFormat.fst(50,20-50,43); use=CntFormat.fst(109,5-109,24)
(or label_6
...
;; def=Prims.fst(356,2-356,58); use=CntFormat.fst(107,21-109,46)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
CntFormat.uint32)

;; def=Prims.fst(356,26-356,41); use=CntFormat.fst(107,21-109,46)
(= @x7
(CntFormat.bytes_to_uint32 @x3))


;; def=FStar.Pervasives.Native.fst(59,33-59,35); use=CntFormat.fst(107,21-109,46)
(= (CntFormat.bytes_to_uint32 @x3)
@x7)
)
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(107,21-109,46)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,30-74,42); use=CntFormat.fst(109,42-109,45)
(or label_7

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,30-74,42); use=CntFormat.fst(109,42-109,45)
(= (Platform.Bytes.length @x4)
(BoxInt 2))
)
...
;; def=CntFormat.fst(69,21-108,17); use=CntFormat.fst(107,21-109,46)
(= @x4
@x8)
)
...
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
(Tm_refine_0643f30616668b6c2208c12d5e73aa3a @x4))

;; def=CntFormat.fst(105,57-109,45); use=CntFormat.fst(107,21-109,46)
(= (CntFormat.bytes_to_uint16 @x4)
@x9)
)

;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(107,21-109,46)
(and (implies 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(174,15-176,44); use=CntFormat.fst(109,26-109,45)
(and 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(174,15-174,43); use=CntFormat.fst(109,26-109,45)
(<= (BoxInt_proj_0 (Platform.Bytes.repr_bytes (CntFormat.bytes_to_uint16 @x4)))
(BoxInt_proj_0 (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x4)))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(175,13-175,43); use=CntFormat.fst(109,26-109,45)
(implies 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(175,14-175,30); use=CntFormat.fst(109,26-109,45)
(= (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x4)
(BoxInt 1))


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(175,35-175,42); use=CntFormat.fst(109,26-109,45)
(< (BoxInt_proj_0 (CntFormat.bytes_to_uint16 @x4))
(BoxInt_proj_0 (BoxInt 256)))
)


;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(176,13-176,44); use=CntFormat.fst(109,26-109,45)
(= @x4
(Platform.Bytes.bytes_of_int (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x4)
(CntFormat.bytes_to_uint16 @x4)))
...
;; def=CntFormat.fst(49,20-49,43); use=CntFormat.fst(109,26-109,45)
(or label_8
...
;; def=FStar.Pervasives.Native.fst(59,43-59,45); use=CntFormat.fst(107,21-109,46)
(= (CntFormat.bytes_to_uint16 @x4)
@x10)
)
...
;; def=CntFormat.fst(105,44-109,46); use=CntFormat.fst(107,21-109,46)
(= (FStar.Pervasives.Native.Mktuple2 CntFormat.uint32
CntFormat.uint16
(CntFormat.bytes_to_uint32 @x3)
(CntFormat.bytes_to_uint16 @x4))
@x11)
...
;; def=CntFormat.fst(106,6-106,32); use=CntFormat.fst(109,4-109,46)
(or label_9

;; def=CntFormat.fst(106,6-106,32); use=CntFormat.fst(109,4-109,46)
(= @x0
(CntFormat.signal (FStar.Pervasives.Native.fst CntFormat.uint32
CntFormat.uint16
(FStar.Pervasives.Native.Mktuple2 CntFormat.uint32
CntFormat.uint16
(CntFormat.bytes_to_uint32 @x3)
(CntFormat.bytes_to_uint16 @x4)))
(FStar.Pervasives.Native.snd CntFormat.uint32
CntFormat.uint16
(FStar.Pervasives.Native.Mktuple2 CntFormat.uint32
CntFormat.uint16
(CntFormat.bytes_to_uint32 @x3)
...
; Starting query at CntFormat.fst(107,0-109,46)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CntFormat.signal_split, 3)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_CntFormat.signal_size, projection_inverse_BoxInt_proj_0
...
; encoding sigelt let signal_split


; <Start encoding let signal_split>

(declare-fun CntFormat.signal_split (Term) Term)
(declare-fun Tm_refine_67273ea3556be6c6a1a16961dd4cef50 (Term) Term)
;;;;;;;;;;;;;;;;m: msg signal_size   -> x:     (uint32 & uint16){m = signal (FStar.Pervasives.Native.fst x) (FStar.Pervasives.Native.snd x)}
(declare-fun Tm_arrow_fb1c80b1dab08ce0c299992e08704360 () Term)
(declare-fun CntFormat.signal_split@tok () Term)


; </end encoding let signal_split>

(push) ;; push{2

; Starting query at CntFormat.fst(111,7-115,54)

(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_79a32f140ad547f7bf40e926818bd33b (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=CntFormat.fst(112,5-115,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_79a32f140ad547f7bf40e926818bd33b @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_79a32f140ad547f7bf40e926818bd33b @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_79a32f140ad547f7bf40e926818bd33b))

:named refinement_kinding_Tm_refine_79a32f140ad547f7bf40e926818bd33b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=CntFormat.fst(112,5-115,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_79a32f140ad547f7bf40e926818bd33b @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=FStar.Seq.Base.fsti(174,57-174,75); use=CntFormat.fst(112,5-115,54)
(iff 
;; def=FStar.Seq.Base.fsti(174,50-174,51); use=CntFormat.fst(112,5-115,54)
(BoxBool_proj_0 @x1)


;; def=FStar.Seq.Base.fsti(174,64-174,75); use=CntFormat.fst(112,5-115,54)
(Valid 
;; def=FStar.Seq.Base.fsti(174,64-174,75); use=CntFormat.fst(112,5-115,54)
(FStar.Seq.Base.equal (FStar.UInt8.t Dummy_value)
(CntFormat.signal @x2
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_79a32f140ad547f7bf40e926818bd33b))

:named refinement_interpretation_Tm_refine_79a32f140ad547f7bf40e926818bd33b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_79a32f140ad547f7bf40e926818bd33b
;;; Fact-ids: 
(assert (! 
;; def=FStar.Seq.Base.fsti(174,49-174,77); use=CntFormat.fst(112,5-115,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_79a32f140ad547f7bf40e926818bd33b @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq Prims.bool)))
...
:pattern ((Valid (Prims.hasEq (Tm_refine_79a32f140ad547f7bf40e926818bd33b @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_79a32f140ad547f7bf40e926818bd33b))

:named haseqTm_refine_79a32f140ad547f7bf40e926818bd33b))


; Encoding query formula : forall (s0: CntFormat.uint32) (c0: CntFormat.uint16) (s1: CntFormat.uint32) (c1: CntFormat.uint16).
;   Prims.hasEq FStar.UInt8.t /\
;   (forall (any_result: Type0).
;       FStar.UInt8.t == any_result ==>
;       (forall (any_result:
;           r:
;           Prims.bool{r <==> FStar.Seq.Base.equal (CntFormat.signal s0 c0) (CntFormat.signal s1 c1)})
;         .
;           FStar.Seq.Base.eq (CntFormat.signal s0 c0) (CntFormat.signal s1 c1) == any_result ==>
;           (forall (return_val:
;               r:
;               Prims.bool
;                 {r <==> FStar.Seq.Base.equal (CntFormat.signal s0 c0) (CntFormat.signal s1 c1)}).
;               return_val == FStar.Seq.Base.eq (CntFormat.signal s0 c0) (CntFormat.signal s1 c1) ==>
;               FStar.Seq.Base.eq (CntFormat.signal s0 c0) (CntFormat.signal s1 c1) == return_val ==>
;               (forall (any_result: Prims.logical).
;                   FStar.Seq.Base.eq (CntFormat.signal s0 c0) (CntFormat.signal s1 c1) == any_result ==>
;                   Prims.hasEq FStar.UInt8.t /\
;                   (forall (_:
;                       Prims.squash (FStar.Seq.Base.eq (CntFormat.signal s0 c0)
;                             (CntFormat.signal s1 c1))).
;                       (*  - Could not prove post-condition
; *)
;                       Prims.hasEq CntFormat.uint32 /\ (s0 = s1 ==> Prims.hasEq CntFormat.uint16)))))
;   )


; Context: While encoding a query
; While typechecking the top-level declaration `val CntFormat.signal_components_corr`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=CntFormat.fst(111,7-115,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
CntFormat.uint32)
(HasType @x1
...
;; def=Prims.fst(459,77-459,89); use=CntFormat.fst(112,5-115,54)
(and 
;; def=Prims.fst(73,23-73,30); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(56,36-56,40)
(or label_1

;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(112,5-115,54)
(Valid 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(112,5-115,54)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
;; def=Prims.fst(451,66-451,102); use=CntFormat.fst(112,5-115,54)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_type)

;; def=FStar.Seq.Base.fsti(174,9-174,10); use=CntFormat.fst(112,5-115,54)
(= (FStar.UInt8.t Dummy_value)
@x4)
)
...
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Tm_refine_79a32f140ad547f7bf40e926818bd33b @x0
@x1
@x2
@x3))

;; def=FStar.Seq.Base.fsti(174,49-174,77); use=CntFormat.fst(113,23-113,59)
...
;; def=Prims.fst(356,2-356,58); use=CntFormat.fst(112,5-115,54)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Tm_refine_79a32f140ad547f7bf40e926818bd33b @x0
@x1
...
;; def=Prims.fst(356,26-356,41); use=CntFormat.fst(112,5-115,54)
(= @x6
(FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(CntFormat.signal @x0
@x1)
...
;; def=Prims.fst(180,10-180,11); use=CntFormat.fst(112,5-115,54)
(= (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(CntFormat.signal @x0
@x1)
(CntFormat.signal @x2
...
;; def=FStar.Pervasives.fsti(112,28-112,31); use=CntFormat.fst(112,5-115,54)
(= (Prims.b2t (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(CntFormat.signal @x0
@x1)
(CntFormat.signal @x2
...
;; def=dummy(0,0-0,0); use=CntFormat.fst(112,5-115,54)
(and 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(113,2-113,7)
(or label_2

;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(114,18-114,38)
(Valid 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(114,18-114,38)
(Prims.hasEq (FStar.UInt8.t Dummy_value))
)
...
(forall ((@x8 Term))
 (! (implies (HasType @x8
(Prims.squash (Prims.b2t (FStar.Seq.Base.eq (FStar.UInt8.t Dummy_value)
(CntFormat.signal @x0
@x1)
(CntFormat.signal @x2
@x3)))))

;; def=CntFormat.fst(112,5-114,26); use=CntFormat.fst(114,19-114,37)
(and 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(114,19-114,21)
(or label_3

;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(114,19-114,21)
(Valid 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(114,19-114,21)
(Prims.hasEq CntFormat.uint32)
)
)

(implies 
;; def=CntFormat.fst(114,19-114,26); use=CntFormat.fst(114,19-114,26)
(= @x0
@x2)


;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(114,35-114,37)
(or label_4

;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(114,35-114,37)
(Valid 
;; def=Prims.fst(73,23-73,30); use=CntFormat.fst(114,35-114,37)
(Prims.hasEq CntFormat.uint16)
)
)
))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CntFormat.signal_components_corr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_CntFormat.uint16, equation_CntFormat.uint32, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, haseqTm_refine_75aaae859fab93cdc6b9fa05a2e66b27, haseqTm_refine_92ae293f6e4cd7fc83170fef96182afc, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.UInt8.t, typing_Prims.int
