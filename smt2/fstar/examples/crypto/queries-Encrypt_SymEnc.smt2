...
; Externals for interface FStar.Array


; <Skipped #set-options "--max_fuel 0 --initial_fuel 0 --initial_ifuel 0 --max_ifuel 0"/>


; <Start encoding val FStar.Array.array>

(declare-fun FStar.Array.array (Term) Term)

(declare-fun FStar.Array.array@tok () Term)

; </end encoding val FStar.Array.array>


; <Start encoding val FStar.Array.as_ref>

(declare-fun FStar.Array.as_ref (Term Term) Term)
(declare-fun Tm_ghost_arrow_ca1a13271fdf0303c0dd4d079ae26d7f () Term)
(declare-fun FStar.Array.as_ref@tok () Term)

; </end encoding val FStar.Array.as_ref>


; <Start encoding let sel>

(declare-fun FStar.Array.sel (Term Term Term) Term)
(declare-fun Tm_ghost_arrow_be634bffbc27668e6ece399062475c68 () Term)
(declare-fun FStar.Array.sel@tok () Term)
...
(declare-fun FStar.Array.contains (Term Term Term) Term)
(declare-fun Tm_arrow_6265347dc772c30ea1a5c67de1b9e8b3 () Term)
(declare-fun FStar.Array.contains@tok () Term)
...
(declare-fun FStar.Array.unused_in (Term Term Term) Term)
(declare-fun Tm_arrow_ca0c8982d51a37659a90f37db6ad2add () Term)
(declare-fun FStar.Array.unused_in@tok () Term)

; </end encoding let unused_in>


; <Start encoding let heap_upd>

(declare-fun FStar.Array.heap_upd (Term Term Term Term) Term)
(declare-fun Tm_ghost_arrow_3c8a704d3e72dfeafeb07b7b92a7e7ce () Term)
(declare-fun FStar.Array.heap_upd@tok () Term)

; </end encoding let heap_upd>


; <Start encoding let addr_of>

(declare-fun FStar.Array.addr_of (Term Term) Term)
(declare-fun Tm_ghost_arrow_2de0cc9fbe9180eb47cf35de852a49ef () Term)
(declare-fun FStar.Array.addr_of@tok () Term)
...
(declare-fun FStar.Array.only (Term Term) Term)
(declare-fun Tm_ghost_arrow_00698ba5fa2e6547474aab34694c1d71 () Term)
(declare-fun FStar.Array.only@tok () Term)

; </end encoding let only>


; <Start encoding val FStar.Array.op_At_Bar>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.op_At_Bar (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.op_At_Bar@tok () Term)

; </end encoding val FStar.Array.op_At_Bar>


; <Start encoding let create_post>

(declare-fun FStar.Array.create_post (Term Term) Term)
(declare-fun Tm_arrow_70e9b5e95f71ad8183a6e58fc55160c9 (Term) Term)
(declare-fun Tm_arrow_6eba91f9ce13dd94ce673c0df1fdd226 () Term)
(declare-fun FStar.Array.create_post@tok () Term)


(declare-fun Tm_abs_a4c0085b1573b5348c84639b50ee0254 (Term Term) Term)

; </end encoding let create_post>


; <Start encoding val FStar.Array.of_seq>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.of_seq (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.of_seq@tok () Term)

; </end encoding val FStar.Array.of_seq>


; <Start encoding val FStar.Array.to_seq>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.to_seq (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.to_seq@tok () Term)

; </end encoding val FStar.Array.to_seq>


; <Start encoding val FStar.Array.of_list>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.of_list (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.of_list@tok () Term)

; </end encoding val FStar.Array.of_list>


; <Start encoding val FStar.Array.create>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.create (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.create@tok () Term)

; </end encoding val FStar.Array.create>


; <Start encoding val FStar.Array.index>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.index (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.index@tok () Term)

; </end encoding val FStar.Array.index>


; <Start encoding val FStar.Array.upd>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.upd (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.upd@tok () Term)

; </end encoding val FStar.Array.upd>


; <Start encoding val FStar.Array.length>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.length (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.length@tok () Term)

; </end encoding val FStar.Array.length>


; <Start encoding val FStar.Array.op>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.op (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.op@tok () Term)

; </end encoding val FStar.Array.op>


; <Start encoding val FStar.Array.swap>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.swap (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.swap@tok () Term)

; </end encoding val FStar.Array.swap>


; <Start encoding val FStar.Array.copy>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.copy (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.copy@tok () Term)

; </end encoding val FStar.Array.copy>


; <Start encoding val FStar.Array.sub>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Array.sub (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Array.sub@tok () Term)

; </end encoding val FStar.Array.sub>


; End Externals for interface FStar.Array


; Externals for module AES


; <Start encoding let bytes>

(declare-fun AES.bytes () Term)

; </end encoding let bytes>


; <Start encoding let nbytes>

(declare-fun AES.nbytes (Term) Term)

(declare-fun AES.nbytes@tok () Term)
(declare-fun Tm_refine_8f0006372dc7eef1f8d6507769207c67 (Term) Term)

; </end encoding let nbytes>


; <Start encoding let blocksize>

(declare-fun AES.blocksize (Dummy_sort) Term)

; </end encoding let blocksize>


; <Start encoding let psize>

(declare-fun AES.psize (Dummy_sort) Term)

; </end encoding let psize>


; <Start encoding let csize>

(declare-fun AES.csize (Dummy_sort) Term)

; </end encoding let csize>


; <Start encoding let plain>

(declare-fun AES.plain () Term)
...
(declare-fun AES.keysize (Dummy_sort) Term)
...
(declare-fun AES.key () Term)

; </end encoding let key>


; <Start encoding val AES.dummy>

(declare-fun AES.dummy (Dummy_sort) Term)

; </end encoding val AES.dummy>


; <Start encoding val AES.generated>

(declare-fun AES.generated (Term) Term)
;;;;;;;;;;;;;;;;_: key -> Prims.bool
(declare-fun Tm_arrow_aa3246d399031d633070bbbf5f08c783 () Term)
(declare-fun AES.generated@tok () Term)

; </end encoding val AES.generated>


; <Start encoding val AES.gen>

(declare-fun AES.gen (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> key
(declare-fun Tm_arrow_0739d11a39165525e13b0c54c1fec0a1 () Term)
(declare-fun AES.gen@tok () Term)

; </end encoding val AES.gen>


; <Start encoding val AES.dec>

(declare-fun AES.dec (Term Term) Term)
;;;;;;;;;;;;;;;;_: key -> _: cipher -> plain
(declare-fun Tm_arrow_0ea952d183a17b66c11fbcefe074c83c () Term)
(declare-fun AES.dec@tok () Term)

; </end encoding val AES.dec>


; <Start encoding val AES.enc>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun AES.enc (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun AES.enc@tok () Term)

; </end encoding val AES.enc>


; End Externals for module AES

(push) ;; push{1

; Internals for Encrypt_SymEnc
...
(declare-fun Encrypt_SymEnc.bytes () Term)

; </end encoding let bytes>


; encoding sigelt type Encrypt_SymEnc.key


; <Start encoding type Encrypt_SymEnc.key>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Encrypt_SymEnc.key (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Encrypt_SymEnc.key@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Encrypt_SymEnc.Ideal (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Ideal_p (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Ideal_r (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Ideal_plain (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Ideal_repr (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Ideal__2 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Ideal_i (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Encrypt_SymEnc.Ideal
(declare-fun Encrypt_SymEnc.Ideal@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Encrypt_SymEnc.Concrete (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Concrete_p (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Concrete_r (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Concrete_plain (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Concrete_repr (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Concrete__2 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Concrete_i (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Encrypt_SymEnc.Concrete
(declare-fun Encrypt_SymEnc.Concrete@tok () Term)




;;;;;;;;;;;;;;;;plain: (_: r -> p) -> repr: (_: p -> r) -> _2: AES.key -> i: Prims.int -> key p r
(declare-fun Tm_arrow_d0a35aba9fb1afdfcc676204275474df () Term)
...
; <start constructor Encrypt_SymEnc.key>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Encrypt_SymEnc.key ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
(Encrypt_SymEnc.key @x0
@x1))
 
;;no pats
:qid is-Encrypt_SymEnc.key))))

; </end constructor Encrypt_SymEnc.key>


; <start constructor Encrypt_SymEnc.Ideal>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Encrypt_SymEnc.Ideal ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
115)
(= __@x0
(Encrypt_SymEnc.Ideal (Encrypt_SymEnc.Ideal_p __@x0)
(Encrypt_SymEnc.Ideal_r __@x0)
(Encrypt_SymEnc.Ideal_plain __@x0)
(Encrypt_SymEnc.Ideal_repr __@x0)
(Encrypt_SymEnc.Ideal__2 __@x0)
(Encrypt_SymEnc.Ideal_i __@x0)))))

; </end constructor Encrypt_SymEnc.Ideal>


; <start constructor Encrypt_SymEnc.Concrete>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Encrypt_SymEnc.Concrete ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
128)
(= __@x0
(Encrypt_SymEnc.Concrete (Encrypt_SymEnc.Concrete_p __@x0)
(Encrypt_SymEnc.Concrete_r __@x0)
(Encrypt_SymEnc.Concrete_plain __@x0)
(Encrypt_SymEnc.Concrete_repr __@x0)
(Encrypt_SymEnc.Concrete__2 __@x0)
(Encrypt_SymEnc.Concrete_i __@x0)))))

; </end constructor Encrypt_SymEnc.Concrete>


; </end encoding type Encrypt_SymEnc.key>


; encoding sigelt val Encrypt_SymEnc.uu___is_Ideal


; <Start encoding val Encrypt_SymEnc.uu___is_Ideal>

(declare-fun Encrypt_SymEnc.uu___is_Ideal (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: key p r -> Prims.bool
(declare-fun Tm_arrow_f78387fa6b6d50a2c4ba98cf18b3d579 () Term)
(declare-fun Encrypt_SymEnc.uu___is_Ideal@tok () Term)

; </end encoding val Encrypt_SymEnc.uu___is_Ideal>


; encoding sigelt let uu___is_Ideal


; <Skipped let uu___is_Ideal/>


; encoding sigelt val Encrypt_SymEnc.__proj__Ideal__item__plain


; <Start encoding val Encrypt_SymEnc.__proj__Ideal__item__plain>

(declare-fun Tm_refine_aeba281ff3db5ef268124d6ac4de91c8 (Term Term) Term)
(declare-fun Encrypt_SymEnc.__proj__Ideal__item__plain (Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: key p r {Ideal? _} -> _: r -> p
(declare-fun Tm_arrow_90b3776ee4c4d250ab002a5427db86c2 () Term)
(declare-fun Encrypt_SymEnc.__proj__Ideal__item__plain@tok () Term)


; </end encoding val Encrypt_SymEnc.__proj__Ideal__item__plain>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Encrypt_SymEnc.uu___is_Ideal; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
...
(Encrypt_SymEnc.key @x0
@x1)))
(HasType (Encrypt_SymEnc.uu___is_Ideal @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Encrypt_SymEnc.uu___is_Ideal @x0
@x1
@x2))
:qid typing_Encrypt_SymEnc.uu___is_Ideal))

:named typing_Encrypt_SymEnc.uu___is_Ideal))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AES.nbytes; Namespace AES
(assert (! 
;; def=AES.fst(23,5-23,11); use=AES.fst(23,5-23,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (AES.nbytes @x0)
Tm_type))
 

:pattern ((AES.nbytes @x0))
:qid typing_AES.nbytes))

:named typing_AES.nbytes))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AES.keysize; Namespace AES
(assert (! 
;; def=AES.fst(34,4-34,11); use=AES.fst(34,4-34,11)
(forall ((@u0 Dummy_sort))
 (! (HasType (AES.keysize @u0)
Prims.int)
 

:pattern ((AES.keysize @u0))
:qid typing_AES.keysize))

:named typing_AES.keysize))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AES.key; Namespace AES
(assert (! (HasType AES.key
Tm_type)
:named typing_AES.key))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AES.bytes; Namespace AES
(assert (! (HasType AES.bytes
Tm_type)
:named typing_AES.bytes))
...
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(24,10-24,13); use=Encrypt_SymEnc.fst(24,10-24,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Encrypt_SymEnc.key@tok
@x0)
@x1)
(Encrypt_SymEnc.key @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Encrypt_SymEnc.key@tok
@x0)
@x1))

:pattern ((Encrypt_SymEnc.key @x0
@x1))
:qid token_correspondence_Encrypt_SymEnc.key@tok))

:named token_correspondence_Encrypt_SymEnc.key@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
...
(Encrypt_SymEnc.Ideal @x1
@x2
@x3
@x4
@x5
@x6)
(Encrypt_SymEnc.key @x7
@x8))
...
(Encrypt_SymEnc.key @x7
@x8)))
:qid subterm_ordering_Encrypt_SymEnc.Ideal))

:named subterm_ordering_Encrypt_SymEnc.Ideal))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Encrypt_SymEnc.Concrete @x1
@x2
@x3
@x4
@x5
...
(Encrypt_SymEnc.key @x7
@x8)))
:qid subterm_ordering_Encrypt_SymEnc.Concrete))

:named subterm_ordering_Encrypt_SymEnc.Concrete))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Encrypt_SymEnc.__proj__Ideal__item__plain; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_aeba281ff3db5ef268124d6ac4de91c8 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_aeba281ff3db5ef268124d6ac4de91c8 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_aeba281ff3db5ef268124d6ac4de91c8))

:named refinement_kinding_Tm_refine_aeba281ff3db5ef268124d6ac4de91c8))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name AES.nbytes; Namespace AES
(assert (! 
;; def=AES.fst(23,22-23,50); use=AES.fst(23,22-23,50)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_8f0006372dc7eef1f8d6507769207c67 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_8f0006372dc7eef1f8d6507769207c67 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_8f0006372dc7eef1f8d6507769207c67))

:named refinement_kinding_Tm_refine_8f0006372dc7eef1f8d6507769207c67))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.pos; Namespace Prims
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_aeba281ff3db5ef268124d6ac4de91c8 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Encrypt_SymEnc.key @x2
@x3))

;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
(BoxBool_proj_0 (Encrypt_SymEnc.uu___is_Ideal @x2
@x3
@x1))
))
...
(Tm_refine_aeba281ff3db5ef268124d6ac4de91c8 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_aeba281ff3db5ef268124d6ac4de91c8))

:named refinement_interpretation_Tm_refine_aeba281ff3db5ef268124d6ac4de91c8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.UInt8.div; Namespace FStar.UInt8
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8f0006372dc7eef1f8d6507769207c67 @x2))
(and (HasTypeFuel @u0
@x1
AES.bytes)

;; def=AES.fst(23,30-23,49); use=AES.fst(23,30-23,49)
...
@x1
(Tm_refine_8f0006372dc7eef1f8d6507769207c67 @x2)))
:qid refinement_interpretation_Tm_refine_8f0006372dc7eef1f8d6507769207c67))

:named refinement_interpretation_Tm_refine_8f0006372dc7eef1f8d6507769207c67))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
...
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Ideal_repr (Encrypt_SymEnc.Ideal @x0
@x1
@x2
@x3
@x4
...
:pattern ((Encrypt_SymEnc.Ideal @x0
@x1
@x2
@x3
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Ideal_repr))

:named projection_inverse_Encrypt_SymEnc.Ideal_repr))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Ideal_r (Encrypt_SymEnc.Ideal @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Ideal_r))

:named projection_inverse_Encrypt_SymEnc.Ideal_r))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Ideal_plain (Encrypt_SymEnc.Ideal @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Ideal_plain))

:named projection_inverse_Encrypt_SymEnc.Ideal_plain))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Ideal_p (Encrypt_SymEnc.Ideal @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Ideal_p))

:named projection_inverse_Encrypt_SymEnc.Ideal_p))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Ideal_i (Encrypt_SymEnc.Ideal @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Ideal_i))

:named projection_inverse_Encrypt_SymEnc.Ideal_i))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Ideal__2 (Encrypt_SymEnc.Ideal @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Ideal__2))

:named projection_inverse_Encrypt_SymEnc.Ideal__2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Concrete_repr (Encrypt_SymEnc.Concrete @x0
@x1
@x2
@x3
@x4
...
:pattern ((Encrypt_SymEnc.Concrete @x0
@x1
@x2
@x3
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Concrete_repr))

:named projection_inverse_Encrypt_SymEnc.Concrete_repr))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Concrete_r (Encrypt_SymEnc.Concrete @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Concrete_r))

:named projection_inverse_Encrypt_SymEnc.Concrete_r))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Concrete_plain (Encrypt_SymEnc.Concrete @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Concrete_plain))

:named projection_inverse_Encrypt_SymEnc.Concrete_plain))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Concrete_p (Encrypt_SymEnc.Concrete @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Concrete_p))

:named projection_inverse_Encrypt_SymEnc.Concrete_p))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Concrete_i (Encrypt_SymEnc.Concrete @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Concrete_i))

:named projection_inverse_Encrypt_SymEnc.Concrete_i))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= (Encrypt_SymEnc.Concrete__2 (Encrypt_SymEnc.Concrete @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid projection_inverse_Encrypt_SymEnc.Concrete__2))

:named projection_inverse_Encrypt_SymEnc.Concrete__2))
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! (is-Tm_arrow (PreType Encrypt_SymEnc.key@tok))
:named pre_kinding_Encrypt_SymEnc.key@tok))
...
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! (and (IsTotFun Encrypt_SymEnc.key@tok)

;; def=Encrypt_SymEnc.fst(24,10-24,13); use=Encrypt_SymEnc.fst(24,10-24,13)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Encrypt_SymEnc.key@tok
@x0))
 

:pattern ((ApplyTT Encrypt_SymEnc.key@tok
@x0))
:qid kinding_Encrypt_SymEnc.key@tok))
...
:pattern ((Encrypt_SymEnc.key @x0
@x1))
:qid kinding_Encrypt_SymEnc.key@tok.1))
)
:named kinding_Encrypt_SymEnc.key@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_aeba281ff3db5ef268124d6ac4de91c8
;;; Fact-ids: Name Encrypt_SymEnc.__proj__Ideal__item__plain; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_aeba281ff3db5ef268124d6ac4de91c8 @x0
@x1)))
(Valid (Prims.hasEq (Encrypt_SymEnc.key @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_aeba281ff3db5ef268124d6ac4de91c8 @x0
@x1))))
:qid haseqTm_refine_aeba281ff3db5ef268124d6ac4de91c8))

:named haseqTm_refine_aeba281ff3db5ef268124d6ac4de91c8))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_8f0006372dc7eef1f8d6507769207c67
;;; Fact-ids: Name AES.nbytes; Namespace AES
(assert (! 
;; def=AES.fst(23,22-23,50); use=AES.fst(23,22-23,50)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8f0006372dc7eef1f8d6507769207c67 @x0)))
(Valid (Prims.hasEq AES.bytes)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8f0006372dc7eef1f8d6507769207c67 @x0))))
:qid haseqTm_refine_8f0006372dc7eef1f8d6507769207c67))

:named haseqTm_refine_8f0006372dc7eef1f8d6507769207c67))
...
(assert (! (HasType AES.key
Tm_type)
:named function_token_typing_AES.key))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name AES.bytes; Namespace AES
(assert (! (HasType AES.bytes
Tm_type)
:named function_token_typing_AES.bytes))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(24,10-24,13); use=Encrypt_SymEnc.fst(24,10-24,13)
...
(Encrypt_SymEnc.key @x2
@x3))
(or (and (is-Encrypt_SymEnc.Ideal @x1)
(= @x2
(Encrypt_SymEnc.Ideal_p @x1))
(= @x3
(Encrypt_SymEnc.Ideal_r @x1)))
(and (is-Encrypt_SymEnc.Concrete @x1)
(= @x2
(Encrypt_SymEnc.Concrete_p @x1))
(= @x3
(Encrypt_SymEnc.Concrete_r @x1)))))
...
(Encrypt_SymEnc.key @x2
@x3)))
:qid fuel_guarded_inversion_Encrypt_SymEnc.key))

:named fuel_guarded_inversion_Encrypt_SymEnc.key))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! (= 105
(Term_constr_id Encrypt_SymEnc.key@tok))
:named fresh_token_Encrypt_SymEnc.key@tok))
...
;;;;;;;;;;;;;;;;Equation for AES.nbytes
;;; Fact-ids: Name AES.nbytes; Namespace AES
(assert (! 
;; def=AES.fst(23,5-23,11); use=AES.fst(23,5-23,11)
(forall ((@x0 Term))
 (! (= (AES.nbytes @x0)
(Tm_refine_8f0006372dc7eef1f8d6507769207c67 @x0))
 

:pattern ((AES.nbytes @x0))
:qid equation_AES.nbytes))

:named equation_AES.nbytes))
;;;;;;;;;;;;;;;;Equation for AES.keysize
;;; Fact-ids: Name AES.keysize; Namespace AES
(assert (! 
;; def=AES.fst(34,4-34,11); use=AES.fst(34,4-34,11)
(forall ((@u0 Dummy_sort))
...
:qid equation_AES.keysize))

:named equation_AES.keysize))
;;;;;;;;;;;;;;;;Equation for AES.key
;;; Fact-ids: Name AES.key; Namespace AES
(assert (! (= AES.key
(AES.nbytes (AES.keysize Dummy_value)))
:named equation_AES.key))
;;;;;;;;;;;;;;;;Equation for AES.bytes
;;; Fact-ids: Name AES.bytes; Namespace AES
(assert (! (= AES.bytes
Platform.Bytes.bytes)
:named equation_AES.bytes))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Encrypt_SymEnc.uu___is_Ideal; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Encrypt_SymEnc.uu___is_Ideal @x0
@x1
@x2)
(BoxBool (is-Encrypt_SymEnc.Ideal @x2)))
 

:pattern ((Encrypt_SymEnc.uu___is_Ideal @x0
@x1
@x2))
:qid disc_equation_Encrypt_SymEnc.Ideal))

:named disc_equation_Encrypt_SymEnc.Ideal))
...
(Encrypt_SymEnc.key @x1
@x2)))
:qid data_typing_intro_Encrypt_SymEnc.Ideal@tok))

:named data_typing_intro_Encrypt_SymEnc.Ideal@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
...
(Encrypt_SymEnc.key @x1
@x2)))
:qid data_typing_intro_Encrypt_SymEnc.Concrete@tok))

:named data_typing_intro_Encrypt_SymEnc.Concrete@tok))
...
(HasTypeFuel @u0
@x3
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x7
@x8))
(HasTypeFuel @u0
@x4
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x8
@x7))
(HasTypeFuel @u0
@x5
AES.key)
...
(Encrypt_SymEnc.key @x7
@x8)))
:qid data_elim_Encrypt_SymEnc.Ideal))

:named data_elim_Encrypt_SymEnc.Ideal))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
...
(Encrypt_SymEnc.key @x7
@x8)))
:qid data_elim_Encrypt_SymEnc.Concrete))

:named data_elim_Encrypt_SymEnc.Concrete))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term) (@x1 Term))
 (! (= 104
(Term_constr_id (Encrypt_SymEnc.key @x0
@x1)))
 

:pattern ((Encrypt_SymEnc.key @x0
@x1))
:qid constructor_distinct_Encrypt_SymEnc.key))

:named constructor_distinct_Encrypt_SymEnc.key))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,4-25,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= 115
(Term_constr_id (Encrypt_SymEnc.Ideal @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid constructor_distinct_Encrypt_SymEnc.Ideal))

:named constructor_distinct_Encrypt_SymEnc.Ideal))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Encrypt_SymEnc.key; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Ideal; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (= 128
(Term_constr_id (Encrypt_SymEnc.Concrete @x0
@x1
@x2
@x3
@x4
...
@x4
@x5))
:qid constructor_distinct_Encrypt_SymEnc.Concrete))

:named constructor_distinct_Encrypt_SymEnc.Concrete))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
(Encrypt_SymEnc.key @x2
@x3)))
:qid Encrypt_SymEnc_pretyping_9ea91ebfeabdfb1e0a9759d641f6da23))

:named Encrypt_SymEnc_pretyping_9ea91ebfeabdfb1e0a9759d641f6da23))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Prims.pow2; Namespace Prims
(assert (! 
;; def=Prims.fst(708,8-708,12); use=Prims.fst(708,8-708,12)
...
; Starting query at Encrypt_SymEnc.fst(25,15-25,20)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (p: Type) (r: Type) (projectee: _: Encrypt_SymEnc.key p r {Ideal? _}).
;   (*  - Could not prove post-condition
; *) ~(Ideal? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Ideal__item__plain`
...
Tm_type)
(HasType @x2
(Tm_refine_aeba281ff3db5ef268124d6ac4de91c8 @x0
@x1))

;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,15-25,20)
(not 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,15-25,20)
(BoxBool_proj_0 (Encrypt_SymEnc.uu___is_Ideal @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.__proj__Ideal__item__plain, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_aeba281ff3db5ef268124d6ac4de91c8
...
; encoding sigelt let __proj__Ideal__item__plain


; <Skipped let __proj__Ideal__item__plain/>


; encoding sigelt val Encrypt_SymEnc.__proj__Ideal__item__repr


; <Start encoding val Encrypt_SymEnc.__proj__Ideal__item__repr>


(declare-fun Encrypt_SymEnc.__proj__Ideal__item__repr (Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: key p r {Ideal? _} -> _: p -> r
(declare-fun Tm_arrow_2f1e69d308664e0f4fb49bdbe37db330 () Term)
(declare-fun Encrypt_SymEnc.__proj__Ideal__item__repr@tok () Term)


; </end encoding val Encrypt_SymEnc.__proj__Ideal__item__repr>

(push) ;; push{2

; Starting query at Encrypt_SymEnc.fst(25,34-25,38)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Ideal__item__repr`
...
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,34-25,38)
(not 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,34-25,38)
(BoxBool_proj_0 (Encrypt_SymEnc.uu___is_Ideal @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.__proj__Ideal__item__repr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_aeba281ff3db5ef268124d6ac4de91c8
...
; encoding sigelt let __proj__Ideal__item__repr


; <Skipped let __proj__Ideal__item__repr/>


; encoding sigelt val Encrypt_SymEnc.__proj__Ideal__item___2


; <Start encoding val Encrypt_SymEnc.__proj__Ideal__item___2>


(declare-fun Encrypt_SymEnc.__proj__Ideal__item___2 (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: key p r {Ideal? _} -> AES.key
(declare-fun Tm_arrow_89a7cafb3a5e8c2216377654956159b0 () Term)
(declare-fun Encrypt_SymEnc.__proj__Ideal__item___2@tok () Term)

; </end encoding val Encrypt_SymEnc.__proj__Ideal__item___2>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Ideal__item___2`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.__proj__Ideal__item___2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_aeba281ff3db5ef268124d6ac4de91c8
...
; encoding sigelt let __proj__Ideal__item___2


; <Skipped let __proj__Ideal__item___2/>


; encoding sigelt val Encrypt_SymEnc.__proj__Ideal__item__i


; <Start encoding val Encrypt_SymEnc.__proj__Ideal__item__i>


(declare-fun Encrypt_SymEnc.__proj__Ideal__item__i (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: key p r {Ideal? _} -> Prims.int
(declare-fun Tm_arrow_87ad09cb31c022cf0b6eef8a2341e1c8 () Term)
(declare-fun Encrypt_SymEnc.__proj__Ideal__item__i@tok () Term)

; </end encoding val Encrypt_SymEnc.__proj__Ideal__item__i>

(push) ;; push{2

; Starting query at Encrypt_SymEnc.fst(25,63-25,64)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Ideal__item__i`
...
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,63-25,64)
(not 
;; def=Encrypt_SymEnc.fst(25,4-25,9); use=Encrypt_SymEnc.fst(25,63-25,64)
(BoxBool_proj_0 (Encrypt_SymEnc.uu___is_Ideal @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.__proj__Ideal__item__i, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_aeba281ff3db5ef268124d6ac4de91c8
...
; encoding sigelt let __proj__Ideal__item__i


; <Skipped let __proj__Ideal__item__i/>


; encoding sigelt val Encrypt_SymEnc.uu___is_Concrete


; <Start encoding val Encrypt_SymEnc.uu___is_Concrete>

(declare-fun Encrypt_SymEnc.uu___is_Concrete (Term Term Term) Term)

(declare-fun Encrypt_SymEnc.uu___is_Concrete@tok () Term)

; </end encoding val Encrypt_SymEnc.uu___is_Concrete>


; encoding sigelt let uu___is_Concrete


; <Skipped let uu___is_Concrete/>


; encoding sigelt val Encrypt_SymEnc.__proj__Concrete__item__plain


; <Start encoding val Encrypt_SymEnc.__proj__Concrete__item__plain>

(declare-fun Tm_refine_c498f4d14808e5b989acda0ba70ad0bf (Term Term) Term)
(declare-fun Encrypt_SymEnc.__proj__Concrete__item__plain (Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: key p r {Concrete? _} -> _: r -> p
(declare-fun Tm_arrow_4924e90d11cda4381c023f3e7cef3912 () Term)
(declare-fun Encrypt_SymEnc.__proj__Concrete__item__plain@tok () Term)


; </end encoding val Encrypt_SymEnc.__proj__Concrete__item__plain>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Encrypt_SymEnc.uu___is_Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(Encrypt_SymEnc.key @x0
@x1)))
(HasType (Encrypt_SymEnc.uu___is_Concrete @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Encrypt_SymEnc.uu___is_Concrete @x0
@x1
@x2))
:qid typing_Encrypt_SymEnc.uu___is_Concrete))

:named typing_Encrypt_SymEnc.uu___is_Concrete))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Encrypt_SymEnc.__proj__Concrete__item__plain; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c498f4d14808e5b989acda0ba70ad0bf @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_c498f4d14808e5b989acda0ba70ad0bf @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_c498f4d14808e5b989acda0ba70ad0bf))

:named refinement_kinding_Tm_refine_c498f4d14808e5b989acda0ba70ad0bf))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Encrypt_SymEnc.__proj__Concrete__item__plain; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c498f4d14808e5b989acda0ba70ad0bf @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Encrypt_SymEnc.key @x2
...
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(BoxBool_proj_0 (Encrypt_SymEnc.uu___is_Concrete @x2
@x3
@x1))
))
...
(Tm_refine_c498f4d14808e5b989acda0ba70ad0bf @x2
@x3)))
:qid refinement_interpretation_Tm_refine_c498f4d14808e5b989acda0ba70ad0bf))

:named refinement_interpretation_Tm_refine_c498f4d14808e5b989acda0ba70ad0bf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c498f4d14808e5b989acda0ba70ad0bf
;;; Fact-ids: Name Encrypt_SymEnc.__proj__Concrete__item__plain; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c498f4d14808e5b989acda0ba70ad0bf @x0
@x1)))
(Valid (Prims.hasEq (Encrypt_SymEnc.key @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c498f4d14808e5b989acda0ba70ad0bf @x0
@x1))))
:qid haseqTm_refine_c498f4d14808e5b989acda0ba70ad0bf))

:named haseqTm_refine_c498f4d14808e5b989acda0ba70ad0bf))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Encrypt_SymEnc.uu___is_Concrete; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,4-26,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Encrypt_SymEnc.uu___is_Concrete @x0
@x1
@x2)
(BoxBool (is-Encrypt_SymEnc.Concrete @x2)))
 

:pattern ((Encrypt_SymEnc.uu___is_Concrete @x0
@x1
@x2))
:qid disc_equation_Encrypt_SymEnc.Concrete))

:named disc_equation_Encrypt_SymEnc.Concrete))
(push) ;; push{2

; Starting query at Encrypt_SymEnc.fst(26,15-26,20)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (p: Type) (r: Type) (projectee: _: Encrypt_SymEnc.key p r {Concrete? _}).
;   (*  - Could not prove post-condition
; *) ~(Concrete? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Concrete__item__plain`
...
Tm_type)
(HasType @x2
(Tm_refine_c498f4d14808e5b989acda0ba70ad0bf @x0
@x1))

;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,15-26,20)
(not 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,15-26,20)
(BoxBool_proj_0 (Encrypt_SymEnc.uu___is_Concrete @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.__proj__Concrete__item__plain, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_c498f4d14808e5b989acda0ba70ad0bf
...
; encoding sigelt let __proj__Concrete__item__plain


; <Skipped let __proj__Concrete__item__plain/>


; encoding sigelt val Encrypt_SymEnc.__proj__Concrete__item__repr


; <Start encoding val Encrypt_SymEnc.__proj__Concrete__item__repr>


(declare-fun Encrypt_SymEnc.__proj__Concrete__item__repr (Term Term Term) Term)


;;;;;;;;;;;;;;;;projectee: _: key p r {Concrete? _} -> _: p -> r
(declare-fun Tm_arrow_442a519aa94b09e9059b294333aaecf0 () Term)
(declare-fun Encrypt_SymEnc.__proj__Concrete__item__repr@tok () Term)


; </end encoding val Encrypt_SymEnc.__proj__Concrete__item__repr>

(push) ;; push{2

; Starting query at Encrypt_SymEnc.fst(26,34-26,38)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Concrete__item__repr`
...
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,34-26,38)
(not 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,34-26,38)
(BoxBool_proj_0 (Encrypt_SymEnc.uu___is_Concrete @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.__proj__Concrete__item__repr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_c498f4d14808e5b989acda0ba70ad0bf
...
; encoding sigelt let __proj__Concrete__item__repr


; <Skipped let __proj__Concrete__item__repr/>


; encoding sigelt val Encrypt_SymEnc.__proj__Concrete__item___2


; <Start encoding val Encrypt_SymEnc.__proj__Concrete__item___2>


(declare-fun Encrypt_SymEnc.__proj__Concrete__item___2 (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: key p r {Concrete? _} -> AES.key
(declare-fun Tm_arrow_393d1b895a3f983fd3cee7a13b1faf3d () Term)
(declare-fun Encrypt_SymEnc.__proj__Concrete__item___2@tok () Term)

; </end encoding val Encrypt_SymEnc.__proj__Concrete__item___2>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Concrete__item___2`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.__proj__Concrete__item___2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_c498f4d14808e5b989acda0ba70ad0bf
...
; encoding sigelt let __proj__Concrete__item___2


; <Skipped let __proj__Concrete__item___2/>


; encoding sigelt val Encrypt_SymEnc.__proj__Concrete__item__i


; <Start encoding val Encrypt_SymEnc.__proj__Concrete__item__i>


(declare-fun Encrypt_SymEnc.__proj__Concrete__item__i (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: key p r {Concrete? _} -> Prims.int
(declare-fun Tm_arrow_0f398fe7ae50c71063b458deaf5ec08b () Term)
(declare-fun Encrypt_SymEnc.__proj__Concrete__item__i@tok () Term)

; </end encoding val Encrypt_SymEnc.__proj__Concrete__item__i>

(push) ;; push{2

; Starting query at Encrypt_SymEnc.fst(26,63-26,64)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Concrete__item__i`
...
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,63-26,64)
(not 
;; def=Encrypt_SymEnc.fst(26,4-26,12); use=Encrypt_SymEnc.fst(26,63-26,64)
(BoxBool_proj_0 (Encrypt_SymEnc.uu___is_Concrete @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.__proj__Concrete__item__i, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_c498f4d14808e5b989acda0ba70ad0bf
...
; encoding sigelt let __proj__Concrete__item__i


; <Skipped let __proj__Concrete__item__i/>


; encoding sigelt val Encrypt_SymEnc.encrypted


; <Start encoding val Encrypt_SymEnc.encrypted>

(declare-fun Encrypt_SymEnc.encrypted (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: key p r -> _: bytes -> Type
(declare-fun Tm_arrow_4738a6d53c6d0d7e2c3704c990356fad () Term)
(declare-fun Encrypt_SymEnc.encrypted@tok () Term)

; </end encoding val Encrypt_SymEnc.encrypted>
...
(declare-fun Encrypt_SymEnc.cipher (Term Term Term) Term)
;;;;;;;;;;;;;;;;p: Type -> r: Type -> k: key p r -> Type
(declare-fun Tm_arrow_40a82bd91a7bd8681bbada7dbd130a4f () Term)
(declare-fun Encrypt_SymEnc.cipher@tok () Term)
(declare-fun Tm_refine_2ccb7058860a095a0f0b25bced8444a0 (Term Term Term) Term)

; </end encoding let cipher>


; encoding sigelt val Encrypt_SymEnc.keygen


; <Skipped val Encrypt_SymEnc.keygen/>


; encoding sigelt val Encrypt_SymEnc.decrypt


; <Skipped val Encrypt_SymEnc.decrypt/>


; encoding sigelt val Encrypt_SymEnc.encrypt


; <Skipped val Encrypt_SymEnc.encrypt/>


; encoding sigelt let c


; <Start encoding let c>

(declare-fun Encrypt_SymEnc.c (Dummy_sort) Term)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Encrypt_SymEnc.c; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(49,4-49,5); use=Encrypt_SymEnc.fst(49,4-49,5)
(forall ((@u0 Dummy_sort))
 (! (HasType (Encrypt_SymEnc.c @u0)
(FStar.ST.ref Prims.nat))
 

:pattern ((Encrypt_SymEnc.c @u0))
:qid typing_Encrypt_SymEnc.c))

:named typing_Encrypt_SymEnc.c))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AES.psize; Namespace AES
(assert (! 
;; def=AES.fst(26,4-26,9); use=AES.fst(26,4-26,9)
(forall ((@u0 Dummy_sort))
 (! (HasType (AES.psize @u0)
Prims.int)
 

:pattern ((AES.psize @u0))
:qid typing_AES.psize))

:named typing_AES.psize))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AES.plain; Namespace AES
(assert (! (HasType AES.plain
Tm_type)
:named typing_AES.plain))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AES.blocksize; Namespace AES
(assert (! 
;; def=AES.fst(25,4-25,13); use=AES.fst(25,4-25,13)
(forall ((@u0 Dummy_sort))
 (! (HasType (AES.blocksize @u0)
Prims.int)
 

:pattern ((AES.blocksize @u0))
:qid typing_AES.blocksize))

:named typing_AES.blocksize))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
(assert (! (HasType AES.plain
Tm_type)
:named function_token_typing_AES.plain))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
:qid equation_AES.psize))

:named equation_AES.psize))
;;;;;;;;;;;;;;;;Equation for AES.plain
;;; Fact-ids: Name AES.plain; Namespace AES
(assert (! (= AES.plain
(AES.nbytes (AES.psize Dummy_value)))
:named equation_AES.plain))
;;;;;;;;;;;;;;;;Equation for AES.blocksize
;;; Fact-ids: Name AES.blocksize; Namespace AES
(assert (! 
;; def=AES.fst(25,4-25,13); use=AES.fst(25,4-25,13)
(forall ((@u0 Dummy_sort))
...
:qid equation_AES.blocksize))

:named equation_AES.blocksize))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at Encrypt_SymEnc.fst(51,31-57,30)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
;;;;;;;;;;;;;;;;_: AES.plain -> p
(declare-fun Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(42,40-51,13); use=Encrypt_SymEnc.fst(51,4-51,13)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x0)
Tm_type))
:qid kinding_Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0))

:named kinding_Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(42,40-51,13); use=Encrypt_SymEnc.fst(51,4-51,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x2)))
:qid Encrypt_SymEnc_pre_typing_Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0))

:named Encrypt_SymEnc_pre_typing_Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(42,40-51,13); use=Encrypt_SymEnc.fst(51,4-51,13)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x1))
(and 
;; def=Encrypt_SymEnc.fst(42,40-51,13); use=Encrypt_SymEnc.fst(51,4-51,13)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid Encrypt_SymEnc_interpretation_Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x1)))
:qid Encrypt_SymEnc_interpretation_Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0))

:named Encrypt_SymEnc_interpretation_Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0))
;;;;;;;;;;;;;;;;_: p -> AES.plain
(declare-fun Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e (Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(42,70-51,13); use=Encrypt_SymEnc.fst(51,4-51,13)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e @x0)
Tm_type))
:qid kinding_Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e))

:named kinding_Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(42,70-51,13); use=Encrypt_SymEnc.fst(51,4-51,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e @x2)))
:qid Encrypt_SymEnc_pre_typing_Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e))

:named Encrypt_SymEnc_pre_typing_Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(42,70-51,13); use=Encrypt_SymEnc.fst(51,4-51,13)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e @x1))
(and 
;; def=Encrypt_SymEnc.fst(42,70-51,13); use=Encrypt_SymEnc.fst(51,4-51,13)
(forall ((@x2 Term))
 (! (implies (HasType @x2
...
:pattern ((ApplyTT @x0
@x2))
:qid Encrypt_SymEnc_interpretation_Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e @x1)))
:qid Encrypt_SymEnc_interpretation_Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e))

:named Encrypt_SymEnc_interpretation_Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.Heap.trivial_preorder@tok))
...
; Encoding query formula : forall (p: Type) (safe: Prims.bool) (plain: (_: AES.plain -> p)) (repr: (_: p -> AES.plain)).
;   (*  - Could not prove post-condition
; *)
;   forall (h0: FStar.Monotonic.Heap.heap).
;     FStar.Monotonic.Heap.sel h0 Encrypt_SymEnc.c + 1 >= 0 /\
;     (forall (return_val: Prims.nat).
;         return_val == FStar.Monotonic.Heap.sel h0 Encrypt_SymEnc.c + 1 ==>
;         return_val == FStar.Monotonic.Heap.sel h0 Encrypt_SymEnc.c + 1 ==>
;         FStar.Heap.trivial_preorder Prims.nat
;           (FStar.Monotonic.Heap.sel h0 Encrypt_SymEnc.c)
;           return_val)


; Context: While encoding a query
; While typechecking the top-level declaration `let keygen`
...
Prims.bool)
(HasType @x2
(Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x0))
(HasType @x3
(Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e @x0)))
...
;; def=Prims.fst(459,77-459,89); use=Encrypt_SymEnc.fst(51,31-57,30)
(and 
;; def=Prims.fst(680,18-680,24); use=Encrypt_SymEnc.fst(53,7-53,13)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Encrypt_SymEnc.fst(53,7-53,13)
(>= (BoxInt_proj_0 (Prims.op_Addition (FStar.Monotonic.Heap.sel Prims.nat
(FStar.Heap.trivial_preorder Prims.nat)
@x4
(Encrypt_SymEnc.c Dummy_value))
(BoxInt 1)))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=Prims.fst(356,2-356,58); use=Encrypt_SymEnc.fst(51,31-57,30)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Encrypt_SymEnc.fst(51,31-57,30)
(= @x5
(Prims.op_Addition (FStar.Monotonic.Heap.sel Prims.nat
(FStar.Heap.trivial_preorder Prims.nat)
@x4
(Encrypt_SymEnc.c Dummy_value))
(BoxInt 1)))
...
;; def=Encrypt_SymEnc.fst(49,11-53,13); use=Encrypt_SymEnc.fst(53,2-53,13)
(= @x5
(Prims.op_Addition (FStar.Monotonic.Heap.sel Prims.nat
(FStar.Heap.trivial_preorder Prims.nat)
@x4
...
;; def=FStar.ST.fst(124,14-124,29); use=Encrypt_SymEnc.fst(53,4-53,6)
(or label_2
...
Prims.nat)
(FStar.Monotonic.Heap.sel Prims.nat
(FStar.Heap.trivial_preorder Prims.nat)
@x4
(Encrypt_SymEnc.c Dummy_value)))
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.keygen, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_FStar.Heap.trivial_preorder, equation_FStar.Heap.trivial_rel, equation_FStar.ST.mref, equation_FStar.ST.ref, equation_Prims.nat, interpretation_Tm_abs_568747eb5009c1dec504311dee989dc2, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_e33ef751d600ad1c7f71142479103c47, refinement_kinding_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, token_correspondence_FStar.Heap.trivial_preorder, true_interp, typing_Encrypt_SymEnc.c, typing_FStar.Heap.trivial_preorder, typing_FStar.Monotonic.Heap.sel
...
; encoding sigelt let keygen


; <Start encoding let keygen>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Encrypt_SymEnc.keygen (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Encrypt_SymEnc.keygen@tok () Term)

; </end encoding let keygen>


; encoding sigelt type Encrypt_SymEnc.entry


; <Start encoding type Encrypt_SymEnc.entry>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Encrypt_SymEnc.entry (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Encrypt_SymEnc.entry@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Encrypt_SymEnc.Entry (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Entry_p (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Entry_k (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Entry_c (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Encrypt_SymEnc.Entry_plain (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Encrypt_SymEnc.Entry
(declare-fun Encrypt_SymEnc.Entry@tok () Term)
;;;;;;;;;;;;;;;;k: key p AES.plain -> c: cipher p AES.plain k -> plain: p -> entry
(declare-fun Tm_arrow_f19446c70fdd5a784defc77e6836732c () Term)

; <start constructor Encrypt_SymEnc.entry>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Encrypt_SymEnc.entry ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
205)
(exists ((@x0 Term))
 (! (= __@x0
(Encrypt_SymEnc.entry @x0))
 
;;no pats
:qid is-Encrypt_SymEnc.entry))))

; </end constructor Encrypt_SymEnc.entry>
...
212)
(= __@x0
(Encrypt_SymEnc.Entry (Encrypt_SymEnc.Entry_p __@x0)
(Encrypt_SymEnc.Entry_k __@x0)
(Encrypt_SymEnc.Entry_c __@x0)
(Encrypt_SymEnc.Entry_plain __@x0)))))

; </end constructor Encrypt_SymEnc.Entry>


; </end encoding type Encrypt_SymEnc.entry>


; encoding sigelt val Encrypt_SymEnc.uu___is_Entry


; <Start encoding val Encrypt_SymEnc.uu___is_Entry>

(declare-fun Encrypt_SymEnc.uu___is_Entry (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: entry -> Prims.bool
(declare-fun Tm_arrow_44760a386169884eecad7ffde9670150 () Term)
(declare-fun Encrypt_SymEnc.uu___is_Entry@tok () Term)

; </end encoding val Encrypt_SymEnc.uu___is_Entry>


; encoding sigelt let uu___is_Entry


; <Skipped let uu___is_Entry/>


; encoding sigelt val Encrypt_SymEnc.__proj__Entry__item__k


; <Start encoding val Encrypt_SymEnc.__proj__Entry__item__k>

(declare-fun Encrypt_SymEnc.__proj__Entry__item__k (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: entry -> key p AES.plain
(declare-fun Tm_arrow_2dc0d63be82ed43819fd3d8ddaff4a7c () Term)
(declare-fun Encrypt_SymEnc.__proj__Entry__item__k@tok () Term)

; </end encoding val Encrypt_SymEnc.__proj__Entry__item__k>


; encoding sigelt let __proj__Entry__item__k


; <Skipped let __proj__Entry__item__k/>


; encoding sigelt val Encrypt_SymEnc.__proj__Entry__item__c


; <Start encoding val Encrypt_SymEnc.__proj__Entry__item__c>

(declare-fun Encrypt_SymEnc.__proj__Entry__item__c (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: entry -> cipher p AES.plain projectee.k
(declare-fun Tm_arrow_443dae5ce249d6f4b96e28289f70f4a5 () Term)
(declare-fun Encrypt_SymEnc.__proj__Entry__item__c@tok () Term)

; </end encoding val Encrypt_SymEnc.__proj__Entry__item__c>


; encoding sigelt let __proj__Entry__item__c


; <Skipped let __proj__Entry__item__c/>


; encoding sigelt val Encrypt_SymEnc.__proj__Entry__item__plain


; <Start encoding val Encrypt_SymEnc.__proj__Entry__item__plain>

(declare-fun Encrypt_SymEnc.__proj__Entry__item__plain (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: entry -> p
(declare-fun Tm_arrow_a1bc90faa77fdb10b19b702a67a48b97 () Term)
(declare-fun Encrypt_SymEnc.__proj__Entry__item__plain@tok () Term)

; </end encoding val Encrypt_SymEnc.__proj__Entry__item__plain>


; encoding sigelt let __proj__Entry__item__plain


; <Skipped let __proj__Entry__item__plain/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Encrypt_SymEnc.encrypted; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(38,12-38,21); use=Encrypt_SymEnc.fst(38,12-38,21)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
@x1))
(HasType @x3
Encrypt_SymEnc.bytes))
(HasType (Encrypt_SymEnc.encrypted @x0
@x1
@x2
@x3)
Tm_type))
...
:pattern ((Encrypt_SymEnc.encrypted @x0
@x1
@x2
@x3))
:qid typing_Encrypt_SymEnc.encrypted))

:named typing_Encrypt_SymEnc.encrypted))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Encrypt_SymEnc.cipher; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(40,5-40,11); use=Encrypt_SymEnc.fst(40,5-40,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Encrypt_SymEnc.key @x0
@x1)))
(HasType (Encrypt_SymEnc.cipher @x0
@x1
@x2)
Tm_type))
 

:pattern ((Encrypt_SymEnc.cipher @x0
@x1
@x2))
:qid typing_Encrypt_SymEnc.cipher))

:named typing_Encrypt_SymEnc.cipher))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Encrypt_SymEnc.bytes; Namespace Encrypt_SymEnc
(assert (! (HasType Encrypt_SymEnc.bytes
Tm_type)
:named typing_Encrypt_SymEnc.bytes))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AES.csize; Namespace AES
(assert (! 
;; def=AES.fst(27,4-27,9); use=AES.fst(27,4-27,9)
(forall ((@u0 Dummy_sort))
 (! (HasType (AES.csize @u0)
Prims.int)
 

:pattern ((AES.csize @u0))
:qid typing_AES.csize))

:named typing_AES.csize))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name AES.cipher; Namespace AES
(assert (! (HasType AES.cipher
Tm_type)
:named typing_AES.cipher))
;;;;;;;;;;;;;;;;name-token correspondence
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Encrypt_SymEnc.entry; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Entry; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(59,10-59,15); use=Encrypt_SymEnc.fst(59,10-59,15)
(forall ((@x0 Term))
 (! (= (ApplyTT Encrypt_SymEnc.entry@tok
@x0)
(Encrypt_SymEnc.entry @x0))
 

:pattern ((ApplyTT Encrypt_SymEnc.entry@tok
@x0))

:pattern ((Encrypt_SymEnc.entry @x0))
:qid token_correspondence_Encrypt_SymEnc.entry@tok))

:named token_correspondence_Encrypt_SymEnc.entry@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name Encrypt_SymEnc.entry; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Entry; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(60,4-60,9); use=Encrypt_SymEnc.fst(60,4-60,9)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Encrypt_SymEnc.Entry @x1
@x2
@x3
@x4)
(Encrypt_SymEnc.entry @x5))
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
@x2
(Encrypt_SymEnc.Entry @x1
...
@x4)
(Encrypt_SymEnc.entry @x5)))
:qid subterm_ordering_Encrypt_SymEnc.Entry))

:named subterm_ordering_Encrypt_SymEnc.Entry))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name Encrypt_SymEnc.cipher; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(40,45-40,75); use=Encrypt_SymEnc.fst(40,45-40,75)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_2ccb7058860a095a0f0b25bced8444a0 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_2ccb7058860a095a0f0b25bced8444a0 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_2ccb7058860a095a0f0b25bced8444a0))

:named refinement_kinding_Tm_refine_2ccb7058860a095a0f0b25bced8444a0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pure_post'; Namespace Prims
(assert (! 
;; def=Prims.fst(315,31-315,40); use=Prims.fst(315,31-315,40)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_2ccb7058860a095a0f0b25bced8444a0 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Encrypt_SymEnc.fst(40,60-40,73); use=Encrypt_SymEnc.fst(40,60-40,73)
(Valid 
;; def=Encrypt_SymEnc.fst(40,60-40,73); use=Encrypt_SymEnc.fst(40,60-40,73)
(Encrypt_SymEnc.encrypted @x2
@x3
@x4
@x1)
)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_2ccb7058860a095a0f0b25bced8444a0))

:named refinement_interpretation_Tm_refine_2ccb7058860a095a0f0b25bced8444a0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
...
;; def=Encrypt_SymEnc.fst(60,4-60,9); use=Encrypt_SymEnc.fst(60,4-60,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Encrypt_SymEnc.Entry_plain (Encrypt_SymEnc.Entry @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_Encrypt_SymEnc.Entry_plain))

:named projection_inverse_Encrypt_SymEnc.Entry_plain))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.entry; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Entry; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(60,4-60,9); use=Encrypt_SymEnc.fst(60,4-60,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Encrypt_SymEnc.Entry_p (Encrypt_SymEnc.Entry @x0
@x1
@x2
@x3))
@x0)
...
@x2
@x3))
:qid projection_inverse_Encrypt_SymEnc.Entry_p))

:named projection_inverse_Encrypt_SymEnc.Entry_p))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.entry; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Entry; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(60,4-60,9); use=Encrypt_SymEnc.fst(60,4-60,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Encrypt_SymEnc.Entry_k (Encrypt_SymEnc.Entry @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Encrypt_SymEnc.Entry_k))

:named projection_inverse_Encrypt_SymEnc.Entry_k))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Encrypt_SymEnc.entry; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Entry; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(60,4-60,9); use=Encrypt_SymEnc.fst(60,4-60,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Encrypt_SymEnc.Entry_c (Encrypt_SymEnc.Entry @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Encrypt_SymEnc.Entry_c))

:named projection_inverse_Encrypt_SymEnc.Entry_c))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Encrypt_SymEnc.entry; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Entry; Namespace Encrypt_SymEnc
(assert (! (is-Tm_arrow (PreType Encrypt_SymEnc.entry@tok))
:named pre_kinding_Encrypt_SymEnc.entry@tok))
...
;;; Fact-ids: Name Encrypt_SymEnc.entry; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Entry; Namespace Encrypt_SymEnc
(assert (! (and (IsTotFun Encrypt_SymEnc.entry@tok)

;; def=Encrypt_SymEnc.fst(59,10-59,15); use=Encrypt_SymEnc.fst(59,10-59,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Encrypt_SymEnc.entry @x0)
Tm_type))
 

:pattern ((Encrypt_SymEnc.entry @x0))
:qid kinding_Encrypt_SymEnc.entry@tok))
)
:named kinding_Encrypt_SymEnc.entry@tok))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_2ccb7058860a095a0f0b25bced8444a0
;;; Fact-ids: Name Encrypt_SymEnc.cipher; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(40,45-40,75); use=Encrypt_SymEnc.fst(40,45-40,75)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_2ccb7058860a095a0f0b25bced8444a0 @x0
@x1
@x2)))
(Valid (Prims.hasEq AES.cipher)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_2ccb7058860a095a0f0b25bced8444a0 @x0
@x1
@x2))))
:qid haseqTm_refine_2ccb7058860a095a0f0b25bced8444a0))

:named haseqTm_refine_2ccb7058860a095a0f0b25bced8444a0))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name Prims.prop; Namespace Prims
(assert (! (HasType Prims.prop
Tm_type)
...
(assert (! (HasType Encrypt_SymEnc.bytes
Tm_type)
:named function_token_typing_Encrypt_SymEnc.bytes))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name AES.cipher; Namespace AES
(assert (! (HasType AES.cipher
Tm_type)
:named function_token_typing_AES.cipher))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(614,5-614,9); use=Prims.fst(614,5-614,9)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Encrypt_SymEnc.entry @x2))
(and (is-Encrypt_SymEnc.Entry @x1)
(= @x2
(Encrypt_SymEnc.Entry_p @x1))))
 

:pattern ((HasTypeFuel @u0
@x1
(Encrypt_SymEnc.entry @x2)))
:qid fuel_guarded_inversion_Encrypt_SymEnc.entry))

:named fuel_guarded_inversion_Encrypt_SymEnc.entry))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! (= 319
...
;;; Fact-ids: Name Encrypt_SymEnc.entry; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Entry; Namespace Encrypt_SymEnc
(assert (! (= 206
(Term_constr_id Encrypt_SymEnc.entry@tok))
:named fresh_token_Encrypt_SymEnc.entry@tok))
...
;;;;;;;;;;;;;;;;Equation for Encrypt_SymEnc.cipher
;;; Fact-ids: Name Encrypt_SymEnc.cipher; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(40,5-40,11); use=Encrypt_SymEnc.fst(40,5-40,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Encrypt_SymEnc.cipher @x0
@x1
@x2)
(Tm_refine_2ccb7058860a095a0f0b25bced8444a0 @x0
@x1
@x2))
...
@x1
@x2))
:qid equation_Encrypt_SymEnc.cipher))

:named equation_Encrypt_SymEnc.cipher))
;;;;;;;;;;;;;;;;Equation for Encrypt_SymEnc.bytes
;;; Fact-ids: Name Encrypt_SymEnc.bytes; Namespace Encrypt_SymEnc
(assert (! (= Encrypt_SymEnc.bytes
Platform.Bytes.bytes)
:named equation_Encrypt_SymEnc.bytes))
;;;;;;;;;;;;;;;;Equation for AES.csize
;;; Fact-ids: Name AES.csize; Namespace AES
(assert (! 
;; def=AES.fst(27,4-27,9); use=AES.fst(27,4-27,9)
(forall ((@u0 Dummy_sort))
...
:qid equation_AES.csize))

:named equation_AES.csize))
;;;;;;;;;;;;;;;;Equation for AES.cipher
;;; Fact-ids: Name AES.cipher; Namespace AES
(assert (! (= AES.cipher
(AES.nbytes (AES.csize Dummy_value)))
:named equation_AES.cipher))
...
@x4)
(Encrypt_SymEnc.entry @x1)))
:qid data_typing_intro_Encrypt_SymEnc.Entry@tok))

:named data_typing_intro_Encrypt_SymEnc.Entry@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(615,4-615,7); use=Prims.fst(615,4-615,7)
...
(HasTypeFuel @u0
@x2
(Encrypt_SymEnc.key @x5
AES.plain))
(HasTypeFuel @u0
@x3
(Encrypt_SymEnc.cipher @x5
AES.plain
@x2))
(HasTypeFuel @u0
@x4
...
@x4)
(Encrypt_SymEnc.entry @x5)))
:qid data_elim_Encrypt_SymEnc.Entry))

:named data_elim_Encrypt_SymEnc.Entry))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.list; Namespace Prims; Name Prims.Nil; Namespace Prims; Name Prims.Cons; Namespace Prims
(assert (! 
;; def=Prims.fst(614,5-614,9); use=Prims.fst(614,5-614,9)
...
(forall ((@x0 Term))
 (! (= 205
(Term_constr_id (Encrypt_SymEnc.entry @x0)))
 

:pattern ((Encrypt_SymEnc.entry @x0))
:qid constructor_distinct_Encrypt_SymEnc.entry))

:named constructor_distinct_Encrypt_SymEnc.entry))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Encrypt_SymEnc.entry; Namespace Encrypt_SymEnc; Name Encrypt_SymEnc.Entry; Namespace Encrypt_SymEnc
(assert (! 
;; def=Encrypt_SymEnc.fst(60,4-60,9); use=Encrypt_SymEnc.fst(60,4-60,9)
...
@x0
(Encrypt_SymEnc.entry @x2)))
:qid Encrypt_SymEnc_pretyping_acb87ff79abbfe702a5142198d21c167))

:named Encrypt_SymEnc_pretyping_acb87ff79abbfe702a5142198d21c167))
(push) ;; push{2

; Starting query at Encrypt_SymEnc.fst(62,47-62,58)
...
;       (FStar.ST.ref (Prims.list Encrypt_SymEnc.entry)))
;     (h: FStar.Monotonic.Heap.heap).
;     (forall (a: FStar.ST.ref (Prims.list Encrypt_SymEnc.entry)) (h1: FStar.Monotonic.Heap.heap).
;         Prims.auto_squash (p a h1)) ==>
;     (forall (a:
;         FStar.ST.mref (Prims.list Encrypt_SymEnc.entry)
;           (FStar.Heap.trivial_preorder (Prims.list Encrypt_SymEnc.entry)))
;         (h1: FStar.Monotonic.Heap.heap).
;         FStar.Monotonic.Heap.fresh a h h1 /\ FStar.Monotonic.Heap.modifies FStar.Set.empty h h1 /\
;         FStar.Monotonic.Heap.sel h1 a == [] ==>
;         p a h1)


; Context: While encoding a query
; While typechecking the top-level declaration `let log`
...
(forall ((@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x1
(FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap
(FStar.ST.ref (Prims.list (Encrypt_SymEnc.entry @x0)))))
(HasType @x2
FStar.Monotonic.Heap.heap)

;; def=FStar.ST.fst(76,50-76,87); use=Encrypt_SymEnc.fst(62,47-62,58)
...
;; def=FStar.ST.fst(76,80-76,86); use=Encrypt_SymEnc.fst(62,47-62,58)
(Valid 
;; def=FStar.ST.fst(76,80-76,86); use=Encrypt_SymEnc.fst(62,47-62,58)
(ApplyTT (ApplyTT @x1
@x3)
...
;; def=FStar.ST.fst(76,50-76,87); use=Encrypt_SymEnc.fst(62,50-62,55)
(forall ((@x3 Term) (@x4 Term))
 (! (implies (and (HasType @x3
(FStar.ST.mref (Prims.list (Encrypt_SymEnc.entry @x0))
(FStar.Heap.trivial_preorder (Prims.list (Encrypt_SymEnc.entry @x0)))))
(HasType @x4
FStar.Monotonic.Heap.heap)

;; def=FStar.ST.fst(89,22-89,35); use=Encrypt_SymEnc.fst(62,50-62,55)
(Valid 
;; def=FStar.ST.fst(89,22-89,35); use=Encrypt_SymEnc.fst(62,50-62,55)
(FStar.Monotonic.Heap.fresh (Prims.list (Encrypt_SymEnc.entry @x0))
(FStar.Heap.trivial_preorder (Prims.list (Encrypt_SymEnc.entry @x0)))
@x3
@x2
@x4)
...
;; def=FStar.ST.fst(89,39-89,63); use=Encrypt_SymEnc.fst(62,50-62,55)
(Valid 
;; def=FStar.ST.fst(89,39-89,63); use=Encrypt_SymEnc.fst(62,50-62,55)
...
;; def=FStar.ST.fst(89,67-89,83); use=Encrypt_SymEnc.fst(62,50-62,55)
(= (FStar.Monotonic.Heap.sel (Prims.list (Encrypt_SymEnc.entry @x0))
(FStar.Heap.trivial_preorder (Prims.list (Encrypt_SymEnc.entry @x0)))
@x4
@x3)
(Prims.Nil (Encrypt_SymEnc.entry @x0)))
)

;; def=FStar.Pervasives.fsti(463,24-463,34); use=Encrypt_SymEnc.fst(62,47-62,58)
(Valid 
;; def=FStar.Pervasives.fsti(463,24-463,34); use=Encrypt_SymEnc.fst(62,47-62,58)
(ApplyTT (ApplyTT @x1
@x3)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.log, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_FStar.ST.ref
...
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Encrypt_SymEnc.log (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Encrypt_SymEnc.log@tok () Term)
...
; Starting query at Encrypt_SymEnc.fst(65,2-71,93)
...
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(44,33-64,14); use=Encrypt_SymEnc.fst(64,13-66,9)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x0)
Tm_type)
...
; Encoding query formula : forall (p: Type) (k: Encrypt_SymEnc.key p AES.plain) (text: p).
;   (*  - Could not prove post-condition
; *)
;   forall (h0: FStar.Monotonic.Heap.heap)
;     (k: FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap (Encrypt_SymEnc.cipher p AES.plain k)).
;     (forall (x: Encrypt_SymEnc.cipher p AES.plain k) (h: FStar.Monotonic.Heap.heap).
;         {:pattern Prims.guard_free (k x h)}
;         Prims.auto_squash (k x h)) ==>
;     (~(Ideal? k) /\ ~(Concrete? k) ==> Prims.l_False) /\
;     (forall (b: (_: AES.plain -> p)) (b: (_: p -> AES.plain)) (b: AES.key) (b: Prims.int).
;         k == Encrypt_SymEnc.Ideal b b b b ==>
;         (forall (c: AES.cipher).
;             (*  - Subtyping check failed
;   - Expected type Prims.eqtype got type Type0
; *)
;             Prims.hasEq AES.plain))


; Context: While encoding a query
; While typechecking the top-level declaration `let encrypt`
...
;; def=FStar.Pervasives.fsti(478,2-479,93); use=Encrypt_SymEnc.fst(65,2-71,93)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(FStar.Pervasives.st_post_h FStar.Monotonic.Heap.heap
(Encrypt_SymEnc.cipher @x0
...
;; def=FStar.Pervasives.fsti(479,4-479,81); use=Encrypt_SymEnc.fst(65,2-71,93)
(forall ((@x5 Term) (@x6 Term))
 (! 
;; def=FStar.Pervasives.fsti(479,75-479,80); use=Encrypt_SymEnc.fst(65,2-71,93)
(Valid 
;; def=FStar.Pervasives.fsti(479,75-479,80); use=Encrypt_SymEnc.fst(65,2-71,93)
(ApplyTT (ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=Encrypt_SymEnc.fst(65,2-71,93)
(and (implies 
;; def=Encrypt_SymEnc.fst(64,15-64,16); use=Encrypt_SymEnc.fst(65,8-65,9)
(and 
;; def=Encrypt_SymEnc.fst(64,15-64,16); use=Encrypt_SymEnc.fst(65,8-65,9)
(not 
;; def=Encrypt_SymEnc.fst(64,15-64,16); use=Encrypt_SymEnc.fst(65,8-65,9)
...
;; def=FStar.Pervasives.fsti(489,2-489,27); use=Encrypt_SymEnc.fst(65,2-71,93)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x0))
...
;; def=Encrypt_SymEnc.fst(64,15-66,25); use=Encrypt_SymEnc.fst(65,8-66,25)
(= @x1
(Encrypt_SymEnc.Ideal @x0
AES.plain
@x5
@x6
@x7
...
;; def=dummy(0,0-0,0); use=Encrypt_SymEnc.fst(66,28-70,28)
(forall ((@x9 Term))
 (! (implies (HasType @x9
AES.cipher)

;; def=Prims.fst(73,23-73,30); use=Encrypt_SymEnc.fst(66,41-66,44)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.encrypt, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Platform.Bytes.HasEq_bytes, disc_equation_Encrypt_SymEnc.Concrete, disc_equation_Encrypt_SymEnc.Ideal, equation_AES.bytes, equation_AES.nbytes, equation_AES.plain, equation_AES.psize, fuel_guarded_inversion_Encrypt_SymEnc.key, haseqTm_refine_8f0006372dc7eef1f8d6507769207c67, projection_inverse_BoxBool_proj_0
...
; encoding sigelt let encrypt


; <Start encoding let encrypt>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Encrypt_SymEnc.encrypt (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Encrypt_SymEnc.encrypt@tok () Term)

; </end encoding let encrypt>
...
; Starting query at Encrypt_SymEnc.fst(75,2-81,52)
...
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(43,33-74,14); use=Encrypt_SymEnc.fst(74,13-76,9)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x0)
Tm_type)
...
:named Encrypt_SymEnc_interpretation_Tm_arrow_3b7f0f2bf04b3d9ba43f33de7ae8642e))
(declare-fun Tm_refine_c00866a52f40da4c555639f9621dfdfd (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(40,45-40,73); use=Encrypt_SymEnc.fst(77,28-77,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_c00866a52f40da4c555639f9621dfdfd @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_c00866a52f40da4c555639f9621dfdfd @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_c00866a52f40da4c555639f9621dfdfd))

:named refinement_kinding_Tm_refine_c00866a52f40da4c555639f9621dfdfd))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(40,45-40,73); use=Encrypt_SymEnc.fst(77,28-77,32)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c00866a52f40da4c555639f9621dfdfd @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Encrypt_SymEnc.fst(40,60-40,73); use=Encrypt_SymEnc.fst(77,28-77,32)
(or 
;; def=Encrypt_SymEnc.fst(40,60-40,73); use=Encrypt_SymEnc.fst(77,28-77,32)
(Valid 
;; def=Encrypt_SymEnc.fst(40,60-40,73); use=Encrypt_SymEnc.fst(77,28-77,32)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_c00866a52f40da4c555639f9621dfdfd))

:named refinement_interpretation_Tm_refine_c00866a52f40da4c555639f9621dfdfd))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c00866a52f40da4c555639f9621dfdfd
;;; Fact-ids: 
(assert (! 
;; def=Encrypt_SymEnc.fst(40,45-40,73); use=Encrypt_SymEnc.fst(77,28-77,32)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c00866a52f40da4c555639f9621dfdfd @x0
@x1
@x2)))
(Valid (Prims.hasEq AES.cipher)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c00866a52f40da4c555639f9621dfdfd @x0
@x1
@x2))))
:qid haseqTm_refine_c00866a52f40da4c555639f9621dfdfd))

:named haseqTm_refine_c00866a52f40da4c555639f9621dfdfd))

; Encoding query formula : forall (p: Type) (k: Encrypt_SymEnc.key p AES.plain) (c: Encrypt_SymEnc.cipher p AES.plain k).
;   (*  - Could not prove post-condition
; *)
;   forall (h0: FStar.Monotonic.Heap.heap)
;     (k: FStar.Pervasives.all_post_h FStar.Monotonic.Heap.heap p).
;     (forall (x: FStar.Pervasives.result p) (h: FStar.Monotonic.Heap.heap).
;         {:pattern Prims.guard_free (k x h)}
;         Prims.auto_squash (k x h)) ==>
;     (~(Ideal? k) /\ ~(Concrete? k) ==> Prims.l_False) /\
;     (forall (b: (_: AES.plain -> p)) (b: (_: p -> AES.plain)) (b: AES.key) (b: Prims.int).
;         k == Encrypt_SymEnc.Ideal b b b b ==>
;         (forall (_: Encrypt_SymEnc.entry).
;             (*  - Could not prove post-condition
; *)
;             forall (b: Encrypt_SymEnc.key p AES.plain)
;               (b: Encrypt_SymEnc.cipher p AES.plain b)
;               (b: p).
;               _ == Encrypt_SymEnc.Entry b b b ==>
;               Prims.hasEq AES.cipher /\
;               (forall (any_result: Type0).
;                   c:
;                   AES.cipher{Encrypt_SymEnc.encrypted k c \/ Encrypt_SymEnc.encrypted b c} ==
;                   any_result ==>
;                   (Encrypt_SymEnc.encrypted k c ==>
;                     Encrypt_SymEnc.encrypted k c \/ Encrypt_SymEnc.encrypted b c) /\
;                   (forall (any_result: Encrypt_SymEnc.cipher p AES.plain k).
;                       c == any_result ==>
;                       Encrypt_SymEnc.encrypted b b ==>
;                       Encrypt_SymEnc.encrypted k b \/ Encrypt_SymEnc.encrypted b b)))
;         <:
;         Prims.GTot Type0)


; Context: While encoding a query
; While typechecking the top-level declaration `let decrypt`
...
;; def=FStar.Pervasives.fsti(667,4-667,88); use=Encrypt_SymEnc.fst(75,2-81,52)
(forall ((@x5 Term) (@x6 Term))
 (! 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=Encrypt_SymEnc.fst(75,2-81,52)
(Valid 
;; def=FStar.Pervasives.fsti(667,82-667,87); use=Encrypt_SymEnc.fst(75,2-81,52)
(ApplyTT (ApplyTT @x4
@x5)
...
;; def=Prims.fst(459,77-459,89); use=Encrypt_SymEnc.fst(75,2-81,52)
(and (implies 
;; def=Encrypt_SymEnc.fst(74,15-74,16); use=Encrypt_SymEnc.fst(75,8-75,9)
(and 
;; def=Encrypt_SymEnc.fst(74,15-74,16); use=Encrypt_SymEnc.fst(75,8-75,9)
(not 
;; def=Encrypt_SymEnc.fst(74,15-74,16); use=Encrypt_SymEnc.fst(75,8-75,9)
...
;; def=FStar.Pervasives.fsti(681,7-681,32); use=Encrypt_SymEnc.fst(75,2-81,52)
(forall ((@x5 Term))
 (! (implies (HasType @x5
(Tm_arrow_aede19a9083f90c34f37ddcd46a8aba0 @x0))
...
;; def=Encrypt_SymEnc.fst(74,15-76,25); use=Encrypt_SymEnc.fst(75,8-76,25)
(= @x1
(Encrypt_SymEnc.Ideal @x0
AES.plain
@x5
...
;; def=dummy(0,0-0,0); use=Encrypt_SymEnc.fst(75,2-81,52)
(forall ((@x9 Term))
 (! (implies (HasType @x9
(Encrypt_SymEnc.entry @x0))

;; def=Prims.fst(413,99-413,120); use=Encrypt_SymEnc.fst(77,28-77,32)
(forall ((@x10 Term))
 (! (implies (HasType @x10
(Encrypt_SymEnc.key @x0
AES.plain))
...
;; def=Encrypt_SymEnc.fst(77,11-77,24); use=Encrypt_SymEnc.fst(77,28-77,32)
(= @x9
(Encrypt_SymEnc.Entry @x0
@x10
@x11
...
;; def=Prims.fst(459,77-459,89); use=Encrypt_SymEnc.fst(77,28-77,32)
(and 
;; def=Encrypt_SymEnc.fst(40,47-40,57); use=Encrypt_SymEnc.fst(40,45-40,73)
(or label_2

;; def=Encrypt_SymEnc.fst(40,47-40,57); use=Encrypt_SymEnc.fst(77,28-77,32)
(Valid 
;; def=Encrypt_SymEnc.fst(40,47-40,57); use=Encrypt_SymEnc.fst(77,28-77,32)
(Prims.hasEq AES.cipher)
)
...
;; def=Prims.fst(451,66-451,102); use=Encrypt_SymEnc.fst(77,28-77,32)
(forall ((@x13 Term))
 (! (implies (and (HasType @x13
Tm_type)

;; def=Prims.fst(588,31-588,32); use=Encrypt_SymEnc.fst(77,28-77,32)
(= (Tm_refine_c00866a52f40da4c555639f9621dfdfd @x0
@x1
@x10)
@x13)
)
...
;; def=Prims.fst(459,77-459,89); use=Encrypt_SymEnc.fst(77,28-77,32)
(and (implies 
;; def=Encrypt_SymEnc.fst(40,60-40,73); use=Encrypt_SymEnc.fst(77,28-77,29)
(Valid 
;; def=Encrypt_SymEnc.fst(40,60-40,73); use=Encrypt_SymEnc.fst(77,28-77,29)
(Encrypt_SymEnc.encrypted @x0
AES.plain
@x1
@x2)
)
...
;; def=dummy(0,0-0,0); use=Encrypt_SymEnc.fst(77,28-77,32)
(= @x2
@x14)


;; def=Encrypt_SymEnc.fst(40,60-40,73); use=Encrypt_SymEnc.fst(77,30-77,32)
(Valid 
;; def=Encrypt_SymEnc.fst(40,60-40,73); use=Encrypt_SymEnc.fst(77,30-77,32)
(Encrypt_SymEnc.encrypted @x0
AES.plain
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Encrypt_SymEnc.decrypt, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, assumption_Platform.Bytes.HasEq_bytes, disc_equation_Encrypt_SymEnc.Concrete, disc_equation_Encrypt_SymEnc.Ideal, equation_AES.bytes, equation_AES.cipher, equation_AES.csize, equation_AES.nbytes, equation_AES.plain, fuel_guarded_inversion_Encrypt_SymEnc.key, haseqTm_refine_8f0006372dc7eef1f8d6507769207c67, projection_inverse_BoxBool_proj_0
