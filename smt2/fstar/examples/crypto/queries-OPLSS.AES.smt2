...
;;;;;;;;;;;;;;;;data constructor proxy: FStar.ModifiesGen.Cls
(declare-fun FStar.ModifiesGen.Cls@tok () Term)
...
; </end encoding type FStar.ModifiesGen.cls>


; <Start encoding val FStar.ModifiesGen.uu___is_Cls>

(declare-fun FStar.ModifiesGen.uu___is_Cls (Term Term) Term)
(declare-fun Tm_ghost_arrow_f754b7d644c427ad07bd07b148cc4602 () Term)
(declare-fun FStar.ModifiesGen.uu___is_Cls@tok () Term)

; </end encoding val FStar.ModifiesGen.uu___is_Cls>


; <Skipped let uu___is_Cls/>


; <Start encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_includes>
...
; </end encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_includes>


; <Skipped let __proj__Cls__item__aloc_includes/>


; <Start encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_includes_refl>
...
; </end encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_includes_refl>


; <Skipped let __proj__Cls__item__aloc_includes_refl/>


; <Start encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_includes_trans>
...
; </end encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_includes_trans>


; <Skipped let __proj__Cls__item__aloc_includes_trans/>


; <Start encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_disjoint>
...
; </end encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_disjoint>


; <Skipped let __proj__Cls__item__aloc_disjoint/>


; <Start encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_disjoint_sym>
...
; </end encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_disjoint_sym>


; <Skipped let __proj__Cls__item__aloc_disjoint_sym/>


; <Start encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_disjoint_includes>
...
; </end encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_disjoint_includes>


; <Skipped let __proj__Cls__item__aloc_disjoint_includes/>


; <Start encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_preserved>
...
; </end encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_preserved>


; <Skipped let __proj__Cls__item__aloc_preserved/>


; <Start encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_preserved_refl>
...
; </end encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_preserved_refl>


; <Skipped let __proj__Cls__item__aloc_preserved_refl/>


; <Start encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_preserved_trans>
...
; </end encoding val FStar.ModifiesGen.__proj__Cls__item__aloc_preserved_trans>


; <Skipped let __proj__Cls__item__aloc_preserved_trans/>


; <Start encoding val FStar.ModifiesGen.__proj__Cls__item__same_mreference_aloc_preserved>
...
; </end encoding val FStar.ModifiesGen.__proj__Cls__item__same_mreference_aloc_preserved>


; <Skipped let __proj__Cls__item__same_mreference_aloc_preserved/>


; <Start encoding val FStar.ModifiesGen.loc>
...
; </end encoding val FStar.ModifiesGen.loc>


; <Start encoding val FStar.ModifiesGen.loc_none>
...
; </end encoding val FStar.ModifiesGen.loc_none>


; <Start encoding val FStar.ModifiesGen.loc_union>

(declare-fun FStar.ModifiesGen.loc_union (Term Term Term Term) Term)
(declare-fun Tm_arrow_2d053c0dc13941e70a838c4077ca0e7b () Term)
(declare-fun FStar.ModifiesGen.loc_union@tok () Term)

; </end encoding val FStar.ModifiesGen.loc_union>


; <Start encoding val FStar.ModifiesGen.loc_union_idem>
...
; </end encoding val FStar.ModifiesGen.loc_union_idem>


; <Start encoding val FStar.ModifiesGen.loc_union_comm>
...
; </end encoding val FStar.ModifiesGen.loc_union_comm>


; <Start encoding val FStar.ModifiesGen.loc_union_assoc>
...
; </end encoding val FStar.ModifiesGen.loc_union_assoc>


; <Start encoding val FStar.ModifiesGen.loc_union_loc_none_l>
...
; </end encoding val FStar.ModifiesGen.loc_union_loc_none_l>


; <Start encoding val FStar.ModifiesGen.loc_union_loc_none_r>
...
; </end encoding val FStar.ModifiesGen.loc_union_loc_none_r>


; <Start encoding val FStar.ModifiesGen.loc_of_aloc>

(declare-fun FStar.ModifiesGen.loc_of_aloc (Term Term Term Term Term) Term)
(declare-fun Tm_arrow_648ef7df429c5f728f1aed5a4a8ad7b1 () Term)
(declare-fun FStar.ModifiesGen.loc_of_aloc@tok () Term)

; </end encoding val FStar.ModifiesGen.loc_of_aloc>


; <Start encoding val FStar.ModifiesGen.loc_of_aloc_not_none>
...
; </end encoding val FStar.ModifiesGen.loc_of_aloc_not_none>


; <Start encoding val FStar.ModifiesGen.loc_addresses>

(declare-fun FStar.ModifiesGen.loc_addresses (Term Term Term Term Term) Term)
(declare-fun Tm_arrow_0139b7b9716616141cafad55b779fd7c () Term)
(declare-fun FStar.ModifiesGen.loc_addresses@tok () Term)

; </end encoding val FStar.ModifiesGen.loc_addresses>


; <Start encoding val FStar.ModifiesGen.loc_regions>

(declare-fun FStar.ModifiesGen.loc_regions (Term Term Term Term) Term)
(declare-fun Tm_arrow_7029fb305d3a630d9cc90946b8421dbd () Term)
(declare-fun FStar.ModifiesGen.loc_regions@tok () Term)

; </end encoding val FStar.ModifiesGen.loc_regions>


; <Start encoding let loc_mreference>

(declare-fun FStar.ModifiesGen.loc_mreference (Term Term Term Term Term) Term)
(declare-fun Tm_arrow_c6e77f4f921612e654df2e70064f7e53 () Term)
(declare-fun FStar.ModifiesGen.loc_mreference@tok () Term)

; </end encoding let loc_mreference>


; <Start encoding let loc_freed_mreference>
...
; </end encoding let loc_freed_mreference>


; <Start encoding let loc_region_only>

(declare-fun FStar.ModifiesGen.loc_region_only (Term Term Term Term) Term)
(declare-fun Tm_arrow_aca4b20d42632969acbf20ba75599058 () Term)
(declare-fun FStar.ModifiesGen.loc_region_only@tok () Term)

; </end encoding let loc_region_only>


; <Start encoding let loc_all_regions_from>
...
; </end encoding let loc_all_regions_from>


; <Start encoding val FStar.ModifiesGen.loc_includes>
...
; </end encoding val FStar.ModifiesGen.loc_includes>


; <Start encoding val FStar.ModifiesGen.loc_includes_refl>
...
; </end encoding val FStar.ModifiesGen.loc_includes_refl>


; <Start encoding val FStar.ModifiesGen.loc_includes_trans>
...
; </end encoding val FStar.ModifiesGen.loc_includes_trans>


; <Start encoding val FStar.ModifiesGen.loc_includes_union_r>
...
; </end encoding val FStar.ModifiesGen.loc_includes_union_r>


; <Start encoding val FStar.ModifiesGen.loc_includes_union_l>
...
; </end encoding val FStar.ModifiesGen.loc_includes_union_l>


; <Start encoding val FStar.ModifiesGen.loc_includes_none>
...
; </end encoding val FStar.ModifiesGen.loc_includes_none>


; <Start encoding val FStar.ModifiesGen.loc_includes_none_elim>
...
; </end encoding val FStar.ModifiesGen.loc_includes_none_elim>


; <Start encoding val FStar.ModifiesGen.loc_includes_aloc>
...
; </end encoding val FStar.ModifiesGen.loc_includes_aloc>


; <Start encoding val FStar.ModifiesGen.loc_includes_aloc_elim>
...
; </end encoding val FStar.ModifiesGen.loc_includes_aloc_elim>


; <Start encoding val FStar.ModifiesGen.loc_includes_addresses_aloc>
...
; </end encoding val FStar.ModifiesGen.loc_includes_addresses_aloc>


; <Start encoding val FStar.ModifiesGen.loc_includes_region_aloc>
...
; </end encoding val FStar.ModifiesGen.loc_includes_region_aloc>


; <Start encoding val FStar.ModifiesGen.loc_includes_region_addresses>
...
; </end encoding val FStar.ModifiesGen.loc_includes_region_addresses>


; <Start encoding val FStar.ModifiesGen.loc_includes_region_region>
...
; </end encoding val FStar.ModifiesGen.loc_includes_region_region>


; <Start encoding val FStar.ModifiesGen.loc_includes_region_union_l>
...
; </end encoding val FStar.ModifiesGen.loc_includes_region_union_l>


; <Start encoding val FStar.ModifiesGen.loc_includes_addresses_addresses>
...
; </end encoding val FStar.ModifiesGen.loc_includes_addresses_addresses>


; <Start encoding val FStar.ModifiesGen.loc_disjoint>

(declare-fun FStar.ModifiesGen.loc_disjoint (Term Term Term Term) Term)

(declare-fun FStar.ModifiesGen.loc_disjoint@tok () Term)

; </end encoding val FStar.ModifiesGen.loc_disjoint>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_sym>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_sym>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_none_r>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_none_r>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_union_r>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_union_r>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_includes>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_includes>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_aloc_intro>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_aloc_intro>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_aloc_elim>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_aloc_elim>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_addresses_intro>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_addresses_intro>


; <Start encoding let loc_disjoint_addresses>
...
; </end encoding let loc_disjoint_addresses>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_addresses_elim>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_addresses_elim>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_aloc_addresses_intro>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_aloc_addresses_intro>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_aloc_addresses_elim>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_aloc_addresses_elim>


; <Start encoding val FStar.ModifiesGen.loc_disjoint_regions>
...
; </end encoding val FStar.ModifiesGen.loc_disjoint_regions>


; <Start encoding val FStar.ModifiesGen.address_liveness_insensitive_locs>
...
; </end encoding val FStar.ModifiesGen.address_liveness_insensitive_locs>


; <Start encoding val FStar.ModifiesGen.loc_includes_address_liveness_insensitive_locs_aloc>
...
; </end encoding val FStar.ModifiesGen.loc_includes_address_liveness_insensitive_locs_aloc>


; <Start encoding val FStar.ModifiesGen.loc_includes_address_liveness_insensitive_locs_addresses>
...
; </end encoding val FStar.ModifiesGen.loc_includes_address_liveness_insensitive_locs_addresses>


; <Start encoding val FStar.ModifiesGen.region_liveness_insensitive_locs>
...
; </end encoding val FStar.ModifiesGen.region_liveness_insensitive_locs>


; <Start encoding val FStar.ModifiesGen.loc_includes_region_liveness_insensitive_locs_address_liveness_insensitive_locs>
...
; </end encoding val FStar.ModifiesGen.loc_includes_region_liveness_insensitive_locs_address_liveness_insensitive_locs>


; <Start encoding val FStar.ModifiesGen.loc_includes_region_liveness_insensitive_locs_loc_regions>
...
; </end encoding val FStar.ModifiesGen.loc_includes_region_liveness_insensitive_locs_loc_regions>


; <Start encoding val FStar.ModifiesGen.loc_includes_region_liveness_insensitive_locs_loc_addresses>
...
; </end encoding val FStar.ModifiesGen.loc_includes_region_liveness_insensitive_locs_loc_addresses>


; <Start encoding val FStar.ModifiesGen.loc_includes_region_liveness_insensitive_locs_loc_of_aloc>
...
; </end encoding val FStar.ModifiesGen.loc_includes_region_liveness_insensitive_locs_loc_of_aloc>


; <Start encoding val FStar.ModifiesGen.modifies>
...
; </end encoding val FStar.ModifiesGen.modifies>


; <Start encoding val FStar.ModifiesGen.modifies_intro>
...
; </end encoding val FStar.ModifiesGen.modifies_intro>


; <Start encoding val FStar.ModifiesGen.modifies_none_intro>
...
; </end encoding val FStar.ModifiesGen.modifies_none_intro>


; <Start encoding val FStar.ModifiesGen.modifies_address_intro>
...
; </end encoding val FStar.ModifiesGen.modifies_address_intro>


; <Start encoding val FStar.ModifiesGen.modifies_aloc_intro>
...
; </end encoding val FStar.ModifiesGen.modifies_aloc_intro>


; <Start encoding val FStar.ModifiesGen.modifies_live_region>
...
; </end encoding val FStar.ModifiesGen.modifies_live_region>


; <Start encoding val FStar.ModifiesGen.modifies_mreference_elim>
...
; </end encoding val FStar.ModifiesGen.modifies_mreference_elim>


; <Start encoding val FStar.ModifiesGen.modifies_aloc_elim>
...
; </end encoding val FStar.ModifiesGen.modifies_aloc_elim>


; <Start encoding val FStar.ModifiesGen.modifies_refl>
...
; </end encoding val FStar.ModifiesGen.modifies_refl>


; <Start encoding val FStar.ModifiesGen.modifies_loc_includes>
...
; </end encoding val FStar.ModifiesGen.modifies_loc_includes>


; <Start encoding val FStar.ModifiesGen.modifies_preserves_liveness>
...
; </end encoding val FStar.ModifiesGen.modifies_preserves_liveness>


; <Start encoding val FStar.ModifiesGen.modifies_preserves_liveness_strong>
...
; </end encoding val FStar.ModifiesGen.modifies_preserves_liveness_strong>


; <Start encoding val FStar.ModifiesGen.modifies_preserves_region_liveness>
...
; </end encoding val FStar.ModifiesGen.modifies_preserves_region_liveness>


; <Start encoding val FStar.ModifiesGen.modifies_preserves_region_liveness_reference>
...
; </end encoding val FStar.ModifiesGen.modifies_preserves_region_liveness_reference>


; <Start encoding val FStar.ModifiesGen.modifies_preserves_region_liveness_aloc>
...
; </end encoding val FStar.ModifiesGen.modifies_preserves_region_liveness_aloc>


; <Start encoding val FStar.ModifiesGen.modifies_trans>
...
; </end encoding val FStar.ModifiesGen.modifies_trans>


; <Start encoding val FStar.ModifiesGen.modifies_only_live_regions>
...
; </end encoding val FStar.ModifiesGen.modifies_only_live_regions>


; <Start encoding val FStar.ModifiesGen.no_upd_fresh_region>
...
; </end encoding val FStar.ModifiesGen.no_upd_fresh_region>


; <Start encoding val FStar.ModifiesGen.fresh_frame_modifies>
...
; </end encoding val FStar.ModifiesGen.fresh_frame_modifies>


; <Start encoding val FStar.ModifiesGen.new_region_modifies>
...
; </end encoding val FStar.ModifiesGen.new_region_modifies>


; <Start encoding val FStar.ModifiesGen.popped_modifies>
...
; </end encoding val FStar.ModifiesGen.popped_modifies>


; <Start encoding val FStar.ModifiesGen.modifies_fresh_frame_popped>
...
; </end encoding val FStar.ModifiesGen.modifies_fresh_frame_popped>


; <Start encoding val FStar.ModifiesGen.modifies_loc_regions_intro>
...
; </end encoding val FStar.ModifiesGen.modifies_loc_regions_intro>


; <Start encoding val FStar.ModifiesGen.modifies_loc_addresses_intro>
...
; </end encoding val FStar.ModifiesGen.modifies_loc_addresses_intro>


; <Start encoding val FStar.ModifiesGen.modifies_ralloc_post>
...
; </end encoding val FStar.ModifiesGen.modifies_ralloc_post>


; <Start encoding val FStar.ModifiesGen.modifies_salloc_post>
...
; </end encoding val FStar.ModifiesGen.modifies_salloc_post>


; <Start encoding val FStar.ModifiesGen.modifies_free>
...
; </end encoding val FStar.ModifiesGen.modifies_free>


; <Start encoding val FStar.ModifiesGen.modifies_none_modifies>
...
; </end encoding val FStar.ModifiesGen.modifies_none_modifies>


; <Start encoding val FStar.ModifiesGen.modifies_upd>
...
; </end encoding val FStar.ModifiesGen.modifies_upd>


; <Start encoding val FStar.ModifiesGen.modifies_strengthen>
...
; </end encoding val FStar.ModifiesGen.modifies_strengthen>


; <Start encoding val FStar.ModifiesGen.does_not_contain_addr>
...
; </end encoding val FStar.ModifiesGen.does_not_contain_addr>


; <Start encoding val FStar.ModifiesGen.not_live_region_does_not_contain_addr>
...
; </end encoding val FStar.ModifiesGen.not_live_region_does_not_contain_addr>


; <Start encoding val FStar.ModifiesGen.unused_in_does_not_contain_addr>
...
; </end encoding val FStar.ModifiesGen.unused_in_does_not_contain_addr>


; <Start encoding val FStar.ModifiesGen.addr_unused_in_does_not_contain_addr>
...
; </end encoding val FStar.ModifiesGen.addr_unused_in_does_not_contain_addr>


; <Start encoding val FStar.ModifiesGen.does_not_contain_addr_addr_unused_in>
...
; </end encoding val FStar.ModifiesGen.does_not_contain_addr_addr_unused_in>


; <Start encoding val FStar.ModifiesGen.free_does_not_contain_addr>
...
; </end encoding val FStar.ModifiesGen.free_does_not_contain_addr>


; <Start encoding val FStar.ModifiesGen.does_not_contain_addr_elim>
...
; </end encoding val FStar.ModifiesGen.does_not_contain_addr_elim>


; <Start encoding val FStar.ModifiesGen.loc_not_unused_in>

(declare-fun FStar.ModifiesGen.loc_not_unused_in (Term Term Term) Term)
(declare-fun Tm_arrow_b402d00fb9ae9a041dfbbb4525d494c1 () Term)
(declare-fun FStar.ModifiesGen.loc_not_unused_in@tok () Term)

; </end encoding val FStar.ModifiesGen.loc_not_unused_in>


; <Start encoding val FStar.ModifiesGen.loc_unused_in>

(declare-fun FStar.ModifiesGen.loc_unused_in (Term Term Term) Term)

(declare-fun FStar.ModifiesGen.loc_unused_in@tok () Term)

; </end encoding val FStar.ModifiesGen.loc_unused_in>


; <Start encoding val FStar.ModifiesGen.loc_regions_unused_in>
...
; </end encoding val FStar.ModifiesGen.loc_regions_unused_in>


; <Start encoding val FStar.ModifiesGen.loc_addresses_unused_in>
...
; </end encoding val FStar.ModifiesGen.loc_addresses_unused_in>


; <Start encoding val FStar.ModifiesGen.loc_addresses_not_unused_in>
...
; </end encoding val FStar.ModifiesGen.loc_addresses_not_unused_in>


; <Start encoding val FStar.ModifiesGen.loc_unused_in_not_unused_in_disjoint>
...
; </end encoding val FStar.ModifiesGen.loc_unused_in_not_unused_in_disjoint>


; <Start encoding val FStar.ModifiesGen.not_live_region_loc_not_unused_in_disjoint>
...
; </end encoding val FStar.ModifiesGen.not_live_region_loc_not_unused_in_disjoint>


; <Start encoding val FStar.ModifiesGen.modifies_address_liveness_insensitive_unused_in>
...
; </end encoding val FStar.ModifiesGen.modifies_address_liveness_insensitive_unused_in>


; <Start encoding val FStar.ModifiesGen.modifies_only_not_unused_in>
...
; </end encoding val FStar.ModifiesGen.modifies_only_not_unused_in>


; <Start encoding let modifies_only_live_addresses>
...
; </end encoding let modifies_only_live_addresses>


; <Start encoding val FStar.ModifiesGen.mreference_live_loc_not_unused_in>
...
; </end encoding val FStar.ModifiesGen.mreference_live_loc_not_unused_in>


; <Start encoding val FStar.ModifiesGen.mreference_unused_in_loc_unused_in>
...
; </end encoding val FStar.ModifiesGen.mreference_unused_in_loc_unused_in>


; <Start encoding val FStar.ModifiesGen.aloc_union>
...
; </end encoding val FStar.ModifiesGen.aloc_union>


; <Start encoding val FStar.ModifiesGen.cls_union>
...
; </end encoding val FStar.ModifiesGen.cls_union>


; <Start encoding val FStar.ModifiesGen.union_loc_of_loc>
...
(declare-fun Tm_arrow_6e4ef40f8cc9d03c654dd501b133af1f () Term)
(declare-fun FStar.ModifiesGen.union_loc_of_loc@tok () Term)

; </end encoding val FStar.ModifiesGen.union_loc_of_loc>


; <Start encoding val FStar.ModifiesGen.union_loc_of_loc_none>
...
; </end encoding val FStar.ModifiesGen.union_loc_of_loc_none>


; <Start encoding val FStar.ModifiesGen.union_loc_of_loc_union>
...
; </end encoding val FStar.ModifiesGen.union_loc_of_loc_union>


; <Start encoding val FStar.ModifiesGen.union_loc_of_loc_addresses>
...
; </end encoding val FStar.ModifiesGen.union_loc_of_loc_addresses>


; <Start encoding val FStar.ModifiesGen.union_loc_of_loc_regions>
...
; </end encoding val FStar.ModifiesGen.union_loc_of_loc_regions>


; <Start encoding val FStar.ModifiesGen.union_loc_of_loc_includes>
...
; </end encoding val FStar.ModifiesGen.union_loc_of_loc_includes>


; <Start encoding val FStar.ModifiesGen.union_loc_of_loc_disjoint>
...
; </end encoding val FStar.ModifiesGen.union_loc_of_loc_disjoint>


; <Start encoding val FStar.ModifiesGen.modifies_union_loc_of_loc>
...
; </end encoding val FStar.ModifiesGen.modifies_union_loc_of_loc>


; <Start encoding val FStar.ModifiesGen.loc_of_union_loc>
...
(declare-fun Tm_arrow_d45b8dfc3593fe2743b2c918a263fafb () Term)
(declare-fun FStar.ModifiesGen.loc_of_union_loc@tok () Term)

; </end encoding val FStar.ModifiesGen.loc_of_union_loc>


; <Start encoding val FStar.ModifiesGen.loc_of_union_loc_union_loc_of_loc>
...
; </end encoding val FStar.ModifiesGen.loc_of_union_loc_union_loc_of_loc>


; <Start encoding val FStar.ModifiesGen.loc_of_union_loc_none>
...
; </end encoding val FStar.ModifiesGen.loc_of_union_loc_none>


; <Start encoding val FStar.ModifiesGen.loc_of_union_loc_union>
...
; </end encoding val FStar.ModifiesGen.loc_of_union_loc_union>


; <Start encoding val FStar.ModifiesGen.loc_of_union_loc_addresses>
...
; </end encoding val FStar.ModifiesGen.loc_of_union_loc_addresses>


; <Start encoding val FStar.ModifiesGen.loc_of_union_loc_regions>
...
; </end encoding val FStar.ModifiesGen.loc_of_union_loc_regions>


; <Start encoding val FStar.ModifiesGen.raise_aloc>
...
; </end encoding val FStar.ModifiesGen.raise_aloc>


; <Start encoding val FStar.ModifiesGen.raise_cls>
...
; </end encoding val FStar.ModifiesGen.raise_cls>


; <Start encoding val FStar.ModifiesGen.raise_loc>
...
; </end encoding val FStar.ModifiesGen.raise_loc>


; <Start encoding val FStar.ModifiesGen.raise_loc_none>
...
; </end encoding val FStar.ModifiesGen.raise_loc_none>


; <Start encoding val FStar.ModifiesGen.raise_loc_union>
...
; </end encoding val FStar.ModifiesGen.raise_loc_union>


; <Start encoding val FStar.ModifiesGen.raise_loc_addresses>
...
; </end encoding val FStar.ModifiesGen.raise_loc_addresses>


; <Start encoding val FStar.ModifiesGen.raise_loc_regions>
...
; </end encoding val FStar.ModifiesGen.raise_loc_regions>


; <Start encoding val FStar.ModifiesGen.raise_loc_includes>
...
; </end encoding val FStar.ModifiesGen.raise_loc_includes>


; <Start encoding val FStar.ModifiesGen.raise_loc_disjoint>
...
; </end encoding val FStar.ModifiesGen.raise_loc_disjoint>


; <Start encoding val FStar.ModifiesGen.modifies_raise_loc>
...
; </end encoding val FStar.ModifiesGen.modifies_raise_loc>


; <Start encoding val FStar.ModifiesGen.lower_loc>
...
; </end encoding val FStar.ModifiesGen.lower_loc>


; <Start encoding val FStar.ModifiesGen.lower_loc_raise_loc>
...
; </end encoding val FStar.ModifiesGen.lower_loc_raise_loc>


; <Start encoding val FStar.ModifiesGen.raise_loc_lower_loc>
...
; </end encoding val FStar.ModifiesGen.raise_loc_lower_loc>


; <Start encoding val FStar.ModifiesGen.lower_loc_none>
...
; </end encoding val FStar.ModifiesGen.lower_loc_none>


; <Start encoding val FStar.ModifiesGen.lower_loc_union>
...
; </end encoding val FStar.ModifiesGen.lower_loc_union>


; <Start encoding val FStar.ModifiesGen.lower_loc_addresses>
...
; </end encoding val FStar.ModifiesGen.lower_loc_addresses>


; <Start encoding val FStar.ModifiesGen.lower_loc_regions>
...
; </end encoding val FStar.ModifiesGen.lower_loc_regions>
...
; <Start encoding let __reduce__>

(declare-fun FStar.BigOps.__reduce__ (Dummy_sort) Term)

; </end encoding let __reduce__>
...
; <Start encoding val FStar.BigOps.normal_eq>
...
; </end encoding val FStar.BigOps.normal_eq>


; <Start encoding let map_op'>
...
; </end encoding let map_op'>


; <Start encoding val FStar.BigOps.map_op'_nil>
...
; </end encoding val FStar.BigOps.map_op'_nil>


; <Start encoding val FStar.BigOps.map_op'_cons>
...
; </end encoding val FStar.BigOps.map_op'_cons>


; <Start encoding let big_and'>
...
; </end encoding let big_and'>


; <Start encoding val FStar.BigOps.big_and'_nil>
...
; </end encoding val FStar.BigOps.big_and'_nil>


; <Start encoding val FStar.BigOps.big_and'_cons>
...
; </end encoding val FStar.BigOps.big_and'_cons>


; <Start encoding val FStar.BigOps.big_and'_prop>
...
; </end encoding val FStar.BigOps.big_and'_prop>


; <Start encoding val FStar.BigOps.big_and'_forall>
...
; </end encoding val FStar.BigOps.big_and'_forall>
...
; </end encoding let big_or'>


; <Start encoding val FStar.BigOps.big_or'_nil>
...
; </end encoding val FStar.BigOps.big_or'_nil>


; <Start encoding val FStar.BigOps.big_or'_cons>
...
; </end encoding val FStar.BigOps.big_or'_cons>


; <Start encoding val FStar.BigOps.big_or'_prop>
...
; </end encoding val FStar.BigOps.big_or'_prop>


; <Start encoding val FStar.BigOps.big_or'_exists>
...
; </end encoding val FStar.BigOps.big_or'_exists>
...
; <Start encoding let rec pairwise_op'>
...
; </end encoding let rec pairwise_op'>


; <Start encoding let symmetric>
...
; <Start encoding let anti_reflexive>
...
; </end encoding let anti_reflexive>


; <Start encoding let pairwise_and'>
...
; </end encoding let pairwise_and'>


; <Start encoding val FStar.BigOps.pairwise_and'_nil>
...
; </end encoding val FStar.BigOps.pairwise_and'_nil>


; <Start encoding val FStar.BigOps.pairwise_and'_cons>
...
; </end encoding val FStar.BigOps.pairwise_and'_cons>


; <Start encoding val FStar.BigOps.pairwise_and'_prop>
...
; </end encoding val FStar.BigOps.pairwise_and'_prop>


; <Start encoding val FStar.BigOps.pairwise_and'_forall>
...
; </end encoding val FStar.BigOps.pairwise_and'_forall>


; <Start encoding val FStar.BigOps.pairwise_and'_forall_no_repeats>
...
; </end encoding val FStar.BigOps.pairwise_and'_forall_no_repeats>
...
; <Start encoding let pairwise_or'>
...
; </end encoding let pairwise_or'>


; <Start encoding val FStar.BigOps.pairwise_or'_nil>
...
; </end encoding val FStar.BigOps.pairwise_or'_nil>


; <Start encoding val FStar.BigOps.pairwise_or'_cons>
...
; </end encoding val FStar.BigOps.pairwise_or'_cons>


; <Start encoding val FStar.BigOps.pairwise_or'_prop>
...
; </end encoding val FStar.BigOps.pairwise_or'_prop>


; <Start encoding val FStar.BigOps.pairwise_or'_exists>
...
; </end encoding val FStar.BigOps.pairwise_or'_exists>


; <Start encoding val FStar.BigOps.pairwise_or'_exists_no_repeats>
...
; </end encoding val FStar.BigOps.pairwise_or'_exists_no_repeats>
...
; Externals for interface LowStar.Monotonic.Buffer


; <Start encoding let srel>

(declare-fun LowStar.Monotonic.Buffer.srel (Term) Term)

(declare-fun LowStar.Monotonic.Buffer.srel@tok () Term)

; </end encoding let srel>


; <Start encoding let compatible_subseq_preorder>
...
; </end encoding let compatible_subseq_preorder>


; <Start encoding val LowStar.Monotonic.Buffer.mbuffer>
...
; </end encoding val LowStar.Monotonic.Buffer.mbuffer>


; <Start encoding val LowStar.Monotonic.Buffer.g_is_null>
...
; </end encoding val LowStar.Monotonic.Buffer.g_is_null>


; <Start encoding val LowStar.Monotonic.Buffer.mnull>
...
; </end encoding val LowStar.Monotonic.Buffer.mnull>


; <Start encoding val LowStar.Monotonic.Buffer.null_unique>
...
; </end encoding val LowStar.Monotonic.Buffer.null_unique>


; <Start encoding val LowStar.Monotonic.Buffer.unused_in>
...
; </end encoding val LowStar.Monotonic.Buffer.unused_in>


; <Start encoding val LowStar.Monotonic.Buffer.live>
...
; </end encoding val LowStar.Monotonic.Buffer.live>


; <Start encoding val LowStar.Monotonic.Buffer.live_null>
...
; </end encoding val LowStar.Monotonic.Buffer.live_null>


; <Start encoding val LowStar.Monotonic.Buffer.live_is_null>
...
; </end encoding val LowStar.Monotonic.Buffer.live_is_null>


; <Start encoding val LowStar.Monotonic.Buffer.live_not_unused_in>
...
; </end encoding val LowStar.Monotonic.Buffer.live_not_unused_in>


; <Start encoding val LowStar.Monotonic.Buffer.lemma_live_equal_mem_domains>
...
; </end encoding val LowStar.Monotonic.Buffer.lemma_live_equal_mem_domains>
...
; <Start encoding val LowStar.Monotonic.Buffer.frameOf>
...
; </end encoding val LowStar.Monotonic.Buffer.frameOf>


; <Start encoding val LowStar.Monotonic.Buffer.as_addr>
...
; </end encoding val LowStar.Monotonic.Buffer.as_addr>


; <Start encoding val LowStar.Monotonic.Buffer.unused_in_equiv>
...
; </end encoding val LowStar.Monotonic.Buffer.unused_in_equiv>


; <Start encoding val LowStar.Monotonic.Buffer.live_region_frameOf>
...
; </end encoding val LowStar.Monotonic.Buffer.live_region_frameOf>


; <Start encoding val LowStar.Monotonic.Buffer.len>
...
; </end encoding val LowStar.Monotonic.Buffer.len>
...
; <Start encoding val LowStar.Monotonic.Buffer.len_null>
...
; </end encoding val LowStar.Monotonic.Buffer.len_null>


; <Start encoding val LowStar.Monotonic.Buffer.length_null_1>
...
; </end encoding val LowStar.Monotonic.Buffer.length_null_1>


; <Start encoding val LowStar.Monotonic.Buffer.length_null_2>
...
; </end encoding val LowStar.Monotonic.Buffer.length_null_2>


; <Start encoding val LowStar.Monotonic.Buffer.as_seq>
...
; </end encoding val LowStar.Monotonic.Buffer.as_seq>


; <Start encoding val LowStar.Monotonic.Buffer.length_as_seq>
...
; </end encoding val LowStar.Monotonic.Buffer.length_as_seq>
...
; <Start encoding val LowStar.Monotonic.Buffer.mbuffer_injectivity_in_first_preorder>
...
; </end encoding val LowStar.Monotonic.Buffer.mbuffer_injectivity_in_first_preorder>


; <Start encoding let compatible_sub>
...
; </end encoding let compatible_sub>


; <Start encoding val LowStar.Monotonic.Buffer.mgsub>
...
; </end encoding val LowStar.Monotonic.Buffer.mgsub>


; <Start encoding val LowStar.Monotonic.Buffer.live_gsub>
...
; </end encoding val LowStar.Monotonic.Buffer.live_gsub>


; <Start encoding val LowStar.Monotonic.Buffer.gsub_is_null>
...
; </end encoding val LowStar.Monotonic.Buffer.gsub_is_null>


; <Start encoding val LowStar.Monotonic.Buffer.len_gsub>
...
; </end encoding val LowStar.Monotonic.Buffer.len_gsub>


; <Start encoding val LowStar.Monotonic.Buffer.frameOf_gsub>
...
; </end encoding val LowStar.Monotonic.Buffer.frameOf_gsub>


; <Start encoding val LowStar.Monotonic.Buffer.as_addr_gsub>
...
; </end encoding val LowStar.Monotonic.Buffer.as_addr_gsub>


; <Start encoding val LowStar.Monotonic.Buffer.mgsub_inj>
...
; </end encoding val LowStar.Monotonic.Buffer.mgsub_inj>


; <Start encoding val LowStar.Monotonic.Buffer.gsub_gsub>
...
; </end encoding val LowStar.Monotonic.Buffer.gsub_gsub>


; <Start encoding val LowStar.Monotonic.Buffer.gsub_zero_length>
...
; </end encoding val LowStar.Monotonic.Buffer.gsub_zero_length>


; <Start encoding val LowStar.Monotonic.Buffer.as_seq_gsub>
...
; </end encoding val LowStar.Monotonic.Buffer.as_seq_gsub>


; <Start encoding val LowStar.Monotonic.Buffer.live_same_addresses_equal_types_and_preorders>
...
; </end encoding val LowStar.Monotonic.Buffer.live_same_addresses_equal_types_and_preorders>


; <Start encoding val LowStar.Monotonic.Buffer.loc>

(declare-fun LowStar.Monotonic.Buffer.loc () Term)

; </end encoding val LowStar.Monotonic.Buffer.loc>


; <Start encoding val LowStar.Monotonic.Buffer.loc_none>

(declare-fun LowStar.Monotonic.Buffer.loc_none (Dummy_sort) Term)

; </end encoding val LowStar.Monotonic.Buffer.loc_none>


; <Start encoding val LowStar.Monotonic.Buffer.loc_union>

(declare-fun LowStar.Monotonic.Buffer.loc_union (Term Term) Term)
(declare-fun Tm_arrow_79e07213d9f0e2f77aef4b1f1fdd5490 () Term)
(declare-fun LowStar.Monotonic.Buffer.loc_union@tok () Term)

; </end encoding val LowStar.Monotonic.Buffer.loc_union>


; <Start encoding val LowStar.Monotonic.Buffer.loc_union_idem>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_union_idem>


; <Start encoding val LowStar.Monotonic.Buffer.loc_union_comm>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_union_comm>


; <Start encoding val LowStar.Monotonic.Buffer.loc_union_assoc>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_union_assoc>


; <Start encoding val LowStar.Monotonic.Buffer.loc_union_idem_1>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_union_idem_1>


; <Start encoding val LowStar.Monotonic.Buffer.loc_union_idem_2>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_union_idem_2>


; <Start encoding val LowStar.Monotonic.Buffer.loc_union_loc_none_l>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_union_loc_none_l>


; <Start encoding val LowStar.Monotonic.Buffer.loc_union_loc_none_r>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_union_loc_none_r>


; <Start encoding val LowStar.Monotonic.Buffer.loc_buffer_from_to>

(declare-fun LowStar.Monotonic.Buffer.loc_buffer_from_to (Term Term Term Term Term Term) Term)
(declare-fun Tm_arrow_ea84d3f45c49a5cbb3e4db0afae7d67a () Term)
(declare-fun LowStar.Monotonic.Buffer.loc_buffer_from_to@tok () Term)

; </end encoding val LowStar.Monotonic.Buffer.loc_buffer_from_to>


; <Start encoding val LowStar.Monotonic.Buffer.loc_buffer>

(declare-fun LowStar.Monotonic.Buffer.loc_buffer (Term Term Term Term) Term)
(declare-fun Tm_arrow_64aa69173402571bcbacc698325582b8 () Term)
(declare-fun LowStar.Monotonic.Buffer.loc_buffer@tok () Term)

; </end encoding val LowStar.Monotonic.Buffer.loc_buffer>


; <Start encoding val LowStar.Monotonic.Buffer.loc_buffer_eq>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_buffer_eq>


; <Start encoding val LowStar.Monotonic.Buffer.loc_buffer_from_to_high>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_buffer_from_to_high>


; <Start encoding val LowStar.Monotonic.Buffer.loc_buffer_from_to_none>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_buffer_from_to_none>


; <Start encoding val LowStar.Monotonic.Buffer.loc_buffer_from_to_mgsub>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_buffer_from_to_mgsub>


; <Start encoding val LowStar.Monotonic.Buffer.loc_buffer_mgsub_eq>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_buffer_mgsub_eq>


; <Start encoding val LowStar.Monotonic.Buffer.loc_buffer_null>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_buffer_null>


; <Start encoding val LowStar.Monotonic.Buffer.loc_buffer_from_to_eq>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_buffer_from_to_eq>


; <Start encoding val LowStar.Monotonic.Buffer.loc_buffer_mgsub_rel_eq>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_buffer_mgsub_rel_eq>


; <Start encoding val LowStar.Monotonic.Buffer.loc_addresses>

(declare-fun LowStar.Monotonic.Buffer.loc_addresses (Term Term Term) Term)
(declare-fun Tm_arrow_3609a762c23c5a23da38520fc5840fc5 () Term)
(declare-fun LowStar.Monotonic.Buffer.loc_addresses@tok () Term)

; </end encoding val LowStar.Monotonic.Buffer.loc_addresses>


; <Start encoding let loc_addr_of_buffer>
...
; </end encoding let loc_addr_of_buffer>


; <Start encoding val LowStar.Monotonic.Buffer.loc_regions>

(declare-fun LowStar.Monotonic.Buffer.loc_regions (Term Term) Term)
(declare-fun Tm_arrow_45860dfbcd748eb921e8afab125e87dc () Term)
(declare-fun LowStar.Monotonic.Buffer.loc_regions@tok () Term)

; </end encoding val LowStar.Monotonic.Buffer.loc_regions>


; <Start encoding let loc_mreference>

(declare-fun LowStar.Monotonic.Buffer.loc_mreference (Term Term Term) Term)
(declare-fun Tm_arrow_7eaed2ec0fa893fefab4ac7ef05f172f () Term)
...
(declare-fun Tm_arrow_8c6dfb237bdbd7bad2b18c1e32268384 () Term)
...
; <Start encoding val LowStar.Monotonic.Buffer.loc_includes>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_refl>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_refl>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_trans>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_trans>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_trans_backwards>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_trans_backwards>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_union_r>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_union_r>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_union_l>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_union_l>
...
; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_none>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_none>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_gsub_buffer_r>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_gsub_buffer_r>
...
; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_gsub_buffer_l>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_gsub_buffer_l>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_loc_buffer_loc_buffer_from_to>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_loc_buffer_loc_buffer_from_to>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_loc_buffer_from_to>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_loc_buffer_from_to>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_as_seq>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun LowStar.Monotonic.Buffer.loc_includes_as_seq (Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun LowStar.Monotonic.Buffer.loc_includes_as_seq@tok () Term)

; </end encoding val LowStar.Monotonic.Buffer.loc_includes_as_seq>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_addresses_buffer>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_addresses_buffer>
...
; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_region_buffer>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_region_buffer>
...
; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_region_addresses>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_region_addresses>
...
; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_region_region>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_region_region>
...
; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_region_union_l>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_region_union_l>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_addresses_addresses>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_addresses_addresses>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_addresses_addresses_1>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_addresses_addresses_1>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_addresses_addresses_2>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_addresses_addresses_2>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_union_l_buffer>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_union_l_buffer>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_union_l_addresses>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_union_l_addresses>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_union_l_regions>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_union_l_regions>


; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint>


; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint_sym>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint_sym>
...
; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint_none_r>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint_none_r>


; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint_union_r>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint_union_r>


; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint_includes>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint_includes>
...
; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint_includes_r>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint_includes_r>


; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint_gsub_buffer>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint_gsub_buffer>


; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint_loc_buffer_from_to>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint_loc_buffer_from_to>


; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint_addresses>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint_addresses>


; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint_regions>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint_regions>


; <Start encoding let buf_t>
...
(declare-fun Tm_abs_4baac76050fa5ed3a75b47ab5804b838 () Term)

; </end encoding let buf_t>


; <Start encoding let buf>
...
; </end encoding let buf>


; <Start encoding let all_live>
...
; </end encoding let all_live>


; <Start encoding let all_disjoint>
...
; </end encoding let all_disjoint>


; <Start encoding let loc_union_l>

(declare-fun LowStar.Monotonic.Buffer.loc_union_l (Term) Term)
(declare-fun Tm_arrow_f3ca47fa4dd58c36ce14cb0d9f47a9e5 () Term)
(declare-fun LowStar.Monotonic.Buffer.loc_union_l@tok () Term)

; </end encoding let loc_union_l>


; <Start encoding let loc_pairwise_disjoint>
...
; </end encoding let loc_pairwise_disjoint>


; <Start encoding val LowStar.Monotonic.Buffer.modifies>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_live_region>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_live_region>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_mreference_elim>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_mreference_elim>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_buffer_elim>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_buffer_elim>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_buffer_from_to_elim>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_buffer_from_to_elim>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_refl>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_refl>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_loc_includes>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_loc_includes>


; <Start encoding val LowStar.Monotonic.Buffer.address_liveness_insensitive_locs>

(declare-fun LowStar.Monotonic.Buffer.address_liveness_insensitive_locs (Dummy_sort) Term)

; </end encoding val LowStar.Monotonic.Buffer.address_liveness_insensitive_locs>


; <Start encoding val LowStar.Monotonic.Buffer.region_liveness_insensitive_locs>

(declare-fun LowStar.Monotonic.Buffer.region_liveness_insensitive_locs (Dummy_sort) Term)

; </end encoding val LowStar.Monotonic.Buffer.region_liveness_insensitive_locs>


; <Start encoding val LowStar.Monotonic.Buffer.address_liveness_insensitive_buffer>
...
; </end encoding val LowStar.Monotonic.Buffer.address_liveness_insensitive_buffer>


; <Start encoding val LowStar.Monotonic.Buffer.address_liveness_insensitive_addresses>
...
; </end encoding val LowStar.Monotonic.Buffer.address_liveness_insensitive_addresses>


; <Start encoding val LowStar.Monotonic.Buffer.region_liveness_insensitive_buffer>
...
; </end encoding val LowStar.Monotonic.Buffer.region_liveness_insensitive_buffer>


; <Start encoding val LowStar.Monotonic.Buffer.region_liveness_insensitive_addresses>
...
; </end encoding val LowStar.Monotonic.Buffer.region_liveness_insensitive_addresses>


; <Start encoding val LowStar.Monotonic.Buffer.region_liveness_insensitive_regions>
...
; </end encoding val LowStar.Monotonic.Buffer.region_liveness_insensitive_regions>


; <Start encoding val LowStar.Monotonic.Buffer.region_liveness_insensitive_address_liveness_insensitive>

(declare-fun LowStar.Monotonic.Buffer.region_liveness_insensitive_address_liveness_insensitive () Term)

; </end encoding val LowStar.Monotonic.Buffer.region_liveness_insensitive_address_liveness_insensitive>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_mreference>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_mreference>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_buffer>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_buffer>


; <Start encoding let modifies_liveness_insensitive_mreference_weak>
...
; </end encoding let modifies_liveness_insensitive_mreference_weak>


; <Start encoding let modifies_liveness_insensitive_buffer_weak>
...
; </end encoding let modifies_liveness_insensitive_buffer_weak>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region_mreference>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region_mreference>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region_buffer>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region_buffer>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region_weak>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region_weak>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region_mreference_weak>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region_mreference_weak>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region_buffer_weak>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_liveness_insensitive_region_buffer_weak>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_trans>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_trans>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_trans_linear>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_trans_linear>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_only_live_regions>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_only_live_regions>


; <Start encoding val LowStar.Monotonic.Buffer.no_upd_fresh_region>
...
; </end encoding val LowStar.Monotonic.Buffer.no_upd_fresh_region>


; <Start encoding val LowStar.Monotonic.Buffer.new_region_modifies>
...
; </end encoding val LowStar.Monotonic.Buffer.new_region_modifies>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_fresh_frame_popped>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_fresh_frame_popped>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_loc_regions_intro>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_loc_regions_intro>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_loc_addresses_intro>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_loc_addresses_intro>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_ralloc_post>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_ralloc_post>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_salloc_post>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_salloc_post>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_free>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_free>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_none_modifies>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_none_modifies>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_upd>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_upd>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_loc_buffer_from_to_intro>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_loc_buffer_from_to_intro>


; <Start encoding val LowStar.Monotonic.Buffer.does_not_contain_addr>
...
; </end encoding val LowStar.Monotonic.Buffer.does_not_contain_addr>


; <Start encoding val LowStar.Monotonic.Buffer.not_live_region_does_not_contain_addr>
...
; </end encoding val LowStar.Monotonic.Buffer.not_live_region_does_not_contain_addr>


; <Start encoding val LowStar.Monotonic.Buffer.unused_in_does_not_contain_addr>
...
; </end encoding val LowStar.Monotonic.Buffer.unused_in_does_not_contain_addr>


; <Start encoding val LowStar.Monotonic.Buffer.addr_unused_in_does_not_contain_addr>
...
; </end encoding val LowStar.Monotonic.Buffer.addr_unused_in_does_not_contain_addr>


; <Start encoding val LowStar.Monotonic.Buffer.free_does_not_contain_addr>
...
; </end encoding val LowStar.Monotonic.Buffer.free_does_not_contain_addr>


; <Start encoding val LowStar.Monotonic.Buffer.does_not_contain_addr_elim>
...
; </end encoding val LowStar.Monotonic.Buffer.does_not_contain_addr_elim>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_only_live_addresses>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_only_live_addresses>


; <Start encoding val LowStar.Monotonic.Buffer.loc_not_unused_in>

(declare-fun LowStar.Monotonic.Buffer.loc_not_unused_in (Term) Term)
(declare-fun Tm_arrow_7a7f781e9ee134508e484d33d2028424 () Term)
(declare-fun LowStar.Monotonic.Buffer.loc_not_unused_in@tok () Term)

; </end encoding val LowStar.Monotonic.Buffer.loc_not_unused_in>


; <Start encoding val LowStar.Monotonic.Buffer.loc_unused_in>

(declare-fun LowStar.Monotonic.Buffer.loc_unused_in (Term) Term)

(declare-fun LowStar.Monotonic.Buffer.loc_unused_in@tok () Term)

; </end encoding val LowStar.Monotonic.Buffer.loc_unused_in>


; <Start encoding let loc_in>
...
; </end encoding let loc_in>


; <Start encoding let loc_not_in>

(declare-fun LowStar.Monotonic.Buffer.loc_not_in (Term Term) Term)

(declare-fun LowStar.Monotonic.Buffer.loc_not_in@tok () Term)

; </end encoding let loc_not_in>


; <Start encoding val LowStar.Monotonic.Buffer.loc_regions_unused_in>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_regions_unused_in>


; <Start encoding val LowStar.Monotonic.Buffer.loc_unused_in_not_unused_in_disjoint>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_unused_in_not_unused_in_disjoint>


; <Start encoding val LowStar.Monotonic.Buffer.not_live_region_loc_not_unused_in_disjoint>
...
; </end encoding val LowStar.Monotonic.Buffer.not_live_region_loc_not_unused_in_disjoint>


; <Start encoding val LowStar.Monotonic.Buffer.fresh_frame_loc_not_unused_in_disjoint>
...
; </end encoding val LowStar.Monotonic.Buffer.fresh_frame_loc_not_unused_in_disjoint>


; <Start encoding val LowStar.Monotonic.Buffer.live_loc_not_unused_in>
...
; </end encoding val LowStar.Monotonic.Buffer.live_loc_not_unused_in>


; <Start encoding val LowStar.Monotonic.Buffer.unused_in_loc_unused_in>
...
; </end encoding val LowStar.Monotonic.Buffer.unused_in_loc_unused_in>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_address_liveness_insensitive_unused_in>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_address_liveness_insensitive_unused_in>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_only_not_unused_in>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_only_not_unused_in>


; <Start encoding val LowStar.Monotonic.Buffer.mreference_live_loc_not_unused_in>
...
; </end encoding val LowStar.Monotonic.Buffer.mreference_live_loc_not_unused_in>


; <Start encoding val LowStar.Monotonic.Buffer.mreference_unused_in_loc_unused_in>
...
; </end encoding val LowStar.Monotonic.Buffer.mreference_unused_in_loc_unused_in>


; <Start encoding val LowStar.Monotonic.Buffer.unused_in_not_unused_in_disjoint_2>
...
; </end encoding val LowStar.Monotonic.Buffer.unused_in_not_unused_in_disjoint_2>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_loc_unused_in>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_loc_unused_in>


; <Start encoding let fresh_loc>
...
; </end encoding let fresh_loc>


; <Start encoding val LowStar.Monotonic.Buffer.ralloc_post_fresh_loc>
...
(declare-fun Tm_refine_f66e3e9c5cfa5dc28f9d0303f6e78009 (Term Term) Term)

; </end encoding val LowStar.Monotonic.Buffer.ralloc_post_fresh_loc>


; <Start encoding val LowStar.Monotonic.Buffer.fresh_frame_modifies>
...
; </end encoding val LowStar.Monotonic.Buffer.fresh_frame_modifies>


; <Start encoding val LowStar.Monotonic.Buffer.popped_modifies>
...
; </end encoding val LowStar.Monotonic.Buffer.popped_modifies>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_remove_new_locs>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_remove_new_locs>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_remove_fresh_frame>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_remove_fresh_frame>
...
; </end encoding let includes>


; <Start encoding val LowStar.Monotonic.Buffer.disjoint_neq>
...
; </end encoding val LowStar.Monotonic.Buffer.disjoint_neq>


; <Start encoding val LowStar.Monotonic.Buffer.empty_disjoint>
...
; </end encoding val LowStar.Monotonic.Buffer.empty_disjoint>


; <Start encoding val LowStar.Monotonic.Buffer.includes_frameOf_as_addr>
...
; </end encoding val LowStar.Monotonic.Buffer.includes_frameOf_as_addr>


; <Start encoding let mpointer>
...
; </end encoding let mpointer>


; <Start encoding let mpointer_or_null>
...
; </end encoding let mpointer_or_null>


; <Start encoding let deref>
...
; </end encoding let deref>


; <Start encoding val LowStar.Monotonic.Buffer.pointer_distinct_sel_disjoint>
...
; </end encoding val LowStar.Monotonic.Buffer.pointer_distinct_sel_disjoint>


; <Start encoding val LowStar.Monotonic.Buffer.is_null>
...
; </end encoding val LowStar.Monotonic.Buffer.is_null>


; <Start encoding val LowStar.Monotonic.Buffer.msub>
...
; </end encoding val LowStar.Monotonic.Buffer.msub>


; <Start encoding val LowStar.Monotonic.Buffer.moffset>
...
; </end encoding val LowStar.Monotonic.Buffer.moffset>


; <Start encoding val LowStar.Monotonic.Buffer.index>
...
; </end encoding val LowStar.Monotonic.Buffer.index>


; <Start encoding val LowStar.Monotonic.Buffer.g_upd_seq>
...
; </end encoding val LowStar.Monotonic.Buffer.g_upd_seq>


; <Start encoding val LowStar.Monotonic.Buffer.lemma_g_upd_with_same_seq>
...
; </end encoding val LowStar.Monotonic.Buffer.lemma_g_upd_with_same_seq>


; <Start encoding val LowStar.Monotonic.Buffer.g_upd_seq_as_seq>
...
; </end encoding val LowStar.Monotonic.Buffer.g_upd_seq_as_seq>


; <Start encoding let g_upd>
...
; </end encoding let g_upd>


; <Start encoding val LowStar.Monotonic.Buffer.g_upd_modifies_strong>
...
; </end encoding val LowStar.Monotonic.Buffer.g_upd_modifies_strong>


; <Start encoding val LowStar.Monotonic.Buffer.upd'>
...
; </end encoding val LowStar.Monotonic.Buffer.upd'>
...
; <Start encoding val LowStar.Monotonic.Buffer.recallable>
...
; </end encoding val LowStar.Monotonic.Buffer.recallable>


; <Start encoding val LowStar.Monotonic.Buffer.region_lifetime_buf>
...
; </end encoding val LowStar.Monotonic.Buffer.region_lifetime_buf>


; <Start encoding let rrel_rel_always_compatible>
...
; </end encoding let rrel_rel_always_compatible>


; <Start encoding val LowStar.Monotonic.Buffer.region_lifetime_sub>
...
; </end encoding val LowStar.Monotonic.Buffer.region_lifetime_sub>


; <Start encoding val LowStar.Monotonic.Buffer.recallable_null>
...
; </end encoding val LowStar.Monotonic.Buffer.recallable_null>


; <Start encoding val LowStar.Monotonic.Buffer.recallable_mgsub>
...
; </end encoding val LowStar.Monotonic.Buffer.recallable_mgsub>


; <Start encoding val LowStar.Monotonic.Buffer.recall>
...
; </end encoding val LowStar.Monotonic.Buffer.recall>
...
; <Start encoding val LowStar.Monotonic.Buffer.witnessed>
...
; </end encoding val LowStar.Monotonic.Buffer.witnessed>


; <Start encoding val LowStar.Monotonic.Buffer.witness_p>
...
; </end encoding val LowStar.Monotonic.Buffer.witness_p>


; <Start encoding val LowStar.Monotonic.Buffer.recall_p>
...
; </end encoding val LowStar.Monotonic.Buffer.recall_p>


; <Start encoding val LowStar.Monotonic.Buffer.witnessed_functorial>
...
; </end encoding val LowStar.Monotonic.Buffer.witnessed_functorial>


; <Start encoding val LowStar.Monotonic.Buffer.witnessed_functorial_st>
...
; </end encoding val LowStar.Monotonic.Buffer.witnessed_functorial_st>


; <Start encoding val LowStar.Monotonic.Buffer.freeable>
...
; </end encoding val LowStar.Monotonic.Buffer.freeable>


; <Start encoding val LowStar.Monotonic.Buffer.free>
...
; </end encoding val LowStar.Monotonic.Buffer.free>


; <Start encoding val LowStar.Monotonic.Buffer.freeable_length>
...
; </end encoding val LowStar.Monotonic.Buffer.freeable_length>


; <Start encoding val LowStar.Monotonic.Buffer.freeable_disjoint>
...
; </end encoding val LowStar.Monotonic.Buffer.freeable_disjoint>
...
; </end encoding let lmbuffer>


; <Start encoding let alloc_post_mem_common>
...
; </end encoding let alloc_post_mem_common>


; <Start encoding let lmbuffer_or_null>
...
; </end encoding let lmbuffer_or_null>


; <Start encoding let alloc_partial_post_mem_common>
...
; </end encoding let alloc_partial_post_mem_common>


; <Start encoding let malloc_pre>
...
; </end encoding let malloc_pre>


; <Start encoding val LowStar.Monotonic.Buffer.mgcmalloc>
...
; </end encoding val LowStar.Monotonic.Buffer.mgcmalloc>


; <Start encoding val LowStar.Monotonic.Buffer.mgcmalloc_and_blit>
...
; </end encoding val LowStar.Monotonic.Buffer.mgcmalloc_and_blit>


; <Start encoding let mgcmalloc_partial>
...
; </end encoding let mgcmalloc_partial>


; <Start encoding val LowStar.Monotonic.Buffer.mmalloc>
...
; </end encoding val LowStar.Monotonic.Buffer.mmalloc>


; <Start encoding val LowStar.Monotonic.Buffer.mmalloc_and_blit>
...
; </end encoding val LowStar.Monotonic.Buffer.mmalloc_and_blit>


; <Start encoding let mmalloc_partial>
...
; </end encoding let mmalloc_partial>


; <Start encoding let alloca_pre>
...
; </end encoding let alloca_pre>


; <Start encoding val LowStar.Monotonic.Buffer.malloca>
...
; </end encoding val LowStar.Monotonic.Buffer.malloca>


; <Start encoding val LowStar.Monotonic.Buffer.malloca_and_blit>
...
; </end encoding val LowStar.Monotonic.Buffer.malloca_and_blit>


; <Start encoding let alloca_of_list_pre>
...
; </end encoding let alloca_of_list_pre>


; <Start encoding val LowStar.Monotonic.Buffer.malloca_of_list>
...
; </end encoding val LowStar.Monotonic.Buffer.malloca_of_list>


; <Start encoding let gcmalloc_of_list_pre>
...
; </end encoding let gcmalloc_of_list_pre>


; <Start encoding val LowStar.Monotonic.Buffer.mgcmalloc_of_list>
...
; </end encoding val LowStar.Monotonic.Buffer.mgcmalloc_of_list>


; <Start encoding let mgcmalloc_of_list_partial>
...
; </end encoding let mgcmalloc_of_list_partial>


; <Start encoding let alloc_drgn_pre>
...
; </end encoding let alloc_drgn_pre>


; <Start encoding val LowStar.Monotonic.Buffer.mmalloc_drgn>
...
; </end encoding val LowStar.Monotonic.Buffer.mmalloc_drgn>


; <Start encoding val LowStar.Monotonic.Buffer.mmalloc_drgn_mm>
...
; </end encoding val LowStar.Monotonic.Buffer.mmalloc_drgn_mm>


; <Start encoding val LowStar.Monotonic.Buffer.mmalloc_drgn_and_blit>
...
; </end encoding val LowStar.Monotonic.Buffer.mmalloc_drgn_and_blit>


; <Start encoding val LowStar.Monotonic.Buffer.blit>
...
; </end encoding val LowStar.Monotonic.Buffer.blit>


; <Start encoding val LowStar.Monotonic.Buffer.fill>
...
; </end encoding val LowStar.Monotonic.Buffer.fill>


; <Start encoding val LowStar.Monotonic.Buffer.abuffer'>

(declare-fun LowStar.Monotonic.Buffer.abuffer_ (Term Term) Term)

(declare-fun LowStar.Monotonic.Buffer.abuffer_@tok () Term)

; </end encoding val LowStar.Monotonic.Buffer.abuffer'>


; <Start encoding let abuffer>

(declare-fun LowStar.Monotonic.Buffer.abuffer (Term Term) Term)

(declare-fun LowStar.Monotonic.Buffer.abuffer@tok () Term)

; </end encoding let abuffer>


; <Start encoding val LowStar.Monotonic.Buffer.cloc_cls>

(declare-fun LowStar.Monotonic.Buffer.cloc_cls (Dummy_sort) Term)


; </end encoding val LowStar.Monotonic.Buffer.cloc_cls>


; <Start encoding val LowStar.Monotonic.Buffer.cloc_of_loc>
...
; </end encoding val LowStar.Monotonic.Buffer.cloc_of_loc>


; <Start encoding val LowStar.Monotonic.Buffer.loc_of_cloc>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_of_cloc>


; <Start encoding val LowStar.Monotonic.Buffer.loc_of_cloc_of_loc>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_of_cloc_of_loc>


; <Start encoding val LowStar.Monotonic.Buffer.cloc_of_loc_of_cloc>
...
; </end encoding val LowStar.Monotonic.Buffer.cloc_of_loc_of_cloc>


; <Start encoding val LowStar.Monotonic.Buffer.cloc_of_loc_none>
...
; </end encoding val LowStar.Monotonic.Buffer.cloc_of_loc_none>


; <Start encoding val LowStar.Monotonic.Buffer.cloc_of_loc_union>
...
; </end encoding val LowStar.Monotonic.Buffer.cloc_of_loc_union>


; <Start encoding val LowStar.Monotonic.Buffer.cloc_of_loc_addresses>
...
; </end encoding val LowStar.Monotonic.Buffer.cloc_of_loc_addresses>


; <Start encoding val LowStar.Monotonic.Buffer.cloc_of_loc_regions>
...
; </end encoding val LowStar.Monotonic.Buffer.cloc_of_loc_regions>


; <Start encoding val LowStar.Monotonic.Buffer.loc_includes_to_cloc>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_includes_to_cloc>


; <Start encoding val LowStar.Monotonic.Buffer.loc_disjoint_to_cloc>
...
; </end encoding val LowStar.Monotonic.Buffer.loc_disjoint_to_cloc>


; <Start encoding val LowStar.Monotonic.Buffer.modifies_to_cloc>
...
; </end encoding val LowStar.Monotonic.Buffer.modifies_to_cloc>


; End Externals for interface LowStar.Monotonic.Buffer
...
; Externals for module OPLSS


; <Start encoding let bytes>

(declare-fun OPLSS.bytes () Term)
...
(declare-fun OPLSS.lbytes (Term) Term)

(declare-fun OPLSS.lbytes@tok () Term)
(declare-fun Tm_refine_1770f7f5914d37a8c358e0f35e606914 (Term) Term)

; </end encoding let lbytes>


; <Start encoding val OPLSS.random>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun OPLSS.random (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun OPLSS.random@tok () Term)

; </end encoding val OPLSS.random>


; <Start encoding val OPLSS.byte_of_int>

(declare-fun Tm_refine_31c7d3d85d92cb942c95a78642e657c7 () Term)
(declare-fun OPLSS.byte_of_int (Term) Term)

;;;;;;;;;;;;;;;;n: Prims.nat{n < 256} -> FStar.UInt8.t
(declare-fun Tm_arrow_dc0caa3ac4d2eb60e55b41b249a44c6a () Term)
(declare-fun OPLSS.byte_of_int@tok () Term)

; </end encoding val OPLSS.byte_of_int>


; <Start encoding val OPLSS.xor>

(declare-fun OPLSS.xor (Term Term Term) Term)
;;;;;;;;;;;;;;;;l: Prims.nat -> _: lbytes l -> _: lbytes l -> lbytes l
(declare-fun Tm_arrow_ea32a656d547c0c854330a4a84cc71c3 () Term)
(declare-fun OPLSS.xor@tok () Term)

; </end encoding val OPLSS.xor>


; <Skipped val OPLSS.auto_lemma_mem_snoc/>


; <Start encoding let auto_lemma_mem_snoc>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun OPLSS.auto_lemma_mem_snoc (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun OPLSS.auto_lemma_mem_snoc@tok () Term)

; </end encoding let auto_lemma_mem_snoc>


; End Externals for module OPLSS

(push) ;; push{1

; Internals for OPLSS.AES


; encoding sigelt val OPLSS.AES.ivsize


; <Start encoding val OPLSS.AES.ivsize>

(declare-fun OPLSS.AES.ivsize (Dummy_sort) Term)

; </end encoding val OPLSS.AES.ivsize>


; encoding sigelt let iv


; <Start encoding let iv>

(declare-fun OPLSS.AES.iv () Term)

; </end encoding let iv>


; encoding sigelt val OPLSS.AES.keysize


; <Start encoding val OPLSS.AES.keysize>

(declare-fun OPLSS.AES.keysize (Dummy_sort) Term)

; </end encoding val OPLSS.AES.keysize>
...
(declare-fun OPLSS.AES.key () Term)

; </end encoding let key>


; encoding sigelt val OPLSS.AES.plainsize


; <Start encoding val OPLSS.AES.plainsize>

(declare-fun OPLSS.AES.plainsize (Dummy_sort) Term)

; </end encoding val OPLSS.AES.plainsize>
...
(declare-fun OPLSS.AES.plain () Term)

; </end encoding let plain>


; encoding sigelt val OPLSS.AES.cipher_size


; <Start encoding val OPLSS.AES.cipher_size>

(declare-fun OPLSS.AES.cipher_size (Dummy_sort) Term)

; </end encoding val OPLSS.AES.cipher_size>
...
(declare-fun OPLSS.AES.cipher () Term)
...
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name LowStar.Monotonic.Buffer.region_liveness_insensitive_address_liveness_insensitive; Namespace LowStar.Monotonic.Buffer
(assert (! (HasType LowStar.Monotonic.Buffer.region_liveness_insensitive_address_liveness_insensitive
(Prims.squash (LowStar.Monotonic.Buffer.loc_includes (LowStar.Monotonic.Buffer.region_liveness_insensitive_locs Dummy_value)
(LowStar.Monotonic.Buffer.address_liveness_insensitive_locs Dummy_value))))
:named function_token_typing_LowStar.Monotonic.Buffer.region_liveness_insensitive_address_liveness_insensitive))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name LowStar.Monotonic.Buffer.region_liveness_insensitive_address_liveness_insensitive; Namespace LowStar.Monotonic.Buffer
(assert (! (HasType LowStar.Monotonic.Buffer.region_liveness_insensitive_address_liveness_insensitive
(Prims.squash (LowStar.Monotonic.Buffer.loc_includes (LowStar.Monotonic.Buffer.region_liveness_insensitive_locs Dummy_value)
(LowStar.Monotonic.Buffer.address_liveness_insensitive_locs Dummy_value))))
:named typing_LowStar.Monotonic.Buffer.region_liveness_insensitive_address_liveness_insensitive))
;;;;;;;;;;;;;;;;unit typing
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.AES.ivsize; Namespace OPLSS.AES
(assert (! 
;; def=OPLSS.AES.fst(20,11-20,17); use=OPLSS.AES.fst(20,11-20,17)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.AES.ivsize @u0)
Prims.nat)
 

:pattern ((OPLSS.AES.ivsize @u0))
:qid typing_OPLSS.AES.ivsize))

:named typing_OPLSS.AES.ivsize))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.AES.cipher_size; Namespace OPLSS.AES
(assert (! 
;; def=OPLSS.AES.fst(35,11-35,22); use=OPLSS.AES.fst(35,11-35,22)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.AES.cipher_size @u0)
Prims.nat)
 

:pattern ((OPLSS.AES.cipher_size @u0))
:qid typing_OPLSS.AES.cipher_size))

:named typing_OPLSS.AES.cipher_size))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name LowStar.Monotonic.Buffer.region_liveness_insensitive_locs; Namespace LowStar.Monotonic.Buffer
(assert (! 
;; def=LowStar.Monotonic.Buffer.fsti(1089,4-1089,36); use=LowStar.Monotonic.Buffer.fsti(1089,4-1089,36)
(forall ((@u0 Dummy_sort))
 (! (HasType (LowStar.Monotonic.Buffer.region_liveness_insensitive_locs @u0)
LowStar.Monotonic.Buffer.loc)
 

:pattern ((LowStar.Monotonic.Buffer.region_liveness_insensitive_locs @u0))
:qid typing_LowStar.Monotonic.Buffer.region_liveness_insensitive_locs))

:named typing_LowStar.Monotonic.Buffer.region_liveness_insensitive_locs))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name LowStar.Monotonic.Buffer.loc_includes; Namespace LowStar.Monotonic.Buffer
(assert (! 
;; def=LowStar.Monotonic.Buffer.fsti(590,4-590,16); use=LowStar.Monotonic.Buffer.fsti(590,4-590,16)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
LowStar.Monotonic.Buffer.loc)
(HasType @x1
LowStar.Monotonic.Buffer.loc))
(HasType (LowStar.Monotonic.Buffer.loc_includes @x0
@x1)
Tm_type))
 

:pattern ((LowStar.Monotonic.Buffer.loc_includes @x0
@x1))
:qid typing_LowStar.Monotonic.Buffer.loc_includes))

:named typing_LowStar.Monotonic.Buffer.loc_includes))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name LowStar.Monotonic.Buffer.loc; Namespace LowStar.Monotonic.Buffer
(assert (! (HasType LowStar.Monotonic.Buffer.loc
Tm_type)
:named typing_LowStar.Monotonic.Buffer.loc))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name LowStar.Monotonic.Buffer.address_liveness_insensitive_locs; Namespace LowStar.Monotonic.Buffer
(assert (! 
;; def=LowStar.Monotonic.Buffer.fsti(1087,4-1087,37); use=LowStar.Monotonic.Buffer.fsti(1087,4-1087,37)
(forall ((@u0 Dummy_sort))
 (! (HasType (LowStar.Monotonic.Buffer.address_liveness_insensitive_locs @u0)
LowStar.Monotonic.Buffer.loc)
 

:pattern ((LowStar.Monotonic.Buffer.address_liveness_insensitive_locs @u0))
:qid typing_LowStar.Monotonic.Buffer.address_liveness_insensitive_locs))

:named typing_LowStar.Monotonic.Buffer.address_liveness_insensitive_locs))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name OPLSS.byte_of_int; Namespace OPLSS
...
;;; Fact-ids: Name OPLSS.byte_of_int; Namespace OPLSS
(assert (! 
;; def=OPLSS.fst(13,17-13,31); use=OPLSS.fst(13,17-13,31)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=OPLSS.fst(13,23-13,30); use=OPLSS.fst(13,23-13,30)
(< (BoxInt_proj_0 @x1)
...
;;;;;;;;;;;;;;;;Lemma: LowStar.Monotonic.Buffer.loc_includes_trans_backwards
;;; Fact-ids: Name LowStar.Monotonic.Buffer.loc_includes_trans_backwards; Namespace LowStar.Monotonic.Buffer
...
;; def=LowStar.Monotonic.Buffer.fsti(609,13-609,31); use=LowStar.Monotonic.Buffer.fsti(609,13-609,31)
(Valid 
;; def=LowStar.Monotonic.Buffer.fsti(609,13-609,31); use=LowStar.Monotonic.Buffer.fsti(609,13-609,31)
(LowStar.Monotonic.Buffer.loc_includes @x0
@x1)
)


;; def=LowStar.Monotonic.Buffer.fsti(609,35-609,53); use=LowStar.Monotonic.Buffer.fsti(609,35-609,53)
(Valid 
;; def=LowStar.Monotonic.Buffer.fsti(609,35-609,53); use=LowStar.Monotonic.Buffer.fsti(609,35-609,53)
(LowStar.Monotonic.Buffer.loc_includes @x1
@x2)
)
)

;; def=LowStar.Monotonic.Buffer.fsti(610,11-610,31); use=LowStar.Monotonic.Buffer.fsti(610,11-610,31)
(Valid 
;; def=LowStar.Monotonic.Buffer.fsti(610,11-610,31); use=LowStar.Monotonic.Buffer.fsti(610,11-610,31)
(LowStar.Monotonic.Buffer.loc_includes @x0
@x2)
...
:pattern ((LowStar.Monotonic.Buffer.loc_includes @x0
@x2) (LowStar.Monotonic.Buffer.loc_includes @x1
@x2))
:qid lemma_LowStar.Monotonic.Buffer.loc_includes_trans_backwards))
:named lemma_LowStar.Monotonic.Buffer.loc_includes_trans_backwards))
;;;;;;;;;;;;;;;;Lemma: LowStar.Monotonic.Buffer.loc_includes_refl
;;; Fact-ids: Name LowStar.Monotonic.Buffer.loc_includes_refl; Namespace LowStar.Monotonic.Buffer
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
LowStar.Monotonic.Buffer.loc)

;; def=LowStar.Monotonic.Buffer.fsti(597,2-597,20); use=LowStar.Monotonic.Buffer.fsti(597,2-597,20)
(Valid 
;; def=LowStar.Monotonic.Buffer.fsti(597,2-597,20); use=LowStar.Monotonic.Buffer.fsti(597,2-597,20)
(LowStar.Monotonic.Buffer.loc_includes @x0
@x0)
...
:pattern ((LowStar.Monotonic.Buffer.loc_includes @x0
@x0))
:qid lemma_LowStar.Monotonic.Buffer.loc_includes_refl))
:named lemma_LowStar.Monotonic.Buffer.loc_includes_refl))
...
(assert (! (HasType LowStar.Monotonic.Buffer.loc
Tm_type)
:named function_token_typing_LowStar.Monotonic.Buffer.loc))
...
; Starting query at OPLSS.AES.fst(38,0-38,45)

(declare-fun label_1 () Bool)

; Encoding query formula : OPLSS.AES.ivsize + OPLSS.AES.cipher_size >= 0


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let iv_cipher`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(680,18-680,24); use=OPLSS.AES.fst(38,23-38,45)
(or label_1

;; def=Prims.fst(680,18-680,24); use=OPLSS.AES.fst(38,23-38,45)
(>= (BoxInt_proj_0 (Prims.op_Addition (OPLSS.AES.ivsize Dummy_value)
(OPLSS.AES.cipher_size Dummy_value)))
(BoxInt_proj_0 (BoxInt 0)))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.AES.iv_cipher, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_Prims.nat, primitive_Prims.op_Addition, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_OPLSS.AES.cipher_size, typing_OPLSS.AES.ivsize
