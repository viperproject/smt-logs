...
; Externals for interface OPLSS.Flag


; <Start encoding val OPLSS.Flag.flag>

(declare-fun OPLSS.Flag.flag () Term)

; </end encoding val OPLSS.Flag.flag>


; <Start encoding val OPLSS.Flag.mk>

(declare-fun OPLSS.Flag.mk (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.bool -> flag
(declare-fun Tm_arrow_4716bbc57517de5f35cdf4bb5f6e3c94 () Term)
(declare-fun OPLSS.Flag.mk@tok () Term)

; </end encoding val OPLSS.Flag.mk>


; <Start encoding val OPLSS.Flag.reveal>

(declare-fun OPLSS.Flag.reveal (Term) Term)
;;;;;;;;;;;;;;;;_: flag -> Prims.GTot Prims.bool
(declare-fun Tm_ghost_arrow_01684be3e1d2ed4d8c389311f1196203 () Term)
(declare-fun OPLSS.Flag.reveal@tok () Term)

; </end encoding val OPLSS.Flag.reveal>


; <Start encoding val OPLSS.Flag.idealizing>

(declare-fun OPLSS.Flag.idealizing (Term) Term)
(declare-fun Tm_refine_bbc2c33c942676f2ea978d203358799a (Term) Term)
;;;;;;;;;;;;;;;;f: flag -> b: Prims.bool{b == reveal f}
(declare-fun Tm_arrow_e452fb51cf35b9e7b3b23965dc03fda2 () Term)
(declare-fun OPLSS.Flag.idealizing@tok () Term)


; </end encoding val OPLSS.Flag.idealizing>


; End Externals for interface OPLSS.Flag
...
; Externals for module OPLSS.AES
...
; <Start encoding let iv_cipher>

(declare-fun OPLSS.AES.iv_cipher () Term)

; </end encoding let iv_cipher>


; <Start encoding val OPLSS.AES.aes_encrypt>

(declare-fun OPLSS.AES.aes_encrypt (Term Term Term) Term)
;;;;;;;;;;;;;;;;k: key -> iv: iv -> p: plain -> cipher
(declare-fun Tm_arrow_a7425dab3e484fac1235687649dce7e5 () Term)
(declare-fun OPLSS.AES.aes_encrypt@tok () Term)

; </end encoding val OPLSS.AES.aes_encrypt>


; <Start encoding val OPLSS.AES.aes_decrypt>

(declare-fun OPLSS.AES.aes_decrypt (Term Term Term) Term)
;;;;;;;;;;;;;;;;k: key -> iv: iv -> c: cipher -> plain
(declare-fun Tm_arrow_8cadf9070c81174701b0cbd7ab0e662f () Term)
(declare-fun OPLSS.AES.aes_decrypt@tok () Term)

; </end encoding val OPLSS.AES.aes_decrypt>


; <Start encoding val OPLSS.AES.enc_dec_inverses>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun OPLSS.AES.enc_dec_inverses (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun OPLSS.AES.enc_dec_inverses@tok () Term)

; </end encoding val OPLSS.AES.enc_dec_inverses>


; End Externals for module OPLSS.AES


; Externals for interface OPLSS.Ideal


; <Start encoding val OPLSS.Ideal.uf_cma>

(declare-fun OPLSS.Ideal.uf_cma (Dummy_sort) Term)

; </end encoding val OPLSS.Ideal.uf_cma>


; <Start encoding val OPLSS.Ideal.pre_ind_cpa>

(declare-fun OPLSS.Ideal.pre_ind_cpa (Dummy_sort) Term)
(declare-fun Tm_refine_46b68b9714c8e3c8a3384ac3f5230ed1 () Term)


; </end encoding val OPLSS.Ideal.pre_ind_cpa>


; <Start encoding val OPLSS.Ideal.ind_cpa>

(declare-fun OPLSS.Ideal.ind_cpa (Dummy_sort) Term)
(declare-fun Tm_refine_9bfa85103653817f1c9189142c4becbc () Term)


; </end encoding val OPLSS.Ideal.ind_cpa>


; <Start encoding val OPLSS.Ideal.ae>

(declare-fun OPLSS.Ideal.ae (Dummy_sort) Term)
(declare-fun Tm_refine_9ab0ebe287f0645e6f2f11ecad663151 () Term)


; </end encoding val OPLSS.Ideal.ae>


; <Start encoding let auth>

(declare-fun OPLSS.Ideal.auth (Dummy_sort) Term)

; </end encoding let auth>


; <Start encoding let conf>

(declare-fun OPLSS.Ideal.conf (Dummy_sort) Term)



; </end encoding let conf>


; End Externals for interface OPLSS.Ideal

(push) ;; push{1

; Internals for OPLSS.Plain


; encoding sigelt val OPLSS.Plain.plain


; <Skipped val OPLSS.Plain.plain/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.AES.plain; Namespace OPLSS.AES
(assert (! (HasType OPLSS.AES.plain
Tm_type)
:named typing_OPLSS.AES.plain))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.AES.keysize; Namespace OPLSS.AES
(assert (! 
;; def=OPLSS.AES.fst(24,11-24,18); use=OPLSS.AES.fst(24,11-24,18)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.AES.keysize @u0)
Prims.nat)
 

:pattern ((OPLSS.AES.keysize @u0))
:qid typing_OPLSS.AES.keysize))

:named typing_OPLSS.AES.keysize))
;;;;;;;;;;;;;;;;free var typing
...
(assert (! (HasType OPLSS.AES.plain
Tm_type)
:named function_token_typing_OPLSS.AES.plain))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name LowStar.Monotonic.Buffer.loc; Namespace LowStar.Monotonic.Buffer
(assert (! (HasType LowStar.Monotonic.Buffer.loc
Tm_type)
...
;;;;;;;;;;;;;;;;Equation for OPLSS.AES.plain
;;; Fact-ids: Name OPLSS.AES.plain; Namespace OPLSS.AES
(assert (! (= OPLSS.AES.plain
(OPLSS.lbytes (OPLSS.AES.keysize Dummy_value)))
:named equation_OPLSS.AES.plain))
...
; Starting query at OPLSS.Plain.fst(20,5-20,10)

(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq OPLSS.AES.plain
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(73,23-73,30); use=OPLSS.Plain.fst(20,22-20,31)
(or label_1

;; def=Prims.fst(73,23-73,30); use=OPLSS.Plain.fst(20,22-20,31)
(Valid 
;; def=Prims.fst(73,23-73,30); use=OPLSS.Plain.fst(20,22-20,31)
(Prims.hasEq OPLSS.AES.plain)
)
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.Plain.plain, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_OPLSS.AES.plain, equation_OPLSS.bytes, equation_OPLSS.lbytes, equation_Prims.eqtype, haseqTm_refine_1770f7f5914d37a8c358e0f35e606914, lemma_FStar.Seq.Base.hasEq_lemma, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_FStar.UInt8.t
...
(declare-fun OPLSS.Plain.plain (Dummy_sort) Term)

; </end encoding let plain>


; encoding sigelt val OPLSS.Plain.reveal


; <Skipped val OPLSS.Plain.reveal/>


; encoding sigelt let reveal


; <Start encoding let reveal>

(declare-fun OPLSS.Plain.reveal (Term) Term)
;;;;;;;;;;;;;;;;p: plain -> Prims.GTot OPLSS.AES.plain
(declare-fun Tm_ghost_arrow_67f9c81be718cbad89cb279824301564 () Term)
(declare-fun OPLSS.Plain.reveal@tok () Term)

; </end encoding let reveal>


; encoding sigelt val OPLSS.Plain.hide


; <Skipped val OPLSS.Plain.hide/>


; encoding sigelt let hide


; <Start encoding let hide>

(declare-fun OPLSS.Plain.hide (Term) Term)
;;;;;;;;;;;;;;;;b: OPLSS.AES.plain -> Prims.GTot plain
(declare-fun Tm_ghost_arrow_2ce6908c670bb0708638e743452f88b8 () Term)
(declare-fun OPLSS.Plain.hide@tok () Term)

; </end encoding let hide>


; encoding sigelt val OPLSS.Plain.reveal_hide


; <Skipped val OPLSS.Plain.reveal_hide/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.Plain.reveal; Namespace OPLSS.Plain
(assert (! 
;; def=OPLSS.Plain.fst(22,4-22,10); use=OPLSS.Plain.fst(22,4-22,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(OPLSS.Plain.plain Dummy_value))
(HasType (OPLSS.Plain.reveal @x0)
OPLSS.AES.plain))
 

:pattern ((OPLSS.Plain.reveal @x0))
:qid typing_OPLSS.Plain.reveal))

:named typing_OPLSS.Plain.reveal))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.Plain.plain; Namespace OPLSS.Plain
(assert (! 
;; def=OPLSS.Plain.fst(20,5-20,10); use=OPLSS.Plain.fst(20,5-20,10)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.Plain.plain @u0)
Prims.eqtype)
 

:pattern ((OPLSS.Plain.plain @u0))
:qid typing_OPLSS.Plain.plain))

:named typing_OPLSS.Plain.plain))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.Plain.hide; Namespace OPLSS.Plain
(assert (! 
;; def=OPLSS.Plain.fst(24,4-24,8); use=OPLSS.Plain.fst(24,4-24,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
OPLSS.AES.plain)
(HasType (OPLSS.Plain.hide @x0)
(OPLSS.Plain.plain Dummy_value)))
 

:pattern ((OPLSS.Plain.hide @x0))
:qid typing_OPLSS.Plain.hide))

:named typing_OPLSS.Plain.hide))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;;;;;;;;;;;;;;;;Equation for OPLSS.Plain.reveal
;;; Fact-ids: Name OPLSS.Plain.reveal; Namespace OPLSS.Plain
(assert (! 
;; def=OPLSS.Plain.fst(22,4-22,10); use=OPLSS.Plain.fst(22,4-22,10)
(forall ((@x0 Term))
 (! (= (OPLSS.Plain.reveal @x0)
@x0)
 

:pattern ((OPLSS.Plain.reveal @x0))
:qid equation_OPLSS.Plain.reveal))

:named equation_OPLSS.Plain.reveal))
;;;;;;;;;;;;;;;;Equation for OPLSS.Plain.plain
;;; Fact-ids: Name OPLSS.Plain.plain; Namespace OPLSS.Plain
(assert (! 
;; def=OPLSS.Plain.fst(20,5-20,10); use=OPLSS.Plain.fst(20,5-20,10)
(forall ((@u0 Dummy_sort))
...
:qid equation_OPLSS.Plain.plain))

:named equation_OPLSS.Plain.plain))
;;;;;;;;;;;;;;;;Equation for OPLSS.Plain.hide
;;; Fact-ids: Name OPLSS.Plain.hide; Namespace OPLSS.Plain
(assert (! 
;; def=OPLSS.Plain.fst(24,4-24,8); use=OPLSS.Plain.fst(24,4-24,8)
(forall ((@x0 Term))
...
:pattern ((OPLSS.Plain.hide @x0))
:qid equation_OPLSS.Plain.hide))

:named equation_OPLSS.Plain.hide))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
; Starting query at OPLSS.Plain.fst(29,4-29,6)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (p: OPLSS.Plain.plain).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         OPLSS.Plain.hide (OPLSS.Plain.reveal p) == p ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let reveal_hide`
...
;; def=Prims.fst(441,36-441,97); use=OPLSS.Plain.fst(29,4-29,6)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=OPLSS.Plain.fst(27,10-27,32); use=OPLSS.Plain.fst(29,4-29,6)
(or label_2

;; def=OPLSS.Plain.fst(27,10-27,32); use=OPLSS.Plain.fst(29,4-29,6)
(= (OPLSS.Plain.hide (OPLSS.Plain.reveal @x0))
@x0)
)
)

;; def=Prims.fst(441,83-441,96); use=OPLSS.Plain.fst(29,4-29,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS.Plain.fst(29,4-29,6)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.Plain.reveal_hide, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_OPLSS.Plain.hide, equation_OPLSS.Plain.reveal
...
; encoding sigelt let reveal_hide


; <Start encoding let reveal_hide>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun OPLSS.Plain.reveal_hide (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun OPLSS.Plain.reveal_hide@tok () Term)

; </end encoding let reveal_hide>


; encoding sigelt val OPLSS.Plain.hide_reveal


; <Skipped val OPLSS.Plain.hide_reveal/>

;;;;;;;;;;;;;;;;Lemma: OPLSS.Plain.reveal_hide
;;; Fact-ids: Name OPLSS.Plain.reveal_hide; Namespace OPLSS.Plain
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
(OPLSS.Plain.plain Dummy_value))

;; def=OPLSS.Plain.fsti(27,10-27,32); use=OPLSS.Plain.fst(26,4-26,15)
(= (OPLSS.Plain.hide (OPLSS.Plain.reveal @x0))
@x0)
)
...
:pattern ((OPLSS.Plain.reveal @x0))
:qid lemma_OPLSS.Plain.reveal_hide))
:named lemma_OPLSS.Plain.reveal_hide))
(push) ;; push{2

; Starting query at OPLSS.Plain.fst(34,4-34,6)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (b: OPLSS.AES.plain).
;   (*  - Could not prove post-condition
; *)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         OPLSS.Plain.reveal (OPLSS.Plain.hide b) == b ==> p pure_result) ==>
;     (forall (any_result: Prims.unit). p any_result)


; Context: While encoding a query
; While typechecking the top-level declaration `let hide_reveal`
...
;; def=Prims.fst(441,36-441,97); use=OPLSS.Plain.fst(34,4-34,6)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=OPLSS.Plain.fst(32,10-32,32); use=OPLSS.Plain.fst(34,4-34,6)
(or label_2

;; def=OPLSS.Plain.fst(32,10-32,32); use=OPLSS.Plain.fst(34,4-34,6)
(= (OPLSS.Plain.reveal (OPLSS.Plain.hide @x0))
@x0)
)
)

;; def=Prims.fst(441,83-441,96); use=OPLSS.Plain.fst(34,4-34,6)
(Valid 
;; def=Prims.fst(441,83-441,96); use=OPLSS.Plain.fst(34,4-34,6)
(ApplyTT @x1
@x2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.Plain.hide_reveal, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_OPLSS.Plain.hide, equation_OPLSS.Plain.reveal
...
; encoding sigelt let hide_reveal


; <Start encoding let hide_reveal>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun OPLSS.Plain.hide_reveal (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun OPLSS.Plain.hide_reveal@tok () Term)

; </end encoding let hide_reveal>


; encoding sigelt val OPLSS.Plain.repr


; <Skipped val OPLSS.Plain.repr/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.Ideal.uf_cma; Namespace OPLSS.Ideal
(assert (! 
;; def=OPLSS.Ideal.fsti(28,4-28,10); use=OPLSS.Ideal.fsti(28,4-28,10)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.Ideal.uf_cma @u0)
OPLSS.Flag.flag)
 

:pattern ((OPLSS.Ideal.uf_cma @u0))
:qid typing_OPLSS.Ideal.uf_cma))

:named typing_OPLSS.Ideal.uf_cma))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.Ideal.pre_ind_cpa; Namespace OPLSS.Ideal
(assert (! 
;; def=OPLSS.Ideal.fsti(32,4-32,15); use=OPLSS.Ideal.fsti(32,4-32,15)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.Ideal.pre_ind_cpa @u0)
Tm_refine_46b68b9714c8e3c8a3384ac3f5230ed1)
 

:pattern ((OPLSS.Ideal.pre_ind_cpa @u0))
:qid typing_OPLSS.Ideal.pre_ind_cpa))

:named typing_OPLSS.Ideal.pre_ind_cpa))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.Ideal.ind_cpa; Namespace OPLSS.Ideal
(assert (! 
;; def=OPLSS.Ideal.fsti(35,4-35,11); use=OPLSS.Ideal.fsti(35,4-35,11)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.Ideal.ind_cpa @u0)
Tm_refine_9bfa85103653817f1c9189142c4becbc)
 

:pattern ((OPLSS.Ideal.ind_cpa @u0))
:qid typing_OPLSS.Ideal.ind_cpa))

:named typing_OPLSS.Ideal.ind_cpa))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.Ideal.conf; Namespace OPLSS.Ideal
(assert (! 
;; def=OPLSS.Ideal.fsti(49,4-49,8); use=OPLSS.Ideal.fsti(49,4-49,8)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.Ideal.conf @u0)
Tm_refine_9bfa85103653817f1c9189142c4becbc)
 

:pattern ((OPLSS.Ideal.conf @u0))
:qid typing_OPLSS.Ideal.conf))

:named typing_OPLSS.Ideal.conf))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.Flag.reveal; Namespace OPLSS.Flag
(assert (! 
;; def=OPLSS.Flag.fsti(35,4-35,10); use=OPLSS.Flag.fsti(35,4-35,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
OPLSS.Flag.flag)
(HasType (OPLSS.Flag.reveal @x0)
Prims.bool))
 

:pattern ((OPLSS.Flag.reveal @x0))
:qid typing_OPLSS.Flag.reveal))

:named typing_OPLSS.Flag.reveal))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.Flag.flag; Namespace OPLSS.Flag
(assert (! (HasType OPLSS.Flag.flag
Tm_type)
:named typing_OPLSS.Flag.flag))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name OPLSS.Ideal.ind_cpa; Namespace OPLSS.Ideal
(assert (! (HasType Tm_refine_9bfa85103653817f1c9189142c4becbc
Tm_type)
:named refinement_kinding_Tm_refine_9bfa85103653817f1c9189142c4becbc))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name OPLSS.Ideal.ae; Namespace OPLSS.Ideal
(assert (! (HasType Tm_refine_9ab0ebe287f0645e6f2f11ecad663151
Tm_type)
:named refinement_kinding_Tm_refine_9ab0ebe287f0645e6f2f11ecad663151))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name OPLSS.Ideal.pre_ind_cpa; Namespace OPLSS.Ideal
(assert (! (HasType Tm_refine_46b68b9714c8e3c8a3384ac3f5230ed1
Tm_type)
:named refinement_kinding_Tm_refine_46b68b9714c8e3c8a3384ac3f5230ed1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name OPLSS.Ideal.ind_cpa; Namespace OPLSS.Ideal
(assert (! 
;; def=OPLSS.Ideal.fsti(35,14-35,55); use=OPLSS.Ideal.fsti(35,14-35,55)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_9bfa85103653817f1c9189142c4becbc)
...
;; def=OPLSS.Ideal.fsti(35,22-35,53); use=OPLSS.Ideal.fsti(35,22-35,53)
(implies 
;; def=OPLSS.Ideal.fsti(35,22-35,30); use=OPLSS.Ideal.fsti(35,22-35,30)
(BoxBool_proj_0 (OPLSS.Flag.reveal @x1))


;; def=OPLSS.Ideal.fsti(35,35-35,53); use=OPLSS.Ideal.fsti(35,35-35,53)
(BoxBool_proj_0 (OPLSS.Flag.reveal (OPLSS.Ideal.pre_ind_cpa Dummy_value)))
)
))
...
@x1
Tm_refine_9bfa85103653817f1c9189142c4becbc))
:qid refinement_interpretation_Tm_refine_9bfa85103653817f1c9189142c4becbc))

:named refinement_interpretation_Tm_refine_9bfa85103653817f1c9189142c4becbc))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name OPLSS.Ideal.ae; Namespace OPLSS.Ideal
(assert (! 
;; def=OPLSS.Ideal.fsti(41,9-43,44); use=OPLSS.Ideal.fsti(41,9-43,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_9ab0ebe287f0645e6f2f11ecad663151)
(and (HasTypeFuel @u0
@x1
OPLSS.Flag.flag)
(BoxBool_proj_0 (Prims.op_AmpAmp (Prims.op_Equality Prims.bool
(OPLSS.Flag.reveal @x1)
(OPLSS.Flag.reveal (OPLSS.Ideal.pre_ind_cpa Dummy_value)))
(OPLSS.Flag.reveal (OPLSS.Ideal.uf_cma Dummy_value))))
(BoxBool_proj_0 (OPLSS.Flag.reveal (OPLSS.Ideal.ind_cpa Dummy_value)))))
 

:pattern ((HasTypeFuel @u0
@x1
Tm_refine_9ab0ebe287f0645e6f2f11ecad663151))
:qid refinement_interpretation_Tm_refine_9ab0ebe287f0645e6f2f11ecad663151))

:named refinement_interpretation_Tm_refine_9ab0ebe287f0645e6f2f11ecad663151))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name OPLSS.Ideal.pre_ind_cpa; Namespace OPLSS.Ideal
(assert (! 
;; def=OPLSS.Ideal.fsti(32,18-32,53); use=OPLSS.Ideal.fsti(32,18-32,53)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_46b68b9714c8e3c8a3384ac3f5230ed1)
...
;; def=OPLSS.Ideal.fsti(32,26-32,51); use=OPLSS.Ideal.fsti(32,26-32,51)
(= (OPLSS.Flag.reveal @x1)
(OPLSS.Flag.reveal (OPLSS.Ideal.uf_cma Dummy_value)))
))
...
@x1
Tm_refine_46b68b9714c8e3c8a3384ac3f5230ed1))
:qid refinement_interpretation_Tm_refine_46b68b9714c8e3c8a3384ac3f5230ed1))

:named refinement_interpretation_Tm_refine_46b68b9714c8e3c8a3384ac3f5230ed1))
...
;;;;;;;;;;;;;;;;Lemma: OPLSS.Plain.hide_reveal
;;; Fact-ids: Name OPLSS.Plain.hide_reveal; Namespace OPLSS.Plain
(assert (! (forall ((@x0 Term))
 (! (implies (HasType @x0
OPLSS.AES.plain)

;; def=OPLSS.Plain.fsti(31,10-31,32); use=OPLSS.Plain.fst(31,4-31,15)
(= (OPLSS.Plain.reveal (OPLSS.Plain.hide @x0))
@x0)
)
...
:pattern ((OPLSS.Plain.hide @x0))
:qid lemma_OPLSS.Plain.hide_reveal))
:named lemma_OPLSS.Plain.hide_reveal))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9bfa85103653817f1c9189142c4becbc
;;; Fact-ids: Name OPLSS.Ideal.ind_cpa; Namespace OPLSS.Ideal
(assert (! (iff (Valid (Prims.hasEq Tm_refine_9bfa85103653817f1c9189142c4becbc))
(Valid (Prims.hasEq OPLSS.Flag.flag)))
:named haseqTm_refine_9bfa85103653817f1c9189142c4becbc))
;;;;;;;;;;;;;;;;haseq for Tm_refine_9ab0ebe287f0645e6f2f11ecad663151
;;; Fact-ids: Name OPLSS.Ideal.ae; Namespace OPLSS.Ideal
(assert (! (iff (Valid (Prims.hasEq Tm_refine_9ab0ebe287f0645e6f2f11ecad663151))
(Valid (Prims.hasEq OPLSS.Flag.flag)))
:named haseqTm_refine_9ab0ebe287f0645e6f2f11ecad663151))
;;;;;;;;;;;;;;;;haseq for Tm_refine_46b68b9714c8e3c8a3384ac3f5230ed1
;;; Fact-ids: Name OPLSS.Ideal.pre_ind_cpa; Namespace OPLSS.Ideal
(assert (! (iff (Valid (Prims.hasEq Tm_refine_46b68b9714c8e3c8a3384ac3f5230ed1))
(Valid (Prims.hasEq OPLSS.Flag.flag)))
:named haseqTm_refine_46b68b9714c8e3c8a3384ac3f5230ed1))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name OPLSS.Flag.flag; Namespace OPLSS.Flag
(assert (! (HasType OPLSS.Flag.flag
Tm_type)
:named function_token_typing_OPLSS.Flag.flag))
;;;;;;;;;;;;;;;;Equation for OPLSS.Ideal.conf
;;; Fact-ids: Name OPLSS.Ideal.conf; Namespace OPLSS.Ideal
(assert (! 
;; def=OPLSS.Ideal.fsti(49,4-49,8); use=OPLSS.Ideal.fsti(49,4-49,8)
(forall ((@u0 Dummy_sort))
...
(OPLSS.Ideal.ind_cpa Dummy_value))
...
:qid equation_OPLSS.Ideal.conf))

:named equation_OPLSS.Ideal.conf))
(push) ;; push{2

; Starting query at OPLSS.Plain.fst(38,4-38,5)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603
Tm_type)
:named refinement_kinding_Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS.Plain.fst(36,9-36,42); use=OPLSS.Plain.fst(36,9-36,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603)
(and (HasTypeFuel @u0
@x1
(OPLSS.Plain.plain Dummy_value))
(not (BoxBool_proj_0 (OPLSS.Flag.reveal (OPLSS.Ideal.conf Dummy_value))))))
 

:pattern ((HasTypeFuel @u0
@x1
Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603))
:qid refinement_interpretation_Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603))

:named refinement_interpretation_Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603))
(Valid (Prims.hasEq (OPLSS.Plain.plain Dummy_value))))
:named haseqTm_refine_ce1d06067eb8b9d48b708f26cd1b3603))

; Encoding query formula : forall (p: OPLSS.Plain.plain{Prims.op_Negation (OPLSS.Flag.reveal OPLSS.Ideal.conf)}).
;   (*  - Could not prove post-condition
; *)
;   Prims.op_Negation (OPLSS.Flag.reveal OPLSS.Ideal.conf) ==> p == OPLSS.Plain.reveal p
...
;; def=OPLSS.Plain.fst(37,17-37,30); use=OPLSS.Plain.fst(38,4-38,5)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.Plain.repr, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_OPLSS.Plain.reveal
...
(declare-fun Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603 () Term)
(declare-fun OPLSS.Plain.repr (Term) Term)

(declare-fun Tm_refine_63376ac5a6258efcb136c2b5623ed4e5 (Term) Term)
;;;;;;;;;;;;;;;;p: plain{Prims.op_Negation (OPLSS.Flag.reveal OPLSS.Ideal.conf)}   -> b: OPLSS.AES.plain{b == reveal p}
(declare-fun Tm_arrow_ce6aaa1853255c80114093ea95f93faf () Term)
(declare-fun OPLSS.Plain.repr@tok () Term)
...
; encoding sigelt val OPLSS.Plain.coerce


; <Skipped val OPLSS.Plain.coerce/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name OPLSS.Ideal.auth; Namespace OPLSS.Ideal
(assert (! 
;; def=OPLSS.Ideal.fsti(46,4-46,8); use=OPLSS.Ideal.fsti(46,4-46,8)
(forall ((@u0 Dummy_sort))
 (! (HasType (OPLSS.Ideal.auth @u0)
OPLSS.Flag.flag)
 

:pattern ((OPLSS.Ideal.auth @u0))
:qid typing_OPLSS.Ideal.auth))

:named typing_OPLSS.Ideal.auth))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name OPLSS.Plain.repr; Namespace OPLSS.Plain
(assert (! (HasType Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603
Tm_type)
:named refinement_kinding_Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name OPLSS.Plain.repr; Namespace OPLSS.Plain
(assert (! 
;; def=OPLSS.Plain.fsti(34,9-34,42); use=OPLSS.Plain.fst(36,4-36,8)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ce1d06067eb8b9d48b708f26cd1b3603)
...
(OPLSS.Ideal.uf_cma Dummy_value))
...
:qid equation_OPLSS.Ideal.auth))

:named equation_OPLSS.Ideal.auth))
(push) ;; push{2

; Starting query at OPLSS.Plain.fst(42,4-42,5)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_0f21919b71dabd360b2a56d78c6748c4 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_0f21919b71dabd360b2a56d78c6748c4
Tm_type)
:named refinement_kinding_Tm_refine_0f21919b71dabd360b2a56d78c6748c4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=OPLSS.Plain.fst(40,11-40,48); use=OPLSS.Plain.fst(40,11-40,48)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_0f21919b71dabd360b2a56d78c6748c4)
(and (HasTypeFuel @u0
@x1
OPLSS.AES.plain)
(not (BoxBool_proj_0 (OPLSS.Flag.reveal (OPLSS.Ideal.auth Dummy_value))))))
 

:pattern ((HasTypeFuel @u0
@x1
Tm_refine_0f21919b71dabd360b2a56d78c6748c4))
:qid refinement_interpretation_Tm_refine_0f21919b71dabd360b2a56d78c6748c4))

:named refinement_interpretation_Tm_refine_0f21919b71dabd360b2a56d78c6748c4))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0f21919b71dabd360b2a56d78c6748c4
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0f21919b71dabd360b2a56d78c6748c4))
(Valid (Prims.hasEq OPLSS.AES.plain)))
:named haseqTm_refine_0f21919b71dabd360b2a56d78c6748c4))

; Encoding query formula : forall (r: OPLSS.AES.plain{Prims.op_Negation (OPLSS.Flag.reveal OPLSS.Ideal.auth)}).
;   (*  - Could not prove post-condition
; *)
;   Prims.op_Negation (OPLSS.Flag.reveal OPLSS.Ideal.auth) ==> r == OPLSS.Plain.hide r
...
;; def=OPLSS.Plain.fst(41,13-41,24); use=OPLSS.Plain.fst(42,4-42,5)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.Plain.coerce, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, equation_OPLSS.Plain.hide
...
(declare-fun Tm_refine_0f21919b71dabd360b2a56d78c6748c4 () Term)
(declare-fun OPLSS.Plain.coerce (Term) Term)

(declare-fun Tm_refine_22c478f5ba6f4dc117e3df7bbd2e5b2b (Term) Term)
;;;;;;;;;;;;;;;;r: OPLSS.AES.plain{Prims.op_Negation (OPLSS.Flag.reveal OPLSS.Ideal.auth)} -> p: plain{p == hide r}
(declare-fun Tm_arrow_d6fe572de0d8f0fb04c324ffb6c318e0 () Term)
(declare-fun OPLSS.Plain.coerce@tok () Term)
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name OPLSS.Plain.coerce; Namespace OPLSS.Plain
(assert (! (HasType Tm_refine_0f21919b71dabd360b2a56d78c6748c4
Tm_type)
:named refinement_kinding_Tm_refine_0f21919b71dabd360b2a56d78c6748c4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name OPLSS.Plain.coerce; Namespace OPLSS.Plain
(assert (! 
;; def=OPLSS.Plain.fsti(37,11-37,48); use=OPLSS.Plain.fst(40,4-40,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_0f21919b71dabd360b2a56d78c6748c4)
...
; Starting query at OPLSS.Plain.fsti(40,0-41,38)
...
; Context: While encoding a query
; While typechecking the top-level declaration `val OPLSS.Plain.length`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=OPLSS.Plain.fsti(40,0-41,38)
(forall ((@x0 Term))
 (! (implies (HasType @x0
(OPLSS.Plain.plain Dummy_value))

;; def=dummy(0,0-0,0); use=OPLSS.Plain.fsti(40,14-41,38)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.nat)

;; def=Prims.fst(73,23-73,30); use=OPLSS.Plain.fsti(41,11-41,12)
(or label_1
...
; encoding sigelt val OPLSS.Plain.length


; <Skipped val OPLSS.Plain.length/>

(push) ;; push{2

; Starting query at OPLSS.Plain.fst(46,4-46,16)
...
; *)
;       Prims.hasEq Prims.nat) /\
;   FStar.Seq.Base.length p = FStar.Seq.Base.length (OPLSS.Plain.reveal p)
...
;; def=OPLSS.Plain.fst(45,4-46,16); use=OPLSS.Plain.fst(45,4-46,16)
(and 
;; def=dummy(0,0-0,0); use=OPLSS.Plain.fst(46,4-46,16)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.nat)

;; def=Prims.fst(73,23-73,30); use=OPLSS.Plain.fst(45,11-45,12)
(or label_1

;; def=Prims.fst(73,23-73,30); use=OPLSS.Plain.fst(46,4-46,16)
(Valid 
;; def=Prims.fst(73,23-73,30); use=OPLSS.Plain.fst(46,4-46,16)
(Prims.hasEq Prims.nat)
)
...
;; def=OPLSS.Plain.fst(45,11-45,36); use=OPLSS.Plain.fst(46,4-46,16)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (OPLSS.Plain.length, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, equation_OPLSS.Plain.reveal, equation_Prims.eqtype, equation_Prims.nat, haseqTm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, typing_Prims.int
